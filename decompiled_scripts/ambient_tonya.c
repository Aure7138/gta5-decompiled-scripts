...
void __EntryFunction__()
{
	...
	if (unk_0xB1A77D5C890711F9(joaat("ambient_tonya")) > 1)
	{
...
void func_1()
{
	if (!unk_0x4D1CAE1CFC4C8868(iLocal_248))
	{
		if (func_165(61))
		{
			iLocal_79 = 6;
...
void func_24(char[4] cParam0, int iParam1, int iParam2)
{
	if (Global_91106 != 10 && Global_91106 != 9)
	{
		...
		func_26(&Global_92910, cParam0, 0, "Start", iParam1, iParam2);
		func_25();
		Global_85617 = 0;
	}
}
...
void func_26(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_164();
	...
	if (!unk_0x1E80C02AC16B6622(unk_0x77F050A399DB77ED()))
	{
		...
		func_63(unk_0x77F050A399DB77ED());
		func_57(unk_0x77F050A399DB77ED(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_54())
		{
			func_47(unk_0x77F050A399DB77ED(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (unk_0x1F2158D615BC4B25(Global_88770[iVar0]))
		{
			if (Global_88770[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0xDF1398076E26B0E4(iParam0) == func_35(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0x968EA16107097324(iParam0, 0))
	{
		...
		*uParam1 = unk_0x21C7BB3FC7BDA875(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x573691DB812DC8AA(&(uParam1->f_77), func_39(iVar0 + 1));
			}
			iVar0++;
		}
				...
				if (unk_0x968EA16107097324(*uParam1, 0))
				{
					if (iParam2 == 0 || unk_0xA2490B3CE6382FBB(unk_0xAF99169F0F5AE41D(*uParam1, 1), unk_0xAF99169F0F5AE41D(iParam0, 1), 1) < 100f)
					{
						...
						if (func_43(*uParam1, func_164(), 1))
						{
							...
							if (!unk_0x35D1CAD6ADAB6491(uVar0, "save_anywhere"))
							{
								return 0;
							}
...
int func_48(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2466327[iParam0 /*5*/][func_49(iParam1)];
...
int func_51(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2486179[iParam0 /*5*/][func_49(iParam1)];
...
void func_55()
{
	...
	if (unk_0x1F2158D615BC4B25(unk_0x77F050A399DB77ED()))
	{
		if (func_46(Global_99250.f_1754.f_539.f_3549) != unk_0xDF1398076E26B0E4(unk_0x77F050A399DB77ED()))
		{
			...
			if (func_37(iVar0) && (!func_56(14) || Global_98202))
			{
...
void func_57(int iParam0, bool bParam1)
{
	...
	iVar0 = func_45(iParam0);
	if (func_37(iVar0) && !unk_0x1E80C02AC16B6622(iParam0))
	{
		if (iParam0 == unk_0x77F050A399DB77ED())
		{
			func_58(iParam0, &(Global_99250.f_1754.f_539.f_298[iVar0 /*284*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_58(int iParam0, var uParam1)
{
	...
	if (!unk_0x1E80C02AC16B6622(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x5C878573BDD0D070(iParam0, func_62(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((unk_0x4D9EC363BAD16B5E(iVar7, &Var9) && !func_59(Var9.f_1)) && iVar70 < 50)
			{
...
int func_68(var uParam0)
{
	if (!unk_0x0B6E83A9A7ED3EBA(unk_0x77F050A399DB77ED()) && !unk_0x1E80C02AC16B6622(unk_0x77F050A399DB77ED()))
	{
		if (func_78())
		{
			*uParam0 = func_74(unk_0xAF99169F0F5AE41D(unk_0x77F050A399DB77ED(), 0), 5, -1, 0, 1, -1);
...
int func_70(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x4C779B19E6DDCDA2())
	{
		if (func_72() == 0)
		{
			return unk_0xB56FEBC510E7E9DE(func_48(func_71(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_74(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_77(iVar0))
		{
			...
			{
				fVar1 = unk_0xA2490B3CE6382FBB(Param0, func_75(iVar0, 0), 1);
...
var func_79()
{
	...
	func_89(&uVar0, unk_0x624CC88A8815545E());
	func_88(&uVar0, unk_0xD3D98375D5CA69E4());
	func_87(&uVar0, unk_0x5C5157A539753532());
	func_82(&uVar0, unk_0xCB12BC5A618B995B());
	func_81(&uVar0, unk_0x9746D90F14C930B9());
	func_80(&uVar0, unk_0xD45B57A596913560());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_85(unk_0xB56FEBC510E7E9DE(iParam0, 31), -1, 1)) + 2011;
}
...
void func_92(char* sParam0, var uParam1, int iParam2)
{
	...
	unk_0x40597C2B44D96D32(sParam0, uParam1, iParam2, func_168(0));
}
...
void func_97(int iParam0)
{
	...
	unk_0x507887ECD0989471(sVar0);
	while (!unk_0xF93DA38375EB3977(sVar0))
	{
		unk_0x507887ECD0989471(sVar0);
		unk_0x4EDE34FBADD967A6(0);
	}
...
int func_125()
{
	return func_120(unk_0x664B47C58CE8A0A4(), 0);
}
...
int func_126(int iParam0)
{
	...
	iVar0 = func_128(&(Global_98337[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
		...
		if (unk_0x1F2158D615BC4B25(unk_0x77F050A399DB77ED()))
		{
			if (!unk_0x1E80C02AC16B6622(unk_0x77F050A399DB77ED()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0x57F90ABC20B2C976(unk_0x8ACD527A7E574590(), 1) || func_139()) || Global_25117) || func_138()) || func_137(8, -1)) || func_135()) || func_78()) || func_136()) || func_134()) || Global_99250.f_6306.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x9D63F8E150A93C77(unk_0x8ACD527A7E574590()) || unk_0x314654A7E186B6B2(unk_0x77F050A399DB77ED())) || unk_0xB2C4D90B868C2250(unk_0x77F050A399DB77ED())) || unk_0xCD7683F575A67B31(unk_0x77F050A399DB77ED())) || unk_0x0C3F372CDA660C9E(unk_0x77F050A399DB77ED())) || unk_0x57F90ABC20B2C976(unk_0x8ACD527A7E574590(), 1)) || unk_0x1F23B510F2B55C10(unk_0x8ACD527A7E574590())) || unk_0x1CC086F95707C553(unk_0x77F050A399DB77ED(), 0)) || func_139()) || Global_98297) || Global_25117) || func_138()) || func_137(8, -1)) || func_135()) || func_78()) || func_136()) || func_134()) || Global_99250.f_6306.f_919[iVar0] == 5) || Global_36247 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_139() || unk_0xAEE8018B8C539989(unk_0x8ACD527A7E574590()) > 0) || func_137(8, -1)) || func_134()) || func_133()) || Global_99250.f_6306.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((unk_0x1CC086F95707C553(unk_0x77F050A399DB77ED(), 0) || !unk_0x116E9F29D23ADBBE(unk_0x8ACD527A7E574590())) || !unk_0x9D63F8E150A93C77(unk_0x8ACD527A7E574590())) || !unk_0x398F615441F52A47()) || unk_0x314654A7E186B6B2(unk_0x77F050A399DB77ED())) || unk_0xCD7683F575A67B31(unk_0x77F050A399DB77ED())) || unk_0x0C3F372CDA660C9E(unk_0x77F050A399DB77ED())) || unk_0x57F90ABC20B2C976(unk_0x8ACD527A7E574590(), 1)) || func_139()) || func_136()) || Global_98297) || Global_25117) || func_138()) || Global_36750) || func_137(8, -1)) || func_135()) || func_133()) || func_134()) || Global_99250.f_6306.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
	...
	switch (iLocal_80)
	{
		case 0:
			if (!func_156())
			{
				if (func_141(103))
				{
					func_155(&uLocal_81, 1, unk_0x77F050A399DB77ED(), "FRANKLIN", 0, 1);
