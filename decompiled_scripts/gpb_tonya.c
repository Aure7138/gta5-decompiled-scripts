...
void __EntryFunction__()
{
	...
	if (func_112(func_114(unk_0xBB0808A181D4745C())))
	{
		func_115(0);
	}
	if (!func_110())
	...
	if (unk_0xA8CEACB4F35AE058(unk_0x56E9E0FD5ACCD35D(unk_0x16F2683693E537C9())) > 1369f && !func_107())
	{
		func_115(0);
	}
	if (unk_0x1C0640BA9A7327B3() < Global_31031 + 10000 && !func_107())
	{
		func_115(0);
	}
	...
	unk_0x745CE398A4B0A3C6(Local_242, 0.5f, 0);
	uLocal_240 = unk_0x36F2404464202779(25, iLocal_36, Local_242, ScriptParam_0.f_17[0], 0, 1);
	func_103();
	unk_0x71199B01895C6202(iLocal_36);
	iLocal_241 = 1;
	if (unk_0xC844350D5D58C99A(uLocal_240) && func_102(uLocal_240))
	{
		unk_0xAFF39FB306F8E232(uLocal_240, 17, 1);
		unk_0x11AD11297DC58CC7(uLocal_240, 1);
	}
	iLocal_297 = 0;
	...
	while (iVar0 == 1)
	{
		...
		{
			func_97(func_114(unk_0xBB0808A181D4745C()));
			func_115(0);
		}
		...
		fVar43 = func_96(unk_0x16F2683693E537C9(), uLocal_240);
		if (fVar43 < 10f && func_95())
		{
			unk_0x50155CDC2C5335FC(uLocal_240, 1, unk_0x16F2683693E537C9(), 31086, 0f, 0f, 0f, 0, -1, -1);
		}
		if (fVar43 < 8f)
		{
			unk_0x50155CDC2C5335FC(unk_0x16F2683693E537C9(), 1, uLocal_240, 31086, 0f, 0f, 0f, 0, -1, -1);
		}
		if (fVar43 < 15f)
		{
		...
		Var76 = { unk_0x68F4C0EC296D3901(uLocal_240, 1) };
		if (((unk_0xE608C809F9416F00(uLocal_240) && !iLocal_250 == 25) && !iLocal_250 == 5) && !iLocal_250 == 6)
		{
			func_94();
			if (func_93())
			{
				func_91();
				unk_0xC6EB89C59F2AF6B8(uLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
				iLocal_250 = 25;
			}
			else
			{
			...
			unk_0xC8B576D6F470FFC6(uLocal_240, "GENERIC_CURSE_MED", "SPEECH_PARAMS_FORCE", 1);
		}
		if (((func_109() || unk_0x2C1AA3A291786CDC()) || func_108()) || !func_110())
		{
			if (!func_89() && unk_0x8A22C4C08282BF26(joaat("director_mode")) == 0)
			{
				if (func_109())
				{
				}
		...
		if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
		{
			if ((((unk_0xD3AB958FFC730661(unk_0xD803B885F5E47A62(), uLocal_240) || unk_0x292E02BF8ABF889C(unk_0xD803B885F5E47A62(), uLocal_240)) && fVar43 < 25f) && func_88(unk_0x16F2683693E537C9()) != joaat("weapon_unarmed")) && func_85(uLocal_240, unk_0x16F2683693E537C9(), 1126825984, 0))
			{
				if (!func_89())
				{
					func_91();
		...
		if (((((unk_0xEB6A8945D1AC98A1(uLocal_240) || unk_0xD3DCEC81D13AAFB1(Var76, 50f, 1)) || unk_0xD3DCEC81D13AAFB1(Var76, 50f, 0)) || unk_0x723EE7F83DF1497D(Var76, 20f, 20f, 20f, 0)) || unk_0x681F21BF9F7B449B(-1, Var76, 50f)) || unk_0x8ADFEA7B4409B2F8(Var76, 1f))
		{
			if (!func_89())
			{
				func_91();
		...
		if (unk_0xB87D13D0C064E9D1(uLocal_240, unk_0x16F2683693E537C9(), 1))
		{
			func_91();
			unk_0xC6EB89C59F2AF6B8(uLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
			iLocal_250 = 24;
		}
		if (func_84(uLocal_240, unk_0x16F2683693E537C9(), 1) < 25f)
		{
			if (!unk_0xE4EDC4B0E92C078B(uLocal_248))
			{
				func_80(&uLocal_248, &uLocal_240, 0);
			}
		}
		else if (unk_0xE4EDC4B0E92C078B(uLocal_248))
		{
			func_79(&uLocal_248);
		}
		if (!bLocal_439)
		{
			if (!unk_0xEB6A8945D1AC98A1(uLocal_240) && !unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
			{
				if (unk_0xB7A628320EFF8E47(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), unk_0x68F4C0EC296D3901(uLocal_240, 1)) < 16f)
				{
		...
		switch (iLocal_250)
		{
			...
			case 5:
				...
				{
					unk_0x96167B03C5A77156(uLocal_240, Local_242, 1f, -1, 1f, 1024, ScriptParam_0.f_17[0]);
					iLocal_250 = 6;
				}
				break;
			...
			case 6:
				...
				if (unk_0xD1960163A3042274(uLocal_240, 713668775) != 1 && unk_0xD1960163A3042274(uLocal_240, 713668775) != 0)
				{
					unk_0x26F63FD28070F2CE("WAIT_MOVE_BACK_TO_INITIAL_POSITION TASK_PLAY_ANIM", 0.02f, 0.26f, 0f, 0, 0, 255, 255);
					unk_0xC6EB89C59F2AF6B8(uLocal_240, &cLocal_340, "idle_intro", 4f, -4f, -1, 0, 0, 0, 0, 0);
					unk_0xF895E10BF4C72645(uLocal_240, 0, 0);
					func_120();
					iLocal_250 = 0;
				}
				break;
			...
			case 3:
				...
				if (func_84(uLocal_240, unk_0x16F2683693E537C9(), 1) < fVar40)
				{
					if (func_58() == 1)
					{
						iLocal_250 = 8;
			...
			case 8:
				...
				{
					if (unk_0xB4ECF989E2C1DAC8(uLocal_240, &Local_372, &Local_356, 3))
					{
						func_52(Global_111583[iLocal_251], iLocal_297, unk_0x8CA9406E01C7EE58(uLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			...
			case 11:
				...
				{
					func_23(&sVar13);
					unk_0xC6EB89C59F2AF6B8(uLocal_240, &Local_404, &sVar13, 2f, -2f, -1, 0, 0, 0, 0, 0);
					iLocal_250 = 12;
				}
				else
				{
			...
			case 15:
				...
				if (unk_0xB4AE0788C1587752(&Local_404))
				{
					...
					if (!func_62())
					{
						...
						func_23(&sVar13);
						unk_0xC6EB89C59F2AF6B8(uLocal_240, &Local_404, &sVar13, 1000f, -1000f, -1, 0, 0, 0, 0, 0);
						unk_0xF895E10BF4C72645(uLocal_240, 0, 0);
						iLocal_250 = 12;
					}
				}
			...
			case 16:
				...
				if (!func_62())
				{
					...
					{
						unk_0xCAC78D14D05349E7(unk_0x16F2683693E537C9(), 0);
					}
					unk_0x8D17794CE3273D70(&Local_420);
					func_11();
					func_101(0, 1);
		...
		bVar81 = unk_0x8A22C4C08282BF26(joaat("context_controller")) > 0;
		if (!bVar81)
		{
		}
		if (((((((((((((iLocal_250 == 0 || iLocal_250 == 1) || iLocal_250 == 3) || iLocal_250 == 8) || iLocal_250 == 9) || iLocal_250 == 7) && func_84(uLocal_240, unk_0x16F2683693E537C9(), 1) < 5f) && bLocal_436 == 1) && !unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 1)) && iVar30 == 0) && bLocal_439 == 1) && !Global_3) && func_7()) && bVar81)
		{
			if (iLocal_298 == -1)
			{
			...
			if (func_4(iLocal_298, 1))
			{
				...
				if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
				{
					unk_0xCAC78D14D05349E7(unk_0x16F2683693E537C9(), 1);
				}
				func_91();
				func_101(1, 1);
				iVar30 = 1;
	...
	while (true)
	{
		...
		if (unk_0xB87D13D0C064E9D1(uLocal_240, unk_0x16F2683693E537C9(), 1) && !bVar83)
		{
			unk_0x11AD11297DC58CC7(uLocal_240, 0);
			unk_0xA3BF0AA5A2608191(uLocal_240);
			unk_0xF3268524E9BE6D6E(uLocal_240, unk_0x16F2683693E537C9(), 100f, -1, 0, 0);
			unk_0xFADC0A217229F6B5(uLocal_240, 1);
			bVar83 = true;
		}
		if ((unk_0x03068588A1FCED1A(uLocal_240) && func_84(uLocal_240, unk_0x16F2683693E537C9(), 1) > 50f) && !unk_0x338D6FF72D84D90F())
		{
			func_115(1);
		}
		unk_0x4EDE34FBADD967A6(0);
...
{
	func_9();
	if (func_102(uLocal_240) && func_102(unk_0x16F2683693E537C9()))
	{
		unk_0x11AD11297DC58CC7(uLocal_240, 0);
		unk_0x01E4BB5190DF7317(uLocal_240, 1193033728, 0);
		unk_0xFADC0A217229F6B5(uLocal_240, 1);
	}
}
...
void func_30()
{
	iLocal_254 = unk_0x09AC81E49EA267F7(0, uLocal_253);
}
...
void func_54()
{
	...
	Local_372 = { Local_388 };
	func_56(&Local_356);
	unk_0xC6EB89C59F2AF6B8(uLocal_240, &Local_388, &Var8, 1000f, -8f, -1, 0, 0, 0, 0, 0);
	unk_0xF895E10BF4C72645(uLocal_240, 0, 0);
...
int func_62()
{
	if (unk_0xD1960163A3042274(uLocal_240, -2017877118) != 1 && unk_0xD1960163A3042274(uLocal_240, -2017877118) != 0)
	{
		return 0;
	}
	return 1;
			...
			if (unk_0xC844350D5D58C99A(*uParam1))
			{
				if (!unk_0xEB6A8945D1AC98A1(*uParam1))
				{
					*uParam0 = func_81(*uParam1, bParam2, 145);
					if (bParam2 == 0)
					{
						unk_0x2A065371C9D96655(*uParam0, 7);
					}
...
int func_82(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x516E63E474722206(uVar0, func_83(unk_0x8CD06866876216F2(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x516E63E474722206(uVar0, func_83(unk_0x8CD06866876216F2(), 0.7f, 0.7f));
		unk_0x321E019A46034F39(uVar0, bParam1);
	}
...
int func_85(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_87(unk_0x68F4C0EC296D3901(uParam1, 1) - unk_0x68F4C0EC296D3901(uParam0, 1)) };
	...
	if (iParam3 == 0)
	{
		Var3 = { unk_0x08D89CE2E20AE305(uParam0) };
	}
	else
	{
		Var3 = { func_87(unk_0x64430C979F516F7A(uParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_88(var uParam0)
{
	...
	unk_0xCAE036C45E7FC720(uParam0, &uVar0, 1);
	return uVar0;
}
...
void func_101(int iParam0, bool bParam1)
{
	...
	{
		unk_0xC6EB89C59F2AF6B8(uLocal_240, &cLocal_324, &Local_218, 1000f, 1000f, -1, 0, 0, 0, 0, 0);
	}
	Local_356 = { Local_218 };
	if (bParam1)
	{
		if (!unk_0xEB6A8945D1AC98A1(uLocal_240) && !unk_0x28072FDD60CE3A6E(uLocal_240, 1))
		{
			unk_0xF895E10BF4C72645(uLocal_240, 0, 0);
		}
	}
...
int func_106()
{
	if (unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[58 /*6*/], 0) && !unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[58 /*6*/], 3))
	{
		return 1;
	}
	return 0;
...
int func_111()
{
	if (unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[60 /*6*/], 0) && !unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[60 /*6*/], 3))
	{
		return 0;
	}
	if (unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[61 /*6*/], 0) && !unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[61 /*6*/], 3))
	{
		return 0;
	}
	if (unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[62 /*6*/], 3))
	{
		return 0;
	}
	if ((unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[58 /*6*/], 2) || unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[59 /*6*/], 2)) || unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[62 /*6*/], 2))
	{
		return 1;
	}
	return 0;
...
{
	return func_113(Global_111638.f_20112, uParam0);
}
...
void func_115(int iParam0)
{
	...
	if (iLocal_241)
	{
		...
		if (iParam0 == 1)
		{
			unk_0xEBA53F35D0085654(&uLocal_240);
		}
		else
		{
			unk_0x6DAD7906B73F064D(&uLocal_240);
		}
		iLocal_241 = 0;
	}
...
void func_120()
{
	if (iLocal_245 == -1)
	{
		iLocal_245 = unk_0x544B74C043CE9948(Local_242, 2f, 2f, 2f, 0f, 0, 1);
	}
}
