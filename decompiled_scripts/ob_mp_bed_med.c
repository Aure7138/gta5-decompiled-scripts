...
void __EntryFunction__()
{
	...
	if ((unk_0xED06FD5709A59F02(18) || func_83()) || Global_2540612.f_1913)
	{
		func_82();
	}
	...
	while (true)
	{
		...
		if ((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && (!unk_0x9CC4D06F5338CA6B() || func_73() == 5)) && !func_61())
		{
			if (unk_0x272784C60C397DB6(Local_338, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), 1) < 3f)
			{
				switch (iLocal_326)
				{
					case 0:
					...
					case 1:
						...
						{
							func_2();
							if (unk_0xCE990E643CD9D0E5(uLocal_325, 0))
							{
								func_1();
							}
						}
			...
			else if (unk_0x272784C60C397DB6(Local_338, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), 1) > 6f)
			{
				func_82();
			}
		}
...
void func_1()
{
	uLocal_332 = unk_0xAB6BAF5BFCAFB141(uLocal_331);
	switch (iLocal_327)
	{
		case 0:
			break;
...
void func_2()
{
	...
	switch (iLocal_327)
	{
		case 0:
			...
			if (func_73() == 5)
			{
				unk_0xD2459066EA58CE43(&uLocal_325, 0);
				if (unk_0xA860C15A1C027CBB() == 4)
				{
					iLocal_330 = 1;
				}
				uLocal_331 = unk_0xAA579EC5104BFDA9(Local_348, Local_351, 2, 0, 1, 1065353216, 0, 1065353216);
				unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), uLocal_331, sLocal_334, sLocal_336, 8f, -2f, 261, 0, 1148846080, 0);
				unk_0xB88AF19828BF16ED(uLocal_331);
				iLocal_327 = 7;
			}
			else if (func_54(9))
			{
				if ((((func_50(Local_338, Var0) && unk_0x518D695E2DBA9DB8(unk_0x9B0761B4C3EB8BC7()) == unk_0xD5C5CDCF5230F2BA(Local_338)) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_342, Local_345, 2f, 0, 1, 0)) && func_49()) && !func_46(unk_0x460153A63B9477BC()))
				{
					if (iLocal_333 == -1)
					{
		...
		case 1:
			Local_354 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0) };
			if (func_44(1, 0, 1))
			{
				if ((((((func_50(Local_338, Var0) && Local_354.f_2 < (Local_338.f_2 + 1f)) && func_54(9)) && unk_0x518D695E2DBA9DB8(unk_0x9B0761B4C3EB8BC7()) == unk_0xD5C5CDCF5230F2BA(Local_338)) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_342, Local_345, 2f, 0, 1, 0)) && func_49()) && !func_46(unk_0x460153A63B9477BC()))
				{
					if (func_42(iLocal_333, 1))
					{
						...
						func_37();
						unk_0x801B883D25479F23(Local_338, 3f, 0);
						Global_1573337 = 9;
						func_27(unk_0x460153A63B9477BC(), 0, 256, 0);
						iLocal_36 = 1;
						unk_0x69C71C91F56D82B9(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_unarmed"), 1);
						func_17(1, 1, 1, 0, 0, 0, 0);
						Local_338 = { unk_0xD7D25254A712E758(sLocal_334, sLocal_335, Local_348, Local_351, 0, 2) };
						Var3 = { unk_0xD78F5800B90C4843(sLocal_334, sLocal_335, Local_348, Local_351, 0, 2) };
						fLocal_341 = Var3.f_2;
						unk_0x83CAF206A9B8748C(unk_0x9B0761B4C3EB8BC7(), Local_338, 1f, 5000, fLocal_341, 0.05f);
						if (unk_0xA860C15A1C027CBB() == 4 && unk_0xAE06B9E39EBDE049(iLocal_41))
						{
							unk_0x607CF0A249FABFDC(unk_0x9B0761B4C3EB8BC7(), func_16(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(iLocal_41, 1)));
							unk_0x854FB153F2EA838B(unk_0x9B0761B4C3EB8BC7(), joaat("MotionState_Aiming"), 0, 0, 0);
							unk_0x8342E6CB98CD545C(unk_0x9B0761B4C3EB8BC7(), 69, 1);
						}
						iLocal_327 = 2;
					}
				}
		...
		case 2:
			...
			{
				unk_0xD2459066EA58CE43(&uLocal_325, 0);
				uLocal_331 = unk_0xAA579EC5104BFDA9(Local_348, Local_351, 2, 0, 0, 1065353216, 0, 1065353216);
				unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), uLocal_331, sLocal_334, sLocal_335, 4f, -2f, 261, 0, 1148846080, 0);
				unk_0xB88AF19828BF16ED(uLocal_331);
				if (unk_0xA860C15A1C027CBB() == 4)
				{
					iLocal_330 = 1;
		...
		case 3:
			...
			if (unk_0xFC5D6FB6EECB392F(uLocal_332))
			{
				unk_0xBE20AB8238688965(&uLocal_325, 0);
				iLocal_327 = 4;
			}
			break;
		...
		case 4:
			...
			if (unk_0x369E69441C066912(uLocal_332) > 0.9f)
			{
				unk_0xD2459066EA58CE43(&uLocal_325, 0);
				uLocal_331 = unk_0xAA579EC5104BFDA9(Local_348, Local_351, 2, 0, 1, 1065353216, 0, 1065353216);
				unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), uLocal_331, sLocal_334, sLocal_336, 8f, -2f, 261, 0, 1148846080, 0);
		...
		case 5:
			...
			{
				unk_0xBE20AB8238688965(&uLocal_325, 0);
				unk_0x81493F39713559B1(uLocal_332, 1);
		...
		case 6:
			...
			if (!func_46(unk_0x460153A63B9477BC()) && unk_0x1BD7199394D7F19A(2, 222))
			{
				if (func_38("SA_BED_OUT"))
				{
					unk_0xD289B55B6AADBA10(1);
				...
				unk_0xD2459066EA58CE43(&uLocal_325, 0);
				uLocal_331 = unk_0xAA579EC5104BFDA9(Local_348, Local_351, 2, 0, 0, 1065353216, 0, 1065353216);
				unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), uLocal_331, sLocal_334, sLocal_337, 2f, -2f, 261, 0, 1148846080, 0);
				unk_0xB88AF19828BF16ED(uLocal_331);
				iLocal_327 = 8;
			}
			break;
		...
		case 7:
			if ((!func_8() && unk_0xEF928B5F0219FDF7(unk_0xD5C5CDCF5230F2BA(Local_338))) && iLocal_330 == 1)
			{
				unk_0xA64AAA3B56078D4C();
			}
			if (((unk_0xEF928B5F0219FDF7(unk_0xD5C5CDCF5230F2BA(Local_338)) && !func_8()) && !func_6()) && Global_1312485.f_8 == 0)
			{
				bLocal_329 = true;
				unk_0xD2459066EA58CE43(&uLocal_325, 0);
				uLocal_331 = unk_0xAA579EC5104BFDA9(Local_348, Local_351, 2, 0, 0, 1065353216, 0, 1065353216);
				unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), uLocal_331, sLocal_334, sLocal_337, 1000f, -2f, 261, 0, 1148846080, 0);
				unk_0xB88AF19828BF16ED(uLocal_331);
				iLocal_327 = 8;
			}
			break;
		...
		case 9:
			...
			if (!unk_0xFC5D6FB6EECB392F(uLocal_332))
			{
				...
				if (iLocal_36)
				{
					func_27(unk_0x460153A63B9477BC(), 1, 0, 0);
					iLocal_36 = 0;
				}
				func_3(0);
...
void func_3(int iParam0)
{
	...
	if (unk_0x25DDB354A40FFCDB())
	{
		Global_2409291.f_3 = unk_0x6CAAB7E78B5D978A();
	}
}
...
void func_17(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (unk_0x25DDB354A40FFCDB())
		{
			if (((((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_22(unk_0x460153A63B9477BC())) && !func_19(unk_0x460153A63B9477BC(), 0)) && !func_18()) && !bParam4) && !bParam5)
			{
				unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), 0);
			}
		}
		else if (((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_22(unk_0x460153A63B9477BC())) && !bParam4) && !bParam5)
		{
			unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), 0);
		}
		Global_76831 = 0;
	...
	else
	{
		...
		if (unk_0x166E920FB00B2DBB(iParam0) && (unk_0x5A228A6A51E757C8(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_19(unk_0x460153A63B9477BC(), 0) && !func_23()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_31(uVar27) && !unk_0xEB1D872D96DDA8E2(uVar27))
				{
					if (!bVar22)
					{
...
void func_32(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		...
		if (func_19(unk_0x460153A63B9477BC(), 0))
		{
...
{
	return unk_0xCE990E643CD9D0E5(Global_1377236.f_241.f_136[func_48(9) /*33*/][iParam0], func_47(9));
}
...
int func_49()
{
	...
	iVar9 = unk_0x3214CDFE45D11916(unk_0x9B0761B4C3EB8BC7(), &uVar0, -1);
	if (iVar9 > 0)
	{
		iVar10 = 0;
		while (iVar10 <= 7)
		{
			if (!unk_0x5AEB5DDFFAD43CA5(uVar0[iVar10]))
			{
				if (unk_0x1037B9D45CE6B788(uVar0[iVar10], Local_342, Local_345, 2f, 0, 1, 0))
				{
					return 0;
				}
			}
...
int func_50(struct<3> Param0, float fParam3, var uParam4, var uParam5)
{
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		if ((!unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) && !unk_0x0922C2E075A5F18C(unk_0x9B0761B4C3EB8BC7())) && unk_0x4DC4117F94CD5B84(unk_0x460153A63B9477BC()))
		{
			...
			{
				if ((((unk_0xC337F69A1938DDA2() && !unk_0x3EBB66F936A3436E()) && !unk_0xF41C1CE0EE0A23A8()) && !func_43(0)) && !func_53())
				{
					if ((Global_95883 && Global_95884) || func_52())
					{
						return 0;
					}
					if (func_51(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Param0, fParam3, 0))
					{
						return 1;
					}
				}
...
{
	if ((((((unk_0xCE990E643CD9D0E5(Global_1573336, iParam0) || Global_1573337 != -1) || func_59()) || unk_0xF283063436CFEA72(unk_0x460153A63B9477BC())) || unk_0x8B1FF66E0C62B7AE(unk_0x460153A63B9477BC())) || func_58()) || func_55(iParam0))
	{
		return 0;
	}
	return 1;
...
int func_60()
{
	unk_0x131ED02492676000(sLocal_334);
	if (!unk_0xC614DDE265D18415(sLocal_334))
	{
		return 0;
	}
	iLocal_328 = 1;
...
void func_82()
{
	...
	func_4();
	if (!func_22(unk_0x460153A63B9477BC()) && !unk_0xE9159DB182CF0841())
	{
		func_27(unk_0x460153A63B9477BC(), 1, 0, 0);
	}
	func_76();
