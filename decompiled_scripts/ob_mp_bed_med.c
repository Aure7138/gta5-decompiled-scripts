...
void __EntryFunction__()
{
	...
	if ((unk_0x4210287E2833D44B(18) || func_87()) || Global_2544210.f_1916)
	{
		func_86();
	}
	...
	while (true)
	{
		...
		if ((!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()) && (!unk_0xF471787D45ADC2C1() || func_77() == 5)) && !func_65())
		{
			if (unk_0x0BABEFEA577FCFA4(Local_338, unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 0), 1) < 3f)
			{
				switch (iLocal_326)
				{
					case 0:
					...
					case 1:
						...
						{
							func_2();
							if (unk_0x234B68AC2E35ED5A(uLocal_325, 0))
							{
								func_1();
							}
						}
			...
			else if (unk_0x0BABEFEA577FCFA4(Local_338, unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 0), 1) > 6f)
			{
				func_86();
			}
		}
...
void func_1()
{
	uLocal_332 = unk_0x51FB94D5F3D17E35(uLocal_331);
	switch (iLocal_327)
	{
		case 0:
			break;
...
void func_2()
{
	...
	switch (iLocal_327)
	{
		case 0:
			...
			if (func_77() == 5)
			{
				unk_0xC664C0067EEAB8D1(&uLocal_325, 0);
				if (unk_0xC7E4E71866B09979() == 4)
				{
					iLocal_330 = 1;
				}
				uLocal_331 = unk_0x88A92D91AB021F3F(Local_348, Local_351, 2, 0, 1, 1065353216, 0, 1065353216);
				unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), uLocal_331, sLocal_334, sLocal_336, 8f, -2f, 261, 0, 1148846080, 0);
				unk_0x20F6F12F2945E30E(uLocal_331);
				iLocal_327 = 7;
			}
			else if (func_54(9))
			{
				if ((((func_50(Local_338, Var0) && unk_0xB71084333B418824(unk_0x7D2B9E6A64637269()) == unk_0xDE7E9AF51E2E18EB(Local_338)) && unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_342, Local_345, 2f, 0, 1, 0)) && func_49()) && !func_46(unk_0x1146A9AE09CE2B14()))
				{
					if (iLocal_333 == -1)
					{
		...
		case 1:
			Local_354 = { unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 0) };
			if (func_44(1, 0, 1))
			{
				if ((((((func_50(Local_338, Var0) && Local_354.f_2 < (Local_338.f_2 + 1f)) && func_54(9)) && unk_0xB71084333B418824(unk_0x7D2B9E6A64637269()) == unk_0xDE7E9AF51E2E18EB(Local_338)) && unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_342, Local_345, 2f, 0, 1, 0)) && func_49()) && !func_46(unk_0x1146A9AE09CE2B14()))
				{
					if (func_42(iLocal_333, 1))
					{
						...
						func_37();
						unk_0xAA464864BA733E26(Local_338, 3f, 0);
						Global_1573341 = 9;
						func_27(unk_0x1146A9AE09CE2B14(), 0, 256, 0);
						iLocal_36 = 1;
						unk_0x2FF622571073AA69(unk_0x7D2B9E6A64637269(), joaat("weapon_unarmed"), 1);
						func_17(1, 1, 1, 0, 0, 0, 0);
						Local_338 = { unk_0xBF480D363C51CDF8(sLocal_334, sLocal_335, Local_348, Local_351, 0, 2) };
						Var3 = { unk_0x04F690ADA8C71424(sLocal_334, sLocal_335, Local_348, Local_351, 0, 2) };
						fLocal_341 = Var3.f_2;
						unk_0x28A5BAF912B4E14D(unk_0x7D2B9E6A64637269(), Local_338, 1f, 5000, fLocal_341, 0.05f);
						if (unk_0xC7E4E71866B09979() == 4 && unk_0x419E13582192CFEA(iLocal_41))
						{
							unk_0xB8446EB9A449F64A(unk_0x7D2B9E6A64637269(), func_16(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), unk_0xD6E677FAD7521410(iLocal_41, 1)));
							unk_0xEE90D1369E1800A2(unk_0x7D2B9E6A64637269(), joaat("MotionState_Aiming"), 0, 0, 0);
							unk_0xD991F7672CE8EAD3(unk_0x7D2B9E6A64637269(), 69, 1);
						}
						iLocal_327 = 2;
					}
				}
		...
		case 2:
			...
			{
				unk_0xC664C0067EEAB8D1(&uLocal_325, 0);
				uLocal_331 = unk_0x88A92D91AB021F3F(Local_348, Local_351, 2, 0, 0, 1065353216, 0, 1065353216);
				unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), uLocal_331, sLocal_334, sLocal_335, 4f, -2f, 261, 0, 1148846080, 0);
				unk_0x20F6F12F2945E30E(uLocal_331);
				if (unk_0xC7E4E71866B09979() == 4)
				{
					iLocal_330 = 1;
		...
		case 3:
			...
			if (unk_0xEEC203A73BC92E7E(uLocal_332))
			{
				unk_0x191DDA30577F440A(&uLocal_325, 0);
				iLocal_327 = 4;
			}
			break;
		...
		case 4:
			...
			if (unk_0x0BC8768247440B3A(uLocal_332) > 0.9f)
			{
				unk_0xC664C0067EEAB8D1(&uLocal_325, 0);
				uLocal_331 = unk_0x88A92D91AB021F3F(Local_348, Local_351, 2, 0, 1, 1065353216, 0, 1065353216);
				unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), uLocal_331, sLocal_334, sLocal_336, 8f, -2f, 261, 0, 1148846080, 0);
		...
		case 5:
			...
			{
				unk_0x191DDA30577F440A(&uLocal_325, 0);
				unk_0xB9314D20143CEED3(uLocal_332, 1);
		...
		case 6:
			...
			if (!func_46(unk_0x1146A9AE09CE2B14()) && unk_0x86AF801D34E482FF(2, 222))
			{
				if (func_38("SA_BED_OUT"))
				{
					unk_0x66AE54CE92457FEE(1);
				...
				unk_0xC664C0067EEAB8D1(&uLocal_325, 0);
				uLocal_331 = unk_0x88A92D91AB021F3F(Local_348, Local_351, 2, 0, 0, 1065353216, 0, 1065353216);
				unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), uLocal_331, sLocal_334, sLocal_337, 2f, -2f, 261, 0, 1148846080, 0);
				unk_0x20F6F12F2945E30E(uLocal_331);
				iLocal_327 = 8;
			}
			break;
		...
		case 7:
			if ((!func_8() && unk_0xC4EACCE45DBAA313(unk_0xDE7E9AF51E2E18EB(Local_338))) && iLocal_330 == 1)
			{
				unk_0x4A70C67E8FD1FB85();
			}
			if (((unk_0xC4EACCE45DBAA313(unk_0xDE7E9AF51E2E18EB(Local_338)) && !func_8()) && !func_6()) && Global_1312485.f_8 == 0)
			{
				bLocal_329 = true;
				unk_0xC664C0067EEAB8D1(&uLocal_325, 0);
				uLocal_331 = unk_0x88A92D91AB021F3F(Local_348, Local_351, 2, 0, 0, 1065353216, 0, 1065353216);
				unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), uLocal_331, sLocal_334, sLocal_337, 1000f, -2f, 261, 0, 1148846080, 0);
				unk_0x20F6F12F2945E30E(uLocal_331);
				iLocal_327 = 8;
			}
			break;
		...
		case 9:
			...
			if (!unk_0xEEC203A73BC92E7E(uLocal_332))
			{
				...
				if (iLocal_36)
				{
					func_27(unk_0x1146A9AE09CE2B14(), 1, 0, 0);
					iLocal_36 = 0;
				}
				func_3(0);
...
{
	if (!Global_2409299 == iParam0)
	{
		Global_2409299.f_1 = 0;
	}
	Global_2409299 = iParam0;
	if (unk_0x02BFF15CAA701972())
	{
		Global_2409299.f_3 = unk_0x551F46B3C7DFB654();
	}
}
...
void func_17(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (unk_0x02BFF15CAA701972())
		{
			if (((((!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()) && !func_22(unk_0x1146A9AE09CE2B14())) && !func_19(unk_0x1146A9AE09CE2B14(), 0)) && !func_18()) && !bParam4) && !bParam5)
			{
				unk_0x8F160110753EB17B(unk_0x7D2B9E6A64637269(), 0);
			}
		}
		else if (((!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()) && !func_22(unk_0x1146A9AE09CE2B14())) && !bParam4) && !bParam5)
		{
			unk_0x8F160110753EB17B(unk_0x7D2B9E6A64637269(), 0);
		}
		Global_77246 = 0;
	...
	else
	{
		...
		if (unk_0x8CFC2F41A749E236(iParam0) && (unk_0xCAD1755E530A6012(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_19(unk_0x1146A9AE09CE2B14(), 0) && !func_23()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_31(uVar27) && !unk_0x0D5E478A215B3F4A(uVar27))
				{
					if (!bVar22)
					{
			...
			else
			{
				if (!func_31(uVar27) && !unk_0x0D5E478A215B3F4A(uVar27))
				{
					...
					if (func_28(Global_4456448.f_133963))
					{
...
void func_32(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		...
		if (func_19(unk_0x1146A9AE09CE2B14(), 0))
		{
...
{
	return unk_0x234B68AC2E35ED5A(Global_1379108.f_241.f_136[func_48(9) /*33*/][iParam0], func_47(9));
}
...
int func_49()
{
	...
	iVar9 = unk_0x65C60F47A52ECB92(unk_0x7D2B9E6A64637269(), &uVar0, -1);
	if (iVar9 > 0)
	{
		iVar10 = 0;
		while (iVar10 <= 7)
		{
			if (!unk_0xECEC7528A52B4EE8(uVar0[iVar10]))
			{
				if (unk_0x8954E9D0A9F6F8CF(uVar0[iVar10], Local_342, Local_345, 2f, 0, 1, 0))
				{
					return 0;
				}
			}
...
int func_50(struct<3> Param0, float fParam3, var uParam4, var uParam5)
{
	if (unk_0xCAD1755E530A6012(unk_0x1146A9AE09CE2B14()))
	{
		if ((!unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0) && !unk_0x2AB8EC6521549BAD(unk_0x7D2B9E6A64637269())) && unk_0xDF02DA324F934755(unk_0x1146A9AE09CE2B14()))
		{
			...
			{
				if ((((unk_0xB90EB35E662F9812() && !unk_0x2CA4B93E310C1860()) && !unk_0x790D618D34F7307C()) && !func_43(0)) && !func_53())
				{
					if ((Global_96298 && Global_96299) || func_52())
					{
						return 0;
					}
					if (func_51(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Param0, fParam3, 0))
					{
						return 1;
					}
				}
...
{
	if ((((((unk_0x234B68AC2E35ED5A(Global_1573340, iParam0) || Global_1573341 != -1) || func_63()) || unk_0xB590A8673D04F7DA(unk_0x1146A9AE09CE2B14())) || unk_0xAE07F5C5D7B878C1(unk_0x1146A9AE09CE2B14())) || func_62()) || func_59(iParam0))
	{
		return 0;
	}
	if (func_55(unk_0x1146A9AE09CE2B14()) == 4)
	{
		return 0;
	}
	return 1;
...
int func_64()
{
	unk_0x068BDE31F7D112BB(sLocal_334);
	if (!unk_0x0EC2B29D4172D225(sLocal_334))
	{
		return 0;
	}
	iLocal_328 = 1;
...
int func_65()
{
	...
	if (func_66() != 0)
	{
		if (unk_0x636F1F53CC61D2C9(func_66()) == 0)
		{
			return 1;
		}
	}
...
void func_86()
{
	...
	if (iLocal_328)
	{
		unk_0xF9135F131C423364(sLocal_334);
	}
	func_4();
	if (!func_22(unk_0x1146A9AE09CE2B14()) && !unk_0xCE84F8AB9BD41C13())
	{
		func_27(unk_0x1146A9AE09CE2B14(), 1, 0, 0);
	}
	func_80();
