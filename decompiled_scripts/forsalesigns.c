...
void __EntryFunction__()
{
	...
	if (unk_0x7B70881748D166CD(joaat("forsalesigns")) > 1)
	{
...
void func_1()
{
	...
	if (iLocal_42)
	{
		if (func_52(uLocal_44))
		{
			if ((((!func_51() && !unk_0xA26A1295C5145A11(uLocal_44)) && !unk_0xCED6B5226244381C(uLocal_44)) && !unk_0x78F9A93AC3E99CD8(uLocal_44)) && !unk_0x5AEB5DDFFAD43CA5(uLocal_44))
			{
				if (func_50(uLocal_44, unk_0x9B0761B4C3EB8BC7(), 1) <= 3f)
				{
					if ((unk_0x578C4EF320340AF7() - iLocal_43) > 8000)
					{
			...
			if (func_50(uLocal_44, unk_0x9B0761B4C3EB8BC7(), 1) > 150f)
			{
				func_26(&uLocal_44);
			}
		}
	...
	while (iVar0 < 15)
	{
		if (unk_0xAE06B9E39EBDE049(Local_210[iVar0 /*11*/]))
		{
			if (unk_0x4E3A4DABBC3BA0D5(Local_210[iVar0 /*11*/], 0) || func_24(Local_210[iVar0 /*11*/]))
			{
				unk_0xBE20AB8238688965(&(Global_111858.f_10045.f_108), iVar0);
				func_21(iVar0);
				unk_0x95178967C65CAD85(&(Local_210[iVar0 /*11*/]));
				bLocal_39 = true;
				func_20(1, 0);
				func_18();
			}
		...
		else if (!unk_0xCE990E643CD9D0E5(Global_111858.f_10045.f_108, iVar0))
		{
...
int func_2(int iParam0)
{
	...
	else
	{
		...
		{
			if (!unk_0xCE990E643CD9D0E5(Global_111858.f_10045.f_108, func_3(func_4(iParam0), iVar0)))
			{
				return 0;
			}
			iVar0++;
...
int func_5(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (unk_0xCE990E643CD9D0E5(Global_111858.f_10045.f_108, func_3(func_4(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
	...
	if (bLocal_39)
	{
		switch (iLocal_40)
		{
			case 0:
				...
				{
					uLocal_41 = unk_0x5DEA4192B46CB99B("MIDSIZED_MESSAGE");
					if (unk_0x95EF219D38B20CFF(uLocal_41))
					{
						uVar0 = unk_0x5E54B0823F46079E();
						unk_0xC4CC25B68A91D144(uVar0, "SIGN_DESTROYED", "HUD_AWARDS", 1);
						iLocal_40++;
					}
				}
				break;
			...
			case 1:
				unk_0x830F007E19C63E14(uLocal_41, "SHOW_SHARD_MIDSIZED_MESSAGE");
				unk_0xB23270F3D5E62FDE("FS_TITLE");
				unk_0x2042E9CA4306F725();
				unk_0xB23270F3D5E62FDE("FS_DESTROY");
				unk_0x42710E9E08FA375A(func_5(2));
				unk_0x2042E9CA4306F725();
			...
			case 2:
				...
				{
					unk_0x830F007E19C63E14(uLocal_41, "SHARD_ANIM_OUT");
				...
				else if (!func_12())
				{
					if (unk_0x95EF219D38B20CFF(uLocal_41))
					{
						unk_0x37FC7E88C7659D33(uLocal_41, 100, 100, 100, 255, 0);
					}
				}
				break;
			...
			case 4:
				if (unk_0x95EF219D38B20CFF(uLocal_41))
				{
					unk_0x2E352DDBBF674246(&uLocal_41);
				}
				bLocal_376 = false;
				bLocal_39 = false;
				iLocal_40 = 0;
...
void func_13(var uParam0, int iParam1, bool bParam2, float fParam3)
{
	...
	{
		if (func_15(unk_0x9B0761B4C3EB8BC7(), uParam0->f_3, fParam3) && !unk_0xAE06B9E39EBDE049(*uParam0))
		{
			...
			*uParam0 = unk_0x79CC07752E7432A1(iParam1, uParam0->f_3, 1, 1, 0);
			uParam0->f_10 = 1;
...
void func_16(var uParam0, var uParam1)
{
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(*uParam0, 1), 1) >= 110f && !unk_0xA38BFCB05DBE439D(*uParam0))
		{
			func_17(uParam0);
			*uParam1 = 0;
		}
...
int func_24(var uParam0)
{
	...
	Var0 = { unk_0x090239DEAF625B17(uParam0, 0) };
...
int func_30()
{
	...
	if (unk_0x460153A63B9477BC() == func_33())
	{
		return 0;
	}
...
float func_50(var uParam0, var uParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_54()
{
	...
	if (func_52(unk_0x9B0761B4C3EB8BC7()))
	{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (unk_0x36FE6D3220816ADA(uVar2[iVar1]) == func_56(58))
			{
				uLocal_44 = uVar2[iVar1];
				if (!unk_0x1758275D343D5BA3(uLocal_44))
				{
					unk_0x4F3C4F457D44BB0F(uLocal_44, 1, 0);
				}
				unk_0x055A73D4AFD214F1(uLocal_44, 0);
				unk_0x0DC39BE87E4C5599(uLocal_44, 0);
				unk_0x14EFF93E9B692DAD(uLocal_44, "POSTJOSH");
				unk_0xD3D9D7C84656DAE5(uLocal_44, joaat("player"));
				func_55(&uLocal_45, 5, uLocal_44, "JOSH", 1, 1);
				return 1;
			}
		}
		iVar1++;
...
void func_55(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_59()
{
	...
	unk_0x74528AC0906CBABE(iLocal_38);
...
void func_68()
{
	...
	{
		func_70(13, unk_0xF34EE736CF047844(Global_111858.f_10190.f_3853));
	}
	if (!unk_0xC4A02490EB1F450B())
	{
		if (!Global_76833)
		{
			if (func_69() == 2 == 0 && !unk_0x25DDB354A40FFCDB())
			{
