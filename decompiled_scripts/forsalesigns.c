...
void __EntryFunction__()
{
	...
	if (unk_0xA96867DD0A63C62C(joaat("forsalesigns")) > 1)
	{
...
void func_1()
{
	...
	if (iLocal_42)
	{
		...
		{
			if ((((!func_45() && !unk_0x9337892D1C5EA0F0(uLocal_44)) && !unk_0xFFE4F37124DBE6D9(uLocal_44)) && !unk_0x21F498AB53003A3E(uLocal_44)) && !unk_0xEB361B4BD195A4D3(uLocal_44))
			{
				if (func_44(uLocal_44, unk_0xA0081090911D13E5(), 1) <= 3f)
				{
					if ((unk_0xDF658EB6CA91DFBC() - iLocal_43) > 8000)
					{
			...
			if (func_44(uLocal_44, unk_0xA0081090911D13E5(), 1) > 150f)
			{
				func_26(&uLocal_44);
			}
		}
	...
	while (iVar0 < 15)
	{
		if (unk_0xD3FACCDA4D66AEAD(Local_210[iVar0 /*11*/]))
		{
			if (unk_0xD9890AC57C9BDC10(Local_210[iVar0 /*11*/]) || func_24(Local_210[iVar0 /*11*/]))
			{
				unk_0x88B0F0DC270164B7(&(Global_101553.f_8904.f_108), iVar0);
				func_21(iVar0);
				unk_0xDABCA6C17F8B4208(&(Local_210[iVar0 /*11*/]));
				bLocal_39 = true;
				func_20(1, 0);
				func_18();
			}
		...
		else if (!unk_0x08BA6DD398CA197C(Global_101553.f_8904.f_108, iVar0))
		{
...
int func_2(int iParam0)
{
	...
	else
	{
		...
		{
			if (!unk_0x08BA6DD398CA197C(Global_101553.f_8904.f_108, func_3(func_4(iParam0), iVar0)))
			{
				return 0;
			}
			iVar0++;
...
int func_5(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (unk_0x08BA6DD398CA197C(Global_101553.f_8904.f_108, func_3(func_4(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
	...
	if (bLocal_39)
	{
		switch (iLocal_40)
		{
			case 0:
				...
				{
					uLocal_41 = unk_0x474309DF4921072A("MIDSIZED_MESSAGE");
					if (unk_0x1E3F61C2C1E29520(uLocal_41))
					{
						uVar0 = unk_0x2657E29E0DD8087E();
						unk_0xAB16AADE80707D47(uVar0, "SIGN_DESTROYED", "HUD_AWARDS", 1);
						iLocal_40++;
					}
				}
				break;
			...
			case 1:
				unk_0xB9D4F4DE7E7EC038(uLocal_41, "SHOW_SHARD_MIDSIZED_MESSAGE");
				unk_0x709662CF2BD061A4("FS_TITLE");
				unk_0x1E77BE8F4283FA05();
				unk_0x709662CF2BD061A4("FS_DESTROY");
				unk_0x3F9D1B882EC0B8AF(func_5(2));
				unk_0x1E77BE8F4283FA05();
			...
			case 2:
				...
				{
					unk_0xB9D4F4DE7E7EC038(uLocal_41, "SHARD_ANIM_OUT");
				...
				else if (!func_12())
				{
					if (unk_0x1E3F61C2C1E29520(uLocal_41))
					{
						unk_0x0F83039847376F53(uLocal_41, 100, 100, 100, 255, 0);
					}
				}
				break;
			...
			case 4:
				if (unk_0x1E3F61C2C1E29520(uLocal_41))
				{
					unk_0xA12A0D38735CCBF2(&uLocal_41);
				}
				bLocal_376 = false;
				bLocal_39 = false;
				iLocal_40 = 0;
...
void func_13(var uParam0, int iParam1, bool bParam2, float fParam3)
{
	...
	{
		if (func_15(unk_0xA0081090911D13E5(), uParam0->f_3, fParam3) && !unk_0xD3FACCDA4D66AEAD(*uParam0))
		{
			unk_0x491067A8E906F22D(iParam1);
			while (!unk_0x2C1B5A0D3E233FC3(iParam1))
			{
				unk_0x491067A8E906F22D(iParam1);
				unk_0x4EDE34FBADD967A6(0);
			}
			...
			*uParam0 = unk_0xE1C25770C2FB7AE3(iParam1, uParam0->f_3, 1, 1, 0);
			uParam0->f_10 = 1;
...
bool func_15(var uParam0, struct<3> Param1, float fParam4)
{
...
void func_16(var uParam0, var uParam1)
{
	if (!unk_0xEB361B4BD195A4D3(unk_0xA0081090911D13E5()))
	{
		if (unk_0x999A157665D69393(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), unk_0xC59DF10B4FC39DF8(*uParam0, 1), 1) >= 110f && !unk_0x7DB334F5F834726A(*uParam0))
		{
			func_17(uParam0);
			*uParam1 = 0;
		}
...
int func_24(var uParam0)
{
	...
	Var0 = { unk_0x3A02D44277FBA4BE(uParam0, 0) };
...
void func_35()
{
	...
	if (unk_0xD3FACCDA4D66AEAD(unk_0xA0081090911D13E5()))
	{
		if (func_38(Global_101553.f_1991.f_539.f_3549) != unk_0x705BC1BB91F530B5(unk_0xA0081090911D13E5()))
		{
			...
			if (func_36(iVar0) && (!func_39(14) || Global_100505))
			{
...
int func_48()
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (unk_0x705BC1BB91F530B5(uVar2[iVar1]) == func_50(58))
			{
				uLocal_44 = uVar2[iVar1];
				if (!unk_0x18C670321BC98FDA(uLocal_44))
				{
					unk_0x7B17650F15A8876D(uLocal_44, 1, 0);
				}
				unk_0xFB4B028F94A31239(uLocal_44, 0);
				unk_0xB43604F27F1EAE5F(uLocal_44, 0);
				unk_0xDB721F9F36A8FE26(uLocal_44, "POSTJOSH");
				unk_0x65889F26F311FC55(uLocal_44, joaat("player"));
...
void func_53()
{
	...
	unk_0x2C07692AA3545079(iLocal_38);
...
void func_59(char* sParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		if (!unk_0xD28EDDD3F7264249(&(Global_101553.f_12996[iVar0 /*104*/])))
		{
			if (unk_0x28C1B9853548BD8E(&(Global_101553.f_12996[iVar0 /*104*/]), sParam0))
			{
				if (Global_101553.f_12996[iVar0 /*104*/].f_24 == 0)
				{
				}
				Global_101553.f_12996[iVar0 /*104*/].f_24 = 1;
				if (Global_101553.f_12996[iVar0 /*104*/].f_25 == 1)
				{
					if (Global_101553.f_12996[iVar0 /*104*/].f_99[0] == 1)
					{
						Global_101553.f_12906[0 /*20*/].f_17 = 0;
					}
					if (Global_101553.f_12996[iVar0 /*104*/].f_99[1] == 1)
					{
						Global_101553.f_12906[1 /*20*/].f_17 = 0;
					}
					if (Global_101553.f_12996[iVar0 /*104*/].f_99[2] == 1)
					{
					...
					Global_101553.f_12996[iVar0 /*104*/].f_25 = 0;
					if (iParam1 == 1)
					{
						Global_101553.f_12996[iVar0 /*104*/].f_27 = 1;
					}
				}
			}
		}
...
void func_62()
{
	...
	{
		func_64(13, unk_0xF34EE736CF047844(Global_101553.f_9049.f_3853));
	}
	if (!unk_0x426131BF5A0B35D2())
	{
		if (!Global_69617)
		{
			if (func_63() == 2 == 0 && !unk_0xA86CA03D9749EEB3())
			{
