...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (unk_0x0EB28750412C3A5A(Local_309, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0), 1) < 3f)
			{
				switch (iLocal_307)
				{
					case 0:
...
void func_1()
{
	...
	switch (iLocal_308)
	{
		case 0:
			...
			{
				if (unk_0xBFDF2644D7CBD7C5(unk_0x16F2683693E537C9(), Local_312, 90f) || iLocal_317)
				{
					func_32("TV_HLP0");
		...
		case 1:
			if (func_31(1, 0, 1))
			{
				if (func_35(Local_309, Var0) && unk_0xBF75E4DF4C367CD9(Local_309, 3f, joaat("prop_cs_remote_01"), 0))
				{
					if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
					{
						if ((!unk_0x85651FDAB8414096(unk_0xD803B885F5E47A62()) && !unk_0xBBFFD1937ED16008(unk_0xD803B885F5E47A62())) && unk_0x06F8112AA79C53D9(0, 51))
						{
							...
							unk_0x679C321F8CAA2CFA(Local_312, 3f, 0);
		...
		case 2:
			...
			uLocal_319 = unk_0xE9744DB7B8CA6965(Local_323, Local_326, 2);
			if (Global_30828[1 /*11*/].f_2)
			{
				unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), uLocal_319, sLocal_322, "enter_no_remote", 8f, -4f, 0, 0, 1148846080, 0);
				unk_0xE14EC663EED44AD5(func_18(), uLocal_319, "enter_no_remote_remote", sLocal_322, 8f, -4f, 0, 1148846080);
			}
			else
			{
				unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), uLocal_319, sLocal_322, "enter", 8f, -4f, 0, 0, 1148846080, 0);
				unk_0xE14EC663EED44AD5(func_18(), uLocal_319, "enter_remote", sLocal_322, 8f, -4f, 0, 1148846080);
			}
			if (unk_0xB818A4F8553577BC(uLocal_319))
			{
				unk_0xEFC3DF9D33E248D8(uLocal_319, 0);
			}
			if (unk_0x6C3F127AAF415E69() != 4)
			{
				uLocal_321 = unk_0x0D032838710EE57D("DEFAULT_ANIMATED_CAMERA", 1);
				if (Global_30828[1 /*11*/].f_2)
				{
					unk_0x93E9ED66DAB9FBE3(uLocal_321, uLocal_319, "enter_no_remote_cam", sLocal_322);
				}
				else
				{
					unk_0x93E9ED66DAB9FBE3(uLocal_321, uLocal_319, "enter_cam", sLocal_322);
				}
				unk_0x91F5B0244AAE6222(uLocal_321, "HAND_SHAKE", 0.2f);
		...
		case 3:
			...
			if (!Global_30828[1 /*11*/].f_2)
			{
				if (unk_0xA45992A6CE82FB43(uLocal_319) > 0.691f)
				{
					func_16();
					func_12(1, 0, 1, 0, 0);
				}
			}
			if (unk_0xA45992A6CE82FB43(uLocal_319) > 0.9f)
			{
				uLocal_319 = unk_0xE9744DB7B8CA6965(Local_323, Local_326, 2);
				unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), uLocal_319, sLocal_322, "base", 8f, -8f, 64, 0, 1148846080, 0);
				unk_0xE14EC663EED44AD5(func_18(), uLocal_319, "base_remote", sLocal_322, 8f, -8f, 64, 1148846080);
				unk_0xC90224D9E95E5E3A(uLocal_319, 1);
				func_32("TV_HLP7");
		...
		case 5:
			...
			if (!func_8())
			{
				...
				{
					uLocal_319 = unk_0xE9744DB7B8CA6965(Local_323, Local_326, 2);
					unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), uLocal_319, sLocal_322, "exit", 8f, -8f, 0, 0, 1148846080, 0);
					unk_0xE14EC663EED44AD5(func_18(), uLocal_319, "exit_remote", sLocal_322, 8f, -8f, 0, 1148846080);
					if (func_6(uLocal_321))
					{
						unk_0x93E9ED66DAB9FBE3(uLocal_321, uLocal_319, "exit_cam", sLocal_322);
					}
					if (unk_0xB818A4F8553577BC(uLocal_319))
					{
						unk_0xEFC3DF9D33E248D8(uLocal_319, 0);
				...
				{
					uLocal_319 = unk_0xE9744DB7B8CA6965(Local_323, Local_326, 2);
					unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), uLocal_319, sLocal_322, "idle_a", 8f, -8f, 0, 0, 1148846080, 0);
					unk_0xE14EC663EED44AD5(func_18(), uLocal_319, "idle_a_remote", sLocal_322, 8f, -8f, 0, 1148846080);
					if (unk_0xB818A4F8553577BC(uLocal_319))
					{
						unk_0xEFC3DF9D33E248D8(uLocal_319, 0);
					}
		...
		case 6:
			...
			unk_0x3FC8DBCC154CA56B();
			unk_0x38C3A68D7861DCFD(0, 0, 1);
			if (unk_0x69DF961355195C3C(uLocal_319))
			{
				if (iLocal_316)
				{
					fVar3 = unk_0xA45992A6CE82FB43(uLocal_319);
					if (fVar3 > 0.3f)
					{
		...
		case 8:
			if (unk_0x6FB46C25CCB7E6D5(joaat("num_sh_tv_watched"), &iLocal_320, -1))
			{
				unk_0xCDC520E5E48E63D9(joaat("num_sh_tv_watched"), iLocal_320 + 1, 1);
			}
...
var func_18()
{
	...
	uVar0 = unk_0x4B72871A3BE7B474(Local_309, 3f, joaat("prop_cs_remote_01"), 0, 0, 1);
	return uVar0;
}
		...
		if ((!unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0) && !unk_0x4E861BC5B1EDA7BD(unk_0x16F2683693E537C9())) && unk_0x93B62D155C014521(unk_0xD803B885F5E47A62()))
		{
			if (!unk_0x681F21BF9F7B449B(-1, Param0, 2f))
			{
				if ((((unk_0x19C7D1907D1DDDAB() && !unk_0x22A8E52414415B76()) && !unk_0xF1CB2C261DFBA748()) && !func_39(0)) && !func_38())
				{
					...
					if (func_36(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), Param0, fParam3, 0))
					{
						return 1;
					}
				}
...
int func_41()
{
	...
	iVar0 = unk_0x4B72871A3BE7B474(Local_309, 10f, joaat("prop_cs_remote_01"), 0, 0, 1);
...
void func_56()
{
	...
	if (unk_0x9F4FE516EAACCFC5(uLocal_321))
	{
		unk_0xE3BB8E05FCEB3FBE(uLocal_321, 0);
		unk_0x9A8DDC7C522F5BF5(uLocal_321, 0);
	}
	func_10();
	if (iLocal_51)
	{
