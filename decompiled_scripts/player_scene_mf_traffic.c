...
int func_2()
{
	...
	if (func_5(&uLocal_241, 0f))
	{
		...
		if (!unk_0x1C2F771CDC87A3A5(iLocal_77[iVar0], 0))
		{
			uVar1 = unk_0xFD5C5BBD1FE92BB7(iLocal_77[iVar0], -1, 0);
			if (!unk_0x4FAFF4BCB7633475(uVar1))
			{
				fVar2 = unk_0xD2AA6F822D3A55D2(0.5f, 1f);
				fVar3 = unk_0xD2AA6F822D3A55D2(0f, 0.5f);
				unk_0xAA8884A4BB5B0167(iLocal_77[iVar0], unk_0xF2DB717A73826179((fVar2 * 1000f)), 0, 0);
				func_3(&uLocal_241, fVar3);
			}
		}
	}
	if (unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Local_237, 1) > 100f)
	{
		return 1;
	}
	return 0;
...
int func_11()
{
	...
	{
		func_13();
		func_12(&uLocal_241, unk_0xD2AA6F822D3A55D2(1.75f, 2.25f));
		return 1;
	}
	if (!func_9(&uLocal_241))
	{
		func_12(&uLocal_241, (unk_0xD2AA6F822D3A55D2(1.75f, 2.25f) * 2f));
	}
	return 0;
}
...
void func_13()
{
	...
	while (iVar0 < 4)
	{
		if (!unk_0x1C2F771CDC87A3A5(iLocal_153[iVar0], 0))
		{
			uVar2 = unk_0xFD5C5BBD1FE92BB7(iLocal_153[iVar0], -1, 0);
	...
	while (iVar0 < 4)
	{
		if (!unk_0x1C2F771CDC87A3A5(iLocal_181[iVar0], 0))
		{
			uVar3 = unk_0xFD5C5BBD1FE92BB7(iLocal_181[iVar0], -1, 0);
	...
	while (iVar0 < 4)
	{
		if (!unk_0x1C2F771CDC87A3A5(iLocal_209[iVar0], 0))
		{
			uVar4 = unk_0xFD5C5BBD1FE92BB7(iLocal_209[iVar0], -1, 0);
...
void func_14(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	Var0 = { 0f, fParam2, 0f };
	Var3 = { unk_0x0D1381B6E0F3987D(uParam1, Var0) };
	unk_0xB5396F1FB088FE38(&uVar6);
	unk_0xCF6CC9EA0D2EFE23(0, uParam1, Var3, fParam2, 0, unk_0x4B423FAA24E8ABF0(uParam1), iParam3, 2f, 5f);
	unk_0x7C8E9DE09D4AD3FF(0, uParam1, fParam2, iParam3);
	unk_0x93C0674FC00824D0(uVar6);
	unk_0x4BD42B0527065BB6(uParam0, uVar6);
...
void func_33()
{
	...
	{
		unk_0xEC9DAA34BBB4658C(iLocal_72[iVar0]);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_90)
	{
		unk_0xEC9DAA34BBB4658C(iLocal_90[iVar0]);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_158)
	{
		unk_0xEC9DAA34BBB4658C(iLocal_158[iVar0]);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_186)
	{
		unk_0xEC9DAA34BBB4658C(iLocal_186[iVar0]);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_214)
	{
		unk_0xEC9DAA34BBB4658C(iLocal_214[iVar0]);
		iVar0++;
	}
	iVar1 = 0;
	bVar2 = false;
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_72)
		{
			if (!unk_0x6252BC0DD8A320DB(iLocal_72[iVar0]))
			{
				unk_0xEC9DAA34BBB4658C(iLocal_72[iVar0]);
				bVar2 = false;
			}
		...
		while (iVar0 < 12)
		{
			...
			{
				if (!unk_0x6252BC0DD8A320DB(iLocal_90[iVar0]))
				{
					unk_0xEC9DAA34BBB4658C(iLocal_90[iVar0]);
					bVar2 = false;
				}
				...
				{
					unk_0x2094BC4B6731BA68(Local_237 + Local_103[iVar0 /*3*/], 10f, 1, 0, 0, 0);
					iLocal_77[iVar0] = unk_0x5779387E956077A6(iLocal_90[iVar0], Local_237 + Local_103[iVar0 /*3*/], (fLocal_240 + uLocal_140[iVar0]), 1, 1, 0);
					unk_0xF88FC425EC7D675D(iLocal_77[iVar0], 250);
					unk_0xB344489A3C5FFBBB(iLocal_77[iVar0], 2f);
					unk_0x11C125313CB8ADA2(iLocal_77[iVar0], 1);
				}
			}
			iVar0++;
		}
		...
		while (iVar0 < 4)
		{
			if (!unk_0xFC8BFE4B41177C22(iLocal_153[iVar0]))
			{
				if (!unk_0x6252BC0DD8A320DB(iLocal_158[iVar0]))
				{
					unk_0xEC9DAA34BBB4658C(iLocal_158[iVar0]);
					bVar2 = false;
				}
				...
				{
					unk_0x2094BC4B6731BA68(Local_237 + Local_163[iVar0 /*3*/], 10f, 1, 0, 0, 0);
					iLocal_153[iVar0] = unk_0x5779387E956077A6(iLocal_158[iVar0], Local_237 + Local_163[iVar0 /*3*/], (fLocal_240 + uLocal_176[iVar0]), 1, 1, 0);
					unk_0xF88FC425EC7D675D(iLocal_153[iVar0], 250);
					unk_0xB344489A3C5FFBBB(iLocal_153[iVar0], 2f);
					unk_0x11C125313CB8ADA2(iLocal_153[iVar0], 1);
				}
			}
			iVar0++;
		}
		...
		while (iVar0 < 4)
		{
			if (!unk_0xFC8BFE4B41177C22(iLocal_181[iVar0]))
			{
				if (!unk_0x6252BC0DD8A320DB(iLocal_186[iVar0]))
				{
					unk_0xEC9DAA34BBB4658C(iLocal_186[iVar0]);
					bVar2 = false;
				}
				...
				{
					unk_0x2094BC4B6731BA68(Local_237 + Local_191[iVar0 /*3*/], 10f, 1, 0, 0, 0);
					iLocal_181[iVar0] = unk_0x5779387E956077A6(iLocal_186[iVar0], Local_237 + Local_191[iVar0 /*3*/], (fLocal_240 + uLocal_204[iVar0]), 1, 1, 0);
					unk_0xF88FC425EC7D675D(iLocal_181[iVar0], 250);
					unk_0xB344489A3C5FFBBB(iLocal_181[iVar0], 2f);
					unk_0x11C125313CB8ADA2(iLocal_181[iVar0], 1);
				}
			}
			iVar0++;
		}
		...
		while (iVar0 < 4)
		{
			if (!unk_0xFC8BFE4B41177C22(iLocal_209[iVar0]))
			{
				if (!unk_0x6252BC0DD8A320DB(iLocal_214[iVar0]))
				{
					unk_0xEC9DAA34BBB4658C(iLocal_214[iVar0]);
					bVar2 = false;
				}
				...
				{
					unk_0x2094BC4B6731BA68(Local_237 + Local_219[iVar0 /*3*/], 10f, 1, 0, 0, 0);
					iLocal_209[iVar0] = unk_0x5779387E956077A6(iLocal_214[iVar0], Local_237 + Local_219[iVar0 /*3*/], (fLocal_240 + uLocal_232[iVar0]), 1, 1, 0);
					unk_0xF88FC425EC7D675D(iLocal_209[iVar0], 250);
					unk_0xB344489A3C5FFBBB(iLocal_209[iVar0], 2f);
					unk_0x11C125313CB8ADA2(iLocal_209[iVar0], 1);
				}
			}
			iVar0++;
		}
	...
	while (iVar0 < 12)
	{
		if (!unk_0x1C2F771CDC87A3A5(iLocal_77[iVar0], 0))
		{
			uVar3 = unk_0x8728A378EF2B46B2(iLocal_77[iVar0], 4, iLocal_72[func_36()], -1, 1, 1);
			func_34(uVar3);
			unk_0x11C125313CB8ADA2(iLocal_77[iVar0], 1);
			unk_0x11C125313CB8ADA2(uVar3, 1);
			unk_0x55098D9E9AD58806(iLocal_90[iVar0]);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (!unk_0x1C2F771CDC87A3A5(iLocal_153[iVar0], 0))
		{
			if (unk_0x2EEC0612337D20CE(iLocal_153[iVar0]) > 0)
			{
				uVar4 = unk_0x8728A378EF2B46B2(iLocal_153[iVar0], 4, iLocal_72[func_36()], -1, 1, 1);
				func_34(uVar4);
				unk_0x11C125313CB8ADA2(iLocal_77[iVar0], 1);
				unk_0x11C125313CB8ADA2(uVar4, 1);
				unk_0x55098D9E9AD58806(iLocal_158[iVar0]);
			}
		}
		iVar0++;
	}
	if (!unk_0x2EEC0612337D20CE(iLocal_153[2]) > 0)
	{
		unk_0xF89624E52FCBE454(iLocal_153[0], iLocal_153[2], 1065353216);
	}
	if (!unk_0x2EEC0612337D20CE(iLocal_153[3]) > 0)
	{
		unk_0xF89624E52FCBE454(iLocal_153[1], iLocal_153[3], 1065353216);
	}
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (!unk_0x1C2F771CDC87A3A5(iLocal_181[iVar0], 0))
		{
			if (unk_0x2EEC0612337D20CE(iLocal_181[iVar0]) > 0)
			{
				uVar5 = unk_0x8728A378EF2B46B2(iLocal_181[iVar0], 4, iLocal_72[func_36()], -1, 1, 1);
				func_34(uVar5);
				unk_0x11C125313CB8ADA2(iLocal_77[iVar0], 1);
				unk_0x11C125313CB8ADA2(uVar5, 1);
				unk_0x55098D9E9AD58806(iLocal_186[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < 4)
	{
		if (!unk_0x1C2F771CDC87A3A5(iLocal_209[iVar0], 0))
		{
			if (unk_0x2EEC0612337D20CE(iLocal_209[iVar0]) > 0)
			{
				uVar6 = unk_0x8728A378EF2B46B2(iLocal_209[iVar0], 4, iLocal_72[func_36()], -1, 1, 1);
				func_34(uVar6);
				unk_0x11C125313CB8ADA2(iLocal_77[iVar0], 1);
				unk_0x11C125313CB8ADA2(uVar6, 1);
				unk_0x55098D9E9AD58806(iLocal_214[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_72)
	{
		unk_0x55098D9E9AD58806(iLocal_72[iVar0]);
		iVar0++;
	}
}
...
int func_36()
{
	...
	iVar0 = unk_0xC5935DFB3F39785A(0, iLocal_72);
	if (unk_0x6252BC0DD8A320DB(iLocal_72[iVar0]))
	{
		return iVar0;
	}
	...
	{
		if (unk_0x6252BC0DD8A320DB(iLocal_72[iVar6]))
		{
	...
	iVar0 = unk_0xC5935DFB3F39785A(0, iVar7);
	iVar6 = 0;
	while (iVar6 < iLocal_72)
	{
		...
		default:
			...
			while (iVar24 < *uParam12)
			{
				...
				*(uParam12[iVar24 /*3*/]) = { 0f, 0f, 0f };
				(*uParam13)[iVar24] = unk_0xD2AA6F822D3A55D2(0f, 360f);
				iVar24++;
			}
			break;
	}
	...
	*(uParam0[1 /*3*/]) = { Vector(0f, -21.4697f, -0.889f) + func_45(-1090519040, 1056964608) };
	...
	while (iVar3 <= (*uParam0 - 1))
	{
		...
		*(uParam0[iVar3 /*3*/]) = { *(uParam0[iVar3 /*3*/]) + func_45(-1090519040, 1056964608) };
		(*uParam1)[iVar3] = unk_0xD2AA6F822D3A55D2(-22f, -15f);
		iVar3++;
	}
...
void func_56()
{
	...
	{
		unk_0x68298CA6191CDFDB(&(iLocal_77[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_153)
	{
		unk_0x68298CA6191CDFDB(&(iLocal_153[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_181)
	{
		unk_0x68298CA6191CDFDB(&(iLocal_181[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_209)
	{
		unk_0x68298CA6191CDFDB(&(iLocal_209[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_72)
