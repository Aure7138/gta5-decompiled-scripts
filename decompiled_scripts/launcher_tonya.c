...
void func_186(var uParam0)
{
	...
	if (func_180() || unk_0x04458B4E5D9E466A())
	{
		unk_0xD681CC2BC1084DB6(0);
		return;
	}
	...
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		fVar0 = unk_0xB7A628320EFF8E47(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_92);
		if (fVar0 < (20f * 20f) && iLocal_98)
		{
			switch (iLocal_99)
			{
				...
				case 2:
					if (func_193(&uLocal_265))
					{
						if (func_187(&uLocal_265) > unk_0xC4EAB25A108C2429(9f, 15f))
						{
							iLocal_268++;
							switch (iLocal_268)
							{
...
float func_187(var uParam0)
{
	if (func_193(uParam0))
	{
		...
		{
			return (func_188(BitTest(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_188(BitTest(*uParam0, 4)) - fParam1);
...
void func_208(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		if (!unk_0xACC32B78196FBC2A(sParam1))
		{
			...
			{
				if (func_212(unk_0xE2D3D51028F0428A(), Param2, 1) <= 100f)
				{
					func_211(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_212(unk_0xE2D3D51028F0428A(), Param2, 1) > 120f)
				{
					func_214(iParam0);
				}
			}
...
void func_218(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_129(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_220(uParam1) || !unk_0xFCF559C8631ABED7(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_219(iParam2) && !unk_0x2E7F5417D4F4DD69(iParam0, unk_0xE2D3D51028F0428A(), 25f))
					{
						unk_0x529D306014D3C29A(iParam0, unk_0xE2D3D51028F0428A(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_220(uParam1) && uParam1->f_4 == 0) && unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_219(iParam2) || unk_0x2E7F5417D4F4DD69(iParam0, unk_0xE2D3D51028F0428A(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x49D97B076E3590AC(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_256(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_129(uParam0->f_28[0]) && unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
			{
				unk_0x7461D7C5BA953BC7(&uVar1);
				unk_0xA888F8CC04F25CC8(&uVar1);
