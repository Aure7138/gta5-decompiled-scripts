...
void __EntryFunction__()
{
	...
	fLocal_14 = 0.001f;
	iLocal_17 = -1;
	uLocal_20 = unk_0x43B8950858CAD66F(100f, 100f, 30f);
	iLocal_22 = 1;
	fLocal_25 = 0f;
	fLocal_28 = 0f;
	fLocal_31 = 0f;
	...
	uLocal_18 = unk_0x9A64FC8B83855E3B("p_bubblegum");
	...
	while (true)
	{
		...
		{
			iLocal_22 = 0;
			uLocal_19 = unk_0x3A5E675E99CE82DC("DEFAULT_SCRIPTED_CAMERA", 1);
			if (unk_0x54DA78A82349F5AC(uLocal_19))
			{
				unk_0xA5BB6562A45BA2E6(uLocal_19, -160.6632f, -1072.144f, -1615.471f, -89.4999f, -0.2863f, 58.1189f, 45f, 0, 1, 1, 2);
				unk_0xA316D8C27D14C788(uLocal_19, 0.01f);
				unk_0x176DD5FEFDE13359(uLocal_19, 0.02f);
				unk_0x04E786541E35ECB1(1, 0, 3000, 1, 0, 0);
			}
			unk_0x216986E3E3E543F2(uLocal_20, 66);
		}
		iLocal_21 = 1;
...
void func_1(var uParam0)
{
	if (Global_14392 == 0)
	{
		if (unk_0x5FCAE3F8AEC656AF(2, 189) || unk_0x5FCAE3F8AEC656AF(2, 190))
		{
			Global_14392 = 1;
	...
	if (Global_14392 == 0)
	{
		...
		if (!bLocal_23 == bLocal_24)
		{
			...
			unk_0x4ACF99392701B935(fLocal_25);
		...
		if (!bLocal_26 == bLocal_27)
		{
			...
			unk_0x4ACF99392701B935(fLocal_28);
			unk_0x7E5FA681CB7A2EF7();
		}
		...
		if (!bLocal_29 == bLocal_30)
		{
			...
			unk_0x4ACF99392701B935(fLocal_31);
			unk_0x7E5FA681CB7A2EF7();
		}
		...
		if (!bLocal_32 == bLocal_33)
		{
			...
			unk_0x4ACF99392701B935(fLocal_34);
			unk_0x7E5FA681CB7A2EF7();
		}
		...
		if (!bLocal_35 == bLocal_36)
		{
			...
			unk_0x4ACF99392701B935(fLocal_37);
			unk_0x7E5FA681CB7A2EF7();
		}
		if (unk_0x117D586920E8F7BA(2, 204))
		{
			bLocal_38 = true;
			fLocal_40 = 1f;
		}
		if (unk_0x5FCAE3F8AEC656AF(2, 204))
		{
			bLocal_38 = true;
			fLocal_40 = 1f;
		}
		...
		if (!bLocal_38 == bLocal_39)
		{
			...
			unk_0x4ACF99392701B935(fLocal_40);
			unk_0x7E5FA681CB7A2EF7();
		}
		...
		if (!bLocal_41 == bLocal_42)
		{
			...
			unk_0x4ACF99392701B935(fLocal_43);
			unk_0x7E5FA681CB7A2EF7();
		}
		...
		if (unk_0x5FCAE3F8AEC656AF(2, 203))
		{
			bLocal_44 = true;
			fLocal_46 = 1f;
		}
		...
		if (!bLocal_44 == bLocal_45)
		{
			bLocal_45 = bLocal_44;
			unk_0x8CED8F78CC31BEF2(uParam0, "SET_INPUT_EVENT");
			unk_0xD2DC8221939F80F7(14);
			unk_0x4ACF99392701B935(fLocal_46);
			unk_0x7E5FA681CB7A2EF7();
		}
	}
}
...
void func_2()
{
	if (unk_0x54DA78A82349F5AC(uLocal_19))
	{
		unk_0x1D1A369233055AEC(uLocal_19, 0);
	}
