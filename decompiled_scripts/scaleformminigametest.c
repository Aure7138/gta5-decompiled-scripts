...
void __EntryFunction__()
{
	...
	fLocal_14 = 0.001f;
	iLocal_17 = -1;
	uLocal_20 = unk_0x6820C712C1DD618A(100f, 100f, 30f);
	iLocal_22 = 1;
	fLocal_25 = 0f;
	fLocal_28 = 0f;
	fLocal_31 = 0f;
	...
	uLocal_18 = unk_0x5DEA4192B46CB99B("p_bubblegum");
	...
	while (true)
	{
		...
		{
			iLocal_22 = 0;
			uLocal_19 = unk_0x68C2E3309DCAD71E("DEFAULT_SCRIPTED_CAMERA", 1);
			if (unk_0x40397A9A17EEC1C5(uLocal_19))
			{
				unk_0x3FD8029C7A771A0E(uLocal_19, -160.6632f, -1072.144f, -1615.471f, -89.4999f, -0.2863f, 58.1189f, 45f, 0, 1, 1, 2);
				unk_0x8FFDD70F5142C6E0(uLocal_19, 0.01f);
				unk_0x4A5E99F2490D786A(uLocal_19, 0.02f);
				unk_0x3ED9330214992278(1, 0, 3000, 1, 0, 0);
			}
			unk_0xE7B8403ABCA0391D(uLocal_20, 66);
		}
		iLocal_21 = 1;
...
void func_2()
{
	if (unk_0x40397A9A17EEC1C5(uLocal_19))
	{
		unk_0xB8B0F7C8C1548C5B(uLocal_19, 0);
	}
