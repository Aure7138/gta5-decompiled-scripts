...
int func_190(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2454188[iParam0 /*6*/][func_191(iParam1)];
...
void func_260(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	iVar0 = Global_2454188[iParam0 /*6*/][func_191(iParam2)];
	if (iVar0 != 0)
	{
...
int func_382(int iParam0, int iParam1)
{
	...
	if (func_392(&Global_2543745))
	{
		if (func_390(&Global_2543745, iParam0))
		{
			return 0;
		}
		if (func_383(&Global_2543745, iParam0))
		{
			return 1;
		}
	}
