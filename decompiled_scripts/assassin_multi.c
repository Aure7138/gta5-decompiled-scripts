...
void __EntryFunction__()
{
	...
	if (unk_0x4210287E2833D44B(3))
	{
		...
		func_513();
		if (unk_0x419E13582192CFEA(iLocal_1465))
		{
			unk_0x4603196EEEA2355C(iLocal_1465, 1, 0);
			unk_0x3CBE9F07524C242D(iLocal_1465, 1, 0);
			unk_0xC22CF0F8AABFA658(iLocal_1465, 1);
		}
	...
	uLocal_1589 = unk_0x0823FA7465392E20(Local_1563 - Vector(2f, 2f, 2f), Local_1563 + Vector(2f, 2f, 2f), 0, 1, 1, 1);
	func_508();
	iLocal_1444 = 1;
	...
	while (true)
	{
		...
		unk_0xE9F487B66E055135("M_ASS2", 0);
		...
		if (func_499(&uScriptParam_0))
		{
			if (func_498())
			{
				...
				unk_0xE6B53A6E51AAA49F(uLocal_1589, 0);
				func_518();
...
int func_21(var uParam0)
{
	...
	{
		case 0:
			if (IntToFloat(iLocal_1545) >= ((fLocal_1560 * 1f) / 2f) && !unk_0x123480158F10FA67())
			{
				func_38(&(uParam0->f_16), 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
...
void func_39(int iParam0, var uParam1, float fParam2, var uParam3, bool bParam4)
{
	if (!*uParam3)
	{
		*iParam0 = unk_0xDFB7BFA6482FEE1E();
		*uParam3 = 1;
	}
	*uParam1 = (unk_0xDFB7BFA6482FEE1E() - *iParam0);
...
float func_45(var uParam0)
{
	if (func_497(uParam0))
	{
		...
		{
			return (func_46(unk_0x234B68AC2E35ED5A(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
void func_48()
{
	if (!iLocal_1538)
	{
		if (unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) > 0)
		{
			if (!func_51())
			{
				func_49(unk_0x7D2B9E6A64637269(), "SPOT_POLICE", 24);
				iLocal_1538 = 1;
			}
		}
	}
...
{
	unk_0x676B3404DACBD7C7(iParam0, sParam1, func_50(iParam2), 1);
}
	...
	if (iLocal_1042 > 4)
	{
		if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
		{
			...
			if (unk_0x419E13582192CFEA(iVar0))
			{
				...
				{
					if ((iVar0 != iLocal_1583 && !unk_0x0297E633EADA2182(iVar0)) && !unk_0xEE1D92A39CF8E1E6(iVar0))
					{
						iLocal_1583 = iVar0;
						unk_0x4985CD0720AFD468(iLocal_1583, 1, 0);
						unk_0xD5CF6F9E6FB73F7B(iLocal_1583, 0);
					}
				}
			}
		}
...
void func_53(struct<39> Param0, var uParam39, var uParam40)
{
	...
	switch (iLocal_1044)
	{
		...
		case 1:
			...
			if (func_141(&uLocal_150, 1, 0) && unk_0x6F75D3BB2E4578CE())
			{
...
void func_101(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_107(uParam0->f_1, 256) || (func_107(uParam0->f_1, 8192) && unk_0x0C7C436873368EDB(2)))
	{
		...
		if (unk_0x3640D836D145B814())
		{
			...
			unk_0x9D7453DF8B7E9E0B(func_107(uParam0->f_1, 4096));
			unk_0x392841D58D2EED1D();
		}
		iVar5 = 0;
		iVar6 = 0;
	...
	while (bVar0)
	{
		...
		if ((uParam0->f_565 || uParam0->f_566) && uParam0->f_56 != 0)
		{
			if (IntToFloat(uParam0->f_572) > (IntToFloat(uParam0->f_558 + 1165) - (15000f * fParam2)))
			{
				...
				uParam0->f_559 = func_111((uParam0->f_559 + (((1f / 0.3f) * uParam0->f_573) * unk_0x0000000050597EE2())), 0f, 1f);
				uParam0->f_573 = func_111((uParam0->f_573 + 0.07f), 0.75f, 1.15f);
			}
		}
		else
		{
			uParam0->f_559 = func_111((uParam0->f_559 - ((((1f / 0.3f) * uParam0->f_573) * 0.01f) * unk_0x0000000050597EE2())), 0f, 1f);
			uParam0->f_573 = func_111((uParam0->f_573 + 0.07f), 0.75f, 1.15f);
		}
...
void func_110(var uParam0, bool bParam1)
{
	...
	func_106(unk_0x908D1ACF42DAF9B8(2, 215, true));
	func_105("ES_HELP");
	if (unk_0x3640D836D145B814())
	{
		unk_0x9D7453DF8B7E9E0B(true);
	...
	if (bParam1)
	{
		unk_0x704F8697BB515627(uParam0->f_4, "SET_DATA_SLOT");
		unk_0x9E3D03981E2E9AD9(1);
		func_106(unk_0x908D1ACF42DAF9B8(2, 216, true));
		func_105("ES_XPAND");
		if (unk_0x3640D836D145B814())
		{
			unk_0x9D7453DF8B7E9E0B(true);
...
void func_112(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_127();
		unk_0x80B2E30CC8B794C0(0.5f, (fVar1 - (func_130((2f - 0.5f)) - 0.001388889f)), fVar6, func_125(1f), uVar13, uVar14, uVar15, unk_0xF2DB717A73826179((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
	...
	while (iVar17 < uParam0->f_56)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			func_122(uParam0, iVar17, (fVar1 + func_130(2f)), fVar9, fVar10, unk_0xF2DB717A73826179((IntToFloat(iVar0) * fVar12)));
		}
		else
		{
			return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_111((fVar11 / (0.6f * func_130(25f))), 0f, 1f);
					func_127();
					unk_0x80B2E30CC8B794C0(0.5f, (fVar1 + func_130((2f * 0.5f))), fVar6, func_125(1f), uVar13, uVar14, uVar15, unk_0xF2DB717A73826179((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_130((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_130((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_556)
			{
				case 0:
					...
					unk_0xBC68FBDA73BBB4A6(fVar20, (fVar1 + func_130((2f * 2f))), 0);
					break;
...
var func_118(int iParam0, bool bParam1)
{
	...
	if (!unk_0xAB6A270F84A8781E(&(Global_22670.f_7286[iParam0 /*16*/])))
	{
		...
		{
			Var19 = { func_120(unk_0x1146A9AE09CE2B14()) };
...
char* func_121(int iParam0)
{
	...
	if (!unk_0xAB6A270F84A8781E(&(Global_22670.f_6277[iParam0 /*16*/])))
	{
		...
		{
			Var16 = { func_120(unk_0x1146A9AE09CE2B14()) };
...
void func_122(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	...
	unk_0xD7BF3EFD7B2022EC(1);
	unk_0x9E8B548C035F223D(1f, func_124(14f));
	unk_0x7160B751D113C8C6(0);
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			unk_0xDDD5C8D7152E128F("CommonMenu", func_118(7, 0), (fParam4 - 0.006f), ((fParam2 + func_130(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_115(5, 0, 1, &fVar5, &fVar6, 0);
			unk_0xDDD5C8D7152E128F("CommonMenu", func_118(5, 0), (fParam4 - 0.006f), ((fParam2 + func_130(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_115(6, 0, 1, &fVar5, &fVar6, 0);
			unk_0xDDD5C8D7152E128F("CommonMenu", func_118(6, 0), (fParam4 - 0.006f), ((fParam2 + func_130(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_123(int iParam0, int iParam1, float fParam2, float fParam3, char* sParam4, int iParam5)
{
	...
	switch (iParam5)
	{
		case 4:
		case 5:
			unk_0x9E8B548C035F223D(1f, func_124(18f));
...
void func_142(var uParam0)
{
	...
	unk_0x704F8697BB515627(uParam0->f_4, "SET_DATA_SLOT");
	unk_0x9E3D03981E2E9AD9(2);
	func_106(unk_0x908D1ACF42DAF9B8(2, 188, true));
	func_105("ES_HELP_TU");
	unk_0x392841D58D2EED1D();
	unk_0x704F8697BB515627(uParam0->f_4, "SET_DATA_SLOT");
	unk_0x9E3D03981E2E9AD9(1);
	func_106(unk_0x908D1ACF42DAF9B8(2, 187, true));
	func_105("ES_HELP_TD");
	unk_0x392841D58D2EED1D();
	unk_0x704F8697BB515627(uParam0->f_4, "SET_DATA_SLOT");
	unk_0x9E3D03981E2E9AD9(0);
	func_106(unk_0x908D1ACF42DAF9B8(2, 202, true));
	func_105("ES_HELP_AB");
	unk_0x392841D58D2EED1D();
	unk_0x704F8697BB515627(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	unk_0x392841D58D2EED1D();
...
void func_143(var uParam0)
{
	...
	fVar0 = 0f;
	unk_0xD7BF3EFD7B2022EC(0);
	unk_0x9E8B548C035F223D(1f, func_124(16f));
	if (uParam0->f_31 == 0)
	{
		if (uParam0->f_29)
		{
...
void func_145()
{
	...
	if (!iLocal_139)
	{
		...
		if (Global_93547)
		{
			func_150(&uLocal_150, 6, &(Local_727.f_12), "MTPHPERSKI", unk_0xF34EE736CF047844(fLocal_134), 0, 3, 0);
			func_150(&uLocal_150, 6, &(Local_727.f_24), "MTPHPERSKI", 0, 0, 3, 0);
			func_150(&uLocal_150, 6, &(Local_727.f_30), "MTPHPERSKI", unk_0xF2DB717A73826179((fLocal_136 + fLocal_135)), 0, 3, 0);
			func_149();
		}
		else
		{
			if (bLocal_138)
			{
				func_150(&uLocal_150, 6, &(Local_727.f_12), "MTPHPERRET", unk_0xF34EE736CF047844(fLocal_134), 0, 3, 0);
			}
			else
			{
				func_150(&uLocal_150, 9, &(Local_727.f_12), "", unk_0xF34EE736CF047844(fLocal_134), 0, 0, 0);
			}
			if (!unk_0xAB6A270F84A8781E(&(Local_727.f_18)))
			{
				if (bLocal_137)
				{
					...
					func_150(&uLocal_150, 3, &(Local_727.f_30), "", unk_0xF2DB717A73826179((fLocal_136 + fLocal_135)), 0, 2, 0);
				}
				else
				{
					func_150(&uLocal_150, 6, &(Local_727.f_24), "", 0, 0, 1, 0);
					func_150(&uLocal_150, 3, &(Local_727.f_30), "", unk_0xF2DB717A73826179(fLocal_135), 0, 0, 0);
				}
			}
			else
			{
...
void func_154(var uParam0)
{
	if (func_497(uParam0))
	{
		if (!func_47(uParam0))
		{
			uParam0->f_2 = (func_46(unk_0x234B68AC2E35ED5A(*uParam0, 4)) - uParam0->f_1);
...
{
	uParam0->f_1 = (func_46(unk_0x234B68AC2E35ED5A(*uParam0, 4)) - fParam1);
	...
	switch (iLocal_1042)
	{
		...
		case 4:
			...
			if (bLocal_1514)
			{
				...
				unk_0x6AF7EE4DD9F8B944(Local_1570, 5f, 1, 0, 0, 0);
		...
		case 7:
			...
			if (iLocal_1461 >= 2)
			{
				if (unk_0x419E13582192CFEA(iLocal_1575))
				{
					if (func_281(iLocal_1575, unk_0x7D2B9E6A64637269(), 1) > 500f)
					{
						unk_0x795957CD3A0042C8(&iLocal_1575);
					}
				}
			}
			if (!iLocal_1536)
			...
			{
				if ((func_264(uParam0, uParam1) || (unk_0x87BE50F80F3FCEAB(unk_0x1146A9AE09CE2B14(), *uParam1) && func_263(*uParam1, 1) < 150f)) || (unk_0x4140085B99B17F97(unk_0x1146A9AE09CE2B14(), *uParam1) && func_263(*uParam1, 1) < 150f))
				{
					func_262(*uParam1);
					iLocal_1042 = 10;
				}
		...
		case 10:
			...
			{
				if (iLocal_1516 && !unk_0xECEC7528A52B4EE8(*uParam1))
				{
					func_258();
					unk_0xF0CFD24C4C5A6185(*uParam1, 1, 0, 0);
				}
		...
		case 11:
			...
			{
				if (!unk_0xECEC7528A52B4EE8(*uParam1) && iLocal_1461 == 2)
				{
					unk_0xC595907BB71C921D(*uParam1, 0, 0);
				}
				if (iLocal_1461 == 1)
				{
					if (!unk_0xECEC7528A52B4EE8(uParam1->f_7))
					{
						unk_0x5C679902079A7E80(&uVar0);
						unk_0x4261814A9A26E86F(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_quick_f", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
						unk_0x4261814A9A26E86F(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_cower_loop_f", 1000f, -8f, -1, 1, 0, 0, 0, 0);
						unk_0x1BBD0A5729AB1226(uVar0);
						unk_0x8A1AC8EBC73850C8(uParam1->f_7, uVar0);
					...
					if (unk_0x419E13582192CFEA(uParam1->f_1))
					{
						...
						{
							unk_0xD5CF6F9E6FB73F7B(uParam1->f_1, 0);
						}
					}
				}
				iLocal_1540++;
		...
		case 12:
			...
			{
				unk_0xB63015EB91A2D1FF("SCRIPTED_SCANNER_REPORT_ASS_MULTI_01", 0f);
			}
			break;
	}
	return 0;
...
void func_166(var uParam0, int iParam1)
{
	...
	*iParam1 = 0;
	if (iLocal_1461 != 1)
	{
		unk_0x795957CD3A0042C8(&(iParam1->f_1));
		if (unk_0x419E13582192CFEA(iLocal_1575))
		{
			unk_0x795957CD3A0042C8(&iLocal_1575);
		}
	}
	else if (unk_0x419E13582192CFEA(iParam1->f_1))
	{
		iLocal_1575 = iParam1->f_1;
	}
	if (unk_0x419E13582192CFEA(iLocal_1574))
	{
		unk_0x795957CD3A0042C8(&iLocal_1574);
	}
	if (unk_0x419E13582192CFEA(iLocal_1577))
	{
		unk_0x795957CD3A0042C8(&iLocal_1577);
	}
	if (unk_0x419E13582192CFEA(iLocal_1576))
	{
		unk_0x795957CD3A0042C8(&iLocal_1576);
	}
	iLocal_1518 = 0;
	iLocal_1548 = 0;
	iLocal_143 = 0;
...
void func_177(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		if (!unk_0xAB6A270F84A8781E((*uParam0)[iVar0]))
		{
			unk_0xF9135F131C423364((*uParam0)[iVar0]);
		}
		iVar0++;
	}
}
...
void func_182(var uParam0, var uParam1)
{
	...
	if (uParam1->f_14 != 0)
	{
		unk_0x824F744352C8BC82(uParam1->f_14);
	}
	if (unk_0x419E13582192CFEA(*uParam0))
	{
		unk_0x0F3BD19FF11738D3(uParam0);
	...
	{
		unk_0x0F3BD19FF11738D3(&(uParam0->f_7));
	}
	if (unk_0x419E13582192CFEA(uParam0->f_9))
	{
		unk_0x0F3BD19FF11738D3(&(uParam0->f_9));
	}
}
...
void func_183(var uParam0, var uParam1)
{
	...
	unk_0x824F744352C8BC82(joaat("a_f_y_fitness_02"));
	if (unk_0x419E13582192CFEA(*uParam0))
	{
		unk_0x0F3BD19FF11738D3(uParam0);
	}
	...
	while (iVar0 <= 1)
	{
		if (unk_0x419E13582192CFEA(Local_2204[iVar0 /*9*/]))
		{
			unk_0x0F3BD19FF11738D3(&(Local_2204[iVar0 /*9*/]));
		}
		iVar0++;
	}
}
...
void func_184()
{
	...
	while (iVar0 < 4)
	{
		if (unk_0x419E13582192CFEA(uLocal_1578[iVar0]))
		{
			unk_0x795957CD3A0042C8(&(uLocal_1578[iVar0]));
		}
		iVar0++;
	}
}
...
void func_185()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			unk_0x824F744352C8BC82(iLocal_1585[iVar0]);
		}
		iVar0++;
	}
}
...
void func_191(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_215(iParam1) && unk_0x1F9D47D45E125FA6(iParam1))
	{
		iVar1 = 0;
...
{
	if (func_215(unk_0x7D2B9E6A64637269()))
	{
...
int func_196(char* sParam0)
{
	if (!func_197(1, 1, 0))
	{
		if ((!unk_0xAB6A270F84A8781E(sParam0) && func_217(sParam0)) || func_217("CMN_HINT"))
		{
			unk_0x66AE54CE92457FEE(1);
		}
		return 0;
...
int func_197(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_204() || func_203(Global_4456448.f_133963)) || func_202())
	{
		if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
		{
			...
			iVar1 = func_201(unk_0x7D2B9E6A64637269(), 0);
			if (((unk_0xCA5702B560C1A812(iVar0, iVar1) || (unk_0x6471F4759775FCA4(iVar0) == joaat("apc") && iVar1 != -1)) || (unk_0x6471F4759775FCA4(iVar0) == joaat("akula") && iVar1 != -1)) || (((unk_0x6471F4759775FCA4(iVar0) == joaat("riot2") && iVar1 == 0) && func_200(iVar0, 10)) && unk_0xB51972B58BF40F96(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_198(int iParam0)
{
	if (iParam0 != func_28())
	{
		...
		else if ((Global_1312902 && iParam0 == unk_0x1146A9AE09CE2B14()) && func_199(iParam0, 1, 0))
		{
			return Global_2426865[iParam0 /*449*/].f_319.f_6 != -1;
		}
	}
...
bool func_207()
{
	return func_208(unk_0x1146A9AE09CE2B14());
}
...
int func_210(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_213(bParam1, bParam2, bParam3) || unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((unk_0xDFB7BFA6482FEE1E() - uParam0->f_4) > 500)
			{
				...
				{
					if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 1) || func_211(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
	...
	switch (iLocal_1462)
	{
		...
		case 1:
			if (func_223(*uParam1, uParam1->f_1, &Local_122, &uLocal_133, 1, 0, 0, 1, 1) || iLocal_1518)
			{
				...
				{
					unk_0x46EDFC827DC67D89(*uParam1, 1, 1);
					if (unk_0xF41EB7643E61A928(*uParam1, uParam1->f_1, 0))
					{
						if (unk_0xBFCE58B2B3249999(uParam1->f_1, 0))
						{
							if (!unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
							{
								unk_0x5B1F7232B835EC44(*uParam1, uParam1->f_1, unk_0x7D2B9E6A64637269(), 8, 35f, 786468, 500f, -1f, 1);
							}
							else
							{
								unk_0x7B5530AB21BFC748(*uParam1, uParam1->f_1, unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0), 8, 35f, 786468, 500f, -1f, 1);
							}
						}
					}
					else
					{
						unk_0x1DC2BF231DE6A016(*uParam1, unk_0x7D2B9E6A64637269(), 1000f, -1, 0, 0);
					}
				}
				unk_0xC1B1E9A034A63A62(0);
				iLocal_1462 = 2;
			...
			{
				if (!unk_0xC49311A2A500FF09(*uParam1, 0))
				{
					unk_0xB1D85A6C23F2F945(*uParam1, uParam1->f_1, -1);
					unk_0x47D0DDD8833C5E5F(uParam1->f_1, 1084227584);
				}
				unk_0x49CB177958B472A8(uParam1->f_1, 4f);
				unk_0x5C679902079A7E80(&uVar0);
				unk_0xA0F8D741F5D8E7E4(0, uParam1->f_1, -1637.682f, 1018.619f, 152.1026f, 4, 22f, 786468, 10f, -1f, 1);
				unk_0x0509CE092AC81B7C(0, uParam1->f_1, 22f, 786468);
				unk_0x1BBD0A5729AB1226(uVar0);
				unk_0x8A1AC8EBC73850C8(*uParam1, uVar0);
				unk_0x8D5B447F21217223(&uVar0);
				iLocal_1517 = 1;
			}
			break;
		...
		case 2:
			...
			else if (!unk_0xECEC7528A52B4EE8(*uParam1))
			{
				if (!iLocal_1526)
				{
					if (!unk_0xC49311A2A500FF09(*uParam1, 0))
					{
						if (unk_0x4E8DA737B686529A(*uParam1, 780511057) != 1)
						{
							unk_0xA415F00D0E0DFBCE(*uParam1, 1, 0);
							unk_0x1DC2BF231DE6A016(*uParam1, unk_0x7D2B9E6A64637269(), 1000f, -1, 0, 0);
							iLocal_1526 = 1;
						}
					}
				}
				if ((func_263(*uParam1, 1) < 15f && !func_51()) && !unk_0x6B9E71121F5B8154(*uParam1))
				{
					if (!iLocal_1521)
					{
...
{
	func_44(&uLocal_1590);
	fLocal_1559 = unk_0x644B8DBA4F69BB73(3f, 7f);
}
...
int func_224(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_225(unk_0x7D2B9E6A64637269(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (unk_0x6B9E71121F5B8154(iParam0) && func_263(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_227(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (unk_0x24A466C655E8588A(iParam0, 2))
	{
		...
		else
		{
			...
			if (unk_0x8A92595B8AA1D4E9(iParam0) || func_228(iVar3))
			{
				if (unk_0x591190E69BE43117(iParam1, unk_0xD6E677FAD7521410(iParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (unk_0x836F48E8C4A773BF(unk_0xFAA5505029C4B5A6(iParam1), iParam0, 120f) && unk_0x895779B17E5AA5FE(iParam1, iParam0, 17))
		...
		if (unk_0xBFCE58B2B3249999(iParam0, 0))
		{
			if (unk_0x27FC1B0077581B37(iParam0, -1, 0) != 0)
			{
				if (unk_0xBDC364B886846D11(unk_0x7D2B9E6A64637269(), &iVar0, 1))
				{
					...
					{
						if (func_281(unk_0x7D2B9E6A64637269(), iParam0, 1) < 40f)
						{
...
void func_230(var uParam0)
{
	...
	unk_0xFA3E6ADC3E5D386E(uParam0->f_2, 1);
	unk_0x13CC211F9F7ACE7F(uParam0->f_2, 0);
}
...
int func_231(int iParam0, int iParam1, bool bParam2)
{
	...
	if (unk_0x55F5BD4ABD80B211(iParam0))
	{
		unk_0xDD205B87CDFD0C1B(uVar0, func_104(unk_0x02BFF15CAA701972(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xDD205B87CDFD0C1B(uVar0, func_104(unk_0x02BFF15CAA701972(), 0.7f, 0.7f));
		unk_0xB592493CDC7124C3(uVar0, iParam1);
	}
	else if (unk_0x50997FC21D62251F(iParam0))
	{
...
void func_232(var uParam0)
{
	switch (iLocal_1462)
	{
		...
		case 1:
			if (!iLocal_1516)
			{
				if ((((func_223(*uParam0, 0, &Local_122, &uLocal_133, 0, 1, 0, 1, 1) || unk_0xA3EE9E61D762C09A(unk_0xD6E677FAD7521410(*uParam0, 1), 15f, 0, 1)) || iLocal_1518) || func_263(*uParam0, 1) < 5f) || (unk_0x6A86865E010A134F(unk_0x7D2B9E6A64637269()) && func_263(*uParam0, 1) <= 35f))
				{
					if (!unk_0xECEC7528A52B4EE8(*uParam0))
					{
						...
						unk_0x4261814A9A26E86F(*uParam0, "oddjobs@assassinate@multi@windowwasher", "_shot_reaction", 8f, -8f, -1, 2, 0, 0, 0, 0);
						iLocal_1462 = 2;
					}
				}
			}
		...
		case 2:
			...
			if (unk_0x4E8DA737B686529A(*uParam0, -2017877118) != 1 && unk_0x4E8DA737B686529A(*uParam0, 474215631) != 1)
			{
...
void func_234(var uParam0, var uParam1)
{
	...
	switch (iLocal_1462)
	{
		case 0:
			...
			{
				unk_0x440657FAB96ABF59(uParam1->f_1, 1);
			}
			if (!unk_0xE50EB54E0F21BED0(*uParam1, 0))
			{
				unk_0x36E99F43D00365FE(*uParam1, 16);
			}
			if (!unk_0xE50EB54E0F21BED0(uParam1->f_7, 0))
			{
				unk_0x36E99F43D00365FE(uParam1->f_7, 16);
				unk_0xC595907BB71C921D(uParam1->f_7, 105, 0);
			}
			unk_0x068BDE31F7D112BB("veh@boat@marquis@rps@enter_exit");
			iLocal_1462 = 1;
			break;
		...
		case 1:
			...
			if (((func_223(*uParam1, uParam1->f_1, &Local_122, &uLocal_133, 0, 1, 0, 1, 1) || func_223(uParam1->f_7, uParam1->f_1, &Local_122, &uLocal_133, 0, 1, 0, 1, 1)) || func_243(uParam1)) || (func_242(*uParam1, 50f) && iLocal_1518))
			{
				if (!unk_0xECEC7528A52B4EE8(*uParam1))
				{
					if (fVar1 <= 75f)
					{
						if (!unk_0xE50EB54E0F21BED0(uParam1->f_1, 0))
						{
							if (unk_0x0EC2B29D4172D225("veh@boat@marquis@rps@enter_exit"))
							{
								iLocal_1628 = unk_0xD955F1CC0BCABC78(0f, 0f, 0f, 0f, 0f, 0f, 2);
								unk_0xADAE2D0345EF09F9(iLocal_1628, uParam1->f_1, unk_0xED5AD56E2C551D1E(uParam1->f_1, "seat_dside_r"));
								unk_0xAD844C8843FC405C(*uParam1, iLocal_1628, "veh@boat@marquis@rps@enter_exit", "jump_out", 4f, -4f, 0, 1, 1148846080, 0);
							}
						}
					}
					else
					{
						...
						if (!unk_0xE50EB54E0F21BED0(uParam1->f_1, 0))
						{
							iLocal_1628 = unk_0xD955F1CC0BCABC78(0f, 0f, 0f, 0f, 0f, 0f, 2);
							unk_0xADAE2D0345EF09F9(iLocal_1628, uParam1->f_1, unk_0xED5AD56E2C551D1E(uParam1->f_1, "seat_dside_r"));
							unk_0xAD844C8843FC405C(*uParam1, iLocal_1628, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_steer_m", 4f, -1000f, 0, 1, 1148846080, 0);
						}
					}
				}
				if (!unk_0xECEC7528A52B4EE8(uParam1->f_7))
				{
					...
					{
						unk_0x4261814A9A26E86F(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_steer_f", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
						unk_0x4261814A9A26E86F(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_cower_loop_f", 1000f, -8f, -1, 1, 0, 0, 0, 0);
					}
					unk_0x1BBD0A5729AB1226(uVar0);
					unk_0x8A1AC8EBC73850C8(uParam1->f_7, uVar0);
					unk_0x8D5B447F21217223(&uVar0);
					unk_0x504B26425DFF773C(uParam1->f_7, 1);
				...
				if (!unk_0xECEC7528A52B4EE8(uParam1->f_9))
				{
					if (unk_0x4E8DA737B686529A(uParam1->f_9, 1805844857) != 1)
					{
						unk_0xCA089CD1A17D76DF(uParam1->f_9);
						unk_0x1DC2BF231DE6A016(uParam1->f_9, unk_0x7D2B9E6A64637269(), 200f, -1, 0, 0);
						unk_0x504B26425DFF773C(uParam1->f_9, 1);
					}
				}
				iLocal_1542 = 0;
				unk_0x46EDFC827DC67D89(*uParam1, 1, 1);
			...
			else
			{
				...
				if (!iLocal_1522)
				{
					if (unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_1574, 0))
					{
						if (!unk_0xECEC7528A52B4EE8(uParam1->f_9))
						{
							if (unk_0x4E8DA737B686529A(uParam1->f_9, 1805844857) != 1)
		...
		case 2:
			if (!unk_0xE50EB54E0F21BED0(*uParam1, 0))
			{
				if (!unk_0xE50EB54E0F21BED0(uParam1->f_1, 0))
				{
					if (unk_0x27FC1B0077581B37(uParam1->f_1, -1, 0) != *uParam1)
					{
						if (bLocal_1531)
						{
							if (unk_0xEEC203A73BC92E7E(iLocal_1628))
							{
								fVar2 = unk_0x0BC8768247440B3A(iLocal_1628);
							}
							if (fVar2 > 0.8f)
							{
								unk_0xCA089CD1A17D76DF(*uParam1);
								unk_0xB1D85A6C23F2F945(*uParam1, uParam1->f_1, -1);
							}
						}
						else
						{
							...
							if (fVar2 > 0.9f)
							{
								if (unk_0x4E8DA737B686529A(*uParam1, 1805844857) != 1)
								{
									unk_0x1DC2BF231DE6A016(*uParam1, unk_0x7D2B9E6A64637269(), 1000f, -1, 0, 0);
								}
							}
					...
					else if (unk_0x4E8DA737B686529A(*uParam1, -1273030092) != 1)
					{
						unk_0xA0F8D741F5D8E7E4(*uParam1, uParam1->f_1, unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), 8, 20f, 786468, 500f, -1f, 1);
					}
				}
				if (!iLocal_1520)
				{
	...
	switch (iLocal_1544)
	{
		case 0:
			if (!func_51())
			{
				if (iLocal_1543 == -1)
				{
					iLocal_1543 = unk_0xB36B8558948EA7A8(0, 4);
				}
		...
		case 2:
			if (func_220())
			{
				if (iLocal_1543 == -1)
				{
					iLocal_1543 = unk_0xB36B8558948EA7A8(0, 3);
				}
				else if (iLocal_1543 == 0)
				{
...
int func_241(int iParam0)
{
	switch (*iParam0)
	{
		case 0:
			...
			unk_0x8ADA462BC5F42FD8(Local_1045.f_0, unk_0x7D2B9E6A64637269(), 5000, 0, 2);
			*iParam0++;
			break;
...
int func_242(int iParam0, float fParam1)
{
	...
	if (unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) > 0)
	{
		if (!unk_0xECEC7528A52B4EE8(iParam0))
		{
			...
			if (unk_0xD4C5E892E2E71D05((Var0.f_0 - fParam1), (Var0.f_1 - fParam1), (Var0.f_2 - fParam1), (Var0.f_0 + fParam1), (Var0.f_1 + fParam1), (Var0.f_2 + fParam1)))
			{
				return 1;
			}
		}
...
int func_243(var uParam0)
{
	...
	{
		if (unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), uParam0->f_1, 1) || unk_0x83B12E293561B796(unk_0x7D2B9E6A64637269(), uParam0->f_1))
		{
			return 1;
		}
	}
...
void func_244(var uParam0, var uParam1)
{
	...
	switch (iLocal_1462)
	{
		...
		case 1:
			if (((((func_223(*uParam1, 0, &Local_122, &uLocal_133, 1, 0, 0, 1, 1) || func_254(&bLocal_1523)) || func_253(*uParam1, &uLocal_1596, 1f, 20f, &uLocal_1524)) || (func_242(*uParam1, 25f) && iLocal_1518)) || unk_0xDCD58F2C1C3707C7(-1, -1218.042f, -1549.616f, -3.3703f, -1185.349f, -1597.103f, 10.5993f, 46f)) || iLocal_1518)
			{
				unk_0x75B41F5020877259(0);
				...
				if (unk_0x7F716EA884E75E49(unk_0x7D2B9E6A64637269()) || (iVar2 && iVar1 != joaat("weapon_unarmed")))
				{
					unk_0x1DC2BF231DE6A016(*uParam1, unk_0x7D2B9E6A64637269(), 500f, -1, 0, 0);
				}
				else
				{
					unk_0x9DA29013F33252A6(*uParam1, unk_0x7D2B9E6A64637269(), 0, 16);
				}
				func_266(0);
				unk_0x46EDFC827DC67D89(*uParam1, 1, 1);
				iLocal_1518 = 1;
		...
		case 2:
			...
			{
				iVar0 = func_249(0, unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), 20f);
				if (iVar0 != 0)
				{
		...
		if (!func_51())
		{
			if (!iLocal_1518)
			{
				if (!iLocal_1519)
				{
					...
					else if (func_263(*uParam0, 1) < 20f && !unk_0x123480158F10FA67())
					{
						func_248(uParam0);
					}
				}
			...
			else
			{
				...
				if (!iLocal_1521)
				{
					if (unk_0x4E8DA737B686529A(*uParam0, 780511057) == 1)
					{
...
void func_246(var uParam0)
{
	if (!unk_0xECEC7528A52B4EE8(*uParam0))
	{
		...
		{
			if (unk_0x698F51FB33ADAF7B(*uParam0, "misscommon@response", "bring_it_on", 3))
			{
		...
		{
			if (unk_0x4E8DA737B686529A(*uParam0, -2017877118) != 1 && !func_51())
			{
		...
		{
			if (unk_0x698F51FB33ADAF7B(*uParam0, "misscommon@response", "threaten", 3))
			{
		...
		{
			if (unk_0x4E8DA737B686529A(*uParam0, -2017877118) != 1)
			{
...
void func_247(int iParam0, char* sParam1, char* sParam2)
{
	...
	unk_0x4261814A9A26E86F(0, sParam1, sParam2, 4f, -4f, -1, 0, 0, 0, 0, 0);
	unk_0x1BBD0A5729AB1226(uVar0);
...
void func_248(var uParam0)
{
	...
	else if (iLocal_1548 < 7)
	{
		if (func_45(&uLocal_1590) > fLocal_1559 && !func_51())
		{
			...
			func_44(&uLocal_1590);
			fLocal_1559 = unk_0x644B8DBA4F69BB73(5f, 8f);
			iLocal_1548++;
		}
	}
}
...
var func_249(bool bParam0, struct<3> Param1, float fParam4)
{
	...
	while (iVar0 <= 1)
	{
		if (!unk_0xECEC7528A52B4EE8(Local_2204[iVar0 /*9*/]))
		{
			if ((bParam0 && unk_0x9B9082138A642C14(Local_2204[iVar0 /*9*/])) || (!bParam0 && !unk_0x9B9082138A642C14(Local_2204[iVar0 /*9*/])))
			{
	...
	if (!unk_0xECEC7528A52B4EE8(Local_2204[iVar0 /*9*/]))
	{
		switch (Local_2204[iVar0 /*9*/].f_8)
		{
			case 0:
				...
				{
					if (unk_0x4E8DA737B686529A(Local_2204[iVar0 /*9*/], 242628503) != 1)
					{
						unk_0xCA089CD1A17D76DF(Local_2204[iVar0 /*9*/]);
						unk_0x5C679902079A7E80(&uVar1);
						unk_0x3C3DD4D53CF82FCD(0, Local_2204[iVar0 /*9*/].f_1, 1f, 0, 0, 786603, -1082130432);
						unk_0xFBF1F1BE9D437D22(0, Local_1563, 0);
						unk_0x1BBD0A5729AB1226(uVar1);
						unk_0x8A1AC8EBC73850C8(Local_2204[iVar0 /*9*/], uVar1);
						unk_0x8D5B447F21217223(&uVar1);
					}
				}
				else if (unk_0x4E8DA737B686529A(Local_2204[iVar0 /*9*/], 242628503) != 1 && unk_0x4E8DA737B686529A(Local_2204[iVar0 /*9*/], -2017877118) != 1)
				{
			...
			case 1:
				if (unk_0x4E8DA737B686529A(Local_2204[iVar0 /*9*/], -2017877118) != 1)
				{
			...
			case 2:
				if (unk_0x4E8DA737B686529A(Local_2204[iVar0 /*9*/], -1146898486) != 1)
				{
					unk_0x4B770B4D8C1A469B(Local_2204[iVar0 /*9*/], 1193033728, 0);
				}
				break;
			}
	}
	...
	if (!unk_0x6B9E71121F5B8154(iParam0))
	{
		if (bParam1)
		{
			if (unk_0x9B9082138A642C14(iParam0))
			{
				...
				if (iVar0 == 0)
				{
					unk_0x4261814A9A26E86F(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_a", 4f, -4f, -1, 1, unk_0x644B8DBA4F69BB73(0, 1065353216), 0, 0, 0);
				}
				else if (iVar0 == 1)
				{
					unk_0x4261814A9A26E86F(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_b", 4f, -4f, -1, 1, unk_0x644B8DBA4F69BB73(0, 1065353216), 0, 0, 0);
				}
				else
				{
					unk_0x4261814A9A26E86F(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_c", 4f, -4f, -1, 1, unk_0x644B8DBA4F69BB73(0, 1065353216), 0, 0, 0);
				}
			}
			else
			{
				...
				if (iVar0 == 0)
				{
					unk_0x4261814A9A26E86F(iParam0, "oddjobs@assassinate@multi@", "idle_a_pros", 4f, -4f, -1, 1, unk_0x644B8DBA4F69BB73(0, 1065353216), 0, 0, 0);
				}
				else
				{
					unk_0x4261814A9A26E86F(iParam0, "oddjobs@assassinate@multi@", "idle_a_pros", 4f, -4f, -1, 1, unk_0x644B8DBA4F69BB73(0, 1065353216), 0, 0, 0);
...
void func_255()
{
	if (unk_0x419E13582192CFEA(Local_1045.f_0))
	{
		if (!unk_0xECEC7528A52B4EE8(Local_1045.f_0))
		{
			unk_0xD991F7672CE8EAD3(Local_1045.f_0, 187, 1);
			unk_0xD991F7672CE8EAD3(Local_1045.f_0, 155, 1);
		}
	}
}
...
void func_260(var uParam0)
{
	...
	if (unk_0xBFCE58B2B3249999(uParam0->f_1, 0))
	{
		if (!unk_0xECEC7528A52B4EE8(*uParam0))
		{
			if (!unk_0x698F51FB33ADAF7B(*uParam0, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_m", 3))
			{
				unk_0x4261814A9A26E86F(*uParam0, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_m", 8f, -8f, -1, 1, 0, 0, 0, 0);
			}
			if (!unk_0x5976053523EA16C8(*uParam0))
			{
				unk_0x0F1058706D5A58B4(*uParam0, uParam0->f_1, 0, Var0, Var3, 1, 1, 0, 0, 2, 1);
			}
		}
		if (!unk_0xECEC7528A52B4EE8(uParam0->f_7))
		{
			if (!unk_0x698F51FB33ADAF7B(uParam0->f_7, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_f", 3))
			{
				unk_0x4261814A9A26E86F(uParam0->f_7, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_f", 8f, -8f, -1, 1, 0, 0, 0, 0);
			}
			if (!unk_0x5976053523EA16C8(uParam0->f_7))
			{
				unk_0x0F1058706D5A58B4(uParam0->f_7, uParam0->f_1, 0, Var6, Var9, 1, 1, 1, 0, 2, 1);
			}
		}
	}
}
...
void func_261(var uParam0, var uParam1)
{
	...
	{
		case 0:
			if (unk_0x4E8DA737B686529A(*uParam1, 242628503) != 1)
			{
				fVar1 = unk_0xA8D713A937F31250(*uParam1);
				if (fVar1 < (uParam0->f_4 - 20f) || fVar1 > (uParam0->f_4 + 20f))
				{
					if (unk_0x4E8DA737B686529A(*uParam1, 1920390111) != 1)
					{
						unk_0x12D312F073772E84(*uParam1, uParam0->f_4, 0);
					}
				}
				else
				{
					unk_0x5C679902079A7E80(&uVar0);
					unk_0x4261814A9A26E86F(0, "oddjobs@assassinate@multi@", "idle_a", 4f, -4f, -1, 1, 0, 0, 0, 0);
					unk_0x1BBD0A5729AB1226(uVar0);
					unk_0x8A1AC8EBC73850C8(*uParam1, uVar0);
					unk_0x8D5B447F21217223(&uVar0);
				}
...
{
	return func_281(unk_0xD56332194D622ECE(unk_0x638BDC79E655C1C2()), iParam0, iParam1);
}
...
int func_265(int iParam0)
{
	if (iLocal_1461 == 0)
	{
		if ((func_223(*iParam0, 0, &Local_122, &uLocal_133, 0, 0, 0, 1, 1) || func_254(&bLocal_1523)) || unk_0x16B4C536089C3CAD(-1, Local_1563, 25f))
		{
			return 1;
		}
	}
	...
	if (!iLocal_1527)
	{
		...
		while (iVar0 <= 1)
		{
			if (!unk_0xECEC7528A52B4EE8(Local_2204[iVar0 /*9*/]))
			{
				...
				if (iVar1 == 0 || iVar1 == 1)
				{
					if (unk_0x4E8DA737B686529A(Local_2204[iVar0 /*9*/], 1805844857) != 1)
					{
						unk_0x1DC2BF231DE6A016(Local_2204[iVar0 /*9*/], unk_0x7D2B9E6A64637269(), 200f, -1, 0, 0);
						unk_0x504B26425DFF773C(Local_2204[iVar0 /*9*/], 1);
					}
				}
				else if (unk_0x4E8DA737B686529A(Local_2204[iVar0 /*9*/], 1805844857) != 1)
				{
					unk_0x3C3DD4D53CF82FCD(Local_2204[iVar0 /*9*/], func_267(), 2f, 0, 0, 786603, -1082130432);
					unk_0x504B26425DFF773C(Local_2204[iVar0 /*9*/], 1);
				}
			}
			if (bParam0)
...
Vector3 func_267()
{
	...
	iVar3 = (unk_0xB36B8558948EA7A8(0, 65535) % 6);
	switch (iVar3)
	{
		case 0:
...
int func_268(int iParam0, var uParam1)
{
	if (unk_0xE0A6F16F546C8274())
	{
		...
		else if (unk_0x419E13582192CFEA(*iParam0))
		{
			if (unk_0xECEC7528A52B4EE8(*iParam0))
			{
				if (unk_0xBFCE58B2B3249999(iParam0->f_1, 0) && unk_0xA6E8FBD68548675F(*iParam0, iParam0->f_1, 1))
				{
					iLocal_1027 = 1;
				}
			...
			else if (unk_0xBFCE58B2B3249999(iParam0->f_1, 0))
			{
				if (unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iParam0->f_1, 0))
				{
					if (unk_0x4DDAC4C80BACF92C(iParam0->f_1) > 10f && unk_0x83B12E293561B796(iParam0->f_1, *iParam0))
					{
						if (unk_0xC49311A2A500FF09(*iParam0, 0))
						{
							unk_0x2B28BAEB9F9FF900(*iParam0);
						}
						unk_0xC595907BB71C921D(*iParam0, 0, 0);
						iLocal_1027 = 1;
						unk_0x2DC2890038BFF758(3f, 1073741824, 3);
						return 1;
					}
...
int func_271(var uParam0)
{
	...
	if (unk_0xA9C0BBFB9CBB66F1(*uParam0) && unk_0xA9C0BBFB9CBB66F1(uParam0->f_14))
	{
		return 1;
	}
	return 0;
...
void func_272(var uParam0, int iParam1)
{
	switch (iLocal_1461)
	{
		...
		case 1:
			if (!unk_0x419E13582192CFEA(iParam1->f_9))
			{
				iParam1->f_9 = unk_0x0FDCFECB2EF2BC1C(5, uParam0->f_16, uParam0->f_22, uParam0->f_25, 1, 1);
				unk_0xE37EB80DFB0D31FB(iParam1->f_9, 0, 0);
				unk_0x3C20070426E380C1(iParam1->f_9, "WORLD_HUMAN_SUNBATHE", uParam0->f_22, uParam0->f_25, 0, 0, 1);
				unk_0xA415F00D0E0DFBCE(iParam1->f_9, 17, 1);
			}
			if (!unk_0xECEC7528A52B4EE8(iParam1->f_7))
			{
				unk_0xBE91B077ADADE97F(iParam1->f_7, 1);
				unk_0x472BD05C38FE7A6B(iParam1->f_7, 0);
				unk_0x4170FE884DF7426D(iParam1->f_7, 0, 1, 0, 0);
				unk_0x4170FE884DF7426D(iParam1->f_7, 2, 1, 2, 0);
				unk_0x4170FE884DF7426D(iParam1->f_7, 3, 0, 3, 0);
				unk_0x4170FE884DF7426D(iParam1->f_7, 4, 0, 3, 0);
				unk_0x4170FE884DF7426D(iParam1->f_7, 8, 1, 0, 0);
			}
			if (unk_0x419E13582192CFEA(iParam1->f_1))
			{
				unk_0x32051C1124051B7B(iParam1->f_1, 1);
				unk_0xEDE553A156C99512(iParam1->f_1, 1);
				unk_0x8B58E7AC53EED9F1(iParam1->f_1, 1);
			}
			if (!unk_0xECEC7528A52B4EE8(*iParam1))
			{
				unk_0x472BD05C38FE7A6B(*iParam1, 0);
			...
			iLocal_1574 = unk_0x170478CC84C8AE2F(joaat("seashark"), -2190.741f, -470.3163f, -0.4779f, 308.1181f, 1, 1, 0);
			unk_0xE6B53A6E51AAA49F(uLocal_1589, 0);
			uLocal_1589 = unk_0x0823FA7465392E20(Vector(-0.10296f, -468.8926f, -2182.363f) - Vector(15f, 15f, 15f), Vector(-0.10296f, -468.8926f, -2182.363f) + Vector(15f, 15f, 15f), 0, 1, 1, 1);
			iLocal_1543 = -1;
			iLocal_1544 = 0;
			break;
		
		case 2:
			if ((!unk_0xECEC7528A52B4EE8(*iParam1) && unk_0x419E13582192CFEA(iParam1->f_11[0])) && unk_0x419E13582192CFEA(iParam1->f_11[1]))
			{
				func_38(&(iParam1->f_16), 3, *iParam1, "OJAmlWASHER", 0, 1);
				unk_0x0F1058706D5A58B4(*iParam1, iParam1->f_11[0], 0, -2.1f, -0.4f, 0.25f, 0f, 0f, 180f, 1, 1, 0, 0, 2, 1);
				unk_0x4261814A9A26E86F(*iParam1, "oddjobs@assassinate@multi@windowwasher", "_idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
				unk_0x83E421E5A4A2A512(iParam1->f_11[0], 225);
				unk_0x83E421E5A4A2A512(iParam1->f_11[1], 225);
			}
			break;
		...
		case 3:
			if (!unk_0xECEC7528A52B4EE8(*iParam1))
			{
				unk_0xA415F00D0E0DFBCE(*iParam1, 6, 1);
				unk_0x4C9F834EDF566D4A(*iParam1, 0, 4096, -1);
				unk_0xF1A4298C3391F2DD(*iParam1, 1);
				func_38(&uLocal_1629, 3, *iParam1, "OJAmlBIKER", 0, 1);
				func_38(&(iParam1->f_16), 3, *iParam1, "OJAmlBIKER", 0, 1);
				if (unk_0xBFCE58B2B3249999(iParam1->f_1, 0))
				{
					unk_0xB1D85A6C23F2F945(*iParam1, iParam1->f_1, -1);
					unk_0x47D0DDD8833C5E5F(iParam1->f_1, 1084227584);
				}
			}
			iLocal_1576 = unk_0x170478CC84C8AE2F(joaat("camper"), -1400.575f, 738.8264f, 182.1478f, 194.607f, 1, 1, 0);
			unk_0x47D0DDD8833C5E5F(iLocal_1576, 1084227584);
			iLocal_1577 = unk_0x170478CC84C8AE2F(joaat("bjxl"), -1371.269f, 734.4243f, 182.5433f, 182.766f, 1, 1, 0);
			unk_0x47D0DDD8833C5E5F(iLocal_1577, 1084227584);
			break;
	}
	if (!unk_0xECEC7528A52B4EE8(*iParam1))
	{
		unk_0xEA44C65D5434D223(*iParam1, 1, 0);
	}
}
...
void func_273()
{
	...
	Local_2204[0 /*9*/] = unk_0x0FDCFECB2EF2BC1C(5, joaat("a_f_y_fitness_02"), Local_2204[0 /*9*/].f_1, 169.9513f, 1, 1);
	func_252(Local_2204[0 /*9*/], 1);
	Local_2204[1 /*9*/] = unk_0x0FDCFECB2EF2BC1C(5, joaat("a_f_y_beach_01"), Local_2204[1 /*9*/].f_1, 257.4617f, 1, 1);
	func_252(Local_2204[1 /*9*/], 1);
	unk_0xA415F00D0E0DFBCE(Local_2204[0 /*9*/], 17, 1);
	unk_0xA415F00D0E0DFBCE(Local_2204[0 /*9*/], 1, 0);
	unk_0xBE91B077ADADE97F(Local_2204[0 /*9*/], 1);
	unk_0xA415F00D0E0DFBCE(Local_2204[1 /*9*/], 17, 1);
	unk_0xA415F00D0E0DFBCE(Local_2204[1 /*9*/], 1, 0);
	unk_0xBE91B077ADADE97F(Local_2204[1 /*9*/], 1);
}
...
void func_274(var uParam0, int iParam1)
{
	...
	func_38(&(iParam1->f_16), 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
	if (uParam0->f_274 == 1)
	{
	...
	if (unk_0x575B7C28D81C0B4D(iParam1->f_2))
	{
		unk_0x1AD5BCFEC31BB8D9(&(iParam1->f_2));
	}
	if (uParam0->f_274 == 1)
	{
		unk_0xDD944E3FD2028A48(iParam1->f_2, "ASS_HK_DESTBLIP");
	}
	else if (uParam0->f_274 == 0)
	{
	}
	...
	{
		if (!unk_0x419E13582192CFEA(iParam1->f_7))
		{
			iParam1->f_7 = unk_0x0FDCFECB2EF2BC1C(4, uParam0->f_14, uParam0->f_18, uParam0->f_21, 1, 1);
			if (uParam0->f_274 == 1)
			{
				unk_0x4261814A9A26E86F(iParam1->f_7, "ODDJOBS@ASSASSINATE@VICE@HOOKER", "idle_b", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
				unk_0x354924FCEF0851C8(iParam1->f_7, 1);
				func_38(&(iParam1->f_16), 4, iParam1->f_7, "OJAhkHOOKER", 0, 1);
				unk_0xBE91B077ADADE97F(iParam1->f_7, 1);
				unk_0xA415F00D0E0DFBCE(iParam1->f_7, 17, 1);
				unk_0x82D2BB48A39F1E88(iParam1->f_7, 128, 1);
				unk_0x7B28A83A0D3DD0F9(iParam1->f_7, 134, 1);
			}
		}
	}
	if (uParam0->f_15 != 0)
	{
		if (uParam0->f_274 != 0)
		{
			iParam1->f_8 = unk_0x170478CC84C8AE2F(uParam0->f_15, uParam0->f_26, uParam0->f_29, 1, 1, 0);
		}
		if (uParam0->f_274 == 1)
		{
			unk_0xB021D5C8EC8634FA(iParam1->f_8, 3, 0);
			unk_0x2B360ED559ED11A6(iParam1->f_8, 1);
			unk_0x2B360ED559ED11A6(iParam1->f_8, 0);
			iLocal_1029 = unk_0x42F3C85A00B4FC7B(iParam1->f_8, 4, uParam0->f_16, -1, 1, 1);
	...
	if (uParam0->f_274 == 2)
	{
		if (!unk_0x575B7C28D81C0B4D(iParam1->f_2))
		{
			iParam1->f_2 = unk_0x27E44C95E1D1461C(uParam0->f_6);
			unk_0x13CC211F9F7ACE7F(iParam1->f_2, 1);
			unk_0x1EF92774F7B1187E(iParam1->f_2, 1);
			unk_0xFA3E6ADC3E5D386E(iParam1->f_2, 1);
		}
	}
	else if (uParam0->f_274 == 0)
	{
		iParam1->f_2 = unk_0x27E44C95E1D1461C(uParam0->f_6);
		unk_0x13CC211F9F7ACE7F(iParam1->f_2, 1);
		unk_0x1EF92774F7B1187E(iParam1->f_2, 3);
		unk_0xFA3E6ADC3E5D386E(iParam1->f_2, 3);
		unk_0xDD944E3FD2028A48(iParam1->f_2, "ASS_BS_BLIP");
	}
	else
	{
		iParam1->f_2 = unk_0x27E44C95E1D1461C(uParam0->f_6);
	...
	while (iVar0 < 4)
	{
		...
		{
			iParam1->f_11[iVar0] = unk_0x795434E153F90E41(uParam0->f_244[iVar0], uParam0->f_249[iVar0 /*3*/], 1, 1, 0);
			unk_0xCE1DD60A1DF5A973(iParam1->f_11[iVar0], 1);
			unk_0x3CBE9F07524C242D(iParam1->f_11[iVar0], 1, 0);
			if (iVar0 == 1)
			{
				unk_0xA2C015B68CE01357(iParam1->f_11[iVar0], 1);
			}
			if (uParam0->f_262[iVar0] != 0f)
			{
				unk_0xCD37A28258D70638(iParam1->f_11[iVar0], uParam0->f_262[iVar0]);
			}
		}
		iVar0++;
	}
...
int func_279(var uParam0)
{
	...
	unk_0x16E516CA9C88FF48(joaat("a_f_y_fitness_02"));
	if ((unk_0xA9C0BBFB9CBB66F1(*uParam0) && unk_0xA9C0BBFB9CBB66F1(joaat("a_f_y_beach_01"))) && unk_0xA9C0BBFB9CBB66F1(joaat("a_f_y_fitness_02")))
	{
		return 1;
	}
	return 0;
...
{
	return func_250(unk_0xD56332194D622ECE(unk_0x638BDC79E655C1C2()), Param0, iParam3);
}
...
void func_282()
{
	...
	if (func_497(&uLocal_1602))
	{
		if (func_45(&uLocal_1602) > 30f)
		{
			...
			if (iLocal_1540 == 1)
			{
				if (unk_0x2A488C176D52CCA5(Var0, Local_1617[0 /*3*/]) < 100f || unk_0x6A86865E010A134F(unk_0x7D2B9E6A64637269()))
				{
					if (unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) == 0)
					{
			...
			{
				if (unk_0x2A488C176D52CCA5(Var0, Local_1617[1 /*3*/]) < 100f || unk_0x6A86865E010A134F(unk_0x7D2B9E6A64637269()))
				{
					if (unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) == 0)
					{
						unk_0xD63E470D46B4F8A5(unk_0x1146A9AE09CE2B14(), 2, 0);
			...
			{
				if (unk_0x2A488C176D52CCA5(Var0, Local_1617[2 /*3*/]) < 100f || unk_0x6A86865E010A134F(unk_0x7D2B9E6A64637269()))
				{
					if (unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) == 0)
					{
						unk_0xD63E470D46B4F8A5(unk_0x1146A9AE09CE2B14(), 2, 0);
...
void func_283()
{
	if (iLocal_1461 == 2)
	{
		if (!unk_0xD88C6898FFA824A3(&uLocal_1562))
		{
			if (!unk_0xECEC7528A52B4EE8(Local_1045.f_0))
			{
				if (!iLocal_1516)
				{
					unk_0x46EDFC827DC67D89(Local_1045.f_0, 1, 1);
					unk_0x451AB475C3CD97F2(Local_1045.f_0, 1, 1, 0, 1, 1, 0);
				}
			}
			if (unk_0xC1E412BF2D1D6DA1("WINDOWWASHERFALL_MASTER", 0))
			{
				unk_0x218077812CB5CC2A(-648.59f, 305.73f, 120f);
			}
			if (unk_0x8ACA9ACB93EC151E())
			{
				unk_0xD269EA3552557C81(1f);
			}
			iLocal_1516 = 1;
		}
		else if (!unk_0xD88C6898FFA824A3(&uLocal_1561))
		{
			if (!unk_0xECEC7528A52B4EE8(Local_1045.f_0))
			{
				if (!iLocal_1516)
			...
			if (unk_0xC1E412BF2D1D6DA1("WINDOWWASHERFALL_MASTER", 0))
			{
				unk_0x218077812CB5CC2A(-638.1931f, 306.014f, 121.4236f);
			}
			if (unk_0x8ACA9ACB93EC151E())
			{
				unk_0xD269EA3552557C81(1f);
...
void func_284(var uParam0, var uParam1)
{
	...
	if (unk_0x419E13582192CFEA(uParam1->f_11[0]))
	{
		Var9 = { unk_0xD6E677FAD7521410(uParam1->f_11[0], 1) };
	}
	else
	{
	...
	switch (iLocal_1550)
	{
			...
			if (!bLocal_1525)
			{
				if (iLocal_1461 == 2)
				{
					if (unk_0xB7A628320EFF8E47(Var0, Var3) < 40000f)
					{
						if (unk_0x419E13582192CFEA(uParam1->f_11[0]))
						{
							if (unk_0x419E13582192CFEA(uParam1->f_11[1]))
							{
								...
								else
								{
									if (!unk_0xD88C6898FFA824A3(&uLocal_1562))
									{
										uLocal_1562 = unk_0x6E43E6EB24D5F3FB(-648.59f, 305.73f, fVar13, 0f, 90f, 0f, fVar14, 0, -1f, 5f, 0.5f, 0, 0, 1, 5f, 1, 0);
									}
									if (!unk_0xD88C6898FFA824A3(&uLocal_1561))
									{
										uLocal_1561 = unk_0x6E43E6EB24D5F3FB(-638.93f, 304.92f, fVar13, 0f, 90f, 0f, fVar14, 0, -1f, 5f, 0.5f, 0, 0, 1, 5f, 1, 0);
									}
									if (unk_0xD88C6898FFA824A3(&uLocal_1561) && unk_0xD88C6898FFA824A3(&uLocal_1562))
									{
										unk_0xF2C714EC203F71D8(uLocal_1562, uParam1->f_11[1], uParam1->f_11[0], -648.59f, 305.73f, fVar13, -648.59f, 305.73f, Var9.f_2, fVar14, 0, 0, 0, 0);
										unk_0xF2C714EC203F71D8(uLocal_1561, uParam1->f_11[1], uParam1->f_11[0], -638.93f, 304.92f, fVar13, -638.93f, 304.92f, Var9.f_2, fVar14, 0, 0, 0, 0);
										bLocal_1525 = true;
										iLocal_1550 = 1;
									}
								}
		...
		case 1:
			...
			{
				if (unk_0xB4E725A8915BDF60(uParam1->f_11[0]))
				{
					if (iLocal_1462 < 2)
					{
						if (!unk_0xECEC7528A52B4EE8(*uParam1))
						{
							unk_0x5C679902079A7E80(&uVar12);
							unk_0x4261814A9A26E86F(0, "oddjobs@assassinate@multi@windowwasher", "_idle_to_up", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
							unk_0x4261814A9A26E86F(0, "oddjobs@assassinate@multi@windowwasher", "_up_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
							unk_0x1BBD0A5729AB1226(uVar12);
							unk_0x8A1AC8EBC73850C8(*uParam1, uVar12);
							unk_0x8D5B447F21217223(&uVar12);
						}
					}
					iLocal_1550 = 2;
				}
		...
		case 2:
			Var6 = { unk_0xD6E677FAD7521410(uParam1->f_11[0], 1) };
			if (unk_0xE50EB54E0F21BED0(*uParam1, 0))
			{
				iLocal_1550 = 3;
			}
			if (unk_0xD88C6898FFA824A3(&uLocal_1562) && unk_0xD88C6898FFA824A3(&uLocal_1561))
			{
				unk_0xF8AE879D2DF8CC1D(uLocal_1562);
				unk_0xF8AE879D2DF8CC1D(uLocal_1561);
				if (Var6.f_2 >= 125f)
				{
					if (iLocal_1462 < 2)
					{
						...
						{
							unk_0x5C679902079A7E80(&uVar12);
							unk_0x4261814A9A26E86F(0, "oddjobs@assassinate@multi@windowwasher", "_up_to_wash", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
							unk_0x4261814A9A26E86F(0, "oddjobs@assassinate@multi@windowwasher", "_wash_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
							unk_0x1BBD0A5729AB1226(uVar12);
							unk_0x8A1AC8EBC73850C8(*uParam1, uVar12);
							unk_0x8D5B447F21217223(&uVar12);
						}
					}
					unk_0xB5804B90CA0871B8(uLocal_1562);
					unk_0xB5804B90CA0871B8(uLocal_1561);
					iLocal_1550 = 3;
					unk_0xBC5268D1B5C5B73B(uParam1->f_11[0], 2, -20f, 0f, -20f, -4.78f, 0.65f, -0.78f, 0, 0, 0, 1, 0, 1);
				}
			}
			else
			{
...
void func_285()
{
	if (!unk_0x419E13582192CFEA(iLocal_1584))
	{
		if (!unk_0xE50EB54E0F21BED0(unk_0x7D2B9E6A64637269(), 0))
		{
			if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
			{
				iLocal_1584 = unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0);
				if (unk_0x419E13582192CFEA(iLocal_1584) && !unk_0xE50EB54E0F21BED0(iLocal_1584, 0))
				{
	...
	while (iVar0 < 9)
	{
		if (unk_0x419E13582192CFEA(Global_96701[iVar0]))
		{
			if (Global_96701[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0x6471F4759775FCA4(iParam0) == func_293(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0xBFCE58B2B3249999(iParam0, 0))
	{
		...
		*uParam1 = unk_0x8F77FF37B3B66EE9(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x191DDA30577F440A(&(uParam1->f_77), func_296(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_302()
{
	...
	if (!unk_0x419E13582192CFEA(iLocal_1466))
	{
		return;
	}
	if (!unk_0xE50EB54E0F21BED0(unk_0x7D2B9E6A64637269(), 0))
	...
	if (unk_0xB7A628320EFF8E47(Var0, Local_1469) > 10000f)
	{
		if (unk_0x419E13582192CFEA(iLocal_1466))
		{
			...
			unk_0x04F4D55F2C0C756D(&iLocal_1466);
		}
		if (unk_0x419E13582192CFEA(iLocal_1465))
		{
			unk_0x4603196EEEA2355C(iLocal_1465, 1, 0);
...
void func_304(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_371(unk_0x471C98FD94C0A5FD(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_364(unk_0x471C98FD94C0A5FD(), 1);
			if (iVar5 != -1)
			{
...
{
	func_306(&Global_105842, unk_0x471C98FD94C0A5FD(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_306(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_10();
	...
	if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
	{
		...
		func_324(unk_0x7D2B9E6A64637269());
		func_317(unk_0x7D2B9E6A64637269(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_316())
		{
			func_312(unk_0x7D2B9E6A64637269(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
int func_313(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2592627[iParam0 /*3*/][func_65(iParam1)];
...
void func_318(int iParam0, var uParam1)
{
	...
	if (!unk_0xECEC7528A52B4EE8(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x2CBBA235A635CC58(iParam0, func_323(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((unk_0xF98B272A945FAE61(iVar9, &Var11) && !func_320(Var11.f_1)) && iVar72 < 51)
			{
...
int func_330(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x02BFF15CAA701972())
	{
		if (func_332() == 0)
		{
			return unk_0x234B68AC2E35ED5A(func_70(func_331(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_376(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_19985)
	{
		if (Global_19798.f_1 == 6)
		{
			...
			func_378(1);
			func_380(Global_19779, "DISPLAY_VIEW", 1f, unk_0xBBDA792448DB5A89(Global_19778), -1082130432, -1082130432, -1082130432);
		}
	}
					...
					if (iVar0 == Global_7675[iVar1 /*15*/].f_4)
					{
						if (Global_8237[iVar0] == 0)
						{
							...
							if (Global_2463492)
							{
								if (iVar1 == 14)
								{
									func_379(Global_19779, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7675[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(Global_22188), -1f, &(Global_7675[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8237[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7675[iVar1 /*15*/].f_4)
					{
						if (Global_8237[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_379(Global_19779, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7675[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(Global_22193), -1f, &(Global_7675[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_77248)
								{
									...
									func_379(Global_19779, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7675[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(iVar4), -1f, &(Global_7675[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19798)
									...
									func_379(Global_19779, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7675[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(iVar6), -1f, &(Global_7675[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7675[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_379(Global_19779, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7675[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(iVar9), -1f, &(Global_7675[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_379(Global_19779, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7675[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(0), -1f, &(Global_7675[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8237[iVar0] = 1;
						}
					}
...
int func_389()
{
	unk_0x16E516CA9C88FF48(joaat("premier"));
	unk_0x16E516CA9C88FF48(joaat("dilettante"));
	unk_0x16E516CA9C88FF48(joaat("vigero"));
	while ((!unk_0xA9C0BBFB9CBB66F1(joaat("premier")) || !unk_0xA9C0BBFB9CBB66F1(joaat("dilettante"))) || !unk_0xA9C0BBFB9CBB66F1(joaat("vigero")))
	{
		return 0;
	}
	return 1;
...
int func_398(var uParam0, var uParam1, bool bParam2)
{
	...
	if ((!unk_0x080D38ACEC5DC1A2(3) && !func_394(&(uParam0->f_34))) && !func_390(uParam1))
	{
		func_501(uParam1);
		return 0;
	}
...
void func_416()
{
	if (!unk_0x419E13582192CFEA(uLocal_1578[0]))
	{
		uLocal_1578[0] = unk_0x170478CC84C8AE2F(iLocal_1585[0], -723.8201f, -916.5402f, 18.0145f, 267.798f, 1, 1, 0);
	}
	if (!unk_0x419E13582192CFEA(uLocal_1578[1]))
	{
		uLocal_1578[1] = unk_0x170478CC84C8AE2F(iLocal_1585[1], -735.5003f, -931.6205f, 18.0173f, 359.3239f, 1, 1, 0);
		unk_0x83E421E5A4A2A512(uLocal_1578[1], 100);
	}
	if (!unk_0x419E13582192CFEA(uLocal_1578[2]))
	{
		uLocal_1578[2] = unk_0x170478CC84C8AE2F(iLocal_1585[0], -726.7143f, -940.2681f, 18.0173f, 178.3615f, 1, 1, 0);
	}
	if (!unk_0x419E13582192CFEA(uLocal_1578[3]))
	{
		uLocal_1578[3] = unk_0x170478CC84C8AE2F(iLocal_1585[2], -730.5711f, -909.9425f, 18.0349f, 357.4066f, 1, 1, 0);
	}
}
	...
	if (func_401(uParam0))
	{
		...
		if (func_400(uParam0))
		{
			...
			if (unk_0x419E13582192CFEA(iVar0))
			{
				...
				else if ((!func_435(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && unk_0xDA654EB115F9FF7D(unk_0x471C98FD94C0A5FD(), "startup_positioning"))
				{
...
{
	if ((((((((((!unk_0x419E13582192CFEA(iParam0) || !unk_0xBFCE58B2B3249999(iParam0, 0)) || func_310(iParam0, 0, 0)) || func_310(iParam0, 1, 0)) || func_310(iParam0, 2, 0)) || func_291(iParam0) != 145) || func_425(iParam0)) || func_424(iParam0)) || func_423(iParam0)) || func_422(iParam0)) || !func_421(unk_0x6471F4759775FCA4(iParam0)))
	{
		if (func_424(iParam0))
		{
		}
...
int func_435(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_436(iParam0, uVar1[iVar6], 1) && func_402(unk_0xD6E677FAD7521410(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_209(Param1, 0f, 0f, 0f, 0)) || unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(iParam0, 1), unk_0xD6E677FAD7521410(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_438(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0x419E13582192CFEA(Global_96701[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x6471F4759775FCA4(Global_96701[iVar0]) == func_293(iParam0, iParam1))
				{
...
void func_439(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (unk_0xBFCE58B2B3249999(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (unk_0x234B68AC2E35ED5A(uParam1->f_77, func_296(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (unk_0x234B68AC2E35ED5A(uParam1->f_77, func_296(iVar1 + 1)))
			{
			}
			else
			{
				unk_0x191DDA30577F440A(&(uParam1->f_77), func_296(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (unk_0x234B68AC2E35ED5A(uParam1->f_77, func_296(iVar2)))
				{
				}
				else
				{
					unk_0x191DDA30577F440A(&(uParam1->f_77), func_296(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (unk_0x234B68AC2E35ED5A(uParam1->f_77, func_296(iVar3)))
				{
				}
				else
				{
					unk_0x191DDA30577F440A(&(uParam1->f_77), func_296(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (unk_0x234B68AC2E35ED5A(uParam1->f_77, func_296(iVar4)))
					{
					}
					else
					{
						unk_0x191DDA30577F440A(&(uParam1->f_77), func_296(iVar4));
					}
				}
				iVar4++;
			}
		...
		{
			if (unk_0x234B68AC2E35ED5A(uParam1->f_77, func_296(4)))
			{
			}
			else
			{
				unk_0x191DDA30577F440A(&(uParam1->f_77), func_296(4));
			}
		}
		...
		{
			unk_0x191DDA30577F440A(&(uParam1->f_77), func_296(1));
		}
		...
		if (((unk_0x234B68AC2E35ED5A(uParam1->f_77, 15) || func_447(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_446())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!unk_0xE267416B80E7921F(uParam1->f_66) && !unk_0x8D367F0B53916265(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (unk_0x234B68AC2E35ED5A(uParam1->f_77, func_296(iVar5 + 1)))
				{
...
int func_440(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_444(unk_0x6471F4759775FCA4(*iParam0), 1) && unk_0xB51972B58BF40F96(*iParam0, 24) != func_443(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x6895CB0D4F2E7CDC(*iParam0, 24, func_443(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_442(iParam0);
	if (func_441(*iParam0))
	{
...
int func_448(int iParam0)
{
	if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
	{
		if (!func_454(unk_0x1146A9AE09CE2B14(), -1))
		{
	...
	if (func_450(unk_0x1146A9AE09CE2B14()) == 3)
	{
		if (unk_0x419E13582192CFEA(iParam0) && unk_0xBFCE58B2B3249999(iParam0, 0))
		{
...
void func_456(var uParam0, var uParam1, bool bParam2)
{
	...
	while ((!unk_0x080D38ACEC5DC1A2(3) || !func_394(&(uParam0->f_34))) || !func_390(uParam1))
	{
		func_501(uParam1);
		unk_0x4EDE34FBADD967A6(0);
	}
...
void func_468(var uParam0)
{
	*uParam0 = joaat("s_m_y_winclean_01");
	...
	unk_0xC1E412BF2D1D6DA1("WINDOWWASHERFALL_MASTER", 0);
	fLocal_1558 = 500f;
}
...
int func_469(var uParam0, char* sParam1)
{
	...
	while (iVar0 < *uParam0)
	{
		if (!unk_0x4030103C8B148AFC((*uParam0)[iVar0]))
		{
			if (unk_0xDA654EB115F9FF7D((*uParam0)[iVar0], uParam1))
			{
				return 0;
			}
		}
...
void func_472()
{
	...
	while (iVar0 < 3)
	{
		unk_0x16E516CA9C88FF48(iLocal_1585[iVar0]);
		iVar0++;
	}
}
...
void func_475(var uParam0)
{
	...
	{
		case 0:
			unk_0x068BDE31F7D112BB("oddjobs@assassinate@multi@call");
			unk_0x16E516CA9C88FF48(joaat("p_phonebox_01b_s"));
			func_474();
			unk_0xC1B1E9A034A63A62(0);
			unk_0x952AB441FA24BF16("SCRIPT\ASSASSINATION_MULTI", false, -1);
			if ((unk_0x0EC2B29D4172D225("oddjobs@assassinate@multi@call") && unk_0xA9C0BBFB9CBB66F1(joaat("p_phonebox_01b_s"))) && func_389())
			{
				bLocal_1535 = true;
			}
			if (bLocal_1535)
			{
				if (unk_0x419E13582192CFEA(iLocal_1465))
				{
					...
					unk_0x6AF7EE4DD9F8B944(-700.1226f, -916.8699f, 18.1667f, 5f, 1, 0, 0, 0);
					...
					if (unk_0x419E13582192CFEA(iLocal_1465))
					{
						unk_0x4603196EEEA2355C(iLocal_1465, 0, 0);
						unk_0x3CBE9F07524C242D(iLocal_1465, 0, 0);
						unk_0xC22CF0F8AABFA658(iLocal_1465, 0);
						iLocal_1466 = unk_0x795434E153F90E41(joaat("p_phonebox_01b_s"), -700.1226f, -916.8699f, 18.1667f, 1, 1, 0);
						unk_0xBDDCDEC7B6205897(iLocal_1466, 0f, 0f, 0f, 2, 1);
						unk_0x3CBE9F07524C242D(iLocal_1466, 0, 0);
						unk_0xC22CF0F8AABFA658(iLocal_1466, 0);
					}
					uLocal_1506 = unk_0xD1F051AA4563F197(-700.1226f, -916.8699f, 18.1667f, 350f, 12, 127);
					func_481(1, 1, 1, 0, 0, 0, 0);
					if (!unk_0xE50EB54E0F21BED0(unk_0x7D2B9E6A64637269(), 0))
					{
						unk_0xE37EB80DFB0D31FB(unk_0x7D2B9E6A64637269(), 0, 0);
						unk_0x78CDDD1E6367978D(unk_0x7D2B9E6A64637269(), Local_1472, 1, 0, 0, 1);
						unk_0xCD37A28258D70638(unk_0x7D2B9E6A64637269(), fLocal_1475);
						unk_0x2FF622571073AA69(unk_0x7D2B9E6A64637269(), joaat("weapon_unarmed"), 1);
						unk_0x603ABA046B239722(unk_0x7D2B9E6A64637269(), 1);
					}
					uLocal_1505 = unk_0xD955F1CC0BCABC78(Local_1499, Local_1502, 2);
					if (unk_0x419E13582192CFEA(iLocal_1466))
					{
						unk_0xADAE2D0345EF09F9(uLocal_1505, iLocal_1466, -1);
					}
					unk_0xAD844C8843FC405C(unk_0x7D2B9E6A64637269(), iLocal_1505, "oddjobs@assassinate@multi@call", "ass_multi_target_call_p1", 1000f, -2f, 2, 0, 1148846080, 0);
					unk_0xED3365BAA5895E01(iLocal_1466, iLocal_1505, "ass_multi_target_call_phone", "oddjobs@assassinate@multi@call", 1000f, -2f, 0, 1148846080);
					if (!unk_0x0E8572B08CEB6A11(uLocal_1467))
					{
						uLocal_1468 = unk_0x1CA878DB277C6DF0(26379945, Local_1479, Local_1482, 35f, 1, 2);
						uLocal_1467 = unk_0x1CA878DB277C6DF0(26379945, Local_1485, Local_1488, 35f, 0, 2);
						unk_0x32279DAB93C9A9FA(uLocal_1467, uLocal_1468, 2500, 1, 1);
						unk_0x09F9466B03D29D2D(1, 0, 3000, 1, 0, 0);
						unk_0x9C9EC7CC88D050FA(uLocal_1467, "HAND_SHAKE", 0.2f);
					}
					func_416();
					func_38(&(uParam0->f_16), 3, 0, "LESTER", 0, 1);
					func_38(&(uParam0->f_16), 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
				...
				else
				{
					...
					if (!unk_0x419E13582192CFEA(iLocal_1465))
					{
						iLocal_1465 = unk_0xB219A5BFF547852F(Local_1469, 5f, joaat("prop_phonebox_01b"), 1, 0, 1);
					}
				}
			}
			break;
		...
		case 1:
			...
			if (!iLocal_1498)
			{
				if (!unk_0xE50EB54E0F21BED0(unk_0x7D2B9E6A64637269(), 0))
				{
					if (unk_0xEEC203A73BC92E7E(iLocal_1505))
					{
						if (unk_0x0BC8768247440B3A(iLocal_1505) > 0.05f)
						{
			...
			if (((func_497(&uLocal_1491) && func_45(&uLocal_1491) > fLocal_1476) || (unk_0xEEC203A73BC92E7E(iLocal_1505) && unk_0x0BC8768247440B3A(iLocal_1505) >= 0.978f)) || bLocal_1497)
			{
				iLocal_1464 = 3;
			}
			break;
		...
		case 2:
			...
			if (bLocal_1497)
			{
				if (unk_0x8B6A925F148E0E94())
				{
					...
					{
						unk_0xE37EB80DFB0D31FB(unk_0x7D2B9E6A64637269(), 0, 0);
						unk_0x78CDDD1E6367978D(unk_0x7D2B9E6A64637269(), -700.2628f, -917.5313f, 18.2147f, 1, 0, 0, 1);
						unk_0xCD37A28258D70638(unk_0x7D2B9E6A64637269(), 73.3924f);
					}
					unk_0x90ED32458AC2D129(iLocal_1466, -1000f, 1);
					unk_0x4EDE34FBADD967A6(0);
		...
		case 3:
			...
			if (unk_0xE2BB9441C54169BF(uLocal_1506))
			{
				unk_0xDF27EE31B849DF76(uLocal_1506);
			}
			unk_0x3CBE9F07524C242D(iLocal_1466, 1, 0);
			unk_0x2542B03313A1A1E5();
			...
			unk_0x87524F5C1E0857AB(unk_0x1146A9AE09CE2B14(), 0);
			unk_0xF9135F131C423364("oddjobs@assassinate@multi@call");
			unk_0x39E572BDDBA714A2(&iLocal_1465);
			iLocal_1042 = 4;
			break;
	}
}
...
int func_479(var uParam0, float fParam1, struct<3> Param2, struct<3> Param5, float fParam8, bool bParam9, float fParam10)
{
	if (unk_0x0E8572B08CEB6A11(*uParam0))
	{
		if (func_497(&uLocal_1494))
		{
			...
			{
				unk_0x7508AE96782B0441(uLocal_1467, Param2);
				unk_0xBD833AA6EB59C81B(uLocal_1467, Param5, 2);
				unk_0xEF20E9A7B745D17A(uLocal_1467, fParam8);
				if (bParam9)
				{
					unk_0x9C9EC7CC88D050FA(uLocal_1467, "HAND_SHAKE", fParam10);
				}
				return 1;
			}
		}
...
void func_481(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (unk_0x02BFF15CAA701972())
		{
			if (((((!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()) && !func_485(unk_0x1146A9AE09CE2B14())) && !func_483(unk_0x1146A9AE09CE2B14(), 0)) && !func_482()) && !bParam4) && !bParam5)
			{
				unk_0x8F160110753EB17B(unk_0x7D2B9E6A64637269(), 0);
			}
		}
		else if (((!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()) && !func_485(unk_0x1146A9AE09CE2B14())) && !bParam4) && !bParam5)
		{
			unk_0x8F160110753EB17B(unk_0x7D2B9E6A64637269(), 0);
		}
		Global_77246 = 0;
