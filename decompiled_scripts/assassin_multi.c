...
void __EntryFunction__()
{
	...
	if (unk_0xD4BE58A7E3E102AC(3))
	{
		...
		func_513();
		if (unk_0xD4B321D9096B01FC(iLocal_1465))
		{
			unk_0x2BBEC4B37B923F4B(iLocal_1465, 1, 0);
			unk_0x8C85E8C71AD74415(iLocal_1465, 1, 0);
			unk_0xE679FB04E61F88AA(iLocal_1465, 1);
		}
	...
	uLocal_1589 = unk_0x740FE9B7B3FE1CE5(Local_1563 - Vector(2f, 2f, 2f), Local_1563 + Vector(2f, 2f, 2f), 0, 1, 1, 1);
	func_508();
	iLocal_1444 = 1;
	...
	while (true)
	{
		...
		unk_0x643E26919A174002("M_ASS2", 0);
		...
		if (func_499(&uScriptParam_0))
		{
			if (func_498())
			{
				...
				unk_0x9E64FD43AF331B00(uLocal_1589, 0);
				func_518();
		...
		else if (!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
		{
			...
			{
				Global_111560.f_19958.f_6 = func_517();
				fLocal_134 = (Global_111560.f_19958.f_6 / 1000f);
...
int func_21(var uParam0)
{
	...
	{
		case 0:
			if (IntToFloat(iLocal_1545) >= ((fLocal_1560 * 1f) / 2f) && !unk_0xA99E47125B44409B())
			{
				func_38(&(uParam0->f_16), 1, unk_0x0FA8183DAD2B3203(), "FRANKLIN", 0, 1);
...
void func_39(int iParam0, var uParam1, float fParam2, var uParam3, bool bParam4)
{
	if (!*uParam3)
	{
		*iParam0 = unk_0x9B35D07DCD0F0B43();
		*uParam3 = 1;
	}
	*uParam1 = (unk_0x9B35D07DCD0F0B43() - *iParam0);
...
float func_45(var uParam0)
{
	if (func_497(uParam0))
	{
		...
		{
			return (func_46(unk_0xA2BC31158C8CEFD2(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
void func_48()
{
	if (!iLocal_1538)
	{
		if (unk_0xEBE4F888D9965006(unk_0x7C7787D2D7139A85()) > 0)
		{
			if (!func_51())
			{
				func_49(unk_0x0FA8183DAD2B3203(), "SPOT_POLICE", 24);
				iLocal_1538 = 1;
			}
		}
	}
...
{
	unk_0x39F932B751C1253B(iParam0, sParam1, func_50(iParam2), 1);
}
	...
	if (iLocal_1042 > 4)
	{
		if (!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
		{
			...
			if (unk_0xD4B321D9096B01FC(iVar0))
			{
				...
				{
					if ((iVar0 != iLocal_1583 && !unk_0xE294A1321110B3E9(iVar0)) && !unk_0x00123AB82C5FAC28(iVar0))
					{
						iLocal_1583 = iVar0;
						unk_0xE5C667CF3B4642D2(iLocal_1583, 1, 0);
						unk_0xB570C44B09DEF4A5(iLocal_1583, 0);
					}
				}
			}
		}
...
void func_53(struct<39> Param0, var uParam39, var uParam40)
{
	...
	switch (iLocal_1044)
	{
		...
		case 1:
			...
			if (func_141(&uLocal_150, 1, 0) && unk_0x1833CACA51B09D34())
			{
...
void func_101(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_107(uParam0->f_1, 256) || (func_107(uParam0->f_1, 8192) && unk_0x6BFFC38B3F0D92C2(2)))
	{
		...
		if (unk_0xE434AB6E3DE89861())
		{
			...
			unk_0x282C78036676E0C2(func_107(uParam0->f_1, 4096));
			unk_0xAC7C2DE2DDC7AF03();
		}
		iVar5 = 0;
		iVar6 = 0;
...
void func_110(var uParam0, bool bParam1)
{
	...
	func_106(unk_0x357127A2E350E9F6(2, 215, true));
	func_105("ES_HELP");
	if (unk_0xE434AB6E3DE89861())
	{
		unk_0x282C78036676E0C2(true);
	...
	if (bParam1)
	{
		unk_0xF1BC72CEC2746995(uParam0->f_4, "SET_DATA_SLOT");
		unk_0xD02F24F3E2DB263A(1);
		func_106(unk_0x357127A2E350E9F6(2, 216, true));
		func_105("ES_XPAND");
		if (unk_0xE434AB6E3DE89861())
		{
			unk_0x282C78036676E0C2(true);
...
void func_112(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_127();
		unk_0x6276EB2A4CC7B039(0.5f, (fVar1 - (func_130((2f - 0.5f)) - 0.001388889f)), fVar6, func_125(1f), uVar13, uVar14, uVar15, unk_0xF2DB717A73826179((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_111((fVar11 / (0.6f * func_130(25f))), 0f, 1f);
					func_127();
					unk_0x6276EB2A4CC7B039(0.5f, (fVar1 + func_130((2f * 0.5f))), fVar6, func_125(1f), uVar13, uVar14, uVar15, unk_0xF2DB717A73826179((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_130((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_130((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_556)
			{
				case 0:
					...
					unk_0xBD217E52410D1B67(fVar20, (fVar1 + func_130((2f * 2f))), 0);
					break;
...
var func_118(int iParam0, bool bParam1)
{
	...
	if (!unk_0x9591DE0F00127F2A(&(Global_22350.f_7013[iParam0 /*16*/])))
	{
		...
		{
			Var19 = { func_120(unk_0x7C7787D2D7139A85()) };
...
char* func_121(int iParam0)
{
	...
	if (!unk_0x9591DE0F00127F2A(&(Global_22350.f_6020[iParam0 /*16*/])))
	{
		...
		{
			Var16 = { func_120(unk_0x7C7787D2D7139A85()) };
...
void func_122(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	...
	unk_0xC81BF7585F33A61A(1);
	unk_0x8E0F19C19C409DDB(1f, func_124(14f));
	unk_0xA0147851A8831777(0);
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			unk_0x53017FFA0ED0CAF8("CommonMenu", func_118(7, 0), (fParam4 - 0.006f), ((fParam2 + func_130(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_115(5, 0, 1, &fVar5, &fVar6, 0);
			unk_0x53017FFA0ED0CAF8("CommonMenu", func_118(5, 0), (fParam4 - 0.006f), ((fParam2 + func_130(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_115(6, 0, 1, &fVar5, &fVar6, 0);
			unk_0x53017FFA0ED0CAF8("CommonMenu", func_118(6, 0), (fParam4 - 0.006f), ((fParam2 + func_130(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_123(int iParam0, int iParam1, float fParam2, float fParam3, char* sParam4, int iParam5)
{
	...
	switch (iParam5)
	{
		case 4:
		case 5:
			unk_0x8E0F19C19C409DDB(1f, func_124(18f));
...
void func_142(var uParam0)
{
	...
	unk_0xF1BC72CEC2746995(uParam0->f_4, "SET_DATA_SLOT");
	unk_0xD02F24F3E2DB263A(2);
	func_106(unk_0x357127A2E350E9F6(2, 188, true));
	func_105("ES_HELP_TU");
	unk_0xAC7C2DE2DDC7AF03();
	unk_0xF1BC72CEC2746995(uParam0->f_4, "SET_DATA_SLOT");
	unk_0xD02F24F3E2DB263A(1);
	func_106(unk_0x357127A2E350E9F6(2, 187, true));
	func_105("ES_HELP_TD");
	unk_0xAC7C2DE2DDC7AF03();
	unk_0xF1BC72CEC2746995(uParam0->f_4, "SET_DATA_SLOT");
	unk_0xD02F24F3E2DB263A(0);
	func_106(unk_0x357127A2E350E9F6(2, 202, true));
	func_105("ES_HELP_AB");
	unk_0xAC7C2DE2DDC7AF03();
	unk_0xF1BC72CEC2746995(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	unk_0xAC7C2DE2DDC7AF03();
...
void func_143(var uParam0)
{
	...
	fVar0 = 0f;
	unk_0xC81BF7585F33A61A(0);
	unk_0x8E0F19C19C409DDB(1f, func_124(16f));
	if (uParam0->f_31 == 0)
	{
		if (uParam0->f_29)
		{
...
void func_145()
{
	...
	if (!iLocal_139)
	{
		func_151(&uLocal_150, &Local_727, &Global_61486, 0);
...
void func_154(var uParam0)
{
	if (func_497(uParam0))
	{
		if (!func_47(uParam0))
		{
			uParam0->f_2 = (func_46(unk_0xA2BC31158C8CEFD2(*uParam0, 4)) - uParam0->f_1);
...
{
	uParam0->f_1 = (func_46(unk_0xA2BC31158C8CEFD2(*uParam0, 4)) - fParam1);
...
int func_156(var uParam0, var uParam1)
{
	...
	switch (iLocal_1042)
	{
		...
		case 4:
			...
			{
				iLocal_1556 = Global_98669.f_12[0];
				if (iLocal_1552 == 0)
				{
					iLocal_1540 = 0;
			...
			if (bLocal_1514)
			{
				...
				unk_0xB82DC93528F8603C(Local_1570, 5f, 1, 0, 0, 0);
		...
		case 6:
			...
			Global_98669.f_12[0] = iLocal_1556;
		...
		case 7:
			...
			if (iLocal_1461 >= 2)
			{
				if (unk_0xD4B321D9096B01FC(iLocal_1575))
				{
					if (func_281(iLocal_1575, unk_0x0FA8183DAD2B3203(), 1) > 500f)
					{
						unk_0xF25956700ADFD77F(&iLocal_1575);
					}
				}
			}
			if (!iLocal_1536)
			...
			{
				if ((func_264(uParam0, uParam1) || (unk_0x4412340828EC2614(unk_0x7C7787D2D7139A85(), *uParam1) && func_263(*uParam1, 1) < 150f)) || (unk_0x2A06948F22A49FC3(unk_0x7C7787D2D7139A85(), *uParam1) && func_263(*uParam1, 1) < 150f))
				{
					func_262(*uParam1);
					iLocal_1042 = 10;
				}
		...
		case 10:
			...
			{
				if (iLocal_1516 && !unk_0x2BF5E63466422C38(*uParam1))
				{
					func_258();
					unk_0x308CB1217E10567C(*uParam1, 1, 0, 0);
				}
		...
		case 11:
			...
			{
				if (!unk_0x2BF5E63466422C38(*uParam1) && iLocal_1461 == 2)
				{
					unk_0x0BBBAC4546BFE280(*uParam1, 0, 0);
				}
				if (iLocal_1461 == 1)
				{
					if (!unk_0x2BF5E63466422C38(uParam1->f_7))
					{
						unk_0xA12E1659DEF57244(&uVar0);
						unk_0x5D672CB011E20B28(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_quick_f", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
						unk_0x5D672CB011E20B28(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_cower_loop_f", 1000f, -8f, -1, 1, 0, 0, 0, 0);
						unk_0x15A7B753872B3CE3(uVar0);
						unk_0xC544A8E1032AC1CF(uParam1->f_7, uVar0);
					...
					if (unk_0xD4B321D9096B01FC(uParam1->f_1))
					{
						...
						{
							unk_0xB570C44B09DEF4A5(uParam1->f_1, 0);
						}
					}
				}
				iLocal_1540++;
		...
		case 12:
			...
			{
				unk_0x2136EFCE710EB280("SCRIPTED_SCANNER_REPORT_ASS_MULTI_01", 0f);
			}
			break;
	}
	return 0;
...
void func_166(var uParam0, int iParam1)
{
	...
	*iParam1 = 0;
	if (iLocal_1461 != 1)
	{
		unk_0xF25956700ADFD77F(&(iParam1->f_1));
		if (unk_0xD4B321D9096B01FC(iLocal_1575))
		{
			unk_0xF25956700ADFD77F(&iLocal_1575);
		}
	}
	else if (unk_0xD4B321D9096B01FC(iParam1->f_1))
	{
		iLocal_1575 = iParam1->f_1;
	}
	if (unk_0xD4B321D9096B01FC(iLocal_1574))
	{
		unk_0xF25956700ADFD77F(&iLocal_1574);
	}
	if (unk_0xD4B321D9096B01FC(iLocal_1577))
	{
		unk_0xF25956700ADFD77F(&iLocal_1577);
	}
	if (unk_0xD4B321D9096B01FC(iLocal_1576))
	{
		unk_0xF25956700ADFD77F(&iLocal_1576);
	}
	iLocal_1518 = 0;
	iLocal_1548 = 0;
	iLocal_143 = 0;
...
void func_177(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		if (!unk_0x9591DE0F00127F2A((*uParam0)[iVar0]))
		{
			unk_0x7D74D6A091150B86((*uParam0)[iVar0]);
		}
		iVar0++;
	}
}
...
void func_182(var uParam0, var uParam1)
{
	...
	if (uParam1->f_14 != 0)
	{
		unk_0xE0AC40EF164A2569(uParam1->f_14);
	}
	if (unk_0xD4B321D9096B01FC(*uParam0))
	{
		unk_0x0FFB05DA97E810B5(uParam0);
	...
	{
		unk_0x0FFB05DA97E810B5(&(uParam0->f_7));
	}
	if (unk_0xD4B321D9096B01FC(uParam0->f_9))
	{
		unk_0x0FFB05DA97E810B5(&(uParam0->f_9));
	}
}
...
void func_183(var uParam0, var uParam1)
{
	...
	unk_0xE0AC40EF164A2569(joaat("a_f_y_fitness_02"));
	if (unk_0xD4B321D9096B01FC(*uParam0))
	{
		unk_0x0FFB05DA97E810B5(uParam0);
	}
	...
	while (iVar0 <= 1)
	{
		if (unk_0xD4B321D9096B01FC(Local_2204[iVar0 /*9*/]))
		{
			unk_0x0FFB05DA97E810B5(&(Local_2204[iVar0 /*9*/]));
		}
		iVar0++;
	}
}
...
void func_184()
{
	...
	while (iVar0 < 4)
	{
		if (unk_0xD4B321D9096B01FC(uLocal_1578[iVar0]))
		{
			unk_0xF25956700ADFD77F(&(uLocal_1578[iVar0]));
		}
		iVar0++;
	}
}
...
void func_185()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			unk_0xE0AC40EF164A2569(iLocal_1585[iVar0]);
		}
		iVar0++;
	}
}
...
void func_191(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_215(iParam1) && unk_0x0975E9E48EA2CC7B(iParam1))
	{
		iVar1 = 0;
...
{
	if (func_215(unk_0x0FA8183DAD2B3203()))
	{
...
int func_196(char* sParam0)
{
	if (!func_197(1, 1, 0))
	{
		if ((!unk_0x9591DE0F00127F2A(sParam0) && func_217(sParam0)) || func_217("CMN_HINT"))
		{
			unk_0x0D23E3918F7AF11B(1);
		}
		return 0;
...
int func_197(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_204() || func_203(Global_4456448.f_190930)) || func_202())
	{
		if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
		{
			...
			iVar1 = func_201(unk_0x0FA8183DAD2B3203(), 0);
			if (((unk_0x2068C310844A89D8(iVar0, iVar1) || (unk_0x7F375072508F738F(iVar0) == joaat("apc") && iVar1 != -1)) || (unk_0x7F375072508F738F(iVar0) == joaat("akula") && iVar1 != -1)) || (((unk_0x7F375072508F738F(iVar0) == joaat("riot2") && iVar1 == 0) && func_200(iVar0, 10)) && unk_0xF05B9E4C6631EA28(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_198(int iParam0)
{
	if (iParam0 != func_28())
	{
		...
		else if ((Global_1312873 && iParam0 == unk_0x7C7787D2D7139A85()) && func_199(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
bool func_207()
{
	return func_208(unk_0x7C7787D2D7139A85());
}
...
int func_210(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_213(bParam1, bParam2, bParam3) || unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((unk_0x9B35D07DCD0F0B43() - uParam0->f_4) > 500)
			{
				...
				{
					if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 1) || func_211(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
	...
	switch (iLocal_1462)
	{
		...
		case 1:
			if (func_223(*uParam1, uParam1->f_1, &Local_122, &uLocal_133, 1, 0, 0, 1, 1) || iLocal_1518)
			{
				...
				{
					unk_0xDA778D908FD69EEE(*uParam1, 1, 1);
					if (unk_0x95ED3BD0F52D542A(*uParam1, uParam1->f_1, 0))
					{
						if (unk_0xD960230552BC4165(uParam1->f_1, 0))
						{
							if (!unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
							{
								unk_0x12038E5513D763A5(*uParam1, uParam1->f_1, unk_0x0FA8183DAD2B3203(), 8, 35f, 786468, 500f, -1f, 1);
							}
							else
							{
								unk_0xF7D74EF517BDB7D0(*uParam1, uParam1->f_1, unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0), 8, 35f, 786468, 500f, -1f, 1);
							}
						}
					}
					else
					{
						unk_0xF0E9590A910B74BE(*uParam1, unk_0x0FA8183DAD2B3203(), 1000f, -1, 0, 0);
					}
				}
				unk_0xC1B1E9A034A63A62(0);
				iLocal_1462 = 2;
			...
			{
				if (!unk_0x5294582CE404D3F4(*uParam1, 0))
				{
					unk_0xB425E338F85508A5(*uParam1, uParam1->f_1, -1);
					unk_0x1ECAE5FB4DE78CF8(uParam1->f_1, 1084227584);
				}
				unk_0xD32341B4ADEC0821(uParam1->f_1, 4f);
				unk_0xA12E1659DEF57244(&uVar0);
				unk_0x522D78AE25E882BB(0, uParam1->f_1, -1637.682f, 1018.619f, 152.1026f, 4, 22f, 786468, 10f, -1f, 1);
				unk_0x24BD9CEBA5D40F00(0, uParam1->f_1, 22f, 786468);
				unk_0x15A7B753872B3CE3(uVar0);
				unk_0xC544A8E1032AC1CF(*uParam1, uVar0);
				unk_0x78829A259A6975CD(&uVar0);
				iLocal_1517 = 1;
			}
			break;
		...
		case 2:
			...
			else if (!unk_0x2BF5E63466422C38(*uParam1))
			{
				if (!iLocal_1526)
				{
					if (!unk_0x5294582CE404D3F4(*uParam1, 0))
					{
						if (unk_0x411C065ADB822CD9(*uParam1, 780511057) != 1)
						{
							unk_0xDEB0AA30ABFDCF48(*uParam1, 1, 0);
							unk_0xF0E9590A910B74BE(*uParam1, unk_0x0FA8183DAD2B3203(), 1000f, -1, 0, 0);
							iLocal_1526 = 1;
						}
					}
				}
				if ((func_263(*uParam1, 1) < 15f && !func_51()) && !unk_0x3DAA08BFD9A801FD(*uParam1))
				{
					if (!iLocal_1521)
					{
...
{
	func_44(&uLocal_1590);
	fLocal_1559 = unk_0x64A3FFD9D62755C5(3f, 7f);
}
...
int func_224(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_225(unk_0x0FA8183DAD2B3203(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (unk_0x3DAA08BFD9A801FD(iParam0) && func_263(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_227(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (unk_0x9DCEF22792B5C15C(iParam0, 2))
	{
		...
		else
		{
			...
			if (unk_0x7E1657C6CCABF258(iParam0) || func_228(iVar3))
			{
				if (unk_0xC49563EAE7AACA6C(iParam1, unk_0xACE5E491FC1B0D37(iParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (unk_0x9B1F9CEC0CB28F35(unk_0x3D464779B732760F(iParam1), iParam0, 120f) && unk_0x20510084026BC387(iParam1, iParam0, 17))
		...
		if (unk_0xD960230552BC4165(iParam0, 0))
		{
			if (unk_0x300C62F79A4441EB(iParam0, -1, 0) != 0)
			{
				if (unk_0x63EA4FAF7CDEFEC7(unk_0x0FA8183DAD2B3203(), &iVar0, 1))
				{
					...
					{
						if (func_281(unk_0x0FA8183DAD2B3203(), iParam0, 1) < 40f)
						{
...
void func_230(var uParam0)
{
	...
	unk_0x088577CF98F96D05(uParam0->f_2, 1);
	unk_0x925BD1075D119B45(uParam0->f_2, 0);
}
...
int func_231(int iParam0, int iParam1, bool bParam2)
{
	...
	if (unk_0x905FBA24E7FA8D23(iParam0))
	{
		unk_0xBC0D06064C5B5413(uVar0, func_104(unk_0x393E9918BC37548A(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xBC0D06064C5B5413(uVar0, func_104(unk_0x393E9918BC37548A(), 0.7f, 0.7f));
		unk_0x14C335BB2F079BD4(uVar0, iParam1);
	}
	else if (unk_0x0F100E7952E44923(iParam0))
	{
...
void func_232(var uParam0)
{
	switch (iLocal_1462)
	{
		...
		case 1:
			if (!iLocal_1516)
			{
				if ((((func_223(*uParam0, 0, &Local_122, &uLocal_133, 0, 1, 0, 1, 1) || unk_0x381E4B25A3623531(unk_0xACE5E491FC1B0D37(*uParam0, 1), 15f, 0, 1)) || iLocal_1518) || func_263(*uParam0, 1) < 5f) || (unk_0x2F879C0BDBED0194(unk_0x0FA8183DAD2B3203()) && func_263(*uParam0, 1) <= 35f))
				{
					if (!unk_0x2BF5E63466422C38(*uParam0))
					{
						...
						unk_0x5D672CB011E20B28(*uParam0, "oddjobs@assassinate@multi@windowwasher", "_shot_reaction", 8f, -8f, -1, 2, 0, 0, 0, 0);
						iLocal_1462 = 2;
					}
				}
			}
		...
		case 2:
			...
			if (unk_0x411C065ADB822CD9(*uParam0, -2017877118) != 1 && unk_0x411C065ADB822CD9(*uParam0, 474215631) != 1)
			{
...
void func_234(var uParam0, var uParam1)
{
	...
	switch (iLocal_1462)
	{
		case 0:
			...
			{
				unk_0x16ADFD9590870396(uParam1->f_1, 1);
			}
			if (!unk_0xF4B969E0807E76C7(*uParam1, 0))
			{
				unk_0x13270E3387617690(*uParam1, 16);
			}
			if (!unk_0xF4B969E0807E76C7(uParam1->f_7, 0))
			{
				unk_0x13270E3387617690(uParam1->f_7, 16);
				unk_0x0BBBAC4546BFE280(uParam1->f_7, 105, 0);
			}
			unk_0x36B659209EBDD366("veh@boat@marquis@rps@enter_exit");
			iLocal_1462 = 1;
			break;
		...
		case 1:
			...
			if (((func_223(*uParam1, uParam1->f_1, &Local_122, &uLocal_133, 0, 1, 0, 1, 1) || func_223(uParam1->f_7, uParam1->f_1, &Local_122, &uLocal_133, 0, 1, 0, 1, 1)) || func_243(uParam1)) || (func_242(*uParam1, 50f) && iLocal_1518))
			{
				if (!unk_0x2BF5E63466422C38(*uParam1))
				{
					if (fVar1 <= 75f)
					{
						if (!unk_0xF4B969E0807E76C7(uParam1->f_1, 0))
						{
							if (unk_0xB25A0D192C6A0A5B("veh@boat@marquis@rps@enter_exit"))
							{
								iLocal_1628 = unk_0xF2A54C51C03CADAA(0f, 0f, 0f, 0f, 0f, 0f, 2);
								unk_0xADFCDA47D7031CF3(iLocal_1628, uParam1->f_1, unk_0xCC77DF450B31521D(uParam1->f_1, "seat_dside_r"));
								unk_0x8582CCEB95B1F1BE(*uParam1, iLocal_1628, "veh@boat@marquis@rps@enter_exit", "jump_out", 4f, -4f, 0, 1, 1148846080, 0);
							}
						}
					}
					else
					{
						...
						if (!unk_0xF4B969E0807E76C7(uParam1->f_1, 0))
						{
							iLocal_1628 = unk_0xF2A54C51C03CADAA(0f, 0f, 0f, 0f, 0f, 0f, 2);
							unk_0xADFCDA47D7031CF3(iLocal_1628, uParam1->f_1, unk_0xCC77DF450B31521D(uParam1->f_1, "seat_dside_r"));
							unk_0x8582CCEB95B1F1BE(*uParam1, iLocal_1628, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_steer_m", 4f, -1000f, 0, 1, 1148846080, 0);
						}
					}
				}
				if (!unk_0x2BF5E63466422C38(uParam1->f_7))
				{
					...
					{
						unk_0x5D672CB011E20B28(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_steer_f", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
						unk_0x5D672CB011E20B28(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_cower_loop_f", 1000f, -8f, -1, 1, 0, 0, 0, 0);
					}
					unk_0x15A7B753872B3CE3(uVar0);
					unk_0xC544A8E1032AC1CF(uParam1->f_7, uVar0);
					unk_0x78829A259A6975CD(&uVar0);
					unk_0x7D81B41B134BD6F2(uParam1->f_7, 1);
				...
				if (!unk_0x2BF5E63466422C38(uParam1->f_9))
				{
					if (unk_0x411C065ADB822CD9(uParam1->f_9, 1805844857) != 1)
					{
						unk_0xC6612209077465DD(uParam1->f_9);
						unk_0xF0E9590A910B74BE(uParam1->f_9, unk_0x0FA8183DAD2B3203(), 200f, -1, 0, 0);
						unk_0x7D81B41B134BD6F2(uParam1->f_9, 1);
					}
				}
				iLocal_1542 = 0;
				unk_0xDA778D908FD69EEE(*uParam1, 1, 1);
			...
			else
			{
				...
				if (!iLocal_1522)
				{
					if (unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), iLocal_1574, 0))
					{
						if (!unk_0x2BF5E63466422C38(uParam1->f_9))
						{
							if (unk_0x411C065ADB822CD9(uParam1->f_9, 1805844857) != 1)
		...
		case 2:
			if (!unk_0xF4B969E0807E76C7(*uParam1, 0))
			{
				if (!unk_0xF4B969E0807E76C7(uParam1->f_1, 0))
				{
					if (unk_0x300C62F79A4441EB(uParam1->f_1, -1, 0) != *uParam1)
					{
						if (bLocal_1531)
						{
							if (unk_0xB50E39CA0A3E6020(iLocal_1628))
							{
								fVar2 = unk_0x91F0628278985DB8(iLocal_1628);
							}
							if (fVar2 > 0.8f)
							{
								unk_0xC6612209077465DD(*uParam1);
								unk_0xB425E338F85508A5(*uParam1, uParam1->f_1, -1);
							}
						}
						else
						{
							...
							if (fVar2 > 0.9f)
							{
								if (unk_0x411C065ADB822CD9(*uParam1, 1805844857) != 1)
								{
									unk_0xF0E9590A910B74BE(*uParam1, unk_0x0FA8183DAD2B3203(), 1000f, -1, 0, 0);
								}
							}
					...
					else if (unk_0x411C065ADB822CD9(*uParam1, -1273030092) != 1)
					{
						unk_0x522D78AE25E882BB(*uParam1, uParam1->f_1, unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1), 8, 20f, 786468, 500f, -1f, 1);
					}
				}
				if (!iLocal_1520)
				{
...
void func_236(char* sParam0, int iParam1, bool bParam2, int iParam3, float fParam4, float fParam5, float fParam6, char* sParam7)
{
	...
	if (iParam3 != 0)
	{
		unk_0x5F5C6A264C2CA8B1(*iParam1, sParam0, iParam3, sParam7, 0, 0);
	}
	else if ((fParam4 != 0f || fParam5 != 0f) || fParam6 != 0f)
	{
		unk_0x0A41046A9C717367(*iParam1, sParam0, fParam4, fParam5, fParam6, sParam7, 0, 0, 0);
	}
	else
	{
		unk_0x9964F5BBD9415AB7(*iParam1, sParam0, sParam7, 1);
	}
}
	...
	switch (iLocal_1544)
	{
		case 0:
			if (!func_51())
			{
				if (iLocal_1543 == -1)
				{
					iLocal_1543 = unk_0xBAC643F143880136(0, 4);
				}
		...
		case 2:
			if (func_220())
			{
				if (iLocal_1543 == -1)
				{
					iLocal_1543 = unk_0xBAC643F143880136(0, 3);
				}
				else if (iLocal_1543 == 0)
				{
...
int func_241(int iParam0)
{
	switch (*iParam0)
	{
		case 0:
			...
			unk_0x6E2920E14F5F962C(Local_1045.f_0, unk_0x0FA8183DAD2B3203(), 5000, 0, 2);
			*iParam0++;
			break;
...
int func_242(int iParam0, float fParam1)
{
	...
	if (unk_0xEBE4F888D9965006(unk_0x7C7787D2D7139A85()) > 0)
	{
		if (!unk_0x2BF5E63466422C38(iParam0))
		{
			...
			if (unk_0x93C8A1C0AB43700A((Var0.f_0 - fParam1), (Var0.f_1 - fParam1), (Var0.f_2 - fParam1), (Var0.f_0 + fParam1), (Var0.f_1 + fParam1), (Var0.f_2 + fParam1)))
			{
				return 1;
			}
		}
...
int func_243(var uParam0)
{
	...
	{
		if (unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), uParam0->f_1, 1) || unk_0x7A10CED38342D31F(unk_0x0FA8183DAD2B3203(), uParam0->f_1))
		{
			return 1;
		}
	}
...
void func_244(var uParam0, var uParam1)
{
	...
	switch (iLocal_1462)
	{
		...
		case 1:
			if (((((func_223(*uParam1, 0, &Local_122, &uLocal_133, 1, 0, 0, 1, 1) || func_254(&bLocal_1523)) || func_253(*uParam1, &uLocal_1596, 1f, 20f, &uLocal_1524)) || (func_242(*uParam1, 25f) && iLocal_1518)) || unk_0x1B58046E9C881440(-1, -1218.042f, -1549.616f, -3.3703f, -1185.349f, -1597.103f, 10.5993f, 46f)) || iLocal_1518)
			{
				unk_0x623942A4F366F9BB(0);
				...
				if (unk_0x90D8021D13215A35(unk_0x0FA8183DAD2B3203()) || (iVar2 && iVar1 != joaat("weapon_unarmed")))
				{
					unk_0xF0E9590A910B74BE(*uParam1, unk_0x0FA8183DAD2B3203(), 500f, -1, 0, 0);
				}
				else
				{
					unk_0xF827FEB33E873F71(*uParam1, unk_0x0FA8183DAD2B3203(), 0, 16);
				}
				func_266(0);
				unk_0xDA778D908FD69EEE(*uParam1, 1, 1);
				iLocal_1518 = 1;
		...
		case 2:
			...
			{
				iVar0 = func_249(0, unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1), 20f);
				if (iVar0 != 0)
				{
		...
		if (!func_51())
		{
			if (!iLocal_1518)
			{
				if (!iLocal_1519)
				{
					...
					else if (func_263(*uParam0, 1) < 20f && !unk_0xA99E47125B44409B())
					{
						func_248(uParam0);
					}
				}
			...
			else
			{
				...
				if (!iLocal_1521)
				{
					if (unk_0x411C065ADB822CD9(*uParam0, 780511057) == 1)
					{
...
void func_246(var uParam0)
{
	if (!unk_0x2BF5E63466422C38(*uParam0))
	{
		...
		{
			if (unk_0xF6FD8019402CF03B(*uParam0, "misscommon@response", "bring_it_on", 3))
			{
		...
		{
			if (unk_0x411C065ADB822CD9(*uParam0, -2017877118) != 1 && !func_51())
			{
		...
		{
			if (unk_0xF6FD8019402CF03B(*uParam0, "misscommon@response", "threaten", 3))
			{
		...
		{
			if (unk_0x411C065ADB822CD9(*uParam0, -2017877118) != 1)
			{
...
void func_247(int iParam0, char* sParam1, char* sParam2)
{
	...
	unk_0x5D672CB011E20B28(0, sParam1, sParam2, 4f, -4f, -1, 0, 0, 0, 0, 0);
	unk_0x15A7B753872B3CE3(uVar0);
...
void func_248(var uParam0)
{
	...
	else if (iLocal_1548 < 7)
	{
		if (func_45(&uLocal_1590) > fLocal_1559 && !func_51())
		{
			...
			func_44(&uLocal_1590);
			fLocal_1559 = unk_0x64A3FFD9D62755C5(5f, 8f);
			iLocal_1548++;
		}
	}
}
...
var func_249(bool bParam0, struct<3> Param1, float fParam4)
{
	...
	while (iVar0 <= 1)
	{
		if (!unk_0x2BF5E63466422C38(Local_2204[iVar0 /*9*/]))
		{
			if ((bParam0 && unk_0x0F81A86FA23D44FA(Local_2204[iVar0 /*9*/])) || (!bParam0 && !unk_0x0F81A86FA23D44FA(Local_2204[iVar0 /*9*/])))
			{
	...
	if (!unk_0x2BF5E63466422C38(Local_2204[iVar0 /*9*/]))
	{
		switch (Local_2204[iVar0 /*9*/].f_8)
		{
			case 0:
				...
				{
					if (unk_0x411C065ADB822CD9(Local_2204[iVar0 /*9*/], 242628503) != 1)
					{
						unk_0xC6612209077465DD(Local_2204[iVar0 /*9*/]);
						unk_0xA12E1659DEF57244(&uVar1);
						unk_0x2DA4721F22121754(0, Local_2204[iVar0 /*9*/].f_1, 1f, 0, 0, 786603, -1082130432);
						unk_0xD65F7D9CC109BCC8(0, Local_1563, 0);
						unk_0x15A7B753872B3CE3(uVar1);
						unk_0xC544A8E1032AC1CF(Local_2204[iVar0 /*9*/], uVar1);
						unk_0x78829A259A6975CD(&uVar1);
					}
				}
				else if (unk_0x411C065ADB822CD9(Local_2204[iVar0 /*9*/], 242628503) != 1 && unk_0x411C065ADB822CD9(Local_2204[iVar0 /*9*/], -2017877118) != 1)
				{
			...
			case 1:
				if (unk_0x411C065ADB822CD9(Local_2204[iVar0 /*9*/], -2017877118) != 1)
				{
			...
			case 2:
				if (unk_0x411C065ADB822CD9(Local_2204[iVar0 /*9*/], -1146898486) != 1)
				{
					unk_0xDE8E5CE8855FA963(Local_2204[iVar0 /*9*/], 1193033728, 0);
				}
				break;
			}
	}
	...
	if (!unk_0x3DAA08BFD9A801FD(iParam0))
	{
		if (bParam1)
		{
			if (unk_0x0F81A86FA23D44FA(iParam0))
			{
				...
				if (iVar0 == 0)
				{
					unk_0x5D672CB011E20B28(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_a", 4f, -4f, -1, 1, unk_0x64A3FFD9D62755C5(0, 1065353216), 0, 0, 0);
				}
				else if (iVar0 == 1)
				{
					unk_0x5D672CB011E20B28(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_b", 4f, -4f, -1, 1, unk_0x64A3FFD9D62755C5(0, 1065353216), 0, 0, 0);
				}
				else
				{
					unk_0x5D672CB011E20B28(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_c", 4f, -4f, -1, 1, unk_0x64A3FFD9D62755C5(0, 1065353216), 0, 0, 0);
				}
			}
			else
			{
				...
				if (iVar0 == 0)
				{
					unk_0x5D672CB011E20B28(iParam0, "oddjobs@assassinate@multi@", "idle_a_pros", 4f, -4f, -1, 1, unk_0x64A3FFD9D62755C5(0, 1065353216), 0, 0, 0);
				}
				else
				{
					unk_0x5D672CB011E20B28(iParam0, "oddjobs@assassinate@multi@", "idle_a_pros", 4f, -4f, -1, 1, unk_0x64A3FFD9D62755C5(0, 1065353216), 0, 0, 0);
...
void func_255()
{
	if (unk_0xD4B321D9096B01FC(Local_1045.f_0))
	{
		if (!unk_0x2BF5E63466422C38(Local_1045.f_0))
		{
			unk_0x70CBCB37A00F34A2(Local_1045.f_0, 187, 1);
			unk_0x70CBCB37A00F34A2(Local_1045.f_0, 155, 1);
		}
	}
}
...
void func_260(var uParam0)
{
	...
	if (unk_0xD960230552BC4165(uParam0->f_1, 0))
	{
		if (!unk_0x2BF5E63466422C38(*uParam0))
		{
			if (!unk_0xF6FD8019402CF03B(*uParam0, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_m", 3))
			{
				unk_0x5D672CB011E20B28(*uParam0, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_m", 8f, -8f, -1, 1, 0, 0, 0, 0);
			}
			if (!unk_0xCA7317DE7E0F89E9(*uParam0))
			{
				unk_0x01DF2D3988024DB4(*uParam0, uParam0->f_1, 0, Var0, Var3, 1, 1, 0, 0, 2, 1);
			}
		}
		if (!unk_0x2BF5E63466422C38(uParam0->f_7))
		{
			if (!unk_0xF6FD8019402CF03B(uParam0->f_7, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_f", 3))
			{
				unk_0x5D672CB011E20B28(uParam0->f_7, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_f", 8f, -8f, -1, 1, 0, 0, 0, 0);
			}
			if (!unk_0xCA7317DE7E0F89E9(uParam0->f_7))
			{
				unk_0x01DF2D3988024DB4(uParam0->f_7, uParam0->f_1, 0, Var6, Var9, 1, 1, 1, 0, 2, 1);
			}
		}
	}
}
...
void func_261(var uParam0, var uParam1)
{
	...
	{
		case 0:
			if (unk_0x411C065ADB822CD9(*uParam1, 242628503) != 1)
			{
				fVar1 = unk_0xD2809C7F7FD79247(*uParam1);
				if (fVar1 < (uParam0->f_4 - 20f) || fVar1 > (uParam0->f_4 + 20f))
				{
					if (unk_0x411C065ADB822CD9(*uParam1, 1920390111) != 1)
					{
						unk_0xF671F163E3851D8B(*uParam1, uParam0->f_4, 0);
					}
				}
				else
				{
					unk_0xA12E1659DEF57244(&uVar0);
					unk_0x5D672CB011E20B28(0, "oddjobs@assassinate@multi@", "idle_a", 4f, -4f, -1, 1, 0, 0, 0, 0);
					unk_0x15A7B753872B3CE3(uVar0);
					unk_0xC544A8E1032AC1CF(*uParam1, uVar0);
					unk_0x78829A259A6975CD(&uVar0);
				}
...
{
	return func_281(unk_0x23625FE58BACEBFD(unk_0x7A8732CFB5113E77()), iParam0, iParam1);
}
...
int func_265(int iParam0)
{
	if (iLocal_1461 == 0)
	{
		if ((func_223(*iParam0, 0, &Local_122, &uLocal_133, 0, 0, 0, 1, 1) || func_254(&bLocal_1523)) || unk_0x54D242CA888C9BF1(-1, Local_1563, 25f))
		{
			return 1;
		}
	}
	...
	if (!iLocal_1527)
	{
		...
		while (iVar0 <= 1)
		{
			if (!unk_0x2BF5E63466422C38(Local_2204[iVar0 /*9*/]))
			{
				...
				if (iVar1 == 0 || iVar1 == 1)
				{
					if (unk_0x411C065ADB822CD9(Local_2204[iVar0 /*9*/], 1805844857) != 1)
					{
						unk_0xF0E9590A910B74BE(Local_2204[iVar0 /*9*/], unk_0x0FA8183DAD2B3203(), 200f, -1, 0, 0);
						unk_0x7D81B41B134BD6F2(Local_2204[iVar0 /*9*/], 1);
					}
				}
				else if (unk_0x411C065ADB822CD9(Local_2204[iVar0 /*9*/], 1805844857) != 1)
				{
					unk_0x2DA4721F22121754(Local_2204[iVar0 /*9*/], func_267(), 2f, 0, 0, 786603, -1082130432);
					unk_0x7D81B41B134BD6F2(Local_2204[iVar0 /*9*/], 1);
				}
			}
			if (bParam0)
...
Vector3 func_267()
{
	...
	iVar3 = (unk_0xBAC643F143880136(0, 65535) % 6);
	switch (iVar3)
	{
		case 0:
...
int func_268(int iParam0, var uParam1)
{
	if (unk_0xBF28CCACDDFF5346())
	{
		...
		else if (unk_0xD4B321D9096B01FC(*iParam0))
		{
			if (unk_0x2BF5E63466422C38(*iParam0))
			{
				if (unk_0xD960230552BC4165(iParam0->f_1, 0) && unk_0x3656B691E303FDE0(*iParam0, iParam0->f_1, 1))
				{
					iLocal_1027 = 1;
				}
			...
			else if (unk_0xD960230552BC4165(iParam0->f_1, 0))
			{
				if (unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), iParam0->f_1, 0))
				{
					if (unk_0xB8D4A2BAA78AB950(iParam0->f_1) > 10f && unk_0x7A10CED38342D31F(iParam0->f_1, *iParam0))
					{
						if (unk_0x5294582CE404D3F4(*iParam0, 0))
						{
							unk_0x74DCEB05B4DA59AD(*iParam0);
						}
						unk_0x0BBBAC4546BFE280(*iParam0, 0, 0);
						iLocal_1027 = 1;
						unk_0xE9A303771BF0C29A(3f, 1073741824, 3);
						return 1;
					}
...
int func_271(var uParam0)
{
	...
	if (unk_0x6DF9C43E3CC645BC(*uParam0) && unk_0x6DF9C43E3CC645BC(uParam0->f_14))
	{
		return 1;
	}
	return 0;
...
void func_272(var uParam0, int iParam1)
{
	switch (iLocal_1461)
	{
		...
		case 1:
			if (!unk_0xD4B321D9096B01FC(iParam1->f_9))
			{
				iParam1->f_9 = unk_0xB983F26E7AFB47BF(5, uParam0->f_16, uParam0->f_22, uParam0->f_25, 1, 1);
				unk_0xCFEC09B98C6C5993(iParam1->f_9, 0, 0);
				unk_0x21F540B8E4F23B03(iParam1->f_9, "WORLD_HUMAN_SUNBATHE", uParam0->f_22, uParam0->f_25, 0, 0, 1);
				unk_0xDEB0AA30ABFDCF48(iParam1->f_9, 17, 1);
			}
			if (!unk_0x2BF5E63466422C38(iParam1->f_7))
			{
				unk_0xCC94EE23853F38E4(iParam1->f_7, 1);
				unk_0x11BA22EEA4D73366(iParam1->f_7, 0);
				unk_0x0453EBC0FB8D8A80(iParam1->f_7, 0, 1, 0, 0);
				unk_0x0453EBC0FB8D8A80(iParam1->f_7, 2, 1, 2, 0);
				unk_0x0453EBC0FB8D8A80(iParam1->f_7, 3, 0, 3, 0);
				unk_0x0453EBC0FB8D8A80(iParam1->f_7, 4, 0, 3, 0);
				unk_0x0453EBC0FB8D8A80(iParam1->f_7, 8, 1, 0, 0);
			}
			if (unk_0xD4B321D9096B01FC(iParam1->f_1))
			{
				unk_0xF0ACB85418455412(iParam1->f_1, 1);
				unk_0x4B49D40DB6CF2B2B(iParam1->f_1, 1);
				unk_0x9D3FE4786B8925D2(iParam1->f_1, 1);
			}
			if (!unk_0x2BF5E63466422C38(*iParam1))
			{
				unk_0x11BA22EEA4D73366(*iParam1, 0);
				func_38(&uLocal_1629, 3, *iParam1, "OJAmlYACHTTARGET", 0, 1);
				func_38(&(iParam1->f_16), 3, *iParam1, "OJAmlYACHTTARGET", 0, 1);
				unk_0xDA778D908FD69EEE(*iParam1, 1, 1);
			}
			iLocal_1574 = unk_0x847817A65E16621A(joaat("seashark"), -2190.741f, -470.3163f, -0.4779f, 308.1181f, 1, 1, 0);
			unk_0x9E64FD43AF331B00(uLocal_1589, 0);
			uLocal_1589 = unk_0x740FE9B7B3FE1CE5(Vector(-0.10296f, -468.8926f, -2182.363f) - Vector(15f, 15f, 15f), Vector(-0.10296f, -468.8926f, -2182.363f) + Vector(15f, 15f, 15f), 0, 1, 1, 1);
			iLocal_1543 = -1;
			iLocal_1544 = 0;
			break;
		
		case 2:
			if ((!unk_0x2BF5E63466422C38(*iParam1) && unk_0xD4B321D9096B01FC(iParam1->f_11[0])) && unk_0xD4B321D9096B01FC(iParam1->f_11[1]))
			{
				func_38(&(iParam1->f_16), 3, *iParam1, "OJAmlWASHER", 0, 1);
				unk_0x01DF2D3988024DB4(*iParam1, iParam1->f_11[0], 0, -2.1f, -0.4f, 0.25f, 0f, 0f, 180f, 1, 1, 0, 0, 2, 1);
				unk_0x5D672CB011E20B28(*iParam1, "oddjobs@assassinate@multi@windowwasher", "_idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
				unk_0x5C566093AEF7FD18(iParam1->f_11[0], 225);
				unk_0x5C566093AEF7FD18(iParam1->f_11[1], 225);
			}
			break;
		...
		case 3:
			if (!unk_0x2BF5E63466422C38(*iParam1))
			{
				unk_0xDEB0AA30ABFDCF48(*iParam1, 6, 1);
				unk_0x19B5693CAD014B0F(*iParam1, 0, 4096, -1);
				unk_0xE62BE0EB9BC772E3(*iParam1, 1);
				func_38(&uLocal_1629, 3, *iParam1, "OJAmlBIKER", 0, 1);
				func_38(&(iParam1->f_16), 3, *iParam1, "OJAmlBIKER", 0, 1);
				if (unk_0xD960230552BC4165(iParam1->f_1, 0))
				{
					unk_0xB425E338F85508A5(*iParam1, iParam1->f_1, -1);
					unk_0x1ECAE5FB4DE78CF8(iParam1->f_1, 1084227584);
				}
			}
			iLocal_1576 = unk_0x847817A65E16621A(joaat("camper"), -1400.575f, 738.8264f, 182.1478f, 194.607f, 1, 1, 0);
			unk_0x1ECAE5FB4DE78CF8(iLocal_1576, 1084227584);
			iLocal_1577 = unk_0x847817A65E16621A(joaat("bjxl"), -1371.269f, 734.4243f, 182.5433f, 182.766f, 1, 1, 0);
			unk_0x1ECAE5FB4DE78CF8(iLocal_1577, 1084227584);
			break;
	}
	if (!unk_0x2BF5E63466422C38(*iParam1))
	{
		unk_0xD35ECDBE422E2361(*iParam1, 1, 0);
	}
}
...
void func_273()
{
	...
	Local_2204[0 /*9*/] = unk_0xB983F26E7AFB47BF(5, joaat("a_f_y_fitness_02"), Local_2204[0 /*9*/].f_1, 169.9513f, 1, 1);
	func_252(Local_2204[0 /*9*/], 1);
	Local_2204[1 /*9*/] = unk_0xB983F26E7AFB47BF(5, joaat("a_f_y_beach_01"), Local_2204[1 /*9*/].f_1, 257.4617f, 1, 1);
	func_252(Local_2204[1 /*9*/], 1);
	unk_0xDEB0AA30ABFDCF48(Local_2204[0 /*9*/], 17, 1);
	unk_0xDEB0AA30ABFDCF48(Local_2204[0 /*9*/], 1, 0);
	unk_0xCC94EE23853F38E4(Local_2204[0 /*9*/], 1);
	unk_0xDEB0AA30ABFDCF48(Local_2204[1 /*9*/], 17, 1);
	unk_0xDEB0AA30ABFDCF48(Local_2204[1 /*9*/], 1, 0);
	unk_0xCC94EE23853F38E4(Local_2204[1 /*9*/], 1);
}
...
void func_274(var uParam0, int iParam1)
{
	...
	func_38(&(iParam1->f_16), 1, unk_0x0FA8183DAD2B3203(), "FRANKLIN", 0, 1);
	if (uParam0->f_274 == 1)
	{
	...
	if (unk_0x39A01A052D9B5FF0(iParam1->f_2))
	{
		unk_0xAA2276003B2ADF1B(&(iParam1->f_2));
	}
	if (uParam0->f_274 == 1)
	{
		unk_0x058B6969CEED705F(iParam1->f_2, "ASS_HK_DESTBLIP");
	}
	else if (uParam0->f_274 == 0)
	{
	}
	...
	{
		if (!unk_0xD4B321D9096B01FC(iParam1->f_7))
		{
			iParam1->f_7 = unk_0xB983F26E7AFB47BF(4, uParam0->f_14, uParam0->f_18, uParam0->f_21, 1, 1);
			if (uParam0->f_274 == 1)
			{
				unk_0x5D672CB011E20B28(iParam1->f_7, "ODDJOBS@ASSASSINATE@VICE@HOOKER", "idle_b", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
				unk_0xB35478A1AA54EA1A(iParam1->f_7, 1);
				func_38(&(iParam1->f_16), 4, iParam1->f_7, "OJAhkHOOKER", 0, 1);
				unk_0xCC94EE23853F38E4(iParam1->f_7, 1);
				unk_0xDEB0AA30ABFDCF48(iParam1->f_7, 17, 1);
				unk_0x3A6FD57A8EC62253(iParam1->f_7, 128, 1);
				unk_0x1DB66BD2267055C0(iParam1->f_7, 134, 1);
			}
		}
	}
	if (uParam0->f_15 != 0)
	{
		if (uParam0->f_274 != 0)
		{
			iParam1->f_8 = unk_0x847817A65E16621A(uParam0->f_15, uParam0->f_26, uParam0->f_29, 1, 1, 0);
		}
		if (uParam0->f_274 == 1)
		{
			unk_0xE40520F16D25E48C(iParam1->f_8, 3, 0);
			unk_0x302E0AC3BB715211(iParam1->f_8, 1);
			unk_0x302E0AC3BB715211(iParam1->f_8, 0);
			iLocal_1029 = unk_0x81024A420EDCE2B5(iParam1->f_8, 4, uParam0->f_16, -1, 1, 1);
	...
	if (uParam0->f_274 == 2)
	{
		if (!unk_0x39A01A052D9B5FF0(iParam1->f_2))
		{
			iParam1->f_2 = unk_0xACAD99314B51277E(uParam0->f_6);
			unk_0x925BD1075D119B45(iParam1->f_2, 1);
			unk_0x878F49741469A18E(iParam1->f_2, 1);
			unk_0x088577CF98F96D05(iParam1->f_2, 1);
		}
	}
	else if (uParam0->f_274 == 0)
	{
		iParam1->f_2 = unk_0xACAD99314B51277E(uParam0->f_6);
		unk_0x925BD1075D119B45(iParam1->f_2, 1);
		unk_0x878F49741469A18E(iParam1->f_2, 3);
		unk_0x088577CF98F96D05(iParam1->f_2, 3);
		unk_0x058B6969CEED705F(iParam1->f_2, "ASS_BS_BLIP");
	}
	else
	{
		iParam1->f_2 = unk_0xACAD99314B51277E(uParam0->f_6);
	...
	while (iVar0 < 4)
	{
		...
		{
			iParam1->f_11[iVar0] = unk_0x7187764DB5121FC9(uParam0->f_244[iVar0], uParam0->f_249[iVar0 /*3*/], 1, 1, 0);
			unk_0x775879DF24E29944(iParam1->f_11[iVar0], 1);
			unk_0x8C85E8C71AD74415(iParam1->f_11[iVar0], 1, 0);
			if (iVar0 == 1)
			{
				unk_0x860A5CC30A0EF207(iParam1->f_11[iVar0], 1);
			}
			if (uParam0->f_262[iVar0] != 0f)
			{
				unk_0x5A2B7C446C0CF087(iParam1->f_11[iVar0], uParam0->f_262[iVar0]);
			}
		}
		iVar0++;
	}
...
int func_279(var uParam0)
{
	...
	unk_0x6BB2B1818CAE531E(joaat("a_f_y_fitness_02"));
	if ((unk_0x6DF9C43E3CC645BC(*uParam0) && unk_0x6DF9C43E3CC645BC(joaat("a_f_y_beach_01"))) && unk_0x6DF9C43E3CC645BC(joaat("a_f_y_fitness_02")))
	{
		return 1;
	}
	return 0;
...
{
	return func_250(unk_0x23625FE58BACEBFD(unk_0x7A8732CFB5113E77()), Param0, iParam3);
}
...
void func_282()
{
	...
	if (func_497(&uLocal_1602))
	{
		if (func_45(&uLocal_1602) > 30f)
		{
			...
			if (iLocal_1540 == 1)
			{
				if (unk_0x2A488C176D52CCA5(Var0, Local_1617[0 /*3*/]) < 100f || unk_0x2F879C0BDBED0194(unk_0x0FA8183DAD2B3203()))
				{
					if (unk_0xEBE4F888D9965006(unk_0x7C7787D2D7139A85()) == 0)
					{
			...
			{
				if (unk_0x2A488C176D52CCA5(Var0, Local_1617[1 /*3*/]) < 100f || unk_0x2F879C0BDBED0194(unk_0x0FA8183DAD2B3203()))
				{
					if (unk_0xEBE4F888D9965006(unk_0x7C7787D2D7139A85()) == 0)
					{
						unk_0x31EBACD75CD1F9EC(unk_0x7C7787D2D7139A85(), 2, 0);
			...
			{
				if (unk_0x2A488C176D52CCA5(Var0, Local_1617[2 /*3*/]) < 100f || unk_0x2F879C0BDBED0194(unk_0x0FA8183DAD2B3203()))
				{
					if (unk_0xEBE4F888D9965006(unk_0x7C7787D2D7139A85()) == 0)
					{
						unk_0x31EBACD75CD1F9EC(unk_0x7C7787D2D7139A85(), 2, 0);
...
void func_283()
{
	if (iLocal_1461 == 2)
	{
		if (!unk_0xFD5DB0E7D32743DA(&uLocal_1562))
		{
			if (!unk_0x2BF5E63466422C38(Local_1045.f_0))
			{
				if (!iLocal_1516)
				{
					unk_0xDA778D908FD69EEE(Local_1045.f_0, 1, 1);
					unk_0xE8CF1EE4C8858654(Local_1045.f_0, 1, 1, 0, 1, 1, 0);
				}
			}
			if (unk_0x711CB1B03E023C5A("WINDOWWASHERFALL_MASTER", 0))
			{
				unk_0xF36E1C1FF1A8C6CD(-648.59f, 305.73f, 120f);
			}
			if (unk_0xC6649C48084573DA())
			{
				unk_0x5F6A0EDEF2DFCC3E(1f);
			}
			iLocal_1516 = 1;
		}
		else if (!unk_0xFD5DB0E7D32743DA(&uLocal_1561))
		{
			if (!unk_0x2BF5E63466422C38(Local_1045.f_0))
			{
				if (!iLocal_1516)
			...
			if (unk_0x711CB1B03E023C5A("WINDOWWASHERFALL_MASTER", 0))
			{
				unk_0xF36E1C1FF1A8C6CD(-638.1931f, 306.014f, 121.4236f);
			}
			if (unk_0xC6649C48084573DA())
			{
				unk_0x5F6A0EDEF2DFCC3E(1f);
...
void func_284(var uParam0, var uParam1)
{
	...
	if (unk_0xD4B321D9096B01FC(uParam1->f_11[0]))
	{
		Var9 = { unk_0xACE5E491FC1B0D37(uParam1->f_11[0], 1) };
	}
	else
	{
	...
	switch (iLocal_1550)
	{
			...
			if (!bLocal_1525)
			{
				if (iLocal_1461 == 2)
				{
					if (unk_0xB7A628320EFF8E47(Var0, Var3) < 40000f)
					{
						if (unk_0xD4B321D9096B01FC(uParam1->f_11[0]))
						{
							if (unk_0xD4B321D9096B01FC(uParam1->f_11[1]))
							{
								...
								else
								{
									if (!unk_0xFD5DB0E7D32743DA(&uLocal_1562))
									{
										uLocal_1562 = unk_0x3D1F94A8AF166634(-648.59f, 305.73f, fVar13, 0f, 90f, 0f, fVar14, 0, -1f, 5f, 0.5f, 0, 0, 1, 5f, 1, 0);
									}
									if (!unk_0xFD5DB0E7D32743DA(&uLocal_1561))
									{
										uLocal_1561 = unk_0x3D1F94A8AF166634(-638.93f, 304.92f, fVar13, 0f, 90f, 0f, fVar14, 0, -1f, 5f, 0.5f, 0, 0, 1, 5f, 1, 0);
									}
									if (unk_0xFD5DB0E7D32743DA(&uLocal_1561) && unk_0xFD5DB0E7D32743DA(&uLocal_1562))
									{
										unk_0x8B531B07BCE182C1(uLocal_1562, uParam1->f_11[1], uParam1->f_11[0], -648.59f, 305.73f, fVar13, -648.59f, 305.73f, Var9.f_2, fVar14, 0, 0, 0, 0);
										unk_0x8B531B07BCE182C1(uLocal_1561, uParam1->f_11[1], uParam1->f_11[0], -638.93f, 304.92f, fVar13, -638.93f, 304.92f, Var9.f_2, fVar14, 0, 0, 0, 0);
										bLocal_1525 = true;
										iLocal_1550 = 1;
									}
								}
		...
		case 1:
			...
			{
				if (unk_0x62E95D2FED28E41C(uParam1->f_11[0]))
				{
					if (iLocal_1462 < 2)
					{
						if (!unk_0x2BF5E63466422C38(*uParam1))
						{
							unk_0xA12E1659DEF57244(&uVar12);
							unk_0x5D672CB011E20B28(0, "oddjobs@assassinate@multi@windowwasher", "_idle_to_up", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
							unk_0x5D672CB011E20B28(0, "oddjobs@assassinate@multi@windowwasher", "_up_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
							unk_0x15A7B753872B3CE3(uVar12);
							unk_0xC544A8E1032AC1CF(*uParam1, uVar12);
							unk_0x78829A259A6975CD(&uVar12);
						}
					}
					iLocal_1550 = 2;
				}
		...
		case 2:
			Var6 = { unk_0xACE5E491FC1B0D37(uParam1->f_11[0], 1) };
			if (unk_0xF4B969E0807E76C7(*uParam1, 0))
			{
				iLocal_1550 = 3;
			}
			if (unk_0xFD5DB0E7D32743DA(&uLocal_1562) && unk_0xFD5DB0E7D32743DA(&uLocal_1561))
			{
				unk_0x81E9731B7D5D1B7F(uLocal_1562);
				unk_0x81E9731B7D5D1B7F(uLocal_1561);
				if (Var6.f_2 >= 125f)
				{
					if (iLocal_1462 < 2)
					{
						...
						{
							unk_0xA12E1659DEF57244(&uVar12);
							unk_0x5D672CB011E20B28(0, "oddjobs@assassinate@multi@windowwasher", "_up_to_wash", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
							unk_0x5D672CB011E20B28(0, "oddjobs@assassinate@multi@windowwasher", "_wash_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
							unk_0x15A7B753872B3CE3(uVar12);
							unk_0xC544A8E1032AC1CF(*uParam1, uVar12);
							unk_0x78829A259A6975CD(&uVar12);
						}
					}
					unk_0x7E631F8C183B3503(uLocal_1562);
					unk_0x7E631F8C183B3503(uLocal_1561);
					iLocal_1550 = 3;
					unk_0x0977D05D452C9828(uParam1->f_11[0], 2, -20f, 0f, -20f, -4.78f, 0.65f, -0.78f, 0, 0, 0, 1, 0, 1);
				}
			}
			else
			{
...
void func_285()
{
	if (!unk_0xD4B321D9096B01FC(iLocal_1584))
	{
		if (!unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
		{
			if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
			{
				iLocal_1584 = unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0);
				if (unk_0xD4B321D9096B01FC(iLocal_1584) && !unk_0xF4B969E0807E76C7(iLocal_1584, 0))
				{
	...
	while (iVar0 < 9)
	{
		if (unk_0xD4B321D9096B01FC(Global_96030[iVar0]))
		{
			if (Global_96030[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0x7F375072508F738F(iParam0) == func_293(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0xD960230552BC4165(iParam0, 0))
	{
		...
		*uParam1 = unk_0x15573EDB7C261B90(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xA1E7A40E1F56E511(&(uParam1->f_77), func_296(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_302()
{
	...
	if (!unk_0xD4B321D9096B01FC(iLocal_1466))
	{
		return;
	}
	if (!unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
	...
	if (unk_0xB7A628320EFF8E47(Var0, Local_1469) > 10000f)
	{
		if (unk_0xD4B321D9096B01FC(iLocal_1466))
		{
			...
			unk_0x377C9F2989832369(&iLocal_1466);
		}
		if (unk_0xD4B321D9096B01FC(iLocal_1465))
		{
			unk_0x2BBEC4B37B923F4B(iLocal_1465, 1, 0);
...
void func_304(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_371(unk_0x0037AFCBDC61F351(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_364(unk_0x0037AFCBDC61F351(), 1);
			if (iVar5 != -1)
			{
...
{
	func_306(&Global_105109, unk_0x0037AFCBDC61F351(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_306(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_10();
	...
	if (!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
	{
		...
		func_324(unk_0x0FA8183DAD2B3203());
		func_317(unk_0x0FA8183DAD2B3203(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_316())
		{
			func_312(unk_0x0FA8183DAD2B3203(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
int func_313(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2576213[iParam0 /*3*/][func_65(iParam1)];
...
void func_318(int iParam0, var uParam1)
{
	...
	if (!unk_0x2BF5E63466422C38(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x8DF76C2DDD0C74F6(iParam0, func_323(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((unk_0xF361E8FFC872484A(iVar9, &Var11) && !func_320(Var11.f_1)) && iVar72 < 51)
			{
...
int func_330(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x393E9918BC37548A())
	{
		if (func_332() == 0)
		{
			return unk_0xA2BC31158C8CEFD2(func_70(func_331(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_376(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_19665)
	{
		if (Global_19486.f_1 == 6)
		{
			...
			func_378(1);
			func_380(Global_19467, "DISPLAY_VIEW", 1f, unk_0xBBDA792448DB5A89(Global_19466), -1082130432, -1082130432, -1082130432);
		}
	}
					...
					if (iVar0 == Global_7363[iVar1 /*15*/].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (Global_2458994)
							{
								if (iVar1 == 14)
								{
									func_379(Global_19467, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7363[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(Global_21868), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_7925[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7363[iVar1 /*15*/].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_379(Global_19467, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7363[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(Global_21873), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76577)
								{
									...
									func_379(Global_19467, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7363[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(iVar4), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19486)
									...
									func_379(Global_19467, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7363[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(iVar6), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7363[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_379(Global_19467, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7363[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(iVar9), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_379(Global_19467, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7363[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(0), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_7925[iVar0] = 1;
						}
					}
...
int func_389()
{
	unk_0x6BB2B1818CAE531E(joaat("premier"));
	unk_0x6BB2B1818CAE531E(joaat("dilettante"));
	unk_0x6BB2B1818CAE531E(joaat("vigero"));
	while ((!unk_0x6DF9C43E3CC645BC(joaat("premier")) || !unk_0x6DF9C43E3CC645BC(joaat("dilettante"))) || !unk_0x6DF9C43E3CC645BC(joaat("vigero")))
	{
		return 0;
	}
	return 1;
...
int func_398(var uParam0, var uParam1, bool bParam2)
{
	...
	if ((!unk_0xA3D567B14856EDE1(3) && !func_394(&(uParam0->f_34))) && !func_390(uParam1))
	{
		func_501(uParam1);
		return 0;
	}
...
void func_416()
{
	if (!unk_0xD4B321D9096B01FC(uLocal_1578[0]))
	{
		uLocal_1578[0] = unk_0x847817A65E16621A(iLocal_1585[0], -723.8201f, -916.5402f, 18.0145f, 267.798f, 1, 1, 0);
	}
	if (!unk_0xD4B321D9096B01FC(uLocal_1578[1]))
	{
		uLocal_1578[1] = unk_0x847817A65E16621A(iLocal_1585[1], -735.5003f, -931.6205f, 18.0173f, 359.3239f, 1, 1, 0);
		unk_0x5C566093AEF7FD18(uLocal_1578[1], 100);
	}
	if (!unk_0xD4B321D9096B01FC(uLocal_1578[2]))
	{
		uLocal_1578[2] = unk_0x847817A65E16621A(iLocal_1585[0], -726.7143f, -940.2681f, 18.0173f, 178.3615f, 1, 1, 0);
	}
	if (!unk_0xD4B321D9096B01FC(uLocal_1578[3]))
	{
		uLocal_1578[3] = unk_0x847817A65E16621A(iLocal_1585[2], -730.5711f, -909.9425f, 18.0349f, 357.4066f, 1, 1, 0);
	}
}

int func_417(struct<3> Param0, float fParam3)
{
	return func_418(&(Global_105109.f_2890), Param0, fParam3, 0);
}
	...
	if (func_401(uParam0))
	{
		...
		if (func_400(uParam0))
		{
			...
			if (unk_0xD4B321D9096B01FC(iVar0))
			{
				...
				else if ((!func_435(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && unk_0x2553916E420E8EF0(unk_0x0037AFCBDC61F351(), "startup_positioning"))
				{
...
{
	if ((((((((((!unk_0xD4B321D9096B01FC(iParam0) || !unk_0xD960230552BC4165(iParam0, 0)) || func_310(iParam0, 0, 0)) || func_310(iParam0, 1, 0)) || func_310(iParam0, 2, 0)) || func_291(iParam0) != 145) || func_425(iParam0)) || func_424(iParam0)) || func_423(iParam0)) || func_422(iParam0)) || !func_421(unk_0x7F375072508F738F(iParam0)))
	{
		if (func_424(iParam0))
		{
		}
...
int func_435(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_436(iParam0, uVar1[iVar6], 1) && func_402(unk_0xACE5E491FC1B0D37(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_209(Param1, 0f, 0f, 0f, 0)) || unk_0xD34AF93E9BCF12F0(unk_0xACE5E491FC1B0D37(iParam0, 1), unk_0xACE5E491FC1B0D37(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_438(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xD4B321D9096B01FC(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x7F375072508F738F(Global_96030[iVar0]) == func_293(iParam0, iParam1))
				{
...
void func_439(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (unk_0xD960230552BC4165(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (unk_0xA2BC31158C8CEFD2(uParam1->f_77, func_296(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (unk_0xA2BC31158C8CEFD2(uParam1->f_77, func_296(iVar1 + 1)))
			{
			}
			else
			{
				unk_0xA1E7A40E1F56E511(&(uParam1->f_77), func_296(iVar1 + 1));
			}
		}
		...
		if (!unk_0xDC118E11A4081E9A(uParam1->f_66) && !unk_0x5EA23EAAAD4E34BF(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (unk_0xA2BC31158C8CEFD2(uParam1->f_77, func_296(iVar2 + 1)))
				{
...
int func_440(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_444(unk_0x7F375072508F738F(*iParam0), 1) && unk_0xF05B9E4C6631EA28(*iParam0, 24) != func_443(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xED4CA44675A55548(*iParam0, 24, func_443(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_442(iParam0);
	if (func_441(*iParam0))
	{
...
void func_456(var uParam0, var uParam1, bool bParam2)
{
	...
	while ((!unk_0xA3D567B14856EDE1(3) || !func_394(&(uParam0->f_34))) || !func_390(uParam1))
	{
		func_501(uParam1);
		unk_0x4EDE34FBADD967A6(0);
	}
...
void func_468(var uParam0)
{
	*uParam0 = joaat("s_m_y_winclean_01");
	...
	unk_0x711CB1B03E023C5A("WINDOWWASHERFALL_MASTER", 0);
	fLocal_1558 = 500f;
}
...
int func_469(var uParam0, char* sParam1)
{
	...
	while (iVar0 < *uParam0)
	{
		if (!unk_0x79FCE4565761C974((*uParam0)[iVar0]))
		{
			if (unk_0x2553916E420E8EF0((*uParam0)[iVar0], uParam1))
			{
				return 0;
			}
		}
...
void func_472()
{
	...
	while (iVar0 < 3)
	{
		unk_0x6BB2B1818CAE531E(iLocal_1585[iVar0]);
		iVar0++;
	}
}
...
void func_475(var uParam0)
{
	if (iLocal_1464 < 3)
	{
		unk_0x5C809672B50B6CAC(-717.8348f, -932.1736f, 18.01735f, 26f);
	}
	switch (iLocal_1464)
	{
		case 0:
			unk_0x36B659209EBDD366("oddjobs@assassinate@multi@call");
			unk_0x6BB2B1818CAE531E(joaat("p_phonebox_01b_s"));
			func_474();
			unk_0xC1B1E9A034A63A62(0);
			unk_0x059780A8877D0C70("SCRIPT\ASSASSINATION_MULTI", false, -1);
			if ((unk_0xB25A0D192C6A0A5B("oddjobs@assassinate@multi@call") && unk_0x6DF9C43E3CC645BC(joaat("p_phonebox_01b_s"))) && func_389())
			{
				bLocal_1535 = true;
			}
			if (bLocal_1535)
			{
				if (unk_0xD4B321D9096B01FC(iLocal_1465))
				{
					...
					unk_0xB82DC93528F8603C(-700.1226f, -916.8699f, 18.1667f, 5f, 1, 0, 0, 0);
					...
					if (unk_0xD4B321D9096B01FC(iLocal_1465))
					{
						unk_0x2BBEC4B37B923F4B(iLocal_1465, 0, 0);
						unk_0x8C85E8C71AD74415(iLocal_1465, 0, 0);
						unk_0xE679FB04E61F88AA(iLocal_1465, 0);
						iLocal_1466 = unk_0x7187764DB5121FC9(joaat("p_phonebox_01b_s"), -700.1226f, -916.8699f, 18.1667f, 1, 1, 0);
						unk_0xF3D48447FACBBE72(iLocal_1466, 0f, 0f, 0f, 2, 1);
						unk_0x8C85E8C71AD74415(iLocal_1466, 0, 0);
						unk_0xE679FB04E61F88AA(iLocal_1466, 0);
					}
					uLocal_1506 = unk_0xB455EDED5B2FA6ED(-700.1226f, -916.8699f, 18.1667f, 350f, 12, 127);
					func_481(1, 1, 1, 0, 0, 0);
					if (!unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
					{
						unk_0xCFEC09B98C6C5993(unk_0x0FA8183DAD2B3203(), 0, 0);
						unk_0xCB3446C6A91D1A78(unk_0x0FA8183DAD2B3203(), Local_1472, 1, 0, 0, 1);
						unk_0x5A2B7C446C0CF087(unk_0x0FA8183DAD2B3203(), fLocal_1475);
						unk_0xE5DAA5553A176799(unk_0x0FA8183DAD2B3203(), joaat("weapon_unarmed"), 1);
						unk_0xFBE658450F3CCCC4(unk_0x0FA8183DAD2B3203(), 1);
					}
					uLocal_1505 = unk_0xF2A54C51C03CADAA(Local_1499, Local_1502, 2);
					if (unk_0xD4B321D9096B01FC(iLocal_1466))
					{
						unk_0xADFCDA47D7031CF3(uLocal_1505, iLocal_1466, -1);
					}
					unk_0x8582CCEB95B1F1BE(unk_0x0FA8183DAD2B3203(), iLocal_1505, "oddjobs@assassinate@multi@call", "ass_multi_target_call_p1", 1000f, -2f, 2, 0, 1148846080, 0);
					unk_0xD9EC67B3064ADB79(iLocal_1466, iLocal_1505, "ass_multi_target_call_phone", "oddjobs@assassinate@multi@call", 1000f, -2f, 0, 1148846080);
					if (!unk_0xD2652A8A890B29BA(uLocal_1467))
					{
						uLocal_1468 = unk_0x3715936BB73409D6(26379945, Local_1479, Local_1482, 35f, 1, 2);
						uLocal_1467 = unk_0x3715936BB73409D6(26379945, Local_1485, Local_1488, 35f, 0, 2);
						unk_0x479DACF5AA4C6D03(uLocal_1467, uLocal_1468, 2500, 1, 1);
						unk_0x0298C8010FD5A69E(1, 0, 3000, 1, 0, 0);
						unk_0x678A9FFAA65D1846(uLocal_1467, "HAND_SHAKE", 0.2f);
					}
					func_416();
					func_38(&(uParam0->f_16), 3, 0, "LESTER", 0, 1);
					func_38(&(uParam0->f_16), 1, unk_0x0FA8183DAD2B3203(), "FRANKLIN", 0, 1);
				...
				else
				{
					...
					if (!unk_0xD4B321D9096B01FC(iLocal_1465))
					{
						iLocal_1465 = unk_0x91D67DB02D1040F1(Local_1469, 5f, joaat("prop_phonebox_01b"), 1, 0, 1);
					}
				}
			}
			break;
		...
		case 1:
			...
			if (!iLocal_1498)
			{
				if (!unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
				{
					if (unk_0xB50E39CA0A3E6020(iLocal_1505))
					{
						if (unk_0x91F0628278985DB8(iLocal_1505) > 0.05f)
						{
			...
			if (((func_497(&uLocal_1491) && func_45(&uLocal_1491) > fLocal_1476) || (unk_0xB50E39CA0A3E6020(iLocal_1505) && unk_0x91F0628278985DB8(iLocal_1505) >= 0.978f)) || bLocal_1497)
			{
				iLocal_1464 = 3;
			}
			break;
		...
		case 2:
			...
			if (bLocal_1497)
			{
				if (unk_0x260395BA7F0C83CB())
				{
					...
					{
						unk_0xCFEC09B98C6C5993(unk_0x0FA8183DAD2B3203(), 0, 0);
						unk_0xCB3446C6A91D1A78(unk_0x0FA8183DAD2B3203(), -700.2628f, -917.5313f, 18.2147f, 1, 0, 0, 1);
						unk_0x5A2B7C446C0CF087(unk_0x0FA8183DAD2B3203(), 73.3924f);
					}
					unk_0x1498B6B9F7C33B0A(iLocal_1466, -1000f, 1);
					unk_0x4EDE34FBADD967A6(0);
		...
		case 3:
			...
			if (unk_0x257687A186581E55(uLocal_1506))
			{
				unk_0xD28D0A0B38E43BAC(uLocal_1506);
			}
			unk_0x8C85E8C71AD74415(iLocal_1466, 1, 0);
			unk_0x6525353FD09C7122();
			...
			unk_0xF1E958D9BB4D1EF6(unk_0x7C7787D2D7139A85(), 0);
			unk_0x7D74D6A091150B86("oddjobs@assassinate@multi@call");
			unk_0x86A9549BD3D71664(&iLocal_1465);
			iLocal_1042 = 4;
			break;
	}
}
...
int func_479(var uParam0, float fParam1, struct<3> Param2, struct<3> Param5, float fParam8, bool bParam9, float fParam10)
{
	if (unk_0xD2652A8A890B29BA(*uParam0))
	{
		if (func_497(&uLocal_1494))
		{
			...
			{
				unk_0xF44C160C97CC41EB(uLocal_1467, Param2);
				unk_0x92B8564A1A66EF0A(uLocal_1467, Param5, 2);
				unk_0x494374BCB9580EA5(uLocal_1467, fParam8);
				if (bParam9)
				{
					unk_0x678A9FFAA65D1846(uLocal_1467, "HAND_SHAKE", fParam10);
				}
				return 1;
			}
		}
...
void func_481(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (unk_0x393E9918BC37548A())
		{
			if (((((!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()) && !func_485(unk_0x7C7787D2D7139A85())) && !func_483(unk_0x7C7787D2D7139A85(), 0)) && !func_482()) && !bParam4) && !bParam5)
			{
				unk_0x04F5A8AA60EC662B(unk_0x0FA8183DAD2B3203(), 0);
			}
		}
		else if (((!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()) && !func_485(unk_0x7C7787D2D7139A85())) && !bParam4) && !bParam5)
		{
			unk_0x04F5A8AA60EC662B(unk_0x0FA8183DAD2B3203(), 0);
		}
		Global_76575 = 0;
