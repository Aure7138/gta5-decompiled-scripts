...
void func_1()
{
	if (unk_0xC9D9444186B5A374() > 7000)
	{
		...
		{
			if (unk_0x5534579797ACFD77(unk_0xC8B93D94F8954288(), uLocal_52, 10f, 10f, 10f, 0, 1, 0) && iLocal_54 == 0)
			{
				unk_0x5AE11BC36633DE4E(0);
				Local_48 = { unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1) };
				unk_0x3E2E609450787FFE(&uLocal_55);
				unk_0x7FFE31040063EDAE(0, Local_48, 0);
				unk_0x5323F488E6A1B660(0, "amb@PREACHER", "PREACH", 8f, -8f, -1, 1, 0, 0, 0, 0);
				unk_0x939BC11172AA1303(uLocal_55);
				if (!unk_0xB6900B8CB0ABBD2B(uLocal_52))
				{
					unk_0xBFE865E3B513451B(uLocal_52, uLocal_55);
				}
				unk_0xA9351C9309E03069(&uLocal_55);
				iLocal_54 = 1;
			}
			if (unk_0x5534579797ACFD77(unk_0xC8B93D94F8954288(), uLocal_52, 3f, 3f, 3f, 0, 1, 0) && iLocal_53 == 0)
			{
				Local_48 = { unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1) };
				unk_0x5AE11BC36633DE4E(0);
				unk_0x3E2E609450787FFE(&uLocal_55);
...
void func_2()
{
	unk_0x7567CEA8E6B5340B(joaat("s_m_m_strpreach_01"));
	unk_0xC0E8B67A4385D37D("amb@PREACHER");
	while (!unk_0x0845149A26DABBA5(joaat("s_m_m_strpreach_01")) || !unk_0xF9B86DC1728F1339("amb@PREACHER"))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	Local_48.f_2 = (Local_45.f_2 - 1f);
	uLocal_52 = unk_0x71DD988C1B903F5D(19, joaat("s_m_m_strpreach_01"), Local_45.f_0, Local_45.f_1, Local_48.f_2, 0f, 1, 1);
	if (!unk_0xB6900B8CB0ABBD2B(uLocal_52))
	{
		unk_0x3E2E609450787FFE(&uLocal_55);
		unk_0x7FFE31040063EDAE(0, Local_48, 0);
