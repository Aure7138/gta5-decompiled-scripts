...
void func_1()
{
	...
	{
		if (((((!func_28() && !unk_0x11DBA82F76F3C4C2(uLocal_205)) && !unk_0x6B9E71121F5B8154(uLocal_205)) && !unk_0x28E91B800C85243D(uLocal_205)) && !unk_0xECEC7528A52B4EE8(uLocal_205)) && !unk_0xC49311A2A500FF09(uLocal_205, 0))
		{
			if (func_27(uLocal_205, unk_0x7D2B9E6A64637269(), 1) <= 2.3f)
			{
				if ((unk_0xDFB7BFA6482FEE1E() - iLocal_203) > 8000)
				{
					if (func_4(&uLocal_38, "EPS4AUD", "EPS4_FOLLJ", 7, 0, 0, 0))
					{
						iLocal_203 = unk_0xDFB7BFA6482FEE1E();
					}
				}
			}
		}
		if (func_27(uLocal_205, unk_0x7D2B9E6A64637269(), 1) > 150f)
		{
			func_3(&uLocal_205);
		}
	}
	...
	{
		if (((((!func_28() && !unk_0x11DBA82F76F3C4C2(uLocal_204)) && !unk_0x6B9E71121F5B8154(uLocal_204)) && !unk_0x28E91B800C85243D(uLocal_204)) && !unk_0xECEC7528A52B4EE8(uLocal_204)) && !unk_0xC49311A2A500FF09(uLocal_204, 0))
		{
			if (func_27(uLocal_204, unk_0x7D2B9E6A64637269(), 1) <= 2.7f)
			{
				if ((unk_0xDFB7BFA6482FEE1E() - iLocal_203) > 8000)
				{
		...
		if (func_27(uLocal_204, unk_0x7D2B9E6A64637269(), 1) > 150f)
		{
			func_3(&uLocal_204);
		}
	}
...
void func_30()
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (unk_0x6471F4759775FCA4(uVar2[iVar1]) == func_32(55))
			{
				uLocal_205 = uVar2[iVar1];
				if (!unk_0xEE1D92A39CF8E1E6(uLocal_205))
				{
					unk_0x4985CD0720AFD468(uLocal_205, 1, 0);
				}
				unk_0xEC7D41CF790FC6FB(uLocal_205, 0);
				unk_0x1D7A4E9E23D306D6(uLocal_205, 0);
				unk_0x7A4EA1D3F050E568(uLocal_205, "POSTJIMMY");
				unk_0x2271ED1E65FB75EE(uLocal_205, joaat("player"));
				func_31(&uLocal_38, 5, uLocal_205, "JIMMYBOSTON", 1, 1);
			}
			if (unk_0x6471F4759775FCA4(uVar2[iVar1]) == func_32(60))
			{
				uLocal_204 = uVar2[iVar1];
				if (!unk_0xEE1D92A39CF8E1E6(uLocal_204))
				{
					unk_0x4985CD0720AFD468(uLocal_204, 1, 0);
				}
				unk_0xEC7D41CF790FC6FB(uLocal_204, 0);
				unk_0x1D7A4E9E23D306D6(uLocal_204, 0);
				unk_0x7A4EA1D3F050E568(uLocal_204, "POSTMARNIE");
				unk_0x2271ED1E65FB75EE(uLocal_204, joaat("player"));
...
{
	if (((!func_16() == iParam0 || func_35()) || func_34()) || Global_77245 != -1)
	{
		if (!func_16() == 1)
		{
		}
