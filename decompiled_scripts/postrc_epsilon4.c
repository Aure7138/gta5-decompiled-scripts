...
void func_1()
{
	...
	{
		if (((((!func_22() && !unk_0x48368B3E430594FA(uLocal_205)) && !unk_0x7F4AE93855973529(uLocal_205)) && !unk_0xCA8CA260AD1BCD17(uLocal_205)) && !unk_0xCA41A00932714525(uLocal_205)) && !unk_0xFD0FE723227D5AB6(uLocal_205, 0))
		{
			if (func_21(uLocal_205, unk_0x17B5CC8A8615737D(), 1) <= 2.3f)
			{
				if ((unk_0x94E3E074F38DF86C() - iLocal_203) > 8000)
				{
					if (func_4(&uLocal_38, "EPS4AUD", "EPS4_FOLLJ", 7, 0, 0, 0))
					{
						iLocal_203 = unk_0x94E3E074F38DF86C();
					}
				}
			}
		}
		if (func_21(uLocal_205, unk_0x17B5CC8A8615737D(), 1) > 150f)
		{
			func_3(&uLocal_205);
		}
	}
	...
	{
		if (((((!func_22() && !unk_0x48368B3E430594FA(uLocal_204)) && !unk_0x7F4AE93855973529(uLocal_204)) && !unk_0xCA8CA260AD1BCD17(uLocal_204)) && !unk_0xCA41A00932714525(uLocal_204)) && !unk_0xFD0FE723227D5AB6(uLocal_204, 0))
		{
			if (func_21(uLocal_204, unk_0x17B5CC8A8615737D(), 1) <= 2.7f)
			{
				if ((unk_0x94E3E074F38DF86C() - iLocal_203) > 8000)
				{
		...
		if (func_21(uLocal_204, unk_0x17B5CC8A8615737D(), 1) > 150f)
		{
			func_3(&uLocal_204);
		}
	}
...
void func_24()
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (unk_0x0324EEB10F81965F(uVar2[iVar1]) == func_26(55))
			{
				uLocal_205 = uVar2[iVar1];
				if (!unk_0xC26429B504BA534D(uLocal_205))
				{
					unk_0xF0F77C99098F999B(uLocal_205, 1, 0);
				}
				unk_0x4DF0B516187EED5A(uLocal_205, 0);
				unk_0x6F65279C9BC14EDB(uLocal_205, 0);
				unk_0x3BEB2E27EBD72589(uLocal_205, "POSTJIMMY");
				unk_0x3BB70315907D9456(uLocal_205, joaat("player"));
				func_25(&uLocal_38, 5, uLocal_205, "JIMMYBOSTON", 1, 1);
			}
			if (unk_0x0324EEB10F81965F(uVar2[iVar1]) == func_26(60))
			{
				uLocal_204 = uVar2[iVar1];
				if (!unk_0xC26429B504BA534D(uLocal_204))
				{
					unk_0xF0F77C99098F999B(uLocal_204, 1, 0);
				}
				unk_0x4DF0B516187EED5A(uLocal_204, 0);
				unk_0x6F65279C9BC14EDB(uLocal_204, 0);
				unk_0x3BEB2E27EBD72589(uLocal_204, "POSTMARNIE");
				unk_0x3BB70315907D9456(uLocal_204, joaat("player"));
...
{
	if (((!func_11() == iParam0 || func_29()) || func_28()) || Global_69699 != -1)
	{
		if (!func_11() == 1)
		{
		}
