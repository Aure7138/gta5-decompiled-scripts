...
void __EntryFunction__()
{
	...
	if (unk_0xB9B05E900D325C36(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_103526[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_253(&(Global_103526[Var0.f_0 /*10*/].f_9));
			}
		}
		func_240(&Var0, 1);
	}
	iVar64[0] = 35;
	if (!func_237(&iVar64, &Var0, Var61, 1f))
	{
		func_236();
	...
	func_225(&Var0);
	uLocal_92 = unk_0x765BE154A2FACB3E(Var61 - Vector(20f, 20f, 20f), Var61 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
	...
	while (true)
	{
		...
		func_186(Var0.f_0);
		func_178(&iLocal_91, &(Var0.f_9), Var61);
		if (func_163(&Var0, 0))
		{
			if (Var0.f_0 == 35)
			{
				if (iLocal_93 == 0)
				{
					if (!unk_0xD7D749DFCCD114B8(1736361794))
					{
						unk_0xC17DE5E1919298F5(1736361794, joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, 1, 1, 0);
					}
					if (unk_0xD7D749DFCCD114B8(1736361794))
					{
						unk_0x43F60FB4C819ED4A(1736361794, 0f, 1, 0);
						unk_0x84436CFB65E8F6EA(1736361794, 1, 1, 0);
						iLocal_93 = 1;
					}
				}
			}
...
bool func_231(int iParam0, char* sParam1)
{
...
int func_237(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_238((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_238((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_238(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_239(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_239(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_241(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	func_245(uParam0, bParam2);
	func_242(uParam0, bParam3);
}

void func_242(var uParam0, bool bParam1)
{
	func_243(&(uParam0->f_41), bParam1);
}
