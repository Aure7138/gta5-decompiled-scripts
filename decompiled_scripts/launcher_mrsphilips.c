...
void __EntryFunction__()
{
	...
	func_236(&Var0);
	uLocal_92 = unk_0x54ECDA2DAB9CFB10(Var61 - Vector(20f, 20f, 20f), Var61 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
	...
	while (true)
	{
		...
		if (func_174(&Var0, 0))
		{
			if (Var0.f_0 == 35)
			{
				if (iLocal_93 == 0)
				{
					if (!unk_0xB2FB1E59B6F71D15(1736361794))
					{
						unk_0xC6DABC9B8ADA3309(1736361794, joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, 1, 1, 0);
					}
					if (unk_0xB2FB1E59B6F71D15(1736361794))
					{
						unk_0xE34512C3600D64F2(1736361794, 0f, 1, 0);
						unk_0x289D605FFACC399B(1736361794, 1, 1, 0);
						iLocal_93 = 1;
					}
				}
			}
...
void func_252(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
