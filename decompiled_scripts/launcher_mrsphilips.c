...
void __EntryFunction__()
{
	...
	{
		func_241("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_100273[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_241("Relinquishing candidate id...");
				func_240(&(Global_100273[Var0.f_0 /*10*/].f_9));
			}
		}
		func_227(&Var0, 1);
	}
	iVar64[0] = 35;
	if (!func_224(&iVar64, &Var0, Var61, 1f))
	{
		func_223();
		func_241("SCRIPT TERMINATED");
	...
	func_212(&Var0);
	uLocal_92 = unk_0x33189531E55C7E33(Var61 - Vector(20f, 20f, 20f), Var61 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
	...
	while (true)
	{
		...
		func_173(Var0.f_0);
		func_165(&iLocal_91, &(Var0.f_9), Var61);
		if (func_150(&Var0, 0))
		{
			if (Var0.f_0 == 35)
			{
...
int func_2(int iParam0)
{
	...
	if (!func_149())
	{
		while (!func_140(*iParam0))
		{
			...
			if (!func_174(iParam0, *iParam0 != 2))
			{
				func_241("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			unk_0x4EDE34FBADD967A6(0);
		}
	...
	if (!func_97(iParam0))
	{
		func_241("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
int func_97(var* uParam0)
{
	...
	if (func_127(&(uParam0->f_1)))
	{
		...
		{
			func_241("Initial cutscene loaded and passing to RC mission.");
			unk_0x074026B0599A6B63(iVar0);
		}
		else
		{
			func_241("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
int func_127(char* sParam0)
{
	...
	func_241("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}
						...
						if (unk_0xA1F52EC3ECE1D42E(unk_0xF4745590D18D14B8(unk_0x06736567F820A39E(), 1), unk_0xF4745590D18D14B8(uParam0->f_28[0], 1), 1) < 3f)
						{
							if (func_156(2))
							{
								if (func_154(uParam0->f_27))
								{
									...
									func_241("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (unk_0x355D28D9FFE3ABA1(unk_0x06736567F820A39E()) >= 2f)
				{
					if (unk_0x923F1BB1676259BF(unk_0x06736567F820A39E(), 245.8885f, 371.9034f, 103.9884f, 241.5898f, 359.6458f, 107.3461f, 1.25f, 0, 1, 0))
					{
						if (func_156(2))
						{
							...
							{
								func_153(uParam0->f_27, *uParam0);
								func_241("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (unk_0x923F1BB1676259BF(unk_0x06736567F820A39E(), 2728.948f, 4143.44f, 42.29295f, 2722.213f, 4144.521f, 45.43182f, 10f, 0, 1, 0))
				{
					if (func_156(2))
					{
						...
						{
							func_153(1, *uParam0);
							func_241("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!unk_0x923F1BB1676259BF(unk_0x06736567F820A39E(), -983.5426f, 369.1104f, 68.46017f, -1028.566f, 395.4613f, 94.57245f, 15f, 0, 1, 0))
					{
						if (!unk_0x923F1BB1676259BF(unk_0x06736567F820A39E(), -983.875f, 346.7556f, 68.02096f, -1021.451f, 336.3458f, 93.18714f, 14.5f, 0, 1, 0))
						{
							if (func_156(2))
							{
								...
								{
									func_153(uParam0->f_27, *uParam0);
									func_241("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_153(int iParam0, int iParam1)
{
	if (iParam0 == 1)
	{
		...
		if (unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 0))
		{
			func_241("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (unk_0xC32E6148FEFD72AD(unk_0x06736567F820A39E()) || unk_0x06071C128D7E648A(unk_0x06736567F820A39E()))
			{
				func_241("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_174(var uParam0, bool bParam1)
{
	...
	if (Global_69521)
	{
		func_241("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	...
	{
		func_241("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_205(*uParam0))
	{
		...
		func_241("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_241("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_241("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	...
	if (func_110(unk_0x06736567F820A39E()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (unk_0xC1EDB61CE0A4B94E(uParam0->f_35[iVar0]))
			{
				...
				{
					func_241("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!unk_0x1B6292EA51632C25(uParam0->f_35[iVar0], 0))
				{
					func_241("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (unk_0x1D58D319587D567F(uParam0->f_35[iVar0], unk_0x06736567F820A39E(), 0))
				{
					func_241("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (unk_0x6267527E254067CA(uParam0->f_35[iVar0]) < 850)
				{
					func_241("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 0))
					{
						...
						{
							func_241("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_155(uVar2))
						{
							if (unk_0x79469DA5833EACA8(uVar2) == joaat("towtruck") || unk_0x79469DA5833EACA8(iVar2) == joaat("towtruck2"))
							{
								if (func_155(uParam0->f_35[iVar0]))
								{
									...
									{
										func_241("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_155(iVar3))
						{
							...
							{
								func_241("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							...
							{
								func_241("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
	...
	if (func_110(unk_0x06736567F820A39E()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (unk_0xC1EDB61CE0A4B94E(uParam0->f_28[iVar0]))
			{
				if (!unk_0xCFC04A38F256EE06(uParam0->f_28[iVar0]))
				{
					if (unk_0x7A6749CADAC50206(unk_0x06736567F820A39E()))
					{
						if (unk_0x0280B42925DCFDEC(unk_0x06736567F820A39E(), uParam0->f_28[iVar0]))
						{
							...
							func_241("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((unk_0xA14561E9EE07759B(uParam0->f_28[iVar0]) || unk_0xCCC1EF74C8029770(uParam0->f_28[iVar0])) || unk_0x742804C434C92427(uParam0->f_28[iVar0]))
					{
						...
						func_241("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (unk_0x9C4162CAC2B459EC(uParam0->f_28[iVar0]))
					{
						if (unk_0x53B456945AE5C7DE(uParam0->f_28[iVar0], unk_0x06736567F820A39E(), 3f, 3f, 3f, 0, 1, 0))
						{
							...
							func_241("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_203(*uParam0))
					{
						if (!func_139(*uParam0))
						{
							if (func_198(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_241("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (unk_0x3A55B6AA596FF586(-1, unk_0xF4745590D18D14B8(uParam0->f_28[iVar0], 1), 15f))
						{
							...
							func_241("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_186(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_241("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_185(*uParam0))
					{
						...
						if (unk_0xB0565BA1AD71378E(unk_0xE0BDAFA1A39552D6()) > 0)
						{
							...
							func_241("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_241("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_111(uParam0->f_41[0]))
						{
...
void func_212(int iParam0)
{
	if (!unk_0x920167EE0888FA4E())
	{
		func_241("Player out of range [TERMINATING]");
		func_227(iParam0, 1);
	}
	func_213(iParam0);
	func_241("Created initial scene");
}
...
int func_215(int iParam0)
{
	...
	if (Global_69521)
	{
		func_241("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_101186.f_7851 && !func_92(1))
	{
		func_241("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_216(iParam0))
	{
		Global_100273[iParam0 /*10*/].f_1 = 1;
		func_241("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_91310.f_11 == 6)
	{
		if (Global_91310 < 9)
		{
			...
			{
				func_241("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_100273[iParam0 /*10*/].f_1 = 1;
		func_241("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}
...
bool func_218(int iParam0, char* sParam1)
{
...
int func_224(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	...
	if (*iParam0 == 1)
	{
		if (func_225((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_225((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_241("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_225(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_226(Var1.f_6, Param1, fParam4, 0))
	{
...
void func_227(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		func_241("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_228(iParam0, 0, 0, 0);
	}
	unk_0x8659A4920DA95096(uLocal_92, 0);
	if (iLocal_91 != -1)
	{
		func_241("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_172(&iLocal_91);
	}
	if (bParam1)
	{
...
void func_228(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_236(uParam0, iParam1);
	func_232(uParam0, bParam2);
	func_229(uParam0, bParam3);
}

void func_229(var uParam0, bool bParam1)
{
	func_230(&(uParam0->f_41), bParam1);
}
...
void func_243()
{
	func_241("Running start routines.");
	Global_100904++;
}
