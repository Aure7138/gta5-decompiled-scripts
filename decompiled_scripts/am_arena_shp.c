...
void func_1()
{
	...
	{
		iVar2 = (1000 / unk_0xF2DB717A73826179((unk_0x0B852B0BF94A8DC1() * 1000f)));
...
void func_17(var uParam0)
{
	...
	if (iVar7 || unk_0xFCEF367B86651ED3(1, uParam0, &Var0, 7))
	{
		...
		if (iVar9 != -1)
		{
			...
			{
				Global_4535172[iVar9 /*85*/].f_66.f_18 = unk_0x8034325BF6D6E41F();
			}
		}
		bVar95 = true;
		if (iVar9 != -1)
			...
			case 0:
				if (iVar9 != -1)
				{
					...
					else if (func_13())
					{
						if (bVar95)
						{
							unk_0x11FD21BA1B765FE2(Global_4535172[iVar9 /*85*/].f_66, &uVar96);
						}
					}
				}
				break;
							...
							else if (Global_4535172[iVar9 /*85*/].f_66.f_11 & 2 != 0)
							{
								...
								if (func_23(Global_4536676) && func_13())
								{
									if (!func_22(Global_4535172[iVar9 /*85*/].f_66))
									{
										...
										Global_4536533[iVar101 /*7*/].f_4 = unk_0x7E3F74F641EE6B27();
									}
								}
								else
								{
						...
						else if (Global_4535172[iVar9 /*85*/].f_66.f_11 & 2 != 0)
						{
							...
							if (func_23(Global_4536676) && func_13())
							{
								if (!func_22(Global_4535172[iVar9 /*85*/].f_66))
								{
									...
									Global_4536533[iVar102 /*7*/].f_4 = unk_0x7E3F74F641EE6B27();
								}
							}
							else
							{
					...
					else if (Global_4535172[iVar9 /*85*/].f_66.f_11 & 2 != 0)
					{
						...
						if ((func_23(Global_4536676) && func_13()) && func_31(Var0.f_2))
						{
							if (!func_22(Global_4535172[iVar9 /*85*/].f_66))
							{
								...
								Global_4536533[iVar103 /*7*/].f_4 = unk_0x7E3F74F641EE6B27();
							}
						}
						else
						{
...
void func_32(int iParam0, bool bParam1)
{
	...
	switch (Global_4535172[iParam0 /*85*/].f_66.f_4)
	{
		...
		case -1834046564:
			...
			unk_0x46B2ECD9DD5C325A(Global_4535172[iParam0 /*85*/].f_66.f_1, iVar1, iVar0, 0, iVar16);
			break;
	...
	switch (Global_4535172[iParam0 /*85*/].f_66.f_4)
	{
		...
		case -1896606724:
			...
			unk_0xDCA98A271D0CC516(Global_4535172[iParam0 /*85*/].f_66.f_1, 0, 1, &Var6);
			break;
		...
		case 883337077:
			...
			unk_0x04AA32C25ED6D69D(Global_4535172[iParam0 /*85*/].f_66.f_1, &Var17);
			break;
	...
	if (func_13())
	{
		if (bParam1)
		{
			unk_0x11FD21BA1B765FE2(Global_4535172[iParam0 /*85*/].f_66, &uVar20);
		}
	}
	func_7(iParam0);
}
