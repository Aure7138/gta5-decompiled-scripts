		...
		if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
		{
			if (unk_0x765F6FEEFF39224F(iLocal_68))
			{
				if (!unk_0xD62C4419A41F106A(iLocal_68, 0))
				{
					...
					{
						Var0 = { unk_0xFBB1F99A825CAB09(iLocal_68, 1) };
						fVar3 = unk_0xC472E34C8FBEC678(iLocal_68);
						unk_0xBEADAF07D2339505(unk_0x33CD235DF1E6A94E(), Var0.f_0, Var0.f_1, (Var0.f_2 + 4f), 1, 0, 0, 1);
						bVar4 = true;
					}
				}
			...
			if (!bVar4)
			{
				...
				{
					Var0 = { unk_0x2CA911E7569D12EA(unk_0x33CD235DF1E6A94E(), -1.5f, 3.5f, 1f) };
				}
				else if (iParam0 == joaat("buzzard"))
				{
					Var0 = { unk_0x2CA911E7569D12EA(unk_0x33CD235DF1E6A94E(), 0f, 6f, 2f) };
				}
				else
				{
					Var0 = { unk_0x2CA911E7569D12EA(unk_0x33CD235DF1E6A94E(), 0f, 3.5f, 1f) };
				}
				fVar3 = (unk_0xC472E34C8FBEC678(unk_0x33CD235DF1E6A94E()) + 90f);
			}
			if (func_17(iParam0, Var0, fVar3))
			{
				iLocal_68 = unk_0xC651C43AB13A15E5(iParam0, Var0, fVar3, 0, 1, 0);
...
void func_15(char* sParam0)
{
	...
	else
	{
		...
		unk_0xB8155D6650F8C5A1(sParam0);
	}
}
...
int func_17(int iParam0, struct<3> Param1, float fParam4)
{
	...
	unk_0xFEF5F9BB57EA2E8D(iParam0, &Var28, &Var31);
	Var34.f_0 = (unk_0x7EECA16E87982278((Var31.f_0 - Var28.f_0)) / 2f);
	Var34.f_1 = (unk_0x7EECA16E87982278((Var31.f_1 - Var28.f_1)) / 2f);
	Var34.f_2 = (unk_0x7EECA16E87982278((Var31.f_2 - Var28.f_2)) / 2f);
	Var0[0 /*3*/] = { Param1 };
	Var0[1 /*3*/] = { unk_0xCD1EDCB38767B47C(Param1, fParam4, -Var34.f_0, -Var34.f_1, -Var34.f_2) };
	Var0[2 /*3*/] = { unk_0xCD1EDCB38767B47C(Param1, fParam4, Var34.f_0, -Var34.f_1, -Var34.f_2) };
	Var0[3 /*3*/] = { unk_0xCD1EDCB38767B47C(Param1, fParam4, Var34.f_0, Var34.f_1, -Var34.f_2) };
	Var0[4 /*3*/] = { unk_0xCD1EDCB38767B47C(Param1, fParam4, -Var34.f_0, Var34.f_1, -Var34.f_2) };
	Var0[5 /*3*/] = { unk_0xCD1EDCB38767B47C(Param1, fParam4, -Var34.f_0, -Var34.f_1, Var34.f_2) };
	Var0[6 /*3*/] = { unk_0xCD1EDCB38767B47C(Param1, fParam4, Var34.f_0, -Var34.f_1, Var34.f_2) };
	Var0[7 /*3*/] = { unk_0xCD1EDCB38767B47C(Param1, fParam4, Var34.f_0, Var34.f_1, Var34.f_2) };
	Var0[8 /*3*/] = { unk_0xCD1EDCB38767B47C(Param1, fParam4, -Var34.f_0, Var34.f_1, Var34.f_2) };
	if (!unk_0xA4EE7D490EB4E0C9(Param1))
	{
		return 0;
	}
	uVar50 = unk_0xB48050F6C65C8232(func_18(unk_0x95B959F18401C09A()) + Vector(1f, 0f, 0f), Param1, 87, unk_0x33CD235DF1E6A94E(), 0);
	unk_0x819B6E76423AE494(uVar50, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
	uVar44 = unk_0xB48050F6C65C8232(Var0[1 /*3*/], Var0[3 /*3*/], 87, unk_0x33CD235DF1E6A94E(), 0);
	unk_0x819B6E76423AE494(uVar44, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
	uVar45 = unk_0xB48050F6C65C8232(Var0[2 /*3*/], Var0[4 /*3*/], 87, unk_0x33CD235DF1E6A94E(), 0);
	unk_0x819B6E76423AE494(uVar45, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
	uVar46 = unk_0xB48050F6C65C8232(Var0[5 /*3*/], Var0[7 /*3*/], 87, unk_0x33CD235DF1E6A94E(), 0);
	unk_0x819B6E76423AE494(uVar46, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
	uVar47 = unk_0xB48050F6C65C8232(Var0[6 /*3*/], Var0[8 /*3*/], 87, unk_0x33CD235DF1E6A94E(), 0);
	unk_0x819B6E76423AE494(uVar47, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
	uVar48 = unk_0xB48050F6C65C8232(Var0[1 /*3*/], Var0[8 /*3*/], 87, unk_0x33CD235DF1E6A94E(), 0);
	unk_0x819B6E76423AE494(uVar48, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
	uVar49 = unk_0xB48050F6C65C8232(Var0[2 /*3*/], Var0[7 /*3*/], 87, unk_0x33CD235DF1E6A94E(), 0);
	unk_0x819B6E76423AE494(uVar49, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
...
{
	if (unk_0xF237530C2DEF2576(uParam0))
	{
...
void func_35()
{
	...
	switch (iLocal_64)
	{
		...
		case 2:
			...
			unk_0x697EBA5CF1A6AB57(unk_0x33CD235DF1E6A94E(), joaat("gadget_parachute"), 1, 0, 1);
			Var0 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1) };
			uVar3 = unk_0xC472E34C8FBEC678(unk_0x33CD235DF1E6A94E());
			unk_0x8C1596BAD35D957A(Var0, &fVar4, 0, 0);
			fVar4 = (fVar4 + 500f);
			unk_0xBEADAF07D2339505(unk_0x33CD235DF1E6A94E(), Var0.f_0, Var0.f_1, fVar4, 1, 0, 0, 1);
...
void func_38()
{
	...
	switch (iLocal_62)
	{
		...
		case 5:
			...
			Var0 = { func_18(unk_0x95B959F18401C09A()) };
...
void func_68()
{
	if (iLocal_57 == 4)
	{
		...
		if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
		{
			...
			unk_0x697EBA5CF1A6AB57(unk_0x33CD235DF1E6A94E(), joaat("gadget_parachute"), 1, 1, 1);
			func_5(10);
		}
	}
}
...
void func_77()
{
	if (iLocal_51 == 4)
	{
		...
		if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
		{
			unk_0xE18BDD1E31C07544(unk_0x33CD235DF1E6A94E(), joaat("weapon_knife"), -1, 0);
			unk_0xE18BDD1E31C07544(unk_0x33CD235DF1E6A94E(), joaat("weapon_smg"), 300, 0);
			unk_0xE18BDD1E31C07544(unk_0x33CD235DF1E6A94E(), joaat("weapon_assaultrifle"), 300, 1);
			unk_0xE18BDD1E31C07544(unk_0x33CD235DF1E6A94E(), joaat("weapon_pumpshotgun"), 150, 0);
			unk_0xE18BDD1E31C07544(unk_0x33CD235DF1E6A94E(), joaat("weapon_sniperrifle"), 30, 0);
			unk_0xE18BDD1E31C07544(unk_0x33CD235DF1E6A94E(), joaat("weapon_grenade"), 5, 0);
			unk_0xE18BDD1E31C07544(unk_0x33CD235DF1E6A94E(), joaat("weapon_rpg"), 5, 0);
		}
	}
}
		...
		if (unk_0x765F6FEEFF39224F(uVar0))
		{
			if (unk_0x91D5C8283D19AF49(iVar0, 0))
			{
				...
				if (iParam0 & 512 != 0)
				{
					...
					uVar4 = unk_0x4527878B077DBA42(iVar0, &uVar3);
					if (!unk_0x786AF4A44E1B5B4B(uVar4))
					{
						if (unk_0x36163153849DFDA1(uVar4) == unk_0x36163153849DFDA1("taxiService"))
						{
							return 0;
						}
					}
...
void func_109()
{
	if (func_14(14) || (!unk_0x73DA1542B2F0C458() && iLocal_94 != 0))
	{
	...
	if (iLocal_94 != 0)
	{
		if (!func_14(14))
		{
			if ((unk_0xE3903F59E2F22150() - iLocal_94) > 1000)
			{
				iLocal_94 = 0;
			}
		}
