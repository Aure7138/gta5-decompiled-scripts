		...
		if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
		{
			if (unk_0xAE06B9E39EBDE049(iLocal_68))
			{
				if (!unk_0xA59F96B50B97E63C(iLocal_68, 0))
				{
					...
					{
						Var0 = { unk_0x3E4D3CCC220BDFB1(iLocal_68, 1) };
						fVar3 = unk_0xEF7858F25585F853(iLocal_68);
						unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), Var0.f_0, Var0.f_1, (Var0.f_2 + 4f), 1, 0, 0, 1);
						bVar4 = true;
					}
				}
			...
			if (!bVar4)
			{
				...
				fVar3 = (unk_0xEF7858F25585F853(unk_0x9B0761B4C3EB8BC7()) + 90f);
			}
			if (func_18(iParam0, Var0, fVar3))
			{
				iLocal_68 = unk_0xCE4780E24AFDFBF9(iParam0, Var0, fVar3, 0, 1, 0);
...
void func_16(char* sParam0)
{
	...
	else
	{
		...
		unk_0x64AE0DA93273B549(sParam0);
	}
}
...
int func_18(int iParam0, struct<3> Param1, float fParam4)
{
	...
	unk_0x140662B520844E45(iParam0, &Var28, &Var31);
	Var34.f_0 = (unk_0x0D77CDCF403AEBD2((Var31.f_0 - Var28.f_0)) / 2f);
	Var34.f_1 = (unk_0x0D77CDCF403AEBD2((Var31.f_1 - Var28.f_1)) / 2f);
	Var34.f_2 = (unk_0x0D77CDCF403AEBD2((Var31.f_2 - Var28.f_2)) / 2f);
	Var0[0 /*3*/] = { Param1 };
	Var0[1 /*3*/] = { unk_0x1BAE5C94E38E44FE(Param1, fParam4, -Var34.f_0, -Var34.f_1, -Var34.f_2) };
	Var0[2 /*3*/] = { unk_0x1BAE5C94E38E44FE(Param1, fParam4, Var34.f_0, -Var34.f_1, -Var34.f_2) };
	Var0[3 /*3*/] = { unk_0x1BAE5C94E38E44FE(Param1, fParam4, Var34.f_0, Var34.f_1, -Var34.f_2) };
	Var0[4 /*3*/] = { unk_0x1BAE5C94E38E44FE(Param1, fParam4, -Var34.f_0, Var34.f_1, -Var34.f_2) };
	Var0[5 /*3*/] = { unk_0x1BAE5C94E38E44FE(Param1, fParam4, -Var34.f_0, -Var34.f_1, Var34.f_2) };
	Var0[6 /*3*/] = { unk_0x1BAE5C94E38E44FE(Param1, fParam4, Var34.f_0, -Var34.f_1, Var34.f_2) };
	Var0[7 /*3*/] = { unk_0x1BAE5C94E38E44FE(Param1, fParam4, Var34.f_0, Var34.f_1, Var34.f_2) };
	Var0[8 /*3*/] = { unk_0x1BAE5C94E38E44FE(Param1, fParam4, -Var34.f_0, Var34.f_1, Var34.f_2) };
	if (!unk_0xECF201F09142F9D9(Param1))
	{
		return 0;
	}
	uVar50 = unk_0x00190B8DAB9274EF(func_19(unk_0x460153A63B9477BC()) + Vector(1f, 0f, 0f), Param1, 87, unk_0x9B0761B4C3EB8BC7(), 0);
	unk_0x0F0E6A09A9C90474(uVar50, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
	uVar44 = unk_0x00190B8DAB9274EF(Var0[1 /*3*/], Var0[3 /*3*/], 87, unk_0x9B0761B4C3EB8BC7(), 0);
	unk_0x0F0E6A09A9C90474(uVar44, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
	uVar45 = unk_0x00190B8DAB9274EF(Var0[2 /*3*/], Var0[4 /*3*/], 87, unk_0x9B0761B4C3EB8BC7(), 0);
	unk_0x0F0E6A09A9C90474(uVar45, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
	uVar46 = unk_0x00190B8DAB9274EF(Var0[5 /*3*/], Var0[7 /*3*/], 87, unk_0x9B0761B4C3EB8BC7(), 0);
	unk_0x0F0E6A09A9C90474(uVar46, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
	uVar47 = unk_0x00190B8DAB9274EF(Var0[6 /*3*/], Var0[8 /*3*/], 87, unk_0x9B0761B4C3EB8BC7(), 0);
	unk_0x0F0E6A09A9C90474(uVar47, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
	uVar48 = unk_0x00190B8DAB9274EF(Var0[1 /*3*/], Var0[8 /*3*/], 87, unk_0x9B0761B4C3EB8BC7(), 0);
	unk_0x0F0E6A09A9C90474(uVar48, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
	uVar49 = unk_0x00190B8DAB9274EF(Var0[2 /*3*/], Var0[7 /*3*/], 87, unk_0x9B0761B4C3EB8BC7(), 0);
	unk_0x0F0E6A09A9C90474(uVar49, &iVar43, &uVar37, &uVar40, &uVar51);
	if (iVar43 != 0)
	{
		return 0;
	}
...
{
	if (unk_0xA620E7D1DFDADB5C(uParam0))
	{
...
void func_36()
{
	...
	switch (iLocal_64)
	{
		...
		case 2:
			...
			unk_0x92BD213E6A0E666B(unk_0x9B0761B4C3EB8BC7(), joaat("gadget_parachute"), 1, 0, 1);
			Var0 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1) };
			uVar3 = unk_0xEF7858F25585F853(unk_0x9B0761B4C3EB8BC7());
			unk_0xE5CC8E2D904E42CE(Var0, &fVar4, 0, 0);
			fVar4 = (fVar4 + 500f);
			unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), Var0.f_0, Var0.f_1, fVar4, 1, 0, 0, 1);
...
void func_59(int iParam0, var uParam1, float fParam2, float fParam3, var uParam4, bool bParam5)
{
	...
	if (unk_0x40397A9A17EEC1C5(uParam4))
	{
		unk_0x2311A669433389E8(uParam4, "DRUNK_SHAKE", fParam3);
		Global_42768 = uParam4;
	}
	else
	{
		Global_42768 = 0;
...
void func_69()
{
	if (iLocal_57 == 4)
	{
		...
		if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
		{
			...
			unk_0x92BD213E6A0E666B(unk_0x9B0761B4C3EB8BC7(), joaat("gadget_parachute"), 1, 1, 1);
			func_5(10);
		}
	}
}
...
void func_78()
{
	if (iLocal_51 == 4)
	{
		...
		if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
		{
			unk_0xEB879F62C8DFA9E2(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_knife"), -1, 0);
			unk_0xEB879F62C8DFA9E2(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_smg"), 300, 0);
			unk_0xEB879F62C8DFA9E2(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_assaultrifle"), 300, 1);
			unk_0xEB879F62C8DFA9E2(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_pumpshotgun"), 150, 0);
			unk_0xEB879F62C8DFA9E2(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_sniperrifle"), 30, 0);
			unk_0xEB879F62C8DFA9E2(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_grenade"), 5, 0);
			unk_0xEB879F62C8DFA9E2(unk_0x9B0761B4C3EB8BC7(), joaat("weapon_rpg"), 5, 0);
		}
	}
}
		...
		if (unk_0xAE06B9E39EBDE049(uVar0))
		{
			if (unk_0x80FF6C016CDB0FAF(iVar0, 0))
			{
				...
				if (iParam0 & 512 != 0)
				{
					...
					uVar4 = unk_0x9ABE4851D274FD5D(iVar0, &uVar3);
					if (!unk_0x7BCC91F3C1CF24E8(uVar4))
					{
						if (unk_0x856D5567211886A2(uVar4) == unk_0x856D5567211886A2("taxiService"))
						{
							return 0;
						}
					}
...
void func_110()
{
	if (func_15(14) || (!unk_0x87F0CB19476706C3() && iLocal_94 != 0))
	{
	...
	if (iLocal_94 != 0)
	{
		if (!func_15(14))
		{
			if ((unk_0x578C4EF320340AF7() - iLocal_94) > 1000)
			{
				iLocal_94 = 0;
			}
		}
