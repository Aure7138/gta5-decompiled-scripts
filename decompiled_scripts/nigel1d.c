...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_92 = func_535(64);
	uLocal_93 = func_535(63);
	...
	if (func_503())
	{
		Global_69734 = 1;
		iLocal_91 = 0;
		while (!func_497(&Local_108, &uLocal_831))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		func_496(&Local_108, 0, 1);
		Global_69734 = 0;
		func_495("Set up script for replay");
	}
	...
	unk_0xDD8638B43D499C77(Local_749.f_0);
	iLocal_354 = 1;
	iLocal_345 = 1;
	iLocal_372 = unk_0xA0F74982C6AAA9D4();
	unk_0x229773841C1D2E13(0);
	unk_0xF17F4B0641AB2DE1(&(Global_101154.f_17264.f_382), 4);
	func_484();
	iVar0 = 0;
	while (iVar0 <= (Local_481.f_0 - 1))
	{
		if (func_483(Local_481[iVar0 /*13*/]))
		{
			unk_0x71065DDFF8D7744C(Local_481[iVar0 /*13*/], iLocal_774);
			unk_0x9AAE2FED7F9C3140(Local_481[iVar0 /*13*/], 0, iLocal_774);
			unk_0xED5347CD6B7B01FA(5, iLocal_774, joaat("player"));
		}
		iVar0++;
	}
	if (unk_0x7489214A03D3A1BC("THUNDER") || unk_0x10F8DEA83B535D8B("THUNDER"))
	{
		unk_0x546FC0B7718905D4("OVERCAST", 25f);
	}
	if (func_503() || func_482(0))
	{
		if (func_482(0) && !func_503())
		{
			iVar1 = 0;
			func_481(unk_0x27D769C59BC9D030(), -1291.596f, -12.9214f, 48.5137f, 294.7073f, 0, 1);
		}
		else
		{
			iVar1 = func_480();
		}
		func_479("Replay stage grabbed: ", iVar1);
		if (Global_85788 == 1)
		{
			iVar1++;
		}
		...
		{
			case 0:
				func_479("Replay skipping to stage ", 1);
				func_478(-1291.596f, -12.9214f, 48.5137f, 294.7073f, 1, 0);
				func_470(1, 0);
				break;
			
			case 1:
				func_479("Replay skipping to stage ", 3);
				func_478(-1190.22f, 36.83f, 52.03f, 299f, 1, 0);
				func_470(3, 0);
				break;
			
			case 2:
				func_479("Replay skipping to stage ", 7);
				func_478(-1324.854f, 60.2491f, 52.54f, 94.6913f, 1, 0);
				func_470(7, 0);
				break;
	...
	while (true)
	{
		unk_0x14CA049761F06FFB("SF_VSM", 0);
		unk_0x4EDE34FBADD967A6(0);
		func_454(Local_108.f_9, 0, 0, 0, 0, 0);
		if (func_483(Local_455.f_0))
		{
			if ((unk_0xA0F74982C6AAA9D4() - iLocal_372) > 2000)
			{
				if (!iLocal_371)
				{
					func_453(Local_455.f_0, 0);
					func_495("Added Mark to headshot watch");
					iLocal_371 = 1;
				}
			}
		}
		...
		{
			if (func_483(unk_0x27D769C59BC9D030()))
			{
				switch (iLocal_169)
				{
					case 0:
...
void func_2()
{
	...
	{
		case 0:
			func_495("In INTRO_PHONECALL stage skip");
			if (iLocal_171 == 1)
			{
				if (func_14())
				{
		...
		case 1:
			func_495("In GO_TO_THE_GOLF_CLUB stage skip");
			if ((func_9(1) && func_8(1)) && func_7(1))
			{
				if (!func_32())
				{
					if (func_483(unk_0x27D769C59BC9D030()))
					{
						unk_0x4EEE9D9427E70F4E(unk_0x27D769C59BC9D030(), -1291.596f, -12.9214f, 48.5137f, 1, 0, 0, 1);
						unk_0xFBDCF3D5834B58D8(unk_0x27D769C59BC9D030(), 303.114f);
					}
				}
			}
			break;
		...
		case 2:
			func_495("Skipping MS_GO_TO_CELBRITY...");
			iLocal_350 = 0;
			if (func_14())
			{
				func_15();
			...
			if (!func_32())
			{
				if (func_483(unk_0x27D769C59BC9D030()))
				{
					unk_0x4EEE9D9427E70F4E(unk_0x27D769C59BC9D030(), -1190.22f, 36.83f, 52.03f, 1, 0, 0, 1);
					unk_0xFBDCF3D5834B58D8(unk_0x27D769C59BC9D030(), 299f);
				}
			}
			break;
		
		case 3:
			func_495("In GO_TO_CELBRITY stage skip");
			if (func_14())
			{
				func_15();
			}
			if (!func_32())
			{
				if (func_483(unk_0x27D769C59BC9D030()))
				{
					unk_0x4EEE9D9427E70F4E(unk_0x27D769C59BC9D030(), -1102.455f, 73.615f, 53.2039f, 1, 0, 0, 1);
					unk_0xFBDCF3D5834B58D8(unk_0x27D769C59BC9D030(), 238f);
				}
				if (func_6(Local_455.f_0))
				{
					if (func_5(Local_749.f_0))
					{
						if (!unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0))
						{
							unk_0xBD875C7680C64C56(Local_455.f_0, Local_749.f_0, -1);
						}
					}
				}
			}
		...
		case 4:
			func_495("Skipping MS_CHASE_THE_GOLFER...");
			if (func_5(Local_749.f_0))
			{
				if (unk_0x3AAD3BDAC622B4F1(Local_749.f_0))
				{
					unk_0xEF936724A389D0F0(Local_749.f_0);
				}
				unk_0x4EEE9D9427E70F4E(Local_749.f_0, -1246.956f, -89.9753f, 42.904f, 1, 0, 0, 1);
				unk_0xFBDCF3D5834B58D8(Local_749.f_0, 238f);
				if (func_6(Local_455.f_0))
				{
					if (!unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0))
					{
			...
			if (!func_32())
			{
				if (func_5(Local_694[4 /*6*/]))
				{
					if (func_483(unk_0x27D769C59BC9D030()))
					{
						if (!unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), Local_694[4 /*6*/], 0))
						{
							unk_0xBD875C7680C64C56(unk_0x27D769C59BC9D030(), Local_694[4 /*6*/], -1);
						}
					}
					unk_0x4EEE9D9427E70F4E(Local_694[4 /*6*/], -1273.736f, -75.3014f, 44.6289f, 1, 0, 0, 1);
					unk_0xFBDCF3D5834B58D8(Local_694[4 /*6*/], 242f);
				}
				else
				{
					func_495("Skip buggy isn't okay, probably going to fail");
				}
			}
			iLocal_362 = 0;
			iLocal_171 = 2;
		...
		case 5:
			func_495("Skipping MS_CHASE_IN_CITY...");
			if (func_5(Local_749.f_0))
			{
				unk_0x51F79AC13D2AD286(Local_749.f_0, 450);
				func_495("SKIPPED CITY CHASE SETTING HEALTH TO 450 ");
			}
			if (func_483(iLocal_777))
			{
				if (unk_0xBF99E4112970270F(iLocal_777))
				{
					unk_0xE223D49B3EFFD3E3(iLocal_777, 1, 1);
				}
			}
			func_4(&Local_455);
			iLocal_354 = 0;
		...
		case 6:
			func_495("Skipping MS_COLLECT_GOLF_CLUB...");
			if (!func_32())
			{
				if (func_483(unk_0x27D769C59BC9D030()))
				{
					unk_0x4EEE9D9427E70F4E(unk_0x27D769C59BC9D030(), unk_0xA8CFDE65C45F813B(iLocal_777, 1) + Vector(0f, 1.5f, 0f), 1, 0, 0, 1);
				}
			}
			iLocal_362 = 1;
			iLocal_171 = 2;
		...
		case 9:
			...
			while (iVar0 <= 2)
			{
				if (func_483(Local_481[iVar0 /*13*/]))
				{
					unk_0x51F79AC13D2AD286(Local_481[iVar0 /*13*/], 0);
				}
				iVar0++;
			}
			break;
...
int func_7(int iParam0)
{
	...
	while (iVar0 <= 2)
	{
		unk_0x97C59C4E8349D15F(Local_521[iVar0 /*13*/].f_8);
		iVar0++;
	}
	if (iParam0 == 0)
	{
		...
		while (iVar0 <= 2)
		{
			if (!unk_0x875098323FCA8FE6(Local_521[iVar0 /*13*/].f_8))
			{
				return 0;
			}
			iVar0++;
...
int func_8(int iParam0)
{
	...
	while (iVar0 <= 2)
	{
		unk_0x97C59C4E8349D15F(Local_481[iVar0 /*13*/].f_8);
		iVar0++;
	}
	if (iParam0 == 0)
	{
		...
		while (iVar0 <= 2)
		{
			if (!unk_0x875098323FCA8FE6(Local_481[iVar0 /*13*/].f_8))
			{
				return 0;
			}
			iVar0++;
...
int func_9(int iParam0)
{
	...
	while (iVar0 <= 3)
	{
		unk_0x97C59C4E8349D15F(Local_402[iVar0 /*13*/].f_8);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 8)
	{
		unk_0x97C59C4E8349D15F(Local_694[iVar0 /*6*/].f_5);
		iVar0++;
	}
	if (iParam0 == 0)
	{
		...
		while (iVar0 <= 3)
		{
			if (!unk_0x875098323FCA8FE6(Local_402[iVar0 /*13*/].f_8))
			{
				return 0;
			}
			iVar0++;
		...
		while (iVar0 <= 8)
		{
			if (!unk_0x875098323FCA8FE6(Local_694[iVar0 /*6*/].f_5))
			{
				return 0;
			}
			iVar0++;
		}
		if (((!unk_0xCE92500E70EEA516("NIGEL1DTRANS") || !unk_0xCE92500E70EEA516("NIGEL1DGOLF")) || !unk_0xCE92500E70EEA516("NIGEL1DGOLF2")) || !unk_0xCE92500E70EEA516("NIGEL1DCRASH"))
		{
			return 0;
		}
	}
...
void func_36()
{
	...
	{
		case 0:
			func_495("ENTERING END PHONECALL");
			iLocal_373 = unk_0xA0F74982C6AAA9D4();
			if (func_483(unk_0x27D769C59BC9D030()))
			{
				iVar0 = 0;
				while (iVar0 <= 2)
				{
					func_289(Local_481[iVar0 /*13*/], 0);
					func_288(&(Local_481[iVar0 /*13*/].f_11));
					iVar0++;
				}
				func_288(&iLocal_339);
				func_287(&uLocal_174, 2);
				func_287(&uLocal_174, 3);
				func_287(&uLocal_174, 4);
				func_286(&uLocal_174, 2, unk_0x27D769C59BC9D030(), "TREVOR", 0, 1);
				func_286(&uLocal_174, 3, 0, "NIGEL", 0, 1);
				func_286(&uLocal_174, 4, 0, "MRSTHORNHILL", 0, 1);
				iLocal_171 = 1;
				func_495("ENTERING END PHONECALL LOOP");
			}
			break;
		...
		case 1:
			...
			if (!func_14())
			{
				if (!iLocal_359)
				{
					if ((unk_0xA0F74982C6AAA9D4() - iLocal_373) > 3000)
					{
						if (func_237(&uLocal_174, 64, "NIG1DAU", "NIG1D_OUTRO", 9, 1, 0, 0, 0))
						{
		...
		case 2:
			func_495("CLEANUP END PHONECALL");
...
void func_41()
{
	...
	{
		func_43(13, unk_0xF34EE736CF047844(Global_101154.f_8884.f_3853));
	}
	if (!unk_0x1AB59BFCD46AAD2F())
	{
		if (!Global_69489)
		{
			if (func_42() == 2 == 0 && !unk_0x0E063DDE8855EC52())
			{
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_101(func_120(iParam1, uParam0->f_2), Global_69309, 0);
...
void func_183()
{
	...
	if (unk_0xD2CFFE76B625AE55(unk_0x27D769C59BC9D030()))
	{
		if (func_234(Global_101154.f_1826.f_539.f_3549) != unk_0x946C63BD9EF05437(unk_0x27D769C59BC9D030()))
		{
			...
			if (func_184(iVar0) && (!func_122(14) || Global_100106))
			{
				if (Global_101154.f_1826.f_539.f_3549 != iVar0 && func_184(Global_101154.f_1826.f_539.f_3549))
				{
...
void func_189(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_190(&uVar32, Var0.f_3, Global_91315, iParam1, iParam2);
	}
}
...
void func_195()
{
	...
	{
		func_183();
		unk_0x5665D3BF66653DD2(func_196(Global_101154.f_1826.f_539.f_3549));
	}
	else
	{
...
int func_215()
{
	if ((func_42() == -1 || func_42() == 999) && !func_216() == 0)
	{
		return 1;
	}
	return 0;
...
int func_230()
{
	return func_231(unk_0x3AA961419D971CB2(), 0);
}
...
int func_232(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (unk_0xF426A5DE932B3BEE(Global_69311[1 /*14*/].f_6, 0) && !unk_0xF426A5DE932B3BEE(Global_69311[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_103(iParam1, Global_69311[1 /*14*/].f_5, Global_69311[1 /*14*/].f_2, 1, Global_69311[1 /*14*/].f_1, 1, 0);
			if (iParam1 == 12)
			{
				iVar0 = 1;
				if (iParam0 == joaat("player_zero"))
				...
				if (iVar0 == 1)
				{
					uVar3 = { func_110(iParam0, iParam2) };
					iVar1 = 0;
					while (iVar1 <= 14)
					{
						if ((uVar3[iVar1] != -99 && iVar1 != 12) && iVar1 != 14)
						{
							if (iVar1 != 13)
							{
								func_232(iParam0, iVar1, uVar3[iVar1], 1, 1);
								func_233(iParam0, iVar1, uVar3[iVar1], 1);
							}
							else
							{
								uVar19 = { func_107(iParam0, uVar3[iVar1]) };
								iVar2 = 0;
								while (iVar2 <= 8)
								{
									func_232(iParam0, 14, uVar19[iVar2], 1, 1);
									func_233(iParam0, 14, uVar19[iVar2], 1);
									iVar2++;
								}
							}
						}
		...
		{
			func_103(iParam1, Global_69311[1 /*14*/].f_5, Global_69311[1 /*14*/].f_2, 1, Global_69311[1 /*14*/].f_1, 0, 1);
		}
					...
					switch (iParam1)
					{
						...
						case 11:
							if (iParam2 >= 9 && iParam2 <= 24)
							{
								...
								func_232(iParam0, 11, iVar29, 1, 0);
							}
							else if (iParam2 >= 25 && iParam2 <= 40)
							{
						...
						case 14:
							if (iParam2 >= 64 && iParam2 <= 79)
							{
								...
								func_232(iParam0, 14, iVar29, 1, 0);
							}
							break;
					}
					break;
...
int func_233(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (unk_0xF426A5DE932B3BEE(Global_69311[1 /*14*/].f_6, 0) && !unk_0xF426A5DE932B3BEE(Global_69311[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_103(iParam1, Global_69311[1 /*14*/].f_5, Global_69311[1 /*14*/].f_2, 0, Global_69311[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_103(iParam1, Global_69311[1 /*14*/].f_5, Global_69311[1 /*14*/].f_2, 0, Global_69311[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
bool func_237(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)
{
	func_246(uParam0, iParam1, sParam2, iParam6, iParam7, 0);
	Global_15760 = 0;
	Global_15719 = 1;
	Global_15726 = 0;
	Global_15721 = 0;
...
void func_247()
{
	...
	if (func_483(Local_455.f_0))
	{
		switch (iLocal_170)
		{
			case 0:
				func_284();
				if (func_265(Local_455.f_0, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					if (!func_14())
					{
						if (func_14())
						...
						unk_0x356675505D724E40(Local_782.f_1, Local_455.f_0, unk_0x5C9720EC37666AF2(Local_455.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
						if (func_5(Local_749.f_0))
						{
							if (func_6(Local_455.f_0))
							{
								if (!unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0))
								{
									unk_0x835BBE043A81D6DD(Local_455.f_0, Local_749.f_0, -1, -1, 1073741824, 1, 0);
								}
							}
						}
						func_495("GS_WAIT_FOR_PLAYER, player threatened Glen; attacking...");
						func_286(&uLocal_174, 7, Local_481[0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						if (func_263())
						{
							func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 0, 0);
						}
						else
						{
							func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_5", 7, 0, 0);
						}
						func_257();
						iLocal_170 = 3;
					}
				...
				else if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_455.f_0, 11f, 11f, 11f, 0, 1, 0))
				{
					if (!func_179(unk_0x27D769C59BC9D030(), 12, 4))
					{
						if (func_14())
						{
							func_12();
						}
						func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
						func_286(&uLocal_174, 2, unk_0x27D769C59BC9D030(), "TREVOR", 0, 1);
						func_262(&uLocal_174, "NIG1DAU", "NIG1D_FLEE", "NIG1D_FLEE_1", 7, 0, 0);
						if (func_5(Local_749.f_0))
						{
							if (func_6(Local_455.f_0))
							{
						...
						func_495("GS_WAIT_FOR_PLAYER, player got too close to Glen (alert_dis); attacking...");
						func_257();
						unk_0x356675505D724E40(Local_782.f_1, Local_455.f_0, unk_0x5C9720EC37666AF2(Local_455.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
						iLocal_170 = 3;
					}
					...
					{
						iLocal_388 = unk_0xA0F74982C6AAA9D4();
			...
			case 1:
				if (func_265(Local_455.f_0, 1, 1116471296, 1126825984, 0, 0, 0, 0) || iLocal_350 == 1)
				{
					func_495("GS_PLAYER_IN_OUTFIT, player threatened Glen or returned a second time; attacking...");
					func_257();
				}
				else
				{
					if (!unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_455.f_0, 11f, 11f, 11f, 0, 1, 0))
					{
						unk_0x356675505D724E40(Local_782.f_1, Local_455.f_0, unk_0x5C9720EC37666AF2(Local_455.f_0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
						unk_0x33A0CEA494F4C2A3(&uLocal_776);
						unk_0xD9F9CB5C8842E29C(0, 112f, 0);
						unk_0x878D12AEFBF5BAF0(0, "rcmnigel1d", "swing_a_mark", 8f, -2f, -1, 0, 0, 0, 0, 0);
						unk_0x878D12AEFBF5BAF0(0, "rcmnigel1d", "swing_b_mark", 8f, -2f, -1, 0, 0, 0, 0, 0);
						unk_0x575C8AF5AF9A9FED(uLocal_776, 1);
						unk_0x33F83FC0F5F458E3(uLocal_776);
						unk_0x8B8674266D533E9F(Local_455.f_0, uLocal_776);
						unk_0x433C209504FBC7EE(&uLocal_776);
						if (func_483(Local_468.f_0))
						{
							unk_0x7440EFC435CB25D1(Local_468.f_0);
						}
						iLocal_350 = 1;
						iVar0 = 0;
						while (iVar0 <= 2)
					...
					else if ((unk_0xA0F74982C6AAA9D4() - iLocal_381) >= 2500)
					{
						if (unk_0x799B2D82E6E6C363(Local_455.f_0, unk_0x27D769C59BC9D030()))
						{
							if (!func_14())
							{
								func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
								func_286(&uLocal_174, 2, unk_0x27D769C59BC9D030(), "TREVOR", 0, 1);
								if (func_256(&uLocal_174, "NIG1DAU", "NIG1D_BUMPF", 7, 0, 0, 0))
								{
									iLocal_381 = unk_0xA0F74982C6AAA9D4();
								}
							}
					...
					if ((func_5(Local_749.f_0) && func_5(Local_694[5 /*6*/])) && func_483(unk_0x27D769C59BC9D030()))
					{
						if (unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), Local_749.f_0, 0) || unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), Local_694[5 /*6*/], 0))
						{
							if (func_14())
							{
								func_15();
							}
							iLocal_387 = unk_0xA0F74982C6AAA9D4();
							func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
							func_286(&uLocal_174, 2, unk_0x27D769C59BC9D030(), "TREVOR", 0, 1);
							func_262(&uLocal_174, "NIG1DAU", "NIG1D_BANK", "NIG1D_BANK_1", 7, 0, 0);
							unk_0x33A0CEA494F4C2A3(&uLocal_776);
							unk_0x878D12AEFBF5BAF0(0, "rcmnigel1d", "thanks_male_03", 8f, -8f, -1, 0, 0, 0, 0, 0);
					...
					if ((unk_0xA0F74982C6AAA9D4() - iLocal_388) >= 15000)
					{
						if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_455.f_0, 11f, 11f, 11f, 0, 1, 0))
						{
							func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
							func_262(&uLocal_174, "NIG1DAU", "NIG1D_BANK", "NIG1D_BANK_2", 7, 0, 0);
							unk_0x33A0CEA494F4C2A3(&uLocal_776);
							unk_0xF14C2AE8A3F59CE0(0, unk_0x27D769C59BC9D030(), -1);
							unk_0x33F83FC0F5F458E3(uLocal_776);
							unk_0x8B8674266D533E9F(Local_455.f_0, uLocal_776);
							unk_0x433C209504FBC7EE(&uLocal_776);
							if (func_483(Local_782.f_1))
							{
								unk_0x356675505D724E40(Local_782.f_1, Local_455.f_0, unk_0x5C9720EC37666AF2(Local_455.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
							}
							iLocal_387 = unk_0xA0F74982C6AAA9D4();
			...
			case 2:
				if (func_265(Local_455.f_0, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					func_495("GS_ANGRY_AT_PLAYER, player threatened Glen; attacking...");
					func_257();
				}
				if (!unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_455.f_0, 11f, 11f, 11f, 0, 1, 0))
				{
					unk_0x356675505D724E40(Local_782.f_1, Local_455.f_0, unk_0x5C9720EC37666AF2(Local_455.f_0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					unk_0x33A0CEA494F4C2A3(&uLocal_776);
					unk_0x7ACF885D02B287A3(0, -1094.57f, 60.98f, 52.67f, 0);
					unk_0x878D12AEFBF5BAF0(0, "mini@golf", "iron_idle_high_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x878D12AEFBF5BAF0(0, "mini@golf", "iron_swing_intro_high", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x878D12AEFBF5BAF0(0, "mini@golf", "iron_swing_action_high", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x878D12AEFBF5BAF0(0, "mini@golf", "swing_outro", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x878D12AEFBF5BAF0(0, "mini@golf", "swing_react_bad_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x575C8AF5AF9A9FED(uLocal_776, 1);
					unk_0x33F83FC0F5F458E3(uLocal_776);
					unk_0x8B8674266D533E9F(Local_455.f_0, uLocal_776);
					unk_0x433C209504FBC7EE(&uLocal_776);
			...
			case 3:
				if (((func_5(Local_749.f_0) && func_255(Local_455.f_0, Local_749.f_0, 1) < 10f) && !unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), Local_749.f_0, 0)) && !unk_0x71A741FE7CE9D57A(Local_749.f_0))
				{
					if (unk_0xDD5B7E23D882DABD(Local_455.f_0, Local_749.f_0))
					{
						func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
						func_286(&uLocal_174, 2, unk_0x27D769C59BC9D030(), "TREVOR", 0, 1);
						func_262(&uLocal_174, "NIG1DAU", "NIG1D_FLEE", "NIG1D_FLEE_3", 7, 0, 0);
						if (func_6(Local_455.f_0))
						{
							if (!func_253())
							{
								unk_0x347457A360E454FB(Local_455.f_0, Local_749.f_0, "NIGEL1DGOLF", 786468, 0, 12, -1, -1082130432, 0, 1073741824);
							}
							else
							{
								iLocal_363 = 1;
								unk_0x347457A360E454FB(Local_455.f_0, Local_749.f_0, "NIGEL1DGOLF2", 786468, 0, 12, -1, -1082130432, 0, 1073741824);
							}
						}
						iLocal_170 = 4;
					}
			...
			case 4:
				...
				if (func_5(Local_749.f_0))
				{
					if (unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0))
					{
						if (iLocal_169 != 4)
						{
							if (unk_0x63B52896FA93CA2E(Local_749.f_0) >= 200)
							{
								func_289(Local_455.f_0, 0);
								iLocal_170 = 6;
							}
							if (func_248())
							{
					...
					if (unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), Local_749.f_0, 1))
					{
						iLocal_170 = 7;
					}
				}
			...
			case 6:
				...
				if (func_5(Local_749.f_0))
				{
					if (!unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0) || unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), Local_749.f_0, 1))
					{
						iLocal_170 = 7;
					}
				}
			...
			case 7:
				func_495("Celeb crashed or forced out - quitting chase");
				if (iLocal_169 < 6)
				{
				...
				if (func_5(Local_749.f_0))
				{
					if (unk_0x3AAD3BDAC622B4F1(Local_749.f_0))
					{
						unk_0x47419E1CD54CFC70("NIGEL1DGOLF");
						unk_0x47419E1CD54CFC70("NIGEL1DGOLF2");
					}
				}
				func_289(Local_455.f_0, 1);
				iLocal_170 = 8;
	...
	else
	{
		if (!iLocal_374)
		{
			func_495("bReplayCelebDeadCheck tripped, recording last 2 seconds");
			unk_0xA0342EB4AE1476FC(2f, 2f, 0);
			iLocal_374 = 1;
		}
		if (!unk_0xF426A5DE932B3BEE(Global_101154.f_17264.f_382, 4))
		{
			unk_0x26545538B51562AD(&(Global_101154.f_17264.f_382), 4);
		}
	}
}
...
int func_248()
{
	if (unk_0xECC01072E61D2F3A(Local_749.f_0) < 0.15f && unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0))
	{
		iLocal_378++;
		if (iLocal_378 > 30)
		{
			unk_0xEF936724A389D0F0(Local_749.f_0);
			if (func_5(Local_749.f_0) && func_483(Local_455.f_0))
			{
				unk_0x29D71D9710F2540E(Local_749.f_0, 2f, 3, 0);
				if (unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0))
				{
					unk_0xF156AA2A744B309E(Local_455.f_0);
					if (func_14())
					{
						func_12();
					}
					func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
					func_262(&uLocal_174, "NIG1DAU", "NIG1D_GIVEUP", "NIG1D_GIVEUP_1", 7, 0, 0);
					func_495("Celeb vehicle stuck");
				}
			}
			return 1;
		}
...
void func_249()
{
	if (unk_0xFFA15D908A6FDCD4(unk_0xA8CFDE65C45F813B(Local_455.f_0, 1), 20f, 1))
	{
		if (!unk_0x45252A58A2BF9751())
		{
			if (!func_14())
			{
				if ((unk_0xA0F74982C6AAA9D4() - iLocal_385) >= 3000)
				{
					switch (iLocal_379)
					{
						case 0:
							func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
							func_262(&uLocal_174, "NIG1DAU", "NIG1D_HIT", "NIG1D_HIT_7", 7, 0, 0);
							break;
						
						case 1:
							func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
							func_262(&uLocal_174, "NIG1DAU", "NIG1D_HIT", "NIG1D_HIT_8", 7, 0, 0);
							break;
						
						case 2:
							func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
							func_262(&uLocal_174, "NIG1DAU", "NIG1D_HIT", "NIG1D_HIT_9", 7, 0, 0);
							break;
						
						case 3:
							func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
							func_262(&uLocal_174, "NIG1DAU", "NIG1D_HIT", "NIG1D_HIT_10", 7, 0, 0);
							break;
					}
					iLocal_379++;
					iLocal_384 = unk_0xA0F74982C6AAA9D4();
					iLocal_385 = unk_0xA0F74982C6AAA9D4();
				}
			}
		}
	}
	...
	if (iLocal_169 == 4 || iLocal_169 == 5)
	{
		if (iLocal_380 < 5)
		{
			if (!unk_0x45252A58A2BF9751())
			{
				if (!func_14())
				{
					if ((unk_0xA0F74982C6AAA9D4() - iLocal_386) > 15000)
					{
						if (func_6(Local_455.f_0))
						{
							if (func_251(Local_455.f_0, unk_0x27D769C59BC9D030()) < 40f)
							{
								func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
								func_286(&uLocal_174, 2, unk_0x27D769C59BC9D030(), "TREVOR", 0, 1);
								switch (iLocal_380)
								{
									case 0:
										if (func_256(&uLocal_174, "NIG1DAU", "NIG1D_CHASE1", 8, 0, 0, 0))
										{
											func_495("Chase conv 1 started...");
											iLocal_386 = unk_0xA0F74982C6AAA9D4();
											iLocal_380++;
										}
										break;
									
									case 1:
										if (func_256(&uLocal_174, "NIG1DAU", "NIG1D_CHASE2", 8, 0, 0, 0))
										{
											func_495("Chase conv 2 started...");
											iLocal_386 = unk_0xA0F74982C6AAA9D4();
											iLocal_380++;
										}
										break;
									...
									case 2:
										if (func_256(&uLocal_174, "NIG1DAU", "NIG1D_CHASE3", 8, 0, 0, 0))
										{
											func_495("Chase conv 3 started...");
											iLocal_386 = unk_0xA0F74982C6AAA9D4();
											iLocal_380++;
										}
										break;
									...
									case 3:
										if (iLocal_169 == 5)
										{
											if (func_256(&uLocal_174, "NIG1DAU", "NIG1D_CHASE4", 8, 0, 0, 0))
											{
												func_495("Chase conv 4 started...");
												iLocal_386 = unk_0xA0F74982C6AAA9D4();
												iLocal_380++;
											}
										}
									...
									case 4:
										if (iLocal_169 == 5)
										{
											if (func_256(&uLocal_174, "NIG1DAU", "NIG1D_CHASE5", 8, 0, 0, 0))
											{
												func_495("Chase conv 5 started...");
												iLocal_386 = unk_0xA0F74982C6AAA9D4();
												iLocal_380++;
											}
										}
...
void func_252()
{
	...
	func_495("RESET COURSE SECURITY");
	iLocal_353 = 1;
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		if (func_483(Local_521[iVar0 /*13*/]))
		{
			iLocal_681[iVar0] = 1;
		}
		iVar0++;
...
int func_253()
{
	if (func_483(unk_0x27D769C59BC9D030()))
	{
		if (func_254(&uLocal_935, unk_0xA8CFDE65C45F813B(unk_0x27D769C59BC9D030(), 1)))
		{
			return 1;
		}
	}
...
void func_257()
{
	...
	if (iLocal_357 == 0)
	{
		...
		while (iVar0 <= 2)
		{
			if (func_483(Local_481[iVar0 /*13*/]))
			{
				unk_0xF156AA2A744B309E(Local_481[iVar0 /*13*/]);
				unk_0x33A0CEA494F4C2A3(&uLocal_775);
				unk_0x963F67A22BBFA2AE(0, unk_0x3A5708FEE1B560A9(250, 600));
				unk_0xF7CC6FE06DC847BB(0, unk_0x27D769C59BC9D030(), 0, 16);
				unk_0x33F83FC0F5F458E3(uLocal_775);
				unk_0x8B8674266D533E9F(Local_481[iVar0 /*13*/], uLocal_775);
				unk_0x433C209504FBC7EE(&uLocal_775);
				unk_0x7ED3655E5924C6F4(Local_481[iVar0 /*13*/], 25, 1);
				unk_0xD6FF698E7BC1C003(Local_481[iVar0 /*13*/], 1);
				unk_0x94DC76C688E7D222(Local_481[iVar0 /*13*/], 1);
				unk_0x246DB3A0E0918F4E(Local_481[iVar0 /*13*/], 1);
				unk_0xED5347CD6B7B01FA(5, iLocal_774, joaat("player"));
				iLocal_667[iVar0] = 4;
				if (!unk_0x7B4654D62B7E0E9E(Local_481[iVar0 /*13*/].f_11))
				{
					Local_481[iVar0 /*13*/].f_11 = func_261(Local_481[iVar0 /*13*/], 0, 0, 5);
				}
				func_479("Attack player, security guard: ", iVar0);
			}
			iVar0++;
		}
		if (func_5(Local_749.f_0))
		{
			if (!unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), Local_749.f_0, 0))
			{
				if (func_6(Local_455.f_0))
				{
					if (!unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0))
					{
						...
						unk_0x963F67A22BBFA2AE(0, unk_0x3A5708FEE1B560A9(250, 500));
						unk_0x835BBE043A81D6DD(0, Local_749.f_0, -1, -1, 1073741824, 1, 0);
						unk_0x33F83FC0F5F458E3(uLocal_775);
						unk_0x8B8674266D533E9F(Local_455.f_0, uLocal_775);
						unk_0x433C209504FBC7EE(&uLocal_775);
						func_495("Making Glen get into vehicle through MAKE_SECURITY_ATTACK()");
						iLocal_170 = 3;
					}
				}
			}
		...
		if (func_483(Local_468.f_0))
		{
			unk_0xD6FF698E7BC1C003(Local_468.f_0, 1);
		}
		func_289(Local_468.f_0, 1);
		func_259();
		if (iLocal_169 <= 3 && func_483(Local_455.f_0))
		{
			unk_0x356675505D724E40(Local_782.f_1, Local_455.f_0, unk_0x5C9720EC37666AF2(Local_455.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
			if (func_483(Local_468.f_0))
			{
				unk_0x356675505D724E40(Local_825.f_0, Local_468.f_0, unk_0x5C9720EC37666AF2(Local_468.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
			}
		}
		else if (unk_0xBF99E4112970270F(Local_782.f_1))
		{
			unk_0xE223D49B3EFFD3E3(Local_782.f_1, 1, 1);
		}
		func_258(790, 0);
		iLocal_357 = 1;
	}
...
void func_259()
{
	...
	while (iVar0 <= 5)
	{
		if (func_483(Local_561[iVar0 /*13*/]))
		{
			func_260(iVar0);
			iLocal_671[iVar0] = 3;
		}
...
{
	if (unk_0xD2CFFE76B625AE55(Local_788[iParam0 /*6*/]))
	{
		if (unk_0xBF99E4112970270F(Local_788[iParam0 /*6*/]))
		{
			unk_0xE223D49B3EFFD3E3(Local_788[iParam0 /*6*/], 1, 1);
		}
	}
	func_289(Local_561[iParam0 /*13*/], 1);
}
...
int func_263()
{
	if ((func_264(unk_0x27D769C59BC9D030()) == joaat("weapon_sniperrifle") || func_264(unk_0x27D769C59BC9D030()) == joaat("weapon_heavysniper")) || func_264(unk_0x27D769C59BC9D030()) == joaat("weapon_remotesniper"))
	{
		return 1;
	}
	return 0;
...
int func_265(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_483(unk_0x27D769C59BC9D030()) && func_483(iParam0))
	{
		...
		if (!unk_0x1D01F222CF5E89FA(unk_0x27D769C59BC9D030(), 6))
		{
			if (unk_0x1FEDE585C0F25C08(unk_0x27D769C59BC9D030()))
			{
				...
				{
					return func_278(unk_0x27D769C59BC9D030(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_266(int iParam0, float fParam1)
{
	...
	if (func_483(unk_0x27D769C59BC9D030()) && func_483(iParam0))
	{
		if (func_277(iParam0) || unk_0x3FB18423318A562B(unk_0x4D29100D094E5511(), iParam0))
		{
			if (unk_0x1D01F222CF5E89FA(unk_0x27D769C59BC9D030(), 6))
			{
				fVar0 = 40f;
...
{
	return func_268(iParam0, unk_0x27D769C59BC9D030(), fParam1, 1, 250, 7);
}
...
bool func_268(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_269(&(Local_49[iVar4 /*4*/]), Var1, iParam1, &(Local_49[iVar4 /*4*/].f_3), iParam0, iParam5);
...
int func_272(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_274(unk_0xA8CFDE65C45F813B(iParam1, 1) - unk_0xA8CFDE65C45F813B(iParam0, 1)) };
	...
	{
		Var3 = { func_274(unk_0x52AB056B2AF7BB53(iParam0, 31086, 0f, 5f, 0f) - unk_0x52AB056B2AF7BB53(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_282(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_274(Param1 - unk_0xA8CFDE65C45F813B(iParam0, 1)) };
...
void func_284()
{
	...
	{
		case 0:
			if (func_6(Local_455.f_0) && func_483(unk_0x27D769C59BC9D030()))
			{
				if (((func_285(unk_0x27D769C59BC9D030(), Local_455.f_0, 35f, 1) && iLocal_667[0] != 5) && iLocal_667[1] != 5) && iLocal_667[2] != 5)
				{
					if (!func_14())
					{
						func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
						if (func_256(&uLocal_174, "NIG1DAU", "NIG1D_SWING", 8, 0, 0, 0))
						{
							iLocal_693 = 1;
						}
					}
		...
		case 2:
			if ((unk_0xA0F74982C6AAA9D4() - iLocal_381) > 4500)
			{
				iLocal_693 = 0;
			}
			break;
...
void func_289(int iParam0, int iParam1)
{
	if (func_6(iParam0))
	{
		if (iParam1 == 0)
		{
			...
			unk_0x7ED3655E5924C6F4(iParam0, 31, 0);
			unk_0x7ED3655E5924C6F4(iParam0, 28, 0);
		...
		else
		{
			...
			unk_0x1545069170501814(iParam0, 65536, 1);
			unk_0x1545069170501814(iParam0, 128, 1);
			...
			unk_0x1545069170501814(iParam0, 64, 0);
			unk_0x33A0CEA494F4C2A3(&uLocal_776);
			unk_0x3DA9DFE29006A19F(0, unk_0x27D769C59BC9D030(), 200f, -1, 1, 0);
			unk_0x33F83FC0F5F458E3(uLocal_776);
			unk_0x8B8674266D533E9F(iParam0, uLocal_776);
			unk_0x433C209504FBC7EE(&uLocal_776);
			unk_0x94DC76C688E7D222(iParam0, 1);
		}
	}
...
void func_290()
{
	...
	switch (iLocal_171)
	{
		case 0:
			...
			func_495("ENTERING LOSE THE COPS");
			iLocal_171 = 1;
			break;
...
void func_291()
{
	if (iLocal_368)
	{
		if (!func_483(Local_455.f_0) && func_293())
		{
			func_495("Player achieved FOUR!");
			iLocal_368 = 0;
			func_292(792);
		}
	}
...
void func_294()
{
	...
	if (iLocal_348 == 0)
	{
		if (func_300(0))
		{
			...
			while (iVar0 <= 1)
			{
				func_299(&(Local_640[iVar0 /*13*/]), 0);
				unk_0xA8ED9F72DC442242(Local_640[iVar0 /*13*/], 1);
				unk_0xFFD8329ED7A8E20C(Local_640[iVar0 /*13*/], 0);
				iVar0++;
			}
			iVar0 = 0;
			while (iVar0 <= 1)
			{
				func_298(&(Local_755[iVar0 /*6*/]), 0);
				unk_0x7C898812896A5304(Local_755[iVar0 /*6*/].f_5, 1);
				iVar0++;
			}
			iLocal_348 = 1;
		}
	...
	else
	{
		...
		while (iVar0 <= 1)
		{
			if (func_483(Local_640[iVar0 /*13*/]))
			{
				func_295(iVar0);
			}
			iVar0++;
...
void func_295(int iParam0)
{
	switch (iLocal_678[iParam0])
	{
		case 0:
			if (func_5(Local_749.f_0))
			{
				if (func_483(Local_455.f_0))
				{
					if (unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0))
					{
						if (unk_0xC4F9E3DD5445F8E4(Local_455.f_0, Local_640[iParam0 /*13*/], 62f, 62f, 62f, 0, 1, 0))
						{
							if (func_6(Local_640[iParam0 /*13*/]))
							{
								unk_0xF14C2AE8A3F59CE0(Local_640[iParam0 /*13*/], Local_455.f_0, -1);
								iLocal_678[iParam0] = 1;
							}
						}
						else if (unk_0xFFA15D908A6FDCD4(unk_0xA8CFDE65C45F813B(Local_640[iParam0 /*13*/], 1), 15f, 1))
						{
							func_286(&uLocal_174, 8, Local_640[iParam0 /*13*/], "NIGEL1DAMBIENTGOLFER1", 0, 1);
							if (func_255(unk_0x27D769C59BC9D030(), Local_640[iParam0 /*13*/], 1) < 45f)
							{
								func_296(Local_561[iParam0 /*13*/], "GENERIC_CURSE_MED", 34);
							}
							func_289(Local_640[iParam0 /*13*/], 0);
							iLocal_678[iParam0] = 3;
						}
					}
					else if (func_265(Local_640[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || unk_0xC4F9E3DD5445F8E4(Local_455.f_0, Local_640[iParam0 /*13*/], 30f, 30f, 30f, 0, 1, 0))
					{
						func_289(Local_640[iParam0 /*13*/], 0);
						iLocal_678[iParam0] = 3;
					}
		...
		case 1:
			if (unk_0xC4F9E3DD5445F8E4(Local_455.f_0, Local_640[iParam0 /*13*/], 38f, 38f, 38f, 0, 1, 0))
			{
				if (func_6(Local_640[iParam0 /*13*/]))
				{
					func_286(&uLocal_174, 8, Local_640[iParam0 /*13*/], "NIGEL1DAMBIENTGOLFER1", 0, 1);
					if (func_255(unk_0x27D769C59BC9D030(), Local_640[iParam0 /*13*/], 1) < 45f)
					{
						func_296(Local_561[iParam0 /*13*/], "GENERIC_CURSE_HIGH", 34);
					}
					unk_0x09D2BE36C9D2B76F(Local_640[iParam0 /*13*/]);
					unk_0x3D09311EB0F37652(Local_640[iParam0 /*13*/], Local_640[iParam0 /*13*/].f_4, 3f, -1, 1193033728, 1056964608);
					unk_0x94DC76C688E7D222(Local_640[iParam0 /*13*/], 1);
		...
		case 2:
			if (unk_0xB1988D54B2C48CB5(Local_640[iParam0 /*13*/], Local_640[iParam0 /*13*/].f_4, 2f, 2f, 2f, 0, 1, 0))
			{
				func_289(Local_640[iParam0 /*13*/], 0);
				iLocal_678[iParam0] = 3;
			}
...
{
	unk_0x83983CFE8950EEAC(uParam0, sParam1, func_297(iParam2), 1);
}
...
{
	if (unk_0x875098323FCA8FE6(iParam0->f_8))
	{
		*iParam0 = unk_0x91D233CD0204A37F(26, iParam0->f_8, iParam0->f_1, 0f, 1, 1);
		if (func_483(*iParam0))
		{
			unk_0xFBDCF3D5834B58D8(*iParam0, iParam0->f_7);
		}
		if (iParam1 == 1)
		{
			unk_0x0049DE0B34213B12(iParam0->f_8);
		}
	}
}
...
int func_300(int iParam0)
{
	...
	while (iVar0 <= 1)
	{
		unk_0x97C59C4E8349D15F(Local_640[iVar0 /*13*/].f_8);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		unk_0x97C59C4E8349D15F(Local_755[iVar0 /*6*/].f_5);
		iVar0++;
	}
	if (iParam0 == 0)
	{
		...
		while (iVar0 <= 1)
		{
			if (!unk_0x875098323FCA8FE6(Local_640[iVar0 /*13*/].f_8))
			{
				return 0;
			}
			iVar0++;
		...
		while (iVar0 <= 1)
		{
			if (!unk_0x875098323FCA8FE6(Local_755[iVar0 /*6*/].f_5))
			{
				return 0;
			}
			iVar0++;
...
void func_301()
{
	...
	if (iLocal_345 == 0)
	{
		if (func_8(0))
		{
			func_495("Celeb security loaded, creating now...");
			iVar0 = 0;
			while (iVar0 <= 2)
			{
				func_299(&(Local_481[iVar0 /*13*/]), 0);
				unk_0xA8ED9F72DC442242(Local_481[iVar0 /*13*/], 1);
				unk_0xAC9A80BE63D6295F(Local_481[iVar0 /*13*/], joaat("weapon_pistol"), -1, 0, 1);
				unk_0x2CBC4FD55924CEE9(Local_481[iVar0 /*13*/], 1);
				unk_0xFFD8329ED7A8E20C(Local_481[iVar0 /*13*/], 1);
				unk_0x71065DDFF8D7744C(Local_481[iVar0 /*13*/], iLocal_774);
				unk_0xA82663A60582A7D7(Local_481[iVar0 /*13*/], 1);
				unk_0xF9867932DC1A555E(Local_481[iVar0 /*13*/].f_8, 1);
				iVar0++;
			}
			iLocal_345 = 1;
		}
	...
	while (iVar0 <= 2)
	{
		if (func_483(Local_481[iVar0 /*13*/]))
		{
			if (iLocal_357 == 0 && iLocal_351 == 0)
			{
				if (func_311())
				{
					func_495("Monitor_Security, player has 'mucked about' with the celeb scene; attacking...");
					if (func_310(unk_0x27D769C59BC9D030(), -1098.865f, 69.9792f, 53.6198f, 1) < 45f)
					{
						func_286(&uLocal_174, 7, Local_481[iVar0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
						func_257();
					}
					else
					{
		...
		else
		{
			if (unk_0x7B4654D62B7E0E9E(Local_481[iVar0 /*13*/].f_11))
			{
				unk_0x9403D0F4C7711241(&(Local_481[iVar0 /*13*/].f_11));
			}
			if (unk_0xD2CFFE76B625AE55(Local_481[iVar0 /*13*/]))
			{
				if (unk_0x2006A8C1BA2AFE80(Local_481[iVar0 /*13*/], 0))
				{
...
void func_303(int iParam0)
{
	...
	if (func_483(unk_0x27D769C59BC9D030()) && func_483(Local_481[iParam0 /*13*/]))
	{
		if (func_255(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 1) < 20f)
		{
			if (!unk_0xF40DABEAD014F84B(Local_481[iParam0 /*13*/], unk_0x27D769C59BC9D030()))
			{
				unk_0x85FD30B510E7C05E(Local_481[iParam0 /*13*/], unk_0x27D769C59BC9D030(), 1000, 0, 2);
			}
		}
	}
	...
	{
		case 0:
			if (func_265(Local_481[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || unk_0x3BA391CFC751A0E7(Local_481[iParam0 /*13*/], 60))
			{
				if (func_267(Local_481[iParam0 /*13*/], 110f))
				{
					if (func_14())
					{
						func_12();
					...
					if (func_263())
					{
						func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 1, 0);
					}
					func_495("SS_GUARD_AREA, player threatened Celeb security; attacking...");
					func_257();
				}
			}
			else if (unk_0x92B7E26C02EFE31E())
			{
				if ((unk_0x4FB9EE3D0706477D(Local_481[iParam0 /*13*/]) && func_267(Local_481[iParam0 /*13*/], 1126825984)) && func_255(Local_481[iParam0 /*13*/], unk_0x27D769C59BC9D030(), 1) < 50f)
				{
					if (func_14())
					{
						func_12();
					...
					func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 1, 0);
					func_495("SS_GUARD_AREA, player tried sniping Celeb security but was spotted; attacking...");
					func_257();
				}
			}
			else if (unk_0xC542D24D363306EC(unk_0x4D29100D094E5511(), Local_481[iParam0 /*13*/]))
			{
				if (func_263())
				{
					if (func_267(Local_481[iParam0 /*13*/], 1126825984))
					{
						if (func_14())
						{
							func_12();
						...
						func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 1, 0))
						{
							func_495("SS_GUARD_AREA, player aimed Sniper Rifle when security could see them; attacking...");
							func_257();
						}
					}
				}
			...
			{
				if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0))
				{
					if (!func_179(unk_0x27D769C59BC9D030(), 12, 4))
					{
						if (!func_307())
						{
							if (func_267(Local_481[iParam0 /*13*/], 1126825984) && unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
							{
								if (func_14())
								{
									func_12();
								...
								func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_5", 7, 0, 0))
								{
									func_495("SS_GUARD_AREA, player armed, not wearing outfit, guard has LOS or player within 18m; attacking...");
									func_257();
								}
							}
						}
						else if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
						{
							if (iLocal_349 == 0)
							{
								func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								...
								{
									if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_1", 7, 0, 0))
									{
										unk_0x33A0CEA494F4C2A3(&uLocal_775);
										unk_0x878D12AEFBF5BAF0(0, "rcmnigel1d", "thanks_male_03", 8f, -8f, -1, 0, 0, 0, 0, 0);
										unk_0xF14C2AE8A3F59CE0(0, unk_0x27D769C59BC9D030(), -1);
										unk_0x33F83FC0F5F458E3(uLocal_775);
										unk_0x8B8674266D533E9F(Local_481[iParam0 /*13*/], uLocal_775);
										unk_0x433C209504FBC7EE(&uLocal_775);
										iLocal_387 = unk_0xA0F74982C6AAA9D4();
										iLocal_349 = 1;
								...
								else if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_1", 7, 1, 0))
								{
									unk_0x33A0CEA494F4C2A3(&uLocal_775);
									unk_0x878D12AEFBF5BAF0(0, "rcmnigel1d", "thanks_male_03", 8f, -8f, -1, 0, 0, 0, 0, 0);
									unk_0xF14C2AE8A3F59CE0(0, unk_0x27D769C59BC9D030(), -1);
							...
							{
								if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 12f, 12f, 12f, 0, 1, 0))
								{
									if (func_14())
									{
										func_12();
									...
									func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
									if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0))
									{
										func_495("SS_GUARD_AREA, non-outfit, player came back to area after being warned; attacking");
										func_257();
									}
								}
							}
					...
					else if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
					{
						if (iLocal_349 == 0)
						{
							if (!func_14() && iLocal_359 == 0)
							{
								...
								{
									unk_0xF14C2AE8A3F59CE0(Local_481[iParam0 /*13*/], unk_0x27D769C59BC9D030(), -1);
								}
								if (func_6(Local_468.f_0))
								{
									unk_0x85FD30B510E7C05E(Local_468.f_0, unk_0x27D769C59BC9D030(), -1, 0, 2);
								}
								if (func_6(Local_455.f_0))
								{
									unk_0x85FD30B510E7C05E(Local_455.f_0, unk_0x27D769C59BC9D030(), -1, 0, 2);
									unk_0x33A0CEA494F4C2A3(&uLocal_776);
									unk_0xF14C2AE8A3F59CE0(0, unk_0x27D769C59BC9D030(), 1500);
									unk_0x878D12AEFBF5BAF0(0, "rcmnigel1d", "idle_c", 2f, -4f, -1, 1, 0, 0, 0, 0);
									unk_0x33F83FC0F5F458E3(uLocal_776);
									unk_0x8B8674266D533E9F(Local_455.f_0, uLocal_776);
									unk_0x433C209504FBC7EE(&uLocal_776);
								}
								...
								func_286(&uLocal_174, 2, unk_0x27D769C59BC9D030(), "TREVOR", 0, 1);
								func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
								if (func_256(&uLocal_174, "NIG1DAU", "NIG1D_OUTFIT", 7, 0, 0, 0))
								{
									iLocal_349 = 1;
									iVar0 = 0;
									while (iVar0 <= 2)
						...
						else if (iLocal_351 == 1)
						{
							if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 12f, 12f, 12f, 0, 1, 0))
							{
								...
								func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0))
								{
									func_495("SS_GUARD_AREA, outfit, player came back to area after being warned; attacking");
									func_257();
								}
							}
						}
			...
			else if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 50f, 50f, 50f, 0, 1, 0))
			{
				if (!unk_0x753C14DD45ABE554(unk_0xD9FFE8E1642C81E2(unk_0x27D769C59BC9D030(), 0), Local_749.f_5))
				{
					if (func_267(Local_481[iParam0 /*13*/], 1126825984))
					{
						if (func_14())
						...
						if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0))
						{
							func_495("SS_GUARD_AREA, player 50m away from group in non-buggy vehicle; attacking");
							func_257();
						}
					}
				}
				else if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0))
				{
					if (unk_0xECC01072E61D2F3A(unk_0xD9FFE8E1642C81E2(unk_0x27D769C59BC9D030(), 0)) >= 15f)
					{
						func_306("Going too fast, going to trigger aggro: ", unk_0xECC01072E61D2F3A(unk_0xD9FFE8E1642C81E2(unk_0x27D769C59BC9D030(), 0)));
						if (unk_0x3BA391CFC751A0E7(Local_481[iParam0 /*13*/], 60) || unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 6f, 6f, 6f, 0, 1, 0))
						{
							if (func_267(Local_481[iParam0 /*13*/], 1126825984))
							{
								if (func_14())
								...
								if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0))
								{
									func_495("SS_GUARD_AREA, player went too fast too close to security; attacking");
									func_257();
								}
							}
						}
					}
					else if (func_267(Local_481[iParam0 /*13*/], 1126825984))
					{
						func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						if (iLocal_356 == 0)
						{
							if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_7", 7, 0, 0))
							{
								func_479("'You can't drive through here buddy said by ped id: ", iParam0);
								if (func_6(Local_481[iParam0 /*13*/]))
								{
									unk_0xF14C2AE8A3F59CE0(Local_481[iParam0 /*13*/], unk_0x27D769C59BC9D030(), -1);
								}
		...
		case 1:
			if (!func_307())
			{
				if (func_267(Local_481[iParam0 /*13*/], 1126825984))
				{
					if (func_255(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 1) < 80f)
					{
						func_495("SS_GO_TO_PLAYER, player armed, guard has LOS; attacking...");
						func_257();
					}
				}
			}
			else if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0) && iLocal_351 == 1)
			{
				func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
				if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_3", 7, 0, 0))
				{
					if (func_6(Local_481[iParam0 /*13*/]))
					{
						unk_0xF14C2AE8A3F59CE0(Local_481[iParam0 /*13*/], unk_0x27D769C59BC9D030(), -1);
			...
			else if ((unk_0xA0F74982C6AAA9D4() - iLocal_387) >= 8000)
			{
				if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_2", 7, 0, 0))
					{
						unk_0x33A0CEA494F4C2A3(&uLocal_775);
						unk_0xF14C2AE8A3F59CE0(0, unk_0x27D769C59BC9D030(), -1);
						unk_0x85FD30B510E7C05E(0, unk_0x27D769C59BC9D030(), 7000, 0, 2);
						unk_0x878D12AEFBF5BAF0(0, "rcmnigel1d", "thanks_male_05", 4f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x33F83FC0F5F458E3(uLocal_775);
						unk_0x8B8674266D533E9F(Local_481[iParam0 /*13*/], uLocal_775);
						unk_0x433C209504FBC7EE(&uLocal_775);
						iLocal_387 = unk_0xA0F74982C6AAA9D4();
						iLocal_667[iParam0] = 2;
						func_495("Guard: going into SS_WARN_PLAYER ");
					}
				}
			}
			break;
		...
		case 2:
			if (!func_307())
			{
				if (func_267(Local_481[iParam0 /*13*/], 1126825984))
				{
					if (func_255(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 1) < 80f)
					{
						func_495("SS_WARN_PLAYER, player armed, guard has LOS; attacking...");
						func_257();
					}
				}
			}
			else if (!func_179(unk_0x27D769C59BC9D030(), 12, 4))
			{
				if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 4f, 4f, 4f, 0, 1, 0) || (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_455.f_0, 8f, 8f, 8f, 0, 1, 0) && iLocal_351 == 1))
				{
					func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_3", 7, 0, 0))
					{
					...
					func_495("SS_WARN_PLAYER, player got too close, going to aim...");
				}
				else
				{
					if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0))
					{
						if (unk_0x9A4E2270C2271219(unk_0x27D769C59BC9D030(), 0))
						{
							if (unk_0xECC01072E61D2F3A(unk_0xD9FFE8E1642C81E2(unk_0x27D769C59BC9D030(), 0)) >= 15f)
							{
								...
								func_306("SS_WARN_PLAYER, going too fast: ", unk_0xECC01072E61D2F3A(unk_0xD9FFE8E1642C81E2(unk_0x27D769C59BC9D030(), 0)));
								func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
								func_495("SS_WARN_PLAYER, player in vehicle going too fast within 9m of guard; attacking...");
								func_257();
							}
						}
					}
					if ((unk_0xA0F74982C6AAA9D4() - iLocal_387) >= 7000)
					{
						if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
						{
							func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
							if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_3", 7, 0, 0))
							{
								...
								iLocal_387 = unk_0xA0F74982C6AAA9D4();
								iLocal_667[iParam0] = 3;
								func_495("SS_WARN_PLAYER, player took too long, going to aim...");
							}
						}
						else if (func_255(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 1) > 20f)
						{
							unk_0xD9F9CB5C8842E29C(Local_481[iParam0 /*13*/], Local_481[iParam0 /*13*/].f_7, 0);
							unk_0x7440EFC435CB25D1(Local_481[iParam0 /*13*/]);
							func_495("SS_WARN_PLAYER, player >20m away, returning to SS_GUARD_AREA...");
			...
			else if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
			{
				if (iLocal_349 == 0)
				{
					if (!func_14() && iLocal_359 == 0)
					{
						...
						if (func_6(Local_455.f_0))
						{
							unk_0xF14C2AE8A3F59CE0(Local_455.f_0, unk_0x27D769C59BC9D030(), -1);
						}
						func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						func_286(&uLocal_174, 2, unk_0x27D769C59BC9D030(), "TREVOR", 0, 1);
						func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
				...
				else if (iLocal_351 == 1)
				{
					if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 12f, 12f, 12f, 0, 1, 0))
					{
						...
						if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0))
						{
							func_495("SS_WARN_PLAYER, outfit worn, player came back to area after being warned; attacking");
							func_257();
						}
					}
				}
		...
		case 3:
			if (!func_307())
			{
				if (func_267(Local_481[iParam0 /*13*/], 1126825984))
				{
					if (func_255(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 1) < 80f)
					{
						...
						func_495("SS_AIM_AT_PLAYER, player armed, guard has LOS; attacking...");
						if (iLocal_357 == 0)
						{
							func_257();
						}
						...
						{
							unk_0xF156AA2A744B309E(Local_481[iParam0 /*13*/]);
							unk_0x33A0CEA494F4C2A3(&uLocal_775);
							unk_0x963F67A22BBFA2AE(0, unk_0x3A5708FEE1B560A9(5, 200));
							unk_0xF7CC6FE06DC847BB(0, unk_0x27D769C59BC9D030(), 0, 16);
							unk_0x33F83FC0F5F458E3(uLocal_775);
							unk_0x8B8674266D533E9F(Local_481[iParam0 /*13*/], uLocal_775);
							unk_0x433C209504FBC7EE(&uLocal_775);
							unk_0x7ED3655E5924C6F4(Local_481[iParam0 /*13*/], 25, 1);
							unk_0xD6FF698E7BC1C003(Local_481[iParam0 /*13*/], 1);
							unk_0x94DC76C688E7D222(Local_481[iParam0 /*13*/], 1);
							unk_0x246DB3A0E0918F4E(Local_481[iParam0 /*13*/], 1);
							unk_0xED5347CD6B7B01FA(5, iLocal_774, joaat("player"));
							iLocal_667[iParam0] = 4;
							if (!unk_0x7B4654D62B7E0E9E(Local_481[iParam0 /*13*/].f_11))
							{
								Local_481[iParam0 /*13*/].f_11 = func_261(Local_481[iParam0 /*13*/], 0, 0, 5);
							}
							func_479("Attack player, FORCE security guard: ", iParam0);
						}
					}
				}
			}
			...
			{
				if (unk_0xFFA15D908A6FDCD4(unk_0xA8CFDE65C45F813B(Local_481[iParam0 /*13*/], 1), 20f, 0) && unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					if (func_14())
					{
						func_12();
					...
					func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
					func_495("SS_AIM_AT_PLAYER, bullet detected within 20m of a ped, attacking...");
					func_257();
				}
				if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 7f, 7f, 5f, 0, 1, 0) || (func_305(unk_0x27D769C59BC9D030(), -1097.28f, 68.05f, 52.99f, 10f) && iLocal_351 == 1))
				{
					if (func_14())
					{
						func_12();
					...
					func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
					func_495("SS_AIM_AT_PLAYER, player got too close, attacking...");
					func_257();
				}
				else
				{
					if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
					{
						if (unk_0x9A4E2270C2271219(unk_0x27D769C59BC9D030(), 0))
						{
							if (unk_0xECC01072E61D2F3A(unk_0xD9FFE8E1642C81E2(unk_0x27D769C59BC9D030(), 0)) >= 15f)
							{
								...
								func_306("SS_AIM_AT_PLAYER, going too fast: ", unk_0xECC01072E61D2F3A(unk_0xD9FFE8E1642C81E2(unk_0x27D769C59BC9D030(), 0)));
								func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
								func_495("SS_AIM_AT_PLAYER, player in vehicle above acceptable speed, within 20m; attacking...");
								func_257();
							}
						}
					}
					if ((unk_0xA0F74982C6AAA9D4() - iLocal_387) >= 10000)
					{
						if (func_483(Local_455.f_0))
						{
							if (!unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0) && !unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_455.f_0, 11f, 11f, 11f, 0, 1, 0))
							{
								if (func_6(Local_481[iParam0 /*13*/]))
								{
									unk_0x09D2BE36C9D2B76F(Local_481[iParam0 /*13*/]);
									unk_0x3D09311EB0F37652(Local_481[iParam0 /*13*/], Local_481[iParam0 /*13*/].f_1, 3f, -1, Local_481[iParam0 /*13*/].f_7, 1056964608);
								}
								iLocal_351 = 1;
								iLocal_667[iParam0] = 0;
							}
							else if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
							{
								if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0) || (unk_0xA0F74982C6AAA9D4() - iLocal_387) >= 12000)
								{
									if (func_14())
									{
										func_12();
									...
									func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
									func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
									func_495("SS_AIM_AT_PLAYER, player took too long and didn't move away, attacking...");
									func_257();
								}
							}
						}
		...
		case 4:
			if (func_255(Local_481[iParam0 /*13*/], unk_0x27D769C59BC9D030(), 1) > 120f && (unk_0x9A4E2270C2271219(Local_455.f_0, 0) || func_483(Local_455.f_0)))
			{
				if (unk_0x7B4654D62B7E0E9E(Local_481[iParam0 /*13*/].f_11))
				{
					unk_0x9403D0F4C7711241(&(Local_481[iParam0 /*13*/].f_11));
					func_289(Local_481[iParam0 /*13*/], 1);
					iLocal_667[iParam0] = 6;
				}
			}
			else if (!func_304(Local_481[iParam0 /*13*/], 242628503))
			{
				unk_0x33A0CEA494F4C2A3(&uLocal_775);
				unk_0x963F67A22BBFA2AE(0, unk_0x3A5708FEE1B560A9(5, 200));
				unk_0xF7CC6FE06DC847BB(0, unk_0x27D769C59BC9D030(), 0, 16);
		...
		case 5:
			...
			if (func_265(Local_481[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || unk_0x3BA391CFC751A0E7(Local_481[iParam0 /*13*/], 60))
			{
				func_495("SS_STANDDOWN, player threatened Glen OR guard thought he'd get run over; attacking...");
				func_257();
			}
			else if (unk_0xC542D24D363306EC(unk_0x4D29100D094E5511(), Local_481[iParam0 /*13*/]))
			{
				if (func_263())
				{
					if (func_267(Local_481[iParam0 /*13*/], 1126825984))
					{
						...
						func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 0, 0);
						func_495("SS_STANDDOWN, player aiming Sniper Rifle, guard has LOS; attacking...");
						func_257();
					}
				}
			}
...
bool func_305(int iParam0, struct<3> Param1, float fParam4)
{
	return unk_0xB7A628320EFF8E47(unk_0xA8CFDE65C45F813B(iParam0, 1), Param1) <= (fParam4 * fParam4);
}

void func_306(char* sParam0, float fParam1)
{
	sParam0 = sParam0;
	fParam1 = fParam1;
}
...
int func_307()
{
	if (func_264(unk_0x27D769C59BC9D030()) != joaat("weapon_unarmed") && func_264(unk_0x27D769C59BC9D030()) != joaat("object"))
	{
		if (func_264(unk_0x27D769C59BC9D030()) != joaat("weapon_golfclub"))
		{
			return 0;
		}
		if (!unk_0x9A4E2270C2271219(unk_0x27D769C59BC9D030(), 0))
...
void func_308()
{
	...
	if (unk_0xD2CFFE76B625AE55(Local_455.f_0))
	{
		if (iLocal_169 < 3 || func_255(unk_0x27D769C59BC9D030(), Local_455.f_0, 1) > 100f)
		{
			iVar0 = 0;
			while (iVar0 <= 2)
			{
				if (func_6(Local_481[iVar0 /*13*/]))
				{
					...
					if (iVar0 == 1)
					{
						if (unk_0xD2CFFE76B625AE55(Local_455.f_0))
						{
							unk_0xF14C2AE8A3F59CE0(Local_481[iVar0 /*13*/], Local_455.f_0, 0);
							unk_0x9B6F077214CEDE77(Local_481[iVar0 /*13*/], Local_455.f_0, 20000, 6f, 1073741824, 1073741824, 0);
						}
					}
					else
					{
						unk_0x85FD30B510E7C05E(Local_481[iVar0 /*13*/], unk_0x27D769C59BC9D030(), -1, 0, 2);
					}
					unk_0xCA26676919C42B5B(Local_481[iVar0 /*13*/], joaat("weapon_pistol"), 1);
					unk_0x7F4F6E605AAF8691(Local_481[iVar0 /*13*/], 1, -1, "DEFAULT_ACTION");
					func_479("Alerted, security guard: ", iVar0);
				}
				iLocal_667[iVar0] = 3;
				iVar0++;
			}
			if (func_483(Local_455.f_0))
			{
				if (!func_304(Local_455.f_0, 474215631))
				{
					unk_0xF156AA2A744B309E(Local_455.f_0);
					unk_0x4F84B4D98F3DA350(Local_455.f_0, -1);
				}
			}
			if (func_483(Local_468.f_0))
			{
				unk_0xF156AA2A744B309E(Local_468.f_0);
				if (unk_0xBF99E4112970270F(Local_825.f_0))
				{
					unk_0xE223D49B3EFFD3E3(Local_825.f_0, 1, 1);
				}
				unk_0x3DA9DFE29006A19F(Local_468.f_0, unk_0x27D769C59BC9D030(), 300f, -1, 1, 0);
				func_309(&Local_468, 1, 0, 1);
				iLocal_355 = 1;
			}
			iLocal_351 = 1;
			func_258(790, 0);
		...
		{
			func_495("Alert called, but guards need to attack instead");
			func_257();
		}
	}
}
...
int func_311()
{
	...
	while (iVar0 <= 2)
	{
		if ((!func_483(Local_481[iVar0 /*13*/]) || func_312(unk_0x27D769C59BC9D030(), Local_481[iVar0 /*13*/], 1)) || unk_0xBD036012AF60D938(Local_481[iVar0 /*13*/]))
		{
			func_495("HAS_PLAYER_MUCKED_ABOUT(): Player bumped celeb security with vehicle OR celeb security dead");
			return 1;
		}
		iVar0++;
	}
	if ((!func_483(Local_455.f_0) || func_312(unk_0x27D769C59BC9D030(), Local_455.f_0, 1)) || unk_0xBD036012AF60D938(Local_455.f_0))
	{
		func_495("HAS_PLAYER_MUCKED_ABOUT(): Celeb ragdoll OR player bumped celeb with vehicle OR celeb isn't alive");
		return 1;
	}
	if ((!func_483(Local_468.f_0) || func_312(unk_0x27D769C59BC9D030(), Local_468.f_0, 1)) || unk_0xBD036012AF60D938(Local_468.f_0))
	{
		func_495("HAS_PLAYER_MUCKED_ABOUT(): Celeb friend ragdoll OR player bumped friend with vehicle OR friend isn't alive");
		return 1;
	}
	if (func_5(Local_749.f_0) && func_483(unk_0x27D769C59BC9D030()))
	{
		if (unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), Local_749.f_0, 0))
		{
			func_495("HAS_PLAYER_MUCKED_ABOUT(): Player in celeb's golf cart");
			return 1;
		}
	}
	else
	{
		func_495("HAS_PLAYER_MUCKED_ABOUT(): Celeb golf cart not OK, player destroyed it?");
		return 1;
	}
	if (func_5(Local_694[4 /*6*/]) && func_483(unk_0x27D769C59BC9D030()))
	{
		if (unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), Local_694[4 /*6*/], 0))
		{
			func_495("HAS_PLAYER_MUCKED_ABOUT(): Player in golf cart behind celeb");
			return 1;
		}
	}
	else
	{
		func_495("HAS_PLAYER_MUCKED_ABOUT(): Golf cart behind celeb not OK, player destroyed it?");
		return 1;
	}
	if (func_5(Local_694[5 /*6*/]) && func_483(unk_0x27D769C59BC9D030()))
	{
		if (unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), Local_694[5 /*6*/], 0))
		{
			func_495("HAS_PLAYER_MUCKED_ABOUT(): Player in golf cart next to celeb");
			return 1;
		}
	}
	else
	{
		func_495("HAS_PLAYER_MUCKED_ABOUT(): Golf cart next to celeb not OK, player destroyed it?");
		return 1;
	}
	return 0;
}
...
{
	if (func_6(iParam0) && unk_0x9A4E2270C2271219(iParam0, 0))
	{
		if (func_6(iParam1))
		{
	...
	switch (iLocal_171)
	{
		case 0:
			...
			while (iVar0 <= 2)
			{
				if (unk_0x7B4654D62B7E0E9E(Local_481[iVar0 /*13*/].f_11))
				{
					unk_0xC5B4E9487339A2BB(Local_481[iVar0 /*13*/].f_11, 0.7f);
				}
				iVar0++;
			}
			func_495("ENTERING LOSE THE SECURITY ");
			iLocal_171 = 1;
			break;
		
		case 1:
			if (!func_293() && !func_314())
			{
				func_301();
			}
			else
...
int func_314()
{
	...
	while (iVar0 <= 2)
	{
		if (func_483(Local_481[iVar0 /*13*/]))
		{
			if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_481[iVar0 /*13*/], 70f, 70f, 70f, 0, 1, 0))
			{
				return 0;
			}
		}
	...
	switch (iLocal_171)
	{
		case 0:
			...
			if (func_483(Local_782.f_1))
			{
				if (iLocal_361 == 0)
				{
					if (!func_14() || unk_0xC06A80AF9911D7A8(203) == 0)
					{
						func_33("N1D_COLLECT", 7500, 5);
						iLocal_361 = 1;
					}
			...
			unk_0xA0342EB4AE1476FC(4f, 10f, 1);
			func_320(&uLocal_36, 0, 0);
			func_495("ENTERING COLLECT GOLF CLUB ");
			iLocal_171 = 1;
			break;
		...
		case 1:
			...
			if (iLocal_367 == 0)
			{
				if (func_318(unk_0x27D769C59BC9D030()))
				{
					func_317();
				}
			}
			...
			if (func_483(Local_782.f_1))
			{
				if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_782.f_1, 0.8f, 0.8f, 2f, 0, 1, 1))
				{
					if (unk_0x0E023C3ABA6B29DD(Local_782.f_1))
					{
						func_495("Golf club attached to bag - correct?");
						unk_0x2A5264C35FD91CE4(uLocal_389, "COLLECT_IN_BAG", Local_782.f_1, "NIGEL_1D_SOUNDSET", 0, 0);
					}
					else
					{
						func_495("Golf club NOT attached to bag - correct?");
						unk_0x2A5264C35FD91CE4(uLocal_389, "COLLECT_OUT_BAG", Local_782.f_1, "NIGEL_1D_SOUNDSET", 0, 0);
					}
					unk_0x09942629F73A2BD5(0, 300, 128);
					iLocal_362 = 1;
					func_316(0, -1);
					iLocal_171 = 2;
				}
		...
		case 2:
			if (iLocal_362 == 1)
			{
				unk_0x8ACEB4FC9E9EE225();
				iLocal_359 = 0;
				if (unk_0xD2CFFE76B625AE55(Local_782.f_1))
				{
					unk_0x7C0FE14555841C1E(&(Local_782.f_1));
				}
				func_288(&iLocal_339);
				if (!func_293() && !func_314())
				{
...
void func_317()
{
	if (iLocal_367 == 0)
	{
		...
		{
			unk_0xF30F45A6EE56923E("SCRIPTED_SCANNER_REPORT_NIGEL_1D_01", 0f);
			func_495("*** Played special Nigel 1D police report ***");
			iLocal_367 = 1;
		}
	}
}
...
{
	if (func_254(&uLocal_831, unk_0xA8CFDE65C45F813B(iParam0, 1)))
	{
		return 1;
	}
	return 0;
...
void func_319()
{
	if (iLocal_364 == 0)
	{
		if (func_483(Local_782.f_1) && iLocal_169 == 6)
		{
			if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_782.f_1, 25f, 25f, 25f, 0, 1, 0))
			{
				iLocal_364 = 1;
			}
		}
	...
	if (func_483(unk_0x27D769C59BC9D030()))
	{
		if (iLocal_358 == 0)
		{
			if (iLocal_170 == 7 || iLocal_169 == 6)
			{
				if (func_483(Local_782.f_1))
				{
					if (iLocal_364 == 1)
					{
						if (!unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_782.f_1, 65f, 65f, 65f, 0, 1, 0))
						{
		...
		else if (iLocal_170 == 7 || iLocal_169 == 6)
		{
			if (func_483(Local_782.f_1))
			{
				if (!unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_782.f_1, 140f, 140f, 140f, 0, 1, 0))
				{
					func_34(3);
				}
			}
		...
		if (iLocal_169 < 6)
		{
			if (func_483(Local_455.f_0))
			{
				if (!unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_455.f_0, 140f, 140f, 140f, 0, 1, 0) && !func_268(unk_0x27D769C59BC9D030(), Local_455.f_0, 1126825984, 1, 250, 7))
				{
					func_34(1);
				}
			}
...
void func_322()
{
	if (iLocal_344 == 1)
	{
		...
		func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
		func_286(&uLocal_174, 2, unk_0x27D769C59BC9D030(), "TREVOR", 0, 1);
		func_262(&uLocal_174, "NIG1DAU", "NIG1D_HIT", "NIG1D_HIT_11", 7, 0, 0);
	}
	if (unk_0xD2CFFE76B625AE55(Local_455.f_0) && func_483(Local_782.f_1))
	{
		if (unk_0x53D573A48E8DFC4C(Local_782.f_1, Local_455.f_0))
		{
			unk_0xE223D49B3EFFD3E3(Local_782.f_1, 1, 1);
		}
	}
	...
	if (unk_0xD2CFFE76B625AE55(Local_782.f_1))
	{
		iLocal_339 = unk_0xABF4388EB11AD060(Local_782.f_1);
		unk_0x8D910E607F73E53D(iLocal_339, 2);
	}
}
...
void func_323()
{
	switch (iLocal_171)
	{
		case 0:
			...
			if (func_5(Local_749.f_0))
			{
				if (unk_0x4C3235E6E203703D(Local_749.f_0) > 600)
				{
					unk_0x51F79AC13D2AD286(Local_749.f_0, 600);
				}
			}
			if (func_483(iLocal_777))
			{
				if (!unk_0xBF99E4112970270F(iLocal_777))
				{
					func_495("Reattaching bag to buggy!?");
					unk_0x356675505D724E40(iLocal_777, Local_749.f_0, 0, 0.2f, -1.3f, 0.5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
				}
			}
			if (func_483(Local_782.f_1) && func_483(Local_455.f_0))
			{
				if (!unk_0xBF99E4112970270F(Local_782.f_1))
				{
					func_495("Reattaching club to bag!?");
					unk_0x356675505D724E40(Local_782.f_1, iLocal_777, 0, 0.1f, 0f, -0.25f, -5f, 155f, 0f, 0, 0, 0, 0, 2, 1);
				}
				else if (unk_0x53D573A48E8DFC4C(Local_782.f_1, Local_455.f_0))
				{
					func_495("Glen still holding club, reattach to bag");
					unk_0xE223D49B3EFFD3E3(Local_782.f_1, 1, 1);
					unk_0x356675505D724E40(Local_782.f_1, iLocal_777, 0, 0.1f, 0f, -0.25f, -5f, 155f, 0f, 0, 0, 0, 0, 2, 1);
				}
			}
			unk_0x66EEFE13E1BFC898(2);
			func_495("ENTERING CHASE IN CITY ");
			func_288(&iLocal_339);
			iLocal_339 = func_350(Local_749.f_0, 0, 5);
			iLocal_171 = 1;
			break;
		...
		case 1:
			func_247();
			func_319();
			func_349(iLocal_339, Local_749.f_0, 140f, 1061158912, 0);
			func_291();
			if (bLocal_369)
			{
				if (func_483(Local_782.f_1) && func_483(iLocal_777))
				{
					if (!unk_0x9A4E2270C2271219(unk_0x27D769C59BC9D030(), 0))
					{
						if (unk_0x53D573A48E8DFC4C(Local_782.f_1, iLocal_777))
						{
							if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_782.f_1, 0.8f, 0.8f, 2f, 0, 1, 1))
							{
								unk_0x2A5264C35FD91CE4(uLocal_389, "COLLECT_IN_BAG", Local_782.f_1, "NIGEL_1D_SOUNDSET", 0, 0);
...
int func_324()
{
	if (func_5(Local_749.f_0))
	{
		if (func_483(Local_455.f_0))
		{
			func_326(&uLocal_36, Local_749.f_0, 0, 0, 1, 1, 1);
			if (unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0))
			{
				func_325();
			}
			if ((func_248() || unk_0xAB191CE9D0342508(Local_749.f_0, 0, 0)) || unk_0xAB191CE9D0342508(Local_749.f_0, 1, 0))
			{
				func_495("Buggy stuck or front tyres burst in city - returning true");
				if (unk_0x3AAD3BDAC622B4F1(Local_749.f_0))
				{
					unk_0x47419E1CD54CFC70("NIGEL1DGOLF");
					unk_0x47419E1CD54CFC70("NIGEL1DGOLF2");
			...
			if (unk_0x4C3235E6E203703D(Local_749.f_0) < 500)
			{
				func_495("Buggy health below threshold - returning true");
				iLocal_344 = 1;
				return 1;
			}
			if (!unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0))
			{
				func_495("Celeb not in buggy while monitoring chase - returning true");
				return 1;
			}
		}
		else
		{
			func_495("Celeb dead - returning true");
			return 1;
		}
	}
	else
	{
		func_495("Buggy somehow not ok - returning true");
		return 1;
	}
	return 0;
}
...
void func_325()
{
	if (func_483(Local_455.f_0))
	{
		if (!unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_455.f_0, 20f, 20f, 20f, 0, 1, 0))
		{
			unk_0x54D07F6EC0E6D324(Local_455.f_0, 0.3f);
		}
		else
		{
			unk_0x54D07F6EC0E6D324(Local_455.f_0, 0f);
		}
	}
}
...
{
	func_327(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}
...
void func_329(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_347(iParam1) && unk_0x55D0FF0532D6A513(iParam1))
	{
		iVar1 = 0;
...
{
	if (func_347(unk_0x27D769C59BC9D030()))
	{
...
int func_334(char* sParam0)
{
	if (!func_335(1, 1, 0))
	{
		if ((!unk_0x75CB9E30BA492FF0(sParam0) && func_321(sParam0)) || func_321("CMN_HINT"))
		{
			unk_0x5BD150B52CE8D356(1);
		}
		return 0;
...
bool func_339()
{
	return func_340(unk_0x4D29100D094E5511());
}
...
int func_342(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_345(bParam1, bParam2, bParam3) || unk_0x9A4E2270C2271219(unk_0x27D769C59BC9D030(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((unk_0xA0F74982C6AAA9D4() - uParam0->f_4) > 500)
			{
				...
				{
					if (unk_0x9A4E2270C2271219(unk_0x27D769C59BC9D030(), 1) || func_343(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_349(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_351()
{
	...
	{
		case 0:
			func_495("CHASE THE GOLFER ");
			iLocal_384 = unk_0xA0F74982C6AAA9D4();
			iLocal_385 = unk_0xA0F74982C6AAA9D4();
			iLocal_386 = unk_0xA0F74982C6AAA9D4();
			unk_0xC5B4E9487339A2BB(iLocal_339, 1f);
			func_365(&(Local_694[3 /*6*/]));
			if (func_483(iLocal_777) && func_5(Local_749.f_0))
			{
				if (!unk_0xBF99E4112970270F(iLocal_777))
				{
					func_495("Reattaching bag to buggy!?");
			...
			if ((func_483(Local_782.f_1) && func_483(Local_455.f_0)) && func_5(Local_749.f_0))
			{
				if (!unk_0xBF99E4112970270F(Local_782.f_1))
				{
					func_495("Reattaching club to bag!?");
		...
		case 1:
			...
			func_317();
			unk_0xBBC617778A2D3CA1(unk_0x4D29100D094E5511());
			func_349(iLocal_339, Local_455.f_0, 140f, 1061158912, 0);
			if (!func_483(Local_782.f_1))
			{
				unk_0x8ACEB4FC9E9EE225();
				if (func_14())
			...
			if (func_352() || !func_483(Local_455.f_0))
			{
				func_33("N1D_COLLECT", 7500, 5);
				func_35(6);
			}
			else
			{
				...
				if (unk_0x576F8D887AA9D188(Local_749.f_0) >= 200)
				{
					iLocal_171 = 2;
				}
			}
...
int func_352()
{
	if (func_5(Local_749.f_0))
	{
		if (func_483(Local_455.f_0))
		{
			...
			if ((func_248() || unk_0xAB191CE9D0342508(Local_749.f_0, 0, 0)) || unk_0xAB191CE9D0342508(Local_749.f_0, 1, 0))
			{
				...
				unk_0xF156AA2A744B309E(Local_455.f_0);
				func_289(Local_455.f_0, 1);
				func_495("*** Celeb cart stuck or a front wheel is burst - chase monitor returning True");
				return 1;
			}
			else
			{
			...
			{
				iLocal_344 = 1;
				func_495("*** Celeb cart below drop club threshold - chase monitor returning True");
				return 1;
			}
			if (!unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0))
			{
				func_495("*** Celeb no longer in vehicle - chase monitor returning True");
				return 1;
			}
			if (unk_0x77F1B7F6C32990D6(Local_749.f_0, unk_0x27D769C59BC9D030(), 1) && !unk_0x6AE62C1DA604CA92(Local_749.f_0, 0, 2))
			{
				func_353();
				func_479("VEHICLE HEALTH IS ", unk_0x4C3235E6E203703D(Local_749.f_0));
				unk_0x1393E54C663BBD20(Local_749.f_0);
			}
			else if (unk_0x77F1B7F6C32990D6(Local_749.f_0, unk_0x27D769C59BC9D030(), 1))
			{
				func_479("VEHICLE HEALTH IS ", unk_0x4C3235E6E203703D(Local_749.f_0));
				unk_0x1393E54C663BBD20(Local_749.f_0);
			}
	...
	{
		func_495("*** Celeb cart wrecked/not OK - chase monitor returning True");
		func_289(Local_455.f_0, 1);
		return 1;
	}
	return 0;
...
void func_353()
{
	if (!unk_0x45252A58A2BF9751() || unk_0xC06A80AF9911D7A8(203) == 0)
	{
		if (!func_14())
		{
			if ((unk_0xA0F74982C6AAA9D4() - iLocal_384) >= 6000)
			{
				func_286(&uLocal_174, 6, Local_455.f_0, "FOSTENBURG", 0, 1);
				if (func_256(&uLocal_174, "NIG1DAU", "NIG1D_HIT", 7, 0, 0, 0))
				{
					iLocal_384 = unk_0xA0F74982C6AAA9D4();
					iLocal_385 = unk_0xA0F74982C6AAA9D4();
				}
			...
			if (func_5(Local_749.f_0))
			{
				if (unk_0x1C48F76B3D032074(Local_455.f_0, Local_749.f_0, 0))
				{
					if (iLocal_363 == 0)
					{
						if (!unk_0x3AAD3BDAC622B4F1(Local_749.f_0))
						{
							unk_0x347457A360E454FB(Local_455.f_0, Local_749.f_0, "NIGEL1DGOLF", 786468, 0, 8, -1, -1082130432, 0, 1073741824);
						}
					}
					else if (!unk_0x3AAD3BDAC622B4F1(Local_749.f_0))
					{
						iLocal_363 = 0;
					}
				}
...
void func_355()
{
	...
	if (iLocal_347 == 0)
	{
		if (func_362(0))
		{
			...
			while (iVar0 <= 5)
			{
				func_299(&(Local_561[iVar0 /*13*/]), 0);
				unk_0xA8ED9F72DC442242(Local_561[iVar0 /*13*/], 1);
				unk_0xFFD8329ED7A8E20C(Local_561[iVar0 /*13*/], 1);
				iVar0++;
			}
			iVar0 = 0;
			while (iVar0 <= 5)
			{
				func_361(&(Local_788[iVar0 /*6*/]), 0);
				unk_0x356675505D724E40(Local_788[iVar0 /*6*/], Local_561[iVar0 /*13*/], unk_0x5C9720EC37666AF2(Local_561[iVar0 /*13*/], 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
				iVar0++;
			}
			unk_0x356675505D724E40(Local_788[0 /*6*/], Local_561[0 /*13*/], unk_0x5C9720EC37666AF2(Local_561[0 /*13*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			unk_0x356675505D724E40(Local_788[1 /*6*/], Local_561[1 /*13*/], unk_0x5C9720EC37666AF2(Local_561[1 /*13*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			unk_0x356675505D724E40(Local_788[2 /*6*/], Local_561[2 /*13*/], unk_0x5C9720EC37666AF2(Local_561[2 /*13*/], 28422), 0f, 0f, 0.05f, 0f, -10f, -90f, 0, 0, 0, 0, 2, 1);
			unk_0x356675505D724E40(Local_788[3 /*6*/], Local_561[3 /*13*/], unk_0x5C9720EC37666AF2(Local_561[3 /*13*/], 28422), -0.01f, 0f, 0f, 10f, 0f, -90f, 0, 0, 0, 0, 2, 1);
			iVar0 = 0;
			while (iVar0 <= 1)
			{
				if (func_6(Local_561[iVar0 /*13*/]))
				{
					unk_0x878D12AEFBF5BAF0(Local_561[iVar0 /*13*/], "rcmnigel1d", Local_561[iVar0 /*13*/].f_12, 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				iVar0++;
			}
			iVar0 = 2;
			while (iVar0 <= 3)
			{
				if (func_6(Local_561[iVar0 /*13*/]))
				{
					unk_0x878D12AEFBF5BAF0(Local_561[iVar0 /*13*/], "mini@golf", Local_561[iVar0 /*13*/].f_12, 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				iVar0++;
			}
			iLocal_347 = 1;
	...
	else
	{
		...
		while (iVar0 <= 5)
		{
			if (func_360(iVar0))
			{
				...
				{
					iLocal_671[iVar0] = 4;
					func_479("This Ambient Golfer is now dead: ", iVar0);
					func_358(iVar0);
				}
			}
			if (func_483(Local_561[iVar0 /*13*/]))
...
void func_356(int iParam0)
{
	switch (iLocal_671[iParam0])
	{
		case 0:
			if (!unk_0x9A4E2270C2271219(unk_0x27D769C59BC9D030(), 0))
			{
				if (unk_0xFFA15D908A6FDCD4(unk_0xA8CFDE65C45F813B(Local_561[iParam0 /*13*/], 1), 50f, 0))
				{
					func_260(iParam0);
					if (!func_14() && !unk_0x45252A58A2BF9751())
					{
						func_296(Local_561[iParam0 /*13*/], "GENERIC_SHOCKED_HIGH", 34);
					}
					func_495("AS_PLAYGOLF, bullet in area of ambient golfer (no vehicle); alerted...");
					func_308();
					iLocal_671[iParam0] = 1;
				}
				else if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_561[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					if (func_265(Local_561[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
						if (!func_307())
						{
							if (!func_14() && !unk_0x45252A58A2BF9751())
							{
								func_296(Local_561[iParam0 /*13*/], "GENERIC_FRIGHTENED_HIGH", 34);
							}
							func_260(iParam0);
							func_495("AS_PLAYGOLF, player threatened ambient golfer; attacking...");
							func_308();
							iLocal_671[iParam0] = 1;
						}
						else
						{
							Local_399 = { unk_0xA8CFDE65C45F813B(Local_561[iParam0 /*13*/], 1) };
							Local_561[iParam0 /*13*/].f_10 = 1;
							func_357();
							if (!func_14() && !unk_0x45252A58A2BF9751())
							{
								func_296(Local_561[iParam0 /*13*/], "GENERIC_FUCK_YOU", 34);
								func_495("Played aggro line from ambient golfer...");
							}
							unk_0xFFD8329ED7A8E20C(Local_561[iParam0 /*13*/], 1);
							unk_0xF7CC6FE06DC847BB(Local_561[iParam0 /*13*/], unk_0x27D769C59BC9D030(), 0, 16);
							if (unk_0xD2CFFE76B625AE55(Local_788[iParam0 /*6*/]))
							{
								if (unk_0xBF99E4112970270F(Local_788[iParam0 /*6*/]))
								{
					...
					else if (func_267(Local_561[iParam0 /*13*/], 1126825984))
					{
						if (!func_307())
						{
							if (!func_14() && !unk_0x45252A58A2BF9751())
							...
							func_260(iParam0);
							func_495("AS_PLAYGOLF, player armed and ambient golfer has LOS; attacking...");
							func_308();
							iLocal_671[iParam0] = 1;
						}
					}
			...
			else if (unk_0xECC01072E61D2F3A(unk_0xD9FFE8E1642C81E2(unk_0x27D769C59BC9D030(), 0)) >= 10f)
			{
				if ((unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_561[iParam0 /*13*/], 11f, 11f, 11f, 0, 1, 0) && unk_0x3BA391CFC751A0E7(Local_561[iParam0 /*13*/], 60)) || unk_0x1A82CEBB20BF3F73(Local_561[iParam0 /*13*/]))
				{
					if (!func_14() && !unk_0x45252A58A2BF9751())
					{
						func_296(Local_561[iParam0 /*13*/], "GENERIC_CURSE_MED", 34);
					}
					func_479("This ambient golfer nearly got run over and is now attacking player: ", iParam0);
					unk_0xFFD8329ED7A8E20C(Local_561[iParam0 /*13*/], 1);
					unk_0xF7CC6FE06DC847BB(Local_561[iParam0 /*13*/], unk_0x27D769C59BC9D030(), 0, 16);
					func_357();
					iLocal_671[iParam0] = 1;
			...
			else if (unk_0xFFA15D908A6FDCD4(unk_0xA8CFDE65C45F813B(Local_561[iParam0 /*13*/], 1), 50f, 1))
			{
				func_289(Local_561[iParam0 /*13*/], 1);
				func_358(iParam0);
				if (!func_14() && !unk_0x45252A58A2BF9751())
				...
				func_495("AS_PLAYGOLF, bullet in area of ambient golfer (in vehicle); attacking...");
				func_308();
				iLocal_671[iParam0] = 1;
			}
			else if (unk_0x1A82CEBB20BF3F73(Local_561[iParam0 /*13*/]) || unk_0x77F1B7F6C32990D6(Local_561[iParam0 /*13*/], unk_0x27D769C59BC9D030(), 1))
			{
				func_495("Player damaged an ambient golfer with their vehicle (or another vehicle damaged them?)");
				if (!func_14() && !unk_0x45252A58A2BF9751())
				{
					func_296(Local_561[iParam0 /*13*/], "GENERIC_FUCK_YOU", 34);
				}
		...
		case 1:
			if (func_265(Local_561[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) && !func_307())
			{
				if (!func_14() && !unk_0x45252A58A2BF9751())
				{
					func_286(&uLocal_174, 8, Local_561[iParam0 /*13*/], "NIGEL1DAMBIENTGOLFER1", 0, 1);
					func_296(Local_561[iParam0 /*13*/], "GENERIC_CURSE_MED", 34);
				}
				func_495("AS_ALERTED, player threatened ambient golfer and was armed; attacking...");
				func_308();
				func_260(iParam0);
				iLocal_671[iParam0] = 3;
			}
		...
		case 3:
			if (!func_304(Local_561[iParam0 /*13*/], 1805844857))
			{
				func_260(iParam0);
			}
			func_309(&(Local_561[iParam0 /*13*/]), 1, 0, 1);
			break;
...
void func_357()
{
	...
	while (iVar0 <= 5)
	{
		if (func_483(Local_561[iVar0 /*13*/]))
		{
			...
			{
				if (unk_0xB1988D54B2C48CB5(Local_561[iVar0 /*13*/], Local_399, 20f, 20f, 20f, 0, 1, 0))
				{
					unk_0xFFD8329ED7A8E20C(Local_561[iVar0 /*13*/], 1);
					unk_0xF7CC6FE06DC847BB(Local_561[iVar0 /*13*/], unk_0x27D769C59BC9D030(), 0, 16);
					if (unk_0xD2CFFE76B625AE55(Local_788[iVar0 /*6*/]))
					{
						if (unk_0xBF99E4112970270F(Local_788[iVar0 /*6*/]))
						{
							unk_0xE223D49B3EFFD3E3(Local_788[iVar0 /*6*/], 1, 1);
						}
					}
					iLocal_671[iVar0] = 1;
				}
...
void func_358(int iParam0)
{
	...
	if (unk_0xD2CFFE76B625AE55(Local_561[iParam0 /*13*/]))
	{
		iVar0 = 0;
		while (iVar0 <= 5)
		{
			if (func_483(Local_561[iVar0 /*13*/]))
			{
				if (func_359(Local_561[iParam0 /*13*/], Local_561[iVar0 /*13*/], 20f))
				{
					if (iLocal_671[iVar0] != 3)
					{
						func_479("Making this Ambient Golfer flee from dead ped: ", iVar0);
						func_260(iVar0);
					}
				}
			}
...
{
	return unk_0xB7A628320EFF8E47(unk_0xA8CFDE65C45F813B(iParam0, 0), unk_0xA8CFDE65C45F813B(iParam1, 1)) <= (fParam2 * fParam2);
}
...
int func_360(int iParam0)
{
	if (unk_0xD2CFFE76B625AE55(Local_561[iParam0 /*13*/]))
	{
		if (unk_0x2006A8C1BA2AFE80(Local_561[iParam0 /*13*/], 0))
		{
			if (unk_0xD2CFFE76B625AE55(Local_788[iParam0 /*6*/]))
			{
				if (unk_0xBF99E4112970270F(Local_788[iParam0 /*6*/]))
...
void func_361(var uParam0, int iParam1)
{
	if (unk_0x875098323FCA8FE6(uParam0->f_5))
	{
		*uParam0 = unk_0xA8C993B9F5CB4D92(uParam0->f_5, uParam0->f_1, 1, 1, 0);
		if (unk_0xD2CFFE76B625AE55(*uParam0))
		{
			unk_0xFBDCF3D5834B58D8(*uParam0, uParam0->f_4);
		}
	}
	if (iParam1 == 1)
	{
...
int func_362(int iParam0)
{
	...
	while (iVar0 <= 5)
	{
		unk_0x97C59C4E8349D15F(Local_561[iVar0 /*13*/].f_8);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		unk_0x97C59C4E8349D15F(Local_788[iVar0 /*6*/].f_5);
		iVar0++;
	}
	if (iParam0 == 0)
	{
		...
		while (iVar0 <= 5)
		{
			if (!unk_0x875098323FCA8FE6(Local_561[iVar0 /*13*/].f_8))
			{
				return 0;
			}
			iVar0++;
		...
		while (iVar0 <= 5)
		{
			if (!unk_0x875098323FCA8FE6(Local_788[iVar0 /*6*/].f_5))
			{
				return 0;
			}
			iVar0++;
...
void func_363()
{
	if (iLocal_355 == 0)
	{
		if (func_483(Local_468.f_0))
		{
			if (func_265(Local_468.f_0, 1, 1116471296, 1126825984, 0, 0, 0, 0))
			{
				if (func_483(Local_468.f_0))
				{
					unk_0xD6FF698E7BC1C003(Local_468.f_0, 1);
...
void func_366()
{
	...
	{
		case 0:
			func_495("ENTERING GET THE CLUB 1 ");
			if (iLocal_361 == 0)
			{
				func_33("N1D_TAKE", 7500, 5);
				iLocal_361 = 1;
			...
			func_288(&iLocal_339);
			iLocal_339 = func_261(Local_455.f_0, 1, 0, 5);
			iLocal_171 = 1;
			break;
		...
		case 1:
			...
			if (func_483(Local_455.f_0))
			{
				if (unk_0xFA5CB09BC1B8EFDF(Local_455.f_0))
				{
					bLocal_366 = true;
				}
				if (func_5(Local_749.f_0))
			...
			if (bLocal_366 == 1)
			{
				if (func_483(Local_455.f_0))
				{
					if (unk_0xBD036012AF60D938(Local_455.f_0))
					{
						if (unk_0xBF99E4112970270F(Local_782.f_1))
						{
							unk_0xE223D49B3EFFD3E3(Local_782.f_1, 1, 1);
		...
		case 2:
			unk_0x8ACEB4FC9E9EE225();
			if (func_483(Local_455.f_0) && !bLocal_366)
			{
				func_35(4);
			}
			else
...
void func_367()
{
	switch (iLocal_690)
	{
		case 0:
			if (func_483(unk_0x27D769C59BC9D030()))
			{
				if (unk_0xB1988D54B2C48CB5(unk_0x27D769C59BC9D030(), -1377.18f, 55.39f, 53.7f, 2f, 2f, 2f, 0, 1, 1))
				{
					if (!unk_0x9A4E2270C2271219(unk_0x27D769C59BC9D030(), 1) && unk_0x98CEDC9398D49BB8(unk_0x27D769C59BC9D030(), -1379.154f, 57.95101f, 52.19011f, -1378.735f, 53.17284f, 54.94018f, 4f, 0, 1, 0))
					{
						iLocal_690 = 1;
					}
				}
		...
		case 1:
			if (!unk_0x54DA78A82349F5AC(uLocal_343))
			{
				uLocal_343 = func_369();
			}
			if (!unk_0x54DA78A82349F5AC(uLocal_341))
			{
				uLocal_341 = unk_0x197AFDD7C344686F(180543640, -1409.452f, 53.5135f, 78.0868f, -26.7543f, 0f, -85.6976f, 50f, 0, 2);
				unk_0x11313BF69BBB7F1B(uLocal_341, 4500);
				unk_0x68B47845D7A7BF1B(uLocal_341, uLocal_343, 1500, 3);
				unk_0x1E0F2731E278B09A(uLocal_341, -1382.719f, 55.216f, 58.0408f, -15.6873f, 0f, -88.6059f, 1500, 3, 2);
				unk_0x1E0F2731E278B09A(uLocal_341, -1409.452f, 53.5135f, 78.0868f, -26.7543f, 0f, -85.6976f, 1500, 3, 2);
			}
			unk_0x9F805E4A6F671CEE(unk_0x4D29100D094E5511(), false, 0);
			unk_0x83DB85FD25128C55(0);
			if (func_483(unk_0x27D769C59BC9D030()))
			{
				unk_0xE4A57337AE998385(unk_0x27D769C59BC9D030(), -1368.33f, 56.4194f, 52.4637f, 1f, 20000, 1048576000, 0, 1193033728);
			}
			iLocal_690 = 2;
			break;
		
		case 2:
			if (!unk_0xF92D82BAF297B579(uLocal_343))
			{
				if (!unk_0xF92D82BAF297B579(uLocal_341))
				{
					unk_0xA931FF68636DF31C(uLocal_343, 1);
					unk_0x04E786541E35ECB1(1, 1, 3000, 1, 0, 0);
				}
			}
			else if (!unk_0xF92D82BAF297B579(uLocal_341))
			{
				unk_0xA931FF68636DF31C(uLocal_341, 1);
				unk_0x04E786541E35ECB1(1, 1, 3000, 1, 0, 0);
				iLocal_690 = 3;
			}
			break;
		...
		case 3:
			if (unk_0xB1988D54B2C48CB5(unk_0x27D769C59BC9D030(), -1368.33f, 56.4194f, 52.4637f, 2f, 2f, 2f, 0, 1, 1))
			{
				unk_0x4EDE34FBADD967A6(2000);
				func_67(unk_0x27D769C59BC9D030(), 12, 4, 0, -1, 0, 0, 0, -1, -1, -1, 0);
				func_368(2);
				iLocal_370 = 1;
				if (func_483(unk_0x27D769C59BC9D030()))
				{
					unk_0xE4A57337AE998385(unk_0x27D769C59BC9D030(), -1373.09f, 55.61f, 52.71f, 1f, 20000, 1048576000, 0, 1193033728);
				}
		...
		case 4:
			if (!unk_0x54DA78A82349F5AC(uLocal_342))
			{
				uLocal_342 = unk_0x197AFDD7C344686F(180543640, -1373.681f, 57.0584f, 54.9717f, -10.6657f, 0f, 91.5916f, 50f, 0, 2);
				unk_0x11313BF69BBB7F1B(uLocal_342, 4500);
				unk_0x68B47845D7A7BF1B(uLocal_342, uLocal_341, 1500, 3);
				unk_0x1E0F2731E278B09A(uLocal_342, -1382.719f, 55.216f, 58.0408f, -15.6873f, 0f, -88.6059f, 1500, 3, 2);
				unk_0x1E0F2731E278B09A(uLocal_342, -1373.681f, 57.0584f, 54.9717f, -10.6657f, 0f, 91.5916f, 1500, 3, 2);
			}
			if (!unk_0xF92D82BAF297B579(uLocal_342))
			{
				unk_0x04E786541E35ECB1(1, 1, 3000, 1, 0, 0);
				unk_0xA931FF68636DF31C(uLocal_342, 1);
				unk_0x4EDE34FBADD967A6(3500);
				iLocal_690 = 5;
			}
			if (unk_0xF92D82BAF297B579(uLocal_343))
			{
				unk_0xA931FF68636DF31C(uLocal_343, 0);
			}
			if (unk_0xF92D82BAF297B579(uLocal_341))
			{
				unk_0xA931FF68636DF31C(uLocal_341, 0);
			}
			break;
		...
		case 5:
			if (unk_0x54DA78A82349F5AC(uLocal_342))
			{
				if (unk_0xF92D82BAF297B579(uLocal_342))
				{
					...
					unk_0xA931FF68636DF31C(uLocal_342, 0);
					unk_0x4EDE34FBADD967A6(2000);
					unk_0x9F805E4A6F671CEE(unk_0x4D29100D094E5511(), true, 0);
					unk_0x83DB85FD25128C55(1);
					unk_0x1D1A369233055AEC(uLocal_343, 0);
					unk_0x1D1A369233055AEC(uLocal_341, 0);
					unk_0x1D1A369233055AEC(uLocal_342, 0);
				}
			}
			func_288(&uLocal_340);
			break;
...
var func_369()
{
	return unk_0x4B49D13510261EFF("DEFAULT_SCRIPTED_CAMERA", unk_0xDD23360B0FA2E0E2(), unk_0x1FD56C4830604096(2), unk_0x76DA9CDEC35E18D8(), 0, 2);
}
...
void func_370()
{
	...
	if (iLocal_360 == 0)
	{
		if (func_9(0))
		{
			func_495("Concierge scene loaded, creating now...");
			iVar0 = 0;
			while (iVar0 <= 3)
			{
				func_299(&(Local_402[iVar0 /*13*/]), 0);
				unk_0xA8ED9F72DC442242(Local_402[iVar0 /*13*/], 1);
				iVar0++;
			}
			func_298(&(Local_694[0 /*6*/]), 0);
			unk_0xBD875C7680C64C56(Local_402[1 /*13*/], Local_694[0 /*6*/], -1);
			unk_0x7D77C969FB817825(Local_402[1 /*13*/], 0);
			iLocal_360 = 1;
			iVar0 = 0;
			while (iVar0 <= 3)
			{
				unk_0x0049DE0B34213B12(Local_402[iVar0 /*13*/].f_8);
				iVar0++;
			}
			iVar0 = 0;
			while (iVar0 <= 8)
			{
				unk_0x0049DE0B34213B12(Local_694[iVar0 /*6*/].f_5);
				iVar0++;
			}
		}
	}
...
void func_371()
{
	...
	while (iVar0 <= 3)
	{
		if (func_483(Local_402[iVar0 /*13*/]))
		{
			func_372(iVar0);
		}
		iVar0++;
...
void func_372(int iParam0)
{
	...
	{
		case 0:
			if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), Local_402[iParam0 /*13*/], 6f, 6f, 6f, 0, 1, 1))
			{
				if (unk_0x810AFFABCBF31E2D(Local_402[iParam0 /*13*/], 150319005) != 1)
				{
					unk_0x85FD30B510E7C05E(Local_402[iParam0 /*13*/], unk_0x27D769C59BC9D030(), 500, 12, 2);
				}
			}
			if (func_265(Local_402[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0))
			{
				if (!unk_0x45252A58A2BF9751() || unk_0xC06A80AF9911D7A8(203) == 0)
				{
					if (!func_14())
					{
						if (iParam0 == 0)
						{
							func_286(&uLocal_174, 7, Local_402[iParam0 /*13*/], "CONCIERGE", 0, 1);
							func_286(&uLocal_174, 2, unk_0x27D769C59BC9D030(), "TREVOR", 0, 1);
							func_262(&uLocal_174, "NIG1DAU", "NIG1D_FLEE", "NIG1D_FLEE_9", 7, 0, 0);
						}
					}
				}
				func_364();
			...
			else if (unk_0xFFA15D908A6FDCD4(unk_0xA8CFDE65C45F813B(Local_402[iParam0 /*13*/], 1), 30f, 1))
			{
				if (!unk_0x45252A58A2BF9751() || unk_0xC06A80AF9911D7A8(203) == 0)
				{
					if (!func_14())
					{
						if (iParam0 == 0)
						{
							func_286(&uLocal_174, 7, Local_402[iParam0 /*13*/], "CONCIERGE", 0, 1);
							func_286(&uLocal_174, 2, unk_0x27D769C59BC9D030(), "TREVOR", 0, 1);
							func_262(&uLocal_174, "NIG1DAU", "NIG1D_FLEE", "NIG1D_FLEE_7", 7, 0, 0);
						}
					}
				}
				func_364();
...
void func_374()
{
	if (func_483(unk_0x27D769C59BC9D030()))
	{
		if (!func_318(unk_0x27D769C59BC9D030()))
		{
			if (!func_375(unk_0x27D769C59BC9D030()))
			{
				func_34(1);
			}
			else
			{
				unk_0xCB3AA991DE0DE3A6(iLocal_339, 1);
			}
		}
		else if (!unk_0x7B4654D62B7E0E9E(iLocal_339))
		{
			func_495("Recreated mission blip");
			iLocal_339 = func_261(Local_455.f_0, 1, 0, 5);
		}
		else
		{
			unk_0xCB3AA991DE0DE3A6(iLocal_339, 0);
		}
	}
}
...
{
	if (func_254(&uLocal_883, unk_0xA8CFDE65C45F813B(iParam0, 0)))
	{
		return 1;
	}
	return 0;
...
void func_376()
{
	...
	{
		case 0:
			unk_0xA0342EB4AE1476FC(2f, 8f, 1);
			func_495("ENTERING GO TO CELEBRITY ");
			if (iLocal_361 == 0)
			{
				func_33("N1D_TAKE", 7500, 5);
				iLocal_361 = 1;
		...
		case 1:
			...
			func_247();
			func_367();
			if (func_483(Local_455.f_0) && func_483(unk_0x27D769C59BC9D030()))
			{
				if (func_285(unk_0x27D769C59BC9D030(), Local_455.f_0, 50f, 1) || iLocal_170 == 3)
				{
					iLocal_171 = 2;
				}
				else if (func_32())
				...
				{
					if (func_285(unk_0x27D769C59BC9D030(), Local_455.f_0, 150f, 1))
					{
						iLocal_171 = 2;
					}
				}
		...
		case 2:
			...
			if (unk_0x9A4E2270C2271219(unk_0x27D769C59BC9D030(), 0))
			{
				func_377(1, "MS_GET_THE_CLUB", 1, 0, 0, 1);
			}
			else
			{
				func_377(1, "MS_GET_THE_CLUB", 1, 0, 0, 0);
			}
			if (func_483(Local_455.f_0))
			{
				func_35(3);
...
void func_377(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_435(unk_0x3AA961419D971CB2(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_231(unk_0x3AA961419D971CB2(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_432(&(Global_91278.f_3));
				if (iVar10 > -1)
				{
...
{
	func_379(&Global_95496, unk_0x3AA961419D971CB2(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_379(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_243();
	...
	if (!unk_0xE4F7206742848BAF(unk_0x27D769C59BC9D030()))
	{
		func_408(&(uParam0->f_2305), 0);
		func_407(unk_0x27D769C59BC9D030());
		func_401(unk_0x27D769C59BC9D030(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_400())
		{
			func_396(unk_0x27D769C59BC9D030(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
	...
	if (iParam4 == 1)
	{
		func_381(&(uParam0->f_2311), uParam0, iParam5, 1, 1, 0);
	}
	func_380(&(uParam0->f_2401));
	uParam3 = uParam3;
	uParam2 = uParam2;
}
...
void func_381(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (func_393(iParam2, &iVar0, iParam3, iParam5))
	{
	...
	while (iVar0 < 9)
	{
		if (unk_0xD2CFFE76B625AE55(Global_88942[iVar0]))
		{
			if (Global_88942[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0x946C63BD9EF05437(iParam0) == func_388(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0x0B4DDB992C7BCF57(iParam0, 0))
	{
		...
		*uParam1 = unk_0xC960169422AD5363(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x26545538B51562AD(&(uParam1->f_77), func_391(iVar0 + 1));
			}
			iVar0++;
		}
			...
			if (unk_0xD2CFFE76B625AE55(*uParam1))
			{
				if (unk_0x0B4DDB992C7BCF57(*uParam1, 0))
				{
					if (iParam2 == 0 || unk_0x676D4CD42E0837CA(unk_0xA8CFDE65C45F813B(*uParam1, 1), unk_0xA8CFDE65C45F813B(iParam0, 1), 1) < 100f)
					{
						...
						if (func_394(*uParam1, func_243(), 1))
						{
...
void func_401(int iParam0, bool bParam1)
{
	...
	iVar0 = func_180(iParam0);
	if (func_184(iVar0) && !unk_0xE4F7206742848BAF(iParam0))
	{
		if (iParam0 == unk_0x27D769C59BC9D030())
		{
			func_402(iParam0, &(Global_101154.f_1826.f_539.f_298[iVar0 /*284*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_402(int iParam0, var uParam1)
{
	...
	if (!unk_0xE4F7206742848BAF(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x4411BBC9BC706B88(iParam0, func_406(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((unk_0x91156000A6A01C12(iVar7, &Var9) && !func_403(Var9.f_1)) && iVar70 < 50)
			{
...
bool func_410(int iParam0, var uParam1, var uParam2)
{
	...
	*uParam2 = 0f;
	...
	return !func_341(*uParam1, 0f, 0f, 0f, 0);
}
...
int func_411(var uParam0)
{
	if (!unk_0x2006A8C1BA2AFE80(unk_0x27D769C59BC9D030(), 0) && !unk_0xE4F7206742848BAF(unk_0x27D769C59BC9D030()))
	{
		if (func_420())
		{
			*uParam0 = func_416(unk_0xA8CFDE65C45F813B(unk_0x27D769C59BC9D030(), 0), 5, -1, 0, 1, -1);
...
int func_413(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x0E063DDE8855EC52())
	{
		if (func_42() == 0)
		{
			return unk_0xF426A5DE932B3BEE(func_101(func_414(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_416(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_419(iVar0))
		{
			if (!bParam5 || func_418(iVar0))
			{
				fVar1 = unk_0x676D4CD42E0837CA(Param0, func_417(iVar0, 0), 1);
...
var func_421()
{
	...
	func_431(&uVar0, unk_0x2FADF5E93AB8D64B());
	func_430(&uVar0, unk_0x51C7DC141C5D0E6B());
	func_429(&uVar0, unk_0xEFEADD7EBD01C0A6());
	func_424(&uVar0, unk_0x388418AD39C0F4DE());
	func_423(&uVar0, unk_0xE3911478C9FE04B2());
	func_422(&uVar0, unk_0x8FB5B60BC869990E());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_427(unk_0xF426A5DE932B3BEE(iParam0, 31), -1, 1)) + 2011;
}
...
int func_433(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_434(Global_101154.f_7775.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_434(Global_101154.f_7775.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_434(Global_101154.f_7775.f_99.f_205[11]);
			break;
		
		case 90:
			return func_434(Global_101154.f_7775.f_99.f_205[7]);
			break;
		
		case 93:
			return func_434(Global_101154.f_7775.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_438()
{
	...
	{
		case 0:
			func_495("ENTERING GO TO GOLF CLUB ");
			if (iLocal_361 == 0)
			{
				func_33("N1D_TAKE", 7500, 5);
				iLocal_361 = 1;
			...
			{
				func_495("Glen was not alive when trying to create the blip in GO_TO_THE_GOLF_CLUB() init");
				func_442();
				iLocal_339 = func_261(Local_455.f_0, 1, 0, 5);
			}
			func_439(0);
			func_495("ENTERING GO TO GOLF CLUB LOOP ");
			if (func_482(0) && iLocal_173)
			{
				func_17(1, 1, 1);
			}
			unk_0x66EEFE13E1BFC898(0);
		...
		case 1:
			if (iLocal_354 == 0)
			{
				func_495("Glen created in GO_TO_THE_GOLF_CLUB() SS_UPDATE");
				func_442();
			}
			else
			{
...
void func_439(int iParam0)
{
	...
	{
		if (!unk_0x7B4654D62B7E0E9E(uLocal_340))
		{
			iLocal_340 = func_440(-1377.18f, 55.39f, 53.7f, 0);
			unk_0x216986E3E3E543F2(iLocal_340, 109);
		}
		iLocal_690 = 0;
	}
}

int func_440(struct<3> Param0, int iParam3)
{
	int iVar0;
	
	iVar0 = unk_0x43B8950858CAD66F(Param0);
	unk_0xC5B4E9487339A2BB(iVar0, func_441(unk_0x0E063DDE8855EC52(), 1f, 1f));
	unk_0xAB27F3DE6390C749(iVar0, iParam3);
	return iVar0;
}

float func_441(bool bParam0, float fParam1, float fParam2)
{
	if (bParam0)
	{
		return fParam1;
...
void func_442()
{
	while (iLocal_354 == 0)
	{
		if (func_443(0))
		{
			func_299(&Local_455, 0);
			unk_0x2F228A16D7B61C5F(Local_455.f_0, 0, 0, 0, false);
			unk_0xA8ED9F72DC442242(Local_455.f_0, 1);
			unk_0xFFD8329ED7A8E20C(Local_455.f_0, 0);
			unk_0x2CBC4FD55924CEE9(Local_455.f_0, 1);
			unk_0xD6FF698E7BC1C003(Local_455.f_0, 1);
			func_453(Local_455.f_0, 0);
			func_299(&Local_468, 0);
			func_361(&Local_825, 0);
			unk_0x356675505D724E40(Local_825.f_0, Local_468.f_0, unk_0x5C9720EC37666AF2(Local_468.f_0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			unk_0x878D12AEFBF5BAF0(Local_468.f_0, "rcmnigel1d", "idle_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
			unk_0xA8ED9F72DC442242(Local_468.f_0, 1);
			unk_0xFFD8329ED7A8E20C(Local_468.f_0, 0);
			if (func_483(Local_455.f_0))
			{
				Local_782.f_3 = { unk_0x05BE3B45A415255D(unk_0xA8CFDE65C45F813B(Local_455.f_0, 1), 1067030938, 1069547520) };
			}
			iLocal_777 = unk_0xA8C993B9F5CB4D92(joaat("prop_golf_bag_01"), Local_782.f_3, 1, 1, 0);
			func_298(&Local_749, 0);
			if (unk_0x159730DB57D995D0("NIGEL_1D_SCENE"))
			{
				if (func_5(Local_749.f_0))
				{
					unk_0x75C3321388DDC4F1(Local_749.f_0, "NIGEL_1D_GOLF_CART_A", 0);
				}
			}
			unk_0x8BE1AEC303A057F7(Local_749.f_0, 1, 1, 0);
			unk_0x51F79AC13D2AD286(Local_749.f_0, 1200);
			unk_0x356675505D724E40(iLocal_777, Local_749.f_0, 0, 0.2f, -1.3f, 0.5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			unk_0x7C898812896A5304(Local_749.f_5, 1);
			Local_782.f_1 = unk_0xA8C993B9F5CB4D92(joaat("prop_golf_wood_01"), Local_782.f_3, 1, 1, 0);
			unk_0x356675505D724E40(Local_782.f_1, Local_455.f_0, unk_0x5C9720EC37666AF2(Local_455.f_0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			unk_0x0049DE0B34213B12(Local_455.f_8);
			unk_0x33A0CEA494F4C2A3(&uLocal_776);
			unk_0xD9F9CB5C8842E29C(0, 112f, 0);
			unk_0x878D12AEFBF5BAF0(0, "rcmnigel1d", "swing_a_mark", 8f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0x878D12AEFBF5BAF0(0, "rcmnigel1d", "swing_b_mark", 8f, -2f, -1, 0, 0, 0, 0, 0);
			...
			unk_0x8B8674266D533E9F(Local_455.f_0, uLocal_776);
			unk_0x433C209504FBC7EE(&uLocal_776);
			func_298(&(Local_694[4 /*6*/]), 0);
			func_298(&(Local_694[5 /*6*/]), 0);
			func_495("Celeb created!");
			iLocal_354 = 1;
		}
		else
		{
			func_495("Waiting for celeb assets...");
		}
		unk_0x4EDE34FBADD967A6(0);
	}
}
...
int func_443(int iParam0)
{
	...
	unk_0x97C59C4E8349D15F(iLocal_781);
	unk_0x97C59C4E8349D15F(joaat("a_m_y_golfer_01"));
	unk_0x97C59C4E8349D15F(Local_749.f_5);
	unk_0x97C59C4E8349D15F(Local_825.f_5);
	if (iParam0 == 0)
	{
		if (!unk_0x875098323FCA8FE6(iLocal_781))
		{
			return 0;
		}
		if (!unk_0x875098323FCA8FE6(joaat("a_m_y_golfer_01")))
		{
			return 0;
		}
		if (!unk_0x875098323FCA8FE6(Local_749.f_5))
		{
			return 0;
		}
		if (!unk_0x875098323FCA8FE6(Local_825.f_5))
		{
			return 0;
		}
	}
...
void func_444()
{
	...
	{
		case 0:
			func_495("ENTERING PHONE CALL 3 ");
			func_286(&uLocal_174, 2, unk_0x27D769C59BC9D030(), "TREVOR", 0, 1);
			func_286(&uLocal_174, 3, 0, "NIGEL", 0, 1);
			func_286(&uLocal_174, 4, 0, "MRSTHORNHILL", 0, 1);
			if (iLocal_173 == 1)
		...
		case 1:
			if (!iLocal_359)
			{
				if (func_237(&uLocal_174, 64, "NIG1DAU", "NIG1D_INTRO", 9, 1, 0, 0, 0))
				{
					unk_0xA0342EB4AE1476FC(2f, 8f, 1);
...
void func_447()
{
	...
	func_3(&Local_749);
	func_449(&(Local_782.f_1));
	func_449(&iLocal_777);
	func_449(&Local_825);
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		func_449(&(Local_788[iVar0 /*6*/]));
		iVar0++;
	}
	if (unk_0xB436470ACC226C30(Local_782.f_0))
	{
		unk_0x7EAE1191BBEA53F7(Local_782.f_0);
	}
	func_288(&iLocal_339);
	iVar0 = 0;
	while (iVar0 <= 2)
	...
	unk_0x1FCC08AE8E31FD6C(iLocal_774);
	func_448(2, uLocal_365);
}
	...
	if (Global_69743 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x3934E959DB2478D3())
			{
				...
				Var4 = { func_456(Global_69744, Global_69746, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_467(0) || Global_69758) || Global_69747 == 1) || !unk_0xCBB243DDC0D132D1())
	{
		return 0;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((unk_0x67FB99B1361E144E() || func_337(0)) || func_466(1))
			{
			}
			else
			{
...
{
	return func_469(iParam0, Global_35711);
}
...
void func_470(int iParam0, int iParam1)
{
	...
	if (iLocal_172 == 3)
	{
		func_495("We are trying to skip to Get The Club...");
	}
	else if (iLocal_172 == 1)
	{
		func_495("We are trying to skip to Go to Golf Club...");
	}
	iLocal_173 = 0;
	func_1(iLocal_172);
}
...
void func_471()
{
	...
	iLocal_691 = 0;
	func_472();
	if (unk_0xCE92500E70EEA516("NIGEL1DTRANS"))
	{
		unk_0x47419E1CD54CFC70("NIGEL1DTRANS");
	}
	if (unk_0xCE92500E70EEA516("NIGEL1DGOLF"))
	{
		unk_0x47419E1CD54CFC70("NIGEL1DGOLF");
	}
	if (unk_0xCE92500E70EEA516("NIGEL1DGOLF2"))
	{
		unk_0x47419E1CD54CFC70("NIGEL1DGOLF2");
	}
	if (unk_0xCE92500E70EEA516("NIGEL1DCRASH"))
	{
		unk_0x47419E1CD54CFC70("NIGEL1DCRASH");
	}
	iLocal_354 = 0;
	iLocal_345 = 0;
	func_484();
	if (func_483(unk_0x27D769C59BC9D030()))
	{
		unk_0x4EEE9D9427E70F4E(unk_0x27D769C59BC9D030(), -1330.118f, -72.3159f, 48.1812f, 1, 0, 0, 1);
		unk_0xFBDCF3D5834B58D8(unk_0x27D769C59BC9D030(), 326f);
	}
	func_35(1);
}
...
void func_472()
{
	...
	while (iVar0 <= 2)
	{
		unk_0x0049DE0B34213B12(Local_521[iVar0 /*13*/].f_8);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		unk_0x0049DE0B34213B12(Local_481[iVar0 /*13*/].f_8);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		unk_0x0049DE0B34213B12(Local_561[iVar0 /*13*/].f_8);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		unk_0x0049DE0B34213B12(Local_640[iVar0 /*13*/].f_8);
		iVar0++;
	}
	unk_0x0049DE0B34213B12(iLocal_781);
	iVar0 = 0;
	while (iVar0 <= 8)
	{
		unk_0x0049DE0B34213B12(Local_694[iVar0 /*6*/].f_5);
	...
	while (iVar0 <= 1)
	{
		unk_0x0049DE0B34213B12(Local_755[iVar0 /*6*/].f_5);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		unk_0x0049DE0B34213B12(Local_788[iVar0 /*6*/].f_5);
		iVar0++;
	}
}
...
void func_473(bool bParam0, bool bParam1)
{
	...
	func_474(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, bParam1, 1, 1, 1);
}

void func_474(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	var uVar0;
	...
	if (unk_0x2DB75A8F096AB1F1(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x90CDF5C9FC20A5BF(func_475(unk_0xB927AFB90873B8C1()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_481(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
void func_484()
{
	...
	iLocal_379 = 0;
	iLocal_380 = 0;
	uLocal_389 = unk_0x9EE81D7901D9BCE2();
	if (!unk_0x159730DB57D995D0("NIGEL_1D_SCENE"))
	{
		unk_0xF8B012FD1C255840("NIGEL_1D_SCENE");
	}
	if (unk_0x159730DB57D995D0("NIGEL_1D_SCENE"))
	{
		if (func_5(Local_749.f_0))
	...
	iLocal_348 = 0;
	iLocal_357 = 0;
	uLocal_365 = func_493(2);
	unk_0x5974EAB5457E93B2("SecurityGroup", &iLocal_774);
	unk_0xED5347CD6B7B01FA(1, iLocal_774, joaat("COP"));
	unk_0xED5347CD6B7B01FA(1, joaat("COP"), iLocal_774);
	unk_0x73FC038FEC1E71CF("NIGEL1DTRANS");
	unk_0x73FC038FEC1E71CF("NIGEL1DGOLF");
	unk_0x73FC038FEC1E71CF("NIGEL1DGOLF2");
	unk_0x73FC038FEC1E71CF("NIGEL1DCRASH");
	unk_0x88172B3983EC5071("rcmnigel1d");
	unk_0x88172B3983EC5071("mini@golf");
	unk_0x8378AB3CED5FF44A("NIGEL1D", 0);
	unk_0x97C59C4E8349D15F(joaat("caddy"));
	while (((((((!unk_0x911CCA58116D31F0(0) || !unk_0x482101C9B3483958("rcmnigel1d")) || !unk_0x482101C9B3483958("mini@golf")) || !unk_0xCE92500E70EEA516("NIGEL1DTRANS")) || !unk_0xCE92500E70EEA516("NIGEL1DGOLF")) || !unk_0xCE92500E70EEA516("NIGEL1DGOLF2")) || !unk_0xCE92500E70EEA516("NIGEL1DCRASH")) || !unk_0x875098323FCA8FE6(joaat("caddy")))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	unk_0x0062D9D41655E62A(0.75f);
	unk_0x9F805E4A6F671CEE(unk_0x4D29100D094E5511(), true, 256);
	uLocal_778 = unk_0x84496C593C3C7F04(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
	unk_0xE03080E2E83BF49E(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f);
	uLocal_779 = unk_0x84496C593C3C7F04(-1379.33f, 45.13f, 50.68f, -1368.01f, 69.83f, 55.9f, 0, 1, 1, 1);
	if (iLocal_780 == -1)
	{
		iLocal_780 = unk_0x1CFFA4F4C25D434F(-1375.08f, 55.55f, 52.93f, 4f, 6f, 4f, 355f, 0, 7);
	}
	func_491(64, 2, 0);
	if (func_337(0))
	{
	...
	func_488(&uLocal_831);
	func_487(&uLocal_831, -1313.714f, -27.2202f, 48.0314f);
	func_487(&uLocal_831, -1294.066f, -27.0136f, 47.5724f);
	func_487(&uLocal_831, -1069.844f, -143.769f, 39.7493f);
	func_487(&uLocal_831, -925.2529f, -89.9079f, 38.3457f);
	func_487(&uLocal_831, -1010.948f, 40.0643f, 49.9277f);
	func_487(&uLocal_831, -1122.838f, 233.7037f, 64.7587f);
	func_487(&uLocal_831, -1282.578f, 188.8798f, 59.2769f);
	func_487(&uLocal_831, -1328.153f, 192.0178f, 57.8136f);
	func_487(&uLocal_831, -1386.75f, 167.32f, 57.11f);
	func_487(&uLocal_831, -1411.5f, 109.64f, 51.49f);
	func_487(&uLocal_831, -1399.63f, -10.83f, 51.93f);
	func_487(&uLocal_831, -1359.54f, 18.93f, 52.52f);
	func_487(&uLocal_831, -1342.27f, 16.92f, 52.16f);
	func_486(&uLocal_831);
	func_485(&uLocal_883, &uLocal_831, 100f);
	func_488(&uLocal_935);
	func_487(&uLocal_935, -1100.2f, 77.1233f, 53.2703f);
	func_487(&uLocal_935, -1040.69f, 97.3963f, 51.9067f);
	func_487(&uLocal_935, -977.9333f, -5.5166f, 45.6548f);
	func_487(&uLocal_935, -1039.687f, -35.872f, 45.4867f);
	func_487(&uLocal_935, -1062.19f, -2.8635f, 49.6013f);
	func_486(&uLocal_935);
	iLocal_173 = 1;
}
...
int func_497(var uParam0, var uParam1)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_488(uParam1);
			func_487(uParam1, -1313.714f, -27.2202f, 48.0314f);
			func_487(uParam1, -1294.066f, -27.0136f, 47.5724f);
			func_487(uParam1, -1069.844f, -143.769f, 39.7493f);
			func_487(uParam1, -925.2529f, -89.9079f, 38.3457f);
			func_487(uParam1, -1010.948f, 40.0643f, 49.9277f);
			func_487(uParam1, -1122.838f, 233.7037f, 64.7587f);
			func_487(uParam1, -1282.578f, 188.8798f, 59.2769f);
			func_487(uParam1, -1328.153f, 192.0178f, 57.8136f);
			func_487(uParam1, -1386.75f, 167.32f, 57.11f);
			func_487(uParam1, -1411.5f, 109.64f, 51.49f);
			func_487(uParam1, -1379.52f, 111.05f, 54.28f);
			func_487(uParam1, -1371.77f, 24.07f, 52.88f);
			func_487(uParam1, -1342.27f, 16.92f, 52.16f);
			func_486(uParam1);
			iVar9 = 0;
			while (iVar9 <= (iVar0 - 1))
			{
			...
			unk_0x88172B3983EC5071(uParam0->f_48);
			unk_0x88172B3983EC5071(sVar8);
			iLocal_91 = 1;
			break;
		
		case 1:
			if ((!func_502(&iVar0) || !unk_0x482101C9B3483958(uParam0->f_48)) || !unk_0x482101C9B3483958(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			func_498(41, 1);
			uParam0->f_28[0] = unk_0x91D233CD0204A37F(26, iVar0[3], -1096.855f, 67.6858f, 52.952f, 112f, 1, 1);
			unk_0x2F228A16D7B61C5F(uParam0->f_28[0], 0, 0, 0, false);
			unk_0xA8ED9F72DC442242(uParam0->f_28[0], 1);
			unk_0x2CBC4FD55924CEE9(uParam0->f_28[0], 1);
			unk_0xD6FF698E7BC1C003(uParam0->f_28[0], 1);
			unk_0xFFD8329ED7A8E20C(uParam0->f_28[0], 1);
			uParam0->f_41[0] = unk_0xA8C993B9F5CB4D92(iVar0[1], -1096.855f, 67.6858f, 52.952f, 1, 1, 0);
			...
			unk_0x878D12AEFBF5BAF0(0, uParam0->f_48, "swing_a_mark", 8f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0x878D12AEFBF5BAF0(0, uParam0->f_48, "swing_b_mark", 8f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0x575C8AF5AF9A9FED(uVar10, 1);
			unk_0x33F83FC0F5F458E3(uVar10);
			unk_0x8B8674266D533E9F(uParam0->f_28[0], uVar10);
			unk_0x433C209504FBC7EE(&uVar10);
			uParam0->f_28[1] = unk_0x91D233CD0204A37F(26, iVar0[4], -1096.258f, 69.723f, 53.0107f, 163f, 1, 1);
			unk_0x878D12AEFBF5BAF0(uParam0->f_28[1], uParam0->f_48, "idle_a_friend_watching", 8f, -8f, -1, 1, 0, 0, 0, 0);
			unk_0xA8ED9F72DC442242(uParam0->f_28[1], 1);
			uParam0->f_41[1] = unk_0xA8C993B9F5CB4D92(iVar0[2], -1096.258f, 69.723f, 53.0107f, 1, 1, 0);
			unk_0x356675505D724E40(uParam0->f_41[1], uParam0->f_28[1], unk_0x5C9720EC37666AF2(uParam0->f_28[1], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			uParam0->f_28[2] = unk_0x91D233CD0204A37F(26, iVar0[0], -1105.622f, 66.4609f, 53.07f, 118f, 1, 1);
			uParam0->f_28[3] = unk_0x91D233CD0204A37F(26, iVar0[0], -1090.09f, 64.3905f, 52.5607f, 238f, 1, 1);
			uParam0->f_28[4] = unk_0x91D233CD0204A37F(26, iVar0[0], -1093.736f, 73.8568f, 53.0388f, 319f, 1, 1);
			iVar9 = 2;
			while (iVar9 <= 4)
			{
				unk_0xA8ED9F72DC442242(uParam0->f_28[iVar9], 1);
				unk_0xAC9A80BE63D6295F(uParam0->f_28[iVar9], joaat("weapon_pistol"), -1, 0, 1);
				unk_0x2CBC4FD55924CEE9(uParam0->f_28[iVar9], 1);
				unk_0xFFD8329ED7A8E20C(uParam0->f_28[iVar9], 1);
				unk_0xA82663A60582A7D7(uParam0->f_28[iVar9], 1);
				unk_0x246DB3A0E0918F4E(uParam0->f_28[iVar9], 1);
				unk_0xF9867932DC1A555E(iVar0[0], 1);
				iVar9++;
			}
			uParam0->f_35[0] = unk_0x4E76306EE6AE7596(iVar0[5], -1099.91f, 61.2608f, 52.8124f, 243f, 1, 1);
			unk_0xFA3ED0FFF3FD8F34(uParam0->f_35[0]);
			unk_0x8BE1AEC303A057F7(uParam0->f_35[0], 1, 1, 0);
			unk_0x51F79AC13D2AD286(uParam0->f_35[0], 1200);
			unk_0x7C898812896A5304(iVar0[5], 1);
			uParam0->f_41[2] = unk_0xA8C993B9F5CB4D92(iVar0[6], -1099.91f, 63.2608f, 52.8124f, 1, 1, 0);
			unk_0x356675505D724E40(uParam0->f_41[2], uParam0->f_35[0], 0, 0.2f, -1.3f, 0.5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			uParam0->f_35[1] = unk_0x4E76306EE6AE7596(iVar0[5], -1102.335f, 75.7757f, 53.2591f, 293f, 1, 1);
			uParam0->f_35[2] = unk_0x4E76306EE6AE7596(iVar0[5], -1103.023f, 65.6267f, 53.056f, 203f, 1, 1);
			iVar9 = 1;
			while (iVar9 <= 2)
			{
				unk_0xFA3ED0FFF3FD8F34(uParam0->f_35[iVar9]);
				iVar9++;
			}
			iVar9 = 0;
			while (iVar9 <= (iVar0 - 1))
...
void func_498(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 37:
			...
			{
				uLocal_107 = func_501();
				unk_0x46FA2CC6615D6359("WORLD_HUMAN_GUARD_STAND", 0);
				unk_0x46FA2CC6615D6359("WORLD_HUMAN_CLIPBOARD", 0);
				unk_0x46FA2CC6615D6359("WORLD_VEHICLE_DRIVE_SOLO", 0);
				func_500();
				unk_0x90CDF5C9FC20A5BF(-1100.5f, 789.8f, 164.34f, 20f, 0);
				func_499(0);
			}
			else
			{
		...
		case 38:
			if (bParam1)
			{
				uLocal_107 = unk_0x84496C593C3C7F04(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
				unk_0x46FA2CC6615D6359("WORLD_HUMAN_GUARD_STAND", 0);
				unk_0x46FA2CC6615D6359("WORLD_HUMAN_CLIPBOARD", 0);
				unk_0x46FA2CC6615D6359("WORLD_VEHICLE_DRIVE_SOLO", 0);
				unk_0xE03080E2E83BF49E(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f);
				unk_0xF9867932DC1A555E(joaat("s_m_y_doorman_01"), 1);
				unk_0xF9867932DC1A555E(joaat("s_m_m_bouncer_01"), 1);
				unk_0x90CDF5C9FC20A5BF(-558.2858f, 284.4073f, 81.1764f, 15f, 0);
				unk_0x90CDF5C9FC20A5BF(-573.394f, 289.3696f, 79.06918f, 15f, 0);
				unk_0xEFA71310CAEBAE1F(-554.17f, 307.68f, 82.84f, 2f, 1, 0, 0, 0);
				unk_0x5B40EC93D0367189(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1);
				unk_0x2FA9C6D79054F1BE(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0);
				unk_0x7C898812896A5304(joaat("gauntlet"), 1);
			}
			else
			{
				unk_0x3CE75187603652E2(uLocal_107, 0);
				unk_0x46FA2CC6615D6359("WORLD_HUMAN_GUARD_STAND", 1);
				unk_0x46FA2CC6615D6359("WORLD_HUMAN_CLIPBOARD", 1);
				unk_0x46FA2CC6615D6359("WORLD_VEHICLE_DRIVE_SOLO", 1);
				unk_0xF557B4BDE99A5E64();
				unk_0xF9867932DC1A555E(joaat("s_m_y_doorman_01"), 0);
				unk_0xF9867932DC1A555E(joaat("s_m_m_bouncer_01"), 0);
				unk_0x5B40EC93D0367189(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 1, 1);
				unk_0x7C898812896A5304(joaat("gauntlet"), 0);
			}
			break;
		...
		case 39:
			if (bParam1)
			{
				uLocal_107 = unk_0x84496C593C3C7F04(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
				unk_0xE03080E2E83BF49E(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f);
				unk_0x5B40EC93D0367189(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1);
				unk_0x2FA9C6D79054F1BE(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0);
				unk_0xEFA71310CAEBAE1F(-1035.73f, 365.44f, 68.91f, 35f, 1, 0, 0, 0);
				unk_0xC972AA2C9F94741D(-1035.73f, 365.44f, 68.91f, 27f, 0, 0, 0, 0, 0);
				unk_0x90CDF5C9FC20A5BF(-1035.73f, 365.44f, 68.91f, 27f, 0);
			}
			else
			{
				unk_0x3CE75187603652E2(uLocal_107, 0);
				unk_0xF557B4BDE99A5E64();
				unk_0x5B40EC93D0367189(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 1, 1);
			}
			break;
		...
		case 41:
			if (bParam1)
			{
				uLocal_107 = unk_0x84496C593C3C7F04(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
				unk_0xE03080E2E83BF49E(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f);
				unk_0xEFA71310CAEBAE1F(-1096.855f, 67.6858f, 52.952f, 15f, 1, 0, 0, 0);
			}
			else
			{
				unk_0x3CE75187603652E2(uLocal_107, 0);
		...
		case 42:
			if (bParam1)
			{
				uLocal_107 = unk_0x84496C593C3C7F04(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
				unk_0xE03080E2E83BF49E(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f);
			}
			else
			{
				unk_0x3CE75187603652E2(uLocal_107, 0);
...
void func_499(bool bParam0)
{
	...
	Var6 = { Var0 };
	Var9 = { Var3 };
	unk_0x34EB68F89DCC1D05(Var6, Var9, 25f, 0, bParam0, 1);
	unk_0x5B40EC93D0367189(Var0, Var3, bParam0, 1);
	if (!bParam0)
	{
		unk_0x2FA9C6D79054F1BE(Var0, Var3, 0);
		unk_0xEFA71310CAEBAE1F(-1100.5f, 789.8f, 164.34f, 40f, 1, 0, 0, 0);
	}
}

void func_500()
{
	unk_0xE03080E2E83BF49E(-1112.99f, 774.12f, 151.77f, -1077.99f, 853.65f, 187.66f);
}

var func_501()
{
	return unk_0x84496C593C3C7F04(-1212.16f, 634.82f, 138.5f, -1010.08f, 830.94f, 180.47f, 0, 1, 1, 1);
}
...
void func_504(int iParam0)
{
	...
	if (unk_0x159730DB57D995D0("NIGEL_1D_SCENE"))
	{
		unk_0x354EC40268FD2071("NIGEL_1D_SCENE");
	}
	unk_0x6E53DF2C222F676E();
	iVar0 = 0;
	while (iVar0 <= 3)
	{
		func_309(&(Local_402[iVar0 /*13*/]), 1, 0, 1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_309(&(Local_521[iVar0 /*13*/]), 1, 0, 1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_309(&(Local_481[iVar0 /*13*/]), 1, 0, 1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		func_309(&(Local_561[iVar0 /*13*/]), 1, 0, 1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		func_309(&(Local_640[iVar0 /*13*/]), 1, 0, 1);
		iVar0++;
	}
	func_309(&Local_468, 1, 0, 1);
	func_309(&Local_455, 1, 0, 1);
	iVar0 = 0;
	while (iVar0 <= 8)
	{
		func_365(&(Local_694[iVar0 /*6*/]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		func_365(&(Local_755[iVar0 /*6*/]));
		iVar0++;
	}
	func_365(&Local_749);
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		func_512(&(Local_788[iVar0 /*6*/]), 0);
		iVar0++;
	}
	func_211(188, 1, 0, 1, 0);
	Global_33874 = 1;
	unk_0x4EDE34FBADD967A6(0);
	unk_0x3CE75187603652E2(uLocal_778, 0);
	unk_0x3CE75187603652E2(uLocal_779, 0);
	if (iLocal_780 > -1)
	{
		unk_0xC296DD42927416B7(iLocal_780);
	}
	unk_0x651E63BA2F4975EC("rcmnigel1d");
	unk_0x651E63BA2F4975EC("mini@golf");
	unk_0x66EEFE13E1BFC898(0);
	func_505(&Local_108, 0, 0, 0);
...
int func_517(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_520())
	{
		...
		{
			iVar33 = func_432(unk_0x3AA961419D971CB2());
			if (iVar33 > -1)
			{
...
int func_518()
{
	...
	iVar0 = func_435(&(Global_91278.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_520()
{
	...
	{
		if (func_432(&(Global_91278.f_3)) > -1)
		{
			return 1;
		}
	}
