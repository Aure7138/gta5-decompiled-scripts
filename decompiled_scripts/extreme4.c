...
void __EntryFunction__()
{
	...
	uLocal_367 = unk_0x04B8CCFB93858A27();
	...
	if (unk_0xD4B321D9096B01FC(iLocal_179))
	{
	}
	func_318();
	if (!func_335())
	{
		if ((func_317(Local_82.f_28[0]) && func_317(unk_0x0FA8183DAD2B3203())) && !func_316(unk_0x0FA8183DAD2B3203(), Local_82.f_28[0], 4f, 1))
		{
			iLocal_383 = 1;
		}
	}
	while (true)
	{
		...
		unk_0x643E26919A174002("SF_UR", 0);
		...
		{
			if (func_317(unk_0x0FA8183DAD2B3203()) && unk_0x42A24CB7B8A08E11(unk_0x0FA8183DAD2B3203(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, 1, 0))
			{
				if (func_317(Local_155.f_0))
				{
					if (func_316(unk_0x0FA8183DAD2B3203(), Local_155.f_0, 10f, 1))
					{
						func_297();
					}
				}
...
void func_1()
{
	switch (iLocal_147)
	{
		case 0:
			...
			if (unk_0x9591DE0F00127F2A(sLocal_168))
			{
				func_351(1);
			}
			else
...
void func_8()
{
	switch (iLocal_149)
	{
		...
		case 1:
			if (unk_0xD4B321D9096B01FC(iLocal_178))
			{
				if (!unk_0xF4B969E0807E76C7(iLocal_178, 0))
				{
					if (func_316(unk_0x0FA8183DAD2B3203(), iLocal_178, 1f, 1))
					{
						unk_0xC167C31F20B1FD61(unk_0x0FA8183DAD2B3203(), joaat("gadget_parachute"), 1, 0, 0);
						unk_0x377C9F2989832369(&iLocal_178);
					}
				}
			}
			if (iLocal_347 == 0)
			...
			if (func_317(unk_0x0FA8183DAD2B3203()))
			{
				if (iLocal_375 == 0)
				{
					if (unk_0x42A24CB7B8A08E11(unk_0x0FA8183DAD2B3203(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, 0, 1, 0) && unk_0x330AA53EE85E1453(unk_0x0FA8183DAD2B3203()) == 2)
					{
						iLocal_375 = 1;
					}
				}
				if (func_228(Local_155.f_0))
				{
					...
					{
						if ((unk_0x9B35D07DCD0F0B43() > iLocal_370 + 25000 || unk_0x42A24CB7B8A08E11(unk_0x0FA8183DAD2B3203(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || unk_0x42A24CB7B8A08E11(unk_0x0FA8183DAD2B3203(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
						{
							iLocal_149 = 2;
						}
					}
				}
				else if ((unk_0x9B35D07DCD0F0B43() > iLocal_370 + 25000 || unk_0x42A24CB7B8A08E11(unk_0x0FA8183DAD2B3203(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || unk_0x42A24CB7B8A08E11(unk_0x0FA8183DAD2B3203(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
				{
					iLocal_149 = 2;
				}
			}
			if (unk_0x9B35D07DCD0F0B43() < iLocal_370 + 5000)
			{
				if (unk_0xB9AB61E108CF483B())
				{
		...
		case 2:
			if (((!unk_0x833B0C8009274D84(unk_0x0FA8183DAD2B3203()) && !unk_0x604F402D213D3BE5(unk_0x0FA8183DAD2B3203())) && unk_0xB7017D87B119F8F1(unk_0x0FA8183DAD2B3203()) < 2f) && !unk_0x3DAA08BFD9A801FD(unk_0x0FA8183DAD2B3203()))
			{
...
void func_9()
{
	if (iLocal_375 == 1)
	{
		unk_0xE9A303771BF0C29A(10f, 4f, 0);
		func_210(762);
	}
	func_2(1);
	func_10(84, 1);
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_77(func_96(iParam1, uParam0->f_2), Global_76386, 0);
			if (unk_0xA2BC31158C8CEFD2(uVar0, uParam0->f_1))
			{
				unk_0xA1E7A40E1F56E511(&(uParam0->f_6), 1);
			}
			uVar0 = func_77(func_95(iParam1, uParam0->f_2), Global_76386, 0);
			if (unk_0xA2BC31158C8CEFD2(uVar0, uParam0->f_1))
			{
				unk_0xA1E7A40E1F56E511(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_77(iVar1, Global_76386, 0);
				if (!unk_0xA2BC31158C8CEFD2(uVar0, uParam0->f_1))
				{
					unk_0xA1E7A40E1F56E511(&(uParam0->f_6), 4);
				}
...
void func_229()
{
	...
	if (!unk_0xD2652A8A890B29BA(uLocal_352))
	{
	}
	if (!unk_0xD2652A8A890B29BA(uLocal_353))
	{
	}
	if (!unk_0xD2652A8A890B29BA(uLocal_354))
	{
	}
	if (!unk_0xD2652A8A890B29BA(uLocal_355))
	{
	}
	if (!unk_0xD2652A8A890B29BA(uLocal_356))
	{
	}
	if (!unk_0xD2652A8A890B29BA(uLocal_357))
	{
	}
	if (!unk_0xD2652A8A890B29BA(uLocal_358))
	{
	}
	if (!unk_0xD2652A8A890B29BA(uLocal_359))
	{
	}
	if (!unk_0xD2652A8A890B29BA(uLocal_360))
	{
	}
	if (!unk_0xD2652A8A890B29BA(uLocal_361))
	{
	}
	if (!unk_0xD2652A8A890B29BA(uLocal_362))
	{
	}
	unk_0x9F761741AA5B98D2(fVar1);
	unk_0x5AC8A91A3FD00B39(0);
	unk_0x4BEE8AE599A4A300(0);
	unk_0x3D0DE925C0536CA0(unk_0x7C7787D2D7139A85(), false, 128);
	unk_0x8E3496DF5BF7F24D("EXTREME_04_CUSTOM_QUIET_SCENE");
	func_244(800, 0);
	iLocal_376 = 0;
	iLocal_377 = 0;
	iLocal_379 = 0;
	...
	iLocal_377 = 0;
	iLocal_382 = 0;
	unk_0x87C696D270A891ED("SLOWMO_EXTREME_04");
	unk_0x2296B840B5BE9383(0);
	while (unk_0x9B35D07DCD0F0B43() < iLocal_374 + 11000 && !unk_0x260395BA7F0C83CB())
	{
		if (!unk_0xB50E39CA0A3E6020(uLocal_371) && !unk_0xB50E39CA0A3E6020(uLocal_372))
		{
			if (func_242(400))
			{
				bLocal_381 = true;
		...
		if (!iLocal_379)
		{
			if (unk_0xB50E39CA0A3E6020(uLocal_371))
			{
				if (unk_0x91F0628278985DB8(uLocal_371) == 1f)
				{
					if (func_317(Local_155.f_0))
					{
						uLocal_372 = unk_0xF2A54C51C03CADAA(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
						uLocal_364 = unk_0x87B0FFB353287F00("DEFAULT_ANIMATED_CAMERA", 1);
						unk_0x8582CCEB95B1F1BE(Local_155.f_0, uLocal_372, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						unk_0xC8210337A7389E13(uLocal_372, 0);
						unk_0x0472F75F711AABCE(uLocal_364, 1);
						unk_0x0116AC515A8787A5(uLocal_364, uLocal_372, "Base_Jump_Spot_02_CAM", "rcmextreme4");
						unk_0x0298C8010FD5A69E(1, 0, 3000, 1, 0, 0);
						unk_0xCFEC09B98C6C5993(Local_155.f_0, 0, 0);
						unk_0xDC5BA18043353983(uLocal_363, 0);
						iLocal_379 = 1;
					}
				}
			}
		...
		{
			if (unk_0xB50E39CA0A3E6020(uLocal_372) && unk_0x91F0628278985DB8(uLocal_372) >= 0.2f)
			{
				if (!unk_0xB50E39CA0A3E6020(uLocal_373))
				{
					unk_0xDEDE5A5FE5D475CB("RCM_Extreme4_Fall_and_impact", 0);
				}
			}
			if (unk_0xB50E39CA0A3E6020(uLocal_372) && unk_0x91F0628278985DB8(uLocal_372) == 1f)
			{
				if (func_317(Local_155.f_0))
				{
					uLocal_373 = unk_0xF2A54C51C03CADAA(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
					uLocal_365 = unk_0x87B0FFB353287F00("DEFAULT_ANIMATED_CAMERA", 1);
					unk_0x8582CCEB95B1F1BE(Local_155.f_0, uLocal_373, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
					unk_0xC8210337A7389E13(uLocal_373, 1);
					unk_0x0472F75F711AABCE(uLocal_365, 1);
					unk_0x0116AC515A8787A5(uLocal_365, uLocal_373, "Fall_and_impact_CAM", "rcmextreme4");
					unk_0x85DFADFD2165FE65(uLocal_373);
					unk_0x0298C8010FD5A69E(1, 0, 3000, 1, 0, 0);
					unk_0xCFEC09B98C6C5993(Local_155.f_0, 0, 0);
					unk_0xDC5BA18043353983(uLocal_364, 0);
					iLocal_380 = 1;
				}
			}
		}
		else if (unk_0xB50E39CA0A3E6020(uLocal_373) && unk_0x91F0628278985DB8(uLocal_373) >= 0.323f)
		{
			if (!iLocal_376)
			{
				unk_0x2A340E5B0AF591B5("scr_extrm4_water_splash", 1655.27f, -20.8134f, 133.841f, 0f, 0f, 0f, 1f, 0, 0, 0);
				unk_0xA4B65F2569A21B95(1f);
				func_240();
				iLocal_376 = 1;
			}
			else if (!iLocal_382)
			{
				if (unk_0xB50E39CA0A3E6020(uLocal_373) && unk_0x91F0628278985DB8(uLocal_373) >= 0.44f)
				{
					uLocal_180 = unk_0xCC982E63B755625A("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
					unk_0x50A24C075D8115BB(uLocal_180, 1f);
					iLocal_382 = 1;
				}
			}
		}
		if (unk_0x9B35D07DCD0F0B43() > iLocal_374 + 600 && fVar1 == 1f)
		{
			if (!iLocal_377)
			{
				iLocal_377 = 1;
		...
		fVar2 = (1f / 30f);
		fVar3 = (unk_0x9927BD5F023FA79D() / fVar2);
		if (unk_0x9B35D07DCD0F0B43() > iLocal_374 + 630)
		{
		...
		if (unk_0x9B35D07DCD0F0B43() > iLocal_374 + 563)
		{
			if (iVar0 == 1)
			{
				func_3(&uLocal_175);
		...
		if (unk_0x9B35D07DCD0F0B43() > iLocal_374 + 871)
		{
			if (iVar0 == 2)
			{
				if (func_317(Local_155.f_0))
		...
		if (unk_0x9B35D07DCD0F0B43() > iLocal_374 + 2000)
		{
			if (iVar0 == 3)
			{
				if (func_317(Local_155.f_0))
		...
		if (unk_0x9B35D07DCD0F0B43() > iLocal_374 + 3500)
		{
			if (iVar0 == 4)
			{
				iVar0 = 5;
		...
		if (unk_0x9B35D07DCD0F0B43() > iLocal_374 + 10000)
		{
			if (iVar0 != 7)
			{
				unk_0xDC5BA18043353983(uLocal_365, 0);
				uLocal_362 = unk_0x87B0FFB353287F00("DEFAULT_SCRIPTED_CAMERA", 1);
				unk_0x88C9848645E010B6(uLocal_362, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
				unk_0x0298C8010FD5A69E(1, 0, 3000, 1, 0, 0);
				unk_0x0472F75F711AABCE(uLocal_362, 1);
				iVar0 = 7;
			}
		}
	}
	if (bLocal_381)
	{
		if (unk_0xB50E39CA0A3E6020(uLocal_373))
		{
			unk_0x778379C2FB24C6F1(uLocal_373);
		}
		unk_0xDA121A208136850D("EXT4_JUMPED_OS");
		func_240();
		uLocal_362 = unk_0x87B0FFB353287F00("DEFAULT_SCRIPTED_CAMERA", 1);
		unk_0x88C9848645E010B6(uLocal_362, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
		unk_0x0298C8010FD5A69E(1, 0, 3000, 1, 0, 0);
	...
	unk_0x0BD57148624CBE09("SLOWMO_EXTREME_04");
	func_3(&uLocal_175);
	if (func_317(Local_155.f_0))
	{
		if (iVar0 < 3)
		{
			unk_0x0BBBAC4546BFE280(Local_155.f_0, 101, 0);
			Var4 = { unk_0xACE5E491FC1B0D37(Local_155.f_0, 1) };
			if (Var4.f_2 > 155f)
			{
				fVar7 = 155f;
			}
			...
			unk_0xCB3446C6A91D1A78(Local_155.f_0, 1657.046f, -17.4571f, fVar7, 1, 0, 0, 1);
		}
	}
	...
	unk_0x5AC8A91A3FD00B39(1);
	unk_0x4BEE8AE599A4A300(1);
	unk_0x3D0DE925C0536CA0(unk_0x7C7787D2D7139A85(), true, 128);
	unk_0x9F761741AA5B98D2(1f);
	if (func_228(Local_155.f_0))
	{
		if (unk_0xB50E39CA0A3E6020(uLocal_373))
		{
			unk_0x418ABE435B684083(uLocal_373, 1f);
		}
		unk_0x5BBDAD06F405ED2C(Local_155.f_0);
		unk_0xCFEC09B98C6C5993(Local_155.f_0, 0, 0);
		unk_0xCB3446C6A91D1A78(Local_155.f_0, 1655.77f, -20.04f, 135.8f, 1, 0, 0, 1);
		unk_0x0BBBAC4546BFE280(Local_155.f_0, 0, 0);
	}
	func_230(&uLocal_182, 1, unk_0x0FA8183DAD2B3203(), "FRANKLIN", 0, 1);
...
void func_232(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()) && !func_236(unk_0x7C7787D2D7139A85())) && !func_234(unk_0x7C7787D2D7139A85(), 0)) && !func_233()) && !bParam4) && !bParam5)
			{
				unk_0x04F5A8AA60EC662B(unk_0x0FA8183DAD2B3203(), 0);
			}
		}
		else if (((!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()) && !func_236(unk_0x7C7787D2D7139A85())) && !bParam4) && !bParam5)
		{
			unk_0x04F5A8AA60EC662B(unk_0x0FA8183DAD2B3203(), 0);
		}
		Global_76575 = 0;
...
void func_245()
{
	if (iLocal_149 < 2)
	{
		unk_0xF45B7CAEA9F06737("EXT4_JUMPED_OS");
	}
	switch (iLocal_149)
	{
		case 0:
			iLocal_151 = 0;
			if (unk_0x42A24CB7B8A08E11(unk_0x0FA8183DAD2B3203(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, 0, 1, 0))
			{
				unk_0xD951D071C4C60D8C("es_4_rcm_p2_concat", 6, 8);
			}
			else
			{
				unk_0xD951D071C4C60D8C("es_4_rcm_p2_concat", 5, 8);
			}
			unk_0xCFF6AB47B7B014FF(uLocal_367);
			if (unk_0xF628B2ECEE913E4E())
			{
				unk_0xD1FEA8C1A32B5B0C("Dom", 8, 2, 0, 0);
			}
			if (!func_266())
			{
				if (func_260(1, 20f, 1))
				{
					if ((!iLocal_383 || unk_0x9B35D07DCD0F0B43() > iLocal_384 + 3000) || unk_0xC49563EAE7AACA6C(unk_0x0FA8183DAD2B3203(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0))
					{
						unk_0x2296B840B5BE9383(1);
						unk_0x3268D119250624E8(2048);
						if (func_317(Local_155.f_0))
						{
							unk_0x38F2C110546BD846(Local_155.f_0, "Dom", 0, joaat("cs_dom"), 0);
						}
						unk_0x4EDE34FBADD967A6(0);
						iLocal_383 = 0;
						unk_0xAB681892AAC7844A(0);
						unk_0x7D17F1A2E0EEDBB9("EXTREME_04_CUSTOM_QUIET_SCENE");
						if (func_317(Local_155.f_0))
						{
							unk_0x860A5CC30A0EF207(Local_155.f_0, 0);
						}
						if (unk_0xD4B321D9096B01FC(iLocal_179) && !unk_0xF4B969E0807E76C7(iLocal_179, 0))
						{
							unk_0x2BBEC4B37B923F4B(iLocal_179, 0, 0);
						}
						if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
						{
							iLocal_172 = unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0);
							iLocal_181 = unk_0x7F375072508F738F(iLocal_172);
							if (unk_0x2741F9670A602A19(iLocal_181) == 1 || unk_0xF39FF829579D1A21(iLocal_181) == 1)
							{
						...
						unk_0xBB65AAC660EECEA8(1660.186f, -7.492f, 172.774f, 200f, 0);
						uLocal_366 = unk_0x740FE9B7B3FE1CE5(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
						iLocal_149 = 1;
					}
				}
			}
		...
		case 1:
			if (unk_0x33D7ABC47E81DCF9())
			{
				if (unk_0x5038F629059483A1(0))
				{
					if (!iLocal_154)
					{
						if (!unk_0xB50E39CA0A3E6020(uLocal_371))
						{
							if (func_317(Local_155.f_0))
							{
								if (!unk_0xD2652A8A890B29BA(uLocal_363))
								{
									uLocal_363 = unk_0x87B0FFB353287F00("DEFAULT_ANIMATED_CAMERA", 1);
								}
								unk_0x0472F75F711AABCE(uLocal_363, 1);
								unk_0x0298C8010FD5A69E(1, 0, 3000, 1, 0, 0);
								uLocal_371 = unk_0xF2A54C51C03CADAA(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
								unk_0x8582CCEB95B1F1BE(Local_155.f_0, uLocal_371, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
								unk_0xC8210337A7389E13(uLocal_371, 1);
								unk_0x0472F75F711AABCE(uLocal_363, 1);
								unk_0x0116AC515A8787A5(uLocal_363, uLocal_371, "Base_Jump_Spot_CAM", "rcmextreme4");
								unk_0x0298C8010FD5A69E(1, 0, 3000, 1, 0, 0);
								unk_0xCFEC09B98C6C5993(Local_155.f_0, 0, 0);
								iLocal_154 = 1;
							}
				...
				if (func_317(Local_155.f_0))
				{
					if (unk_0xDFB741CB32BE818E("Dom", 0))
					{
						iLocal_149 = 2;
					}
				}
		...
		case 2:
			...
			if (unk_0xD4B321D9096B01FC(iLocal_179) && !unk_0xF4B969E0807E76C7(iLocal_179, 0))
			{
				unk_0x2BBEC4B37B923F4B(iLocal_179, 1, 0);
			}
			if (iLocal_151 == 0)
			{
				unk_0x81995F6F93D8C987("EXT4_JUMPED_OS");
				func_246(3);
			}
			break;
	}
...
void func_247(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0xD699DB8EAB756F25(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0xBB65AAC660EECEA8(func_248(unk_0x7A8732CFB5113E77()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_250(struct<3> Param0, float fParam3)
{
	...
	if (!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
	{
		...
		if (unk_0xD4B321D9096B01FC(iVar0))
		{
			...
			{
				unk_0xCB3446C6A91D1A78(iVar0, Param0, 1, 0, 0, 1);
...
int func_260(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
	{
		...
		{
			if (!func_264(unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_263(unk_0x0FA8183DAD2B3203(), -828834893))
				{
...
void func_267()
{
	if (!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
	{
		...
		{
			if (((((((unk_0x3772881BFFE6C3F8(0, 30) || unk_0x3772881BFFE6C3F8(0, 31)) || unk_0x3772881BFFE6C3F8(0, 23)) || unk_0x3772881BFFE6C3F8(0, 21)) || unk_0x3772881BFFE6C3F8(0, 22)) || (func_279() && unk_0x3772881BFFE6C3F8(0, 1))) || (func_279() && unk_0x3772881BFFE6C3F8(0, 2))) || (func_279() && unk_0x3772881BFFE6C3F8(0, 32)))
			{
	...
	switch (iLocal_149)
	{
		case 0:
			...
			{
				unk_0xDEB0AA30ABFDCF48(Local_82.f_28[0], 17, 1);
			}
			iLocal_368 = 0;
			iLocal_383 = 1;
			func_278("EXT4_01", 7500, 1);
			uLocal_170 = func_277(Local_155.f_0, 1, 1, 5);
			unk_0xC1B1E9A034A63A62(0);
			iLocal_149 = 1;
			break;
		...
		case 1:
			...
			if (func_317(unk_0x0FA8183DAD2B3203()))
			{
				if (func_317(Local_155.f_0))
				{
					if (func_316(unk_0x0FA8183DAD2B3203(), Local_155.f_0, 100f, 1))
					{
						unk_0xD951D071C4C60D8C("es_4_rcm_p2_concat", 6, 8);
						if (unk_0xF628B2ECEE913E4E())
						{
					...
					if (unk_0x3DAA08BFD9A801FD(Local_155.f_0))
					{
						unk_0x0BBBAC4546BFE280(Local_155.f_0, 0, 0);
					}
					if (func_316(unk_0x0FA8183DAD2B3203(), Local_155.f_0, 32f, 1))
					{
						...
						else
						{
							if (!iLocal_378)
							{
								if (func_316(unk_0x0FA8183DAD2B3203(), Local_155.f_0, 30f, 1) && !func_266())
								{
							...
							func_269();
							if (!unk_0x01B4DA7FA4E5AD3A(unk_0x0FA8183DAD2B3203(), Local_155.f_0))
							{
								unk_0x6E2920E14F5F962C(unk_0x0FA8183DAD2B3203(), Local_155.f_0, -1, 0, 2);
							}
						}
					}
					if (unk_0x42A24CB7B8A08E11(unk_0x0FA8183DAD2B3203(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, 0, 1, 0))
					{
						if (!unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
						{
							iLocal_149 = 2;
		...
		case 2:
			...
			if (func_317(unk_0x0FA8183DAD2B3203()))
			{
				if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
				{
					unk_0x784753B14715F27F(unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0), 5f, 1, 0);
...
void func_268()
{
	if (func_317(Local_155.f_0))
	{
		if (unk_0x411C065ADB822CD9(Local_155.f_0, 242628503) != 1)
		{
			unk_0xC544A8E1032AC1CF(Local_155.f_0, uLocal_171);
		}
	}
}
...
void func_269()
{
	if (!func_266())
	{
		if (iLocal_368 < 5)
		{
			if (unk_0x9B35D07DCD0F0B43() > (iLocal_369 + (8000 + unk_0xBAC643F143880136(0, 2000))))
			{
				if (unk_0xDE3C2FB26058823A(uLocal_367))
				{
	...
	if (!func_266())
	{
		if ((unk_0x059780A8877D0C70("EXTREME_04_DOM_A", 0, -1) && unk_0x059780A8877D0C70("EXTREME_04_DOM_B", 0, -1)) && unk_0x059780A8877D0C70("EXTREME_04_DOM_C", 0, -1))
		{
			if (unk_0xDE3C2FB26058823A(uLocal_367))
			{
				unk_0x5F5C6A264C2CA8B1(uLocal_367, "DOM", Local_155.f_0, "EXTREME_04_SOUNDSET", 0, 0);
			}
		}
	}
}
...
int func_274(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_258(Param1 - unk_0xACE5E491FC1B0D37(iParam0, 1)) };
	...
	{
		Var3 = { func_258(unk_0x0E516C24C87F5D0C(iParam0, 31086, 0f, 5f, 0f) - unk_0x0E516C24C87F5D0C(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_280()
{
	...
	else
	{
		...
		unk_0xD06C31EF9A42C2B4(unk_0x0FA8183DAD2B3203(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
		func_244(800, 0);
		iLocal_152 = 1;
		func_287(1, 1, 1);
	}
...
void func_281()
{
	...
	unk_0xD06C31EF9A42C2B4(Local_82.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 0.25f, 0, 40000f);
	unk_0x8EB1E7594B0F5A9C("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 0);
	unk_0x7FB505C34A14BAAA(Local_155.f_1, 20f, 0, 0, 0, 0, 0, 0);
	if (!unk_0xD4B321D9096B01FC(iLocal_173))
	{
		iLocal_173 = unk_0x847817A65E16621A(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, 1, 1, 0);
	}
	if (!unk_0xD4B321D9096B01FC(iLocal_174))
	{
		iLocal_174 = unk_0x847817A65E16621A(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, 1, 1, 0);
	}
	if (!unk_0xD4B321D9096B01FC(iLocal_176))
	{
		iLocal_176 = unk_0x7187764DB5121FC9(joaat("prop_box_wood01a"), 1666.282f, -11.20408f, 172.7773f, 1, 1, 0);
		unk_0xF3D48447FACBBE72(iLocal_176, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!unk_0xD4B321D9096B01FC(iLocal_177))
	{
		iLocal_177 = unk_0x7187764DB5121FC9(joaat("prop_box_wood01a"), 1667.076f, -12.07778f, 173.2611f, 1, 1, 0);
		unk_0xF3D48447FACBBE72(iLocal_177, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_317(Local_155.f_0))
	{
		if (unk_0x411C065ADB822CD9(Local_155.f_0, 242628503) != 1)
		{
			...
			unk_0x5D672CB011E20B28(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, "rcmextreme4", "fidget_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, "rcmextreme4", "fidget_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x509D27D3AE4D5D9A(uLocal_171, 1);
	...
	if (func_317(Local_155.f_0))
	{
		unk_0xACD33DBAF2546FCF(Local_155.f_0, 0);
		func_230(&uLocal_182, 4, Local_155.f_0, "DOM", 0, 1);
		unk_0xDB889DCC8B0139E6(Local_155.f_0, unk_0x79CDB5CF25B388E3(unk_0x0FA8183DAD2B3203()));
	}
	if (!unk_0xD4B321D9096B01FC(iLocal_179))
	{
		iLocal_179 = unk_0x6645847093E58917(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
	}
	unk_0xF3D48447FACBBE72(iLocal_179, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	unk_0xAF87685A609CD981(iLocal_179, "Chute_Off_Bag", "skydive@parachute@", 4f, 0, 1, 0, 0.99f, 0);
	func_246(1);
}
...
void func_291()
{
	switch (iLocal_150)
	{
		case 0:
			...
			{
				if (!iLocal_383 || unk_0x9B35D07DCD0F0B43() > iLocal_384 + 3500)
				{
					func_292();
					unk_0x2296B840B5BE9383(1);
					...
					if (func_228(Local_82.f_28[0]))
					{
						unk_0x38F2C110546BD846(Local_82.f_28[0], "Hudson", 0, joaat("a_c_retriever"), 0);
					}
					unk_0x4EDE34FBADD967A6(0);
					unk_0xAB681892AAC7844A(0);
		...
		case 2:
			func_285(unk_0x0FA8183DAD2B3203(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			unk_0xB300618E39F089F8(unk_0x0FA8183DAD2B3203(), joaat("MotionState_Walk"), 0, 1, 0);
			unk_0xC4ED4DDEA17F155D(unk_0x0FA8183DAD2B3203(), 1f);
			unk_0xD06C31EF9A42C2B4(unk_0x0FA8183DAD2B3203(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
			unk_0xA291E27354439AE9(0f, 1065353216);
...
int func_293(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
	{
		if ((!unk_0xCE4D7B70DA8B0C86(unk_0x0FA8183DAD2B3203()) && !unk_0xE6B36186AADE8F35(unk_0x0FA8183DAD2B3203())) && !unk_0x0B8262712AD6841C(unk_0x0FA8183DAD2B3203()))
		{
			if (!func_264(unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_296()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_335() && func_317(Local_82.f_28[0])) && func_317(unk_0x0FA8183DAD2B3203())) && iLocal_383 == 1)
	{
		if (!unk_0xE5409F09171D0BEE())
		{
			unk_0x3D0DE925C0536CA0(unk_0x7C7787D2D7139A85(), false, 0);
			unk_0x6E2920E14F5F962C(unk_0x0FA8183DAD2B3203(), Local_82.f_28[0], -1, 0, 2);
			unk_0x30FCF578B001D6A3(unk_0x0FA8183DAD2B3203(), Local_82.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
			unk_0x13DD5FDC457B7DBC(1);
			unk_0xFFFB9D39E6C8D02D(Local_82.f_28[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, 0);
			unk_0x6ED5C852EC8B4D01(fVar0);
			unk_0x2AAAA86E5F9FA80C(fVar1);
			unk_0x5476CF199D6A8619(fVar2);
			unk_0x975B7DA1F63360EC(fVar3);
			unk_0x825B331DFF75F2BD(fVar4);
			iLocal_384 = unk_0x9B35D07DCD0F0B43();
		}
		else
		{
			if (func_316(unk_0x0FA8183DAD2B3203(), Local_82.f_28[0], 4f, 1))
			{
...
void func_297()
{
	...
	if (iLocal_383)
	{
		if (!unk_0xE5409F09171D0BEE())
		{
			unk_0x3D0DE925C0536CA0(unk_0x7C7787D2D7139A85(), false, 0);
			unk_0x6E2920E14F5F962C(unk_0x0FA8183DAD2B3203(), Local_155.f_0, -1, 0, 2);
			unk_0xD06C31EF9A42C2B4(unk_0x0FA8183DAD2B3203(), 1658.95f, -5.45f, 173.78f, 1f, -1, 0.25f, 0, -161.08f);
			unk_0x13DD5FDC457B7DBC(1);
			unk_0xFFFB9D39E6C8D02D(Local_155.f_0, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
			unk_0x6ED5C852EC8B4D01(fVar0);
			unk_0x2AAAA86E5F9FA80C(fVar1);
			unk_0x5476CF199D6A8619(fVar2);
			unk_0x975B7DA1F63360EC(fVar3);
...
void func_298()
{
	...
	if (iLocal_148 == 1)
	{
		...
		{
			fVar0 = unk_0xD34AF93E9BCF12F0(unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1), unk_0xACE5E491FC1B0D37(Local_155.f_0, 1), 1);
			if (iLocal_153 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			if (fVar0 > 150f)
			{
				...
				{
					unk_0x6B29681A8280DB75(uLocal_170, 1);
				}
			}
			else if (unk_0x39A01A052D9B5FF0(uLocal_170))
			{
				unk_0x6B29681A8280DB75(uLocal_170, 0);
			}
		}
		if (unk_0x42A24CB7B8A08E11(unk_0x0FA8183DAD2B3203(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, 0, 1, 0))
		{
			sLocal_168 = "EXT4_F2";
			iLocal_148 = 4;
		}
...
int func_310(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	...
	switch (Global_76831)
	{
		...
		case 5:
			if ((unk_0x33D7ABC47E81DCF9() || func_312(0)) || func_311(1))
			{
			}
			else
			{
...
void func_318()
{
	...
	unk_0x9F815D4FA0C47F97("EXT4", 0);
	while (!unk_0xA3D567B14856EDE1(0))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	unk_0x6BB2B1818CAE531E(joaat("prop_box_guncase_03a"));
	unk_0x6BB2B1818CAE531E(joaat("prop_box_wood01a"));
	unk_0x6BB2B1818CAE531E(joaat("p_parachute_s"));
	unk_0x6BB2B1818CAE531E(joaat("bmx"));
	while (((!unk_0x6DF9C43E3CC645BC(joaat("prop_box_guncase_03a")) || !unk_0x6DF9C43E3CC645BC(joaat("prop_box_wood01a"))) || !unk_0x6DF9C43E3CC645BC(joaat("p_parachute_s"))) || !unk_0x6DF9C43E3CC645BC(joaat("bmx")))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0xD4B321D9096B01FC(uLocal_175))
	{
		iLocal_175 = unk_0x366EC9EEE4362C87(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, 1, 1, 0);
		unk_0xF3D48447FACBBE72(iLocal_175, 90f, 0f, -63f, 2, 1);
		unk_0x860A5CC30A0EF207(iLocal_175, 1);
		unk_0x2BBEC4B37B923F4B(iLocal_175, 0, 0);
	}
	func_322(1);
	if (!unk_0xD4B321D9096B01FC(Local_155.f_0))
	{
		func_319(&Local_155, 52, Local_155.f_1, Local_155.f_4, "Ext4-Dom", 1);
		unk_0x860A5CC30A0EF207(Local_155.f_0, 1);
		unk_0xCC94EE23853F38E4(Local_155.f_0, 1);
		unk_0x6587121229FA1EAA(Local_155.f_0, 1);
		unk_0x0453EBC0FB8D8A80(Local_155.f_0, 8, 2, 0, 0);
		unk_0x29A678E1131D7F88(Local_155.f_0, 1);
		unk_0x1DB66BD2267055C0(Local_155.f_0, 137, 1);
		unk_0x1DB66BD2267055C0(Local_155.f_0, 118, 0);
		unk_0x1DB66BD2267055C0(Local_155.f_0, 208, 1);
		unk_0x6E84F47D0D3E5BC9(Local_155.f_0, 5000);
	}
	if (func_228(unk_0x0FA8183DAD2B3203()))
	{
		func_230(&uLocal_182, 1, unk_0x0FA8183DAD2B3203(), "FRANKLIN", 0, 1);
...
{
	unk_0x6BB2B1818CAE531E(Local_155.f_5);
	unk_0x36B659209EBDD366("rcmextreme4");
	unk_0x36B659209EBDD366("skydive@parachute@");
	unk_0x6BB2B1818CAE531E(joaat("sanchez"));
	unk_0x8CD04D2D122523B6();
	if (iParam0 == 1)
	{
		while ((((!unk_0x6DF9C43E3CC645BC(Local_155.f_5) || !unk_0x6DF9C43E3CC645BC(joaat("sanchez"))) || !unk_0xB25A0D192C6A0A5B("rcmextreme4")) || !unk_0xB25A0D192C6A0A5B("skydive@parachute@")) || !unk_0x5B9201742B00334D())
		{
			unk_0x4EDE34FBADD967A6(0);
		}
	}
...
void func_336(int iParam0)
{
	...
	unk_0x8EB1E7594B0F5A9C("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 1);
...
void func_349()
{
	...
	unk_0x7D74D6A091150B86("rcmextreme4");
}
...
void func_351(bool bParam0)
{
	...
	if (!func_372())
	{
		...
		{
			func_167(iVar0, 1, 0);
			func_352(unk_0x0037AFCBDC61F351(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
...
int func_353(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_359())
	{
		...
		{
			iVar33 = func_354(unk_0x0037AFCBDC61F351());
			if (iVar33 > -1)
			{
