	...
	while (true)
	{
		...
		if (iLocal_148 < 3 && iLocal_383)
		{
			if (func_317(unk_0xE2D3D51028F0428A()) && unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, 1, 0))
			{
				...
				{
					if (func_316(unk_0xE2D3D51028F0428A(), Local_155.f_0, 10f, 1))
					{
						func_297();
					}
				}
...
void func_14()
{
	...
	{
		func_16(13, unk_0xF34EE736CF047844(Global_112915.f_10194.f_3853));
	}
	...
	switch (iLocal_149)
	{
		...
		case 1:
			...
			if (func_317(unk_0xE2D3D51028F0428A()))
			{
				if (func_317(Local_155.f_0))
				{
					if (func_316(unk_0xE2D3D51028F0428A(), Local_155.f_0, 100f, 1))
					{
						unk_0xCB3859A62F123AEF("es_4_rcm_p2_concat", 6, 8);
						if (unk_0x2566F947AAB7B2A7())
						{
					...
					if (func_316(unk_0xE2D3D51028F0428A(), Local_155.f_0, 32f, 1))
					{
						...
						else
						{
							if (!iLocal_378)
							{
								if (func_316(unk_0xE2D3D51028F0428A(), Local_155.f_0, 30f, 1) && !func_266())
								{
...
void func_268()
{
	if (func_317(Local_155.f_0))
	{
		if (unk_0x174CED88B97C78D9(Local_155.f_0, 242628503) != 1)
		{
