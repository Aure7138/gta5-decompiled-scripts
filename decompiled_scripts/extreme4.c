...
void __EntryFunction__()
{
	...
	if (unk_0x86CCCD2FAE9D5E65(iLocal_178))
	{
	}
	func_309();
	if (!func_321())
	{
		if ((func_308(Local_81.f_28[0]) && func_308(unk_0x81873881071CD9FE())) && !func_307(unk_0x81873881071CD9FE(), Local_81.f_28[0], 4f))
		{
			iLocal_382 = 1;
		}
	}
	while (true)
	{
		...
		unk_0x36137B7A77318822("SF_UR", 0);
		...
		{
			if (func_308(unk_0x81873881071CD9FE()) && unk_0xD1FFD959917D4ED8(unk_0x81873881071CD9FE(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, 1, 0))
			{
				if (func_308(Local_154.f_0))
				{
					if (func_307(unk_0x81873881071CD9FE(), Local_154.f_0, 10f))
					{
						func_288();
					}
				}
...
void func_1()
{
	switch (iLocal_146)
	{
		case 0:
			...
			if (unk_0xB318FDA0D1ABDB20(sLocal_167))
			{
				func_337(1);
			}
			else
...
void func_8()
{
	switch (iLocal_148)
	{
		...
		case 1:
			if (unk_0x86CCCD2FAE9D5E65(iLocal_177))
			{
				if (!unk_0x930F8FBB8E9537CC(iLocal_177))
				{
					if (func_307(unk_0x81873881071CD9FE(), iLocal_177, 1f))
					{
						unk_0x8E4A427F5C43E416(unk_0x81873881071CD9FE(), joaat("gadget_parachute"), 1, 0, 0);
						unk_0xAB6AFD52AD641D70(&iLocal_177);
					}
				}
			}
			if (iLocal_346 == 0)
			{
				...
				if (func_221(Local_154.f_0))
				{
				}
				iLocal_346 = 1;
			}
			if (func_308(unk_0x81873881071CD9FE()))
			{
				if (iLocal_374 == 0)
				{
					if (unk_0xD1FFD959917D4ED8(unk_0x81873881071CD9FE(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, 0, 1, 0) && unk_0x212579F7919ACAFB(unk_0x81873881071CD9FE()) == 2)
					{
						iLocal_374 = 1;
					}
				}
				if (func_221(Local_154.f_0))
				{
					...
					{
						if ((unk_0x48E480685981C7D4() > iLocal_369 + 25000 || unk_0xD1FFD959917D4ED8(unk_0x81873881071CD9FE(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || unk_0xD1FFD959917D4ED8(unk_0x81873881071CD9FE(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
						{
							iLocal_148 = 2;
						}
					}
				}
				else if ((unk_0x48E480685981C7D4() > iLocal_369 + 25000 || unk_0xD1FFD959917D4ED8(unk_0x81873881071CD9FE(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || unk_0xD1FFD959917D4ED8(unk_0x81873881071CD9FE(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
				{
					iLocal_148 = 2;
				}
			}
			if (unk_0x48E480685981C7D4() < iLocal_369 + 5000)
			{
				if (unk_0xFF43EABF617B213F())
				{
		...
		case 2:
			if (((!unk_0x98AED52C4D8603AF(unk_0x81873881071CD9FE()) && !unk_0x326033AAF1073AF3(unk_0x81873881071CD9FE())) && unk_0x2C7FEB2538D88E8C(unk_0x81873881071CD9FE()) < 2f) && !unk_0xD81BC0FD4D47CC04(unk_0x81873881071CD9FE()))
			{
				if (func_209(&uLocal_181, "EXT4AUD", "EXT4_WIL2", 8, 0, 0, 0))
				{
					func_9();
				}
			}
...
void func_9()
{
	if (iLocal_374 == 1)
	{
		unk_0x2CEC5A597B1DFFE1(10f, 4f, 0);
		func_208(762);
	}
	func_2(1);
	func_10(84, 1);
...
void func_92(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		{
			uVar0 = func_76(func_95(iParam1, uParam0->f_2), Global_68879, 0);
			if (unk_0x236D8AD7EE179F46(uVar0, uParam0->f_1))
			{
				unk_0xF3148AAF69AF9CBC(&(uParam0->f_6), 1);
			}
			uVar0 = func_76(func_94(iParam1, uParam0->f_2), Global_68879, 0);
			if (unk_0x236D8AD7EE179F46(uVar0, uParam0->f_1))
			{
				unk_0xF3148AAF69AF9CBC(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_76(iVar1, Global_68879, 0);
				if (!unk_0x236D8AD7EE179F46(uVar0, uParam0->f_1))
				{
					unk_0xF3148AAF69AF9CBC(&(uParam0->f_6), 4);
				}
...
void func_222()
{
	...
	if (!unk_0x42E36F2D658EB2FF(uLocal_351))
	{
	}
	if (!unk_0x42E36F2D658EB2FF(uLocal_352))
	{
	}
	if (!unk_0x42E36F2D658EB2FF(uLocal_353))
	{
	}
	if (!unk_0x42E36F2D658EB2FF(uLocal_354))
	{
	}
	if (!unk_0x42E36F2D658EB2FF(uLocal_355))
	{
	}
	if (!unk_0x42E36F2D658EB2FF(uLocal_356))
	{
	}
	if (!unk_0x42E36F2D658EB2FF(uLocal_357))
	{
	}
	if (!unk_0x42E36F2D658EB2FF(uLocal_358))
	{
	}
	if (!unk_0x42E36F2D658EB2FF(uLocal_359))
	{
	}
	if (!unk_0x42E36F2D658EB2FF(uLocal_360))
	{
	}
	if (!unk_0x42E36F2D658EB2FF(uLocal_361))
	{
	}
	unk_0xCF2F32222FF93448(fVar1);
	unk_0xF1BC58601CA4A5C7(0);
	unk_0x3BF4F473786B0150(0);
	unk_0x034205BA180B4E43(unk_0x1329891157A54C63(), false, 128);
	unk_0x0C22E352114F699C("EXTREME_04_CUSTOM_QUIET_SCENE");
	func_236(800, 0);
	iLocal_375 = 0;
	iLocal_376 = 0;
	iLocal_378 = 0;
	...
	iLocal_376 = 0;
	iLocal_381 = 0;
	unk_0xAF6AFC714D6D0DC9("SLOWMO_EXTREME_04");
	unk_0xE8F8B47D8785FAD4(0);
	while (unk_0x48E480685981C7D4() < iLocal_373 + 11000 && !unk_0x29AFA2493D7C23D0())
	{
		if (!unk_0xDD7720E17AF5FE17(uLocal_370) && !unk_0xDD7720E17AF5FE17(uLocal_371))
		{
			if (func_234(400))
			{
				bLocal_380 = true;
		...
		if (!iLocal_378)
		{
			if (unk_0xDD7720E17AF5FE17(uLocal_370))
			{
				if (unk_0xF855C83E3A17514B(uLocal_370) == 1f)
				{
					if (func_308(Local_154.f_0))
					{
						uLocal_371 = unk_0x59C061A719024602(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
						uLocal_363 = unk_0xAAC4D4F273757469("DEFAULT_ANIMATED_CAMERA", 1);
						unk_0x58BEA8B2364F8C48(Local_154.f_0, uLocal_371, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						unk_0xC64A07C5C44EA267(uLocal_371, 0);
						unk_0xDD0B0D77CB8995B1(uLocal_363, 1);
						unk_0xC813152833B59518(uLocal_363, uLocal_371, "Base_Jump_Spot_02_CAM", "rcmextreme4");
						unk_0xFEBF3DDE5E4DC5C5(1, 0, 3000, 1, 0, 0);
						unk_0x95BE9BA77CA91710(Local_154.f_0, 0, 0);
						unk_0x35B958B469415A23(uLocal_362, 0);
						iLocal_378 = 1;
					}
				}
			}
		...
		{
			if (unk_0xDD7720E17AF5FE17(uLocal_371) && unk_0xF855C83E3A17514B(uLocal_371) >= 0.2f)
			{
				if (!unk_0xDD7720E17AF5FE17(uLocal_372))
				{
					unk_0x48B259DC788A1D43("RCM_Extreme4_Fall_and_impact", 0);
				}
			}
			if (unk_0xDD7720E17AF5FE17(uLocal_371) && unk_0xF855C83E3A17514B(uLocal_371) == 1f)
			{
				if (func_308(Local_154.f_0))
				{
					uLocal_372 = unk_0x59C061A719024602(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
					uLocal_364 = unk_0xAAC4D4F273757469("DEFAULT_ANIMATED_CAMERA", 1);
					unk_0x58BEA8B2364F8C48(Local_154.f_0, uLocal_372, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
					unk_0xC64A07C5C44EA267(uLocal_372, 1);
					unk_0xDD0B0D77CB8995B1(uLocal_364, 1);
					unk_0xC813152833B59518(uLocal_364, uLocal_372, "Fall_and_impact_CAM", "rcmextreme4");
					unk_0x7A7305FD98CE3186(uLocal_372);
					unk_0xFEBF3DDE5E4DC5C5(1, 0, 3000, 1, 0, 0);
					unk_0x95BE9BA77CA91710(Local_154.f_0, 0, 0);
					unk_0x35B958B469415A23(uLocal_363, 0);
					iLocal_379 = 1;
				}
			}
		}
		else if (unk_0xDD7720E17AF5FE17(uLocal_372) && unk_0xF855C83E3A17514B(uLocal_372) >= 0.323f)
		{
			if (!iLocal_375)
			{
				unk_0x5507A18216809420("scr_extrm4_water_splash", 1655.27f, -20.8134f, 133.841f, 0f, 0f, 0f, 1f, 0, 0, 0);
				unk_0x2C26CC9D8750362C(1f);
				func_232();
				iLocal_375 = 1;
			}
			else if (!iLocal_381)
			{
				if (unk_0xDD7720E17AF5FE17(uLocal_372) && unk_0xF855C83E3A17514B(uLocal_372) >= 0.44f)
				{
					uLocal_179 = unk_0xBCBFC611FE1A1291("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
					unk_0x88E12E71CBC65E59(uLocal_179, 1f);
					iLocal_381 = 1;
				}
			}
		}
		if (unk_0x48E480685981C7D4() > iLocal_373 + 600 && fVar1 == 1f)
		{
			if (!iLocal_376)
			{
				iLocal_376 = 1;
		...
		fVar2 = (1f / 30f);
		fVar3 = (unk_0x8D51D24D214E2FF2() / fVar2);
		if (unk_0x48E480685981C7D4() > iLocal_373 + 630)
		{
		...
		if (unk_0x48E480685981C7D4() > iLocal_373 + 563)
		{
			if (iVar0 == 1)
			{
				func_3(&uLocal_174);
		...
		if (unk_0x48E480685981C7D4() > iLocal_373 + 871)
		{
			if (iVar0 == 2)
			{
				if (func_308(Local_154.f_0))
		...
		if (unk_0x48E480685981C7D4() > iLocal_373 + 2000)
		{
			if (iVar0 == 3)
			{
				if (func_308(Local_154.f_0))
		...
		if (unk_0x48E480685981C7D4() > iLocal_373 + 3500)
		{
			if (iVar0 == 4)
			{
				iVar0 = 5;
		...
		if (unk_0x48E480685981C7D4() > iLocal_373 + 10000)
		{
			if (iVar0 != 7)
			{
				unk_0x35B958B469415A23(uLocal_364, 0);
				uLocal_361 = unk_0xAAC4D4F273757469("DEFAULT_SCRIPTED_CAMERA", 1);
				unk_0xD269CB43D12C6BF5(uLocal_361, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
				unk_0xFEBF3DDE5E4DC5C5(1, 0, 3000, 1, 0, 0);
				unk_0xDD0B0D77CB8995B1(uLocal_361, 1);
				iVar0 = 7;
			}
		}
	}
	if (bLocal_380)
	{
		if (unk_0xDD7720E17AF5FE17(uLocal_372))
		{
			unk_0xFE6070EA9CB4C319(uLocal_372);
		}
		unk_0x9CEDFD70C55A7F8F("EXT4_JUMPED_OS");
		func_232();
		uLocal_361 = unk_0xAAC4D4F273757469("DEFAULT_SCRIPTED_CAMERA", 1);
		unk_0xD269CB43D12C6BF5(uLocal_361, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
		unk_0xFEBF3DDE5E4DC5C5(1, 0, 3000, 1, 0, 0);
	...
	unk_0xA1A8FFBCDA61AC40("SLOWMO_EXTREME_04");
	func_3(&uLocal_174);
	if (func_308(Local_154.f_0))
	{
		if (iVar0 < 3)
		{
			unk_0x9765BF567DB87B5F(Local_154.f_0, 101);
			Var4 = { unk_0xB6AE0DAE06D56288(Local_154.f_0, 1) };
			if (Var4.f_2 > 155f)
			{
				fVar7 = 155f;
			}
			...
			unk_0xB067093BBAF0A747(Local_154.f_0, 1657.046f, -17.4571f, fVar7, 1, 0, 0, 1);
		}
	}
	...
	unk_0xF1BC58601CA4A5C7(1);
	unk_0x3BF4F473786B0150(1);
	unk_0x034205BA180B4E43(unk_0x1329891157A54C63(), true, 128);
	unk_0xCF2F32222FF93448(1f);
	if (func_221(Local_154.f_0))
	{
		if (unk_0xDD7720E17AF5FE17(uLocal_372))
		{
			unk_0x176AAFA85E979842(uLocal_372, 1f);
		}
		unk_0x1E2B48EE3EC55DCF(Local_154.f_0);
		unk_0x95BE9BA77CA91710(Local_154.f_0, 0, 0);
		unk_0xB067093BBAF0A747(Local_154.f_0, 1655.77f, -20.04f, 135.8f, 1, 0, 0, 1);
		unk_0x9765BF567DB87B5F(Local_154.f_0, 0);
	}
	func_223(&uLocal_181, 1, unk_0x81873881071CD9FE(), "FRANKLIN", 0, 1);
	func_209(&uLocal_181, "EXT4AUD", "EXT4_DUMB", 7, 0, 0, 0);
}
...
void func_225(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (!unk_0x5FEB513A4402FD59(unk_0x81873881071CD9FE()) && !func_226(unk_0x1329891157A54C63()))
		{
...
void func_237()
{
	if (iLocal_148 < 2)
	{
		unk_0xA3BC6AA446F03669("EXT4_JUMPED_OS");
	}
	switch (iLocal_148)
	{
		case 0:
			iLocal_150 = 0;
			if (unk_0xD1FFD959917D4ED8(unk_0x81873881071CD9FE(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, 0, 1, 0))
			{
				unk_0xA9F0B166E9ABE875("es_4_rcm_p2_concat", 6, 8);
			}
			else
			{
				unk_0xA9F0B166E9ABE875("es_4_rcm_p2_concat", 5, 8);
			}
			unk_0x98A5E5B909F1B162(uLocal_366);
			if (unk_0xFE489BA9CA22B147())
			{
				unk_0x4A379EBEE935C3A0("Dom", 8, 2, 0, 0);
			}
			if (!func_257())
			{
				if (func_252(1, 20f, 1))
				{
					if ((!iLocal_382 || unk_0x48E480685981C7D4() > iLocal_383 + 3000) || unk_0x515B65C19A5CA9B1(unk_0x81873881071CD9FE(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0))
					{
						unk_0xE8F8B47D8785FAD4(1);
						unk_0x5632EA201EAF956B(2048);
						if (func_308(Local_154.f_0))
						{
							unk_0x991ABCA492D8C897(Local_154.f_0, "Dom", 0, joaat("cs_dom"), 0);
						}
						unk_0x4EDE34FBADD967A6(0);
						iLocal_382 = 0;
						unk_0x59E3A6BEFC421137(0);
						unk_0xF2A6D4C99549CA85("EXTREME_04_CUSTOM_QUIET_SCENE");
						if (func_308(Local_154.f_0))
						{
							unk_0xA8F22633ACC22189(Local_154.f_0, 0);
						}
						if (unk_0x86CCCD2FAE9D5E65(iLocal_178) && !unk_0x930F8FBB8E9537CC(iLocal_178))
						{
							unk_0xABA9860C0161F3CD(iLocal_178, 0);
						}
						if (unk_0xE5AB05962FA1FF3F(unk_0x81873881071CD9FE(), 0))
						{
							iLocal_171 = unk_0xE68E6B44DABA9C05(unk_0x81873881071CD9FE(), 0);
							iLocal_180 = unk_0x14B7103DBD149FFE(iLocal_171);
							if (unk_0x61A26017817C6AED(iLocal_180) == 1 || unk_0xC5ABD699DDC9D5A0(iLocal_180) == 1)
							{
							...
							func_243(1654.721f, 4.166876f, 172.5245f, 1662.562f, -8.920052f, 178.2742f, 6.25f, Local_347, fLocal_350, 1, 1, 1, 0, 0);
						}
						else
						{
							Local_347 = { 1649.793f, 11.7826f, 172.7745f };
							fLocal_350 = 220.9923f;
							func_242(Local_347, fLocal_350);
						}
						func_239(1660.186f, -7.492f, 172.774f, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1);
						unk_0x984F8E3A66FFFEE5(1660.186f, -7.492f, 172.774f, 200f, 0);
						uLocal_365 = unk_0x13705C66F125D98D(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
						iLocal_148 = 1;
					}
				}
			}
		...
		case 1:
			if (unk_0x521385D8214D27C4())
			{
				if (unk_0x1787C7476F17BD5C(0))
				{
					if (!iLocal_153)
					{
						if (!unk_0xDD7720E17AF5FE17(uLocal_370))
						{
							if (func_308(Local_154.f_0))
							{
								if (!unk_0x42E36F2D658EB2FF(uLocal_362))
								{
									uLocal_362 = unk_0xAAC4D4F273757469("DEFAULT_ANIMATED_CAMERA", 1);
								}
								unk_0xDD0B0D77CB8995B1(uLocal_362, 1);
								unk_0xFEBF3DDE5E4DC5C5(1, 0, 3000, 1, 0, 0);
								uLocal_370 = unk_0x59C061A719024602(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
								unk_0x58BEA8B2364F8C48(Local_154.f_0, uLocal_370, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
								unk_0xC64A07C5C44EA267(uLocal_370, 1);
								unk_0xDD0B0D77CB8995B1(uLocal_362, 1);
								unk_0xC813152833B59518(uLocal_362, uLocal_370, "Base_Jump_Spot_CAM", "rcmextreme4");
								unk_0xFEBF3DDE5E4DC5C5(1, 0, 3000, 1, 0, 0);
								unk_0x95BE9BA77CA91710(Local_154.f_0, 0, 0);
								iLocal_153 = 1;
							}
				...
				if (func_308(Local_154.f_0))
				{
					if (unk_0x673E6879232705DA("Dom", 0))
					{
						iLocal_148 = 2;
					}
				}
		...
		case 2:
			...
			if (unk_0x86CCCD2FAE9D5E65(iLocal_178) && !unk_0x930F8FBB8E9537CC(iLocal_178))
			{
				unk_0xABA9860C0161F3CD(iLocal_178, 1);
			}
			if (iLocal_150 == 0)
			{
				unk_0x80650551CC58C784("EXT4_JUMPED_OS");
				func_238(3);
			}
			break;
	}
...
void func_239(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0x7DF7DE8C76D7F346(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x984F8E3A66FFFEE5(func_240(unk_0xEC537F0C0E8265EE()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_242(struct<3> Param0, float fParam3)
{
	...
	if (!unk_0x5FEB513A4402FD59(unk_0x81873881071CD9FE()))
	{
		...
		if (unk_0x86CCCD2FAE9D5E65(iVar0))
		{
			...
			{
				unk_0xB067093BBAF0A747(iVar0, Param0, 1, 0, 0, 1);
				unk_0xC24172029826A66F(iVar0, fParam3);
...
int func_252(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0xE5AB05962FA1FF3F(unk_0x81873881071CD9FE(), 0))
	{
		...
		{
			if (!func_256(unk_0xE68E6B44DABA9C05(unk_0x81873881071CD9FE(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_255(unk_0x81873881071CD9FE(), -828834893))
				{
...
void func_258()
{
	if (!unk_0x5FEB513A4402FD59(unk_0x81873881071CD9FE()))
	{
		...
		{
			if (((((((unk_0xCAD9951C953F5B2D(0, 30) || unk_0xCAD9951C953F5B2D(0, 31)) || unk_0xCAD9951C953F5B2D(0, 23)) || unk_0xCAD9951C953F5B2D(0, 21)) || unk_0xCAD9951C953F5B2D(0, 22)) || (func_270() && unk_0xCAD9951C953F5B2D(0, 1))) || (func_270() && unk_0xCAD9951C953F5B2D(0, 2))) || (func_270() && unk_0xCAD9951C953F5B2D(0, 32)))
			{
	...
	{
		case 0:
			if (func_308(Local_81.f_28[0]))
			{
				unk_0x4B9FA68A3AC8C29D(Local_81.f_28[0], 17, 1);
			}
			iLocal_367 = 0;
			iLocal_382 = 1;
			func_269("EXT4_01", 7500, 1);
			uLocal_169 = func_268(Local_154.f_0, 1, 1, 5);
			unk_0xC1B1E9A034A63A62(0);
			iLocal_148 = 1;
			break;
		...
		case 1:
			...
			if (func_308(unk_0x81873881071CD9FE()))
			{
				if (func_308(Local_154.f_0))
				{
					if (func_307(unk_0x81873881071CD9FE(), Local_154.f_0, 100f))
					{
						unk_0xA9F0B166E9ABE875("es_4_rcm_p2_concat", 6, 8);
						if (unk_0xFE489BA9CA22B147())
						{
					...
					if (unk_0xD81BC0FD4D47CC04(Local_154.f_0))
					{
						unk_0x9765BF567DB87B5F(Local_154.f_0, 0);
					}
					if (func_307(unk_0x81873881071CD9FE(), Local_154.f_0, 32f))
					{
						if (func_262(Local_154.f_0, 1, 0, 0, 0))
						{
							if (iLocal_168 == 0)
							{
								if (!func_257())
								{
									func_261(&uLocal_181, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_1", 7, 0, 0);
									iLocal_168 = 1;
								}
							}
							else if (iLocal_168 == 1)
							{
								if (!func_257())
								{
									func_261(&uLocal_181, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_2", 7, 0, 0);
									iLocal_168 = 2;
								}
							}
						}
						else
						{
							if (!iLocal_377)
							{
								if (func_307(unk_0x81873881071CD9FE(), Local_154.f_0, 30f) && !func_257())
								{
									if (func_209(&uLocal_181, "EXT4AUD", "EXT4_COMM", 7, 0, 0, 0))
									{
										iLocal_377 = 1;
									}
								}
							...
							func_260();
							if (!unk_0xD6A9D2FC007C67B9(unk_0x81873881071CD9FE(), Local_154.f_0))
							{
								unk_0xAF625598EDA64AD3(unk_0x81873881071CD9FE(), Local_154.f_0, -1, 0, 2);
							}
						}
					}
					if (unk_0xD1FFD959917D4ED8(unk_0x81873881071CD9FE(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, 0, 1, 0))
					{
						if (!unk_0xE5AB05962FA1FF3F(unk_0x81873881071CD9FE(), 0))
						{
							iLocal_148 = 2;
		...
		case 2:
			...
			if (func_308(unk_0x81873881071CD9FE()))
			{
				if (unk_0xE5AB05962FA1FF3F(unk_0x81873881071CD9FE(), 0))
				{
					unk_0xE4DF2496E641851E(unk_0xE68E6B44DABA9C05(unk_0x81873881071CD9FE(), 0), 5f, 1, 0);
...
void func_259()
{
	if (func_308(Local_154.f_0))
	{
		if (unk_0xFA1212DE7C455679(Local_154.f_0, 242628503) != 1)
		{
			unk_0xC65002CAA1212AF9(Local_154.f_0, uLocal_170);
		}
	}
}
...
void func_260()
{
	if (!func_257())
	{
		if (iLocal_367 < 5)
		{
			if (unk_0x48E480685981C7D4() > (iLocal_368 + (8000 + unk_0x2E0A9E3291F398E3(0, 2000))))
			{
				if (unk_0xBDC7EB9D855C9610(uLocal_366))
				{
					if (func_209(&uLocal_181, "EXT4AUD", "EXT4_DOM", 6, 0, 0, 0))
					{
	...
	if (!func_257())
	{
		if ((unk_0x9D2B95F4020E5347("EXTREME_04_DOM_A", 0) && unk_0x9D2B95F4020E5347("EXTREME_04_DOM_B", 0)) && unk_0x9D2B95F4020E5347("EXTREME_04_DOM_C", 0))
		{
			if (unk_0xBDC7EB9D855C9610(uLocal_366))
			{
				unk_0x058526005957A956(uLocal_366, "DOM", Local_154.f_0, "EXTREME_04_SOUNDSET", 0, 0);
			}
		}
	}
}
...
int func_265(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_250(Param1 - unk_0xB6AE0DAE06D56288(iParam0, 1)) };
	...
	{
		Var3 = { func_250(unk_0xC91EFAB304EB7DE6(iParam0, 31086, 0f, 5f, 0f) - unk_0xC91EFAB304EB7DE6(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_271()
{
	...
	else
	{
		...
		unk_0xD91194CE3D1E1D77(unk_0x81873881071CD9FE(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
		func_236(800, 0);
		iLocal_151 = 1;
		func_278(1, 1, 1);
	}
...
void func_272()
{
	...
	{
		func_276(Local_81.f_28[0], 1737.453f, 101.7498f, 170.0243f, 288.5211f, 0, 1);
	}
	else
	{
		func_273(&(Local_81.f_28[0]), 1737.453f, 101.7498f, 170.0243f, 288.5211f);
	}
	unk_0xD91194CE3D1E1D77(Local_81.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 0.25f, 0, 40000f);
	unk_0xC904C30D9B70F037("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 0);
	unk_0xA450601E968044DB(Local_154.f_1, 20f, 0, 0, 0, 0, 0);
	if (!unk_0x86CCCD2FAE9D5E65(iLocal_172))
	{
		iLocal_172 = unk_0xE00F8DEA9778FC87(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, 1, 1);
	}
	if (!unk_0x86CCCD2FAE9D5E65(iLocal_173))
	{
		iLocal_173 = unk_0xE00F8DEA9778FC87(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, 1, 1);
	}
	if (!unk_0x86CCCD2FAE9D5E65(iLocal_175))
	{
		iLocal_175 = unk_0xF364195A57BB7AE3(joaat("prop_box_wood01a"), 1666.282f, -11.20408f, 172.7773f, 1, 1, 0);
		unk_0x3A45EB0810EBE71C(iLocal_175, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!unk_0x86CCCD2FAE9D5E65(iLocal_176))
	{
		iLocal_176 = unk_0xF364195A57BB7AE3(joaat("prop_box_wood01a"), 1667.076f, -12.07778f, 173.2611f, 1, 1, 0);
		unk_0x3A45EB0810EBE71C(iLocal_176, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_308(Local_154.f_0))
	{
		if (unk_0xFA1212DE7C455679(Local_154.f_0, 242628503) != 1)
		{
			unk_0xEAD984C2869B8B7C(&uLocal_170);
			unk_0x31C1393E4ACFD794(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x31C1393E4ACFD794(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x31C1393E4ACFD794(0, "rcmextreme4", "fidget_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x31C1393E4ACFD794(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x31C1393E4ACFD794(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x31C1393E4ACFD794(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x31C1393E4ACFD794(0, "rcmextreme4", "fidget_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x52AF899C680AA5D4(uLocal_170, 1);
			unk_0x56D9ED1541046AF6(uLocal_170);
			unk_0xC65002CAA1212AF9(Local_154.f_0, uLocal_170);
		}
	}
	if (func_308(Local_154.f_0))
	{
		unk_0x2644F84BE1F3524B(Local_154.f_0, 0);
		func_223(&uLocal_181, 4, Local_154.f_0, "DOM", 0, 1);
		unk_0x506A601663C5417C(Local_154.f_0, unk_0x88594869E178AFA2(unk_0x81873881071CD9FE()));
	}
	if (!unk_0x86CCCD2FAE9D5E65(iLocal_178))
	{
		iLocal_178 = unk_0x8C3ADD3E5B9DE90B(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
	}
	unk_0x3A45EB0810EBE71C(iLocal_178, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	unk_0x72C254C049438316(iLocal_178, "Chute_Off_Bag", "skydive@parachute@", 4f, 0, 1, 0, 0.99f, 0);
	func_238(1);
}

void func_273(var uParam0, struct<3> Param1, float fParam4)
{
	func_274(uParam0, iLocal_80, Param1, fParam4, 26);
...
void func_282()
{
	switch (iLocal_149)
	{
		case 0:
			...
			{
				if (!iLocal_382 || unk_0x48E480685981C7D4() > iLocal_383 + 3500)
				{
					func_283();
					unk_0xE8F8B47D8785FAD4(1);
					...
					if (func_221(Local_81.f_28[0]))
					{
						unk_0x991ABCA492D8C897(Local_81.f_28[0], "Hudson", 0, joaat("a_c_retriever"), 0);
					}
					unk_0x4EDE34FBADD967A6(0);
					unk_0x59E3A6BEFC421137(0);
		...
		case 2:
			func_276(unk_0x81873881071CD9FE(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			unk_0x03EB8112BA30917C(unk_0x81873881071CD9FE(), joaat("MotionState_Walk"), 0, 1, 0);
			unk_0x3776159AF6933ED3(unk_0x81873881071CD9FE(), 1f);
			unk_0xD91194CE3D1E1D77(unk_0x81873881071CD9FE(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
			unk_0xEAB527164AD92BF3(0f, 1065353216);
...
int func_284(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0xE5AB05962FA1FF3F(unk_0x81873881071CD9FE(), 0))
	{
		if ((!unk_0xF8F0C55E476A5A81(unk_0x81873881071CD9FE()) && !unk_0x042BDEC3DAAA336A(unk_0x81873881071CD9FE())) && !unk_0x25B75802E65C5545(unk_0x81873881071CD9FE()))
		{
			if (!func_256(unk_0xE68E6B44DABA9C05(unk_0x81873881071CD9FE(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_287()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_321() && func_308(Local_81.f_28[0])) && func_308(unk_0x81873881071CD9FE())) && iLocal_382 == 1)
	{
		if (!unk_0xCA020F3125A93EB9())
		{
			unk_0x034205BA180B4E43(unk_0x1329891157A54C63(), false, 0);
			unk_0xAF625598EDA64AD3(unk_0x81873881071CD9FE(), Local_81.f_28[0], -1, 0, 2);
			unk_0x874614DC82BB9C8A(unk_0x81873881071CD9FE(), Local_81.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
			unk_0x14D4D383767CAD59(1);
			unk_0xA9076AE35130AE29(Local_81.f_28[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, 0);
			unk_0x7847D611294B8B1E(fVar0);
			unk_0xEAAF5FE5FD8EA573(fVar1);
			unk_0x90BAA3C579857A9F(fVar2);
			unk_0x624A5C79ECF3209C(fVar3);
			unk_0x924CFBAB178D48E9(fVar4);
			iLocal_383 = unk_0x48E480685981C7D4();
		}
		else
		{
			if (func_307(unk_0x81873881071CD9FE(), Local_81.f_28[0], 4f))
			{
...
void func_288()
{
	...
	if (iLocal_382)
	{
		if (!unk_0xCA020F3125A93EB9())
		{
			unk_0x034205BA180B4E43(unk_0x1329891157A54C63(), false, 0);
			unk_0xAF625598EDA64AD3(unk_0x81873881071CD9FE(), Local_154.f_0, -1, 0, 2);
			unk_0xD91194CE3D1E1D77(unk_0x81873881071CD9FE(), 1658.95f, -5.45f, 173.78f, 1f, -1, 0.25f, 0, -161.08f);
			unk_0x14D4D383767CAD59(1);
			unk_0xA9076AE35130AE29(Local_154.f_0, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
			unk_0x7847D611294B8B1E(fVar0);
			unk_0xEAAF5FE5FD8EA573(fVar1);
			unk_0x90BAA3C579857A9F(fVar2);
			unk_0x624A5C79ECF3209C(fVar3);
...
void func_289()
{
	...
	if (iLocal_147 == 1)
	{
		...
		{
			fVar0 = unk_0x0D6E79537424BACE(unk_0xB6AE0DAE06D56288(unk_0x81873881071CD9FE(), 1), unk_0xB6AE0DAE06D56288(Local_154.f_0, 1), 1);
			if (iLocal_152 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			if (fVar0 > 150f)
			{
				if (unk_0xFBACB273AA628CC5(uLocal_169))
				{
					unk_0x20F5C387A2DC0C80(uLocal_169, 1);
				}
			}
			else if (unk_0xFBACB273AA628CC5(uLocal_169))
			{
				unk_0x20F5C387A2DC0C80(uLocal_169, 0);
			}
		}
		if (unk_0xD1FFD959917D4ED8(unk_0x81873881071CD9FE(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, 0, 1, 0))
		{
			sLocal_167 = "EXT4_F2";
			iLocal_147 = 4;
		}
	...
	if (Global_69274 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x29AFA2493D7C23D0())
			{
				...
				Var4 = { func_292(Global_69275, Global_69277, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_304(0) || Global_69289) || Global_69278 == 1) || !unk_0xECDEA377354CBDA4())
	{
		return 0;
	}
	switch (Global_69274)
	{
		...
		case 5:
			if ((unk_0x521385D8214D27C4() || func_303(0)) || func_302(1))
			{
			}
			else
			{
...
{
	return func_306(iParam0, Global_35443);
}
...
void func_309()
{
	...
	Local_154.f_5 = func_361(52);
	Local_154.f_9 = { 1660.324f, -11.7125f, 173.9638f };
	Local_154.f_12 = 119.6007f;
	unk_0x86B83C54AF71BD12("EXT4", 0);
	while (!unk_0xCD8DA898314F3016(0))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	unk_0x32A12757CBF48A33(joaat("prop_box_guncase_03a"));
	unk_0x32A12757CBF48A33(joaat("prop_box_wood01a"));
	unk_0x32A12757CBF48A33(joaat("p_parachute_s"));
	unk_0x32A12757CBF48A33(joaat("bmx"));
	while (((!unk_0x33ACB874CECA2D4B(joaat("prop_box_guncase_03a")) || !unk_0x33ACB874CECA2D4B(joaat("prop_box_wood01a"))) || !unk_0x33ACB874CECA2D4B(joaat("p_parachute_s"))) || !unk_0x33ACB874CECA2D4B(joaat("bmx")))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0x86CCCD2FAE9D5E65(uLocal_174))
	{
		iLocal_174 = unk_0x530605DB2F32365F(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, 1, 1, 0);
		unk_0x3A45EB0810EBE71C(iLocal_174, 90f, 0f, -63f, 2, 1);
		unk_0xA8F22633ACC22189(iLocal_174, 1);
		unk_0xABA9860C0161F3CD(iLocal_174, 0);
	}
	func_313(1);
	if (!unk_0x86CCCD2FAE9D5E65(Local_154.f_0))
	{
		func_310(&Local_154, 52, Local_154.f_1, Local_154.f_4, "Ext4-Dom", 1);
		unk_0xA8F22633ACC22189(Local_154.f_0, 1);
		unk_0x1D15D99A10A15334(Local_154.f_0, 1);
		unk_0xA7149121C1FEA65B(Local_154.f_0, 1);
		unk_0x03F73D35E5AC583A(Local_154.f_0, 8, 2, 0, 0);
		unk_0x7FF6BAAA4631F943(Local_154.f_0, 1);
		unk_0xCE566DBDCACD245E(Local_154.f_0, 137, 1);
		unk_0xCE566DBDCACD245E(Local_154.f_0, 118, 0);
		unk_0xCE566DBDCACD245E(Local_154.f_0, 208, 1);
		unk_0x0CD6B65135C8C3FE(Local_154.f_0, 5000);
	}
	if (func_221(unk_0x81873881071CD9FE()))
	{
		func_223(&uLocal_181, 1, unk_0x81873881071CD9FE(), "FRANKLIN", 0, 1);
...
{
	unk_0x32A12757CBF48A33(Local_154.f_5);
	unk_0x295DC04FC13E025B("rcmextreme4");
	unk_0x295DC04FC13E025B("skydive@parachute@");
	unk_0x32A12757CBF48A33(joaat("sanchez"));
	unk_0x18C8823792832C78();
	if (iParam0 == 1)
	{
		while ((((!unk_0x33ACB874CECA2D4B(Local_154.f_5) || !unk_0x33ACB874CECA2D4B(joaat("sanchez"))) || !unk_0x8E8B546E1A81D27F("rcmextreme4")) || !unk_0x8E8B546E1A81D27F("skydive@parachute@")) || !unk_0x7A74065A1435C8AB())
		{
			unk_0x4EDE34FBADD967A6(0);
		}
	}
...
void func_322(int iParam0)
{
	...
	func_334(&iLocal_175, 0);
	func_334(&iLocal_176, 0);
	func_334(&iLocal_177, 0);
	unk_0xC904C30D9B70F037("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 1);
	func_323(&Local_81, 1, 0, 0);
...
{
	func_323(&Local_81, 1, 0, 0);
	func_333(&(Local_81.f_28[0]), 1, 0, 1);
	unk_0xD8323B49BAE93D80("rcmextreme4");
}
...
void func_337(bool bParam0)
{
	...
	if (!func_356())
	{
		...
		{
			func_165(iVar0, 1, 0);
			func_338(unk_0x11CA2334E341B424(), iVar0);
		}
		else
		{
			if (Global_98018[iVar0 /*10*/].f_9 == -1)
...
int func_339(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_345())
	{
		...
		{
			iVar33 = func_340(unk_0x11CA2334E341B424());
			if (iVar33 > -1)
			{
...
int func_345()
{
	...
	{
		if (func_340(&(Global_90809.f_3)) > -1)
		{
			return 1;
		}
	}
