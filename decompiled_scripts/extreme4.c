...
void __EntryFunction__()
{
	...
	uLocal_367 = unk_0x9FF6FFD9EB30D086();
	...
	if (unk_0x2137828D03306CAF(iLocal_179))
	{
	}
	func_312();
	if (!func_324())
	{
		if ((func_311(Local_82.f_28[0]) && func_311(unk_0x2A5EB8B0FE590B91())) && !func_310(unk_0x2A5EB8B0FE590B91(), Local_82.f_28[0], 4f, 1))
		{
			iLocal_383 = 1;
		}
	}
	while (true)
	{
		...
		unk_0xE57EE82872DC7A9F("SF_UR", 0);
		...
		{
			if (func_311(unk_0x2A5EB8B0FE590B91()) && unk_0x9A46207BB68ED2F0(unk_0x2A5EB8B0FE590B91(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, 1, 0))
			{
				if (func_311(Local_155.f_0))
				{
					if (func_310(unk_0x2A5EB8B0FE590B91(), Local_155.f_0, 10f, 1))
					{
						func_291();
					}
				}
...
void func_1()
{
	switch (iLocal_147)
	{
		case 0:
			...
			if (unk_0x58478145CAF8429C(sLocal_168))
			{
				func_340(1);
			}
			else
...
void func_8()
{
	switch (iLocal_149)
	{
		...
		case 1:
			if (unk_0x2137828D03306CAF(iLocal_178))
			{
				if (!unk_0xA9A04898798AE9E6(iLocal_178, 0))
				{
					if (func_310(unk_0x2A5EB8B0FE590B91(), iLocal_178, 1f, 1))
					{
						unk_0x0013D519C885E60B(unk_0x2A5EB8B0FE590B91(), joaat("gadget_parachute"), 1, 0, 0);
						unk_0xBE35B7268C680A20(&iLocal_178);
					}
				}
			}
			if (iLocal_347 == 0)
			...
			if (func_311(unk_0x2A5EB8B0FE590B91()))
			{
				if (iLocal_375 == 0)
				{
					if (unk_0x9A46207BB68ED2F0(unk_0x2A5EB8B0FE590B91(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, 0, 1, 0) && unk_0xE17D97D6D348472B(unk_0x2A5EB8B0FE590B91()) == 2)
					{
						iLocal_375 = 1;
					}
				}
				if (func_222(Local_155.f_0))
				{
					...
					{
						if ((unk_0x3732B96D7A1859B4() > iLocal_370 + 25000 || unk_0x9A46207BB68ED2F0(unk_0x2A5EB8B0FE590B91(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || unk_0x9A46207BB68ED2F0(unk_0x2A5EB8B0FE590B91(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
						{
							iLocal_149 = 2;
						}
					}
				}
				else if ((unk_0x3732B96D7A1859B4() > iLocal_370 + 25000 || unk_0x9A46207BB68ED2F0(unk_0x2A5EB8B0FE590B91(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || unk_0x9A46207BB68ED2F0(unk_0x2A5EB8B0FE590B91(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
				{
					iLocal_149 = 2;
				}
			}
			if (unk_0x3732B96D7A1859B4() < iLocal_370 + 5000)
			{
				if (unk_0x211BAFB9C9DDEA2C())
				{
		...
		case 2:
			if (((!unk_0x4A9CF3B18638900F(unk_0x2A5EB8B0FE590B91()) && !unk_0x7D8FA69AD9D01A2B(unk_0x2A5EB8B0FE590B91())) && unk_0x3C59D102BD975DAD(unk_0x2A5EB8B0FE590B91()) < 2f) && !unk_0x62F5757271CA0B05(unk_0x2A5EB8B0FE590B91()))
			{
...
void func_9()
{
	if (iLocal_375 == 1)
	{
		unk_0x27D0C73ADD305F3C(10f, 4f, 0);
		func_209(762);
	}
	func_2(1);
	func_10(84, 1);
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_77(func_96(iParam1, uParam0->f_2), Global_69618, 0);
			if (unk_0xAA4F14DA15DB0B51(uVar0, uParam0->f_1))
			{
				unk_0xF6082E2ADA1C795B(&(uParam0->f_6), 1);
			}
			uVar0 = func_77(func_95(iParam1, uParam0->f_2), Global_69618, 0);
			if (unk_0xAA4F14DA15DB0B51(uVar0, uParam0->f_1))
			{
				unk_0xF6082E2ADA1C795B(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_77(iVar1, Global_69618, 0);
				if (!unk_0xAA4F14DA15DB0B51(uVar0, uParam0->f_1))
				{
					unk_0xF6082E2ADA1C795B(&(uParam0->f_6), 4);
				}
...
void func_223()
{
	...
	if (!unk_0x9FA769EB6C3BCCE4(uLocal_352))
	{
	}
	if (!unk_0x9FA769EB6C3BCCE4(uLocal_353))
	{
	}
	if (!unk_0x9FA769EB6C3BCCE4(uLocal_354))
	{
	}
	if (!unk_0x9FA769EB6C3BCCE4(uLocal_355))
	{
	}
	if (!unk_0x9FA769EB6C3BCCE4(uLocal_356))
	{
	}
	if (!unk_0x9FA769EB6C3BCCE4(uLocal_357))
	{
	}
	...
	if (!unk_0x9FA769EB6C3BCCE4(uLocal_360))
	{
	}
	if (!unk_0x9FA769EB6C3BCCE4(uLocal_361))
	{
	}
	if (!unk_0x9FA769EB6C3BCCE4(uLocal_362))
	{
	}
	unk_0x27EB3C87BA9CA1FD(fVar1);
	unk_0xDA0C5084402DA99C(0);
	unk_0xA6C8C7573424CA93(0);
	unk_0x73EC54DB6766EF37(unk_0x0FFED3E94261A832(), false, 128);
	unk_0x40F160C3038ECAF5("EXTREME_04_CUSTOM_QUIET_SCENE");
	func_238(800, 0);
	iLocal_376 = 0;
	iLocal_377 = 0;
	iLocal_379 = 0;
	...
	iLocal_377 = 0;
	iLocal_382 = 0;
	unk_0x25E9076ADC15BB09("SLOWMO_EXTREME_04");
	unk_0x4BFEFCE41695E744(0);
	while (unk_0x3732B96D7A1859B4() < iLocal_374 + 11000 && !unk_0xF4EE9D6C8E60AE22())
	{
		if (!unk_0x354ACA1BAED67927(uLocal_371) && !unk_0x354ACA1BAED67927(uLocal_372))
		{
			if (func_236(400))
			{
				bLocal_381 = true;
		...
		if (!iLocal_379)
		{
			if (unk_0x354ACA1BAED67927(uLocal_371))
			{
				if (unk_0x58DF249E321EAB8E(uLocal_371) == 1f)
				{
					if (func_311(Local_155.f_0))
					{
						uLocal_372 = unk_0x6D46C949A32B8D73(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
						uLocal_364 = unk_0x1FF428E592B6F928("DEFAULT_ANIMATED_CAMERA", 1);
						unk_0x5F778B8D6D7DF47B(Local_155.f_0, uLocal_372, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						unk_0xEE68E88B8F41075D(uLocal_372, 0);
						unk_0xD429163073BD3A47(uLocal_364, 1);
						unk_0x70D9DCACEFF60406(uLocal_364, uLocal_372, "Base_Jump_Spot_02_CAM", "rcmextreme4");
						unk_0xB9658EBA374EC2AD(1, 0, 3000, 1, 0, 0);
						unk_0xB1D181DBFC526F52(Local_155.f_0, 0, 0);
						unk_0x1E2E6AAAD9AE1286(uLocal_363, 0);
						iLocal_379 = 1;
					}
				}
			}
		...
		{
			if (unk_0x354ACA1BAED67927(uLocal_372) && unk_0x58DF249E321EAB8E(uLocal_372) >= 0.2f)
			{
				if (!unk_0x354ACA1BAED67927(uLocal_373))
				{
					unk_0x9B6C1E54A1DEEBFA("RCM_Extreme4_Fall_and_impact", 0);
				}
			}
			if (unk_0x354ACA1BAED67927(uLocal_372) && unk_0x58DF249E321EAB8E(uLocal_372) == 1f)
			{
				if (func_311(Local_155.f_0))
				{
					uLocal_373 = unk_0x6D46C949A32B8D73(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
					uLocal_365 = unk_0x1FF428E592B6F928("DEFAULT_ANIMATED_CAMERA", 1);
					unk_0x5F778B8D6D7DF47B(Local_155.f_0, uLocal_373, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
					unk_0xEE68E88B8F41075D(uLocal_373, 1);
					unk_0xD429163073BD3A47(uLocal_365, 1);
					unk_0x70D9DCACEFF60406(uLocal_365, uLocal_373, "Fall_and_impact_CAM", "rcmextreme4");
					unk_0x40D6B0ECAF43DBF6(uLocal_373);
					unk_0xB9658EBA374EC2AD(1, 0, 3000, 1, 0, 0);
					unk_0xB1D181DBFC526F52(Local_155.f_0, 0, 0);
					unk_0x1E2E6AAAD9AE1286(uLocal_364, 0);
					iLocal_380 = 1;
				}
			}
		}
		else if (unk_0x354ACA1BAED67927(uLocal_373) && unk_0x58DF249E321EAB8E(uLocal_373) >= 0.323f)
		{
			if (!iLocal_376)
			{
				unk_0x0C757274C4CEE111("scr_extrm4_water_splash", 1655.27f, -20.8134f, 133.841f, 0f, 0f, 0f, 1f, 0, 0, 0);
				unk_0x590D9984A142C53B(1f);
				func_234();
				iLocal_376 = 1;
			}
			else if (!iLocal_382)
			{
				if (unk_0x354ACA1BAED67927(uLocal_373) && unk_0x58DF249E321EAB8E(uLocal_373) >= 0.44f)
				{
					uLocal_180 = unk_0x78FD7BAE3324E564("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
					unk_0x9776F2BC240C4ACA(uLocal_180, 1f);
					iLocal_382 = 1;
				}
			}
		}
		if (unk_0x3732B96D7A1859B4() > iLocal_374 + 600 && fVar1 == 1f)
		{
			if (!iLocal_377)
			{
				iLocal_377 = 1;
		...
		fVar2 = (1f / 30f);
		fVar3 = (unk_0xBCA469D44FBFAC80() / fVar2);
		if (unk_0x3732B96D7A1859B4() > iLocal_374 + 630)
		{
		...
		if (unk_0x3732B96D7A1859B4() > iLocal_374 + 563)
		{
			if (iVar0 == 1)
			{
				func_3(&uLocal_175);
		...
		if (unk_0x3732B96D7A1859B4() > iLocal_374 + 871)
		{
			if (iVar0 == 2)
			{
				if (func_311(Local_155.f_0))
		...
		if (unk_0x3732B96D7A1859B4() > iLocal_374 + 2000)
		{
			if (iVar0 == 3)
			{
				if (func_311(Local_155.f_0))
		...
		if (unk_0x3732B96D7A1859B4() > iLocal_374 + 3500)
		{
			if (iVar0 == 4)
			{
				iVar0 = 5;
		...
		if (unk_0x3732B96D7A1859B4() > iLocal_374 + 10000)
		{
			if (iVar0 != 7)
			{
				unk_0x1E2E6AAAD9AE1286(uLocal_365, 0);
				uLocal_362 = unk_0x1FF428E592B6F928("DEFAULT_SCRIPTED_CAMERA", 1);
				unk_0xF3FE3F0E2BC462D7(uLocal_362, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
				unk_0xB9658EBA374EC2AD(1, 0, 3000, 1, 0, 0);
				unk_0xD429163073BD3A47(uLocal_362, 1);
				iVar0 = 7;
			}
		}
	}
	if (bLocal_381)
	{
		if (unk_0x354ACA1BAED67927(uLocal_373))
		{
			unk_0xC617F34F2C882E89(uLocal_373);
		}
		unk_0x15AFDA4756FDF7EC("EXT4_JUMPED_OS");
		func_234();
		uLocal_362 = unk_0x1FF428E592B6F928("DEFAULT_SCRIPTED_CAMERA", 1);
		unk_0xF3FE3F0E2BC462D7(uLocal_362, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
		unk_0xB9658EBA374EC2AD(1, 0, 3000, 1, 0, 0);
	...
	unk_0xA1D08AB9FFF8A22E("SLOWMO_EXTREME_04");
	func_3(&uLocal_175);
	if (func_311(Local_155.f_0))
	{
		if (iVar0 < 3)
		{
			unk_0x67E5DE1657F60AC6(Local_155.f_0, 101);
			Var4 = { unk_0xD1EE0E9FCD74A37B(Local_155.f_0, 1) };
			if (Var4.f_2 > 155f)
			{
				fVar7 = 155f;
			}
			...
			unk_0x8E979F037EACE55A(Local_155.f_0, 1657.046f, -17.4571f, fVar7, 1, 0, 0, 1);
		}
	}
	...
	unk_0xDA0C5084402DA99C(1);
	unk_0xA6C8C7573424CA93(1);
	unk_0x73EC54DB6766EF37(unk_0x0FFED3E94261A832(), true, 128);
	unk_0x27EB3C87BA9CA1FD(1f);
	if (func_222(Local_155.f_0))
	{
		if (unk_0x354ACA1BAED67927(uLocal_373))
		{
			unk_0x7D700F8B84AB6466(uLocal_373, 1f);
		}
		unk_0x5DE3EC94E90BB96F(Local_155.f_0);
		unk_0xB1D181DBFC526F52(Local_155.f_0, 0, 0);
		unk_0x8E979F037EACE55A(Local_155.f_0, 1655.77f, -20.04f, 135.8f, 1, 0, 0, 1);
		unk_0x67E5DE1657F60AC6(Local_155.f_0, 0);
	}
	func_224(&uLocal_182, 1, unk_0x2A5EB8B0FE590B91(), "FRANKLIN", 0, 1);
...
void func_226(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()) && !func_230(unk_0x0FFED3E94261A832())) && !func_228(unk_0x0FFED3E94261A832(), 0)) && !func_227())
			{
				unk_0xF65C7766FB8D4B2C(unk_0x2A5EB8B0FE590B91(), 0);
			}
		}
		else if (!unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()) && !func_230(unk_0x0FFED3E94261A832()))
		{
			unk_0xF65C7766FB8D4B2C(unk_0x2A5EB8B0FE590B91(), 0);
		}
		Global_69798 = 0;
...
void func_239()
{
	if (iLocal_149 < 2)
	{
		unk_0x8CF1128C350F1552("EXT4_JUMPED_OS");
	}
	switch (iLocal_149)
	{
		case 0:
			iLocal_151 = 0;
			if (unk_0x9A46207BB68ED2F0(unk_0x2A5EB8B0FE590B91(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, 0, 1, 0))
			{
				unk_0x8243AC20524825EB("es_4_rcm_p2_concat", 6, 8);
			}
			else
			{
				unk_0x8243AC20524825EB("es_4_rcm_p2_concat", 5, 8);
			}
			unk_0xDC0343058D861402(uLocal_367);
			if (unk_0x4492AAB360D28093())
			{
				unk_0xA73D2885CDC54CCB("Dom", 8, 2, 0, 0);
			}
			if (!func_260())
			{
				if (func_254(1, 20f, 1))
				{
					if ((!iLocal_383 || unk_0x3732B96D7A1859B4() > iLocal_384 + 3000) || unk_0x7DDA81F38FB30F23(unk_0x2A5EB8B0FE590B91(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0))
					{
						unk_0x4BFEFCE41695E744(1);
						unk_0x256CC452D2C1731B(2048);
						if (func_311(Local_155.f_0))
						{
							unk_0x063C67E5BF3D0895(Local_155.f_0, "Dom", 0, joaat("cs_dom"), 0);
						}
						unk_0x4EDE34FBADD967A6(0);
						iLocal_383 = 0;
						unk_0xF01DFB77A6A50908(0);
						unk_0xB0D390F8FEB78903("EXTREME_04_CUSTOM_QUIET_SCENE");
						if (func_311(Local_155.f_0))
						{
							unk_0xA32D9C84C1A93920(Local_155.f_0, 0);
						}
						if (unk_0x2137828D03306CAF(iLocal_179) && !unk_0xA9A04898798AE9E6(iLocal_179, 0))
						{
							unk_0x4C1FCB3943DAF647(iLocal_179, 0, 0);
						}
						if (unk_0xC4A39E4229BD3ABE(unk_0x2A5EB8B0FE590B91(), 0))
						{
							iLocal_172 = unk_0x0C20E539D876C5B3(unk_0x2A5EB8B0FE590B91(), 0);
							iLocal_181 = unk_0xD3B21CE53AA7BE51(iLocal_172);
							if (unk_0x6CB676485E7724F8(iLocal_181) == 1 || unk_0x4BD9974FDDE2D1EC(iLocal_181) == 1)
							{
						...
						unk_0xF128ECFE9D500DA6(1660.186f, -7.492f, 172.774f, 200f, 0);
						uLocal_366 = unk_0x25118499AB6F447B(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
						iLocal_149 = 1;
					}
				}
			}
		...
		case 1:
			if (unk_0x863D84AFAC2AB730())
			{
				if (unk_0x05E45421C17E15FD(0))
				{
					if (!iLocal_154)
					{
						if (!unk_0x354ACA1BAED67927(uLocal_371))
						{
							if (func_311(Local_155.f_0))
							{
								if (!unk_0x9FA769EB6C3BCCE4(uLocal_363))
								{
									uLocal_363 = unk_0x1FF428E592B6F928("DEFAULT_ANIMATED_CAMERA", 1);
								}
								unk_0xD429163073BD3A47(uLocal_363, 1);
								unk_0xB9658EBA374EC2AD(1, 0, 3000, 1, 0, 0);
								uLocal_371 = unk_0x6D46C949A32B8D73(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
								unk_0x5F778B8D6D7DF47B(Local_155.f_0, uLocal_371, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
								unk_0xEE68E88B8F41075D(uLocal_371, 1);
								unk_0xD429163073BD3A47(uLocal_363, 1);
								unk_0x70D9DCACEFF60406(uLocal_363, uLocal_371, "Base_Jump_Spot_CAM", "rcmextreme4");
								unk_0xB9658EBA374EC2AD(1, 0, 3000, 1, 0, 0);
								unk_0xB1D181DBFC526F52(Local_155.f_0, 0, 0);
								iLocal_154 = 1;
							}
				...
				if (func_311(Local_155.f_0))
				{
					if (unk_0x2C290803FEDB1727("Dom", 0))
					{
						iLocal_149 = 2;
					}
				}
		...
		case 2:
			...
			if (unk_0x2137828D03306CAF(iLocal_179) && !unk_0xA9A04898798AE9E6(iLocal_179, 0))
			{
				unk_0x4C1FCB3943DAF647(iLocal_179, 1, 0);
			}
			if (iLocal_151 == 0)
			{
				unk_0x988197573BDAD49A("EXT4_JUMPED_OS");
				func_240(3);
			}
			break;
	}
...
void func_241(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0xB8B285A272E7A79E(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0xF128ECFE9D500DA6(func_242(unk_0x8A41C463063AFC8E()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_244(struct<3> Param0, float fParam3)
{
	...
	if (!unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()))
	{
		...
		if (unk_0x2137828D03306CAF(iVar0))
		{
			...
			{
				unk_0x8E979F037EACE55A(iVar0, Param0, 1, 0, 0, 1);
...
int func_254(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0xC4A39E4229BD3ABE(unk_0x2A5EB8B0FE590B91(), 0))
	{
		...
		{
			if (!func_258(unk_0x0C20E539D876C5B3(unk_0x2A5EB8B0FE590B91(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_257(unk_0x2A5EB8B0FE590B91(), -828834893))
				{
...
void func_261()
{
	if (!unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()))
	{
		...
		{
			if (((((((unk_0x83F6A1E4E653AD75(0, 30) || unk_0x83F6A1E4E653AD75(0, 31)) || unk_0x83F6A1E4E653AD75(0, 23)) || unk_0x83F6A1E4E653AD75(0, 21)) || unk_0x83F6A1E4E653AD75(0, 22)) || (func_273() && unk_0x83F6A1E4E653AD75(0, 1))) || (func_273() && unk_0x83F6A1E4E653AD75(0, 2))) || (func_273() && unk_0x83F6A1E4E653AD75(0, 32)))
			{
	...
	switch (iLocal_149)
	{
		case 0:
			...
			{
				unk_0x89AEA58335779997(Local_82.f_28[0], 17, 1);
			}
			iLocal_368 = 0;
			iLocal_383 = 1;
		...
		case 1:
			...
			if (func_311(unk_0x2A5EB8B0FE590B91()))
			{
				if (func_311(Local_155.f_0))
				{
					if (func_310(unk_0x2A5EB8B0FE590B91(), Local_155.f_0, 100f, 1))
					{
						unk_0x8243AC20524825EB("es_4_rcm_p2_concat", 6, 8);
						if (unk_0x4492AAB360D28093())
						{
					...
					if (unk_0x62F5757271CA0B05(Local_155.f_0))
					{
						unk_0x67E5DE1657F60AC6(Local_155.f_0, 0);
					}
					if (func_310(unk_0x2A5EB8B0FE590B91(), Local_155.f_0, 32f, 1))
					{
						...
						else
						{
							if (!iLocal_378)
							{
								if (func_310(unk_0x2A5EB8B0FE590B91(), Local_155.f_0, 30f, 1) && !func_260())
								{
							...
							func_263();
							if (!unk_0x6E115CCEE961DCCE(unk_0x2A5EB8B0FE590B91(), Local_155.f_0))
							{
								unk_0xEDF42871EAD55C9B(unk_0x2A5EB8B0FE590B91(), Local_155.f_0, -1, 0, 2);
							}
						}
					}
					if (unk_0x9A46207BB68ED2F0(unk_0x2A5EB8B0FE590B91(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, 0, 1, 0))
					{
						if (!unk_0xC4A39E4229BD3ABE(unk_0x2A5EB8B0FE590B91(), 0))
						{
							iLocal_149 = 2;
		...
		case 2:
			...
			if (func_311(unk_0x2A5EB8B0FE590B91()))
			{
				if (unk_0xC4A39E4229BD3ABE(unk_0x2A5EB8B0FE590B91(), 0))
				{
					unk_0x8231579045104F87(unk_0x0C20E539D876C5B3(unk_0x2A5EB8B0FE590B91(), 0), 5f, 1, 0);
...
void func_262()
{
	if (func_311(Local_155.f_0))
	{
		if (unk_0xE897E371352225D5(Local_155.f_0, 242628503) != 1)
		{
			unk_0x234E551BB8E8813B(Local_155.f_0, uLocal_171);
		}
	}
}
...
void func_263()
{
	if (!func_260())
	{
		if (iLocal_368 < 5)
		{
			if (unk_0x3732B96D7A1859B4() > (iLocal_369 + (8000 + unk_0x895FB9FE885E36ED(0, 2000))))
			{
				if (unk_0xBB6A424DD700764B(uLocal_367))
				{
	...
	if (!func_260())
	{
		if ((unk_0x741298E7009A20C9("EXTREME_04_DOM_A", 0, -1) && unk_0x741298E7009A20C9("EXTREME_04_DOM_B", 0, -1)) && unk_0x741298E7009A20C9("EXTREME_04_DOM_C", 0, -1))
		{
			if (unk_0xBB6A424DD700764B(uLocal_367))
			{
				unk_0x853D8B40635017CB(uLocal_367, "DOM", Local_155.f_0, "EXTREME_04_SOUNDSET", 0, 0);
			}
		}
	}
}
...
int func_268(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_252(Param1 - unk_0xD1EE0E9FCD74A37B(iParam0, 1)) };
	...
	{
		Var3 = { func_252(unk_0x585F703DF3E83B6E(iParam0, 31086, 0f, 5f, 0f) - unk_0x585F703DF3E83B6E(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_274()
{
	...
	else
	{
		...
		unk_0x28FB7E63A217D6DE(unk_0x2A5EB8B0FE590B91(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
		func_238(800, 0);
		iLocal_152 = 1;
		func_281(1, 1, 1);
	}
...
void func_275()
{
	...
	unk_0x28FB7E63A217D6DE(Local_82.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 0.25f, 0, 40000f);
	unk_0x10632CBB5FE7F881("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 0);
	unk_0x17F1CA1754EDB8DB(Local_155.f_1, 20f, 0, 0, 0, 0, 0);
	if (!unk_0x2137828D03306CAF(iLocal_173))
	{
		iLocal_173 = unk_0xE42A511281C9895B(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, 1, 1, 0);
	}
	if (!unk_0x2137828D03306CAF(iLocal_174))
	{
		iLocal_174 = unk_0xE42A511281C9895B(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, 1, 1, 0);
	}
	if (!unk_0x2137828D03306CAF(iLocal_176))
	{
		iLocal_176 = unk_0xA3618B5F6184DAD2(joaat("prop_box_wood01a"), 1666.282f, -11.20408f, 172.7773f, 1, 1, 0);
		unk_0xD39DE0C6C0F91C27(iLocal_176, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!unk_0x2137828D03306CAF(iLocal_177))
	{
		iLocal_177 = unk_0xA3618B5F6184DAD2(joaat("prop_box_wood01a"), 1667.076f, -12.07778f, 173.2611f, 1, 1, 0);
		unk_0xD39DE0C6C0F91C27(iLocal_177, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_311(Local_155.f_0))
	{
		if (unk_0xE897E371352225D5(Local_155.f_0, 242628503) != 1)
		{
			unk_0x219EE6A7B599E7DC(&uLocal_171);
			unk_0xF1C3427BFED79E6B(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, "rcmextreme4", "fidget_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, "rcmextreme4", "fidget_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x61CCF2A09F373F7B(uLocal_171, 1);
			unk_0xBD718C5BA2122192(uLocal_171);
			unk_0x234E551BB8E8813B(Local_155.f_0, uLocal_171);
		}
	}
	if (func_311(Local_155.f_0))
	{
		unk_0x876D35DC1850E7FC(Local_155.f_0, 0);
		func_224(&uLocal_182, 4, Local_155.f_0, "DOM", 0, 1);
		unk_0x3C030E241A3543D2(Local_155.f_0, unk_0xF14CC08EB3D9D296(unk_0x2A5EB8B0FE590B91()));
	}
	if (!unk_0x2137828D03306CAF(iLocal_179))
	{
		iLocal_179 = unk_0xE9AB9BA1F0DCD1BC(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
	}
	unk_0xD39DE0C6C0F91C27(iLocal_179, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	unk_0x7A1ADAF75122D493(iLocal_179, "Chute_Off_Bag", "skydive@parachute@", 4f, 0, 1, 0, 0.99f, 0);
	func_240(1);
}
...
void func_285()
{
	switch (iLocal_150)
	{
		case 0:
			...
			{
				if (!iLocal_383 || unk_0x3732B96D7A1859B4() > iLocal_384 + 3500)
				{
					func_286();
					unk_0x4BFEFCE41695E744(1);
					...
					if (func_222(Local_82.f_28[0]))
					{
						unk_0x063C67E5BF3D0895(Local_82.f_28[0], "Hudson", 0, joaat("a_c_retriever"), 0);
					}
					unk_0x4EDE34FBADD967A6(0);
					unk_0xF01DFB77A6A50908(0);
		...
		case 2:
			func_279(unk_0x2A5EB8B0FE590B91(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			unk_0xAEE1122D64BCDB87(unk_0x2A5EB8B0FE590B91(), joaat("MotionState_Walk"), 0, 1, 0);
			unk_0xB0B7001BD1E09137(unk_0x2A5EB8B0FE590B91(), 1f);
			unk_0x28FB7E63A217D6DE(unk_0x2A5EB8B0FE590B91(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
			unk_0x61C3B2A4FEFA1D6D(0f, 1065353216);
...
int func_287(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0xC4A39E4229BD3ABE(unk_0x2A5EB8B0FE590B91(), 0))
	{
		if ((!unk_0xCC7D3FD2D4585BF3(unk_0x2A5EB8B0FE590B91()) && !unk_0x67F6B31C1A3F63CC(unk_0x2A5EB8B0FE590B91())) && !unk_0x9A1BA6388EDC7DF4(unk_0x2A5EB8B0FE590B91()))
		{
			if (!func_258(unk_0x0C20E539D876C5B3(unk_0x2A5EB8B0FE590B91(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_290()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_324() && func_311(Local_82.f_28[0])) && func_311(unk_0x2A5EB8B0FE590B91())) && iLocal_383 == 1)
	{
		if (!unk_0x943D8B466B9BD1A3())
		{
			unk_0x73EC54DB6766EF37(unk_0x0FFED3E94261A832(), false, 0);
			unk_0xEDF42871EAD55C9B(unk_0x2A5EB8B0FE590B91(), Local_82.f_28[0], -1, 0, 2);
			unk_0xF172DDE61134A915(unk_0x2A5EB8B0FE590B91(), Local_82.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
			unk_0xB70844A24734245D(1);
			unk_0x8E8B3A8DE1143EAE(Local_82.f_28[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, 0);
			unk_0x0C04B7F547B80498(fVar0);
			unk_0x690F5A0AC9900F12(fVar1);
			unk_0x2C091DFD693214C2(fVar2);
			unk_0xBBF98646A362B41E(fVar3);
			unk_0x0D73F7490DDEE7A5(fVar4);
			iLocal_384 = unk_0x3732B96D7A1859B4();
		}
		else
		{
			if (func_310(unk_0x2A5EB8B0FE590B91(), Local_82.f_28[0], 4f, 1))
			{
...
void func_291()
{
	...
	if (iLocal_383)
	{
		if (!unk_0x943D8B466B9BD1A3())
		{
			unk_0x73EC54DB6766EF37(unk_0x0FFED3E94261A832(), false, 0);
			unk_0xEDF42871EAD55C9B(unk_0x2A5EB8B0FE590B91(), Local_155.f_0, -1, 0, 2);
			unk_0x28FB7E63A217D6DE(unk_0x2A5EB8B0FE590B91(), 1658.95f, -5.45f, 173.78f, 1f, -1, 0.25f, 0, -161.08f);
			unk_0xB70844A24734245D(1);
			unk_0x8E8B3A8DE1143EAE(Local_155.f_0, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
			unk_0x0C04B7F547B80498(fVar0);
			unk_0x690F5A0AC9900F12(fVar1);
			unk_0x2C091DFD693214C2(fVar2);
			unk_0xBBF98646A362B41E(fVar3);
...
void func_292()
{
	...
	if (iLocal_148 == 1)
	{
		...
		{
			fVar0 = unk_0x4A2E6F541CD8C36E(unk_0xD1EE0E9FCD74A37B(unk_0x2A5EB8B0FE590B91(), 1), unk_0xD1EE0E9FCD74A37B(Local_155.f_0, 1), 1);
			if (iLocal_153 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			if (fVar0 > 150f)
			{
				if (unk_0xBDD3EABACAB97D09(uLocal_170))
				{
					unk_0xA4F6216A8431C2E8(uLocal_170, 1);
				}
			}
			else if (unk_0xBDD3EABACAB97D09(uLocal_170))
			{
				unk_0xA4F6216A8431C2E8(uLocal_170, 0);
			}
		}
		if (unk_0x9A46207BB68ED2F0(unk_0x2A5EB8B0FE590B91(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, 0, 1, 0))
		{
			sLocal_168 = "EXT4_F2";
			iLocal_148 = 4;
		}
...
{
	if (((!func_307(0) || Global_70069) || Global_70058 == 1) || !unk_0x0B21CC5276C2CE1B())
	{
		return 0;
	}
	switch (Global_70054)
	{
		...
		case 5:
			if ((unk_0x863D84AFAC2AB730() || func_306(0)) || func_305(1))
			{
			}
			else
			{
...
{
	return func_309(iParam0, Global_35813);
}
...
void func_312()
{
	...
	unk_0xC9173FA08E7D8227("EXT4", 0);
	while (!unk_0x44FB58EFDA8731B7(0))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	unk_0x0F39DF6675B2333E(joaat("prop_box_guncase_03a"));
	unk_0x0F39DF6675B2333E(joaat("prop_box_wood01a"));
	unk_0x0F39DF6675B2333E(joaat("p_parachute_s"));
	unk_0x0F39DF6675B2333E(joaat("bmx"));
	while (((!unk_0xA1FC9D7AEA164881(joaat("prop_box_guncase_03a")) || !unk_0xA1FC9D7AEA164881(joaat("prop_box_wood01a"))) || !unk_0xA1FC9D7AEA164881(joaat("p_parachute_s"))) || !unk_0xA1FC9D7AEA164881(joaat("bmx")))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0x2137828D03306CAF(uLocal_175))
	{
		iLocal_175 = unk_0x999AC25128E45284(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, 1, 1, 0);
		unk_0xD39DE0C6C0F91C27(iLocal_175, 90f, 0f, -63f, 2, 1);
		unk_0xA32D9C84C1A93920(iLocal_175, 1);
		unk_0x4C1FCB3943DAF647(iLocal_175, 0, 0);
	}
	func_316(1);
	if (!unk_0x2137828D03306CAF(Local_155.f_0))
	{
		func_313(&Local_155, 52, Local_155.f_1, Local_155.f_4, "Ext4-Dom", 1);
		unk_0xA32D9C84C1A93920(Local_155.f_0, 1);
		unk_0x4C47904AE69D7393(Local_155.f_0, 1);
		unk_0x88146CB95BA975DD(Local_155.f_0, 1);
		unk_0x6CA29A70250F194F(Local_155.f_0, 8, 2, 0, 0);
		unk_0x75DFBCBE268F4432(Local_155.f_0, 1);
		unk_0x31AC59B7C21A2047(Local_155.f_0, 137, 1);
		unk_0x31AC59B7C21A2047(Local_155.f_0, 118, 0);
		unk_0x31AC59B7C21A2047(Local_155.f_0, 208, 1);
		unk_0x88D9DF53359130B9(Local_155.f_0, 5000);
	}
	if (func_222(unk_0x2A5EB8B0FE590B91()))
	{
		func_224(&uLocal_182, 1, unk_0x2A5EB8B0FE590B91(), "FRANKLIN", 0, 1);
...
{
	unk_0x0F39DF6675B2333E(Local_155.f_5);
	unk_0xA7C81DED990D3418("rcmextreme4");
	unk_0xA7C81DED990D3418("skydive@parachute@");
	unk_0x0F39DF6675B2333E(joaat("sanchez"));
	unk_0x926AB8F66F783F4D();
	if (iParam0 == 1)
	{
		while ((((!unk_0xA1FC9D7AEA164881(Local_155.f_5) || !unk_0xA1FC9D7AEA164881(joaat("sanchez"))) || !unk_0x45834D6C20FFF689("rcmextreme4")) || !unk_0x45834D6C20FFF689("skydive@parachute@")) || !unk_0x1135D5BD86A70AD2())
		{
			unk_0x4EDE34FBADD967A6(0);
		}
	}
...
void func_325(int iParam0)
{
	...
	unk_0x10632CBB5FE7F881("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 1);
...
void func_338()
{
	...
	unk_0x15167ADA0B7D44AE("rcmextreme4");
}
