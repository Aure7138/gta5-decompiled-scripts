...
void __EntryFunction__()
{
	...
	uLocal_367 = unk_0x3DF2C10FD29336A3();
	...
	if (unk_0x23E9113C762466ED(iLocal_179))
	{
	}
	func_312();
	if (!func_324())
	{
		if ((func_311(Local_82.f_28[0]) && func_311(unk_0x17B5CC8A8615737D())) && !func_310(unk_0x17B5CC8A8615737D(), Local_82.f_28[0], 4f, 1))
		{
			iLocal_383 = 1;
		}
	}
	while (true)
	{
		...
		unk_0x31683E0D6DBB707E("SF_UR", 0);
		...
		{
			if (func_311(unk_0x17B5CC8A8615737D()) && unk_0x70A9F320A34FAC28(unk_0x17B5CC8A8615737D(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, 1, 0))
			{
				if (func_311(Local_155.f_0))
				{
					if (func_310(unk_0x17B5CC8A8615737D(), Local_155.f_0, 10f, 1))
					{
						func_291();
					}
				}
...
void func_1()
{
	switch (iLocal_147)
	{
		case 0:
			...
			if (unk_0x9C88EB7B70229335(sLocal_168))
			{
				func_340(1);
			}
			else
...
void func_8()
{
	switch (iLocal_149)
	{
		...
		case 1:
			if (unk_0x23E9113C762466ED(iLocal_178))
			{
				if (!unk_0xA929B2923D14E2F8(iLocal_178, 0))
				{
					if (func_310(unk_0x17B5CC8A8615737D(), iLocal_178, 1f, 1))
					{
						unk_0xC1B7B5C6FDC0755B(unk_0x17B5CC8A8615737D(), joaat("gadget_parachute"), 1, 0, 0);
						unk_0x1AAFEA627BB9C402(&iLocal_178);
					}
				}
			}
			if (iLocal_347 == 0)
			...
			if (func_311(unk_0x17B5CC8A8615737D()))
			{
				if (iLocal_375 == 0)
				{
					if (unk_0x70A9F320A34FAC28(unk_0x17B5CC8A8615737D(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, 0, 1, 0) && unk_0xD4337557D3DEFC11(unk_0x17B5CC8A8615737D()) == 2)
					{
						iLocal_375 = 1;
					}
				}
				if (func_222(Local_155.f_0))
				{
					...
					{
						if ((unk_0x94E3E074F38DF86C() > iLocal_370 + 25000 || unk_0x70A9F320A34FAC28(unk_0x17B5CC8A8615737D(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || unk_0x70A9F320A34FAC28(unk_0x17B5CC8A8615737D(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
						{
							iLocal_149 = 2;
						}
					}
				}
				else if ((unk_0x94E3E074F38DF86C() > iLocal_370 + 25000 || unk_0x70A9F320A34FAC28(unk_0x17B5CC8A8615737D(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || unk_0x70A9F320A34FAC28(unk_0x17B5CC8A8615737D(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
				{
					iLocal_149 = 2;
				}
			}
			if (unk_0x94E3E074F38DF86C() < iLocal_370 + 5000)
			{
				if (unk_0xC81784511829F091())
				{
		...
		case 2:
			if (((!unk_0xA9969D6750AB48B7(unk_0x17B5CC8A8615737D()) && !unk_0xC3B1F1C9A58948C2(unk_0x17B5CC8A8615737D())) && unk_0xEF1ECDC49CE81822(unk_0x17B5CC8A8615737D()) < 2f) && !unk_0x7F4AE93855973529(unk_0x17B5CC8A8615737D()))
			{
...
void func_9()
{
	if (iLocal_375 == 1)
	{
		unk_0x2DE9FDD822EE641B(10f, 4f, 0);
		func_209(762);
	}
	func_2(1);
	func_10(84, 1);
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_77(func_96(iParam1, uParam0->f_2), Global_69521, 0);
			if (unk_0x48B8265059381CD0(uVar0, uParam0->f_1))
			{
				unk_0xEB79FECD9022AAF0(&(uParam0->f_6), 1);
			}
			uVar0 = func_77(func_95(iParam1, uParam0->f_2), Global_69521, 0);
			if (unk_0x48B8265059381CD0(uVar0, uParam0->f_1))
			{
				unk_0xEB79FECD9022AAF0(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_77(iVar1, Global_69521, 0);
				if (!unk_0x48B8265059381CD0(uVar0, uParam0->f_1))
				{
					unk_0xEB79FECD9022AAF0(&(uParam0->f_6), 4);
				}
...
void func_223()
{
	...
	if (!unk_0x0F1BF24ED3B7ED40(uLocal_352))
	{
	}
	if (!unk_0x0F1BF24ED3B7ED40(uLocal_353))
	{
	}
	if (!unk_0x0F1BF24ED3B7ED40(uLocal_354))
	{
	}
	if (!unk_0x0F1BF24ED3B7ED40(uLocal_355))
	{
	}
	if (!unk_0x0F1BF24ED3B7ED40(uLocal_356))
	{
	}
	if (!unk_0x0F1BF24ED3B7ED40(uLocal_357))
	{
	}
	if (!unk_0x0F1BF24ED3B7ED40(uLocal_358))
	{
	}
	if (!unk_0x0F1BF24ED3B7ED40(uLocal_359))
	{
	}
	if (!unk_0x0F1BF24ED3B7ED40(uLocal_360))
	{
	}
	if (!unk_0x0F1BF24ED3B7ED40(uLocal_361))
	{
	}
	if (!unk_0x0F1BF24ED3B7ED40(uLocal_362))
	{
	}
	unk_0x8ADF92E4B51709E2(fVar1);
	unk_0xE418A8E16B02C0AC(0);
	unk_0x2D28D5B324F77D2D(0);
	unk_0xC8C3338D4DBC00FE(unk_0xBE369BE1BC57A796(), false, 128);
	unk_0xB8CAC5F3774894A1("EXTREME_04_CUSTOM_QUIET_SCENE");
	func_238(800, 0);
	iLocal_376 = 0;
	iLocal_377 = 0;
	iLocal_379 = 0;
	...
	iLocal_377 = 0;
	iLocal_382 = 0;
	unk_0x2156AF318C71023B("SLOWMO_EXTREME_04");
	unk_0x46081AAD7F4633BD(0);
	while (unk_0x94E3E074F38DF86C() < iLocal_374 + 11000 && !unk_0x25BD4C26D84038CD())
	{
		if (!unk_0x00743AFDA92F3B04(uLocal_371) && !unk_0x00743AFDA92F3B04(uLocal_372))
		{
			if (func_236(400))
			{
				bLocal_381 = true;
		...
		if (!iLocal_379)
		{
			if (unk_0x00743AFDA92F3B04(uLocal_371))
			{
				if (unk_0x96F65998C0685177(uLocal_371) == 1f)
				{
					if (func_311(Local_155.f_0))
					{
						uLocal_372 = unk_0x356EABB012B22D07(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
						uLocal_364 = unk_0xBD7A488D61CE4287("DEFAULT_ANIMATED_CAMERA", 1);
						unk_0xA17D768ED938600C(Local_155.f_0, uLocal_372, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						unk_0xD3BB86584359B533(uLocal_372, 0);
						unk_0xA652CA24468EC747(uLocal_364, 1);
						unk_0x563AC676C8BDAD48(uLocal_364, uLocal_372, "Base_Jump_Spot_02_CAM", "rcmextreme4");
						unk_0x9274EF97A90581BE(1, 0, 3000, 1, 0, 0);
						unk_0xDEAF24B058321A05(Local_155.f_0, 0, 0);
						unk_0x2BC4A4AFFC2D937D(uLocal_363, 0);
						iLocal_379 = 1;
					}
				}
			}
		...
		{
			if (unk_0x00743AFDA92F3B04(uLocal_372) && unk_0x96F65998C0685177(uLocal_372) >= 0.2f)
			{
				if (!unk_0x00743AFDA92F3B04(uLocal_373))
				{
					unk_0x6244BFF5BB1E7059("RCM_Extreme4_Fall_and_impact", 0);
				}
			}
			if (unk_0x00743AFDA92F3B04(uLocal_372) && unk_0x96F65998C0685177(uLocal_372) == 1f)
			{
				if (func_311(Local_155.f_0))
				{
					uLocal_373 = unk_0x356EABB012B22D07(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
					uLocal_365 = unk_0xBD7A488D61CE4287("DEFAULT_ANIMATED_CAMERA", 1);
					unk_0xA17D768ED938600C(Local_155.f_0, uLocal_373, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
					unk_0xD3BB86584359B533(uLocal_373, 1);
					unk_0xA652CA24468EC747(uLocal_365, 1);
					unk_0x563AC676C8BDAD48(uLocal_365, uLocal_373, "Fall_and_impact_CAM", "rcmextreme4");
					unk_0x035464080AF1E0AE(uLocal_373);
					unk_0x9274EF97A90581BE(1, 0, 3000, 1, 0, 0);
					unk_0xDEAF24B058321A05(Local_155.f_0, 0, 0);
					unk_0x2BC4A4AFFC2D937D(uLocal_364, 0);
					iLocal_380 = 1;
				}
			}
		}
		else if (unk_0x00743AFDA92F3B04(uLocal_373) && unk_0x96F65998C0685177(uLocal_373) >= 0.323f)
		{
			if (!iLocal_376)
			{
				unk_0x289A9D382EC2E2FA("scr_extrm4_water_splash", 1655.27f, -20.8134f, 133.841f, 0f, 0f, 0f, 1f, 0, 0, 0);
				unk_0xAAFA0D937D78F630(1f);
				func_234();
				iLocal_376 = 1;
			}
			else if (!iLocal_382)
			{
				if (unk_0x00743AFDA92F3B04(uLocal_373) && unk_0x96F65998C0685177(uLocal_373) >= 0.44f)
				{
					uLocal_180 = unk_0x759E422F846BA6EC("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
					unk_0xFA6FE63FC98B8066(uLocal_180, 1f);
					iLocal_382 = 1;
				}
			}
		}
		if (unk_0x94E3E074F38DF86C() > iLocal_374 + 600 && fVar1 == 1f)
		{
			if (!iLocal_377)
			{
				iLocal_377 = 1;
		...
		fVar2 = (1f / 30f);
		fVar3 = (unk_0xE9F97E1BC0CACE24() / fVar2);
		if (unk_0x94E3E074F38DF86C() > iLocal_374 + 630)
		{
		...
		if (unk_0x94E3E074F38DF86C() > iLocal_374 + 563)
		{
			if (iVar0 == 1)
			{
				func_3(&uLocal_175);
		...
		if (unk_0x94E3E074F38DF86C() > iLocal_374 + 871)
		{
			if (iVar0 == 2)
			{
				if (func_311(Local_155.f_0))
		...
		if (unk_0x94E3E074F38DF86C() > iLocal_374 + 2000)
		{
			if (iVar0 == 3)
			{
				if (func_311(Local_155.f_0))
		...
		if (unk_0x94E3E074F38DF86C() > iLocal_374 + 3500)
		{
			if (iVar0 == 4)
			{
				iVar0 = 5;
		...
		if (unk_0x94E3E074F38DF86C() > iLocal_374 + 10000)
		{
			if (iVar0 != 7)
			{
				unk_0x2BC4A4AFFC2D937D(uLocal_365, 0);
				uLocal_362 = unk_0xBD7A488D61CE4287("DEFAULT_SCRIPTED_CAMERA", 1);
				unk_0x10AEEB80A49DD974(uLocal_362, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
				unk_0x9274EF97A90581BE(1, 0, 3000, 1, 0, 0);
				unk_0xA652CA24468EC747(uLocal_362, 1);
				iVar0 = 7;
			}
		}
	}
	if (bLocal_381)
	{
		if (unk_0x00743AFDA92F3B04(uLocal_373))
		{
			unk_0xA76C6422E6F68875(uLocal_373);
		}
		unk_0x01BF9836BF02F6C4("EXT4_JUMPED_OS");
		func_234();
		uLocal_362 = unk_0xBD7A488D61CE4287("DEFAULT_SCRIPTED_CAMERA", 1);
		unk_0x10AEEB80A49DD974(uLocal_362, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
		unk_0x9274EF97A90581BE(1, 0, 3000, 1, 0, 0);
	...
	unk_0x80D24361A541257A("SLOWMO_EXTREME_04");
	func_3(&uLocal_175);
	if (func_311(Local_155.f_0))
	{
		if (iVar0 < 3)
		{
			unk_0x4B04B4FAE554FA03(Local_155.f_0, 101);
			Var4 = { unk_0x57240623C1BC6E88(Local_155.f_0, 1) };
			if (Var4.f_2 > 155f)
			{
				fVar7 = 155f;
			}
			...
			unk_0x5DC8C2F2F8A363C2(Local_155.f_0, 1657.046f, -17.4571f, fVar7, 1, 0, 0, 1);
		}
	}
	...
	unk_0xE418A8E16B02C0AC(1);
	unk_0x2D28D5B324F77D2D(1);
	unk_0xC8C3338D4DBC00FE(unk_0xBE369BE1BC57A796(), true, 128);
	unk_0x8ADF92E4B51709E2(1f);
	if (func_222(Local_155.f_0))
	{
		if (unk_0x00743AFDA92F3B04(uLocal_373))
		{
			unk_0xCE49D4A5BC766F78(uLocal_373, 1f);
		}
		unk_0xBC8C26E1CC191108(Local_155.f_0);
		unk_0xDEAF24B058321A05(Local_155.f_0, 0, 0);
		unk_0x5DC8C2F2F8A363C2(Local_155.f_0, 1655.77f, -20.04f, 135.8f, 1, 0, 0, 1);
		unk_0x4B04B4FAE554FA03(Local_155.f_0, 0);
	}
	func_224(&uLocal_182, 1, unk_0x17B5CC8A8615737D(), "FRANKLIN", 0, 1);
...
void func_226(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!unk_0xCA41A00932714525(unk_0x17B5CC8A8615737D()) && !func_230(unk_0xBE369BE1BC57A796())) && !func_228(unk_0xBE369BE1BC57A796(), 0)) && !func_227())
			{
				unk_0xC6042F55A6EA17B2(unk_0x17B5CC8A8615737D(), 0);
			}
		}
		else if (!unk_0xCA41A00932714525(unk_0x17B5CC8A8615737D()) && !func_230(unk_0xBE369BE1BC57A796()))
		{
			unk_0xC6042F55A6EA17B2(unk_0x17B5CC8A8615737D(), 0);
		}
		Global_69700 = 0;
...
void func_239()
{
	if (iLocal_149 < 2)
	{
		unk_0x5823F1F25CE33C5D("EXT4_JUMPED_OS");
	}
	switch (iLocal_149)
	{
		case 0:
			iLocal_151 = 0;
			if (unk_0x70A9F320A34FAC28(unk_0x17B5CC8A8615737D(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, 0, 1, 0))
			{
				unk_0xF2705A63E3587B6C("es_4_rcm_p2_concat", 6, 8);
			}
			else
			{
				unk_0xF2705A63E3587B6C("es_4_rcm_p2_concat", 5, 8);
			}
			unk_0x2EB37CDED0E516F3(uLocal_367);
			if (unk_0x6E5BBCE1B1E5B2EB())
			{
				unk_0x5C9E441B0B13FC8B("Dom", 8, 2, 0, 0);
			}
			if (!func_260())
			{
				if (func_254(1, 20f, 1))
				{
					if ((!iLocal_383 || unk_0x94E3E074F38DF86C() > iLocal_384 + 3000) || unk_0x1C34CE8087E3897C(unk_0x17B5CC8A8615737D(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0))
					{
						unk_0x46081AAD7F4633BD(1);
						unk_0x51C344BE3DCB5CB5(2048);
						if (func_311(Local_155.f_0))
						{
							unk_0xD9C496FEAA81FF4A(Local_155.f_0, "Dom", 0, joaat("cs_dom"), 0);
						}
						unk_0x4EDE34FBADD967A6(0);
						iLocal_383 = 0;
						unk_0x72B6EAB729050F5B(0);
						unk_0x4A5D4AD0FE6ACF73("EXTREME_04_CUSTOM_QUIET_SCENE");
						if (func_311(Local_155.f_0))
						{
							unk_0x98F0FA127445E343(Local_155.f_0, 0);
						}
						if (unk_0x23E9113C762466ED(iLocal_179) && !unk_0xA929B2923D14E2F8(iLocal_179, 0))
						{
							unk_0x027DB6817AB239EB(iLocal_179, 0, 0);
						}
						if (unk_0xFD0FE723227D5AB6(unk_0x17B5CC8A8615737D(), 0))
						{
							iLocal_172 = unk_0x60604E51E30D25B8(unk_0x17B5CC8A8615737D(), 0);
							iLocal_181 = unk_0x0324EEB10F81965F(iLocal_172);
							if (unk_0xC2AFD5CFEDC8F22A(iLocal_181) == 1 || unk_0xD28959FE5BC2D14D(iLocal_181) == 1)
							{
						...
						unk_0x26D48449559660BA(1660.186f, -7.492f, 172.774f, 200f, 0);
						uLocal_366 = unk_0xD1D19967E553E144(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
						iLocal_149 = 1;
					}
				}
			}
		...
		case 1:
			if (unk_0x1B76B77EDF24A933())
			{
				if (unk_0x66FBC42991B0D41E(0))
				{
					if (!iLocal_154)
					{
						if (!unk_0x00743AFDA92F3B04(uLocal_371))
						{
							if (func_311(Local_155.f_0))
							{
								if (!unk_0x0F1BF24ED3B7ED40(uLocal_363))
								{
									uLocal_363 = unk_0xBD7A488D61CE4287("DEFAULT_ANIMATED_CAMERA", 1);
								}
								unk_0xA652CA24468EC747(uLocal_363, 1);
								unk_0x9274EF97A90581BE(1, 0, 3000, 1, 0, 0);
								uLocal_371 = unk_0x356EABB012B22D07(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
								unk_0xA17D768ED938600C(Local_155.f_0, uLocal_371, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
								unk_0xD3BB86584359B533(uLocal_371, 1);
								unk_0xA652CA24468EC747(uLocal_363, 1);
								unk_0x563AC676C8BDAD48(uLocal_363, uLocal_371, "Base_Jump_Spot_CAM", "rcmextreme4");
								unk_0x9274EF97A90581BE(1, 0, 3000, 1, 0, 0);
								unk_0xDEAF24B058321A05(Local_155.f_0, 0, 0);
								iLocal_154 = 1;
							}
				...
				if (func_311(Local_155.f_0))
				{
					if (unk_0x649012AFAC9B7CD0("Dom", 0))
					{
						iLocal_149 = 2;
					}
				}
		...
		case 2:
			...
			if (unk_0x23E9113C762466ED(iLocal_179) && !unk_0xA929B2923D14E2F8(iLocal_179, 0))
			{
				unk_0x027DB6817AB239EB(iLocal_179, 1, 0);
			}
			if (iLocal_151 == 0)
			{
				unk_0x5BE53482EFD49141("EXT4_JUMPED_OS");
				func_240(3);
			}
			break;
	}
...
void func_241(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0xCF7855B965948E97(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x26D48449559660BA(func_242(unk_0x592069F95C314814()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_244(struct<3> Param0, float fParam3)
{
	...
	if (!unk_0xCA41A00932714525(unk_0x17B5CC8A8615737D()))
	{
		...
		if (unk_0x23E9113C762466ED(iVar0))
		{
			...
			{
				unk_0x5DC8C2F2F8A363C2(iVar0, Param0, 1, 0, 0, 1);
				unk_0x0608D50823C6AA6D(iVar0, fParam3);
...
int func_254(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0xFD0FE723227D5AB6(unk_0x17B5CC8A8615737D(), 0))
	{
		...
		{
			if (!func_258(unk_0x60604E51E30D25B8(unk_0x17B5CC8A8615737D(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_257(unk_0x17B5CC8A8615737D(), -828834893))
				{
...
void func_261()
{
	if (!unk_0xCA41A00932714525(unk_0x17B5CC8A8615737D()))
	{
		...
		{
			if (((((((unk_0x79888727131C6854(0, 30) || unk_0x79888727131C6854(0, 31)) || unk_0x79888727131C6854(0, 23)) || unk_0x79888727131C6854(0, 21)) || unk_0x79888727131C6854(0, 22)) || (func_273() && unk_0x79888727131C6854(0, 1))) || (func_273() && unk_0x79888727131C6854(0, 2))) || (func_273() && unk_0x79888727131C6854(0, 32)))
			{
	...
	switch (iLocal_149)
	{
		case 0:
			...
			{
				unk_0xC96275575DC981A9(Local_82.f_28[0], 17, 1);
			}
			iLocal_368 = 0;
			iLocal_383 = 1;
		...
		case 1:
			...
			if (func_311(unk_0x17B5CC8A8615737D()))
			{
				if (func_311(Local_155.f_0))
				{
					if (func_310(unk_0x17B5CC8A8615737D(), Local_155.f_0, 100f, 1))
					{
						unk_0xF2705A63E3587B6C("es_4_rcm_p2_concat", 6, 8);
						if (unk_0x6E5BBCE1B1E5B2EB())
						{
					...
					if (unk_0x7F4AE93855973529(Local_155.f_0))
					{
						unk_0x4B04B4FAE554FA03(Local_155.f_0, 0);
					}
					if (func_310(unk_0x17B5CC8A8615737D(), Local_155.f_0, 32f, 1))
					{
						...
						else
						{
							if (!iLocal_378)
							{
								if (func_310(unk_0x17B5CC8A8615737D(), Local_155.f_0, 30f, 1) && !func_260())
								{
							...
							func_263();
							if (!unk_0x1D0EB673E1AE9A25(unk_0x17B5CC8A8615737D(), Local_155.f_0))
							{
								unk_0x4718A774D9248520(unk_0x17B5CC8A8615737D(), Local_155.f_0, -1, 0, 2);
							}
						}
					}
					if (unk_0x70A9F320A34FAC28(unk_0x17B5CC8A8615737D(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, 0, 1, 0))
					{
						if (!unk_0xFD0FE723227D5AB6(unk_0x17B5CC8A8615737D(), 0))
						{
							iLocal_149 = 2;
		...
		case 2:
			...
			if (func_311(unk_0x17B5CC8A8615737D()))
			{
				if (unk_0xFD0FE723227D5AB6(unk_0x17B5CC8A8615737D(), 0))
				{
					unk_0xEEA9C8F490BB3507(unk_0x60604E51E30D25B8(unk_0x17B5CC8A8615737D(), 0), 5f, 1, 0);
...
void func_262()
{
	if (func_311(Local_155.f_0))
	{
		if (unk_0x1F8F07D86DA1A701(Local_155.f_0, 242628503) != 1)
		{
			unk_0x00E85C3B3BD34B10(Local_155.f_0, uLocal_171);
		}
	}
}
...
void func_263()
{
	if (!func_260())
	{
		if (iLocal_368 < 5)
		{
			if (unk_0x94E3E074F38DF86C() > (iLocal_369 + (8000 + unk_0x0E29C61F26D96FDB(0, 2000))))
			{
				if (unk_0x7DFE463FA760D738(uLocal_367))
				{
	...
	if (!func_260())
	{
		if ((unk_0x985A2515CBAF7290("EXTREME_04_DOM_A", 0, -1) && unk_0x985A2515CBAF7290("EXTREME_04_DOM_B", 0, -1)) && unk_0x985A2515CBAF7290("EXTREME_04_DOM_C", 0, -1))
		{
			if (unk_0x7DFE463FA760D738(uLocal_367))
			{
				unk_0xEE4ED1F88396A702(uLocal_367, "DOM", Local_155.f_0, "EXTREME_04_SOUNDSET", 0, 0);
			}
		}
	}
}
...
int func_268(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_252(Param1 - unk_0x57240623C1BC6E88(iParam0, 1)) };
	...
	{
		Var3 = { func_252(unk_0x425DAA25CBB7EDE2(iParam0, 31086, 0f, 5f, 0f) - unk_0x425DAA25CBB7EDE2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_274()
{
	...
	else
	{
		...
		unk_0x084522380FECC554(unk_0x17B5CC8A8615737D(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
		func_238(800, 0);
		iLocal_152 = 1;
		func_281(1, 1, 1);
	}
...
void func_275()
{
	...
	unk_0x084522380FECC554(Local_82.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 0.25f, 0, 40000f);
	unk_0xBFB6E3E25249995F("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 0);
	unk_0x0668B21A0C3A4821(Local_155.f_1, 20f, 0, 0, 0, 0, 0);
	if (!unk_0x23E9113C762466ED(iLocal_173))
	{
		iLocal_173 = unk_0x692A2891A2BA7352(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, 1, 1);
	}
	if (!unk_0x23E9113C762466ED(iLocal_174))
	{
		iLocal_174 = unk_0x692A2891A2BA7352(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, 1, 1);
	}
	if (!unk_0x23E9113C762466ED(iLocal_176))
	{
		iLocal_176 = unk_0x521A82CF998EDB21(joaat("prop_box_wood01a"), 1666.282f, -11.20408f, 172.7773f, 1, 1, 0);
		unk_0x04A5FAE5B1EB8E28(iLocal_176, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!unk_0x23E9113C762466ED(iLocal_177))
	{
		iLocal_177 = unk_0x521A82CF998EDB21(joaat("prop_box_wood01a"), 1667.076f, -12.07778f, 173.2611f, 1, 1, 0);
		unk_0x04A5FAE5B1EB8E28(iLocal_177, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_311(Local_155.f_0))
	{
		if (unk_0x1F8F07D86DA1A701(Local_155.f_0, 242628503) != 1)
		{
			unk_0x86DD54980FE55567(&uLocal_171);
			unk_0xEB1EFACA68933402(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, "rcmextreme4", "fidget_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, "rcmextreme4", "fidget_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x85111902FC00A5CF(uLocal_171, 1);
			unk_0x007AE2AA9E15FA7B(uLocal_171);
			unk_0x00E85C3B3BD34B10(Local_155.f_0, uLocal_171);
		}
	}
	if (func_311(Local_155.f_0))
	{
		unk_0xB5E6A8B9C64444C4(Local_155.f_0, 0);
		func_224(&uLocal_182, 4, Local_155.f_0, "DOM", 0, 1);
		unk_0x3BB70315907D9456(Local_155.f_0, unk_0x7B619B0C33282280(unk_0x17B5CC8A8615737D()));
	}
	if (!unk_0x23E9113C762466ED(iLocal_179))
	{
		iLocal_179 = unk_0xAB96B96F513DBFC2(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
	}
	unk_0x04A5FAE5B1EB8E28(iLocal_179, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	unk_0x15DDCF52D0DB08C1(iLocal_179, "Chute_Off_Bag", "skydive@parachute@", 4f, 0, 1, 0, 0.99f, 0);
	func_240(1);
}
...
void func_285()
{
	switch (iLocal_150)
	{
		case 0:
			...
			{
				if (!iLocal_383 || unk_0x94E3E074F38DF86C() > iLocal_384 + 3500)
				{
					func_286();
					unk_0x46081AAD7F4633BD(1);
					...
					if (func_222(Local_82.f_28[0]))
					{
						unk_0xD9C496FEAA81FF4A(Local_82.f_28[0], "Hudson", 0, joaat("a_c_retriever"), 0);
					}
					unk_0x4EDE34FBADD967A6(0);
					unk_0x72B6EAB729050F5B(0);
		...
		case 2:
			func_279(unk_0x17B5CC8A8615737D(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			unk_0x44B1CF13D39D96CE(unk_0x17B5CC8A8615737D(), joaat("MotionState_Walk"), 0, 1, 0);
			unk_0x316B8FE556E99FA1(unk_0x17B5CC8A8615737D(), 1f);
			unk_0x084522380FECC554(unk_0x17B5CC8A8615737D(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
			unk_0x503F20CB07C55470(0f, 1065353216);
...
int func_287(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0xFD0FE723227D5AB6(unk_0x17B5CC8A8615737D(), 0))
	{
		if ((!unk_0x8EC3C2BC25ED8ECA(unk_0x17B5CC8A8615737D()) && !unk_0x72FC030E928A5207(unk_0x17B5CC8A8615737D())) && !unk_0xE40FC0529CC75B0F(unk_0x17B5CC8A8615737D()))
		{
			if (!func_258(unk_0x60604E51E30D25B8(unk_0x17B5CC8A8615737D(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_290()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_324() && func_311(Local_82.f_28[0])) && func_311(unk_0x17B5CC8A8615737D())) && iLocal_383 == 1)
	{
		if (!unk_0xAB01297DD4A8577F())
		{
			unk_0xC8C3338D4DBC00FE(unk_0xBE369BE1BC57A796(), false, 0);
			unk_0x4718A774D9248520(unk_0x17B5CC8A8615737D(), Local_82.f_28[0], -1, 0, 2);
			unk_0x8C17F851E89377D3(unk_0x17B5CC8A8615737D(), Local_82.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
			unk_0x7C685139990C384F(1);
			unk_0x986AC95588E8693B(Local_82.f_28[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, 0);
			unk_0x052981497D46112E(fVar0);
			unk_0x32CE35B63F0BF48D(fVar1);
			unk_0xACC12FC81030C21A(fVar2);
			unk_0x254ECD140D986976(fVar3);
			unk_0xAE5FD86A4AD93299(fVar4);
			iLocal_384 = unk_0x94E3E074F38DF86C();
		}
		else
		{
			if (func_310(unk_0x17B5CC8A8615737D(), Local_82.f_28[0], 4f, 1))
			{
...
void func_291()
{
	...
	if (iLocal_383)
	{
		if (!unk_0xAB01297DD4A8577F())
		{
			unk_0xC8C3338D4DBC00FE(unk_0xBE369BE1BC57A796(), false, 0);
			unk_0x4718A774D9248520(unk_0x17B5CC8A8615737D(), Local_155.f_0, -1, 0, 2);
			unk_0x084522380FECC554(unk_0x17B5CC8A8615737D(), 1658.95f, -5.45f, 173.78f, 1f, -1, 0.25f, 0, -161.08f);
			unk_0x7C685139990C384F(1);
			unk_0x986AC95588E8693B(Local_155.f_0, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
			unk_0x052981497D46112E(fVar0);
			unk_0x32CE35B63F0BF48D(fVar1);
			unk_0xACC12FC81030C21A(fVar2);
			unk_0x254ECD140D986976(fVar3);
...
void func_292()
{
	...
	if (iLocal_148 == 1)
	{
		...
		{
			fVar0 = unk_0x3DC4639D5F23DEA2(unk_0x57240623C1BC6E88(unk_0x17B5CC8A8615737D(), 1), unk_0x57240623C1BC6E88(Local_155.f_0, 1), 1);
			if (iLocal_153 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			if (fVar0 > 150f)
			{
				if (unk_0xA3794949321E107C(uLocal_170))
				{
					unk_0x76C0584E1FF9B958(uLocal_170, 1);
				}
			}
			else if (unk_0xA3794949321E107C(uLocal_170))
			{
				unk_0x76C0584E1FF9B958(uLocal_170, 0);
			}
		}
		if (unk_0x70A9F320A34FAC28(unk_0x17B5CC8A8615737D(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, 0, 1, 0))
		{
			sLocal_168 = "EXT4_F2";
			iLocal_148 = 4;
		}
...
{
	if (((!func_307(0) || Global_69971) || Global_69960 == 1) || !unk_0x30F06AB0772AFB80())
	{
		return 0;
	}
	switch (Global_69956)
	{
		...
		case 5:
			if ((unk_0x1B76B77EDF24A933() || func_306(0)) || func_305(1))
			{
			}
			else
			{
...
{
	return func_309(iParam0, Global_35781);
}
...
void func_312()
{
	...
	unk_0xA73AE78D2491E6E1("EXT4", 0);
	while (!unk_0x657558590DD37F85(0))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	unk_0xE1324F59713746FA(joaat("prop_box_guncase_03a"));
	unk_0xE1324F59713746FA(joaat("prop_box_wood01a"));
	unk_0xE1324F59713746FA(joaat("p_parachute_s"));
	unk_0xE1324F59713746FA(joaat("bmx"));
	while (((!unk_0x9F746898F7881612(joaat("prop_box_guncase_03a")) || !unk_0x9F746898F7881612(joaat("prop_box_wood01a"))) || !unk_0x9F746898F7881612(joaat("p_parachute_s"))) || !unk_0x9F746898F7881612(joaat("bmx")))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0x23E9113C762466ED(uLocal_175))
	{
		iLocal_175 = unk_0x89241A4EA7EE46D2(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, 1, 1, 0);
		unk_0x04A5FAE5B1EB8E28(iLocal_175, 90f, 0f, -63f, 2, 1);
		unk_0x98F0FA127445E343(iLocal_175, 1);
		unk_0x027DB6817AB239EB(iLocal_175, 0, 0);
	}
	func_316(1);
	if (!unk_0x23E9113C762466ED(Local_155.f_0))
	{
		func_313(&Local_155, 52, Local_155.f_1, Local_155.f_4, "Ext4-Dom", 1);
		unk_0x98F0FA127445E343(Local_155.f_0, 1);
		unk_0xCC61640A821F277C(Local_155.f_0, 1);
		unk_0x39DF32F630CC12A7(Local_155.f_0, 1);
		unk_0x2F933BB106547968(Local_155.f_0, 8, 2, 0, 0);
		unk_0xC114CBAEC75AFD9E(Local_155.f_0, 1);
		unk_0x6018E338F7ABCE75(Local_155.f_0, 137, 1);
		unk_0x6018E338F7ABCE75(Local_155.f_0, 118, 0);
		unk_0x6018E338F7ABCE75(Local_155.f_0, 208, 1);
		unk_0x4DF0B516187EED5A(Local_155.f_0, 5000);
	}
	if (func_222(unk_0x17B5CC8A8615737D()))
	{
		func_224(&uLocal_182, 1, unk_0x17B5CC8A8615737D(), "FRANKLIN", 0, 1);
...
{
	unk_0xE1324F59713746FA(Local_155.f_5);
	unk_0xA0E7D0E8FE126EE8("rcmextreme4");
	unk_0xA0E7D0E8FE126EE8("skydive@parachute@");
	unk_0xE1324F59713746FA(joaat("sanchez"));
	unk_0xD250AE1AB37DC648();
	if (iParam0 == 1)
	{
		while ((((!unk_0x9F746898F7881612(Local_155.f_5) || !unk_0x9F746898F7881612(joaat("sanchez"))) || !unk_0xF4F8AE8DD0F08C1E("rcmextreme4")) || !unk_0xF4F8AE8DD0F08C1E("skydive@parachute@")) || !unk_0xD181F97E98E28C18())
		{
			unk_0x4EDE34FBADD967A6(0);
		}
	}
...
void func_325(int iParam0)
{
	...
	unk_0xBFB6E3E25249995F("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 1);
...
void func_338()
{
	...
	unk_0xF9FFB9857F3120F8("rcmextreme4");
}
...
void func_340(bool bParam0)
{
	...
	if (!func_359())
	{
		...
		{
			func_166(iVar0, 1, 0);
			func_341(unk_0x6AF6B39BFDB53CB5(), iVar0);
		}
		else
		{
			if (Global_100787[iVar0 /*10*/].f_9 == -1)
...
int func_342(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_348())
	{
		...
		{
			iVar33 = func_343(unk_0x6AF6B39BFDB53CB5());
			if (iVar33 > -1)
			{
