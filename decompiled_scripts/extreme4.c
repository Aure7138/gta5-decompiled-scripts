...
void __EntryFunction__()
{
	...
	uLocal_367 = unk_0x2D524E0AFDB169D5();
	...
	if (unk_0x31F12808DC47A9E5(iLocal_179))
	{
	}
	func_312();
	if (!func_324())
	{
		if ((func_311(Local_82.f_28[0]) && func_311(unk_0x18F7BE9ACB7D08F4())) && !func_310(unk_0x18F7BE9ACB7D08F4(), Local_82.f_28[0], 4f, 1))
		{
			iLocal_383 = 1;
		}
	}
	while (true)
	{
		...
		unk_0x89FD0BC32FAB9F88("SF_UR", 0);
		...
		{
			if (func_311(unk_0x18F7BE9ACB7D08F4()) && unk_0x11BBEE2752B9D0C8(unk_0x18F7BE9ACB7D08F4(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, 1, 0))
			{
				if (func_311(Local_155.f_0))
				{
					if (func_310(unk_0x18F7BE9ACB7D08F4(), Local_155.f_0, 10f, 1))
					{
						func_291();
					}
				}
...
void func_1()
{
	switch (iLocal_147)
	{
		case 0:
			...
			if (unk_0xFAFFA408239A026B(sLocal_168))
			{
				func_340(1);
			}
			else
...
void func_8()
{
	switch (iLocal_149)
	{
		...
		case 1:
			if (unk_0x31F12808DC47A9E5(iLocal_178))
			{
				if (!unk_0x74C2FE037DFC8B4A(iLocal_178, 0))
				{
					if (func_310(unk_0x18F7BE9ACB7D08F4(), iLocal_178, 1f, 1))
					{
						unk_0x7D154B840BD03D00(unk_0x18F7BE9ACB7D08F4(), joaat("gadget_parachute"), 1, 0, 0);
						unk_0x5BE35A26B9097351(&iLocal_178);
					}
				}
			}
			if (iLocal_347 == 0)
			...
			if (func_311(unk_0x18F7BE9ACB7D08F4()))
			{
				if (iLocal_375 == 0)
				{
					if (unk_0x11BBEE2752B9D0C8(unk_0x18F7BE9ACB7D08F4(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, 0, 1, 0) && unk_0xA0F074EA9E24102C(unk_0x18F7BE9ACB7D08F4()) == 2)
					{
						iLocal_375 = 1;
					}
				}
				if (func_222(Local_155.f_0))
				{
					...
					{
						if ((unk_0x5AFB8ED811F05E4D() > iLocal_370 + 25000 || unk_0x11BBEE2752B9D0C8(unk_0x18F7BE9ACB7D08F4(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || unk_0x11BBEE2752B9D0C8(unk_0x18F7BE9ACB7D08F4(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
						{
							iLocal_149 = 2;
						}
					}
				}
				else if ((unk_0x5AFB8ED811F05E4D() > iLocal_370 + 25000 || unk_0x11BBEE2752B9D0C8(unk_0x18F7BE9ACB7D08F4(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || unk_0x11BBEE2752B9D0C8(unk_0x18F7BE9ACB7D08F4(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
				{
					iLocal_149 = 2;
				}
			}
			if (unk_0x5AFB8ED811F05E4D() < iLocal_370 + 5000)
			{
				if (unk_0xA7255C604D37FB1D())
				{
		...
		case 2:
			if (((!unk_0x5D063CF6A2578E13(unk_0x18F7BE9ACB7D08F4()) && !unk_0xDDA45FDD097F5240(unk_0x18F7BE9ACB7D08F4())) && unk_0xC2A319FA5560AFF3(unk_0x18F7BE9ACB7D08F4()) < 2f) && !unk_0x0B90D19A63676F41(unk_0x18F7BE9ACB7D08F4()))
			{
...
void func_9()
{
	if (iLocal_375 == 1)
	{
		unk_0xB5BB914B70AA434E(10f, 4f, 0);
		func_209(762);
	}
	func_2(1);
	func_10(84, 1);
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_77(func_96(iParam1, uParam0->f_2), Global_70664, 0);
			if (unk_0xB03A1684359C50A1(uVar0, uParam0->f_1))
			{
				unk_0xD2A9C3F486236CC5(&(uParam0->f_6), 1);
			}
			uVar0 = func_77(func_95(iParam1, uParam0->f_2), Global_70664, 0);
			if (unk_0xB03A1684359C50A1(uVar0, uParam0->f_1))
			{
				unk_0xD2A9C3F486236CC5(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_77(iVar1, Global_70664, 0);
				if (!unk_0xB03A1684359C50A1(uVar0, uParam0->f_1))
				{
					unk_0xD2A9C3F486236CC5(&(uParam0->f_6), 4);
				}
...
void func_223()
{
	...
	if (!unk_0x5400DC5FAEBF30F0(uLocal_352))
	{
	}
	if (!unk_0x5400DC5FAEBF30F0(uLocal_353))
	{
	}
	if (!unk_0x5400DC5FAEBF30F0(uLocal_354))
	{
	}
	if (!unk_0x5400DC5FAEBF30F0(uLocal_355))
	{
	}
	if (!unk_0x5400DC5FAEBF30F0(uLocal_356))
	{
	}
	if (!unk_0x5400DC5FAEBF30F0(uLocal_357))
	{
	}
	if (!unk_0x5400DC5FAEBF30F0(uLocal_358))
	{
	}
	if (!unk_0x5400DC5FAEBF30F0(uLocal_359))
	{
	}
	if (!unk_0x5400DC5FAEBF30F0(uLocal_360))
	{
	}
	if (!unk_0x5400DC5FAEBF30F0(uLocal_361))
	{
	}
	if (!unk_0x5400DC5FAEBF30F0(uLocal_362))
	{
	}
	unk_0x3F9FBB0647D763E2(fVar1);
	unk_0x4A3AD9384F0AAEA0(0);
	unk_0x77B57B2BB7F3EA0A(0);
	unk_0xF70DE7344EBF0825(unk_0x8CFC7D6E1DA5D304(), false, 128);
	unk_0xA11D9B06B99FE786("EXTREME_04_CUSTOM_QUIET_SCENE");
	func_238(800, 0);
	iLocal_376 = 0;
	iLocal_377 = 0;
	iLocal_379 = 0;
	...
	iLocal_377 = 0;
	iLocal_382 = 0;
	unk_0x4AB98CFBED392E9A("SLOWMO_EXTREME_04");
	unk_0x7916F6A7B5558376(0);
	while (unk_0x5AFB8ED811F05E4D() < iLocal_374 + 11000 && !unk_0xEC0ECEF2AF3FDA8D())
	{
		if (!unk_0xCF0FA6AB02EA68F7(uLocal_371) && !unk_0xCF0FA6AB02EA68F7(uLocal_372))
		{
			if (func_236(400))
			{
				bLocal_381 = true;
		...
		if (!iLocal_379)
		{
			if (unk_0xCF0FA6AB02EA68F7(uLocal_371))
			{
				if (unk_0x74CE979B042A1253(uLocal_371) == 1f)
				{
					if (func_311(Local_155.f_0))
					{
						uLocal_372 = unk_0x3C3438327FFEB224(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
						uLocal_364 = unk_0x5E35D8CCDF065701("DEFAULT_ANIMATED_CAMERA", 1);
						unk_0x4DD2EB945B4192FD(Local_155.f_0, uLocal_372, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						unk_0x07BA5921A1FAAFFF(uLocal_372, 0);
						unk_0x2C535610856B3F4D(uLocal_364, 1);
						unk_0xFB34CCC40E7806C4(uLocal_364, uLocal_372, "Base_Jump_Spot_02_CAM", "rcmextreme4");
						unk_0xF5F744EF9F4DB21E(1, 0, 3000, 1, 0, 0);
						unk_0x8F2E6C470A0005D4(Local_155.f_0, 0, 0);
						unk_0x13AD763DBD687842(uLocal_363, 0);
						iLocal_379 = 1;
					}
				}
			}
		...
		{
			if (unk_0xCF0FA6AB02EA68F7(uLocal_372) && unk_0x74CE979B042A1253(uLocal_372) >= 0.2f)
			{
				if (!unk_0xCF0FA6AB02EA68F7(uLocal_373))
				{
					unk_0x70AEA93D2FE08DCA("RCM_Extreme4_Fall_and_impact", 0);
				}
			}
			if (unk_0xCF0FA6AB02EA68F7(uLocal_372) && unk_0x74CE979B042A1253(uLocal_372) == 1f)
			{
				if (func_311(Local_155.f_0))
				{
					uLocal_373 = unk_0x3C3438327FFEB224(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
					uLocal_365 = unk_0x5E35D8CCDF065701("DEFAULT_ANIMATED_CAMERA", 1);
					unk_0x4DD2EB945B4192FD(Local_155.f_0, uLocal_373, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
					unk_0x07BA5921A1FAAFFF(uLocal_373, 1);
					unk_0x2C535610856B3F4D(uLocal_365, 1);
					unk_0xFB34CCC40E7806C4(uLocal_365, uLocal_373, "Fall_and_impact_CAM", "rcmextreme4");
					unk_0x158782AFBA8DA86C(uLocal_373);
					unk_0xF5F744EF9F4DB21E(1, 0, 3000, 1, 0, 0);
					unk_0x8F2E6C470A0005D4(Local_155.f_0, 0, 0);
					unk_0x13AD763DBD687842(uLocal_364, 0);
					iLocal_380 = 1;
				}
			}
		}
		else if (unk_0xCF0FA6AB02EA68F7(uLocal_373) && unk_0x74CE979B042A1253(uLocal_373) >= 0.323f)
		{
			if (!iLocal_376)
			{
				unk_0x4F5059FC7C764C51("scr_extrm4_water_splash", 1655.27f, -20.8134f, 133.841f, 0f, 0f, 0f, 1f, 0, 0, 0);
				unk_0xD699205C60A58179(1f);
				func_234();
				iLocal_376 = 1;
			}
			else if (!iLocal_382)
			{
				if (unk_0xCF0FA6AB02EA68F7(uLocal_373) && unk_0x74CE979B042A1253(uLocal_373) >= 0.44f)
				{
					uLocal_180 = unk_0x5E06EB8FFDFE3321("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
					unk_0x3E7DDF777AD399F1(uLocal_180, 1f);
					iLocal_382 = 1;
				}
			}
		}
		if (unk_0x5AFB8ED811F05E4D() > iLocal_374 + 600 && fVar1 == 1f)
		{
			if (!iLocal_377)
			{
				iLocal_377 = 1;
		...
		fVar2 = (1f / 30f);
		fVar3 = (unk_0x64031EF2AE5F9603() / fVar2);
		if (unk_0x5AFB8ED811F05E4D() > iLocal_374 + 630)
		{
		...
		if (unk_0x5AFB8ED811F05E4D() > iLocal_374 + 563)
		{
			if (iVar0 == 1)
			{
				func_3(&uLocal_175);
		...
		if (unk_0x5AFB8ED811F05E4D() > iLocal_374 + 871)
		{
			if (iVar0 == 2)
			{
				if (func_311(Local_155.f_0))
		...
		if (unk_0x5AFB8ED811F05E4D() > iLocal_374 + 2000)
		{
			if (iVar0 == 3)
			{
				if (func_311(Local_155.f_0))
		...
		if (unk_0x5AFB8ED811F05E4D() > iLocal_374 + 3500)
		{
			if (iVar0 == 4)
			{
				iVar0 = 5;
		...
		if (unk_0x5AFB8ED811F05E4D() > iLocal_374 + 10000)
		{
			if (iVar0 != 7)
			{
				unk_0x13AD763DBD687842(uLocal_365, 0);
				uLocal_362 = unk_0x5E35D8CCDF065701("DEFAULT_SCRIPTED_CAMERA", 1);
				unk_0x444064C4BEF055A9(uLocal_362, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
				unk_0xF5F744EF9F4DB21E(1, 0, 3000, 1, 0, 0);
				unk_0x2C535610856B3F4D(uLocal_362, 1);
				iVar0 = 7;
			}
		}
	}
	if (bLocal_381)
	{
		if (unk_0xCF0FA6AB02EA68F7(uLocal_373))
		{
			unk_0x27C1FD582D1D979E(uLocal_373);
		}
		unk_0x633C8E78F68C0DAE("EXT4_JUMPED_OS");
		func_234();
		uLocal_362 = unk_0x5E35D8CCDF065701("DEFAULT_SCRIPTED_CAMERA", 1);
		unk_0x444064C4BEF055A9(uLocal_362, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
		unk_0xF5F744EF9F4DB21E(1, 0, 3000, 1, 0, 0);
	...
	unk_0x380152845FC16FFE("SLOWMO_EXTREME_04");
	func_3(&uLocal_175);
	if (func_311(Local_155.f_0))
	{
		if (iVar0 < 3)
		{
			unk_0x874004759C4BE8DC(Local_155.f_0, 101);
			Var4 = { unk_0x761660F5CE986DC4(Local_155.f_0, 1) };
			if (Var4.f_2 > 155f)
			{
				fVar7 = 155f;
			}
			...
			unk_0x990FFD4FB6ADD630(Local_155.f_0, 1657.046f, -17.4571f, fVar7, 1, 0, 0, 1);
		}
	}
	...
	unk_0x4A3AD9384F0AAEA0(1);
	unk_0x77B57B2BB7F3EA0A(1);
	unk_0xF70DE7344EBF0825(unk_0x8CFC7D6E1DA5D304(), true, 128);
	unk_0x3F9FBB0647D763E2(1f);
	if (func_222(Local_155.f_0))
	{
		if (unk_0xCF0FA6AB02EA68F7(uLocal_373))
		{
			unk_0xE8444942F8401658(uLocal_373, 1f);
		}
		unk_0xD9FCA20C1C5553F7(Local_155.f_0);
		unk_0x8F2E6C470A0005D4(Local_155.f_0, 0, 0);
		unk_0x990FFD4FB6ADD630(Local_155.f_0, 1655.77f, -20.04f, 135.8f, 1, 0, 0, 1);
		unk_0x874004759C4BE8DC(Local_155.f_0, 0);
	}
	func_224(&uLocal_182, 1, unk_0x18F7BE9ACB7D08F4(), "FRANKLIN", 0, 1);
...
void func_226(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!unk_0x0FAE113CE72ED842(unk_0x18F7BE9ACB7D08F4()) && !func_230(unk_0x8CFC7D6E1DA5D304())) && !func_228(unk_0x8CFC7D6E1DA5D304(), 0)) && !func_227())
			{
				unk_0xF74B493CCF90C997(unk_0x18F7BE9ACB7D08F4(), 0);
			}
		}
		else if (!unk_0x0FAE113CE72ED842(unk_0x18F7BE9ACB7D08F4()) && !func_230(unk_0x8CFC7D6E1DA5D304()))
		{
			unk_0xF74B493CCF90C997(unk_0x18F7BE9ACB7D08F4(), 0);
		}
		Global_70850 = 0;
...
void func_239()
{
	if (iLocal_149 < 2)
	{
		unk_0x6662DABCFF1B4AD5("EXT4_JUMPED_OS");
	}
	switch (iLocal_149)
	{
		case 0:
			iLocal_151 = 0;
			if (unk_0x11BBEE2752B9D0C8(unk_0x18F7BE9ACB7D08F4(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, 0, 1, 0))
			{
				unk_0x2638484EFB343584("es_4_rcm_p2_concat", 6, 8);
			}
			else
			{
				unk_0x2638484EFB343584("es_4_rcm_p2_concat", 5, 8);
			}
			unk_0xEF5B50EACBB40FA0(uLocal_367);
			if (unk_0x42AFCF847E4360A0())
			{
				unk_0x58DE45421C2560C5("Dom", 8, 2, 0, 0);
			}
			if (!func_260())
			{
				if (func_254(1, 20f, 1))
				{
					if ((!iLocal_383 || unk_0x5AFB8ED811F05E4D() > iLocal_384 + 3000) || unk_0x8673F2F1802ADEF7(unk_0x18F7BE9ACB7D08F4(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0))
					{
						unk_0x7916F6A7B5558376(1);
						unk_0xCE82A1B9F41AE9D1(2048);
						if (func_311(Local_155.f_0))
						{
							unk_0x8440A52435684AA5(Local_155.f_0, "Dom", 0, joaat("cs_dom"), 0);
						}
						unk_0x4EDE34FBADD967A6(0);
						iLocal_383 = 0;
						unk_0xBC3C2A3068412290(0);
						unk_0x64D773F3BE6DC50A("EXTREME_04_CUSTOM_QUIET_SCENE");
						if (func_311(Local_155.f_0))
						{
							unk_0x73D7E57BF0ED7FEB(Local_155.f_0, 0);
						}
						if (unk_0x31F12808DC47A9E5(iLocal_179) && !unk_0x74C2FE037DFC8B4A(iLocal_179, 0))
						{
							unk_0xA12407EB7D7CF146(iLocal_179, 0, 0);
						}
						if (unk_0x657B649BA2AD3582(unk_0x18F7BE9ACB7D08F4(), 0))
						{
							iLocal_172 = unk_0x5AD687C3474F04B4(unk_0x18F7BE9ACB7D08F4(), 0);
							iLocal_181 = unk_0x4F69FBD64CDF125B(iLocal_172);
							if (unk_0x881022B41FD53CD6(iLocal_181) == 1 || unk_0x422717A3330EA45D(iLocal_181) == 1)
							{
						...
						unk_0xE6B6928D4EED07B1(1660.186f, -7.492f, 172.774f, 200f, 0);
						uLocal_366 = unk_0x1701E0E6A11D6B65(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
						iLocal_149 = 1;
					}
				}
			}
		...
		case 1:
			if (unk_0xEAE1A41FBC3984B1())
			{
				if (unk_0xAA006BC2D04125D0(0))
				{
					if (!iLocal_154)
					{
						if (!unk_0xCF0FA6AB02EA68F7(uLocal_371))
						{
							if (func_311(Local_155.f_0))
							{
								if (!unk_0x5400DC5FAEBF30F0(uLocal_363))
								{
									uLocal_363 = unk_0x5E35D8CCDF065701("DEFAULT_ANIMATED_CAMERA", 1);
								}
								unk_0x2C535610856B3F4D(uLocal_363, 1);
								unk_0xF5F744EF9F4DB21E(1, 0, 3000, 1, 0, 0);
								uLocal_371 = unk_0x3C3438327FFEB224(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
								unk_0x4DD2EB945B4192FD(Local_155.f_0, uLocal_371, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
								unk_0x07BA5921A1FAAFFF(uLocal_371, 1);
								unk_0x2C535610856B3F4D(uLocal_363, 1);
								unk_0xFB34CCC40E7806C4(uLocal_363, uLocal_371, "Base_Jump_Spot_CAM", "rcmextreme4");
								unk_0xF5F744EF9F4DB21E(1, 0, 3000, 1, 0, 0);
								unk_0x8F2E6C470A0005D4(Local_155.f_0, 0, 0);
								iLocal_154 = 1;
							}
				...
				if (func_311(Local_155.f_0))
				{
					if (unk_0x2D6E6D9121DADEC3("Dom", 0))
					{
						iLocal_149 = 2;
					}
				}
		...
		case 2:
			...
			if (unk_0x31F12808DC47A9E5(iLocal_179) && !unk_0x74C2FE037DFC8B4A(iLocal_179, 0))
			{
				unk_0xA12407EB7D7CF146(iLocal_179, 1, 0);
			}
			if (iLocal_151 == 0)
			{
				unk_0x9BEA833CAF67289C("EXT4_JUMPED_OS");
				func_240(3);
			}
			break;
	}
...
void func_241(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0x557001354138B7FB(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0xE6B6928D4EED07B1(func_242(unk_0x0A91D180DDC7A1B8()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_244(struct<3> Param0, float fParam3)
{
	...
	if (!unk_0x0FAE113CE72ED842(unk_0x18F7BE9ACB7D08F4()))
	{
		...
		if (unk_0x31F12808DC47A9E5(iVar0))
		{
			...
			{
				unk_0x990FFD4FB6ADD630(iVar0, Param0, 1, 0, 0, 1);
...
int func_254(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x657B649BA2AD3582(unk_0x18F7BE9ACB7D08F4(), 0))
	{
		...
		{
			if (!func_258(unk_0x5AD687C3474F04B4(unk_0x18F7BE9ACB7D08F4(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_257(unk_0x18F7BE9ACB7D08F4(), -828834893))
				{
...
void func_261()
{
	if (!unk_0x0FAE113CE72ED842(unk_0x18F7BE9ACB7D08F4()))
	{
		...
		{
			if (((((((unk_0x02EA7C5633421A0F(0, 30) || unk_0x02EA7C5633421A0F(0, 31)) || unk_0x02EA7C5633421A0F(0, 23)) || unk_0x02EA7C5633421A0F(0, 21)) || unk_0x02EA7C5633421A0F(0, 22)) || (func_273() && unk_0x02EA7C5633421A0F(0, 1))) || (func_273() && unk_0x02EA7C5633421A0F(0, 2))) || (func_273() && unk_0x02EA7C5633421A0F(0, 32)))
			{
	...
	switch (iLocal_149)
	{
		case 0:
			...
			{
				unk_0x273FE09AE985A00A(Local_82.f_28[0], 17, 1);
			}
			iLocal_368 = 0;
			iLocal_383 = 1;
		...
		case 1:
			...
			if (func_311(unk_0x18F7BE9ACB7D08F4()))
			{
				if (func_311(Local_155.f_0))
				{
					if (func_310(unk_0x18F7BE9ACB7D08F4(), Local_155.f_0, 100f, 1))
					{
						unk_0x2638484EFB343584("es_4_rcm_p2_concat", 6, 8);
						if (unk_0x42AFCF847E4360A0())
						{
					...
					if (unk_0x0B90D19A63676F41(Local_155.f_0))
					{
						unk_0x874004759C4BE8DC(Local_155.f_0, 0);
					}
					if (func_310(unk_0x18F7BE9ACB7D08F4(), Local_155.f_0, 32f, 1))
					{
						...
						else
						{
							if (!iLocal_378)
							{
								if (func_310(unk_0x18F7BE9ACB7D08F4(), Local_155.f_0, 30f, 1) && !func_260())
								{
							...
							func_263();
							if (!unk_0xF8491170DDFDAA84(unk_0x18F7BE9ACB7D08F4(), Local_155.f_0))
							{
								unk_0x6016A20BFEAEFE11(unk_0x18F7BE9ACB7D08F4(), Local_155.f_0, -1, 0, 2);
							}
						}
					}
					if (unk_0x11BBEE2752B9D0C8(unk_0x18F7BE9ACB7D08F4(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, 0, 1, 0))
					{
						if (!unk_0x657B649BA2AD3582(unk_0x18F7BE9ACB7D08F4(), 0))
						{
							iLocal_149 = 2;
		...
		case 2:
			...
			if (func_311(unk_0x18F7BE9ACB7D08F4()))
			{
				if (unk_0x657B649BA2AD3582(unk_0x18F7BE9ACB7D08F4(), 0))
				{
					unk_0x7F8DAED41E5794FC(unk_0x5AD687C3474F04B4(unk_0x18F7BE9ACB7D08F4(), 0), 5f, 1, 0);
...
void func_262()
{
	if (func_311(Local_155.f_0))
	{
		if (unk_0x2BBAA45ECDE3DAE2(Local_155.f_0, 242628503) != 1)
		{
			unk_0x73F69DD57B7E92A9(Local_155.f_0, uLocal_171);
		}
	}
}
...
void func_263()
{
	if (!func_260())
	{
		if (iLocal_368 < 5)
		{
			if (unk_0x5AFB8ED811F05E4D() > (iLocal_369 + (8000 + unk_0x61E9B3BFA06B017B(0, 2000))))
			{
				if (unk_0x688DCBE66AEC44C4(uLocal_367))
				{
	...
	if (!func_260())
	{
		if ((unk_0xFF22FE9205F44FB6("EXTREME_04_DOM_A", 0, -1) && unk_0xFF22FE9205F44FB6("EXTREME_04_DOM_B", 0, -1)) && unk_0xFF22FE9205F44FB6("EXTREME_04_DOM_C", 0, -1))
		{
			if (unk_0x688DCBE66AEC44C4(uLocal_367))
			{
				unk_0x598D55F9D453C505(uLocal_367, "DOM", Local_155.f_0, "EXTREME_04_SOUNDSET", 0, 0);
			}
		}
	}
}
...
int func_268(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_252(Param1 - unk_0x761660F5CE986DC4(iParam0, 1)) };
	...
	{
		Var3 = { func_252(unk_0x433176BD83D09D7E(iParam0, 31086, 0f, 5f, 0f) - unk_0x433176BD83D09D7E(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_274()
{
	...
	else
	{
		...
		unk_0xA303A4837FBB8DDE(unk_0x18F7BE9ACB7D08F4(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
		func_238(800, 0);
		iLocal_152 = 1;
		func_281(1, 1, 1);
	}
...
void func_275()
{
	...
	unk_0xA303A4837FBB8DDE(Local_82.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 0.25f, 0, 40000f);
	unk_0x6D7801DE0E52AE2C("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 0);
	unk_0xE54597236B7D8C63(Local_155.f_1, 20f, 0, 0, 0, 0, 0, 0);
	if (!unk_0x31F12808DC47A9E5(iLocal_173))
	{
		iLocal_173 = unk_0x3064CCF56C6C32BC(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, 1, 1, 0);
	}
	if (!unk_0x31F12808DC47A9E5(iLocal_174))
	{
		iLocal_174 = unk_0x3064CCF56C6C32BC(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, 1, 1, 0);
	}
	if (!unk_0x31F12808DC47A9E5(iLocal_176))
	{
		iLocal_176 = unk_0x7082ECB3731CD86C(joaat("prop_box_wood01a"), 1666.282f, -11.20408f, 172.7773f, 1, 1, 0);
		unk_0x58F6B49606932378(iLocal_176, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!unk_0x31F12808DC47A9E5(iLocal_177))
	{
		iLocal_177 = unk_0x7082ECB3731CD86C(joaat("prop_box_wood01a"), 1667.076f, -12.07778f, 173.2611f, 1, 1, 0);
		unk_0x58F6B49606932378(iLocal_177, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_311(Local_155.f_0))
	{
		if (unk_0x2BBAA45ECDE3DAE2(Local_155.f_0, 242628503) != 1)
		{
			unk_0xC8BEB049F3BFC0AB(&uLocal_171);
			unk_0xB5746603774C4C9D(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xB5746603774C4C9D(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xB5746603774C4C9D(0, "rcmextreme4", "fidget_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xB5746603774C4C9D(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xB5746603774C4C9D(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xB5746603774C4C9D(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xB5746603774C4C9D(0, "rcmextreme4", "fidget_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x8F251305F4CAD788(uLocal_171, 1);
			unk_0xAFDA7B8F83B2CA58(uLocal_171);
			unk_0x73F69DD57B7E92A9(Local_155.f_0, uLocal_171);
		}
	}
	if (func_311(Local_155.f_0))
	{
		unk_0xFE6A6646619C0AED(Local_155.f_0, 0);
		func_224(&uLocal_182, 4, Local_155.f_0, "DOM", 0, 1);
		unk_0x641E77554763EF06(Local_155.f_0, unk_0x773D11D22FA84F6D(unk_0x18F7BE9ACB7D08F4()));
	}
	if (!unk_0x31F12808DC47A9E5(iLocal_179))
	{
		iLocal_179 = unk_0xCEE0CA4013E48409(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
	}
	unk_0x58F6B49606932378(iLocal_179, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	unk_0x33AE9ADB6499B6DB(iLocal_179, "Chute_Off_Bag", "skydive@parachute@", 4f, 0, 1, 0, 0.99f, 0);
	func_240(1);
}
...
void func_285()
{
	switch (iLocal_150)
	{
		case 0:
			...
			{
				if (!iLocal_383 || unk_0x5AFB8ED811F05E4D() > iLocal_384 + 3500)
				{
					func_286();
					unk_0x7916F6A7B5558376(1);
					...
					if (func_222(Local_82.f_28[0]))
					{
						unk_0x8440A52435684AA5(Local_82.f_28[0], "Hudson", 0, joaat("a_c_retriever"), 0);
					}
					unk_0x4EDE34FBADD967A6(0);
					unk_0xBC3C2A3068412290(0);
		...
		case 2:
			func_279(unk_0x18F7BE9ACB7D08F4(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			unk_0x1DCD07B7EA2DDAFE(unk_0x18F7BE9ACB7D08F4(), joaat("MotionState_Walk"), 0, 1, 0);
			unk_0x70FFF831DC7E9FC8(unk_0x18F7BE9ACB7D08F4(), 1f);
			unk_0xA303A4837FBB8DDE(unk_0x18F7BE9ACB7D08F4(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
			unk_0x4CCECEB2EA5D6A82(0f, 1065353216);
...
int func_287(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0x657B649BA2AD3582(unk_0x18F7BE9ACB7D08F4(), 0))
	{
		if ((!unk_0x8E8D5D5EC87F35D7(unk_0x18F7BE9ACB7D08F4()) && !unk_0x38E433ABCF3784A4(unk_0x18F7BE9ACB7D08F4())) && !unk_0x3C08111698DB7162(unk_0x18F7BE9ACB7D08F4()))
		{
			if (!func_258(unk_0x5AD687C3474F04B4(unk_0x18F7BE9ACB7D08F4(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_290()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_324() && func_311(Local_82.f_28[0])) && func_311(unk_0x18F7BE9ACB7D08F4())) && iLocal_383 == 1)
	{
		if (!unk_0x76AF8AC551A53D4C())
		{
			unk_0xF70DE7344EBF0825(unk_0x8CFC7D6E1DA5D304(), false, 0);
			unk_0x6016A20BFEAEFE11(unk_0x18F7BE9ACB7D08F4(), Local_82.f_28[0], -1, 0, 2);
			unk_0x660A0833403DB7B4(unk_0x18F7BE9ACB7D08F4(), Local_82.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
			unk_0x33A9F3CD35CB0655(1);
			unk_0x211B8384E5838644(Local_82.f_28[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, 0);
			unk_0x1A653E20651F0FD4(fVar0);
			unk_0x089F94E871B1FD43(fVar1);
			unk_0xE70AD31C98116EDB(fVar2);
			unk_0xB0AF33801D767F98(fVar3);
			unk_0xD20A8016E96CF139(fVar4);
			iLocal_384 = unk_0x5AFB8ED811F05E4D();
		}
		else
		{
			if (func_310(unk_0x18F7BE9ACB7D08F4(), Local_82.f_28[0], 4f, 1))
			{
...
void func_291()
{
	...
	if (iLocal_383)
	{
		if (!unk_0x76AF8AC551A53D4C())
		{
			unk_0xF70DE7344EBF0825(unk_0x8CFC7D6E1DA5D304(), false, 0);
			unk_0x6016A20BFEAEFE11(unk_0x18F7BE9ACB7D08F4(), Local_155.f_0, -1, 0, 2);
			unk_0xA303A4837FBB8DDE(unk_0x18F7BE9ACB7D08F4(), 1658.95f, -5.45f, 173.78f, 1f, -1, 0.25f, 0, -161.08f);
			unk_0x33A9F3CD35CB0655(1);
			unk_0x211B8384E5838644(Local_155.f_0, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
			unk_0x1A653E20651F0FD4(fVar0);
			unk_0x089F94E871B1FD43(fVar1);
			unk_0xE70AD31C98116EDB(fVar2);
			unk_0xB0AF33801D767F98(fVar3);
...
void func_292()
{
	...
	if (iLocal_148 == 1)
	{
		...
		{
			fVar0 = unk_0x15EE504466B7BBD3(unk_0x761660F5CE986DC4(unk_0x18F7BE9ACB7D08F4(), 1), unk_0x761660F5CE986DC4(Local_155.f_0, 1), 1);
			if (iLocal_153 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			if (fVar0 > 150f)
			{
				...
				{
					unk_0xC3BBD8D349129F55(uLocal_170, 1);
				}
			}
			else if (unk_0xE769D9B5158D0F11(uLocal_170))
			{
				unk_0xC3BBD8D349129F55(uLocal_170, 0);
			}
		}
		if (unk_0x11BBEE2752B9D0C8(unk_0x18F7BE9ACB7D08F4(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, 0, 1, 0))
		{
			sLocal_168 = "EXT4_F2";
			iLocal_148 = 4;
		}
	...
	if (Global_71106 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0xEC0ECEF2AF3FDA8D())
			{
				...
				Var4 = { func_295(Global_71107, Global_71109, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_307(0) || Global_71121) || Global_71110 == 1) || !unk_0xC8AB6A5E6C1E6613())
	{
		return 0;
	}
	switch (Global_71106)
	{
		...
		case 5:
			if ((unk_0xEAE1A41FBC3984B1() || func_306(0)) || func_305(1))
			{
			}
			else
			{
...
{
	return func_309(iParam0, Global_35859);
}
...
void func_312()
{
	...
	unk_0x8E058779F430F4D7("EXT4", 0);
	while (!unk_0x9F22E45F3CF7EACA(0))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	unk_0x9016574B77A748EE(joaat("prop_box_guncase_03a"));
	unk_0x9016574B77A748EE(joaat("prop_box_wood01a"));
	unk_0x9016574B77A748EE(joaat("p_parachute_s"));
	unk_0x9016574B77A748EE(joaat("bmx"));
	while (((!unk_0xEDFE27D1AEA0EA7F(joaat("prop_box_guncase_03a")) || !unk_0xEDFE27D1AEA0EA7F(joaat("prop_box_wood01a"))) || !unk_0xEDFE27D1AEA0EA7F(joaat("p_parachute_s"))) || !unk_0xEDFE27D1AEA0EA7F(joaat("bmx")))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0x31F12808DC47A9E5(uLocal_175))
	{
		iLocal_175 = unk_0xF9AE1AECDAABDFA9(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, 1, 1, 0);
		unk_0x58F6B49606932378(iLocal_175, 90f, 0f, -63f, 2, 1);
		unk_0x73D7E57BF0ED7FEB(iLocal_175, 1);
		unk_0xA12407EB7D7CF146(iLocal_175, 0, 0);
	}
	func_316(1);
	if (!unk_0x31F12808DC47A9E5(Local_155.f_0))
	{
		func_313(&Local_155, 52, Local_155.f_1, Local_155.f_4, "Ext4-Dom", 1);
		unk_0x73D7E57BF0ED7FEB(Local_155.f_0, 1);
		unk_0x40E2910BAF39B1C7(Local_155.f_0, 1);
		unk_0x5FF97B71C576EF53(Local_155.f_0, 1);
		unk_0xDEA702F2138E0B35(Local_155.f_0, 8, 2, 0, 0);
		unk_0x0FD0F9C088D4B182(Local_155.f_0, 1);
		unk_0x764AFC5A3A16C2B0(Local_155.f_0, 137, 1);
		unk_0x764AFC5A3A16C2B0(Local_155.f_0, 118, 0);
		unk_0x764AFC5A3A16C2B0(Local_155.f_0, 208, 1);
		unk_0xD592E5486B0119A2(Local_155.f_0, 5000);
	}
	if (func_222(unk_0x18F7BE9ACB7D08F4()))
	{
		func_224(&uLocal_182, 1, unk_0x18F7BE9ACB7D08F4(), "FRANKLIN", 0, 1);
...
{
	unk_0x9016574B77A748EE(Local_155.f_5);
	unk_0x831CD0FBFB26EC7E("rcmextreme4");
	unk_0x831CD0FBFB26EC7E("skydive@parachute@");
	unk_0x9016574B77A748EE(joaat("sanchez"));
	unk_0xF43D99776B580DA7();
	if (iParam0 == 1)
	{
		while ((((!unk_0xEDFE27D1AEA0EA7F(Local_155.f_5) || !unk_0xEDFE27D1AEA0EA7F(joaat("sanchez"))) || !unk_0x028356968FDD2DF2("rcmextreme4")) || !unk_0x028356968FDD2DF2("skydive@parachute@")) || !unk_0x8851E7053F291F92())
		{
			unk_0x4EDE34FBADD967A6(0);
		}
	}
...
void func_325(int iParam0)
{
	...
	unk_0x6D7801DE0E52AE2C("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 1);
...
void func_338()
{
	...
	unk_0x334F1DD67B2EC86A("rcmextreme4");
}
