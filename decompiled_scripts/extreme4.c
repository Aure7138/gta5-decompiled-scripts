...
void __EntryFunction__()
{
	...
	uLocal_367 = unk_0x8CCC0A0504C52531();
	...
	if (unk_0x765F6FEEFF39224F(iLocal_179))
	{
	}
	func_312();
	if (!func_324())
	{
		if ((func_311(Local_82.f_28[0]) && func_311(unk_0x33CD235DF1E6A94E())) && !func_310(unk_0x33CD235DF1E6A94E(), Local_82.f_28[0], 4f, 1))
		{
			iLocal_383 = 1;
		}
	}
	while (true)
	{
		...
		unk_0x65F534DDBF48606F("SF_UR", 0);
		...
		{
			if (func_311(unk_0x33CD235DF1E6A94E()) && unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, 1, 0))
			{
				if (func_311(Local_155.f_0))
				{
					if (func_310(unk_0x33CD235DF1E6A94E(), Local_155.f_0, 10f, 1))
					{
						func_291();
					}
				}
...
void func_1()
{
	switch (iLocal_147)
	{
		case 0:
			...
			if (unk_0x786AF4A44E1B5B4B(sLocal_168))
			{
				func_340(1);
			}
			else
...
void func_8()
{
	switch (iLocal_149)
	{
		...
		case 1:
			...
			{
				if (!unk_0xD62C4419A41F106A(iLocal_178, 0))
				{
					if (func_310(unk_0x33CD235DF1E6A94E(), iLocal_178, 1f, 1))
					{
						unk_0x697EBA5CF1A6AB57(unk_0x33CD235DF1E6A94E(), joaat("gadget_parachute"), 1, 0, 0);
						unk_0xEC26F4BFC9942A0C(&iLocal_178);
					}
				}
			}
			if (iLocal_347 == 0)
			...
			if (func_311(unk_0x33CD235DF1E6A94E()))
			{
				if (iLocal_375 == 0)
				{
					if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, 0, 1, 0) && unk_0xDBAC1EFC22D74E44(unk_0x33CD235DF1E6A94E()) == 2)
					{
						iLocal_375 = 1;
					}
				}
				if (func_222(Local_155.f_0))
				{
					...
					{
						if ((unk_0xE3903F59E2F22150() > iLocal_370 + 25000 || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
						{
							iLocal_149 = 2;
						}
					}
				}
				else if ((unk_0xE3903F59E2F22150() > iLocal_370 + 25000 || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
				{
					iLocal_149 = 2;
				}
			}
			if (unk_0xE3903F59E2F22150() < iLocal_370 + 5000)
			{
				if (unk_0x239E30C22D4EE2C6())
				{
		...
		case 2:
			if (((!unk_0xE19223B3551F58B8(unk_0x33CD235DF1E6A94E()) && !unk_0xD084701173607F29(unk_0x33CD235DF1E6A94E())) && unk_0x06EDAF915C19EB69(unk_0x33CD235DF1E6A94E()) < 2f) && !unk_0x3AF2B3B68DD52355(unk_0x33CD235DF1E6A94E()))
			{
...
void func_9()
{
	if (iLocal_375 == 1)
	{
		unk_0xB5D26BFA756D0D11(10f, 4f, 0);
		func_209(762);
	}
	func_2(1);
	func_10(84, 1);
...
void func_223()
{
	...
	if (!unk_0x117DAF3BF7232886(uLocal_352))
	{
	}
	if (!unk_0x117DAF3BF7232886(uLocal_353))
	{
	}
	if (!unk_0x117DAF3BF7232886(uLocal_354))
	{
	}
	if (!unk_0x117DAF3BF7232886(uLocal_355))
	{
	}
	if (!unk_0x117DAF3BF7232886(uLocal_356))
	{
	}
	if (!unk_0x117DAF3BF7232886(uLocal_357))
	{
	}
	if (!unk_0x117DAF3BF7232886(uLocal_358))
	{
	}
	if (!unk_0x117DAF3BF7232886(uLocal_359))
	{
	}
	if (!unk_0x117DAF3BF7232886(uLocal_360))
	{
	}
	if (!unk_0x117DAF3BF7232886(uLocal_361))
	{
	}
	if (!unk_0x117DAF3BF7232886(uLocal_362))
	{
	}
	unk_0xCBDC8BC7A589C76E(fVar1);
	unk_0x35675D19812BDF22(0);
	unk_0xDFF589A2149528CE(0);
	unk_0x3449EA232F9B8EAD(unk_0x95B959F18401C09A(), false, 128);
	unk_0x7CED302277C0F3D3("EXTREME_04_CUSTOM_QUIET_SCENE");
	func_238(800, 0);
	iLocal_376 = 0;
	iLocal_377 = 0;
	iLocal_379 = 0;
	...
	iLocal_377 = 0;
	iLocal_382 = 0;
	unk_0xAC9D950541866E3F("SLOWMO_EXTREME_04");
	unk_0xF68C9C9A191F2B68(0);
	while (unk_0xE3903F59E2F22150() < iLocal_374 + 11000 && !unk_0xBB5E373390A5F824())
	{
		if (!unk_0xDB4C79A9697E6A55(uLocal_371) && !unk_0xDB4C79A9697E6A55(uLocal_372))
		{
			if (func_236(400))
			{
				bLocal_381 = true;
		...
		if (!iLocal_379)
		{
			if (unk_0xDB4C79A9697E6A55(uLocal_371))
			{
				if (unk_0x4EDDCE9AAE0FC976(uLocal_371) == 1f)
				{
					if (func_311(Local_155.f_0))
					{
						uLocal_372 = unk_0x38A6890195DD00D1(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
						uLocal_364 = unk_0x00E62F31D05EB2AC("DEFAULT_ANIMATED_CAMERA", 1);
						unk_0x08798CBF817BA887(Local_155.f_0, uLocal_372, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						unk_0x34C803C2BC1CAFB2(uLocal_372, 0);
						unk_0x189377BFBDC9127F(uLocal_364, 1);
						unk_0x76909D790DDFDCE9(uLocal_364, uLocal_372, "Base_Jump_Spot_02_CAM", "rcmextreme4");
						unk_0x63F0B040CE6EDF0F(1, 0, 3000, 1, 0, 0);
						unk_0x880B00F3FAE4C022(Local_155.f_0, 0, 0);
						unk_0x2F8A4DF7D0DFF0A8(uLocal_363, 0);
						iLocal_379 = 1;
					}
				}
			}
		...
		{
			if (unk_0xDB4C79A9697E6A55(uLocal_372) && unk_0x4EDDCE9AAE0FC976(uLocal_372) >= 0.2f)
			{
				if (!unk_0xDB4C79A9697E6A55(uLocal_373))
				{
					unk_0xB07C5277D109E240("RCM_Extreme4_Fall_and_impact", 0);
				}
			}
			if (unk_0xDB4C79A9697E6A55(uLocal_372) && unk_0x4EDDCE9AAE0FC976(uLocal_372) == 1f)
			{
				if (func_311(Local_155.f_0))
				{
					uLocal_373 = unk_0x38A6890195DD00D1(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
					uLocal_365 = unk_0x00E62F31D05EB2AC("DEFAULT_ANIMATED_CAMERA", 1);
					unk_0x08798CBF817BA887(Local_155.f_0, uLocal_373, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
					unk_0x34C803C2BC1CAFB2(uLocal_373, 1);
					unk_0x189377BFBDC9127F(uLocal_365, 1);
					unk_0x76909D790DDFDCE9(uLocal_365, uLocal_373, "Fall_and_impact_CAM", "rcmextreme4");
					unk_0xCD2F9B1910503400(uLocal_373);
					unk_0x63F0B040CE6EDF0F(1, 0, 3000, 1, 0, 0);
					unk_0x880B00F3FAE4C022(Local_155.f_0, 0, 0);
					unk_0x2F8A4DF7D0DFF0A8(uLocal_364, 0);
					iLocal_380 = 1;
				}
			}
		}
		else if (unk_0xDB4C79A9697E6A55(uLocal_373) && unk_0x4EDDCE9AAE0FC976(uLocal_373) >= 0.323f)
		{
			if (!iLocal_376)
			{
				unk_0xCE6951DBE6A6A68E("scr_extrm4_water_splash", 1655.27f, -20.8134f, 133.841f, 0f, 0f, 0f, 1f, 0, 0, 0);
				unk_0x89F3C8AB1FEA591B(1f);
				func_234();
				iLocal_376 = 1;
			}
			else if (!iLocal_382)
			{
				if (unk_0xDB4C79A9697E6A55(uLocal_373) && unk_0x4EDDCE9AAE0FC976(uLocal_373) >= 0.44f)
				{
					uLocal_180 = unk_0xC5466C3A31DBCD76("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
					unk_0x6082CF5A3BB6D714(uLocal_180, 1f);
					iLocal_382 = 1;
				}
			}
		}
		if (unk_0xE3903F59E2F22150() > iLocal_374 + 600 && fVar1 == 1f)
		{
			if (!iLocal_377)
			{
				iLocal_377 = 1;
		...
		fVar2 = (1f / 30f);
		fVar3 = (unk_0x7C475FA8D877007F() / fVar2);
		if (unk_0xE3903F59E2F22150() > iLocal_374 + 630)
		{
		...
		if (unk_0xE3903F59E2F22150() > iLocal_374 + 563)
		{
			if (iVar0 == 1)
			{
				func_3(&uLocal_175);
		...
		if (unk_0xE3903F59E2F22150() > iLocal_374 + 871)
		{
			if (iVar0 == 2)
			{
				if (func_311(Local_155.f_0))
		...
		if (unk_0xE3903F59E2F22150() > iLocal_374 + 2000)
		{
			if (iVar0 == 3)
			{
				if (func_311(Local_155.f_0))
		...
		if (unk_0xE3903F59E2F22150() > iLocal_374 + 3500)
		{
			if (iVar0 == 4)
			{
				iVar0 = 5;
		...
		if (unk_0xE3903F59E2F22150() > iLocal_374 + 10000)
		{
			if (iVar0 != 7)
			{
				unk_0x2F8A4DF7D0DFF0A8(uLocal_365, 0);
				uLocal_362 = unk_0x00E62F31D05EB2AC("DEFAULT_SCRIPTED_CAMERA", 1);
				unk_0x2AAFDB86F2CBFB67(uLocal_362, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
				unk_0x63F0B040CE6EDF0F(1, 0, 3000, 1, 0, 0);
				unk_0x189377BFBDC9127F(uLocal_362, 1);
				iVar0 = 7;
			}
		}
	}
	if (bLocal_381)
	{
		if (unk_0xDB4C79A9697E6A55(uLocal_373))
		{
			unk_0xBAAE4EDEBAEC4378(uLocal_373);
		}
		unk_0x33854B8151B6D8EC("EXT4_JUMPED_OS");
		func_234();
		uLocal_362 = unk_0x00E62F31D05EB2AC("DEFAULT_SCRIPTED_CAMERA", 1);
		unk_0x2AAFDB86F2CBFB67(uLocal_362, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
		unk_0x63F0B040CE6EDF0F(1, 0, 3000, 1, 0, 0);
	...
	unk_0x1A0C641ECB831C03("SLOWMO_EXTREME_04");
	func_3(&uLocal_175);
	if (func_311(Local_155.f_0))
	{
		if (iVar0 < 3)
		{
			unk_0x7FC2040EB34E0E31(Local_155.f_0, 101, 0);
			Var4 = { unk_0xFBB1F99A825CAB09(Local_155.f_0, 1) };
			if (Var4.f_2 > 155f)
			{
				fVar7 = 155f;
			}
			...
			unk_0xBEADAF07D2339505(Local_155.f_0, 1657.046f, -17.4571f, fVar7, 1, 0, 0, 1);
		}
	}
	...
	unk_0x35675D19812BDF22(1);
	unk_0xDFF589A2149528CE(1);
	unk_0x3449EA232F9B8EAD(unk_0x95B959F18401C09A(), true, 128);
	unk_0xCBDC8BC7A589C76E(1f);
	if (func_222(Local_155.f_0))
	{
		if (unk_0xDB4C79A9697E6A55(uLocal_373))
		{
			unk_0xDD450B93C16ACEA7(uLocal_373, 1f);
		}
		unk_0x31826EF4A8BC8E9F(Local_155.f_0);
		unk_0x880B00F3FAE4C022(Local_155.f_0, 0, 0);
		unk_0xBEADAF07D2339505(Local_155.f_0, 1655.77f, -20.04f, 135.8f, 1, 0, 0, 1);
		unk_0x7FC2040EB34E0E31(Local_155.f_0, 0, 0);
	}
	func_224(&uLocal_182, 1, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
...
void func_239()
{
	if (iLocal_149 < 2)
	{
		unk_0x7E2EAC500C9B54E3("EXT4_JUMPED_OS");
	}
	switch (iLocal_149)
	{
		case 0:
			iLocal_151 = 0;
			if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, 0, 1, 0))
			{
				unk_0xAD16833367AC0879("es_4_rcm_p2_concat", 6, 8);
			}
			else
			{
				unk_0xAD16833367AC0879("es_4_rcm_p2_concat", 5, 8);
			}
			unk_0xCBE6AF58552C63B2(uLocal_367);
			if (unk_0xA812C1043FE92B58())
			{
				unk_0xBFD0F8E7B0DF0A1B("Dom", 8, 2, 0, 0);
			}
			if (!func_260())
			{
				if (func_254(1, 20f, 1))
				{
					if ((!iLocal_383 || unk_0xE3903F59E2F22150() > iLocal_384 + 3000) || unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0))
					{
						unk_0xF68C9C9A191F2B68(1);
						unk_0x2EC4FFC8740228D3(2048);
						if (func_311(Local_155.f_0))
						{
							unk_0xEF6624A3AFF02A02(Local_155.f_0, "Dom", 0, joaat("cs_dom"), 0);
						}
						unk_0x4EDE34FBADD967A6(0);
						iLocal_383 = 0;
						unk_0x3754CDF254D9F523(0);
						unk_0xDEFB5E2E5CBD460A("EXTREME_04_CUSTOM_QUIET_SCENE");
						if (func_311(Local_155.f_0))
						{
							unk_0xF70578F5CD9822CB(Local_155.f_0, 0);
						}
						if (unk_0x765F6FEEFF39224F(iLocal_179) && !unk_0xD62C4419A41F106A(iLocal_179, 0))
						{
							unk_0x0CDD28A9DFCE2FCE(iLocal_179, 0, 0);
						}
						if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
						{
							iLocal_172 = unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0);
							iLocal_181 = unk_0x541D5C57194E73C4(iLocal_172);
							if (unk_0x0C2E237744BA0026(iLocal_181) == 1 || unk_0x9E374B5F44A76AE2(iLocal_181) == 1)
							{
						...
						unk_0x9C47E5CDFB45F474(1660.186f, -7.492f, 172.774f, 200f, 0);
						uLocal_366 = unk_0x0335D8135051EA56(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
						iLocal_149 = 1;
					}
				}
			}
		...
		case 1:
			if (unk_0x286C823E0969F22A())
			{
				if (unk_0x2442598EA366437F(0))
				{
					if (!iLocal_154)
					{
						if (!unk_0xDB4C79A9697E6A55(uLocal_371))
						{
							if (func_311(Local_155.f_0))
							{
								if (!unk_0x117DAF3BF7232886(uLocal_363))
								{
									uLocal_363 = unk_0x00E62F31D05EB2AC("DEFAULT_ANIMATED_CAMERA", 1);
								}
								unk_0x189377BFBDC9127F(uLocal_363, 1);
								unk_0x63F0B040CE6EDF0F(1, 0, 3000, 1, 0, 0);
								uLocal_371 = unk_0x38A6890195DD00D1(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
								unk_0x08798CBF817BA887(Local_155.f_0, uLocal_371, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
								unk_0x34C803C2BC1CAFB2(uLocal_371, 1);
								unk_0x189377BFBDC9127F(uLocal_363, 1);
								unk_0x76909D790DDFDCE9(uLocal_363, uLocal_371, "Base_Jump_Spot_CAM", "rcmextreme4");
								unk_0x63F0B040CE6EDF0F(1, 0, 3000, 1, 0, 0);
								unk_0x880B00F3FAE4C022(Local_155.f_0, 0, 0);
								iLocal_154 = 1;
							}
				...
				if (func_311(Local_155.f_0))
				{
					if (unk_0x3CA08F647CEAD042("Dom", 0))
					{
						iLocal_149 = 2;
					}
				}
		...
		case 2:
			...
			if (unk_0x765F6FEEFF39224F(iLocal_179) && !unk_0xD62C4419A41F106A(iLocal_179, 0))
			{
				unk_0x0CDD28A9DFCE2FCE(iLocal_179, 1, 0);
			}
			if (iLocal_151 == 0)
			{
				unk_0x65BA35D6D61F1574("EXT4_JUMPED_OS");
				func_240(3);
			}
			break;
	}
...
void func_241(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0xF272A2699B521CE6(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x9C47E5CDFB45F474(func_242(unk_0x3EE1295CEFBEFED4()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_244(struct<3> Param0, float fParam3)
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		...
		if (unk_0x765F6FEEFF39224F(iVar0))
		{
			...
			{
				unk_0xBEADAF07D2339505(iVar0, Param0, 1, 0, 0, 1);
...
int func_254(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		...
		{
			if (!func_258(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_257(unk_0x33CD235DF1E6A94E(), -828834893))
				{
...
void func_261()
{
	if (!unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		...
		{
			if (((((((unk_0xF1CDE9FD207C4CD8(0, 30) || unk_0xF1CDE9FD207C4CD8(0, 31)) || unk_0xF1CDE9FD207C4CD8(0, 23)) || unk_0xF1CDE9FD207C4CD8(0, 21)) || unk_0xF1CDE9FD207C4CD8(0, 22)) || (func_273() && unk_0xF1CDE9FD207C4CD8(0, 1))) || (func_273() && unk_0xF1CDE9FD207C4CD8(0, 2))) || (func_273() && unk_0xF1CDE9FD207C4CD8(0, 32)))
			{
	...
	switch (iLocal_149)
	{
		case 0:
			...
			{
				unk_0x28F648743D7DE312(Local_82.f_28[0], 17, 1);
			}
			iLocal_368 = 0;
			iLocal_383 = 1;
		...
		case 1:
			...
			if (func_311(unk_0x33CD235DF1E6A94E()))
			{
				if (func_311(Local_155.f_0))
				{
					if (func_310(unk_0x33CD235DF1E6A94E(), Local_155.f_0, 100f, 1))
					{
						unk_0xAD16833367AC0879("es_4_rcm_p2_concat", 6, 8);
						if (unk_0xA812C1043FE92B58())
						{
					...
					if (unk_0x3AF2B3B68DD52355(Local_155.f_0))
					{
						unk_0x7FC2040EB34E0E31(Local_155.f_0, 0, 0);
					}
					if (func_310(unk_0x33CD235DF1E6A94E(), Local_155.f_0, 32f, 1))
					{
						...
						else
						{
							if (!iLocal_378)
							{
								if (func_310(unk_0x33CD235DF1E6A94E(), Local_155.f_0, 30f, 1) && !func_260())
								{
							...
							func_263();
							if (!unk_0xFB2C4D32FED130AB(unk_0x33CD235DF1E6A94E(), Local_155.f_0))
							{
								unk_0xC4A347124F39D998(unk_0x33CD235DF1E6A94E(), Local_155.f_0, -1, 0, 2);
							}
						}
					}
					if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, 0, 1, 0))
					{
						if (!unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
						{
							iLocal_149 = 2;
		...
		case 2:
			...
			if (func_311(unk_0x33CD235DF1E6A94E()))
			{
				if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
				{
					unk_0xA4DF1E31BCDF9978(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), 5f, 1, 0);
...
void func_262()
{
	if (func_311(Local_155.f_0))
	{
		if (unk_0xD76D6BCC14B95CE1(Local_155.f_0, 242628503) != 1)
		{
			unk_0x13A2D602CD10CBAC(Local_155.f_0, uLocal_171);
		}
	}
}
...
void func_263()
{
	if (!func_260())
	{
		if (iLocal_368 < 5)
		{
			if (unk_0xE3903F59E2F22150() > (iLocal_369 + (8000 + unk_0x9EC3B269A34A2BEE(0, 2000))))
			{
				if (unk_0x66DE54BD13B1BD88(uLocal_367))
				{
	...
	if (!func_260())
	{
		if ((unk_0x3C05A6D663EA1B6A("EXTREME_04_DOM_A", 0, -1) && unk_0x3C05A6D663EA1B6A("EXTREME_04_DOM_B", 0, -1)) && unk_0x3C05A6D663EA1B6A("EXTREME_04_DOM_C", 0, -1))
		{
			if (unk_0x66DE54BD13B1BD88(uLocal_367))
			{
				unk_0xE9739440E5BF08EE(uLocal_367, "DOM", Local_155.f_0, "EXTREME_04_SOUNDSET", 0, 0);
			}
		}
	}
}
...
int func_268(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_252(Param1 - unk_0xFBB1F99A825CAB09(iParam0, 1)) };
	...
	{
		Var3 = { func_252(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_274()
{
	...
	else
	{
		...
		unk_0x7E268975AF5EA74F(unk_0x33CD235DF1E6A94E(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
		func_238(800, 0);
		iLocal_152 = 1;
		func_281(1, 1, 1);
	}
...
void func_275()
{
	...
	unk_0x7E268975AF5EA74F(Local_82.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 0.25f, 0, 40000f);
	unk_0xCC323859A8DA2B88("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 0);
	unk_0xB7350047030F7672(Local_155.f_1, 20f, 0, 0, 0, 0, 0, 0);
	if (!unk_0x765F6FEEFF39224F(iLocal_173))
	{
		iLocal_173 = unk_0xC651C43AB13A15E5(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, 1, 1, 0);
	}
	if (!unk_0x765F6FEEFF39224F(iLocal_174))
	{
		iLocal_174 = unk_0xC651C43AB13A15E5(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, 1, 1, 0);
	}
	if (!unk_0x765F6FEEFF39224F(iLocal_176))
	{
		iLocal_176 = unk_0x7CA67831169E8AA6(joaat("prop_box_wood01a"), 1666.282f, -11.20408f, 172.7773f, 1, 1, 0);
		unk_0x1C8705F667F673EA(iLocal_176, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!unk_0x765F6FEEFF39224F(iLocal_177))
	{
		iLocal_177 = unk_0x7CA67831169E8AA6(joaat("prop_box_wood01a"), 1667.076f, -12.07778f, 173.2611f, 1, 1, 0);
		unk_0x1C8705F667F673EA(iLocal_177, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_311(Local_155.f_0))
	{
		if (unk_0xD76D6BCC14B95CE1(Local_155.f_0, 242628503) != 1)
		{
			unk_0x99414FB2D30425C1(&uLocal_171);
			unk_0x108754262311D34F(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x108754262311D34F(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x108754262311D34F(0, "rcmextreme4", "fidget_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x108754262311D34F(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x108754262311D34F(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x108754262311D34F(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x108754262311D34F(0, "rcmextreme4", "fidget_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x656E3BB78935070E(uLocal_171, 1);
			unk_0xC734F59A13D39AEF(uLocal_171);
			unk_0x13A2D602CD10CBAC(Local_155.f_0, uLocal_171);
		}
	}
	if (func_311(Local_155.f_0))
	{
		unk_0x1096811DB3A77EC1(Local_155.f_0, 0);
		func_224(&uLocal_182, 4, Local_155.f_0, "DOM", 0, 1);
		unk_0x0648A75D3F60E864(Local_155.f_0, unk_0xC408CC95C7202D67(unk_0x33CD235DF1E6A94E()));
	}
	if (!unk_0x765F6FEEFF39224F(iLocal_179))
	{
		iLocal_179 = unk_0x5A4D875D71EDECDE(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
	}
	unk_0x1C8705F667F673EA(iLocal_179, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	unk_0x1BE9DE786D9E5DF3(iLocal_179, "Chute_Off_Bag", "skydive@parachute@", 4f, 0, 1, 0, 0.99f, 0);
	func_240(1);
}
...
void func_285()
{
	switch (iLocal_150)
	{
		case 0:
			...
			{
				if (!iLocal_383 || unk_0xE3903F59E2F22150() > iLocal_384 + 3500)
				{
					func_286();
					unk_0xF68C9C9A191F2B68(1);
					...
					if (func_222(Local_82.f_28[0]))
					{
						unk_0xEF6624A3AFF02A02(Local_82.f_28[0], "Hudson", 0, joaat("a_c_retriever"), 0);
					}
					unk_0x4EDE34FBADD967A6(0);
					unk_0x3754CDF254D9F523(0);
		...
		case 2:
			func_279(unk_0x33CD235DF1E6A94E(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			unk_0x13C3FE558ED056EE(unk_0x33CD235DF1E6A94E(), joaat("MotionState_Walk"), 0, 1, 0);
			unk_0x9B60F55261702F28(unk_0x33CD235DF1E6A94E(), 1f);
			unk_0x7E268975AF5EA74F(unk_0x33CD235DF1E6A94E(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
			unk_0xD6EDA274D82E8678(0f, 1065353216);
...
int func_287(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		if ((!unk_0xBEAC9DF5323BB074(unk_0x33CD235DF1E6A94E()) && !unk_0x21DE39E28274C4C1(unk_0x33CD235DF1E6A94E())) && !unk_0xA5C8D37514ACC1FA(unk_0x33CD235DF1E6A94E()))
		{
			if (!func_258(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_290()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_324() && func_311(Local_82.f_28[0])) && func_311(unk_0x33CD235DF1E6A94E())) && iLocal_383 == 1)
	{
		if (!unk_0x8D255802EBF1DA76())
		{
			unk_0x3449EA232F9B8EAD(unk_0x95B959F18401C09A(), false, 0);
			unk_0xC4A347124F39D998(unk_0x33CD235DF1E6A94E(), Local_82.f_28[0], -1, 0, 2);
			unk_0x38CD0CF7DF213A81(unk_0x33CD235DF1E6A94E(), Local_82.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
			unk_0xEA7CEAC893AF46C2(1);
			unk_0xC94CF61BF93818C8(Local_82.f_28[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, 0);
			unk_0xFB4925A947E64714(fVar0);
			unk_0x25251FF925945B3D(fVar1);
			unk_0x4F34FA95E899603F(fVar2);
			unk_0x5704F3CD60ECC7C7(fVar3);
			unk_0x19DD747264520C12(fVar4);
			iLocal_384 = unk_0xE3903F59E2F22150();
		}
		else
		{
			if (func_310(unk_0x33CD235DF1E6A94E(), Local_82.f_28[0], 4f, 1))
			{
...
void func_291()
{
	...
	if (iLocal_383)
	{
		if (!unk_0x8D255802EBF1DA76())
		{
			unk_0x3449EA232F9B8EAD(unk_0x95B959F18401C09A(), false, 0);
			unk_0xC4A347124F39D998(unk_0x33CD235DF1E6A94E(), Local_155.f_0, -1, 0, 2);
			unk_0x7E268975AF5EA74F(unk_0x33CD235DF1E6A94E(), 1658.95f, -5.45f, 173.78f, 1f, -1, 0.25f, 0, -161.08f);
			unk_0xEA7CEAC893AF46C2(1);
			unk_0xC94CF61BF93818C8(Local_155.f_0, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
			unk_0xFB4925A947E64714(fVar0);
			unk_0x25251FF925945B3D(fVar1);
			unk_0x4F34FA95E899603F(fVar2);
			unk_0x5704F3CD60ECC7C7(fVar3);
...
void func_292()
{
	...
	if (iLocal_148 == 1)
	{
		...
		{
			fVar0 = unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1), unk_0xFBB1F99A825CAB09(Local_155.f_0, 1), 1);
			if (iLocal_153 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			if (fVar0 > 150f)
			{
				...
				{
					unk_0x0E734BC61706D976(uLocal_170, 1);
				}
			}
			else if (unk_0xE38E3CF1625A4145(uLocal_170))
			{
				unk_0x0E734BC61706D976(uLocal_170, 0);
			}
		}
		if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, 0, 1, 0))
		{
			sLocal_168 = "EXT4_F2";
			iLocal_148 = 4;
		}
...
{
	if (((!func_307(0) || Global_71859) || Global_71848 == 1) || !unk_0x73DA1542B2F0C458())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((unk_0x286C823E0969F22A() || func_306(0)) || func_305(1))
			{
			}
			else
			{
...
void func_312()
{
	...
	unk_0x2EE8D1440C9060EF("EXT4", 0);
	while (!unk_0x8A7F864DAB908749(0))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	unk_0xB815670C37E03CDE(joaat("prop_box_guncase_03a"));
	unk_0xB815670C37E03CDE(joaat("prop_box_wood01a"));
	unk_0xB815670C37E03CDE(joaat("p_parachute_s"));
	unk_0xB815670C37E03CDE(joaat("bmx"));
	while (((!unk_0x5D98D654CDC2165A(joaat("prop_box_guncase_03a")) || !unk_0x5D98D654CDC2165A(joaat("prop_box_wood01a"))) || !unk_0x5D98D654CDC2165A(joaat("p_parachute_s"))) || !unk_0x5D98D654CDC2165A(joaat("bmx")))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0x765F6FEEFF39224F(uLocal_175))
	{
		iLocal_175 = unk_0xDD9A603448A23A17(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, 1, 1, 0);
		unk_0x1C8705F667F673EA(iLocal_175, 90f, 0f, -63f, 2, 1);
		unk_0xF70578F5CD9822CB(iLocal_175, 1);
		unk_0x0CDD28A9DFCE2FCE(iLocal_175, 0, 0);
	}
	func_316(1);
	if (!unk_0x765F6FEEFF39224F(Local_155.f_0))
	{
		func_313(&Local_155, 52, Local_155.f_1, Local_155.f_4, "Ext4-Dom", 1);
		unk_0xF70578F5CD9822CB(Local_155.f_0, 1);
		unk_0x4A852F02088ECC9D(Local_155.f_0, 1);
		unk_0x141A3DB3233829B3(Local_155.f_0, 1);
		unk_0x93AA93DA1B137032(Local_155.f_0, 8, 2, 0, 0);
		unk_0x167979048B7CE51D(Local_155.f_0, 1);
		unk_0x5FEE418CE11E6DDE(Local_155.f_0, 137, 1);
		unk_0x5FEE418CE11E6DDE(Local_155.f_0, 118, 0);
		unk_0x5FEE418CE11E6DDE(Local_155.f_0, 208, 1);
		unk_0xF8E07C228A90E953(Local_155.f_0, 5000);
	}
	if (func_222(unk_0x33CD235DF1E6A94E()))
	{
		func_224(&uLocal_182, 1, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
...
{
	unk_0xB815670C37E03CDE(Local_155.f_5);
	unk_0x0483D0035D6E46FD("rcmextreme4");
	unk_0x0483D0035D6E46FD("skydive@parachute@");
	unk_0xB815670C37E03CDE(joaat("sanchez"));
	unk_0x13157A56158089D8();
	if (iParam0 == 1)
	{
		while ((((!unk_0x5D98D654CDC2165A(Local_155.f_5) || !unk_0x5D98D654CDC2165A(joaat("sanchez"))) || !unk_0xE9CCF312047EBEE0("rcmextreme4")) || !unk_0xE9CCF312047EBEE0("skydive@parachute@")) || !unk_0xD3957903B061A8C8())
		{
			unk_0x4EDE34FBADD967A6(0);
		}
	}
...
void func_325(int iParam0)
{
	...
	unk_0xCC323859A8DA2B88("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 1);
...
void func_338()
{
	...
	unk_0xFF2DEA68E2D3602E("rcmextreme4");
}
...
void func_340(bool bParam0)
{
	...
	if (!func_360())
	{
		...
		{
			func_166(iVar0, 1, 0);
			func_341(unk_0xD178EF744F20B712(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
...
int func_342(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_348())
	{
		...
		{
			iVar33 = func_343(unk_0xD178EF744F20B712());
			if (iVar33 > -1)
			{
