...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		Var1 = { unk_0x3E4D3CCC220BDFB1(uLocal_72, 0) };
		fVar4 = unk_0xB7A628320EFF8E47(Local_176 + Local_181, Var1);
		if (fVar4 < (4.5f * 4.5f))
		{
			unk_0xD8C1C38EE8BC2AC6(uLocal_72, uLocal_74, uLocal_179, 786599);
			return 1;
		}
	}
	return 0;
...
int func_3(var uParam0)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(uLocal_72))
	{
	}
	else
	{
	...
	if (unk_0x80FF6C016CDB0FAF(uLocal_74, 0))
	{
	}
	else
	{
...
int func_4()
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (unk_0xFC5D6FB6EECB392F(Global_96285))
		{
			...
			if (!func_5(Global_98676, uLocal_74, 2))
			{
				if (fVar1 >= 0.9f)
				{
					unk_0x13A4BD6CC31F7B8F(Global_98676, uLocal_74, 2);
				}
			}
			if (!iLocal_180)
			{
				unk_0x6A8F948698B360B4(uLocal_72, 0);
				iLocal_180 = 1;
			}
			unk_0xDC3073F7CC12181D(uLocal_72, uLocal_74, 6, 50);
		}
		else
		{
			if (!func_5(Global_98676, uLocal_74, 2))
			...
			unk_0x1CD098484842AE0B(uLocal_74, -8f, 1);
			unk_0x4EDE34FBADD967A6(100);
			if (!func_3(&uVar0))
			{
				unk_0x9DC06E2A59C5AEBB(&uVar2);
				unk_0xDC3073F7CC12181D(0, uLocal_74, 24, 50);
				unk_0xC67F9BF03C2472AB(0, 2000);
				unk_0xDEFE57D3575A1A8A(0, uLocal_74, Local_176 + Local_181, uLocal_179, 0, uLocal_75, 786599, ((4.5f / 2f) - 1f), 10f);
				unk_0x19F29730874AD6F1(uVar2);
				unk_0x9B6EC2CECE1010EF(iLocal_72, uVar2);
...
void func_22()
{
	...
	unk_0x78FCB2E22C41B9D5(iLocal_73);
	unk_0x410A1E7AD7D5C774(iLocal_73, 1);
	uLocal_74 = unk_0x84F0027A508D7D7D(Local_181 + Local_173, 15f, uLocal_75, 2);
	iVar0 = 0;
	while ((!unk_0xAE06B9E39EBDE049(Global_98676) || !unk_0xAE06B9E39EBDE049(uLocal_74)) || (!unk_0x7D167B9A0CCDA347(iLocal_73) && iVar0 < 400))
	{
		if (!unk_0xAE06B9E39EBDE049(iLocal_74))
		{
			iLocal_74 = unk_0x84F0027A508D7D7D(Local_181 + Local_173, 15f, uLocal_75, 2);
		}
		iVar0++;
		unk_0x4EDE34FBADD967A6(0);
	}
	unk_0x4F3C4F457D44BB0F(Global_98676, 1, 1);
	...
	{
		unk_0xC160551F55D6365A(iLocal_74, 1, 1, 0);
		unk_0x5DC21979EC6C531F(iLocal_74, 2);
		unk_0xB11D151E210D4FAC(iLocal_74, 1084227584);
		iLocal_72 = unk_0x6A7A2C83BD302BA4(iLocal_74, 4, iLocal_73, -1, 1, 1);
		unk_0xD93D982926D0D8B3(iLocal_72, 0);
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_27(uParam109, 17, 1785177548, 1785177548, unk_0x658086F2B3C5E4E4(-5f, 5f), unk_0x658086F2B3C5E4E4(-5f, 5f), 0f, unk_0x658086F2B3C5E4E4(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_27(uParam109, 144, 1785177548, 1785177548, unk_0x658086F2B3C5E4E4(-5f, 5f), unk_0x658086F2B3C5E4E4(-5f, 5f), 0f, unk_0x658086F2B3C5E4E4(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_27(uParam109, 43, 1785177548, 1785177548, unk_0x658086F2B3C5E4E4(-5f, 5f), unk_0x658086F2B3C5E4E4(-5f, 5f), 0f, unk_0x658086F2B3C5E4E4(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
...
void func_50()
{
	if (!unk_0xA59F96B50B97E63C(iLocal_72, 0) && unk_0x1D2A3118784C0272(iLocal_72, 1))
	{
		unk_0x2481907DEE6B85EA(&iLocal_72);
	}
	if (!unk_0xA59F96B50B97E63C(iLocal_74, 0) && unk_0x1D2A3118784C0272(iLocal_74, 1))
	{
		unk_0xE730EAF558C97567(&iLocal_74);
	}
	unk_0x410A1E7AD7D5C774(iLocal_73, 0);
	unk_0x74528AC0906CBABE(iLocal_73);
