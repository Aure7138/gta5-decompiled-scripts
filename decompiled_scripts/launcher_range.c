		...
		if (fVar3 < 400f)
		{
			if (!iLocal_134)
			{
				if ((unk_0xAE06B9E39EBDE049(Local_140[0 /*6*/].f_1) && unk_0xAE06B9E39EBDE049(iLocal_123)) && !unk_0x7C4984752F886E92(iLocal_123, 1))
				{
					...
					unk_0x1CFE480FE307CCD9(0, Var5, 2000, joaat("FIRING_PATTERN_BURST_FIRE"));
			...
			if (!iLocal_135)
			{
				if ((unk_0xAE06B9E39EBDE049(Local_140[1 /*6*/].f_1) && unk_0xAE06B9E39EBDE049(iLocal_124)) && !unk_0x7C4984752F886E92(iLocal_124, 1))
				{
					...
					unk_0x1CFE480FE307CCD9(0, Var5, 1000, joaat("FIRING_PATTERN_BURST_FIRE"));
					unk_0x62726974410B1305(uVar4, 1);
					unk_0x19F29730874AD6F1(uVar4);
			...
			if (!iLocal_136)
			{
				if ((unk_0xAE06B9E39EBDE049(Local_140[2 /*6*/].f_1) && unk_0xAE06B9E39EBDE049(iLocal_125)) && !unk_0x7C4984752F886E92(iLocal_125, 1))
				{
					...
					unk_0x1CFE480FE307CCD9(0, Var5, 1500, joaat("FIRING_PATTERN_BURST_FIRE"));
					unk_0x62726974410B1305(uVar4, 1);
					unk_0x19F29730874AD6F1(uVar4);
...
void func_85()
{
	...
	if (bLocal_133)
	{
		...
		if (fVar3 > 225f)
		{
			...
			unk_0x3C9318CA0A4E1D58(iLocal_124, "move_ped_strafing");
			unk_0x3C9318CA0A4E1D58(iLocal_125, "move_ped_strafing");
			unk_0xEFBCE8F8316F89EA(2, joaat("CIVMALE"), iLocal_139);
			unk_0xEFBCE8F8316F89EA(2, joaat("CIVFEMALE"), iLocal_139);
			unk_0xEFBCE8F8316F89EA(2, joaat("COP"), iLocal_139);
			unk_0xEFBCE8F8316F89EA(2, iLocal_139, joaat("CIVMALE"));
			unk_0xEFBCE8F8316F89EA(2, iLocal_139, joaat("CIVFEMALE"));
...
void func_99()
{
	...
	if (unk_0x2A488C176D52CCA5(6.594f, -1100.162f, 28.797f, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0)) < 50f)
	{
		iLocal_138 = 0;
		if (!func_100(28))
		{
