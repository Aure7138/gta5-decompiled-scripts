...
void __EntryFunction__()
{
	...
	if (func_386())
	{
		...
		func_320(&iVar0, -257.08f, 285.27f, 90.43f, 12.52f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145);
	...
	{
		unk_0x4EDE34FBADD967A6(0);
		unk_0xCBBDAEEE9AB391E3("SF_PTP", 0);
	...
	if (!func_218(Local_84.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
	{
		switch (iLocal_83)
		{
			case 0:
				...
				{
					unk_0x49876BF356F39E66(Local_84.f_28[0], 1);
				}
				iLocal_83 = 1;
				break;
			...
			case 1:
				...
				{
					if (unk_0x0ACACDD53B4C4879(uLocal_331))
					{
...
int func_218(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_217(unk_0x096275889B8E0EE0()) && func_217(iParam0))
	{
		...
		if (!unk_0x0878A3DD21BC848A(unk_0x096275889B8E0EE0(), 6))
		{
			if (unk_0x4811DE9A3F16F275(unk_0x096275889B8E0EE0()))
			{
				...
				{
					return func_231(unk_0x096275889B8E0EE0(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_219(int iParam0, float fParam1)
{
	...
	if (func_217(unk_0x096275889B8E0EE0()) && func_217(iParam0))
	{
		if (func_230(iParam0) || unk_0x27F89FDC16688A7A(unk_0x217E9DC48139933D(), iParam0))
		{
			if (unk_0x0878A3DD21BC848A(unk_0x096275889B8E0EE0(), 6))
			{
				fVar0 = 40f;
...
{
	return func_221(iParam0, unk_0x096275889B8E0EE0(), fParam1, 1, 250, 7);
}
...
int func_225(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_227(unk_0xA86D5F069399F44D(iParam1, 1) - unk_0xA86D5F069399F44D(iParam0, 1)) };
	...
	{
		Var3 = { func_227(unk_0x012B43913EE9671C(iParam0, 31086, 0f, 5f, 0f) - unk_0x012B43913EE9671C(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_235(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_227(Param1 - unk_0xA86D5F069399F44D(iParam0, 1)) };
...
void func_237()
{
	if (unk_0xBFFB35986CAAE58C(unk_0x217E9DC48139933D()) && func_217(Local_84.f_28[0]))
	{
		unk_0x28358D889B3D7AF6(Local_84.f_28[0], 1, unk_0x096275889B8E0EE0(), 31086, 0f, 0f, 0f, 0, -1, -1);
		unk_0x28358D889B3D7AF6(unk_0x096275889B8E0EE0(), 1, Local_84.f_28[0], 31086, 0f, 0f, 0f, 0, -1, -1);
	}
}
	...
	switch (iLocal_83)
	{
		case 0:
			...
			if (func_217(unk_0x096275889B8E0EE0()))
			{
				...
				{
					func_271(sLocal_159, unk_0x096275889B8E0EE0(), 0, 2);
				}
			}
			if (func_265(1, 1093140480, 0))
			{
				...
				{
					unk_0xBFBD2726A7694056(Local_84.f_28[0], sLocal_161, 0, 0, 0);
				}
				if (func_217(unk_0x096275889B8E0EE0()))
				{
					unk_0xBFBD2726A7694056(unk_0x096275889B8E0EE0(), sLocal_159, 0, 0, 0);
				}
				if (unk_0xD42BD6EB2E0F1677(iLocal_148[0]))
				{
					unk_0xBFBD2726A7694056(iLocal_148[0], sLocal_155, 0, iLocal_151, 0);
				}
				else
				{
					unk_0xBFBD2726A7694056(iLocal_148[0], sLocal_155, 2, iLocal_151, 0);
				}
				if (unk_0xD42BD6EB2E0F1677(iLocal_148[1]))
				{
					unk_0xBFBD2726A7694056(iLocal_148[1], sLocal_156, 0, iLocal_152, 0);
				}
				else
				{
					unk_0xBFBD2726A7694056(iLocal_148[1], sLocal_156, 2, iLocal_152, 0);
				}
				if (unk_0xD42BD6EB2E0F1677(iLocal_146))
				{
					unk_0xBFBD2726A7694056(iLocal_146, sLocal_158, 0, iLocal_154, 0);
				}
				else
				{
					unk_0xBFBD2726A7694056(iLocal_146, sLocal_158, 2, iLocal_154, 0);
				}
				if (unk_0xD42BD6EB2E0F1677(iLocal_147))
				{
					unk_0xBFBD2726A7694056(iLocal_147, sLocal_157, 0, iLocal_153, 0);
				}
				else
				{
					unk_0xBFBD2726A7694056(iLocal_147, sLocal_157, 2, iLocal_153, 0);
				}
		...
		case 1:
			...
			if (unk_0x22C5A1F01BEB01C3(sLocal_161, 0))
			{
				uLocal_331 = unk_0x4D3B117F889EADDA(Local_332, Local_335, 2);
				unk_0x3605588B4955CFAF(Local_84.f_28[0], uLocal_331, sLocal_160, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
				unk_0x76BA60E29B3C3B96(Local_84.f_28[0], 0, 0);
			}
			if (unk_0x22C5A1F01BEB01C3(sLocal_159, 0))
			{
				unk_0xF6A103413A202C37(unk_0x096275889B8E0EE0(), -258.8661f, 292.7882f, 90.5764f, 1, 0, 0, 1);
				unk_0xCF2B9C0645C4651B(unk_0x096275889B8E0EE0(), 153.0417f);
				unk_0x76BA60E29B3C3B96(unk_0x096275889B8E0EE0(), 0, 0);
			}
			if (!unk_0xD42BD6EB2E0F1677(iLocal_147))
			{
				if (unk_0xD42BD6EB2E0F1677(unk_0x3D1E025CE31024DC(sLocal_157, iLocal_153)))
				{
					iLocal_147 = unk_0x280BBE5601EAA983(unk_0x3D1E025CE31024DC(sLocal_157, iLocal_153));
				}
			}
			else if (unk_0x0ACACDD53B4C4879(uLocal_331) && unk_0x22C5A1F01BEB01C3(sLocal_157, 0))
			{
				unk_0xF6A103413A202C37(iLocal_147, Local_332, 0, 0, 0, 1);
				unk_0x9CC8314DFEDE441E(iLocal_147, Local_335, 2, 0);
				unk_0xCF307902D4A3A68C(iLocal_147, uLocal_331, "leadout_pap_3_rcm_dumpster", sLocal_160, 1000f, -8f, 0, 1148846080);
				unk_0x4C9E96473D4F1A88(iLocal_147);
			}
			if (!unk_0xD42BD6EB2E0F1677(iLocal_148[0]))
			{
				if (unk_0xD42BD6EB2E0F1677(unk_0x3D1E025CE31024DC(sLocal_155, 0)))
				{
					iLocal_148[0] = unk_0x280BBE5601EAA983(unk_0x3D1E025CE31024DC(sLocal_155, iLocal_151));
				}
			}
			else if (unk_0x0ACACDD53B4C4879(uLocal_331) && unk_0x22C5A1F01BEB01C3(sLocal_155, 0))
			{
				unk_0xCF307902D4A3A68C(iLocal_148[0], uLocal_331, "leadout_pap_3_rcm_lid_l", sLocal_160, 1000f, -8f, 1, 1148846080);
				unk_0x4C9E96473D4F1A88(iLocal_148[0]);
			}
			if (!unk_0xD42BD6EB2E0F1677(iLocal_148[1]))
			{
				if (unk_0xD42BD6EB2E0F1677(unk_0x3D1E025CE31024DC(sLocal_156, 0)))
				{
					iLocal_148[1] = unk_0x280BBE5601EAA983(unk_0x3D1E025CE31024DC(sLocal_156, iLocal_152));
				}
			}
			else if (unk_0x0ACACDD53B4C4879(uLocal_331) && unk_0x22C5A1F01BEB01C3(sLocal_156, 0))
			{
				unk_0xCF307902D4A3A68C(iLocal_148[1], uLocal_331, "leadout_pap_3_rcm_lid_r", sLocal_160, 1000f, -8f, 1, 1148846080);
				unk_0x4C9E96473D4F1A88(iLocal_148[1]);
			}
			if (!unk_0xD42BD6EB2E0F1677(iLocal_146))
			{
				if (unk_0xD42BD6EB2E0F1677(unk_0x3D1E025CE31024DC(sLocal_158, 0)))
				{
					iLocal_146 = unk_0x280BBE5601EAA983(unk_0x3D1E025CE31024DC(sLocal_158, iLocal_154));
				}
			}
			else if (unk_0x0ACACDD53B4C4879(uLocal_331) && unk_0x22C5A1F01BEB01C3(sLocal_158, 0))
			{
				unk_0xF6A103413A202C37(iLocal_146, -261.1132f, 294.1956f, 90.68612f, 0, 0, 0, 1);
				unk_0x9CC8314DFEDE441E(iLocal_146, -0.604164f, -2.332095f, 89.8831f, 2, 0);
				unk_0x4C9E96473D4F1A88(iLocal_146);
			}
...
void func_240(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_216(unk_0x096275889B8E0EE0()))
	{
...
void func_241(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (!unk_0x6CFF81397164A1D3(unk_0x096275889B8E0EE0()) && !func_242(unk_0x217E9DC48139933D()))
		{
...
void func_250(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0xBFFB35986CAAE58C(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x06139B2CBC513B29(func_252(unk_0x47E385B0D957C8D4()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_262()
{
	...
	iVar10 = unk_0x2F96E7720B0B19EA();
	if (unk_0xD42BD6EB2E0F1677(iVar10))
	{
		unk_0xDCB8DDD5D054A7E7(unk_0xDA76A9F39210D365(iVar10), &(Var0[0 /*3*/]), &(Var0[1 /*3*/]));
		Var7 = { func_263() };
...
int func_265(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 0))
	{
		...
		{
			if (!func_270(unk_0xB3598EA616C3FFC3(unk_0x096275889B8E0EE0(), 0), fParam1, 1, 1056964608, 0, 1))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_269(unk_0x096275889B8E0EE0(), -828834893))
				{
...
void func_277()
{
	if (func_248())
	{
		unk_0xD1F7F32640ADFD12(Local_84.f_28[0], 0f, 0f, 0f, 1, -1, 1500, 2000, 0);
	}
}
...
void func_278()
{
	...
	{
		case 0:
			if (!unk_0x2E882EA08284F674("PAPARAZZO_03_SCENE"))
			{
				unk_0x5F70787AC4BF7928("PAPARAZZO_03_SCENE");
			}
			iLocal_344 = 0;
			func_280("PAP_3_RCM", 0);
			if (func_216(Local_84.f_28[0]) && unk_0xD42BD6EB2E0F1677(iLocal_147))
			{
				uLocal_329 = unk_0x4D3B117F889EADDA(unk_0xA86D5F069399F44D(iLocal_147, 1), unk_0xE09CAF86C32CB48F(iLocal_147, 2), 2);
				unk_0x3605588B4955CFAF(Local_84.f_28[0], uLocal_329, sLocal_160, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				if (unk_0xD42BD6EB2E0F1677(iLocal_147))
				{
					unk_0xCF307902D4A3A68C(iLocal_147, uLocal_329, "leadin_pap_3_rcm_dumpster", sLocal_160, 1000f, -8f, 0, 1148846080);
				}
				if (unk_0xD42BD6EB2E0F1677(iLocal_148[0]))
				{
					unk_0xCF307902D4A3A68C(iLocal_148[0], uLocal_329, "leadin_pap_3_rcm_lid_l", sLocal_160, 1000f, -8f, 0, 1148846080);
				}
				if (unk_0xD42BD6EB2E0F1677(iLocal_148[1]))
				{
					unk_0xCF307902D4A3A68C(iLocal_148[1], uLocal_329, "leadin_pap_3_rcm_lid_r", sLocal_160, 1000f, -8f, 0, 1148846080);
				}
				func_240(1, 1, 1, 1);
				iLocal_83 = 1;
			}
		...
		case 1:
			if (func_216(Local_84.f_28[0]) && unk_0xD42BD6EB2E0F1677(iLocal_147))
			{
				if (unk_0x0ACACDD53B4C4879(uLocal_329))
				{
					if (unk_0x5D6C0F302EC49A67(uLocal_329) > 0.99f)
					{
						if (!unk_0x0ACACDD53B4C4879(uLocal_330))
						{
							uLocal_330 = unk_0x4D3B117F889EADDA(unk_0xA86D5F069399F44D(iLocal_147, 1), unk_0xE09CAF86C32CB48F(iLocal_147, 2), 2);
							unk_0x3605588B4955CFAF(Local_84.f_28[0], uLocal_330, sLocal_160, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
							unk_0x76BA60E29B3C3B96(Local_84.f_28[0], 0, 0);
							if (unk_0xD42BD6EB2E0F1677(iLocal_147))
							{
								unk_0xCF307902D4A3A68C(iLocal_147, uLocal_330, "idle_01_pap_3_rcm_dumpster", sLocal_160, 1000f, -8f, 0, 1148846080);
								unk_0x4C9E96473D4F1A88(iLocal_147);
							}
							if (unk_0xD42BD6EB2E0F1677(iLocal_148[0]))
							{
								unk_0xCF307902D4A3A68C(iLocal_148[0], uLocal_330, "idle_01_pap_3_rcm_lid_l", sLocal_160, 1000f, -8f, 0, 1148846080);
								unk_0x4C9E96473D4F1A88(iLocal_148[0]);
							}
							if (unk_0xD42BD6EB2E0F1677(iLocal_148[1]))
							{
								unk_0xCF307902D4A3A68C(iLocal_148[1], uLocal_330, "idle_01_pap_3_rcm_lid_r", sLocal_160, 1000f, -8f, 0, 1148846080);
								unk_0x4C9E96473D4F1A88(iLocal_148[1]);
							}
						}
					}
					if (unk_0x5D6C0F302EC49A67(uLocal_329) > 0.3f)
					{
						if (!bLocal_327)
						{
					...
					if (unk_0x5D6C0F302EC49A67(uLocal_329) > 0.05f)
					{
						func_277();
					}
				}
...
void func_279()
{
	if (unk_0xD42BD6EB2E0F1677(Local_84.f_41[3]) && !iLocal_344)
	{
		unk_0x2E80BF72EF7C87AC("scr_rcpap1_camera", unk_0x012B43913EE9671C(Local_84.f_28[0], 28422, Local_339), unk_0xE09CAF86C32CB48F(Local_84.f_41[3], 2), 1065353216, 0, 0, 0);
		if (!unk_0x54E8BDC138905351(uLocal_338))
		{
			unk_0x9F36E8A3D2A21276(uLocal_338);
		}
		if (unk_0x9C623A934CD60291(sLocal_342, 0))
		{
			unk_0x8DA75EC60D972359(uLocal_338, "CAMERA", unk_0x012B43913EE9671C(Local_84.f_28[0], 28422, Local_339), sLocal_343, 0, 0, 0);
			iLocal_344 = 1;
		}
	}
}
...
void func_282()
{
	if (unk_0xBFFB35986CAAE58C(unk_0x217E9DC48139933D()))
	{
		if (unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 0))
		{
			if (func_270(unk_0xB3598EA616C3FFC3(unk_0x096275889B8E0EE0(), 0), 10.5f, 1, 1056964608, 0, 1))
			{
...
void func_287()
{
	...
	if (func_216(unk_0x096275889B8E0EE0()))
	{
		uLocal_145 = unk_0x7553587E61AC2272(unk_0x096275889B8E0EE0());
	}
	if (func_216(Local_84.f_28[0]))
	{
		unk_0x6ECBACF91786FB7A(Local_84.f_28[0], uLocal_145);
		unk_0x020E173F318C12DA(Local_84.f_28[0], 132, 1);
		unk_0x2AD4789CBFD829EC(Local_84.f_28[0], 1);
		unk_0x49876BF356F39E66(Local_84.f_28[0], 1);
	}
	if (!unk_0xD42BD6EB2E0F1677(iLocal_146))
	{
		iLocal_146 = unk_0x066A16145417A72D(-261.19f, 292.22f, 90.79f, 10f, iLocal_154, 1, 0, 1);
		unk_0x24AED2A608F93C4C(iLocal_146, 0);
	}
	if (!unk_0xD42BD6EB2E0F1677(iLocal_147))
	{
	...
	func_295(&uLocal_162, 1, unk_0x096275889B8E0EE0(), "FRANKLIN", 0, 1);
	func_295(&uLocal_162, 3, Local_84.f_28[0], "BEVERLY", 0, 1);
	unk_0x7C11D0C2EFACD80D("PAP3", 0);
	unk_0xA862A2AD321F94B4(sLocal_160);
	unk_0x001FF43843028E0C();
	while (!unk_0x27FF6FE8009B40CA(sLocal_160) || !unk_0x13A3F30A9ED0BC31())
	{
		func_281();
		unk_0x4EDE34FBADD967A6(0);
	}
	uLocal_338 = unk_0xC488DC56F57F2505();
	if (func_386())
	{
		switch (func_294())
		{
...
void func_288()
{
	...
	func_291();
	func_239(1);
	func_290(unk_0x096275889B8E0EE0(), -258.8661f, 292.7882f, 90.5764f, 153.0393f, 0, 1);
	func_289(1, 1, 1);
}
...
void func_291()
{
	if (func_217(Local_84.f_28[0]) && unk_0xD42BD6EB2E0F1677(iLocal_147))
	{
		uLocal_331 = unk_0x4D3B117F889EADDA(Local_332, Local_335, 2);
		unk_0x3605588B4955CFAF(Local_84.f_28[0], uLocal_331, sLocal_160, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
		if (unk_0xD42BD6EB2E0F1677(iLocal_147))
		...
		unk_0xEF8E0121E6DA9F93(uLocal_331, 0.02f);
	}
	bLocal_328 = false;
}
...
int func_297()
{
	...
	else if (unk_0xD42BD6EB2E0F1677(Local_84.f_28[0]))
	{
		if (unk_0x7D5B1F88E7504BBA(Local_84.f_28[0]))
		{
			func_298("P3BEVDEAD");
			return 1;
		}
		else if (unk_0x5741F02781727066(Local_84.f_28[0]) > unk_0x82368787EA73C0F7(Local_84.f_28[0]))
		{
			func_298("P3BEVHURT");
			return 1;
		}
...
void func_299()
{
	...
	{
		case 0:
			if (unk_0xD3852F22AB713A1F(sLocal_345, "DEFAULT"))
			{
				func_402(1);
			}
			else
...
{
	if (((!func_316(0) || Global_68514) || Global_68503 == 1) || !unk_0x37F9A426FBCF4AF2())
	{
		return 0;
	}
	switch (Global_68499)
	{
		...
		case 5:
			if ((unk_0x2004A43D1B1A5D9F() || func_286(0)) || func_315(1))
			{
			}
			else
			{
...
{
	if ((((((((((!unk_0xD42BD6EB2E0F1677(iParam0) || !unk_0xB86D29B10F627379(iParam0, 0)) || func_257(iParam0, 0, 0)) || func_257(iParam0, 1, 0)) || func_257(iParam0, 2, 0)) || func_345(iParam0) != 145) || func_344(iParam0)) || func_343(iParam0)) || func_328(iParam0)) || func_342(iParam0)) || !func_335(unk_0xDA76A9F39210D365(iParam0)))
	{
		if (func_343(iParam0))
		{
		}
...
int func_380(var uParam0)
{
	...
	switch (iLocal_78)
	{
		case 0:
			...
			{
				unk_0xFA28FE3A6246FC30(iVar0[iVar31]);
				iVar31++;
			}
			unk_0xA862A2AD321F94B4(sVar30);
			iLocal_78 = 1;
			break;
		
		case 1:
			if (!func_385(&iVar0) || !unk_0x27FF6FE8009B40CA(sVar30))
			{
				return 0;
			}
			iLocal_78 = 2;
		...
		case 2:
			...
			if (!unk_0xD42BD6EB2E0F1677(uParam0->f_28[0]))
			{
				if (func_382(&(uParam0->f_28[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					...
					unk_0x584EEBEECD248926(uParam0->f_28[0], 9, 1, 0, 0);
					unk_0x49876BF356F39E66(uParam0->f_28[0], 1);
				}
				else
				{
					bVar32 = false;
			...
			{
				if (!unk_0xD42BD6EB2E0F1677(uParam0->f_41[3]))
				{
					func_381(&(uParam0->f_41[3]), iVar0[1], unk_0xC899C78DB72CCBCC(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_217(uParam0->f_41[3]))
					{
						unk_0x1B21CF9397F27FEE(uParam0->f_41[3], uParam0->f_28[0], unk_0xD1E5B4D09626571A(uParam0->f_28[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
						unk_0x4AD96EF928BD4F9A(iVar0[1]);
					}
					else
					{
						bVar32 = false;
			...
			if (bVar32)
			{
				uVar6[0] = unk_0x066A16145417A72D(-260.62f, 292.1391f, 90.604f, 10f, joaat("prop_cs_dumpster_01a"), 1, 0, 1);
				Var10[0 /*3*/] = { -260.614f, 292.106f, 91.127f };
				Var20[0 /*3*/] = { 7.2E-05f, -2.500116f, 89.63998f };
				uVar6[1] = unk_0x066A16145417A72D(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidl"), 1, 0, 1);
				Var10[1 /*3*/] = { -261.108f, 292.5062f, 92.03645f };
				Var20[1 /*3*/] = { -0.656039f, -2.50018f, 89.6114f };
				uVar6[2] = unk_0x066A16145417A72D(-261.5835f, 291.6671f, 92.066f, 10f, joaat("prop_cs_dumpster_lidr"), 1, 0, 1);
				Var10[2 /*3*/] = { -261.1135f, 291.6249f, 91.99765f };
				Var20[2 /*3*/] = { -0.281056f, -2.500049f, 89.62769f };
				iVar31 = 0;
				while (iVar31 <= 2)
				{
					unk_0x0AD8BB0ADAFEDEE5(&(uVar6[iVar31]));
					iVar31++;
				}
				unk_0x069848B3FB3C4426(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), 1);
				unk_0x069848B3FB3C4426(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), 1);
				unk_0x069848B3FB3C4426(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), 1);
				uParam0->f_41[0] = unk_0x50F5AA376602B35C(joaat("prop_cs_dumpster_01a"), Var10[0 /*3*/], 1, 1, 0);
				unk_0x9CC8314DFEDE441E(uParam0->f_41[0], Var20[0 /*3*/], 2, 1);
				unk_0x24AED2A608F93C4C(uParam0->f_41[0], 0);
				uParam0->f_41[1] = unk_0x50F5AA376602B35C(joaat("prop_cs_dumpster_lidl"), Var10[1 /*3*/], 1, 1, 0);
				unk_0x9CC8314DFEDE441E(uParam0->f_41[1], Var20[1 /*3*/], 2, 1);
				unk_0x24AED2A608F93C4C(uParam0->f_41[1], 0);
				uParam0->f_41[2] = unk_0x50F5AA376602B35C(joaat("prop_cs_dumpster_lidr"), Var10[2 /*3*/], 1, 1, 0);
				unk_0x9CC8314DFEDE441E(uParam0->f_41[2], Var20[2 /*3*/], 2, 1);
				unk_0x24AED2A608F93C4C(uParam0->f_41[2], 0);
				iLocal_78 = 3;
			}
			break;
		...
		case 3:
			...
			{
				uLocal_81 = unk_0x4D3B117F889EADDA(unk_0xA86D5F069399F44D(uParam0->f_41[0], 1), unk_0xE09CAF86C32CB48F(uParam0->f_41[0], 2), 2);
				unk_0xCF307902D4A3A68C(uParam0->f_41[0], uLocal_81, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1148846080);
				unk_0x074C419F65D01DE7(uLocal_81, 1);
				if (func_217(uParam0->f_28[0]))
				{
					unk_0x3605588B4955CFAF(uParam0->f_28[0], uLocal_81, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_217(uParam0->f_41[1]))
				{
					unk_0xCF307902D4A3A68C(uParam0->f_41[1], uLocal_81, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1148846080);
				}
				if (func_217(uParam0->f_41[2]))
				{
					unk_0xCF307902D4A3A68C(uParam0->f_41[2], uLocal_81, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1148846080);
				}
			}
			iVar31 = 0;
			while (iVar31 <= (iVar0 - 1))
			{
				unk_0x4AD96EF928BD4F9A(iVar0[iVar31]);
				iVar31++;
			}
			unk_0x4763145053A33D46(sVar30);
			return 1;
			break;
	}
	return 0;
...
{
	func_249(uParam0);
	*uParam0 = unk_0x1A2D7464B1CAA1C8(uParam1, Param2, 1, 1, 0);
...
void func_387()
{
	...
	if (unk_0x2E882EA08284F674("PAPARAZZO_03_SCENE"))
	{
		unk_0xC27FB879C2B9A2EB("PAPARAZZO_03_SCENE");
	}
	unk_0x80443F20AE28A765(uLocal_338);
	if (unk_0xD42BD6EB2E0F1677(iLocal_148[0]))
	{
		unk_0x7D9EFB7AD6B19754(iLocal_148[0], 1);
	}
	if (unk_0xD42BD6EB2E0F1677(iLocal_148[1]))
	{
		unk_0x7D9EFB7AD6B19754(iLocal_148[1], 1);
	}
	func_400(&(iLocal_148[0]), 0);
	func_400(&(iLocal_148[1]), 0);
	func_400(&iLocal_146, 0);
	func_400(&iLocal_147, 0);
	unk_0x4763145053A33D46(sLocal_160);
...
void func_402(bool bParam0)
{
	...
	if (!func_419())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_403(unk_0x8F77B33B6A34D8BA(), iVar0);
		}
		else
		{
			if (Global_96440[iVar0 /*10*/].f_9 == -1)
...
int func_404(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_410())
	{
		...
		{
			iVar33 = func_405(unk_0x8F77B33B6A34D8BA());
			if (iVar33 > -1)
			{
