...
void __EntryFunction__()
{
	...
	{
		unk_0x4EDE34FBADD967A6(0);
		unk_0xBB5777EE55D3B041("SF_PTP", 0);
	...
	if (!func_219(Local_85.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
	{
		switch (iLocal_84)
		{
			case 0:
				...
				{
					unk_0xAAD662D7E0D59F4C(Local_85.f_28[0], 1);
				}
				iLocal_84 = 1;
				break;
			...
			case 1:
				...
				{
					if (unk_0xBC6B93737FCDC466(uLocal_332))
					{
...
int func_219(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_218(unk_0xC8B93D94F8954288()) && func_218(iParam0))
	{
		...
		if (!unk_0x74BBB84E37C71AAC(unk_0xC8B93D94F8954288(), 6))
		{
			if (unk_0x7E515EEFC038658D(unk_0xC8B93D94F8954288()))
			{
				...
				{
					return func_232(unk_0xC8B93D94F8954288(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_220(int iParam0, float fParam1)
{
	...
	if (func_218(unk_0xC8B93D94F8954288()) && func_218(iParam0))
	{
		if (func_231(iParam0) || unk_0x0BBFEAC55291063A(unk_0xA34E7C2A5118D638(), iParam0))
		{
			if (unk_0x74BBB84E37C71AAC(unk_0xC8B93D94F8954288(), 6))
			{
				fVar0 = 40f;
...
{
	return func_222(iParam0, unk_0xC8B93D94F8954288(), fParam1, 1, 250, 7);
}
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_228(unk_0x44C17CCB85A88A1F(iParam1, 1) - unk_0x44C17CCB85A88A1F(iParam0, 1)) };
	...
	{
		Var3 = { func_228(unk_0xB867FC7DBA46C0F1(iParam0, 31086, 0f, 5f, 0f) - unk_0xB867FC7DBA46C0F1(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_236(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_228(Param1 - unk_0x44C17CCB85A88A1F(iParam0, 1)) };
...
void func_238()
{
	if (unk_0x06972B20E75CBE06(unk_0xA34E7C2A5118D638()) && func_218(Local_85.f_28[0]))
	{
		unk_0xE4BB4B20A5F91492(Local_85.f_28[0], 1, unk_0xC8B93D94F8954288(), 31086, 0f, 0f, 0f, 0, -1, -1);
		unk_0xE4BB4B20A5F91492(unk_0xC8B93D94F8954288(), 1, Local_85.f_28[0], 31086, 0f, 0f, 0f, 0, -1, -1);
	}
}
...
void func_239()
{
	switch (iLocal_84)
	{
		case 0:
			func_278();
			if (func_218(unk_0xC8B93D94F8954288()))
			{
				if (unk_0x35081E98CA82CBB4())
				{
					func_272(sLocal_160, unk_0xC8B93D94F8954288(), 0, 2);
				}
			}
			if (func_266(1, 1093140480, 0))
			{
				...
				{
					unk_0x5D713171D2C2E177(Local_85.f_28[0], sLocal_162, 0, 0, 0);
				}
				if (func_218(unk_0xC8B93D94F8954288()))
				{
					unk_0x5D713171D2C2E177(unk_0xC8B93D94F8954288(), sLocal_160, 0, 0, 0);
				}
				if (unk_0x95CCECA3948CFE7B(iLocal_149[0]))
				{
					unk_0x5D713171D2C2E177(iLocal_149[0], sLocal_156, 0, iLocal_152, 0);
				}
				else
				{
					unk_0x5D713171D2C2E177(iLocal_149[0], sLocal_156, 2, iLocal_152, 0);
				}
				if (unk_0x95CCECA3948CFE7B(iLocal_149[1]))
				{
					unk_0x5D713171D2C2E177(iLocal_149[1], sLocal_157, 0, iLocal_153, 0);
				}
				else
				{
					unk_0x5D713171D2C2E177(iLocal_149[1], sLocal_157, 2, iLocal_153, 0);
				}
				if (unk_0x95CCECA3948CFE7B(iLocal_147))
				{
					unk_0x5D713171D2C2E177(iLocal_147, sLocal_159, 0, iLocal_155, 0);
				}
				else
				{
					unk_0x5D713171D2C2E177(iLocal_147, sLocal_159, 2, iLocal_155, 0);
				}
				if (unk_0x95CCECA3948CFE7B(iLocal_148))
				{
					unk_0x5D713171D2C2E177(iLocal_148, sLocal_158, 0, iLocal_154, 0);
				}
				else
				{
					unk_0x5D713171D2C2E177(iLocal_148, sLocal_158, 2, iLocal_154, 0);
				}
		...
		case 1:
			...
			if (unk_0x669E4BAB086C2648(sLocal_162, 0))
			{
				uLocal_332 = unk_0x0B15BB6DFB729046(Local_333, Local_336, 2);
				unk_0xA5666A46C1079EFE(Local_85.f_28[0], uLocal_332, sLocal_161, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
				unk_0x01BAA21528B22625(Local_85.f_28[0], 0, 0);
			}
			if (unk_0x669E4BAB086C2648(sLocal_160, 0))
			{
				unk_0xC76B5C68AB6DC7DF(unk_0xC8B93D94F8954288(), -258.8661f, 292.7882f, 90.5764f, 1, 0, 0, 1);
				unk_0x765E3FA65D011F03(unk_0xC8B93D94F8954288(), 153.0417f);
				unk_0x01BAA21528B22625(unk_0xC8B93D94F8954288(), 0, 0);
			}
			if (!unk_0x95CCECA3948CFE7B(iLocal_148))
			{
				if (unk_0x95CCECA3948CFE7B(unk_0x3B56A7E9193FB661(sLocal_158, iLocal_154)))
				{
					iLocal_148 = unk_0x9F549071D7D4F964(unk_0x3B56A7E9193FB661(sLocal_158, iLocal_154));
				}
			}
			else if (unk_0xBC6B93737FCDC466(uLocal_332) && unk_0x669E4BAB086C2648(sLocal_158, 0))
			{
				unk_0xC76B5C68AB6DC7DF(iLocal_148, Local_333, 0, 0, 0, 1);
				unk_0x68931E8B45B3CA92(iLocal_148, Local_336, 2, 0);
				unk_0x16A73DD34A0EE6C3(iLocal_148, uLocal_332, "leadout_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1148846080);
				unk_0x7ABC16BB2DEF73E6(iLocal_148);
			}
			if (!unk_0x95CCECA3948CFE7B(iLocal_149[0]))
			{
				if (unk_0x95CCECA3948CFE7B(unk_0x3B56A7E9193FB661(sLocal_156, 0)))
				{
					iLocal_149[0] = unk_0x9F549071D7D4F964(unk_0x3B56A7E9193FB661(sLocal_156, iLocal_152));
				}
			}
			else if (unk_0xBC6B93737FCDC466(uLocal_332) && unk_0x669E4BAB086C2648(sLocal_156, 0))
			{
				unk_0x16A73DD34A0EE6C3(iLocal_149[0], uLocal_332, "leadout_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 1, 1148846080);
				unk_0x7ABC16BB2DEF73E6(iLocal_149[0]);
			}
			if (!unk_0x95CCECA3948CFE7B(iLocal_149[1]))
			{
				if (unk_0x95CCECA3948CFE7B(unk_0x3B56A7E9193FB661(sLocal_157, 0)))
				{
					iLocal_149[1] = unk_0x9F549071D7D4F964(unk_0x3B56A7E9193FB661(sLocal_157, iLocal_153));
				}
			}
			else if (unk_0xBC6B93737FCDC466(uLocal_332) && unk_0x669E4BAB086C2648(sLocal_157, 0))
			{
				unk_0x16A73DD34A0EE6C3(iLocal_149[1], uLocal_332, "leadout_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 1, 1148846080);
				unk_0x7ABC16BB2DEF73E6(iLocal_149[1]);
			}
			if (!unk_0x95CCECA3948CFE7B(iLocal_147))
			{
				if (unk_0x95CCECA3948CFE7B(unk_0x3B56A7E9193FB661(sLocal_159, 0)))
				{
					iLocal_147 = unk_0x9F549071D7D4F964(unk_0x3B56A7E9193FB661(sLocal_159, iLocal_155));
				}
			}
			else if (unk_0xBC6B93737FCDC466(uLocal_332) && unk_0x669E4BAB086C2648(sLocal_159, 0))
			{
				unk_0xC76B5C68AB6DC7DF(iLocal_147, -261.1132f, 294.1956f, 90.68612f, 0, 0, 0, 1);
				unk_0x68931E8B45B3CA92(iLocal_147, -0.604164f, -2.332095f, 89.8831f, 2, 0);
				unk_0x7ABC16BB2DEF73E6(iLocal_147);
			}
...
void func_241(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_217(unk_0xC8B93D94F8954288()))
	{
...
void func_242(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (!unk_0x2DC9BA2299B45EA6(unk_0xC8B93D94F8954288()) && !func_243(unk_0xA34E7C2A5118D638()))
		{
...
void func_251(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0x06972B20E75CBE06(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x425A7D451DB73551(func_253(unk_0x1A96BAEAC664567A()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_263()
{
	...
	iVar10 = unk_0x974516F979AD07BC();
	if (unk_0x95CCECA3948CFE7B(iVar10))
	{
		unk_0xA8349C905E4A8DE7(unk_0x6D5BB810CC209E15(iVar10), &(Var0[0 /*3*/]), &(Var0[1 /*3*/]));
		Var7 = { func_264() };
...
int func_266(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x277ECDA23D8CCEB4(unk_0xC8B93D94F8954288(), 0))
	{
		...
		{
			if (!func_271(unk_0x275BEBE583A163B5(unk_0xC8B93D94F8954288(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_270(unk_0xC8B93D94F8954288(), -828834893))
				{
...
void func_278()
{
	if (func_249())
	{
		unk_0x4E0A15B03F32C5E5(Local_85.f_28[0], 0f, 0f, 0f, 1, -1, 1500, 2000, 0);
	}
}
...
void func_279()
{
	...
	{
		case 0:
			if (!unk_0xB5F5536784683C33("PAPARAZZO_03_SCENE"))
			{
				unk_0x925AE2E6F6E41362("PAPARAZZO_03_SCENE");
			}
			iLocal_345 = 0;
			func_281("PAP_3_RCM", 0);
			if (func_217(Local_85.f_28[0]) && unk_0x95CCECA3948CFE7B(iLocal_148))
			{
				uLocal_330 = unk_0x0B15BB6DFB729046(unk_0x44C17CCB85A88A1F(iLocal_148, 1), unk_0xF57992155BDFCC67(iLocal_148, 2), 2);
				unk_0xA5666A46C1079EFE(Local_85.f_28[0], uLocal_330, sLocal_161, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				if (unk_0x95CCECA3948CFE7B(iLocal_148))
				{
					unk_0x16A73DD34A0EE6C3(iLocal_148, uLocal_330, "leadin_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1148846080);
				}
				if (unk_0x95CCECA3948CFE7B(iLocal_149[0]))
				{
					unk_0x16A73DD34A0EE6C3(iLocal_149[0], uLocal_330, "leadin_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 0, 1148846080);
				}
				if (unk_0x95CCECA3948CFE7B(iLocal_149[1]))
				{
					unk_0x16A73DD34A0EE6C3(iLocal_149[1], uLocal_330, "leadin_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 0, 1148846080);
				}
				func_241(1, 1, 1, 1);
				iLocal_84 = 1;
			}
		...
		case 1:
			if (func_217(Local_85.f_28[0]) && unk_0x95CCECA3948CFE7B(iLocal_148))
			{
				if (unk_0xBC6B93737FCDC466(uLocal_330))
				{
					if (unk_0x2091E42376999826(uLocal_330) > 0.99f)
					{
						if (!unk_0xBC6B93737FCDC466(uLocal_331))
						{
							uLocal_331 = unk_0x0B15BB6DFB729046(unk_0x44C17CCB85A88A1F(iLocal_148, 1), unk_0xF57992155BDFCC67(iLocal_148, 2), 2);
							unk_0xA5666A46C1079EFE(Local_85.f_28[0], uLocal_331, sLocal_161, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
							unk_0x01BAA21528B22625(Local_85.f_28[0], 0, 0);
							if (unk_0x95CCECA3948CFE7B(iLocal_148))
							{
								unk_0x16A73DD34A0EE6C3(iLocal_148, uLocal_331, "idle_01_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1148846080);
								unk_0x7ABC16BB2DEF73E6(iLocal_148);
							}
							if (unk_0x95CCECA3948CFE7B(iLocal_149[0]))
							{
								unk_0x16A73DD34A0EE6C3(iLocal_149[0], uLocal_331, "idle_01_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 0, 1148846080);
								unk_0x7ABC16BB2DEF73E6(iLocal_149[0]);
							}
							if (unk_0x95CCECA3948CFE7B(iLocal_149[1]))
							{
								unk_0x16A73DD34A0EE6C3(iLocal_149[1], uLocal_331, "idle_01_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 0, 1148846080);
								unk_0x7ABC16BB2DEF73E6(iLocal_149[1]);
							}
						}
					}
					if (unk_0x2091E42376999826(uLocal_330) > 0.3f)
					{
						if (!bLocal_328)
						{
					...
					if (unk_0x2091E42376999826(uLocal_330) > 0.05f)
					{
						func_278();
					}
				}
...
void func_280()
{
	if (unk_0x95CCECA3948CFE7B(Local_85.f_41[3]) && !iLocal_345)
	{
		unk_0x9D2C7831992D8E95("scr_rcpap1_camera", unk_0xB867FC7DBA46C0F1(Local_85.f_28[0], 28422, Local_340), unk_0xF57992155BDFCC67(Local_85.f_41[3], 2), 1065353216, 0, 0, 0);
		if (!unk_0x6108F37F12ABC27B(uLocal_339))
		{
			unk_0x7A2D5FC5F94932AA(uLocal_339);
		}
		if (unk_0xC4C141A321D45FD8(sLocal_343, 0))
		{
			unk_0xE55275772E833643(uLocal_339, "CAMERA", unk_0xB867FC7DBA46C0F1(Local_85.f_28[0], 28422, Local_340), sLocal_344, 0, 0, 0);
			iLocal_345 = 1;
		}
	}
}
...
void func_283()
{
	if (unk_0x06972B20E75CBE06(unk_0xA34E7C2A5118D638()))
	{
		if (unk_0x277ECDA23D8CCEB4(unk_0xC8B93D94F8954288(), 0))
		{
			if (func_271(unk_0x275BEBE583A163B5(unk_0xC8B93D94F8954288(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_288()
{
	...
	if (func_217(unk_0xC8B93D94F8954288()))
	{
		uLocal_146 = unk_0xBD4278CDF5C53C71(unk_0xC8B93D94F8954288());
	}
	if (func_217(Local_85.f_28[0]))
	{
		unk_0xCBD60E398042F554(Local_85.f_28[0], uLocal_146);
		unk_0xC778754E36F3FFD6(Local_85.f_28[0], 132, 1);
		unk_0xF1A02DDEC7E15D6E(Local_85.f_28[0], 1);
		unk_0xAAD662D7E0D59F4C(Local_85.f_28[0], 1);
	}
	if (!unk_0x95CCECA3948CFE7B(iLocal_147))
	{
		iLocal_147 = unk_0xB999434FB1CECA11(-261.19f, 292.22f, 90.79f, 10f, iLocal_155, 1, 0, 1);
		unk_0x6C3FCAFEEF537750(iLocal_147, 0);
	}
	if (!unk_0x95CCECA3948CFE7B(iLocal_148))
	{
	...
	func_296(&uLocal_163, 1, unk_0xC8B93D94F8954288(), "FRANKLIN", 0, 1);
	func_296(&uLocal_163, 3, Local_85.f_28[0], "BEVERLY", 0, 1);
	unk_0xF3AC452C34BF0E13("PAP3", 0);
	unk_0xC0E8B67A4385D37D(sLocal_161);
	unk_0x8CBF0FAEA6BA6D37();
	while (!unk_0xF9B86DC1728F1339(sLocal_161) || !unk_0xB6161F3A3EDA5AA1())
	{
		func_282();
		unk_0x4EDE34FBADD967A6(0);
	}
	uLocal_339 = unk_0x83E9D86E63672B9A();
	if (func_391())
	{
		switch (func_295())
		{
...
void func_289()
{
	...
	func_292();
	func_240(1);
	func_291(unk_0xC8B93D94F8954288(), -258.8661f, 292.7882f, 90.5764f, 153.0393f, 0, 1);
	func_290(1, 1, 1);
}
...
void func_292()
{
	if (func_218(Local_85.f_28[0]) && unk_0x95CCECA3948CFE7B(iLocal_148))
	{
		uLocal_332 = unk_0x0B15BB6DFB729046(Local_333, Local_336, 2);
		unk_0xA5666A46C1079EFE(Local_85.f_28[0], uLocal_332, sLocal_161, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
		if (unk_0x95CCECA3948CFE7B(iLocal_148))
		...
		unk_0x7739CB1FE4967985(uLocal_332, 0.02f);
	}
	bLocal_329 = false;
}
...
int func_298()
{
	...
	else if (unk_0x95CCECA3948CFE7B(Local_85.f_28[0]))
	{
		if (unk_0xB6900B8CB0ABBD2B(Local_85.f_28[0]))
		{
			func_299("P3BEVDEAD");
			return 1;
		}
		else if (unk_0x5A333ED85C979D34(Local_85.f_28[0]) > unk_0xD3A4099D2845F152(Local_85.f_28[0]))
		{
			func_299("P3BEVHURT");
			return 1;
		}
...
void func_300()
{
	...
	{
		case 0:
			if (unk_0xF8D041B05C3D1FD4(sLocal_346, "DEFAULT"))
			{
				func_407(1);
			}
			else
...
{
	if (((!func_317(0) || Global_69586) || Global_69575 == 1) || !unk_0xB66DD474AA9E764E())
	{
		return 0;
	}
	switch (Global_69571)
	{
		...
		case 5:
			if ((unk_0x308528B5CF35F306() || func_287(0)) || func_316(1))
			{
			}
			else
			{
...
{
	if ((((((((((!unk_0x95CCECA3948CFE7B(iParam0) || !unk_0x5D42322C7DB888D0(iParam0, 0)) || func_258(iParam0, 0, 0)) || func_258(iParam0, 1, 0)) || func_258(iParam0, 2, 0)) || func_347(iParam0) != 145) || func_346(iParam0)) || func_345(iParam0)) || func_329(iParam0)) || func_344(iParam0)) || !func_336(unk_0x6D5BB810CC209E15(iParam0)))
	{
		if (func_345(iParam0))
		{
		}
...
int func_385(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			{
				unk_0x7567CEA8E6B5340B(iVar0[iVar31]);
				iVar31++;
			}
			unk_0xC0E8B67A4385D37D(sVar30);
			iLocal_79 = 1;
			break;
		
		case 1:
			if (!func_390(&iVar0) || !unk_0xF9B86DC1728F1339(sVar30))
			{
				return 0;
			}
			iLocal_79 = 2;
		...
		case 2:
			...
			{
				if (func_387(&(uParam0->f_28[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					unk_0x9AA5A07C66C84468(uParam0->f_28[0]);
					unk_0x8C245572EDB27776(uParam0->f_28[0], 9, 1, 0, 0);
					unk_0xAAD662D7E0D59F4C(uParam0->f_28[0], 1);
				}
				else
				{
					bVar32 = false;
			...
			if (func_217(uParam0->f_28[0]))
			{
				...
				{
					func_386(&(uParam0->f_41[3]), iVar0[1], unk_0xCC31DB73C65552D8(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_218(uParam0->f_41[3]))
					{
						unk_0xAD318582A32CA5D2(uParam0->f_41[3], uParam0->f_28[0], unk_0xF2122440C667309F(uParam0->f_28[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
						unk_0x4BBD72565A0AF033(iVar0[1]);
					}
					else
					{
						bVar32 = false;
			...
			if (bVar32)
			{
				uVar6[0] = unk_0xB999434FB1CECA11(-260.62f, 292.1391f, 90.604f, 10f, joaat("prop_cs_dumpster_01a"), 1, 0, 1);
				Var10[0 /*3*/] = { -260.614f, 292.106f, 91.127f };
				Var20[0 /*3*/] = { 7.2E-05f, -2.500116f, 89.63998f };
				uVar6[1] = unk_0xB999434FB1CECA11(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidl"), 1, 0, 1);
				Var10[1 /*3*/] = { -261.108f, 292.5062f, 92.03645f };
				Var20[1 /*3*/] = { -0.656039f, -2.50018f, 89.6114f };
				uVar6[2] = unk_0xB999434FB1CECA11(-261.5835f, 291.6671f, 92.066f, 10f, joaat("prop_cs_dumpster_lidr"), 1, 0, 1);
				Var10[2 /*3*/] = { -261.1135f, 291.6249f, 91.99765f };
				Var20[2 /*3*/] = { -0.281056f, -2.500049f, 89.62769f };
				iVar31 = 0;
				while (iVar31 <= 2)
				{
					unk_0xC2BB205CCEB68102(&(uVar6[iVar31]));
					iVar31++;
				}
				unk_0xF3B031799E7F7016(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), 1);
				unk_0xF3B031799E7F7016(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), 1);
				unk_0xF3B031799E7F7016(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), 1);
				uParam0->f_41[0] = unk_0xB2AD4914C25D1420(joaat("prop_cs_dumpster_01a"), Var10[0 /*3*/], 1, 1, 0);
				unk_0x68931E8B45B3CA92(uParam0->f_41[0], Var20[0 /*3*/], 2, 1);
				unk_0x6C3FCAFEEF537750(uParam0->f_41[0], 0);
				uParam0->f_41[1] = unk_0xB2AD4914C25D1420(joaat("prop_cs_dumpster_lidl"), Var10[1 /*3*/], 1, 1, 0);
				unk_0x68931E8B45B3CA92(uParam0->f_41[1], Var20[1 /*3*/], 2, 1);
				unk_0x6C3FCAFEEF537750(uParam0->f_41[1], 0);
				uParam0->f_41[2] = unk_0xB2AD4914C25D1420(joaat("prop_cs_dumpster_lidr"), Var10[2 /*3*/], 1, 1, 0);
				unk_0x68931E8B45B3CA92(uParam0->f_41[2], Var20[2 /*3*/], 2, 1);
				unk_0x6C3FCAFEEF537750(uParam0->f_41[2], 0);
				iLocal_79 = 3;
			}
			break;
		...
		case 3:
			...
			{
				uLocal_82 = unk_0x0B15BB6DFB729046(unk_0x44C17CCB85A88A1F(uParam0->f_41[0], 1), unk_0xF57992155BDFCC67(uParam0->f_41[0], 2), 2);
				unk_0x16A73DD34A0EE6C3(uParam0->f_41[0], uLocal_82, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1148846080);
				unk_0x53DDB73894A6597A(uLocal_82, 1);
				if (func_218(uParam0->f_28[0]))
				{
					unk_0xA5666A46C1079EFE(uParam0->f_28[0], uLocal_82, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_218(uParam0->f_41[1]))
				{
					unk_0x16A73DD34A0EE6C3(uParam0->f_41[1], uLocal_82, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1148846080);
				}
				if (func_218(uParam0->f_41[2]))
				{
					unk_0x16A73DD34A0EE6C3(uParam0->f_41[2], uLocal_82, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1148846080);
				}
			}
			iVar31 = 0;
			while (iVar31 <= (iVar0 - 1))
			{
				unk_0x4BBD72565A0AF033(iVar0[iVar31]);
				iVar31++;
			}
			unk_0x3ECF1E41E6ED71D8(sVar30);
			return 1;
			break;
	}
	return 0;
...
void func_386(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_250(uParam0);
...
int func_387(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_388(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0x95CCECA3948CFE7B(*uParam0))
		{
			if (!unk_0xB6900B8CB0ABBD2B(*uParam0))
...
int func_388(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	int iVar0;
...
void func_392()
{
	...
	if (unk_0xB5F5536784683C33("PAPARAZZO_03_SCENE"))
	{
		unk_0xDB9D78E5137EE7AD("PAPARAZZO_03_SCENE");
	}
	unk_0x279EB90079F76860(uLocal_339);
	if (unk_0x95CCECA3948CFE7B(iLocal_149[0]))
	{
		unk_0xB7A2078CD1C9A82F(iLocal_149[0], 1);
	}
	if (unk_0x95CCECA3948CFE7B(iLocal_149[1]))
	{
		unk_0xB7A2078CD1C9A82F(iLocal_149[1], 1);
	}
	func_405(&(iLocal_149[0]), 0);
	func_405(&(iLocal_149[1]), 0);
	func_405(&iLocal_147, 0);
	func_405(&iLocal_148, 0);
	unk_0x3ECF1E41E6ED71D8(sLocal_161);
	unk_0x946BF5DFB2A71B9E();
	func_404(&uLocal_163, 1);
	func_404(&uLocal_163, 3);
	unk_0x48591CDE727D1F6A(0, 1);
	unk_0x7846F09C04C34C46();
	func_403(&(Local_85.f_28[0]), 1, 0, 1);
	func_393(&Local_85, 1, 0, 0);
...
void func_407(bool bParam0)
{
	...
	if (!func_424())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_408(unk_0xC4E68AF0B559FAC4(), iVar0);
		}
		else
		{
			if (Global_100063[iVar0 /*10*/].f_9 == -1)
...
int func_409(char* sParam0, int iParam1, int iParam2)
{
	var uVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_415())
	{
		...
		{
			iVar33 = func_410(unk_0xC4E68AF0B559FAC4());
			if (iVar33 > -1)
			{
...
int func_411()
{
	...
	iVar0 = func_412(&(Global_91106.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_412(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
int func_415()
{
	...
	{
		if (func_410(&(Global_91106.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_428(&(uParam0->f_28));
	func_428(&(uParam0->f_35));
	func_428(&(uParam0->f_41));
}
