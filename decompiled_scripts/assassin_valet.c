...
void __EntryFunction__()
{
	...
	uLocal_54 = unk_0x5354F72E0D8D7E53();
	uLocal_55 = unk_0x526A9A6B1B39C5F0();
	iLocal_268 = -1;
	fLocal_270 = 1f;
	iLocal_383 = 100;
	iLocal_384 = 3;
	...
	iLocal_1045 = unk_0xFC1458A37D98B502();
	...
	func_510();
	iLocal_269 = 0;
	Local_57 = { func_508(iLocal_269) };
	unk_0xDF1ACFD53102CEB0(iLocal_1327, 1);
	unk_0xDF1ACFD53102CEB0(iLocal_1328, 1);
	unk_0x3A257DFDA1E817FD();
	if (func_513())
	{
		bLocal_376 = true;
		iLocal_1209 = func_507();
		if (Global_87155)
		{
			if (iLocal_1209 <= 1)
			{
	...
	while (true)
	{
		...
		else if (!unk_0x3AB6A1A9084FB0A4(iLocal_1045))
		{
			func_442();
			if (iLocal_1031 < 10)
			{
			...
			if (((iLocal_1134 || bLocal_1139) && iLocal_1031 < 11) || (bLocal_1169 && iLocal_1031 < 11))
			{
				...
				else if (func_46(&uLocal_1354) > 2.5f)
				{
					if (!iLocal_1170)
					{
						...
						{
							if (!unk_0x3AB6A1A9084FB0A4(iLocal_1057))
							{
								unk_0xB8E08BD5B184DF4E(iLocal_1057);
								if (iLocal_1044 == 1)
								{
									if (unk_0x6ADD12BF4D6D2587(iLocal_1314))
									{
										if (!unk_0x88DDBE9908752BF0(iLocal_1057, 0))
										{
											unk_0x2C85E478535743C1(iLocal_1057, iLocal_1314, iLocal_1314, 2f, 0, 0.5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
										}
									}
									if (unk_0x6ADD12BF4D6D2587(iLocal_1057) && !unk_0x3AB6A1A9084FB0A4(iLocal_1057))
									{
								...
								{
									if (unk_0x6ADD12BF4D6D2587(iLocal_1312) && unk_0xB8DE76287EDC4957(iLocal_1312, 0))
									{
										unk_0x2C85E478535743C1(iLocal_1057, iLocal_1312, iLocal_1312, 2f, 0, 0.5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
									}
								...
								{
									unk_0x9627C22EF3C3F4D6(iLocal_1057, unk_0xFC1458A37D98B502(), -1, 0);
									func_2(iLocal_1057);
								}
							}
						}
...
void func_1()
{
	...
	if (unk_0x88DDBE9908752BF0(iLocal_1045, 0))
	{
		iVar0 = unk_0xDFD115BB10FE46A9(iLocal_1045, 0);
	...
	if (bLocal_1144)
	{
		if (unk_0x03760B63FE11B718(iVar0, iLocal_1312))
		{
			unk_0x8BD98D78A3EE499E(iVar0, iLocal_1312);
		}
	}
}
...
{
	return func_24(unk_0x25D049AAC4603E65(unk_0x98EC0789D9F0703B()), iParam0, iParam1);
}
...
int func_25(float fParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!unk_0x3AB6A1A9084FB0A4(uLocal_1050[iVar0]))
		{
	...
	while (iVar0 <= 1)
	{
		if (!unk_0x3AB6A1A9084FB0A4(uLocal_1054[iVar0]))
		{
...
int func_30(int iParam0, bool bParam1)
{
	...
	while (iVar0 <= 2)
	{
		if (!unk_0x3AB6A1A9084FB0A4(uLocal_1050[iVar0]))
		{
			if (bParam1 || (!bParam1 && !unk_0x88DDBE9908752BF0(uLocal_1050[iVar0], 0)))
			{
	...
	while (iVar0 <= 1)
	{
		if (!unk_0x3AB6A1A9084FB0A4(uLocal_1054[iVar0]))
		{
			if (bParam1 || (!bParam1 && !unk_0x88DDBE9908752BF0(uLocal_1054[iVar0], 0)))
			{
	...
	while (iVar0 <= 1)
	{
		if (!unk_0x3AB6A1A9084FB0A4(iLocal_1047[iVar0]))
		{
			if (bParam1 || (!bParam1 && !unk_0x88DDBE9908752BF0(uLocal_1054[iVar0], 0)))
			{
...
void func_34(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_36(Global_104555.f_18503[iVar0], &Var2, &fVar5))
			{
...
float func_46(var uParam0)
{
	if (func_52(uParam0))
	{
		...
		{
			return (func_47(unk_0xC80D31E4B587871C(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_47(unk_0xC80D31E4B587871C(*uParam0, 4)) - fParam1);
...
int func_54(int iParam0)
{
	...
	if (iLocal_1031 > 11)
	{
		if (!unk_0x3AB6A1A9084FB0A4(iLocal_1046))
		{
			if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
			{
				if (unk_0xA8D0477084E86A92(iLocal_1046, iLocal_1312, 0))
				{
					bVar1 = true;
				}
			}
		...
		if (unk_0x6ADD12BF4D6D2587(iLocal_1046))
		{
			if (!unk_0x3AB6A1A9084FB0A4(iLocal_1046))
			{
				if (func_24(iLocal_1045, iLocal_1046, 1) >= fVar0)
				{
					if (bVar1)
					{
						if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
						{
							if (unk_0xEC211A86AB3726B6(iLocal_1312) || !unk_0x841ED61760A7D07B(iLocal_1312))
							{
								*iParam0 = 6;
								return 1;
							}
					...
					else if (unk_0xEC211A86AB3726B6(iLocal_1046))
					{
						*iParam0 = 6;
						return 1;
					}
				}
				else if (unk_0xA6DECE14FC9A8C51(uLocal_1120))
				{
					if (func_24(iLocal_1045, iLocal_1046, 1) >= (fVar0 * 0.5f))
					{
						if (!unk_0xD81F878E5EB092AD(uLocal_1120))
						{
							unk_0x0A8FD2D5529E1737(uLocal_1120, 1);
						}
					}
					else if (unk_0xD81F878E5EB092AD(uLocal_1120))
					{
						unk_0x0A8FD2D5529E1737(uLocal_1120, 0);
					}
				}
			}
		}
...
int func_65(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_72() || func_71(Global_4456448.f_143970)) || func_70())
	{
		if (unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0))
		{
			if ((unk_0x841136DE070DD9F6(unk_0xDFD115BB10FE46A9(unk_0xFC1458A37D98B502(), 0), func_69(unk_0xFC1458A37D98B502(), 0)) || (unk_0x82FF3DFBC3965CC0(unk_0xDFD115BB10FE46A9(unk_0xFC1458A37D98B502(), 0)) == joaat("apc") && func_69(unk_0xFC1458A37D98B502(), 0) != -1)) || (unk_0x82FF3DFBC3965CC0(unk_0xDFD115BB10FE46A9(unk_0xFC1458A37D98B502(), 0)) == joaat("akula") && func_69(unk_0xFC1458A37D98B502(), 0) != -1))
			{
				return 0;
			}
		}
...
void func_87(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	if (!unk_0x1CF95440F1970B4F("SCRIPT\ASSASSINATION_MULTI", 0, -1))
	{
		bLocal_1363 = false;
	}
	else
...
void func_91()
{
	...
	switch (iLocal_1207)
	{
		case 0:
			if (!func_22())
			{
				if (!unk_0x191BE1BC8F26F3C1(uLocal_1050[0], 0))
				{
					unk_0xCB3D88C918AA637C(uLocal_1050[0]);
				}
				if (!unk_0x191BE1BC8F26F3C1(uLocal_1050[1], 0))
				{
					unk_0xCB3D88C918AA637C(uLocal_1050[1]);
				}
				iVar0 = func_95();
				if (bLocal_1157)
				{
				...
				else if (!bLocal_1164 && unk_0x3AB6A1A9084FB0A4(iLocal_1046))
				{
					if (!iLocal_1173)
					{
						func_28(iVar0, 3, "OJAvaGUARD");
		...
		case 2:
			if (iLocal_1173 || !unk_0x3AB6A1A9084FB0A4(iLocal_1046))
			{
				if (!func_22() && !bLocal_1157)
				{
					...
					else if (!bLocal_1181 && unk_0x3AB6A1A9084FB0A4(iLocal_1046))
					{
						iVar0 = func_95();
						func_94(iVar0);
					}
			...
			if (func_52(&uLocal_1339))
			{
				if ((func_46(&uLocal_1339) > fLocal_1244 && func_92()) || unk_0x08765A6321A42CA1(unk_0xFC1458A37D98B502()))
				{
					func_3();
					if (!iLocal_1134)
					{
...
int func_92()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0x6ADD12BF4D6D2587(uLocal_1050[iVar0]) && !unk_0x191BE1BC8F26F3C1(uLocal_1050[iVar0], 0))
		{
			unk_0x2217C45231E6A537(uLocal_1050[iVar0], 85, 1);
			if (unk_0x46D8E79A1B95ACE2(uLocal_1050[iVar0], unk_0xFC1458A37D98B502()))
			{
				return 1;
			}
		}
	...
	while (iVar0 < 2)
	{
		if (unk_0x6ADD12BF4D6D2587(uLocal_1054[iVar0]) && !unk_0x191BE1BC8F26F3C1(uLocal_1054[iVar0], 0))
		{
			unk_0x2217C45231E6A537(uLocal_1054[iVar0], 85, 1);
			if (unk_0x46D8E79A1B95ACE2(uLocal_1054[iVar0], unk_0xFC1458A37D98B502()))
			{
				return 1;
			}
		}
	...
	while (iVar0 < 2)
	{
		if (unk_0x6ADD12BF4D6D2587(iLocal_1047[iVar0]) && !unk_0x191BE1BC8F26F3C1(iLocal_1047[iVar0], 0))
		{
			unk_0x2217C45231E6A537(iLocal_1047[iVar0], 85, 1);
			if (unk_0x46D8E79A1B95ACE2(iLocal_1047[iVar0], unk_0xFC1458A37D98B502()))
			{
				return 1;
			}
		}
...
void func_94(int iParam0)
{
	if (!bLocal_1181)
	{
		if (unk_0x6ADD12BF4D6D2587(iLocal_1046) && unk_0x3AB6A1A9084FB0A4(iLocal_1046))
		{
			if (!func_22())
			{
...
int func_95()
{
	...
	while (iVar1 < 3)
	{
		if (unk_0x6ADD12BF4D6D2587(uLocal_1050[iVar1]) && !unk_0x3AB6A1A9084FB0A4(uLocal_1050[iVar1]))
		{
	...
	if (iVar0 == 0)
	{
		...
		while (iVar1 < 2)
		{
			if (unk_0x6ADD12BF4D6D2587(uLocal_1054[iVar1]) && !unk_0x3AB6A1A9084FB0A4(uLocal_1054[iVar1]))
			{
	...
	if (iVar0 == 0)
	{
		...
		while (iVar1 < 2)
		{
			if (unk_0x6ADD12BF4D6D2587(iLocal_1047[iVar1]) && !unk_0x3AB6A1A9084FB0A4(iLocal_1047[iVar1]))
			{
...
int func_97(int iParam0)
{
	...
	if (!iLocal_1134)
	{
		...
		if (unk_0xC931425E2B416A2F(iLocal_1045, 4))
		{
			if (unk_0x08765A6321A42CA1(iLocal_1045))
			{
				fVar1 = func_26(unk_0xFC1458A37D98B502(), -1230.599f, -196.5408f, 38.1528f, 1);
				unk_0x5AD8564EFD5BEC2E(iLocal_1045, &iVar2, 1);
		...
		if ((func_101(iLocal_1312) || func_100(iLocal_1312)) || (unk_0x6ADD12BF4D6D2587(iLocal_1312) && unk_0xEBE499597C718EB8(iLocal_1312, iLocal_1045, 1)))
		{
			return 1;
		}
		if (func_101(iLocal_1313) || (unk_0x6ADD12BF4D6D2587(iLocal_1313) && unk_0xEBE499597C718EB8(iLocal_1313, iLocal_1045, 1)))
		{
			return 1;
		}
		if (unk_0x6ADD12BF4D6D2587(iLocal_1312) && !unk_0x191BE1BC8F26F3C1(iLocal_1312, 0))
		{
			if (unk_0xA8D0477084E86A92(iLocal_1045, iLocal_1312, 0))
			{
				unk_0x6862DF5504F63883(iLocal_1312, 1);
				unk_0x44E1F9DBBF6D172A(iLocal_1312);
				return 1;
			}
		}
		if (unk_0x6ADD12BF4D6D2587(iLocal_1312))
		{
			if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
			{
				if (unk_0x88DDBE9908752BF0(iLocal_1045, 0))
				{
					iVar0 = unk_0xDFD115BB10FE46A9(iLocal_1045, 0);
					if (unk_0x9A213A2345825783(iVar0, iLocal_1312) || (bLocal_1144 && unk_0x03760B63FE11B718(iVar0, iLocal_1312)))
					{
						*iParam0 = 4;
						return 1;
					}
		...
		if (iLocal_1031 < 11)
		{
			if (unk_0x4E69510C44147A5C(-1, Local_1308, fLocal_1311))
			{
				return 1;
			}
		}
		else if (unk_0x4E69510C44147A5C(-1, Local_1308, fLocal_1311))
		{
			if (func_98())
			{
				iLocal_1188 = 1;
...
int func_100(int iParam0)
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
		...
		{
			if (unk_0x37956F2B588E40E6(iParam0) == 3 && unk_0x0191A52225EFA665(iLocal_1045) == iParam0)
			{
				return 1;
			}
		}
...
int func_102(int iParam0)
{
	if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
	{
		if (unk_0x4A54CB0F526FC86F(unk_0xFC1458A37D98B502(), iLocal_1312, joaat("weapon_stickybomb"), -1))
		{
...
void func_103()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0x6ADD12BF4D6D2587(uLocal_1050[iVar0]))
		{
	...
	while (iVar0 < 2)
	{
		if (unk_0x6ADD12BF4D6D2587(uLocal_1054[iVar0]))
		{
			if (iLocal_1134 && !bLocal_1167)
			{
	...
	while (iVar0 < 2)
	{
		if (unk_0x6ADD12BF4D6D2587(iLocal_1047[iVar0]))
		{
			if (iLocal_1134 && !bLocal_1167)
			{
			...
			if (!unk_0x3AB6A1A9084FB0A4(iLocal_1047[iVar0]))
			{
				...
				{
					unk_0x2217C45231E6A537(iLocal_1047[iVar0], 128, 1);
				}
			}
		}
		iVar0++;
	...
	if (iLocal_1134)
	{
		if (!unk_0x191BE1BC8F26F3C1(iLocal_1046, 0))
		{
			unk_0x2217C45231E6A537(iLocal_1046, 120, 1);
		}
	}
}
...
void func_104(int iParam0)
{
	...
	switch (iLocal_1037[iParam0])
	{
		...
		case 1:
			if (unk_0xB8DE76287EDC4957(iLocal_1313, 0))
			{
				if (func_128())
				{
					if (!unk_0xFF95C59FBC63673B(iLocal_1313))
					{
						if (unk_0x317536BCEA8FA6B0(iLocal_1313, -1, 0) == uLocal_1054[iParam0])
						{
							unk_0x84EF7D14703E1230(uLocal_1054[iParam0], iLocal_1313, "OJASva_104", 948, 0, 16, 18, 6f, 0, 1073741824);
						}
					}
		...
		case 2:
			if (unk_0xB8DE76287EDC4957(iLocal_1313, 0))
			{
				if (!unk_0xFF95C59FBC63673B(iLocal_1313))
				{
					Var1 = { unk_0xB3328BA8976B416C(iLocal_1313, 1) };
					uVar4 = unk_0xF0371FE6E2BF9599(iLocal_1313);
					iLocal_1147 = 0;
		...
		case 3:
			if (unk_0xB8DE76287EDC4957(iLocal_1313, 0))
			{
				if (!unk_0x191BE1BC8F26F3C1(uLocal_1054[iParam0], 0))
				{
					if (unk_0xA8D0477084E86A92(uLocal_1054[iParam0], iLocal_1313, 0) && unk_0xB8DE76287EDC4957(iLocal_1312, 0))
					{
						if (!iLocal_1134)
						{
							if (unk_0x317536BCEA8FA6B0(iLocal_1313, -1, 0) == uLocal_1054[iParam0])
							{
								if (unk_0x78F50AA8F955BEFC(uLocal_1054[iParam0], -1273030092) != 1)
								{
									unk_0x704F59A957541E38(uLocal_1054[iParam0], iLocal_1313, iLocal_1312, -1, 45f, 786981, 10f, -1, 10f);
								}
							}
						}
						else if (unk_0x317536BCEA8FA6B0(iLocal_1313, -1, 0) == uLocal_1054[iParam0])
						{
							if (!iLocal_1148)
							{
								if (unk_0x191BE1BC8F26F3C1(iLocal_1046, 0))
						...
						{
							if (unk_0x78F50AA8F955BEFC(uLocal_1054[iParam0], 780511057) != 1)
							{
								if (!unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0))
								{
									if (unk_0x90D5DFB054818BA7(iLocal_1313) < 5f)
									{
										iLocal_1037[iParam0] = 8;
									}
								}
						...
						else if (unk_0x78F50AA8F955BEFC(uLocal_1054[iParam0], 780511057) != 1)
						{
							unk_0xD7F5B2902EBBD04E(iVar0, unk_0xFC1458A37D98B502(), 0, 16);
						}
					}
		...
		case 5:
			if (!func_93(iLocal_1045))
			{
				if (func_46(&uLocal_1333) >= 27f || unk_0xC308146F18B10A6F(unk_0x9EB17624F44A8DA4(), 0))
				{
					if (!unk_0x3AB6A1A9084FB0A4(iVar0))
					{
						if (unk_0x21B6FFFD04C9FF3A(iLocal_1045, iVar0, 5f, 5f, 3f, 0, 1, 0))
						{
		...
		case 6:
			if (bLocal_1159)
			{
				unk_0x6931076730A4AC5D(&uLocal_1324);
				...
				unk_0x78F763FF6DE9BCA2(0, unk_0xFC1458A37D98B502(), func_122(), 1f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				unk_0x1B16DD5C115FE009(uLocal_1324);
				if (!unk_0x3AB6A1A9084FB0A4(uLocal_1054[iParam0]))
				{
					unk_0xAB30B1CF01A198C1(uLocal_1054[iParam0], uLocal_1324);
				}
				unk_0xFAA3EF7FF92E1F9E(&uLocal_1324);
			}
			else
			{
				unk_0x6931076730A4AC5D(&uLocal_1324);
		...
		case 7:
			if (!unk_0x3AB6A1A9084FB0A4(uLocal_1054[iParam0]))
			{
				if (unk_0x78F50AA8F955BEFC(uLocal_1054[iParam0], 1435919172) != 1)
				{
					unk_0x2C85E478535743C1(uLocal_1054[iParam0], iLocal_1045, iLocal_1045, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				}
			}
			break;
	...
	if (!iLocal_1134)
	{
		...
		else if (func_112(iVar0, iLocal_1313, &Local_360, &iLocal_371, 0, 0, 0, 1, 1) || func_111(iLocal_1313))
		{
			...
			if (iVar5 != 0)
			{
				func_110(unk_0xB3328BA8976B416C(iVar5, 1), 1097859072, 1116471296);
			}
			if (!func_109())
			{
				iLocal_1134 = 1;
	...
	{
		if (unk_0xA8D0477084E86A92(iVar0, iLocal_1313, 0))
		{
			if (((!unk_0xB8DE76287EDC4957(iLocal_1313, 0) || !unk_0xB8DE76287EDC4957(iLocal_1312, 0)) || iLocal_1146) || !bLocal_1137)
			{
...
int func_108(int iParam0, float fParam1)
{
	if (!iLocal_1134)
	{
		if (!func_93(iLocal_1045))
		{
			if (unk_0x6ADD12BF4D6D2587(iParam0))
			{
				if (!unk_0x3AB6A1A9084FB0A4(iParam0))
				{
					...
					{
						if (unk_0xCA3C40448996C9BA(iParam0, iLocal_1045, 120f))
						{
							if (unk_0xFFCE4302A2DB825B(iParam0, iLocal_1045, 17))
							{
		...
		else if (unk_0x6ADD12BF4D6D2587(iParam0))
		{
			if (!unk_0x3AB6A1A9084FB0A4(iParam0))
			{
				if (unk_0x21B6FFFD04C9FF3A(iLocal_1045, iParam0, 5f, 5f, 1f, 0, 1, 0))
				{
					if (unk_0xCA3C40448996C9BA(iParam0, iLocal_1045, 120f))
					{
						if (unk_0xFFCE4302A2DB825B(iParam0, iLocal_1045, 17))
...
void func_110(struct<3> Param0, float fParam3, float fParam4)
{
	...
	if (unk_0x191BE1BC8F26F3C1(iLocal_1312, 0) || iLocal_1188)
	{
		bLocal_1157 = true;
	}
	if (unk_0x6ADD12BF4D6D2587(iLocal_1046))
	{
		if (((unk_0x613CDAB05D8C57C8(iLocal_1046, joaat("weapon_sniperrifle"), 0) || unk_0x613CDAB05D8C57C8(iLocal_1046, joaat("weapon_heavysniper"), 0)) || unk_0x613CDAB05D8C57C8(iLocal_1046, joaat("weapon_remotesniper"), 0)) || unk_0x613CDAB05D8C57C8(iLocal_1046, joaat("weapon_marksmanrifle"), 0))
		{
			iLocal_1156 = 1;
			iLocal_1032 = 1;
		}
	...
	{
		if (!unk_0xFF95C59FBC63673B(iLocal_1312))
		{
			fParam3 = (fParam3 * 2f);
			iVar0 = 1;
		}
	...
	if (!iLocal_1134)
	{
		...
		{
			fVar1 = func_26(unk_0xFC1458A37D98B502(), Param0, 1);
			if (fVar1 > fParam3)
			{
				iLocal_1158 = 1;
				if (fVar1 > fParam4)
...
int func_113(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (!bLocal_356)
		{
			iLocal_357 = unk_0xDE523AF6F7B269AB(iParam0);
			bLocal_356 = true;
		}
		iLocal_358 = unk_0xDE523AF6F7B269AB(iParam0);
...
int func_116(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (unk_0xC931425E2B416A2F(iParam0, 2))
	{
		...
		else
		{
			...
			if (unk_0x0A1D4A2F0A088C25(iParam0) || func_101(iVar3))
			{
				if (unk_0x0C88267282FD588F(iParam1, unk_0xB3328BA8976B416C(iParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (unk_0xCA3C40448996C9BA(unk_0x07F64790D10D1DB5(iParam1), iParam0, 120f) && unk_0xFFCE4302A2DB825B(iParam1, iParam0, 17))
...
void func_120(int iParam0)
{
	...
	if (!unk_0x3AB6A1A9084FB0A4(iLocal_1045) && !unk_0x3AB6A1A9084FB0A4(iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
		{
		...
		unk_0x9627C22EF3C3F4D6(0, iLocal_1045, -1, 0);
...
{
	if (!unk_0x191BE1BC8F26F3C1(iLocal_1045, 0))
	{
		if (!unk_0x88DDBE9908752BF0(iLocal_1045, 0))
		{
			if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
			...
			unk_0x6931076730A4AC5D(&uLocal_1324);
			unk_0x16416C5B54FDBCBB(0, 0, 256);
			unk_0xD7F5B2902EBBD04E(0, iLocal_1045, 0, 16);
			unk_0x1B16DD5C115FE009(uLocal_1324);
			if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
			{
				unk_0xAB30B1CF01A198C1(iParam0, uLocal_1324);
			}
			unk_0xFAA3EF7FF92E1F9E(&uLocal_1324);
		}
		else if (!unk_0x3AB6A1A9084FB0A4(iParam0))
		{
			if (unk_0x78F50AA8F955BEFC(iParam0, 780511057) != 1)
			{
				...
				unk_0xD7F5B2902EBBD04E(iParam0, iLocal_1045, 0, 16);
			}
		}
	}
}
...
void func_123(int iParam0, struct<3> Param1)
{
	if (!iLocal_1134)
	{
		if (!unk_0x3AB6A1A9084FB0A4(iParam0))
		{
			if (unk_0x21B6FFFD04C9FF3A(iLocal_1045, iParam0, Param1, 0, 1, 0))
			{
				if (unk_0xCA3C40448996C9BA(iParam0, iLocal_1045, 160f))
				{
					if (unk_0xFFCE4302A2DB825B(iParam0, iLocal_1045, 17))
					{
						unk_0x2C85E478535743C1(iParam0, iLocal_1045, iLocal_1045, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
						iLocal_1044 = 5;
						iLocal_1134 = 1;
					}
				}
		...
		if (!unk_0x88DDBE9908752BF0(*iParam0, 0))
		{
			if (!iLocal_1136)
			{
				if (*iParam0 == iLocal_1057)
				{
					unk_0xFAA3EF7FF92E1F9E(&uVar0);
					unk_0x6931076730A4AC5D(&uVar0);
					unk_0x4C7AF3B2BE8C3193(0, iLocal_1045, 20000, 2f, 1f, 1073741824, 0);
					unk_0xAC838A977FB6E6BC(0, iLocal_1045, -1);
					unk_0x1B16DD5C115FE009(uVar0);
					unk_0xAB30B1CF01A198C1(*iParam0, uVar0);
					unk_0xFAA3EF7FF92E1F9E(&uVar0);
					iLocal_1136 = 1;
				...
				{
					unk_0xAC838A977FB6E6BC(*iParam0, iLocal_1045, -1);
				}
			}
...
int func_126()
{
	...
	if (!unk_0x3AB6A1A9084FB0A4(unk_0xFC1458A37D98B502()))
	{
		...
		if (!unk_0x191BE1BC8F26F3C1(iLocal_1312, 0))
		{
			Var3 = { unk_0xB3328BA8976B416C(iLocal_1312, 1) };
		}
...
void func_127(int iParam0)
{
	...
	if (!unk_0x191BE1BC8F26F3C1(uLocal_1054[iParam0], 0))
	{
		if (unk_0xB8DE76287EDC4957(iLocal_1313, 0))
		{
			if (!unk_0xA8D0477084E86A92(uLocal_1054[iParam0], iLocal_1313, 0))
			{
				if (unk_0x78F50AA8F955BEFC(uLocal_1054[iParam0], -1794415470) != 1)
				{
					unk_0x6F8C8278B7C06889(uLocal_1054[iParam0], iLocal_1313, 20000, iVar0, 2f, 1, 0);
				}
			}
		}
	}
...
int func_128()
{
	if (!unk_0x3AB6A1A9084FB0A4(uLocal_1054[0]) && !unk_0x3AB6A1A9084FB0A4(uLocal_1054[1]))
	{
		if (unk_0xA8D0477084E86A92(uLocal_1054[0], iLocal_1313, 0) && unk_0xA8D0477084E86A92(uLocal_1054[1], iLocal_1313, 0))
		{
			return 1;
		}
	}
...
void func_129(struct<3> Param0, struct<3> Param3, float fParam6)
{
	if (!iLocal_1134)
	{
		if (unk_0x53C4FF461321A689(Param0, Param3, fParam6, joaat("weapon_stickybomb"), 0))
		{
			iLocal_1134 = 1;
		}
	}
	...
	switch (iLocal_1033[iParam0])
	{
		case 0:
			if (!unk_0x3AB6A1A9084FB0A4(iVar0))
			{
				unk_0xFAA3EF7FF92E1F9E(&uLocal_1324);
				unk_0x6931076730A4AC5D(&uLocal_1324);
				unk_0x755F86FFB31712D8(0, Local_1268[iParam0 /*3*/], 1f, 0, 0, 786603, -1082130432);
				unk_0x2DAC3448B66448E8(0, fLocal_1221[iParam0], 0);
				unk_0x1B16DD5C115FE009(uLocal_1324);
				unk_0xAB30B1CF01A198C1(iVar0, uLocal_1324);
				unk_0xFAA3EF7FF92E1F9E(&uLocal_1324);
			...
			if (unk_0x6ADD12BF4D6D2587(iVar0))
			{
				if (!unk_0x191BE1BC8F26F3C1(iVar0, 0))
				{
					if (!bLocal_1169)
					{
						...
						{
							if (unk_0x0C88267282FD588F(iVar0, Local_1268[iParam0 /*3*/], 3f, 3f, 3f, 0, 1, 0))
							{
		...
		case 3:
			...
			else if (func_46(&uLocal_1333) > uLocal_1227[iParam0] || unk_0xC308146F18B10A6F(unk_0x9EB17624F44A8DA4(), 0))
			{
				func_124(&iVar0);
				iLocal_1033[iParam0] = 2;
			}
		...
		case 4:
			if (!unk_0x3AB6A1A9084FB0A4(iVar0))
			{
				unk_0x5C5D33A1B2711D21(iVar0, 1);
			...
			if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
			{
				if (!unk_0x3AB6A1A9084FB0A4(iVar0))
				{
					if (iParam0 == 0)
					{
						unk_0x60C06BFD037BB7CF(uLocal_1050[0], uLocal_1050[1], -1, 0, 2);
						if (!unk_0xA8D0477084E86A92(iVar0, iLocal_1312, 0))
						{
							unk_0x6F8C8278B7C06889(iVar0, iLocal_1312, 30000, -1, 1f, 1, 0);
						}
					}
					else if (iParam0 == 1)
					{
						unk_0x60C06BFD037BB7CF(uLocal_1050[1], uLocal_1050[0], -1, 0, 2);
						if (!unk_0xA8D0477084E86A92(iVar0, iLocal_1312, 0))
						{
							unk_0x6F8C8278B7C06889(iVar0, iLocal_1312, 30000, 0, 1f, 1, 0);
						}
					}
					else if (iParam0 == 2)
					{
						if (unk_0xB8DE76287EDC4957(iLocal_1313, 0))
						{
							if (!unk_0xA8D0477084E86A92(iVar0, iLocal_1313, 0))
							{
								unk_0x6F8C8278B7C06889(iVar0, iLocal_1313, 30000, 1, 1f, 1, 0);
							}
						}
					}
				}
		...
		case 5:
			...
			if (!unk_0x191BE1BC8F26F3C1(iVar0, 0))
			{
				if (unk_0x78F50AA8F955BEFC(iVar0, 150319005) != 1)
				{
					if (iParam0 == 0)
					{
						unk_0x60C06BFD037BB7CF(uLocal_1050[iParam0], uLocal_1050[1], -1, 2048, 4);
					}
					else if (iParam0 == 1)
					{
						unk_0x60C06BFD037BB7CF(uLocal_1050[iParam0], uLocal_1050[0], -1, 2048, 4);
					}
				}
			}
			if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
					...
					if (iLocal_1134)
					{
						if (!unk_0x3AB6A1A9084FB0A4(iVar0))
						{
							if (unk_0x78F50AA8F955BEFC(iVar0, 780511057) != 1)
							{
								...
								unk_0xD7F5B2902EBBD04E(iVar0, iLocal_1045, 0, 16);
							}
						}
					}
				}
		...
		case 6:
			if (!iLocal_1134)
			{
				if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
				{
					if (unk_0x317536BCEA8FA6B0(iLocal_1312, -1, 0) == iVar0)
					{
						if (!unk_0x3AB6A1A9084FB0A4(iVar0))
						{
							unk_0xA15269351F50F113(iLocal_1312, 1, 1, 0);
							if (func_132())
							{
								unk_0x84EF7D14703E1230(iVar0, iLocal_1312, "OJASva_101a", 181, 0, 16, -1, 10f, 0, 1073741824);
							}
							else
							{
								unk_0x84EF7D14703E1230(iVar0, iLocal_1312, "OJASva_101", 181, 0, 0, -1, -1f, 0, 1073741824);
							}
						}
					}
		...
		case 7:
			if (iLocal_1134)
			{
				if ((unk_0xB8DE76287EDC4957(iLocal_1312, 0) && unk_0x317536BCEA8FA6B0(iLocal_1312, -1, 0) == iVar0) && unk_0x317536BCEA8FA6B0(iLocal_1312, 1, 0) == iLocal_1046)
				{
					if (!unk_0x3AB6A1A9084FB0A4(iVar0))
					{
						if (bLocal_1149 || (iLocal_1163 && !unk_0xFF95C59FBC63673B(iLocal_1312)))
						{
							...
							if (!unk_0x3AB6A1A9084FB0A4(unk_0xFC1458A37D98B502()))
							{
								if (unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0))
								{
									...
									{
										unk_0x6F03491E8F9F397C(iVar0, iLocal_1312, unk_0xDFD115BB10FE46A9(unk_0xFC1458A37D98B502(), 0), 8, 35f, 786469, -1f, -1f, 1);
									}
								}
								else if (unk_0x78F50AA8F955BEFC(iVar0, -1273030092) != 1)
								{
									unk_0xD2C269DBF147B406(iVar0, iLocal_1312, unk_0xFC1458A37D98B502(), 8, 35f, 786469, -1f, -1f, 1);
								}
							}
						}
					}
			...
			else if (bLocal_1149 || (iLocal_1163 && !unk_0xFF95C59FBC63673B(iLocal_1312)))
			{
				if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
				{
					if (unk_0x317536BCEA8FA6B0(iLocal_1312, -1, 0) == iVar0)
					{
						if (!unk_0x191BE1BC8F26F3C1(iVar0, 0))
						{
							if (unk_0x78F50AA8F955BEFC(iVar0, -1273030092) != 1)
							{
								unk_0x2931C350CED41AD3(iVar0, iLocal_1312, Local_1290, 8, 25f, 786603, -1f, -1f, 1);
							}
						}
					}
				}
		...
		case 8:
			if (bLocal_1159)
			{
				...
				unk_0x78F763FF6DE9BCA2(0, unk_0xFC1458A37D98B502(), func_122(), 1f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				unk_0x1B16DD5C115FE009(uLocal_1324);
				if (!unk_0x191BE1BC8F26F3C1(uLocal_1050[iParam0], 0))
				{
					unk_0xAB30B1CF01A198C1(uLocal_1050[iParam0], uLocal_1324);
				}
				unk_0xFAA3EF7FF92E1F9E(&uLocal_1324);
			}
			else
		...
		case 9:
			if (!unk_0x3AB6A1A9084FB0A4(uLocal_1050[iParam0]))
			{
				if (unk_0x78F50AA8F955BEFC(uLocal_1050[iParam0], 1435919172) != 1)
				{
					unk_0x2C85E478535743C1(uLocal_1050[iParam0], iLocal_1045, iLocal_1045, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				}
			}
			break;
...
int func_131(int iParam0)
{
	...
	if (!iLocal_1134)
	{
		if (unk_0x6ADD12BF4D6D2587(iParam0))
		{
			...
			if (func_112(iParam0, iVar0, &Local_360, &iLocal_371, 0, 0, 0, 1, 1) || (unk_0x9F887157983E8EFC(iParam0) && func_23(iParam0, 1) < 1.5f))
			{
				return 1;
			}
		}
...
int func_132()
{
	...
	uLocal_1212 = unk_0x3689C35A674B0772(unk_0xFC1458A37D98B502(), &iVar1);
...
int func_134()
{
	if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iLocal_1046))
		{
			if (!iLocal_1134)
			{
				if (unk_0xA8D0477084E86A92(iLocal_1046, iLocal_1312, 0) && func_135())
				{
					return 1;
				}
			}
			else if (unk_0xA8D0477084E86A92(iLocal_1046, iLocal_1312, 0))
			{
				return 1;
			}
		}
...
int func_135()
{
	...
	while (iVar0 <= 1)
	{
		if (!unk_0x3AB6A1A9084FB0A4(iLocal_1047[iVar0]))
		{
			if (!unk_0x88DDBE9908752BF0(iLocal_1047[iVar0], 0))
			{
				iVar1 = 0;
			}
		}
...
void func_137(int iParam0)
{
	if (!unk_0x3AB6A1A9084FB0A4(iParam0))
	{
		if (func_23(iParam0, 1) < 5f)
		{
			...
			{
				unk_0x9627C22EF3C3F4D6(iParam0, iLocal_1045, -1, 0);
			}
		}
...
void func_141(int iParam0)
{
	...
	if (!unk_0x6ADD12BF4D6D2587(iLocal_1047[iParam0]))
	{
		return;
	}
	switch (iLocal_1041[iParam0])
	{
		case 0:
			if (!unk_0x191BE1BC8F26F3C1(iLocal_1046, 0))
			{
				if (!unk_0x88DDBE9908752BF0(iLocal_1046, 0))
				{
					if (!unk_0x3AB6A1A9084FB0A4(iLocal_1047[iParam0]))
					{
						if (iParam0 == 0)
						{
							unk_0xF2163C96119FBF4B(iLocal_1047[iParam0], iLocal_1046, 1.5f, 0f, 0f, 1f, -1, 1036831949, 1);
						}
						else if (iParam0 == 1)
						{
							if (unk_0xB8DE76287EDC4957(iLocal_1313, 0))
							{
								...
								unk_0x6F8C8278B7C06889(0, iLocal_1313, 30000, 2, 1f, 1, 0);
								unk_0x1B16DD5C115FE009(uVar2);
								unk_0xAB30B1CF01A198C1(iLocal_1047[iParam0], uVar2);
		...
		case 1:
			...
			if (!unk_0x191BE1BC8F26F3C1(iLocal_1047[iParam0], 0))
			{
				if (unk_0xB8DE76287EDC4957(iVar0, 0))
				{
					if (!unk_0x191BE1BC8F26F3C1(iLocal_1047[iParam0], 0))
					{
						if (!unk_0xA8D0477084E86A92(iLocal_1047[iParam0], iVar0, 0))
						{
							if (unk_0x88DDBE9908752BF0(iLocal_1046, 0))
							{
								if (unk_0x78F50AA8F955BEFC(iLocal_1047[iParam0], -1794415470) != 1)
								{
									unk_0x6F8C8278B7C06889(iLocal_1047[iParam0], iVar0, 30000, iVar1, 1f, 1, 0);
								}
							}
						}
						else
		...
		case 2:
			...
			if (unk_0xB8DE76287EDC4957(iVar0, 0))
			{
				if (!unk_0x191BE1BC8F26F3C1(iLocal_1047[iParam0], 0))
				{
					if (unk_0xA8D0477084E86A92(iLocal_1047[iParam0], iVar0, 0) && unk_0xB8DE76287EDC4957(iLocal_1312, 0))
					{
						if (iLocal_1134)
						{
							if (!bLocal_1164)
							{
								if (unk_0x78F50AA8F955BEFC(iLocal_1047[iParam0], 780511057) != 1)
								{
									if (!unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0))
									{
									...
									unk_0xD7F5B2902EBBD04E(iLocal_1047[iParam0], unk_0xFC1458A37D98B502(), 0, 16);
								}
							}
							else if (unk_0x78F50AA8F955BEFC(iLocal_1047[iParam0], 780511057) != 1)
							{
								unk_0xD7F5B2902EBBD04E(iLocal_1047[iParam0], unk_0xFC1458A37D98B502(), 0, 16);
							}
						}
		...
		case 3:
			if (!unk_0x3AB6A1A9084FB0A4(iLocal_1047[iParam0]))
			{
				if (unk_0x353094543C6ECFC4(iLocal_1047[iParam0]))
				{
					unk_0x6CFCAFBA031AB20A(iLocal_1047[iParam0]);
				}
			}
			if (bLocal_1159)
			{
				...
				unk_0x78F763FF6DE9BCA2(0, unk_0xFC1458A37D98B502(), func_122(), 1f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				unk_0x1B16DD5C115FE009(uLocal_1324);
				unk_0xAB30B1CF01A198C1(iLocal_1047[iParam0], uLocal_1324);
				unk_0xFAA3EF7FF92E1F9E(&uLocal_1324);
			}
			else if (!unk_0x3AB6A1A9084FB0A4(iLocal_1047[iParam0]))
			{
				unk_0x4EC2D0046891F1C5(iLocal_1047[iParam0], Local_1305, 15f, 0, 0);
				unk_0x4F9A62E773100FDC(iLocal_1047[iParam0], 1);
				unk_0xAE6EBBBBD8B9FB30(iLocal_1047[iParam0], 0, 1);
				unk_0x5C57ECBE59C08573(iLocal_1047[iParam0], 2f);
				if (!iLocal_1131 && !unk_0x88DDBE9908752BF0(iLocal_1047[iParam0], 0))
				{
					unk_0x6931076730A4AC5D(&uLocal_1324);
					if (unk_0x3AB6A1A9084FB0A4(iLocal_1046))
					{
					...
					else
					{
						...
						unk_0xF2163C96119FBF4B(0, iLocal_1046, 1.5f, 0f, 0f, 2f, -1, 1036831949, 1);
					}
					unk_0x1B16DD5C115FE009(uLocal_1324);
					iLocal_1131 = 1;
				}
				else
				{
					if (unk_0x6ADD12BF4D6D2587(iLocal_1312) && unk_0xB8DE76287EDC4957(iLocal_1312, 0))
					{
						Var4 = { unk_0xDCD8BDD2E10C660E(iLocal_1312, unk_0xD323488FDDE4A80F(iLocal_1312, "wheel_lr")) };
						Var7 = { unk_0xB3328BA8976B416C(iLocal_1312, 1) };
						Var7 = { Var4 - Var7 };
						unk_0x31285BC066B7B5D6(iLocal_1047[iParam0], iLocal_1312, Var7, 1.5f, 0);
					}
					unk_0x6931076730A4AC5D(&uLocal_1324);
					unk_0x16416C5B54FDBCBB(0, 0, 0);
					if (unk_0x3AB6A1A9084FB0A4(iLocal_1046) && !func_44(func_142(), Var4, 0))
					{
						unk_0x1D077D3591C6FFA7(0, Var4, func_122(), 2f, 0, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
						unk_0x7C7B3B9FE1579DA8(0, Var4, -1, 0, 0.25f, 0, 0, 0, 1);
					}
					else
					{
						...
						if (!unk_0x191BE1BC8F26F3C1(iLocal_1046, 0))
						{
							unk_0xF2163C96119FBF4B(0, iLocal_1046, 0f, -1.5f, 0f, 2f, -1, 1036831949, 1);
						}
					}
					unk_0x1B16DD5C115FE009(uLocal_1324);
				}
		...
		case 4:
			if (!unk_0x191BE1BC8F26F3C1(iLocal_1047[iParam0], 0))
			{
				if (unk_0xA5F6598E13F98E08(iLocal_1047[iParam0], "oddjobs@assassinate@hotel@", "enter", 3))
				{
					fVar3 = unk_0x7A70772AE40E3821(iLocal_1047[iParam0], "oddjobs@assassinate@hotel@", "enter");
					if (fVar3 < 0.5f)
					{
						unk_0xCA854FCB18A4FD22(iLocal_1047[iParam0], "oddjobs@assassinate@hotel@", "enter", 3.5f);
					}
					else
					{
						unk_0xCA854FCB18A4FD22(iLocal_1047[iParam0], "oddjobs@assassinate@hotel@", "enter", 1f);
					}
				}
			}
			break;
		...
		case 5:
			...
			if (!unk_0x3AB6A1A9084FB0A4(iLocal_1046))
			{
				if (!unk_0x3AB6A1A9084FB0A4(iLocal_1047[iParam0]))
				{
					if (unk_0x88DDBE9908752BF0(iLocal_1046, 0))
					{
						unk_0xD7F5B2902EBBD04E(iLocal_1047[iParam0], iLocal_1045, 0, 16);
					}
					else
					{
						unk_0x2C85E478535743C1(iLocal_1047[iParam0], iLocal_1046, unk_0xFC1458A37D98B502(), 3f, 1, 0.005f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
					}
				}
	...
	else if (iLocal_1041[iParam0] < 5)
	{
		if (!unk_0x3AB6A1A9084FB0A4(iLocal_1047[iParam0]))
		{
			...
			unk_0x7CC6FC1BBB113002(iLocal_1047[iParam0]);
			unk_0x4F9A62E773100FDC(iLocal_1047[iParam0], 2);
			unk_0xAE6EBBBBD8B9FB30(iLocal_1047[iParam0], 13, 1);
		}
		iLocal_1041[iParam0] = 5;
	}
}
...
void func_144()
{
	...
	if (unk_0x6ADD12BF4D6D2587(iLocal_1046))
	{
		Local_1305 = { unk_0xB3328BA8976B416C(iLocal_1046, 0) };
	}
	switch (iLocal_1040)
	{
		case 0:
			if (!unk_0x191BE1BC8F26F3C1(iLocal_1046, 0))
			{
				if (unk_0xB8DE76287EDC4957(iLocal_1312, 0) && !unk_0x191BE1BC8F26F3C1(uLocal_1050[0], 0))
				{
					if (!unk_0xA8D0477084E86A92(iLocal_1046, iLocal_1312, 0))
					{
						if (unk_0x78F50AA8F955BEFC(iLocal_1046, -1794415470) != 1)
						{
							if (!iLocal_1134 && !iLocal_1158)
							{
								unk_0x6F8C8278B7C06889(iLocal_1046, iLocal_1312, 30000, 1, 1f, 1, 0);
							}
							else
							{
								unk_0x6F8C8278B7C06889(iLocal_1046, iLocal_1312, 30000, 1, 2f, 1, 0);
							}
		...
		case 1:
			...
			if (!iLocal_1179)
			{
				if (func_146())
				{
					if (func_24(iLocal_1046, unk_0xFC1458A37D98B502(), 1) <= 5f && !func_22())
					{
						if (func_30(25f, 1) == 0)
						{
							if (func_145())
		...
		case 4:
			if (!unk_0x191BE1BC8F26F3C1(iLocal_1046, 0))
			{
				if (unk_0xA8D0477084E86A92(iLocal_1046, iLocal_1312, 0))
				{
					if (unk_0x78F50AA8F955BEFC(iLocal_1046, -828834893) != 1)
					{
						unk_0x16416C5B54FDBCBB(iLocal_1046, 0, 256);
					}
				}
				else if (!bLocal_1164)
				{
					unk_0x5C57ECBE59C08573(iLocal_1046, 2f);
					unk_0xFAA3EF7FF92E1F9E(&uVar0);
					unk_0x6931076730A4AC5D(&uVar0);
					unk_0x12C9D41D52A560D6(0, "oddjobs@assassinate@hotel@", "alert_gunshot", 8f, -4f, 1000, 0, 0, 0, 0, 0);
					unk_0xD68E88A8E0BE8697(0, iLocal_1045, 200f, -1, 0, 0);
					unk_0x1B16DD5C115FE009(uVar0);
					if (!unk_0x191BE1BC8F26F3C1(iLocal_1046, 0))
					{
						unk_0xAB30B1CF01A198C1(iLocal_1046, uVar0);
					}
					unk_0xFAA3EF7FF92E1F9E(&uVar0);
					bLocal_1164 = true;
				}
				else if (unk_0x78F50AA8F955BEFC(iLocal_1046, 1435919172) != 1)
				{
					unk_0xD68E88A8E0BE8697(iLocal_1046, iLocal_1045, 200f, -1, 0, 0);
				}
				if (!iLocal_1179)
				{
...
int func_146()
{
	...
	if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
	{
		iVar0 = unk_0x317536BCEA8FA6B0(iLocal_1312, -1, 0);
		if (iVar0 == 0 || (iVar0 != 0 && unk_0x3AB6A1A9084FB0A4(iVar0)))
		{
			iVar0 = unk_0x317536BCEA8FA6B0(iLocal_1312, 0, 0);
			if (iVar0 == 0 || (iVar0 != 0 && unk_0x3AB6A1A9084FB0A4(iVar0)))
			{
				iVar0 = unk_0x317536BCEA8FA6B0(iLocal_1312, 2, 0);
				if (iVar0 == 0 || (iVar0 != 0 && unk_0x3AB6A1A9084FB0A4(iVar0)))
				{
					return 1;
				}
	...
	switch (iLocal_1031)
	{
		...
		case 6:
			...
			if (bLocal_1142)
			{
				...
				{
					func_51(&uLocal_1336, Global_104555.f_19933.f_5);
				}
				iLocal_1209 = func_507();
				if (Global_87155)
				{
	...
	switch (iLocal_1215)
	{
		case 0:
			if (!iLocal_377)
			{
				...
				Global_104555.f_19933.f_5 = func_46(&uLocal_1336);
				fLocal_372 = Global_104555.f_19933.f_5;
				func_232();
				iLocal_377 = 1;
				iLocal_1215 = 1;
			}
		...
		case 1:
			...
			if (func_228(&uLocal_388, 1, 0) && unk_0xEB55C9C28A1E0326())
			{
...
void func_204(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_219();
		unk_0x09C2CBFA4CD804AC(0.5f, (fVar1 - (func_222((2f - 0.5f)) - 0.001388889f)), fVar6, func_217(1f), uVar13, uVar14, uVar15, unk_0xF2DB717A73826179((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_203((fVar11 / (0.6f * func_222(25f))), 0f, 1f);
					func_219();
					unk_0x09C2CBFA4CD804AC(0.5f, (fVar1 + func_222((2f * 0.5f))), fVar6, func_217(1f), uVar13, uVar14, uVar15, unk_0xF2DB717A73826179((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_222((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_222((25f * 0.2f)));
...
var func_210(int iParam0, bool bParam1)
{
	...
	if (!unk_0xAB019B170BF1309C(&(Global_17301.f_6719[iParam0 /*16*/])))
	{
		...
		{
			Var19 = { func_212(unk_0x9EB17624F44A8DA4()) };
...
char* func_213(int iParam0)
{
	...
	if (!unk_0xAB019B170BF1309C(&(Global_17301.f_5886[iParam0 /*16*/])))
	{
		...
		{
			Var16 = { func_212(unk_0x9EB17624F44A8DA4()) };
...
void func_232()
{
	...
	if (!iLocal_377)
	{
		func_238(&uLocal_388, &Local_965, &Global_55918, 0);
		...
		else
		{
			...
			if (!unk_0xAB019B170BF1309C(&(Local_965.f_18)))
			{
				if (bLocal_375)
				{
...
void func_241()
{
	...
	switch (iLocal_1193)
	{
		...
		case 1:
			if (!unk_0x3AB6A1A9084FB0A4(unk_0xFC1458A37D98B502()))
			{
				fVar0 = func_26(unk_0xFC1458A37D98B502(), Local_1299, 1);
...
void func_243()
{
	...
	while (iVar0 < 2)
	{
		if (unk_0x6ADD12BF4D6D2587(iLocal_1047[iVar0]))
		{
			if (!unk_0x3AB6A1A9084FB0A4(iLocal_1047[iVar0]))
			{
				...
				unk_0xB8E08BD5B184DF4E(iLocal_1047[iVar0]);
				unk_0x486F346ADFE56674(&(iLocal_1047[iVar0]));
			}
		}
		iVar0++;
	}
	if (unk_0x6ADD12BF4D6D2587(iLocal_1046))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iLocal_1046))
		{
			unk_0xB8E08BD5B184DF4E(iLocal_1046);
			unk_0x486F346ADFE56674(&iLocal_1046);
		}
	}
	iVar0 = 0;
	while (iVar0 < 3)
	{
		if (unk_0x6ADD12BF4D6D2587(uLocal_1050[iVar0]))
		{
			if (!unk_0x3AB6A1A9084FB0A4(uLocal_1050[iVar0]))
			{
				...
				unk_0xB8E08BD5B184DF4E(uLocal_1050[iVar0]);
				unk_0x486F346ADFE56674(&(uLocal_1050[iVar0]));
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < 2)
	{
		if (unk_0x6ADD12BF4D6D2587(uLocal_1054[iVar0]))
		{
			if (!unk_0x3AB6A1A9084FB0A4(uLocal_1054[iVar0]))
			{
				...
				unk_0xB8E08BD5B184DF4E(uLocal_1054[iVar0]);
				unk_0x486F346ADFE56674(&(uLocal_1054[iVar0]));
			}
		}
		iVar0++;
	}
	unk_0x14776E43F90DD454(iLocal_1325);
}
...
void func_248()
{
	if (unk_0x6ADD12BF4D6D2587(iLocal_1312))
	{
		if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
		{
			unk_0x4BEFCD5DAE410A90(iLocal_1312, 1);
		}
		unk_0x5380482A432E314E(&iLocal_1312);
	}
	if (unk_0x6ADD12BF4D6D2587(iLocal_1313))
	{
		if (!unk_0x191BE1BC8F26F3C1(iLocal_1313, 0))
		{
			if ((unk_0x841ED61760A7D07B(iLocal_1313) && !unk_0xEC211A86AB3726B6(iLocal_1313)) && !unk_0x3E9CABD07B829173())
			{
				unk_0x5380482A432E314E(&iLocal_1313);
			}
			else
			{
				if (unk_0x6ADD12BF4D6D2587(uLocal_1054[0]) && !unk_0x191BE1BC8F26F3C1(uLocal_1054[0], 0))
				{
					if (!unk_0x191BE1BC8F26F3C1(iLocal_1313, 0))
					{
						if (unk_0xA8D0477084E86A92(uLocal_1054[0], iLocal_1313, 0))
						{
							unk_0x957CEE967C939968(uLocal_1054[0]);
						}
					}
				}
				if (unk_0x6ADD12BF4D6D2587(uLocal_1054[1]) && !unk_0x191BE1BC8F26F3C1(uLocal_1054[1], 0))
				{
					if (!unk_0x191BE1BC8F26F3C1(iLocal_1313, 0))
					{
						if (unk_0xA8D0477084E86A92(uLocal_1054[1], iLocal_1313, 0))
						{
							unk_0x957CEE967C939968(uLocal_1054[1]);
						}
					}
				}
				if (!unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
				{
					if (unk_0xA8D0477084E86A92(unk_0xFC1458A37D98B502(), iLocal_1313, 0))
					{
	...
	if (unk_0x6ADD12BF4D6D2587(uLocal_1316[0]))
	{
		unk_0x5380482A432E314E(&(uLocal_1316[0]));
	}
	if (unk_0x6ADD12BF4D6D2587(uLocal_1316[1]))
	{
		unk_0x5380482A432E314E(&(uLocal_1316[1]));
	}
	if (unk_0x6ADD12BF4D6D2587(iLocal_1319) && !unk_0x191BE1BC8F26F3C1(iLocal_1319, 0))
	{
		if (unk_0x9761C10D57B68069(iLocal_1319) && unk_0xCB234F3DD6FF9368(iLocal_1319, 1))
		{
			unk_0x5380482A432E314E(&iLocal_1319);
		}
	}
}
...
void func_249(bool bParam0)
{
	...
	if (bParam0)
	{
		if (unk_0xA6DECE14FC9A8C51(uLocal_1120))
		{
			unk_0xE30CF11C0EE14316(&uLocal_1120);
		}
	}
	iVar0 = 0;
	while (iVar0 < 3)
	{
		if (unk_0xA6DECE14FC9A8C51(uLocal_1121[iVar0]))
		{
			unk_0xE30CF11C0EE14316(&(uLocal_1121[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 2)
	{
		if (unk_0xA6DECE14FC9A8C51(uLocal_1125[iVar0]))
		{
			unk_0xE30CF11C0EE14316(&(uLocal_1125[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
...
void func_250()
{
	if (unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), Local_1293, Local_1296, fLocal_1243, 1, 0, 0))
	{
		bLocal_1152 = true;
	}
	else
...
void func_252()
{
	if (!bLocal_1149)
	{
		if (unk_0x6ADD12BF4D6D2587(iLocal_1312))
		{
			if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
			{
				unk_0x4BEFCD5DAE410A90(iLocal_1312, 3);
	...
	switch (iLocal_1193)
	{
		case 0:
			if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
			{
				if (func_134())
				{
					if (!unk_0x3AB6A1A9084FB0A4(uLocal_1050[0]))
					{
						if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
						{
							if (unk_0xA8D0477084E86A92(uLocal_1050[0], iLocal_1312, 0))
							{
								bLocal_1145 = true;
								func_251();
								iLocal_1031 = 13;
...
void func_259()
{
	unk_0x14776E43F90DD454(iLocal_1327);
	unk_0x14776E43F90DD454(iLocal_1328);
}
...
void func_261(var uParam0)
{
	...
	{
		if (unk_0xEC211A86AB3726B6(*uParam0))
		{
...
void func_263()
{
	...
	if (unk_0x6ADD12BF4D6D2587(iLocal_1046) && !unk_0x191BE1BC8F26F3C1(iLocal_1046, 0))
	{
		Var7 = { unk_0xB3328BA8976B416C(iLocal_1046, 1) };
		fVar10 = unk_0xF0371FE6E2BF9599(iLocal_1046);
	}
	Var0[0 /*3*/] = { unk_0x9EA50C5EC175E58E(Var7, fVar10, 1f, -1f, 0f) };
	Var0[1 /*3*/] = { unk_0x9EA50C5EC175E58E(Var7, fVar10, -1f, -1f, 0f) };
	iVar11 = 0;
	while (iVar11 < 2)
	{
		if (iVar11 == 0)
		{
			iLocal_1047[iVar11] = unk_0xAC992EFAD62C33BF(26, iLocal_1327, Var0[0 /*3*/], Var0[0 /*3*/].f_1, 38.3253f, uLocal_1239[iLocal_1202], 1, 1);
		}
		else
		{
			iLocal_1047[iVar11] = unk_0xAC992EFAD62C33BF(26, iLocal_1328, Var0[1 /*3*/], Var0[1 /*3*/].f_1, 38.3253f, uLocal_1239[iLocal_1202], 1, 1);
		}
		unk_0xCFF0CD14B439821D(iLocal_1047[iVar11], 1, 1);
		unk_0xE537629E02E8DA21(iLocal_1047[iVar11]);
		unk_0xAE6EBBBBD8B9FB30(iLocal_1047[iVar11], 3, 0);
		unk_0xAE6EBBBBD8B9FB30(iLocal_1047[iVar11], 23, 1);
		unk_0xAE6EBBBBD8B9FB30(iLocal_1047[iVar11], 30, 0);
		unk_0xAE6EBBBBD8B9FB30(iLocal_1047[iVar11], 13, 1);
		unk_0x3811A0FC01E02FC1(iLocal_1047[iVar11], 2);
		unk_0xE9B3D12A64CC7C1A(iLocal_1047[iVar11], 1);
		func_264(iLocal_1047[iVar11], 1);
		unk_0x3FF3A0D63A2E2DB1(iLocal_1047[iVar11], 1);
		iVar11++;
	}
}
...
void func_264(int iParam0, bool bParam1)
{
	...
	{
		unk_0x9E058151726E58DE(iParam0, joaat("weapon_pistol"), -1, 0, 1);
	}
	if (!bParam1)
	{
	...
	unk_0xCE93FCB8A8D8DF0B(iParam0, iLocal_1332);
}

void func_265()
{
	func_267();
	iLocal_1202 = unk_0x63A6486593EC7EC3(0, iLocal_1195);
	iLocal_1046 = unk_0xAC992EFAD62C33BF(26, iLocal_1325, Local_1258[iLocal_1202 /*3*/], uLocal_1239[iLocal_1202], 1, 1);
	unk_0xCFF0CD14B439821D(iLocal_1046, 1, 1);
	unk_0xE537629E02E8DA21(iLocal_1046);
	...
	unk_0xA5D25D3F884FF516(uLocal_1120, 1f);
}
...
int func_266(int iParam0, int iParam1, bool bParam2)
{
	...
	if (unk_0x8A3FF8E81B40BB75(iParam0))
	{
		unk_0xA5D25D3F884FF516(uVar0, func_196(unk_0x3A711520F83BAE98(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xA5D25D3F884FF516(uVar0, func_196(unk_0x3A711520F83BAE98(), 0.7f, 0.7f));
		unk_0xDB6E56C09E5CF0AA(uVar0, iParam1);
	}
	else if (unk_0x0423B20CB20B7901(iParam0))
	{
...
void func_267()
{
	...
	while (iVar0 < 3)
	{
		if (!unk_0x9E06F0EE20F58CED(Local_1248[iVar0 /*3*/], 5f) && !func_271(iVar0, 6f))
		{
...
{
	return func_26(unk_0x25D049AAC4603E65(unk_0x98EC0789D9F0703B()), Param0, iParam3);
}
...
{
	if (unk_0x717FFCE23DE4C8C8(Local_1248[iParam0 /*3*/], fParam1))
	{
		return 1;
	}
	return 0;
...
int func_273()
{
	...
	unk_0x6FF834D85E2DD4C6(iLocal_1325);
	if (unk_0x9A0B2ED5055D3F0B(iLocal_1325))
	{
		iVar0 = 1;
	}
	else
...
int func_274()
{
	if (((unk_0x6ADD12BF4D6D2587(uLocal_1050[0]) && unk_0x6ADD12BF4D6D2587(uLocal_1050[1])) && !unk_0x3AB6A1A9084FB0A4(uLocal_1050[0])) && !unk_0x3AB6A1A9084FB0A4(uLocal_1050[1]))
	{
		if (unk_0xA8D0477084E86A92(uLocal_1050[0], iLocal_1312, 0) && unk_0xA8D0477084E86A92(uLocal_1050[1], iLocal_1312, 0))
		{
			return 1;
		}
	}
...
void func_276()
{
	switch (iLocal_1193)
	{
		case 0:
			...
			if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
			{
				unk_0xA15269351F50F113(iLocal_1312, 0, 1, 0);
			}
			if (!unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
			{
				if (!unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0))
			...
			unk_0x872F1C1F8587CCC7(&Local_360, 4);
	...
	*uParam0 = unk_0x87889570F3396ABD(-1221.954f, -210.746f, 38.638f, 27f, 0, 4);
	...
	if (iLocal_1319 != 0)
	{
		if (unk_0x6ADD12BF4D6D2587(iLocal_1319) && !unk_0x191BE1BC8F26F3C1(iLocal_1319, 0))
		{
			...
			{
				Var0 = { unk_0xB3328BA8976B416C(iLocal_1319, 1) };
				return 1;
			}
		}
	}
...
void func_280()
{
	...
	while (iVar1 < 3)
	{
		if (!unk_0x6ADD12BF4D6D2587(uLocal_1050[iVar1]))
		{
			if (iVar1 == 2)
			{
				iVar0 = iLocal_1328;
			...
			uLocal_1050[iVar1] = unk_0xAC992EFAD62C33BF(26, iVar0, Local_1268[iVar1 /*3*/], fLocal_1221[iVar1], 1, 1);
			if (iVar1 == 0)
			{
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 0, 0, 2, 0);
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 3, 0, 0, 0);
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 4, 0, 1, 0);
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 8, 0, 0, 0);
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 11, 0, 0, 0);
			}
			else if (iVar1 == 1)
			{
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 0, 1, 2, 0);
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 3, 0, 1, 0);
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 4, 0, 0, 0);
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 8, 0, 0, 0);
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 11, 0, 2, 0);
			}
			else if (iVar1 == 2)
			{
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 0, 1, 2, 0);
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 3, 0, 2, 0);
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 4, 0, 1, 0);
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 8, 0, 0, 0);
				unk_0x03924C68EFCBC511(uLocal_1050[iVar1], 11, 1, 1, 0);
			}
		}
		if (!unk_0x3AB6A1A9084FB0A4(uLocal_1050[iVar1]))
		{
			unk_0x5C5D33A1B2711D21(uLocal_1050[iVar1], 0);
			unk_0xE9B3D12A64CC7C1A(uLocal_1050[iVar1], 1);
			unk_0xAE6EBBBBD8B9FB30(uLocal_1050[iVar1], 23, 1);
			unk_0xAE6EBBBBD8B9FB30(uLocal_1050[iVar1], 30, 0);
			unk_0x3811A0FC01E02FC1(uLocal_1050[iVar1], 2);
			unk_0xAE01EF4BC84AFE7C(uLocal_1050[iVar1], 104, 1);
...
void func_281()
{
	func_283();
	func_282();
	unk_0x14776E43F90DD454(iLocal_1329);
}
...
void func_282()
{
	...
	while (iVar0 < 2)
	{
		if (!unk_0x6ADD12BF4D6D2587(uLocal_1054[iVar0]))
		{
			if (iVar0 == 0)
			{
				uLocal_1054[iVar0] = unk_0x00D1A9572426E8DD(iLocal_1313, 26, iLocal_1327, -1, 1, 1);
			}
			else if (iVar0 == 1)
			{
				uLocal_1054[iVar0] = unk_0x00D1A9572426E8DD(iLocal_1313, 26, iLocal_1328, 0, 1, 1);
			}
			func_264(uLocal_1054[iVar0], 1);
			unk_0xAE6EBBBBD8B9FB30(uLocal_1054[iVar0], 3, 0);
			unk_0xAE6EBBBBD8B9FB30(uLocal_1054[iVar0], 23, 1);
			unk_0xAE6EBBBBD8B9FB30(uLocal_1054[iVar0], 30, 0);
			unk_0x3811A0FC01E02FC1(uLocal_1054[iVar0], 2);
			unk_0xE9B3D12A64CC7C1A(uLocal_1054[iVar0], 1);
		}
		iVar0++;
	}
}
...
void func_283()
{
	if (!unk_0x6ADD12BF4D6D2587(iLocal_1313))
	{
		iLocal_1313 = unk_0xEA60F3B426BB095B(iLocal_1329, Local_1284, fLocal_1233, 1, 1, 0);
		unk_0x207466E78DA21033(iLocal_1313, 0);
	}
}
...
void func_298(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_358(unk_0x436287B7DB306165(), 1);
			if (iVar5 != -1)
			{
				Global_104555.f_18544[iVar5 /*6*/].f_4 = 0;
				MemCopy(&uVar6, {func_357(iVar5)}, 4);
				unk_0xEBDD0888F628D3FB(&uVar6, 0, Global_92870, iParam0);
			}
			else
			{
				iVar10 = func_356(&(Global_92833.f_3));
				if (iVar10 > -1)
				{
...
void func_314(int iParam0, var uParam1)
{
	...
	if (!unk_0x3AB6A1A9084FB0A4(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0xB50B73D3F4DD1613(iParam0, func_319(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((unk_0xD10DDFA63A9D9BDA(iVar9, &Var11) && !func_316(Var11.f_1)) && iVar72 < 50)
			{
...
int func_322(struct<3> Param0, char* sParam3, struct<3> Param4)
{
	int iVar0;
	int iVar1;
...
int func_330(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 47)
	{
		if (iParam3 == 6 || iParam3 == func_343(iVar0))
		{
			...
			{
				fVar1 = unk_0xBE3C4023003180FC(Param0, func_331(iVar0, 0), 1);
...
Vector3 func_333(int iParam0, int iParam1)
{
	...
	if (Global_1595538 != func_68())
	{
		if (iParam1 == 3)
		{
			if (func_334(iParam0, 1, &Var0, 0, 0))
			{
				Var6 = { Var0 };
			}
		}
		else if (iParam1 == 2)
		{
			...
			{
				if (func_334(iParam0, 2, &Var0, 0, 0))
				{
					Var6 = { Var0 };
				}
			}
...
int func_334(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	Var18 = { Var12 - Var0 };
	Var18 = { func_335(Var18, -Var0.f_3.f_2) };
	Var18 = { func_335(Var18, Var6.f_3.f_2) };
	*uParam2 = { unk_0x9EA50C5EC175E58E(Var6, 0f, Var18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_335(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_351(unk_0xC80D31E4B587871C(iParam0, 31), -1, 1)) + 2011;
}
...
void func_360(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, struct<3> Param7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_368()
{
	...
	{
		case 0:
			if (func_399(1084227584, 1) || (bLocal_1151 && unk_0xC548195DB18979E1(uLocal_1130)))
			{
				func_398(-1248.398f, -183.366f, 37.72881f, -1216.437f, -196.8727f, 44.07541f, 59.25f, Local_1665, fLocal_1668, 1, 1, 1, 0, 0);
				unk_0x9B8406983378711E(-1220.57f, -185.96f, 38.4f, 50f, 0, 0, 0, 0, 0, 0);
				...
				if (!unk_0x191BE1BC8F26F3C1(iLocal_1312, 0))
				{
					if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
					{
						unk_0x8D7ABC97ED508270(iLocal_1312, 107, "ASSOJva", 1);
						unk_0x7A1DBB5E36EE3379(iLocal_1312, 2500f);
					}
				}
				if (!unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
				{
			...
			else if (unk_0xC548195DB18979E1(uLocal_1130))
			{
			}
			break;
...
int func_369()
{
	...
	switch (iLocal_1194)
	{
		case 0:
			func_395(0, 0, 1);
			func_394();
			unk_0x7E4FCDC8BAD0CF6D(uLocal_1330, "HAND_SHAKE", 0.2f);
			unk_0x7E4FCDC8BAD0CF6D(uLocal_1331, "HAND_SHAKE", 0.2f);
			unk_0xF10DA1539629CC3F(uLocal_1331, uLocal_1330, 6000, 0, 0);
		...
		case 1:
			if (!unk_0x191BE1BC8F26F3C1(iLocal_1312, 0))
			{
				if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
				{
					...
					{
						if (unk_0x8DDE799D31A3D099(iLocal_1312))
						{
							unk_0x7674774BB9279265(iLocal_1312);
						}
						unk_0x8D7ABC97ED508270(iLocal_1312, 102, "ASSOJva", 1);
						unk_0x7A1DBB5E36EE3379(iLocal_1312, 4500f);
						unk_0x62429167B5AEF353(iLocal_1312, 1);
						func_246("ASS_VA_SNIPE2", 7500, 1);
						unk_0xA6DE0FBA9218D7F0(uLocal_1330, -1218.861f, -191.0496f, 38.83616f, 3.519839f, -0.000706f, 42.27108f, 38f, 0, 1, 1, 2);
						unk_0xCA21C7D4C54FCA93(uLocal_1330, 0.5f);
						unk_0x9A20E34C5F56D075(uLocal_1330, 7f);
						unk_0x7E4FCDC8BAD0CF6D(uLocal_1330, "HAND_SHAKE", 0.2f);
						unk_0xA6DE0FBA9218D7F0(uLocal_1331, -1218.91f, -190.8791f, 38.84585f, 3.519839f, -0.000706f, 43.33815f, 38f, 0, 1, 1, 2);
						unk_0xCA21C7D4C54FCA93(uLocal_1331, 0.7f);
						unk_0x9A20E34C5F56D075(uLocal_1331, 10f);
						unk_0x7E4FCDC8BAD0CF6D(uLocal_1331, "HAND_SHAKE", 0.2f);
						unk_0xF10DA1539629CC3F(uLocal_1331, uLocal_1330, 2000, 3, 3);
						iLocal_1194++;
					}
				}
			}
		...
		case 2:
			if (!unk_0x191BE1BC8F26F3C1(iLocal_1312, 0))
			{
				if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
				{
					if (unk_0x9DC40A4E8D2F7969(iLocal_1312) >= 7000f)
					{
						unk_0x5496EE849BB0CFF1(iLocal_1312);
						iLocal_1192 = 0;
						while (iLocal_1192 < 3)
						{
							if (!unk_0x191BE1BC8F26F3C1(uLocal_1050[iLocal_1192], 0))
							{
								if (iLocal_1192 == 0)
								{
									iVar0 = 1250;
								...
								if (unk_0x78F50AA8F955BEFC(uLocal_1050[iLocal_1192], 242628503) != 1)
								{
									unk_0xFAA3EF7FF92E1F9E(&uLocal_1324);
									unk_0x6931076730A4AC5D(&uLocal_1324);
									unk_0x16416C5B54FDBCBB(0, iVar0, 0);
									unk_0x380C1E7B7740D618(0, Local_1248[iLocal_1192 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
									unk_0x1B16DD5C115FE009(uLocal_1324);
									unk_0xAB30B1CF01A198C1(uLocal_1050[iLocal_1192], uLocal_1324);
									unk_0xFAA3EF7FF92E1F9E(&uLocal_1324);
								}
							}
							iLocal_1192++;
		...
		case 3:
			if (unk_0x83666F9FB8FEBD4B() >= 2000)
			{
				...
				{
					unk_0xA6DE0FBA9218D7F0(uLocal_1330, -1265.549f, -213.4919f, 43.0913f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
					unk_0x7E4FCDC8BAD0CF6D(uLocal_1330, "HAND_SHAKE", 0.2f);
					unk_0xA6DE0FBA9218D7F0(uLocal_1331, -1266.063f, -213.922f, 43.0918f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
					unk_0x7E4FCDC8BAD0CF6D(uLocal_1331, "HAND_SHAKE", 0.2f);
					unk_0xF10DA1539629CC3F(uLocal_1331, uLocal_1330, 4000, 3, 3);
					iLocal_1217 = 4000;
				}
				else
				{
					unk_0xA6DE0FBA9218D7F0(uLocal_1330, -1266.193f, -215.217f, 43.2442f, -3.1088f, 0.0498f, -48.5594f, 38f, 0, 1, 1, 2);
					unk_0x7E4FCDC8BAD0CF6D(uLocal_1330, "HAND_SHAKE", 0.2f);
					unk_0xA6DE0FBA9218D7F0(uLocal_1331, -1267.53f, -215.7824f, 43.1067f, -9.2365f, 0.0498f, -48.3561f, 38f, 0, 1, 1, 2);
					unk_0x7E4FCDC8BAD0CF6D(uLocal_1331, "HAND_SHAKE", 0.2f);
					unk_0xF10DA1539629CC3F(uLocal_1331, uLocal_1330, 4000, 3, 3);
					iLocal_1217 = 4000;
				}
		...
		case 4:
			...
			if (unk_0x83666F9FB8FEBD4B() >= iLocal_1217)
			{
				...
				unk_0xDA5162F6425C44AA(iLocal_1312, 1, 1);
				unk_0xDA5162F6425C44AA(iLocal_1312, 0, 1);
				unk_0xDA5162F6425C44AA(iLocal_1312, 2, 1);
				unk_0x3E80C2F7BC665259(1);
				if (unk_0x1FB367C588A91451() == 4)
				{
...
void func_370(bool bParam0)
{
	...
	if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
	{
		...
		unk_0x9E6ACDF1473CD846(102, "ASSOJva");
		unk_0x9E6ACDF1473CD846(107, "ASSOJva");
		unk_0xBD8D47FDC6902B2D(iLocal_1312, Local_1290, 1, 0, 0, 1);
		unk_0x48ED7B2293A96722(iLocal_1312, fLocal_1220);
		unk_0xDA5162F6425C44AA(iLocal_1312, 0, 1);
		unk_0xDA5162F6425C44AA(iLocal_1312, 1, 1);
		unk_0xDA5162F6425C44AA(iLocal_1312, 2, 1);
		unk_0xDA5162F6425C44AA(iLocal_1312, 2, 1);
...
{
	func_386(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}
	...
	if (unk_0x6ADD12BF4D6D2587(iVar0))
	{
		...
		if (unk_0xB8DE76287EDC4957(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_388(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_388(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (unk_0xB8DE76287EDC4957(iParam0, 0))
	{
		...
		if (((((((((((((((func_389(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_389(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_389(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_389(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_389(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_389(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_389(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_389(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_389(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_389(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_389(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_389(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_389(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_389(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_389(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_389(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_389(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_393()
{
	...
	{
		unk_0x957CEE967C939968(unk_0xFC1458A37D98B502());
		unk_0xBD8D47FDC6902B2D(unk_0xFC1458A37D98B502(), Local_1302, 1, 0, 0, 1);
		unk_0x48ED7B2293A96722(unk_0xFC1458A37D98B502(), 299.4985f);
	}
	if (unk_0x6ADD12BF4D6D2587(iLocal_1315))
	{
		if (unk_0xB8DE76287EDC4957(iLocal_1315, 0))
		{
			unk_0xA15269351F50F113(iLocal_1315, 0, 1, 0);
			unk_0xBD8D47FDC6902B2D(iLocal_1315, -1251.873f, -256.7999f, 38.2695f, 1, 0, 0, 1);
			unk_0x48ED7B2293A96722(iLocal_1315, 296.7603f);
			unk_0xACE486395AA1867D(iLocal_1315, 1084227584);
		}
	}
}
...
void func_396()
{
	if (unk_0x6ADD12BF4D6D2587(iLocal_1312))
	{
		if (unk_0xB8DE76287EDC4957(iLocal_1312, 0))
		{
			...
			while (iLocal_1192 < 3)
			{
				if (!unk_0x6ADD12BF4D6D2587(uLocal_1050[iLocal_1192]))
				{
					if (iLocal_1192 == 0)
					{
						uLocal_1050[iLocal_1192] = unk_0x00D1A9572426E8DD(iLocal_1312, 26, iLocal_1327, -1, 1, 1);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 0, 0, 2, 0);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 3, 0, 0, 0);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 4, 0, 1, 0);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 8, 0, 0, 0);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 11, 0, 0, 0);
					}
					else if (iLocal_1192 == 1)
					{
						uLocal_1050[iLocal_1192] = unk_0x00D1A9572426E8DD(iLocal_1312, 26, iLocal_1327, 0, 1, 1);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 0, 1, 2, 0);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 3, 0, 1, 0);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 4, 0, 0, 0);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 8, 0, 0, 0);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 11, 0, 2, 0);
					}
					else if (iLocal_1192 == 2)
					{
						uLocal_1050[iLocal_1192] = unk_0x00D1A9572426E8DD(iLocal_1312, 26, iLocal_1328, 1, 1, 1);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 0, 1, 2, 0);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 3, 0, 2, 0);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 4, 0, 1, 0);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 8, 0, 0, 0);
						unk_0x03924C68EFCBC511(uLocal_1050[iLocal_1192], 11, 1, 1, 0);
					}
				}
				iLocal_1192++;
			}
...
void func_397()
{
	if (!unk_0x6ADD12BF4D6D2587(iLocal_1312))
	{
		iLocal_1312 = unk_0xEA60F3B426BB095B(iLocal_1326, Local_1287, fLocal_1219, 1, 1, 0);
		unk_0x14776E43F90DD454(iLocal_1326);
		unk_0xFA87254221D30EB8(iLocal_1312, 1);
		unk_0xCFF0CD14B439821D(iLocal_1312, 1, 1);
		unk_0x55B1BF6B77028A46(iLocal_1312, 1);
	}
}
...
{
	func_386(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}
...
int func_399(int iParam0, int iParam1)
{
	...
	if (((unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0) && func_400(unk_0xDFD115BB10FE46A9(unk_0xFC1458A37D98B502(), 0), iParam0, 1, 1056964608, 0, 1, 0)) && !unk_0x0ACC2116170FA204(unk_0xFC1458A37D98B502())) || !unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0))
	{
...
int func_400(int iParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_402()
{
	...
	switch (iLocal_1193)
	{
		...
		case 1:
			func_415();
			if (!unk_0x6ADD12BF4D6D2587(iLocal_1319))
			{
				if (!unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
				{
					if (unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0))
					{
						...
						{
							iLocal_1319 = unk_0xDFD115BB10FE46A9(unk_0xFC1458A37D98B502(), 0);
							if (unk_0x6ADD12BF4D6D2587(iLocal_1319) && !unk_0x191BE1BC8F26F3C1(iLocal_1319, 0))
							{
								func_284(iLocal_1319);
							}
			...
			if (!unk_0xC308146F18B10A6F(unk_0x9EB17624F44A8DA4(), 0))
			{
				if (!func_412())
				{
					if (!unk_0xA6DECE14FC9A8C51(uLocal_1119))
					{
						uLocal_1119 = func_411(Local_1302, 1);
						unk_0x62BD54E491535B76(uLocal_1119, "ASS_VA_DESTBLIP");
						func_410(&uLocal_1119, -1234.307f, -250.6783f, 38.2238f, 28.914f);
						if (!iLocal_1133)
						{
				...
				else if (unk_0xC548195DB18979E1(uLocal_1130) && func_408())
				{
					func_407();
					func_251();
					iLocal_1031 = 8;
			...
			{
				func_406(uLocal_1119, "ASS_VA_LOSECOPS");
			}
			else
			{
				func_31(3);
...
void func_403()
{
	if (!iLocal_1132)
	{
		...
		{
			func_405();
			uLocal_1130 = unk_0xC167CBCBE7230263(-1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 80f, 12, 127);
			iLocal_1132 = 1;
		}
	}
	else if (func_269(Local_1302, 1) > 120f)
	{
		if (unk_0xB774D40D7819292F(uLocal_1130))
		{
			unk_0x48B475D0F512A41A(uLocal_1130);
			func_259();
			iLocal_1132 = 0;
		}
	}
	else if (!unk_0xB774D40D7819292F(uLocal_1130))
	{
		if (!func_404())
		{
			iLocal_1132 = 0;
...
void func_405()
{
	unk_0x6FF834D85E2DD4C6(iLocal_1327);
	unk_0x6FF834D85E2DD4C6(iLocal_1328);
}
...
void func_407()
{
	if (unk_0xA6DECE14FC9A8C51(uLocal_1119))
	{
		unk_0xE30CF11C0EE14316(&uLocal_1119);
	}
}
...
int func_408()
{
	...
	func_405();
	if (unk_0x9A0B2ED5055D3F0B(iLocal_1327) && unk_0x9A0B2ED5055D3F0B(iLocal_1328))
	{
		iVar0 = 1;
	}
	else
...
void func_410(var uParam0, struct<3> Param1, float fParam4)
{
	if (unk_0xA6DECE14FC9A8C51(*uParam0))
	{
...
var func_411(struct<3> Param0, int iParam3)
{
	var uVar0;
...
int func_412()
{
	...
	if (func_413())
	{
		if (unk_0x0C88267282FD588F(iLocal_1045, Local_1302, 25f, 25f, 90f, 1, 1, 0))
		{
			iVar1 = 1;
		}
	}
	if (unk_0xF5D0CBECCA41314A(unk_0x9EB17624F44A8DA4()) == 0)
	{
		if ((fVar0 < 2f || unk_0x0C88267282FD588F(iLocal_1045, Local_1302, 2f, 2f, 2f, 1, 1, 0)) || iVar1)
		{
...
int func_413()
{
	...
	{
		iLocal_1315 = unk_0xDFD115BB10FE46A9(unk_0xFC1458A37D98B502(), 0);
		iVar0 = unk_0x82FF3DFBC3965CC0(iLocal_1315);
...
void func_414()
{
	...
	switch (iLocal_1205)
	{
		...
		case 1:
			Local_1691[0] = unk_0xAC992EFAD62C33BF(4, joaat("a_f_m_bevhills_01"), -1220.679f, -203.2689f, 38.3251f, 321.2841f, 1, 1);
			Local_1691[1] = unk_0xAC992EFAD62C33BF(4, joaat("a_f_m_bevhills_02"), -1219.596f, -201.3663f, 38.3251f, 110.7199f, 1, 1);
			unk_0x771A86309E0CA47B(Local_1691[0], 1);
			unk_0x771A86309E0CA47B(Local_1691[1], 1);
			unk_0x6931076730A4AC5D(&uVar0);
			unk_0x60C06BFD037BB7CF(0, Local_1691[1], -1, 0, 2);
			unk_0xE81769B567532C48(0, "WORLD_HUMAN_TOURIST_MOBILE", -1220.679f, -203.2689f, 38.3251f, 321.2841f, 0, 0, 1);
			unk_0x1B16DD5C115FE009(uVar0);
			if (!unk_0x191BE1BC8F26F3C1(Local_1691[0], 0))
			{
				unk_0xAB30B1CF01A198C1(Local_1691[0], uVar0);
			}
			unk_0xFAA3EF7FF92E1F9E(&uVar0);
			unk_0x6931076730A4AC5D(&uVar0);
			unk_0x60C06BFD037BB7CF(0, Local_1691[0], -1, 0, 2);
			unk_0xE81769B567532C48(0, "WORLD_HUMAN_TOURIST_MAP", -1219.596f, -201.3663f, 38.3251f, 110.7199f, 0, 0, 1);
			unk_0x1B16DD5C115FE009(uVar0);
			if (!unk_0x191BE1BC8F26F3C1(Local_1691[1], 0))
			{
				unk_0xAB30B1CF01A198C1(Local_1691[1], uVar0);
			}
			unk_0xFAA3EF7FF92E1F9E(&uVar0);
			Local_1691.f_4 = unk_0xEA60F3B426BB095B(joaat("taxi"), -1221.73f, -199.0665f, 38.1751f, 152.5038f, 1, 1, 0);
			unk_0xACE486395AA1867D(Local_1691.f_4, 1084227584);
			Local_1691.f_3 = unk_0x00D1A9572426E8DD(Local_1691.f_4, 4, joaat("a_m_y_hipster_01"), -1, 1, 1);
			unk_0x771A86309E0CA47B(Local_1691.f_3, 1);
			unk_0x60C06BFD037BB7CF(Local_1691.f_3, Local_1691[0], -1, 0, 2);
			Local_1691.f_8[0] = unk_0xAC992EFAD62C33BF(4, joaat("a_m_m_bevhills_01"), -1211.597f, -184.5331f, 38.3255f, 4.5193f, 1, 1);
			Local_1691.f_8[1] = unk_0xAC992EFAD62C33BF(4, joaat("a_m_y_hipster_01"), -1211.654f, -182.7625f, 38.3255f, 166.2532f, 1, 1);
			unk_0x771A86309E0CA47B(Local_1691.f_8[0], 1);
			unk_0x771A86309E0CA47B(Local_1691.f_8[1], 1);
			unk_0x12C9D41D52A560D6(Local_1691.f_8[0], "oddjobs@assassinate@hotel@", "idle_a", 8f, -4f, -1, 1, 0, 0, 0, 0);
			unk_0x12C9D41D52A560D6(Local_1691.f_8[1], "oddjobs@assassinate@hotel@", "argue_b", 8f, -4f, -1, 1, 0, 0, 0, 0);
			Local_1691.f_5[0] = unk_0xAC992EFAD62C33BF(4, joaat("a_m_m_bevhills_01"), -1229.099f, -176.3197f, 38.3255f, 231.8036f, 1, 1);
			Local_1691.f_5[1] = unk_0xAC992EFAD62C33BF(4, joaat("a_f_m_bevhills_02"), -1249.779f, -162.4767f, 39.4131f, 220.1651f, 1, 1);
			unk_0x771A86309E0CA47B(Local_1691.f_5[0], 1);
			unk_0x771A86309E0CA47B(Local_1691.f_5[1], 1);
			unk_0x12C9D41D52A560D6(Local_1691.f_5[0], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
			unk_0x12C9D41D52A560D6(Local_1691.f_5[1], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
			Local_1691.f_11 = 1;
...
void func_415()
{
	...
	if (iLocal_1186)
	{
		if (!unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
		{
			fLocal_1245 = unk_0x2A488C176D52CCA5(unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1), Local_1302);
			iLocal_1186 = 0;
		}
	}
...
void func_417()
{
	...
	if (unk_0x6ADD12BF4D6D2587(iLocal_1058))
	{
		func_422();
		if (!unk_0x3AB6A1A9084FB0A4(iLocal_1058))
		{
			fVar1 = func_23(iLocal_1058, 1);
			unk_0x4ACB9D202CFF8727(iLocal_1058, 0);
			unk_0xEB2D96E7D3F4906C(iLocal_1058, 0);
			unk_0x5C5D33A1B2711D21(iLocal_1058, 0);
			unk_0x66698545014E2F21(iLocal_1058, 16);
			unk_0xAE01EF4BC84AFE7C(iLocal_1058, 208, 1);
			if (fVar1 < 5f)
			{
			...
			{
				if (unk_0xEC211A86AB3726B6(iLocal_1058) || !unk_0x841ED61760A7D07B(iLocal_1058))
				{
					func_418();
				}
			}
			switch (iLocal_1191)
			{
				case 0:
					if (!unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
					{
						if ((unk_0x08765A6321A42CA1(unk_0xFC1458A37D98B502()) || (unk_0x6ADD12BF4D6D2587(iLocal_1058) && unk_0xEBE499597C718EB8(iLocal_1058, unk_0xFC1458A37D98B502(), 1))) || unk_0xEBE499597C718EB8(iLocal_1690, unk_0xFC1458A37D98B502(), 1))
						{
							if (unk_0xEBE499597C718EB8(iLocal_1690, unk_0xFC1458A37D98B502(), 1))
							{
							}
							unk_0x60C54803C97FDAAB(iLocal_1058, "move_lester_CaneUp", 1048576000);
							unk_0x12C9D41D52A560D6(iLocal_1058, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 1000f, -4f, -1, 790536, 0, 0, 0, 0);
							iLocal_1191 = 1;
						}
					}
					break;
				...
				case 1:
					if (unk_0xA5F6598E13F98E08(iLocal_1058, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 3))
					{
						if (unk_0x7A70772AE40E3821(iLocal_1058, "oddjobs@assassinate@hotel@leadin", "Lester_Getup") >= 0.376f)
						{
							unk_0x6931076730A4AC5D(&uVar0);
							...
							unk_0x93F12E7D8D931858(0, unk_0xF0371FE6E2BF9599(iLocal_1058), 0);
							unk_0x1B16DD5C115FE009(uVar0);
							unk_0xAB30B1CF01A198C1(iLocal_1058, uVar0);
							unk_0xFAA3EF7FF92E1F9E(&uVar0);
							unk_0x31BBD48AA2503617(iLocal_1058, joaat("MotionState_Walk"), 0, 0, 0);
							iLocal_1191 = 2;
						}
					}
					break;
...
void func_418()
{
	if (unk_0x6ADD12BF4D6D2587(iLocal_1058))
	{
		unk_0x68433819717660CF(&iLocal_1058);
	}
}

int func_419(var uParam0, float fParam1)
{
	if (func_421(uParam0, fParam1))
	{
		func_420(uParam0);
		return 1;
	}
...
void func_422()
{
	if (unk_0x6ADD12BF4D6D2587(iLocal_1058))
	{
		if (unk_0xEBE499597C718EB8(iLocal_1058, unk_0xFC1458A37D98B502(), 1))
		{
			func_31(9);
		}
	}
...
void func_429()
{
	uLocal_1316[0] = unk_0xEA60F3B426BB095B(iLocal_1329, -1270.045f, -251.4953f, 41.4459f, 214.63f, 1, 1, 0);
	uLocal_1316[1] = unk_0xEA60F3B426BB095B(iLocal_1329, -1265.199f, -218.4823f, 45.9981f, 127.85f, 1, 1, 0);
}

void func_430()
{
	uLocal_1330 = unk_0x5AC38B4D80D4E352(26379945, -1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
	uLocal_1331 = unk_0x5AC38B4D80D4E352(26379945, -1243.588f, -251.4826f, 50.3187f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
}
...
int func_431()
{
	...
	iVar0 = 0;
	if (((((((((unk_0x9A0B2ED5055D3F0B(iLocal_1326) && unk_0x9A0B2ED5055D3F0B(iLocal_1329)) && unk_0x0840F461D7BD8859(102, "ASSOJva")) && unk_0x0840F461D7BD8859(107, "ASSOJva")) && unk_0xC316B5E3E7ACF515("OJASva_101")) && unk_0xC316B5E3E7ACF515("OJASva_101a")) && unk_0xC316B5E3E7ACF515("OJASva_104")) && unk_0x3A801AA34DD821BE("ODDJOBS@ASSASSINATE@GUARD")) && unk_0x3A801AA34DD821BE("oddjobs@assassinate@hotel@")) && unk_0x9F0887BCBFCF3C2F(3))
	{
		iVar0 = 1;
	}
	return iVar0;
...
void func_432()
{
	unk_0x6FF834D85E2DD4C6(iLocal_1326);
	unk_0x6FF834D85E2DD4C6(iLocal_1329);
...
void func_433(bool bParam0)
{
	if (bParam0)
	{
		unk_0x4C15495E88D71C61(Vector(39.1642f, -193.934f, -1237.397f) - Vector(150f, 150f, 150f), Vector(39.1642f, -193.934f, -1237.397f) + Vector(150f, 150f, 150f), 0, 1);
		unk_0xBF98CCF1EA4B13E9(-1349.176f, -39.0123f, -100.7554f, -1173.215f, -297.7677f, 100.8606f, 0, 1);
	}
	else
	{
		unk_0x4C15495E88D71C61(-1340.905f, -68.1138f, -100.7554f, -1176.622f, -287.8646f, 100.8606f, 1, 1);
...
void func_434()
{
	...
	unk_0x4DE114E3C7F8B7C2("Guards", &iLocal_1332);
	unk_0xF96119FCCD4D1889(1, joaat("COP"), iLocal_1332);
	unk_0xF96119FCCD4D1889(1, iLocal_1332, joaat("COP"));
	unk_0xF96119FCCD4D1889(5, iLocal_1332, joaat("player"));
	unk_0xF96119FCCD4D1889(5, joaat("player"), iLocal_1332);
	unk_0x247EAA2E93D4A021(-1220.57f, -185.96f, 38.4f, 200f, 1, 0, 0, 0);
	unk_0xBB0951717202666D(-1298.684f, -324.0442f, -35.578f, -1113.372f, -46.1583f, 55.609f);
	uLocal_1128 = unk_0xCB389937EDB1519A(Var0 - Vector(15f, 15f, 15f), Var0 + Vector(15f, 15f, 15f), 0, 1, 1, 1);
	uLocal_1129 = unk_0xCB389937EDB1519A(Var3 - Vector(45f, 35f, 35f), Var3 + Vector(45f, 35f, 35f), 0, 1, 1, 1);
}

void func_435()
{
	StringCopy(&Local_965, "ASS_VA_PASSED", 24);
	MemCopy(&(Local_965.f_6), {Global_55918}, 6);
...
void func_436()
{
	...
	while (iLocal_1192 <= 4)
	{
		uLocal_1227[iLocal_1192] = unk_0x5B811202FCBE9E9D(0f, 2f);
		iLocal_1192++;
	}
	fLocal_373 = 7000f;
	fLocal_374 = 2000f;
	...
	switch (iLocal_1193)
	{
		...
		case 1:
			if (!unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
			{
				...
				unk_0x247EAA2E93D4A021(-1507.715f, -941.1313f, 8.37286f, 10f, 1, 0, 0, 0);
				unk_0xBD8D47FDC6902B2D(unk_0xFC1458A37D98B502(), Local_1669, 1, 0, 0, 1);
				unk_0x48ED7B2293A96722(unk_0xFC1458A37D98B502(), fLocal_1672);
				...
				if (!unk_0x8EA3C8E091EA5BA4(uLocal_1673))
				{
					uLocal_1673 = unk_0x5AC38B4D80D4E352(26379945, Local_1675, Local_1678, 42.2032f, 1, 2);
					unk_0x7E4FCDC8BAD0CF6D(uLocal_1673, "HAND_SHAKE", 0.3f);
				}
				if (!unk_0x8EA3C8E091EA5BA4(uLocal_1674))
				{
					uLocal_1674 = unk_0x5AC38B4D80D4E352(26379945, Local_1681, Local_1684, 42.2032f, 0, 2);
					unk_0xF10DA1539629CC3F(uLocal_1674, uLocal_1673, 5000, 1, 1);
					unk_0x7E4FCDC8BAD0CF6D(uLocal_1673, "HAND_SHAKE", 0.3f);
				}
				unk_0x3458550DF8E9B453(1, 0, 3000, 1, 0, 0);
				if (func_40(0))
		...
		case 4:
			...
			unk_0x4982ECE0928DA13D(iLocal_1058, "Lester", 2, joaat("ig_lestercrest"), 0);
		...
		case 6:
			...
			if (!unk_0x6ADD12BF4D6D2587(iLocal_1058))
			{
				if (unk_0x9C7ACE0D4DCBE96F("Lester", 0))
				{
					...
					{
						iLocal_1058 = unk_0x07F64790D10D1DB5(unk_0xA78D8DA2425CB3DB("Lester", 0));
					}
				}
			}
			if (!unk_0x6ADD12BF4D6D2587(iLocal_1059))
			{
				if (unk_0x9C7ACE0D4DCBE96F("WalkingStick_Lester", 0))
				{
					if (unk_0x6ADD12BF4D6D2587(unk_0xA78D8DA2425CB3DB("WalkingStick_Lester", 0)))
					{
						iLocal_1059 = unk_0xA78D8DA2425CB3DB("WalkingStick_Lester", 0);
					}
				}
			}
			unk_0xBB9A3C553EECB180(0);
			...
			if (unk_0x6ADD12BF4D6D2587(unk_0xA78D8DA2425CB3DB("Lester", 0)))
			{
				...
				{
					if (unk_0x6ADD12BF4D6D2587(iLocal_1058) && !unk_0x3AB6A1A9084FB0A4(iLocal_1058))
					{
						unk_0xBD8D47FDC6902B2D(iLocal_1058, -1509.458f, -948.195f, 7.75f, 1, 0, 0, 1);
						unk_0x48ED7B2293A96722(iLocal_1058, -11f);
						unk_0x12C9D41D52A560D6(iLocal_1058, "oddjobs@assassinate@hotel@leadin", "lester_leadin", 1000f, -8f, -1, 790537, 0f, 0, 1, 0);
						unk_0x9A0C1F836B24E46E(iLocal_1058, 0, 0);
					}
				}
			}
			if (unk_0x6ADD12BF4D6D2587(unk_0xA78D8DA2425CB3DB("Lester", 0)))
			{
				if (unk_0xBBC745B9F75E27D0("WalkingStick_Lester", 0))
				{
					if (unk_0x6ADD12BF4D6D2587(iLocal_1058) && !unk_0x3AB6A1A9084FB0A4(iLocal_1058))
					{
						unk_0xA9D382E7BA095148(iLocal_1059, iLocal_1058, unk_0xDD09837E5235FE91(iLocal_1058, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					}
				}
			}
			if (unk_0x6F1392C5F51B32A4() && !unk_0xA8113D347D14630F())
			{
				...
				if (!unk_0x3AB6A1A9084FB0A4(iLocal_1058))
				{
					unk_0xD38F266C132F2897(iLocal_1058, 0, 0, 0, 0, 0, 0, 0, 0);
					unk_0x5718F894FDA63A9E(iLocal_1058, 1);
				}
				unk_0xBB9A3C553EECB180(0);
				unk_0x7C9705890EF6612E(0, 1065353216);
				if (unk_0x3E9CABD07B829173())
...
void func_439()
{
	if (!unk_0x6ADD12BF4D6D2587(iLocal_1690))
	{
		iLocal_1690 = unk_0xCBD07018689DF383(-1510.103f, -947.7194f, 8.2332f, 5f, joaat("prop_bench_08"), 1, 0, 1);
	}
}
				...
				if (unk_0x6ADD12BF4D6D2587(iVar0))
				{
					if (unk_0xB8DE76287EDC4957(iVar0, 0))
					{
						if ((iVar0 != iLocal_1320[0] && iVar0 != iLocal_1320[1]) && iVar0 != iLocal_1320[2])
						{
							...
							unk_0xDD29FF4BAB8AFF9C(iLocal_1320[iLocal_1216 + 1], 1, 0);
							unk_0x6F64D6648FF4F4EC(iLocal_1320[iLocal_1216 + 1], 0);
							iLocal_1216++;
						}
					}
				}
...
void func_443()
{
	if (bLocal_1140)
	{
		...
		else
		{
			...
			if (!iLocal_1138)
			{
				func_444(Local_1691.f_5[0], 0);
				func_444(Local_1691.f_5[1], 0);
			}
			else
			{
...
void func_446()
{
	...
	switch (iLocal_1206)
	{
		case 0:
			...
			{
				if (!unk_0x191BE1BC8F26F3C1(Local_1691[0], 0) && !unk_0x191BE1BC8F26F3C1(Local_1691[1], 0))
				{
					unk_0x60C06BFD037BB7CF(Local_1691[0], Local_1691[1], -1, 0, 2);
					unk_0x60C06BFD037BB7CF(Local_1691[1], Local_1691[0], -1, 0, 2);
				}
				if (((unk_0x6ADD12BF4D6D2587(Local_1691[1]) && unk_0x6ADD12BF4D6D2587(Local_1691.f_4)) && !unk_0x3AB6A1A9084FB0A4(Local_1691[1])) && unk_0xB8DE76287EDC4957(Local_1691.f_4, 0))
				{
					unk_0xB8E08BD5B184DF4E(Local_1691[1]);
					unk_0x6F8C8278B7C06889(Local_1691[1], Local_1691.f_4, 20000, 2, 1f, 1, 0);
				}
		...
		case 1:
			if (!iLocal_1174)
			{
				if (func_52(&uLocal_1348))
				{
					...
					{
						if (((unk_0x6ADD12BF4D6D2587(Local_1691[0]) && unk_0x6ADD12BF4D6D2587(Local_1691.f_4)) && !unk_0x3AB6A1A9084FB0A4(Local_1691[0])) && unk_0xB8DE76287EDC4957(Local_1691.f_4, 0))
						{
							if (unk_0x78F50AA8F955BEFC(Local_1691[0], -1794415470) != 1)
							{
								unk_0xB8E08BD5B184DF4E(Local_1691[0]);
								unk_0x6F8C8278B7C06889(Local_1691[0], Local_1691.f_4, 20000, 1, 1f, 1, 0);
								iLocal_1174 = 1;
							}
						}
					}
			...
			if (!unk_0x3AB6A1A9084FB0A4(Local_1691[0]) && !unk_0x3AB6A1A9084FB0A4(Local_1691[1]))
			{
				if (unk_0xA8D0477084E86A92(Local_1691[0], Local_1691.f_4, 0) && unk_0xA8D0477084E86A92(Local_1691[1], Local_1691.f_4, 0))
				{
					if (!unk_0x191BE1BC8F26F3C1(Local_1691.f_3, 0) && !unk_0x191BE1BC8F26F3C1(Local_1691.f_4, 0))
					{
						unk_0xCB3D88C918AA637C(Local_1691.f_3);
						func_50(&uLocal_1348);
					}
					iLocal_1206++;
				}
		...
		case 2:
			if (func_52(&uLocal_1348))
			{
				if (func_46(&uLocal_1348) > 3f)
				{
					if (!unk_0x3AB6A1A9084FB0A4(Local_1691.f_3) && unk_0xB8DE76287EDC4957(Local_1691.f_4, 0))
					{
						unk_0x84EF7D14703E1230(Local_1691.f_3, Local_1691.f_4, "OJAS_HotelTaxi01", 786485, 0, 16, -1, 10f, 0, 1073741824);
						iLocal_1206++;
					}
				}
			}
		...
		case 3:
			if (!unk_0x191BE1BC8F26F3C1(Local_1691.f_3, 0) && !unk_0x191BE1BC8F26F3C1(Local_1691.f_4, 0))
			{
				if (!unk_0xFF95C59FBC63673B(Local_1691.f_4) || iLocal_1177)
				{
					unk_0x96247F0EC873C446(Local_1691.f_3, Local_1691.f_4, 10f, 786603);
					iLocal_1206++;
				}
			}
			break;
		...
		case 4:
			if (iLocal_1177)
			{
				if (!unk_0x3AB6A1A9084FB0A4(uLocal_1054[0]))
				{
					iVar0 = uLocal_1054[0];
				}
				else
...
void func_447()
{
	if ((unk_0x6ADD12BF4D6D2587(Local_1691.f_3) && !unk_0x191BE1BC8F26F3C1(Local_1691.f_3, 0)) && !unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
	{
		unk_0xD68E88A8E0BE8697(Local_1691.f_3, unk_0xFC1458A37D98B502(), 1000f, -1, 0, 0);
	}
	if ((unk_0x6ADD12BF4D6D2587(Local_1691[0]) && !unk_0x191BE1BC8F26F3C1(Local_1691[0], 0)) && !unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
	{
		unk_0xD68E88A8E0BE8697(Local_1691[0], unk_0xFC1458A37D98B502(), 1000f, -1, 0, 0);
		unk_0xE17958D3FD0F9EE9(Local_1691[0], 2, 0);
	}
	if ((unk_0x6ADD12BF4D6D2587(Local_1691[1]) && !unk_0x191BE1BC8F26F3C1(Local_1691[1], 0)) && !unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
	{
		unk_0xD68E88A8E0BE8697(Local_1691[1], unk_0xFC1458A37D98B502(), 1000f, -1, 0, 0);
		unk_0xE17958D3FD0F9EE9(Local_1691[1], 2, 0);
	}
	if ((unk_0x6ADD12BF4D6D2587(Local_1691.f_8[0]) && !unk_0x191BE1BC8F26F3C1(Local_1691.f_8[0], 0)) && !unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
	{
		unk_0xD68E88A8E0BE8697(Local_1691.f_8[0], unk_0xFC1458A37D98B502(), 1000f, -1, 0, 0);
	}
	if ((unk_0x6ADD12BF4D6D2587(Local_1691.f_8[1]) && !unk_0x191BE1BC8F26F3C1(Local_1691.f_8[1], 0)) && !unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
	{
		unk_0xD68E88A8E0BE8697(Local_1691.f_8[1], unk_0xFC1458A37D98B502(), 1000f, -1, 0, 0);
	}
	if ((unk_0x6ADD12BF4D6D2587(Local_1691.f_5[0]) && !unk_0x191BE1BC8F26F3C1(Local_1691.f_5[0], 0)) && !unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
	{
		unk_0xD68E88A8E0BE8697(Local_1691.f_5[0], unk_0xFC1458A37D98B502(), 1000f, -1, 0, 0);
	}
	if ((unk_0x6ADD12BF4D6D2587(Local_1691.f_5[1]) && !unk_0x191BE1BC8F26F3C1(Local_1691.f_5[1], 0)) && !unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
	{
		unk_0xD68E88A8E0BE8697(Local_1691.f_5[1], unk_0xFC1458A37D98B502(), 1000f, -1, 0, 0);
	}
}

int func_448()
{
	if (!unk_0x191BE1BC8F26F3C1(Local_1691.f_3, 0))
	{
		if (unk_0x27C8A4034A05DC21(Local_1691.f_3))
		{
			if (unk_0x4EAE4CAB6D3C4502(Local_1691.f_3) == unk_0xFC1458A37D98B502())
			{
				return 1;
			}
		}
	}
	if (!unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0) && !unk_0x191BE1BC8F26F3C1(Local_1691.f_4, 0))
	{
		if (unk_0xA8D0477084E86A92(unk_0xFC1458A37D98B502(), Local_1691.f_4, 0))
		{
			return 1;
		}
	}
...
{
	return func_453(&(Global_98118.f_2875), Param0, fParam3, 0);
}
...
int func_479(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_481(iParam0, uVar1[iVar6], 1) && func_480(unk_0xB3328BA8976B416C(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_44(Param1, 0f, 0f, 0f, 0)) || unk_0xBE3C4023003180FC(unk_0xB3328BA8976B416C(iParam0, 1), unk_0xB3328BA8976B416C(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_480(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_485(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_489(unk_0x82FF3DFBC3965CC0(*uParam0), 1) && unk_0xF928889F6E5C7677(*uParam0, 24) != func_488(*uParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xA9EF3F93CBFFF6D0(*uParam0, 24, func_488(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_487(uParam0);
	if (func_486(*uParam0))
	{
...
void func_514()
{
	...
	unk_0xCA107A9AAF17E75F(uLocal_1128, 0);
	unk_0xCA107A9AAF17E75F(uLocal_1129, 0);
	func_506();
	func_86(&uLocal_1529, 0, 0);
	if (!unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0))
	{
	...
	unk_0xDF1ACFD53102CEB0(iLocal_1327, 0);
	unk_0xDF1ACFD53102CEB0(iLocal_1328, 0);
	func_515();
