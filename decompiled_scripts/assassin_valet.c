...
void __EntryFunction__()
{
	...
	uLocal_53 = unk_0x386A330DA3CBD6A0();
	uLocal_54 = unk_0xDEE2BB2717E7BE07();
	iLocal_267 = -1;
	fLocal_269 = 1f;
	iLocal_382 = 100;
	iLocal_383 = 3;
	...
	{
		unk_0xDD74AAB135833BB7("ASS1_FAIL");
		func_477(&(Global_97358.f_18217.f_1), 1024);
		func_475();
		func_470();
	}
	unk_0x6F468A6C94DC21AE(1);
	iLocal_1043 = unk_0x9F92518438215DD0();
	...
	unk_0xE821145469AA0ECD(iLocal_1325, 1);
	unk_0xE821145469AA0ECD(iLocal_1326, 1);
	...
	if (func_469())
	{
		...
		if (iLocal_1207 == 0)
		{
			if (iLocal_1151)
			{
				...
				if (((!unk_0x567194A60F82D51A(unk_0xB6A50C909A8FABC3(iVar0)) && !unk_0xDB519A4108C6BFB1(unk_0xB6A50C909A8FABC3(iVar0))) && !unk_0xAAF77E03CD60491E(unk_0xB6A50C909A8FABC3(iVar0))) && !unk_0x2A210BAD0D74322B(iVar0))
				{
		...
		else if (iLocal_1207 == 1)
		{
			if (iLocal_1151)
			{
				...
				if (((!unk_0x567194A60F82D51A(unk_0xB6A50C909A8FABC3(iVar1)) && !unk_0xDB519A4108C6BFB1(unk_0xB6A50C909A8FABC3(iVar1))) && !unk_0xAAF77E03CD60491E(unk_0xB6A50C909A8FABC3(iVar1))) && !unk_0x2A210BAD0D74322B(iVar1))
				{
		...
		else if (iLocal_1207 == 2)
		{
			if (iLocal_1151)
			{
				...
				if (((!unk_0x567194A60F82D51A(unk_0xB6A50C909A8FABC3(iVar2)) && !unk_0xDB519A4108C6BFB1(unk_0xB6A50C909A8FABC3(iVar2))) && !unk_0xAAF77E03CD60491E(unk_0xB6A50C909A8FABC3(iVar2))) && !unk_0x2A210BAD0D74322B(iVar2))
				{
					unk_0x77C765087051EDD6(iVar2);
				}
				else
				{
					unk_0xCD3EBB4EAE50293F(&iVar2);
				}
			}
	...
	while (true)
	{
		unk_0x2F626F4BEC43C4F6("M_ASS1", 0);
		if (iLocal_1141)
		{
			if (func_420())
			{
		...
		else if (!unk_0x3E0478C40AB5B38D(iLocal_1043))
		{
			func_412();
			if (iLocal_1029 < 10)
			{
			...
			if (((iLocal_1132 || bLocal_1137) && iLocal_1029 < 11) || (bLocal_1167 && iLocal_1029 < 11))
			{
				...
				else if (func_46(&uLocal_1352) > 2.5f)
				{
					if (!iLocal_1168)
					{
						...
						{
							if (!unk_0x3E0478C40AB5B38D(iLocal_1055))
							{
								unk_0x32D18ECD9E6F9BE2(iLocal_1055);
								if (iLocal_1042 == 1)
								{
									if (unk_0x746960881FB19A89(iLocal_1312))
									{
										if (!unk_0x827151D7B70CB853(iLocal_1055, 0))
										{
											unk_0x5F14A4E9A3FB84D9(iLocal_1055, iLocal_1312, iLocal_1312, 2f, 0, 0.5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
										}
									}
									if (unk_0x746960881FB19A89(iLocal_1055) && !unk_0x3E0478C40AB5B38D(iLocal_1055))
									{
								...
								{
									if (unk_0x746960881FB19A89(iLocal_1310) && unk_0xFC38B241541883D3(iLocal_1310, 0))
									{
										unk_0x5F14A4E9A3FB84D9(iLocal_1055, iLocal_1310, iLocal_1310, 2f, 0, 0.5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
									}
								...
								{
									unk_0xF58859AEB2D983FE(iLocal_1055, unk_0x9F92518438215DD0(), -1, 0);
									func_2(iLocal_1055);
								}
							}
						}
...
void func_1()
{
	...
	if (unk_0x827151D7B70CB853(iLocal_1043, 0))
	{
		iVar0 = unk_0x1161215F69587BDA(iLocal_1043, 0);
	...
	if (bLocal_1142)
	{
		if (unk_0x545772C7EE8EA363(iVar0, iLocal_1310))
		{
			unk_0xD8A4BDFD6188E21B(iVar0, iLocal_1310);
		}
	}
}
...
void func_2(int iParam0)
{
	...
	if (!iLocal_1178)
	{
		if ((unk_0x746960881FB19A89(iParam0) && !unk_0x3E0478C40AB5B38D(iParam0)) && func_23(iParam0, 1) < 50f)
		{
			if (!func_22())
			{
				if (iLocal_1042 == 4)
			...
			{
				Var0 = { func_5() };
				if (!unk_0x6B08EC9A88700FBB(&Var0, "OJAS_FEED"))
				{
					func_3();
				}
			}
...
{
	return func_24(unk_0x4E6043D225B9C75F(unk_0x2563F6EECD8726D3()), iParam0, iParam1);
}
...
int func_25(float fParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!unk_0x3E0478C40AB5B38D(uLocal_1048[iVar0]))
		{
	...
	while (iVar0 <= 1)
	{
		if (!unk_0x3E0478C40AB5B38D(uLocal_1052[iVar0]))
		{
...
int func_30(int iParam0, bool bParam1)
{
	...
	while (iVar0 <= 2)
	{
		if (!unk_0x3E0478C40AB5B38D(uLocal_1048[iVar0]))
		{
			if (bParam1 || (!bParam1 && !unk_0x827151D7B70CB853(uLocal_1048[iVar0], 0)))
			{
	...
	while (iVar0 <= 1)
	{
		if (!unk_0x3E0478C40AB5B38D(uLocal_1052[iVar0]))
		{
			if (bParam1 || (!bParam1 && !unk_0x827151D7B70CB853(uLocal_1052[iVar0], 0)))
			{
	...
	while (iVar0 <= 1)
	{
		if (!unk_0x3E0478C40AB5B38D(iLocal_1045[iVar0]))
		{
			if (bParam1 || (!bParam1 && !unk_0x827151D7B70CB853(uLocal_1052[iVar0], 0)))
			{
...
void func_32(int iParam0)
{
	...
	if (Global_97358.f_7341 || func_40(0))
	{
		iVar0 = func_39();
		if (!func_33(iVar0))
		{
...
int func_33(int iParam0)
{
	...
	func_34(&(Global_97358.f_1729.f_539), iVar1);
...
void func_34(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_36(Global_97358.f_16787[iVar0], &Var2, &fVar5))
			{
...
float func_46(var uParam0)
{
	if (func_52(uParam0))
	{
		...
		{
			return (func_47(unk_0x94E72F17611BCD3C(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_47(unk_0x94E72F17611BCD3C(*uParam0, 4)) - fParam1);
...
int func_54(int iParam0)
{
	...
	if (iLocal_1029 > 11)
	{
		if (!unk_0x3E0478C40AB5B38D(iLocal_1044))
		{
			if (unk_0xFC38B241541883D3(iLocal_1310, 0))
			{
				if (unk_0x44E080690DA76A2A(iLocal_1044, iLocal_1310, 0))
				{
					bVar1 = true;
				}
			}
		...
		if (unk_0x746960881FB19A89(iLocal_1044))
		{
			if (!unk_0x3E0478C40AB5B38D(iLocal_1044))
			{
				if (func_24(iLocal_1043, iLocal_1044, 1) >= fVar0)
				{
					if (bVar1)
					{
						if (unk_0xFC38B241541883D3(iLocal_1310, 0))
						{
							if (unk_0xC7FF9739199F83C9(iLocal_1310) || !unk_0x0FF9FE2CB115CFB9(iLocal_1310))
							{
								*iParam0 = 6;
								return 1;
							}
					...
					else if (unk_0xC7FF9739199F83C9(iLocal_1044))
					{
						*iParam0 = 6;
						return 1;
					}
				}
				else if (unk_0x2E6E8D325977B3EC(uLocal_1118))
				{
					if (func_24(iLocal_1043, iLocal_1044, 1) >= (fVar0 * 0.5f))
					{
						if (!unk_0xB6D75801CD1BCFBE(uLocal_1118))
						{
							unk_0xA0BFA3F6C43DF44B(uLocal_1118, 1);
						}
					}
					else if (unk_0xB6D75801CD1BCFBE(uLocal_1118))
					{
						unk_0xA0BFA3F6C43DF44B(uLocal_1118, 0);
					}
				}
			}
		}
...
void func_59(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_76(iParam1) && unk_0xB3CC729BBAA21637(iParam1))
	{
		iVar1 = 0;
...
{
	if (func_76(unk_0x9F92518438215DD0()))
	{
...
int func_64(char* sParam0)
{
	if (!func_65(1, 1, 0))
	{
		if ((!unk_0x9E9AFDBF482248F6(sParam0) && func_78(sParam0)) || func_78("CMN_HINT"))
		{
			unk_0x35611EEE7A1FFEDB(1);
		}
		return 0;
...
bool func_69()
{
	return func_70(unk_0xCFC72E446B0B3AD7());
}
...
int func_71(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_74(bParam1, bParam2, bParam3) || unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((unk_0x17103F66FBB44C3C() - uParam0->f_4) > 500)
			{
				...
				{
					if (unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 1) || func_72(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_80(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	if (!unk_0xEC2376DA57EC68E1("SCRIPT\ASSASSINATION_MULTI", 0))
	{
		bLocal_1361 = false;
	}
	else
	...
	if (iLocal_1211 < 30000)
	{
		...
		if (bLocal_1361)
		{
			if (func_52(&uLocal_1358))
			{
				...
				{
					unk_0x86F4B3D6FF8F65DE(-1, "ASSASSINATIONS_HOTEL_TIMER_COUNTDOWN", "ASSASSINATION_MULTI", 1);
					func_50(&uLocal_1358);
				}
			}
			else
...
void func_84()
{
	...
	switch (iLocal_1205)
	{
		case 0:
			if (!func_22())
			{
				if (!unk_0x0BA451447C3B1A8D(uLocal_1048[0]))
				{
					unk_0xD2062A6AC314B85E(uLocal_1048[0]);
				}
				if (!unk_0x0BA451447C3B1A8D(uLocal_1048[1]))
				{
					unk_0xD2062A6AC314B85E(uLocal_1048[1]);
				}
				iVar0 = func_88();
				if (bLocal_1155)
				{
				...
				else if (!bLocal_1162 && unk_0x3E0478C40AB5B38D(iLocal_1044))
				{
					if (!iLocal_1171)
					{
						func_28(iVar0, 3, "OJAvaGUARD");
		...
		case 2:
			if (iLocal_1171 || !unk_0x3E0478C40AB5B38D(iLocal_1044))
			{
				if (!func_22() && !bLocal_1155)
				{
					...
					else if (!bLocal_1179 && unk_0x3E0478C40AB5B38D(iLocal_1044))
					{
						iVar0 = func_88();
						func_87(iVar0);
					}
			...
			if (func_52(&uLocal_1337))
			{
				if ((func_46(&uLocal_1337) > fLocal_1242 && func_85()) || unk_0x4A4902C6AC8DCB7E(unk_0x9F92518438215DD0()))
				{
					func_3();
					if (!iLocal_1132)
					{
...
int func_85()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0x746960881FB19A89(uLocal_1048[iVar0]) && !unk_0x0BA451447C3B1A8D(uLocal_1048[iVar0]))
		{
			unk_0xE69F90D298F4217D(uLocal_1048[iVar0], 85, 1);
			if (unk_0x6EC085250818253D(uLocal_1048[iVar0], unk_0x9F92518438215DD0()))
			{
				return 1;
			}
		}
	...
	while (iVar0 < 2)
	{
		if (unk_0x746960881FB19A89(uLocal_1052[iVar0]) && !unk_0x0BA451447C3B1A8D(uLocal_1052[iVar0]))
		{
			unk_0xE69F90D298F4217D(uLocal_1052[iVar0], 85, 1);
			if (unk_0x6EC085250818253D(uLocal_1052[iVar0], unk_0x9F92518438215DD0()))
			{
				return 1;
			}
		}
	...
	while (iVar0 < 2)
	{
		if (unk_0x746960881FB19A89(iLocal_1045[iVar0]) && !unk_0x0BA451447C3B1A8D(iLocal_1045[iVar0]))
		{
			unk_0xE69F90D298F4217D(iLocal_1045[iVar0], 85, 1);
			if (unk_0x6EC085250818253D(iLocal_1045[iVar0], unk_0x9F92518438215DD0()))
			{
				return 1;
			}
		}
...
int func_86(int iParam0)
{
	if (unk_0x746960881FB19A89(iParam0))
	{
		if (!unk_0xFE0FA79BC49EBB07(iParam0, -1252.302f, -213.9033f, 35.11222f, -1205.808f, -183.0681f, 45.32541f, 51f, 0, 1, 0) && !unk_0xFE0FA79BC49EBB07(iParam0, -1250.809f, -192.5218f, 35.33125f, -1231.866f, -161.3655f, 45.02535f, 12.8f, 0, 1, 0))
		{
			return 1;
		}
	}
...
void func_87(int iParam0)
{
	if (!bLocal_1179)
	{
		if (unk_0x746960881FB19A89(iLocal_1044) && unk_0x3E0478C40AB5B38D(iLocal_1044))
		{
			if (!func_22())
			{
				if ((unk_0x746960881FB19A89(iParam0) && !unk_0x3E0478C40AB5B38D(iParam0)) && func_23(iParam0, 1) < 75f)
				{
					func_28(iParam0, 3, "OJAvaGUARD");
...
int func_88()
{
	...
	while (iVar1 < 3)
	{
		if (unk_0x746960881FB19A89(uLocal_1048[iVar1]) && !unk_0x3E0478C40AB5B38D(uLocal_1048[iVar1]))
		{
	...
	if (iVar0 == 0)
	{
		...
		while (iVar1 < 2)
		{
			if (unk_0x746960881FB19A89(uLocal_1052[iVar1]) && !unk_0x3E0478C40AB5B38D(uLocal_1052[iVar1]))
			{
	...
	if (iVar0 == 0)
	{
		...
		while (iVar1 < 2)
		{
			if (unk_0x746960881FB19A89(iLocal_1045[iVar1]) && !unk_0x3E0478C40AB5B38D(iLocal_1045[iVar1]))
			{
...
int func_90(int iParam0)
{
	...
	if (!iLocal_1132)
	{
		...
		if (unk_0x860AFAABAECF6379(iLocal_1043, 4))
		{
			if (unk_0x4A4902C6AC8DCB7E(iLocal_1043))
			{
				fVar1 = func_26(unk_0x9F92518438215DD0(), -1230.599f, -196.5408f, 38.1528f, 1);
				unk_0x9DA0F3A686A566A6(iLocal_1043, &iVar2, 1);
		...
		if ((func_94(iLocal_1310) || func_93(iLocal_1310)) || (unk_0x746960881FB19A89(iLocal_1310) && unk_0xE99AF5B1B3F0BB7C(iLocal_1310, iLocal_1043, 1)))
		{
			return 1;
		}
		if (func_94(iLocal_1311) || (unk_0x746960881FB19A89(iLocal_1311) && unk_0xE99AF5B1B3F0BB7C(iLocal_1311, iLocal_1043, 1)))
		{
			return 1;
		}
		if (unk_0x746960881FB19A89(iLocal_1310) && !unk_0x0BA451447C3B1A8D(iLocal_1310))
		{
			if (unk_0x44E080690DA76A2A(iLocal_1043, iLocal_1310, 0))
			{
				unk_0x5B6033B32F1B0E5D(iLocal_1310, 1);
				unk_0x34DD67F320C88D51(iLocal_1310);
				return 1;
			}
		}
		if (unk_0x746960881FB19A89(iLocal_1310))
		{
			if (unk_0xFC38B241541883D3(iLocal_1310, 0))
			{
				...
				{
					iVar0 = unk_0x1161215F69587BDA(iLocal_1043, 0);
					if (unk_0x30281E710B12FB9F(iVar0, iLocal_1310) || (bLocal_1142 && unk_0x545772C7EE8EA363(iVar0, iLocal_1310)))
					{
						*iParam0 = 4;
						return 1;
					}
		...
		if (iLocal_1029 < 11)
		{
			if (unk_0x24E7720869956FA9(-1, Local_1306, fLocal_1309))
			{
				return 1;
			}
		}
		else if (unk_0x24E7720869956FA9(-1, Local_1306, fLocal_1309))
		{
			if (func_91())
			{
				iLocal_1186 = 1;
...
int func_91()
{
	if (unk_0xFE0FA79BC49EBB07(unk_0x9F92518438215DD0(), -1272.181f, -241.2545f, 62.90406f, -1300.203f, -201.3968f, 40.40408f, 44.5f, 0, 0, 0) || unk_0xFE0FA79BC49EBB07(unk_0x9F92518438215DD0(), -1270.125f, -253.9321f, 62.90407f, -1311.414f, -193.6588f, 38.23291f, 44.5f, 0, 0, 0))
	{
		return 1;
	}
	return 0;
...
int func_93(int iParam0)
{
	if (unk_0x746960881FB19A89(iParam0))
	{
		...
		{
			if (unk_0x433D30FBB06F5E87(iParam0) == 3 && unk_0xBD0F8DEB580D2E67(iLocal_1043) == iParam0)
			{
				return 1;
			}
		}
		...
		if (unk_0xFC38B241541883D3(iParam0, 0))
		{
			if (unk_0xB5BBEB12C77EE430(iParam0, -1) != 0)
			{
				if (unk_0x9DA0F3A686A566A6(unk_0x9F92518438215DD0(), &iVar0, 1))
				{
					if (iVar0 == joaat("weapon_stickybomb"))
					{
						if (func_24(unk_0x9F92518438215DD0(), iParam0, 1) < 40f)
						{
...
int func_95(int iParam0)
{
	if (unk_0xFC38B241541883D3(iLocal_1310, 0))
	{
		if (unk_0xD8E4C099E8375B67(unk_0x9F92518438215DD0(), iLocal_1310, joaat("weapon_stickybomb"), -1))
		{
			if (unk_0x7B84A37860AE5A7C(-1223.024f, -187.3076f, 39.02538f, -1220.311f, -186.2481f, 40.42538f, 6.5f, joaat("weapon_stickybomb"), 0) || unk_0x7B84A37860AE5A7C(-1223.024f, -187.3076f, 38.02538f, -1220.311f, -186.2481f, 40.42538f, 4.5f, joaat("weapon_stickybomb"), 0))
			{
				*iParam0 = 8;
				return 1;
			}
...
void func_96()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0x746960881FB19A89(uLocal_1048[iVar0]))
		{
	...
	while (iVar0 < 2)
	{
		if (unk_0x746960881FB19A89(uLocal_1052[iVar0]))
		{
			if (iLocal_1132 && !bLocal_1165)
			{
	...
	while (iVar0 < 2)
	{
		if (unk_0x746960881FB19A89(iLocal_1045[iVar0]))
		{
			if (iLocal_1132 && !bLocal_1165)
			{
			...
			if (!unk_0x3E0478C40AB5B38D(iLocal_1045[iVar0]))
			{
				...
				{
					unk_0xE69F90D298F4217D(iLocal_1045[iVar0], 128, 1);
				}
			}
		}
		iVar0++;
	...
	if (iLocal_1132)
	{
		if (!unk_0x0BA451447C3B1A8D(iLocal_1044))
		{
			unk_0xE69F90D298F4217D(iLocal_1044, 120, 1);
		}
	}
}
...
void func_97(int iParam0)
{
	...
	switch (iLocal_1035[iParam0])
	{
		...
		case 1:
			if (unk_0xFC38B241541883D3(iLocal_1311, 0))
			{
				if (func_121())
				{
					if (!unk_0xA9F3D2C5FC57B2A8(iLocal_1311))
					{
						if (unk_0xB5BBEB12C77EE430(iLocal_1311, -1) == uLocal_1052[iParam0])
						{
							unk_0x788DEE284D8ADED5(uLocal_1052[iParam0], iLocal_1311, "OJASva_104", 948, 0, 16, 18, 6f, 0, 1073741824);
						}
					}
		...
		case 2:
			if (unk_0xFC38B241541883D3(iLocal_1311, 0))
			{
				if (!unk_0xA9F3D2C5FC57B2A8(iLocal_1311))
				{
					Var1 = { unk_0x77009B1C011405A9(iLocal_1311, 1) };
					uVar4 = unk_0xE691E4EA6B4440C6(iLocal_1311);
					iLocal_1145 = 0;
		...
		case 3:
			if (unk_0xFC38B241541883D3(iLocal_1311, 0))
			{
				if (!unk_0x0BA451447C3B1A8D(uLocal_1052[iParam0]))
				{
					if (unk_0x44E080690DA76A2A(uLocal_1052[iParam0], iLocal_1311, 0) && unk_0xFC38B241541883D3(iLocal_1310, 0))
					{
						if (!iLocal_1132)
						{
							if (unk_0xB5BBEB12C77EE430(iLocal_1311, -1) == uLocal_1052[iParam0])
							{
								if (unk_0xE962BD784DD0E442(uLocal_1052[iParam0], -1273030092) != 1)
								{
									unk_0xC6C4308CDA4C206C(uLocal_1052[iParam0], iLocal_1311, iLocal_1310, -1, 45f, 786981, 10f, -1, 10f);
								}
							}
						}
						else if (unk_0xB5BBEB12C77EE430(iLocal_1311, -1) == uLocal_1052[iParam0])
						{
							if (!iLocal_1146)
							{
								if (unk_0x0BA451447C3B1A8D(iLocal_1044))
								{
									if (unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0))
									{
										unk_0xF78316EFCA911012(iVar0, unk_0x9F92518438215DD0(), 0, 16);
									}
									else
									{
								...
								{
									unk_0xC6C4308CDA4C206C(uLocal_1052[iParam0], iLocal_1311, iLocal_1310, -1, 45f, 786981, 10f, -1, 10f);
									unk_0x27B9D4AB2873E651(iVar0, unk_0x9F92518438215DD0());
									iLocal_1146 = 1;
								}
							}
						}
						...
						{
							if (unk_0xE962BD784DD0E442(uLocal_1052[iParam0], 780511057) != 1)
							{
								if (!unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0))
								{
									if (unk_0x9EF11DECA38804B6(iLocal_1311) < 5f)
									{
										iLocal_1035[iParam0] = 8;
									}
								}
						...
						else if (unk_0xE962BD784DD0E442(uLocal_1052[iParam0], 780511057) != 1)
						{
							unk_0xF78316EFCA911012(iVar0, unk_0x9F92518438215DD0(), 0, 16);
						}
					}
		...
		case 5:
			if (!func_86(iLocal_1043))
			{
				if (func_46(&uLocal_1331) >= 27f || unk_0x99A27D5F9B887E5F(unk_0xCFC72E446B0B3AD7(), 0))
				{
					if (!unk_0x3E0478C40AB5B38D(iVar0))
					{
						if (unk_0x5093D6F9140AD109(iLocal_1043, iVar0, 5f, 5f, 3f, 0, 1, 0))
						{
		...
		case 6:
			if (bLocal_1157)
			{
				unk_0xF87DA7F5BA8C7D0F(&uLocal_1322);
				unk_0xF811299AF81DB581(0, 0, 0);
				unk_0x284B09A617F0967C(0, func_115(), unk_0x073B65E051D2F03E(1000, 1500), 2048, 4);
				unk_0x284B09A617F0967C(0, func_115(), unk_0x073B65E051D2F03E(2000, 2500), 2048, 4);
				unk_0x92641D4778270335(0, unk_0x9F92518438215DD0(), unk_0x073B65E051D2F03E(10000, 11000), 30f, 1f, 1073741824, 0);
				unk_0xFD691F9CDF9FE857(0, unk_0x9F92518438215DD0(), func_115(), 1f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				unk_0x3179CCC77CBAB31F(uLocal_1322);
				if (!unk_0x3E0478C40AB5B38D(uLocal_1052[iParam0]))
				{
					unk_0xC7EBE3C9AC83FAAA(uLocal_1052[iParam0], uLocal_1322);
				}
				unk_0xCD02E3C29B8253A6(&uLocal_1322);
			}
			else
			{
				unk_0xF87DA7F5BA8C7D0F(&uLocal_1322);
				unk_0xF811299AF81DB581(0, 0, 0);
				unk_0x1E0FCE815D17DDA5(0, func_115(), unk_0x073B65E051D2F03E(3000, 3500), 1, 0);
				unk_0x1E0FCE815D17DDA5(0, func_115(), unk_0x073B65E051D2F03E(3000, 3500), 0, 0);
				unk_0x1E0FCE815D17DDA5(0, func_115(), unk_0x073B65E051D2F03E(3000, 3500), 0, 0);
				unk_0x1E0FCE815D17DDA5(0, func_115(), unk_0x073B65E051D2F03E(3000, 3500), 0, 0);
				unk_0x1E0FCE815D17DDA5(0, func_115(), -1, 0, 0);
				unk_0x3179CCC77CBAB31F(uLocal_1322);
				if (!unk_0x3E0478C40AB5B38D(uLocal_1052[iParam0]))
				{
					unk_0xC7EBE3C9AC83FAAA(uLocal_1052[iParam0], uLocal_1322);
		...
		case 7:
			if (!unk_0x3E0478C40AB5B38D(uLocal_1052[iParam0]))
			{
				if (unk_0xE962BD784DD0E442(uLocal_1052[iParam0], 1435919172) != 1)
				{
					unk_0x5F14A4E9A3FB84D9(uLocal_1052[iParam0], iLocal_1043, iLocal_1043, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				}
			}
			break;
	...
	if (!iLocal_1132)
	{
		...
		else if (func_105(iVar0, iLocal_1311, &Local_359, &iLocal_370, 0, 0, 0, 1, 1) || func_104(iLocal_1311))
		{
			...
			if (iVar5 != 0)
			{
				func_103(unk_0x77009B1C011405A9(iVar5, 1), 1097859072, 1116471296);
			}
			if (!func_102())
			{
				iLocal_1132 = 1;
	...
	else if (!unk_0x3E0478C40AB5B38D(iVar0))
	{
		if (unk_0x44E080690DA76A2A(iVar0, iLocal_1311, 0))
		{
			if (((!unk_0xFC38B241541883D3(iLocal_1311, 0) || !unk_0xFC38B241541883D3(iLocal_1310, 0)) || iLocal_1144) || !bLocal_1135)
			{
...
int func_101(int iParam0, float fParam1)
{
	if (!iLocal_1132)
	{
		if (!func_86(iLocal_1043))
		{
			if (unk_0x746960881FB19A89(iParam0))
			{
				if (!unk_0x3E0478C40AB5B38D(iParam0))
				{
					...
					{
						if (unk_0x53C8F92CF78772BF(iParam0, iLocal_1043, 120f))
						{
							if (unk_0xF160EF76D53E7ADB(iParam0, iLocal_1043, 17))
							{
								if (!unk_0xFE0FA79BC49EBB07(unk_0x9F92518438215DD0(), -1251.791f, -147.043f, 42.679f, -1197.245f, -212.232f, 50.679f, 35f, 1, 1, 0) && !unk_0xFE0FA79BC49EBB07(unk_0x9F92518438215DD0(), -1259.282f, -204.172f, -60.654f, -1304.335f, -235.719f, 60.654f, 85f, 1, 1, 0))
								{
									return 1;
								}
							}
		...
		else if (unk_0x746960881FB19A89(iParam0))
		{
			if (!unk_0x3E0478C40AB5B38D(iParam0))
			{
				if (unk_0x5093D6F9140AD109(iLocal_1043, iParam0, 5f, 5f, 1f, 0, 1, 0))
				{
					if (unk_0x53C8F92CF78772BF(iParam0, iLocal_1043, 120f))
					{
						if (unk_0xF160EF76D53E7ADB(iParam0, iLocal_1043, 17))
...
void func_103(struct<3> Param0, float fParam3, float fParam4)
{
	...
	if (unk_0x0BA451447C3B1A8D(iLocal_1310) || iLocal_1186)
	{
		bLocal_1155 = true;
	}
	if (unk_0x746960881FB19A89(iLocal_1044))
	{
		if (((unk_0x524CA7E8DE1D7035(iLocal_1044, joaat("weapon_sniperrifle"), 0) || unk_0x524CA7E8DE1D7035(iLocal_1044, joaat("weapon_heavysniper"), 0)) || unk_0x524CA7E8DE1D7035(iLocal_1044, joaat("weapon_remotesniper"), 0)) || unk_0x524CA7E8DE1D7035(iLocal_1044, joaat("weapon_marksmanrifle"), 0))
		{
			iLocal_1154 = 1;
			iLocal_1030 = 1;
		}
	...
	{
		if (!unk_0xA9F3D2C5FC57B2A8(iLocal_1310))
		{
			fParam3 = (fParam3 * 2f);
			iVar0 = 1;
		}
	...
	if (!iLocal_1132)
	{
		...
		{
			fVar1 = func_26(unk_0x9F92518438215DD0(), Param0, 1);
			if (fVar1 > fParam3)
			{
				iLocal_1156 = 1;
				if (fVar1 > fParam4)
			...
			if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
			{
				if (unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0))
				{
					...
					if (unk_0x746960881FB19A89(iVar0) && unk_0xFC38B241541883D3(iVar0, 0))
					{
						...
						if (fVar1 > 7f)
						{
							if (unk_0x30281E710B12FB9F(iVar0, iParam0) || unk_0xE99AF5B1B3F0BB7C(iVar0, iParam0, 1))
							{
								return 1;
							}
						}
...
int func_106(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (!bLocal_355)
		{
			iLocal_356 = unk_0xFD181DDA4D8D6786(iParam0);
			bLocal_355 = true;
		}
		iLocal_357 = unk_0xFD181DDA4D8D6786(iParam0);
	...
	if (func_107(unk_0x9F92518438215DD0(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (unk_0xBD280C076BC69C97(iParam0) && func_23(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_109(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (unk_0x860AFAABAECF6379(iParam0, 2))
	{
		...
		else
		{
			...
			if (unk_0x5EE181A2C8679F09(iParam0) || func_94(iVar3))
			{
				if (unk_0x41EEB10CCC2497A8(iParam1, unk_0x77009B1C011405A9(iParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (unk_0x53C8F92CF78772BF(unk_0x240654B57CFFBFB3(iParam1), iParam0, 120f) && unk_0xF160EF76D53E7ADB(iParam1, iParam0, 17))
	...
	if (!unk_0x3E0478C40AB5B38D(iParam1))
	{
		if (unk_0xFC38B241541883D3(iParam0, 0))
		{
			if (unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0))
			{
				...
				{
					if (!unk_0x44E080690DA76A2A(iParam1, iParam0, 0))
					{
						if (unk_0xE962BD784DD0E442(iParam1, -1794415470) != 1)
						{
							unk_0x4073360CA020BB84(iParam1, iParam0, 20000, -1, 2f, 1, 0);
						}
					}
					else if (unk_0xE962BD784DD0E442(iParam1, -1273030092) != 1)
					{
						unk_0xBBB86C3DA83A56F3(iParam1, iParam0, unk_0x1161215F69587BDA(unk_0x9F92518438215DD0(), 0), 6, 35f, 786469, -1f, -1f, 1);
						unk_0x27B9D4AB2873E651(iParam1, unk_0x9F92518438215DD0());
					}
				}
				else if (!unk_0x44E080690DA76A2A(iParam1, iParam0, 0))
				{
					if (unk_0xE962BD784DD0E442(iParam1, 780511057) != 1)
					{
						unk_0xF78316EFCA911012(iParam1, unk_0x9F92518438215DD0(), 0, 16);
					}
				}
			}
			else if (unk_0x44E080690DA76A2A(iParam1, iParam0, 0))
			{
				...
				{
					if (unk_0xE962BD784DD0E442(iParam1, -1273030092) != 1)
					{
						unk_0x7FC0EEAECC1615C3(iParam1, iParam0, unk_0x9F92518438215DD0(), 6, 35f, 786469, -1f, -1f, 1);
						unk_0x27B9D4AB2873E651(iParam1, unk_0x9F92518438215DD0());
					}
				}
				else if (unk_0xE962BD784DD0E442(iParam1, 780511057) != 1)
				{
					unk_0xF78316EFCA911012(iParam1, unk_0x9F92518438215DD0(), 0, 16);
				}
			}
...
void func_113(int iParam0)
{
	...
	if (!unk_0x3E0478C40AB5B38D(iLocal_1043) && !unk_0x3E0478C40AB5B38D(iParam0))
	{
		if (!unk_0x0BA451447C3B1A8D(iParam0))
		{
		...
		unk_0xF58859AEB2D983FE(0, iLocal_1043, -1, 0);
...
{
	if (!unk_0x0BA451447C3B1A8D(iLocal_1043))
	{
		if (!unk_0x827151D7B70CB853(iLocal_1043, 0))
		{
			if (!unk_0x0BA451447C3B1A8D(iParam0))
			...
			unk_0xF87DA7F5BA8C7D0F(&uLocal_1322);
			unk_0xF811299AF81DB581(0, 0, 256);
			unk_0xF78316EFCA911012(0, iLocal_1043, 0, 16);
			unk_0x3179CCC77CBAB31F(uLocal_1322);
			if (!unk_0x0BA451447C3B1A8D(iParam0))
			{
				unk_0xC7EBE3C9AC83FAAA(iParam0, uLocal_1322);
			}
			unk_0xCD02E3C29B8253A6(&uLocal_1322);
		}
		else if (!unk_0x3E0478C40AB5B38D(iParam0))
		{
			if (unk_0xE962BD784DD0E442(iParam0, 780511057) != 1)
			{
				unk_0x32D18ECD9E6F9BE2(iParam0);
				unk_0xF78316EFCA911012(iParam0, iLocal_1043, 0, 16);
			}
		}
	}
}
...
Vector3 func_115()
{
	...
	iVar3 = (unk_0x073B65E051D2F03E(0, 65535) % 3);
	switch (iVar3)
	{
		case 0:
...
void func_116(int iParam0, struct<3> Param1)
{
	if (!iLocal_1132)
	{
		if (!unk_0x3E0478C40AB5B38D(iParam0))
		{
			if (unk_0x5093D6F9140AD109(iLocal_1043, iParam0, Param1, 0, 1, 0))
			{
				if (unk_0x53C8F92CF78772BF(iParam0, iLocal_1043, 160f))
				{
					if (unk_0xF160EF76D53E7ADB(iParam0, iLocal_1043, 17))
					{
						unk_0x5F14A4E9A3FB84D9(iParam0, iLocal_1043, iLocal_1043, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
						iLocal_1042 = 5;
						iLocal_1132 = 1;
					}
				}
			...
			{
				if (unk_0xE962BD784DD0E442(iParam0, -1207174364) != 1)
				{
					unk_0x5F14A4E9A3FB84D9(iParam0, iLocal_1043, iLocal_1043, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				}
			}
		...
		if (!unk_0x827151D7B70CB853(*iParam0, 0))
		{
			if (!iLocal_1134)
			{
				if (*iParam0 == iLocal_1055)
				{
					unk_0xCD02E3C29B8253A6(&uVar0);
					unk_0xF87DA7F5BA8C7D0F(&uVar0);
					unk_0x92641D4778270335(0, iLocal_1043, 20000, 2f, 1f, 1073741824, 0);
					unk_0x23F243BF5B07DA90(0, iLocal_1043, -1);
					unk_0x3179CCC77CBAB31F(uVar0);
					unk_0xC7EBE3C9AC83FAAA(*iParam0, uVar0);
					unk_0xCD02E3C29B8253A6(&uVar0);
					iLocal_1134 = 1;
				...
				else if (unk_0xE962BD784DD0E442(*iParam0, 1227113341) != 1)
				{
					unk_0x23F243BF5B07DA90(*iParam0, iLocal_1043, -1);
				}
			}
			else if (*iParam0 != iLocal_1055)
			{
				if (unk_0xE962BD784DD0E442(*iParam0, 1227113341) != 1)
				{
					unk_0x23F243BF5B07DA90(*iParam0, iLocal_1043, -1);
				}
			}
...
int func_119()
{
	...
	if (!unk_0x3E0478C40AB5B38D(unk_0x9F92518438215DD0()))
	{
		...
		if (!unk_0x0BA451447C3B1A8D(iLocal_1310))
		{
			Var3 = { unk_0x77009B1C011405A9(iLocal_1310, 1) };
		}
...
void func_120(int iParam0)
{
	...
	if (!unk_0x0BA451447C3B1A8D(uLocal_1052[iParam0]))
	{
		if (unk_0xFC38B241541883D3(iLocal_1311, 0))
		{
			if (!unk_0x44E080690DA76A2A(uLocal_1052[iParam0], iLocal_1311, 0))
			{
				if (unk_0xE962BD784DD0E442(uLocal_1052[iParam0], -1794415470) != 1)
				{
					unk_0x4073360CA020BB84(uLocal_1052[iParam0], iLocal_1311, 20000, iVar0, 2f, 1, 0);
				}
			}
		}
	}
...
int func_121()
{
	if (!unk_0x3E0478C40AB5B38D(uLocal_1052[0]) && !unk_0x3E0478C40AB5B38D(uLocal_1052[1]))
	{
		if (unk_0x44E080690DA76A2A(uLocal_1052[0], iLocal_1311, 0) && unk_0x44E080690DA76A2A(uLocal_1052[1], iLocal_1311, 0))
		{
			return 1;
		}
	}
...
void func_122(struct<3> Param0, struct<3> Param3, float fParam6)
{
	if (!iLocal_1132)
	{
		if (unk_0x7B84A37860AE5A7C(Param0, Param3, fParam6, joaat("weapon_stickybomb"), 0))
		{
			iLocal_1132 = 1;
		}
	}
...
void func_123(int iParam0)
{
	...
	switch (iLocal_1031[iParam0])
	{
		case 0:
			if (!unk_0x3E0478C40AB5B38D(iVar0))
			{
				unk_0xCD02E3C29B8253A6(&uLocal_1322);
				unk_0xF87DA7F5BA8C7D0F(&uLocal_1322);
				unk_0x11C32E558C0429ED(0, Local_1266[iParam0 /*3*/], 1f, 0, 0, 786603, -1082130432);
				unk_0x70A8B8D6374F080F(0, fLocal_1219[iParam0], 0);
				unk_0x3179CCC77CBAB31F(uLocal_1322);
				unk_0xC7EBE3C9AC83FAAA(iVar0, uLocal_1322);
				unk_0xCD02E3C29B8253A6(&uLocal_1322);
		...
		case 1:
			if (unk_0x746960881FB19A89(iVar0))
			{
				if (!unk_0x0BA451447C3B1A8D(iVar0))
				{
					if (!bLocal_1167)
					{
						if (unk_0xE962BD784DD0E442(iVar0, -2017877118) != 1 && unk_0xE962BD784DD0E442(iVar0, 242628503) != 1)
						{
							if (unk_0x41EEB10CCC2497A8(iVar0, Local_1266[iParam0 /*3*/], 3f, 3f, 3f, 0, 1, 0))
							{
		...
		case 3:
			...
			else if (func_46(&uLocal_1331) > uLocal_1225[iParam0] || unk_0x99A27D5F9B887E5F(unk_0xCFC72E446B0B3AD7(), 0))
			{
				func_117(&iVar0);
				iLocal_1031[iParam0] = 2;
			}
		...
		case 4:
			if (!unk_0x3E0478C40AB5B38D(iVar0))
			{
				unk_0x0CFE85F88BE373C8(iVar0, 1);
				unk_0xE69F90D298F4217D(iVar0, 60, 1);
			}
			if (unk_0xFC38B241541883D3(iLocal_1310, 0))
			{
				if (!unk_0x3E0478C40AB5B38D(iVar0))
				{
					if (iParam0 == 0)
					{
						unk_0x402A96371F34E6D8(uLocal_1048[0], uLocal_1048[1], -1, 0, 2);
						if (!unk_0x44E080690DA76A2A(iVar0, iLocal_1310, 0))
						{
							unk_0x4073360CA020BB84(iVar0, iLocal_1310, 30000, -1, 1f, 1, 0);
						}
					}
					else if (iParam0 == 1)
					{
						unk_0x402A96371F34E6D8(uLocal_1048[1], uLocal_1048[0], -1, 0, 2);
						if (!unk_0x44E080690DA76A2A(iVar0, iLocal_1310, 0))
						{
							unk_0x4073360CA020BB84(iVar0, iLocal_1310, 30000, 0, 1f, 1, 0);
						}
					}
					else if (iParam0 == 2)
					{
						if (unk_0xFC38B241541883D3(iLocal_1311, 0))
						{
							if (!unk_0x44E080690DA76A2A(iVar0, iLocal_1311, 0))
							{
								unk_0x4073360CA020BB84(iVar0, iLocal_1311, 30000, 1, 1f, 1, 0);
							}
						}
					}
				}
		...
		case 5:
			...
			if (!unk_0x0BA451447C3B1A8D(iVar0))
			{
				if (unk_0xE962BD784DD0E442(iVar0, 150319005) != 1)
				{
					if (iParam0 == 0)
					{
						unk_0x402A96371F34E6D8(uLocal_1048[iParam0], uLocal_1048[1], -1, 2048, 4);
					}
					else if (iParam0 == 1)
					{
						unk_0x402A96371F34E6D8(uLocal_1048[iParam0], uLocal_1048[0], -1, 2048, 4);
					}
				}
			}
			if (unk_0xFC38B241541883D3(iLocal_1310, 0))
			{
				if (!func_127())
				{
					if (iLocal_1132)
					{
						if (!unk_0x3E0478C40AB5B38D(iVar0))
						{
							if (unk_0xE962BD784DD0E442(iVar0, 780511057) != 1)
							{
								...
								unk_0xF78316EFCA911012(iVar0, iLocal_1043, 0, 16);
							}
						}
					}
				}
		...
		case 6:
			if (!iLocal_1132)
			{
				if (unk_0xFC38B241541883D3(iLocal_1310, 0))
				{
					if (unk_0xB5BBEB12C77EE430(iLocal_1310, -1) == iVar0)
					{
						if (!unk_0x3E0478C40AB5B38D(iVar0))
						{
							...
							if (func_125())
							{
								unk_0x788DEE284D8ADED5(iVar0, iLocal_1310, "OJASva_101a", 181, 0, 16, -1, 10f, 0, 1073741824);
							}
							else
							{
								unk_0x788DEE284D8ADED5(iVar0, iLocal_1310, "OJASva_101", 181, 0, 0, -1, -1f, 0, 1073741824);
							}
						}
					}
		...
		case 7:
			if (iLocal_1132)
			{
				if ((unk_0xFC38B241541883D3(iLocal_1310, 0) && unk_0xB5BBEB12C77EE430(iLocal_1310, -1) == iVar0) && unk_0xB5BBEB12C77EE430(iLocal_1310, 1) == iLocal_1044)
				{
					if (!unk_0x3E0478C40AB5B38D(iVar0))
					{
						if (bLocal_1147 || (iLocal_1161 && !unk_0xA9F3D2C5FC57B2A8(iLocal_1310)))
						{
							...
							if (!unk_0x3E0478C40AB5B38D(unk_0x9F92518438215DD0()))
							{
								if (unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0))
								{
									if (unk_0xE962BD784DD0E442(iVar0, -1273030092) != 1)
									{
										unk_0xBBB86C3DA83A56F3(iVar0, iLocal_1310, unk_0x1161215F69587BDA(unk_0x9F92518438215DD0(), 0), 8, 35f, 786469, -1f, -1f, 1);
									}
								}
								else if (unk_0xE962BD784DD0E442(iVar0, -1273030092) != 1)
								{
									unk_0x7FC0EEAECC1615C3(iVar0, iLocal_1310, unk_0x9F92518438215DD0(), 8, 35f, 786469, -1f, -1f, 1);
								}
							}
						}
					}
			...
			else if (bLocal_1147 || (iLocal_1161 && !unk_0xA9F3D2C5FC57B2A8(iLocal_1310)))
			{
				if (unk_0xFC38B241541883D3(iLocal_1310, 0))
				{
					if (unk_0xB5BBEB12C77EE430(iLocal_1310, -1) == iVar0)
					{
						if (!unk_0x0BA451447C3B1A8D(iVar0))
						{
							if (unk_0xE962BD784DD0E442(iVar0, -1273030092) != 1)
							{
								unk_0x2B0CA599BAD90FB6(iVar0, iLocal_1310, Local_1288, 8, 25f, 786603, -1f, -1f, 1);
							}
						}
					}
				}
		...
		case 8:
			if (bLocal_1157)
			{
				...
				unk_0xF811299AF81DB581(0, 0, 0);
				unk_0x284B09A617F0967C(0, func_115(), unk_0x073B65E051D2F03E(1000, 1500), 2048, 4);
				unk_0x92641D4778270335(0, unk_0x9F92518438215DD0(), unk_0x073B65E051D2F03E(15000, 16000), 30f, 1f, 1073741824, 0);
				unk_0xFD691F9CDF9FE857(0, unk_0x9F92518438215DD0(), func_115(), 1f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				unk_0x3179CCC77CBAB31F(uLocal_1322);
				if (!unk_0x0BA451447C3B1A8D(uLocal_1048[iParam0]))
				{
					unk_0xC7EBE3C9AC83FAAA(uLocal_1048[iParam0], uLocal_1322);
				}
				unk_0xCD02E3C29B8253A6(&uLocal_1322);
			}
			else
		...
		case 9:
			if (!unk_0x3E0478C40AB5B38D(uLocal_1048[iParam0]))
			{
				if (unk_0xE962BD784DD0E442(uLocal_1048[iParam0], 1435919172) != 1)
				{
					unk_0x5F14A4E9A3FB84D9(uLocal_1048[iParam0], iLocal_1043, iLocal_1043, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				}
			}
			break;
	...
	if (!iLocal_1132)
	{
		...
		else if (func_124(iVar0))
		{
			...
			if (iVar2 != 0)
			{
				func_103(unk_0x77009B1C011405A9(iVar2, 1), 1097859072, 1116471296);
			}
			if (!func_102())
			{
				iLocal_1132 = 1;
...
int func_124(int iParam0)
{
	...
	if (!iLocal_1132)
	{
		if (unk_0x746960881FB19A89(iParam0))
		{
			...
			if (func_105(iParam0, iVar0, &Local_359, &iLocal_370, 0, 0, 0, 1, 1) || (unk_0xBD280C076BC69C97(iParam0) && func_23(iParam0, 1) < 1.5f))
			{
				return 1;
			}
		}
...
int func_125()
{
	...
	uLocal_1210 = unk_0xFC9FFBE3300B9CD9(unk_0x9F92518438215DD0(), &iVar1);
	uLocal_1210 = uLocal_1210;
	uLocal_1210 = iVar1;
	iVar0 = 0;
	while (iVar0 < iVar1)
	{
		if (unk_0x746960881FB19A89(iVar1[iVar0]) && !unk_0x0BA451447C3B1A8D(iVar1[iVar0]))
		{
			if (unk_0xFE0FA79BC49EBB07(iVar1[iVar0], -1218.844f, -278.623f, 36.8196f, -1248.403f, -225.8467f, 43.15606f, 8.5f, 0, 1, 0))
			{
				iLocal_1209++;
			}
		}
...
int func_127()
{
	if (unk_0xFC38B241541883D3(iLocal_1310, 0))
	{
		if (!unk_0x3E0478C40AB5B38D(iLocal_1044))
		{
			if (!iLocal_1132)
			{
				if (unk_0x44E080690DA76A2A(iLocal_1044, iLocal_1310, 0) && func_128())
				{
					return 1;
				}
			}
			else if (unk_0x44E080690DA76A2A(iLocal_1044, iLocal_1310, 0))
			{
				return 1;
			}
		}
...
int func_128()
{
	...
	while (iVar0 <= 1)
	{
		if (!unk_0x3E0478C40AB5B38D(iLocal_1045[iVar0]))
		{
			if (!unk_0x827151D7B70CB853(iLocal_1045[iVar0], 0))
			{
				iVar1 = 0;
			}
		}
...
void func_129(int iParam0)
{
	switch (iLocal_1206)
	{
		case 0:
			if (!unk_0x0BA451447C3B1A8D(iParam0))
			{
				if (unk_0xE962BD784DD0E442(iParam0, 1630799643) != 1)
				{
					unk_0xF58859AEB2D983FE(iParam0, unk_0x9F92518438215DD0(), -1, 0);
				}
				func_28(iParam0, 3, "OJAvaGUARD");
...
void func_130(int iParam0)
{
	if (!unk_0x3E0478C40AB5B38D(iParam0))
	{
		...
		{
			if (unk_0xE962BD784DD0E442(iParam0, -1207174364) != 1 && unk_0xE962BD784DD0E442(iParam0, 1630799643) != 1)
			{
				unk_0xF58859AEB2D983FE(iParam0, iLocal_1043, -1, 0);
			}
		}
		else if (unk_0xE962BD784DD0E442(iParam0, -1207174364) != 1)
		{
			if (iParam0 == iLocal_1055)
			{
				unk_0x5F14A4E9A3FB84D9(iParam0, iLocal_1043, iLocal_1043, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
			}
			else if (unk_0xE962BD784DD0E442(iParam0, 1630799643) != 1)
			{
				unk_0xF58859AEB2D983FE(iParam0, iLocal_1043, -1, 0);
			}
		}
...
void func_132(int iParam0, var uParam1)
{
	...
	if (iVar0 == 0)
	{
		unk_0x7CF15DD8B3815A0D(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_earpiece_a", 8f, -8f, -1, 1, unk_0x3250987ED5A577C0(0f, 1f), 1, 0, 0);
	}
	else if (iVar0 == 1)
	{
		unk_0x7CF15DD8B3815A0D(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_earpiece_b", 8f, -8f, -1, 1, unk_0x3250987ED5A577C0(0f, 1f), 1, 0, 0);
	}
	else if (iVar0 == 2)
	{
		unk_0x7CF15DD8B3815A0D(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_fold_arms", 8f, -8f, -1, 1, unk_0x3250987ED5A577C0(0f, 1f), 1, 0, 0);
	}
	else if (iVar0 == 3)
	{
		unk_0x7CF15DD8B3815A0D(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_look", 8f, -8f, -1, 1, unk_0x3250987ED5A577C0(0f, 1f), 1, 0, 0);
	}
	*uParam1 = iVar0;
}
...
int func_133(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = unk_0x073B65E051D2F03E(iParam0, iParam1);
...
void func_134(int iParam0)
{
	...
	if (!unk_0x746960881FB19A89(iLocal_1045[iParam0]))
	{
		return;
	}
	switch (iLocal_1039[iParam0])
	{
		case 0:
			if (!unk_0x0BA451447C3B1A8D(iLocal_1044))
			{
				if (!unk_0x827151D7B70CB853(iLocal_1044, 0))
				{
					if (!unk_0x3E0478C40AB5B38D(iLocal_1045[iParam0]))
					{
						if (iParam0 == 0)
						{
							unk_0x3EF9F824EB10BF1F(iLocal_1045[iParam0], iLocal_1044, 1.5f, 0f, 0f, 1f, -1, 1036831949, 1);
						}
						else if (iParam0 == 1)
						{
							if (unk_0xFC38B241541883D3(iLocal_1311, 0))
							{
								...
								unk_0x11C32E558C0429ED(0, -1222.992f, -191.0932f, 38.17538f, 1f, 0, 0, 786603, -1082130432);
								unk_0x18CA21B07F636243(0, "WORLD_HUMAN_GUARD_STAND", 0, 0);
								unk_0x4073360CA020BB84(0, iLocal_1311, 30000, 2, 1f, 1, 0);
								unk_0x3179CCC77CBAB31F(uVar2);
								unk_0xC7EBE3C9AC83FAAA(iLocal_1045[iParam0], uVar2);
		...
		case 1:
			...
			if (!unk_0x0BA451447C3B1A8D(iLocal_1045[iParam0]))
			{
				if (unk_0xFC38B241541883D3(iVar0, 0))
				{
					if (!unk_0x0BA451447C3B1A8D(iLocal_1045[iParam0]))
					{
						if (!unk_0x44E080690DA76A2A(iLocal_1045[iParam0], iVar0, 0))
						{
							if (unk_0x827151D7B70CB853(iLocal_1044, 0))
							{
								if (unk_0xE962BD784DD0E442(iLocal_1045[iParam0], -1794415470) != 1)
								{
									unk_0x4073360CA020BB84(iLocal_1045[iParam0], iVar0, 30000, iVar1, 1f, 1, 0);
								}
							}
						}
						else
		...
		case 2:
			...
			if (unk_0xFC38B241541883D3(iVar0, 0))
			{
				if (!unk_0x0BA451447C3B1A8D(iLocal_1045[iParam0]))
				{
					if (unk_0x44E080690DA76A2A(iLocal_1045[iParam0], iVar0, 0) && unk_0xFC38B241541883D3(iLocal_1310, 0))
					{
						if (iLocal_1132)
						{
							if (!bLocal_1162)
							{
								if (unk_0xE962BD784DD0E442(iLocal_1045[iParam0], 780511057) != 1)
								{
									if (!unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0))
									{
										if (unk_0x9EF11DECA38804B6(iVar0) < 5f)
										{
											iLocal_1039[iParam0] = 5;
										}
									}
									unk_0xF78316EFCA911012(iLocal_1045[iParam0], unk_0x9F92518438215DD0(), 0, 16);
								}
							}
							else if (unk_0xE962BD784DD0E442(iLocal_1045[iParam0], 780511057) != 1)
							{
								unk_0xF78316EFCA911012(iLocal_1045[iParam0], unk_0x9F92518438215DD0(), 0, 16);
							}
						}
		...
		case 3:
			if (!unk_0x3E0478C40AB5B38D(iLocal_1045[iParam0]))
			{
				if (unk_0xFE7B766A3EC52BAD(iLocal_1045[iParam0]))
				{
					unk_0xE7F5E74491BCEA02(iLocal_1045[iParam0]);
				}
			}
			if (bLocal_1157)
			{
				...
				unk_0xFD691F9CDF9FE857(0, unk_0x9F92518438215DD0(), func_115(), 1f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				unk_0x3179CCC77CBAB31F(uLocal_1322);
				unk_0xC7EBE3C9AC83FAAA(iLocal_1045[iParam0], uLocal_1322);
				unk_0xCD02E3C29B8253A6(&uLocal_1322);
			}
			else if (!unk_0x3E0478C40AB5B38D(iLocal_1045[iParam0]))
			{
				unk_0x241B22B5B8B8DBDB(iLocal_1045[iParam0], Local_1303, 15f, 0, 0);
				unk_0x9A43E575C1997EF8(iLocal_1045[iParam0], 1);
				unk_0x64277E0EB39C1162(iLocal_1045[iParam0], 0, 1);
				unk_0x0365EE015603E149(iLocal_1045[iParam0], 2f);
				if (!iLocal_1129 && !unk_0x827151D7B70CB853(iLocal_1045[iParam0], 0))
				{
					unk_0xF87DA7F5BA8C7D0F(&uLocal_1322);
					if (unk_0x3E0478C40AB5B38D(iLocal_1044))
					{
						unk_0x7CF15DD8B3815A0D(0, "oddjobs@assassinate@hotel@", "alert_gunshot", 8f, -4f, 1250, 0, 0, 0, 0, 0);
						unk_0x1E0FCE815D17DDA5(0, func_115(), 3000, 0, 1);
						unk_0xF58859AEB2D983FE(0, unk_0x9F92518438215DD0(), -1, 0);
					}
					else
					{
						unk_0x7CF15DD8B3815A0D(0, "oddjobs@assassinate@hotel@", "alert_gunshot", 8f, -4f, 700, 0, 0, 0, 0, 0);
						unk_0x3EF9F824EB10BF1F(0, iLocal_1044, 1.5f, 0f, 0f, 2f, -1, 1036831949, 1);
					}
					unk_0x3179CCC77CBAB31F(uLocal_1322);
					iLocal_1129 = 1;
				}
				else
				{
					if (unk_0x746960881FB19A89(iLocal_1310) && unk_0xFC38B241541883D3(iLocal_1310, 0))
					{
						Var4 = { unk_0x038249BAB926B732(iLocal_1310, unk_0xB96C39A95065BDE2(iLocal_1310, "wheel_lr")) };
						Var7 = { unk_0x77009B1C011405A9(iLocal_1310, 1) };
						Var7 = { Var4 - Var7 };
						unk_0xF9FF109016228B33(iLocal_1045[iParam0], iLocal_1310, Var7, 1.5f, 0);
					}
					unk_0xF87DA7F5BA8C7D0F(&uLocal_1322);
					unk_0xF811299AF81DB581(0, 0, 0);
					if (unk_0x3E0478C40AB5B38D(iLocal_1044) && !func_44(func_135(), Var4))
					{
						unk_0xC09BA3382ED3024E(0, Var4, func_115(), 2f, 0, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
						unk_0xB4A325B6A5973ABC(0, Var4, -1, 0, 0.25f, 0, 0, 0, 1);
					}
					else
					{
						unk_0x1E0FCE815D17DDA5(0, func_115(), 1500, 1, 0);
						if (!unk_0x0BA451447C3B1A8D(iLocal_1044))
						{
							unk_0x3EF9F824EB10BF1F(0, iLocal_1044, 0f, -1.5f, 0f, 2f, -1, 1036831949, 1);
						}
					}
					unk_0x3179CCC77CBAB31F(uLocal_1322);
				}
		...
		case 4:
			if (!unk_0x0BA451447C3B1A8D(iLocal_1045[iParam0]))
			{
				if (unk_0x3C17D9ED0E5F3FCA(iLocal_1045[iParam0], "oddjobs@assassinate@hotel@", "enter", 3))
				{
					fVar3 = unk_0xD17241758B91AAED(iLocal_1045[iParam0], "oddjobs@assassinate@hotel@", "enter");
					if (fVar3 < 0.5f)
					{
						unk_0x32C245E0760F73B7(iLocal_1045[iParam0], "oddjobs@assassinate@hotel@", "enter", 3.5f);
					}
					else
					{
						unk_0x32C245E0760F73B7(iLocal_1045[iParam0], "oddjobs@assassinate@hotel@", "enter", 1f);
					}
				}
			}
			break;
		...
		case 5:
			...
			if (!unk_0x3E0478C40AB5B38D(iLocal_1044))
			{
				if (!unk_0x3E0478C40AB5B38D(iLocal_1045[iParam0]))
				{
					if (unk_0x827151D7B70CB853(iLocal_1044, 0))
					{
						unk_0xF78316EFCA911012(iLocal_1045[iParam0], iLocal_1043, 0, 16);
					}
					else
					{
						unk_0x5F14A4E9A3FB84D9(iLocal_1045[iParam0], iLocal_1044, unk_0x9F92518438215DD0(), 3f, 1, 0.005f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
					}
				}
				iLocal_1039[iParam0] = 6;
			}
			else if (unk_0xFC38B241541883D3(iVar0, 0))
			{
				if (unk_0x9EF11DECA38804B6(iVar0) < 5f)
				{
	...
	else if (iLocal_1039[iParam0] < 5)
	{
		if (!unk_0x3E0478C40AB5B38D(iLocal_1045[iParam0]))
		{
			...
			unk_0x93B6AE39977DA649(iLocal_1045[iParam0]);
			unk_0x9A43E575C1997EF8(iLocal_1045[iParam0], 2);
			unk_0x64277E0EB39C1162(iLocal_1045[iParam0], 13, 1);
		}
		iLocal_1039[iParam0] = 5;
	}
}
...
void func_137()
{
	...
	if (unk_0x746960881FB19A89(iLocal_1044))
	{
		Local_1303 = { unk_0x77009B1C011405A9(iLocal_1044, 0) };
	}
	switch (iLocal_1038)
	{
		case 0:
			if (!unk_0x0BA451447C3B1A8D(iLocal_1044))
			{
				if (unk_0xFC38B241541883D3(iLocal_1310, 0) && !unk_0x0BA451447C3B1A8D(uLocal_1048[0]))
				{
					if (!unk_0x44E080690DA76A2A(iLocal_1044, iLocal_1310, 0))
					{
						if (unk_0xE962BD784DD0E442(iLocal_1044, -1794415470) != 1)
						{
							if (!iLocal_1132 && !iLocal_1156)
							{
								unk_0x4073360CA020BB84(iLocal_1044, iLocal_1310, 30000, 1, 1f, 1, 0);
							}
							else
							{
								unk_0x4073360CA020BB84(iLocal_1044, iLocal_1310, 30000, 1, 2f, 1, 0);
							}
		...
		case 1:
			...
			if (!iLocal_1177)
			{
				if (func_139())
				{
					if (func_24(iLocal_1044, unk_0x9F92518438215DD0(), 1) <= 5f && !func_22())
					{
						if (func_30(25f, 1) == 0)
						{
							if (func_138())
		...
		case 4:
			if (!unk_0x0BA451447C3B1A8D(iLocal_1044))
			{
				if (unk_0x44E080690DA76A2A(iLocal_1044, iLocal_1310, 0))
				{
					if (unk_0xE962BD784DD0E442(iLocal_1044, -828834893) != 1)
					{
						unk_0xF811299AF81DB581(iLocal_1044, 0, 256);
					}
				}
				else if (!bLocal_1162)
				{
					unk_0x0365EE015603E149(iLocal_1044, 2f);
					unk_0xCD02E3C29B8253A6(&uVar0);
					unk_0xF87DA7F5BA8C7D0F(&uVar0);
					unk_0x7CF15DD8B3815A0D(0, "oddjobs@assassinate@hotel@", "alert_gunshot", 8f, -4f, 1000, 0, 0, 0, 0, 0);
					unk_0x722E6B3A5162A6BB(0, iLocal_1043, 200f, -1, 0, 0);
					unk_0x3179CCC77CBAB31F(uVar0);
					if (!unk_0x0BA451447C3B1A8D(iLocal_1044))
					{
						unk_0xC7EBE3C9AC83FAAA(iLocal_1044, uVar0);
					}
					unk_0xCD02E3C29B8253A6(&uVar0);
					bLocal_1162 = true;
				}
				else if (unk_0xE962BD784DD0E442(iLocal_1044, 1435919172) != 1)
				{
					unk_0x722E6B3A5162A6BB(iLocal_1044, iLocal_1043, 200f, -1, 0, 0);
				}
				if (!iLocal_1177)
				{
	...
	if (!iLocal_1132)
	{
		...
		else if (func_124(iLocal_1044) || iLocal_1186)
		{
			...
			if (iVar1 != 0)
			{
				func_103(unk_0x77009B1C011405A9(iVar1, 1), 1097859072, 1116471296);
			}
			if (!func_102())
			{
				iLocal_1132 = 1;
...
int func_139()
{
	...
	if (unk_0xFC38B241541883D3(iLocal_1310, 0))
	{
		iVar0 = unk_0xB5BBEB12C77EE430(iLocal_1310, -1);
		if (iVar0 == 0 || (iVar0 != 0 && unk_0x3E0478C40AB5B38D(iVar0)))
		{
			iVar0 = unk_0xB5BBEB12C77EE430(iLocal_1310, 0);
			if (iVar0 == 0 || (iVar0 != 0 && unk_0x3E0478C40AB5B38D(iVar0)))
			{
				iVar0 = unk_0xB5BBEB12C77EE430(iLocal_1310, 2);
				if (iVar0 == 0 || (iVar0 != 0 && unk_0x3E0478C40AB5B38D(iVar0)))
				{
					return 1;
				}
...
void func_141()
{
	if (!iLocal_1163)
	{
		if (iLocal_1029 > 15)
		{
			unk_0xDD74AAB135833BB7("ASS1_ALERT");
			iLocal_1163 = 1;
		}
	}
	if (!iLocal_1164)
	...
	switch (iLocal_1029)
	{
		...
		case 6:
			...
			if (bLocal_1140)
			{
				if (Global_97358.f_18217.f_5 != 0f)
				{
					func_51(&uLocal_1334, Global_97358.f_18217.f_5);
				}
				iLocal_1207 = func_463();
				if (Global_84544)
				{
	...
	switch (iLocal_1213)
	{
		case 0:
			if (!iLocal_376)
			{
				...
				Global_97358.f_18217.f_5 = func_46(&uLocal_1334);
				fLocal_371 = Global_97358.f_18217.f_5;
				func_215();
				iLocal_376 = 1;
				iLocal_1213 = 1;
			}
		...
		case 1:
			...
			if (func_211(&uLocal_387, 1, 0) && unk_0x53B202470852810A())
			{
...
void func_148(struct<25> Param0, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38)
{
	...
	if (func_111(Global_97358.f_18217.f_1, 4194304))
	{
...
void func_149(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_150(Global_97358.f_29774[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_153(int iParam0)
{
	...
	else if (unk_0x94E72F17611BCD3C(Global_97358.f_23789.f_471, iParam0) || unk_0x94E72F17611BCD3C(Global_2097152[func_155() /*8064*/].f_5756.f_10, iParam0))
	{
		bVar0 = true;
		unk_0xF76EE56D3E7DAF1B(&(Global_97358.f_23789.f_471), iParam0);
		unk_0xF76EE56D3E7DAF1B(&(Global_2097152[func_155() /*8064*/].f_5756.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		unk_0x3BE5C2319988C0DB("COUP_RED");
		unk_0xDB4BC767CEF09274(func_154(iParam0));
...
bool func_157(int iParam0)
{
	...
	return unk_0x94E72F17611BCD3C(Global_2097152[func_155() /*8064*/].f_5756.f_10, iParam0);
}
...
int func_160(int iParam0, int iParam1)
{
	...
	if (func_168(&Global_2545750))
	{
		if (func_166(&Global_2545750, iParam0))
		{
			return 0;
		}
		if (func_161(&Global_2545750, iParam0))
		{
			return 1;
		}
	}
...
float func_173()
{
	...
	fVar0 = 0f;
	if (func_111(Global_97358.f_18217.f_1, 8192))
	{
		fVar0 = (fVar0 + 0.2f);
	}
	if (func_111(Global_97358.f_18217.f_1, 16384))
	{
		fVar0 = (fVar0 + 0.2f);
	}
	if (func_111(Global_97358.f_18217.f_1, 32768))
	{
		fVar0 = (fVar0 + 0.2f);
	}
	if (func_111(Global_97358.f_18217.f_1, 65536))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	if (func_111(Global_97358.f_18217.f_1, 131072))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	if (func_111(Global_97358.f_18217.f_1, 262144))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	if (func_111(Global_97358.f_18217.f_1, 524288))
	{
		fVar0 = (fVar0 + 0.333f);
	}
	if (func_111(Global_97358.f_18217.f_1, 1048576))
	{
		fVar0 = (fVar0 + 0.333f);
	}
	if (func_111(Global_97358.f_18217.f_1, 2097152))
	{
		fVar0 = (fVar0 + 0.333f);
	}
	return fVar0;
...
void func_174()
{
	func_477(&(Global_97358.f_18217.f_1), 2048);
}
...
void func_175(var uParam0)
{
	...
	if (!Global_68513)
	{
		if (!unk_0xCB90E9273A35BF89(unk_0x2563F6EECD8726D3()))
		{
			if (!Global_68514)
			{
				if (unk_0x2E9CF5C574019636() && !func_40(0))
				{
...
void func_178(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (!func_184(uParam0->f_1, 256) || (func_184(uParam0->f_1, 8192) && unk_0x54610002CC66A3C6(2)))
	{
		...
		if (unk_0x708CE249B4F97BF8())
		{
			...
			unk_0x63E5FA5DEE979BD6(func_184(uParam0->f_1, 4096));
			unk_0x7E86CE5F658823DB();
		}
		iVar5 = 0;
		iVar6 = 0;
...
int func_186(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	...
	if (!uParam0->f_563)
	{
		switch (func_16(unk_0x4E6043D225B9C75F(unk_0x2563F6EECD8726D3())))
		{
			case 1:
	...
	while (bVar0)
	{
		...
		if ((uParam0->f_565 || uParam0->f_566) && uParam0->f_56 != 0)
		{
			if (IntToFloat(uParam0->f_572) > (IntToFloat(uParam0->f_558 + 1165) - (15000f * fParam2)))
			{
				...
				uParam0->f_559 = func_188((uParam0->f_559 + (((1f / 0.3f) * uParam0->f_573) * unk_0x0000000050597EE2())), 0f, 1f);
				uParam0->f_573 = func_188((uParam0->f_573 + 0.07f), 0.75f, 1.15f);
			}
		}
		else
		{
			uParam0->f_559 = func_188((uParam0->f_559 - ((((1f / 0.3f) * uParam0->f_573) * 0.01f) * unk_0x0000000050597EE2())), 0f, 1f);
			uParam0->f_573 = func_188((uParam0->f_573 + 0.07f), 0.75f, 1.15f);
		}
...
void func_187(var uParam0, bool bParam1)
{
	...
	func_183(unk_0x34B4609B3C3F7CD6(2, 215, true));
	func_182("ES_HELP");
	if (unk_0x708CE249B4F97BF8())
	{
		unk_0x63E5FA5DEE979BD6(true);
	...
	if (bParam1)
	{
		unk_0x48F299599202B77A(uParam0->f_4, "SET_DATA_SLOT");
		unk_0x4BD4D58838D3F8E5(1);
		func_183(unk_0x34B4609B3C3F7CD6(2, 216, true));
		func_182("ES_XPAND");
		if (unk_0x708CE249B4F97BF8())
		{
			unk_0x63E5FA5DEE979BD6(true);
...
void func_189(var uParam0, float fParam1, bool bParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	if (fVar11 >= 0f)
	{
		...
		func_203();
		unk_0x2C21286870CDCF47(0.5f, (fVar1 - (func_205((2f - 0.5f)) - 0.001388889f)), fVar6, func_201(1f), uVar13, uVar14, uVar15, unk_0xF2DB717A73826179((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
	...
	while (iVar17 < uParam0->f_56)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			func_198(uParam0, iVar17, (fVar1 + func_205(2f)), fVar9, fVar10, unk_0xF2DB717A73826179((IntToFloat(iVar0) * fVar12)));
		}
		else
		{
			return;
	...
	if (uParam0->f_56 > 0)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			fVar12 = func_188((fVar11 / (0.6f * func_205(25f))), 0f, 1f);
			func_203();
			unk_0x2C21286870CDCF47(0.5f, (fVar1 + func_205((2f * 0.5f))), fVar6, func_201(1f), uVar13, uVar14, uVar15, unk_0xF2DB717A73826179((fVar12 * IntToFloat(iVar16))), 0);
		}
	}
	if (uParam0->f_549)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_556)
			{
				case 0:
					...
					unk_0xC5A6B5A176BD3AE0(fVar20, (fVar1 + func_205((2f * 2f))), 0);
					break;
...
void func_191(char* sParam0, float fParam1, float fParam2, int iParam3, bool bParam4, int iParam5)
{
...
int func_192(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)
{
	var uVar0;
	char* sVar1;
	int iVar2;
	...
	if (unk_0x398F092142D37E17(sVar1) != 0)
	{
		...
		Var7.f_0 = (Var7.f_0 * (func_193(iParam0) / fVar4));
...
var func_195(int iParam0, bool bParam1)
{
	char* sVar0[2];
...
void func_198(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	unk_0x3EF8FB8F31B18D9F(1);
	unk_0xC98C9F8951F37C8D(1f, func_200(14f));
	unk_0xA682F10B60088C3D(0);
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			unk_0x58A67A48C3633535("CommonMenu", func_195(7, 0), (fParam4 - 0.006f), ((fParam2 + func_205(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_192(5, 0, 1, &fVar5, &fVar6, 0);
			unk_0x58A67A48C3633535("CommonMenu", func_195(5, 0), (fParam4 - 0.006f), ((fParam2 + func_205(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_192(6, 0, 1, &fVar5, &fVar6, 0);
			unk_0x58A67A48C3633535("CommonMenu", func_195(6, 0), (fParam4 - 0.006f), ((fParam2 + func_205(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_199(int iParam0, int iParam1, float fParam2, float fParam3, char* sParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	switch (iParam5)
	{
		case 4:
		case 5:
			unk_0xC98C9F8951F37C8D(1f, func_200(18f));
...
int func_209(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
void func_210(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (*uParam0 == 0)
	{
...
void func_212(var uParam0)
{
	...
	func_183(unk_0x34B4609B3C3F7CD6(2, 188, true));
	func_182("ES_HELP_TU");
	unk_0x7E86CE5F658823DB();
	unk_0x48F299599202B77A(uParam0->f_4, "SET_DATA_SLOT");
	unk_0x4BD4D58838D3F8E5(1);
	func_183(unk_0x34B4609B3C3F7CD6(2, 187, true));
	func_182("ES_HELP_TD");
	unk_0x7E86CE5F658823DB();
	unk_0x48F299599202B77A(uParam0->f_4, "SET_DATA_SLOT");
	unk_0x4BD4D58838D3F8E5(0);
	func_183(unk_0x34B4609B3C3F7CD6(2, 202, true));
	func_182("ES_HELP_AB");
	unk_0x7E86CE5F658823DB();
	unk_0x48F299599202B77A(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	unk_0x7E86CE5F658823DB();
...
void func_213(var uParam0)
{
	...
	fVar0 = 0f;
	unk_0x3EF8FB8F31B18D9F(0);
	unk_0xC98C9F8951F37C8D(1f, func_200(16f));
	if (uParam0->f_31 == 0)
	{
		if (uParam0->f_29)
		{
...
void func_215()
{
	...
	if (!iLocal_376)
	{
		...
		if (Global_84544)
		{
			func_220(&uLocal_387, 6, &(Local_963.f_12), "MTPHPERSKI", unk_0xF34EE736CF047844(fLocal_371), 0, 3, 0);
			func_220(&uLocal_387, 6, &(Local_963.f_24), "MTPHPERSKI", 0, 0, 3, 0);
			func_220(&uLocal_387, 6, &(Local_963.f_30), "MTPHPERSKI", unk_0xF2DB717A73826179((fLocal_373 + fLocal_372)), 0, 3, 0);
			func_219();
		}
		else
		{
			if (bLocal_375)
			{
				func_220(&uLocal_387, 6, &(Local_963.f_12), "MTPHPERRET", unk_0xF34EE736CF047844(fLocal_371), 0, 3, 0);
			}
			else
			{
				func_220(&uLocal_387, 9, &(Local_963.f_12), "", unk_0xF34EE736CF047844(fLocal_371), 0, 0, 0);
			}
			if (!unk_0x9E9AFDBF482248F6(&(Local_963.f_18)))
			{
				if (bLocal_374)
				{
					func_220(&uLocal_387, 6, &(Local_963.f_24), "", 0, 0, 2, 0);
					func_220(&uLocal_387, 3, &(Local_963.f_30), "", unk_0xF2DB717A73826179((fLocal_373 + fLocal_372)), 0, 2, 0);
				}
				else
				{
					func_220(&uLocal_387, 6, &(Local_963.f_24), "", 0, 0, 1, 0);
					func_220(&uLocal_387, 3, &(Local_963.f_30), "", unk_0xF2DB717A73826179(fLocal_372), 0, 0, 0);
				}
			}
			else
			{
...
void func_216()
{
	...
	{
		func_217(38, unk_0xF34EE736CF047844(fLocal_371), 1);
		if (bLocal_374)
		{
			func_217(39, 1, 1);
		}
		...
		if (bLocal_374)
		{
			func_217(40, unk_0xF2DB717A73826179((fLocal_373 + fLocal_372)), 1);
		}
		else
		{
			func_217(40, unk_0xF2DB717A73826179(fLocal_372), 1);
		}
	...
	{
		func_217(52, unk_0xF34EE736CF047844(fLocal_371), 1);
		if (bLocal_374)
		{
			func_217(53, 1, 1);
		}
		...
		if (bLocal_374)
		{
			func_217(56, unk_0xF2DB717A73826179((fLocal_373 + fLocal_372)), 1);
		}
		else
		{
			func_217(56, unk_0xF2DB717A73826179(fLocal_372), 1);
		}
	...
	{
		func_217(66, unk_0xF34EE736CF047844(fLocal_371), 1);
		if (bLocal_374)
		{
			func_217(67, 1, 1);
		}
		...
		if (bLocal_374)
		{
			func_217(68, unk_0xF2DB717A73826179((fLocal_373 + fLocal_372)), 1);
		}
		else
		{
			func_217(68, unk_0xF2DB717A73826179(fLocal_372), 1);
		}
	...
	{
		func_217(81, unk_0xF34EE736CF047844(fLocal_371), 1);
		if (bLocal_374)
		{
			func_217(82, 1, 1);
		}
		...
		if (bLocal_374)
		{
			func_217(83, unk_0xF2DB717A73826179((fLocal_373 + fLocal_372)), 1);
		}
		else
		{
			func_217(83, unk_0xF2DB717A73826179(fLocal_372), 1);
		}
	...
	{
		func_217(97, unk_0xF34EE736CF047844(fLocal_371), 1);
		if (bLocal_374)
		{
			func_217(98, 1, 1);
		}
		...
		if (bLocal_374)
		{
			func_217(99, unk_0xF2DB717A73826179((fLocal_373 + fLocal_372)), 1);
		}
		else
		{
			func_217(99, unk_0xF2DB717A73826179(fLocal_372), 1);
		}
...
void func_218(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_220(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
...
void func_221(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
...
void func_222()
{
	func_477(&(Global_97358.f_18217.f_1), 4194304);
}
	...
	if (!bLocal_1173)
	{
		if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
		{
			if (unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0))
			{
				...
				{
					if (unk_0x9A28E4216D017B9D(iVar0))
					{
						if (unk_0xD670D03A989D1279("ASS1_LOST"))
						{
							bLocal_1173 = true;
						}
					}
...
void func_224()
{
	...
	switch (iLocal_1191)
	{
		...
		case 1:
			if (!unk_0x3E0478C40AB5B38D(unk_0x9F92518438215DD0()))
			{
				fVar0 = func_26(unk_0x9F92518438215DD0(), Local_1297, 1);
...
int func_225()
{
	if (bLocal_1173)
	{
		unk_0xDD74AAB135833BB7("ASS1_LOST");
		iLocal_1174 = 1;
	}
	func_226();
	return 1;
...
void func_226()
{
	...
	while (iVar0 < 2)
	{
		if (unk_0x746960881FB19A89(iLocal_1045[iVar0]))
		{
			if (!unk_0x3E0478C40AB5B38D(iLocal_1045[iVar0]))
			{
				...
				unk_0x32D18ECD9E6F9BE2(iLocal_1045[iVar0]);
				unk_0x995B3705D02B0401(&(iLocal_1045[iVar0]));
			}
		}
		iVar0++;
	}
	if (unk_0x746960881FB19A89(iLocal_1044))
	{
		if (!unk_0x3E0478C40AB5B38D(iLocal_1044))
		{
			unk_0x32D18ECD9E6F9BE2(iLocal_1044);
			unk_0x995B3705D02B0401(&iLocal_1044);
		}
	}
	iVar0 = 0;
	while (iVar0 < 3)
	{
		if (unk_0x746960881FB19A89(uLocal_1048[iVar0]))
		{
			if (!unk_0x3E0478C40AB5B38D(uLocal_1048[iVar0]))
			{
				...
				unk_0x32D18ECD9E6F9BE2(uLocal_1048[iVar0]);
				unk_0x995B3705D02B0401(&(uLocal_1048[iVar0]));
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < 2)
	{
		if (unk_0x746960881FB19A89(uLocal_1052[iVar0]))
		{
			if (!unk_0x3E0478C40AB5B38D(uLocal_1052[iVar0]))
			{
				...
				unk_0x32D18ECD9E6F9BE2(uLocal_1052[iVar0]);
				unk_0x995B3705D02B0401(&(uLocal_1052[iVar0]));
			}
		}
		iVar0++;
	}
	unk_0x0880E86251A44B7F(iLocal_1323);
}
...
void func_230()
{
	...
	switch (iLocal_1191)
	{
		case 0:
			...
			else if (!unk_0x99A27D5F9B887E5F(unk_0xCFC72E446B0B3AD7(), 0) && func_30(125f, 1) == 0)
			{
				iLocal_1191++;
			}
			break;
		...
		case 1:
			if (!unk_0x99A27D5F9B887E5F(unk_0xCFC72E446B0B3AD7(), 0) && func_30(125f, 1) == 0)
			{
				func_223();
				func_226();
				func_232(1);
...
void func_231()
{
	if (unk_0x746960881FB19A89(iLocal_1310))
	{
		if (unk_0xFC38B241541883D3(iLocal_1310, 0))
		{
			unk_0x993B4D0D3CD44124(iLocal_1310, 1);
		}
		unk_0x9187463EB4918A4D(&iLocal_1310);
	}
	if (unk_0x746960881FB19A89(iLocal_1311))
	{
		if (!unk_0x0BA451447C3B1A8D(iLocal_1311))
		{
			if ((unk_0x0FF9FE2CB115CFB9(iLocal_1311) && !unk_0xC7FF9739199F83C9(iLocal_1311)) && !unk_0x2E9CF5C574019636())
			{
				unk_0x9187463EB4918A4D(&iLocal_1311);
			}
			else
			{
				if (unk_0x746960881FB19A89(uLocal_1052[0]) && !unk_0x0BA451447C3B1A8D(uLocal_1052[0]))
				{
					if (!unk_0x0BA451447C3B1A8D(iLocal_1311))
					{
						if (unk_0x44E080690DA76A2A(uLocal_1052[0], iLocal_1311, 0))
						{
							unk_0x71628E52718BD195(uLocal_1052[0]);
						}
					}
				}
				if (unk_0x746960881FB19A89(uLocal_1052[1]) && !unk_0x0BA451447C3B1A8D(uLocal_1052[1]))
				{
					if (!unk_0x0BA451447C3B1A8D(iLocal_1311))
					{
						if (unk_0x44E080690DA76A2A(uLocal_1052[1], iLocal_1311, 0))
						{
							unk_0x71628E52718BD195(uLocal_1052[1]);
						}
					}
				}
				if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
				{
					if (unk_0x44E080690DA76A2A(unk_0x9F92518438215DD0(), iLocal_1311, 0))
					{
	...
	if (unk_0x746960881FB19A89(uLocal_1314[0]))
	{
		unk_0x9187463EB4918A4D(&(uLocal_1314[0]));
	}
	if (unk_0x746960881FB19A89(uLocal_1314[1]))
	{
		unk_0x9187463EB4918A4D(&(uLocal_1314[1]));
	}
	if (unk_0x746960881FB19A89(iLocal_1317) && !unk_0x0BA451447C3B1A8D(iLocal_1317))
	{
		if (unk_0x34E74FF8690AA4B1(iLocal_1317) && unk_0xAD2C236C4A4B83C9(iLocal_1317, 1))
		{
			unk_0x9187463EB4918A4D(&iLocal_1317);
		}
	}
}
...
void func_232(bool bParam0)
{
	...
	if (bParam0)
	{
		if (unk_0x2E6E8D325977B3EC(uLocal_1118))
		{
			unk_0x0451B5D93A4BDAA0(&uLocal_1118);
		}
	}
	iVar0 = 0;
	while (iVar0 < 3)
	{
		if (unk_0x2E6E8D325977B3EC(uLocal_1119[iVar0]))
		{
			unk_0x0451B5D93A4BDAA0(&(uLocal_1119[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 2)
	{
		if (unk_0x2E6E8D325977B3EC(uLocal_1123[iVar0]))
		{
			unk_0x0451B5D93A4BDAA0(&(uLocal_1123[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
...
void func_233()
{
	if (unk_0xFE0FA79BC49EBB07(unk_0x9F92518438215DD0(), Local_1291, Local_1294, fLocal_1241, 1, 0, 0))
	{
		bLocal_1150 = true;
	}
	else
...
void func_235()
{
	if (!bLocal_1147)
	{
		if (unk_0x746960881FB19A89(iLocal_1310))
		{
			if (unk_0xFC38B241541883D3(iLocal_1310, 0))
			{
				unk_0x993B4D0D3CD44124(iLocal_1310, 3);
...
int func_236(int iParam0, int iParam1)
{
	if (unk_0xFC38B241541883D3(iParam0, 0))
	{
		if (((unk_0xED6198B6F71F1E6F(iParam0, 0, iParam1) || unk_0xED6198B6F71F1E6F(iParam0, 2, iParam1)) || unk_0xED6198B6F71F1E6F(iParam0, 3, iParam1)) || unk_0xED6198B6F71F1E6F(iParam0, 1, iParam1))
		{
			return 1;
		}
	}
	...
	switch (iLocal_1191)
	{
		case 0:
			if (unk_0xFC38B241541883D3(iLocal_1310, 0))
			{
				if (func_127())
				{
					if (!unk_0x3E0478C40AB5B38D(uLocal_1048[0]))
					{
						if (unk_0xFC38B241541883D3(iLocal_1310, 0))
						{
							if (unk_0x44E080690DA76A2A(uLocal_1048[0], iLocal_1310, 0))
							{
								bLocal_1143 = true;
								func_234();
								iLocal_1029 = 13;
...
void func_242()
{
	unk_0x0880E86251A44B7F(iLocal_1325);
	unk_0x0880E86251A44B7F(iLocal_1326);
}
...
void func_244(var uParam0)
{
	...
	{
		if (unk_0xC7FF9739199F83C9(*uParam0))
		{
...
void func_246()
{
	...
	if (unk_0x746960881FB19A89(iLocal_1044) && !unk_0x0BA451447C3B1A8D(iLocal_1044))
	{
		Var7 = { unk_0x77009B1C011405A9(iLocal_1044, 1) };
		uVar10 = unk_0xE691E4EA6B4440C6(iLocal_1044);
	}
	Var0[0 /*3*/] = { unk_0x81D32A4E7E765EA7(Var7, uVar10, 1f, -1f, 0f) };
	Var0[1 /*3*/] = { unk_0x81D32A4E7E765EA7(Var7, uVar10, -1f, -1f, 0f) };
	iVar11 = 0;
	while (iVar11 < 2)
	{
		if (iVar11 == 0)
		{
			iLocal_1045[iVar11] = unk_0xA00B5D954AD320BF(26, iLocal_1325, Var0[0 /*3*/], Var0[0 /*3*/].f_1, 38.3253f, uLocal_1237[iLocal_1200], 1, 1);
		}
		else
		{
			iLocal_1045[iVar11] = unk_0xA00B5D954AD320BF(26, iLocal_1326, Var0[1 /*3*/], Var0[1 /*3*/].f_1, 38.3253f, uLocal_1237[iLocal_1200], 1, 1);
		}
		unk_0x512E0C109ACECCA1(iLocal_1045[iVar11], 1);
		unk_0x3E2A91442BB9855D(iLocal_1045[iVar11]);
		unk_0x64277E0EB39C1162(iLocal_1045[iVar11], 3, 0);
		unk_0x64277E0EB39C1162(iLocal_1045[iVar11], 23, 1);
		unk_0x64277E0EB39C1162(iLocal_1045[iVar11], 30, 0);
		unk_0x64277E0EB39C1162(iLocal_1045[iVar11], 13, 1);
		unk_0x79C17B0FEABE87FB(iLocal_1045[iVar11], 2);
		unk_0xE8105B7E3908547D(iLocal_1045[iVar11], 1);
		func_247(iLocal_1045[iVar11], 1);
		unk_0x2FBA45EE923B0834(iLocal_1045[iVar11], 1);
		iVar11++;
	}
}
...
void func_247(int iParam0, bool bParam1)
{
	...
	{
		unk_0x46D3B8FF073CD238(iParam0, joaat("weapon_pistol"), -1, 0, 1);
	}
	if (!bParam1)
	{
	...
	unk_0x488909512824324E(iParam0, 60);
	unk_0x55CB9E8ED151C9E9(iParam0, 2);
	unk_0x4A1AC49BA4A747F7(iParam0, 1);
	unk_0x66ECAC609810906D(iParam0, 1);
	unk_0xA50AD6983D49A772(iParam0, iLocal_1330);
}

void func_248()
{
	func_250();
	iLocal_1200 = unk_0x073B65E051D2F03E(0, iLocal_1193);
	iLocal_1044 = unk_0xA00B5D954AD320BF(26, iLocal_1323, Local_1256[iLocal_1200 /*3*/], uLocal_1237[iLocal_1200], 1, 1);
	unk_0x512E0C109ACECCA1(iLocal_1044, 1);
	unk_0x3E2A91442BB9855D(iLocal_1044);
	...
	unk_0xD4916ED85412C8D9(uLocal_1118, 1f);
}
...
int func_249(int iParam0, int iParam1, bool bParam2)
{
	...
	if (unk_0x2B1914308D0376C8(iParam0))
	{
		unk_0xD4916ED85412C8D9(uVar0, func_181(unk_0x4B69FB3A5B09A1BA(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xD4916ED85412C8D9(uVar0, func_181(unk_0x4B69FB3A5B09A1BA(), 0.7f, 0.7f));
		unk_0xFEE42298F5E238BE(uVar0, iParam1);
	}
	else if (unk_0xA6C29CC20CD3DCB4(iParam0))
	{
...
void func_250()
{
	...
	while (iVar0 < 3)
	{
		if (!unk_0xE298336AB6E66F7E(Local_1246[iVar0 /*3*/], 5f) && !func_254(iVar0, 6f))
		{
...
float func_252(struct<3> Param0, int iParam3)
{
	return func_26(unk_0x4E6043D225B9C75F(unk_0x2563F6EECD8726D3()), Param0, iParam3);
}

int func_253()
{
	if (func_26(unk_0x9F92518438215DD0(), -1237.566f, -156.8824f, 39.41317f, 1) < 13f)
	{
		return 1;
	}
	return 0;
...
{
	if (unk_0x65473DAE13685EEB(Local_1246[iParam0 /*3*/], fParam1))
	{
		return 1;
	}
	return 0;
...
int func_256()
{
	...
	unk_0x3BC6D217451D6BB7(iLocal_1323);
	if (unk_0x149162179DBAEDB0(iLocal_1323))
	{
		iVar0 = 1;
	}
	else
...
int func_257()
{
	if (((unk_0x746960881FB19A89(uLocal_1048[0]) && unk_0x746960881FB19A89(uLocal_1048[1])) && !unk_0x3E0478C40AB5B38D(uLocal_1048[0])) && !unk_0x3E0478C40AB5B38D(uLocal_1048[1]))
	{
		if (unk_0x44E080690DA76A2A(uLocal_1048[0], iLocal_1310, 0) && unk_0x44E080690DA76A2A(uLocal_1048[1], iLocal_1310, 0))
		{
			return 1;
		}
	}
...
void func_259()
{
	switch (iLocal_1191)
	{
		case 0:
			...
			if (unk_0xFC38B241541883D3(iLocal_1310, 0))
			{
				unk_0x6FD45FA39DD18625(iLocal_1310, 0, 1);
			}
			if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
			{
				if (!unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0))
			...
			func_264();
			func_263();
			unk_0xDD74AAB135833BB7("ASS1_START");
			unk_0xEDB9A377CD8B7F03(&Local_359, 4);
...
int func_262(var uParam0)
{
	...
	*uParam0 = unk_0x86ED1EA56B0ED915(-1221.954f, -210.746f, 38.638f, 27f, 0, 4);
	if (((*uParam0 != 0 && *uParam0 != iLocal_1310) && *uParam0 != iLocal_1311) && *uParam0 != Local_1689.f_4)
	{
		if (unk_0x746960881FB19A89(*uParam0) && !unk_0x0BA451447C3B1A8D(*uParam0))
		{
			if (unk_0xB5BBEB12C77EE430(*uParam0, -1) == 0)
			{
	...
	if (iLocal_1317 != 0)
	{
		if (unk_0x746960881FB19A89(iLocal_1317) && !unk_0x0BA451447C3B1A8D(iLocal_1317))
		{
			...
			{
				Var0 = { unk_0x77009B1C011405A9(iLocal_1317, 1) };
				return 1;
			}
		}
	}
...
void func_263()
{
	...
	while (iVar1 < 3)
	{
		if (!unk_0x746960881FB19A89(uLocal_1048[iVar1]))
		{
			if (iVar1 == 2)
			{
				iVar0 = iLocal_1326;
			...
			uLocal_1048[iVar1] = unk_0xA00B5D954AD320BF(26, iVar0, Local_1266[iVar1 /*3*/], fLocal_1219[iVar1], 1, 1);
			if (iVar1 == 0)
			{
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 0, 0, 2, 0);
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 3, 0, 0, 0);
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 4, 0, 1, 0);
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 8, 0, 0, 0);
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 11, 0, 0, 0);
			}
			else if (iVar1 == 1)
			{
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 0, 1, 2, 0);
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 3, 0, 1, 0);
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 4, 0, 0, 0);
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 8, 0, 0, 0);
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 11, 0, 2, 0);
			}
			else if (iVar1 == 2)
			{
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 0, 1, 2, 0);
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 3, 0, 2, 0);
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 4, 0, 1, 0);
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 8, 0, 0, 0);
				unk_0xB27BF64B02C0107E(uLocal_1048[iVar1], 11, 1, 1, 0);
			}
		}
		if (!unk_0x3E0478C40AB5B38D(uLocal_1048[iVar1]))
		{
			unk_0x0CFE85F88BE373C8(uLocal_1048[iVar1], 0);
			unk_0xE8105B7E3908547D(uLocal_1048[iVar1], 1);
			unk_0x64277E0EB39C1162(uLocal_1048[iVar1], 23, 1);
			unk_0x64277E0EB39C1162(uLocal_1048[iVar1], 30, 0);
			unk_0x79C17B0FEABE87FB(uLocal_1048[iVar1], 2);
			unk_0x9001FCB58244C11D(uLocal_1048[iVar1], 104, 1);
...
void func_264()
{
	func_266();
	func_265();
	unk_0x0880E86251A44B7F(iLocal_1327);
}
...
void func_265()
{
	...
	while (iVar0 < 2)
	{
		if (!unk_0x746960881FB19A89(uLocal_1052[iVar0]))
		{
			if (iVar0 == 0)
			{
				uLocal_1052[iVar0] = unk_0xAD7526C9AA33EE39(iLocal_1311, 26, iLocal_1325, -1, 1, 1);
			}
			else if (iVar0 == 1)
			{
				uLocal_1052[iVar0] = unk_0xAD7526C9AA33EE39(iLocal_1311, 26, iLocal_1326, 0, 1, 1);
			}
			func_247(uLocal_1052[iVar0], 1);
			unk_0x64277E0EB39C1162(uLocal_1052[iVar0], 3, 0);
			unk_0x64277E0EB39C1162(uLocal_1052[iVar0], 23, 1);
			unk_0x64277E0EB39C1162(uLocal_1052[iVar0], 30, 0);
			unk_0x79C17B0FEABE87FB(uLocal_1052[iVar0], 2);
			unk_0xE8105B7E3908547D(uLocal_1052[iVar0], 1);
		}
		iVar0++;
	}
}
...
void func_266()
{
	if (!unk_0x746960881FB19A89(iLocal_1311))
	{
		iLocal_1311 = unk_0xB0694AD0A3BB8936(iLocal_1327, Local_1282, fLocal_1231, 1, 1);
		unk_0xDFA36C740458266A(iLocal_1311, 0);
	}
}

void func_267(int iParam0)
{
	func_268(&(Global_93593.f_2167), &Global_93593, iParam0, 1);
}
	...
	while (iVar0 < 9)
	{
		if (unk_0x746960881FB19A89(Global_87698[iVar0]))
		{
			if (Global_87698[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0xB6A50C909A8FABC3(iParam0) == func_274(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0xFC38B241541883D3(iParam0, 0))
	{
		...
		*uParam1 = unk_0x015D5CDAA9114947(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xEDB9A377CD8B7F03(&(uParam1->f_53), func_277(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_280(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_337(unk_0xC2E9075570B5D2B9(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_330(unk_0xC2E9075570B5D2B9(), 1);
			if (iVar5 != -1)
			{
...
{
	func_282(&Global_93593, unk_0xC2E9075570B5D2B9(), iParam0, uParam1, iParam3, iParam2);
}

void func_282(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_13();
	...
	if (!unk_0x3E0478C40AB5B38D(unk_0x9F92518438215DD0()))
	{
		...
		func_302(unk_0x9F92518438215DD0());
		func_296(unk_0x9F92518438215DD0(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_295())
		{
			func_288(unk_0x9F92518438215DD0(), &(uParam0->f_472[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
void func_284(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_288(int iParam0, var uParam1, int iParam2)
{
	...
	if (!unk_0x3E0478C40AB5B38D(iParam0))
	{
		...
		else if (unk_0x4B69FB3A5B09A1BA() && unk_0xB6A50C909A8FABC3(iParam0) == unk_0xB6A50C909A8FABC3(unk_0x9F92518438215DD0()))
		{
			if (func_292(161, -1))
			{
				uParam1->f_59 = func_289(2039, Global_68104, 0);
			}
			else
			{
				uParam1->f_59 = func_289(744, Global_68104, 0);
			}
			uParam1->f_60 = func_289(745, Global_68104, 0);
			uParam1->f_61 = func_289(746, Global_68104, 0);
		}
...
int func_289(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2454588[iParam0 /*6*/][func_290(iParam1)];
...
int func_292(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2474108[iParam0 /*6*/][func_290(iParam1)];
...
void func_296(int iParam0, bool bParam1)
{
	...
	iVar0 = func_16(iParam0);
	if (func_15(iVar0) && !unk_0x3E0478C40AB5B38D(iParam0))
	{
		if (iParam0 == unk_0x9F92518438215DD0())
		{
			func_297(iParam0, &(Global_97358.f_1729.f_539.f_298[iVar0 /*284*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_297(int iParam0, var uParam1)
{
	...
	if (!unk_0x3E0478C40AB5B38D(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x7F787D5EAAAE2C90(iParam0, func_301(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((unk_0xAC241C22541A2A46(iVar7, &Var9) && !func_298(Var9.f_1)) && iVar70 < 50)
			{
...
int func_306(var uParam0)
{
	if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()) && !unk_0x3E0478C40AB5B38D(unk_0x9F92518438215DD0()))
	{
		if (func_316())
		{
			*uParam0 = func_312(unk_0x77009B1C011405A9(unk_0x9F92518438215DD0(), 0), 5, -1, 0, 1);
...
int func_308(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x4B69FB3A5B09A1BA())
	{
		if (func_310() == 0)
		{
			return unk_0x94E72F17611BCD3C(func_289(func_309(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_312(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 43)
	{
		if (iParam3 == 5 || iParam3 == func_315(iVar0))
		{
			...
			{
				fVar1 = unk_0x91EAD4F2F9B5B38A(Param0, func_313(iVar0), 1);
...
var func_317()
{
	...
	func_327(&uVar0, unk_0xD9940DF735CED1D5());
	func_326(&uVar0, unk_0x00CE62DFC32D8B1E());
	func_325(&uVar0, unk_0x3E15607264E063C3());
	func_320(&uVar0, unk_0xA2C54D866C588926());
	func_319(&uVar0, unk_0x35E06151CD8A2DD1());
	func_318(&uVar0, unk_0x4C625096668FC49E());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_323(unk_0x94E72F17611BCD3C(iParam0, 31), -1, 1)) + 2011;
}
...
int func_335(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_336(Global_97358.f_7341.f_99.f_203[10]);
			break;
		
		case 74:
		case 75:
			return func_336(Global_97358.f_7341.f_99.f_203[8]);
			break;
		
		case 84:
		case 85:
			return func_336(Global_97358.f_7341.f_99.f_203[11]);
			break;
		
		case 90:
			return func_336(Global_97358.f_7341.f_99.f_203[7]);
			break;
		
		case 93:
			return func_336(Global_97358.f_7341.f_99.f_203[9]);
			break;
	}
	return 0;
}
...
void func_339()
{
	...
	if (!unk_0x3E0478C40AB5B38D(unk_0x9F92518438215DD0()))
	{
		...
		if (unk_0x746960881FB19A89(iVar0))
		{
			if (unk_0xFE0FA79BC49EBB07(iVar0, -1214.517f, -158.91f, -39.165f, -1243.589f, -238.784f, 39.165f, 15f, 0, 0, 0) && !unk_0x44E080690DA76A2A(unk_0x9F92518438215DD0(), iVar0, 0))
			{
...
void func_340()
{
	...
	{
		case 0:
			if (func_370(1084227584, 1) || (bLocal_1149 && unk_0xE6F1F0ACBC95D3A0(uLocal_1128)))
			{
				func_369(-1248.398f, -183.366f, 37.72881f, -1216.437f, -196.8727f, 44.07541f, 59.25f, Local_1663, fLocal_1666, 1, 1, 1, 0, 0);
				unk_0x8F9D4AA83F37F6E2(-1220.57f, -185.96f, 38.4f, 50f, 0, 0, 0, 0, 0);
				unk_0x52106E0E9A3B74B8(-1220.57f, -185.96f, 38.4f, 50f, 0);
				func_368();
				func_367();
				if (!unk_0x0BA451447C3B1A8D(iLocal_1310))
				{
					if (unk_0xFC38B241541883D3(iLocal_1310, 0))
					{
						unk_0x62F337D16CFC3C6E(iLocal_1310, 107, "ASSOJva", 1);
						unk_0xD172502A99767BFE(iLocal_1310, 2500f);
					}
				}
				if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
				{
					if (unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0))
					{
						unk_0xF137CB02A3F10019(unk_0x1161215F69587BDA(unk_0x9F92518438215DD0(), 0), "OFF");
					}
				}
				iLocal_1191++;
			}
			else if (unk_0xE6F1F0ACBC95D3A0(uLocal_1128))
			{
			}
			break;
...
int func_341()
{
	...
	switch (iLocal_1192)
	{
		case 0:
			func_366(0, 0, 1);
			func_365();
			unk_0x79DDEE9A5547C864(uLocal_1328, "HAND_SHAKE", 0.2f);
			unk_0x79DDEE9A5547C864(uLocal_1329, "HAND_SHAKE", 0.2f);
			unk_0xA789EBE28A200809(uLocal_1329, uLocal_1328, 6000, 0, 0);
		...
		case 1:
			if (!unk_0x0BA451447C3B1A8D(iLocal_1310))
			{
				if (unk_0xFC38B241541883D3(iLocal_1310, 0))
				{
					...
					{
						if (unk_0x1B277BFA27CD5A9F(iLocal_1310))
						{
							unk_0x0DC4413F65975A4C(iLocal_1310);
						}
						unk_0x62F337D16CFC3C6E(iLocal_1310, 102, "ASSOJva", 1);
						unk_0xD172502A99767BFE(iLocal_1310, 4500f);
						unk_0xADAAE65E52D253A1(iLocal_1310, 1);
						func_229("ASS_VA_SNIPE2", 7500, 1);
						unk_0xD137F1896B8B6A2E(uLocal_1328, -1218.861f, -191.0496f, 38.83616f, 3.519839f, -0.000706f, 42.27108f, 38f, 0, 1, 1, 2);
						unk_0xD5A0D26AB7D86823(uLocal_1328, 0.5f);
						unk_0x8EE833BBF73F1975(uLocal_1328, 7f);
						unk_0x79DDEE9A5547C864(uLocal_1328, "HAND_SHAKE", 0.2f);
						unk_0xD137F1896B8B6A2E(uLocal_1329, -1218.91f, -190.8791f, 38.84585f, 3.519839f, -0.000706f, 43.33815f, 38f, 0, 1, 1, 2);
						unk_0xD5A0D26AB7D86823(uLocal_1329, 0.7f);
						unk_0x8EE833BBF73F1975(uLocal_1329, 10f);
						unk_0x79DDEE9A5547C864(uLocal_1329, "HAND_SHAKE", 0.2f);
						unk_0xA789EBE28A200809(uLocal_1329, uLocal_1328, 2000, 3, 3);
						iLocal_1192++;
					}
				}
			}
		...
		case 2:
			if (!unk_0x0BA451447C3B1A8D(iLocal_1310))
			{
				if (unk_0xFC38B241541883D3(iLocal_1310, 0))
				{
					if (unk_0x2767A2FD649FAEE2(iLocal_1310) >= 7000f)
					{
						unk_0xBDE3D6A0084825C6(iLocal_1310);
						iLocal_1190 = 0;
						while (iLocal_1190 < 3)
						{
							if (!unk_0x0BA451447C3B1A8D(uLocal_1048[iLocal_1190]))
							{
								if (iLocal_1190 == 0)
								{
									iVar0 = 1250;
								...
								if (unk_0xE962BD784DD0E442(uLocal_1048[iLocal_1190], 242628503) != 1)
								{
									unk_0xCD02E3C29B8253A6(&uLocal_1322);
									unk_0xF87DA7F5BA8C7D0F(&uLocal_1322);
									unk_0xF811299AF81DB581(0, iVar0, 0);
									unk_0x27DF0A5AA993D7B6(0, Local_1246[iLocal_1190 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
									unk_0x3179CCC77CBAB31F(uLocal_1322);
									unk_0xC7EBE3C9AC83FAAA(uLocal_1048[iLocal_1190], uLocal_1322);
									unk_0xCD02E3C29B8253A6(&uLocal_1322);
								}
							}
							iLocal_1190++;
		...
		case 3:
			if (unk_0x83666F9FB8FEBD4B() >= 2000)
			{
				...
				{
					unk_0xD137F1896B8B6A2E(uLocal_1328, -1265.549f, -213.4919f, 43.0913f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
					unk_0x79DDEE9A5547C864(uLocal_1328, "HAND_SHAKE", 0.2f);
					unk_0xD137F1896B8B6A2E(uLocal_1329, -1266.063f, -213.922f, 43.0918f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
					unk_0x79DDEE9A5547C864(uLocal_1329, "HAND_SHAKE", 0.2f);
					unk_0xA789EBE28A200809(uLocal_1329, uLocal_1328, 4000, 3, 3);
					iLocal_1215 = 4000;
				}
				else
				{
					unk_0xD137F1896B8B6A2E(uLocal_1328, -1266.193f, -215.217f, 43.2442f, -3.1088f, 0.0498f, -48.5594f, 38f, 0, 1, 1, 2);
					unk_0x79DDEE9A5547C864(uLocal_1328, "HAND_SHAKE", 0.2f);
					unk_0xD137F1896B8B6A2E(uLocal_1329, -1267.53f, -215.7824f, 43.1067f, -9.2365f, 0.0498f, -48.3561f, 38f, 0, 1, 1, 2);
					unk_0x79DDEE9A5547C864(uLocal_1329, "HAND_SHAKE", 0.2f);
					unk_0xA789EBE28A200809(uLocal_1329, uLocal_1328, 4000, 3, 3);
					iLocal_1215 = 4000;
				}
		...
		case 4:
			...
			if (unk_0x83666F9FB8FEBD4B() >= iLocal_1215)
			{
				...
				unk_0x6AC537DA214AB66E(102, "ASSOJva");
				unk_0x6AC537DA214AB66E(107, "ASSOJva");
				unk_0x7B6A36C278A92381(iLocal_1310, 1, 1);
				unk_0x7B6A36C278A92381(iLocal_1310, 0, 1);
				unk_0x7B6A36C278A92381(iLocal_1310, 2, 1);
				unk_0x35611EEE7A1FFEDB(1);
				if (unk_0x6AD0A8B1485375C4() == 4)
				{
				...
				{
					unk_0x5561AF15AEF3E06B(1, 0f, 1, 0);
				}
				func_346(1, 1, 1);
				return 1;
			}
...
void func_342(bool bParam0)
{
	...
	if (unk_0xFC38B241541883D3(iLocal_1310, 0))
	{
		...
		unk_0x6AC537DA214AB66E(102, "ASSOJva");
		unk_0x6AC537DA214AB66E(107, "ASSOJva");
		unk_0xFA51DC22F6E34F6E(iLocal_1310, Local_1288, 1, 0, 0, 1);
		unk_0x03D97EDECF2E1859(iLocal_1310, fLocal_1218);
		unk_0x7B6A36C278A92381(iLocal_1310, 0, 1);
		unk_0x7B6A36C278A92381(iLocal_1310, 1, 1);
		unk_0x7B6A36C278A92381(iLocal_1310, 2, 1);
		unk_0x7B6A36C278A92381(iLocal_1310, 2, 1);
...
{
	if (func_345() && unk_0x17103F66FBB44C3C() >= iParam0 + 1000)
	{
...
void func_348(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (!unk_0x3E0478C40AB5B38D(unk_0x9F92518438215DD0()) && !func_349(unk_0xCFC72E446B0B3AD7()))
		{
...
void func_355()
{
	...
	{
		unk_0x71628E52718BD195(unk_0x9F92518438215DD0());
		unk_0xFA51DC22F6E34F6E(unk_0x9F92518438215DD0(), -1266.173f, -214.0011f, 41.4459f, 1, 0, 0, 1);
		unk_0x03D97EDECF2E1859(unk_0x9F92518438215DD0(), 310.0126f);
	}
}
...
void func_357(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
Vector3 func_361(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
void func_364()
{
	...
	{
		unk_0x71628E52718BD195(unk_0x9F92518438215DD0());
		unk_0xFA51DC22F6E34F6E(unk_0x9F92518438215DD0(), Local_1300, 1, 0, 0, 1);
		unk_0x03D97EDECF2E1859(unk_0x9F92518438215DD0(), 299.4985f);
	}
	if (unk_0x746960881FB19A89(iLocal_1313))
	{
		if (unk_0xFC38B241541883D3(iLocal_1313, 0))
		{
			unk_0x6FD45FA39DD18625(iLocal_1313, 0, 1);
			unk_0xFA51DC22F6E34F6E(iLocal_1313, -1251.873f, -256.7999f, 38.2695f, 1, 0, 0, 1);
			unk_0x03D97EDECF2E1859(iLocal_1313, 296.7603f);
			unk_0x77C765087051EDD6(iLocal_1313);
		}
	}
}
...
int func_365()
{
	iLocal_381 = unk_0x17103F66FBB44C3C();
	return iLocal_381;
}
...
void func_367()
{
	if (unk_0x746960881FB19A89(iLocal_1310))
	{
		if (unk_0xFC38B241541883D3(iLocal_1310, 0))
		{
			...
			while (iLocal_1190 < 3)
			{
				if (!unk_0x746960881FB19A89(uLocal_1048[iLocal_1190]))
				{
					if (iLocal_1190 == 0)
					{
						uLocal_1048[iLocal_1190] = unk_0xAD7526C9AA33EE39(iLocal_1310, 26, iLocal_1325, -1, 1, 1);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 0, 0, 2, 0);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 3, 0, 0, 0);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 4, 0, 1, 0);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 8, 0, 0, 0);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 11, 0, 0, 0);
					}
					else if (iLocal_1190 == 1)
					{
						uLocal_1048[iLocal_1190] = unk_0xAD7526C9AA33EE39(iLocal_1310, 26, iLocal_1325, 0, 1, 1);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 0, 1, 2, 0);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 3, 0, 1, 0);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 4, 0, 0, 0);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 8, 0, 0, 0);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 11, 0, 2, 0);
					}
					else if (iLocal_1190 == 2)
					{
						uLocal_1048[iLocal_1190] = unk_0xAD7526C9AA33EE39(iLocal_1310, 26, iLocal_1326, 1, 1, 1);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 0, 1, 2, 0);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 3, 0, 2, 0);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 4, 0, 1, 0);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 8, 0, 0, 0);
						unk_0xB27BF64B02C0107E(uLocal_1048[iLocal_1190], 11, 1, 1, 0);
					}
				}
				iLocal_1190++;
			}
...
void func_368()
{
	if (!unk_0x746960881FB19A89(iLocal_1310))
	{
		iLocal_1310 = unk_0xB0694AD0A3BB8936(iLocal_1324, Local_1285, fLocal_1217, 1, 1);
		unk_0x0880E86251A44B7F(iLocal_1324);
		unk_0x76369414188E9AC2(iLocal_1310, 1);
		unk_0x512E0C109ACECCA1(iLocal_1310, 1);
		unk_0x4CADBE993729D2BE(iLocal_1310, 1);
	}
}
...
int func_370(int iParam0, int iParam1)
{
	...
	if (((unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0) && func_371(unk_0x1161215F69587BDA(unk_0x9F92518438215DD0(), 0), iParam0, 1, 1056964608, 0, 1)) && !unk_0xFAF3D214E00907D8(unk_0x9F92518438215DD0())) || !unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0))
	{
...
int func_371(int iParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5)
{
...
void func_372()
{
	...
	switch (iLocal_1191)
	{
		...
		case 1:
			func_385();
			if (!unk_0x746960881FB19A89(iLocal_1317))
			{
				if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
				{
					if (unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0))
					{
						...
						{
							iLocal_1317 = unk_0x1161215F69587BDA(unk_0x9F92518438215DD0(), 0);
							if (unk_0x746960881FB19A89(iLocal_1317) && !unk_0x0BA451447C3B1A8D(iLocal_1317))
							{
								func_267(iLocal_1317);
							}
			...
			if (!unk_0x99A27D5F9B887E5F(unk_0xCFC72E446B0B3AD7(), 0))
			{
				if (!func_382())
				{
					if (!unk_0x2E6E8D325977B3EC(uLocal_1117))
					{
						uLocal_1117 = func_381(Local_1300, 1);
						unk_0x2A8C2BEEA4F7041F(uLocal_1117, "ASS_VA_DESTBLIP");
				...
				else if (unk_0xE6F1F0ACBC95D3A0(uLocal_1128) && func_378())
				{
					func_377();
					func_234();
					iLocal_1029 = 8;
...
void func_373()
{
	if (!iLocal_1130)
	{
		...
		{
			func_375();
			uLocal_1128 = unk_0x8BFBA64EB0BC286D(-1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 80f, 12, 127);
			iLocal_1130 = 1;
		}
	}
	else if (func_252(Local_1300, 1) > 120f)
	{
		if (unk_0x03CD2347FEE9BC2F(uLocal_1128))
		{
			unk_0x96ECF2D6A0A83101(uLocal_1128);
			func_242();
			iLocal_1130 = 0;
		}
	}
	else if (!unk_0x03CD2347FEE9BC2F(uLocal_1128))
	{
		if (!func_374())
		{
			iLocal_1130 = 0;
...
void func_375()
{
	unk_0x3BC6D217451D6BB7(iLocal_1325);
	unk_0x3BC6D217451D6BB7(iLocal_1326);
}
...
void func_377()
{
	if (unk_0x2E6E8D325977B3EC(uLocal_1117))
	{
		unk_0x0451B5D93A4BDAA0(&uLocal_1117);
	}
}
...
int func_378()
{
	...
	func_375();
	if (unk_0x149162179DBAEDB0(iLocal_1325) && unk_0x149162179DBAEDB0(iLocal_1326))
	{
		iVar0 = 1;
	}
	else
...
bool func_379(char* sParam0, int iParam1, int iParam2)
{
...
void func_380(var uParam0, struct<3> Param1, float fParam4)
{
	if (unk_0x2E6E8D325977B3EC(*uParam0))
	{
...
int func_382()
{
	...
	if (func_383())
	{
		if (unk_0x41EEB10CCC2497A8(iLocal_1043, Local_1300, 25f, 25f, 90f, 1, 1, 0))
		{
			iVar1 = 1;
		}
	}
	if (unk_0xD092BBE40A1C72AA(unk_0xCFC72E446B0B3AD7()) == 0)
	{
		if ((fVar0 < 2f || unk_0x41EEB10CCC2497A8(iLocal_1043, Local_1300, 2f, 2f, 2f, 1, 1, 0)) || iVar1)
		{
			if (!unk_0xFE0FA79BC49EBB07(unk_0x9F92518438215DD0(), -1141.085f, -192.66f, 75.756f, -1246.085f, -192.66f, 100.756f, 115f, 0, 1, 0))
			{
				if (func_383() && iVar1)
				{
					return 1;
...
int func_383()
{
	...
	{
		iLocal_1313 = unk_0x1161215F69587BDA(unk_0x9F92518438215DD0(), 0);
		iVar0 = unk_0xB6A50C909A8FABC3(iLocal_1313);
...
void func_384()
{
	...
	switch (iLocal_1203)
	{
		case 0:
			...
			unk_0x3BC6D217451D6BB7(joaat("a_f_m_bevhills_01"));
			unk_0x3BC6D217451D6BB7(joaat("a_f_m_bevhills_02"));
			unk_0x3BC6D217451D6BB7(joaat("a_m_y_hipster_01"));
			unk_0x3BC6D217451D6BB7(joaat("taxi"));
			unk_0x33733EEE6375F985("OJAS_HotelTaxi01");
			unk_0xDA293E5084610B09("oddjobs@assassinate@hotel@");
			if ((((((unk_0x149162179DBAEDB0(joaat("a_m_m_bevhills_01")) && unk_0x149162179DBAEDB0(joaat("a_f_m_bevhills_01"))) && unk_0x149162179DBAEDB0(joaat("a_f_m_bevhills_02"))) && unk_0x149162179DBAEDB0(joaat("taxi"))) && unk_0x149162179DBAEDB0(joaat("a_m_y_hipster_01"))) && unk_0x3DA2EED4204CE591("oddjobs@assassinate@hotel@")) && unk_0x2922F456A375F556("OJAS_HotelTaxi01"))
			{
				iLocal_1203++;
			}
			break;
		...
		case 1:
			Local_1689[0] = unk_0xA00B5D954AD320BF(4, joaat("a_f_m_bevhills_01"), -1220.679f, -203.2689f, 38.3251f, 321.2841f, 1, 1);
			Local_1689[1] = unk_0xA00B5D954AD320BF(4, joaat("a_f_m_bevhills_02"), -1219.596f, -201.3663f, 38.3251f, 110.7199f, 1, 1);
			unk_0x4A1AC49BA4A747F7(Local_1689[0], 1);
			unk_0x4A1AC49BA4A747F7(Local_1689[1], 1);
			unk_0xF87DA7F5BA8C7D0F(&uVar0);
			unk_0x402A96371F34E6D8(0, Local_1689[1], -1, 0, 2);
			unk_0x192535C8601D382F(0, "WORLD_HUMAN_TOURIST_MOBILE", -1220.679f, -203.2689f, 38.3251f, 321.2841f, 0, 0, 1);
			unk_0x3179CCC77CBAB31F(uVar0);
			if (!unk_0x0BA451447C3B1A8D(Local_1689[0]))
			{
				unk_0xC7EBE3C9AC83FAAA(Local_1689[0], uVar0);
			}
			unk_0xCD02E3C29B8253A6(&uVar0);
			unk_0xF87DA7F5BA8C7D0F(&uVar0);
			unk_0x402A96371F34E6D8(0, Local_1689[0], -1, 0, 2);
			unk_0x192535C8601D382F(0, "WORLD_HUMAN_TOURIST_MAP", -1219.596f, -201.3663f, 38.3251f, 110.7199f, 0, 0, 1);
			unk_0x3179CCC77CBAB31F(uVar0);
			if (!unk_0x0BA451447C3B1A8D(Local_1689[1]))
			{
				unk_0xC7EBE3C9AC83FAAA(Local_1689[1], uVar0);
			}
			unk_0xCD02E3C29B8253A6(&uVar0);
			Local_1689.f_4 = unk_0xB0694AD0A3BB8936(joaat("taxi"), -1221.73f, -199.0665f, 38.1751f, 152.5038f, 1, 1);
			unk_0x77C765087051EDD6(Local_1689.f_4);
			Local_1689.f_3 = unk_0xAD7526C9AA33EE39(Local_1689.f_4, 4, joaat("a_m_y_hipster_01"), -1, 1, 1);
			unk_0x4A1AC49BA4A747F7(Local_1689.f_3, 1);
			unk_0x402A96371F34E6D8(Local_1689.f_3, Local_1689[0], -1, 0, 2);
			Local_1689.f_8[0] = unk_0xA00B5D954AD320BF(4, joaat("a_m_m_bevhills_01"), -1211.597f, -184.5331f, 38.3255f, 4.5193f, 1, 1);
			Local_1689.f_8[1] = unk_0xA00B5D954AD320BF(4, joaat("a_m_y_hipster_01"), -1211.654f, -182.7625f, 38.3255f, 166.2532f, 1, 1);
			unk_0x4A1AC49BA4A747F7(Local_1689.f_8[0], 1);
			unk_0x4A1AC49BA4A747F7(Local_1689.f_8[1], 1);
			unk_0x7CF15DD8B3815A0D(Local_1689.f_8[0], "oddjobs@assassinate@hotel@", "idle_a", 8f, -4f, -1, 1, 0, 0, 0, 0);
			unk_0x7CF15DD8B3815A0D(Local_1689.f_8[1], "oddjobs@assassinate@hotel@", "argue_b", 8f, -4f, -1, 1, 0, 0, 0, 0);
			Local_1689.f_5[0] = unk_0xA00B5D954AD320BF(4, joaat("a_m_m_bevhills_01"), -1229.099f, -176.3197f, 38.3255f, 231.8036f, 1, 1);
			Local_1689.f_5[1] = unk_0xA00B5D954AD320BF(4, joaat("a_f_m_bevhills_02"), -1249.779f, -162.4767f, 39.4131f, 220.1651f, 1, 1);
			unk_0x4A1AC49BA4A747F7(Local_1689.f_5[0], 1);
			unk_0x4A1AC49BA4A747F7(Local_1689.f_5[1], 1);
			unk_0x7CF15DD8B3815A0D(Local_1689.f_5[0], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
			unk_0x7CF15DD8B3815A0D(Local_1689.f_5[1], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
			Local_1689.f_11 = 1;
			unk_0x0880E86251A44B7F(joaat("a_m_m_bevhills_01"));
			unk_0x0880E86251A44B7F(joaat("a_f_m_bevhills_01"));
			unk_0x0880E86251A44B7F(joaat("a_f_m_bevhills_02"));
...
void func_385()
{
	...
	if (iLocal_1184)
	{
		if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
		{
			fLocal_1243 = unk_0x2A488C176D52CCA5(unk_0x77009B1C011405A9(unk_0x9F92518438215DD0(), 1), Local_1300);
			iLocal_1184 = 0;
		}
	}
...
void func_387()
{
	...
	if (unk_0x746960881FB19A89(iLocal_1056))
	{
		func_392();
		if (!unk_0x3E0478C40AB5B38D(iLocal_1056))
		{
			fVar1 = func_23(iLocal_1056, 1);
			unk_0xF25BFC104A163677(iLocal_1056, 0);
			unk_0x9352BAE0948677D4(iLocal_1056, 0);
			unk_0x0CFE85F88BE373C8(iLocal_1056, 0);
			unk_0x31D76D55E7CE5C71(iLocal_1056, 16);
			unk_0x9001FCB58244C11D(iLocal_1056, 208, 1);
			if (fVar1 < 5f)
			{
			...
			{
				if (unk_0xC7FF9739199F83C9(iLocal_1056) || !unk_0x0FF9FE2CB115CFB9(iLocal_1056))
				{
					func_388();
				}
			}
			switch (iLocal_1189)
			{
				case 0:
					if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
					{
						if ((unk_0x4A4902C6AC8DCB7E(unk_0x9F92518438215DD0()) || (unk_0x746960881FB19A89(iLocal_1056) && unk_0xE99AF5B1B3F0BB7C(iLocal_1056, unk_0x9F92518438215DD0(), 1))) || unk_0xE99AF5B1B3F0BB7C(iLocal_1688, unk_0x9F92518438215DD0(), 1))
						{
							if (unk_0xE99AF5B1B3F0BB7C(iLocal_1688, unk_0x9F92518438215DD0(), 1))
							{
							}
							unk_0xB08BAA85EDA206FD(iLocal_1056, "move_lester_CaneUp", 1048576000);
							unk_0x7CF15DD8B3815A0D(iLocal_1056, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 1000f, -4f, -1, 790536, 0, 0, 0, 0);
							iLocal_1189 = 1;
						}
					}
					break;
				...
				case 1:
					if (unk_0x3C17D9ED0E5F3FCA(iLocal_1056, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 3))
					{
						if (unk_0xD17241758B91AAED(iLocal_1056, "oddjobs@assassinate@hotel@leadin", "Lester_Getup") >= 0.376f)
						{
							unk_0xF87DA7F5BA8C7D0F(&uVar0);
							unk_0x27DF0A5AA993D7B6(0, -1502.029f, -948.687f, 7.65061f, 1f, 20000, 1f, 1, 1193033728);
							unk_0x27DF0A5AA993D7B6(0, -1462.339f, -964.178f, 6.3394f, 1f, -1, 1f, 1, 1193033728);
							unk_0x6A678E26A585E3C6(0, unk_0xE691E4EA6B4440C6(iLocal_1056), 0);
							unk_0x3179CCC77CBAB31F(uVar0);
							unk_0xC7EBE3C9AC83FAAA(iLocal_1056, uVar0);
							unk_0xCD02E3C29B8253A6(&uVar0);
							unk_0xC9FC7EC443B3E63E(iLocal_1056, joaat("MotionState_Walk"), 0, 0, 0);
							iLocal_1189 = 2;
						}
					}
					break;
...
void func_388()
{
	if (unk_0x746960881FB19A89(iLocal_1056))
	{
		unk_0x7763EDCBED8A5840(&iLocal_1056);
	}
}
...
void func_392()
{
	if (unk_0x746960881FB19A89(iLocal_1056))
	{
		if (unk_0xE99AF5B1B3F0BB7C(iLocal_1056, unk_0x9F92518438215DD0(), 1))
		{
			func_31(9);
		}
	}
...
void func_393()
{
	unk_0xDD74AAB135833BB7("ASS1_STOP");
	if (!unk_0x94E72F17611BCD3C(Global_89962.f_20, 13))
	{
		func_462();
	}
	func_394(0, -1, 1);
...
void func_397()
{
	...
	unk_0xDD74AAB135833BB7("ASS1_RESTART1");
	while (!func_378())
	{
		unk_0x4EDE34FBADD967A6(0);
	}
...
void func_399()
{
	uLocal_1314[0] = unk_0xB0694AD0A3BB8936(iLocal_1327, -1270.045f, -251.4953f, 41.4459f, 214.63f, 1, 1);
	uLocal_1314[1] = unk_0xB0694AD0A3BB8936(iLocal_1327, -1265.199f, -218.4823f, 45.9981f, 127.85f, 1, 1);
}

void func_400()
{
	uLocal_1328 = unk_0x0ED114FA9F0CF64D(26379945, -1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
	uLocal_1329 = unk_0x0ED114FA9F0CF64D(26379945, -1243.588f, -251.4826f, 50.3187f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
}
...
int func_401()
{
	...
	iVar0 = 0;
	if (((((((((unk_0x149162179DBAEDB0(iLocal_1324) && unk_0x149162179DBAEDB0(iLocal_1327)) && unk_0x381FCADDEA0C040B(102, "ASSOJva")) && unk_0x381FCADDEA0C040B(107, "ASSOJva")) && unk_0x2922F456A375F556("OJASva_101")) && unk_0x2922F456A375F556("OJASva_101a")) && unk_0x2922F456A375F556("OJASva_104")) && unk_0x3DA2EED4204CE591("ODDJOBS@ASSASSINATE@GUARD")) && unk_0x3DA2EED4204CE591("oddjobs@assassinate@hotel@")) && unk_0x7DE7B5897062BC2C(3))
	{
		iVar0 = 1;
	}
	return iVar0;
...
void func_402()
{
	unk_0x3BC6D217451D6BB7(iLocal_1324);
	unk_0x3BC6D217451D6BB7(iLocal_1327);
	unk_0xDA293E5084610B09("ODDJOBS@ASSASSINATE@GUARD");
	unk_0xDA293E5084610B09("oddjobs@assassinate@hotel@");
	unk_0x9C53AD1E8A38ADEE("ASS_VA", 3);
	unk_0x8E6E37300A0A2B22(102, "ASSOJva");
	unk_0x8E6E37300A0A2B22(107, "ASSOJva");
	unk_0x33733EEE6375F985("OJASva_101");
	unk_0x33733EEE6375F985("OJASva_101a");
	unk_0x33733EEE6375F985("OJASva_104");
}
...
void func_403(bool bParam0)
{
	if (bParam0)
	{
		unk_0xCF023D488D3EAE4D(Vector(39.1642f, -193.934f, -1237.397f) - Vector(150f, 150f, 150f), Vector(39.1642f, -193.934f, -1237.397f) + Vector(150f, 150f, 150f), 0, 1);
		unk_0xE60172AD5C95C90B(-1349.176f, -39.0123f, -100.7554f, -1173.215f, -297.7677f, 100.8606f, 0, 1);
	}
	else
	{
		unk_0xCF023D488D3EAE4D(-1340.905f, -68.1138f, -100.7554f, -1176.622f, -287.8646f, 100.8606f, 1, 1);
		unk_0xA2CF1D8BA5F3BD69(-1349.176f, -39.0123f, -100.7554f, -1173.215f, -297.7677f, 100.8606f, 1);
	}
}
...
void func_404()
{
	...
	unk_0x4B38C66919CC2E48("Guards", &iLocal_1330);
	unk_0xF2061C15946C53A2(1, joaat("COP"), iLocal_1330);
	unk_0xF2061C15946C53A2(1, iLocal_1330, joaat("COP"));
	unk_0xF2061C15946C53A2(5, iLocal_1330, joaat("player"));
	unk_0xF2061C15946C53A2(5, joaat("player"), iLocal_1330);
	unk_0xFC90BEDEE248C76D(-1220.57f, -185.96f, 38.4f, 200f, 1, 0, 0, 0);
	unk_0x24EA77E513B7621A(-1298.684f, -324.0442f, -35.578f, -1113.372f, -46.1583f, 55.609f);
	uLocal_1126 = unk_0x676E460800A9E1B7(Var0 - Vector(15f, 15f, 15f), Var0 + Vector(15f, 15f, 15f), 0, 1, 1, 1);
	uLocal_1127 = unk_0x676E460800A9E1B7(Var3 - Vector(45f, 35f, 35f), Var3 + Vector(45f, 35f, 35f), 0, 1, 1, 1);
}
...
void func_406()
{
	...
	while (iLocal_1190 <= 4)
	{
		uLocal_1225[iLocal_1190] = unk_0x3250987ED5A577C0(0f, 2f);
		iLocal_1190++;
	}
	fLocal_372 = 7000f;
	fLocal_373 = 2000f;
...
void func_407()
{
	...
	{
		case 0:
			unk_0x4CE9C0B6BB26989C("ASS_INT_2_ALT1", 8);
			unk_0x3BC6D217451D6BB7(joaat("ig_lestercrest"));
			unk_0x3BC6D217451D6BB7(joaat("prop_cs_walking_stick"));
			unk_0xDA293E5084610B09("oddjobs@assassinate@hotel@leadin");
			unk_0xDA293E5084610B09("oddjobs@assassinate@hotel@leaning@");
			unk_0xF56FC42B9186CE3F("move_lester_CaneUp");
			unk_0x6EAEC8403384110F(unk_0xCFC72E446B0B3AD7(), 0, 0);
			unk_0x4BAAF4A818239FFF(unk_0xCFC72E446B0B3AD7(), 0);
			if ((((unk_0x149162179DBAEDB0(joaat("ig_lestercrest")) && unk_0x149162179DBAEDB0(joaat("prop_cs_walking_stick"))) && unk_0x3DA2EED4204CE591("oddjobs@assassinate@hotel@leadin")) && unk_0x3DA2EED4204CE591("oddjobs@assassinate@hotel@leaning@")) && unk_0x18E6A43566D33720("move_lester_CaneUp"))
			{
				iLocal_1191++;
			}
			break;
		...
		case 1:
			if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
			{
				...
				unk_0xFC90BEDEE248C76D(-1507.715f, -941.1313f, 8.37286f, 10f, 1, 0, 0, 0);
				unk_0xFA51DC22F6E34F6E(unk_0x9F92518438215DD0(), Local_1667, 1, 0, 0, 1);
				unk_0x03D97EDECF2E1859(unk_0x9F92518438215DD0(), fLocal_1670);
				unk_0xF0875A1DC909B469(unk_0x9F92518438215DD0(), 0, 0);
				unk_0x7CF15DD8B3815A0D(unk_0x9F92518438215DD0(), "oddjobs@assassinate@hotel@leaning@", "idle_a", 1000f, -4f, -1, 513, 0, 0, 0, 0);
				if (!unk_0x5329DB72517417AE(uLocal_1671))
				{
					uLocal_1671 = unk_0x0ED114FA9F0CF64D(26379945, Local_1673, Local_1676, 42.2032f, 1, 2);
					unk_0x79DDEE9A5547C864(uLocal_1671, "HAND_SHAKE", 0.3f);
				}
				if (!unk_0x5329DB72517417AE(uLocal_1672))
				{
					uLocal_1672 = unk_0x0ED114FA9F0CF64D(26379945, Local_1679, Local_1682, 42.2032f, 0, 2);
					unk_0xA789EBE28A200809(uLocal_1672, uLocal_1671, 5000, 1, 1);
					unk_0x79DDEE9A5547C864(uLocal_1671, "HAND_SHAKE", 0.3f);
				}
				unk_0x42DDE752BB6A4CBA(1, 0, 3000, 1, 0, 0);
				if (func_40(0))
		...
		case 2:
			if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
			{
				if (unk_0x3C17D9ED0E5F3FCA(unk_0x9F92518438215DD0(), "oddjobs@assassinate@hotel@leaning@", "idle_a", 3))
				{
		...
		case 4:
			...
			unk_0x717851935436D1B0(iLocal_1056, "Lester", 2, joaat("ig_lestercrest"), 0);
			unk_0x717851935436D1B0(0, "WalkingStick_Lester", 2, joaat("prop_cs_walking_stick"), 0);
		...
		case 6:
			...
			if (!unk_0x746960881FB19A89(iLocal_1056))
			{
				if (unk_0xC7CFFD6593F96B47("Lester", 0))
				{
					if (unk_0x746960881FB19A89(unk_0xC8F47416C1E89E8A("Lester", 0)))
					{
						iLocal_1056 = unk_0x240654B57CFFBFB3(unk_0xC8F47416C1E89E8A("Lester", 0));
					}
				}
			}
			if (!unk_0x746960881FB19A89(iLocal_1057))
			{
				if (unk_0xC7CFFD6593F96B47("WalkingStick_Lester", 0))
				{
					if (unk_0x746960881FB19A89(unk_0xC8F47416C1E89E8A("WalkingStick_Lester", 0)))
					{
						iLocal_1057 = unk_0xC8F47416C1E89E8A("WalkingStick_Lester", 0);
					}
				}
			}
			unk_0x5EF916489F3787FC(0);
			...
			if (unk_0x746960881FB19A89(unk_0xC8F47416C1E89E8A("Lester", 0)))
			{
				...
				{
					if (unk_0x746960881FB19A89(iLocal_1056) && !unk_0x3E0478C40AB5B38D(iLocal_1056))
					{
						unk_0xFA51DC22F6E34F6E(iLocal_1056, -1509.458f, -948.195f, 7.75f, 1, 0, 0, 1);
						unk_0x03D97EDECF2E1859(iLocal_1056, -11f);
						unk_0x7CF15DD8B3815A0D(iLocal_1056, "oddjobs@assassinate@hotel@leadin", "lester_leadin", 1000f, -8f, -1, 790537, 0f, 0, 1, 0);
						unk_0xF0875A1DC909B469(iLocal_1056, 0, 0);
					}
				}
			}
			if (unk_0x746960881FB19A89(unk_0xC8F47416C1E89E8A("Lester", 0)))
			{
				if (unk_0x87E70BB14C5C25EE("WalkingStick_Lester", 0))
				{
					if (unk_0x746960881FB19A89(iLocal_1056) && !unk_0x3E0478C40AB5B38D(iLocal_1056))
					{
						unk_0x80BA810554025DFF(iLocal_1057, iLocal_1056, unk_0xB8BF0926F5E41F7D(iLocal_1056, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					}
				}
			}
			if (unk_0x18E5FE61656F62A0() && !unk_0xC42238EA2EBA3C42())
			{
				func_348(0, 1, 1, 0);
				if (!unk_0x3E0478C40AB5B38D(iLocal_1056))
				{
					unk_0x08B4E5756419497B(iLocal_1056, 0, 0, 0, 0, 0, 0, 0, 0);
					unk_0x29C0F4A5219281BA(iLocal_1056, 1);
				}
				unk_0x5EF916489F3787FC(0);
				unk_0x203B2685C1715644(0, 1065353216);
				if (unk_0x2E9CF5C574019636())
...
void func_409()
{
	if (!unk_0x746960881FB19A89(iLocal_1688))
	{
		iLocal_1688 = unk_0x73A3AED255AF2667(-1510.103f, -947.7194f, 8.2332f, 5f, joaat("prop_bench_08"), 1, 0, 1);
	}
}
				...
				if (unk_0x746960881FB19A89(iVar0))
				{
					if (unk_0xFC38B241541883D3(iVar0, 0))
					{
						if ((iVar0 != iLocal_1318[0] && iVar0 != iLocal_1318[1]) && iVar0 != iLocal_1318[2])
						{
							...
							unk_0x336AE92FD68DEF98(iLocal_1318[iLocal_1214 + 1], 1, 0);
							unk_0x15675A42E7A21B90(iLocal_1318[iLocal_1214 + 1], 0);
							iLocal_1214++;
						}
					}
				}
	...
	if (Local_1689.f_11)
	{
		if (!bLocal_1167)
		{
			if (iLocal_1029 < 10)
			{
				...
				{
					iVar0 = func_30(1116471296, 1);
					if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()) && !unk_0x0BA451447C3B1A8D(iVar0))
					{
...
void func_415(int iParam0, bool bParam1)
{
	...
	if (!unk_0x3E0478C40AB5B38D(iParam0))
	{
		if ((bParam1 && unk_0xE962BD784DD0E442(iParam0, 242628503) != 1) || !bParam1)
		{
			unk_0xF87DA7F5BA8C7D0F(&uVar0);
			unk_0x11C32E558C0429ED(0, -1214.343f, -132.1107f, 40.2416f, 1f, 0, 0, 786603, -1082130432);
...
void func_416()
{
	...
	switch (iLocal_1204)
	{
		case 0:
			...
			{
				if (!unk_0x0BA451447C3B1A8D(Local_1689[0]) && !unk_0x0BA451447C3B1A8D(Local_1689[1]))
				{
					unk_0x402A96371F34E6D8(Local_1689[0], Local_1689[1], -1, 0, 2);
					unk_0x402A96371F34E6D8(Local_1689[1], Local_1689[0], -1, 0, 2);
				}
				if (((unk_0x746960881FB19A89(Local_1689[1]) && unk_0x746960881FB19A89(Local_1689.f_4)) && !unk_0x3E0478C40AB5B38D(Local_1689[1])) && unk_0xFC38B241541883D3(Local_1689.f_4, 0))
				{
					unk_0x32D18ECD9E6F9BE2(Local_1689[1]);
					unk_0x4073360CA020BB84(Local_1689[1], Local_1689.f_4, 20000, 2, 1f, 1, 0);
				}
		...
		case 1:
			if (!iLocal_1172)
			{
				if (func_52(&uLocal_1346))
				{
					...
					{
						if (((unk_0x746960881FB19A89(Local_1689[0]) && unk_0x746960881FB19A89(Local_1689.f_4)) && !unk_0x3E0478C40AB5B38D(Local_1689[0])) && unk_0xFC38B241541883D3(Local_1689.f_4, 0))
						{
							if (unk_0xE962BD784DD0E442(Local_1689[0], -1794415470) != 1)
							{
								unk_0x32D18ECD9E6F9BE2(Local_1689[0]);
								unk_0x4073360CA020BB84(Local_1689[0], Local_1689.f_4, 20000, 1, 1f, 1, 0);
								iLocal_1172 = 1;
							}
						}
					}
			...
			if (!unk_0x3E0478C40AB5B38D(Local_1689[0]) && !unk_0x3E0478C40AB5B38D(Local_1689[1]))
			{
				if (unk_0x44E080690DA76A2A(Local_1689[0], Local_1689.f_4, 0) && unk_0x44E080690DA76A2A(Local_1689[1], Local_1689.f_4, 0))
				{
					if (!unk_0x0BA451447C3B1A8D(Local_1689.f_3) && !unk_0x0BA451447C3B1A8D(Local_1689.f_4))
					{
						unk_0xD2062A6AC314B85E(Local_1689.f_3);
						func_50(&uLocal_1346);
					}
					iLocal_1204++;
				}
		...
		case 2:
			if (func_52(&uLocal_1346))
			{
				if (func_46(&uLocal_1346) > 3f)
				{
					if (!unk_0x3E0478C40AB5B38D(Local_1689.f_3) && unk_0xFC38B241541883D3(Local_1689.f_4, 0))
					{
						unk_0x788DEE284D8ADED5(Local_1689.f_3, Local_1689.f_4, "OJAS_HotelTaxi01", 786485, 0, 16, -1, 10f, 0, 1073741824);
						iLocal_1204++;
					}
				}
			}
		...
		case 3:
			if (!unk_0x0BA451447C3B1A8D(Local_1689.f_3) && !unk_0x0BA451447C3B1A8D(Local_1689.f_4))
			{
				if (!unk_0xA9F3D2C5FC57B2A8(Local_1689.f_4) || iLocal_1175)
				{
					unk_0xAFFE01EF7078CAD9(Local_1689.f_3, Local_1689.f_4, 10f, 786603);
					iLocal_1204++;
				}
			}
			break;
		...
		case 4:
			if (iLocal_1175)
			{
				if (!unk_0x3E0478C40AB5B38D(uLocal_1052[0]))
				{
					iVar0 = uLocal_1052[0];
				}
				else
...
void func_417()
{
	if ((unk_0x746960881FB19A89(Local_1689.f_3) && !unk_0x0BA451447C3B1A8D(Local_1689.f_3)) && !unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
	{
		unk_0x722E6B3A5162A6BB(Local_1689.f_3, unk_0x9F92518438215DD0(), 1000f, -1, 0, 0);
	}
	if ((unk_0x746960881FB19A89(Local_1689[0]) && !unk_0x0BA451447C3B1A8D(Local_1689[0])) && !unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
	{
		unk_0x722E6B3A5162A6BB(Local_1689[0], unk_0x9F92518438215DD0(), 1000f, -1, 0, 0);
		unk_0xA334EDA2335A13CA(Local_1689[0], 2, 0);
	}
	if ((unk_0x746960881FB19A89(Local_1689[1]) && !unk_0x0BA451447C3B1A8D(Local_1689[1])) && !unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
	{
		unk_0x722E6B3A5162A6BB(Local_1689[1], unk_0x9F92518438215DD0(), 1000f, -1, 0, 0);
		unk_0xA334EDA2335A13CA(Local_1689[1], 2, 0);
	}
	if ((unk_0x746960881FB19A89(Local_1689.f_8[0]) && !unk_0x0BA451447C3B1A8D(Local_1689.f_8[0])) && !unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
	{
		unk_0x722E6B3A5162A6BB(Local_1689.f_8[0], unk_0x9F92518438215DD0(), 1000f, -1, 0, 0);
	}
	if ((unk_0x746960881FB19A89(Local_1689.f_8[1]) && !unk_0x0BA451447C3B1A8D(Local_1689.f_8[1])) && !unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
	{
		unk_0x722E6B3A5162A6BB(Local_1689.f_8[1], unk_0x9F92518438215DD0(), 1000f, -1, 0, 0);
	}
	if ((unk_0x746960881FB19A89(Local_1689.f_5[0]) && !unk_0x0BA451447C3B1A8D(Local_1689.f_5[0])) && !unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
	{
		unk_0x722E6B3A5162A6BB(Local_1689.f_5[0], unk_0x9F92518438215DD0(), 1000f, -1, 0, 0);
	}
	if ((unk_0x746960881FB19A89(Local_1689.f_5[1]) && !unk_0x0BA451447C3B1A8D(Local_1689.f_5[1])) && !unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
	{
		unk_0x722E6B3A5162A6BB(Local_1689.f_5[1], unk_0x9F92518438215DD0(), 1000f, -1, 0, 0);
	}
}

int func_418()
{
	if (!unk_0x0BA451447C3B1A8D(Local_1689.f_3))
	{
		if (unk_0xBCBBB7902DEFA79B(Local_1689.f_3))
		{
			if (unk_0x3D93A927E390E214(Local_1689.f_3) == unk_0x9F92518438215DD0())
			{
				return 1;
			}
		}
	}
	if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()) && !unk_0x0BA451447C3B1A8D(Local_1689.f_4))
	{
		if (unk_0x44E080690DA76A2A(unk_0x9F92518438215DD0(), Local_1689.f_4, 0))
		{
			return 1;
		}
	}
	...
	if (unk_0x24E7720869956FA9(-1, -1231.326f, -201.7195f, 38.2114f, 20f))
	{
		return 1;
	}
	return 0;
...
int func_422(struct<3> Param0, float fParam3)
{
	return func_423(&(Global_93593.f_2167), Param0, fParam3, 0);
}

int func_423(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_458(uParam0))
	{
		...
		if (func_457(uParam0))
		{
			...
			if (unk_0x746960881FB19A89(iVar0))
			{
				...
				else if ((!func_446(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && unk_0x6B08EC9A88700FBB(unk_0xC2E9075570B5D2B9(), "startup_positioning"))
				{
...
void func_424(int iParam0, int iParam1)
{
	...
	func_276(iParam0, &(Global_97358.f_18371.f_4742));
}

int func_425(int iParam0)
{
	if ((((((((((!unk_0x746960881FB19A89(iParam0) || !unk_0xFC38B241541883D3(iParam0, 0)) || func_286(iParam0, 0, 0)) || func_286(iParam0, 1, 0)) || func_286(iParam0, 2, 0)) || func_272(iParam0) != 145) || func_436(iParam0)) || func_435(iParam0)) || func_434(iParam0)) || func_433(iParam0)) || !func_426(unk_0xB6A50C909A8FABC3(iParam0)))
	{
		if (func_435(iParam0))
		{
		}
...
void func_440(int iParam0)
{
	...
	if (func_444(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_439(iParam0, 0)) && Global_68047.f_42 == 0) && Global_97358.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] != 0) && Global_97358.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] > 3) && (!func_442(0, Global_67138.f_555[0 /*21*/].f_12) || !func_442(1, Global_67138.f_555[0 /*21*/].f_12)))
			{
				func_441(Global_97358.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/], &Global_68047);
...
void func_441(struct<54> Param0, var uParam54)
{
...
int func_442(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_443(&(Global_97358.f_18371.f_4414[iVar0 /*109*/])))
	{
		return 0;
	}
	return func_427(Global_97358.f_18371.f_4414[iVar0 /*109*/][iParam0 /*54*/].f_42);
}
...
int func_444(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0x94E72F17611BCD3C(uParam0->f_9, 10))
	{
		...
		if (!func_44(Global_97358.f_18371.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_44(Global_97358.f_1729.f_539.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_44(Global_97358.f_1729.f_539.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
int func_446(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_448(iParam0, uVar1[iVar6], 1) && func_447(unk_0x77009B1C011405A9(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam4 || func_44(Param1, 0f, 0f, 0f)) || unk_0x91EAD4F2F9B5B38A(unk_0x77009B1C011405A9(iParam0, 1), unk_0x77009B1C011405A9(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_447(struct<3> Param0, struct<3> Param3, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_450(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0x746960881FB19A89(Global_87698[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0xB6A50C909A8FABC3(Global_87698[iVar0]) == func_274(iParam0, iParam1))
				{
...
void func_451(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (unk_0xFC38B241541883D3(uParam0, 0))
	{
		...
		if (((unk_0x94E72F17611BCD3C(uParam1->f_53, 15) || func_455(iParam0)) || (((uParam1->f_38 == 0 && uParam1->f_39 == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_454())
		{
			uParam1->f_38 = 0;
			uParam1->f_39 = 0;
			uParam1->f_40 = 0;
		...
		if (!unk_0xAAF77E03CD60491E(uParam1->f_42) && !unk_0x567194A60F82D51A(uParam1->f_42))
		{
			...
			while (iVar0 <= 11)
			{
				if (unk_0x94E72F17611BCD3C(uParam1->f_53, func_277(iVar0 + 1)))
				{
					if (!unk_0x364F41CAA0A051EA(iParam0, iVar0 + 1))
					{
...
void func_456(struct<3> Param0, float fParam3, int iParam4)
{
	int iVar0;
...
bool func_459()
{
	return func_457(&(Global_93593.f_2167));
}

void func_460()
{
	func_461(&(Global_93593.f_2167));
}
...
struct<39> func_464(int iParam0)
{
	struct<39> Var0;
...
void func_466()
{
	...
	bVar0 = func_111(Global_97358.f_18217.f_1, 4096);
	Global_97358.f_18217.f_1 = 0;
	if (bVar0)
	{
		func_477(&(Global_97358.f_18217.f_1), 4096);
	}
}
...
bool func_468()
{
	return func_458(&(Global_93593.f_2167));
}
...
void func_470()
{
	...
	unk_0x52AD825A68D804AA("SCRIPT\ASSASSINATION_MULTI");
	func_243();
	func_226();
	func_231();
	func_232(1);
	...
	if (unk_0x746960881FB19A89(Global_86864.f_28[0]))
	{
		...
		unk_0x8FCF30FFEAA1C4D4(&(Global_86864.f_28[0]));
	}
	unk_0xD643E324F7E6A17B(uLocal_1126, 0);
	unk_0xD643E324F7E6A17B(uLocal_1127, 0);
	func_462();
	func_79(&uLocal_1527, 0, 0);
	if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
	{
		func_472(unk_0x9F92518438215DD0(), 1);
		unk_0x8AB186762992E626(unk_0x9F92518438215DD0(), 0, -1, 0);
	}
	unk_0xB1E35D138037D248(1f);
	unk_0x69A5FB1BDF9C17C4();
	unk_0xE821145469AA0ECD(iLocal_1325, 0);
	unk_0xE821145469AA0ECD(iLocal_1326, 0);
	func_471();
...
void func_471()
{
	...
	while (iVar0 < 3)
	{
		if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()) && !unk_0x3E0478C40AB5B38D(unk_0x9F92518438215DD0()))
		{
			...
			{
				unk_0xFA51DC22F6E34F6E(unk_0x9F92518438215DD0(), -1223.185f, -185.4723f, 38.1753f, 1, 0, 0, 1);
				unk_0x03D97EDECF2E1859(unk_0x9F92518438215DD0(), 119.5633f);
			}
		}
		iVar0++;
	}
...
void func_474()
{
	unk_0x6AC537DA214AB66E(102, "ASSOJva");
	unk_0x6AC537DA214AB66E(107, "ASSOJva");
	unk_0x39881B5994C9278A("OJASva_101");
	unk_0x39881B5994C9278A("OJASva_101a");
	unk_0x39881B5994C9278A("OJASva_104");
}
