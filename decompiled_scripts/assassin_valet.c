...
int func_72(int iParam0)
{
	if (iParam0 != func_12())
	{
		...
		else if ((Global_1575054 && iParam0 == unk_0x9E2D6C50374FCFA9()) && func_73(iParam0, 1, 0))
		{
			return Global_2689224[iParam0 /*451*/].f_317.f_6 != -1;
		}
	}
	...
	switch (iLocal_1035)
	{
		...
		case 6:
			...
			if (bLocal_1146)
			{
				...
				{
					func_57(&uLocal_1340, Global_112922.f_19963.f_5);
				}
				iLocal_1213 = func_527();
				if (Global_94157)
				{
	...
	switch (iLocal_1219)
	{
		case 0:
			if (!iLocal_377)
			{
				...
				Global_112922.f_19963.f_5 = func_52(&uLocal_1340);
...
void func_166(bool bParam0)
{
	...
	else if (BitTest(Global_112922.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_168() /*5559*/].f_675.f_10, bParam0))
	{
		bVar0 = true;
		unk_0xB0550BC91B0159D6(&(Global_112922.f_20564.f_471), bParam0);
		unk_0xB0550BC91B0159D6(&(Global_2359296[func_168() /*5559*/].f_675.f_10), bParam0);
	}
	if (bVar0)
	{
...
{
	func_313(&Global_106470, unk_0x05CBA41180F5D521(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_498(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xE5965CDF24F93A9F(Global_97311[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x15CAA6D7B11F1A7C(Global_97311[iVar0]) == func_304(iParam0, iParam1))
				{
...
int func_500(var uParam0, var uParam1, var uParam2)
{
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (unk_0x0DD0BC46C4CFD6AD(*uParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_505(*uParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_504(unk_0x15CAA6D7B11F1A7C(*uParam0), 1) && unk_0x0DD0BC46C4CFD6AD(*uParam0, 24) != func_503(*uParam0, ((*uParam1)[38] - 1)))
	{
...
{
	if (!func_507() && func_506(uParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_513(int iParam0)
{
	if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
	{
		if (!func_519(unk_0x9E2D6C50374FCFA9(), -1))
		{
	...
	if (func_515(unk_0x9E2D6C50374FCFA9()) == 3)
	{
		if (unk_0xE5965CDF24F93A9F(iParam0) && unk_0x55A0C756C4A8220C(iParam0, 0))
		{
...
void func_520(struct<3> Param0, float fParam3, int iParam4)
{
	int iVar0;
...
void func_534()
{
	...
	if (unk_0xE5965CDF24F93A9F(Global_96477.f_28[0]))
	{
		...
		unk_0x59E393B344098656(&(Global_96477.f_28[0]));
	}
	...
	if (!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0))
	{
		func_536(unk_0xE2D3D51028F0428A(), 1);
