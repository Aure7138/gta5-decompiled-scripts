...
int func_2()
{
	...
	if (unk_0x2A488C176D52CCA5(unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1), Local_104) > 100f)
	{
		return 1;
	}
	return 0;
	...
	if (unk_0xD4B321D9096B01FC(iParam0))
	{
		switch (iLocal_82[iParam1])
		{
			case 0:
				...
				if (unk_0x411C065ADB822CD9(iParam0, -1146898486) != 1)
				{
					unk_0xDE8E5CE8855FA963(iParam0, 1193033728, 0);
					unk_0x7D81B41B134BD6F2(iLocal_72[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!unk_0x9591DE0F00127F2A(&(Local_87[iParam1 /*4*/])))
				{
				...
				if (!unk_0xA140C9429D2DC627(iParam0))
				{
					unk_0x40BF84B2C3F30631(iParam0, sVar0, 0, 1);
					unk_0x7D81B41B134BD6F2(iLocal_72[iParam1], 1);
				}
				break;
			...
			case 3:
				...
				if (unk_0x411C065ADB822CD9(iParam0, 1805844857) != 1)
				{
					...
					unk_0xF0E9590A910B74BE(iParam0, unk_0x0FA8183DAD2B3203(), 50f, 20000, 1, 0);
					return 1;
				}
				if (unk_0xB7A628320EFF8E47(unk_0xACE5E491FC1B0D37(iParam0, 1), unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1)) > (50f * 50f))
				{
					iLocal_82[iParam1] = 0;
					return 1;
				}
...
void func_21()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_77)
		{
			...
			if (!unk_0x9591DE0F00127F2A(&(Local_87[iVar0 /*4*/])))
			{
				unk_0x42B7026D73D48D50(&(Local_87[iVar0 /*4*/]));
				if (!unk_0x5F74A266852104C3(&(Local_87[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = unk_0xB983F26E7AFB47BF(4, iLocal_77[iVar0], Local_104 + Local_108[iVar0 /*3*/], 0, 1, 1);
			unk_0x5A2B7C446C0CF087(iLocal_72[iVar0], (fLocal_107 + fLocal_121[iVar0]));
			...
			unk_0x18CD1B73D89ABE21(iLocal_72[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_22()
{
	...
	switch (iLocal_70)
	{
		case 97:
			...
			Local_108[3 /*3*/] = { Vector(45.5004f, unk_0x64A3FFD9D62755C5(-205.8167f, -210.4254f), unk_0x64A3FFD9D62755C5(-1416.54f, -1428.501f)) - Local_104 };
