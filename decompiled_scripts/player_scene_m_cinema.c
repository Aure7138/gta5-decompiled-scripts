...
int func_2()
{
	...
	if (unk_0x2A488C176D52CCA5(unk_0xF4745590D18D14B8(unk_0x06736567F820A39E(), 1), Local_100) > 100f)
	{
		return 1;
	}
	return 0;
	...
	if (unk_0xC1EDB61CE0A4B94E(iParam0))
	{
		switch (iLocal_78[iParam1])
		{
			case 0:
				...
				if (unk_0xFB900D9EE2ACC400(iParam0, -1146898486) != 1)
				{
					unk_0x841E84F12BA2CFC5(iParam0, 1193033728, 0);
					unk_0x97C5D2BB8E47131D(iLocal_68[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!unk_0x226FA58470A21AEF(&(Local_83[iParam1 /*4*/])))
				{
				...
				if (!unk_0xD60AA22BDFBDDD10(iParam0))
				{
					unk_0xD5FDD0DED35FFF91(iParam0, sVar0, 0, 1);
					unk_0x97C5D2BB8E47131D(iLocal_68[iParam1], 1);
				}
				break;
			...
			case 3:
				...
				if (unk_0xFB900D9EE2ACC400(iParam0, 1805844857) != 1)
				{
					...
					unk_0xFEDD46326A41DB46(iParam0, unk_0x06736567F820A39E(), 50f, 20000, 1, 0);
					return 1;
				}
				if (unk_0xB7A628320EFF8E47(unk_0xF4745590D18D14B8(iParam0, 1), unk_0xF4745590D18D14B8(unk_0x06736567F820A39E(), 1)) > (50f * 50f))
				{
					iLocal_78[iParam1] = 0;
					return 1;
				}
...
int func_7(int iParam0, int iParam1)
{
	...
	if (!unk_0xAD79840A082ADD7F())
	{
		...
		else if (iParam1 == func_8(Global_91096) && iParam1 != 0)
		{
			Global_91096 = 0;
		}
	}
...
void func_20()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_73)
		{
			...
			if (!unk_0x226FA58470A21AEF(&(Local_83[iVar0 /*4*/])))
			{
				unk_0x47CCE1B84DDCD2A7(&(Local_83[iVar0 /*4*/]));
				if (!unk_0x04D070195A8178CD(&(Local_83[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_73[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0xB500796AAD639F82(4, iLocal_73[iVar0], Local_100 + Local_104[iVar0 /*3*/], 0, 1, 1);
			unk_0xEF32567B3A5047F5(iLocal_68[iVar0], (fLocal_103 + fLocal_117[iVar0]));
			...
			unk_0x7F075F9DEA8FE763(iLocal_68[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	switch (iLocal_66)
	{
		case 97:
			...
			Local_104[3 /*3*/] = { Vector(45.5004f, unk_0x83D8CBE6E641FA2A(-205.8167f, -210.4254f), unk_0x83D8CBE6E641FA2A(-1416.54f, -1428.501f)) - Local_100 };
