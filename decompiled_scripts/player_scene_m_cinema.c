...
int func_2()
{
	...
	if (unk_0x2A488C176D52CCA5(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_104) > 100f)
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_82[iParam1])
		{
			case 0:
				...
				if (unk_0x16BC17A8EDC701A2(iParam0, -1146898486) != 1)
				{
					...
					unk_0xCBA6B2B569DCAFD8(iLocal_72[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!unk_0x7BCC91F3C1CF24E8(&(Local_87[iParam1 /*4*/])))
				{
			...
			case 3:
				...
				if (unk_0xB7A628320EFF8E47(unk_0x3E4D3CCC220BDFB1(iParam0, 1), unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1)) > (50f * 50f))
				{
					iLocal_82[iParam1] = 0;
					return 1;
				}
...
void func_21()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_77)
		{
			...
			if (!unk_0x7BCC91F3C1CF24E8(&(Local_87[iVar0 /*4*/])))
			{
				unk_0xBE9B3870B1B370E3(&(Local_87[iVar0 /*4*/]));
				if (!unk_0x8DC2EFD1CECAA468(&(Local_87[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = unk_0xB3116B49FE00E2F1(4, iLocal_77[iVar0], Local_104 + Local_108[iVar0 /*3*/], 0, 1, 1);
			unk_0xE922BAA80E8F9324(iLocal_72[iVar0], (fLocal_107 + fLocal_121[iVar0]));
			...
			unk_0x4478D8ED4673EF14(iLocal_72[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_22()
{
	...
	switch (iLocal_70)
	{
		case 97:
			...
			Local_108[3 /*3*/] = { Vector(45.5004f, unk_0x658086F2B3C5E4E4(-205.8167f, -210.4254f), unk_0x658086F2B3C5E4E4(-1416.54f, -1428.501f)) - Local_104 };
