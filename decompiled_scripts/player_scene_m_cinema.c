...
int func_2()
{
	...
	if (unk_0x2A488C176D52CCA5(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1), Local_104) > 100f)
	{
		return 1;
	}
	return 0;
	...
	if (unk_0x765F6FEEFF39224F(iParam0))
	{
		switch (iLocal_82[iParam1])
		{
			case 0:
				...
				if (unk_0xD76D6BCC14B95CE1(iParam0, -1146898486) != 1)
				{
					unk_0xBD4591245C650283(iParam0, 1193033728, 0);
					unk_0x897EF720254BBEA3(iLocal_72[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!unk_0x786AF4A44E1B5B4B(&(Local_87[iParam1 /*4*/])))
				{
				...
				if (!unk_0x9CEB33F9F7FA9FE7(iParam0))
				{
					unk_0xF6D940C3CF409665(iParam0, sVar0, 0, 1);
					unk_0x897EF720254BBEA3(iLocal_72[iParam1], 1);
				}
				break;
			...
			case 3:
				...
				if (unk_0xD76D6BCC14B95CE1(iParam0, 1805844857) != 1)
				{
					...
					unk_0xECCD4FDA45197F97(iParam0, unk_0x33CD235DF1E6A94E(), 50f, 20000, 1, 0);
					return 1;
				}
				if (unk_0xB7A628320EFF8E47(unk_0xFBB1F99A825CAB09(iParam0, 1), unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1)) > (50f * 50f))
				{
					iLocal_82[iParam1] = 0;
					return 1;
				}
...
void func_20()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_77)
		{
			...
			if (!unk_0x786AF4A44E1B5B4B(&(Local_87[iVar0 /*4*/])))
			{
				unk_0x8F59DE352CFE248B(&(Local_87[iVar0 /*4*/]));
				if (!unk_0x07AB0925A06BD5AD(&(Local_87[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = unk_0x9BA5CF280376EEA4(4, iLocal_77[iVar0], Local_104 + Local_108[iVar0 /*3*/], 0, 1, 1);
			unk_0x3C990C409B3845DE(iLocal_72[iVar0], (fLocal_107 + fLocal_121[iVar0]));
			...
			unk_0xC2A270E9C5578803(iLocal_72[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	switch (iLocal_70)
	{
		case 97:
			...
			Local_108[3 /*3*/] = { Vector(45.5004f, unk_0x9562E33C057F7589(-205.8167f, -210.4254f), unk_0x9562E33C057F7589(-1416.54f, -1428.501f)) - Local_104 };
