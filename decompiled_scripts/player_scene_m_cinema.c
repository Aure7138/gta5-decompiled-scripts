...
int func_2()
{
	...
	if (unk_0x2A488C176D52CCA5(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 1), Local_104) > 100f)
	{
		return 1;
	}
	return 0;
	...
	if (unk_0x724D816EA203A79E(iParam0))
	{
		switch (iLocal_82[iParam1])
		{
			case 0:
				...
				if (unk_0xF4FCC3C1048FF2AB(iParam0, -1146898486) != 1)
				{
					unk_0x8CE2798B9A7027EC(iParam0, 1193033728, 0);
					unk_0x22321800954A532E(iLocal_72[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!unk_0xF1734B55490E9045(&(Local_87[iParam1 /*4*/])))
				{
				...
				{
					unk_0xA3A7138EAD2268A0(iParam0, sVar0, 0, 1);
					unk_0x22321800954A532E(iLocal_72[iParam1], 1);
				}
				break;
			...
			case 3:
				...
				if (unk_0xB7A628320EFF8E47(unk_0x541C2AEF053615BC(iParam0, 1), unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 1)) > (50f * 50f))
				{
					iLocal_82[iParam1] = 0;
					return 1;
				}
...
void func_20()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_77)
		{
			...
			if (!unk_0xF1734B55490E9045(&(Local_87[iVar0 /*4*/])))
			{
				unk_0x63831D2D5110C305(&(Local_87[iVar0 /*4*/]));
				if (!unk_0xACE95AD318CE412B(&(Local_87[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = unk_0x01B3635C3E8EDD81(4, iLocal_77[iVar0], Local_104 + Local_108[iVar0 /*3*/], 0, 1, 1);
			unk_0x019CE76D5286C95C(iLocal_72[iVar0], (fLocal_107 + fLocal_121[iVar0]));
			...
			unk_0xF1FC2182A76AD7FC(iLocal_72[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	switch (iLocal_70)
	{
		case 97:
			...
			Local_108[3 /*3*/] = { Vector(45.5004f, unk_0x55AEFCD285ECC0F2(-205.8167f, -210.4254f), unk_0x55AEFCD285ECC0F2(-1416.54f, -1428.501f)) - Local_104 };
