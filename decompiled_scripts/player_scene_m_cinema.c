...
int func_2()
{
	...
	if (unk_0x2A488C176D52CCA5(unk_0xBF8499F46AD9093A(unk_0xA16EC202D9D35357(), 1), Local_99) > 100f)
	{
		return 1;
	}
	return 0;
	...
	if (unk_0x538DF9E5B1DF01EB(iParam0))
	{
		switch (iLocal_77[iParam1])
		{
			case 0:
				...
				if (unk_0x221AC1EF116F6053(iParam0, -1146898486) != 1)
				{
					unk_0xAC9F22F89987627B(iParam0, 1193033728, 0);
					unk_0x2686393074E14730(iLocal_67[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!unk_0x06771AF7795B3ECF(&(Local_82[iParam1 /*4*/])))
				{
					unk_0xB8BA7F44DF1575E1(&(Local_82[iParam1 /*4*/]), &(iLocal_67[iParam1]), 1, 1424);
					iLocal_77[iParam1] = 4;
					return 0;
				}
				if (func_4(iParam0))
				...
				if (!unk_0x8AAB3054688240A9(iParam0))
				{
					unk_0x1DCF0D2934DBC782(iParam0, sVar0, 0, 1);
					unk_0x2686393074E14730(iLocal_67[iParam1], 1);
				}
				break;
			...
			case 3:
				...
				if (unk_0x221AC1EF116F6053(iParam0, 1805844857) != 1)
				{
					...
					unk_0xEA36CC2E7750344B(iParam0, unk_0xA16EC202D9D35357(), 50f, 20000, 1, 0);
					return 1;
				}
				if (unk_0xB7A628320EFF8E47(unk_0xBF8499F46AD9093A(iParam0, 1), unk_0xBF8499F46AD9093A(unk_0xA16EC202D9D35357(), 1)) > (50f * 50f))
				{
					iLocal_77[iParam1] = 0;
					return 1;
				}
...
int func_7(int iParam0, int iParam1)
{
	...
	if (!unk_0xB4B5BF5882A555F9())
	{
		...
		else if (iParam1 == func_8(Global_89828) && iParam1 != 0)
		{
			Global_89828 = 0;
		}
	}
...
void func_20()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_72)
		{
			...
			if (!unk_0x06771AF7795B3ECF(&(Local_82[iVar0 /*4*/])))
			{
				unk_0x19DD85EFF70867D4(&(Local_82[iVar0 /*4*/]));
				if (!unk_0x3EBB3CB89FC2CE55(&(Local_82[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_67)
	{
		if (iLocal_72[iVar0] != 0)
		{
			iLocal_67[iVar0] = unk_0x6F9DE0DE8363ADF1(4, iLocal_72[iVar0], Local_99 + Local_103[iVar0 /*3*/], 0, 1, 1);
			unk_0x34639238667C4381(iLocal_67[iVar0], (fLocal_102 + fLocal_116[iVar0]));
			...
			unk_0x551186C5C186D1DC(iLocal_67[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	func_25(iLocal_65, &Local_99, &fLocal_102, &cVar0);
	Var8.f_1 = -1;
	Var8.f_17 = 4;
	Var8.f_17.f_8 = 4;
	Var8.f_17.f_13 = 4;
	...
	switch (iLocal_65)
	{
		case 97:
			...
			Local_103[3 /*3*/] = { Vector(45.5004f, unk_0x1E253A1A83763D22(-205.8167f, -210.4254f), unk_0x1E253A1A83763D22(-1416.54f, -1428.501f)) - Local_99 };
