...
void func_13()
{
			...
			if (Local_56.f_1 != Global_110890)
			{
				if (!unk_0x5AEB5DDFFAD43CA5(Local_56.f_1))
				{
					...
					if (!unk_0xA26A1295C5145A11(Local_56.f_1) && !unk_0xF83D0A2EC884A4DD(Local_56.f_1, 0))
					{
						...
						{
							if (unk_0xAE06B9E39EBDE049(Local_56.f_0))
							{
								if (unk_0x80FF6C016CDB0FAF(Local_56.f_0, 0))
								{
									if (unk_0xACBCFA3095C5A434(Local_56.f_1, Local_56.f_0))
									{
										unk_0x9DC06E2A59C5AEBB(&uVar0);
										if ((!unk_0xB064AF9925F5537B(Local_56.f_0, 1, 0) || !unk_0xB064AF9925F5537B(Local_56.f_0, 2, 0)) || !unk_0xB064AF9925F5537B(Local_56.f_0, 0, 0))
										{
											unk_0xC67F9BF03C2472AB(0, 2000);
										}
										else
										...
										unk_0xD8C1C38EE8BC2AC6(0, Local_56.f_0, 12f, 790699);
										unk_0x19F29730874AD6F1(uVar0);
	...
	if (unk_0xAE06B9E39EBDE049(Local_56.f_0))
	{
		if (unk_0x1D2A3118784C0272(Local_56.f_0, 0))
		{
			if (Local_56.f_0 != Global_110889)
			{
...
int func_51(int iParam0)
{
	...
	if (!unk_0xA59F96B50B97E63C(iParam0, 0))
	{
		...
		Var9 = { Var3 - Var0 };
		Var12 = { Var6 - Var0 };
		if (unk_0xED4B54A984E6E361(Var9.f_0, Var9.f_1, Var12.f_0, Var12.f_1) < 90f)
		{
			return 1;
		}
	}
...
int func_67()
{
	...
	Var0 = { unk_0x3E4D3CCC220BDFB1(Local_56.f_0, 0) };
	if (!Local_56.f_2)
	{
		if (!Local_56.f_3)
		{
			if (func_68(Var0, Local_56.f_14, Local_56.f_6, &(Local_56.f_17), &(Local_56.f_6)))
			{
				if (!unk_0xA59F96B50B97E63C(Local_56.f_1, 0))
				{
					...
					if (Local_56.f_4)
					{
						unk_0xDEFE57D3575A1A8A(Local_56.f_1, Local_56.f_0, Local_56.f_17, 10f, 0, unk_0x36FE6D3220816ADA(Local_56.f_0), Local_56.f_29, 5f, unk_0x272784C60C397DB6(Var0, Local_56.f_17, 1));
						Local_56.f_4 = 0;
					}
					else
					{
						unk_0x2976DB62CAE67C30(Local_56.f_1, Local_56.f_0, Local_56.f_17, Local_56.f_6, 3, 90f, 1);
					}
				}
				Local_56.f_2 = 1;
			}
		...
		else
		{
			unk_0x8F4C441CE8099187(Local_56.f_1, 0.5f);
			Local_56.f_17 = { Var0 };
			unk_0xDC3073F7CC12181D(Local_56.f_1, Local_56.f_0, 6, 15000);
			Local_56.f_2 = 1;
		}
	}
	else if (!func_19(Local_56.f_1, -272084098))
	{
		if (unk_0xFD7B900D58065E3B(Local_56.f_0))
		{
			unk_0xDC3073F7CC12181D(Local_56.f_1, Local_56.f_0, 1, 1000000);
			return 1;
		}
	}
	else
	{
		...
		{
			if (unk_0xFD7B900D58065E3B(Local_56.f_0) || unk_0xC7D09905123DCFF3(Local_56.f_0))
			{
				unk_0xDC3073F7CC12181D(Local_56.f_1, Local_56.f_0, 1, 1000000);
				return 1;
			}
...
int func_75()
{
	...
	if (!Local_56.f_2)
	{
		...
		{
			unk_0xDEFE57D3575A1A8A(Local_56.f_1, Local_56.f_0, Local_56.f_14, 12f, 0, unk_0x36FE6D3220816ADA(Local_56.f_0), Local_56.f_29, (Local_56.f_7 - 20f), 20f);
			Local_56.f_2 = 1;
		}
	}
	else
	{
		Var0 = { unk_0x3E4D3CCC220BDFB1(Local_56.f_0, 1) };
			...
			if (unk_0x7D167B9A0CCDA347(iLocal_100))
			{
				if (unk_0x7D167B9A0CCDA347(iLocal_99))
				{
					...
					if (func_101(&Var0, &uVar3, &(Local_56.f_8), iVar4, 1103626240))
					{
						...
						{
							Local_56.f_5 = func_77(unk_0x3E4D3CCC220BDFB1(Local_56.f_0, 1), unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1));
							Local_56.f_2 = 0;
							Local_56.f_8 = 0;
							iLocal_53 = 2;
						}
...
int func_107()
{
	...
	if (iLocal_53 == 2 || iLocal_53 == 3)
	{
		...
		if (unk_0xCDF860E56BBCC6B4(Local_56.f_0, unk_0x9B0761B4C3EB8BC7(), 1))
		{
			return 1;
		}
		...
		if (func_38(Local_274, Var0, 20f))
		{
			if (unk_0x2311EB213A0CB707(unk_0x460153A63B9477BC(), Local_56.f_0) || unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), Local_56.f_0))
			{
				return 1;
			}
			if (unk_0x7922FF28ED63354A(unk_0x9B0761B4C3EB8BC7()))
