...
void func_13()
{
			...
			if (Local_56.f_1 != Global_111325)
			{
				if (!unk_0xECEC7528A52B4EE8(Local_56.f_1))
				{
					...
					if (!unk_0x11DBA82F76F3C4C2(Local_56.f_1) && !unk_0x3D28F4F0775C6C2A(Local_56.f_1, 0))
					{
						...
						{
							if (unk_0x419E13582192CFEA(Local_56.f_0))
							{
								if (unk_0xBFCE58B2B3249999(Local_56.f_0, 0))
								{
									if (unk_0x2C10A11A684CFE96(Local_56.f_1, Local_56.f_0))
									{
										unk_0x5C679902079A7E80(&uVar0);
										if ((!unk_0x9B73EB6255D4AE81(Local_56.f_0, 1, 0) || !unk_0x9B73EB6255D4AE81(Local_56.f_0, 2, 0)) || !unk_0x9B73EB6255D4AE81(Local_56.f_0, 0, 0))
										{
											unk_0xC85977CD781454AC(0, 2000);
										}
										else
										...
										unk_0x0509CE092AC81B7C(0, Local_56.f_0, 12f, 790699);
										unk_0x1BBD0A5729AB1226(uVar0);
	...
	if (unk_0x419E13582192CFEA(Local_56.f_0))
	{
		if (unk_0x9984C023D4E57C2E(Local_56.f_0, 0))
		{
			if (Local_56.f_0 != Global_111324)
			{
...
int func_51(int iParam0)
{
	...
	if (!unk_0xE50EB54E0F21BED0(iParam0, 0))
	{
		...
		Var9 = { Var3 - Var0 };
		Var12 = { Var6 - Var0 };
		if (unk_0x6EE46314283D3C7D(Var9.f_0, Var9.f_1, Var12.f_0, Var12.f_1) < 90f)
		{
			return 1;
		}
	}
...
int func_67()
{
	...
	Var0 = { unk_0xD6E677FAD7521410(Local_56.f_0, 0) };
	if (!Local_56.f_2)
	{
		if (!Local_56.f_3)
		{
			if (func_68(Var0, Local_56.f_14, Local_56.f_6, &(Local_56.f_17), &(Local_56.f_6)))
			{
				if (!unk_0xE50EB54E0F21BED0(Local_56.f_1, 0))
				{
					...
					if (Local_56.f_4)
					{
						unk_0xE946751408DFA71B(Local_56.f_1, Local_56.f_0, Local_56.f_17, 10f, 0, unk_0x6471F4759775FCA4(Local_56.f_0), Local_56.f_29, 5f, unk_0x0BABEFEA577FCFA4(Var0, Local_56.f_17, 1));
						Local_56.f_4 = 0;
					}
					else
					{
						unk_0xE7FD307AF3D07EF7(Local_56.f_1, Local_56.f_0, Local_56.f_17, Local_56.f_6, 3, 90f, 1);
					}
				}
				Local_56.f_2 = 1;
			}
		...
		else
		{
			unk_0xA46C42B60F7890E9(Local_56.f_1, 0.5f);
			Local_56.f_17 = { Var0 };
			unk_0x5501AD171E63CFEB(Local_56.f_1, Local_56.f_0, 6, 15000);
			Local_56.f_2 = 1;
		}
	}
	else if (!func_19(Local_56.f_1, -272084098))
	{
		if (unk_0x8879B2803A5F8682(Local_56.f_0))
		{
			unk_0x5501AD171E63CFEB(Local_56.f_1, Local_56.f_0, 1, 1000000);
			return 1;
		}
	}
	else
	{
		...
		{
			if (unk_0x8879B2803A5F8682(Local_56.f_0) || unk_0x670EBC79D84CAC16(Local_56.f_0))
			{
				unk_0x5501AD171E63CFEB(Local_56.f_1, Local_56.f_0, 1, 1000000);
				return 1;
			}
...
int func_75()
{
	...
	if (!Local_56.f_2)
	{
		...
		{
			unk_0xE946751408DFA71B(Local_56.f_1, Local_56.f_0, Local_56.f_14, 12f, 0, unk_0x6471F4759775FCA4(Local_56.f_0), Local_56.f_29, (Local_56.f_7 - 20f), 20f);
			Local_56.f_2 = 1;
		}
	}
	else
	{
		Var0 = { unk_0xD6E677FAD7521410(Local_56.f_0, 1) };
			...
			if (unk_0xA9C0BBFB9CBB66F1(iLocal_100))
			{
				if (unk_0xA9C0BBFB9CBB66F1(iLocal_99))
				{
					...
					if (func_101(&Var0, &uVar3, &(Local_56.f_8), iVar4, 1103626240))
					{
						...
						{
							Local_56.f_5 = func_77(unk_0xD6E677FAD7521410(Local_56.f_0, 1), unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1));
							Local_56.f_2 = 0;
							Local_56.f_8 = 0;
							iLocal_53 = 2;
						}
...
int func_107()
{
	...
	if (iLocal_53 == 2 || iLocal_53 == 3)
	{
		...
		if (unk_0xA6E8FBD68548675F(Local_56.f_0, unk_0x7D2B9E6A64637269(), 1))
		{
			return 1;
		}
		...
		if (func_38(Local_274, Var0, 20f))
		{
			if (unk_0x4140085B99B17F97(unk_0x1146A9AE09CE2B14(), Local_56.f_0) || unk_0x87BE50F80F3FCEAB(unk_0x1146A9AE09CE2B14(), Local_56.f_0))
			{
				return 1;
			}
			if (unk_0x7F716EA884E75E49(unk_0x7D2B9E6A64637269()))
