...
void func_5(int iParam0)
{
	...
	else if (unk_0xA921AA820C25702F(Global_97173.f_23756.f_471, iParam0) || unk_0xA921AA820C25702F(Global_2097152[func_7() /*8053*/].f_5756.f_10, iParam0))
	{
		bVar0 = true;
		unk_0xE80492A9AC099A93(&(Global_97173.f_23756.f_471), iParam0);
		unk_0xE80492A9AC099A93(&(Global_2097152[func_7() /*8053*/].f_5756.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		unk_0x202709F4C58A0424("COUP_RED");
		unk_0xC63CD5D2920ACBE7(func_6(iParam0));
...
bool func_9(int iParam0)
{
	...
	return unk_0xA921AA820C25702F(Global_2097152[func_7() /*8053*/].f_5756.f_10, iParam0);
}
...
int func_12(int iParam0, int iParam1)
{
	...
	if (func_22(&Global_2543745))
	{
		if (func_20(&Global_2543745, iParam0))
		{
			return 0;
		}
		if (func_13(&Global_2543745, iParam0))
		{
			return 1;
		}
	}
...
{
	unk_0x3A618A217E5154F0(0.852f, 0.81f, 0.141f, 0.025f, 0, 0, 0, 175, false);
	func_32(255, 255, 255, 255);
	func_31(0.81f, 0.8f, sParam0, iParam1, 0);
}

void func_31(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)
{
