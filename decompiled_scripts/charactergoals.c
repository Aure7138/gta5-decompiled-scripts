...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		switch (iLocal_18)
		{
			...
			case 2:
				iLocal_23 = unk_0x1ADBAAC322D61F73();
...
void func_1(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_2(Global_101186.f_32651[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_5(int iParam0)
{
	...
	else if (unk_0x7DA173D4FD42F36B(Global_101186.f_25165.f_471, iParam0) || unk_0x7DA173D4FD42F36B(Global_2097152[func_7() /*10510*/].f_7704.f_10, iParam0))
	{
		bVar0 = true;
		unk_0x99BCB15F954AF579(&(Global_101186.f_25165.f_471), iParam0);
		unk_0x99BCB15F954AF579(&(Global_2097152[func_7() /*10510*/].f_7704.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		unk_0x999E5F6D1B49D87B("COUP_RED");
		unk_0x4C5D86B5B659C953(func_6(iParam0));
...
bool func_9(int iParam0)
{
	...
	return unk_0x7DA173D4FD42F36B(Global_2097152[func_7() /*10510*/].f_7704.f_10, iParam0);
}
...
int func_12(int iParam0, int iParam1)
{
	...
	if (func_22(&Global_2568285))
	{
		if (func_20(&Global_2568285, iParam0))
		{
			return 0;
		}
		if (func_13(&Global_2568285, iParam0))
		{
			return 1;
		}
	}
...
void func_16(var uParam0)
{
	...
	func_18(uParam0, (Global_2568284 - 0.5f));
}
...
void func_30(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
	...
	unk_0x1C785DE53446A241(iParam2, 0);
}
...
{
	unk_0xF2277E9F99F5ECC1(0.852f, 0.81f, 0.141f, 0.025f, 0, 0, 0, 175, 0);
...
{
	if (unk_0x98934607F8D0FB03(joaat("appsidetask")) > 0)
	{
		return 0;
	}
	if (func_39() == 0)
...
int func_42(int iParam0, int iParam1, int iParam2)
{
	...
	return func_2(Global_101186.f_32651[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
