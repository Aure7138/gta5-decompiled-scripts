...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		switch (iLocal_18)
		{
			...
			case 2:
				iLocal_23 = unk_0x84A97C70FFDEC0C8();
...
void func_1(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_2(Global_101652.f_26993[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_5(int iParam0)
{
	...
	else if (unk_0xF44A5E894FE76438(Global_101652.f_19507.f_471, iParam0) || unk_0xF44A5E894FE76438(Global_2097152[func_7() /*10730*/].f_7546.f_10, iParam0))
	{
		bVar0 = true;
		unk_0x4EA098C870B73AB7(&(Global_101652.f_19507.f_471), iParam0);
		unk_0x4EA098C870B73AB7(&(Global_2097152[func_7() /*10730*/].f_7546.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		unk_0x053CD3063CA9436C("COUP_RED");
		unk_0xB1953EBEF4D6BD85(func_6(iParam0));
...
bool func_9(int iParam0)
{
	...
	return unk_0xF44A5E894FE76438(Global_2097152[func_7() /*10730*/].f_7546.f_10, iParam0);
}
...
int func_12(int iParam0, int iParam1)
{
	...
	if (func_22(&Global_2595490))
	{
		if (func_20(&Global_2595490, iParam0))
		{
			return 0;
		}
		if (func_13(&Global_2595490, iParam0))
		{
			return 1;
		}
	}
...
void func_16(var uParam0)
{
	...
	func_18(uParam0, (Global_2595489 - 0.5f));
}
...
void func_30(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
	...
	unk_0x9C51EFE6A55E70E2(iParam2, 0);
}
...
{
	unk_0xED5C6BE1E2C9B186(0.852f, 0.81f, 0.141f, 0.025f, 0, 0, 0, 175, 0);
...
{
	if (unk_0xAB964FCFAC3C767A(joaat("appsidetask")) > 0)
	{
		return 0;
	}
	if (func_39() == 0)
...
int func_42(int iParam0, int iParam1, int iParam2)
{
	...
	return func_2(Global_101652.f_26993[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
