...
void __EntryFunction__()
{
	...
	if (func_294(unk_0xE2D3D51028F0428A()))
	{
...
void func_1()
{
	switch (iLocal_145)
	{
		...
		case 1:
			...
			if (!iLocal_160)
			{
				if (func_294(Local_83.f_28[0]) && unk_0xE5965CDF24F93A9F(iLocal_147))
				{
			...
			else if (unk_0xCE2C78E9FC0B01E3(uLocal_149))
			{
				if (unk_0x54DE1614490C2A83(uLocal_149) > 0.29f)
				{
					if (!iLocal_161)
					{
						func_231(&uLocal_163, 2, unk_0xE2D3D51028F0428A(), "Trevor", 0, 1);
				...
				if (func_215(Local_83.f_28[0], unk_0xE2D3D51028F0428A(), 1) > 17.5f)
				{
					if (func_293(Local_83.f_28[0]))
					{
...
void func_235(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()) && !func_239(unk_0x9E2D6C50374FCFA9())) && !func_237(unk_0x9E2D6C50374FCFA9(), 0)) && !func_236()) && !bParam4) && !bParam5)
			{
				unk_0x9210F85E9CD785F1(unk_0xE2D3D51028F0428A(), 0);
			}
		}
		else if (((!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()) && !func_239(unk_0x9E2D6C50374FCFA9())) && !bParam4) && !bParam5)
		{
			unk_0x9210F85E9CD785F1(unk_0xE2D3D51028F0428A(), 0);
		}
		Global_77850 = 0;
		...
		case 1:
			...
			if (unk_0x6F2E1326DB60D575("Josh", 0))
			{
				...
				if (!iLocal_160)
				{
					...
					func_245(unk_0xE2D3D51028F0428A(), -1104.65f, 289.02f, 63.25f, 16.6717f, 0, 1);
					unk_0x080C97B891E2F3AA(0f, 1065353216);
					unk_0x94953C3FF0664F66(0f);
					if (func_294(Local_83.f_28[0]) && unk_0xE5965CDF24F93A9F(iLocal_147))
					{
...
void func_246(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0x3583A42587543334(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0xF96094A43D443C41(func_247(unk_0xB6BA8B8E3D0B41C6()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_260(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
	{
		...
		{
			if (!func_266(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_265(unk_0xE2D3D51028F0428A(), -828834893))
				{
		...
		case 1:
			if (!func_5(0))
			{
				...
				else if (unk_0xCE2C78E9FC0B01E3(uLocal_148))
				{
					...
					if (func_215(unk_0xE2D3D51028F0428A(), Local_83.f_28[0], 1) <= 2.5f)
					{
...
void func_270()
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
		{
			if (func_266(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_290(0) || Global_78121) || Global_78110 == 1) || !unk_0xE9E8955A780DDA01())
	{
		return 0;
	}
	switch (Global_78106)
	{
		...
		case 5:
			if ((unk_0xF34D8FCAE3FD4EE4() || func_275(0)) || func_289(1))
			{
			}
			else
			{
...
void func_323(bool bParam0)
{
	...
	if (!func_340())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_324(unk_0x05CBA41180F5D521(), iVar0);
		}
		else
		{
			if (Global_112002[iVar0 /*10*/].f_9 == -1)
...
int func_325(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_331())
	{
		...
		{
			iVar33 = func_326(unk_0x05CBA41180F5D521());
			if (iVar33 > -1)
			{
