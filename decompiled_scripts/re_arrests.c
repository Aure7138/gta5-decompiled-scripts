...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			case 0:
				if ((unk_0x18544C93469391DA() && !func_115()) && !func_102())
				{
					if (func_99())
					{
						iLocal_48 = 1;
			...
			case 1:
				if (func_95())
				{
					unk_0x4D067011AB7A4264(2551.038f, 4708.613f, 32.6775f, 2536.979f, 5022.179f, 43.8519f, 300f, 0, 1, 1);
...
void func_1()
{
	...
	{
		unk_0xC31A3F1982C7B12B(iLocal_55, 129, 1);
	}
	if (func_81(iLocal_55))
	{
		if (unk_0x910C31F2C06B61D5(iLocal_55, 0))
		{
			bLocal_298 = true;
		}
	}
	if (!unk_0xAF437D7C802AB246(iLocal_54) && (iLocal_49 != 2 && iLocal_49 != 1))
	{
		if (!unk_0xAF437D7C802AB246(iLocal_55))
		{
			switch (iLocal_52)
			{
				case 0:
					unk_0xFEA6925E5471805C("copChasesCriminal", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
					if (unk_0x83666F9FB8FEBD4B() > 10)
					{
						if (!bLocal_74)
						{
							if (unk_0xC47857E5E74EA5AF(iLocal_54, 1227113341) == 7)
							{
								unk_0xD0153915878AE371(iLocal_54, iLocal_55, -1, 1f, 3f, 1073741824, 0);
							}
						}
					}
					if (unk_0x83666F9FB8FEBD4B() > 4000)
					{
						if (!bLocal_74)
						{
							if (unk_0xC47857E5E74EA5AF(iLocal_55, 1805844857) == 7)
							{
								if (unk_0xC47857E5E74EA5AF(iLocal_55, -2017877118) == 1)
								{
									unk_0x94C68C807E25D4C1(iLocal_55, 2, 1);
								}
								unk_0x4B79E06845D63B96(iLocal_55, iLocal_54, 150f, -1, 0, 0);
							}
						}
					}
					fVar4 = unk_0xF18329472591CFE6(unk_0x1141852D07400777(iLocal_54, 1), unk_0x1141852D07400777(iLocal_55, 1), 1);
					if (unk_0x83666F9FB8FEBD4B() > 8000 || fVar4 < 1.5f)
					{
						iVar5 = func_77();
						if (iVar5 == 1)
						{
							unk_0xD0153915878AE371(iLocal_54, iLocal_55, -1, 1f, 0.01f, 1073741824, 0);
						}
					}
					...
					if (unk_0x83666F9FB8FEBD4B() > 2000)
					{
						if (iVar5 || iLocal_278 == 1)
						{
							if (!func_76())
							{
								...
								bLocal_294 = (unk_0x8E2CF6ACCED3BD0F(iLocal_55) || unk_0x0BEB89C5B6DBEA8E(iLocal_55));
								if (!unk_0xFB3EFA6765C8A823(iLocal_54, joaat("weapon_pistol"), 0))
								{
									unk_0xCC897563F1971D6A(iLocal_54, joaat("weapon_pistol"), -1, 0, 1);
								}
								unk_0x36EE5CBF45EC4826(iLocal_54, joaat("weapon_pistol"), 1);
								Local_68 = { unk_0x1141852D07400777(iLocal_55, 1) };
								unk_0xFA2C5C2D054C888E(iLocal_54);
								unk_0x94026C1D1DB14225(&uLocal_73);
								if (!bLocal_294 && fVar4 > 2f)
								{
									unk_0x17CB02C811BE994D(0, Local_68.f_0, Local_68.f_1, (Local_68.f_2 + 4f), 1000, 1566631136);
								}
								unk_0x6A8BCE61F660B8D0(0, iLocal_55, -1, 2048, 2);
								unk_0x8C2752F3FF55C28A(0, iLocal_55, iLocal_55, 1f, 0, 3f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
								unk_0xA02736B50802C8BB(0, iLocal_55, 5000, 0);
								unk_0x911ECBCE73F8EC3F(uLocal_73);
								unk_0xC2C4A3A9FF2FBFFF(iLocal_54, uLocal_73);
								unk_0x33A90AD8FA327B72(&uLocal_73);
								unk_0x29FD5B1A4BA65801(iLocal_54);
								unk_0x8D6671D78D1F569B(iLocal_54, 1);
								unk_0xC1B1E9A034A63A62(0);
								iLocal_246 = unk_0x9D40BBF80D8F5E8A();
								if (bLocal_294)
								{
									unk_0xFA2C5C2D054C888E(iLocal_55);
									unk_0x4BD86B667E57964D(iLocal_55);
									iLocal_52 = 4;
								}
								else
								{
					...
					{
						unk_0xFEA6925E5471805C("copChasesCriminal TIMERA() < 2000", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
					}
					if (unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
					{
						if (!unk_0xAF437D7C802AB246(iLocal_54) && !unk_0x76B2D234F1895632(unk_0xF0295FF51F2D7803(unk_0xE7869D5D7816A9B6(), 0)))
						{
							if (unk_0x3C1B1C07A878AE1D(unk_0xF0295FF51F2D7803(unk_0xE7869D5D7816A9B6(), 0), iLocal_54))
							{
								unk_0xFA2C5C2D054C888E(iLocal_54);
								iLocal_52 = 1;
								unk_0x39FD98334BDB065B(iLocal_54, 500);
							}
						}
					}
					break;
				...
				case 1:
					if (unk_0xC47857E5E74EA5AF(iLocal_54, -982327190) == 7)
					{
						unk_0xD0153915878AE371(iLocal_54, iLocal_55, -1, 1f, 3f, 1073741824, 0);
						iLocal_52 = 0;
					}
				...
				case 2:
					if ((unk_0x9D40BBF80D8F5E8A() - iLocal_246) > 1000)
					{
						Var1 = { 0f, 0f, (unk_0x2CAFFCD9F5E16D2F(iLocal_55) * 3f) };
						unk_0x33E113E52A91C5C3(iLocal_55, Var1, 2f, -1, 1f, 1024, 1193033728);
						iLocal_52 = 3;
					}
					break;
				
				case 3:
					if ((unk_0x9D40BBF80D8F5E8A() - iLocal_246) > 4500)
					{
						iLocal_52 = 4;
					}
					break;
				...
				case 4:
					bLocal_74 = true;
					unk_0x94026C1D1DB14225(&uLocal_73);
					unk_0xDCF460AE46C9489C(0, sLocal_258, "idle_2_hands_up", 2f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0xDCF460AE46C9489C(0, sLocal_258, "kneeling_arrest_idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x911ECBCE73F8EC3F(uLocal_73);
					unk_0xC2C4A3A9FF2FBFFF(iLocal_55, uLocal_73);
					unk_0x33A90AD8FA327B72(&uLocal_73);
					unk_0x29FD5B1A4BA65801(iLocal_55);
					unk_0x8D6671D78D1F569B(iLocal_55, 1);
					unk_0x6E450556B0975D28(iLocal_55, 1);
					iLocal_52 = 5;
					break;
				...
				case 5:
					if (iLocal_50 == 3)
					{
						if (unk_0xC47857E5E74EA5AF(iLocal_54, 242628503) == 7)
						{
							unk_0xFA2C5C2D054C888E(iLocal_54);
							if (!unk_0xFB3EFA6765C8A823(iLocal_54, joaat("weapon_pistol"), 0))
							{
							...
							unk_0x36EE5CBF45EC4826(iLocal_54, joaat("weapon_pistol"), 1);
							unk_0x94026C1D1DB14225(&uLocal_73);
							unk_0xA02736B50802C8BB(0, iLocal_55, -1, 0);
							unk_0x911ECBCE73F8EC3F(uLocal_73);
							unk_0xC2C4A3A9FF2FBFFF(iLocal_54, uLocal_73);
							unk_0x33A90AD8FA327B72(&uLocal_73);
							unk_0x8D6671D78D1F569B(iLocal_54, 1);
				...
				case 6:
					if (unk_0xC45A34912542C4EB(iLocal_57, 0) && !unk_0xAF437D7C802AB246(iLocal_56))
					{
						unk_0x934B5D681061E394(iLocal_57, 1);
						if (unk_0xC47857E5E74EA5AF(iLocal_54, -2017877118) == 7)
						{
							if (unk_0xC47857E5E74EA5AF(iLocal_56, -1273030092) == 7)
							{
								if (unk_0xE8C390D56BE854E1(iLocal_55, iLocal_57, 2, 0, 0))
								{
									if (!unk_0xAF437D7C802AB246(iLocal_55))
									{
										if (!unk_0xF50745B40235B5B8(iLocal_55, iLocal_57))
										{
											if (!unk_0x0930CF2B56CCE2B8(iLocal_55, 0))
											{
												if (unk_0xC47857E5E74EA5AF(iLocal_55, -1794415470) == 7)
												{
													unk_0x94026C1D1DB14225(&uLocal_73);
													unk_0xDCF460AE46C9489C(0, sLocal_258, "kneeling_arrest_get_up", 8f, -2f, -1, 0, 0, 0, 0, 0);
													unk_0x911ECBCE73F8EC3F(uLocal_73);
													unk_0xC2C4A3A9FF2FBFFF(iLocal_55, uLocal_73);
													unk_0x33A90AD8FA327B72(&uLocal_73);
													unk_0xA9CA101B50B90993(0, iLocal_72, iLocal_71);
													unk_0xA9CA101B50B90993(0, iLocal_71, iLocal_72);
												}
											}
										}
									}
									...
									{
										unk_0xB3B7290E7F960AFC(iLocal_54);
										if (!unk_0x0930CF2B56CCE2B8(iLocal_54, 0))
										{
											if (unk_0xC45A34912542C4EB(iLocal_57, 0))
											{
												if (!func_76())
												{
													if (func_66(&uLocal_78, "REARRAU", "REARR_INCAR", 4, iLocal_254, 0, 0))
													{
														...
														{
															if (unk_0xFA68268DB708808B(iLocal_56, iLocal_55, 180f))
															{
														...
														else if (unk_0xFA68268DB708808B(iLocal_56, iLocal_55, 180f))
														{
															Local_295 = { -2.978f, -0.75f, 1f };
														}
														else
														...
														unk_0x94026C1D1DB14225(&uLocal_73);
														unk_0xBE9AFED5018B4A06(0, unk_0xBD306D8AFEF4E078(iLocal_57, Local_295), iLocal_55, 0.75f, 0, 0.5f, 4f, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 60000);
														unk_0xA02736B50802C8BB(0, iLocal_55, -1, 0);
														unk_0x911ECBCE73F8EC3F(uLocal_73);
														unk_0xC2C4A3A9FF2FBFFF(iLocal_54, uLocal_73);
														unk_0x33A90AD8FA327B72(&uLocal_73);
														unk_0x8D6671D78D1F569B(iLocal_54, 1);
														unk_0x821446383BC10D9B(iLocal_57, 0);
														iLocal_244 = 8000;
														unk_0x5AE11BC36633DE4E(0);
														iLocal_277 = unk_0x9D40BBF80D8F5E8A();
														iLocal_52 = 7;
													}
												}
											}
				...
				case 7:
					if (!unk_0xAF437D7C802AB246(iLocal_54))
					{
						if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iLocal_54, 35f, 35f, 35f, 0, 1, 0))
						{
							if ((unk_0x9D40BBF80D8F5E8A() - iLocal_277) > 8000)
							{
								if (!func_76())
								{
									unk_0x6A8BCE61F660B8D0(iLocal_54, unk_0xE7869D5D7816A9B6(), 6000, 2048, 2);
						...
						if (unk_0xC45A34912542C4EB(iLocal_57, 0))
						{
							if (iLocal_64)
							{
								if (func_64(iLocal_54, iLocal_57) == 2)
								{
									unk_0x65682335D54DEA1C(iLocal_55, iLocal_57, -1, 2, 1f, 1, 0);
								}
								else
								{
									unk_0x65682335D54DEA1C(iLocal_55, iLocal_57, -1, 1, 1f, 1, 0);
								}
								iLocal_52 = 8;
							}
							else if (iLocal_63)
							{
								fVar6 = unk_0xF18329472591CFE6(unk_0x1141852D07400777(iLocal_55, 1), unk_0x1141852D07400777(iLocal_57, 1), 1);
								if (fVar6 < 4f && iLocal_285 == 0)
								{
									unk_0xFBBCDB428409716C(iLocal_55, iLocal_57, 60000, 0.5f, Local_295.f_0, Local_295.f_1, 1f, 1);
									iLocal_285 = 1;
								}
								else if (fVar6 < 3f)
								{
							...
							else if (!unk_0x23417CDB252083F9(iLocal_55, sLocal_258, "kneeling_arrest_get_up", 3))
							{
								if (func_64(iLocal_54, iLocal_57) == 2)
								{
								...
								if (bLocal_298)
								{
									unk_0xA8BB37BC9C4A95D4(iLocal_55, "MOVE_M@BAIL_BOND_TAZERED", 1048576000);
								}
								else
								{
									unk_0xA8BB37BC9C4A95D4(iLocal_55, "MOVE_M@BAIL_BOND_NOT_TAZERED", 1048576000);
								}
								iLocal_63 = 1;
							}
						}
					...
					if (unk_0xC45A34912542C4EB(iLocal_57, 0))
					{
						if (!unk_0xAF437D7C802AB246(iLocal_56))
						{
							if (unk_0xF50745B40235B5B8(iLocal_55, iLocal_57))
							{
								...
								if (unk_0xF50745B40235B5B8(iLocal_54, iLocal_57))
								{
									unk_0xE81313E76FEC1E97(iLocal_56, iLocal_57, 10f, 786603);
									unk_0x8D6671D78D1F569B(iLocal_56, 1);
									unk_0x9BEE7E791BC4D38B(iLocal_54, 0);
									func_164();
								}
								else if (unk_0xC47857E5E74EA5AF(iLocal_54, -1794415470) == 7)
								{
									unk_0xFA2C5C2D054C888E(iLocal_54);
									unk_0x65682335D54DEA1C(iLocal_54, iLocal_57, 20000, 0, 1f, 1, 0);
									unk_0x8D6671D78D1F569B(iLocal_54, 1);
								}
							}
						}
		...
		if (!unk_0xAF437D7C802AB246(iLocal_55))
		{
			...
			else
			{
				if (iLocal_49 == 1 || iLocal_49 == 3)
				{
					if (!func_76())
					{
						if (unk_0xF18329472591CFE6(unk_0x1141852D07400777(iLocal_55, 1), unk_0x1141852D07400777(unk_0xE7869D5D7816A9B6(), 1), 1) < 20f)
						{
							func_66(&uLocal_78, "REARRAU", sLocal_274, 4, iLocal_254, 0, 0);
						}
					}
				}
				if (unk_0x23417CDB252083F9(iLocal_55, sLocal_258, "kneeling_arrest_idle", 3))
				{
					unk_0x94026C1D1DB14225(&uLocal_73);
					unk_0xDCF460AE46C9489C(0, sLocal_258, "kneeling_arrest_get_up", 2f, -2f, -1, 0, 0, 0, 0, 0);
				...
				{
					unk_0x4B79E06845D63B96(iLocal_55, unk_0xE7869D5D7816A9B6(), 150f, -1, 0, 0);
					unk_0x8D6671D78D1F569B(iLocal_55, 1);
				}
				unk_0x4EDE34FBADD967A6(0);
				if (iLocal_49 == 0)
...
void func_2()
{
	...
	Var1 = { 40f, 40f, 20f };
	if (unk_0x9D40BBF80D8F5E8A() > iLocal_255 + 1000)
	{
		if (!unk_0xAF437D7C802AB246(iLocal_54))
		{
			if (!unk_0x0E6C083BC5101C8B(iLocal_54, unk_0xE7869D5D7816A9B6(), Var1, 0, 1, 0))
			{
				iVar0++;
			}
		}
		...
		if (!unk_0xAF437D7C802AB246(iLocal_55))
		{
			if (!unk_0x0E6C083BC5101C8B(iLocal_55, unk_0xE7869D5D7816A9B6(), Var1, 0, 1, 0))
			{
				iVar0++;
			}
		}
...
void func_3(bool bParam0)
{
	...
	if (!unk_0xAF437D7C802AB246(iLocal_54))
	{
		switch (iLocal_50)
		{
			case 0:
				if ((iLocal_243 == 3 || iLocal_52 == 5) || iLocal_52 == 6)
				{
					if (!func_76())
					{
						unk_0xFA2C5C2D054C888E(iLocal_54);
						unk_0x94026C1D1DB14225(&uLocal_73);
						unk_0x27ADB0309A9865E0(0, unk_0x1141852D07400777(iLocal_55, 0), 10000, 0, 2);
						unk_0xDCF460AE46C9489C(0, sLocal_258, sVar0, 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0xDCF460AE46C9489C(0, sLocal_258, sVar1, 16f, -8f, -1, 1, 0, 0, 0, 0);
						unk_0x911ECBCE73F8EC3F(uLocal_73);
						unk_0xC2C4A3A9FF2FBFFF(iLocal_54, uLocal_73);
						unk_0x33A90AD8FA327B72(&uLocal_73);
						iLocal_50 = 1;
			...
			case 1:
				if (unk_0x23417CDB252083F9(iLocal_54, sLocal_258, sVar1, 3))
				{
					if (!unk_0xAF437D7C802AB246(iLocal_55))
					{
						if (!func_76())
			...
			case 2:
				if (!func_76())
				{
					if (func_10())
					{
						if (unk_0xC45A34912542C4EB(iLocal_57, 0))
						{
							unk_0xE60F3B685E34342B(iLocal_57, 0);
							unk_0x821446383BC10D9B(iLocal_57, 1);
						}
						unk_0xFA2C5C2D054C888E(iLocal_54);
						unk_0x94026C1D1DB14225(&uLocal_73);
						unk_0xDCF460AE46C9489C(0, sLocal_258, sVar2, 8f, -1.5f, -1, 0, 0, 0, 0, 0);
						unk_0x911ECBCE73F8EC3F(uLocal_73);
						unk_0xC2C4A3A9FF2FBFFF(iLocal_54, uLocal_73);
						unk_0x33A90AD8FA327B72(&uLocal_73);
						unk_0xA573D5E64CDFAF83(iLocal_54, 0, 0);
						func_8();
						iLocal_50 = 3;
					}
				}
			...
			case 3:
				...
				if (unk_0xD51CFE69539DB6D8(iLocal_55) || !unk_0x76B2D234F1895632(iLocal_55))
				{
					if (unk_0x3C1B1C07A878AE1D(unk_0xE7869D5D7816A9B6(), iLocal_55))
					{
						if (!func_76())
						{
				...
				if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iLocal_54, 35f, 35f, 35f, 0, 1, 0))
				{
					unk_0x8207E3ADD67AFA6E(iLocal_54, 1, unk_0xE7869D5D7816A9B6(), 31086, 0f, 0f, 0f, 0, -1, -1);
					unk_0x8207E3ADD67AFA6E(unk_0xE7869D5D7816A9B6(), 1, iLocal_54, 31086, 0f, 0f, 0f, 0, -1, -1);
					if (unk_0xC9D9444186B5A374() > iLocal_244 || iLocal_262)
					{
						if (iLocal_49 == 3 || iLocal_49 == 0)
						{
							if (!unk_0xAF437D7C802AB246(iLocal_55))
							{
								...
								{
									unk_0x6A8BCE61F660B8D0(iLocal_54, unk_0xE7869D5D7816A9B6(), 500, 2048, 2);
									func_66(&uLocal_78, "REARRAU", "REARR_PLEAVE", 4, iLocal_254, 0, 0);
									iLocal_244 = 8000;
								}
							}
						...
						else
						{
							...
							else if (!func_76())
							{
								unk_0x6A8BCE61F660B8D0(iLocal_54, unk_0xE7869D5D7816A9B6(), 6000, 2048, 2);
								func_66(&uLocal_78, "REARRAU", "REARR_PLEAVE", 4, iLocal_254, 0, 0);
								iLocal_244 = unk_0x0ADD324BC46177EF(8, 22);
								iLocal_244 *= 30000;
							}
							unk_0x5AE11BC36633DE4E(0);
						}
				...
				if (iLocal_52 != 8)
				{
					if (unk_0xC45A34912542C4EB(iLocal_57, 0))
					{
						if (!unk_0xAF437D7C802AB246(iLocal_55))
						{
							if (!unk_0x8AF655CC5761C7A2(iLocal_55, iLocal_57, 0))
							{
								func_63();
							}
						}
...
void func_4()
{
	if (!iLocal_262)
	{
		...
		unk_0x94026C1D1DB14225(&uLocal_73);
		unk_0xDCF460AE46C9489C(0, sLocal_259, "enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0xDCF460AE46C9489C(0, sLocal_259, sLocal_260, 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0xDCF460AE46C9489C(0, sLocal_259, "exit", 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0xDCF460AE46C9489C(0, sLocal_258, "kneeling_arrest_idle", 8f, -8f, -1, 9, 0, 0, 0, 0);
		unk_0x911ECBCE73F8EC3F(uLocal_73);
		unk_0xC2C4A3A9FF2FBFFF(iLocal_55, uLocal_73);
		unk_0x33A90AD8FA327B72(&uLocal_73);
		iLocal_262 = 1;
	}
	else if (unk_0x23417CDB252083F9(iLocal_55, sLocal_259, "enter", 3))
	{
		if (func_5())
		{
	...
	else if (unk_0x23417CDB252083F9(iLocal_55, sLocal_259, "exit", 3))
	{
	}
	else if (unk_0x23417CDB252083F9(iLocal_55, sLocal_259, sLocal_260, 3))
	{
...
int func_5()
{
	if (unk_0x9D40BBF80D8F5E8A() > iLocal_264 + 6000)
	{
...
void func_6()
{
	...
	{
		unk_0x94026C1D1DB14225(&uLocal_73);
		unk_0xDCF460AE46C9489C(0, sLocal_258, "radio_enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0xDCF460AE46C9489C(0, sLocal_258, "radio_chatter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0xDCF460AE46C9489C(0, sLocal_258, "radio_exit", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		unk_0xA02736B50802C8BB(0, iLocal_55, -1, 0);
		unk_0x911ECBCE73F8EC3F(uLocal_73);
		unk_0xC2C4A3A9FF2FBFFF(iLocal_54, uLocal_73);
		unk_0x33A90AD8FA327B72(&uLocal_73);
	...
	else if (unk_0x23417CDB252083F9(iLocal_54, sLocal_258, "radio_chatter", 3))
	{
		if (func_5())
		{
	...
	else if (unk_0x23417CDB252083F9(iLocal_54, sLocal_258, "radio_exit", 3))
	{
		iLocal_263 = 0;
		func_8();
	}
	...
	switch (iLocal_51)
	{
		case 0:
			if (!bLocal_74)
			{
				...
				unk_0x76B2D234F1895632(iLocal_54);
				unk_0x76B2D234F1895632(iLocal_55);
				if (unk_0xD51CFE69539DB6D8(iLocal_54) && unk_0xD51CFE69539DB6D8(iLocal_55))
				{
					unk_0xFBBCDB428409716C(iLocal_54, iLocal_55, -1, 3f, 0f, 0f, 1f, 0);
				}
				unk_0x5AE11BC36633DE4E(0);
			}
			break;
		...
		case 2:
			if (unk_0xC45A34912542C4EB(iLocal_57, 0))
			{
				if ((unk_0x9D40BBF80D8F5E8A() - iLocal_291) > 20000)
				{
					if (!unk_0xAF437D7C802AB246(iLocal_56))
					{
						if (unk_0xC47857E5E74EA5AF(iLocal_56, -1273030092) == 7)
						{
							unk_0x65682335D54DEA1C(iLocal_54, iLocal_57, -1, 0, 1f, 1, 0);
							iLocal_51 = 3;
						}
					}
				}
...
int func_10()
{
	...
	if (unk_0x5053BF6D5604065B(iVar12))
	{
		if (unk_0x534DA90AB4BE425C(unk_0x1141852D07400777(iLocal_54, 0), 1, &Var0, 1, 1077936128, 0))
		{
			if (unk_0xD8D6AD49486DB74C(&Var0, &Var6, &uVar9, 0f, 180f, 50f, 1, 1, 1))
			{
				iLocal_57 = unk_0xD504D1FF5DD2FFD7(iVar12, Var6, 0, 1, 1);
				iLocal_56 = unk_0xF430A9686E704FA3(iLocal_57, 6, joaat("s_m_y_ranger_01"), -1, 1, 1);
				unk_0x1C26C4B0DAB91B21(iLocal_56, 294, 1);
				if (!unk_0xFB3EFA6765C8A823(iLocal_56, joaat("weapon_pistol"), 0))
				{
					unk_0xCC897563F1971D6A(iLocal_56, joaat("weapon_pistol"), -1, 0, 1);
				}
				unk_0x36EE5CBF45EC4826(iLocal_56, joaat("weapon_pistol"), 1);
				unk_0x690C5239500171FE(iLocal_56, iLocal_71);
				unk_0x18F90CF5D756C783(iLocal_57, 3);
				unk_0x9BEE7E791BC4D38B(iLocal_56, 1);
				unk_0xC9CEB5227A733CE6(iLocal_57);
				unk_0x12F88FDE652A5758(iLocal_57, 1);
				unk_0x8734A10B003ED2B6(iLocal_57, 1);
				Var0 = { unk_0x1141852D07400777(iLocal_57, 1) };
				Var3 = { unk_0x1141852D07400777(unk_0xE7869D5D7816A9B6(), 1) - Var0 };
				unk_0x151F32CB40BE730C(iLocal_57, unk_0x2C393A56EDEECDE4(Var3.f_0, Var3.f_1));
				unk_0x534DA90AB4BE425C(unk_0x1141852D07400777(iLocal_54, 0), 1, &Var0, 1, 1077936128, 0);
				if (unk_0xF18329472591CFE6(Var0, 2528.563f, 2639.115f, 36.9446f, 1) < 75f)
				{
					Var0 = { 2473.601f, 2496.765f, 40.87f };
				}
				if (unk_0xF18329472591CFE6(2538.71f, 2592.007f, 36.9446f, Var0, 1) < 16f)
				{
					Var0 = { 2473.601f, 2496.765f, 40.87f };
				}
				unk_0x6187AAA1BF80C7C3(iLocal_56, iLocal_57, Var0, 4, 7f, 786471, 5f, -1f, 1);
				unk_0xA299DFC4364AB573(iLocal_57, 4f);
				unk_0x821446383BC10D9B(iLocal_57, 1);
				iLocal_77 = 1;
...
int func_11()
{
	...
	{
		case 0:
			if (unk_0xC47857E5E74EA5AF(iLocal_54, 242628503) == 7 || unk_0x9D40BBF80D8F5E8A() > iLocal_246 + 15000)
			{
				if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iLocal_54, 25f, 25f, 25f, 0, 1, 0))
				{
					if (!unk_0xAF437D7C802AB246(iLocal_54))
					{
						unk_0xFA2C5C2D054C888E(iLocal_54);
						...
						{
							unk_0xD0153915878AE371(0, iLocal_55, -1, 3.5f, 2f, 1073741824, 0);
						}
		...
		case 1:
			if (unk_0xC47857E5E74EA5AF(iLocal_54, 242628503) == 1)
			{
				if (unk_0x229936D409069998(iLocal_54) > 0)
				{
					if (!func_76())
					{
						if (iLocal_245 < 2)
		...
		case 2:
			...
			unk_0x58F62EDF6111D598(iLocal_54, unk_0xE7869D5D7816A9B6(), 100);
			break;
...
void func_12()
{
	...
	bVar0 = unk_0x915685CA559C211B(iLocal_55, unk_0xE7869D5D7816A9B6(), 1);
	bVar1 = func_48();
	if (bVar1)
	{
	}
		...
		if (!bVar0)
		{
			if (!bVar1)
			{
				if (iLocal_49 == 2 || bLocal_74 == 1)
				{
					...
					{
						case 8:
							unk_0xFEA6925E5471805C("criminal_thanks 8", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
							unk_0x4ADC112587E95B61(uLocal_59, 1);
							if (!unk_0x76B2D234F1895632(iLocal_55) && unk_0x23417CDB252083F9(iLocal_55, sLocal_258, "kneeling_arrest_idle", 3))
							{
								unk_0x94026C1D1DB14225(&uLocal_73);
								unk_0xDCF460AE46C9489C(0, sLocal_258, "kneeling_arrest_get_up", 8f, -8f, -1, 0, 0, 0, 0, 0);
								unk_0x911ECBCE73F8EC3F(uLocal_73);
								unk_0xC2C4A3A9FF2FBFFF(iLocal_55, uLocal_73);
								unk_0x33A90AD8FA327B72(&uLocal_73);
								iLocal_247 = 9;
						...
						case 9:
							unk_0xFEA6925E5471805C("criminal_thanks 9", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
							if (unk_0xC47857E5E74EA5AF(iLocal_55, 242628503) == 7)
							{
								iLocal_247 = 0;
							}
							break;
						...
						case 0:
							unk_0xFEA6925E5471805C("criminal_thanks 0", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
							if (unk_0x0E6C083BC5101C8B(iLocal_55, unk_0xE7869D5D7816A9B6(), 75f, 75f, 75f, 0, 1, 0))
							{
								unk_0x3AE219FD480C0ED6(iLocal_55, 1);
								iLocal_247 = 3;
							}
							break;
						
						case 1:
							unk_0xFEA6925E5471805C("criminal_thanks 1", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
							if (unk_0x3761EA7F8628B81A(iLocal_55, unk_0x1141852D07400777(iLocal_54, 0), 4f, 4f, 3f, 0, 1, 0))
							{
								iLocal_247 = 2;
							}
							else
							{
								unk_0xFA2C5C2D054C888E(iLocal_55);
								unk_0x94026C1D1DB14225(&uLocal_73);
								unk_0x27ADB0309A9865E0(0, unk_0x1141852D07400777(iLocal_54, 0), 1000, 0, 2);
								unk_0x33E113E52A91C5C3(0, unk_0x1141852D07400777(iLocal_54, 0), 2f, -1, 3f, 0, 1193033728);
								unk_0x911ECBCE73F8EC3F(uLocal_73);
								unk_0xC2C4A3A9FF2FBFFF(iLocal_55, uLocal_73);
								unk_0x33A90AD8FA327B72(&uLocal_73);
								iLocal_247 = 2;
						...
						case 2:
							unk_0xFEA6925E5471805C("criminal_thanks 2", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
							if (unk_0x3761EA7F8628B81A(iLocal_55, unk_0x1141852D07400777(iLocal_54, 0), 4f, 4f, 3f, 0, 1, 0))
							{
								if (unk_0xC47857E5E74EA5AF(iLocal_55, 242628503) == 7 || func_66(&uLocal_78, "REARRAU", sLocal_271, 4, iLocal_254, 0, 0))
								{
									iLocal_247 = 6;
								}
							}
							else if (unk_0xC47857E5E74EA5AF(iLocal_55, 242628503) == 7)
							{
								unk_0x94026C1D1DB14225(&uLocal_73);
								unk_0x27ADB0309A9865E0(0, unk_0x1141852D07400777(iLocal_54, 0), 1000, 0, 2);
								unk_0x33E113E52A91C5C3(0, unk_0x1141852D07400777(iLocal_54, 0), 2f, -1, 3f, 0, 1193033728);
						...
						case 3:
							unk_0xFEA6925E5471805C("criminal_thanks 3", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
							if (unk_0x0E6C083BC5101C8B(iLocal_55, unk_0xE7869D5D7816A9B6(), 5f, 5f, 3f, 0, 1, 0))
							{
								iLocal_247 = 4;
							}
							else if (unk_0x0E6C083BC5101C8B(iLocal_55, unk_0xE7869D5D7816A9B6(), 75f, 75f, 75f, 0, 1, 0))
							{
								if (!func_76())
								{
									unk_0xFA2C5C2D054C888E(iLocal_55);
									unk_0x94026C1D1DB14225(&uLocal_73);
									unk_0xD0153915878AE371(0, unk_0xE7869D5D7816A9B6(), -1, 8f, 2f, 1073741824, 0);
									unk_0x911ECBCE73F8EC3F(uLocal_73);
									unk_0xC2C4A3A9FF2FBFFF(iLocal_55, uLocal_73);
									unk_0x33A90AD8FA327B72(&uLocal_73);
									iLocal_247 = 4;
						...
						case 4:
							unk_0xFEA6925E5471805C("criminal_thanks 4", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
							if (unk_0x0E6C083BC5101C8B(iLocal_55, unk_0xE7869D5D7816A9B6(), 9f, 9f, 9f, 0, 1, 0))
							{
						...
						case 7:
							unk_0xFEA6925E5471805C("criminal_thanks 7", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
							if (!unk_0x1022821BCC621056(iLocal_55, unk_0xE7869D5D7816A9B6()))
							{
								unk_0x6A8BCE61F660B8D0(iLocal_55, unk_0xE7869D5D7816A9B6(), -1, 2064, 2);
							}
							if (!unk_0xFA68268DB708808B(iLocal_55, unk_0xE7869D5D7816A9B6(), 30f))
							{
								unk_0x58F62EDF6111D598(iLocal_55, unk_0xE7869D5D7816A9B6(), -1);
							}
							if ((unk_0x9D40BBF80D8F5E8A() - iLocal_292) > 2000)
							{
								iLocal_247 = 5;
							}
							break;
						...
						case 5:
							unk_0xFEA6925E5471805C("criminal_thanks 5", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
							if (unk_0x23417CDB252083F9(iLocal_55, sLocal_258, "Thanks_Male_05", 3) || unk_0xC47857E5E74EA5AF(iLocal_55, 242628503) == 7)
							{
								if (!func_76())
								{
									if (iLocal_245 < 2)
									{
										...
										unk_0xDCF460AE46C9489C(iLocal_55, sLocal_258, "Thanks_Male_05", 16f, -16f, -1, 16, 0, 0, 0, 0);
									}
									else
									{
									...
									unk_0x44C7AD5B54E267EE(iLocal_55);
									iLocal_247 = 6;
								}
							}
							break;
						...
						case 6:
							unk_0xFEA6925E5471805C("criminal_thanks 6", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
							if (!func_76())
							{
								unk_0x4B79E06845D63B96(iLocal_55, unk_0xE7869D5D7816A9B6(), 150f, -1, 0, 0);
								func_164();
...
void func_15(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_16(Global_99155.f_32499[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_48()
{
	...
	if (unk_0xC45A34912542C4EB(iLocal_57, 0))
	{
		if (unk_0x0E6C083BC5101C8B(iLocal_57, iLocal_55, fVar0, fVar0, fVar0, 0, 1, 0))
		{
			return 1;
		}
	}
	iVar1 = unk_0x421E6299B34E6001(unk_0x1141852D07400777(iLocal_55, 0), fVar0, fVar0, fVar0, -1);
	if (!unk_0xAF437D7C802AB246(iVar1))
	{
		if (unk_0x1B2DC87EFB36DF80(iVar1) == joaat("s_f_y_cop_01") || unk_0x1B2DC87EFB36DF80(iVar1) == joaat("s_m_y_cop_01"))
		{
			return 1;
		}
	}
	...
	iVar2 = unk_0x11EF3EB1EF47F297(unk_0x1141852D07400777(iLocal_55, 0), fVar0, 0, 1024);
...
void func_49()
{
	...
	if (!unk_0xAF437D7C802AB246(iLocal_55))
	{
		bVar0 = unk_0x3C1B1C07A878AE1D(unk_0xE7869D5D7816A9B6(), iLocal_55);
		uVar1 = unk_0x915685CA559C211B(iLocal_55, unk_0xE7869D5D7816A9B6(), 1);
		if (((uVar1 || func_62()) || func_60()) || bVar0)
		{
			func_59();
			if (bLocal_74)
			{
				if (((bVar0 || uVar1) && !unk_0x8E2CF6ACCED3BD0F(iLocal_55)) && !unk_0x51374A0BB2871E6E(iLocal_55, 0))
				{
					unk_0xFA2C5C2D054C888E(iLocal_55);
					unk_0x5F0FEFB9EF0F238E(iLocal_55, 500, 2000, 0, 0, 0, 0);
					unk_0xC2EA5B4B2052D2F1(iLocal_55, -1);
					unk_0x8D6671D78D1F569B(iLocal_55, 1);
				}
				else if (!unk_0x51374A0BB2871E6E(iLocal_55, 0) && !unk_0x8E2CF6ACCED3BD0F(iLocal_55))
				{
					unk_0xFA2C5C2D054C888E(iLocal_55);
					unk_0xC2EA5B4B2052D2F1(iLocal_55, -1);
					unk_0x8D6671D78D1F569B(iLocal_55, 1);
				...
				if (!func_76())
				{
					if (!unk_0xAF437D7C802AB246(iLocal_54) && iLocal_286 == 0)
					{
	...
	else
	{
		...
		func_59();
		if (unk_0x915685CA559C211B(iLocal_55, unk_0xE7869D5D7816A9B6(), 1))
		{
			if (bLocal_74)
			{
				func_55(1);
	...
	if (!unk_0xAF437D7C802AB246(iLocal_54))
	{
		...
		if (unk_0xD51CFE69539DB6D8(iLocal_56))
		{
			if (!unk_0xAF437D7C802AB246(iLocal_56))
			{
				if ((unk_0x915685CA559C211B(iLocal_56, unk_0xE7869D5D7816A9B6(), 1) && unk_0x8219941CC4732B36(iLocal_56) < 190) || (unk_0x915685CA559C211B(iLocal_56, unk_0xE7869D5D7816A9B6(), 1) && unk_0x8E2CF6ACCED3BD0F(iLocal_56)))
				{
					iVar2 = 1;
				}
				if (unk_0xD51CFE69539DB6D8(iLocal_57) && unk_0x915685CA559C211B(iLocal_57, unk_0xE7869D5D7816A9B6(), 1))
				{
					iVar2 = 1;
				}
			}
		...
		if ((((((unk_0x915685CA559C211B(iLocal_54, unk_0xE7869D5D7816A9B6(), 1) && unk_0x8219941CC4732B36(iLocal_54) < 190) || func_53()) || unk_0x51AFBB2BC4E2AAFD(unk_0x3F80C6638E3A1A90(), 0)) || func_52()) || (unk_0x915685CA559C211B(iLocal_54, unk_0xE7869D5D7816A9B6(), 1) && unk_0x8E2CF6ACCED3BD0F(iLocal_54))) || iVar2 == 1)
		{
			func_55(1);
	...
	if (!unk_0xAF437D7C802AB246(iLocal_54) && !unk_0xAF437D7C802AB246(iLocal_55))
	{
		if (unk_0x915685CA559C211B(iLocal_54, unk_0xE7869D5D7816A9B6(), 1) && unk_0x915685CA559C211B(iLocal_55, unk_0xE7869D5D7816A9B6(), 1))
		{
			if (unk_0x8219941CC4732B36(iLocal_54) < 190 && unk_0x8219941CC4732B36(iLocal_55) < 190)
			{
				func_59();
				func_55(1);
				iLocal_49 = 1;
		...
		if (!unk_0x0E6C083BC5101C8B(iLocal_55, iLocal_54, 110f, 110f, 40f, 0, 1, 0))
		{
			if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iLocal_54, 20f, 20f, 20f, 0, 1, 0))
			{
				func_50();
				unk_0x4EDE34FBADD967A6(0);
				func_66(&uLocal_78, "REARRAU", "REARR_PORUN", 4, iLocal_254, 0, 0);
			}
			else if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iLocal_55, 40f, 40f, 40f, 0, 1, 0))
			{
				func_50();
				unk_0x4EDE34FBADD967A6(0);
	...
	if (unk_0xAF437D7C802AB246(iLocal_55))
	{
		if (!unk_0xAF437D7C802AB246(iLocal_54))
		{
			if (!unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iLocal_54, 100f, 100f, 40f, 0, 1, 0))
			{
				func_164();
			}
		}
...
bool func_52()
{
	...
	if (unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
	{
		...
		if (unk_0xC45A34912542C4EB(iLocal_57, 0))
		{
			if (unk_0x3C1B1C07A878AE1D(unk_0xF0295FF51F2D7803(unk_0xE7869D5D7816A9B6(), 0), iLocal_57))
			{
				bVar0 = true;
			}
		}
...
int func_53()
{
	...
	Var0 = { 3f, 3f, 3f };
	Var3 = { -3f, -3f, -3f };
	if (unk_0x742CA22C114D89E4(unk_0x5D551231E967CD2B(iLocal_54, 31086, 0f, 0f, 0f), 0.5f, 1))
	{
		if (unk_0xAF437D7C802AB246(iLocal_55))
		{
			return 1;
		}
		else if (!unk_0x742CA22C114D89E4(unk_0x5D551231E967CD2B(iLocal_55, 31086, 0f, 0f, 0f), 2f, 1))
		{
			return 1;
		}
	}
	if (unk_0x7D7A581CD9045B46(unk_0x5D551231E967CD2B(iLocal_54, 31086, 0f, 0f, 0f), 3f))
	{
		return 1;
	}
	if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iLocal_54, 5f, 5f, 5f, 0, 1, 0))
	{
		if (!unk_0xAF437D7C802AB246(iLocal_54))
		{
			if (unk_0x386C3192F791D414(unk_0x3F80C6638E3A1A90(), iLocal_54) || unk_0xBC273BCD46110BE6(unk_0x3F80C6638E3A1A90(), iLocal_54))
			{
				if (unk_0x5E99B63A819500A5(unk_0xE7869D5D7816A9B6(), &iVar6, 1))
				{
		...
		if (!unk_0xAF437D7C802AB246(iLocal_55))
		{
			if (unk_0x386C3192F791D414(unk_0x3F80C6638E3A1A90(), iLocal_55) || unk_0xBC273BCD46110BE6(unk_0x3F80C6638E3A1A90(), iLocal_55))
			{
				if (unk_0x5E99B63A819500A5(unk_0xE7869D5D7816A9B6(), &iVar6, 1))
				{
					if (iVar6 != joaat("weapon_unarmed"))
	...
	Var0 = { Var0 + unk_0x5D551231E967CD2B(iLocal_54, 31086, 0f, 0f, 0f) };
	Var3 = { Var3 + unk_0x5D551231E967CD2B(iLocal_54, 31086, 0f, 0f, 0f) };
	if (((unk_0xE31E0B1502061553(Var3, Var0, joaat("weapon_smokegrenade"), 1) || unk_0xE31E0B1502061553(Var3, Var0, joaat("weapon_grenade"), 1)) || unk_0xE31E0B1502061553(Var3, Var0, joaat("weapon_stickybomb"), 1)) || unk_0xE31E0B1502061553(Var3, Var0, joaat("vehicle_weapon_tank"), 1))
	{
		return 1;
	}
	return 0;
...
void func_55(int iParam0)
{
	if (!unk_0xAF437D7C802AB246(iLocal_54))
	{
		...
		if (!bLocal_61)
		{
			...
			unk_0x6FF6F40CA433340F(unk_0x3F80C6638E3A1A90(), 0);
			unk_0x321C1AA209172C00(iLocal_54, 1);
			if (unk_0xD11595488376CB53(uLocal_58))
			{
				unk_0x4ADC112587E95B61(uLocal_58, 0);
			}
			if (iParam0 == 1)
			{
				if (!unk_0xAF437D7C802AB246(iLocal_55))
				{
					if (unk_0xC47857E5E74EA5AF(iLocal_55, 1805844857) == 7)
					{
						...
						{
							unk_0x94026C1D1DB14225(&uLocal_73);
							unk_0xDCF460AE46C9489C(0, sLocal_258, "kneeling_arrest_escape", 8f, -8f, -1, 4096, 0, 0, 0, 0);
							unk_0x4B79E06845D63B96(0, iLocal_54, 150f, -1, 0, 0);
							unk_0x911ECBCE73F8EC3F(uLocal_73);
							unk_0xC2C4A3A9FF2FBFFF(iLocal_55, uLocal_73);
							unk_0x33A90AD8FA327B72(&uLocal_73);
							unk_0x29F3FAC40F745C80(iLocal_55, joaat("MotionState_Run"), 0, 0, 0);
							unk_0x8D6671D78D1F569B(iLocal_55, 1);
						}
						else
						{
				...
				if ((!unk_0x76B2D234F1895632(iLocal_55) && !unk_0xAF437D7C802AB246(iLocal_55)) && !unk_0x76B2D234F1895632(unk_0xE7869D5D7816A9B6()))
				{
					if (unk_0xF18329472591CFE6(unk_0x1141852D07400777(iLocal_55, 1), unk_0x1141852D07400777(unk_0xE7869D5D7816A9B6(), 1), 1) < 20f)
					{
						if (!func_76())
			...
			if (unk_0xC45A34912542C4EB(iLocal_57, 0))
			{
				unk_0x18F90CF5D756C783(iLocal_57, 1);
			}
			func_57();
			unk_0x4EDE34FBADD967A6(0);
			unk_0x4EDE34FBADD967A6(0);
...
void func_56()
{
	if (unk_0xD51CFE69539DB6D8(iLocal_56))
	{
		if (!unk_0xAF437D7C802AB246(iLocal_56))
		{
			...
			unk_0x13C351F151D49F89(0, unk_0xE7869D5D7816A9B6(), 0, 16);
			unk_0x911ECBCE73F8EC3F(uLocal_73);
			unk_0xC2C4A3A9FF2FBFFF(iLocal_56, uLocal_73);
			unk_0x33A90AD8FA327B72(&uLocal_73);
			unk_0x8D6671D78D1F569B(iLocal_56, 1);
			unk_0x5D04A2BDCC04FCAE(iLocal_56, 1, 0);
		}
	}
}
...
void func_59()
{
	if (!unk_0xAF437D7C802AB246(iLocal_55))
	{
		if (unk_0xD11595488376CB53(uLocal_59))
		{
			unk_0x4ADC112587E95B61(uLocal_59, 0);
		}
		unk_0x29FD5B1A4BA65801(iLocal_55);
	}
}
...
int func_60()
{
	if (!unk_0x76B2D234F1895632(iLocal_54))
	{
		if (bLocal_74)
		{
			if (unk_0x3C1B1C07A878AE1D(unk_0xE7869D5D7816A9B6(), iLocal_54))
			{
				if ((unk_0x9D40BBF80D8F5E8A() - iLocal_276) > 1000)
				{
					func_61();
				}
			}
...
int func_62()
{
	if (unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
	{
		if (unk_0x3C1B1C07A878AE1D(unk_0xF0295FF51F2D7803(unk_0xE7869D5D7816A9B6(), 0), iLocal_55))
		{
			if (bLocal_74)
			{
				if (iLocal_52 != 7)
				{
					if (unk_0x2A488C176D52CCA5(unk_0x1141852D07400777(iLocal_55, 1), Local_68) > 2.5f)
					{
						return 1;
					}
				}
	...
	if (bLocal_74)
	{
		if (unk_0x3C1B1C07A878AE1D(unk_0xE7869D5D7816A9B6(), iLocal_55))
		{
			if (unk_0x8E2CF6ACCED3BD0F(iLocal_55))
			{
				if (iLocal_52 != 7)
				{
					if (unk_0x2A488C176D52CCA5(unk_0x1141852D07400777(iLocal_55, 1), Local_68) > 2.5f)
		...
		switch (iLocal_245)
		{
			...
			case 1:
				if (!func_76())
				{
					if (!unk_0xAF437D7C802AB246(iLocal_55))
					{
						...
						unk_0x8D6671D78D1F569B(iLocal_55, 1);
						unk_0x09714949CF524B00(iLocal_55, 101);
			...
			case 2:
				if (!unk_0xAF437D7C802AB246(iLocal_54))
				{
					if (!unk_0xAF437D7C802AB246(iLocal_55))
					{
						unk_0xA9CA101B50B90993(2, iLocal_72, iLocal_71);
						unk_0xA9CA101B50B90993(2, iLocal_71, iLocal_72);
						unk_0x13C351F151D49F89(iLocal_54, iLocal_55, 0, 16);
					}
					else
					{
						unk_0x5EE92E5069683596(iLocal_54, 1193033728, 0);
						func_164();
					}
					unk_0x8D6671D78D1F569B(iLocal_54, 1);
				}
...
int func_64(int iParam0, int iParam1)
{
	...
	if (unk_0xC45A34912542C4EB(iParam1, 0))
	{
		...
		Var3 = { unk_0xBD306D8AFEF4E078(iParam1, 1f, -0.5f, 0f) };
		Var9 = { Var3 - Var0 };
		Var6 = { unk_0xBD306D8AFEF4E078(iParam1, -1f, -0.5f, 0f) };
		Var12 = { Var6 - Var0 };
...
void func_65()
{
	if (!func_76())
	{
		if (!iLocal_293)
		{
			if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iLocal_54, 30f, 30f, 30f, 0, 1, 0))
			{
		...
		{
			if (unk_0x0ADD324BC46177EF(0, 99) > 50)
			{
				func_66(&uLocal_78, "REARRAU", "REARR_PRAND", 4, iLocal_254, 0, 0);
			}
			else if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iLocal_55, 10f, 10f, 10f, 0, 1, 0))
			{
				func_66(&uLocal_78, "REARRAU", sLocal_268, 4, iLocal_254, 0, 0);
			}
			else if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iLocal_54, 10f, 10f, 10f, 0, 1, 0))
			{
				func_66(&uLocal_78, "REARRAU", sLocal_268, 4, iLocal_254, 0, 0);
			}
			else
...
int func_77()
{
	if (unk_0x0E6C083BC5101C8B(iLocal_55, iLocal_54, 3.5f, 3.5f, 3.5f, 0, 1, 0) || func_80())
	{
...
int func_78(float fParam0)
{
	...
	if (unk_0x9A7D0B2F6566231C(unk_0x1141852D07400777(iLocal_55, 1), &uVar0, &Var1))
	{
...
void func_82()
{
	if ((unk_0x9D40BBF80D8F5E8A() - iLocal_253) > 500)
	{
		if ((iLocal_49 != 1 && iLocal_49 != 3) && iLocal_49 != 2)
		{
			if (unk_0xD11595488376CB53(uLocal_59))
			{
				unk_0x4ADC112587E95B61(uLocal_59, iLocal_248);
				if (iLocal_248 == 1)
				{
					iLocal_248 = 0;
				}
		...
		if (!bLocal_61)
		{
			if (unk_0xD11595488376CB53(uLocal_58))
			{
				unk_0x4ADC112587E95B61(uLocal_58, iLocal_249);
				if (iLocal_249 == 1)
				{
					iLocal_249 = 0;
				}
	...
	if (!bLocal_289 == bLocal_288)
	{
		if (bLocal_288)
		{
			if (unk_0xD11595488376CB53(uLocal_59))
			{
				unk_0x9C9B069F802F9A20(uLocal_59, 1);
			}
			if (unk_0xD11595488376CB53(uLocal_58))
			{
				unk_0x9C9B069F802F9A20(uLocal_58, 1);
			}
		}
		else
		{
			if (unk_0xD11595488376CB53(uLocal_59))
			{
				unk_0x9C9B069F802F9A20(uLocal_59, 0);
			}
			if (unk_0xD11595488376CB53(uLocal_58))
			{
				unk_0x9C9B069F802F9A20(uLocal_58, 0);
			}
		}
...
int func_83(float fParam0)
{
	...
	if (unk_0x22E902D6AF27E232(unk_0xE7869D5D7816A9B6(), Local_279, Local_282, 194.75f, 0, 1, 0))
	{
		return 1;
	}
	if (!unk_0xAF437D7C802AB246(iLocal_54))
	{
		if (unk_0x0E6C083BC5101C8B(iLocal_54, unk_0xE7869D5D7816A9B6(), Var2, 0, 1, 0))
		{
			iVar0 = 1;
		}
		else
	...
	if (!unk_0xAF437D7C802AB246(iLocal_55))
	{
		if (unk_0x0E6C083BC5101C8B(iLocal_55, unk_0xE7869D5D7816A9B6(), Var2, 0, 1, 0))
		{
			iVar0 = 1;
		}
		else
...
int func_84(int iParam0)
{
	if (func_89())
	{
		...
		if (func_88(Global_99144))
		{
			func_85(0);
		}
		unk_0xFB04AECD5A11A220(1, "RE_TITLE");
		if (iParam0 && func_88(Global_99144))
		{
...
int func_89()
{
	switch (func_90(&Global_25093, 0, 5, 0, unk_0xE3E113B4DB09AAF8()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_93(iParam0, Global_35619);
}
...
int func_95()
{
	...
	if (!unk_0xAF437D7C802AB246(iLocal_54))
	{
		if (!unk_0xAF437D7C802AB246(iLocal_55))
		{
			if ((unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iLocal_54, fVar0, fVar0, fVar0, 0, 1, 0) || unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iLocal_55, fVar0, fVar0, fVar0, 0, 1, 0)) || unk_0x22E902D6AF27E232(unk_0xE7869D5D7816A9B6(), Local_279, Local_282, 194.75f, 0, 1, 0))
			{
				if (!unk_0xD11595488376CB53(uLocal_59))
				{
...
int func_97(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xFC630C7120A34CE4(uVar0, func_98(unk_0x00AAD79B42B3E036(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xFC630C7120A34CE4(uVar0, func_98(unk_0x00AAD79B42B3E036(), 0.7f, 0.7f));
		unk_0x4ADC112587E95B61(uVar0, bParam1);
	}
...
int func_99()
{
	...
	unk_0x801429C020C467BA(joaat("prop_ld_binbag_01"));
	unk_0x2B0BB514F9140141(sLocal_258);
	unk_0x2B0BB514F9140141(sLocal_259);
	unk_0x5FC34204E17B27E0("MOVE_M@BAIL_BOND_NOT_TAZERED");
	unk_0x5FC34204E17B27E0("MOVE_M@BAIL_BOND_TAZERED");
	if ((((((unk_0x5053BF6D5604065B(iVar0) && unk_0x5053BF6D5604065B(iVar1)) && unk_0x5053BF6D5604065B(joaat("prop_ld_binbag_01"))) && unk_0x2917D5E1CB5CE43A(sLocal_258)) && unk_0x2917D5E1CB5CE43A(sLocal_259)) && unk_0x05416FE34E390CB7("MOVE_M@BAIL_BOND_NOT_TAZERED")) && unk_0x05416FE34E390CB7("MOVE_M@BAIL_BOND_TAZERED"))
	{
		iLocal_54 = unk_0xA7F4088D9A2629CC(6, iVar0, Var2, fVar8, 1, 1);
		unk_0x1C26C4B0DAB91B21(iLocal_54, 294, 1);
		unk_0x5D04A2BDCC04FCAE(iLocal_54, 1, 0);
		unk_0x6E450556B0975D28(iLocal_54, 1);
		unk_0x9BEE7E791BC4D38B(iLocal_54, 1);
		func_101(&uLocal_78, 1, iLocal_54, "ArrestCop", 0, 1);
		unk_0xC602CB510D8B9EAE(iLocal_54, 1);
		unk_0x20A7731B1904C2E6(iLocal_54, 1);
		iLocal_55 = unk_0xA7F4088D9A2629CC(26, iVar1, Var5, fVar9, 1, 1);
		unk_0x5D04A2BDCC04FCAE(iLocal_55, 1, 0);
		unk_0x1C26C4B0DAB91B21(iLocal_55, 42, 1);
		unk_0x1C26C4B0DAB91B21(iLocal_55, 281, 1);
		unk_0x9BEE7E791BC4D38B(iLocal_55, 1);
		func_101(&uLocal_78, 2, iLocal_55, sLocal_265, 0, 1);
		unk_0xC602CB510D8B9EAE(iLocal_55, 1);
		if (iLocal_53 == 1)
		{
			unk_0x497AFDFE79EEFE4F(iLocal_55, 0, 0, 2, 0);
			unk_0x497AFDFE79EEFE4F(iLocal_55, 2, 0, 0, 0);
			unk_0x497AFDFE79EEFE4F(iLocal_55, 3, 2, 0, 0);
			unk_0x497AFDFE79EEFE4F(iLocal_55, 4, 0, 0, 0);
		}
		func_100();
		if (func_43() == 0)
		{
			func_101(&uLocal_78, 0, unk_0xE7869D5D7816A9B6(), "MICHAEL", 0, 1);
		}
		else if (func_43() == 1)
		{
			func_101(&uLocal_78, 0, unk_0xE7869D5D7816A9B6(), "FRANKLIN", 0, 1);
		}
		else if (func_43() == 2)
		{
			func_101(&uLocal_78, 0, unk_0xE7869D5D7816A9B6(), "TREVOR", 0, 1);
		}
		if (!unk_0xFB3EFA6765C8A823(iLocal_54, joaat("weapon_pistol"), 0))
		{
			unk_0xCC897563F1971D6A(iLocal_54, joaat("weapon_pistol"), -1, 0, 1);
		...
		unk_0x36EE5CBF45EC4826(iLocal_54, joaat("weapon_pistol"), 1);
		uLocal_60 = unk_0x8C15E6EC0BC9B4BE(joaat("prop_ld_binbag_01"), Local_65.f_0, Local_65.f_1, (Local_65.f_2 + 100f), 1, 1, 0);
		unk_0x60365B5AF8BF1FFA(uLocal_60, 0, 0);
		if (unk_0x2A488C176D52CCA5(2411.32f, 4958.76f, 45.19f, Local_65) < 10f)
		{
			iLocal_53 = 1;
			unk_0x94026C1D1DB14225(&uLocal_73);
			unk_0xEF557F8B8E594B2F(0, 2473.254f, 4901.651f, 43.1488f, 3f, -1, 2f, 1, Local_250, 1193033728);
			unk_0x4B79E06845D63B96(0, iLocal_54, 150f, -1, 0, 0);
			unk_0x911ECBCE73F8EC3F(uLocal_73);
			unk_0xC2C4A3A9FF2FBFFF(iLocal_55, uLocal_73);
			unk_0x8D6671D78D1F569B(iLocal_55, 1);
			unk_0x33A90AD8FA327B72(&uLocal_73);
			unk_0x60C665492B5CF05B(2544.862f, 4729.893f, 27.8986f, 2564.862f, 4749.893f, 28.8986f, 1);
		}
		else
		{
			iLocal_53 = 2;
			unk_0x94026C1D1DB14225(&uLocal_73);
			unk_0xEF557F8B8E594B2F(0, 2531.445f, 2521.749f, 38.2072f, 3f, -1, 2f, 1, Local_250, 1193033728);
			unk_0x4B79E06845D63B96(0, iLocal_54, 150f, -1, 0, 0);
			unk_0x911ECBCE73F8EC3F(uLocal_73);
			unk_0xC2C4A3A9FF2FBFFF(iLocal_55, uLocal_73);
			unk_0x8D6671D78D1F569B(iLocal_55, 1);
...
void func_100()
{
	Local_250.f_0 = 0f;
	Local_250.f_1 = 10f;
	unk_0x79EE909282B7E387(iLocal_54, 2);
	unk_0x7E3DC7ED30B648F0(iLocal_54, 13, 1);
	unk_0x7E3DC7ED30B648F0(iLocal_54, 2, 1);
	unk_0x7E3DC7ED30B648F0(iLocal_54, 1, 1);
	unk_0x7E3DC7ED30B648F0(iLocal_54, 11, 0);
	unk_0x45AC72BF50E50EFE(iLocal_54, 0);
	unk_0x79EE909282B7E387(iLocal_55, 3);
	unk_0x7E3DC7ED30B648F0(iLocal_55, 17, 1);
	unk_0x7E3DC7ED30B648F0(iLocal_55, 6, 1);
	unk_0x7E3DC7ED30B648F0(iLocal_55, 1, 1);
	unk_0x7E3DC7ED30B648F0(iLocal_55, 11, 0);
	unk_0x7346544C767CFCBF(iLocal_55, 128, 1);
	unk_0x7346544C767CFCBF(iLocal_55, 1, 0);
	unk_0x103FCC2BD24292A3("RE_ARREST_COP", &iLocal_71);
	unk_0x103FCC2BD24292A3("RE_ARREST_CRIM", &iLocal_72);
	unk_0x690C5239500171FE(iLocal_54, iLocal_71);
	unk_0x690C5239500171FE(iLocal_55, iLocal_72);
	unk_0xA9CA101B50B90993(4, iLocal_72, iLocal_71);
	unk_0xA9CA101B50B90993(3, iLocal_71, joaat("player"));
	unk_0xA9CA101B50B90993(3, iLocal_72, joaat("player"));
	unk_0xA9CA101B50B90993(4, iLocal_72, joaat("COP"));
	unk_0x0814FB03E16A03C1(iLocal_54, sLocal_257);
	unk_0x0814FB03E16A03C1(iLocal_55, sLocal_256);
}
...
int func_102()
{
	...
	{
		if (unk_0xA8CEACB4F35AE058(unk_0x834FF019A048DE2C(unk_0xE7869D5D7816A9B6())) > 1369f && !func_110())
		{
			return 0;
		}
	}
...
int func_121(struct<3> Param0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		...
		if (!func_157(Global_99155.f_29444.f_43[iParam3]))
		{
			return 0;
		}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_135(unk_0xB519E5386FBF69E5(iParam0, 31), -1, 1)) + 2011;
}
...
int func_138()
{
	...
	func_144(&uVar0, unk_0x0CE219089BDB83C5());
	func_143(&uVar0, unk_0x1B24A2CA27443F7B());
	func_142(&uVar0, unk_0x7C833E3C6EEE41E0());
	func_141(&uVar0, unk_0x2DA3502053F9E535());
	func_140(&uVar0, unk_0xEB4EA596232DA76E());
	func_139(&uVar0, unk_0xB99227ECC84A576C());
	return uVar0;
}
		...
		if (unk_0xD51CFE69539DB6D8(unk_0xE7869D5D7816A9B6()))
		{
			if (!unk_0xAF437D7C802AB246(unk_0xE7869D5D7816A9B6()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xA01404E50546EA1D(unk_0x3F80C6638E3A1A90(), 1) || func_155()) || Global_25036) || func_154()) || func_74(8, -1)) || func_151()) || func_153()) || func_152()) || func_150()) || Global_99155.f_6302.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x69CFD69005B7F5D7(unk_0x3F80C6638E3A1A90()) || unk_0x47EF9ED961F4F559(unk_0xE7869D5D7816A9B6())) || unk_0xF3140D055686CF79(unk_0xE7869D5D7816A9B6())) || unk_0x8E2CF6ACCED3BD0F(unk_0xE7869D5D7816A9B6())) || unk_0xA2245114BF58F40D(unk_0xE7869D5D7816A9B6())) || unk_0xA01404E50546EA1D(unk_0x3F80C6638E3A1A90(), 1)) || unk_0x39CB1B5DEC5DD307(unk_0x3F80C6638E3A1A90())) || unk_0x0930CF2B56CCE2B8(unk_0xE7869D5D7816A9B6(), 0)) || func_155()) || Global_98202) || Global_25036) || func_154()) || func_74(8, -1)) || func_151()) || func_153()) || func_152()) || func_150()) || Global_99155.f_6302.f_919[iVar0] == 5) || Global_36166 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x8E2CF6ACCED3BD0F(unk_0xE7869D5D7816A9B6()) || unk_0xA2245114BF58F40D(unk_0xE7869D5D7816A9B6())) || unk_0xA01404E50546EA1D(unk_0x3F80C6638E3A1A90(), 1)) || unk_0x0930CF2B56CCE2B8(unk_0xE7869D5D7816A9B6(), 0)) || func_155()) || Global_98202) || Global_25036) || func_154()) || func_74(8, -1)) || func_153()) || func_152()) || func_150()) || Global_99155.f_6302.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_155() || unk_0x44B59DB1458EE8E0(unk_0x3F80C6638E3A1A90()) > 0) || func_74(8, -1)) || func_150()) || func_149()) || Global_99155.f_6302.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_164()
{
	if (unk_0x4341FD2C227CC4C0())
	{
		...
		{
			if (!unk_0xAF437D7C802AB246(iLocal_55) && !unk_0x76B2D234F1895632(iLocal_55))
			{
				unk_0x76B2D234F1895632(iLocal_54);
				if (unk_0xD51CFE69539DB6D8(iLocal_54))
				{
					unk_0x29F2993666F68F46(iLocal_55, unk_0x1141852D07400777(iLocal_54, 1), 9000f, -1, 0, 0);
				}
				else
				{
					unk_0x29F2993666F68F46(iLocal_55, unk_0x1141852D07400777(iLocal_55, 1), 9000f, -1, 0, 0);
				}
		...
		if (unk_0xD51CFE69539DB6D8(iLocal_54))
		{
			if (!unk_0xAF437D7C802AB246(iLocal_54))
			{
				unk_0x8D6671D78D1F569B(iLocal_54, 1);
				unk_0x9BEE7E791BC4D38B(iLocal_54, 0);
				unk_0xC3BF4FACB3821EC2(iLocal_54, 1);
				unk_0x321C1AA209172C00(iLocal_54, 1);
			}
		}
		if (unk_0xD51CFE69539DB6D8(iLocal_56))
		{
			if (!unk_0xAF437D7C802AB246(iLocal_56))
			{
				...
				unk_0xC3BF4FACB3821EC2(iLocal_56, 1);
			}
		}
		if (func_177())
		{
	...
	unk_0x8BF2AD7A954B9A59(2551.038f, 4708.613f, 32.6775f, 2536.979f, 5022.179f, 43.8519f, 300f, 1);
	if (iLocal_287)
	{
		unk_0xFBDF63459A604D13(unk_0x3F80C6638E3A1A90(), 3, 0);
		unk_0x6FF6F40CA433340F(unk_0x3F80C6638E3A1A90(), 0);
...
void func_165(int iParam0)
{
	...
	if (func_177())
	{
		...
		func_169(30000);
		StringCopy(&cVar0, func_168(Global_99144, 1), 64);
		if (func_167(Global_99144) > 0)
		{
...
int func_177()
{
	if ((Global_99144 == func_119() && unk_0x4341FD2C227CC4C0()) && Global_99145)
	{
		return 1;
	}
	return 0;
...
void func_183()
{
	...
	if (!unk_0x11ED867E5A37BE49())
	{
		if (!Global_69236)
		{
			if (func_184() == 2 == 0 && !unk_0x00AAD79B42B3E036())
			{
...
void func_196()
{
	if (!bLocal_74 && iLocal_51 == 0)
	{
		if (!unk_0xAF437D7C802AB246(iLocal_54) && !unk_0xAF437D7C802AB246(iLocal_55))
		{
			unk_0x34912824AE482D65(iLocal_54, unk_0x1141852D07400777(iLocal_55, 1), 3f, 20000, 1193033728, 1056964608);
			unk_0x8D6671D78D1F569B(iLocal_54, 1);
			unk_0x4EDE34FBADD967A6(0);
		}
	}
