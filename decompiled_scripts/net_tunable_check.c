...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (func_6() || Global_1816871 == 1)
		{
			func_5();
		}
		if (func_1(&uLocal_21, &Global_284735))
		{
			func_5();
		}
...
int func_1(var uParam0, var uParam1)
{
	...
	if (uParam0->f_2)
	{
		if (unk_0x18DD02B781D4AD2F(unk_0xB34837A3BB15AB69(unk_0x5AFB8ED811F05E4D(), uParam0->f_1)) >= uParam0->f_3)
		{
			func_4();
		}
	}
			...
			while (iVar2 <= iVar11)
			{
				if (iVar2 < iVar10)
				{
					...
					if (iVar2 >= Var3.f_4 && iVar2 != 27)
					{
						...
						{
							if (unk_0xF4D4ECB70D8E9FA1(iVar12, Var3.f_5, &fVar0))
							{
								if (fVar0 > Var3.f_1 || fVar0 < Var3.f_0)
								{
									uParam0->f_2 = 1;
									uParam0->f_3 = unk_0x61E9B3BFA06B017B(20000, 30000);
									uParam0->f_1 = unk_0x5AFB8ED811F05E4D();
								}
							}
							else if (unk_0xCD2A503C347D9EFF(iVar12, Var3.f_5, &iVar1))
							{
...
void func_4()
{
	unk_0x2ED7366F2AA172FB();
	unk_0xC1431657B4FEA2FB(-9f, -9f, -9f, -10f, -10f, -10f, -25f, -25f, -25f, -28f, -28f, -28f, 0f, 0f, 0f, 0, 0, 0);
	unk_0x1701E0E6A11D6B65(-9f, -9f, -9f, -10f, -10f, -10f, 0, 1, 1, 1);
	func_4();
}
...
int func_6()
{
	...
	if (func_7() != 0)
	{
		if (unk_0xE7FAF8E78F7D3A73(func_7()) == 0)
		{
			return 1;
		}
	}
