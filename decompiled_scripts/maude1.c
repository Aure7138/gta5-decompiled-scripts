	...
	switch (iLocal_143)
	{
		...
		case 1:
			...
			if (func_17(iLocal_158))
			{
				...
				if (!func_243(0))
				{
					if (unk_0xB7A628320EFF8E47(Var0, unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 0)) > 14400f)
					{
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_304(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
