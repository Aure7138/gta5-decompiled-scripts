	...
	switch (iLocal_143)
	{
		...
		case 1:
			...
			if (func_17(iLocal_158))
			{
				...
				if (!func_243(0))
				{
					if (unk_0xB7A628320EFF8E47(Var0, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0)) > 14400f)
					{
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_304(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
