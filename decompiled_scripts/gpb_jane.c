...
void __EntryFunction__()
{
	...
	while (iVar0 == 1)
	{
		...
		{
			func_91(func_107(unk_0xFABF5258A318B1DC()));
			func_108(0);
		}
		...
		switch (iLocal_250)
		{
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_505)
					{
						Global_103181[iLocal_251] = uLocal_504;
					}
					else
					{
...
void func_9()
{
	...
	{
		unk_0x1241657DD24F3387(uLocal_240, sLocal_448, 1048576000);
	}
}
...
void func_98()
{
	unk_0xA7C81DED990D3418(sLocal_448);
	while (!unk_0x45834D6C20FFF689(sLocal_448))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	iLocal_449 = 1;
...
void func_108(int iParam0)
{
	...
	if (iLocal_241)
	{
		...
		if (unk_0x35302CD5A5D37EED(&uVar0, &Local_500))
		{
			func_13();
		}
		if (iParam0 == 1)
...
void func_112()
{
	if (iLocal_449 == 1)
	{
		if (unk_0x45834D6C20FFF689(sLocal_448))
		{
			unk_0x15167ADA0B7D44AE(sLocal_448);
		}
	}
}
