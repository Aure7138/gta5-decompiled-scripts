...
void __EntryFunction__()
{
	...
	while (iVar0 == 1)
	{
		...
		{
			func_91(func_107(unk_0xFCA64981FEF7C913()));
			func_108(0);
		}
		...
		switch (iLocal_250)
		{
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_505)
					{
						Global_104496[iLocal_251] = uLocal_504;
					}
					else
					{
...
void func_9()
{
	...
	{
		unk_0x7DCD69F135A25F0E(uLocal_240, sLocal_448, 1048576000);
	}
}
...
void func_98()
{
	unk_0x831CD0FBFB26EC7E(sLocal_448);
	while (!unk_0x028356968FDD2DF2(sLocal_448))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	iLocal_449 = 1;
...
void func_108(int iParam0)
{
	...
	if (iLocal_241)
	{
		...
		if (unk_0x9D39145AD645E383(&uVar0, &Local_500))
		{
			func_13();
		}
		if (iParam0 == 1)
...
void func_112()
{
	if (iLocal_449 == 1)
	{
		if (unk_0x028356968FDD2DF2(sLocal_448))
		{
			unk_0x334F1DD67B2EC86A(sLocal_448);
		}
	}
}
