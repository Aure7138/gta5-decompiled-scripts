...
void __EntryFunction__()
{
	...
	while (iVar0 == 1)
	{
		...
		{
			func_91(func_107(unk_0xC4E68AF0B559FAC4()));
			func_108(0);
		}
		...
		switch (iLocal_250)
		{
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_505)
					{
						Global_100921[iLocal_251] = uLocal_504;
					}
					else
					{
...
void func_9()
{
	...
	{
		unk_0x9740820061E05C06(uLocal_240, sLocal_448, 1048576000);
	}
}
...
void func_98()
{
	unk_0xC0E8B67A4385D37D(sLocal_448);
	while (!unk_0xF9B86DC1728F1339(sLocal_448))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	iLocal_449 = 1;
...
void func_108(int iParam0)
{
	...
	if (iLocal_241)
	{
		...
		if (unk_0xF8D041B05C3D1FD4(&uVar0, &Local_500))
		{
			func_13();
		}
		if (iParam0 == 1)
...
void func_112()
{
	if (iLocal_449 == 1)
	{
		if (unk_0xF9B86DC1728F1339(sLocal_448))
		{
			unk_0x3ECF1E41E6ED71D8(sLocal_448);
		}
	}
}
