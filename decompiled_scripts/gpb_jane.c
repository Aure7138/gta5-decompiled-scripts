...
void __EntryFunction__()
{
	...
	while (iVar0 == 1)
	{
		...
		{
			func_91(func_107(unk_0x367152330DB70D69()));
			func_108(0);
		}
		...
		switch (iLocal_250)
		{
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_505)
					{
						Global_101498[iLocal_251] = uLocal_504;
					}
					else
					{
...
void func_9()
{
	...
	{
		unk_0x207947B723A8ADC7(uLocal_240, sLocal_448, 1048576000);
	}
}
...
void func_98()
{
	unk_0xA9DC3948106CC3E4(sLocal_448);
	while (!unk_0xAD21C77209FD2024(sLocal_448))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	iLocal_449 = 1;
...
void func_108(int iParam0)
{
	...
	if (iLocal_241)
	{
		...
		if (unk_0x28C1B9853548BD8E(&uVar0, &Local_500))
		{
			func_13();
		}
		if (iParam0 == 1)
...
void func_112()
{
	if (iLocal_449 == 1)
	{
		if (unk_0xAD21C77209FD2024(sLocal_448))
		{
			unk_0x04269E768DDAF940(sLocal_448);
		}
	}
}
