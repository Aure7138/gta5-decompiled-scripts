...
void __EntryFunction__()
{
	...
	while (iVar0 == 1)
	{
		...
		{
			func_91(func_107(unk_0x47B34031F915C179()));
			func_108(0);
		}
		...
		switch (iLocal_250)
		{
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_505)
					{
						Global_101131[iLocal_251] = uLocal_504;
					}
					else
					{
...
void func_9()
{
	...
	{
		unk_0x04347E3774A28B85(uLocal_240, sLocal_448, 1048576000);
	}
}
...
void func_98()
{
	unk_0x198E497B820DA913(sLocal_448);
	while (!unk_0x7B43775D6E0D7325(sLocal_448))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	iLocal_449 = 1;
...
void func_108(int iParam0)
{
	...
	if (iLocal_241)
	{
		...
		if (unk_0x2F6869889D97DFED(&uVar0, &Local_500))
		{
			func_13();
		}
		if (iParam0 == 1)
...
void func_112()
{
	if (iLocal_449 == 1)
	{
		if (unk_0x7B43775D6E0D7325(sLocal_448))
		{
			unk_0x6B09668CBB188BED(sLocal_448);
		}
	}
}
