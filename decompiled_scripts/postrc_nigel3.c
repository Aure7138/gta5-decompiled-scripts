...
void func_1()
{
	switch (iLocal_21)
	{
		case 0:
			...
			else if ((unk_0xDFB7BFA6482FEE1E() - iLocal_187) > 12000 && unk_0xB7A628320EFF8E47(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), unk_0xD6E677FAD7521410(uLocal_188, 1)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
int func_22()
{
	...
	fVar0 = 200f;
	if (unk_0xB7A628320EFF8E47(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), unk_0xD6E677FAD7521410(uLocal_188, 1)) >= (fVar0 * fVar0) && !unk_0xB4E725A8915BDF60(uLocal_188))
	{
		return 0;
	}
	return 1;
