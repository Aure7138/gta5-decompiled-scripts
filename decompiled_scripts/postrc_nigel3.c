...
void func_1()
{
	...
	{
		case 0:
			if ((unk_0x5AFB8ED811F05E4D() - iLocal_187) > 5000 && unk_0x1B843A60307EECA4(uLocal_188, unk_0x18F7BE9ACB7D08F4(), 1))
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					unk_0xA3F48AA4B6323A62(uLocal_188);
					iLocal_21 = 1;
				}
			}
			else if ((unk_0x5AFB8ED811F05E4D() - iLocal_187) > 12000 && unk_0xB7A628320EFF8E47(unk_0x761660F5CE986DC4(unk_0x18F7BE9ACB7D08F4(), 1), unk_0x761660F5CE986DC4(uLocal_188, 1)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
{
	iLocal_187 = unk_0x5AFB8ED811F05E4D();
	func_16(&uLocal_22, 2, unk_0x18F7BE9ACB7D08F4(), "TREVOR", 0, 1);
...
int func_17()
{
	...
	fVar0 = 200f;
	if (unk_0xB7A628320EFF8E47(unk_0x761660F5CE986DC4(unk_0x18F7BE9ACB7D08F4(), 1), unk_0x761660F5CE986DC4(uLocal_188, 1)) >= (fVar0 * fVar0) && !unk_0x3AAE8FF7FB37F69E(uLocal_188))
	{
		return 0;
	}
	return 1;
...
int func_19()
{
	if (unk_0x31F12808DC47A9E5(uLocal_188))
	{
		if (!unk_0x0FAE113CE72ED842(uLocal_188))
		{
			return 1;
		}
	}
...
void func_21()
{
	...
	if (unk_0x31F12808DC47A9E5(unk_0x18F7BE9ACB7D08F4()))
	{
		if (func_24(Global_104551.f_2353.f_539.f_4301) != unk_0x4F69FBD64CDF125B(unk_0x18F7BE9ACB7D08F4()))
		{
			...
			if (func_22(iVar0) && (!func_10(14) || Global_103502))
			{
...
int func_25()
{
	...
	{
		iVar17 = unk_0x74A7D93DBA7322F5(unk_0x18F7BE9ACB7D08F4(), &uVar0, -1);
		iVar18 = 0;
		while (iVar18 <= (iVar17 - 1))
		{
			if (uVar0[iVar18] != 0 && unk_0x31F12808DC47A9E5(uVar0[iVar18]))
			{
				if (unk_0x4F69FBD64CDF125B(uVar0[iVar18]) == joaat("u_m_m_aldinapoli"))
				{
					unk_0x337F2213526139E0(uVar0[iVar18], 1, 1);
...
void func_26()
{
	...
	if (unk_0x31F12808DC47A9E5(uLocal_188))
	{
		unk_0xDBE64C5761554FBF(&uLocal_188);
	}
