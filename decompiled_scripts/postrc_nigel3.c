...
void func_1()
{
	...
	{
		case 0:
			if ((unk_0xE3903F59E2F22150() - iLocal_187) > 5000 && unk_0x91BBD269506D61D2(uLocal_188, unk_0x33CD235DF1E6A94E(), 1))
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					unk_0x0D847D71D9E6142E(uLocal_188);
					iLocal_21 = 1;
				}
			}
			else if ((unk_0xE3903F59E2F22150() - iLocal_187) > 12000 && unk_0xB7A628320EFF8E47(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1), unk_0xFBB1F99A825CAB09(uLocal_188, 1)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
{
	iLocal_187 = unk_0xE3903F59E2F22150();
	func_16(&uLocal_22, 2, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
...
int func_17()
{
	...
	fVar0 = 200f;
	if (unk_0xB7A628320EFF8E47(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1), unk_0xFBB1F99A825CAB09(uLocal_188, 1)) >= (fVar0 * fVar0) && !unk_0x3F219400E5FE4B69(uLocal_188))
	{
		return 0;
	}
	return 1;
...
int func_19()
{
	if (unk_0x765F6FEEFF39224F(uLocal_188))
	{
		if (!unk_0xBC2FC12AD0FBF72E(uLocal_188))
		{
			return 1;
		}
	}
...
int func_25()
{
	...
	{
		iVar17 = unk_0xB62DA19846051096(unk_0x33CD235DF1E6A94E(), &uVar0, -1);
		iVar18 = 0;
		while (iVar18 <= (iVar17 - 1))
		{
			if (uVar0[iVar18] != 0 && unk_0x765F6FEEFF39224F(uVar0[iVar18]))
			{
				if (unk_0x541D5C57194E73C4(uVar0[iVar18]) == joaat("u_m_m_aldinapoli"))
				{
					unk_0x0D21E1FDE062ED99(uVar0[iVar18], 1, 1);
...
void func_26()
{
	...
	if (unk_0x765F6FEEFF39224F(uLocal_188))
	{
		unk_0x1F45B4626AC4A4C0(&uLocal_188);
	}
