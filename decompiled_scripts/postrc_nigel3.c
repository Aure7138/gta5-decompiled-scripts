...
void func_1()
{
	...
	{
		case 0:
			if ((unk_0x1DD05E817C89C737() - iLocal_187) > 5000 && unk_0x9B3D4335E0EDB0BE(uLocal_188, unk_0x4A8C381C258A124D(), 1))
			{
			...
			else if ((unk_0x1DD05E817C89C737() - iLocal_187) > 12000 && unk_0xB7A628320EFF8E47(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(uLocal_188, 1)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
{
	iLocal_187 = unk_0x1DD05E817C89C737();
	func_21(&uLocal_22, 2, unk_0x4A8C381C258A124D(), "TREVOR", 0, 1);
...
int func_22()
{
	...
	fVar0 = 200f;
	if (unk_0xB7A628320EFF8E47(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(uLocal_188, 1)) >= (fVar0 * fVar0) && !unk_0xCB5CAFF0A4A8B74B(uLocal_188))
	{
		return 0;
	}
	return 1;
...
int func_31()
{
	...
	{
		iVar17 = unk_0xAA3F0A9E20917995(unk_0x4A8C381C258A124D(), &uVar0, -1);
		iVar18 = 0;
		while (iVar18 <= (iVar17 - 1))
		{
			if (uVar0[iVar18] != 0 && unk_0xFC8BFE4B41177C22(uVar0[iVar18]))
			{
				if (unk_0x4B423FAA24E8ABF0(uVar0[iVar18]) == joaat("u_m_m_aldinapoli"))
				{
					unk_0xEE0BCDB1B5E36BCB(uVar0[iVar18], 1, 1);
