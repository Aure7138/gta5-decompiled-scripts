...
void func_1()
{
	switch (iLocal_21)
	{
		case 0:
			...
			else if ((unk_0x320D1840B6DAA1CC() - iLocal_187) > 12000 && unk_0xB7A628320EFF8E47(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(uLocal_188, 1)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
int func_22()
{
	...
	fVar0 = 200f;
	if (unk_0xB7A628320EFF8E47(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(uLocal_188, 1)) >= (fVar0 * fVar0) && !unk_0xBC7D3EDF3455BC35(uLocal_188))
	{
		return 0;
	}
	return 1;
