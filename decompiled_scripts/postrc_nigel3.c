...
void func_1()
{
	...
	{
		case 0:
			if ((unk_0x9B35D07DCD0F0B43() - iLocal_187) > 5000 && unk_0x3656B691E303FDE0(uLocal_188, unk_0x0FA8183DAD2B3203(), 1))
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					unk_0x7FF38BFB318C1A86(uLocal_188);
					iLocal_21 = 1;
				}
			}
			else if ((unk_0x9B35D07DCD0F0B43() - iLocal_187) > 12000 && unk_0xB7A628320EFF8E47(unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1), unk_0xACE5E491FC1B0D37(uLocal_188, 1)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
{
	iLocal_187 = unk_0x9B35D07DCD0F0B43();
	func_21(&uLocal_22, 2, unk_0x0FA8183DAD2B3203(), "TREVOR", 0, 1);
...
int func_22()
{
	...
	fVar0 = 200f;
	if (unk_0xB7A628320EFF8E47(unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1), unk_0xACE5E491FC1B0D37(uLocal_188, 1)) >= (fVar0 * fVar0) && !unk_0x62E95D2FED28E41C(uLocal_188))
	{
		return 0;
	}
	return 1;
...
int func_24()
{
	if (unk_0xD4B321D9096B01FC(uLocal_188))
	{
		if (!unk_0x2BF5E63466422C38(uLocal_188))
		{
			return 1;
		}
	}
...
int func_31()
{
	...
	{
		iVar17 = unk_0xB7AEB865047E4CC6(unk_0x0FA8183DAD2B3203(), &uVar0, -1);
		iVar18 = 0;
		while (iVar18 <= (iVar17 - 1))
		{
			if (uVar0[iVar18] != 0 && unk_0xD4B321D9096B01FC(uVar0[iVar18]))
			{
				if (unk_0x7F375072508F738F(uVar0[iVar18]) == joaat("u_m_m_aldinapoli"))
				{
					unk_0xE5C667CF3B4642D2(uVar0[iVar18], 1, 1);
...
void func_32()
{
	...
	if (unk_0xD4B321D9096B01FC(uLocal_188))
	{
		unk_0x0FFB05DA97E810B5(&uLocal_188);
	}
