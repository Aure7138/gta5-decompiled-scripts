...
void func_1()
{
	switch (iLocal_21)
	{
		case 0:
			...
			else if ((unk_0x578C4EF320340AF7() - iLocal_187) > 12000 && unk_0xB7A628320EFF8E47(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(uLocal_188, 1)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
int func_22()
{
	...
	fVar0 = 200f;
	if (unk_0xB7A628320EFF8E47(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(uLocal_188, 1)) >= (fVar0 * fVar0) && !unk_0xA38BFCB05DBE439D(uLocal_188))
	{
		return 0;
	}
	return 1;
