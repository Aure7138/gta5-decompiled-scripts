...
int func_2()
{
	...
	while (iVar0 < iLocal_237)
	{
		...
		{
			Var5 = { unk_0x68F4C0EC296D3901(iLocal_237[iVar0], 1) };
...
void func_26(int iParam0, int iParam1)
{
	...
	if (!unk_0xEB6A8945D1AC98A1(iParam0))
	{
		...
		{
			case 0:
				if (unk_0xB4ECF989E2C1DAC8(iParam0, &cLocal_345, &(Local_394[iParam1 /*16*/]), 2))
				{
					fVar0 = -1f;
					fVar1 = -1f;
					if (unk_0xDC2A248C2CB7B3DB(&cLocal_345, &(Local_394[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1) || func_35(&cLocal_345, &(Local_394[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1))
					{
						...
						if (fVar2 > fVar0)
						{
							...
							unk_0x96167B03C5A77156(iParam0, Local_273 + Local_284[iParam1 /*3*/], fVar3, -1, (fLocal_294[iParam1] * 0.1f), 0, 1193033728);
							unk_0xBD453909DC26A85D(iParam0, iVar4, 0, 0, 0);
				...
				{
					unk_0xA3BF0AA5A2608191(iParam0);
					if (unk_0xEA6BC48857E0AC4C(&(Local_427[iParam1 /*16*/])))
					{
						if (func_32(Local_284[iParam1 /*3*/], 0f, 0f, 0f, 0))
						{
							Var5 = { unk_0x68F4C0EC296D3901(iParam0, 1) };
							Local_284[iParam1 /*3*/] = { Var5 - Local_273 * Vector(4f, 4f, 4f) };
						}
						if (!unk_0xEA6BC48857E0AC4C(&(Local_691[iParam1 /*16*/])))
						{
							unk_0x79C43E2BAC7C696F(iParam0, &(Local_691[iParam1 /*16*/]), 1048576000);
						}
						unk_0x96167B03C5A77156(iParam0, Local_273 + Local_284[iParam1 /*3*/], 1f, -1, 0.25f, 0, 1193033728);
						iLocal_240[iParam1] = 1;
					}
					else
					{
						...
						{
							iLocal_724 = unk_0xE9744DB7B8CA6965(Local_273, 0f, 0f, fLocal_276, 2);
							unk_0xC90224D9E95E5E3A(iLocal_724, 1);
						}
						iVar8 = 5;
						iVar9 = 144;
						iVar10 = 0;
						if (iLocal_256[0] == joaat("p_trev_rope_01_s") || iLocal_256[1] == joaat("p_trev_rope_01_s"))
						{
							...
							unk_0x11AD11297DC58CC7(iLocal_237[iParam1], 1);
							unk_0x25C5402CC10F76CD(iLocal_237[iParam1], 0);
							...
							unk_0x9DD8618CA5BF832D(iLocal_237[iParam1], 64, 1);
							unk_0x9DD8618CA5BF832D(iLocal_237[iParam1], 249, 1);
							unk_0x9DD8618CA5BF832D(iLocal_237[iParam1], 335, 1);
							iVar11 = 0;
							while (iVar11 < iLocal_253)
							{
								unk_0x98868AF51859FC75(iLocal_253[iVar11], 0);
						...
						unk_0x915804B434753CBD(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_427[iParam1 /*16*/]), 1000f, -1000f, iVar8, iVar9, 1000f, iVar10);
						iVar11 = 0;
						while (iVar11 < iLocal_253)
						{
							if (iLocal_256[iVar11] != 0)
							{
								if (!unk_0xEA6BC48857E0AC4C(&(Local_592[iVar11 /*16*/])))
								{
									unk_0xE14EC663EED44AD5(iLocal_253[iVar11], iLocal_724, &(Local_592[iVar11 /*16*/]), &cLocal_345, 8f, 8f, 0, 1148846080);
								}
							}
							iVar11++;
						}
			...
			case 1:
				if (!unk_0xBFDE4EE64C4BF2D6(iLocal_237[iParam1], uLocal_252))
				{
					if (!unk_0x7AEFFBD77F2CF1EC(uLocal_252))
					{
						uLocal_252 = unk_0xCF3D07D677EC9ACD(0);
					}
					if (iParam1 == 0)
					{
						unk_0xE987E96726242F1B(iLocal_237[iParam1], uLocal_252);
					}
					else
					{
						unk_0xE25C96A9C36BE5D2(iLocal_237[iParam1], uLocal_252);
					}
				}
				if (unk_0xD1960163A3042274(iParam0, 713668775) != 1)
				{
					...
					unk_0xA371FDC12D462090(iParam0, Local_273 + Local_284[iParam1 /*3*/], fLocal_294[iParam1], 1077936128, 1086324736);
			...
			case 10:
				...
				unk_0x9DD8618CA5BF832D(iLocal_237[iParam1], 249, 1);
				unk_0x9DD8618CA5BF832D(iLocal_237[iParam1], 335, 1);
				if (unk_0xB4ECF989E2C1DAC8(iLocal_237[iParam1], &cLocal_345, &(Local_427[iParam1 /*16*/]), 2))
				{
					if (iLocal_70 == 288)
					{
						if (iLocal_731 <= 0)
				...
				else
				{
					...
					unk_0x915804B434753CBD(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_427[iParam1 /*16*/]), 1000f, -1000f, iVar13, iVar14, 1000f, iVar15);
					iVar16 = 0;
					while (iVar16 < iLocal_253)
					{
						if (iLocal_256[iVar16] != 0)
						{
							if (!unk_0xEA6BC48857E0AC4C(&(Local_592[iVar16 /*16*/])))
							{
								unk_0xE14EC663EED44AD5(iLocal_253[iVar16], iLocal_724, &(Local_592[iVar16 /*16*/]), &cLocal_345, 8f, 8f, 0, 1148846080);
							}
						}
						iVar16++;
					}
				...
				if (bVar18)
				{
					...
					unk_0xEFC3DF9D33E248D8(iLocal_724, 1);
					unk_0xC90224D9E95E5E3A(iLocal_724, 0);
					iVar19 = 4;
					iVar20 = 4276;
					iVar21 = 0;
					unk_0x915804B434753CBD(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_460[iParam1 /*16*/]), 8f, -1000f, iVar19, iVar20, 8f, iVar21);
					unk_0x98868AF51859FC75(iLocal_237[iParam1], 0);
					unk_0x5E678B691C852774(iLocal_237[iParam1], iVar20);
					unk_0x4E885A246A9D983A(iLocal_237[iParam1], 208, 1);
					iVar22 = 0;
					while (iVar22 < iLocal_253)
					{
						if (iLocal_256[iVar22] != 0)
						{
							if (!unk_0xEA6BC48857E0AC4C(&(Local_625[iVar22 /*16*/])))
							{
								unk_0xE14EC663EED44AD5(iLocal_253[iVar22], iLocal_724, &(Local_625[iVar22 /*16*/]), &cLocal_345, 8f, 8f, 0, 1148846080);
								unk_0x98868AF51859FC75(iLocal_253[iVar22], 0);
							}
						}
						iVar22++;
					}
			...
			case 11:
				...
				if (!bVar23)
				{
					...
					unk_0xEFC3DF9D33E248D8(iLocal_724, 0);
					unk_0xC90224D9E95E5E3A(iLocal_724, 1);
					iVar24 = 0;
					iVar25 = 180;
					iVar26 = 0;
					unk_0x915804B434753CBD(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_493[iParam1 /*16*/]), 1000f, -1000f, iVar24, iVar25, 1000f, iVar26);
					iVar27 = 0;
					while (iVar27 < iLocal_253)
					{
						if (iLocal_256[iVar27] != 0)
						{
							if (!unk_0xEA6BC48857E0AC4C(&(Local_658[iVar27 /*16*/])))
							{
								unk_0xE14EC663EED44AD5(iLocal_253[iVar27], iLocal_724, &(Local_658[iVar27 /*16*/]), &cLocal_345, 8f, 8f, 0, 1148846080);
							}
						}
						iVar27++;
					}
			...
			case 12:
				...
				unk_0x9DD8618CA5BF832D(iLocal_237[iParam1], 249, 1);
				unk_0x9DD8618CA5BF832D(iLocal_237[iParam1], 335, 1);
				if (!unk_0xB4ECF989E2C1DAC8(iLocal_237[iParam1], &cLocal_345, &(Local_493[iParam1 /*16*/]), 2))
				{
					if (!unk_0x69DF961355195C3C(iLocal_724))
					{
						iLocal_724 = unk_0xE9744DB7B8CA6965(Local_273, 0f, 0f, fLocal_276, 2);
					}
					unk_0x915804B434753CBD(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_493[iParam1 /*16*/]), 1000f, -1000f, 0, 0, 1148846080, 0);
					iVar28 = 0;
					while (iVar28 < iLocal_253)
					{
						if (iLocal_256[iVar28] != 0)
						{
							if (!unk_0xEA6BC48857E0AC4C(&(Local_658[iVar28 /*16*/])))
							{
								unk_0xE14EC663EED44AD5(iLocal_253[iVar28], iLocal_724, &(Local_658[iVar28 /*16*/]), &cLocal_345, 8f, 8f, 0, 1148846080);
							}
						}
						iVar28++;
					}
		...
		if (unk_0xC844350D5D58C99A(iParam0))
		{
			...
			while (iVar29 < iLocal_253)
			{
				if (unk_0xC844350D5D58C99A(iLocal_253[iVar29]))
				{
					...
					unk_0x1E9649458B15960F(iLocal_253[iVar29], 0);
...
int func_29(int iParam0)
{
	...
	if (iLocal_70 == 237)
	{
		fVar1 = unk_0xB7A628320EFF8E47(unk_0x68F4C0EC296D3901(iParam0, 0), unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0));
		if (fVar1 < (10f * 10f))
		{
			return 1;
		}
...
{
	unk_0xEB0A515D699A7E90(uParam0, sParam1, sParam2, func_34(iParam3), 0);
}
...
int func_35(char[4] cParam0, char* sParam1, char* sParam2, float fParam3, float fParam4)
{
	...
	{
		if (unk_0x7F8A39872A07D2CE(cParam0, "SWITCH@TREVOR@SCARES_TRAMP"))
		{
			if (unk_0x7F8A39872A07D2CE(uParam1, "trev_scares_tramp_exit_tramp"))
			{
				*fParam3 = 0.8f;
				*fParam4 = 1f;
				return 1;
		...
		if (unk_0x7F8A39872A07D2CE(cParam0, "SWITCH@TREVOR@CHASE_STRIPPERS"))
		{
		...
		if (unk_0x7F8A39872A07D2CE(cParam0, "SWITCH@TREVOR@THROW_FOOD"))
		{
		...
		if (unk_0x69DF961355195C3C(Global_96074))
		{
			...
			while (iVar0 < iLocal_237)
			{
				if (!unk_0xEB6A8945D1AC98A1(iLocal_237[iVar0]))
				{
					...
					fVar6 = -1f;
					fVar7 = -1f;
					if (unk_0xDC2A248C2CB7B3DB(&cLocal_345, &(Local_394[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7) || func_35(&cLocal_345, &(Local_394[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7))
					{
						fVar1 = -8f;
						iVar2 = 2;
						iVar3 = 0;
					...
					unk_0x915804B434753CBD(iLocal_237[iVar0], Global_96074, &cLocal_345, &(Local_394[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_240[iVar0] = 0;
				}
				iVar0++;
			}
			...
			while (iVar0 < iLocal_253)
			{
				...
				{
					if (!unk_0xEA6BC48857E0AC4C(&(Local_559[iVar0 /*16*/])))
					{
						unk_0xE14EC663EED44AD5(iLocal_253[iVar0], Global_96074, &(Local_559[iVar0 /*16*/]), &cLocal_345, 8f, -1000f, 0, 1148846080);
					}
				}
				iVar0++;
			}
...
int func_38()
{
	...
	if (unk_0x69DF961355195C3C(Global_96073))
	{
		...
		while (iVar0 < iLocal_237)
		{
			if (!unk_0xEB6A8945D1AC98A1(iLocal_237[iVar0]))
			{
				unk_0x915804B434753CBD(iLocal_237[iVar0], Global_96073, &cLocal_345, &(Local_361[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_253)
		{
			if (unk_0xC844350D5D58C99A(iLocal_253[iVar0]))
			{
				if (!unk_0xEA6BC48857E0AC4C(&(Local_526[iVar0 /*16*/])))
				{
					unk_0xE14EC663EED44AD5(iLocal_253[iVar0], Global_96073, &(Local_526[iVar0 /*16*/]), &cLocal_345, 8f, -1000f, 0, 1148846080);
				}
			}
			iVar0++;
		}
...
void func_47()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_243)
		{
			...
			if (!unk_0xEA6BC48857E0AC4C(&(Local_691[iVar0 /*16*/])))
			{
				unk_0x4E09E67A27F104A7(&(Local_691[iVar0 /*16*/]));
				if (!unk_0x59F02DA2266A744C(&(Local_691[iVar0 /*16*/])))
				{
					bVar2 = false;
				}
			}
		...
		unk_0x3F423BF5B8125A50(&cLocal_345);
		if (!unk_0xB4AE0788C1587752(&cLocal_345))
		{
			bVar2 = false;
			unk_0x3F423BF5B8125A50(&cLocal_345);
		}
	...
	while (iVar0 < iLocal_237)
	{
		if (iLocal_243[iVar0] != 0)
		{
			iLocal_237[iVar0] = unk_0x36F2404464202779(26, iLocal_243[iVar0], Local_273 + Local_277[iVar0 /*3*/], 0, 1, 1);
			...
			unk_0xAFF39FB306F8E232(iLocal_237[iVar0], 13, 0);
			unk_0xAFF39FB306F8E232(iLocal_237[iVar0], 17, 1);
			unk_0xC6EB89C59F2AF6B8(iLocal_237[iVar0], &cLocal_345, &(Local_361[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, 0, 0, 0);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_253)
	{
		if (iLocal_256[iVar0] != 0)
		{
			iLocal_253[iVar0] = unk_0x7707E48765093646(iLocal_256[iVar0], Local_273 + Local_277[iVar0 /*3*/] + Local_259[iVar0 /*3*/], 1, 1, 0);
			unk_0xC023D1C4BF532815(iLocal_253[iVar0], Vector((fLocal_276 + fLocal_291[iVar0]), 0f, 0f) + Local_266[iVar0 /*3*/], 2, 1);
			if (!unk_0xEA6BC48857E0AC4C(&(Local_526[iVar0 /*16*/])))
			{
				unk_0xD65E6E13E145467B(iLocal_253[iVar0], &(Local_526[iVar0 /*16*/]), &cLocal_345, 8f, 1, 0, 0, 0, 0);
			}
		}
		iVar0++;
	}
...
void func_48()
{
	...
	switch (iLocal_70)
	{
		case 237:
			...
			fLocal_729 = 0.15f;
			Local_277[0 /*3*/] = { unk_0x79833B02DBD2A244(-10f, 10f), unk_0x79833B02DBD2A244(-10f, 10f), 0f };
			Local_277[1 /*3*/] = { unk_0x79833B02DBD2A244(-10f, 10f), unk_0x79833B02DBD2A244(-10f, 10f), 0f };
		...
		case 244:
			...
			StringCopy(&(Local_427[0 /*16*/]), "", 64);
			Local_277[0 /*3*/] = { unk_0x79833B02DBD2A244(-5f, 5f), unk_0x79833B02DBD2A244(-5f, 5f), 0f };
...
void func_58()
{
	...
	unk_0x8D17794CE3273D70(&cLocal_345);
	if (unk_0x7AEFFBD77F2CF1EC(uLocal_252))
	{
		unk_0x4064D48958EACC19(uLocal_252);
	}
