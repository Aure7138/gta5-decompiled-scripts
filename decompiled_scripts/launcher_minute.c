...
void __EntryFunction__()
{
	...
	if (Var0.f_0 == 32)
	{
		unk_0x5B40EC93D0367189(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0, 1);
		unk_0x2FA9C6D79054F1BE(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
		unk_0xEFA71310CAEBAE1F(Var61, 40f, 1, 0, 0, 0);
	}
	else if (Var0.f_0 == 34)
	{
		uLocal_97 = func_226();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 32)
		{
			...
			{
				if (!func_188(329.513f, 3402.691f, 36.258f, unk_0xA8CFDE65C45F813B(Var0.f_35[1], 1), 1056964608))
				{
...
int func_168(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_111(unk_0x27D769C59BC9D030()) && func_111(iParam0->f_28[0])) && !func_130()) && (unk_0xA0F74982C6AAA9D4() - iParam0->f_60) > iParam8) && func_172(unk_0x27D769C59BC9D030(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_173(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_159(2))
		{
			if (!func_130())
			{
				if (((func_111(unk_0x27D769C59BC9D030()) && func_111(iParam0->f_28[0])) && func_111(iParam0->f_28[1])) && func_172(unk_0x27D769C59BC9D030(), Param1, 1) < 20f)
				{
			...
			else if (((func_175(sParam5) && !*uParam10 == 1) && func_111(unk_0x27D769C59BC9D030())) && func_172(unk_0x27D769C59BC9D030(), Param1, 1) >= 20f)
			{
				func_271("pause conversation");
				func_174(1);
				*uParam10 = 1;
			}
			if (func_172(unk_0x27D769C59BC9D030(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_177(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x2DB75A8F096AB1F1(unk_0x4D29100D094E5511()))
	{
		if (!unk_0x75CB9E30BA492FF0(sParam1))
		{
			...
			{
				if (func_172(unk_0x27D769C59BC9D030(), Param2, 1) <= 100f)
				{
					func_180(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_172(unk_0x27D769C59BC9D030(), Param2, 1) > 120f)
				{
					func_182(iParam0);
				}
			}
			...
			if (unk_0xD2CFFE76B625AE55(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_198(unk_0x27D769C59BC9D030(), uParam0->f_35[iVar0]))
							{
...
int func_201(int iParam0, float fParam1)
{
	...
	{
		if (func_212(iParam0) || unk_0x3FB18423318A562B(unk_0x4D29100D094E5511(), iParam0))
		{
...
{
	return func_203(iParam0, unk_0x27D769C59BC9D030(), fParam1, 1, 250, 7);
}
...
int func_216(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_209(Param1 - unk_0xA8CFDE65C45F813B(uParam0, 1)) };
...
int func_239(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x88172B3983EC5071("rcmminute1");
			unk_0xEFA71310CAEBAE1F(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			unk_0xEFA71310CAEBAE1F(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			if (!func_236(&iVar0) || !unk_0x482101C9B3483958("rcmminute1"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!unk_0xD2CFFE76B625AE55(uParam0->f_28[1]))
			{
				if (func_231(&(uParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
					...
					unk_0x2F228A16D7B61C5F(uParam0->f_28[1], 1, 0, 0, 0);
				}
				else
				{
					bVar6 = false;
			...
			if (!unk_0xD2CFFE76B625AE55(uParam0->f_35[1]))
			{
				...
				unk_0xAF18A34434FDEA9C(uParam0->f_35[1], 0);
			}
			if (bVar6)
			{
				iLocal_91 = 3;
		...
		case 3:
			if (unk_0x482101C9B3483958("rcmminute1"))
			{
				if (func_111(uParam0->f_28[0]))
				{
					if (!unk_0xF4954568C87BA772(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						unk_0xF156AA2A744B309E(uParam0->f_28[0]);
						unk_0x878D12AEFBF5BAF0(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (func_111(uParam0->f_28[1]))
				{
					...
					unk_0x878D12AEFBF5BAF0(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x56F64CC9254C2E4F(uParam0->f_28[1], 185, 1);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
void func_240(int iParam0, var uParam1)
{
	if (unk_0xD2CFFE76B625AE55(uParam0))
	{
		unk_0xFF67B6EC799C2F15(iParam0, 0);
		unk_0x37B592C0F74990D2(iParam0, 2);
		unk_0x7C898812896A5304(uParam1, 1);
		unk_0x259CEB8F7994E17B(iParam0, 0, 0);
		unk_0x292E660CC707615A(iParam0, 1);
	}
}
...
void func_254(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		unk_0x5B40EC93D0367189(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 1, 1);
	}
	else if (*iParam0 == 34)
	{
