...
void __EntryFunction__()
{
	...
	if (Var0.f_0 == 32)
	{
		unk_0x3B4B46A2A779D56E(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0, 1);
		unk_0xC3033060E0409665(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
		unk_0x7EE425AE3317BA69(Var61, 40f, 1, 0, 0, 0);
	}
	else if (Var0.f_0 == 34)
	{
		uLocal_97 = func_239();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 32)
		{
			...
			{
				if (!func_201(329.513f, 3402.691f, 36.258f, unk_0x761660F5CE986DC4(Var0.f_35[1], 1), 1056964608))
				{
...
int func_181(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_123(unk_0x18F7BE9ACB7D08F4()) && func_123(iParam0->f_28[0])) && !func_142()) && (unk_0x5AFB8ED811F05E4D() - iParam0->f_60) > iParam8) && func_185(unk_0x18F7BE9ACB7D08F4(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_186(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_172(2))
		{
			if (!func_142())
			{
				if (((func_123(unk_0x18F7BE9ACB7D08F4()) && func_123(iParam0->f_28[0])) && func_123(iParam0->f_28[1])) && func_185(unk_0x18F7BE9ACB7D08F4(), Param1, 1) < 20f)
				{
			...
			else if (((func_188(sParam5) && !*uParam10 == 1) && func_123(unk_0x18F7BE9ACB7D08F4())) && func_185(unk_0x18F7BE9ACB7D08F4(), Param1, 1) >= 20f)
			{
				func_284("pause conversation");
				func_187(1);
				*uParam10 = 1;
			}
			if (func_185(unk_0x18F7BE9ACB7D08F4(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_190(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x557001354138B7FB(unk_0x8CFC7D6E1DA5D304()))
	{
		if (!unk_0xFAFFA408239A026B(sParam1))
		{
			...
			{
				if (func_185(unk_0x18F7BE9ACB7D08F4(), Param2, 1) <= 100f)
				{
					func_193(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_185(unk_0x18F7BE9ACB7D08F4(), Param2, 1) > 120f)
				{
					func_195(iParam0);
				}
			}
...
void func_203()
{
	...
	{
		unk_0x42488C0044DA7469("Joe", 1, 0, 0, 0);
		unk_0x42488C0044DA7469("Josef", 0, 0, 0, 0);
		unk_0x42488C0044DA7469("Josef", 1, 0, 0, 0);
	}
}
			...
			if (unk_0x31F12808DC47A9E5(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_211(unk_0x18F7BE9ACB7D08F4(), uParam0->f_35[iVar0]))
							{
...
int func_214(int iParam0, float fParam1)
{
	...
	{
		if (func_225(iParam0) || unk_0xF905401F186A9803(unk_0x8CFC7D6E1DA5D304(), iParam0))
		{
...
{
	return func_216(iParam0, unk_0x18F7BE9ACB7D08F4(), fParam1, 1, 250, 7);
}
...
int func_220(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_222(unk_0x761660F5CE986DC4(iParam1, 1) - unk_0x761660F5CE986DC4(iParam0, 1)) };
	...
	{
		Var3 = { func_222(unk_0x433176BD83D09D7E(iParam0, 31086, 0f, 5f, 0f) - unk_0x433176BD83D09D7E(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_229(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_222(Param1 - unk_0x761660F5CE986DC4(uParam0, 1)) };
...
{
	if ((func_237() && Global_92829.f_11 == 6) && iParam0 == func_161(&(Global_92829.f_3), 0))
	{
		return 1;
	}
	return 0;
...
var func_239()
{
	return unk_0x1701E0E6A11D6B65(-309.1f, 6205.4f, 30f, -279.33f, 6217.98f, 40f, 0, 1, 1, 1);
}
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x31F12808DC47A9E5(uParam0->f_35[1]))
			{
				...
				unk_0xB447DBA72E281B1B(uParam0->f_35[1], 0);
			...
			if (!unk_0x31F12808DC47A9E5(uParam0->f_41[1]))
			{
				...
				unk_0x947CE5CCDDBA0651(uParam0->f_41[1], uParam0->f_28[0], unk_0xCA57A734FF47CDF5(uParam0->f_28[0], 18905), 0.12f, 0f, 0.03f, 90f, 0f, 90f, 0, 0, 0, 0, 2, 1);
			}
			if (bVar7)
			{
				iLocal_91 = 3;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (unk_0x31F12808DC47A9E5(uParam0->f_35[0]))
			{
				...
				unk_0xD5D1BF12DEFE6979(uParam0->f_35[0], 14f);
				unk_0x116D235ABEF5CE46(iVar0[0], 1);
			}
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
...
int func_252(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x831CD0FBFB26EC7E("rcmminute1");
			unk_0x7EE425AE3317BA69(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			unk_0x7EE425AE3317BA69(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			if (!func_249(&iVar0) || !unk_0x028356968FDD2DF2("rcmminute1"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!unk_0x31F12808DC47A9E5(uParam0->f_28[1]))
			{
				if (func_244(&(uParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
					...
					unk_0xD8D896F64358DA36(uParam0->f_28[1], 1, 0, 0, 0);
				}
				else
				{
					bVar6 = false;
			...
			if (!unk_0x31F12808DC47A9E5(uParam0->f_35[1]))
			{
				...
				unk_0x98AB858AD44F622D(uParam0->f_35[1], 0);
			}
			if (bVar6)
			{
				iLocal_91 = 3;
		...
		case 3:
			if (unk_0x028356968FDD2DF2("rcmminute1"))
			{
				if (func_123(uParam0->f_28[0]))
				{
					if (!unk_0xDFEB6D8BCE2B43F6(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						unk_0x267F7A2DFDFFB077(uParam0->f_28[0]);
						unk_0xB5746603774C4C9D(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (func_123(uParam0->f_28[1]))
				{
					...
					unk_0xB5746603774C4C9D(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x764AFC5A3A16C2B0(uParam0->f_28[1], 185, 1);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
void func_253(int iParam0, var uParam1)
{
	if (unk_0x31F12808DC47A9E5(uParam0))
	{
		unk_0x5B8B17345AD1581B(iParam0, 0);
		unk_0xA2B45B1D3EE42178(iParam0, 2);
		unk_0x116D235ABEF5CE46(uParam1, 1);
		unk_0x6780B033CB86560E(iParam0, 0, 0);
		unk_0x4D8AAF889D588F4D(iParam0, 1);
	}
}
...
void func_267(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		unk_0x3B4B46A2A779D56E(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 1, 1);
	}
	else if (*iParam0 == 34)
	{
