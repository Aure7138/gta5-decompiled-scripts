...
void __EntryFunction__()
{
	...
	if (Var0.f_0 == 32)
	{
		...
		unk_0x2094BC4B6731BA68(Var61, 40f, 1, 0, 0, 0);
	}
	else if (Var0.f_0 == 34)
	{
		uLocal_97 = func_250();
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_132(unk_0x4A8C381C258A124D()) && func_132(iParam0->f_28[0])) && !func_151()) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam8) && func_196(unk_0x4A8C381C258A124D(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_183(2))
		{
			...
			else if (((func_199(sParam5) && !*uParam10 == 1) && func_132(unk_0x4A8C381C258A124D())) && func_196(unk_0x4A8C381C258A124D(), Param1, 1) >= 20f)
			{
				func_295("pause conversation");
				func_198(1);
				*uParam10 = 1;
			}
			if (func_196(unk_0x4A8C381C258A124D(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
int func_231(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var3 = { func_233(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
