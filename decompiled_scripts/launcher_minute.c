...
void __EntryFunction__()
{
	...
	if (Var0.f_0 == 32)
	{
		unk_0xC7210908156431E0(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0, 1);
		unk_0xD1D6EEB3AEFA757C(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f));
		unk_0x84710FE7666EBF7B(Var61, 40f, 1, 0, 0, 0);
	}
	else if (Var0.f_0 == 34)
	{
		uLocal_96 = func_225();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 32)
		{
			...
			{
				if (!func_187(329.513f, 3402.691f, 36.258f, unk_0xBF8499F46AD9093A(Var0.f_35[1], 1), 1056964608))
				{
...
int func_167(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_111(unk_0xA16EC202D9D35357()) && func_111(iParam0->f_28[0])) && !func_129()) && (unk_0x09560C7DE2A384BD() - iParam0->f_60) > iParam8) && func_171(unk_0xA16EC202D9D35357(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_172(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_158(2))
		{
			if (!func_129())
			{
				if (((func_111(unk_0xA16EC202D9D35357()) && func_111(iParam0->f_28[0])) && func_111(iParam0->f_28[1])) && func_171(unk_0xA16EC202D9D35357(), Param1, 1) < 20f)
				{
			...
			else if (((func_174(sParam5) && !*uParam10 == 1) && func_111(unk_0xA16EC202D9D35357())) && func_171(unk_0xA16EC202D9D35357(), Param1, 1) >= 20f)
			{
				func_270("pause conversation");
				func_173(1);
				*uParam10 = 1;
			}
			if (func_171(unk_0xA16EC202D9D35357(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_176(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x2AF80829930084FD(unk_0x1788E93557766241()))
	{
		if (!unk_0x06771AF7795B3ECF(sParam1))
		{
			...
			{
				if (func_171(unk_0xA16EC202D9D35357(), Param2, 1) <= 100f)
				{
					func_179(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_171(unk_0xA16EC202D9D35357(), Param2, 1) > 120f)
				{
					func_181(iParam0);
				}
			}
			...
			if (unk_0x538DF9E5B1DF01EB(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_197(unk_0xA16EC202D9D35357(), uParam0->f_35[iVar0]))
							{
...
int func_200(int iParam0, float fParam1)
{
	...
	{
		if (func_211(iParam0) || unk_0xCE95EFC08A74C6D8(unk_0x1788E93557766241(), iParam0))
		{
...
{
	return func_202(iParam0, unk_0xA16EC202D9D35357(), fParam1, 1, 250, 7);
}
...
int func_206(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_208(unk_0xBF8499F46AD9093A(iParam1, 1) - unk_0xBF8499F46AD9093A(iParam0, 1)) };
	...
	{
		Var3 = { func_208(unk_0xCDC62EA66023BC94(iParam0, 31086, 0f, 5f, 0f) - unk_0xCDC62EA66023BC94(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_215(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_208(Param1 - unk_0xBF8499F46AD9093A(uParam0, 1)) };
...
{
	if ((func_223() && Global_90042.f_11 == 6) && iParam0 == func_147(&(Global_90042.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_238(var uParam0)
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			unk_0x3D28909AF30D70F4("rcmminute1");
			unk_0x84710FE7666EBF7B(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			iLocal_90 = 1;
			break;
		
		case 1:
			unk_0x84710FE7666EBF7B(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			if (!func_235(&iVar0) || !unk_0x6C47E32491756A1A("rcmminute1"))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			...
			if (!unk_0x538DF9E5B1DF01EB(uParam0->f_28[1]))
			{
				if (func_230(&(uParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
					...
					unk_0xD8C28445617D0902(uParam0->f_28[1], 1, 0, 0, 0);
				}
				else
				{
					bVar6 = false;
			...
			if (!unk_0x538DF9E5B1DF01EB(uParam0->f_35[1]))
			{
				...
				unk_0xF819510E1E1025C4(uParam0->f_35[1], 0);
			}
			if (bVar6)
			{
				iLocal_90 = 3;
		...
		case 3:
			if (unk_0x6C47E32491756A1A("rcmminute1"))
			{
				if (func_111(uParam0->f_28[0]))
				{
					if (!unk_0x95EDB2DEFA5BB405(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						unk_0x937785D9C1929236(uParam0->f_28[0]);
						unk_0x5B5659C49032B96C(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (func_111(uParam0->f_28[1]))
				{
					...
					unk_0x5B5659C49032B96C(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0xA1478EBA54DDE31B(uParam0->f_28[1], 185, 1);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
void func_239(int iParam0, var uParam1)
{
	if (unk_0x538DF9E5B1DF01EB(uParam0))
	{
		unk_0x9B50549E01094E48(iParam0, 0);
		unk_0x542B8BF5C21F2470(iParam0, 2);
		unk_0x32DC163A33A4AB6D(uParam1, 1);
		unk_0x58E0272CBA220320(iParam0, 0, 0);
		unk_0x5CDB4C8C611F6B1A(iParam0, 1);
	}
}
...
void func_253(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		unk_0xC7210908156431E0(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 1, 1);
	}
	else if (*iParam0 == 34)
	{
