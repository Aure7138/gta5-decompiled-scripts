...
void __EntryFunction__()
{
	...
	if (Var0.f_0 == 32)
	{
		unk_0x20A9229D8F4F054A(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0, 1);
		unk_0x24266D999C1121E2(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
		unk_0x333EF04F1A5ADEB5(Var61, 40f, 1, 0, 0, 0);
	}
	else if (Var0.f_0 == 34)
	{
		uLocal_97 = func_239();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 32)
		{
			...
			{
				if (!func_201(329.513f, 3402.691f, 36.258f, unk_0xD1EE0E9FCD74A37B(Var0.f_35[1], 1), 1056964608))
				{
...
int func_181(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_123(unk_0x2A5EB8B0FE590B91()) && func_123(iParam0->f_28[0])) && !func_142()) && (unk_0x3732B96D7A1859B4() - iParam0->f_60) > iParam8) && func_185(unk_0x2A5EB8B0FE590B91(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_186(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_172(2))
		{
			if (!func_142())
			{
				if (((func_123(unk_0x2A5EB8B0FE590B91()) && func_123(iParam0->f_28[0])) && func_123(iParam0->f_28[1])) && func_185(unk_0x2A5EB8B0FE590B91(), Param1, 1) < 20f)
				{
			...
			else if (((func_188(sParam5) && !*uParam10 == 1) && func_123(unk_0x2A5EB8B0FE590B91())) && func_185(unk_0x2A5EB8B0FE590B91(), Param1, 1) >= 20f)
			{
				func_284("pause conversation");
				func_187(1);
				*uParam10 = 1;
			}
			if (func_185(unk_0x2A5EB8B0FE590B91(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_190(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0xB8B285A272E7A79E(unk_0x0FFED3E94261A832()))
	{
		if (!unk_0x58478145CAF8429C(sParam1))
		{
			...
			{
				if (func_185(unk_0x2A5EB8B0FE590B91(), Param2, 1) <= 100f)
				{
					func_193(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_185(unk_0x2A5EB8B0FE590B91(), Param2, 1) > 120f)
				{
					func_195(iParam0);
				}
			}
...
void func_203()
{
	...
	{
		unk_0xA33C0B84EC296D92("Joe", 1, 0, 0, 0);
		unk_0xA33C0B84EC296D92("Josef", 0, 0, 0, 0);
		unk_0xA33C0B84EC296D92("Josef", 1, 0, 0, 0);
	}
}
			...
			if (unk_0x2137828D03306CAF(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_211(unk_0x2A5EB8B0FE590B91(), uParam0->f_35[iVar0]))
							{
...
int func_214(int iParam0, float fParam1)
{
	...
	{
		if (func_225(iParam0) || unk_0xE97AF56371F08BE1(unk_0x0FFED3E94261A832(), iParam0))
		{
...
{
	return func_216(iParam0, unk_0x2A5EB8B0FE590B91(), fParam1, 1, 250, 7);
}
...
int func_220(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_222(unk_0xD1EE0E9FCD74A37B(iParam1, 1) - unk_0xD1EE0E9FCD74A37B(iParam0, 1)) };
	...
	{
		Var3 = { func_222(unk_0x585F703DF3E83B6E(iParam0, 31086, 0f, 5f, 0f) - unk_0x585F703DF3E83B6E(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_229(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_222(Param1 - unk_0xD1EE0E9FCD74A37B(uParam0, 1)) };
...
{
	if ((func_237() && Global_91777.f_11 == 6) && iParam0 == func_161(&(Global_91777.f_3), 0))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (unk_0x2137828D03306CAF(uParam0->f_35[0]))
			{
				...
				unk_0x170792970BF5726F(uParam0->f_35[0], 14f);
				unk_0x02E663D7DDAE8202(iVar0[0], 1);
			}
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
...
int func_252(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0xA7C81DED990D3418("rcmminute1");
			unk_0x333EF04F1A5ADEB5(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			unk_0x333EF04F1A5ADEB5(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			if (!func_249(&iVar0) || !unk_0x45834D6C20FFF689("rcmminute1"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!unk_0x2137828D03306CAF(uParam0->f_28[1]))
			{
				if (func_244(&(uParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
					...
					unk_0xDEC831C0189DE207(uParam0->f_28[1], 1, 0, 0, 0);
				}
				else
				{
					bVar6 = false;
			...
			if (!unk_0x2137828D03306CAF(uParam0->f_35[1]))
			{
				...
				unk_0xBB7DA429845F53D4(uParam0->f_35[1], 0);
			}
			if (bVar6)
			{
				iLocal_91 = 3;
		...
		case 3:
			if (unk_0x45834D6C20FFF689("rcmminute1"))
			{
				if (func_123(uParam0->f_28[0]))
				{
					if (!unk_0x453DB1DBE5D81637(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						unk_0x654FFF4D16298AC5(uParam0->f_28[0]);
						unk_0xF1C3427BFED79E6B(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (func_123(uParam0->f_28[1]))
				{
					...
					unk_0xF1C3427BFED79E6B(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x31AC59B7C21A2047(uParam0->f_28[1], 185, 1);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
void func_253(int iParam0, var uParam1)
{
	if (unk_0x2137828D03306CAF(uParam0))
	{
		unk_0x3D7CDF71C4AF0392(iParam0, 0);
		unk_0xD1A53D507962BF1F(iParam0, 2);
		unk_0x02E663D7DDAE8202(uParam1, 1);
		unk_0xD3E5E6DE4F3CED03(iParam0, 0, 0);
		unk_0xCFE4626F633D6C6A(iParam0, 1);
	}
}
...
void func_267(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		unk_0x20A9229D8F4F054A(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 1, 1);
	}
	else if (*iParam0 == 34)
	{
