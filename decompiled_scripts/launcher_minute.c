...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Var0.f_0 == 32)
		{
			...
			{
				if (!func_209(329.513f, 3402.691f, 36.258f, unk_0x6B62510F212526DC(Var0.f_35[1], 1), 1056964608))
				{
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_129(unk_0xE2D3D51028F0428A()) && func_129(iParam0->f_28[0])) && !func_148()) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam8) && func_193(unk_0xE2D3D51028F0428A(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_194(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_180(2))
		{
			if (!func_148())
			{
				if (((func_129(unk_0xE2D3D51028F0428A()) && func_129(iParam0->f_28[0])) && func_129(iParam0->f_28[1])) && func_193(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f)
				{
			...
			else if (((func_196(sParam5) && !*uParam10 == 1) && func_129(unk_0xE2D3D51028F0428A())) && func_193(unk_0xE2D3D51028F0428A(), Param1, 1) >= 20f)
			{
				func_292("pause conversation");
				func_195(1);
				*uParam10 = 1;
			}
			if (func_193(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_198(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		if (!unk_0xACC32B78196FBC2A(sParam1))
		{
			...
			{
				if (func_193(unk_0xE2D3D51028F0428A(), Param2, 1) <= 100f)
				{
					func_201(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_193(unk_0xE2D3D51028F0428A(), Param2, 1) > 120f)
				{
					func_203(iParam0);
				}
			}
...
void func_213(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_129(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_215(uParam1) || !unk_0xFCF559C8631ABED7(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_214(iParam2) && !unk_0x2E7F5417D4F4DD69(iParam0, unk_0xE2D3D51028F0428A(), 25f))
					{
						unk_0x529D306014D3C29A(iParam0, unk_0xE2D3D51028F0428A(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_215(uParam1) && uParam1->f_4 == 0) && unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_214(iParam2) || unk_0x2E7F5417D4F4DD69(iParam0, unk_0xE2D3D51028F0428A(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x49D97B076E3590AC(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0xE5965CDF24F93A9F(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_219(unk_0xE2D3D51028F0428A(), uParam0->f_35[iVar0]))
							{
...
{
	return func_224(iParam0, unk_0xE2D3D51028F0428A(), fParam1, 1, 250, 7);
}
...
int func_228(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_230(unk_0x6B62510F212526DC(iParam1, 1) - unk_0x6B62510F212526DC(iParam0, 1)) };
	...
	{
		Var3 = { func_230(unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_237(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_230(Param1 - unk_0x6B62510F212526DC(uParam0, 1)) };
...
int func_260(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			unk_0x7A997A0A971D305F(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			if (!func_257(&iVar0) || !unk_0x6F940C2636C076AD("rcmminute1"))
			{
				return 0;
			}
			iLocal_91 = 2;
