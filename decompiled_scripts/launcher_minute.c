...
void __EntryFunction__()
{
	...
	if (Var0.f_0 == 32)
	{
		unk_0xE6C975AE756267A4(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0, 1);
		unk_0xEBFD2617C2981F31(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
		unk_0x500FFA49AC5ABB1D(Var61, 40f, 1, 0, 0, 0);
	}
	else if (Var0.f_0 == 34)
	{
		uLocal_97 = func_228();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 32)
		{
			...
			{
				if (!func_190(329.513f, 3402.691f, 36.258f, unk_0xC086F8D75730FA3A(Var0.f_35[1], 1), 1056964608))
				{
...
int func_170(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_112(unk_0xD5A676B97920D126()) && func_112(iParam0->f_28[0])) && !func_131()) && (unk_0x84A97C70FFDEC0C8() - iParam0->f_60) > iParam8) && func_174(unk_0xD5A676B97920D126(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_175(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_161(2))
		{
			if (!func_131())
			{
				if (((func_112(unk_0xD5A676B97920D126()) && func_112(iParam0->f_28[0])) && func_112(iParam0->f_28[1])) && func_174(unk_0xD5A676B97920D126(), Param1, 1) < 20f)
				{
			...
			else if (((func_177(sParam5) && !*uParam10 == 1) && func_112(unk_0xD5A676B97920D126())) && func_174(unk_0xD5A676B97920D126(), Param1, 1) >= 20f)
			{
				func_273("pause conversation");
				func_176(1);
				*uParam10 = 1;
			}
			if (func_174(unk_0xD5A676B97920D126(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_179(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x9BA2465846EC8271(unk_0xFB6B3EEFAB2DD12C()))
	{
		if (!unk_0xC55B9553B3EDADE9(sParam1))
		{
			...
			{
				if (func_174(unk_0xD5A676B97920D126(), Param2, 1) <= 100f)
				{
					func_182(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_174(unk_0xD5A676B97920D126(), Param2, 1) > 120f)
				{
					func_184(iParam0);
				}
			}
...
void func_192()
{
	...
	{
		unk_0x216C3CC1BCD1E9D7("Joe", 1, 0, 0, 0);
		unk_0x216C3CC1BCD1E9D7("Josef", 0, 0, 0, 0);
		unk_0x216C3CC1BCD1E9D7("Josef", 1, 0, 0, 0);
	}
}
			...
			if (unk_0x7887B64A08364778(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_200(unk_0xD5A676B97920D126(), uParam0->f_35[iVar0]))
							{
...
int func_203(int iParam0, float fParam1)
{
	...
	{
		if (func_214(iParam0) || unk_0x982AB85BDD884D31(unk_0xFB6B3EEFAB2DD12C(), iParam0))
		{
...
{
	return func_205(iParam0, unk_0xD5A676B97920D126(), fParam1, 1, 250, 7);
}
...
int func_209(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_211(unk_0xC086F8D75730FA3A(iParam1, 1) - unk_0xC086F8D75730FA3A(iParam0, 1)) };
	...
	{
		Var3 = { func_211(unk_0x6DE9A8183DA7678E(iParam0, 31086, 0f, 5f, 0f) - unk_0x6DE9A8183DA7678E(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_218(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_211(Param1 - unk_0xC086F8D75730FA3A(uParam0, 1)) };
...
{
	if ((func_226() && Global_91486.f_11 == 6) && iParam0 == func_150(&(Global_91486.f_3), 0))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (unk_0x7887B64A08364778(uParam0->f_35[0]))
			{
				...
				unk_0xDC5873FE07F6821C(uParam0->f_35[0], 14f);
				unk_0xFA03BA297FE81584(iVar0[0], 1);
			}
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
...
int func_241(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x49E996A1E39EAAD7("rcmminute1");
			unk_0x500FFA49AC5ABB1D(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			unk_0x500FFA49AC5ABB1D(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			if (!func_238(&iVar0) || !unk_0xD7669BF035CDA5F6("rcmminute1"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!unk_0x7887B64A08364778(uParam0->f_28[1]))
			{
				if (func_233(&(uParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
					...
					unk_0xA89A57E40879561F(uParam0->f_28[1], 1, 0, 0, 0);
				}
				else
				{
					bVar6 = false;
			...
			if (!unk_0x7887B64A08364778(uParam0->f_35[1]))
			{
				...
				unk_0xFF4749958FDEC48C(uParam0->f_35[1], 0);
			}
			if (bVar6)
			{
				iLocal_91 = 3;
		...
		case 3:
			if (unk_0xD7669BF035CDA5F6("rcmminute1"))
			{
				if (func_112(uParam0->f_28[0]))
				{
					if (!unk_0xEBA40DFF7CCE3511(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						unk_0x37338B7B7C4982DC(uParam0->f_28[0]);
						unk_0x290A57C93304EF16(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (func_112(uParam0->f_28[1]))
				{
					...
					unk_0x290A57C93304EF16(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x237B0CFB6EEBD3BA(uParam0->f_28[1], 185, 1);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
void func_242(int iParam0, var uParam1)
{
	if (unk_0x7887B64A08364778(uParam0))
	{
		unk_0xB00AE7B9B8ED8B33(iParam0, 0);
		unk_0xAFC3B32426D08964(iParam0, 2);
		unk_0xFA03BA297FE81584(uParam1, 1);
		unk_0x4790D4CCED5150A0(iParam0, 0, 0);
		unk_0x7E1EA48517D28990(iParam0, 1);
	}
}
...
void func_256(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		unk_0xE6C975AE756267A4(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 1, 1);
	}
	else if (*iParam0 == 34)
	{
