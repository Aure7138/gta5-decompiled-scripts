...
void __EntryFunction__()
{
	...
	if (Var0.f_0 == 32)
	{
		unk_0x8E09E8C52602EBB2(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0, 1);
		unk_0xC6AD633F6B896D88(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
		unk_0xF82BC5193AF62796(Var61, 40f, 1, 0, 0, 0);
	}
	else if (Var0.f_0 == 34)
	{
		uLocal_97 = func_250();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 32)
		{
			...
			{
				if (!func_212(329.513f, 3402.691f, 36.258f, unk_0x30BE8A934C020461(Var0.f_35[1], 1), 1056964608))
				{
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_132(unk_0xC1A5EC5C986B98AD()) && func_132(iParam0->f_28[0])) && !func_151()) && (unk_0xA5E11AF0A2B928C1() - iParam0->f_60) > iParam8) && func_196(unk_0xC1A5EC5C986B98AD(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_183(2))
		{
			if (!func_151())
			{
				if (((func_132(unk_0xC1A5EC5C986B98AD()) && func_132(iParam0->f_28[0])) && func_132(iParam0->f_28[1])) && func_196(unk_0xC1A5EC5C986B98AD(), Param1, 1) < 20f)
				{
			...
			else if (((func_199(sParam5) && !*uParam10 == 1) && func_132(unk_0xC1A5EC5C986B98AD())) && func_196(unk_0xC1A5EC5C986B98AD(), Param1, 1) >= 20f)
			{
				func_295("pause conversation");
				func_198(1);
				*uParam10 = 1;
			}
			if (func_196(unk_0xC1A5EC5C986B98AD(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_201(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(sParam1))
		{
			...
			{
				if (func_196(unk_0xC1A5EC5C986B98AD(), Param2, 1) <= 100f)
				{
					func_204(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_196(unk_0xC1A5EC5C986B98AD(), Param2, 1) > 120f)
				{
					func_206(iParam0);
				}
			}
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_222(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[iVar0]))
							{
...
int func_225(int iParam0, float fParam1)
{
	...
	{
		if (func_236(iParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), iParam0))
		{
...
{
	return func_227(iParam0, unk_0xC1A5EC5C986B98AD(), fParam1, 1, 250, 7);
}
...
int func_231(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_233(unk_0x30BE8A934C020461(iParam1, 1) - unk_0x30BE8A934C020461(iParam0, 1)) };
	...
	{
		Var3 = { func_233(unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_240(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_233(Param1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
int func_263(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			unk_0xF82BC5193AF62796(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			if (!func_260(&iVar0) || !unk_0x2BBF749E555360DC("rcmminute1"))
			{
				return 0;
			}
			iLocal_91 = 2;
...
void func_264(int iParam0, var uParam1)
{
	if (unk_0x7DE17ACDD8BA2642(uParam0))
	{
		unk_0xE89126C47B21ED30(iParam0, 0);
		unk_0x439314AD4FC79186(iParam0, 2);
		unk_0x9C56520AE72AFDBF(uParam1, 1);
		unk_0x495ED6976429C1E8(iParam0, 0, 0);
		unk_0x9D92700BDDC6B69B(iParam0, 1);
	}
}
...
void func_278(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		unk_0x8E09E8C52602EBB2(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 1, 1);
	}
	else if (*iParam0 == 34)
	{
