							...
							if (BitTest(Global_32543[iVar2 /*23*/].f_11, 19))
							{
								switch (iLocal_64)
								{
									...
									case 2:
										...
										{
											Global_32543[iVar2 /*23*/].f_19 = unk_0x34864AB7DA700AA6(Global_32543[iVar2 /*23*/][iLocal_64 /*3*/]);
											unk_0x4C905FB262965D5D(Global_32543[iVar2 /*23*/].f_19, Global_32543[iVar2 /*23*/].f_12[iLocal_64]);
										}
										break;
						...
						else
						{
							if (BitTest(Global_32543[iVar2 /*23*/].f_11, 19))
							{
								switch (iLocal_64)
								{
									...
									case 0:
									case 2:
										unk_0xDABC73EF230B6665(Global_32543[iVar2 /*23*/].f_19, Global_32543[iVar2 /*23*/][iLocal_64 /*3*/]);
										break;
...
void func_11()
{
	...
	while (iVar5 < 7)
	{
		...
		{
			if (unk_0xC450B06E5AAA0985(Global_32543[iLocal_55[iVar5] /*23*/].f_19))
			{
				fVar6 = unk_0xED977E2AE2CB16EE(Var0, unk_0x3CF9D442F2C902BD(Global_32543[iLocal_55[iVar5] /*23*/].f_19), 1);
				if (fVar6 < fVar4)
				{
					fVar4 = fVar6;
					iVar3 = iVar5;
	...
	while (iVar5 < 7)
	{
		if (iLocal_55[iVar5] != -1)
		{
			...
			else if (unk_0xC450B06E5AAA0985(Global_32543[iLocal_55[iVar5] /*23*/].f_19))
			{
...
int func_40()
{
	if (unk_0xE7B45027762DEFE7(unk_0xB6B621402486C3E4()) != iLocal_49)
	{
		iLocal_49 = unk_0xE7B45027762DEFE7(unk_0xB6B621402486C3E4());
		return 1;
	}
	return 0;
}
...
int func_41()
{
	...
	if (unk_0x5295501D0862870D() != iLocal_48)
	{
		iLocal_48 = unk_0x5295501D0862870D();
		return 1;
	}
	return 0;
}
