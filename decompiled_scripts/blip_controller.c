							...
							if (unk_0xCE990E643CD9D0E5(Global_31346[iVar2 /*23*/].f_11, 19))
							{
								switch (iLocal_64)
								{
									...
									case 2:
										...
										{
											Global_31346[iVar2 /*23*/].f_19 = unk_0x6820C712C1DD618A(Global_31346[iVar2 /*23*/][iLocal_64 /*3*/]);
											unk_0xE7B8403ABCA0391D(Global_31346[iVar2 /*23*/].f_19, Global_31346[iVar2 /*23*/].f_12[iLocal_64]);
										}
										break;
						...
						else
						{
							if (unk_0xCE990E643CD9D0E5(Global_31346[iVar2 /*23*/].f_11, 19))
							{
								switch (iLocal_64)
								{
									...
									case 0:
									case 2:
										unk_0xC96DB2548BD4EDDD(Global_31346[iVar2 /*23*/].f_19, Global_31346[iVar2 /*23*/][iLocal_64 /*3*/]);
										break;
			...
			if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
			{
				...
				else
				{
					...
					if (!func_9(138))
					{
						if (unk_0x7B70881748D166CD(joaat("chop")) == 0)
						{
							if (unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), -11.15f, -1425.56f, 29.67f, 1) > 50f)
							{
								func_8(138, 1, 0);
							}
						}
...
void func_11()
{
	...
	while (iVar5 < 7)
	{
		...
		{
			if (unk_0x8F678487EEBD8CE4(Global_31346[iLocal_55[iVar5] /*23*/].f_19))
			{
				fVar6 = unk_0x272784C60C397DB6(Var0, unk_0x41A1ED9BB4ED4772(Global_31346[iLocal_55[iVar5] /*23*/].f_19), 1);
				if (fVar6 < fVar4)
				{
					fVar4 = fVar6;
					iVar3 = iVar5;
	...
	while (iVar5 < 7)
	{
		if (iLocal_55[iVar5] != -1)
		{
			...
			else if (unk_0x8F678487EEBD8CE4(Global_31346[iLocal_55[iVar5] /*23*/].f_19))
			{
...
void func_20(var uParam0, int iParam1)
{
	...
	iVar0 = func_1();
	unk_0xA4B9414EAF344C79(uParam0, 1);
	unk_0xE346A71235BB8065(uParam0, 2);
	unk_0xECC9A00CF1181EC2(uParam0, func_22(iParam1));
	if (Global_31346[iParam1 /*23*/].f_16 == 4 || Global_31346[iParam1 /*23*/].f_16 == 8)
	{
		switch (iVar0)
		{
			case 0:
				unk_0xECC9A00CF1181EC2(uParam0, 42);
				break;
			
			case 1:
				unk_0xECC9A00CF1181EC2(uParam0, 43);
				break;
			
			case 2:
				unk_0xECC9A00CF1181EC2(uParam0, 44);
				break;
			}
	}
	...
	if (!unk_0x7BCC91F3C1CF24E8(&(Global_31346[iParam1 /*23*/].f_20)))
	{
		...
		{
			unk_0xB023F5C66F5716C7(uParam0, &(Global_31346[iParam1 /*23*/].f_20));
		}
	}
	...
	if (bVar3 && !bVar4)
	{
		unk_0x91136D871CEAF8CC(uParam0, false);
	}
	else
	{
		unk_0x91136D871CEAF8CC(uParam0, true);
	}
	if (bVar2 && bVar1)
	{
	...
	else
	{
		...
		if (bVar1)
		{
			unk_0x14C1B9C77E952C6F(uParam0, 3);
		}
	}
	switch (Global_31346[iParam1 /*23*/].f_16)
	{
		case 7:
			unk_0xE346A71235BB8065(uParam0, 2);
			unk_0x320DB6C68D1E5257(uParam0, 0);
			break;
		...
		case 1:
			unk_0xE346A71235BB8065(uParam0, 3);
			unk_0x320DB6C68D1E5257(uParam0, 1);
			break;
		
		case 9:
			unk_0xE346A71235BB8065(uParam0, 1);
			unk_0xE65136BD2DC219B0(uParam0, 10);
			unk_0x320DB6C68D1E5257(uParam0, 0);
			break;
		...
		case 8:
			...
			{
				unk_0xE346A71235BB8065(uParam0, 5);
			}
			if (unk_0xCE990E643CD9D0E5(Global_31346[iParam1 /*23*/].f_11, 8))
			{
				if (!func_29(iParam1))
				{
					...
					else
					{
						...
						{
							unk_0x91136D871CEAF8CC(uParam0, unk_0xCE990E643CD9D0E5(Global_31346[iParam1 /*23*/].f_11, 5));
							unk_0xE346A71235BB8065(uParam0, 3);
							unk_0x91136D871CEAF8CC(uParam0, true);
							unk_0xA84FFDABF9CF5108(uParam0, 1);
							unk_0xFA81E0FBD7F5ACA0(uParam0, 0.77f);
						}
						else
						{
							unk_0xFA81E0FBD7F5ACA0(uParam0, 0.72f);
						}
					}
				}
				else
				{
					if (unk_0xCE990E643CD9D0E5(Global_31346[iParam1 /*23*/].f_11, 28))
					{
						unk_0xB7F03636BDF7080E(uParam0, 128);
					}
					if (Global_31346[iParam1 /*23*/].f_16 == 8)
					{
						unk_0xA84FFDABF9CF5108(uParam0, 0);
					}
				}
			}
			break;
	...
	{
		unk_0xB19BFB8FADC36D3F(uParam0, 0);
	}
	if (unk_0xCE990E643CD9D0E5(Global_31346[iParam1 /*23*/].f_11, 20))
	{
		unk_0x015E25E7260FD30F(uParam0, 1);
	}
	else
	{
		unk_0x015E25E7260FD30F(uParam0, 0);
	}
	if (unk_0xCE990E643CD9D0E5(Global_31346[iParam1 /*23*/].f_11, 29))
	{
		unk_0xECC9A00CF1181EC2(uParam0, 39);
	}
}
...
{
	if (iLocal_68 && unk_0xCE990E643CD9D0E5(Global_31346[iParam0 /*23*/].f_11, 13))
	{
		unk_0xBE20AB8238688965(&(Global_31346[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if (iLocal_69 && ((unk_0xCE990E643CD9D0E5(Global_31346[iParam0 /*23*/].f_11, 7) || unk_0xCE990E643CD9D0E5(Global_31346[iParam0 /*23*/].f_11, 11)) || unk_0xCE990E643CD9D0E5(Global_31346[iParam0 /*23*/].f_11, 16)))
	{
		unk_0xBE20AB8238688965(&(Global_31346[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if (iLocal_70 && unk_0xCE990E643CD9D0E5(Global_31346[iParam0 /*23*/].f_11, 14))
	{
		unk_0xBE20AB8238688965(&(Global_31346[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if (iLocal_65 && ((unk_0xCE990E643CD9D0E5(Global_31346[iParam0 /*23*/].f_11, 10) || unk_0xCE990E643CD9D0E5(Global_31346[iParam0 /*23*/].f_11, 8)) || unk_0xCE990E643CD9D0E5(Global_31346[iParam0 /*23*/].f_11, 19)))
	{
		unk_0xBE20AB8238688965(&(Global_31346[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	...
	if (iLocal_72 && unk_0xCE990E643CD9D0E5(Global_31346[iParam0 /*23*/].f_11, 27))
	{
		unk_0xBE20AB8238688965(&(Global_31346[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if ((iLocal_73 && (unk_0xCE990E643CD9D0E5(Global_31346[iParam0 /*23*/].f_11, 1) || unk_0xCE990E643CD9D0E5(Global_31346[iParam0 /*23*/].f_11, 2))) || Global_31346[iParam0 /*23*/].f_16 == 1)
	{
		unk_0xBE20AB8238688965(&(Global_31346[iParam0 /*23*/].f_11), 18);
		return 1;
	}
...
int func_40()
{
	if (unk_0x1A3D0DF92BF7D8C4(unk_0x2639A2323BEA8CC6()) != iLocal_49)
	{
		iLocal_49 = unk_0x1A3D0DF92BF7D8C4(unk_0x2639A2323BEA8CC6());
		return 1;
	}
	return 0;
}
...
int func_41()
{
	...
	if (unk_0x1F596C965B00E290() != iLocal_48)
	{
		iLocal_48 = unk_0x1F596C965B00E290();
		return 1;
	}
	return 0;
}
