...
int func_74(int iParam0)
{
	...
	if (((!func_75(unk_0x259BE71D8A81D4FA()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger")) && !bVar0)
	{
		return 0;
	}
	return 1;
...
int func_133(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = unk_0x7B6C0A0D604E68FA(iParam3, 10, -1, 0, -1, func_121(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
void func_173(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar56 >= 0)
		{
			iVar57 = unk_0x7B6C0A0D604E68FA(iVar1, 10, -1, 0, -1, func_121(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_229(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	unk_0x4A3280817398D754(Param0, iParam5, 0);
	iVar0 = 0;
	while (!unk_0x9E2D35FA908F57B4() && iVar0 < iParam4)
	{
		iVar0++;
		unk_0x4EDE34FBADD967A6(0);
	}
