...
void __EntryFunction__()
{
	...
	if (unk_0x25531002BCF0D968(joaat("epsilontract")) > 1)
	{
...
void func_1()
{
	...
	if ((func_46(unk_0x507DA4994C3D8EBD()) && !func_45(14)) && !unk_0xC2C705ED6124A7C2())
	{
		if (iLocal_39 < 10)
		{
			if (iLocal_39 == 0)
			{
				if (!func_44(36) && (unk_0xF976C624234A4AA8() - iLocal_40) > iLocal_41)
				{
			...
			else if (iLocal_39 < 10)
			{
				if (!iLocal_40 == -1)
				{
					if ((unk_0xF976C624234A4AA8() - iLocal_40) > 15000)
					{
			...
			{
				if (unk_0x0561B9096FB80229(Local_47[iLocal_39 /*11*/].f_1) || func_41(Local_47[iLocal_39 /*11*/].f_1))
				{
					...
					iVar0 = (805 + iLocal_39);
					func_39(iVar0, 1, -1, 1);
					unk_0x2849EC95E9D69392(joaat("num_hidden_packages_2"), 1f);
					bLocal_44 = true;
					if (iLocal_39 < 10)
					{
						iLocal_39++;
				...
				else if (unk_0xBAE26BE2046B39E0(Local_47[iLocal_39 /*11*/].f_1))
				{
	...
	if (*bParam0)
	{
		switch (*uParam4)
		{
			case 0:
				*uParam5 = unk_0xAFBDE0BB5C885026("MIDSIZED_MESSAGE");
				if (unk_0xE908465F9CDF4F1A(*uParam5))
				{
					...
					if (iParam3 == 6)
					{
						unk_0x84795EA8F54230A1(iVar0, "PEYOTE_COMPLETED", "HUD_AWARDS", 1);
					}
					else
					{
						unk_0x84795EA8F54230A1(iVar0, "COLLECTED", "HUD_AWARDS", 1);
					}
					*uParam4++;
				}
				break;
			...
			case 1:
				...
				unk_0x844339A27F0F1508(func_4(iParam3));
				unk_0x113A6F657EE871A3();
...
int func_4(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (unk_0x61D8FEAF64881CDA(Global_97173.f_8270.f_108, func_10(func_11(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_17(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_18(unk_0x054BCC5519168683(&cVar2, &cVar2, 0, 2, unk_0xB0EEA0615087D74B(func_19(iParam1)), 0));
		}
		else
		{
			func_18(unk_0x054BCC5519168683("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, unk_0xB0EEA0615087D74B(func_19(iParam1)), 0));
		}
		switch (Global_14393)
		{
			case 0:
			...
			if (!func_45(13) && !func_45(14))
			{
				if (!unk_0xBAE26BE2046B39E0(uParam0->f_1))
				{
					if (unk_0xB7A628320EFF8E47(unk_0xBF1B13057E5119A4(unk_0x507DA4994C3D8EBD(), 1), uParam0->f_3) <= (50f * 50f))
					{
						...
						while (!unk_0xD291857D0C9C7FEC(iParam1))
						{
							unk_0xCBE6AC5010E5CE5C(iParam1);
							unk_0x4EDE34FBADD967A6(0);
						}
						...
						if (bParam4)
						{
							...
							uParam0->f_1 = unk_0x00D55FB1F137D220(joaat("pickup_custom_script"), uParam0->f_3, uParam0->f_6, uVar0, -1, iParam5, 1, iParam1);
						}
						else
						{
							...
							unk_0x3DBE2A7AF9E71C82(&uVar0, 1);
							uParam0->f_1 = unk_0x134AE1EC4D58EAE4(iParam2, uParam0->f_3, uVar0, -1, 1, iParam1);
						}
...
void func_33(var uParam0, var uParam1)
{
	if (!unk_0x9F94F2CFDCA78C55(unk_0x507DA4994C3D8EBD()))
	{
		if (unk_0x8FE221761D524CFE(unk_0xBF1B13057E5119A4(unk_0x507DA4994C3D8EBD(), 1), unk_0xC615E5E6E1D987A1(*uParam0), 1) >= 60f)
		{
			func_40(uParam0);
			*uParam0 = 0;
			*uParam1 = 0;
...
{
	if (func_35(unk_0x507DA4994C3D8EBD(), Param0, 7f))
	{
		unk_0xE6D93A0484388DB3(unk_0x507DA4994C3D8EBD(), Param0, 100, 2048, 1);
	}
}
