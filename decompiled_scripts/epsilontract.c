...
int func_4(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (unk_0xE2D0C323A1AE5D85(Global_112915.f_10049.f_108, func_8(func_9(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
{
	if (func_34(unk_0xE2D3D51028F0428A(), Param0, 7f))
	{
		unk_0xE1E1AF00CA06A2B7(unk_0xE2D3D51028F0428A(), Param0, 100, 2048, 1);
	}
}

bool func_34(var uParam0, struct<3> Param1, float fParam4)
{
