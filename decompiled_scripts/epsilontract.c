...
void __EntryFunction__()
{
	...
	if (unk_0x222F76006659B0EB(joaat("epsilontract")) > 1)
	{
...
void func_1()
{
	...
	if ((func_47(unk_0x0FA8183DAD2B3203()) && !func_46(14)) && !unk_0x260395BA7F0C83CB())
	{
		if (iLocal_41 < 10)
		{
			if (iLocal_41 == 0)
			{
				if (!func_45(36) && (unk_0x9B35D07DCD0F0B43() - iLocal_42) > iLocal_43)
				{
			...
			else if (iLocal_41 < 10)
			{
				if (!iLocal_42 == -1)
				{
					if ((unk_0x9B35D07DCD0F0B43() - iLocal_42) > 15000)
					{
			...
			{
				if (unk_0x21AD65E0E8A26E8C(Local_49[iLocal_41 /*11*/].f_1) || func_42(Local_49[iLocal_41 /*11*/].f_1))
				{
					...
					iVar0 = (805 + iLocal_41);
					func_40(iVar0, 1, -1, 1);
					unk_0x7EDBC2F023CB055F(joaat("num_hidden_packages_2"), 1f);
					bLocal_46 = true;
					if (iLocal_41 < 10)
					{
						iLocal_41++;
				...
				else if (unk_0x71FE36FB85146FC0(Local_49[iLocal_41 /*11*/].f_1))
				{
	...
	if (*bParam0)
	{
		switch (*uParam4)
		{
			case 0:
				*uParam5 = unk_0x1FAFE9BB9D8960C1("MIDSIZED_MESSAGE");
				if (unk_0x08EA887200715AD9(*uParam5))
				{
					...
					if (iParam3 == 6)
					{
						unk_0x9964F5BBD9415AB7(iVar0, "PEYOTE_COMPLETED", "HUD_AWARDS", 1);
					}
					else
					{
						unk_0x9964F5BBD9415AB7(iVar0, "COLLECTED", "HUD_AWARDS", 1);
					}
					*uParam4++;
				}
				break;
			...
			case 1:
				...
				unk_0x6A8B3CC08A759F44(func_4(iParam3));
				unk_0x81019766FF500CCA();
...
int func_4(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (unk_0xA2BC31158C8CEFD2(Global_111560.f_10044.f_108, func_10(func_11(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_17(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_18(unk_0x480C449653B881B1(&cVar2, &cVar2, 0, 2, unk_0xD54FB72F71EFE6C4(func_19(iParam1)), 0));
		}
		else
		{
			func_18(unk_0x480C449653B881B1("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, unk_0xD54FB72F71EFE6C4(func_19(iParam1)), 0));
		}
		switch (Global_19486)
		{
			case 0:
			...
			if (!func_46(13) && !func_46(14))
			{
				if (!unk_0x71FE36FB85146FC0(uParam0->f_1))
				{
					if (unk_0xB7A628320EFF8E47(unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1), uParam0->f_3) <= (50f * 50f))
					{
						...
						while (!unk_0x6DF9C43E3CC645BC(iParam1))
						{
							unk_0x6BB2B1818CAE531E(iParam1);
							unk_0x4EDE34FBADD967A6(0);
						}
						...
						if (bParam4)
						{
							...
							uParam0->f_1 = unk_0x007AE20F9BF069CA(joaat("pickup_custom_script"), uParam0->f_3, uParam0->f_6, uVar0, -1, iParam5, 1, iParam1);
						}
						else
						{
							...
							unk_0xA1E7A40E1F56E511(&uVar0, 1);
							uParam0->f_1 = unk_0xFE261C9FF385EA5E(iParam2, uParam0->f_3, uVar0, -1, 1, iParam1);
						}
...
void func_34(var uParam0, var uParam1)
{
	if (!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
	{
		if (unk_0xD34AF93E9BCF12F0(unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1), unk_0x1E451C0025BB4589(*uParam0), 1) >= 60f)
		{
			func_41(uParam0);
			*uParam0 = 0;
			*uParam1 = 0;
...
{
	if (func_36(unk_0x0FA8183DAD2B3203(), Param0, 7f))
	{
		unk_0x33BF981A2389AF13(unk_0x0FA8183DAD2B3203(), Param0, 100, 2048, 1);
	}
}
...
int func_42(var uParam0)
{
	...
	if (func_47(unk_0x0FA8183DAD2B3203()))
	{
