...
void __EntryFunction__()
{
	...
	if (unk_0xA96867DD0A63C62C(joaat("epsilontract")) > 1)
	{
...
void func_1()
{
	...
	if ((func_46(unk_0xA0081090911D13E5()) && !func_45(14)) && !unk_0x2C22E7D1C80A53EF())
	{
		if (iLocal_41 < 10)
		{
			if (iLocal_41 == 0)
			{
				if (!func_44(36) && (unk_0xDF658EB6CA91DFBC() - iLocal_42) > iLocal_43)
				{
			...
			else if (iLocal_41 < 10)
			{
				if (!iLocal_42 == -1)
				{
					if ((unk_0xDF658EB6CA91DFBC() - iLocal_42) > 15000)
					{
			...
			{
				if (unk_0xC37D05B586FADB2B(Local_49[iLocal_41 /*11*/].f_1) || func_41(Local_49[iLocal_41 /*11*/].f_1))
				{
					...
					iVar0 = (805 + iLocal_41);
					func_39(iVar0, 1, -1, 1);
					unk_0xD3363C33C5D52A45(joaat("num_hidden_packages_2"), 1f);
					bLocal_46 = true;
					if (iLocal_41 < 10)
					{
						iLocal_41++;
				...
				else if (unk_0x04793529D4EC36D1(Local_49[iLocal_41 /*11*/].f_1))
				{
	...
	if (*bParam0)
	{
		switch (*uParam4)
		{
			case 0:
				*uParam5 = unk_0x474309DF4921072A("MIDSIZED_MESSAGE");
				if (unk_0x1E3F61C2C1E29520(*uParam5))
				{
					...
					if (iParam3 == 6)
					{
						unk_0xAB16AADE80707D47(iVar0, "PEYOTE_COMPLETED", "HUD_AWARDS", 1);
					}
					else
					{
						unk_0xAB16AADE80707D47(iVar0, "COLLECTED", "HUD_AWARDS", 1);
					}
					*uParam4++;
				}
				break;
			...
			case 1:
				...
				unk_0x3F9D1B882EC0B8AF(func_4(iParam3));
				unk_0x1E77BE8F4283FA05();
...
int func_4(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (unk_0x08BA6DD398CA197C(Global_101553.f_8904.f_108, func_10(func_11(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_15(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar1 < Global_46219[iVar0 /*203*/].f_3)
	{
		...
		if (iVar3 < 3)
		{
			func_16(Global_46219[iVar0 /*203*/].f_4[iVar1], Global_46219[iVar0 /*203*/].f_1, 1, bParam2, 0);
		}
		iVar1++;
	}
	return 1;
...
void func_16(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar20;
		Var3 = { func_26(Global_36919[iVar20 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_26(Global_36919[iVar26 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
void func_17(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_18(unk_0xDAB775768F2B11B1(&cVar2, &cVar2, 0, 2, unk_0xFFC9DE7E93AEAE21(func_19(iParam1)), 0));
		}
		else
		{
			func_18(unk_0xDAB775768F2B11B1("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, unk_0xFFC9DE7E93AEAE21(func_19(iParam1)), 0));
		}
		switch (Global_14443)
		{
			case 0:
...
void func_22()
{
	...
	if (unk_0xD3FACCDA4D66AEAD(unk_0xA0081090911D13E5()))
	{
		if (func_25(Global_101553.f_1991.f_539.f_3549) != unk_0x705BC1BB91F530B5(unk_0xA0081090911D13E5()))
		{
			...
			if (func_23(iVar0) && (!func_45(14) || Global_100505))
			{
				...
				if (!unk_0x04793529D4EC36D1(uParam0->f_1))
				{
					if (unk_0xB7A628320EFF8E47(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), uParam0->f_3) <= (50f * 50f))
					{
						...
						if (bParam4)
						{
							...
							uParam0->f_1 = unk_0x2B370F74D5B53597(joaat("pickup_custom_script"), uParam0->f_3, uParam0->f_6, uVar0, -1, iParam5, 1, iParam1);
						}
						else
						{
							...
							unk_0x88B0F0DC270164B7(&uVar0, 1);
							uParam0->f_1 = unk_0x2C909F6674445C8D(iParam2, uParam0->f_3, uVar0, -1, 1, iParam1);
						}
...
void func_33(var uParam0, var uParam1)
{
	if (!unk_0xEB361B4BD195A4D3(unk_0xA0081090911D13E5()))
	{
		if (unk_0x999A157665D69393(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), unk_0xCA4126970421B696(*uParam0), 1) >= 60f)
		{
			func_40(uParam0);
			*uParam0 = 0;
			*uParam1 = 0;
...
{
	if (func_35(unk_0xA0081090911D13E5(), Param0, 7f))
	{
		unk_0x6486E0794864EE9B(unk_0xA0081090911D13E5(), Param0, 100, 2048, 1);
	}
}
...
int func_43(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	StringCopy(&(Global_101553.f_12996[iVar0 /*104*/]), sParam2, 64);
	Global_101553.f_12996[iVar0 /*104*/].f_17 = iParam1;
	if (iParam3 == 0)
	{
		return 0;
	}
	...
	{
		Global_101553.f_12996[iVar0 /*104*/].f_24 = iParam3;
	}
	Global_101553.f_12996[iVar0 /*104*/].f_25 = iParam4;
	Global_101553.f_12996[iVar0 /*104*/].f_26 = iParam5;
	Global_101553.f_12996[iVar0 /*104*/].f_29 = iParam6;
	Global_101553.f_12996[iVar0 /*104*/].f_30 = iParam8;
	Global_101553.f_12996[iVar0 /*104*/].f_31 = iParam7;
...
void func_47()
{
	...
	iVar0 = 0;
	if (Global_101553.f_17429.f_388)
	{
