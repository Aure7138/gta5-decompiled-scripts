...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		unk_0xAEF7C45DAFB8E9B0("SF_MrsPhilips", 0);
		...
		case 1:
			switch (iLocal_142)
			{
				case 0:
					...
					{
						func_222();
						if (!unk_0x60C47897C07F44B1(1736361794))
						{
							unk_0x6ADE529A7C2BA641(1736361794, joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, 1, 1, 0);
						}
						if (unk_0x60C47897C07F44B1(1736361794))
						{
							unk_0xCCD157619BAD6BE2(1736361794, 0f, 1, 0);
							unk_0xDC5C33A98881772F(1736361794, 0, 1, 0);
						}
				...
				case 2:
					if (unk_0x3EBB66F936A3436E())
					{
						...
						{
							func_216(unk_0x9B0761B4C3EB8BC7(), 1974.513f, 3814.579f, 32.4266f, 270f, 0, 1);
							unk_0x854FB153F2EA838B(unk_0x9B0761B4C3EB8BC7(), joaat("MotionState_Walk"), 0, 1, 0);
							unk_0xF0C2AEEDB4BDCF16(unk_0x460153A63B9477BC(), 1f, 4000, 0, 1, 0);
...
void func_2()
{
	...
	{
		unk_0xCCD157619BAD6BE2(1736361794, 0f, 1, 0);
		unk_0xDC5C33A98881772F(1736361794, 1, 1, 0);
	}
	func_3(110, 1);
	func_250();
}
...
void func_31()
{
	...
	while (iVar0 <= 8)
	{
		...
		if (unk_0xAE06B9E39EBDE049(uVar1) && !unk_0x5AEB5DDFFAD43CA5(uVar1))
		{
...
int func_32(var uParam0, int iParam1, int iParam2)
{
	...
	{
		unk_0x4FCABD4082A6C808(uParam0, Global_76647[1 /*14*/].f_12);
	}
	else
	{
		uVar31 = { func_79(iVar0, 0) };
		Global_76647[1 /*14*/] = { func_83(iVar0, iParam1, uVar31[iParam1], -1) };
		if (unk_0xD6A0115FA2F3F0EC(uParam0, func_75(iParam1)) > 0 && unk_0x7CF1CA3F6DB5685F(uParam0, func_75(iParam1), Global_76647[1 /*14*/].f_3) > 0)
		{
			unk_0x45F588C0DD767737(uParam0, func_75(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, 0);
		}
	}
...
int func_33(var uParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_148(uParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_64, Global_111858.f_2359.f_539[iVar0 /*65*/].f_63))
		{
...
int func_35(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
				...
				if (unk_0xCE990E643CD9D0E5(Global_76647[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							...
							func_51(uParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
							func_66(14);
							if (Global_76645 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							unk_0x45F588C0DD767737(uParam0, func_75(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, unk_0xABAC9462CD887571(uParam0, func_75(iVar0)));
						}
						else
						{
							unk_0x45F588C0DD767737(uParam0, func_75(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
						}
						func_66(iVar0);
						if (Global_76645 == 1)
						{
			...
			{
				Global_76647[1 /*14*/] = { func_83(iVar10, iVar0, func_41(uParam0, iVar0, -1), -1) };
	...
	else
	{
		if (iParam4 == -1)
		{
			unk_0x45F588C0DD767737(uParam0, func_75(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, unk_0xABAC9462CD887571(uParam0, func_75(iParam1)));
		}
		else
		{
			unk_0x45F588C0DD767737(uParam0, func_75(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
		}
		if (Global_76645 == 1)
		{
			iVar2 = 0;
...
void func_51(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_52(unk_0x36FE6D3220816ADA(uParam0), 14, iVar0, unk_0xEAF476EEF924D2C9(uParam0, 0, iParam2, iParam3)))
			{
				unk_0x694113444F21E39F(uParam0, 34, 1);
				unk_0x694113444F21E39F(uParam0, 36, 1);
			}
			else
			{
				unk_0x694113444F21E39F(uParam0, 34, 0);
...
int func_56(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = unk_0x36FE6D3220816ADA(uParam0);
	iVar1 = unk_0xEAF476EEF924D2C9(uParam0, iParam3, iParam1, iParam2);
	if (iVar1 != -1 && iVar1 != 0)
	{
		if (iVar0 == joaat("mp_m_freemode_01"))
		{
			return func_58(unk_0x36FE6D3220816ADA(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_58(unk_0x36FE6D3220816ADA(uParam0), iVar1, 14, 4);
		}
	}
	iVar2 = unk_0x99134D420E2DAA74(uParam0, iParam3);
	iVar4 = 0;
	while (iVar4 <= (iVar2 - 1))
	{
		iVar6 = unk_0x2CB217E5FD6878E9(uParam0, iParam3, iVar4);
		if (iVar4 != iParam1)
		{
			iVar3 = (iVar3 + iVar6);
		}
...
int func_74(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_148(uParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_61, Global_111858.f_2359.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_148(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76647[1 /*14*/].f_3 == unk_0x3FB4D40A857CEA77(uParam0, func_75(iParam1)) && Global_76647[1 /*14*/].f_4 == unk_0x79AFA009D186C4FB(uParam0, func_75(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_205(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam1 == 1)
	{
		...
		{
			if (func_204(unk_0x9B0761B4C3EB8BC7()))
			{
	...
	if (func_206(unk_0x9B0761B4C3EB8BC7()))
	{
...
void func_207(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if (((((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_211(unk_0x460153A63B9477BC())) && !func_209(unk_0x460153A63B9477BC(), 0)) && !func_208()) && !bParam4) && !bParam5)
			{
				unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), 0);
			}
		}
		else if (((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_211(unk_0x460153A63B9477BC())) && !bParam4) && !bParam5)
		{
			unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), 0);
		}
		Global_76831 = 0;
...
int func_216(var uParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)
{
	...
	if (func_204(uParam0))
	{
		...
		unk_0xE922BAA80E8F9324(uParam0, fParam4);
		if (bParam5)
		{
			return bVar0;
		}
...
void func_217(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0x5A228A6A51E757C8(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x773B9DEB93E81B2F(func_218(unk_0x2639A2323BEA8CC6()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_223(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_230(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_229(unk_0x9B0761B4C3EB8BC7(), -828834893))
				{
...
int func_230(var uParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	{
		unk_0xD4C86DEC93F19FB0(uParam0, uParam1, iParam2, iParam4);
	}
	Global_29 = unk_0x578C4EF320340AF7();
	if (!unk_0xA59F96B50B97E63C(uParam0, 0))
	{
		if (unk_0x0D77CDCF403AEBD2(unk_0xF3A639BEE7AADF55(uParam0)) <= fParam3)
		{
			return 1;
		}
	}
...
void func_231(var uParam0)
{
	if (!unk_0xA59F96B50B97E63C(uParam0, 0))
	{
		if (unk_0xAADB7E66E4BD2B67(uParam0))
		{
			if (unk_0xC1067169688057A8(uParam0))
			{
				unk_0x348DC18FDCA78997(uParam0, 0);
			}
		}
	}
}
...
{
	if (((!func_247(0) || Global_77102) || Global_77091 == 1) || !unk_0x87F0CB19476706C3())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((unk_0x3EBB66F936A3436E() || func_246(0)) || func_245(1))
			{
			}
			else
			{
...
void func_266(bool bParam0)
{
	...
	if (!func_287())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_267(unk_0x6C5C6B207AA78253(), iVar0);
		}
		else
		{
			if (Global_110945[iVar0 /*10*/].f_9 == -1)
...
int func_268(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_274())
	{
		...
		{
			iVar33 = func_269(unk_0x6C5C6B207AA78253());
			if (iVar33 > -1)
			{
