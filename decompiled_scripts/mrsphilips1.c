...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		unk_0x208784099002BC30("SF_MrsPhilips", 0);
		...
		case 1:
			switch (iLocal_140)
			{
				case 0:
					...
					{
						func_217();
						if (!unk_0xC153C43EA202C8C1(1736361794))
						{
							unk_0x6F8838D03D1DC226(1736361794, joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, true, true, false);
						}
						if (unk_0xC153C43EA202C8C1(1736361794))
						{
							unk_0xB6E6FBA95C7324AC(1736361794, 0f, true, false);
							unk_0x6BAB9442830C7F53(1736361794, 0, true, false);
						}
				...
				case 2:
					if (unk_0xD3C2E180A40F031E())
					{
						...
						{
							func_211(unk_0xD80958FC74E988A6(), 1974.513f, 3814.579f, 32.4266f, 270f, 0, 1);
							unk_0xF28965D04F570DCA(unk_0xD80958FC74E988A6(), joaat("MotionState_Walk"), false, 1, false);
							unk_0x477D5D63E63ECA5D(unk_0x4F8644AF03D0E0D6(), 1f, 4000, 0f, true, false);
...
void func_2()
{
	...
	{
		unk_0xB6E6FBA95C7324AC(1736361794, 0f, true, false);
		unk_0x6BAB9442830C7F53(1736361794, 1, true, false);
	}
	func_3(110, 1);
	func_244();
}
...
void func_201(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_202(unk_0xD80958FC74E988A6()))
	{
...
void func_203(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_208(0, bParam3, iParam2);
		if (!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()) && !func_204(unk_0x4F8644AF03D0E0D6()))
		{
...
int func_208(bool bParam0, bool bParam1, var uParam2)
{
	int iVar0;
...
int func_211(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_212(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0x5E9564D8246B909A(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0xBE31FD6CE464AC59(func_213(unk_0xA5EDC40EF369B48D()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_218(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
	{
		...
		{
			if (!func_225(unk_0x9A9112A0FE9A4713(unk_0xD80958FC74E988A6(), false), fParam1, 1, 1056964608, 0, 1))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_224(unk_0xD80958FC74E988A6(), -828834893))
				{
...
int func_225(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5)
{
...
{
	if (((!func_241(0) || Global_68336) || Global_68325 == 1) || !unk_0x5A859503B0C08678())
	{
		return 0;
	}
	switch (Global_68321)
	{
		...
		case 5:
			if ((unk_0xD3C2E180A40F031E() || func_240(0)) || func_239(1))
			{
			}
			else
			{
...
void func_260(bool bParam0)
{
	...
	if (!func_279())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_261(unk_0x442E0A7EDE4A738A(), iVar0);
		}
		else
		{
			if (Global_96260[iVar0 /*10*/].f_9 == -1)
...
int func_262(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_268())
	{
		...
		{
			iVar33 = func_263(unk_0x442E0A7EDE4A738A());
			if (iVar33 > -1)
			{
