...
int func_252(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2588062[iParam0 /*3*/][func_76(iParam1)];
...
void func_257(int iParam0, var uParam1)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x285D770154CF7612(iParam0, func_262(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_297(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_492()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_734))
	{
		...
		{
			unk_0xF62C19B1689A771C(1, iLocal_608, joaat("player"));
		}
		if (!iLocal_619)
		{
...
void func_514()
{
	if (!iLocal_631)
	{
		...
		unk_0xEFBCE8F8316F89EA(1, iLocal_608, joaat("player"));
		unk_0xEFBCE8F8316F89EA(1, joaat("player"), iLocal_608);
		unk_0xEFBCE8F8316F89EA(2, iLocal_608, -2065892691);
		unk_0xEFBCE8F8316F89EA(2, joaat("player"), -2065892691);
		iLocal_631 = 1;
	}
}
