...
void __EntryFunction__()
{
	...
	uLocal_82 = unk_0x12772FC739A13F81(joaat("weapon_sniperrifle"));
	uLocal_83 = unk_0x70418C66CB4C3F79(joaat("component_at_scope_large"));
	uLocal_84 = unk_0x70418C66CB4C3F79(joaat("component_at_ar_supp_02"));
	...
	func_505(25);
	func_504();
	func_503(&uLocal_153, 2, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
...
void func_1()
{
	switch (iLocal_321)
	{
		case 0:
			...
			func_7();
			if (unk_0x786AF4A44E1B5B4B(sLocal_738))
			{
				func_531(1);
			}
			else
...
void func_14()
{
	...
	{
		func_16(13, unk_0xF34EE736CF047844(Global_106565.f_10188.f_3853));
	}
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_82(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_82(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, joaat("HAT"), 1) || unk_0xEA26831785699C09(func_60(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, joaat("HAT"), 0) || unk_0xEA26831785699C09(func_60(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, joaat("HAT"), 1) || unk_0xEA26831785699C09(func_60(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, joaat("HAT"), 0) || unk_0xEA26831785699C09(func_60(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!unk_0xC4ED190294E9E658(Var20.f_0))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_93(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, unk_0xEA26831785699C09(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_93(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, unk_0xEA26831785699C09(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = unk_0x51C67A1CC9BD53D6(iVar1, 7, -1, 0, -1, func_82(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_218()
{
	if (iLocal_621)
	{
		...
		unk_0x68E7C703C4450F0F(unk_0x33CD235DF1E6A94E(), joaat("AMMO_SNIPER"), uLocal_723);
	}
	else
	{
		...
		case 1:
			if (unk_0xBB5E373390A5F824())
			{
				...
				if (func_302(unk_0x33CD235DF1E6A94E()))
				{
					...
					if (!func_211())
					{
						func_223(unk_0x33CD235DF1E6A94E(), Local_913, fLocal_916, 0, 1);
					}
					if (func_302(iLocal_734))
					{
						unk_0xC4A347124F39D998(unk_0x33CD235DF1E6A94E(), iLocal_734, -1, 0, 2);
					}
					func_222(1);
					func_220(0);
				}
...
void func_220(bool bParam0)
{
	if (func_302(iLocal_734))
	{
		if (bParam0)
		{
			...
			{
				if (!unk_0x731F434EAFE6E9FE(iLocal_734, func_221()))
				{
					unk_0xED68CDDDE25A144E(iLocal_734);
					unk_0x140D4A6561E11695(iLocal_734, func_221());
					unk_0xDD02EC6C22FD1487(iLocal_734, 1);
					unk_0xF70578F5CD9822CB(iLocal_734, 0);
				}
			}
		}
		else if (unk_0x731F434EAFE6E9FE(iLocal_734, func_221()))
		{
			unk_0xED68CDDDE25A144E(iLocal_734);
			unk_0x5D94F4D6FE7DA516(iLocal_734);
		}
	}
}
...
void func_225(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_208(unk_0xD178EF744F20B712(), 1);
			if (iVar5 != -1)
			{
...
void func_251(int iParam0, var uParam1)
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x7D8E16FB3C783D5E(iParam0, func_256(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((unk_0x078B659F6F2C8960(iVar9, &Var11) && !func_253(Var11.f_1)) && iVar72 < 51)
			{
...
int func_262(var uParam0)
{
	if (!unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		if (func_284())
		{
			*uParam0 = func_267(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 0), 6, -1, 0, 1, -1);
...
int func_267(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_283(iVar0))
		{
			...
			{
				fVar1 = unk_0x16E00F066AFFEA0D(Param0, func_268(iVar0, 0), 1);
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_291(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
...
void func_304()
{
	...
	if (iLocal_724 < 3)
	{
		if (!bLocal_641)
		{
			if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_769, Local_772, 20f, 0, 1, 0))
			{
				func_315();
				if (iLocal_659[17])
				{
...
void func_305()
{
	...
	while (iVar23 < 4)
	{
		if (unk_0xCC9A41DD2CD0C58B(iVar18[iVar23], Var0[iVar23 /*3*/], 1))
		{
			uLocal_975[iVar23] = unk_0xC651C43AB13A15E5(iVar18[iVar23], Var0[iVar23 /*3*/], fVar13[iVar23], 1, 1, 0);
		}
		iVar23++;
	}
...
void func_306()
{
	unk_0x71CA80D41E1338B4(iLocal_729);
	unk_0x71CA80D41E1338B4(iLocal_730);
}
...
{
	if (!unk_0xE38E3CF1625A4145(iLocal_610))
	{
	...
	if (unk_0xE38E3CF1625A4145(iLocal_610))
	{
		if (!bParam0)
		{
			unk_0xCE5C49921A521962(iLocal_610, 0.75f);
		}
		unk_0x0E734BC61706D976(iLocal_610, iParam1);
	}
}
		...
		while (iVar1 < 3)
		{
			if (((Local_499[iVar0 /*54*/][iVar1 /*17*/].f_3 != 1 && Local_499[iVar0 /*54*/][iVar1 /*17*/].f_3 != 0) && Local_499[iVar0 /*54*/].f_52 != 4) && Local_499[iVar0 /*54*/].f_52 != 5)
			{
				if (!func_302(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
					if (!Local_499[iVar0 /*54*/][iVar1 /*17*/].f_1)
					{
						...
						Local_959[iVar0 /*3*/] = { unk_0xFBB1F99A825CAB09(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6, 1) };
						iLocal_687[iVar0] = 1;
						Local_499[iVar0 /*54*/][iVar1 /*17*/].f_1 = 1;
						if (Local_499[iVar0 /*54*/][0 /*17*/].f_1 == 1)
						{
							if (!unk_0xD62C4419A41F106A(Local_499[iVar0 /*54*/][1 /*17*/].f_6, 0))
							{
								Local_499[iVar0 /*54*/][1 /*17*/].f_4 = 0;
								iLocal_715 = 1;
							}
							else if (!unk_0xD62C4419A41F106A(Local_499[iVar0 /*54*/][2 /*17*/].f_6, 0))
							{
				...
				else if (unk_0x416C37C19CCE0077(unk_0xFBB1F99A825CAB09(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6, 1), 2f, 0))
				{
					iLocal_624 = 0;
					iLocal_628 = 1;
					iLocal_716 = 0;
					...
					while (iLocal_716 < 3)
					{
						...
						{
							Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_14 = { unk_0xFBB1F99A825CAB09(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, 1) };
							Local_499[iVar0 /*54*/].f_52 = 4;
						}
			...
			switch (Local_499[iVar0 /*54*/].f_52)
			{
				...
				case 4:
					...
					while (iLocal_716 < 3)
					{
						if ((unk_0x765F6FEEFF39224F(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, 0)) && !unk_0xBC2FC12AD0FBF72E(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6))
						{
				...
				case 2:
					...
					while (iLocal_716 < 3)
					{
						...
						{
							if (unk_0x765F6FEEFF39224F(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, 0))
							{
								unk_0x7B7A3E5CC3FBE978(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, Local_959[iVar0 /*3*/], unk_0x9562E33C057F7589(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_317(int iParam0, int iParam1)
{
	...
	{
		if (!unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
		{
			unk_0xB13B4A13090E7801(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6);
		}
	...
	switch (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 3:
			if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_499[iParam0 /*54*/][iParam1 /*17*/].f_7 = (unk_0xE3903F59E2F22150() + unk_0x9EC3B269A34A2BEE(3000, 8000));
		...
		case 4:
			if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (unk_0xE3903F59E2F22150() > Local_499[iParam0 /*54*/][iParam1 /*17*/].f_7 && Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
				{
					...
					while (iVar0 < 3)
					{
						if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iVar0 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iVar0 /*17*/].f_6, 0))
						{
		...
		case 5:
			if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10 = unk_0x9EC3B269A34A2BEE(0, 8);
				if (!iLocal_650[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10])
				{
					...
					{
						unk_0x7E268975AF5EA74F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], 1f, -1, 0.25f, 512, unk_0x9562E33C057F7589(0f, 359.9f));
					}
					else if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6, 0))
					{
						unk_0x38CD0CF7DF213A81(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6, Local_499[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
					}
		...
		case 6:
			if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 && unk_0x18FB647D79B09657(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_320(iParam0), 0, 0, 0))
				{
					iVar1 = 0;
					iVar1 = 0;
					while (iVar1 < 3)
					{
						if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
						{
							unk_0xED68CDDDE25A144E(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6);
							unk_0x126A03BD41622048(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], 7.5f, 0f, 1f);
		...
		case 11:
			if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				...
				{
					unk_0x6DA4DBA91F234052(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_959[iParam0 /*3*/], 50f, -1, 0, 0);
				}
				else
				{
					unk_0x6DA4DBA91F234052(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_499[iParam0 /*54*/][iParam1 /*17*/].f_14, 50f, -1, 0, 0);
				}
				unk_0x897EF720254BBEA3(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
		...
		case 12:
			if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (iLocal_687[iParam0])
				{
					...
					{
						unk_0x7B7A3E5CC3FBE978(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_959[iParam0 /*3*/], unk_0x9562E33C057F7589(1f, 2.5f), 0, 0, 786603, -1082130432);
		...
		case 8:
			if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6) && !unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6, 0))
				{
					unk_0x38CD0CF7DF213A81(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6, Local_499[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
		...
		case 13:
			if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				if (unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
				{
				...
				unk_0x0D847D71D9E6142E(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6);
			}
...
{
	if ((((unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_769, Local_772, 20f, 0, 1, 0) && unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) && iLocal_633) && iLocal_724 < 3)
	{
		if (!unk_0xE38E3CF1625A4145(Local_499[iParam0 /*54*/][iParam1 /*17*/]))
		{
			Local_499[iParam0 /*54*/][iParam1 /*17*/] = func_309(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
			if (unk_0xE38E3CF1625A4145(Local_499[iParam0 /*54*/][iParam1 /*17*/]))
			{
				unk_0xCE5C49921A521962(Local_499[iParam0 /*54*/][iParam1 /*17*/], 0.7f);
			}
			if (!unk_0xD62C4419A41F106A(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				unk_0x6B8FD1D1616EE677(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
			}
		}
	}
	else
...
void func_336(int iParam0, int iParam1)
{
	...
	if (!func_302(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6 = unk_0x9BA5CF280376EEA4(26, iLocal_727, Var0, unk_0x9562E33C057F7589(0f, 359.9f), 1, 1);
		if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
		{
			unk_0x7FC2040EB34E0E31(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
			unk_0x4A852F02088ECC9D(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
			Local_499[iParam0 /*54*/][iParam1 /*17*/].f_3 = 8;
		}
	}
}
...
void func_337(int iParam0, int iParam1)
{
	if (!func_302(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		if (!iLocal_650[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10])
		{
			Local_499[iParam0 /*54*/][iParam1 /*17*/].f_5 = unk_0x9562E33C057F7589(0f, 359.9f);
			Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6 = unk_0x9BA5CF280376EEA4(26, iLocal_727, Local_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], Local_499[iParam0 /*54*/][iParam1 /*17*/].f_5, 1, 1);
			if (unk_0x765F6FEEFF39224F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				unk_0x7FC2040EB34E0E31(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
				unk_0x4A852F02088ECC9D(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
...
void func_338(int iParam0, int iParam1)
{
	if (func_339())
	{
		unk_0xE9739440E5BF08EE(-1, "COYOTE_BARK_MASTER", Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
	}
	else
	{
		unk_0xE9739440E5BF08EE(-1, "COYOTE_CRY_MASTER", Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
	}
}
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (unk_0xBB5E373390A5F824())
			{
				...
				if (!func_211())
				{
					func_223(unk_0x33CD235DF1E6A94E(), Local_803, fLocal_806, 0, 1);
					func_342();
				}
				iLocal_321 = 2;
			}
...
void func_346()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0xE38E3CF1625A4145(Local_322[iVar0 /*10*/].f_9))
		{
			unk_0x1ABDB383C83A336A(&(Local_322[iVar0 /*10*/].f_9));
		}
	...
	if (iLocal_618)
	{
		unk_0x71CA80D41E1338B4(iLocal_726);
	}
}
...
void func_349()
{
	unk_0xB815670C37E03CDE(iLocal_729);
	unk_0xB815670C37E03CDE(iLocal_730);
	while (!unk_0x5D98D654CDC2165A(iLocal_729) || !unk_0x5D98D654CDC2165A(iLocal_730))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
}
...
int func_351()
{
	if (unk_0x765F6FEEFF39224F(iLocal_734) && !unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0))
	{
		if (!unk_0x335C0645074963FE(iLocal_734, unk_0x33CD235DF1E6A94E(), Local_775, 0, 0, 0))
		{
			return 1;
		}
	}
...
void func_353()
{
	...
	func_354();
	if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_907, Local_910, 3.5f, 0, 1, 0) || iLocal_659[16])
	{
		func_348();
		func_341();
		iLocal_318 = 15;
...
void func_354()
{
	...
	while (iVar0 < 5)
	{
		...
		{
			func_368(iVar0);
			if (unk_0x765F6FEEFF39224F(Local_353[iVar0 /*29*/].f_28))
			{
				if (!unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_763, Local_766, 10f, 0, 1, 0))
				{
					if (!bLocal_636)
					{
						if (unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1))
						{
							bLocal_636 = true;
							func_312(6);
						}
		...
		switch (Local_353[iVar0 /*29*/].f_13)
		{
			...
			case 2:
				Local_353[iVar0 /*29*/].f_7 = unk_0x9EC3B269A34A2BEE(0, 5);
				if ((!unk_0x7E0147E36EF8D6AC(Local_353[Local_353[iVar0 /*29*/].f_7 /*29*/].f_16, 4.5f) && iLocal_705 < 3) && unk_0xCC9A41DD2CD0C58B(Local_353[iVar0 /*29*/].f_9, Local_353[iVar0 /*29*/].f_16, 1))
				{
					Local_353[iVar0 /*29*/].f_28 = unk_0xC651C43AB13A15E5(Local_353[iVar0 /*29*/].f_9, Local_353[iVar0 /*29*/].f_16, Local_353[iVar0 /*29*/].f_4, 1, 1, 0);
					if (unk_0x765F6FEEFF39224F(Local_353[iVar0 /*29*/].f_28) && !unk_0xD62C4419A41F106A(Local_353[iVar0 /*29*/].f_28, 0))
					{
						unk_0xAD3D24C8070DA056(Local_353[iVar0 /*29*/].f_28, 1);
						unk_0x4459178BAF2918E1(Local_353[iVar0 /*29*/].f_28, 1);
						Local_353[iVar0 /*29*/].f_7 = unk_0x9EC3B269A34A2BEE(0, 5);
						Local_353[iVar0 /*29*/].f_12 = unk_0xE196503B36B6194B(Local_353[iVar0 /*29*/].f_28, 26, Local_353[Local_353[iVar0 /*29*/].f_7 /*29*/].f_10, -1, 1, 1);
						if (unk_0x765F6FEEFF39224F(Local_353[iVar0 /*29*/].f_12))
						{
							Local_353[iVar0 /*29*/].f_11 = unk_0x7CA67831169E8AA6(iLocal_731, Local_353[iVar0 /*29*/].f_16, 1, 1, 0);
							if (unk_0x765F6FEEFF39224F(Local_353[iVar0 /*29*/].f_11))
							{
								unk_0x2F0A6390D863D337(Local_353[iVar0 /*29*/].f_11, Local_353[iVar0 /*29*/].f_12, unk_0xFCAF61876D23D31D(Local_353[iVar0 /*29*/].f_12, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
								unk_0x0CDD28A9DFCE2FCE(Local_353[iVar0 /*29*/].f_11, 0, 0);
								unk_0x43D47AD82DA3C6EC(Local_353[iVar0 /*29*/].f_12, 1, 1);
								unk_0xAD3D24C8070DA056(Local_353[iVar0 /*29*/].f_12, 1);
								Local_353[iVar0 /*29*/].f_2 = 0;
								Local_353[iVar0 /*29*/].f_1 = 0;
								Local_353[iVar0 /*29*/].f_3 = 0;
								unk_0x4A852F02088ECC9D(Local_353[iVar0 /*29*/].f_12, 1);
								unk_0x77C4189A8E5C57C2(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
								iLocal_705++;
			...
			case 4:
				...
				{
					if (!unk_0x18FB647D79B09657(Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_19, 10f, 10f, 10f, 0, 0, 0))
					{
							...
							if (func_318(Local_353[iVar0 /*29*/].f_28))
							{
								if (func_365(iVar0))
								{
									if (!Local_353[iVar0 /*29*/].f_1)
									{
										...
										func_364(iVar0);
										unk_0x0D847D71D9E6142E(Local_353[iVar0 /*29*/].f_28);
						...
						{
							if (unk_0x416C37C19CCE0077(unk_0xFBB1F99A825CAB09(Local_353[iVar0 /*29*/].f_28, 1), 5f, 1))
							{
								iLocal_629 = 1;
							}
						}
					...
					{
						unk_0xED68CDDDE25A144E(Local_353[iVar0 /*29*/].f_12);
						unk_0x4459178BAF2918E1(Local_353[iVar0 /*29*/].f_28, 0);
						unk_0x21D56A8927F5A92A(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 8f, 786599);
						unk_0x897EF720254BBEA3(Local_353[iVar0 /*29*/].f_12, 1);
						Local_353[iVar0 /*29*/].f_13 = 15;
					}
				}
				else
			...
			case 5:
				if (func_302(Local_353[iVar0 /*29*/].f_12) && func_367(Local_353[iVar0 /*29*/].f_28))
				{
					...
					{
						unk_0x19A39772525FA2CD(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, Var1, unk_0xC472E34C8FBEC678(Local_353[iVar0 /*29*/].f_28), 3, 270f, 1);
					}
					else if (func_339())
					{
						unk_0x78893508441AD74F(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 5, 2000);
					}
					else
					{
						unk_0x78893508441AD74F(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 4, 2000);
					}
					func_2();
			...
			case 6:
				if ((func_224(Local_353[iVar0 /*29*/].f_28) && func_302(Local_353[iVar0 /*29*/].f_12)) && !unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1))
				{
					if (unk_0x61DFE32FB87BC784(Local_353[iVar0 /*29*/].f_28))
					{
						unk_0xED68CDDDE25A144E(Local_353[iVar0 /*29*/].f_12);
						unk_0x4A852F02088ECC9D(Local_353[iVar0 /*29*/].f_12, 1);
						if (!unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1) || !Local_353[iVar0 /*29*/].f_2)
						{
							unk_0x0FF06FD8DEB3AB01(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 1);
						}
						else
						{
							func_359(iVar0);
			...
			case 7:
				if (func_302(Local_353[iVar0 /*29*/].f_12) && !unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1))
				{
					if (!unk_0xF0D230FB550CD6EB(Local_353[iVar0 /*29*/].f_12, 0))
					{
						if (!unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1) || !Local_353[iVar0 /*29*/].f_2)
						{
					...
					else if (unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1))
					{
						func_359(iVar0);
					}
				}
			...
			case 8:
				if ((func_302(Local_353[iVar0 /*29*/].f_12) && !unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1)) && func_367(Local_353[iVar0 /*29*/].f_28))
				{
					Var4 = { unk_0xFBB1F99A825CAB09(Local_353[iVar0 /*29*/].f_12, 1) };
					if (!unk_0xF0D230FB550CD6EB(Local_353[iVar0 /*29*/].f_12, 0))
					{
						if (!unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1) && !unk_0x416C37C19CCE0077(Var4, 3f, 1))
						{
							Local_353[iVar0 /*29*/].f_25 = { unk_0x2CA911E7569D12EA(Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_22) };
							Local_353[iVar0 /*29*/].f_6 = (unk_0xC472E34C8FBEC678(Local_353[iVar0 /*29*/].f_28) + Local_353[iVar0 /*29*/].f_5);
							unk_0xED68CDDDE25A144E(Local_353[iVar0 /*29*/].f_12);
							unk_0x4A852F02088ECC9D(Local_353[iVar0 /*29*/].f_12, 1);
							unk_0x7E268975AF5EA74F(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_25, 1f, -1, 0.25f, 0, Local_353[iVar0 /*29*/].f_6);
			...
			case 9:
				if (func_302(Local_353[iVar0 /*29*/].f_12) && !unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1))
				{
					...
					if (!unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1) && !unk_0x416C37C19CCE0077(Var4, 3f, 1))
					{
						if (unk_0x18FB647D79B09657(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_25, 1f, 1f, 1f, 0, 0, 1))
						{
							unk_0xED68CDDDE25A144E(Local_353[iVar0 /*29*/].f_12);
							unk_0x4A852F02088ECC9D(Local_353[iVar0 /*29*/].f_12, 1);
							unk_0x11C4AF4137F2A4B5(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 0);
			...
			case 10:
				if (func_302(Local_353[iVar0 /*29*/].f_12) && !unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1))
				{
					...
					if (!unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1) && !unk_0x416C37C19CCE0077(Var4, 3f, 1))
					{
						Local_353[iVar0 /*29*/].f_15 = unk_0xD76D6BCC14B95CE1(Local_353[iVar0 /*29*/].f_12, -875674219);
			...
			case 11:
				if (func_302(Local_353[iVar0 /*29*/].f_12) && !unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1))
				{
					...
					if (!unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1) && !unk_0x416C37C19CCE0077(Var4, 3f, 1))
					{
						unk_0x99414FB2D30425C1(&(Local_353[iVar0 /*29*/].f_14));
						...
						unk_0xC734F59A13D39AEF(Local_353[iVar0 /*29*/].f_14);
						unk_0x13A2D602CD10CBAC(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_14);
						unk_0xA7A57E7757ED035E(&(Local_353[iVar0 /*29*/].f_14));
						Local_353[iVar0 /*29*/].f_8 = unk_0xE3903F59E2F22150() + 20000;
			...
			case 12:
				if (func_302(Local_353[iVar0 /*29*/].f_12) && !unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1))
				{
					...
					if (!unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1) && !unk_0x416C37C19CCE0077(Var4, 3f, 1))
					{
						if (unk_0xE3903F59E2F22150() > Local_353[iVar0 /*29*/].f_8)
						{
							if (unk_0x042B0E494045A7DF(Local_353[iVar0 /*29*/].f_11))
							{
								unk_0x0CDD28A9DFCE2FCE(Local_353[iVar0 /*29*/].f_11, 0, 0);
							}
							else
						...
						else if (unk_0x1CE8F0A08E65CA6A(Local_353[iVar0 /*29*/].f_12, "ODDJOBS@HUNTER", "enter_call", 3) && !unk_0x042B0E494045A7DF(Local_353[iVar0 /*29*/].f_11))
						{
							unk_0x0CDD28A9DFCE2FCE(Local_353[iVar0 /*29*/].f_11, 1, 0);
						}
					}
					else
					{
			...
			case 13:
				if (!unk_0x91BBD269506D61D2(Local_353[iVar0 /*29*/].f_28, unk_0x33CD235DF1E6A94E(), 1))
				{
					if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(Local_353[iVar0 /*29*/].f_28, 0), unk_0xFBB1F99A825CAB09(Local_353[iVar0 /*29*/].f_12, 1), 0) > 100f)
					{
						Local_353[iVar0 /*29*/].f_13 = 15;
					}
				}
			...
			case 15:
				...
				if (unk_0x765F6FEEFF39224F(Local_353[iVar0 /*29*/].f_12))
				{
					if (!unk_0xD62C4419A41F106A(Local_353[iVar0 /*29*/].f_12, 0))
					{
						unk_0x897EF720254BBEA3(Local_353[iVar0 /*29*/].f_12, 1);
					}
		...
		{
			if (unk_0x16E00F066AFFEA0D(Local_800, unk_0xFBB1F99A825CAB09(Local_353[iVar0 /*29*/].f_28, 1), 1) > 450f)
			{
				Local_353[iVar0 /*29*/].f_13 = 15;
			}
		}
...
void func_357(int iParam0)
{
	...
	if (func_302(iVar0))
	{
		if (func_367(Local_353[iParam0 /*29*/].f_28))
		{
			...
			unk_0x99414FB2D30425C1(&(Local_353[iParam0 /*29*/].f_14));
			unk_0xC838CE9837D0ABAF(0, Local_353[iParam0 /*29*/].f_28, 60000, -1, 1f, 1, 0);
			unk_0x21D56A8927F5A92A(0, Local_353[iParam0 /*29*/].f_28, 60f, 786468);
			unk_0xC734F59A13D39AEF(Local_353[iParam0 /*29*/].f_14);
			unk_0x13A2D602CD10CBAC(iVar0, Local_353[iParam0 /*29*/].f_14);
			unk_0x897EF720254BBEA3(iVar0, 1);
			unk_0xA7A57E7757ED035E(&(Local_353[iParam0 /*29*/].f_14));
		}
...
Vector3 func_358(int iParam0)
{
	...
	if (func_367(iParam0))
	{
		Var0 = { unk_0x2CA911E7569D12EA(iParam0, 5f, 25f, 0f) };
		if (unk_0x8E241517F0F541CC(Var0, &Var3, 1, 1077936128, 0))
		{
			if (unk_0x446BC6EBC42BAFA8(Var3, 0, &Var3))
			{
				if (!unk_0x7E0147E36EF8D6AC(Var3, 2f) && !unk_0xC106293D8BB9B710(Var3, 2f, 0))
				{
					return Var3;
				}
			}
...
void func_359(int iParam0)
{
	...
	{
		unk_0xED68CDDDE25A144E(Local_353[iParam0 /*29*/].f_12);
		unk_0x4A852F02088ECC9D(Local_353[iParam0 /*29*/].f_12, 1);
		if (func_367(Local_353[iParam0 /*29*/].f_28))
		{
			if (unk_0x10930B9CAD4111C2(Local_353[iParam0 /*29*/].f_12, Local_353[iParam0 /*29*/].f_28, 0))
			{
				unk_0x77C4189A8E5C57C2(Local_353[iParam0 /*29*/].f_12, Local_353[iParam0 /*29*/].f_28, Local_353[iParam0 /*29*/].f_19, 80f, 1, 0, 786469, 5f, 2f);
				Local_353[iParam0 /*29*/].f_13 = 14;
			}
			else
			{
				unk_0x6DA4DBA91F234052(Local_353[iParam0 /*29*/].f_12, Local_748, 10000f, -1, 0, 0);
				Local_353[iParam0 /*29*/].f_13 = 13;
			}
		}
		Local_353[iParam0 /*29*/].f_2 = 1;
		unk_0x897EF720254BBEA3(Local_353[iParam0 /*29*/].f_12, 1);
	}
	else
	{
...
void func_360()
{
	if (!iLocal_625)
	{
		if (func_339())
		{
			iLocal_704 = unk_0xE3903F59E2F22150() + 1000;
			iLocal_625 = 1;
		}
	}
	else if (unk_0xE3903F59E2F22150() > iLocal_704)
	{
...
int func_362()
{
	...
	if (func_302(unk_0x33CD235DF1E6A94E()))
	{
		...
		if (func_302(iLocal_734))
		{
			Var3 = { unk_0xFBB1F99A825CAB09(iLocal_734, 1) };
			if (func_363(unk_0x33CD235DF1E6A94E(), iLocal_734, 0) <= 10f && unk_0x7EECA16E87982278((Var0.f_2 - Var3.f_2)) < 1.5f)
			{
				return 1;
			}
		}
...
void func_364(int iParam0)
{
	...
	if (!unk_0xD62C4419A41F106A(Local_353[iParam0 /*29*/].f_28, 0))
	{
		unk_0x6B8FD1D1616EE677(Local_353[iParam0 /*29*/].f_28, 0);
	}
...
{
	if (unk_0x765F6FEEFF39224F(Local_353[iParam0 /*29*/].f_28) && !unk_0xD62C4419A41F106A(Local_353[iParam0 /*29*/].f_28, 0))
	{
		if (unk_0xEED5625DB4F88798(Local_353[iParam0 /*29*/].f_28, 1, 0))
		{
			Local_353[iParam0 /*29*/].f_22 = { 2.5f, 3f, 0f };
			Local_353[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (unk_0xEED5625DB4F88798(Local_353[iParam0 /*29*/].f_28, 5, 0))
		{
			Local_353[iParam0 /*29*/].f_22 = { 2.5f, -3f, 0f };
			Local_353[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (unk_0xEED5625DB4F88798(Local_353[iParam0 /*29*/].f_28, 4, 0))
		{
			Local_353[iParam0 /*29*/].f_22 = { -2.5f, -3f, 0f };
			Local_353[iParam0 /*29*/].f_5 = -90f;
			return 1;
		}
		else if (unk_0xEED5625DB4F88798(Local_353[iParam0 /*29*/].f_28, 0, 0))
		{
			Local_353[iParam0 /*29*/].f_22 = { -2.5f, 3f, 0f };
			Local_353[iParam0 /*29*/].f_5 = -90f;
			return 1;
...
{
	if (unk_0x765F6FEEFF39224F(Local_353[iParam0 /*29*/].f_12))
	{
		if (unk_0xD62C4419A41F106A(Local_353[iParam0 /*29*/].f_12, 0) || !unk_0xD62C4419A41F106A(Local_353[iParam0 /*29*/].f_12, 0))
		{
			if (unk_0x91BBD269506D61D2(Local_353[iParam0 /*29*/].f_12, unk_0x33CD235DF1E6A94E(), 1))
			{
				func_359(iParam0);
			}
		}
...
void func_371()
{
	if (bLocal_639)
	{
		unk_0x71CA80D41E1338B4(Local_353[0 /*29*/].f_9);
		unk_0x71CA80D41E1338B4(Local_353[1 /*29*/].f_9);
		unk_0x71CA80D41E1338B4(Local_353[2 /*29*/].f_9);
		unk_0x71CA80D41E1338B4(Local_353[3 /*29*/].f_9);
		unk_0x71CA80D41E1338B4(Local_353[4 /*29*/].f_9);
		unk_0x71CA80D41E1338B4(Local_353[0 /*29*/].f_10);
		unk_0x71CA80D41E1338B4(Local_353[1 /*29*/].f_10);
		unk_0x71CA80D41E1338B4(Local_353[2 /*29*/].f_10);
		unk_0x71CA80D41E1338B4(Local_353[3 /*29*/].f_10);
		unk_0x71CA80D41E1338B4(Local_353[4 /*29*/].f_10);
		unk_0x71CA80D41E1338B4(iLocal_731);
		bLocal_639 = false;
	}
}
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (unk_0xBB5E373390A5F824())
			{
				...
				iLocal_319 = 13;
				unk_0xB7350047030F7672(Local_800, 50f, 0, 0, 0, 0, 0, 0);
				unk_0xB7350047030F7672(Local_794, 50f, 0, 0, 0, 0, 0, 0);
				unk_0xB7350047030F7672(Local_797, 50f, 0, 0, 0, 0, 0, 0);
				unk_0x31826EF4A8BC8E9F(unk_0x33CD235DF1E6A94E());
				func_370();
				func_344();
				func_343();
				...
				if (!func_211())
				{
					func_223(unk_0x33CD235DF1E6A94E(), Local_748, fLocal_691, 0, 1);
					func_342();
				}
				iLocal_321 = 2;
			}
...
{
	func_377();
	unk_0xB815670C37E03CDE(Local_353[0 /*29*/].f_9);
	unk_0xB815670C37E03CDE(Local_353[1 /*29*/].f_9);
	unk_0xB815670C37E03CDE(Local_353[2 /*29*/].f_9);
	unk_0xB815670C37E03CDE(Local_353[3 /*29*/].f_9);
	unk_0xB815670C37E03CDE(Local_353[4 /*29*/].f_9);
	unk_0xB815670C37E03CDE(Local_353[0 /*29*/].f_10);
	unk_0xB815670C37E03CDE(Local_353[1 /*29*/].f_10);
	unk_0xB815670C37E03CDE(Local_353[2 /*29*/].f_10);
	unk_0xB815670C37E03CDE(Local_353[3 /*29*/].f_10);
	unk_0xB815670C37E03CDE(Local_353[4 /*29*/].f_10);
	unk_0xB815670C37E03CDE(iLocal_731);
	while ((((((((((!unk_0x5D98D654CDC2165A(Local_353[0 /*29*/].f_9) || !unk_0x5D98D654CDC2165A(Local_353[1 /*29*/].f_9)) || !unk_0x5D98D654CDC2165A(Local_353[2 /*29*/].f_9)) || !unk_0x5D98D654CDC2165A(Local_353[3 /*29*/].f_9)) || !unk_0x5D98D654CDC2165A(Local_353[4 /*29*/].f_9)) || !unk_0x5D98D654CDC2165A(Local_353[0 /*29*/].f_10)) || !unk_0x5D98D654CDC2165A(Local_353[1 /*29*/].f_10)) || !unk_0x5D98D654CDC2165A(Local_353[2 /*29*/].f_10)) || !unk_0x5D98D654CDC2165A(Local_353[3 /*29*/].f_10)) || !unk_0x5D98D654CDC2165A(Local_353[4 /*29*/].f_10)) || !unk_0x5D98D654CDC2165A(iLocal_731))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	bLocal_639 = true;
...
void func_379()
{
	...
	unk_0x0765F7F4BF11748C(Local_751, fLocal_701);
	unk_0x0765F7F4BF11748C(Local_754, fLocal_701);
	unk_0x453924F2AAE93AD9(0f);
	unk_0x2E6EC0FAB080C550(0f, 0f);
	if (unk_0xB813DCBD5002BC42() == 4)
	{
...
void func_380()
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_734) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		if (!bLocal_630)
		{
			if (!unk_0x335C0645074963FE(iLocal_734, unk_0x33CD235DF1E6A94E(), Local_820, 0, 1, 0) || unk_0x65F35477FEAD6F0F(unk_0x33CD235DF1E6A94E()) != 0)
			{
				if (!unk_0xE19223B3551F58B8(iLocal_734))
				{
					bLocal_630 = true;
				}
			}
		}
		else if (unk_0x335C0645074963FE(iLocal_734, unk_0x33CD235DF1E6A94E(), Local_823, 0, 1, 0) && unk_0x65F35477FEAD6F0F(unk_0x33CD235DF1E6A94E()) == 0)
		{
...
void func_383()
{
	...
	if (!iLocal_640)
	{
		if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), Local_745, 50f, 50f, 50f, 0, 1, 0))
		{
			func_385();
			iLocal_640 = 1;
		}
	...
	if (!bLocal_630)
	{
		if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), Local_745, 5f, 5f, 5f, 0, 1, 0) && func_384(1077936128, 1))
		{
			unk_0x5856B9BF2B4E98C4(Local_794, Local_797, 0, 1);
			func_8(&iLocal_609);
			func_375();
			func_2();
			func_341();
...
void func_385()
{
	unk_0x0335D8135051EA56(Local_871, Local_874, 0, 1, 1, 1);
	unk_0x798B28A324675954(Local_871, Local_874);
	unk_0x9C47E5CDFB45F474(Local_904, 5f, 0);
}
...
void func_386()
{
	...
	if (iLocal_659[3])
	{
		...
		{
			func_225(2, "Player has finished shooting all the satellite dishes", 0, 0, 0, 1);
			if (unk_0x765F6FEEFF39224F(iLocal_980))
			{
				unk_0xD303E20CB0AE4AD0(iLocal_980, 1);
			}
			if (iLocal_722 <= 3)
			{
				func_372(769, 3, 1);
...
void func_387()
{
	...
	unk_0x0765F7F4BF11748C(Local_751, fLocal_701);
	unk_0x0765F7F4BF11748C(Local_754, fLocal_701);
	if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_757, Local_760, 7f, 1, 1, 0))
	{
		if (iLocal_659[1])
		{
			iLocal_637 = 0;
...
void func_389()
{
	...
	unk_0x0765F7F4BF11748C(Local_751, fLocal_701);
	unk_0x0765F7F4BF11748C(Local_754, fLocal_701);
	if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_757, Local_760, 7f, 0, 1, 0))
	{
		func_315();
		func_394();
		func_373();
		...
		if (!unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0) && (unk_0x18FB647D79B09657(iLocal_734, Local_778, 2f, 2f, 2f, 0, 1, 0) || iLocal_724 >= 3))
		{
			if (!bLocal_641)
			{
				if (iLocal_724 >= 3)
				{
					if (!unk_0x18FB647D79B09657(iLocal_734, Local_778, 2f, 2f, 2f, 0, 1, 0))
					{
						func_220(1);
					}
					iLocal_318 = 8;
		...
		if (!unk_0xE38E3CF1625A4145(Local_322[iVar0 /*10*/].f_9))
		{
			if (func_224(Local_322[iVar0 /*10*/]))
			{
				if (!Local_322[iVar0 /*10*/].f_7)
				{
					...
					unk_0xB9E84A421C105943(Local_322[iVar0 /*10*/].f_9, 1);
				}
			}
		}
		iVar0++;
	...
	while (iVar0 < 3)
	{
		...
		if (Local_322[iVar0 /*10*/].f_7 == 1)
		{
			if (!Local_322[iVar0 /*10*/].f_8)
			{
				...
				{
					unk_0x0D847D71D9E6142E(Local_322[iVar0 /*10*/]);
					iLocal_724++;
				}
				else
				{
...
{
	if (unk_0x765F6FEEFF39224F(Local_322[iParam0 /*10*/]) && !Local_322[iParam0 /*10*/].f_7)
	{
		Local_322[iParam0 /*10*/].f_5 = unk_0xE80842D7B53F8525(Local_322[iParam0 /*10*/]);
		if (Local_322[iParam0 /*10*/].f_5 < 100)
		{
			...
			unk_0xF56E8C0D662F8C55(Local_322[iParam0 /*10*/], 1, 0);
		}
	}
}
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (unk_0xBB5E373390A5F824())
			{
				...
				if (!func_211())
				{
					func_223(unk_0x33CD235DF1E6A94E(), Local_742, fLocal_690, 0, 1);
				}
				func_8(&iLocal_609);
				func_222(1);
...
void func_397()
{
	unk_0x9C47E5CDFB45F474(Local_877, 3f, 0);
	unk_0x798B28A324675954(Local_880, Local_883);
	unk_0x9C47E5CDFB45F474(Local_886, 3f, 0);
	unk_0x798B28A324675954(Local_889, Local_892);
	unk_0x9C47E5CDFB45F474(Local_895, 3f, 0);
	unk_0x798B28A324675954(Local_898, Local_901);
}
...
int func_398()
{
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			unk_0xBAE549A63F38DAE8(Local_322[iVar0 /*10*/].f_1, 2f, 0);
			Local_322[iVar0 /*10*/] = unk_0x7CA67831169E8AA6(iLocal_726, Local_322[iVar0 /*10*/].f_1, 1, 1, 0);
			if (unk_0x765F6FEEFF39224F(Local_322[iVar0 /*10*/]))
			{
				unk_0x3C990C409B3845DE(Local_322[iVar0 /*10*/], Local_322[iVar0 /*10*/].f_4);
				unk_0x739A7D2DB09904E4(Local_322[iVar0 /*10*/], 0);
				unk_0x7FC2040EB34E0E31(Local_322[iVar0 /*10*/], 100, 0);
				unk_0x76CE32E50F0C5270(Local_322[iVar0 /*10*/], 1);
				Local_322[iVar0 /*10*/].f_7 = 0;
				Local_322[iVar0 /*10*/].f_8 = 0;
			}
			iVar0++;
		}
		if (((unk_0x765F6FEEFF39224F(Local_322[0 /*10*/]) && unk_0x765F6FEEFF39224F(Local_322[1 /*10*/])) && unk_0x765F6FEEFF39224F(Local_322[2 /*10*/])) && func_399())
		{
			unk_0x71CA80D41E1338B4(iLocal_726);
			iLocal_618 = 0;
			return 1;
...
int func_399()
{
	iLocal_721 = unk_0x9EC3B269A34A2BEE(0, 3);
	if (unk_0x765F6FEEFF39224F(Local_322[iLocal_721 /*10*/]))
	{
...
void func_400()
{
	unk_0xB815670C37E03CDE(iLocal_726);
	while (!unk_0x5D98D654CDC2165A(iLocal_726))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	iLocal_618 = 1;
...
void func_401()
{
	...
	else
	{
		...
		if (unk_0xE38E3CF1625A4145(iLocal_610))
		{
			if (!unk_0xD6B80456723E619E(iLocal_610))
			{
				if (!unk_0x335C0645074963FE(iLocal_734, unk_0x33CD235DF1E6A94E(), Local_820, 0, 1, 0))
				{
					func_2();
					func_308(1, 0);
					func_313("HT_BKHTER");
			...
			else
			{
				...
				if (unk_0x335C0645074963FE(iLocal_734, unk_0x33CD235DF1E6A94E(), Local_823, 0, 1, 0))
				{
					func_308(1, 0);
					if (func_388("HT_BKHTER", 0, 0))
					{
		...
		case 1:
			if (unk_0xBB5E373390A5F824())
			{
				if (unk_0x286C823E0969F22A())
				{
					...
					if (unk_0x765F6FEEFF39224F(iLocal_733))
					{
						unk_0xEC26F4BFC9942A0C(&iLocal_733);
					}
				}
				...
				if (!func_211())
				{
					func_223(unk_0x33CD235DF1E6A94E(), Local_810, fLocal_813, 0, 1);
					func_342();
				}
				func_222(1);
				unk_0xB7350047030F7672(Local_807, 2f, 0, 0, 0, 0, 0, 0);
				func_7();
				iLocal_321 = 2;
			}
			break;
			...
			switch (iLocal_706)
			{
				case 0:
					if (func_430(1, 1093140480, 0))
					{
						...
						{
							unk_0xEF6624A3AFF02A02(unk_0x33CD235DF1E6A94E(), sLocal_740, 0, 0, 0);
						}
						if (func_224(iLocal_734))
						{
							unk_0xEF6624A3AFF02A02(iLocal_734, sLocal_741, 0, 0, 0);
							unk_0xEE199BCFFA2081A1(sLocal_741, unk_0x33CD235DF1E6A94E(), 0);
							iLocal_733 = func_426(iLocal_734, joaat("weapon_sniperrifle"), 1, 0, 0, 0, 0, 0, 0);
						}
						if (unk_0x765F6FEEFF39224F(iLocal_733))
						{
							unk_0xEF6624A3AFF02A02(iLocal_733, "Daves_Rifle", 0, 0, 0);
						}
						func_425();
						...
						{
							unk_0xBEADAF07D2339505(iLocal_980, 1806.732f, 3934.353f, 33.3275f, 1, 0, 0, 1);
							unk_0x3C990C409B3845DE(iLocal_980, 76.1155f);
						}
				...
				case 1:
					if (unk_0x3CA08F647CEAD042(sLocal_741, joaat("p_cletus_necklace_s")))
					{
						if (!bLocal_623)
						{
					...
					{
						unk_0x63B8AF155FC68CD7(iLocal_733, unk_0x33CD235DF1E6A94E());
					}
					if (unk_0x3CA08F647CEAD042(sLocal_740, 0))
					{
			...
			if (unk_0xBB5E373390A5F824())
			{
				if (func_398())
				{
					if (func_302(iLocal_734))
					{
						...
						{
							func_223(iLocal_734, Local_791, fLocal_698, 0, 1);
							unk_0x681FB12989BD5DEA(iLocal_734, joaat("weapon_sniperrifle"));
							unk_0xED68CDDDE25A144E(iLocal_734);
							iLocal_319 = 2;
						}
					}
...
int func_426(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_254(iVar2, iVar8) != 0)
	{
		if (!unk_0xD62C4419A41F106A(iParam0, 0))
		{
			if (unk_0xCC2C88B9353CAF70(iParam0, iVar2, func_254(iVar2, iVar8)))
			{
				if (func_429(func_254(iVar2, iVar8)))
				{
					uVar9 = unk_0x70418C66CB4C3F79(func_254(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_254(iVar2, iVar8) != 0)
	{
		if (!unk_0xD62C4419A41F106A(iParam0, 0))
		{
			if (unk_0xCC2C88B9353CAF70(iParam0, iVar2, func_254(iVar2, iVar8)))
			{
				unk_0x062CA5B6A29665F1(uVar1, func_254(iVar2, iVar8));
...
int func_430(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		...
		{
			if (!func_433(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_436()
{
	if (!unk_0x8D255802EBF1DA76() && func_363(unk_0x33CD235DF1E6A94E(), iLocal_734, 1) > 3f)
	{
		iLocal_711 = unk_0xE3903F59E2F22150() + 2000;
		if (func_302(iLocal_734))
		{
			if (func_302(unk_0x33CD235DF1E6A94E()))
			{
			}
			unk_0xC94CF61BF93818C8(iLocal_734, 0f, 0f, 0f, 1, 13000, 2000, 2000, 0);
			unk_0xFB4925A947E64714(fLocal_692);
			unk_0x25251FF925945B3D(fLocal_693);
			unk_0x4F34FA95E899603F(fLocal_694);
			unk_0x5704F3CD60ECC7C7(fLocal_695);
			unk_0x19DD747264520C12(fLocal_696);
			unk_0xEA7CEAC893AF46C2(1);
		}
	}
	else if (func_302(iLocal_734) && func_302(unk_0x33CD235DF1E6A94E()))
	{
		if (unk_0xE3903F59E2F22150() > iLocal_711 || func_363(unk_0x33CD235DF1E6A94E(), iLocal_734, 1) <= 3f)
		{
			if (func_363(unk_0x33CD235DF1E6A94E(), iLocal_734, 1) <= 3f)
			{
			}
			iLocal_706 = 0;
			iLocal_321 = 0;
...
void func_437()
{
	...
	if (func_302(iLocal_734))
	{
		unk_0x3D258435016D9F74(iLocal_734, 200);
		unk_0x4280426804263490(iLocal_734, 0);
		unk_0x9AA80CA39F863D9D(iLocal_734, 0);
		unk_0x5FEE418CE11E6DDE(iLocal_734, 169, 1);
		unk_0x5FEE418CE11E6DDE(iLocal_734, 206, 1);
		unk_0x5FEE418CE11E6DDE(iLocal_734, 32, 0);
		unk_0x139C6344B571F912(iLocal_734, 0);
		unk_0xFDA78B1CA2B4FB0A(iLocal_734);
		unk_0xDD9D9FFE59B3E34D(iLocal_734, 1);
		unk_0x7D1F395C3A7A37BE(iLocal_734, 0);
		unk_0xAD3D24C8070DA056(iLocal_734, 1);
		unk_0x1096811DB3A77EC1(iLocal_734, 0);
		unk_0xC36B7971576CC42F(iLocal_734, 1);
		unk_0xBCC19B7CC61AE8CD(iLocal_734, 1);
	}
	iLocal_321 = 0;
	if (func_518())
	{
...
void func_440()
{
	...
	{
		iLocal_621 = 1;
		uLocal_723 = unk_0x0757D4E12D1DE916(unk_0x33CD235DF1E6A94E(), joaat("AMMO_SNIPER"));
	}
}
...
void func_442()
{
	...
	while (!unk_0x5D98D654CDC2165A(iLocal_727))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
}
...
void func_446()
{
	if (unk_0xB813DCBD5002BC42() != 4)
	{
		if ((unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_859, Local_862, 16f, 0, 1, 0) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_865, Local_868, 19f, 0, 1, 0)) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_871, Local_874, 19f, 0, 1, 0))
		{
...
void func_447()
{
	...
	if (func_302(unk_0x33CD235DF1E6A94E()))
	{
		...
		switch (iLocal_319)
		{
			...
			case 3:
				func_308(1, 0);
				iLocal_720 = unk_0xE3903F59E2F22150() + 2000;
				unk_0xBEADAF07D2339505(iLocal_734, Local_791, 1, 0, 0, 1);
				unk_0x3C990C409B3845DE(iLocal_734, fLocal_698);
				iLocal_319 = 2;
				break;
			...
			case 2:
				if (func_302(iLocal_734))
				{
					...
					{
						bLocal_623 = true;
						iLocal_720 = unk_0xE3903F59E2F22150() + 5000;
						unk_0x681FB12989BD5DEA(iLocal_734, joaat("weapon_sniperrifle"));
						unk_0x7E268975AF5EA74F(iLocal_734, Local_778, 1f, 60000, 0.25f, 512, Local_322[iLocal_721 /*10*/].f_6);
						unk_0x1096811DB3A77EC1(iLocal_734, 0);
						iLocal_319 = 4;
					}
				}
			...
			case 4:
				if (unk_0xD76D6BCC14B95CE1(iLocal_734, 713668775) == 7)
				{
					if (unk_0x18FB647D79B09657(iLocal_734, Local_778, 1.5f, 1.5f, 1.5f, 0, 1, 0))
					{
						unk_0xED68CDDDE25A144E(iLocal_734);
						unk_0xC4A347124F39D998(iLocal_734, unk_0x33CD235DF1E6A94E(), -1, 1024, 2);
						unk_0x1096811DB3A77EC1(iLocal_734, 1);
						unk_0x4A852F02088ECC9D(iLocal_734, 1);
						iLocal_319 = 6;
					}
				}
				else if (!iLocal_659[0])
				{
					if (unk_0xE3903F59E2F22150() > iLocal_720)
					{
			...
			case 5:
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_734))
				{
					if (unk_0xEAF6E82C7BDE5A4C(iLocal_734, joaat("weapon_sniperrifle"), 0))
					{
						unk_0x681FB12989BD5DEA(iLocal_734, joaat("weapon_sniperrifle"));
					}
					if (func_478())
					{
						if (unk_0x042B0E494045A7DF(iLocal_732))
						{
						...
						func_343();
						func_8(&iLocal_610);
						unk_0x31826EF4A8BC8E9F(iLocal_734);
						unk_0xBEADAF07D2339505(iLocal_734, Local_778, 1, 0, 0, 1);
						unk_0x3C990C409B3845DE(iLocal_734, fLocal_690);
						iLocal_635 = 0;
						iLocal_319 = 6;
					}
				}
			...
			case 6:
				...
				else if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_757, Local_760, 7f, 0, 1, 0) && func_362())
				{
					if (func_475())
					{
						func_370();
			...
			case 12:
				if (func_361(&uLocal_153, cLocal_739, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					if (iLocal_719 == -1)
					{
						iLocal_719 = unk_0x6E6EB18FDAB9A074(Local_853, Local_856, 0f, 0, 7);
					}
					func_370();
					iLocal_659[9] = 1;
					func_220(0);
					...
					iLocal_714 = 0;
					unk_0xC4A347124F39D998(iLocal_734, unk_0x33CD235DF1E6A94E(), -1, 1024, 2);
					unk_0x7E268975AF5EA74F(iLocal_734, Local_781, 1f, 60000, 0.25f, 512, fLocal_691);
					unk_0x1096811DB3A77EC1(iLocal_734, 0);
					iLocal_319 = 14;
				}
				break;
			...
			case 13:
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_734))
				{
					if (func_478())
					{
						...
						unk_0x31826EF4A8BC8E9F(iLocal_734);
						unk_0xBEADAF07D2339505(iLocal_734, Local_781, 1, 0, 0, 1);
						unk_0x3C990C409B3845DE(iLocal_734, fLocal_691);
						func_370();
						func_343();
						func_344();
						func_8(&iLocal_610);
			...
			case 14:
				if (unk_0xD76D6BCC14B95CE1(iLocal_734, 713668775) == 7)
				{
					if (unk_0x18FB647D79B09657(iLocal_734, Local_781, 1.25f, 1.25f, 2.5f, 0, 1, 0) && unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_763, Local_766, 10f, 0, 1, 0))
					{
						if (func_475())
						{
							if (func_361(&uLocal_153, cLocal_739, "HUNT1_HERE", 7, 0, 0, 0) || iLocal_714 == 1)
							{
								...
								if (iLocal_719 != -1)
								{
									unk_0xF4BF002874250DB7(iLocal_719);
									iLocal_719 = -1;
								}
								func_343();
								iLocal_659[11] = 1;
			...
			case 16:
				if (func_467())
				{
					iLocal_717 = 0;
					func_448();
					unk_0x7E268975AF5EA74F(iLocal_734, Local_946[0 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
					unk_0x1096811DB3A77EC1(iLocal_734, 1);
					func_308(0, 0);
					iLocal_319 = 17;
				}
			...
			case 17:
				unk_0x9B60F55261702F28(iLocal_734, 1.4f);
				if (!iLocal_659[15])
				{
					if (func_362())
					{
						if (!func_217())
						{
							if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 0), Local_748, 1) > 10f)
							{
				...
				switch (iLocal_717)
				{
					case 0:
						...
						{
							unk_0x7E268975AF5EA74F(iLocal_734, Local_946[1 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_717++;
						}
						break;
					...
					case 1:
						...
						{
							unk_0x7E268975AF5EA74F(iLocal_734, Local_946[2 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_717++;
						}
						break;
					...
					case 2:
						...
						{
							unk_0x7E268975AF5EA74F(iLocal_734, Local_946[3 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_717++;
						}
						break;
					...
					case 3:
						...
						{
							unk_0x7E268975AF5EA74F(iLocal_734, Local_784, 1f, 60000, 0.25f, 512, fLocal_697);
							iLocal_717++;
						}
						break;
					
					case 4:
						if (unk_0xD76D6BCC14B95CE1(iLocal_734, 713668775) == 7 || (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_907, Local_910, 3.5f, 0, 1, 0) && unk_0xD4B4F68F3449CBEC(iLocal_734, Local_907, Local_910, 3.5f, 0, 1, 0)))
						{
							unk_0x1096811DB3A77EC1(iLocal_734, 0);
							iLocal_319 = 18;
						}
			...
			case 20:
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_734))
				{
					if (func_478())
					{
						...
						unk_0x31826EF4A8BC8E9F(iLocal_734);
						unk_0xBEADAF07D2339505(iLocal_734, Local_784, 1, 0, 0, 1);
						unk_0x3C990C409B3845DE(iLocal_734, fLocal_787);
						func_343();
						func_344();
						func_308(1, 0);
						iLocal_319 = 18;
			...
			case 18:
				...
				{
					Var0 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1) };
					if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_907, Local_910, 3.5f, 0, 1, 0) || Var0.f_2 > 41f)
					{
						if (func_361(&uLocal_153, cLocal_739, "HUNT_ROOF", 7, 0, 0, 0))
						{
							unk_0xED68CDDDE25A144E(iLocal_734);
							unk_0x7E268975AF5EA74F(iLocal_734, Local_788, 1f, 60000, 0.25f, 512, fLocal_699);
							iLocal_659[16] = 1;
							unk_0x1096811DB3A77EC1(iLocal_734, 0);
							iLocal_319 = 21;
						}
					}
					else if (unk_0xD76D6BCC14B95CE1(iLocal_734, -875674219) != 1)
					{
						unk_0x11C4AF4137F2A4B5(iLocal_734, unk_0x33CD235DF1E6A94E(), -1);
					}
				}
				break;
			...
			case 22:
				...
				if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_769, Local_772, 20f, 0, 1, 0))
				{
					...
					{
						func_310();
						iLocal_708 = unk_0xE3903F59E2F22150() + 2000;
						bLocal_626 = true;
					}
					if (func_475())
					{
				...
				if (bLocal_626)
				{
					if (unk_0xE3903F59E2F22150() > iLocal_708)
					{
						func_310();
			...
			case 24:
				...
				{
					unk_0x31826EF4A8BC8E9F(iLocal_734);
					unk_0xBEADAF07D2339505(iLocal_734, Local_917, 1, 0, 0, 1);
					unk_0x3C990C409B3845DE(iLocal_734, fLocal_920);
					unk_0xC4A347124F39D998(iLocal_734, unk_0x33CD235DF1E6A94E(), -1, 0, 2);
				...
				if (!func_217())
				{
					...
					else if (!func_217())
					{
						if (func_302(iLocal_734))
						{
							...
							unk_0x7E268975AF5EA74F(0, Local_966, 1f, 60000, 0.25f, 0, 40000f);
							unk_0x7E268975AF5EA74F(0, Local_969, 1f, 60000, 0.25f, 0, 40000f);
							unk_0x7E268975AF5EA74F(0, Local_972, 1f, 60000, 0.25f, 0, 40000f);
							unk_0xBD4591245C650283(0, 1193033728, 0);
							unk_0xC734F59A13D39AEF(uLocal_737);
							unk_0x13A2D602CD10CBAC(iLocal_734, uLocal_737);
							unk_0xA7A57E7757ED035E(&uLocal_737);
							unk_0x897EF720254BBEA3(iLocal_734, 1);
						}
						iLocal_319 = 0;
					}
				}
		...
		if (((iLocal_318 != 21 && !iLocal_659[20]) && iLocal_319 != 25) && iLocal_319 != 0)
		{
			if (!iLocal_627)
			{
				...
				{
					if (unk_0x3AF2B3B68DD52355(iLocal_734))
					{
						func_2();
						iLocal_710 = unk_0xE3903F59E2F22150() + 2400;
						iLocal_627 = 1;
					}
				}
				if (((unk_0xD62C4419A41F106A(iLocal_734, 0) || unk_0x91BBD269506D61D2(iLocal_734, unk_0x33CD235DF1E6A94E(), 1)) || unk_0x792D8D44CDA437C2(iLocal_734, 0, 2)) || unk_0xCA12322D8FBBDBEE(-1, unk_0xFBB1F99A825CAB09(iLocal_734, 0), 10f))
				{
					func_2();
					iLocal_710 = unk_0xE3903F59E2F22150() + 2400;
					iLocal_627 = 1;
			...
			else if (unk_0xE3903F59E2F22150() > iLocal_710)
			{
				if (unk_0x765F6FEEFF39224F(iLocal_734))
				{
					if (!unk_0xD62C4419A41F106A(iLocal_734, 0))
					{
						unk_0xED68CDDDE25A144E(iLocal_734);
						unk_0xECCD4FDA45197F97(iLocal_734, unk_0x33CD235DF1E6A94E(), 100f, -1, 0, 0);
						unk_0x897EF720254BBEA3(iLocal_734, 1);
						func_312(2);
					}
					else
	...
	if (func_452())
	{
		...
		while (iVar1 < func_451())
		{
			if (unk_0x765F6FEEFF39224F(func_450(iVar1)))
			{
				...
				{
					if (unk_0x3234E15469EA77BB(iVar0, iLocal_727))
					{
...
void func_453()
{
	if (!unk_0xF0D230FB550CD6EB(iLocal_734, 0) && !unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		if (!iLocal_992)
		{
			iLocal_993 = unk_0xE3903F59E2F22150() + 3000;
			iLocal_992 = 1;
		}
		else if (unk_0xE3903F59E2F22150() > iLocal_993)
		{
			if (func_362())
			{
...
void func_454()
{
	if (!unk_0xDFB97818AD6C09CC(iLocal_734, 1) && !unk_0xDFB97818AD6C09CC(unk_0x33CD235DF1E6A94E(), 1))
	{
		if (unk_0xF0D230FB550CD6EB(iLocal_734, 0) && unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
		{
			if (!iLocal_638)
			{
				iLocal_703 = unk_0xE3903F59E2F22150() + 3000;
				iLocal_638 = 1;
			}
			else if (unk_0xE3903F59E2F22150() > iLocal_703)
			{
				if (!func_217())
				{
					if (!iLocal_659[8])
					{
						...
						{
							if (!unk_0x786AF4A44E1B5B4B(&Local_982))
							{
								Local_982 = { func_455() };
							}
							else
...
void func_457()
{
	...
	if (func_302(unk_0x33CD235DF1E6A94E()) && func_302(iLocal_734))
	{
		if (unk_0xF0D230FB550CD6EB(iLocal_734, 0) && unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
		{
			if (func_224(iLocal_980))
			{
				if (unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0) == iLocal_980 && unk_0xF2C96862595654B4(iLocal_734, 0) == iLocal_980)
				{
					if (!iLocal_990)
					{
						iLocal_991 = unk_0xE80842D7B53F8525(iLocal_980);
						iLocal_990 = 1;
					}
					else
					{
						iVar0 = unk_0xE80842D7B53F8525(iLocal_980);
						if (iVar0 < iLocal_991)
						{
							func_458();
	...
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		if (!iLocal_659[7])
		{
			if (!func_217())
			{
				if (func_362())
				{
					if (unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0) == iLocal_980)
					{
...
void func_461()
{
	if (!unk_0xDFB97818AD6C09CC(iLocal_734, 1) && !unk_0xDFB97818AD6C09CC(unk_0x33CD235DF1E6A94E(), 1))
	{
		if (!unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_757, Local_760, 7f, 0, 1, 0))
		{
			if (!unk_0xF0D230FB550CD6EB(iLocal_734, 0) && !unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 1))
			{
				if (!iLocal_644)
				{
					if (!func_388("HT_NXTLOC", 0, 0) && iLocal_659[4])
					{
						iLocal_718 = unk_0xE3903F59E2F22150() + 20000;
						iLocal_644 = 1;
					}
				}
				else if (unk_0xE3903F59E2F22150() > iLocal_718)
				{
...
void func_464()
{
	if (!unk_0xDFB97818AD6C09CC(iLocal_734, 1) && !unk_0xDFB97818AD6C09CC(unk_0x33CD235DF1E6A94E(), 1))
	{
		if (!iLocal_988)
		{
			...
			{
				iLocal_989 = unk_0xE3903F59E2F22150() + 3000;
				iLocal_988 = 1;
			}
		}
		else if (unk_0xE3903F59E2F22150() > iLocal_989)
		{
			if (!func_217() && func_362())
			{
				if (!iLocal_659[4])
...
void func_465()
{
	if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_757, Local_760, 16f, 0, 1, 0))
	{
		if ((iLocal_683[1] && !func_388("HT_NXTLOC", 0, 0)) && !func_217())
		{
			if (!iLocal_643)
			{
				iLocal_702 = unk_0xE3903F59E2F22150() + 15000;
				iLocal_643 = 1;
			}
			else if (unk_0xE3903F59E2F22150() > iLocal_702)
			{
...
void func_466()
{
	if (unk_0x5C415D10D5CBF689(unk_0x33CD235DF1E6A94E()))
	{
		if (!iLocal_620)
		{
			uLocal_994 = unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0);
			if (!unk_0xF0D230FB550CD6EB(iLocal_734, 1))
			{
				if (!unk_0x612EFCA65BA8C250(uLocal_994))
				{
					if (func_362())
					{
						if (!func_217())
...
int func_467()
{
	if (!unk_0x1CE8F0A08E65CA6A(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) && !unk_0x1CE8F0A08E65CA6A(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3))
	{
		if (!unk_0x765F6FEEFF39224F(iLocal_732))
		{
			unk_0xED68CDDDE25A144E(iLocal_734);
		...
		{
			unk_0xEC26F4BFC9942A0C(&iLocal_732);
		}
	}
	else if (!unk_0x765F6FEEFF39224F(iLocal_732))
	{
		unk_0xED68CDDDE25A144E(iLocal_734);
		return 1;
	}
...
void func_468()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0x416C37C19CCE0077(Local_322[iVar0 /*10*/].f_1, 10f, 1))
		{
			if (!func_217())
			{
...
void func_470(int iParam0)
{
	...
	if (((iLocal_724 < 3 && !func_388("HT_SHDISH", 0, 0)) && !func_388("HT_SHTYRE", 0, 0)) && !func_388("HT_SHCOY", 0, 0))
	{
		if (iLocal_624)
		{
			if (unk_0xE3903F59E2F22150() > iLocal_712)
			{
		...
		{
			iLocal_713 = unk_0x9EC3B269A34A2BEE(10000, 15000);
			iLocal_712 = (unk_0xE3903F59E2F22150() + iLocal_713);
			iLocal_624 = 1;
		}
	}
}
			...
			case 0:
				switch (iParam0)
				{
					case 0:
						...
						if (iLocal_616)
						{
							if (!unk_0x18FB647D79B09657(iLocal_734, Local_778, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !unk_0xC5DC7627BD3861CF(iLocal_734, Local_322[iLocal_721 /*10*/].f_1, 30f))
							{
								if (unk_0xD76D6BCC14B95CE1(iLocal_734, 713668775) != 1 || unk_0xD76D6BCC14B95CE1(iLocal_734, 713668775) != 7)
								{
									iLocal_714 = 1;
								}
							}
					...
					case 1:
						if (!unk_0x18FB647D79B09657(iLocal_734, Local_781, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_472(iLocal_734, fLocal_691, 30f))
						{
							iLocal_714 = 1;
						}
						break;
					...
					case 2:
						if (!unk_0x18FB647D79B09657(iLocal_734, Local_788, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_472(iLocal_734, fLocal_699, 30f))
						{
							iLocal_714 = 1;
						}
						break;
	...
	if (!bParam1 || iLocal_616)
	{
		if (func_478())
		{
			...
			if (func_302(iLocal_734))
			{
				...
				if (bParam1)
				{
					unk_0x9F878FE3F23E2C8B(0, Local_322[iLocal_721 /*10*/].f_1, 0);
				}
				if (bParam0)
				{
				...
				unk_0x13A2D602CD10CBAC(iLocal_734, uVar0);
...
int func_475()
{
	if (func_302(unk_0x33CD235DF1E6A94E()))
	{
		if (unk_0xC996D6D89A97A11A(func_476(unk_0x33CD235DF1E6A94E())) == joaat("GROUP_SNIPER"))
		{
			return 1;
		}
	}
...
int func_478()
{
	if (unk_0x765F6FEEFF39224F(iLocal_732) && unk_0x5A4FB33F5B279A76(iLocal_732, iLocal_734))
	{
		return 1;
	}
	if (!iLocal_612)
...
void func_479()
{
	unk_0xB815670C37E03CDE(iLocal_728);
	while (!unk_0x5D98D654CDC2165A(iLocal_728))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	iLocal_612 = 1;
...
void func_480(bool bParam0)
{
	...
	if (func_302(iLocal_734))
	{
		if (unk_0x1CE8F0A08E65CA6A(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) || unk_0x1CE8F0A08E65CA6A(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_INTRO", 3))
		{
			unk_0x4A852F02088ECC9D(iLocal_734, 1);
			unk_0xE0DAC4ABE9900D9A(iLocal_734);
			unk_0x99414FB2D30425C1(&uVar0);
...
void func_481(bool bParam0)
{
	...
	iVar1 = 0;
	if (func_302(iLocal_734) && func_302(unk_0x33CD235DF1E6A94E()))
	{
		if (func_452())
		{
			iVar1 = 0;
			while (iVar1 < func_451())
			{
				...
				{
					iVar0 = unk_0x22B02EC53152632C(func_450(iVar1));
					if (iVar0 != unk_0x33CD235DF1E6A94E() && iVar0 != iLocal_734)
					{
			...
			while (iVar1 < 5)
			{
				if (unk_0x765F6FEEFF39224F(Local_353[iVar1 /*29*/].f_12))
				{
					if (unk_0x91BBD269506D61D2(Local_353[iVar1 /*29*/].f_12, unk_0x33CD235DF1E6A94E(), 1))
					{
						unk_0x0D847D71D9E6142E(Local_353[iVar1 /*29*/].f_12);
						iLocal_707++;
					}
				}
				iVar1++;
...
void func_482()
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_734))
	{
		if (((unk_0x7EEE8B447AB73C25(unk_0xFBB1F99A825CAB09(iLocal_734, 0) + Vector(2f, 2f, 2f), unk_0xFBB1F99A825CAB09(iLocal_734, 0) - Vector(2f, 2f, 2f), joaat("weapon_grenade"), 0) || unk_0x7EEE8B447AB73C25(unk_0xFBB1F99A825CAB09(iLocal_734, 0) + Vector(2f, 2f, 2f), unk_0xFBB1F99A825CAB09(iLocal_734, 0) - Vector(2f, 2f, 2f), joaat("weapon_stickybomb"), 0)) || unk_0x7EEE8B447AB73C25(unk_0xFBB1F99A825CAB09(iLocal_734, 0) + Vector(2f, 2f, 2f), unk_0xFBB1F99A825CAB09(iLocal_734, 0) - Vector(2f, 2f, 2f), joaat("weapon_molotov"), 0)) || unk_0xCA12322D8FBBDBEE(-1, unk_0xFBB1F99A825CAB09(iLocal_734, 0), 10f))
		{
			unk_0x2E68B0F85993946B(1, iLocal_608, joaat("player"));
		}
		if (!iLocal_619)
		{
			if (func_484() || unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_734))
			{
				if (func_217())
				{
					func_310();
		...
		if (!bLocal_645)
		{
			if (unk_0xE19223B3551F58B8(iLocal_734))
			{
				unk_0xAD3D24C8070DA056(iLocal_734, 0);
				bLocal_645 = true;
			}
		}
		else if (unk_0xF7C907E9E8E2BB22(iLocal_734))
		{
			unk_0xAD3D24C8070DA056(iLocal_734, 1);
			bLocal_645 = false;
		}
...
int func_484()
{
	if (func_302(iLocal_734))
	{
		if (iLocal_319 != 25)
		{
			if ((!unk_0x9ED464AAA493C8EF(unk_0x33CD235DF1E6A94E(), 6) && unk_0xA08B8AEC5B1A55D6(unk_0x33CD235DF1E6A94E())) && func_363(iLocal_734, unk_0x33CD235DF1E6A94E(), 1) <= 3f)
			{
				return 1;
			}
		}
		else if (((!unk_0x9ED464AAA493C8EF(unk_0x33CD235DF1E6A94E(), 6) && unk_0xA08B8AEC5B1A55D6(unk_0x33CD235DF1E6A94E())) && unk_0x910FF514D7BC5674(unk_0x33CD235DF1E6A94E(), iLocal_734, 30f)) && func_363(iLocal_734, unk_0x33CD235DF1E6A94E(), 1) <= 2f)
		{
			return 1;
		}
	}
...
void func_485()
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_734))
	{
		if ((unk_0x1CE8F0A08E65CA6A(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3) && unk_0x204DEACC5BECF723(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO") >= 0.68f) || iLocal_714 == 1)
		{
			if (unk_0x765F6FEEFF39224F(iLocal_732))
			{
				unk_0xEC26F4BFC9942A0C(&iLocal_732);
		...
		if (!unk_0x765F6FEEFF39224F(iLocal_732))
		{
			if (unk_0x1CE8F0A08E65CA6A(iLocal_734, "ODDJOBS@HUNTER", "binoculars_intro", 3) && unk_0x204DEACC5BECF723(iLocal_734, "ODDJOBS@HUNTER", "binoculars_intro") >= 0.242f)
			{
				iLocal_732 = unk_0x7CA67831169E8AA6(iLocal_728, unk_0xFBB1F99A825CAB09(iLocal_734, 1), 0, 0, 0);
			}
		}
		else if (!unk_0x5A4FB33F5B279A76(iLocal_732, iLocal_734))
		{
			unk_0x2F0A6390D863D337(iLocal_732, iLocal_734, unk_0xFCAF61876D23D31D(iLocal_734, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
void func_504()
{
	if (!iLocal_631)
	{
		unk_0x9315FCF6CFE2AB41("FRIENDLIES", &iLocal_608);
		unk_0x0648A75D3F60E864(iLocal_734, iLocal_608);
		unk_0xD2E80177F27FD43F(1, iLocal_608, joaat("player"));
		unk_0xD2E80177F27FD43F(1, joaat("player"), iLocal_608);
		unk_0xD2E80177F27FD43F(2, iLocal_608, -2065892691);
		unk_0xD2E80177F27FD43F(2, joaat("player"), -2065892691);
		iLocal_631 = 1;
	}
}
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			if (!unk_0x765F6FEEFF39224F(uParam0->f_28[0]))
			{
				...
				{
					unk_0x697EBA5CF1A6AB57(uParam0->f_28[0], joaat("weapon_sniperrifle"), 0, 1, 1);
				}
				else
				{
					bVar4 = false;
			...
			if (!unk_0x765F6FEEFF39224F(uParam0->f_35[0]))
			{
				...
				unk_0xB7350047030F7672(1804.501f, 3922.917f, 32.8091f, 2f, 0, 0, 0, 0, 0, 0);
			}
			if (bVar4)
			{
				iLocal_79 = 3;
		...
		case 3:
			if (func_224(uParam0->f_28[0]))
			{
				...
				unk_0x5FEE418CE11E6DDE(uParam0->f_28[0], 104, 1);
				unk_0x274C6068B660FFB4(uParam0->f_28[0], joaat("weapon_sniperrifle"), 1);
...
void func_519()
{
	...
	if (iLocal_612)
	{
		unk_0x71CA80D41E1338B4(iLocal_728);
	}
	if (bLocal_611)
	{
		unk_0xF1CFA0046BB67893(uLocal_735, 0);
	}
	if (iLocal_640)
	{
		unk_0xF1CFA0046BB67893(uLocal_736, 0);
	}
...
void func_530()
{
	unk_0x71CA80D41E1338B4(iLocal_727);
}
...
int func_533(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_536())
	{
		...
		{
			iVar33 = func_296(unk_0xD178EF744F20B712());
			if (iVar33 > -1)
			{
