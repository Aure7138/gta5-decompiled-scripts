...
void __EntryFunction__()
{
	...
	if (unk_0xA96867DD0A63C62C(joaat("ambient_tonyacall")) > 1)
	{
	...
	while (true)
	{
		...
		switch (iLocal_37)
		{
			...
			case 1:
				...
				unk_0xA9DC3948106CC3E4("amb@world_human_smoking@female@enter");
				unk_0xA9DC3948106CC3E4("amb@world_human_smoking@female@idle_a");
				unk_0x491067A8E906F22D(joaat("prop_phone_ing"));
				if (((((unk_0x2C1B5A0D3E233FC3(joaat("prop_phone_ing")) && unk_0xAD21C77209FD2024("amb@world_human_stand_mobile@female@standing@call@enter")) && unk_0xAD21C77209FD2024("amb@world_human_stand_mobile@female@standing@call@base")) && unk_0xAD21C77209FD2024("amb@world_human_stand_mobile@female@standing@call@exit")) && unk_0xAD21C77209FD2024("amb@world_human_smoking@female@enter")) && unk_0xAD21C77209FD2024("amb@world_human_smoking@female@idle_a"))
				{
					iLocal_37 = 2;
				}
				break;
...
int func_1()
{
	...
	if ((unk_0xB7A628320EFF8E47(Var0, Var3) > 10000f || unk_0x912AD5A10E7633F0(uLocal_38, 0)) || func_4())
	{
		...
		case 0:
			if (unk_0xD3FACCDA4D66AEAD(uLocal_38) && !unk_0x912AD5A10E7633F0(uLocal_38, 0))
			{
				if (unk_0x6E07DBF03F3AC258(uLocal_38, Local_57, 1f, 1f, 1f, 0, 1, 0))
				{
					...
					unk_0x3998B29E786DFD96(uLocal_38, uVar6);
					unk_0x7DFD14B8B873D6B5(&uVar6);
					iLocal_40 = 1;
				}
			}
			...
			if (unk_0xD3FACCDA4D66AEAD(uLocal_38) && !unk_0x912AD5A10E7633F0(uLocal_38, 0))
			{
				if (unk_0x962AB147BBEEBE33(uLocal_38) == 1)
				{
					if (!unk_0xD3FACCDA4D66AEAD(uLocal_39))
					{
						...
						{
							fVar7 = unk_0xAC6AEF29F754B011(uLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar7 >= 0.157f)
							{
				...
				{
					iVar8 = (unk_0xB5BF1B58C833F7A9(0, 65535) % 2);
					if (iVar8 == 0)
					{
...
int func_26(int iParam0, int iParam1)
{
	...
	uVar0 = unk_0x08BA6DD398CA197C(Global_101553.f_7940.f_99.f_219[iParam0], iParam1);
	return uVar0;
}
...
void func_27()
{
	...
	unk_0x04269E768DDAF940("amb@world_human_smoking@female@enter");
	unk_0x04269E768DDAF940("amb@world_human_smoking@female@idle_a");
