...
void __EntryFunction__()
{
	...
	if (unk_0x636F1F53CC61D2C9(joaat("ambient_tonyacall")) > 1)
	{
	...
	while (true)
	{
		...
		switch (iLocal_37)
		{
			...
			case 1:
				...
				unk_0x068BDE31F7D112BB("amb@world_human_smoking@female@enter");
				unk_0x068BDE31F7D112BB("amb@world_human_smoking@female@idle_a");
				unk_0x16E516CA9C88FF48(joaat("prop_phone_ing"));
				if (((((unk_0xA9C0BBFB9CBB66F1(joaat("prop_phone_ing")) && unk_0x0EC2B29D4172D225("amb@world_human_stand_mobile@female@standing@call@enter")) && unk_0x0EC2B29D4172D225("amb@world_human_stand_mobile@female@standing@call@base")) && unk_0x0EC2B29D4172D225("amb@world_human_stand_mobile@female@standing@call@exit")) && unk_0x0EC2B29D4172D225("amb@world_human_smoking@female@enter")) && unk_0x0EC2B29D4172D225("amb@world_human_smoking@female@idle_a"))
				{
					iLocal_37 = 2;
				}
				break;
...
int func_1()
{
	...
	{
		Var3 = { unk_0xD6E677FAD7521410(uLocal_38, 1) };
	}
	else
	{
		Var3 = { 408.5002f, -1624.583f, 29.2928f };
	}
	if ((unk_0xB7A628320EFF8E47(Var0, Var3) > 10000f || unk_0xE50EB54E0F21BED0(uLocal_38, 0)) || func_4())
	{
	...
	switch (iLocal_40)
	{
		case 0:
			...
			{
				if (unk_0x591190E69BE43117(uLocal_38, Local_57, 1f, 1f, 1f, 0, 1, 0))
				{
					unk_0x8D5B447F21217223(&uVar6);
					unk_0x5C679902079A7E80(&uVar6);
					unk_0x12D312F073772E84(0, fLocal_60, 0);
					...
					unk_0x8A1AC8EBC73850C8(uLocal_38, uVar6);
					unk_0x8D5B447F21217223(&uVar6);
					iLocal_40 = 1;
				}
			}
			...
			if (unk_0x419E13582192CFEA(uLocal_38) && !unk_0xE50EB54E0F21BED0(uLocal_38, 0))
			{
				if (unk_0x507B30DD5CDF782F(uLocal_38) == 1)
				{
					if (!unk_0x419E13582192CFEA(uLocal_39))
					{
						...
						{
							fVar7 = unk_0x4598B7969D5B0A28(uLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar7 >= 0.157f)
							{
				...
				{
					iVar8 = (unk_0xB36B8558948EA7A8(0, 65535) % 2);
					if (iVar8 == 0)
					{
...
int func_28()
{
	...
	unk_0x61CB990E8973DFE6(Var0, fLocal_41, 1, 1, &uVar3, 0, 1, -1);
	if (unk_0x419E13582192CFEA(uVar3) && !unk_0xE50EB54E0F21BED0(uVar3, 0))
	{
		...
		if (iVar4 == joaat("ig_tonya"))
		{
			...
			unk_0x2271ED1E65FB75EE(uLocal_38, joaat("player"));
			...
			if (!func_29(Local_57))
			{
				...
				{
					unk_0x45B1B4E55BF15523(uLocal_38, Local_57, 1f, -1, 0.25f, 0, fLocal_60);
					unk_0x504B26425DFF773C(uLocal_38, 1);
				}
				return 1;
			}
...
int func_32(int iParam0, int iParam1)
{
	...
	uVar0 = unk_0x234B68AC2E35ED5A(Global_112293.f_9083.f_99.f_219[iParam0], iParam1);
	return uVar0;
}
...
void func_33()
{
	...
	unk_0xF9135F131C423364("amb@world_human_smoking@female@enter");
	unk_0xF9135F131C423364("amb@world_human_smoking@female@idle_a");
