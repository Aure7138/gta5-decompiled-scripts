...
void __EntryFunction__()
{
	...
	if (unk_0x968BF1C2C695B61A(joaat("ambient_tonyacall")) > 1)
	{
	...
	while (true)
	{
		...
		switch (iLocal_36)
		{
			...
			case 1:
				...
				unk_0x295DC04FC13E025B("amb@world_human_smoking@female@enter");
				unk_0x295DC04FC13E025B("amb@world_human_smoking@female@idle_a");
				unk_0x32A12757CBF48A33(joaat("prop_phone_ing"));
				if (((((unk_0x33ACB874CECA2D4B(joaat("prop_phone_ing")) && unk_0x8E8B546E1A81D27F("amb@world_human_stand_mobile@female@standing@call@enter")) && unk_0x8E8B546E1A81D27F("amb@world_human_stand_mobile@female@standing@call@base")) && unk_0x8E8B546E1A81D27F("amb@world_human_stand_mobile@female@standing@call@exit")) && unk_0x8E8B546E1A81D27F("amb@world_human_smoking@female@enter")) && unk_0x8E8B546E1A81D27F("amb@world_human_smoking@female@idle_a"))
				{
					iLocal_36 = 2;
				}
				break;
...
int func_1()
{
	...
	if ((unk_0xB7A628320EFF8E47(Var0, Var3) > 10000f || unk_0x930F8FBB8E9537CC(uLocal_37)) || func_4())
	{
	...
	switch (iLocal_39)
	{
		case 0:
			if (unk_0x86CCCD2FAE9D5E65(uLocal_37) && !unk_0x930F8FBB8E9537CC(uLocal_37))
			{
				...
				{
					unk_0xA3561415EB3DA3A3(&uVar6);
					unk_0xEAD984C2869B8B7C(&uVar6);
					...
					unk_0x56D9ED1541046AF6(uVar6);
					unk_0xC65002CAA1212AF9(uLocal_37, uVar6);
					unk_0xA3561415EB3DA3A3(&uVar6);
					iLocal_39 = 1;
				}
			}
			...
			if (unk_0x86CCCD2FAE9D5E65(uLocal_37) && !unk_0x930F8FBB8E9537CC(uLocal_37))
			{
				if (unk_0xAE5083278B0C9CDD(uLocal_37) == 1)
				{
					if (!unk_0x86CCCD2FAE9D5E65(uLocal_38))
					{
						...
						{
							fVar7 = unk_0xC00796CF40447CA8(uLocal_37, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar7 >= 0.157f)
							{
				...
				{
					iVar8 = (unk_0x2E0A9E3291F398E3(0, 65535) % 2);
					if (iVar8 == 0)
					{
...
int func_26(int iParam0, int iParam1)
{
	...
	uVar0 = unk_0x236D8AD7EE179F46(Global_98931.f_7699.f_99.f_219[iParam0], iParam1);
	return uVar0;
}
...
void func_27()
{
	...
	unk_0xD8323B49BAE93D80("amb@world_human_smoking@female@enter");
	unk_0xD8323B49BAE93D80("amb@world_human_smoking@female@idle_a");
