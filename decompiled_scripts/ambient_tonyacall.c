...
void __EntryFunction__()
{
	...
	if (unk_0x8F38E94BBF3404CD(joaat("ambient_tonyacall")) > 1)
	{
	...
	while (true)
	{
		...
		switch (iLocal_37)
		{
			...
			case 1:
				...
				unk_0x6450931B826B49D9("amb@world_human_smoking@female@enter");
				unk_0x6450931B826B49D9("amb@world_human_smoking@female@idle_a");
				unk_0x6FF834D85E2DD4C6(joaat("prop_phone_ing"));
				if (((((unk_0x9A0B2ED5055D3F0B(joaat("prop_phone_ing")) && unk_0x3A801AA34DD821BE("amb@world_human_stand_mobile@female@standing@call@enter")) && unk_0x3A801AA34DD821BE("amb@world_human_stand_mobile@female@standing@call@base")) && unk_0x3A801AA34DD821BE("amb@world_human_stand_mobile@female@standing@call@exit")) && unk_0x3A801AA34DD821BE("amb@world_human_smoking@female@enter")) && unk_0x3A801AA34DD821BE("amb@world_human_smoking@female@idle_a"))
				{
					iLocal_37 = 2;
				}
				break;
...
int func_1()
{
	...
	if ((unk_0xB7A628320EFF8E47(Var0, Var3) > 10000f || unk_0x191BE1BC8F26F3C1(uLocal_38, 0)) || func_4())
	{
	...
	switch (iLocal_40)
	{
		case 0:
			if (unk_0x6ADD12BF4D6D2587(uLocal_38) && !unk_0x191BE1BC8F26F3C1(uLocal_38, 0))
			{
				...
				{
					unk_0xFAA3EF7FF92E1F9E(&uVar6);
					unk_0x6931076730A4AC5D(&uVar6);
					...
					unk_0x1B16DD5C115FE009(uVar6);
					unk_0xAB30B1CF01A198C1(uLocal_38, uVar6);
					unk_0xFAA3EF7FF92E1F9E(&uVar6);
					iLocal_40 = 1;
				}
			}
			...
			if (unk_0x6ADD12BF4D6D2587(uLocal_38) && !unk_0x191BE1BC8F26F3C1(uLocal_38, 0))
			{
				if (unk_0x2332DC2174507412(uLocal_38) == 1)
				{
					if (!unk_0x6ADD12BF4D6D2587(uLocal_39))
					{
						...
						{
							fVar7 = unk_0x7A70772AE40E3821(uLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar7 >= 0.157f)
							{
				...
				{
					iVar8 = (unk_0x63A6486593EC7EC3(0, 65535) % 2);
					if (iVar8 == 0)
					{
...
int func_26(int iParam0, int iParam1)
{
	...
	uVar0 = unk_0xC80D31E4B587871C(Global_104555.f_9055.f_99.f_219[iParam0], iParam1);
	return uVar0;
}
...
void func_27()
{
	...
	unk_0xFCCDDE0E48CF9588("amb@world_human_smoking@female@enter");
	unk_0xFCCDDE0E48CF9588("amb@world_human_smoking@female@idle_a");
