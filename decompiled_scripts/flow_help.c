...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (Global_112915.f_20410.f_145 > 0 || Global_111555)
		{
				...
				if (!Global_111554)
				{
					if (Global_112915.f_20410.f_145 > 0)
					{
						if (func_20(&(Global_112915.f_20410[iLocal_37 /*16*/])))
						{
							if (func_18(func_19()))
							{
								if (unk_0xE2D0C323A1AE5D85(Global_112915.f_20410[iLocal_37 /*16*/].f_11, func_12()))
								{
									if (Global_112915.f_20410[iLocal_37 /*16*/].f_12 == Global_112915.f_20410.f_146[func_12()])
									{
										if (unk_0x320D1840B6DAA1CC() > Global_111557)
										{
											if (unk_0x320D1840B6DAA1CC() > Global_112915.f_20410[iLocal_37 /*16*/].f_8)
											{
												if (unk_0x3C57C2F07FEE34D2(&(Global_112915.f_20410[iLocal_37 /*16*/].f_4), ""))
												{
			...
			if (!unk_0x3C57C2F07FEE34D2(&(Global_112915.f_20410[iLocal_37 /*16*/]), &Local_20) && !unk_0x3C57C2F07FEE34D2(&(Global_112915.f_20410[iLocal_37 /*16*/]), ""))
			{
				if (Global_112915.f_20410[iLocal_37 /*16*/].f_10 != -1)
				{
					if (unk_0x320D1840B6DAA1CC() > Global_112915.f_20410[iLocal_37 /*16*/].f_10)
					{
						iVar2 = iLocal_37;
