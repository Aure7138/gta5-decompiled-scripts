...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (Global_111858.f_20406.f_145 > 0 || Global_110498)
		{
				...
				if (!Global_110497)
				{
					if (Global_111858.f_20406.f_145 > 0)
					{
						if (func_20(&(Global_111858.f_20406[iLocal_37 /*16*/])))
						{
							if (func_18(func_19()))
							{
								if (unk_0xCE990E643CD9D0E5(Global_111858.f_20406[iLocal_37 /*16*/].f_11, func_12()))
								{
									if (Global_111858.f_20406[iLocal_37 /*16*/].f_12 == Global_111858.f_20406.f_146[func_12()])
									{
										if (unk_0x578C4EF320340AF7() > Global_110500)
										{
											if (unk_0x578C4EF320340AF7() > Global_111858.f_20406[iLocal_37 /*16*/].f_8)
											{
												if (unk_0xF005CCA4263DF67F(&(Global_111858.f_20406[iLocal_37 /*16*/].f_4), ""))
												{
			...
			if (!unk_0xF005CCA4263DF67F(&(Global_111858.f_20406[iLocal_37 /*16*/]), &Local_20) && !unk_0xF005CCA4263DF67F(&(Global_111858.f_20406[iLocal_37 /*16*/]), ""))
			{
				if (Global_111858.f_20406[iLocal_37 /*16*/].f_10 != -1)
				{
					if (unk_0x578C4EF320340AF7() > Global_111858.f_20406[iLocal_37 /*16*/].f_10)
					{
						iVar2 = iLocal_37;
