#region Local Var
	...
	var uLocal_101 = 0;
	var uLocal_102 = 0;
	struct<6> Local_103 = { 0, 0, 0, 0, 0, -1 } ;
	var uLocal_109 = 0;
	var uLocal_110 = 0;
	var uLocal_111 = 3;
	var uLocal_112 = 17;
...
void __EntryFunction__()
{
	...
	unk_0x7C11D0C2EFACD80D("FMMC", 2);
	unk_0x4D51E59243281D80(unk_0x217E9DC48139933D(), 0, 0);
	iLocal_224 = Global_1602437.f_1;
	func_16(1, iLocal_224 != 6, 1);
	Global_1312441 = 0;
	Local_103.f_5 = Global_1602437;
	Global_1312366 = 0;
	Global_1312442 = 0;
	iLocal_223 = Global_1602437;
	if (Global_1602437 == 0)
	{
		Global_1602437.f_1 = iLocal_224;
	}
	Global_1675348 = 0;
	while (true)
	{
		if (iLocal_223 != Global_1602437)
		{
			func_15(&Local_103);
			iLocal_223 = Global_1602437;
			unk_0x7D1D4A3602B6AD4E(&(Local_103.f_4), 0);
		}
		if (func_14() == 3)
		{
			func_26();
		...
		switch (iLocal_221)
		{
			case 0:
				unk_0x7C11D0C2EFACD80D("FMMC", 2);
				if (unk_0xA25C10B66B1AA911("FMMC", 2))
				{
					iLocal_221 = 1;
				}
				break;
			...
			case 1:
				if (Local_103.f_5 != Global_1602437)
				{
					Local_103.f_5 = Global_1602437;
					func_16(1, 1, 1);
					func_15(&Local_103);
				}
				unk_0x56CE42A528156A67();
				func_12(&Local_103);
				Global_1675349 = 0;
				Global_1675348 = 0;
				iLocal_221 = 4;
			...
			case 4:
				if (func_9())
				{
					if ((Global_1602437.f_1 != 6 && Global_1602437 != 4) && Global_1602437.f_1 != 5)
					{
						if (func_8(&uLocal_222))
						{
							iLocal_221 = 2;
						}
					}
					...
					{
						if (func_7(&uLocal_222))
						{
							iLocal_221 = 2;
						}
					}
					else if (func_6(&uLocal_222))
					{
						iLocal_221 = 2;
					}
				}
			...
			case 3:
				if (unk_0xCCBB0BB9790E1F47(2, 217))
				{
					iLocal_221 = 1;
				}
				break;
...
{
	if (!unk_0x4ED6CFDFE8D4131A(*uParam0, 2))
	{
		unk_0x46ED607DDD40D7FE("FM_Race_Creator");
		if (unk_0xE97BD36574F8B0A6("FM_Race_Creator"))
		{
			if (!func_3())
			{
				unk_0xE81651AD79516E48("FM_Race_Creator", 17000);
				unk_0x0086D3067E1CFD1C("FM_Race_Creator");
				unk_0xF73FBE4845C43B5B(uParam0, 2);
			}
		}
	}
	else if (unk_0x8E34C953364A76DD(joaat("fm_race_creator")) == 0)
	{
...
int func_3()
{
	if ((((unk_0x8E34C953364A76DD(joaat("fm_mission_creator")) > 0 || unk_0x8E34C953364A76DD(joaat("fm_deathmatch_creator")) > 0) || unk_0x8E34C953364A76DD(joaat("fm_race_creator")) > 0) || unk_0x8E34C953364A76DD(joaat("fm_capture_creator")) > 0) || unk_0x8E34C953364A76DD(joaat("fm_lts_creator")) > 0)
	{
		return 1;
	}
	return 0;
...
int func_5(var uParam0)
{
	if (!unk_0x4ED6CFDFE8D4131A(*uParam0, 2))
	{
		unk_0x46ED607DDD40D7FE("FM_Deathmatch_Creator");
		if (unk_0xE97BD36574F8B0A6("FM_Deathmatch_Creator"))
		{
			if (!func_3())
			{
				unk_0xE81651AD79516E48("FM_Deathmatch_Creator", 17000);
				unk_0x0086D3067E1CFD1C("FM_Deathmatch_Creator");
				unk_0xF73FBE4845C43B5B(uParam0, 2);
			}
		}
	}
	else if (unk_0x8E34C953364A76DD(joaat("fm_deathmatch_creator")) == 0)
	{
		unk_0x7D1D4A3602B6AD4E(uParam0, 2);
		return 1;
	}
...
int func_6(var uParam0)
{
	if (!unk_0x4ED6CFDFE8D4131A(*uParam0, 2))
	{
		unk_0x46ED607DDD40D7FE("FM_Capture_Creator");
		if (unk_0xE97BD36574F8B0A6("FM_Capture_Creator"))
		{
			if (!func_3())
			{
				unk_0xE81651AD79516E48("FM_Capture_Creator", 17000);
				unk_0x0086D3067E1CFD1C("FM_Capture_Creator");
				unk_0xF73FBE4845C43B5B(uParam0, 2);
			}
		}
	}
	else if (unk_0x8E34C953364A76DD(joaat("fm_capture_creator")) == 0)
	{
		unk_0x7D1D4A3602B6AD4E(uParam0, 2);
		return 1;
	}
...
int func_7(var uParam0)
{
	if (!unk_0x4ED6CFDFE8D4131A(*uParam0, 2))
	{
		unk_0x46ED607DDD40D7FE("FM_LTS_Creator");
		if (unk_0xE97BD36574F8B0A6("FM_LTS_Creator"))
		{
			if (!func_3())
			{
				unk_0xE81651AD79516E48("FM_LTS_Creator", 17000);
				unk_0x0086D3067E1CFD1C("FM_LTS_Creator");
				unk_0xF73FBE4845C43B5B(uParam0, 2);
			}
		}
	}
	else if (unk_0x8E34C953364A76DD(joaat("fm_lts_creator")) == 0)
	{
		unk_0x7D1D4A3602B6AD4E(uParam0, 2);
		return 1;
	}
...
int func_8(var uParam0)
{
	if (!unk_0x4ED6CFDFE8D4131A(*uParam0, 2))
	{
		unk_0x46ED607DDD40D7FE("FM_Mission_Creator");
		if (unk_0xE97BD36574F8B0A6("FM_Mission_Creator"))
		{
			if (!func_3())
			{
				unk_0xE81651AD79516E48("FM_Mission_Creator", 17000);
				unk_0x0086D3067E1CFD1C("FM_Mission_Creator");
				unk_0xF73FBE4845C43B5B(uParam0, 2);
			}
		}
	}
	else if (unk_0x8E34C953364A76DD(joaat("fm_mission_creator")) == 0)
	{
		unk_0x7D1D4A3602B6AD4E(uParam0, 2);
		return 1;
	}
...
void func_12(var uParam0)
{
	if (Global_1602437 == 0)
	{
		Global_1602437.f_13 = uParam0->f_8[0 /*18*/][5];
		Global_1602437.f_14 = uParam0->f_8[0 /*18*/][5];
		Global_1602437.f_18 = uParam0->f_8[0 /*18*/][7] + 1;
	}
	else if (Global_1602437 == 1)
	{
		Global_1602437.f_13 = uParam0->f_8[1 /*18*/][0];
		Global_1602437.f_37 = uParam0->f_8[1 /*18*/][2];
		Global_1602437.f_39 = uParam0->f_8[1 /*18*/][3];
		Global_1602437.f_15 = uParam0->f_8[1 /*18*/][4];
		Global_1602437.f_32189 = uParam0->f_8[1 /*18*/][5];
		Global_1602437.f_32188 = uParam0->f_8[1 /*18*/][6];
		Global_1602437.f_45 = uParam0->f_8[1 /*18*/][7];
		Global_1602437.f_26304 = uParam0->f_8[1 /*18*/][8];
		Global_1602437.f_50 = uParam0->f_8[1 /*18*/][9];
		Global_1602437.f_40 = uParam0->f_8[1 /*18*/][10];
		Global_1602437.f_42 = uParam0->f_8[1 /*18*/][11];
		Global_1602437.f_44 = uParam0->f_8[1 /*18*/][12];
		Global_1602437.f_43 = uParam0->f_8[1 /*18*/][13];
		Global_1602437.f_33013 = uParam0->f_8[1 /*18*/][14];
	}
	else if (Global_1602437 == 2)
	{
		Global_1602437.f_13 = uParam0->f_8[2 /*18*/][4];
		Global_1602437.f_25922 = uParam0->f_8[2 /*18*/][14];
		Global_1602437.f_25919 = uParam0->f_8[2 /*18*/][7];
	}
}
...
int func_14()
{
	if (unk_0x4ED6CFDFE8D4131A(Global_1327593.f_102, 1))
	{
		return 1;
	}
	if (unk_0x4ED6CFDFE8D4131A(Global_1327593.f_102, 2))
	{
		unk_0x7D1D4A3602B6AD4E(&(Global_1327593.f_102), 2);
		return 2;
	}
	if (unk_0x4ED6CFDFE8D4131A(Global_1327593.f_102, 3))
	{
		unk_0x7D1D4A3602B6AD4E(&(Global_1327593.f_102), 3);
		return 3;
	}
	return 0;
}
...
void func_15(var uParam0)
{
	...
	uParam0->f_8[0 /*18*/][7] = 1;
	uParam0->f_8[0 /*18*/][11] = 0;
}
...
void func_16(bool bParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 <= 4)
	{
		func_23(&(Global_1602437.f_60434[iVar0 /*1269*/]));
		func_21(&(Global_1602437.f_66780[iVar0 /*434*/]));
		iVar0++;
	}
	func_21(&(Global_1602437.f_68951));
	iVar0 = 0;
	while (iVar0 <= 24)
	{
	...
	while (iVar0 <= 68)
	{
		func_20(&(Global_1602437.f_57342[iVar0 /*39*/]), iVar0);
		iVar0++;
	}
	...
	while (iVar0 <= 9)
	{
		func_19(&(Global_1602437.f_69739[iVar0 /*10*/]));
		iVar0++;
	}
