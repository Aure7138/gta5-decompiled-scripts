...
void __EntryFunction__()
{
	...
	if (unk_0x9EC5BDC006623C42(19))
	{
		...
		unk_0x65BA35D6D61F1574("JOSH4_MISSION_FAIL");
		func_454(1);
		func_443();
	}
	if (func_442())
	{
		func_476("*** Setting up initial scene for replay");
		func_441(Local_106, fLocal_109, 1, 0);
		func_476("*** Replay setup started");
		Global_71835 = 1;
		iLocal_79 = 0;
		while (!func_430(&Local_443))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		func_476("*** Josh 4 scene set up");
		func_429(&Local_443, 0, 1);
		Global_71835 = 0;
	}
	if (func_428(Local_443.f_28[1]))
	{
		unk_0x9FD099B0593CD91D(Local_443.f_28[1], 1);
	}
	if (func_428(Local_443.f_28[2]))
	{
		unk_0x9FD099B0593CD91D(Local_443.f_28[2], 1);
	}
	iLocal_507 = Local_443.f_35[0];
	iLocal_508 = Local_443.f_35[1];
	func_476("*** About to set up positions...");
	func_427();
	func_425(58, 2, 0);
	if (func_442())
	{
		func_476("*** Creating replay vehicle and jumping to post-cutscene");
		func_325(&iLocal_86, -1100.04f, 280.6f, 63.53f, 267.48f, 0, 0, 1, 1, 0, joaat("asterope"), 0, 145, 1);
		unk_0x65BA35D6D61F1574("JOSH4_RESTART1");
		func_318();
	}
	while (true)
	{
		unk_0x65F534DDBF48606F("SF_BOC", 0);
		unk_0x4EDE34FBADD967A6(0);
		func_302(Local_443.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_87)
		{
			case 0:
				func_293();
...
void func_1()
{
	...
	switch (iLocal_88)
	{
		case 0:
			func_429(&Local_443, 0, 1);
			if (func_428(iLocal_507))
			{
				unk_0x4D5F3407F1F37E28(iLocal_507, 0, 0, 0, 0, 0, 0, 0, 0);
			}
			if (func_428(iLocal_508))
			{
				unk_0x4D5F3407F1F37E28(iLocal_508, 0, 0, 0, 0, 0, 0, 0, 0);
			}
			func_254("JOSH4_LOSECOPS", 7500, 1);
			unk_0x98F04A4FFB4AD01C(unk_0x3EE1295CEFBEFED4(), 2, 0);
			unk_0x66D901F8097E8E86(unk_0x3EE1295CEFBEFED4(), 0);
			unk_0x798B28A324675954(-1140.223f, 271.745f, 50f, -1082.403f, 344.8568f, 80f);
			unk_0x252F9CE6A90B6B86(-1140.223f, 271.745f, 50f, -1082.403f, 344.8568f, 80f, 0, 0);
			unk_0x9C47E5CDFB45F474(-1114.788f, 319.3401f, 66.1226f, 20.5f, 0);
			if (func_428(Local_443.f_28[0]))
			{
				unk_0xC4A347124F39D998(Local_443.f_28[0], unk_0x33CD235DF1E6A94E(), -1, 0, 2);
			}
			unk_0x29074975F22A27B9(2);
			iLocal_511 = unk_0xE3903F59E2F22150();
			iLocal_88 = 1;
			break;
		...
		case 1:
			...
			func_208();
			func_206();
			if (unk_0x002F527E1A3238DC(unk_0x3EE1295CEFBEFED4()) <= 0 && !func_205())
			{
				iVar0 = 1;
				while (iVar0 <= (Local_443.f_28 - 1))
				{
					if (func_428(Local_443.f_28[iVar0]))
					{
				...
				{
					if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_507, 0))
					{
						func_202(777);
					}
				}
...
void func_2()
{
	if (func_428(unk_0x33CD235DF1E6A94E()))
	{
		if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
		{
			unk_0x65BA35D6D61F1574("JOSH4_COPS_LOST_RADIO");
			func_476("Starting 'JOSH4_COPS_LOST_RADIO'");
		}
		else
		{
			unk_0x65BA35D6D61F1574("JOSH4_COPS_LOST");
			func_476("Starting 'JOSH4_COPS_LOST'");
		}
	}
	else
	{
		unk_0x65BA35D6D61F1574("JOSH4_COPS_LOST");
		func_476("Player is somehow not alive when passing the mission - starting 'JOSH4_COPS_LOST'");
	}
	func_3(91, 1);
	func_443();
}
...
int func_70(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2539502[iParam0 /*3*/][func_69(iParam1)];
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_70(func_88(iParam1, uParam0->f_2), Global_71399, 0);
			if (unk_0x0E4018692D92041D(uVar0, uParam0->f_1))
			{
				unk_0x8950ED5730F62EE8(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_70(iVar1, Global_71399, 0);
				if (!unk_0x0E4018692D92041D(uVar0, uParam0->f_1))
				{
					unk_0x8950ED5730F62EE8(&(uParam0->f_6), 4);
				}
...
void func_206()
{
	if (iLocal_533 == 0)
	{
		if (func_207(unk_0x33CD235DF1E6A94E(), -1116.62f, 299.12f, 64.96f, 1) > 50f)
		{
			unk_0xCF33FE51707573DB("SCRIPTED_SCANNER_REPORT_JOSH_4_01", 0f);
			func_476("*** Played special Josh 4 police report ***");
			iLocal_533 = 1;
		}
	}
}
...
void func_208()
{
	if (iLocal_528 == 0)
	{
		if (!unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -1208.581f, 309.8494f, 80.69189f, -1041.645f, 319.5811f, 60.40263f, 178.5f, 0, 1, 0))
		{
			while (func_205())
			{
				func_223();
			...
			func_222(&uLocal_278, 2, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
			func_222(&uLocal_278, 4, Local_443.f_28[0], "JOSH", 0, 1);
			iLocal_531 = unk_0xE3903F59E2F22150();
			iLocal_528++;
		}
	}
	else if (iLocal_528 == 1)
	{
		if (iLocal_102 != 0)
		{
			if ((unk_0xE3903F59E2F22150() - iLocal_531) > 6000)
			{
				if (iLocal_102 == 3)
				{
				...
				else if (iLocal_102 == 1)
				{
					if (func_428(Local_443.f_28[0]))
					{
						if (func_209(unk_0x33CD235DF1E6A94E(), Local_443.f_28[0], 1) < 75f)
						{
	...
	switch (iLocal_102)
	{
		case 0:
			if (iLocal_101 == 3)
			{
				if (func_428(Local_443.f_28[0]))
				{
					unk_0xED68CDDDE25A144E(Local_443.f_28[0]);
					if (func_203(iLocal_508))
					{
						if (unk_0xA58C083E829597F7(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, iLocal_508, 0))
						{
							func_476("Back gate blocked");
							Local_110 = { -1130.35f, 307.92f, 65.19f };
							unk_0x99414FB2D30425C1(&uLocal_506);
							unk_0x7E268975AF5EA74F(0, Local_110, 2f, 20000, 1f, 1, 1193033728);
							unk_0x7E268975AF5EA74F(0, -1126.56f, 319.85f, 65.98f, 2f, 20000, 1f, 1, 1193033728);
							unk_0xECCD4FDA45197F97(0, unk_0x33CD235DF1E6A94E(), 500f, -1, 0, 0);
							unk_0xC734F59A13D39AEF(uLocal_506);
							unk_0x897EF720254BBEA3(Local_443.f_28[0], 1);
							unk_0x13A2D602CD10CBAC(Local_443.f_28[0], uLocal_506);
						}
						else
						{
							func_476("Back gate clear");
							unk_0x99414FB2D30425C1(&uLocal_506);
							if (func_203(iLocal_508))
							{
								unk_0x48B8A6610EAA0C89(0, iLocal_508, unk_0x33CD235DF1E6A94E(), 8, 30f, 786469, 500f, 0.1f, 1);
							}
							else
							{
								unk_0xECCD4FDA45197F97(0, unk_0x33CD235DF1E6A94E(), 500f, -1, 0, 0);
					...
					else
					{
						...
						if (func_203(iLocal_508))
						{
							unk_0xC838CE9837D0ABAF(0, iLocal_508, 20000, -1, 1073741824, 1, 0);
							unk_0x48B8A6610EAA0C89(0, iLocal_508, unk_0x33CD235DF1E6A94E(), 8, 30f, 786469, 500f, 0.1f, 1);
						}
						else
						{
					...
					unk_0x33F6BE48E356DA27(Local_443.f_28[0], 2, 1);
					unk_0xA7A57E7757ED035E(&uLocal_506);
				}
				iLocal_532 = unk_0xE3903F59E2F22150();
				unk_0x7D1F395C3A7A37BE(Local_443.f_28[0], 1);
				unk_0x5FEE418CE11E6DDE(Local_443.f_28[0], 177, 1);
				iLocal_102 = 1;
			}
			break;
		...
		case 1:
			if (func_428(Local_443.f_28[0]))
			{
				if (!iLocal_525)
				{
					...
					{
						if (func_209(Local_443.f_28[0], unk_0x33CD235DF1E6A94E(), 0) < 20f)
						{
							func_222(&uLocal_278, 2, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
							func_222(&uLocal_278, 4, Local_443.f_28[0], "JOSH", 0, 1);
							if (func_205())
							...
							func_476("Doing Josh comment");
						}
						else
						{
							func_476("Too far away to do Josh comment");
						}
						iLocal_525 = 1;
					}
				}
				if (func_203(iLocal_508))
				{
					if (unk_0x10930B9CAD4111C2(Local_443.f_28[0], iLocal_508, 1))
					{
						if (unk_0x787CBB9DB6BA1A49(iLocal_508) < 20f)
						{
							unk_0xED68CDDDE25A144E(Local_443.f_28[0]);
							unk_0x07C339D4328CA16C(Local_443.f_28[0], 0, 4416);
							unk_0xECCD4FDA45197F97(Local_443.f_28[0], unk_0x33CD235DF1E6A94E(), 510f, -1, 0, 0);
							func_228(&iLocal_508);
						}
					}
					if (func_428(unk_0x33CD235DF1E6A94E()))
					{
						if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_508, 1))
						{
							unk_0xED68CDDDE25A144E(Local_443.f_28[0]);
							unk_0xECCD4FDA45197F97(Local_443.f_28[0], unk_0x33CD235DF1E6A94E(), 510f, -1, 0, 0);
							func_228(&iLocal_508);
					...
					if (unk_0x2E9A4AE2A5B4D8E8(Local_443.f_28[0]))
					{
						if (iLocal_526 == 0)
						{
				...
				if (func_209(unk_0x33CD235DF1E6A94E(), Local_443.f_28[0], 1) > 350f)
				{
					func_476("Deleting Josh, setting as lost");
					func_227(&(Local_443.f_28[0]));
					func_226(&iLocal_508);
					iLocal_102 = 2;
				}
				if (func_428(unk_0x33CD235DF1E6A94E()) && func_428(Local_443.f_28[0]))
				{
					if (iLocal_529 < 3)
					{
						if (func_209(unk_0x33CD235DF1E6A94E(), Local_443.f_28[0], 1) < 10f)
						{
							if (!func_205() && (unk_0xE3903F59E2F22150() - iLocal_532) > 8000)
							{
			...
			{
				if (unk_0x91BBD269506D61D2(Local_443.f_28[0], unk_0x33CD235DF1E6A94E(), 1))
				{
					unk_0xB5D26BFA756D0D11(2f, 2f, 0);
					func_476("Player killed Josh!");
					func_202(776);
				}
				func_476("Josh - DEAD!");
				if (func_205())
...
void func_231()
{
	switch (Local_89.f_11)
	{
		case 0:
			...
			while (iLocal_510 <= 4)
			{
				if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_534[iLocal_510 /*7*/], Local_534[iLocal_510 /*7*/].f_3, Local_534[iLocal_510 /*7*/].f_6, 0, 1, 2))
				{
					func_232("Player detected inside flee direction trigger: ", iLocal_510);
					unk_0xB815670C37E03CDE(iLocal_85);
					unk_0xB815670C37E03CDE(iLocal_84);
					...
					func_476("Requesting flee recording: ");
					func_232(Local_89.f_10, Local_89.f_9);
					unk_0xD51062C52BCD2AE8(Local_89.f_9, Local_89.f_10);
					while ((!unk_0x371855A6F27F144B(Local_89.f_9, Local_89.f_10) || !unk_0x5D98D654CDC2165A(iLocal_85)) || !unk_0x5D98D654CDC2165A(iLocal_84))
					{
						unk_0x4EDE34FBADD967A6(0);
					}
					func_476("Flee car has loaded!");
					Local_89.f_11 = 1;
				}
				iLocal_510++;
			}
		...
		case 1:
			if (!unk_0x765F6FEEFF39224F(Local_89.f_7))
			{
				Local_89.f_7 = unk_0xC651C43AB13A15E5(iLocal_85, Local_89, 0f, 1, 1, 0);
				unk_0x1B2303F9DC2D90D5(Local_89.f_7, 1084227584);
				unk_0x6FBC94381B016AB4(Local_89.f_7, Local_89.f_3, Local_89.f_4, Local_89.f_5, Local_89.f_6);
				Local_89.f_8 = unk_0xE196503B36B6194B(Local_89.f_7, 6, iLocal_84, -1, 1, 1);
				unk_0x697EBA5CF1A6AB57(Local_89.f_8, joaat("weapon_pistol"), -1, 0, 1);
				unk_0x4A852F02088ECC9D(Local_89.f_8, 1);
				unk_0xED68CDDDE25A144E(Local_89.f_8);
				func_476("Flee car created!");
				Local_89.f_11 = 2;
			}
			break;
		...
		case 2:
			...
			{
				if (func_428(Local_89.f_8))
				{
					if (unk_0xF0D230FB550CD6EB(Local_89.f_8, 0))
					{
						unk_0xCCFFBA26C1726838(Local_89.f_7, Local_89.f_9, Local_89.f_10, 1);
						unk_0x2B2AFC30DE3FE922(Local_89.f_7, 1);
						func_232("*** m_AI_FleeCar.iRecNum: ", Local_89.f_9);
						switch (Local_89.f_9)
						{
							case 0:
								unk_0xA36A8CD53DC38048(Local_89.f_7, 1.5f);
								break;
							
							case 1:
								unk_0xA36A8CD53DC38048(Local_89.f_7, 1f);
								break;
							
							case 2:
								unk_0xA36A8CD53DC38048(Local_89.f_7, 1.4f);
								break;
		...
		case 3:
			if (func_203(Local_89.f_7))
			{
				if (!unk_0x4278060E716E1226(Local_89.f_7))
				{
					if (unk_0x371855A6F27F144B(Local_89.f_9, Local_89.f_10))
					{
						unk_0x4167B14D99BD7D75(Local_89.f_9, Local_89.f_10);
						func_476("Flee car recording finished!");
						Local_89.f_11 = 4;
					}
				}
				else
		...
		case 4:
			if (func_203(Local_89.f_7))
			{
				if (func_428(Local_89.f_8))
				{
					unk_0x4A852F02088ECC9D(Local_89.f_8, 0);
					func_204(&(Local_89.f_8), 1, 0, 1);
				}
				Local_89.f_11 = 5;
				func_228(&(Local_89.f_7));
			}
			func_476("Flee car & ped released!");
			break;
	}
}
...
void func_233()
{
	...
	switch (iLocal_101)
	{
		case 0:
			...
			if ((unk_0xE3903F59E2F22150() - iLocal_511) > 4000)
			{
				func_476("************************************** TIMEOUT - AIM next frame");
				iLocal_101 = 1;
				iLocal_511 = unk_0xE3903F59E2F22150();
			}
			iVar0 = 1;
			while (iVar0 <= (Local_443.f_28 - 1))
			{
				if (func_428(Local_443.f_28[iVar0]))
				{
					if (func_209(Local_443.f_28[iVar0], unk_0x33CD235DF1E6A94E(), 0) > 10f)
					{
						func_476("************************************** TOO FAR - AIM next frame");
						iLocal_101 = 1;
						iLocal_511 = unk_0xE3903F59E2F22150();
					}
				}
		...
		case 2:
			if ((unk_0xE3903F59E2F22150() - iLocal_511) > 20000)
			{
				func_476("************************************** TIMEOUT - ARREST next frame");
				if (func_428(Local_443.f_28[1]))
				{
					unk_0xED68CDDDE25A144E(Local_443.f_28[1]);
					unk_0x4A852F02088ECC9D(Local_443.f_28[1], 0);
					unk_0xFEC326A8E632C9AE(Local_443.f_28[1], unk_0x33CD235DF1E6A94E());
				}
				iLocal_101 = 4;
				iLocal_511 = unk_0xE3903F59E2F22150();
			}
			...
			while (iVar0 <= (Local_443.f_28 - 1))
			{
				if (func_428(Local_443.f_28[iVar0]))
				{
					if (func_209(Local_443.f_28[iVar0], unk_0x33CD235DF1E6A94E(), 0) > 12f)
					{
						func_476("************************************** TOO FAR - ATTACK next frame");
						iLocal_101 = 3;
						iLocal_511 = unk_0xE3903F59E2F22150();
					}
				}
		...
		case 4:
			...
			while (iVar0 <= (Local_443.f_28 - 1))
			{
				if (func_428(Local_443.f_28[iVar0]))
				{
					...
					{
						func_476("************************************** THREAT DURING ARREST - ATTACK next frame");
						iLocal_101 = 3;
						iLocal_511 = unk_0xE3903F59E2F22150();
					}
				}
		...
		case 3:
			...
			if (!iLocal_518)
			{
				...
				unk_0xA53C1C92EE35EC0E(6, 1);
				iVar0 = 1;
				while (iVar0 <= (Local_443.f_28 - 1))
				{
					if (func_428(Local_443.f_28[iVar0]))
					{
						unk_0xED68CDDDE25A144E(Local_443.f_28[iVar0]);
						unk_0x4A852F02088ECC9D(Local_443.f_28[iVar0], 0);
						unk_0x99414FB2D30425C1(&uLocal_506);
						unk_0x0B303ED4E12A5F06(0, unk_0x33CD235DF1E6A94E(), -1, joaat("FIRING_PATTERN_BURST_FIRE"));
						unk_0xC734F59A13D39AEF(uLocal_506);
						unk_0x13A2D602CD10CBAC(Local_443.f_28[iVar0], uLocal_506);
						unk_0xA7A57E7757ED035E(&uLocal_506);
					}
					iVar0++;
				}
				func_222(&uLocal_113, 2, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
				...
				func_476("Doing cop fire warning");
				iLocal_518 = 1;
				iLocal_530 = unk_0xE3903F59E2F22150();
			}
			else
			{
				iVar1 = 1;
				...
				{
					if (func_428(Local_443.f_28[iVar1]))
					{
						if (func_209(Local_443.f_28[iVar1], unk_0x33CD235DF1E6A94E(), 1) > 20f)
						{
							unk_0xDE9FF07CFD5DC172(Local_443.f_28[iVar1], 75);
						}
						else
						{
							unk_0xDE9FF07CFD5DC172(Local_443.f_28[iVar1], 1);
						}
					}
					iVar1++;
				}
				if ((unk_0xE3903F59E2F22150() - iLocal_530) > 15000)
				{
					iVar1 = 1;
					while (iVar1 <= (Local_443.f_28 - 1))
					{
						if (func_428(Local_443.f_28[iVar1]))
						{
							if (func_209(Local_443.f_28[iVar1], unk_0x33CD235DF1E6A94E(), 1) >= 50f)
							{
	...
	if (iLocal_101 != 3)
	{
		...
		while (iVar0 <= (Local_443.f_28 - 1))
		{
			if (func_428(Local_443.f_28[iVar0]))
			{
				if (unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), Local_443.f_28[iVar0]))
				{
					iVar2 = joaat("weapon_unarmed");
					if (!unk_0x96C4B46F194803A7(unk_0x33CD235DF1E6A94E(), &iVar2, 1))
					{
						func_476("************************************** AIMED WEAPON - ATTACK now");
						iLocal_101 = 3;
					}
				}
				if (func_234(Local_443.f_28[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					func_476("************************************** ATTACKED/THREATENED - ATTACK now");
					iLocal_101 = 3;
				}
				if (iLocal_101 != 4)
				{
					if (func_209(Local_443.f_28[iVar0], unk_0x33CD235DF1E6A94E(), 0) < 2.3f)
					{
						func_476("************************************** TOO CLOSE - ATTACK now");
						iLocal_101 = 3;
					}
				}
			}
...
int func_234(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_428(unk_0x33CD235DF1E6A94E()) && func_428(iParam0))
	{
		...
		if (!unk_0x9ED464AAA493C8EF(unk_0x33CD235DF1E6A94E(), 6))
		{
			if (unk_0xA08B8AEC5B1A55D6(unk_0x33CD235DF1E6A94E()))
			{
				...
				{
					return func_247(unk_0x33CD235DF1E6A94E(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_235(int iParam0, float fParam1)
{
	...
	if (func_428(unk_0x33CD235DF1E6A94E()) && func_428(iParam0))
	{
		if (func_246(iParam0) || unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iParam0))
		{
			if (unk_0x9ED464AAA493C8EF(unk_0x33CD235DF1E6A94E(), 6))
			{
				fVar0 = 40f;
...
{
	return func_237(iParam0, unk_0x33CD235DF1E6A94E(), fParam1, 1, 250, 7);
}
...
int func_241(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_243(unk_0xFBB1F99A825CAB09(iParam1, 1) - unk_0xFBB1F99A825CAB09(iParam0, 1)) };
	...
	{
		Var3 = { func_243(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_251(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_243(Param1 - unk_0xFBB1F99A825CAB09(iParam0, 1)) };
...
void func_253()
{
	...
	else
	{
		...
		{
			case 0:
				if ((unk_0xE3903F59E2F22150() - iLocal_105) > 1000)
				{
					iLocal_103 = 1;
				}
				break;
			...
			case 1:
				if (!func_205() && !unk_0xC4B7D5901EDA35B5())
				{
					if (iLocal_104)
					{
						func_222(&uLocal_113, 2, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
...
void func_255()
{
	if (iLocal_87 == 1)
	{
		...
		{
			if (unk_0x7E15D709E86EB560() > 14000 && !iLocal_522)
			{
				unk_0x65BA35D6D61F1574("JOSH4_START");
				func_476("Starting 'JOSH4_START'");
				iLocal_522 = 1;
			}
		}
	}
	...
	{
		unk_0x65BA35D6D61F1574("JOSH4_ACTION");
		func_476("Starting 'JOSH4_ACTION'");
		iLocal_523 = 1;
	}
	else if (!iLocal_524)
	{
		if (func_428(unk_0x33CD235DF1E6A94E()))
		{
			if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
			{
				unk_0x65BA35D6D61F1574("JOSH4_VEHICLE");
				func_476("Starting 'JOSH4_VEHICLE'");
				iLocal_524 = 1;
			}
		}
	}
...
void func_256()
{
	...
	if (unk_0xA812C1043FE92B58())
	{
		if (func_428(Local_443.f_28[1]))
		{
			func_476("Trying to set Cop 1 component variation (intro loop)");
			unk_0xEE199BCFFA2081A1("Cop_standing_idle", Local_443.f_28[1], 0);
		}
		if (func_428(Local_443.f_28[2]))
		{
			func_476("Trying to set Cop 2 component variation (intro loop)");
			unk_0xEE199BCFFA2081A1("Cop_with_notepad", Local_443.f_28[2], 0);
		}
	}
	switch (iLocal_88)
	{
		case 0:
			if (!unk_0xCE3CFF625BEBAA04(sLocal_83, ""))
			{
				if (iLocal_519 == 0)
				{
		...
		case 1:
			switch (iLocal_527)
			{
				case 0:
					if (func_284(1, 1093140480, 0))
					{
						...
						if (func_203(iVar0))
						{
							...
							else if (unk_0xD4B4F68F3449CBEC(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, 1, 0))
							{
						...
						if (func_203(iLocal_507))
						{
							unk_0xBEADAF07D2339505(iLocal_507, -1107.5f, 280.33f, 64.01f, 1, 0, 0, 1);
							unk_0x3C990C409B3845DE(iLocal_507, 97.97f);
							unk_0x1B2303F9DC2D90D5(iLocal_507, 1084227584);
						}
						iLocal_527++;
					}
					break;
				...
				case 1:
					unk_0x0483D0035D6E46FD("rcmjosh4");
					unk_0x0483D0035D6E46FD("combat@gestures@pistol@halt");
					unk_0x0483D0035D6E46FD("combat@gestures@pistol@glances");
					unk_0xB815670C37E03CDE(iLocal_509);
					iLocal_527++;
					break;
				
				case 2:
					if (((unk_0xE9CCF312047EBEE0("rcmjosh4") && unk_0xE9CCF312047EBEE0("combat@gestures@pistol@halt")) && unk_0xE9CCF312047EBEE0("combat@gestures@pistol@glances")) && unk_0x5D98D654CDC2165A(iLocal_509))
					{
						iLocal_527++;
					}
					break;
				...
				case 3:
					...
					if (func_268())
					{
						...
						unk_0xB5D26BFA756D0D11(0f, 5f, 0);
						iLocal_527 = 4;
					}
					func_267();
					if (unk_0x66D6584F4E8C88AE())
					{
						...
						{
							unk_0x65BA35D6D61F1574("JOSH4_START");
							func_476("Starting 'JOSH4_START' via cutscene skip");
							iLocal_522 = 1;
						}
					}
					break;
...
void func_257(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_258(unk_0x33CD235DF1E6A94E()))
	{
...
void func_259(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if (((((!unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()) && !func_263(unk_0x95B959F18401C09A())) && !func_261(unk_0x95B959F18401C09A(), 0)) && !func_260()) && !bParam4) && !bParam5)
			{
				unk_0x9611832841071B69(unk_0x33CD235DF1E6A94E(), 0);
			}
		}
		else if (((!unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()) && !func_263(unk_0x95B959F18401C09A())) && !bParam4) && !bParam5)
		{
			unk_0x9611832841071B69(unk_0x33CD235DF1E6A94E(), 0);
		}
		Global_71588 = 0;
...
void func_267()
{
	if (unk_0x3CA08F647CEAD042("Josh", 0))
	{
		if (func_428(Local_443.f_28[0]))
		{
			func_476("Playing Josh's leadout");
			unk_0x99414FB2D30425C1(&uLocal_506);
			unk_0xC4A347124F39D998(0, unk_0x33CD235DF1E6A94E(), -1, 2, 2);
			unk_0x108754262311D34F(0, "rcmjosh4", "josh_leadout_loop", 4f, -4f, -1, 262153, 0, 0, 0, 0);
			unk_0xC734F59A13D39AEF(uLocal_506);
			unk_0x13A2D602CD10CBAC(Local_443.f_28[0], uLocal_506);
			unk_0xA7A57E7757ED035E(&uLocal_506);
			unk_0x13C3FE558ED056EE(Local_443.f_28[0], joaat("MotionState_DoNothing"), 0, 1, 0);
		}
	}
	if (unk_0x3CA08F647CEAD042("Security_guard_pistol", 0))
	{
		if (func_428(iLocal_504) && func_428(Local_443.f_28[1]))
		{
			unk_0x63B8AF155FC68CD7(iLocal_504, Local_443.f_28[1]);
			func_476("*** Gave idle cop gun");
		}
	}
	if (unk_0x3CA08F647CEAD042("FBI_Agent_1_Gun", 0))
	{
		if (func_428(iLocal_505) && func_428(Local_443.f_28[2]))
		{
			unk_0x63B8AF155FC68CD7(iLocal_505, Local_443.f_28[2]);
			func_476("*** Gave notepad cop gun");
		}
	}
	if (unk_0x3CA08F647CEAD042("Cop_standing_idle", 0))
	{
		if (func_428(Local_443.f_28[1]))
		{
			unk_0x13C3FE558ED056EE(Local_443.f_28[1], joaat("MotionState_Aiming"), 0, 1, 0);
			unk_0x99414FB2D30425C1(&uLocal_506);
			unk_0xC4A347124F39D998(0, unk_0x33CD235DF1E6A94E(), -1, 1026, 2);
			unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), -1, 1);
			unk_0x108754262311D34F(0, "combat@gestures@pistol@glances", "90", 8f, -1000f, -1, 262184, 0, 0, 0, 0);
			unk_0xC734F59A13D39AEF(uLocal_506);
			unk_0x13A2D602CD10CBAC(Local_443.f_28[1], uLocal_506);
			unk_0xA7A57E7757ED035E(&uLocal_506);
			func_476("*** Idle cop anim");
		}
	}
	if (unk_0x3CA08F647CEAD042("Cop_with_notepad", 0))
	{
		if (func_428(Local_443.f_28[2]))
		{
			unk_0x13C3FE558ED056EE(Local_443.f_28[2], joaat("MotionState_Aiming"), 0, 1, 0);
			unk_0x99414FB2D30425C1(&uLocal_506);
			unk_0xC4A347124F39D998(0, unk_0x33CD235DF1E6A94E(), -1, 1026, 2);
			unk_0x1E6D9DB41BEDAFB3(0, -1103.72f, 289.46f, 63.23f, unk_0x33CD235DF1E6A94E(), 1f, 0, 0.1f, 1082130432, 1, 0, 1, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
			unk_0x1E6D9DB41BEDAFB3(0, -1106.08f, 288.55f, 63.31f, unk_0x33CD235DF1E6A94E(), 1f, 0, 0.1f, 1082130432, 1, 0, 1, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
			unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), -1, 1);
			unk_0xC734F59A13D39AEF(uLocal_506);
			unk_0x13A2D602CD10CBAC(Local_443.f_28[2], uLocal_506);
			unk_0xA7A57E7757ED035E(&uLocal_506);
			func_476("*** Notepad cop anim");
		}
	}
}
...
void func_269(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0xF272A2699B521CE6(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x9C47E5CDFB45F474(func_271(unk_0x3EE1295CEFBEFED4()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_283()
{
	if (func_428(unk_0x33CD235DF1E6A94E()))
	{
		...
		func_476("*** Registered Trevor");
	}
	if (func_428(Local_443.f_28[0]))
	{
		unk_0xEF6624A3AFF02A02(Local_443.f_28[0], "Josh", 0, 0, 0);
		func_476("*** Registered Josh");
	}
	if (func_428(Local_443.f_28[1]))
	{
		iLocal_504 = unk_0x99D60D17E2820498(joaat("weapon_pistol"), -1, unk_0xFBB1F99A825CAB09(Local_443.f_28[1], 1), 1, 1065353216, 0, 0, 1);
		unk_0xEF6624A3AFF02A02(Local_443.f_28[1], "Cop_standing_idle", 0, 0, 0);
		func_476("*** Registered Cop standing");
	}
	if (func_428(Local_443.f_28[2]))
	{
		iLocal_505 = unk_0x99D60D17E2820498(joaat("weapon_pistol"), -1, unk_0xFBB1F99A825CAB09(Local_443.f_28[2], 1), 1, 1065353216, 0, 0, 1);
		unk_0xEF6624A3AFF02A02(Local_443.f_28[2], "Cop_with_notepad", 0, 0, 0);
		func_476("*** Registered Cop with notepad");
	}
	if (func_428(iLocal_504))
	{
		unk_0xEF6624A3AFF02A02(iLocal_504, "Security_guard_pistol", 0, 0, 0);
		func_476("*** Registered idle cop gun");
	}
	if (func_428(iLocal_505))
	{
		unk_0xEF6624A3AFF02A02(iLocal_505, "FBI_Agent_1_Gun", 0, 0, 0);
		func_476("*** Registered notepad cop gun");
	}
	iLocal_522 = 0;
	iLocal_523 = 0;
	iLocal_524 = 0;
...
int func_284(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		...
		{
			if (!func_288(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_287(unk_0x33CD235DF1E6A94E(), -828834893))
				{
...
void func_291(int iParam0)
{
	...
	unk_0x0483D0035D6E46FD("combat@gestures@pistol@glances");
	unk_0xB815670C37E03CDE(iLocal_509);
	while ((!unk_0xE9CCF312047EBEE0("combat@gestures@pistol@halt") || !unk_0xE9CCF312047EBEE0("combat@gestures@pistol@glances")) || !unk_0x5D98D654CDC2165A(iLocal_509))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (unk_0x8FCF53827AC6136E(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"), 0))
	{
		unk_0x41D9972DE84520AB(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, 0, 0f, 0);
	}
	if (unk_0x8FCF53827AC6136E(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), 0))
	{
		unk_0x41D9972DE84520AB(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, 0, 0f, 0);
	}
	if (func_428(Local_443.f_28[0]))
	{
		if (iParam0 == 1)
		{
			unk_0xBEADAF07D2339505(Local_443.f_28[0], -1103.962f, 291.3401f, 63.367f, 1, 0, 0, 1);
			unk_0x3C990C409B3845DE(Local_443.f_28[0], 193.1737f);
			unk_0x108754262311D34F(Local_443.f_28[0], "rcmjosh4", "josh_leadout_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
		}
		unk_0xAD3D24C8070DA056(Local_443.f_28[0], 1);
		unk_0xF0BE7CB40DE62A2F(Local_443.f_28[0], 1);
	}
	if (iParam0 == 1)
	{
		if (func_428(Local_443.f_28[2]))
		{
			unk_0x697EBA5CF1A6AB57(Local_443.f_28[2], joaat("weapon_pistol"), -1, 1, 1);
			unk_0xBEADAF07D2339505(Local_443.f_28[2], -1106.08f, 288.55f, 63.31f, 1, 0, 0, 1);
			unk_0x99414FB2D30425C1(&uLocal_506);
			unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), -1, 1);
			unk_0xC734F59A13D39AEF(uLocal_506);
			unk_0x13A2D602CD10CBAC(Local_443.f_28[2], uLocal_506);
			unk_0xA7A57E7757ED035E(&uLocal_506);
			unk_0x4A852F02088ECC9D(Local_443.f_28[2], 1);
		}
	}
	if (iParam0 == 1)
	{
		if (func_428(Local_443.f_28[1]))
		{
			unk_0x697EBA5CF1A6AB57(Local_443.f_28[1], joaat("weapon_pistol"), -1, 1, 1);
			unk_0xBEADAF07D2339505(Local_443.f_28[1], -1102.41f, 289.73f, 63.18f, 1, 0, 0, 1);
			unk_0x99414FB2D30425C1(&uLocal_506);
			unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), -1, 1);
			unk_0xC734F59A13D39AEF(uLocal_506);
			unk_0x13A2D602CD10CBAC(Local_443.f_28[1], uLocal_506);
			unk_0xA7A57E7757ED035E(&uLocal_506);
			unk_0x4A852F02088ECC9D(Local_443.f_28[1], 1);
		}
	}
	if (func_428(Local_443.f_28[1]))
	{
		unk_0x28F648743D7DE312(Local_443.f_28[1], 23, 1);
	}
	if (func_428(Local_443.f_28[2]))
	{
		unk_0x28F648743D7DE312(Local_443.f_28[2], 23, 1);
	}
	if (func_203(Local_443.f_35[1]))
	{
		unk_0xD303E20CB0AE4AD0(Local_443.f_35[1], 1);
	}
	func_222(&uLocal_278, 2, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
	iLocal_512 = 0;
	iLocal_513 = 0;
...
void func_293()
{
	...
	if (unk_0xA812C1043FE92B58())
	{
		if (func_428(Local_443.f_28[1]))
		{
			func_476("Trying to set Cop 1 component variation (leadin loop)");
			unk_0xEE199BCFFA2081A1("Cop_standing_idle", Local_443.f_28[1], 0);
		}
		if (func_428(Local_443.f_28[2]))
		{
			func_476("Trying to set Cop 2 component variation (leadin loop)");
			unk_0xEE199BCFFA2081A1("Cop_with_notepad", Local_443.f_28[2], 0);
		}
	}
	switch (iLocal_88)
	{
		case 0:
			if (!func_5(0) && unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0))
			{
				func_476("Doing setup for leadin");
				func_222(&uLocal_278, 4, Local_443.f_28[0], "JOSH", 0, 1);
				func_222(&uLocal_278, 2, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
				unk_0x0483D0035D6E46FD("rcmjosh4");
				if (unk_0xE9CCF312047EBEE0("rcmjosh4"))
				{
					iLocal_88 = 1;
				}
			}
			...
			{
				func_476("Skipping setup for leadin (repeat play/wrong area)");
				func_290(1);
			}
			break;
		...
		case 1:
			if (!func_5(0) && unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0))
			{
				if (func_428(unk_0x33CD235DF1E6A94E()) && func_258(Local_443.f_28[0]))
				{
					if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, 1, 0))
					{
						if (!func_294())
						{
							if (!func_287(unk_0x33CD235DF1E6A94E(), -875674219))
							{
								unk_0x11C4AF4137F2A4B5(unk_0x33CD235DF1E6A94E(), Local_443.f_28[0], 0);
							}
						}
						else
						{
				...
				if (!iLocal_519)
				{
					...
					{
						if (unk_0x1CE8F0A08E65CA6A(Local_443.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_205())
						{
							unk_0x108754262311D34F(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, -1, 2, 0, 0, 0, 0);
							func_476("Done Josh leadin anim");
							if (func_258(Local_443.f_28[2]))
							{
								unk_0x108754262311D34F(Local_443.f_28[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, -1, 2, 0, 0, 0, 0);
								func_476("Done Notepad cop leadin anim");
							}
							if (func_258(Local_443.f_28[1]))
							{
								unk_0x108754262311D34F(Local_443.f_28[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, -1, 2, 0, 0, 0, 0);
								func_476("Done Speaker cop leadin anim");
							}
							unk_0x4742207943D8EB65();
							unk_0xAD16833367AC0879("JOSH_4_INT_CONCAT", 2, 8);
							iLocal_519 = 1;
						}
					}
				}
				...
				{
					if ((func_428(unk_0x33CD235DF1E6A94E()) && func_258(Local_443.f_28[0])) && !func_294())
					{
						if (!func_287(unk_0x33CD235DF1E6A94E(), -875674219))
						{
							unk_0x11C4AF4137F2A4B5(unk_0x33CD235DF1E6A94E(), Local_443.f_28[0], 0);
					...
					if (func_258(Local_443.f_28[0]))
					{
						if (unk_0x1CE8F0A08E65CA6A(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							if (unk_0x204DEACC5BECF723(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.276f)
							{
								if (iLocal_520 == 0)
								{
									if (func_210(&uLocal_278, "JOSH4AU", "JOSH_4_INTLI", 9, 0, 0, 0))
									{
										unk_0xB5D26BFA756D0D11(2f, 3f, 1);
										iLocal_520 = 1;
									}
								}
							}
							if (unk_0x204DEACC5BECF723(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.98f)
							{
								func_290(1);
							}
							if (func_209(unk_0x33CD235DF1E6A94E(), Local_443.f_28[0], 1) <= 2f)
							{
								if (func_205())
								{
									func_223();
								}
								func_476("Player too close to Josh, starting cutscene early");
								func_290(1);
							}
						}
						else
...
void func_296()
{
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
	{
		if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
		{
			if (func_288(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_302(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0xBB5E373390A5F824())
			{
				...
				Var4 = { func_304(Global_71845, Global_71847, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
struct<2> func_304(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar2;
...
int func_313(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (((!func_315(0) || Global_71859) || Global_71848 == 1) || !unk_0x73DA1542B2F0C458())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((unk_0x286C823E0969F22A() || func_300(0)) || func_314(1))
			{
			}
			else
			{
...
void func_318()
{
	if (func_428(Local_443.f_28[1]))
	{
		unk_0xC7C47D4054903839(Local_443.f_28[1], -1102.48f, 290.2f, 64.22f, 0, 0, 1);
		unk_0x3C990C409B3845DE(Local_443.f_28[1], 177.74f);
	}
	else
	{
		Local_443.f_28[1] = unk_0x9BA5CF280376EEA4(6, iLocal_84, -1102.92f, 290.12f, -200f, 40.46f, 0, 0);
	}
	if (func_428(Local_443.f_28[2]))
	{
		unk_0xC7C47D4054903839(Local_443.f_28[2], -1103.94f, 290.21f, 64.28f, 0, 0, 1);
		unk_0x3C990C409B3845DE(Local_443.f_28[2], -167.67f);
	}
	else
	{
		Local_443.f_28[2] = unk_0x9BA5CF280376EEA4(6, iLocal_84, -1102.73f, 290.91f, -200f, 92.06f, 0, 0);
	}
	if (!func_324())
	{
		func_323(unk_0x33CD235DF1E6A94E(), Local_106, fLocal_109, 1, 1);
		unk_0xD6EDA274D82E8678(0f, 1065353216);
		unk_0xC7E6A5D90DED6E0B(0f);
	}
	func_291(1);
	unk_0xB815670C37E03CDE(iLocal_509);
	while (!unk_0x5D98D654CDC2165A(iLocal_509))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	func_290(2);
...
int func_321(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		unk_0x1ABC36611CBE0E84(-1502457334, 0f, 0, 0);
		unk_0x046ED2CF120C8949(-1502457334, 3, 0, 1);
		iVar0++;
	}
	else
	{
	...
	if (bParam1)
	{
		unk_0x1ABC36611CBE0E84(-1994188940, 0f, 0, 0);
		unk_0x046ED2CF120C8949(-1994188940, 3, 0, 1);
		iVar0++;
	}
	else
	{
...
int func_322(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		unk_0xE02A7B5EE70EF82F(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0);
		unk_0x1ABC36611CBE0E84(904342475, 1f, 0, 0);
		unk_0x046ED2CF120C8949(904342475, 4, 0, 1);
		iVar0++;
	}
	else
	{
	...
	if (bParam1)
	{
		unk_0xE02A7B5EE70EF82F(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), 0);
		unk_0x1ABC36611CBE0E84(-795418380, -0.9f, 0, 0);
		unk_0x046ED2CF120C8949(-795418380, 4, 0, 1);
		iVar0++;
	}
	else
	{
...
int func_323(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
void func_325(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_442() || !func_424())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_421(iParam6, iParam7, iParam8, iParam13))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_399(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_398(Param1, 0f, 0f, 0f, 0))
		{
			Param1 = { Global_100114.f_2890 };
			fParam4 = Global_100114.f_2890.f_6;
		}
		unk_0xCE04CE961AF41AB9(Param1, 5f, 1, 0, 0, 0);
		func_392(Param1, 5f, 0);
		if (func_151(iParam12))
		{
			func_390(iParam12, 0);
			while (!func_326(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
		}
...
int func_326(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)
{
	var uVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (unk_0x5D98D654CDC2165A(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = unk_0xC651C43AB13A15E5(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, 0, 0, 0);
				...
				func_384(iParam0, &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (unk_0x5D98D654CDC2165A(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = unk_0xC651C43AB13A15E5(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, 0, 0, 0);
				...
				func_384(iParam0, &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				unk_0x90425F35DD715133(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (unk_0x541D5C57194E73C4(*iParam0) == joaat("bodhi2"))
...
void func_327(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_151(iParam0) && unk_0x765F6FEEFF39224F(*iParam1)) && unk_0x91D5C8283D19AF49(*iParam1, 0))
	{
		...
		if (unk_0x7BF2203BA17719C8(*iParam1) >= 0 && func_332(*iParam1, 0, &uVar0))
		{
			func_331(iParam1, &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106565.f_20112[iParam0 /*43*/].f_31 = func_330(*iParam1);
				...
				func_328(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_106565.f_20112[iParam0 /*43*/].f_1));
				...
				func_328(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_106565.f_20112[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_328(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_329(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_329(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_332(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = unk_0x541D5C57194E73C4(iParam0);
	if ((!func_360(iVar0, bParam1, uParam2) && !func_359(unk_0x95B959F18401C09A())) && !func_343(iParam0))
	{
		return 0;
	}
	if (func_359(unk_0x95B959F18401C09A()))
	{
		if (func_342(iVar0))
		{
			return 1;
	...
	bVar1 = false;
	if (func_341(unk_0x95B959F18401C09A()) && (unk_0x097E7778E3E162E8(iVar0) || unk_0x57D74362A8BD1490(iVar0)))
	{
		bVar1 = true;
	}
	if (((unk_0xF3E8C179636ED71E(iParam0) && !func_339(iParam0)) && !bVar1) && !(func_338(unk_0x541D5C57194E73C4(iParam0)) && func_334(unk_0x95B959F18401C09A())))
	{
	...
	if (!unk_0xB331FCEB94EB05C8())
	{
		if ((func_333(iParam0) && unk_0x541D5C57194E73C4(iParam0) != joaat("sentinel2")) && unk_0x541D5C57194E73C4(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_334(int iParam0)
{
	if (iParam0 != func_337())
	{
		if (func_336(iParam0, 1, 1))
		{
			...
			{
				return func_335(Global_2424047[iParam0 /*416*/].f_309.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_339(int iParam0)
{
	switch (unk_0x541D5C57194E73C4(iParam0))
	{
		...
		case joaat("monster4"):
		case joaat("monster5"):
			if (func_340(unk_0x95B959F18401C09A()))
			{
				return 1;
			}
			break;
...
int func_340(int iParam0)
{
	if (iParam0 != func_337())
	{
		if (func_336(iParam0, 1, 1))
		{
			if (Global_2424047[iParam0 /*416*/].f_309.f_5 != -1)
			{
				return func_335(Global_2424047[iParam0 /*416*/].f_309.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_341(int iParam0)
{
	if (iParam0 != func_337())
	{
		if (func_336(iParam0, 1, 1))
		{
			if (Global_2424047[iParam0 /*416*/].f_309.f_5 != -1)
			{
				return func_335(Global_2424047[iParam0 /*416*/].f_309.f_5) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_358(unk_0x95B959F18401C09A()) || func_357(unk_0x95B959F18401C09A()))
	{
		if (func_344(iParam0))
		{
			return 1;
...
int func_345(int iParam0)
{
	...
	if (func_346(unk_0x541D5C57194E73C4(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_347(int iParam0, bool bParam1)
{
	switch (unk_0x541D5C57194E73C4(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_349(unk_0x541D5C57194E73C4(iParam0), 0))
			{
				if (Global_2528542.f_292 == iParam0)
				{
					return 1;
				}
				else if (func_348(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_357(int iParam0)
{
	if (iParam0 != func_337())
	{
		if (func_336(iParam0, 1, 1))
		{
			...
			{
				return func_335(Global_2424047[iParam0 /*416*/].f_309.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_358(int iParam0)
{
	if (iParam0 != func_337())
	{
		if (func_336(iParam0, 1, 1))
		{
			if (Global_2424047[iParam0 /*416*/].f_309.f_5 != -1 && Global_2424047[iParam0 /*416*/].f_309.f_8 != func_337())
			{
				return func_335(Global_2424047[iParam0 /*416*/].f_309.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_359(int iParam0)
{
	if (iParam0 != func_337())
	{
		if (func_336(iParam0, 1, 1))
		{
			if (Global_2424047[iParam0 /*416*/].f_309.f_5 != -1)
			{
				return func_335(Global_2424047[iParam0 /*416*/].f_309.f_5) == 9;
			}
		}
	}
	return 0;
...
int func_360(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_341(unk_0x95B959F18401C09A()) && (unk_0x097E7778E3E162E8(iParam0) || unk_0x57D74362A8BD1490(iParam0)))
	{
		bVar0 = true;
	}
...
void func_362(int iParam0, int iParam1)
{
	...
	func_363(iParam0, &(Global_106565.f_32743.f_5510));
}
...
void func_363(int iParam0, var uParam1)
{
	...
	if (unk_0x91D5C8283D19AF49(iParam0, 0))
	{
		...
		*uParam1 = unk_0x4FD199DD0B583F5C(iParam0);
		...
		if (uParam1->f_65 == -1 && !func_365(uParam1->f_66))
		{
			uParam1->f_65 = 0;
		}
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x8950ED5730F62EE8(&(uParam1->f_77), func_364(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!unk_0x765F6FEEFF39224F(iParam0) || !unk_0x91D5C8283D19AF49(iParam0, 0)) || func_277(iParam0, 0, 0)) || func_277(iParam0, 1, 0)) || func_277(iParam0, 2, 0)) || func_380(iParam0) != 145) || func_379(iParam0)) || func_378(iParam0)) || func_333(iParam0)) || func_377(iParam0)) || !func_367(unk_0x541D5C57194E73C4(iParam0)))
	{
		if (func_378(iParam0))
		{
		}
...
int func_384(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_356(unk_0x541D5C57194E73C4(*uParam0), 1) && unk_0xEECA910C75BFF02B(*uParam0, 24) != func_387(*uParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xB4B3AEABE432069B(*uParam0, 24, func_387(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_386(uParam0);
	if (func_385(*uParam0))
	{
...
void func_390(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0x765F6FEEFF39224F(Global_91043[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x541D5C57194E73C4(Global_91043[iVar0]) == func_391(iParam0, iParam1))
				{
...
void func_392(struct<3> Param0, float fParam3, int iParam4)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_397(&(Global_70409.f_555[0 /*21*/]), iVar0))
		{
...
void func_393(int iParam0)
{
	...
	if (func_397(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_180(iParam0, 0)) && Global_71318.f_66 == 0) && Global_106565.f_32743.f_1958[Global_70409.f_555[0 /*21*/].f_14] != 0) && Global_106565.f_32743.f_1958[Global_70409.f_555[0 /*21*/].f_14] > 3) && (!func_395(0, Global_70409.f_555[0 /*21*/].f_12) || !func_395(1, Global_70409.f_555[0 /*21*/].f_12)))
			{
				func_394(&(Global_106565.f_32743.f_69[Global_70409.f_555[0 /*21*/].f_14 /*78*/]), &Global_71318);
...
int func_395(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_396(&(Global_106565.f_32743.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_368(Global_106565.f_32743.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_397(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0x0E4018692D92041D(uParam0->f_9, 10))
	{
		...
		if (!func_398(Global_106565.f_32743.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_398(Global_106565.f_2357.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_398(Global_106565.f_2357.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_399(struct<3> Param0, float fParam3)
{
	return func_400(&(Global_100114.f_2890), Param0, fParam3, 0);
}

int func_400(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_417(uParam0))
	{
		...
		if (func_416(uParam0))
		{
			...
			if (unk_0x765F6FEEFF39224F(iVar0))
			{
				...
				else if ((!func_402(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && unk_0xCE3CFF625BEBAA04(unk_0xD178EF744F20B712(), "startup_positioning"))
				{
...
int func_402(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	{
		case joaat("cargobob"):
			if (func_404(iParam0, Global_70409.f_139[38], 0))
			{
				func_393(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_404(iParam0, Global_70409.f_139[43], 1))
			{
				func_393(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_404(iParam0, uVar1[iVar6], 1) && func_403(unk_0xFBB1F99A825CAB09(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_398(Param1, 0f, 0f, 0f, 0)) || unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(iParam0, 1), unk_0xFBB1F99A825CAB09(uVar1[iVar6], 1), 1) < 10f)
					{
						unk_0x7AC8DF0B83EB4C6B(&iParam0);
						return 1;
					}
...
void func_405(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (unk_0x91D5C8283D19AF49(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (unk_0x0E4018692D92041D(uParam1->f_77, func_364(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (unk_0x0E4018692D92041D(uParam1->f_77, func_364(iVar1 + 1)))
			{
			}
			else
			{
				unk_0x8950ED5730F62EE8(&(uParam1->f_77), func_364(iVar1 + 1));
			}
		}
		...
		if (((unk_0x0E4018692D92041D(uParam1->f_77, 15) || func_408(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_407())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!unk_0x097E7778E3E162E8(uParam1->f_66) && !unk_0x444D956C7F94526E(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (unk_0x0E4018692D92041D(uParam1->f_77, func_364(iVar2 + 1)))
				{
...
int func_409(int iParam0)
{
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		if (!func_415(unk_0x95B959F18401C09A(), -1))
		{
	...
	if (func_411(unk_0x95B959F18401C09A()) == 3)
	{
		if (unk_0x765F6FEEFF39224F(iParam0) && unk_0x91D5C8283D19AF49(iParam0, 0))
		{
...
int func_415(var uParam0, int iParam1)
{
	...
	if (func_336(uParam0, 1, 1))
	{
		...
		{
			uVar0 = unk_0xF2C96862595654B4(unk_0x378BD4B3881338C2(uParam0), 0);
...
int func_417(var uParam0)
{
	...
	if (!func_368(uParam0->f_12.f_66, 0))
	{
		return 0;
	}
...
bool func_418()
{
	return func_416(&(Global_100114.f_2890));
}

void func_419()
{
	func_420(&(Global_100114.f_2890));
}
...
int func_421(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_423(Global_100114.f_2890.f_12.f_66))
	{
		return 0;
	}
...
void func_427()
{
	...
	unk_0x2EE8D1440C9060EF("JOSH4", 0);
	...
	if (func_324())
	{
		if (func_322(0, 1))
		{
			func_476("*** Opened Josh gate for replay");
		}
	}
	func_476("*** Set up coords");
}
...
int func_430(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			while (iVar5 <= (iVar0 - 1))
			{
				unk_0xB815670C37E03CDE(iVar0[iVar5]);
				iVar5++;
			}
			func_440(&(uParam0->f_48), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_79 = 1;
			break;
		
		case 1:
			if (!func_439(&iVar0) || !func_437(&(uParam0->f_48)))
			{
				return 0;
			}
			if (!func_322(0, 1))
		...
		case 2:
			...
			{
				if (func_434(&(uParam0->f_28[0]), 58, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
				{
			...
			{
				func_433(&(uParam0->f_28[1]), iVar0[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
				if (func_428(uParam0->f_28[1]))
				{
					unk_0xFDA78B1CA2B4FB0A(uParam0->f_28[1]);
					unk_0x4A852F02088ECC9D(uParam0->f_28[1], 1);
					unk_0x697EBA5CF1A6AB57(uParam0->f_28[1], joaat("weapon_pistol"), -1, 0, 1);
					if (unk_0xE9CCF312047EBEE0("rcmjosh4"))
					{
						unk_0xED68CDDDE25A144E(uParam0->f_28[1]);
						unk_0x108754262311D34F(uParam0->f_28[1], "rcmjosh4", "BECKON_A_COP_B", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
				else
				{
			...
			if (!unk_0x765F6FEEFF39224F(uParam0->f_28[2]))
			{
				func_433(&(uParam0->f_28[2]), iVar0[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
				if (func_428(uParam0->f_28[2]))
				{
					unk_0x93AA93DA1B137032(uParam0->f_28[2], 0, 1, 1, 0);
					unk_0x93AA93DA1B137032(uParam0->f_28[2], 3, 0, 1, 0);
					unk_0x93AA93DA1B137032(uParam0->f_28[2], 10, 0, 1, 0);
					unk_0x4A852F02088ECC9D(uParam0->f_28[2], 1);
					unk_0x697EBA5CF1A6AB57(uParam0->f_28[2], joaat("weapon_pistol"), -1, 0, 1);
					if (unk_0xE9CCF312047EBEE0("rcmjosh4"))
					{
						unk_0xED68CDDDE25A144E(uParam0->f_28[2]);
						unk_0x108754262311D34F(uParam0->f_28[2], "rcmjosh4", "BECKON_A_COP_A", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
				else
				{
			...
			{
				func_432(&(uParam0->f_35[0]), iVar0[3], -1107.5f, 280.33f, 64.01f, 97.97f);
			}
			if (!unk_0x765F6FEEFF39224F(uParam0->f_35[1]))
			{
				func_431(&(uParam0->f_35[1]), 0);
				if (func_203(uParam0->f_35[1]))
				{
					unk_0xFA05791B9B8FA536(uParam0->f_35[1], 900f);
					fVar6 = unk_0x787CBB9DB6BA1A49(uParam0->f_35[1]);
					fVar6 = (fVar6 / 2f);
					unk_0xB81134EAAC434D76(uParam0->f_35[1], fVar6);
					unk_0x1B2303F9DC2D90D5(uParam0->f_35[1], 1084227584);
				}
				else
				{
					bVar7 = false;
		...
		case 3:
			if (unk_0x8FCF53827AC6136E(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"), 0))
			{
				unk_0x41D9972DE84520AB(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, 1, 0f, 0);
			}
			if (unk_0x8FCF53827AC6136E(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), 0))
			{
				unk_0x41D9972DE84520AB(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, 1, 0f, 0);
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
			{
				unk_0x71CA80D41E1338B4(iVar0[iVar5]);
				iVar5++;
			}
			return 1;
			break;
...
void func_431(var uParam0, bool bParam1)
{
	...
	func_432(uParam0, iLocal_81, Var0, fVar3);
	unk_0xD6D2420F0051065A(*uParam0, 4);
	unk_0xD303E20CB0AE4AD0(*uParam0, 3);
	unk_0x1C2B995BA5ADE8FF(*uParam0, 0, 0);
	unk_0x23F395CF89089EB2(*uParam0, 1);
}

void func_432(var uParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_226(uParam0);
	*uParam0 = unk_0xC651C43AB13A15E5(iParam1, Param2, fParam5, 1, 1, 0);
	if (unk_0x765F6FEEFF39224F(*uParam0))
	{
...
void func_433(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_227(uParam0);
	*uParam0 = unk_0x9BA5CF280376EEA4(iParam6, uParam1, Param2, fParam5, 0, 0);
}

int func_434(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_435(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0x765F6FEEFF39224F(*uParam0))
		{
			if (!unk_0xD62C4419A41F106A(*uParam0, 0))
...
int func_435(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_443()
{
	...
	if (func_453())
	{
		func_476("...Random Character Script was triggered so additional cleanup required");
	}
	iVar0 = 1;
	while (iVar0 <= (Local_443.f_28 - 1))
	{
	...
	unk_0xBBC0B8E2F3D2EEEC(-1140.223f, 271.745f, 50f, -1082.403f, 344.8568f, 80f, 0);
	func_444(&Local_443, 1, 0, 0);
	unk_0x71CA80D41E1338B4(iLocal_85);
	unk_0x71CA80D41E1338B4(iLocal_84);
...
void func_454(bool bParam0)
{
	...
	if (!func_471())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_455(unk_0xD178EF744F20B712(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
...
int func_456(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_462())
	{
		...
		{
			iVar33 = func_457(unk_0xD178EF744F20B712());
			if (iVar33 > -1)
			{
