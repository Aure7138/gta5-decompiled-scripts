...
void __EntryFunction__()
{
	...
	func_436("*** Now in Josh 4 loop ***");
	Local_443 = { ScriptParam_0 };
	func_434(&Local_443);
	unk_0x5B0FC38A6C315E32(1);
	if (unk_0x24862A9CDC8F8874(19))
	{
		func_433("Force cleanup [TERMINATING]");
		unk_0x233432976E597324("JOSH4_MISSION_FAIL");
		func_414(1);
		func_403();
	}
	if (func_402())
	{
		func_436("*** Setting up initial scene for replay");
		func_401(Local_106, fLocal_109, 1, 0);
		func_436("*** Replay setup started");
		Global_69562 = 1;
		iLocal_79 = 0;
		while (!func_390(&Local_443))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		func_436("*** Josh 4 scene set up");
		func_389(&Local_443, 0, 1);
		Global_69562 = 0;
	}
	if (func_388(Local_443.f_28[1]))
	{
		unk_0x63E00E88AE3C86A3(Local_443.f_28[1], 1);
	}
	if (func_388(Local_443.f_28[2]))
	{
		unk_0x63E00E88AE3C86A3(Local_443.f_28[2], 1);
	}
	iLocal_507 = Local_443.f_35[0];
	iLocal_508 = Local_443.f_35[1];
	func_436("*** About to set up positions...");
	func_387();
	func_385(58, 2, 0);
	if (func_402())
	{
		func_436("*** Creating replay vehicle and jumping to post-cutscene");
		func_321(&iLocal_86, -1100.04f, 280.6f, 63.53f, 267.48f, 0, 0, 1, 1, 0, joaat("asterope"), 0, 145, 1);
		unk_0x233432976E597324("JOSH4_RESTART1");
		func_314();
	}
	while (true)
	{
		unk_0xBB5777EE55D3B041("SF_BOC", 0);
		unk_0x4EDE34FBADD967A6(0);
...
void func_1()
{
	...
	switch (iLocal_88)
	{
		case 0:
			func_389(&Local_443, 0, 1);
			if (func_388(iLocal_507))
			{
				unk_0x916DBBB1A4A313B5(iLocal_507, 0, 0, 0, 0, 0, 0, 0, 0);
			}
			if (func_388(iLocal_508))
			{
				unk_0x916DBBB1A4A313B5(iLocal_508, 0, 0, 0, 0, 0, 0, 0, 0);
			}
			func_253("JOSH4_LOSECOPS", 7500, 1);
			unk_0xB47D5A4E4AE9BEAD(unk_0x1A96BAEAC664567A(), 2, 0);
			...
			unk_0x425A7D451DB73551(-1114.788f, 319.3401f, 66.1226f, 20.5f, 0);
			if (func_388(Local_443.f_28[0]))
			{
				unk_0xE48D9147BC1F4CD7(Local_443.f_28[0], unk_0xC8B93D94F8954288(), -1, 0, 2);
			}
			unk_0x63E7E25783E6FD80(2);
			iLocal_511 = unk_0x693EBB4F13506457();
			iLocal_88 = 1;
			break;
		...
		case 1:
			...
			func_207();
			func_205();
			if (unk_0x6338DEFCA89B8CD6(unk_0x1A96BAEAC664567A()) <= 0 && !func_204())
			{
				iVar0 = 1;
				while (iVar0 <= (Local_443.f_28 - 1))
				{
					if (func_388(Local_443.f_28[iVar0]))
					{
				...
				{
					if (unk_0x0C7EC810080F0459(unk_0xC8B93D94F8954288(), iLocal_507, 0))
					{
						func_201(777);
					}
				}
...
void func_2()
{
	if (func_388(unk_0xC8B93D94F8954288()))
	{
		if (unk_0x277ECDA23D8CCEB4(unk_0xC8B93D94F8954288(), 0))
		{
			unk_0x233432976E597324("JOSH4_COPS_LOST_RADIO");
			func_436("Starting 'JOSH4_COPS_LOST_RADIO'");
		}
		else
		{
			unk_0x233432976E597324("JOSH4_COPS_LOST");
			func_436("Starting 'JOSH4_COPS_LOST'");
		}
	}
	else
	{
		unk_0x233432976E597324("JOSH4_COPS_LOST");
		func_436("Player is somehow not alive when passing the mission - starting 'JOSH4_COPS_LOST'");
	}
	func_3(91, 1);
	func_403();
}
...
int func_69(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2466774[iParam0 /*5*/][func_68(iParam1)];
...
void func_205()
{
	if (iLocal_533 == 0)
	{
		if (func_206(unk_0xC8B93D94F8954288(), -1116.62f, 299.12f, 64.96f, 1) > 50f)
		{
			unk_0x6550E854B6D80CD9("SCRIPTED_SCANNER_REPORT_JOSH_4_01", 0f);
			func_436("*** Played special Josh 4 police report ***");
			iLocal_533 = 1;
		}
	}
}
...
void func_207()
{
	if (iLocal_528 == 0)
	{
		if (!unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), -1208.581f, 309.8494f, 80.69189f, -1041.645f, 319.5811f, 60.40263f, 178.5f, 0, 1, 0))
		{
			while (func_204())
			{
				func_222();
			...
			func_221(&uLocal_278, 2, unk_0xC8B93D94F8954288(), "TREVOR", 0, 1);
			func_221(&uLocal_278, 4, Local_443.f_28[0], "JOSH", 0, 1);
			iLocal_531 = unk_0x693EBB4F13506457();
			iLocal_528++;
		}
	}
	else if (iLocal_528 == 1)
	{
		if (iLocal_102 != 0)
		{
			if ((unk_0x693EBB4F13506457() - iLocal_531) > 6000)
			{
				if (iLocal_102 == 3)
				{
				...
				else if (iLocal_102 == 1)
				{
					if (func_388(Local_443.f_28[0]))
					{
						if (func_208(unk_0xC8B93D94F8954288(), Local_443.f_28[0], 1) < 75f)
						{
	...
	switch (iLocal_102)
	{
		case 0:
			if (iLocal_101 == 3)
			{
				if (func_388(Local_443.f_28[0]))
				{
					unk_0x5124C5FA52D2AF3E(Local_443.f_28[0]);
					if (func_202(iLocal_508))
					{
						if (unk_0xF473E4B36466850D(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, iLocal_508, 0))
						{
							func_436("Back gate blocked");
							Local_110 = { -1130.35f, 307.92f, 65.19f };
							unk_0x3E2E609450787FFE(&uLocal_506);
							unk_0x81333BEA4837207C(0, Local_110, 2f, 20000, 1f, 1, 1193033728);
							unk_0x81333BEA4837207C(0, -1126.56f, 319.85f, 65.98f, 2f, 20000, 1f, 1, 1193033728);
							unk_0x622E764F80DBF8B7(0, unk_0xC8B93D94F8954288(), 500f, -1, 0, 0);
							unk_0x939BC11172AA1303(uLocal_506);
							unk_0xF1A02DDEC7E15D6E(Local_443.f_28[0], 1);
							unk_0xBFE865E3B513451B(Local_443.f_28[0], uLocal_506);
						}
						else
						{
							func_436("Back gate clear");
							unk_0x3E2E609450787FFE(&uLocal_506);
							if (func_202(iLocal_508))
							{
								unk_0xC2E4F4B0B73CFE01(0, iLocal_508, unk_0xC8B93D94F8954288(), 8, 30f, 786469, 500f, 0.1f, 1);
							}
							else
							{
								unk_0x622E764F80DBF8B7(0, unk_0xC8B93D94F8954288(), 500f, -1, 0, 0);
					...
					{
						func_436("Josh car not ok - do Josh flee anyway");
						unk_0x3E2E609450787FFE(&uLocal_506);
						unk_0x81333BEA4837207C(0, Local_110, 2f, 20000, 1f, 1, 1193033728);
						if (func_202(iLocal_508))
						{
							unk_0x9CEFBE395E148A32(0, iLocal_508, 20000, -1, 1073741824, 1, 0);
							unk_0xC2E4F4B0B73CFE01(0, iLocal_508, unk_0xC8B93D94F8954288(), 8, 30f, 786469, 500f, 0.1f, 1);
						}
						else
						{
					...
					unk_0xF36EA652E4A6CED0(Local_443.f_28[0], 2, 1);
					unk_0xA9351C9309E03069(&uLocal_506);
				}
				iLocal_532 = unk_0x693EBB4F13506457();
				unk_0xF4D417768DCC5DED(Local_443.f_28[0], 1);
				unk_0xC778754E36F3FFD6(Local_443.f_28[0], 177, 1);
				iLocal_102 = 1;
			}
			break;
		...
		case 1:
			if (func_388(Local_443.f_28[0]))
			{
				if (!iLocal_525)
				{
					...
					{
						if (func_208(Local_443.f_28[0], unk_0xC8B93D94F8954288(), 0) < 20f)
						{
							func_221(&uLocal_278, 2, unk_0xC8B93D94F8954288(), "TREVOR", 0, 1);
							func_221(&uLocal_278, 4, Local_443.f_28[0], "JOSH", 0, 1);
							if (func_204())
							...
							func_436("Doing Josh comment");
						}
						else
						{
							func_436("Too far away to do Josh comment");
						}
						iLocal_525 = 1;
					}
				}
				if (func_202(iLocal_508))
				{
					if (unk_0x0C7EC810080F0459(Local_443.f_28[0], iLocal_508, 1))
					{
						if (unk_0x78FF715074ED0311(iLocal_508) < 20f)
						{
							unk_0x5124C5FA52D2AF3E(Local_443.f_28[0]);
							unk_0xE5F6BE3F8E937ACE(Local_443.f_28[0], 0, 4416);
							unk_0x622E764F80DBF8B7(Local_443.f_28[0], unk_0xC8B93D94F8954288(), 510f, -1, 0, 0);
							func_227(&iLocal_508);
						}
					}
					if (func_388(unk_0xC8B93D94F8954288()))
					{
						if (unk_0x0C7EC810080F0459(unk_0xC8B93D94F8954288(), iLocal_508, 1))
						{
							unk_0x5124C5FA52D2AF3E(Local_443.f_28[0]);
							unk_0x622E764F80DBF8B7(Local_443.f_28[0], unk_0xC8B93D94F8954288(), 510f, -1, 0, 0);
							func_227(&iLocal_508);
					...
					if (unk_0xB03AB89ABCAB2B4E(Local_443.f_28[0]))
					{
						if (iLocal_526 == 0)
						{
				...
				if (func_208(unk_0xC8B93D94F8954288(), Local_443.f_28[0], 1) > 350f)
				{
					func_436("Deleting Josh, setting as lost");
					func_226(&(Local_443.f_28[0]));
					func_225(&iLocal_508);
					iLocal_102 = 2;
				}
				if (func_388(unk_0xC8B93D94F8954288()) && func_388(Local_443.f_28[0]))
				{
					if (iLocal_529 < 3)
					{
						if (func_208(unk_0xC8B93D94F8954288(), Local_443.f_28[0], 1) < 10f)
						{
							if (!func_204() && (unk_0x693EBB4F13506457() - iLocal_532) > 8000)
							{
			...
			{
				if (unk_0x87D4C731B013290A(Local_443.f_28[0], unk_0xC8B93D94F8954288(), 1))
				{
					unk_0xD810132681A9B83C(2f, 2f, 0);
					func_436("Player killed Josh!");
					func_201(776);
				}
				func_436("Josh - DEAD!");
				if (func_204())
...
void func_230()
{
	switch (Local_89.f_11)
	{
		case 0:
			...
			while (iLocal_510 <= 4)
			{
				if (unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), Local_534[iLocal_510 /*7*/], Local_534[iLocal_510 /*7*/].f_3, Local_534[iLocal_510 /*7*/].f_6, 0, 1, 2))
				{
					func_231("Player detected inside flee direction trigger: ", iLocal_510);
					unk_0x7567CEA8E6B5340B(iLocal_85);
					unk_0x7567CEA8E6B5340B(iLocal_84);
					...
					func_436("Requesting flee recording: ");
					func_231(Local_89.f_10, Local_89.f_9);
					unk_0xC80AE0BAE243FFB1(Local_89.f_9, Local_89.f_10);
					while ((!unk_0x953ED5E61AD54581(Local_89.f_9, Local_89.f_10) || !unk_0x0845149A26DABBA5(iLocal_85)) || !unk_0x0845149A26DABBA5(iLocal_84))
					{
						unk_0x4EDE34FBADD967A6(0);
					}
					func_436("Flee car has loaded!");
					Local_89.f_11 = 1;
				}
				iLocal_510++;
			}
		...
		case 1:
			if (!unk_0x95CCECA3948CFE7B(Local_89.f_7))
			{
				Local_89.f_7 = unk_0xD53B4DCC7B2C8551(iLocal_85, Local_89, 0f, 1, 1);
				unk_0xF18809B65D87E197(Local_89.f_7);
				unk_0xD1F23A1EEEED99E5(Local_89.f_7, Local_89.f_3, Local_89.f_4, Local_89.f_5, Local_89.f_6);
				Local_89.f_8 = unk_0xDEFAEEE1A4058454(Local_89.f_7, 6, iLocal_84, -1, 1, 1);
				unk_0x640290651A86938B(Local_89.f_8, joaat("weapon_pistol"), -1, 0, 1);
				unk_0xAAD662D7E0D59F4C(Local_89.f_8, 1);
				unk_0x5124C5FA52D2AF3E(Local_89.f_8);
				func_436("Flee car created!");
				Local_89.f_11 = 2;
			}
			break;
		...
		case 2:
			...
			{
				if (func_388(Local_89.f_8))
				{
					if (unk_0x277ECDA23D8CCEB4(Local_89.f_8, 0))
					{
						unk_0x40564938AEE5A138(Local_89.f_7, Local_89.f_9, Local_89.f_10, 1);
						unk_0x17FAE80A2D8843F7(Local_89.f_7, 1);
						func_231("*** m_AI_FleeCar.iRecNum: ", Local_89.f_9);
						switch (Local_89.f_9)
						{
							case 0:
								unk_0x3CC319FBB198DFA5(Local_89.f_7, 1.5f);
								break;
							
							case 1:
								unk_0x3CC319FBB198DFA5(Local_89.f_7, 1f);
								break;
							
							case 2:
								unk_0x3CC319FBB198DFA5(Local_89.f_7, 1.4f);
								break;
		...
		case 3:
			if (func_202(Local_89.f_7))
			{
				if (!unk_0xD80D5A6EF9C19146(Local_89.f_7))
				{
					if (unk_0x953ED5E61AD54581(Local_89.f_9, Local_89.f_10))
					{
						unk_0x28ED861DB3DADA0B(Local_89.f_9, Local_89.f_10);
						func_436("Flee car recording finished!");
						Local_89.f_11 = 4;
					}
				}
				else
		...
		case 4:
			if (func_202(Local_89.f_7))
			{
				if (func_388(Local_89.f_8))
				{
					unk_0xAAD662D7E0D59F4C(Local_89.f_8, 0);
					func_203(&(Local_89.f_8), 1, 0, 1);
				}
				Local_89.f_11 = 5;
				func_227(&(Local_89.f_7));
			}
			func_436("Flee car & ped released!");
			break;
	}
}
...
void func_232()
{
	...
	switch (iLocal_101)
	{
		case 0:
			...
			if ((unk_0x693EBB4F13506457() - iLocal_511) > 4000)
			{
				func_436("************************************** TIMEOUT - AIM next frame");
				iLocal_101 = 1;
				iLocal_511 = unk_0x693EBB4F13506457();
			}
			iVar0 = 1;
			while (iVar0 <= (Local_443.f_28 - 1))
			{
				if (func_388(Local_443.f_28[iVar0]))
				{
					if (func_208(Local_443.f_28[iVar0], unk_0xC8B93D94F8954288(), 0) > 10f)
					{
						func_436("************************************** TOO FAR - AIM next frame");
						iLocal_101 = 1;
						iLocal_511 = unk_0x693EBB4F13506457();
					}
				}
		...
		case 2:
			if ((unk_0x693EBB4F13506457() - iLocal_511) > 20000)
			{
				func_436("************************************** TIMEOUT - ARREST next frame");
				if (func_388(Local_443.f_28[1]))
				{
					unk_0x5124C5FA52D2AF3E(Local_443.f_28[1]);
					unk_0xAAD662D7E0D59F4C(Local_443.f_28[1], 0);
					unk_0xD538F54FFE87B03A(Local_443.f_28[1], unk_0xC8B93D94F8954288());
				}
				iLocal_101 = 4;
				iLocal_511 = unk_0x693EBB4F13506457();
			}
			...
			while (iVar0 <= (Local_443.f_28 - 1))
			{
				if (func_388(Local_443.f_28[iVar0]))
				{
					if (func_208(Local_443.f_28[iVar0], unk_0xC8B93D94F8954288(), 0) > 12f)
					{
						func_436("************************************** TOO FAR - ATTACK next frame");
						iLocal_101 = 3;
						iLocal_511 = unk_0x693EBB4F13506457();
					}
				}
		...
		case 4:
			...
			while (iVar0 <= (Local_443.f_28 - 1))
			{
				if (func_388(Local_443.f_28[iVar0]))
				{
					...
					{
						func_436("************************************** THREAT DURING ARREST - ATTACK next frame");
						iLocal_101 = 3;
						iLocal_511 = unk_0x693EBB4F13506457();
					}
				}
		...
		case 3:
			...
			if (!iLocal_518)
			{
				...
				unk_0x21F5FB3C8D48F7F5(6, 1);
				iVar0 = 1;
				while (iVar0 <= (Local_443.f_28 - 1))
				{
					if (func_388(Local_443.f_28[iVar0]))
					{
						unk_0x5124C5FA52D2AF3E(Local_443.f_28[iVar0]);
						unk_0xAAD662D7E0D59F4C(Local_443.f_28[iVar0], 0);
						unk_0x3E2E609450787FFE(&uLocal_506);
						unk_0xA719CF90648199CC(0, unk_0xC8B93D94F8954288(), -1, joaat("FIRING_PATTERN_BURST_FIRE"));
						unk_0x939BC11172AA1303(uLocal_506);
						unk_0xBFE865E3B513451B(Local_443.f_28[iVar0], uLocal_506);
						unk_0xA9351C9309E03069(&uLocal_506);
					}
					iVar0++;
				}
				func_221(&uLocal_113, 2, unk_0xC8B93D94F8954288(), "TREVOR", 0, 1);
				...
				func_436("Doing cop fire warning");
				iLocal_518 = 1;
				iLocal_530 = unk_0x693EBB4F13506457();
			}
			else
			{
				iVar1 = 1;
				...
				{
					if (func_388(Local_443.f_28[iVar1]))
					{
						if (func_208(Local_443.f_28[iVar1], unk_0xC8B93D94F8954288(), 1) > 20f)
						{
							unk_0x687051455B40FE5B(Local_443.f_28[iVar1], 75);
						}
						else
						{
							unk_0x687051455B40FE5B(Local_443.f_28[iVar1], 1);
						}
					}
					iVar1++;
				}
				if ((unk_0x693EBB4F13506457() - iLocal_530) > 15000)
				{
					iVar1 = 1;
					while (iVar1 <= (Local_443.f_28 - 1))
					{
						if (func_388(Local_443.f_28[iVar1]))
						{
							if (func_208(Local_443.f_28[iVar1], unk_0xC8B93D94F8954288(), 1) >= 50f)
							{
	...
	if (iLocal_101 != 3)
	{
		...
		while (iVar0 <= (Local_443.f_28 - 1))
		{
			if (func_388(Local_443.f_28[iVar0]))
			{
				if (unk_0x0BBFEAC55291063A(unk_0xA34E7C2A5118D638(), Local_443.f_28[iVar0]))
				{
					iVar2 = joaat("weapon_unarmed");
					if (!unk_0xA51F11E1DC7307BB(unk_0xC8B93D94F8954288(), &iVar2, 1))
					{
						func_436("************************************** AIMED WEAPON - ATTACK now");
						iLocal_101 = 3;
					}
				}
				if (func_233(Local_443.f_28[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					func_436("************************************** ATTACKED/THREATENED - ATTACK now");
					iLocal_101 = 3;
				}
				if (iLocal_101 != 4)
				{
					if (func_208(Local_443.f_28[iVar0], unk_0xC8B93D94F8954288(), 0) < 2.3f)
					{
						func_436("************************************** TOO CLOSE - ATTACK now");
						iLocal_101 = 3;
					}
				}
			}
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_388(unk_0xC8B93D94F8954288()) && func_388(iParam0))
	{
		...
		if (!unk_0x74BBB84E37C71AAC(unk_0xC8B93D94F8954288(), 6))
		{
			if (unk_0x7E515EEFC038658D(unk_0xC8B93D94F8954288()))
			{
				...
				{
					return func_246(unk_0xC8B93D94F8954288(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_234(int iParam0, float fParam1)
{
	...
	if (func_388(unk_0xC8B93D94F8954288()) && func_388(iParam0))
	{
		if (func_245(iParam0) || unk_0x0BBFEAC55291063A(unk_0xA34E7C2A5118D638(), iParam0))
		{
			if (unk_0x74BBB84E37C71AAC(unk_0xC8B93D94F8954288(), 6))
			{
				fVar0 = 40f;
...
{
	return func_236(iParam0, unk_0xC8B93D94F8954288(), fParam1, 1, 250, 7);
}
...
bool func_236(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (!func_388(iParam0) || !func_388(iParam1))
	{
		if (iVar4 != -1)
		{
...
int func_240(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_242(unk_0x44C17CCB85A88A1F(iParam1, 1) - unk_0x44C17CCB85A88A1F(iParam0, 1)) };
	...
	{
		Var3 = { func_242(unk_0xB867FC7DBA46C0F1(iParam0, 31086, 0f, 5f, 0f) - unk_0xB867FC7DBA46C0F1(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_250(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_242(Param1 - unk_0x44C17CCB85A88A1F(iParam0, 1)) };
...
void func_252()
{
	...
	else
	{
		...
		{
			case 0:
				if ((unk_0x693EBB4F13506457() - iLocal_105) > 1000)
				{
					iLocal_103 = 1;
				}
				break;
			...
			case 1:
				if (!func_204() && !unk_0xA3858ADDDBC3CB71())
				{
					if (iLocal_104)
					{
						func_221(&uLocal_113, 2, unk_0xC8B93D94F8954288(), "TREVOR", 0, 1);
...
void func_254()
{
	if (iLocal_87 == 1)
	{
		...
		{
			if (unk_0xFE2EB5413118713A() > 14000 && !iLocal_522)
			{
				unk_0x233432976E597324("JOSH4_START");
				func_436("Starting 'JOSH4_START'");
				iLocal_522 = 1;
			}
		}
	}
	...
	{
		unk_0x233432976E597324("JOSH4_ACTION");
		func_436("Starting 'JOSH4_ACTION'");
		iLocal_523 = 1;
	}
	else if (!iLocal_524)
	{
		if (func_388(unk_0xC8B93D94F8954288()))
		{
			if (unk_0x277ECDA23D8CCEB4(unk_0xC8B93D94F8954288(), 0))
			{
				unk_0x233432976E597324("JOSH4_VEHICLE");
				func_436("Starting 'JOSH4_VEHICLE'");
				iLocal_524 = 1;
			}
		}
	}
...
void func_255()
{
	...
	if (unk_0x35081E98CA82CBB4())
	{
		if (func_388(Local_443.f_28[1]))
		{
			func_436("Trying to set Cop 1 component variation (intro loop)");
			unk_0xF7B15A5F0A17B0E6("Cop_standing_idle", Local_443.f_28[1], 0);
		}
		if (func_388(Local_443.f_28[2]))
		{
			func_436("Trying to set Cop 2 component variation (intro loop)");
			unk_0xF7B15A5F0A17B0E6("Cop_with_notepad", Local_443.f_28[2], 0);
		}
	}
	switch (iLocal_88)
	{
		case 0:
			if (!unk_0xF8D041B05C3D1FD4(sLocal_83, ""))
			{
				if (iLocal_519 == 0)
				{
			...
			switch (iLocal_527)
			{
				case 0:
					if (func_282(1, 1093140480, 0))
					{
						...
						if (func_202(iVar0))
						{
							if (unk_0xAF40E7422A6D9D80(unk_0x6D5BB810CC209E15(iVar0)))
							{
								Var1 = { -1089.27f, 283.76f, 64.22f };
								fVar4 = 132.53f;
							}
							else if (unk_0x8DF850DA069BF37C(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, 1, 0))
							{
						...
						if (func_202(iLocal_507))
						{
							unk_0xC76B5C68AB6DC7DF(iLocal_507, -1107.5f, 280.33f, 64.01f, 1, 0, 0, 1);
							unk_0x765E3FA65D011F03(iLocal_507, 97.97f);
							unk_0xF18809B65D87E197(iLocal_507);
						}
						iLocal_527++;
					}
					break;
				...
				case 1:
					unk_0xC0E8B67A4385D37D("rcmjosh4");
					unk_0xC0E8B67A4385D37D("combat@gestures@pistol@halt");
					unk_0xC0E8B67A4385D37D("combat@gestures@pistol@glances");
					unk_0x7567CEA8E6B5340B(iLocal_509);
					iLocal_527++;
					break;
				
				case 2:
					if (((unk_0xF9B86DC1728F1339("rcmjosh4") && unk_0xF9B86DC1728F1339("combat@gestures@pistol@halt")) && unk_0xF9B86DC1728F1339("combat@gestures@pistol@glances")) && unk_0x0845149A26DABBA5(iLocal_509))
					{
						iLocal_527++;
					}
					break;
				...
				case 3:
					...
					if (func_266())
					{
						...
						unk_0xD810132681A9B83C(0f, 5f, 0);
						iLocal_527 = 4;
					}
					func_265();
					if (unk_0x2C87734B4748BBD5())
					{
						...
						{
							unk_0x233432976E597324("JOSH4_START");
							func_436("Starting 'JOSH4_START' via cutscene skip");
							iLocal_522 = 1;
						}
					}
					break;
...
void func_256(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_257(unk_0xC8B93D94F8954288()))
	{
...
void func_258(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (!unk_0x2DC9BA2299B45EA6(unk_0xC8B93D94F8954288()) && !func_259(unk_0xA34E7C2A5118D638()))
		{
...
void func_265()
{
	if (unk_0x669E4BAB086C2648("Josh", 0))
	{
		if (func_388(Local_443.f_28[0]))
		{
			func_436("Playing Josh's leadout");
			unk_0x3E2E609450787FFE(&uLocal_506);
			unk_0xE48D9147BC1F4CD7(0, unk_0xC8B93D94F8954288(), -1, 2, 2);
			unk_0x5323F488E6A1B660(0, "rcmjosh4", "josh_leadout_loop", 4f, -4f, -1, 262153, 0, 0, 0, 0);
			unk_0x939BC11172AA1303(uLocal_506);
			unk_0xBFE865E3B513451B(Local_443.f_28[0], uLocal_506);
			unk_0xA9351C9309E03069(&uLocal_506);
			unk_0x447955D97DC49D70(Local_443.f_28[0], joaat("MotionState_DoNothing"), 0, 1, 0);
		}
	}
	if (unk_0x669E4BAB086C2648("Security_guard_pistol", 0))
	{
		if (func_388(iLocal_504) && func_388(Local_443.f_28[1]))
		{
			unk_0x5DCB9AB3EDCDA9A2(iLocal_504, Local_443.f_28[1]);
			func_436("*** Gave idle cop gun");
		}
	}
	if (unk_0x669E4BAB086C2648("FBI_Agent_1_Gun", 0))
	{
		if (func_388(iLocal_505) && func_388(Local_443.f_28[2]))
		{
			unk_0x5DCB9AB3EDCDA9A2(iLocal_505, Local_443.f_28[2]);
			func_436("*** Gave notepad cop gun");
		}
	}
	if (unk_0x669E4BAB086C2648("Cop_standing_idle", 0))
	{
		if (func_388(Local_443.f_28[1]))
		{
			unk_0x447955D97DC49D70(Local_443.f_28[1], joaat("MotionState_Aiming"), 0, 1, 0);
			unk_0x3E2E609450787FFE(&uLocal_506);
			unk_0xE48D9147BC1F4CD7(0, unk_0xC8B93D94F8954288(), -1, 1026, 2);
			unk_0x726676CF6AC20DCB(0, unk_0xC8B93D94F8954288(), -1, 1);
			unk_0x5323F488E6A1B660(0, "combat@gestures@pistol@glances", "90", 8f, -1000f, -1, 262184, 0, 0, 0, 0);
			unk_0x939BC11172AA1303(uLocal_506);
			unk_0xBFE865E3B513451B(Local_443.f_28[1], uLocal_506);
			unk_0xA9351C9309E03069(&uLocal_506);
			func_436("*** Idle cop anim");
		}
	}
	if (unk_0x669E4BAB086C2648("Cop_with_notepad", 0))
	{
		if (func_388(Local_443.f_28[2]))
		{
			unk_0x447955D97DC49D70(Local_443.f_28[2], joaat("MotionState_Aiming"), 0, 1, 0);
			unk_0x3E2E609450787FFE(&uLocal_506);
			unk_0xE48D9147BC1F4CD7(0, unk_0xC8B93D94F8954288(), -1, 1026, 2);
			unk_0xD9650EE91822AA1A(0, -1103.72f, 289.46f, 63.23f, unk_0xC8B93D94F8954288(), 1f, 0, 0.1f, 1082130432, 1, 0, 1, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
			unk_0xD9650EE91822AA1A(0, -1106.08f, 288.55f, 63.31f, unk_0xC8B93D94F8954288(), 1f, 0, 0.1f, 1082130432, 1, 0, 1, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
			unk_0x726676CF6AC20DCB(0, unk_0xC8B93D94F8954288(), -1, 1);
			unk_0x939BC11172AA1303(uLocal_506);
			unk_0xBFE865E3B513451B(Local_443.f_28[2], uLocal_506);
			unk_0xA9351C9309E03069(&uLocal_506);
			func_436("*** Notepad cop anim");
		}
	}
}
...
void func_281()
{
	if (func_388(unk_0xC8B93D94F8954288()))
	{
		unk_0x5D713171D2C2E177(unk_0xC8B93D94F8954288(), "Trevor", 0, 0, 0);
		func_436("*** Registered Trevor");
	}
	if (func_388(Local_443.f_28[0]))
	{
		unk_0x5D713171D2C2E177(Local_443.f_28[0], "Josh", 0, 0, 0);
		func_436("*** Registered Josh");
	}
	if (func_388(Local_443.f_28[1]))
	{
		iLocal_504 = unk_0x528C51384A93BF09(joaat("weapon_pistol"), -1, unk_0x44C17CCB85A88A1F(Local_443.f_28[1], 1), 1, 1065353216, 0);
		unk_0x5D713171D2C2E177(Local_443.f_28[1], "Cop_standing_idle", 0, 0, 0);
		func_436("*** Registered Cop standing");
	}
	if (func_388(Local_443.f_28[2]))
	{
		iLocal_505 = unk_0x528C51384A93BF09(joaat("weapon_pistol"), -1, unk_0x44C17CCB85A88A1F(Local_443.f_28[2], 1), 1, 1065353216, 0);
		unk_0x5D713171D2C2E177(Local_443.f_28[2], "Cop_with_notepad", 0, 0, 0);
		func_436("*** Registered Cop with notepad");
	}
	if (func_388(iLocal_504))
	{
		unk_0x5D713171D2C2E177(iLocal_504, "Security_guard_pistol", 0, 0, 0);
		func_436("*** Registered idle cop gun");
	}
	if (func_388(iLocal_505))
	{
		unk_0x5D713171D2C2E177(iLocal_505, "FBI_Agent_1_Gun", 0, 0, 0);
		func_436("*** Registered notepad cop gun");
	}
	iLocal_522 = 0;
	iLocal_523 = 0;
	iLocal_524 = 0;
...
int func_282(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x277ECDA23D8CCEB4(unk_0xC8B93D94F8954288(), 0))
	{
		...
		{
			if (!func_286(unk_0x275BEBE583A163B5(unk_0xC8B93D94F8954288(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_285(unk_0xC8B93D94F8954288(), -828834893))
				{
...
int func_286(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	{
		unk_0x5C384485B80ABDBC(uParam0, fParam1, iParam2, iParam4);
	}
...
void func_288(int iParam0)
{
	...
	unk_0xC0E8B67A4385D37D("combat@gestures@pistol@glances");
	unk_0x7567CEA8E6B5340B(iLocal_509);
	while ((!unk_0xF9B86DC1728F1339("combat@gestures@pistol@halt") || !unk_0xF9B86DC1728F1339("combat@gestures@pistol@glances")) || !unk_0x0845149A26DABBA5(iLocal_509))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (unk_0x32AADF258A6B79F2(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"), 0))
	{
		unk_0xBEBEBC7C7A0BDA34(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, 0, 0f, 0);
	}
	if (unk_0x32AADF258A6B79F2(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), 0))
	{
		unk_0xBEBEBC7C7A0BDA34(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, 0, 0f, 0);
	}
	if (func_388(Local_443.f_28[0]))
	{
		if (iParam0 == 1)
		{
			unk_0xC76B5C68AB6DC7DF(Local_443.f_28[0], -1103.962f, 291.3401f, 63.367f, 1, 0, 0, 1);
			unk_0x765E3FA65D011F03(Local_443.f_28[0], 193.1737f);
			unk_0x5323F488E6A1B660(Local_443.f_28[0], "rcmjosh4", "josh_leadout_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
		}
		unk_0xCDBFAADCD2D0674F(Local_443.f_28[0], 1);
		unk_0x58F516BB5E324590(Local_443.f_28[0], 1);
	}
	if (iParam0 == 1)
	{
		if (func_388(Local_443.f_28[2]))
		{
			unk_0x640290651A86938B(Local_443.f_28[2], joaat("weapon_pistol"), -1, 1, 1);
			unk_0xC76B5C68AB6DC7DF(Local_443.f_28[2], -1106.08f, 288.55f, 63.31f, 1, 0, 0, 1);
			unk_0x3E2E609450787FFE(&uLocal_506);
			unk_0x726676CF6AC20DCB(0, unk_0xC8B93D94F8954288(), -1, 1);
			unk_0x939BC11172AA1303(uLocal_506);
			unk_0xBFE865E3B513451B(Local_443.f_28[2], uLocal_506);
			unk_0xA9351C9309E03069(&uLocal_506);
			unk_0xAAD662D7E0D59F4C(Local_443.f_28[2], 1);
		}
	}
	if (iParam0 == 1)
	{
		if (func_388(Local_443.f_28[1]))
		{
			unk_0x640290651A86938B(Local_443.f_28[1], joaat("weapon_pistol"), -1, 1, 1);
			unk_0xC76B5C68AB6DC7DF(Local_443.f_28[1], -1102.41f, 289.73f, 63.18f, 1, 0, 0, 1);
			unk_0x3E2E609450787FFE(&uLocal_506);
			unk_0x726676CF6AC20DCB(0, unk_0xC8B93D94F8954288(), -1, 1);
			unk_0x939BC11172AA1303(uLocal_506);
			unk_0xBFE865E3B513451B(Local_443.f_28[1], uLocal_506);
			unk_0xA9351C9309E03069(&uLocal_506);
			unk_0xAAD662D7E0D59F4C(Local_443.f_28[1], 1);
		}
	}
	if (func_388(Local_443.f_28[1]))
	{
		unk_0x1296D571B761D748(Local_443.f_28[1], 23, 1);
	}
	if (func_388(Local_443.f_28[2]))
	{
		unk_0x1296D571B761D748(Local_443.f_28[2], 23, 1);
	}
	if (func_202(Local_443.f_35[1]))
	{
		unk_0x0782F0CAEA719452(Local_443.f_35[1], 1);
	}
	func_221(&uLocal_278, 2, unk_0xC8B93D94F8954288(), "TREVOR", 0, 1);
	iLocal_512 = 0;
	iLocal_513 = 0;
...
void func_290()
{
	...
	if (unk_0x35081E98CA82CBB4())
	{
		if (func_388(Local_443.f_28[1]))
		{
			func_436("Trying to set Cop 1 component variation (leadin loop)");
			unk_0xF7B15A5F0A17B0E6("Cop_standing_idle", Local_443.f_28[1], 0);
		}
		if (func_388(Local_443.f_28[2]))
		{
			func_436("Trying to set Cop 2 component variation (leadin loop)");
			unk_0xF7B15A5F0A17B0E6("Cop_with_notepad", Local_443.f_28[2], 0);
		}
	}
	switch (iLocal_88)
	{
		case 0:
			if (!func_5(0) && unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0))
			{
				func_436("Doing setup for leadin");
				func_221(&uLocal_278, 4, Local_443.f_28[0], "JOSH", 0, 1);
				func_221(&uLocal_278, 2, unk_0xC8B93D94F8954288(), "TREVOR", 0, 1);
				unk_0xC0E8B67A4385D37D("rcmjosh4");
				if (unk_0xF9B86DC1728F1339("rcmjosh4"))
				{
					iLocal_88 = 1;
				}
			}
			...
			{
				func_436("Skipping setup for leadin (repeat play/wrong area)");
				func_287(1);
			}
			break;
		...
		case 1:
			if (!func_5(0) && unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0))
			{
				if (func_388(unk_0xC8B93D94F8954288()) && func_257(Local_443.f_28[0]))
				{
					if (unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, 1, 0))
					{
						if (!func_291())
						{
							if (!func_285(unk_0xC8B93D94F8954288(), -875674219))
							{
								unk_0xC518AECFA9CF7722(unk_0xC8B93D94F8954288(), Local_443.f_28[0], 0);
							}
						}
						else
						{
							func_284();
							unk_0x2BE3C7FA4FCCA784(0, 30, 1);
							unk_0x2BE3C7FA4FCCA784(0, 31, 1);
				...
				if (!iLocal_519)
				{
					...
					{
						if (unk_0xCD61E9D5CABC7E35(Local_443.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_204())
						{
							unk_0x5323F488E6A1B660(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, -1, 2, 0, 0, 0, 0);
							func_436("Done Josh leadin anim");
							if (func_257(Local_443.f_28[2]))
							{
								unk_0x5323F488E6A1B660(Local_443.f_28[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, -1, 2, 0, 0, 0, 0);
								func_436("Done Notepad cop leadin anim");
							}
							if (func_257(Local_443.f_28[1]))
							{
								unk_0x5323F488E6A1B660(Local_443.f_28[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, -1, 2, 0, 0, 0, 0);
								func_436("Done Speaker cop leadin anim");
							}
							unk_0xCDBEE0F3B4A74754();
							unk_0x4767D2EEF03042F6("JOSH_4_INT_CONCAT", 2, 8);
							iLocal_519 = 1;
						}
					}
				}
				...
				{
					if ((func_388(unk_0xC8B93D94F8954288()) && func_257(Local_443.f_28[0])) && !func_291())
					{
						if (!func_285(unk_0xC8B93D94F8954288(), -875674219))
						{
							unk_0xC518AECFA9CF7722(unk_0xC8B93D94F8954288(), Local_443.f_28[0], 0);
					...
					if (func_257(Local_443.f_28[0]))
					{
						if (unk_0xCD61E9D5CABC7E35(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							if (unk_0x853B39ECA83DA242(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.276f)
							{
								if (iLocal_520 == 0)
								{
									if (func_209(&uLocal_278, "JOSH4AU", "JOSH_4_INTLI", 9, 0, 0, 0))
									{
										unk_0xD810132681A9B83C(2f, 3f, 1);
										iLocal_520 = 1;
									}
								}
							}
							if (unk_0x853B39ECA83DA242(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.98f)
							{
								func_287(1);
							}
							if (func_208(unk_0xC8B93D94F8954288(), Local_443.f_28[0], 1) <= 2f)
							{
								if (func_204())
								{
									func_222();
								}
								func_436("Player too close to Josh, starting cutscene early");
								func_287(1);
							}
						}
						else
...
void func_293()
{
	if (unk_0x06972B20E75CBE06(unk_0xA34E7C2A5118D638()))
	{
		if (unk_0x277ECDA23D8CCEB4(unk_0xC8B93D94F8954288(), 0))
		{
			if (func_286(unk_0x275BEBE583A163B5(unk_0xC8B93D94F8954288(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_311(0) || Global_69586) || Global_69575 == 1) || !unk_0xB66DD474AA9E764E())
	{
		return 0;
	}
	switch (Global_69571)
	{
		...
		case 5:
			if ((unk_0x308528B5CF35F306() || func_297(0)) || func_310(1))
			{
			}
			else
			{
...
void func_314()
{
	if (func_388(Local_443.f_28[1]))
	{
		unk_0x636EE5A38E3EB8FF(Local_443.f_28[1], -1102.48f, 290.2f, 64.22f, 0, 0, 1);
		unk_0x765E3FA65D011F03(Local_443.f_28[1], 177.74f);
	}
	else
	{
		Local_443.f_28[1] = unk_0x71DD988C1B903F5D(6, iLocal_84, -1102.92f, 290.12f, -200f, 40.46f, 0, 0);
	}
	if (func_388(Local_443.f_28[2]))
	{
		unk_0x636EE5A38E3EB8FF(Local_443.f_28[2], -1103.94f, 290.21f, 64.28f, 0, 0, 1);
		unk_0x765E3FA65D011F03(Local_443.f_28[2], -167.67f);
	}
	else
	{
		Local_443.f_28[2] = unk_0x71DD988C1B903F5D(6, iLocal_84, -1102.73f, 290.91f, -200f, 92.06f, 0, 0);
	}
	if (!func_320())
	{
		func_319(unk_0xC8B93D94F8954288(), Local_106, fLocal_109, 1, 1);
		unk_0x0F9FDCEB321235AB(0f, 1065353216);
		unk_0x8C67D2FDE360FBCA(0f);
	}
	func_288(1);
	unk_0x7567CEA8E6B5340B(iLocal_509);
	while (!unk_0x0845149A26DABBA5(iLocal_509))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	func_287(2);
...
int func_317(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		unk_0xC0E67E73A6E9A0EE(-1502457334, 0f, 0, 0);
		unk_0x130F0C5AE7B52B7A(-1502457334, 3, 0, 1);
		iVar0++;
	}
	else
	{
	...
	if (bParam1)
	{
		unk_0xC0E67E73A6E9A0EE(-1994188940, 0f, 0, 0);
		unk_0x130F0C5AE7B52B7A(-1994188940, 3, 0, 1);
		iVar0++;
	}
	else
	{
...
int func_318(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		unk_0xB32AEE4AC291E533(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0);
		unk_0xC0E67E73A6E9A0EE(904342475, 1f, 0, 0);
		unk_0x130F0C5AE7B52B7A(904342475, 4, 0, 1);
		iVar0++;
	}
	else
	{
	...
	if (bParam1)
	{
		unk_0xB32AEE4AC291E533(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), 0);
		unk_0xC0E67E73A6E9A0EE(-795418380, -0.9f, 0, 0);
		unk_0x130F0C5AE7B52B7A(-795418380, 4, 0, 1);
		iVar0++;
	}
	else
	{
...
int func_319(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)
{
	...
	if (func_388(uParam0))
	{
		...
		unk_0xC76B5C68AB6DC7DF(uParam0, Param1, 1, 0, 0, iParam6);
...
void func_321(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_366(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_365(Param1, 0f, 0f, 0f, 0))
		{
		...
		if (Global_100976.f_1770.f_539.f_1635[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (unk_0x0845149A26DABBA5(Global_100976.f_1770.f_539.f_1635[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = unk_0xD53B4DCC7B2C8551(Global_100976.f_1770.f_539.f_1635[0 /*295*/][iParam1 /*98*/], Param2, fParam5, 0, 0);
				...
				func_351(iParam0, &(Global_100976.f_1770.f_539.f_1635[0 /*295*/][iParam1 /*98*/].f_31), &(Global_100976.f_1770.f_539.f_1635[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_100976.f_1770.f_539.f_1635[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (unk_0x0845149A26DABBA5(Global_100976.f_1770.f_539.f_1635[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = unk_0xD53B4DCC7B2C8551(Global_100976.f_1770.f_539.f_1635[1 /*295*/][iParam1 /*98*/], Param2, fParam5, 0, 0);
				...
				func_351(iParam0, &(Global_100976.f_1770.f_539.f_1635[1 /*295*/][iParam1 /*98*/].f_31), &(Global_100976.f_1770.f_539.f_1635[1 /*295*/][iParam1 /*98*/].f_81));
				unk_0xB5F81A101AEF27D3(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (unk_0x6D5BB810CC209E15(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (unk_0x0845149A26DABBA5(Var5.f_0))
			{
				...
				*iParam0 = unk_0xD53B4DCC7B2C8551(Var5.f_0, Param2, fParam5, 1, 1);
				...
				func_351(iParam0, &(Var5.f_31), &(Var5.f_81));
				unk_0xB5F81A101AEF27D3(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_323(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_150(iParam0) && unk_0x95CCECA3948CFE7B(*iParam1)) && unk_0x5D42322C7DB888D0(*iParam1, 0))
	{
		...
		if ((unk_0xD40E68146088B236(*iParam1) >= 0 && unk_0xD40E68146088B236(*iParam1) < 255) && func_328(*iParam1, 0, &uVar0))
		{
			...
			if (bParam3)
			{
				...
				Global_100976.f_24587[iParam0 /*43*/].f_31 = func_326(*iParam1);
				...
				func_324(Global_100976.f_1770.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_100976.f_1770.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_100976.f_24587[iParam0 /*43*/].f_1));
				...
				func_324(Global_100976.f_1770.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_100976.f_24587[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_328(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	{
		if ((func_329(iParam0) && unk_0x6D5BB810CC209E15(iParam0) != joaat("sentinel2")) && unk_0x6D5BB810CC209E15(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
void func_332(int iParam0, int iParam1)
{
	...
	func_333(iParam0, &(Global_100976.f_18751.f_5510));
}
	...
	if (unk_0x5D42322C7DB888D0(iParam0, 0))
	{
		...
		*uParam1 = unk_0x65979062393E9301(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x59A0729D503ED758(&(uParam1->f_77), func_334(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!unk_0x95CCECA3948CFE7B(iParam0) || !unk_0x5D42322C7DB888D0(iParam0, 0)) || func_275(iParam0, 0, 0)) || func_275(iParam0, 1, 0)) || func_275(iParam0, 2, 0)) || func_347(iParam0) != 145) || func_346(iParam0)) || func_345(iParam0)) || func_329(iParam0)) || func_344(iParam0)) || !func_336(unk_0x6D5BB810CC209E15(iParam0)))
	{
		if (func_345(iParam0))
		{
		}
...
int func_351(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_354(unk_0x6D5BB810CC209E15(*uParam0), 1) && unk_0x342B167253E636DE(*uParam0, 24) != func_353(*uParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xA05B0407D11A92AD(*uParam0, 24, func_353(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	if (func_352(*uParam0))
	{
...
void func_357(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0x95CCECA3948CFE7B(Global_88770[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x6D5BB810CC209E15(Global_88770[iVar0]) == func_358(iParam0, iParam1))
				{
...
void func_359(struct<3> Param0, float fParam3, int iParam4)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_364(&(Global_68186.f_555[0 /*21*/]), iVar0))
		{
...
void func_360(int iParam0)
{
	...
	if (func_364(&(Global_68186.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_179(iParam0, 0)) && Global_69095.f_66 == 0) && Global_100976.f_18751.f_1958[Global_68186.f_555[0 /*21*/].f_14] != 0) && Global_100976.f_18751.f_1958[Global_68186.f_555[0 /*21*/].f_14] > 3) && (!func_362(0, Global_68186.f_555[0 /*21*/].f_12) || !func_362(1, Global_68186.f_555[0 /*21*/].f_12)))
			{
				func_361(&(Global_100976.f_18751.f_69[Global_68186.f_555[0 /*21*/].f_14 /*78*/]), &Global_69095);
...
int func_362(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_363(&(Global_100976.f_18751.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_337(Global_100976.f_18751.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_364(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0xDCC86F723E82125E(uParam0->f_9, 10))
	{
		...
		if (!func_365(Global_100976.f_18751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_365(Global_100976.f_1770.f_539.f_2816[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_365(Global_100976.f_1770.f_539.f_2816[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_365(struct<3> Param0, struct<3> Param3, bool bParam6)
{
	if (bParam6)
	{
...
int func_366(struct<3> Param0, float fParam3)
{
	return func_367(&(Global_95323.f_2311), Param0, fParam3, 0);
}

int func_367(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_377(uParam0))
	{
		...
		if (func_376(uParam0))
		{
			...
			if (unk_0x95CCECA3948CFE7B(iVar0))
			{
				...
				func_372(iVar0, &(uParam0->f_12), 0, 1);
				bVar4 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam5)
					{
						...
						{
							func_357(uParam0->f_11, 1);
						}
						else if (unk_0xE6CB12C10EE5D793(unk_0x6D5BB810CC209E15(iVar0)))
						{
							func_357(uParam0->f_11, 2);
						}
					}
					unk_0xB7EC803E2C9CEC74(iVar0, 0);
					unk_0x328CAEC77C070FA5(iVar0, 0);
					unk_0x0CE9795408B4B974(iVar0, 1);
					func_348(iVar0, uParam0->f_11);
				}
				else if ((!func_369(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && unk_0xF8D041B05C3D1FD4(unk_0xC4E68AF0B559FAC4(), "startup_positioning"))
				{
					iVar8 = func_368(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_369(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_371(iParam0, Global_68186.f_139[38], 0))
			{
				func_360(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_371(iParam0, Global_68186.f_139[43], 1))
			{
				func_360(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_371(iParam0, uVar1[iVar6], 1) && func_370(unk_0x44C17CCB85A88A1F(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_365(Param1, 0f, 0f, 0f, 0)) || unk_0x4F982ED5336EA899(unk_0x44C17CCB85A88A1F(iParam0, 1), unk_0x44C17CCB85A88A1F(uVar1[iVar6], 1), 1) < 10f)
					{
						unk_0x95F5F15D238A7F1C(&iParam0);
						return 1;
					}
...
int func_370(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_372(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (unk_0x5D42322C7DB888D0(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (unk_0xDCC86F723E82125E(uParam1->f_77, func_334(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (unk_0xDCC86F723E82125E(uParam1->f_77, func_334(iVar1 + 1)))
			{
			}
			else
			{
				unk_0x59A0729D503ED758(&(uParam1->f_77), func_334(iVar1 + 1));
			}
		}
		...
		if (((unk_0xDCC86F723E82125E(uParam1->f_77, 15) || func_375(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_374())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!unk_0xAF40E7422A6D9D80(uParam1->f_66) && !unk_0x9DABB329596B1BD6(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (unk_0xDCC86F723E82125E(uParam1->f_77, func_334(iVar2 + 1)))
				{
...
int func_377(var uParam0)
{
	...
	if (!func_337(uParam0->f_12.f_66, 0))
	{
		return 0;
	}
	if (uParam0->f_12.f_66 == joaat("stunt") && func_370(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_378()
{
	return func_376(&(Global_95323.f_2311));
}

void func_379()
{
	func_380(&(Global_95323.f_2311));
}
...
int func_381(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_383(Global_95323.f_2311.f_12.f_66))
	{
		return 0;
	}
...
bool func_384()
{
	return func_377(&(Global_95323.f_2311));
}
...
void func_387()
{
	...
	unk_0xF3AC452C34BF0E13("JOSH4", 0);
	...
	if (func_320())
	{
		if (func_318(0, 1))
		{
			func_436("*** Opened Josh gate for replay");
		}
	}
	func_436("*** Set up coords");
}
...
void func_389(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 6)
	{
		if (func_388(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_388(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_388(uParam0->f_41[iVar0]))
		{
...
int func_390(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			while (iVar5 <= (iVar0 - 1))
			{
				unk_0x7567CEA8E6B5340B(iVar0[iVar5]);
				iVar5++;
			}
			func_400(&(uParam0->f_48), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_79 = 1;
			break;
		
		case 1:
			if (!func_399(&iVar0) || !func_397(&(uParam0->f_48)))
			{
				return 0;
			}
			if (!func_318(0, 1))
		...
		case 2:
			...
			{
				if (func_394(&(uParam0->f_28[0]), 58, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
				{
			...
			if (!unk_0x95CCECA3948CFE7B(uParam0->f_28[1]))
			{
				func_393(&(uParam0->f_28[1]), iVar0[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
				if (func_388(uParam0->f_28[1]))
				{
					unk_0x9AA5A07C66C84468(uParam0->f_28[1]);
					unk_0xAAD662D7E0D59F4C(uParam0->f_28[1], 1);
					unk_0x640290651A86938B(uParam0->f_28[1], joaat("weapon_pistol"), -1, 0, 1);
					if (unk_0xF9B86DC1728F1339("rcmjosh4"))
					{
						unk_0x5124C5FA52D2AF3E(uParam0->f_28[1]);
						unk_0x5323F488E6A1B660(uParam0->f_28[1], "rcmjosh4", "BECKON_A_COP_B", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
				else
				{
			...
			if (!unk_0x95CCECA3948CFE7B(uParam0->f_28[2]))
			{
				func_393(&(uParam0->f_28[2]), iVar0[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
				if (func_388(uParam0->f_28[2]))
				{
					unk_0x8C245572EDB27776(uParam0->f_28[2], 0, 1, 1, 0);
					unk_0x8C245572EDB27776(uParam0->f_28[2], 3, 0, 1, 0);
					unk_0x8C245572EDB27776(uParam0->f_28[2], 10, 0, 1, 0);
					unk_0xAAD662D7E0D59F4C(uParam0->f_28[2], 1);
					unk_0x640290651A86938B(uParam0->f_28[2], joaat("weapon_pistol"), -1, 0, 1);
					if (unk_0xF9B86DC1728F1339("rcmjosh4"))
					{
						unk_0x5124C5FA52D2AF3E(uParam0->f_28[2]);
						unk_0x5323F488E6A1B660(uParam0->f_28[2], "rcmjosh4", "BECKON_A_COP_A", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
				else
				{
			...
			{
				func_392(&(uParam0->f_35[0]), iVar0[3], -1107.5f, 280.33f, 64.01f, 97.97f);
			}
			if (!unk_0x95CCECA3948CFE7B(uParam0->f_35[1]))
			{
				func_391(&(uParam0->f_35[1]), 0);
				if (func_202(uParam0->f_35[1]))
				{
					unk_0x1F7ED83E60948CC2(uParam0->f_35[1], 900f);
					fVar6 = unk_0x78FF715074ED0311(uParam0->f_35[1]);
					fVar6 = (fVar6 / 2f);
					unk_0x62C4DFB4097A1725(uParam0->f_35[1], fVar6);
					unk_0xF18809B65D87E197(uParam0->f_35[1]);
				}
				else
				{
					bVar7 = false;
		...
		case 3:
			if (unk_0x32AADF258A6B79F2(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"), 0))
			{
				unk_0xBEBEBC7C7A0BDA34(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, 1, 0f, 0);
			}
			if (unk_0x32AADF258A6B79F2(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), 0))
			{
				unk_0xBEBEBC7C7A0BDA34(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, 1, 0f, 0);
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
			{
				unk_0x4BBD72565A0AF033(iVar0[iVar5]);
				iVar5++;
			}
			return 1;
			break;
...
void func_391(var uParam0, bool bParam1)
{
	...
	func_392(uParam0, iLocal_81, Var0, fVar3);
	unk_0xC690D7B0DE1C3FD5(*uParam0, 4);
	unk_0x0782F0CAEA719452(*uParam0, 3);
	unk_0x20F2C35BB8206D0D(*uParam0, 0, 0);
	unk_0x48B4BE828B448C49(*uParam0, 1);
}

void func_392(var uParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_225(uParam0);
...
void func_393(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_226(uParam0);
...
int func_395(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_397(var uParam0)
{
	if (func_398(uParam0))
	{
		unk_0xC0E8B67A4385D37D(*uParam0);
...
void func_403()
{
	...
	if (func_413())
	{
		func_436("...Random Character Script was triggered so additional cleanup required");
	}
	iVar0 = 1;
	while (iVar0 <= (Local_443.f_28 - 1))
	{
	...
	func_404(&Local_443, 1, 0, 0);
	unk_0x4BBD72565A0AF033(iLocal_85);
	unk_0x4BBD72565A0AF033(iLocal_84);
...
void func_414(bool bParam0)
{
	...
	if (!func_431())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_415(unk_0xC4E68AF0B559FAC4(), iVar0);
		}
		else
		{
			if (Global_100063[iVar0 /*10*/].f_9 == -1)
...
int func_416(char* sParam0, int iParam1, int iParam2)
{
	var uVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_422())
	{
		...
		{
			iVar33 = func_417(unk_0xC4E68AF0B559FAC4());
			if (iVar33 > -1)
			{
...
int func_418()
{
	...
	iVar0 = func_419(&(Global_91106.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_419(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
	
	iVar0 = unk_0x7CBED6EFED40E7EB(uParam0);
	iVar1 = func_420(iVar0, 1);
	if (iVar1 == -1 && !bParam1)
	{
	}
	return iVar1;
...
int func_422()
{
	...
	{
		if (func_417(&(Global_91106.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_435(&(uParam0->f_28));
	func_435(&(uParam0->f_35));
	func_435(&(uParam0->f_41));
}
