...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_58(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
...
{
	return (Param0.f_1 != -1 && Param0.f_0 != func_179());
}
...
int func_120(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	while (iVar1832 <= iVar3)
	{
		...
		else
		{
			...
			{
				fVar1836 = unk_0xB7A628320EFF8E47(Var4, Var1833);
				if (fVar10 > fVar1836)
				{
					iVar1831++;
					if (iVar1831 == iVar0)
	...
	while (iVar0 < func_189())
	{
		if (unk_0x8CFC2F41A749E236(unk_0xC502CD39B4994F3A(iVar0)) && func_78(unk_0xC502CD39B4994F3A(iVar0), 1, 1))
		{
			if (unk_0x234B68AC2E35ED5A(Local_128[iVar0 /*3*/].f_1, 0))
			{
				...
				if (Param0.f_1 == 18)
				{
					if (unk_0xAB0F784335D14AC3() >= func_188(Param0.f_0))
					{
						return 1;
					}
					else
				...
				if (iLocal_119 >= func_188(Param0.f_0))
				{
					return 1;
				}
			}
				...
				if (!func_281(unk_0x1146A9AE09CE2B14(), 2))
				{
					...
					if (unk_0x636F1F53CC61D2C9(unk_0x15173FB88ABC94F9(&cVar1)) == 0)
					{
						if (!unk_0x3F466B2A5F02D328(&cVar1, -1, 0, 0) || unk_0x5478C744B6AAC199(&cVar1, -1, 0) < 32)
						{
							...
							{
								Local_98.f_0 = Global_2511173.f_3.f_1;
...
int func_210(struct<17> Param0, var uParam17, var uParam18, var uParam19, var uParam20, bool bParam21)
{
	...
	if (unk_0x9E75EF59FA74838C(&cVar0))
	{
		...
		if (unk_0x79CDCC8ABB331B8C(&cVar0))
		{
			...
			iVar10 = unk_0xB8BA7F44DF1575E1(&cVar0, &Param0, 21, func_211(Param0.f_0));
...
{
	func_303();
	func_301(func_302(Param0.f_0), Param0);
