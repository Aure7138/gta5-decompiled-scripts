...
void func_1()
{
	...
	switch (Global_2508417.f_2)
	{
		...
		case 6:
			if (!func_11())
			{
				if (unk_0x1B2EFC1EEC84CBE3(func_6(Global_2508417.f_3.f_1), -1, 0, 0))
				{
					func_168(7);
...
{
	if (unk_0xCE990E643CD9D0E5(Global_2508417.f_1, iParam0))
	{
		unk_0xD2459066EA58CE43(&(Global_2508417.f_1), iParam0);
	}
}
...
void func_17(int iParam0)
{
	if (!unk_0xCE990E643CD9D0E5(Global_2508417.f_1, iParam0))
	{
		unk_0xBE20AB8238688965(&(Global_2508417.f_1), iParam0);
	}
}
...
int func_63(int iParam0, var uParam1)
{
	...
	{
		Global_2515401 = { func_62(iParam0) };
		Global_2515414 = { func_62(uParam1) };
...
int func_81(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	while (iVar1715 <= iVar3)
	{
		...
		else
		{
			...
			{
				fVar1719 = unk_0xB7A628320EFF8E47(Var4, Var1716);
				if (fVar10 > fVar1719)
				{
					iVar1714++;
					if (iVar1714 == iVar0)
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_140(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
{
	return unk_0xCE990E643CD9D0E5(Global_2508417.f_1, iParam0);
}
	...
	while (iVar0 < func_155())
	{
		if (unk_0x166E920FB00B2DBB(unk_0xF1110FE23C67293A(iVar0)) && func_57(unk_0xF1110FE23C67293A(iVar0), 1, 1))
		{
			if (unk_0xCE990E643CD9D0E5(Local_126[iVar0 /*3*/].f_1, 0))
			{
				...
				if (Param0.f_1 == 18)
				{
					if (unk_0xB9E6DF0411C3488E() >= func_154(Param0.f_0))
					{
						return 1;
					}
					else
				...
				if (iLocal_117 >= func_154(Param0.f_0))
				{
					return 1;
				}
			}
...
void func_175()
{
	...
	switch (Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_2)
	{
		...
		case 5:
			...
			{
				unk_0xD2459066EA58CE43(&(Global_2540612.f_206.f_1), 1);
				unk_0xD2459066EA58CE43(&(Global_2540612.f_206.f_1), 2);
				unk_0xD2459066EA58CE43(&(Global_2540612.f_206.f_1), 3);
				func_259(6);
			}
				...
				if (!func_260(unk_0x460153A63B9477BC(), 2))
				{
					...
					if (unk_0x7B70881748D166CD(unk_0x856D5567211886A2(&cVar1)) == 0)
					{
						if (!unk_0x1B2EFC1EEC84CBE3(&cVar1, -1, 0, 0) || unk_0x96799BFA3859CDC1(&cVar1, -1, 0) < 32)
						{
							...
							{
								Local_96.f_0 = Global_2508417.f_3.f_1;
...
int func_176(struct<17> Param0, var uParam17, var uParam18, var uParam19, var uParam20, bool bParam21)
{
	...
	if (unk_0x55B9A76AF5A44EE2(&cVar0))
	{
		...
		if (unk_0x8DC2EFD1CECAA468(&cVar0))
		{
			...
			iVar10 = unk_0xB8BA7F44DF1575E1(&cVar0, &Param0, 21, func_177(Param0.f_0));
...
void func_181()
{
	...
	{
		if (!unk_0xCE990E643CD9D0E5(Global_2540612.f_206.f_1, 1))
		{
			if (((Global_262145.f_45 * 120000) - func_198(&(Global_2508417.f_177), 0, 0)) < 360000)
			{
				if (!unk_0xCE990E643CD9D0E5(Global_2540612.f_206.f_1, 1))
				{
					...
					unk_0xBE20AB8238688965(&(Global_2540612.f_206.f_1), 1);
				}
			}
			else if (((Global_262145.f_45 * 120000) - func_198(&(Global_2508417.f_177), 0, 0)) < 600000)
			{
				if (!unk_0xCE990E643CD9D0E5(Global_2540612.f_206.f_1, 2))
				{
					if (func_188(31, 0, 0) && !func_187())
					{
						func_182("ACD_TSCH", 5);
					}
					unk_0xBE20AB8238688965(&(Global_2540612.f_206.f_1), 2);
				}
			}
			else if (((Global_262145.f_45 * 120000) - func_198(&(Global_2508417.f_177), 0, 0)) < 1200000)
			{
				if (!unk_0xCE990E643CD9D0E5(Global_2540612.f_206.f_1, 3))
				{
					if (func_188(31, 0, 0) && !func_187())
					{
						func_182("ACD_TSCH", 10);
					}
					unk_0xBE20AB8238688965(&(Global_2540612.f_206.f_1), 3);
				}
			}
		}
	}
...
int func_197(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2588062[iParam0 /*3*/][func_190(iParam1)];
...
int func_202(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 4:
			return (((((func_188(20, 0, 0) && !func_205(unk_0x460153A63B9477BC(), 1)) && !func_205(unk_0x460153A63B9477BC(), 2)) && !func_205(unk_0x460153A63B9477BC(), 3)) && !Global_2440277.f_3858) && !func_203());
...
int func_229(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		uVar0 = Global_2552060[iParam0 /*3*/][func_190(iParam1)];
...
int func_276(struct<21> Param0)
{
	...
	func_277(0, -1, 0);
	unk_0x97D2F2E2C92FD519(&Global_2508417, 186);
