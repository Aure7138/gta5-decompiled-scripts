...
int func_2()
{
	...
	fVar0 = unk_0xB7A628320EFF8E47(unk_0xA8CFDE65C45F813B(unk_0x27D769C59BC9D030(), 1), Local_78);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
int func_3(int iParam0, int iParam1)
{
	...
	while (iVar1 < *iParam0)
	{
		if (!unk_0xE4F7206742848BAF((*iParam0)[iVar1]))
		{
		...
		else if (unk_0xD2CFFE76B625AE55((*iParam0)[iVar1]))
		{
		}
		iVar1++;
	}
...
void func_19()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_73)
		{
			...
			{
				unk_0x97C59C4E8349D15F(iLocal_73[iVar0]);
				if (!unk_0x875098323FCA8FE6(iLocal_73[iVar0]))
				{
					unk_0x97C59C4E8349D15F(iLocal_73[iVar0]);
					bVar2 = false;
				}
		...
		if (!unk_0x75CB9E30BA492FF0(&cLocal_113))
		{
			unk_0x88172B3983EC5071(&cLocal_113);
			if (!unk_0x482101C9B3483958(&cLocal_113))
			{
				unk_0x88172B3983EC5071(&cLocal_113);
				bVar2 = false;
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_73[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0x91D233CD0204A37F(26, iLocal_73[iVar0], Local_78 + Local_82[iVar0 /*3*/], 0, 1, 1);
			unk_0x0359A241E2DD22AC(iLocal_68[iVar0], Vector(uLocal_81, 0f, 0f) + Local_95[iVar0 /*3*/], 2, 1);
			unk_0x49A20F75B1327C29(iLocal_68[iVar0], 0);
			if (iLocal_66 == 288)
			{
				unk_0x5D927D8655264D6C(iLocal_68[iVar0], 3, 1, 0, 0);
				unk_0x5D927D8655264D6C(iLocal_68[iVar0], 4, 0, 0, 0);
			}
			else
			{
				unk_0x49A20F75B1327C29(iLocal_68[iVar0], 0);
			}
			unk_0x7ED3655E5924C6F4(iLocal_68[iVar0], 13, 0);
			unk_0x7ED3655E5924C6F4(iLocal_68[iVar0], 17, 1);
			unk_0xA8ED9F72DC442242(iLocal_68[iVar0], 1);
			unk_0xFFD8329ED7A8E20C(iLocal_68[iVar0], 0);
			unk_0xFEB38679E5E29979(iLocal_68[iVar0], &cLocal_113, &(Local_121[iVar0 /*8*/]), Local_78 + Local_82[iVar0 /*3*/], Vector(uLocal_81, 0f, 0f) + Local_95[iVar0 /*3*/], 1000f, -8f, -1, iLocal_154, 0, 2, 0);
			unk_0x8A3D3E40973625F0(iLocal_68[iVar0], 0, 0);
			unk_0x94DC76C688E7D222(iLocal_68[iVar0], 1);
			unk_0xC908FA7A5EBB2825(iLocal_68[iVar0], 55, 1);
			if (iLocal_162[iVar0] > 0)
			{
				unk_0xE24B9AA8FD1D0507(iLocal_68[iVar0], 1, 0.36f, 0.71f, "ShotgunSmall");
				unk_0x8BD4D3FFE41C61E7(iLocal_68[iVar0], 1, 0.81f, 0.733f, 4);
				unk_0x8BD4D3FFE41C61E7(iLocal_68[iVar0], 0, 0.94f, 0.59f, 3);
				unk_0x8BD4D3FFE41C61E7(iLocal_68[iVar0], 3, 0.24f, 0.62f, 4);
				unk_0x8BD4D3FFE41C61E7(iLocal_68[iVar0], 2, 0f, 0.15f, 2);
				unk_0x8BD4D3FFE41C61E7(iLocal_68[iVar0], 5, 0.46f, 0.853f, 3);
				unk_0x8BD4D3FFE41C61E7(iLocal_68[iVar0], 4, 0.308f, 0.786f, 3);
				unk_0xD728E42852AE3D6E(iLocal_68[iVar0], 3, 0.375f, 0.398f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0xD728E42852AE3D6E(iLocal_68[iVar0], 3, 0.5f, 0.6f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0xD728E42852AE3D6E(iLocal_68[iVar0], 3, 0.6f, 0.25f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0xD728E42852AE3D6E(iLocal_68[iVar0], 3, 0.65f, 0.325f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0xD728E42852AE3D6E(iLocal_68[iVar0], 0, 0.58f, 0.704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_155)
	{
		if (iLocal_162[iVar0] > 0)
		{
			...
			fVar14 = 1f;
			fVar15 = -1f;
			iLocal_155[iVar0] = unk_0xAC874EE6A397A6B3(iLocal_162[iVar0], Local_78 + Local_169[iVar0 /*3*/], Var3, Var6, fVar9, fVar10, fVar11, fVar12, fVar13, fVar14, fVar15, 0, 0, 0);
			unk_0x4EDE34FBADD967A6(0);
		}
		iVar0++;
	}
...
void func_21()
{
	...
	switch (iLocal_66)
	{
		case 280:
			...
			iLocal_162[4] = 1015;
			iLocal_162[5] = 1015;
			Local_169[4 /*3*/] = { Local_169[0 /*3*/] + Local_169[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x5C02660403071A83(0.5f, 0.5f), unk_0x5C02660403071A83(0.5f, 0.5f)) };
			Local_169[5 /*3*/] = { Local_169[1 /*3*/] + Local_169[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x5C02660403071A83(0.5f, 0.5f), unk_0x5C02660403071A83(0.5f, 0.5f)) };
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_23(uParam109, 17, 1785177548, 1785177548, unk_0x5C02660403071A83(-5f, 5f), unk_0x5C02660403071A83(-5f, 5f), 0f, unk_0x5C02660403071A83(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_23(uParam109, 144, 1785177548, 1785177548, unk_0x5C02660403071A83(-5f, 5f), unk_0x5C02660403071A83(-5f, 5f), 0f, unk_0x5C02660403071A83(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_23(uParam109, 43, 1785177548, 1785177548, unk_0x5C02660403071A83(-5f, 5f), unk_0x5C02660403071A83(-5f, 5f), 0f, unk_0x5C02660403071A83(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
...
void func_33()
{
	...
	while (iVar0 < iLocal_73)
	{
		if (iLocal_73[iVar0] != 0)
		{
			unk_0x0049DE0B34213B12(iLocal_73[iVar0]);
		}
		iVar0++;
	}
	if (!unk_0x75CB9E30BA492FF0(&cLocal_113))
	{
		unk_0x651E63BA2F4975EC(&cLocal_113);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_155)
	{
		if (unk_0xDBBA5C22951CCD7A(iLocal_155[iVar0]))
		{
		}
		iVar0++;
	}
