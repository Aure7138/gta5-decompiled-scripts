...
int func_2()
{
	...
	fVar0 = unk_0xB7A628320EFF8E47(unk_0x761660F5CE986DC4(unk_0x18F7BE9ACB7D08F4(), 1), Local_82);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
int func_3(int iParam0, int iParam1)
{
	...
	while (iVar1 < *iParam0)
	{
		if (!unk_0x0FAE113CE72ED842((*iParam0)[iVar1]))
		{
		...
		else if (unk_0x31F12808DC47A9E5((*iParam0)[iVar1]))
		{
		}
		iVar1++;
	}
...
int func_6(int iParam0, int iParam1)
{
	...
	if (!unk_0x51CFE20A158947F4())
	{
		...
		else if (iParam1 == func_7(Global_92615) && iParam1 != 0)
		{
			Global_92615 = 0;
		}
	}
...
void func_19()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_77)
		{
			...
			{
				unk_0x9016574B77A748EE(iLocal_77[iVar0]);
				if (!unk_0xEDFE27D1AEA0EA7F(iLocal_77[iVar0]))
				{
					unk_0x9016574B77A748EE(iLocal_77[iVar0]);
					bVar2 = false;
				}
		...
		if (!unk_0xFAFFA408239A026B(&cLocal_117))
		{
			unk_0x831CD0FBFB26EC7E(&cLocal_117);
			if (!unk_0x028356968FDD2DF2(&cLocal_117))
			{
				unk_0x831CD0FBFB26EC7E(&cLocal_117);
				bVar2 = false;
			}
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = unk_0x364B87C5C64BD100(26, iLocal_77[iVar0], Local_82 + Local_86[iVar0 /*3*/], 0, 1, 1);
			unk_0x58F6B49606932378(iLocal_72[iVar0], Vector(uLocal_85, 0f, 0f) + Local_99[iVar0 /*3*/], 2, 1);
			unk_0x48FBF866E2964067(iLocal_72[iVar0], 0);
			if (iLocal_70 == 288)
			{
				unk_0xDEA702F2138E0B35(iLocal_72[iVar0], 3, 1, 0, 0);
				unk_0xDEA702F2138E0B35(iLocal_72[iVar0], 4, 0, 0, 0);
			}
			else
			{
				unk_0x48FBF866E2964067(iLocal_72[iVar0], 0);
			}
			unk_0x273FE09AE985A00A(iLocal_72[iVar0], 13, 0);
			unk_0x273FE09AE985A00A(iLocal_72[iVar0], 17, 1);
			unk_0x40E2910BAF39B1C7(iLocal_72[iVar0], 1);
			unk_0x44EB7E24C5D75087(iLocal_72[iVar0], 0);
			unk_0x981A584B2E775D45(iLocal_72[iVar0], &cLocal_117, &(Local_125[iVar0 /*8*/]), Local_82 + Local_86[iVar0 /*3*/], Vector(uLocal_85, 0f, 0f) + Local_99[iVar0 /*3*/], 1000f, -8f, -1, iLocal_158, 0, 2, 0);
			unk_0x8F2E6C470A0005D4(iLocal_72[iVar0], 0, 0);
			unk_0x10F31830C95ED2E5(iLocal_72[iVar0], 1);
			unk_0xB05E48165A6F6058(iLocal_72[iVar0], 55, 1);
			if (iLocal_166[iVar0] > 0)
			{
				unk_0x249797A6B1A830A9(iLocal_72[iVar0], 1, 0.36f, 0.71f, "ShotgunSmall");
				unk_0x882B022908552A3F(iLocal_72[iVar0], 1, 0.81f, 0.733f, 4);
				unk_0x882B022908552A3F(iLocal_72[iVar0], 0, 0.94f, 0.59f, 3);
				unk_0x882B022908552A3F(iLocal_72[iVar0], 3, 0.24f, 0.62f, 4);
				unk_0x882B022908552A3F(iLocal_72[iVar0], 2, 0f, 0.15f, 2);
				unk_0x882B022908552A3F(iLocal_72[iVar0], 5, 0.46f, 0.853f, 3);
				unk_0x882B022908552A3F(iLocal_72[iVar0], 4, 0.308f, 0.786f, 3);
				unk_0x6E84AEA23E75B751(iLocal_72[iVar0], 3, 0.375f, 0.398f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0x6E84AEA23E75B751(iLocal_72[iVar0], 3, 0.5f, 0.6f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0x6E84AEA23E75B751(iLocal_72[iVar0], 3, 0.6f, 0.25f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0x6E84AEA23E75B751(iLocal_72[iVar0], 3, 0.65f, 0.325f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0x6E84AEA23E75B751(iLocal_72[iVar0], 0, 0.58f, 0.704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_159)
	{
		if (iLocal_166[iVar0] > 0)
		{
			...
			fVar14 = 1f;
			fVar15 = -1f;
			iLocal_159[iVar0] = unk_0x6B01B73E7B5A03F7(iLocal_166[iVar0], Local_82 + Local_173[iVar0 /*3*/], Var3, Var6, fVar9, fVar10, fVar11, fVar12, fVar13, fVar14, fVar15, 0, 0, 0);
			unk_0x4EDE34FBADD967A6(0);
		}
		iVar0++;
	}
...
void func_21()
{
	...
	func_25(iLocal_70, &Local_82, &uLocal_85, &cVar0);
	Var8.f_1 = -1;
	Var8.f_17 = 4;
	Var8.f_17.f_8 = 4;
	Var8.f_17.f_13 = 4;
	...
	switch (iLocal_70)
	{
		case 280:
			...
			iLocal_166[4] = 1015;
			iLocal_166[5] = 1015;
			Local_173[4 /*3*/] = { Local_173[0 /*3*/] + Local_173[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x3D81861E1A1652A9(0.5f, 0.5f), unk_0x3D81861E1A1652A9(0.5f, 0.5f)) };
			Local_173[5 /*3*/] = { Local_173[1 /*3*/] + Local_173[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x3D81861E1A1652A9(0.5f, 0.5f), unk_0x3D81861E1A1652A9(0.5f, 0.5f)) };
			break;
...
int func_22(struct<109> Param0, var uParam109)
{
	...
	switch (Param0.f_2)
	{
		...
		case 2:
			*uParam109 = { Global_91005[0 /*109*/] };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_24(uParam109);
			uParam109->f_118 = Global_92593[0];
			return 1;
			break;
		
		case 3:
			*uParam109 = { Global_91005[1 /*109*/] };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_24(uParam109);
			uParam109->f_118 = Global_92593[1];
			return 1;
			break;
		
		case 4:
			*uParam109 = { Global_91005[2 /*109*/] };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_24(uParam109);
			uParam109->f_118 = Global_92593[2];
			return 1;
			break;
		...
		case 5:
			*uParam109 = { Param0 };
			...
			uParam109->f_110 = -982327190;
			func_24(uParam109);
			uParam109->f_118 = Global_92593[Param0.f_3];
			return 1;
			break;
		...
		case 155:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_23(uParam109, 17, 1785177548, 1785177548, unk_0x3D81861E1A1652A9(-5f, 5f), unk_0x3D81861E1A1652A9(-5f, 5f), 0f, unk_0x3D81861E1A1652A9(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_23(uParam109, 144, 1785177548, 1785177548, unk_0x3D81861E1A1652A9(-5f, 5f), unk_0x3D81861E1A1652A9(-5f, 5f), 0f, unk_0x3D81861E1A1652A9(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_23(uParam109, 43, 1785177548, 1785177548, unk_0x3D81861E1A1652A9(-5f, 5f), unk_0x3D81861E1A1652A9(-5f, 5f), 0f, unk_0x3D81861E1A1652A9(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_104551.f_2353.f_539.f_2290[0];
			StringCopy(sParam2, func_32(Global_104551.f_2353.f_539.f_2294[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_104551.f_2353.f_539.f_2290[1];
			StringCopy(sParam2, func_32(Global_104551.f_2353.f_539.f_2294[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_104551.f_2353.f_539.f_2290[2];
			StringCopy(sParam2, func_32(Global_104551.f_2353.f_539.f_2294[2]), 32);
			return 1;
			break;
...
void func_33()
{
	...
	while (iVar0 < iLocal_77)
	{
		if (iLocal_77[iVar0] != 0)
		{
			unk_0x419C9117019F2E5A(iLocal_77[iVar0]);
		}
		iVar0++;
	}
	if (!unk_0xFAFFA408239A026B(&cLocal_117))
	{
		unk_0x334F1DD67B2EC86A(&cLocal_117);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_159)
	{
		if (unk_0xDA28286C1AF56926(iLocal_159[iVar0]))
		{
		}
		iVar0++;
	}
