...
int func_2()
{
	...
	fVar0 = unk_0xB7A628320EFF8E47(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_82);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
int func_3(int iParam0, int iParam1)
{
	...
	while (iVar1 < *iParam0)
	{
		if (!unk_0x5AEB5DDFFAD43CA5((*iParam0)[iVar1]))
		{
		...
		else if (unk_0xAE06B9E39EBDE049((*iParam0)[iVar1]))
		{
		}
		iVar1++;
	}
...
void func_10()
{
	...
	{
		if (func_13(Global_111858.f_2359.f_539.f_4321) != unk_0x36FE6D3220816ADA(unk_0x9B0761B4C3EB8BC7()))
		{
			iVar0 = func_12(unk_0x9B0761B4C3EB8BC7());
...
void func_20()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_77)
		{
			...
			{
				unk_0x78FCB2E22C41B9D5(iLocal_77[iVar0]);
				if (!unk_0x7D167B9A0CCDA347(iLocal_77[iVar0]))
				{
					unk_0x78FCB2E22C41B9D5(iLocal_77[iVar0]);
					bVar2 = false;
				}
		...
		if (!unk_0x7BCC91F3C1CF24E8(&cLocal_117))
		{
			unk_0x131ED02492676000(&cLocal_117);
			if (!unk_0xC614DDE265D18415(&cLocal_117))
			{
				unk_0x131ED02492676000(&cLocal_117);
				bVar2 = false;
			}
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = unk_0xB3116B49FE00E2F1(26, iLocal_77[iVar0], Local_82 + Local_86[iVar0 /*3*/], 0, 1, 1);
			unk_0xC82085403E46A869(iLocal_72[iVar0], Vector(uLocal_85, 0f, 0f) + Local_99[iVar0 /*3*/], 2, 1);
			unk_0xD93D982926D0D8B3(iLocal_72[iVar0], 0);
			if (iLocal_70 == 288)
			{
				unk_0x45F588C0DD767737(iLocal_72[iVar0], 3, 1, 0, 0);
				unk_0x45F588C0DD767737(iLocal_72[iVar0], 4, 0, 0, 0);
			}
			else
			{
				unk_0xD93D982926D0D8B3(iLocal_72[iVar0], 0);
			}
			unk_0x6673CC701BC8E9C1(iLocal_72[iVar0], 13, 0);
			unk_0x6673CC701BC8E9C1(iLocal_72[iVar0], 17, 1);
			unk_0x4E65320BC9AD521C(iLocal_72[iVar0], 1);
			unk_0x0DC39BE87E4C5599(iLocal_72[iVar0], 0);
			unk_0x81DCDE42A0B23C21(iLocal_72[iVar0], &cLocal_117, &(Local_125[iVar0 /*8*/]), Local_82 + Local_86[iVar0 /*3*/], Vector(uLocal_85, 0f, 0f) + Local_99[iVar0 /*3*/], 1000f, -8f, -1, iLocal_158, 0, 2, 0);
			unk_0x1322CA891C5DF18A(iLocal_72[iVar0], 0, 0);
			unk_0xCBA6B2B569DCAFD8(iLocal_72[iVar0], 1);
			unk_0x8342E6CB98CD545C(iLocal_72[iVar0], 55, 1);
			if (iLocal_166[iVar0] > 0)
			{
				unk_0x1535F41404228601(iLocal_72[iVar0], 1, 0.36f, 0.71f, "ShotgunSmall");
				unk_0x8CD0D18BBDEA2635(iLocal_72[iVar0], 1, 0.81f, 0.733f, 4);
				unk_0x8CD0D18BBDEA2635(iLocal_72[iVar0], 0, 0.94f, 0.59f, 3);
				unk_0x8CD0D18BBDEA2635(iLocal_72[iVar0], 3, 0.24f, 0.62f, 4);
				unk_0x8CD0D18BBDEA2635(iLocal_72[iVar0], 2, 0f, 0.15f, 2);
				unk_0x8CD0D18BBDEA2635(iLocal_72[iVar0], 5, 0.46f, 0.853f, 3);
				unk_0x8CD0D18BBDEA2635(iLocal_72[iVar0], 4, 0.308f, 0.786f, 3);
				unk_0xC40573784954F2AD(iLocal_72[iVar0], 3, 0.375f, 0.398f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0xC40573784954F2AD(iLocal_72[iVar0], 3, 0.5f, 0.6f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0xC40573784954F2AD(iLocal_72[iVar0], 3, 0.6f, 0.25f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0xC40573784954F2AD(iLocal_72[iVar0], 3, 0.65f, 0.325f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0xC40573784954F2AD(iLocal_72[iVar0], 0, 0.58f, 0.704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_159)
	{
		if (iLocal_166[iVar0] > 0)
		{
			...
			fVar14 = 1f;
			fVar15 = -1f;
			iLocal_159[iVar0] = unk_0xF00FBB09122693FC(iLocal_166[iVar0], Local_82 + Local_173[iVar0 /*3*/], Var3, Var6, fVar9, fVar10, fVar11, fVar12, fVar13, fVar14, fVar15, 0, 0, 0);
			unk_0x4EDE34FBADD967A6(0);
		}
		iVar0++;
	}
...
void func_22()
{
	...
	switch (iLocal_70)
	{
		case 280:
			...
			iLocal_166[4] = 1015;
			iLocal_166[5] = 1015;
			Local_173[4 /*3*/] = { Local_173[0 /*3*/] + Local_173[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x658086F2B3C5E4E4(0.5f, 0.5f), unk_0x658086F2B3C5E4E4(0.5f, 0.5f)) };
			Local_173[5 /*3*/] = { Local_173[1 /*3*/] + Local_173[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x658086F2B3C5E4E4(0.5f, 0.5f), unk_0x658086F2B3C5E4E4(0.5f, 0.5f)) };
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_24(uParam109, 17, 1785177548, 1785177548, unk_0x658086F2B3C5E4E4(-5f, 5f), unk_0x658086F2B3C5E4E4(-5f, 5f), 0f, unk_0x658086F2B3C5E4E4(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_24(uParam109, 144, 1785177548, 1785177548, unk_0x658086F2B3C5E4E4(-5f, 5f), unk_0x658086F2B3C5E4E4(-5f, 5f), 0f, unk_0x658086F2B3C5E4E4(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_24(uParam109, 43, 1785177548, 1785177548, unk_0x658086F2B3C5E4E4(-5f, 5f), unk_0x658086F2B3C5E4E4(-5f, 5f), 0f, unk_0x658086F2B3C5E4E4(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
...
void func_34()
{
	...
	while (iVar0 < iLocal_77)
	{
		if (iLocal_77[iVar0] != 0)
		{
			unk_0x74528AC0906CBABE(iLocal_77[iVar0]);
		}
		iVar0++;
	}
	if (!unk_0x7BCC91F3C1CF24E8(&cLocal_117))
	...
	while (iVar0 < iLocal_159)
	{
		if (unk_0xB18B779C3BD6AD7B(iLocal_159[iVar0]))
		{
		}
		iVar0++;
	}
