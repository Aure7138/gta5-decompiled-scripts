...
int func_2()
{
	...
	fVar0 = unk_0xB7A628320EFF8E47(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), Local_78);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
int func_3(int iParam0, int iParam1)
{
	...
	while (iVar1 < *iParam0)
	{
		if (!unk_0xEB361B4BD195A4D3((*iParam0)[iVar1]))
		{
		...
		else if (unk_0xD3FACCDA4D66AEAD((*iParam0)[iVar1]))
		{
		}
		iVar1++;
	}
...
int func_6(int iParam0, int iParam1)
{
	...
	if (!unk_0xC740F8182E7E9681())
	{
		...
		else if (iParam1 == func_7(Global_91192) && iParam1 != 0)
		{
			Global_91192 = 0;
		}
	}
...
void func_19()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_73)
		{
			...
			{
				unk_0x491067A8E906F22D(iLocal_73[iVar0]);
				if (!unk_0x2C1B5A0D3E233FC3(iLocal_73[iVar0]))
				{
					unk_0x491067A8E906F22D(iLocal_73[iVar0]);
					bVar2 = false;
				}
		...
		if (!unk_0x509383441597090D(&cLocal_113))
		{
			unk_0xA9DC3948106CC3E4(&cLocal_113);
			if (!unk_0xAD21C77209FD2024(&cLocal_113))
			{
				unk_0xA9DC3948106CC3E4(&cLocal_113);
				bVar2 = false;
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_73[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0xF8418B3B87CFCCBF(26, iLocal_73[iVar0], Local_78 + Local_82[iVar0 /*3*/], 0, 1, 1);
			unk_0x4A1ACDDF793F9777(iLocal_68[iVar0], Vector(uLocal_81, 0f, 0f) + Local_95[iVar0 /*3*/], 2, 1);
			unk_0x6F040B02C824E718(iLocal_68[iVar0], 0);
			if (iLocal_66 == 288)
			{
				unk_0xA27FDFE5C0EBB875(iLocal_68[iVar0], 3, 1, 0, 0);
				unk_0xA27FDFE5C0EBB875(iLocal_68[iVar0], 4, 0, 0, 0);
			}
			else
			{
				unk_0x6F040B02C824E718(iLocal_68[iVar0], 0);
			}
			unk_0x87BBAE0EE5DD7680(iLocal_68[iVar0], 13, 0);
			unk_0x87BBAE0EE5DD7680(iLocal_68[iVar0], 17, 1);
			unk_0xFF5CE2ECB4FBD4A8(iLocal_68[iVar0], 1);
			unk_0xB43604F27F1EAE5F(iLocal_68[iVar0], 0);
			unk_0x80D24BCACA9887CB(iLocal_68[iVar0], &cLocal_113, &(Local_121[iVar0 /*8*/]), Local_78 + Local_82[iVar0 /*3*/], Vector(uLocal_81, 0f, 0f) + Local_95[iVar0 /*3*/], 1000f, -8f, -1, iLocal_154, 0, 2, 0);
			unk_0x2945E3CE39DA8591(iLocal_68[iVar0], 0, 0);
			unk_0x77637031DE326F70(iLocal_68[iVar0], 1);
			unk_0xF674E664795C8CB3(iLocal_68[iVar0], 55, 1);
			if (iLocal_162[iVar0] > 0)
			{
				unk_0xCB88B21296566D72(iLocal_68[iVar0], 1, 0.36f, 0.71f, "ShotgunSmall");
				unk_0x87C53255252E0028(iLocal_68[iVar0], 1, 0.81f, 0.733f, 4);
				unk_0x87C53255252E0028(iLocal_68[iVar0], 0, 0.94f, 0.59f, 3);
				unk_0x87C53255252E0028(iLocal_68[iVar0], 3, 0.24f, 0.62f, 4);
				unk_0x87C53255252E0028(iLocal_68[iVar0], 2, 0f, 0.15f, 2);
				unk_0x87C53255252E0028(iLocal_68[iVar0], 5, 0.46f, 0.853f, 3);
				unk_0x87C53255252E0028(iLocal_68[iVar0], 4, 0.308f, 0.786f, 3);
				unk_0x1BECB532D62605C2(iLocal_68[iVar0], 3, 0.375f, 0.398f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0x1BECB532D62605C2(iLocal_68[iVar0], 3, 0.5f, 0.6f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0x1BECB532D62605C2(iLocal_68[iVar0], 3, 0.6f, 0.25f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0x1BECB532D62605C2(iLocal_68[iVar0], 3, 0.65f, 0.325f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0x1BECB532D62605C2(iLocal_68[iVar0], 0, 0.58f, 0.704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_155)
	{
		if (iLocal_162[iVar0] > 0)
		{
			...
			fVar14 = 1f;
			fVar15 = -1f;
			iLocal_155[iVar0] = unk_0xDDCD96747E437A72(iLocal_162[iVar0], Local_78 + Local_169[iVar0 /*3*/], Var3, Var6, fVar9, fVar10, fVar11, fVar12, fVar13, fVar14, fVar15, 0, 0, 0);
			unk_0x4EDE34FBADD967A6(0);
		}
		iVar0++;
	}
...
void func_21()
{
	...
	switch (iLocal_66)
	{
		case 280:
			...
			iLocal_162[4] = 1015;
			iLocal_162[5] = 1015;
			Local_169[4 /*3*/] = { Local_169[0 /*3*/] + Local_169[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0xF25F352E34274C58(0.5f, 0.5f), unk_0xF25F352E34274C58(0.5f, 0.5f)) };
			Local_169[5 /*3*/] = { Local_169[1 /*3*/] + Local_169[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0xF25F352E34274C58(0.5f, 0.5f), unk_0xF25F352E34274C58(0.5f, 0.5f)) };
			break;
...
int func_22(struct<109> Param0, var uParam109)
{
	...
	switch (Param0.f_2)
	{
		...
		case 2:
			*uParam109 = { Global_89582[0 /*109*/] };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_24(uParam109);
			uParam109->f_118 = Global_91170[0];
			return 1;
			break;
		
		case 3:
			*uParam109 = { Global_89582[1 /*109*/] };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_24(uParam109);
			uParam109->f_118 = Global_91170[1];
			return 1;
			break;
		
		case 4:
			*uParam109 = { Global_89582[2 /*109*/] };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_24(uParam109);
			uParam109->f_118 = Global_91170[2];
			return 1;
			break;
		...
		case 5:
			*uParam109 = { Param0 };
			...
			uParam109->f_110 = -982327190;
			func_24(uParam109);
			uParam109->f_118 = Global_91170[Param0.f_3];
			return 1;
			break;
		...
		case 155:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_23(uParam109, 17, 1785177548, 1785177548, unk_0xF25F352E34274C58(-5f, 5f), unk_0xF25F352E34274C58(-5f, 5f), 0f, unk_0xF25F352E34274C58(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_23(uParam109, 144, 1785177548, 1785177548, unk_0xF25F352E34274C58(-5f, 5f), unk_0xF25F352E34274C58(-5f, 5f), 0f, unk_0xF25F352E34274C58(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_23(uParam109, 43, 1785177548, 1785177548, unk_0xF25F352E34274C58(-5f, 5f), unk_0xF25F352E34274C58(-5f, 5f), 0f, unk_0xF25F352E34274C58(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_101553.f_1991.f_539.f_1538[0];
			StringCopy(sParam2, func_32(Global_101553.f_1991.f_539.f_1542[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_101553.f_1991.f_539.f_1538[1];
			StringCopy(sParam2, func_32(Global_101553.f_1991.f_539.f_1542[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_101553.f_1991.f_539.f_1538[2];
			StringCopy(sParam2, func_32(Global_101553.f_1991.f_539.f_1542[2]), 32);
			return 1;
			break;
...
void func_33()
{
	...
	while (iVar0 < iLocal_73)
	{
		if (iLocal_73[iVar0] != 0)
		{
			unk_0x2C07692AA3545079(iLocal_73[iVar0]);
		}
		iVar0++;
	}
	if (!unk_0x509383441597090D(&cLocal_113))
	{
		unk_0x04269E768DDAF940(&cLocal_113);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_155)
	{
		if (unk_0x80B78FF6EC54F967(iLocal_155[iVar0]))
		{
		}
		iVar0++;
	}
