				...
				if (!func_43(74))
				{
					...
					else if (func_23(iLocal_96))
					{
						...
						while (iVar1 <= 262)
						{
							...
							{
								if (unk_0x8F678487EEBD8CE4(Global_31346[iVar34 /*23*/].f_19))
								{
									unk_0x009A89A6CD1E6C3E(Global_31346[iVar34 /*23*/].f_19, 1);
									unk_0x9178C42B36234BF1(Global_31346[iVar34 /*23*/].f_19, 10000);
									switch (func_9())
									{
										case 1:
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_31(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (!func_82(iVar0) || iVar0 == 52)
	{
		if (!unk_0xCE990E643CD9D0E5(Global_111858.f_18570.f_390[iLocal_52], iLocal_51))
		{
			...
			else if (Global_110945[iVar0 /*10*/].f_8 != -1)
			{
				...
				{
					if (unk_0xCE990E643CD9D0E5(Global_31346[iLocal_74[Global_110945[iVar0 /*10*/].f_8] /*23*/].f_11, 6))
					{
...
void func_83(int iParam0)
{
	...
	if (unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 0) && !unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 3))
	{
		if (!Global_111858.f_18570[iParam0 /*6*/].f_1)
		{
			...
			if (iParam0 == 57)
			{
				iVar33 = unk_0x344C570D6F8700DF(3, 11);
				iVar33 *= 30;
	...
	else if (Global_110945[iParam0 /*10*/].f_3)
	{
		...
		if (!func_120() && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), Var0.f_6, 0) > fVar61)
		{
			Global_110945[iParam0 /*10*/].f_3 = 0;
		}
		else
	...
	iVar62 = 0;
	if ((((iVar60 && !unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 3)) && unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 0)) && unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 1)) && unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 2))
	{
	...
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		if (!func_45(35))
		{
			if (unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 2) && !unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 3))
			{
				...
				{
					if (unk_0xB7A628320EFF8E47(Var0.f_6, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1)) < 81f)
					{
						sVar64 = "";
						...
						if (!unk_0x7BCC91F3C1CF24E8(sVar64))
						{
...
int func_112(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			{
				iVar0 = unk_0x36FE6D3220816ADA(func_113(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 1)));
				switch (iVar0)
				{
