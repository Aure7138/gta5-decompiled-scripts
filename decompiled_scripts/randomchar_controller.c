				...
				if (!func_43(74))
				{
					...
					else if (func_23(iLocal_96))
					{
						...
						while (iVar1 <= 262)
						{
							...
							{
								if (unk_0xE4EDC4B0E92C078B(Global_31146[iVar34 /*23*/].f_19))
								{
									unk_0xF412DD40DE84CE72(Global_31146[iVar34 /*23*/].f_19, 1);
									unk_0x0EC848EFF66DF45A(Global_31146[iVar34 /*23*/].f_19, 10000);
									switch (func_9())
									{
										case 1:
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_31(unk_0xEAE0D21A50E6C7F4(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (!func_82(iVar0) || iVar0 == 52)
	{
		if (!unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569.f_390[iLocal_52], iLocal_51))
		{
			...
			else if (Global_110725[iVar0 /*10*/].f_8 != -1)
			{
				...
				{
					if (unk_0xEAE0D21A50E6C7F4(Global_31146[iLocal_74[Global_110725[iVar0 /*10*/].f_8] /*23*/].f_11, 6))
					{
...
void func_83(int iParam0)
{
	...
	else if (Global_110725[iParam0 /*10*/].f_3)
	{
		...
		if (!func_120() && unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0), Var0.f_6, 0) > fVar61)
		{
			Global_110725[iParam0 /*10*/].f_3 = 0;
		}
		else
	...
	iVar62 = 0;
	if ((((iVar60 && !unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[iParam0 /*6*/], 3)) && unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[iParam0 /*6*/], 0)) && unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[iParam0 /*6*/], 1)) && unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[iParam0 /*6*/], 2))
	{
	...
	if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
	{
		if (!func_45(35))
		{
			if (unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[iParam0 /*6*/], 2) && !unk_0xEAE0D21A50E6C7F4(Global_111638.f_18569[iParam0 /*6*/], 3))
			{
				...
				{
					if (unk_0xB7A628320EFF8E47(Var0.f_6, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1)) < 81f)
					{
						sVar64 = "";
