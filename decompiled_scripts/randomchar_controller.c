				...
				if (!func_42(74))
				{
					...
					else if (func_22(iLocal_96))
					{
						...
						while (iVar1 <= 262)
						{
							...
							{
								if (unk_0xA3794949321E107C(Global_25501[iVar34 /*23*/].f_19))
								{
									unk_0x76C0584E1FF9B958(Global_25501[iVar34 /*23*/].f_19, 1);
									unk_0x9DD4955F28C1A885(Global_25501[iVar34 /*23*/].f_19, 10000);
									switch (func_9())
									{
										case 1:
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_30(unk_0x48B8265059381CD0(iParam0, 31), -1, 1)) + 2011;
}
...
int func_41()
{
	...
	func_40(&uVar0, unk_0x0956E4296D9CC40A());
	func_39(&uVar0, unk_0x32883EAC7DC86C40());
	func_38(&uVar0, unk_0x80BC37C67CB292E5());
	func_36(&uVar0, unk_0x202B089E6328ABFA());
	func_37(&uVar0, unk_0xCD8338A83E1BCC14());
	func_35(&uVar0, unk_0x1BBFD9409EC2598C());
	return uVar0;
}
...
void func_45()
{
	if (!func_44(39))
	{
		if (unk_0x48B8265059381CD0(Global_101700.f_17533[27 /*6*/], 3))
		{
...
void func_48()
{
	if (unk_0xCF7855B965948E97(unk_0xBE369BE1BC57A796()))
	{
		if (!func_44(55))
		{
			if ((func_52(5) && func_50(unk_0x17B5CC8A8615737D(), func_51(5), 1) < func_49(5)) || (func_52(6) && func_50(unk_0x17B5CC8A8615737D(), func_51(6), 1) < func_49(6)))
			{
...
void func_53()
{
	if (func_69())
	{
		if (!func_42(114))
		{
			if (unk_0x48B8265059381CD0(Global_101700.f_17533[46 /*6*/], 3))
			{
		...
		{
			if (unk_0x48B8265059381CD0(Global_101700.f_17533[51 /*6*/], 3))
			{
...
void func_60(int iParam0)
{
	...
	while (iVar15 < Global_101700.f_6647.f_198)
	{
		...
		{
			func_61(Global_101700.f_6647.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
void func_70()
{
	...
	{
		if (!unk_0x48B8265059381CD0(Global_101700.f_17533.f_390[iLocal_52], iLocal_51))
		{
			func_17(iVar0, &Var1);
			if (iVar0 == 58)
			{
				unk_0xEB79FECD9022AAF0(&(Global_101700.f_17533.f_390[iLocal_52]), iLocal_51);
			}
			else if (unk_0x33FE10504886A9BA(Var1.f_6))
			{
				unk_0xEB79FECD9022AAF0(&(Global_101700.f_17533.f_390[iLocal_52]), iLocal_51);
			}
			else if (Global_100787[iVar0 /*10*/].f_8 != -1)
			{
				...
				{
					if (unk_0x48B8265059381CD0(Global_25501[iLocal_74[Global_100787[iVar0 /*10*/].f_8] /*23*/].f_11, 6))
					{
...
void func_77(int iParam0)
{
	...
	if (!unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 1))
	{
		if (!Var0.f_23)
		{
			unk_0xEB79FECD9022AAF0(&(Global_101700.f_17533[iParam0 /*6*/]), 1);
		}
	}
	if (unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 0) && !unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 3))
	{
		if (!Global_101700.f_17533[iParam0 /*6*/].f_1)
		{
			...
			if (iParam0 == 57)
			{
				iVar33 = unk_0x0E29C61F26D96FDB(3, 11);
				iVar33 *= 30;
				func_33(&uVar32, 0, 0, iVar33, 0, 0, 0);
			}
			Global_101700.f_17533[iParam0 /*6*/].f_2 = uVar32;
		...
		if (unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 1))
		{
			if (!unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 2))
			{
				...
				if (Var0.f_15 > 0 && bVar34)
				{
					...
					{
						func_116(Global_101700.f_17533[iParam0 /*6*/].f_2, &uVar35, &uVar36, &uVar37, &iVar38, &iVar39, &iVar40);
				...
				if (bVar34)
				{
					unk_0xEB79FECD9022AAF0(&(Global_101700.f_17533[iParam0 /*6*/]), 2);
					...
					if (iParam0 == 35)
					{
						...
						unk_0x6E6FC548ABB12D5F("launcher_MrsPhilips");
					}
					else if (iParam0 == 58)
					{
						Global_100787[iParam0 /*10*/].f_3 = 0;
						unk_0x6E6FC548ABB12D5F("launcher_Tonya");
					}
					else
					{
	...
	if (unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 2) && !unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 3))
	{
		bVar59 = true;
		if (func_122(iParam0))
		{
		...
		if (!bVar59)
		{
			unk_0x21E7933CCC7B3724(&(Global_101700.f_17533[iParam0 /*6*/]), 2);
		}
	}
	iVar60 = 1;
	...
	else if (Global_100787[iParam0 /*10*/].f_3)
	{
		...
		if (!func_114() && unk_0x3DC4639D5F23DEA2(unk_0x57240623C1BC6E88(unk_0x17B5CC8A8615737D(), 0), Var0.f_6, 0) > fVar61)
		{
			Global_100787[iParam0 /*10*/].f_3 = 0;
		}
		else
	...
	iVar62 = 0;
	if ((((iVar60 && !unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 3)) && unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 0)) && unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 1)) && unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 2))
	{
	...
	if (!unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 4))
	{
		if (unk_0x765F5B806B517045(&(Var0.f_10)) == unk_0x765F5B806B517045(""))
		{
			unk_0xEB79FECD9022AAF0(&(Global_101700.f_17533[iParam0 /*6*/]), 4);
		}
		else if (iVar62 == 2)
		{
			if (func_88(Var0.f_26, func_9()))
			{
				if (!func_83() && !unk_0xE9E6B5364105A000())
				{
	...
	if (unk_0xCF7855B965948E97(unk_0xBE369BE1BC57A796()))
	{
		if (!func_44(35))
		{
			if (unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 2) && !unk_0x48B8265059381CD0(Global_101700.f_17533[iParam0 /*6*/], 3))
			{
				if (((((!func_88(Var0.f_26, func_9()) && !func_97(iParam0)) && !func_76(iParam0)) && !func_80(iParam0)) && !func_79(iParam0)) && !Global_100787[iParam0 /*10*/].f_3)
				{
					if (unk_0xB7A628320EFF8E47(Var0.f_6, unk_0x57240623C1BC6E88(unk_0x17B5CC8A8615737D(), 1)) < 81f)
					{
						sVar64 = "";
						if (unk_0x48B8265059381CD0(Var0.f_26, 1))
						{
							sVar64 = "TRIG_RC_F";
						}
						else if (unk_0x48B8265059381CD0(Var0.f_26, 0))
						{
							sVar64 = "TRIG_RC_M";
						}
						else
						...
						if (!unk_0x9C88EB7B70229335(sVar64))
						{
...
int func_79(int iParam0)
{
	if (iParam0 == 2)
	{
		if (unk_0x48B8265059381CD0(Global_101700.f_17533[3 /*6*/], 3) && Global_100787[3 /*10*/].f_3 == 1)
		{
			return 1;
		}
	}
	...
	{
		if (unk_0x48B8265059381CD0(Global_101700.f_17533[2 /*6*/], 3) && Global_100787[2 /*10*/].f_3 == 1)
		{
			return 1;
		}
	}
...
int func_80(int iParam0)
{
	...
	{
		if (unk_0x48B8265059381CD0(Global_101700.f_17533[2 /*6*/], 0) && unk_0x48B8265059381CD0(Global_101700.f_17533[3 /*6*/], 0))
		{
...
int func_82(int iParam0)
{
	...
	bVar1 = unk_0x48B8265059381CD0(Global_25501[iVar0 /*23*/].f_11, 0);
	bVar2 = unk_0x48B8265059381CD0(Global_25501[iVar0 /*23*/].f_11, 15);
	if (bVar1 && bVar2)
	{
		return 1;
	}
...
void func_84(int iParam0, int iParam1)
{
	...
	{
		case 1:
			Global_25501[iVar0 /*23*/].f_12[0] = 40;
			break;
		
		case 3:
			Global_25501[iVar0 /*23*/].f_12[0] = 60;
			break;
	}
	unk_0xEB79FECD9022AAF0(&(Global_25501[iVar0 /*23*/].f_11), 18);
	if (Global_25498 == 1)
...
void func_87(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if (bParam1)
	{
		if (!bParam3)
		{
			...
			if (bParam1 != unk_0x48B8265059381CD0(Global_25501[iVar0 /*23*/].f_11, 8))
			{
				unk_0xEB79FECD9022AAF0(&(Global_25501[iVar0 /*23*/].f_11), 18);
			}
			unk_0xEB79FECD9022AAF0(&(Global_25501[iVar0 /*23*/].f_11), 8);
		}
		else
		{
			Global_25501[iVar0 /*23*/].f_18 = iParam2;
			if (bParam1 != unk_0x48B8265059381CD0(Global_25501[iVar0 /*23*/].f_11, 10))
			{
				unk_0xEB79FECD9022AAF0(&(Global_25501[iVar0 /*23*/].f_11), 18);
			}
			unk_0xEB79FECD9022AAF0(&(Global_25501[iVar0 /*23*/].f_11), 10);
		}
		unk_0xEB79FECD9022AAF0(&(Global_25501[iVar0 /*23*/].f_11), 18);
	}
	else
...
int func_88(int iParam0, int iParam1)
{
	switch (iParam1)
	{
		...
		case 1:
		case 2:
			return unk_0x48B8265059381CD0(iParam0, iParam1);
...
void func_89(int iParam0)
{
	...
	if (unk_0x48B8265059381CD0(Global_25501[iVar0 /*23*/].f_11, 8) || unk_0x48B8265059381CD0(Global_25501[iVar0 /*23*/].f_11, 10))
	{
		unk_0xEB79FECD9022AAF0(&(Global_25501[iVar0 /*23*/].f_11), 18);
	}
	unk_0x21E7933CCC7B3724(&(Global_25501[iVar0 /*23*/].f_11), 8);
	unk_0x21E7933CCC7B3724(&(Global_25501[iVar0 /*23*/].f_11), 10);
	unk_0xEB79FECD9022AAF0(&(Global_25501[iVar0 /*23*/].f_11), 18);
}
...
void func_90(int iParam0, int iParam1)
{
	...
	{
		if ((unk_0x48B8265059381CD0(Global_101700.f_17533[2 /*6*/], 3) || unk_0x48B8265059381CD0(Global_101700.f_17533[3 /*6*/], 3)) || unk_0x48B8265059381CD0(Global_101700.f_17533[4 /*6*/], 3))
		{
...
void func_92(int iParam0, int iParam1)
{
	...
	unk_0x847FC56255B9284E(&(Global_25501[iVar0 /*23*/].f_11), 21, 26, iParam1);
	if (Global_25498 == 1)
	{
		Global_25499 = 1;
	}
...
void func_94(int iParam0, var uParam1)
{
	...
	Global_25498 = 1;
	Global_25501[iVar0 /*23*/].f_10 = uParam1;
	Global_31551 = 1;
	unk_0xEB79FECD9022AAF0(&(Global_25501[iVar0 /*23*/].f_11), 18);
}
...
void func_96(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		unk_0xEB79FECD9022AAF0(&(Global_25501[iVar0 /*23*/].f_11), 28);
	}
	else
	{
		unk_0x21E7933CCC7B3724(&(Global_25501[iVar0 /*23*/].f_11), 28);
	}
	if (Global_25498 == 1)
	{
		Global_25499 = 1;
...
int func_106(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!unk_0xCA41A00932714525(unk_0x17B5CC8A8615737D()))
		{
			...
			{
				iVar0 = unk_0x0324EEB10F81965F(func_107(unk_0x60604E51E30D25B8(unk_0x17B5CC8A8615737D(), 1)));
				switch (iVar0)
				{
...
void func_108(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_109(iParam0) && unk_0x82F1A060D8F4583B(Global_82612[26 /*34*/].f_6) == 0)
			{
				Global_101700.f_6220[iParam0] = 1;
				unk_0x01C5575F2350FF9E(uParam1->f_5, Global_101700.f_6220[iParam0], 1, 1);
			}
...
void func_129(int iParam0, int iParam1)
{
	...
	unk_0xEB79FECD9022AAF0(&(Global_25501[iVar0 /*23*/].f_11), 16);
