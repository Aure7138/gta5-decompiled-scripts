...
void __EntryFunction__()
{
	...
	if (func_437(Local_86.f_28[0]))
	{
		...
		unk_0x4F3C4F457D44BB0F(iLocal_156, 1, 1);
	}
	func_436();
	if (func_447())
	{
	...
	{
		unk_0x4EDE34FBADD967A6(0);
		unk_0xAEF7C45DAFB8E9B0("SF_Dreyfuss", 0);
...
void func_2(var uParam0)
{
	if (unk_0xAE06B9E39EBDE049(*uParam0))
	{
		...
		if (func_3(*uParam0))
		{
			...
			{
				if (func_437(unk_0x9B0761B4C3EB8BC7()))
				{
...
{
	if (unk_0xCE990E643CD9D0E5(Global_98955.f_20, 17))
	{
		return 0;
	}
...
int func_228()
{
	...
	if (unk_0x460153A63B9477BC() == func_231())
	{
		return 0;
	}
	if (func_229(unk_0x460153A63B9477BC()))
	{
		return 0;
	}
...
void func_246()
{
	switch (iLocal_155)
	{
		case 0:
			...
			if (unk_0x8F678487EEBD8CE4(iLocal_157))
			{
				unk_0xFA81E0FBD7F5ACA0(iLocal_157, 0.7f);
			}
			if (func_437(iLocal_156))
			{
				unk_0x9DC06E2A59C5AEBB(&uLocal_160);
				if (unk_0x47DBF174A0CB9D55(iLocal_156, 0))
				{
					unk_0x0AB756271BADC8DF(0, 0, 0);
				}
				unk_0x8B18A80E8EB15510(0, unk_0x9B0761B4C3EB8BC7(), 500f, -1, 0, 0);
				unk_0x19F29730874AD6F1(uLocal_160);
				unk_0x9B6EC2CECE1010EF(iLocal_156, uLocal_160);
				unk_0x4F83FEE4454169D4(&uLocal_160);
			}
			func_243();
			iLocal_537 = 0;
			iLocal_155 = 1;
		...
		case 1:
			...
			if (!func_437(iLocal_156))
			{
				...
				if (!unk_0xCE990E643CD9D0E5(Global_111858.f_18570.f_382, 0))
				{
					unk_0xBE20AB8238688965(&(Global_111858.f_18570.f_382), 0);
				}
				func_295(4);
			}
			else if (func_293(unk_0x9B0761B4C3EB8BC7(), iLocal_156) > 250f)
			{
				unk_0xBE1CA603598C1441(6f, 2f, 4);
				func_295(4);
			}
			else
			{
				...
				func_247();
				unk_0x480671405D16FA0B(iLocal_156, 1.8f);
			}
			break;
...
void func_247()
{
	if (!bLocal_507)
	{
		if (func_259(unk_0x9B0761B4C3EB8BC7(), iLocal_156, fLocal_334, 1))
		{
			if (unk_0xC0736D5851285045(iLocal_156))
			{
...
void func_248(int iParam0, int iParam1, int iParam2, var uParam3, char* sParam4, char* sParam5, bool bParam6)
{
	...
	if (!*uParam3)
	{
		if (!iLocal_537)
		{
			if (!*iParam0)
			{
				if ((func_249(iLocal_156) && !unk_0xCED6B5226244381C(iLocal_156)) && !unk_0x4FCA2ADE072802D1(iLocal_156))
				{
					if (func_259(unk_0x9B0761B4C3EB8BC7(), iLocal_156, fLocal_334, 1))
					{
						if (!func_242())
	...
	else if ((bParam6 && !iLocal_548 == 0) && !func_242())
	{
		...
		if (iLocal_548 == 1 && unk_0xAE06B9E39EBDE049(iLocal_156))
		{
			unk_0xBB7976F6FB9C9DD2(iLocal_156);
		}
		iLocal_548 = 0;
	}
}
...
int func_250(int iParam0)
{
	if (iLocal_548 == 0)
	{
		...
		else if (unk_0xCDF860E56BBCC6B4(iLocal_156, unk_0x9B0761B4C3EB8BC7(), iParam0) && iLocal_519 < 4)
		{
			func_243();
			iLocal_548 = 1;
		}
...
int func_251(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_437(unk_0x9B0761B4C3EB8BC7()) && func_437(iParam0))
	{
...
int func_254(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_256(Param1 - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
	...
	{
		Var3 = { func_256(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_259(int iParam0, int iParam1, float fParam2, int iParam3)
{
...
void func_260(int iParam0, char* sParam1, char* sParam2, var uParam3, int iParam4, int iParam5)
{
	if (unk_0x8F678487EEBD8CE4(*iParam0))
	{
		if ((unk_0x578C4EF320340AF7() - *uParam3) > 500)
		{
			if (unk_0xB5E6347DF3BDF00E(*iParam0) == 1)
			{
				unk_0xECC9A00CF1181EC2(*iParam0, 3);
				unk_0xB023F5C66F5716C7(*iParam0, "BLIP_FRIEND");
				if ((unk_0x578C4EF320340AF7() - iParam4) < 7500 && iParam5)
				{
					if (!unk_0x2F80DB5A41D045E6() || func_262(sParam1, 0, 0))
					{
			...
			else
			{
				...
				unk_0xB023F5C66F5716C7(*iParam0, "BLIP_ENEMY");
				if ((unk_0x578C4EF320340AF7() - iParam4) < 7500 && iParam5)
				{
					if (!unk_0x2F80DB5A41D045E6() || func_262(sParam2, 0, 0))
					{
...
void func_266(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_291(iParam1) && unk_0xDC79F755CB11603C(iParam1))
	{
		iVar1 = 0;
...
{
	if (func_291(unk_0x9B0761B4C3EB8BC7()))
	{
...
int func_272(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_279() || func_278(Global_4456448.f_129348)) || func_277())
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			iVar1 = func_276(unk_0x9B0761B4C3EB8BC7(), 0);
			if (((unk_0x09F8284D2E03269D(iVar0, iVar1) || (unk_0x36FE6D3220816ADA(iVar0) == joaat("apc") && iVar1 != -1)) || (unk_0x36FE6D3220816ADA(iVar0) == joaat("akula") && iVar1 != -1)) || (((unk_0x36FE6D3220816ADA(iVar0) == joaat("riot2") && iVar1 == 0) && func_275(iVar0, 10)) && unk_0x7F8B14CBFB9813E5(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_273(int iParam0)
{
	if (iParam0 != func_231())
	{
		...
		else if ((Global_1312896 && iParam0 == unk_0x460153A63B9477BC()) && func_274(iParam0, 1, 0))
		{
			return Global_2426097[iParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
bool func_283()
{
	return func_284(unk_0x460153A63B9477BC());
}
...
int func_286(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_289(bParam1, bParam2, bParam3) || unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((unk_0x578C4EF320340AF7() - uParam0->f_4) > 500)
			{
				...
				{
					if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 1) || func_287(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_297()
{
	if (func_437(iLocal_156))
	{
		if (unk_0x37BCA35686C6B213(iLocal_156, joaat("weapon_stungun"), 0))
		{
			if (func_437(iLocal_156))
			{
				unk_0x697DA7132EE43ABC(iLocal_156, 99, 0);
			}
		}
	}
}
...
void func_298()
{
	...
	{
		case 0:
			unk_0x27E543EDE9AEA8F2(Local_147, Local_147.f_3, 1, 1);
			...
			if (func_437(Local_86.f_35[0]))
			{
				...
				while (iVar0 < 3)
				{
					Local_526[iVar0 /*3*/] = { unk_0x3E4D3CCC220BDFB1(Local_86.f_35[0], 1) };
					iVar0++;
				}
			}
			iLocal_536 = unk_0x578C4EF320340AF7();
			iLocal_333 = 0;
			iLocal_537 = 0;
			iLocal_155 = 1;
			break;
		...
		case 1:
			...
			else
			{
				if (func_437(Local_86.f_35[0]))
				{
					if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) && unk_0xA65352E7FEA59881(Local_86.f_35[0], unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0)))
					{
					...
					if (((!iLocal_332 && !iLocal_333) && unk_0x6E0C5E7AAF8B6214(iLocal_156)) && !unk_0xC2169C00B643278B(Local_86.f_35[0], -1474.445f, 519.4703f, 117.0069f, 15f, 15f, 15f, 0, 1, 0))
					{
						unk_0xBD204892D76E6303(iLocal_156, Local_86.f_35[0], unk_0x9B0761B4C3EB8BC7(), 8, 90f, 786469, 100f, 1f, 1);
						iLocal_333 = 1;
					}
				}
				func_250(0);
				func_263(&uLocal_549, iLocal_156, 0, 0, 1, 1, 1);
				if (((!iLocal_332 && func_259(unk_0x9B0761B4C3EB8BC7(), iLocal_156, 10f, 1)) && unk_0x6E0C5E7AAF8B6214(unk_0x9B0761B4C3EB8BC7())) && unk_0x6E0C5E7AAF8B6214(iLocal_156))
				{
					unk_0xBD204892D76E6303(iLocal_156, Local_86.f_35[0], unk_0x9B0761B4C3EB8BC7(), 8, 90f, 786468, 100f, 1f, 1);
					iLocal_332 = 1;
				}
				if (!func_304())
				{
...
void func_299()
{
	if (func_437(Local_86.f_35[0]))
	{
		...
		else if (unk_0xC0736D5851285045(iLocal_156) || !func_3(Local_86.f_35[0]))
		{
			iLocal_332 = 1;
			func_295(3);
		}
...
int func_300()
{
	if (func_437(Local_86.f_35[0]))
	{
		if (unk_0xE0B3BC41DDA88DF0(iLocal_156, Local_86.f_35[0], 0))
		{
			if ((unk_0x578C4EF320340AF7() - iLocal_536) > 3000)
			{
				func_302();
...
void func_302()
{
	...
	Local_526[2 /*3*/] = { unk_0x3E4D3CCC220BDFB1(Local_86.f_35[0], 1) };
}
...
int func_303()
{
	...
	{
		iVar0 = 0;
		if (unk_0x5C87AA49B5DF6712(Local_86.f_35[0], 0, 0))
		{
			iVar0++;
		}
		if (unk_0x5C87AA49B5DF6712(Local_86.f_35[0], 1, 0))
		{
			iVar0++;
		}
		if (unk_0x5C87AA49B5DF6712(Local_86.f_35[0], 4, 0))
		{
			iVar0++;
		}
		if (unk_0x5C87AA49B5DF6712(Local_86.f_35[0], 5, 0))
		{
			iVar0++;
		}
		if (iVar0 > 1)
...
int func_304()
{
	if (func_249(unk_0x9B0761B4C3EB8BC7()))
	{
		if (unk_0xAE06B9E39EBDE049(Local_86.f_35[0]))
		{
			if (func_437(Local_86.f_35[0]))
			{
...
int func_305(int iParam0)
{
	...
	iVar0 = unk_0xC2E2CC6CF95AF8A3(unk_0x3E4D3CCC220BDFB1(Local_86.f_35[0], 1), 20f, iParam0, 6);
	if (unk_0xAE06B9E39EBDE049(iVar0))
	{
		if (unk_0xBA9474B1995C6AAD(iVar0, Local_86.f_35[0]))
		{
...
void func_306()
{
	switch (iLocal_155)
	{
		case 0:
			...
			{
				unk_0x5DC21979EC6C531F(Local_86.f_35[0], 1);
				unk_0xC160551F55D6365A(Local_86.f_35[0], 1, 1, 0);
				unk_0xFF90B7B5F1AF504A(Local_86.f_35[0], 0, 0, 0);
			}
			if (func_437(iLocal_156))
			{
				unk_0x675CCBC7D80F079E(iLocal_156, 3f);
				if (!unk_0x8F678487EEBD8CE4(iLocal_157))
				{
				...
				if (func_3(Local_86.f_35[0]))
				{
					...
					unk_0x3C1B180EE30D36EF(0, -1472.27f, 513.9628f, 116.898f, 3f, 20000, 0.25f, 1, 1193033728);
					unk_0xC584E49FC3559A86(0, Local_86.f_35[0], 20000, -1, 3f, 1, 0);
					unk_0xD8C1C38EE8BC2AC6(0, Local_86.f_35[0], 15f, 262144);
					unk_0x19F29730874AD6F1(uLocal_159);
					unk_0x9B6EC2CECE1010EF(iLocal_156, uLocal_159);
					uLocal_330 = unk_0xE00203D68987D23E(unk_0x3E4D3CCC220BDFB1(Local_86.f_35[0], 1), 100f, 10f, 0);
				}
				else
				{
					unk_0x8B18A80E8EB15510(iLocal_156, unk_0x9B0761B4C3EB8BC7(), 500f, -1, 0, 0);
				}
			}
			if (!unk_0xAE06B9E39EBDE049(iLocal_161))
			{
				unk_0x78FCB2E22C41B9D5(iLocal_162);
				while (!unk_0x7D167B9A0CCDA347(iLocal_162))
				{
					unk_0x4EDE34FBADD967A6(0);
				}
				iLocal_161 = unk_0xCE4780E24AFDFBF9(iLocal_162, -1482.366f, 529.0344f, 117.2725f, 201.5764f, 1, 1, 0);
				unk_0x74528AC0906CBABE(iLocal_162);
			}
			func_311(500, 0);
			iLocal_158 = unk_0x578C4EF320340AF7();
			iLocal_563 = 0;
			iLocal_155 = 1;
			break;
		
		case 1:
			if (iLocal_563 == 0 && unk_0x87F0CB19476706C3())
			{
			...
			else
			{
				...
				if (iLocal_331)
				{
					if (func_437(iLocal_156))
					{
						if ((unk_0x578C4EF320340AF7() - iLocal_158) > 3000)
						{
							unk_0x675CCBC7D80F079E(iLocal_156, 3f);
						}
						else
				...
				if ((func_307(242628503) && unk_0x18B8D57C51EEB5CC(iLocal_156) > 0) && func_303())
				{
					func_295(3);
				}
			}
...
{
	if (unk_0x16BC17A8EDC701A2(iLocal_156, iParam0) == 1 || unk_0x16BC17A8EDC701A2(iLocal_156, iParam0) == 0)
	{
		return 1;
	}
	return 0;
...
int func_308()
{
	if (unk_0xAE06B9E39EBDE049(Local_86.f_35[0]))
	{
		...
		{
			if (unk_0x18B8D57C51EEB5CC(iLocal_156) > 0)
			{
				if (!unk_0xC2169C00B643278B(Local_86.f_35[0], Local_82, 20f, 20f, 100f, 0, 1, 0))
				{
					sLocal_423 = "DREY1_CGONE";
					iLocal_332 = 1;
					func_295(3);
				...
				else if (!unk_0xC2169C00B643278B(Local_86.f_35[0], Local_82, 5f, 5f, 100f, 0, 1, 0))
				{
...
int func_309(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_256(unk_0x3E4D3CCC220BDFB1(iParam1, 1) - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
...
void func_310()
{
	...
	{
		if (unk_0xACBCFA3095C5A434(iLocal_156, Local_86.f_35[0]))
		{
			if (unk_0x8F678487EEBD8CE4(iLocal_157))
			{
				unk_0xFA81E0FBD7F5ACA0(iLocal_157, 1f);
			}
			iLocal_155 = 2;
		}
	}
...
void func_312(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	if (unk_0x8F678487EEBD8CE4(*uParam0))
	{
		...
		*uParam3 = unk_0x578C4EF320340AF7();
		*uParam4 = unk_0x578C4EF320340AF7();
	}
}

int func_313(var uParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
int func_314()
{
	if (unk_0x8865B8E834909D76(-1482.992f, 523.4556f, 117.9981f, 15f, joaat("prop_lrggate_01_l"), 0) && unk_0x8865B8E834909D76(-1477.865f, 525.6363f, 118.0456f, 15f, joaat("prop_lrggate_01_r"), 0))
	{
		unk_0x2D4BE3F34B14D5F0(joaat("prop_lrggate_01_l"), -1482.992f, 523.4556f, 117.9981f, 1, 0f, 0);
		unk_0x2D4BE3F34B14D5F0(joaat("prop_lrggate_01_r"), -1477.865f, 525.6363f, 118.0456f, 1, 0f, 0);
		unk_0x2D4BE3F34B14D5F0(joaat("prop_lrggate_01_l"), -1482.992f, 523.4556f, 117.9981f, 1, 1f, 0);
		unk_0x2D4BE3F34B14D5F0(joaat("prop_lrggate_01_r"), -1477.865f, 525.6363f, 118.0456f, 1, -1f, 0);
		return 1;
	}
	return 0;
}
...
void func_316()
{
	switch (iLocal_155)
	{
		case 0:
			...
			if (((unk_0x87F0CB19476706C3() && !func_447()) && func_437(iLocal_156)) && func_294(unk_0x9B0761B4C3EB8BC7(), Local_86.f_28[0], 1) > 4f)
			{
				unk_0xF1B800B6646C4019(iLocal_156, 0f, 0f, -0.5f, 1, -1, 3000, 2000, 0);
				unk_0x8AA2C5E3C6438257(0.3f);
				unk_0xE2AA8012BC8A9464(-0.01f);
				unk_0x89F30480E0C49A16(35f);
			...
			iLocal_565 = unk_0x5BBA0055476D633A(-1459.57f, 485.16f, 115.2f, 10f, joaat("prop_yoga_mat_02"), 1, 0, 1);
			if (unk_0xAE06B9E39EBDE049(iLocal_565))
			{
				unk_0x6A8F948698B360B4(iLocal_565, 1);
			}
			iLocal_155 = 1;
			iLocal_564 = 0;
			break;
			...
			switch (iLocal_562)
			{
				case 0:
					if (func_437(unk_0x9B0761B4C3EB8BC7()))
					{
						...
						{
							unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), iLocal_156, -1, 0, 2);
							iLocal_562++;
						}
					}
					break;
				...
				case 1:
					if (func_437(unk_0x9B0761B4C3EB8BC7()))
					{
						...
						if (!func_242() && func_387(1, 1093140480, 0))
						{
							if (func_437(iLocal_156))
							{
								unk_0xFA3AB7AE2A01375E(iLocal_156, sLocal_164, 0, 0, 0);
							}
							func_386();
				...
				case 2:
					if (unk_0x3EBB66F936A3436E())
					{
						...
						unk_0xCFF81C0C8D63E62E(-1477f, 496.8f, 117.4f, 30f);
						unk_0xF27E737981AFB47D(-1473.376f, 517.8441f, 116.8854f, 30f, 0, 0, 0, 0, 0, 0);
						func_311(500, 0);
						iLocal_562++;
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						if (unk_0x10447A1CD8175FC0("Dreyfuss", 0) && func_437(iLocal_156))
						{
							unk_0x3C1B180EE30D36EF(iLocal_156, -1475.366f, 500.3797f, 116.6013f, 3f, 20000, 0.25f, 1, 1193033728);
						}
					}
					break;
			}
...
void func_318(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (unk_0x25DDB354A40FFCDB())
		{
			if (((((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_322(unk_0x460153A63B9477BC())) && !func_320(unk_0x460153A63B9477BC(), 0)) && !func_319()) && !bParam4) && !bParam5)
			{
				unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), 0);
			}
		}
		else if (((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_322(unk_0x460153A63B9477BC())) && !bParam4) && !bParam5)
		{
			unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), 0);
		}
		Global_76831 = 0;
...
int func_324(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_326(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0x5A228A6A51E757C8(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x773B9DEB93E81B2F(func_327(unk_0x2639A2323BEA8CC6()), 50f, 0);
		}
		if (iParam7 == 1)
		{
	...
	if (unk_0xAE06B9E39EBDE049(Global_102423.f_4))
	{
		if (unk_0x80FF6C016CDB0FAF(Global_102423.f_4, 0))
		{
			if (func_376(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_373(unk_0x3E4D3CCC220BDFB1(Global_102423.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_330(Global_102423.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_330(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (unk_0xAE06B9E39EBDE049(iParam0) && unk_0x80FF6C016CDB0FAF(iParam0, 0))
	{
		...
		func_364(iParam5, &Var0, Param1, uParam4, func_367(iParam0));
...
{
	if ((((((((((!unk_0xAE06B9E39EBDE049(iParam0) || !unk_0x80FF6C016CDB0FAF(iParam0, 0)) || func_348(iParam0, 0, 0)) || func_348(iParam0, 1, 0)) || func_348(iParam0, 2, 0)) || func_367(iParam0) != 145) || func_347(iParam0)) || func_346(iParam0)) || func_345(iParam0)) || func_344(iParam0)) || !func_334(unk_0x36FE6D3220816ADA(iParam0)))
	{
		if (func_346(iParam0))
		{
		}
...
var func_350()
{
	...
	func_360(&uVar0, unk_0x1D3A3697182AD8B3());
	func_359(&uVar0, unk_0x81F2E25F8C019191());
	func_358(&uVar0, unk_0x1F596C965B00E290());
	func_353(&uVar0, unk_0x371CFD525753F70C());
	func_352(&uVar0, unk_0xF225116F449A5CC6());
	func_351(&uVar0, unk_0x2E48CFA70ABFC06A());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_356(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_364(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6)
{
	if (func_361(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
	...
	if (unk_0x80FF6C016CDB0FAF(iParam0, 0))
	{
		...
		*uParam1 = unk_0x999BFF5D72C9701A(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xBE20AB8238688965(&(uParam1->f_77), func_369(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_378(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, var uParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
{
	return func_384(Global_102423.f_2890.f_12.f_66, Param0, iParam3);
}
...
int func_384(int iParam0, struct<3> Param1, int iParam4)
{
	...
	unk_0x140662B520844E45(iParam0, &Var0, &Var3);
...
int func_387(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_391(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_390(unk_0x9B0761B4C3EB8BC7(), -828834893))
				{
...
void func_393()
{
	...
	if (iLocal_564 == 0)
	{
		if (func_437(iLocal_156))
		{
			if (func_294(unk_0x9B0761B4C3EB8BC7(), iLocal_156, 1) < 3f)
			{
				iLocal_564 = 1;
				unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), false, 0);
				unk_0x9B94F6169B0DAEFD(unk_0x9B0761B4C3EB8BC7());
				unk_0xD08E9EAF091A1AAB(unk_0x9B0761B4C3EB8BC7(), iLocal_156, 0);
			}
		}
	}
}
...
void func_395()
{
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_391(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_416(0) || Global_77102) || Global_77091 == 1) || !unk_0x87F0CB19476706C3())
	{
		return 0;
	}
	switch (Global_77087)
	{
		...
		case 5:
			if ((unk_0x3EBB66F936A3436E() || func_281(0)) || func_415(1))
			{
			}
			else
			{
...
void func_419(int iParam0)
{
	...
	unk_0x555EE41D7C7078E6(-1462.177f, 485.6856f, 115.2016f, 200f, 1, 0, 0, 0);
	if (!func_430())
	{
		unk_0x2BB0EF9DE445EA13(unk_0x9B0761B4C3EB8BC7());
		func_429(unk_0x9B0761B4C3EB8BC7(), -1462.177f, 485.6856f, 115.2016f, 97.1913f, 0, 1);
	}
	func_2(&iLocal_161);
	func_4(&iLocal_156);
	func_2(&(Local_86.f_35[0]));
	...
	if (!func_430())
	{
		func_422(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), 100f, 12, 5000, 0, 0);
	}
	func_421(0, -1, 1);
	if (iParam0 == 1)
	{
...
void func_424()
{
	if (!func_437(Local_86.f_35[0]))
	{
		unk_0x78FCB2E22C41B9D5(iLocal_163);
		while (!unk_0x7D167B9A0CCDA347(iLocal_163))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		Local_86.f_35[0] = unk_0xCE4780E24AFDFBF9(iLocal_163, Local_82, fLocal_85, 1, 1, 0);
		unk_0x74528AC0906CBABE(iLocal_163);
	}
	if (func_437(Local_86.f_35[0]))
	{
		unk_0x22BA2B3490860247(Local_86.f_35[0], 0);
		unk_0x29897D845D2C290B(Local_86.f_35[0], 1);
		unk_0xC29A9E1088D83B1B(Local_86.f_35[0], "DR3YFU55");
	}
}
...
void func_425()
{
	...
	if (func_437(iLocal_156))
	{
		...
		unk_0x694113444F21E39F(iLocal_156, 177, 1);
		unk_0x0DC39BE87E4C5599(iLocal_156, 1);
		unk_0x82FF25D1808866E5(iLocal_156, 1, 0);
		unk_0xA5EAD2ACE2C8BBB2(iLocal_156, 1, 1);
		unk_0xDE7C7B8F0806F931(iLocal_156, 0);
		unk_0x4E65320BC9AD521C(iLocal_156, 1);
		unk_0x694113444F21E39F(iLocal_156, 281, 1);
		unk_0x694113444F21E39F(iLocal_156, 42, 1);
	}
}
...
int func_429(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
void func_436()
{
	...
	unk_0x410A1E7AD7D5C774(iLocal_81, 1);
	func_432();
	unk_0xD2459066EA58CE43(&(Global_111858.f_18570.f_382), 0);
	unk_0xBAA4D421B8B8A744("DREY1", 0);
	func_426(&uLocal_165, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
	func_425();
	func_424();
}
...
{
	unk_0x27E543EDE9AEA8F2(-1594.9f, 457.8715f, -100f, -1366.784f, 635.579f, 900f, iParam0, 1);
	unk_0xAF7D4BF357E8B79E(-1473.517f, 508f, 115.601f, -1471.017f, 514.829f, 120f, iParam0, 1);
}

var func_439()
{
	return unk_0xC08A186299DFDA0A(-1495.496f, 519.4606f, 100.8889f, -1429.111f, 468.1972f, 120.9696f, 0, 1, 1, 1);
}
...
int func_440(var uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			{
				unk_0xA785552633ED203B(uParam0->f_28[0], unk_0x9B0761B4C3EB8BC7(), -1, 2096, 2);
			}
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_35[0]))
			{
				...
				if (func_437(uParam0->f_35[0]))
				{
					...
					unk_0xC29A9E1088D83B1B(uParam0->f_35[0], "DR3YFU55");
					unk_0x410A1E7AD7D5C774(iLocal_81, 1);
				}
			}
			if (bVar4)
		...
		case 3:
			...
			if (func_437(uParam0->f_28[0]))
			{
				unk_0x773B9DEB93E81B2F(unk_0x3E4D3CCC220BDFB1(uParam0->f_28[0], 1), 50f, 0);
			}
			unk_0xF27E737981AFB47D(-1471.166f, 510.6191f, 115.8419f, 4f, 0, 0, 0, 0, 0, 0);
			func_438(0);
			return 1;
			break;
	}
...
void func_441(var uParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_2(uParam0);
...
int func_442(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_427(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0xAE06B9E39EBDE049(*uParam0))
		{
			if (!unk_0xA59F96B50B97E63C(*uParam0, 0))
...
void func_448()
{
	...
	unk_0x1E337EE68290597A(uLocal_561, 0);
	unk_0x410A1E7AD7D5C774(iLocal_81, 0);
	func_190(99, 0, 1, 1, 0);
	func_401(&iLocal_565, 0);
...
void func_458(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (unk_0xAE06B9E39EBDE049(*uParam0))
	{
		if (!unk_0x5AEB5DDFFAD43CA5(*uParam0))
...
void func_459()
{
	...
	{
		unk_0xCBA6B2B569DCAFD8(iLocal_156, 1);
		unk_0xA5EAD2ACE2C8BBB2(iLocal_156, 0, 1);
	}
	func_458(&iLocal_156, 1, 0, 1);
	func_455(&iLocal_161);
	func_460();
	unk_0x27E543EDE9AEA8F2(Local_147, Local_147.f_3, 1, 1);
	unk_0x4D5DDC0BF2001F78(uLocal_330);
}
...
void func_464(bool bParam0)
{
	...
	if (!func_481())
	{
		...
		{
			func_168(iVar0, 1, 0);
			func_465(unk_0x6C5C6B207AA78253(), iVar0);
		}
		else
		{
			if (Global_110945[iVar0 /*10*/].f_9 == -1)
...
int func_466(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_472())
	{
		...
		{
			iVar33 = func_467(unk_0x6C5C6B207AA78253());
			if (iVar33 > -1)
			{
