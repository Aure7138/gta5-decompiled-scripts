...
int func_22(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		uVar0 = Global_2551832[iParam0 /*3*/][func_23(iParam1)];
			...
			case 3005:
				...
				if (func_327(unk_0x460153A63B9477BC()))
				{
					...
					if (func_325(iVar2))
					{
						...
						func_311(iVar3, 1);
						unk_0xBE20AB8238688965(&Global_1678138, iVar0);
					}
				}
				break;
...
void func_317(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	iVar1 = (iVar0 - unk_0x44F29CF6A0675F4F(unk_0x624736CA66E14161(unk_0x6CAAB7E78B5D978A(), Global_2515521[iParam1 /*2*/])));
	if (bParam2)
	{
