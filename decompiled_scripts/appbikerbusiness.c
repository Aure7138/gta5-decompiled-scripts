...
void __EntryFunction__()
{
	...
	iLocal_768 = -1;
	iLocal_769 = -1;
	if (unk_0x1BCDA92AD0A7835B(unk_0x36163153849DFDA1("appBikerBusiness")) > 1)
	{
		func_468(1);
	}
	uLocal_755 = unk_0x199B24FF79A52CCF("BIKER_BUSINESSES");
	while (!unk_0x11AE7F6A404414C9(uLocal_755))
	{
	...
	{
		iLocal_584 = func_458(unk_0x95B959F18401C09A());
	}
	else
	{
		func_449(unk_0x95B959F18401C09A(), 0, 0, 0);
	}
	func_431();
	if (unk_0x765F6FEEFF39224F(unk_0x33CD235DF1E6A94E()) && !unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0))
	{
		Local_567 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1) };
	}
	if (!func_428(7638, -1, -1))
	{
		func_425();
	}
	...
	if (iLocal_584 != 0)
	{
		iVar0 = func_423(iLocal_584);
		if (iVar0 != -1)
		{
			if (func_422(unk_0x95B959F18401C09A(), iLocal_584) == func_421(iLocal_584))
			{
				if (!unk_0x0E4018692D92041D(Global_1365075, iVar0))
				{
					func_420(iVar0, 1, 0);
					unk_0x8950ED5730F62EE8(&Global_1365075, iVar0);
				}
			}
			else
			{
				unk_0xCE689A8E8C42ED78(&Global_1365075, iVar0);
			}
		}
	}
	while (func_419())
	{
		if (unk_0x0E4018692D92041D(Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_23, 14) || func_418(unk_0x33CD235DF1E6A94E(), Local_567, 1) > 5f)
		{
			func_468(0);
		}
		...
		if (func_417(unk_0x95B959F18401C09A()) || ((!func_428(7638, -1, -1) && func_415(unk_0x95B959F18401C09A())) && func_397()))
		{
			func_396(7638, 1, -1, 1);
		}
		func_383();
		...
		if (iLocal_584 != 0)
		{
			iVar1 = func_423(iLocal_584);
			if ((iVar1 > -1 && iVar1 < 6) && iLocal_582 != Global_1365067[iVar1])
			{
				func_431();
			}
		}
		if (iLocal_585 == -1 && !Global_1671156)
		{
			func_11();
		}
		else if (iLocal_581 != 190)
		{
			if (!func_10(&uLocal_586))
			{
				func_9(&uLocal_586, 0, 0);
			}
			else if (func_8(&uLocal_586, 200, 0))
			{
				if (!Global_1671156)
				{
					func_3(unk_0x95B959F18401C09A(), iLocal_584, iLocal_585, 1);
					Global_1671156 = 1;
					func_468(0);
				}
				else if (!Global_1671295.f_2481)
				{
					func_1();
				}
			}
		}
		else if (!func_10(&uLocal_588))
		{
			func_9(&uLocal_588, 0, 0);
			unk_0x7EDEAEAED85BEE4F(800);
		}
		else if (!Global_1671295.f_2481)
		{
			if (unk_0x0E4018692D92041D(Global_1365042, 0))
			{
				func_1();
			}
			else if (func_8(&uLocal_588, 15000, 0))
			{
				func_1();
			}
		}
...
void func_3(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_7(unk_0x95B959F18401C09A(), iParam1))
	{
		iVar0 = func_4(unk_0x95B959F18401C09A(), iParam1);
		if (bParam3)
		{
			Global_1589819[iParam0 /*818*/].f_273.f_177[iVar0 /*12*/].f_10 = iParam2 + 1;
		}
		else
		{
			Global_1589819[iParam0 /*818*/].f_273.f_177[iVar0 /*12*/].f_10 = 0;
		}
	}
}
...
void func_11()
{
	...
	{
		unk_0xBB698266C5FDF0A7(uLocal_755, "GET_CURRENT_SELECTION");
		uLocal_756 = unk_0x614EE52A69097A4C();
		unk_0xBB698266C5FDF0A7(uLocal_755, "GET_SELECTED_BUSINESS_ID");
		uLocal_758 = unk_0x614EE52A69097A4C();
		unk_0xBB698266C5FDF0A7(uLocal_755, "GET_CURRENT_SCREEN_ID");
		uLocal_759 = unk_0x614EE52A69097A4C();
		iLocal_572 = 0;
		iLocal_571 = 0;
	}
	if ((unk_0x833B1A3D9F713E03(2, 202) || unk_0x833B1A3D9F713E03(2, 238)) && iLocal_572)
	{
		unk_0xBB698266C5FDF0A7(uLocal_755, "GET_CURRENT_SCREEN_ID");
		uLocal_759 = unk_0x614EE52A69097A4C();
		iLocal_572 = 0;
	}
	if (unk_0xBFCC17D9792F43AF(uLocal_759) && !iLocal_572)
	{
		iLocal_580 = unk_0x82D58DA03789627A(uLocal_759);
		iLocal_572 = 1;
	}
	if (iLocal_576 && !iLocal_577)
	{
		unk_0xBB698266C5FDF0A7(uLocal_755, "GET_CURRENT_ROLLOVER");
		uLocal_757 = unk_0x614EE52A69097A4C();
		iLocal_577 = 1;
	}
	if (iLocal_577)
	{
		if (unk_0xBFCC17D9792F43AF(uLocal_757))
		{
			iLocal_578 = unk_0x82D58DA03789627A(uLocal_757);
			iLocal_577 = 0;
		}
	}
	if (iLocal_578 == 3014 && func_381())
	{
		unk_0x37621D6689F9E3C3("OR_RSP_TUT");
		unk_0x092150016C06C431(0, 0, 1, 8000);
		iVar0 = func_378(9356, -1, -1) + 1;
		func_377(9356, iVar0, -1, 1);
		iLocal_575 = 1;
	}
	if (!iLocal_571)
	{
		if (unk_0xBFCC17D9792F43AF(uLocal_756) && unk_0xBFCC17D9792F43AF(uLocal_758))
		{
			iVar1 = unk_0x82D58DA03789627A(uLocal_756);
			iVar2 = unk_0x82D58DA03789627A(uLocal_758);
			iVar3 = -1;
			if (iLocal_584 != 0)
			{
				iVar3 = func_423(iLocal_584);
			}
			switch (iVar1)
			{
				case 101:
				...
				case 102:
					func_215(0, iVar2);
					unk_0x0F8EAEEC97DDBCB3(-1, "Click_Cancel", "DLC_Biker_Computer_Sounds", 1);
					break;
				
				case 2001:
					func_191(iVar2, iVar1);
					break;
				
				case 3001:
					if (Global_1365067[iVar3] >= Global_262145.f_17791)
					{
						func_190(0, "OR_MIS_NA_B", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (func_189(iVar3))
					{
						func_190(0, "OR_MIS_NA_C", "OR_OVRLY_OK", "", -1, 1);
					}
					break;
				
				case 3002:
					if (Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar3 /*12*/].f_4 <= 0)
					{
						func_190(0, "OR_UPGR_NS", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (func_178(iLocal_584) == 2)
					{
						func_190(0, "OR_UPGR_RES", "OR_OVRLY_OK", "", -1, 1);
					}
					break;
				
				case 3003:
					if (func_177(unk_0x95B959F18401C09A()))
					{
						func_190(0, "BKR_TF_R3", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (!func_175(192))
					{
						if (func_174(unk_0x95B959F18401C09A()) && !func_177(unk_0x95B959F18401C09A()))
						{
							iVar4 = func_31(unk_0x95B959F18401C09A(), 192, 0);
						}
						if (iVar4 == 15)
						{
							func_190(0, "GENERAL_MLF_G1", "OR_OVRLY_OK", "", -1, 1);
						}
						else if (iVar4 == 16)
						{
							func_190(0, "GENERAL_MLF_G4", "OR_OVRLY_OK", "", -1, 1);
						}
						else
						{
							func_190(0, "BKR_TF_R6", "OR_OVRLY_OK", "", -1, 1);
						}
					}
					else
					{
						func_190(iVar1, "OR_BUS_SETUP", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
					}
					break;
				...
				case 3005:
					if (func_189(iVar3))
					{
						func_190(0, "UA_CANT_SDOWN", "OR_OVRLY_OK", "", -1, 1);
					}
					else
					{
						func_190(iVar1, "OR_STOP_PROD", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
					}
					break;
				...
				case 3006:
					if (Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar3 /*12*/].f_4 <= 0)
					{
						func_190(0, "OR_BS_NOT_SETUP", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (Global_1365067[iVar3] <= 0)
					{
						func_190(iVar1, "OR_START_PRD_NS", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
					}
					else
					{
						func_190(iVar1, "OR_START_PROD", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
					}
					break;
				...
				case 3014:
					iVar6 = Global_1365067[iVar3];
					iVar7 = func_13(0, iVar6, 0);
					if (Global_262145.f_18354)
					{
						func_190(0, "OR_BS_PAY_NA", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (Global_1365067[iVar3] >= Global_262145.f_17791)
					{
						func_190(0, "OR_MIS_NA_B", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (func_189(iVar3))
					...
					else if (!unk_0x8AF8FB62F0BE628C(iVar7, 0, 1, 0, -1, 0))
					{
						func_190(0, "OR_BS_PAY_NM", "OR_OVRLY_OK", "", -1, 1);
					}
					else
					{
						func_190(iVar1, "OR_BUY_SUP", "WHOUSE_CONF", "WHOUSE_CANC", iVar7, 0);
					}
					break;
...
void func_12(int iParam0)
{
	...
	if (Global_1365067[func_423(iLocal_584)] >= Global_262145.f_17791)
	{
		func_190(0, "OR_MIS_NA_B", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_189(func_423(iLocal_584)))
	{
		func_190(0, "OR_MIS_NA_C", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (!func_175(192))
	{
		if (func_174(unk_0x95B959F18401C09A()) && !func_177(unk_0x95B959F18401C09A()))
		{
			iVar0 = func_31(unk_0x95B959F18401C09A(), 192, 0);
		}
		if (iVar0 == 15)
		{
			func_190(0, "GENERAL_MLF_G1", "OR_OVRLY_OK", "", -1, 1);
	...
	{
		func_190(iParam0, "OR_STEAL_SUP", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
	}
}
...
int func_13(bool bParam0, int iParam1, bool bParam2)
{
	...
	{
		iVar0 = Global_262145.f_17505;
	}
	else
	{
		iVar0 = Global_262145.f_18355;
	}
...
void func_15(int iParam0, bool bParam1)
{
	...
	if (func_17(iLocal_584))
	{
		func_190(0, "OR_BUS_EMPTY", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (!func_175(190))
	{
		if (func_174(unk_0x95B959F18401C09A()) && !func_177(unk_0x95B959F18401C09A()))
		{
			iVar0 = func_31(unk_0x95B959F18401C09A(), 190, 0);
		}
		if (iVar0 == 15)
		{
			func_190(0, "GENERAL_MLF_G1", "OR_OVRLY_OK", "", -1, 1);
		...
		{
			func_190(0, "OR_MIS_NA", "OR_OVRLY_OK", "", -1, 1);
		}
	}
	else if (func_16(iLocal_584) > 25)
	{
		if (bParam1)
		{
			func_190(1003, "OR_SELL_GDB", "OR_OVRLY_OK", "", -1, 0);
		}
		else
		{
			func_190(1002, "OR_SELL_GDB", "OR_OVRLY_OK", "", -1, 0);
		}
	}
	else
	{
		func_190(iParam0, "OR_SELL_GD", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
	}
}
...
int func_16(int iParam0)
{
	...
	iVar1 = func_422(unk_0x95B959F18401C09A(), iParam0);
...
int func_17(int iParam0)
{
	...
	if (func_7(unk_0x95B959F18401C09A(), iParam0))
	{
		iVar0 = func_423(iParam0);
		return Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_1 == 0;
	}
	return 0;
}
...
void func_18(int iParam0, int iParam1)
{
	...
	if (!func_30(iVar0))
	{
		func_190(0, "OR_UPGR_NA", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_4 <= 0)
	{
		func_190(0, "OR_UPGR_NS", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_29(iParam0, iLocal_584))
	{
		func_190(0, "OR_UPGR_NA", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_28(unk_0x95B959F18401C09A(), iLocal_584, iParam0))
	{
		func_190(0, "OR_UPGR_OWN", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (unk_0x8AF8FB62F0BE628C(func_19(iParam0, iLocal_584), 0, 1, 0, -1, 0))
	{
		func_190(iParam1, "OR_BUY_UPGR", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
	}
	else
	{
		func_190(0, "OR_UPG_NO_MONEY", "OR_OVRLY_OK", "", -1, 1);
	}
}
...
int func_19(int iParam0, int iParam1)
{
	...
	switch (iVar0)
	{
		...
		case 5:
			iVar1 = func_26(unk_0x95B959F18401C09A());
			if (unk_0xB331FCEB94EB05C8() && func_25())
			{
				iVar2 = 0;
				iVar3 = 0;
				if (iParam0 == 8)
				...
				uVar20 = unk_0x36163153849DFDA1(&sVar4);
				if (unk_0x5333990AE9AEBC1F(uVar20))
				{
					uVar21 = unk_0x5B9C00971544AAA9(uVar20, 426439576, 1);
					return uVar21;
				}
			}
			switch (iParam0)
			{
				...
				case 1:
					return Global_262145.f_20836;
				
				case 3:
					return Global_262145.f_20824;
				...
				case 7:
					...
					{
						return (0 + Global_262145.f_20829);
					}
					break;
				...
				case 8:
					...
					{
						return (Global_262145.f_20828 + Global_262145.f_20830);
					}
					else
					{
						return (0 + Global_262145.f_20830);
					}
					break;
				
				case 9:
					return Global_262145.f_20831;
				
				case 10:
					return Global_262145.f_20832;
				
				case 11:
					return Global_262145.f_20833;
			}
			break;
	}
	return 0;
...
int func_29(int iParam0, int iParam1)
{
	...
	switch (iVar0)
	{
		...
		case 4:
			...
			{
				case 0:
					return Global_262145.f_17649;
				
				case 2:
					return Global_262145.f_17650;
		...
		case 3:
			...
			{
				case 0:
					return Global_262145.f_17648;
				
				case 2:
					return Global_262145.f_17647;
				
				case 1:
					return Global_262145.f_17646;
...
int func_31(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_66(func_152(iParam1, -1, -1, -1), func_121(iParam1, -1, 1, -1, -1, iParam0), func_75(iParam1, -1, -1, -1, -1, iParam0), 0, 1))
	{
		return 0;
	}
	iVar0 = iParam1;
	...
	else if (func_53(iParam1) == 2)
	{
		...
		if (!bParam2)
		{
			if (Global_1626536[iParam0 /*603*/].f_11.f_34 != func_5())
			{
				return 9;
			}
		}
...
int func_46(int iParam0)
{
	...
	while (iVar0 < 32)
	{
		...
		if (unk_0xC4DEA49C5B465481(iVar1))
		{
			if ((Global_1626536[iParam0 /*603*/].f_11.f_34 != func_5() && Global_1626536[iParam0 /*603*/].f_11.f_34 == iVar1) && Global_1626536[iVar1 /*603*/].f_11.f_34 == iParam0)
			{
				return 1;
			}
		}
...
int func_57()
{
	return func_58(unk_0x95B959F18401C09A());
}
...
int func_58(int iParam0)
{
	...
	if (iVar0 != func_5() && Global_1626536[iVar0 /*603*/].f_11.f_447 == 1)
	{
		return 8;
	}
	return 4;
...
{
	return Global_1645834.f_11.f_147[func_63(iParam0)];
}
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_100(iParam1, iParam2, iParam3, unk_0x7C1C88877E8AAA50(uParam5), iParam4);
		
		case 233:
			return func_93(iParam1, iParam2, iParam3, unk_0x7C1C88877E8AAA50(iParam5), iParam4);
		...
		case 243:
			return func_76(iParam1, iParam2, unk_0x7C1C88877E8AAA50(iParam5), iParam4);
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!func_98(iParam0))
	{
		if (iParam3 != func_5())
		{
			iVar0 = (iVar0 + func_95(iParam0, func_42(iParam3) + 1, iParam3, -1, iParam2));
		}
	}
	if (func_94(iParam0))
	{
...
int func_95(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
...
int func_99(int iParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	...
	if (!func_110(iParam0))
	{
		if (iParam3 != func_5())
		{
			iVar0 = (iVar0 + func_102(iParam0, func_42(iParam3) + 1, iParam3, -1, iParam2));
		}
	}
	if (func_101(iParam0))
	{
...
{
	if (iParam0 == func_5() || Global_1589819[iParam0 /*818*/].f_273.f_258 == 0)
	{
		return 50;
	}
...
int func_111(int iParam0, int iParam1, int iParam2, var uParam3)
{
	switch (iParam0)
	{
		case 1:
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 178:
		case 188:
			return func_147(iParam1, iParam3, iParam4);
		
		case 225:
		case 226:
			return func_143(iParam1, iParam3, iParam4, 0, 0);
		...
		case 229:
		case 230:
			return func_137(iParam1, iParam3, iParam4, unk_0x7C1C88877E8AAA50(uParam5), 0, 0, 0);
		
		case 233:
			return func_131(iParam1, iParam3, iParam4, unk_0x7C1C88877E8AAA50(iParam5), 0, 0, 0);
			return 6;
		...
		case 192:
			return func_130(iParam1, iParam3);
		...
		case 237:
		case 250:
			return func_129(iParam1, iParam3, iParam4);
		...
		case 243:
			return func_122(iParam1, iParam3, unk_0x7C1C88877E8AAA50(iParam5), 0, -1, 0, 0);
...
int func_122(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	...
	if (!bParam6)
	{
		...
		{
			iVar0 = (iVar0 + func_125(func_42(iParam2) + 1, iParam0));
		}
	}
	if (!bParam3)
	{
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	...
	if (!bParam5)
	{
		...
		if (iParam3 != func_5())
		{
			iVar0 = (iVar0 + func_136(iParam0, func_42(iParam3) + 1));
		}
	}
	if (!bParam6)
	{
		if (func_135(0, iParam1) != -1)
		{
			if (iParam3 != func_5())
			{
				iVar0 = (iVar0 + func_134(func_42(iParam3) + 1, iParam0));
			}
		}
	}
	if (!bParam4)
...
int func_137(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	...
	if (!bParam5)
	{
		...
		if (iParam3 != func_5())
		{
			iVar0 = (iVar0 + func_142(iParam0, func_42(iParam3) + 1));
		}
	}
	if (!bParam6)
	{
		if (func_141(0, iParam1) != -1)
		{
			if (iParam3 != func_5())
			{
				iVar0 = (iVar0 + func_140(func_42(iParam3) + 1, iParam0));
			}
		}
	}
	if (!bParam4)
...
int func_143(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	...
	if (!bParam4)
	{
		...
		iVar0 = (iVar0 + func_146(iParam0, func_89() + 1));
	}
	if (!bParam3)
	{
		if (func_145(iParam0))
...
int func_147(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = (iVar0 + func_150(iParam0, func_89() + 1, iParam2));
...
int func_152(int iParam0, int iParam1, int iParam2, int iParam3)
{
	switch (iParam0)
	{
		...
		case 178:
		case 188:
			return func_170(iParam1, iParam2, iParam3);
		
		case 225:
		case 226:
			return func_167(iParam1, iParam2, iParam3, 0);
		...
		case 229:
		case 230:
			return func_164(iParam1, iParam2, iParam3, 0);
		
		case 233:
			return func_161(iParam1, iParam2, iParam3, 0);
		...
		case 238:
		case 249:
			return func_156(iParam1, iParam2);
		...
		case 243:
			return func_153(iParam1, iParam2, 0, -1);
...
int func_154(int iParam0, int iParam1)
{
	if (func_124(iParam0, iParam1))
	{
		return (func_123(iParam0, iParam1) + func_155(iParam0, iParam1));
	}
	return 0;
}
...
int func_162(int iParam0, var uParam1)
{
	if (func_133(iParam0))
	{
		return (func_132(iParam0) + func_163(iParam0, uParam1));
	}
	return 0;
}
...
int func_165(int iParam0, int iParam1)
{
	if (func_139(iParam0))
	{
		return (func_138(iParam0) + func_166(iParam0, iParam1));
	}
	return 0;
}
...
int func_168(int iParam0)
{
	if (func_145(iParam0))
	{
		return (func_144(iParam0) + func_169(iParam0));
	}
	return 0;
}
...
{
	if (!func_176(unk_0x95B959F18401C09A(), iParam0, 0))
	{
		return 0;
	}
	if (!func_64(unk_0x95B959F18401C09A()))
	{
		return 0;
	}
	if (func_177(unk_0x95B959F18401C09A()))
...
int func_178(int iParam0)
{
	...
	iVar0 = func_423(iParam0);
	if (Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_4 <= 0)
	{
		return 4;
	}
	else if (!func_187(unk_0x95B959F18401C09A(), iVar0) && !func_186(iVar0))
	{
		return 2;
	}
	else if (func_179(iVar0, iParam0))
	{
		return 1;
	}
	return 3;
...
int func_179(int iParam0, int iParam1)
{
	if (iParam0 == 5)
	{
		if (Global_1365067[iParam0] > 0 && (!func_184(iParam1) || !func_180(unk_0x95B959F18401C09A(), iParam1)))
		{
			if (!Global_262145.f_20950 || func_174(unk_0x95B959F18401C09A()))
			{
				return 1;
			}
		}
	...
	if ((Global_1365067[iParam0] > 0 && !func_184(iParam1)) && (!Global_262145.f_18353 || func_64(unk_0x95B959F18401C09A())))
	{
		return 1;
	}
	return 0;
...
{
	return func_182(iParam0, iParam1) >= func_181(iParam1);
}
...
int func_182(int iParam0, int iParam1)
{
	...
	if (func_6(iParam1) && func_183(iParam1))
	{
		iVar0 = 0;
		while (iVar0 <= 5)
		{
			if (Global_1589819[iParam0 /*818*/].f_273.f_177[iVar0 /*12*/] == iParam1)
			{
				return Global_1589819[iParam0 /*818*/].f_273.f_250;
			}
			iVar0++;
		}
	}
...
{
	return func_185(unk_0x95B959F18401C09A(), iParam0);
}
...
int func_185(int iParam0, int iParam1)
{
	...
	if (iParam0 != func_5() && func_7(iParam0, iParam1))
	{
		...
		if (func_30(iVar0))
		{
			return Global_1589819[iParam0 /*818*/].f_273.f_177[iVar0 /*12*/].f_1 >= func_421(iParam1);
		}
	}
	return 0;
}
...
{
	return Global_1365050[iParam0] != 0;
}

int func_187(int iParam0, int iParam1)
{
	if (iParam0 != func_5() && func_7(iParam0, func_188(iParam0, iParam1)))
	{
...
int func_188(int iParam0, int iParam1)
{
	...
	if (func_6(Global_1589819[iParam0 /*818*/].f_273.f_177[iParam1 /*12*/]))
	{
...
{
	return Global_1365043[iParam0] != 0;
}

void func_190(int iParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, bool bParam5)
{
	iLocal_579 = iParam0;
	unk_0xBB698266C5FDF0A7(uLocal_755, "SHOW_OVERLAY");
	...
	unk_0x86B03D46DC28E3ED(sParam2);
	unk_0x86B03D46DC28E3ED(sParam3);
	unk_0x818901B332D5541D();
	if (bParam5)
	{
		unk_0x0F8EAEEC97DDBCB3(-1, "Click_Fail", "DLC_Biker_Computer_Sounds", 1);
	}
	iLocal_574 = 1;
}
...
void func_191(int iParam0, int iParam1)
{
	...
	iVar0 = iParam0;
	bVar1 = func_211(iVar0);
	iVar2 = func_208(iVar0);
	if (func_207(unk_0x95B959F18401C09A(), func_27(iVar0)))
	{
		iVar3 = func_206(unk_0x95B959F18401C09A(), func_27(iVar0));
		iVar2 = (iVar2 - func_194(iVar3));
	}
	if (bVar1)
	{
		iVar2 = 0;
	}
	if (iVar2 > 0 && !unk_0x8AF8FB62F0BE628C(iVar2, 0, 1, 0, -1, 0))
	{
		func_190(0, "OR_BUS_AFF", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_192(iVar0))
	{
		if (func_207(unk_0x95B959F18401C09A(), func_27(iVar0)))
		{
			func_190(1001, "OR_BUY_BUSB", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
		}
		else
		{
			func_190(iParam1, "OR_BUY_BUS", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
		}
	}
	else
	{
		func_190(0, "OR_BUS_NA", "OR_OVRLY_OK", "", -1, 1);
	}
}

int func_192(int iParam0)
{
	if (func_193(iParam0) || func_7(unk_0x95B959F18401C09A(), iParam0))
	{
		return 0;
	}
	return 1;
...
int func_194(int iParam0)
{
	...
	iVar0 = (func_201(iParam0) / 2);
	if (iVar0 < 0)
	{
		iVar0 = (func_208(iParam0) / 2);
	}
	if (func_28(unk_0x95B959F18401C09A(), iParam0, 0))
	{
		iVar1 = (func_19(0, iParam0) / 2);
		iVar0 = (iVar0 + iVar1);
	}
	if (func_28(unk_0x95B959F18401C09A(), iParam0, 2))
	{
	...
	if (func_183(iParam0))
	{
		if (func_200(unk_0x95B959F18401C09A()))
		{
			iVar3 = (func_19(6, iParam0) / 2);
			iVar0 = (iVar0 + iVar3);
		}
		if (func_199(unk_0x95B959F18401C09A()))
		{
			iVar4 = (Global_262145.f_20828 / 2);
			iVar0 = (iVar0 + iVar4);
		}
		if (func_198(unk_0x95B959F18401C09A()))
		{
			iVar5 = (Global_262145.f_20828 / 2);
			iVar0 = (iVar0 + iVar5);
		}
		if (func_197(unk_0x95B959F18401C09A()))
		{
			iVar6 = (func_19(9, iParam0) / 2);
			iVar0 = (iVar0 + iVar6);
		}
		if (func_196(unk_0x95B959F18401C09A()))
		{
			iVar7 = (func_19(10, iParam0) / 2);
			iVar0 = (iVar0 + iVar7);
		}
		if (func_195(unk_0x95B959F18401C09A()))
		{
...
int func_201(int iParam0)
{
	...
	if (func_7(unk_0x95B959F18401C09A(), iParam0))
	{
		iVar0 = func_4(unk_0x95B959F18401C09A(), iParam0);
		if (func_202(iVar0, &uVar1))
		{
			return uVar1;
		}
	}
...
{
	if (func_22(func_205(iParam0), -1, 0) == func_22(func_204(iParam0), -1, 0))
	{
		*uParam1 = func_22(func_203(iParam0), -1, 0);
		return *uParam1 >= 0;
	}
	return 0;
}
...
int func_208(int iParam0)
{
	...
	if (unk_0xB331FCEB94EB05C8() && func_25())
	{
		...
		func_210(&sVar1, iParam0, bVar0);
		uVar17 = unk_0x36163153849DFDA1(&sVar1);
		if (unk_0x5333990AE9AEBC1F(uVar17))
		{
			uVar18 = unk_0x5B9C00971544AAA9(uVar17, 426439576, 1);
			StringCopy(&cVar19, func_209(iParam0), 16);
			return uVar18;
		}
		else
		{
			StringCopy(&cVar23, func_209(iParam0), 16);
		}
	}
	if (func_211(iParam0))
	{
...
void func_210(char* sParam0, int iParam1, bool bParam2)
{
...
bool func_212()
{
	return (func_214() || func_213());
}

int func_213()
{
	switch (unk_0x75EE164BF3E020A4())
	{
		case 1:
		case 2:
		case 3:
...
void func_215(bool bParam0, int iParam1)
{
	...
	unk_0xF8600B0C544D4018(uLocal_755, "HIDE_OVERLAY");
	iLocal_574 = 0;
	if (bParam0)
	{
		switch (iLocal_579)
		{
			case 2001:
				if (iLocal_573)
				{
					unk_0xF8600B0C544D4018(uLocal_755, "SHOW_HOMEPAGE");
					iLocal_573 = 0;
				}
				else if (!func_193(iParam1))
				{
					unk_0x0F8EAEEC97DDBCB3(-1, "Click_Special", "DLC_Biker_Computer_Sounds", 1);
					if (func_207(unk_0x95B959F18401C09A(), func_27(iParam1)))
					{
						func_374(iParam1);
						func_373(iVar0, 0);
					}
			...
			case 1001:
				func_190(2001, "OR_BUY_SAV", "WHOUSE_CONF", "WHOUSE_CANC", func_317(iParam1), 0);
				break;
			...
			case 1002:
				if (!func_175(190))
				{
					if (func_174(unk_0x95B959F18401C09A()) && !func_177(unk_0x95B959F18401C09A()))
					{
						iVar1 = func_31(unk_0x95B959F18401C09A(), 190, 0);
					}
					if (iVar1 == 15)
					{
						func_190(0, "GENERAL_MLF_G1", "OR_OVRLY_OK", "", -1, 1);
				...
				{
					func_190(3011, "OR_SELL_GD", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
				}
				break;
			...
			case 1003:
				...
				{
					func_190(3012, "OR_SELL_GD", "WHOUSE_CONF", "WHOUSE_CANC", -1, 0);
				}
				break;
			
			case 3003:
				if (func_316(iLocal_584))
				{
					unk_0x0F8EAEEC97DDBCB3(-1, "Click_Special", "DLC_Biker_Computer_Sounds", 1);
					func_312(iLocal_584);
					func_310(func_423(iLocal_584));
				}
				break;
			
			case 3005:
				unk_0x0F8EAEEC97DDBCB3(-1, "Business_Shutdown", "DLC_Biker_Computer_Sounds", 1);
				iVar0 = func_423(iLocal_584);
				func_296();
				func_373(iVar0, 1);
				func_431();
				...
				{
					iVar2 = func_294(func_27(iLocal_584));
					if (func_293(iVar2))
					{
						iVar3 = func_291(iVar2);
						func_282(iVar3);
						unk_0x8950ED5730F62EE8(&Global_1671152, iVar0);
					}
				}
				break;
			
			case 3006:
				unk_0x0F8EAEEC97DDBCB3(-1, "Business_Restart", "DLC_Biker_Computer_Sounds", 1);
				iVar0 = func_423(iLocal_584);
				func_280(func_423(iLocal_584));
				func_431();
				func_373(iVar0, 0);
				break;
			
			case 3008:
				if (func_279(0, iLocal_584))
				{
					if (func_275(0))
					{
						func_271(0);
			...
			case 3009:
				if (func_279(1, iLocal_584))
				{
					if (func_275(1))
					{
						func_271(1);
						func_431();
						func_190(0, "OR_SUS_P_STAF", "OR_OVRLY_OK", "", -1, 1);
					}
				}
				break;
			
			case 3010:
				if (func_279(2, iLocal_584))
				{
					if (func_275(2))
					{
						func_271(2);
			...
			case 3011:
				if (func_256(iLocal_584))
				{
					unk_0x0F8EAEEC97DDBCB3(-1, "Click_Special", "DLC_Biker_Computer_Sounds", 1);
					func_254(func_423(iLocal_584), !Global_262145.f_16856);
					func_238(190, iLocal_584, 0);
					func_234(iLocal_584, 0);
				}
				else
				{
					func_190(0, func_233(iLocal_766), "OR_OVRLY_OK", "", -1, 1);
				}
				break;
			...
			case 3012:
				if (func_256(iLocal_584))
				{
					unk_0x0F8EAEEC97DDBCB3(-1, "Click_Special", "DLC_Biker_Computer_Sounds", 1);
					func_254(func_423(iLocal_584), !Global_262145.f_16856);
					func_238(190, iLocal_584, 1);
					func_234(iLocal_584, 1);
				}
				else
				{
					func_190(0, func_233(iLocal_766), "OR_OVRLY_OK", "", -1, 1);
			...
			case 3014:
				unk_0x0F8EAEEC97DDBCB3(-1, "Click_Special", "DLC_Biker_Computer_Sounds", 1);
				func_220(iLocal_584, -1);
				iVar0 = func_423(iLocal_584);
				if (func_219())
				{
					func_216(iVar0);
					func_190(0, "OR_RSP_PAID", "OR_OVRLY_OK", "", -1, 0);
					func_431();
					unk_0xEDF90B96BED57BCE(1);
					if (func_17(iLocal_584))
					{
						unk_0x37621D6689F9E3C3("OR_PSUP_OTW0");
					}
					else
					{
						unk_0x37621D6689F9E3C3("OR_PSUP_OTW1");
					}
					unk_0x092150016C06C431(0, 0, 1, 8000);
				}
				else
				{
					func_190(0, "UA_PSUP_FAIL", "OR_OVRLY_OK", "", -1, 1);
				}
				break;
			...
			case 3015:
				if (func_316(iLocal_584))
				{
					Global_1671153 = iLocal_584;
					unk_0x0F8EAEEC97DDBCB3(-1, "Click_Special", "DLC_Biker_Computer_Sounds", 1);
					func_238(192, iLocal_584, -1);
					func_254(func_423(iLocal_584), !Global_262145.f_16856);
					func_310(func_423(iLocal_584));
				}
				break;
...
{
	if (Global_1365043[iParam0] == 0)
	{
		Global_1365043[iParam0] = unk_0xEF4753434B24594D();
		func_217(func_218(iParam0), 1, -1, 1, 0);
	}
}
...
int func_219()
{
	...
	while (iVar9 < 5)
	{
		if (Global_4263509[iVar9 /*84*/].f_65.f_4 == 268924934)
		{
			iLocal_768 = iVar9;
		}
		else
	...
	while (!func_8(&uVar7, 15000, 0))
	{
		if (iLocal_769 == -1)
		{
			if (Global_4263509[iLocal_768 /*84*/].f_65 != 2147483647)
			{
				iLocal_769 = Global_4263509[iLocal_768 /*84*/].f_65;
			}
		}
		iVar10 = 0;
		while (iVar10 < unk_0x77BABFD1D75AA582(1))
		{
			if (unk_0x5487531DB7DA4AB5(1, iVar10) == 223)
			{
				if (unk_0x286A5F0670063839(1, iVar10, &Var0, 7))
				{
					if (Var0.f_0 == iLocal_769 && Var0.f_0 != -1)
					{
						if (Var0.f_2 == 0)
						{
							return 1;
...
void func_220(int iParam0, int iParam1)
{
	...
	if (func_25())
	{
		func_221(268924934, iVar3, &iVar6, 0, 1, 0);
		Global_4263509[iVar6 /*84*/] = uVar4;
		Global_4263509[iVar6 /*84*/].f_1 = iVar5;
		Global_4263509[iVar6 /*84*/].f_9 = iVar2;
	}
	else
	{
		unk_0xE5B884DE6E6FA75D(iVar3, uVar4, iVar5, iVar2);
	}
}
...
int func_222(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (!bVar0)
	{
		if (!unk_0xB412AA3DEE298A52(func_24()) || unk_0x2832F5CD8A109CD6())
		{
			Global_4264085 = 1;
			return 0;
		}
...
void func_223(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	switch (iParam1)
	{
		case 1704445500:
...
void func_224(int iParam0)
{
	...
	if (iParam0 != -1)
	{
		...
		func_225(&(Global_4263509[iParam0 /*84*/]));
	}
}
...
void func_225(var uParam0)
{
	...
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
	func_226(&(uParam0->f_13));
	func_226(&(uParam0->f_13.f_13));
...
int func_229(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, int iParam5, bool bParam6, var uParam7, var uParam8, int iParam9, bool bParam10)
{
	int iVar0;
	...
	while (iVar0 < 5)
	{
		if (Global_4263509[iVar0 /*84*/].f_65.f_2 == 0)
		{
			...
			{
				func_230(Global_4263509[iVar0 /*84*/], iVar0);
			}
			return iVar0;
		}
		iVar0++;
...
void func_230(struct<66> Param0, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, int iParam84)
{
	struct<3> Var0;
	int iVar35;
...
void func_238(int iParam0, int iParam1, int iParam2)
{
	if (func_175(iParam0))
	{
		func_239(iParam0, iParam1, iParam2);
...
void func_240(var uParam0, var uParam1)
{
	if (func_252())
	{
		if (!func_250(unk_0x95B959F18401C09A(), 0))
		{
			func_249(uParam0);
			func_241(uParam0, func_245(1, 1), func_244(), func_243(), func_242(), uParam1);
		}
	}
}

void func_241(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	struct<7> Var0;
...
int func_250(int iParam0, int iParam1)
{
	...
	{
		return func_53(Global_1626536[iParam0 /*603*/].f_11.f_33) == iParam1;
	}
	return 0;
}
...
bool func_252()
{
	return func_174(unk_0x95B959F18401C09A());
}

void func_253(var uParam0, var uParam1)
{
	Global_1626536[unk_0x95B959F18401C09A() /*603*/].f_11.f_193 = uParam0;
	Global_1626536[unk_0x95B959F18401C09A() /*603*/].f_11.f_193.f_1 = uParam1;
}
...
void func_254(int iParam0, bool bParam1)
{
	...
	func_396(func_255(iParam0), bParam1, -1, 1);
...
int func_256(int iParam0)
{
	...
	iVar0 = func_423(iParam0);
	if (!func_176(unk_0x95B959F18401C09A(), 190, 0))
	{
		iLocal_766 = 4;
		return 0;
	}
	...
	if (func_25())
	{
		...
		iLocal_765 = 0;
		iVar1 = func_269(1);
		while (!func_258(iVar0, iVar1, &iLocal_767))
		{
			unk_0x4EDE34FBADD967A6(0);
			func_383();
		}
...
bool func_258(int iParam0, int iParam1, int iParam2)
{
	...
	switch (*iParam2)
	{
		case 0:
			...
			if (func_264(78225582, -1799524201, iParam1, -1018905335, 1, 0, 1, 4, iVar0, 3))
			{
				*iParam2 = 1;
			}
			else
		...
		case 1:
			if (func_260(func_268()))
			{
				if (func_259(func_268()) == 2)
				{
					*iParam2 = 2;
					func_224(func_268());
					func_257(iParam1);
...
int func_261()
{
	...
	if (!bVar0)
	{
		if (!unk_0xB412AA3DEE298A52(func_24()) || unk_0x2832F5CD8A109CD6())
		{
			if (func_263(Global_4263509[iVar2 /*84*/].f_65.f_6, Global_4263509[iVar2 /*84*/].f_65.f_4, Global_4263509[iVar2 /*84*/].f_65.f_1) == 1)
			{
				Global_4264085 = 1;
			}
			return 0;
	...
	if (iVar3 != 2147483647)
	{
		if ((bVar0 || iVar1) || unk_0x64875ABCC43EF9A8(iVar3))
		{
			...
			if (bVar0 || iVar1)
			{
				func_230(Global_4263509[iVar2 /*84*/], iVar2);
			}
			Global_4264070 = 1;
			return 1;
		}
...
int func_264(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	bool bVar0;
	int iVar1;
	struct<4> Var2;
	...
	if (iVar1 == -1)
	{
		if (!func_266(&iVar1, iParam0, iParam1, iParam3, iParam7, iParam9))
		{
			return 0;
		}
	}
...
int func_266(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	*iParam0 = 0;
	...
	{
		*iParam0 = func_229(uVar3, iParam1, -2085313189, uParam3, iParam2, 0, 1, uParam4, uParam5, 0, bVar0);
		return 1;
	}
	return 0;
}
...
void func_272(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_7(unk_0x95B959F18401C09A(), iParam0))
	{
		...
		if (bParam2)
		{
			unk_0x8950ED5730F62EE8(&(Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_5), iParam1);
		}
		else
		{
			unk_0xCE689A8E8C42ED78(&(Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_5), iParam1);
		}
		func_217(func_274(iVar0, iParam1), func_273(bParam2), -1, 1, 0);
	}
}
...
int func_275(int iParam0)
{
	...
	bVar0 = true;
	iVar1 = 1;
	iVar2 = func_19(iParam0, iLocal_584);
	iVar3 = iParam0;
	iVar4 = func_423(iLocal_584);
	iVar5 = func_278(iVar4, iVar3 + 1);
	iVar6 = func_27(iLocal_584);
	iVar7 = func_277(iVar6, iVar3 + 1, 1);
	if (func_25())
	{
		bVar0 = false;
		while (!func_276(-103880010, 235173372, iVar7, 1, iVar2, &iLocal_583, iVar5, 3, 0, 0))
		{
			unk_0x4EDE34FBADD967A6(0);
			func_383();
			if (iLocal_583 == 1 && func_268() == -1)
			{
				iLocal_583 = 3;
				iVar1 = 0;
			}
	...
	if (bVar0)
	{
		if (iVar2 > 0)
		{
			Var8.f_0 = unk_0x36163153849DFDA1(func_209(iLocal_584));
			Var8.f_1 = iVar6;
			Var8.f_2 = iParam0;
			unk_0xFF6DA45BDAD55783(iVar2, &Var8, 0, 1);
		}
		iLocal_570 = 1;
		if (func_25())
		{
...
bool func_276(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	{
		case 0:
			if (func_264(78225582, iParam0, iParam2, iParam1, iParam3, iParam4, 1, 4, iParam6, iParam7))
			{
				if (func_261())
				{
					*uParam5 = 1;
			...
			if (func_260(func_268()))
			{
				if (func_259(func_268()) == 2)
				{
					*uParam5 = 2;
					if (iParam4 != 0)
					{
						unk_0x9409D2F56E25B407(func_262(func_268()));
						if (iParam0 == 1394405165)
						{
							unk_0xA904E41046D3AD46(iParam4, iParam8, 0, 0);
						}
						...
						{
							unk_0x68642A60A49B0D2B(iParam4, iParam8, 18, 1, 0, 0, 0, iParam9, 0, 1);
						}
					}
					func_224(func_268());
				}
...
int func_277(int iParam0, int iParam1, int iParam2)
{
	...
	return unk_0x36163153849DFDA1(&Var0);
}
...
{
	if (!func_28(unk_0x95B959F18401C09A(), iParam1, iParam0) && unk_0x8AF8FB62F0BE628C(func_19(iParam0, iParam1), 0, 1, 0, -1, 0))
	{
		return 1;
	}
	return 0;
...
{
	if (Global_1365050[iParam0] == 0)
	{
		Global_1365050[iParam0] = unk_0xEF4753434B24594D();
		func_396(func_281(iParam0), 1, -1, 1);
	}
}
...
void func_282(int iParam0)
{
	...
	iVar0 = func_289(unk_0x95B959F18401C09A(), iParam0);
	if (!func_288(iVar0))
	{
		return;
	}
	func_285(iVar0, iParam0, 1, 0);
	func_284(&(Global_2506021[iParam0 /*2*/]));
	iVar1 = iVar0;
	iVar2 = func_283(iParam0);
	func_377(iVar2, 0, -1, 1);
	if (iParam0 < 4)
	{
		iVar1 = (iVar1 + iParam0 * 7);
		unk_0xCE689A8E8C42ED78(&(Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_275.f_2), iVar1);
	}
	else
	{
		unk_0xCE689A8E8C42ED78(&(Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_275.f_3), iVar1);
	}
	Global_2458546 = 1;
}
...
void func_285(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (!func_290(iParam1) || !func_288(iParam0))
	{
		return;
	}
	iVar0 = func_287(iParam0);
	iVar1 = (iVar0 - unk_0xEE14D9A9F531ADDC(unk_0x5009A219B22D2352(unk_0x78DCC5D0CB43DEBA(), Global_2506021[iParam1 /*2*/])));
	if (bParam2)
	{
		func_284(&(Global_2506021[iParam1 /*2*/]));
	}
	if (bParam3)
	{
		iVar1 = iVar0;
	...
	func_217(iVar2, iVar1, -1, 1, 0);
	Global_2506040[iParam0] = iVar1;
}
...
int func_289(int iParam0, int iParam1)
{
	...
	if (iParam1 < 4)
	{
		...
		while (iVar0 <= iVar3)
		{
			if (unk_0x0E4018692D92041D(Global_1589819[iParam0 /*818*/].f_273.f_275.f_2, iVar0))
			{
	...
	else
	{
		...
		while (iVar0 <= 7)
		{
			if (unk_0x0E4018692D92041D(Global_1589819[iParam0 /*818*/].f_273.f_275.f_3, iVar0))
			{
				iVar1 = iVar0;
			}
			else
...
int func_292(int iParam0, int iParam1)
{
	...
	if (!func_290(iParam0) || !func_288(iParam1))
	{
		return 0;
	}
	if (iParam0 < 4)
	{
		...
		if (unk_0x0E4018692D92041D(Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_275.f_2, iVar0))
		{
			return 1;
		}
	}
	...
	{
		iVar0 = iParam1;
		if (unk_0x0E4018692D92041D(Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_275.f_3, iVar0))
		{
			return 1;
		}
	}
...
void func_296()
{
	...
	iVar0 = func_423(iLocal_584);
	if (func_25() && func_422(unk_0x95B959F18401C09A(), iLocal_584) > 0)
	{
		iVar1 = func_269(1);
		iLocal_764 = 1;
		while (!func_258(iVar0, iVar1, &iLocal_767))
		...
		{
			iLocal_767 = 0;
			iVar2 = func_422(unk_0x95B959F18401C09A(), iLocal_584);
			while (!func_306(iVar0, iVar2, 0, 0, &iLocal_767, 0))
			{
				unk_0x4EDE34FBADD967A6(0);
				func_383();
			}
			...
			if (iLocal_767 == 2)
			{
				func_297(unk_0x95B959F18401C09A(), iLocal_584, 1, 0, 0, 0);
				func_420(iVar0, 0, 0);
			}
		}
	}
...
void func_297(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	...
	if (func_30(iVar0))
	{
		if (func_7(iParam0, iParam1))
		{
			...
			if (bParam3)
			{
				Global_1589819[iParam0 /*818*/].f_273.f_177[iVar0 /*12*/].f_4 = 0;
				func_377(func_305(iVar0), 0, -1, 1);
			}
			else
			{
				Global_1589819[iParam0 /*818*/].f_273.f_177[iVar0 /*12*/].f_4 = 1;
				func_377(func_305(iVar0), 1, -1, 1);
			}
			if (bParam2)
			{
				func_217(func_304(iVar0), 0, -1, 1, 0);
				Global_1589819[iParam0 /*818*/].f_273.f_177[iVar0 /*12*/].f_1 = 0;
			}
			if (bParam4)
			{
				func_217(func_303(iVar0), 0, -1, 1, 0);
				func_302(iVar0, 0);
				func_301(iVar0, 0);
			}
			Global_1365050[iVar0] = 0;
			func_396(func_281(iVar0), 0, -1, 1);
			func_396(func_300(iVar0), 0, -1, 1);
			if (func_27(iParam1) == 1)
			{
				Global_1365065 = 1;
				Global_1365077 = 0;
			}
			Global_1589819[iParam0 /*818*/].f_273.f_177[iVar0 /*12*/].f_8 = 0;
			func_396(func_299(iVar0), 0, -1, 1);
			func_298(iVar0);
			if (func_183(iParam1))
			{
				if (bParam5)
				{
					Global_1589819[iParam0 /*818*/].f_273.f_250 = 0;
					func_217(5442, 0, -1, 1, 0);
				}
			}
			Global_2458547 = 1;
		}
...
{
	unk_0xCE689A8E8C42ED78(&Global_1365074, iParam0);
	unk_0xCE689A8E8C42ED78(&Global_1365074, iParam0 + 6);
}
...
{
	if (iParam0 != -1 && iParam1 != Global_1365067[iParam0])
	{
		Global_1365067[iParam0] = iParam1;
	}
}
...
bool func_306(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (*iParam4)
	{
		case 0:
			...
			if (iParam3 == 0 || func_264(78225582, -1799524201, iVar3, -788753717, 1, 0, 1, 4, iVar2, 3))
			{
				if (func_264(78225582, 69656641, iVar4, -788753717, iParam1, 0, 1, 4, 0, 3))
				{
					if (func_264(78225582, -739932302, iVar5, -788753717, 1, iParam2, 0, 4, iVar4, 3))
					{
						*iParam4 = 1;
					}
					else
		...
		case 1:
			if (func_260(func_268()))
			{
				if (func_259(func_268()) == 2)
				{
					...
					{
						unk_0x9409D2F56E25B407(func_262(func_268()));
						iVar0 = func_188(unk_0x95B959F18401C09A(), iParam0);
						iVar1 = func_27(iVar0);
						unk_0xD03C3D53A195C1E1(iParam2, unk_0x36163153849DFDA1(func_209(iVar0)), iVar1, iParam5);
					}
					*iParam4 = 2;
					func_224(func_268());
				}
...
int func_317(int iParam0)
{
	...
	iVar0 = iParam0;
	iVar1 = func_27(iVar0);
	iVar2 = func_206(unk_0x95B959F18401C09A(), iVar1);
	return func_194(iVar2);
}
...
void func_318(int iParam0)
{
	...
	while (iVar2 < 6)
	{
		if (Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar2 /*12*/] == 0)
		{
			iVar1 = iVar2;
		}
		else
	...
	if (func_362(iVar0, &iVar1, 0))
	{
		...
		func_325(28);
		func_325(29);
		func_324(func_423(iParam0));
		func_321();
		func_396(func_281(iVar1), 0, -1, 1);
		func_298(iVar1);
		func_319(iVar1);
		iLocal_570 = 1;
		func_190(2001, "OR_PUR_SUC", "OR_OVRLY_OK", "", -1, 0);
	}
	else
	{
		func_190(0, "BKR_TF_R5", "OR_OVRLY_OK", "", -1, 0);
	}
}
...
{
	Global_1365076 = 0;
	func_396(func_320(iParam0), 0, -1, 1);
	if (iParam0 == 5)
	{
		func_396(15440, 0, -1, 1);
	}
	Global_1365147 = 0;
	func_284(&Global_1365148);
}
...
void func_321()
{
	...
	Global_1365064 = unk_0xEF4753434B24594D();
}
...
void func_322(int iParam0)
{
	...
	if (Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iParam0 /*12*/] != 0 && Global_1365057[iParam0] != 0)
	{
		iVar0 = (unk_0xEF4753434B24594D() - Global_1365057[iParam0]);
		if (iVar0 > 1000000)
		{
		}
		else
		{
			func_217(func_323(iParam0), iVar0, -1, 1, 0);
		}
	}
}
...
{
	Global_1365057[iParam0] = unk_0xEF4753434B24594D();
	func_217(func_323(iParam0), 0, -1, 1, 0);
}
...
void func_326(int iParam0)
{
	...
	bVar4 = false;
	uVar5 = unk_0xE2B961C714AD503C(func_350(iVar0, 0));
	Var6 = { func_349(iVar0, iVar2) };
	iVar10 = func_24();
	iVar11 = 0;
	iVar12 = func_208(iVar0);
	iVar13 = -1;
	iVar14 = func_421(iVar0);
	iVar15 = func_422(unk_0x95B959F18401C09A(), iVar0);
	iVar16 = func_348(unk_0x95B959F18401C09A(), iVar0, iVar15);
	iVar17 = 0;
	iVar18 = 0;
	iVar19 = 0;
	iVar20 = 0;
	...
	iVar27 = 0;
	bVar28 = false;
	if (func_7(unk_0x95B959F18401C09A(), iVar0))
	{
		iVar11 = func_423(iVar0);
		iVar21 = func_344(func_346(iVar10, iVar11), func_345(iVar10, iVar11));
		iVar24 = func_344(func_342(iVar10, iVar11), func_341(iVar10, iVar11));
		iVar25 = func_344(func_339(iVar10, iVar11), func_338(iVar10, iVar11));
		iVar20 = func_337(iVar10, iVar11);
		iVar18 = func_335(iVar0);
		iVar19 = func_331(iVar11, 0, 1);
		iVar26 = func_331(iVar11, 0, 0);
		iVar27 = func_331(iVar11, 1, 1);
		iVar17 = Global_1365067[iVar11];
		iVar22 = func_13(0, iVar17, 0);
		bVar4 = Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar11 /*12*/].f_4 > 0;
		if (bVar4 || func_330(iVar0))
		{
			bVar28 = true;
		}
	}
	...
	unk_0xBB698266C5FDF0A7(uLocal_755, "ADD_BUSINESS");
	unk_0x4D9DA18AB3C2A466(iParam0);
	unk_0x4D9DA18AB3C2A466(iVar2);
	unk_0x86B03D46DC28E3ED(&Var6);
	unk_0x86B03D46DC28E3ED(uVar5);
	unk_0x86B03D46DC28E3ED(&Var6);
	unk_0x4D9DA18AB3C2A466(iVar3);
	unk_0x4D9DA18AB3C2A466(iVar12);
	unk_0x4D9DA18AB3C2A466(iVar13);
	unk_0x4D9DA18AB3C2A466(iVar30);
	unk_0x4D9DA18AB3C2A466(iVar16);
	unk_0x4D9DA18AB3C2A466(iVar17);
	unk_0x295B86DE57A0721D(bVar4);
	unk_0x4D9DA18AB3C2A466(iVar18);
	unk_0x4D9DA18AB3C2A466(iVar19);
	unk_0x4D9DA18AB3C2A466(iVar20);
	unk_0x295B86DE57A0721D(bVar28);
	unk_0x4D9DA18AB3C2A466(iVar22);
	unk_0x4D9DA18AB3C2A466(iVar23);
	unk_0x295B86DE57A0721D(bVar1);
	unk_0x818901B332D5541D();
	unk_0xBB698266C5FDF0A7(uLocal_755, "ADD_BUSINESS_STATS");
	unk_0x4D9DA18AB3C2A466(iParam0);
	...
	unk_0x818901B332D5541D();
	unk_0xBB698266C5FDF0A7(uLocal_755, "SET_START_PRODUCTION_STATUS");
	unk_0x295B86DE57A0721D(bVar4);
	unk_0x818901B332D5541D();
}
...
{
	return func_208(iParam0) < func_328(iParam0);
}
...
int func_330(int iParam0)
{
	...
	iVar0 = func_423(iParam0);
	if ((func_7(unk_0x95B959F18401C09A(), iParam0) && Global_1365067[iVar0] < Global_262145.f_17791) && !func_189(iVar0))
	{
		return 1;
	}
	return 0;
...
int func_331(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		return func_22(func_334(iParam0), -1, 0);
	}
	else if (bParam2)
	{
		return func_22(func_333(iParam0), -1, 0);
	}
	return func_22(func_332(iParam0), -1, 0);
}
...
int func_335(int iParam0)
{
	...
	iVar0 = func_423(iParam0);
	return func_22(func_336(iVar0), -1, 0);
}
...
{
	return (func_339(iParam0, iParam1) + func_342(iParam0, iParam1));
}

int func_338(int iParam0, int iParam1)
{
	return func_22(func_235(iParam1), iParam0, 0);
}

int func_339(int iParam0, int iParam1)
{
	return func_22(func_340(iParam1), iParam0, 0);
}
...
{
	return func_22(func_236(iParam1), iParam0, 0);
}
...
{
	return func_22(func_311(iParam1), iParam0, 0);
}

int func_346(int iParam0, int iParam1)
{
	return func_22(func_347(iParam1), iParam0, 0);
}
...
Vector3 func_350(int iParam0, int iParam1)
{
	...
	if (iParam1 && !func_351(Var0[1 /*3*/], 0f, 0f, 0f, 0))
	{
		return Var0[1 /*3*/];
	}
	return Var0[0 /*3*/];
...
void func_352(int iParam0)
{
	...
	if (func_6(iParam0))
	{
		...
		else
		{
			...
			while (iVar1 <= 5)
			{
				if (Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar1 /*12*/] == 0)
				{
					iVar0 = iVar1;
				}
				else
		...
		func_217(func_204(iVar0), iParam0, -1, 1, 0);
		func_217(func_205(iVar0), iParam0, -1, 1, 0);
		Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/] = iParam0;
		if (func_183(iParam0))
		{
			Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_11 = 0;
			func_377(9359, 0, -1, 1);
			func_217(5618, 0, -1, 1, 0);
		}
		func_361(iVar0);
		if (14 == iParam0 && func_212())
		{
			func_353(3, 1);
		}
		if (28 == iParam0 && func_212())
		{
			func_353(1, 1);
		}
	}
...
void func_353(int iParam0, bool bParam1)
{
	...
	else if (func_359(iParam0))
	{
		...
		if (bParam1)
		{
			unk_0x8950ED5730F62EE8(&iVar1, iVar0);
		}
		else
		{
			unk_0xCE689A8E8C42ED78(&iVar1, iVar0);
		}
		func_217(6419, iVar1, -1, 1, 0);
		if (func_358(iParam0))
		{
			func_356(19);
		}
...
void func_356(int iParam0)
{
	...
	if (bVar5)
	{
		if (!unk_0x0E4018692D92041D(iVar4, iVar3))
		{
			unk_0x8950ED5730F62EE8(&iVar4, iVar3);
			func_217(6154, iVar4, -1, 1, 0);
		}
	}
	else if (unk_0x0E4018692D92041D(iVar4, iVar3))
	{
		unk_0xCE689A8E8C42ED78(&iVar4, iVar3);
		func_217(6154, iVar4, -1, 1, 0);
	}
}
...
bool func_357(int iParam0)
{
	...
	{
		iVar1 = func_22(6419, -1, 0);
		bVar3 = unk_0x0E4018692D92041D(iVar1, iVar0);
	}
	else if (func_355(iParam0))
	{
		if (func_354(iParam0))
...
{
	func_217(func_333(iParam0), 0, -1, 1, 0);
	func_217(func_332(iParam0), 0, -1, 1, 0);
	func_217(func_311(iParam0), 0, -1, 1, 0);
	func_217(func_334(iParam0), 0, -1, 1, 0);
	func_217(func_347(iParam0), 0, -1, 1, 0);
	func_217(func_336(iParam0), 0, -1, 1, 0);
	func_217(func_235(iParam0), 0, -1, 1, 0);
	func_217(func_236(iParam0), 0, -1, 1, 0);
	func_217(func_340(iParam0), 0, -1, 1, 0);
	func_217(func_343(iParam0), 0, -1, 1, 0);
}
...
int func_362(int iParam0, int iParam1, int iParam2)
{
	...
	StringCopy(&cVar3, func_209(iParam0), 16);
	iVar7 = unk_0x11E019C8F43ACC8A((unk_0xBBDA792448DB5A89(func_208(iParam0)) * Global_262145.f_77));
	iVar0 = iVar7;
	bVar8 = func_211(iParam0);
	if (bVar8)
	{
		iVar7 = 0;
		iVar0 = 0;
	...
	else
	{
		*iParam1 = func_423(iParam2);
		...
		{
			iVar2 = func_194(iParam2);
			iVar1 = (iVar7 - iVar2);
		}
		if (iVar1 > 0)
		{
			if (!unk_0x8AF8FB62F0BE628C(iVar1, 0, 1, 0, -1, 0))
			{
				func_372(unk_0x36163153849DFDA1(&cVar3), iVar1, 0);
				iLocal_766 = 1;
				unk_0x0F8EAEEC97DDBCB3(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
				return 0;
			}
	...
	if (func_25())
	{
		iLocal_764 = 1;
		iLocal_765 = 0;
		iVar9 = func_371(iParam0, 0);
		iVar10 = func_370(*iParam1);
		iVar11 = 0;
		if (bVar8)
		{
			iVar9 = func_371(iParam0, 1);
		}
		if (iParam2 != 0 && iParam2 != 32)
		{
			bVar12 = false;
			...
			iVar11 = func_371(iParam2, bVar12);
		}
		iVar13 = -1;
		while (func_369(&iVar13, iVar7, *iParam1, -1616616027, 235173372, iVar9, iVar10, iVar2, iVar11))
		{
			func_383();
			unk_0x4EDE34FBADD967A6(0);
		}
	...
	Var14.f_0 = unk_0x36163153849DFDA1(func_209(iParam0));
	Var14.f_1 = func_27(iParam0);
	Var14.f_2 = -1;
	if (iVar1 > 0)
	{
		func_364(joaat("mpply_ingamestore_moneyspent"), iVar1);
	}
	iParam2 = func_188(unk_0x95B959F18401C09A(), *iParam1);
	func_363(*iParam1, iVar7);
	if (iParam2 == 0 || iParam2 == 32)
	{
		if (func_25())
		{
		...
		unk_0x54F6931BFE89203E(iVar7, &Var14, 0, 1);
	}
	else if (func_328(iParam2) > 0)
	{
		if (func_25())
		{
			unk_0x9409D2F56E25B407(func_262(func_268()));
		}
		unk_0x2A800DC75D41B200(iVar2, unk_0x36163153849DFDA1(func_209(iParam2)));
		if (func_25())
		{
			unk_0x9409D2F56E25B407(func_262(func_268()));
		}
		unk_0x06714A444AD32BE2(iVar7, &Var14, 0, 1);
	}
	if (func_25())
	{
		func_224(func_268());
...
{
	func_217(func_203(iParam0), iParam1, -1, 1, 0);
}
...
int func_369(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	...
	if (iLocal_764)
	{
		switch (iLocal_765)
		{
			case 0:
				...
				if (func_264(78225582, iParam3, iParam5, iParam4, 1, iParam1, uParam2, 4, iParam6, 3))
				{
					...
					if (iParam8 != 0)
					{
						if (func_264(78225582, iParam3, iParam8, iParam4, 1, iParam7, 1, 4, iParam6, 3))
						{
						}
						else
						{
...
int func_371(int iParam0, bool bParam1)
{
	...
	func_210(&sVar0, iParam0, bParam1);
	return unk_0x36163153849DFDA1(&sVar0);
}
...
void func_374(int iParam0)
{
	...
	iVar0 = func_27(iParam0);
	iVar1 = func_206(unk_0x95B959F18401C09A(), iVar0);
	if (func_362(iParam0, &uVar2, iVar1))
	{
		func_375(iParam0, iVar1);
		func_326(iVar1);
		func_326(iParam0);
		iLocal_573 = 1;
		iLocal_570 = 1;
...
void func_375(int iParam0, int iParam1)
{
	...
	if (func_376(iParam0, iParam1))
	{
		...
		func_302(iVar0, 0);
		func_217(func_303(iVar0), 0, -1, 1, 0);
		Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_1 = 0;
		func_217(func_304(iVar0), 0, -1, 1, 0);
		Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_4 = 0;
		func_377(func_305(iVar0), 0, -1, 1);
		Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_5 = 0;
		func_217(func_274(iVar0, 2), 0, -1, 1, 0);
		func_217(func_274(iVar0, 0), 0, -1, 1, 0);
		func_217(func_274(iVar0, 1), 0, -1, 1, 0);
		Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_6 = 0;
		func_396(func_255(iVar0), 0, -1, 1);
		if (iVar0 != 5)
		{
			func_361(iVar0);
		}
		Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_8 = 0;
		func_396(func_299(iVar0), 0, -1, 1);
		if (func_183(iParam0))
		{
			Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_11 = 0;
			Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_250 = 0;
			func_217(5442, 0, -1, 1, 0);
		}
		Global_1365050[iVar0] = 0;
		func_396(func_281(iVar0), 0, -1, 1);
...
var func_377(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_378(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	iVar1 = func_380(iParam0, iParam1);
	uVar2 = func_379(iParam0);
	if (0 != iVar1)
	{
...
int func_381()
{
	if (!iLocal_575 && func_378(9356, -1, -1) < 3)
	{
		return 1;
	}
	return 0;
...
void func_382()
{
	...
	{
		unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	unk_0xAE4810E427AD9203(2, 206, 1);
	if (unk_0x833B1A3D9F713E03(2, 206))
	{
		unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0x33CAB544FAAE661D(2))
	{
		...
		{
			unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		unk_0xAE4810E427AD9203(2, 187, 1);
		if (unk_0x833B1A3D9F713E03(2, 187))
		{
			unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0x1771F6BAF60B44FA(2, 187))
		{
			unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_RELEASE_EVENT", unk_0xBBDA792448DB5A89(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0x1771F6BAF60B44FA(2, 188))
		{
			unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_RELEASE_EVENT", unk_0xBBDA792448DB5A89(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (unk_0x833B1A3D9F713E03(2, 188))
		{
			unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(188), -1082130432, -1082130432, -1082130432, -1082130432);
			iLocal_576 = 1;
		}
		unk_0xAE4810E427AD9203(2, 187, 1);
		if (unk_0x833B1A3D9F713E03(2, 187))
		{
			unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(187), -1082130432, -1082130432, -1082130432, -1082130432);
			iLocal_576 = 1;
		}
	}
	...
	{
		unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	unk_0xAE4810E427AD9203(2, 190, 1);
	if (unk_0x833B1A3D9F713E03(2, 190))
	{
		unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	unk_0xAE4810E427AD9203(2, 201, 1);
	if (unk_0x833B1A3D9F713E03(2, 201))
	{
		unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	unk_0xAE4810E427AD9203(2, 202, 1);
	if (unk_0x833B1A3D9F713E03(2, 202))
	{
		unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(202), -1082130432, -1082130432, -1082130432, -1082130432);
		if (((iLocal_580 == 1 || iLocal_580 == -1) || iLocal_580 == 4) || iLocal_580 == 5)
		{
			if (!iLocal_574)
			{
				func_468(0);
		...
		unk_0x0F8EAEEC97DDBCB3(-1, "Click_Back", "DLC_Biker_Computer_Sounds", 1);
	}
	unk_0xAE4810E427AD9203(2, 203, 1);
	if (unk_0x833B1A3D9F713E03(2, 203))
	{
		unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	unk_0xAE4810E427AD9203(2, 204, 1);
	if (unk_0x833B1A3D9F713E03(2, 204))
	{
		unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0x33CAB544FAAE661D(2))
	{
		unk_0xBB698266C5FDF0A7(uLocal_755, "SET_MOUSE_INPUT");
		unk_0x8DAB5B12D7B9AD29(unk_0x2D0598FBFD4D8A23(2, 239));
		unk_0x8DAB5B12D7B9AD29(unk_0x2D0598FBFD4D8A23(2, 240));
		iLocal_576 = 1;
		unk_0x818901B332D5541D();
		unk_0xAE4810E427AD9203(2, 237, 1);
		...
		{
			unk_0x4A6DCCDF973E702F(uLocal_755, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(202), -1082130432, -1082130432, -1082130432, -1082130432);
			if ((iLocal_580 == 1 || iLocal_580 == -1) || iLocal_580 == 4)
			{
				if (!iLocal_574)
				{
					func_468(0);
	...
	else
	{
		...
		if (((iVar0 != 127 || iLocal_760 != 127) || iVar1 != 127) || iLocal_761 != 127)
		{
			unk_0xBB698266C5FDF0A7(uLocal_755, "SET_ANALOG_STICK_INPUT");
			iLocal_760 = iVar0;
			iLocal_761 = iVar1;
			unk_0x295B86DE57A0721D(true);
			unk_0x4D9DA18AB3C2A466(iLocal_760);
			unk_0x4D9DA18AB3C2A466(iLocal_761);
			unk_0x818901B332D5541D();
			iLocal_576 = 1;
		}
	}
	...
	if (((iVar2 != 127 || iLocal_762 != 127) || iVar3 != 127) || iLocal_763 != 127)
	{
		...
		unk_0x4D9DA18AB3C2A466(iLocal_762);
		unk_0x4D9DA18AB3C2A466(iLocal_763);
		unk_0x295B86DE57A0721D(bVar4);
		unk_0x818901B332D5541D();
		if (!bVar4)
		{
...
void func_383()
{
	...
	unk_0x5C58D0ADA22491FA(1);
	unk_0xFF524AE40FB6301A(uLocal_755, 255, 255, 255, 255, 0);
	func_390();
	func_387(0);
	func_384(1);
}
...
int func_397()
{
	return func_398(&uLocal_590, "BPLESAU", "BPLES_TUT1", 8, 0, 0, 0);
}

int func_398(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_414(uParam0, 145, sParam1, iParam4, iParam5, iParam6);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_406()
{
	...
	{
		if (func_409(Global_106565.f_2357.f_539.f_4321) != unk_0x541D5C57194E73C4(unk_0x33CD235DF1E6A94E()))
		{
			iVar0 = func_408(unk_0x33CD235DF1E6A94E());
			if (func_407(iVar0) && (!func_410(14) || Global_105516))
			{
				if (Global_106565.f_2357.f_539.f_4321 != iVar0 && func_407(Global_106565.f_2357.f_539.f_4321))
				{
...
void func_414(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)
{
...
{
	if (func_416(Global_1589819[iParam0 /*818*/].f_273.f_25, -1) && !unk_0x0E4018692D92041D(Global_1589819[iParam0 /*818*/].f_273.f_23, 1))
	{
		return 1;
	}
	return 0;
...
float func_418(var uParam0, struct<3> Param1, int iParam4)
{
	struct<3> Var0;
...
{
	func_427(1);
	func_426(&uLocal_590, 2, 0, "LJT", 0, 1);
}
...
void func_431()
{
	...
	if (func_448())
	{
		...
		iVar0 = func_423(iLocal_584);
		iVar1 = iLocal_584;
		iVar2 = func_27(iLocal_584);
		func_326(iVar1);
		if (!func_17(iLocal_584))
		{
			iVar3 = func_348(unk_0x95B959F18401C09A(), iLocal_584, func_422(unk_0x95B959F18401C09A(), iLocal_584));
			fVar4 = (unk_0xBBDA792448DB5A89(iVar3) * Global_262145.f_18468);
			iVar5 = unk_0xF2DB717A73826179(fVar4);
			func_438(func_237(iLocal_584), &cVar10, &cVar6);
			func_437(iVar1, 1, &cVar6, &cVar10, iVar5, 1);
			func_438(!func_237(iLocal_584), &cVar10, &cVar6);
			fVar4 = (unk_0xBBDA792448DB5A89(iVar3) * Global_262145.f_18469);
			iVar5 = unk_0xF2DB717A73826179(fVar4);
			func_437(iVar1, 2, &cVar6, &cVar10, iVar5, 1);
		}
		iVar14 = 0;
		while (iVar14 < 12)
		{
			iVar15 = iVar14;
			bVar16 = true;
			Var17 = { func_436(iVar2, iVar15) };
			if (func_28(unk_0x95B959F18401C09A(), iLocal_584, iVar15) || Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_4 <= 0)
			{
				bVar16 = false;
			}
			iVar21 = func_19(iVar15, iLocal_584);
			iVar22 = -1;
			if (func_435(iLocal_584, iVar15) && bVar16)
			{
				iVar22 = iVar21;
				iVar21 = func_434(iVar15, iLocal_584);
			}
			func_432(iVar1, iVar14 + 1, func_433(iVar15), iVar21, iVar22, bVar16, &Var17);
			iVar14++;
		}
	}
	else
...
void func_432(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, char* sParam6)
{
	unk_0xBB698266C5FDF0A7(uLocal_755, "ADD_BUSINESS_UPGRADE");
	unk_0x4D9DA18AB3C2A466(iParam0);
	unk_0x4D9DA18AB3C2A466(iParam1);
	unk_0x86B03D46DC28E3ED(uParam2);
	unk_0x4D9DA18AB3C2A466(iParam3);
	unk_0x86B03D46DC28E3ED(uParam6);
	unk_0x4D9DA18AB3C2A466(iParam4);
	unk_0x818901B332D5541D();
	unk_0xBB698266C5FDF0A7(uLocal_755, "SET_BUSINESS_UPGRADE_STATUS");
	unk_0x4D9DA18AB3C2A466(iParam0);
	unk_0x4D9DA18AB3C2A466(iParam1);
...
{
	return func_19(iParam1, iParam0) < func_434(iParam1, iParam0);
}

struct<4> func_436(int iParam0, int iParam1)
{
	struct<4> Var0;
...
void func_437(int iParam0, int iParam1, char[4] cParam2, char* sParam3, int iParam4, bool bParam5)
{
	unk_0xBB698266C5FDF0A7(uLocal_755, "ADD_BUSINESS_BUYER");
	unk_0x4D9DA18AB3C2A466(iParam0);
	unk_0x4D9DA18AB3C2A466(iParam1);
	unk_0x86B03D46DC28E3ED(cParam2);
	unk_0x86B03D46DC28E3ED(sParam3);
	unk_0x4D9DA18AB3C2A466(iParam4);
	unk_0x818901B332D5541D();
	unk_0xBB698266C5FDF0A7(uLocal_755, "SET_BUSINESS_BUYER_STATUS");
	unk_0x4D9DA18AB3C2A466(iParam0);
	unk_0x4D9DA18AB3C2A466(iParam1);
	unk_0x295B86DE57A0721D(bParam5);
	unk_0x818901B332D5541D();
...
void func_438(bool bParam0, char* sParam1, char* sParam2)
{
	if (bParam0)
	{
...
void func_439(bool bParam0)
{
	...
	uVar0 = func_441(unk_0x95B959F18401C09A());
	if (unk_0x786AF4A44E1B5B4B(uVar0))
	{
		uVar0 = func_440();
	}
	unk_0xBB698266C5FDF0A7(uLocal_755, "SET_PLAYER_DATA");
	unk_0x86B03D46DC28E3ED(uVar0);
...
{
	if (((func_34(iParam0, 28) || func_34(unk_0x95B959F18401C09A(), 28)) || func_447(iParam0)) && !func_445(iParam0))
	{
		return func_440();
	}
	if (iParam0 != unk_0x95B959F18401C09A())
	...
	if (func_443(iParam0, 1))
	{
		if (func_64(iParam0))
		{
			return func_442(&(Global_1626536[iParam0 /*603*/].f_11.f_104));
		}
		else
		{
			return func_442(&(Global_1626536[iParam0 /*603*/].f_11.f_373));
		}
	}
	else
	{
...
{
	return func_444(iParam0, bParam1, 1);
}
...
struct<13> func_446(int iParam0)
{
	struct<13> Var0;
	...
	else
	{
		...
		if (unk_0xC4DEA49C5B465481(iParam0) && (unk_0xF272A2699B521CE6(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_246(unk_0x95B959F18401C09A(), 0) && !func_454()))
				{
			...
			if (bParam1)
			{
				if (!func_453(uVar25) && !unk_0x67E42C11097164BA(uVar25))
				{
					if (!bVar21)
					{
			...
			else
			{
				if (!func_453(uVar25) && !unk_0x67E42C11097164BA(uVar25))
				{
					...
					if (func_450(Global_4456448.f_161209))
					{
...
int func_458(int iParam0)
{
	if (func_460(iParam0))
	{
		return func_459(Global_2424047[iParam0 /*416*/].f_309.f_5);
	}
	return 0;
}
...
int func_460(int iParam0)
{
	if (iParam0 != func_5())
	{
		if (func_248(iParam0, 1, 1))
		{
			...
			{
				return func_461(Global_2424047[iParam0 /*416*/].f_309.f_5) == 2;
			}
		}
	}
	return 0;
...
void func_468(int iParam0)
{
	...
	unk_0x83A1D480DB0B52CC(&uLocal_755);
	func_462(iParam0);
	func_464(0);
	func_472();
	unk_0x671D054583DD5BFC(1000);
	unk_0x0F8EAEEC97DDBCB3(-1, "Exit", "DLC_Biker_Computer_Sounds", 1);
	if (unk_0x4CE1DD5CFC1F941E())
	{
		func_424(0, 1, 1, 1);
	}
	if (!func_460(unk_0x95B959F18401C09A()))
	{
		func_449(unk_0x95B959F18401C09A(), 1, 0, 0);
	}
	if (func_428(7638, -1, -1) && func_471())
	{
		Var0 = { func_470() };
		if (unk_0xCE3CFF625BEBAA04(&Var0, "BPLES_TUT1"))
		{
			func_396(7638, 0, -1, 1);
			func_469();
		}
