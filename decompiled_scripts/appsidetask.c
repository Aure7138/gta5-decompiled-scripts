...
void func_5()
{
	unk_0x545012F14516B7DC(0.824f, 0.5f, 0.253f, 0.313f, 0, 0, 0, 155, 0);
	func_6();
}
...
void func_6()
{
	...
	unk_0xD49409263C7DA1DD(0f, 0.93f);
...
void func_9()
{
	...
	unk_0xAF24EA89F4EF8594(255, 128, 0, 255);
	unk_0x74F2ECA031310618(1, 0, 78, 255, 255);
}
