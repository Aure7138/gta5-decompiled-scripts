...
void __EntryFunction__()
{
	...
	if (unk_0x78BF2001491914AC(67))
	{
		...
		if (bVar23)
		{
			if (unk_0x2137828D03306CAF(iLocal_400) && unk_0x769F0F6444C1ABE0(iLocal_400))
			{
				func_257(80, 1);
				unk_0x0D7634B211BCB8B0(joaat("sp_killed_dr_friedlander"), 1, 1);
			}
			func_255(0, 0);
		}
		else
	...
	unk_0x03F063804FDEDF1C(-1899.756f, -561.3688f, 10.78784f, 100f);
	...
	if (!unk_0x859EE44BE17CBC0F(unk_0x0FFED3E94261A832()) && !unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()))
	{
	...
	while (true)
	{
		...
		switch (iLocal_60)
		{
			case 0:
				if (func_237())
				{
					unk_0x0013D519C885E60B(unk_0x2A5EB8B0FE590B91(), joaat("weapon_unarmed"), -1, 0, 1);
				}
				...
				func_231();
				while (unk_0xC4A39E4229BD3ABE(unk_0x2A5EB8B0FE590B91(), 1))
				{
					unk_0x4EDE34FBADD967A6(0);
				}
				unk_0x28FB7E63A217D6DE(unk_0x2A5EB8B0FE590B91(), -1918.944f, -577.8114f, 10.8764f, 1f, -1, 1048576000, 0, 1193033728);
				uVar12 = unk_0xAAB0D8F87DC2361F(26379945, -1896.529f, -545.7853f, 18.7228f, 3.1482f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
				uVar13 = unk_0xAAB0D8F87DC2361F(26379945, -1896.866f, -547.7337f, 18.8316f, 4.9529f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
				unk_0x8D1BBCBB0981EC8D(uVar13, uVar12, 5000, 1, 1);
			...
			case 1:
				...
				if (bVar4)
				{
					if (!bVar5)
					{
						if (unk_0x4492AAB360D28093())
						{
							...
							{
								func_123(&cLocal_407, unk_0x2A5EB8B0FE590B91(), 0, 2);
							}
							if (!unk_0xA9A04898798AE9E6(iLocal_399, 0))
							{
				...
				{
					if (!unk_0xA9A04898798AE9E6(unk_0x2A5EB8B0FE590B91(), 0) && !unk_0xA9A04898798AE9E6(iLocal_399, 0))
					{
						unk_0x063C67E5BF3D0895(unk_0x2A5EB8B0FE590B91(), &cLocal_407, 0, 0, 0);
						unk_0x063C67E5BF3D0895(iLocal_399, &cLocal_413, 0, 0, 0);
					}
					unk_0x256CC452D2C1731B(0);
					unk_0x14C8C7CE9B1CB5A5();
					unk_0x39E6BFF51A22111E();
					unk_0x749F8DABD0CEE89A(-1906.842f, -572.3835f, 19.1046f, -1.5254f, 0.0003f, 171.4657f, 12f, 0);
					func_119(&uLocal_248);
					func_119(&uVar6);
					iLocal_60 = 2;
				}
			...
			case 2:
				if (unk_0x9FA769EB6C3BCCE4(uVar12))
				{
					unk_0x1E2E6AAAD9AE1286(uVar12, 0);
				}
				if (unk_0x9FA769EB6C3BCCE4(uVar13))
				{
					unk_0x1E2E6AAAD9AE1286(uVar13, 0);
				}
				if (unk_0x2C290803FEDB1727(&cLocal_407, 0))
				{
					func_118(iLocal_399, 1, 0);
				}
				if (unk_0x2C290803FEDB1727(&cLocal_413, 0))
				{
			...
			case 3:
				func_108();
				if (unk_0xF4EE9D6C8E60AE22() || bVar24)
				{
					if (bVar24)
					{
					...
					while (unk_0xFD918707B1B07874() && !unk_0xAFCB22D9B08750BD())
					{
						unk_0x4EDE34FBADD967A6(0);
						func_108();
					}
					func_107(&uLocal_251);
					bVar24 = false;
					unk_0x9B0467159FAB9F56(400);
				}
				if (!bVar2)
				{
					if (!bLocal_435 && !unk_0x4F561A675BAC81C6())
					{
						Local_61.f_20 = 0;
				...
				else if ((func_121(&uLocal_251) > 5f && func_120()) || (unk_0xA1EDDE074DA26387() && ((Local_61.f_20 != 1 || func_121(&uLocal_251) > fVar22) || func_81(iLocal_82, iLocal_399, &uLocal_404))))
				{
					func_78();
					if (!unk_0xA9A04898798AE9E6(unk_0x2A5EB8B0FE590B91(), 0))
					{
					...
					unk_0x256CC452D2C1731B(0);
					unk_0xFD213087BC4CC3B3(iLocal_59);
					iLocal_60 = 14;
				}
				if (!bVar5 && bLocal_435)
				{
			...
			case 14:
				if (unk_0x9FA769EB6C3BCCE4(uLocal_404))
				{
					unk_0xB9658EBA374EC2AD(0, 0, 3000, 1, 0, 0);
					unk_0x1E2E6AAAD9AE1286(uLocal_404, 0);
				}
				if (((func_77() && unk_0x863D84AFAC2AB730()) && !unk_0xEF08C8E0C4679477()) && !unk_0xF4EE9D6C8E60AE22())
				{
				...
				if (unk_0x05E45421C17E15FD(0))
				{
					...
					else
					{
						...
						if (!unk_0xA9A04898798AE9E6(unk_0x2A5EB8B0FE590B91(), 0))
						{
							...
							unk_0x81642E3BC0111BF2(unk_0x2A5EB8B0FE590B91(), 1, 0);
							unk_0xA32D9C84C1A93920(unk_0x2A5EB8B0FE590B91(), 0);
							func_74(unk_0x2A5EB8B0FE590B91(), -1902.609f, -559.9267f, 10.7916f);
							unk_0x2681BA3707AF6DA7(unk_0x2A5EB8B0FE590B91(), fLocal_426);
							unk_0x164CA344DBD7B6F3(0f);
							unk_0x61C3B2A4FEFA1D6D(0f, 1065353216);
							func_65(0, 1, 1, 0);
							iLocal_402 = unk_0x19D9DFABC3C7D219();
							if (unk_0x2137828D03306CAF(iLocal_402))
							{
								if (!unk_0xA9A04898798AE9E6(iLocal_402, 0))
								{
									unk_0x8E979F037EACE55A(iLocal_402, func_64(iLocal_402), 1, 0, 0, 1);
									unk_0x2681BA3707AF6DA7(iLocal_402, 231f);
								}
							}
							if (unk_0xF4EE9D6C8E60AE22())
							{
								if (!iLocal_436)
								{
									unk_0x749F8DABD0CEE89A(-1903.87f, -562.9188f, 12.8354f, func_63(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
									iLocal_436 = 1;
									unk_0x4EDE34FBADD967A6(0);
								}
								if (!iLocal_437)
				...
				else
				{
					if (!iLocal_436)
					{
						if (unk_0xC01930F478B14879() > 60000)
						{
							if (iLocal_82 == 4)
							{
								unk_0x749F8DABD0CEE89A(-1905.5f, -557.8768f, 12.4125f, func_63(Vector(11.9712f, -560.4745f, -1903.855f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
							}
							else
							{
								unk_0x749F8DABD0CEE89A(-1903.87f, -562.9188f, 12.8354f, func_63(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
					...
					if (!iLocal_437)
					{
						if (unk_0x96EAB4D6F5C6CD68() >= 16)
						{
							...
							else if (func_121(&uVar9) > func_61(func_239()))
							{
								if (func_239() == 4)
								{
									iLocal_400 = unk_0xD00B79C0E206E082(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
									unk_0x6CA29A70250F194F(iLocal_400, 3, iLocal_432, uLocal_433, 0);
									unk_0x6CA29A70250F194F(iLocal_400, 4, 0, uLocal_434, 0);
									unk_0x88D9DF53359130B9(iLocal_400, (2000 + unk_0x895FB9FE885E36ED(5, 301)));
									unk_0xD44F61F61676BA14(iLocal_400, 1);
			...
			case 15:
				...
				if (unk_0xA9A04898798AE9E6(iLocal_400, 0))
				{
					func_257(80, 1);
					unk_0x0D7634B211BCB8B0(joaat("sp_killed_dr_friedlander"), 1, 1);
					func_84(&uLocal_83, "DrfAud", "DRF_KILL", 9, 0, 0, 0);
					if (unk_0xBDD3EABACAB97D09(uLocal_403))
					{
						unk_0xEB5D36079067EBA5(uLocal_403, 1);
					}
					iLocal_60 = 17;
				}
				else if (!unk_0x2137828D03306CAF(iLocal_400) || func_59(iLocal_400, unk_0x2A5EB8B0FE590B91(), 1) > 300f)
				{
					func_84(&uLocal_83, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
					if (unk_0xBDD3EABACAB97D09(uLocal_403))
					{
						unk_0xEB5D36079067EBA5(uLocal_403, 3);
					}
					if (unk_0x2137828D03306CAF(iLocal_400))
					{
						unk_0xCF5A819ECA466C6C(unk_0xD1EE0E9FCD74A37B(iLocal_400, 1), 10f, 0);
					}
					iLocal_60 = 17;
				}
				else
				{
					func_47();
					unk_0x31AC59B7C21A2047(iLocal_400, 26, 1);
					if (func_62(&uLocal_266))
					{
						if (func_121(&uLocal_266) > 2.5f)
						{
							unk_0xBA338CFC66A5608A(unk_0x0FFED3E94261A832(), 2f, 1000, 0, 1, 0);
							unk_0x73EC54DB6766EF37(unk_0x0FFED3E94261A832(), 0, 0);
							func_119(&uLocal_266);
						}
					}
					if (!iLocal_439)
					{
						...
						if (func_121(&uLocal_263) > 2f)
						{
							...
							uLocal_404 = unk_0xAAB0D8F87DC2361F(26379945, Var26, Var29, 50f, 0, 2);
							unk_0x8D1BBCBB0981EC8D(uLocal_404, uLocal_405, 2660, 1, 1);
							if (unk_0x2137828D03306CAF(iLocal_402) && !unk_0xA9A04898798AE9E6(iLocal_402, 0))
							{
								unk_0x1FD7155AA0D91CFA(iLocal_402);
								unk_0xF65C7766FB8D4B2C(iLocal_402, 0);
								unk_0x036812C583B4220C(iLocal_402, 1);
							}
							func_107(&uLocal_263);
							iLocal_439 = 1;
						}
					...
					else if (unk_0x9FA769EB6C3BCCE4(uLocal_405))
					{
						if (func_121(&uLocal_263) >= 2.66f)
						{
							unk_0x164CA344DBD7B6F3(func_46(unk_0xAD69426B73C6E186() == 2, -16f, 0f));
							unk_0xB9658EBA374EC2AD(0, 1, 340, 0, 0, 0);
							unk_0x1E2E6AAAD9AE1286(uLocal_405, 0);
						}
						else
						{
							unk_0x164CA344DBD7B6F3(0f);
					...
					if (iLocal_438 && unk_0x7B0D0EA42CF4A6CC(unk_0x0FFED3E94261A832()))
					{
						if (func_44(&uLocal_257, 0.5f))
						{
							...
							if (!unk_0xBDD3EABACAB97D09(uLocal_403))
							{
								if (!unk_0xA9A04898798AE9E6(iLocal_400, 0))
								{
									uLocal_403 = unk_0x9E3A324AB806771E(iLocal_400);
									unk_0xEB5D36079067EBA5(uLocal_403, 1);
									func_107(&uLocal_257);
								}
							}
							else if (unk_0x53AE6C246AD237D5(uLocal_403) != 3)
							{
								unk_0xEB5D36079067EBA5(uLocal_403, 3);
					...
					if (!unk_0x769F0F6444C1ABE0(iLocal_400))
					{
						if (unk_0x2137828D03306CAF(iLocal_401))
						{
							if (unk_0xC4A39E4229BD3ABE(iLocal_400, 0))
							{
								iVar0 = 1;
							}
							if (!unk_0xE4B596B1029F4F6A(iLocal_400))
							{
								if ((((((((!unk_0x7FAC45D56235AB39(iLocal_401, 0) || unk_0x5B9B499C707C2A95(unk_0x2A5EB8B0FE590B91(), iLocal_401, 1)) || unk_0x12CF5C6534A94BEE(iLocal_401, 0, 2000)) || unk_0x12CF5C6534A94BEE(iLocal_401, 1, 2000)) || unk_0x12CF5C6534A94BEE(iLocal_401, 2, 2000)) || unk_0x12CF5C6534A94BEE(iLocal_401, 3, 2000)) || (iVar0 && !unk_0xC4A39E4229BD3ABE(iLocal_400, 0))) || func_40(iLocal_401)) || func_36(iLocal_401))
								{
									unk_0xCD6FB688ED8B6284(iLocal_400, unk_0x2A5EB8B0FE590B91(), 3000f, -1, 0, 0);
								}
							}
						}
						else if (!unk_0xE4B596B1029F4F6A(iLocal_400))
						{
							unk_0xCD6FB688ED8B6284(iLocal_400, unk_0x2A5EB8B0FE590B91(), 3000f, -1, 0, 0);
						}
						if (!bVar25 && !unk_0x9A46207BB68ED2F0(iLocal_400, -1892.139f, -567.194f, 10.5f, -1904.935f, -556.4423f, 13.5f, 4.73f, 0, 1, 0))
						{
							unk_0x4C47904AE69D7393(iLocal_400, 0);
							bVar25 = true;
						}
					}
				}
			...
			case 17:
				...
				if (func_121(&uLocal_254) > 4f || unk_0xF4EE9D6C8E60AE22())
				{
					unk_0x789C84F1B8496AD0(&uLocal_403);
					if (unk_0x9FA769EB6C3BCCE4(uLocal_404))
					{
						unk_0x1E2E6AAAD9AE1286(uLocal_404, 0);
					}
					...
					if (!func_1(80))
					{
						if (unk_0x2137828D03306CAF(iLocal_400))
						{
							if (unk_0x2137828D03306CAF(iLocal_401) && unk_0x5B9B499C707C2A95(iLocal_400, iLocal_401, 0))
							{
								unk_0xA613FDAC42DBBFAD(&iLocal_401);
							}
						}
						unk_0x27BAC9B39BCC6522(&iLocal_400);
					}
...
int func_2(int iParam0, int iParam1, int iParam2)
{
	...
	return func_3(Global_103236.f_27831[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_6(int iParam0)
{
	...
	else if (unk_0xAA4F14DA15DB0B51(Global_103236.f_20345.f_471, iParam0) || unk_0xAA4F14DA15DB0B51(Global_2097152[func_8() /*10885*/].f_7546.f_10, iParam0))
	{
		bVar0 = true;
		unk_0x507FE690B1271947(&(Global_103236.f_20345.f_471), iParam0);
		unk_0x507FE690B1271947(&(Global_2097152[func_8() /*10885*/].f_7546.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		unk_0xD05F099FEF4ED10A("COUP_RED");
		unk_0xD5DA3EC5EEC78358(func_7(iParam0));
...
bool func_10(int iParam0)
{
	...
	return unk_0xAA4F14DA15DB0B51(Global_2097152[func_8() /*10885*/].f_7546.f_10, iParam0);
}
...
int func_13(int iParam0, int iParam1)
{
	...
	if (func_23(&Global_2600921))
	{
		if (func_21(&Global_2600921, iParam0))
		{
			return 0;
		}
		if (func_14(&Global_2600921, iParam0))
		{
			return 1;
		}
	}
...
void func_17(var uParam0)
{
	...
	func_19(uParam0, (Global_2600920 - 0.5f));
}
...
void func_32()
{
	...
	if (unk_0x2137828D03306CAF(unk_0x2A5EB8B0FE590B91()))
	{
		if (func_35(Global_103236.f_2164.f_539.f_4301) != unk_0xD3B21CE53AA7BE51(unk_0x2A5EB8B0FE590B91()))
		{
			...
			if (func_33(iVar0) && (!func_25(14) || Global_102188))
			{
...
int func_36(int iParam0)
{
	...
	if ((func_39(unk_0x2A5EB8B0FE590B91()) && unk_0xC4A39E4229BD3ABE(unk_0x2A5EB8B0FE590B91(), 0)) && func_37(iParam0))
	{
...
{
	uParam0->f_1 = (func_42(unk_0xAA4F14DA15DB0B51(*uParam0, 4)) - fParam1);
...
void func_47()
{
	...
	if ((!unk_0x2137828D03306CAF(iLocal_400) || unk_0xA9A04898798AE9E6(iLocal_400, 0)) || unk_0xA9A04898798AE9E6(unk_0x2A5EB8B0FE590B91(), 0))
	{
		return;
	}
	...
	fVar6 = unk_0xB7A628320EFF8E47(unk_0xD1EE0E9FCD74A37B(unk_0x2A5EB8B0FE590B91(), 1), unk_0xD1EE0E9FCD74A37B(iLocal_400, 1));
	if (iLocal_429 < 7)
	{
		if (iLocal_429 <= 0)
		{
			...
			{
				iVar4 = unk_0x895FB9FE885E36ED(0, 7);
				unk_0xF6082E2ADA1C795B(&uLocal_428, iVar4);
		...
		{
			if (fVar6 <= 144f && !unk_0xFFAAE8D0237CEDEB(unk_0x2A5EB8B0FE590B91()))
			{
				iVar4 = unk_0x895FB9FE885E36ED(0, (7 - iLocal_429));
				while (iVar5 >= 0 && iVar5 < 7)
				{
					if (!unk_0xAA4F14DA15DB0B51(uLocal_428, iVar5))
					{
						if (iVar4 == 0)
						{
							unk_0xF6082E2ADA1C795B(&uLocal_428, iVar5);
							iVar4 = iVar5;
							iVar5 = -2;
						}
						else
	...
	if (iLocal_431 < 8)
	{
		if (iLocal_431 <= 0)
		{
			if (func_121(&uLocal_272) > 1f && !unk_0xFFAAE8D0237CEDEB(iLocal_400))
			{
				iVar4 = unk_0x895FB9FE885E36ED(0, 8);
				unk_0xF6082E2ADA1C795B(&uLocal_430, iVar4);
		...
		{
			if (fVar6 <= 2500f && !unk_0xFFAAE8D0237CEDEB(iLocal_400))
			{
				iVar4 = unk_0x895FB9FE885E36ED(0, (8 - iLocal_431));
				iVar5 = 0;
				while (iVar5 >= 0)
				{
					if (!unk_0xAA4F14DA15DB0B51(uLocal_430, iVar5))
					{
						if (iVar4 == 0)
						{
							unk_0xF6082E2ADA1C795B(&uLocal_430, iVar5);
							iVar4 = iVar5;
							iVar5 = -2;
						}
						else
	...
	if (((!iLocal_438 && iLocal_429 >= 1) && iLocal_431 >= 1) && !unk_0x5CA780C6DF42F0B0())
	{
		iLocal_438 = 1;
	}
}
...
Vector3 func_64(int iParam0)
{
	...
	unk_0xDC850475E5EA7BAB(iParam0, &uVar0, &uVar3, &uVar6, &uVar9);
	unk_0xDE3E0D9E2E663E9A(unk_0xD3B21CE53AA7BE51(iParam0), &uVar12, &Var15);
...
void func_65(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (unk_0x591AF4C50B46E014())
		{
			if (((!unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()) && !func_70(unk_0x0FFED3E94261A832())) && !func_67(unk_0x0FFED3E94261A832(), 0)) && !func_66())
			{
...
void func_76()
{
	...
	if (!unk_0x7FAC45D56235AB39(iLocal_401, 0))
	{
		unk_0xA613FDAC42DBBFAD(&iLocal_401);
		iLocal_401 = unk_0xE42A511281C9895B(iLocal_57, Local_422, fLocal_427, 1, 1, 0);
		unk_0x23B7F0BEB9890E62(iLocal_401, 6);
	}
	if (unk_0x2137828D03306CAF(iLocal_399))
	{
		unk_0x27BAC9B39BCC6522(&iLocal_399);
	}
	if ((!unk_0xA9A04898798AE9E6(unk_0x2A5EB8B0FE590B91(), 0) && !unk_0xA9A04898798AE9E6(iLocal_401, 0)) && unk_0x7FAC45D56235AB39(iLocal_401, 0))
	{
		unk_0x8E979F037EACE55A(unk_0x2A5EB8B0FE590B91(), -1907.827f, -560.0641f, 10.8064f, 1, 0, 0, 1);
		unk_0x2681BA3707AF6DA7(unk_0x2A5EB8B0FE590B91(), 260.195f);
		unk_0x8E979F037EACE55A(iLocal_401, Local_422, 1, 0, 0, 1);
		unk_0x2681BA3707AF6DA7(iLocal_401, fLocal_427);
		if (unk_0x2137828D03306CAF(iLocal_402))
		{
			if (!unk_0xA9A04898798AE9E6(iLocal_402, 0))
			{
				unk_0x1FD7155AA0D91CFA(iLocal_402);
				unk_0xF65C7766FB8D4B2C(iLocal_402, 1);
				unk_0x036812C583B4220C(iLocal_402, 0);
				unk_0x8E979F037EACE55A(iLocal_402, func_64(iLocal_402), 1, 0, 0, 1);
				unk_0x2681BA3707AF6DA7(iLocal_402, 231f);
			}
		}
		...
		if ((!iLocal_437 || !unk_0x2137828D03306CAF(iLocal_400)) || unk_0xA9A04898798AE9E6(iLocal_400, 0))
		{
			iLocal_400 = unk_0xD00B79C0E206E082(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
			unk_0x6CA29A70250F194F(iLocal_400, 3, iLocal_432, uLocal_433, 0);
			unk_0x6CA29A70250F194F(iLocal_400, 4, 0, uLocal_434, 0);
			unk_0x88D9DF53359130B9(iLocal_400, (2000 + unk_0x895FB9FE885E36ED(5, 301)));
			unk_0xD44F61F61676BA14(iLocal_400, 1);
			unk_0x4C47904AE69D7393(iLocal_400, 1);
			func_60(&uLocal_83, 1, iLocal_400, "FRIEDLANDER", 0, 1);
			iLocal_437 = 1;
		}
		else
		{
			unk_0x8E979F037EACE55A(iLocal_400, -1899.7f, -562.2f, 10.7945f, 1, 0, 0, 1);
			unk_0x2681BA3707AF6DA7(iLocal_400, 217.9453f);
			unk_0x5DE3EC94E90BB96F(iLocal_400);
			unk_0xD605CAC9F8611B4D(iLocal_400, -1);
		}
		if (unk_0xF4EE9D6C8E60AE22())
		{
			if (!iLocal_436)
			{
				unk_0x749F8DABD0CEE89A(-1905.5f, -557.8768f, 12.4125f, func_63(Vector(12.4748f, -560.2881f, -1904.709f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
				iLocal_436 = 1;
				unk_0x4EDE34FBADD967A6(0);
			}
			while (!unk_0xAFCB22D9B08750BD() || (!unk_0x769F0F6444C1ABE0(iLocal_400) && !unk_0x39A87EB82832D16C(iLocal_400)))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			if (!unk_0xA9A04898798AE9E6(unk_0x2A5EB8B0FE590B91(), 0))
		...
		fVar0 = 2f;
		if (!unk_0x769F0F6444C1ABE0(iLocal_400) && !unk_0xA9A04898798AE9E6(iLocal_401, 0))
		{
			unk_0x219EE6A7B599E7DC(&uLocal_406);
			unk_0xA6AC097BEBB7B1F0(0, iLocal_401, -1, -1, fVar0, 1, 0);
			unk_0xED057CE9299687BC(0, iLocal_401, -1783.73f, -629.1945f, 9.89f, 20f, 0, unk_0xD3B21CE53AA7BE51(iLocal_401), 786484, 10f, 12f);
			unk_0x37959C6A7F431781(0, iLocal_401, 19f, 786484);
			unk_0xBD718C5BA2122192(uLocal_406);
			unk_0x234E551BB8E8813B(iLocal_400, uLocal_406);
			unk_0xAEE1122D64BCDB87(iLocal_400, joaat("MotionState_Run"), 1, 1, 1);
		}
		uLocal_403 = unk_0x9E3A324AB806771E(iLocal_400);
		unk_0xEB5D36079067EBA5(uLocal_403, 1);
		func_107(&uLocal_257);
		unk_0x164CA344DBD7B6F3(0f);
		unk_0x61C3B2A4FEFA1D6D(0f, 1065353216);
		uLocal_405 = unk_0xAAB0D8F87DC2361F(26379945, -1904.615f, -558.892f, 12.8339f, -9.0794f, 0f, -127.4455f, 50f, 1, 2);
		unk_0xB9658EBA374EC2AD(1, 0, 3000, 1, 0, 0);
		unk_0xA6C8C7573424CA93(0);
		unk_0xDA0C5084402DA99C(0);
	}
	unk_0x333EF04F1A5ADEB5(-1886.884f, -571.1942f, 11.3828f, 2.5f, 1, 1, 0, 0);
	unk_0xE42A511281C9895B(iLocal_58, -1886.884f, -571.1942f, 11.3828f, -40.83f, 1, 1, 0);
}
...
int func_81(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_82())
	{
		if (!unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()) && !unk_0x769F0F6444C1ABE0(iParam1))
		{
			if (!unk_0x453DB1DBE5D81637(unk_0x2A5EB8B0FE590B91(), &cVar1, &Var13, 3))
			{
				unk_0xF1C3427BFED79E6B(unk_0x2A5EB8B0FE590B91(), &cVar1, &Var13, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				unk_0xF1C3427BFED79E6B(iParam1, &cVar1, &cVar21, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				unk_0xF1C3427BFED79E6B(unk_0x2A5EB8B0FE590B91(), &cVar9, &cVar25, 2f, -1000f, -1, 32 | iVar0, 0, 0, 4, 0);
				unk_0xF1C3427BFED79E6B(iParam1, &cVar9, &cVar31, 2f, -1000f, -1, 32 | iVar0, 0, 0, 0, 0);
				unk_0xB1D181DBFC526F52(unk_0x2A5EB8B0FE590B91(), 0, 0);
				unk_0xB1D181DBFC526F52(iParam1, 0, 0);
				...
				if (!unk_0x9FA769EB6C3BCCE4(*uParam2))
				{
					*uParam2 = unk_0xCF3DF64B225054FA(26379945, 0);
				}
				unk_0xADF936AD56C4C4C0(*uParam2, -1906.842f, -572.3835f, 19.1046f);
				unk_0x28BE4B7676B6AD67(*uParam2, -1.5254f, 0.0003f, 171.4657f, 2);
				unk_0x4DD38134E80D1D6A(*uParam2, 17f);
				unk_0xD429163073BD3A47(*uParam2, 1);
				unk_0xB9658EBA374EC2AD(1, 0, 3000, 1, 0, 0);
			}
			else if (unk_0x1E479544F884CFB5(unk_0x2A5EB8B0FE590B91(), &cVar1, &Var13) >= 0.99f)
			{
				return 1;
			}
		}
...
bool func_82()
{
	return (unk_0x45834D6C20FFF689("missdrfriedlanderdrf_idles") && unk_0x45834D6C20FFF689("facials@drf"));
}
...
int func_85(var uParam0, var uParam1, var uParam2)
{
	...
	{
		bVar0 = unk_0x92BC4A8239BDDACC(2, 201);
		uVar1 = unk_0x92BC4A8239BDDACC(2, 202);
		if (bVar0 || uVar1)
		{
			if (bVar0)
			{
...
void func_86(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (!func_91(uParam0->f_1, 256) || (func_91(uParam0->f_1, 8192) && unk_0x94CC8BB8EDADFF62(2)))
	{
		...
		if (unk_0x5018862FF5D9F844())
		{
			...
			unk_0xD426F7366505EADF(func_91(uParam0->f_1, 4096));
			unk_0x8123397DC676E794();
		}
		iVar5 = 0;
		iVar6 = 0;
...
void func_95(var uParam0, var uParam1, int iParam2)
{
	...
	iVar0 |= 98304;
	unk_0x8243AC20524825EB(uParam0, iVar0, 8);
}
...
int func_96(var uParam0, int iParam1)
{
	...
	if (unk_0x35302CD5A5D37EED(&Var1, "OBTSX01"))
	{
		return 8;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTSX02"))
	{
		return 16;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTSX03"))
	{
		return 32;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTSX04"))
	{
		return 64;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTSX05"))
	{
		return 128;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTSX06"))
	{
		return 256;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTSX07"))
	{
		return 512;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTSX08"))
	{
		return 1024;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTSX09"))
	{
		return 2048;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTSX10"))
	{
		return 4096;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTSX11"))
	{
		return 8192;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTSX12"))
	{
		return 16384;
	}
	return 8;
...
struct<4> func_97(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_98(&(Global_103236.f_19742), iVar4, 1);
	}
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 13) && !func_103(&(Global_103236.f_19742), iParam0))
	{
		iVar2[iParam0] = 0;
	}
	else if ((iParam1 > 0 && iParam1 < 13) && !func_103(&(Global_103236.f_19742), iParam1))
	{
		iVar2[iParam1] = 0;
	}
	else if ((iParam2 > 0 && iParam2 < 13) && !func_103(&(Global_103236.f_19742), iParam2))
	{
		iVar2[iParam2] = 0;
	}
	else if ((iParam3 > 0 && iParam3 < 13) && !func_103(&(Global_103236.f_19742), iParam3))
	{
		iVar2[iParam3] = 0;
	}
	else if ((iParam4 > 0 && iParam4 < 13) && !func_103(&(Global_103236.f_19742), iParam4))
	{
		iVar2[iParam4] = 0;
	}
...
void func_108()
{
	...
	{
		unk_0x4E6996123FABDB93(2, 200, 0);
	}
}
...
void func_117(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, struct<3> Param5, float fParam8, int iParam9)
{
	...
	*uParam2 = unk_0x19D9DFABC3C7D219();
	if (unk_0x2137828D03306CAF(*uParam2))
	{
		if (!unk_0x7FAC45D56235AB39(*uParam2, 0))
		{
			*uParam2 = 0;
		}
		else
		{
			iVar0 = unk_0xD3B21CE53AA7BE51(*uParam2);
			if (unk_0xC6B6C45D0DE76B0B(iVar0) || unk_0x11217C882DAE7DDD(iVar0))
			{
				*uParam2 = 0;
			}
			else
			{
				iVar1 = unk_0x8F8E5C33266ED978(*uParam2, -1, 0);
				if (iVar1 != 0 && iVar1 != unk_0x2A5EB8B0FE590B91())
				{
					*uParam2 = 0;
				}
			}
	...
	{
		*uParam1 = Global_88419[0];
		unk_0x216B434C1A609F5B(*uParam1, 1, 1);
	}
	if (unk_0x2137828D03306CAF(*uParam1))
	{
		...
		{
			unk_0x1FD7155AA0D91CFA(*uParam1);
			unk_0xA32D9C84C1A93920(*uParam1, 0);
		}
	}
	if (!unk_0x2137828D03306CAF(*uParam1))
	{
		*uParam1 = unk_0xE42A511281C9895B(iParam9, Param5, fParam8, 1, 1, 0);
		unk_0x23B7F0BEB9890E62(*uParam1, 6);
	}
	if (unk_0x2137828D03306CAF(*uParam2))
	{
		if (!unk_0x03322C3918511AA0(*uParam2))
		{
			unk_0x216B434C1A609F5B(*uParam2, 1, 0);
		}
	}
	func_60(uParam4, 0, unk_0x2A5EB8B0FE590B91(), "MICHAEL", 0, 1);
	func_60(uParam4, 1, iParam0, "FRIEDLANDER", 0, 1);
	if (unk_0x9FA769EB6C3BCCE4(*uParam3))
	{
		unk_0x1E2E6AAAD9AE1286(*uParam3, 0);
	}
	if (!unk_0x9FA769EB6C3BCCE4(*uParam3))
	{
		*uParam3 = unk_0xCF3DF64B225054FA(26379945, 0);
	}
	unk_0xADF936AD56C4C4C0(*uParam3, -1906.842f, -572.3835f, 19.1046f);
	unk_0x28BE4B7676B6AD67(*uParam3, -1.5254f, 0.0003f, 171.4657f, 2);
	unk_0x4DD38134E80D1D6A(*uParam3, 17f);
	unk_0xD429163073BD3A47(*uParam3, 1);
	unk_0xB9658EBA374EC2AD(1, 0, 3000, 1, 0, 0);
	unk_0x39E6BFF51A22111E();
}
...
void func_118(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam1 && !unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()))
	{
		unk_0x8E979F037EACE55A(unk_0x2A5EB8B0FE590B91(), -1907.39f, -577.33f, 17.64f, 1, 0, 0, 1);
		unk_0x2681BA3707AF6DA7(unk_0x2A5EB8B0FE590B91(), 318.6574f);
		unk_0xF1C3427BFED79E6B(unk_0x2A5EB8B0FE590B91(), &cVar1, &cVar13, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		unk_0xF1C3427BFED79E6B(unk_0x2A5EB8B0FE590B91(), &cVar9, &cVar21, 1000f, -2f, -1, 32 | iVar0, 0, 0, 4, 0);
		unk_0xB1D181DBFC526F52(unk_0x2A5EB8B0FE590B91(), 0, 0);
	}
	if (iParam2 && !unk_0x769F0F6444C1ABE0(iParam0))
	{
		unk_0x8E979F037EACE55A(iParam0, -1907.69f, -574.77f, 17.67f, 1, 0, 0, 1);
		unk_0x2681BA3707AF6DA7(iParam0, 177f);
		unk_0xF1C3427BFED79E6B(iParam0, &cVar1, &cVar17, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		unk_0xF1C3427BFED79E6B(iParam0, &cVar9, &cVar25, 1000f, -2f, -1, 32 | iVar0, 0, 0, 0, 0);
...
float func_121(var uParam0)
{
	if (func_62(uParam0))
	{
		...
		{
			return (func_42(unk_0xAA4F14DA15DB0B51(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
void func_123(char[4] cParam0, int iParam1, int iParam2, int iParam3)
{
	...
	while (iVar65 < 12)
	{
		unk_0xA73D2885CDC54CCB(cParam0, iVar65, Var0.f_13[iVar65], Var0[iVar65], iParam2);
		iVar65++;
	}
	iVar65 = 0;
	while (iVar65 < 9)
	{
		...
		{
			unk_0xA33C0B84EC296D92(cParam0, iVar65, -1, 0, iParam2);
		}
		else
		{
			unk_0xA33C0B84EC296D92(cParam0, iVar65, Var0.f_39[iVar65], Var0.f_49[iVar65], iParam2);
		}
		iVar65++;
	}
}
...
int func_126(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_128(unk_0xD3B21CE53AA7BE51(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_128(unk_0xD3B21CE53AA7BE51(iParam0), iVar1, 14, 4);
		}
	}
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = unk_0xC507E3262E7D4F77(iParam3, 6, -1, 0, -1, func_130(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_141(func_143(iParam1, uParam0->f_2), Global_69618, 0);
			if (unk_0xAA4F14DA15DB0B51(uVar0, uParam0->f_1))
			{
				unk_0xF6082E2ADA1C795B(&(uParam0->f_6), 1);
			}
			uVar0 = func_141(func_140(iParam1, uParam0->f_2), Global_69618, 0);
			if (unk_0xAA4F14DA15DB0B51(uVar0, uParam0->f_1))
			{
				unk_0xF6082E2ADA1C795B(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_141(iVar1, Global_69618, 0);
				if (!unk_0xAA4F14DA15DB0B51(uVar0, uParam0->f_1))
				{
					unk_0xF6082E2ADA1C795B(&(uParam0->f_6), 4);
				}
...
int func_141(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2507378[iParam0 /*3*/][func_142(iParam1)];
...
void func_148(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = unk_0xC507E3262E7D4F77(iVar1, 6, -1, 0, -1, func_130(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_206(int iParam0, var uParam1, int iParam2)
{
	...
	if (!unk_0x769F0F6444C1ABE0(iParam0))
	{
		...
		else if (unk_0x591AF4C50B46E014() && unk_0xD3B21CE53AA7BE51(iParam0) == unk_0xD3B21CE53AA7BE51(unk_0x2A5EB8B0FE590B91()))
		{
			if (func_207(161, -1))
			{
				uParam1->f_59 = func_141(2046, Global_69618, 0);
			}
			else
			{
				uParam1->f_59 = func_141(748, Global_69618, 0);
			}
			uParam1->f_60 = func_141(749, Global_69618, 0);
			uParam1->f_61 = func_141(750, Global_69618, 0);
		}
...
int func_207(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2526994[iParam0 /*3*/][func_142(iParam1)];
...
void func_210(char* sParam0, int iParam1)
{
	...
	unk_0x8243AC20524825EB(sParam0, iVar1, 8);
}
...
int func_211(int iParam0)
{
	...
	if (unk_0x35302CD5A5D37EED(&Var1, "OBTOW01"))
	{
		return 128;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTOW02"))
	{
		return 256;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTOW03"))
	{
		return 512;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTOW04"))
	{
		return 1024;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTOW05"))
	{
		return 2048;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTOW06"))
	{
		return 4096;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTOW07"))
	{
		return 8192;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTOW08"))
	{
		return 16384;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTOW09"))
	{
		return 32768;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTOW10"))
	{
		return 65536;
	}
	else if (unk_0x35302CD5A5D37EED(&Var1, "OBTOW11"))
	{
		return 131072;
	}
	return 128;
...
struct<4> func_212(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_217(&(Global_103236.f_19742), 8) && iParam1) && iParam0 != 4) && func_215(3) > 0) && unk_0x399F81B56505EE6F(0, 1065353216) < 0.75f)
	{
		iVar4 = 8;
		*uParam3 = 4;
	}
	...
	{
		if (!func_217(&(Global_103236.f_19742), 1) && func_215(5) > 0)
		{
			unk_0xF6082E2ADA1C795B(&uVar5, 1);
			iVar6++;
		}
		if (!func_217(&(Global_103236.f_19742), 2) && func_215(7) >= 2)
		{
			unk_0xF6082E2ADA1C795B(&uVar5, 2);
			iVar6++;
		}
		if (!func_217(&(Global_103236.f_19742), 3) && ((((func_215(8) > 0 || func_215(9) > 0) && func_215(7) > 0) && iParam1) && iParam0 != 4))
		{
			unk_0xF6082E2ADA1C795B(&uVar5, 3);
			iVar6++;
		}
		if ((!func_217(&(Global_103236.f_19742), 4) && func_215(1) > 0) && func_215(1) < 3)
		{
			unk_0xF6082E2ADA1C795B(&uVar5, 4);
			iVar6++;
		}
		if (!func_217(&(Global_103236.f_19742), 5) && func_215(1) >= 3)
		{
			unk_0xF6082E2ADA1C795B(&uVar5, 5);
			iVar6++;
		}
		if (!func_217(&(Global_103236.f_19742), 6) && func_215(0) > 0)
		{
			unk_0xF6082E2ADA1C795B(&uVar5, 6);
			iVar6++;
		}
		if (!func_217(&(Global_103236.f_19742), 7))
		{
			unk_0xF6082E2ADA1C795B(&uVar5, 7);
			iVar6++;
		}
		if (((!func_217(&(Global_103236.f_19742), 8) && iParam1) && func_215(3) > 0) && iParam0 != 4)
		{
			unk_0xF6082E2ADA1C795B(&uVar5, 8);
			iVar6++;
		}
		if (!func_217(&(Global_103236.f_19742), 9))
		{
			unk_0xF6082E2ADA1C795B(&uVar5, 9);
			iVar6++;
		}
		if (!func_217(&(Global_103236.f_19742), 10))
		{
			unk_0xF6082E2ADA1C795B(&uVar5, 10);
			iVar6++;
		}
		if (!func_217(&(Global_103236.f_19742), 11))
		{
			unk_0xF6082E2ADA1C795B(&uVar5, 11);
			iVar6++;
		}
		if (iVar6 <= 0)
		{
		...
		else
		{
			...
			while (iVar7 > 0)
			{
				if (unk_0xAA4F14DA15DB0B51(uVar5, iVar8))
				{
					iVar7 = (iVar7 - 1);
					if (iVar7 == 0)
					{
	...
	if (bParam2)
	{
		func_213(&(Global_103236.f_19742), iVar4, 1);
	}
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 12) && !func_217(&(Global_103236.f_19742), iParam0))
	{
		iVar2[iParam0] = 0;
		bVar15 = true;
	}
	if ((iParam1 > 0 && iParam1 < 12) && !func_217(&(Global_103236.f_19742), iParam1))
	{
		iVar2[iParam1] = 0;
		bVar15 = true;
	}
	if ((iParam2 > 0 && iParam2 < 12) && !func_217(&(Global_103236.f_19742), iParam2))
	{
		iVar2[iParam2] = 0;
		bVar15 = true;
	}
	if ((iParam3 > 0 && iParam3 < 12) && !func_217(&(Global_103236.f_19742), iParam3))
	{
		iVar2[iParam3] = 0;
		bVar15 = true;
	}
	if ((iParam4 > 0 && iParam4 < 12) && !func_217(&(Global_103236.f_19742), iParam4))
	{
		iVar2[iParam4] = 0;
		bVar15 = true;
	}
...
int func_215(int iParam0)
{
	...
	{
		case 0:
			return func_216(&Global_88390, 1);
			break;
		
		case 1:
			return func_216(&Global_88392, 3);
			break;
		
		case 2:
			return func_216(&Global_88396, 1);
			break;
		
		case 3:
			return func_216(&Global_88398, 1);
			break;
		
		case 4:
			return func_216(&Global_88400, 1);
			break;
		
		case 5:
			return func_216(&Global_88402, 1);
			break;
		
		case 6:
			return func_216(&Global_88404, 1);
			break;
		
		case 7:
			return func_216(&Global_88406, 2);
			break;
		
		case 8:
			return func_216(&Global_88409, 1);
			break;
		
		case 9:
			return func_216(&Global_88411, 1);
			break;
	}
	return 0;
}
...
void func_220(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6, var uParam7, var uParam8)
{
	...
	unk_0x6CA29A70250F194F(*uParam0, 3, uParam6, uParam7, 0);
	unk_0x6CA29A70250F194F(*uParam0, 4, 0, uParam8, 0);
	func_221(1, 0);
	func_65(1, 1, 1, 0);
}
...
{
	if (!unk_0x9C7858CC7B9F7719("Office_Background_Stream", "SHRINK_SOUNDS"))
	{
		return 0;
	}
	if (func_229(uParam0))
...
void func_232(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	unk_0x9C7858CC7B9F7719("Office_Background_Stream", "SHRINK_SOUNDS");
	unk_0x749F8DABD0CEE89A(-1904.2f, -573.2f, 19.6f, -0.2f, 0f, -59.4f, 10f, 0);
	func_233();
}

void func_233()
{
	unk_0xA7C81DED990D3418("missdrfriedlanderdrf_idles");
	unk_0xA7C81DED990D3418("facials@drf");
}
...
void func_240(int iParam0, int iParam1, var uParam2, int iParam3)
{
	...
	{
		unk_0xFECCD8AF38671477(iParam1);
	}
...
void func_242()
{
	...
	while (iVar1 < 10)
	{
		...
		{
			case 0:
				func_243(&Global_88390, 1);
				break;
			
			case 1:
				func_243(&Global_88392, 3);
				break;
			
			case 2:
				func_243(&Global_88396, 1);
				break;
			
			case 3:
				func_243(&Global_88398, 1);
				break;
			
			case 4:
				func_243(&Global_88400, 1);
				break;
			
			case 5:
				func_243(&Global_88402, 1);
				break;
			
			case 6:
				func_243(&Global_88404, 1);
				break;
			
			case 7:
				func_243(&Global_88406, 2);
				break;
			
			case 8:
				func_243(&Global_88409, 1);
				break;
			
			case 9:
				func_243(&Global_88411, 1);
				break;
		}
		iVar1++;
	}
...
void func_245()
{
	...
	if (Global_103236.f_8866 || func_254(0))
	{
		if (!func_253())
		{
			iVar0 = func_252();
...
int func_247(int iParam0)
{
	...
	func_248(&(Global_103236.f_2164.f_539), iVar1);
...
void func_248(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_250(Global_103236.f_18314[iVar0], &Var2, &fVar5))
			{
				Global_103236.f_18314[iVar0] = 318;
				func_249(&(uParam0->f_2276[iVar0]));
...
void func_255(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_254(0) && Global_70046.f_1 == 1) && func_256(Global_70046))
		{
		}
		else
		{
