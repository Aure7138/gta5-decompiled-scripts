...
void __EntryFunction__()
{
	...
	if (unk_0xBCA819F9975BEDFA(67))
	{
		...
		if (bVar23)
		{
			if (unk_0x23E9113C762466ED(iLocal_400) && unk_0xCA41A00932714525(iLocal_400))
			{
				func_257(80, 1);
				unk_0xCE46AC18A4A47E2D(joaat("sp_killed_dr_friedlander"), 1, 1);
			}
			func_255(0, 0);
		}
		else
	...
	unk_0x8F088665928570EA(-1899.756f, -561.3688f, 10.78784f, 100f);
	...
	if (!unk_0xCEB2A4290BD633BE(unk_0xBE369BE1BC57A796()) && !unk_0xCA41A00932714525(unk_0x17B5CC8A8615737D()))
	{
	...
	while (true)
	{
		...
		switch (iLocal_60)
		{
			case 0:
				if (func_237())
				{
					unk_0xC1B7B5C6FDC0755B(unk_0x17B5CC8A8615737D(), joaat("weapon_unarmed"), -1, 0, 1);
				}
				...
				func_231();
				while (unk_0xFD0FE723227D5AB6(unk_0x17B5CC8A8615737D(), 1))
				{
					unk_0x4EDE34FBADD967A6(0);
				}
				unk_0x084522380FECC554(unk_0x17B5CC8A8615737D(), -1918.944f, -577.8114f, 10.8764f, 1f, -1, 1048576000, 0, 1193033728);
				uVar12 = unk_0x077CBD2E7E281022(26379945, -1896.529f, -545.7853f, 18.7228f, 3.1482f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
				uVar13 = unk_0x077CBD2E7E281022(26379945, -1896.866f, -547.7337f, 18.8316f, 4.9529f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
				unk_0x6530B35F40F7E78B(uVar13, uVar12, 5000, 1, 1);
			...
			case 1:
				...
				if (bVar4)
				{
					if (!bVar5)
					{
						if (unk_0x6E5BBCE1B1E5B2EB())
						{
							...
							{
								func_123(&cLocal_407, unk_0x17B5CC8A8615737D(), 0, 2);
							}
							if (!unk_0xA929B2923D14E2F8(iLocal_399, 0))
							{
				...
				{
					if (!unk_0xA929B2923D14E2F8(unk_0x17B5CC8A8615737D(), 0) && !unk_0xA929B2923D14E2F8(iLocal_399, 0))
					{
						unk_0xD9C496FEAA81FF4A(unk_0x17B5CC8A8615737D(), &cLocal_407, 0, 0, 0);
						unk_0xD9C496FEAA81FF4A(iLocal_399, &cLocal_413, 0, 0, 0);
					}
					unk_0x51C344BE3DCB5CB5(0);
					unk_0x49219669A551245B();
					unk_0x772E33FE6031D858();
					unk_0xAEA344F4AC19514E(-1906.842f, -572.3835f, 19.1046f, -1.5254f, 0.0003f, 171.4657f, 12f, 0);
					func_119(&uLocal_248);
					func_119(&uVar6);
					iLocal_60 = 2;
				}
			...
			case 2:
				if (unk_0x0F1BF24ED3B7ED40(uVar12))
				{
					unk_0x2BC4A4AFFC2D937D(uVar12, 0);
				}
				if (unk_0x0F1BF24ED3B7ED40(uVar13))
				{
					unk_0x2BC4A4AFFC2D937D(uVar13, 0);
				}
				if (unk_0x649012AFAC9B7CD0(&cLocal_407, 0))
				{
					func_118(iLocal_399, 1, 0);
				}
				if (unk_0x649012AFAC9B7CD0(&cLocal_413, 0))
				{
			...
			case 3:
				func_108();
				if (unk_0x25BD4C26D84038CD() || bVar24)
				{
					if (bVar24)
					{
					...
					while (unk_0xE41614517B6436B2() && !unk_0xDDF188456A3373B2())
					{
						unk_0x4EDE34FBADD967A6(0);
						func_108();
					}
					func_107(&uLocal_251);
					bVar24 = false;
					unk_0xC7845898207D067F(400);
				}
				if (!bVar2)
				{
					if (!bLocal_435 && !unk_0x80A7A5165A9C7607())
					{
						Local_61.f_20 = 0;
				...
				else if ((func_121(&uLocal_251) > 5f && func_120()) || (unk_0x77888DFE5B94E7E5() && ((Local_61.f_20 != 1 || func_121(&uLocal_251) > fVar22) || func_81(iLocal_82, iLocal_399, &uLocal_404))))
				{
					func_78();
					if (!unk_0xA929B2923D14E2F8(unk_0x17B5CC8A8615737D(), 0))
					{
					...
					unk_0x51C344BE3DCB5CB5(0);
					unk_0x924CDE68BA2ED3BA(iLocal_59);
					iLocal_60 = 14;
				}
				if (!bVar5 && bLocal_435)
				{
			...
			case 14:
				if (unk_0x0F1BF24ED3B7ED40(uLocal_404))
				{
					unk_0x9274EF97A90581BE(0, 0, 3000, 1, 0, 0);
					unk_0x2BC4A4AFFC2D937D(uLocal_404, 0);
				}
				if (((func_77() && unk_0x1B76B77EDF24A933()) && !unk_0x46EEE08565CE19CA()) && !unk_0x25BD4C26D84038CD())
				{
				...
				if (unk_0x66FBC42991B0D41E(0))
				{
					...
					else
					{
						...
						if (!unk_0xA929B2923D14E2F8(unk_0x17B5CC8A8615737D(), 0))
						{
							...
							unk_0xCEDF2A713644AEDA(unk_0x17B5CC8A8615737D(), 1, 0);
							unk_0x98F0FA127445E343(unk_0x17B5CC8A8615737D(), 0);
							func_74(unk_0x17B5CC8A8615737D(), -1902.609f, -559.9267f, 10.7916f);
							unk_0x0608D50823C6AA6D(unk_0x17B5CC8A8615737D(), fLocal_426);
							unk_0xBA7CD73403732191(0f);
							unk_0x503F20CB07C55470(0f, 1065353216);
							func_65(0, 1, 1, 0);
							iLocal_402 = unk_0x0C00E753D78DEA62();
							if (unk_0x23E9113C762466ED(iLocal_402))
							{
								if (!unk_0xA929B2923D14E2F8(iLocal_402, 0))
								{
									unk_0x5DC8C2F2F8A363C2(iLocal_402, func_64(iLocal_402), 1, 0, 0, 1);
									unk_0x0608D50823C6AA6D(iLocal_402, 231f);
								}
							}
							if (unk_0x25BD4C26D84038CD())
							{
								if (!iLocal_436)
								{
									unk_0xAEA344F4AC19514E(-1903.87f, -562.9188f, 12.8354f, func_63(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
									iLocal_436 = 1;
									unk_0x4EDE34FBADD967A6(0);
								}
								if (!iLocal_437)
				...
				else
				{
					if (!iLocal_436)
					{
						if (unk_0x4A933E1DE60245B7() > 60000)
						{
							if (iLocal_82 == 4)
							{
								unk_0xAEA344F4AC19514E(-1905.5f, -557.8768f, 12.4125f, func_63(Vector(11.9712f, -560.4745f, -1903.855f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
							}
							else
							{
								unk_0xAEA344F4AC19514E(-1903.87f, -562.9188f, 12.8354f, func_63(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
					...
					if (!iLocal_437)
					{
						if (unk_0x54A5232B445E24B8() >= 16)
						{
							...
							else if (func_121(&uVar9) > func_61(func_239()))
							{
								if (func_239() == 4)
								{
									iLocal_400 = unk_0x2AD5F4170F4ACBEB(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
									unk_0x2F933BB106547968(iLocal_400, 3, iLocal_432, uLocal_433, 0);
									unk_0x2F933BB106547968(iLocal_400, 4, 0, uLocal_434, 0);
									unk_0x4DF0B516187EED5A(iLocal_400, (2000 + unk_0x0E29C61F26D96FDB(5, 301)));
									unk_0x4114B83B329702FF(iLocal_400, 1);
			...
			case 15:
				...
				if (unk_0xA929B2923D14E2F8(iLocal_400, 0))
				{
					func_257(80, 1);
					unk_0xCE46AC18A4A47E2D(joaat("sp_killed_dr_friedlander"), 1, 1);
					func_84(&uLocal_83, "DrfAud", "DRF_KILL", 9, 0, 0, 0);
					if (unk_0xA3794949321E107C(uLocal_403))
					{
						unk_0xCC930AE12D020496(uLocal_403, 1);
					}
					iLocal_60 = 17;
				}
				else if (!unk_0x23E9113C762466ED(iLocal_400) || func_59(iLocal_400, unk_0x17B5CC8A8615737D(), 1) > 300f)
				{
					func_84(&uLocal_83, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
					if (unk_0xA3794949321E107C(uLocal_403))
					{
						unk_0xCC930AE12D020496(uLocal_403, 3);
					}
					if (unk_0x23E9113C762466ED(iLocal_400))
					{
						unk_0x7B408F9F309B3E56(unk_0x57240623C1BC6E88(iLocal_400, 1), 10f, 0);
					}
					iLocal_60 = 17;
				}
				else
				{
					func_47();
					unk_0x6018E338F7ABCE75(iLocal_400, 26, 1);
					if (func_62(&uLocal_266))
					{
						if (func_121(&uLocal_266) > 2.5f)
						{
							unk_0x5436326547492A67(unk_0xBE369BE1BC57A796(), 2f, 1000, 0, 1, 0);
							unk_0xC8C3338D4DBC00FE(unk_0xBE369BE1BC57A796(), 0, 0);
							func_119(&uLocal_266);
						}
					}
					if (!iLocal_439)
					{
						...
						if (func_121(&uLocal_263) > 2f)
						{
							...
							uLocal_404 = unk_0x077CBD2E7E281022(26379945, Var26, Var29, 50f, 0, 2);
							unk_0x6530B35F40F7E78B(uLocal_404, uLocal_405, 2660, 1, 1);
							if (unk_0x23E9113C762466ED(iLocal_402) && !unk_0xA929B2923D14E2F8(iLocal_402, 0))
							{
								unk_0x31589F3476134C55(iLocal_402);
								unk_0xC6042F55A6EA17B2(iLocal_402, 0);
								unk_0x879CEFE7BE03F4A6(iLocal_402, 1);
							}
							func_107(&uLocal_263);
							iLocal_439 = 1;
						}
					...
					else if (unk_0x0F1BF24ED3B7ED40(uLocal_405))
					{
						if (func_121(&uLocal_263) >= 2.66f)
						{
							unk_0xBA7CD73403732191(func_46(unk_0x1066E7A58E2A0D9D() == 2, -16f, 0f));
							unk_0x9274EF97A90581BE(0, 1, 340, 0, 0, 0);
							unk_0x2BC4A4AFFC2D937D(uLocal_405, 0);
						}
						else
						{
							unk_0xBA7CD73403732191(0f);
					...
					if (iLocal_438 && unk_0x94A5DEE82C898FDF(unk_0xBE369BE1BC57A796()))
					{
						if (func_44(&uLocal_257, 0.5f))
						{
							...
							if (!unk_0xA3794949321E107C(uLocal_403))
							{
								if (!unk_0xA929B2923D14E2F8(iLocal_400, 0))
								{
									uLocal_403 = unk_0xF1FE04D602EA392E(iLocal_400);
									unk_0xCC930AE12D020496(uLocal_403, 1);
									func_107(&uLocal_257);
								}
							}
							else if (unk_0xB1E66230B78B5E30(uLocal_403) != 3)
							{
								unk_0xCC930AE12D020496(uLocal_403, 3);
					...
					if (!unk_0xCA41A00932714525(iLocal_400))
					{
						if (unk_0x23E9113C762466ED(iLocal_401))
						{
							if (unk_0xFD0FE723227D5AB6(iLocal_400, 0))
							{
								iVar0 = 1;
							}
							if (!unk_0x48368B3E430594FA(iLocal_400))
							{
								if ((((((((!unk_0x45CD66F0A131E554(iLocal_401, 0) || unk_0x2315BB1606BC3DC3(unk_0x17B5CC8A8615737D(), iLocal_401, 1)) || unk_0x01F09F0D64EF3285(iLocal_401, 0, 2000)) || unk_0x01F09F0D64EF3285(iLocal_401, 1, 2000)) || unk_0x01F09F0D64EF3285(iLocal_401, 2, 2000)) || unk_0x01F09F0D64EF3285(iLocal_401, 3, 2000)) || (iVar0 && !unk_0xFD0FE723227D5AB6(iLocal_400, 0))) || func_40(iLocal_401)) || func_36(iLocal_401))
								{
									unk_0xCA58071CE9CCE891(iLocal_400, unk_0x17B5CC8A8615737D(), 3000f, -1, 0, 0);
								}
							}
						}
						else if (!unk_0x48368B3E430594FA(iLocal_400))
						{
							unk_0xCA58071CE9CCE891(iLocal_400, unk_0x17B5CC8A8615737D(), 3000f, -1, 0, 0);
						}
						if (!bVar25 && !unk_0x70A9F320A34FAC28(iLocal_400, -1892.139f, -567.194f, 10.5f, -1904.935f, -556.4423f, 13.5f, 4.73f, 0, 1, 0))
						{
							unk_0xCC61640A821F277C(iLocal_400, 0);
							bVar25 = true;
						}
					}
				}
			...
			case 17:
				...
				if (func_121(&uLocal_254) > 4f || unk_0x25BD4C26D84038CD())
				{
					unk_0x020DF7300725ECAB(&uLocal_403);
					if (unk_0x0F1BF24ED3B7ED40(uLocal_404))
					{
						unk_0x2BC4A4AFFC2D937D(uLocal_404, 0);
					}
					...
					if (!func_1(80))
					{
						if (unk_0x23E9113C762466ED(iLocal_400))
						{
							if (unk_0x23E9113C762466ED(iLocal_401) && unk_0x2315BB1606BC3DC3(iLocal_400, iLocal_401, 0))
							{
								unk_0x813865264334331D(&iLocal_401);
							}
						}
						unk_0x478AE709A466CB7E(&iLocal_400);
					}
...
int func_2(int iParam0, int iParam1, int iParam2)
{
	...
	return func_3(Global_101700.f_27009[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_6(int iParam0)
{
	...
	else if (unk_0x48B8265059381CD0(Global_101700.f_19523.f_471, iParam0) || unk_0x48B8265059381CD0(Global_2097152[func_8() /*10758*/].f_7546.f_10, iParam0))
	{
		bVar0 = true;
		unk_0x21E7933CCC7B3724(&(Global_101700.f_19523.f_471), iParam0);
		unk_0x21E7933CCC7B3724(&(Global_2097152[func_8() /*10758*/].f_7546.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		unk_0xBD18006F0815A298("COUP_RED");
		unk_0x34D84D73B5DF8E80(func_7(iParam0));
...
bool func_10(int iParam0)
{
	...
	return unk_0x48B8265059381CD0(Global_2097152[func_8() /*10758*/].f_7546.f_10, iParam0);
}
...
int func_13(int iParam0, int iParam1)
{
	...
	if (func_23(&Global_2595550))
	{
		if (func_21(&Global_2595550, iParam0))
		{
			return 0;
		}
		if (func_14(&Global_2595550, iParam0))
		{
			return 1;
		}
	}
...
void func_17(var uParam0)
{
	...
	func_19(uParam0, (Global_2595549 - 0.5f));
}
...
void func_32()
{
	...
	if (unk_0x23E9113C762466ED(unk_0x17B5CC8A8615737D()))
	{
		if (func_35(Global_101700.f_2095.f_539.f_3549) != unk_0x0324EEB10F81965F(unk_0x17B5CC8A8615737D()))
		{
			...
			if (func_33(iVar0) && (!func_25(14) || Global_100652))
			{
...
int func_36(int iParam0)
{
	...
	if ((func_39(unk_0x17B5CC8A8615737D()) && unk_0xFD0FE723227D5AB6(unk_0x17B5CC8A8615737D(), 0)) && func_37(iParam0))
	{
...
{
	uParam0->f_1 = (func_42(unk_0x48B8265059381CD0(*uParam0, 4)) - fParam1);
...
void func_47()
{
	...
	if ((!unk_0x23E9113C762466ED(iLocal_400) || unk_0xA929B2923D14E2F8(iLocal_400, 0)) || unk_0xA929B2923D14E2F8(unk_0x17B5CC8A8615737D(), 0))
	{
		return;
	}
	...
	fVar6 = unk_0xB7A628320EFF8E47(unk_0x57240623C1BC6E88(unk_0x17B5CC8A8615737D(), 1), unk_0x57240623C1BC6E88(iLocal_400, 1));
	if (iLocal_429 < 7)
	{
		if (iLocal_429 <= 0)
		{
			...
			{
				iVar4 = unk_0x0E29C61F26D96FDB(0, 7);
				unk_0xEB79FECD9022AAF0(&uLocal_428, iVar4);
		...
		{
			if (fVar6 <= 144f && !unk_0x68F6AE14C052BF51(unk_0x17B5CC8A8615737D()))
			{
				iVar4 = unk_0x0E29C61F26D96FDB(0, (7 - iLocal_429));
				while (iVar5 >= 0 && iVar5 < 7)
				{
					if (!unk_0x48B8265059381CD0(uLocal_428, iVar5))
					{
						if (iVar4 == 0)
						{
							unk_0xEB79FECD9022AAF0(&uLocal_428, iVar5);
							iVar4 = iVar5;
							iVar5 = -2;
						}
						else
	...
	if (iLocal_431 < 8)
	{
		if (iLocal_431 <= 0)
		{
			if (func_121(&uLocal_272) > 1f && !unk_0x68F6AE14C052BF51(iLocal_400))
			{
				iVar4 = unk_0x0E29C61F26D96FDB(0, 8);
				unk_0xEB79FECD9022AAF0(&uLocal_430, iVar4);
		...
		{
			if (fVar6 <= 2500f && !unk_0x68F6AE14C052BF51(iLocal_400))
			{
				iVar4 = unk_0x0E29C61F26D96FDB(0, (8 - iLocal_431));
				iVar5 = 0;
				while (iVar5 >= 0)
				{
					if (!unk_0x48B8265059381CD0(uLocal_430, iVar5))
					{
						if (iVar4 == 0)
						{
							unk_0xEB79FECD9022AAF0(&uLocal_430, iVar5);
							iVar4 = iVar5;
							iVar5 = -2;
						}
						else
	...
	if (((!iLocal_438 && iLocal_429 >= 1) && iLocal_431 >= 1) && !unk_0x75342B3CD0FB5275())
	{
		iLocal_438 = 1;
	}
}
...
Vector3 func_64(int iParam0)
{
	...
	unk_0x0A3949A30D4211BD(iParam0, &uVar0, &uVar3, &uVar6, &uVar9);
	unk_0x9475086C69ACF470(unk_0x0324EEB10F81965F(iParam0), &uVar12, &Var15);
...
void func_65(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (unk_0x63C468D583002D23())
		{
			if (((!unk_0xCA41A00932714525(unk_0x17B5CC8A8615737D()) && !func_70(unk_0xBE369BE1BC57A796())) && !func_67(unk_0xBE369BE1BC57A796(), 0)) && !func_66())
			{
...
void func_76()
{
	...
	if (!unk_0x45CD66F0A131E554(iLocal_401, 0))
	{
		unk_0x813865264334331D(&iLocal_401);
		iLocal_401 = unk_0x692A2891A2BA7352(iLocal_57, Local_422, fLocal_427, 1, 1);
		unk_0xEF9B9F466C3E73F6(iLocal_401, 6);
	}
	if (unk_0x23E9113C762466ED(iLocal_399))
	{
		unk_0x478AE709A466CB7E(&iLocal_399);
	}
	if ((!unk_0xA929B2923D14E2F8(unk_0x17B5CC8A8615737D(), 0) && !unk_0xA929B2923D14E2F8(iLocal_401, 0)) && unk_0x45CD66F0A131E554(iLocal_401, 0))
	{
		unk_0x5DC8C2F2F8A363C2(unk_0x17B5CC8A8615737D(), -1907.827f, -560.0641f, 10.8064f, 1, 0, 0, 1);
		unk_0x0608D50823C6AA6D(unk_0x17B5CC8A8615737D(), 260.195f);
		unk_0x5DC8C2F2F8A363C2(iLocal_401, Local_422, 1, 0, 0, 1);
		unk_0x0608D50823C6AA6D(iLocal_401, fLocal_427);
		if (unk_0x23E9113C762466ED(iLocal_402))
		{
			if (!unk_0xA929B2923D14E2F8(iLocal_402, 0))
			{
				unk_0x31589F3476134C55(iLocal_402);
				unk_0xC6042F55A6EA17B2(iLocal_402, 1);
				unk_0x879CEFE7BE03F4A6(iLocal_402, 0);
				unk_0x5DC8C2F2F8A363C2(iLocal_402, func_64(iLocal_402), 1, 0, 0, 1);
				unk_0x0608D50823C6AA6D(iLocal_402, 231f);
			}
		}
		...
		if ((!iLocal_437 || !unk_0x23E9113C762466ED(iLocal_400)) || unk_0xA929B2923D14E2F8(iLocal_400, 0))
		{
			iLocal_400 = unk_0x2AD5F4170F4ACBEB(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
			unk_0x2F933BB106547968(iLocal_400, 3, iLocal_432, uLocal_433, 0);
			unk_0x2F933BB106547968(iLocal_400, 4, 0, uLocal_434, 0);
			unk_0x4DF0B516187EED5A(iLocal_400, (2000 + unk_0x0E29C61F26D96FDB(5, 301)));
			unk_0x4114B83B329702FF(iLocal_400, 1);
			unk_0xCC61640A821F277C(iLocal_400, 1);
			func_60(&uLocal_83, 1, iLocal_400, "FRIEDLANDER", 0, 1);
			iLocal_437 = 1;
		}
		else
		{
			unk_0x5DC8C2F2F8A363C2(iLocal_400, -1899.7f, -562.2f, 10.7945f, 1, 0, 0, 1);
			unk_0x0608D50823C6AA6D(iLocal_400, 217.9453f);
			unk_0xBC8C26E1CC191108(iLocal_400);
			unk_0x3C1C089273A382C6(iLocal_400, -1);
		}
		if (unk_0x25BD4C26D84038CD())
		{
			if (!iLocal_436)
			{
				unk_0xAEA344F4AC19514E(-1905.5f, -557.8768f, 12.4125f, func_63(Vector(12.4748f, -560.2881f, -1904.709f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
				iLocal_436 = 1;
				unk_0x4EDE34FBADD967A6(0);
			}
			while (!unk_0xDDF188456A3373B2() || (!unk_0xCA41A00932714525(iLocal_400) && !unk_0x291EF658E660C270(iLocal_400)))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			if (!unk_0xA929B2923D14E2F8(unk_0x17B5CC8A8615737D(), 0))
		...
		fVar0 = 2f;
		if (!unk_0xCA41A00932714525(iLocal_400) && !unk_0xA929B2923D14E2F8(iLocal_401, 0))
		{
			unk_0x86DD54980FE55567(&uLocal_406);
			unk_0x3AD5401AC8DD9226(0, iLocal_401, -1, -1, fVar0, 1, 0);
			unk_0xBAEDE72EB6870B58(0, iLocal_401, -1783.73f, -629.1945f, 9.89f, 20f, 0, unk_0x0324EEB10F81965F(iLocal_401), 786484, 10f, 12f);
			unk_0x9178B6CFE95D27C6(0, iLocal_401, 19f, 786484);
			unk_0x007AE2AA9E15FA7B(uLocal_406);
			unk_0x00E85C3B3BD34B10(iLocal_400, uLocal_406);
			unk_0x44B1CF13D39D96CE(iLocal_400, joaat("MotionState_Run"), 1, 1, 1);
		}
		uLocal_403 = unk_0xF1FE04D602EA392E(iLocal_400);
		unk_0xCC930AE12D020496(uLocal_403, 1);
		func_107(&uLocal_257);
		unk_0xBA7CD73403732191(0f);
		unk_0x503F20CB07C55470(0f, 1065353216);
		uLocal_405 = unk_0x077CBD2E7E281022(26379945, -1904.615f, -558.892f, 12.8339f, -9.0794f, 0f, -127.4455f, 50f, 1, 2);
		unk_0x9274EF97A90581BE(1, 0, 3000, 1, 0, 0);
		unk_0x2D28D5B324F77D2D(0);
		unk_0xE418A8E16B02C0AC(0);
	}
	unk_0x1B60289D0F2A2E3C(-1886.884f, -571.1942f, 11.3828f, 2.5f, 1, 1, 0, 0);
	unk_0x692A2891A2BA7352(iLocal_58, -1886.884f, -571.1942f, 11.3828f, -40.83f, 1, 1);
}
...
int func_81(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_82())
	{
		if (!unk_0xCA41A00932714525(unk_0x17B5CC8A8615737D()) && !unk_0xCA41A00932714525(iParam1))
		{
			if (!unk_0x5132972D2BBC5A62(unk_0x17B5CC8A8615737D(), &cVar1, &Var13, 3))
			{
				unk_0xEB1EFACA68933402(unk_0x17B5CC8A8615737D(), &cVar1, &Var13, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				unk_0xEB1EFACA68933402(iParam1, &cVar1, &cVar21, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				unk_0xEB1EFACA68933402(unk_0x17B5CC8A8615737D(), &cVar9, &cVar25, 2f, -1000f, -1, 32 | iVar0, 0, 0, 4, 0);
				unk_0xEB1EFACA68933402(iParam1, &cVar9, &cVar31, 2f, -1000f, -1, 32 | iVar0, 0, 0, 0, 0);
				unk_0xDEAF24B058321A05(unk_0x17B5CC8A8615737D(), 0, 0);
				unk_0xDEAF24B058321A05(iParam1, 0, 0);
				...
				if (!unk_0x0F1BF24ED3B7ED40(*uParam2))
				{
					*uParam2 = unk_0x9F2F24963A4C5E27(26379945, 0);
				}
				unk_0x451B3BE1DE87C4F5(*uParam2, -1906.842f, -572.3835f, 19.1046f);
				unk_0xF612AE5AD0E3336E(*uParam2, -1.5254f, 0.0003f, 171.4657f, 2);
				unk_0x4BF6276065449F9C(*uParam2, 17f);
				unk_0xA652CA24468EC747(*uParam2, 1);
				unk_0x9274EF97A90581BE(1, 0, 3000, 1, 0, 0);
			}
			else if (unk_0x8E978F99E8F731CB(unk_0x17B5CC8A8615737D(), &cVar1, &Var13) >= 0.99f)
			{
				return 1;
			}
		}
...
bool func_82()
{
	return (unk_0xF4F8AE8DD0F08C1E("missdrfriedlanderdrf_idles") && unk_0xF4F8AE8DD0F08C1E("facials@drf"));
}
...
int func_85(var uParam0, var uParam1, var uParam2)
{
	...
	{
		bVar0 = unk_0x4B972043966C2EB8(2, 201);
		uVar1 = unk_0x4B972043966C2EB8(2, 202);
		if (bVar0 || uVar1)
		{
			if (bVar0)
			{
...
void func_86(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (!func_91(uParam0->f_1, 256) || (func_91(uParam0->f_1, 8192) && unk_0x987367D2EDB45658(2)))
	{
		...
		if (unk_0xEF4E5E47AF0D4480())
		{
			...
			unk_0x14ED5B5B8289F2FC(func_91(uParam0->f_1, 4096));
			unk_0x44983883E630A945();
		}
		iVar5 = 0;
		iVar6 = 0;
...
void func_95(var uParam0, var uParam1, int iParam2)
{
	...
	iVar0 |= 98304;
	unk_0xF2705A63E3587B6C(uParam0, iVar0, 8);
}
...
int func_96(var uParam0, int iParam1)
{
	...
	if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTSX01"))
	{
		return 8;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTSX02"))
	{
		return 16;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTSX03"))
	{
		return 32;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTSX04"))
	{
		return 64;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTSX05"))
	{
		return 128;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTSX06"))
	{
		return 256;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTSX07"))
	{
		return 512;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTSX08"))
	{
		return 1024;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTSX09"))
	{
		return 2048;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTSX10"))
	{
		return 4096;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTSX11"))
	{
		return 8192;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTSX12"))
	{
		return 16384;
	}
	return 8;
...
struct<4> func_97(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_98(&(Global_101700.f_18920), iVar4, 1);
	}
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 13) && !func_103(&(Global_101700.f_18920), iParam0))
	{
		iVar2[iParam0] = 0;
	}
	else if ((iParam1 > 0 && iParam1 < 13) && !func_103(&(Global_101700.f_18920), iParam1))
	{
		iVar2[iParam1] = 0;
	}
	else if ((iParam2 > 0 && iParam2 < 13) && !func_103(&(Global_101700.f_18920), iParam2))
	{
		iVar2[iParam2] = 0;
	}
	else if ((iParam3 > 0 && iParam3 < 13) && !func_103(&(Global_101700.f_18920), iParam3))
	{
		iVar2[iParam3] = 0;
	}
	else if ((iParam4 > 0 && iParam4 < 13) && !func_103(&(Global_101700.f_18920), iParam4))
	{
		iVar2[iParam4] = 0;
	}
...
void func_108()
{
	...
	{
		unk_0xD1BB2AD73E7FC3A7(2, 200, 0);
	}
}
...
void func_117(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, struct<3> Param5, float fParam8, int iParam9)
{
	...
	*uParam2 = unk_0x0C00E753D78DEA62();
	if (unk_0x23E9113C762466ED(*uParam2))
	{
		...
		{
			iVar0 = unk_0x0324EEB10F81965F(*uParam2);
			if (unk_0xA55B002FED5A9858(iVar0) || unk_0x3B548F49528B5FA7(iVar0))
			{
				*uParam2 = 0;
			}
			else
			{
				iVar1 = unk_0x17206B315923243C(*uParam2, -1, 0);
				if (iVar1 != 0 && iVar1 != unk_0x17B5CC8A8615737D())
				{
					*uParam2 = 0;
				}
			}
	...
	{
		*uParam1 = Global_88321[0];
		unk_0xF0F77C99098F999B(*uParam1, 1, 1);
	}
	if (unk_0x23E9113C762466ED(*uParam1))
	{
		...
		{
			unk_0x31589F3476134C55(*uParam1);
			unk_0x98F0FA127445E343(*uParam1, 0);
		}
	}
	if (!unk_0x23E9113C762466ED(*uParam1))
	{
		*uParam1 = unk_0x692A2891A2BA7352(iParam9, Param5, fParam8, 1, 1);
		unk_0xEF9B9F466C3E73F6(*uParam1, 6);
	}
	if (unk_0x23E9113C762466ED(*uParam2))
	{
		if (!unk_0xC26429B504BA534D(*uParam2))
		{
			unk_0xF0F77C99098F999B(*uParam2, 1, 0);
		}
	}
	func_60(uParam4, 0, unk_0x17B5CC8A8615737D(), "MICHAEL", 0, 1);
	func_60(uParam4, 1, iParam0, "FRIEDLANDER", 0, 1);
	if (unk_0x0F1BF24ED3B7ED40(*uParam3))
	{
		unk_0x2BC4A4AFFC2D937D(*uParam3, 0);
	}
	if (!unk_0x0F1BF24ED3B7ED40(*uParam3))
	{
		*uParam3 = unk_0x9F2F24963A4C5E27(26379945, 0);
	}
	unk_0x451B3BE1DE87C4F5(*uParam3, -1906.842f, -572.3835f, 19.1046f);
	unk_0xF612AE5AD0E3336E(*uParam3, -1.5254f, 0.0003f, 171.4657f, 2);
	unk_0x4BF6276065449F9C(*uParam3, 17f);
	unk_0xA652CA24468EC747(*uParam3, 1);
	unk_0x9274EF97A90581BE(1, 0, 3000, 1, 0, 0);
	unk_0x772E33FE6031D858();
}
...
void func_118(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam1 && !unk_0xCA41A00932714525(unk_0x17B5CC8A8615737D()))
	{
		unk_0x5DC8C2F2F8A363C2(unk_0x17B5CC8A8615737D(), -1907.39f, -577.33f, 17.64f, 1, 0, 0, 1);
		unk_0x0608D50823C6AA6D(unk_0x17B5CC8A8615737D(), 318.6574f);
		unk_0xEB1EFACA68933402(unk_0x17B5CC8A8615737D(), &cVar1, &cVar13, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		unk_0xEB1EFACA68933402(unk_0x17B5CC8A8615737D(), &cVar9, &cVar21, 1000f, -2f, -1, 32 | iVar0, 0, 0, 4, 0);
		unk_0xDEAF24B058321A05(unk_0x17B5CC8A8615737D(), 0, 0);
	}
	if (iParam2 && !unk_0xCA41A00932714525(iParam0))
	{
		unk_0x5DC8C2F2F8A363C2(iParam0, -1907.69f, -574.77f, 17.67f, 1, 0, 0, 1);
		unk_0x0608D50823C6AA6D(iParam0, 177f);
		unk_0xEB1EFACA68933402(iParam0, &cVar1, &cVar17, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		unk_0xEB1EFACA68933402(iParam0, &cVar9, &cVar25, 1000f, -2f, -1, 32 | iVar0, 0, 0, 0, 0);
...
float func_121(var uParam0)
{
	if (func_62(uParam0))
	{
		...
		{
			return (func_42(unk_0x48B8265059381CD0(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
void func_123(char[4] cParam0, int iParam1, int iParam2, int iParam3)
{
	...
	while (iVar65 < 12)
	{
		unk_0x5C9E441B0B13FC8B(cParam0, iVar65, Var0.f_13[iVar65], Var0[iVar65], iParam2);
		iVar65++;
	}
	iVar65 = 0;
	while (iVar65 < 9)
	{
		...
		{
			unk_0x5677A9C1ADA50A6E(cParam0, iVar65, -1, 0, iParam2);
		}
		else
		{
			unk_0x5677A9C1ADA50A6E(cParam0, iVar65, Var0.f_39[iVar65], Var0.f_49[iVar65], iParam2);
		}
		iVar65++;
	}
}
...
int func_126(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_128(unk_0x0324EEB10F81965F(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_128(unk_0x0324EEB10F81965F(iParam0), iVar1, 14, 4);
		}
	}
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = unk_0xE423D4D72B60A747(iParam3, 6, -1, 0, -1, func_130(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_141(func_143(iParam1, uParam0->f_2), Global_69521, 0);
			if (unk_0x48B8265059381CD0(uVar0, uParam0->f_1))
			{
				unk_0xEB79FECD9022AAF0(&(uParam0->f_6), 1);
			}
			uVar0 = func_141(func_140(iParam1, uParam0->f_2), Global_69521, 0);
			if (unk_0x48B8265059381CD0(uVar0, uParam0->f_1))
			{
				unk_0xEB79FECD9022AAF0(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_141(iVar1, Global_69521, 0);
				if (!unk_0x48B8265059381CD0(uVar0, uParam0->f_1))
				{
					unk_0xEB79FECD9022AAF0(&(uParam0->f_6), 4);
				}
...
int func_141(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2503826[iParam0 /*3*/][func_142(iParam1)];
...
void func_148(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = unk_0xE423D4D72B60A747(iVar1, 6, -1, 0, -1, func_130(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_206(int iParam0, var uParam1, int iParam2)
{
	...
	if (!unk_0xCA41A00932714525(iParam0))
	{
		...
		else if (unk_0x63C468D583002D23() && unk_0x0324EEB10F81965F(iParam0) == unk_0x0324EEB10F81965F(unk_0x17B5CC8A8615737D()))
		{
			if (func_207(161, -1))
			{
				uParam1->f_59 = func_141(2045, Global_69521, 0);
			}
			else
			{
				uParam1->f_59 = func_141(747, Global_69521, 0);
			}
			uParam1->f_60 = func_141(748, Global_69521, 0);
			uParam1->f_61 = func_141(749, Global_69521, 0);
		}
...
int func_207(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2522581[iParam0 /*3*/][func_142(iParam1)];
...
void func_210(char* sParam0, int iParam1)
{
	...
	unk_0xF2705A63E3587B6C(sParam0, iVar1, 8);
}
...
int func_211(int iParam0)
{
	...
	if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTOW01"))
	{
		return 128;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTOW02"))
	{
		return 256;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTOW03"))
	{
		return 512;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTOW04"))
	{
		return 1024;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTOW05"))
	{
		return 2048;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTOW06"))
	{
		return 4096;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTOW07"))
	{
		return 8192;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTOW08"))
	{
		return 16384;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTOW09"))
	{
		return 32768;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTOW10"))
	{
		return 65536;
	}
	else if (unk_0x6A7B0D91FD88D9EE(&Var1, "OBTOW11"))
	{
		return 131072;
	}
	return 128;
...
struct<4> func_212(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_217(&(Global_101700.f_18920), 8) && iParam1) && iParam0 != 4) && func_215(3) > 0) && unk_0x6B1497B2FDBC8466(0, 1065353216) < 0.75f)
	{
		iVar4 = 8;
		*uParam3 = 4;
	}
	...
	{
		if (!func_217(&(Global_101700.f_18920), 1) && func_215(5) > 0)
		{
			unk_0xEB79FECD9022AAF0(&uVar5, 1);
			iVar6++;
		}
		if (!func_217(&(Global_101700.f_18920), 2) && func_215(7) >= 2)
		{
			unk_0xEB79FECD9022AAF0(&uVar5, 2);
			iVar6++;
		}
		if (!func_217(&(Global_101700.f_18920), 3) && ((((func_215(8) > 0 || func_215(9) > 0) && func_215(7) > 0) && iParam1) && iParam0 != 4))
		{
			unk_0xEB79FECD9022AAF0(&uVar5, 3);
			iVar6++;
		}
		if ((!func_217(&(Global_101700.f_18920), 4) && func_215(1) > 0) && func_215(1) < 3)
		{
			unk_0xEB79FECD9022AAF0(&uVar5, 4);
			iVar6++;
		}
		if (!func_217(&(Global_101700.f_18920), 5) && func_215(1) >= 3)
		{
			unk_0xEB79FECD9022AAF0(&uVar5, 5);
			iVar6++;
		}
		if (!func_217(&(Global_101700.f_18920), 6) && func_215(0) > 0)
		{
			unk_0xEB79FECD9022AAF0(&uVar5, 6);
			iVar6++;
		}
		if (!func_217(&(Global_101700.f_18920), 7))
		{
			unk_0xEB79FECD9022AAF0(&uVar5, 7);
			iVar6++;
		}
		if (((!func_217(&(Global_101700.f_18920), 8) && iParam1) && func_215(3) > 0) && iParam0 != 4)
		{
			unk_0xEB79FECD9022AAF0(&uVar5, 8);
			iVar6++;
		}
		if (!func_217(&(Global_101700.f_18920), 9))
		{
			unk_0xEB79FECD9022AAF0(&uVar5, 9);
			iVar6++;
		}
		if (!func_217(&(Global_101700.f_18920), 10))
		{
			unk_0xEB79FECD9022AAF0(&uVar5, 10);
			iVar6++;
		}
		if (!func_217(&(Global_101700.f_18920), 11))
		{
			unk_0xEB79FECD9022AAF0(&uVar5, 11);
			iVar6++;
		}
		if (iVar6 <= 0)
		{
		...
		else
		{
			...
			while (iVar7 > 0)
			{
				if (unk_0x48B8265059381CD0(uVar5, iVar8))
				{
					iVar7 = (iVar7 - 1);
					if (iVar7 == 0)
					{
	...
	if (bParam2)
	{
		func_213(&(Global_101700.f_18920), iVar4, 1);
	}
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 12) && !func_217(&(Global_101700.f_18920), iParam0))
	{
		iVar2[iParam0] = 0;
		bVar15 = true;
	}
	if ((iParam1 > 0 && iParam1 < 12) && !func_217(&(Global_101700.f_18920), iParam1))
	{
		iVar2[iParam1] = 0;
		bVar15 = true;
	}
	if ((iParam2 > 0 && iParam2 < 12) && !func_217(&(Global_101700.f_18920), iParam2))
	{
		iVar2[iParam2] = 0;
		bVar15 = true;
	}
	if ((iParam3 > 0 && iParam3 < 12) && !func_217(&(Global_101700.f_18920), iParam3))
	{
		iVar2[iParam3] = 0;
		bVar15 = true;
	}
	if ((iParam4 > 0 && iParam4 < 12) && !func_217(&(Global_101700.f_18920), iParam4))
	{
		iVar2[iParam4] = 0;
		bVar15 = true;
	}
...
int func_215(int iParam0)
{
	...
	{
		case 0:
			return func_216(&Global_88292, 1);
			break;
		
		case 1:
			return func_216(&Global_88294, 3);
			break;
		
		case 2:
			return func_216(&Global_88298, 1);
			break;
		
		case 3:
			return func_216(&Global_88300, 1);
			break;
		
		case 4:
			return func_216(&Global_88302, 1);
			break;
		
		case 5:
			return func_216(&Global_88304, 1);
			break;
		
		case 6:
			return func_216(&Global_88306, 1);
			break;
		
		case 7:
			return func_216(&Global_88308, 2);
			break;
		
		case 8:
			return func_216(&Global_88311, 1);
			break;
		
		case 9:
			return func_216(&Global_88313, 1);
			break;
	}
	return 0;
}
...
void func_220(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6, var uParam7, var uParam8)
{
	...
	unk_0x2F933BB106547968(*uParam0, 3, uParam6, uParam7, 0);
	unk_0x2F933BB106547968(*uParam0, 4, 0, uParam8, 0);
	func_221(1, 0);
	func_65(1, 1, 1, 0);
}
...
struct<6> func_227(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
{
	if (!unk_0xAA18627F95EFB68D("Office_Background_Stream", "SHRINK_SOUNDS"))
	{
		return 0;
	}
	if (func_229(uParam0))
...
void func_232(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	unk_0xAA18627F95EFB68D("Office_Background_Stream", "SHRINK_SOUNDS");
	unk_0xAEA344F4AC19514E(-1904.2f, -573.2f, 19.6f, -0.2f, 0f, -59.4f, 10f, 0);
	func_233();
}

void func_233()
{
	unk_0xA0E7D0E8FE126EE8("missdrfriedlanderdrf_idles");
	unk_0xA0E7D0E8FE126EE8("facials@drf");
}
...
void func_242()
{
	...
	while (iVar1 < 10)
	{
		...
		{
			case 0:
				func_243(&Global_88292, 1);
				break;
			
			case 1:
				func_243(&Global_88294, 3);
				break;
			
			case 2:
				func_243(&Global_88298, 1);
				break;
			
			case 3:
				func_243(&Global_88300, 1);
				break;
			
			case 4:
				func_243(&Global_88302, 1);
				break;
			
			case 5:
				func_243(&Global_88304, 1);
				break;
			
			case 6:
				func_243(&Global_88306, 1);
				break;
			
			case 7:
				func_243(&Global_88308, 2);
				break;
			
			case 8:
				func_243(&Global_88311, 1);
				break;
			
			case 9:
				func_243(&Global_88313, 1);
				break;
		}
		iVar1++;
	}
...
void func_245()
{
	...
	if (Global_101700.f_8044 || func_254(0))
	{
		if (!func_253())
		{
			iVar0 = func_252();
...
int func_247(int iParam0)
{
	...
	func_248(&(Global_101700.f_2095.f_539), iVar1);
...
void func_248(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_250(Global_101700.f_17492[iVar0], &Var2, &fVar5))
			{
...
void func_255(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_254(0) && Global_69948.f_1 == 1) && func_256(Global_69948))
		{
		}
		else
		{
