...
int func_10()
{
	...
	{
		if ((unk_0x5E9564D8246B909A(unk_0x4F8644AF03D0E0D6()) && unk_0x49C32D60007AFA47(unk_0x4F8644AF03D0E0D6())) && !unk_0xD9D2CFFF49FAB35F())
		{
			if (func_20(0))
			{
				func_11(48, 4, 0);
...
int func_26()
{
	if ((Global_97173.f_29699[48 /*29*/].f_12[0] == 1 && Global_97173.f_29699[48 /*29*/].f_12[1] == 1) && Global_97173.f_29699[48 /*29*/].f_12[2] == 1)
	{
		if ((((func_25() || func_24()) || func_23()) || func_22()) || func_21())
		{
			return 1;
