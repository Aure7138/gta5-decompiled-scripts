...
int func_10()
{
	...
	{
		if ((unk_0x6DF20EAB8093DF19(unk_0x8ACD527A7E574590()) && unk_0x116E9F29D23ADBBE(unk_0x8ACD527A7E574590())) && !unk_0xA153A26DF49EBCC0())
		{
			if (func_20(0))
			{
				func_11(48, 4, 0);
...
int func_26()
{
	if ((Global_99250.f_32503[48 /*29*/].f_12[0] == 1 && Global_99250.f_32503[48 /*29*/].f_12[1] == 1) && Global_99250.f_32503[48 /*29*/].f_12[2] == 1)
	{
		if ((((func_25() || func_24()) || func_23()) || func_22()) || func_21())
		{
			return 1;
