...
int func_10()
{
	...
	{
		if ((unk_0x2E6D4A0CE8AD9494(unk_0x3F80C6638E3A1A90()) && unk_0x4844BC1882594FDB(unk_0x3F80C6638E3A1A90())) && !unk_0xF478777FFCC96862())
		{
			if (func_20(0))
			{
				func_11(48, 4, 0);
...
int func_26()
{
	if ((Global_99155.f_32499[48 /*29*/].f_12[0] == 1 && Global_99155.f_32499[48 /*29*/].f_12[1] == 1) && Global_99155.f_32499[48 /*29*/].f_12[2] == 1)
	{
		if ((((func_25() || func_24()) || func_23()) || func_22()) || func_21())
		{
			return 1;
