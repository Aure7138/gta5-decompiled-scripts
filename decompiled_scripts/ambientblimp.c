...
int func_10()
{
	...
	{
		if ((unk_0xCF7855B965948E97(unk_0xBE369BE1BC57A796()) && unk_0x94A5DEE82C898FDF(unk_0xBE369BE1BC57A796())) && !unk_0xE9E6B5364105A000())
		{
			if (func_20(0))
			{
				func_11(48, 4, 0);
...
int func_26()
{
	if ((Global_101700.f_27009[48 /*29*/].f_12[0] == 1 && Global_101700.f_27009[48 /*29*/].f_12[1] == 1) && Global_101700.f_27009[48 /*29*/].f_12[2] == 1)
	{
		if ((((func_25() || func_24()) || func_23()) || func_22()) || func_21())
		{
			return 1;
