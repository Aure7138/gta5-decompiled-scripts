...
int func_10()
{
	...
	{
		if ((unk_0xCAD1755E530A6012(unk_0x1146A9AE09CE2B14()) && unk_0xDF02DA324F934755(unk_0x1146A9AE09CE2B14())) && !unk_0xF471787D45ADC2C1())
		{
			if (func_26(0))
			{
				func_11(48, 4, 0);
		...
		if (bParam2)
		{
			if (!Global_77248)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8327[iParam1 /*4*/] = { func_13(iParam0) };
					...
					{
						Global_8278[1 /*6*/] = { func_13(iParam0) };
