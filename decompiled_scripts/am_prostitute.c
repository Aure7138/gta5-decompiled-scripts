		...
		if ((iLocal_54 % iVar0) == 0)
		{
			if (unk_0x05086B70D2CFEA6F(unk_0xCFA8A401AAD7BB5A(iVar0)))
			{
				...
				if (!unk_0x1D403DFADBC2DE3C(iVar2, 0))
				{
					...
					{
						if (unk_0xB7A628320EFF8E47(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 0), unk_0x541C2AEF053615BC(iVar2, 1)) <= 22500f)
						{
							if (!iLocal_56)
							{
...
void func_5()
{
	...
	if (iVar2 != 0)
	{
		unk_0x38E776D9FA75679B(1, &Var0, 2, iVar2);
	}
}
...
{
	Local_58[unk_0x822BEC8031773562() /*3*/] = iParam0;
}
...
int func_12(int iParam0)
{
	if (iParam0 == -1)
	{
		return Local_58[unk_0x822BEC8031773562() /*3*/];
	}
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
			{
				...
				if (func_26(&uVar2))
				{
					...
					{
						if (func_12(iVar1) == unk_0x3187EF5798B5D209(uVar3, 0, 0) || unk_0x62F3A07C43FFB568(func_12(iVar1), uVar3, 1))
						{
					...
					Var4 = { unk_0x541C2AEF053615BC(func_12(iVar1), 0) };
					Var7 = { unk_0x541C2AEF053615BC(iVar0, 0) };
					Var10 = { unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 0) };
...
int func_14()
{
	...
	iVar0 = 0;
	iVar10 = unk_0x252B0CBDBF5803ED(unk_0xBC25C936A095B5BA(), &uVar1, -1);
	if (iVar10 > 0)
	{
		iVar11 = 0;
		while (iVar11 <= 7)
		{
			if (!unk_0x36CEFBE9B745A58D(uVar1[iVar11]))
			{
				if (unk_0x4DF0825BB012BDB0(uVar1[iVar11], "WORLD_HUMAN_PROSTITUTE_HIGH_CLASS") || unk_0x4DF0825BB012BDB0(uVar1[iVar11], "WORLD_HUMAN_PROSTITUTE_LOW_CLASS"))
				{
					if (func_16(uVar1[iVar11]))
					{
						if (!func_15(uVar1[iVar11]))
						{
							if (!unk_0x889DA6CE8E4DB344(uVar1[iVar11]))
							{
								return uVar1[iVar11];
							}
						}
...
int func_16(var uParam0)
{
	...
	uVar1 = unk_0x0B00D4CDDAB33814(uParam0, &uVar0);
	if (!unk_0xF1734B55490E9045(uVar1))
	{
		if (unk_0x3362CDE8460ED38B(uVar1, "GB_VEHICLE_EXPORT"))
		{
			return 0;
		}
		if (unk_0x3362CDE8460ED38B(uVar1, "BUSINESS_BATTLES_SELL"))
		{
			return 0;
		}
		if (unk_0x3362CDE8460ED38B(uVar1, "BUSINESS_BATTLES"))
		{
			return 0;
		}
	}
...
int func_26(var uParam0)
{
	...
	{
		if (unk_0x3187EF5798B5D209(unk_0xD20EBB97FE8799ED(*uParam0), -1, 0) == *uParam0)
		{
			return 1;
		}
	}
...
void func_46(struct<21> Param0)
{
	...
	func_47(0, -1, 0);
	unk_0xE45D6A3FD6454198(&Local_58, 97);
	if (unk_0x7AF0088ABFA713B6())
	{
		func_5();
	}
