...
void func_1()
{
	...
	switch (iLocal_684)
	{
		case 0:
			...
			if (!unk_0x429D45A6C6520026(sLocal_818))
			{
				func_33(sLocal_818);
			}
			else
		...
		case 1:
			if (func_17())
			{
				...
				func_2();
				unk_0xFDD15D670AD33E10(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), 30f, 1, 0, 0, 0);
				func_369();
			}
			break;
	}
...
void func_3()
{
	...
	unk_0x3E11F609741642B7(uLocal_80);
...
{
	func_13(&(Global_99633.f_2875), Param0, fParam3);
}
...
void func_20(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_22(Global_106070.f_18505[iVar0], &Var2, &fVar5))
			{
...
void func_38()
{
	...
	switch (iLocal_684)
	{
		...
		case 1:
			if (!func_101(unk_0xA19140A5C42D8715(), Local_827, 270f))
			{
				iLocal_684 = 2;
			}
...
void func_102()
{
	...
	switch (iLocal_684)
	{
		case 0:
			if (func_116(iLocal_683, bLocal_28))
			{
				if (unk_0x91347D2A80F38492(unk_0xD4E735F4B6A956AC()) == 0)
				{
					...
					{
						if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_874, 0))
						{
		...
		case 3:
			...
			{
				if (!unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), Local_868.f_0, 0))
				{
					unk_0x692D5500D82E4F5D(unk_0xA19140A5C42D8715(), Local_868.f_0, -1);
				}
				else
				{
	...
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			else
			{
				...
				{
					fVar0 = (fParam12 / 2f);
					if (func_101(unk_0xA19140A5C42D8715(), Param1, fVar0))
					{
						*iParam7 = 0;
		...
		case 0:
			...
			else if (func_143(1, Local_824, 0))
			{
				if (func_142())
				{
					...
					unk_0xFC00A668AFC2126D(joaat("s_m_y_garbage"), 1);
					iLocal_683 = 2;
					func_7(&iLocal_821);
				...
				else if (((func_143(2, Local_868.f_1, Local_868.f_4) && func_143(3, Local_840.f_1, Local_840.f_4)) && func_143(4, Local_854.f_1, Local_854.f_4)) && func_135(0))
				{
					...
					unk_0xFC00A668AFC2126D(joaat("towtruck"), 1);
					unk_0xFC00A668AFC2126D(joaat("s_m_y_garbage"), 1);
					if (unk_0xA262B2C30069FA97(Local_868.f_0) != 0)
					{
						iVar0 = unk_0xA262B2C30069FA97(Local_868.f_0);
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	unk_0x94E87D83163B4BEB("Enemies", &uLocal_80);
	unk_0xDFA901280292A2FB(Local_111[0 /*11*/], uLocal_80);
	unk_0xDFA901280292A2FB(Local_111[1 /*11*/], uLocal_80);
	unk_0xD759B92031944D46(Local_111[0 /*11*/], 1, 0);
	unk_0xD759B92031944D46(Local_111[1 /*11*/], 1, 0);
...
void func_123()
{
	if (!unk_0xE0FD180CD24C0B67(Local_111[0 /*11*/], iLocal_109, 0))
	{
		unk_0x956B3CF461C0C1C9(Local_111[0 /*11*/], unk_0x3201284584C7CD83(iLocal_109, func_131(1)), 1f, -1, 1048576000, 0, 1193033728);
...
{
	if (!unk_0x588F5E48C78F1C73(iLocal_109, 0, 0))
	{
		func_125(bParam0);
		if (iLocal_661 != (iLocal_81 - 1))
		{
			if (iLocal_661 == 4)
			{
				unk_0x51A4D35222277C1F(Local_111[0 /*11*/], iLocal_109, Local_134[iLocal_661 /*25*/], 15f, 2883755, Local_134[iLocal_661 /*25*/].f_6);
			}
			else
			{
				unk_0xE49301B2B6F420DE(Local_111[0 /*11*/], iLocal_109, Local_134[iLocal_661 /*25*/], 15f, 0, 0, 2883755, Local_134[iLocal_661 /*25*/].f_6, Local_134[iLocal_661 /*25*/].f_7);
			}
		...
		{
			unk_0x731722E696597BD1(Local_111[0 /*11*/], iLocal_109, 15f, 786599);
			Local_111[0 /*11*/].f_8 = Local_111[0 /*11*/].f_7;
...
void func_125(bool bParam0)
{
	if (iLocal_661 != -1)
	{
		...
		{
			unk_0x413F34FCFABEDE4B(Local_134[iLocal_661 /*25*/].f_11 - Local_134[iLocal_661 /*25*/].f_14, Local_134[iLocal_661 /*25*/].f_11 + Local_134[iLocal_661 /*25*/].f_14, 1, 1);
		}
	}
	if (!bParam0)
	{
	...
	if (iLocal_661 != -1)
	{
		if (!func_130(Local_134[iLocal_661 /*25*/].f_11) && !func_130(Local_134[iLocal_661 /*25*/].f_14))
		{
			unk_0x413F34FCFABEDE4B(Local_134[iLocal_661 /*25*/].f_11 - Local_134[iLocal_661 /*25*/].f_14, Local_134[iLocal_661 /*25*/].f_11 + Local_134[iLocal_661 /*25*/].f_14, 0, 1);
		}
	}
}
...
int func_126()
{
	...
	{
		Var1 = { unk_0xE2BBD32891C18569(iLocal_109, 1) };
		iVar4 = 0;
		while (iVar4 <= (iLocal_81 - 1))
		{
			fVar28 = unk_0x499324B3EF19C288(Var1, Local_134[iVar4 /*25*/], 1);
		...
		fVar30 = func_127(Local_134[iVar0 /*25*/] - Var1, unk_0xFA0A034A8C86C35E(iLocal_109));
		iVar5 = iVar0;
		iVar31 = 0;
		while (fVar30 < 0f && iVar31 < 40)
		{
			...
			Var1 = { unk_0xE2BBD32891C18569(iLocal_109, 1) };
			fVar30 = func_127(Local_134[iVar5 /*25*/] - Var1, unk_0xFA0A034A8C86C35E(iLocal_109));
			iVar31++;
		}
		if (iVar31 >= 40)
		{
...
int func_129()
{
	...
	iVar0 = unk_0x22C775856F4633CA(0, (iLocal_81 - 1));
...
Vector3 func_131(bool bParam0)
{
	...
	if (!bParam0)
	{
		uVar3 = unk_0x4F9AEAB2CC029A5C(iLocal_109, "wheel_rf");
	}
	else
	{
		uVar3 = unk_0x4F9AEAB2CC029A5C(iLocal_109, "wheel_lf");
	}
	Var0 = { unk_0xB31A4B66C16032CC(iLocal_109, uVar3) };
	Var0 = { unk_0x61141C81AF57CBDC(iLocal_109, Var0) };
	if (!bParam0)
	{
...
void func_138(int iParam0, struct<3> Param1)
{
	...
	if ((Param1.f_0 == Global_25834[iVar0 /*23*/][0 /*3*/] && Param1.f_1 == Global_25834[iVar0 /*23*/][0 /*3*/].f_1) && Param1.f_2 == Global_25834[iVar0 /*23*/][0 /*3*/].f_2)
	{
		return;
	}
	Global_25831 = 1;
	unk_0x2BCFB39E86340DAA(&(Global_25834[iVar0 /*23*/].f_11), 18);
	Global_25834[iVar0 /*23*/][0 /*3*/] = { Param1 };
	Global_31884 = 1;
}
...
int func_142()
{
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		if (unk_0xD3C4AB5E628133C1(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), joaat("trash")))
		{
			...
			iLocal_874 = unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0);
			if (func_36(iLocal_874))
			{
				return 1;
			}
...
int func_143(int iParam0, struct<3> Param1, float fParam4)
{
	switch (iParam0)
	{
		...
		case 1:
			unk_0x6A633E13B2A856AE(sLocal_819, 0);
		...
		case 2:
			if (func_36(Global_89824[0]))
			{
				...
				Local_868.f_0 = Global_89824[0];
				if (func_36(Local_868.f_0))
				{
					func_35(Local_868.f_0, 0);
					unk_0x0BE3742BB3253F0E(Local_868.f_0, 1);
					unk_0xEAF1F3E17588C851(Local_868.f_0, 1);
					return 1;
				}
			}
		...
		case 3:
			if (unk_0xDC5D81351D6A4DDB(Global_89824.f_9[0]))
			{
				if (!unk_0xD61D0CA14AE902DF(Global_89824.f_9[0], 1))
				{
					...
					Local_840.f_0 = Global_89824.f_9[0];
					if (func_335(Local_840.f_0))
					{
						unk_0x1F4E5EFBFE503FB3(Local_840.f_0, true);
						unk_0x13E0A8160525AE55(Local_840.f_0, 170, 0);
						unk_0xC2C4AE9DB4A0BEF3(Local_840.f_0, 65536, 1);
						unk_0x3B7A32E04BBE59A5(Local_840.f_0, 50, 1);
						return 1;
					}
				}
				else
			...
			else if (func_144(&Local_840, Local_840.f_5, Local_840.f_1, Local_840.f_4, 1, 0, 1, 1))
			{
				if (func_36(Local_868.f_0))
				{
					unk_0x692D5500D82E4F5D(Local_840.f_0, Local_868.f_0, -1);
					unk_0x1F4E5EFBFE503FB3(Local_840.f_0, true);
					unk_0x13E0A8160525AE55(Local_840.f_0, 170, 0);
					unk_0xC2C4AE9DB4A0BEF3(Local_840.f_0, 65536, 1);
					unk_0x3B7A32E04BBE59A5(Local_840.f_0, 50, 1);
		...
		case 4:
			if (unk_0xDC5D81351D6A4DDB(Global_89824.f_9[1]))
			{
				if (!unk_0xD61D0CA14AE902DF(Global_89824.f_9[1], 1))
				{
					...
					Local_854.f_0 = Global_89824.f_9[1];
					if (func_335(Local_854.f_0))
					{
						unk_0x13E0A8160525AE55(Local_854.f_0, 170, 0);
						unk_0xC2C4AE9DB4A0BEF3(Local_854.f_0, 65536, 1);
						unk_0x3B7A32E04BBE59A5(Local_854.f_0, 50, 1);
						unk_0x1F4E5EFBFE503FB3(Local_854.f_0, true);
						unk_0x98D1B1BD9C3AA456(Local_854.f_0, 1, 1);
						return 1;
					}
				}
				else
			...
			else if (func_144(&Local_854, Local_854.f_5, Local_854.f_1, Local_854.f_4, 1, 0, 1, 1))
			{
				if (func_36(Local_868.f_0))
				{
					unk_0x692D5500D82E4F5D(Local_854.f_0, Local_868.f_0, 0);
					unk_0x13E0A8160525AE55(Local_854.f_0, 170, 0);
					unk_0xC2C4AE9DB4A0BEF3(Local_854.f_0, 65536, 1);
					unk_0x3B7A32E04BBE59A5(Local_854.f_0, 50, 1);
					unk_0x1F4E5EFBFE503FB3(Local_854.f_0, true);
...
void func_150(var uParam0, int iParam1)
{
	if (func_335(*uParam0))
	{
		...
		if (unk_0x411C28019DEA5CEF(*uParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 3))
		{
			if (unk_0xE5B5A1FFAA0834BD(*uParam0, "missfbi4prepp1", "_bag_drop_garbage_man") >= 0.172f)
			{
				if (func_10(Local_134[iLocal_661 /*25*/].f_17) && unk_0xF797E4DD45066C88(Local_134[iLocal_661 /*25*/].f_17))
				{
					...
					unk_0xF334C9B245CD323D(Local_134[iLocal_661 /*25*/].f_17, 1, 0);
					unk_0x237212ABD2DC57D3(Local_134[iLocal_661 /*25*/].f_17, 1, unk_0xFA0A034A8C86C35E(*uParam0), 0, 1, 1, 0);
				}
			}
		}
		switch (uParam0->f_5)
	...
	else
	{
		...
		{
			if (unk_0xF797E4DD45066C88(Local_134[iLocal_661 /*25*/].f_17))
			{
				unk_0xF334C9B245CD323D(Local_134[iLocal_661 /*25*/].f_17, 1, 0);
				unk_0x237212ABD2DC57D3(Local_134[iLocal_661 /*25*/].f_17, 1, unk_0xFA0A034A8C86C35E(*uParam0), 0, 1, 1, 0);
			}
		...
		if (unk_0xDC5D81351D6A4DDB(*uParam0))
		{
			if (!func_151(unk_0xA19140A5C42D8715(), *uParam0, 150f, 1) && !bLocal_665)
			{
...
void func_152(var uParam0)
{
	...
	{
		case 5:
			if ((unk_0xFD34717937104F1C() - uParam0->f_1) > uParam0->f_3)
			{
				if (func_178(*uParam0, 780511057))
				{
					unk_0x9568B1B58F78FF36(*uParam0);
				}
				unk_0x33B5487515BD13D5(*uParam0, unk_0xA19140A5C42D8715(), 30f, -1, 0, 0);
				uParam0->f_6 = 6;
		...
		case 21:
			...
			{
				if (func_171(*uParam0, unk_0xA19140A5C42D8715(), 1126825984, 1, 250, 7))
				{
					func_170(uParam0, 1);
					return;
				}
		...
		case 10:
			if ((unk_0xFD34717937104F1C() - uParam0->f_1) > uParam0->f_3)
			{
				if (unk_0x5D7DFE2058701942(*uParam0, 0))
				{
					unk_0xB0D7019224A3A443(*uParam0, 120, 1);
					uParam0->f_6 = 12;
					uParam0->f_1 = unk_0xFD34717937104F1C();
				}
		...
		case 3:
			if ((unk_0xFD34717937104F1C() - uParam0->f_1) > uParam0->f_3)
			{
				unk_0x1701009E85B15DA4(*uParam0, 1, 1);
				unk_0x33B5487515BD13D5(*uParam0, unk_0xA19140A5C42D8715(), 500f, -1, 0, 1);
				uParam0->f_1 = unk_0xFD34717937104F1C();
				uParam0->f_6 = 4;
				uParam0->f_5 = 1;
			}
		...
		case 11:
			func_166(uParam0);
			if ((unk_0xFD34717937104F1C() - uParam0->f_1) > 5000)
			{
				if (!func_178(*uParam0, 713668775))
				{
					if (unk_0xDC5D81351D6A4DDB(Local_111[func_165(uParam0->f_10) /*11*/]))
					{
						unk_0x956B3CF461C0C1C9(*uParam0, Local_667, 1f, -1, 2f, 0, 1193033728);
					}
				}
				uParam0->f_1 = unk_0xFD34717937104F1C();
				uParam0->f_6 = 23;
		...
		case 18:
			if (!func_178(*uParam0, -2017877118))
			{
				...
				if (func_164(unk_0xE2BBD32891C18569(*uParam0, 1), unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1)) > 1.5f)
				{
					unk_0xD87AD31611110768(0, unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), 0);
				}
		...
		case 19:
			...
			if (!func_178(*uParam0, -2017877118))
			{
				unk_0x0EEB301CAA50A123(*uParam0, "WORLD_HUMAN_MOBILE_FILM_SHOCKING", 6000, 1);
				uParam0->f_5 = 1;
				uParam0->f_6 = 20;
				uParam0->f_1 = unk_0xFD34717937104F1C();
			}
		...
		case 1:
			if (!unk_0xE0FD180CD24C0B67(*uParam0, iLocal_109, 0))
			{
				func_162(uParam0);
			}
			break;
		...
		case 2:
			if (!unk_0x8A29BBDF4603E52B(*uParam0) && (unk_0xFD34717937104F1C() - uParam0->f_1) > 3000)
			{
				func_162(uParam0);
			}
			break;
		...
		case 4:
			if ((unk_0xFD34717937104F1C() - uParam0->f_1) > 8000)
			{
				...
				unk_0x1701009E85B15DA4(*uParam0, 0, 1);
				uParam0->f_1 = unk_0xFD34717937104F1C();
				uParam0->f_6 = 8;
			}
		...
		case 6:
			if ((unk_0xFD34717937104F1C() - uParam0->f_1) > uParam0->f_2)
			{
				if (!func_151(*uParam0, unk_0xA19140A5C42D8715(), 15f, 1))
				{
					func_7(&(uParam0->f_4));
					uParam0->f_6 = 7;
					uParam0->f_1 = unk_0xFD34717937104F1C();
		...
		case 7:
			if (unk_0xE0FD180CD24C0B67(*uParam0, iLocal_109, 1))
			{
				...
				if (!func_151(*uParam0, unk_0xA19140A5C42D8715(), 120f, 1))
				{
					func_5(uParam0, 1, 0, 1);
				}
			}
		...
		case 9:
			if (unk_0x97B2B0016AD3C7C6(*uParam0))
			{
				func_170(uParam0, 1);
				return;
			}
			if ((unk_0xFD34717937104F1C() - uParam0->f_1) > uParam0->f_2 || !func_178(*uParam0, 2104565373))
			{
				func_157(uParam0);
			}
			break;
		...
		case 16:
			...
			if ((unk_0xFD34717937104F1C() - iLocal_670) >= 9000)
			{
				if (!func_155(uParam0))
				{
					func_157(uParam0);
			...
			else if ((unk_0xFD34717937104F1C() - iLocal_670) >= 5000 && (unk_0xFD34717937104F1C() - iLocal_670) <= 5500)
			{
				if (unk_0x5D7DFE2058701942(*uParam0, 0))
				{
					if (unk_0x5CEAC7C46CA2644F(*uParam0))
					{
						unk_0xD5D7EE979B88FFAF(*uParam0);
					}
				}
			}
			break;
		...
		case 20:
			...
			if ((unk_0xFD34717937104F1C() - uParam0->f_1) >= 6000)
			{
				if (!unk_0x54F6F5A823224519(*uParam0, unk_0x3201284584C7CD83(iLocal_109, 5f, 0f, -2f), unk_0xE2BBD32891C18569(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
				{
					func_157(uParam0);
				}
				else
...
int func_153(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_154(Param1 - unk_0xE2BBD32891C18569(iParam0, 1)) };
	...
	{
		Var3 = { func_154(unk_0x505186370955851F(iParam0, 31086, 0f, 5f, 0f) - unk_0x505186370955851F(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), unk_0x3201284584C7CD83(iLocal_109, 0f, 10f, -2f), unk_0x3201284584C7CD83(iLocal_109, 0f, 3f, 2f), 5f, 0, 1, 0) && unk_0x9661F58DC617631D(*uParam0))
	{
		return 1;
	}
	return 0;
...
void func_156(var uParam0)
{
	...
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		...
		if (func_36(iVar0))
		{
			if (!unk_0x5860446BFB759B77(*uParam0, iVar0, -1, 0, 0))
			{
				uParam0->f_6 = 18;
				uParam0->f_1 = unk_0xFD34717937104F1C();
			}
...
{
	unk_0x80E7C4A78224C8F9(2, uLocal_80, joaat("player"));
	switch (uParam0->f_8)
	{
		case 4:
			break;
		...
		case 3:
			if (!func_178(*uParam0, 242628503))
			{
				...
				if (!unk_0xE0FD180CD24C0B67(*uParam0, iLocal_109, 0))
				{
					if (uParam0->f_10 == 0)
					{
						unk_0x956B3CF461C0C1C9(*uParam0, unk_0x3201284584C7CD83(iLocal_109, func_131(1)), 1f, -1, 1048576000, 0, 1193033728);
						uParam0->f_7 = 1;
					}
					else
					{
						unk_0x956B3CF461C0C1C9(*uParam0, unk_0x3201284584C7CD83(iLocal_109, func_131(0)), 1f, -1, 1048576000, 0, 1193033728);
						uParam0->f_7 = 1;
					}
				}
			}
		...
		case 9:
			...
			else if (!unk_0xE0FD180CD24C0B67(*uParam0, iLocal_109, 0))
			{
				if (uParam0->f_10 == 0)
				{
					unk_0x956B3CF461C0C1C9(*uParam0, unk_0x3201284584C7CD83(iLocal_109, func_131(1)), 1f, -1, 1048576000, 0, 1193033728);
...
void func_158(var uParam0)
{
	if (!func_178(*uParam0, -71340211))
	{
		if (Local_134[iLocal_661 /*25*/].f_23 != 0)
		{
			if (func_10(Local_134[iLocal_661 /*25*/].f_17))
			{
				unk_0x3A943C9C7008C211(*uParam0, Local_134[iLocal_661 /*25*/].f_17, -1, 0f, 180f, 1f, 0);
			}
		}
		else
		{
			unk_0x956B3CF461C0C1C9(*uParam0, Local_134[iLocal_661 /*25*/].f_19, 1f, 20000, -1f, 0, func_159(Local_134[iLocal_661 /*25*/].f_19, unk_0xE2BBD32891C18569(*uParam0, 1), 1));
		}
		if (func_36(iLocal_109))
		{
			unk_0xD6B4F40F1425E83F(iLocal_109, 5, 0, 0);
		}
...
int func_160()
{
	if (func_36(iLocal_109) && func_335(unk_0xA19140A5C42D8715()))
	{
		if (unk_0xDEAEC99031DCB92A(iLocal_109, unk_0xA19140A5C42D8715(), 1))
		{
			unk_0xDCB46BFC2265476A(iLocal_109);
			if (func_161() || unk_0x24A1A7BF4ED94B71(iLocal_109) < 851)
			{
				return 1;
			}
		}
...
int func_161()
{
	...
	while (iVar0 <= 5)
	{
		if (unk_0xB7223494EA10AF2F(iLocal_109, iVar0, 0))
		{
			iVar1++;
		}
		iVar0++;
...
{
	if (func_36(iLocal_109) && (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_109, 0) && !unk_0xE0FD180CD24C0B67(*uParam0, iLocal_109, 0)))
	{
		if (unk_0xEAA5CEF8875FEEED(iLocal_109) > 0f)
		{
			uParam0->f_1 = unk_0xFD34717937104F1C();
			uParam0->f_8 = uParam0->f_7;
			uParam0->f_5 = 1;
...
{
	func_163(uParam0);
	if ((unk_0x852B8F739A2072BE(unk_0xA19140A5C42D8715(), 6) || iParam1) || uParam0->f_6 == 23)
	{
		if (!func_151(unk_0xA19140A5C42D8715(), *uParam0, 10f, 1))
		{
...
int func_175(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_154(unk_0xE2BBD32891C18569(iParam1, 1) - unk_0xE2BBD32891C18569(iParam0, 1)) };
...
void func_179(var uParam0)
{
	...
	{
		case 1:
			if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_109, 1))
			{
				func_170(uParam0, 0);
				return;
			}
		...
		case 2:
			if (unk_0xB10F7FE89663CB5B(*uParam0, iLocal_109))
			{
			...
			else if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_109, 1))
			{
				func_170(uParam0, 0);
				return;
			}
			...
			if (bLocal_664)
			{
				if (iLocal_661 <= 20 && iLocal_661 != -1)
				{
					if (!Local_134[iLocal_661 /*25*/].f_18)
					{
						...
						{
							if (Local_134[iLocal_661 /*25*/].f_9 && unk_0x097275D546C9735F(iLocal_109))
							{
								func_189();
							}
						}
		...
		case 5:
			if (func_36(iLocal_109))
			{
				unk_0x0185AEECD1FF63F3(iLocal_109, 25f, 10, 0);
				fVar0 = unk_0xEAA5CEF8875FEEED(iLocal_109);
				if (fVar0 < 8f)
				{
					func_188(uParam0);
				}
		...
		case 6:
			if (!func_178(*uParam0, 242628503) && unk_0x097275D546C9735F(iLocal_109))
			{
				if (bLocal_664)
				{
					uParam0->f_8 = uParam0->f_7;
		...
		case 7:
			...
			{
				if (unk_0xE0FD180CD24C0B67(Local_111[1 /*11*/], iLocal_109, 0) && Local_111[1 /*11*/].f_7 == 3)
				{
					func_124(0);
				}
			}
...
void func_180(var uParam0)
{
	...
	switch (uParam0->f_9)
	{
		case 1:
			...
			{
				unk_0x2F89329397A277BC(&uVar0);
				if (func_164(unk_0xE2BBD32891C18569(*uParam0, 1), Local_134[iLocal_661 /*25*/].f_19) > 1.5f)
				{
					unk_0xD87AD31611110768(0, Local_134[iLocal_661 /*25*/].f_19, 0);
				}
		...
		case 2:
			if (func_178(*uParam0, 242628503))
			{
				if (unk_0x411C28019DEA5CEF(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man", 3))
				{
					if (unk_0xE5B5A1FFAA0834BD(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man") >= 0.333f)
					{
						...
						if (func_10(Local_134[iLocal_661 /*25*/].f_17) && !unk_0xF797E4DD45066C88(Local_134[iLocal_661 /*25*/].f_17))
						{
							unk_0x96B71B23D409A3DB(Local_134[iLocal_661 /*25*/].f_17, *uParam0, unk_0xF622A022C26057AA(*uParam0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
						}
					}
				}
			...
			else if (!func_178(*uParam0, 713668775))
			{
				if (func_36(iLocal_109))
				{
					unk_0x956B3CF461C0C1C9(*uParam0, unk_0x3201284584C7CD83(iLocal_109, 0f, -4.8f, 0f), 1f, -1, 0.25f, 0, unk_0x552C823E1D2A019C(iLocal_109));
				}
				uParam0->f_9 = 3;
			}
			unk_0x0C0C85D739611039(*uParam0, 0.2f);
		...
		case 3:
			if (func_36(iLocal_109))
			{
				if (!func_185(unk_0x3201284584C7CD83(iLocal_109, 0f, -5.5f, 0f), iLocal_109, 1.9f, 1.9f, 8f))
				{
					if (unk_0xA60C975CBAB69F34(*uParam0, unk_0x3201284584C7CD83(iLocal_109, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, 0, 1, 0))
					{
						if (!func_178(*uParam0, 713668775))
						{
							unk_0x2F89329397A277BC(&uVar1);
							if (func_164(unk_0xE2BBD32891C18569(*uParam0, 1), unk_0xE2BBD32891C18569(iLocal_109, 1)) > 3f)
							{
								unk_0x47D73A216DD513C8(0, unk_0x552C823E1D2A019C(iLocal_109), 0);
							}
		...
		case 4:
			if (!func_185(unk_0x3201284584C7CD83(iLocal_109, 0f, -5.5f, 0f), *uParam0, 1.9f, 1.9f, 8f))
			{
				if (func_178(*uParam0, 242628503))
				{
						...
						if (unk_0xE5B5A1FFAA0834BD(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man") >= 0.391f)
						{
							if (func_10(Local_134[iLocal_661 /*25*/].f_17))
							{
								if (unk_0xF797E4DD45066C88(Local_134[iLocal_661 /*25*/].f_17))
								{
									...
									unk_0x7E6858FEEE18D422(*uParam0);
									unk_0xF334C9B245CD323D(Local_134[iLocal_661 /*25*/].f_17, 1, 0);
									unk_0x3DD8DC3DEB7BD74E(Local_134[iLocal_661 /*25*/].f_17, 2f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1082130432, -1082130432, -1082130432);
									unk_0x237212ABD2DC57D3(Local_134[iLocal_661 /*25*/].f_17, 1, unk_0xFA0A034A8C86C35E(*uParam0), 0, 1, 1, 0);
								}
								if (unk_0xC556072C29E00F04(Local_134[iLocal_661 /*25*/].f_17, iLocal_109))
								{
				...
				else
				{
					...
					if (func_36(iLocal_109))
					{
						unk_0x6B6894ACFD0185EF(iLocal_109, 5, 0);
						func_181(&(Local_134[iLocal_661 /*25*/].f_17));
					}
					func_157(uParam0);
				}
...
void func_182(var uParam0)
{
	...
	unk_0x80E7C4A78224C8F9(5, uLocal_80, joaat("player"));
	func_163(uParam0);
	if (!unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		if (!unk_0x5D7DFE2058701942(*uParam0, 0))
...
int func_185(struct<3> Param0, int iParam3, struct<3> Param4)
{
	...
	if (Local_82.f_26)
	{
		if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			if (unk_0xFAC06EE780B57279(Local_82.f_18))
			{
				if (func_10(Local_82.f_18))
				{
					if (unk_0xB86D86A5DBBC79F0(Local_82.f_18) == unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 1))
					{
						return 1;
					}
				}
		...
		else if (unk_0x281590680327CDEA(Local_82.f_18))
		{
			if (func_10(Local_82.f_18))
			{
				if (unk_0xA2EA4BA455370F3C(Local_82.f_18) == unk_0xA19140A5C42D8715())
				{
					return 1;
				}
			}
...
void func_187(var uParam0, int iParam1)
{
	switch (uParam0->f_1)
	{
		...
		case 1:
			*uParam0 = unk_0x931DC90E31FA1705(uParam0->f_2, uParam0->f_5, 511, uParam1, 7);
			break;
...
void func_188(var uParam0)
{
	...
	{
		unk_0x2F89329397A277BC(&uVar0);
		unk_0xE49301B2B6F420DE(0, iLocal_109, Local_134[iLocal_661 /*25*/].f_3, 8f, 0, joaat("trash"), 786469, 10f, 15f);
		unk_0xACD687595DC10DD1(0, iLocal_109, Local_134[iLocal_661 /*25*/].f_3, Local_134[iLocal_661 /*25*/].f_8, Local_134[iLocal_661 /*25*/].f_10, 5f, 1);
		unk_0x301F42EEE3C40328(uVar0);
		unk_0xE1072FA2FECBAD96(*uParam0, uVar0);
		unk_0x3A95A0A3221D4208(&uVar0);
		uParam0->f_7 = 6;
...
void func_190(var uParam0, bool bParam1)
{
	...
	if (func_185(unk_0x3201284584C7CD83(iLocal_109, func_131(bParam1)), iLocal_109, 1.9f, 1.9f, 8f))
	{
		if (unk_0x54F6F5A823224519(*uParam0, unk_0x3201284584C7CD83(iLocal_109, 5f, 0f, -2f), unk_0xE2BBD32891C18569(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0) && unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), unk_0x3201284584C7CD83(iLocal_109, 5f, 0f, -2f), unk_0xE2BBD32891C18569(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
		{
			func_191(uParam0);
		}
		else if (!func_178(*uParam0, 1227113341) && unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), unk_0x3201284584C7CD83(iLocal_109, 5f, 0f, -2f), unk_0xE2BBD32891C18569(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
		{
			unk_0x9568B1B58F78FF36(*uParam0);
			unk_0x8F65948C5AFB744E(*uParam0, unk_0xA19140A5C42D8715(), -1, 4f, 1f, 1073741824, 0);
		}
	}
	else if (func_101(*uParam0, unk_0x3201284584C7CD83(iLocal_109, func_131(bParam1)), 5f))
	{
		iVar0 = -1;
		if (!bParam1)
		{
		...
		unk_0xA2EBCD9385E56019(*uParam0, iLocal_109, -1, iVar0, 1f, 8388609, 0);
		uParam0->f_7 = 2;
	}
}
...
void func_192(var uParam0)
{
	if (uParam0->f_5 != 1)
	{
		if (func_36(iLocal_109) && unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			if (!func_178(*uParam0, 2104565373) && unk_0xE0FD180CD24C0B67(*uParam0, iLocal_109, 0))
			{
				if (func_151(unk_0xA19140A5C42D8715(), iLocal_109, 10f, 1))
				{
					if (unk_0xC556072C29E00F04(iLocal_109, unk_0xA19140A5C42D8715()))
					{
						unk_0xF486A07743D53969(*uParam0, unk_0xA19140A5C42D8715(), 0, 0f, 0f, 0f, 10f, 100, 1, joaat("FIRING_PATTERN_FULL_AUTO"));
						uParam0->f_1 = unk_0xFD34717937104F1C();
						uParam0->f_6 = 9;
					}
				}
...
void func_193()
{
	...
	while (iVar0 <= (iLocal_81 - 1))
	{
		if (Local_134[iVar0 /*25*/].f_23 != 0)
		{
			...
			{
				if ((iVar0 != iLocal_661 && func_10(Local_134[iVar0 /*25*/].f_17)) && func_195(Local_134[iVar0 /*25*/].f_17, unk_0xA19140A5C42D8715(), 1) > 200f)
				{
					unk_0xC0AC848E56940C34(&(Local_134[iVar0 /*25*/].f_17));
					Local_134[iVar0 /*25*/].f_24 = 0;
				}
			}
			else if (Local_134[iVar0 /*25*/].f_23 != 0)
			{
				if (func_101(unk_0xA19140A5C42D8715(), Local_134[iVar0 /*25*/], 100f) || func_101(Local_111[0 /*11*/], Local_134[iVar0 /*25*/], 120f))
				{
...
void func_196(var uParam0, int iParam1, int iParam2)
{
	if (uParam0->f_5 != 1 || iParam2)
	{
		if (!func_335(Local_111[func_165(iParam1) /*11*/]))
		{
			if (!bLocal_665)
			{
				if (unk_0xDC5D81351D6A4DDB(Local_111[func_165(iParam1) /*11*/]))
				{
					...
					{
						Local_667 = { unk_0xE2BBD32891C18569(Local_111[func_165(iParam1) /*11*/], 1) };
						uParam0->f_1 = unk_0xFD34717937104F1C();
						uParam0->f_8 = uParam0->f_7;
						uParam0->f_5 = 1;
						uParam0->f_6 = 11;
		...
		{
			if (func_175(*uParam0, Local_111[func_165(iParam1) /*11*/], 140f, 0) && func_151(Local_111[func_165(iParam1) /*11*/], unk_0xA19140A5C42D8715(), 15f, 1))
			{
				uParam0->f_5 = 1;
				uParam0->f_6 = 21;
			}
		...
		if (uParam0->f_10 == 0 && uParam0->f_7 == 4)
		{
			if (func_155(uParam0))
			{
				...
				{
					unk_0xF486A07743D53969(*uParam0, unk_0xA19140A5C42D8715(), 0, 0f, 0f, 0f, 10f, 100, 1, joaat("FIRING_PATTERN_FULL_AUTO"));
					unk_0x3CC9147E361DE531(iLocal_109, 2000f);
					iLocal_670 = unk_0xFD34717937104F1C();
					uParam0->f_1 = unk_0xFD34717937104F1C();
					uParam0->f_6 = 16;
					uParam0->f_5 = 1;
				}
		...
		if (func_198(*uParam0, 1, 70f, 170f, 0, 1, 0, 0) && !func_197(uParam0))
		{
			if (unk_0x852B8F739A2072BE(unk_0xA19140A5C42D8715(), 6))
			{
				if (func_36(iLocal_109))
				{
					if (unk_0xE0FD180CD24C0B67(*uParam0, iLocal_109, 0))
					{
						if (unk_0xEAA5CEF8875FEEED(iLocal_109) > 5f)
						{
							if (iParam1 == 0)
							{
								unk_0x5175E271E03B40D8(*uParam0, iLocal_109, unk_0xA19140A5C42D8715(), 8, 30f, 786469, 300f, 2f, 1);
								uParam0->f_6 = 7;
								unk_0xCE889E9ADEDDE843(Local_111[func_165(iParam1) /*11*/], -1);
								Local_111[func_165(iParam1) /*11*/].f_6 = 10;
								Local_111[func_165(iParam1) /*11*/].f_5 = 1;
								uParam0->f_5 = 1;
								uParam0->f_1 = unk_0xFD34717937104F1C();
								Local_111[func_165(iParam1) /*11*/].f_1 = unk_0xFD34717937104F1C();
							}
							else
							{
								unk_0xCE889E9ADEDDE843(*uParam0, -1);
								uParam0->f_6 = 12;
								unk_0x5175E271E03B40D8(Local_111[func_165(iParam1) /*11*/], iLocal_109, unk_0xA19140A5C42D8715(), 8, 30f, 786469, 300f, 2f, 1);
						...
						else
						{
							...
							if (unk_0xDC5D81351D6A4DDB(Local_111[func_165(iParam1) /*11*/]))
							{
								if (func_175(Local_111[func_165(iParam1) /*11*/], unk_0xA19140A5C42D8715(), 1126825984, 0))
								{
									func_170(&(Local_111[func_165(iParam1) /*11*/]), 0);
								}
							}
						}
						unk_0xDCB46BFC2265476A(*uParam0);
					}
					else
					{
						func_170(uParam0, 0);
			...
			else
			{
				...
				if (func_171(Local_111[func_165(iParam1) /*11*/], *uParam0, 1126825984, 1, 250, 7))
				{
					...
					unk_0xDCB46BFC2265476A(Local_111[func_165(iParam1) /*11*/]);
				}
			}
			uParam0->f_5 = 1;
		}
		else if (unk_0x97B2B0016AD3C7C6(*uParam0))
		{
			func_163(uParam0);
			unk_0x33B5487515BD13D5(*uParam0, unk_0xA19140A5C42D8715(), 500f, -1, 0, 1);
			uParam0->f_6 = 2;
		...
		if (unk_0x685AE6AF34B35D3B(*uParam0))
		{
			if (func_10(Local_134[iLocal_661 /*25*/].f_17))
			{
				if (unk_0xF797E4DD45066C88(Local_134[iLocal_661 /*25*/].f_17))
	...
	if (uParam0->f_5 != 1)
	{
		if (func_335(Local_111[func_165(iParam1) /*11*/]))
		{
			if (unk_0x97B2B0016AD3C7C6(Local_111[func_165(iParam1) /*11*/]))
			{
				func_163(uParam0);
				unk_0x33B5487515BD13D5(*uParam0, unk_0xA19140A5C42D8715(), 120f, -1, 0, 0);
				uParam0->f_1 = unk_0xFD34717937104F1C();
				uParam0->f_6 = 7;
				uParam0->f_5 = 1;
			}
...
{
	if ((unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), unk_0x3201284584C7CD83(*uParam0, 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !unk_0x852B8F739A2072BE(unk_0xA19140A5C42D8715(), 6)) && unk_0x703A9347832E1FFA(unk_0xA19140A5C42D8715()))
	{
		return 1;
	}
	return 0;
...
{
	if (func_151(uParam0, unk_0xA19140A5C42D8715(), 6f, 1))
	{
		if (!unk_0x5D7DFE2058701942(uParam0, 0))
		{
...
void func_208()
{
	if (func_36(Local_868.f_0))
	{
		if (func_151(unk_0xA19140A5C42D8715(), Local_868.f_0, 100f, 1) && !iLocal_837)
		{
		...
		else if (!func_151(unk_0xA19140A5C42D8715(), Local_868.f_0, 120f, 1) && iLocal_837)
		{
		...
		switch (*iParam2)
		{
			case 0:
				...
				else
				{
					...
					{
						unk_0xB9509A39A48644C4(func_109(func_76(), bParam9));
					}
					if (func_76() != 33)
					{
						func_211(iParam0);
	...
	switch (iLocal_684)
	{
		...
		case 3:
			if (func_36(iLocal_874))
			{
				if (!unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_874, 0))
				{
					unk_0x692D5500D82E4F5D(unk_0xA19140A5C42D8715(), iLocal_874, -1);
				}
				else
				{
			...
			if (!func_218(iVar2))
			{
				if (func_77(iVar2, 0))
				{
					if (func_225(iVar2) || func_223(iVar2))
					{
						if (func_222(iVar2, 0))
						{
							unk_0x1F7948851FB36E88(iVar2, 1, 1);
			...
			else if (unk_0x82384F63D814C864(iVar2, 1))
			{
				if (func_225(iVar2))
				{
					if (unk_0xF9D4EF1338E38AFB(iVar2, -1273030092) != 1 && unk_0xF9D4EF1338E38AFB(iVar2, -1273030092) != 0)
					{
						...
						{
							unk_0xE49301B2B6F420DE(iVar2, unk_0xCAEB6CE71A2C7212(iVar2, 0), Local_827, 20f, 0, 0, 34340901, 2f, 10f);
						}
						else
						{
				...
				else if (func_223(iVar2))
				{
					if (func_36(Local_868.f_0))
					{
						if (!func_151(iVar2, Local_868.f_0, 17f, 1))
						{
							if (unk_0xF9D4EF1338E38AFB(iVar2, -1273030092) != 1 && unk_0xF9D4EF1338E38AFB(iVar2, -1273030092) != 0)
							{
								unk_0x4123165906C17D87(iVar2, unk_0xCAEB6CE71A2C7212(iVar2, 0), Local_868.f_0, 3, 20f, 786468, 2f, 0.5f, 1);
							}
						}
					}
				}
...
int func_225(int iParam0)
{
	if (!func_224())
	{
		if ((unk_0xDC5D81351D6A4DDB(Local_868.f_0) && unk_0x1095F403F52B42E1(Local_868.f_0, 0)) && !unk_0xA60C975CBAB69F34(Local_868.f_0, Local_827, 2f, 2f, 2f, 0, 1, 0))
		{
			if ((!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()) && unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), Local_868.f_0, 0)) && unk_0x91347D2A80F38492(unk_0xD4E735F4B6A956AC()) == 0)
			{
				if (unk_0xE0FD180CD24C0B67(iParam0, Local_868.f_0, 0) && unk_0xB0D49A1F9F054602(Local_868.f_0, -1, 0) == iParam0)
				{
					return 1;
				}
			}
...
void func_226(int iParam0)
{
	if (iLocal_683 > 1)
	{
		if (iLocal_685 > 0)
		{
			if (!unk_0x05EFB6A616B6FADE(Local_688[iParam0 /*8*/].f_7, 0) && iLocal_686 == 1)
			{
				if (!unk_0x8187CC9EB2D7CFE6())
				{
					if (func_230(&uLocal_879, cLocal_878, Local_688[iParam0 /*8*/][0], 8, 0, 0, 0))
					{
						unk_0x2BCFB39E86340DAA(&(Local_688[iParam0 /*8*/].f_7), 0);
					}
				}
			}
		}
		...
		{
			if ((unk_0x05EFB6A616B6FADE(Local_688[iParam0 /*8*/].f_7, 0) && !unk_0x05EFB6A616B6FADE(Local_688[iParam0 /*8*/].f_7, 1)) && iLocal_686 == 1)
			{
				if (!unk_0x8187CC9EB2D7CFE6())
				{
					if (func_230(&uLocal_879, cLocal_878, Local_688[iParam0 /*8*/][1], 7, 0, 0, 0))
					{
						unk_0x2BCFB39E86340DAA(&(Local_688[iParam0 /*8*/].f_7), 1);
					}
				}
			}
			if (!unk_0x05EFB6A616B6FADE(Local_688[iParam0 /*8*/].f_7, 5))
			{
				if (func_229(iLocal_874, Local_827, 1) < 15f && iLocal_686 == 1)
				{
					if (!unk_0x8187CC9EB2D7CFE6())
					{
						...
						{
							unk_0x2BCFB39E86340DAA(&(Local_688[iParam0 /*8*/].f_7), 5);
						}
					}
				}
			}
...
{
	if (!unk_0x05EFB6A616B6FADE(Local_688[iParam0 /*8*/].f_7, iParam1))
	{
		if (iLocal_1052 != -1)
		{
			if (!unk_0x8187CC9EB2D7CFE6())
			{
				...
				{
					unk_0x2BCFB39E86340DAA(&(Local_688[iParam0 /*8*/].f_7), iParam1);
				}
			}
		}
		else if (!func_231() && !unk_0x8187CC9EB2D7CFE6())
		{
			iLocal_1052 = unk_0xFD34717937104F1C();
		}
		else
		{
			iLocal_1052 = -1;
...
{
	if ((unk_0x05EFB6A616B6FADE(Local_688[0 /*8*/].f_7, iParam0) || unk_0x05EFB6A616B6FADE(Local_688[1 /*8*/].f_7, iParam0)) || unk_0x05EFB6A616B6FADE(Local_688[2 /*8*/].f_7, iParam0))
	{
		return 1;
	}
	return 0;
...
void func_232()
{
	if (func_101(unk_0xA19140A5C42D8715(), Local_827, 220f))
	{
		if (!iLocal_877 && !func_101(unk_0xA19140A5C42D8715(), Local_827, 100f))
		{
			iLocal_877 = func_147(&uLocal_876, joaat("cavalcade2"), 1370.912f, -2060.055f, 50.9983f, 312.8686f, 1);
		}
	}
	else if (func_101(unk_0xA19140A5C42D8715(), Local_827, 240f))
	{
		if (iLocal_877)
		{
			func_6(&uLocal_876);
...
void func_233()
{
	...
	switch (iLocal_684)
	{
		...
		case 1:
			...
			if (!bLocal_833)
			{
				if (func_335(Local_840.f_0) && unk_0x97B2B0016AD3C7C6(Local_840.f_0))
				{
					func_235();
				}
				if (func_335(Local_854.f_0) && unk_0x97B2B0016AD3C7C6(Local_854.f_0))
				{
					func_235();
				}
			}
...
int func_245(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_253() || func_252(Global_4456448.f_152990)) || func_251())
	{
		if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			...
			if (((unk_0x39CF954DC56E2A1F(iVar0, iVar1) || (unk_0x8F474E419F56E48D(iVar0) == joaat("apc") && iVar1 != -1)) || (unk_0x8F474E419F56E48D(iVar0) == joaat("akula") && iVar1 != -1)) || (((unk_0x8F474E419F56E48D(iVar0) == joaat("riot2") && iVar1 == 0) && func_249(iVar0, 10)) && unk_0x22D95AF01E737CA1(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_278()
{
	...
	if (unk_0xDC5D81351D6A4DDB(iVar0))
	{
		if (unk_0x1095F403F52B42E1(iVar0, 0))
		{
			func_279(iVar0, unk_0xE2BBD32891C18569(iVar0, 1), unk_0x552C823E1D2A019C(iVar0), 24, 0);
		}
	}
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_306(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
...
void func_332()
{
	...
	if (!func_36(iLocal_874))
	{
		...
		if (func_36(Local_868.f_0) && !func_151(unk_0xA19140A5C42D8715(), Local_868.f_0, fVar0, 1))
		{
			func_334(2);
		}
	}
	...
	{
		iVar1 = 0;
		if (!func_151(unk_0xA19140A5C42D8715(), iLocal_874, fVar0, 1))
		{
			iVar1++;
		}
		if (func_36(uLocal_875))
		{
			if (!func_151(unk_0xA19140A5C42D8715(), uLocal_875, fVar0, 1))
			{
				iVar1++;
			}
		}
		...
		if (func_36(Local_868.f_0))
		{
			if (!func_151(unk_0xA19140A5C42D8715(), Local_868.f_0, fVar0, 1))
			{
				iVar1++;
			}
		}
...
void func_369()
{
	...
	unk_0xFC00A668AFC2126D(joaat("s_m_y_garbage"), 0);
	func_62();
	func_379();
	func_378();
	func_370(0);
...
void func_370(bool bParam0)
{
	...
	if (bParam0)
	{
		if (unk_0xDC5D81351D6A4DDB(iLocal_874))
		{
			if (unk_0xDC5D81351D6A4DDB(unk_0xA19140A5C42D8715()))
			{
				if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	...
	func_139(&uLocal_671, 0, 0);
	if (unk_0x37B568B777BC65F9(uLocal_823))
	{
		unk_0x8E88E73F74A9FF79(0, 0, 3000, 1, 0, 0);
		unk_0x77F0486CE0E598D5(uLocal_823, 0);
	}
}
...
void func_377()
{
	unk_0xA5DE74AE39867B03(Local_868.f_5);
}
