...
void __EntryFunction__()
{
	...
	while (true)
	{
		unk_0xCBBDAEEE9AB391E3("M_TrT", 0);
		if (func_321(unk_0x096275889B8E0EE0()))
		{
			func_317();
			func_313();
	...
	switch (iLocal_683)
	{
		case 0:
			...
			if (unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 0))
			{
				...
				if (func_36(iVar0) && unk_0xDA76A9F39210D365(iVar0) == joaat("towtruck"))
				{
					func_35(iVar0, 2);
				}
			}
			if (!unk_0x2CF12F9ACF18F048(sLocal_817))
			{
				func_33(sLocal_817);
			}
			else
		...
		case 1:
			if (func_17())
			{
				...
				func_2();
				unk_0x3B882A96EA77D5B1(unk_0xA86D5F069399F44D(unk_0x096275889B8E0EE0(), 1), 30f, 1, 0, 0, 0);
				func_355();
			}
			break;
	}
...
void func_3()
{
	...
	unk_0x1A217D7977B7A43B(uLocal_79);
	unk_0x4763145053A33D46("missfbi4prepp1");
	unk_0xDDB2F6758A3724EF("missfbi4prepp1_garbageman");
}
...
void func_26()
{
	...
	{
		if (func_30(Global_97353.f_1729.f_539.f_3213) != unk_0xDA76A9F39210D365(unk_0x096275889B8E0EE0()))
		{
...
void func_38()
{
	...
	switch (iLocal_683)
	{
		...
		case 1:
			if (!func_100(unk_0x096275889B8E0EE0(), Local_826, 270f))
			{
				iLocal_683 = 2;
			}
...
void func_42(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (!unk_0x6CFF81397164A1D3(unk_0x096275889B8E0EE0()) && !func_43(unk_0x217E9DC48139933D()))
		{
...
void func_101()
{
	...
	switch (iLocal_683)
	{
		case 0:
			if (func_115(iLocal_682, bLocal_27))
			{
				if (unk_0xABC532F9098BFD9D(unk_0x217E9DC48139933D()) == 0)
				{
					...
					{
						if (unk_0x9C8E4D238C999648(unk_0x096275889B8E0EE0(), iLocal_873, 0))
						{
		...
		case 3:
			...
			{
				if (!unk_0x9C8E4D238C999648(unk_0x096275889B8E0EE0(), Local_867.f_0, 0))
				{
					unk_0xF80258351D8421EB(unk_0x096275889B8E0EE0(), Local_867.f_0, -1);
				}
				else
				{
...
int func_106(int iParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	...
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			if (!unk_0x5E58342602E94718(unk_0x096275889B8E0EE0(), Param1, fParam12, fParam12, 2f, 0, 1, 2))
			{
				...
				{
					unk_0xB836C5982F4438BA(func_112(func_75()));
				}
				*iParam7 = 1;
			...
			else
			{
				...
				{
					fVar0 = (fParam12 / 2f);
					if (func_100(unk_0x096275889B8E0EE0(), Param1, fVar0))
					{
						*iParam7 = 0;
	...
	else
	{
		...
		if (!*iParam8)
		{
			...
			{
				unk_0xB836C5982F4438BA(func_108(func_75(), 0));
			}
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_142(1, Local_823, 0))
			{
				if (func_141())
				{
					...
					unk_0x57F925DF866E2CBD(joaat("s_m_y_garbage"), 1);
					iLocal_682 = 2;
					func_7(&iLocal_820);
					...
					unk_0x904737E822742E53("WORLD_VEHICLE_ATTRACTOR", 0);
				...
				else if (((func_142(2, Local_867.f_1, Local_867.f_4) && func_142(3, Local_839.f_1, Local_839.f_4)) && func_142(4, Local_853.f_1, Local_853.f_4)) && func_134(0))
				{
					...
					unk_0x57F925DF866E2CBD(joaat("towtruck"), 1);
					unk_0x57F925DF866E2CBD(joaat("s_m_y_garbage"), 1);
					if (unk_0x6D2C41A8BD6D6FD0(Local_867.f_0) != 0)
					{
						iVar0 = unk_0x6D2C41A8BD6D6FD0(Local_867.f_0);
		...
		case 1:
			if (bParam1)
			{
				...
				{
					func_117(unk_0x096275889B8E0EE0(), 1197.861f, -353.011f, 68.0929f, 278.9647f);
					func_116();
					bLocal_27 = false;
					unk_0x904737E822742E53("DRIVE", 0);
					unk_0x904737E822742E53("WORLD_VEHICLE_ATTRACTOR", 0);
...
void func_120(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	unk_0x352AB5EAB2338B18("Enemies", &uLocal_79);
	unk_0x6ECBACF91786FB7A(Local_110[0 /*11*/], uLocal_79);
	unk_0x6ECBACF91786FB7A(Local_110[1 /*11*/], uLocal_79);
	unk_0x0A5D170C44CB2189(Local_110[0 /*11*/], 1, 0);
	unk_0x0A5D170C44CB2189(Local_110[1 /*11*/], 1, 0);
...
void func_122()
{
	if (!unk_0x9C8E4D238C999648(Local_110[0 /*11*/], iLocal_108, 0))
	{
		unk_0x14A4402A811D03C0(Local_110[0 /*11*/], unk_0xC899C78DB72CCBCC(iLocal_108, func_130(1)), 1f, -1, 1048576000, 0, 1193033728);
...
{
	if (!unk_0xE052C1B1CAA4ECE4(iLocal_108, 0))
	{
		func_124(bParam0);
		if (iLocal_660 != (iLocal_80 - 1))
		{
			if (iLocal_660 == 4)
			{
				unk_0xABBB949C62E22DE3(Local_110[0 /*11*/], iLocal_108, Local_133[iLocal_660 /*25*/], 15f, 2883755, Local_133[iLocal_660 /*25*/].f_6);
			}
			else
			{
				unk_0xBB26FB233542CFFE(Local_110[0 /*11*/], iLocal_108, Local_133[iLocal_660 /*25*/], 15f, 0, 0, 2883755, Local_133[iLocal_660 /*25*/].f_6, Local_133[iLocal_660 /*25*/].f_7);
			}
		...
		{
			unk_0x02C53261E93C1B87(Local_110[0 /*11*/], iLocal_108, 15f, 786599);
			Local_110[0 /*11*/].f_8 = Local_110[0 /*11*/].f_7;
...
void func_124(bool bParam0)
{
	if (iLocal_660 != -1)
	{
		...
		{
			unk_0xBBB134FB9D50C0CC(Local_133[iLocal_660 /*25*/].f_11 - Local_133[iLocal_660 /*25*/].f_14, Local_133[iLocal_660 /*25*/].f_11 + Local_133[iLocal_660 /*25*/].f_14, 1, 1);
		}
	}
	if (!bParam0)
	{
	...
	if (iLocal_660 != -1)
	{
		if (!func_129(Local_133[iLocal_660 /*25*/].f_11) && !func_129(Local_133[iLocal_660 /*25*/].f_14))
		{
			unk_0xBBB134FB9D50C0CC(Local_133[iLocal_660 /*25*/].f_11 - Local_133[iLocal_660 /*25*/].f_14, Local_133[iLocal_660 /*25*/].f_11 + Local_133[iLocal_660 /*25*/].f_14, 0, 1);
		}
	}
}
...
int func_125()
{
	...
	{
		Var1 = { unk_0xA86D5F069399F44D(iLocal_108, 1) };
		iVar4 = 0;
		while (iVar4 <= (iLocal_80 - 1))
		{
			fVar28 = unk_0x0BE7F4E3CDBAFB28(Var1, Local_133[iVar4 /*25*/], 1);
		...
		fVar30 = func_126(Local_133[iVar0 /*25*/] - Var1, unk_0x2412D9C05BB09B97(iLocal_108));
		iVar5 = iVar0;
		iVar31 = 0;
		while (fVar30 < 0f && iVar31 < 40)
		{
			...
			Var1 = { unk_0xA86D5F069399F44D(iLocal_108, 1) };
			fVar30 = func_126(Local_133[iVar5 /*25*/] - Var1, unk_0x2412D9C05BB09B97(iLocal_108));
			iVar31++;
		}
		if (iVar31 >= 40)
		{
...
int func_128()
{
	...
	iVar0 = unk_0x9C1C462D7B1DD1F9(0, (iLocal_80 - 1));
...
Vector3 func_130(bool bParam0)
{
	...
	if (!bParam0)
	{
		uVar3 = unk_0xBACA8FE9C76C124E(iLocal_108, "wheel_rf");
	}
	else
	{
		uVar3 = unk_0xBACA8FE9C76C124E(iLocal_108, "wheel_lf");
	}
	Var0 = { unk_0x82CFA50E34681CA5(iLocal_108, uVar3) };
	Var0 = { unk_0x497C6B1A2C9AE69C(iLocal_108, Var0) };
	if (!bParam0)
	{
...
{
	unk_0xA862A2AD321F94B4("missfbi4prepp1");
	unk_0x18EBAFC307C79DD2("missfbi4prepp1_garbageman");
	if (bParam0)
	{
		while (!unk_0x27FF6FE8009B40CA("missfbi4prepp1") && !unk_0xD280D9E0E6D4D29F("missfbi4prepp1_garbageman"))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		return 1;
	}
	else if (unk_0x27FF6FE8009B40CA("missfbi4prepp1") && unk_0xD280D9E0E6D4D29F("missfbi4prepp1_garbageman"))
	{
		return 1;
	}
	return 0;
...
void func_136(var uParam0)
{
	...
	func_91(uParam0, iVar0, unk_0x096275889B8E0EE0(), sVar1, 0, 1);
}
...
int func_141()
{
	if (unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 0))
	{
		if (unk_0x0045A54EC7A22455(unk_0xB3598EA616C3FFC3(unk_0x096275889B8E0EE0(), 0), joaat("trash")))
		{
			unk_0xDC19C288082E586E(unk_0xB3598EA616C3FFC3(unk_0x096275889B8E0EE0(), 0), 1, 0);
			iLocal_873 = unk_0xB3598EA616C3FFC3(unk_0x096275889B8E0EE0(), 0);
			if (func_36(iLocal_873))
			{
				return 1;
			}
...
int func_142(int iParam0, struct<3> Param1, float fParam4)
{
	switch (iParam0)
	{
		...
		case 1:
			unk_0x7C11D0C2EFACD80D(sLocal_818, 0);
		...
		case 2:
			if (func_36(Global_86864[0]))
			{
				...
				if (func_36(Local_867.f_0))
				{
					...
					unk_0x252253C8A45AA1FC(Local_867.f_0, 1);
					unk_0x740CB4F3F602C9F4(Local_867.f_0, 1);
					return 1;
				}
			}
		...
		case 3:
			if (unk_0xD42BD6EB2E0F1677(Global_86864.f_9[0]))
			{
				if (!unk_0x60B55BC4863CE98E(Global_86864.f_9[0], 1))
				{
					...
					if (func_321(Local_839.f_0))
					{
						unk_0x49876BF356F39E66(Local_839.f_0, true);
						unk_0x020E173F318C12DA(Local_839.f_0, 170, 0);
						unk_0xF6482620334B0094(Local_839.f_0, 65536, 1);
						unk_0x32A582AACCBCAEFE(Local_839.f_0, 50, 1);
						return 1;
					}
				}
				else
			...
			else if (func_143(&Local_839, Local_839.f_5, Local_839.f_1, Local_839.f_4, 1, 0, 1, 1))
			{
				if (func_36(Local_867.f_0))
				{
					unk_0xF80258351D8421EB(Local_839.f_0, Local_867.f_0, -1);
					unk_0x49876BF356F39E66(Local_839.f_0, true);
					unk_0x020E173F318C12DA(Local_839.f_0, 170, 0);
					unk_0xF6482620334B0094(Local_839.f_0, 65536, 1);
					unk_0x32A582AACCBCAEFE(Local_839.f_0, 50, 1);
		...
		case 4:
			...
			{
				if (!unk_0x60B55BC4863CE98E(Global_86864.f_9[1], 1))
				{
					unk_0xDC19C288082E586E(Global_86864.f_9[1], 1, 1);
					Local_853.f_0 = Global_86864.f_9[1];
					if (func_321(Local_853.f_0))
					{
						unk_0x020E173F318C12DA(Local_853.f_0, 170, 0);
						unk_0xF6482620334B0094(Local_853.f_0, 65536, 1);
						unk_0x32A582AACCBCAEFE(Local_853.f_0, 50, 1);
						unk_0x49876BF356F39E66(Local_853.f_0, true);
						unk_0x9B9EE31AED48072E(Local_853.f_0, 1);
						return 1;
					}
				}
				else
			...
			else if (func_143(&Local_853, Local_853.f_5, Local_853.f_1, Local_853.f_4, 1, 0, 1, 1))
			{
				if (func_36(Local_867.f_0))
				{
					unk_0xF80258351D8421EB(Local_853.f_0, Local_867.f_0, 0);
					unk_0x020E173F318C12DA(Local_853.f_0, 170, 0);
					unk_0xF6482620334B0094(Local_853.f_0, 65536, 1);
					unk_0x32A582AACCBCAEFE(Local_853.f_0, 50, 1);
					unk_0x49876BF356F39E66(Local_853.f_0, true);
...
void func_149(var uParam0, int iParam1)
{
	if (func_321(*uParam0))
	{
		...
		if (unk_0xDEE49D5CA6C49148(*uParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 3))
		{
			if (unk_0x6B0B5671C53485D8(*uParam0, "missfbi4prepp1", "_bag_drop_garbage_man") >= 0.172f)
			{
				if (func_10(Local_133[iLocal_660 /*25*/].f_17) && unk_0xEE6AD63ABF59C0B7(Local_133[iLocal_660 /*25*/].f_17))
				{
					unk_0x4F94F6F61C24F87C(*uParam0, 1048576000);
					unk_0xDBE3DEBE116FC3FD(*uParam0);
					if (iLocal_660 <= 20 && iLocal_660 != -1)
					{
						Local_133[iLocal_660 /*25*/].f_18 = 1;
						uParam0->f_9 = 0;
					}
					unk_0x64CDE9D6BF8ECAD3(Local_133[iLocal_660 /*25*/].f_17, 1, 0);
					unk_0x31DA7CEC5334DB37(Local_133[iLocal_660 /*25*/].f_17, 1, unk_0x2412D9C05BB09B97(*uParam0), 0, 1, 1, 0);
				}
			}
		}
		switch (uParam0->f_5)
	...
	else
	{
		...
		{
			if (unk_0xEE6AD63ABF59C0B7(Local_133[iLocal_660 /*25*/].f_17))
			{
				unk_0x64CDE9D6BF8ECAD3(Local_133[iLocal_660 /*25*/].f_17, 1, 0);
				unk_0x31DA7CEC5334DB37(Local_133[iLocal_660 /*25*/].f_17, 1, unk_0x2412D9C05BB09B97(*uParam0), 0, 1, 1, 0);
			}
		...
		if (unk_0xD42BD6EB2E0F1677(*uParam0))
		{
			if (!func_150(unk_0x096275889B8E0EE0(), *uParam0, 150f) && !bLocal_664)
			{
...
void func_151(var uParam0)
{
	...
	{
		case 5:
			if ((unk_0x4F67E8ECA7D3F667() - uParam0->f_1) > uParam0->f_3)
			{
				if (func_177(*uParam0, 780511057))
				{
					unk_0x0F1ABE64C3C18E5A(*uParam0);
				}
				unk_0x06C6AD4F38E8412D(*uParam0, unk_0x096275889B8E0EE0(), 30f, -1, 0, 0);
				uParam0->f_6 = 6;
				uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
			}
			break;
		...
		case 21:
			...
			{
				if (func_170(*uParam0, unk_0x096275889B8E0EE0(), 1126825984, 1, 250, 7))
				{
					func_169(uParam0, 1);
					return;
				}
			...
			if ((unk_0x4F67E8ECA7D3F667() - uParam0->f_1) > uParam0->f_3)
			{
				...
				{
					unk_0xC1E57B22216DB5F2(*uParam0, unk_0x096275889B8E0EE0(), 8f, -1f, 10f, 0);
				}
				else
				{
				...
				if (!unk_0xCD82FA174080B3B1(uParam0->f_4))
				{
		...
		case 10:
			if ((unk_0x4F67E8ECA7D3F667() - uParam0->f_1) > uParam0->f_3)
			{
				if (unk_0x52BE10F427339B39(*uParam0, 0))
				{
					unk_0x28AC5FC91EA70789(*uParam0, 120, 1);
					uParam0->f_6 = 12;
					uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
				}
		...
		case 3:
			if ((unk_0x4F67E8ECA7D3F667() - uParam0->f_1) > uParam0->f_3)
			{
				unk_0x121389EDF3165EFB(*uParam0, 1, 1);
				unk_0x06C6AD4F38E8412D(*uParam0, unk_0x096275889B8E0EE0(), 500f, -1, 0, 1);
				uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
				uParam0->f_6 = 4;
				uParam0->f_5 = 1;
			}
		...
		case 11:
			func_165(uParam0);
			if ((unk_0x4F67E8ECA7D3F667() - uParam0->f_1) > 5000)
			{
				if (!func_177(*uParam0, 713668775))
				{
					if (unk_0xD42BD6EB2E0F1677(Local_110[func_164(uParam0->f_10) /*11*/]))
					{
						unk_0x14A4402A811D03C0(*uParam0, Local_666, 1f, -1, 2f, 0, 1193033728);
					}
				}
				uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
				uParam0->f_6 = 23;
		...
		case 18:
			if (!func_177(*uParam0, -2017877118))
			{
				...
				if (func_163(unk_0xA86D5F069399F44D(*uParam0, 1), unk_0xA86D5F069399F44D(unk_0x096275889B8E0EE0(), 1)) > 1.5f)
				{
					unk_0x26D1C211B43D46E1(0, unk_0xA86D5F069399F44D(unk_0x096275889B8E0EE0(), 1), 0);
				}
				unk_0x42E581F1274EFDB7(0, "WORLD_HUMAN_MOBILE_FILM_SHOCKING", 6000, 1);
				unk_0xFF7E39890B2840DD(uVar1);
				unk_0xD59C10966EB589EA(*uParam0, uVar1);
		...
		case 19:
			...
			if (!func_177(*uParam0, -2017877118))
			{
				unk_0x42E581F1274EFDB7(*uParam0, "WORLD_HUMAN_MOBILE_FILM_SHOCKING", 6000, 1);
				uParam0->f_5 = 1;
				uParam0->f_6 = 20;
				uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
			}
		...
		case 1:
			if (!unk_0x9C8E4D238C999648(*uParam0, iLocal_108, 0))
			{
				func_161(uParam0);
			}
			break;
		...
		case 2:
			if (!unk_0x08B96A437661F1BC(*uParam0) && (unk_0x4F67E8ECA7D3F667() - uParam0->f_1) > 3000)
			{
				func_161(uParam0);
			}
			break;
		...
		case 4:
			if ((unk_0x4F67E8ECA7D3F667() - uParam0->f_1) > 8000)
			{
				...
				unk_0x121389EDF3165EFB(*uParam0, 0, 1);
				uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
				uParam0->f_6 = 8;
			}
			else if (unk_0xABC532F9098BFD9D(unk_0x217E9DC48139933D()) > 1)
			{
				unk_0x121389EDF3165EFB(*uParam0, 0, 1);
				uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
				uParam0->f_6 = 8;
		...
		case 6:
			if ((unk_0x4F67E8ECA7D3F667() - uParam0->f_1) > uParam0->f_2)
			{
				if (!func_150(*uParam0, unk_0x096275889B8E0EE0(), 15f))
				{
					func_7(&(uParam0->f_4));
					uParam0->f_6 = 7;
					uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
		...
		case 7:
			if (unk_0x9C8E4D238C999648(*uParam0, iLocal_108, 1))
			{
				...
				if (!func_150(*uParam0, unk_0x096275889B8E0EE0(), 120f))
				{
					func_5(uParam0, 1, 0, 1);
				}
			}
		...
		case 9:
			if (unk_0x1E8A2C0DC15A2CCA(*uParam0))
			{
				func_169(uParam0, 1);
				return;
			}
			if ((unk_0x4F67E8ECA7D3F667() - uParam0->f_1) > uParam0->f_2 || !func_177(*uParam0, 2104565373))
			{
				func_156(uParam0);
			}
			break;
		...
		case 16:
			...
			if ((unk_0x4F67E8ECA7D3F667() - iLocal_669) >= 9000)
			{
				if (!func_154(uParam0))
				{
					func_156(uParam0);
			...
			else if ((unk_0x4F67E8ECA7D3F667() - iLocal_669) >= 5000 && (unk_0x4F67E8ECA7D3F667() - iLocal_669) <= 5500)
			{
				if (unk_0x52BE10F427339B39(*uParam0, 0))
				{
					if (unk_0xBC22A86CD72FE102(*uParam0))
					{
						unk_0xD74CE87EDE75C5BD(*uParam0);
					}
				}
			}
			break;
		...
		case 20:
			...
			if ((unk_0x4F67E8ECA7D3F667() - uParam0->f_1) >= 6000)
			{
				if (!unk_0xD3151E53134595E5(*uParam0, unk_0xC899C78DB72CCBCC(iLocal_108, 5f, 0f, -2f), unk_0xA86D5F069399F44D(iLocal_108, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
				{
					func_156(uParam0);
				}
				else
...
int func_152(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_153(Param1 - unk_0xA86D5F069399F44D(iParam0, 1)) };
	...
	{
		Var3 = { func_153(unk_0x012B43913EE9671C(iParam0, 31086, 0f, 5f, 0f) - unk_0x012B43913EE9671C(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	if (unk_0xD3151E53134595E5(unk_0x096275889B8E0EE0(), unk_0xC899C78DB72CCBCC(iLocal_108, 0f, 10f, -2f), unk_0xC899C78DB72CCBCC(iLocal_108, 0f, 3f, 2f), 5f, 0, 1, 0) && unk_0x82A66DCC07835AD4(*uParam0))
	{
		return 1;
	}
	return 0;
...
void func_155(var uParam0)
{
	...
	if (unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 0))
	{
		...
		if (func_36(iVar0))
		{
			if (!unk_0x80DDCCB2F4A3EB57(*uParam0, iVar0, -1, 0, 0))
			{
				uParam0->f_6 = 18;
				uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
			}
...
{
	unk_0x9E0FEFE102840007(2, uLocal_79, joaat("player"));
	switch (uParam0->f_8)
	{
		case 4:
			break;
		...
		case 3:
			if (!func_177(*uParam0, 242628503))
			{
				...
				if (!unk_0x9C8E4D238C999648(*uParam0, iLocal_108, 0))
				{
					if (uParam0->f_10 == 0)
					{
						unk_0x14A4402A811D03C0(*uParam0, unk_0xC899C78DB72CCBCC(iLocal_108, func_130(1)), 1f, -1, 1048576000, 0, 1193033728);
						uParam0->f_7 = 1;
					}
					else
					{
						unk_0x14A4402A811D03C0(*uParam0, unk_0xC899C78DB72CCBCC(iLocal_108, func_130(0)), 1f, -1, 1048576000, 0, 1193033728);
						uParam0->f_7 = 1;
					}
				}
			}
		...
		case 9:
			...
			else if (!unk_0x9C8E4D238C999648(*uParam0, iLocal_108, 0))
			{
				if (uParam0->f_10 == 0)
				{
					unk_0x14A4402A811D03C0(*uParam0, unk_0xC899C78DB72CCBCC(iLocal_108, func_130(1)), 1f, -1, 1048576000, 0, 1193033728);
...
void func_157(var uParam0)
{
	if (!func_177(*uParam0, -71340211))
	{
		if (Local_133[iLocal_660 /*25*/].f_23 != 0)
		{
			if (func_10(Local_133[iLocal_660 /*25*/].f_17))
			{
				unk_0x26CE82EE0721D430(*uParam0, Local_133[iLocal_660 /*25*/].f_17, -1, 0f, 180f, 1f, 0);
			}
		}
		else
		{
			unk_0x14A4402A811D03C0(*uParam0, Local_133[iLocal_660 /*25*/].f_19, 1f, 20000, -1f, 0, func_158(Local_133[iLocal_660 /*25*/].f_19, unk_0xA86D5F069399F44D(*uParam0, 1), 1));
		}
		if (func_36(iLocal_108))
		{
			unk_0x550CE392A4672412(iLocal_108, 5, 0, 0);
		}
...
int func_159()
{
	if (func_36(iLocal_108) && func_321(unk_0x096275889B8E0EE0()))
	{
		if (unk_0x7B6E7BEC1143AC86(iLocal_108, unk_0x096275889B8E0EE0(), 1))
		{
			unk_0xBB19AC7D4DCEFD0F(iLocal_108);
			if (func_160() || unk_0x82368787EA73C0F7(iLocal_108) < 851)
			{
				return 1;
			}
		}
...
int func_160()
{
	...
	while (iVar0 <= 5)
	{
		if (unk_0xA8E6DDEBFADD66C2(iLocal_108, iVar0, 0))
		{
			iVar1++;
		}
		iVar0++;
	...
	if (uParam0->f_7 == 9)
	{
		if (uParam0->f_9 >= 2)
		{
			if (!unk_0x6CFF81397164A1D3(*uParam0))
			{
				unk_0x4F94F6F61C24F87C(*uParam0, 1048576000);
				unk_0xDBE3DEBE116FC3FD(*uParam0);
				unk_0x8DBC05C86F873CC9(*uParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 8f, -8f, -1, 56, 0, 0, 0, 0);
			}
		}
	}
}
...
{
	if (func_36(iLocal_108) && (unk_0x9C8E4D238C999648(unk_0x096275889B8E0EE0(), iLocal_108, 0) && !unk_0x9C8E4D238C999648(*uParam0, iLocal_108, 0)))
	{
		if (unk_0xFB6BA510A533DF81(iLocal_108) > 0f)
		{
			uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
			uParam0->f_8 = uParam0->f_7;
			uParam0->f_5 = 1;
...
int func_167(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x17D3E31025A05A57(iVar0, func_168(unk_0x03A753E2C8458335(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x17D3E31025A05A57(iVar0, func_168(unk_0x03A753E2C8458335(), 0.7f, 0.7f));
		unk_0x5F3268378F24D97B(iVar0, bParam1);
	}
...
{
	func_162(uParam0);
	if ((unk_0x0878A3DD21BC848A(unk_0x096275889B8E0EE0(), 6) || iParam1) || uParam0->f_6 == 23)
	{
		if (!func_150(unk_0x096275889B8E0EE0(), *uParam0, 10f))
		{
...
int func_174(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_153(unk_0xA86D5F069399F44D(iParam1, 1) - unk_0xA86D5F069399F44D(iParam0, 1)) };
...
void func_178(var uParam0)
{
	...
	{
		case 1:
			if (unk_0x9C8E4D238C999648(unk_0x096275889B8E0EE0(), iLocal_108, 1))
			{
				func_169(uParam0, 0);
				return;
			}
		...
		case 2:
			if (unk_0xEB8F1713A0FC1B96(*uParam0, iLocal_108))
			{
			...
			else if (unk_0x9C8E4D238C999648(unk_0x096275889B8E0EE0(), iLocal_108, 1))
			{
				func_169(uParam0, 0);
				return;
			}
			...
			if (bLocal_663)
			{
				if (iLocal_660 <= 20 && iLocal_660 != -1)
				{
					if (!Local_133[iLocal_660 /*25*/].f_18)
					{
						...
						{
							if (Local_133[iLocal_660 /*25*/].f_9 && unk_0x78C3311A73135241(iLocal_108))
							{
								func_188();
							}
						}
		...
		case 5:
			if (func_36(iLocal_108))
			{
				unk_0x334357D0C82BAE3D(iLocal_108, 25f, 10, 0);
				fVar0 = unk_0xFB6BA510A533DF81(iLocal_108);
				if (fVar0 < 8f)
				{
					func_187(uParam0);
				}
		...
		case 6:
			if (!func_177(*uParam0, 242628503) && unk_0x78C3311A73135241(iLocal_108))
			{
				if (bLocal_663)
				{
					uParam0->f_8 = uParam0->f_7;
				...
				{
					unk_0x36DBE8E570B9FBCE(*uParam0, 0, 0);
					uParam0->f_8 = uParam0->f_7;
					uParam0->f_7 = 8;
				}
			}
		...
		case 7:
			...
			{
				if (unk_0x9C8E4D238C999648(Local_110[1 /*11*/], iLocal_108, 0) && Local_110[1 /*11*/].f_7 == 3)
				{
					func_123(0);
				}
			}
...
void func_179(var uParam0)
{
	...
	switch (uParam0->f_9)
	{
		case 1:
			...
			{
				unk_0xF4BF3E3D7FE56705(&uVar0);
				if (func_163(unk_0xA86D5F069399F44D(*uParam0, 1), Local_133[iLocal_660 /*25*/].f_19) > 1.5f)
				{
					unk_0x26D1C211B43D46E1(0, Local_133[iLocal_660 /*25*/].f_19, 0);
				}
				unk_0x8DBC05C86F873CC9(0, "missfbi4prepp1", "_bag_pickup_garbage_man", 8f, -16f, -1, 528384, 0, 0, 0, 0);
				unk_0xFF7E39890B2840DD(uVar0);
				unk_0xD59C10966EB589EA(*uParam0, uVar0);
				unk_0x5EC7E18324A7D03D(&uVar0);
				uParam0->f_9 = 2;
			...
			unk_0xD14BB8AD8FD52FA3(*uParam0, 0.2f);
			break;
		
		case 2:
			if (func_177(*uParam0, 242628503))
			{
				if (unk_0xDEE49D5CA6C49148(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man", 3))
				{
					if (unk_0x6B0B5671C53485D8(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man") >= 0.333f)
					{
						unk_0xCC853EDF7160419D(*uParam0, "missfbi4prepp1_garbageman", 0f);
						unk_0xCC6F6A2C5289B686(*uParam0, "missfbi4prepp1_garbageman");
						if (func_10(Local_133[iLocal_660 /*25*/].f_17) && !unk_0xEE6AD63ABF59C0B7(Local_133[iLocal_660 /*25*/].f_17))
						{
							unk_0x1B21CF9397F27FEE(Local_133[iLocal_660 /*25*/].f_17, *uParam0, unk_0xD1E5B4D09626571A(*uParam0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
						}
					}
				}
			...
			else if (!func_177(*uParam0, 713668775))
			{
				if (func_36(iLocal_108))
				{
					unk_0x14A4402A811D03C0(*uParam0, unk_0xC899C78DB72CCBCC(iLocal_108, 0f, -4.8f, 0f), 1f, -1, 0.25f, 0, unk_0xC230DD956E2F5507(iLocal_108));
				}
				uParam0->f_9 = 3;
			}
			unk_0xD14BB8AD8FD52FA3(*uParam0, 0.2f);
		...
		case 3:
			if (func_36(iLocal_108))
			{
				if (!func_184(unk_0xC899C78DB72CCBCC(iLocal_108, 0f, -5.5f, 0f), iLocal_108, 1.9f, 1.9f, 8f))
				{
					if (unk_0x5E58342602E94718(*uParam0, unk_0xC899C78DB72CCBCC(iLocal_108, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, 0, 1, 0))
					{
						if (!func_177(*uParam0, 713668775))
						{
							unk_0xF4BF3E3D7FE56705(&uVar1);
							if (func_163(unk_0xA86D5F069399F44D(*uParam0, 1), unk_0xA86D5F069399F44D(iLocal_108, 1)) > 3f)
							{
								unk_0xD54B51DB3BD1FB16(0, unk_0xC230DD956E2F5507(iLocal_108), 0);
							}
							unk_0x8DBC05C86F873CC9(0, "missfbi4prepp1", "_bag_throw_garbage_man", 8f, -8f, -1, 0, 0, 0, 0, 0);
							unk_0xFF7E39890B2840DD(uVar1);
							unk_0xD59C10966EB589EA(*uParam0, uVar1);
							unk_0x5EC7E18324A7D03D(&uVar1);
							uParam0->f_9 = 4;
		...
		case 4:
			if (!func_184(unk_0xC899C78DB72CCBCC(iLocal_108, 0f, -5.5f, 0f), *uParam0, 1.9f, 1.9f, 8f))
			{
				if (func_177(*uParam0, 242628503))
				{
					if (unk_0xDEE49D5CA6C49148(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man", 3))
					{
						if (unk_0x6B0B5671C53485D8(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man") >= 0.391f)
						{
							if (func_10(Local_133[iLocal_660 /*25*/].f_17))
							{
								if (unk_0xEE6AD63ABF59C0B7(Local_133[iLocal_660 /*25*/].f_17))
								{
									...
									unk_0xDBE3DEBE116FC3FD(*uParam0);
									unk_0x64CDE9D6BF8ECAD3(Local_133[iLocal_660 /*25*/].f_17, 1, 0);
									unk_0x91BDE8E32E8D88D6(Local_133[iLocal_660 /*25*/].f_17, 2f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1082130432, -1082130432, -1082130432);
									unk_0x31DA7CEC5334DB37(Local_133[iLocal_660 /*25*/].f_17, 1, unk_0x2412D9C05BB09B97(*uParam0), 0, 1, 1, 0);
								}
								if (unk_0x9A2304A64C3C8423(Local_133[iLocal_660 /*25*/].f_17, iLocal_108))
								{
				...
				else
				{
					...
					if (func_36(iLocal_108))
					{
						unk_0x6A3C24B91FD0EA09(iLocal_108, 5, 0);
						func_180(&(Local_133[iLocal_660 /*25*/].f_17));
					}
					func_156(uParam0);
				}
...
void func_181(var uParam0)
{
	...
	unk_0x9E0FEFE102840007(5, uLocal_79, joaat("player"));
	func_162(uParam0);
	if (!unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 0))
	{
		if (!unk_0x52BE10F427339B39(*uParam0, 0))
...
int func_184(struct<3> Param0, int iParam3, struct<3> Param4)
{
	...
	if (Local_81.f_26)
	{
		if (unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 0))
		{
			if (unk_0xC3D96AF45FCCEC4C(Local_81.f_18))
			{
				if (func_10(Local_81.f_18))
				{
					if (unk_0xDF1E5AAC561AFC59(Local_81.f_18) == unk_0xB3598EA616C3FFC3(unk_0x096275889B8E0EE0(), 1))
					{
						return 1;
					}
				}
		...
		else if (unk_0xCF8176912DDA4EA5(Local_81.f_18))
		{
			if (func_10(Local_81.f_18))
			{
				if (unk_0x0F16D042BD640EA3(Local_81.f_18) == unk_0x096275889B8E0EE0())
				{
					return 1;
				}
			}
...
void func_185(var uParam0, var uParam1)
{
	...
	iVar1 = unk_0xEDE8AC7C5108FB1D(*uParam0, &iVar0, &(uParam0->f_20), &(uParam0->f_23), &(uParam0->f_18));
...
void func_186(var uParam0, int iParam1)
{
	switch (uParam0->f_1)
	{
		...
		case 1:
			*uParam0 = unk_0xD1B966852E9F6951(uParam0->f_2, uParam0->f_5, 511, uParam1, 7);
			break;
		
		case 2:
			*uParam0 = unk_0x895BF13C9580944C(uParam0->f_17, 511, 4);
			break;
		
		case 3:
			*uParam0 = unk_0x717B9C6C2E27C8B8(uParam0->f_17, 511, 4);
			break;
		
		case 4:
			*uParam0 = unk_0xD9E8F7430CE85A03(uParam0->f_2, uParam0->f_8, uParam0->f_11, uParam0->f_14, 6, iParam1, 4);
			break;
		
		case 5:
			*uParam0 = unk_0x42DCB9936A6ECC33(uParam0->f_2, uParam0->f_5, uParam0->f_15, 511, iParam1, 4);
			break;
	}
...
void func_187(var uParam0)
{
	...
	{
		unk_0xF4BF3E3D7FE56705(&uVar0);
		unk_0xBB26FB233542CFFE(0, iLocal_108, Local_133[iLocal_660 /*25*/].f_3, 8f, 0, joaat("trash"), 786469, 10f, 15f);
		unk_0x7D2FE09C35FB3508(0, iLocal_108, Local_133[iLocal_660 /*25*/].f_3, Local_133[iLocal_660 /*25*/].f_8, Local_133[iLocal_660 /*25*/].f_10, 5f, 1);
		unk_0xFF7E39890B2840DD(uVar0);
		unk_0xD59C10966EB589EA(*uParam0, uVar0);
		unk_0x5EC7E18324A7D03D(&uVar0);
		uParam0->f_7 = 6;
...
void func_189(var uParam0, bool bParam1)
{
	...
	if (func_184(unk_0xC899C78DB72CCBCC(iLocal_108, func_130(bParam1)), iLocal_108, 1.9f, 1.9f, 8f))
	{
		if (unk_0xD3151E53134595E5(*uParam0, unk_0xC899C78DB72CCBCC(iLocal_108, 5f, 0f, -2f), unk_0xA86D5F069399F44D(iLocal_108, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0) && unk_0xD3151E53134595E5(unk_0x096275889B8E0EE0(), unk_0xC899C78DB72CCBCC(iLocal_108, 5f, 0f, -2f), unk_0xA86D5F069399F44D(iLocal_108, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
		{
			func_190(uParam0);
		}
		else if (!func_177(*uParam0, 1227113341) && unk_0xD3151E53134595E5(unk_0x096275889B8E0EE0(), unk_0xC899C78DB72CCBCC(iLocal_108, 5f, 0f, -2f), unk_0xA86D5F069399F44D(iLocal_108, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
		{
			unk_0x0F1ABE64C3C18E5A(*uParam0);
			unk_0xF553365A64BDFF94(*uParam0, unk_0x096275889B8E0EE0(), -1, 4f, 1f, 1073741824, 0);
		}
	}
	else if (func_100(*uParam0, unk_0xC899C78DB72CCBCC(iLocal_108, func_130(bParam1)), 5f))
	{
		iVar0 = -1;
		if (!bParam1)
		{
		...
		unk_0x12C24A48BF610759(*uParam0, iLocal_108, -1, iVar0, 1f, 8388609, 0);
		uParam0->f_7 = 2;
	}
}
...
void func_191(var uParam0)
{
	if (uParam0->f_5 != 1)
	{
		if (func_36(iLocal_108) && unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 0))
		{
			if (!func_177(*uParam0, 2104565373) && unk_0x9C8E4D238C999648(*uParam0, iLocal_108, 0))
			{
				if (func_150(unk_0x096275889B8E0EE0(), iLocal_108, 10f))
				{
					if (unk_0x9A2304A64C3C8423(iLocal_108, unk_0x096275889B8E0EE0()))
					{
						unk_0x1A373BA62A07ADC1(*uParam0, unk_0x096275889B8E0EE0(), 0, 0f, 0f, 0f, 10f, 100, 1, joaat("FIRING_PATTERN_FULL_AUTO"));
						uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
						uParam0->f_6 = 9;
					}
				}
...
void func_192()
{
	...
	while (iVar0 <= (iLocal_80 - 1))
	{
		if (Local_133[iVar0 /*25*/].f_23 != 0)
		{
			...
			{
				if ((iVar0 != iLocal_660 && func_10(Local_133[iVar0 /*25*/].f_17)) && func_194(Local_133[iVar0 /*25*/].f_17, unk_0x096275889B8E0EE0(), 1) > 200f)
				{
					unk_0x931914268722C263(&(Local_133[iVar0 /*25*/].f_17));
					Local_133[iVar0 /*25*/].f_24 = 0;
				}
			}
			else if (Local_133[iVar0 /*25*/].f_23 != 0)
			{
				if (func_100(unk_0x096275889B8E0EE0(), Local_133[iVar0 /*25*/], 100f) || func_100(Local_110[0 /*11*/], Local_133[iVar0 /*25*/], 120f))
				{
...
void func_195(var uParam0, int iParam1, int iParam2)
{
	if (uParam0->f_5 != 1 || iParam2)
	{
		if (!func_321(Local_110[func_164(iParam1) /*11*/]))
		{
			if (!bLocal_664)
			{
				if (unk_0xD42BD6EB2E0F1677(Local_110[func_164(iParam1) /*11*/]))
				{
					...
					{
						Local_666 = { unk_0xA86D5F069399F44D(Local_110[func_164(iParam1) /*11*/], 1) };
						uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
						uParam0->f_8 = uParam0->f_7;
						uParam0->f_5 = 1;
						uParam0->f_6 = 11;
		...
		{
			if (func_174(*uParam0, Local_110[func_164(iParam1) /*11*/], 140f, 0) && func_150(Local_110[func_164(iParam1) /*11*/], unk_0x096275889B8E0EE0(), 15f))
			{
				uParam0->f_5 = 1;
				uParam0->f_6 = 21;
			}
		...
		if (uParam0->f_10 == 0 && uParam0->f_7 == 4)
		{
			if (func_154(uParam0))
			{
				...
				{
					unk_0x1A373BA62A07ADC1(*uParam0, unk_0x096275889B8E0EE0(), 0, 0f, 0f, 0f, 10f, 100, 1, joaat("FIRING_PATTERN_FULL_AUTO"));
					unk_0x99F8995861CE774B(iLocal_108, 2000f);
					iLocal_669 = unk_0x4F67E8ECA7D3F667();
					uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
					uParam0->f_6 = 16;
					uParam0->f_5 = 1;
				}
		...
		if (func_197(*uParam0, 1, 70f, 170f, 0, 1, 0, 0) && !func_196(uParam0))
		{
			if (unk_0x0878A3DD21BC848A(unk_0x096275889B8E0EE0(), 6))
			{
				if (func_36(iLocal_108))
				{
					if (unk_0x9C8E4D238C999648(*uParam0, iLocal_108, 0))
					{
						if (unk_0xFB6BA510A533DF81(iLocal_108) > 5f)
						{
							if (iParam1 == 0)
							{
								unk_0x8B5A576784E393A4(*uParam0, iLocal_108, unk_0x096275889B8E0EE0(), 8, 30f, 786469, 300f, 2f, 1);
								uParam0->f_6 = 7;
								unk_0x6EE9AE1124E7C613(Local_110[func_164(iParam1) /*11*/], -1);
								Local_110[func_164(iParam1) /*11*/].f_6 = 10;
								Local_110[func_164(iParam1) /*11*/].f_5 = 1;
								uParam0->f_5 = 1;
								uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
								Local_110[func_164(iParam1) /*11*/].f_1 = unk_0x4F67E8ECA7D3F667();
							}
							else
							{
								unk_0x6EE9AE1124E7C613(*uParam0, -1);
								uParam0->f_6 = 12;
								unk_0x8B5A576784E393A4(Local_110[func_164(iParam1) /*11*/], iLocal_108, unk_0x096275889B8E0EE0(), 8, 30f, 786469, 300f, 2f, 1);
						...
						else
						{
							...
							if (unk_0xD42BD6EB2E0F1677(Local_110[func_164(iParam1) /*11*/]))
							{
								if (func_174(Local_110[func_164(iParam1) /*11*/], unk_0x096275889B8E0EE0(), 1126825984, 0))
								{
									func_169(&(Local_110[func_164(iParam1) /*11*/]), 0);
								}
							}
						}
						unk_0xBB19AC7D4DCEFD0F(*uParam0);
					}
					else
					{
						func_169(uParam0, 0);
			...
			else
			{
				...
				if (func_170(Local_110[func_164(iParam1) /*11*/], *uParam0, 1126825984, 1, 250, 7))
				{
					...
					unk_0xBB19AC7D4DCEFD0F(Local_110[func_164(iParam1) /*11*/]);
				}
			}
			uParam0->f_5 = 1;
		}
		else if (unk_0x1E8A2C0DC15A2CCA(*uParam0))
		{
			func_162(uParam0);
			unk_0x06C6AD4F38E8412D(*uParam0, unk_0x096275889B8E0EE0(), 500f, -1, 0, 1);
			uParam0->f_6 = 2;
	...
	if (uParam0->f_5 != 1)
	{
		if (func_321(Local_110[func_164(iParam1) /*11*/]))
		{
			if (unk_0x1E8A2C0DC15A2CCA(Local_110[func_164(iParam1) /*11*/]))
			{
				func_162(uParam0);
				unk_0x06C6AD4F38E8412D(*uParam0, unk_0x096275889B8E0EE0(), 120f, -1, 0, 0);
				uParam0->f_1 = unk_0x4F67E8ECA7D3F667();
				uParam0->f_6 = 7;
				uParam0->f_5 = 1;
			}
...
{
	if ((unk_0x5E58342602E94718(unk_0x096275889B8E0EE0(), unk_0xC899C78DB72CCBCC(*uParam0, 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !unk_0x0878A3DD21BC848A(unk_0x096275889B8E0EE0(), 6)) && unk_0x42FAEF3CD9241800(unk_0x096275889B8E0EE0()))
	{
		return 1;
	}
	return 0;
	...
	if (func_10(unk_0x096275889B8E0EE0()) && func_10(iParam0))
	{
		...
		if (!unk_0x0878A3DD21BC848A(unk_0x096275889B8E0EE0(), 6))
		{
			if (unk_0x4811DE9A3F16F275(unk_0x096275889B8E0EE0()))
			{
				...
				{
					return func_201(unk_0x096275889B8E0EE0(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_198(int iParam0, float fParam1)
{
	...
	if (func_10(unk_0x096275889B8E0EE0()) && func_10(iParam0))
	{
		if (func_200(iParam0) || unk_0x27F89FDC16688A7A(unk_0x217E9DC48139933D(), iParam0))
		{
			if (unk_0x0878A3DD21BC848A(unk_0x096275889B8E0EE0(), 6))
			{
				fVar0 = 40f;
...
{
	return func_170(iParam0, unk_0x096275889B8E0EE0(), fParam1, 1, 250, 7);
}
...
{
	if (func_150(uParam0, unk_0x096275889B8E0EE0(), 6f))
	{
		if (!unk_0x52BE10F427339B39(uParam0, 0))
		{
...
void func_207()
{
	if (func_36(Local_867.f_0))
	{
		if (func_150(unk_0x096275889B8E0EE0(), Local_867.f_0, 100f) && !iLocal_836)
		{
			unk_0x07D04AD5EF0CEB94(joaat("trash"), 3);
			if (!unk_0xB935F3154BC913C8(joaat("trash")))
			{
				iLocal_836 = 1;
			}
		}
		else if (!func_150(unk_0x096275889B8E0EE0(), Local_867.f_0, 120f) && iLocal_836)
		{
			unk_0x888A4E675B38F5AD(joaat("trash"));
			iLocal_836 = 0;
		}
	}
}
		...
		switch (*iParam2)
		{
			case 0:
				if (unk_0x9C8E4D238C999648(unk_0x096275889B8E0EE0(), *iParam0, 0))
				{
					...
					if (func_99(func_107(func_75()), 0, 0))
					{
						unk_0xB836C5982F4438BA(func_107(func_75()));
					}
					if (*iParam0 == iParam8)
					{
						*iParam2 = 1;
				...
				else
				{
					...
					{
						unk_0xB836C5982F4438BA(func_108(func_75(), bParam9));
					}
					if (func_75() != 33)
					{
						func_210(iParam0);
			...
			case 2:
			case 1:
				if ((!unk_0x9C8E4D238C999648(unk_0x096275889B8E0EE0(), *iParam0, 0) && !func_213(*iParam0)) && !func_212(*iParam0))
				{
					func_7(iParam4);
...
void func_210(var uParam0)
{
	...
	if (unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 0))
	{
		...
		if (iVar0 != *uParam0)
		{
			if (func_36(iVar0))
			{
				if (unk_0xDA76A9F39210D365(iVar0) == func_211(func_75()))
				{
					func_6(uParam0);
					*uParam0 = iVar0;
					func_35(*uParam0, 1);
...
int func_212(int iParam0)
{
	...
	if ((func_321(unk_0x096275889B8E0EE0()) && unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 0)) && func_36(iParam0))
	{
...
void func_214()
{
	...
	switch (iLocal_683)
	{
		case 0:
			if (func_115(iLocal_682, bLocal_27))
			{
				if (unk_0xABC532F9098BFD9D(unk_0x217E9DC48139933D()) == 0 && !func_230())
				{
		...
		case 3:
			if (func_36(iLocal_873))
			{
				if (!unk_0x9C8E4D238C999648(unk_0x096275889B8E0EE0(), iLocal_873, 0))
				{
					unk_0xF80258351D8421EB(unk_0x096275889B8E0EE0(), iLocal_873, -1);
				}
				else
				{
	...
	while (iVar0 < 3)
	{
		...
		if (!unk_0x6CFF81397164A1D3(iVar2))
		{
			if (func_76(iVar2, 0))
			{
				if (!bVar1)
				{
					if (func_150(unk_0x096275889B8E0EE0(), iVar2, 5f))
					{
						if (!func_230())
						{
							func_225(iVar0);
			...
			if (!func_217(iVar2))
			{
				if (func_76(iVar2, 0))
				{
					if (func_224(iVar2) || func_222(iVar2))
					{
						if (func_221(iVar2, 0))
						{
							unk_0xDC19C288082E586E(iVar2, 1, 1);
							unk_0x49876BF356F39E66(iVar2, true);
							unk_0x0F1ABE64C3C18E5A(iVar2);
						}
					}
				}
			}
			else if (unk_0x622B1980CBE13332(iVar2, 1))
			{
				if (func_224(iVar2))
				{
					if (unk_0x04932A97CB319DE0(iVar2, -1273030092) != 1 && unk_0x04932A97CB319DE0(iVar2, -1273030092) != 0)
					{
						if (unk_0x421CEB1D8D021C2D(623.3781f, -172.26f, 1700.732f, -2115.843f))
						{
							unk_0xBB26FB233542CFFE(iVar2, unk_0xB3598EA616C3FFC3(iVar2, 0), Local_826, 20f, 0, 0, 34340901, 2f, 10f);
						}
						else
						{
							unk_0x3A75D916CC3E33B5(623.3781f, -172.26f, 1700.732f, -2115.843f);
						}
					}
				}
				else if (func_222(iVar2))
				{
					if (func_36(Local_867.f_0))
					{
						if (!func_150(iVar2, Local_867.f_0, 17f))
						{
							if (unk_0x04932A97CB319DE0(iVar2, -1273030092) != 1 && unk_0x04932A97CB319DE0(iVar2, -1273030092) != 0)
							{
								unk_0xB7B1266C683A825A(iVar2, unk_0xB3598EA616C3FFC3(iVar2, 0), Local_867.f_0, 3, 20f, 786468, 2f, 0.5f, 1);
							}
						}
					}
				}
...
int func_222(int iParam0)
{
	...
	if (!func_223())
	{
		if ((!unk_0x6CFF81397164A1D3(unk_0x096275889B8E0EE0()) && unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 0)) && unk_0xABC532F9098BFD9D(unk_0x217E9DC48139933D()) == 0)
		{
			iVar0 = unk_0xB3598EA616C3FFC3(unk_0x096275889B8E0EE0(), 0);
			if (func_36(iVar0))
			{
				if (unk_0x0045A54EC7A22455(iVar0, joaat("trash")))
				{
					return 0;
				}
				if (unk_0x9C8E4D238C999648(iParam0, iVar0, 0) && unk_0xD214895E39AA3787(iVar0, -1) == iParam0)
				{
					return 1;
				}
			}
...
int func_224(int iParam0)
{
	if (!func_223())
	{
		if ((unk_0xD42BD6EB2E0F1677(Local_867.f_0) && unk_0xB86D29B10F627379(Local_867.f_0, 0)) && !unk_0x5E58342602E94718(Local_867.f_0, Local_826, 2f, 2f, 2f, 0, 1, 0))
		{
			if ((!unk_0x6CFF81397164A1D3(unk_0x096275889B8E0EE0()) && unk_0x9C8E4D238C999648(unk_0x096275889B8E0EE0(), Local_867.f_0, 0)) && unk_0xABC532F9098BFD9D(unk_0x217E9DC48139933D()) == 0)
			{
				if (unk_0x9C8E4D238C999648(iParam0, Local_867.f_0, 0) && unk_0xD214895E39AA3787(Local_867.f_0, -1) == iParam0)
				{
					return 1;
				}
			}
...
void func_225(int iParam0)
{
	if (iLocal_682 > 1)
	{
		if (iLocal_684 > 0)
		{
			if (!unk_0x4ED6CFDFE8D4131A(Local_687[iParam0 /*8*/].f_7, 0) && iLocal_685 == 1)
			{
				if (!unk_0x24D15F45F410375F())
				{
					if (func_229(&uLocal_878, cLocal_877, Local_687[iParam0 /*8*/][0], 8, 0, 0, 0))
					{
						unk_0xF73FBE4845C43B5B(&(Local_687[iParam0 /*8*/].f_7), 0);
					}
				}
			}
		}
		...
		{
			if ((unk_0x4ED6CFDFE8D4131A(Local_687[iParam0 /*8*/].f_7, 0) && !unk_0x4ED6CFDFE8D4131A(Local_687[iParam0 /*8*/].f_7, 1)) && iLocal_685 == 1)
			{
				if (!unk_0x24D15F45F410375F())
				{
					if (func_229(&uLocal_878, cLocal_877, Local_687[iParam0 /*8*/][1], 7, 0, 0, 0))
					{
						unk_0xF73FBE4845C43B5B(&(Local_687[iParam0 /*8*/].f_7), 1);
					}
				}
			}
			if (!unk_0x4ED6CFDFE8D4131A(Local_687[iParam0 /*8*/].f_7, 5))
			{
				if (func_228(iLocal_873, Local_826, 1) < 15f && iLocal_685 == 1)
				{
					if (!unk_0x24D15F45F410375F())
					{
						...
						{
							unk_0xF73FBE4845C43B5B(&(Local_687[iParam0 /*8*/].f_7), 5);
						}
					}
				}
			}
			switch (func_29(unk_0x096275889B8E0EE0()))
			{
				case 0:
					if (iParam0 == 1)
					{
...
{
	if (!unk_0x4ED6CFDFE8D4131A(Local_687[iParam0 /*8*/].f_7, iParam1))
	{
		if (iLocal_1051 != -1)
		{
			if (!unk_0x24D15F45F410375F())
			{
				...
				{
					unk_0xF73FBE4845C43B5B(&(Local_687[iParam0 /*8*/].f_7), iParam1);
				}
			}
		}
		else if (!func_230() && !unk_0x24D15F45F410375F())
		{
			iLocal_1051 = unk_0x4F67E8ECA7D3F667();
		}
		else
		{
			iLocal_1051 = -1;
...
{
	if ((unk_0x4ED6CFDFE8D4131A(Local_687[0 /*8*/].f_7, iParam0) || unk_0x4ED6CFDFE8D4131A(Local_687[1 /*8*/].f_7, iParam0)) || unk_0x4ED6CFDFE8D4131A(Local_687[2 /*8*/].f_7, iParam0))
	{
		return 1;
	}
	return 0;
...
void func_231()
{
	if (func_100(unk_0x096275889B8E0EE0(), Local_826, 220f))
	{
		if (!iLocal_876 && !func_100(unk_0x096275889B8E0EE0(), Local_826, 100f))
		{
			iLocal_876 = func_146(&uLocal_875, joaat("cavalcade2"), 1370.912f, -2060.055f, 50.9983f, 312.8686f, 1);
		}
	}
	else if (func_100(unk_0x096275889B8E0EE0(), Local_826, 240f))
	{
		if (iLocal_876)
		{
			func_6(&uLocal_875);
...
void func_232()
{
	...
	switch (iLocal_683)
	{
		...
		case 1:
			...
			if (!bLocal_832)
			{
				if (func_321(Local_839.f_0) && unk_0x1E8A2C0DC15A2CCA(Local_839.f_0))
				{
					func_234();
				}
				if (func_321(Local_853.f_0) && unk_0x1E8A2C0DC15A2CCA(Local_853.f_0))
				{
					func_234();
				}
			}
...
void func_238(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_254(iParam1) && unk_0xFFC96ECB7FA404CA(iParam1))
	{
		iVar1 = 0;
...
{
	if (func_254(unk_0x096275889B8E0EE0()))
	{
...
int func_243(char* sParam0)
{
	if (!func_244(1, 1, 0))
	{
		if ((!unk_0x2CF12F9ACF18F048(sParam0) && func_139(sParam0)) || func_139("CMN_HINT"))
		{
			unk_0x0BFC2C61FB5B6CA1(1);
		}
		return 0;
...
bool func_247()
{
	return func_248(unk_0x217E9DC48139933D());
}
...
int func_249(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_252(bParam1, bParam2, bParam3) || unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((unk_0x4F67E8ECA7D3F667() - uParam0->f_4) > 500)
			{
				...
				{
					if (unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 1) || func_250(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
		...
		case 0:
			if (func_115(iLocal_682, 0))
			{
				...
				else
				{
					if (func_32(0))
					{
						func_117(unk_0x096275889B8E0EE0(), 1228.635f, -348.4277f, 68.0929f, 86.7244f);
...
void func_268()
{
	...
	if (unk_0xD42BD6EB2E0F1677(iVar0))
	{
		if (unk_0xB86D29B10F627379(iVar0, 0))
		{
			func_269(iVar0, unk_0xA86D5F069399F44D(iVar0, 1), unk_0xC230DD956E2F5507(iVar0), 24, 0);
		}
	}
}
...
{
	if ((((((((((!unk_0xD42BD6EB2E0F1677(iParam0) || !unk_0xB86D29B10F627379(iParam0, 0)) || func_284(iParam0, 0, 0)) || func_284(iParam0, 1, 0)) || func_284(iParam0, 2, 0)) || func_307(iParam0) != 145) || func_283(iParam0)) || func_282(iParam0)) || func_281(iParam0)) || func_280(iParam0)) || !func_273(unk_0xDA76A9F39210D365(iParam0)))
	{
		if (func_282(iParam0))
		{
		}
...
var func_287()
{
	...
	func_297(&uVar0, unk_0xB6101ABE62B5F080());
	func_296(&uVar0, unk_0x4E162231B823DBBF());
	func_295(&uVar0, unk_0xC82CF208C2B19199());
	func_290(&uVar0, unk_0xDF2FD796C54480A5());
	func_289(&uVar0, unk_0x2D44E8FC79EAB1AC());
	func_288(&uVar0, unk_0xE136DCA28C4A48BA());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_293(unk_0x4ED6CFDFE8D4131A(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (unk_0xB86D29B10F627379(iParam0, 0))
	{
		...
		*uParam1 = unk_0x925BC0BB4ADD9133(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xF73FBE4845C43B5B(&(uParam1->f_53), func_309(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_318()
{
	...
	if (!func_36(iLocal_873))
	{
		...
		if (func_36(Local_867.f_0) && !func_150(unk_0x096275889B8E0EE0(), Local_867.f_0, fVar0))
		{
			func_320(2);
		}
	}
	...
	{
		iVar1 = 0;
		if (!func_150(unk_0x096275889B8E0EE0(), iLocal_873, fVar0))
		{
			iVar1++;
		}
		if (func_36(uLocal_874))
		{
			if (!func_150(unk_0x096275889B8E0EE0(), uLocal_874, fVar0))
			{
				iVar1++;
			}
		}
		...
		if (func_36(Local_867.f_0))
		{
			if (!func_150(unk_0x096275889B8E0EE0(), Local_867.f_0, fVar0))
			{
				iVar1++;
			}
		}
...
int func_335(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x03A753E2C8458335())
	{
		if (func_330() == 0)
		{
			return unk_0x4ED6CFDFE8D4131A(func_328(func_329(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_355()
{
	...
	unk_0x57F925DF866E2CBD(joaat("s_m_y_garbage"), 0);
	func_61();
	func_365();
	func_364();
	func_356(0);
...
void func_356(bool bParam0)
{
	...
	unk_0x904737E822742E53("WORLD_VEHICLE_ATTRACTOR", 1);
	...
	if (bParam0)
	{
		if (unk_0xD42BD6EB2E0F1677(iLocal_873))
		{
			if (unk_0xD42BD6EB2E0F1677(unk_0x096275889B8E0EE0()))
			{
				if (!unk_0x6CFF81397164A1D3(unk_0x096275889B8E0EE0()))
	...
	func_138(&uLocal_670, 0, 0);
	if (unk_0x153AD457764FD704(uLocal_822))
	{
		unk_0x33281167E4942E4F(0, 0, 3000, 1, 0, 0);
		unk_0x4E67E0B6D7FD5145(uLocal_822, 0);
	}
}
...
void func_363()
{
	unk_0x4AD96EF928BD4F9A(Local_867.f_5);
}
