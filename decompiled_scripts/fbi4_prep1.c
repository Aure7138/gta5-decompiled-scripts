...
void __EntryFunction__()
{
	...
	while (true)
	{
		unk_0xE10447427D928F55("M_TrT", 0);
		if (func_321(unk_0xE7869D5D7816A9B6()))
		{
			func_317();
			func_313();
	...
	switch (iLocal_684)
	{
		case 0:
			...
			if (unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
			{
				...
				if (func_36(iVar0) && unk_0x1B2DC87EFB36DF80(iVar0) == joaat("towtruck"))
				{
					func_35(iVar0, 2);
				}
			}
			if (!unk_0xF6917DE0E003509D(sLocal_818))
			{
				func_33(sLocal_818);
			}
			else
		...
		case 1:
			if (func_17())
			{
				...
				func_2();
				unk_0xB86B1248EA9B87EA(unk_0x1141852D07400777(unk_0xE7869D5D7816A9B6(), 1), 30f, 1, 0, 0, 0);
				func_355();
			}
			break;
	}
...
void func_3()
{
	...
	unk_0xF6231EA8B0BD197C(uLocal_80);
	unk_0x8B10CC9832827D27("missfbi4prepp1");
	unk_0x04C15FC9EFAA71CC("missfbi4prepp1_garbageman");
}
...
{
	func_13(&(Global_95220.f_2311), Param0, fParam3);
}
...
void func_18(int iParam0)
{
	...
	if (Global_99155.f_7699 || func_32(0))
	{
		iVar0 = func_31();
		if (!func_19(iVar0))
		{
...
int func_19(int iParam0)
{
	...
	func_20(&(Global_99155.f_1750.f_539), iVar1);
...
void func_20(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_22(Global_99155.f_17147[iVar0], &Var2, &fVar5))
			{
...
void func_26()
{
	...
	{
		if (func_30(Global_99155.f_1750.f_539.f_3549) != unk_0x1B2DC87EFB36DF80(unk_0xE7869D5D7816A9B6()))
		{
			iVar0 = func_29(unk_0xE7869D5D7816A9B6());
			if (func_28(iVar0) && (!func_27(14) || Global_98107))
			{
				if (Global_99155.f_1750.f_539.f_3549 != iVar0 && func_28(Global_99155.f_1750.f_539.f_3549))
				{
...
void func_38()
{
	...
	switch (iLocal_684)
	{
		...
		case 1:
			if (!func_100(unk_0xE7869D5D7816A9B6(), Local_827, 270f))
			{
				iLocal_684 = 2;
			}
...
void func_42(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (!unk_0xAF437D7C802AB246(unk_0xE7869D5D7816A9B6()) && !func_43(unk_0x3F80C6638E3A1A90()))
		{
...
void func_57(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_32(0) && Global_69482.f_1 == 1) && func_58(Global_69482))
		{
		}
		else
		{
...
int func_77(int iParam0)
{
	...
	return Global_88836[func_78(iParam0)];
}
...
void func_101()
{
	...
	switch (iLocal_684)
	{
		case 0:
			if (func_115(iLocal_683, bLocal_28))
			{
				if (unk_0x44B59DB1458EE8E0(unk_0x3F80C6638E3A1A90()) == 0)
				{
					...
					{
						if (unk_0x8AF655CC5761C7A2(unk_0xE7869D5D7816A9B6(), iLocal_874, 0))
						{
		...
		case 3:
			...
			{
				if (!unk_0x8AF655CC5761C7A2(unk_0xE7869D5D7816A9B6(), Local_868.f_0, 0))
				{
					unk_0x0CC1C59D57D7212B(unk_0xE7869D5D7816A9B6(), Local_868.f_0, -1);
				}
				else
				{
...
int func_106(int iParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	...
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			if (!unk_0x3761EA7F8628B81A(unk_0xE7869D5D7816A9B6(), Param1, fParam12, fParam12, 2f, 0, 1, 2))
			{
				...
				{
					unk_0x621ABFDE5A901516(func_112(func_75()));
				}
				*iParam7 = 1;
			...
			else
			{
				...
				{
					fVar0 = (fParam12 / 2f);
					if (func_100(unk_0xE7869D5D7816A9B6(), Param1, fVar0))
					{
						*iParam7 = 0;
	...
	else
	{
		...
		if (!*iParam8)
		{
			...
			{
				unk_0x621ABFDE5A901516(func_108(func_75(), 0));
			}
...
int func_109(float fParam0, int iParam1)
{
	...
	if (unk_0xC45A34912542C4EB(iVar0, 0))
	{
		if (unk_0xBD6B21D725712BDE(iVar0, -1) == unk_0xE7869D5D7816A9B6())
		{
			...
			{
				unk_0x1B9F8E5CCC384F1E(iVar0, fParam0, iParam1, 0);
				return 0;
			}
		}
		else
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_142(1, Local_824, 0))
			{
				if (func_141())
				{
					...
					unk_0x7E38E815EF844C74(joaat("s_m_y_garbage"), 1);
					iLocal_683 = 2;
					func_7(&iLocal_821);
					...
					unk_0x7146F608C2C17ACC("WORLD_VEHICLE_ATTRACTOR", 0);
				...
				else if (((func_142(2, Local_868.f_1, Local_868.f_4) && func_142(3, Local_840.f_1, Local_840.f_4)) && func_142(4, Local_854.f_1, Local_854.f_4)) && func_134(0))
				{
					...
					unk_0x7E38E815EF844C74(joaat("towtruck"), 1);
					unk_0x7E38E815EF844C74(joaat("s_m_y_garbage"), 1);
					if (unk_0x612EFDB1D15630E7(Local_868.f_0) != 0)
					{
						iVar0 = unk_0x612EFDB1D15630E7(Local_868.f_0);
		...
		case 1:
			if (bParam1)
			{
				...
				{
					func_117(unk_0xE7869D5D7816A9B6(), 1197.861f, -353.011f, 68.0929f, 278.9647f);
					func_116();
					bLocal_28 = false;
					unk_0x7146F608C2C17ACC("DRIVE", 0);
					unk_0x7146F608C2C17ACC("WORLD_VEHICLE_ATTRACTOR", 0);
...
void func_120(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	unk_0x103FCC2BD24292A3("Enemies", &uLocal_80);
	unk_0x690C5239500171FE(Local_111[0 /*11*/], uLocal_80);
	unk_0x690C5239500171FE(Local_111[1 /*11*/], uLocal_80);
	unk_0x5D04A2BDCC04FCAE(Local_111[0 /*11*/], 1, 0);
	unk_0x5D04A2BDCC04FCAE(Local_111[1 /*11*/], 1, 0);
...
void func_122()
{
	if (!unk_0x8AF655CC5761C7A2(Local_111[0 /*11*/], iLocal_109, 0))
	{
		unk_0x33E113E52A91C5C3(Local_111[0 /*11*/], unk_0xBD306D8AFEF4E078(iLocal_109, func_130(1)), 1f, -1, 1048576000, 0, 1193033728);
...
{
	if (!unk_0xD12071DBE8393EC8(iLocal_109, 0))
	{
		func_124(bParam0);
		if (iLocal_661 != (iLocal_81 - 1))
		{
			if (iLocal_661 == 4)
			{
				unk_0xC961CB8769A9CBEE(Local_111[0 /*11*/], iLocal_109, Local_134[iLocal_661 /*25*/], 15f, 2883755, Local_134[iLocal_661 /*25*/].f_6);
			}
			else
			{
				unk_0x8543F365CDBCAAAD(Local_111[0 /*11*/], iLocal_109, Local_134[iLocal_661 /*25*/], 15f, 0, 0, 2883755, Local_134[iLocal_661 /*25*/].f_6, Local_134[iLocal_661 /*25*/].f_7);
			}
		...
		{
			unk_0xE81313E76FEC1E97(Local_111[0 /*11*/], iLocal_109, 15f, 786599);
			Local_111[0 /*11*/].f_8 = Local_111[0 /*11*/].f_7;
...
void func_124(bool bParam0)
{
	if (iLocal_661 != -1)
	{
		...
		{
			unk_0xBDF0A810DD6A47D3(Local_134[iLocal_661 /*25*/].f_11 - Local_134[iLocal_661 /*25*/].f_14, Local_134[iLocal_661 /*25*/].f_11 + Local_134[iLocal_661 /*25*/].f_14, 1, 1);
		}
	}
	if (!bParam0)
	{
	...
	if (iLocal_661 != -1)
	{
		if (!func_129(Local_134[iLocal_661 /*25*/].f_11) && !func_129(Local_134[iLocal_661 /*25*/].f_14))
		{
			unk_0xBDF0A810DD6A47D3(Local_134[iLocal_661 /*25*/].f_11 - Local_134[iLocal_661 /*25*/].f_14, Local_134[iLocal_661 /*25*/].f_11 + Local_134[iLocal_661 /*25*/].f_14, 0, 1);
		}
	}
}
...
int func_125()
{
	...
	{
		Var1 = { unk_0x1141852D07400777(iLocal_109, 1) };
		iVar4 = 0;
		while (iVar4 <= (iLocal_81 - 1))
		{
			fVar28 = unk_0xF18329472591CFE6(Var1, Local_134[iVar4 /*25*/], 1);
		...
		fVar30 = func_126(Local_134[iVar0 /*25*/] - Var1, unk_0x5ED441592163C054(iLocal_109));
		iVar5 = iVar0;
		iVar31 = 0;
		while (fVar30 < 0f && iVar31 < 40)
		{
			...
			Var1 = { unk_0x1141852D07400777(iLocal_109, 1) };
			fVar30 = func_126(Local_134[iVar5 /*25*/] - Var1, unk_0x5ED441592163C054(iLocal_109));
			iVar31++;
		}
		if (iVar31 >= 40)
		{
...
int func_128()
{
	...
	iVar0 = unk_0x0ADD324BC46177EF(0, (iLocal_81 - 1));
...
Vector3 func_130(bool bParam0)
{
	...
	if (!bParam0)
	{
		uVar3 = unk_0x56ADDC5BECDDD8A5(iLocal_109, "wheel_rf");
	}
	else
	{
		uVar3 = unk_0x56ADDC5BECDDD8A5(iLocal_109, "wheel_lf");
	}
	Var0 = { unk_0x242AD66021ED4052(iLocal_109, uVar3) };
	Var0 = { unk_0x61CBEF33034AF6B9(iLocal_109, Var0) };
	if (!bParam0)
	{
...
{
	unk_0x2B0BB514F9140141("missfbi4prepp1");
	unk_0x8BDA0EA8B300D1C1("missfbi4prepp1_garbageman");
	if (bParam0)
	{
		while (!unk_0x2917D5E1CB5CE43A("missfbi4prepp1") && !unk_0xBE9911AEE3029428("missfbi4prepp1_garbageman"))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		return 1;
	}
	else if (unk_0x2917D5E1CB5CE43A("missfbi4prepp1") && unk_0xBE9911AEE3029428("missfbi4prepp1_garbageman"))
	{
		return 1;
	}
	return 0;
...
void func_136(var uParam0)
{
	...
	func_91(uParam0, iVar0, unk_0xE7869D5D7816A9B6(), sVar1, 0, 1);
}
...
int func_141()
{
	if (unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
	{
		if (unk_0x7579897B912B3328(unk_0xF0295FF51F2D7803(unk_0xE7869D5D7816A9B6(), 0), joaat("trash")))
		{
			unk_0x20BB4B94CC6DDC9A(unk_0xF0295FF51F2D7803(unk_0xE7869D5D7816A9B6(), 0), 1, 0);
			iLocal_874 = unk_0xF0295FF51F2D7803(unk_0xE7869D5D7816A9B6(), 0);
			if (func_36(iLocal_874))
			{
				return 1;
			}
...
int func_142(int iParam0, struct<3> Param1, float fParam4)
{
	switch (iParam0)
	{
		...
		case 1:
			unk_0x36A3D6FBED10EF81(sLocal_819, 0);
		...
		case 2:
			if (func_36(Global_87855[0]))
			{
				unk_0x20BB4B94CC6DDC9A(Global_87855[0], 1, 1);
				Local_868.f_0 = Global_87855[0];
				if (func_36(Local_868.f_0))
				{
					func_35(Local_868.f_0, 0);
					unk_0x8100F8AA27EE924B(Local_868.f_0, 1);
					unk_0xFD092FF761E54535(Local_868.f_0, 1);
					return 1;
				}
			}
		...
		case 3:
			if (unk_0xD51CFE69539DB6D8(Global_87855.f_9[0]))
			{
				if (!unk_0x3816C3BD290334DC(Global_87855.f_9[0], 1))
				{
					...
					Local_840.f_0 = Global_87855.f_9[0];
					if (func_321(Local_840.f_0))
					{
						unk_0x9BEE7E791BC4D38B(Local_840.f_0, true);
						unk_0x1C26C4B0DAB91B21(Local_840.f_0, 170, 0);
						unk_0x7346544C767CFCBF(Local_840.f_0, 65536, 1);
						unk_0x7E3DC7ED30B648F0(Local_840.f_0, 50, 1);
						return 1;
					}
				}
				else
			...
			else if (func_143(&Local_840, Local_840.f_5, Local_840.f_1, Local_840.f_4, 1, 0, 1, 1))
			{
				if (func_36(Local_868.f_0))
				{
					unk_0x0CC1C59D57D7212B(Local_840.f_0, Local_868.f_0, -1);
					unk_0x9BEE7E791BC4D38B(Local_840.f_0, true);
					unk_0x1C26C4B0DAB91B21(Local_840.f_0, 170, 0);
					unk_0x7346544C767CFCBF(Local_840.f_0, 65536, 1);
					unk_0x7E3DC7ED30B648F0(Local_840.f_0, 50, 1);
		...
		case 4:
			...
			{
				if (!unk_0x3816C3BD290334DC(Global_87855.f_9[1], 1))
				{
					unk_0x20BB4B94CC6DDC9A(Global_87855.f_9[1], 1, 1);
					Local_854.f_0 = Global_87855.f_9[1];
					if (func_321(Local_854.f_0))
					{
						unk_0x1C26C4B0DAB91B21(Local_854.f_0, 170, 0);
						unk_0x7346544C767CFCBF(Local_854.f_0, 65536, 1);
						unk_0x7E3DC7ED30B648F0(Local_854.f_0, 50, 1);
						unk_0x9BEE7E791BC4D38B(Local_854.f_0, true);
						unk_0xC602CB510D8B9EAE(Local_854.f_0, 1);
						return 1;
					}
				}
				else
			...
			else if (func_143(&Local_854, Local_854.f_5, Local_854.f_1, Local_854.f_4, 1, 0, 1, 1))
			{
				if (func_36(Local_868.f_0))
				{
					unk_0x0CC1C59D57D7212B(Local_854.f_0, Local_868.f_0, 0);
					unk_0x1C26C4B0DAB91B21(Local_854.f_0, 170, 0);
					unk_0x7346544C767CFCBF(Local_854.f_0, 65536, 1);
					unk_0x7E3DC7ED30B648F0(Local_854.f_0, 50, 1);
					unk_0x9BEE7E791BC4D38B(Local_854.f_0, true);
...
void func_149(var uParam0, int iParam1)
{
	if (func_321(*uParam0))
	{
		...
		if (unk_0x23417CDB252083F9(*uParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 3))
		{
			if (unk_0xCB337035DFE5097C(*uParam0, "missfbi4prepp1", "_bag_drop_garbage_man") >= 0.172f)
			{
				if (func_10(Local_134[iLocal_661 /*25*/].f_17) && unk_0xD55D878601C46BA9(Local_134[iLocal_661 /*25*/].f_17))
				{
					unk_0xC456353A87F0538B(*uParam0, 1048576000);
					unk_0x1E4330D1AF23718F(*uParam0);
					if (iLocal_661 <= 20 && iLocal_661 != -1)
					{
						Local_134[iLocal_661 /*25*/].f_18 = 1;
						uParam0->f_9 = 0;
					}
					unk_0x27B54A887EC71B05(Local_134[iLocal_661 /*25*/].f_17, 1, 0);
					unk_0x2FD3AA0C3395806A(Local_134[iLocal_661 /*25*/].f_17, 1, unk_0x5ED441592163C054(*uParam0), 0, 1, 1, 0);
				}
			}
		}
		switch (uParam0->f_5)
	...
	else
	{
		...
		{
			if (unk_0xD55D878601C46BA9(Local_134[iLocal_661 /*25*/].f_17))
			{
				unk_0x27B54A887EC71B05(Local_134[iLocal_661 /*25*/].f_17, 1, 0);
				unk_0x2FD3AA0C3395806A(Local_134[iLocal_661 /*25*/].f_17, 1, unk_0x5ED441592163C054(*uParam0), 0, 1, 1, 0);
			}
		...
		if (unk_0xD51CFE69539DB6D8(*uParam0))
		{
			if (!func_150(unk_0xE7869D5D7816A9B6(), *uParam0, 150f) && !bLocal_665)
			{
...
void func_151(var uParam0)
{
	...
	{
		case 5:
			if ((unk_0x9D40BBF80D8F5E8A() - uParam0->f_1) > uParam0->f_3)
			{
				if (func_177(*uParam0, 780511057))
				{
					unk_0xFA2C5C2D054C888E(*uParam0);
				}
				unk_0x4B79E06845D63B96(*uParam0, unk_0xE7869D5D7816A9B6(), 30f, -1, 0, 0);
				uParam0->f_6 = 6;
		...
		case 21:
			...
			{
				if (func_170(*uParam0, unk_0xE7869D5D7816A9B6(), 1126825984, 1, 250, 7))
				{
					func_169(uParam0, 1);
					return;
				}
			...
			if ((unk_0x9D40BBF80D8F5E8A() - uParam0->f_1) > uParam0->f_3)
			{
				...
				{
					unk_0x506C3CF53904596F(*uParam0, unk_0xE7869D5D7816A9B6(), 8f, -1f, 10f, 0);
				}
				else
				{
				...
				if (!unk_0xD11595488376CB53(uParam0->f_4))
				{
		...
		case 10:
			if ((unk_0x9D40BBF80D8F5E8A() - uParam0->f_1) > uParam0->f_3)
			{
				if (unk_0x51374A0BB2871E6E(*uParam0, 0))
				{
					unk_0xC31A3F1982C7B12B(*uParam0, 120, 1);
					uParam0->f_6 = 12;
					uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
				}
		...
		case 3:
			if ((unk_0x9D40BBF80D8F5E8A() - uParam0->f_1) > uParam0->f_3)
			{
				unk_0x6FD4DE4DAEA4ED56(*uParam0, 1, 1);
				unk_0x4B79E06845D63B96(*uParam0, unk_0xE7869D5D7816A9B6(), 500f, -1, 0, 1);
				uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
				uParam0->f_6 = 4;
				uParam0->f_5 = 1;
			}
		...
		case 11:
			func_165(uParam0);
			if ((unk_0x9D40BBF80D8F5E8A() - uParam0->f_1) > 5000)
			{
				if (!func_177(*uParam0, 713668775))
				{
					if (unk_0xD51CFE69539DB6D8(Local_111[func_164(uParam0->f_10) /*11*/]))
					{
						unk_0x33E113E52A91C5C3(*uParam0, Local_667, 1f, -1, 2f, 0, 1193033728);
					}
				}
				uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
				uParam0->f_6 = 23;
		...
		case 18:
			if (!func_177(*uParam0, -2017877118))
			{
				...
				if (func_163(unk_0x1141852D07400777(*uParam0, 1), unk_0x1141852D07400777(unk_0xE7869D5D7816A9B6(), 1)) > 1.5f)
				{
					unk_0xDE6D5CD5475B6C9F(0, unk_0x1141852D07400777(unk_0xE7869D5D7816A9B6(), 1), 0);
				}
				unk_0x7D786F4317F35B2E(0, "WORLD_HUMAN_MOBILE_FILM_SHOCKING", 6000, 1);
				unk_0x911ECBCE73F8EC3F(uVar1);
				unk_0xC2C4A3A9FF2FBFFF(*uParam0, uVar1);
		...
		case 19:
			...
			if (!func_177(*uParam0, -2017877118))
			{
				unk_0x7D786F4317F35B2E(*uParam0, "WORLD_HUMAN_MOBILE_FILM_SHOCKING", 6000, 1);
				uParam0->f_5 = 1;
				uParam0->f_6 = 20;
				uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
			}
		...
		case 1:
			if (!unk_0x8AF655CC5761C7A2(*uParam0, iLocal_109, 0))
			{
				func_161(uParam0);
			}
			break;
		...
		case 2:
			if (!unk_0x471E33531AEA977D(*uParam0) && (unk_0x9D40BBF80D8F5E8A() - uParam0->f_1) > 3000)
			{
				func_161(uParam0);
			}
			break;
		...
		case 4:
			if ((unk_0x9D40BBF80D8F5E8A() - uParam0->f_1) > 8000)
			{
				...
				unk_0x6FD4DE4DAEA4ED56(*uParam0, 0, 1);
				uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
				uParam0->f_6 = 8;
			}
			else if (unk_0x44B59DB1458EE8E0(unk_0x3F80C6638E3A1A90()) > 1)
			{
				unk_0x6FD4DE4DAEA4ED56(*uParam0, 0, 1);
				uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
				uParam0->f_6 = 8;
		...
		case 6:
			if ((unk_0x9D40BBF80D8F5E8A() - uParam0->f_1) > uParam0->f_2)
			{
				if (!func_150(*uParam0, unk_0xE7869D5D7816A9B6(), 15f))
				{
					func_7(&(uParam0->f_4));
					uParam0->f_6 = 7;
					uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
		...
		case 7:
			if (unk_0x8AF655CC5761C7A2(*uParam0, iLocal_109, 1))
			{
				...
				if (!func_150(*uParam0, unk_0xE7869D5D7816A9B6(), 120f))
				{
					func_5(uParam0, 1, 0, 1);
				}
			}
		...
		case 9:
			if (unk_0x4231F56FA5885AE9(*uParam0))
			{
				func_169(uParam0, 1);
				return;
			}
			if ((unk_0x9D40BBF80D8F5E8A() - uParam0->f_1) > uParam0->f_2 || !func_177(*uParam0, 2104565373))
			{
				func_156(uParam0);
			}
			break;
		...
		case 16:
			...
			if ((unk_0x9D40BBF80D8F5E8A() - iLocal_670) >= 9000)
			{
				if (!func_154(uParam0))
				{
					func_156(uParam0);
			...
			else if ((unk_0x9D40BBF80D8F5E8A() - iLocal_670) >= 5000 && (unk_0x9D40BBF80D8F5E8A() - iLocal_670) <= 5500)
			{
				if (unk_0x51374A0BB2871E6E(*uParam0, 0))
				{
					if (unk_0x988161BB78EEE9AD(*uParam0))
					{
						unk_0x2AF72FDC86E8A4E5(*uParam0);
					}
				}
			}
			break;
		...
		case 20:
			...
			if ((unk_0x9D40BBF80D8F5E8A() - uParam0->f_1) >= 6000)
			{
				if (!unk_0x22E902D6AF27E232(*uParam0, unk_0xBD306D8AFEF4E078(iLocal_109, 5f, 0f, -2f), unk_0x1141852D07400777(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
				{
					func_156(uParam0);
				}
				else
...
int func_152(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_153(Param1 - unk_0x1141852D07400777(iParam0, 1)) };
	...
	{
		Var3 = { func_153(unk_0x5D551231E967CD2B(iParam0, 31086, 0f, 5f, 0f) - unk_0x5D551231E967CD2B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	if (unk_0x22E902D6AF27E232(unk_0xE7869D5D7816A9B6(), unk_0xBD306D8AFEF4E078(iLocal_109, 0f, 10f, -2f), unk_0xBD306D8AFEF4E078(iLocal_109, 0f, 3f, 2f), 5f, 0, 1, 0) && unk_0x960D953E3623A78D(*uParam0))
	{
		return 1;
	}
	return 0;
...
void func_155(var uParam0)
{
	...
	if (unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
	{
		...
		if (func_36(iVar0))
		{
			if (!unk_0xE8C390D56BE854E1(*uParam0, iVar0, -1, 0, 0))
			{
				uParam0->f_6 = 18;
				uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
			}
...
{
	unk_0xA9CA101B50B90993(2, uLocal_80, joaat("player"));
	switch (uParam0->f_8)
	{
		case 4:
			break;
		...
		case 3:
			if (!func_177(*uParam0, 242628503))
			{
				...
				if (!unk_0x8AF655CC5761C7A2(*uParam0, iLocal_109, 0))
				{
					if (uParam0->f_10 == 0)
					{
						unk_0x33E113E52A91C5C3(*uParam0, unk_0xBD306D8AFEF4E078(iLocal_109, func_130(1)), 1f, -1, 1048576000, 0, 1193033728);
						uParam0->f_7 = 1;
					}
					else
					{
						unk_0x33E113E52A91C5C3(*uParam0, unk_0xBD306D8AFEF4E078(iLocal_109, func_130(0)), 1f, -1, 1048576000, 0, 1193033728);
						uParam0->f_7 = 1;
					}
				}
			}
		...
		case 9:
			...
			else if (!unk_0x8AF655CC5761C7A2(*uParam0, iLocal_109, 0))
			{
				if (uParam0->f_10 == 0)
				{
					unk_0x33E113E52A91C5C3(*uParam0, unk_0xBD306D8AFEF4E078(iLocal_109, func_130(1)), 1f, -1, 1048576000, 0, 1193033728);
...
void func_157(var uParam0)
{
	if (!func_177(*uParam0, -71340211))
	{
		if (Local_134[iLocal_661 /*25*/].f_23 != 0)
		{
			if (func_10(Local_134[iLocal_661 /*25*/].f_17))
			{
				unk_0x0F600EFBA9B18BAD(*uParam0, Local_134[iLocal_661 /*25*/].f_17, -1, 0f, 180f, 1f, 0);
			}
		}
		else
		{
			unk_0x33E113E52A91C5C3(*uParam0, Local_134[iLocal_661 /*25*/].f_19, 1f, 20000, -1f, 0, func_158(Local_134[iLocal_661 /*25*/].f_19, unk_0x1141852D07400777(*uParam0, 1), 1));
		}
		if (func_36(iLocal_109))
		{
			unk_0xDBF2D7502C37C299(iLocal_109, 5, 0, 0);
		}
...
int func_159()
{
	if (func_36(iLocal_109) && func_321(unk_0xE7869D5D7816A9B6()))
	{
		if (unk_0x915685CA559C211B(iLocal_109, unk_0xE7869D5D7816A9B6(), 1))
		{
			unk_0x29FD5B1A4BA65801(iLocal_109);
			if (func_160() || unk_0x8219941CC4732B36(iLocal_109) < 851)
			{
				return 1;
			}
		}
...
int func_160()
{
	...
	while (iVar0 <= 5)
	{
		if (unk_0x3F916E486684A3A8(iLocal_109, iVar0, 0))
		{
			iVar1++;
		}
		iVar0++;
	...
	if (uParam0->f_7 == 9)
	{
		if (uParam0->f_9 >= 2)
		{
			if (!unk_0xAF437D7C802AB246(*uParam0))
			{
				unk_0xC456353A87F0538B(*uParam0, 1048576000);
				unk_0x1E4330D1AF23718F(*uParam0);
				unk_0xDCF460AE46C9489C(*uParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 8f, -8f, -1, 56, 0, 0, 0, 0);
			}
		}
	}
}
...
{
	if (func_36(iLocal_109) && (unk_0x8AF655CC5761C7A2(unk_0xE7869D5D7816A9B6(), iLocal_109, 0) && !unk_0x8AF655CC5761C7A2(*uParam0, iLocal_109, 0)))
	{
		if (unk_0xD4F0FC8FFEDE152B(iLocal_109) > 0f)
		{
			uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
			uParam0->f_8 = uParam0->f_7;
			uParam0->f_5 = 1;
...
int func_167(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xFC630C7120A34CE4(iVar0, func_168(unk_0x00AAD79B42B3E036(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xFC630C7120A34CE4(iVar0, func_168(unk_0x00AAD79B42B3E036(), 0.7f, 0.7f));
		unk_0x4ADC112587E95B61(iVar0, bParam1);
	}
...
{
	func_162(uParam0);
	if ((unk_0x72957E5DA83E879F(unk_0xE7869D5D7816A9B6(), 6) || iParam1) || uParam0->f_6 == 23)
	{
		if (!func_150(unk_0xE7869D5D7816A9B6(), *uParam0, 10f))
		{
...
int func_174(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_153(unk_0x1141852D07400777(iParam1, 1) - unk_0x1141852D07400777(iParam0, 1)) };
...
void func_178(var uParam0)
{
	...
	{
		case 1:
			if (unk_0x8AF655CC5761C7A2(unk_0xE7869D5D7816A9B6(), iLocal_109, 1))
			{
				func_169(uParam0, 0);
				return;
			}
		...
		case 2:
			if (unk_0xF50745B40235B5B8(*uParam0, iLocal_109))
			{
			...
			else if (unk_0x8AF655CC5761C7A2(unk_0xE7869D5D7816A9B6(), iLocal_109, 1))
			{
				func_169(uParam0, 0);
				return;
			}
			...
			if (bLocal_664)
			{
				if (iLocal_661 <= 20 && iLocal_661 != -1)
				{
					if (!Local_134[iLocal_661 /*25*/].f_18)
					{
						...
						{
							if (Local_134[iLocal_661 /*25*/].f_9 && unk_0x6D30046757C9C4F9(iLocal_109))
							{
								func_188();
							}
						}
		...
		case 5:
			if (func_36(iLocal_109))
			{
				unk_0x1B9F8E5CCC384F1E(iLocal_109, 25f, 10, 0);
				fVar0 = unk_0xD4F0FC8FFEDE152B(iLocal_109);
				if (fVar0 < 8f)
				{
					func_187(uParam0);
				}
		...
		case 6:
			if (!func_177(*uParam0, 242628503) && unk_0x6D30046757C9C4F9(iLocal_109))
			{
				if (bLocal_664)
				{
					uParam0->f_8 = uParam0->f_7;
				...
				{
					unk_0xCD7A5BCC47D00FB2(*uParam0, 0, 0);
					uParam0->f_8 = uParam0->f_7;
					uParam0->f_7 = 8;
				}
			}
		...
		case 7:
			...
			{
				if (unk_0x8AF655CC5761C7A2(Local_111[1 /*11*/], iLocal_109, 0) && Local_111[1 /*11*/].f_7 == 3)
				{
					func_123(0);
				}
			}
...
void func_179(var uParam0)
{
	...
	switch (uParam0->f_9)
	{
		case 1:
			...
			{
				unk_0x94026C1D1DB14225(&uVar0);
				if (func_163(unk_0x1141852D07400777(*uParam0, 1), Local_134[iLocal_661 /*25*/].f_19) > 1.5f)
				{
					unk_0xDE6D5CD5475B6C9F(0, Local_134[iLocal_661 /*25*/].f_19, 0);
				}
				unk_0xDCF460AE46C9489C(0, "missfbi4prepp1", "_bag_pickup_garbage_man", 8f, -16f, -1, 528384, 0, 0, 0, 0);
				unk_0x911ECBCE73F8EC3F(uVar0);
				unk_0xC2C4A3A9FF2FBFFF(*uParam0, uVar0);
				unk_0x33A90AD8FA327B72(&uVar0);
				uParam0->f_9 = 2;
			...
			unk_0x2184527A517352FE(*uParam0, 0.2f);
			break;
		
		case 2:
			if (func_177(*uParam0, 242628503))
			{
				if (unk_0x23417CDB252083F9(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man", 3))
				{
					if (unk_0xCB337035DFE5097C(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man") >= 0.333f)
					{
						unk_0xA8BB37BC9C4A95D4(*uParam0, "missfbi4prepp1_garbageman", 0f);
						unk_0x221855D40AA0FC73(*uParam0, "missfbi4prepp1_garbageman");
						if (func_10(Local_134[iLocal_661 /*25*/].f_17) && !unk_0xD55D878601C46BA9(Local_134[iLocal_661 /*25*/].f_17))
						{
							unk_0x9E4D318905B670CB(Local_134[iLocal_661 /*25*/].f_17, *uParam0, unk_0x206A9EC63F98F19D(*uParam0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
						}
					}
				}
			...
			else if (!func_177(*uParam0, 713668775))
			{
				if (func_36(iLocal_109))
				{
					unk_0x33E113E52A91C5C3(*uParam0, unk_0xBD306D8AFEF4E078(iLocal_109, 0f, -4.8f, 0f), 1f, -1, 0.25f, 0, unk_0x2CAFFCD9F5E16D2F(iLocal_109));
				}
				uParam0->f_9 = 3;
			}
			unk_0x2184527A517352FE(*uParam0, 0.2f);
		...
		case 3:
			if (func_36(iLocal_109))
			{
				if (!func_184(unk_0xBD306D8AFEF4E078(iLocal_109, 0f, -5.5f, 0f), iLocal_109, 1.9f, 1.9f, 8f))
				{
					if (unk_0x3761EA7F8628B81A(*uParam0, unk_0xBD306D8AFEF4E078(iLocal_109, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, 0, 1, 0))
					{
						if (!func_177(*uParam0, 713668775))
						{
							unk_0x94026C1D1DB14225(&uVar1);
							if (func_163(unk_0x1141852D07400777(*uParam0, 1), unk_0x1141852D07400777(iLocal_109, 1)) > 3f)
							{
								unk_0xF78809EA8A08F2D1(0, unk_0x2CAFFCD9F5E16D2F(iLocal_109), 0);
							}
							unk_0xDCF460AE46C9489C(0, "missfbi4prepp1", "_bag_throw_garbage_man", 8f, -8f, -1, 0, 0, 0, 0, 0);
							unk_0x911ECBCE73F8EC3F(uVar1);
							unk_0xC2C4A3A9FF2FBFFF(*uParam0, uVar1);
							unk_0x33A90AD8FA327B72(&uVar1);
							uParam0->f_9 = 4;
		...
		case 4:
			if (!func_184(unk_0xBD306D8AFEF4E078(iLocal_109, 0f, -5.5f, 0f), *uParam0, 1.9f, 1.9f, 8f))
			{
				if (func_177(*uParam0, 242628503))
				{
					if (unk_0x23417CDB252083F9(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man", 3))
					{
						if (unk_0xCB337035DFE5097C(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man") >= 0.391f)
						{
							if (func_10(Local_134[iLocal_661 /*25*/].f_17))
							{
								if (unk_0xD55D878601C46BA9(Local_134[iLocal_661 /*25*/].f_17))
								{
									...
									unk_0x1E4330D1AF23718F(*uParam0);
									unk_0x27B54A887EC71B05(Local_134[iLocal_661 /*25*/].f_17, 1, 0);
									unk_0x94D1E7548565F807(Local_134[iLocal_661 /*25*/].f_17, 2f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1082130432, -1082130432, -1082130432);
									unk_0x2FD3AA0C3395806A(Local_134[iLocal_661 /*25*/].f_17, 1, unk_0x5ED441592163C054(*uParam0), 0, 1, 1, 0);
								}
								if (unk_0x3C1B1C07A878AE1D(Local_134[iLocal_661 /*25*/].f_17, iLocal_109))
								{
				...
				else
				{
					...
					if (func_36(iLocal_109))
					{
						unk_0x64BC661927CC9D64(iLocal_109, 5, 0);
						func_180(&(Local_134[iLocal_661 /*25*/].f_17));
					}
					func_156(uParam0);
				}
...
void func_181(var uParam0)
{
	...
	unk_0xA9CA101B50B90993(5, uLocal_80, joaat("player"));
	func_162(uParam0);
	if (!unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
	{
		if (!unk_0x51374A0BB2871E6E(*uParam0, 0))
...
int func_184(struct<3> Param0, int iParam3, struct<3> Param4)
{
	...
	if (Local_82.f_26)
	{
		if (unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
		{
			if (unk_0x8C1ED5BB2888BA25(Local_82.f_18))
			{
				if (func_10(Local_82.f_18))
				{
					if (unk_0xE59FAD6B5E1AA42D(Local_82.f_18) == unk_0xF0295FF51F2D7803(unk_0xE7869D5D7816A9B6(), 1))
					{
						return 1;
					}
				}
		...
		else if (unk_0x41B17741CACC905E(Local_82.f_18))
		{
			if (func_10(Local_82.f_18))
			{
				if (unk_0x10E754B2E0DF2A70(Local_82.f_18) == unk_0xE7869D5D7816A9B6())
				{
					return 1;
				}
			}
...
void func_185(var uParam0, var uParam1)
{
	...
	iVar1 = unk_0x9CBE058E2C3ABB72(*uParam0, &iVar0, &(uParam0->f_20), &(uParam0->f_23), &(uParam0->f_18));
...
void func_186(var uParam0, int iParam1)
{
	switch (uParam0->f_1)
	{
		...
		case 1:
			*uParam0 = unk_0x1EAB9962ED64CF16(uParam0->f_2, uParam0->f_5, 511, uParam1, 7);
			break;
		
		case 2:
			*uParam0 = unk_0xFABB2FCCE6252C30(uParam0->f_17, 511, 4);
			break;
		
		case 3:
			*uParam0 = unk_0x5F99E6D0ED94D586(uParam0->f_17, 511, 4);
			break;
		
		case 4:
			*uParam0 = unk_0x77FB1C984FBD2045(uParam0->f_2, uParam0->f_8, uParam0->f_11, uParam0->f_14, 6, iParam1, 4);
			break;
		
		case 5:
			*uParam0 = unk_0x107BA8B020DB9C5F(uParam0->f_2, uParam0->f_5, uParam0->f_15, 511, iParam1, 4);
			break;
	}
...
void func_187(var uParam0)
{
	...
	{
		unk_0x94026C1D1DB14225(&uVar0);
		unk_0x8543F365CDBCAAAD(0, iLocal_109, Local_134[iLocal_661 /*25*/].f_3, 8f, 0, joaat("trash"), 786469, 10f, 15f);
		unk_0x638E5A39639FFC7F(0, iLocal_109, Local_134[iLocal_661 /*25*/].f_3, Local_134[iLocal_661 /*25*/].f_8, Local_134[iLocal_661 /*25*/].f_10, 5f, 1);
		unk_0x911ECBCE73F8EC3F(uVar0);
		unk_0xC2C4A3A9FF2FBFFF(*uParam0, uVar0);
		unk_0x33A90AD8FA327B72(&uVar0);
		uParam0->f_7 = 6;
...
void func_189(var uParam0, bool bParam1)
{
	...
	if (func_184(unk_0xBD306D8AFEF4E078(iLocal_109, func_130(bParam1)), iLocal_109, 1.9f, 1.9f, 8f))
	{
		if (unk_0x22E902D6AF27E232(*uParam0, unk_0xBD306D8AFEF4E078(iLocal_109, 5f, 0f, -2f), unk_0x1141852D07400777(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0) && unk_0x22E902D6AF27E232(unk_0xE7869D5D7816A9B6(), unk_0xBD306D8AFEF4E078(iLocal_109, 5f, 0f, -2f), unk_0x1141852D07400777(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
		{
			func_190(uParam0);
		}
		else if (!func_177(*uParam0, 1227113341) && unk_0x22E902D6AF27E232(unk_0xE7869D5D7816A9B6(), unk_0xBD306D8AFEF4E078(iLocal_109, 5f, 0f, -2f), unk_0x1141852D07400777(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
		{
			unk_0xFA2C5C2D054C888E(*uParam0);
			unk_0xD0153915878AE371(*uParam0, unk_0xE7869D5D7816A9B6(), -1, 4f, 1f, 1073741824, 0);
		}
	}
	else if (func_100(*uParam0, unk_0xBD306D8AFEF4E078(iLocal_109, func_130(bParam1)), 5f))
	{
		iVar0 = -1;
		if (!bParam1)
		{
		...
		unk_0x65682335D54DEA1C(*uParam0, iLocal_109, -1, iVar0, 1f, 8388609, 0);
		uParam0->f_7 = 2;
	}
}
...
void func_191(var uParam0)
{
	if (uParam0->f_5 != 1)
	{
		if (func_36(iLocal_109) && unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
		{
			if (!func_177(*uParam0, 2104565373) && unk_0x8AF655CC5761C7A2(*uParam0, iLocal_109, 0))
			{
				if (func_150(unk_0xE7869D5D7816A9B6(), iLocal_109, 10f))
				{
					if (unk_0x3C1B1C07A878AE1D(iLocal_109, unk_0xE7869D5D7816A9B6()))
					{
						unk_0x66D2B52327C9F60D(*uParam0, unk_0xE7869D5D7816A9B6(), 0, 0f, 0f, 0f, 10f, 100, 1, joaat("FIRING_PATTERN_FULL_AUTO"));
						uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
						uParam0->f_6 = 9;
					}
				}
...
void func_192()
{
	...
	while (iVar0 <= (iLocal_81 - 1))
	{
		if (Local_134[iVar0 /*25*/].f_23 != 0)
		{
			...
			{
				if ((iVar0 != iLocal_661 && func_10(Local_134[iVar0 /*25*/].f_17)) && func_194(Local_134[iVar0 /*25*/].f_17, unk_0xE7869D5D7816A9B6(), 1) > 200f)
				{
					unk_0xD4E454973E16D31B(&(Local_134[iVar0 /*25*/].f_17));
					Local_134[iVar0 /*25*/].f_24 = 0;
				}
			}
			else if (Local_134[iVar0 /*25*/].f_23 != 0)
			{
				if (func_100(unk_0xE7869D5D7816A9B6(), Local_134[iVar0 /*25*/], 100f) || func_100(Local_111[0 /*11*/], Local_134[iVar0 /*25*/], 120f))
				{
...
void func_195(var uParam0, int iParam1, int iParam2)
{
	if (uParam0->f_5 != 1 || iParam2)
	{
		if (!func_321(Local_111[func_164(iParam1) /*11*/]))
		{
			if (!bLocal_665)
			{
				if (unk_0xD51CFE69539DB6D8(Local_111[func_164(iParam1) /*11*/]))
				{
					...
					{
						Local_667 = { unk_0x1141852D07400777(Local_111[func_164(iParam1) /*11*/], 1) };
						uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
						uParam0->f_8 = uParam0->f_7;
						uParam0->f_5 = 1;
						uParam0->f_6 = 11;
		...
		{
			if (func_174(*uParam0, Local_111[func_164(iParam1) /*11*/], 140f, 0) && func_150(Local_111[func_164(iParam1) /*11*/], unk_0xE7869D5D7816A9B6(), 15f))
			{
				uParam0->f_5 = 1;
				uParam0->f_6 = 21;
			}
		...
		if (uParam0->f_10 == 0 && uParam0->f_7 == 4)
		{
			if (func_154(uParam0))
			{
				...
				{
					unk_0x66D2B52327C9F60D(*uParam0, unk_0xE7869D5D7816A9B6(), 0, 0f, 0f, 0f, 10f, 100, 1, joaat("FIRING_PATTERN_FULL_AUTO"));
					unk_0xEB8B8C2A73945CE1(iLocal_109, 2000f);
					iLocal_670 = unk_0x9D40BBF80D8F5E8A();
					uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
					uParam0->f_6 = 16;
					uParam0->f_5 = 1;
				}
		...
		if (func_197(*uParam0, 1, 70f, 170f, 0, 1, 0, 0) && !func_196(uParam0))
		{
			if (unk_0x72957E5DA83E879F(unk_0xE7869D5D7816A9B6(), 6))
			{
				if (func_36(iLocal_109))
				{
					if (unk_0x8AF655CC5761C7A2(*uParam0, iLocal_109, 0))
					{
						if (unk_0xD4F0FC8FFEDE152B(iLocal_109) > 5f)
						{
							if (iParam1 == 0)
							{
								unk_0x547730440687D355(*uParam0, iLocal_109, unk_0xE7869D5D7816A9B6(), 8, 30f, 786469, 300f, 2f, 1);
								uParam0->f_6 = 7;
								unk_0xC2EA5B4B2052D2F1(Local_111[func_164(iParam1) /*11*/], -1);
								Local_111[func_164(iParam1) /*11*/].f_6 = 10;
								Local_111[func_164(iParam1) /*11*/].f_5 = 1;
								uParam0->f_5 = 1;
								uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
								Local_111[func_164(iParam1) /*11*/].f_1 = unk_0x9D40BBF80D8F5E8A();
							}
							else
							{
								unk_0xC2EA5B4B2052D2F1(*uParam0, -1);
								uParam0->f_6 = 12;
								unk_0x547730440687D355(Local_111[func_164(iParam1) /*11*/], iLocal_109, unk_0xE7869D5D7816A9B6(), 8, 30f, 786469, 300f, 2f, 1);
						...
						else
						{
							...
							if (unk_0xD51CFE69539DB6D8(Local_111[func_164(iParam1) /*11*/]))
							{
								if (func_174(Local_111[func_164(iParam1) /*11*/], unk_0xE7869D5D7816A9B6(), 1126825984, 0))
								{
									func_169(&(Local_111[func_164(iParam1) /*11*/]), 0);
								}
							}
						}
						unk_0x29FD5B1A4BA65801(*uParam0);
					}
					else
					{
						func_169(uParam0, 0);
			...
			else
			{
				...
				if (func_170(Local_111[func_164(iParam1) /*11*/], *uParam0, 1126825984, 1, 250, 7))
				{
					...
					unk_0x29FD5B1A4BA65801(Local_111[func_164(iParam1) /*11*/]);
				}
			}
			uParam0->f_5 = 1;
		}
		else if (unk_0x4231F56FA5885AE9(*uParam0))
		{
			func_162(uParam0);
			unk_0x4B79E06845D63B96(*uParam0, unk_0xE7869D5D7816A9B6(), 500f, -1, 0, 1);
			uParam0->f_6 = 2;
		...
		if (unk_0x8E2CF6ACCED3BD0F(*uParam0))
		{
			if (func_10(Local_134[iLocal_661 /*25*/].f_17))
			{
				if (unk_0xD55D878601C46BA9(Local_134[iLocal_661 /*25*/].f_17))
	...
	if (uParam0->f_5 != 1)
	{
		if (func_321(Local_111[func_164(iParam1) /*11*/]))
		{
			if (unk_0x4231F56FA5885AE9(Local_111[func_164(iParam1) /*11*/]))
			{
				func_162(uParam0);
				unk_0x4B79E06845D63B96(*uParam0, unk_0xE7869D5D7816A9B6(), 120f, -1, 0, 0);
				uParam0->f_1 = unk_0x9D40BBF80D8F5E8A();
				uParam0->f_6 = 7;
				uParam0->f_5 = 1;
			}
...
{
	if ((unk_0x3761EA7F8628B81A(unk_0xE7869D5D7816A9B6(), unk_0xBD306D8AFEF4E078(*uParam0, 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !unk_0x72957E5DA83E879F(unk_0xE7869D5D7816A9B6(), 6)) && unk_0x9FB2F45912EB7218(unk_0xE7869D5D7816A9B6()))
	{
		return 1;
	}
	return 0;
	...
	if (func_10(unk_0xE7869D5D7816A9B6()) && func_10(iParam0))
	{
		...
		if (!unk_0x72957E5DA83E879F(unk_0xE7869D5D7816A9B6(), 6))
		{
			if (unk_0xC3AE89795D844EE9(unk_0xE7869D5D7816A9B6()))
			{
				...
				{
					return func_201(unk_0xE7869D5D7816A9B6(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_198(int iParam0, float fParam1)
{
	...
	if (func_10(unk_0xE7869D5D7816A9B6()) && func_10(iParam0))
	{
		if (func_200(iParam0) || unk_0x386C3192F791D414(unk_0x3F80C6638E3A1A90(), iParam0))
		{
			if (unk_0x72957E5DA83E879F(unk_0xE7869D5D7816A9B6(), 6))
			{
				fVar0 = 40f;
...
{
	return func_170(iParam0, unk_0xE7869D5D7816A9B6(), fParam1, 1, 250, 7);
}
...
{
	if (func_150(uParam0, unk_0xE7869D5D7816A9B6(), 6f))
	{
		if (!unk_0x51374A0BB2871E6E(uParam0, 0))
		{
...
void func_207()
{
	if (func_36(Local_868.f_0))
	{
		if (func_150(unk_0xE7869D5D7816A9B6(), Local_868.f_0, 100f) && !iLocal_837)
		{
			unk_0xD016326278B5D42B(joaat("trash"), 3);
			if (!unk_0xE5ED4BE9950F1B30(joaat("trash")))
			{
				iLocal_837 = 1;
			}
		}
		else if (!func_150(unk_0xE7869D5D7816A9B6(), Local_868.f_0, 120f) && iLocal_837)
		{
			unk_0x22CA804442E37496(joaat("trash"));
			iLocal_837 = 0;
		}
	}
}
		...
		switch (*iParam2)
		{
			case 0:
				if (unk_0x8AF655CC5761C7A2(unk_0xE7869D5D7816A9B6(), *iParam0, 0))
				{
					...
					if (func_99(func_107(func_75()), 0, 0))
					{
						unk_0x621ABFDE5A901516(func_107(func_75()));
					}
					if (*iParam0 == iParam8)
					{
						*iParam2 = 1;
				...
				else
				{
					...
					{
						unk_0x621ABFDE5A901516(func_108(func_75(), bParam9));
					}
					if (func_75() != 33)
					{
						func_210(iParam0);
			...
			case 2:
			case 1:
				if ((!unk_0x8AF655CC5761C7A2(unk_0xE7869D5D7816A9B6(), *iParam0, 0) && !func_213(*iParam0)) && !func_212(*iParam0))
				{
					func_7(iParam4);
...
void func_210(var uParam0)
{
	...
	if (unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
	{
		...
		if (iVar0 != *uParam0)
		{
			if (func_36(iVar0))
			{
				if (unk_0x1B2DC87EFB36DF80(iVar0) == func_211(func_75()))
				{
					func_6(uParam0);
					*uParam0 = iVar0;
					func_35(*uParam0, 1);
...
int func_212(int iParam0)
{
	...
	if ((func_321(unk_0xE7869D5D7816A9B6()) && unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0)) && func_36(iParam0))
	{
...
void func_214()
{
	...
	switch (iLocal_684)
	{
		case 0:
			if (func_115(iLocal_683, bLocal_28))
			{
				if (unk_0x44B59DB1458EE8E0(unk_0x3F80C6638E3A1A90()) == 0 && !func_230())
				{
		...
		case 3:
			if (func_36(iLocal_874))
			{
				if (!unk_0x8AF655CC5761C7A2(unk_0xE7869D5D7816A9B6(), iLocal_874, 0))
				{
					unk_0x0CC1C59D57D7212B(unk_0xE7869D5D7816A9B6(), iLocal_874, -1);
				}
				else
				{
	...
	while (iVar0 < 3)
	{
		...
		if (!unk_0xAF437D7C802AB246(iVar2))
		{
			if (func_76(iVar2, 0))
			{
				if (!bVar1)
				{
					if (func_150(unk_0xE7869D5D7816A9B6(), iVar2, 5f))
					{
						if (!func_230())
						{
							func_225(iVar0);
			...
			if (!func_217(iVar2))
			{
				if (func_76(iVar2, 0))
				{
					if (func_224(iVar2) || func_222(iVar2))
					{
						if (func_221(iVar2, 0))
						{
							unk_0x20BB4B94CC6DDC9A(iVar2, 1, 1);
							unk_0x9BEE7E791BC4D38B(iVar2, true);
							unk_0xFA2C5C2D054C888E(iVar2);
						}
					}
				}
			}
			else if (unk_0x4C5CA989AEF3A14C(iVar2, 1))
			{
				if (func_224(iVar2))
				{
					if (unk_0xC47857E5E74EA5AF(iVar2, -1273030092) != 1 && unk_0xC47857E5E74EA5AF(iVar2, -1273030092) != 0)
					{
						if (unk_0x5870CB0276CF5667(623.3781f, -172.26f, 1700.732f, -2115.843f))
						{
							unk_0x8543F365CDBCAAAD(iVar2, unk_0xF0295FF51F2D7803(iVar2, 0), Local_827, 20f, 0, 0, 34340901, 2f, 10f);
						}
						else
						{
							unk_0x1A10579F8DE3BF6B(623.3781f, -172.26f, 1700.732f, -2115.843f);
						}
					}
				}
				else if (func_222(iVar2))
				{
					if (func_36(Local_868.f_0))
					{
						if (!func_150(iVar2, Local_868.f_0, 17f))
						{
							if (unk_0xC47857E5E74EA5AF(iVar2, -1273030092) != 1 && unk_0xC47857E5E74EA5AF(iVar2, -1273030092) != 0)
							{
								unk_0x03C1B195D300CB1D(iVar2, unk_0xF0295FF51F2D7803(iVar2, 0), Local_868.f_0, 3, 20f, 786468, 2f, 0.5f, 1);
							}
						}
					}
				}
...
int func_222(int iParam0)
{
	...
	if (!func_223())
	{
		if ((!unk_0xAF437D7C802AB246(unk_0xE7869D5D7816A9B6()) && unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0)) && unk_0x44B59DB1458EE8E0(unk_0x3F80C6638E3A1A90()) == 0)
		{
			iVar0 = unk_0xF0295FF51F2D7803(unk_0xE7869D5D7816A9B6(), 0);
			if (func_36(iVar0))
			{
				if (unk_0x7579897B912B3328(iVar0, joaat("trash")))
				{
					return 0;
				}
				if (unk_0x8AF655CC5761C7A2(iParam0, iVar0, 0) && unk_0xBD6B21D725712BDE(iVar0, -1) == iParam0)
				{
					return 1;
				}
			}
...
int func_224(int iParam0)
{
	if (!func_223())
	{
		if ((unk_0xD51CFE69539DB6D8(Local_868.f_0) && unk_0xC45A34912542C4EB(Local_868.f_0, 0)) && !unk_0x3761EA7F8628B81A(Local_868.f_0, Local_827, 2f, 2f, 2f, 0, 1, 0))
		{
			if ((!unk_0xAF437D7C802AB246(unk_0xE7869D5D7816A9B6()) && unk_0x8AF655CC5761C7A2(unk_0xE7869D5D7816A9B6(), Local_868.f_0, 0)) && unk_0x44B59DB1458EE8E0(unk_0x3F80C6638E3A1A90()) == 0)
			{
				if (unk_0x8AF655CC5761C7A2(iParam0, Local_868.f_0, 0) && unk_0xBD6B21D725712BDE(Local_868.f_0, -1) == iParam0)
				{
					return 1;
				}
			}
...
void func_225(int iParam0)
{
	if (iLocal_683 > 1)
	{
		if (iLocal_685 > 0)
		{
			if (!unk_0xB519E5386FBF69E5(Local_688[iParam0 /*8*/].f_7, 0) && iLocal_686 == 1)
			{
				if (!unk_0x13ACC601BB29A690())
				{
					if (func_229(&uLocal_879, cLocal_878, Local_688[iParam0 /*8*/][0], 8, 0, 0, 0))
					{
						unk_0x9956FB0E4B50ECB8(&(Local_688[iParam0 /*8*/].f_7), 0);
					}
				}
			}
		}
		...
		{
			if ((unk_0xB519E5386FBF69E5(Local_688[iParam0 /*8*/].f_7, 0) && !unk_0xB519E5386FBF69E5(Local_688[iParam0 /*8*/].f_7, 1)) && iLocal_686 == 1)
			{
				if (!unk_0x13ACC601BB29A690())
				{
					if (func_229(&uLocal_879, cLocal_878, Local_688[iParam0 /*8*/][1], 7, 0, 0, 0))
					{
						unk_0x9956FB0E4B50ECB8(&(Local_688[iParam0 /*8*/].f_7), 1);
					}
				}
			}
			if (!unk_0xB519E5386FBF69E5(Local_688[iParam0 /*8*/].f_7, 5))
			{
				if (func_228(iLocal_874, Local_827, 1) < 15f && iLocal_686 == 1)
				{
					if (!unk_0x13ACC601BB29A690())
					{
						...
						{
							unk_0x9956FB0E4B50ECB8(&(Local_688[iParam0 /*8*/].f_7), 5);
						}
					}
				}
			}
			switch (func_29(unk_0xE7869D5D7816A9B6()))
			{
				case 0:
					if (iParam0 == 1)
					{
...
{
	if (!unk_0xB519E5386FBF69E5(Local_688[iParam0 /*8*/].f_7, iParam1))
	{
		if (iLocal_1052 != -1)
		{
			if (!unk_0x13ACC601BB29A690())
			{
				...
				{
					unk_0x9956FB0E4B50ECB8(&(Local_688[iParam0 /*8*/].f_7), iParam1);
				}
			}
		}
		else if (!func_230() && !unk_0x13ACC601BB29A690())
		{
			iLocal_1052 = unk_0x9D40BBF80D8F5E8A();
		}
		else
		{
			iLocal_1052 = -1;
...
{
	if ((unk_0xB519E5386FBF69E5(Local_688[0 /*8*/].f_7, iParam0) || unk_0xB519E5386FBF69E5(Local_688[1 /*8*/].f_7, iParam0)) || unk_0xB519E5386FBF69E5(Local_688[2 /*8*/].f_7, iParam0))
	{
		return 1;
	}
	return 0;
...
void func_231()
{
	if (func_100(unk_0xE7869D5D7816A9B6(), Local_827, 220f))
	{
		if (!iLocal_877 && !func_100(unk_0xE7869D5D7816A9B6(), Local_827, 100f))
		{
			iLocal_877 = func_146(&uLocal_876, joaat("cavalcade2"), 1370.912f, -2060.055f, 50.9983f, 312.8686f, 1);
		}
	}
	else if (func_100(unk_0xE7869D5D7816A9B6(), Local_827, 240f))
	{
		if (iLocal_877)
		{
			func_6(&uLocal_876);
...
void func_232()
{
	...
	switch (iLocal_684)
	{
		...
		case 1:
			...
			if (!bLocal_833)
			{
				if (func_321(Local_840.f_0) && unk_0x4231F56FA5885AE9(Local_840.f_0))
				{
					func_234();
				}
				if (func_321(Local_854.f_0) && unk_0x4231F56FA5885AE9(Local_854.f_0))
				{
					func_234();
				}
			}
...
void func_238(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_254(iParam1) && unk_0xB756E8D139BDE124(iParam1))
	{
		iVar1 = 0;
...
{
	if (func_254(unk_0xE7869D5D7816A9B6()))
	{
...
int func_243(char* sParam0)
{
	if (!func_244(1, 1, 0))
	{
		if ((!unk_0xF6917DE0E003509D(sParam0) && func_139(sParam0)) || func_139("CMN_HINT"))
		{
			unk_0x1D208E4A4E1D4FFE(1);
		}
		return 0;
...
bool func_247()
{
	return func_248(unk_0x3F80C6638E3A1A90());
}
...
int func_249(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_252(bParam1, bParam2, bParam3) || unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((unk_0x9D40BBF80D8F5E8A() - uParam0->f_4) > 500)
			{
				...
				{
					if (unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 1) || func_250(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
		...
		case 0:
			if (func_115(iLocal_683, 0))
			{
				...
				else
				{
					if (func_32(0))
					{
						func_117(unk_0xE7869D5D7816A9B6(), 1228.635f, -348.4277f, 68.0929f, 86.7244f);
...
void func_268()
{
	...
	if (unk_0xD51CFE69539DB6D8(iVar0))
	{
		if (unk_0xC45A34912542C4EB(iVar0, 0))
		{
			func_269(iVar0, unk_0x1141852D07400777(iVar0, 1), unk_0x2CAFFCD9F5E16D2F(iVar0), 24, 0);
		}
	}
}
...
void func_270(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_298(&(Global_68105.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (unk_0xD51CFE69539DB6D8(iParam1))
	{
		if (unk_0xC45A34912542C4EB(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_99155.f_18731.f_4801 = func_287();
			}
...
void func_271(int iParam0, int iParam1)
{
	...
	func_308(iParam0, &(Global_99155.f_18731.f_5510));
}

int func_272(int iParam0)
{
	if ((((((((((!unk_0xD51CFE69539DB6D8(iParam0) || !unk_0xC45A34912542C4EB(iParam0, 0)) || func_284(iParam0, 0, 0)) || func_284(iParam0, 1, 0)) || func_284(iParam0, 2, 0)) || func_307(iParam0) != 145) || func_283(iParam0)) || func_282(iParam0)) || func_281(iParam0)) || func_280(iParam0)) || !func_273(unk_0x1B2DC87EFB36DF80(iParam0)))
	{
		if (func_282(iParam0))
		{
		}
...
var func_287()
{
	...
	func_297(&uVar0, unk_0x0CE219089BDB83C5());
	func_296(&uVar0, unk_0x1B24A2CA27443F7B());
	func_295(&uVar0, unk_0x7C833E3C6EEE41E0());
	func_290(&uVar0, unk_0x2DA3502053F9E535());
	func_289(&uVar0, unk_0xEB4EA596232DA76E());
	func_288(&uVar0, unk_0xB99227ECC84A576C());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_293(unk_0xB519E5386FBF69E5(iParam0, 31), -1, 1)) + 2011;
}
...
int func_298(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0xB519E5386FBF69E5(uParam0->f_9, 10))
	{
		...
		if (!func_15(Global_99155.f_18731.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_15(Global_99155.f_1750.f_539.f_2816[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_15(Global_99155.f_1750.f_539.f_2816[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_301(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6)
{
	if (func_298(&(Global_68105.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_306(iParam0);
			func_305(uParam1, &(Global_99155.f_18731.f_69[Global_68105.f_555[0 /*21*/].f_14 /*78*/]));
	...
	if (unk_0xC45A34912542C4EB(iParam0, 0))
	{
		...
		*uParam1 = unk_0x0FD17058EC3E1147(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x9956FB0E4B50ECB8(&(uParam1->f_77), func_309(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_318()
{
	...
	if (!func_36(iLocal_874))
	{
		...
		if (func_36(Local_868.f_0) && !func_150(unk_0xE7869D5D7816A9B6(), Local_868.f_0, fVar0))
		{
			func_320(2);
		}
	}
	...
	{
		iVar1 = 0;
		if (!func_150(unk_0xE7869D5D7816A9B6(), iLocal_874, fVar0))
		{
			iVar1++;
		}
		if (func_36(uLocal_875))
		{
			if (!func_150(unk_0xE7869D5D7816A9B6(), uLocal_875, fVar0))
			{
				iVar1++;
			}
		}
		...
		if (func_36(Local_868.f_0))
		{
			if (!func_150(unk_0xE7869D5D7816A9B6(), Local_868.f_0, fVar0))
			{
				iVar1++;
			}
		}
...
void func_326(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	iVar0 = Global_2466310[iParam0 /*5*/][func_327(iParam2)];
	if (iVar0 != 0)
	{
...
int func_328(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2466310[iParam0 /*5*/][func_327(iParam1)];
...
int func_335(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x00AAD79B42B3E036())
	{
		if (func_330() == 0)
		{
			return unk_0xB519E5386FBF69E5(func_328(func_329(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_355()
{
	...
	unk_0x7E38E815EF844C74(joaat("s_m_y_garbage"), 0);
	func_61();
	func_365();
	func_364();
	func_356(0);
...
void func_356(bool bParam0)
{
	...
	unk_0x7146F608C2C17ACC("WORLD_VEHICLE_ATTRACTOR", 1);
	...
	if (bParam0)
	{
		if (unk_0xD51CFE69539DB6D8(iLocal_874))
		{
			if (unk_0xD51CFE69539DB6D8(unk_0xE7869D5D7816A9B6()))
			{
				if (!unk_0xAF437D7C802AB246(unk_0xE7869D5D7816A9B6()))
	...
	func_138(&uLocal_671, 0, 0);
	if (unk_0xCF686B56FD5328B5(uLocal_823))
	{
		unk_0x538689EF05955EF7(0, 0, 3000, 1, 0, 0);
		unk_0x74FF6D08DE291367(uLocal_823, 0);
	}
}
...
void func_363()
{
	unk_0x839E9476E54502A2(Local_868.f_5);
}
