...
void __EntryFunction__()
{
	...
	if (unk_0x7D9C4B359376D38A(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_103642[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_297(&(Global_103642[Var0.f_0 /*10*/].f_9));
			}
		}
		func_280(&Var0, 1);
	}
	...
	else if (Var0.f_0 == 30)
	{
		...
		iLocal_262 = unk_0x53C562FD2B9E3AB0();
	}
	while (true)
	{
		unk_0x4EDE34FBADD967A6(0);
...
void func_187()
{
	...
	{
		case 0:
			if ((unk_0x53C562FD2B9E3AB0() - iLocal_262) > 100 && bLocal_263 == 0)
			{
				iLocal_96 = 1;
			}
			break;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_196(unk_0xFC1458A37D98B502()) && func_196(iParam0->f_28[0])) && !func_142()) && (unk_0x53C562FD2B9E3AB0() - iParam0->f_60) > iParam8) && func_208(unk_0xFC1458A37D98B502(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_199(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
	{
		if (!unk_0xAB019B170BF1309C(sParam1))
		{
			...
			{
				if (func_208(unk_0xFC1458A37D98B502(), Param2, 1) <= 100f)
				{
					func_202(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_208(unk_0xFC1458A37D98B502(), Param2, 1) > 120f)
				{
					func_204(iParam0);
				}
			}
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_212(uParam1) || !unk_0xA5F6598E13F98E08(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_212(uParam1) && uParam1->f_4 == 0) && unk_0xBE3C4023003180FC(unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1), unk_0xB3328BA8976B416C(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_228(unk_0xB3328BA8976B416C(iParam1, 1) - unk_0xB3328BA8976B416C(iParam0, 1)) };
	...
	{
		Var3 = { func_228(unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 5f, 0f) - unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_235(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_228(Param1 - unk_0xB3328BA8976B416C(uParam0, 1)) };
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_196(uParam0->f_28[0]))
			{
				...
				uLocal_94 = unk_0x8383F9C605E523B7(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				unk_0xD0E12C501EE26329(uLocal_94, 1);
				unk_0x8E628F774C748D93(uParam0->f_28[0], uLocal_94, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
void func_280(int iParam0, bool bParam1)
{
	...
	if (unk_0xA6DECE14FC9A8C51(uLocal_264))
	{
		unk_0xE30CF11C0EE14316(&uLocal_264);
	}
