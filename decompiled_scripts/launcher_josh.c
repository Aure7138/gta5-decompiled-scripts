...
void func_197()
{
	...
	{
		case 0:
			if ((unk_0x1DD05E817C89C737() - iLocal_262) > 100 && bLocal_263 == 0)
			{
				iLocal_96 = 1;
			}
			break;
...
int func_211(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_210(unk_0x4A8C381C258A124D()) && func_210(iParam0->f_28[0])) && !func_150()) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam8) && func_222(unk_0x4A8C381C258A124D(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_240(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var3 = { func_242(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
