				...
				case 2:
					if (!unk_0x3EBB66F936A3436E())
					{
						...
						if (func_309(Local_96.f_35[0]))
						{
							...
							if (func_309(Local_96.f_28[0]))
							{
								unk_0xD3D9D7C84656DAE5(Local_96.f_28[0], joaat("player"));
							...
							if (func_309(Local_96.f_28[1]))
							{
								unk_0xD3D9D7C84656DAE5(Local_96.f_28[1], joaat("player"));
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_278(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
