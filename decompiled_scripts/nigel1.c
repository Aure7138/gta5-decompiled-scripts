				...
				case 2:
					if (!unk_0x2CA4B93E310C1860())
					{
						...
						if (func_309(Local_96.f_35[0]))
						{
							...
							if (func_309(Local_96.f_28[0]))
							{
								unk_0x2271ED1E65FB75EE(Local_96.f_28[0], joaat("player"));
							...
							if (func_309(Local_96.f_28[1]))
							{
								unk_0x2271ED1E65FB75EE(Local_96.f_28[1], joaat("player"));
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_278(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
