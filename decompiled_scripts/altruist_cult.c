...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (unk_0xA80721FDC3BDCCDB() || iLocal_173)
		{
			...
			switch (iLocal_50)
			{
				...
				case 4:
					...
					{
						if (unk_0xBC2FC12AD0FBF72E(iLocal_196[iVar0]))
						{
							if (unk_0xE38E3CF1625A4145(uLocal_229[iVar0]))
							{
								unk_0x1ABDB383C83A336A(&(uLocal_229[iVar0]));
							}
						}
						else
						{
							if (unk_0x181998D7D100C503(iLocal_196[iVar0]))
							{
								if (unk_0xE38E3CF1625A4145(uLocal_229[iVar0]))
								{
									unk_0x1ABDB383C83A336A(&(uLocal_229[iVar0]));
							...
							else if (unk_0x335C0645074963FE(iLocal_196[iVar0], unk_0x33CD235DF1E6A94E(), 30f, 30f, 30f, 0, 1, 0))
							{
								if (!func_108())
								{
									if (iLocal_191 < unk_0xE3903F59E2F22150())
									{
										...
										iLocal_191 = (unk_0xE3903F59E2F22150() + unk_0x9EC3B269A34A2BEE(4500, 6000));
									}
								}
							}
							bLocal_175 = true;
				...
				case 3:
					...
					{
						uLocal_249 = func_60();
						if (!unk_0x11AE7F6A404414C9(uLocal_249))
						{
							break;
						}
					...
					{
						iLocal_190 = 0;
						unk_0xCEE359851F3C8198(uLocal_410);
						unk_0x74CCCCFC496FBDC7(uLocal_248);
						iVar0 = 0;
						while (iVar0 < iLocal_196)
						{
							if (unk_0x765F6FEEFF39224F(iLocal_196[iVar0]))
							{
								unk_0x4B8B69DAE5BAC592(&(iLocal_196[iVar0]));
							}
							iVar0++;
						}
						iVar0 = 0;
						...
						{
							if (unk_0x765F6FEEFF39224F(iLocal_221[iVar0]))
							{
								unk_0xEC26F4BFC9942A0C(&(iLocal_221[iVar0]));
							}
							iVar0++;
						}
						if (unk_0x117DAF3BF7232886(uLocal_246))
						{
							unk_0x189377BFBDC9127F(uLocal_246, 0);
						}
						if (unk_0x765F6FEEFF39224F(uLocal_215))
						{
							unk_0xEC26F4BFC9942A0C(&uLocal_215);
						}
						if (unk_0x765F6FEEFF39224F(uLocal_215))
						{
							unk_0xEC26F4BFC9942A0C(&uLocal_215);
...
int func_31(var uParam0, var uParam1, var uParam2, char* sParam3, var uParam4, int iParam5, int iParam6, bool bParam7, float fParam8, bool bParam9)
{
	switch (*uParam1)
	{
		...
		case 1:
			...
			unk_0xFA6BEE2B1507FF1E(uParam2);
...
{
	uParam0->f_1 = (func_34(unk_0x0E4018692D92041D(*uParam0, 4)) - fParam1);
...
void func_36(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	unk_0x58355301CBA19400();
	unk_0x5C58D0ADA22491FA(uParam2);
...
void func_61()
{
	if (!iLocal_176)
	{
		...
		uLocal_399 = unk_0x199B24FF79A52CCF("MIDSIZED_MESSAGE");
		func_96(1);
		while (!unk_0x11AE7F6A404414C9(uLocal_399))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		unk_0xBB698266C5FDF0A7(uLocal_399, "SHOW_SHARD_MIDSIZED_MESSAGE");
		func_50("CULT_PASS");
		unk_0x614EE52A69097A4C();
		while (!func_95())
		{
	...
	unk_0xFF524AE40FB6301A(uLocal_399, 255, 255, 255, 255, 0);
	if (!iLocal_178)
	{
		if (unk_0x83666F9FB8FEBD4B() > 9500)
		{
			unk_0xBB698266C5FDF0A7(uLocal_399, "SHARD_ANIM_OUT");
			unk_0x4D9DA18AB3C2A466(1);
	...
	{
		if (unk_0x11AE7F6A404414C9(uLocal_399))
		{
			unk_0x83A1D480DB0B52CC(&uLocal_399);
			func_96(0);
		}
		while (unk_0x16E00F066AFFEA0D(func_93(unk_0x95B959F18401C09A()), Local_117, 1) < 209f && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		func_62(18);
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_72(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
...
void func_109()
{
	...
	switch (iLocal_190)
	{
		case 0:
			...
			unk_0xB815670C37E03CDE(joaat("prop_box_wood03a"));
			unk_0xB815670C37E03CDE(joaat("prop_box_wood04a"));
			unk_0xB815670C37E03CDE(joaat("prop_box_wood05a"));
			unk_0xB815670C37E03CDE(joaat("prop_security_case_01"));
			while ((((((!func_136() || !unk_0x5D98D654CDC2165A(joaat("a_m_o_acult_02"))) || !unk_0x5D98D654CDC2165A(joaat("a_m_y_acult_02"))) || !unk_0x5D98D654CDC2165A(joaat("prop_box_wood03a"))) || !unk_0x5D98D654CDC2165A(joaat("prop_box_wood04a"))) || !unk_0x5D98D654CDC2165A(joaat("prop_box_wood05a"))) || !unk_0x5D98D654CDC2165A(joaat("prop_security_case_01")))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			uLocal_576 = func_129(unk_0x33CD235DF1E6A94E(), joaat("weapon_assaultrifle"), 1, 0, 0, 0, 0, 0, 0);
			if (unk_0x765F6FEEFF39224F(uLocal_576))
			{
				unk_0xEF6624A3AFF02A02(iLocal_576, "Trevors_weapon", 0, 0, 0);
			}
			...
			if (func_136() && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
			{
				...
				unk_0xEF6624A3AFF02A02(iLocal_196[11], "Cult_Master", 2, joaat("a_m_o_acult_02"), 0);
				unk_0xEF6624A3AFF02A02(iLocal_196[12], "Rear_Cult", 2, joaat("a_m_o_acult_02"), 0);
				unk_0xEF6624A3AFF02A02(iLocal_196[13], "Left_Old_Cult", 2, joaat("a_m_o_acult_02"), 0);
				unk_0xEF6624A3AFF02A02(iLocal_196[14], "Carbine_Cult", 2, joaat("a_m_y_acult_02"), 0);
				unk_0xEF6624A3AFF02A02(iLocal_196[15], "Shotgun_Cult", 2, joaat("a_m_y_acult_02"), 0);
			...
			if (unk_0x765F6FEEFF39224F(iLocal_196[0]))
			{
				unk_0x4B8B69DAE5BAC592(&(iLocal_196[0]));
			}
			if (unk_0x765F6FEEFF39224F(iLocal_196[1]))
			{
				unk_0x4B8B69DAE5BAC592(&(iLocal_196[1]));
			}
			if (unk_0x117DAF3BF7232886(uLocal_246))
			{
				unk_0x189377BFBDC9127F(uLocal_246, 0);
			...
			if (unk_0x765F6FEEFF39224F(uLocal_215))
			{
				unk_0xEC26F4BFC9942A0C(&iLocal_215);
			}
			if (unk_0x765F6FEEFF39224F(iLocal_215))
			{
				unk_0xEC26F4BFC9942A0C(&iLocal_215);
			}
			unk_0x63F0B040CE6EDF0F(0, 0, 3000, 1, 0, 0);
			if (unk_0xE38E3CF1625A4145(uLocal_228))
			{
				unk_0x1ABDB383C83A336A(&uLocal_228);
			}
			func_21(1, 1, 1, 0, 0, 0);
			unk_0x3449EA232F9B8EAD(unk_0x95B959F18401C09A(), 0, 0);
			unk_0xEDF90B96BED57BCE(1);
			...
			unk_0xCE04CE961AF41AB9(Local_117, 100f, 1, 0, 0, 0);
			unk_0x0335D8135051EA56(Local_117 - Vector(100f, 60f, 80f), Local_117 + Vector(100f, 60f, 80f), 0, 1, 1, 1);
			unk_0x4B06B5746CBEC99F(0f);
			unk_0xA53C1C92EE35EC0E(3, 0);
			unk_0xA53C1C92EE35EC0E(5, 0);
			uLocal_248 = unk_0xD911392442636B60(-1173.509f, 4924.365f, 222.21f, 277.2293f, 2, 0, 2, 1);
		...
		case 6:
			if (unk_0x2442598EA366437F(0))
			{
				...
				{
					if (!unk_0x765F6FEEFF39224F(iLocal_196[11]))
					{
						iLocal_196[11] = unk_0x22B02EC53152632C(unk_0x0DBE02F22EF4C0B4("CULT_MASTER", 0));
					}
				}
				if (unk_0x3CA08F647CEAD042("REAR_CULT", 0))
				{
					if (!unk_0x765F6FEEFF39224F(iLocal_196[12]))
					{
						iLocal_196[12] = unk_0x22B02EC53152632C(unk_0x0DBE02F22EF4C0B4("REAR_CULT", 0));
					}
				}
				if (unk_0x3CA08F647CEAD042("LEFT_OLD_CULT", 0))
				{
					if (!unk_0x765F6FEEFF39224F(iLocal_196[13]))
					{
						iLocal_196[13] = unk_0x22B02EC53152632C(unk_0x0DBE02F22EF4C0B4("LEFT_OLD_CULT", 0));
					}
				}
				if (unk_0x3CA08F647CEAD042("CARBINE_CULT", 0))
				{
					if (!unk_0x765F6FEEFF39224F(iLocal_196[14]))
					{
						iLocal_196[14] = unk_0x22B02EC53152632C(unk_0x0DBE02F22EF4C0B4("CARBINE_CULT", 0));
					}
				}
				if (unk_0x3CA08F647CEAD042("SHOTGUN_CULT", 0))
				{
					if (!unk_0x765F6FEEFF39224F(iLocal_196[15]))
					{
						iLocal_196[15] = unk_0x22B02EC53152632C(unk_0x0DBE02F22EF4C0B4("SHOTGUN_CULT", 0));
					}
				}
				if (unk_0x3CA08F647CEAD042("TREVOR", 0))
				{
					...
					unk_0x7CF15CBDDF414EF0(unk_0x33CD235DF1E6A94E(), -1173.509f, 4924.365f, 222.21f, -1, 0, 0f, 1, 0, uLocal_248, 0);
					unk_0x880B00F3FAE4C022(unk_0x33CD235DF1E6A94E(), 1, 0);
				}
				if (unk_0x3CA08F647CEAD042("Trevors_weapon", 0))
				{
					unk_0x63B8AF155FC68CD7(iLocal_576, unk_0x33CD235DF1E6A94E());
				}
				...
				unk_0x9315FCF6CFE2AB41("rghCult", &uLocal_410);
				iVar1 = 0;
				while (iVar1 < iLocal_196)
				{
					if (((iVar1 == 0 || iVar1 == 5) || iVar1 == 6) || iVar1 == 10)
					{
						iLocal_196[iVar1] = unk_0x9BA5CF280376EEA4(26, joaat("a_m_o_acult_01"), Local_51[iVar1 /*3*/], fLocal_100[iVar1], 1, 1);
						unk_0xC475906893AEB995(iLocal_196[iVar1], 0);
						unk_0x697EBA5CF1A6AB57(iLocal_196[iVar1], joaat("weapon_assaultrifle"), -1, 1, 1);
						unk_0x34A51926277F67BC(iLocal_196[iVar1], 0);
						unk_0x52F5AAAD4824B17E(iLocal_196[iVar1], 2);
						unk_0x16D56D398FB73BE7(iLocal_196[iVar1], 50f, 20);
						unk_0xDE9FF07CFD5DC172(iLocal_196[iVar1], 5);
						unk_0x5F9955D3E93BCC84(iLocal_196[iVar1], 100f);
						unk_0x18E5E2B41CD6CE17(iLocal_196[iVar1], 100f);
						unk_0x7FC2040EB34E0E31(iLocal_196[iVar1], 150, 0);
						unk_0x41AAD0031D053A00(iLocal_196[iVar1], unk_0x9EC3B269A34A2BEE(40, 60));
						unk_0x277716E9E7CC0692(iLocal_196[iVar1], unk_0x33CD235DF1E6A94E(), 0, 16);
					}
					else if (iVar1 == 2)
					{
						iLocal_196[iVar1] = unk_0x9BA5CF280376EEA4(26, joaat("a_m_o_acult_02"), Local_51[iVar1 /*3*/], fLocal_100[iVar1], 1, 1);
						unk_0xC475906893AEB995(iLocal_196[iVar1], 0);
						unk_0x697EBA5CF1A6AB57(iLocal_196[iVar1], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
						unk_0x28F648743D7DE312(iLocal_196[iVar1], 50, 1);
						unk_0x34A51926277F67BC(iLocal_196[iVar1], 2);
						unk_0x52F5AAAD4824B17E(iLocal_196[iVar1], 1);
						unk_0x16D56D398FB73BE7(iLocal_196[iVar1], 50f, 20);
						unk_0xDE9FF07CFD5DC172(iLocal_196[iVar1], 5);
						unk_0x5F9955D3E93BCC84(iLocal_196[iVar1], 100f);
						unk_0x18E5E2B41CD6CE17(iLocal_196[iVar1], 100f);
					...
					{
						if (((((!unk_0xBC2FC12AD0FBF72E(iLocal_196[iVar1]) && !unk_0xBC2FC12AD0FBF72E(iLocal_196[11])) && !unk_0xBC2FC12AD0FBF72E(iLocal_196[12])) && !unk_0xBC2FC12AD0FBF72E(iLocal_196[13])) && !unk_0xBC2FC12AD0FBF72E(iLocal_196[14])) && !unk_0xBC2FC12AD0FBF72E(iLocal_196[15]))
						{
							unk_0x697EBA5CF1A6AB57(iLocal_196[11], joaat("weapon_pistol"), -1, 1, 1);
							unk_0x697EBA5CF1A6AB57(iLocal_196[12], joaat("weapon_assaultrifle"), -1, 1, 1);
							unk_0x697EBA5CF1A6AB57(iLocal_196[13], joaat("weapon_assaultrifle"), -1, 1, 1);
							unk_0x697EBA5CF1A6AB57(iLocal_196[14], joaat("weapon_carbinerifle"), -1, 1, 1);
							unk_0x697EBA5CF1A6AB57(iLocal_196[15], joaat("weapon_pumpshotgun"), -1, 1, 1);
							unk_0x28F648743D7DE312(iLocal_196[iVar1], 0, 1);
							unk_0x34A51926277F67BC(iLocal_196[iVar1], 3);
							unk_0x52F5AAAD4824B17E(iLocal_196[iVar1], 0);
							unk_0xDE9FF07CFD5DC172(iLocal_196[iVar1], 0);
							unk_0xE53211B793893FFD(iLocal_196[iVar1], 1f, 1f);
							unk_0x99414FB2D30425C1(&uLocal_247);
							unk_0x1E6D9DB41BEDAFB3(0, -1159.33f, 4924.412f, 221.6576f, unk_0x33CD235DF1E6A94E(), 2f, 1, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
							...
							unk_0xC734F59A13D39AEF(uLocal_247);
							unk_0x13A2D602CD10CBAC(iLocal_196[15], uLocal_247);
							unk_0xA7A57E7757ED035E(&uLocal_247);
							unk_0x99414FB2D30425C1(&uLocal_247);
							unk_0x1E6D9DB41BEDAFB3(0, -1163.279f, 4932.933f, 222.541f, unk_0x33CD235DF1E6A94E(), 1f, 1, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
							unk_0xB37A0BA7D41EA5E1(0, unk_0x33CD235DF1E6A94E(), 5000, 0);
							unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), 7500, 0);
							unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), 4500, 0);
							unk_0x277716E9E7CC0692(0, unk_0x33CD235DF1E6A94E(), 0, 16);
							unk_0xC734F59A13D39AEF(uLocal_247);
							unk_0x13A2D602CD10CBAC(iLocal_196[14], uLocal_247);
							unk_0xA7A57E7757ED035E(&uLocal_247);
							unk_0x99414FB2D30425C1(&uLocal_247);
							unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), 2500, 0);
							unk_0xB37A0BA7D41EA5E1(0, unk_0x33CD235DF1E6A94E(), 5000, 0);
							unk_0x1E6D9DB41BEDAFB3(0, -1156.175f, 4926.073f, 221.3447f, unk_0x33CD235DF1E6A94E(), 2f, 1, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
							unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), 6500, 0);
							unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), 4500, 0);
							unk_0x277716E9E7CC0692(0, unk_0x33CD235DF1E6A94E(), 0, 16);
							unk_0xC734F59A13D39AEF(uLocal_247);
							unk_0x13A2D602CD10CBAC(iLocal_196[13], uLocal_247);
							unk_0xA7A57E7757ED035E(&uLocal_247);
							unk_0x99414FB2D30425C1(&uLocal_247);
							unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), 3000, 0);
							unk_0x1E6D9DB41BEDAFB3(0, -1157.962f, 4922.196f, 221.309f, unk_0x33CD235DF1E6A94E(), 2f, 1, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
							unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), 5500, 0);
							unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), 4500, 0);
							unk_0x277716E9E7CC0692(0, unk_0x33CD235DF1E6A94E(), 0, 16);
							unk_0xC734F59A13D39AEF(uLocal_247);
							unk_0x13A2D602CD10CBAC(iLocal_196[12], uLocal_247);
							unk_0xA7A57E7757ED035E(&uLocal_247);
							unk_0x99414FB2D30425C1(&uLocal_247);
							unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), 4500, 0);
							unk_0xB37A0BA7D41EA5E1(0, unk_0x33CD235DF1E6A94E(), 10000, 0);
							unk_0x1E6D9DB41BEDAFB3(0, -1161.475f, 4916.061f, 220.5658f, unk_0x33CD235DF1E6A94E(), 2f, 1, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
							unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), 4500, 0);
							unk_0x4DDF5809B68AA635(0, unk_0x33CD235DF1E6A94E(), 4500, 0);
							unk_0x277716E9E7CC0692(0, unk_0x33CD235DF1E6A94E(), 0, 16);
							unk_0xC734F59A13D39AEF(uLocal_247);
							unk_0x13A2D602CD10CBAC(iLocal_196[11], uLocal_247);
							unk_0xA7A57E7757ED035E(&uLocal_247);
							unk_0x897EF720254BBEA3(iLocal_196[iVar1], 1);
							unk_0x41E36A540F8F323F(iLocal_196[iVar1], 156, 1);
						}
					}
					else
					{
						iLocal_196[iVar1] = unk_0x9BA5CF280376EEA4(26, joaat("a_m_o_acult_02"), Local_51[iVar1 /*3*/], fLocal_100[iVar1], 1, 1);
						unk_0xC475906893AEB995(iLocal_196[iVar1], 0);
						unk_0x697EBA5CF1A6AB57(iLocal_196[iVar1], joaat("weapon_pistol"), -1, 1, 1);
						unk_0x28F648743D7DE312(iLocal_196[iVar1], 50, 1);
						unk_0x34A51926277F67BC(iLocal_196[iVar1], 2);
						unk_0x52F5AAAD4824B17E(iLocal_196[iVar1], 0);
						unk_0x16D56D398FB73BE7(iLocal_196[iVar1], 50f, 20);
						unk_0x1E0350F1D7702D6A(iLocal_196[iVar1], 1);
						unk_0xDE9FF07CFD5DC172(iLocal_196[iVar1], 5);
						unk_0x5F9955D3E93BCC84(iLocal_196[iVar1], 100f);
						unk_0x18E5E2B41CD6CE17(iLocal_196[iVar1], 100f);
						unk_0x41AAD0031D053A00(iLocal_196[iVar1], unk_0x9EC3B269A34A2BEE(40, 60));
					...
					unk_0x0648A75D3F60E864(iLocal_196[iVar1], uLocal_410);
					unk_0x3C990C409B3845DE(iLocal_196[iVar1], func_127(unk_0xFBB1F99A825CAB09(iLocal_196[iVar1], 1), func_93(unk_0x95B959F18401C09A())));
					unk_0x4A852F02088ECC9D(iLocal_196[iVar1], 1);
					unk_0x5FEE418CE11E6DDE(iLocal_196[iVar1], 42, 1);
					uLocal_229[iVar1] = func_125(iLocal_196[iVar1], 1, 145);
					iVar1++;
				}
				func_97(&uLocal_411, 0, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
				...
				if (!bLocal_172)
				{
					uLocal_216[0] = unk_0x3B3AEF3A73FB80C9(joaat("pickup_money_case"), -1074.165f, 4897.468f, 213.2754f, -72f, 0f, 42.48f, iVar0, 25000, 2, 1, joaat("prop_security_case_01"));
					uLocal_216[1] = unk_0x3B3AEF3A73FB80C9(joaat("pickup_money_case"), -1094.671f, 4892.789f, 215.0707f, -72f, 0f, 42.48f, iVar0, 25000, 2, 1, joaat("prop_security_case_01"));
					uLocal_216[2] = unk_0x3B3AEF3A73FB80C9(joaat("pickup_money_case"), -1113.95f, 4904.385f, 217.6001f, -72f, 0f, 42.48f, iVar0, 25000, 2, 1, joaat("prop_security_case_01"));
					uLocal_216[3] = unk_0x3B3AEF3A73FB80C9(joaat("pickup_money_case"), -1145.273f, 4907.894f, 219.9734f, -72f, 0f, 42.48f, iVar0, 25000, 2, 1, joaat("prop_security_case_01"));
				}
				uLocal_216[0] = uLocal_216[0];
				uLocal_216[1] = uLocal_216[1];
				uLocal_216[2] = uLocal_216[2];
				uLocal_216[3] = uLocal_216[3];
				iLocal_221[0] = unk_0x7CA67831169E8AA6(joaat("prop_box_wood04a"), -1158.69f, 4915.709f, 220.2644f, 1, 1, 0);
				iLocal_221[1] = unk_0x7CA67831169E8AA6(joaat("prop_box_wood03a"), -1156.246f, 4918.6f, 220.5432f, 1, 1, 0);
				iLocal_221[2] = unk_0x7CA67831169E8AA6(joaat("prop_box_wood04a"), -1145.802f, 4931.816f, 219.9683f, 1, 1, 0);
				iLocal_221[3] = unk_0x7CA67831169E8AA6(joaat("prop_box_wood04a"), -1133.369f, 4919.067f, 218.8385f, 1, 1, 0);
				iLocal_221[4] = unk_0x7CA67831169E8AA6(joaat("prop_box_wood05a"), -1132.025f, 4921.483f, 218.8244f, 1, 1, 0);
				iLocal_221[5] = unk_0x7CA67831169E8AA6(joaat("prop_box_wood03a"), -1112.66f, 4929.268f, 217.1752f, 1, 1, 0);
				unk_0x1C8705F667F673EA(iLocal_221[0], 12.24288f, -0.014582f, 27.06056f, 2, 1);
				unk_0x1C8705F667F673EA(iLocal_221[1], 7.733739f, 9.432779f, -2.865618f, 2, 1);
				unk_0x1C8705F667F673EA(iLocal_221[2], 3.735082f, 4.551246f, 86.30917f, 2, 1);
				unk_0x1C8705F667F673EA(iLocal_221[3], 0.240341f, 1.095195f, 36.59031f, 2, 1);
				unk_0x1C8705F667F673EA(iLocal_221[4], 7.6772f, 1.232743f, 93.27483f, 2, 1);
				unk_0x1C8705F667F673EA(iLocal_221[5], 3.367802f, -5.14387f, 97.30567f, 2, 1);
				if (func_124() < 50)
				{
...
int func_126(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xCE5C49921A521962(uVar0, func_39(unk_0xB331FCEB94EB05C8(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xCE5C49921A521962(uVar0, func_39(unk_0xB331FCEB94EB05C8(), 0.7f, 0.7f));
		unk_0xBF11C8A43770C598(uVar0, bParam1);
	}
...
int func_129(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	Var5 = { unk_0xFBB1F99A825CAB09(iParam0, 0) - Vector(10f, 0f, 0f) };
	if (bParam3)
	{
	...
	while (func_133(iVar2, iVar8) != 0)
	{
		if (!unk_0xD62C4419A41F106A(iParam0, 0))
		{
			if (unk_0xCC2C88B9353CAF70(iParam0, iVar2, func_133(iVar2, iVar8)))
			{
				if (func_132(func_133(iVar2, iVar8)))
				{
					iVar9 = unk_0x70418C66CB4C3F79(func_133(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	}
	uVar1 = unk_0x99D60D17E2820498(iVar2, iVar3, Var5, iVar0, 1065353216, iVar9, iParam7, iParam8);
	while (func_133(iVar2, iVar8) != 0)
	{
		if (!unk_0xD62C4419A41F106A(iParam0, 0))
		{
			if (unk_0xCC2C88B9353CAF70(iParam0, iVar2, func_133(iVar2, iVar8)))
			{
				unk_0x062CA5B6A29665F1(uVar1, func_133(iVar2, iVar8));
	...
	if (!unk_0xD62C4419A41F106A(iParam0, 0))
	{
		...
		{
			unk_0xA0DDB8AAFD50ADBA(uVar1, unk_0x4A37FD3869B2D716(iParam0, iVar2));
		}
	}
	return uVar1;
}
...
void func_130(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0)
	{
		unk_0x062CA5B6A29665F1(uParam0, iVar0);
	}
}
...
void func_150()
{
	if (fLocal_183 > 0f)
	{
		fLocal_183 = (fLocal_183 - (0.6f / (1f / unk_0x7C475FA8D877007F())));
	}
	else
	{
		fLocal_183 = 0f;
	...
	if (fLocal_183 >= 0f)
	{
		unk_0x1ABC36611CBE0E84(Global_35548[10 /*31*/], fLocal_183, 0, 1);
		unk_0x046ED2CF120C8949(Global_35548[10 /*31*/], 4, 0, 1);
	}
	if (fLocal_182 < 0f)
	{
		fLocal_182 = (fLocal_182 + (0.6f / (1f / unk_0x7C475FA8D877007F())));
	}
	else
	{
		fLocal_182 = 0f;
	...
	if (fLocal_182 <= 0f)
	{
		unk_0x1ABC36611CBE0E84(Global_35548[9 /*31*/], fLocal_182, 0, 1);
	...
	switch (iLocal_189)
	{
		case 0:
			...
			if ((((unk_0x5D98D654CDC2165A(joaat("a_m_o_acult_02")) && unk_0x5D98D654CDC2165A(joaat("prop_anim_cash_pile_02"))) && unk_0xE9CCF312047EBEE0("random@altruist_cult")) && unk_0x7E2EAC500C9B54E3("AC_DELIVERED")) && unk_0x045F471986387527(joaat("weapon_assaultrifle")))
			{
				...
				if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
				{
					uLocal_213 = unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0);
					if (unk_0x91D5C8283D19AF49(uLocal_213, 0))
					{
						if (unk_0x61DFE32FB87BC784(uLocal_213))
						{
							iLocal_189++;
						}
					}
				...
				{
					uLocal_213 = unk_0x8918EC905FC8975D();
					if (!unk_0xBC2FC12AD0FBF72E(uLocal_193[0]) && !unk_0xBC2FC12AD0FBF72E(uLocal_193[1]))
					{
						unk_0xED68CDDDE25A144E(uLocal_193[0]);
						unk_0x5D94F4D6FE7DA516(uLocal_193[0]);
						unk_0xED68CDDDE25A144E(uLocal_193[1]);
						unk_0x5D94F4D6FE7DA516(uLocal_193[1]);
					}
					iLocal_189++;
				}
			}
		...
		case 1:
			if (unk_0x765F6FEEFF39224F(uLocal_213))
			{
				if (!unk_0x5A04E3BD0B5E7E49(iLocal_213))
				{
					unk_0x0D21E1FDE062ED99(iLocal_213, 1, 0);
				}
				if (unk_0x18FB647D79B09657(iLocal_213, Local_120, 13f, 13f, 13f, 0, 1, 0))
				{
					unk_0xBEADAF07D2339505(iLocal_213, -1028.415f, 4924.863f, 205.9386f, 0, 0, 0, 1);
					if (!unk_0xD62C4419A41F106A(iLocal_213, 0))
					{
						unk_0x3C990C409B3845DE(iLocal_213, 149.8882f);
						unk_0x1B2303F9DC2D90D5(iLocal_213, 1084227584);
					}
				}
			}
			unk_0xCE04CE961AF41AB9(Local_120, 12f, 1, 0, 0, 0);
			...
			if (!unk_0xBC2FC12AD0FBF72E(uLocal_193[0]) && !unk_0xBC2FC12AD0FBF72E(uLocal_193[1]))
			{
				unk_0xBEADAF07D2339505(uLocal_193[0], Vector(205.5761f, 4915.152f, -1035.625f) - Vector(0f, 0f, 1f), 1, 0, 0, 1);
				unk_0x3C990C409B3845DE(uLocal_193[0], 128.2065f);
				unk_0xBEADAF07D2339505(uLocal_193[1], Vector(205.5761f, 4915.152f, -1035.625f) - Vector(0f, 1f, 0f), 1, 0, 0, 1);
				unk_0x3C990C409B3845DE(uLocal_193[1], 128.2065f);
			}
			iLocal_196[0] = unk_0x9BA5CF280376EEA4(26, joaat("a_m_o_acult_02"), -1042.56f, 4913.516f, 207.0988f, 282.4169f, 1, 1);
			func_97(&uLocal_411, 1, iLocal_196[0], "ACULTMember1", 0, 1);
			if (Global_106565.f_24989.f_5 >= 2)
			{
				iLocal_196[1] = unk_0x9BA5CF280376EEA4(26, joaat("a_m_o_acult_02"), -1041.757f, 4908.49f, 207.2777f, 305.3168f, 1, 1);
			...
			unk_0x4A852F02088ECC9D(iLocal_196[0], 1);
			iLocal_215 = unk_0x99D60D17E2820498(joaat("weapon_assaultrifle"), -1, unk_0xFBB1F99A825CAB09(iLocal_196[0], 1), 1, 1065353216, 0, 0, 1);
			unk_0x2F0A6390D863D337(iLocal_215, iLocal_196[0], unk_0xFCAF61876D23D31D(iLocal_196[0], 60309), 0.12f, 0.028f, -0.003f, -82.208f, -7.06f, -8.038f, 0, 0, 0, 0, 2, 1);
			if (Global_106565.f_24989.f_5 < 2)
			{
				uLocal_214 = unk_0x7CA67831169E8AA6(joaat("prop_anim_cash_pile_02"), Local_117, 1, 1, 0);
				unk_0x2F0A6390D863D337(uLocal_214, unk_0x33CD235DF1E6A94E(), unk_0xFCAF61876D23D31D(unk_0x33CD235DF1E6A94E(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			}
			else if (Global_106565.f_24989.f_5 >= 2)
			{
				unk_0x697EBA5CF1A6AB57(iLocal_196[1], joaat("weapon_assaultrifle"), -1, 1, 1);
			}
			uLocal_246 = unk_0x00E62F31D05EB2AC("DEFAULT_ANIMATED_CAMERA", 1);
			uLocal_188 = unk_0x38A6890195DD00D1(-1044.636f, 4915.204f, 212.32f, 0f, 0f, 110.52f, 2);
			unk_0x08798CBF817BA887(unk_0x33CD235DF1E6A94E(), uLocal_188, "random@altruist_cult", sLocal_405, 1000f, -2f, 4, 0, 1148846080, 0);
			unk_0x08798CBF817BA887(iLocal_196[0], uLocal_188, "random@altruist_cult", sLocal_403, 1000f, -2f, 4, 0, 1148846080, 0);
			if (Global_106565.f_24989.f_5 >= 2)
			{
				unk_0x08798CBF817BA887(iLocal_196[1], uLocal_188, "random@altruist_cult", sLocal_404, 1000f, -2f, 4, 0, 1148846080, 0);
			}
			unk_0x76909D790DDFDCE9(uLocal_246, uLocal_188, sLocal_408, "random@altruist_cult");
			unk_0x63F0B040CE6EDF0F(1, 0, 3000, 1, 0, 0);
			if (!unk_0xBC2FC12AD0FBF72E(uLocal_193[0]) && !unk_0xBC2FC12AD0FBF72E(uLocal_193[1]))
			{
				unk_0x08798CBF817BA887(uLocal_193[0], uLocal_188, "random@altruist_cult", sLocal_406, 1000f, -2f, 4, 0, 1148846080, 0);
				unk_0x08798CBF817BA887(uLocal_193[1], uLocal_188, "random@altruist_cult", sLocal_407, 1000f, -2f, 4, 0, 1148846080, 0);
			}
			iLocal_189++;
			break;
		
		case 2:
			if (!unk_0xBC2FC12AD0FBF72E(uLocal_193[0]))
			{
				if (unk_0x28C4F998CC33B00F(uLocal_193[0]))
				{
			...
			if (!unk_0xBC2FC12AD0FBF72E(uLocal_193[1]))
			{
				if (unk_0x28C4F998CC33B00F(uLocal_193[1]))
				{
			...
			if (unk_0x4EDDCE9AAE0FC976(uLocal_188) > fLocal_185)
			{
				iLocal_189++;
			}
			break;
		...
		case 3:
			...
			if (unk_0x4EDDCE9AAE0FC976(uLocal_188) > fLocal_184)
			{
				iLocal_189++;
			}
			break;
		...
		case 4:
			if (Global_106565.f_24989.f_5 < 2)
			{
				...
				if (unk_0x765F6FEEFF39224F(iLocal_214))
				{
					unk_0xEC26F4BFC9942A0C(&iLocal_214);
				}
				if (unk_0x765F6FEEFF39224F(iLocal_215))
				{
					unk_0xEC26F4BFC9942A0C(&iLocal_215);
	...
	switch (iLocal_189)
	{
		case 0:
			...
			if ((((unk_0x5D98D654CDC2165A(joaat("a_m_o_acult_02")) && unk_0x5D98D654CDC2165A(joaat("prop_anim_cash_pile_02"))) && unk_0xE9CCF312047EBEE0("random@altruist_cult")) && unk_0x7E2EAC500C9B54E3("AC_DELIVERED")) && unk_0x045F471986387527(joaat("weapon_assaultrifle")))
			{
				...
				if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
				{
					iLocal_213 = unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0);
					if (unk_0x91D5C8283D19AF49(iLocal_213, 0))
					{
						if (unk_0x61DFE32FB87BC784(iLocal_213))
						{
							iLocal_189++;
						}
					}
				...
				{
					iLocal_213 = unk_0x8918EC905FC8975D();
					if (!unk_0xBC2FC12AD0FBF72E(uLocal_193[0]))
					{
						unk_0xED68CDDDE25A144E(uLocal_193[0]);
						unk_0x5D94F4D6FE7DA516(uLocal_193[0]);
		...
		case 1:
			if (unk_0x765F6FEEFF39224F(iLocal_213))
			{
				if (!unk_0x5A04E3BD0B5E7E49(iLocal_213))
				{
					unk_0x0D21E1FDE062ED99(iLocal_213, 1, 0);
			...
			unk_0x5AE11BC36633DE4E(0);
			unk_0x4A852F02088ECC9D(iLocal_196[0], 1);
			iLocal_214 = unk_0x7CA67831169E8AA6(joaat("prop_anim_cash_pile_02"), Local_117, 1, 1, 0);
			iLocal_215 = unk_0x99D60D17E2820498(joaat("weapon_assaultrifle"), -1, unk_0xFBB1F99A825CAB09(iLocal_196[0], 1), 1, 1065353216, 0, 0, 1);
			unk_0x2F0A6390D863D337(iLocal_215, iLocal_196[0], unk_0xFCAF61876D23D31D(iLocal_196[0], 60309), 0.12f, 0.028f, -0.003f, -82.208f, -7.06f, -8.038f, 0, 0, 0, 0, 2, 1);
			if (Global_106565.f_24989.f_5 < 3)
			{
				if (Global_106565.f_24989.f_5 == 0)
				{
					unk_0x2F0A6390D863D337(iLocal_214, unk_0x33CD235DF1E6A94E(), unk_0xFCAF61876D23D31D(unk_0x33CD235DF1E6A94E(), 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					unk_0x2F0A6390D863D337(iLocal_214, unk_0x33CD235DF1E6A94E(), unk_0xFCAF61876D23D31D(unk_0x33CD235DF1E6A94E(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
				}
			}
			else if (Global_106565.f_24989.f_5 >= 3)
			{
		...
		case 3:
			...
			if (Global_106565.f_24989.f_5 == 1 || Global_106565.f_24989.f_5 == 2)
			{
				if ((unk_0x4EDDCE9AAE0FC976(uLocal_188) > 0.9742857f && !iLocal_181) && unk_0xB813DCBD5002BC42() == 4)
				{
		...
		case 4:
			if (Global_106565.f_24989.f_5 < 3)
			{
				...
				else
				{
					...
					if (unk_0x765F6FEEFF39224F(iLocal_196[0]))
					{
						unk_0x0CDD28A9DFCE2FCE(iLocal_196[0], 0, 0);
					}
					if (unk_0x765F6FEEFF39224F(iLocal_196[1]))
					{
						unk_0x0CDD28A9DFCE2FCE(iLocal_196[1], 0, 0);
					}
					if (unk_0x765F6FEEFF39224F(uLocal_193[0]))
					{
						unk_0x0CDD28A9DFCE2FCE(uLocal_193[0], 0, 0);
					}
					iLocal_189++;
				}
				if (unk_0x765F6FEEFF39224F(iLocal_214))
				...
				if (unk_0xCE3CFF625BEBAA04(sLocal_408, "cult_p4_cam"))
				{
					unk_0x63F0B040CE6EDF0F(0, 0, 3000, 1, 0, 0);
				}
				else
...
void func_181()
{
	if (func_183())
	{
		if (func_14() == 2)
		{
			...
			{
				unk_0x6E4DFDF8EFB7AD50(func_182(), &uLocal_186, &iLocal_187);
				if (iLocal_187 == 1)
				{
					uLocal_193[0] = unk_0x0C517890387F4AE4(func_182(), 0);
					if (unk_0x18FB647D79B09657(uLocal_193[0], Local_120, 5f, 5f, 5f, 0, 1, 0))
					{
						if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
						{
				...
				{
					uLocal_193[0] = unk_0x0C517890387F4AE4(func_182(), 0);
					uLocal_193[1] = unk_0x0C517890387F4AE4(func_182(), 1);
					if (unk_0x18FB647D79B09657(uLocal_193[0], Local_120, 5f, 5f, 5f, 0, 1, 0) && unk_0x18FB647D79B09657(uLocal_193[1], Local_120, 5f, 5f, 5f, 0, 1, 0))
					{
						if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
						{
							if (!unk_0xD62C4419A41F106A(unk_0x8918EC905FC8975D(), 0))
...
void func_184()
{
	if (func_187())
	{
		if (iLocal_400 == 0)
		{
			iLocal_400 = unk_0x0335D8135051EA56(Local_117 - Vector(100f, 60f, 80f), Local_117 + Vector(100f, 60f, 80f), 0, 1, 1, 1);
		}
		while (unk_0x16E00F066AFFEA0D(func_93(unk_0x95B959F18401C09A()), Local_117, 1) < 209f)
		{
			unk_0x4EDE34FBADD967A6(0);
		}
	}
	...
	{
		if (unk_0x9AA1574E00850065(2017343592, joaat("player")) != 5)
		{
			if (func_186())
			{
				unk_0xD2E80177F27FD43F(5, 2017343592, joaat("player"));
			}
			else if (func_185())
			{
				unk_0xD2E80177F27FD43F(5, 2017343592, joaat("player"));
	...
	else if (func_14() == 2)
	{
		if (unk_0x9AA1574E00850065(2017343592, joaat("player")) != 5)
		{
			...
			else if (unk_0x9AA1574E00850065(2017343592, joaat("player")) != 1)
			{
				unk_0xD2E80177F27FD43F(1, 2017343592, joaat("player"));
			}
		}
	}
	if (func_186())
...
int func_185()
{
	if ((((((unk_0x7E480C68737C0B83(Local_123, Local_126, fLocal_129, 1) || unk_0x7E480C68737C0B83(Local_130, Local_133, fLocal_136, 1)) || unk_0x7E480C68737C0B83(Local_137, Local_140, fLocal_143, 1)) || unk_0x7E480C68737C0B83(Local_144, Local_147, fLocal_150, 1)) || unk_0x7E480C68737C0B83(Local_151, Local_154, fLocal_157, 1)) || unk_0x7E480C68737C0B83(Local_158, Local_161, fLocal_164, 1)) || unk_0x7E480C68737C0B83(Local_165, Local_168, fLocal_171, 1))
	{
		return 1;
	}
	return 0;
...
int func_186()
{
	if ((((((unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_123, Local_126, fLocal_129, 0, 1, 0) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_130, Local_133, fLocal_136, 0, 1, 0)) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_137, Local_140, fLocal_143, 0, 1, 0)) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_144, Local_147, fLocal_150, 0, 1, 0)) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_151, Local_154, fLocal_157, 0, 1, 0)) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_158, Local_161, fLocal_164, 0, 1, 0)) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), Local_165, Local_168, fLocal_171, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
void func_188()
{
	unk_0xD2E80177F27FD43F(255, 2017343592, joaat("player"));
