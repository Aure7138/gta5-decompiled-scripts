...
{
	return unk_0x11BBEE2752B9D0C8(uParam0, 355.6093f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.99947f, 15f, 0, 1, 0);
}
...
int func_70()
{
	if (Global_1595531 != func_58())
	{
		if (unk_0x1D96871229AA29DD("base_corridor_seats", Global_1595531, 1, 0))
		{
			return 0;
		}
