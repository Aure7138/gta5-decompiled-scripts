...
{
	return unk_0x54F6F5A823224519(uParam0, 355.6093f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.99947f, 15f, 0, 1, 0);
}
...
int func_71()
{
	if (Global_1589596 != func_59())
	{
		if (unk_0x653C5F9B95C5F892("base_corridor_seats", Global_1589596, 1, 0))
		{
			return 0;
		}
