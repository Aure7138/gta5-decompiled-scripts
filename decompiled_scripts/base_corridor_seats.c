...
{
	return unk_0x42A24CB7B8A08E11(uParam0, 355.6093f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.99947f, 15f, 0, 1, 0);
}
...
int func_73()
{
	if (Global_1590291 != func_60())
	{
		if (unk_0x09573FC4C0F4DB13("base_corridor_seats", Global_1590291, 1, 0))
		{
			return 0;
		}
