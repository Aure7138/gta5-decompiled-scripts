...
{
	return unk_0xD4B4F68F3449CBEC(uParam0, 355.6093f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.99947f, 15f, 0, 1, 0);
}
...
int func_72()
{
	if (Global_1589667 != func_59())
	{
		if (unk_0x6C7B3B04B7D86C9E("base_corridor_seats", Global_1589667, 1, 0))
		{
			return 0;
		}
