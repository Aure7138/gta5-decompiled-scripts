...
{
	return unk_0x0C265B3C448E6954(uParam0, 355.6093f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.99947f, 15f, 0, 1, 0);
}
...
int func_70()
{
	if (Global_1589140 != func_58())
	{
		if (unk_0x18C4EA3345AA5A99("base_corridor_seats", Global_1589140, 1, 0))
		{
			return 0;
		}
