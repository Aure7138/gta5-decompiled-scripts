...
int func_64()
{
	...
	if (unk_0x987A5F1E1A67E3C0(func_73(unk_0x9E2D6C50374FCFA9()), Global_1946941.f_1010[154 /*3*/], 1) >= 150f)
	{
		return 1;
	}
	if (func_65())
...
int func_74(int iParam0)
{
	if (iParam0 != func_52())
	{
		...
		else if ((Global_1575054 && iParam0 == unk_0x9E2D6C50374FCFA9()) && func_53(iParam0, 1, 0))
		{
			return Global_2689224[iParam0 /*451*/].f_317.f_6 != -1;
		}
	}
