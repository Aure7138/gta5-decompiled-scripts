...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!iLocal_58)
		{
			if (!iLocal_57 && unk_0x8B6A925F148E0E94())
			{
				unk_0x78CDDD1E6367978D(unk_0x7D2B9E6A64637269(), Local_65, 1, 0, 0, 1);
				unk_0xCD37A28258D70638(unk_0x7D2B9E6A64637269(), fLocal_63);
				unk_0x22C43B6780E8FE5B(Local_65, 2500f, 0);
...
int func_1()
{
	if (!unk_0xBB61E4E5DB5BBD9B(uLocal_64, "garage_decor_01"))
	{
		unk_0xEFDEF37B67B5BBF4(uLocal_64, "garage_decor_01");
	}
	else
	{
		unk_0xB15BA3909055E465(uLocal_64);
		return 1;
	}
	return 0;
}
...
int func_2()
{
	uLocal_64 = unk_0xB71084333B418824(unk_0x7D2B9E6A64637269());
	if (unk_0xE75EE67F14EAAE37(uLocal_64))
	{
		if (!iLocal_60)
		{
			unk_0x0EFDA7B3FFAA82B3(uLocal_64);
			iLocal_60 = 1;
		}
		else if (unk_0xC4EACCE45DBAA313(uLocal_64))
		{
			unk_0x8BAFB6B897BD2A31(uLocal_64);
			return 1;
		}
	}
	return 0;
