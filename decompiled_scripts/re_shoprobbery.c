...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (unk_0x43045253AC4C7FF5() || iLocal_164)
		{
			if (!func_188())
			{
				if (func_187())
			...
			unk_0x4C3EC3682F8AFD6F("RE_SR", 0);
					...
					case 1:
						switch (iLocal_46)
						{
							case 0:
								...
								{
									func_172();
									if (unk_0x319560E9F4C27299(iLocal_153))
									{
										func_166();
										iLocal_137 = 1;
									}
								...
								else
								{
									...
									func_163();
									unk_0xBC4C3BADA8503A20(iLocal_153);
									if (func_162())
									{
										if (!iLocal_159)
										{
									...
									if (func_160())
									{
										if (unk_0x16833EFAA58E63DB(uLocal_193))
										{
											unk_0x0B57C567D698C373(&uLocal_193);
										}
										...
										{
											if (!unk_0xEB361B4BD195A4D3(iLocal_114[iVar0]))
											{
												unk_0x0756233E85C362F2(iLocal_114[iVar0], unk_0xA0081090911D13E5(), 0, 16);
												unk_0x77637031DE326F70(iLocal_114[iVar0], 1);
												if (!unk_0x16833EFAA58E63DB(uLocal_185[iVar0]))
												{
										...
										if (iLocal_49 == 2)
										{
											...
											{
												if (!unk_0xEB361B4BD195A4D3(iLocal_117[iVar0]))
												{
													unk_0x9A213173324A528B(iLocal_117[iVar0], -1);
													unk_0x77637031DE326F70(iLocal_117[iVar0], 1);
												}
												iVar0++;
											}
											iVar0 = 0;
											...
											{
												if (!unk_0xEB361B4BD195A4D3(iLocal_121[iVar0]))
												{
													unk_0x9A213173324A528B(iLocal_121[iVar0], -1);
													unk_0x77637031DE326F70(iLocal_121[iVar0], 1);
												}
												iVar0++;
											}
										}
										unk_0xE9755D24C3BFFBED(&iLocal_167);
										bLocal_140 = true;
										iLocal_46 = 1;
										iLocal_47 = 3;
									}
									if (func_158())
									{
										...
										unk_0x40613A37889C363B(88, Local_194, 15000f);
										iLocal_46 = 1;
									}
								}
								break;
							...
							case 1:
								...
								{
									if (unk_0xD3FACCDA4D66AEAD(iLocal_117[iVar1]))
									{
										if (unk_0x4AEC0F4FC7FE62C7(iLocal_117[iVar1], unk_0xA0081090911D13E5(), 1))
										{
											func_150();
										}
									}
								...
								{
									if (unk_0xD3FACCDA4D66AEAD(iLocal_121[iVar1]))
									{
										if (unk_0x4AEC0F4FC7FE62C7(iLocal_121[iVar1], unk_0xA0081090911D13E5(), 1))
										{
											func_150();
										}
									}
								...
								switch (iLocal_47)
								{
									...
									case 2:
										...
										{
											if (unk_0xD3FACCDA4D66AEAD(iLocal_167))
											{
												if (!unk_0x884626CDE60D6728(iLocal_167))
												{
													func_139();
													unk_0x2538B3290C0E12F3(iLocal_114[0], joaat("weapon_unarmed"), 1);
													unk_0xD25643FC09708802(iLocal_167, iLocal_114[0], unk_0xFA167453DE504152(iLocal_114[0], 57005), 0.3f, 0f, 0f, 80f, -90f, 0f, 1, 1, 0, 0, 2, 1);
												}
											}
										}
										if (unk_0xF9043F0F074A61B5(Local_194 - Vector(20f, 20f, 20f), Local_194 + Vector(20f, 20f, 20f), 0))
										{
											if (!unk_0xEB361B4BD195A4D3(iLocal_117[1]))
											{
												unk_0x8D95319102961B7A(iLocal_117[1], Local_103, 150f, -1, 0, 0);
												unk_0xFF5CE2ECB4FBD4A8(iLocal_117[1], 0);
												unk_0x0689C659BF2D3BF7(&(iLocal_117[1]));
											}
											if (!unk_0xEB361B4BD195A4D3(iLocal_117[2]))
											{
												unk_0x8D95319102961B7A(iLocal_117[2], Local_103, 150f, -1, 0, 0);
												unk_0xFF5CE2ECB4FBD4A8(iLocal_117[2], 0);
												unk_0x0689C659BF2D3BF7(&(iLocal_117[2]));
											}
											iVar2 = 0;
											while (iVar2 <= (iLocal_113 - 1))
											{
												if (!unk_0xEB361B4BD195A4D3(iLocal_121[iVar2]))
												{
													unk_0xEDA527A4943E849D(iLocal_121[iVar2], 1);
													unk_0x95C55738CAE00A20(&uLocal_152);
													if (iLocal_49 == 1)
													{
														unk_0xC9567EA69F3CC4C2(0, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, 0, 1, 0);
													}
													else if (iLocal_49 == 2)
													{
														unk_0x1429584A1E80336C(0, -1201.476f, -790.2733f, 15.5475f, 2f, -1, 1048576000, 0, 1193033728);
													}
													unk_0x8D95319102961B7A(0, Local_103, 150f, -1, 0, 0);
													unk_0x70B222EEA46C37FA(uLocal_152);
													unk_0x3998B29E786DFD96(iLocal_121[iVar2], uLocal_152);
													unk_0x7DFD14B8B873D6B5(&uLocal_152);
													unk_0x77637031DE326F70(iLocal_121[iVar2], 1);
													unk_0xFF5CE2ECB4FBD4A8(iLocal_121[iVar2], 0);
													unk_0xB43604F27F1EAE5F(iLocal_121[iVar2], 1);
													unk_0x0689C659BF2D3BF7(&(iLocal_121[iVar2]));
												}
												iVar2++;
											}
										}
										if (func_138() || unk_0x83666F9FB8FEBD4B() > 20000)
										{
											if (!iLocal_164)
											{
												if (!unk_0x912AD5A10E7633F0(iLocal_114[0], 0))
												{
													func_130(0, 1, 1, 0);
													func_125(0);
													...
													unk_0xC9567EA69F3CC4C2(unk_0xA0081090911D13E5(), "random@shop_robbery", "kneel_getup_p", 2f, -2f, 2700, 0, 0f, 0, 0, 0);
													if (iLocal_49 == 1)
													{
														if (unk_0xD3FACCDA4D66AEAD(iLocal_167))
														{
															unk_0xEDBE0CD7C81FA37E(iLocal_167, 0, 0);
															unk_0x591413670A1EF437(iLocal_167, 0, 0);
														}
													}
													else if (iLocal_49 == 2)
													{
													...
													while (iVar1 < iLocal_117)
													{
														if (!unk_0xEB361B4BD195A4D3(iLocal_117[iVar1]))
														{
															unk_0xFF5CE2ECB4FBD4A8(iLocal_117[iVar1], 0);
														}
														iVar1++;
													}
													iVar1 = 0;
													while (iVar1 < iLocal_121)
													{
														if (!unk_0xEB361B4BD195A4D3(iLocal_121[iVar1]))
														{
															unk_0xFF5CE2ECB4FBD4A8(iLocal_121[iVar1], 0);
														}
														iVar1++;
													}
													if (!unk_0xEB361B4BD195A4D3(iLocal_117[0]))
													{
														unk_0xFF5CE2ECB4FBD4A8(iLocal_117[0], 1);
														unk_0x95C55738CAE00A20(&uLocal_152);
														unk_0xC9567EA69F3CC4C2(0, "random@robbery", "f_distressed_loop", 2f, -2f, -1, 9, 0f, 0, 0, 0);
														unk_0x70B222EEA46C37FA(uLocal_152);
														unk_0x3998B29E786DFD96(iLocal_117[0], uLocal_152);
														unk_0x7DFD14B8B873D6B5(&uLocal_152);
														unk_0x77637031DE326F70(iLocal_117[0], 1);
													}
													if (!func_124())
													{
										...
										if (!iLocal_139)
										{
											if (unk_0x2FB5C9A04733E5EF(unk_0xA0081090911D13E5(), "random@shop_robbery", "kneel_getup_p", 3))
											{
												if (unk_0xAC6AEF29F754B011(unk_0xA0081090911D13E5(), "random@shop_robbery", "kneel_getup_p") > 0.7f || (unk_0xAC6AEF29F754B011(unk_0xA0081090911D13E5(), "random@shop_robbery", "kneel_getup_p") > 0.6f && func_112(64)))
												{
										...
										if (iLocal_49 == 1)
										{
											...
											if (!unk_0xEB361B4BD195A4D3(iLocal_114[0]) && unk_0x1F1B2B6E500380C5(iLocal_175, 0))
											{
												if (unk_0x1FD87E888EB4FC00(iLocal_114[0], iLocal_175, 0))
												{
													if (unk_0xD3FACCDA4D66AEAD(iLocal_167))
													{
														unk_0xE9755D24C3BFFBED(&iLocal_167);
											...
											{
												if (unk_0x16833EFAA58E63DB(uLocal_185[0]))
												{
													unk_0x0B57C567D698C373(&(uLocal_185[0]));
												}
												if (unk_0x16833EFAA58E63DB(uLocal_185[1]))
												{
													unk_0x0B57C567D698C373(&(uLocal_185[1]));
												}
												if (!unk_0x16833EFAA58E63DB(uLocal_191))
												{
													uLocal_191 = func_108(iLocal_175, 1, 0);
												}
												bLocal_161 = true;
												if (!unk_0xEB361B4BD195A4D3(iLocal_184))
												{
													unk_0x87BBAE0EE5DD7680(iLocal_184, 17, 1);
													unk_0x87BBAE0EE5DD7680(iLocal_184, 6, 1);
													unk_0x87BBAE0EE5DD7680(iLocal_184, 1, 1);
													unk_0x96F7890AEA06DDAE(iLocal_184, iLocal_175, unk_0xA0081090911D13E5(), 8, 16f, 786469, -1f, -1f, 1);
													unk_0x77637031DE326F70(iLocal_184, 1);
													iLocal_162 = 1;
												}
											}
											if (iLocal_162 && !iLocal_224)
											{
												if (unk_0x1F1B2B6E500380C5(iLocal_175, 0) && !unk_0xEB361B4BD195A4D3(iLocal_184))
												{
													if (!unk_0x6E07DBF03F3AC258(iLocal_175, Local_55[0 /*3*/], 20f, 20f, 10f, 0, 1, 0))
													{
														unk_0x96F7890AEA06DDAE(iLocal_184, iLocal_175, unk_0xA0081090911D13E5(), 8, 19f, 786469, -1f, -1f, 1);
														iLocal_224 = 1;
													}
												}
											}
											if (func_107())
											{
												if (!unk_0xEB361B4BD195A4D3(iLocal_184))
												{
													if (unk_0x1F1B2B6E500380C5(iLocal_175, 0))
													{
														if (!iLocal_163)
														{
															unk_0x87BBAE0EE5DD7680(iLocal_184, 17, 1);
															unk_0x87BBAE0EE5DD7680(iLocal_184, 6, 1);
															unk_0x87BBAE0EE5DD7680(iLocal_184, 1, 1);
															unk_0x96F7890AEA06DDAE(iLocal_184, iLocal_175, unk_0xA0081090911D13E5(), 8, 17f, 786469, -1f, -1f, 1);
															iLocal_163 = 1;
														}
														if (!unk_0xEB361B4BD195A4D3(iLocal_114[0]))
														{
															if (unk_0x1FD87E888EB4FC00(iLocal_114[0], iLocal_175, 0))
															{
																if (unk_0x16833EFAA58E63DB(uLocal_185[0]))
												...
												while (iVar3 <= (iLocal_111 - 1))
												{
													if (!iLocal_141[iVar3])
													{
														if (!unk_0xEB361B4BD195A4D3(iLocal_114[iVar3]))
														{
															if (unk_0x39FEE545B315414E(iLocal_114[iVar3], 0) && !unk_0xEB361B4BD195A4D3(iLocal_184))
															{
																unk_0x04EAFCCD1700249A(iLocal_114[iVar3], unk_0xA0081090911D13E5(), 0, 0.3f, 0.7f, 1.9f, -1f, 15, 0, -753768974);
																iLocal_141[iVar3] = 1;
															}
															else if (!unk_0x16833EFAA58E63DB(uLocal_192))
															{
																unk_0x0756233E85C362F2(iLocal_114[iVar3], unk_0xA0081090911D13E5(), 0, 16);
																unk_0x77637031DE326F70(iLocal_114[iVar3], 1);
																if (unk_0x16833EFAA58E63DB(uLocal_191))
																{
																	unk_0x0B57C567D698C373(&uLocal_191);
																}
																if (!unk_0x16833EFAA58E63DB(uLocal_185[iVar3]))
																{
													...
													if (!iLocal_144[iVar3])
													{
														if (unk_0x1F1B2B6E500380C5(iLocal_175, 0))
														{
															if (!unk_0xEB361B4BD195A4D3(iLocal_114[iVar3]))
															{
																if ((unk_0xEB361B4BD195A4D3(iLocal_184) || unk_0x6315EBE95A97CADF(iLocal_175, -1, 0)) || unk_0x601CCD1205C6523F(iLocal_114[iVar3]))
																{
																	unk_0xEDA527A4943E849D(iLocal_114[iVar3], 1);
																	unk_0x95C55738CAE00A20(&uLocal_152);
																	unk_0x8474D2383AC8AF53(0, 0, 0);
																	unk_0x69E46DC398F0B2BD(0, unk_0xA0081090911D13E5(), 300f, -1, 0, 0);
																	unk_0x70B222EEA46C37FA(uLocal_152);
																	unk_0x3998B29E786DFD96(iLocal_114[iVar3], uLocal_152);
																	unk_0x7DFD14B8B873D6B5(&uLocal_152);
																	unk_0x77637031DE326F70(iLocal_114[iVar3], 1);
																	if (!unk_0xEB361B4BD195A4D3(iLocal_184))
																	{
																		unk_0xEDA527A4943E849D(iLocal_184, 1);
																		unk_0x95C55738CAE00A20(&uLocal_152);
																		unk_0x8474D2383AC8AF53(0, 0, 0);
																		unk_0x69E46DC398F0B2BD(0, unk_0xA0081090911D13E5(), 300f, -1, 0, 0);
																		unk_0x70B222EEA46C37FA(uLocal_152);
																		unk_0x3998B29E786DFD96(iLocal_184, uLocal_152);
																		unk_0x7DFD14B8B873D6B5(&uLocal_152);
																		unk_0x77637031DE326F70(iLocal_184, 1);
																	}
																	if (!unk_0x16833EFAA58E63DB(uLocal_192))
																	{
																		if (unk_0x16833EFAA58E63DB(uLocal_191))
																		{
																			unk_0x0B57C567D698C373(&uLocal_191);
										...
										else if (iLocal_49 == 2)
										{
											...
											if (unk_0xEB361B4BD195A4D3(iLocal_114[1]))
											{
												if (unk_0x16833EFAA58E63DB(uLocal_185[1]))
												{
											...
											if (unk_0xEB361B4BD195A4D3(iLocal_114[0]))
											{
												if (unk_0xD3FACCDA4D66AEAD(iLocal_167))
												{
													if (unk_0x884626CDE60D6728(iLocal_167))
													{
														unk_0xFE84F1ABBFFC8840(iLocal_167, 1, 1);
													}
													unk_0xE9755D24C3BFFBED(&iLocal_167);
													func_105();
													func_102();
											...
											else if (unk_0x4AEC0F4FC7FE62C7(iLocal_114[0], unk_0xA0081090911D13E5(), 1))
											{
												if (unk_0xD3FACCDA4D66AEAD(iLocal_167))
												{
													if (unk_0x884626CDE60D6728(iLocal_167))
									...
									case 10:
										...
										if (iLocal_49 == 1)
										{
											if (!iLocal_160)
											{
												unk_0xA9DC3948106CC3E4("random@robbery");
												if (!unk_0xAD21C77209FD2024("random@robbery"))
												{
													unk_0xA9DC3948106CC3E4("random@robbery");
												}
												else if (!unk_0xEB361B4BD195A4D3(iLocal_117[0]))
												{
													unk_0x27327EB62D93CDBA(iLocal_117[0], -818.5553f, -185.4815f, 36.5689f, 1, 0, 0, 1);
													unk_0x10BB9EA2ADBCF0F3(iLocal_117[0], 47.0582f);
													unk_0xC9567EA69F3CC4C2(iLocal_117[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0f, 0, 0, 0);
													if (!unk_0xEB361B4BD195A4D3(iLocal_117[1]))
													{
														unk_0x8D95319102961B7A(iLocal_117[1], Local_103, 150f, -1, 0, 0);
														unk_0xFF5CE2ECB4FBD4A8(iLocal_117[1], 0);
													...
													{
														if (!unk_0xEB361B4BD195A4D3(iLocal_121[iVar4]))
														{
															unk_0x95C55738CAE00A20(&uLocal_152);
															unk_0xC9567EA69F3CC4C2(0, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, 0, 1, 0);
															unk_0x8D95319102961B7A(0, Local_103, 150f, -1, 0, 0);
															unk_0x70B222EEA46C37FA(uLocal_152);
															unk_0x3998B29E786DFD96(iLocal_121[iVar4], uLocal_152);
															unk_0x7DFD14B8B873D6B5(&uLocal_152);
															unk_0x77637031DE326F70(iLocal_121[iVar4], 1);
															unk_0xFF5CE2ECB4FBD4A8(iLocal_121[iVar4], 0);
															unk_0xB43604F27F1EAE5F(iLocal_121[iVar4], 1);
															unk_0x0689C659BF2D3BF7(&(iLocal_121[iVar4]));
														}
														iVar4++;
													}
													iLocal_160 = 1;
										...
										else if (iLocal_49 == 2)
										{
											if (!iLocal_160)
											{
												...
												{
													unk_0x27327EB62D93CDBA(iLocal_117[0], -1197.455f, -776.0289f, 16.3254f, 1, 0, 0, 1);
													unk_0x10BB9EA2ADBCF0F3(iLocal_117[0], 205.7753f);
													unk_0xC9567EA69F3CC4C2(iLocal_117[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0f, 0, 0, 0);
													if (!unk_0xEB361B4BD195A4D3(iLocal_117[1]))
													{
														unk_0x8D95319102961B7A(iLocal_117[1], Local_103, 150f, -1, 0, 0);
													...
													{
														if (!unk_0xEB361B4BD195A4D3(iLocal_121[iVar5]))
														{
															unk_0x8D95319102961B7A(iLocal_121[iVar5], Local_103, 150f, -1, 0, 0);
															unk_0xFF5CE2ECB4FBD4A8(iLocal_121[iVar5], 0);
															unk_0xB43604F27F1EAE5F(iLocal_121[iVar5], 1);
															unk_0x0689C659BF2D3BF7(&(iLocal_121[iVar5]));
														}
														iVar5++;
													}
													iLocal_160 = 1;
											...
											if (unk_0xE99F157D6ECE25DA(-1201.43f, -776.86f, 17.99f, 6f, joaat("v_ilev_clothmiddoor"), 0))
											{
												unk_0x555D253AB8DC8914(joaat("v_ilev_clothmiddoor"), -1201.43f, -776.86f, 17.99f, 0, 0f, 0);
											}
										}
										if (func_162())
										{
										}
										if ((func_158() && !unk_0x39FEE545B315414E(unk_0xA0081090911D13E5(), 0)) && !unk_0xFFE4F37124DBE6D9(unk_0xA0081090911D13E5()))
										{
											unk_0xC1B1E9A034A63A62(0);
											iLocal_47 = 11;
										}
										if (unk_0x2A488C176D52CCA5(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), func_238()) > (fLocal_197 + 150f))
										{
											iLocal_47 = 12;
										}
										...
										else if (unk_0x4AEC0F4FC7FE62C7(iLocal_117[0], unk_0xA0081090911D13E5(), 1))
										{
											func_70(2);
											func_49();
										}
									...
									case 13:
										if (!iLocal_225)
										{
											if (!unk_0xEB361B4BD195A4D3(iLocal_117[0]))
											{
												unk_0xD3032BAC1ECE011F(iLocal_117[0]);
												if (iLocal_49 == 1)
												{
												...
												unk_0x5F6B2DFB57BBCE9A(iLocal_117[0], 20000);
												unk_0x77637031DE326F70(iLocal_117[0], 1);
												unk_0xFF5CE2ECB4FBD4A8(iLocal_117[0], 0);
												iLocal_225 = 1;
											}
										}
										if (!func_124())
...
void func_1()
{
	if (func_158())
	{
		...
		if (!iLocal_182)
		{
			if (!unk_0xEB361B4BD195A4D3(iLocal_117[0]))
			{
				...
				unk_0x30822041FD942595(unk_0xC59DF10B4FC39DF8(iLocal_117[0], 1), 20f, 0);
	...
	if (bLocal_181)
	{
		if (!iLocal_183)
		{
			...
			Local_198 = { unk_0xC59DF10B4FC39DF8(iLocal_117[0], 0) };
			if (iLocal_49 == 1)
			{
			...
			uLocal_216 = unk_0x6194C3993E6BB2A5(Local_198, Local_204, 2);
			uLocal_210 = unk_0x669DFEC6C5E8A812("DEFAULT_ANIMATED_CAMERA", 0);
			unk_0x7EB0D56EE8F8F8E8(uLocal_210, uLocal_216, sLocal_215, sLocal_211);
			unk_0xB0993C95A7DBF879(unk_0xA0081090911D13E5());
			unk_0xCAD643E9EAD85BD2(unk_0xA0081090911D13E5(), uLocal_216, sLocal_211, sLocal_212, 1000f, -2f, 5, 0, 1148846080, 0);
			unk_0x2945E3CE39DA8591(unk_0xA0081090911D13E5(), 0, 0);
			unk_0xB0993C95A7DBF879(iLocal_117[0]);
			unk_0xCAD643E9EAD85BD2(iLocal_117[0], uLocal_216, sLocal_211, sLocal_213, 1000f, -2f, 4, 0, 1148846080, 0);
			unk_0x2945E3CE39DA8591(iLocal_117[0], 0, 0);
			iLocal_167 = unk_0xE1C25770C2FB7AE3(joaat("prop_cs_duffel_01"), unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), 1, 1, 0);
			unk_0x6101ECFE82230F9B(iLocal_167, uLocal_216, sLocal_214, sLocal_211, 1000f, 1090519040, 0, 1148846080);
			if (!unk_0xEB361B4BD195A4D3(iLocal_117[0]))
			{
				func_48();
				unk_0x07553DAC96600443(uLocal_210, 1);
	...
	if (unk_0xA84C8086E7377CD5(uLocal_216) > fLocal_217 && iLocal_183)
	{
		if (!unk_0xEB361B4BD195A4D3(iLocal_117[0]))
		{
			unk_0xFB4B028F94A31239(iLocal_117[0], iLocal_189);
			unk_0xD3032BAC1ECE011F(iLocal_117[0]);
			unk_0x95C55738CAE00A20(&uLocal_152);
			unk_0xC9567EA69F3CC4C2(0, "random@robbery", "stand_worried_female", 2f, -2f, -1, 1, 0f, 0, 0, 0);
			unk_0x70B222EEA46C37FA(uLocal_152);
			unk_0x3998B29E786DFD96(iLocal_117[0], uLocal_152);
			unk_0x7DFD14B8B873D6B5(&uLocal_152);
			unk_0x77637031DE326F70(iLocal_117[0], 1);
		...
		unk_0x9B109E7410A2CB10(unk_0x0C1D3C552325765B(), 1f, 650, 0, 1, 0);
		func_130(0, 1, 1, 0);
		unk_0xFDEC0B505BCB00C0(unk_0x0C1D3C552325765B(), 1, 4);
		unk_0x943A052E20E9C2CE(1);
		unk_0x627D428B266FEDCA(1);
		unk_0xF414004DEC115D4A(unk_0xA0081090911D13E5(), 0);
		unk_0x8BDD755F07063522(0f);
		unk_0xD2C0F2FD77D871FA(0, 0, 3, 0);
		unk_0x50C86ABC13A071F8(uLocal_210, 0);
		func_45();
...
void func_4(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2491469[iParam0 /*3*/][func_5(iParam2)];
	if (iVar0 != 0)
	{
...
int func_7(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2491469[iParam0 /*3*/][func_5(iParam1)];
...
int func_11(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0xA86CA03D9749EEB3())
	{
		if (func_9() == 0)
		{
			return unk_0x08BA6DD398CA197C(func_7(func_8(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_12(int iParam0, int iParam1, int iParam2)
{
	...
	return func_13(Global_101553.f_32740[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_16(int iParam0)
{
	...
	else if (unk_0x08BA6DD398CA197C(Global_101553.f_25254.f_471, iParam0) || unk_0x08BA6DD398CA197C(Global_2097152[func_18() /*10106*/].f_7120.f_10, iParam0))
	{
		bVar0 = true;
		unk_0x09C86C0C5CA26B1E(&(Global_101553.f_25254.f_471), iParam0);
		unk_0x09C86C0C5CA26B1E(&(Global_2097152[func_18() /*10106*/].f_7120.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		unk_0x754E61FE98961B39("COUP_RED");
		unk_0xBDE6EEC5F6BDC060(func_17(iParam0));
...
bool func_20(int iParam0)
{
	...
	return unk_0x08BA6DD398CA197C(Global_2097152[func_18() /*10106*/].f_7120.f_10, iParam0);
}
...
int func_23(int iParam0, int iParam1)
{
	...
	if (func_33(&Global_2578151))
	{
		if (func_31(&Global_2578151, iParam0))
		{
			return 0;
		}
		if (func_24(&Global_2578151, iParam0))
		{
			return 1;
		}
	}
...
void func_27(var uParam0)
{
	...
	func_29(uParam0, (Global_2578150 - 0.5f));
}
...
void func_40()
{
	...
	{
		if (func_43(Global_101553.f_1991.f_539.f_3549) != unk_0x705BC1BB91F530B5(unk_0xA0081090911D13E5()))
		{
			iVar0 = func_42(unk_0xA0081090911D13E5());
			if (func_41(iVar0) && (!func_35(14) || Global_100505))
			{
				if (Global_101553.f_1991.f_539.f_3549 != iVar0 && func_41(Global_101553.f_1991.f_539.f_3549))
				{
...
void func_45()
{
	if (iLocal_49 == 1)
	{
		if (unk_0xD3FACCDA4D66AEAD(iLocal_117[0]))
		{
			if (!unk_0xEB361B4BD195A4D3(iLocal_117[0]))
			{
				unk_0xFF5CE2ECB4FBD4A8(iLocal_117[0], 0);
				unk_0x0689C659BF2D3BF7(&(iLocal_117[0]));
			}
		}
		if (unk_0xD3FACCDA4D66AEAD(iLocal_117[1]))
		{
			if (!unk_0xEB361B4BD195A4D3(iLocal_117[1]))
			{
				unk_0xFF5CE2ECB4FBD4A8(iLocal_117[1], 0);
		...
		if (unk_0xD3FACCDA4D66AEAD(iLocal_121[0]))
		{
			if (!unk_0xEB361B4BD195A4D3(iLocal_121[0]))
			{
				unk_0xFF5CE2ECB4FBD4A8(iLocal_121[0], 0);
				unk_0x0689C659BF2D3BF7(&(iLocal_121[0]));
			}
		}
		if (unk_0xD3FACCDA4D66AEAD(iLocal_121[1]))
		{
			if (!unk_0xEB361B4BD195A4D3(iLocal_121[1]))
			{
				unk_0xFF5CE2ECB4FBD4A8(iLocal_121[1], 0);
				unk_0x0689C659BF2D3BF7(&(iLocal_121[1]));
			}
		}
		if (unk_0xD3FACCDA4D66AEAD(iLocal_121[2]))
		{
			if (!unk_0xEB361B4BD195A4D3(iLocal_121[2]))
			{
				unk_0x27327EB62D93CDBA(iLocal_121[2], -820.424f, -181.9059f, 36.5687f, 1, 0, 0, 1);
				unk_0x10BB9EA2ADBCF0F3(iLocal_121[2], 167.7909f);
				unk_0xFF5CE2ECB4FBD4A8(iLocal_121[2], 0);
				unk_0x0689C659BF2D3BF7(&(iLocal_121[2]));
			}
		}
	}
}
...
void func_48()
{
	if (iLocal_49 == 1)
	{
		...
		{
			if (unk_0x6E07DBF03F3AC258(unk_0x525584039F375488(), unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), 8f, 8f, 8f, 0, 1, 0) || unk_0x6E07DBF03F3AC258(unk_0x525584039F375488(), -823.1281f, -187.9591f, 36.6189f, 8f, 8f, 8f, 0, 1, 0))
			{
				unk_0x27327EB62D93CDBA(unk_0x525584039F375488(), -831.9709f, -192.0823f, 36.5008f, 0, 0, 0, 1);
				unk_0x74207974B5483203(unk_0x525584039F375488());
			}
		}
		unk_0x0B17BC5D018E224B(-823.1281f, -187.9591f, 36.6189f, 3f, 1, 0, 0, 0);
	}
	else if (iLocal_49 == 2)
	{
		if (unk_0x1F1B2B6E500380C5(unk_0x525584039F375488(), 0))
		{
			if (unk_0x6E07DBF03F3AC258(unk_0x525584039F375488(), unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), 8f, 8f, 8f, 0, 1, 0) || unk_0x6E07DBF03F3AC258(unk_0x525584039F375488(), -1201.017f, -777.5527f, 16.3398f, 8f, 8f, 8f, 0, 1, 0))
			{
				unk_0x27327EB62D93CDBA(unk_0x525584039F375488(), -1205.936f, -781.2014f, 16.0088f, 0, 0, 0, 1);
				unk_0x74207974B5483203(unk_0x525584039F375488());
			}
		}
		unk_0x0B17BC5D018E224B(-1201.017f, -777.5527f, 16.3398f, 8f, 1, 0, 0, 0);
	}
}
...
void func_55()
{
	...
	{
		func_36(13, unk_0xF34EE736CF047844(Global_101553.f_9049.f_3853));
	}
...
int func_76(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!unk_0xEB361B4BD195A4D3(unk_0xA0081090911D13E5()))
		{
			...
			{
				iVar0 = unk_0x705BC1BB91F530B5(func_77(unk_0xF8DB47D339B8B953(unk_0xA0081090911D13E5(), 1)));
				switch (iVar0)
				{
...
void func_78(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_79(iParam0) && unk_0xA96867DD0A63C62C(Global_82527[26 /*34*/].f_6) == 0)
			{
				Global_101553.f_6116[iParam0] = 1;
				unk_0x6A7EBBBF8B647A25(uParam1->f_5, Global_101553.f_6116[iParam0], 1, 1);
			}
...
int func_81()
{
	...
	func_91(&uVar0, unk_0x8A1006B6887A61DE());
	func_90(&uVar0, unk_0x4A29A51562AC24A5());
	func_89(&uVar0, unk_0x7C42343912622BB6());
	func_84(&uVar0, unk_0x5EE1E0D1EBF5F7F6());
	func_83(&uVar0, unk_0x55ED786EB10EA740());
	func_82(&uVar0, unk_0x3258DF33389FB224());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_87(unk_0x08BA6DD398CA197C(iParam0, 31), -1, 1)) + 2011;
}
...
void func_99()
{
	if (unk_0xC37D05B586FADB2B(uLocal_110))
	{
		...
		func_100(&uLocal_229);
		fLocal_197 = unk_0x2A488C176D52CCA5(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), func_238());
		unk_0xC1B1E9A034A63A62(0);
		iLocal_47 = 10;
	}
	if (unk_0x04793529D4EC36D1(uLocal_110))
	{
		if (unk_0x2A488C176D52CCA5(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), unk_0xCA4126970421B696(uLocal_110)) > 200f)
		{
			func_150();
		}
	}
...
void func_102()
{
	...
	if (!unk_0x04793529D4EC36D1(uLocal_110))
	{
		unk_0x88B0F0DC270164B7(&uLocal_106, 3);
		unk_0x88B0F0DC270164B7(&uLocal_106, 4);
		unk_0x88B0F0DC270164B7(&uLocal_106, 1);
		if (!bLocal_161)
		{
			if (unk_0x912AD5A10E7633F0(iLocal_114[0], 0))
			{
				if (unk_0xD3FACCDA4D66AEAD(iLocal_114[0]))
				{
					Local_107 = { unk_0x98C1B5DB039FB606(iLocal_114[0], 1067030938, 1069547520) };
				}
			}
			else
			{
				Local_107 = { unk_0x9AB61CF2F1CE8D84(unk_0xC59DF10B4FC39DF8(iLocal_114[0], 1), 1067030938, 1069547520) };
			}
		}
		else if (unk_0xD3FACCDA4D66AEAD(iLocal_175))
		{
			Local_107 = { unk_0x9AB61CF2F1CE8D84(unk_0xC59DF10B4FC39DF8(iLocal_175, 0), 1067030938, 1069547520) };
		}
		Local_107 = { Local_107.f_0, Local_107.f_1, (Local_107.f_2 + 0.25f) };
		uLocal_110 = unk_0x2C909F6674445C8D(joaat("pickup_money_med_bag"), Local_107, uLocal_106, iLocal_189, 1, joaat("prop_cs_duffel_01"));
		...
		if (iLocal_49 == 1)
		{
			...
			while (iVar0 <= (iLocal_111 - 1))
			{
				if (!unk_0xEB361B4BD195A4D3(iLocal_114[iVar0]))
				{
					unk_0xEDA527A4943E849D(iLocal_114[iVar0], 1);
					unk_0xD3032BAC1ECE011F(iLocal_114[iVar0]);
					unk_0x95C55738CAE00A20(&uLocal_152);
					unk_0x8474D2383AC8AF53(0, 0, 0);
					unk_0x69E46DC398F0B2BD(0, unk_0xA0081090911D13E5(), 300f, -1, 0, 0);
					unk_0x70B222EEA46C37FA(uLocal_152);
					unk_0x3998B29E786DFD96(iLocal_114[iVar0], uLocal_152);
					unk_0x7DFD14B8B873D6B5(&uLocal_152);
					unk_0x77637031DE326F70(iLocal_114[iVar0], 1);
				}
				iVar0++;
		...
		else if (iLocal_49 == 2)
		{
			if (!unk_0xEB361B4BD195A4D3(iLocal_114[0]))
			{
				unk_0xEB6B0D85F7D79F78(iLocal_114[0]);
				if (!unk_0x6EE56158B3EDF9EC(iLocal_114[0]))
				{
					func_46();
					unk_0x4EDE34FBADD967A6(0);
...
int func_103(var uParam0)
{
	...
	unk_0xC40118229E47A3D7(uVar0, func_104(unk_0xA86CA03D9749EEB3(), 0.7f, 0.7f));
	return uVar0;
}
...
void func_105()
{
	if (unk_0x16833EFAA58E63DB(uLocal_192))
	{
		unk_0x0B57C567D698C373(&uLocal_192);
	}
	if (unk_0x16833EFAA58E63DB(uLocal_193))
	{
		unk_0x0B57C567D698C373(&uLocal_193);
...
int func_106()
{
	...
	else if (unk_0xEB361B4BD195A4D3(iLocal_114[0]))
	{
		iLocal_149 = 1;
	}
	if (!bLocal_161)
	{
		if (!unk_0xD3FACCDA4D66AEAD(iLocal_114[1]))
		{
			iLocal_150 = 1;
		}
		else if (unk_0xEB361B4BD195A4D3(iLocal_114[1]))
		{
			iLocal_150 = 1;
		}
	}
	...
	if (!unk_0xD3FACCDA4D66AEAD(iLocal_184))
	{
		iLocal_151 = 1;
	}
	else if (unk_0xEB361B4BD195A4D3(iLocal_184) || !unk_0x39FEE545B315414E(iLocal_184, 0))
	{
		iLocal_151 = 1;
	}
...
int func_107()
{
	...
	while (iVar0 <= (iLocal_111 - 1))
	{
		if (unk_0xD3FACCDA4D66AEAD(iLocal_114[iVar0]))
		{
			if (!unk_0xEB361B4BD195A4D3(iLocal_114[iVar0]) || unk_0x912AD5A10E7633F0(iLocal_114[iVar0], 0))
			{
				if (unk_0x4AEC0F4FC7FE62C7(iLocal_114[iVar0], unk_0xA0081090911D13E5(), 1))
				{
					return 1;
				}
			}
	...
	while (iVar0 <= (iLocal_111 - 1))
	{
		if (unk_0xD3FACCDA4D66AEAD(iLocal_114[iVar0]))
		{
			if (!unk_0xEB361B4BD195A4D3(iLocal_114[iVar0]))
			{
				if (unk_0x12AE3D700F6A2545(iLocal_114[iVar0]))
				{
					if (unk_0xEA5E391ACA923D54(iLocal_114[iVar0]) == unk_0xA0081090911D13E5())
					{
						unk_0xEDA527A4943E849D(iLocal_114[iVar0], 1);
						unk_0x69E46DC398F0B2BD(iLocal_114[iVar0], unk_0xA0081090911D13E5(), 250f, -1, 0, 0);
						unk_0x77637031DE326F70(iLocal_114[iVar0], 1);
						unk_0x4EDE34FBADD967A6(0);
						unk_0x0689C659BF2D3BF7(&(iLocal_114[iVar0]));
						return 1;
					}
				}
			}
	...
	if (unk_0xD3FACCDA4D66AEAD(iLocal_184))
	{
		if (!unk_0xEB361B4BD195A4D3(iLocal_184) || unk_0x912AD5A10E7633F0(iLocal_184, 0))
		{
			if (unk_0x4AEC0F4FC7FE62C7(iLocal_184, unk_0xA0081090911D13E5(), 1))
			{
				return 1;
			}
		}
		if (!unk_0xEB361B4BD195A4D3(iLocal_184))
		{
			if (unk_0xA206EFFF59CEDCA5(unk_0xA0081090911D13E5(), joaat("weapon_stungun")))
			{
				return 1;
			}
		}
	...
	if (unk_0xD3FACCDA4D66AEAD(iLocal_184))
	{
		if (!unk_0xEB361B4BD195A4D3(iLocal_184))
		{
			if (unk_0x12AE3D700F6A2545(iLocal_184))
			{
				if (unk_0xEA5E391ACA923D54(iLocal_184) == unk_0xA0081090911D13E5())
				{
					unk_0xEDA527A4943E849D(iLocal_184, 1);
					unk_0x69E46DC398F0B2BD(iLocal_184, unk_0xA0081090911D13E5(), 250f, -1, 0, 0);
					unk_0x77637031DE326F70(iLocal_184, 1);
					unk_0x4EDE34FBADD967A6(0);
					unk_0x0689C659BF2D3BF7(&iLocal_184);
					return 1;
				}
			}
		}
	...
	{
		if (!unk_0x912AD5A10E7633F0(iLocal_175, 0) || unk_0x912AD5A10E7633F0(iLocal_175, 0))
		{
			if (unk_0x4AEC0F4FC7FE62C7(iLocal_175, unk_0xA0081090911D13E5(), 1))
			{
				return 1;
			}
		}
...
int func_109(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xC40118229E47A3D7(uVar0, func_104(unk_0xA86CA03D9749EEB3(), 1f, 1f));
		if (!bParam2)
		{
	...
	if (unk_0x1F1B2B6E500380C5(iLocal_175, 0))
	{
		if (!unk_0xEB361B4BD195A4D3(iLocal_114[0]))
		{
			if (unk_0x1FD87E888EB4FC00(iLocal_114[0], iLocal_175, 0))
			{
				if (!unk_0xEB361B4BD195A4D3(iLocal_114[1]))
				{
					if (unk_0x1FD87E888EB4FC00(iLocal_114[1], iLocal_175, 0))
					{
						return 1;
					}
				}
...
int func_112(int iParam0)
{
	...
	iVar0 = (unk_0xCEA3D75B69A1A87E(2, 195) - 128);
	iVar1 = (unk_0xCEA3D75B69A1A87E(2, 196) - 128);
...
void func_130(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (unk_0xA86CA03D9749EEB3())
		{
			if (((!unk_0xEB361B4BD195A4D3(unk_0xA0081090911D13E5()) && !func_134(unk_0x0C1D3C552325765B())) && !func_132(unk_0x0C1D3C552325765B(), 0)) && !func_131())
			{
				unk_0x39800A40136ECF37(unk_0xA0081090911D13E5(), 0);
			}
		}
		else if (!unk_0xEB361B4BD195A4D3(unk_0xA0081090911D13E5()) && !func_134(unk_0x0C1D3C552325765B()))
		{
			unk_0x39800A40136ECF37(unk_0xA0081090911D13E5(), 0);
		}
		Global_69615 = 0;
...
int func_138()
{
	if (!unk_0xEB361B4BD195A4D3(iLocal_114[0]) && !unk_0xEB361B4BD195A4D3(iLocal_114[1]))
	{
		if (iLocal_49 == 1)
		{
			if (!iLocal_165)
			{
				if (!unk_0xFD4DDA3E1EF89C67(iLocal_114[0], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, 1, 0))
				{
					iLocal_165 = 1;
				}
			}
			if (!iLocal_166)
			{
				if (!unk_0xFD4DDA3E1EF89C67(iLocal_114[1], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, 1, 0))
				{
					iLocal_166 = 1;
				}
			}
		...
		else if (iLocal_49 == 2)
		{
			if (!iLocal_165)
			{
				if ((!unk_0xFD4DDA3E1EF89C67(iLocal_114[0], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, 1, 0) || unk_0xFD4DDA3E1EF89C67(iLocal_114[0], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, 1, 0)) || unk_0xFD4DDA3E1EF89C67(iLocal_114[0], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, 1, 0))
				{
					unk_0x69E46DC398F0B2BD(iLocal_114[0], unk_0xA0081090911D13E5(), 1000f, -1, 0, 0);
					iLocal_165 = 1;
				}
			}
			if (!iLocal_166)
			{
				if ((!unk_0xFD4DDA3E1EF89C67(iLocal_114[1], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, 1, 0) || unk_0xFD4DDA3E1EF89C67(iLocal_114[1], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, 1, 0)) || unk_0xFD4DDA3E1EF89C67(iLocal_114[1], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, 1, 0))
				{
					unk_0x69E46DC398F0B2BD(iLocal_114[1], unk_0xA0081090911D13E5(), 1000f, -1, 0, 0);
					iLocal_166 = 1;
				}
			}
		}
...
void func_139()
{
	...
	Var0 = { unk_0xC59DF10B4FC39DF8(iLocal_167, 1) };
	Var3 = { unk_0x3A02D44277FBA4BE(iLocal_167, 2) };
	unk_0xE9755D24C3BFFBED(&iLocal_167);
	iLocal_167 = unk_0xE1C25770C2FB7AE3(joaat("prop_cs_duffel_01"), Var0, 1, 1, 0);
	unk_0x4A1ACDDF793F9777(iLocal_167, Var3, 2, 1);
}
...
void func_140()
{
	if (unk_0xD3FACCDA4D66AEAD(iLocal_114[0]))
	{
		if (unk_0x2A488C176D52CCA5(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), unk_0xC59DF10B4FC39DF8(iLocal_114[0], 0)) > 200f && unk_0x460E7746DAC01E79(iLocal_114[0]))
		{
			if (unk_0x16833EFAA58E63DB(uLocal_185[0]))
			{
				unk_0x0B57C567D698C373(&(uLocal_185[0]));
			}
			unk_0x0689C659BF2D3BF7(&(iLocal_114[0]));
			bLocal_147 = true;
		}
	}
	else
	...
	if (unk_0xD3FACCDA4D66AEAD(iLocal_175))
	{
		if (unk_0x2A488C176D52CCA5(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), unk_0xC59DF10B4FC39DF8(iLocal_175, 0)) > 200f && unk_0x460E7746DAC01E79(iLocal_175))
		{
			if (unk_0x16833EFAA58E63DB(uLocal_191))
			{
				unk_0x0B57C567D698C373(&uLocal_191);
			}
			unk_0x615DE34FC732CF11(&iLocal_175);
			bLocal_148 = true;
		}
	}
	else
...
void func_141()
{
	if (!unk_0x912AD5A10E7633F0(iLocal_175, 0))
	{
		if (unk_0xC6FE0F623405BFA8(iLocal_175) < 800)
		{
			unk_0xA082D4AC00BC651A(iLocal_175, 0);
			unk_0xA0BCF2878D04DC73(iLocal_175, 10f);
		}
	}
}
	...
	while (iVar0 <= (iLocal_111 - 1))
	{
		if (unk_0xD3FACCDA4D66AEAD(iLocal_114[iVar0]))
		{
			if (unk_0xEB361B4BD195A4D3(iLocal_114[iVar0]))
			{
				if (unk_0x16833EFAA58E63DB(uLocal_185[iVar0]))
				{
					unk_0x0B57C567D698C373(&(uLocal_185[iVar0]));
				}
			}
		}
		iVar0++;
...
void func_143()
{
	...
	if (unk_0x4B626BBA5EE1CFF0(unk_0xA0081090911D13E5()))
	{
		if (!bLocal_140)
		{
			...
			{
				if (!unk_0xEB361B4BD195A4D3(iLocal_114[iVar1]))
				{
					unk_0x0756233E85C362F2(iLocal_114[iVar1], unk_0xA0081090911D13E5(), 0, 16);
				}
				iVar1++;
			}
			bLocal_140 = true;
	...
	{
		unk_0xB49DAD10DC051295("RE51A_SHOP");
		func_46();
		unk_0x4EDE34FBADD967A6(0);
		if (iLocal_49 == 1)
		{
	...
	if (!bLocal_140)
	{
		...
		else if (iLocal_49 == 2)
		{
			...
			if (unk_0xD3FACCDA4D66AEAD(iLocal_167) && !unk_0xEB361B4BD195A4D3(iLocal_114[0]))
			{
				if (!iLocal_178)
				{
					iLocal_178 = 1;
		...
		if (!iLocal_138)
		{
			if (iLocal_49 == 1)
			{
				...
				{
					unk_0xE9755D24C3BFFBED(&(uLocal_168[0]));
					unk_0xE9755D24C3BFFBED(&(uLocal_168[1]));
					if (unk_0x1F1B2B6E500380C5(iLocal_175, 0))
					{
						if (!unk_0xEB361B4BD195A4D3(iLocal_114[0]))
						{
							unk_0xD3032BAC1ECE011F(iLocal_114[0]);
							unk_0x95C55738CAE00A20(&uLocal_152);
							unk_0x5CEE5F34DA93AE97(0);
							unk_0xA4FE049E1F729261(0, iLocal_175, -1, 0, 2f, 1, 0);
							unk_0x70B222EEA46C37FA(uLocal_152);
							unk_0x3998B29E786DFD96(iLocal_114[0], uLocal_152);
							unk_0x7DFD14B8B873D6B5(&uLocal_152);
						}
						if (!unk_0xEB361B4BD195A4D3(iLocal_114[1]))
						{
							unk_0xE33751BF671E2013(iLocal_114[1], joaat("MotionState_Run"), 1, 0, 0);
							unk_0x95C55738CAE00A20(&uLocal_152);
							unk_0x5CEE5F34DA93AE97(0);
							unk_0xA4FE049E1F729261(0, iLocal_175, -1, 1, 2f, 1, 0);
							unk_0x70B222EEA46C37FA(uLocal_152);
							unk_0x3998B29E786DFD96(iLocal_114[1], uLocal_152);
							unk_0x7DFD14B8B873D6B5(&uLocal_152);
						}
						iLocal_47 = 2;
						iLocal_138 = 1;
					...
					else
					{
						if (!unk_0xEB361B4BD195A4D3(iLocal_114[0]))
						{
							unk_0xEDA527A4943E849D(iLocal_114[0], 1);
							unk_0xB0993C95A7DBF879(iLocal_114[0]);
							unk_0x95C55738CAE00A20(&uLocal_152);
							unk_0x5CEE5F34DA93AE97(0);
						...
						if (!unk_0xEB361B4BD195A4D3(iLocal_114[1]))
						{
							unk_0xEDA527A4943E849D(iLocal_114[1], 1);
							unk_0xB0993C95A7DBF879(iLocal_114[1]);
							unk_0x95C55738CAE00A20(&uLocal_152);
							unk_0x5CEE5F34DA93AE97(0);
							unk_0x69E46DC398F0B2BD(0, unk_0xA0081090911D13E5(), 1000f, -1, 0, 0);
							unk_0x70B222EEA46C37FA(uLocal_152);
			...
			{
				if (unk_0xA84C8086E7377CD5(uLocal_216) > 0.453f)
				{
					if (!unk_0xEB361B4BD195A4D3(iLocal_117[0]))
					{
						unk_0xFF5CE2ECB4FBD4A8(iLocal_117[0], 1);
					...
					{
						unk_0xD3032BAC1ECE011F(iLocal_114[0]);
						unk_0x797AA7825A5A2D95(iLocal_114[0], 128, 1);
						unk_0x797AA7825A5A2D95(iLocal_114[0], 1, 1);
						unk_0x87BBAE0EE5DD7680(iLocal_114[0], 17, 1);
						unk_0x44A694E0E28FA402(iLocal_114[0], 1.6f);
						unk_0xEDA527A4943E849D(iLocal_114[0], 1);
						unk_0x95C55738CAE00A20(&uLocal_152);
						unk_0xC9567EA69F3CC4C2(0, "random@robbery", "run", 2f, -2f, -1, 49, 0f, 0, 0, 0);
						unk_0x06A0AFACC5EA5396(0, "re_shoprobbery", 0, 0, 16);
						unk_0x5CEE5F34DA93AE97(0);
						unk_0x70B222EEA46C37FA(uLocal_152);
						unk_0x3998B29E786DFD96(iLocal_114[0], uLocal_152);
						unk_0x7DFD14B8B873D6B5(&uLocal_152);
						unk_0x77637031DE326F70(iLocal_114[0], 1);
						unk_0x5AE11BC36633DE4E(0);
					}
					if (!unk_0xEB361B4BD195A4D3(iLocal_114[1]))
					{
						unk_0x797AA7825A5A2D95(iLocal_114[1], 128, 1);
						unk_0x797AA7825A5A2D95(iLocal_114[1], 1, 1);
						unk_0x87BBAE0EE5DD7680(iLocal_114[1], 17, 1);
						unk_0x44A694E0E28FA402(iLocal_114[1], 1.6f);
						unk_0xEDA527A4943E849D(iLocal_114[1], 1);
						unk_0x95C55738CAE00A20(&uLocal_152);
						unk_0x5CEE5F34DA93AE97(0);
						unk_0x06A0AFACC5EA5396(0, "re_shoprobbery2", 0, 0, 17);
						unk_0x70B222EEA46C37FA(uLocal_152);
						unk_0x3998B29E786DFD96(iLocal_114[1], uLocal_152);
						unk_0x7DFD14B8B873D6B5(&uLocal_152);
						unk_0x77637031DE326F70(iLocal_114[1], 1);
					}
					iLocal_47 = 2;
					iLocal_138 = 1;
				}
...
void func_144()
{
	switch (iLocal_227)
	{
		case 0:
			func_130(1, 1, 1, 0);
			unk_0xF3C7015EF0F4A17C(func_145(unk_0x0C1D3C552325765B()), 10f, 0);
			uLocal_226 = unk_0x669DFEC6C5E8A812("DEFAULT_ANIMATED_CAMERA", 0);
			unk_0x07553DAC96600443(uLocal_226, 1);
			unk_0x7EB0D56EE8F8F8E8(uLocal_226, uLocal_216, "robbery_action_cam", "random@shop_robbery");
			if (iLocal_49 == 1)
			{
				unk_0xA7667D1639F16A5C("Hair_room");
			}
			unk_0x2D5A415AD869CB5F(1, 0, 3000, 1, 0, 0);
			iLocal_228 = unk_0xDF658EB6CA91DFBC() + 3500;
			iLocal_227++;
			break;
		
		case 1:
			if (iLocal_228 < unk_0xDF658EB6CA91DFBC())
			{
				if (iLocal_49 == 1)
				{
					unk_0x8BDD755F07063522(115f);
					unk_0x2A7D387AD73F1D15(-9.1222f, 1065353216);
				}
				else if (iLocal_49 == 2)
				{
					unk_0x8BDD755F07063522(44.5236f);
					unk_0x2A7D387AD73F1D15(-18.1582f, 1065353216);
				}
				unk_0x2E1E57681BD2050A();
				unk_0x07553DAC96600443(uLocal_226, 0);
...
void func_146()
{
	...
	if (!iLocal_136 && func_149(1, 0, 1))
	{
		...
		if (iLocal_49 == 1)
		{
			if (!iLocal_177)
			{
				uLocal_216 = unk_0x6194C3993E6BB2A5(Local_201, Local_207, 2);
				unk_0xB0993C95A7DBF879(unk_0xA0081090911D13E5());
				unk_0xCAD643E9EAD85BD2(unk_0xA0081090911D13E5(), uLocal_216, "random@shop_robbery", "robbery_action_p", 8f, -8f, 1, 0, 1148846080, 0);
				unk_0x2945E3CE39DA8591(unk_0xA0081090911D13E5(), 1, 0);
				if (((!unk_0xEB361B4BD195A4D3(iLocal_114[0]) && !unk_0xEB361B4BD195A4D3(iLocal_114[1])) && !unk_0xEB361B4BD195A4D3(iLocal_117[0])) && unk_0xD3FACCDA4D66AEAD(iLocal_167))
				{
					unk_0xCAD643E9EAD85BD2(iLocal_114[0], uLocal_216, "random@shop_robbery", "robbery_action_b", 8f, -8f, 1, 0, 1148846080, 0);
					unk_0xCAD643E9EAD85BD2(iLocal_114[1], uLocal_216, "random@shop_robbery", "robbery_action_a", 8f, -8f, 1, 0, 1148846080, 0);
					unk_0xCAD643E9EAD85BD2(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_action_f", 8f, -4f, 0, 0, 1148846080, 0);
					unk_0x6101ECFE82230F9B(iLocal_167, uLocal_216, "robbery_action_bag", "random@shop_robbery", 8f, -8f, 0, 1148846080);
				}
				unk_0xB1A2B8A065E00D0C(uLocal_216, 0.06f);
				iLocal_177 = 1;
			}
		}
		else if (iLocal_49 == 2)
		{
			...
			{
				unk_0xD3032BAC1ECE011F(iLocal_117[0]);
				unk_0xC9567EA69F3CC4C2(iLocal_117[0], "random@robbery", "robbery_main_female", 2f, -2f, -1, 0, 0f, 0, 0, 0);
			}
			unk_0x639927C5DE78E8D7(-1195.062f, -773.2098f, 16.324f, 20f, 4);
			uLocal_216 = unk_0x6194C3993E6BB2A5(Local_201, Local_207, 2);
			if (((!unk_0xEB361B4BD195A4D3(iLocal_114[0]) && !unk_0xEB361B4BD195A4D3(iLocal_114[1])) && !unk_0xEB361B4BD195A4D3(iLocal_117[0])) && unk_0xD3FACCDA4D66AEAD(iLocal_167))
			{
				unk_0xCAD643E9EAD85BD2(iLocal_114[0], uLocal_216, "random@shop_robbery", "robbery_action_b", 2f, -2f, 1, 0, 1148846080, 0);
				unk_0xCAD643E9EAD85BD2(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_action_f", 2f, -2f, 0, 0, 1148846080, 0);
				if (unk_0xD3FACCDA4D66AEAD(uLocal_168[0]) && unk_0xD3FACCDA4D66AEAD(uLocal_168[1]))
				{
					unk_0xD25643FC09708802(uLocal_168[0], iLocal_117[0], unk_0xFA167453DE504152(iLocal_117[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
					unk_0xD25643FC09708802(uLocal_168[1], iLocal_117[0], unk_0xFA167453DE504152(iLocal_117[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
				}
			}
			unk_0xB1A2B8A065E00D0C(uLocal_216, 0.05f);
			Local_201 = { -1199.369f, -776.1991f, 16.3235f };
			Local_207 = { 0f, 0f, -60f };
			uLocal_216 = unk_0x6194C3993E6BB2A5(Local_201, Local_207, 2);
			if (!unk_0xEB361B4BD195A4D3(iLocal_114[1]))
			{
				unk_0xCAD643E9EAD85BD2(iLocal_114[1], uLocal_216, "random@shop_robbery", "robbery_action_a", 2f, -2f, 1, 0, 1148846080, 0);
			}
			unk_0xB1A2B8A065E00D0C(uLocal_216, 0.06f);
			unk_0x27327EB62D93CDBA(unk_0xA0081090911D13E5(), -1200.455f, -777.6201f, 16.3244f, 1, 0, 0, 1);
			unk_0x10BB9EA2ADBCF0F3(unk_0xA0081090911D13E5(), 305.3806f);
			unk_0xD3032BAC1ECE011F(unk_0xA0081090911D13E5());
			unk_0x95C55738CAE00A20(&uLocal_152);
			unk_0xC9567EA69F3CC4C2(0, "random@shop_robbery", "robbery_action_p", 1000f, -2f, -1, 134217736, 0.06f, 0, 0, 0);
			unk_0xC9567EA69F3CC4C2(0, "random@shop_robbery", "kneel_loop_p", 2f, -4f, -1, 134217737, 0f, 0, 0, 0);
			unk_0x70B222EEA46C37FA(uLocal_152);
			unk_0x3998B29E786DFD96(unk_0xA0081090911D13E5(), uLocal_152);
			unk_0x7DFD14B8B873D6B5(&uLocal_152);
			unk_0x2945E3CE39DA8591(unk_0xA0081090911D13E5(), 0, 0);
		}
		iLocal_136 = 1;
	...
	if ((iLocal_49 == 1 && unk_0xD3FACCDA4D66AEAD(iLocal_175)) || iLocal_49 == 2)
	{
		unk_0xC1B1E9A034A63A62(0);
		iLocal_47 = 1;
	}
...
void func_147()
{
	...
	else if (unk_0x2C1B5A0D3E233FC3(iVar0))
	{
		if (func_148())
		{
			if (unk_0xFD4DDA3E1EF89C67(uLocal_171, -828.3692f, -194.4669f, 36.41385f, -824.5801f, -201.1353f, 39.39436f, 4.3125f, 0, 1, 0))
			{
		...
		iLocal_175 = unk_0xE044C77D0FC9DB66(iVar0, Local_172, 31.9252f, 1, 1);
		unk_0xEDA527A4943E849D(iLocal_175, 1);
		unk_0x74207974B5483203(iLocal_175);
		unk_0x6F40E1EE32FE6A5E(iLocal_175, 1, 1, 0);
		iLocal_184 = unk_0x667A2CFA1914073C(iLocal_175, 26, joaat("g_m_y_korean_01"), -1, 1, 1);
		unk_0x705E4255B39314A7(iLocal_184, 134, 1);
		unk_0xFF5CE2ECB4FBD4A8(iLocal_184, 1);
		unk_0x65889F26F311FC55(iLocal_184, iLocal_190);
		unk_0x87BBAE0EE5DD7680(iLocal_184, 8, 0);
		unk_0x54753279989302A7(iLocal_184, 0);
		unk_0x76A0FFACB5B58711(iLocal_184, 13);
		unk_0x8942ADC0DB9F81E4(iLocal_184, joaat("weapon_pistol"), -1, 1, 1);
		unk_0xB1EC0D434D45E629(iLocal_184, 1, 0);
		unk_0x705E4255B39314A7(iLocal_184, 42, 1);
		iLocal_176 = 1;
	}
}
...
int func_148()
{
	...
	{
		if (unk_0x6E07DBF03F3AC258(iVar0, -829.3693f, -191.9869f, 36.4616f, 15f, 15f, 5f, 0, 1, 0))
		{
			uLocal_171 = iVar0;
			if (!unk_0x18C670321BC98FDA(uLocal_171))
			{
				unk_0x7B17650F15A8876D(uLocal_171, 1, 0);
			}
			return 1;
		}
	}
...
int func_151(int iParam0)
{
	if (func_152())
	{
		...
		if (func_58(Global_101542))
		{
			func_96(0);
		}
		unk_0xA57E42D9C41110A9(1, "RE_TITLE");
		if (iParam0 && func_58(Global_101542))
		{
...
int func_152()
{
	switch (func_153(&Global_25244, 0, 5, 0, unk_0xEAE20F1125B83888()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_156(iParam0, Global_35775);
}
...
int func_158()
{
	if (iLocal_49 == 1)
	{
		if (unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), -803.4598f, -175.8135f, 36.28367f, -823.0242f, -187.0462f, 40.53547f, 11.9375f, 0, 1, 0) || unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), -823.3706f, -188.0602f, 36.62162f, -822.8361f, -187.7466f, 39.06914f, 1.5f, 0, 1, 0))
		{
			return 1;
		}
	}
	...
	{
		if (((unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, 1, 0) && !unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), -1203.899f, -776.9178f, 20.16803f, -1201.289f, -780.4698f, 15.61526f, 3.9375f, 0, 1, 0)) && !unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, 1, 0)) && !unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, 1, 0))
		{
			return 1;
		}
	}
...
int func_160()
{
	...
	if (unk_0x6E07DBF03F3AC258(unk_0xA0081090911D13E5(), -823.1281f, -187.9591f, 36.6189f, 12f, 12f, 12f, 0, 1, 0) || unk_0x6E07DBF03F3AC258(unk_0xA0081090911D13E5(), -1201.017f, -777.5527f, 16.3398f, 12f, 12f, 12f, 0, 1, 0))
	{
		if (!unk_0xEB361B4BD195A4D3(iLocal_114[0]) && !unk_0xEB361B4BD195A4D3(iLocal_114[1]))
		{
			if (unk_0x4AEC0F4FC7FE62C7(iLocal_114[0], unk_0xA0081090911D13E5(), 1) || unk_0x4AEC0F4FC7FE62C7(iLocal_114[1], unk_0xA0081090911D13E5(), 1))
			{
				return 1;
			}
			if (unk_0x5CA53329DE05CCF7(iLocal_114[0], unk_0xA0081090911D13E5()) || unk_0x5CA53329DE05CCF7(iLocal_114[1], unk_0xA0081090911D13E5()))
			{
				if (((unk_0x97209242946B9B9F(unk_0x0C1D3C552325765B(), iLocal_114[0]) || unk_0x352F748C85BFEDC5(unk_0x0C1D3C552325765B(), iLocal_114[0])) || unk_0x97209242946B9B9F(unk_0x0C1D3C552325765B(), iLocal_114[1])) || unk_0x352F748C85BFEDC5(unk_0x0C1D3C552325765B(), iLocal_114[1]))
				{
					if (iLocal_126 == -1)
					{
				...
				if (iLocal_126 != -1 && unk_0xDF658EB6CA91DFBC() > iLocal_126 + 1500)
				{
					return 1;
				}
			}
	...
	if (unk_0x5C34581AE9065414(-1, Local_194 - Vector(20f, 20f, 20f), Local_194 + Vector(20f, 20f, 20f)))
	{
		return 1;
	}
	if (unk_0x912AD5A10E7633F0(iLocal_114[0], 0) || unk_0x912AD5A10E7633F0(iLocal_114[1], 0))
	{
		return 1;
	}
	if (unk_0x39FEE545B315414E(unk_0xA0081090911D13E5(), 0) && func_158())
	{
		return 1;
	}
	if (unk_0xFFE4F37124DBE6D9(unk_0xA0081090911D13E5()) && func_158())
	{
		return 1;
	}
	if (!unk_0xEB361B4BD195A4D3(iLocal_114[0]) && !unk_0xEB361B4BD195A4D3(iLocal_114[1]))
	{
		if (((unk_0x34C304F99D27E19A(unk_0xA0081090911D13E5(), unk_0xC59DF10B4FC39DF8(iLocal_114[1], 1) - Vector(12f, 12f, 12f), unk_0xC59DF10B4FC39DF8(iLocal_114[1], 1) + Vector(12f, 12f, 12f), 0, 1) && !unk_0x4CD028B657AD22EA(unk_0xA0081090911D13E5())) || unk_0xB53CC268A7051C62(unk_0xC59DF10B4FC39DF8(iLocal_114[0], 1), 3f, 1)) || unk_0xB53CC268A7051C62(unk_0xC59DF10B4FC39DF8(iLocal_114[1], 1), 3f, 1))
		{
			return 1;
		}
	}
	...
	while (iVar0 < iLocal_117)
	{
		if (unk_0xD3FACCDA4D66AEAD(iLocal_117[iVar0]))
		{
			if (unk_0x4AEC0F4FC7FE62C7(iLocal_117[iVar0], unk_0xA0081090911D13E5(), 1))
			{
				return 1;
			}
		}
	...
	while (iVar0 < iLocal_121)
	{
		if (unk_0xD3FACCDA4D66AEAD(iLocal_121[iVar0]))
		{
			if (unk_0x4AEC0F4FC7FE62C7(iLocal_121[iVar0], unk_0xA0081090911D13E5(), 1))
			{
				return 1;
			}
		}
...
int func_162()
{
	if (unk_0x6E07DBF03F3AC258(unk_0xA0081090911D13E5(), -823.1281f, -187.9591f, 36.6189f, 4f, 4f, 4f, 0, 1, 0) || unk_0x6E07DBF03F3AC258(unk_0xA0081090911D13E5(), -1201.017f, -777.5527f, 16.3398f, 4f, 4f, 4f, 0, 1, 0))
	{
...
void func_163()
{
	if (!unk_0xEB361B4BD195A4D3(iLocal_117[1]))
	{
		if (unk_0x1F1602FD864AA4C1(iLocal_117[1]))
		{
		...
		unk_0xA4FBF6E76C1B1672(iLocal_117[1], 26, 0, 0);
	}
	if (!unk_0xEB361B4BD195A4D3(iLocal_121[1]))
	{
		func_164(iLocal_121[1], "SCREAM_PANIC", "WAVELOAD_PAIN_FEMALE", 3);
		unk_0xA4FBF6E76C1B1672(iLocal_121[1], 3, 0, 0);
	}
}

void func_164(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	unk_0x9A1116B636E7177A(uParam0, sParam1, sParam2, func_165(iParam3), 0);
}
...
void func_166()
{
	...
	unk_0xD8C3303D0A49D05B("ROBBERS", &iLocal_190);
	iVar0 = 0;
	while (iVar0 <= (iLocal_111 - 1))
	{
		iLocal_114[iVar0] = unk_0xF8418B3B87CFCCBF(26, iLocal_222, Local_55[iVar0 /*3*/], fLocal_62[iVar0], 1, 1);
		unk_0xFF5CE2ECB4FBD4A8(iLocal_114[iVar0], 1);
		unk_0x65889F26F311FC55(iLocal_114[iVar0], iLocal_190);
		unk_0x87BBAE0EE5DD7680(iLocal_114[iVar0], 8, 0);
		unk_0x54753279989302A7(iLocal_114[iVar0], 0);
		unk_0x76A0FFACB5B58711(iLocal_114[iVar0], 13);
		unk_0x8942ADC0DB9F81E4(iLocal_114[iVar0], joaat("weapon_pistol"), -1, 1, 1);
		unk_0xB1EC0D434D45E629(iLocal_114[iVar0], 1, 0);
		unk_0x705E4255B39314A7(iLocal_114[iVar0], 42, 1);
		unk_0x705E4255B39314A7(iLocal_114[iVar0], 269, 1);
		unk_0x705E4255B39314A7(iLocal_114[iVar0], 188, 1);
		unk_0xEBC040B50DB4346A(iLocal_114[iVar0], 0);
		unk_0x797AA7825A5A2D95(iLocal_114[iVar0], 128, 1);
		unk_0x797AA7825A5A2D95(iLocal_114[iVar0], 8, 1);
		iVar0++;
	}
	unk_0xDB721F9F36A8FE26(iLocal_114[0], "pedRobber[0]");
	unk_0xDB721F9F36A8FE26(iLocal_114[1], "pedRobber[1]");
	unk_0xFDDE2C1A05E64390(5, iLocal_190, joaat("player"));
	unk_0xFDDE2C1A05E64390(5, joaat("player"), iLocal_190);
	unk_0xFDDE2C1A05E64390(5, iLocal_190, joaat("COP"));
	unk_0xFDDE2C1A05E64390(5, joaat("COP"), iLocal_190);
	if (func_39() == 0)
	{
		func_171(&uLocal_232, 0, unk_0xA0081090911D13E5(), "MICHAEL", 0, 1);
	}
	else if (func_39() == 1)
	{
		func_171(&uLocal_232, 0, unk_0xA0081090911D13E5(), "FRANKLIN", 0, 1);
	}
	else if (func_39() == 2)
	{
		func_171(&uLocal_232, 0, unk_0xA0081090911D13E5(), "TREVOR", 0, 1);
	}
	iLocal_167 = unk_0xE1C25770C2FB7AE3(iLocal_188, Local_97, 1, 1, 0);
	if (iLocal_49 == 1)
	{
		unk_0x6A173E5A316F6DE8(Local_128 - Vector(20f, 20f, 20f), Local_128 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
		unk_0x3607936F13065720(joaat("baller"), 1);
		uLocal_168[0] = unk_0xE1C25770C2FB7AE3(joaat("prop_anim_cash_pile_01"), Local_97, 1, 1, 0);
		uLocal_168[1] = unk_0xE1C25770C2FB7AE3(joaat("prop_anim_cash_pile_01"), Local_97 - Vector(0.1f, 0f, 0f), 1, 1, 0);
		unk_0xD97F9F0D7231AC43(iLocal_114[0], "G_M_Y_KorLieut_01_Korean_MINI_01");
		unk_0xD97F9F0D7231AC43(iLocal_114[1], "G_M_Y_Korean_01_Korean_MINI_02");
		Local_201 = { -821.565f, -186.467f, 36.6f };
		Local_207 = { 0f, 0f, -59.96f };
		uLocal_216 = unk_0x6194C3993E6BB2A5(Local_201, Local_207, 2);
		unk_0x530044AE9D695B53(uLocal_216, 1);
		unk_0xCAD643E9EAD85BD2(iLocal_114[1], uLocal_216, "random@shop_robbery", "robbery_intro_loop_a", 8f, -8f, 0, 0, 1148846080, 0);
		unk_0x6101ECFE82230F9B(iLocal_167, uLocal_216, "robbery_intro_loop_bag", "random@shop_robbery", 1000f, 1090519040, 0, 1148846080);
		iVar0 = 0;
		while (iVar0 <= (iLocal_112 - 1))
		{
			iLocal_117[iVar0] = unk_0xF8418B3B87CFCCBF(26, iLocal_219, Local_65[iVar0 /*3*/], fLocal_75[iVar0], 1, 1);
			unk_0x87BBAE0EE5DD7680(iLocal_117[iVar0], 17, 1);
			unk_0xFF5CE2ECB4FBD4A8(iLocal_117[iVar0], 1);
			unk_0xB43604F27F1EAE5F(iLocal_117[iVar0], 0);
			unk_0x705E4255B39314A7(iLocal_117[iVar0], 269, 1);
			iVar0++;
		}
		unk_0xDB721F9F36A8FE26(iLocal_117[0], "pedWorker[0]");
		unk_0xDB721F9F36A8FE26(iLocal_117[1], "pedWorker[1]");
		unk_0xDB721F9F36A8FE26(iLocal_117[2], "pedWorker[2]");
		iLocal_121[0] = unk_0xF8418B3B87CFCCBF(26, iLocal_220, Local_79[0 /*3*/], fLocal_92[0], 1, 1);
		unk_0x87BBAE0EE5DD7680(iLocal_121[0], 17, 1);
		unk_0xFF5CE2ECB4FBD4A8(iLocal_121[0], 1);
		unk_0xB43604F27F1EAE5F(iLocal_121[0], 0);
		unk_0x705E4255B39314A7(iLocal_121[0], 269, 1);
		iVar0 = 1;
		while (iVar0 <= 2)
		{
			iLocal_121[iVar0] = unk_0xF8418B3B87CFCCBF(26, iLocal_221, Local_79[iVar0 /*3*/], fLocal_92[iVar0], 1, 1);
			unk_0x87BBAE0EE5DD7680(iLocal_121[iVar0], 17, 1);
			unk_0xFF5CE2ECB4FBD4A8(iLocal_121[iVar0], 1);
			unk_0xB43604F27F1EAE5F(iLocal_121[iVar0], 0);
			unk_0x705E4255B39314A7(iLocal_121[iVar0], 269, 1);
			iVar0++;
		}
		unk_0xDB721F9F36A8FE26(iLocal_121[0], "pedShopper[0]");
		unk_0xDB721F9F36A8FE26(iLocal_121[1], "pedShopper[1]");
		unk_0xDB721F9F36A8FE26(iLocal_121[2], "pedShopper[2]");
		unk_0xA27FDFE5C0EBB875(iLocal_117[0], 0, 0, 0, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_117[0], 2, 1, 1, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_117[0], 3, 1, 0, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_117[0], 4, 0, 0, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_117[0], 5, 0, 0, 0);
		unk_0xCAD643E9EAD85BD2(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_intro_loop_f", 8f, -8f, 0, 0, 1148846080, 0);
		unk_0xD97F9F0D7231AC43(iLocal_117[0], "A_M_Y_BevHills_01_White_Mini_01");
		func_171(&uLocal_232, 5, iLocal_117[0], "REROBShopworker", 0, 1);
		unk_0xA27FDFE5C0EBB875(iLocal_117[1], 0, 1, 0, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_117[1], 2, 0, 0, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_117[1], 3, 0, 0, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_117[1], 4, 1, 2, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_117[1], 5, 0, 0, 0);
		unk_0x9A213173324A528B(iLocal_117[1], -1);
		unk_0x77637031DE326F70(iLocal_117[1], 1);
		unk_0xA27FDFE5C0EBB875(iLocal_117[2], 0, 1, 0, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_117[2], 2, 1, 0, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_117[2], 3, 0, 2, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_117[2], 4, 1, 2, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_117[2], 5, 0, 0, 0);
		unk_0x9A213173324A528B(iLocal_117[2], -1);
		unk_0x77637031DE326F70(iLocal_117[2], 1);
		uLocal_216 = unk_0x6194C3993E6BB2A5(-812.37f, -185.65f, 37.5804f, 0f, 0f, 30f, 2);
		unk_0x530044AE9D695B53(uLocal_216, 1);
		unk_0xA27FDFE5C0EBB875(iLocal_121[0], 0, 0, 1, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_121[0], 2, 0, 0, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_121[0], 3, 0, 1, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_121[0], 4, 0, 1, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_121[0], 8, 0, 0, 0);
		unk_0xCAD643E9EAD85BD2(iLocal_121[0], uLocal_216, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0x77637031DE326F70(iLocal_121[0], 1);
		uLocal_216 = unk_0x6194C3993E6BB2A5(-817.5606f, -190.8273f, 37.6114f, 0f, 0f, 25.8399f, 2);
		unk_0x530044AE9D695B53(uLocal_216, 1);
		unk_0xA27FDFE5C0EBB875(iLocal_121[1], 0, 0, 0, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_121[1], 2, 0, 1, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_121[1], 3, 1, 1, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_121[1], 4, 1, 1, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_121[1], 8, 0, 0, 0);
		unk_0xCAD643E9EAD85BD2(iLocal_121[1], uLocal_216, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0x77637031DE326F70(iLocal_121[1], 1);
		uLocal_216 = unk_0x6194C3993E6BB2A5(-816.1862f, -182.897f, 37.68f, 0f, 0f, 30f, 2);
		unk_0x530044AE9D695B53(uLocal_216, 1);
		unk_0xA27FDFE5C0EBB875(iLocal_121[2], 0, 1, 0, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_121[2], 2, 0, 2, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_121[2], 3, 0, 1, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_121[2], 4, 1, 0, 0);
		unk_0xA27FDFE5C0EBB875(iLocal_121[2], 8, 0, 0, 0);
		unk_0xCAD643E9EAD85BD2(iLocal_121[2], uLocal_216, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0x77637031DE326F70(iLocal_121[2], 1);
		unk_0x55F009A57228A86D(iLocal_114[0], iLocal_117[0], -1, 0);
		unk_0x965CFA6E4E433BDE(-871f, -246f, 0f, -798f, -163f, 50f, 0, 1);
		unk_0x4BD80690941D84BE("Hairdresser1");
		func_170(0, 1);
		func_169(0);
	...
	{
		unk_0x6A173E5A316F6DE8(Local_131 - Vector(20f, 20f, 20f), Local_131 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
		unk_0x4A1ACDDF793F9777(iLocal_167, Local_100, 2, 1);
		iLocal_117[0] = unk_0xF8418B3B87CFCCBF(26, iLocal_219, Local_65[0 /*3*/], fLocal_75[0], 1, 1);
		unk_0xDB721F9F36A8FE26(iLocal_117[0], "pedWorker[0]");
		unk_0xD97F9F0D7231AC43(iLocal_117[0], "A_M_Y_BeachVesp_01_White_Mini_01");
		func_171(&uLocal_232, 6, iLocal_117[0], "REROBShopworker2", 0, 1);
		iLocal_117[1] = unk_0xF8418B3B87CFCCBF(26, iLocal_218, Local_65[1 /*3*/], fLocal_75[1], 1, 1);
		unk_0xDB721F9F36A8FE26(iLocal_117[1], "pedWorker[1]");
		iVar0 = 0;
		while (iVar0 <= (iLocal_112 - 1))
		{
		...
		iLocal_121[0] = unk_0xF8418B3B87CFCCBF(26, iLocal_220, Local_79[0 /*3*/], fLocal_92[0], 1, 1);
		unk_0xDB721F9F36A8FE26(iLocal_121[0], "pedShopper[0]");
		iLocal_121[1] = unk_0xF8418B3B87CFCCBF(26, iLocal_221, Local_79[1 /*3*/], fLocal_92[1], 1, 1);
		unk_0xDB721F9F36A8FE26(iLocal_121[1], "pedShopper[1]");
		iVar0 = 0;
		...
		unk_0xC9567EA69F3CC4C2(iLocal_117[0], "random@shop_robbery", "robbery_intro_loop_f", 4f, -4f, -1, 9, 0f, 0, 0, 0);
		unk_0x77637031DE326F70(iLocal_117[0], 1);
		unk_0xC9567EA69F3CC4C2(iLocal_117[1], "random@robbery", "f_cower_02", 4f, -4f, -1, 9, 0f, 0, 0, 0);
		unk_0x77637031DE326F70(iLocal_117[1], 1);
		unk_0x9A213173324A528B(iLocal_121[0], -1);
		unk_0x77637031DE326F70(iLocal_121[0], 1);
		unk_0xC9567EA69F3CC4C2(iLocal_121[1], "random@robbery", "f_cower_01", 4f, -4f, -1, 9, 0f, 0, 0, 0);
		unk_0x77637031DE326F70(iLocal_121[1], 1);
		Local_201 = { -1192.01f, -768.929f, 16.358f };
		Local_207 = { 0f, 0f, -59.5f };
		uLocal_216 = unk_0x6194C3993E6BB2A5(Local_201, Local_207, 2);
		unk_0x530044AE9D695B53(uLocal_216, 1);
		unk_0xCAD643E9EAD85BD2(iLocal_114[0], uLocal_216, "random@shop_robbery", "robbery_intro_loop_b", 2f, -2f, 0, 0, 1148846080, 0);
		unk_0xCAD643E9EAD85BD2(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_intro_loop_f", 2f, -2f, 0, 0, 1148846080, 0);
		unk_0xC9567EA69F3CC4C2(iLocal_114[1], "random@shop_robbery", "robbery_intro_loop_a", 16f, -4f, -1, 9, 0f, 0, 0, 0);
		func_170(14, 1);
		func_169(14);
		unk_0x4EDE34FBADD967A6(500);
		func_167(14, 0, 0);
	...
	unk_0x2C07692AA3545079(joaat("a_f_y_bevhills_02"));
	unk_0x2C07692AA3545079(joaat("a_m_y_bevhills_02"));
	unk_0x2C07692AA3545079(joaat("a_m_y_hipster_01"));
	unk_0x2C07692AA3545079(joaat("a_f_y_hipster_04"));
	unk_0x2C07692AA3545079(joaat("g_m_y_korean_01"));
}
...
void func_172()
{
	if (!iLocal_135)
	{
		iLocal_153 = unk_0xDACF94AE8FA53F42(Local_55[0 /*3*/]);
		unk_0x493EEE1A031FD768(iLocal_153);
		iLocal_135 = 1;
	}
}
...
void func_173()
{
	unk_0x491067A8E906F22D(iLocal_219);
	unk_0x491067A8E906F22D(iLocal_220);
	unk_0x491067A8E906F22D(iLocal_221);
	unk_0x491067A8E906F22D(iLocal_222);
	unk_0x491067A8E906F22D(joaat("prop_anim_cash_pile_01"));
	unk_0x491067A8E906F22D(joaat("prop_cs_duffel_01"));
	unk_0x4D45DF6114075356("re_shoprobbery");
	unk_0x4D45DF6114075356("re_shoprobbery2");
	unk_0xA9DC3948106CC3E4("random@robbery");
	unk_0xA9DC3948106CC3E4("random@shop_robbery");
	unk_0x27971883A8701E73("RE51A_SHOP");
	if ((((((((((unk_0x2C1B5A0D3E233FC3(iLocal_219) && unk_0x2C1B5A0D3E233FC3(iLocal_220)) && unk_0x2C1B5A0D3E233FC3(iLocal_221)) && unk_0x2C1B5A0D3E233FC3(iLocal_222)) && unk_0x2C1B5A0D3E233FC3(joaat("prop_anim_cash_pile_01"))) && unk_0x2C1B5A0D3E233FC3(joaat("prop_cs_duffel_01"))) && unk_0x3E85D449D6D4832B("re_shoprobbery")) && unk_0x3E85D449D6D4832B("re_shoprobbery2")) && unk_0xAD21C77209FD2024("random@robbery")) && unk_0xAD21C77209FD2024("random@shop_robbery")) && unk_0x27971883A8701E73("RE51A_SHOP"))
	{
		iLocal_53 = 1;
	}
	else
...
int func_175()
{
	if (unk_0xC0691D80D21C989D(unk_0x0C1D3C552325765B()) && !unk_0xEB361B4BD195A4D3(unk_0xA0081090911D13E5()))
	{
		...
		if (unk_0xA8CEACB4F35AE058(unk_0x24D47569A04F80A8(unk_0xA0081090911D13E5())) > 1369f && !func_186())
		{
			return 0;
		}
	}
...
int func_188()
{
	if ((Global_101542 == func_67() && unk_0x0D9CC5C2000C6EA4()) && Global_101543)
	{
		return 1;
	}
	return 0;
...
int func_192(struct<3> Param0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		...
		if (!func_216(Global_101553.f_29685.f_43[iParam3]))
		{
			return 0;
		}
		...
		if (unk_0xD3FACCDA4D66AEAD(unk_0xA0081090911D13E5()))
		{
			if (!unk_0xEB361B4BD195A4D3(unk_0xA0081090911D13E5()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xE7B06BF48958E63C(unk_0x0C1D3C552325765B(), 1) || func_214()) || Global_25187) || func_213()) || func_121(8, -1)) || func_210()) || func_212()) || func_211()) || func_209()) || Global_101553.f_6543.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0xB8E921FDBC0BA08C(unk_0x0C1D3C552325765B()) || unk_0x630BD2AFB0686BBA(unk_0xA0081090911D13E5())) || unk_0x69FEFE28E1352842(unk_0xA0081090911D13E5())) || unk_0xFFE4F37124DBE6D9(unk_0xA0081090911D13E5())) || unk_0x96E535A40E0E0B83(unk_0xA0081090911D13E5())) || unk_0xE7B06BF48958E63C(unk_0x0C1D3C552325765B(), 1)) || unk_0x2FFAB3D2307F1BA7(unk_0x0C1D3C552325765B())) || unk_0x019E78F3A1071807(unk_0xA0081090911D13E5(), 0)) || func_214()) || Global_100600) || Global_25187) || func_213()) || func_121(8, -1)) || func_210()) || func_212()) || func_211()) || func_209()) || Global_101553.f_6543.f_919[iVar0] == 5) || Global_36322 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0xFFE4F37124DBE6D9(unk_0xA0081090911D13E5()) || unk_0x96E535A40E0E0B83(unk_0xA0081090911D13E5())) || unk_0xE7B06BF48958E63C(unk_0x0C1D3C552325765B(), 1)) || unk_0x019E78F3A1071807(unk_0xA0081090911D13E5(), 0)) || func_214()) || Global_100600) || Global_25187) || func_213()) || func_121(8, -1)) || func_212()) || func_211()) || func_209()) || Global_101553.f_6543.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_214() || unk_0x7DC70BB637724B43(unk_0x0C1D3C552325765B()) > 0) || func_121(8, -1)) || func_209()) || func_208()) || Global_101553.f_6543.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((unk_0x019E78F3A1071807(unk_0xA0081090911D13E5(), 0) || !unk_0xDC48E9E2CC7437D3(unk_0x0C1D3C552325765B())) || !unk_0xB8E921FDBC0BA08C(unk_0x0C1D3C552325765B())) || !unk_0xB20CA7A3EE29687A()) || unk_0x630BD2AFB0686BBA(unk_0xA0081090911D13E5())) || unk_0xFFE4F37124DBE6D9(unk_0xA0081090911D13E5())) || unk_0x96E535A40E0E0B83(unk_0xA0081090911D13E5())) || unk_0xE7B06BF48958E63C(unk_0x0C1D3C552325765B(), 1)) || func_214()) || func_211()) || Global_100600) || Global_25187) || func_213()) || Global_36906) || func_121(8, -1)) || func_210()) || func_208()) || func_209()) || Global_101553.f_6543.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_224()
{
	...
	{
		func_125(0);
		unk_0x8821193EA2732C2C("RE51A_SHOP");
		unk_0x8E3DB58E9EDB1597();
		unk_0x5D4C739EF48A09AE(-871f, -246f, 0f, -798f, -163f, 50f, 1);
		unk_0x3134206142001736("re_shoprobbery");
		unk_0x3134206142001736("re_shoprobbery2");
		iVar0 = 0;
		while (iVar0 <= (iLocal_111 - 1))
		{
			if (unk_0xD3FACCDA4D66AEAD(iLocal_114[iVar0]))
			{
				if (!unk_0xEB361B4BD195A4D3(iLocal_114[iVar0]) && !unk_0x39FEE545B315414E(iLocal_114[iVar0], 0))
				{
					unk_0x8D95319102961B7A(iLocal_114[iVar0], Local_103, 150f, -1, 0, 0);
					unk_0x77637031DE326F70(iLocal_114[iVar0], 1);
				}
				unk_0x0689C659BF2D3BF7(&(iLocal_114[iVar0]));
			}
		...
		while (iVar0 <= (iLocal_113 - 1))
		{
			if (unk_0xD3FACCDA4D66AEAD(iLocal_121[iVar0]))
			{
				if (!unk_0xEB361B4BD195A4D3(iLocal_121[iVar0]))
				{
					unk_0xEDA527A4943E849D(iLocal_121[iVar0], 1);
					unk_0x95C55738CAE00A20(&uLocal_152);
					if (iLocal_49 == 1)
					{
						unk_0xC9567EA69F3CC4C2(0, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, 0, 1, 0);
					...
					{
						unk_0xD3032BAC1ECE011F(iLocal_121[iVar0]);
						unk_0x1429584A1E80336C(0, -1201.476f, -790.2733f, 15.5475f, 2f, -1, 1048576000, 0, 1193033728);
					}
					unk_0x8D95319102961B7A(0, Local_103, 150f, -1, 0, 0);
					unk_0x70B222EEA46C37FA(uLocal_152);
					unk_0x3998B29E786DFD96(iLocal_121[iVar0], uLocal_152);
					unk_0x7DFD14B8B873D6B5(&uLocal_152);
					unk_0x77637031DE326F70(iLocal_121[iVar0], 1);
				}
			}
		...
		while (iVar0 <= (iLocal_112 - 1))
		{
			if (unk_0xD3FACCDA4D66AEAD(iLocal_117[iVar0]))
			{
				if (!unk_0xEB361B4BD195A4D3(iLocal_117[iVar0]))
				{
					unk_0x705E4255B39314A7(iLocal_117[iVar0], 317, 1);
					unk_0xEDA527A4943E849D(iLocal_117[iVar0], 1);
					if (iVar0 == 0)
					{
						if (!iLocal_183)
						{
							unk_0xD3032BAC1ECE011F(iLocal_117[iVar0]);
							unk_0x8D95319102961B7A(iLocal_117[iVar0], Local_103, 150f, -1, 0, 0);
						}
						else
						{
							unk_0xFF5CE2ECB4FBD4A8(iLocal_117[iVar0], 0);
						}
					}
					else
					{
						...
						unk_0x8D95319102961B7A(0, Local_103, 150f, -1, 0, 0);
						unk_0x70B222EEA46C37FA(uLocal_152);
						unk_0x3998B29E786DFD96(iLocal_117[iVar0], uLocal_152);
						unk_0x7DFD14B8B873D6B5(&uLocal_152);
					}
					unk_0xFF5CE2ECB4FBD4A8(iLocal_117[iVar0], 0);
					unk_0xB43604F27F1EAE5F(iLocal_117[iVar0], 1);
				}
			}
			iVar0++;
		}
		...
		if (unk_0xD3FACCDA4D66AEAD(iLocal_167))
		{
			...
			unk_0xDABCA6C17F8B4208(&iLocal_167);
		}
		if (unk_0xD3FACCDA4D66AEAD(iLocal_175))
		{
			unk_0x615DE34FC732CF11(&iLocal_175);
...
void func_225(int iParam0)
{
	...
	if (func_188())
	{
		...
		func_228(30000);
		StringCopy(&cVar0, func_227(Global_101542, 1), 64);
		if (func_66(Global_101542) > 0)
		{
...
Vector3 func_238()
{
	...
	if (unk_0xC0691D80D21C989D(unk_0x0C1D3C552325765B()))
	{
		fVar0 = unk_0x999A157665D69393(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), Local_128, 1);
		iLocal_127 = 1;
		if (unk_0x999A157665D69393(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), Local_131, 1) < fVar0)
		{
			fVar0 = unk_0x999A157665D69393(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), Local_131, 1);
			iLocal_127 = 2;
		}
		if (iLocal_127 == 1)
		{
