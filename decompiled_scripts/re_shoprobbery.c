...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (unk_0x173751E886F8E9AB() || iLocal_164)
		{
			if (!func_198())
			{
				if (func_197())
					...
					case 1:
						switch (iLocal_46)
						{
							case 0:
								...
								{
									func_182();
									if (unk_0xD0B0D1BD29678350(iLocal_153))
									{
										func_176();
										iLocal_137 = 1;
									}
								...
								else
								{
									...
									func_173();
									unk_0xBBB6D0F765409642(iLocal_153);
									if (func_172())
									{
										if (!iLocal_159)
										{
									...
									if (func_170())
									{
										if (unk_0xC450B06E5AAA0985(uLocal_193))
										{
											unk_0xFE54B8568B2ABD12(&uLocal_193);
										}
										...
										{
											if (!unk_0x4FAFF4BCB7633475(iLocal_114[iVar0]))
											{
												unk_0x62A5310368A20EFA(iLocal_114[iVar0], unk_0x4A8C381C258A124D(), 0, 16);
												unk_0x44FB298D6382876D(iLocal_114[iVar0], 1);
												if (!unk_0xC450B06E5AAA0985(uLocal_185[iVar0]))
												{
										...
										if (iLocal_49 == 2)
										{
											...
											{
												if (!unk_0x4FAFF4BCB7633475(iLocal_117[iVar0]))
												{
													unk_0xAFC7A89C990C4339(iLocal_117[iVar0], -1);
													unk_0x44FB298D6382876D(iLocal_117[iVar0], 1);
												}
												iVar0++;
											}
											iVar0 = 0;
											...
											{
												if (!unk_0x4FAFF4BCB7633475(iLocal_121[iVar0]))
												{
													unk_0xAFC7A89C990C4339(iLocal_121[iVar0], -1);
													unk_0x44FB298D6382876D(iLocal_121[iVar0], 1);
												}
												iVar0++;
											}
										}
										unk_0x51C8BEA2005931AB(&iLocal_167);
										bLocal_140 = true;
										iLocal_46 = 1;
										iLocal_47 = 3;
									}
									if (func_168())
									{
										...
										unk_0x18B384412B836744(90, Local_194, 15000f);
										iLocal_46 = 1;
									}
								}
								break;
							...
							case 1:
								...
								{
									if (unk_0xFC8BFE4B41177C22(iLocal_117[iVar1]))
									{
										if (unk_0x9B3D4335E0EDB0BE(iLocal_117[iVar1], unk_0x4A8C381C258A124D(), 1))
										{
											func_160();
										}
									}
								...
								{
									if (unk_0xFC8BFE4B41177C22(iLocal_121[iVar1]))
									{
										if (unk_0x9B3D4335E0EDB0BE(iLocal_121[iVar1], unk_0x4A8C381C258A124D(), 1))
										{
											func_160();
										}
									}
								...
								switch (iLocal_47)
								{
									...
									case 2:
										...
										if (unk_0xC9D9444186B5A374() > 500)
										{
											...
											{
												if (!unk_0xA3736D76B0E93E93(iLocal_167))
												{
													func_149();
													unk_0x3C0F448853B71C92(iLocal_114[0], joaat("weapon_unarmed"), 1);
													unk_0x4D306DD94DD6FDBA(iLocal_167, iLocal_114[0], unk_0x72F7E39FB49FC0BA(iLocal_114[0], 57005), 0.3f, 0f, 0f, 80f, -90f, 0f, 1, 1, 0, 0, 2, 1, 0);
												}
											}
										}
										if (unk_0xE94C7FA27FEB00DD(Local_194 - Vector(20f, 20f, 20f), Local_194 + Vector(20f, 20f, 20f), 0))
										{
											if (!unk_0x4FAFF4BCB7633475(iLocal_117[1]))
											{
												unk_0xFD251F92B546F389(iLocal_117[1], Local_103, 150f, -1, 0, 0);
												unk_0xAAA71DD7E9059338(iLocal_117[1], 0);
												unk_0xF09E30AF1B8FB379(&(iLocal_117[1]));
											}
											if (!unk_0x4FAFF4BCB7633475(iLocal_117[2]))
											{
												unk_0xFD251F92B546F389(iLocal_117[2], Local_103, 150f, -1, 0, 0);
												unk_0xAAA71DD7E9059338(iLocal_117[2], 0);
												unk_0xF09E30AF1B8FB379(&(iLocal_117[2]));
											}
											iVar2 = 0;
											while (iVar2 <= (iLocal_113 - 1))
											{
												if (!unk_0x4FAFF4BCB7633475(iLocal_121[iVar2]))
												{
													unk_0x788F35D395511DFE(iLocal_121[iVar2], 1, 1);
													unk_0xB5396F1FB088FE38(&uLocal_152);
													if (iLocal_49 == 1)
													{
													...
													unk_0xFD251F92B546F389(0, Local_103, 150f, -1, 0, 0);
													unk_0x93C0674FC00824D0(uLocal_152);
													unk_0x4BD42B0527065BB6(iLocal_121[iVar2], uLocal_152);
													unk_0xD0557B139A542F12(&uLocal_152);
													unk_0x44FB298D6382876D(iLocal_121[iVar2], 1);
													unk_0xAAA71DD7E9059338(iLocal_121[iVar2], 0);
													unk_0x3F58BFCF656F0DF1(iLocal_121[iVar2], 1);
													unk_0xF09E30AF1B8FB379(&(iLocal_121[iVar2]));
												}
												iVar2++;
											}
										}
										if (func_148() || unk_0x83666F9FB8FEBD4B() > 20000)
										{
											if (!iLocal_164)
											{
												if (!unk_0x1C2F771CDC87A3A5(iLocal_114[0], 0))
												{
													...
													if (iLocal_49 == 1)
													{
														if (unk_0xFC8BFE4B41177C22(iLocal_167))
														{
															unk_0x4285E11B28063EE0(iLocal_167, 0, 0);
													...
													while (iVar1 < iLocal_117)
													{
														if (!unk_0x4FAFF4BCB7633475(iLocal_117[iVar1]))
														{
															unk_0xAAA71DD7E9059338(iLocal_117[iVar1], 0);
														}
														iVar1++;
													}
													iVar1 = 0;
													while (iVar1 < iLocal_121)
													{
														if (!unk_0x4FAFF4BCB7633475(iLocal_121[iVar1]))
														{
															unk_0xAAA71DD7E9059338(iLocal_121[iVar1], 0);
														}
														iVar1++;
													}
													if (!unk_0x4FAFF4BCB7633475(iLocal_117[0]))
													{
														unk_0xAAA71DD7E9059338(iLocal_117[0], 1);
														unk_0xB5396F1FB088FE38(&uLocal_152);
														unk_0x10425721983AE158(0, "random@robbery", "f_distressed_loop", 2f, -2f, -1, 9, 0f, 0, 0, 0);
														unk_0x93C0674FC00824D0(uLocal_152);
														unk_0x4BD42B0527065BB6(iLocal_117[0], uLocal_152);
														unk_0xD0557B139A542F12(&uLocal_152);
														unk_0x44FB298D6382876D(iLocal_117[0], 1);
													}
													if (!func_132())
													{
										...
										if (!iLocal_139)
										{
											...
											{
												if (unk_0x82E64DE58A6B84A8(unk_0x4A8C381C258A124D(), "random@shop_robbery", "kneel_getup_p") > 0.7f || (unk_0x82E64DE58A6B84A8(unk_0x4A8C381C258A124D(), "random@shop_robbery", "kneel_getup_p") > 0.6f && func_115(64)))
												{
										...
										if (iLocal_49 == 1)
										{
											...
											if (!unk_0x4FAFF4BCB7633475(iLocal_114[0]) && unk_0xD9F5E1FEFD1329E4(iLocal_175, 0))
											{
												if (unk_0xCECDBB848D53DEB2(iLocal_114[0], iLocal_175, 0))
												{
													if (unk_0xFC8BFE4B41177C22(iLocal_167))
													{
														unk_0x51C8BEA2005931AB(&iLocal_167);
											...
											{
												if (unk_0xC450B06E5AAA0985(uLocal_185[0]))
												{
													unk_0xFE54B8568B2ABD12(&(uLocal_185[0]));
												}
												if (unk_0xC450B06E5AAA0985(uLocal_185[1]))
												{
													unk_0xFE54B8568B2ABD12(&(uLocal_185[1]));
												}
												if (!unk_0xC450B06E5AAA0985(uLocal_191))
												{
													uLocal_191 = func_111(iLocal_175, 1, 0);
												}
												bLocal_161 = true;
												if (!unk_0x4FAFF4BCB7633475(iLocal_184))
												{
													unk_0xBE8796DB2B90A437(iLocal_184, 17, 1);
													unk_0xBE8796DB2B90A437(iLocal_184, 6, 1);
													unk_0xBE8796DB2B90A437(iLocal_184, 1, 1);
													unk_0x13DE13EA38996410(iLocal_184, iLocal_175, unk_0x4A8C381C258A124D(), 8, 16f, 786469, -1f, -1f, 1);
													unk_0x44FB298D6382876D(iLocal_184, 1);
													iLocal_162 = 1;
												}
											}
											if (iLocal_162 && !iLocal_224)
											{
												if (unk_0xD9F5E1FEFD1329E4(iLocal_175, 0) && !unk_0x4FAFF4BCB7633475(iLocal_184))
												{
													if (!unk_0x65FFA94B82A71741(iLocal_175, Local_55[0 /*3*/], 20f, 20f, 10f, 0, 1, 0))
													{
														unk_0x13DE13EA38996410(iLocal_184, iLocal_175, unk_0x4A8C381C258A124D(), 8, 19f, 786469, -1f, -1f, 1);
														iLocal_224 = 1;
													}
												}
											}
											if (func_110())
											{
												if (!unk_0x4FAFF4BCB7633475(iLocal_184))
												{
													if (unk_0xD9F5E1FEFD1329E4(iLocal_175, 0))
													{
														if (!iLocal_163)
														{
															unk_0xBE8796DB2B90A437(iLocal_184, 17, 1);
															unk_0xBE8796DB2B90A437(iLocal_184, 6, 1);
															unk_0xBE8796DB2B90A437(iLocal_184, 1, 1);
															unk_0x13DE13EA38996410(iLocal_184, iLocal_175, unk_0x4A8C381C258A124D(), 8, 17f, 786469, -1f, -1f, 1);
															iLocal_163 = 1;
														}
														if (!unk_0x4FAFF4BCB7633475(iLocal_114[0]))
														{
															if (unk_0xCECDBB848D53DEB2(iLocal_114[0], iLocal_175, 0))
															{
																if (unk_0xC450B06E5AAA0985(uLocal_185[0]))
												...
												while (iVar3 <= (iLocal_111 - 1))
												{
													if (!iLocal_141[iVar3])
													{
														if (!unk_0x4FAFF4BCB7633475(iLocal_114[iVar3]))
														{
															if (unk_0x7F420695E3F776FB(iLocal_114[iVar3], 0) && !unk_0x4FAFF4BCB7633475(iLocal_184))
															{
																unk_0xD83588CA24829967(iLocal_114[iVar3], unk_0x4A8C381C258A124D(), 0, 0.3f, 0.7f, 1.9f, -1f, 15, 0, -753768974);
																iLocal_141[iVar3] = 1;
															}
															else if (!unk_0xC450B06E5AAA0985(uLocal_192))
															{
																unk_0x62A5310368A20EFA(iLocal_114[iVar3], unk_0x4A8C381C258A124D(), 0, 16);
																unk_0x44FB298D6382876D(iLocal_114[iVar3], 1);
																if (unk_0xC450B06E5AAA0985(uLocal_191))
																{
																	unk_0xFE54B8568B2ABD12(&uLocal_191);
																}
																if (!unk_0xC450B06E5AAA0985(uLocal_185[iVar3]))
																{
													...
													if (!iLocal_144[iVar3])
													{
														if (unk_0xD9F5E1FEFD1329E4(iLocal_175, 0))
														{
															if (!unk_0x4FAFF4BCB7633475(iLocal_114[iVar3]))
															{
																if ((unk_0x4FAFF4BCB7633475(iLocal_184) || unk_0xC39AE5D390581AD5(iLocal_175, -1, 0)) || unk_0x5B702A5D1F2635BE(iLocal_114[iVar3]))
																{
																	unk_0x788F35D395511DFE(iLocal_114[iVar3], 1, 1);
																	unk_0xB5396F1FB088FE38(&uLocal_152);
																	unk_0x092B9247AF00F5CF(0, 0, 0);
																	unk_0xD844F5E50DAB6FF7(0, unk_0x4A8C381C258A124D(), 300f, -1, 0, 0);
																	unk_0x93C0674FC00824D0(uLocal_152);
																	unk_0x4BD42B0527065BB6(iLocal_114[iVar3], uLocal_152);
																	unk_0xD0557B139A542F12(&uLocal_152);
																	unk_0x44FB298D6382876D(iLocal_114[iVar3], 1);
																	if (!unk_0x4FAFF4BCB7633475(iLocal_184))
																	{
																		unk_0x788F35D395511DFE(iLocal_184, 1, 1);
																		unk_0xB5396F1FB088FE38(&uLocal_152);
																		unk_0x092B9247AF00F5CF(0, 0, 0);
																		unk_0xD844F5E50DAB6FF7(0, unk_0x4A8C381C258A124D(), 300f, -1, 0, 0);
																		unk_0x93C0674FC00824D0(uLocal_152);
																		unk_0x4BD42B0527065BB6(iLocal_184, uLocal_152);
																		unk_0xD0557B139A542F12(&uLocal_152);
																		unk_0x44FB298D6382876D(iLocal_184, 1);
																	}
																	if (!unk_0xC450B06E5AAA0985(uLocal_192))
																	{
																		if (unk_0xC450B06E5AAA0985(uLocal_191))
																		{
																			unk_0xFE54B8568B2ABD12(&uLocal_191);
										...
										else if (iLocal_49 == 2)
										{
											...
											if (unk_0x4FAFF4BCB7633475(iLocal_114[1]))
											{
												if (unk_0xC450B06E5AAA0985(uLocal_185[1]))
												{
											...
											if (unk_0x4FAFF4BCB7633475(iLocal_114[0]))
											{
												if (unk_0xFC8BFE4B41177C22(iLocal_167))
												{
													if (unk_0xA3736D76B0E93E93(iLocal_167))
													{
														unk_0x837D67618BF89034(iLocal_167, 1, 1);
													}
													unk_0x51C8BEA2005931AB(&iLocal_167);
													func_108();
													func_105();
											...
											else if (unk_0x9B3D4335E0EDB0BE(iLocal_114[0], unk_0x4A8C381C258A124D(), 1))
											{
												if (unk_0xFC8BFE4B41177C22(iLocal_167))
												{
													if (unk_0xA3736D76B0E93E93(iLocal_167))
									...
									case 10:
										...
										if (iLocal_49 == 1)
										{
											if (!iLocal_160)
											{
												...
												else if (!unk_0x4FAFF4BCB7633475(iLocal_117[0]))
												{
													unk_0xB2BD5837A8D3CEDA(iLocal_117[0], -818.5553f, -185.4815f, 36.5689f, 1, 0, 0, 1);
													unk_0x5C96CEA06531AB03(iLocal_117[0], 47.0582f);
													unk_0x10425721983AE158(iLocal_117[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0f, 0, 0, 0);
													if (!unk_0x4FAFF4BCB7633475(iLocal_117[1]))
													{
														unk_0xFD251F92B546F389(iLocal_117[1], Local_103, 150f, -1, 0, 0);
														unk_0xAAA71DD7E9059338(iLocal_117[1], 0);
													...
													{
														if (!unk_0x4FAFF4BCB7633475(iLocal_121[iVar4]))
														{
															unk_0xB5396F1FB088FE38(&uLocal_152);
															unk_0x10425721983AE158(0, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, 0, 1, 0);
															unk_0xFD251F92B546F389(0, Local_103, 150f, -1, 0, 0);
															unk_0x93C0674FC00824D0(uLocal_152);
															unk_0x4BD42B0527065BB6(iLocal_121[iVar4], uLocal_152);
															unk_0xD0557B139A542F12(&uLocal_152);
															unk_0x44FB298D6382876D(iLocal_121[iVar4], 1);
															unk_0xAAA71DD7E9059338(iLocal_121[iVar4], 0);
															unk_0x3F58BFCF656F0DF1(iLocal_121[iVar4], 1);
															unk_0xF09E30AF1B8FB379(&(iLocal_121[iVar4]));
														}
														iVar4++;
													}
													iLocal_160 = 1;
										...
										else if (iLocal_49 == 2)
										{
											if (!iLocal_160)
											{
												...
												{
													unk_0xB2BD5837A8D3CEDA(iLocal_117[0], -1197.455f, -776.0289f, 16.3254f, 1, 0, 0, 1);
													unk_0x5C96CEA06531AB03(iLocal_117[0], 205.7753f);
													unk_0x10425721983AE158(iLocal_117[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0f, 0, 0, 0);
													if (!unk_0x4FAFF4BCB7633475(iLocal_117[1]))
													{
														unk_0xFD251F92B546F389(iLocal_117[1], Local_103, 150f, -1, 0, 0);
													...
													{
														if (!unk_0x4FAFF4BCB7633475(iLocal_121[iVar5]))
														{
															unk_0xFD251F92B546F389(iLocal_121[iVar5], Local_103, 150f, -1, 0, 0);
															unk_0xAAA71DD7E9059338(iLocal_121[iVar5], 0);
															unk_0x3F58BFCF656F0DF1(iLocal_121[iVar5], 1);
															unk_0xF09E30AF1B8FB379(&(iLocal_121[iVar5]));
														}
														iVar5++;
													}
													iLocal_160 = 1;
										...
										if ((func_168() && !unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0)) && !unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()))
										{
											unk_0xC1B1E9A034A63A62(0);
											iLocal_47 = 11;
										}
										if (unk_0x2A488C176D52CCA5(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), func_248()) > (fLocal_197 + 150f))
										{
											iLocal_47 = 12;
										}
										...
										else if (unk_0x9B3D4335E0EDB0BE(iLocal_117[0], unk_0x4A8C381C258A124D(), 1))
										{
											func_73(2);
											func_53();
										}
									...
									case 13:
										if (!iLocal_225)
										{
											if (!unk_0x4FAFF4BCB7633475(iLocal_117[0]))
											{
												unk_0x974022927CB47E68(iLocal_117[0]);
												if (iLocal_49 == 1)
												{
												...
												unk_0xE69B8FE2F4FD0178(iLocal_117[0], 20000);
												unk_0x44FB298D6382876D(iLocal_117[0], 1);
												unk_0xAAA71DD7E9059338(iLocal_117[0], 0);
												iLocal_225 = 1;
											}
										}
										if (!func_132())
...
void func_1()
{
	if (func_168())
	{
		...
		if (!iLocal_182)
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_117[0]))
			{
				...
				unk_0xEC73DFE5CE55E19C(unk_0xD1A6A821F5AC81DB(iLocal_117[0], 1), 20f, 0);
	...
	if (bLocal_181)
	{
		if (!iLocal_183)
		{
			...
			Local_198 = { unk_0xD1A6A821F5AC81DB(iLocal_117[0], 0) };
			if (iLocal_49 == 1)
			{
			...
			uLocal_216 = unk_0x2EC137C692A52458(Local_198, Local_204, 2);
			uLocal_210 = unk_0x69D23632E4288DBD("DEFAULT_ANIMATED_CAMERA", 0);
			unk_0xF9B66DAE101B699C(uLocal_210, uLocal_216, sLocal_215, sLocal_211);
			unk_0x19626F992DC71FB9(unk_0x4A8C381C258A124D());
			unk_0x3DA436E63AB0F541(unk_0x4A8C381C258A124D(), uLocal_216, sLocal_211, sLocal_212, 1000f, -2f, 5, 0, 1148846080, 0);
			unk_0xD8ED11B32DF72E0B(unk_0x4A8C381C258A124D(), 0, 0);
			unk_0x19626F992DC71FB9(iLocal_117[0]);
			unk_0x3DA436E63AB0F541(iLocal_117[0], uLocal_216, sLocal_211, sLocal_213, 1000f, -2f, 4, 0, 1148846080, 0);
			unk_0xD8ED11B32DF72E0B(iLocal_117[0], 0, 0);
			iLocal_167 = unk_0x4E55EAB577C13329(joaat("prop_cs_duffel_01"), unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), 1, 1, 0);
			unk_0x381D671BCFC294D9(iLocal_167, uLocal_216, sLocal_214, sLocal_211, 1000f, 1090519040, 0, 1148846080);
			if (!unk_0x4FAFF4BCB7633475(iLocal_117[0]))
			{
				func_52();
				unk_0x4CBC5D1BC117616B(uLocal_210, 1);
	...
	if (unk_0xBD3B265153D3BA2D(uLocal_216) > fLocal_217 && iLocal_183)
	{
		if (!unk_0x4FAFF4BCB7633475(iLocal_117[0]))
		{
			unk_0x886FA295C1257AAA(iLocal_117[0], iLocal_189);
			unk_0x974022927CB47E68(iLocal_117[0]);
			unk_0xB5396F1FB088FE38(&uLocal_152);
		...
		unk_0x8EAC8FBDF8A3830E(unk_0x259BE71D8A81D4FA(), 1f, 650, 0, 1, 0);
		func_140(0, 1, 1, 0, 0, 0, 0);
		...
		unk_0x85E6A1E36B5E2E4D(uLocal_210, 0);
		func_49();
...
void func_16(bool bParam0)
{
	...
	else if (BitTest(Global_113648.f_20566.f_471, bParam0) || BitTest(Global_2359296[func_18() /*5568*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		unk_0x8744D2E3FC95740E(&(Global_113648.f_20566.f_471), bParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_18() /*5568*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		unk_0xCCDB0041859B85A6("COUP_RED");
		unk_0xACF853FB3F6EA7D4(func_17(bParam0));
...
void func_49()
{
	if (iLocal_49 == 1)
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_117[0]))
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_117[0]))
			{
				unk_0xAAA71DD7E9059338(iLocal_117[0], 0);
				unk_0xF09E30AF1B8FB379(&(iLocal_117[0]));
			}
		}
		if (unk_0xFC8BFE4B41177C22(iLocal_117[1]))
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_117[1]))
			{
				unk_0xAAA71DD7E9059338(iLocal_117[1], 0);
		...
		if (unk_0xFC8BFE4B41177C22(iLocal_121[0]))
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_121[0]))
			{
				unk_0xAAA71DD7E9059338(iLocal_121[0], 0);
				unk_0xF09E30AF1B8FB379(&(iLocal_121[0]));
			}
		}
		if (unk_0xFC8BFE4B41177C22(iLocal_121[1]))
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_121[1]))
			{
				unk_0xAAA71DD7E9059338(iLocal_121[1], 0);
				unk_0xF09E30AF1B8FB379(&(iLocal_121[1]));
			}
		}
		if (unk_0xFC8BFE4B41177C22(iLocal_121[2]))
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_121[2]))
			{
				unk_0xB2BD5837A8D3CEDA(iLocal_121[2], -820.424f, -181.9059f, 36.5687f, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(iLocal_121[2], 167.7909f);
				unk_0xAAA71DD7E9059338(iLocal_121[2], 0);
				unk_0xF09E30AF1B8FB379(&(iLocal_121[2]));
			}
		}
	}
}
...
void func_59()
{
	...
	{
		func_38(13, unk_0xF34EE736CF047844(Global_113648.f_10196.f_3853));
	}
...
void func_76(int iParam0)
{
	...
	bVar7 = false;
	bVar8 = false;
	fVar10 = unk_0xED977E2AE2CB16EE(Var0, unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), 1);
	...
	if (unk_0x486FF5D06E9659F1(joaat("startup_positioning")) == 0)
	{
		if (BitTest(Global_38862[(iParam0 / 32)], (iParam0 % 32)))
		{
			if (fVar10 < 25f)
			{
				...
				iVar12 = unk_0x0E171121A3A25363(Var0);
		...
		else
		{
			...
			switch (iVar9)
			{
				case 1:
					...
					else if (fVar10 > 3f || unk_0x1D5CD3EAAA7422B0(unk_0x8CA2126DEA4C3796(Var0.f_5)) <= 0.015f)
					{
						iVar14 = unk_0xF8F35890F43ED2AE(unk_0x4A8C381C258A124D());
						iVar15 = unk_0x0E171121A3A25363(Var0);
					...
					if (bVar13)
					{
						...
						unk_0xEBB2809684978887(Var0.f_5, iVar9, 0, 1);
						bVar8 = true;
					}
					break;
...
int func_79(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
		{
			...
			{
				iVar0 = unk_0x4B423FAA24E8ABF0(func_80(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 1)));
				switch (iVar0)
				{
...
void func_81(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 202:
			...
			{
				if (unk_0x2A488C176D52CCA5(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), *uParam1) >= 12f)
				{
		...
		case 142:
			...
			else if (unk_0x486FF5D06E9659F1(joaat("jewelry_heist")) == 0 && unk_0x486FF5D06E9659F1(joaat("jewelry_setup1")) == 0)
			{
				if (iVar1 >= 21)
				{
					if (unk_0x2A488C176D52CCA5(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), *uParam1) >= 18f)
					{
						Global_113648.f_7263[iParam0] = 1;
						unk_0xEBB2809684978887(uParam1->f_5, Global_113648.f_7263[iParam0], 1, 1);
					}
		...
		case 144:
			...
			{
				if (unk_0x2A488C176D52CCA5(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), *uParam1) >= 40f)
				{
					Global_113648.f_7263[iParam0] = 1;
					unk_0xEBB2809684978887(uParam1->f_5, Global_113648.f_7263[iParam0], 1, 1);
				}
		...
		case 71:
		case 72:
			if (!func_82(iParam0) && unk_0x486FF5D06E9659F1(Global_91469[26 /*34*/].f_6) == 0)
			{
				Global_113648.f_7263[iParam0] = 1;
				unk_0xEBB2809684978887(uParam1->f_5, Global_113648.f_7263[iParam0], 1, 1);
			}
...
bool func_82(int iParam0)
{
	...
	Var0 = { func_95(iParam0) };
	iVar7 = unk_0x117BCCA03F7A311A(Var0.f_5);
...
int func_84()
{
	...
	func_94(&uVar0, unk_0x4BA5A16068183C5E());
	func_93(&uVar0, unk_0x18E502A71E28968C());
	func_92(&uVar0, unk_0x5295501D0862870D());
	func_87(&uVar0, unk_0xB12880C92EA6EE15());
	func_86(&uVar0, unk_0x8825A6E0A30BDCB8());
	func_85(&uVar0, unk_0x7598FE4545010A75());
	return uVar0;
}
...
void func_102()
{
	if (unk_0x1D56B24774D5E23C(uLocal_110))
	{
		...
		func_103(&uLocal_229);
		fLocal_197 = unk_0x2A488C176D52CCA5(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), func_248());
		unk_0xC1B1E9A034A63A62(0);
		iLocal_47 = 10;
	}
	if (unk_0xB0E14182FAD64944(uLocal_110))
	{
		if (unk_0x2A488C176D52CCA5(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0x80C8AA1625977488(uLocal_110)) > 200f)
		{
			func_160();
		}
	}
...
void func_105()
{
	...
	if (!unk_0xB0E14182FAD64944(uLocal_110))
	{
		unk_0x0B0C9A0F9AAEB7F0(&uLocal_106, 3);
		unk_0x0B0C9A0F9AAEB7F0(&uLocal_106, 4);
		unk_0x0B0C9A0F9AAEB7F0(&uLocal_106, 1);
		if (!bLocal_161)
		{
			if (unk_0x1C2F771CDC87A3A5(iLocal_114[0], 0))
			{
				if (unk_0xFC8BFE4B41177C22(iLocal_114[0]))
				{
					Local_107 = { unk_0x240E88FB0B8CC932(iLocal_114[0], 1067030938, 1069547520) };
				}
			}
			else
			{
				Local_107 = { unk_0x165E2DDD2BD0F07D(unk_0xD1A6A821F5AC81DB(iLocal_114[0], 1), 1067030938, 1069547520) };
			}
		}
		else if (unk_0xFC8BFE4B41177C22(iLocal_175))
		{
			Local_107 = { unk_0x165E2DDD2BD0F07D(unk_0xD1A6A821F5AC81DB(iLocal_175, 0), 1067030938, 1069547520) };
		}
		Local_107 = { Local_107.f_0, Local_107.f_1, (Local_107.f_2 + 0.25f) };
		uLocal_110 = unk_0x8D4CAF9A056EA9E4(joaat("pickup_money_med_bag"), Local_107, uLocal_106, iLocal_189, 1, joaat("prop_cs_duffel_01"));
		...
		if (iLocal_49 == 1)
		{
			...
			while (iVar0 <= (iLocal_111 - 1))
			{
				if (!unk_0x4FAFF4BCB7633475(iLocal_114[iVar0]))
				{
					unk_0x788F35D395511DFE(iLocal_114[iVar0], 1, 1);
					unk_0x974022927CB47E68(iLocal_114[iVar0]);
					unk_0xB5396F1FB088FE38(&uLocal_152);
					unk_0x092B9247AF00F5CF(0, 0, 0);
					unk_0xD844F5E50DAB6FF7(0, unk_0x4A8C381C258A124D(), 300f, -1, 0, 0);
					unk_0x93C0674FC00824D0(uLocal_152);
					unk_0x4BD42B0527065BB6(iLocal_114[iVar0], uLocal_152);
					unk_0xD0557B139A542F12(&uLocal_152);
					unk_0x44FB298D6382876D(iLocal_114[iVar0], 1);
				}
				iVar0++;
		...
		else if (iLocal_49 == 2)
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_114[0]))
			{
				unk_0xBEB96F1A510EE9AA(iLocal_114[0]);
				if (!unk_0xCE6BB45648900227(iLocal_114[0]))
				{
					func_50();
					unk_0x4EDE34FBADD967A6(0);
...
int func_106(var uParam0)
{
	...
	unk_0x5D3946F818C6B331(uVar0, func_107(unk_0x76CD105BCAC6EB9F(), 0.7f, 0.7f));
	return uVar0;
}
...
void func_108()
{
	if (unk_0xC450B06E5AAA0985(uLocal_192))
	{
		unk_0xFE54B8568B2ABD12(&uLocal_192);
	}
	if (unk_0xC450B06E5AAA0985(uLocal_193))
	{
		unk_0xFE54B8568B2ABD12(&uLocal_193);
...
int func_109()
{
	...
	else if (unk_0x4FAFF4BCB7633475(iLocal_114[0]))
	{
		iLocal_149 = 1;
	}
	if (!bLocal_161)
	{
		if (!unk_0xFC8BFE4B41177C22(iLocal_114[1]))
		{
			iLocal_150 = 1;
		}
		else if (unk_0x4FAFF4BCB7633475(iLocal_114[1]))
		{
			iLocal_150 = 1;
		}
	}
	...
	if (!unk_0xFC8BFE4B41177C22(iLocal_184))
	{
		iLocal_151 = 1;
	}
	else if (unk_0x4FAFF4BCB7633475(iLocal_184) || !unk_0x7F420695E3F776FB(iLocal_184, 0))
	{
		iLocal_151 = 1;
	}
...
int func_110()
{
	...
	while (iVar0 <= (iLocal_111 - 1))
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_114[iVar0]))
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_114[iVar0]) || unk_0x1C2F771CDC87A3A5(iLocal_114[iVar0], 0))
			{
				if (unk_0x9B3D4335E0EDB0BE(iLocal_114[iVar0], unk_0x4A8C381C258A124D(), 1))
				{
					return 1;
				}
			}
	...
	while (iVar0 <= (iLocal_111 - 1))
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_114[iVar0]))
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_114[iVar0]))
			{
				if (unk_0xA6534E6C7AE314D6(iLocal_114[iVar0]))
				{
					if (unk_0xC1089D3918F03D33(iLocal_114[iVar0]) == unk_0x4A8C381C258A124D())
					{
						unk_0x788F35D395511DFE(iLocal_114[iVar0], 1, 1);
						unk_0xD844F5E50DAB6FF7(iLocal_114[iVar0], unk_0x4A8C381C258A124D(), 250f, -1, 0, 0);
						unk_0x44FB298D6382876D(iLocal_114[iVar0], 1);
						unk_0x4EDE34FBADD967A6(0);
						unk_0xF09E30AF1B8FB379(&(iLocal_114[iVar0]));
						return 1;
					}
				}
			}
	...
	if (unk_0xFC8BFE4B41177C22(iLocal_184))
	{
		if (!unk_0x4FAFF4BCB7633475(iLocal_184) || unk_0x1C2F771CDC87A3A5(iLocal_184, 0))
		{
			if (unk_0x9B3D4335E0EDB0BE(iLocal_184, unk_0x4A8C381C258A124D(), 1))
			{
				return 1;
			}
		}
	...
	if (unk_0xFC8BFE4B41177C22(iLocal_184))
	{
		if (!unk_0x4FAFF4BCB7633475(iLocal_184))
		{
			if (unk_0xA6534E6C7AE314D6(iLocal_184))
			{
				if (unk_0xC1089D3918F03D33(iLocal_184) == unk_0x4A8C381C258A124D())
				{
					unk_0x788F35D395511DFE(iLocal_184, 1, 1);
					unk_0xD844F5E50DAB6FF7(iLocal_184, unk_0x4A8C381C258A124D(), 250f, -1, 0, 0);
					unk_0x44FB298D6382876D(iLocal_184, 1);
					unk_0x4EDE34FBADD967A6(0);
					unk_0xF09E30AF1B8FB379(&iLocal_184);
					return 1;
				}
			}
		}
	...
	{
		if (!unk_0x1C2F771CDC87A3A5(iLocal_175, 0) || unk_0x1C2F771CDC87A3A5(iLocal_175, 0))
		{
			if (unk_0x9B3D4335E0EDB0BE(iLocal_175, unk_0x4A8C381C258A124D(), 1))
			{
				return 1;
			}
		}
	...
	if (unk_0xD9F5E1FEFD1329E4(iLocal_175, 0))
	{
		if (!unk_0x4FAFF4BCB7633475(iLocal_114[0]))
		{
			if (unk_0xCECDBB848D53DEB2(iLocal_114[0], iLocal_175, 0))
			{
				if (!unk_0x4FAFF4BCB7633475(iLocal_114[1]))
				{
					if (unk_0xCECDBB848D53DEB2(iLocal_114[1], iLocal_175, 0))
					{
						return 1;
					}
				}
...
int func_148()
{
	if (!unk_0x4FAFF4BCB7633475(iLocal_114[0]) && !unk_0x4FAFF4BCB7633475(iLocal_114[1]))
	{
		if (iLocal_49 == 1)
		{
			if (!iLocal_165)
			{
				if (!unk_0x5105BE70DEF1F5FB(iLocal_114[0], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, 1, 0))
				{
					iLocal_165 = 1;
				}
			}
			if (!iLocal_166)
			{
				if (!unk_0x5105BE70DEF1F5FB(iLocal_114[1], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, 1, 0))
				{
					iLocal_166 = 1;
				}
			}
		...
		else if (iLocal_49 == 2)
		{
			if (!iLocal_165)
			{
				if ((!unk_0x5105BE70DEF1F5FB(iLocal_114[0], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, 1, 0) || unk_0x5105BE70DEF1F5FB(iLocal_114[0], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, 1, 0)) || unk_0x5105BE70DEF1F5FB(iLocal_114[0], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, 1, 0))
				{
					unk_0xD844F5E50DAB6FF7(iLocal_114[0], unk_0x4A8C381C258A124D(), 1000f, -1, 0, 0);
					iLocal_165 = 1;
				}
			}
			if (!iLocal_166)
			{
				if ((!unk_0x5105BE70DEF1F5FB(iLocal_114[1], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, 1, 0) || unk_0x5105BE70DEF1F5FB(iLocal_114[1], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, 1, 0)) || unk_0x5105BE70DEF1F5FB(iLocal_114[1], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, 1, 0))
				{
					unk_0xD844F5E50DAB6FF7(iLocal_114[1], unk_0x4A8C381C258A124D(), 1000f, -1, 0, 0);
					iLocal_166 = 1;
				}
			}
		}
...
void func_149()
{
	...
	Var0 = { unk_0xD1A6A821F5AC81DB(iLocal_167, 1) };
	Var3 = { unk_0x88124E0D60FB8D11(iLocal_167, 2) };
	unk_0x51C8BEA2005931AB(&iLocal_167);
	iLocal_167 = unk_0x4E55EAB577C13329(joaat("prop_cs_duffel_01"), Var0, 1, 1, 0);
	unk_0xCF39804E8C88080E(iLocal_167, Var3, 2, 1);
}
...
void func_150()
{
	if (unk_0xFC8BFE4B41177C22(iLocal_114[0]))
	{
		if (unk_0x2A488C176D52CCA5(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iLocal_114[0], 0)) > 200f && unk_0xF6C26AE940C14749(iLocal_114[0]))
		{
			if (unk_0xC450B06E5AAA0985(uLocal_185[0]))
			{
				unk_0xFE54B8568B2ABD12(&(uLocal_185[0]));
			}
			unk_0xF09E30AF1B8FB379(&(iLocal_114[0]));
			bLocal_147 = true;
		}
	}
	else
	...
	if (unk_0xFC8BFE4B41177C22(iLocal_175))
	{
		if (unk_0x2A488C176D52CCA5(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iLocal_175, 0)) > 200f && unk_0xF6C26AE940C14749(iLocal_175))
		{
			if (unk_0xC450B06E5AAA0985(uLocal_191))
			{
				unk_0xFE54B8568B2ABD12(&uLocal_191);
			}
			unk_0x68298CA6191CDFDB(&iLocal_175);
			bLocal_148 = true;
		}
	}
	else
...
void func_151()
{
	if (!unk_0x1C2F771CDC87A3A5(iLocal_175, 0))
	{
		if (unk_0x8D91ADE44AC79BC9(iLocal_175) < 800)
		{
			unk_0xD25E9BDC14A0B649(iLocal_175, 0, 0);
			unk_0x2AEBE39F6BF7D6BC(iLocal_175, 10f);
		}
	}
}
	...
	while (iVar0 <= (iLocal_111 - 1))
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_114[iVar0]))
		{
			if (unk_0x4FAFF4BCB7633475(iLocal_114[iVar0]))
			{
				if (unk_0xC450B06E5AAA0985(uLocal_185[iVar0]))
				{
					unk_0xFE54B8568B2ABD12(&(uLocal_185[iVar0]));
				}
			}
		}
		iVar0++;
...
void func_153()
{
	...
	if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
	{
		if (!bLocal_140)
		{
			...
			{
				if (!unk_0x4FAFF4BCB7633475(iLocal_114[iVar1]))
				{
					unk_0x62A5310368A20EFA(iLocal_114[iVar1], unk_0x4A8C381C258A124D(), 0, 16);
				}
				iVar1++;
			}
			bLocal_140 = true;
	...
	if (!bLocal_140)
	{
		...
		else if (iLocal_49 == 2)
		{
			...
			if (unk_0xFC8BFE4B41177C22(iLocal_167) && !unk_0x4FAFF4BCB7633475(iLocal_114[0]))
			{
				if (!iLocal_178)
				{
					iLocal_178 = 1;
		...
		if (!iLocal_138)
		{
			if (iLocal_49 == 1)
			{
				...
				{
					unk_0x51C8BEA2005931AB(&(uLocal_168[0]));
					unk_0x51C8BEA2005931AB(&(uLocal_168[1]));
					if (unk_0xD9F5E1FEFD1329E4(iLocal_175, 0))
					{
						if (!unk_0x4FAFF4BCB7633475(iLocal_114[0]))
						{
							unk_0x974022927CB47E68(iLocal_114[0]);
							unk_0xB5396F1FB088FE38(&uLocal_152);
							unk_0x84B06A81C98DA4B8(0);
							unk_0xEBA229B2E0BB05E0(0, iLocal_175, -1, 0, 2f, 1, 0);
							unk_0x93C0674FC00824D0(uLocal_152);
							unk_0x4BD42B0527065BB6(iLocal_114[0], uLocal_152);
							unk_0xD0557B139A542F12(&uLocal_152);
						}
						if (!unk_0x4FAFF4BCB7633475(iLocal_114[1]))
						{
							unk_0x717804C8C8DA67BF(iLocal_114[1], joaat("MotionState_Run"), 1, 0, 0);
							unk_0xB5396F1FB088FE38(&uLocal_152);
							unk_0x84B06A81C98DA4B8(0);
							unk_0xEBA229B2E0BB05E0(0, iLocal_175, -1, 1, 2f, 1, 0);
							unk_0x93C0674FC00824D0(uLocal_152);
							unk_0x4BD42B0527065BB6(iLocal_114[1], uLocal_152);
							unk_0xD0557B139A542F12(&uLocal_152);
						}
						iLocal_47 = 2;
						iLocal_138 = 1;
					...
					else
					{
						if (!unk_0x4FAFF4BCB7633475(iLocal_114[0]))
						{
							unk_0x788F35D395511DFE(iLocal_114[0], 1, 1);
							unk_0x19626F992DC71FB9(iLocal_114[0]);
							unk_0xB5396F1FB088FE38(&uLocal_152);
							unk_0x84B06A81C98DA4B8(0);
						...
						if (!unk_0x4FAFF4BCB7633475(iLocal_114[1]))
						{
							unk_0x788F35D395511DFE(iLocal_114[1], 1, 1);
							unk_0x19626F992DC71FB9(iLocal_114[1]);
							unk_0xB5396F1FB088FE38(&uLocal_152);
							unk_0x84B06A81C98DA4B8(0);
							unk_0xD844F5E50DAB6FF7(0, unk_0x4A8C381C258A124D(), 1000f, -1, 0, 0);
							unk_0x93C0674FC00824D0(uLocal_152);
			...
			{
				if (unk_0xBD3B265153D3BA2D(uLocal_216) > 0.453f)
				{
					if (!unk_0x4FAFF4BCB7633475(iLocal_117[0]))
					{
						unk_0xAAA71DD7E9059338(iLocal_117[0], 1);
					...
					{
						unk_0x974022927CB47E68(iLocal_114[0]);
						unk_0x1CA08719184AFC6F(iLocal_114[0], 128, 1);
						unk_0x1CA08719184AFC6F(iLocal_114[0], 1, 1);
						unk_0xBE8796DB2B90A437(iLocal_114[0], 17, 1);
						unk_0x4190C67D524CD0DC(iLocal_114[0], 1.6f);
						unk_0x788F35D395511DFE(iLocal_114[0], 1, 1);
						unk_0xB5396F1FB088FE38(&uLocal_152);
						...
						unk_0x4BD42B0527065BB6(iLocal_114[0], uLocal_152);
						unk_0xD0557B139A542F12(&uLocal_152);
						unk_0x44FB298D6382876D(iLocal_114[0], 1);
						unk_0x5AE11BC36633DE4E(0);
					}
					if (!unk_0x4FAFF4BCB7633475(iLocal_114[1]))
					{
						unk_0x1CA08719184AFC6F(iLocal_114[1], 128, 1);
						unk_0x1CA08719184AFC6F(iLocal_114[1], 1, 1);
						unk_0xBE8796DB2B90A437(iLocal_114[1], 17, 1);
						unk_0x4190C67D524CD0DC(iLocal_114[1], 1.6f);
						unk_0x788F35D395511DFE(iLocal_114[1], 1, 1);
						unk_0xB5396F1FB088FE38(&uLocal_152);
						unk_0x84B06A81C98DA4B8(0);
						...
						unk_0x4BD42B0527065BB6(iLocal_114[1], uLocal_152);
						unk_0xD0557B139A542F12(&uLocal_152);
						unk_0x44FB298D6382876D(iLocal_114[1], 1);
					}
					iLocal_47 = 2;
					iLocal_138 = 1;
				}
...
void func_154()
{
	switch (iLocal_227)
	{
		case 0:
			func_140(1, 1, 1, 0, 0, 0, 0);
			unk_0x55F7AC4B2B875901(func_155(unk_0x259BE71D8A81D4FA()), 10f, 0);
			uLocal_226 = unk_0x69D23632E4288DBD("DEFAULT_ANIMATED_CAMERA", 0);
			unk_0x4CBC5D1BC117616B(uLocal_226, 1);
			unk_0xF9B66DAE101B699C(uLocal_226, uLocal_216, "robbery_action_cam", "random@shop_robbery");
			if (iLocal_49 == 1)
			{
				unk_0xDC750660004ECB83("Hair_room");
			}
			unk_0xE37AF9002E782BA0(1, 0, 3000, 1, 0, 0);
			iLocal_228 = unk_0x1DD05E817C89C737() + 3500;
			iLocal_227++;
			break;
		
		case 1:
			if (iLocal_228 < unk_0x1DD05E817C89C737())
			{
				if (iLocal_49 == 1)
				{
				...
				unk_0x4CBC5D1BC117616B(uLocal_226, 0);
...
void func_156()
{
	...
	if (!iLocal_136 && func_159(1, 0, 1))
	{
		...
		if (iLocal_49 == 1)
		{
			if (!iLocal_177)
			{
				uLocal_216 = unk_0x2EC137C692A52458(Local_201, Local_207, 2);
				unk_0x19626F992DC71FB9(unk_0x4A8C381C258A124D());
				unk_0x3DA436E63AB0F541(unk_0x4A8C381C258A124D(), uLocal_216, "random@shop_robbery", "robbery_action_p", 8f, -8f, 1, 0, 1148846080, 0);
				unk_0xD8ED11B32DF72E0B(unk_0x4A8C381C258A124D(), 1, 0);
				if (((!unk_0x4FAFF4BCB7633475(iLocal_114[0]) && !unk_0x4FAFF4BCB7633475(iLocal_114[1])) && !unk_0x4FAFF4BCB7633475(iLocal_117[0])) && unk_0xFC8BFE4B41177C22(iLocal_167))
				{
					unk_0x3DA436E63AB0F541(iLocal_114[0], uLocal_216, "random@shop_robbery", "robbery_action_b", 8f, -8f, 1, 0, 1148846080, 0);
					unk_0x3DA436E63AB0F541(iLocal_114[1], uLocal_216, "random@shop_robbery", "robbery_action_a", 8f, -8f, 1, 0, 1148846080, 0);
					unk_0x3DA436E63AB0F541(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_action_f", 8f, -4f, 0, 0, 1148846080, 0);
					unk_0x381D671BCFC294D9(iLocal_167, uLocal_216, "robbery_action_bag", "random@shop_robbery", 8f, -8f, 0, 1148846080);
				}
				unk_0x7BB893EF8F683419(uLocal_216, 0.06f);
				iLocal_177 = 1;
			}
		}
		else if (iLocal_49 == 2)
		{
			...
			{
				unk_0x974022927CB47E68(iLocal_117[0]);
				unk_0x10425721983AE158(iLocal_117[0], "random@robbery", "robbery_main_female", 2f, -2f, -1, 0, 0f, 0, 0, 0);
			}
			unk_0x4A3280817398D754(-1195.062f, -773.2098f, 16.324f, 20f, 4);
			uLocal_216 = unk_0x2EC137C692A52458(Local_201, Local_207, 2);
			if (((!unk_0x4FAFF4BCB7633475(iLocal_114[0]) && !unk_0x4FAFF4BCB7633475(iLocal_114[1])) && !unk_0x4FAFF4BCB7633475(iLocal_117[0])) && unk_0xFC8BFE4B41177C22(iLocal_167))
			{
				unk_0x3DA436E63AB0F541(iLocal_114[0], uLocal_216, "random@shop_robbery", "robbery_action_b", 2f, -2f, 1, 0, 1148846080, 0);
				unk_0x3DA436E63AB0F541(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_action_f", 2f, -2f, 0, 0, 1148846080, 0);
				if (unk_0xFC8BFE4B41177C22(uLocal_168[0]) && unk_0xFC8BFE4B41177C22(uLocal_168[1]))
				{
					unk_0x4D306DD94DD6FDBA(uLocal_168[0], iLocal_117[0], unk_0x72F7E39FB49FC0BA(iLocal_117[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1, 0);
					unk_0x4D306DD94DD6FDBA(uLocal_168[1], iLocal_117[0], unk_0x72F7E39FB49FC0BA(iLocal_117[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1, 0);
				}
			}
			unk_0x7BB893EF8F683419(uLocal_216, 0.05f);
			Local_201 = { -1199.369f, -776.1991f, 16.3235f };
			Local_207 = { 0f, 0f, -60f };
			uLocal_216 = unk_0x2EC137C692A52458(Local_201, Local_207, 2);
			if (!unk_0x4FAFF4BCB7633475(iLocal_114[1]))
			{
				unk_0x3DA436E63AB0F541(iLocal_114[1], uLocal_216, "random@shop_robbery", "robbery_action_a", 2f, -2f, 1, 0, 1148846080, 0);
			}
			unk_0x7BB893EF8F683419(uLocal_216, 0.06f);
			...
			unk_0x93C0674FC00824D0(uLocal_152);
			unk_0x4BD42B0527065BB6(unk_0x4A8C381C258A124D(), uLocal_152);
			unk_0xD0557B139A542F12(&uLocal_152);
			unk_0xD8ED11B32DF72E0B(unk_0x4A8C381C258A124D(), 0, 0);
		}
		iLocal_136 = 1;
	...
	if ((iLocal_49 == 1 && unk_0xFC8BFE4B41177C22(iLocal_175)) || iLocal_49 == 2)
	{
		unk_0xC1B1E9A034A63A62(0);
		iLocal_47 = 1;
	}
...
void func_157()
{
	...
	else if (unk_0x6252BC0DD8A320DB(iVar0))
	{
		if (func_158())
		{
			if (unk_0x5105BE70DEF1F5FB(uLocal_171, -828.3692f, -194.4669f, 36.41385f, -824.5801f, -201.1353f, 39.39436f, 4.3125f, 0, 1, 0))
			{
		...
		iLocal_175 = unk_0x5779387E956077A6(iVar0, Local_172, 31.9252f, 1, 1, 0);
		unk_0x788F35D395511DFE(iLocal_175, 1, 1);
		unk_0x1DE99C193C7EC64B(iLocal_175, 1084227584);
		unk_0xC229299217554C78(iLocal_175, 1, 1, 0);
		iLocal_184 = unk_0x8728A378EF2B46B2(iLocal_175, 26, joaat("g_m_y_korean_01"), -1, 1, 1);
		unk_0x0428AFDCAA63B06E(iLocal_184, 134, 1);
		unk_0xAAA71DD7E9059338(iLocal_184, 1);
		unk_0x3CEA1FD137ACE2D9(iLocal_184, iLocal_190);
		unk_0xBE8796DB2B90A437(iLocal_184, 8, 0);
		unk_0x139711196A42A037(iLocal_184, 0);
		unk_0xC652B7E19CE29859(iLocal_184, 13);
		unk_0xB41DEC3AAC1AA107(iLocal_184, joaat("weapon_pistol"), -1, 1, 1);
		unk_0x87EDE48547CC8942(iLocal_184, 1, 0);
		unk_0x0428AFDCAA63B06E(iLocal_184, 42, 1);
		iLocal_176 = 1;
	}
}
...
int func_158()
{
	...
	if (unk_0xD9F5E1FEFD1329E4(uVar0, 0))
	{
		...
		{
			uLocal_171 = iVar0;
			if (!unk_0x110821AE6C63DD4F(uLocal_171))
			{
				unk_0xEE0BCDB1B5E36BCB(uLocal_171, 1, 0);
			}
			return 1;
		}
	}
...
int func_162()
{
	switch (func_163(&Global_32223, 0, 5, 0, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return 1;
			break;
...
int func_170()
{
	...
	if (unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), -823.1281f, -187.9591f, 36.6189f, 12f, 12f, 12f, 0, 1, 0) || unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), -1201.017f, -777.5527f, 16.3398f, 12f, 12f, 12f, 0, 1, 0))
	{
		if (!unk_0x4FAFF4BCB7633475(iLocal_114[0]) && !unk_0x4FAFF4BCB7633475(iLocal_114[1]))
		{
			if (unk_0x9B3D4335E0EDB0BE(iLocal_114[0], unk_0x4A8C381C258A124D(), 1) || unk_0x9B3D4335E0EDB0BE(iLocal_114[1], unk_0x4A8C381C258A124D(), 1))
			{
				return 1;
			}
			if (unk_0x7E54CB377175F94E(iLocal_114[0], unk_0x4A8C381C258A124D()) || unk_0x7E54CB377175F94E(iLocal_114[1], unk_0x4A8C381C258A124D()))
			{
				if (((unk_0xE5D813FA6F741B01(unk_0x259BE71D8A81D4FA(), iLocal_114[0]) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), iLocal_114[0])) || unk_0xE5D813FA6F741B01(unk_0x259BE71D8A81D4FA(), iLocal_114[1])) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), iLocal_114[1]))
				{
					if (iLocal_126 == -1)
					{
				...
				if (iLocal_126 != -1 && unk_0x1DD05E817C89C737() > iLocal_126 + 1500)
				{
					return 1;
				}
			}
	...
	if (unk_0x8AC0662A292C36F4(-1, Local_194 - Vector(20f, 20f, 20f), Local_194 + Vector(20f, 20f, 20f)))
	{
		return 1;
	}
	if (unk_0x1C2F771CDC87A3A5(iLocal_114[0], 0) || unk_0x1C2F771CDC87A3A5(iLocal_114[1], 0))
	{
		return 1;
	}
	if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) && func_168())
	{
		return 1;
	}
	if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) && func_168())
	{
		return 1;
	}
	if (!unk_0x4FAFF4BCB7633475(iLocal_114[0]) && !unk_0x4FAFF4BCB7633475(iLocal_114[1]))
	{
		if (((unk_0x6051CE9D47B0B904(unk_0x4A8C381C258A124D(), unk_0xD1A6A821F5AC81DB(iLocal_114[1], 1) - Vector(12f, 12f, 12f), unk_0xD1A6A821F5AC81DB(iLocal_114[1], 1) + Vector(12f, 12f, 12f), 0, 1) && !unk_0x3C2402675D8FFADA(unk_0x4A8C381C258A124D())) || unk_0x398315D0C90DE6F6(unk_0xD1A6A821F5AC81DB(iLocal_114[0], 1), 3f, 1)) || unk_0x398315D0C90DE6F6(unk_0xD1A6A821F5AC81DB(iLocal_114[1], 1), 3f, 1))
		{
			return 1;
		}
	}
	...
	while (iVar0 < iLocal_117)
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_117[iVar0]))
		{
			if (unk_0x9B3D4335E0EDB0BE(iLocal_117[iVar0], unk_0x4A8C381C258A124D(), 1))
			{
				return 1;
			}
		}
	...
	while (iVar0 < iLocal_121)
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_121[iVar0]))
		{
			if (unk_0x9B3D4335E0EDB0BE(iLocal_121[iVar0], unk_0x4A8C381C258A124D(), 1))
			{
				return 1;
			}
		}
...
void func_173()
{
	if (!unk_0x4FAFF4BCB7633475(iLocal_117[1]))
	{
		if (unk_0xB98B1A5B59BC5065(iLocal_117[1]))
		{
		...
		unk_0xEBA2204AAD092B47(iLocal_117[1], 26, 0, 0);
	}
	if (!unk_0x4FAFF4BCB7633475(iLocal_121[1]))
	{
		func_174(iLocal_121[1], "SCREAM_PANIC", "WAVELOAD_PAIN_FEMALE", 3);
		unk_0xEBA2204AAD092B47(iLocal_121[1], 3, 0, 0);
	}
}

void func_174(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, sParam2, func_175(iParam3), 0);
}
...
void func_176()
{
	...
	unk_0x06CD913C241C765E("ROBBERS", &iLocal_190);
	iVar0 = 0;
	while (iVar0 <= (iLocal_111 - 1))
	{
		iLocal_114[iVar0] = unk_0xB1DBFEB95C0EFB88(26, iLocal_222, Local_55[iVar0 /*3*/], fLocal_62[iVar0], 1, 1);
		unk_0xAAA71DD7E9059338(iLocal_114[iVar0], 1);
		unk_0x3CEA1FD137ACE2D9(iLocal_114[iVar0], iLocal_190);
		unk_0xBE8796DB2B90A437(iLocal_114[iVar0], 8, 0);
		unk_0x139711196A42A037(iLocal_114[iVar0], 0);
		unk_0xC652B7E19CE29859(iLocal_114[iVar0], 13);
		unk_0xB41DEC3AAC1AA107(iLocal_114[iVar0], joaat("weapon_pistol"), -1, 1, 1);
		unk_0x87EDE48547CC8942(iLocal_114[iVar0], 1, 0);
		unk_0x0428AFDCAA63B06E(iLocal_114[iVar0], 42, 1);
		unk_0x0428AFDCAA63B06E(iLocal_114[iVar0], 269, 1);
		unk_0x0428AFDCAA63B06E(iLocal_114[iVar0], 188, 1);
		unk_0x81E9E7612B0E4BCE(iLocal_114[iVar0], 0);
		unk_0x1CA08719184AFC6F(iLocal_114[iVar0], 128, 1);
		unk_0x1CA08719184AFC6F(iLocal_114[iVar0], 8, 1);
		iVar0++;
	}
	unk_0xEB418CA245FFE897(iLocal_114[0], "pedRobber[0]");
	unk_0xEB418CA245FFE897(iLocal_114[1], "pedRobber[1]");
	unk_0xD414C47AFF81382A(5, iLocal_190, joaat("player"));
	unk_0xD414C47AFF81382A(5, joaat("player"), iLocal_190);
	unk_0xD414C47AFF81382A(5, iLocal_190, joaat("COP"));
	unk_0xD414C47AFF81382A(5, joaat("COP"), iLocal_190);
	if (func_42() == 0)
	{
		func_181(&uLocal_232, 0, unk_0x4A8C381C258A124D(), "MICHAEL", 0, 1);
	}
	else if (func_42() == 1)
	{
		func_181(&uLocal_232, 0, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
	}
	else if (func_42() == 2)
	{
		func_181(&uLocal_232, 0, unk_0x4A8C381C258A124D(), "TREVOR", 0, 1);
	}
	iLocal_167 = unk_0x4E55EAB577C13329(iLocal_188, Local_97, 1, 1, 0);
	if (iLocal_49 == 1)
	{
		unk_0xA7B0B03284E7503C(Local_128 - Vector(20f, 20f, 20f), Local_128 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
		unk_0xCCA6D8A84EE8C88A(joaat("baller"), 1);
		uLocal_168[0] = unk_0x4E55EAB577C13329(joaat("prop_anim_cash_pile_01"), Local_97, 1, 1, 0);
		uLocal_168[1] = unk_0x4E55EAB577C13329(joaat("prop_anim_cash_pile_01"), Local_97 - Vector(0.1f, 0f, 0f), 1, 1, 0);
		unk_0x397CF4F4C8B17365(iLocal_114[0], "G_M_Y_KorLieut_01_Korean_MINI_01");
		unk_0x397CF4F4C8B17365(iLocal_114[1], "G_M_Y_Korean_01_Korean_MINI_02");
		Local_201 = { -821.565f, -186.467f, 36.6f };
		Local_207 = { 0f, 0f, -59.96f };
		uLocal_216 = unk_0x2EC137C692A52458(Local_201, Local_207, 2);
		unk_0xBF3497E24DEAD835(uLocal_216, 1);
		unk_0x3DA436E63AB0F541(iLocal_114[1], uLocal_216, "random@shop_robbery", "robbery_intro_loop_a", 8f, -8f, 0, 0, 1148846080, 0);
		unk_0x381D671BCFC294D9(iLocal_167, uLocal_216, "robbery_intro_loop_bag", "random@shop_robbery", 1000f, 1090519040, 0, 1148846080);
		iVar0 = 0;
		while (iVar0 <= (iLocal_112 - 1))
		{
			iLocal_117[iVar0] = unk_0xB1DBFEB95C0EFB88(26, iLocal_219, Local_65[iVar0 /*3*/], fLocal_75[iVar0], 1, 1);
			unk_0xBE8796DB2B90A437(iLocal_117[iVar0], 17, 1);
			unk_0xAAA71DD7E9059338(iLocal_117[iVar0], 1);
			unk_0x3F58BFCF656F0DF1(iLocal_117[iVar0], 0);
			unk_0x0428AFDCAA63B06E(iLocal_117[iVar0], 269, 1);
			iVar0++;
		}
		unk_0xEB418CA245FFE897(iLocal_117[0], "pedWorker[0]");
		unk_0xEB418CA245FFE897(iLocal_117[1], "pedWorker[1]");
		unk_0xEB418CA245FFE897(iLocal_117[2], "pedWorker[2]");
		iLocal_121[0] = unk_0xB1DBFEB95C0EFB88(26, iLocal_220, Local_79[0 /*3*/], fLocal_92[0], 1, 1);
		unk_0xBE8796DB2B90A437(iLocal_121[0], 17, 1);
		unk_0xAAA71DD7E9059338(iLocal_121[0], 1);
		unk_0x3F58BFCF656F0DF1(iLocal_121[0], 0);
		unk_0x0428AFDCAA63B06E(iLocal_121[0], 269, 1);
		iVar0 = 1;
		while (iVar0 <= 2)
		{
			iLocal_121[iVar0] = unk_0xB1DBFEB95C0EFB88(26, iLocal_221, Local_79[iVar0 /*3*/], fLocal_92[iVar0], 1, 1);
			unk_0xBE8796DB2B90A437(iLocal_121[iVar0], 17, 1);
			unk_0xAAA71DD7E9059338(iLocal_121[iVar0], 1);
			unk_0x3F58BFCF656F0DF1(iLocal_121[iVar0], 0);
			unk_0x0428AFDCAA63B06E(iLocal_121[iVar0], 269, 1);
			iVar0++;
		}
		unk_0xEB418CA245FFE897(iLocal_121[0], "pedShopper[0]");
		unk_0xEB418CA245FFE897(iLocal_121[1], "pedShopper[1]");
		unk_0xEB418CA245FFE897(iLocal_121[2], "pedShopper[2]");
		unk_0xD1C578C204015E1F(iLocal_117[0], 0, 0, 0, 0);
		unk_0xD1C578C204015E1F(iLocal_117[0], 2, 1, 1, 0);
		unk_0xD1C578C204015E1F(iLocal_117[0], 3, 1, 0, 0);
		unk_0xD1C578C204015E1F(iLocal_117[0], 4, 0, 0, 0);
		unk_0xD1C578C204015E1F(iLocal_117[0], 5, 0, 0, 0);
		unk_0x3DA436E63AB0F541(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_intro_loop_f", 8f, -8f, 0, 0, 1148846080, 0);
		unk_0x397CF4F4C8B17365(iLocal_117[0], "A_M_Y_BevHills_01_White_Mini_01");
		func_181(&uLocal_232, 5, iLocal_117[0], "REROBShopworker", 0, 1);
		unk_0xD1C578C204015E1F(iLocal_117[1], 0, 1, 0, 0);
		unk_0xD1C578C204015E1F(iLocal_117[1], 2, 0, 0, 0);
		unk_0xD1C578C204015E1F(iLocal_117[1], 3, 0, 0, 0);
		unk_0xD1C578C204015E1F(iLocal_117[1], 4, 1, 2, 0);
		unk_0xD1C578C204015E1F(iLocal_117[1], 5, 0, 0, 0);
		unk_0xAFC7A89C990C4339(iLocal_117[1], -1);
		unk_0x44FB298D6382876D(iLocal_117[1], 1);
		unk_0xD1C578C204015E1F(iLocal_117[2], 0, 1, 0, 0);
		unk_0xD1C578C204015E1F(iLocal_117[2], 2, 1, 0, 0);
		unk_0xD1C578C204015E1F(iLocal_117[2], 3, 0, 2, 0);
		unk_0xD1C578C204015E1F(iLocal_117[2], 4, 1, 2, 0);
		unk_0xD1C578C204015E1F(iLocal_117[2], 5, 0, 0, 0);
		unk_0xAFC7A89C990C4339(iLocal_117[2], -1);
		unk_0x44FB298D6382876D(iLocal_117[2], 1);
		uLocal_216 = unk_0x2EC137C692A52458(-812.37f, -185.65f, 37.5804f, 0f, 0f, 30f, 2);
		unk_0xBF3497E24DEAD835(uLocal_216, 1);
		unk_0xD1C578C204015E1F(iLocal_121[0], 0, 0, 1, 0);
		unk_0xD1C578C204015E1F(iLocal_121[0], 2, 0, 0, 0);
		unk_0xD1C578C204015E1F(iLocal_121[0], 3, 0, 1, 0);
		unk_0xD1C578C204015E1F(iLocal_121[0], 4, 0, 1, 0);
		unk_0xD1C578C204015E1F(iLocal_121[0], 8, 0, 0, 0);
		unk_0x3DA436E63AB0F541(iLocal_121[0], uLocal_216, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0x44FB298D6382876D(iLocal_121[0], 1);
		uLocal_216 = unk_0x2EC137C692A52458(-817.5606f, -190.8273f, 37.6114f, 0f, 0f, 25.8399f, 2);
		unk_0xBF3497E24DEAD835(uLocal_216, 1);
		unk_0xD1C578C204015E1F(iLocal_121[1], 0, 0, 0, 0);
		unk_0xD1C578C204015E1F(iLocal_121[1], 2, 0, 1, 0);
		unk_0xD1C578C204015E1F(iLocal_121[1], 3, 1, 1, 0);
		unk_0xD1C578C204015E1F(iLocal_121[1], 4, 1, 1, 0);
		unk_0xD1C578C204015E1F(iLocal_121[1], 8, 0, 0, 0);
		unk_0x3DA436E63AB0F541(iLocal_121[1], uLocal_216, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0x44FB298D6382876D(iLocal_121[1], 1);
		uLocal_216 = unk_0x2EC137C692A52458(-816.1862f, -182.897f, 37.68f, 0f, 0f, 30f, 2);
		unk_0xBF3497E24DEAD835(uLocal_216, 1);
		unk_0xD1C578C204015E1F(iLocal_121[2], 0, 1, 0, 0);
		unk_0xD1C578C204015E1F(iLocal_121[2], 2, 0, 2, 0);
		unk_0xD1C578C204015E1F(iLocal_121[2], 3, 0, 1, 0);
		unk_0xD1C578C204015E1F(iLocal_121[2], 4, 1, 0, 0);
		unk_0xD1C578C204015E1F(iLocal_121[2], 8, 0, 0, 0);
		unk_0x3DA436E63AB0F541(iLocal_121[2], uLocal_216, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0x44FB298D6382876D(iLocal_121[2], 1);
		unk_0x646DE293036A3499(iLocal_114[0], iLocal_117[0], -1, 0);
	...
	{
		unk_0xA7B0B03284E7503C(Local_131 - Vector(20f, 20f, 20f), Local_131 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
		unk_0xCF39804E8C88080E(iLocal_167, Local_100, 2, 1);
		iLocal_117[0] = unk_0xB1DBFEB95C0EFB88(26, iLocal_219, Local_65[0 /*3*/], fLocal_75[0], 1, 1);
		unk_0xEB418CA245FFE897(iLocal_117[0], "pedWorker[0]");
		unk_0x397CF4F4C8B17365(iLocal_117[0], "A_M_Y_BeachVesp_01_White_Mini_01");
		func_181(&uLocal_232, 6, iLocal_117[0], "REROBShopworker2", 0, 1);
		iLocal_117[1] = unk_0xB1DBFEB95C0EFB88(26, iLocal_218, Local_65[1 /*3*/], fLocal_75[1], 1, 1);
		unk_0xEB418CA245FFE897(iLocal_117[1], "pedWorker[1]");
		iVar0 = 0;
		while (iVar0 <= (iLocal_112 - 1))
		{
		...
		iLocal_121[0] = unk_0xB1DBFEB95C0EFB88(26, iLocal_220, Local_79[0 /*3*/], fLocal_92[0], 1, 1);
		unk_0xEB418CA245FFE897(iLocal_121[0], "pedShopper[0]");
		iLocal_121[1] = unk_0xB1DBFEB95C0EFB88(26, iLocal_221, Local_79[1 /*3*/], fLocal_92[1], 1, 1);
		unk_0xEB418CA245FFE897(iLocal_121[1], "pedShopper[1]");
		iVar0 = 0;
		...
		unk_0x10425721983AE158(iLocal_117[0], "random@shop_robbery", "robbery_intro_loop_f", 4f, -4f, -1, 9, 0f, 0, 0, 0);
		unk_0x44FB298D6382876D(iLocal_117[0], 1);
		unk_0x10425721983AE158(iLocal_117[1], "random@robbery", "f_cower_02", 4f, -4f, -1, 9, 0f, 0, 0, 0);
		unk_0x44FB298D6382876D(iLocal_117[1], 1);
		unk_0xAFC7A89C990C4339(iLocal_121[0], -1);
		unk_0x44FB298D6382876D(iLocal_121[0], 1);
		unk_0x10425721983AE158(iLocal_121[1], "random@robbery", "f_cower_01", 4f, -4f, -1, 9, 0f, 0, 0, 0);
		unk_0x44FB298D6382876D(iLocal_121[1], 1);
		Local_201 = { -1192.01f, -768.929f, 16.358f };
		Local_207 = { 0f, 0f, -59.5f };
		uLocal_216 = unk_0x2EC137C692A52458(Local_201, Local_207, 2);
		unk_0xBF3497E24DEAD835(uLocal_216, 1);
		unk_0x3DA436E63AB0F541(iLocal_114[0], uLocal_216, "random@shop_robbery", "robbery_intro_loop_b", 2f, -2f, 0, 0, 1148846080, 0);
		unk_0x3DA436E63AB0F541(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_intro_loop_f", 2f, -2f, 0, 0, 1148846080, 0);
		unk_0x10425721983AE158(iLocal_114[1], "random@shop_robbery", "robbery_intro_loop_a", 16f, -4f, -1, 9, 0f, 0, 0, 0);
		func_180(14, 1);
		func_179(14);
		unk_0x4EDE34FBADD967A6(500);
		func_177(14, 0, 0);
...
void func_182()
{
	if (!iLocal_135)
	{
		iLocal_153 = unk_0x0E171121A3A25363(Local_55[0 /*3*/]);
		unk_0x74C1590CC91B3930(iLocal_153);
		iLocal_135 = 1;
	}
}
...
void func_183()
{
	...
	unk_0xEC9DAA34BBB4658C(iLocal_221);
	unk_0xEC9DAA34BBB4658C(iLocal_222);
	...
	if ((((((((((unk_0x6252BC0DD8A320DB(iLocal_219) && unk_0x6252BC0DD8A320DB(iLocal_220)) && unk_0x6252BC0DD8A320DB(iLocal_221)) && unk_0x6252BC0DD8A320DB(iLocal_222)) && unk_0x6252BC0DD8A320DB(joaat("prop_anim_cash_pile_01"))) && unk_0x6252BC0DD8A320DB(joaat("prop_cs_duffel_01"))) && unk_0xA08EEC7306CF6198("re_shoprobbery")) && unk_0xA08EEC7306CF6198("re_shoprobbery2")) && unk_0xE100DD4F82A51BDE("random@robbery")) && unk_0xE100DD4F82A51BDE("random@shop_robbery")) && unk_0x16088CC55E7F218A("RE51A_SHOP"))
	{
		iLocal_53 = 1;
	}
	else
...
int func_185()
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()) && !unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
	{
		...
		if (unk_0xA8CEACB4F35AE058(unk_0xE5741C6B6539231F(unk_0x4A8C381C258A124D())) > 1369f && !func_196())
		{
			return 0;
		}
	}
...
int func_198()
{
	if ((Global_113637 == func_70() && unk_0x9FA91AA1AC724CD0()) && Global_113638)
	{
		return 1;
	}
	return 0;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_224()) || Global_32166) || func_223()) || func_129(8, -1)) || func_220()) || func_222()) || func_221()) || func_219()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D())) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D())) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D())) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D())) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1)) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA())) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0)) || func_224()) || Global_112695) || Global_32166) || func_223()) || func_129(8, -1)) || func_220()) || func_222()) || func_221()) || func_219()) || Global_113648.f_7690.f_919[bVar0] == 5) || Global_43804 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D())) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1)) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0)) || func_224()) || Global_112695) || Global_32166) || func_223()) || func_129(8, -1)) || func_222()) || func_221()) || func_219()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_224() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0) || func_129(8, -1)) || func_219()) || func_218()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_234()
{
	...
	if (iLocal_223)
	{
		...
		while (iVar0 <= (iLocal_111 - 1))
		{
			if (unk_0xFC8BFE4B41177C22(iLocal_114[iVar0]))
			{
				if (!unk_0x4FAFF4BCB7633475(iLocal_114[iVar0]) && !unk_0x7F420695E3F776FB(iLocal_114[iVar0], 0))
				{
					unk_0xFD251F92B546F389(iLocal_114[iVar0], Local_103, 150f, -1, 0, 0);
					unk_0x44FB298D6382876D(iLocal_114[iVar0], 1);
				}
				unk_0xF09E30AF1B8FB379(&(iLocal_114[iVar0]));
			}
		...
		while (iVar0 <= (iLocal_113 - 1))
		{
			if (unk_0xFC8BFE4B41177C22(iLocal_121[iVar0]))
			{
				if (!unk_0x4FAFF4BCB7633475(iLocal_121[iVar0]))
				{
					unk_0x788F35D395511DFE(iLocal_121[iVar0], 1, 1);
					unk_0xB5396F1FB088FE38(&uLocal_152);
					if (iLocal_49 == 1)
					{
						unk_0x10425721983AE158(0, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, 0, 1, 0);
					...
					{
						unk_0x974022927CB47E68(iLocal_121[iVar0]);
						unk_0xA966E518B752B92A(0, -1201.476f, -790.2733f, 15.5475f, 2f, -1, 1048576000, 0, 1193033728);
					}
					unk_0xFD251F92B546F389(0, Local_103, 150f, -1, 0, 0);
					unk_0x93C0674FC00824D0(uLocal_152);
					unk_0x4BD42B0527065BB6(iLocal_121[iVar0], uLocal_152);
					unk_0xD0557B139A542F12(&uLocal_152);
					unk_0x44FB298D6382876D(iLocal_121[iVar0], 1);
				}
			}
		...
		while (iVar0 <= (iLocal_112 - 1))
		{
			if (unk_0xFC8BFE4B41177C22(iLocal_117[iVar0]))
			{
				if (!unk_0x4FAFF4BCB7633475(iLocal_117[iVar0]))
				{
					unk_0x0428AFDCAA63B06E(iLocal_117[iVar0], 317, 1);
					unk_0x788F35D395511DFE(iLocal_117[iVar0], 1, 1);
					if (iVar0 == 0)
					{
						if (!iLocal_183)
						{
							unk_0x974022927CB47E68(iLocal_117[iVar0]);
							unk_0xFD251F92B546F389(iLocal_117[iVar0], Local_103, 150f, -1, 0, 0);
						}
						else
						{
							unk_0xAAA71DD7E9059338(iLocal_117[iVar0], 0);
						}
					}
					else
					{
						...
						unk_0xFD251F92B546F389(0, Local_103, 150f, -1, 0, 0);
						unk_0x93C0674FC00824D0(uLocal_152);
						unk_0x4BD42B0527065BB6(iLocal_117[iVar0], uLocal_152);
						unk_0xD0557B139A542F12(&uLocal_152);
					}
					unk_0xAAA71DD7E9059338(iLocal_117[iVar0], 0);
					unk_0x3F58BFCF656F0DF1(iLocal_117[iVar0], 1);
				}
			}
			iVar0++;
		}
		...
		if (unk_0xFC8BFE4B41177C22(iLocal_167))
		{
			...
			unk_0xB3B56385ECA230B4(&iLocal_167);
		}
		if (unk_0xFC8BFE4B41177C22(iLocal_175))
		{
			unk_0x68298CA6191CDFDB(&iLocal_175);
...
Vector3 func_248()
{
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		fVar0 = unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Local_128, 1);
		iLocal_127 = 1;
		if (unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Local_131, 1) < fVar0)
		{
			fVar0 = unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Local_131, 1);
			iLocal_127 = 2;
		}
		if (iLocal_127 == 1)
		{
