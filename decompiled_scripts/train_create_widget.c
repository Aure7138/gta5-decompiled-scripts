	...
	while (true)
	{
		...
		if (!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()))
		{
			if (iLocal_7)
			{
				...
				{
					unk_0x5B76B14AE875C795(&iLocal_0);
				}
				iLocal_0 = unk_0x63C6CCA8E68AE8C8(iLocal_4, Local_1, bLocal_6);
				iLocal_7 = 0;
			}
			if (iLocal_9)
			{
			...
			if (unk_0x4C241E39B23DF959(iLocal_0, false) && !unk_0x5F9532F3B5CC2551(iLocal_0))
			{
				unk_0xAA0BC91BE0B796E3(iLocal_0, fLocal_5);
				unk_0x16469284DB8C62B5(iLocal_0, fLocal_5);
			}
			if (bLocal_8)
			{
				func_1();
