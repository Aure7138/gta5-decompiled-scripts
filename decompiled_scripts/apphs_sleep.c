			...
			switch (Global_14394.f_1)
			{
				...
				case 8:
					...
					if (func_11(2, Global_14362, 0))
					{
						func_10();
						Global_14372 = 1;
						func_9(Global_14375, "DISPLAY_VIEW", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_26();
...
void func_12()
{
	if (Global_14372 == 0)
	{
		if (func_11(2, Global_14363, 0))
		{
			func_15();
			Global_14372 = 1;
			func_28();
			unk_0x21ED0FC9B5CC748B(Global_14375, "GET_CURRENT_SELECTION");
			uLocal_35 = unk_0x723E3684EF582590();
			while (!unk_0xAB56DCBFCD98FF03(uLocal_35))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			Global_3069[Global_14394 /*2811*/][iLocal_37 /*281*/].f_259 = iLocal_17[unk_0x2D1F70CC7C051146(uLocal_35)];
			func_13(Global_14375, "SET_HEADER", &(Global_3069[Global_14394 /*2811*/][iLocal_37 /*281*/].f_7[Global_3069[Global_14394 /*2811*/][iLocal_37 /*281*/].f_259 /*4*/]), 0, 0, 0, 0);
			if (Global_3069[Global_14394 /*2811*/][0 /*281*/].f_259 == 2)
			{
				func_9(Global_14375, "SET_SLEEP_MODE", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else
			{
				func_9(Global_14375, "SET_SLEEP_MODE", 0f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			if (func_4(0))
			{
				func_3();
...
void func_19()
{
	...
	while (iVar16 < 9)
	{
		iVar17 = 0;
		iVar18 = 9;
		Global_3069[Global_14394 /*2811*/][iLocal_37 /*281*/].f_84[iVar18] = 5000;
		while (iVar17 < 9)
		{
			if (Global_3069[Global_14394 /*2811*/][iLocal_37 /*281*/].f_124[iVar17] == 1)
			{
				if (iVar0[iVar17] == 0)
				{
					if (Global_3069[Global_14394 /*2811*/][iLocal_37 /*281*/].f_84[iVar17] < Global_3069[Global_14394 /*2811*/][iLocal_37 /*281*/].f_84[iVar18])
					{
						iVar18 = iVar17;
						func_20(Global_14375, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(13), unk_0xBBDA792448DB5A89(iVar16), unk_0xBBDA792448DB5A89(Global_3069[Global_14394 /*2811*/][iLocal_37 /*281*/].f_104[iVar18]), -1f, -1f, &(Global_3069[Global_14394 /*2811*/][iLocal_37 /*281*/].f_7[iVar18 /*4*/]), 0, 0, 0, 0);
					}
				}
			}
			iVar17++;
		...
		iVar0[iVar18] = 1;
		if (Global_3069[Global_14394 /*2811*/][iLocal_37 /*281*/].f_124[iVar16] == 1)
		{
			iLocal_33++;
		}
		iVar16++;
	}
	func_9(Global_14375, "DISPLAY_VIEW", 13f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_13(Global_14375, "SET_HEADER", &(Global_3069[Global_14394 /*2811*/][iLocal_37 /*281*/].f_7[Global_3069[Global_14394 /*2811*/][iLocal_37 /*281*/].f_259 /*4*/]), 0, 0, 0, 0);
	if (Global_14382)
	{
		func_20(Global_14375, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205", 0, 0, 0, 0);
		func_20(Global_14375, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206", 0, 0, 0, 0);
	}
	else
	{
		func_20(Global_14375, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
		func_20(Global_14375, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, 0, 0, 0, 0, 0);
	}
	func_20(Global_14375, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
...
void func_22()
{
	func_9(Global_14375, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_24()
{
	func_9(Global_14375, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(1), -1082130432, -1082130432, -1082130432, -1082130432);
	unk_0x35D7948F61AA3FEC(-1, "Menu_Navigate", &Global_14383, 1);
	func_25();
}
...
void func_26()
{
	...
	while (iVar16 < 9)
	{
		iVar17 = 0;
		iVar18 = 9;
		Global_3069[Global_14394 /*2811*/][iVar18 /*281*/] = 5000;
		while (iVar17 < 9)
		{
			if (Global_3069[Global_14394 /*2811*/][iVar17 /*281*/].f_280 == 1)
			{
				if (iVar0[iVar17] == 0)
				{
					if (iVar17 == 0)
					{
						if (Global_3069[Global_14394 /*2811*/][iVar17 /*281*/] < Global_3069[Global_14394 /*2811*/][iVar18 /*281*/])
						{
							iVar18 = iVar17;
							func_20(Global_14375, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(2), unk_0xBBDA792448DB5A89(iVar16), -1f, -1f, -1f, &(Global_3069[Global_14394 /*2811*/][iVar18 /*281*/].f_2), 0, 0, 0, 0);
						}
					}
				}
			}
		...
		iLocal_17[iVar16] = iVar18;
		iVar0[iVar18] = 1;
		if (Global_3069[Global_14394 /*2811*/][iVar16 /*281*/].f_280 == 1)
		{
			iLocal_33++;
		}
		iVar16++;
...
void func_30()
{
	...
	{
		if (func_33(Global_98931.f_1750.f_539.f_3549) != unk_0x14B7103DBD149FFE(unk_0x81873881071CD9FE()))
		{
			iVar0 = func_32(unk_0x81873881071CD9FE());
			if (func_31(iVar0) && (!func_34(14) || Global_97883))
			{
				if (Global_98931.f_1750.f_539.f_3549 != iVar0 && func_31(Global_98931.f_1750.f_539.f_3549))
				{
