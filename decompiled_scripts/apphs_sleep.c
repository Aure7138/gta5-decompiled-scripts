...
void func_12()
{
	if (Global_14531 == 0)
	{
		if (func_11(2, Global_14522, 0))
		{
			...
			uLocal_36 = unk_0x614EE52A69097A4C();
			while (!unk_0xBFCC17D9792F43AF(uLocal_36))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			Global_3228[Global_14553 /*2811*/][iLocal_38 /*281*/].f_259 = iLocal_18[unk_0x82D58DA03789627A(uLocal_36)];
		...
		while (iVar17 < 9)
		{
			if (Global_3228[Global_14553 /*2811*/][iLocal_38 /*281*/].f_124[iVar17] == 1)
			{
				if (iVar0[iVar17] == 0)
				{
					...
					{
						iVar18 = iVar17;
						func_20(Global_14534, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(13), unk_0xBBDA792448DB5A89(iVar16), unk_0xBBDA792448DB5A89(Global_3228[Global_14553 /*2811*/][iLocal_38 /*281*/].f_104[iVar18]), -1f, -1f, &(Global_3228[Global_14553 /*2811*/][iLocal_38 /*281*/].f_7[iVar18 /*4*/]), 0, 0, 0, 0);
					}
				}
			}
			iVar17++;
...
void func_22()
{
	func_9(Global_14534, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_24()
{
	func_9(Global_14534, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(1), -1082130432, -1082130432, -1082130432, -1082130432);
	unk_0x0F8EAEEC97DDBCB3(-1, "Menu_Navigate", &Global_14542, 1);
	func_25();
}
			...
			if (Global_3228[Global_14553 /*2811*/][iVar17 /*281*/].f_280 == 1)
			{
				if (iVar0[iVar17] == 0)
				{
					if (iVar17 == 0)
					{
						...
						{
							iVar18 = iVar17;
							func_20(Global_14534, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(2), unk_0xBBDA792448DB5A89(iVar16), -1f, -1f, -1f, &(Global_3228[Global_14553 /*2811*/][iVar18 /*281*/].f_2), 0, 0, 0, 0);
						}
					}
				}
			}
