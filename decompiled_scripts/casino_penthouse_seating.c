...
int func_66()
{
	...
	if (func_79(unk_0x9E2D6C50374FCFA9()) && unk_0xA829C9A2767AC8EF())
	{
		return 1;
	}
	if (func_77() != 0)
...
void func_86(var uParam0)
{
	...
	if (uParam0->f_13 > 2)
	{
		...
		func_87(unk_0x9E2D6C50374FCFA9(), 1, 0, 0);
	}
	...
	else
	{
		...
		if (unk_0x0D01086B38EC256F(iParam0) && (unk_0x3583A42587543334(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_96(unk_0x9E2D6C50374FCFA9(), 0) && !func_95()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_91(uVar27) && !unk_0xE2ED785E8DB4D3FF(uVar27))
				{
					if (!bVar22)
					{
...
void func_92(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		...
		if (func_96(unk_0x9E2D6C50374FCFA9(), 0))
		{
...
void func_100()
{
	unk_0xD9B114A8D3A8319F(32, 0, func_111());
	func_109(0, -1, 0);
	func_108();
	func_101();
	if (unk_0x9315DBF7D972F07A())
