...
void __EntryFunction__()
{
	...
	if (unk_0xD32535FA4397160F(unk_0x45755F80A3E63D8B()) > 1 && !func_136(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar1 = 0f;
			if (unk_0xF1F1EBE69E9A0DE7(ScriptParam_0.f_1[0 /*3*/], &fVar1, 0))
			{
				if (fVar1 != 0f)
				{
		...
		if (unk_0xD2CFFE76B625AE55(iLocal_85) && !unk_0x2006A8C1BA2AFE80(iLocal_85, 0))
		{
			...
			switch (iLocal_95)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_108(3) && !Global_91312)
						{
							...
							{
								if ((!func_136(uLocal_94, 1) || !unk_0xD2CFFE76B625AE55(func_107())) && !Global_91312)
								{
									func_129(10);
									break;
								}
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_86(iLocal_86))
								{
									...
									else if (!func_136(uLocal_94, 2048) || !unk_0x46768B1495288824())
									{
										func_84(&iLocal_96);
				...
				case 5:
					...
					if (unk_0x9A8E9A1E029E9A5A(&Local_69))
					{
						...
						if (iVar5 == 1)
						{
							...
							{
								unk_0x9846B4D56971A958(&iLocal_86);
							}
				...
				case 6:
					...
					if (func_136(uLocal_94, 2097152))
					{
						if (!func_108(3) && !unk_0xA6C3B54732ED5989(uLocal_52))
						{
							func_129(10);
						}
					}
					...
					{
						unk_0x70474C6AB0E99EB4(unk_0xF2DB717A73826179((func_23(&uLocal_107) * 1000f)), iLocal_99, 0);
						func_22(&uLocal_107);
						...
						if (iLocal_99 != -1)
						{
							if (func_136(Global_99807, 0))
							{
								unk_0x07B7705D7B23A4CA(func_30(iLocal_99), 0, Global_91315, 0);
...
void func_2()
{
	...
	unk_0x651E63BA2F4975EC("amb@world_human_hang_out_street@male_a@idle_a");
	unk_0x651E63BA2F4975EC("amb@world_human_hang_out_street@male_b@idle_a");
	unk_0x651E63BA2F4975EC("amb@world_human_hang_out_street@male_c@idle_a");
	unk_0x651E63BA2F4975EC("amb@world_human_aa_smoke@male@idle_a");
	unk_0x651E63BA2F4975EC("random@street_race");
	...
	{
		if (unk_0xAE930CC2795F78CF(sVar0))
		{
			if (unk_0x28CF037DC47EE46D(sVar0))
			{
				unk_0xE28C11441D3C6728(sVar0, 0);
			}
		}
	}
}
...
void func_18()
{
	...
	{
		case 0:
			unk_0x37782C5969C66777(-223.42f, 3948.36f, 36.52f, -212.37f, 3818.97f, 37.53f, 50f, 1);
			break;
		
		case 1:
			unk_0x37782C5969C66777(-509.1254f, 1987.582f, 205.3305f, -948.5215f, 2752.741f, 25.35144f, 300f, 1);
			break;
		
		case 3:
			unk_0x37782C5969C66777(-1943.822f, 4462.286f, 0f, -229.0783f, 4227.072f, 50f, 250f, 1);
			break;
		...
		case 5:
			unk_0x37782C5969C66777(2242.488f, 2568.146f, -10f, 2242.488f, 1568.146f, 200f, 1000f, 1);
			break;
		
		case 2:
			unk_0x37782C5969C66777(2809.948f, 2993.644f, -9.3564f, 2952.969f, 2530.636f, 177.1921f, 500f, 1);
			break;
	}
}
...
float func_23(var uParam0)
{
	if (func_26(uParam0))
	{
		...
		{
			return (func_24(unk_0xF426A5DE932B3BEE(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
void func_29(char* sParam0, int iParam1, int iParam2)
{
	...
	unk_0x29DB55F64B471648(sParam0, iParam1, iParam2, func_7(0));
}
...
{
	uParam0->f_1 = (func_24(unk_0xF426A5DE932B3BEE(*uParam0, 4)) - fParam1);
...
int func_36()
{
	...
	unk_0xEC04D6F4A1ED71ED("SwitchSceneNeutral", 0, 1);
...
void func_50()
{
	...
	fVar0 = unk_0xB7A628320EFF8E47(unk_0xA8CFDE65C45F813B(unk_0x27D769C59BC9D030(), 1), Local_121);
	if (fVar0 < 62500f)
	{
		func_74();
		func_71();
...
int func_52()
{
	...
	while (iVar0 < func_53())
	{
		if (!unk_0xD2CFFE76B625AE55(Local_329[iVar0 /*14*/]) || !unk_0xD2CFFE76B625AE55(Local_329[iVar0 /*14*/].f_1))
		{
			return 0;
		}
		iVar0++;
	}
	if (!unk_0xD2CFFE76B625AE55(Local_329.f_83) || !unk_0xD2CFFE76B625AE55(Local_329.f_83.f_1))
	{
		return 0;
	}
	return 1;
...
void func_54()
{
	...
	if (unk_0xD2CFFE76B625AE55(iLocal_157) && !unk_0x2006A8C1BA2AFE80(iLocal_157, 0))
	{
		if (unk_0x3BF4F8DBABE55D2B(iLocal_157))
		{
			return;
		}
	}
	...
	{
		iVar0 = (unk_0x3A5708FEE1B560A9(0, 65535) % 3) + 1;
		if (iVar0 > 0 && iVar0 <= 3)
		{
			if (unk_0x2006A8C1BA2AFE80(Local_329[(iVar0 - 1) /*14*/], 0))
			{
				return;
			}
			switch (iVar0)
...
void func_70()
{
	...
	if (unk_0x2DB75A8F096AB1F1(unk_0x4D29100D094E5511()) && !unk_0x2006A8C1BA2AFE80(Local_329.f_83, 0))
	{
		...
		unk_0xEE40B5E30309799D(Local_329.f_83, 0f, 0f, 0.75f, 1, 2000, 2000, 2000, 0);
	}
}
...
void func_71()
{
	...
	if (!unk_0x2006A8C1BA2AFE80(iLocal_157, 0) && !unk_0x2006A8C1BA2AFE80(unk_0x27D769C59BC9D030(), 0))
	{
		switch (iLocal_328)
		{
			case 0:
				if (unk_0xB7A628320EFF8E47(unk_0xA8CFDE65C45F813B(iLocal_157, 1), unk_0xA8CFDE65C45F813B(unk_0x27D769C59BC9D030(), 1)) < 64f && !unk_0x9A4E2270C2271219(unk_0x27D769C59BC9D030(), 0))
				{
					iLocal_161 = 0;
					iLocal_162 = 0;
					iLocal_328 = 1;
			...
			case 1:
				...
				unk_0x8B8674266D533E9F(iLocal_157, uVar1);
				unk_0x433C209504FBC7EE(&uVar1);
				iLocal_328 = 2;
				break;
			
			case 2:
				if ((unk_0x810AFFABCBF31E2D(iLocal_157, 242628503) != 1 || unk_0xB1D18B06E0525A9E(iLocal_157, unk_0x27D769C59BC9D030(), 20f)) && !unk_0x1BF2632AED6B5924())
				{
					unk_0xF14C2AE8A3F59CE0(iLocal_157, unk_0x27D769C59BC9D030(), -1);
					if (!iLocal_162)
					{
			...
			case 3:
				...
				{
					func_33(&uLocal_144);
					unk_0x878D12AEFBF5BAF0(iLocal_157, "random@street_race", "_streetracer_wait_loop", 4f, -4f, -1, 9, 0, 0, 0, 0);
					iLocal_328 = 4;
				}
				break;
			
			case 4:
				if (unk_0xB7A628320EFF8E47(unk_0xA8CFDE65C45F813B(iLocal_157, 1), unk_0xA8CFDE65C45F813B(unk_0x27D769C59BC9D030(), 1)) > 225f)
				{
					unk_0x33A0CEA494F4C2A3(&uVar2);
					unk_0xD9F9CB5C8842E29C(0, Local_329.f_83.f_9, 1000);
					unk_0x878D12AEFBF5BAF0(0, Local_329.f_83.f_12, Local_329.f_83.f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x33F83FC0F5F458E3(uVar2);
					unk_0x8B8674266D533E9F(iLocal_157, uVar2);
...
{
	unk_0x1D6AFE0F8AC2F140(iParam0, sParam1, sParam2, func_73(iParam3), 0);
}
...
void func_74()
{
	...
	while (iVar2 < 5)
	{
		if (unk_0xD2CFFE76B625AE55(Local_329[iVar2 /*14*/].f_1) && unk_0xD2CFFE76B625AE55(Local_329[iVar2 /*14*/]))
		{
			if (func_79(Local_329[iVar2 /*14*/], 1, 0, 0, 0) || unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), Local_329[iVar2 /*14*/].f_1, 1))
			{
				func_77();
				func_76(iLocal_105);
				unk_0x9F805E4A6F671CEE(unk_0x4D29100D094E5511(), 1, 0);
			}
			if (!unk_0xE4F7206742848BAF(Local_329[iVar2 /*14*/]))
			{
				if (func_26(&(Local_125[iVar2 /*3*/])))
				{
					if (func_23(&(Local_125[iVar2 /*3*/])) > uLocal_150[iVar2])
					{
						if (unk_0x0B4DDB992C7BCF57(Local_329[iVar2 /*14*/].f_1, 0) && unk_0x1C48F76B3D032074(Local_329[iVar2 /*14*/], Local_329[iVar2 /*14*/].f_1, 0))
						{
							iVar0 = unk_0x3A5708FEE1B560A9(250, 500);
							iVar1 = unk_0x3A5708FEE1B560A9(250, 500);
							unk_0x33A0CEA494F4C2A3(&uVar3);
							unk_0xCB3588C2CE159109(0, Local_329[iVar2 /*14*/].f_1, 1, iVar0);
							unk_0xCB3588C2CE159109(0, Local_329[iVar2 /*14*/].f_1, 31, iVar1);
							unk_0x33F83FC0F5F458E3(uVar3);
							if (!unk_0xE4F7206742848BAF(Local_329[iVar2 /*14*/]))
							{
								unk_0x8B8674266D533E9F(Local_329[iVar2 /*14*/], uVar3);
							}
							unk_0x433C209504FBC7EE(&uVar3);
						}
						func_33(&(Local_125[iVar2 /*3*/]));
						uLocal_150[iVar2] = unk_0x5C02660403071A83(0f, 3f);
					}
				}
				else
				{
			...
			if (!unk_0x2006A8C1BA2AFE80(Local_329[iVar2 /*14*/], 0))
			{
				if ((unk_0x799B2D82E6E6C363(unk_0x27D769C59BC9D030(), Local_329[iVar2 /*14*/]) && !unk_0xBD036012AF60D938(Local_329[iVar2 /*14*/])) && !unk_0x8D1E4231095B313B(Local_329[iVar2 /*14*/]))
				{
				...
				{
					unk_0x33A0CEA494F4C2A3(&uVar3);
					unk_0xD9F9CB5C8842E29C(0, Local_329[iVar2 /*14*/].f_9, 1000);
					unk_0x878D12AEFBF5BAF0(0, Local_329[iVar2 /*14*/].f_12, Local_329[iVar2 /*14*/].f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x33F83FC0F5F458E3(uVar3);
					unk_0x8B8674266D533E9F(Local_329[iVar2 /*14*/], uVar3);
					unk_0x433C209504FBC7EE(&uVar3);
					Local_329[iVar2 /*14*/].f_11 = 0;
				}
				if (unk_0xBD036012AF60D938(Local_329[iVar2 /*14*/]) || unk_0x8D1E4231095B313B(Local_329[iVar2 /*14*/]))
				{
					if (!Local_329[iVar2 /*14*/].f_10 && (unk_0xBD036012AF60D938(Local_329[iVar2 /*14*/]) || unk_0x8D1E4231095B313B(Local_329[iVar2 /*14*/])))
					{
						Local_329.f_101++;
					}
				...
				else if (Local_329[iVar2 /*14*/].f_10)
				{
					...
					unk_0x878D12AEFBF5BAF0(0, "gestures@m@standing@casual", func_75(), 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0xD9F9CB5C8842E29C(0, Local_329[iVar2 /*14*/].f_9, 1000);
					unk_0x878D12AEFBF5BAF0(0, Local_329[iVar2 /*14*/].f_12, Local_329[iVar2 /*14*/].f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x33F83FC0F5F458E3(uVar3);
					unk_0x8B8674266D533E9F(Local_329[iVar2 /*14*/], uVar3);
	...
	if (unk_0xD2CFFE76B625AE55(Local_329.f_83.f_1) && unk_0xD2CFFE76B625AE55(Local_329.f_83))
	{
		if (unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), Local_329.f_83.f_1, 0))
		{
		...
		if (!unk_0xE4F7206742848BAF(Local_329.f_83))
		{
			if (func_26(&uLocal_141))
			{
				if (func_23(&uLocal_141) > fLocal_156)
				{
					if (unk_0x0B4DDB992C7BCF57(Local_329.f_83.f_1, 0) && unk_0x1C48F76B3D032074(Local_329.f_83, Local_329.f_83.f_1, 0))
					{
						iVar0 = unk_0x3A5708FEE1B560A9(250, 500);
						iVar1 = unk_0x3A5708FEE1B560A9(250, 500);
						unk_0x33A0CEA494F4C2A3(&uVar3);
						unk_0xCB3588C2CE159109(0, Local_329.f_83.f_1, 1, iVar0);
						unk_0xCB3588C2CE159109(0, Local_329.f_83.f_1, 31, iVar1);
						unk_0x33F83FC0F5F458E3(uVar3);
						if (!unk_0xE4F7206742848BAF(Local_329.f_83))
						{
							unk_0x8B8674266D533E9F(Local_329.f_83, uVar3);
						}
						unk_0x433C209504FBC7EE(&uVar3);
					}
					func_33(&uLocal_141);
					fLocal_156 = unk_0x5C02660403071A83(0f, 3f);
				}
			}
			else
			{
		...
		if (!unk_0x2006A8C1BA2AFE80(Local_329.f_83, 0))
		{
			if ((unk_0x799B2D82E6E6C363(unk_0x27D769C59BC9D030(), Local_329.f_83) && !unk_0xBD036012AF60D938(Local_329.f_83)) && !unk_0x8D1E4231095B313B(Local_329.f_83))
			{
			...
			if (unk_0xBD036012AF60D938(Local_329.f_83) || unk_0x8D1E4231095B313B(Local_329.f_83))
			{
			...
			else if (Local_329.f_83.f_10)
			{
				...
				unk_0x878D12AEFBF5BAF0(0, "gestures@m@standing@casual", func_75(), 8f, -8f, -1, 0, 0, 0, 0, 0);
				unk_0xD9F9CB5C8842E29C(0, Local_329.f_83.f_9, 1000);
				unk_0x878D12AEFBF5BAF0(0, Local_329.f_83.f_12, Local_329.f_83.f_13, 8f, -8f, -1, 0, 0, 0, 0, 0);
				unk_0x33F83FC0F5F458E3(uVar3);
				unk_0x8B8674266D533E9F(Local_329.f_83, uVar3);
				unk_0x433C209504FBC7EE(&uVar3);
				iLocal_328 = 4;
...
void func_77()
{
	...
	unk_0xFCB979DB36343941(unk_0x27D769C59BC9D030(), &iVar0, -1);
	iVar12 = 0;
	iVar12 = 0;
	while (iVar12 < iVar0)
	{
		if (unk_0xD2CFFE76B625AE55(iVar0[iVar12]) && !unk_0xE4F7206742848BAF(iVar0[iVar12]))
		{
			if (unk_0x1D01F222CF5E89FA(unk_0x27D769C59BC9D030(), 4))
			{
				unk_0x3DA9DFE29006A19F(iVar0[iVar12], unk_0x27D769C59BC9D030(), 100f, -1, 0, 0);
			}
			else
			{
				unk_0x33A0CEA494F4C2A3(&uVar11);
				unk_0xF14C2AE8A3F59CE0(0, unk_0x27D769C59BC9D030(), unk_0x3A5708FEE1B560A9(300, 900));
				unk_0xF7CC6FE06DC847BB(0, unk_0x27D769C59BC9D030(), 0, 0);
				unk_0x33F83FC0F5F458E3(uVar11);
				unk_0x8B8674266D533E9F(iVar0[iVar12], uVar11);
...
int func_79(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (unk_0xD2CFFE76B625AE55(uParam0))
	{
		if (!unk_0xE4F7206742848BAF(iParam0))
		{
			...
			if (unk_0xFA5CB09BC1B8EFDF(iParam0))
			{
				return 1;
			}
			...
			{
				if (unk_0x0F12B5F9C73EBD42(iParam0) == iVar0)
				{
					return 1;
				}
			}
...
{
	return func_81(unk_0xC834A7C58DEB59B4(unk_0xB927AFB90873B8C1()), uParam0, iParam1);
}
...
{
	if (unk_0xD2CFFE76B625AE55(iParam0) && unk_0x1C48F76B3D032074(unk_0x27D769C59BC9D030(), iParam0, 0))
	{
		return 0;
	}
	else
		...
		if (unk_0xD2CFFE76B625AE55(unk_0x27D769C59BC9D030()))
		{
			if (!unk_0xE4F7206742848BAF(unk_0x27D769C59BC9D030()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xA3626A14E36A87F3(unk_0x4D29100D094E5511(), 1) || func_105()) || Global_25122) || func_104()) || func_90(8, -1)) || func_101()) || func_103()) || func_102()) || func_92()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x0E14B2E6EB7392B5(unk_0x4D29100D094E5511()) || unk_0x0BAF34551BADE6DC(unk_0x27D769C59BC9D030())) || unk_0x0F74EBD810C90005(unk_0x27D769C59BC9D030())) || unk_0xBD036012AF60D938(unk_0x27D769C59BC9D030())) || unk_0x91C2FD50D18141F4(unk_0x27D769C59BC9D030())) || unk_0xA3626A14E36A87F3(unk_0x4D29100D094E5511(), 1)) || unk_0x300FBC9A9F898890(unk_0x4D29100D094E5511())) || unk_0x55AE67E25C3C8024(unk_0x27D769C59BC9D030(), 0)) || func_105()) || Global_100201) || Global_25122) || func_104()) || func_90(8, -1)) || func_101()) || func_103()) || func_102()) || func_92()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0xBD036012AF60D938(unk_0x27D769C59BC9D030()) || unk_0x91C2FD50D18141F4(unk_0x27D769C59BC9D030())) || unk_0xA3626A14E36A87F3(unk_0x4D29100D094E5511(), 1)) || unk_0x55AE67E25C3C8024(unk_0x27D769C59BC9D030(), 0)) || func_105()) || Global_100201) || Global_25122) || func_104()) || func_90(8, -1)) || func_103()) || func_102()) || func_92()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_105() || unk_0xC6861DC0B749762A(unk_0x4D29100D094E5511()) > 0) || func_90(8, -1)) || func_92()) || func_100()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((unk_0x55AE67E25C3C8024(unk_0x27D769C59BC9D030(), 0) || !unk_0x170C6E2649B67440(unk_0x4D29100D094E5511())) || !unk_0x0E14B2E6EB7392B5(unk_0x4D29100D094E5511())) || !unk_0xCBB243DDC0D132D1()) || unk_0x0BAF34551BADE6DC(unk_0x27D769C59BC9D030())) || unk_0xBD036012AF60D938(unk_0x27D769C59BC9D030())) || unk_0x91C2FD50D18141F4(unk_0x27D769C59BC9D030())) || unk_0xA3626A14E36A87F3(unk_0x4D29100D094E5511(), 1)) || func_105()) || func_102()) || Global_100201) || Global_25122) || func_104()) || Global_36839) || func_90(8, -1)) || func_101()) || func_100()) || func_92()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_111()
{
	...
	iVar0 = unk_0xEFEADD7EBD01C0A6();
	if ((iVar0 <= iLocal_119 && iVar0 >= iLocal_120) || unk_0xC6861DC0B749762A(unk_0x4D29100D094E5511()) != 0)
	{
		return;
	}
	if (bLocal_158)
	{
		...
		{
			if (unk_0xAE930CC2795F78CF(sVar1))
			{
				if (!unk_0x28CF037DC47EE46D(sVar1))
				{
					unk_0xE28C11441D3C6728(sVar1, 1);
				}
			}
		}
	}
...
void func_112()
{
	...
	if (fLocal_110 > 9f)
	{
		...
		while (iVar5 < Local_329.f_0)
		{
			...
			{
				Local_329[iVar5 /*14*/].f_1 = unk_0x4E76306EE6AE7596(func_116(0), Local_329[iVar5 /*14*/].f_2, Local_329[iVar5 /*14*/].f_5, 1, 1);
				unk_0xFA3ED0FFF3FD8F34(Local_329[iVar5 /*14*/].f_1);
				unk_0x1B7FCBF5F0A9F480(Local_329[iVar5 /*14*/].f_1, 1);
				if (func_117(Local_329[iVar5 /*14*/].f_6))
				{
					Local_329[iVar5 /*14*/] = unk_0x9961770283FB23FE(Local_329[iVar5 /*14*/].f_1, 4, func_115(), -1, 1, 1);
					unk_0x8BE1AEC303A057F7(Local_329[iVar5 /*14*/].f_1, 1, 0, 0);
				}
				else
				{
					Local_329[iVar5 /*14*/] = unk_0x91D233CD0204A37F(4, func_115(), Local_329[iVar5 /*14*/].f_6, Local_329[iVar5 /*14*/].f_9, 1, 1);
					iVar1 = iVar5;
					switch (iVar1)
					{
						case 0:
					...
					unk_0x963F67A22BBFA2AE(0, unk_0x3A5708FEE1B560A9(100, 500));
					unk_0x878D12AEFBF5BAF0(0, sVar3, sVar4, 8f, -8f, -1, 8193, unk_0x5C02660403071A83(0, 1065353216), 0, 0, 0);
					unk_0x33F83FC0F5F458E3(uVar0);
					unk_0x8B8674266D533E9F(Local_329[iVar5 /*14*/], uVar0);
					unk_0x433C209504FBC7EE(&uVar0);
				}
				unk_0x846AF7F4E166B47A(Local_329[iVar5 /*14*/], 1);
				unk_0xEA9F3D2740164867(Local_329[iVar5 /*14*/], 1, 4096, -1);
			}
			iVar5++;
		}
		Local_329.f_83.f_1 = unk_0x4E76306EE6AE7596(func_116(1), Local_329.f_83.f_2, Local_329.f_83.f_5, 1, 1);
		unk_0xFA3ED0FFF3FD8F34(Local_329.f_83.f_1);
		unk_0x1B7FCBF5F0A9F480(Local_329.f_83.f_1, 1);
		if (func_117(Local_329.f_83.f_6))
		{
			Local_329.f_83 = unk_0x9961770283FB23FE(Local_329.f_83.f_1, 4, func_115(), -1, 1, 1);
			unk_0x8BE1AEC303A057F7(Local_329.f_83.f_1, 1, 0, 0);
		}
		else
		{
			Local_329.f_83 = unk_0x91D233CD0204A37F(4, func_115(), Local_329.f_83.f_6, Local_329.f_83.f_9, 1, 1);
			...
			unk_0x33A0CEA494F4C2A3(&uVar0);
			unk_0x4E2F67DAF5750EE5(0, func_114((unk_0x3A5708FEE1B560A9(0, 65535) % 1000), 1, 1000));
			unk_0x878D12AEFBF5BAF0(0, "amb@world_human_aa_smoke@male@idle_a", sVar4, 8f, -8f, -1, 1, unk_0x5C02660403071A83(0, 1065353216), 0, 0, 0);
			unk_0x33F83FC0F5F458E3(uVar0);
			unk_0x8B8674266D533E9F(Local_329.f_83, uVar0);
			unk_0x433C209504FBC7EE(&uVar0);
		}
	}
	...
	if (!unk_0x2006A8C1BA2AFE80(Local_329[0 /*14*/], 0))
	{
		func_113(&uLocal_163, 1, Local_329[0 /*14*/], "MALE1", 0, 1);
	}
	if (!unk_0x2006A8C1BA2AFE80(Local_329[1 /*14*/], 0))
	{
		func_113(&uLocal_163, 2, Local_329[1 /*14*/], "MALE2", 0, 1);
	}
	if (!unk_0x2006A8C1BA2AFE80(Local_329[2 /*14*/], 0))
	{
...
int func_116(bool bParam0)
{
	...
	{
		if (unk_0xCCCEEEDD3FD9AA24(Local_329.f_71[iVar1]))
		{
			iVar0++;
		}
		iVar1++;
	...
	iVar0 = unk_0x3A5708FEE1B560A9(0, iVar0);
...
void func_121()
{
	...
	{
		case 0:
			unk_0x34EB68F89DCC1D05(-223.42f, 3948.36f, 36.52f, -212.37f, 3818.97f, 37.53f, 50f, 1, 0, 1);
			unk_0xC972AA2C9F94741D(-227.43f, 3888.9f, 36.41f, 50f, 1, 0, 0, 0, 0);
			unk_0x46FA2CC6615D6359("WORLD_HUMAN_HIKER", 0);
			break;
		
		case 1:
			unk_0x34EB68F89DCC1D05(-509.1254f, 1987.582f, 205.3305f, -948.5215f, 2752.741f, 25.35144f, 300f, 0, 0, 1);
			break;
		
		case 3:
			unk_0x46FA2CC6615D6359("WORLD_VEHICLE_DRIVE_SOLO", 0);
			unk_0x34EB68F89DCC1D05(-1943.822f, 4462.286f, 0f, -229.0783f, 4227.072f, 50f, 250f, 1, 0, 1);
			unk_0x31D69BBC7F83114D(-1943.822f, 4462.286f, 0f, -229.0783f, 4227.072f, 50f, 250f, 0, 0, 0, 0, 0);
			unk_0x34EB68F89DCC1D05(-196.58f, 4217.64f, 50.083f, -202.574f, 4210.926f, 40.0262f, 10f, 1, 0, 1);
			unk_0x46FA2CC6615D6359("WORLD_HUMAN_HIKER", 0);
			unk_0x46FA2CC6615D6359("WORLD_VEHICLE_EMPTY", 0);
			unk_0x46FA2CC6615D6359("WORLD_MOUNTAIN_LION_WANDER", 0);
			break;
		
		case 4:
			unk_0x46FA2CC6615D6359("WORLD_VEHICLE_DRIVE_SOLO", 0);
			unk_0x46FA2CC6615D6359("WORLD_VEHICLE_EMPTY", 1);
			unk_0x46FA2CC6615D6359("WORLD_VEHICLE_BIKE_OFF_ROAD_RACE", 1);
			break;
		
		case 5:
			unk_0x46FA2CC6615D6359("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 0);
			unk_0x34EB68F89DCC1D05(2242.488f, 2568.146f, -10f, 2242.488f, 1568.146f, 200f, 100f, 1, 0, 1);
			unk_0x31D69BBC7F83114D(2242.488f, 2568.146f, -10f, 2242.488f, 1568.146f, 200f, 1000f, 0, 0, 0, 0, 0);
			break;
		
		case 2:
			unk_0xE28C11441D3C6728("QUARRY", 0);
			unk_0x34EB68F89DCC1D05(2809.948f, 2993.644f, -9.3564f, 2952.969f, 2530.636f, 177.1921f, 500f, 1, 0, 1);
			unk_0x31D69BBC7F83114D(2809.948f, 2993.644f, -9.3564f, 2952.969f, 2530.636f, 177.1921f, 500f, 0, 0, 0, 0, 0);
			break;
	}
}
...
var func_122()
{
	return ((((((((func_123(&(Local_329.f_71)) && func_123(&(Local_329.f_77))) && func_123(&(Local_329.f_99))) && unk_0x482101C9B3483958("amb@world_human_hang_out_street@male_a@idle_a")) && unk_0x482101C9B3483958("amb@world_human_hang_out_street@male_b@idle_a")) && unk_0x482101C9B3483958("amb@world_human_hang_out_street@male_c@idle_a")) && unk_0x482101C9B3483958("amb@world_human_aa_smoke@male@idle_a")) && unk_0x482101C9B3483958("random@street_race")) && unk_0x482101C9B3483958("gestures@m@standing@casual"));
}
...
void func_124()
{
	...
	unk_0x88172B3983EC5071("amb@world_human_hang_out_street@male_a@idle_a");
	unk_0x88172B3983EC5071("amb@world_human_hang_out_street@male_b@idle_a");
	unk_0x88172B3983EC5071("amb@world_human_hang_out_street@male_c@idle_a");
	unk_0x88172B3983EC5071("amb@world_human_aa_smoke@male@idle_a");
	unk_0x88172B3983EC5071("random@street_race");
	unk_0x88172B3983EC5071("gestures@m@standing@casual");
	if (iLocal_124 == 0)
	{
		unk_0x97C59C4E8349D15F(joaat("prop_fncwood_14c"));
		unk_0x97C59C4E8349D15F(joaat("prop_fncwood_14e"));
	}
	...
	unk_0xA252A3A0F6CD48EC(1, &cVar0);
...
void func_137()
{
	...
	if (!func_109(func_140(iLocal_124)) && unk_0xCBB243DDC0D132D1())
	{
		if (iLocal_105 != 263)
		{
...
bool func_138(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		return unk_0xF426A5DE932B3BEE(Global_25433[iVar0 /*23*/].f_11, 15);
	}
	return unk_0xF426A5DE932B3BEE(Global_25433[iVar0 /*23*/].f_11, 0);
}
