	...
	while (iVar19 < 2)
	{
		switch (iVar19)
		{
			case 0:
				...
				fVar14 = unk_0x832AD84AA258AE80(Var10.f_0, Var10.f_1);
				fVar15 = (fVar16 + 180f);
				if (fVar15 > 360f)
				{
					fVar15 = (fVar15 - 360f);
				...
				if (unk_0x2A488C176D52CCA5(unk_0x26C2ACB261895E70(*uParam1, *uParam2, fVar17, 0f, 0f), unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1)) > unk_0x2A488C176D52CCA5(unk_0x26C2ACB261895E70(*uParam1, *uParam2, -fVar17, 0f, 0f), unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1)))
				{
					fVar17 = -fVar17;
				}
