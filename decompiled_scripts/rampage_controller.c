...
void __EntryFunction__()
{
	...
	iLocal_30 = 52;
	iLocal_28 = 77;
	if (unk_0xB4C854DD86E40FDA(joaat("rampage_controller")) > 1)
	{
	...
	while (iVar0 < 5)
	{
		...
		unk_0xCED9E32812D6C7C7(&(Global_112915.f_18574[(iLocal_30 + iVar0) /*6*/]), 3);
		iVar0++;
	}
	func_19(1);
	while (true)
...
void func_19(bool bParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		func_23(iVar1, 1);
		func_22(iVar1, 44);
		if (((Global_112915.f_2352[iVar0 /*2*/] >= 1 || func_36(108) == 1) || func_21((iLocal_29 + iVar0), 0)) || unk_0xE2D0C323A1AE5D85(Global_112915.f_18574[(iLocal_30 + iVar0) /*6*/], 3))
		{
			func_20(iVar1, 1);
		}
		iVar0++;
...
void func_28()
{
	...
	{
		func_32(13, unk_0xF34EE736CF047844(Global_112915.f_10194.f_3853));
	}
