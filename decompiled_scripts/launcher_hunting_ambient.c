		...
		if (unk_0xC844350D5D58C99A(uLocal_85) && !unk_0x437347B10A200C4B(iLocal_85, 0))
		{
			...
			switch (iLocal_95)
			{
				...
				case 6:
					...
					if (func_87(uLocal_94, 2097152))
					{
						if (!func_73(3) && !unk_0x1727A44C562FBED2(uLocal_52))
						{
							func_80(10);
						}
					}
...
void func_38()
{
	...
	if ((unk_0xC844350D5D58C99A(iLocal_124) && !unk_0x437347B10A200C4B(iLocal_124, 0)) && !unk_0x4E861BC5B1EDA7BD(iLocal_124))
	{
		...
		unk_0x9A8BCD43DBDDCDCA(iLocal_124, 0, 0);
		unk_0xF3F7BF451A720FDF(iLocal_124, 1);
		...
		if (unk_0xC844350D5D58C99A(iLocal_123) && !unk_0x437347B10A200C4B(iLocal_123, 0))
		{
			...
			unk_0xF3F7BF451A720FDF(iLocal_123, 1);
			unk_0x9A8BCD43DBDDCDCA(iLocal_123, 0, 0);
...
void func_77()
{
	if (bLocal_125)
	{
		...
		if (!iLocal_127)
		{
			unk_0x28F5E4DA506AC0CA(-1702.46f, 4666.36f, 22.1255f, 10f, 0, 0, 0, 0, 0, 0);
			if (!unk_0xC844350D5D58C99A(iLocal_123))
			{
				iLocal_123 = unk_0x122AAB0B1D6F55AD(joaat("blazer"), -1707.434f, 4666.563f, 22.1095f, 323.2491f, 1, 1, 0);
			}
			if (!unk_0xC844350D5D58C99A(iLocal_124))
			{
				iLocal_124 = unk_0x122AAB0B1D6F55AD(joaat("journey"), -1702.695f, 4666.941f, 22.7091f, 80.03f, 1, 1, 0);
				unk_0x44A200C9B6E1CEA6(iLocal_124, 1);
			}
			iLocal_127 = 1;
		}
	}
