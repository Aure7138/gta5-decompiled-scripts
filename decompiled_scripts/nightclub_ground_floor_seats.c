...
int func_84()
{
	if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -1607.052f, -3011.89f, -80.00597f, -1574.768f, -3011.67f, -77.99634f, 9.5f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_86()
{
	if (Global_2426097[unk_0x460153A63B9477BC() /*443*/].f_314.f_9 != func_19())
	{
		if (unk_0x1B2EFC1EEC84CBE3("nightclub_ground_floor_seats", Global_2426097[unk_0x460153A63B9477BC() /*443*/].f_314.f_9, 1, 0))
		{
			return 0;
		}
