...
int func_72()
{
	if (unk_0xA829C9A2767AC8EF() && !func_82())
	{
		return 1;
	}
	if (!func_81())
...
int func_81()
{
	if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), -1607.052f, -3011.89f, -80.00597f, -1574.768f, -3011.67f, -77.99634f, 9.5f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_83()
{
	if (Global_2689224[unk_0x9E2D6C50374FCFA9() /*451*/].f_317.f_9 != func_19())
	{
		if (unk_0x7B0A672B0283F03E("nightclub_ground_floor_seats", Global_2689224[unk_0x9E2D6C50374FCFA9() /*451*/].f_317.f_9, 1, 0))
		{
			return 0;
		}
