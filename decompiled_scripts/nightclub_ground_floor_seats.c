...
int func_71()
{
	if (unk_0xBB5E373390A5F824() && !func_84())
	{
		return 1;
	}
	if (!func_83())
...
int func_83()
{
	if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -1607.052f, -3011.89f, -80.00597f, -1574.768f, -3011.67f, -77.99634f, 9.5f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_85()
{
	if (Global_2424047[unk_0x95B959F18401C09A() /*416*/].f_309.f_8 != func_19())
	{
		if (unk_0x6C7B3B04B7D86C9E("nightclub_ground_floor_seats", Global_2424047[unk_0x95B959F18401C09A() /*416*/].f_309.f_8, 1, 0))
		{
			return 0;
		}
