...
int func_72()
{
	if (unk_0x71364F510A1CB69F() && !func_84())
	{
		return 1;
	}
	if (!func_83())
...
int func_83()
{
	if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -1607.052f, -3011.89f, -80.00597f, -1574.768f, -3011.67f, -77.99634f, 9.5f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_85()
{
	if (Global_2423801[unk_0xD4E735F4B6A956AC() /*413*/].f_309.f_7 != func_19())
	{
		if (unk_0x653C5F9B95C5F892("nightclub_ground_floor_seats", Global_2423801[unk_0xD4E735F4B6A956AC() /*413*/].f_309.f_7, 1, 0))
		{
			return 0;
		}
