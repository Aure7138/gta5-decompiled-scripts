...
int func_71()
{
	if (unk_0x17FAADF9916EF741() && !func_83())
	{
		return 1;
	}
	if (!func_82())
...
int func_82()
{
	if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -1607.052f, -3011.89f, -80.00597f, -1574.768f, -3011.67f, -77.99634f, 9.5f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_84()
{
	if (Global_2423644[unk_0xB5CEFD608600A09F() /*406*/].f_305.f_4 != func_19())
	{
		if (unk_0x18C4EA3345AA5A99("nightclub_ground_floor_seats", Global_2423644[unk_0xB5CEFD608600A09F() /*406*/].f_305.f_4, 1, 0))
		{
			return 0;
		}
