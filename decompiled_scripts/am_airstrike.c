...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			func_81();
			switch (func_80(unk_0x9725084D4DFE8258()))
			{
				case 0:
					if (func_79() > 0)
					{
						Local_298[unk_0x9725084D4DFE8258() /*5*/] = 2;
					}
					break;
				...
				case 2:
					if (func_79() == 3)
					{
						Local_298[unk_0x9725084D4DFE8258() /*5*/] = 3;
					}
					break;
...
void func_1()
{
	...
	if (Local_241.f_55 == 1)
	{
		if (!Local_241.f_56)
		{
			if (((!unk_0xC9EED58014EF1F40() || func_7("AIRSTRIKE_1")) || func_7("AIRSTRIKE_2")) || func_7("AIRSTRIKE_4"))
			{
	...
	if (bLocal_51)
	{
		if (!func_3(unk_0xCFC72E446B0B3AD7(), 1))
		{
			Local_241.f_0 = 3;
		}
	}
	else if (func_3(unk_0xCFC72E446B0B3AD7(), 1) || func_2())
	{
		Local_241.f_0 = 3;
	}
...
void func_12()
{
	...
	if (func_16(Local_62))
	{
		...
		{
			Local_62 = { unk_0x77009B1C011405A9(unk_0x1349078BE884A8E7(Local_241.f_2), 1) };
	...
	switch (Local_241.f_50)
	{
		case 0:
			...
			{
				if (!unk_0x94E72F17611BCD3C(uLocal_240, Local_241.f_50))
				{
					Var0 = { Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 };
					Var0.f_2 = Local_62.f_2;
					Var3 = { Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 };
					Var3 = { Var3 + Vector(0f, 0.1f, 0.1f) };
					unk_0x7844FB9DB5F9220C(Var3 + Vector(10f, 0f, 0f), &(Var3.f_2));
					Var3.f_2 = (Var3.f_2 - 25f);
					unk_0xA4ED623A1607B7AC(Var0, Var3, iVar6, 1, joaat("weapon_airstrike_rocket"), unk_0x9F92518438215DD0(), 1, 0, -1f, unk_0x9F92518438215DD0(), 1, 1, 0, 0);
					func_10(&(Local_241.f_51), 0, 0);
					iLocal_56 = 1;
					unk_0xEDB9A377CD8B7F03(&uLocal_240, Local_241.f_50);
				}
			}
		...
		case 1:
			if (!func_11(&(Local_241.f_51)))
			{
				if (!unk_0x94E72F17611BCD3C(uLocal_240, Local_241.f_50))
				{
					Var0 = { Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 + Vector(0f, 5f, 5f) };
					Var0.f_2 = Local_62.f_2;
					Var3 = { Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 + Vector(0f, 5f, 5f) };
					Var3 = { Var3 + Vector(0f, 0.1f, 0.1f) };
					unk_0x7844FB9DB5F9220C(Var3 + Vector(10f, 0f, 0f), &(Var3.f_2));
					Var3.f_2 = (Var3.f_2 - 25f);
					unk_0xA4ED623A1607B7AC(Var0, Var3, iVar6, 1, joaat("weapon_airstrike_rocket"), unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3), 1, 0, -1f, unk_0x9F92518438215DD0(), 1, 0, 0, 0);
					func_10(&(Local_241.f_51), 0, 0);
					unk_0xEDB9A377CD8B7F03(&uLocal_240, Local_241.f_50);
				}
			}
		...
		case 5:
			if (!func_11(&(Local_241.f_51)))
			{
				if (!unk_0x94E72F17611BCD3C(uLocal_240, Local_241.f_50))
				{
					Var0 = { Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 + Vector(0f, 5f, 10f) };
					Var0.f_2 = Local_62.f_2;
					Var3 = { Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 + Vector(0f, 5f, 10f) };
					Var3 = { Var3 + Vector(0f, 0.1f, 0.1f) };
					unk_0x7844FB9DB5F9220C(Var3 + Vector(10f, 0f, 0f), &(Var3.f_2));
					Var3.f_2 = (Var3.f_2 - 25f);
					unk_0xA4ED623A1607B7AC(Var0, Var3, iVar6, 1, joaat("weapon_airstrike_rocket"), unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3), 1, 0, -1f, unk_0x9F92518438215DD0(), 1, 0, 0, 0);
		...
		case 6:
			if (!func_11(&(Local_241.f_51)))
			{
				if (!unk_0x94E72F17611BCD3C(uLocal_240, Local_241.f_50))
				{
					Var0 = { Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 + Vector(0f, 10f, 10f) };
					Var0.f_2 = Local_62.f_2;
					Var3 = { Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 + Vector(0f, 10f, 10f) };
					Var3 = { Var3 + Vector(0f, 0.1f, 0.1f) };
					unk_0x7844FB9DB5F9220C(Var3 + Vector(10f, 0f, 0f), &(Var3.f_2));
					Var3.f_2 = (Var3.f_2 - 25f);
					unk_0xA4ED623A1607B7AC(Var0, Var3, iVar6, 1, joaat("weapon_airstrike_rocket"), unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3), 1, 0, -1f, unk_0x9F92518438215DD0(), 1, 0, 0, 0);
...
int func_14(var uParam0)
{
	...
	{
		return !func_15(unk_0x1349078BE884A8E7(uParam0));
	}
	return 0;
}
...
void func_17()
{
	...
	if (func_14(Local_241.f_2))
	{
		uVar0 = unk_0x1349078BE884A8E7(Local_241.f_2);
		Var4 = { unk_0x77009B1C011405A9(uVar0, 1) };
	}
	if (!iLocal_58)
	{
		if (!func_16(Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2))
		{
			Var1 = { Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 };
		}
		else if (func_23(unk_0xCFC72E446B0B3AD7(), 1, 1))
		{
	...
	if (bLocal_57)
	{
		if (!iLocal_58)
		{
			if (func_14(Local_241.f_2))
			{
				if (!unk_0x41EEB10CCC2497A8(iVar0, Local_59, 75f, 75f, 1000f, 0, 1, 0))
				{
					fLocal_65 = unk_0x91EAD4F2F9B5B38A(Var4, Var1, 0);
				}
				else
				{
					iLocal_58 = 1;
	...
	if (unk_0x746960881FB19A89(unk_0x9F92518438215DD0()))
	{
		if (!unk_0x0BA451447C3B1A8D(unk_0x9F92518438215DD0()))
		{
			if (!iLocal_55)
			{
				...
				{
					bVar3 = !func_76();
					unk_0x46D3B8FF073CD238(unk_0x9F92518438215DD0(), joaat("weapon_flare"), 1, bVar3, bVar3);
					unk_0x3E5529EA76D127DA(unk_0x9F92518438215DD0(), joaat("weapon_flare"), bVar3);
					iLocal_55 = 1;
				}
			}
			else if (unk_0x0404FE58B20E5686(unk_0x9F92518438215DD0(), joaat("weapon_flare"), 100f, &(Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2), 1))
			{
				if (func_75(Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2, 0f, 0f, 0f))
				{
					Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 = { Var0 };
				}
				...
				if (!iLocal_54)
				{
					if (!func_74(Local_241.f_2.f_3))
					{
						...
						{
							func_73();
							unk_0x32D18ECD9E6F9BE2(unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3));
							unk_0xC7EBE3C9AC83FAAA(unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3), uLocal_48);
							unk_0xF37759F06F6BBE96(unk_0x1349078BE884A8E7(Local_241.f_2), unk_0xF2DB717A73826179(50f));
							iLocal_54 = 1;
						}
					}
				}
			...
			else if (!iLocal_53)
			{
				...
				{
					if (func_72(unk_0x9F92518438215DD0()))
					{
	...
	switch (Local_241.f_2.f_2)
	{
		...
		case 2:
			if (func_14(Local_241.f_2))
			{
				...
				{
					uLocal_46 = unk_0x5304FE8A2CED6AE8(uVar0);
					unk_0xAFF0147EA2454485(uLocal_46, 16);
					unk_0x2A8C2BEEA4F7041F(uLocal_46, "AIRSTRIKE_5");
					unk_0x49101D6A0E39441B(uLocal_46, 0);
				}
				else
				{
					unk_0xE850D00C6437EA40(uLocal_46, unk_0x11E019C8F43ACC8A(unk_0xE691E4EA6B4440C6(uVar0)));
				}
				if (!iLocal_52)
				{
					if (!func_16(Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2))
					{
						Var7 = { Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 };
					}
					else
					{
						Var7 = { Local_59 };
					}
					if (unk_0x91EAD4F2F9B5B38A(Var7, unk_0x77009B1C011405A9(uVar0, 1), 1) <= (60f * 5f))
					{
						unk_0x2C663B02C347E7D5(unk_0x1349078BE884A8E7(Local_241.f_2));
						iLocal_52 = 1;
					}
				}
				if (!iLocal_238)
				{
					if (!Local_241.f_54)
					{
						if (!func_74(Local_241.f_2.f_3))
						{
							if (!func_16(Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2))
							{
								if (unk_0x91EAD4F2F9B5B38A(func_47(unk_0xCFC72E446B0B3AD7()), unk_0x77009B1C011405A9(unk_0x1349078BE884A8E7(Local_241.f_2.f_3), 1), 0) <= 250f)
								{
									if (unk_0x91EAD4F2F9B5B38A(Var7, unk_0x77009B1C011405A9(iVar0, 1), 1) >= (60f * 2.5f))
									{
					...
					if (!Local_241.f_53)
					{
						if (!func_16(Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2))
						{
							if (func_29() == 2)
							{
								...
								Var1 = { Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 - Vector(1000f, 25f, 25f) };
								Var4 = { Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 + Vector(1000f, 25f, 25f) };
								Var1.f_2 = -200f;
								Var4.f_2 = 1500f;
								if (unk_0x41EEB10CCC2497A8(iVar0, Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2, 75f, 75f, 1000f, 0, 1, 0) && unk_0x34B6D387C9A70A16(Var1, Var4, joaat("weapon_flare"), 0))
								{
									Local_241.f_53 = 1;
								}
							}
						...
						else if (unk_0x41EEB10CCC2497A8(iVar0, Local_59, 75f, 75f, 1000f, 0, 1, 0))
						{
							Local_241.f_53 = 1;
							Local_241.f_50 = 100;
							Local_241.f_54 = 1;
...
void func_27()
{
	...
	if (!func_74(Local_241.f_2.f_3))
	{
		...
		{
			if (unk_0x34CE5EC4D87561E4(Local_241.f_2.f_3))
			{
				uVar0 = unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3);
...
int func_29()
{
	...
	if (!unk_0xB0164DDCBF420548(Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 + Vector(0.5f, 0f, 0f)))
	{
		Local_241.f_55 = 1;
		return Local_241.f_55;
	}
...
void func_38()
{
	...
	if (unk_0x746960881FB19A89(unk_0x9F92518438215DD0()))
	{
		if (func_41(Global_97358.f_1729.f_539.f_3213) != unk_0xB6A50C909A8FABC3(unk_0x9F92518438215DD0()))
		{
			iVar0 = func_40(unk_0x9F92518438215DD0());
			if (func_39(iVar0) && (!func_42(14) || Global_96311))
			{
...
int func_51()
{
	if ((!unk_0x53C457DC61CBEBCA(Local_241.f_2.f_3) && func_70(Local_241.f_2.f_3.f_1)) && unk_0x53C457DC61CBEBCA(Local_241.f_2))
	{
		if (func_14(Local_241.f_2))
		{
			if (func_53(&(Local_241.f_2.f_3), Local_241.f_2, 22, Local_241.f_2.f_3.f_1, -1, 1, 1, 1))
			{
				unk_0x4A1AC49BA4A747F7(unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3), 1);
				unk_0xA50AD6983D49A772(unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3), Global_1574053);
				unk_0xFF59B84B0722F68E(unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3), 0);
				unk_0xE8105B7E3908547D(unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3), 1);
				func_52();
				unk_0xC7EBE3C9AC83FAAA(unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3), uLocal_47);
				unk_0xF37759F06F6BBE96(unk_0x1349078BE884A8E7(Local_241.f_2), unk_0xF2DB717A73826179(50f));
			}
		}
	}
	if (!unk_0x53C457DC61CBEBCA(Local_241.f_2.f_3))
	{
		return 0;
	}
	unk_0x0880E86251A44B7F(Local_241.f_2.f_3.f_1);
	return 1;
}
...
void func_52()
{
	if (!iLocal_49)
	{
		if (func_14(Local_241.f_2))
		{
			unk_0xF87DA7F5BA8C7D0F(&uLocal_47);
			unk_0x6A3A0F12B1081E17(0, unk_0x1349078BE884A8E7(Local_241.f_2), 0, 0, Local_59 + Vector((50f + 5f), 0f, 0f), 4, 60f, 15f, -1f, unk_0x11E019C8F43ACC8A((50f + 5f)), 20);
			unk_0x6A3A0F12B1081E17(0, unk_0x1349078BE884A8E7(Local_241.f_2), 0, 0, Local_241.f_2.f_14, 4, 60f, 25f, -1f, unk_0x11E019C8F43ACC8A((50f + 5f)), 20);
			unk_0x3179CCC77CBAB31F(uLocal_47);
			iLocal_49 = 1;
		}
	}
}
...
int func_54()
{
	...
	if (!unk_0x53C457DC61CBEBCA(Local_241.f_2))
	{
		if (func_70(Local_241.f_2.f_1))
		{
			if (unk_0x0B3C0074C96B047B("AIRSTRIKE_FLYOVER", 0))
			{
				func_66(&Var0, &uVar3);
				if (func_56(Var0, 6f, 1f, 1f, 5f, 1, 1, 1, 1123024896, 0, -1, 1, 0, 0, 0, 0))
				{
					if (func_55(&(Local_241.f_2), Local_241.f_2.f_1, Var0, uVar3, 1, 1, 1, 0, 1, 1))
					{
						...
						unk_0x993B4D0D3CD44124(unk_0x1349078BE884A8E7(Local_241.f_2), 2);
						unk_0xD9B13F0A69759C12(unk_0x1349078BE884A8E7(Local_241.f_2), 0);
						unk_0x4EFB72476F8D3302(unk_0x1349078BE884A8E7(Local_241.f_2), 1);
						unk_0x3BD670EFDCBA8935(unk_0x1349078BE884A8E7(Local_241.f_2));
						unk_0xBF3459C0ACC7B82F(unk_0x1349078BE884A8E7(Local_241.f_2), 60f);
						unk_0x6FD45FA39DD18625(unk_0x1349078BE884A8E7(Local_241.f_2), 1, 1);
						unk_0xD6064E207C330447(unk_0x1349078BE884A8E7(Local_241.f_2), 1000);
						unk_0x185D18DA9BC98757(unk_0x1349078BE884A8E7(Local_241.f_2), 0);
						unk_0xDA06BD0F8C6042F9(unk_0x1349078BE884A8E7(Local_241.f_2), 3);
						unk_0xAA8BB7693505FCBB(unk_0x1349078BE884A8E7(Local_241.f_2));
						unk_0x0880E86251A44B7F(Local_241.f_2.f_1);
						return 1;
					}
				}
			}
...
int func_57(struct<3> Param0, float fParam3, int iParam4, int iParam5, float fParam6, bool bParam7, int iParam8, float fParam9, bool bParam10)
{
	...
	if (iParam4 && !bParam7)
	{
		if (func_23(unk_0xCFC72E446B0B3AD7(), 1, 1))
		{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (!func_59(iVar1, 0) && unk_0x7F0B9D2743F95A8F(unk_0xCFC72E446B0B3AD7(), iVar1))
			{
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != unk_0xCFC72E446B0B3AD7()))
				{
					if ((func_58(iVar1) || !bParam10) && !Global_2414035[iVar1 /*254*/].f_253)
					{
						fVar2 = fParam6;
						if (fParam9 > 0f)
						{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && unk_0xCFC72E446B0B3AD7() != iVar1) || iParam8 == 0)
		{
			if (func_23(iVar1, bParam4, bParam5))
			{
				...
				{
					if (!bParam7 || (!unk_0x3E0478C40AB5B38D(unk_0x4E6043D225B9C75F(iVar1)) && func_58(iVar1)))
					{
						...
						{
							if (((unk_0x59A4BF97B76AD953(unk_0xCFC72E446B0B3AD7()) == -1 && uParam9) && bParam6) && func_63(iVar1))
							{
							}
...
{
	if (func_65(unk_0xCFC72E446B0B3AD7(), iParam0))
	{
		return 1;
	}
	Global_2445561 = { func_64(iParam0) };
...
int func_65(int iParam0, var uParam1)
{
	...
	{
		Global_2445561 = { func_64(iParam0) };
		Global_2445574 = { func_64(uParam1) };
...
void func_66(var uParam0, var uParam1)
{
	...
	*uParam0 = { func_68(Local_59 + Vector(200f, 0f, 0f), 600f, 600f, (200f / 2f)) };
	fVar0 = unk_0xBFD88A10ECC17193((*uParam0 - 600f), (uParam0->f_1 - 600f), (*uParam0 + 600f), (uParam0->f_1 + 600f));
...
Vector3 func_68(struct<3> Param0, float fParam3, float fParam4, float fParam5)
{
	...
	fVar3 = (fParam5 / 2f);
	Var0 = { func_69(Var0, unk_0x3250987ED5A577C0(fParam3, fParam4)) };
...
int func_72(int iParam0)
{
	...
	if (unk_0x8524DF00FC9C3785(iParam0))
	{
...
void func_73()
{
	if (!iLocal_50)
	{
		if (func_14(Local_241.f_2))
		{
			unk_0xF87DA7F5BA8C7D0F(&uLocal_48);
			unk_0x6A3A0F12B1081E17(0, unk_0x1349078BE884A8E7(Local_241.f_2), 0, 0, Local_298[unk_0x9725084D4DFE8258() /*5*/].f_2 + Vector((50f + 5f), 0f, 0f), 4, 60f, 15f, -1f, unk_0x11E019C8F43ACC8A((50f + 5f)), 20);
			unk_0x6A3A0F12B1081E17(0, unk_0x1349078BE884A8E7(Local_241.f_2), 0, 0, Local_241.f_2.f_14, 4, 60f, 25f, -1f, unk_0x11E019C8F43ACC8A((50f + 5f)), 20);
			unk_0x3179CCC77CBAB31F(uLocal_48);
			iLocal_50 = 1;
		}
	}
}
...
void func_77()
{
	if (!iLocal_237)
	{
		if (!func_74(Local_241.f_2.f_3))
		{
			func_78(&uLocal_72, 3, unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3), "FM_Pilot_Air", 1, 1);
			iLocal_237 = 1;
		}
	}
}
...
void func_82()
{
	if (unk_0x53C457DC61CBEBCA(Local_241.f_2.f_3) && unk_0x53C457DC61CBEBCA(Local_241.f_2))
	{
		if (func_14(Local_241.f_2) && !func_74(Local_241.f_2.f_3))
		{
			unk_0x6A3A0F12B1081E17(unk_0x3CD0885BEAA1EC4B(Local_241.f_2.f_3), unk_0x1349078BE884A8E7(Local_241.f_2), 0, unk_0x9F92518438215DD0(), 1f, 1f, 1f, 8, 60f, 1000f, -1f, 400, 400);
		}
	}
...
int func_87()
{
	...
	if (func_88() != 0)
	{
		if (unk_0x7B47A371E2D93C2C(func_88()) == 0)
		{
			return 1;
		}
	}
...
void func_98(struct<20> Param0)
{
	...
	func_102(0, -1, 0);
	unk_0xA32DB9C55050112C(&Local_241, 57);
	unk_0x85862F9356411B89(&Local_298, 11);
	...
	if (unk_0x746960881FB19A89(unk_0x9F92518438215DD0()))
	{
		Local_59 = { unk_0x77009B1C011405A9(unk_0x9F92518438215DD0(), 0) };
	}
	if (func_3(unk_0xCFC72E446B0B3AD7(), 1))
	{
		bLocal_51 = true;
	...
	func_99(64, 1);
	Local_298[unk_0x9725084D4DFE8258() /*5*/] = 0;
}
