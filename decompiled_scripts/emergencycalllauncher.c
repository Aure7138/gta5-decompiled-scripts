...
void func_3()
{
	...
	{
		Local_209 = { func_5() };
		if (unk_0x16CDA1894CFE0781(unk_0xB793F1A0B6CC4AE1(&Local_209)) == 0)
		{
			func_4();
		}
		else
...
void func_4()
{
	...
	{
		Global_24669 = 0;
		StringCopy(&Global_24670, "NULL", 24);
	}
}
...
void func_7()
{
	switch (iLocal_43)
	{
				...
				if (!Global_24504)
				{
					if (func_25())
					{
						if (func_8(&uLocal_44, 130, "LOCAUD", "LOC_CALLQ", iLocal_216, "CELL_601", "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0, 0, 0, 0))
						{
							if (!func_6())
							{
								unk_0x19DD85EFF70867D4("emergencycall");
								while (!unk_0x3EBB3CB89FC2CE55("emergencycall"))
								{
									unk_0x4EDE34FBADD967A6(0);
								}
		...
		case 1:
			if (unk_0x16CDA1894CFE0781(joaat("emergencycall")) == 0)
			{
				if (!func_27(130))
				{
					iLocal_42 = 1;
...
bool func_8(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	StringCopy(&Global_15799, sParam6, 24);
	StringCopy(&Global_15805, sParam7, 24);
	StringCopy(&Global_15811, sParam8, 24);
...
void func_16()
{
	...
	if (unk_0x538DF9E5B1DF01EB(unk_0xA16EC202D9D35357()))
	{
		if (func_19(Global_97439.f_1729.f_539.f_3213) != unk_0xA609E58449080951(unk_0xA16EC202D9D35357()))
		{
			...
			if (func_17(iVar0) && (!func_20(14) || Global_96391))
			{
...
{
	Global_24669 = 1;
	StringCopy(&Global_24670, unk_0x7E5A426328F6E635(), 24);
}
