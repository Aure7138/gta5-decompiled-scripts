...
void __EntryFunction__()
{
	...
	func_31(&uLocal_44, 1, 0, "EMSDispatch", 0, 1);
	func_30();
	while (true)
	{
...
void func_3()
{
	...
	{
		Local_209 = { func_5() };
		if (unk_0x7B47A371E2D93C2C(unk_0x398F092142D37E17(&Local_209)) == 0)
		{
			func_4();
		}
		else
...
void func_7()
{
	switch (iLocal_43)
	{
		case 0:
			if (func_27(130))
			{
				...
				if (!Global_24502)
				{
					if (func_25())
					{
						if (func_8(&uLocal_44, 130, "LOCAUD", "LOC_CALLQ", iLocal_216, "CELL_601", "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0, 0, 0, 0))
						{
							if (!func_6())
							{
								unk_0x9AD29F8AF48B9AD1("emergencycall");
								while (!unk_0x197501C41CB2403F("emergencycall"))
								{
									unk_0x4EDE34FBADD967A6(0);
								}
								unk_0xE81651AD79516E48("emergencycall", 512);
							}
							iLocal_43 = 1;
						}
					}
					else if (func_8(&uLocal_44, 130, "LOCAUD", "LOC_CALLQ", iLocal_216, "CELL_601", "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0, 0, 0, 0))
					{
						if (!func_6())
						{
							unk_0x9AD29F8AF48B9AD1("emergencycall");
		...
		case 1:
			if (unk_0x7B47A371E2D93C2C(joaat("emergencycall")) == 0)
			{
				if (!func_27(130))
				{
					iLocal_42 = 1;
...
bool func_8(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	StringCopy(&Global_15798, sParam6, 24);
	StringCopy(&Global_15804, sParam7, 24);
	StringCopy(&Global_15810, sParam8, 24);
...
void func_16()
{
	...
	{
		if (func_19(Global_97358.f_1729.f_539.f_3213) != unk_0xB6A50C909A8FABC3(unk_0x9F92518438215DD0()))
		{
			iVar0 = func_18(unk_0x9F92518438215DD0());
			if (func_17(iVar0) && (!func_20(14) || Global_96311))
			{
...
void func_24(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
{
	Global_24667 = 1;
	StringCopy(&Global_24668, unk_0xC2E9075570B5D2B9(), 24);
}
