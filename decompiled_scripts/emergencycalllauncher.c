...
void func_3()
{
	if (func_6())
	{
		...
		if (unk_0x486FF5D06E9659F1(unk_0x70E57E9927B6BA58(&uLocal_210)) == 0)
		{
			func_4();
		}
		else
...
void func_7()
{
	...
	{
		case 0:
			if ((((((func_35(130) && func_33(unk_0x259BE71D8A81D4FA()) != 192) && func_33(unk_0x259BE71D8A81D4FA()) != 190) && func_33(unk_0x259BE71D8A81D4FA()) != 191) && func_33(unk_0x259BE71D8A81D4FA()) != 225) && func_33(unk_0x259BE71D8A81D4FA()) != 226) && func_33(unk_0x259BE71D8A81D4FA()) != 227)
			{
				if (Global_32398)
				{
					iLocal_217 = 11;
...
bool func_8(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	StringCopy(&Global_21831, sParam6, 24);
	StringCopy(&Global_21837, sParam7, 24);
	StringCopy(&Global_21843, sParam8, 24);
...
{
	Global_32389 = 1;
	StringCopy(&Global_32390, unk_0x1AF90EB93E0012D6(), 32);
}
