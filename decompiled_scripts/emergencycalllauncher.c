...
void __EntryFunction__()
{
	...
	func_31(&uLocal_45, 1, 0, "EMSDispatch", 0, 1);
	func_30();
	while (true)
	{
...
void func_3()
{
	...
	{
		Local_210 = { func_5() };
		if (unk_0xB1A77D5C890711F9(unk_0x39BD4614CF899227(&Local_210)) == 0)
		{
			func_4();
		}
		else
...
void func_4()
{
	...
	{
		Global_25338 = 0;
		StringCopy(&Global_25339, "NULL", 24);
	}
}
...
void func_7()
{
	switch (iLocal_44)
	{
				...
				if (!Global_25173)
				{
					if (func_25())
					{
						if (func_8(&uLocal_45, 130, "LOCAUD", "LOC_CALLQ", iLocal_217, "CELL_601", "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0, 0, 0, 0))
						{
							if (!func_6())
							{
								unk_0x507887ECD0989471("emergencycall");
								while (!unk_0xF93DA38375EB3977("emergencycall"))
								{
									unk_0x4EDE34FBADD967A6(0);
								}
		...
		case 1:
			if (unk_0xB1A77D5C890711F9(joaat("emergencycall")) == 0)
			{
				if (!func_27(130))
				{
					iLocal_43 = 1;
...
bool func_8(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	StringCopy(&Global_15818, sParam6, 24);
	StringCopy(&Global_15824, sParam7, 24);
	StringCopy(&Global_15830, sParam8, 24);
...
void func_16()
{
	...
	if (unk_0x1F2158D615BC4B25(unk_0x77F050A399DB77ED()))
	{
		if (func_19(Global_99250.f_1754.f_539.f_3549) != unk_0xDF1398076E26B0E4(unk_0x77F050A399DB77ED()))
		{
			...
			if (func_17(iVar0) && (!func_20(14) || Global_98202))
			{
...
{
	Global_25338 = 1;
	StringCopy(&Global_25339, unk_0x664B47C58CE8A0A4(), 24);
}
