...
void __EntryFunction__()
{
	...
	while (iLocal_62)
	{
		...
		if (func_535())
		{
			...
			else if (!unk_0xB540EEBB14C48518(iLocal_96))
			{
				bVar0 = false;
				unk_0x39926DD5354848E1(iLocal_96);
			}
		}
				...
				if (bVar0)
				{
					...
					switch (iLocal_294)
					{
						case 0:
							if (iLocal_293 == -1)
							{
								if (unk_0x0D14162FE6E23CF2(iLocal_96))
								{
									iLocal_293 = func_486();
								}
								else if (func_484())
							...
							else if (func_479())
							{
								if (func_478())
								{
									if (func_535())
									{
										if (unk_0xB540EEBB14C48518(iLocal_96))
										{
											unk_0x0EEB301CAA50A123(iLocal_96, "WORLD_HUMAN_PROSTITUTE_HIGH_CLASS", 0, 0);
										}
										else
										{
											unk_0x39926DD5354848E1(iLocal_96);
...
void func_3()
{
	if (iLocal_295 > 0)
	{
		if (unk_0x1095F403F52B42E1(iLocal_98, 0))
		{
			if (!unk_0x4915F4759304D5CF(iLocal_97))
			{
				if (!unk_0xE0FD180CD24C0B67(iLocal_97, iLocal_98, 0))
				{
					func_90();
				}
			}
	...
	if (!unk_0xDC5D81351D6A4DDB(iLocal_97) || unk_0x7112137033807390(iLocal_97, 0))
	{
		func_89(15);
	}
	switch (iLocal_295)
	{
		...
		case 6:
			if (!unk_0x4915F4759304D5CF(iLocal_97))
			{
				if (unk_0xF9D4EF1338E38AFB(iLocal_96, 242628503) == 7)
				{
					iLocal_65 = unk_0xFD34717937104F1C();
					iLocal_66 = (iLocal_65 - iLocal_64);
					if (iLocal_66 >= 10000 || !unk_0x10E54C268D1B3FED(iLocal_96, iLocal_97, 12f, 12f, 5f, 0, 1, 0))
					{
		...
		case 7:
			...
			{
				unk_0xE49301B2B6F420DE(iLocal_97, iLocal_98, Local_90, (unk_0xC3B6F3872400A86D(iLocal_98) * 0.65f), 0, 0, 786859, 4f, -1f);
				iLocal_295 = 8;
			}
			break;
		
		case 8:
			if (unk_0xB7A628320EFF8E47(Local_90, unk_0xE2BBD32891C18569(iLocal_96, 1)) < 25f && unk_0xF9D4EF1338E38AFB(iLocal_97, -1817882002) != 1)
			{
				iLocal_297 = unk_0x22C775856F4633CA(1, 3);
				iLocal_295 = 11;
			}
		...
		case 15:
			if (unk_0xDC5D81351D6A4DDB(iLocal_96) && unk_0xDC5D81351D6A4DDB(iLocal_98))
			{
				if (unk_0xE0FD180CD24C0B67(iLocal_96, iLocal_98, 0))
				{
					if (!unk_0x7112137033807390(iLocal_97, 0))
					{
						if (unk_0xF9D4EF1338E38AFB(iLocal_97, -828834893) != 1)
						{
							unk_0xCB482EF95FAE4D73(iLocal_96, 0, 16842752);
						}
					}
				}
				else
...
void func_4()
{
	...
	{
		case 0:
			unk_0x08BDB2B0A49A64C5(iLocal_96, 0.916f);
		...
		case 1:
			if (unk_0xB7A628320EFF8E47(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 0), unk_0xE2BBD32891C18569(iLocal_96, 0)) < 22500f)
			{
				func_32();
			}
			func_29(iLocal_98);
...
int func_27(int iParam0)
{
	if (func_28())
	{
		if (!unk_0xE59B461FD3AB95B5(unk_0x8F474E419F56E48D(iParam0), unk_0xE2BBD32891C18569(iParam0, 1), 1))
		{
			return 1;
		}
	}
...
void func_30(var uParam0)
{
	...
	if (unk_0x1095F403F52B42E1(*uParam0, 0))
	{
		Var0 = { 0f, 0f, -0.1f };
		Var3 = { 0f, 0f, 0f };
		unk_0xFAE5E5AC968944E8(*uParam0, 1, Var0, Var3, 0, 1, 1, 1, 1, 0);
	}
}

bool func_31()
{
	return unk_0xC621379C202E086C(iLocal_96, 876132797);
}
...
{
	if (unk_0x429D45A6C6520026(sLocal_63))
	{
		sLocal_63 = func_44(iParam0, 0, 0);
		return 0;
	}
	if (!unk_0x39C2D9AB77873F84(sLocal_63))
	{
		return 0;
	}
	else
...
int func_49(int iParam0)
{
	...
	if (!unk_0x7112137033807390(iParam0, 0))
	{
		if (unk_0x97B2B0016AD3C7C6(iParam0) || !func_51(iParam0, iLocal_98, -1))
		{
			Var0 = { unk_0xE2BBD32891C18569(iParam0, 1) };
			unk_0xC2C4AE9DB4A0BEF3(iParam0, 196624, 1);
			if (func_50())
			{
				unk_0x1659AF2827EC9D40(iParam0, Var0, 300f, -1, 1, 1);
			}
...
float func_52(int iParam0)
{
	...
	Var0 = { unk_0xE2BBD32891C18569(iLocal_96, 1) };
	Var3 = { Local_90 };
	if (iParam0 == 0)
	{
...
void func_53()
{
	if (!unk_0x4915F4759304D5CF(iLocal_97))
	{
		if (unk_0x1095F403F52B42E1(iLocal_98, 0))
		{
			if (unk_0xE0FD180CD24C0B67(iLocal_97, iLocal_98, 0))
			{
				if (unk_0xF9D4EF1338E38AFB(iLocal_96, 242628503) == 1)
				{
					if (unk_0x5100CFEF9EA1B0E5(iLocal_96) > 0)
					{
						if (unk_0xE0FD180CD24C0B67(iLocal_96, iLocal_98, 0))
						{
							func_477("prostitute WAITING TO END   - DRIVING OFF (WANDER)");
							unk_0x2F89329397A277BC(&uLocal_101);
							unk_0x731722E696597BD1(0, iLocal_98, 10f, 786603);
							unk_0x301F42EEE3C40328(uLocal_101);
							unk_0xE1072FA2FECBAD96(iLocal_97, uLocal_101);
							unk_0x3A95A0A3221D4208(&uLocal_101);
							Local_90 = { func_54(unk_0xE2BBD32891C18569(iLocal_96, 1)) };
							unk_0x6D68030C791111E0(func_44(iLocal_96, 0, 0));
							iLocal_295 = 7;
...
void func_56()
{
	...
	if (!unk_0x4915F4759304D5CF(iLocal_97))
	{
		if (unk_0x1095F403F52B42E1(iLocal_98, 0))
		{
			if (unk_0xE0FD180CD24C0B67(iLocal_97, iLocal_98, 0))
			{
				fVar0 = unk_0xEAA5CEF8875FEEED(iLocal_98);
				if (unk_0x10E54C268D1B3FED(iLocal_97, iLocal_96, 15f, 15f, 5f, 0, 1, 0) && fVar0 <= 1f)
				{
					func_63(iLocal_96);
					iLocal_65 = unk_0xFD34717937104F1C();
					iLocal_66 = (iLocal_65 - iLocal_64);
					if (iLocal_66 >= iLocal_68)
					{
						if (func_535())
						{
							if (unk_0xB540EEBB14C48518(iLocal_97))
							{
								unk_0x53FF9BDD8529ACD2(iLocal_97);
							}
						}
						else
						{
						...
						iLocal_68 = unk_0x22C775856F4633CA(0, 10000);
						if (iLocal_68 > 2500)
						{
							unk_0x9568B1B58F78FF36(iLocal_96);
							unk_0x3A95A0A3221D4208(&uLocal_101);
							unk_0x2F89329397A277BC(&uLocal_101);
							unk_0xA2EBCD9385E56019(0, iLocal_98, -1, 0, 1f, 8388609, 0);
							unk_0xB3E1967E66494060(0, -1);
							unk_0x301F42EEE3C40328(uLocal_101);
							unk_0xE1072FA2FECBAD96(iLocal_96, uLocal_101);
							unk_0x3A95A0A3221D4208(&uLocal_101);
...
int func_57()
{
	...
	if (!unk_0xDC5D81351D6A4DDB(iLocal_96) || unk_0x4915F4759304D5CF(iLocal_96))
	{
		return 1;
	}
	if (!func_535())
	{
		if (unk_0x5D7DFE2058701942(iLocal_96, 1))
		{
			unk_0x1CBE3F8ED90509B2(iLocal_96, 1193033728, 0);
		}
		else if (func_476(iLocal_49, 4194304))
		{
			...
			{
				unk_0x3F01127ECD227890(0, func_61(iLocal_293), func_60(7), 8f, -1.5f, -1, 0, 0, 0, 0, 0);
			}
			func_58(1);
			unk_0x301F42EEE3C40328(uVar0);
			unk_0xE1072FA2FECBAD96(iLocal_96, uVar0);
	...
	switch (iLocal_54)
	{
		...
		case 1:
			if (func_476(iLocal_75, 524288))
			{
				if (unk_0xB540EEBB14C48518(iLocal_96))
				{
					unk_0x3F01127ECD227890(iLocal_96, func_61(iLocal_293), func_60(7), 8f, -1.5f, -1, 0, 0, 0, 0, 0);
				}
				else
				{
					unk_0x39926DD5354848E1(iLocal_96);
		...
		case 2:
			if (func_476(iLocal_75, 524288))
			{
				if (unk_0xB540EEBB14C48518(iLocal_96))
				{
					if (unk_0xF9D4EF1338E38AFB(iLocal_96, -2017877118) == 7)
					{
						func_58(0);
						iLocal_54 = 3;
					}
...
void func_58(bool bParam0)
{
	...
	if (((unk_0xA6F0C4E7E1A7F439(iLocal_96) || unk_0x0D14162FE6E23CF2(iLocal_96)) || unk_0x68128F973FA5E2E3(iLocal_96, func_59(0))) || unk_0x68128F973FA5E2E3(iLocal_96, func_59(1)))
	{
		return;
	}
	Var0 = { unk_0xE2BBD32891C18569(iLocal_96, 1) };
	if (!unk_0x07EC788D27AB67D3(Var0, func_59(0), 20f, 1) && !unk_0x07EC788D27AB67D3(Var0, func_59(1), 20f, 1))
	{
		if (bParam0)
		{
	...
	if (!bParam0)
	{
		unk_0xB62205D12F35BF49(iLocal_96, Var0, 20f, 0);
	}
	else
	{
		unk_0xB62205D12F35BF49(0, Var0, 20f, 0);
	}
}
...
void func_62()
{
	if (unk_0x4915F4759304D5CF(iLocal_96))
	{
		return;
	}
	if (!unk_0x958D2327555FAEA5(iLocal_96))
	{
		if (func_18() == 2)
		{
			unk_0xE85BD4A26C0DFACA(iLocal_96, "HOOKER_DECLINED_TREVOR", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
		else
		{
			unk_0xE85BD4A26C0DFACA(iLocal_96, "HOOKER_DECLINED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
	}
}
...
void func_63(int iParam0)
{
	if (!unk_0x4915F4759304D5CF(iParam0))
	{
		if (func_64(iParam0))
		{
			unk_0xB0D7019224A3A443(iParam0, 109, 1);
		}
	}
}
...
int func_64(int iParam0)
{
	if (!unk_0x4915F4759304D5CF(iParam0))
	{
		if ((unk_0x411C28019DEA5CEF(iParam0, func_61(iLocal_293), func_60(1), 3) || unk_0x411C28019DEA5CEF(iParam0, func_61(iLocal_293), func_60(2), 3)) || unk_0x411C28019DEA5CEF(iParam0, func_61(iLocal_293), func_60(3), 3))
		{
			return 1;
		}
	}
	...
	if (!unk_0x4915F4759304D5CF(iLocal_97))
	{
		if (unk_0x1095F403F52B42E1(iLocal_98, 0))
		{
			if (unk_0xE0FD180CD24C0B67(iLocal_97, iLocal_98, 0))
			{
				if (unk_0xF9D4EF1338E38AFB(iLocal_96, 242628503) == 1)
				{
					if (unk_0x5100CFEF9EA1B0E5(iLocal_96) > 1)
					{
						if (unk_0x10E54C268D1B3FED(iLocal_96, iLocal_97, 20f, 20f, 10f, 0, 1, 0))
						{
							fVar0 = unk_0xEAA5CEF8875FEEED(iLocal_98);
							if (fVar0 <= 1f)
							{
								func_66(0);
								iLocal_64 = unk_0xFD34717937104F1C();
								iLocal_68 = unk_0x22C775856F4633CA(4000, 8000);
...
int func_66(bool bParam0)
{
	...
	if (!func_535())
	{
		if (bParam0)
		{
			unk_0xA95C9BC9CAF4C02D(iLocal_96, "PROSTITUTE_GROUP", 0);
		...
		if (func_476(iLocal_49, 4194304))
		{
			...
			unk_0x3F01127ECD227890(0, func_61(iLocal_293), func_60(0), 2f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0x3F01127ECD227890(0, func_61(iLocal_293), func_60(iVar0), 2f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0x3F01127ECD227890(0, func_61(iLocal_293), func_60(4), 2f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0x301F42EEE3C40328(uVar1);
			unk_0xE1072FA2FECBAD96(iLocal_96, uVar1);
	...
	switch (iLocal_53)
	{
		...
		case 1:
			if (func_476(iLocal_49, 4194304))
			{
				if (unk_0xB540EEBB14C48518(iLocal_96))
				{
					unk_0x3F01127ECD227890(iLocal_96, func_61(iLocal_293), func_60(0), 2f, -2f, -1, 0, 0, 0, 0, 0);
					iLocal_53 = 2;
				}
				else
				{
		...
		case 2:
			if (unk_0xB540EEBB14C48518(iLocal_96))
			{
				...
				{
					iVar0 = unk_0x22C775856F4633CA(1, 4);
					unk_0x3F01127ECD227890(iLocal_96, func_61(iLocal_293), func_60(iVar0), 2f, -2f, -1, 0, 0, 0, 0, 0);
					iLocal_53 = 3;
				}
			}
			else
		...
		case 3:
			if (unk_0xB540EEBB14C48518(iLocal_96))
			{
				if (unk_0xF9D4EF1338E38AFB(iLocal_96, -2017877118) == 7)
				{
					unk_0x3F01127ECD227890(iLocal_96, func_61(iLocal_293), func_60(4), 2f, -2f, -1, 1, 0, 0, 0, 0);
					iLocal_53 = 4;
				}
			}
			else
	...
	if (!unk_0x958D2327555FAEA5(iLocal_96))
	{
		switch (func_18())
		{
			case 0:
				...
				{
					unk_0xE85BD4A26C0DFACA(iLocal_96, "SOLICIT_MICHAEL", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				else
				{
					unk_0xE85BD4A26C0DFACA(iLocal_96, "SOLICIT_MICHAEL_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				break;
			...
			case 1:
				if (!func_68(iLocal_96))
				{
					unk_0xE85BD4A26C0DFACA(iLocal_96, "SOLICIT_FRANKLIN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				else
				{
					unk_0xE85BD4A26C0DFACA(iLocal_96, "SOLICIT_FRANKLIN_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				break;
			...
			case 2:
				if (!func_68(iLocal_96))
				{
					unk_0xE85BD4A26C0DFACA(iLocal_96, "SOLICIT_TREVOR", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				else
				{
					unk_0xE85BD4A26C0DFACA(iLocal_96, "SOLICIT_TREVOR_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				break;
			}
	}
...
bool func_74(int iParam0, int iParam1, int iParam2)
{
	...
	return unk_0x7710E77D1959B321(uParam0, uVar0) == func_75(iParam1, iParam2);
}
...
bool func_78(int iParam0, int iParam1, int iParam2)
{
	...
	return unk_0x774CB20D17C3FF03(uParam0, uVar0) == func_79(iParam1, iParam2);
}
...
void func_82()
{
	...
	if (!unk_0x4915F4759304D5CF(iLocal_97))
	{
		if (unk_0x1095F403F52B42E1(iLocal_98, 0))
		{
			...
			{
				fVar0 = unk_0xEAA5CEF8875FEEED(iLocal_98);
				if (unk_0xF9D4EF1338E38AFB(iLocal_97, -272084098) == 7 || fVar0 <= 1f)
				{
					unk_0xDFCF5BB9A4E3B293(unk_0x8F474E419F56E48D(iLocal_98), &Var4, &Var1);
					Var7 = { Var1 - Var4 };
					Var7 = { Var7 / Vector(2f, 2f, 2f) };
					Var10 = { unk_0x3201284584C7CD83(iLocal_98, 0.2f, 0.2f, 0f) };
					Var13 = { unk_0x3201284584C7CD83(iLocal_98, 0.2f, 0.2f, 0f) };
					Var16 = { unk_0xE2BBD32891C18569(iLocal_96, 1) };
					if (unk_0x2A488C176D52CCA5(Var16, Var13) < unk_0x2A488C176D52CCA5(Var16, Var10))
					{
						Var10 = { Var13 };
					}
					unk_0x2F89329397A277BC(&uLocal_101);
					unk_0x956B3CF461C0C1C9(0, Var10.f_0, Var10.f_1, Var10.f_2, 1f, -1, 0.5f, 8192, 1193033728);
					unk_0x0177431263151C4E(0, iLocal_97, 0);
					unk_0xB3E1967E66494060(0, -1);
					unk_0x301F42EEE3C40328(uLocal_101);
					unk_0xE1072FA2FECBAD96(iLocal_96, uLocal_101);
					unk_0x3A95A0A3221D4208(&uLocal_101);
	...
	if (!unk_0x4915F4759304D5CF(iLocal_97))
	{
		if (unk_0x1095F403F52B42E1(iLocal_98, 0))
		{
			if (unk_0xE0FD180CD24C0B67(iLocal_97, iLocal_98, 0))
			{
				...
				{
					if (func_84(unk_0xE2BBD32891C18569(iLocal_97, 1), 1106247680))
					{
						return;
					}
					Var0 = { unk_0xE2BBD32891C18569(iLocal_96, 1) };
					if (unk_0xA177613398FB538B(Var0, &Var0, 8, 1077936128, 0))
					{
						unk_0x7B19AF4B9DCA6BAB(iLocal_97, 1f);
						unk_0xF98BC2B4D0B8304E(iLocal_97, 0.2f);
						unk_0x3E1061046D82F070(iLocal_97, 0.05f);
						unk_0xACD687595DC10DD1(iLocal_97, iLocal_98, Var0, 0f, 3, 360f, 1);
						unk_0x22DD1D053CFF9707(iLocal_97, iLocal_96, -1, 2048, 4);
...
bool func_84(struct<3> Param0, int iParam3)
{
	if (func_535())
	{
		return unk_0x7394AC2F67EAA91C(Param0 - Vector(iParam3, iParam3, iParam3), Param0 + Vector(iParam3, iParam3, iParam3));
	}
	return (unk_0xF0AB7FB93B889653(Param0 - Vector(iParam3, iParam3, iParam3), Param0 + Vector(iParam3, iParam3, iParam3)) || unk_0x7394AC2F67EAA91C(Param0 - Vector(iParam3, iParam3, iParam3), Param0 + Vector(iParam3, iParam3, iParam3)));
}
	...
	if (unk_0x1095F403F52B42E1(*iParam0, 0))
	{
		...
		if (func_88(iVar0, 0) && func_87(*iParam0))
		{
			if (unk_0xD63FAD81FAF5E0CB(*iParam0) > 0)
			{
				...
				if (((iVar1 == 0 && unk_0x588F5E48C78F1C73(*iParam0, 0, 0)) && (!unk_0x39FC9AD10285F177(*iParam0, 1) && !unk_0x39FC9AD10285F177(*iParam0, 0))) || unk_0xB0D49A1F9F054602(*iParam0, 0, 0) == iLocal_96)
				{
					if (func_41(*iParam0))
					{
...
void func_90()
{
	if (func_535())
	{
		...
		{
			unk_0x9568B1B58F78FF36(iLocal_96);
			unk_0x53FF9BDD8529ACD2(iLocal_96);
		}
	}
	else
	{
	...
	iLocal_97 = 0;
	iLocal_98 = 0;
	unk_0x3F01127ECD227890(iLocal_96, func_61(iLocal_293), func_60(4), 2f, -2f, -1, 1, unk_0xF59B9063EDAC7451(0f, 0.9f), 0, 0, 0);
	func_89(0);
	iLocal_296 = 0;
	iLocal_294 = 1;
}
	...
	switch (iLocal_295)
	{
		case 0:
			...
			else if (iLocal_296 != 0 && !func_456("PROS_NO_MONEY"))
			{
				...
				{
					case 0:
						func_455(&uLocal_122, 0, unk_0xA19140A5C42D8715(), "MICHAEL", 0, 1);
						break;
					
					case 1:
						func_455(&uLocal_122, 0, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
						break;
					
					case 2:
						func_455(&uLocal_122, 0, unk_0xA19140A5C42D8715(), "TREVOR", 0, 1);
						break;
				}
				iLocal_295 = 1;
			}
		...
		case 11:
			...
			if (func_535())
			{
				unk_0xB0D7019224A3A443(unk_0xA19140A5C42D8715(), 433, 1);
				func_218(uParam0);
			}
			break;
...
void func_95()
{
	if (!unk_0x958D2327555FAEA5(unk_0xA19140A5C42D8715()))
	{
		if (iLocal_72 == 0)
		{
			...
			{
				unk_0xC2C4AE9DB4A0BEF3(iLocal_96, 32768, 0);
				unk_0xC2C4AE9DB4A0BEF3(iLocal_96, 196624, 1);
			}
			unk_0xE85BD4A26C0DFACA(iLocal_96, "HOOKER_LEAVES_ANGRY", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			func_89(15);
		}
	}
}
...
void func_96()
{
	...
	{
		case 0:
			if (!unk_0x958D2327555FAEA5(iLocal_96) || func_114(&uLocal_107) > 4f)
			{
				func_109(iLocal_96);
		...
		case 1:
			func_106();
			if (unk_0x958D2327555FAEA5(iLocal_96) || func_105())
			{
...
void func_99(bool bParam0)
{
	if (!unk_0x4915F4759304D5CF(iLocal_96))
	{
		...
		{
			unk_0x680F17660351F21B(&iLocal_96);
		}
		else
		{
...
void func_100(int iParam0, bool bParam1)
{
	...
	if (!unk_0x4915F4759304D5CF(uParam0))
	{
		...
		if (func_476(iLocal_49, 134217728))
		{
			unk_0xC2C4AE9DB4A0BEF3(iParam0, 32768, 1);
		...
		if (func_535())
		{
			if (unk_0x24B6018003B89ED4(iLocal_96))
			{
				if (unk_0x8F01F94322569B77(unk_0xF1764ACD94FCB3A3(iLocal_96)))
				{
...
{
	if (!unk_0x5860446BFB759B77(uParam0, unk_0xCAEB6CE71A2C7212(uParam0, 0), 0, 0, 0))
	{
	...
	if (unk_0xDC5D81351D6A4DDB(unk_0xA19140A5C42D8715()))
	{
		if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			...
			if (unk_0xDC5D81351D6A4DDB(iVar1))
			{
				...
				if (unk_0xB0D49A1F9F054602(iVar1, 0, 0) != iLocal_96)
				{
					bVar0 = true;
				}
...
void func_116(bool bParam0)
{
	...
	if (bParam0)
	{
		Var0 = { unk_0x288B716F47E9BBBC(iLocal_99, 2) };
		unk_0xD87B76260C547F31(180f);
		unk_0xAA32DD4848CF93E0((-5.5f - Var0.f_0), 1065353216);
	}
...
void func_118()
{
	...
	{
		unk_0x7CE8BDE02895D2F9(iLocal_99, 1);
	}
	if (iLocal_302 != 5)
	{
		...
		{
			if (!unk_0x8A29BBDF4603E52B(iLocal_96) || unk_0x80C8B831B972D6A0(unk_0xA19140A5C42D8715()))
			{
				iLocal_302 = 5;
			}
			if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
...
void func_122()
{
	...
	if (!unk_0x958D2327555FAEA5(iLocal_96))
	{
		unk_0xE85BD4A26C0DFACA(iLocal_96, "SEX_FINISHED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_123()
{
	...
	if (!unk_0x958D2327555FAEA5(iLocal_96))
	{
		unk_0xE85BD4A26C0DFACA(iLocal_96, "HOOKER_HAD_ENOUGH", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_127()
{
	...
	switch (iLocal_305)
	{
		...
		case 5:
			...
			{
				func_175(iLocal_96, 0);
				unk_0x3F01127ECD227890(iLocal_96, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(iLocal_305, 1, bVar1, bVar2), 4f, -4f, -1, 1, 0, 0, 0, 0);
				func_175(unk_0xA19140A5C42D8715(), -1);
				unk_0x3F01127ECD227890(unk_0xA19140A5C42D8715(), func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(iLocal_305, 0, bVar1, bVar2), 4f, -4f, -1, 1, 0, 0, 0, 0);
				func_116(1);
				iLocal_50 = 0;
				iLocal_73 = 0;
				iLocal_61 = 0;
...
void func_145()
{
	...
	{
		func_147(13, unk_0xF34EE736CF047844(Global_106070.f_10166.f_3853));
	}
...
void func_150(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_81, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(unk_0xA19140A5C42D8715(), iLocal_82, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(4, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_151(int iParam0, int iParam1, var uParam2, var uParam3, float fParam4, float fParam5, int iParam6, int iParam7, float fParam8, int iParam9)
{
	...
	{
		unk_0xE5565DEAABF9D588(iParam0, iParam1, uParam2, uParam3, fParam4, fParam5, iParam6, iParam7, fParam8, iParam9);
	}
}
...
void func_152(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_81, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_154(&iLocal_82, 0, 0, 0);
	func_153(unk_0xA19140A5C42D8715(), iLocal_82, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(4, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
void func_153(int iParam0, int iParam1, var uParam2, var uParam3, float fParam4, float fParam5, int iParam6, int iParam7, int iParam8)
{
	if (func_535())
	{
		unk_0xEA3AB11BD7C55DFF(iParam0, iParam1, uParam2, uParam3, fParam4, fParam5, iParam6, iParam7, iParam8, 0);
	}
}
...
void func_154(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	*iParam0 = func_157(Var0, 0f, 0f, 0f, bParam3, iParam2, 2);
	if (iParam1 == 0)
	{
		func_156(*iParam0, iLocal_99, unk_0x4F9AEAB2CC029A5C(iLocal_99, "seat_dside_f"));
	}
	else if (iParam1 == 1)
	{
		func_156(*iParam0, iLocal_99, unk_0x4F9AEAB2CC029A5C(iLocal_99, "seat_pside_f"));
	}
...
void func_155(var uParam0, struct<3> Param1, struct<3> Param4, int iParam7)
{
	if (!func_535())
	{
		unk_0x0BC3D6353E611561(uParam0, Param1, Param4, iParam7);
	}
}
...
void func_156(var uParam0, int iParam1, var uParam2)
{
	...
	if (func_535())
	{
		unk_0x44651DC12AB6C225(uParam0, iParam1, uParam2);
	}
	else
	{
		unk_0x460F6BE568AFE564(uParam0, iParam1, uParam2);
	}
}
...
var func_157(struct<3> Param0, struct<3> Param3, bool bParam6, int iParam7, int iParam8)
{
	...
	if (func_535())
	{
		...
		uVar0 = unk_0xDFA309EC878D6A65(Param0, Param3, iParam8, bParam6, iParam7, 1065353216, 0, 1065353216);
	}
	else
	{
		uVar0 = unk_0x70788DC3D80C9DEB(Param0, Param3, iParam8);
		unk_0x52CEAE2B7DAC257E(uVar0, bParam6);
		unk_0xDA16255FBFC16B28(uVar0, iParam7);
	}
	return uVar0;
}
...
void func_158(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_80, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(unk_0xA19140A5C42D8715(), iLocal_80, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(3, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_159(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_80, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_153(unk_0xA19140A5C42D8715(), iLocal_80, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(3, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
void func_167(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_79, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(2, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(unk_0xA19140A5C42D8715(), iLocal_79, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(2, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_168(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_79, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(2, 1, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
	func_153(unk_0xA19140A5C42D8715(), iLocal_79, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(2, 0, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
}
...
void func_169(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_78, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(unk_0xA19140A5C42D8715(), iLocal_78, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(1, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_170(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_78, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_153(unk_0xA19140A5C42D8715(), iLocal_78, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(1, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
float func_171(int iParam0)
{
	...
	if (func_535())
	{
		uVar0 = unk_0x33CECDD9E141E18E(unk_0x2B3422BC14FE3213(iParam0));
	}
	else
	{
		uVar0 = unk_0x33CECDD9E141E18E(iParam0);
	}
	return uVar0;
}
...
void func_173(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_76, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(0, 1, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
	func_151(unk_0xA19140A5C42D8715(), iLocal_77, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(0, 0, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
}
...
void func_174(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_76, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(0, 1, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
	func_154(&iLocal_77, 0, 0, 1);
	func_153(unk_0xA19140A5C42D8715(), iLocal_77, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_38(0, 0, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
}

void func_175(int iParam0, int iParam1)
{
	if (!unk_0xE0FD180CD24C0B67(iParam0, iLocal_99, 0))
	{
		if (!func_535())
		{
			unk_0x692D5500D82E4F5D(iParam0, iLocal_99, iParam1);
		}
		else if (!unk_0xE0FD180CD24C0B67(iParam0, iLocal_99, 0))
		{
			unk_0xA2EBCD9385E56019(iParam0, iLocal_99, -1, iParam1, 2f, 16, 0);
		}
	}
}
...
void func_176(int iParam0)
{
	...
	uVar0 = func_178(func_179(2), unk_0xB31A4B66C16032CC(iLocal_99, unk_0x4F9AEAB2CC029A5C(iLocal_99, "windscreen")));
	uVar1 = func_178(func_179(1), unk_0xB31A4B66C16032CC(iLocal_99, unk_0x4F9AEAB2CC029A5C(iLocal_99, "windscreen")));
	Var2 = { unk_0x288B716F47E9BBBC(iLocal_99, 2) };
	fVar5 = unk_0x552C823E1D2A019C(iLocal_99);
	if (fVar5 >= 180f)
	{
		fVar6 = (fVar5 - 180f);
	}
...
void func_177(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	...
	*uParam0 = unk_0x57FC10C74CC15F22("DEFAULT_SCRIPTED_CAMERA", 0);
	...
	unk_0x1D7183E3760DB4E5(*uParam0, Param1, uParam0->f_1, fParam7, 0, 1, 1, 2);
	unk_0x8E88E73F74A9FF79(1, 0, 3000, 1, 0, 0);
}
...
Vector3 func_179(int iParam0)
{
	...
	unk_0xDFCF5BB9A4E3B293(unk_0x8F474E419F56E48D(iLocal_99), &uVar3, &Var6);
	Var9 = { unk_0xB31A4B66C16032CC(iLocal_99, unk_0x4F9AEAB2CC029A5C(iLocal_99, "windscreen")) };
	Var12 = { unk_0x61141C81AF57CBDC(iLocal_99, Var9) };
	switch (iParam0)
	{
		case 0:
			Var0 = { unk_0x3201284584C7CD83(iLocal_99, 0f, (Var6.f_1 + 1.4f), Var12.f_2) };
			break;
		
		case 1:
			Var0 = { unk_0x3201284584C7CD83(iLocal_99, 1.5f, (Var6.f_1 + 1.2f), (Var12.f_2 - 0.1f)) };
			break;
		
		case 2:
			Var0 = { unk_0x3201284584C7CD83(iLocal_99, -3.7f, 0.7f, Var12.f_2) };
			break;
...
Vector3 func_180()
{
	...
	unk_0xDFCF5BB9A4E3B293(unk_0x8F474E419F56E48D(iLocal_99), &Var6, &uVar9);
	Var0 = { unk_0xB31A4B66C16032CC(iLocal_99, unk_0x4F9AEAB2CC029A5C(iLocal_99, "windscreen")) };
	Var3 = { unk_0x61141C81AF57CBDC(iLocal_99, Var0) };
	Var3.f_2 = (Var3.f_2 + 0.09f);
	Var6.f_1 = (Var6.f_1 - 1f);
	return unk_0x3201284584C7CD83(iLocal_99, 0f, -unk_0x69C0BB7D03EE045D(Var6.f_1), Var3.f_2);
}
...
{
	if (!unk_0x37B568B777BC65F9(Local_313[*iParam0 /*7*/]))
	{
		return;
	}
	if (!unk_0xD8AE52C8418BED79(Local_313[*iParam0 /*7*/]))
	{
		return;
	}
	unk_0xBC1542DDC31676C2(Local_313[*iParam0 /*7*/], "HAND_SHAKE", 0.25f);
...
void func_188()
{
	...
	else
	{
		...
		{
			case 0:
				if (unk_0xC621379C202E086C(iLocal_96, 876132797))
				{
					unk_0xB0E737394929E89F(0, 200, 84);
					unk_0xFAE5E5AC968944E8(iLocal_99, 1, 0f, 0f, -0.05f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
					func_190();
				}
				break;
			...
			case 2:
				if (func_476(iLocal_49, 32768))
				{
					if (func_535())
					{
						iVar0 = unk_0x2B3422BC14FE3213(iLocal_79);
					}
					else
					{
						iVar0 = iLocal_79;
					...
					if (unk_0xFE5DE0C3200E00F2(iVar0))
					{
						...
						if ((((((((((((((fVar1 > 0.01f && fVar1 < 0.019f) || (fVar1 > 0.093f && fVar1 < 0.1f)) || (fVar1 > 0.165f && fVar1 < 0.172f)) || (fVar1 > 0.231f && fVar1 < 0.239f)) || (fVar1 > 0.308f && fVar1 < 0.317f)) || (fVar1 > 0.37f && fVar1 < 0.378f)) || (fVar1 > 0.437f && fVar1 < 0.443f)) || (fVar1 > 0.507f && fVar1 < 0.518f)) || (fVar1 > 0.58f && fVar1 < 0.587f)) || (fVar1 > 0.651f && fVar1 < 0.659f)) || (fVar1 > 0.72f && fVar1 < 0.729f)) || (fVar1 > 0.788f && fVar1 < 0.794f)) || (fVar1 > 0.862f && fVar1 < 0.87f)) || (fVar1 > 0.937f && fVar1 < 0.946f))
						{
							if (!func_509(512))
							{
								...
								unk_0xFAE5E5AC968944E8(iLocal_99, 1, 0f, 0f, -0.1f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
								func_190();
								func_189(512);
							}
						}
				...
				else if (unk_0xC621379C202E086C(iLocal_96, 876132797))
				{
					unk_0xB0E737394929E89F(0, 200, 252);
					unk_0xFAE5E5AC968944E8(iLocal_99, 1, 0f, 0f, -0.1f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
					func_190();
...
void func_191()
{
	...
	if (unk_0xDC5D81351D6A4DDB(unk_0xA19140A5C42D8715()))
	{
		iLocal_59 = unk_0x24A1A7BF4ED94B71(unk_0xA19140A5C42D8715());
	}
}
...
bool func_193()
{
	return unk_0x411C28019DEA5CEF(iLocal_96, func_44(unk_0xA19140A5C42D8715(), 0, 0), func_194(iLocal_96, func_43(), 1), 3);
}
...
void func_195()
{
	...
	if (unk_0x958D2327555FAEA5(iLocal_96) || unk_0x958D2327555FAEA5(unk_0xA19140A5C42D8715()))
	{
		return;
	}
...
void func_196()
{
	...
	if (!unk_0x958D2327555FAEA5(iLocal_96) && !unk_0x958D2327555FAEA5(unk_0xA19140A5C42D8715()))
	{
		...
		else if (func_7(&uLocal_107) > unk_0xF59B9063EDAC7451(2f, 5f))
		{
...
void func_197(int iParam0)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				unk_0xE85BD4A26C0DFACA(iLocal_96, "SEX_ORAL", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			else
			{
				unk_0xE85BD4A26C0DFACA(iLocal_96, "SEX_ORAL_FEM", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			break;
		...
		case 2:
			if (func_198(unk_0xD4E735F4B6A956AC()))
			{
				unk_0xE85BD4A26C0DFACA(iLocal_96, "SEX_GENERIC", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			else
			{
				unk_0xE85BD4A26C0DFACA(iLocal_96, "SEX_GENERIC_FEM", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			break;
	}
}
...
bool func_211(int iParam0)
{
	...
	if (func_535())
	{
		uVar0 = unk_0xFE5DE0C3200E00F2(unk_0x2B3422BC14FE3213(iParam0));
	}
	else
	{
		uVar0 = unk_0xFE5DE0C3200E00F2(iParam0);
	}
	return uVar0;
}
...
void func_212()
{
	if (unk_0x71364F510A1CB69F())
	{
		...
		unk_0x4299736016AECE26(unk_0xA19140A5C42D8715(), func_214(), 1, 0, 0, 1);
...
void func_215()
{
	...
	if (func_217(&uLocal_104, 3f) && !unk_0xC3553172354FFB69(uLocal_103))
	{
		iVar0 = unk_0xF34EE736CF047844(((func_216() - 2f) * 1000f));
		unk_0x930701157A4B9374(uLocal_102, 0);
		unk_0xD21CD2A6F93F44A6(uLocal_103, uLocal_102, iVar0, 1, 1);
	}
...
void func_221(var uParam0)
{
	...
	if (unk_0xDC5D81351D6A4DDB(iLocal_96))
	{
		if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
		{
			iVar0 = unk_0x24A1A7BF4ED94B71(iLocal_96);
...
void func_224()
{
	...
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		...
		if (func_535())
		{
			if (unk_0xB540EEBB14C48518(iLocal_99))
			{
				unk_0xC87692063D3D3E05(iLocal_99, 1);
				unk_0x6EB2D9504928F849(iLocal_99, 4);
				unk_0xBAC6F37667632916(iLocal_99, 1);
				unk_0x9F3F43B8D4BC7F09(iLocal_99, 0, 0);
			}
		}
		else
		{
		...
		if (!func_369() || !unk_0xE0FD180CD24C0B67(iLocal_96, iLocal_99, 0))
		{
			func_459(0);
			return;
		}
	...
	func_206(0);
	if ((!unk_0x097275D546C9735F(iLocal_99) && unk_0x02B9944258987761(unk_0xD4E735F4B6A956AC())) && !func_476(iLocal_49, 1024))
	{
		iLocal_295 = 7;
		func_367(1, -1);
	...
	switch (iLocal_301)
	{
		...
		case 1:
						...
						if (unk_0xCC1BBE3267AB0DC9(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0)))
						{
							if (unk_0xB0D49A1F9F054602(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), -1, 0) == unk_0xA19140A5C42D8715())
							{
								if (unk_0xB540EEBB14C48518(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0)))
								{
									...
									{
										unk_0x1F7948851FB36E88(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), 0, 0);
									}
								}
								else
								{
			...
			if (func_362())
			{
				...
				unk_0x26ABEC1EEED61639(iLocal_96);
				iLocal_301 = 2;
			}
			break;
		...
		case 3:
			...
			if (((unk_0xDF0ADAD7E584090D(2, 187) || (unk_0x0B9F814BC8D14042(2) && unk_0xDF0ADAD7E584090D(2, 242))) || (unk_0x0B9F814BC8D14042(2) && unk_0x53E955948D35BDB5(0, 33))) || (((unk_0x47C01C0E6F4C1D06() && !unk_0x0B9F814BC8D14042(2)) && iVar7 > 100) && (unk_0xFD34717937104F1C() - iLocal_89) > 300))
			{
				unk_0xE11F00B4AC919F45(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
			...
			else if (((unk_0xDF0ADAD7E584090D(2, 188) || (unk_0x0B9F814BC8D14042(2) && unk_0xDF0ADAD7E584090D(2, 241))) || (unk_0x0B9F814BC8D14042(2) && unk_0x53E955948D35BDB5(0, 32))) || (((unk_0x47C01C0E6F4C1D06() && !unk_0x0B9F814BC8D14042(2)) && iVar7 < -100) && (unk_0xFD34717937104F1C() - iLocal_89) > 300))
			{
				unk_0xE11F00B4AC919F45(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
				func_477("UP pressed!");
				if (iLocal_70 > 0)
		...
		case 4:
			iVar10 = unk_0x96D46A32BCAB0A68(iLocal_96);
			if (iLocal_297 == 3)
			{
				func_367(1, -1);
				func_275();
				...
				else
				{
					if (func_269() >= 20)
					{
						iVar10 += 20;
						func_226(20);
						unk_0x8C26EBB3525646D4(iLocal_96, iVar10);
					}
					func_459(1);
					return;
				}
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_17367.f_5726)
		{
			...
			if (unk_0xFEB6EEC0545AF7AA(&(Global_17367.f_4690)) != 0 && Global_17367.f_4764 != -1)
			{
				...
				{
					func_314(Global_17367.f_4766, 1, 1, &fVar36, &fVar37, bParam7);
					func_304(Global_17367.f_4766, 1, &iVar47, &iVar48, &iVar49, &iVar50);
					unk_0xE56EDA9982C42132(func_312(Global_17367.f_4766), func_309(Global_17367.f_4766, 1), ((Global_17364 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
				}
			...
			if (unk_0xFEB6EEC0545AF7AA(&(Global_4266986.f_21)) != 0 && Global_4266986.f_65 != -1)
			{
				...
				{
					func_314(Global_4266986.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					func_304(Global_4266986.f_67, 1, &iVar47, &iVar48, &iVar49, &iVar50);
					unk_0xE56EDA9982C42132(func_312(Global_4266986.f_67), func_309(Global_4266986.f_67, 1), ((Global_17364 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
				}
				fVar51 = (fVar51 + (((unk_0xAC0B4B294E7DA73D(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
			...
			func_297(iVar61, iParam1, iParam8, 0, 0, 0, bParam4, 1, 0);
			unk_0xCD282E433560A509(76, 84);
			unk_0xE4C207949B93A9C7(-0.05f, -0.05f, 0f, 0f);
		}
		if (iVar5 == 1 || !Global_17367.f_5726)
										...
										if (bVar54)
										{
											if (func_314(26, 1, 0, &fVar36, &fVar37, bParam7))
											{
												...
												if (func_314(26, 1, 1, &fVar36, &fVar37, bParam7))
												{
													...
													unk_0xE56EDA9982C42132(func_312(26), func_309(26, 1), ((fVar34 + fVar42) + fVar45), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
												}
											}
											if (func_314(27, 1, 0, &fVar36, &fVar37, bParam7))
											{
												...
												if (func_314(27, 1, 1, &fVar36, &fVar37, bParam7))
												{
													...
													unk_0xE56EDA9982C42132(func_312(27), func_309(27, 1), (((fVar34 + fVar42) + fVar45) + (fVar43 + fVar44)), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
												}
											}
										}
										iVar25 = 0;
											...
											else if (Global_17367.f_2124[iVar24 /*5*/][iVar14] == 4)
											{
												if (Global_17367.f_4433[(iVar22 + iVar28)] == 2 || Global_17367.f_4433[(iVar22 + iVar28)] == 48)
												{
													if (func_314(Global_17367.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
													{
														...
														{
															func_304(Global_17367.f_4433[(iVar22 + iVar28)], bVar32, &iVar47, &iVar48, &iVar49, &iVar50);
															if (Global_17367.f_5081[iVar8] == 2)
															{
																unk_0xE56EDA9982C42132(func_312(Global_17367.f_4433[(iVar22 + iVar28)]), func_309(Global_17367.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
															else
															{
																unk_0xE56EDA9982C42132(func_312(Global_17367.f_4433[(iVar22 + iVar28)]), func_309(Global_17367.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
											...
											while (iVar14 < iVar28)
											{
												if (Global_17367.f_4433[(iVar22 + iVar14)] != 2 && Global_17367.f_4433[(iVar22 + iVar14)] != 48)
												{
													if (func_314(Global_17367.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
													{
														...
														{
															func_304(Global_17367.f_4433[(iVar22 + iVar14)], bVar32, &iVar47, &iVar48, &iVar49, &iVar50);
															if (Global_17367.f_4433[(iVar22 + iVar14)] == 30)
															{
																unk_0xE56EDA9982C42132(func_312(Global_17367.f_4433[(iVar22 + iVar14)]), func_309(Global_17367.f_4433[(iVar22 + iVar14)], bVar32), (Global_17364 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
															else if (Global_17367.f_5081[iVar8] == 2)
															{
																unk_0xE56EDA9982C42132(func_312(Global_17367.f_4433[(iVar22 + iVar14)]), func_309(Global_17367.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
															else
															{
																unk_0xE56EDA9982C42132(func_312(Global_17367.f_4433[(iVar22 + iVar14)]), func_309(Global_17367.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
														}
								...
								case 4:
									if (iVar5 == 1 && bVar33)
									{
										if (func_314(Global_17367.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
										{
											...
											{
												func_304(Global_17367.f_4433[iVar22], bVar32, &iVar47, &iVar48, &iVar49, &iVar50);
												unk_0xE56EDA9982C42132(func_312(Global_17367.f_4433[iVar22]), func_309(Global_17367.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), (fVar36 * func_290(Global_17367.f_4433[iVar22])), (fVar37 * func_290(Global_17367.f_4433[iVar22])), 0f, iVar47, iVar48, iVar49, iVar50, 0);
											}
										}
									}
									bVar41 = true;
...
var func_309(int iParam0, bool bParam1)
{
	...
	if (!unk_0x429D45A6C6520026(&(Global_17367.f_6863[iParam0 /*16*/])))
	{
		...
		{
			Var19 = { func_311(unk_0xD4E735F4B6A956AC()) };
...
char* func_312(int iParam0)
{
	...
	if (!unk_0x429D45A6C6520026(&(Global_17367.f_6014[iParam0 /*16*/])))
	{
		...
		{
			Var16 = { func_311(unk_0xD4E735F4B6A956AC()) };
...
int func_314(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)
{
	...
	if (unk_0xFEB6EEC0545AF7AA(&cVar16) != 0)
	{
		...
		Var37.f_0 = (Var37.f_0 * (func_315(iParam0) / fVar34));
		Var37.f_1 = (Var37.f_1 * (func_315(iParam0) / fVar34));
		if (!bParam2)
		{
...
void func_319()
{
	...
	{
		iLocal_304 = func_337();
		func_328(&iLocal_304, 0, 0, unk_0x22C775856F4633CA(1, 2), 0, 0, 0);
	}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_160(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
			...
			if (iParam0 == unk_0xA19140A5C42D8715())
			{
				if (!func_198(unk_0xD4E735F4B6A956AC()))
				{
					...
					if (!func_509(256))
					{
						func_189(256);
						iLocal_86 = iVar0;
						iLocal_87 = unk_0x7710E77D1959B321(unk_0xA19140A5C42D8715(), 6);
...
void func_361()
{
	...
	unk_0x68995A99EFE15C73(iLocal_96);
	if (!unk_0x958D2327555FAEA5(iLocal_96))
	{
		if (iLocal_72 < 1)
		{
			unk_0xE85BD4A26C0DFACA(iLocal_96, "HOOKER_OFFER_SERVICE", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
		else
		{
			unk_0xE85BD4A26C0DFACA(iLocal_96, "HOOKER_OFFER_AGAIN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
	}
}
...
void func_365()
{
	...
	if (unk_0xDC5D81351D6A4DDB(iLocal_96))
	{
		iLocal_60 = unk_0x24A1A7BF4ED94B71(iLocal_96);
	}
}
...
void func_366()
{
	...
	if (unk_0xDC5D81351D6A4DDB(unk_0xA19140A5C42D8715()))
	{
		if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			...
			if (unk_0xDC5D81351D6A4DDB(iVar0))
			{
				Local_56 = { unk_0xE2BBD32891C18569(iVar0, 1) };
			}
		}
	}
}
	...
	if (unk_0x91347D2A80F38492(unk_0xD4E735F4B6A956AC()) == 0)
	{
		if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
		{
			if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
			{
				...
				if (!iLocal_99 == 0)
				{
					if ((unk_0x1095F403F52B42E1(iLocal_99, 0) && !unk_0x463E3A48A46C9195(iLocal_99)) && !unk_0xEE9EA5C5862BBFA3(iLocal_99))
					{
...
int func_371(int iParam0)
{
	...
	Var3 = { unk_0xE2BBD32891C18569(iLocal_99, 1) };
	if (iLocal_308[iParam0] == 0)
	{
		if (unk_0x8F474E419F56E48D(iLocal_99) == joaat("tyrant"))
		{
			iLocal_308[iParam0] = unk_0xFC629A9C757A492E(Var0, Var3, 0.1f, 511, iLocal_99, 3);
		}
		else if ((unk_0x8F474E419F56E48D(iLocal_99) == joaat("casco") || unk_0x8F474E419F56E48D(iLocal_99) == joaat("feltzer3")) || unk_0x8F474E419F56E48D(iLocal_99) == joaat("fagaloa"))
		{
			iLocal_308[iParam0] = unk_0xFC629A9C757A492E(Var0, Var3, 0.15f, 511, iLocal_99, 3);
		}
		else
		{
			iLocal_308[iParam0] = unk_0xFC629A9C757A492E(Var0, Var3, 0.25f, 511, iLocal_99, 3);
		}
	}
	else
	{
		switch (unk_0x7C00B4755E048785(iLocal_308[iParam0], &iVar6, &uVar7, &uVar10, &uVar13))
		{
			case 2:
...
void func_374()
{
	...
	if (!unk_0x37B568B777BC65F9(uLocal_102))
	{
		uLocal_102 = unk_0x57FC10C74CC15F22("DEFAULT_SCRIPTED_CAMERA", 1);
	}
	if (!unk_0x37B568B777BC65F9(uLocal_103))
	{
		uLocal_103 = unk_0x57FC10C74CC15F22("DEFAULT_SCRIPTED_CAMERA", 1);
	}
	func_375(&Var0, &Var7);
	unk_0x057123F3A835FE47(uLocal_102, Var0);
	unk_0xC831502E35848BE4(uLocal_102, Var0.f_3, 2);
	unk_0xF62A5A3CB8DB2402(uLocal_102, Var0.f_6);
	unk_0x057123F3A835FE47(uLocal_103, Var7);
	unk_0xC831502E35848BE4(uLocal_103, Var7.f_3, 2);
	unk_0xF62A5A3CB8DB2402(uLocal_103, Var7.f_6);
	unk_0x930701157A4B9374(uLocal_102, 1);
	unk_0x930701157A4B9374(uLocal_103, 0);
	unk_0x8E88E73F74A9FF79(1, 0, 3000, 1, 0, 0);
}
...
bool func_378()
{
	return unk_0xB7A628320EFF8E47(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), func_380()) < (func_379() * func_379());
}
...
void func_381()
{
	...
	if (func_369() && unk_0xE0FD180CD24C0B67(iLocal_96, iLocal_99, 0))
	{
		if (unk_0x097275D546C9735F(iLocal_99) && unk_0x678F978B0FAD24D2(iLocal_99))
		{
			if ((func_388() && !func_378()) && !func_387())
			{
				...
				{
					uLocal_85 = unk_0xFAFCEBFB311E0625(unk_0xE2BBD32891C18569(iLocal_99, 0), 40f, 40f, 40f, unk_0x552C823E1D2A019C(iLocal_99), 0, 7);
					unk_0x962CF6A9EA6FDCAC(unk_0xD4E735F4B6A956AC(), 0, 896);
					func_468(&iLocal_49, 2048);
					iLocal_100 = 0;
					unk_0x94E87D83163B4BEB("ProstituteInPlay", &uLocal_307);
					unk_0x80E7C4A78224C8F9(1, uLocal_307, joaat("player"));
					unk_0xDFA901280292A2FB(iLocal_96, uLocal_307);
			...
			{
				if ((!unk_0x958D2327555FAEA5(unk_0xA19140A5C42D8715()) && func_7(&uLocal_107) > 15f) && func_384())
				{
...
void func_383()
{
	...
	if (!unk_0x958D2327555FAEA5(iLocal_96))
	{
		unk_0xE85BD4A26C0DFACA(iLocal_96, "HOOKER_SECLUDED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_385()
{
	if (func_535())
	{
		unk_0x13E0A8160525AE55(iLocal_96, 229, 1);
		unk_0x13E0A8160525AE55(iLocal_96, 26, 1);
		unk_0x13E0A8160525AE55(iLocal_96, 115, 1);
		unk_0x1F4E5EFBFE503FB3(iLocal_96, 1);
	}
}
...
void func_386()
{
	...
	if (!func_476(iLocal_49, 2097152))
	{
		if (unk_0xFD34717937104F1C() > iLocal_84)
		{
			if (iLocal_100 == 0)
			{
				Var0 = { unk_0xE2BBD32891C18569(iLocal_99, 1) };
				unk_0x8F7BA8E028ADF980(Var0, &fVar6, 0, 0);
				Var0.f_2 = (fVar6 + 0.15f);
				Var3 = { unk_0x3201284584C7CD83(iLocal_99, 0f, 0f, -2f) };
				iLocal_100 = unk_0x2655F64CD0F70A6B(Var0, Var3, 2f, 511, iLocal_99, 7);
			}
			else if (unk_0x2C8266B4AB07E621(iLocal_100, &iVar8, &uVar9, &uVar12, &iVar7, &uVar15) == 2)
			{
				if (iVar8 != 0)
				{
				...
				iLocal_84 = unk_0xFD34717937104F1C() + 1500;
				iLocal_100 = 0;
			}
		}
	}
...
int func_388()
{
	...
	if (!unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0))
	{
		...
		if (unk_0x07EC788D27AB67D3(Var1, func_59(0), 12f, 0) || unk_0x07EC788D27AB67D3(Var1, func_59(1), 12f, 0))
		{
			return 0;
		}
		if (func_394())
		...
		if (func_84(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), (30f * 0.5f)))
		{
			return 0;
		}
		if (!unk_0x5860446BFB759B77(iLocal_96, iLocal_99, 0, 0, 0))
		{
			return 0;
		}
		unk_0x56034861306E5ABC(1);
		if (unk_0x00A7785CBA069915(Var1, 20f, 1, 1, &iVar0, 0, 1, -1))
		{
			if (unk_0xDC5D81351D6A4DDB(iVar0))
			{
				if (!unk_0x7112137033807390(iVar0, 0))
				{
					if (unk_0x58DE86018EA47551(iVar0, iLocal_99, 17))
					{
						return 0;
					}
				}
...
int func_392(struct<3> Param0)
{
	...
	uVar0 = unk_0xD48AF06A1B183940(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 0), 1, 1, 1077936128, 0);
	unk_0x71C5C1FE45545D92(uVar0, &Param0);
	if (unk_0x09586DC2AC6A64B7(uVar0))
	{
		if (!unk_0xE8509487D07FBBAB(uVar0))
		{
			if (unk_0xB7A628320EFF8E47(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 0), Param0) > 400f)
			{
				return 1;
			}
		}
		else if (unk_0xB7A628320EFF8E47(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 0), Param0) > 56.25f)
		{
			return 1;
		}
	}
	else if (!unk_0xE8509487D07FBBAB(uVar0))
	{
		if (unk_0xB7A628320EFF8E47(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 0), Param0) > 400f)
		{
			return 1;
	...
	{
		uVar0 = unk_0xD48AF06A1B183940(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 0), 1, 8, 1077936128, 0);
		unk_0x71C5C1FE45545D92(uVar0, &Param0);
		if (unk_0xB7A628320EFF8E47(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 0), Param0) > 400f)
		{
			return 1;
...
int func_393(int iParam0, var uParam1)
{
	...
	Var0[0 /*3*/] = { unk_0x3201284584C7CD83(iParam0, 2f, 0f, 0f) };
	Var0[1 /*3*/] = { unk_0x3201284584C7CD83(iParam0, -2f, 0f, 0f) };
	Var0[2 /*3*/] = { unk_0x3201284584C7CD83(iParam0, 0f, 2f, 0f) };
	Var0[3 /*3*/] = { unk_0x3201284584C7CD83(iParam0, 0f, -2f, 0f) };
	if (unk_0x5AED11AE1D358697(Var0[0 /*3*/], uParam1, 1077936128, 0))
	{
		return 1;
	}
	else if (unk_0x5AED11AE1D358697(Var0[1 /*3*/], uParam1, 1077936128, 0))
	{
		return 1;
	}
	else if (unk_0x5AED11AE1D358697(Var0[2 /*3*/], uParam1, 1077936128, 0))
	{
		return 1;
	}
	else if (unk_0x5AED11AE1D358697(Var0[3 /*3*/], uParam1, 1077936128, 0))
	{
		return 1;
	}
	return 0;
...
void func_403()
{
	if (!unk_0x7112137033807390(iLocal_96, 0))
	{
		if (unk_0x10E54C268D1B3FED(iLocal_96, unk_0xA19140A5C42D8715(), 5f, 5f, 5f, 0, 1, 0) || func_476(iLocal_49, 8192))
		{
			unk_0xD481A812073CCF02(0, 101, 1);
			unk_0xD481A812073CCF02(0, 74, 1);
			unk_0x9EA8CBEA7355649E(0, 51);
			if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0) && unk_0x5D7DFE2058701942(iLocal_96, 0))
			{
				unk_0xA45E1AA8B9CF45AD(iLocal_96, 50);
				unk_0x82416ADE738F7F1F(iLocal_96, 5f);
				if (func_476(iLocal_49, 16))
				{
					if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
					{
				...
				if (unk_0x1095F403F52B42E1(iLocal_99, 0))
				{
					if (unk_0xB10F7FE89663CB5B(iLocal_96, iLocal_99) && unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_99, 0))
					{
						...
						if (func_476(iLocal_49, 8))
						{
							if (unk_0xD7AFBCBD45CE1D9D(func_86()))
							{
								...
								{
									unk_0x2D0A6B97553FE4E3(iLocal_96, unk_0xFEB6EEC0545AF7AA("MINI_PROSTITUTE_LOW_RESTRICTED_PASSENGER"));
								}
								else if (func_413(iLocal_99))
								{
									unk_0x2D0A6B97553FE4E3(iLocal_96, unk_0xFEB6EEC0545AF7AA("MINI_PROSTITUTE_LOW_RESTRICTED_NOAMBIENT_PASSENGER"));
								}
								else if (func_412(iLocal_99))
								{
									unk_0x2D0A6B97553FE4E3(iLocal_96, unk_0xFEB6EEC0545AF7AA("MINI_PROSTITUTE_LOW_LOWRIDER_PASSENGER"));
								}
								else if (func_411(iLocal_99))
								{
									unk_0x2D0A6B97553FE4E3(iLocal_96, unk_0xFEB6EEC0545AF7AA("MINI_PROSTITUTE_LOW_LOWRIDER2_PASSENGER"));
								}
								else if (func_410(iLocal_99))
								{
									unk_0x2D0A6B97553FE4E3(iLocal_96, unk_0xFEB6EEC0545AF7AA("MINI_PROSTITUTE_LOW_INFERNUS2_PASSENGER"));
								}
								else if (func_409(iLocal_99))
								{
									unk_0x2D0A6B97553FE4E3(iLocal_96, unk_0xFEB6EEC0545AF7AA("MINI_PROSTITUTE_LOW_SC1_PASSENGER"));
								}
								else if (func_408(iLocal_99))
								{
									unk_0x2D0A6B97553FE4E3(iLocal_96, unk_0xFEB6EEC0545AF7AA("MINI_PROSTITUTE_LOW_TEZERACT_PASSENGER"));
								}
								else if (func_407(iLocal_99))
								{
									unk_0x2D0A6B97553FE4E3(iLocal_96, unk_0xFEB6EEC0545AF7AA("MINI_PROSTITUTE_LOW_DOMINATOR3_PASSENGER"));
								}
								else if (func_406(iLocal_99))
								{
									unk_0x2D0A6B97553FE4E3(iLocal_96, unk_0xFEB6EEC0545AF7AA("MINI_PROSTITUTE_LOW_ITALIGTO_PASSENGER"));
								}
								else
								{
									unk_0x2D0A6B97553FE4E3(iLocal_96, unk_0xFEB6EEC0545AF7AA("MINI_PROSTITUTE_LOW_PASSENGER"));
								}
							}
						}
						if (func_535())
						{
							unk_0x1F7948851FB36E88(iLocal_96, 0, 0);
						}
						else
						{
							unk_0x1F7948851FB36E88(iLocal_96, 1, 1);
						}
						func_175(iLocal_96, 0);
						func_383();
						iLocal_64 = unk_0xFD34717937104F1C();
			...
			{
				if ((func_405(iLocal_96, unk_0xA19140A5C42D8715(), 1) > 11f || func_404(20f)) || !unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_99, 0))
				{
					func_108(&uLocal_113);
					if (!unk_0x5D7DFE2058701942(iLocal_96, 0))
					{
						unk_0x9568B1B58F78FF36(iLocal_96);
						func_459(0);
				...
				if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
				{
					...
					else if (!unk_0x5860446BFB759B77(iLocal_96, iLocal_99, 0, 0, 0))
					{
						if (!func_105())
						{
...
void func_415(var uParam0)
{
	...
	if (func_114(&uLocal_113) >= 20f || !unk_0x10E54C268D1B3FED(iLocal_96, unk_0xA19140A5C42D8715(), 3f, 3f, 3f, 0, 1, 0))
	{
		if (func_476(iLocal_75, 524288))
		{
			func_108(&uLocal_113);
	...
	func_63(iLocal_96);
	if (((unk_0x10E54C268D1B3FED(iLocal_96, unk_0xA19140A5C42D8715(), 3f, 3f, 3f, 0, 1, 0) || func_476(iLocal_75, 1)) && !func_209(0)) && !func_394())
	{
		if (!unk_0x5860446BFB759B77(iLocal_96, iLocal_99, 0, 0, 0))
		{
			if (!func_105())
	...
	else if (func_456("PROS_ACCEPT"))
	{
		...
		if (func_535())
		{
			iVar0 = unk_0xF9D4EF1338E38AFB(iLocal_96, -2017877118);
			if (iVar0 != 1 && iVar0 != 0)
			{
				func_526();
				func_521(uParam0);
...
void func_416()
{
	...
	{
		func_419();
		if (func_417(iLocal_74, 1) || unk_0x0099F119B7ADB4B3(unk_0xD4E735F4B6A956AC()))
		{
		...
		if (func_476(iLocal_49, 8192))
		{
			...
			if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
			{
				if (unk_0xF9D4EF1338E38AFB(iLocal_96, -1794415470) != 1 && !unk_0xE0FD180CD24C0B67(iLocal_96, unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), 1))
				{
					unk_0xA2EBCD9385E56019(iLocal_96, iLocal_99, -1, 0, 1f, 8388609, 0);
				}
			}
			sLocal_63 = func_44(unk_0xA19140A5C42D8715(), 1, 0);
			unk_0x6D68030C791111E0(sLocal_63);
			sLocal_63 = func_44(unk_0xA19140A5C42D8715(), 0, 1);
			unk_0x6D68030C791111E0(sLocal_63);
			func_34(&uLocal_107);
			iLocal_295 = 5;
		}
...
int func_423()
{
	...
	if (!func_535())
	{
		...
		else if (func_476(iLocal_49, 4194304))
		{
			...
			unk_0x2F89329397A277BC(&uVar1);
			unk_0x3F01127ECD227890(0, func_61(iLocal_293), func_60(5), 2f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0x3F01127ECD227890(0, func_61(iLocal_293), func_60(iVar0), 8f, -8f, -1, 1, 0, 0, 0, 0);
			unk_0x301F42EEE3C40328(uVar1);
			unk_0xE1072FA2FECBAD96(iLocal_96, uVar1);
			unk_0x3A95A0A3221D4208(&uVar1);
		}
	...
	switch (iLocal_55)
	{
		...
		case 1:
			if (unk_0xB540EEBB14C48518(iLocal_96))
			{
				unk_0x3F01127ECD227890(iLocal_96, func_61(iLocal_293), func_60(5), 2f, -2f, -1, 0, 0, 0, 0, 0);
				iLocal_55 = 2;
			}
			else
			{
		...
		case 2:
			if (unk_0xB540EEBB14C48518(iLocal_96))
			{
				...
				{
					iVar0 = unk_0x22C775856F4633CA(8, 11);
					unk_0x3F01127ECD227890(iLocal_96, func_61(iLocal_293), func_60(iVar0), 8f, -8f, -1, 1, 0, 0, 0, 0);
					iLocal_55 = 3;
				}
			}
			else
...
int func_424(bool bParam0)
{
	...
	if (func_405(iLocal_96, unk_0xA19140A5C42D8715(), 1) > 11f)
	{
		return 0;
	}
	if (!unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	...
	if (func_84(unk_0xE2BBD32891C18569(iLocal_96, 1), 1106247680))
	{
	...
	if (!func_369())
	{
		if (!func_535())
		{
			if ((!iLocal_88 && !Global_105117) && func_426(unk_0xA19140A5C42D8715(), 0) == -1)
			{
				func_338("PROS_CAR", -1);
				iLocal_88 = 1;
			}
...
void func_425()
{
	...
	{
		if (!unk_0x958D2327555FAEA5(unk_0xA19140A5C42D8715()) && !unk_0x958D2327555FAEA5(iLocal_96))
		{
...
void func_427()
{
	...
	{
		func_416();
		if (unk_0xF9D4EF1338E38AFB(iLocal_96, 242628503) == 7 && !func_476(iLocal_49, 8192))
		{
			if (func_66(1))
			{
				func_108(&uLocal_113);
...
void func_429(var uParam0)
{
	...
	unk_0xDFCF5BB9A4E3B293(unk_0x8F474E419F56E48D(iLocal_99), &Var6, &Var3);
	Var0 = { Var3 - Var6 };
	Var0 = { Var0 / Vector(2f, 2f, 2f) };
	Var9 = { unk_0x3201284584C7CD83(iLocal_99, -(Var0.f_0 + 0.2f), 0f, 0f) };
	Var12 = { unk_0x3201284584C7CD83(iLocal_99, (Var0.f_0 + 0.2f), 0f, 0f) };
	Var15 = { unk_0xE2BBD32891C18569(iLocal_96, 1) };
	if (unk_0x2A488C176D52CCA5(Var15, Var12) < unk_0x2A488C176D52CCA5(Var15, Var9))
	{
		Var9 = { Var12 };
	}
	if ((unk_0xF9D4EF1338E38AFB(iLocal_96, -1794415470) != 1 || !func_476(iLocal_49, 8192)) && unk_0xB7A628320EFF8E47(Local_93, Var9) > 0f)
	{
		if (func_535())
		{
			if (!unk_0x4943BEEC19289B8E(iLocal_96))
			{
				unk_0x1F7948851FB36E88(iLocal_96, 0, 1);
			}
			func_439(&uLocal_287, func_61(iLocal_293));
			func_433(uParam0, 1);
			func_430(&uLocal_287, uParam0);
		}
		unk_0x2F89329397A277BC(&uVar18);
		unk_0x956B3CF461C0C1C9(0, Var9.f_0, Var9.f_1, Var9.f_2, 1f, -1, 1f, 8192, 1193033728);
		unk_0xD87AD31611110768(0, unk_0x505186370955851F(unk_0xA19140A5C42D8715(), 31086, 0f, 0f, 0f), 0);
		unk_0x301F42EEE3C40328(uVar18);
		unk_0xE1072FA2FECBAD96(iLocal_96, uVar18);
		unk_0x3A95A0A3221D4208(&uVar18);
		Local_93 = { Var9 };
	}
}
	...
	if (func_424(1))
	{
		...
		if (func_457(&uLocal_113, 2f) || func_476(iLocal_49, 8192))
		{
			...
			if (func_355(&sVar0, 0))
			{
				...
				unk_0x22DD1D053CFF9707(unk_0xA19140A5C42D8715(), iLocal_96, -1, 2048, 4);
				func_429(uParam0);
				func_468(&iLocal_49, 4);
				Global_25609 = 1;
				Global_2423801[unk_0xD4E735F4B6A956AC() /*413*/].f_405 = 1;
...
int func_471()
{
	...
	iLocal_98 = unk_0x4C059EBFED753303(unk_0xE2BBD32891C18569(iLocal_96, 1), 15f, 0, 6);
	if (unk_0xDC5D81351D6A4DDB(iLocal_98) && !unk_0x7112137033807390(iLocal_98, 0))
	{
		if (unk_0x1095F403F52B42E1(iLocal_98, 0))
		{
			if (func_85(&iLocal_98))
			{
				iLocal_97 = unk_0xB0D49A1F9F054602(iLocal_98, -1, 0);
				if (!iLocal_97 == 0)
				{
					if (func_472(&iLocal_97))
					{
						iVar0 = unk_0x8F474E419F56E48D(iLocal_98);
						if (!iVar0 == joaat("taxi") && !iVar0 == joaat("taxi"))
						{
							if (!unk_0x4943BEEC19289B8E(iLocal_97))
							{
								unk_0x1F7948851FB36E88(iLocal_97, 1, 0);
							}
							if (!unk_0x4943BEEC19289B8E(iLocal_98))
							{
								unk_0x1F7948851FB36E88(iLocal_98, 1, 0);
							}
							unk_0x1F4E5EFBFE503FB3(iLocal_97, 1);
							unk_0x98D1B1BD9C3AA456(iLocal_97, 0, 1);
							unk_0x98D1B1BD9C3AA456(iLocal_98, 0, 1);
							return 1;
						}
					}
				}
...
int func_473()
{
	if (unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0) || unk_0x7112137033807390(iLocal_96, 0))
	{
		return 0;
	}
	return 1;
...
void func_475()
{
	if (!unk_0x7112137033807390(iLocal_96, 0))
	{
		if (!unk_0x8B9D3A1A7C2D3C6B(iLocal_96))
		{
			if (unk_0xF9D4EF1338E38AFB(iLocal_96, 1805844857) != 1)
			{
				unk_0x1F4E5EFBFE503FB3(iLocal_96, 0);
				unk_0xC2C4AE9DB4A0BEF3(iLocal_96, 196628, 1);
				unk_0x57BAE9F63852E6FF(iLocal_96);
				unk_0x33B5487515BD13D5(iLocal_96, unk_0xA19140A5C42D8715(), 300f, -1, 1, 0);
				unk_0xD738221C247C8B71(iLocal_96, 1);
				func_89(15);
			}
		}
	}
...
int func_478()
{
	...
	if (unk_0xF9D4EF1338E38AFB(iLocal_96, 1435919172) == 1)
	{
		return 0;
	}
	if (unk_0xB112D23B8518DD40(iLocal_96))
	{
		return 0;
	}
	return 1;
	...
	switch (iLocal_300)
	{
		...
		case 3:
			if (!unk_0x4915F4759304D5CF(iLocal_96))
			{
				...
				{
					unk_0x1F4E5EFBFE503FB3(iLocal_96, 0);
					unk_0xF5576F3CE9F6C386(iLocal_96, 0);
				...
				else
				{
					...
					func_455(&uLocal_122, 4, iLocal_96, "Prostitutes", 0, 1);
					unk_0xF5576F3CE9F6C386(iLocal_96, 0);
					unk_0xF112280B31B913CA(iLocal_96);
					return 1;
				}
			}
			break;
...
int func_483(int iParam0, char* sParam1, var uParam2)
{
	if (unk_0x05EFB6A616B6FADE(uParam0, 30))
	{
...
int func_484()
{
	if (unk_0x47C3DC461C758C29())
	{
		if (func_18() == 0)
		{
			...
			{
				if (!unk_0x82384F63D814C864(iLocal_96, 1))
				{
					if (func_535())
					{
						unk_0x1F7948851FB36E88(iLocal_96, 0, 0);
...
float func_485(int iParam0, struct<3> Param1, int iParam4)
{
	struct<3> Var0;
...
int func_486()
{
	if (unk_0x68128F973FA5E2E3(iLocal_96, func_59(0)))
	{
		if (unk_0xBA9F2E8BEDB5C602(iLocal_96, "amb@world_human_prostitute@crackhooker@base", "base"))
		{
			return 0;
		}
		if (unk_0xBA9F2E8BEDB5C602(iLocal_96, "amb@world_human_prostitute@cokehead@base", "base"))
		{
			return 1;
		}
	}
	if (unk_0x68128F973FA5E2E3(iLocal_96, func_59(1)))
	{
		if (unk_0xBA9F2E8BEDB5C602(iLocal_96, "amb@world_human_prostitute@french@base", "base"))
		{
			return 3;
		}
		if (unk_0xBA9F2E8BEDB5C602(iLocal_96, "amb@world_human_prostitute@hooker@base", "base"))
		{
			return 2;
		}
	}
...
void func_488(int iParam0)
{
	...
	{
		if (!unk_0x85875A8777624591(iLocal_96, iParam0))
		{
			if (func_535())
			{
				if (unk_0xB540EEBB14C48518(iLocal_96))
				{
					unk_0x53FF9BDD8529ACD2(iLocal_96);
					unk_0x22DD1D053CFF9707(iLocal_96, iParam0, -1, 2048, 4);
				}
			}
			else
			{
	...
	else if (unk_0x85875A8777624591(iLocal_96, iParam0))
	{
		if (func_535())
		{
			if (unk_0xB540EEBB14C48518(iLocal_96))
...
void func_489()
{
	if (Global_25609)
	{
		if (unk_0x1095F403F52B42E1(iLocal_99, 0))
		{
			if (unk_0xE0FD180CD24C0B67(iLocal_96, iLocal_99, 0))
			{
				func_490();
			}
		}
	...
	if (unk_0x7112137033807390(iLocal_96, 0) || !unk_0xDC5D81351D6A4DDB(iLocal_96))
	{
	...
	if ((unk_0xB7A628320EFF8E47(unk_0xE2BBD32891C18569(iLocal_96, 1), unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1)) < Global_25612 || Global_25612 == 0f) && iLocal_296 != 4)
	{
		Global_25612 = unk_0xB7A628320EFF8E47(unk_0xE2BBD32891C18569(iLocal_96, 1), unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1));
...
void func_490()
{
	if (func_535())
	{
		if (unk_0xB540EEBB14C48518(iLocal_96))
		{
			unk_0xB0D7019224A3A443(iLocal_96, 323, 1);
		}
	}
	else
	{
...
void func_491(var uParam0)
{
	if (!iLocal_295 == 12)
	{
		if (!unk_0x7112137033807390(iLocal_96, 0) && !unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0))
		{
			if (func_495())
			{
				if (func_535())
				{
					...
					if (!unk_0x4943BEEC19289B8E(iLocal_96))
					{
						unk_0x1F7948851FB36E88(iLocal_96, 1, 0);
					}
					unk_0x33B5487515BD13D5(iLocal_96, unk_0xA19140A5C42D8715(), 300f, -1, 0, 0);
					unk_0xD738221C247C8B71(iLocal_96, 1);
					unk_0x9568B1B58F78FF36(unk_0xA19140A5C42D8715());
					func_526();
					func_521(uParam0);
			...
			else if (unk_0xDEAEC99031DCB92A(iLocal_96, unk_0xA19140A5C42D8715(), 1))
			{
				iLocal_67++;
				if (iLocal_67 >= 2)
				{
				...
				else
				{
					...
					unk_0xDCB46BFC2265476A(iLocal_96);
				}
			}
			else if (func_493())
			{
...
void func_492()
{
	...
	unk_0x68995A99EFE15C73(iLocal_96);
	unk_0xE85BD4A26C0DFACA(iLocal_96, "APOLOGY_NO_TROUBLE", "SPEECH_PARAMS_FORCE_SHOUTED_CRITICAL", 1);
}
...
int func_495()
{
	...
	if (!func_476(iLocal_49, 4096))
	{
		if (func_405(iLocal_96, unk_0xA19140A5C42D8715(), 1) < 30f)
		{
			Var0 = { unk_0xE2BBD32891C18569(iLocal_96, 1) };
			if ((((((unk_0x5EC525CDAB7A21A8(86, Var0, 30f) || unk_0x5EC525CDAB7A21A8(89, Var0, 30f)) || unk_0x5EC525CDAB7A21A8(88, Var0, 30f)) || unk_0x5EC525CDAB7A21A8(102, Var0, 30f)) || unk_0x5EC525CDAB7A21A8(114, Var0, 30f)) || (unk_0x5EC525CDAB7A21A8(112, Var0, 30f) && !func_535())) || unk_0x41CA0CDBE31A440F(unk_0xA19140A5C42D8715()))
			{
				if (!func_535())
				{
					unk_0x1F4E5EFBFE503FB3(iLocal_96, 0);
...
int func_496()
{
	if ((unk_0xDC5D81351D6A4DDB(iLocal_96) && !unk_0x7112137033807390(iLocal_96, 0)) && !unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0))
	{
		if (func_535())
		{
		...
		if (!unk_0x4915F4759304D5CF(iLocal_96))
		{
			if (!unk_0x5D7DFE2058701942(iLocal_96, 0))
			{
				if (!func_498(9))
				{
					if (!unk_0x7112137033807390(iLocal_96, 0) && !unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0))
					{
						if (unk_0x10E54C268D1B3FED(iLocal_96, unk_0xA19140A5C42D8715(), 100f, 100f, 50f, 0, 1, 0))
						{
							return 1;
						}
						else
...
void func_521(var uParam0)
{
	...
	if (!unk_0x4915F4759304D5CF(iLocal_96))
	{
		if (unk_0x4943BEEC19289B8E(iLocal_96))
		{
			if ((func_535() && unk_0xF9D4EF1338E38AFB(iLocal_96, 1805844857) != 1) && unk_0xF9D4EF1338E38AFB(iLocal_96, -251125078) != 1)
			{
				unk_0x1CBE3F8ED90509B2(iLocal_96, 1193033728, 0);
				if (unk_0xB540EEBB14C48518(iLocal_96))
				{
				...
				if (unk_0x24B6018003B89ED4(iLocal_96))
				{
					unk_0x7E4E83D33161D01A(&iLocal_96);
				}
				unk_0x68995A99EFE15C73(iLocal_96);
			}
			else
	...
	if (!unk_0x4915F4759304D5CF(iLocal_97))
	{
		unk_0x9568B1B58F78FF36(iLocal_97);
	}
	iLocal_97 = 0;
	iLocal_296 = 0;
	...
	if (func_535())
	{
		if (unk_0xA4D0862CD5E60478(uLocal_85))
		{
			unk_0x308B3DBB8CA58E54(uLocal_85);
		}
	}
	iLocal_98 = 0;
	func_524();
	...
	if (!unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0))
	{
		if (func_509(256))
		{
			unk_0x72A0FF8C49CFFC0D(unk_0xA19140A5C42D8715(), 6, iLocal_86, iLocal_87, 0);
			func_189(1024);
		}
	}
...
void func_525(bool bParam0)
{
	if (!unk_0x4915F4759304D5CF(iLocal_96))
	{
		if (unk_0x5D7DFE2058701942(iLocal_96, 0))
		{
			if (unk_0xF9D4EF1338E38AFB(iLocal_96, -828834893) != 1)
			{
				unk_0xCB482EF95FAE4D73(iLocal_96, 0, 65536);
			}
		}
		if (bParam0)
		{
...
void func_526()
{
	...
	if (!unk_0x7112137033807390(iLocal_96, 0))
	{
		...
		unk_0x3C50F1F859BA232B(iLocal_96, 0);
	}
	if (unk_0x1095F403F52B42E1(iLocal_99, 0) && !unk_0x7112137033807390(iLocal_99, 0))
	{
		if (func_535())
		{
			if (unk_0xB540EEBB14C48518(iLocal_99))
			{
				...
				{
					unk_0xC87692063D3D3E05(iLocal_99, 0);
					unk_0x6EB2D9504928F849(iLocal_99, 3);
					unk_0xBAC6F37667632916(iLocal_99, 0);
				}
				unk_0x9F3F43B8D4BC7F09(iLocal_99, 1, 0);
			}
		}
		else
		{
	...
	if (func_535())
	{
		if (func_509(2))
		{
			...
			else if (unk_0xCC1BBE3267AB0DC9(iLocal_99))
			{
				if (unk_0xB540EEBB14C48518(iLocal_99))
				{
					unk_0x14293208022014FA(iLocal_99, 1);
					unk_0xEE032FCCC9029460(iLocal_99, 0);
					unk_0xA71250388C9DB28D(iLocal_99, 0);
				}
				else
				{
					unk_0x39926DD5354848E1(iLocal_99);
					unk_0x14293208022014FA(iLocal_99, 1);
					unk_0xEE032FCCC9029460(iLocal_99, 0);
					unk_0xA71250388C9DB28D(iLocal_99, 0);
				}
...
int func_531(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if ((!unk_0x4732C5888F325E52() && (unk_0x67AA88F93B931038() || !unk_0x4E64773FA9BA7A47())) && unk_0xFEA5B5B75143A4A9())
	{
		...
		if (iParam4 == -1)
		{
			...
			{
				Var69 = { func_311(unk_0xD4E735F4B6A956AC()) };
...
int func_537(int iParam0, int iParam1)
{
	...
	if (func_201(iParam0, 1, 1))
	{
		...
		if (unk_0x5D7DFE2058701942(iVar0, iParam1))
		{
			...
			while (iVar1 < 32)
			{
				uVar2 = unk_0x1483A8AE554B8B2B(iVar1);
				if (func_201(uVar2, 1, 1))
				{
					if (unk_0xEE978C39384D834F(uVar2) != iVar0)
					{
