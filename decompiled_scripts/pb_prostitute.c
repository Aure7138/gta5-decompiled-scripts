...
void __EntryFunction__()
{
	...
	while (iLocal_62)
	{
		...
		if (func_539())
		{
			...
			if (!unk_0x765F6FEEFF39224F(iLocal_96))
			{
				bVar0 = false;
			}
			else if (!unk_0x0A81FE3D92AE2AC9(iLocal_96))
			{
				bVar0 = false;
				unk_0xA5F44EC021F96C6B(iLocal_96);
			}
		}
				...
				if (bVar0)
				{
					...
					switch (iLocal_294)
					{
						case 0:
							if (iLocal_293 == -1)
							{
								if (unk_0x0A3EB09120E78BA4(iLocal_96))
								{
									iLocal_293 = func_489();
								}
								else if (func_487())
							...
							else if (func_482())
							{
								if (func_481())
								{
									if (func_539())
									{
										if (unk_0x0A81FE3D92AE2AC9(iLocal_96))
										{
											unk_0xF6D940C3CF409665(iLocal_96, "WORLD_HUMAN_PROSTITUTE_HIGH_CLASS", 0, 0);
										}
										else
										{
											unk_0xA5F44EC021F96C6B(iLocal_96);
...
void func_3()
{
	if (iLocal_295 > 0)
	{
		if (unk_0x91D5C8283D19AF49(iLocal_98, 0))
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_97))
			{
				if (!unk_0x10930B9CAD4111C2(iLocal_97, iLocal_98, 0))
				{
					func_90();
				}
			}
	...
	if (!unk_0x765F6FEEFF39224F(iLocal_97) || unk_0xD62C4419A41F106A(iLocal_97, 0))
	{
		func_89(15);
	}
	switch (iLocal_295)
	{
		...
		case 6:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_97))
			{
				if (unk_0xD76D6BCC14B95CE1(iLocal_96, 242628503) == 7)
				{
					iLocal_65 = unk_0xE3903F59E2F22150();
					iLocal_66 = (iLocal_65 - iLocal_64);
					if (iLocal_66 >= 10000 || !unk_0x335C0645074963FE(iLocal_96, iLocal_97, 12f, 12f, 5f, 0, 1, 0))
					{
		...
		case 7:
			...
			{
				unk_0x77C4189A8E5C57C2(iLocal_97, iLocal_98, Local_90, (unk_0x629D2D6C17B9B5E2(iLocal_98) * 0.65f), 0, 0, 786859, 4f, -1f);
				iLocal_295 = 8;
			}
			break;
		
		case 8:
			if (unk_0xB7A628320EFF8E47(Local_90, unk_0xFBB1F99A825CAB09(iLocal_96, 1)) < 25f && unk_0xD76D6BCC14B95CE1(iLocal_97, -1817882002) != 1)
			{
				iLocal_297 = unk_0x9EC3B269A34A2BEE(1, 3);
				iLocal_295 = 11;
			}
		...
		case 15:
			if (unk_0x765F6FEEFF39224F(iLocal_96) && unk_0x765F6FEEFF39224F(iLocal_98))
			{
				if (unk_0x10930B9CAD4111C2(iLocal_96, iLocal_98, 0))
				{
					if (!unk_0xD62C4419A41F106A(iLocal_97, 0))
					{
						if (unk_0xD76D6BCC14B95CE1(iLocal_97, -828834893) != 1)
						{
							unk_0x07C339D4328CA16C(iLocal_96, 0, 16842752);
						}
					}
				}
				else
...
void func_4()
{
	...
	{
		case 0:
			unk_0x1F3934A4C07C1854(iLocal_96, 0.916f);
		...
		case 1:
			if (unk_0xB7A628320EFF8E47(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 0), unk_0xFBB1F99A825CAB09(iLocal_96, 0)) < 22500f)
			{
				func_32();
			}
			func_29(iLocal_98);
...
int func_27(int iParam0)
{
	if (func_28())
	{
		if (!unk_0xCC9A41DD2CD0C58B(unk_0x541D5C57194E73C4(iParam0), unk_0xFBB1F99A825CAB09(iParam0, 1), 1))
		{
			return 1;
		}
	}
...
void func_30(var uParam0)
{
	...
	if (unk_0x91D5C8283D19AF49(*uParam0, 0))
	{
		Var0 = { 0f, 0f, -0.1f };
		Var3 = { 0f, 0f, 0f };
		unk_0x0848C95091F9ECB9(*uParam0, 1, Var0, Var3, 0, 1, 1, 1, 1, 0);
	}
}

bool func_31()
{
	return unk_0xFBEC827720F84540(iLocal_96, 876132797);
}
...
{
	if (unk_0x786AF4A44E1B5B4B(sLocal_63))
	{
		sLocal_63 = func_44(iParam0, 0, 0);
		return 0;
	}
	if (!unk_0xE9CCF312047EBEE0(sLocal_63))
	{
		return 0;
	}
	else
...
char* func_44(int iParam0, bool bParam1, int iParam2)
{
	...
	if (!unk_0xD62C4419A41F106A(iParam0, 0))
	{
		uVar0 = unk_0xF2C96862595654B4(iParam0, 1);
...
int func_49(int iParam0)
{
	...
	if (!unk_0xD62C4419A41F106A(iParam0, 0))
	{
		if (unk_0x2E9A4AE2A5B4D8E8(iParam0) || !func_51(iParam0, iLocal_98, -1))
		{
			Var0 = { unk_0xFBB1F99A825CAB09(iParam0, 1) };
			unk_0x33F6BE48E356DA27(iParam0, 196624, 1);
			if (func_50())
			{
				unk_0x6DA4DBA91F234052(iParam0, Var0, 300f, -1, 1, 1);
			}
...
float func_52(int iParam0)
{
	...
	Var0 = { unk_0xFBB1F99A825CAB09(iLocal_96, 1) };
	Var3 = { Local_90 };
	if (iParam0 == 0)
	{
...
void func_53()
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_97))
	{
		if (unk_0x91D5C8283D19AF49(iLocal_98, 0))
		{
			if (unk_0x10930B9CAD4111C2(iLocal_97, iLocal_98, 0))
			{
				if (unk_0xD76D6BCC14B95CE1(iLocal_96, 242628503) == 1)
				{
					if (unk_0x24CA7139A01083BE(iLocal_96) > 0)
					{
						if (unk_0x10930B9CAD4111C2(iLocal_96, iLocal_98, 0))
						{
							func_480("prostitute WAITING TO END   - DRIVING OFF (WANDER)");
							unk_0x99414FB2D30425C1(&uLocal_101);
							unk_0x21D56A8927F5A92A(0, iLocal_98, 10f, 786603);
							unk_0xC734F59A13D39AEF(uLocal_101);
							unk_0x13A2D602CD10CBAC(iLocal_97, uLocal_101);
							unk_0xA7A57E7757ED035E(&uLocal_101);
							Local_90 = { func_54(unk_0xFBB1F99A825CAB09(iLocal_96, 1)) };
							unk_0x0483D0035D6E46FD(func_44(iLocal_96, 0, 0));
							iLocal_295 = 7;
...
void func_56()
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_97))
	{
		if (unk_0x91D5C8283D19AF49(iLocal_98, 0))
		{
			if (unk_0x10930B9CAD4111C2(iLocal_97, iLocal_98, 0))
			{
				fVar0 = unk_0x8BB475EA09C9A0EB(iLocal_98);
				if (unk_0x335C0645074963FE(iLocal_97, iLocal_96, 15f, 15f, 5f, 0, 1, 0) && fVar0 <= 1f)
				{
					func_63(iLocal_96);
					iLocal_65 = unk_0xE3903F59E2F22150();
					iLocal_66 = (iLocal_65 - iLocal_64);
					if (iLocal_66 >= iLocal_68)
					{
						if (func_539())
						{
							if (unk_0x0A81FE3D92AE2AC9(iLocal_97))
							{
								unk_0xE0DAC4ABE9900D9A(iLocal_97);
							}
						}
						else
						{
						...
						iLocal_68 = unk_0x9EC3B269A34A2BEE(0, 10000);
						if (iLocal_68 > 2500)
						{
							unk_0xED68CDDDE25A144E(iLocal_96);
							unk_0xA7A57E7757ED035E(&uLocal_101);
							unk_0x99414FB2D30425C1(&uLocal_101);
							unk_0xC838CE9837D0ABAF(0, iLocal_98, -1, 0, 1f, 8388609, 0);
							unk_0x7D575FC8F42508D8(0, -1);
							unk_0xC734F59A13D39AEF(uLocal_101);
							unk_0x13A2D602CD10CBAC(iLocal_96, uLocal_101);
							unk_0xA7A57E7757ED035E(&uLocal_101);
...
int func_57()
{
	...
	if (!unk_0x765F6FEEFF39224F(iLocal_96) || unk_0xBC2FC12AD0FBF72E(iLocal_96))
	{
		return 1;
	}
	if (!func_539())
	{
		if (unk_0xF0D230FB550CD6EB(iLocal_96, 1))
		{
			unk_0xBD4591245C650283(iLocal_96, 1193033728, 0);
		}
		else if (func_479(iLocal_49, 4194304))
		{
			...
			{
				unk_0x108754262311D34F(0, func_61(iLocal_293), func_60(7), 8f, -1.5f, -1, 0, 0, 0, 0, 0);
			}
			func_58(1);
			unk_0xC734F59A13D39AEF(uVar0);
			unk_0x13A2D602CD10CBAC(iLocal_96, uVar0);
	...
	switch (iLocal_54)
	{
		...
		case 1:
			if (func_479(iLocal_75, 524288))
			{
				if (unk_0x0A81FE3D92AE2AC9(iLocal_96))
				{
					unk_0x108754262311D34F(iLocal_96, func_61(iLocal_293), func_60(7), 8f, -1.5f, -1, 0, 0, 0, 0, 0);
				}
				else
				{
					unk_0xA5F44EC021F96C6B(iLocal_96);
		...
		case 2:
			if (func_479(iLocal_75, 524288))
			{
				if (unk_0x0A81FE3D92AE2AC9(iLocal_96))
				{
					if (unk_0xD76D6BCC14B95CE1(iLocal_96, -2017877118) == 7)
					{
						func_58(0);
						iLocal_54 = 3;
					}
...
void func_58(bool bParam0)
{
	...
	if (((unk_0x9CEB33F9F7FA9FE7(iLocal_96) || unk_0x0A3EB09120E78BA4(iLocal_96)) || unk_0x37FBF97457299644(iLocal_96, func_59(0))) || unk_0x37FBF97457299644(iLocal_96, func_59(1)))
	{
		return;
	}
	Var0 = { unk_0xFBB1F99A825CAB09(iLocal_96, 1) };
	if (!unk_0x52C7F2CBE015C31D(Var0, func_59(0), 20f, 1) && !unk_0x52C7F2CBE015C31D(Var0, func_59(1), 20f, 1))
	{
		if (bParam0)
		{
	...
	if (!bParam0)
	{
		unk_0xA9128AA30F3036C7(iLocal_96, Var0, 20f, 0);
	}
	else
	{
		unk_0xA9128AA30F3036C7(0, Var0, 20f, 0);
	}
}
...
void func_62()
{
	if (unk_0xBC2FC12AD0FBF72E(iLocal_96))
	{
		return;
	}
	if (!unk_0x8B76D954998C9E96(iLocal_96))
	{
		if (func_18() == 2)
		{
			unk_0xAEED0213982928AC(iLocal_96, "HOOKER_DECLINED_TREVOR", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
		else
		{
			unk_0xAEED0213982928AC(iLocal_96, "HOOKER_DECLINED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
	}
}
...
void func_63(int iParam0)
{
	if (!unk_0xBC2FC12AD0FBF72E(iParam0))
	{
		if (func_64(iParam0))
		{
			unk_0x41E36A540F8F323F(iParam0, 109, 1);
		}
	}
}
...
int func_64(int iParam0)
{
	if (!unk_0xBC2FC12AD0FBF72E(iParam0))
	{
		if ((unk_0x1CE8F0A08E65CA6A(iParam0, func_61(iLocal_293), func_60(1), 3) || unk_0x1CE8F0A08E65CA6A(iParam0, func_61(iLocal_293), func_60(2), 3)) || unk_0x1CE8F0A08E65CA6A(iParam0, func_61(iLocal_293), func_60(3), 3))
		{
			return 1;
		}
	}
	...
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_97))
	{
		if (unk_0x91D5C8283D19AF49(iLocal_98, 0))
		{
			if (unk_0x10930B9CAD4111C2(iLocal_97, iLocal_98, 0))
			{
				if (unk_0xD76D6BCC14B95CE1(iLocal_96, 242628503) == 1)
				{
					if (unk_0x24CA7139A01083BE(iLocal_96) > 1)
					{
						if (unk_0x335C0645074963FE(iLocal_96, iLocal_97, 20f, 20f, 10f, 0, 1, 0))
						{
							fVar0 = unk_0x8BB475EA09C9A0EB(iLocal_98);
							if (fVar0 <= 1f)
							{
								func_66(0);
								iLocal_64 = unk_0xE3903F59E2F22150();
								iLocal_68 = unk_0x9EC3B269A34A2BEE(4000, 8000);
...
int func_66(bool bParam0)
{
	...
	if (!func_539())
	{
		if (bParam0)
		{
			unk_0x7B1011A61F402324(iLocal_96, "PROSTITUTE_GROUP", 0);
		...
		if (func_479(iLocal_49, 4194304))
		{
			...
			unk_0x108754262311D34F(0, func_61(iLocal_293), func_60(0), 2f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0x108754262311D34F(0, func_61(iLocal_293), func_60(iVar0), 2f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0x108754262311D34F(0, func_61(iLocal_293), func_60(4), 2f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0xC734F59A13D39AEF(uVar1);
			unk_0x13A2D602CD10CBAC(iLocal_96, uVar1);
	...
	switch (iLocal_53)
	{
		...
		case 1:
			if (func_479(iLocal_49, 4194304))
			{
				if (unk_0x0A81FE3D92AE2AC9(iLocal_96))
				{
					unk_0x108754262311D34F(iLocal_96, func_61(iLocal_293), func_60(0), 2f, -2f, -1, 0, 0, 0, 0, 0);
					iLocal_53 = 2;
				}
				else
				{
		...
		case 2:
			if (unk_0x0A81FE3D92AE2AC9(iLocal_96))
			{
				...
				{
					iVar0 = unk_0x9EC3B269A34A2BEE(1, 4);
					unk_0x108754262311D34F(iLocal_96, func_61(iLocal_293), func_60(iVar0), 2f, -2f, -1, 0, 0, 0, 0, 0);
					iLocal_53 = 3;
				}
			}
			else
		...
		case 3:
			if (unk_0x0A81FE3D92AE2AC9(iLocal_96))
			{
				if (unk_0xD76D6BCC14B95CE1(iLocal_96, -2017877118) == 7)
				{
					unk_0x108754262311D34F(iLocal_96, func_61(iLocal_293), func_60(4), 2f, -2f, -1, 1, 0, 0, 0, 0);
					iLocal_53 = 4;
				}
			}
			else
	...
	if (!unk_0x8B76D954998C9E96(iLocal_96))
	{
		switch (func_18())
		{
			case 0:
				...
				{
					unk_0xAEED0213982928AC(iLocal_96, "SOLICIT_MICHAEL", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				else
				{
					unk_0xAEED0213982928AC(iLocal_96, "SOLICIT_MICHAEL_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				break;
			...
			case 1:
				if (!func_68(iLocal_96))
				{
					unk_0xAEED0213982928AC(iLocal_96, "SOLICIT_FRANKLIN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				else
				{
					unk_0xAEED0213982928AC(iLocal_96, "SOLICIT_FRANKLIN_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				break;
			...
			case 2:
				if (!func_68(iLocal_96))
				{
					unk_0xAEED0213982928AC(iLocal_96, "SOLICIT_TREVOR", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				else
				{
					unk_0xAEED0213982928AC(iLocal_96, "SOLICIT_TREVOR_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				break;
			}
	}
...
bool func_74(int iParam0, int iParam1, int iParam2)
{
	...
	return unk_0xCEB55689C694866C(uParam0, uVar0) == func_75(iParam1, iParam2);
}
...
bool func_78(int iParam0, int iParam1, int iParam2)
{
	...
	return unk_0xA603FBA9F3C17D3A(uParam0, uVar0) == func_79(iParam1, iParam2);
}
...
void func_82()
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_97))
	{
		if (unk_0x91D5C8283D19AF49(iLocal_98, 0))
		{
			...
			{
				fVar0 = unk_0x8BB475EA09C9A0EB(iLocal_98);
				if (unk_0xD76D6BCC14B95CE1(iLocal_97, -272084098) == 7 || fVar0 <= 1f)
				{
					unk_0xFEF5F9BB57EA2E8D(unk_0x541D5C57194E73C4(iLocal_98), &Var4, &Var1);
					Var7 = { Var1 - Var4 };
					Var7 = { Var7 / Vector(2f, 2f, 2f) };
					Var10 = { unk_0x2CA911E7569D12EA(iLocal_98, 0.2f, 0.2f, 0f) };
					Var13 = { unk_0x2CA911E7569D12EA(iLocal_98, 0.2f, 0.2f, 0f) };
					Var16 = { unk_0xFBB1F99A825CAB09(iLocal_96, 1) };
					if (unk_0x2A488C176D52CCA5(Var16, Var13) < unk_0x2A488C176D52CCA5(Var16, Var10))
					{
						Var10 = { Var13 };
					}
					unk_0x99414FB2D30425C1(&uLocal_101);
					unk_0x7E268975AF5EA74F(0, Var10.f_0, Var10.f_1, Var10.f_2, 1f, -1, 0.5f, 8192, 1193033728);
					unk_0x11C4AF4137F2A4B5(0, iLocal_97, 0);
					unk_0x7D575FC8F42508D8(0, -1);
					unk_0xC734F59A13D39AEF(uLocal_101);
					unk_0x13A2D602CD10CBAC(iLocal_96, uLocal_101);
					unk_0xA7A57E7757ED035E(&uLocal_101);
	...
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_97))
	{
		if (unk_0x91D5C8283D19AF49(iLocal_98, 0))
		{
			if (unk_0x10930B9CAD4111C2(iLocal_97, iLocal_98, 0))
			{
				...
				{
					if (func_84(unk_0xFBB1F99A825CAB09(iLocal_97, 1), 1106247680))
					{
						return;
					}
					Var0 = { unk_0xFBB1F99A825CAB09(iLocal_96, 1) };
					if (unk_0x8E241517F0F541CC(Var0, &Var0, 8, 1077936128, 0))
					{
						unk_0x0D5CFE7123DCE05F(iLocal_97, 1f);
						unk_0x7A66899F7E549BA6(iLocal_97, 0.2f);
						unk_0x8120EE2272397CE8(iLocal_97, 0.05f);
						unk_0x19A39772525FA2CD(iLocal_97, iLocal_98, Var0, 0f, 3, 360f, 1);
						unk_0xC4A347124F39D998(iLocal_97, iLocal_96, -1, 2048, 4);
...
bool func_84(struct<3> Param0, int iParam3)
{
	if (func_539())
	{
		return unk_0xB05EBD564C7A1480(Param0 - Vector(iParam3, iParam3, iParam3), Param0 + Vector(iParam3, iParam3, iParam3));
	}
	return (unk_0x4A83E23BE6BCA7B0(Param0 - Vector(iParam3, iParam3, iParam3), Param0 + Vector(iParam3, iParam3, iParam3)) || unk_0xB05EBD564C7A1480(Param0 - Vector(iParam3, iParam3, iParam3), Param0 + Vector(iParam3, iParam3, iParam3)));
}
	...
	if (unk_0x91D5C8283D19AF49(*iParam0, 0))
	{
		...
		if (func_88(iVar0, 0) && func_87(*iParam0))
		{
			if (unk_0xC92AA0DBDDDE8BB8(*iParam0) > 0)
			{
				...
				if (((iVar1 == 0 && unk_0x67FFBB75D2430704(*iParam0, 0, 0)) && (!unk_0x830B1D24ED3D5F55(*iParam0, 1) && !unk_0x830B1D24ED3D5F55(*iParam0, 0))) || unk_0x7BDC41A7CA0C77A2(*iParam0, 0, 0) == iLocal_96)
				{
					if (func_41(*iParam0))
					{
...
void func_90()
{
	if (func_539())
	{
		...
		{
			unk_0xED68CDDDE25A144E(iLocal_96);
			unk_0xE0DAC4ABE9900D9A(iLocal_96);
		}
	}
	else
	{
	...
	iLocal_97 = 0;
	iLocal_98 = 0;
	unk_0x108754262311D34F(iLocal_96, func_61(iLocal_293), func_60(4), 2f, -2f, -1, 1, unk_0x9562E33C057F7589(0f, 0.9f), 0, 0, 0);
	func_89(0);
	iLocal_296 = 0;
	iLocal_294 = 1;
}
	...
	switch (iLocal_295)
	{
		case 0:
			...
			else if (iLocal_296 != 0 && !func_459("PROS_NO_MONEY"))
			{
				...
				{
					case 0:
						func_458(&uLocal_122, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 0, 1);
						break;
					
					case 1:
						func_458(&uLocal_122, 0, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
						break;
					
					case 2:
						func_458(&uLocal_122, 0, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
						break;
				}
				iLocal_295 = 1;
			}
		...
		case 11:
			...
			if (func_539())
			{
				unk_0x41E36A540F8F323F(unk_0x33CD235DF1E6A94E(), 433, 1);
				func_218(uParam0);
			}
			break;
...
void func_95()
{
	if (!unk_0x8B76D954998C9E96(unk_0x33CD235DF1E6A94E()))
	{
		if (iLocal_72 == 0)
		{
			...
			{
				unk_0x33F6BE48E356DA27(iLocal_96, 32768, 0);
				unk_0x33F6BE48E356DA27(iLocal_96, 196624, 1);
			}
			unk_0xAEED0213982928AC(iLocal_96, "HOOKER_LEAVES_ANGRY", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			func_89(15);
		}
	}
}
...
void func_96()
{
	...
	{
		case 0:
			if (!unk_0x8B76D954998C9E96(iLocal_96) || func_114(&uLocal_107) > 4f)
			{
				func_109(iLocal_96);
		...
		case 1:
			func_106();
			if (unk_0x8B76D954998C9E96(iLocal_96) || func_105())
			{
...
void func_99(bool bParam0)
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_96))
	{
		...
		{
			unk_0x4B8B69DAE5BAC592(&iLocal_96);
		}
		else
		{
...
void func_100(int iParam0, bool bParam1)
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(uParam0))
	{
		...
		if (func_479(iLocal_49, 134217728))
		{
			unk_0x33F6BE48E356DA27(iParam0, 32768, 1);
		...
		if (func_539())
		{
			if (unk_0x462247B843778DF4(iLocal_96))
			{
				if (unk_0x5E2784BB00B20E8E(unk_0x8370E68A3DEEB1D3(iLocal_96)))
				{
...
{
	if (!unk_0x782B99DB55846C95(uParam0, unk_0xF2C96862595654B4(uParam0, 0), 0, 0, 0))
	{
	...
	if (unk_0x765F6FEEFF39224F(unk_0x33CD235DF1E6A94E()))
	{
		if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
		{
			...
			if (unk_0x765F6FEEFF39224F(iVar1))
			{
				...
				if (unk_0x7BDC41A7CA0C77A2(iVar1, 0, 0) != iLocal_96)
				{
					bVar0 = true;
				}
...
void func_116(bool bParam0)
{
	...
	if (bParam0)
	{
		Var0 = { unk_0x60B5C1FD066CB864(iLocal_99, 2) };
		unk_0xC7E6A5D90DED6E0B(180f);
		unk_0xD6EDA274D82E8678((-5.5f - Var0.f_0), 1065353216);
	}
...
void func_118()
{
	...
	{
		unk_0xA56208AB5F9EC61A(iLocal_99, 1);
	}
	if (iLocal_302 != 5)
	{
		...
		{
			if (!unk_0x5C415D10D5CBF689(iLocal_96) || unk_0x45AD2119A5B580CD(unk_0x33CD235DF1E6A94E()))
			{
				iLocal_302 = 5;
			}
			if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
...
void func_122()
{
	...
	if (!unk_0x8B76D954998C9E96(iLocal_96))
	{
		unk_0xAEED0213982928AC(iLocal_96, "SEX_FINISHED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_123()
{
	...
	if (!unk_0x8B76D954998C9E96(iLocal_96))
	{
		unk_0xAEED0213982928AC(iLocal_96, "HOOKER_HAD_ENOUGH", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_127()
{
	...
	switch (iLocal_305)
	{
		...
		case 5:
			...
			{
				func_175(iLocal_96, 0);
				unk_0x108754262311D34F(iLocal_96, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(iLocal_305, 1, bVar1, bVar2), 4f, -4f, -1, 1, 0, 0, 0, 0);
				func_175(unk_0x33CD235DF1E6A94E(), -1);
				unk_0x108754262311D34F(unk_0x33CD235DF1E6A94E(), func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(iLocal_305, 0, bVar1, bVar2), 4f, -4f, -1, 1, 0, 0, 0, 0);
				func_116(1);
				iLocal_50 = 0;
				iLocal_73 = 0;
				iLocal_61 = 0;
...
void func_145()
{
	...
	{
		func_147(13, unk_0xF34EE736CF047844(Global_106565.f_10188.f_3853));
	}
...
void func_150(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_81, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(unk_0x33CD235DF1E6A94E(), iLocal_82, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(4, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_151(int iParam0, int iParam1, var uParam2, var uParam3, float fParam4, float fParam5, int iParam6, int iParam7, float fParam8, int iParam9)
{
	...
	{
		unk_0x08798CBF817BA887(iParam0, iParam1, uParam2, uParam3, fParam4, fParam5, iParam6, iParam7, fParam8, iParam9);
	}
}
...
void func_152(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_81, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_154(&iLocal_82, 0, 0, 0);
	func_153(unk_0x33CD235DF1E6A94E(), iLocal_82, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(4, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
void func_153(int iParam0, int iParam1, var uParam2, var uParam3, float fParam4, float fParam5, int iParam6, int iParam7, int iParam8)
{
	if (func_539())
	{
		unk_0x74E9D455686E1F3A(iParam0, iParam1, uParam2, uParam3, fParam4, fParam5, iParam6, iParam7, iParam8, 0);
	}
}
...
void func_154(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	*iParam0 = func_157(Var0, 0f, 0f, 0f, bParam3, iParam2, 2);
	if (iParam1 == 0)
	{
		func_156(*iParam0, iLocal_99, unk_0x89DDAAE6EFF42DD9(iLocal_99, "seat_dside_f"));
	}
	else if (iParam1 == 1)
	{
		func_156(*iParam0, iLocal_99, unk_0x89DDAAE6EFF42DD9(iLocal_99, "seat_pside_f"));
	}
...
void func_155(var uParam0, struct<3> Param1, struct<3> Param4, int iParam7)
{
	if (!func_539())
	{
		unk_0x3E7EA351DBCB7E7A(uParam0, Param1, Param4, iParam7);
	}
}
...
void func_156(var uParam0, int iParam1, var uParam2)
{
	...
	if (func_539())
	{
		unk_0x10E324DB302F7E38(uParam0, iParam1, uParam2);
	}
	else
	{
		unk_0x19CC0F2E313BAF2E(uParam0, iParam1, uParam2);
	}
}
...
var func_157(struct<3> Param0, struct<3> Param3, bool bParam6, int iParam7, int iParam8)
{
	...
	if (func_539())
	{
		...
		uVar0 = unk_0x6D57E93CB68152FE(Param0, Param3, iParam8, bParam6, iParam7, 1065353216, 0, 1065353216);
	}
	else
	{
		uVar0 = unk_0x38A6890195DD00D1(Param0, Param3, iParam8);
		unk_0x34C803C2BC1CAFB2(uVar0, bParam6);
		unk_0x6359F1F7F5174D4A(uVar0, iParam7);
	}
	return uVar0;
}
...
void func_158(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_80, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(unk_0x33CD235DF1E6A94E(), iLocal_80, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(3, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_159(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_80, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_153(unk_0x33CD235DF1E6A94E(), iLocal_80, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(3, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
void func_167(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_79, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(2, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(unk_0x33CD235DF1E6A94E(), iLocal_79, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(2, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_168(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_79, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(2, 1, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
	func_153(unk_0x33CD235DF1E6A94E(), iLocal_79, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(2, 0, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
}
...
void func_169(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_78, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(unk_0x33CD235DF1E6A94E(), iLocal_78, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(1, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_170(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_78, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_153(unk_0x33CD235DF1E6A94E(), iLocal_78, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(1, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
float func_171(int iParam0)
{
	...
	if (func_539())
	{
		uVar0 = unk_0x4EDDCE9AAE0FC976(unk_0x3F2F21BCB3761848(iParam0));
	}
	else
	{
		uVar0 = unk_0x4EDDCE9AAE0FC976(iParam0);
	}
	return uVar0;
}
...
void func_173(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_76, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(0, 1, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
	func_151(unk_0x33CD235DF1E6A94E(), iLocal_77, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(0, 0, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
}
...
void func_174(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_76, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(0, 1, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
	func_154(&iLocal_77, 0, 0, 1);
	func_153(unk_0x33CD235DF1E6A94E(), iLocal_77, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_38(0, 0, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
}

void func_175(int iParam0, int iParam1)
{
	if (!unk_0x10930B9CAD4111C2(iParam0, iLocal_99, 0))
	{
		if (!func_539())
		{
			unk_0x094626C0798AE1F8(iParam0, iLocal_99, iParam1);
		}
		else if (!unk_0x10930B9CAD4111C2(iParam0, iLocal_99, 0))
		{
			unk_0xC838CE9837D0ABAF(iParam0, iLocal_99, -1, iParam1, 2f, 16, 0);
		}
	}
}
...
void func_176(int iParam0)
{
	...
	uVar0 = func_178(func_179(2), unk_0x2D49816199C51B0C(iLocal_99, unk_0x89DDAAE6EFF42DD9(iLocal_99, "windscreen")));
	uVar1 = func_178(func_179(1), unk_0x2D49816199C51B0C(iLocal_99, unk_0x89DDAAE6EFF42DD9(iLocal_99, "windscreen")));
	Var2 = { unk_0x60B5C1FD066CB864(iLocal_99, 2) };
	fVar5 = unk_0xC472E34C8FBEC678(iLocal_99);
	if (fVar5 >= 180f)
	{
		fVar6 = (fVar5 - 180f);
	}
...
void func_177(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	...
	*uParam0 = unk_0x00E62F31D05EB2AC("DEFAULT_SCRIPTED_CAMERA", 0);
	...
	unk_0x2AAFDB86F2CBFB67(*uParam0, Param1, uParam0->f_1, fParam7, 0, 1, 1, 2);
	unk_0x63F0B040CE6EDF0F(1, 0, 3000, 1, 0, 0);
}
...
Vector3 func_179(int iParam0)
{
	...
	unk_0xFEF5F9BB57EA2E8D(unk_0x541D5C57194E73C4(iLocal_99), &uVar3, &Var6);
	Var9 = { unk_0x2D49816199C51B0C(iLocal_99, unk_0x89DDAAE6EFF42DD9(iLocal_99, "windscreen")) };
	Var12 = { unk_0x16068053F8800179(iLocal_99, Var9) };
	switch (iParam0)
	{
		case 0:
			Var0 = { unk_0x2CA911E7569D12EA(iLocal_99, 0f, (Var6.f_1 + 1.4f), Var12.f_2) };
			break;
		
		case 1:
			Var0 = { unk_0x2CA911E7569D12EA(iLocal_99, 1.5f, (Var6.f_1 + 1.2f), (Var12.f_2 - 0.1f)) };
			break;
		
		case 2:
			Var0 = { unk_0x2CA911E7569D12EA(iLocal_99, -3.7f, 0.7f, Var12.f_2) };
			break;
...
Vector3 func_180()
{
	...
	unk_0xFEF5F9BB57EA2E8D(unk_0x541D5C57194E73C4(iLocal_99), &Var6, &uVar9);
	Var0 = { unk_0x2D49816199C51B0C(iLocal_99, unk_0x89DDAAE6EFF42DD9(iLocal_99, "windscreen")) };
	Var3 = { unk_0x16068053F8800179(iLocal_99, Var0) };
	Var3.f_2 = (Var3.f_2 + 0.09f);
	Var6.f_1 = (Var6.f_1 - 1f);
	return unk_0x2CA911E7569D12EA(iLocal_99, 0f, -unk_0x7EECA16E87982278(Var6.f_1), Var3.f_2);
}
...
{
	if (!unk_0x117DAF3BF7232886(Local_313[*iParam0 /*7*/]))
	{
		return;
	}
	if (!unk_0xFAA5C555ED0CEC9B(Local_313[*iParam0 /*7*/]))
	{
		return;
	}
	unk_0x083F68B89E3EA476(Local_313[*iParam0 /*7*/], "HAND_SHAKE", 0.25f);
...
void func_188()
{
	...
	else
	{
		...
		{
			case 0:
				if (unk_0xFBEC827720F84540(iLocal_96, 876132797))
				{
					unk_0x61AE8E2B7BB7D8BA(0, 200, 84);
					unk_0x0848C95091F9ECB9(iLocal_99, 1, 0f, 0f, -0.05f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
					func_190();
				}
				break;
			...
			case 2:
				if (func_479(iLocal_49, 32768))
				{
					if (func_539())
					{
						iVar0 = unk_0x3F2F21BCB3761848(iLocal_79);
					}
					else
					{
						iVar0 = iLocal_79;
					...
					if (unk_0xDB4C79A9697E6A55(iVar0))
					{
						...
						if ((((((((((((((fVar1 > 0.01f && fVar1 < 0.019f) || (fVar1 > 0.093f && fVar1 < 0.1f)) || (fVar1 > 0.165f && fVar1 < 0.172f)) || (fVar1 > 0.231f && fVar1 < 0.239f)) || (fVar1 > 0.308f && fVar1 < 0.317f)) || (fVar1 > 0.37f && fVar1 < 0.378f)) || (fVar1 > 0.437f && fVar1 < 0.443f)) || (fVar1 > 0.507f && fVar1 < 0.518f)) || (fVar1 > 0.58f && fVar1 < 0.587f)) || (fVar1 > 0.651f && fVar1 < 0.659f)) || (fVar1 > 0.72f && fVar1 < 0.729f)) || (fVar1 > 0.788f && fVar1 < 0.794f)) || (fVar1 > 0.862f && fVar1 < 0.87f)) || (fVar1 > 0.937f && fVar1 < 0.946f))
						{
							if (!func_512(512))
							{
								...
								unk_0x0848C95091F9ECB9(iLocal_99, 1, 0f, 0f, -0.1f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
								func_190();
								func_189(512);
							}
						}
				...
				else if (unk_0xFBEC827720F84540(iLocal_96, 876132797))
				{
					unk_0x61AE8E2B7BB7D8BA(0, 200, 252);
					unk_0x0848C95091F9ECB9(iLocal_99, 1, 0f, 0f, -0.1f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
					func_190();
...
void func_191()
{
	...
	if (unk_0x765F6FEEFF39224F(unk_0x33CD235DF1E6A94E()))
	{
		iLocal_59 = unk_0xE80842D7B53F8525(unk_0x33CD235DF1E6A94E());
	}
}
...
bool func_193()
{
	return unk_0x1CE8F0A08E65CA6A(iLocal_96, func_44(unk_0x33CD235DF1E6A94E(), 0, 0), func_194(iLocal_96, func_43(), 1), 3);
}
...
void func_195()
{
	...
	if (unk_0x8B76D954998C9E96(iLocal_96) || unk_0x8B76D954998C9E96(unk_0x33CD235DF1E6A94E()))
	{
		return;
	}
...
void func_196()
{
	...
	if (!unk_0x8B76D954998C9E96(iLocal_96) && !unk_0x8B76D954998C9E96(unk_0x33CD235DF1E6A94E()))
	{
		...
		else if (func_7(&uLocal_107) > unk_0x9562E33C057F7589(2f, 5f))
		{
...
void func_197(int iParam0)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				unk_0xAEED0213982928AC(iLocal_96, "SEX_ORAL", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			else
			{
				unk_0xAEED0213982928AC(iLocal_96, "SEX_ORAL_FEM", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			break;
		...
		case 2:
			if (func_198(unk_0x95B959F18401C09A()))
			{
				unk_0xAEED0213982928AC(iLocal_96, "SEX_GENERIC", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			else
			{
				unk_0xAEED0213982928AC(iLocal_96, "SEX_GENERIC_FEM", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			break;
	}
}
...
bool func_211(int iParam0)
{
	...
	if (func_539())
	{
		uVar0 = unk_0xDB4C79A9697E6A55(unk_0x3F2F21BCB3761848(iParam0));
	}
	else
	{
		uVar0 = unk_0xDB4C79A9697E6A55(iParam0);
	}
	return uVar0;
}
...
void func_212()
{
	if (unk_0xBB5E373390A5F824())
	{
		...
		unk_0xBEADAF07D2339505(unk_0x33CD235DF1E6A94E(), func_214(), 1, 0, 0, 1);
...
void func_215()
{
	...
	if (func_217(&uLocal_104, 3f) && !unk_0x49D25022440E65EE(uLocal_103))
	{
		iVar0 = unk_0xF34EE736CF047844(((func_216() - 2f) * 1000f));
		unk_0x189377BFBDC9127F(uLocal_102, 0);
		unk_0x8EB023915CEEDB99(uLocal_103, uLocal_102, iVar0, 1, 1);
	}
...
void func_221(var uParam0)
{
	...
	if (unk_0x765F6FEEFF39224F(iLocal_96))
	{
		if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
		{
			iVar0 = unk_0xE80842D7B53F8525(iLocal_96);
...
void func_224()
{
	...
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		...
		if (func_539())
		{
			if (unk_0x0A81FE3D92AE2AC9(iLocal_99))
			{
				unk_0x2EE596932F00971D(iLocal_99, 1);
				unk_0x26E0FFDB1AD22AC5(iLocal_99, 4);
				unk_0x3F99D2373794B210(iLocal_99, 1);
				unk_0x1C2B995BA5ADE8FF(iLocal_99, 0, 0);
			}
		}
		else
		{
		...
		if (!func_369() || !unk_0x10930B9CAD4111C2(iLocal_96, iLocal_99, 0))
		{
			func_462(0);
			return;
		}
	...
	func_206(0);
	if ((!unk_0x61DFE32FB87BC784(iLocal_99) && unk_0x5A8ABDA4992DA968(unk_0x95B959F18401C09A())) && !func_479(iLocal_49, 1024))
	{
		iLocal_295 = 7;
		func_367(1, -1);
	...
	switch (iLocal_301)
	{
		...
		case 1:
						...
						if (unk_0x0371ECBEC27AF4BE(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0)))
						{
							if (unk_0x7BDC41A7CA0C77A2(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), -1, 0) == unk_0x33CD235DF1E6A94E())
							{
								if (unk_0x0A81FE3D92AE2AC9(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0)))
								{
									...
									{
										unk_0x0D21E1FDE062ED99(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), 0, 0);
									}
								}
								else
								{
			...
			if (func_362())
			{
				...
				unk_0x42E0C09F4BDF7390(iLocal_96);
				iLocal_301 = 2;
			}
			break;
		...
		case 3:
			...
			if (((unk_0x833B1A3D9F713E03(2, 187) || (unk_0x5D79F3D06EB318A0(2) && unk_0x833B1A3D9F713E03(2, 242))) || (unk_0x5D79F3D06EB318A0(2) && unk_0x5EBE50D55314CEAD(0, 33))) || (((unk_0x4CE1DD5CFC1F941E() && !unk_0x5D79F3D06EB318A0(2)) && iVar7 > 100) && (unk_0xE3903F59E2F22150() - iLocal_89) > 300))
			{
				unk_0x0F8EAEEC97DDBCB3(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
			...
			else if (((unk_0x833B1A3D9F713E03(2, 188) || (unk_0x5D79F3D06EB318A0(2) && unk_0x833B1A3D9F713E03(2, 241))) || (unk_0x5D79F3D06EB318A0(2) && unk_0x5EBE50D55314CEAD(0, 32))) || (((unk_0x4CE1DD5CFC1F941E() && !unk_0x5D79F3D06EB318A0(2)) && iVar7 < -100) && (unk_0xE3903F59E2F22150() - iLocal_89) > 300))
			{
				unk_0x0F8EAEEC97DDBCB3(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
				func_480("UP pressed!");
				if (iLocal_70 > 0)
		...
		case 4:
			iVar10 = unk_0xC69F0E93D95E37FC(iLocal_96);
			if (iLocal_297 == 3)
			{
				func_367(1, -1);
				func_275();
				...
				else
				{
					if (func_269() >= 20)
					{
						iVar10 += 20;
						func_226(20);
						unk_0xF8E07C228A90E953(iLocal_96, iVar10);
					}
					func_462(1);
					return;
				}
		...
		if (iVar5 == 1 && Global_17411.f_5728)
		{
			...
			if (unk_0x36163153849DFDA1(&(Global_17411.f_4690)) != 0 && Global_17411.f_4766 != -1)
			{
				...
				if (Global_17411.f_4768 != 0)
				{
					...
					unk_0x281206A3ED9B7B48(func_312(Global_17411.f_4768), func_309(Global_17411.f_4768, 1), ((Global_17408 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
				}
			...
			if (unk_0x36163153849DFDA1(&(Global_4267964.f_21)) != 0 && Global_4267964.f_65 != -1)
			{
				...
				if (Global_4267964.f_67 != 0)
				{
					...
					unk_0x281206A3ED9B7B48(func_312(Global_4267964.f_67), func_309(Global_4267964.f_67, 1), ((Global_17408 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
				}
				fVar51 = (fVar51 + (((unk_0x6486D2A6F2DC8DCB(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
									...
									if (bVar54)
									{
										if (func_318(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_318(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													unk_0x281206A3ED9B7B48(func_312(26), func_309(26, 1), ((fVar34 + fVar42) + fVar45), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
												}
											}
										}
										if (func_318(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_318(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													unk_0x281206A3ED9B7B48(func_312(27), func_309(27, 1), (((fVar34 + fVar42) + fVar45) + (fVar43 + fVar44)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
												}
											}
										}
									}
												...
												if (func_318(Global_17411.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_318(Global_17411.f_4433[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_17411.f_5083[iVar8] == 2)
															{
																unk_0x281206A3ED9B7B48(func_312(Global_17411.f_4433[(iVar22 + iVar28)]), func_309(Global_17411.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
															else
															{
																unk_0x281206A3ED9B7B48(func_312(Global_17411.f_4433[(iVar22 + iVar28)]), func_309(Global_17411.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
														}
												...
												if (func_318(Global_17411.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_318(Global_17411.f_4433[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																unk_0x281206A3ED9B7B48(func_312(Global_17411.f_4433[(iVar22 + iVar14)]), func_309(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), (Global_17408 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
															else if (Global_17411.f_5083[iVar8] == 2)
															{
																unk_0x281206A3ED9B7B48(func_312(Global_17411.f_4433[(iVar22 + iVar14)]), func_309(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
															else
															{
																unk_0x281206A3ED9B7B48(func_312(Global_17411.f_4433[(iVar22 + iVar14)]), func_309(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
														}
													}
									...
									if (func_318(Global_17411.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_318(Global_17411.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												unk_0x281206A3ED9B7B48(func_312(Global_17411.f_4433[iVar22]), func_309(Global_17411.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_290(Global_17411.f_4433[iVar22])), (fVar37 * func_290(Global_17411.f_4433[iVar22])), 0f, iVar47, iVar48, iVar49, iVar50, 0);
											}
										}
									}
								}
...
var func_309(int iParam0, bool bParam1)
{
	...
	if (!unk_0x786AF4A44E1B5B4B(&(Global_17411.f_6997[iParam0 /*16*/])))
	{
		...
		{
			Var19 = { func_311(unk_0x95B959F18401C09A()) };
...
char* func_312(int iParam0)
{
	...
	if (!unk_0x786AF4A44E1B5B4B(&(Global_17411.f_6020[iParam0 /*16*/])))
	{
		...
		{
			Var16 = { func_311(unk_0x95B959F18401C09A()) };
...
int func_318(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)
{
	...
	if (unk_0x36163153849DFDA1(&cVar16) != 0)
	{
		...
		Var37.f_0 = (Var37.f_0 * (func_319(iParam0) / fVar34));
		Var37.f_1 = (Var37.f_1 * (func_319(iParam0) / fVar34));
		if (!bParam2)
		{
...
void func_323()
{
	...
	{
		iLocal_304 = func_341();
		func_332(&iLocal_304, 0, 0, unk_0x9EC3B269A34A2BEE(1, 2), 0, 0, 0);
	}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_160(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
			...
			if (iParam0 == unk_0x33CD235DF1E6A94E())
			{
				if (!func_198(unk_0x95B959F18401C09A()))
				{
					...
					if (!func_512(256))
					{
						func_189(256);
						iLocal_86 = iVar0;
						iLocal_87 = unk_0xCEB55689C694866C(unk_0x33CD235DF1E6A94E(), 6);
...
void func_361()
{
	...
	unk_0x2918FC6BDEBF9834(iLocal_96);
	if (!unk_0x8B76D954998C9E96(iLocal_96))
	{
		if (iLocal_72 < 1)
		{
			unk_0xAEED0213982928AC(iLocal_96, "HOOKER_OFFER_SERVICE", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
		else
		{
			unk_0xAEED0213982928AC(iLocal_96, "HOOKER_OFFER_AGAIN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
	}
}
...
void func_365()
{
	...
	if (unk_0x765F6FEEFF39224F(iLocal_96))
	{
		iLocal_60 = unk_0xE80842D7B53F8525(iLocal_96);
	}
}
...
void func_366()
{
	...
	if (unk_0x765F6FEEFF39224F(unk_0x33CD235DF1E6A94E()))
	{
		if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
		{
			...
			if (unk_0x765F6FEEFF39224F(iVar0))
			{
				Local_56 = { unk_0xFBB1F99A825CAB09(iVar0, 1) };
			}
		}
	}
}
	...
	if (unk_0x002F527E1A3238DC(unk_0x95B959F18401C09A()) == 0)
	{
		if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
		{
			if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
			{
				...
				if (!iLocal_99 == 0)
				{
					if ((unk_0x91D5C8283D19AF49(iLocal_99, 0) && !unk_0x17260B4EA0652E1C(iLocal_99)) && !unk_0x95BBE5C8D52FE24B(iLocal_99))
					{
...
int func_371(int iParam0)
{
	...
	Var3 = { unk_0xFBB1F99A825CAB09(iLocal_99, 1) };
	if (iLocal_308[iParam0] == 0)
	{
		if (unk_0x541D5C57194E73C4(iLocal_99) == joaat("tyrant"))
		{
			iLocal_308[iParam0] = unk_0xBD1087ABD1970B9C(Var0, Var3, 0.1f, 511, iLocal_99, 3);
		}
		else if ((unk_0x541D5C57194E73C4(iLocal_99) == joaat("casco") || unk_0x541D5C57194E73C4(iLocal_99) == joaat("feltzer3")) || unk_0x541D5C57194E73C4(iLocal_99) == joaat("fagaloa"))
		{
			iLocal_308[iParam0] = unk_0xBD1087ABD1970B9C(Var0, Var3, 0.15f, 511, iLocal_99, 3);
		}
		else
		{
			iLocal_308[iParam0] = unk_0xBD1087ABD1970B9C(Var0, Var3, 0.25f, 511, iLocal_99, 3);
		}
	}
	else
	{
		switch (unk_0x819B6E76423AE494(iLocal_308[iParam0], &iVar6, &uVar7, &uVar10, &uVar13))
		{
			case 2:
...
void func_374()
{
	...
	if (!unk_0x117DAF3BF7232886(uLocal_102))
	{
		uLocal_102 = unk_0x00E62F31D05EB2AC("DEFAULT_SCRIPTED_CAMERA", 1);
	}
	if (!unk_0x117DAF3BF7232886(uLocal_103))
	{
		uLocal_103 = unk_0x00E62F31D05EB2AC("DEFAULT_SCRIPTED_CAMERA", 1);
	}
	func_375(&Var0, &Var7);
	unk_0xFA3130C046AC45A7(uLocal_102, Var0);
	unk_0x833A05A7AD82EA44(uLocal_102, Var0.f_3, 2);
	unk_0x63B608CD1957089E(uLocal_102, Var0.f_6);
	unk_0xFA3130C046AC45A7(uLocal_103, Var7);
	unk_0x833A05A7AD82EA44(uLocal_103, Var7.f_3, 2);
	unk_0x63B608CD1957089E(uLocal_103, Var7.f_6);
	unk_0x189377BFBDC9127F(uLocal_102, 1);
	unk_0x189377BFBDC9127F(uLocal_103, 0);
	unk_0x63F0B040CE6EDF0F(1, 0, 3000, 1, 0, 0);
}
...
bool func_378()
{
	return unk_0xB7A628320EFF8E47(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1), func_380()) < (func_379() * func_379());
}
...
void func_381()
{
	...
	if (func_369() && unk_0x10930B9CAD4111C2(iLocal_96, iLocal_99, 0))
	{
		if (unk_0x61DFE32FB87BC784(iLocal_99) && unk_0x156573D1AADB54ED(iLocal_99))
		{
			if ((func_388() && !func_378()) && !func_387())
			{
				...
				{
					uLocal_85 = unk_0x6E6EB18FDAB9A074(unk_0xFBB1F99A825CAB09(iLocal_99, 0), 40f, 40f, 40f, unk_0xC472E34C8FBEC678(iLocal_99), 0, 7);
					unk_0x3449EA232F9B8EAD(unk_0x95B959F18401C09A(), 0, 896);
					func_471(&iLocal_49, 2048);
					iLocal_100 = 0;
					unk_0x9315FCF6CFE2AB41("ProstituteInPlay", &uLocal_307);
					unk_0xD2E80177F27FD43F(1, uLocal_307, joaat("player"));
					unk_0x0648A75D3F60E864(iLocal_96, uLocal_307);
			...
			{
				if ((!unk_0x8B76D954998C9E96(unk_0x33CD235DF1E6A94E()) && func_7(&uLocal_107) > 15f) && func_384())
				{
...
void func_383()
{
	...
	if (!unk_0x8B76D954998C9E96(iLocal_96))
	{
		unk_0xAEED0213982928AC(iLocal_96, "HOOKER_SECLUDED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_385()
{
	if (func_539())
	{
		unk_0x5FEE418CE11E6DDE(iLocal_96, 229, 1);
		unk_0x5FEE418CE11E6DDE(iLocal_96, 26, 1);
		unk_0x5FEE418CE11E6DDE(iLocal_96, 115, 1);
		unk_0x4A852F02088ECC9D(iLocal_96, 1);
	}
}
...
void func_386()
{
	...
	{
		if (unk_0xE3903F59E2F22150() > iLocal_84)
		{
			if (iLocal_100 == 0)
			{
				Var0 = { unk_0xFBB1F99A825CAB09(iLocal_99, 1) };
				unk_0x8C1596BAD35D957A(Var0, &fVar6, 0, 0);
				Var0.f_2 = (fVar6 + 0.15f);
				Var3 = { unk_0x2CA911E7569D12EA(iLocal_99, 0f, 0f, -2f) };
				iLocal_100 = unk_0x0F79DCFDE3D6F778(Var0, Var3, 2f, 511, iLocal_99, 7);
			}
			else if (unk_0xE7F42E784C2E4682(iLocal_100, &iVar8, &uVar9, &uVar12, &iVar7, &uVar15) == 2)
			{
				if (iVar8 != 0)
				{
				...
				iLocal_84 = unk_0xE3903F59E2F22150() + 1500;
				iLocal_100 = 0;
			}
		}
	}
...
int func_388()
{
	...
	if (!unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0))
	{
		...
		if (unk_0x52C7F2CBE015C31D(Var1, func_59(0), 12f, 0) || unk_0x52C7F2CBE015C31D(Var1, func_59(1), 12f, 0))
		{
			return 0;
		}
		if (func_394())
		...
		if (func_393(iLocal_99, &Var4))
		{
			if (!func_392(Var4))
			{
				if (!func_391(Var1) || func_390(Var1))
				{
					return 0;
				}
			}
		}
		if (func_84(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1), (30f * 0.5f)))
		{
			return 0;
		}
		if (!unk_0x782B99DB55846C95(iLocal_96, iLocal_99, 0, 0, 0))
		{
			return 0;
		}
		unk_0x922453713201594A(1);
		if (unk_0x730FAC2C24A116EC(Var1, 20f, 1, 1, &iVar0, 0, 1, -1))
		{
			if (unk_0x765F6FEEFF39224F(iVar0))
			{
				if (!unk_0xD62C4419A41F106A(iVar0, 0))
				{
					if (unk_0x72F7FAFD0710100C(iVar0, iLocal_99, 17))
					{
						return 0;
					}
				}
...
int func_392(struct<3> Param0)
{
	...
	uVar0 = unk_0x8FE805A2903F1C0A(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 0), 1, 1, 1077936128, 0);
	unk_0x2119DC81E4EDBA78(uVar0, &Param0);
	if (unk_0xF9130D332492FAAF(uVar0))
	{
		if (!unk_0xB024BD7BA99751DA(uVar0))
		{
			if (unk_0xB7A628320EFF8E47(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 0), Param0) > 400f)
			{
				return 1;
			}
		}
		else if (unk_0xB7A628320EFF8E47(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 0), Param0) > 56.25f)
		{
			return 1;
		}
	}
	else if (!unk_0xB024BD7BA99751DA(uVar0))
	{
		if (unk_0xB7A628320EFF8E47(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 0), Param0) > 400f)
		{
			return 1;
	...
	{
		uVar0 = unk_0x8FE805A2903F1C0A(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 0), 1, 8, 1077936128, 0);
		unk_0x2119DC81E4EDBA78(uVar0, &Param0);
		if (unk_0xB7A628320EFF8E47(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 0), Param0) > 400f)
		{
			return 1;
...
int func_393(int iParam0, var uParam1)
{
	...
	Var0[0 /*3*/] = { unk_0x2CA911E7569D12EA(iParam0, 2f, 0f, 0f) };
	Var0[1 /*3*/] = { unk_0x2CA911E7569D12EA(iParam0, -2f, 0f, 0f) };
	Var0[2 /*3*/] = { unk_0x2CA911E7569D12EA(iParam0, 0f, 2f, 0f) };
	Var0[3 /*3*/] = { unk_0x2CA911E7569D12EA(iParam0, 0f, -2f, 0f) };
	if (unk_0x42FFEB8AC39C983D(Var0[0 /*3*/], uParam1, 1077936128, 0))
	{
		return 1;
	}
	else if (unk_0x42FFEB8AC39C983D(Var0[1 /*3*/], uParam1, 1077936128, 0))
	{
		return 1;
	}
	else if (unk_0x42FFEB8AC39C983D(Var0[2 /*3*/], uParam1, 1077936128, 0))
	{
		return 1;
	}
	else if (unk_0x42FFEB8AC39C983D(Var0[3 /*3*/], uParam1, 1077936128, 0))
	{
		return 1;
	}
	return 0;
...
void func_403()
{
	if (!unk_0xD62C4419A41F106A(iLocal_96, 0))
	{
		if (unk_0x335C0645074963FE(iLocal_96, unk_0x33CD235DF1E6A94E(), 5f, 5f, 5f, 0, 1, 0) || func_479(iLocal_49, 8192))
		{
			unk_0x3FD9339AA95E323F(0, 101, 1);
			unk_0x3FD9339AA95E323F(0, 74, 1);
			unk_0x144904D2EAA84341(0, 51);
			if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0) && unk_0xF0D230FB550CD6EB(iLocal_96, 0))
			{
				unk_0x3D258435016D9F74(iLocal_96, 50);
				unk_0x0F74B05FB8108F9C(iLocal_96, 5f);
				if (func_479(iLocal_49, 16))
				{
					if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
					{
				...
				if (unk_0x91D5C8283D19AF49(iLocal_99, 0))
				{
					if (unk_0xEE984ED4E4A374BE(iLocal_96, iLocal_99) && unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_99, 0))
					{
						...
						if (func_479(iLocal_49, 8))
						{
							if (unk_0xCDA107F8BEE35F40(func_86()))
							{
								...
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_RESTRICTED_PASSENGER"));
								}
								else if (func_416(iLocal_99))
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_RESTRICTED_NOAMBIENT_PASSENGER"));
								}
								else if (func_415(iLocal_99))
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_LOWRIDER_PASSENGER"));
								}
								else if (func_414(iLocal_99))
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_LOWRIDER2_PASSENGER"));
								}
								else if (func_413(iLocal_99))
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_INFERNUS2_PASSENGER"));
								}
								else if (func_412(iLocal_99))
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_SC1_PASSENGER"));
								}
								else if (func_411(iLocal_99))
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_TEZERACT_PASSENGER"));
								}
								else if (func_410(iLocal_99))
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_DOMINATOR3_PASSENGER"));
								}
								else if (func_409(iLocal_99))
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_ITALIGTO_PASSENGER"));
								}
								else if (func_408(iLocal_99))
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_RESTRICTED_SCHLAGEN_PASSENGER"));
								}
								else if (func_407(iLocal_99))
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_NEO_PASSENGER"));
								}
								else if (func_406(iLocal_99))
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_PEYOTE2_PASSENGER"));
								}
								else
								{
									unk_0xCA57931F89E1D249(iLocal_96, unk_0x36163153849DFDA1("MINI_PROSTITUTE_LOW_PASSENGER"));
								}
							}
						}
						if (func_539())
						{
							unk_0x0D21E1FDE062ED99(iLocal_96, 0, 0);
						}
						else
						{
							unk_0x0D21E1FDE062ED99(iLocal_96, 1, 1);
						}
						func_175(iLocal_96, 0);
						func_383();
						iLocal_64 = unk_0xE3903F59E2F22150();
			...
			{
				if ((func_405(iLocal_96, unk_0x33CD235DF1E6A94E(), 1) > 11f || func_404(20f)) || !unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_99, 0))
				{
					func_108(&uLocal_113);
					if (!unk_0xF0D230FB550CD6EB(iLocal_96, 0))
					{
						unk_0xED68CDDDE25A144E(iLocal_96);
						func_462(0);
				...
				if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
				{
					...
					else if (!unk_0x782B99DB55846C95(iLocal_96, iLocal_99, 0, 0, 0))
					{
						if (!func_105())
						{
...
void func_418(var uParam0)
{
	...
	if (func_114(&uLocal_113) >= 20f || !unk_0x335C0645074963FE(iLocal_96, unk_0x33CD235DF1E6A94E(), 3f, 3f, 3f, 0, 1, 0))
	{
		if (func_479(iLocal_75, 524288))
		{
			func_108(&uLocal_113);
	...
	func_63(iLocal_96);
	if (((unk_0x335C0645074963FE(iLocal_96, unk_0x33CD235DF1E6A94E(), 3f, 3f, 3f, 0, 1, 0) || func_479(iLocal_75, 1)) && !func_209(0)) && !func_394())
	{
		if (!unk_0x782B99DB55846C95(iLocal_96, iLocal_99, 0, 0, 0))
		{
			if (!func_105())
	...
	else if (func_459("PROS_ACCEPT"))
	{
		...
		if (func_539())
		{
			iVar0 = unk_0xD76D6BCC14B95CE1(iLocal_96, -2017877118);
			if (iVar0 != 1 && iVar0 != 0)
			{
				func_530();
				func_524(uParam0);
...
void func_419()
{
	...
	{
		func_422();
		if (func_420(iLocal_74, 1) || unk_0x1578197A616E70FA(unk_0x95B959F18401C09A()))
		{
		...
		if (func_479(iLocal_49, 8192))
		{
			...
			if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
			{
				if (unk_0xD76D6BCC14B95CE1(iLocal_96, -1794415470) != 1 && !unk_0x10930B9CAD4111C2(iLocal_96, unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), 1))
				{
					unk_0xC838CE9837D0ABAF(iLocal_96, iLocal_99, -1, 0, 1f, 8388609, 0);
				}
			}
			sLocal_63 = func_44(unk_0x33CD235DF1E6A94E(), 1, 0);
			unk_0x0483D0035D6E46FD(sLocal_63);
			sLocal_63 = func_44(unk_0x33CD235DF1E6A94E(), 0, 1);
			unk_0x0483D0035D6E46FD(sLocal_63);
			func_34(&uLocal_107);
			iLocal_295 = 5;
		}
...
int func_426()
{
	...
	if (!func_539())
	{
		...
		else if (func_479(iLocal_49, 4194304))
		{
			...
			unk_0x99414FB2D30425C1(&uVar1);
			unk_0x108754262311D34F(0, func_61(iLocal_293), func_60(5), 2f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0x108754262311D34F(0, func_61(iLocal_293), func_60(iVar0), 8f, -8f, -1, 1, 0, 0, 0, 0);
			unk_0xC734F59A13D39AEF(uVar1);
			unk_0x13A2D602CD10CBAC(iLocal_96, uVar1);
			unk_0xA7A57E7757ED035E(&uVar1);
		}
	...
	switch (iLocal_55)
	{
		...
		case 1:
			if (unk_0x0A81FE3D92AE2AC9(iLocal_96))
			{
				unk_0x108754262311D34F(iLocal_96, func_61(iLocal_293), func_60(5), 2f, -2f, -1, 0, 0, 0, 0, 0);
				iLocal_55 = 2;
			}
			else
			{
		...
		case 2:
			if (unk_0x0A81FE3D92AE2AC9(iLocal_96))
			{
				...
				{
					iVar0 = unk_0x9EC3B269A34A2BEE(8, 11);
					unk_0x108754262311D34F(iLocal_96, func_61(iLocal_293), func_60(iVar0), 8f, -8f, -1, 1, 0, 0, 0, 0);
					iLocal_55 = 3;
				}
			}
			else
...
int func_427(bool bParam0)
{
	...
	if (func_405(iLocal_96, unk_0x33CD235DF1E6A94E(), 1) > 11f)
	{
		return 0;
	}
	if (!unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	...
	if (func_84(unk_0xFBB1F99A825CAB09(iLocal_96, 1), 1106247680))
	{
	...
	if (!func_369())
	{
		if (!func_539())
		{
			if ((!iLocal_88 && !Global_105612) && func_429(unk_0x33CD235DF1E6A94E(), 0) == -1)
			{
				func_342("PROS_CAR", -1);
				iLocal_88 = 1;
			}
...
void func_428()
{
	...
	{
		if (!unk_0x8B76D954998C9E96(unk_0x33CD235DF1E6A94E()) && !unk_0x8B76D954998C9E96(iLocal_96))
		{
...
void func_430()
{
	...
	{
		func_419();
		if (unk_0xD76D6BCC14B95CE1(iLocal_96, 242628503) == 7 && !func_479(iLocal_49, 8192))
		{
			if (func_66(1))
			{
				func_108(&uLocal_113);
...
void func_432(var uParam0)
{
	...
	unk_0xFEF5F9BB57EA2E8D(unk_0x541D5C57194E73C4(iLocal_99), &Var6, &Var3);
	Var0 = { Var3 - Var6 };
	Var0 = { Var0 / Vector(2f, 2f, 2f) };
	Var9 = { unk_0x2CA911E7569D12EA(iLocal_99, -(Var0.f_0 + 0.2f), 0f, 0f) };
	Var12 = { unk_0x2CA911E7569D12EA(iLocal_99, (Var0.f_0 + 0.2f), 0f, 0f) };
	Var15 = { unk_0xFBB1F99A825CAB09(iLocal_96, 1) };
	if (unk_0x2A488C176D52CCA5(Var15, Var12) < unk_0x2A488C176D52CCA5(Var15, Var9))
	{
		Var9 = { Var12 };
	}
	if ((unk_0xD76D6BCC14B95CE1(iLocal_96, -1794415470) != 1 || !func_479(iLocal_49, 8192)) && unk_0xB7A628320EFF8E47(Local_93, Var9) > 0f)
	{
		if (func_539())
		{
			if (!unk_0x5A04E3BD0B5E7E49(iLocal_96))
			{
				unk_0x0D21E1FDE062ED99(iLocal_96, 0, 1);
			}
			func_442(&uLocal_287, func_61(iLocal_293));
			func_436(uParam0, 1);
			func_433(&uLocal_287, uParam0);
		}
		unk_0x99414FB2D30425C1(&uVar18);
		unk_0x7E268975AF5EA74F(0, Var9.f_0, Var9.f_1, Var9.f_2, 1f, -1, 1f, 8192, 1193033728);
		unk_0x9F878FE3F23E2C8B(0, unk_0x61B226C460A8FCC2(unk_0x33CD235DF1E6A94E(), 31086, 0f, 0f, 0f), 0);
		unk_0xC734F59A13D39AEF(uVar18);
		unk_0x13A2D602CD10CBAC(iLocal_96, uVar18);
		unk_0xA7A57E7757ED035E(&uVar18);
		Local_93 = { Var9 };
	}
}
	...
	if (func_427(1))
	{
		...
		if (func_460(&uLocal_113, 2f) || func_479(iLocal_49, 8192))
		{
			...
			if (func_355(&sVar0, 0))
			{
				...
				unk_0xC4A347124F39D998(unk_0x33CD235DF1E6A94E(), iLocal_96, -1, 2048, 4);
				func_432(uParam0);
				func_471(&iLocal_49, 4);
				Global_25915 = 1;
				Global_2424047[unk_0x95B959F18401C09A() /*416*/].f_406 = 1;
...
int func_474()
{
	...
	iLocal_98 = unk_0x5E65439BE0A05829(unk_0xFBB1F99A825CAB09(iLocal_96, 1), 15f, 0, 6);
	if (unk_0x765F6FEEFF39224F(iLocal_98) && !unk_0xD62C4419A41F106A(iLocal_98, 0))
	{
		if (unk_0x91D5C8283D19AF49(iLocal_98, 0))
		{
			if (func_85(&iLocal_98))
			{
				iLocal_97 = unk_0x7BDC41A7CA0C77A2(iLocal_98, -1, 0);
				if (!iLocal_97 == 0)
				{
					if (func_475(&iLocal_97))
					{
						iVar0 = unk_0x541D5C57194E73C4(iLocal_98);
						if (!iVar0 == joaat("taxi") && !iVar0 == joaat("taxi"))
						{
							if (!unk_0x5A04E3BD0B5E7E49(iLocal_97))
							{
								unk_0x0D21E1FDE062ED99(iLocal_97, 1, 0);
							}
							if (!unk_0x5A04E3BD0B5E7E49(iLocal_98))
							{
								unk_0x0D21E1FDE062ED99(iLocal_98, 1, 0);
							}
							unk_0x4A852F02088ECC9D(iLocal_97, 1);
							unk_0x43D47AD82DA3C6EC(iLocal_97, 0, 1);
							unk_0x43D47AD82DA3C6EC(iLocal_98, 0, 1);
							return 1;
						}
					}
				}
...
int func_476()
{
	if (unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0) || unk_0xD62C4419A41F106A(iLocal_96, 0))
	{
		return 0;
	}
	return 1;
...
void func_478()
{
	if (!unk_0xD62C4419A41F106A(iLocal_96, 0))
	{
		if (!unk_0xD82CBCB7E04DDA8A(iLocal_96))
		{
			if (unk_0xD76D6BCC14B95CE1(iLocal_96, 1805844857) != 1)
			{
				unk_0x4A852F02088ECC9D(iLocal_96, 0);
				unk_0x33F6BE48E356DA27(iLocal_96, 196628, 1);
				unk_0x07CA8FF5BA390419(iLocal_96);
				unk_0xECCD4FDA45197F97(iLocal_96, unk_0x33CD235DF1E6A94E(), 300f, -1, 1, 0);
				unk_0x897EF720254BBEA3(iLocal_96, 1);
				func_89(15);
			}
		}
	}
...
int func_481()
{
	...
	if (unk_0xD76D6BCC14B95CE1(iLocal_96, 1435919172) == 1)
	{
		return 0;
	}
	if (unk_0x5896FA9B8FD8B022(iLocal_96))
	{
		return 0;
	}
	return 1;
	...
	switch (iLocal_300)
	{
		...
		case 3:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_96))
			{
				...
				{
					unk_0x4A852F02088ECC9D(iLocal_96, 0);
					unk_0x6EE33B67DCAC6DB1(iLocal_96, 0);
				...
				else
				{
					...
					func_458(&uLocal_122, 4, iLocal_96, "Prostitutes", 0, 1);
					unk_0x6EE33B67DCAC6DB1(iLocal_96, 0);
					unk_0x3E2A39F699947160(iLocal_96);
					return 1;
				}
			}
			break;
...
int func_486(int iParam0, char* sParam1, var uParam2)
{
	if (unk_0x0E4018692D92041D(uParam0, 30))
	{
...
int func_487()
{
	if (unk_0x71EC91BA8C88BCE0())
	{
		if (func_18() == 0)
		{
			...
			{
				if (!unk_0x9E08E12414BD4476(iLocal_96, 1))
				{
					if (func_539())
					{
						unk_0x0D21E1FDE062ED99(iLocal_96, 0, 0);
...
int func_489()
{
	if (unk_0x37FBF97457299644(iLocal_96, func_59(0)))
	{
		if (unk_0xBFE245904B30A6ED(iLocal_96, "amb@world_human_prostitute@crackhooker@base", "base"))
		{
			return 0;
		}
		if (unk_0xBFE245904B30A6ED(iLocal_96, "amb@world_human_prostitute@cokehead@base", "base"))
		{
			return 1;
		}
	}
	if (unk_0x37FBF97457299644(iLocal_96, func_59(1)))
	{
		if (unk_0xBFE245904B30A6ED(iLocal_96, "amb@world_human_prostitute@french@base", "base"))
		{
			return 3;
		}
		if (unk_0xBFE245904B30A6ED(iLocal_96, "amb@world_human_prostitute@hooker@base", "base"))
		{
			return 2;
		}
	}
...
void func_491(int iParam0)
{
	...
	{
		if (!unk_0xFB2C4D32FED130AB(iLocal_96, iParam0))
		{
			if (func_539())
			{
				if (unk_0x0A81FE3D92AE2AC9(iLocal_96))
				{
					unk_0xE0DAC4ABE9900D9A(iLocal_96);
					unk_0xC4A347124F39D998(iLocal_96, iParam0, -1, 2048, 4);
				}
			}
			else
			{
	...
	else if (unk_0xFB2C4D32FED130AB(iLocal_96, iParam0))
	{
		if (func_539())
		{
			if (unk_0x0A81FE3D92AE2AC9(iLocal_96))
...
void func_492()
{
	if (Global_25915)
	{
		if (unk_0x91D5C8283D19AF49(iLocal_99, 0))
		{
			if (unk_0x10930B9CAD4111C2(iLocal_96, iLocal_99, 0))
			{
				func_493();
			}
		}
	...
	if (unk_0xD62C4419A41F106A(iLocal_96, 0) || !unk_0x765F6FEEFF39224F(iLocal_96))
	{
	...
	if ((unk_0xB7A628320EFF8E47(unk_0xFBB1F99A825CAB09(iLocal_96, 1), unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1)) < Global_25918 || Global_25918 == 0f) && iLocal_296 != 4)
	{
		Global_25918 = unk_0xB7A628320EFF8E47(unk_0xFBB1F99A825CAB09(iLocal_96, 1), unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1));
...
void func_493()
{
	if (func_539())
	{
		if (unk_0x0A81FE3D92AE2AC9(iLocal_96))
		{
			unk_0x41E36A540F8F323F(iLocal_96, 323, 1);
		}
	}
	else
	{
...
void func_494(var uParam0)
{
	if (!iLocal_295 == 12)
	{
		if (!unk_0xD62C4419A41F106A(iLocal_96, 0) && !unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0))
		{
			if (func_498())
			{
				if (func_539())
				{
					...
					if (!unk_0x5A04E3BD0B5E7E49(iLocal_96))
					{
						unk_0x0D21E1FDE062ED99(iLocal_96, 1, 0);
					}
					unk_0xECCD4FDA45197F97(iLocal_96, unk_0x33CD235DF1E6A94E(), 300f, -1, 0, 0);
					unk_0x897EF720254BBEA3(iLocal_96, 1);
					unk_0xED68CDDDE25A144E(unk_0x33CD235DF1E6A94E());
					func_530();
					func_524(uParam0);
			...
			else if (unk_0x91BBD269506D61D2(iLocal_96, unk_0x33CD235DF1E6A94E(), 1))
			{
				iLocal_67++;
				if (iLocal_67 >= 2)
				{
				...
				else
				{
					...
					unk_0x0D847D71D9E6142E(iLocal_96);
				}
			}
			else if (func_496())
			{
...
void func_495()
{
	...
	unk_0x2918FC6BDEBF9834(iLocal_96);
	unk_0xAEED0213982928AC(iLocal_96, "APOLOGY_NO_TROUBLE", "SPEECH_PARAMS_FORCE_SHOUTED_CRITICAL", 1);
}
...
int func_498()
{
	...
	if (!func_479(iLocal_49, 4096))
	{
		if (func_405(iLocal_96, unk_0x33CD235DF1E6A94E(), 1) < 30f)
		{
			Var0 = { unk_0xFBB1F99A825CAB09(iLocal_96, 1) };
			if ((((((unk_0x8BBA6285E98709A6(86, Var0, 30f) || unk_0x8BBA6285E98709A6(89, Var0, 30f)) || unk_0x8BBA6285E98709A6(88, Var0, 30f)) || unk_0x8BBA6285E98709A6(102, Var0, 30f)) || unk_0x8BBA6285E98709A6(114, Var0, 30f)) || (unk_0x8BBA6285E98709A6(112, Var0, 30f) && !func_539())) || unk_0x5DACF31D3AC5ED8D(unk_0x33CD235DF1E6A94E()))
			{
				if (!func_539())
				{
					unk_0x4A852F02088ECC9D(iLocal_96, 0);
...
int func_499()
{
	if ((unk_0x765F6FEEFF39224F(iLocal_96) && !unk_0xD62C4419A41F106A(iLocal_96, 0)) && !unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0))
	{
		if (func_539())
		{
		...
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_96))
		{
			if (!unk_0xF0D230FB550CD6EB(iLocal_96, 0))
			{
				if (!func_501(9))
				{
					if (!unk_0xD62C4419A41F106A(iLocal_96, 0) && !unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0))
					{
						if (unk_0x335C0645074963FE(iLocal_96, unk_0x33CD235DF1E6A94E(), 100f, 100f, 50f, 0, 1, 0))
						{
							return 1;
						}
						else
...
void func_515(var uParam0, char* sParam1, int iParam2)
{
	if (unk_0x0E4018692D92041D(*uParam0, 30))
	{
...
void func_524(var uParam0)
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_96))
	{
		if (unk_0x5A04E3BD0B5E7E49(iLocal_96))
		{
			if ((func_539() && unk_0xD76D6BCC14B95CE1(iLocal_96, 1805844857) != 1) && unk_0xD76D6BCC14B95CE1(iLocal_96, -251125078) != 1)
			{
				unk_0xBD4591245C650283(iLocal_96, 1193033728, 0);
				if (unk_0x0A81FE3D92AE2AC9(iLocal_96))
				{
				...
				if (unk_0x462247B843778DF4(iLocal_96))
				{
					unk_0x1F45B4626AC4A4C0(&iLocal_96);
				}
				unk_0x2918FC6BDEBF9834(iLocal_96);
			}
			else
	...
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_97))
	{
		unk_0xED68CDDDE25A144E(iLocal_97);
	}
	iLocal_97 = 0;
	iLocal_296 = 0;
	...
	if (func_539())
	{
		if (unk_0xB0D69EC116526983(uLocal_85))
		{
			unk_0xF4BF002874250DB7(uLocal_85);
		}
	}
	iLocal_98 = 0;
	func_528();
	...
	if (!unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0))
	{
		if (func_512(256))
		{
			unk_0x93AA93DA1B137032(unk_0x33CD235DF1E6A94E(), 6, iLocal_86, iLocal_87, 0);
			func_189(1024);
		}
	}
...
void func_529(bool bParam0)
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_96))
	{
		if (unk_0xF0D230FB550CD6EB(iLocal_96, 0))
		{
			if (unk_0xD76D6BCC14B95CE1(iLocal_96, -828834893) != 1)
			{
				unk_0x07C339D4328CA16C(iLocal_96, 0, 65536);
			}
		}
		if (bParam0)
		{
...
void func_530()
{
	...
	if (!unk_0xD62C4419A41F106A(iLocal_96, 0))
	{
		...
		unk_0xA6E32819044BBB6A(iLocal_96, 0);
	}
	if (unk_0x91D5C8283D19AF49(iLocal_99, 0) && !unk_0xD62C4419A41F106A(iLocal_99, 0))
	{
		if (func_539())
		{
			if (unk_0x0A81FE3D92AE2AC9(iLocal_99))
			{
				...
				{
					unk_0x2EE596932F00971D(iLocal_99, 0);
					unk_0x26E0FFDB1AD22AC5(iLocal_99, 3);
					unk_0x3F99D2373794B210(iLocal_99, 0);
				}
				unk_0x1C2B995BA5ADE8FF(iLocal_99, 1, 0);
			}
		}
		else
		{
	...
	if (func_539())
	{
		if (func_512(2))
		{
			...
			else if (unk_0x0371ECBEC27AF4BE(iLocal_99))
			{
				if (unk_0x0A81FE3D92AE2AC9(iLocal_99))
				{
					unk_0xD303E20CB0AE4AD0(iLocal_99, 1);
					unk_0x9D933DC08CBBEC60(iLocal_99, 0);
					unk_0x0EF4CE307751DE06(iLocal_99, 0);
				}
				else
				{
					unk_0xA5F44EC021F96C6B(iLocal_99);
					unk_0xD303E20CB0AE4AD0(iLocal_99, 1);
					unk_0x9D933DC08CBBEC60(iLocal_99, 0);
					unk_0x0EF4CE307751DE06(iLocal_99, 0);
				}
...
int func_535(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if ((!unk_0x148E92E2B2454BC6() && (unk_0x8553BFC970AE2EC8() || !unk_0xA71A137E08393E8F())) && unk_0xD56CD7C03ECC9CF7())
	{
		...
		if (iParam4 == -1)
		{
			...
			{
				Var69 = { func_311(unk_0x95B959F18401C09A()) };
...
int func_541(int iParam0, int iParam1)
{
	...
	if (func_201(iParam0, 1, 1))
	{
		...
		{
			uVar3 = unk_0xF2C96862595654B4(iVar0, 0);
			iVar1 = 0;
			while (iVar1 < 32)
			{
				uVar2 = unk_0x7C1C88877E8AAA50(iVar1);
				if (func_201(uVar2, 1, 1))
				{
					if (unk_0x378BD4B3881338C2(uVar2) != iVar0)
					{
						if (unk_0x10930B9CAD4111C2(unk_0x378BD4B3881338C2(iVar2), uVar3, iParam1))
						{
							return 1;
						}
					}
