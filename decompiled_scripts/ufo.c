...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			case 0:
				if (unk_0xDA870B7547A455EA() == 3 && func_9())
				{
					iLocal_18 = 1;
				}
				break;
			...
			case 1:
				func_1(152, 1, 0, 1, 0);
				iLocal_18 = 2;
				if (!unk_0xBB89DDBE1CC74BAF("AZ_SPECIAL_UFO_03"))
				{
					unk_0x1031C3D17FE9BFDA("AZ_SPECIAL_UFO_03", 1, 1);
				}
				break;
...
void func_10()
{
	...
	if (unk_0xBB89DDBE1CC74BAF("AZ_SPECIAL_UFO_03"))
	{
		unk_0x1031C3D17FE9BFDA("AZ_SPECIAL_UFO_03", 0, 1);
	}
