...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			case 0:
				if (unk_0xE76C684D1C903A71() == 3 && func_8())
				{
					iLocal_17 = 1;
				}
				break;
			...
			case 1:
				func_1(152, 1, 0, 1, 0);
				iLocal_17 = 2;
				if (!unk_0x5E8D1C4D53630349("AZ_SPECIAL_UFO_03"))
				{
					unk_0x29DEF50C16608986("AZ_SPECIAL_UFO_03", 1, 1);
				}
				break;
...
void func_9()
{
	...
	if (unk_0x5E8D1C4D53630349("AZ_SPECIAL_UFO_03"))
	{
		unk_0x29DEF50C16608986("AZ_SPECIAL_UFO_03", 0, 1);
	}
