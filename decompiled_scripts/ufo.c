...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			case 0:
				if (unk_0x7C833E3C6EEE41E0() == 3 && func_9())
				{
					iLocal_18 = 1;
				}
				break;
			...
			case 1:
				func_1(152, 1, 0, 1, 0);
				iLocal_18 = 2;
				if (!unk_0xB1D7D3F77C6AF72F("AZ_SPECIAL_UFO_03"))
				{
					unk_0x1761C911FBAC0859("AZ_SPECIAL_UFO_03", 1, 1);
				}
				break;
...
void func_10()
{
	...
	if (unk_0xB1D7D3F77C6AF72F("AZ_SPECIAL_UFO_03"))
	{
		unk_0x1761C911FBAC0859("AZ_SPECIAL_UFO_03", 0, 1);
	}
