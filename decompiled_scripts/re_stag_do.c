...
void __EntryFunction__()
{
	...
	if (unk_0xED06FD5709A59F02(11))
	{
		...
		{
			if (unk_0x7DA97DBB7F7D2DE5(iLocal_55))
			{
				unk_0x59478CBBF96AF7D1(iLocal_55);
			}
		}
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57))
		{
			if (unk_0x7DA97DBB7F7D2DE5(iLocal_57))
			{
				unk_0x59478CBBF96AF7D1(iLocal_57);
			}
		}
		func_183();
	}
	...
	while (true)
	{
		...
		if (unk_0x1116855A2A7A342C() || bLocal_116)
		{
			if (!func_149())
			{
				if (func_148())
			...
			switch (iLocal_48)
			{
				...
				case 1:
					...
					if (!iLocal_114)
					{
						...
						func_122();
						func_111();
						if (!unk_0xFC5D6FB6EECB392F(uLocal_318))
						{
							func_110();
						}
					}
					else
					{
						...
						if (iLocal_49 == 3)
						{
							if (unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_87, 1) < 100f)
							{
								...
								if (unk_0xFFDFD8490027DBA5())
								{
									...
									{
										if ((((!unk_0x5AEB5DDFFAD43CA5(iLocal_55) && !unk_0x5AEB5DDFFAD43CA5(iLocal_57)) && !unk_0x5AEB5DDFFAD43CA5(iLocal_56)) && !unk_0x5AEB5DDFFAD43CA5(iLocal_58)) && !unk_0xA59F96B50B97E63C(iLocal_132, 0))
										{
											unk_0x18309CE9F0E2CADF("Groom", iLocal_55, 0);
											unk_0x18309CE9F0E2CADF("Groomsman", iLocal_57, 0);
											unk_0x18309CE9F0E2CADF("Bride", iLocal_56, 0);
											unk_0x18309CE9F0E2CADF("Father_of_the_bride", iLocal_58, 0);
										}
									}
								}
							}
							...
							{
								if (unk_0x47DBF174A0CB9D55(iLocal_57, 0))
								{
									if (unk_0x8F678487EEBD8CE4(uLocal_322))
									{
										unk_0x93370FA10F15BE44(&uLocal_322);
										if (unk_0x8F678487EEBD8CE4(uLocal_320))
										{
											unk_0x93370FA10F15BE44(&uLocal_320);
										}
										if (!unk_0x8F678487EEBD8CE4(uLocal_320))
										{
						...
						if (func_3())
						{
							if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
							{
								unk_0x8B18A80E8EB15510(iLocal_55, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, 0, 0);
							}
							if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57))
							{
								unk_0x8B18A80E8EB15510(iLocal_57, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, 0, 0);
							}
							if (!unk_0x5AEB5DDFFAD43CA5(iLocal_56))
							{
								unk_0x8B18A80E8EB15510(iLocal_56, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, 0, 0);
							}
							if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
							{
								unk_0x8B18A80E8EB15510(iLocal_58, unk_0x9B0761B4C3EB8BC7(), 1000f, -1, 0, 0);
							}
							func_2();
						}
					}
...
int func_3()
{
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		{
			if (unk_0xCDF860E56BBCC6B4(iLocal_55, unk_0x9B0761B4C3EB8BC7(), 1) || unk_0xE72C9284B5143451(iLocal_55))
			{
				return 1;
			}
			if (bLocal_116)
	...
	if (!unk_0xA59F96B50B97E63C(iLocal_59, 0))
	{
		if ((!unk_0x80FF6C016CDB0FAF(iLocal_59, 0) || unk_0x1ADEE74BA60EE218(iLocal_59)) || unk_0xE72C9284B5143451(iLocal_59))
		{
			func_27();
		...
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			{
				if (unk_0xBA9474B1995C6AAD(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), iLocal_59))
				{
					func_27();
					if (func_4(&uLocal_136, "stagdau", "stagdwrcar", 4, 0, 0, 0))
					{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
	{
		if (!unk_0x910DFF8E55ABB8EC(iLocal_55, unk_0x9B0761B4C3EB8BC7(), 150f, 150f, 150f, 0, 1, 0))
		{
			if (!unk_0xA59F96B50B97E63C(iLocal_59, 0))
			{
				if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_59, 0))
				{
	...
	if (iLocal_49 >= 1)
	{
		if (bLocal_123)
		{
			...
			else if (unk_0xCDF860E56BBCC6B4(iLocal_57, unk_0x9B0761B4C3EB8BC7(), 1))
			{
				func_27();
				return 1;
			}
		...
		if (!unk_0xA59F96B50B97E63C(iLocal_59, 0))
		{
			if (!unk_0x910DFF8E55ABB8EC(iLocal_59, unk_0x9B0761B4C3EB8BC7(), 20f, 20f, 20f, 0, 1, 0))
			{
				if (!iLocal_126)
				{
					func_27();
			...
			if (!unk_0x910DFF8E55ABB8EC(iLocal_59, unk_0x9B0761B4C3EB8BC7(), 150f, 150f, 150f, 0, 1, 0))
			{
				return 1;
			}
		}
	...
	if (iLocal_49 == 3)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
		{
			if (unk_0x5AEB5DDFFAD43CA5(iLocal_56) || unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				return 1;
			}
			else if (unk_0xCDF860E56BBCC6B4(iLocal_56, unk_0x9B0761B4C3EB8BC7(), 1) || unk_0xCDF860E56BBCC6B4(iLocal_58, unk_0x9B0761B4C3EB8BC7(), 1))
			{
				return 1;
			}
		}
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57))
		{
			if (!unk_0x910DFF8E55ABB8EC(iLocal_57, unk_0x9B0761B4C3EB8BC7(), 20f, 20f, 20f, 0, 1, 0) && iLocal_310)
			{
				if (!iLocal_127)
				{
					func_27();
			...
			if (!unk_0x910DFF8E55ABB8EC(iLocal_57, unk_0x9B0761B4C3EB8BC7(), 150f, 150f, 150f, 0, 1, 0))
			{
				return 1;
			}
		}
...
var func_29(struct<3> Param0, int iParam3)
{
	...
	unk_0xFA81E0FBD7F5ACA0(uVar0, func_30(unk_0x25DDB354A40FFCDB(), 1f, 1f));
	...
	switch (iLocal_131)
	{
		...
		case 2:
			if ((((!unk_0x5AEB5DDFFAD43CA5(iLocal_55) && !unk_0x5AEB5DDFFAD43CA5(iLocal_57)) && !unk_0x5AEB5DDFFAD43CA5(iLocal_56)) && !unk_0x5AEB5DDFFAD43CA5(iLocal_58)) && !unk_0xA59F96B50B97E63C(iLocal_132, 0))
			{
				if (func_57())
				{
					unk_0xFA3AB7AE2A01375E(iLocal_132, "SDRM_Car", 0, 0, 0);
					unk_0xFA3AB7AE2A01375E(iLocal_55, "Groom", 0, 0, 0);
					unk_0xFA3AB7AE2A01375E(iLocal_57, "Groomsman", 0, 0, 0);
					unk_0xFA3AB7AE2A01375E(iLocal_56, "Bride", 0, 0, 0);
					unk_0xFA3AB7AE2A01375E(iLocal_58, "Father_of_the_bride", 0, 0, 0);
		...
		case 3:
			...
			{
				if (!unk_0xA59F96B50B97E63C(iLocal_132, 0))
				{
					unk_0xB11D151E210D4FAC(iLocal_132, 1084227584);
					unk_0xFC34FFD7661206B7(iLocal_132, 1);
		...
		case 4:
			unk_0x586DDC617E714637(&iLocal_55);
			unk_0x586DDC617E714637(&iLocal_57);
			unk_0x586DDC617E714637(&iLocal_56);
...
void func_39()
{
	...
	{
		func_41(13, unk_0xF34EE736CF047844(Global_111858.f_10190.f_3853));
	}
...
void func_67()
{
	if (!unk_0xA59F96B50B97E63C(iLocal_59, 0) && !unk_0xA59F96B50B97E63C(iLocal_55, 0))
	{
		if (!iLocal_117)
		{
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_59, 0) && unk_0xE0B3BC41DDA88DF0(iLocal_55, iLocal_59, 0))
			{
				iLocal_117 = 1;
				if (unk_0x8F678487EEBD8CE4(uLocal_319))
				{
					unk_0x93370FA10F15BE44(&uLocal_319);
				}
		...
		if (!iLocal_117 && !iLocal_119)
		{
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_59, 0))
			{
				if (!unk_0xE0B3BC41DDA88DF0(iLocal_55, iLocal_59, 0))
				{
					if (!func_71())
					{
					}
					...
					if (!unk_0x8F678487EEBD8CE4(uLocal_319))
					{
						...
						unk_0x3060C53EAE54BBE7(uLocal_319, 1);
					}
					iLocal_117 = 0;
					iLocal_119 = 1;
				}
...
int func_69(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xFA81E0FBD7F5ACA0(uVar0, func_30(unk_0x25DDB354A40FFCDB(), 0.7f, 0.7f));
		unk_0x3060C53EAE54BBE7(uVar0, bParam1);
	}
...
void func_72()
{
	if (unk_0xAE06B9E39EBDE049(iLocal_55))
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
		{
			if (unk_0x910DFF8E55ABB8EC(iLocal_55, unk_0x9B0761B4C3EB8BC7(), 4f, 4f, 4f, 0, 1, 0))
			{
				if ((!unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) && !unk_0x47DBF174A0CB9D55(iLocal_55, 0)) || unk_0x07404C7FE024EC4F(unk_0x9B0761B4C3EB8BC7()))
				{
					if (unk_0x8F678487EEBD8CE4(uLocal_321))
					{
						unk_0x93370FA10F15BE44(&uLocal_321);
						if (!unk_0x8F678487EEBD8CE4(uLocal_320))
						{
							uLocal_320 = func_29(Local_67, 1);
						}
				...
				else if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) && unk_0x47DBF174A0CB9D55(iLocal_55, 0))
				{
					if (unk_0x8F678487EEBD8CE4(uLocal_321))
					{
						unk_0x93370FA10F15BE44(&uLocal_321);
				...
				else if (unk_0x8F678487EEBD8CE4(uLocal_320))
				{
					unk_0x93370FA10F15BE44(&uLocal_320);
					if (!unk_0x8F678487EEBD8CE4(uLocal_321))
					{
			...
			if (!unk_0x7DA97DBB7F7D2DE5(iLocal_55))
			{
				if (!unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_55, 10f, 10f, 10f, 0, 1, 0))
				{
					unk_0x9B94F6169B0DAEFD(iLocal_55);
					unk_0xE19B69814D61BBA5(iLocal_55, func_73());
					unk_0x10162EF76529C10F(iLocal_55, 1);
					unk_0xF5230D38AD1D873D(iLocal_55, 0);
				}
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 1))
		{
			if (!func_77())
			{
				...
				if (unk_0x16BC17A8EDC701A2(iLocal_55, 1227113341) != 1 && unk_0x16BC17A8EDC701A2(iLocal_55, 1227113341) != 0)
				{
					unk_0xE021DCE1063D5DC2(iLocal_55, unk_0x9B0761B4C3EB8BC7(), -1, 6f, 1073741824, 1073741824, 0);
				}
				if (unk_0x47DBF174A0CB9D55(iLocal_55, 0))
				{
					unk_0x0AB756271BADC8DF(iLocal_55, 0, 0);
				}
				if (!iLocal_125)
				{
					if (!func_71())
			...
			{
				iLocal_125 = 0;
				if (((unk_0x16BC17A8EDC701A2(iLocal_55, 1227113341) == 1 || unk_0x16BC17A8EDC701A2(iLocal_55, 1227113341) == 0) || unk_0x16BC17A8EDC701A2(iLocal_55, 242628503) == 1) || unk_0x16BC17A8EDC701A2(iLocal_55, 242628503) == 0)
				{
					unk_0x9B94F6169B0DAEFD(iLocal_55);
					if (!unk_0x7DA97DBB7F7D2DE5(iLocal_55))
					{
		...
		else if (((!unk_0x7DA97DBB7F7D2DE5(iLocal_55) && !unk_0x47DBF174A0CB9D55(iLocal_55, 0)) && unk_0x16BC17A8EDC701A2(iLocal_55, 242628503) != 1) && unk_0x16BC17A8EDC701A2(iLocal_55, 242628503) != 0)
		{
			unk_0xE19B69814D61BBA5(iLocal_55, func_73());
			unk_0x10162EF76529C10F(iLocal_55, 1);
			unk_0xF5230D38AD1D873D(iLocal_55, 0);
...
void func_78(int iParam0, bool bParam1)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iParam0))
	{
		...
		if (bParam1)
		{
			...
			{
				if (unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0) == unk_0xA5D5B1042E8F47BD(iParam0, 0))
				{
					bVar0 = true;
				}
			}
...
void func_79()
{
	if (unk_0xAE06B9E39EBDE049(iLocal_55))
	{
		if (!unk_0xA59F96B50B97E63C(iLocal_55, 0) && !unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			if (func_93("stagd_chape_3"))
			{
				...
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
				{
					if (unk_0x47DBF174A0CB9D55(iLocal_55, 0))
					{
						unk_0x9DC06E2A59C5AEBB(&uLocal_113);
						unk_0xE2348E4036041923(0);
						unk_0xC02F1FF16ABCEA26(0, 30600);
						unk_0x19F29730874AD6F1(uLocal_113);
						unk_0x9B6EC2CECE1010EF(iLocal_55, uLocal_113);
						unk_0x4F83FEE4454169D4(&uLocal_113);
					}
				}
			}
			if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_55, 13.5f, 13.5f, 13.5f, 0, 1, 0) && unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				if (unk_0xE0B3BC41DDA88DF0(iLocal_55, unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), 0))
				{
					if (iLocal_49 == 0)
					{
					...
					if (!bLocal_124)
					{
						...
						if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_87, 150f, 150f, 150f, 0, 1, 0))
						{
							if (iLocal_303 == 0)
							{
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_87(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_95()
{
	...
	if (unk_0xAE06B9E39EBDE049(iLocal_55))
	{
		if (!unk_0xA59F96B50B97E63C(iLocal_55, 0))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
			{
				if (!iLocal_129 && bLocal_118)
				{
					...
					if (unk_0x1037B9D45CE6B788(iLocal_55, -2002.008f, 455.58f, 101.0381f, -2009.761f, 453.2027f, 105.9135f, 12.4375f, 0, 1, 0) || unk_0x83666F9FB8FEBD4B() > 5000)
					{
						iLocal_129 = 1;
						...
						uLocal_134 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -2014.228f, 456.4961f, 103.5524f, -6.509435f, -0.037031f, -95.98762f, 29.00143f, 0, 2);
						uLocal_135 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -2014.334f, 456.418f, 103.3152f, -6.198685f, -0.037031f, -100.5736f, 29.00143f, 0, 2);
						unk_0x2311A669433389E8(uLocal_134, "HAND_SHAKE", 0.25f);
						unk_0x2311A669433389E8(uLocal_135, "HAND_SHAKE", 0.25f);
						unk_0x856549C07003344B(uLocal_134, 1);
						unk_0x3ED9330214992278(1, 0, 3000, 1, 0, 0);
						unk_0x4EDE34FBADD967A6(1000);
						unk_0xF674D9B2033F5F86(uLocal_135, uLocal_134, 4000, 1, 1);
						unk_0x3ED9330214992278(1, 0, 3000, 1, 0, 0);
						unk_0xF27E737981AFB47D(Local_99, 10f, 0, 0, 0, 0, 0, 0);
						if (!unk_0xA59F96B50B97E63C(unk_0xA5D3CD332CD10EE9(), 0))
						{
							unk_0xAD0FA680B43B80A4(unk_0xA5D3CD332CD10EE9());
							if (unk_0xC2169C00B643278B(unk_0xA5D3CD332CD10EE9(), Local_99, 8f, 8f, 8f, 0, 1, 0))
							{
								iLocal_133 = unk_0xA5D3CD332CD10EE9();
								unk_0x4F3C4F457D44BB0F(iLocal_133, 1, 0);
								unk_0x03A2522C845CFAC6(&iLocal_133);
							}
						}
						if (!unk_0xA59F96B50B97E63C(iLocal_59, 0))
						{
							unk_0x5DC21979EC6C531F(iLocal_59, 1);
							if (!unk_0x8F678487EEBD8CE4(uLocal_319))
							{
								uLocal_319 = func_68(iLocal_59, 0, 0);
								unk_0x3060C53EAE54BBE7(uLocal_319, true);
							}
						}
						iLocal_117 = 0;
					}
				}
				if (iLocal_129 && unk_0x40397A9A17EEC1C5(uLocal_134))
				{
					...
					if (unk_0x83666F9FB8FEBD4B() > 6000)
					{
						...
						unk_0x8CFF639CEFF5CF16(1);
						func_58(0, 1, 1, 0, 0, 0, 0);
						unk_0x856549C07003344B(uLocal_134, 0);
						unk_0x3ED9330214992278(0, 0, 3000, 1, 0, 0);
						unk_0xB8B0F7C8C1548C5B(uLocal_134, 0);
				...
				{
					unk_0xF27E737981AFB47D(Local_87, 5f, 0, 0, 0, 0, 0, 0);
				}
			}
			if (!bLocal_123)
			{
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_103, 100f, 100f, 100f, 0, 1, 0))
				{
					unk_0x78FCB2E22C41B9D5(joaat("ig_bestmen"));
					if (unk_0x7D167B9A0CCDA347(joaat("ig_bestmen")))
					{
						iLocal_57 = unk_0xB3116B49FE00E2F1(4, joaat("ig_bestmen"), -2202.747f, 4299.008f, 47.4293f, 73.0028f, 1, 1);
						func_96(&uLocal_136, 4, iLocal_57, "BESTMAN", 0, 1);
						unk_0x45F588C0DD767737(iLocal_57, 0, 0, 0, 0);
						unk_0xD3D9D7C84656DAE5(iLocal_57, joaat("player"));
						unk_0x4E65320BC9AD521C(iLocal_57, 1);
						unk_0x694113444F21E39F(iLocal_57, 185, 1);
						unk_0x9DC06E2A59C5AEBB(&uLocal_113);
						unk_0xD08E9EAF091A1AAB(0, unk_0x9B0761B4C3EB8BC7(), -1);
						unk_0xA785552633ED203B(0, unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
						unk_0x19F29730874AD6F1(uLocal_113);
						unk_0x9B6EC2CECE1010EF(iLocal_57, uLocal_113);
						unk_0x4F83FEE4454169D4(&uLocal_113);
						bLocal_123 = true;
					}
				}
			...
			if (!bLocal_124)
			{
				if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_77, 20f, 20f, 20f, 0, 1, 0))
				{
					func_27();
					if (!func_71())
					{
			...
			if (((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_70, Local_73, fLocal_76, 0, 1, 0) && unk_0x1037B9D45CE6B788(iLocal_55, Local_70, Local_73, fLocal_76, 0, 1, 0)) || (unk_0xC2169C00B643278B(iLocal_55, Local_67, 0f, 0f, 2f, 1, 1, 0) && func_66(1, 0, 1))) || bLocal_118)
			{
				switch (iLocal_49)
				{
					case 0:
						...
						if (!bLocal_118)
						{
							...
							if (!unk_0xA59F96B50B97E63C(iLocal_59, 0))
							{
								...
								if (iVar2 != 0)
								{
									...
									if (iVar3 == 4)
									{
										unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), iLocal_55, 5000, 0, 2);
									}
									else
									{
										unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), iLocal_59, 5000, 2052, 4);
										unk_0x484F2B33DF8A26ED(iLocal_59, 0f, 0f, 0f, 1, -1, 3000, 2000);
									}
								}
							}
							func_27();
							if (!func_71())
							{
								...
								if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
								{
									...
									unk_0x3C1B180EE30D36EF(0, Local_99, 3f, 20000, 1048576000, 0, 1193033728);
									unk_0xD08E9EAF091A1AAB(0, unk_0x9B0761B4C3EB8BC7(), -1);
									unk_0xA785552633ED203B(0, unk_0x9B0761B4C3EB8BC7(), -1, 2048, 2);
									unk_0x19F29730874AD6F1(uLocal_113);
									unk_0x9B6EC2CECE1010EF(iLocal_55, uLocal_113);
									unk_0x4F83FEE4454169D4(&uLocal_113);
									unk_0xCBA6B2B569DCAFD8(iLocal_55, 1);
								}
								bLocal_118 = true;
								unk_0xC1B1E9A034A63A62(0);
							}
						}
						if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55) && !unk_0xA59F96B50B97E63C(iLocal_59, 0))
						{
							if ((bLocal_118 && unk_0xC2169C00B643278B(iLocal_55, Local_99, 1f, 1f, 1f, 0, 1, 0)) && !unk_0x47DBF174A0CB9D55(iLocal_55, 0))
							{
								if (unk_0x7DA97DBB7F7D2DE5(iLocal_55))
								{
									if (!func_71())
								...
								if (unk_0x1D88F87079AF2FA7(iLocal_55))
								{
									if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
									{
										unk_0x80250B8368A4E611(iLocal_55, 0, 0);
										unk_0x58ADF88C51AAFDC5(iLocal_55, 0, 0);
										unk_0x0312E5501F93E5AB(iLocal_55, 1);
										unk_0x6A8F948698B360B4(iLocal_55, 1);
									}
									if (unk_0x83666F9FB8FEBD4B() > 15000)
									{
										if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
										{
											unk_0x45F588C0DD767737(iLocal_55, 2, 1, 0, 0);
											unk_0x45F588C0DD767737(iLocal_55, 0, 0, 1, 0);
											unk_0x45F588C0DD767737(iLocal_55, 3, 1, 0, 0);
											unk_0x45F588C0DD767737(iLocal_55, 4, 1, 0, 0);
											unk_0x45F588C0DD767737(iLocal_55, 11, 0, 0, 0);
											unk_0x80250B8368A4E611(iLocal_55, 1, 0);
											unk_0x58ADF88C51AAFDC5(iLocal_55, 1, 0);
											unk_0x0312E5501F93E5AB(iLocal_55, 0);
											unk_0x6A8F948698B360B4(iLocal_55, 0);
											unk_0x03D382CB0B44E2FC(iLocal_55, Local_99, 1, 0, 0, 1);
											unk_0xE922BAA80E8F9324(iLocal_55, 106.5078f);
											unk_0xF5230D38AD1D873D(iLocal_55, 0);
											unk_0x6673CC701BC8E9C1(iLocal_55, 17, 1);
											unk_0x2CE840C9FCC03A58(iLocal_55, 1);
											unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), iLocal_55, -1, 2048, 4);
											if (!unk_0xA59F96B50B97E63C(iLocal_59, 0))
											{
												unk_0x9DC06E2A59C5AEBB(&uLocal_113);
												unk_0xA785552633ED203B(0, unk_0x9B0761B4C3EB8BC7(), -1, 2052, 4);
												unk_0xC584E49FC3559A86(0, iLocal_59, -1, 0, 2f, 1, 0);
												unk_0x19F29730874AD6F1(uLocal_113);
												unk_0x9B6EC2CECE1010EF(iLocal_55, uLocal_113);
												unk_0x4F83FEE4454169D4(&uLocal_113);
											}
					...
					case 1:
						if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55) && !unk_0xA59F96B50B97E63C(iLocal_59, 0))
						{
							if (unk_0x910DFF8E55ABB8EC(iLocal_55, iLocal_59, 5f, 5f, 5f, 0, 1, 0) && !iLocal_128)
							{
							...
							if (unk_0x47DBF174A0CB9D55(iLocal_55, 0))
							{
								...
								else
								{
									if (iLocal_308 == 0)
									{
										iLocal_308 = unk_0x578C4EF320340AF7();
									}
									if (iLocal_308 != 0 && unk_0x578C4EF320340AF7() > iLocal_308 + 6000)
									{
					...
					case 2:
						if (!bLocal_118)
						{
							...
							if (func_4(&uLocal_136, "stagdau", "stagd_hairc", 4, 0, 0, 0))
							{
								if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
								{
									if (!unk_0xA59F96B50B97E63C(unk_0xA5D3CD332CD10EE9(), 0))
									{
										iLocal_132 = unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0);
										unk_0xD4C86DEC93F19FB0(unk_0xA5D3CD332CD10EE9(), 10.5f, 2, 0);
									}
								}
								if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57) && !unk_0x5AEB5DDFFAD43CA5(iLocal_55))
								{
									if (unk_0x47DBF174A0CB9D55(iLocal_55, 0))
									{
										iLocal_132 = unk_0xA5D5B1042E8F47BD(iLocal_55, 0);
										unk_0x9DC06E2A59C5AEBB(&uLocal_113);
										unk_0xC584E49FC3559A86(0, iLocal_132, -1, 2, 1f, 1, 0);
										unk_0xE2348E4036041923(0);
										unk_0x19F29730874AD6F1(uLocal_113);
										unk_0x9B6EC2CECE1010EF(iLocal_57, uLocal_113);
										unk_0x694113444F21E39F(iLocal_57, 185, 0);
									}
									else
									{
										unk_0xE021DCE1063D5DC2(iLocal_57, iLocal_55, -1, 8f, 1073741824, 1073741824, 0);
									}
									if (!unk_0x8F678487EEBD8CE4(uLocal_322))
									{
						...
						if (bLocal_118 && !unk_0x5AEB5DDFFAD43CA5(iLocal_55))
						{
							if (unk_0x16BC17A8EDC701A2(iLocal_55, 242628503) == 7 || unk_0x83666F9FB8FEBD4B() > 12000)
							{
								Local_67 = { Local_77 };
								Local_70 = { Local_80 };
								Local_73 = { Local_83 };
								...
								{
									iLocal_56 = unk_0xB3116B49FE00E2F1(5, joaat("ig_bride"), -330.36f, 6154.03f, 30.8f, 90f, 1, 1);
									unk_0x4E65320BC9AD521C(iLocal_56, 1);
									unk_0x9DC06E2A59C5AEBB(&uLocal_113);
									unk_0xD08E9EAF091A1AAB(0, unk_0x9B0761B4C3EB8BC7(), -1);
									unk_0x19F29730874AD6F1(uLocal_113);
									unk_0x9B6EC2CECE1010EF(iLocal_56, uLocal_113);
									unk_0x4F83FEE4454169D4(&uLocal_113);
									iLocal_58 = unk_0xB3116B49FE00E2F1(4, joaat("ig_bestmen"), -333.3692f, 6157.644f, 30.489f, 83.2763f, 1, 1);
									unk_0x4E65320BC9AD521C(iLocal_58, 1);
									unk_0xD08E9EAF091A1AAB(iLocal_58, unk_0x9B0761B4C3EB8BC7(), -1);
									unk_0x45F588C0DD767737(iLocal_58, 0, 1, 0, 0);
									uLocal_60[0] = unk_0xCE4780E24AFDFBF9(joaat("washington"), -342.1295f, 6141.404f, 30.4839f, 133.4604f, 1, 1, 0);
									uLocal_60[1] = unk_0xCE4780E24AFDFBF9(joaat("baller2"), -338.3777f, 6137.41f, 30.476f, 135.6866f, 1, 1, 0);
									uLocal_60[2] = unk_0xCE4780E24AFDFBF9(joaat("primo"), -329.4687f, 6143.247f, 30.4893f, 313.82f, 1, 1, 0);
									uLocal_60[3] = unk_0xCE4780E24AFDFBF9(joaat("washington"), -322.3235f, 6135.427f, 30.4924f, 316.5898f, 1, 1, 0);
									unk_0x38633C69DE516059(uLocal_60[0], unk_0x344C570D6F8700DF(0, 127), 0);
									unk_0x38633C69DE516059(uLocal_60[1], unk_0x344C570D6F8700DF(0, 127), 0);
									unk_0x38633C69DE516059(uLocal_60[2], unk_0x344C570D6F8700DF(0, 127), 0);
									unk_0x38633C69DE516059(uLocal_60[3], unk_0x344C570D6F8700DF(0, 127), 0);
									iLocal_49 = 3;
									bLocal_118 = false;
									iLocal_130 = 0;
								}
		...
		else if (unk_0xA59F96B50B97E63C(iLocal_55, 0))
		{
			func_183();
		}
	}
...
void func_97()
{
	if ((iLocal_310 && iLocal_307 != func_80(func_81())) && !unk_0x40397A9A17EEC1C5(uLocal_134))
	{
	...
	if (iLocal_307 == func_80(func_81()))
	{
		...
		if (!func_71())
		{
			...
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
			{
				unk_0x48E48D5929D45C6F(iLocal_55, 1, 1);
			}
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_56))
			{
				unk_0x8B18A80E8EB15510(iLocal_56, unk_0x9B0761B4C3EB8BC7(), 300f, -1, 0, 0);
			}
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				unk_0x8B18A80E8EB15510(iLocal_58, unk_0x9B0761B4C3EB8BC7(), 300f, -1, 0, 0);
			}
			...
			{
				unk_0x9B94F6169B0DAEFD(iLocal_55);
				unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), iLocal_55, 5000, 2048, 2);
				unk_0xA785552633ED203B(iLocal_55, unk_0x9B0761B4C3EB8BC7(), 5000, 2048, 2);
				unk_0x0AB756271BADC8DF(iLocal_55, 0, 0);
				unk_0x59478CBBF96AF7D1(iLocal_55);
			}
			...
			{
				unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), iLocal_55, 5000, 0, 2);
				unk_0x0AB756271BADC8DF(iLocal_57, 500, 0);
			}
			unk_0x4EDE34FBADD967A6(1000);
			if (!unk_0xA59F96B50B97E63C(iLocal_59, 0))
			{
			...
			if (!unk_0xA59F96B50B97E63C(iLocal_55, 0) && !unk_0xA59F96B50B97E63C(unk_0xA5D3CD332CD10EE9(), 0))
			{
				unk_0x9DC06E2A59C5AEBB(&uLocal_113);
				if (unk_0xA5D3CD332CD10EE9() == iLocal_59)
				{
					unk_0xC584E49FC3559A86(0, iLocal_59, -1, -1, 1f, 8, 0);
					unk_0xBD204892D76E6303(0, iLocal_59, unk_0x9B0761B4C3EB8BC7(), 8, 15f, 786469, 10f, 10f, 1);
				}
				else
				{
...
void func_100()
{
	...
	if (iLocal_309 == 0)
	{
		...
		{
			unk_0xC4CC25B68A91D144(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
			iLocal_309++;
		}
	}
	...
	else if (iLocal_309 == 13)
	{
		...
		{
			unk_0xC4CC25B68A91D144(-1, "TIMER_STOP", "HUD_MINI_GAME_SOUNDSET", 1);
			iLocal_309++;
		}
	}
}
...
void func_105()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
	{
		if (!unk_0xA59F96B50B97E63C(iLocal_59, 0) && unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (unk_0xE0B3BC41DDA88DF0(iLocal_55, iLocal_59, 0) && unk_0x4162501391EDB9BF(iLocal_59))
			{
				if (!func_71())
				{
					if (func_106())
			...
			else if (unk_0xE0B3BC41DDA88DF0(iLocal_55, unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), 0) && unk_0x4162501391EDB9BF(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0)))
			{
				if (!func_71())
				{
					func_4(&uLocal_136, "stagdau", "stagd_bump1", 4, 0, 0, 0);
...
void func_107()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
	{
		unk_0x59DF7D162BF6D02E(iLocal_55, 0);
	}
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57))
	{
		unk_0x59DF7D162BF6D02E(iLocal_57, 0);
	}
	if (((((unk_0x910DFF8E55ABB8EC(iLocal_55, unk_0x9B0761B4C3EB8BC7(), 4f, 4f, 4f, 0, 1, 0) || iLocal_49 == 1) || iLocal_126) || iLocal_127) || iLocal_125) || bLocal_118)
	{
		if ((((((iLocal_49 >= 2 && iLocal_120) && iLocal_49 != 1) && !iLocal_126) && !iLocal_127) && !iLocal_125) && !bLocal_118)
		{
			if (unk_0x910DFF8E55ABB8EC(iLocal_57, unk_0x9B0761B4C3EB8BC7(), 4f, 4f, 4f, 0, 1, 0))
			{
				if (func_109())
				{
					func_108(0);
...
void func_110()
{
	...
	else
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
		{
			...
			{
				unk_0x1F8106DB8796859F(iLocal_66, 1, 1);
			}
		}
		while (func_71())
		{
...
void func_111()
{
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !unk_0x5AEB5DDFFAD43CA5(iLocal_55))
	{
		if (!iLocal_115)
		{
			if ((unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_55, 130f, 60f, 50f, 0, 1, 0) && !unk_0x1D88F87079AF2FA7(iLocal_55)) || unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_55, 10f, 10f, 10f, 0, 1, 0))
			{
				if (!unk_0x8F678487EEBD8CE4(uLocal_321))
				{
					uLocal_321 = func_70(iLocal_55, 0, 145);
					unk_0x3DBD102E8C35EA16(uLocal_321, 0);
					unk_0xA785552633ED203B(iLocal_55, unk_0x9B0761B4C3EB8BC7(), -1, 2052, 4);
				}
				if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_55, 10f, 10f, 10f, 0, 1, 0))
				{
					if (unk_0x8F678487EEBD8CE4(uLocal_321))
					{
						unk_0x3DBD102E8C35EA16(uLocal_321, 1);
					}
					unk_0x5AE11BC36633DE4E(0);
					func_98();
					while (func_71())
			...
			if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !unk_0x5AEB5DDFFAD43CA5(iLocal_55))
			{
				if ((!func_149() && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -1131.777f, 2636.418f, 15.589f, -1040.995f, 2717.077f, 31.715f, 60.75f, 0, 1, 0)) && unk_0x8F678487EEBD8CE4(uLocal_321))
				{
					if (!func_71())
					{
					...
					if (!unk_0xA59F96B50B97E63C(unk_0xA5D3CD332CD10EE9(), 0))
					{
						iLocal_65 = unk_0xA5D3CD332CD10EE9();
					}
					func_112(1);
				}
			}
		...
		else if (!iLocal_301)
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
			{
				if (!unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_55, 25f, 25f, 25f, 0, 1, 0))
				{
					func_27();
					unk_0x4EDE34FBADD967A6(0);
...
void func_122()
{
	if (unk_0xAE06B9E39EBDE049(iLocal_55))
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
		{
			if (unk_0x3628D28B8671F14F(-1, unk_0x3E4D3CCC220BDFB1(iLocal_55, 1), 3f))
			{
				unk_0x2BB0EF9DE445EA13(iLocal_55);
				unk_0x697DA7132EE43ABC(iLocal_55, 99, 0);
			}
			if (!unk_0xA59F96B50B97E63C(unk_0xA5D3CD332CD10EE9(), 0))
			{
				...
				{
					unk_0x6A8F948698B360B4(iLocal_55, 0);
					if (unk_0xA65352E7FEA59881(unk_0xA5D3CD332CD10EE9(), iLocal_55))
					{
						unk_0x2BB0EF9DE445EA13(iLocal_55);
						unk_0x697DA7132EE43ABC(iLocal_55, 99, 0);
					}
			...
			if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_55, 2f, 2f, 2f, 0, 1, 0))
			{
				if (!unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (func_66(1, 0, 1))
					{
						if (!iLocal_311)
						{
							...
							if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
							{
								unk_0x555EE41D7C7078E6(unk_0x3E4D3CCC220BDFB1(iLocal_55, 1), 5f, 1, 0, 0, 0);
								unk_0x6D5673CA7E01D619(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), 5f);
							}
							if (!unk_0xA59F96B50B97E63C(unk_0xA5D3CD332CD10EE9(), 0))
							{
								if (unk_0x910DFF8E55ABB8EC(unk_0xA5D3CD332CD10EE9(), iLocal_55, 5f, 5f, 5f, 0, 1, 0))
								{
									unk_0x03D382CB0B44E2FC(unk_0xA5D3CD332CD10EE9(), unk_0x3E4D3CCC220BDFB1(iLocal_55, 1) - Vector(1.5f, 4f, 3f), 1, 0, 0, 1);
									unk_0xB11D151E210D4FAC(unk_0xA5D3CD332CD10EE9(), 1084227584);
								}
							}
							if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
							{
								uLocal_318 = unk_0xF341A134A5B8D4F6(-935.57f, 2767.616f, 24.448f, 2.433f, 0.152f, 53.743f, 2);
								uLocal_134 = unk_0x68C2E3309DCAD71E("DEFAULT_ANIMATED_CAMERA", 0);
								unk_0x8430A80C3E4F5F98(uLocal_318, 0.158f);
								unk_0x00736EE41CC355ED(uLocal_134, uLocal_318, "untie_cam", "re@stag_do@");
								unk_0x2BB0EF9DE445EA13(unk_0x9B0761B4C3EB8BC7());
								unk_0x2BB0EF9DE445EA13(iLocal_55);
								unk_0xDFDB9C533700BC17(iLocal_55, uLocal_318, "re@stag_do@", "untie_ped", 1000f, -1000f, 4, 0, 1148846080, 0);
								unk_0x1322CA891C5DF18A(iLocal_55, 0, 0);
								unk_0xDFDB9C533700BC17(unk_0x9B0761B4C3EB8BC7(), uLocal_318, "re@stag_do@", "untie_player", 1000f, -1000f, 0, 0, 1148846080, 0);
	...
	if (iLocal_311 && !iLocal_312)
	{
		if (!iLocal_316)
		{
			if (unk_0x369E69441C066912(uLocal_318) > 0.2f && unk_0x369E69441C066912(uLocal_318) < 0.3f)
			{
				unk_0x2DB2D4C3CB88500D(-1, "ROPE_CUT", unk_0x9B0761B4C3EB8BC7(), "ROPE_CUT_SOUNDSET", 0, 0);
				iLocal_316 = 1;
			}
		}
		if (unk_0x369E69441C066912(uLocal_318) > 0.4647059f && !iLocal_317)
		{
		...
		if (unk_0x369E69441C066912(uLocal_318) > 0.5f)
		{
			iLocal_312 = 1;
		}
		if (func_123(1000))
	...
	if (iLocal_312 && !iLocal_314)
	{
		...
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
		{
			unk_0x6A8F948698B360B4(iLocal_55, 0);
			unk_0x2BB0EF9DE445EA13(iLocal_55);
			unk_0x4478D8ED4673EF14(iLocal_55, 1);
			unk_0x03D382CB0B44E2FC(iLocal_55, -935.6716f, 2767.772f, 24.4289f, 1, 0, 0, 1);
			unk_0xE922BAA80E8F9324(iLocal_55, 136.9073f);
			unk_0x1322CA891C5DF18A(iLocal_55, 0, 0);
		}
		if (iLocal_315)
		{
	...
	if (iLocal_314 && !unk_0x5AEB5DDFFAD43CA5(iLocal_55))
	{
		if (unk_0x80FF6C016CDB0FAF(unk_0xA5D3CD332CD10EE9(), 0))
		{
			if ((((((unk_0x910DFF8E55ABB8EC(iLocal_55, unk_0xA5D3CD332CD10EE9(), 20f, 20f, 20f, 0, 1, 0) && unk_0x99E61B3887CC8E71(unk_0xA5D3CD332CD10EE9()) >= 1) && !unk_0x5874D60325749F00(unk_0x36FE6D3220816ADA(unk_0xA5D3CD332CD10EE9()))) && !unk_0x442D6659150AF4B3(unk_0x36FE6D3220816ADA(unk_0xA5D3CD332CD10EE9()))) && !unk_0xF9C3E2B9AA9E2294(unk_0x36FE6D3220816ADA(unk_0xA5D3CD332CD10EE9()))) && !unk_0xCA6AF782C906AC86(unk_0x36FE6D3220816ADA(unk_0xA5D3CD332CD10EE9()))) && unk_0x36FE6D3220816ADA(unk_0xA5D3CD332CD10EE9()) != joaat("rhino"))
			{
				unk_0x9DC06E2A59C5AEBB(&uLocal_113);
			...
			else if (!unk_0x7DA97DBB7F7D2DE5(iLocal_55))
			{
				unk_0xE19B69814D61BBA5(iLocal_55, func_73());
				unk_0x10162EF76529C10F(iLocal_55, 1);
				unk_0xF5230D38AD1D873D(iLocal_55, 0);
		...
		unk_0x4E65320BC9AD521C(iLocal_55, 0);
		unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), 1, 0);
		uLocal_320 = func_29(Local_67, 1);
		iLocal_114 = 1;
		bLocal_116 = true;
...
void func_125()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (!unk_0x1758275D343D5BA3(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0)))
			{
				unk_0x4F3C4F457D44BB0F(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), 1, 0);
			}
		}
		iLocal_133 = unk_0x84F0027A508D7D7D(unk_0x3E4D3CCC220BDFB1(iLocal_55, 0), 30f, 0, 4);
		if (!unk_0xA59F96B50B97E63C(iLocal_133, 0))
		{
			if (!unk_0xB064AF9925F5537B(iLocal_133, -1, 0))
			{
				if (unk_0x910DFF8E55ABB8EC(iLocal_133, iLocal_55, 30f, 30f, 30f, 0, 1, 0))
				{
					unk_0x4F3C4F457D44BB0F(iLocal_133, 1, 0);
					if (unk_0x80FF6C016CDB0FAF(iLocal_133, 0))
					{
						unk_0x8B343DEB20722800(iLocal_133, 3000, 0, 0);
						if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
						{
				...
				{
					unk_0xE730EAF558C97567(&iLocal_133);
				}
			}
		}
	}
...
void func_127()
{
	...
	while ((!unk_0xC614DDE265D18415("re@stag_do@") || !unk_0xC614DDE265D18415("re@stag_do@idle_a")) || !unk_0x8B917081F9836EDD("ROPE_CUT", 0, -1))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	iLocal_55 = unk_0xB3116B49FE00E2F1(26, joaat("u_m_y_staggrm_01"), -935.57f, 2767.616f, 24.448f, 140.5f, 1, 1);
	unk_0x3A2AAE59B4681DAF(iLocal_55, "GROOM");
	unk_0xD3D9D7C84656DAE5(iLocal_55, joaat("player"));
	unk_0x4E65320BC9AD521C(iLocal_55, 1);
	unk_0x055A73D4AFD214F1(iLocal_55, 0);
	unk_0x45F588C0DD767737(iLocal_55, 2, 0, 0, 0);
	unk_0x45F588C0DD767737(iLocal_55, 0, 0, 0, 0);
	unk_0x45F588C0DD767737(iLocal_55, 3, 0, 0, 0);
	unk_0x45F588C0DD767737(iLocal_55, 4, 0, 0, 0);
	unk_0x45F588C0DD767737(iLocal_55, 11, 1, 0, 0);
	unk_0xC7F3278FC2D23873(iLocal_55, joaat("empty"));
	unk_0x73745F8F1D07995D(iLocal_55, 3);
	unk_0x694113444F21E39F(iLocal_55, 206, 1);
	unk_0x694113444F21E39F(iLocal_55, 134, 1);
	iLocal_66 = unk_0x79CC07752E7432A1(joaat("prop_stag_do_rope"), unk_0x3E4D3CCC220BDFB1(iLocal_55, 1), 1, 1, 0);
	unk_0xF8A652CE310FFC53(iLocal_66, iLocal_55, unk_0xE6B87C42793036AA(iLocal_55, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	iLocal_59 = unk_0xCE4780E24AFDFBF9(joaat("superd"), -2009.015f, 455.3556f, 101.6528f, 274.8103f, 0, 0, 0);
	unk_0x494ACC4552B7881B(iLocal_59, 1);
	unk_0x463F70A7E1EF1482(iLocal_59, 0f);
	unk_0x5DC21979EC6C531F(iLocal_59, 3);
	unk_0x249EEEE65626B20C(iLocal_59, 0);
	unk_0x34591EBF2048E54F(iLocal_59, 0, 73, 0);
	unk_0x903D8D8F6A330FA9(iLocal_59, 2, 48);
	unk_0x8DFB45E7317A7ED7(iLocal_59, 11, 1, 0);
	unk_0x8DFB45E7317A7ED7(iLocal_59, 12, 1, 0);
	unk_0xC67C29E80EBF396B(joaat("superd"), 3);
	unk_0x1CCBC799127EA27B(iLocal_59, 10000);
	unk_0xE87B2E81877383B1(iLocal_59, 5f);
	unk_0x7C4F70F41134C357(iLocal_59);
	...
	unk_0x410A1E7AD7D5C774(joaat("superd"), 1);
	unk_0xAF7D4BF357E8B79E(Local_87 - Vector(10f, 10f, 10f), Local_87 + Vector(10f, 10f, 10f), 0, 1);
	unk_0xC08A186299DFDA0A(Local_87 - Vector(20f, 20f, 20f), Local_87 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
	unk_0xC08A186299DFDA0A(unk_0x3E4D3CCC220BDFB1(iLocal_55, 0) - Vector(10f, 10f, 10f), unk_0x3E4D3CCC220BDFB1(iLocal_55, 0) + Vector(10f, 10f, 10f), 0, 1, 1, 1);
	...
	unk_0x773B9DEB93E81B2F(unk_0x3E4D3CCC220BDFB1(iLocal_55, 1), 10f, 0);
	if (!unk_0xA59F96B50B97E63C(iLocal_55, 0))
	{
		unk_0x9DC06E2A59C5AEBB(&uLocal_113);
	...
	if (func_16() == 0)
	{
		func_96(&uLocal_136, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 0, 1);
	}
	if (func_16() == 1)
	{
		func_96(&uLocal_136, 0, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
	}
	if (func_16() == 2)
	{
		func_96(&uLocal_136, 0, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
	}
...
void func_130(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2552060[iParam0 /*3*/][func_131(iParam2)];
	if (iVar0 != 0)
	{
...
int func_136()
{
	...
	{
		if (unk_0xB7A628320EFF8E47(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_45) < (75f * 75f))
		{
			return 1;
		}
		if (unk_0xA8CEACB4F35AE058(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_147())
		{
			return 0;
		}
	}
...
void func_183()
{
	...
	{
		func_219(0);
		unk_0xAF7D4BF357E8B79E(Local_87 - Vector(10f, 10f, 10f), Local_87 + Vector(10f, 10f, 10f), 1, 1);
		unk_0x7C58E35D84128447();
		func_27();
		unk_0xEA1D26E78A0A9984(unk_0x460153A63B9477BC());
		if (!unk_0xA59F96B50B97E63C(iLocal_65, 0))
		{
			if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_65, 0) && !unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_65, 50f, 50f, 50f, 0, 1, 0))
			{
				func_195(iLocal_65, 0, 145);
			}
		}
		if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_87, 100f, 100f, 100f, 0, 1, 0))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55) && !unk_0x5AEB5DDFFAD43CA5(iLocal_57))
			{
				unk_0x9DC06E2A59C5AEBB(&uLocal_113);
				unk_0x3C1B180EE30D36EF(0, -330.36f, 6154.03f, 31.8f, 1f, -1, 1048576000, 0, 1193033728);
				unk_0x08F021D149DA1931(0, iLocal_57, 16, 0f, 0f, 0f, 0f, 0f);
				unk_0x19F29730874AD6F1(uLocal_113);
				unk_0x9B6EC2CECE1010EF(iLocal_55, uLocal_113);
				unk_0x4F83FEE4454169D4(&uLocal_113);
				unk_0x9DC06E2A59C5AEBB(&uLocal_113);
				unk_0x3C1B180EE30D36EF(0, -330.36f, 6155.03f, 31.8f, 1f, -1, 1048576000, 0, 1193033728);
				unk_0x08F021D149DA1931(0, iLocal_55, 16, 0f, 0f, 0f, 0f, 0f);
				unk_0x19F29730874AD6F1(uLocal_113);
				unk_0x9B6EC2CECE1010EF(iLocal_57, uLocal_113);
				unk_0x4F83FEE4454169D4(&uLocal_113);
			}
		...
		unk_0xE730EAF558C97567(&iLocal_133);
		unk_0xE730EAF558C97567(&iLocal_59);
		...
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_55))
		{
			unk_0x694113444F21E39F(iLocal_55, 317, 1);
			if (!unk_0xB77B1396EAA80D8F(iLocal_55))
			{
				unk_0x6A8F948698B360B4(iLocal_55, 0);
			}
			unk_0x59478CBBF96AF7D1(iLocal_55);
		...
		else if (unk_0xAE06B9E39EBDE049(iLocal_66))
		{
			unk_0x1F8106DB8796859F(iLocal_66, 1, 1);
		}
		unk_0x2481907DEE6B85EA(&iLocal_55);
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57))
		{
			unk_0x694113444F21E39F(iLocal_57, 317, 1);
			unk_0x4E65320BC9AD521C(iLocal_57, 0);
		}
		unk_0x2481907DEE6B85EA(&iLocal_57);
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_56))
		{
			unk_0x4E65320BC9AD521C(iLocal_56, 0);
		}
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
		{
			unk_0x4E65320BC9AD521C(iLocal_58, 0);
		}
		unk_0x2481907DEE6B85EA(&iLocal_56);
	}
	func_184(-1);
	unk_0xD39E529EBE5DB04F();
}
