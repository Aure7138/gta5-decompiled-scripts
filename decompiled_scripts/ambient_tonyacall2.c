...
int func_1()
{
	...
	if ((unk_0xB7A628320EFF8E47(Var0, Var3) > 10000f || unk_0x437347B10A200C4B(uLocal_38, 0)) || func_27())
	{
		return 1;
	}
	switch (iLocal_40)
		...
		case 0:
			if (unk_0xC844350D5D58C99A(uLocal_38) && !unk_0x437347B10A200C4B(uLocal_38, 0))
			{
				if (unk_0x5A91F08DF773C39D(uLocal_38, Local_57, 1f, 1f, 1f, 0, 1, 0))
				{
					...
					unk_0x78ADC381772E3D54(uLocal_38, uVar7);
					unk_0xF82EA857DA10E0CD(&uVar7);
					iLocal_40 = 1;
				}
			}
			...
			if (unk_0xC844350D5D58C99A(uLocal_38) && !unk_0x437347B10A200C4B(uLocal_38, 0))
			{
				if (unk_0x4F1B602325013CC2(uLocal_38) == 1)
				{
					if (!unk_0xC844350D5D58C99A(uLocal_39))
					{
						...
						{
							fVar8 = unk_0x8CA9406E01C7EE58(uLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar8 >= 0.157f)
							{
