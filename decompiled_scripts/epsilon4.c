...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_80 = func_421(60);
	uLocal_81 = func_421(14);
	...
	uLocal_160 = unk_0x0D6624CFA803F591(iLocal_159);
	sLocal_161 = "empty";
	iLocal_339 = 1;
	iLocal_764 = -1;
	iLocal_765 = -1;
	...
	if (func_397() || func_396(0))
	{
		Global_69862 = 1;
		iLocal_79 = 0;
		while (!func_388(&Local_83))
		{
	...
	uLocal_162 = func_387();
	uLocal_163 = func_386(1855.08f, 4755.85f, 36.81f, 25f);
	iLocal_764 = unk_0x9A431E8DC976B09F(1815.39f, 4698f, 38.87f, 3.5f, 3.5f, 3f, 0f, 0, 7);
	iLocal_765 = unk_0x9A431E8DC976B09F(1824.12f, 4701.39f, 38.29f, 2.5f, 2.5f, 2.5f, 0f, 0, 7);
	iLocal_766 = unk_0x9A431E8DC976B09F(1801.28f, 4700.25f, 39.42f, 2f, 2f, 2f, 0f, 0, 7);
	if (!unk_0x6DEB8F88FFE09057("EPSILONISM_04_MIX"))
	{
		func_385("Starting dynamic mix EPSILONISM_04_MIX");
		unk_0xC94C39C53546E775("EPSILONISM_04_MIX");
	}
	unk_0xA28F0E9F63F56A89(0);
	unk_0xFDDE2C1A05E64390(1, joaat("player"), joaat("player"));
	unk_0xACD6D334FD769B0C(0.5f);
	uLocal_360 = unk_0x41C7F2AF7E95A424(1751.65f, 4676.77f, 43.03f, 1.5f);
	func_382();
	func_365();
	func_364();
	Local_772.f_0 = 0;
	...
	{
		func_361(&(Local_363[iVar0 /*43*/]));
		iVar0++;
	}
	func_360(&(Local_606[0 /*8*/]), Local_151, fLocal_154, Local_83.f_28[0], 0);
	func_360(&(Local_606[1 /*8*/]), Local_155, fLocal_158, Local_83.f_28[1], 0);
	if (func_397())
	{
		if (func_359() == 0)
		{
			func_358(Local_147, fLocal_150, 1, 0);
			func_357(1);
			func_356(&Local_83, 0, 1);
			func_355();
			func_385("Done replay setup");
		}
	}
	else if (func_396(0))
	{
		func_358(Local_147, fLocal_150, 1, 0);
		func_357(0);
		func_356(&Local_83, 1, 1);
		func_355();
	}
	func_353(60, 0, 0);
	while (true)
	{
		unk_0x4C3EC3682F8AFD6F("SF_Epsilon4", 0);
		func_337(Local_83.f_9, 0, 0, 0, 0, 0);
		unk_0xD66AE592C73A70C9(unk_0x0C1D3C552325765B());
		if (func_336())
		{
		...
		if (func_335(unk_0xA0081090911D13E5()))
		{
			if (func_334(unk_0xA0081090911D13E5()) == iLocal_159)
			{
...
void func_1()
{
	...
	switch (Local_772.f_1)
	{
		case 0:
			...
			if (unk_0x28C1B9853548BD8E(sVar0, sLocal_161))
			{
				func_401(1);
			}
			else
...
void func_11()
{
	...
	unk_0xA9DC3948106CC3E4("weapons@holster_1h");
	while (func_334(unk_0xA0081090911D13E5()) == iLocal_159)
	{
		unk_0x4EDE34FBADD967A6(0);
		unk_0x7ABD1B29E6C2963D(2);
		if (unk_0xAD21C77209FD2024("weapons@holster_1h"))
		{
			if (!unk_0x2FB5C9A04733E5EF(unk_0xA0081090911D13E5(), "weapons@holster_1h", "holster", 3))
			{
				unk_0xC9567EA69F3CC4C2(unk_0xA0081090911D13E5(), "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			else if (unk_0xAC6AEF29F754B011(unk_0xA0081090911D13E5(), "weapons@holster_1h", "holster") >= 0.5f)
			{
	...
	if (iVar0 < 12)
	{
		unk_0x10CE8769EE2626C7(joaat("num_epsilon_step"), 12, 1);
		func_12(23, 12);
	}
	func_398();
}
...
int func_13(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar20 = 0;
		func_19(&iVar20);
		iVar21 = func_18(Var10, Global_101553.f_6543.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_16(Global_101553.f_6543.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_14(Global_101553.f_6543.f_765[iVar20 /*10*/]))
				{
					Global_101553.f_6543.f_765[iVar20 /*10*/] = { Var10 };
					func_15(&Var10);
					return 1;
...
void func_19(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_18(Global_101553.f_6543.f_765[iVar0 /*10*/], Global_101553.f_6543.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
int func_216()
{
	return func_217(unk_0x367152330DB70D69(), 0);
}
...
void func_224()
{
	unk_0x15761381A3072BFA(Local_625.f_2);
	unk_0x15761381A3072BFA(Local_625.f_3);
	unk_0x15761381A3072BFA(Local_625.f_4);
	unk_0x15761381A3072BFA(Local_625.f_5);
	Local_625.f_6 = 0;
	Local_625.f_7 = 0;
}
...
void func_226()
{
	switch (Local_772.f_1)
	{
		case 0:
			...
			unk_0x7ABD1B29E6C2963D(2);
			unk_0xB09984D51448364F(unk_0xA0081090911D13E5(), iLocal_159);
			Local_772.f_1 = 1;
			break;
		...
		case 1:
			...
			else if (unk_0x912AD5A10E7633F0(Local_606[0 /*8*/], 0))
			{
				func_236(6);
				Local_772.f_9 = 2;
				Local_772.f_1 = 3;
			}
			else if (unk_0x912AD5A10E7633F0(Local_606[1 /*8*/], 0))
			{
				func_236(6);
				Local_772.f_9 = 3;
				Local_772.f_1 = 3;
			}
			else if (unk_0x4AEC0F4FC7FE62C7(Local_606[0 /*8*/], unk_0xA0081090911D13E5(), 1) && unk_0x377920A41CE2B59C(Local_606[0 /*8*/], 0, 2))
			{
				func_236(6);
				Local_772.f_9 = 4;
				Local_772.f_1 = 3;
			}
			else if (unk_0x4AEC0F4FC7FE62C7(Local_606[1 /*8*/], unk_0xA0081090911D13E5(), 1) && unk_0x377920A41CE2B59C(Local_606[1 /*8*/], 0, 2))
			{
				func_236(6);
				Local_772.f_9 = 5;
				Local_772.f_1 = 3;
			...
			{
				if (func_227(unk_0xA0081090911D13E5(), Local_606[0 /*8*/], 1) >= 50f)
				{
...
void func_237()
{
	...
	if (Local_772.f_3 == 1)
	{
		...
		if (iLocal_353 == 0)
		{
			func_293("EPS_4_MCS_1");
		}
		else if (iLocal_353 == 1)
		{
			func_293("EPS_4_MCS_2");
		}
		else
		{
			func_293("EPS_4_MCS_3");
		}
		if (unk_0xCAC1D33299EA11C3())
		{
			func_385("Trying to set player component variation");
			if (func_228(unk_0xA0081090911D13E5()))
			{
				func_287("Michael", unk_0xA0081090911D13E5(), 0, 2);
			}
			if (iLocal_353 == 0 || iLocal_353 == 2)
			{
				func_385("Trying to set Jimmy prop variation");
				unk_0x712525D5B6D169EE("Jimmy_Boston", 1, 0, 0, 0);
			}
		}
		func_385("SKIP: Doing sync for cutscene skip");
		func_286(1, 1, 1);
		Local_772.f_3 = 0;
	}
	if (Local_772.f_1 == 0)
	{
		func_285("Doing setup for RockScene:", iLocal_353);
		func_283(1);
		func_282();
		unk_0x24816268735E001E(0, 200, 150);
		if (unk_0xCAC1D33299EA11C3())
		{
			func_385("Trying to set player component variation");
			if (func_228(unk_0xA0081090911D13E5()))
		...
		if (!func_281(iLocal_362))
		{
			iLocal_362 = unk_0xE044C77D0FC9DB66(joaat("bison"), 1851.57f, 4772.12f, 39.8f, 31.35f, 1, 1);
			unk_0x728045E0733945FD(iLocal_362, 157, 157);
			unk_0xE491F8C2C2A96483(iLocal_362, 5, 157);
			unk_0x74207974B5483203(iLocal_362);
		}
		func_280(&(Local_606[1 /*8*/]), 1);
		func_280(&(Local_606[0 /*8*/]), 1);
		if (func_335(unk_0xA0081090911D13E5()))
		{
			while (!func_272(1, 1093140480, 0))
			{
				func_385("Waiting for cutscene to be OK to start...");
				unk_0x7ABD1B29E6C2963D(2);
				func_283(1);
				func_282();
				unk_0x24816268735E001E(0, 200, 150);
			...
			unk_0x0DD6A546EB99211B(unk_0x0C1D3C552325765B(), 1);
			iVar0 = unk_0xDF658EB6CA91DFBC();
			while ((unk_0xDF658EB6CA91DFBC() - iVar0) < 500)
			{
				func_385("Doing 500ms pause");
				unk_0x7ABD1B29E6C2963D(2);
				unk_0x0DD6A546EB99211B(unk_0x0C1D3C552325765B(), 1);
				func_283(1);
				func_282();
			...
			if (iLocal_353 == 0)
			{
				...
				{
					unk_0x6BF154720AFAC26B(Local_606[1 /*8*/], "Jimmy_Boston", 0, 0, 0);
				}
				if (func_228(Local_606[0 /*8*/]))
				{
					unk_0x6BF154720AFAC26B(Local_606[0 /*8*/], "Marnie", 0, 0, 0);
				}
				if (func_228(unk_0xA0081090911D13E5()))
				{
					unk_0x6BF154720AFAC26B(unk_0xA0081090911D13E5(), "Michael", 0, 0, 0);
				}
				if (func_228(Local_625.f_0))
				{
					iLocal_641 = func_268(unk_0xA0081090911D13E5(), joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
					unk_0x6BF154720AFAC26B(iLocal_641, "Artefact_Detector", 0, 0, 0);
				}
				if (func_228(Local_363[iLocal_353 /*43*/].f_1))
				{
					unk_0x6BF154720AFAC26B(Local_363[iLocal_353 /*43*/].f_1, "EPS_TV", 0, 0, 0);
				}
			}
			else if (iLocal_353 == 1)
			{
				...
				if (func_228(Local_363[iLocal_353 /*43*/].f_1))
				{
					unk_0x6BF154720AFAC26B(Local_363[iLocal_353 /*43*/].f_1, "EPS_Battery", 0, 0, 0);
				}
			}
			else
			{
				...
				if (func_228(Local_363[iLocal_353 /*43*/].f_1))
				{
					unk_0x6BF154720AFAC26B(Local_363[iLocal_353 /*43*/].f_1, "Old_Boot", 0, 0, 0);
				}
			}
			unk_0xCD18C12FDC3FB874(0);
			unk_0x6831F2B0AA3B6439(1);
			iVar0 = unk_0xDF658EB6CA91DFBC();
			while ((unk_0xDF658EB6CA91DFBC() - iVar0) < 1)
			{
				unk_0x7ABD1B29E6C2963D(2);
				unk_0x4EDE34FBADD967A6(0);
				unk_0x4C3EC3682F8AFD6F("SF_Epsilon4", 0);
			...
			if (iLocal_353 >= 2)
			{
				if (func_228(unk_0xA0081090911D13E5()))
				{
					unk_0x8942ADC0DB9F81E4(unk_0xA0081090911D13E5(), joaat("weapon_unarmed"), -1, 1, 1);
				}
			}
			unk_0x0DD6A546EB99211B(unk_0x0C1D3C552325765B(), 0);
			func_259(Local_363[iLocal_353 /*43*/].f_25, Local_363[iLocal_353 /*43*/].f_28, Local_363[iLocal_353 /*43*/].f_31, Local_363[iLocal_353 /*43*/].f_32, Local_363[iLocal_353 /*43*/].f_35, func_267(), 1, 1, 1, 0, 0);
			func_254(Local_363[iLocal_353 /*43*/].f_2, 1, 0, 1, 1, 1, 1, 0, 1, 1, 1);
		}
		func_285("Finished setup, moving to run loop for RockScene #:", iLocal_353);
		Local_772.f_1 = 1;
	}
	if (Local_772.f_1 == 1)
	{
		...
		else
		{
			if (iLocal_353 >= 2)
			{
				...
				{
					if (unk_0x6990DC1A99A254AC() > 17000)
					{
						if (!unk_0x9726BE1252F8F0B6())
						{
							unk_0x34534A9EB2E27FA9(1847.472f, 4756.157f, 36.6968f, func_252(271.4718f), 145f, 0);
						}
					}
				}
			}
			if (Local_772.f_2 == 0)
			{
				...
				{
					Local_772.f_2 = -1;
					func_385("Cutscene not active, setting event -1");
				}
			}
			if (Local_772.f_2 == 1)
			{
			...
			if (Local_772.f_2 == -1)
			{
				...
				if (iLocal_353 >= 2)
				{
					unk_0xB49DAD10DC051295("EPS4_STOP");
					func_5(&(Local_363[iLocal_353 /*43*/].f_1));
				}
				Local_772.f_1 = 3;
				iLocal_353++;
				func_285("END CUTSCENE: iCurrentRock = ", iLocal_353);
			}
		}
	}
	if (Local_772.f_1 == 3)
	{
		...
		func_385("Doing cleanup for RockScene");
		func_238(1, 0, 1, 1);
		func_355();
	}
}
...
void func_239(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!unk_0xEB361B4BD195A4D3(unk_0xA0081090911D13E5()) && !func_243(unk_0x0C1D3C552325765B())) && !func_241(unk_0x0C1D3C552325765B(), 0)) && !func_240())
			{
				unk_0x39800A40136ECF37(unk_0xA0081090911D13E5(), 0);
			}
		}
		else if (!unk_0xEB361B4BD195A4D3(unk_0xA0081090911D13E5()) && !func_243(unk_0x0C1D3C552325765B()))
		{
			unk_0x39800A40136ECF37(unk_0xA0081090911D13E5(), 0);
		}
		Global_69615 = 0;
...
void func_247()
{
	unk_0xB9D4F4DE7E7EC038(uLocal_165, "SET_COLOUR");
	...
	unk_0xB9D4F4DE7E7EC038(uLocal_165, "SET_DISTANCE");
	unk_0x0FFE3C1DBBA72236(10f);
	unk_0xE73340DA551C95E1();
	unk_0x3C50A3550FB6DB4E(uLocal_166);
	unk_0x04F50370A3D0809C(uLocal_165, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
}
...
int func_248()
{
	if (func_228(unk_0xA0081090911D13E5()))
	{
		if (unk_0xF467E68A540B1B48("Michael", 0))
		{
			if (iLocal_353 >= 2)
			{
				func_385("*** Forcing Michael's move state (end cutscene)");
				unk_0xE33751BF671E2013(unk_0xA0081090911D13E5(), joaat("MotionState_Idle"), 0, 1, 0);
				return 1;
			}
			else
			{
				func_385("*** Forcing Michael's move state");
				if (func_334(unk_0xA0081090911D13E5()) != iLocal_159)
				{
					unk_0x8942ADC0DB9F81E4(unk_0xA0081090911D13E5(), iLocal_159, -1, 1, 1);
				}
				unk_0xE33751BF671E2013(unk_0xA0081090911D13E5(), joaat("MotionState_Idle"), 0, 1, 0);
				return 1;
			}
...
void func_249()
{
	if (func_228(Local_606[1 /*8*/]))
	{
		if (unk_0xF467E68A540B1B48("Jimmy_Boston", 0))
		{
			if (iLocal_353 >= 2)
			{
				if (func_228(Local_83.f_28[1]) && func_281(iLocal_362))
				{
					unk_0x95C55738CAE00A20(&uLocal_782);
					unk_0xBAAF14D0D225FEC1(0, iLocal_362, 0);
					unk_0x70B222EEA46C37FA(uLocal_782);
					unk_0x3998B29E786DFD96(Local_83.f_28[1], uLocal_782);
					unk_0x7DFD14B8B873D6B5(&uLocal_782);
					func_385("Did Jimmy pass exit");
				}
			}
			else
			{
				unk_0xF58CA5EA1A5B2762(Local_83.f_28[1], 1764.089f, 4665.879f, 42.3031f, 1f, 20000, 1193033728, 1056964608);
				func_385("Did Jimmy regular exit");
			}
			unk_0xE33751BF671E2013(Local_606[1 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
		}
	}
}
...
void func_250()
{
	if (func_228(Local_606[0 /*8*/]))
	{
		if (unk_0xF467E68A540B1B48("Marnie", 0))
		{
			if (iLocal_353 >= 2)
			{
				if (func_228(Local_83.f_28[0]) && func_281(iLocal_362))
				{
					unk_0x95C55738CAE00A20(&uLocal_782);
					unk_0xBAAF14D0D225FEC1(0, iLocal_362, -1);
					unk_0xA41BA6C0692C37D3(0, iLocal_362, 1743.33f, 4962.18f, 45.16f, 20f, 0, joaat("bison"), 786599, 5f, -1f);
					unk_0x1F1428EF73399830(0, iLocal_362, 30f, 262275);
					unk_0x70B222EEA46C37FA(uLocal_782);
					unk_0x3998B29E786DFD96(Local_83.f_28[0], uLocal_782);
					unk_0x7DFD14B8B873D6B5(&uLocal_782);
					func_385("Did Marnie pass exit");
				}
			}
			else
			{
				unk_0x1429584A1E80336C(Local_83.f_28[0], unk_0x2E01486DB8218E16(Local_83.f_28[0], 0f, 7f, 0f), 1f, 20000, 0.25f, 5, 1193033728);
				func_385("Did Marnie regular exit");
			}
			unk_0xE33751BF671E2013(Local_606[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
		}
	}
}
...
void func_251()
{
	...
	{
		if (unk_0xF467E68A540B1B48("Artefact_Detector", 0))
		{
			if (iLocal_353 < 2)
			{
				func_385("*** Detector exit");
				unk_0x652F753371E70398(iLocal_641, unk_0xA0081090911D13E5());
				func_5(&iLocal_641);
				if (!unk_0xD3FACCDA4D66AEAD(Local_625.f_0))
				{
					func_385("*** Recreating gDetector.hObj after cutscene...");
					Local_625.f_0 = unk_0x1B65C769A2C57865(unk_0xA0081090911D13E5());
				}
			}
			else
			{
				func_385("*** Detector exit (end cutscene)");
				func_5(&iLocal_641);
			}
		}
	}
...
int func_253()
{
	...
	else if (unk_0x912AD5A10E7633F0(Local_606[0 /*8*/], 0))
	{
		if (iLocal_353 < 2)
		{
			...
			Local_772.f_9 = 2;
			Local_772.f_1 = 3;
			func_385("Mission failed: Marnie dead");
			return 1;
		}
	}
	else if (unk_0x912AD5A10E7633F0(Local_606[1 /*8*/], 0))
	{
		if (iLocal_353 < 2)
		{
			...
			Local_772.f_9 = 3;
			Local_772.f_1 = 3;
			func_385("Mission failed: Jimmy dead");
			return 1;
		}
	}
	else if (unk_0x4AEC0F4FC7FE62C7(Local_606[0 /*8*/], unk_0xA0081090911D13E5(), 1) && unk_0x377920A41CE2B59C(Local_606[0 /*8*/], 0, 2))
	{
		...
		Local_772.f_9 = 4;
		Local_772.f_1 = 3;
		func_385("Mission failed: Marnie injured");
		return 1;
	}
	else if (unk_0x4AEC0F4FC7FE62C7(Local_606[1 /*8*/], unk_0xA0081090911D13E5(), 1) && unk_0x377920A41CE2B59C(Local_606[1 /*8*/], 0, 2))
	{
		...
		Local_772.f_9 = 5;
		Local_772.f_1 = 3;
		func_385("Mission failed: Jimmy injured");
		return 1;
	}
	return 0;
}
...
{
	func_260(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}
...
int func_268(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_270(iVar2, iVar8) != 0)
	{
		if (!unk_0x912AD5A10E7633F0(iParam0, 0))
		{
			if (unk_0xA63C8D5A22A2859B(iParam0, iVar2, func_270(iVar2, iVar8)))
			{
				if (func_269(func_270(iVar2, iVar8)))
				{
					uVar9 = unk_0x47938048EBFFB3FE(func_270(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_270(iVar2, iVar8) != 0)
	{
		if (!unk_0x912AD5A10E7633F0(iParam0, 0))
		{
			if (unk_0xA63C8D5A22A2859B(iParam0, iVar2, func_270(iVar2, iVar8)))
			{
				unk_0x71D66996DB2F36A7(uVar1, func_270(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
int func_272(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x39FEE545B315414E(unk_0xA0081090911D13E5(), 0))
	{
		...
		{
			if (!func_279(unk_0xF8DB47D339B8B953(unk_0xA0081090911D13E5(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_280(var uParam0, bool bParam1)
{
	if (func_335(*uParam0))
	{
		...
		if (bParam1)
		{
			unk_0xB0993C95A7DBF879(*uParam0);
		}
		else
		{
		...
		if (unk_0x5D586EFF7D308A80(*uParam0))
		{
			unk_0x988206841442D7CE(*uParam0);
		}
	}
	else
	{
...
{
	unk_0xB9D4F4DE7E7EC038(uLocal_165, "SET_COLOUR");
	unk_0x7CBFB9F4AF33C67E(67);
	unk_0x7CBFB9F4AF33C67E(200);
	unk_0x7CBFB9F4AF33C67E(255);
	unk_0x7CBFB9F4AF33C67E(255);
	unk_0x7CBFB9F4AF33C67E(209);
	unk_0x7CBFB9F4AF33C67E(67);
	unk_0x7CBFB9F4AF33C67E(255);
...
void func_283(int iParam0)
{
	if (iParam0 == 1)
	{
		if (func_284())
		{
			if ((unk_0x28C1B9853548BD8E(Local_625.f_14, "NO_RECENT_ANIM") || !unk_0x2FB5C9A04733E5EF(Local_625.f_0, "rcm_epsilonism4", Local_625.f_14, 3)) || unk_0xAC6AEF29F754B011(Local_625.f_0, "rcm_epsilonism4", Local_625.f_14) >= 0.98f)
			{
				if (fLocal_640 > 80f)
				{
				...
				unk_0x1C2B9D840AC2664F(Local_625.f_0, Local_625.f_14, "rcm_epsilonism4", 16f, 0, 0, 0, 0, 0);
			}
		}
	}
	else if (func_284())
	{
		if (!unk_0x28C1B9853548BD8E(Local_625.f_14, "NO_RECENT_ANIM"))
		{
			if (unk_0x2FB5C9A04733E5EF(Local_625.f_0, "rcm_epsilonism4", Local_625.f_14, 1))
			{
				if (unk_0xAC6AEF29F754B011(Local_625.f_0, "rcm_epsilonism4", Local_625.f_14) <= 0.05f)
				{
					unk_0xA41D8B32F1C5D284(Local_625.f_0, Local_625.f_14, "rcm_epsilonism4", -4f);
...
void func_296()
{
	...
	if (Local_772.f_3 == 1)
	{
		...
		if (iLocal_353 == 0)
		{
			if (!func_323())
			{
				unk_0x27327EB62D93CDBA(unk_0xA0081090911D13E5(), Local_147, 1, 0, 0, 1);
				unk_0x10BB9EA2ADBCF0F3(unk_0xA0081090911D13E5(), fLocal_150);
			}
			func_280(&(Local_606[1 /*8*/]), 1);
			func_280(&(Local_606[0 /*8*/]), 1);
			if (func_335(Local_606[1 /*8*/]))
			{
				unk_0xBB21B5C3111E5F85(Local_83.f_28[1], 0);
				unk_0x27327EB62D93CDBA(Local_606[1 /*8*/], 1829.75f, 4693.5f, 38.51f, 1, 0, 0, 1);
				unk_0x10BB9EA2ADBCF0F3(Local_606[1 /*8*/], 27.46f);
				Var2 = { unk_0xC59DF10B4FC39DF8(Local_606[1 /*8*/], 1) };
				unk_0x776447CD667051CD(1829.75f, 4693.5f, 38.51f, &fVar1, 0);
				unk_0x27327EB62D93CDBA(Local_606[1 /*8*/], Var2.f_0, Var2.f_1, fVar1, 1, 0, 0, 1);
				func_385("Setting Jimmy position (0)");
			}
			if (func_335(Local_606[0 /*8*/]))
			{
				unk_0x27327EB62D93CDBA(Local_606[0 /*8*/], 1827.32f, 4692.59f, 38.53f, 1, 0, 0, 1);
				unk_0x10BB9EA2ADBCF0F3(Local_606[0 /*8*/], 171.22f);
				func_385("Setting Marnie position (0)");
			}
		}
		else if (iLocal_353 == 1)
		{
			unk_0x27327EB62D93CDBA(unk_0xA0081090911D13E5(), 1754.634f, 4675.789f, 42.9068f, 1, 0, 0, 1);
			unk_0x10BB9EA2ADBCF0F3(unk_0xA0081090911D13E5(), 293.2275f);
			if (func_335(Local_606[1 /*8*/]))
			{
				unk_0x27327EB62D93CDBA(Local_606[1 /*8*/], 1758.586f, 4670.085f, 42.6276f, 1, 0, 0, 1);
				unk_0x10BB9EA2ADBCF0F3(Local_606[1 /*8*/], 262.4368f);
				func_385("Setting Jimmy position (1)");
			}
			if (func_335(Local_606[0 /*8*/]))
			{
				unk_0x27327EB62D93CDBA(Local_606[0 /*8*/], 1759.917f, 4683.584f, 42.7266f, 1, 0, 0, 1);
				unk_0x10BB9EA2ADBCF0F3(Local_606[0 /*8*/], 148.3211f);
				func_385("Setting Marnie position (1)");
			}
		}
		else if (iLocal_353 == 2)
		{
			unk_0x27327EB62D93CDBA(unk_0xA0081090911D13E5(), 1758.454f, 4829.431f, 39.729f, 1, 0, 0, 1);
			unk_0x10BB9EA2ADBCF0F3(unk_0xA0081090911D13E5(), 168.2012f);
			if (func_335(Local_606[0 /*8*/]))
			{
				unk_0x27327EB62D93CDBA(Local_606[0 /*8*/], 1755.005f, 4827.329f, 40.0736f, 1, 0, 0, 1);
				unk_0x10BB9EA2ADBCF0F3(Local_606[0 /*8*/], 169.6486f);
				func_385("Setting Marnie position (2)");
			}
		}
	...
	if (Local_772.f_1 == 0)
	{
		func_285("Doing setup for FindRock section:", iLocal_353);
		func_280(&(Local_606[1 /*8*/]), 0);
		iLocal_350 = 0;
		iLocal_352 = 0;
		iLocal_623 = 0;
		iLocal_359 = -1;
		iLocal_753 = 0;
		iLocal_754 = 0;
		iLocal_755 = unk_0xDF658EB6CA91DFBC();
		iLocal_757 = unk_0xDF658EB6CA91DFBC();
		iLocal_758 = 0;
		if (iLocal_353 == 0)
		{
			if (func_335(unk_0xA0081090911D13E5()))
			...
			if (func_335(Local_606[1 /*8*/]))
			{
				unk_0xB09984D51448364F(Local_606[1 /*8*/], iLocal_159);
				unk_0x1429584A1E80336C(Local_606[1 /*8*/], 1826.246f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 1193033728);
			}
			func_321(&(Local_606[1 /*8*/]), 1);
			iLocal_748 = 8;
			iLocal_749 = 8;
			iLocal_751 = 0;
			iLocal_750 = 0;
		...
		else if (iLocal_353 == 1)
		{
			...
			func_321(&(Local_606[0 /*8*/]), 0);
			func_320(&(Local_606[1 /*8*/]), uLocal_760);
			iLocal_748 = 8;
			iLocal_749 = 8;
			iLocal_751 = 0;
			iLocal_750 = 0;
		...
		else if (iLocal_353 == 2)
		{
			...
			func_320(&(Local_606[0 /*8*/]), uLocal_763);
			func_319(&(Local_606[1 /*8*/]), iLocal_761);
			iLocal_748 = 11;
			iLocal_749 = 12;
			iLocal_751 = 0;
			iLocal_750 = 0;
		...
		func_318(&uLocal_168, 0, unk_0xA0081090911D13E5(), "MICHAEL", 0, 1);
		func_318(&uLocal_168, 5, Local_606[1 /*8*/], "JIMMYBOSTON", 0, 1);
		func_318(&uLocal_168, 4, Local_606[0 /*8*/], "MARNIE", 0, 1);
		if (iLocal_353 == 0)
		{
		...
		func_317(Local_363[iLocal_353 /*43*/].f_18, Local_363[iLocal_353 /*43*/].f_19, Local_363[iLocal_353 /*43*/].f_20, Local_363[iLocal_353 /*43*/].f_21, Local_363[iLocal_353 /*43*/].f_22);
		bLocal_336 = false;
		iLocal_337 = 0;
		iLocal_338 = 0;
		iLocal_339 = 1;
		...
		iLocal_747 = 0;
		unk_0x94724F7C938EBE34(1);
		iLocal_358 = unk_0xDF658EB6CA91DFBC();
		iLocal_747 = unk_0xDF658EB6CA91DFBC() + 1000;
		func_285("Finished setup, moving to run loop for rock #:", iLocal_353);
		Local_772.f_1 = 1;
	}
	if (Local_772.f_1 == 1)
	{
		...
		else if (!func_316(&uLocal_694, unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1)))
		{
			func_236(6);
			Local_772.f_9 = 8;
			Local_772.f_1 = 3;
		...
		else
		{
			...
			while (iVar0 < 2)
			{
				func_313(&(Local_606[iVar0 /*8*/]));
				iVar0++;
			}
			if (unk_0xD3FACCDA4D66AEAD(Local_363[iLocal_353 /*43*/].f_1))
			{
				if (iLocal_353 == 0)
				{
					if (func_227(unk_0xA0081090911D13E5(), Local_363[iLocal_353 /*43*/].f_1, 1) < 100f)
					{
						if (!unk_0xDF3F7A44D6400C56())
						{
							unk_0x6946239981A418D8("EPS_4_MCS_1", 8);
							func_385("Requesting midtro now");
						}
					}
					else if (func_227(unk_0xA0081090911D13E5(), Local_363[iLocal_353 /*43*/].f_1, 1) > 120f)
					{
						if (unk_0xDF3F7A44D6400C56())
						{
							func_385("Player moved away - unloading midtro");
							unk_0x6987F23FD8A8D8B0();
						}
					}
				}
				else if (iLocal_353 == 1)
				{
					if (func_227(unk_0xA0081090911D13E5(), Local_363[iLocal_353 /*43*/].f_1, 1) < 100f)
					{
						if (!unk_0xDF3F7A44D6400C56())
						{
							unk_0x6946239981A418D8("EPS_4_MCS_2", 8);
							func_385("Requesting midtro now");
						}
					}
					else if (func_227(unk_0xA0081090911D13E5(), Local_363[iLocal_353 /*43*/].f_1, 1) > 120f)
				...
				else if (func_227(unk_0xA0081090911D13E5(), Local_363[iLocal_353 /*43*/].f_1, 1) < 100f)
				{
					if (!unk_0xDF3F7A44D6400C56())
					{
						unk_0x6946239981A418D8("EPS_4_MCS_3", 8);
						func_385("Requesting midtro now");
					}
				}
				else if (func_227(unk_0xA0081090911D13E5(), Local_363[iLocal_353 /*43*/].f_1, 1) > 120f)
			...
			func_312(&(Local_363[iLocal_353 /*43*/]));
			if (iLocal_353 == 0)
			{
				if (iLocal_746 == 0)
				{
					if (iLocal_747 < unk_0xDF658EB6CA91DFBC())
					{
						if (!func_336())
						{
							func_311("EPS4_T0");
							iLocal_747 = unk_0xDF658EB6CA91DFBC() + 7500;
							iLocal_746++;
							iLocal_759 = unk_0xDF658EB6CA91DFBC();
						}
						else
						{
							iLocal_746 = 2;
				...
				{
					if (unk_0x2A57AED61E15C7C7(0, 25) || iLocal_747 < unk_0xDF658EB6CA91DFBC())
					{
						unk_0x94724F7C938EBE34(1);
						iLocal_747 = unk_0xDF658EB6CA91DFBC() + 1000;
						iLocal_746++;
			...
			func_283(Local_625.f_1);
			if (iLocal_339 == 1)
			{
				func_310(&uLocal_164);
				if (!func_316(&uLocal_642, unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1)))
				{
					iLocal_339 = 0;
					unk_0x588D9B1F6CF36C3C(0);
					unk_0x715FC4B638D9A515();
				...
				{
					if (unk_0x28C1B9853548BD8E(Local_363[iLocal_353 /*43*/].f_36, sLocal_161) || func_301(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!unk_0x28C1B9853548BD8E(Local_363[iLocal_353 /*43*/].f_36, sLocal_161))
						{
							if (func_228(iLocal_361))
							{
								unk_0xD5DC2873808A9CB5(iLocal_361, unk_0xA0081090911D13E5(), 10000, 0, 2);
							}
						}
						iLocal_759 = unk_0xDF658EB6CA91DFBC();
						iLocal_340 = 1;
				...
				{
					if (!func_276() && (unk_0xDF658EB6CA91DFBC() - iLocal_358) >= 7500)
					{
						if ((unk_0x28C1B9853548BD8E(Local_363[iLocal_353 /*43*/].f_37, sLocal_161) || !unk_0x7298BA0C4D4A4C9E(unk_0xA0081090911D13E5(), iLocal_361, 30f, 30f, 30f, 0, 1, 0)) || func_301(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!unk_0x28C1B9853548BD8E(Local_363[iLocal_353 /*43*/].f_37, sLocal_161))
							{
								if (func_228(iLocal_361))
								{
									unk_0xD5DC2873808A9CB5(iLocal_361, unk_0xA0081090911D13E5(), 5000, 0, 2);
								}
							}
							iLocal_341 = 1;
							iLocal_759 = unk_0xDF658EB6CA91DFBC();
				...
				else if (iLocal_338 == 0 && !func_299(unk_0xA0081090911D13E5(), Local_363[iLocal_353 /*43*/].f_2, 9f))
				{
					if (func_299(unk_0xA0081090911D13E5(), Local_363[iLocal_353 /*43*/].f_2, 20f))
					{
						if (!iLocal_343)
						{
							if (!func_276())
							{
								if (func_301(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_42, 7, 0, 0, 0))
								{
									if (func_228(iLocal_361))
									{
										unk_0xD5DC2873808A9CB5(iLocal_361, unk_0xA0081090911D13E5(), 5000, 0, 2);
									}
									unk_0xF649596310B097AF(3f, 5f, 0);
									iLocal_343 = 1;
								}
							}
						}
					...
					{
						if (func_298(unk_0xA0081090911D13E5(), iLocal_361, 30f, 1) || iLocal_353 == 2)
						{
							if (!func_276() && (unk_0xDF658EB6CA91DFBC() - iLocal_356) > 15000)
							{
								if (bLocal_336)
								{
									if (iLocal_352 == 0)
									{
										...
										{
											if (unk_0x28C1B9853548BD8E(Local_363[iLocal_353 /*43*/].f_40, sLocal_161) || func_301(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_335(iLocal_361))
												{
													unk_0xD5DC2873808A9CB5(iLocal_361, unk_0xA0081090911D13E5(), 3000, 0, 2);
												}
												iLocal_356 = unk_0xDF658EB6CA91DFBC();
												iLocal_750++;
												if (iLocal_353 == 2)
									...
									{
										if (unk_0x28C1B9853548BD8E(Local_363[iLocal_353 /*43*/].f_40, sLocal_161) || func_301(&uLocal_168, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_356 = unk_0xDF658EB6CA91DFBC();
											iLocal_752++;
										}
								...
								{
									if (unk_0x28C1B9853548BD8E(Local_363[iLocal_353 /*43*/].f_41, sLocal_161) || func_301(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_335(iLocal_361))
										{
											unk_0xD5DC2873808A9CB5(iLocal_361, unk_0xA0081090911D13E5(), 3000, 0, 2);
							...
							else if (bLocal_336 != Local_625.f_1)
							{
								...
								if (bLocal_336)
								{
									if (iLocal_357 < unk_0xDF658EB6CA91DFBC())
									{
										if (func_276())
										{
											unk_0x588D9B1F6CF36C3C(1);
										}
										iLocal_356 = (unk_0xDF658EB6CA91DFBC() - 7500);
										iLocal_357 = unk_0xDF658EB6CA91DFBC();
									}
								}
								else
								{
					...
					{
						iLocal_356 = (unk_0xDF658EB6CA91DFBC() - 5000);
					}
				}
				if (iLocal_353 == 0)
				{
					if (iLocal_753 < 5)
					{
						if (((unk_0xDF658EB6CA91DFBC() - iLocal_755) > 7500 && !func_276()) && !unk_0x43589182CF3243AE())
						{
							if (func_228(Local_606[0 /*8*/]))
							{
								if (func_227(Local_606[0 /*8*/], unk_0xA0081090911D13E5(), 1) < 4f)
								{
									if (func_301(&uLocal_168, "EPS4AUD", "EPS4_NEARM", 6, 0, 0, 0))
									{
										iLocal_753++;
										iLocal_755 = unk_0xDF658EB6CA91DFBC();
									}
				...
				else if (iLocal_353 == 1)
				{
					if (iLocal_753 < 4)
					{
						if (((unk_0xDF658EB6CA91DFBC() - iLocal_755) > 7500 && !func_276()) && !unk_0x43589182CF3243AE())
						{
							if (func_228(Local_606[1 /*8*/]))
							{
								if (func_227(Local_606[1 /*8*/], unk_0xA0081090911D13E5(), 1) < 4f)
								{
									if (func_301(&uLocal_168, "EPS4AUD", "EPS4_NEARJ", 6, 0, 0, 0))
									{
										iLocal_753++;
										iLocal_755 = unk_0xDF658EB6CA91DFBC();
									}
					...
					if (iLocal_753 < 3)
					{
						if (((unk_0xDF658EB6CA91DFBC() - iLocal_755) > 7500 && !func_276()) && !unk_0x43589182CF3243AE())
						{
							if (func_228(Local_606[1 /*8*/]))
							{
								if (func_227(Local_606[1 /*8*/], unk_0xA0081090911D13E5(), 1) < 4f)
								{
									if (func_301(&uLocal_168, "EPS4AUD", "EPS4_NEARJP", 6, 0, 0, 0))
									{
										iLocal_753++;
										iLocal_755 = unk_0xDF658EB6CA91DFBC();
									}
					...
					if (iLocal_754 < 4)
					{
						if (((unk_0xDF658EB6CA91DFBC() - iLocal_755) > 7500 && !func_276()) && !unk_0x43589182CF3243AE())
						{
							if (func_228(Local_606[0 /*8*/]))
							{
								if (func_227(Local_606[0 /*8*/], unk_0xA0081090911D13E5(), 1) < 4f)
								{
									if (func_301(&uLocal_168, "EPS4AUD", "EPS4_NEARMP", 6, 0, 0, 0))
									{
										iLocal_754++;
										iLocal_755 = unk_0xDF658EB6CA91DFBC();
									}
				...
				if (unk_0x6E07DBF03F3AC258(unk_0xA0081090911D13E5(), Local_363[iLocal_353 /*43*/].f_2, 6.2f, 6.2f, 2f, 0, 0, 1))
				{
					if (iLocal_359 == -1)
					{
						iLocal_359 = unk_0xDF658EB6CA91DFBC();
					}
					else if ((unk_0xDF658EB6CA91DFBC() - iLocal_359) >= 1500)
					{
						if (func_276())
						{
							func_274();
						}
						iLocal_537 = unk_0xDF658EB6CA91DFBC();
						func_236(3);
						Local_772.f_1 = 3;
					}
				}
				...
				else if (!func_299(unk_0xA0081090911D13E5(), Local_363[iLocal_353 /*43*/].f_2, (9f + 2f)))
				{
					iLocal_337 = 0;
				}
			}
			...
			{
				if (!unk_0x16833EFAA58E63DB(uLocal_164))
				{
					uLocal_164 = func_297(Local_144, 5, 0);
				}
				bLocal_336 = Local_625.f_1;
				if (func_316(&uLocal_642, unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1)))
				{
				...
				else if (iLocal_344 == 0)
				{
					if (iLocal_353 < 2)
					{
						if (unk_0x7298BA0C4D4A4C9E(unk_0xA0081090911D13E5(), iLocal_361, 30f, 30f, 30f, 0, 1, 0))
						{
							if (!func_276() && !unk_0x43589182CF3243AE())
							{
								if (unk_0x28C1B9853548BD8E(Local_363[iLocal_353 /*43*/].f_38, sLocal_161) || func_301(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_38, 7, 0, 0, 0))
								{
									iLocal_344 = 1;
								}
							}
					...
					else if (!func_276() && !unk_0x43589182CF3243AE())
					{
						if (unk_0x28C1B9853548BD8E(Local_363[iLocal_353 /*43*/].f_38, sLocal_161) || func_301(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_38, 7, 0, 0, 0))
						{
							iLocal_344 = 1;
				...
				else if (iLocal_345 == 0)
				{
					if (iLocal_353 < 2)
					{
						if (unk_0x7298BA0C4D4A4C9E(unk_0xA0081090911D13E5(), iLocal_361, 30f, 30f, 30f, 0, 1, 0))
						{
							if ((!func_276() && (unk_0xDF658EB6CA91DFBC() - iLocal_358) >= 7500) && !unk_0x43589182CF3243AE())
							{
								if (unk_0x28C1B9853548BD8E(Local_363[iLocal_353 /*43*/].f_39, sLocal_161) || func_301(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_39, 7, 0, 0, 0))
								{
									iLocal_345 = 1;
								}
							}
					...
					else if ((!func_276() && (unk_0xDF658EB6CA91DFBC() - iLocal_358) >= 7500) && !unk_0x43589182CF3243AE())
					{
						if (unk_0x28C1B9853548BD8E(Local_363[iLocal_353 /*43*/].f_39, sLocal_161) || func_301(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_39, 7, 0, 0, 0))
						{
							iLocal_345 = 1;
	...
	{
		unk_0x7ABD1B29E6C2963D(2);
		func_385("In cleanup for FindRock");
		if (func_276())
		{
			unk_0x588D9B1F6CF36C3C(1);
		}
		...
		func_282();
		unk_0x24816268735E001E(0, 200, 150);
		if ((unk_0xDF658EB6CA91DFBC() - iLocal_537) > 750)
		{
			func_224();
			unk_0xF649596310B097AF(5f, 5f, 0);
			unk_0xF649596310B097AF(3f, 2f, 3);
			unk_0xD3032BAC1ECE011F(unk_0xA0081090911D13E5());
			func_280(&(Local_606[1 /*8*/]), 0);
			func_280(&(Local_606[0 /*8*/]), 0);
			func_355();
		}
	}
}
...
bool func_298(int iParam0, int iParam1, float fParam2, int iParam3)
{
...
void func_312(var uParam0)
{
	...
	fVar0 = unk_0x2A488C176D52CCA5(uParam0->f_2, unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1));
	Var1 = { unk_0xB86A69343E7FBB9A(unk_0xA0081090911D13E5()) };
	...
	Var8 = { uParam0->f_2 - unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1) };
	Var11 = { uParam0->f_2 - unk_0x2E01486DB8218E16(unk_0xA0081090911D13E5(), 0f, -5f, 0f) };
	bVar14 = ((Var8.f_0 * Var4.f_0) + (Var8.f_1 * Var4.f_1)) > 0f;
	fVar15 = (1f - (unk_0x6985B73FFE117B5D(Var4.f_0, Var4.f_1, Var11.f_0, Var11.f_1) / 180f));
	if (fVar0 >= 10f)
	{
	...
	else if (iLocal_354 < unk_0xDF658EB6CA91DFBC())
	{
		if (fVar0 <= 6.5f && bVar16)
		{
			unk_0x15761381A3072BFA(Local_625.f_3);
			unk_0x7DEFCA77DEA2C174(Local_625.f_4, "CONTINUAL_BEEP", unk_0xA0081090911D13E5(), "EPSILONISM_04_SOUNDSET", 0, 0);
			Local_625.f_6 = 1;
		}
		else
		{
			...
			iLocal_354 = (unk_0xDF658EB6CA91DFBC() + iVar18);
			iVar18 = (iVar18 / 3);
			if (iVar18 < 100)
			{
				iVar18 = 100;
			}
			iLocal_355 = (unk_0xDF658EB6CA91DFBC() + iVar18);
			unk_0x7DEFCA77DEA2C174(Local_625.f_3, "IDLE_BEEP", unk_0xA0081090911D13E5(), "EPSILONISM_04_SOUNDSET", 0, 0);
			if (bVar16)
			{
				unk_0x24816268735E001E(0, 200, 150);
			}
			...
			{
				unk_0x24816268735E001E(0, 200, 100);
			}
		}
	}
	if (iLocal_355 > 0 && unk_0xDF658EB6CA91DFBC() > iLocal_355)
	{
		unk_0x15761381A3072BFA(Local_625.f_3);
		iLocal_355 = 0;
	}
	if (unk_0x62B4986EA88E929B())
	{
		if (Local_625.f_7 == 0)
		{
			unk_0x7DEFCA77DEA2C174(Local_625.f_5, "SCAN", unk_0xA0081090911D13E5(), "EPSILONISM_04_SOUNDSET", 0, 0);
			Local_625.f_7 = 1;
		}
		else if (bVar16)
		{
			unk_0x86F350F5CCA04497(Local_625.f_5, "IsOnTarget", 1f);
		}
		else
		{
			unk_0x86F350F5CCA04497(Local_625.f_5, "IsOnTarget", 0f);
		}
		iLocal_759 = unk_0xDF658EB6CA91DFBC();
	}
	...
	else
	{
		...
		unk_0xB9D4F4DE7E7EC038(uLocal_165, "SET_DISTANCE");
		unk_0x0FFE3C1DBBA72236(fLocal_640);
		unk_0xE73340DA551C95E1();
		unk_0x3C50A3550FB6DB4E(uLocal_166);
		unk_0x04F50370A3D0809C(uLocal_165, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	}
	if (unk_0x7F6103BD34B839B0(0, 25))
	{
		unk_0x44A694E0E28FA402(unk_0xA0081090911D13E5(), 1f);
		unk_0xABC36CFE4F3421A0(0, 22, 1);
		if (bLocal_351)
		{
			unk_0x2A7D387AD73F1D15(15f, 1065353216);
...
void func_313(var uParam0)
{
	...
	if (func_335(*uParam0) && unk_0x5D586EFF7D308A80(*uParam0))
	{
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			{
				iVar0 = unk_0xB5BF1B58C833F7A9(0, iLocal_605);
				while (uParam0->f_3 == -1)
				{
					if (Local_538[iVar0 /*6*/].f_5 == 0)
					{
						...
						{
							if (!unk_0x6E07DBF03F3AC258(*uParam0, Local_538[iVar0 /*6*/], 3f, 3f, 3f, 0, 1, 0))
							{
								func_285("Telling ped to go to marker: ", iVar0);
				...
				unk_0x1429584A1E80336C(*uParam0, Local_538[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 1193033728);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (!uParam0->f_7)
				{
					if (unk_0x21178DF77817BF39(*uParam0, 713668775) == 7)
					{
						func_385("Eps reached marker! (follow nav to coord)");
						uParam0->f_1 = 2;
						uParam0->f_2 = 0;
					}
				}
				else if (unk_0x21178DF77817BF39(*uParam0, 2106541073) == 7)
				{
					func_385("Eps reached marker! (go straight to coord)");
					uParam0->f_7 = 0;
					uParam0->f_1 = 2;
					uParam0->f_2 = 0;
				}
		...
		case 2:
			...
			{
				func_285("Telling ped do sequence for marker: ", uParam0->f_3);
				unk_0x95C55738CAE00A20(&uLocal_167);
				if (Local_538[uParam0->f_3 /*6*/].f_4 == 0)
				{
					if (*uParam0 == Local_606[1 /*8*/])
					{
						unk_0xC9567EA69F3CC4C2(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_entry_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0xC9567EA69F3CC4C2(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0xC9567EA69F3CC4C2(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_exit_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else
					{
						unk_0xC9567EA69F3CC4C2(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_entry_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0xC9567EA69F3CC4C2(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0xC9567EA69F3CC4C2(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_exit_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
				}
				else if (Local_538[uParam0->f_3 /*6*/].f_4 == 2)
				{
					unk_0x89DDE5106D814A78(0, Local_538[uParam0->f_3 /*6*/].f_3, 0);
					unk_0xC9567EA69F3CC4C2(0, "rcm_epsilonism4", "peeing", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				else if (Local_538[uParam0->f_3 /*6*/].f_4 == 3)
				{
					unk_0xC9567EA69F3CC4C2(0, "rcm_epsilonism4", "hippy_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				...
				unk_0x70B222EEA46C37FA(uLocal_167);
				unk_0x3998B29E786DFD96(*uParam0, uLocal_167);
				unk_0x7DFD14B8B873D6B5(&uLocal_167);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (unk_0x21178DF77817BF39(*uParam0, 242628503) == 7)
				{
					Local_538[uParam0->f_3 /*6*/].f_5 = 0;
					uParam0->f_3 = -1;
					uParam0->f_1 = 1;
		...
		case 4:
			...
			{
				if (!unk_0x6E07DBF03F3AC258(unk_0xA0081090911D13E5(), uParam0->f_4, 1f, 1f, 1f, 0, 1, 0) || iLocal_353 > 0)
				{
					if (!unk_0x5D586EFF7D308A80(*uParam0))
					{
						unk_0xD3032BAC1ECE011F(*uParam0);
						unk_0xF6C043D83EDAD90F(*uParam0, func_314());
						unk_0x705E4255B39314A7(*uParam0, 167, 1);
					}
					iLocal_756 = unk_0xDF658EB6CA91DFBC();
					if (iLocal_353 == 0)
					{
						unk_0xC5D277D42BC00246(func_314(), 0);
					}
					else
					{
						unk_0xC5D277D42BC00246(func_314(), 0);
					}
					unk_0xF75E59310C395505(func_314(), 4f, -1082130432, -1082130432);
					uParam0->f_2 = 1;
				}
			}
			else if (uParam0->f_2 == 1)
			{
				...
				if (unk_0x3CE167940408A89C(*uParam0))
				{
					if (!iLocal_350)
					{
						if ((unk_0xDF658EB6CA91DFBC() - iLocal_756) > 6000)
						{
							unk_0x95C55738CAE00A20(&uLocal_167);
							if (*uParam0 == Local_606[1 /*8*/])
							{
							...
							if (!func_276() && !unk_0x43589182CF3243AE())
							{
								if (*uParam0 == Local_606[1 /*8*/])
								{
									func_301(&uLocal_168, "EPS4AUD", "EPS4_DAWDJ", 7, 0, 0, 0);
								}
								else
								{
									func_301(&uLocal_168, "EPS4AUD", "EPS4_DAWDM", 7, 0, 0, 0);
								}
							}
							iLocal_350 = 1;
						}
				...
				if (unk_0x8E30A8C5F10F6DD2(unk_0xA0081090911D13E5()) || unk_0xED92E08D8DEBAA73(unk_0xA0081090911D13E5()))
				{
					if ((((unk_0xDF658EB6CA91DFBC() - iLocal_757) > 7500 && !func_276()) && !unk_0x43589182CF3243AE()) && !iLocal_337)
					{
						if (*uParam0 == Local_606[1 /*8*/])
						{
							if (func_301(&uLocal_168, "EPS4AUD", "EPS4_MESSJ", 7, 0, 0, 0))
							{
								iLocal_757 = unk_0xDF658EB6CA91DFBC();
							}
						}
						else if (func_301(&uLocal_168, "EPS4AUD", "EPS4_MESSM", 7, 0, 0, 0))
						{
							iLocal_757 = unk_0xDF658EB6CA91DFBC();
						}
					}
				}
				if ((unk_0xDF658EB6CA91DFBC() - iLocal_759) > 15000)
				{
					if ((((iLocal_758 < 4 && !func_276()) && !unk_0x43589182CF3243AE()) && !iLocal_337) && !func_336())
					{
						if (*uParam0 == Local_606[1 /*8*/])
						{
							if (func_301(&uLocal_168, "EPS4AUD", "EPS4_PROMPTJ", 7, 0, 0, 0))
							{
								iLocal_759 = unk_0xDF658EB6CA91DFBC();
								iLocal_758++;
							}
						}
						else if (func_301(&uLocal_168, "EPS4AUD", "EPS4_PROMPTM", 7, 0, 0, 0))
						{
							iLocal_759 = unk_0xDF658EB6CA91DFBC();
							iLocal_758++;
						}
		...
		case 5:
			...
			{
				unk_0x48FD097BDAEE42DD(*uParam0, unk_0xA0081090911D13E5(), 20000, 4.5f, 1073741824, 1073741824, 0);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
...
{
	if (func_335(iParam0) && func_228(unk_0xA0081090911D13E5()))
	{
		if (iLocal_623 == 0)
		{
			if (unk_0xE2205194B5B97090(unk_0xA0081090911D13E5(), iParam0) && unk_0xFFE4F37124DBE6D9(iParam0))
			{
				func_385("Player knocked Eps over!");
				iLocal_623 = 1;
				iLocal_624 = iParam0;
				unk_0xD3032BAC1ECE011F(iParam0);
			}
		}
		else if (func_335(iLocal_624))
		{
			if (unk_0x5AE21A1C30DF235D(iLocal_624) || unk_0xB6024B1E922B8E1A(iLocal_624))
			{
				if (!func_276() && !unk_0x43589182CF3243AE())
				{
					if (iLocal_624 == Local_606[1 /*8*/])
					{
						if (func_301(&uLocal_168, "EPS4AUD", "EPS4_JKNOCK", 7, 0, 0, 0))
						{
							iLocal_623 = 0;
							iLocal_624 = 0;
						}
					}
					else if (func_301(&uLocal_168, "EPS4AUD", "EPS4_MKNOCK", 7, 0, 0, 0))
					{
						iLocal_623 = 0;
						iLocal_624 = 0;
					}
...
bool func_316(var uParam0, struct<2> Param1, float fParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
{
	unk_0x7DEFCA77DEA2C174(Local_625.f_2, "DEVICE", unk_0xA0081090911D13E5(), "EPSILONISM_04_SOUNDSET", 0, 0);
	if (Local_625.f_13 == 0)
	{
...
void func_319(var uParam0, int iParam1)
{
	if (func_335(*uParam0))
	{
		...
		unk_0xB0993C95A7DBF879(*uParam0);
		unk_0x27327EB62D93CDBA(*uParam0, Local_538[iParam1 /*6*/], 1, 0, 0, 1);
		unk_0x10BB9EA2ADBCF0F3(*uParam0, Local_538[iParam1 /*6*/].f_3);
	}
	else
	{
		uParam0->f_1 = 0;
...
{
	if (func_335(*uParam0) && func_335(unk_0xA0081090911D13E5()))
	{
		uParam0->f_1 = 4;
		uParam0->f_2 = 0;
		unk_0xD5DC2873808A9CB5(*uParam0, unk_0xA0081090911D13E5(), -1, 0, 2);
		if (bParam1)
		{
			unk_0xCD49DDA254A161AF(*uParam0, unk_0xA0081090911D13E5(), 0);
		}
		uParam0->f_4 = { unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1) };
	}
	else
	{
		uParam0->f_1 = 0;
...
int func_325()
{
	...
	unk_0xA9DC3948106CC3E4("rcm_epsilonism4leadinout");
	if (unk_0xAD21C77209FD2024("rcm_epsilonism4") && unk_0xAD21C77209FD2024("rcm_epsilonism4leadinout"))
	{
		return 1;
	}
	return 0;
...
int func_326()
{
	...
	while (iVar0 < iLocal_536)
	{
		unk_0x491067A8E906F22D(Local_363[iVar0 /*43*/]);
		iVar0++;
	}
	unk_0x491067A8E906F22D(uLocal_160);
	unk_0x491067A8E906F22D(joaat("bison"));
	iVar0 = 0;
	while (iVar0 < iLocal_536)
	{
		if (!unk_0x2C1B5A0D3E233FC3(Local_363[iVar0 /*43*/]))
		{
			return 0;
		}
		iVar0++;
	}
	if (!unk_0x2C1B5A0D3E233FC3(iLocal_160) || !unk_0x2C1B5A0D3E233FC3(joaat("bison")))
	{
		return 0;
	}
	return 1;
...
void func_328()
{
	if (unk_0xCAC1D33299EA11C3())
	{
		func_385("Can request assets for cutscene entity in Eps 4");
		unk_0x712525D5B6D169EE("Jimmy_Boston", 1, 0, 0, 0);
		if (func_228(unk_0xA0081090911D13E5()))
		{
			func_287("Michael", unk_0xA0081090911D13E5(), 0, 2);
	...
	if (Local_772.f_3 == 1)
	{
		func_294(1, 1);
		unk_0x6987F23FD8A8D8B0();
		func_385("SKIP: Doing sync for intro skip");
		if (!func_396(0))
		{
			func_286(1, 1, 1);
		}
	...
	if (Local_772.f_1 == 0)
	{
		if (!unk_0xC317719223E13B66())
		{
			unk_0x6946239981A418D8("ep_4_rcm_concat", 8);
		}
		func_385("In Intro setup, waiting for cutscene to be ready...");
		if (func_272(1, 1093140480, 0))
		{
			func_385("Starting intro cutscene...");
			if (func_335(unk_0xA0081090911D13E5()))
			{
				unk_0x6BF154720AFAC26B(unk_0xA0081090911D13E5(), "Michael", 0, 0, 0);
			}
			if (func_335(Local_83.f_28[0]))
			{
				unk_0x6BF154720AFAC26B(Local_83.f_28[0], "Marnie", 0, 0, 0);
			}
			if (func_335(Local_83.f_28[1]))
			{
				unk_0xBB21B5C3111E5F85(Local_83.f_28[1], 0);
				if (func_228(unk_0x1B65C769A2C57865(Local_83.f_28[1])))
				{
					iLocal_641 = func_268(Local_83.f_28[1], joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
					unk_0x6BF154720AFAC26B(iLocal_641, "Artefact_Detector", 0, 0, 0);
				}
				unk_0x6BF154720AFAC26B(Local_83.f_28[1], "Jimmy_Boston", 0, 0, 0);
			}
			if (func_335(unk_0xA0081090911D13E5()))
			{
				unk_0x6BF154720AFAC26B(unk_0xA0081090911D13E5(), "Michael", 0, 0, 0);
			}
			unk_0xB49DAD10DC051295("EPS4_START");
			func_332();
			unk_0x6831F2B0AA3B6439(1);
			unk_0xCD18C12FDC3FB874(0);
			unk_0x4EDE34FBADD967A6(0);
			...
			func_385("Loaded all assets! Moving to intro run loop...");
			Local_772.f_1 = 1;
		}
	}
	if (Local_772.f_1 == 1)
	{
		...
		if (func_228(unk_0xA0081090911D13E5()))
		{
			...
			{
				func_385("*** Forcing Michael's move state");
				func_331(unk_0xA0081090911D13E5(), 1827.161f, 4698.645f, 38.094f, 184.1384f, 0, 1);
				unk_0x8942ADC0DB9F81E4(unk_0xA0081090911D13E5(), iLocal_159, -1, 1, 1);
			}
		}
	...
	if (Local_772.f_1 == 3)
	{
		func_385("Doing intro cleanup and progressing");
		if (!unk_0x7C0379981B7E6E40())
		{
			iLocal_353 = 0;
			func_238(1, 0, 1, 1);
...
void func_329()
{
	...
	if (func_228(Local_606[1 /*8*/]))
	{
		if (unk_0xF467E68A540B1B48("Jimmy_Boston", 0))
		{
			unk_0x776447CD667051CD(1829.8f, 4693.48f, 38.5f, &uVar0, 0);
			unk_0x27327EB62D93CDBA(Local_606[1 /*8*/], 1829.8f, 4693.48f, uVar0, 1, 0, 0, 1);
		}
	}
}
...
void func_330()
{
	if (func_228(Local_606[0 /*8*/]))
	{
		if (unk_0xF467E68A540B1B48("Marnie", 0))
		{
			func_320(&(Local_606[0 /*8*/]), uLocal_762);
			Local_606[0 /*8*/].f_1 = 1;
			Local_606[0 /*8*/].f_2 = 1;
			...
			unk_0xF58CA5EA1A5B2762(Local_606[0 /*8*/], Local_538[Local_606[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 1056964608);
			unk_0xE33751BF671E2013(Local_606[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 1);
			Local_606[0 /*8*/].f_7 = 1;
			func_385("Done Marnie intro exit state");
		}
	}
}
...
void func_333()
{
	...
	{
		func_294(1, 1);
		func_385("SKIP: Doing sync for leadin skip");
		func_286(1, 1, 1);
		Local_772.f_3 = 0;
	}
	if (Local_772.f_1 == 0)
	{
		...
		if (!func_396(0) && unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0))
		{
			func_385("Doing setup for leadin");
			func_318(&uLocal_168, 4, Local_83.f_28[0], "MARNIE", 0, 1);
			if (func_325())
			{
				Local_772.f_1 = 1;
			}
		...
		{
			func_385("Skipping setup for leadin (repeat play/wrong area)");
			Local_772.f_1 = 1;
		}
	}
	if (Local_772.f_1 == 1)
	{
		if ((unk_0xDF658EB6CA91DFBC() - iLocal_354) > 1250)
		{
			unk_0xCEFFD0ED686CCBA0(-1, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
			iLocal_354 = unk_0xDF658EB6CA91DFBC();
		}
		if (!func_396(0) && unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0))
		{
			if (func_227(unk_0xA0081090911D13E5(), Local_83.f_28[0], 1) >= 3f)
			{
				if (!unk_0xFA597181B01136F0())
				{
					if (!iLocal_333)
					{
						...
						{
							unk_0x7F06EF9578636ADC(Local_83.f_28[0], 0f, 0f, 0.2f, 1, 30000, 2000, 2000, 0);
							unk_0xF9972E5A2C83A68B(fLocal_767);
							unk_0xA9678252A5B0205D(fLocal_768);
							unk_0xB4757D7AE1D1D77A(fLocal_769);
							unk_0x16C6902542FDEC3A(fLocal_770);
							unk_0x944FB1B0E1953726(fLocal_771);
							unk_0xDB7CCF634A901817(1);
							if (func_228(unk_0xA0081090911D13E5()))
							{
								unk_0x95C55738CAE00A20(&uLocal_167);
								unk_0xD5DC2873808A9CB5(0, Local_83.f_28[0], 15000, 0, 2);
								unk_0x1429584A1E80336C(0, 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 1193033728);
								unk_0xCD49DDA254A161AF(0, Local_83.f_28[0], 0);
								unk_0x70B222EEA46C37FA(uLocal_167);
								unk_0x3998B29E786DFD96(unk_0xA0081090911D13E5(), uLocal_167);
								unk_0x7DFD14B8B873D6B5(&uLocal_167);
			...
			if (!iLocal_334)
			{
				if (func_335(Local_83.f_28[0]) && !func_276())
				{
					unk_0xD5DC2873808A9CB5(Local_83.f_28[0], unk_0xA0081090911D13E5(), -1, 48, 2);
					unk_0xC9567EA69F3CC4C2(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0, 0, 0, 0);
					unk_0x6987F23FD8A8D8B0();
					unk_0xC9ED8FFB30E7C224("EP_4_RCM_CONCAT", 2, 8);
					func_385("Done Marnie leadin anim - request concat cutscene");
					iLocal_334 = 1;
				}
			}
			else if (func_335(Local_83.f_28[0]))
			{
				if (unk_0x2FB5C9A04733E5EF(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					if (unk_0xAC6AEF29F754B011(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.25f)
					{
						if (!iLocal_335)
						{
							if (func_301(&uLocal_168, "EPS4AUD", "ESP4_RCL", 8, 0, 0, 0))
							{
								func_385("Leadin convo done");
								iLocal_335 = 1;
							}
						}
					}
					if (unk_0xAC6AEF29F754B011(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.95f)
					{
						func_385("Leadin done, launch cutscene");
						func_236(1);
						Local_772.f_1 = 3;
					}
					if (func_227(unk_0xA0081090911D13E5(), Local_83.f_28[0], 1) <= 1.5f)
					{
						unk_0xFDEC0B505BCB00C0(unk_0x0C1D3C552325765B(), false, 0);
						unk_0xD3032BAC1ECE011F(unk_0xA0081090911D13E5());
					}
		...
		{
			func_385("Replay in progress/wrong area, skipping leadin");
			func_236(1);
			Local_772.f_1 = 3;
		}
	}
	if (Local_772.f_1 == 3)
	{
		func_385("Doing leadin cleanup and progressing");
		func_355();
	}
}
...
void func_337(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_69871 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x2C22E7D1C80A53EF())
			{
				...
				Var4 = { func_339(Global_69872, Global_69874, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
struct<2> func_339(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_340(iVar2), 8);
					break;
			}
			break;
...
int func_348(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (((!func_350(0) || Global_69886) || Global_69875 == 1) || !unk_0xB20CA7A3EE29687A())
	{
		return 0;
	}
	switch (Global_69871)
	{
		...
		case 5:
			if ((unk_0x7C0379981B7E6E40() || func_222(0)) || func_349(1))
			{
			}
			else
			{
...
{
	return func_352(iParam0, Global_35775);
}
...
void func_355()
{
	if ((Local_772.f_4 || Local_772.f_5) || Local_772.f_6)
	{
		...
		if (Local_772.f_8 == 1)
		{
			func_385("Sync for skip is TRUE and Intro is queued!");
		}
	}
	else
	{
...
int func_360(var uParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6)
{
	if (iParam5 != 0)
	{
		*uParam0 = iParam5;
		func_385("*** Epsilonist exists, grabbing ped index");
	}
	else
	{
		*uParam0 = unk_0xF8418B3B87CFCCBF(5, iParam6, Param1, fParam4, 1, 1);
		func_385("*** Epsilonist does not exist, creating new");
	}
	if (func_335(*uParam0))
	{
		unk_0x705E4255B39314A7(*uParam0, 132, 1);
		unk_0x65889F26F311FC55(*uParam0, joaat("player"));
		unk_0xC5EFC3500CF4BE6F(*uParam0, 1);
		unk_0xB43604F27F1EAE5F(*uParam0, 0);
		unk_0xEBC040B50DB4346A(*uParam0, 1);
...
void func_361(var uParam0)
{
	...
	Var0 = { uParam0->f_2 };
	func_362("Rock created at: ", uParam0->f_2);
	uParam0->f_1 = unk_0xF7753FE89C776300(*uParam0, Var0, 1, 1, 0);
	if (unk_0xD3FACCDA4D66AEAD(uParam0->f_1))
	{
		unk_0x4A1ACDDF793F9777(uParam0->f_1, uParam0->f_5, 0, 1);
		func_362("Rock rot vector: ", unk_0x3A02D44277FBA4BE(uParam0->f_1, 0));
		func_362("Rock actual position: ", unk_0xC59DF10B4FC39DF8(uParam0->f_1, 0));
		unk_0xDE0EDC55CA40EFE9(uParam0->f_1, 0);
		unk_0xBB21B5C3111E5F85(uParam0->f_1, 1);
	}
}

void func_362(char* sParam0, struct<3> Param1)
{
	sParam0 = sParam0;
	Param1 = { Param1 };
}
...
void func_363()
{
	Local_625.f_2 = unk_0x2657E29E0DD8087E();
	Local_625.f_3 = unk_0x2657E29E0DD8087E();
	Local_625.f_4 = unk_0x2657E29E0DD8087E();
	Local_625.f_5 = unk_0x2657E29E0DD8087E();
	Local_625.f_12 = 0.92f;
	Local_625.f_13 = 0;
	Local_625.f_14 = "NO_RECENT_ANIM";
	uLocal_165 = unk_0x474309DF4921072A("digiscanner");
	while (!unk_0x1E3F61C2C1E29520(uLocal_165))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	...
	unk_0xAF36A5E144D1A146(iLocal_160);
	if (unk_0x3C3FFB3C5310E07E("digiscanner"))
	{
		uLocal_166 = unk_0xA17E85BB0151FB9D("digiscanner");
	}
}
...
void func_365()
{
	func_381(joaat("prop_tv_test"), 1751.65f, 4676.77f, 43.03f, -2.33f, 0.99f, 91.36f);
	func_380(1755.463f, 4678.62f, 44.1477f, -9.5251f, 0f, 122.2955f, 50.832f);
	func_379(3f, -4.5f, 0f);
	func_378(1689.951f, 4762.613f, 40.9216f, 272.5499f);
	func_377(1779.514f, 4691.447f, 39.34577f, 1744.225f, 4674.646f, 46.84829f, 16.5f);
	func_376("EPS4_JCHAT1", sLocal_161);
	func_375("EPS4_JGOOD", "EPS4_JBAD");
	func_374("EPS4_JRET1", "EPS4_JRET2");
	func_373("EPS4_JCLOSE");
	func_372(0f, 0f, 0f);
	func_371(30f, 115f, 0.9f);
	func_381(joaat("prop_battery_01"), 1756.68f, 4832.28f, 39.43f, 90f, 13.21f, 78.57f);
	func_380(1758.032f, 4826.561f, 41.459f, -11.6785f, 0f, 6.5381f, 34.3083f);
	func_379(2f, 4f, 0f);
	func_378(1690.267f, 4769.994f, 40.9216f, 269.3043f);
	func_377(1750.065f, 4833.117f, 36.87026f, 1763.224f, 4831.822f, 43.5425f, 13.75f);
	func_376("EPS4_MCHAT1", "EPS4_MCHAT2");
	func_375("EPS4_MGOOD", "EPS4_MBAD");
	func_374("EPS4_MRET1", "EPS4_MRET2");
	func_373("EPS4_MCLOSE");
	func_372(0f, 0f, 0f);
	func_371(30f, 195f, 0.9f);
	func_381(joaat("prop_old_boot"), 1847.863f, 4756.059f, 36.71f, -70.53f, 75.48f, 132.44f);
	func_380(1829.31f, 4756.158f, 42.4876f, -23.5614f, 0f, -92.2873f, 50f);
	func_379(7.5f, -7.5f, 0f);
	func_378(1689.775f, 4777.77f, 40.9216f, 267.4597f);
	func_377(1856.218f, 4755.223f, 34.67169f, 1841.114f, 4755.489f, 41.43402f, 13.75f);
	func_376("EPS4_PCHAT1", "EPS4_PCHAT2");
	func_375("EPS4_PGOOD", "EPS4_PBAD");
	func_374(sLocal_161, "EPS4_PRET2");
	func_373("EPS4_PCLOSE");
	func_372(0f, 0f, 0f);
	func_371(20.5f, 155f, 0.9f);
	func_370(1820.101f, 4701.099f, 38.545f, 280.7432f, 0);
	func_370(1803.044f, 4700.244f, 39.3123f, 72.1396f, 0);
	func_370(1820.482f, 4672.535f, 35.6368f, 253.4126f, 0);
	func_370(1819.87f, 4694.03f, 38.408f, 231.2265f, 0);
	func_370(1807.122f, 4684.418f, 38.5566f, 150.6129f, 0);
	func_370(1791.058f, 4689.403f, 40.5128f, 103.4073f, 0);
	func_370(1872.626f, 4718.827f, 37.2889f, 210.8288f, 1);
	uLocal_760 = func_370(1764.089f, 4665.879f, 42.3031f, 281.6336f, 2);
	uLocal_762 = func_370(1814.27f, 4651.32f, 37.58f, 173.1089f, 0);
	iLocal_761 = func_370(1846.512f, 4705.614f, 38.1214f, 25.7591f, 3);
	uLocal_763 = func_370(1790.414f, 4722.897f, 37.8533f, 221.4777f, 0);
	func_369(&uLocal_642);
	func_368(&uLocal_642, 1897.42f, 4596.51f, 36.4f);
	func_368(&uLocal_642, 1912.2f, 4676.93f, 39.44f);
	func_368(&uLocal_642, 1886.09f, 4733.68f, 39.48f);
	func_368(&uLocal_642, 1800.24f, 4820.64f, 40.96f);
	func_368(&uLocal_642, 1796.556f, 4893.541f, 40.4741f);
	func_368(&uLocal_642, 1782.651f, 4916.333f, 41.4418f);
	func_368(&uLocal_642, 1746.552f, 4942.362f, 42.8677f);
	func_368(&uLocal_642, 1702.537f, 4893.824f, 36.7751f);
	func_368(&uLocal_642, 1707.273f, 4814.81f, 40.9407f);
	func_368(&uLocal_642, 1729.46f, 4655.21f, 42.61f);
	func_368(&uLocal_642, 1772.05f, 4602.143f, 36.457f);
	func_367(&uLocal_642);
	func_366(&uLocal_694, &uLocal_642, 20f);
}
...
void func_366(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_316(uParam1, *(uParam1[iVar1 /*3*/]) + Var9))
		{
			Var9 = { -Var9 };
		}
...
void func_378(struct<3> Param0, float fParam3)
{
	int iVar0;
...
void func_380(struct<3> Param0, struct<3> Param3, float fParam6)
{
	int iVar0;
...
void func_381(int iParam0, struct<3> Param1, struct<3> Param4)
{
	int iVar0;
...
void func_383()
{
	if (unk_0xC0691D80D21C989D(unk_0x0C1D3C552325765B()))
	{
		if (unk_0x39FEE545B315414E(unk_0xA0081090911D13E5(), 0))
		{
			if (func_279(unk_0xF8DB47D339B8B953(unk_0xA0081090911D13E5(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
var func_386(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
...
int func_388(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			func_395(&(uParam0->f_48), "rcm_epsilonism4", "ep_4_rcm_marnie_base_marnie", "ep_4_rcm_marnie_lookaround_marnie");
			iLocal_79 = 1;
			break;
		...
		case 2:
			...
			if (func_335(unk_0xA0081090911D13E5()))
			{
				uVar5 = unk_0x0EAE41B4E693BA70(unk_0xA0081090911D13E5());
			}
			if (!unk_0xD3FACCDA4D66AEAD(uParam0->f_28[0]))
			{
				if (func_389(&(uParam0->f_28[0]), 60, 1826.13f, 4698.88f, 38.92f, 21.63f, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
					unk_0x65889F26F311FC55(uParam0->f_28[0], uVar5);
			...
			{
				if (func_389(&(uParam0->f_28[1]), 55, 1827.24f, 4699.76f, 39.09f, 57.09f, "EPSILON LAUNCHER RC - JIMMY", 1))
				{
					unk_0x65889F26F311FC55(uParam0->f_28[1], iVar5);
					unk_0x705E4255B39314A7(uParam0->f_28[1], 132, 1);
					unk_0xA4C961D96B05ABB2(uParam0->f_28[1], 1, 0, 0, false);
					unk_0xD3032BAC1ECE011F(uParam0->f_28[1]);
					unk_0x8942ADC0DB9F81E4(uParam0->f_28[1], joaat("weapon_digiscanner"), -1, 1, 1);
					unk_0xC9567EA69F3CC4C2(uParam0->f_28[1], "rcm_epsilonism4", "ep_4_rcm_jimmyboston_base_jb", 8f, -8f, -1, 1, 0, 0, 0, 0);
					func_331(uParam0->f_28[1], 1827.24f, 4699.76f, 39.09f, 57.09f, 1, 1);
				}
				else
				{
					bVar4 = false;
...
void func_398()
{
	...
	if (func_400())
	{
		func_385("...Random Character Script was triggered so additional cleanup required");
	}
	if (func_335(unk_0xA0081090911D13E5()))
	{
		unk_0xB09984D51448364F(unk_0xA0081090911D13E5(), iLocal_159);
		unk_0x2538B3290C0E12F3(unk_0xA0081090911D13E5(), joaat("weapon_unarmed"), 1);
		unk_0xD3032BAC1ECE011F(unk_0xA0081090911D13E5());
		unk_0x5AE6931F30A8F4F2(unk_0xA0081090911D13E5(), 0f);
	}
	if (unk_0x9726BE1252F8F0B6())
	{
		unk_0x2E1E57681BD2050A();
	}
	unk_0xD1F045BC375C4E41(uLocal_360);
	if (func_228(Local_606[0 /*8*/]) && func_228(Local_606[1 /*8*/]))
	{
		if (unk_0x5D586EFF7D308A80(Local_606[0 /*8*/]))
		{
			unk_0x988206841442D7CE(Local_606[0 /*8*/]);
		}
		else if (unk_0x5D586EFF7D308A80(Local_606[1 /*8*/]))
		{
			unk_0x988206841442D7CE(Local_606[1 /*8*/]);
		}
	}
	func_399(&(Local_606[0 /*8*/]), 1, 1, 1);
	func_399(&(Local_606[1 /*8*/]), 1, 1, 1);
	unk_0xC09719D492EA1AB2("digiscanner");
	unk_0x322323456FCFAB4D(uLocal_162, 0);
	unk_0x322323456FCFAB4D(uLocal_163, 0);
	unk_0x30469355CB7C8815(iLocal_764);
	unk_0x30469355CB7C8815(iLocal_765);
	unk_0x30469355CB7C8815(iLocal_766);
	if (unk_0x6DEB8F88FFE09057("EPSILONISM_04_MIX"))
	{
		func_385("Stopping dynamic mix EPSILONISM_04_MIX");
		unk_0x7C1793252FA472B6("EPSILONISM_04_MIX");
	}
...
void func_401(bool bParam0)
{
	...
	if (!func_416())
	{
		...
		{
			func_176(iVar0, 1, 0);
			func_402(unk_0x367152330DB70D69(), iVar0);
		}
		else
		{
			if (Global_100640[iVar0 /*10*/].f_9 == -1)
...
int func_403(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_409())
	{
		...
		{
			iVar33 = func_404(unk_0x367152330DB70D69());
			if (iVar33 > -1)
			{
...
int func_405()
{
	...
	iVar0 = func_406(&(Global_91406.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_409()
{
	...
	{
		if (func_404(&(Global_91406.f_3)) > -1)
		{
			return 1;
		}
	}
