...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_80 = func_420(60);
	uLocal_81 = func_420(14);
	...
	uLocal_160 = unk_0x42CD683647CA9201(iLocal_159);
	sLocal_161 = "empty";
	iLocal_339 = 1;
	iLocal_764 = -1;
	iLocal_765 = -1;
	...
	if (func_396() || func_395(0))
	{
		Global_69734 = 1;
		iLocal_79 = 0;
		while (!func_387(&Local_83))
		{
	...
	uLocal_162 = func_386();
	uLocal_163 = func_385(1855.08f, 4755.85f, 36.81f, 25f);
	iLocal_764 = unk_0x1CFFA4F4C25D434F(1815.39f, 4698f, 38.87f, 3.5f, 3.5f, 3f, 0f, 0, 7);
	iLocal_765 = unk_0x1CFFA4F4C25D434F(1824.12f, 4701.39f, 38.29f, 2.5f, 2.5f, 2.5f, 0f, 0, 7);
	iLocal_766 = unk_0x1CFFA4F4C25D434F(1801.28f, 4700.25f, 39.42f, 2f, 2f, 2f, 0f, 0, 7);
	if (!unk_0x159730DB57D995D0("EPSILONISM_04_MIX"))
	{
		func_384("Starting dynamic mix EPSILONISM_04_MIX");
		unk_0xF8B012FD1C255840("EPSILONISM_04_MIX");
	}
	unk_0x229773841C1D2E13(0);
	unk_0xED5347CD6B7B01FA(1, joaat("player"), joaat("player"));
	unk_0xE71148ED586F1ED1(0.5f);
	uLocal_360 = unk_0x375EAC50583E76FE(1751.65f, 4676.77f, 43.03f, 1.5f);
	func_381();
	func_364();
	func_363();
	Local_772.f_0 = 0;
	...
	{
		func_360(&(Local_363[iVar0 /*43*/]));
		iVar0++;
	}
	func_359(&(Local_606[0 /*8*/]), Local_151, fLocal_154, Local_83.f_28[0], 0);
	func_359(&(Local_606[1 /*8*/]), Local_155, fLocal_158, Local_83.f_28[1], 0);
	if (func_396())
	{
		if (func_358() == 0)
		{
			func_357(Local_147, fLocal_150, 1, 0);
			func_356(1);
			func_355(&Local_83, 0, 1);
			func_354();
			func_384("Done replay setup");
		}
	}
	else if (func_395(0))
	{
		func_357(Local_147, fLocal_150, 1, 0);
		func_356(0);
		func_355(&Local_83, 1, 1);
		func_354();
	}
	func_352(60, 0, 0);
	while (true)
	{
		unk_0x14CA049761F06FFB("SF_Epsilon4", 0);
		func_336(Local_83.f_9, 0, 0, 0, 0, 0);
		unk_0xF9C8589CC0ECFE13(unk_0x4D29100D094E5511());
		if (func_335())
		{
		...
		if (func_334(unk_0x27D769C59BC9D030()))
		{
			if (func_333(unk_0x27D769C59BC9D030()) == iLocal_159)
			{
...
void func_1()
{
	...
	switch (Local_772.f_1)
	{
		case 0:
			...
			if (unk_0xC1C5B83BB6719C6C(sVar0, sLocal_161))
			{
				func_400(1);
			}
			else
...
void func_11()
{
	...
	unk_0x88172B3983EC5071("weapons@holster_1h");
	while (func_333(unk_0x27D769C59BC9D030()) == iLocal_159)
	{
		unk_0x4EDE34FBADD967A6(0);
		unk_0x28981D48C12CB95E(2);
		if (unk_0x482101C9B3483958("weapons@holster_1h"))
		{
			if (!unk_0xF4954568C87BA772(unk_0x27D769C59BC9D030(), "weapons@holster_1h", "holster", 3))
			{
				unk_0x878D12AEFBF5BAF0(unk_0x27D769C59BC9D030(), "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			else if (unk_0x45BFA2594AA26529(unk_0x27D769C59BC9D030(), "weapons@holster_1h", "holster") >= 0.5f)
			{
	...
	if (iVar0 < 12)
	{
		unk_0xE2A8B026FA4DDFFF(joaat("num_epsilon_step"), 12, 1);
		func_12(23, 12);
	}
	func_397();
}
...
int func_13(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar20 = 0;
		func_19(&iVar20);
		iVar21 = func_18(Var10, Global_101154.f_6378.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_16(Global_101154.f_6378.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_14(Global_101154.f_6378.f_765[iVar20 /*10*/]))
				{
					Global_101154.f_6378.f_765[iVar20 /*10*/] = { Var10 };
					func_15(&Var10);
					return 1;
...
void func_19(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_18(Global_101154.f_6378.f_765[iVar0 /*10*/], Global_101154.f_6378.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
int func_215()
{
	return func_216(unk_0x3AA961419D971CB2(), 0);
}
...
void func_223()
{
	unk_0x972F93B6DF7649AC(Local_625.f_2);
	unk_0x972F93B6DF7649AC(Local_625.f_3);
	unk_0x972F93B6DF7649AC(Local_625.f_4);
	unk_0x972F93B6DF7649AC(Local_625.f_5);
	Local_625.f_6 = 0;
	Local_625.f_7 = 0;
}
...
void func_225()
{
	switch (Local_772.f_1)
	{
		case 0:
			...
			unk_0x28981D48C12CB95E(2);
			unk_0xB1F866D7C20C5E2D(unk_0x27D769C59BC9D030(), iLocal_159);
			Local_772.f_1 = 1;
			break;
		...
		case 1:
			...
			else if (unk_0x2006A8C1BA2AFE80(Local_606[0 /*8*/], 0))
			{
				func_235(6);
				Local_772.f_9 = 2;
				Local_772.f_1 = 3;
			}
			else if (unk_0x2006A8C1BA2AFE80(Local_606[1 /*8*/], 0))
			{
				func_235(6);
				Local_772.f_9 = 3;
				Local_772.f_1 = 3;
			}
			else if (unk_0x77F1B7F6C32990D6(Local_606[0 /*8*/], unk_0x27D769C59BC9D030(), 1) && unk_0x6AE62C1DA604CA92(Local_606[0 /*8*/], 0, 2))
			{
				func_235(6);
				Local_772.f_9 = 4;
				Local_772.f_1 = 3;
			}
			else if (unk_0x77F1B7F6C32990D6(Local_606[1 /*8*/], unk_0x27D769C59BC9D030(), 1) && unk_0x6AE62C1DA604CA92(Local_606[1 /*8*/], 0, 2))
			{
				func_235(6);
				Local_772.f_9 = 5;
				Local_772.f_1 = 3;
			...
			else if (func_228(&(Local_606[1 /*8*/])))
			{
				func_235(6);
				Local_772.f_9 = 7;
				Local_772.f_1 = 3;
			}
			else if (func_227(Local_606[0 /*8*/]))
			{
				if (func_226(unk_0x27D769C59BC9D030(), Local_606[0 /*8*/], 1) >= 50f)
				{
...
{
	if (func_229(*uParam0, 1090519040, 1097859072))
	{
		return 1;
	}
	return 0;
...
int func_229(int iParam0, int iParam1, float fParam2)
{
	if (func_227(iParam0))
	{
		...
		if (func_230(iParam0, fParam2, 0, 0))
		{
			return 1;
		}
	}
...
void func_236()
{
	...
	if (Local_772.f_3 == 1)
	{
		...
		if (iLocal_353 == 0)
		{
			func_292("EPS_4_MCS_1");
		}
		else if (iLocal_353 == 1)
		{
			func_292("EPS_4_MCS_2");
		}
		else
		{
			func_292("EPS_4_MCS_3");
		}
		if (unk_0x95921D2FB0B6ACDD())
		{
			func_384("Trying to set player component variation");
			if (func_227(unk_0x27D769C59BC9D030()))
			{
				func_286("Michael", unk_0x27D769C59BC9D030(), 0, 2);
			}
			if (iLocal_353 == 0 || iLocal_353 == 2)
			{
				func_384("Trying to set Jimmy prop variation");
				unk_0xEBCFA81EA7447178("Jimmy_Boston", 1, 0, 0, 0);
			}
		}
		func_384("SKIP: Doing sync for cutscene skip");
		func_285(1, 1, 1);
		Local_772.f_3 = 0;
	}
	if (Local_772.f_1 == 0)
	{
		func_284("Doing setup for RockScene:", iLocal_353);
		func_282(1);
		func_281();
		unk_0x09942629F73A2BD5(0, 200, 150);
		if (unk_0x95921D2FB0B6ACDD())
		{
			func_384("Trying to set player component variation");
			if (func_227(unk_0x27D769C59BC9D030()))
		...
		if (!func_280(iLocal_362))
		{
			iLocal_362 = unk_0x4E76306EE6AE7596(joaat("bison"), 1851.57f, 4772.12f, 39.8f, 31.35f, 1, 1);
			unk_0xFD2475756036347D(iLocal_362, 157, 157);
			unk_0x85E88CC5C37A1A11(iLocal_362, 5, 157);
			unk_0xFA3ED0FFF3FD8F34(iLocal_362);
		}
		func_279(&(Local_606[1 /*8*/]), 1);
		func_279(&(Local_606[0 /*8*/]), 1);
		if (func_334(unk_0x27D769C59BC9D030()))
		{
			while (!func_271(1, 1093140480, 0))
			{
				func_384("Waiting for cutscene to be OK to start...");
				unk_0x28981D48C12CB95E(2);
				func_282(1);
				func_281();
				unk_0x09942629F73A2BD5(0, 200, 150);
			...
			unk_0x83D40CC4E43B3657(unk_0x4D29100D094E5511(), 1);
			iVar0 = unk_0xA0F74982C6AAA9D4();
			while ((unk_0xA0F74982C6AAA9D4() - iVar0) < 500)
			{
				func_384("Doing 500ms pause");
				unk_0x28981D48C12CB95E(2);
				unk_0x83D40CC4E43B3657(unk_0x4D29100D094E5511(), 1);
				func_282(1);
				func_281();
			...
			if (iLocal_353 == 0)
			{
				if (func_227(Local_606[1 /*8*/]))
				{
					unk_0x90F1D412CA4CF490(Local_606[1 /*8*/], "Jimmy_Boston", 0, 0, 0);
				}
				if (func_227(Local_606[0 /*8*/]))
				{
					unk_0x90F1D412CA4CF490(Local_606[0 /*8*/], "Marnie", 0, 0, 0);
				}
				if (func_227(unk_0x27D769C59BC9D030()))
				{
					unk_0x90F1D412CA4CF490(unk_0x27D769C59BC9D030(), "Michael", 0, 0, 0);
				}
				if (func_227(Local_625.f_0))
				{
					iLocal_641 = func_267(unk_0x27D769C59BC9D030(), joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
					unk_0x90F1D412CA4CF490(iLocal_641, "Artefact_Detector", 0, 0, 0);
				}
				if (func_227(Local_363[iLocal_353 /*43*/].f_1))
				{
					unk_0x90F1D412CA4CF490(Local_363[iLocal_353 /*43*/].f_1, "EPS_TV", 0, 0, 0);
				}
			}
			else if (iLocal_353 == 1)
			{
				...
				if (func_227(Local_363[iLocal_353 /*43*/].f_1))
				{
					unk_0x90F1D412CA4CF490(Local_363[iLocal_353 /*43*/].f_1, "EPS_Battery", 0, 0, 0);
				}
			}
			else
			{
				...
				if (func_227(Local_363[iLocal_353 /*43*/].f_1))
				{
					unk_0x90F1D412CA4CF490(Local_363[iLocal_353 /*43*/].f_1, "Old_Boot", 0, 0, 0);
				}
			}
			unk_0xBC7FB8D910011C75(0);
			unk_0x8D1A4408D797A1F3(1);
			iVar0 = unk_0xA0F74982C6AAA9D4();
			while ((unk_0xA0F74982C6AAA9D4() - iVar0) < 1)
			{
				unk_0x28981D48C12CB95E(2);
				unk_0x4EDE34FBADD967A6(0);
				unk_0x14CA049761F06FFB("SF_Epsilon4", 0);
			...
			if (iLocal_353 >= 2)
			{
				if (func_227(unk_0x27D769C59BC9D030()))
				{
					unk_0xAC9A80BE63D6295F(unk_0x27D769C59BC9D030(), joaat("weapon_unarmed"), -1, 1, 1);
				}
			}
			unk_0x83D40CC4E43B3657(unk_0x4D29100D094E5511(), 0);
			func_258(Local_363[iLocal_353 /*43*/].f_25, Local_363[iLocal_353 /*43*/].f_28, Local_363[iLocal_353 /*43*/].f_31, Local_363[iLocal_353 /*43*/].f_32, Local_363[iLocal_353 /*43*/].f_35, func_266(), 1, 1, 1, 0, 0);
			func_253(Local_363[iLocal_353 /*43*/].f_2, 1, 0, 1, 1, 1, 1, 0, 1, 1, 1);
		}
		func_284("Finished setup, moving to run loop for RockScene #:", iLocal_353);
		Local_772.f_1 = 1;
	}
	if (Local_772.f_1 == 1)
	{
		...
		else
		{
			if (iLocal_353 >= 2)
			{
				...
				{
					if (unk_0x692A7BCA51FD25CC() > 17000)
					{
						if (!unk_0x9A7F0D797C57AC34())
						{
							unk_0x048C2DF809E4EFCA(1847.472f, 4756.157f, 36.6968f, func_251(271.4718f), 145f, 0);
						}
					}
				}
			}
			if (Local_772.f_2 == 0)
			{
				...
				{
					Local_772.f_2 = -1;
					func_384("Cutscene not active, setting event -1");
				}
			}
			if (Local_772.f_2 == 1)
			{
			...
			if (Local_772.f_2 == -1)
			{
				...
				if (iLocal_353 >= 2)
				{
					unk_0x68BD4F826EFDDC53("EPS4_STOP");
					func_5(&(Local_363[iLocal_353 /*43*/].f_1));
				}
				Local_772.f_1 = 3;
				iLocal_353++;
				func_284("END CUTSCENE: iCurrentRock = ", iLocal_353);
			}
		}
	}
	if (Local_772.f_1 == 3)
	{
		...
		func_384("Doing cleanup for RockScene");
		func_237(1, 0, 1, 1);
		func_354();
	}
}
...
void func_238(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!unk_0xE4F7206742848BAF(unk_0x27D769C59BC9D030()) && !func_242(unk_0x4D29100D094E5511())) && !func_240(unk_0x4D29100D094E5511(), 0)) && !func_239())
			{
				unk_0xDC994C828DF12354(unk_0x27D769C59BC9D030(), 0);
			}
		}
		else if (!unk_0xE4F7206742848BAF(unk_0x27D769C59BC9D030()) && !func_242(unk_0x4D29100D094E5511()))
		{
			unk_0xDC994C828DF12354(unk_0x27D769C59BC9D030(), 0);
		}
		Global_69487 = 0;
...
void func_246()
{
	unk_0x8CED8F78CC31BEF2(uLocal_165, "SET_COLOUR");
	...
	unk_0x8CED8F78CC31BEF2(uLocal_165, "SET_DISTANCE");
	unk_0x4ACF99392701B935(10f);
	unk_0x7E5FA681CB7A2EF7();
	unk_0x6989B1F0868251F4(uLocal_166);
	unk_0xFF51FA5E68E9F7D4(uLocal_165, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
}
...
int func_247()
{
	if (func_227(unk_0x27D769C59BC9D030()))
	{
		if (unk_0x1F12913CC4103895("Michael", 0))
		{
			if (iLocal_353 >= 2)
			{
				func_384("*** Forcing Michael's move state (end cutscene)");
				unk_0x9B6055629FB6CC23(unk_0x27D769C59BC9D030(), joaat("MotionState_Idle"), 0, 1, 0);
				return 1;
			}
			else
			{
				func_384("*** Forcing Michael's move state");
				if (func_333(unk_0x27D769C59BC9D030()) != iLocal_159)
				{
					unk_0xAC9A80BE63D6295F(unk_0x27D769C59BC9D030(), iLocal_159, -1, 1, 1);
				}
				unk_0x9B6055629FB6CC23(unk_0x27D769C59BC9D030(), joaat("MotionState_Idle"), 0, 1, 0);
				return 1;
			}
...
void func_248()
{
	if (func_227(Local_606[1 /*8*/]))
	{
		if (unk_0x1F12913CC4103895("Jimmy_Boston", 0))
		{
			if (iLocal_353 >= 2)
			{
				if (func_227(Local_83.f_28[1]) && func_280(iLocal_362))
				{
					unk_0x33A0CEA494F4C2A3(&uLocal_782);
					unk_0xA62C2DE6090B87D5(0, iLocal_362, 0);
					unk_0x33F83FC0F5F458E3(uLocal_782);
					unk_0x8B8674266D533E9F(Local_83.f_28[1], uLocal_782);
					unk_0x433C209504FBC7EE(&uLocal_782);
					func_384("Did Jimmy pass exit");
				}
			}
			else
			{
				unk_0x3D09311EB0F37652(Local_83.f_28[1], 1764.089f, 4665.879f, 42.3031f, 1f, 20000, 1193033728, 1056964608);
				func_384("Did Jimmy regular exit");
			}
			unk_0x9B6055629FB6CC23(Local_606[1 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
		}
	}
}
...
void func_249()
{
	if (func_227(Local_606[0 /*8*/]))
	{
		if (unk_0x1F12913CC4103895("Marnie", 0))
		{
			if (iLocal_353 >= 2)
			{
				if (func_227(Local_83.f_28[0]) && func_280(iLocal_362))
				{
					unk_0x33A0CEA494F4C2A3(&uLocal_782);
					unk_0xA62C2DE6090B87D5(0, iLocal_362, -1);
					unk_0x395AA67734CB52F2(0, iLocal_362, 1743.33f, 4962.18f, 45.16f, 20f, 0, joaat("bison"), 786599, 5f, -1f);
					unk_0xF55CF905F405E357(0, iLocal_362, 30f, 262275);
					unk_0x33F83FC0F5F458E3(uLocal_782);
					unk_0x8B8674266D533E9F(Local_83.f_28[0], uLocal_782);
					unk_0x433C209504FBC7EE(&uLocal_782);
					func_384("Did Marnie pass exit");
				}
			}
			else
			{
				unk_0xE4A57337AE998385(Local_83.f_28[0], unk_0xD7C4E2CB0B216852(Local_83.f_28[0], 0f, 7f, 0f), 1f, 20000, 0.25f, 5, 1193033728);
				func_384("Did Marnie regular exit");
			}
			unk_0x9B6055629FB6CC23(Local_606[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
		}
	}
}
...
void func_250()
{
	if (func_227(iLocal_641))
	{
		if (unk_0x1F12913CC4103895("Artefact_Detector", 0))
		{
			if (iLocal_353 < 2)
			{
				func_384("*** Detector exit");
				unk_0x20BC45257DB52111(iLocal_641, unk_0x27D769C59BC9D030());
				func_5(&iLocal_641);
				if (!unk_0xD2CFFE76B625AE55(Local_625.f_0))
				{
					func_384("*** Recreating gDetector.hObj after cutscene...");
					Local_625.f_0 = unk_0x023309AF6DD689A2(unk_0x27D769C59BC9D030());
				}
			}
			else
			{
				func_384("*** Detector exit (end cutscene)");
				func_5(&iLocal_641);
			}
		}
	}
...
Vector3 func_251(float fParam0)
{
...
int func_252()
{
	...
	else if (unk_0x2006A8C1BA2AFE80(Local_606[0 /*8*/], 0))
	{
		if (iLocal_353 < 2)
		{
			...
			Local_772.f_9 = 2;
			Local_772.f_1 = 3;
			func_384("Mission failed: Marnie dead");
			return 1;
		}
	}
	else if (unk_0x2006A8C1BA2AFE80(Local_606[1 /*8*/], 0))
	{
		if (iLocal_353 < 2)
		{
			...
			Local_772.f_9 = 3;
			Local_772.f_1 = 3;
			func_384("Mission failed: Jimmy dead");
			return 1;
		}
	}
	else if (unk_0x77F1B7F6C32990D6(Local_606[0 /*8*/], unk_0x27D769C59BC9D030(), 1) && unk_0x6AE62C1DA604CA92(Local_606[0 /*8*/], 0, 2))
	{
		...
		Local_772.f_9 = 4;
		Local_772.f_1 = 3;
		func_384("Mission failed: Marnie injured");
		return 1;
	}
	else if (unk_0x77F1B7F6C32990D6(Local_606[1 /*8*/], unk_0x27D769C59BC9D030(), 1) && unk_0x6AE62C1DA604CA92(Local_606[1 /*8*/], 0, 2))
	{
		...
		Local_772.f_9 = 5;
		Local_772.f_1 = 3;
		func_384("Mission failed: Jimmy injured");
		return 1;
	}
	return 0;
}
...
void func_253(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0x2DB75A8F096AB1F1(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x90CDF5C9FC20A5BF(func_255(unk_0xB927AFB90873B8C1()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
{
	func_259(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}
...
int func_267(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	while (func_269(iVar2, iVar8) != 0)
	{
		if (!unk_0x2006A8C1BA2AFE80(iParam0, 0))
		{
			if (unk_0x533B5E3EE659E0D8(iParam0, iVar2, func_269(iVar2, iVar8)))
			{
				if (func_268(func_269(iVar2, iVar8)))
				{
					uVar9 = unk_0x92A0372C5411D3CC(func_269(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_269(iVar2, iVar8) != 0)
	{
		if (!unk_0x2006A8C1BA2AFE80(iParam0, 0))
		{
			if (unk_0x533B5E3EE659E0D8(iParam0, iVar2, func_269(iVar2, iVar8)))
			{
				unk_0x7CC49C889B63D0BB(uVar1, func_269(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
int func_271(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x9A4E2270C2271219(unk_0x27D769C59BC9D030(), 0))
	{
		...
		{
			if (!func_278(unk_0xD9FFE8E1642C81E2(unk_0x27D769C59BC9D030(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_279(var uParam0, bool bParam1)
{
	if (func_334(*uParam0))
	{
		...
		if (bParam1)
		{
			unk_0x09D2BE36C9D2B76F(*uParam0);
		}
		else
		{
		...
		if (unk_0x17297F499604E052(*uParam0))
		{
			unk_0xBFE5E4F12033E3EF(*uParam0);
		}
	}
	else
	{
...
{
	unk_0x8CED8F78CC31BEF2(uLocal_165, "SET_COLOUR");
	unk_0xD2DC8221939F80F7(67);
	unk_0xD2DC8221939F80F7(200);
	unk_0xD2DC8221939F80F7(255);
	unk_0xD2DC8221939F80F7(255);
	unk_0xD2DC8221939F80F7(209);
	unk_0xD2DC8221939F80F7(67);
	unk_0xD2DC8221939F80F7(255);
...
void func_282(int iParam0)
{
	if (iParam0 == 1)
	{
		if (func_283())
		{
			if ((unk_0xC1C5B83BB6719C6C(Local_625.f_14, "NO_RECENT_ANIM") || !unk_0xF4954568C87BA772(Local_625.f_0, "rcm_epsilonism4", Local_625.f_14, 3)) || unk_0x45BFA2594AA26529(Local_625.f_0, "rcm_epsilonism4", Local_625.f_14) >= 0.98f)
			{
				if (fLocal_640 > 80f)
				{
				...
				unk_0x7318FEB27BFEAB70(Local_625.f_0, Local_625.f_14, "rcm_epsilonism4", 16f, 0, 0, 0, 0, 0);
			}
		}
	}
	else if (func_283())
	{
		if (!unk_0xC1C5B83BB6719C6C(Local_625.f_14, "NO_RECENT_ANIM"))
		{
			if (unk_0xF4954568C87BA772(Local_625.f_0, "rcm_epsilonism4", Local_625.f_14, 1))
			{
				if (unk_0x45BFA2594AA26529(Local_625.f_0, "rcm_epsilonism4", Local_625.f_14) <= 0.05f)
				{
					unk_0xCF2E232F96B927E2(Local_625.f_0, Local_625.f_14, "rcm_epsilonism4", -4f);
...
void func_287(int iParam0, var uParam1, int iParam2)
{
	...
	func_288(iParam0, &Var2, 0);
	func_288(iParam0, uParam1, iParam2);
	iVar82 = 0;
	iVar83 = 0;
	iVar0 = 0;
	while (iVar0 < 12)
...
void func_295()
{
	...
	if (Local_772.f_3 == 1)
	{
		...
		if (iLocal_353 == 0)
		{
			if (!func_322())
			{
				unk_0x4EEE9D9427E70F4E(unk_0x27D769C59BC9D030(), Local_147, 1, 0, 0, 1);
				unk_0xFBDCF3D5834B58D8(unk_0x27D769C59BC9D030(), fLocal_150);
			}
			func_279(&(Local_606[1 /*8*/]), 1);
			func_279(&(Local_606[0 /*8*/]), 1);
			if (func_334(Local_606[1 /*8*/]))
			{
				unk_0xA8CA82EB31D1626F(Local_83.f_28[1], 0);
				unk_0x4EEE9D9427E70F4E(Local_606[1 /*8*/], 1829.75f, 4693.5f, 38.51f, 1, 0, 0, 1);
				unk_0xFBDCF3D5834B58D8(Local_606[1 /*8*/], 27.46f);
				Var2 = { unk_0xA8CFDE65C45F813B(Local_606[1 /*8*/], 1) };
				unk_0xF1F1EBE69E9A0DE7(1829.75f, 4693.5f, 38.51f, &fVar1, 0);
				unk_0x4EEE9D9427E70F4E(Local_606[1 /*8*/], Var2.f_0, Var2.f_1, fVar1, 1, 0, 0, 1);
				func_384("Setting Jimmy position (0)");
			}
			if (func_334(Local_606[0 /*8*/]))
			{
				unk_0x4EEE9D9427E70F4E(Local_606[0 /*8*/], 1827.32f, 4692.59f, 38.53f, 1, 0, 0, 1);
				unk_0xFBDCF3D5834B58D8(Local_606[0 /*8*/], 171.22f);
				func_384("Setting Marnie position (0)");
			}
		}
		else if (iLocal_353 == 1)
		{
			unk_0x4EEE9D9427E70F4E(unk_0x27D769C59BC9D030(), 1754.634f, 4675.789f, 42.9068f, 1, 0, 0, 1);
			unk_0xFBDCF3D5834B58D8(unk_0x27D769C59BC9D030(), 293.2275f);
			if (func_334(Local_606[1 /*8*/]))
			{
				unk_0x4EEE9D9427E70F4E(Local_606[1 /*8*/], 1758.586f, 4670.085f, 42.6276f, 1, 0, 0, 1);
				unk_0xFBDCF3D5834B58D8(Local_606[1 /*8*/], 262.4368f);
				func_384("Setting Jimmy position (1)");
			}
			if (func_334(Local_606[0 /*8*/]))
			{
				unk_0x4EEE9D9427E70F4E(Local_606[0 /*8*/], 1759.917f, 4683.584f, 42.7266f, 1, 0, 0, 1);
				unk_0xFBDCF3D5834B58D8(Local_606[0 /*8*/], 148.3211f);
				func_384("Setting Marnie position (1)");
			}
		}
		else if (iLocal_353 == 2)
		{
			unk_0x4EEE9D9427E70F4E(unk_0x27D769C59BC9D030(), 1758.454f, 4829.431f, 39.729f, 1, 0, 0, 1);
			unk_0xFBDCF3D5834B58D8(unk_0x27D769C59BC9D030(), 168.2012f);
			if (func_334(Local_606[0 /*8*/]))
			{
				unk_0x4EEE9D9427E70F4E(Local_606[0 /*8*/], 1755.005f, 4827.329f, 40.0736f, 1, 0, 0, 1);
				unk_0xFBDCF3D5834B58D8(Local_606[0 /*8*/], 169.6486f);
				func_384("Setting Marnie position (2)");
			}
		}
	...
	if (Local_772.f_1 == 0)
	{
		func_284("Doing setup for FindRock section:", iLocal_353);
		func_279(&(Local_606[1 /*8*/]), 0);
		iLocal_350 = 0;
		iLocal_352 = 0;
		iLocal_623 = 0;
		iLocal_359 = -1;
		iLocal_753 = 0;
		iLocal_754 = 0;
		iLocal_755 = unk_0xA0F74982C6AAA9D4();
		iLocal_757 = unk_0xA0F74982C6AAA9D4();
		iLocal_758 = 0;
		if (iLocal_353 == 0)
		{
			if (func_334(unk_0x27D769C59BC9D030()))
			...
			if (func_334(Local_606[1 /*8*/]))
			{
				unk_0xB1F866D7C20C5E2D(Local_606[1 /*8*/], iLocal_159);
				unk_0xE4A57337AE998385(Local_606[1 /*8*/], 1826.246f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 1193033728);
			}
			func_320(&(Local_606[1 /*8*/]), 1);
			iLocal_748 = 8;
			iLocal_749 = 8;
			iLocal_751 = 0;
			iLocal_750 = 0;
		...
		else if (iLocal_353 == 1)
		{
			...
			func_320(&(Local_606[0 /*8*/]), 0);
			func_319(&(Local_606[1 /*8*/]), uLocal_760);
			iLocal_748 = 8;
			iLocal_749 = 8;
			iLocal_751 = 0;
			iLocal_750 = 0;
		...
		else if (iLocal_353 == 2)
		{
			...
			func_319(&(Local_606[0 /*8*/]), uLocal_763);
			func_318(&(Local_606[1 /*8*/]), iLocal_761);
			iLocal_748 = 11;
			iLocal_749 = 12;
			iLocal_751 = 0;
			iLocal_750 = 0;
		...
		func_317(&uLocal_168, 0, unk_0x27D769C59BC9D030(), "MICHAEL", 0, 1);
		func_317(&uLocal_168, 5, Local_606[1 /*8*/], "JIMMYBOSTON", 0, 1);
		func_317(&uLocal_168, 4, Local_606[0 /*8*/], "MARNIE", 0, 1);
		if (iLocal_353 == 0)
		{
		...
		func_316(Local_363[iLocal_353 /*43*/].f_18, Local_363[iLocal_353 /*43*/].f_19, Local_363[iLocal_353 /*43*/].f_20, Local_363[iLocal_353 /*43*/].f_21, Local_363[iLocal_353 /*43*/].f_22);
		bLocal_336 = false;
		iLocal_337 = 0;
		iLocal_338 = 0;
		iLocal_339 = 1;
		...
		iLocal_747 = 0;
		unk_0x5BD150B52CE8D356(1);
		iLocal_358 = unk_0xA0F74982C6AAA9D4();
		iLocal_747 = unk_0xA0F74982C6AAA9D4() + 1000;
		func_284("Finished setup, moving to run loop for rock #:", iLocal_353);
		Local_772.f_1 = 1;
	}
	if (Local_772.f_1 == 1)
	{
		...
		else if (!func_315(&uLocal_694, unk_0xA8CFDE65C45F813B(unk_0x27D769C59BC9D030(), 1)))
		{
			func_235(6);
			Local_772.f_9 = 8;
			Local_772.f_1 = 3;
		...
		else
		{
			...
			while (iVar0 < 2)
			{
				func_312(&(Local_606[iVar0 /*8*/]));
				iVar0++;
			}
			if (unk_0xD2CFFE76B625AE55(Local_363[iLocal_353 /*43*/].f_1))
			{
				if (iLocal_353 == 0)
				{
					if (func_226(unk_0x27D769C59BC9D030(), Local_363[iLocal_353 /*43*/].f_1, 1) < 100f)
					{
						if (!unk_0xAA28218C604F91A5())
						{
							unk_0xE592C68A352C5B0A("EPS_4_MCS_1", 8);
							func_384("Requesting midtro now");
						}
					}
					else if (func_226(unk_0x27D769C59BC9D030(), Local_363[iLocal_353 /*43*/].f_1, 1) > 120f)
					{
						if (unk_0xAA28218C604F91A5())
						{
							func_384("Player moved away - unloading midtro");
							unk_0x18159512D699D089();
						}
					}
				}
				else if (iLocal_353 == 1)
				{
					if (func_226(unk_0x27D769C59BC9D030(), Local_363[iLocal_353 /*43*/].f_1, 1) < 100f)
					{
						if (!unk_0xAA28218C604F91A5())
						{
							unk_0xE592C68A352C5B0A("EPS_4_MCS_2", 8);
							func_384("Requesting midtro now");
						}
					}
					else if (func_226(unk_0x27D769C59BC9D030(), Local_363[iLocal_353 /*43*/].f_1, 1) > 120f)
				...
				else if (func_226(unk_0x27D769C59BC9D030(), Local_363[iLocal_353 /*43*/].f_1, 1) < 100f)
				{
					if (!unk_0xAA28218C604F91A5())
					{
						unk_0xE592C68A352C5B0A("EPS_4_MCS_3", 8);
						func_384("Requesting midtro now");
					}
				}
				else if (func_226(unk_0x27D769C59BC9D030(), Local_363[iLocal_353 /*43*/].f_1, 1) > 120f)
			...
			func_311(&(Local_363[iLocal_353 /*43*/]));
			if (iLocal_353 == 0)
			{
				if (iLocal_746 == 0)
				{
					if (iLocal_747 < unk_0xA0F74982C6AAA9D4())
					{
						if (!func_335())
						{
							func_310("EPS4_T0");
							iLocal_747 = unk_0xA0F74982C6AAA9D4() + 7500;
							iLocal_746++;
							iLocal_759 = unk_0xA0F74982C6AAA9D4();
						}
						else
						{
							iLocal_746 = 2;
				...
				{
					if (unk_0x117D586920E8F7BA(0, 25) || iLocal_747 < unk_0xA0F74982C6AAA9D4())
					{
						unk_0x5BD150B52CE8D356(1);
						iLocal_747 = unk_0xA0F74982C6AAA9D4() + 1000;
						iLocal_746++;
			...
			func_282(Local_625.f_1);
			if (iLocal_339 == 1)
			{
				func_309(&uLocal_164);
				if (!func_315(&uLocal_642, unk_0xA8CFDE65C45F813B(unk_0x27D769C59BC9D030(), 1)))
				{
					iLocal_339 = 0;
					unk_0x94DA6AACA7F07289(0);
					unk_0x8ACEB4FC9E9EE225();
				...
				{
					if (unk_0xC1C5B83BB6719C6C(Local_363[iLocal_353 /*43*/].f_36, sLocal_161) || func_300(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!unk_0xC1C5B83BB6719C6C(Local_363[iLocal_353 /*43*/].f_36, sLocal_161))
						{
							if (func_227(iLocal_361))
							{
								unk_0x85FD30B510E7C05E(iLocal_361, unk_0x27D769C59BC9D030(), 10000, 0, 2);
							}
						}
						iLocal_759 = unk_0xA0F74982C6AAA9D4();
						iLocal_340 = 1;
				...
				{
					if (!func_275() && (unk_0xA0F74982C6AAA9D4() - iLocal_358) >= 7500)
					{
						if ((unk_0xC1C5B83BB6719C6C(Local_363[iLocal_353 /*43*/].f_37, sLocal_161) || !unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), iLocal_361, 30f, 30f, 30f, 0, 1, 0)) || func_300(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!unk_0xC1C5B83BB6719C6C(Local_363[iLocal_353 /*43*/].f_37, sLocal_161))
							{
								if (func_227(iLocal_361))
								{
									unk_0x85FD30B510E7C05E(iLocal_361, unk_0x27D769C59BC9D030(), 5000, 0, 2);
								}
							}
							iLocal_341 = 1;
							iLocal_759 = unk_0xA0F74982C6AAA9D4();
				...
				else if (iLocal_338 == 0 && !func_298(unk_0x27D769C59BC9D030(), Local_363[iLocal_353 /*43*/].f_2, 9f))
				{
					if (func_298(unk_0x27D769C59BC9D030(), Local_363[iLocal_353 /*43*/].f_2, 20f))
					{
						if (!iLocal_343)
						{
							if (!func_275())
							{
								if (func_300(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_42, 7, 0, 0, 0))
								{
									if (func_227(iLocal_361))
									{
										unk_0x85FD30B510E7C05E(iLocal_361, unk_0x27D769C59BC9D030(), 5000, 0, 2);
									}
									unk_0xA0342EB4AE1476FC(3f, 5f, 0);
									iLocal_343 = 1;
								}
							}
						}
					...
					{
						if (func_297(unk_0x27D769C59BC9D030(), iLocal_361, 30f, 1) || iLocal_353 == 2)
						{
							if (!func_275() && (unk_0xA0F74982C6AAA9D4() - iLocal_356) > 15000)
							{
								if (bLocal_336)
								{
									if (iLocal_352 == 0)
									{
										...
										{
											if (unk_0xC1C5B83BB6719C6C(Local_363[iLocal_353 /*43*/].f_40, sLocal_161) || func_300(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_334(iLocal_361))
												{
													unk_0x85FD30B510E7C05E(iLocal_361, unk_0x27D769C59BC9D030(), 3000, 0, 2);
												}
												iLocal_356 = unk_0xA0F74982C6AAA9D4();
												iLocal_750++;
												if (iLocal_353 == 2)
									...
									{
										if (unk_0xC1C5B83BB6719C6C(Local_363[iLocal_353 /*43*/].f_40, sLocal_161) || func_300(&uLocal_168, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_356 = unk_0xA0F74982C6AAA9D4();
											iLocal_752++;
										}
								...
								{
									if (unk_0xC1C5B83BB6719C6C(Local_363[iLocal_353 /*43*/].f_41, sLocal_161) || func_300(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_334(iLocal_361))
										{
											unk_0x85FD30B510E7C05E(iLocal_361, unk_0x27D769C59BC9D030(), 3000, 0, 2);
							...
							else if (bLocal_336 != Local_625.f_1)
							{
								...
								if (bLocal_336)
								{
									if (iLocal_357 < unk_0xA0F74982C6AAA9D4())
									{
										if (func_275())
										{
											unk_0x94DA6AACA7F07289(1);
										}
										iLocal_356 = (unk_0xA0F74982C6AAA9D4() - 7500);
										iLocal_357 = unk_0xA0F74982C6AAA9D4();
									}
								}
								else
								{
					...
					{
						iLocal_356 = (unk_0xA0F74982C6AAA9D4() - 5000);
					}
				}
				if (iLocal_353 == 0)
				{
					if (iLocal_753 < 5)
					{
						if (((unk_0xA0F74982C6AAA9D4() - iLocal_755) > 7500 && !func_275()) && !unk_0x45252A58A2BF9751())
						{
							if (func_227(Local_606[0 /*8*/]))
							{
								if (func_226(Local_606[0 /*8*/], unk_0x27D769C59BC9D030(), 1) < 4f)
								{
									if (func_300(&uLocal_168, "EPS4AUD", "EPS4_NEARM", 6, 0, 0, 0))
									{
										iLocal_753++;
										iLocal_755 = unk_0xA0F74982C6AAA9D4();
									}
				...
				else if (iLocal_353 == 1)
				{
					if (iLocal_753 < 4)
					{
						if (((unk_0xA0F74982C6AAA9D4() - iLocal_755) > 7500 && !func_275()) && !unk_0x45252A58A2BF9751())
						{
							if (func_227(Local_606[1 /*8*/]))
							{
								if (func_226(Local_606[1 /*8*/], unk_0x27D769C59BC9D030(), 1) < 4f)
								{
									if (func_300(&uLocal_168, "EPS4AUD", "EPS4_NEARJ", 6, 0, 0, 0))
									{
										iLocal_753++;
										iLocal_755 = unk_0xA0F74982C6AAA9D4();
									}
					...
					if (iLocal_753 < 3)
					{
						if (((unk_0xA0F74982C6AAA9D4() - iLocal_755) > 7500 && !func_275()) && !unk_0x45252A58A2BF9751())
						{
							if (func_227(Local_606[1 /*8*/]))
							{
								if (func_226(Local_606[1 /*8*/], unk_0x27D769C59BC9D030(), 1) < 4f)
								{
									if (func_300(&uLocal_168, "EPS4AUD", "EPS4_NEARJP", 6, 0, 0, 0))
									{
										iLocal_753++;
										iLocal_755 = unk_0xA0F74982C6AAA9D4();
									}
					...
					if (iLocal_754 < 4)
					{
						if (((unk_0xA0F74982C6AAA9D4() - iLocal_755) > 7500 && !func_275()) && !unk_0x45252A58A2BF9751())
						{
							if (func_227(Local_606[0 /*8*/]))
							{
								if (func_226(Local_606[0 /*8*/], unk_0x27D769C59BC9D030(), 1) < 4f)
								{
									if (func_300(&uLocal_168, "EPS4AUD", "EPS4_NEARMP", 6, 0, 0, 0))
									{
										iLocal_754++;
										iLocal_755 = unk_0xA0F74982C6AAA9D4();
									}
				...
				if (unk_0xB1988D54B2C48CB5(unk_0x27D769C59BC9D030(), Local_363[iLocal_353 /*43*/].f_2, 6.2f, 6.2f, 2f, 0, 0, 1))
				{
					if (iLocal_359 == -1)
					{
						iLocal_359 = unk_0xA0F74982C6AAA9D4();
					}
					else if ((unk_0xA0F74982C6AAA9D4() - iLocal_359) >= 1500)
					{
						if (func_275())
						{
							func_273();
						}
						iLocal_537 = unk_0xA0F74982C6AAA9D4();
						func_235(3);
						Local_772.f_1 = 3;
					}
				}
				...
				else if (!func_298(unk_0x27D769C59BC9D030(), Local_363[iLocal_353 /*43*/].f_2, (9f + 2f)))
				{
					iLocal_337 = 0;
				}
			}
			...
			{
				if (!unk_0x7B4654D62B7E0E9E(uLocal_164))
				{
					uLocal_164 = func_296(Local_144, 5, 0);
				}
				bLocal_336 = Local_625.f_1;
				if (func_315(&uLocal_642, unk_0xA8CFDE65C45F813B(unk_0x27D769C59BC9D030(), 1)))
				{
				...
				else if (iLocal_344 == 0)
				{
					if (iLocal_353 < 2)
					{
						if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), iLocal_361, 30f, 30f, 30f, 0, 1, 0))
						{
							if (!func_275() && !unk_0x45252A58A2BF9751())
							{
								if (unk_0xC1C5B83BB6719C6C(Local_363[iLocal_353 /*43*/].f_38, sLocal_161) || func_300(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_38, 7, 0, 0, 0))
								{
									iLocal_344 = 1;
								}
							}
					...
					else if (!func_275() && !unk_0x45252A58A2BF9751())
					{
						if (unk_0xC1C5B83BB6719C6C(Local_363[iLocal_353 /*43*/].f_38, sLocal_161) || func_300(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_38, 7, 0, 0, 0))
						{
							iLocal_344 = 1;
				...
				else if (iLocal_345 == 0)
				{
					if (iLocal_353 < 2)
					{
						if (unk_0xC4F9E3DD5445F8E4(unk_0x27D769C59BC9D030(), iLocal_361, 30f, 30f, 30f, 0, 1, 0))
						{
							if ((!func_275() && (unk_0xA0F74982C6AAA9D4() - iLocal_358) >= 7500) && !unk_0x45252A58A2BF9751())
							{
								if (unk_0xC1C5B83BB6719C6C(Local_363[iLocal_353 /*43*/].f_39, sLocal_161) || func_300(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_39, 7, 0, 0, 0))
								{
									iLocal_345 = 1;
								}
							}
					...
					else if ((!func_275() && (unk_0xA0F74982C6AAA9D4() - iLocal_358) >= 7500) && !unk_0x45252A58A2BF9751())
					{
						if (unk_0xC1C5B83BB6719C6C(Local_363[iLocal_353 /*43*/].f_39, sLocal_161) || func_300(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_39, 7, 0, 0, 0))
						{
							iLocal_345 = 1;
	...
	{
		unk_0x28981D48C12CB95E(2);
		func_384("In cleanup for FindRock");
		if (func_275())
		{
			unk_0x94DA6AACA7F07289(1);
		}
		...
		func_281();
		unk_0x09942629F73A2BD5(0, 200, 150);
		if ((unk_0xA0F74982C6AAA9D4() - iLocal_537) > 750)
		{
			func_223();
			...
			func_279(&(Local_606[1 /*8*/]), 0);
			func_279(&(Local_606[0 /*8*/]), 0);
			func_354();
		}
	}
}

int func_296(struct<3> Param0, int iParam3, int iParam4)
{
	int iVar0;
...
bool func_298(int iParam0, struct<3> Param1, float fParam4)
{
...
void func_311(var uParam0)
{
	...
	fVar0 = unk_0x2A488C176D52CCA5(uParam0->f_2, unk_0xA8CFDE65C45F813B(unk_0x27D769C59BC9D030(), 1));
	Var1 = { unk_0xE7669FB0FEEAD3DD(unk_0x27D769C59BC9D030()) };
	if (fVar0 > Local_625.f_11)
	{
		fVar7 = 0f;
		if (Local_625.f_8 > 0f)
		{
			fVar7 = (fVar7 + (unk_0x0BADBFA3B172435F(((fVar0 - Local_625.f_11) * (360f / Local_625.f_8))) * Local_625.f_10));
		}
		if (Local_625.f_9 > 0f)
		{
			fVar7 = (fVar7 + (unk_0x0BADBFA3B172435F(((fVar0 - Local_625.f_11) * (360f / Local_625.f_9))) * (Local_625.f_10 * -0.7f)));
		}
	...
	Var8 = { uParam0->f_2 - unk_0xA8CFDE65C45F813B(unk_0x27D769C59BC9D030(), 1) };
	Var11 = { uParam0->f_2 - unk_0xD7C4E2CB0B216852(unk_0x27D769C59BC9D030(), 0f, -5f, 0f) };
	bVar14 = ((Var8.f_0 * Var4.f_0) + (Var8.f_1 * Var4.f_1)) > 0f;
	fVar15 = (1f - (unk_0x1E765DC28DD319DF(Var4.f_0, Var4.f_1, Var11.f_0, Var11.f_1) / 180f));
	if (fVar0 >= 10f)
	{
	...
	else if (iLocal_354 < unk_0xA0F74982C6AAA9D4())
	{
		if (fVar0 <= 6.5f && bVar16)
		{
			unk_0x972F93B6DF7649AC(Local_625.f_3);
			unk_0x2A5264C35FD91CE4(Local_625.f_4, "CONTINUAL_BEEP", unk_0x27D769C59BC9D030(), "EPSILONISM_04_SOUNDSET", 0, 0);
			Local_625.f_6 = 1;
		}
		else
		{
			...
			iLocal_354 = (unk_0xA0F74982C6AAA9D4() + iVar18);
			iVar18 = (iVar18 / 3);
			if (iVar18 < 100)
			{
				iVar18 = 100;
			}
			iLocal_355 = (unk_0xA0F74982C6AAA9D4() + iVar18);
			unk_0x2A5264C35FD91CE4(Local_625.f_3, "IDLE_BEEP", unk_0x27D769C59BC9D030(), "EPSILONISM_04_SOUNDSET", 0, 0);
			if (bVar16)
			{
				unk_0x09942629F73A2BD5(0, 200, 150);
			}
			...
			{
				unk_0x09942629F73A2BD5(0, 200, 100);
			}
		}
	}
	if (iLocal_355 > 0 && unk_0xA0F74982C6AAA9D4() > iLocal_355)
	{
		unk_0x972F93B6DF7649AC(Local_625.f_3);
		iLocal_355 = 0;
	}
	if (unk_0x32B2DBD1EB9EECE3())
	{
		if (Local_625.f_7 == 0)
		{
			unk_0x2A5264C35FD91CE4(Local_625.f_5, "SCAN", unk_0x27D769C59BC9D030(), "EPSILONISM_04_SOUNDSET", 0, 0);
			Local_625.f_7 = 1;
		}
		else if (bVar16)
		{
			unk_0xE35939C3B3CA3B85(Local_625.f_5, "IsOnTarget", 1f);
		}
		else
		{
			unk_0xE35939C3B3CA3B85(Local_625.f_5, "IsOnTarget", 0f);
		}
		iLocal_759 = unk_0xA0F74982C6AAA9D4();
	}
	...
	else
	{
		...
		unk_0x8CED8F78CC31BEF2(uLocal_165, "SET_DISTANCE");
		unk_0x4ACF99392701B935(fLocal_640);
		unk_0x7E5FA681CB7A2EF7();
		unk_0x6989B1F0868251F4(uLocal_166);
		unk_0xFF51FA5E68E9F7D4(uLocal_165, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	}
	if (unk_0x5FCAE3F8AEC656AF(0, 25))
	{
		unk_0x1535027F70F1EBC7(unk_0x27D769C59BC9D030(), 1f);
		unk_0xCFF471245AFEEDCE(0, 22, 1);
		if (bLocal_351)
		{
			unk_0x4523FDDB9926E1D8(15f, 1065353216);
...
void func_312(var uParam0)
{
	...
	if (func_334(*uParam0) && unk_0x17297F499604E052(*uParam0))
	{
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			{
				iVar0 = unk_0x3A5708FEE1B560A9(0, iLocal_605);
				while (uParam0->f_3 == -1)
				{
					if (Local_538[iVar0 /*6*/].f_5 == 0)
					{
						...
						{
							if (!unk_0xB1988D54B2C48CB5(*uParam0, Local_538[iVar0 /*6*/], 3f, 3f, 3f, 0, 1, 0))
							{
								func_284("Telling ped to go to marker: ", iVar0);
				...
				unk_0xE4A57337AE998385(*uParam0, Local_538[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 1193033728);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (!uParam0->f_7)
				{
					if (unk_0x810AFFABCBF31E2D(*uParam0, 713668775) == 7)
					{
						func_384("Eps reached marker! (follow nav to coord)");
						uParam0->f_1 = 2;
						uParam0->f_2 = 0;
					}
				}
				else if (unk_0x810AFFABCBF31E2D(*uParam0, 2106541073) == 7)
				{
					func_384("Eps reached marker! (go straight to coord)");
					uParam0->f_7 = 0;
					uParam0->f_1 = 2;
					uParam0->f_2 = 0;
				}
		...
		case 2:
			...
			{
				func_284("Telling ped do sequence for marker: ", uParam0->f_3);
				unk_0x33A0CEA494F4C2A3(&uLocal_167);
				if (Local_538[uParam0->f_3 /*6*/].f_4 == 0)
				{
					if (*uParam0 == Local_606[1 /*8*/])
					{
						unk_0x878D12AEFBF5BAF0(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_entry_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x878D12AEFBF5BAF0(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x878D12AEFBF5BAF0(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_exit_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else
					{
						unk_0x878D12AEFBF5BAF0(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_entry_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x878D12AEFBF5BAF0(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x878D12AEFBF5BAF0(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_exit_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
				}
				else if (Local_538[uParam0->f_3 /*6*/].f_4 == 2)
				{
					unk_0xD9F9CB5C8842E29C(0, Local_538[uParam0->f_3 /*6*/].f_3, 0);
					unk_0x878D12AEFBF5BAF0(0, "rcm_epsilonism4", "peeing", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				else if (Local_538[uParam0->f_3 /*6*/].f_4 == 3)
				{
					unk_0x878D12AEFBF5BAF0(0, "rcm_epsilonism4", "hippy_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				...
				unk_0x33F83FC0F5F458E3(uLocal_167);
				unk_0x8B8674266D533E9F(*uParam0, uLocal_167);
				unk_0x433C209504FBC7EE(&uLocal_167);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (unk_0x810AFFABCBF31E2D(*uParam0, 242628503) == 7)
				{
					Local_538[uParam0->f_3 /*6*/].f_5 = 0;
					uParam0->f_3 = -1;
					uParam0->f_1 = 1;
		...
		case 4:
			...
			{
				if (!unk_0xB1988D54B2C48CB5(unk_0x27D769C59BC9D030(), uParam0->f_4, 1f, 1f, 1f, 0, 1, 0) || iLocal_353 > 0)
				{
					if (!unk_0x17297F499604E052(*uParam0))
					{
						unk_0xF156AA2A744B309E(*uParam0);
						unk_0x3BD6117D6F00B83F(*uParam0, func_313());
						unk_0x56F64CC9254C2E4F(*uParam0, 167, 1);
					}
					iLocal_756 = unk_0xA0F74982C6AAA9D4();
					if (iLocal_353 == 0)
					{
						unk_0xBF08937EF5F49072(func_313(), 0);
					}
					else
					{
						unk_0xBF08937EF5F49072(func_313(), 0);
					}
					unk_0x2E24188B390A926D(func_313(), 4f, -1082130432, -1082130432);
					uParam0->f_2 = 1;
				}
			}
			else if (uParam0->f_2 == 1)
			{
				...
				if (unk_0x537945462B3922D7(*uParam0))
				{
					if (!iLocal_350)
					{
						if ((unk_0xA0F74982C6AAA9D4() - iLocal_756) > 6000)
						{
							unk_0x33A0CEA494F4C2A3(&uLocal_167);
							if (*uParam0 == Local_606[1 /*8*/])
							{
							...
							if (!func_275() && !unk_0x45252A58A2BF9751())
							{
								if (*uParam0 == Local_606[1 /*8*/])
								{
									func_300(&uLocal_168, "EPS4AUD", "EPS4_DAWDJ", 7, 0, 0, 0);
								}
								else
								{
									func_300(&uLocal_168, "EPS4AUD", "EPS4_DAWDM", 7, 0, 0, 0);
								}
							}
							iLocal_350 = 1;
						}
				...
				if (unk_0x431C14C947878B67(unk_0x27D769C59BC9D030()) || unk_0x02AFB3CDBA55341D(unk_0x27D769C59BC9D030()))
				{
					if ((((unk_0xA0F74982C6AAA9D4() - iLocal_757) > 7500 && !func_275()) && !unk_0x45252A58A2BF9751()) && !iLocal_337)
					{
						if (*uParam0 == Local_606[1 /*8*/])
						{
							if (func_300(&uLocal_168, "EPS4AUD", "EPS4_MESSJ", 7, 0, 0, 0))
							{
								iLocal_757 = unk_0xA0F74982C6AAA9D4();
							}
						}
						else if (func_300(&uLocal_168, "EPS4AUD", "EPS4_MESSM", 7, 0, 0, 0))
						{
							iLocal_757 = unk_0xA0F74982C6AAA9D4();
						}
					}
				}
				if ((unk_0xA0F74982C6AAA9D4() - iLocal_759) > 15000)
				{
					if ((((iLocal_758 < 4 && !func_275()) && !unk_0x45252A58A2BF9751()) && !iLocal_337) && !func_335())
					{
						if (*uParam0 == Local_606[1 /*8*/])
						{
							if (func_300(&uLocal_168, "EPS4AUD", "EPS4_PROMPTJ", 7, 0, 0, 0))
							{
								iLocal_759 = unk_0xA0F74982C6AAA9D4();
								iLocal_758++;
							}
						}
						else if (func_300(&uLocal_168, "EPS4AUD", "EPS4_PROMPTM", 7, 0, 0, 0))
						{
							iLocal_759 = unk_0xA0F74982C6AAA9D4();
							iLocal_758++;
						}
		...
		case 5:
			...
			{
				unk_0x9B6F077214CEDE77(*uParam0, unk_0x27D769C59BC9D030(), 20000, 4.5f, 1073741824, 1073741824, 0);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
...
{
	if (func_334(iParam0) && func_227(unk_0x27D769C59BC9D030()))
	{
		if (iLocal_623 == 0)
		{
			if (unk_0x799B2D82E6E6C363(unk_0x27D769C59BC9D030(), iParam0) && unk_0xBD036012AF60D938(iParam0))
			{
				func_384("Player knocked Eps over!");
				iLocal_623 = 1;
				iLocal_624 = iParam0;
				unk_0xF156AA2A744B309E(iParam0);
			}
		}
		else if (func_334(iLocal_624))
		{
			if (unk_0x8D1E4231095B313B(iLocal_624) || unk_0x17753565205CF66F(iLocal_624))
			{
				if (!func_275() && !unk_0x45252A58A2BF9751())
				{
					if (iLocal_624 == Local_606[1 /*8*/])
					{
						if (func_300(&uLocal_168, "EPS4AUD", "EPS4_JKNOCK", 7, 0, 0, 0))
						{
							iLocal_623 = 0;
							iLocal_624 = 0;
						}
					}
					else if (func_300(&uLocal_168, "EPS4AUD", "EPS4_MKNOCK", 7, 0, 0, 0))
					{
						iLocal_623 = 0;
						iLocal_624 = 0;
					}
...
bool func_315(var uParam0, struct<2> Param1, float fParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_316(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	unk_0x2A5264C35FD91CE4(Local_625.f_2, "DEVICE", unk_0x27D769C59BC9D030(), "EPSILONISM_04_SOUNDSET", 0, 0);
	if (Local_625.f_13 == 0)
	{
...
void func_318(var uParam0, int iParam1)
{
	if (func_334(*uParam0))
	{
		...
		unk_0x09D2BE36C9D2B76F(*uParam0);
		unk_0x4EEE9D9427E70F4E(*uParam0, Local_538[iParam1 /*6*/], 1, 0, 0, 1);
		unk_0xFBDCF3D5834B58D8(*uParam0, Local_538[iParam1 /*6*/].f_3);
	}
	else
	{
		uParam0->f_1 = 0;
...
{
	if (func_334(*uParam0) && func_334(unk_0x27D769C59BC9D030()))
	{
		uParam0->f_1 = 4;
		uParam0->f_2 = 0;
		unk_0x85FD30B510E7C05E(*uParam0, unk_0x27D769C59BC9D030(), -1, 0, 2);
		if (bParam1)
		{
			unk_0xF14C2AE8A3F59CE0(*uParam0, unk_0x27D769C59BC9D030(), 0);
		}
		uParam0->f_4 = { unk_0xA8CFDE65C45F813B(unk_0x27D769C59BC9D030(), 1) };
	}
	else
	{
		uParam0->f_1 = 0;
...
int func_324()
{
	...
	unk_0x88172B3983EC5071("rcm_epsilonism4leadinout");
	if (unk_0x482101C9B3483958("rcm_epsilonism4") && unk_0x482101C9B3483958("rcm_epsilonism4leadinout"))
	{
		return 1;
	}
	return 0;
...
int func_325()
{
	...
	while (iVar0 < iLocal_536)
	{
		unk_0x97C59C4E8349D15F(Local_363[iVar0 /*43*/]);
		iVar0++;
	}
	unk_0x97C59C4E8349D15F(uLocal_160);
	unk_0x97C59C4E8349D15F(joaat("bison"));
	iVar0 = 0;
	while (iVar0 < iLocal_536)
	{
		if (!unk_0x875098323FCA8FE6(Local_363[iVar0 /*43*/]))
		{
			return 0;
		}
		iVar0++;
	}
	if (!unk_0x875098323FCA8FE6(iLocal_160) || !unk_0x875098323FCA8FE6(joaat("bison")))
	{
		return 0;
	}
	return 1;
...
void func_327()
{
	if (unk_0x95921D2FB0B6ACDD())
	{
		func_384("Can request assets for cutscene entity in Eps 4");
		unk_0xEBCFA81EA7447178("Jimmy_Boston", 1, 0, 0, 0);
		if (func_227(unk_0x27D769C59BC9D030()))
		{
			func_286("Michael", unk_0x27D769C59BC9D030(), 0, 2);
	...
	if (Local_772.f_3 == 1)
	{
		func_293(1, 1);
		unk_0x18159512D699D089();
		func_384("SKIP: Doing sync for intro skip");
		if (!func_395(0))
		{
			func_285(1, 1, 1);
		}
	...
	if (Local_772.f_1 == 0)
	{
		if (!unk_0xB1FDEE75A71D93F5())
		{
			unk_0xE592C68A352C5B0A("ep_4_rcm_concat", 8);
		}
		func_384("In Intro setup, waiting for cutscene to be ready...");
		if (func_271(1, 1093140480, 0))
		{
			func_384("Starting intro cutscene...");
			if (func_334(unk_0x27D769C59BC9D030()))
			{
				unk_0x90F1D412CA4CF490(unk_0x27D769C59BC9D030(), "Michael", 0, 0, 0);
			}
			if (func_334(Local_83.f_28[0]))
			{
				unk_0x90F1D412CA4CF490(Local_83.f_28[0], "Marnie", 0, 0, 0);
			}
			if (func_334(Local_83.f_28[1]))
			{
				unk_0xA8CA82EB31D1626F(Local_83.f_28[1], 0);
				if (func_227(unk_0x023309AF6DD689A2(Local_83.f_28[1])))
				{
					iLocal_641 = func_267(Local_83.f_28[1], joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
					unk_0x90F1D412CA4CF490(iLocal_641, "Artefact_Detector", 0, 0, 0);
				}
				unk_0x90F1D412CA4CF490(Local_83.f_28[1], "Jimmy_Boston", 0, 0, 0);
			}
			if (func_334(unk_0x27D769C59BC9D030()))
			{
				unk_0x90F1D412CA4CF490(unk_0x27D769C59BC9D030(), "Michael", 0, 0, 0);
			}
			unk_0x68BD4F826EFDDC53("EPS4_START");
			func_331();
			unk_0x8D1A4408D797A1F3(1);
			unk_0xBC7FB8D910011C75(0);
			unk_0x4EDE34FBADD967A6(0);
			...
			func_285(1, 1, 0);
			func_258(1833.393f, 4703.849f, 32.50218f, 1819.368f, 4693.413f, 43.89163f, 18f, 1816.55f, 4683.33f, 37.75f, 339.76f, func_266(), 1, 1, 1, 0, 0);
			func_253(1812f, 4697f, 39.1f, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1);
			while (!func_323())
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			func_384("Loaded all assets! Moving to intro run loop...");
			Local_772.f_1 = 1;
		}
	}
	if (Local_772.f_1 == 1)
	{
		...
		if (func_227(unk_0x27D769C59BC9D030()))
		{
			...
			{
				func_384("*** Forcing Michael's move state");
				func_330(unk_0x27D769C59BC9D030(), 1827.161f, 4698.645f, 38.094f, 184.1384f, 0, 1);
				unk_0xAC9A80BE63D6295F(unk_0x27D769C59BC9D030(), iLocal_159, -1, 1, 1);
			}
		}
	...
	if (Local_772.f_1 == 3)
	{
		func_384("Doing intro cleanup and progressing");
		if (!unk_0x67FB99B1361E144E())
		{
			iLocal_353 = 0;
			func_237(1, 0, 1, 1);
...
void func_328()
{
	...
	if (func_227(Local_606[1 /*8*/]))
	{
		if (unk_0x1F12913CC4103895("Jimmy_Boston", 0))
		{
			unk_0xF1F1EBE69E9A0DE7(1829.8f, 4693.48f, 38.5f, &uVar0, 0);
			unk_0x4EEE9D9427E70F4E(Local_606[1 /*8*/], 1829.8f, 4693.48f, uVar0, 1, 0, 0, 1);
		}
	}
}
...
void func_329()
{
	if (func_227(Local_606[0 /*8*/]))
	{
		if (unk_0x1F12913CC4103895("Marnie", 0))
		{
			func_319(&(Local_606[0 /*8*/]), uLocal_762);
			Local_606[0 /*8*/].f_1 = 1;
			Local_606[0 /*8*/].f_2 = 1;
			...
			unk_0x3D09311EB0F37652(Local_606[0 /*8*/], Local_538[Local_606[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 1056964608);
			unk_0x9B6055629FB6CC23(Local_606[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 1);
			Local_606[0 /*8*/].f_7 = 1;
			func_384("Done Marnie intro exit state");
		}
	}
}
...
void func_332()
{
	...
	{
		func_293(1, 1);
		func_384("SKIP: Doing sync for leadin skip");
		func_285(1, 1, 1);
		Local_772.f_3 = 0;
	}
	if (Local_772.f_1 == 0)
	{
		...
		if (!func_395(0) && unk_0x98CEDC9398D49BB8(unk_0x27D769C59BC9D030(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0))
		{
			func_384("Doing setup for leadin");
			func_317(&uLocal_168, 4, Local_83.f_28[0], "MARNIE", 0, 1);
			if (func_324())
			{
				Local_772.f_1 = 1;
			}
		...
		{
			func_384("Skipping setup for leadin (repeat play/wrong area)");
			Local_772.f_1 = 1;
		}
	}
	if (Local_772.f_1 == 1)
	{
		if ((unk_0xA0F74982C6AAA9D4() - iLocal_354) > 1250)
		{
			unk_0xB3062467BC9D98A8(-1, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
			iLocal_354 = unk_0xA0F74982C6AAA9D4();
		}
		if (!func_395(0) && unk_0x98CEDC9398D49BB8(unk_0x27D769C59BC9D030(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0))
		{
			if (func_226(unk_0x27D769C59BC9D030(), Local_83.f_28[0], 1) >= 3f)
			{
				if (!unk_0x2FC8076880D60BD4())
				{
					if (!iLocal_333)
					{
						if (func_227(Local_83.f_28[0]))
						{
							unk_0xEE40B5E30309799D(Local_83.f_28[0], 0f, 0f, 0.2f, 1, 30000, 2000, 2000, 0);
							unk_0x560952A1AFEC167D(fLocal_767);
							unk_0xA1B37040B6E24E35(fLocal_768);
							unk_0x8A44186D0A43AD46(fLocal_769);
							unk_0x2A7559BA2AEEDF21(fLocal_770);
							unk_0xA4F476D23394503E(fLocal_771);
							unk_0xD1A0164670D2CD32(1);
							if (func_227(unk_0x27D769C59BC9D030()))
							{
								unk_0x33A0CEA494F4C2A3(&uLocal_167);
								unk_0x85FD30B510E7C05E(0, Local_83.f_28[0], 15000, 0, 2);
								unk_0xE4A57337AE998385(0, 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 1193033728);
								unk_0xF14C2AE8A3F59CE0(0, Local_83.f_28[0], 0);
								unk_0x33F83FC0F5F458E3(uLocal_167);
								unk_0x8B8674266D533E9F(unk_0x27D769C59BC9D030(), uLocal_167);
								unk_0x433C209504FBC7EE(&uLocal_167);
			...
			if (!iLocal_334)
			{
				if (func_334(Local_83.f_28[0]) && !func_275())
				{
					unk_0x85FD30B510E7C05E(Local_83.f_28[0], unk_0x27D769C59BC9D030(), -1, 48, 2);
					unk_0x878D12AEFBF5BAF0(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0, 0, 0, 0);
					unk_0x18159512D699D089();
					unk_0xD6EC97AEEF3FE2E2("EP_4_RCM_CONCAT", 2, 8);
					func_384("Done Marnie leadin anim - request concat cutscene");
					iLocal_334 = 1;
				}
			}
			else if (func_334(Local_83.f_28[0]))
			{
				if (unk_0xF4954568C87BA772(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					if (unk_0x45BFA2594AA26529(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.25f)
					{
						if (!iLocal_335)
						{
							if (func_300(&uLocal_168, "EPS4AUD", "ESP4_RCL", 8, 0, 0, 0))
							{
								func_384("Leadin convo done");
								iLocal_335 = 1;
							}
						}
					}
					if (unk_0x45BFA2594AA26529(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.95f)
					{
						func_384("Leadin done, launch cutscene");
						func_235(1);
						Local_772.f_1 = 3;
					}
					if (func_226(unk_0x27D769C59BC9D030(), Local_83.f_28[0], 1) <= 1.5f)
					{
						unk_0x9F805E4A6F671CEE(unk_0x4D29100D094E5511(), false, 0);
						unk_0xF156AA2A744B309E(unk_0x27D769C59BC9D030());
					}
		...
		{
			func_384("Replay in progress/wrong area, skipping leadin");
			func_235(1);
			Local_772.f_1 = 3;
		}
	}
	if (Local_772.f_1 == 3)
	{
		func_384("Doing leadin cleanup and progressing");
		func_354();
	}
}
...
void func_336(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_69743 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x3934E959DB2478D3())
			{
				...
				Var4 = { func_338(Global_69744, Global_69746, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
struct<2> func_338(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_339(iVar2), 8);
					break;
			}
			break;
...
int func_347(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (((!func_349(0) || Global_69758) || Global_69747 == 1) || !unk_0xCBB243DDC0D132D1())
	{
		return 0;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((unk_0x67FB99B1361E144E() || func_221(0)) || func_348(1))
			{
			}
			else
			{
...
{
	return func_351(iParam0, Global_35711);
}
...
void func_354()
{
	if ((Local_772.f_4 || Local_772.f_5) || Local_772.f_6)
	{
		...
		if (Local_772.f_8 == 1)
		{
			func_384("Sync for skip is TRUE and Intro is queued!");
		}
	}
	else
	{
...
int func_359(var uParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6)
{
	if (iParam5 != 0)
	{
		*uParam0 = iParam5;
		func_384("*** Epsilonist exists, grabbing ped index");
	}
	else
	{
		*uParam0 = unk_0x91D233CD0204A37F(5, iParam6, Param1, fParam4, 1, 1);
		func_384("*** Epsilonist does not exist, creating new");
	}
	if (func_334(*uParam0))
	{
		unk_0x56F64CC9254C2E4F(*uParam0, 132, 1);
		unk_0x71065DDFF8D7744C(*uParam0, joaat("player"));
		unk_0x2CBC4FD55924CEE9(*uParam0, 1);
		unk_0xFFD8329ED7A8E20C(*uParam0, 0);
		unk_0xBD230B2B3B0F4DCC(*uParam0, 1);
...
void func_360(var uParam0)
{
	...
	Var0 = { uParam0->f_2 };
	func_361("Rock created at: ", uParam0->f_2);
	uParam0->f_1 = unk_0x8FC46BABCF818990(*uParam0, Var0, 1, 1, 0);
	if (unk_0xD2CFFE76B625AE55(uParam0->f_1))
	{
		unk_0x0359A241E2DD22AC(uParam0->f_1, uParam0->f_5, 0, 1);
		func_361("Rock rot vector: ", unk_0x9A98AE1D9D8DEF06(uParam0->f_1, 0));
		func_361("Rock actual position: ", unk_0xA8CFDE65C45F813B(uParam0->f_1, 0));
		unk_0xCD0F5594F1C6772F(uParam0->f_1, 0);
		unk_0xA8CA82EB31D1626F(uParam0->f_1, 1);
	}
}

void func_361(char* sParam0, struct<3> Param1)
{
	sParam0 = sParam0;
	Param1 = { Param1 };
}
...
void func_362()
{
	Local_625.f_2 = unk_0x9EE81D7901D9BCE2();
	Local_625.f_3 = unk_0x9EE81D7901D9BCE2();
	Local_625.f_4 = unk_0x9EE81D7901D9BCE2();
	Local_625.f_5 = unk_0x9EE81D7901D9BCE2();
	Local_625.f_12 = 0.92f;
	Local_625.f_13 = 0;
	Local_625.f_14 = "NO_RECENT_ANIM";
	uLocal_165 = unk_0x9A64FC8B83855E3B("digiscanner");
	while (!unk_0x4C3CEC038B6637D7(uLocal_165))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	...
	unk_0xEC8E255B8B6DD682(iLocal_160);
	if (unk_0x8B2548A86532AA14("digiscanner"))
	{
		uLocal_166 = unk_0x61AE2E76850532C3("digiscanner");
	}
}
...
void func_364()
{
	func_380(joaat("prop_tv_test"), 1751.65f, 4676.77f, 43.03f, -2.33f, 0.99f, 91.36f);
	func_379(1755.463f, 4678.62f, 44.1477f, -9.5251f, 0f, 122.2955f, 50.832f);
	func_378(3f, -4.5f, 0f);
	func_377(1689.951f, 4762.613f, 40.9216f, 272.5499f);
	func_376(1779.514f, 4691.447f, 39.34577f, 1744.225f, 4674.646f, 46.84829f, 16.5f);
	func_375("EPS4_JCHAT1", sLocal_161);
	func_374("EPS4_JGOOD", "EPS4_JBAD");
	func_373("EPS4_JRET1", "EPS4_JRET2");
	func_372("EPS4_JCLOSE");
	func_371(0f, 0f, 0f);
	func_370(30f, 115f, 0.9f);
	func_380(joaat("prop_battery_01"), 1756.68f, 4832.28f, 39.43f, 90f, 13.21f, 78.57f);
	func_379(1758.032f, 4826.561f, 41.459f, -11.6785f, 0f, 6.5381f, 34.3083f);
	func_378(2f, 4f, 0f);
	func_377(1690.267f, 4769.994f, 40.9216f, 269.3043f);
	func_376(1750.065f, 4833.117f, 36.87026f, 1763.224f, 4831.822f, 43.5425f, 13.75f);
	func_375("EPS4_MCHAT1", "EPS4_MCHAT2");
	func_374("EPS4_MGOOD", "EPS4_MBAD");
	func_373("EPS4_MRET1", "EPS4_MRET2");
	func_372("EPS4_MCLOSE");
	func_371(0f, 0f, 0f);
	func_370(30f, 195f, 0.9f);
	func_380(joaat("prop_old_boot"), 1847.863f, 4756.059f, 36.71f, -70.53f, 75.48f, 132.44f);
	func_379(1829.31f, 4756.158f, 42.4876f, -23.5614f, 0f, -92.2873f, 50f);
	func_378(7.5f, -7.5f, 0f);
	func_377(1689.775f, 4777.77f, 40.9216f, 267.4597f);
	func_376(1856.218f, 4755.223f, 34.67169f, 1841.114f, 4755.489f, 41.43402f, 13.75f);
	func_375("EPS4_PCHAT1", "EPS4_PCHAT2");
	func_374("EPS4_PGOOD", "EPS4_PBAD");
	func_373(sLocal_161, "EPS4_PRET2");
	func_372("EPS4_PCLOSE");
	func_371(0f, 0f, 0f);
	func_370(20.5f, 155f, 0.9f);
	func_369(1820.101f, 4701.099f, 38.545f, 280.7432f, 0);
	func_369(1803.044f, 4700.244f, 39.3123f, 72.1396f, 0);
	func_369(1820.482f, 4672.535f, 35.6368f, 253.4126f, 0);
	func_369(1819.87f, 4694.03f, 38.408f, 231.2265f, 0);
	func_369(1807.122f, 4684.418f, 38.5566f, 150.6129f, 0);
	func_369(1791.058f, 4689.403f, 40.5128f, 103.4073f, 0);
	func_369(1872.626f, 4718.827f, 37.2889f, 210.8288f, 1);
	uLocal_760 = func_369(1764.089f, 4665.879f, 42.3031f, 281.6336f, 2);
	uLocal_762 = func_369(1814.27f, 4651.32f, 37.58f, 173.1089f, 0);
	iLocal_761 = func_369(1846.512f, 4705.614f, 38.1214f, 25.7591f, 3);
	uLocal_763 = func_369(1790.414f, 4722.897f, 37.8533f, 221.4777f, 0);
	func_368(&uLocal_642);
	func_367(&uLocal_642, 1897.42f, 4596.51f, 36.4f);
	func_367(&uLocal_642, 1912.2f, 4676.93f, 39.44f);
	func_367(&uLocal_642, 1886.09f, 4733.68f, 39.48f);
	func_367(&uLocal_642, 1800.24f, 4820.64f, 40.96f);
	func_367(&uLocal_642, 1796.556f, 4893.541f, 40.4741f);
	func_367(&uLocal_642, 1782.651f, 4916.333f, 41.4418f);
	func_367(&uLocal_642, 1746.552f, 4942.362f, 42.8677f);
	func_367(&uLocal_642, 1702.537f, 4893.824f, 36.7751f);
	func_367(&uLocal_642, 1707.273f, 4814.81f, 40.9407f);
	func_367(&uLocal_642, 1729.46f, 4655.21f, 42.61f);
	func_367(&uLocal_642, 1772.05f, 4602.143f, 36.457f);
	func_366(&uLocal_642);
	func_365(&uLocal_694, &uLocal_642, 20f);
}

void func_365(var uParam0, var uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_370(float fParam0, float fParam1, float fParam2)
{
	int iVar0;
...
void func_371(float fParam0, float fParam1, float fParam2)
{
	int iVar0;
...
void func_373(char* sParam0, char* sParam1)
{
	int iVar0;
...
void func_374(char* sParam0, char* sParam1)
{
	int iVar0;
...
void func_376(struct<3> Param0, struct<3> Param3, float fParam6)
{
	int iVar0;
...
void func_377(struct<3> Param0, float fParam3)
{
	int iVar0;
...
void func_379(struct<3> Param0, struct<3> Param3, float fParam6)
{
	int iVar0;
...
void func_380(int iParam0, struct<3> Param1, struct<3> Param4)
{
	int iVar0;
...
void func_382()
{
	if (unk_0x2DB75A8F096AB1F1(unk_0x4D29100D094E5511()))
	{
		if (unk_0x9A4E2270C2271219(unk_0x27D769C59BC9D030(), 0))
		{
			if (func_278(unk_0xD9FFE8E1642C81E2(unk_0x27D769C59BC9D030(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
var func_385(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
...
int func_387(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			func_394(&(uParam0->f_48), "rcm_epsilonism4", "ep_4_rcm_marnie_base_marnie", "ep_4_rcm_marnie_lookaround_marnie");
			iLocal_79 = 1;
			break;
		...
		case 2:
			...
			if (func_334(unk_0x27D769C59BC9D030()))
			{
				uVar5 = unk_0xF384805745D7A349(unk_0x27D769C59BC9D030());
			}
			if (!unk_0xD2CFFE76B625AE55(uParam0->f_28[0]))
			{
				if (func_388(&(uParam0->f_28[0]), 60, 1826.13f, 4698.88f, 38.92f, 21.63f, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
					unk_0x71065DDFF8D7744C(uParam0->f_28[0], uVar5);
			...
			{
				if (func_388(&(uParam0->f_28[1]), 55, 1827.24f, 4699.76f, 39.09f, 57.09f, "EPSILON LAUNCHER RC - JIMMY", 1))
				{
					unk_0x71065DDFF8D7744C(uParam0->f_28[1], iVar5);
					unk_0x56F64CC9254C2E4F(uParam0->f_28[1], 132, 1);
					unk_0x2F228A16D7B61C5F(uParam0->f_28[1], 1, 0, 0, false);
					unk_0xF156AA2A744B309E(uParam0->f_28[1]);
					unk_0xAC9A80BE63D6295F(uParam0->f_28[1], joaat("weapon_digiscanner"), -1, 1, 1);
					unk_0x878D12AEFBF5BAF0(uParam0->f_28[1], "rcm_epsilonism4", "ep_4_rcm_jimmyboston_base_jb", 8f, -8f, -1, 1, 0, 0, 0, 0);
					func_330(uParam0->f_28[1], 1827.24f, 4699.76f, 39.09f, 57.09f, 1, 1);
				}
				else
				{
					bVar4 = false;
...
void func_397()
{
	...
	if (func_399())
	{
		func_384("...Random Character Script was triggered so additional cleanup required");
	}
	if (func_334(unk_0x27D769C59BC9D030()))
	{
		unk_0xB1F866D7C20C5E2D(unk_0x27D769C59BC9D030(), iLocal_159);
		unk_0xCA26676919C42B5B(unk_0x27D769C59BC9D030(), joaat("weapon_unarmed"), 1);
		unk_0xF156AA2A744B309E(unk_0x27D769C59BC9D030());
		unk_0x613A0049DABAE5CC(unk_0x27D769C59BC9D030(), 0f);
	}
	if (unk_0x9A7F0D797C57AC34())
	{
		unk_0x18F9F40035A8905D();
	}
	unk_0x67D85B7BFE402DA0(uLocal_360);
	if (func_227(Local_606[0 /*8*/]) && func_227(Local_606[1 /*8*/]))
	{
		if (unk_0x17297F499604E052(Local_606[0 /*8*/]))
		{
			unk_0xBFE5E4F12033E3EF(Local_606[0 /*8*/]);
		}
		else if (unk_0x17297F499604E052(Local_606[1 /*8*/]))
		{
			unk_0xBFE5E4F12033E3EF(Local_606[1 /*8*/]);
		}
	}
	func_398(&(Local_606[0 /*8*/]), 1, 1, 1);
	func_398(&(Local_606[1 /*8*/]), 1, 1, 1);
	unk_0x508498A0BF4BE26A("digiscanner");
	unk_0x3CE75187603652E2(uLocal_162, 0);
	unk_0x3CE75187603652E2(uLocal_163, 0);
	unk_0xC296DD42927416B7(iLocal_764);
	unk_0xC296DD42927416B7(iLocal_765);
	unk_0xC296DD42927416B7(iLocal_766);
	if (unk_0x159730DB57D995D0("EPSILONISM_04_MIX"))
	{
		func_384("Stopping dynamic mix EPSILONISM_04_MIX");
		unk_0x354EC40268FD2071("EPSILONISM_04_MIX");
	}
...
void func_400(bool bParam0)
{
	...
	if (!func_415())
	{
		...
		{
			func_175(iVar0, 1, 0);
			func_401(unk_0x3AA961419D971CB2(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
int func_402(char* sParam0, int iParam1, int iParam2)
{
	var uVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_408())
	{
		...
		{
			iVar33 = func_403(unk_0x3AA961419D971CB2());
			if (iVar33 > -1)
			{
...
int func_404()
{
	...
	iVar0 = func_405(&(Global_91278.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_408()
{
	...
	{
		if (func_403(&(Global_91278.f_3)) > -1)
		{
			return 1;
		}
	}
