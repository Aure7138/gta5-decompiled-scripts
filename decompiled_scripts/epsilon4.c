...
void __EntryFunction__()
{
	...
	fLocal_31 = 180f;
	iLocal_34 = 3;
	uLocal_79 = func_418(60);
	uLocal_80 = func_418(14);
	...
	uLocal_159 = unk_0x46BF5F23C21A2D0D(iLocal_158);
	sLocal_160 = "empty";
	iLocal_338 = 1;
	iLocal_763 = -1;
	iLocal_764 = -1;
	...
	uLocal_161 = func_384();
	uLocal_162 = func_383(1855.08f, 4755.85f, 36.81f, 25f);
	iLocal_763 = unk_0xEE76955AB86583F1(1815.39f, 4698f, 38.87f, 3.5f, 3.5f, 3f, 0f, 0, 7);
	iLocal_764 = unk_0xEE76955AB86583F1(1824.12f, 4701.39f, 38.29f, 2.5f, 2.5f, 2.5f, 0f, 0, 7);
	iLocal_765 = unk_0xEE76955AB86583F1(1801.28f, 4700.25f, 39.42f, 2f, 2f, 2f, 0f, 0, 7);
	if (!unk_0x4CBFDAD06D630F7C("EPSILONISM_04_MIX"))
	{
		func_382("Starting dynamic mix EPSILONISM_04_MIX");
		unk_0x3EF2F05E6EA65602("EPSILONISM_04_MIX");
	}
	unk_0x6D073A8BCDE701F6(0);
	unk_0x2966D41514EAE84B(1, joaat("player"), joaat("player"));
	unk_0xABC4F2A6D7D56CF4(0.5f);
	uLocal_359 = unk_0xA6FCF4F51F5BCB55(1751.65f, 4676.77f, 43.03f, 1.5f);
	func_379();
	func_362();
	func_361();
	Local_771.f_0 = 0;
	...
	{
		func_358(&(Local_362[iVar0 /*43*/]));
		iVar0++;
	}
	func_357(&(Local_605[0 /*8*/]), Local_150, fLocal_153, Local_82.f_28[0], 0);
	func_357(&(Local_605[1 /*8*/]), Local_154, fLocal_157, Local_82.f_28[1], 0);
	if (func_394())
	{
		if (func_356() == 0)
		{
			func_355(Local_146, fLocal_149, 1, 0);
			func_354(1);
			func_353(&Local_82, 0, 1);
			func_352();
			func_382("Done replay setup");
		}
	}
	else if (func_393(0))
	{
		func_355(Local_146, fLocal_149, 1, 0);
		func_354(0);
		func_353(&Local_82, 1, 1);
		func_352();
	}
	func_350(60, 0, 0);
	while (true)
	{
		unk_0x0022A74B21F0C0B9("SF_Epsilon4", 0);
		func_334(Local_82.f_9, 0, 0, 0, 0, 0);
		unk_0x5227EC6E81831CAF(unk_0x1788E93557766241());
		if (func_333())
		{
		...
		if (func_332(unk_0xA16EC202D9D35357()))
		{
			if (func_331(unk_0xA16EC202D9D35357()) == iLocal_158)
			{
				unk_0x4B404C739A9AFC7A(0, 24, 1);
				unk_0x4B404C739A9AFC7A(0, 257, 1);
			}
		}
		switch (Local_771.f_0)
		{
			case 0:
				func_330();
				break;
...
void func_1()
{
	...
	switch (Local_771.f_1)
	{
		case 0:
			...
			if (unk_0x9BA82E09A986BA4B(sVar0, sLocal_160))
			{
				func_398(1);
			}
			else
...
void func_11()
{
	...
	unk_0x3D28909AF30D70F4("weapons@holster_1h");
	while (func_331(unk_0xA16EC202D9D35357()) == iLocal_158)
	{
		unk_0x4EDE34FBADD967A6(0);
		unk_0x8A5A9834DB717F2D(2);
		if (unk_0x6C47E32491756A1A("weapons@holster_1h"))
		{
			if (!unk_0x95EDB2DEFA5BB405(unk_0xA16EC202D9D35357(), "weapons@holster_1h", "holster", 3))
			{
				unk_0x5B5659C49032B96C(unk_0xA16EC202D9D35357(), "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			else if (unk_0x4CB0BCFFEC712BA2(unk_0xA16EC202D9D35357(), "weapons@holster_1h", "holster") >= 0.5f)
			{
	...
	if (iVar0 < 12)
	{
		unk_0x680350124CC21957(joaat("num_epsilon_step"), 12, 1);
		func_12(23, 12);
	}
	func_395();
}
...
int func_13(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar20 = 0;
		func_19(&iVar20);
		iVar21 = func_18(Var10, Global_97439.f_5944.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_16(Global_97439.f_5944.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_14(Global_97439.f_5944.f_765[iVar20 /*10*/]))
				{
					Global_97439.f_5944.f_765[iVar20 /*10*/] = { Var10 };
					func_15(&Var10);
					return 1;
...
void func_19(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_18(Global_97439.f_5944.f_765[iVar0 /*10*/], Global_97439.f_5944.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
int func_215()
{
	return func_216(unk_0x7E5A426328F6E635(), 0);
}
...
void func_223()
{
	unk_0x7CB5477E93D6A302(Local_624.f_2);
	unk_0x7CB5477E93D6A302(Local_624.f_3);
	unk_0x7CB5477E93D6A302(Local_624.f_4);
	unk_0x7CB5477E93D6A302(Local_624.f_5);
	Local_624.f_6 = 0;
	Local_624.f_7 = 0;
}
...
void func_225()
{
	switch (Local_771.f_1)
	{
		case 0:
			...
			unk_0x8A5A9834DB717F2D(2);
			unk_0x3E3552EF770E2B2A(unk_0xA16EC202D9D35357(), iLocal_158);
			Local_771.f_1 = 1;
			break;
		...
		case 1:
			...
			else if (unk_0xE44A580B551C3645(Local_605[0 /*8*/]))
			{
				func_235(6);
				Local_771.f_9 = 2;
				Local_771.f_1 = 3;
			}
			else if (unk_0xE44A580B551C3645(Local_605[1 /*8*/]))
			{
				func_235(6);
				Local_771.f_9 = 3;
				Local_771.f_1 = 3;
			}
			else if (unk_0xBF8ADDCADFC4691E(Local_605[0 /*8*/], unk_0xA16EC202D9D35357(), 1) && unk_0xD06F1DD413AB5E65(Local_605[0 /*8*/], 0, 2))
			{
				func_235(6);
				Local_771.f_9 = 4;
				Local_771.f_1 = 3;
			}
			else if (unk_0xBF8ADDCADFC4691E(Local_605[1 /*8*/], unk_0xA16EC202D9D35357(), 1) && unk_0xD06F1DD413AB5E65(Local_605[1 /*8*/], 0, 2))
			{
				func_235(6);
				Local_771.f_9 = 5;
				Local_771.f_1 = 3;
			}
			else if (func_228(&(Local_605[0 /*8*/])))
			{
				func_235(6);
				Local_771.f_9 = 6;
				Local_771.f_1 = 3;
			}
			else if (func_228(&(Local_605[1 /*8*/])))
			{
				func_235(6);
				Local_771.f_9 = 7;
				Local_771.f_1 = 3;
			...
			{
				if (func_226(unk_0xA16EC202D9D35357(), Local_605[0 /*8*/], 1) >= 50f)
				{
...
void func_236()
{
	...
	if (Local_771.f_3 == 1)
	{
		...
		if (iLocal_352 == 0)
		{
			func_290("EPS_4_MCS_1");
		}
		else if (iLocal_352 == 1)
		{
			func_290("EPS_4_MCS_2");
		}
		else
		{
			func_290("EPS_4_MCS_3");
		}
		if (unk_0x5EA36FD8E318DCED())
		{
			func_382("Trying to set player component variation");
			if (func_227(unk_0xA16EC202D9D35357()))
			{
				func_284("Michael", unk_0xA16EC202D9D35357(), 0, 2);
			}
			if (iLocal_352 == 0 || iLocal_352 == 2)
			{
				func_382("Trying to set Jimmy prop variation");
				unk_0x4F499783D088D57C("Jimmy_Boston", 1, 0, 0, 0);
			}
		}
		func_382("SKIP: Doing sync for cutscene skip");
		func_283(1, 1, 1);
		Local_771.f_3 = 0;
	}
	if (Local_771.f_1 == 0)
	{
		func_282("Doing setup for RockScene:", iLocal_352);
		func_280(1);
		func_279();
		unk_0x2E4D6907625CDD23(0, 200, 150);
		if (unk_0x5EA36FD8E318DCED())
		{
			func_382("Trying to set player component variation");
			if (func_227(unk_0xA16EC202D9D35357()))
		...
		if (!func_278(iLocal_361))
		{
			iLocal_361 = unk_0x9BB6F54E415071A1(joaat("bison"), 1851.57f, 4772.12f, 39.8f, 31.35f, 1, 1);
			unk_0xEEE37CF92B9966DA(iLocal_361, 157, 157);
			unk_0x780A5DADA769490D(iLocal_361, 5, 157);
			unk_0xAC894C93914464C2(iLocal_361);
		}
		func_277(&(Local_605[1 /*8*/]), 1);
		func_277(&(Local_605[0 /*8*/]), 1);
		if (func_332(unk_0xA16EC202D9D35357()))
		{
			while (!func_269(1, 1093140480, 0))
			{
				func_382("Waiting for cutscene to be OK to start...");
				unk_0x8A5A9834DB717F2D(2);
				func_280(1);
				func_279();
				unk_0x2E4D6907625CDD23(0, 200, 150);
			...
			unk_0xFDCF145DD87C1EEC(unk_0x1788E93557766241(), 1);
			iVar0 = unk_0x09560C7DE2A384BD();
			while ((unk_0x09560C7DE2A384BD() - iVar0) < 500)
			{
				func_382("Doing 500ms pause");
				unk_0x8A5A9834DB717F2D(2);
				unk_0xFDCF145DD87C1EEC(unk_0x1788E93557766241(), 1);
				func_280(1);
				func_279();
			...
			if (iLocal_352 == 0)
			{
				if (func_227(Local_605[1 /*8*/]))
				{
					unk_0x574BF3D848332F6A(Local_605[1 /*8*/], "Jimmy_Boston", 0, 0, 0);
				}
				if (func_227(Local_605[0 /*8*/]))
				{
					unk_0x574BF3D848332F6A(Local_605[0 /*8*/], "Marnie", 0, 0, 0);
				}
				if (func_227(unk_0xA16EC202D9D35357()))
				{
					unk_0x574BF3D848332F6A(unk_0xA16EC202D9D35357(), "Michael", 0, 0, 0);
				}
				if (func_227(Local_624.f_0))
				{
					iLocal_640 = func_266(unk_0xA16EC202D9D35357(), joaat("weapon_digiscanner"), 1, 0, 0, 0, 0);
					unk_0x574BF3D848332F6A(iLocal_640, "Artefact_Detector", 0, 0, 0);
				}
				if (func_227(Local_362[iLocal_352 /*43*/].f_1))
				{
					unk_0x574BF3D848332F6A(Local_362[iLocal_352 /*43*/].f_1, "EPS_TV", 0, 0, 0);
				}
			}
			else if (iLocal_352 == 1)
			{
				...
				if (func_227(Local_362[iLocal_352 /*43*/].f_1))
				{
					unk_0x574BF3D848332F6A(Local_362[iLocal_352 /*43*/].f_1, "EPS_Battery", 0, 0, 0);
				}
			}
			else
			{
				...
				if (func_227(Local_362[iLocal_352 /*43*/].f_1))
				{
					unk_0x574BF3D848332F6A(Local_362[iLocal_352 /*43*/].f_1, "Old_Boot", 0, 0, 0);
				}
			}
			unk_0xEA4B8437C8E2CA24(0);
			unk_0x5279A9DE67877B4B(1);
			iVar0 = unk_0x09560C7DE2A384BD();
			while ((unk_0x09560C7DE2A384BD() - iVar0) < 1)
			{
				unk_0x8A5A9834DB717F2D(2);
				unk_0x4EDE34FBADD967A6(0);
				unk_0x0022A74B21F0C0B9("SF_Epsilon4", 0);
			...
			if (iLocal_352 >= 2)
			{
				if (func_227(unk_0xA16EC202D9D35357()))
				{
					unk_0x39272B2594E03395(unk_0xA16EC202D9D35357(), joaat("weapon_unarmed"), -1, 1, 1);
				}
			}
			unk_0xFDCF145DD87C1EEC(unk_0x1788E93557766241(), 0);
			func_257(Local_362[iLocal_352 /*43*/].f_25, Local_362[iLocal_352 /*43*/].f_28, Local_362[iLocal_352 /*43*/].f_31, Local_362[iLocal_352 /*43*/].f_32, Local_362[iLocal_352 /*43*/].f_35, func_265(), 1, 1, 1, 0, 0);
			func_252(Local_362[iLocal_352 /*43*/].f_2, 1, 0, 1, 1, 1, 1, 0, 1, 1, 1);
		}
		func_282("Finished setup, moving to run loop for RockScene #:", iLocal_352);
		Local_771.f_1 = 1;
	}
	if (Local_771.f_1 == 1)
	{
		...
		else
		{
			if (iLocal_352 >= 2)
			{
				...
				{
					if (unk_0x7CA8D900E987DFB5() > 17000)
					{
						if (!unk_0xA84F80DD9F675CED())
						{
							unk_0x1232944746AEB20F(1847.472f, 4756.157f, 36.6968f, func_250(271.4718f), 145f, 0);
						}
					}
				}
			}
			if (Local_771.f_2 == 0)
			{
				...
				{
					Local_771.f_2 = -1;
					func_382("Cutscene not active, setting event -1");
				}
			}
			if (Local_771.f_2 == 1)
			{
			...
			if (Local_771.f_2 == -1)
			{
				...
				if (iLocal_352 >= 2)
				{
					unk_0x495459882382D113("EPS4_STOP");
					func_5(&(Local_362[iLocal_352 /*43*/].f_1));
				}
				Local_771.f_1 = 3;
				iLocal_352++;
				func_282("END CUTSCENE: iCurrentRock = ", iLocal_352);
			}
		}
	}
	if (Local_771.f_1 == 3)
	{
		...
		func_382("Doing cleanup for RockScene");
		func_237(1, 0, 1, 1);
		func_352();
	}
}
...
void func_238(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		func_243(0, iParam3, iParam2);
		if (!unk_0x2DE0B96E966FD817(unk_0xA16EC202D9D35357()) && !func_239(unk_0x1788E93557766241()))
		{
...
void func_245()
{
	unk_0xB067107D878E9585(uLocal_164, "SET_COLOUR");
	...
	unk_0xB067107D878E9585(uLocal_164, "SET_DISTANCE");
	unk_0x50050D925C27B388(10f);
	unk_0xD3DF251F2DF3B257();
	unk_0x8E515AA7023E13EA(uLocal_165);
	unk_0x782CAB485999E384(uLocal_164, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
}
...
int func_246()
{
	if (func_227(unk_0xA16EC202D9D35357()))
	{
		if (unk_0xE06B94F2BD99223C("Michael", 0))
		{
			if (iLocal_352 >= 2)
			{
				func_382("*** Forcing Michael's move state (end cutscene)");
				unk_0x86E7313D71D1A983(unk_0xA16EC202D9D35357(), joaat("MotionState_Idle"), 0, 1, 0);
				return 1;
			}
			else
			{
				func_382("*** Forcing Michael's move state");
				if (func_331(unk_0xA16EC202D9D35357()) != iLocal_158)
				{
					unk_0x39272B2594E03395(unk_0xA16EC202D9D35357(), iLocal_158, -1, 1, 1);
				}
				unk_0x86E7313D71D1A983(unk_0xA16EC202D9D35357(), joaat("MotionState_Idle"), 0, 1, 0);
				return 1;
			}
...
void func_247()
{
	if (func_227(Local_605[1 /*8*/]))
	{
		if (unk_0xE06B94F2BD99223C("Jimmy_Boston", 0))
		{
			if (iLocal_352 >= 2)
			{
				if (func_227(Local_82.f_28[1]) && func_278(iLocal_361))
				{
					unk_0x6D98AA46076A68BE(&uLocal_781);
					unk_0xF51BC0982D381189(0, iLocal_361, 0);
					unk_0x963BB7C99350D827(uLocal_781);
					unk_0x0891776D0327B77A(Local_82.f_28[1], uLocal_781);
					unk_0x2AF68ED52DC74B7D(&uLocal_781);
					func_382("Did Jimmy pass exit");
				}
			}
			else
			{
				unk_0x047BDE74F5ADA7D9(Local_82.f_28[1], 1764.089f, 4665.879f, 42.3031f, 1f, 20000, 1193033728, 1056964608);
				func_382("Did Jimmy regular exit");
			}
			unk_0x86E7313D71D1A983(Local_605[1 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
		}
	}
}
...
void func_248()
{
	if (func_227(Local_605[0 /*8*/]))
	{
		if (unk_0xE06B94F2BD99223C("Marnie", 0))
		{
			if (iLocal_352 >= 2)
			{
				if (func_227(Local_82.f_28[0]) && func_278(iLocal_361))
				{
					unk_0x6D98AA46076A68BE(&uLocal_781);
					unk_0xF51BC0982D381189(0, iLocal_361, -1);
					unk_0x9909D1FE2BA25A9B(0, iLocal_361, 1743.33f, 4962.18f, 45.16f, 20f, 0, joaat("bison"), 786599, 5f, -1f);
					unk_0x2B79CD6A5064FB19(0, iLocal_361, 30f, 262275);
					unk_0x963BB7C99350D827(uLocal_781);
					unk_0x0891776D0327B77A(Local_82.f_28[0], uLocal_781);
					unk_0x2AF68ED52DC74B7D(&uLocal_781);
					func_382("Did Marnie pass exit");
				}
			}
			else
			{
				unk_0x353F4B963593F141(Local_82.f_28[0], unk_0xA783C6007920169C(Local_82.f_28[0], 0f, 7f, 0f), 1f, 20000, 0.25f, 5, 1193033728);
				func_382("Did Marnie regular exit");
			}
			unk_0x86E7313D71D1A983(Local_605[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
		}
	}
}
...
void func_249()
{
	if (func_227(iLocal_640))
	{
		if (unk_0xE06B94F2BD99223C("Artefact_Detector", 0))
		{
			if (iLocal_352 < 2)
			{
				func_382("*** Detector exit");
				unk_0xEE7D6963A1C93AC3(iLocal_640, unk_0xA16EC202D9D35357());
				func_5(&iLocal_640);
				if (!unk_0x538DF9E5B1DF01EB(Local_624.f_0))
				{
					func_382("*** Recreating gDetector.hObj after cutscene...");
					Local_624.f_0 = unk_0x67DE942190116DCB(unk_0xA16EC202D9D35357());
				}
			}
			else
			{
				func_382("*** Detector exit (end cutscene)");
				func_5(&iLocal_640);
			}
		}
	}
...
Vector3 func_250(float fParam0)
{
...
int func_251()
{
	...
	else if (unk_0xE44A580B551C3645(Local_605[0 /*8*/]))
	{
		if (iLocal_352 < 2)
		{
			...
			Local_771.f_9 = 2;
			Local_771.f_1 = 3;
			func_382("Mission failed: Marnie dead");
			return 1;
		}
	}
	else if (unk_0xE44A580B551C3645(Local_605[1 /*8*/]))
	{
		if (iLocal_352 < 2)
		{
			...
			Local_771.f_9 = 3;
			Local_771.f_1 = 3;
			func_382("Mission failed: Jimmy dead");
			return 1;
		}
	}
	else if (unk_0xBF8ADDCADFC4691E(Local_605[0 /*8*/], unk_0xA16EC202D9D35357(), 1) && unk_0xD06F1DD413AB5E65(Local_605[0 /*8*/], 0, 2))
	{
		...
		Local_771.f_9 = 4;
		Local_771.f_1 = 3;
		func_382("Mission failed: Marnie injured");
		return 1;
	}
	else if (unk_0xBF8ADDCADFC4691E(Local_605[1 /*8*/], unk_0xA16EC202D9D35357(), 1) && unk_0xD06F1DD413AB5E65(Local_605[1 /*8*/], 0, 2))
	{
		...
		Local_771.f_9 = 5;
		Local_771.f_1 = 3;
		func_382("Mission failed: Jimmy injured");
		return 1;
	}
	return 0;
}
...
void func_252(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0x2AF80829930084FD(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x11E84835ED616A25(func_254(unk_0xA495B6AB6F2BF8C7()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
{
	func_258(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}
...
int func_266(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	while (func_267(iVar2, iVar8) != 0)
	{
		if (!unk_0xE44A580B551C3645(iParam0))
		{
			if (unk_0xD5E74D68EBC6D171(iParam0, iVar2, func_267(iVar2, iVar8)))
			{
				unk_0x795C9EBF753C3CAF(uVar1, func_267(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
void func_277(var uParam0, bool bParam1)
{
	if (func_332(*uParam0))
	{
		...
		if (bParam1)
		{
			unk_0x9AB8F163FA160890(*uParam0);
		}
		else
		{
		...
		if (unk_0x9A132E8DFAE1F524(*uParam0))
		{
...
{
	unk_0xB067107D878E9585(uLocal_164, "SET_COLOUR");
	unk_0x26221D1D76579618(67);
	unk_0x26221D1D76579618(200);
	unk_0x26221D1D76579618(255);
	unk_0x26221D1D76579618(255);
	unk_0x26221D1D76579618(209);
	unk_0x26221D1D76579618(67);
	unk_0x26221D1D76579618(255);
...
void func_280(int iParam0)
{
	if (iParam0 == 1)
	{
		if (func_281())
		{
			if ((unk_0x9BA82E09A986BA4B(Local_624.f_14, "NO_RECENT_ANIM") || !unk_0x95EDB2DEFA5BB405(Local_624.f_0, "rcm_epsilonism4", Local_624.f_14, 3)) || unk_0x4CB0BCFFEC712BA2(Local_624.f_0, "rcm_epsilonism4", Local_624.f_14) >= 0.98f)
			{
				if (fLocal_639 > 80f)
				{
				...
				unk_0xCF3A4FADE0BA9E36(Local_624.f_0, Local_624.f_14, "rcm_epsilonism4", 16f, 0, 0, 0, 0, 0);
			}
		}
	}
	else if (func_281())
	{
		if (!unk_0x9BA82E09A986BA4B(Local_624.f_14, "NO_RECENT_ANIM"))
		{
			if (unk_0x95EDB2DEFA5BB405(Local_624.f_0, "rcm_epsilonism4", Local_624.f_14, 1))
			{
				if (unk_0x4CB0BCFFEC712BA2(Local_624.f_0, "rcm_epsilonism4", Local_624.f_14) <= 0.05f)
				{
					unk_0x80CEE78A46F4D7CB(Local_624.f_0, Local_624.f_14, "rcm_epsilonism4", -4f);
...
void func_285(int iParam0, var uParam1, int iParam2)
{
	...
	func_286(iParam0, &Var2, 0);
	func_286(iParam0, uParam1, iParam2);
	iVar82 = 0;
	iVar83 = 0;
	iVar0 = 0;
	while (iVar0 < 12)
...
void func_293()
{
	...
	if (Local_771.f_3 == 1)
	{
		...
		if (iLocal_352 == 0)
		{
			if (!func_320())
			{
				unk_0x6C43BF7625967266(unk_0xA16EC202D9D35357(), Local_146, 1, 0, 0, 1);
				unk_0x34639238667C4381(unk_0xA16EC202D9D35357(), fLocal_149);
			}
			func_277(&(Local_605[1 /*8*/]), 1);
			func_277(&(Local_605[0 /*8*/]), 1);
			if (func_332(Local_605[1 /*8*/]))
			{
				unk_0x3CC3106305C40A28(Local_82.f_28[1], 0);
				unk_0x6C43BF7625967266(Local_605[1 /*8*/], 1829.75f, 4693.5f, 38.51f, 1, 0, 0, 1);
				unk_0x34639238667C4381(Local_605[1 /*8*/], 27.46f);
				Var2 = { unk_0xBF8499F46AD9093A(Local_605[1 /*8*/], 1) };
				unk_0x21B0D803C4C9C45E(1829.75f, 4693.5f, 38.51f, &fVar1, 0);
				unk_0x6C43BF7625967266(Local_605[1 /*8*/], Var2.f_0, Var2.f_1, fVar1, 1, 0, 0, 1);
				func_382("Setting Jimmy position (0)");
			}
			if (func_332(Local_605[0 /*8*/]))
			{
				unk_0x6C43BF7625967266(Local_605[0 /*8*/], 1827.32f, 4692.59f, 38.53f, 1, 0, 0, 1);
				unk_0x34639238667C4381(Local_605[0 /*8*/], 171.22f);
				func_382("Setting Marnie position (0)");
			}
		}
		else if (iLocal_352 == 1)
		{
			unk_0x6C43BF7625967266(unk_0xA16EC202D9D35357(), 1754.634f, 4675.789f, 42.9068f, 1, 0, 0, 1);
			unk_0x34639238667C4381(unk_0xA16EC202D9D35357(), 293.2275f);
			if (func_332(Local_605[1 /*8*/]))
			{
				unk_0x6C43BF7625967266(Local_605[1 /*8*/], 1758.586f, 4670.085f, 42.6276f, 1, 0, 0, 1);
				unk_0x34639238667C4381(Local_605[1 /*8*/], 262.4368f);
				func_382("Setting Jimmy position (1)");
			}
			if (func_332(Local_605[0 /*8*/]))
			{
				unk_0x6C43BF7625967266(Local_605[0 /*8*/], 1759.917f, 4683.584f, 42.7266f, 1, 0, 0, 1);
				unk_0x34639238667C4381(Local_605[0 /*8*/], 148.3211f);
				func_382("Setting Marnie position (1)");
			}
		}
		else if (iLocal_352 == 2)
		{
			unk_0x6C43BF7625967266(unk_0xA16EC202D9D35357(), 1758.454f, 4829.431f, 39.729f, 1, 0, 0, 1);
			unk_0x34639238667C4381(unk_0xA16EC202D9D35357(), 168.2012f);
			if (func_332(Local_605[0 /*8*/]))
			{
				unk_0x6C43BF7625967266(Local_605[0 /*8*/], 1755.005f, 4827.329f, 40.0736f, 1, 0, 0, 1);
				unk_0x34639238667C4381(Local_605[0 /*8*/], 169.6486f);
				func_382("Setting Marnie position (2)");
			}
		}
	...
	if (Local_771.f_1 == 0)
	{
		func_282("Doing setup for FindRock section:", iLocal_352);
		func_277(&(Local_605[1 /*8*/]), 0);
		iLocal_349 = 0;
		iLocal_351 = 0;
		iLocal_622 = 0;
		iLocal_358 = -1;
		iLocal_752 = 0;
		iLocal_753 = 0;
		iLocal_754 = unk_0x09560C7DE2A384BD();
		iLocal_756 = unk_0x09560C7DE2A384BD();
		iLocal_757 = 0;
		if (iLocal_352 == 0)
		{
			if (func_332(unk_0xA16EC202D9D35357()))
			...
			if (func_332(Local_605[1 /*8*/]))
			{
				unk_0x3E3552EF770E2B2A(Local_605[1 /*8*/], iLocal_158);
				unk_0x353F4B963593F141(Local_605[1 /*8*/], 1826.246f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 1193033728);
			}
			func_318(&(Local_605[1 /*8*/]), 1);
			iLocal_747 = 8;
			iLocal_748 = 8;
			iLocal_750 = 0;
			iLocal_749 = 0;
		...
		else if (iLocal_352 == 1)
		{
			...
			func_318(&(Local_605[0 /*8*/]), 0);
			func_317(&(Local_605[1 /*8*/]), uLocal_759);
			iLocal_747 = 8;
			iLocal_748 = 8;
			iLocal_750 = 0;
			iLocal_749 = 0;
		...
		else if (iLocal_352 == 2)
		{
			...
			func_317(&(Local_605[0 /*8*/]), uLocal_762);
			func_316(&(Local_605[1 /*8*/]), iLocal_760);
			iLocal_747 = 11;
			iLocal_748 = 12;
			iLocal_750 = 0;
			iLocal_749 = 0;
		...
		func_315(&uLocal_167, 0, unk_0xA16EC202D9D35357(), "MICHAEL", 0, 1);
		func_315(&uLocal_167, 5, Local_605[1 /*8*/], "JIMMYBOSTON", 0, 1);
		func_315(&uLocal_167, 4, Local_605[0 /*8*/], "MARNIE", 0, 1);
		if (iLocal_352 == 0)
		{
		...
		func_314(Local_362[iLocal_352 /*43*/].f_18, Local_362[iLocal_352 /*43*/].f_19, Local_362[iLocal_352 /*43*/].f_20, Local_362[iLocal_352 /*43*/].f_21, Local_362[iLocal_352 /*43*/].f_22);
		bLocal_335 = false;
		iLocal_336 = 0;
		iLocal_337 = 0;
		iLocal_338 = 1;
		...
		iLocal_746 = 0;
		unk_0xFD1E0AEC770DAF2E(1);
		iLocal_357 = unk_0x09560C7DE2A384BD();
		iLocal_746 = unk_0x09560C7DE2A384BD() + 1000;
		func_282("Finished setup, moving to run loop for rock #:", iLocal_352);
		Local_771.f_1 = 1;
	}
	if (Local_771.f_1 == 1)
	{
		...
		else if (!func_313(&uLocal_693, unk_0xBF8499F46AD9093A(unk_0xA16EC202D9D35357(), 1)))
		{
			func_235(6);
			Local_771.f_9 = 8;
			Local_771.f_1 = 3;
		...
		else
		{
			...
			while (iVar0 < 2)
			{
				func_310(&(Local_605[iVar0 /*8*/]));
				iVar0++;
			}
			if (unk_0x538DF9E5B1DF01EB(Local_362[iLocal_352 /*43*/].f_1))
			{
				if (iLocal_352 == 0)
				{
					if (func_226(unk_0xA16EC202D9D35357(), Local_362[iLocal_352 /*43*/].f_1, 1) < 100f)
					{
						if (!unk_0x74F469BC7D5F3A5D())
						{
							unk_0x752468956AA26EF0("EPS_4_MCS_1", 8);
							func_382("Requesting midtro now");
						}
					}
					else if (func_226(unk_0xA16EC202D9D35357(), Local_362[iLocal_352 /*43*/].f_1, 1) > 120f)
					{
						if (unk_0x74F469BC7D5F3A5D())
						{
							func_382("Player moved away - unloading midtro");
							unk_0x50CEB49FC52ED0FE();
						}
					}
				}
				else if (iLocal_352 == 1)
				{
					if (func_226(unk_0xA16EC202D9D35357(), Local_362[iLocal_352 /*43*/].f_1, 1) < 100f)
					{
						if (!unk_0x74F469BC7D5F3A5D())
						{
							unk_0x752468956AA26EF0("EPS_4_MCS_2", 8);
							func_382("Requesting midtro now");
						}
					}
					else if (func_226(unk_0xA16EC202D9D35357(), Local_362[iLocal_352 /*43*/].f_1, 1) > 120f)
				...
				else if (func_226(unk_0xA16EC202D9D35357(), Local_362[iLocal_352 /*43*/].f_1, 1) < 100f)
				{
					if (!unk_0x74F469BC7D5F3A5D())
					{
						unk_0x752468956AA26EF0("EPS_4_MCS_3", 8);
						func_382("Requesting midtro now");
					}
				}
				else if (func_226(unk_0xA16EC202D9D35357(), Local_362[iLocal_352 /*43*/].f_1, 1) > 120f)
			...
			func_309(&(Local_362[iLocal_352 /*43*/]));
			if (iLocal_352 == 0)
			{
				if (iLocal_745 == 0)
				{
					if (iLocal_746 < unk_0x09560C7DE2A384BD())
					{
						if (!func_333())
						{
							func_308("EPS4_T0");
							iLocal_746 = unk_0x09560C7DE2A384BD() + 7500;
							iLocal_745++;
							iLocal_758 = unk_0x09560C7DE2A384BD();
						}
						else
						{
							iLocal_745 = 2;
				...
				{
					if (unk_0x1453F50088A91E4E(0, 25) || iLocal_746 < unk_0x09560C7DE2A384BD())
					{
						unk_0xFD1E0AEC770DAF2E(1);
						iLocal_746 = unk_0x09560C7DE2A384BD() + 1000;
						iLocal_745++;
			...
			func_280(Local_624.f_1);
			if (iLocal_338 == 1)
			{
				func_307(&uLocal_163);
				if (!func_313(&uLocal_641, unk_0xBF8499F46AD9093A(unk_0xA16EC202D9D35357(), 1)))
				{
					iLocal_338 = 0;
					unk_0x0D68C13151B68364(0);
					unk_0xEDC11454B9658FE1();
				...
				{
					if (unk_0x9BA82E09A986BA4B(Local_362[iLocal_352 /*43*/].f_36, sLocal_160) || func_298(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!unk_0x9BA82E09A986BA4B(Local_362[iLocal_352 /*43*/].f_36, sLocal_160))
						{
							if (func_227(iLocal_360))
							{
								unk_0x4745F9C50C63A48C(iLocal_360, unk_0xA16EC202D9D35357(), 10000, 0, 2);
							}
						}
						iLocal_758 = unk_0x09560C7DE2A384BD();
						iLocal_339 = 1;
				...
				{
					if (!func_273() && (unk_0x09560C7DE2A384BD() - iLocal_357) >= 7500)
					{
						if ((unk_0x9BA82E09A986BA4B(Local_362[iLocal_352 /*43*/].f_37, sLocal_160) || !unk_0x14F9932776F21CC2(unk_0xA16EC202D9D35357(), iLocal_360, 30f, 30f, 30f, 0, 1, 0)) || func_298(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!unk_0x9BA82E09A986BA4B(Local_362[iLocal_352 /*43*/].f_37, sLocal_160))
							{
								if (func_227(iLocal_360))
								{
									unk_0x4745F9C50C63A48C(iLocal_360, unk_0xA16EC202D9D35357(), 5000, 0, 2);
								}
							}
							iLocal_340 = 1;
							iLocal_758 = unk_0x09560C7DE2A384BD();
				...
				else if (iLocal_337 == 0 && !func_296(unk_0xA16EC202D9D35357(), Local_362[iLocal_352 /*43*/].f_2, 9f))
				{
					if (func_296(unk_0xA16EC202D9D35357(), Local_362[iLocal_352 /*43*/].f_2, 20f))
					{
						if (!iLocal_342)
						{
							if (!func_273())
							{
								if (func_298(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_42, 7, 0, 0, 0))
								{
									if (func_227(iLocal_360))
									{
										unk_0x4745F9C50C63A48C(iLocal_360, unk_0xA16EC202D9D35357(), 5000, 0, 2);
									}
									unk_0xA01DA3D318F1C532(3f, 5f, 0);
									iLocal_342 = 1;
								}
							}
						}
					...
					{
						if (func_295(unk_0xA16EC202D9D35357(), iLocal_360, 30f) || iLocal_352 == 2)
						{
							if (!func_273() && (unk_0x09560C7DE2A384BD() - iLocal_355) > 15000)
							{
								if (bLocal_335)
								{
									if (iLocal_351 == 0)
									{
										...
										{
											if (unk_0x9BA82E09A986BA4B(Local_362[iLocal_352 /*43*/].f_40, sLocal_160) || func_298(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_332(iLocal_360))
												{
													unk_0x4745F9C50C63A48C(iLocal_360, unk_0xA16EC202D9D35357(), 3000, 0, 2);
												}
												iLocal_355 = unk_0x09560C7DE2A384BD();
												iLocal_749++;
												if (iLocal_352 == 2)
									...
									{
										if (unk_0x9BA82E09A986BA4B(Local_362[iLocal_352 /*43*/].f_40, sLocal_160) || func_298(&uLocal_167, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_355 = unk_0x09560C7DE2A384BD();
											iLocal_751++;
										}
								...
								{
									if (unk_0x9BA82E09A986BA4B(Local_362[iLocal_352 /*43*/].f_41, sLocal_160) || func_298(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_332(iLocal_360))
										{
											unk_0x4745F9C50C63A48C(iLocal_360, unk_0xA16EC202D9D35357(), 3000, 0, 2);
							...
							else if (bLocal_335 != Local_624.f_1)
							{
								...
								if (bLocal_335)
								{
									if (iLocal_356 < unk_0x09560C7DE2A384BD())
									{
										if (func_273())
										{
											unk_0x0D68C13151B68364(1);
										}
										iLocal_355 = (unk_0x09560C7DE2A384BD() - 7500);
										iLocal_356 = unk_0x09560C7DE2A384BD();
									}
								}
								else
								{
					...
					{
						iLocal_355 = (unk_0x09560C7DE2A384BD() - 5000);
					}
				}
				if (iLocal_352 == 0)
				{
					if (iLocal_752 < 5)
					{
						if (((unk_0x09560C7DE2A384BD() - iLocal_754) > 7500 && !func_273()) && !unk_0xCE3402BDFD2ADED8())
						{
							if (func_227(Local_605[0 /*8*/]))
							{
								if (func_226(Local_605[0 /*8*/], unk_0xA16EC202D9D35357(), 1) < 4f)
								{
									if (func_298(&uLocal_167, "EPS4AUD", "EPS4_NEARM", 6, 0, 0, 0))
									{
										iLocal_752++;
										iLocal_754 = unk_0x09560C7DE2A384BD();
									}
				...
				else if (iLocal_352 == 1)
				{
					if (iLocal_752 < 4)
					{
						if (((unk_0x09560C7DE2A384BD() - iLocal_754) > 7500 && !func_273()) && !unk_0xCE3402BDFD2ADED8())
						{
							if (func_227(Local_605[1 /*8*/]))
							{
								if (func_226(Local_605[1 /*8*/], unk_0xA16EC202D9D35357(), 1) < 4f)
								{
									if (func_298(&uLocal_167, "EPS4AUD", "EPS4_NEARJ", 6, 0, 0, 0))
									{
										iLocal_752++;
										iLocal_754 = unk_0x09560C7DE2A384BD();
									}
					...
					if (iLocal_752 < 3)
					{
						if (((unk_0x09560C7DE2A384BD() - iLocal_754) > 7500 && !func_273()) && !unk_0xCE3402BDFD2ADED8())
						{
							if (func_227(Local_605[1 /*8*/]))
							{
								if (func_226(Local_605[1 /*8*/], unk_0xA16EC202D9D35357(), 1) < 4f)
								{
									if (func_298(&uLocal_167, "EPS4AUD", "EPS4_NEARJP", 6, 0, 0, 0))
									{
										iLocal_752++;
										iLocal_754 = unk_0x09560C7DE2A384BD();
									}
					...
					if (iLocal_753 < 4)
					{
						if (((unk_0x09560C7DE2A384BD() - iLocal_754) > 7500 && !func_273()) && !unk_0xCE3402BDFD2ADED8())
						{
							if (func_227(Local_605[0 /*8*/]))
							{
								if (func_226(Local_605[0 /*8*/], unk_0xA16EC202D9D35357(), 1) < 4f)
								{
									if (func_298(&uLocal_167, "EPS4AUD", "EPS4_NEARMP", 6, 0, 0, 0))
									{
										iLocal_753++;
										iLocal_754 = unk_0x09560C7DE2A384BD();
									}
				...
				if (unk_0x965556ACF6A83973(unk_0xA16EC202D9D35357(), Local_362[iLocal_352 /*43*/].f_2, 6.2f, 6.2f, 2f, 0, 0, 1))
				{
					if (iLocal_358 == -1)
					{
						iLocal_358 = unk_0x09560C7DE2A384BD();
					}
					else if ((unk_0x09560C7DE2A384BD() - iLocal_358) >= 1500)
					{
						if (func_273())
						{
							func_271();
						}
						iLocal_536 = unk_0x09560C7DE2A384BD();
						func_235(3);
						Local_771.f_1 = 3;
					}
				}
				...
				else if (!func_296(unk_0xA16EC202D9D35357(), Local_362[iLocal_352 /*43*/].f_2, (9f + 2f)))
				{
					iLocal_336 = 0;
				}
			}
			...
			{
				if (!unk_0x5660C8AFDD9C1721(uLocal_163))
				{
					uLocal_163 = func_294(Local_143, 5, 0);
				}
				bLocal_335 = Local_624.f_1;
				if (func_313(&uLocal_641, unk_0xBF8499F46AD9093A(unk_0xA16EC202D9D35357(), 1)))
				{
				...
				else if (iLocal_343 == 0)
				{
					if (iLocal_352 < 2)
					{
						if (unk_0x14F9932776F21CC2(unk_0xA16EC202D9D35357(), iLocal_360, 30f, 30f, 30f, 0, 1, 0))
						{
							if (!func_273() && !unk_0xCE3402BDFD2ADED8())
							{
								if (unk_0x9BA82E09A986BA4B(Local_362[iLocal_352 /*43*/].f_38, sLocal_160) || func_298(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_38, 7, 0, 0, 0))
								{
									iLocal_343 = 1;
								}
							}
					...
					else if (!func_273() && !unk_0xCE3402BDFD2ADED8())
					{
						if (unk_0x9BA82E09A986BA4B(Local_362[iLocal_352 /*43*/].f_38, sLocal_160) || func_298(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_38, 7, 0, 0, 0))
						{
							iLocal_343 = 1;
				...
				else if (iLocal_344 == 0)
				{
					if (iLocal_352 < 2)
					{
						if (unk_0x14F9932776F21CC2(unk_0xA16EC202D9D35357(), iLocal_360, 30f, 30f, 30f, 0, 1, 0))
						{
							if ((!func_273() && (unk_0x09560C7DE2A384BD() - iLocal_357) >= 7500) && !unk_0xCE3402BDFD2ADED8())
							{
								if (unk_0x9BA82E09A986BA4B(Local_362[iLocal_352 /*43*/].f_39, sLocal_160) || func_298(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_39, 7, 0, 0, 0))
								{
									iLocal_344 = 1;
								}
							}
					...
					else if ((!func_273() && (unk_0x09560C7DE2A384BD() - iLocal_357) >= 7500) && !unk_0xCE3402BDFD2ADED8())
					{
						if (unk_0x9BA82E09A986BA4B(Local_362[iLocal_352 /*43*/].f_39, sLocal_160) || func_298(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_39, 7, 0, 0, 0))
						{
							iLocal_344 = 1;
	...
	{
		unk_0x8A5A9834DB717F2D(2);
		func_382("In cleanup for FindRock");
		if (func_273())
		{
			unk_0x0D68C13151B68364(1);
		}
		...
		func_279();
		unk_0x2E4D6907625CDD23(0, 200, 150);
		if ((unk_0x09560C7DE2A384BD() - iLocal_536) > 750)
		{
			func_223();
...
bool func_298(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_306(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)
{
...
void func_309(var uParam0)
{
	...
	fVar0 = unk_0x2A488C176D52CCA5(uParam0->f_2, unk_0xBF8499F46AD9093A(unk_0xA16EC202D9D35357(), 1));
	Var1 = { unk_0x0A0652D7F8135EB9(unk_0xA16EC202D9D35357()) };
	if (fVar0 > Local_624.f_11)
	{
		fVar7 = 0f;
		if (Local_624.f_8 > 0f)
		{
			fVar7 = (fVar7 + (unk_0x0BADBFA3B172435F(((fVar0 - Local_624.f_11) * (360f / Local_624.f_8))) * Local_624.f_10));
		}
		if (Local_624.f_9 > 0f)
		{
			fVar7 = (fVar7 + (unk_0x0BADBFA3B172435F(((fVar0 - Local_624.f_11) * (360f / Local_624.f_9))) * (Local_624.f_10 * -0.7f)));
		}
	...
	Var8 = { uParam0->f_2 - unk_0xBF8499F46AD9093A(unk_0xA16EC202D9D35357(), 1) };
	Var11 = { uParam0->f_2 - unk_0xA783C6007920169C(unk_0xA16EC202D9D35357(), 0f, -5f, 0f) };
	bVar14 = ((Var8.f_0 * Var4.f_0) + (Var8.f_1 * Var4.f_1)) > 0f;
	fVar15 = (1f - (unk_0xA8BB1E729C39DD16(Var4.f_0, Var4.f_1, Var11.f_0, Var11.f_1) / 180f));
	if (fVar0 >= 10f)
	{
	...
	else if (iLocal_353 < unk_0x09560C7DE2A384BD())
	{
		if (fVar0 <= 6.5f && bVar16)
		{
			unk_0x7CB5477E93D6A302(Local_624.f_3);
			unk_0x9AF4B23C594DCEE5(Local_624.f_4, "CONTINUAL_BEEP", unk_0xA16EC202D9D35357(), "EPSILONISM_04_SOUNDSET", 0, 0);
			Local_624.f_6 = 1;
		}
		else
		{
			...
			iLocal_353 = (unk_0x09560C7DE2A384BD() + iVar18);
			iVar18 = (iVar18 / 3);
			if (iVar18 < 100)
			{
				iVar18 = 100;
			}
			iLocal_354 = (unk_0x09560C7DE2A384BD() + iVar18);
			unk_0x9AF4B23C594DCEE5(Local_624.f_3, "IDLE_BEEP", unk_0xA16EC202D9D35357(), "EPSILONISM_04_SOUNDSET", 0, 0);
			if (bVar16)
			{
				unk_0x2E4D6907625CDD23(0, 200, 150);
			}
			...
			{
				unk_0x2E4D6907625CDD23(0, 200, 100);
			}
		}
	}
	if (iLocal_354 > 0 && unk_0x09560C7DE2A384BD() > iLocal_354)
	{
		unk_0x7CB5477E93D6A302(Local_624.f_3);
		iLocal_354 = 0;
	}
	if (unk_0x76F7F25F198388A1())
	{
		if (Local_624.f_7 == 0)
		{
			unk_0x9AF4B23C594DCEE5(Local_624.f_5, "SCAN", unk_0xA16EC202D9D35357(), "EPSILONISM_04_SOUNDSET", 0, 0);
			Local_624.f_7 = 1;
		}
		else if (bVar16)
		{
			unk_0x4AE2DA60B696489F(Local_624.f_5, "IsOnTarget", 1f);
		}
		else
		{
			unk_0x4AE2DA60B696489F(Local_624.f_5, "IsOnTarget", 0f);
		}
		iLocal_758 = unk_0x09560C7DE2A384BD();
	}
	...
	else
	{
		...
		unk_0xB067107D878E9585(uLocal_164, "SET_DISTANCE");
		unk_0x50050D925C27B388(fLocal_639);
		unk_0xD3DF251F2DF3B257();
		unk_0x8E515AA7023E13EA(uLocal_165);
		unk_0x782CAB485999E384(uLocal_164, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	}
	if (unk_0xF49761626882E968(0, 25))
	{
		unk_0x00CFDDE7ACCA68D1(unk_0xA16EC202D9D35357(), 1f);
		unk_0x4B404C739A9AFC7A(0, 22, 1);
		if (bLocal_350)
		{
			unk_0x60365B850FB7354F(15f, 1065353216);
...
void func_310(var uParam0)
{
	...
	if (func_332(*uParam0) && unk_0x9A132E8DFAE1F524(*uParam0))
	{
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			{
				iVar0 = unk_0x444ECD635D5FD45F(0, iLocal_604);
				while (uParam0->f_3 == -1)
				{
					if (Local_537[iVar0 /*6*/].f_5 == 0)
					{
						...
						{
							if (!unk_0x965556ACF6A83973(*uParam0, Local_537[iVar0 /*6*/], 3f, 3f, 3f, 0, 1, 0))
							{
								func_282("Telling ped to go to marker: ", iVar0);
				...
				unk_0x353F4B963593F141(*uParam0, Local_537[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 1193033728);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (!uParam0->f_7)
				{
					if (unk_0x221AC1EF116F6053(*uParam0, 713668775) == 7)
					{
						func_382("Eps reached marker! (follow nav to coord)");
						uParam0->f_1 = 2;
						uParam0->f_2 = 0;
					}
				}
				else if (unk_0x221AC1EF116F6053(*uParam0, 2106541073) == 7)
				{
					func_382("Eps reached marker! (go straight to coord)");
					uParam0->f_7 = 0;
					uParam0->f_1 = 2;
					uParam0->f_2 = 0;
				}
		...
		case 2:
			...
			{
				func_282("Telling ped do sequence for marker: ", uParam0->f_3);
				unk_0x6D98AA46076A68BE(&uLocal_166);
				if (Local_537[uParam0->f_3 /*6*/].f_4 == 0)
				{
					if (*uParam0 == Local_605[1 /*8*/])
					{
						unk_0x5B5659C49032B96C(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_entry_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x5B5659C49032B96C(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x5B5659C49032B96C(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_exit_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else
					{
						unk_0x5B5659C49032B96C(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_entry_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x5B5659C49032B96C(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x5B5659C49032B96C(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_exit_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
				}
				else if (Local_537[uParam0->f_3 /*6*/].f_4 == 2)
				{
					unk_0x4341FCA05D2E4938(0, Local_537[uParam0->f_3 /*6*/].f_3, 0);
					unk_0x5B5659C49032B96C(0, "rcm_epsilonism4", "peeing", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				else if (Local_537[uParam0->f_3 /*6*/].f_4 == 3)
				{
					unk_0x5B5659C49032B96C(0, "rcm_epsilonism4", "hippy_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				...
				unk_0x963BB7C99350D827(uLocal_166);
				unk_0x0891776D0327B77A(*uParam0, uLocal_166);
				unk_0x2AF68ED52DC74B7D(&uLocal_166);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (unk_0x221AC1EF116F6053(*uParam0, 242628503) == 7)
				{
					Local_537[uParam0->f_3 /*6*/].f_5 = 0;
					uParam0->f_3 = -1;
					uParam0->f_1 = 1;
		...
		case 4:
			...
			{
				if (!unk_0x965556ACF6A83973(unk_0xA16EC202D9D35357(), uParam0->f_4, 1f, 1f, 1f, 0, 1, 0) || iLocal_352 > 0)
				{
					if (!unk_0x9A132E8DFAE1F524(*uParam0))
					{
						unk_0x937785D9C1929236(*uParam0);
						unk_0xE4C80CFABEAEED8F(*uParam0, func_311());
						unk_0xA1478EBA54DDE31B(*uParam0, 167, 1);
					}
					iLocal_755 = unk_0x09560C7DE2A384BD();
					if (iLocal_352 == 0)
					{
						unk_0xC3A743179E216562(func_311(), 0);
					}
					else
					{
						unk_0xC3A743179E216562(func_311(), 0);
					}
					unk_0xF2D0E8407A46C53A(func_311(), 4f, -1082130432, -1082130432);
					uParam0->f_2 = 1;
				}
			}
			else if (uParam0->f_2 == 1)
			{
				...
				if (unk_0x8C921D498D1DDF5F(*uParam0))
				{
					if (!iLocal_349)
					{
						if ((unk_0x09560C7DE2A384BD() - iLocal_755) > 6000)
						{
							unk_0x6D98AA46076A68BE(&uLocal_166);
							if (*uParam0 == Local_605[1 /*8*/])
							{
							...
							if (!func_273() && !unk_0xCE3402BDFD2ADED8())
							{
								if (*uParam0 == Local_605[1 /*8*/])
								{
									func_298(&uLocal_167, "EPS4AUD", "EPS4_DAWDJ", 7, 0, 0, 0);
								}
								else
								{
									func_298(&uLocal_167, "EPS4AUD", "EPS4_DAWDM", 7, 0, 0, 0);
								}
							}
							iLocal_349 = 1;
						}
				...
				if (unk_0xD7708B5D68A32CA0(unk_0xA16EC202D9D35357()) || unk_0xEF3A70D83EA38426(unk_0xA16EC202D9D35357()))
				{
					if ((((unk_0x09560C7DE2A384BD() - iLocal_756) > 7500 && !func_273()) && !unk_0xCE3402BDFD2ADED8()) && !iLocal_336)
					{
						if (*uParam0 == Local_605[1 /*8*/])
						{
							if (func_298(&uLocal_167, "EPS4AUD", "EPS4_MESSJ", 7, 0, 0, 0))
							{
								iLocal_756 = unk_0x09560C7DE2A384BD();
							}
						}
						else if (func_298(&uLocal_167, "EPS4AUD", "EPS4_MESSM", 7, 0, 0, 0))
						{
							iLocal_756 = unk_0x09560C7DE2A384BD();
						}
					}
				}
				if ((unk_0x09560C7DE2A384BD() - iLocal_758) > 15000)
				{
					if ((((iLocal_757 < 4 && !func_273()) && !unk_0xCE3402BDFD2ADED8()) && !iLocal_336) && !func_333())
					{
						if (*uParam0 == Local_605[1 /*8*/])
						{
							if (func_298(&uLocal_167, "EPS4AUD", "EPS4_PROMPTJ", 7, 0, 0, 0))
							{
								iLocal_758 = unk_0x09560C7DE2A384BD();
								iLocal_757++;
							}
						}
						else if (func_298(&uLocal_167, "EPS4AUD", "EPS4_PROMPTM", 7, 0, 0, 0))
						{
							iLocal_758 = unk_0x09560C7DE2A384BD();
							iLocal_757++;
						}
		...
		case 5:
			...
			{
				unk_0xF3B924DCFDECDB4B(*uParam0, unk_0xA16EC202D9D35357(), 20000, 4.5f, 1073741824, 1073741824, 0);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
...
{
	if (func_332(iParam0) && func_227(unk_0xA16EC202D9D35357()))
	{
		if (iLocal_622 == 0)
		{
			if (unk_0x59C8BF753F6A2D1C(unk_0xA16EC202D9D35357(), iParam0) && unk_0xEAABEAE1DB589285(iParam0))
			{
				func_382("Player knocked Eps over!");
				iLocal_622 = 1;
				iLocal_623 = iParam0;
				unk_0x937785D9C1929236(iParam0);
			}
		}
		else if (func_332(iLocal_623))
		{
			if (unk_0xDBE30D8105A6CC0C(iLocal_623) || unk_0xB4AD7D9D08986FF5(iLocal_623))
			{
				if (!func_273() && !unk_0xCE3402BDFD2ADED8())
				{
					if (iLocal_623 == Local_605[1 /*8*/])
					{
						if (func_298(&uLocal_167, "EPS4AUD", "EPS4_JKNOCK", 7, 0, 0, 0))
						{
							iLocal_622 = 0;
							iLocal_623 = 0;
						}
					}
					else if (func_298(&uLocal_167, "EPS4AUD", "EPS4_MKNOCK", 7, 0, 0, 0))
					{
						iLocal_622 = 0;
						iLocal_623 = 0;
					}
...
bool func_313(var uParam0, struct<2> Param1, float fParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
{
	unk_0x9AF4B23C594DCEE5(Local_624.f_2, "DEVICE", unk_0xA16EC202D9D35357(), "EPSILONISM_04_SOUNDSET", 0, 0);
	if (Local_624.f_13 == 0)
	{
...
void func_316(var uParam0, int iParam1)
{
	if (func_332(*uParam0))
	{
		...
		unk_0x9AB8F163FA160890(*uParam0);
		unk_0x6C43BF7625967266(*uParam0, Local_537[iParam1 /*6*/], 1, 0, 0, 1);
		unk_0x34639238667C4381(*uParam0, Local_537[iParam1 /*6*/].f_3);
	}
	else
	{
		uParam0->f_1 = 0;
...
{
	if (func_332(*uParam0) && func_332(unk_0xA16EC202D9D35357()))
	{
		uParam0->f_1 = 4;
		uParam0->f_2 = 0;
		unk_0x4745F9C50C63A48C(*uParam0, unk_0xA16EC202D9D35357(), -1, 0, 2);
		if (bParam1)
		{
			unk_0x1CAB36EC4E43E586(*uParam0, unk_0xA16EC202D9D35357(), 0);
		}
		uParam0->f_4 = { unk_0xBF8499F46AD9093A(unk_0xA16EC202D9D35357(), 1) };
	}
	else
	{
		uParam0->f_1 = 0;
...
int func_322()
{
	...
	unk_0x3D28909AF30D70F4("rcm_epsilonism4leadinout");
	if (unk_0x6C47E32491756A1A("rcm_epsilonism4") && unk_0x6C47E32491756A1A("rcm_epsilonism4leadinout"))
	{
		return 1;
	}
	return 0;
...
int func_323()
{
	...
	while (iVar0 < iLocal_535)
	{
		unk_0x939DA7EBCC6588FF(Local_362[iVar0 /*43*/]);
		iVar0++;
	}
	unk_0x939DA7EBCC6588FF(uLocal_159);
	unk_0x939DA7EBCC6588FF(joaat("bison"));
	iVar0 = 0;
	while (iVar0 < iLocal_535)
	{
		if (!unk_0x5494F37F35C1D7D7(Local_362[iVar0 /*43*/]))
		{
			return 0;
		}
		iVar0++;
	}
	if (!unk_0x5494F37F35C1D7D7(iLocal_159) || !unk_0x5494F37F35C1D7D7(joaat("bison")))
	{
		return 0;
	}
	return 1;
...
void func_325()
{
	if (unk_0x5EA36FD8E318DCED())
	{
		func_382("Can request assets for cutscene entity in Eps 4");
		unk_0x4F499783D088D57C("Jimmy_Boston", 1, 0, 0, 0);
		if (func_227(unk_0xA16EC202D9D35357()))
		{
			func_284("Michael", unk_0xA16EC202D9D35357(), 0, 2);
	...
	if (Local_771.f_3 == 1)
	{
		func_291(1, 1);
		unk_0x50CEB49FC52ED0FE();
		func_382("SKIP: Doing sync for intro skip");
		if (!func_393(0))
		{
			func_283(1, 1, 1);
		}
	...
	if (Local_771.f_1 == 0)
	{
		if (!unk_0x326BF57075FB3421())
		{
			unk_0x752468956AA26EF0("ep_4_rcm_concat", 8);
		}
		func_382("In Intro setup, waiting for cutscene to be ready...");
		if (func_269(1, 1093140480, 0))
		{
			func_382("Starting intro cutscene...");
			if (func_332(unk_0xA16EC202D9D35357()))
			{
				unk_0x574BF3D848332F6A(unk_0xA16EC202D9D35357(), "Michael", 0, 0, 0);
			}
			if (func_332(Local_82.f_28[0]))
			{
				unk_0x574BF3D848332F6A(Local_82.f_28[0], "Marnie", 0, 0, 0);
			}
			if (func_332(Local_82.f_28[1]))
			{
				unk_0x3CC3106305C40A28(Local_82.f_28[1], 0);
				if (func_227(unk_0x67DE942190116DCB(Local_82.f_28[1])))
				{
					iLocal_640 = func_266(Local_82.f_28[1], joaat("weapon_digiscanner"), 1, 0, 0, 0, 0);
					unk_0x574BF3D848332F6A(iLocal_640, "Artefact_Detector", 0, 0, 0);
				}
				unk_0x574BF3D848332F6A(Local_82.f_28[1], "Jimmy_Boston", 0, 0, 0);
			}
			if (func_332(unk_0xA16EC202D9D35357()))
			{
				unk_0x574BF3D848332F6A(unk_0xA16EC202D9D35357(), "Michael", 0, 0, 0);
			}
			unk_0x495459882382D113("EPS4_START");
			func_329();
			unk_0x5279A9DE67877B4B(1);
			unk_0xEA4B8437C8E2CA24(0);
			unk_0x4EDE34FBADD967A6(0);
			...
			func_283(1, 1, 0);
			func_257(1833.393f, 4703.849f, 32.50218f, 1819.368f, 4693.413f, 43.89163f, 18f, 1816.55f, 4683.33f, 37.75f, 339.76f, func_265(), 1, 1, 1, 0, 0);
			func_252(1812f, 4697f, 39.1f, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1);
			while (!func_321())
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			func_382("Loaded all assets! Moving to intro run loop...");
			Local_771.f_1 = 1;
		}
	}
	if (Local_771.f_1 == 1)
	{
		...
		if (func_227(unk_0xA16EC202D9D35357()))
		{
			...
			{
				func_382("*** Forcing Michael's move state");
				func_328(unk_0xA16EC202D9D35357(), 1827.161f, 4698.645f, 38.094f, 184.1384f, 0, 1);
				unk_0x39272B2594E03395(unk_0xA16EC202D9D35357(), iLocal_158, -1, 1, 1);
			}
		}
	...
	if (Local_771.f_1 == 3)
	{
		func_382("Doing intro cleanup and progressing");
		if (!unk_0xEC35DAD55FA4EEF2())
		{
			iLocal_352 = 0;
			func_237(1, 0, 1, 1);
...
void func_326()
{
	...
	if (func_227(Local_605[1 /*8*/]))
	{
		if (unk_0xE06B94F2BD99223C("Jimmy_Boston", 0))
		{
			unk_0x21B0D803C4C9C45E(1829.8f, 4693.48f, 38.5f, &uVar0, 0);
			unk_0x6C43BF7625967266(Local_605[1 /*8*/], 1829.8f, 4693.48f, uVar0, 1, 0, 0, 1);
		}
	}
}
...
void func_327()
{
	if (func_227(Local_605[0 /*8*/]))
	{
		if (unk_0xE06B94F2BD99223C("Marnie", 0))
		{
			func_317(&(Local_605[0 /*8*/]), uLocal_761);
			Local_605[0 /*8*/].f_1 = 1;
			Local_605[0 /*8*/].f_2 = 1;
			...
			unk_0x047BDE74F5ADA7D9(Local_605[0 /*8*/], Local_537[Local_605[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 1056964608);
			unk_0x86E7313D71D1A983(Local_605[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 1);
			Local_605[0 /*8*/].f_7 = 1;
			func_382("Done Marnie intro exit state");
		}
	}
}

int func_328(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
void func_330()
{
	...
	{
		func_291(1, 1);
		func_382("SKIP: Doing sync for leadin skip");
		func_283(1, 1, 1);
		Local_771.f_3 = 0;
	}
	if (Local_771.f_1 == 0)
	{
		...
		if (!func_393(0) && unk_0x0852C405AF94F670(unk_0xA16EC202D9D35357(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0))
		{
			func_382("Doing setup for leadin");
			func_315(&uLocal_167, 4, Local_82.f_28[0], "MARNIE", 0, 1);
			if (func_322())
			{
				Local_771.f_1 = 1;
			}
		...
		{
			func_382("Skipping setup for leadin (repeat play/wrong area)");
			Local_771.f_1 = 1;
		}
	}
	if (Local_771.f_1 == 1)
	{
		if ((unk_0x09560C7DE2A384BD() - iLocal_353) > 1250)
		{
			unk_0x859FD7253E29A93D(-1, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
			iLocal_353 = unk_0x09560C7DE2A384BD();
		}
		if (!func_393(0) && unk_0x0852C405AF94F670(unk_0xA16EC202D9D35357(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0))
		{
			if (func_226(unk_0xA16EC202D9D35357(), Local_82.f_28[0], 1) >= 3f)
			{
				if (!unk_0x99483D9B7795CE90())
				{
					if (!iLocal_332)
					{
						if (func_227(Local_82.f_28[0]))
						{
							unk_0x82AA7722DE6421AE(Local_82.f_28[0], 0f, 0f, 0.2f, 1, 30000, 2000, 2000, 0);
							unk_0x8FFCC041F289CDDD(fLocal_766);
							unk_0x6AB49DA6F39B439B(fLocal_767);
							unk_0x72FB79DFD0ED5829(fLocal_768);
							unk_0x49DC75D1BC605ED6(fLocal_769);
							unk_0xC90CC6DB48C53CCB(fLocal_770);
							unk_0x52A856A5C906A223(1);
							if (func_227(unk_0xA16EC202D9D35357()))
							{
								unk_0x6D98AA46076A68BE(&uLocal_166);
								unk_0x4745F9C50C63A48C(0, Local_82.f_28[0], 15000, 0, 2);
								unk_0x353F4B963593F141(0, 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 1193033728);
								unk_0x1CAB36EC4E43E586(0, Local_82.f_28[0], 0);
								unk_0x963BB7C99350D827(uLocal_166);
								unk_0x0891776D0327B77A(unk_0xA16EC202D9D35357(), uLocal_166);
								unk_0x2AF68ED52DC74B7D(&uLocal_166);
			...
			if (!iLocal_333)
			{
				if (func_332(Local_82.f_28[0]) && !func_273())
				{
					unk_0x4745F9C50C63A48C(Local_82.f_28[0], unk_0xA16EC202D9D35357(), -1, 48, 2);
					unk_0x5B5659C49032B96C(Local_82.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0, 0, 0, 0);
					unk_0x50CEB49FC52ED0FE();
					unk_0xF0B0E3CDFDE57E49("EP_4_RCM_CONCAT", 2, 8);
					func_382("Done Marnie leadin anim - request concat cutscene");
					iLocal_333 = 1;
				}
			}
			else if (func_332(Local_82.f_28[0]))
			{
				if (unk_0x95EDB2DEFA5BB405(Local_82.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					if (unk_0x4CB0BCFFEC712BA2(Local_82.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.25f)
					{
						if (!iLocal_334)
						{
							if (func_298(&uLocal_167, "EPS4AUD", "ESP4_RCL", 8, 0, 0, 0))
							{
								func_382("Leadin convo done");
								iLocal_334 = 1;
							}
						}
					}
					if (unk_0x4CB0BCFFEC712BA2(Local_82.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.95f)
					{
						func_382("Leadin done, launch cutscene");
						func_235(1);
						Local_771.f_1 = 3;
					}
					if (func_226(unk_0xA16EC202D9D35357(), Local_82.f_28[0], 1) <= 1.5f)
					{
						unk_0xC92B5D880C803814(unk_0x1788E93557766241(), false, 0);
						unk_0x937785D9C1929236(unk_0xA16EC202D9D35357());
					}
		...
		{
			func_382("Replay in progress/wrong area, skipping leadin");
			func_235(1);
			Local_771.f_1 = 3;
		}
	}
	if (Local_771.f_1 == 3)
	{
		func_382("Doing leadin cleanup and progressing");
		func_352();
	}
}
	...
	if (Global_68579 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0xF4C685E933068D23())
			{
				...
				Var4 = { func_336(Global_68580, Global_68582, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_347(0) || Global_68594) || Global_68583 == 1) || !unk_0x83B393DE31BAC8F0())
	{
		return 0;
	}
	switch (Global_68579)
	{
		...
		case 5:
			if ((unk_0xEC35DAD55FA4EEF2() || func_221(0)) || func_346(1))
			{
			}
			else
			{
...
{
	return func_349(iParam0, Global_34915);
}
...
void func_352()
{
	if ((Local_771.f_4 || Local_771.f_5) || Local_771.f_6)
	{
		...
		if (Local_771.f_8 == 1)
		{
			func_382("Sync for skip is TRUE and Intro is queued!");
		}
	}
	else
	{
...
void func_355(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_394())
	{
...
int func_357(var uParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6)
{
	if (iParam5 != 0)
	{
		*uParam0 = iParam5;
		func_382("*** Epsilonist exists, grabbing ped index");
	}
	else
	{
		*uParam0 = unk_0x6F9DE0DE8363ADF1(5, iParam6, Param1, fParam4, 1, 1);
		func_382("*** Epsilonist does not exist, creating new");
	}
	if (func_332(*uParam0))
	{
		unk_0xA1478EBA54DDE31B(*uParam0, 132, 1);
		unk_0xA9465591B42213AE(*uParam0, joaat("player"));
		unk_0x2D79C863A05FB8F7(*uParam0, 1);
		unk_0xA8BC819B54F5B824(*uParam0, 0);
		unk_0x5081050902E0F511(*uParam0, 1);
...
void func_358(var uParam0)
{
	...
	Var0 = { uParam0->f_2 };
	func_359("Rock created at: ", uParam0->f_2);
	uParam0->f_1 = unk_0xCBF2B33114D43CAA(*uParam0, Var0, 1, 1, 0);
	if (unk_0x538DF9E5B1DF01EB(uParam0->f_1))
	{
		unk_0x0BBAD8A322CB595E(uParam0->f_1, uParam0->f_5, 0, 1);
		func_359("Rock rot vector: ", unk_0x1A6D58515B4120D5(uParam0->f_1, 0));
		func_359("Rock actual position: ", unk_0xBF8499F46AD9093A(uParam0->f_1, 0));
		unk_0x75447E2E94CE161A(uParam0->f_1, 0);
		unk_0x3CC3106305C40A28(uParam0->f_1, 1);
	}
}

void func_359(char* sParam0, struct<3> Param1)
{
	sParam0 = sParam0;
	Param1 = { Param1 };
}
...
void func_360()
{
	Local_624.f_2 = unk_0x74F076F396F8C361();
	Local_624.f_3 = unk_0x74F076F396F8C361();
	Local_624.f_4 = unk_0x74F076F396F8C361();
	Local_624.f_5 = unk_0x74F076F396F8C361();
	Local_624.f_12 = 0.92f;
	Local_624.f_13 = 0;
	Local_624.f_14 = "NO_RECENT_ANIM";
	uLocal_164 = unk_0x36ECDA4DD9A3F08D("digiscanner");
	while (!unk_0xC8378A96673BCC40(uLocal_164))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	...
	unk_0x51EE3BB4A6B99F1C(iLocal_159);
	if (unk_0x2E968B59470173AB("digiscanner"))
	{
		uLocal_165 = unk_0x180C45774462E561("digiscanner");
	}
}
...
void func_362()
{
	func_378(joaat("prop_tv_test"), 1751.65f, 4676.77f, 43.03f, -2.33f, 0.99f, 91.36f);
	func_377(1755.463f, 4678.62f, 44.1477f, -9.5251f, 0f, 122.2955f, 50.832f);
	func_376(3f, -4.5f, 0f);
	func_375(1689.951f, 4762.613f, 40.9216f, 272.5499f);
	func_374(1779.514f, 4691.447f, 39.34577f, 1744.225f, 4674.646f, 46.84829f, 16.5f);
	func_373("EPS4_JCHAT1", sLocal_160);
	func_372("EPS4_JGOOD", "EPS4_JBAD");
	func_371("EPS4_JRET1", "EPS4_JRET2");
	func_370("EPS4_JCLOSE");
	func_369(0f, 0f, 0f);
	func_368(30f, 115f, 0.9f);
	func_378(joaat("prop_battery_01"), 1756.68f, 4832.28f, 39.43f, 90f, 13.21f, 78.57f);
	func_377(1758.032f, 4826.561f, 41.459f, -11.6785f, 0f, 6.5381f, 34.3083f);
	func_376(2f, 4f, 0f);
	func_375(1690.267f, 4769.994f, 40.9216f, 269.3043f);
	func_374(1750.065f, 4833.117f, 36.87026f, 1763.224f, 4831.822f, 43.5425f, 13.75f);
	func_373("EPS4_MCHAT1", "EPS4_MCHAT2");
	func_372("EPS4_MGOOD", "EPS4_MBAD");
	func_371("EPS4_MRET1", "EPS4_MRET2");
	func_370("EPS4_MCLOSE");
	func_369(0f, 0f, 0f);
	func_368(30f, 195f, 0.9f);
	func_378(joaat("prop_old_boot"), 1847.863f, 4756.059f, 36.71f, -70.53f, 75.48f, 132.44f);
	func_377(1829.31f, 4756.158f, 42.4876f, -23.5614f, 0f, -92.2873f, 50f);
	func_376(7.5f, -7.5f, 0f);
	func_375(1689.775f, 4777.77f, 40.9216f, 267.4597f);
	func_374(1856.218f, 4755.223f, 34.67169f, 1841.114f, 4755.489f, 41.43402f, 13.75f);
	func_373("EPS4_PCHAT1", "EPS4_PCHAT2");
	func_372("EPS4_PGOOD", "EPS4_PBAD");
	func_371(sLocal_160, "EPS4_PRET2");
	func_370("EPS4_PCLOSE");
	func_369(0f, 0f, 0f);
	func_368(20.5f, 155f, 0.9f);
	func_367(1820.101f, 4701.099f, 38.545f, 280.7432f, 0);
	func_367(1803.044f, 4700.244f, 39.3123f, 72.1396f, 0);
	func_367(1820.482f, 4672.535f, 35.6368f, 253.4126f, 0);
	func_367(1819.87f, 4694.03f, 38.408f, 231.2265f, 0);
	func_367(1807.122f, 4684.418f, 38.5566f, 150.6129f, 0);
	func_367(1791.058f, 4689.403f, 40.5128f, 103.4073f, 0);
	func_367(1872.626f, 4718.827f, 37.2889f, 210.8288f, 1);
	uLocal_759 = func_367(1764.089f, 4665.879f, 42.3031f, 281.6336f, 2);
	uLocal_761 = func_367(1814.27f, 4651.32f, 37.58f, 173.1089f, 0);
	iLocal_760 = func_367(1846.512f, 4705.614f, 38.1214f, 25.7591f, 3);
	uLocal_762 = func_367(1790.414f, 4722.897f, 37.8533f, 221.4777f, 0);
	func_366(&uLocal_641);
	func_365(&uLocal_641, 1897.42f, 4596.51f, 36.4f);
	func_365(&uLocal_641, 1912.2f, 4676.93f, 39.44f);
	func_365(&uLocal_641, 1886.09f, 4733.68f, 39.48f);
	func_365(&uLocal_641, 1800.24f, 4820.64f, 40.96f);
	func_365(&uLocal_641, 1796.556f, 4893.541f, 40.4741f);
	func_365(&uLocal_641, 1782.651f, 4916.333f, 41.4418f);
	func_365(&uLocal_641, 1746.552f, 4942.362f, 42.8677f);
	func_365(&uLocal_641, 1702.537f, 4893.824f, 36.7751f);
	func_365(&uLocal_641, 1707.273f, 4814.81f, 40.9407f);
	func_365(&uLocal_641, 1729.46f, 4655.21f, 42.61f);
	func_365(&uLocal_641, 1772.05f, 4602.143f, 36.457f);
	func_364(&uLocal_641);
	func_363(&uLocal_693, &uLocal_641, 20f);
}

void func_363(var uParam0, var uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_313(uParam1, *(uParam1[iVar1 /*3*/]) + Var9))
		{
			Var9 = { -Var9 };
		}
...
int func_367(struct<3> Param0, float fParam3, int iParam4)
{
	int iVar0;
...
void func_368(float fParam0, float fParam1, float fParam2)
{
	int iVar0;
...
void func_369(float fParam0, float fParam1, float fParam2)
{
	int iVar0;
...
void func_374(struct<3> Param0, struct<3> Param3, float fParam6)
{
	int iVar0;
...
void func_375(struct<3> Param0, float fParam3)
{
	int iVar0;
...
void func_377(struct<3> Param0, struct<3> Param3, float fParam6)
{
	int iVar0;
...
void func_378(int iParam0, struct<3> Param1, struct<3> Param4)
{
	int iVar0;
...
var func_383(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
...
int func_385(var uParam0)
{
	...
	switch (iLocal_78)
	{
		case 0:
			...
			func_392(&(uParam0->f_48), "rcm_epsilonism4", "ep_4_rcm_marnie_base_marnie", "ep_4_rcm_marnie_lookaround_marnie");
			iLocal_78 = 1;
			break;
		
		case 1:
			if (!func_391(&iVar0) || !func_389(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_78 = 2;
		...
		case 2:
			...
			if (func_332(unk_0xA16EC202D9D35357()))
			{
				uVar5 = unk_0x2C741960D7BA6D23(unk_0xA16EC202D9D35357());
			}
			if (!unk_0x538DF9E5B1DF01EB(uParam0->f_28[0]))
			{
				if (func_386(&(uParam0->f_28[0]), 60, 1826.13f, 4698.88f, 38.92f, 21.63f, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
					unk_0xA9465591B42213AE(uParam0->f_28[0], uVar5);
			...
			{
				if (func_386(&(uParam0->f_28[1]), 55, 1827.24f, 4699.76f, 39.09f, 57.09f, "EPSILON LAUNCHER RC - JIMMY", 1))
				{
					unk_0xA9465591B42213AE(uParam0->f_28[1], iVar5);
					unk_0xA1478EBA54DDE31B(uParam0->f_28[1], 132, 1);
					unk_0xD8C28445617D0902(uParam0->f_28[1], 1, 0, 0, false);
					unk_0x937785D9C1929236(uParam0->f_28[1]);
					unk_0x39272B2594E03395(uParam0->f_28[1], joaat("weapon_digiscanner"), -1, 1, 1);
					unk_0x5B5659C49032B96C(uParam0->f_28[1], "rcm_epsilonism4", "ep_4_rcm_jimmyboston_base_jb", 8f, -8f, -1, 1, 0, 0, 0, 0);
					func_328(uParam0->f_28[1], 1827.24f, 4699.76f, 39.09f, 57.09f, 1, 1);
				}
				else
				{
					bVar4 = false;
...
int func_386(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_387(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0x538DF9E5B1DF01EB(*uParam0))
		{
			if (!unk_0xE44A580B551C3645(*uParam0))
...
int func_387(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_395()
{
	...
	if (func_397())
	{
		func_382("...Random Character Script was triggered so additional cleanup required");
	}
	if (func_332(unk_0xA16EC202D9D35357()))
	{
		unk_0x3E3552EF770E2B2A(unk_0xA16EC202D9D35357(), iLocal_158);
		unk_0xB4E8D4EA104CA059(unk_0xA16EC202D9D35357(), joaat("weapon_unarmed"), 1);
		unk_0x937785D9C1929236(unk_0xA16EC202D9D35357());
		unk_0x57B49E5FE6A80035(unk_0xA16EC202D9D35357(), 0f);
	}
	if (unk_0xA84F80DD9F675CED())
	{
		unk_0x099E9F2D6F93D420();
	}
	unk_0x427C278EBE976228(uLocal_359);
	if (func_227(Local_605[0 /*8*/]) && func_227(Local_605[1 /*8*/]))
	{
		if (unk_0x9A132E8DFAE1F524(Local_605[0 /*8*/]))
		{
			unk_0xA7130AF256ED96A1(Local_605[0 /*8*/]);
		}
		else if (unk_0x9A132E8DFAE1F524(Local_605[1 /*8*/]))
		{
			unk_0xA7130AF256ED96A1(Local_605[1 /*8*/]);
		}
	}
	func_396(&(Local_605[0 /*8*/]), 1, 1, 1);
	func_396(&(Local_605[1 /*8*/]), 1, 1, 1);
	unk_0xE30D9670F9320015("digiscanner");
	unk_0xA2D4DD3AE5BD39B4(uLocal_161, 0);
	unk_0xA2D4DD3AE5BD39B4(uLocal_162, 0);
	unk_0xE3E1063389C746FB(iLocal_763);
	unk_0xE3E1063389C746FB(iLocal_764);
	unk_0xE3E1063389C746FB(iLocal_765);
	if (unk_0x4CBFDAD06D630F7C("EPSILONISM_04_MIX"))
	{
		func_382("Stopping dynamic mix EPSILONISM_04_MIX");
		unk_0x124843CE93F39C27("EPSILONISM_04_MIX");
	}
...
void func_398(bool bParam0)
{
	...
	if (!func_413())
	{
		...
		{
			func_175(iVar0, 1, 0);
			func_399(unk_0x7E5A426328F6E635(), iVar0);
		}
		else
		{
			if (Global_96526[iVar0 /*10*/].f_9 == -1)
...
int func_400(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_406())
	{
		...
		{
			iVar33 = func_401(unk_0x7E5A426328F6E635());
			if (iVar33 > -1)
			{
...
int func_402()
{
	...
	iVar0 = func_403(&(Global_90042.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_406()
{
	...
	{
		if (func_401(&(Global_90042.f_3)) > -1)
		{
			return 1;
		}
	}
