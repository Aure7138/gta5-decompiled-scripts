...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_80 = func_418(60);
	uLocal_81 = func_418(14);
	...
	uLocal_160 = unk_0x06C0DD6C22493B3F(iLocal_159);
	sLocal_161 = "empty";
	iLocal_339 = 1;
	iLocal_764 = -1;
	iLocal_765 = -1;
	...
	uLocal_162 = func_384();
	uLocal_163 = func_383(1855.08f, 4755.85f, 36.81f, 25f);
	iLocal_764 = unk_0xDC3487ADA3784C61(1815.39f, 4698f, 38.87f, 3.5f, 3.5f, 3f, 0f, 0, 7);
	iLocal_765 = unk_0xDC3487ADA3784C61(1824.12f, 4701.39f, 38.29f, 2.5f, 2.5f, 2.5f, 0f, 0, 7);
	iLocal_766 = unk_0xDC3487ADA3784C61(1801.28f, 4700.25f, 39.42f, 2f, 2f, 2f, 0f, 0, 7);
	if (!unk_0xB5F5536784683C33("EPSILONISM_04_MIX"))
	{
		func_382("Starting dynamic mix EPSILONISM_04_MIX");
		unk_0x925AE2E6F6E41362("EPSILONISM_04_MIX");
	}
	unk_0xF7CE1213DA9898BD(0);
	unk_0x6CCF5F545348D54E(1, joaat("player"), joaat("player"));
	unk_0xFD62177C7242216E(0.5f);
	uLocal_360 = unk_0x63B6535C7BB386BD(1751.65f, 4676.77f, 43.03f, 1.5f);
	func_379();
	func_362();
	func_361();
	Local_772.f_0 = 0;
	...
	{
		func_358(&(Local_363[iVar0 /*43*/]));
		iVar0++;
	}
	func_357(&(Local_606[0 /*8*/]), Local_151, fLocal_154, Local_83.f_28[0], 0);
	func_357(&(Local_606[1 /*8*/]), Local_155, fLocal_158, Local_83.f_28[1], 0);
	if (func_394())
	{
		if (func_356() == 0)
		{
			func_355(Local_147, fLocal_150, 1, 0);
			func_354(1);
			func_353(&Local_83, 0, 1);
			func_352();
	...
	else if (func_393(0))
	{
		func_355(Local_147, fLocal_150, 1, 0);
		func_354(0);
		func_353(&Local_83, 1, 1);
		func_352();
	}
	func_350(60, 0, 0);
	while (true)
	{
		unk_0xBB5777EE55D3B041("SF_Epsilon4", 0);
		func_334(Local_83.f_9, 0, 0, 0, 0, 0);
		unk_0x84006DD39F650798(unk_0xA34E7C2A5118D638());
		if (func_333())
		{
		...
		if (func_332(unk_0xC8B93D94F8954288()))
		{
			if (func_331(unk_0xC8B93D94F8954288()) == iLocal_159)
			{
...
void func_1()
{
	...
	switch (Local_772.f_1)
	{
		case 0:
			...
			if (unk_0xF8D041B05C3D1FD4(sVar0, sLocal_161))
			{
				func_398(1);
			}
			else
...
void func_11()
{
	...
	unk_0xC0E8B67A4385D37D("weapons@holster_1h");
	while (func_331(unk_0xC8B93D94F8954288()) == iLocal_159)
	{
		unk_0x4EDE34FBADD967A6(0);
		unk_0x68A38902ADFD05FE(2);
		if (unk_0xF9B86DC1728F1339("weapons@holster_1h"))
		{
			if (!unk_0xCD61E9D5CABC7E35(unk_0xC8B93D94F8954288(), "weapons@holster_1h", "holster", 3))
			{
				unk_0x5323F488E6A1B660(unk_0xC8B93D94F8954288(), "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			else if (unk_0x853B39ECA83DA242(unk_0xC8B93D94F8954288(), "weapons@holster_1h", "holster") >= 0.5f)
			{
	...
	if (iVar0 < 12)
	{
		unk_0x071958EFED9481F5(joaat("num_epsilon_step"), 12, 1);
		func_12(23, 12);
	}
	func_395();
}
...
int func_13(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar20 = 0;
		func_19(&iVar20);
		iVar21 = func_18(Var10, Global_100976.f_6322.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_16(Global_100976.f_6322.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_14(Global_100976.f_6322.f_765[iVar20 /*10*/]))
				{
					Global_100976.f_6322.f_765[iVar20 /*10*/] = { Var10 };
					func_15(&Var10);
					return 1;
...
void func_19(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_18(Global_100976.f_6322.f_765[iVar0 /*10*/], Global_100976.f_6322.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
int func_215()
{
	return func_216(unk_0xC4E68AF0B559FAC4(), 0);
}
...
void func_223()
{
	unk_0x7A2D5FC5F94932AA(Local_625.f_2);
	unk_0x7A2D5FC5F94932AA(Local_625.f_3);
	unk_0x7A2D5FC5F94932AA(Local_625.f_4);
	unk_0x7A2D5FC5F94932AA(Local_625.f_5);
	Local_625.f_6 = 0;
	Local_625.f_7 = 0;
}
...
void func_225()
{
	switch (Local_772.f_1)
	{
		case 0:
			...
			unk_0x68A38902ADFD05FE(2);
			unk_0xDDA35844870E2C3A(unk_0xC8B93D94F8954288(), iLocal_159);
			Local_772.f_1 = 1;
			break;
		...
		case 1:
			...
			else if (unk_0xB6900B8CB0ABBD2B(Local_606[0 /*8*/]))
			{
				func_235(6);
				Local_772.f_9 = 2;
				Local_772.f_1 = 3;
			}
			else if (unk_0xB6900B8CB0ABBD2B(Local_606[1 /*8*/]))
			{
				func_235(6);
				Local_772.f_9 = 3;
				Local_772.f_1 = 3;
			}
			else if (unk_0x87D4C731B013290A(Local_606[0 /*8*/], unk_0xC8B93D94F8954288(), 1) && unk_0x320E5435C0472F40(Local_606[0 /*8*/], 0, 2))
			{
				func_235(6);
				Local_772.f_9 = 4;
				Local_772.f_1 = 3;
			}
			else if (unk_0x87D4C731B013290A(Local_606[1 /*8*/], unk_0xC8B93D94F8954288(), 1) && unk_0x320E5435C0472F40(Local_606[1 /*8*/], 0, 2))
			{
				func_235(6);
				Local_772.f_9 = 5;
				Local_772.f_1 = 3;
			...
			{
				if (func_226(unk_0xC8B93D94F8954288(), Local_606[0 /*8*/], 1) >= 50f)
				{
...
void func_236()
{
	...
	if (Local_772.f_3 == 1)
	{
		...
		if (unk_0x35081E98CA82CBB4())
		{
			...
			if (func_227(unk_0xC8B93D94F8954288()))
			{
				func_284("Michael", unk_0xC8B93D94F8954288(), 0, 2);
			}
	...
	if (Local_772.f_1 == 0)
	{
		func_282("Doing setup for RockScene:", iLocal_353);
		func_280(1);
		func_279();
		unk_0x76EF33E3762DAC58(0, 200, 150);
		if (unk_0x35081E98CA82CBB4())
		{
			func_382("Trying to set player component variation");
			if (func_227(unk_0xC8B93D94F8954288()))
		...
		if (!func_278(iLocal_362))
		{
			iLocal_362 = unk_0xD53B4DCC7B2C8551(joaat("bison"), 1851.57f, 4772.12f, 39.8f, 31.35f, 1, 1);
			unk_0x46E519A001AC83B2(iLocal_362, 157, 157);
			unk_0xBA41DA8B3B8610CF(iLocal_362, 5, 157);
			unk_0xF18809B65D87E197(iLocal_362);
		}
		func_277(&(Local_606[1 /*8*/]), 1);
		func_277(&(Local_606[0 /*8*/]), 1);
		if (func_332(unk_0xC8B93D94F8954288()))
		{
			...
			unk_0x304D892DDB998890(unk_0xA34E7C2A5118D638(), 1);
			iVar0 = unk_0x693EBB4F13506457();
			while ((unk_0x693EBB4F13506457() - iVar0) < 500)
			{
			...
			if (iLocal_353 == 0)
			{
				...
				{
					unk_0x5D713171D2C2E177(Local_606[1 /*8*/], "Jimmy_Boston", 0, 0, 0);
				}
				if (func_227(Local_606[0 /*8*/]))
				{
					unk_0x5D713171D2C2E177(Local_606[0 /*8*/], "Marnie", 0, 0, 0);
				}
				if (func_227(unk_0xC8B93D94F8954288()))
				{
				...
				{
					iLocal_641 = func_266(unk_0xC8B93D94F8954288(), joaat("weapon_digiscanner"), 1, 0, 0, 0, 0);
					unk_0x5D713171D2C2E177(iLocal_641, "Artefact_Detector", 0, 0, 0);
				}
				if (func_227(Local_363[iLocal_353 /*43*/].f_1))
				{
					unk_0x5D713171D2C2E177(Local_363[iLocal_353 /*43*/].f_1, "EPS_TV", 0, 0, 0);
				}
			}
			else if (iLocal_353 == 1)
			{
				...
				if (func_227(Local_363[iLocal_353 /*43*/].f_1))
				{
					unk_0x5D713171D2C2E177(Local_363[iLocal_353 /*43*/].f_1, "EPS_Battery", 0, 0, 0);
				}
			}
			else
			{
				...
				if (func_227(Local_363[iLocal_353 /*43*/].f_1))
				{
					unk_0x5D713171D2C2E177(Local_363[iLocal_353 /*43*/].f_1, "Old_Boot", 0, 0, 0);
				}
			}
			unk_0x8E6D4B516B44DE88(0);
			unk_0x1FFBBAD42BF7E243(1);
			iVar0 = unk_0x693EBB4F13506457();
			while ((unk_0x693EBB4F13506457() - iVar0) < 1)
			{
				unk_0x68A38902ADFD05FE(2);
				unk_0x4EDE34FBADD967A6(0);
				unk_0xBB5777EE55D3B041("SF_Epsilon4", 0);
			...
			if (iLocal_353 >= 2)
			{
				if (func_227(unk_0xC8B93D94F8954288()))
				{
					unk_0x640290651A86938B(unk_0xC8B93D94F8954288(), joaat("weapon_unarmed"), -1, 1, 1);
				}
			}
			unk_0x304D892DDB998890(unk_0xA34E7C2A5118D638(), 0);
			func_257(Local_363[iLocal_353 /*43*/].f_25, Local_363[iLocal_353 /*43*/].f_28, Local_363[iLocal_353 /*43*/].f_31, Local_363[iLocal_353 /*43*/].f_32, Local_363[iLocal_353 /*43*/].f_35, func_265(), 1, 1, 1, 0, 0);
			func_252(Local_363[iLocal_353 /*43*/].f_2, 1, 0, 1, 1, 1, 1, 0, 1, 1, 1);
		}
		func_282("Finished setup, moving to run loop for RockScene #:", iLocal_353);
		Local_772.f_1 = 1;
	}
	if (Local_772.f_1 == 1)
	{
		...
		else
		{
			if (iLocal_353 >= 2)
			{
				...
				{
					if (unk_0xFE2EB5413118713A() > 17000)
					{
						if (!unk_0x2394B86AAC723FB8())
						{
							unk_0xCC0E83FD998B9430(1847.472f, 4756.157f, 36.6968f, func_250(271.4718f), 145f, 0);
						}
					}
				}
			}
			...
			if (Local_772.f_2 == -1)
			{
				...
				if (iLocal_353 >= 2)
				{
					unk_0x233432976E597324("EPS4_STOP");
					func_5(&(Local_363[iLocal_353 /*43*/].f_1));
				}
				Local_772.f_1 = 3;
				iLocal_353++;
				func_282("END CUTSCENE: iCurrentRock = ", iLocal_353);
			}
		}
	}
	if (Local_772.f_1 == 3)
...
void func_238(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (!unk_0x2DC9BA2299B45EA6(unk_0xC8B93D94F8954288()) && !func_239(unk_0xA34E7C2A5118D638()))
		{
...
void func_245()
{
	unk_0x7C38F93AF52620B1(uLocal_165, "SET_COLOUR");
	...
	unk_0x7C38F93AF52620B1(uLocal_165, "SET_DISTANCE");
	unk_0x512B59C08EAFA3B9(10f);
	unk_0xD013AC29829DDC02();
	unk_0x052F8F69DC6157DE(uLocal_166);
	unk_0x06D856499865F31F(uLocal_165, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
}
	...
	if (func_227(unk_0xC8B93D94F8954288()))
	{
		if (unk_0x669E4BAB086C2648("Michael", 0))
		{
			...
			else
			{
				...
				if (func_331(unk_0xC8B93D94F8954288()) != iLocal_159)
				{
					unk_0x640290651A86938B(unk_0xC8B93D94F8954288(), iLocal_159, -1, 1, 1);
				}
				unk_0x447955D97DC49D70(unk_0xC8B93D94F8954288(), joaat("MotionState_Idle"), 0, 1, 0);
				return 1;
			}
...
void func_247()
{
	if (func_227(Local_606[1 /*8*/]))
	{
		if (unk_0x669E4BAB086C2648("Jimmy_Boston", 0))
		{
			if (iLocal_353 >= 2)
			{
				if (func_227(Local_83.f_28[1]) && func_278(iLocal_362))
				{
					unk_0x3E2E609450787FFE(&uLocal_782);
					unk_0xB01CB7F664125D84(0, iLocal_362, 0);
					unk_0x939BC11172AA1303(uLocal_782);
					unk_0xBFE865E3B513451B(Local_83.f_28[1], uLocal_782);
					unk_0xA9351C9309E03069(&uLocal_782);
					func_382("Did Jimmy pass exit");
				}
			}
			else
			{
				unk_0x6094B3418D5AE59D(Local_83.f_28[1], 1764.089f, 4665.879f, 42.3031f, 1f, 20000, 1193033728, 1056964608);
				func_382("Did Jimmy regular exit");
			}
			unk_0x447955D97DC49D70(Local_606[1 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
		}
	}
}
...
void func_248()
{
	if (func_227(Local_606[0 /*8*/]))
	{
		if (unk_0x669E4BAB086C2648("Marnie", 0))
		{
			if (iLocal_353 >= 2)
			{
				if (func_227(Local_83.f_28[0]) && func_278(iLocal_362))
				{
					unk_0x3E2E609450787FFE(&uLocal_782);
					unk_0xB01CB7F664125D84(0, iLocal_362, -1);
					unk_0xAC59C2795E065D27(0, iLocal_362, 1743.33f, 4962.18f, 45.16f, 20f, 0, joaat("bison"), 786599, 5f, -1f);
					unk_0x84D04CB0E2B93F55(0, iLocal_362, 30f, 262275);
					unk_0x939BC11172AA1303(uLocal_782);
					unk_0xBFE865E3B513451B(Local_83.f_28[0], uLocal_782);
					unk_0xA9351C9309E03069(&uLocal_782);
			...
			{
				unk_0x81333BEA4837207C(Local_83.f_28[0], unk_0xCC31DB73C65552D8(Local_83.f_28[0], 0f, 7f, 0f), 1f, 20000, 0.25f, 5, 1193033728);
				func_382("Did Marnie regular exit");
			}
			unk_0x447955D97DC49D70(Local_606[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
		}
	}
}
...
void func_249()
{
	...
	{
		if (unk_0x669E4BAB086C2648("Artefact_Detector", 0))
		{
			if (iLocal_353 < 2)
			{
				func_382("*** Detector exit");
				unk_0x5DCB9AB3EDCDA9A2(iLocal_641, unk_0xC8B93D94F8954288());
				func_5(&iLocal_641);
				if (!unk_0x95CCECA3948CFE7B(Local_625.f_0))
				{
					func_382("*** Recreating gDetector.hObj after cutscene...");
					Local_625.f_0 = unk_0xA7C2E7868E127D65(unk_0xC8B93D94F8954288());
				}
			}
			else
			{
...
void func_252(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0x06972B20E75CBE06(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x425A7D451DB73551(func_254(unk_0x1A96BAEAC664567A()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_266(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	...
	while (func_267(iVar2, iVar8) != 0)
	{
		if (!unk_0xB6900B8CB0ABBD2B(iParam0))
		{
			if (unk_0x961525D327D920F6(iParam0, iVar2, func_267(iVar2, iVar8)))
			{
				unk_0x39F6EF6D6BEFF107(uVar1, func_267(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
void func_277(var uParam0, bool bParam1)
{
	if (func_332(*uParam0))
	{
		...
		if (bParam1)
		{
			unk_0xBA73099E237C7E5E(*uParam0);
		}
		else
		{
		...
		if (unk_0x5BE4C4CB01F0877F(*uParam0))
		{
			unk_0x5980997C9ACA0572(*uParam0);
		}
	}
	else
	{
...
{
	unk_0x7C38F93AF52620B1(uLocal_165, "SET_COLOUR");
	unk_0x65960B4E2ADC9F6D(67);
	unk_0x65960B4E2ADC9F6D(200);
	unk_0x65960B4E2ADC9F6D(255);
	unk_0x65960B4E2ADC9F6D(255);
	unk_0x65960B4E2ADC9F6D(209);
	unk_0x65960B4E2ADC9F6D(67);
	unk_0x65960B4E2ADC9F6D(255);
...
void func_280(int iParam0)
{
	if (iParam0 == 1)
	{
		if (func_281())
		{
			if ((unk_0xF8D041B05C3D1FD4(Local_625.f_14, "NO_RECENT_ANIM") || !unk_0xCD61E9D5CABC7E35(Local_625.f_0, "rcm_epsilonism4", Local_625.f_14, 3)) || unk_0x853B39ECA83DA242(Local_625.f_0, "rcm_epsilonism4", Local_625.f_14) >= 0.98f)
			{
				if (fLocal_640 > 80f)
				{
				...
				unk_0xDC31379F47A12F2B(Local_625.f_0, Local_625.f_14, "rcm_epsilonism4", 16f, 0, 0, 0, 0, 0);
			}
		}
	}
	else if (func_281())
	{
		if (!unk_0xF8D041B05C3D1FD4(Local_625.f_14, "NO_RECENT_ANIM"))
		{
			if (unk_0xCD61E9D5CABC7E35(Local_625.f_0, "rcm_epsilonism4", Local_625.f_14, 1))
			{
				if (unk_0x853B39ECA83DA242(Local_625.f_0, "rcm_epsilonism4", Local_625.f_14) <= 0.05f)
				{
					unk_0xAAC4733EB172E004(Local_625.f_0, Local_625.f_14, "rcm_epsilonism4", -4f);
...
void func_293()
{
	...
	if (Local_772.f_3 == 1)
	{
		...
		if (iLocal_353 == 0)
		{
			if (!func_320())
			{
				unk_0xC76B5C68AB6DC7DF(unk_0xC8B93D94F8954288(), Local_147, 1, 0, 0, 1);
				unk_0x765E3FA65D011F03(unk_0xC8B93D94F8954288(), fLocal_150);
			}
			func_277(&(Local_606[1 /*8*/]), 1);
			func_277(&(Local_606[0 /*8*/]), 1);
			if (func_332(Local_606[1 /*8*/]))
			{
				unk_0xB7A2078CD1C9A82F(Local_83.f_28[1], 0);
				unk_0xC76B5C68AB6DC7DF(Local_606[1 /*8*/], 1829.75f, 4693.5f, 38.51f, 1, 0, 0, 1);
				unk_0x765E3FA65D011F03(Local_606[1 /*8*/], 27.46f);
				Var2 = { unk_0x44C17CCB85A88A1F(Local_606[1 /*8*/], 1) };
				unk_0x32B7B9548CC32D81(1829.75f, 4693.5f, 38.51f, &fVar1, 0);
				unk_0xC76B5C68AB6DC7DF(Local_606[1 /*8*/], Var2.f_0, Var2.f_1, fVar1, 1, 0, 0, 1);
				func_382("Setting Jimmy position (0)");
			}
			if (func_332(Local_606[0 /*8*/]))
			{
				unk_0xC76B5C68AB6DC7DF(Local_606[0 /*8*/], 1827.32f, 4692.59f, 38.53f, 1, 0, 0, 1);
				unk_0x765E3FA65D011F03(Local_606[0 /*8*/], 171.22f);
				func_382("Setting Marnie position (0)");
			}
		}
		else if (iLocal_353 == 1)
		{
			unk_0xC76B5C68AB6DC7DF(unk_0xC8B93D94F8954288(), 1754.634f, 4675.789f, 42.9068f, 1, 0, 0, 1);
			unk_0x765E3FA65D011F03(unk_0xC8B93D94F8954288(), 293.2275f);
			if (func_332(Local_606[1 /*8*/]))
			{
				unk_0xC76B5C68AB6DC7DF(Local_606[1 /*8*/], 1758.586f, 4670.085f, 42.6276f, 1, 0, 0, 1);
				unk_0x765E3FA65D011F03(Local_606[1 /*8*/], 262.4368f);
				func_382("Setting Jimmy position (1)");
			}
			if (func_332(Local_606[0 /*8*/]))
			{
				unk_0xC76B5C68AB6DC7DF(Local_606[0 /*8*/], 1759.917f, 4683.584f, 42.7266f, 1, 0, 0, 1);
				unk_0x765E3FA65D011F03(Local_606[0 /*8*/], 148.3211f);
				func_382("Setting Marnie position (1)");
			}
		}
		else if (iLocal_353 == 2)
		{
			unk_0xC76B5C68AB6DC7DF(unk_0xC8B93D94F8954288(), 1758.454f, 4829.431f, 39.729f, 1, 0, 0, 1);
			unk_0x765E3FA65D011F03(unk_0xC8B93D94F8954288(), 168.2012f);
			if (func_332(Local_606[0 /*8*/]))
			{
				unk_0xC76B5C68AB6DC7DF(Local_606[0 /*8*/], 1755.005f, 4827.329f, 40.0736f, 1, 0, 0, 1);
				unk_0x765E3FA65D011F03(Local_606[0 /*8*/], 169.6486f);
	...
	if (Local_772.f_1 == 0)
	{
		func_282("Doing setup for FindRock section:", iLocal_353);
		func_277(&(Local_606[1 /*8*/]), 0);
		iLocal_350 = 0;
		iLocal_352 = 0;
		iLocal_623 = 0;
		iLocal_359 = -1;
		iLocal_753 = 0;
		iLocal_754 = 0;
		iLocal_755 = unk_0x693EBB4F13506457();
		iLocal_757 = unk_0x693EBB4F13506457();
		iLocal_758 = 0;
		if (iLocal_353 == 0)
		{
			if (func_332(unk_0xC8B93D94F8954288()))
			...
			if (func_332(Local_606[1 /*8*/]))
			{
				unk_0xDDA35844870E2C3A(Local_606[1 /*8*/], iLocal_159);
				unk_0x81333BEA4837207C(Local_606[1 /*8*/], 1826.246f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 1193033728);
			}
			func_318(&(Local_606[1 /*8*/]), 1);
			iLocal_748 = 8;
			iLocal_749 = 8;
			iLocal_751 = 0;
			iLocal_750 = 0;
		...
		else if (iLocal_353 == 1)
		{
			...
			func_318(&(Local_606[0 /*8*/]), 0);
			func_317(&(Local_606[1 /*8*/]), uLocal_760);
			iLocal_748 = 8;
			iLocal_749 = 8;
			iLocal_751 = 0;
			iLocal_750 = 0;
		...
		else if (iLocal_353 == 2)
		{
			...
			func_317(&(Local_606[0 /*8*/]), uLocal_763);
			func_316(&(Local_606[1 /*8*/]), iLocal_761);
			iLocal_748 = 11;
			iLocal_749 = 12;
			iLocal_751 = 0;
			iLocal_750 = 0;
		...
		func_315(&uLocal_168, 0, unk_0xC8B93D94F8954288(), "MICHAEL", 0, 1);
		func_315(&uLocal_168, 5, Local_606[1 /*8*/], "JIMMYBOSTON", 0, 1);
		func_315(&uLocal_168, 4, Local_606[0 /*8*/], "MARNIE", 0, 1);
		if (iLocal_353 == 0)
		{
		...
		func_314(Local_363[iLocal_353 /*43*/].f_18, Local_363[iLocal_353 /*43*/].f_19, Local_363[iLocal_353 /*43*/].f_20, Local_363[iLocal_353 /*43*/].f_21, Local_363[iLocal_353 /*43*/].f_22);
		bLocal_336 = false;
		iLocal_337 = 0;
		iLocal_338 = 0;
		iLocal_339 = 1;
		...
		iLocal_747 = 0;
		unk_0x9F4AA6F234E8A860(1);
		iLocal_358 = unk_0x693EBB4F13506457();
		iLocal_747 = unk_0x693EBB4F13506457() + 1000;
		func_282("Finished setup, moving to run loop for rock #:", iLocal_353);
		Local_772.f_1 = 1;
	}
	if (Local_772.f_1 == 1)
	{
		...
		else if (!func_313(&uLocal_694, unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1)))
		{
			func_235(6);
			Local_772.f_9 = 8;
			Local_772.f_1 = 3;
		...
		else
		{
			...
			while (iVar0 < 2)
			{
				func_310(&(Local_606[iVar0 /*8*/]));
				iVar0++;
			}
			if (unk_0x95CCECA3948CFE7B(Local_363[iLocal_353 /*43*/].f_1))
			{
				if (iLocal_353 == 0)
				{
					if (func_226(unk_0xC8B93D94F8954288(), Local_363[iLocal_353 /*43*/].f_1, 1) < 100f)
					{
						if (!unk_0xA65C064741F2CA67())
						{
							unk_0x0B3F3AB0A340D234("EPS_4_MCS_1", 8);
							func_382("Requesting midtro now");
						}
					}
					else if (func_226(unk_0xC8B93D94F8954288(), Local_363[iLocal_353 /*43*/].f_1, 1) > 120f)
					{
						if (unk_0xA65C064741F2CA67())
						{
				...
				else if (iLocal_353 == 1)
				{
					if (func_226(unk_0xC8B93D94F8954288(), Local_363[iLocal_353 /*43*/].f_1, 1) < 100f)
					{
						if (!unk_0xA65C064741F2CA67())
						{
							unk_0x0B3F3AB0A340D234("EPS_4_MCS_2", 8);
							func_382("Requesting midtro now");
						}
					}
					else if (func_226(unk_0xC8B93D94F8954288(), Local_363[iLocal_353 /*43*/].f_1, 1) > 120f)
				...
				else if (func_226(unk_0xC8B93D94F8954288(), Local_363[iLocal_353 /*43*/].f_1, 1) < 100f)
				{
					if (!unk_0xA65C064741F2CA67())
					{
						unk_0x0B3F3AB0A340D234("EPS_4_MCS_3", 8);
						func_382("Requesting midtro now");
					}
				}
				else if (func_226(unk_0xC8B93D94F8954288(), Local_363[iLocal_353 /*43*/].f_1, 1) > 120f)
			...
			func_309(&(Local_363[iLocal_353 /*43*/]));
			if (iLocal_353 == 0)
			{
				if (iLocal_746 == 0)
				{
					if (iLocal_747 < unk_0x693EBB4F13506457())
					{
						if (!func_333())
						{
							func_308("EPS4_T0");
							iLocal_747 = unk_0x693EBB4F13506457() + 7500;
							iLocal_746++;
							iLocal_759 = unk_0x693EBB4F13506457();
						}
						else
						{
							iLocal_746 = 2;
				...
				{
					if (unk_0x8D9008B8900A28D0(0, 25) || iLocal_747 < unk_0x693EBB4F13506457())
					{
						unk_0x9F4AA6F234E8A860(1);
						iLocal_747 = unk_0x693EBB4F13506457() + 1000;
						iLocal_746++;
			...
			func_280(Local_625.f_1);
			if (iLocal_339 == 1)
			{
				func_307(&uLocal_164);
				if (!func_313(&uLocal_642, unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1)))
				{
					iLocal_339 = 0;
					unk_0xB518E9C8553B1D2B(0);
					unk_0x7846F09C04C34C46();
				...
				{
					if (unk_0xF8D041B05C3D1FD4(Local_363[iLocal_353 /*43*/].f_36, sLocal_161) || func_298(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!unk_0xF8D041B05C3D1FD4(Local_363[iLocal_353 /*43*/].f_36, sLocal_161))
						{
							if (func_227(iLocal_361))
							{
								unk_0xE48D9147BC1F4CD7(iLocal_361, unk_0xC8B93D94F8954288(), 10000, 0, 2);
							}
						}
						iLocal_759 = unk_0x693EBB4F13506457();
						iLocal_340 = 1;
				...
				{
					if (!func_273() && (unk_0x693EBB4F13506457() - iLocal_358) >= 7500)
					{
						if ((unk_0xF8D041B05C3D1FD4(Local_363[iLocal_353 /*43*/].f_37, sLocal_161) || !unk_0x5534579797ACFD77(unk_0xC8B93D94F8954288(), iLocal_361, 30f, 30f, 30f, 0, 1, 0)) || func_298(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!unk_0xF8D041B05C3D1FD4(Local_363[iLocal_353 /*43*/].f_37, sLocal_161))
							{
								if (func_227(iLocal_361))
								{
									unk_0xE48D9147BC1F4CD7(iLocal_361, unk_0xC8B93D94F8954288(), 5000, 0, 2);
								}
							}
							iLocal_341 = 1;
							iLocal_759 = unk_0x693EBB4F13506457();
				...
				else if (iLocal_338 == 0 && !func_296(unk_0xC8B93D94F8954288(), Local_363[iLocal_353 /*43*/].f_2, 9f))
				{
					if (func_296(unk_0xC8B93D94F8954288(), Local_363[iLocal_353 /*43*/].f_2, 20f))
					{
						if (!iLocal_343)
						{
							if (!func_273())
							{
								if (func_298(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_42, 7, 0, 0, 0))
								{
									if (func_227(iLocal_361))
									{
										unk_0xE48D9147BC1F4CD7(iLocal_361, unk_0xC8B93D94F8954288(), 5000, 0, 2);
									}
									unk_0xD810132681A9B83C(3f, 5f, 0);
									iLocal_343 = 1;
								}
							}
						}
					...
					{
						if (func_295(unk_0xC8B93D94F8954288(), iLocal_361, 30f) || iLocal_353 == 2)
						{
							if (!func_273() && (unk_0x693EBB4F13506457() - iLocal_356) > 15000)
							{
								if (bLocal_336)
								{
									if (iLocal_352 == 0)
									{
										...
										{
											if (unk_0xF8D041B05C3D1FD4(Local_363[iLocal_353 /*43*/].f_40, sLocal_161) || func_298(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_332(iLocal_361))
												{
													unk_0xE48D9147BC1F4CD7(iLocal_361, unk_0xC8B93D94F8954288(), 3000, 0, 2);
												}
												iLocal_356 = unk_0x693EBB4F13506457();
												iLocal_750++;
												if (iLocal_353 == 2)
									...
									{
										if (unk_0xF8D041B05C3D1FD4(Local_363[iLocal_353 /*43*/].f_40, sLocal_161) || func_298(&uLocal_168, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_356 = unk_0x693EBB4F13506457();
											iLocal_752++;
										}
								...
								{
									if (unk_0xF8D041B05C3D1FD4(Local_363[iLocal_353 /*43*/].f_41, sLocal_161) || func_298(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_332(iLocal_361))
										{
											unk_0xE48D9147BC1F4CD7(iLocal_361, unk_0xC8B93D94F8954288(), 3000, 0, 2);
							...
							else if (bLocal_336 != Local_625.f_1)
							{
								...
								if (bLocal_336)
								{
									if (iLocal_357 < unk_0x693EBB4F13506457())
									{
										if (func_273())
										{
											unk_0xB518E9C8553B1D2B(1);
										}
										iLocal_356 = (unk_0x693EBB4F13506457() - 7500);
										iLocal_357 = unk_0x693EBB4F13506457();
									}
								}
								else
								{
					...
					{
						iLocal_356 = (unk_0x693EBB4F13506457() - 5000);
					}
				}
				if (iLocal_353 == 0)
				{
					if (iLocal_753 < 5)
					{
						if (((unk_0x693EBB4F13506457() - iLocal_755) > 7500 && !func_273()) && !unk_0xA3858ADDDBC3CB71())
						{
							if (func_227(Local_606[0 /*8*/]))
							{
								if (func_226(Local_606[0 /*8*/], unk_0xC8B93D94F8954288(), 1) < 4f)
								{
									if (func_298(&uLocal_168, "EPS4AUD", "EPS4_NEARM", 6, 0, 0, 0))
									{
										iLocal_753++;
										iLocal_755 = unk_0x693EBB4F13506457();
									}
				...
				else if (iLocal_353 == 1)
				{
					if (iLocal_753 < 4)
					{
						if (((unk_0x693EBB4F13506457() - iLocal_755) > 7500 && !func_273()) && !unk_0xA3858ADDDBC3CB71())
						{
							if (func_227(Local_606[1 /*8*/]))
							{
								if (func_226(Local_606[1 /*8*/], unk_0xC8B93D94F8954288(), 1) < 4f)
								{
									if (func_298(&uLocal_168, "EPS4AUD", "EPS4_NEARJ", 6, 0, 0, 0))
									{
										iLocal_753++;
										iLocal_755 = unk_0x693EBB4F13506457();
									}
					...
					if (iLocal_753 < 3)
					{
						if (((unk_0x693EBB4F13506457() - iLocal_755) > 7500 && !func_273()) && !unk_0xA3858ADDDBC3CB71())
						{
							if (func_227(Local_606[1 /*8*/]))
							{
								if (func_226(Local_606[1 /*8*/], unk_0xC8B93D94F8954288(), 1) < 4f)
								{
									if (func_298(&uLocal_168, "EPS4AUD", "EPS4_NEARJP", 6, 0, 0, 0))
									{
										iLocal_753++;
										iLocal_755 = unk_0x693EBB4F13506457();
									}
					...
					if (iLocal_754 < 4)
					{
						if (((unk_0x693EBB4F13506457() - iLocal_755) > 7500 && !func_273()) && !unk_0xA3858ADDDBC3CB71())
						{
							if (func_227(Local_606[0 /*8*/]))
							{
								if (func_226(Local_606[0 /*8*/], unk_0xC8B93D94F8954288(), 1) < 4f)
								{
									if (func_298(&uLocal_168, "EPS4AUD", "EPS4_NEARMP", 6, 0, 0, 0))
									{
										iLocal_754++;
										iLocal_755 = unk_0x693EBB4F13506457();
									}
				...
				if (unk_0xA0C23498D8E0BB93(unk_0xC8B93D94F8954288(), Local_363[iLocal_353 /*43*/].f_2, 6.2f, 6.2f, 2f, 0, 0, 1))
				{
					if (iLocal_359 == -1)
					{
						iLocal_359 = unk_0x693EBB4F13506457();
					}
					else if ((unk_0x693EBB4F13506457() - iLocal_359) >= 1500)
					{
						if (func_273())
						{
							func_271();
						}
						iLocal_537 = unk_0x693EBB4F13506457();
						func_235(3);
						Local_772.f_1 = 3;
					}
				}
				...
				else if (!func_296(unk_0xC8B93D94F8954288(), Local_363[iLocal_353 /*43*/].f_2, (9f + 2f)))
				{
					iLocal_337 = 0;
				}
			}
			...
			{
				if (!unk_0x6B4865E08E90ACC5(uLocal_164))
				{
					uLocal_164 = func_294(Local_144, 5, 0);
				}
				bLocal_336 = Local_625.f_1;
				if (func_313(&uLocal_642, unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1)))
				{
				...
				else if (iLocal_344 == 0)
				{
					if (iLocal_353 < 2)
					{
						if (unk_0x5534579797ACFD77(unk_0xC8B93D94F8954288(), iLocal_361, 30f, 30f, 30f, 0, 1, 0))
						{
							if (!func_273() && !unk_0xA3858ADDDBC3CB71())
							{
								if (unk_0xF8D041B05C3D1FD4(Local_363[iLocal_353 /*43*/].f_38, sLocal_161) || func_298(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_38, 7, 0, 0, 0))
								{
									iLocal_344 = 1;
								}
							}
					...
					else if (!func_273() && !unk_0xA3858ADDDBC3CB71())
					{
						if (unk_0xF8D041B05C3D1FD4(Local_363[iLocal_353 /*43*/].f_38, sLocal_161) || func_298(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_38, 7, 0, 0, 0))
						{
							iLocal_344 = 1;
				...
				else if (iLocal_345 == 0)
				{
					if (iLocal_353 < 2)
					{
						if (unk_0x5534579797ACFD77(unk_0xC8B93D94F8954288(), iLocal_361, 30f, 30f, 30f, 0, 1, 0))
						{
							if ((!func_273() && (unk_0x693EBB4F13506457() - iLocal_358) >= 7500) && !unk_0xA3858ADDDBC3CB71())
							{
								if (unk_0xF8D041B05C3D1FD4(Local_363[iLocal_353 /*43*/].f_39, sLocal_161) || func_298(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_39, 7, 0, 0, 0))
								{
									iLocal_345 = 1;
								}
							}
					...
					else if ((!func_273() && (unk_0x693EBB4F13506457() - iLocal_358) >= 7500) && !unk_0xA3858ADDDBC3CB71())
					{
						if (unk_0xF8D041B05C3D1FD4(Local_363[iLocal_353 /*43*/].f_39, sLocal_161) || func_298(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_39, 7, 0, 0, 0))
						{
							iLocal_345 = 1;
	...
	if (Local_772.f_1 == 3)
	{
		...
		func_279();
		unk_0x76EF33E3762DAC58(0, 200, 150);
		if ((unk_0x693EBB4F13506457() - iLocal_537) > 750)
		{
			func_223();
...
void func_309(var uParam0)
{
	...
	fVar0 = unk_0x2A488C176D52CCA5(uParam0->f_2, unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1));
	Var1 = { unk_0x2CDF65DEC17DF0F9(unk_0xC8B93D94F8954288()) };
	...
	Var8 = { uParam0->f_2 - unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1) };
	Var11 = { uParam0->f_2 - unk_0xCC31DB73C65552D8(unk_0xC8B93D94F8954288(), 0f, -5f, 0f) };
	bVar14 = ((Var8.f_0 * Var4.f_0) + (Var8.f_1 * Var4.f_1)) > 0f;
	fVar15 = (1f - (unk_0x3CD093DDA8B5D04F(Var4.f_0, Var4.f_1, Var11.f_0, Var11.f_1) / 180f));
	if (fVar0 >= 10f)
	{
	...
	else if (iLocal_354 < unk_0x693EBB4F13506457())
	{
		if (fVar0 <= 6.5f && bVar16)
		{
			unk_0x7A2D5FC5F94932AA(Local_625.f_3);
			unk_0x90EA80826C00FB10(Local_625.f_4, "CONTINUAL_BEEP", unk_0xC8B93D94F8954288(), "EPSILONISM_04_SOUNDSET", 0, 0);
			Local_625.f_6 = 1;
		}
		else
		{
			...
			iLocal_354 = (unk_0x693EBB4F13506457() + iVar18);
			iVar18 = (iVar18 / 3);
			if (iVar18 < 100)
			{
				iVar18 = 100;
			}
			iLocal_355 = (unk_0x693EBB4F13506457() + iVar18);
			unk_0x90EA80826C00FB10(Local_625.f_3, "IDLE_BEEP", unk_0xC8B93D94F8954288(), "EPSILONISM_04_SOUNDSET", 0, 0);
			if (bVar16)
			{
				unk_0x76EF33E3762DAC58(0, 200, 150);
			}
			...
			{
				unk_0x76EF33E3762DAC58(0, 200, 100);
			}
		}
	}
	if (iLocal_355 > 0 && unk_0x693EBB4F13506457() > iLocal_355)
	{
		unk_0x7A2D5FC5F94932AA(Local_625.f_3);
		iLocal_355 = 0;
	}
	if (unk_0xA4860063B4E6B963())
	{
		if (Local_625.f_7 == 0)
		{
			unk_0x90EA80826C00FB10(Local_625.f_5, "SCAN", unk_0xC8B93D94F8954288(), "EPSILONISM_04_SOUNDSET", 0, 0);
			Local_625.f_7 = 1;
		}
		else if (bVar16)
		{
			unk_0x19EF487B6B6C1F0B(Local_625.f_5, "IsOnTarget", 1f);
		}
		else
		{
			unk_0x19EF487B6B6C1F0B(Local_625.f_5, "IsOnTarget", 0f);
		}
		iLocal_759 = unk_0x693EBB4F13506457();
	}
	...
	else
	{
		...
		unk_0x7C38F93AF52620B1(uLocal_165, "SET_DISTANCE");
		unk_0x512B59C08EAFA3B9(fLocal_640);
		unk_0xD013AC29829DDC02();
		unk_0x052F8F69DC6157DE(uLocal_166);
		unk_0x06D856499865F31F(uLocal_165, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	}
	if (unk_0x0139E142C27412BC(0, 25))
	{
		unk_0x9EEBFF7C6634D175(unk_0xC8B93D94F8954288(), 1f);
		unk_0x2BE3C7FA4FCCA784(0, 22, 1);
		if (bLocal_351)
		{
			unk_0x0F9FDCEB321235AB(15f, 1065353216);
...
void func_310(var uParam0)
{
	...
	if (func_332(*uParam0) && unk_0x5BE4C4CB01F0877F(*uParam0))
	{
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			{
				iVar0 = unk_0x531444754C426278(0, iLocal_605);
				while (uParam0->f_3 == -1)
				{
					if (Local_538[iVar0 /*6*/].f_5 == 0)
					{
						...
						{
							if (!unk_0xA0C23498D8E0BB93(*uParam0, Local_538[iVar0 /*6*/], 3f, 3f, 3f, 0, 1, 0))
							{
				...
				unk_0x81333BEA4837207C(*uParam0, Local_538[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 1193033728);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (!uParam0->f_7)
				{
					if (unk_0x090C65D5190A249D(*uParam0, 713668775) == 7)
					{
				...
				else if (unk_0x090C65D5190A249D(*uParam0, 2106541073) == 7)
				{
		...
		case 2:
			...
			else if (uParam0->f_2 == 0)
			{
				...
				unk_0x3E2E609450787FFE(&uLocal_167);
				if (Local_538[uParam0->f_3 /*6*/].f_4 == 0)
				{
					if (*uParam0 == Local_606[1 /*8*/])
					{
						unk_0x5323F488E6A1B660(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_entry_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x5323F488E6A1B660(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x5323F488E6A1B660(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_exit_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else
					{
						unk_0x5323F488E6A1B660(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_entry_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x5323F488E6A1B660(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x5323F488E6A1B660(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_exit_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
				}
				else if (Local_538[uParam0->f_3 /*6*/].f_4 == 2)
				{
					unk_0x6EAFBB3A7F6ADEA9(0, Local_538[uParam0->f_3 /*6*/].f_3, 0);
					unk_0x5323F488E6A1B660(0, "rcm_epsilonism4", "peeing", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				else if (Local_538[uParam0->f_3 /*6*/].f_4 == 3)
				{
					unk_0x5323F488E6A1B660(0, "rcm_epsilonism4", "hippy_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				...
				unk_0x939BC11172AA1303(uLocal_167);
				unk_0xBFE865E3B513451B(*uParam0, uLocal_167);
				unk_0xA9351C9309E03069(&uLocal_167);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (unk_0x090C65D5190A249D(*uParam0, 242628503) == 7)
				{
					Local_538[uParam0->f_3 /*6*/].f_5 = 0;
					uParam0->f_3 = -1;
					uParam0->f_1 = 1;
		...
		case 4:
			...
			{
				if (!unk_0xA0C23498D8E0BB93(unk_0xC8B93D94F8954288(), uParam0->f_4, 1f, 1f, 1f, 0, 1, 0) || iLocal_353 > 0)
				{
					if (!unk_0x5BE4C4CB01F0877F(*uParam0))
					{
						unk_0x5124C5FA52D2AF3E(*uParam0);
						unk_0x13B202E60E04C733(*uParam0, func_311());
						unk_0xC778754E36F3FFD6(*uParam0, 167, 1);
					}
					iLocal_756 = unk_0x693EBB4F13506457();
					if (iLocal_353 == 0)
					{
						unk_0xA8FE8F36C91BA927(func_311(), 0);
					}
					else
					{
						unk_0xA8FE8F36C91BA927(func_311(), 0);
					}
					unk_0x6B624E62C30066BB(func_311(), 4f, -1082130432, -1082130432);
					uParam0->f_2 = 1;
				}
			}
			else if (uParam0->f_2 == 1)
			{
				...
				if (unk_0x5852357F37E2F27C(*uParam0))
				{
					if (!iLocal_350)
					{
						if ((unk_0x693EBB4F13506457() - iLocal_756) > 6000)
						{
							unk_0x3E2E609450787FFE(&uLocal_167);
							if (*uParam0 == Local_606[1 /*8*/])
							{
							...
							if (!func_273() && !unk_0xA3858ADDDBC3CB71())
							{
								if (*uParam0 == Local_606[1 /*8*/])
								{
									func_298(&uLocal_168, "EPS4AUD", "EPS4_DAWDJ", 7, 0, 0, 0);
								}
								else
								{
									func_298(&uLocal_168, "EPS4AUD", "EPS4_DAWDM", 7, 0, 0, 0);
								}
							}
							iLocal_350 = 1;
						}
				...
				if (unk_0x50CB4D478D09ED89(unk_0xC8B93D94F8954288()) || unk_0x86E1370A4B848657(unk_0xC8B93D94F8954288()))
				{
					if ((((unk_0x693EBB4F13506457() - iLocal_757) > 7500 && !func_273()) && !unk_0xA3858ADDDBC3CB71()) && !iLocal_337)
					{
						if (*uParam0 == Local_606[1 /*8*/])
						{
							if (func_298(&uLocal_168, "EPS4AUD", "EPS4_MESSJ", 7, 0, 0, 0))
							{
								iLocal_757 = unk_0x693EBB4F13506457();
							}
						}
						else if (func_298(&uLocal_168, "EPS4AUD", "EPS4_MESSM", 7, 0, 0, 0))
						{
							iLocal_757 = unk_0x693EBB4F13506457();
						}
					}
				}
				if ((unk_0x693EBB4F13506457() - iLocal_759) > 15000)
				{
					if ((((iLocal_758 < 4 && !func_273()) && !unk_0xA3858ADDDBC3CB71()) && !iLocal_337) && !func_333())
					{
						if (*uParam0 == Local_606[1 /*8*/])
						{
							if (func_298(&uLocal_168, "EPS4AUD", "EPS4_PROMPTJ", 7, 0, 0, 0))
							{
								iLocal_759 = unk_0x693EBB4F13506457();
								iLocal_758++;
							}
						}
						else if (func_298(&uLocal_168, "EPS4AUD", "EPS4_PROMPTM", 7, 0, 0, 0))
						{
							iLocal_759 = unk_0x693EBB4F13506457();
							iLocal_758++;
						}
		...
		case 5:
			...
			{
				unk_0x1510D3A1E178AAEF(*uParam0, unk_0xC8B93D94F8954288(), 20000, 4.5f, 1073741824, 1073741824, 0);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
...
{
	if (func_332(iParam0) && func_227(unk_0xC8B93D94F8954288()))
	{
		if (iLocal_623 == 0)
		{
			if (unk_0xA499226F64D3A26A(unk_0xC8B93D94F8954288(), iParam0) && unk_0x770AAB67BDD9C729(iParam0))
			{
		...
		else if (func_332(iLocal_624))
		{
			if (unk_0x5B4D7A11EBC299CE(iLocal_624) || unk_0xCD8A4525A9B5A276(iLocal_624))
			{
				if (!func_273() && !unk_0xA3858ADDDBC3CB71())
				{
					if (iLocal_624 == Local_606[1 /*8*/])
					{
						if (func_298(&uLocal_168, "EPS4AUD", "EPS4_JKNOCK", 7, 0, 0, 0))
						{
							iLocal_623 = 0;
							iLocal_624 = 0;
						}
					}
					else if (func_298(&uLocal_168, "EPS4AUD", "EPS4_MKNOCK", 7, 0, 0, 0))
					{
						iLocal_623 = 0;
						iLocal_624 = 0;
					}
...
{
	unk_0x90EA80826C00FB10(Local_625.f_2, "DEVICE", unk_0xC8B93D94F8954288(), "EPSILONISM_04_SOUNDSET", 0, 0);
	if (Local_625.f_13 == 0)
	{
...
void func_316(var uParam0, int iParam1)
{
	if (func_332(*uParam0))
	{
		...
		unk_0xBA73099E237C7E5E(*uParam0);
		unk_0xC76B5C68AB6DC7DF(*uParam0, Local_538[iParam1 /*6*/], 1, 0, 0, 1);
		unk_0x765E3FA65D011F03(*uParam0, Local_538[iParam1 /*6*/].f_3);
	}
	else
	{
		uParam0->f_1 = 0;
...
{
	if (func_332(*uParam0) && func_332(unk_0xC8B93D94F8954288()))
	{
		uParam0->f_1 = 4;
		uParam0->f_2 = 0;
		unk_0xE48D9147BC1F4CD7(*uParam0, unk_0xC8B93D94F8954288(), -1, 0, 2);
		if (bParam1)
		{
			unk_0xC518AECFA9CF7722(*uParam0, unk_0xC8B93D94F8954288(), 0);
		}
		uParam0->f_4 = { unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1) };
	}
	else
	{
		uParam0->f_1 = 0;
...
int func_322()
{
	...
	unk_0xC0E8B67A4385D37D("rcm_epsilonism4leadinout");
	if (unk_0xF9B86DC1728F1339("rcm_epsilonism4") && unk_0xF9B86DC1728F1339("rcm_epsilonism4leadinout"))
	{
		return 1;
	}
	return 0;
...
int func_323()
{
	...
	while (iVar0 < iLocal_536)
	{
		unk_0x7567CEA8E6B5340B(Local_363[iVar0 /*43*/]);
		iVar0++;
	}
	unk_0x7567CEA8E6B5340B(uLocal_160);
	unk_0x7567CEA8E6B5340B(joaat("bison"));
	iVar0 = 0;
	while (iVar0 < iLocal_536)
	{
		if (!unk_0x0845149A26DABBA5(Local_363[iVar0 /*43*/]))
		{
			return 0;
		}
		iVar0++;
	}
	if (!unk_0x0845149A26DABBA5(iLocal_160) || !unk_0x0845149A26DABBA5(joaat("bison")))
	{
		return 0;
	}
	return 1;
...
void func_325()
{
	...
	if (Local_772.f_1 == 0)
	{
		if (!unk_0x57CF017E37442A64())
		{
			unk_0x0B3F3AB0A340D234("ep_4_rcm_concat", 8);
		}
		...
		if (func_269(1, 1093140480, 0))
		{
			...
			if (func_332(Local_83.f_28[0]))
			{
				unk_0x5D713171D2C2E177(Local_83.f_28[0], "Marnie", 0, 0, 0);
			}
			if (func_332(Local_83.f_28[1]))
			{
				unk_0xB7A2078CD1C9A82F(Local_83.f_28[1], 0);
				if (func_227(unk_0xA7C2E7868E127D65(Local_83.f_28[1])))
				{
					iLocal_641 = func_266(Local_83.f_28[1], joaat("weapon_digiscanner"), 1, 0, 0, 0, 0);
					unk_0x5D713171D2C2E177(iLocal_641, "Artefact_Detector", 0, 0, 0);
				}
				unk_0x5D713171D2C2E177(Local_83.f_28[1], "Jimmy_Boston", 0, 0, 0);
			}
			if (func_332(unk_0xC8B93D94F8954288()))
			{
				unk_0x5D713171D2C2E177(unk_0xC8B93D94F8954288(), "Michael", 0, 0, 0);
			}
			unk_0x233432976E597324("EPS4_START");
			func_329();
			unk_0x1FFBBAD42BF7E243(1);
			unk_0x8E6D4B516B44DE88(0);
			unk_0x4EDE34FBADD967A6(0);
	...
	if (Local_772.f_1 == 1)
	{
		...
		if (func_227(unk_0xC8B93D94F8954288()))
		{
			...
			{
				func_382("*** Forcing Michael's move state");
				func_328(unk_0xC8B93D94F8954288(), 1827.161f, 4698.645f, 38.094f, 184.1384f, 0, 1);
				unk_0x640290651A86938B(unk_0xC8B93D94F8954288(), iLocal_159, -1, 1, 1);
			}
		}
...
void func_326()
{
	...
	if (func_227(Local_606[1 /*8*/]))
	{
		if (unk_0x669E4BAB086C2648("Jimmy_Boston", 0))
		{
			unk_0x32B7B9548CC32D81(1829.8f, 4693.48f, 38.5f, &uVar0, 0);
			unk_0xC76B5C68AB6DC7DF(Local_606[1 /*8*/], 1829.8f, 4693.48f, uVar0, 1, 0, 0, 1);
		}
	}
}
...
void func_327()
{
	if (func_227(Local_606[0 /*8*/]))
	{
		if (unk_0x669E4BAB086C2648("Marnie", 0))
		{
			func_317(&(Local_606[0 /*8*/]), uLocal_762);
			Local_606[0 /*8*/].f_1 = 1;
			Local_606[0 /*8*/].f_2 = 1;
			...
			unk_0x6094B3418D5AE59D(Local_606[0 /*8*/], Local_538[Local_606[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 1056964608);
			unk_0x447955D97DC49D70(Local_606[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 1);
			Local_606[0 /*8*/].f_7 = 1;
...
void func_330()
{
	...
	if (Local_772.f_1 == 0)
	{
		...
		if (!func_393(0) && unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0))
		{
			func_382("Doing setup for leadin");
			func_315(&uLocal_168, 4, Local_83.f_28[0], "MARNIE", 0, 1);
			if (func_322())
			{
				Local_772.f_1 = 1;
			}
	...
	if (Local_772.f_1 == 1)
	{
		if ((unk_0x693EBB4F13506457() - iLocal_354) > 1250)
		{
			unk_0xE55275772E833643(-1, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
			iLocal_354 = unk_0x693EBB4F13506457();
		}
		if (!func_393(0) && unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0))
		{
			if (func_226(unk_0xC8B93D94F8954288(), Local_83.f_28[0], 1) >= 3f)
			{
				if (!unk_0x000CF7FDBE12A995())
				{
					if (!iLocal_333)
					{
						...
						{
							unk_0x4E0A15B03F32C5E5(Local_83.f_28[0], 0f, 0f, 0.2f, 1, 30000, 2000, 2000, 0);
							unk_0x6F54F772EE466016(fLocal_767);
							unk_0xBD464480C6D92A9B(fLocal_768);
							unk_0x738D81A70EEB6E1B(fLocal_769);
							unk_0xDDD2941088121FB4(fLocal_770);
							unk_0xFE001801F24E5665(fLocal_771);
							unk_0x3CC0EB07DC1F5A44(1);
							if (func_227(unk_0xC8B93D94F8954288()))
							{
								unk_0x3E2E609450787FFE(&uLocal_167);
								unk_0xE48D9147BC1F4CD7(0, Local_83.f_28[0], 15000, 0, 2);
								unk_0x81333BEA4837207C(0, 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 1193033728);
								unk_0xC518AECFA9CF7722(0, Local_83.f_28[0], 0);
								unk_0x939BC11172AA1303(uLocal_167);
								unk_0xBFE865E3B513451B(unk_0xC8B93D94F8954288(), uLocal_167);
								unk_0xA9351C9309E03069(&uLocal_167);
			...
			if (!iLocal_334)
			{
				if (func_332(Local_83.f_28[0]) && !func_273())
				{
					unk_0xE48D9147BC1F4CD7(Local_83.f_28[0], unk_0xC8B93D94F8954288(), -1, 48, 2);
					unk_0x5323F488E6A1B660(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0, 0, 0, 0);
					unk_0xCDBEE0F3B4A74754();
					unk_0x4767D2EEF03042F6("EP_4_RCM_CONCAT", 2, 8);
					func_382("Done Marnie leadin anim - request concat cutscene");
					iLocal_334 = 1;
				}
			}
			else if (func_332(Local_83.f_28[0]))
			{
				if (unk_0xCD61E9D5CABC7E35(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					if (unk_0x853B39ECA83DA242(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.25f)
					{
						if (!iLocal_335)
						{
							if (func_298(&uLocal_168, "EPS4AUD", "ESP4_RCL", 8, 0, 0, 0))
							{
					...
					if (unk_0x853B39ECA83DA242(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.95f)
					{
						func_382("Leadin done, launch cutscene");
						func_235(1);
						Local_772.f_1 = 3;
					}
					if (func_226(unk_0xC8B93D94F8954288(), Local_83.f_28[0], 1) <= 1.5f)
					{
						unk_0x6C1CBBF18B93CB8E(unk_0xA34E7C2A5118D638(), false, 0);
						unk_0x5124C5FA52D2AF3E(unk_0xC8B93D94F8954288());
					}
	...
	if (Global_69571 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0xD5DFCA69ACAA20E3())
			{
				...
				Var4 = { func_336(Global_69572, Global_69574, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_347(0) || Global_69586) || Global_69575 == 1) || !unk_0xB66DD474AA9E764E())
	{
		return 0;
	}
	switch (Global_69571)
	{
		...
		case 5:
			if ((unk_0x308528B5CF35F306() || func_221(0)) || func_346(1))
			{
			}
			else
			{
...
{
	return func_349(iParam0, Global_35700);
}
...
void func_358(var uParam0)
{
	...
	uParam0->f_1 = unk_0xB2AD4914C25D1420(*uParam0, Var0, 1, 1, 0);
	if (unk_0x95CCECA3948CFE7B(uParam0->f_1))
	{
		unk_0x68931E8B45B3CA92(uParam0->f_1, uParam0->f_5, 0, 1);
		func_359("Rock rot vector: ", unk_0xF57992155BDFCC67(uParam0->f_1, 0));
		func_359("Rock actual position: ", unk_0x44C17CCB85A88A1F(uParam0->f_1, 0));
		unk_0xBC4E8EDD8046417B(uParam0->f_1, 0);
...
void func_360()
{
	Local_625.f_2 = unk_0x83E9D86E63672B9A();
	Local_625.f_3 = unk_0x83E9D86E63672B9A();
	Local_625.f_4 = unk_0x83E9D86E63672B9A();
	Local_625.f_5 = unk_0x83E9D86E63672B9A();
	Local_625.f_12 = 0.92f;
	Local_625.f_13 = 0;
	Local_625.f_14 = "NO_RECENT_ANIM";
	uLocal_165 = unk_0x31DC2CEFEF13C96D("digiscanner");
	while (!unk_0xF518F3C7FACD43B7(uLocal_165))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	...
	unk_0x8D3EF96B70C29C06(iLocal_160);
	if (unk_0x4C4B08464D56970E("digiscanner"))
	{
		uLocal_166 = unk_0xEA2A23EE27BAE0D5("digiscanner");
	}
}
...
void func_362()
{
	...
	func_373("EPS4_JCHAT1", sLocal_161);
	...
	func_371(sLocal_161, "EPS4_PRET2");
	...
	uLocal_760 = func_367(1764.089f, 4665.879f, 42.3031f, 281.6336f, 2);
	uLocal_762 = func_367(1814.27f, 4651.32f, 37.58f, 173.1089f, 0);
	iLocal_761 = func_367(1846.512f, 4705.614f, 38.1214f, 25.7591f, 3);
	uLocal_763 = func_367(1790.414f, 4722.897f, 37.8533f, 221.4777f, 0);
	func_366(&uLocal_642);
	func_365(&uLocal_642, 1897.42f, 4596.51f, 36.4f);
	func_365(&uLocal_642, 1912.2f, 4676.93f, 39.44f);
	func_365(&uLocal_642, 1886.09f, 4733.68f, 39.48f);
	func_365(&uLocal_642, 1800.24f, 4820.64f, 40.96f);
	func_365(&uLocal_642, 1796.556f, 4893.541f, 40.4741f);
	func_365(&uLocal_642, 1782.651f, 4916.333f, 41.4418f);
	func_365(&uLocal_642, 1746.552f, 4942.362f, 42.8677f);
	func_365(&uLocal_642, 1702.537f, 4893.824f, 36.7751f);
	func_365(&uLocal_642, 1707.273f, 4814.81f, 40.9407f);
	func_365(&uLocal_642, 1729.46f, 4655.21f, 42.61f);
	func_365(&uLocal_642, 1772.05f, 4602.143f, 36.457f);
	func_364(&uLocal_642);
	func_363(&uLocal_694, &uLocal_642, 20f);
}
...
int func_385(var uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			if (func_332(unk_0xC8B93D94F8954288()))
			{
				uVar5 = unk_0xBD4278CDF5C53C71(unk_0xC8B93D94F8954288());
			}
			if (!unk_0x95CCECA3948CFE7B(uParam0->f_28[0]))
			{
				...
				{
					unk_0xCBD60E398042F554(uParam0->f_28[0], uVar5);
			...
			if (!unk_0x95CCECA3948CFE7B(uParam0->f_28[1]))
			{
				...
				{
					unk_0xCBD60E398042F554(uParam0->f_28[1], iVar5);
					unk_0xC778754E36F3FFD6(uParam0->f_28[1], 132, 1);
					unk_0x9982920999FF4733(uParam0->f_28[1], 1, 0, 0, false);
					unk_0x5124C5FA52D2AF3E(uParam0->f_28[1]);
					unk_0x640290651A86938B(uParam0->f_28[1], joaat("weapon_digiscanner"), -1, 1, 1);
					unk_0x5323F488E6A1B660(uParam0->f_28[1], "rcm_epsilonism4", "ep_4_rcm_jimmyboston_base_jb", 8f, -8f, -1, 1, 0, 0, 0, 0);
...
void func_395()
{
	...
	if (func_332(unk_0xC8B93D94F8954288()))
	{
		...
		unk_0x80423B6A45BF05DA(unk_0xC8B93D94F8954288(), joaat("weapon_unarmed"), 1);
		unk_0x5124C5FA52D2AF3E(unk_0xC8B93D94F8954288());
		unk_0x319EF6018B1B83B4(unk_0xC8B93D94F8954288(), 0f);
	}
	if (unk_0x2394B86AAC723FB8())
	{
		unk_0x11592AACD6BAEC7F();
	}
	unk_0xE0A93F04DCBD572A(uLocal_360);
	if (func_227(Local_606[0 /*8*/]) && func_227(Local_606[1 /*8*/]))
	{
		if (unk_0x5BE4C4CB01F0877F(Local_606[0 /*8*/]))
		{
			unk_0x5980997C9ACA0572(Local_606[0 /*8*/]);
		}
		else if (unk_0x5BE4C4CB01F0877F(Local_606[1 /*8*/]))
		{
			unk_0x5980997C9ACA0572(Local_606[1 /*8*/]);
		}
	}
	func_396(&(Local_606[0 /*8*/]), 1, 1, 1);
	func_396(&(Local_606[1 /*8*/]), 1, 1, 1);
	unk_0xA4CE556B2DCD4B71("digiscanner");
	unk_0x9DBF08025225340D(uLocal_162, 0);
	unk_0x9DBF08025225340D(uLocal_163, 0);
	unk_0x78DFC4B56BCF3DA9(iLocal_764);
	unk_0x78DFC4B56BCF3DA9(iLocal_765);
	unk_0x78DFC4B56BCF3DA9(iLocal_766);
	if (unk_0xB5F5536784683C33("EPSILONISM_04_MIX"))
	{
		func_382("Stopping dynamic mix EPSILONISM_04_MIX");
		unk_0xDB9D78E5137EE7AD("EPSILONISM_04_MIX");
	}
...
void func_398(bool bParam0)
{
	...
	if (!func_413())
	{
		...
		{
			func_175(iVar0, 1, 0);
			func_399(unk_0xC4E68AF0B559FAC4(), iVar0);
		}
		else
		{
			if (Global_100063[iVar0 /*10*/].f_9 == -1)
...
int func_400(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_406())
	{
		...
		{
			iVar33 = func_401(unk_0xC4E68AF0B559FAC4());
			if (iVar33 > -1)
			{
...
int func_402()
{
	...
	iVar0 = func_403(&(Global_91106.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_406()
{
	...
	{
		if (func_401(&(Global_91106.f_3)) > -1)
		{
			return 1;
		}
	}
