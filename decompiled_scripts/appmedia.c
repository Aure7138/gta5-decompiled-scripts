				...
				switch (Global_14443.f_1)
				{
					...
					case 8:
						if ((func_15(2, Global_14411, 0) && iLocal_210 == 0) && iLocal_211 == 0)
						{
							...
							{
								if (unk_0xF44A5E894FE76438(Global_2314, 15))
								{
								}
								func_13();
							}
...
void func_2()
{
	iLocal_25 = unk_0x8BA1C57857EE8698(0);
	switch (iLocal_25)
	{
		case 0:
			iLocal_24 = 0;
...
void func_3()
{
	...
	iLocal_21 = unk_0xFBFFA786E421D81C();
	iLocal_22 = 0;
	iVar0 = 0;
	while (iLocal_22 < iLocal_21)
	{
		if (unk_0x96447A6C389816A3(iLocal_22))
		{
...
void func_8()
{
	if (iLocal_210 == 0 && iLocal_211 == 1)
	{
		...
		unk_0xD78E51E620C94587(Local_207, 0);
	}
}
...
void func_13()
{
	if (iLocal_210 == 0)
	{
		unk_0xBD23748C55D3B707(&Local_207, 0);
...
void func_22()
{
	...
	if (Global_14421 == 0)
	{
		...
		{
			unk_0x4EA098C870B73AB7(&Global_2314, 15);
			func_24();
			Global_14421 = 1;
			unk_0x3B6EF6403E3F1CAC(Global_14424, "GET_CURRENT_SELECTION");
			uLocal_20 = unk_0x747CF7F7964A7A98();
			while (!unk_0x5BB8F128D41C9D26(uLocal_20))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			iVar0 = unk_0x208C8B7F9E2B7F30(uLocal_20);
			if (iVar0 > -1)
			{
...
void func_26()
{
	if ((unk_0x59D60465DE87FE2F() || unk_0xF1A016B51831B87B()) || unk_0x2D337DD29A7ABD30())
	{
