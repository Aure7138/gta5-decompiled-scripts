				...
				switch (Global_14443.f_1)
				{
					...
					case 8:
						if ((func_15(2, Global_14411, 0) && iLocal_210 == 0) && iLocal_211 == 0)
						{
							...
							{
								if (unk_0x48B8265059381CD0(Global_2314, 15))
								{
								}
								func_13();
							}
...
void func_2()
{
	iLocal_25 = unk_0x84CF4F3B0C6CB3D3(0);
	switch (iLocal_25)
	{
		case 0:
			iLocal_24 = 0;
...
void func_3()
{
	...
	iLocal_21 = unk_0xE1E7B008DD523E21();
	iLocal_22 = 0;
	iVar0 = 0;
	while (iLocal_22 < iLocal_21)
	{
		if (unk_0x809091B9FA64B36F(iLocal_22))
		{
...
void func_8()
{
	if (iLocal_210 == 0 && iLocal_211 == 1)
	{
		...
		unk_0xE018C448439E147D(Local_207, 0);
	}
}
...
void func_13()
{
	if (iLocal_210 == 0)
	{
		unk_0xD48D02F749616B61(&Local_207, 0);
...
void func_22()
{
	...
	if (Global_14421 == 0)
	{
		...
		{
			unk_0x21E7933CCC7B3724(&Global_2314, 15);
			func_24();
			Global_14421 = 1;
			unk_0xEAC9A8A194DF8F91(Global_14424, "GET_CURRENT_SELECTION");
			uLocal_20 = unk_0x2B5EF283DBE89739();
			while (!unk_0x78FB53FF5C2D4903(uLocal_20))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			iVar0 = unk_0x38CC180A8259BCD8(uLocal_20);
			if (iVar0 > -1)
			{
...
void func_26()
{
	if ((unk_0xB15049400DCD8DC9() || unk_0x8EA3D5407E9F4AF0()) || unk_0xEF4E5E47AF0D4480())
	{
