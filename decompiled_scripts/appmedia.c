				...
				switch (Global_14413.f_1)
				{
					...
					case 8:
						if ((func_15(2, Global_14381, 0) && iLocal_210 == 0) && iLocal_211 == 0)
						{
							...
							{
								if (unk_0xB519E5386FBF69E5(Global_2284, 15))
								{
								}
								func_13();
							}
...
void func_2()
{
	iLocal_25 = unk_0x3FF7A23AAE986803(0);
	switch (iLocal_25)
	{
		case 0:
			iLocal_24 = 0;
...
void func_3()
{
	...
	iLocal_21 = unk_0xEE9B8CDC912A5B26();
	iLocal_22 = 0;
	iVar0 = 0;
	while (iLocal_22 < iLocal_21)
	{
		if (unk_0x53C95386E4961722(iLocal_22))
		{
...
void func_8()
{
	if (iLocal_210 == 0 && iLocal_211 == 1)
	{
		...
		unk_0xB0E0125CA07D4D7A(Local_207, 0);
	}
}
...
void func_13()
{
	if (iLocal_210 == 0)
	{
		unk_0x8C25E39279825389(&Local_207, 0);
...
void func_22()
{
	...
	if (Global_14391 == 0)
	{
		...
		{
			unk_0x73817D396768E4C6(&Global_2284, 15);
			func_24();
			Global_14391 = 1;
			unk_0xA4F3B84032D46C13(Global_14394, "GET_CURRENT_SELECTION");
			uLocal_20 = unk_0x96E794F94B35432F();
			while (!unk_0x4B2BEE3B1540A0A3(uLocal_20))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			iVar0 = unk_0x9FF96E17DE53C966(uLocal_20);
			if (iVar0 > -1)
			{
...
void func_26()
{
	if ((unk_0xA4844394CE04D85D() || unk_0xFD563D1BF81A2CB8()) || unk_0xA78EA29AC2FFBADE())
	{
