				...
				switch (Global_14453.f_1)
				{
					...
					case 8:
						if ((func_15(2, Global_14421, 0) && iLocal_210 == 0) && iLocal_211 == 0)
						{
							...
							{
								if (unk_0xB03A1684359C50A1(Global_2324, 15))
								{
								}
								func_13();
							}
...
void func_2()
{
	iLocal_25 = unk_0x3EBD6169F986CB7C(0);
	switch (iLocal_25)
	{
		case 0:
			iLocal_24 = 0;
...
void func_3()
{
	...
	iLocal_21 = unk_0xFC87DEABE8F19867();
	iLocal_22 = 0;
	iVar0 = 0;
	while (iLocal_22 < iLocal_21)
	{
		if (unk_0x128145C59B2D1B7D(iLocal_22))
		{
...
void func_8()
{
	if (iLocal_210 == 0 && iLocal_211 == 1)
	{
		...
		unk_0xA4EB4F11347C8C00(Local_207, 0);
	}
}
...
void func_13()
{
	if (iLocal_210 == 0)
	{
		unk_0x7EE34484BCDD0236(&Local_207, 0);
...
void func_22()
{
	...
	if (Global_14431 == 0)
	{
		...
		{
			unk_0x62148293B793073B(&Global_2324, 15);
			func_24();
			Global_14431 = 1;
			unk_0x76F4FB5EFF5BDED5(Global_14434, "GET_CURRENT_SELECTION");
			uLocal_20 = unk_0xA2A6B56DFF85AF55();
			while (!unk_0xD3DD1071A6494834(uLocal_20))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			iVar0 = unk_0x8B770DAB6473F83C(uLocal_20);
			if (iVar0 > -1)
			{
...
void func_26()
{
	if ((unk_0x35D499EE14C3D367() || unk_0x929A0C5D6A986B4F()) || unk_0xC339C5C5B5E8BC5B())
	{
