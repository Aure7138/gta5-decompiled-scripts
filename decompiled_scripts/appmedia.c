				...
				switch (Global_14413.f_1)
				{
					...
					case 8:
						if ((func_15(2, Global_14381, 0) && iLocal_210 == 0) && iLocal_211 == 0)
						{
							...
							{
								if (unk_0xF426A5DE932B3BEE(Global_2284, 15))
								{
								}
								func_13();
							}
...
void func_2()
{
	iLocal_25 = unk_0xFF662659EC43EA0F(0);
	switch (iLocal_25)
	{
		case 0:
			iLocal_24 = 0;
...
void func_3()
{
	...
	iLocal_21 = unk_0x0C98249A500C8075();
	iLocal_22 = 0;
	iVar0 = 0;
	while (iLocal_22 < iLocal_21)
	{
		if (unk_0x15B76AE030C97E34(iLocal_22))
		{
...
void func_8()
{
	if (iLocal_210 == 0 && iLocal_211 == 1)
	{
		...
		unk_0xDC418668FD6E119F(Local_207, 0);
	}
}
...
void func_13()
{
	if (iLocal_210 == 0)
	{
		unk_0x44F7B7539CCA859F(&Local_207, 0);
...
void func_22()
{
	...
	if (Global_14391 == 0)
	{
		...
		{
			unk_0xF17F4B0641AB2DE1(&Global_2284, 15);
			func_24();
			Global_14391 = 1;
			unk_0x8CED8F78CC31BEF2(Global_14394, "GET_CURRENT_SELECTION");
			uLocal_20 = unk_0xEF0E4A8ABAA0D524();
			while (!unk_0x20B35B8C39C5787D(uLocal_20))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			iVar0 = unk_0x200C167A17C879D9(uLocal_20);
			if (iVar0 > -1)
			{
...
void func_26()
{
	if ((unk_0xE060CF72D1CA5C87() || unk_0xD0333FE560420AC5()) || unk_0xDFCB321F1D24137F())
	{
