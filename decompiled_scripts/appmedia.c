				...
				switch (Global_14394.f_1)
				{
					...
					case 8:
						if ((func_15(2, Global_14362, 0) && iLocal_209 == 0) && iLocal_210 == 0)
						{
							...
							{
								if (unk_0x889D01384B54BCE3(Global_2265, 15))
								{
								}
								func_13();
							}
...
void func_2()
{
	iLocal_24 = unk_0xD6BB66A9984406B7(0);
	switch (iLocal_24)
	{
		case 0:
			iLocal_23 = 0;
...
void func_3()
{
	...
	iLocal_20 = unk_0xF33D198852151281();
	iLocal_21 = 0;
	iVar0 = 0;
	while (iLocal_21 < iLocal_20)
	{
		if (unk_0x4F4D08A6BE5CB3B7(iLocal_21))
		{
...
void func_8()
{
	if (iLocal_209 == 0 && iLocal_210 == 1)
	{
		...
		unk_0x3F65562A61D88419(Local_206, 0);
	}
}
...
void func_13()
{
	if (iLocal_209 == 0)
	{
		unk_0x6B7EB76FEC248DEE(&Local_206, 0);
...
void func_22()
{
	...
	if (Global_14372 == 0)
	{
		...
		{
			unk_0x29DB79DD4D939B38(&Global_2265, 15);
			func_24();
			Global_14372 = 1;
			unk_0xB067107D878E9585(Global_14375, "GET_CURRENT_SELECTION");
			uLocal_19 = unk_0x8CB1A9AD2F4E2E1D();
			while (!unk_0x5AF0E0DBD9FA7F23(uLocal_19))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			iVar0 = unk_0x70F7DBBE883019A5(uLocal_19);
			if (iVar0 > -1)
			{
...
void func_26()
{
	if ((unk_0xD5560895105F1405() || unk_0x9F979F481F18EB48()) || unk_0xF6BAF9F0C2863FFE())
	{
