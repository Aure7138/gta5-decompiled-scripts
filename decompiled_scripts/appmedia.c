				...
				switch (Global_14413.f_1)
				{
					...
					case 8:
						if ((func_15(2, Global_14381, 0) && iLocal_210 == 0) && iLocal_211 == 0)
						{
							...
							{
								if (unk_0x7DA173D4FD42F36B(Global_2284, 15))
								{
								}
								func_13();
							}
...
void func_2()
{
	iLocal_25 = unk_0xEFA557B99344B2EA(0);
	switch (iLocal_25)
	{
		case 0:
			iLocal_24 = 0;
...
void func_3()
{
	...
	iLocal_21 = unk_0xE90035C3FD3D0138();
	iLocal_22 = 0;
	iVar0 = 0;
	while (iLocal_22 < iLocal_21)
	{
		if (unk_0x0D545E201B2C59E4(iLocal_22))
		{
...
void func_8()
{
	if (iLocal_210 == 0 && iLocal_211 == 1)
	{
		...
		unk_0x5D91686F1BB4AF00(Local_207, 0);
	}
}
...
void func_13()
{
	if (iLocal_210 == 0)
	{
		unk_0x817D16DCD3E71305(&Local_207, 0);
...
void func_22()
{
	...
	if (Global_14391 == 0)
	{
		...
		{
			unk_0x99BCB15F954AF579(&Global_2284, 15);
			func_24();
			Global_14391 = 1;
			unk_0x2B859AD680983623(Global_14394, "GET_CURRENT_SELECTION");
			uLocal_20 = unk_0x501E08A637882750();
			while (!unk_0xEC0EC22A8A43C76E(uLocal_20))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			iVar0 = unk_0xFD3CF387C866C665(uLocal_20);
			if (iVar0 > -1)
			{
...
void func_26()
{
	if ((unk_0x438D260E2A787A5B() || unk_0xB6FEE919E18FF45B()) || unk_0x55812CD5A331E1F8())
	{
		unk_0x39ABC5AF5A067B7F();
		if (unk_0xA677004DC118A7F4(0))
		{
			iLocal_24 = 1;
		}
		else
