...
void __EntryFunction__()
{
	...
	{
		if (!unk_0xCFC04A38F256EE06(iLocal_53))
		{
			if (unk_0xE466FA8E4B1B261F(iLocal_53))
			{
				unk_0x334BA4D16EF01A42(iLocal_53);
			}
		}
		func_206();
	}
	...
	while (true)
	{
		...
		if (unk_0x920167EE0888FA4E() || iLocal_131)
		{
			if (!func_160())
			{
				if (func_159())
			...
			unk_0xDEC471C6A5373AC4("RE_BU", 0);
			switch (iLocal_48)
			{
				case 0:
					if (func_147())
				...
				case 1:
					if (unk_0x7868479D9B6694C0(unk_0xE0BDAFA1A39552D6()))
					{
						...
						switch (iLocal_49)
						{
							...
							case 1:
								if ((!func_127(iLocal_54[0], &iLocal_128, &uLocal_127, iLocal_126, iLocal_129, 7f, 0) && !func_127(iLocal_54[1], &iLocal_128, &uLocal_127, iLocal_126, iLocal_129, 7f, 0)) && !func_126())
								{
									switch (iLocal_50)
									{
										case 0:
											func_125();
											if (unk_0x8853522CEFF93BE9(unk_0x06736567F820A39E(), Local_78, 50f, 35f, 50f, 0, 1, 0))
											{
												func_124();
											}
											if (unk_0x8853522CEFF93BE9(unk_0x06736567F820A39E(), Local_78, 80f, 65f, 50f, 0, 1, 0))
											{
												func_123();
											}
											if (!unk_0xBDA1F5E8A36BFA07(iLocal_58, 0))
											{
												if (unk_0x923F1BB1676259BF(unk_0x06736567F820A39E(), 281.9148f, 6816.345f, 4.3197f, 48.3924f, 6885.921f, 43.0037f, 226.5f, 0, 1, 0) || unk_0x8853522CEFF93BE9(unk_0x06736567F820A39E(), Local_88 - Vector(0f, 0f, 7f), 20f, 15f, 50f, 0, 1, 0))
												{
													func_122();
													if (unk_0xCDB4C4200A9B478A(uLocal_114))
													{
														unk_0xF9737DB27C84BFEE(uLocal_114, 0);
													}
													iLocal_64 = 0;
													while (iLocal_64 <= 1)
													{
														if (unk_0xCDB4C4200A9B478A(uLocal_111[iLocal_64]))
														{
															unk_0xF9737DB27C84BFEE(uLocal_111[iLocal_64], 0);
														}
														iLocal_64++;
													}
													if (!func_160())
							...
							case 2:
								if ((func_127(iLocal_54[0], &iLocal_128, &uLocal_127, iLocal_126, iLocal_129, 7f, 0) || func_127(iLocal_54[1], &iLocal_128, &uLocal_127, iLocal_126, iLocal_129, 7f, 0)) || iLocal_129)
								{
									...
									if (unk_0xCDB4C4200A9B478A(uLocal_114))
									{
										unk_0xF9737DB27C84BFEE(uLocal_114, 1);
									}
									iLocal_64 = 0;
									while (iLocal_64 <= 1)
									{
										if (unk_0xCDB4C4200A9B478A(uLocal_111[iLocal_64]))
										{
											unk_0xF9737DB27C84BFEE(uLocal_111[iLocal_64], 1);
										}
										iLocal_64++;
									}
									switch (iLocal_128)
								...
								if (func_126())
								{
									...
									if (!func_111())
									{
										switch (iLocal_51)
										{
											...
											case 5:
												func_104();
												unk_0x4EDE34FBADD967A6(0);
												if (!unk_0xCFC04A38F256EE06(iLocal_54[0]))
												{
													func_102(iLocal_54[0], "GENERIC_WAR_CRY", 24);
												}
												else if (!unk_0xCFC04A38F256EE06(iLocal_54[1]))
												{
									...
									else
									{
										...
										{
											if (!unk_0xCFC04A38F256EE06(iLocal_54[iVar0]))
											{
												unk_0x98C667DDCB5A9B2E(iLocal_54[iVar0], 5, 0, 0);
												unk_0xFEDD46326A41DB46(iLocal_54[iVar0], unk_0x06736567F820A39E(), 1000f, -1, 0, 0);
												unk_0x97C5D2BB8E47131D(iLocal_54[iVar0], 1);
												if (unk_0xC1EDB61CE0A4B94E(iLocal_60))
												{
													if (unk_0xBC572626B3578AD2(iLocal_60))
													{
														unk_0xD02CD3284DDA0268(iLocal_60, 1, 1);
													}
												}
												if (unk_0xCDB4C4200A9B478A(uLocal_111[iVar0]))
												{
													unk_0x2239ED27B231AE2E(&(uLocal_111[iVar0]));
												}
											}
											iVar0++;
										}
							...
							case 4:
								func_85();
								if (!unk_0x8853522CEFF93BE9(unk_0x06736567F820A39E(), Local_107, 100f, 100f, 100f, 1, 1, 0))
								{
									unk_0x71543B3C24188223(1f);
									if (unk_0xC1EDB61CE0A4B94E(iLocal_54[0]) && unk_0xC1EDB61CE0A4B94E(iLocal_54[1]))
									{
										unk_0x5318F6C4C2B82FA7(&(iLocal_54[0]));
										unk_0x5318F6C4C2B82FA7(&(iLocal_54[1]));
									}
								}
								if (!unk_0xC1EDB61CE0A4B94E(iLocal_57))
								{
									if (unk_0x8853522CEFF93BE9(unk_0x06736567F820A39E(), Local_139, 200f, 200f, 200f, 1, 1, 0))
									{
										unk_0xBECC89ACB4E5D4ED(joaat("s_m_m_highsec_01"));
										unk_0xBECC89ACB4E5D4ED(joaat("granger"));
										if (unk_0x5C9FE32E2FF37989(joaat("s_m_m_highsec_01")) && unk_0x5C9FE32E2FF37989(joaat("granger")))
										{
											iLocal_59 = unk_0x75409DE1FC985A9D(joaat("granger"), -1155.043f, 942.9685f, 197.4921f, 161.1247f, 1, 1);
											unk_0x86A805FC25766987(iLocal_59, 200);
											unk_0x2701EC5EF026B004(iLocal_59, 1.5f);
											iLocal_57 = unk_0x064835636E49C34D(iLocal_59, 26, joaat("s_m_m_highsec_01"), -1, 1, 1);
											unk_0x47222A663B914109(iLocal_57, 0, 0, 2, 0);
											unk_0x47222A663B914109(iLocal_57, 3, 0, 0, 0);
											unk_0x47222A663B914109(iLocal_57, 4, 0, 0, 0);
											unk_0xF0683EF788D4342B(iLocal_57, joaat("weapon_pistol"), -1, 1, 1);
											unk_0xDEA5F99894469373(iLocal_57, iLocal_177);
										}
									}
								}
								if (!unk_0xCFC04A38F256EE06(iLocal_53))
								{
									...
									if (unk_0x8853522CEFF93BE9(unk_0x06736567F820A39E(), Local_139, Global_22, 1, 1, 0) && unk_0x53B456945AE5C7DE(iLocal_53, unk_0x06736567F820A39E(), 10f, 10f, 10f, 0, 1, 0))
									{
										if (unk_0xE466FA8E4B1B261F(iLocal_53))
										{
											if (unk_0xCDB4C4200A9B478A(uLocal_137))
											{
												unk_0x2239ED27B231AE2E(&uLocal_137);
											}
											if (unk_0xCDB4C4200A9B478A(uLocal_138))
											{
												unk_0x2239ED27B231AE2E(&uLocal_138);
											}
											if (func_69())
											{
												iLocal_49 = 5;
							...
							case 7:
								...
								if (unk_0xC1EDB61CE0A4B94E(iLocal_60))
								{
									if (unk_0xBC572626B3578AD2(iLocal_60))
									{
										if (!unk_0xCFC04A38F256EE06(iLocal_54[0]))
										{
											if (unk_0x46E9388908C80483(iLocal_54[0], "random@burial", "a_burial_stop", 3))
											{
												if (unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial_stop") > 0.355f)
												{
													unk_0xD02CD3284DDA0268(iLocal_60, 1, 1);
												}
											}
								...
								if (unk_0xCFC04A38F256EE06(iLocal_54[0]) || unk_0xCFC04A38F256EE06(iLocal_54[1]))
								{
									bLocal_147 = true;
								}
								if (bLocal_147)
								{
									if (unk_0x1B6292EA51632C25(iLocal_58, 0))
									{
										if (!unk_0xCFC04A38F256EE06(iLocal_54[0]))
										{
											unk_0x1C06AE946D877DF1(iLocal_54[0]);
											if (unk_0xE53003D20DBC318E(iLocal_54[0], iLocal_58, -1, 0, 0) || unk_0xE53003D20DBC318E(iLocal_54[0], iLocal_58, 0, 0, 0))
											{
												if (!iLocal_164)
												{
													unk_0x1F6717C33A02B7AC(iLocal_54[0]);
													if (unk_0xC1EDB61CE0A4B94E(iLocal_60))
													{
														if (unk_0xBC572626B3578AD2(iLocal_60))
														{
													...
													unk_0xD6763C9F81772BAE(&uLocal_65);
													unk_0x9A12E803B1184012(0);
													unk_0x74E71CEAB0E72F73(0, unk_0xF42E2289B33D5C38(iLocal_58, -0.5f, 0.5f, 0f), unk_0x06736567F820A39E(), 3f, 1, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
													unk_0xEA61E9C6B1D4A33E(0, iLocal_58, -1, -1, 3f, 9, 0);
													unk_0x480BD8426B2323B0(0, iLocal_58, unk_0x06736567F820A39E(), 8, 30f, 262144, -1f, 10f, 1);
													unk_0x6F275D9063DAF754(uLocal_65);
													unk_0x457C4844450FF70E(iLocal_54[0], uLocal_65);
													unk_0xDD1A4EE55D86FE71(&uLocal_65);
													unk_0x97C5D2BB8E47131D(iLocal_54[0], 1);
													unk_0xB7768D1080F53979(iLocal_58, 1);
													iLocal_164 = 1;
												}
												else if (unk_0xFB900D9EE2ACC400(iLocal_54[0], 242628503) == 1)
												{
													if (unk_0x3671D4C049138ACF(iLocal_54[0]) == 3)
													{
														if (!unk_0x53B456945AE5C7DE(iLocal_54[0], unk_0x06736567F820A39E(), 10f, 10f, 10f, 0, 1, 0) && !unk_0x8853522CEFF93BE9(iLocal_54[0], Local_88, 10f, 10f, 10f, 0, 1, 0))
														{
															unk_0x5318F6C4C2B82FA7(&(iLocal_54[0]));
														}
													}
											...
											{
												unk_0xFB9941AAF643A23C(iLocal_54[0], unk_0x06736567F820A39E(), 0, 16);
												unk_0x97C5D2BB8E47131D(iLocal_54[0], 1);
											}
										}
										if (!unk_0xCFC04A38F256EE06(iLocal_54[1]))
										{
											unk_0x1C06AE946D877DF1(iLocal_54[1]);
											if (unk_0xE53003D20DBC318E(iLocal_54[1], iLocal_58, -1, 0, 0) || unk_0xE53003D20DBC318E(iLocal_54[1], iLocal_58, 0, 0, 0))
											{
												if (!iLocal_164)
												{
													unk_0x1F6717C33A02B7AC(iLocal_54[1]);
													unk_0xD6763C9F81772BAE(&uLocal_65);
													unk_0x9A12E803B1184012(0);
													unk_0x74E71CEAB0E72F73(0, unk_0xF42E2289B33D5C38(iLocal_58, -0.5f, 0.5f, 0f), unk_0x06736567F820A39E(), 3f, 1, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
													unk_0xEA61E9C6B1D4A33E(0, iLocal_58, -1, -1, 3f, 9, 0);
													unk_0x480BD8426B2323B0(0, iLocal_58, unk_0x06736567F820A39E(), 8, 30f, 262144, -1f, 10f, 1);
													unk_0x6F275D9063DAF754(uLocal_65);
													unk_0x457C4844450FF70E(iLocal_54[1], uLocal_65);
													unk_0xDD1A4EE55D86FE71(&uLocal_65);
													unk_0x97C5D2BB8E47131D(iLocal_54[1], 1);
													unk_0xB7768D1080F53979(iLocal_58, 1);
													iLocal_164 = 1;
												}
												else if (unk_0xFB900D9EE2ACC400(iLocal_54[1], 242628503) == 1)
												{
													if (unk_0x3671D4C049138ACF(iLocal_54[1]) == 3)
													{
														if (!unk_0x53B456945AE5C7DE(iLocal_54[1], unk_0x06736567F820A39E(), 10f, 10f, 10f, 0, 1, 0) && !unk_0x8853522CEFF93BE9(iLocal_54[1], Local_88, 10f, 10f, 10f, 0, 1, 0))
														{
															unk_0x5318F6C4C2B82FA7(&(iLocal_54[1]));
														}
													}
											...
											{
												unk_0xFB9941AAF643A23C(iLocal_54[1], unk_0x06736567F820A39E(), 0, 16);
												unk_0x97C5D2BB8E47131D(iLocal_54[1], 1);
											}
										}
									}
						...
						if ((func_10() && !func_9()) && iLocal_49 != 9)
						{
							if (!unk_0xCFC04A38F256EE06(iLocal_53))
							{
								if (unk_0x8853522CEFF93BE9(iLocal_53, Local_142, 5f, 5f, 5f, 0, 1, 0))
								{
									func_8(0);
									unk_0x4EDE34FBADD967A6(0);
									func_104();
						...
						if (func_6())
						{
							if (unk_0xC1EDB61CE0A4B94E(iLocal_53))
							{
								unk_0xDAF1451794AD09A3(&iLocal_53);
							}
							func_13();
						}
						if (func_5())
						...
						if (iLocal_49 != 3)
						{
							if (func_1())
							{
								unk_0x25B97FB8615971D6("RE6_BOTH_DEAD");
								if (!iLocal_74)
								{
									unk_0xC1B1E9A034A63A62(0);
									iLocal_106 = unk_0x1ADBAAC322D61F73() + 8500;
									iLocal_74 = 1;
								}
								if (!unk_0xCFC04A38F256EE06(iLocal_53))
								{
									if (unk_0x53B456945AE5C7DE(unk_0x06736567F820A39E(), iLocal_53, 20f, 20f, 20f, 0, 1, 1))
									{
						...
						if (((iLocal_49 == 1 || iLocal_49 == 2) || iLocal_49 == 3) || iLocal_49 == 7)
						{
							if (!unk_0xCFC04A38F256EE06(iLocal_53))
							{
								if (!bLocal_130)
								{
									if (unk_0xFB900D9EE2ACC400(iLocal_53, 1785177548) != 1 && unk_0xFB900D9EE2ACC400(iLocal_53, 1785177548) != 0)
									{
										unk_0x66F20C27DFBDFC38(iLocal_53);
										uLocal_343 = unk_0x70D62E1C98FBC411(Local_78, -2f, -4f, 18f, 2);
										unk_0x13F17EF7A260536D(iLocal_53, uLocal_343, "random@burial", "b_burial", 1000f, -4f, 1, 24592, 1148846080, 0);
										unk_0xD7C7DFD321D78CCA(uLocal_61[0], uLocal_343, "b_burial_legstie", "random@burial", 4f, -4f, 0, 1148846080);
										unk_0xD7C7DFD321D78CCA(uLocal_61[1], uLocal_343, "b_burial_wristtie", "random@burial", 4f, -4f, 0, 1148846080);
										unk_0x58E3D20EAF3A6C20(uLocal_343, 1);
										unk_0x97C5D2BB8E47131D(iLocal_53, 1);
									}
									if (unk_0x64B7FCF50C031E4A(iLocal_53))
									{
										unk_0x5254774EE203F179(iLocal_53, 1);
										unk_0xFEF8CFEA6F9035A4(iLocal_53, 1);
										unk_0xEC337F42DFBAD859(iLocal_53, 0);
									}
								}
								if ((unk_0x742804C434C92427(iLocal_53) || unk_0xCCC1EF74C8029770(iLocal_53)) || (iLocal_125 - unk_0x6267527E254067CA(iLocal_53)) >= 50)
								{
									unk_0x5254774EE203F179(iLocal_53, 1);
									unk_0xFEF8CFEA6F9035A4(iLocal_53, 1);
									unk_0xEC337F42DFBAD859(iLocal_53, 0);
								}
								if (unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 0) && !unk_0xBDA1F5E8A36BFA07(unk_0x34E1EF1E8BCD1BFC(unk_0x06736567F820A39E(), 0), 0))
								{
									if (unk_0x137B8B7A1CAD742A(unk_0x34E1EF1E8BCD1BFC(unk_0x06736567F820A39E(), 0)) < 5f)
									{
									}
									else if (unk_0x0280B42925DCFDEC(unk_0x34E1EF1E8BCD1BFC(unk_0x06736567F820A39E(), 0), iLocal_53))
									{
										unk_0x5254774EE203F179(iLocal_53, 1);
										unk_0xFEF8CFEA6F9035A4(iLocal_53, 1);
										unk_0xEC337F42DFBAD859(iLocal_53, 0);
								...
								if (!unk_0xBDA1F5E8A36BFA07(iLocal_58, 0))
								{
									if (unk_0x0280B42925DCFDEC(iLocal_58, iLocal_53))
									{
										unk_0x5254774EE203F179(iLocal_53, 1);
										unk_0xFEF8CFEA6F9035A4(iLocal_53, 1);
										unk_0xEC337F42DFBAD859(iLocal_53, 0);
...
int func_1()
{
	if (!bLocal_130)
	{
		...
		if (unk_0xC1EDB61CE0A4B94E(iLocal_54[0]) && unk_0xC1EDB61CE0A4B94E(iLocal_54[1]))
		{
			...
			if (unk_0x2ACAB29B00BD0D8A(iLocal_54[0]) && unk_0x2ACAB29B00BD0D8A(iLocal_54[1]))
			{
				return 1;
			}
		}
		...
		if (unk_0xC1EDB61CE0A4B94E(iLocal_54[1]) && !unk_0xC1EDB61CE0A4B94E(iLocal_54[0]))
		{
			if (unk_0xCFC04A38F256EE06(iLocal_54[1]))
			{
				return 1;
...
void func_2()
{
	if (unk_0xCFC04A38F256EE06(iLocal_54[0]))
	{
		if (unk_0xCDB4C4200A9B478A(uLocal_111[0]))
		{
			if (unk_0xC1EDB61CE0A4B94E(iLocal_60))
			{
				if (unk_0xBC572626B3578AD2(iLocal_60))
			...
			func_3(&uLocal_178, 4);
			unk_0x2239ED27B231AE2E(&(uLocal_111[0]));
		}
	}
	if (unk_0xCFC04A38F256EE06(iLocal_54[1]))
	{
		if (unk_0xCDB4C4200A9B478A(uLocal_111[1]))
		{
			func_3(&uLocal_178, 3);
			unk_0x2239ED27B231AE2E(&(uLocal_111[1]));
		}
	}
	if (unk_0xCFC04A38F256EE06(iLocal_53))
	{
		if (!unk_0xBDA1F5E8A36BFA07(iLocal_53, 0))
		{
		}
		if (unk_0xCDB4C4200A9B478A(uLocal_114))
		{
			func_3(&uLocal_178, 5);
			unk_0x2239ED27B231AE2E(&uLocal_114);
		}
	}
}
...
void func_4()
{
	unk_0x25B97FB8615971D6("RE6_END");
	func_206();
}
	...
	if (!unk_0xCFC04A38F256EE06(iLocal_53))
	{
		if (!unk_0xCFC04A38F256EE06(iLocal_54[0]) || !unk_0xCFC04A38F256EE06(iLocal_54[1]))
		{
			if (!func_12())
			{
				...
				{
					case 0:
						if (iLocal_106 < unk_0x1ADBAAC322D61F73())
						{
							if (func_70(&uLocal_178, "REBU2AU", "REBU2_ATT", 4, 0, 0, 0))
							{
								iLocal_106 = (unk_0x1ADBAAC322D61F73() + unk_0xA6055C735E3DD877(3500, 5000));
								iLocal_168++;
							}
						}
						break;
...
void func_19()
{
	...
	{
		func_21(13, unk_0xF34EE736CF047844(Global_101186.f_8960.f_3853));
	}
	if (!unk_0xD67AADBB828CC3BE())
	{
		if (!Global_69521)
		{
			if (func_20() == 2 == 0 && !unk_0x17CC0D5008835470())
			{
...
void func_31()
{
	...
	{
		if (func_35(Global_101186.f_1902.f_539.f_3549) != unk_0x79469DA5833EACA8(unk_0x06736567F820A39E()))
		{
			iVar0 = func_34(unk_0x06736567F820A39E());
			if (func_33(iVar0) && (!func_32(14) || Global_100138))
			{
				if (Global_101186.f_1902.f_539.f_3549 != iVar0 && func_33(Global_101186.f_1902.f_539.f_3549))
				{
...
void func_46()
{
	...
	{
		case 0:
			if (!unk_0xCFC04A38F256EE06(iLocal_53) && unk_0x1B6292EA51632C25(iLocal_59, 0))
			{
				if (unk_0xE466FA8E4B1B261F(iLocal_53))
				{
					unk_0x334BA4D16EF01A42(iLocal_53);
				}
				unk_0xBA63517ADBC1E5E3(iLocal_53, 0);
				unk_0xA26A1133034ECD59(iLocal_53, 1);
				unk_0xD6763C9F81772BAE(&uLocal_65);
				unk_0x3195125C126B79C6(0, unk_0x06736567F820A39E(), 5000, 2048, 2);
				unk_0x608A9ECA218C4D24(0, unk_0x06736567F820A39E(), 0);
				unk_0xEA61E9C6B1D4A33E(0, iLocal_59, -1, 0, 1f, 1, 0);
				unk_0x6F275D9063DAF754(uLocal_65);
				unk_0x457C4844450FF70E(iLocal_53, uLocal_65);
				unk_0xDD1A4EE55D86FE71(&uLocal_65);
				unk_0x97C5D2BB8E47131D(iLocal_53, 1);
				func_104();
				unk_0x4EDE34FBADD967A6(0);
		...
		case 1:
			if (unk_0x1B6292EA51632C25(iLocal_59, 0))
			{
				if (unk_0x93E49C491856D7AD(iLocal_53, iLocal_59, 0))
				{
					if (!unk_0xCFC04A38F256EE06(iLocal_57))
					{
						unk_0x2AF5979C8A445B16(iLocal_57, iLocal_58, 10f, 786599);
						unk_0x97C5D2BB8E47131D(iLocal_57, 1);
					}
					unk_0xB7768D1080F53979(iLocal_59, 1);
					iLocal_136++;
				}
			}
			break;
...
void func_47()
{
	...
	{
		case 0:
			unk_0x054CBFE90FAA6840(255, iLocal_177, joaat("player"));
			unk_0x054CBFE90FAA6840(255, joaat("player"), iLocal_177);
			if (!unk_0xBDA1F5E8A36BFA07(unk_0xF222904387CE4946(), 0))
			{
				unk_0xD5739C1C2A4441D5(unk_0xF222904387CE4946(), 5f, 2, 0);
				if (!unk_0xCFC04A38F256EE06(iLocal_53) && unk_0x1B6292EA51632C25(iLocal_59, 0))
				{
					if (unk_0xE466FA8E4B1B261F(iLocal_53))
					{
		...
		case 1:
			if (unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 0) && !unk_0xC1B8A2E022EFC2C3(unk_0x06736567F820A39E()))
			{
				if (!unk_0xBDA1F5E8A36BFA07(unk_0xF222904387CE4946(), 0))
				{
					if (!unk_0x86B7B352B6FC9D8B(unk_0xF222904387CE4946(), 1))
					{
						if (unk_0xFC47A7E8D708D117(unk_0xF222904387CE4946(), 1) > 0.1f)
						{
							if (func_44() == 0)
							{
		...
		case 2:
			if (unk_0x1B6292EA51632C25(iLocal_59, 0))
			{
				if (unk_0x93E49C491856D7AD(iLocal_53, iLocal_59, 0))
				{
					if (!unk_0xCFC04A38F256EE06(iLocal_57))
					{
						unk_0x2AF5979C8A445B16(iLocal_57, iLocal_59, 10f, 786599);
						unk_0x97C5D2BB8E47131D(iLocal_57, 1);
					}
					unk_0xB7768D1080F53979(iLocal_59, 1);
					iLocal_136++;
...
void func_51()
{
	if (!unk_0xCFC04A38F256EE06(iLocal_53))
	{
		...
		{
			unk_0x3446D2517750B8F3(iLocal_53, 1, 1);
			unk_0x9A12E803B1184012(iLocal_53);
		}
		if (func_55("REBU2_LV2_9") || iLocal_72 > 1)
		{
			unk_0x3446D2517750B8F3(iLocal_53, 0, 1);
		}
	}
	if (func_69() && !func_12())
	{
		...
		switch (iLocal_72)
		{
			...
			case 1:
				iLocal_73 = unk_0x1ADBAAC322D61F73() + 1500;
				iLocal_72++;
				break;
			
			case 2:
				if (iLocal_73 < unk_0x1ADBAAC322D61F73())
				{
			...
			case 4:
				iLocal_73 = unk_0x1ADBAAC322D61F73() + 500;
				iLocal_72++;
				break;
			...
			case 17:
				iLocal_73 = unk_0x1ADBAAC322D61F73() + 1000;
				iLocal_72++;
				break;
			...
			case 19:
				iLocal_73 = unk_0x1ADBAAC322D61F73() + 2500;
				iLocal_72++;
				break;
...
void func_57()
{
	if (!unk_0xCFC04A38F256EE06(iLocal_53))
	{
		if (!iLocal_133)
		{
			if (!unk_0xBDA1F5E8A36BFA07(unk_0xF222904387CE4946(), 0))
			{
				if (!unk_0x93E49C491856D7AD(unk_0x06736567F820A39E(), unk_0xF222904387CE4946(), 1) && unk_0x93E49C491856D7AD(iLocal_53, unk_0xF222904387CE4946(), 0))
				{
		...
		{
			if (unk_0x93E49C491856D7AD(unk_0x06736567F820A39E(), unk_0xF222904387CE4946(), 0) && unk_0x93E49C491856D7AD(iLocal_53, unk_0xF222904387CE4946(), 0))
			{
				iLocal_133 = 0;
			}
		}
	...
	if (!unk_0xCFC04A38F256EE06(iLocal_53))
	{
		if (unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 1))
		{
			if (!func_61())
			{
				...
				if (unk_0xFB900D9EE2ACC400(iLocal_53, 1227113341) != 1 && unk_0xFB900D9EE2ACC400(iLocal_53, 1227113341) != 0)
				{
					unk_0x1C7285D2BF9E26A8(iLocal_53, unk_0x06736567F820A39E(), -1, 6f, 2f, 1073741824, 0);
				}
				if (unk_0x0FDFEC0DD29106EE(iLocal_53, 0))
				{
					unk_0x748A759556B70724(iLocal_53, 0, 4194304);
				}
				if (!iLocal_132)
				{
					func_81(0);
			...
			{
				iLocal_132 = 0;
				if (((unk_0xFB900D9EE2ACC400(iLocal_53, 1227113341) == 1 || unk_0xFB900D9EE2ACC400(iLocal_53, 1227113341) == 0) || unk_0xFB900D9EE2ACC400(iLocal_53, 242628503) == 1) || unk_0xFB900D9EE2ACC400(iLocal_53, 242628503) == 0)
				{
					unk_0x1F6717C33A02B7AC(iLocal_53);
				}
			}
		}
		else if (((!unk_0xE466FA8E4B1B261F(iLocal_53) && !unk_0x0FDFEC0DD29106EE(iLocal_53, 0)) && unk_0xFB900D9EE2ACC400(iLocal_53, 242628503) != 1) && unk_0xFB900D9EE2ACC400(iLocal_53, 242628503) != 0)
		{
			unk_0xF169FEC3395E381D(iLocal_53, func_59());
			unk_0xAD5ACEE958065334(iLocal_53, 1);
			unk_0xC3BAA1D0FDF6A953(iLocal_53, 0);
		}
	}
}
...
int func_61()
{
	if (unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 0))
	{
		...
		{
			if (((((!unk_0xC32E6148FEFD72AD(unk_0x06736567F820A39E()) && !unk_0x06071C128D7E648A(unk_0x06736567F820A39E())) && !unk_0xB2EE69B49C21F2E0(unk_0x06736567F820A39E())) && !unk_0xF090AA685D55F909(unk_0x06736567F820A39E())) && !unk_0xFA48CB2FC7937FC0(unk_0x06736567F820A39E())) && !unk_0x3A4EADE60DE32F9E(unk_0x06736567F820A39E(), joaat("rhino")))
			{
				if (unk_0xD6B335B6F8116876(unk_0x34E1EF1E8BCD1BFC(unk_0x06736567F820A39E(), 0)) >= 1)
				{
					return 1;
	...
	else if (unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 1))
	{
		...
		{
			if ((((!unk_0xEF439FAE899F725F(unk_0x79469DA5833EACA8(unk_0xE8F1FE9FB29EB9CC(unk_0x06736567F820A39E()))) && !unk_0x759D601DDE232B39(unk_0x79469DA5833EACA8(unk_0xE8F1FE9FB29EB9CC(unk_0x06736567F820A39E())))) && !unk_0xE39DC239584B3B40(unk_0x79469DA5833EACA8(unk_0xE8F1FE9FB29EB9CC(unk_0x06736567F820A39E())))) && !unk_0xA53F8F2582952B82(unk_0x79469DA5833EACA8(unk_0xE8F1FE9FB29EB9CC(unk_0x06736567F820A39E())))) && unk_0x79469DA5833EACA8(unk_0xE8F1FE9FB29EB9CC(unk_0x06736567F820A39E())) != joaat("rhino"))
			{
				return 1;
			}
		}
...
void func_62()
{
	if (!unk_0xCFC04A38F256EE06(iLocal_53))
	{
		if (unk_0x59AD7FDEE8F9BAED(iLocal_53))
		{
			if (!iLocal_170)
			{
			...
			{
				iLocal_172 = unk_0x1ADBAAC322D61F73();
			}
		}
		else
		{
	...
	if ((iLocal_172 - iLocal_171) > 180000)
	{
		if (!unk_0xCFC04A38F256EE06(iLocal_53))
		{
			...
			{
				unk_0x334BA4D16EF01A42(iLocal_53);
				if (unk_0x8853522CEFF93BE9(iLocal_53, Local_139, 100f, 100f, 100f, 0, 1, 0))
				{
					unk_0xDCA5DDD55544BA21(iLocal_53, 1740.797f, 4648.756f, 42.6529f, 1f, -1, 1048576000, 0, 1193033728);
					unk_0x97C5D2BB8E47131D(iLocal_53, 1);
				}
				func_104();
				unk_0x4EDE34FBADD967A6(0);
...
void func_63()
{
	if (unk_0xFA5F9090FC25138E(unk_0x06736567F820A39E()))
	{
		...
		{
			iLocal_175 = unk_0x1ADBAAC322D61F73();
		}
	}
	else
	{
	...
	if ((iLocal_175 - iLocal_174) > 120000)
	{
		if (!unk_0xCFC04A38F256EE06(iLocal_53))
		{
			if (unk_0xE466FA8E4B1B261F(iLocal_53))
			{
				...
				if (unk_0x8853522CEFF93BE9(iLocal_53, Local_139, 100f, 100f, 100f, 0, 1, 0))
				{
					unk_0xDCA5DDD55544BA21(iLocal_53, Local_139, 1f, -1, 1048576000, 0, 1193033728);
					unk_0x97C5D2BB8E47131D(iLocal_53, 1);
				}
				else
				{
...
void func_64()
{
	if (!unk_0xCFC04A38F256EE06(iLocal_53))
	{
		if (unk_0x53B456945AE5C7DE(unk_0x06736567F820A39E(), iLocal_53, 8f, 8f, 8f, 0, 1, 0) || unk_0x0DDB00645FCAA0FB(unk_0x06736567F820A39E()))
		{
			if ((unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 0) && !unk_0x93E49C491856D7AD(iLocal_53, unk_0x34E1EF1E8BCD1BFC(unk_0x06736567F820A39E(), 0), 0)) && !unk_0x0DDB00645FCAA0FB(unk_0x06736567F820A39E()))
			{
				if (!unk_0xCDB4C4200A9B478A(uLocal_114))
				{
		...
		else if (!unk_0xCDB4C4200A9B478A(uLocal_114))
		{
			uLocal_114 = func_67(iLocal_53, 0, 145);
		}
		if (!unk_0xE466FA8E4B1B261F(iLocal_53))
		{
			if (!unk_0x53B456945AE5C7DE(unk_0x06736567F820A39E(), iLocal_53, 8f, 8f, 8f, 0, 1, 0))
			{
				unk_0x1F6717C33A02B7AC(iLocal_53);
				unk_0xF169FEC3395E381D(iLocal_53, func_59());
				unk_0xAD5ACEE958065334(iLocal_53, 1);
		...
		if (!unk_0x53B456945AE5C7DE(unk_0x06736567F820A39E(), iLocal_53, 150f, 150f, 150f, 0, 1, 0))
		{
			func_4();
		}
	}
...
var func_65(struct<3> Param0, int iParam3)
{
	...
	unk_0xC5B281EF0EBC2AA6(uVar0, func_66(unk_0x17CC0D5008835470(), 1f, 1f));
...
int func_68(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xC5B281EF0EBC2AA6(uVar0, func_66(unk_0x17CC0D5008835470(), 0.7f, 0.7f));
		unk_0xF2B74C6AE979DE74(uVar0, bParam1);
	}
...
int func_69()
{
	if (unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 0))
	{
		iLocal_169 = unk_0x34E1EF1E8BCD1BFC(unk_0x06736567F820A39E(), 0);
		if (unk_0x1B6292EA51632C25(iLocal_169, 0))
		{
			if (!unk_0xCFC04A38F256EE06(iLocal_53))
			{
				if (unk_0x954A6C5EBD942B9E(iLocal_53, iLocal_169))
				{
					return 1;
				}
			}
...
void func_81(bool bParam0)
{
	if (bParam0)
	{
		if (iLocal_149)
		{
			if (!unk_0x226FA58470A21AEF(&Local_156))
			{
...
void func_85()
{
	if (unk_0xC1EDB61CE0A4B94E(iLocal_53))
	{
		if (!unk_0xCFC04A38F256EE06(iLocal_53))
		{
			unk_0xE736C729727B547E(iLocal_53, 394, 1);
		}
		if (unk_0x1D58D319587D567F(iLocal_53, unk_0x06736567F820A39E(), 1))
		{
			if (!unk_0xCFC04A38F256EE06(iLocal_53))
			{
				unk_0xFEDD46326A41DB46(iLocal_53, unk_0x06736567F820A39E(), 150f, -1, 0, 0);
				unk_0x97C5D2BB8E47131D(iLocal_53, 1);
			}
			if (!unk_0xCFC04A38F256EE06(iLocal_57))
			{
				unk_0x054CBFE90FAA6840(5, iLocal_177, joaat("player"));
				unk_0xFB9941AAF643A23C(iLocal_57, unk_0x06736567F820A39E(), 0, 16);
				unk_0x97C5D2BB8E47131D(iLocal_57, 1);
			}
			func_104();
			unk_0x4EDE34FBADD967A6(0);
		...
		if (unk_0xC1EDB61CE0A4B94E(iLocal_57))
		{
			if (unk_0x1D58D319587D567F(iLocal_57, unk_0x06736567F820A39E(), 1))
			{
				if (!unk_0xCFC04A38F256EE06(iLocal_53))
				{
					unk_0xFEDD46326A41DB46(iLocal_53, unk_0x06736567F820A39E(), 150f, -1, 0, 0);
...
void func_86()
{
	...
	if (!unk_0xCFC04A38F256EE06(iLocal_53))
	{
		if ((unk_0x53B456945AE5C7DE(unk_0x06736567F820A39E(), iLocal_53, 1.2f, 1.2f, 5f, 0, 1, 0) && unk_0x59AD7FDEE8F9BAED(unk_0x06736567F820A39E())) && !unk_0x9C4162CAC2B459EC(unk_0x06736567F820A39E()))
		{
			if (func_48(1, 0, 1))
			{
				bLocal_130 = true;
				...
				{
					func_93(1, 1, 1, 0);
					unk_0x4E7DF84FE130E1D6(unk_0xE0BDAFA1A39552D6(), 0, 24);
					...
					if (unk_0xC1EDB61CE0A4B94E(unk_0xF222904387CE4946()))
					{
						...
						if (unk_0x64B7FCF50C031E4A(unk_0xF222904387CE4946()))
						{
							func_92(unk_0xF222904387CE4946());
							unk_0xFC462627D90533FE(unk_0xF222904387CE4946(), 200f);
						}
						if (unk_0x53B456945AE5C7DE(unk_0xF222904387CE4946(), iLocal_53, 5f, 5f, 5f, 0, 1, 0) || unk_0x8853522CEFF93BE9(unk_0xF222904387CE4946(), Local_88, 5f, 5f, 5f, 0, 1, 0))
						{
							unk_0xA9AD2484206C8140(unk_0xF222904387CE4946(), unk_0xF4745590D18D14B8(iLocal_53, 1) - Vector(0f, 3f, 5f), 0, 0, 0, 1);
							if (!unk_0xBDA1F5E8A36BFA07(unk_0xF222904387CE4946(), 0))
							{
					...
					if (unk_0xC1EDB61CE0A4B94E(iLocal_58))
					{
						if (unk_0x64B7FCF50C031E4A(iLocal_58))
						{
							func_92(iLocal_58);
							unk_0xFC462627D90533FE(iLocal_58, 200f);
						}
						if (unk_0x53B456945AE5C7DE(iLocal_58, iLocal_53, 8f, 8f, 8f, 0, 1, 0))
						{
							unk_0xA9AD2484206C8140(iLocal_58, Local_88, 0, 0, 0, 1);
							if (!unk_0xBDA1F5E8A36BFA07(iLocal_58, 0))
							{
								unk_0xCE889B96E78E6DC5(iLocal_58);
							}
						}
					}
					if (!unk_0xCFC04A38F256EE06(iLocal_53))
					{
						iLocal_169 = unk_0xAA1502685413BDDD(unk_0xF4745590D18D14B8(iLocal_53, 1), 5f, 0, 2);
						if (!unk_0xBDA1F5E8A36BFA07(iLocal_169, 0))
						{
							if (unk_0x64B7FCF50C031E4A(iLocal_169))
							{
								func_92(iLocal_169);
								unk_0xFC462627D90533FE(iLocal_169, 200f);
							}
							unk_0xA9AD2484206C8140(iLocal_169, unk_0xF4745590D18D14B8(iLocal_53, 1) + Vector(0f, 5f, 5f), 1, 0, 0, 1);
						}
					}
					unk_0x1D2204CE0D02765E(Local_78, 10f);
					unk_0x0ED9A5787AC4BFC9(Local_78, 10f, 0);
					unk_0x6C4DEE9BDB093DC6(Local_78, 4.5f, 0, 0, 0, 0, 0);
					unk_0xA9AD2484206C8140(iLocal_53, Local_78, 1, 0, 0, 1);
					unk_0xA9AD2484206C8140(unk_0x06736567F820A39E(), Local_78, 1, 0, 0, 1);
					if (!unk_0xCFC04A38F256EE06(iLocal_53))
					{
					}
					iVar0 = 0;
					while (iVar0 < iLocal_54)
					{
						if (unk_0xC1EDB61CE0A4B94E(iLocal_54[iVar0]))
						{
							if (unk_0x8853522CEFF93BE9(iLocal_54[iVar0], unk_0xF4745590D18D14B8(iLocal_53, 0), 1.5f, 1.5f, 1.5f, 0, 1, 0))
							{
								unk_0xDAF1451794AD09A3(&(iLocal_54[iVar0]));
							}
						}
						iVar0++;
					}
					if (!unk_0xCFC04A38F256EE06(iLocal_53))
					{
						uLocal_343 = unk_0x70D62E1C98FBC411(163.449f, 6839.993f, 18.88f, 0f, 0f, 0f, 2);
						uLocal_77 = unk_0x45D67480D6D39C7E("DEFAULT_ANIMATED_CAMERA", 0);
						unk_0x0EE4AE2956B8434F(uLocal_77, uLocal_343, "untie_cam", "random@burial");
						unk_0x66F20C27DFBDFC38(unk_0x06736567F820A39E());
						unk_0xA9AD2484206C8140(unk_0x06736567F820A39E(), 162.6699f, 6839.238f, 18.8314f, 0, 0, 0, 1);
						unk_0xEF32567B3A5047F5(unk_0x06736567F820A39E(), 18.2311f);
						unk_0xEC337F42DFBAD859(iLocal_53, 200);
						unk_0x5254774EE203F179(iLocal_53, 0);
						unk_0xFEF8CFEA6F9035A4(iLocal_53, 0);
						unk_0x66F20C27DFBDFC38(iLocal_53);
						unk_0x13F17EF7A260536D(iLocal_53, uLocal_343, "random@burial", "untie_ped", 1000f, -1000f, 4, 0, 1148846080, 0);
						unk_0xA9FA4149DF18912C(iLocal_53, 0, 0);
						unk_0x13F17EF7A260536D(unk_0x06736567F820A39E(), uLocal_343, "random@burial", "untie_player", 1000f, -1000f, 0, 0, 1148846080, 0);
						unk_0xA9FA4149DF18912C(unk_0x06736567F820A39E(), 0, 0);
						unk_0xD7C7DFD321D78CCA(uLocal_61[0], uLocal_343, "untie_legstie", "random@burial", 1000f, -1000f, 0, 1148846080);
						unk_0xD7C7DFD321D78CCA(uLocal_61[1], uLocal_343, "untie_wristtie", "random@burial", 1000f, -1000f, 0, 1148846080);
						unk_0x78EE57C40B1C74AA(uLocal_77, 1);
						unk_0xA7E1DB47F3F4BCD1(1, 0, 3000, 1, 0, 0);
						iLocal_120 = unk_0x1ADBAAC322D61F73();
						iLocal_115 = 1;
					}
				}
			}
	...
	if (iLocal_115 && !iLocal_117)
	{
		...
		if (unk_0x4958900440DDE4E4(uLocal_343))
		{
			if ((unk_0x3B5FD456D45F2AAE(uLocal_343) > 0.115f && unk_0x3B5FD456D45F2AAE(uLocal_343) < 0.12f) || (unk_0x3B5FD456D45F2AAE(uLocal_343) > 0.355f && unk_0x3B5FD456D45F2AAE(uLocal_343) < 0.36f))
			{
				unk_0x962E604CCA53388F(-1, "ROPE_CUT", "ROPE_CUT_SOUNDSET", 1);
			}
			if (unk_0x3B5FD456D45F2AAE(uLocal_343) > 0.6f)
			{
				if (!iLocal_116)
				{
					func_104();
		...
		if (((iLocal_119 - iLocal_120) > 9700 && !iLocal_123) && unk_0x8DC3C8E197F6A40D() == 4)
		{
	...
	if (iLocal_117 && !bLocal_122)
	{
		...
		unk_0x963D11E545E699A3(uLocal_343, 1f);
		unk_0x66F20C27DFBDFC38(unk_0x06736567F820A39E());
		unk_0xA9FA4149DF18912C(unk_0x06736567F820A39E(), 0, 0);
		unk_0xA9AD2484206C8140(unk_0x06736567F820A39E(), 162.5284f, 6839.658f, 18.8198f, 1, 0, 0, 1);
		unk_0xEF32567B3A5047F5(unk_0x06736567F820A39E(), 256.7693f);
		if (!unk_0xCFC04A38F256EE06(iLocal_53))
		{
			unk_0x66F20C27DFBDFC38(iLocal_53);
			unk_0xA9FA4149DF18912C(iLocal_53, 0, 0);
			unk_0x7F075F9DEA8FE763(iLocal_53, 1);
			unk_0xA9AD2484206C8140(iLocal_53, 164.4963f, 6839.333f, 18.9657f, 1, 0, 0, 1);
			unk_0xEF32567B3A5047F5(iLocal_53, 73.449f);
		}
		unk_0x086A554C80BC6C5D(26.1578f);
		unk_0xA71476EEBE45FF73(-8.1198f, 1065353216);
		unk_0x78EE57C40B1C74AA(uLocal_77, 0);
		unk_0xA7E1DB47F3F4BCD1(0, 0, 3000, 1, 0, 0);
		unk_0xC2F547D33F9342CC(uLocal_77, 0);
		...
		if (bLocal_122)
		{
			if (!iLocal_121)
			{
				if (!func_12())
				{
					...
					unk_0x054CBFE90FAA6840(1, iLocal_177, joaat("player"));
					unk_0x054CBFE90FAA6840(1, joaat("player"), iLocal_177);
					unk_0xD6763C9F81772BAE(&uLocal_65);
					...
					{
						if (unk_0x53B456945AE5C7DE(iLocal_53, unk_0xF222904387CE4946(), 20f, 20f, 20f, 0, 1, 0) && unk_0xD6B335B6F8116876(unk_0xF222904387CE4946()) > 0)
						{
							unk_0xEA61E9C6B1D4A33E(0, unk_0xF222904387CE4946(), -1, 0, 1f, 1, 0);
						}
						else if (!unk_0xE466FA8E4B1B261F(iLocal_53))
						{
							unk_0xF169FEC3395E381D(iLocal_53, func_59());
							unk_0xAD5ACEE958065334(iLocal_53, 1);
							unk_0xC3BAA1D0FDF6A953(iLocal_53, 0);
					...
					if (func_44() == 2 && !func_9())
					{
						if (!unk_0xCDB4C4200A9B478A(uLocal_138))
						{
							...
							unk_0x3A46FF82408A2709(uLocal_138, 269);
							func_88();
						}
					}
					func_87();
					...
					iLocal_121 = 1;
					unk_0xC1B1E9A034A63A62(0);
					unk_0x2A5A7A67155CA694(-133.841f, -38.5734f, -100f, -126.2403f, -29.194f, 100f, 0);
					unk_0x41BBA77D020A0CEB(-133.841f, -38.5734f, -100f, -126.2403f, -29.194f, 100f, 0, 1);
					func_93(0, 1, 1, 0);
...
void func_92(int iParam0)
{
	if (unk_0xC1EDB61CE0A4B94E(iParam0))
	{
		if (!unk_0xBDA1F5E8A36BFA07(iParam0, 0))
		{
			...
			{
				unk_0x93FB0C7D8460F791(iParam0);
				unk_0xEC337F42DFBAD859(iParam0, unk_0x6267527E254067CA(iParam0) + 200);
				unk_0xFC462627D90533FE(iParam0, (unk_0xA1B16F2399008FCA(iParam0) + 200f));
				unk_0xA393DEF92D73C91E(iParam0, (unk_0x4B2FB28E87E96C63(iParam0) + 200f));
				unk_0x1D2204CE0D02765E(unk_0xF4745590D18D14B8(iParam0, 1), 5f);
				unk_0x79D9EC458879E8B8(unk_0xF4745590D18D14B8(iParam0, 1), 2.5f, 1, 0, 0, 0);
			}
		}
	}
}
		...
		switch (iLocal_168)
		{
			case 0:
				if (iLocal_106 < unk_0x1ADBAAC322D61F73())
				{
					if (func_70(&uLocal_178, "REBU2AU", "REBU2_HPF", 4, 0, 0, 0))
					{
						iLocal_106 = (unk_0x1ADBAAC322D61F73() + unk_0xA6055C735E3DD877(4000, 5500));
						iLocal_168++;
					}
				}
				break;
...
{
	unk_0x6057437695115495(uParam0, sParam1, func_103(iParam2), 1);
}
...
void func_106()
{
	if (!iLocal_67 && unk_0x8853522CEFF93BE9(unk_0x06736567F820A39E(), Local_107, 30f, 30f, 30f, 0, 1, 0))
	{
		if (!unk_0xCFC04A38F256EE06(iLocal_54[1]))
		{
	...
	if (unk_0x1B6292EA51632C25(iLocal_58, 0))
	{
		if (!unk_0xCFC04A38F256EE06(iLocal_54[0]))
		{
			unk_0x480BD8426B2323B0(iLocal_54[0], iLocal_58, unk_0x06736567F820A39E(), 8, 30f, 262144, -1f, 10f, 1);
			unk_0x97C5D2BB8E47131D(iLocal_54[0], 1);
		}
		if (!unk_0xCFC04A38F256EE06(iLocal_54[1]))
		{
			unk_0xEA61E9C6B1D4A33E(iLocal_54[1], iLocal_58, -1, 0, 3f, 1, 0);
			unk_0x97C5D2BB8E47131D(iLocal_54[1], 1);
		}
	}
	else
	{
		...
		while (iLocal_64 <= 1)
		{
			if (!unk_0xCFC04A38F256EE06(iLocal_54[iLocal_64]))
			{
				unk_0xFEDD46326A41DB46(iLocal_54[iLocal_64], unk_0x06736567F820A39E(), 250f, -1, 0, 0);
				unk_0x97C5D2BB8E47131D(iLocal_54[iLocal_64], 1);
			}
			iLocal_64++;
		}
	}
...
void func_107()
{
	if (!unk_0xCFC04A38F256EE06(iLocal_54[0]) && !unk_0xCFC04A38F256EE06(iLocal_54[1]))
	{
		if (!unk_0xA14561E9EE07759B(iLocal_54[0]) && !unk_0xA14561E9EE07759B(iLocal_54[1]))
		{
			if (func_70(&uLocal_178, "REBU2AU", "REBU2_VH", 4, 0, 0, 0))
			{
				if (!unk_0x98D424FE7497139D(iLocal_54[1]))
				{
					unk_0x1F6717C33A02B7AC(iLocal_54[1]);
					unk_0x8C4083252905932E(iLocal_54[1], unk_0x06736567F820A39E(), -1, joaat("FIRING_PATTERN_FULL_AUTO"));
				}
			}
		}
	}
...
void func_108()
{
	...
	if (!unk_0xCFC04A38F256EE06(iLocal_54[0]) && !unk_0xCFC04A38F256EE06(iLocal_54[1]))
	{
		if (!iLocal_69)
		{
			...
			if (unk_0xE722F1A5D8B43C06(iLocal_54[1], unk_0x06736567F820A39E(), 90f))
			{
				func_104();
				unk_0x4EDE34FBADD967A6(0);
				...
				if (!unk_0xCFC04A38F256EE06(iLocal_54[0]) && !unk_0xCFC04A38F256EE06(iLocal_54[1]))
				{
					fVar0 = func_110(iLocal_54[0], unk_0x06736567F820A39E(), 1);
					if (fVar0 > 5f)
					{
						fVar0 = (fVar0 - 2f);
					}
					...
					unk_0xD02CD3284DDA0268(iLocal_60, 0, 1);
					unk_0x4819029CE8AA1780(iLocal_60, iLocal_54[0], unk_0x1E8E6BB8337EDD5C(iLocal_54[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					unk_0x1F6717C33A02B7AC(iLocal_54[0]);
					unk_0xD6763C9F81772BAE(&uLocal_65);
					unk_0x3195125C126B79C6(0, unk_0x06736567F820A39E(), -1, 2048, 2);
					unk_0x28B5966B12DC5B0F(0, "random@burial", "a_burial_stop", 8f, -4f, 2000, 0, 0, 0, 0, 0);
					unk_0x608A9ECA218C4D24(0, unk_0x06736567F820A39E(), 0);
					unk_0x6F275D9063DAF754(uLocal_65);
					unk_0x457C4844450FF70E(iLocal_54[0], uLocal_65);
					unk_0xDD1A4EE55D86FE71(&uLocal_65);
					unk_0xDC8345A5D9F4B348(iLocal_54[1], joaat("weapon_sawnoffshotgun"), 1);
					unk_0x1F6717C33A02B7AC(iLocal_54[1]);
					unk_0xD6763C9F81772BAE(&uLocal_65);
					unk_0x3195125C126B79C6(0, unk_0x06736567F820A39E(), -1, 2048, 2);
					unk_0x1C7285D2BF9E26A8(0, unk_0x06736567F820A39E(), -1, fVar0, 1f, 1073741824, 0);
					unk_0x608A9ECA218C4D24(0, unk_0x06736567F820A39E(), 0);
					unk_0x6F275D9063DAF754(uLocal_65);
					unk_0x457C4844450FF70E(iLocal_54[1], uLocal_65);
					unk_0xDD1A4EE55D86FE71(&uLocal_65);
		...
		if (iLocal_69 && !iLocal_165)
		{
			...
			{
				unk_0xD6763C9F81772BAE(&uLocal_65);
				unk_0x3B642AF42845E74A(0, unk_0x06736567F820A39E(), unk_0x06736567F820A39E(), 1f, 0, 3.5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
				unk_0xF0FD829819E2AD88(0, unk_0x06736567F820A39E(), -1, 0);
				unk_0x6F275D9063DAF754(uLocal_65);
				unk_0x457C4844450FF70E(iLocal_54[1], uLocal_65);
				unk_0xDD1A4EE55D86FE71(&uLocal_65);
				unk_0x25B97FB8615971D6("RE6_START");
				iLocal_165 = 1;
			}
		}
		if (iLocal_165 && !iLocal_166)
		{
			...
			{
				if (unk_0x53B456945AE5C7DE(unk_0x06736567F820A39E(), iLocal_54[0], 30f, 30f, 30f, 0, 1, 0) && unk_0x53B456945AE5C7DE(unk_0x06736567F820A39E(), iLocal_54[1], 30f, 30f, 30f, 0, 1, 0))
				{
					unk_0xF0FD829819E2AD88(iLocal_54[0], unk_0x06736567F820A39E(), -1, 0);
				}
				iLocal_166 = 1;
		...
		if (iLocal_166 && !bLocal_167)
		{
			if (unk_0xC9D9444186B5A374() > 15000 && !func_12())
			{
				if (unk_0x53B456945AE5C7DE(unk_0x06736567F820A39E(), iLocal_54[0], 30f, 30f, 30f, 0, 1, 0) && unk_0x53B456945AE5C7DE(unk_0x06736567F820A39E(), iLocal_54[1], 30f, 30f, 30f, 0, 1, 0))
				{
					unk_0x608A9ECA218C4D24(iLocal_54[0], unk_0x06736567F820A39E(), 0);
					unk_0x608A9ECA218C4D24(iLocal_54[1], unk_0x06736567F820A39E(), 0);
					func_70(&uLocal_178, "REBU2AU", "REBU2_SHO", 4, 0, 0, 0);
					bLocal_167 = true;
				}
			}
		}
		if (((!iLocal_70 && iLocal_165) && !unk_0xCFC04A38F256EE06(iLocal_54[0])) && !unk_0xCFC04A38F256EE06(iLocal_54[1]))
		{
			if (unk_0x53B456945AE5C7DE(unk_0x06736567F820A39E(), iLocal_54[0], 30f, 30f, 30f, 0, 1, 0) && unk_0x53B456945AE5C7DE(unk_0x06736567F820A39E(), iLocal_54[1], 30f, 30f, 30f, 0, 1, 0))
			{
				if (!func_12())
			...
			{
				unk_0xD6763C9F81772BAE(&uLocal_65);
				unk_0x1C7285D2BF9E26A8(0, iLocal_54[1], -1, 2f, 1f, 1073741824, 0);
				unk_0x608A9ECA218C4D24(0, iLocal_54[1], 0);
				unk_0xD5FDD0DED35FFF91(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
				unk_0x6F275D9063DAF754(uLocal_65);
				unk_0x457C4844450FF70E(iLocal_54[0], uLocal_65);
				unk_0xDD1A4EE55D86FE71(&uLocal_65);
				unk_0xD6763C9F81772BAE(&uLocal_65);
				unk_0x1C7285D2BF9E26A8(0, iLocal_54[0], -1, 2f, 1f, 1073741824, 0);
				unk_0x608A9ECA218C4D24(0, iLocal_54[0], 0);
				unk_0xD5FDD0DED35FFF91(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
				unk_0x6F275D9063DAF754(uLocal_65);
				unk_0x457C4844450FF70E(iLocal_54[1], uLocal_65);
				unk_0xDD1A4EE55D86FE71(&uLocal_65);
		...
		if (((unk_0x903D050A71240190(iLocal_54[0], unk_0x06736567F820A39E()) || unk_0x903D050A71240190(iLocal_54[1], unk_0x06736567F820A39E())) || unk_0x004D4AFEA12A84A7(unk_0xE0BDAFA1A39552D6(), iLocal_54[0])) || unk_0x004D4AFEA12A84A7(unk_0xE0BDAFA1A39552D6(), iLocal_54[1]))
		{
			if (unk_0x09AED05FAA64E81C(unk_0x06736567F820A39E(), 4) && !unk_0x09AED05FAA64E81C(unk_0x06736567F820A39E(), 3))
			{
				if (unk_0x59AD7FDEE8F9BAED(unk_0x06736567F820A39E()))
				{
					if (!iLocal_76)
			...
			if (unk_0x09AED05FAA64E81C(unk_0x06736567F820A39E(), 3) && !unk_0x09AED05FAA64E81C(unk_0x06736567F820A39E(), 4))
			{
				if (unk_0x59AD7FDEE8F9BAED(unk_0x06736567F820A39E()))
				{
					if (!iLocal_76)
			...
			if (unk_0x8E078D197865EF83(unk_0xE0BDAFA1A39552D6()) || unk_0x98D424FE7497139D(unk_0x06736567F820A39E()))
			{
				func_112();
			}
		}
...
int func_111()
{
	if (!unk_0xCFC04A38F256EE06(unk_0x06736567F820A39E()))
	{
		if (unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 0))
		{
			if (unk_0x1B6292EA51632C25(unk_0x34E1EF1E8BCD1BFC(unk_0x06736567F820A39E(), 0), 0))
			{
				if ((((unk_0x3A4EADE60DE32F9E(unk_0x06736567F820A39E(), joaat("rhino")) || unk_0x2F086D433258D56D(unk_0x06736567F820A39E())) || unk_0x3A4EADE60DE32F9E(unk_0x06736567F820A39E(), joaat("annihilator"))) || unk_0x3A4EADE60DE32F9E(unk_0x06736567F820A39E(), joaat("buzzard"))) || unk_0x211EB61B2F3222D0(unk_0x06736567F820A39E()))
				{
					return 1;
				}
			}
...
void func_112()
{
	...
	if (!iLocal_145)
	{
		if (unk_0xC1EDB61CE0A4B94E(iLocal_54[0]))
		{
			if (!unk_0xCFC04A38F256EE06(iLocal_54[0]))
			{
				unk_0xE736C729727B547E(iLocal_54[0], 156, 1);
				if (unk_0xC1EDB61CE0A4B94E(iLocal_60))
				{
					unk_0x1C06AE946D877DF1(iLocal_54[0]);
					if (unk_0xBC572626B3578AD2(iLocal_60))
					{
						if (!iLocal_70)
						{
							...
							unk_0xD6763C9F81772BAE(&uLocal_65);
							unk_0x9A12E803B1184012(0);
							unk_0x28B5966B12DC5B0F(0, "random@burial", "a_burial_stop", 8f, -8f, 2000, 0, 0, 0, 0, 0);
							unk_0xFB9941AAF643A23C(0, unk_0x06736567F820A39E(), 0, 16);
							unk_0x6F275D9063DAF754(uLocal_65);
							unk_0x457C4844450FF70E(iLocal_54[0], uLocal_65);
							unk_0xDD1A4EE55D86FE71(&uLocal_65);
							unk_0x97C5D2BB8E47131D(iLocal_54[0], 1);
							unk_0xA9FA4149DF18912C(iLocal_54[0], 0, 0);
							iLocal_145 = 1;
						}
					}
					else
	...
	if (!iLocal_146)
	{
		if (unk_0xC1EDB61CE0A4B94E(iLocal_54[1]))
		{
			if (!unk_0xCFC04A38F256EE06(iLocal_54[1]))
			{
				unk_0xE736C729727B547E(iLocal_54[1], 156, 1);
				unk_0x1C06AE946D877DF1(iLocal_54[1]);
				unk_0xD6763C9F81772BAE(&uLocal_65);
				unk_0x9A12E803B1184012(0);
				unk_0x608A9ECA218C4D24(0, unk_0x06736567F820A39E(), 500);
				unk_0xFB9941AAF643A23C(0, unk_0x06736567F820A39E(), 0, 16);
				unk_0x6F275D9063DAF754(uLocal_65);
				unk_0x457C4844450FF70E(iLocal_54[1], uLocal_65);
				unk_0xDD1A4EE55D86FE71(&uLocal_65);
...
int func_113(int iParam0)
{
	if (func_116())
	{
		...
		if (func_25(Global_101175))
		{
			func_114(0);
		}
		unk_0xEEAF3825AA9B5231(1, "RE_TITLE");
		if (iParam0 && func_25(Global_101175))
		{
...
int func_116()
{
	switch (func_117(&Global_25211, 0, 5, 0, unk_0xAE832DCCE9CD3242()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_120(iParam0, Global_35742);
}
...
void func_122()
{
	if (unk_0xCDB4C4200A9B478A(uLocal_163))
	{
		unk_0x2239ED27B231AE2E(&uLocal_163);
	}
	if (!unk_0xCDB4C4200A9B478A(uLocal_114))
	{
		if (!unk_0xBDA1F5E8A36BFA07(iLocal_53, 0))
	...
	while (iLocal_64 <= 1)
	{
		if (!unk_0xCDB4C4200A9B478A(uLocal_111[iLocal_64]))
		{
			if (!unk_0xBDA1F5E8A36BFA07(iLocal_54[iLocal_64], 0))
			{
		...
		switch (iLocal_168)
		{
			case 0:
				if (iLocal_106 < unk_0x1ADBAAC322D61F73())
				{
					...
					{
						iLocal_106 = (unk_0x1ADBAAC322D61F73() + unk_0xA6055C735E3DD877(4500, 6500));
						iLocal_168++;
					}
				}
				break;
...
void func_124()
{
	switch (iLocal_110)
	{
		...
		case 4:
			iLocal_106 = unk_0x1ADBAAC322D61F73() + 3000;
			iLocal_110++;
			break;
	...
	if (unk_0xC1EDB61CE0A4B94E(iLocal_60))
	{
		if (unk_0xBC572626B3578AD2(iLocal_60))
		{
			if (!unk_0xCFC04A38F256EE06(iLocal_54[0]))
			{
				if (unk_0x46E9388908C80483(iLocal_54[0], "random@burial", "a_burial_stop", 3))
				{
					if (unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial_stop") > 0.124f && unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial") < 0.127f)
					{
						unk_0x2DB1C07C291A0CB5("scr_burial_dirt", iLocal_60, 0f, 0f, -0.95f, 0f, 180f, 0f, 1065353216, 0, 0, 0);
					}
				}
				if (unk_0x46E9388908C80483(iLocal_54[0], "random@burial", "a_burial", 3))
				{
					if (((((unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial") > 0.04f && unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial") < 0.043f) || (unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial") > 0.24f && unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial") < 0.243f)) || (unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial") > 0.44f && unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial") < 0.443f)) || (unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial") > 0.64f && unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial") < 0.643f)) || (unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial") > 0.84f && unk_0xD26997147908D65E(iLocal_54[0], "random@burial", "a_burial") < 0.843f))
					{
						unk_0x2DB1C07C291A0CB5("scr_burial_dirt", iLocal_60, 0f, 0f, -0.95f, 0f, 180f, 0f, 1065353216, 0, 0, 0);
					}
				}
...
int func_126()
{
	if (!iLocal_129)
	{
		if (unk_0xDECA6CE314913AC1(Local_88, 100f, 1) || unk_0xDECA6CE314913AC1(Local_88, 100f, 1))
		{
			if (unk_0xCFC04A38F256EE06(iLocal_54[0]) || unk_0xCFC04A38F256EE06(iLocal_54[1]))
			{
				iLocal_51 = 1;
			...
			else if (!unk_0xDECA6CE314913AC1(Local_88, 100f, 1) || !unk_0xDECA6CE314913AC1(Local_88, 100f, 1))
			{
				iLocal_51 = 1;
				return 1;
			}
		}
		if (((((((((unk_0x47DB429A8F8A7A27(194.3872f, 6833.941f, 62.4419f, 131.3547f, 6845.673f, 15.4613f, 36.9375f, joaat("weapon_smokegrenade"), 1) || unk_0x47DB429A8F8A7A27(194.3872f, 6833.941f, 62.4419f, 131.3547f, 6845.673f, 15.4613f, 36.9375f, joaat("weapon_grenade"), 1)) || unk_0x47DB429A8F8A7A27(194.3872f, 6833.941f, 62.4419f, 131.3547f, 6845.673f, 15.4613f, 36.9375f, joaat("weapon_stickybomb"), 1)) || unk_0x47DB429A8F8A7A27(194.3872f, 6833.941f, 62.4419f, 131.3547f, 6845.673f, 15.4613f, 36.9375f, joaat("weapon_grenadelauncher"), 1)) || unk_0x47DB429A8F8A7A27(194.3872f, 6833.941f, 62.4419f, 131.3547f, 6845.673f, 15.4613f, 36.9375f, joaat("weapon_grenadelauncher_smoke"), 1)) || unk_0x47DB429A8F8A7A27(194.3872f, 6833.941f, 62.4419f, 131.3547f, 6845.673f, 15.4613f, 36.9375f, joaat("weapon_rpg"), 1)) || unk_0x47DB429A8F8A7A27(194.3872f, 6833.941f, 62.4419f, 131.3547f, 6845.673f, 15.4613f, 36.9375f, joaat("weapon_molotov"), 1)) || unk_0x7FAF32E5A5FEFF08(2, Local_88 - Vector(100f, 100f, 100f), Local_88 + Vector(100f, 100f, 100f))) || unk_0x7FAF32E5A5FEFF08(4, Local_88 - Vector(100f, 100f, 100f), Local_88 + Vector(100f, 100f, 100f))) || unk_0x7FAF32E5A5FEFF08(0, Local_88 - Vector(100f, 100f, 100f), Local_88 + Vector(100f, 100f, 100f)))
		{
			iLocal_51 = 1;
			return 1;
		}
		if (unk_0xC1EDB61CE0A4B94E(iLocal_58))
		{
			if (!unk_0xBDA1F5E8A36BFA07(iLocal_58, 0))
			{
				if (unk_0x1D58D319587D567F(iLocal_58, unk_0x06736567F820A39E(), 1) || unk_0x93E49C491856D7AD(unk_0x06736567F820A39E(), iLocal_58, 0))
				{
					unk_0xFE26A2643AFB7A3B(iLocal_58);
					func_112();
					iLocal_51 = 3;
					return 1;
				}
				if (unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 0))
				{
					...
					{
						if (unk_0x36DB50F438E1FBEE(unk_0x34E1EF1E8BCD1BFC(unk_0x06736567F820A39E(), 0), iLocal_58))
						{
							func_112();
							iLocal_51 = 3;
							return 1;
		...
		if (!iLocal_75)
		{
			if (!unk_0xCFC04A38F256EE06(iLocal_54[0]) && !unk_0xCFC04A38F256EE06(iLocal_54[1]))
			{
				if ((((unk_0x903D050A71240190(iLocal_54[0], unk_0x06736567F820A39E()) || unk_0x903D050A71240190(iLocal_54[1], unk_0x06736567F820A39E())) || unk_0x004D4AFEA12A84A7(unk_0xE0BDAFA1A39552D6(), iLocal_54[0])) || unk_0x004D4AFEA12A84A7(unk_0xE0BDAFA1A39552D6(), iLocal_54[1])) || unk_0x8853522CEFF93BE9(unk_0x06736567F820A39E(), Local_88 - Vector(0f, 0f, 7f), 20f, 15f, 35f, 0, 1, 0))
				{
					if (unk_0x8853522CEFF93BE9(unk_0x06736567F820A39E(), Local_88 - Vector(0f, 0f, 7f), 28f, 18f, 35f, 0, 1, 0))
					{
						iLocal_51 = 1;
						return 1;
					}
		...
		if (unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 0))
		{
			if (!unk_0xCFC04A38F256EE06(iLocal_54[0]) && !unk_0xCFC04A38F256EE06(iLocal_54[1]))
			{
				if (!unk_0xBDA1F5E8A36BFA07(unk_0xF222904387CE4946(), 0))
				{
					if (unk_0x0280B42925DCFDEC(unk_0xF222904387CE4946(), iLocal_54[0]) || unk_0x0280B42925DCFDEC(unk_0xF222904387CE4946(), iLocal_54[1]))
					{
						iLocal_51 = 5;
						return 1;
					}
		...
		if (!unk_0xCFC04A38F256EE06(iLocal_53))
		{
			if (unk_0x1D58D319587D567F(iLocal_53, unk_0x06736567F820A39E(), 0) || unk_0xC8A6621AB8F66081(iLocal_53, joaat("weapon_stungun"), 0))
			{
				iLocal_51 = 4;
				return 1;
			}
		...
		if (unk_0xBDA1F5E8A36BFA07(iLocal_54[0], 0) || unk_0xBDA1F5E8A36BFA07(iLocal_54[1], 0))
		{
			iLocal_51 = 6;
			return 1;
		}
...
int func_127(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5, int iParam6)
{
					...
					if (unk_0x225B26AE60B121A0(unk_0xE0BDAFA1A39552D6(), iParam0) || unk_0x1D7CB59C357D17AB(unk_0xE0BDAFA1A39552D6(), iParam0))
					{
						if (fVar9 < fVar0)
						{
							if (unk_0xA382B3D871DD22A4(iParam0, unk_0x06736567F820A39E(), 17))
							{
								...
								func_132("\n");
								func_128("		time since not LockedOn = ", (unk_0x1ADBAAC322D61F73() - iLocal_19));
								func_132("\n");
								bVar2 = true;
								if (unk_0x1ADBAAC322D61F73() > (iLocal_19 + *uParam2))
								{
	...
	if (!bVar2)
	{
		iLocal_19 = unk_0x1ADBAAC322D61F73();
	}
	return 0;
}
...
void func_134()
{
	...
	func_136(43, 1);
	func_136(44, 1);
	unk_0x33189531E55C7E33(Local_139 - Vector(20f, 40f, 40f), Local_139 + Vector(20f, 40f, 40f), 0, 1, 1, 1);
	unk_0x33189531E55C7E33(Local_78 - Vector(20f, 50f, 60f), Local_78 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
	unk_0x2CC3164B94BF6E73(iLocal_105, 1);
	unk_0x6849F03027FD1813(5, 0);
	unk_0x6849F03027FD1813(3, 0);
	unk_0x71543B3C24188223(0f);
	iLocal_53 = unk_0xB500796AAD639F82(26, iLocal_102, Local_78, fLocal_97, 1, 1);
	unk_0xBA63517ADBC1E5E3(iLocal_53, 1);
	unk_0xA26A1133034ECD59(iLocal_53, 0);
	unk_0x6E2532A21AB2C125(iLocal_53, 2, 0);
	unk_0x6E2532A21AB2C125(iLocal_53, 128, 1);
	unk_0xD14E5ED9D5665519(iLocal_53, 1, 0);
	unk_0xD14E5ED9D5665519(iLocal_53, 6, 0);
	unk_0x6553935614875699(iLocal_53, 206, 1);
	unk_0x6553935614875699(iLocal_53, 318, 0);
	unk_0x6553935614875699(iLocal_53, 118, 0);
	unk_0x6553935614875699(iLocal_53, 208, 1);
	unk_0x0B87AFC0B2EECA19(iLocal_102);
	unk_0xEC337F42DFBAD859(iLocal_53, iLocal_125);
	unk_0x20B66CD0E0087C3F(unk_0x06736567F820A39E(), 0);
	unk_0x3ECE0E645B1530B3("rghKidnappers", &iLocal_176);
	unk_0x3ECE0E645B1530B3("rghVictim", &iLocal_177);
	unk_0xDEA5F99894469373(iLocal_53, iLocal_177);
	iLocal_64 = 0;
	while (iLocal_64 <= 1)
	{
		iLocal_54[iLocal_64] = unk_0xB500796AAD639F82(26, iLocal_103, Local_81[iLocal_64 /*3*/], fLocal_98[iLocal_64], 1, 1);
		unk_0xBA63517ADBC1E5E3(iLocal_54[iLocal_64], 1);
		unk_0xE8F16DB86D0CC8C9(iLocal_54[iLocal_64], 1);
		unk_0xD14E5ED9D5665519(iLocal_54[iLocal_64], 0, 1);
		unk_0x6E2532A21AB2C125(iLocal_54[iLocal_64], 2, 0);
		unk_0x6E2532A21AB2C125(iLocal_54[iLocal_64], 128, 1);
		unk_0x6553935614875699(iLocal_54[iLocal_64], 42, 1);
		unk_0x2FD7042D8FE731D1(iLocal_54[0], 2);
		unk_0xD14E5ED9D5665519(iLocal_54[0], 50, 1);
		unk_0x75084666BD6D4F73(iLocal_54[iLocal_64], 50);
		unk_0x49BD4C1B5817C978(iLocal_54[iLocal_64], 13);
		unk_0x215FFA3EE011BA3C(iLocal_54[iLocal_64], 1);
		unk_0xDEA5F99894469373(iLocal_54[iLocal_64], iLocal_176);
		unk_0x194510CFB3606077(iLocal_54[iLocal_64], unk_0xA6055C735E3DD877(800, 2000));
		iLocal_64++;
	}
	unk_0x0B87AFC0B2EECA19(iLocal_104);
	unk_0x0B87AFC0B2EECA19(iLocal_103);
	unk_0x75084666BD6D4F73(iLocal_54[1], 100);
	unk_0xA3AA6235DB0C6E18(iLocal_54[1], joaat("FIRING_PATTERN_BURST_FIRE"));
	unk_0x054CBFE90FAA6840(5, iLocal_176, joaat("player"));
	unk_0xF0683EF788D4342B(iLocal_54[0], joaat("weapon_pistol"), -1, 0, 1);
	unk_0xF0683EF788D4342B(iLocal_54[1], joaat("weapon_sawnoffshotgun"), -1, 0, 1);
	iLocal_58 = unk_0x75409DE1FC985A9D(iLocal_105, Local_88, fLocal_101, 1, 1);
	unk_0xCE889B96E78E6DC5(iLocal_58);
	unk_0x8C2DACAFDE0BFE13(iLocal_58, 3);
	unk_0xFAE5DD72895807B1(iLocal_58, 5, 0, 0);
	unk_0x0B87AFC0B2EECA19(iLocal_105);
	iLocal_60 = unk_0xE6B4261E1DAB4EE0(joaat("prop_ld_shovel"), Local_107, 1, 1, 0);
	unk_0x0B87AFC0B2EECA19(joaat("prop_ld_shovel"));
	uLocal_61[0] = unk_0xE6B4261E1DAB4EE0(joaat("p_arm_bind_cut_s"), Local_107, 1, 1, 0);
	uLocal_61[1] = unk_0xE6B4261E1DAB4EE0(joaat("p_arm_bind_cut_s"), Local_107 + Vector(1f, 1f, 1f), 1, 1, 0);
	unk_0xBECC89ACB4E5D4ED(joaat("p_arm_bind_cut_s"));
	unk_0x4819029CE8AA1780(iLocal_60, iLocal_54[0], unk_0x1E8E6BB8337EDD5C(iLocal_54[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	unk_0x47222A663B914109(iLocal_54[0], 0, 0, 0, 0);
	unk_0x47222A663B914109(iLocal_54[0], 3, 0, 1, 0);
	unk_0x47222A663B914109(iLocal_54[0], 4, 1, 0, 0);
	unk_0x47222A663B914109(iLocal_54[1], 0, 0, 2, 0);
	unk_0x47222A663B914109(iLocal_54[1], 3, 2, 1, 0);
	unk_0x47222A663B914109(iLocal_54[1], 4, 1, 1, 0);
	Var0 = { Local_78 };
	Var3 = { -2f, -4f, 18f };
	uLocal_343 = unk_0x70D62E1C98FBC411(Var0, Var3, 2);
	unk_0x13F17EF7A260536D(iLocal_53, uLocal_343, "random@burial", "b_burial", 4f, -4f, 1, 0, 1148846080, 0);
	unk_0xD7C7DFD321D78CCA(uLocal_61[0], uLocal_343, "b_burial_legstie", "random@burial", 4f, -4f, 0, 1148846080);
	unk_0xD7C7DFD321D78CCA(uLocal_61[1], uLocal_343, "b_burial_wristtie", "random@burial", 4f, -4f, 0, 1148846080);
	unk_0x58E3D20EAF3A6C20(uLocal_343, 1);
	unk_0x97C5D2BB8E47131D(iLocal_53, 1);
	unk_0x28B5966B12DC5B0F(iLocal_54[0], "random@burial", "a_burial", 8f, -4f, -1, 1, 0, 0, 0, 0);
	unk_0x28B5966B12DC5B0F(iLocal_54[1], "random@burial", "c_burial", 8f, -4f, -1, 1, 0, 0, 0, 0);
	unk_0x12BA06847D8D0980(iLocal_54[0], Local_91, Local_94, 2.75f, 0, 0);
	unk_0x12BA06847D8D0980(iLocal_54[1], Local_91, Local_94, 2.75f, 0, 0);
	if (func_44() == 0)
	{
		func_135(&uLocal_178, 0, unk_0x06736567F820A39E(), "MICHAEL", 0, 1);
	}
	else if (func_44() == 1)
	{
		func_135(&uLocal_178, 1, unk_0x06736567F820A39E(), "FRANKLIN", 0, 1);
	}
	else if (func_44() == 2)
	{
		func_135(&uLocal_178, 2, unk_0x06736567F820A39E(), "TREVOR", 0, 1);
	}
	unk_0x0AB51FD6583D814C(iLocal_54[0], "A_M_M_HillBilly_02_WHITE_MINI_03");
	unk_0x0AB51FD6583D814C(iLocal_54[1], "A_M_M_HillBilly_02_WHITE_MINI_02");
	unk_0x0AB51FD6583D814C(iLocal_53, "KIDNAPPEDFEMALE");
...
void func_137(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x17CC0D5008835470())
	{
		if (func_20() == 0)
		{
			...
			func_138(func_141(iParam0), uVar0, -1, 1);
		}
	}
	else
	{
...
void func_138(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = Global_2473854[iParam0 /*5*/][func_139(iParam2)];
	if (iVar0 != 0)
	{
...
int func_140(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2473854[iParam0 /*5*/][func_139(iParam1)];
...
int func_143(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x17CC0D5008835470())
	{
		if (func_20() == 0)
		{
			return unk_0x7DA173D4FD42F36B(func_140(func_141(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_144()
{
	...
	if (unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 1))
	{
		uVar0 = unk_0xE8F1FE9FB29EB9CC(unk_0x06736567F820A39E());
...
void func_145()
{
	...
	unk_0xBECC89ACB4E5D4ED(iLocal_104);
	unk_0xBECC89ACB4E5D4ED(iLocal_103);
	unk_0xBECC89ACB4E5D4ED(iLocal_105);
	unk_0xBECC89ACB4E5D4ED(joaat("prop_ld_shovel"));
	unk_0xBECC89ACB4E5D4ED(joaat("p_arm_bind_cut_s"));
	unk_0x198E497B820DA913("random@burial");
	unk_0x400383B21251468A();
	unk_0x63BA14E731F141F2("ROPE_CUT", 0, -1);
	unk_0xAA821ECDF67A2A25("RE6_BOTH_DEAD_OS");
	if (((((((((unk_0x5C9FE32E2FF37989(iLocal_102) && unk_0x5C9FE32E2FF37989(iLocal_104)) && unk_0x5C9FE32E2FF37989(iLocal_103)) && unk_0x5C9FE32E2FF37989(iLocal_105)) && unk_0x5C9FE32E2FF37989(joaat("prop_ld_shovel"))) && unk_0x5C9FE32E2FF37989(joaat("p_arm_bind_cut_s"))) && unk_0x7B43775D6E0D7325("random@burial")) && unk_0x137D26BF6B6827A1()) && unk_0x63BA14E731F141F2("ROPE_CUT", 0, -1)) && unk_0xAA821ECDF67A2A25("RE6_BOTH_DEAD_OS"))
	{
		bLocal_52 = true;
	}
	else
...
int func_147()
{
	if (unk_0x7868479D9B6694C0(unk_0xE0BDAFA1A39552D6()) && !unk_0xCFC04A38F256EE06(unk_0x06736567F820A39E()))
	{
		...
		if (unk_0xA8CEACB4F35AE058(unk_0xC104F226F4D4A296(unk_0x06736567F820A39E())) > 1369f && !func_158())
		{
			return 0;
		}
	}
...
int func_160()
{
	if ((Global_101175 == func_39() && unk_0x8B2C262B815BC3D1()) && Global_101176)
	{
		return 1;
	}
	return 0;
...
int func_164(struct<3> Param0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		...
		if (!func_200(Global_101186.f_29596.f_43[iParam3]))
		{
			return 0;
		}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_178(unk_0x7DA173D4FD42F36B(iParam0, 31), -1, 1)) + 2011;
}
...
int func_181()
{
	...
	func_187(&uVar0, unk_0xF14A94DD5AC25E5A());
	func_186(&uVar0, unk_0x4DD90C24B73F9042());
	func_185(&uVar0, unk_0xEC5C0F25A9A364A0());
	func_184(&uVar0, unk_0xED13857F967C0912());
	func_183(&uVar0, unk_0x39BDC971C31BA81C());
	func_182(&uVar0, unk_0x6EBF2ECA5972D1E7());
	return uVar0;
}
		...
		if (unk_0xC1EDB61CE0A4B94E(unk_0x06736567F820A39E()))
		{
			if (!unk_0xCFC04A38F256EE06(unk_0x06736567F820A39E()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x043F96EA2F7DC706(unk_0xE0BDAFA1A39552D6()) || unk_0x1C3F1A4FF0A66BD0(unk_0x06736567F820A39E())) || unk_0xDA637881D427DB40(unk_0x06736567F820A39E())) || unk_0x9C4162CAC2B459EC(unk_0x06736567F820A39E())) || unk_0x717A18E48FCBEA99(unk_0x06736567F820A39E())) || unk_0x06919C12C3F93F0B(unk_0xE0BDAFA1A39552D6(), 1)) || unk_0x57EEE01FD8B2618E(unk_0xE0BDAFA1A39552D6())) || unk_0x7C6333A22EDB4BF7(unk_0x06736567F820A39E(), 0)) || func_198()) || Global_100233) || Global_25154) || func_197()) || func_78(8, -1)) || func_196()) || func_195()) || func_194()) || func_193()) || Global_101186.f_6454.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0x06919C12C3F93F0B(unk_0xE0BDAFA1A39552D6(), 1) || func_198()) || Global_25154) || func_197()) || func_78(8, -1)) || func_194()) || func_196()) || func_195()) || func_193()) || Global_101186.f_6454.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x043F96EA2F7DC706(unk_0xE0BDAFA1A39552D6()) || unk_0x1C3F1A4FF0A66BD0(unk_0x06736567F820A39E())) || unk_0xDA637881D427DB40(unk_0x06736567F820A39E())) || unk_0x9C4162CAC2B459EC(unk_0x06736567F820A39E())) || unk_0x717A18E48FCBEA99(unk_0x06736567F820A39E())) || unk_0x06919C12C3F93F0B(unk_0xE0BDAFA1A39552D6(), 1)) || unk_0x57EEE01FD8B2618E(unk_0xE0BDAFA1A39552D6())) || unk_0x7C6333A22EDB4BF7(unk_0x06736567F820A39E(), 0)) || func_198()) || Global_100233) || Global_25154) || func_197()) || func_78(8, -1)) || func_194()) || func_196()) || func_195()) || func_193()) || Global_101186.f_6454.f_919[iVar0] == 5) || Global_36289 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x9C4162CAC2B459EC(unk_0x06736567F820A39E()) || unk_0x717A18E48FCBEA99(unk_0x06736567F820A39E())) || unk_0x06919C12C3F93F0B(unk_0xE0BDAFA1A39552D6(), 1)) || unk_0x7C6333A22EDB4BF7(unk_0x06736567F820A39E(), 0)) || func_198()) || Global_100233) || Global_25154) || func_197()) || func_78(8, -1)) || func_196()) || func_195()) || func_193()) || Global_101186.f_6454.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_198() || unk_0xB0565BA1AD71378E(unk_0xE0BDAFA1A39552D6()) > 0) || func_78(8, -1)) || func_193()) || func_192()) || Global_101186.f_6454.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0xC1EDB61CE0A4B94E(unk_0x06736567F820A39E()))
						{
							if ((((((((((((((unk_0x7C6333A22EDB4BF7(unk_0x06736567F820A39E(), 0) || unk_0xB0565BA1AD71378E(unk_0xE0BDAFA1A39552D6()) > 0) || unk_0x1C3F1A4FF0A66BD0(unk_0x06736567F820A39E())) || unk_0x9C4162CAC2B459EC(unk_0x06736567F820A39E())) || unk_0x717A18E48FCBEA99(unk_0x06736567F820A39E())) || unk_0x06919C12C3F93F0B(unk_0xE0BDAFA1A39552D6(), 1)) || unk_0x57EEE01FD8B2618E(unk_0xE0BDAFA1A39552D6())) || func_198()) || Global_25154) || func_197()) || func_78(8, -1)) || func_195()) || func_194()) || func_193()) || Global_101186.f_6454.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((unk_0x7C6333A22EDB4BF7(unk_0x06736567F820A39E(), 0) || !unk_0x6F54F6E4D3F3FD07(unk_0xE0BDAFA1A39552D6())) || !unk_0x043F96EA2F7DC706(unk_0xE0BDAFA1A39552D6())) || !unk_0xDF916BCF4D39E8C2()) || unk_0x1C3F1A4FF0A66BD0(unk_0x06736567F820A39E())) || unk_0x9C4162CAC2B459EC(unk_0x06736567F820A39E())) || unk_0x717A18E48FCBEA99(unk_0x06736567F820A39E())) || unk_0x06919C12C3F93F0B(unk_0xE0BDAFA1A39552D6(), 1)) || func_198()) || func_195()) || Global_100233) || Global_25154) || func_197()) || Global_36870) || func_78(8, -1)) || func_194()) || func_192()) || func_193()) || Global_101186.f_6454.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((unk_0x7C6333A22EDB4BF7(unk_0x06736567F820A39E(), 0) || !unk_0x6F54F6E4D3F3FD07(unk_0xE0BDAFA1A39552D6())) || !unk_0x043F96EA2F7DC706(unk_0xE0BDAFA1A39552D6())) || !unk_0xDF916BCF4D39E8C2()) || unk_0xAA2F2E1D7A88C64E(unk_0xE0BDAFA1A39552D6(), 0)) || unk_0x1C3F1A4FF0A66BD0(unk_0x06736567F820A39E())) || unk_0x0FDFEC0DD29106EE(unk_0x06736567F820A39E(), 1)) || unk_0x9C4162CAC2B459EC(unk_0x06736567F820A39E())) || unk_0x717A18E48FCBEA99(unk_0x06736567F820A39E())) || unk_0x8B69AEF6B3EE75BF(unk_0x06736567F820A39E())) || unk_0x06919C12C3F93F0B(unk_0xE0BDAFA1A39552D6(), 1)) || unk_0x57EEE01FD8B2618E(unk_0xE0BDAFA1A39552D6())) || func_198()) || Global_100233) || Global_25154) || func_197()) || func_78(8, -1)) || func_194()) || func_192()) || func_196()) || func_195()) || func_193())
						{
							return 0;
						}
						break;
...
void func_206()
{
	...
	if (iLocal_162)
	{
		...
		unk_0x6555D0270D9BE11C("RE6_BOTH_DEAD_OS");
		...
		if (!unk_0xCFC04A38F256EE06(unk_0x06736567F820A39E()))
		{
			if (!unk_0xCFC04A38F256EE06(iLocal_53))
			{
				unk_0x6553935614875699(iLocal_53, 317, 1);
				if (!unk_0x0FDFEC0DD29106EE(iLocal_53, 0))
				{
					unk_0x4DE16F52A5E7F186(iLocal_53);
				}
				if (unk_0xE466FA8E4B1B261F(iLocal_53))
				{
					unk_0x334BA4D16EF01A42(iLocal_53);
			...
			else if (!unk_0xBDA1F5E8A36BFA07(iLocal_53, 0))
			{
				unk_0x5254774EE203F179(iLocal_53, 1);
				unk_0xFEF8CFEA6F9035A4(iLocal_53, 1);
			}
		...
		while (iVar0 < iLocal_54)
		{
			if (!unk_0xCFC04A38F256EE06(iLocal_54[iVar0]) && !unk_0xCFC04A38F256EE06(unk_0x06736567F820A39E()))
			{
				unk_0x1C06AE946D877DF1(iLocal_54[iVar0]);
				if (iLocal_69 || iLocal_76)
				{
					unk_0xFB9941AAF643A23C(iLocal_54[iVar0], unk_0x06736567F820A39E(), 0, 16);
				}
				else
				{
					unk_0xFEDD46326A41DB46(iLocal_54[iVar0], unk_0x06736567F820A39E(), 1000f, -1, 0, 0);
		...
		unk_0xF30CBC00D9F6D48D(&(uLocal_61[0]));
		unk_0xF30CBC00D9F6D48D(&(uLocal_61[1]));
		if (unk_0xC1EDB61CE0A4B94E(iLocal_58))
		{
			unk_0x768B37F1452D4834(&iLocal_58);
		}
		if (unk_0xC1EDB61CE0A4B94E(iLocal_60))
		{
			if (unk_0xBC572626B3578AD2(iLocal_60))
			...
			unk_0x61EEBF9B5AB9820D(&iLocal_60);
		}
		if (unk_0xCDB4C4200A9B478A(uLocal_163))
		{
			unk_0x2239ED27B231AE2E(&uLocal_163);
		...
		while (iLocal_64 <= 1)
		{
			if (unk_0xCDB4C4200A9B478A(uLocal_111[iLocal_64]))
			{
				unk_0x2239ED27B231AE2E(&(uLocal_111[iLocal_64]));
			}
			iLocal_64++;
		}
		if (unk_0xCDB4C4200A9B478A(uLocal_114))
		...
		if (unk_0x97A9CC2DDCDAA0A8(uLocal_77))
		{
			unk_0xC2F547D33F9342CC(uLocal_77, 0);
		}
		...
		unk_0x71543B3C24188223(1f);
		unk_0x41BBA77D020A0CEB(-133.841f, -38.5734f, -100f, -126.2403f, -29.194f, 100f, 1, 1);
	}
	func_207(-1);
	unk_0xF5DF8F3392CDD07B();
}
...
void func_207(int iParam0)
{
	...
	if (func_160())
	{
		...
		func_210(30000);
		StringCopy(&cVar0, func_209(Global_101175, 1), 64);
		if (func_38(Global_101175) > 0)
		{
