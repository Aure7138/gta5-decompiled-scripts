...
void __EntryFunction__()
{
	...
	if (unk_0xC11469DCA6FC3BB5(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_96440[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_251(&(Global_96440[Var0.f_0 /*10*/].f_9));
			}
		}
		func_239(&Var0, 1);
	}
	...
	uLocal_93 = unk_0x55686F8055FF786B(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		{
			if (!func_179(-72.323f, -1258.643f, 28.648f, unk_0xA86D5F069399F44D(Var0.f_35[0], 1), 1056964608))
			{
		...
		if (unk_0xD42BD6EB2E0F1677(unk_0x096275889B8E0EE0()))
		{
			if (!unk_0x6CFF81397164A1D3(unk_0x096275889B8E0EE0()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xC8183AE963C58374(unk_0x217E9DC48139933D(), 1) || func_162()) || Global_24446) || func_161()) || func_160(8, -1)) || func_158()) || func_77()) || func_159()) || func_157()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_162() || unk_0xABC532F9098BFD9D(unk_0x217E9DC48139933D()) > 0) || func_160(8, -1)) || func_157()) || func_156()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_163(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_111(unk_0x096275889B8E0EE0()) && func_111(uParam0->f_28[0])) && !func_129()) && (unk_0x4F67E8ECA7D3F667() - uParam0->f_60) > iParam8) && func_167(unk_0x096275889B8E0EE0(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_166(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_164(&uVar0, cParam4, sParam5, 7, 0, 0);
		uParam0->f_60 = unk_0x4F67E8ECA7D3F667();
		return 1;
	}
	return 0;
}
...
void func_168(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0xBFFB35986CAAE58C(unk_0x217E9DC48139933D()))
	{
		if (!unk_0x2CF12F9ACF18F048(sParam1))
		{
			...
			{
				if (func_167(unk_0x096275889B8E0EE0(), Param2, 1) <= 100f)
				{
					func_171(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_167(unk_0x096275889B8E0EE0(), Param2, 1) > 120f)
				{
					func_173(iParam0);
				}
			}
...
int func_181(var uParam0, bool bParam1)
{
	...
	func_94(*uParam0, &Var0);
	if ((func_215(*uParam0) || func_213(*uParam0)) || Global_68490 == 1)
	{
		return 1;
	}
	if (!unk_0x4F4FF2F3B81506A7())
...
void func_182(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_111(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_184(uParam1) || !unk_0xDEE49D5CA6C49148(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_183(iParam2) && !unk_0x9B4CC17D919C8FC4(iParam0, unk_0x096275889B8E0EE0(), 25f))
					{
						unk_0xFE920E72A4B34285(iParam0, unk_0x096275889B8E0EE0(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_184(uParam1) && uParam1->f_4 == 0) && unk_0x0BE7F4E3CDBAFB28(unk_0xA86D5F069399F44D(unk_0x096275889B8E0EE0(), 1), unk_0xA86D5F069399F44D(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_183(iParam2) || unk_0x9B4CC17D919C8FC4(iParam0, unk_0x096275889B8E0EE0(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f))
					{
						unk_0x8DBC05C86F873CC9(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0xD42BD6EB2E0F1677(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_188(unk_0x096275889B8E0EE0(), uParam0->f_35[iVar0]))
							{
...
int func_191(int iParam0, float fParam1)
{
	...
	{
		if (func_202(iParam0) || unk_0x27F89FDC16688A7A(unk_0x217E9DC48139933D(), iParam0))
		{
...
{
	return func_193(iParam0, unk_0x096275889B8E0EE0(), fParam1, 1, 250, 7);
}
...
int func_197(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_199(unk_0xA86D5F069399F44D(iParam1, 1) - unk_0xA86D5F069399F44D(iParam0, 1)) };
	...
	{
		Var3 = { func_199(unk_0x012B43913EE9671C(iParam0, 31086, 0f, 5f, 0f) - unk_0x012B43913EE9671C(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_206(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_199(Param1 - unk_0xA86D5F069399F44D(uParam0, 1)) };
...
{
	if ((func_214() && Global_89962.f_11 == 6) && iParam0 == func_147(&(Global_89962.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_217(var uParam0)
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			unk_0xA862A2AD321F94B4(sVar7);
			iLocal_90 = 1;
			break;
		
		case 1:
			if (!func_224(&iVar0) || !unk_0x27FF6FE8009B40CA(sVar7))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			...
			if (!unk_0xD42BD6EB2E0F1677(uParam0->f_35[0]))
			{
				...
				unk_0xB375807E9837A2E6(uParam0->f_35[0], 38, 0);
				unk_0x9E3F1A6B5BDD1931(uParam0->f_35[0], 91, 0);
				unk_0xAC447F5493BF482F(uParam0->f_35[0], 0);
				unk_0x175A4852406F9438(uParam0->f_35[0], 0, 2);
				unk_0x175A4852406F9438(uParam0->f_35[0], 1, 1);
				unk_0x175A4852406F9438(uParam0->f_35[0], 2, 1);
				unk_0x175A4852406F9438(uParam0->f_35[0], 3, 1);
				unk_0x175A4852406F9438(uParam0->f_35[0], 4, 1);
				unk_0x175A4852406F9438(uParam0->f_35[0], 6, 0);
				unk_0x175A4852406F9438(uParam0->f_35[0], 7, 2);
				unk_0x175A4852406F9438(uParam0->f_35[0], 10, 0);
				unk_0x175A4852406F9438(uParam0->f_35[0], 23, 20);
				unk_0x75F35BD9450C6115(uParam0->f_35[0], 0, 2, 0);
				unk_0x75F35BD9450C6115(uParam0->f_35[0], 1, 1, 0);
				unk_0x75F35BD9450C6115(uParam0->f_35[0], 2, 1, 0);
				unk_0x75F35BD9450C6115(uParam0->f_35[0], 3, 1, 0);
				unk_0x75F35BD9450C6115(uParam0->f_35[0], 4, 1, 0);
				unk_0x75F35BD9450C6115(uParam0->f_35[0], 6, 0, 0);
				unk_0x75F35BD9450C6115(uParam0->f_35[0], 7, 2, 0);
				unk_0x75F35BD9450C6115(uParam0->f_35[0], 10, 0, 0);
				unk_0x75F35BD9450C6115(uParam0->f_35[0], 23, 20, 0);
				unk_0x7F45E17D00A1DD46(uParam0->f_35[0], 18, 1);
				unk_0x7F45E17D00A1DD46(uParam0->f_35[0], 17, 1);
				unk_0x7F45E17D00A1DD46(uParam0->f_35[0], 22, 1);
				unk_0x96F78A6A075D55D9(uParam0->f_35[0], 3);
				unk_0xFF02C7BFD6A3D593(uParam0->f_35[0], 0);
				unk_0x629F0A0E952CAE7D(uParam0->f_35[0], 2);
				unk_0x57F925DF866E2CBD(iVar0[1], 1);
				unk_0x7263332501E07F52(uParam0->f_35[0]);
				unk_0x4EDE34FBADD967A6(0);
			}
			if (!unk_0xD42BD6EB2E0F1677(uParam0->f_35[1]))
			{
				func_219(&(uParam0->f_35[1]), iVar0[3], -91.07f, -1273.45f, 28.86f, 0.57f);
				unk_0xC10FAC19094E9309(uParam0->f_35[1], 10);
			}
			if (func_111(uParam0->f_28[0]))
			{
				func_218(&(uParam0->f_41[0]), iVar0[2], -71.93684f, -1259.078f, 28.19359f, -177.55f);
				unk_0x1B21CF9397F27FEE(uParam0->f_41[0], uParam0->f_28[0], unk_0xD1E5B4D09626571A(uParam0->f_28[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
			}
			if (bVar8)
			{
				iLocal_90 = 3;
		...
		case 3:
			...
			{
				uVar9 = unk_0xBACA8FE9C76C124E(uParam0->f_35[0], "chassis_dummy");
				Var10 = { unk_0x82CFA50E34681CA5(uParam0->f_35[0], uVar9) };
				uVar6 = unk_0x4D3B117F889EADDA(Var10, unk_0xE09CAF86C32CB48F(uParam0->f_35[0], 2), 2);
				unk_0x074C419F65D01DE7(uVar6, 1);
				unk_0x0D750763E4B00866(uVar6, 0);
				unk_0x3605588B4955CFAF(uParam0->f_28[0], uVar6, sVar7, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
				unk_0xD4648EA39998A07B(uParam0->f_28[0], unk_0x096275889B8E0EE0(), -1, 2050, 4);
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
			{
...
int func_237(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	...
	if (func_238(Var1.f_6, Param1, fParam4))
	{
...
int func_238(struct<3> Param0, struct<3> Param3, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_239(int iParam0, bool bParam1)
{
	...
	unk_0xE2E2B535953BF59E(uLocal_93, 0);
	if (bParam1)
	{
		func_175(*iParam0);
	}
