...
void __EntryFunction__()
{
	...
	uLocal_93 = unk_0x92832F671263F8E0(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		{
			if (!func_179(-72.323f, -1258.643f, 28.648f, unk_0xBF1B13057E5119A4(Var0.f_35[0], 1), 1056964608))
			{
		...
		if (unk_0xFD68187442384158(unk_0x507DA4994C3D8EBD()))
		{
			if (!unk_0x9F94F2CFDCA78C55(unk_0x507DA4994C3D8EBD()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xAC33D6DDFB2C92EC(unk_0xAF65E5A58BE87D95(), 1) || func_162()) || Global_24446) || func_161()) || func_160(8, -1)) || func_158()) || func_77()) || func_159()) || func_157()) || Global_97173.f_5944.f_889[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_162() || unk_0x89D8D467C3C356CB(unk_0xAF65E5A58BE87D95()) > 0) || func_160(8, -1)) || func_157()) || func_156()) || Global_97173.f_5944.f_889[iVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_163(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_111(unk_0x507DA4994C3D8EBD()) && func_111(uParam0->f_28[0])) && !func_129()) && (unk_0xF976C624234A4AA8() - uParam0->f_60) > iParam8) && func_167(unk_0x507DA4994C3D8EBD(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_166(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_164(&uVar0, cParam4, sParam5, 7, 0, 0);
		uParam0->f_60 = unk_0xF976C624234A4AA8();
		return 1;
	}
	return 0;
}
...
void func_168(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x52A84D9C3A400EA8(unk_0xAF65E5A58BE87D95()))
	{
		if (!unk_0x8FA72E132AAFA62F(sParam1))
		{
			...
			{
				if (func_167(unk_0x507DA4994C3D8EBD(), Param2, 1) <= 100f)
				{
					func_171(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_167(unk_0x507DA4994C3D8EBD(), Param2, 1) > 120f)
				{
					func_173(iParam0);
				}
			}
...
void func_182(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_111(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_184(uParam1) || !unk_0x22605DE2E6933CF2(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_183(iParam2) && !unk_0x849DBD2D635C99D5(iParam0, unk_0x507DA4994C3D8EBD(), 25f))
					{
						unk_0xDE75E9DE5B6221E1(iParam0, unk_0x507DA4994C3D8EBD(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_184(uParam1) && uParam1->f_4 == 0) && unk_0x8FE221761D524CFE(unk_0xBF1B13057E5119A4(unk_0x507DA4994C3D8EBD(), 1), unk_0xBF1B13057E5119A4(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_183(iParam2) || unk_0x849DBD2D635C99D5(iParam0, unk_0x507DA4994C3D8EBD(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f))
					{
						unk_0xEC0A546609840086(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0xFD68187442384158(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_188(unk_0x507DA4994C3D8EBD(), uParam0->f_35[iVar0]))
							{
...
int func_191(int iParam0, float fParam1)
{
	...
	{
		if (func_202(iParam0) || unk_0x8DEF14B60C4A9D01(unk_0xAF65E5A58BE87D95(), iParam0))
		{
...
{
	return func_193(iParam0, unk_0x507DA4994C3D8EBD(), fParam1, 1, 250, 7);
}
...
int func_197(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_199(unk_0xBF1B13057E5119A4(iParam1, 1) - unk_0xBF1B13057E5119A4(iParam0, 1)) };
	...
	{
		Var3 = { func_199(unk_0xC5B1818639240D24(iParam0, 31086, 0f, 5f, 0f) - unk_0xC5B1818639240D24(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_206(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_199(Param1 - unk_0xBF1B13057E5119A4(uParam0, 1)) };
...
int func_217(var uParam0)
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			unk_0x395C5D98343F0040(sVar7);
			iLocal_90 = 1;
			break;
		
		case 1:
			if (!func_224(&iVar0) || !unk_0xCE40391AB65FE305(sVar7))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			...
			if (!unk_0xFD68187442384158(uParam0->f_35[0]))
			{
				...
				unk_0x2972E055244638AD(uParam0->f_35[0], 38, 0);
				unk_0xA3A489EE6DDCCD16(uParam0->f_35[0], 91, 0);
				unk_0xB7A7C917CF0448E6(uParam0->f_35[0], 0);
				unk_0x8F179C57E8564697(uParam0->f_35[0], 0, 2);
				unk_0x8F179C57E8564697(uParam0->f_35[0], 1, 1);
				unk_0x8F179C57E8564697(uParam0->f_35[0], 2, 1);
				unk_0x8F179C57E8564697(uParam0->f_35[0], 3, 1);
				unk_0x8F179C57E8564697(uParam0->f_35[0], 4, 1);
				unk_0x8F179C57E8564697(uParam0->f_35[0], 6, 0);
				unk_0x8F179C57E8564697(uParam0->f_35[0], 7, 2);
				unk_0x8F179C57E8564697(uParam0->f_35[0], 10, 0);
				unk_0x8F179C57E8564697(uParam0->f_35[0], 23, 20);
				unk_0x5D4B50E2007354F0(uParam0->f_35[0], 0, 2, 0);
				unk_0x5D4B50E2007354F0(uParam0->f_35[0], 1, 1, 0);
				unk_0x5D4B50E2007354F0(uParam0->f_35[0], 2, 1, 0);
				unk_0x5D4B50E2007354F0(uParam0->f_35[0], 3, 1, 0);
				unk_0x5D4B50E2007354F0(uParam0->f_35[0], 4, 1, 0);
				unk_0x5D4B50E2007354F0(uParam0->f_35[0], 6, 0, 0);
				unk_0x5D4B50E2007354F0(uParam0->f_35[0], 7, 2, 0);
				unk_0x5D4B50E2007354F0(uParam0->f_35[0], 10, 0, 0);
				unk_0x5D4B50E2007354F0(uParam0->f_35[0], 23, 20, 0);
				unk_0xA157CC58CEE29910(uParam0->f_35[0], 18, 1);
				unk_0xA157CC58CEE29910(uParam0->f_35[0], 17, 1);
				unk_0xA157CC58CEE29910(uParam0->f_35[0], 22, 1);
				unk_0xCDC1FD4387DA32EC(uParam0->f_35[0], 3);
				unk_0x1B098CDE9E6BB203(uParam0->f_35[0], 0);
				unk_0x82A70865B4EF1184(uParam0->f_35[0], 2);
				unk_0x941F924D5E9C2140(iVar0[1], 1);
				unk_0xD90C30D269B19096(uParam0->f_35[0]);
				unk_0x4EDE34FBADD967A6(0);
			}
			if (!unk_0xFD68187442384158(uParam0->f_35[1]))
			{
				func_219(&(uParam0->f_35[1]), iVar0[3], -91.07f, -1273.45f, 28.86f, 0.57f);
				unk_0x29CE15040B0080CB(uParam0->f_35[1], 10);
			}
			if (func_111(uParam0->f_28[0]))
			{
				func_218(&(uParam0->f_41[0]), iVar0[2], -71.93684f, -1259.078f, 28.19359f, -177.55f);
				unk_0x26030664C7D28388(uParam0->f_41[0], uParam0->f_28[0], unk_0xA8918EDB277FC51C(uParam0->f_28[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
			}
			if (bVar8)
			{
				iLocal_90 = 3;
		...
		case 3:
			...
			{
				uVar9 = unk_0xD33827A2E07C4BE6(uParam0->f_35[0], "chassis_dummy");
				Var10 = { unk_0xF72E61A2DB753A80(uParam0->f_35[0], uVar9) };
				uVar6 = unk_0x1BEDF9ACAEAB15F8(Var10, unk_0xAD9A5677421290F3(uParam0->f_35[0], 2), 2);
				unk_0x15B365C4645F79B8(uVar6, 1);
				unk_0x36069312B76436F6(uVar6, 0);
				unk_0x206610E40EE4D7D9(uParam0->f_28[0], uVar6, sVar7, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
				unk_0x8E759206778E571F(uParam0->f_28[0], unk_0x507DA4994C3D8EBD(), -1, 2050, 4);
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
			{
...
void func_239(int iParam0, bool bParam1)
{
	...
	unk_0x1D6153ECFEB26B2A(uLocal_93, 0);
	if (bParam1)
	{
		func_175(*iParam0);
	}
