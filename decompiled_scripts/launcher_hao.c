...
void __EntryFunction__()
{
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_104307[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_267("Relinquishing candidate id...");
				func_266(&(Global_104307[Var0.f_0 /*10*/].f_9));
			}
		}
		func_254(&Var0, 1);
	}
	...
	if (func_240(41))
	{
		func_267("SP_MISSION_FRANKLIN_1 is available... [TERMINATING]");
		unk_0x95E4B6F3ED223F5A();
	}
	else
	{
		func_267("SP_MISSION_FRANKLIN_1 is not available...");
	}
	while (!func_231(&Var0))
	{
	...
	uLocal_94 = unk_0x1DAA351326EA3537(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
	unk_0x6C5F5B5F6894CCE3(Var61, Var0.f_15, 1, 0, 0, 0);
	while (true)
	{
		unk_0x4EDE34FBADD967A6(0);
		if (!func_196(&Var0, 1))
		...
		if (func_240(41))
		{
			func_267("SP_MISSION_FRANKLIN_1 became available... [TERMINATING]");
			func_254(&Var0, 1);
		}
		else
		{
		...
		if (func_195(Var0.f_35[0]))
		{
			if (!func_194(-72.323f, -1258.643f, 28.648f, unk_0x541C2AEF053615BC(Var0.f_35[0], 1), 1056964608))
			{
				func_267("Player has moved HAO's vehicle [TERMINATING]");
				func_191(&Var0);
				func_254(&Var0, 1);
			}
		}
		func_190(Var0.f_0);
		func_183(&iLocal_93, &(Var0.f_9), Var61);
		func_178(&Var0, Var61, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
		if (func_164(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
{
	while (!Global_104307[*iParam0 /*10*/])
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	return 1;
...
int func_2(var* uParam0)
{
	...
	if (!func_163())
	{
		while (!func_154(*uParam0))
		{
			if (func_153(*uParam0))
			{
				func_144();
			}
			if (!func_196(uParam0, *uParam0 != 2))
			{
...
{
	func_21(sParam1);
	unk_0x7CB6FD92BE491AD9(&(Global_105220.f_18545[iParam0 /*6*/]), 5);
	...
	while (!unk_0xFA30DFD0084E92FE(Global_105220.f_18545[iParam0 /*6*/], 5))
	{
		if (unk_0xB731B8C5BCE89836(joaat("mission_stat_watcher")) > 0)
		{
			unk_0xF0059F27F7BB6680(&(Global_105220.f_18545[iParam0 /*6*/]), 5);
		}
	}
	func_4(iParam0);
}
...
void func_4(int iParam0)
{
	...
	MemCopy(&Global_55982, {func_9(iParam0)}, 4);
	Global_55970 = 0;
	Global_55969 = 0;
	switch (iParam0)
	{
	...
	if (!Global_55957)
	{
		if ((Global_68213 != iVar1 || Global_68062 == 0) || iVar0 != Global_68212)
		{
			Global_25527 = 0;
			func_10();
			func_6(iParam0);
	...
	Global_55995 = unk_0x105601648511CC64();
	func_5();
	Global_55967 = 0;
}
...
void func_5()
{
	...
	while (iVar0 < Global_68062)
	{
		switch (Global_56192[Global_68063[iVar0 /*9*/] /*13*/])
		{
			...
			case 6:
				if (Global_56192[Global_68063[iVar0 /*9*/] /*13*/].f_3)
				{
...
void func_7(int iParam0)
{
	...
	func_8(Global_68062);
	Global_68063[Global_68062 /*9*/] = iParam0;
	Global_68062++;
	if (Global_56192[iParam0 /*13*/] == 16)
	{
		Global_68214 = 1;
	}
}
...
{
	Global_68063[iParam0 /*9*/].f_1 = 0;
	Global_68063[iParam0 /*9*/].f_2 = 0f;
	Global_68063[iParam0 /*9*/].f_3 = 0;
	Global_68063[iParam0 /*9*/].f_4 = 0;
}
...
{
	Global_55986 = 0;
	Global_55990 = func_15(joaat("sp0_shots"));
	Global_55989 = func_15(joaat("sp0_hits"));
	Global_55992 = func_15(joaat("sp1_shots"));
	Global_55991 = func_15(joaat("sp1_hits"));
	Global_55994 = func_15(joaat("sp2_shots"));
	Global_55993 = func_15(joaat("sp2_hits"));
}
...
void func_23(char[4] cParam0, int iParam1, int iParam2)
{
	if (Global_92955 != 10 && Global_92955 != 9)
	{
		...
		func_25(&Global_95814, cParam0, 0, "Start", iParam1, iParam2);
		func_24();
		Global_87278 = 0;
	}
}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_102();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_54())
		{
			func_47(unk_0xBC25C936A095B5BA(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
	...
	if (unk_0xE59B7F5A03335350(iParam0, 0))
	{
		...
		*uParam1 = unk_0x89FC8F09D6647DEC(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xF0059F27F7BB6680(&(uParam1->f_77), func_38(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_47(int iParam0, var uParam1, int iParam2)
{
	...
	if (!unk_0x36CEFBE9B745A58D(iParam0))
	{
		...
		else if (unk_0x7AF0088ABFA713B6() && unk_0x6F79ECA8C83E4357(iParam0) == unk_0x6F79ECA8C83E4357(unk_0xBC25C936A095B5BA()))
		{
			if (func_51(161, -1))
			{
				uParam1->f_59 = func_48(2051, Global_70790, 0);
			}
			else
			{
				uParam1->f_59 = func_48(752, Global_70790, 0);
			}
			uParam1->f_60 = func_48(753, Global_70790, 0);
			uParam1->f_61 = func_48(754, Global_70790, 0);
		}
...
int func_48(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2530245[iParam0 /*3*/][func_49(iParam1)];
...
int func_51(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2557346[iParam0 /*3*/][func_49(iParam1)];
...
void func_55()
{
	...
	{
		if (func_46(Global_105220.f_2354.f_539.f_4301) != unk_0x6F79ECA8C83E4357(unk_0xBC25C936A095B5BA()))
		{
			iVar0 = func_45(unk_0xBC25C936A095B5BA());
			if (func_36(iVar0) && (!func_56(14) || Global_104171))
			{
				if (Global_105220.f_2354.f_539.f_4301 != iVar0 && func_36(Global_105220.f_2354.f_539.f_4301))
				{
...
void func_57(int iParam0, bool bParam1)
{
	...
	if (func_36(iVar0) && !unk_0x36CEFBE9B745A58D(iParam0))
	{
		if (iParam0 == unk_0xBC25C936A095B5BA())
		{
			func_58(iParam0, &(Global_105220.f_2354.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_58(int iParam0, var uParam1)
{
	...
	if (!unk_0x36CEFBE9B745A58D(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0xFEBBB8B5E3A12A20(iParam0, func_63(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((unk_0x6740839132C4BD08(iVar9, &Var11) && !func_60(Var11.f_1)) && iVar72 < 50)
			{
...
int func_69(var uParam0)
{
	if (!unk_0x1D403DFADBC2DE3C(unk_0xBC25C936A095B5BA(), 0) && !unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
	{
		if (func_90())
		{
			*uParam0 = func_75(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 0), 6, -1, 0, 1, -1);
...
int func_75(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 48)
	{
		if (iParam3 == 6 || iParam3 == func_89(iVar0))
		{
			...
			{
				fVar1 = unk_0xF0F2FC9DE291567F(Param0, func_76(iVar0, 0), 1);
...
Vector3 func_76(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_87(Global_95018);
			break;
		
		case 46:
			if (Global_1589135 != func_86())
			{
				if (func_85(Global_1589135))
				{
					return func_78(2, 2);
				}
				else if (func_77(Global_1589135))
				{
					return func_78(45, 3);
				}
				else
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}
...
void func_104(char* sParam0, var uParam1, int iParam2)
{
	...
	unk_0xFC3106D886D77FE2(sParam0, uParam1, iParam2, func_105(0));
}
...
int func_110(var* uParam0)
{
	...
	{
		if (!unk_0xF1734B55490E9045(&(uParam0->f_9)))
		{
			func_130(1);
		...
		func_111(*uParam0);
		iVar0 = unk_0xB8BA7F44DF1575E1(&(uParam0->f_1), uParam0, 61, 23500);
		unk_0x91DEC7187FA01089(&(uParam0->f_1));
...
void func_111(int iParam0)
{
	...
	if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
	{
		...
		unk_0xC8FD3EBBB90E8D7F(unk_0xBC25C936A095B5BA(), 250, 0);
	}
	if (func_125(iParam0))
	{
...
void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
...
int func_140(char* sParam0)
{
	...
	{
		unk_0x63831D2D5110C305(uParam0);
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
int func_154(int iParam0)
{
	...
	iVar0 = func_156(&(Global_104307[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
{
	Global_104307[iParam0 /*10*/].f_4 = 1;
	Global_104307[iParam0 /*10*/].f_5 = 0;
	Global_104307[iParam0 /*10*/].f_6 = 0;
	Global_104307[iParam0 /*10*/] = 0;
}
...
int func_164(var uParam0, int iParam1)
{
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					if (func_124(uParam0->f_28[0]))
					{
						if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 1), unk_0x541C2AEF053615BC(uParam0->f_28[0], 1), 1) < 3f)
						{
							if (func_169(2))
							{
								if (func_168(uParam0->f_27))
								{
									func_167(uParam0->f_27, *uParam0);
			...
			{
				if ((((!unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -1895.788f, -434.0192f, 40.30126f, -1883.038f, -444.0811f, 50.24509f, 8.5f, 0, 1, 0) && !unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -1883.576f, -443.6434f, 36.40581f, -1874.826f, -448.0797f, 49.15162f, 8.5f, 0, 1, 0)) && !unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -1876.343f, -446.2214f, 35.64637f, -1866.952f, -456.5601f, 49.0442f, 8.5f, 0, 1, 0)) && !unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -1882.997f, -438.9922f, 44.17246f, -1874.079f, -443.342f, 48.69179f, 0.75f, 0, 1, 0)) || unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -1878.822f, -441.7655f, 44.9175f, -1877.941f, -439.9522f, 47.28982f, 1.25f, 0, 1, 0))
				{
					if (func_124(uParam0->f_28[0]))
					{
						if (func_166(uParam0))
			...
			{
				if (!unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 837.0731f, 1261.086f, 366.1592f, 780.8383f, 1260.829f, 351.405f, 17.75f, 0, 1, 0))
				{
					if (func_124(uParam0->f_28[0]))
					{
						if (func_166(uParam0))
		...
		case 2:
			...
			{
				if (unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), uParam0->f_35[0], 0))
				{
					if (func_169(3))
					{
						func_167(uParam0->f_27, *uParam0);
		...
		case 1:
			...
			{
				if (!unk_0x1D403DFADBC2DE3C(uParam0->f_35[0], 0))
				{
					if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 1), unk_0x541C2AEF053615BC(uParam0->f_35[0], 1), 1) < uParam0->f_15)
					{
						if (func_169(2))
						{
							if (func_168(uParam0->f_27))
		...
		case 3:
			if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 1), uParam0->f_17[0 /*3*/], 1) < uParam0->f_15)
			{
				if (func_169(2))
				{
					if (func_168(uParam0->f_27))
		...
		case 4:
			if (unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), uParam0->f_17[0 /*3*/], uParam0->f_17[1 /*3*/], 0, 1, 0))
			{
				if (func_169(2))
				{
					if (func_168(uParam0->f_27))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
				{
					if (func_124(unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0)))
					{
						...
						{
							if (unk_0x27C9F6C1391327CF(unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0), uParam0->f_35[0]))
							{
								if (func_169(3))
								{
									return 1;
						...
						{
							if (unk_0x3E7A19282640095F(unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0)) && unk_0xAEA754DE0733E937(unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0), uParam0->f_35[0]))
							{
								if (func_169(3))
								{
									return 1;
			...
			else if (*uParam0 == 10)
			{
				...
				{
					if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 245.8885f, 371.9034f, 103.9884f, 241.5898f, 359.6458f, 107.3461f, 1.25f, 0, 1, 0))
					{
						if (func_169(2))
						{
							if (func_168(uParam0->f_27))
			...
			{
				if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -164.2046f, 277.4866f, 91.55322f, -153.6f, 277.4061f, 97.33813f, 10f, 0, 1, 0))
				{
					return 0;
				}
			}
			...
			{
				if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 2728.948f, 4143.44f, 42.29295f, 2722.213f, 4144.521f, 45.43182f, 10f, 0, 1, 0))
				{
					if (func_169(2))
					{
						if (func_168(1))
			...
			{
				if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -992.4995f, 358.7455f, 96.3735f, -1021.94f, 361.8888f, 65.36148f, 30f, 0, 1, 0))
				{
					if (!unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -983.5426f, 369.1104f, 68.46017f, -1028.566f, 395.4613f, 94.57245f, 15f, 0, 1, 0))
					{
						if (!unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -983.875f, 346.7556f, 68.02096f, -1021.451f, 336.3458f, 93.18714f, 14.5f, 0, 1, 0))
						{
							if (func_169(2))
							{
								if (func_168(uParam0->f_27))
			...
			if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), uParam0->f_17[0 /*3*/], uParam0->f_17[1 /*3*/], uParam0->f_24, 0, 1, 0))
			{
				if (*uParam0 == 45)
				{
					if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 2338.697f, 2597.037f, 45.39052f, 2324.003f, 2597.185f, 47.74961f, 8.5f, 0, 1, 0))
					{
						return 0;
					}
				}
...
void func_165()
{
	func_27(&(Global_95814.f_2875), &Global_95814, 0, 1, 1, 0);
}
...
int func_166(var uParam0)
{
	...
	if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0) && uParam0->f_27)
	{
		...
		if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 1), unk_0x541C2AEF053615BC(uParam0->f_28[0], 1), 1) < (uParam0->f_15 + fVar0))
		{
			return 1;
		}
	}
	else if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 1), unk_0x541C2AEF053615BC(uParam0->f_28[0], 1), 1) < uParam0->f_15)
	{
		return 1;
	}
	return 0;
	...
	if (iParam0 == 1)
	{
		...
		if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
		{
			...
			if (unk_0xE3CA72BD77D43B09(unk_0xBC25C936A095B5BA()) || unk_0x57379381A330B2FF(unk_0xBC25C936A095B5BA()))
			{
				...
				unk_0x2D655AA68FA1736B(unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0), 0, 1, 0);
			}
			func_144();
		}
	}
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_177()) || Global_104267) || Global_25279) || func_176()) || func_175(8, -1)) || func_90()) || func_174()) || func_173()) || func_172()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1) || func_177()) || Global_25279) || func_176()) || func_175(8, -1)) || func_173()) || func_90()) || func_174()) || func_172()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_177()) || Global_104267) || Global_25279) || func_176()) || func_175(8, -1)) || func_173()) || func_90()) || func_174()) || func_172()) || Global_105220.f_7659.f_919[iVar0] == 5) || Global_36452 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA()) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_177()) || Global_104267) || Global_25279) || func_176()) || func_175(8, -1)) || func_90()) || func_174()) || func_172()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_177() || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || func_175(8, -1)) || func_172()) || func_171()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_175(8, -1) || func_90()) || func_174()) || func_171()) || func_170())
						{
							return 0;
						}
					...
					case 6:
						if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
						{
							if ((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || func_177()) || Global_25279) || func_176()) || func_175(8, -1)) || func_174()) || func_173()) || func_172()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || !unk_0x8CC5A4A5615C6420(unk_0xB5CEFD608600A09F())) || !unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F())) || !unk_0x726D9204B160D23E()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || func_177()) || func_174()) || Global_104267) || Global_25279) || func_176()) || Global_37057) || func_175(8, -1)) || func_173()) || func_171()) || func_172()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_178(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_124(unk_0xBC25C936A095B5BA()) && func_124(uParam0->f_28[0])) && !func_143()) && (unk_0x105601648511CC64() - uParam0->f_60) > iParam8) && func_182(unk_0xBC25C936A095B5BA(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_181(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_179(&uVar0, cParam4, sParam5, 7, 0, 0);
		uParam0->f_60 = unk_0x105601648511CC64();
		return 1;
	}
	return 0;
}

void func_179(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	func_180(uParam0, 145, sParam1, iParam4, iParam5, 0);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_183(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (!unk_0xF1734B55490E9045(sParam1))
		{
			...
			{
				if (func_182(unk_0xBC25C936A095B5BA(), Param2, 1) <= 100f)
				{
					func_186(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_182(unk_0xBC25C936A095B5BA(), Param2, 1) > 120f)
				{
					func_188(iParam0);
				}
			}
...
int func_185(int iParam0)
{
	if (Global_70974 == iParam0)
	{
		if (Global_70975 == -1)
		{
			if (Global_70973 < unk_0xC87A57742F7D3C06())
			{
				return 1;
			}
		}
...
void func_186(int iParam0, int iParam1)
{
	...
	if (Global_70971 < 5)
	{
		Global_70960[Global_70971 /*2*/] = 0;
		Global_70960[Global_70971 /*2*/].f_1 = iParam1;
		bVar0 = false;
		while (!bVar0)
		{
			bVar0 = true;
			iVar1 = 0;
			while (iVar1 < Global_70971)
			{
				if (Global_70960[iVar1 /*2*/] == Global_70960[Global_70971 /*2*/])
				{
					Global_70960[Global_70971 /*2*/]++;
					bVar0 = false;
				}
				iVar1++;
			}
		}
		*iParam0 = Global_70960[Global_70971 /*2*/];
		Global_70971++;
		Global_70972 = 1;
	}
	else
...
void func_190(int iParam0)
{
	...
	Global_104307[iParam0 /*10*/].f_1 = 1;
}
...
void func_191(var uParam0)
{
	...
	if (func_124(unk_0xBC25C936A095B5BA()))
	{
		...
		while (iVar0 <= (uParam0->f_28 - 1))
		{
			...
			{
				if (!unk_0x5237AF95232D78C5(uParam0->f_28[iVar0], 0))
				{
					unk_0xD434A01DEA38A939(uParam0->f_28[iVar0], 1, 0);
					unk_0x346478B12F69D4E3(uParam0->f_28[0], 0);
				}
				unk_0x22321800954A532E(uParam0->f_28[iVar0], 1);
				if (*uParam0 == 34)
				{
					if (func_124(uParam0->f_41[0]))
					{
						unk_0xD434A01DEA38A939(uParam0->f_41[0], 1, 0);
						unk_0x346478B12F69D4E3(uParam0->f_41[0], 0);
					}
				}
				switch (*uParam0)
				{
					case 19:
						func_192(uParam0->f_28[iVar0]);
						break;
					...
					case 8:
						...
						unk_0xA8E6405305C0D7DF(uParam0->f_28[iVar0], uVar1);
					...
					default:
						unk_0xD999D66C5AFA4BE3(uParam0->f_28[iVar0]);
						unk_0x5558ED6D4A2DEC93(uParam0->f_28[iVar0], unk_0xBC25C936A095B5BA(), 10000f, -1, 0, 0);
						break;
					}
			}
			iVar0++;
...
void func_192(int iParam0)
{
	...
	if (func_124(unk_0xBC25C936A095B5BA()) && func_124(uParam0))
	{
...
int func_194(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_196(var uParam0, bool bParam1)
{
	...
	func_107(*uParam0, &Var0);
	if ((func_230(*uParam0) || func_228(*uParam0)) || Global_71223 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
	...
	if (uParam0->f_16 == 2 || uParam0->f_16 == 1)
	{
		if (func_124(uParam0->f_35[0]))
		{
			if (!unk_0x4DBCE270B354E123(uParam0->f_35[0], Var0.f_6, 8f, 8f, 8f, 0, 1, 0))
			{
				return 0;
			}
		}
	...
	if (*uParam0 == 10)
	{
		if (unk_0xC9FA5D38428AB6BE(-1, uParam0->f_17[0 /*3*/], 8f))
		{
	...
	if (Var0.f_4 != 17)
	{
		if (!unk_0xFA30DFD0084E92FE(Var0.f_26, func_102()))
		{
...
void func_197(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_124(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_199(uParam1) || !unk_0x96044E39418AAF17(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_198(iParam2) && !unk_0xC5B8A5F778E321DD(iParam0, unk_0xBC25C936A095B5BA(), 25f))
					{
						unk_0x85DB484A637CEAB9(iParam0, unk_0xBC25C936A095B5BA(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_199(uParam1) && uParam1->f_4 == 0) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 1), unk_0x541C2AEF053615BC(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_198(iParam2) || unk_0xC5B8A5F778E321DD(iParam0, unk_0xBC25C936A095B5BA(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0xE896C0AD02364F2A(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
void func_201(var uParam0)
{
	...
	if (func_124(unk_0xBC25C936A095B5BA()))
	{
		...
		while (iVar0 <= (uParam0->f_28 - 1))
		{
			if (func_123(uParam0->f_28[iVar0]))
			{
				unk_0x91629AC1E1F78419(uParam0->f_28[iVar0], 1, 0);
				unk_0x2E35C4FA5F0ED22F(uParam0->f_28[iVar0], 0);
				unk_0x22321800954A532E(uParam0->f_28[iVar0], 1);
				unk_0xB8CBD998685C0685(uParam0->f_28[iVar0], unk_0xBC25C936A095B5BA(), 0, 16);
				unk_0x02537C8C1BEEB477(&(uParam0->f_28[iVar0]));
			}
			iVar0++;
		}
	}
	...
	if (func_123(unk_0xBC25C936A095B5BA()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (unk_0x724D816EA203A79E(uParam0->f_35[iVar0]))
			{
				...
				if (unk_0x8D66276473ABD7CC(uParam0->f_35[iVar0]) < 850)
				{
				...
				if (bParam2)
				{
					if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
					{
						if (unk_0xE921F8171F0733B3(uParam0->f_35[iVar0], unk_0xBC25C936A095B5BA()) && unk_0x8910237449BB6F79(unk_0xBC25C936A095B5BA()) > 5f)
						{
						...
						uVar2 = unk_0x3E12B546F3F2597A();
						if (func_195(uVar2))
						{
							if (unk_0x6F79ECA8C83E4357(uVar2) == joaat("towtruck") || unk_0x6F79ECA8C83E4357(iVar2) == joaat("towtruck2"))
							{
								if (func_195(uParam0->f_35[iVar0]))
								{
									if (unk_0x27C9F6C1391327CF(iVar2, uParam0->f_35[iVar0]))
									{
					...
					else
					{
						...
						if (func_195(iVar3))
						{
							if (unk_0xE921F8171F0733B3(uParam0->f_35[iVar0], iVar3) && unk_0x8910237449BB6F79(iVar3) > 6f)
							{
						...
						if (*uParam0 == 16)
						{
							if (func_203(unk_0xBC25C936A095B5BA(), uParam0->f_35[iVar0]))
							{
...
int func_204(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_123(unk_0xBC25C936A095B5BA()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (unk_0x724D816EA203A79E(uParam0->f_28[iVar0]))
			{
				if (!unk_0x36CEFBE9B745A58D(uParam0->f_28[iVar0]))
				{
					if (unk_0xCBBE5AFE2CD2E9B6(unk_0xBC25C936A095B5BA()))
					{
						if (unk_0xE921F8171F0733B3(unk_0xBC25C936A095B5BA(), uParam0->f_28[iVar0]))
						{
							if (iParam2 == 0)
							{
								func_191(uParam0);
					...
					if ((unk_0x48EBE45A9A7EB10C(uParam0->f_28[iVar0]) || unk_0x127812AA6652253F(uParam0->f_28[iVar0])) || unk_0xA0ABD1D1512F5AFC(uParam0->f_28[iVar0]))
					{
						if (iParam2 == 0)
						{
							func_191(uParam0);
					...
					if (unk_0x2CDE18D6C89522AD(uParam0->f_28[iVar0]))
					{
						if (unk_0xE642C1AC73CE364E(uParam0->f_28[iVar0], unk_0xBC25C936A095B5BA(), 3f, 3f, 3f, 0, 1, 0))
						{
							if (iParam2 == 0)
							{
								func_191(uParam0);
					...
					if (func_223(*uParam0))
					{
						...
						if (unk_0xC9FA5D38428AB6BE(-1, unk_0x541C2AEF053615BC(uParam0->f_28[iVar0], 1), 15f))
						{
							if (iParam2 == 0)
							{
								func_191(uParam0);
					...
					if (!func_205(*uParam0))
					{
						if (unk_0xC9FA5D38428AB6BE(-1, unk_0x541C2AEF053615BC(uParam0->f_28[iVar0], 1), 5f))
						{
							if (iParam2 == 0)
							{
								func_191(uParam0);
...
int func_206(int iParam0, float fParam1)
{
	...
	{
		if (func_217(iParam0) || unk_0x425BEBAA53B39EBF(unk_0xB5CEFD608600A09F(), iParam0))
		{
...
{
	return func_208(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_208(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_216(iParam0, iParam1);
	if (!func_124(iParam0) || !func_124(iParam1))
	{
		if (iVar4 != -1)
		{
			func_215(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_209(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x105601648511CC64() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_209(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_212(int iParam0, int iParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_214(unk_0x541C2AEF053615BC(iParam1, 1) - unk_0x541C2AEF053615BC(iParam0, 1)) };
	...
	{
		Var3 = { func_214(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_213(Var3, Var0);
...
float func_213(struct<3> Param0, struct<3> Param3)
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_214(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
int func_218(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_124(unk_0xBC25C936A095B5BA()) && func_124(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_222(uParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_219(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_220(var uParam0, float fParam1)
{
	...
	{
		if (func_221(uParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_221(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_214(Param1 - unk_0x541C2AEF053615BC(uParam0, 1)) };
...
int func_222(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_224(int iParam0)
{
	...
	if (!unk_0xFA30DFD0084E92FE(Global_105220.f_18545[iParam0 /*6*/], 2))
	{
		return 1;
	}
	return 0;
...
{
	if ((func_229() && Global_92955.f_11 == 6) && iParam0 == func_162(&(Global_92955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_230(int iParam0)
{
	if (func_105(0))
	{
		if (Global_71224.f_1 == 7)
		{
			if (Global_71224 == iParam0)
			{
				return 1;
			}
		}
...
int func_232(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x522053D86D6E1C7A(sVar7);
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_239(&iVar0) || !unk_0xF9E082857622D91E(sVar7))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				if (!func_236(&(uParam0->f_28[0]), 53, -71.93684f, -1259.7f, 28.19359f, -177.55f, "HAO LAUNCHER RC - HAO", 1))
				{
					bVar8 = false;
				}
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_35[0]))
			{
				func_234(&(uParam0->f_35[0]), iVar0[1], -72.3226f, -1258.643f, 28.1915f, 90.8326f);
				unk_0x914C5DE0B15B8B59(uParam0->f_35[0], 38, 0);
				unk_0x4C59702AC1076A88(uParam0->f_35[0], 91, 0);
				unk_0x1345B3BF11EDB0CF(uParam0->f_35[0], 0);
				unk_0xAC5CA95BB98F2400(uParam0->f_35[0], 0, 2);
				unk_0xAC5CA95BB98F2400(uParam0->f_35[0], 1, 1);
				unk_0xAC5CA95BB98F2400(uParam0->f_35[0], 2, 1);
				unk_0xAC5CA95BB98F2400(uParam0->f_35[0], 3, 1);
				unk_0xAC5CA95BB98F2400(uParam0->f_35[0], 4, 1);
				unk_0xAC5CA95BB98F2400(uParam0->f_35[0], 6, 0);
				unk_0xAC5CA95BB98F2400(uParam0->f_35[0], 7, 2);
				unk_0xAC5CA95BB98F2400(uParam0->f_35[0], 10, 0);
				unk_0xAC5CA95BB98F2400(uParam0->f_35[0], 23, 20);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_35[0], 0, 2, 0);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_35[0], 1, 1, 0);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_35[0], 2, 1, 0);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_35[0], 3, 1, 0);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_35[0], 4, 1, 0);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_35[0], 6, 0, 0);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_35[0], 7, 2, 0);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_35[0], 10, 0, 0);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_35[0], 23, 20, 0);
				unk_0xB25E25030D61B529(uParam0->f_35[0], 18, 1);
				unk_0xB25E25030D61B529(uParam0->f_35[0], 17, 1);
				unk_0xB25E25030D61B529(uParam0->f_35[0], 22, 1);
				unk_0xD421BC740C5340C3(uParam0->f_35[0], 3);
				unk_0x17BBC63824839F77(uParam0->f_35[0], 0);
				unk_0x93D3868AE0D83B7C(uParam0->f_35[0], 2);
				unk_0x8510BC031C24B862(iVar0[1], 1);
				unk_0xF0A40F19AAB79E88(uParam0->f_35[0], 1084227584);
				unk_0x4EDE34FBADD967A6(0);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_35[1]))
			{
				func_234(&(uParam0->f_35[1]), iVar0[3], -91.07f, -1273.45f, 28.86f, 0.57f);
				unk_0x6012A6A4F2950585(uParam0->f_35[1], 10);
			}
			if (func_124(uParam0->f_28[0]))
			{
				func_233(&(uParam0->f_41[0]), iVar0[2], -71.93684f, -1259.078f, 28.19359f, -177.55f);
				unk_0x5DBE04849460E608(uParam0->f_41[0], uParam0->f_28[0], unk_0xFA18E720A39243D0(uParam0->f_28[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
			}
			if (bVar8)
			{
				iLocal_91 = 3;
		...
		case 3:
			if (func_123(uParam0->f_28[0]) && func_195(uParam0->f_35[0]))
			{
				uVar9 = unk_0xB5B60A04E1654409(uParam0->f_35[0], "chassis_dummy");
				Var10 = { unk_0x3EA3A28A85F8C32F(uParam0->f_35[0], uVar9) };
				uVar6 = unk_0xD0D858E538FD01C3(Var10, unk_0xD7490CDEF40F3DA2(uParam0->f_35[0], 2), 2);
				unk_0xC2BF3DE5E47F801D(uVar6, 1);
				unk_0x69D4A898629B0BDA(uVar6, 0);
				unk_0xB62398E536F695FC(uParam0->f_28[0], uVar6, sVar7, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
				unk_0x56F2E1B5599188FA(uParam0->f_28[0], unk_0xBC25C936A095B5BA(), -1, 2050, 4);
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
			{
...
void func_234(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_235(uParam0);
...
int func_236(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_237(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0x724D816EA203A79E(*uParam0))
		{
			if (!unk_0x1D403DFADBC2DE3C(*uParam0, 0))
...
int func_237(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	int iVar0;
...
int func_241(int iParam0)
{
	...
	if (!unk_0xFA30DFD0084E92FE(Var0.f_26, iVar32))
	{
		return 1;
	}
	return 0;
...
int func_242(int iParam0)
{
	...
	if (!Global_105220.f_9056 && !func_105(1))
	{
	...
	if (Global_92955.f_11 == 6)
	{
		if (Global_92955 < 9)
		{
			func_107(iParam0, &sVar0);
			if (unk_0x3362CDE8460ED38B(&(Global_92955.f_3), sVar0))
			{
...
int func_243(int iParam0)
{
	...
	if (iParam0 == 58)
	{
		if (func_244(5))
		{
			Global_104307[iParam0 /*10*/].f_3 = 0;
		}
	}
	if (Global_104307[iParam0 /*10*/].f_3 == 1)
	{
		return 0;
	}
	return 1;
...
int func_244(int iParam0)
{
	...
	else if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
	{
		...
		iVar9 = unk_0x5E29F9399E0829A3(Global_88138[iParam0 /*10*/].f_3, &sVar1);
		if (iVar9 != 0 && Global_93007.f_319 == iVar9)
		{
			return 1;
		}
	}
...
bool func_247(int iParam0)
{
	...
	return unk_0xFA30DFD0084E92FE(Global_105220.f_18545[iParam0 /*6*/], 2);
}
...
bool func_248(int iParam0)
{
	...
	return unk_0xFA30DFD0084E92FE(Global_105220.f_18545[iParam0 /*6*/], 0);
}
...
int func_252(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	...
	{
		if (unk_0xFA30DFD0084E92FE(Global_105220.f_18545[iParam0 /*6*/], 0))
		{
...
void func_254(int iParam0, bool bParam1)
{
	...
	unk_0x483687B0FCA5415A(uLocal_94, 0);
	if (bParam1)
	{
		func_190(*iParam0);
	}
...
void func_263(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_264(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_264(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (unk_0x724D816EA203A79E(*uParam0))
	{
