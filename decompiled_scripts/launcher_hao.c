...
void __EntryFunction__()
{
	...
	{
		func_254("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_100640[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_254("Relinquishing candidate id...");
				func_253(&(Global_100640[Var0.f_0 /*10*/].f_9));
			}
		}
		func_241(&Var0, 1);
	}
	iVar64[0] = 24;
	if (!func_238(&iVar64, &Var0, Var61, 1f))
	{
		func_237();
		func_254("SCRIPT TERMINATED");
		unk_0x78C587487CD40B92();
	}
	if (!func_229(Var0.f_0))
	{
		func_237();
		func_254("SCRIPT TERMINATED");
		unk_0x78C587487CD40B92();
	}
	if (func_228(Var0.f_0))
	{
		func_237();
		func_254("SCRIPT TERMINATED");
		unk_0x78C587487CD40B92();
	...
	if (func_227(41))
	{
		func_254("SP_MISSION_FRANKLIN_1 is available... [TERMINATING]");
		unk_0x78C587487CD40B92();
	}
	else
	{
		func_254("SP_MISSION_FRANKLIN_1 is not available...");
	}
	while (!func_218(&Var0))
	{
		...
		{
			func_254("Player out of range [TERMINATING]");
			func_241(&Var0, 1);
		}
	}
	uLocal_94 = unk_0x6A173E5A316F6DE8(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		if (func_227(41))
		{
			func_254("SP_MISSION_FRANKLIN_1 became available... [TERMINATING]");
			func_241(&Var0, 1);
		}
		else
		{
		...
		if (func_182(Var0.f_35[0]))
		{
			if (!func_181(-72.323f, -1258.643f, 28.648f, unk_0xC59DF10B4FC39DF8(Var0.f_35[0], 1), 1056964608))
			{
				func_254("Player has moved HAO's vehicle [TERMINATING]");
				func_178(&Var0);
				func_241(&Var0, 1);
			}
		}
		func_177(Var0.f_0);
		func_170(&iLocal_93, &(Var0.f_9), Var61);
		func_165(&Var0, Var61, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
		if (func_151(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_2(var* uParam0)
{
	...
	if (!func_150())
	{
		while (!func_141(*uParam0))
		{
			if (func_140(*uParam0))
			{
				func_132();
			}
			if (!func_183(uParam0, *uParam0 != 2))
			{
				func_254("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			unk_0x4EDE34FBADD967A6(0);
		}
	...
	if (!func_98(uParam0))
	{
		func_254("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
int func_98(var* uParam0)
{
	...
	if (func_128(&(uParam0->f_1)))
	{
		...
		{
			func_254("Initial cutscene loaded and passing to RC mission.");
			unk_0x8894F50D634D5984(iVar0);
		}
		else
		{
			func_254("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_119(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (unk_0xA86CA03D9749EEB3())
		{
			if (((!unk_0xEB361B4BD195A4D3(unk_0xA0081090911D13E5()) && !func_123(unk_0x0C1D3C552325765B())) && !func_121(unk_0x0C1D3C552325765B(), 0)) && !func_120())
			{
				unk_0x39800A40136ECF37(unk_0xA0081090911D13E5(), 0);
			}
		}
		else if (!unk_0xEB361B4BD195A4D3(unk_0xA0081090911D13E5()) && !func_123(unk_0x0C1D3C552325765B()))
		{
			unk_0x39800A40136ECF37(unk_0xA0081090911D13E5(), 0);
		}
		Global_69615 = 0;
...
int func_128(char* sParam0)
{
	...
	func_254("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}
...
void func_133()
{
	if (unk_0xC0691D80D21C989D(unk_0x0C1D3C552325765B()))
	{
		if (unk_0x39FEE545B315414E(unk_0xA0081090911D13E5(), 0))
		{
			if (func_134(unk_0xF8DB47D339B8B953(unk_0xA0081090911D13E5(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_141(int iParam0)
{
	...
	iVar0 = func_143(&(Global_100640[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
{
	return func_146(iParam0, Global_35775);
}
...
int func_148()
{
	return func_149(unk_0x367152330DB70D69(), 0);
}
	...
	switch (uParam0->f_16)
	{
				...
				if (unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					if (func_112(uParam0->f_28[0]))
					{
						if (unk_0x999A157665D69393(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), unk_0xC59DF10B4FC39DF8(uParam0->f_28[0], 1), 1) < 3f)
						{
							if (func_156(2))
							{
								if (func_155(uParam0->f_27))
								{
									func_154(uParam0->f_27, *uParam0);
									func_254("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (unk_0x39FEE545B315414E(unk_0xA0081090911D13E5(), 0))
				{
					if (func_112(unk_0xF8DB47D339B8B953(unk_0xA0081090911D13E5(), 0)))
					{
				...
				if (unk_0x4B1467B1A6A35A02(unk_0xA0081090911D13E5()) >= 2f)
				{
					if (unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), 245.8885f, 371.9034f, 103.9884f, 241.5898f, 359.6458f, 107.3461f, 1.25f, 0, 1, 0))
					{
						if (func_156(2))
						{
							...
							{
								func_154(uParam0->f_27, *uParam0);
								func_254("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), 2728.948f, 4143.44f, 42.29295f, 2722.213f, 4144.521f, 45.43182f, 10f, 0, 1, 0))
				{
					if (func_156(2))
					{
						...
						{
							func_154(1, *uParam0);
							func_254("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), -983.5426f, 369.1104f, 68.46017f, -1028.566f, 395.4613f, 94.57245f, 15f, 0, 1, 0))
					{
						if (!unk_0xFD4DDA3E1EF89C67(unk_0xA0081090911D13E5(), -983.875f, 346.7556f, 68.02096f, -1021.451f, 336.3458f, 93.18714f, 14.5f, 0, 1, 0))
						{
							if (func_156(2))
							{
								...
								{
									func_154(uParam0->f_27, *uParam0);
									func_254("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_154(int iParam0, int iParam1)
{
	if (iParam0 == 1)
	{
		...
		if (unk_0x39FEE545B315414E(unk_0xA0081090911D13E5(), 0))
		{
			func_254("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (unk_0x496D383FB5E4FEC8(unk_0xA0081090911D13E5()) || unk_0xD73333C5744EC59F(unk_0xA0081090911D13E5()))
			{
				func_254("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
		...
		if (unk_0xD3FACCDA4D66AEAD(unk_0xA0081090911D13E5()))
		{
			if (!unk_0xEB361B4BD195A4D3(unk_0xA0081090911D13E5()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xE7B06BF48958E63C(unk_0x0C1D3C552325765B(), 1) || func_164()) || Global_25187) || func_163()) || func_162(8, -1)) || func_160()) || func_78()) || func_161()) || func_159()) || Global_101553.f_6543.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0xB8E921FDBC0BA08C(unk_0x0C1D3C552325765B()) || unk_0x630BD2AFB0686BBA(unk_0xA0081090911D13E5())) || unk_0x69FEFE28E1352842(unk_0xA0081090911D13E5())) || unk_0xFFE4F37124DBE6D9(unk_0xA0081090911D13E5())) || unk_0x96E535A40E0E0B83(unk_0xA0081090911D13E5())) || unk_0xE7B06BF48958E63C(unk_0x0C1D3C552325765B(), 1)) || unk_0x2FFAB3D2307F1BA7(unk_0x0C1D3C552325765B())) || unk_0x019E78F3A1071807(unk_0xA0081090911D13E5(), 0)) || func_164()) || Global_100600) || Global_25187) || func_163()) || func_162(8, -1)) || func_160()) || func_78()) || func_161()) || func_159()) || Global_101553.f_6543.f_919[iVar0] == 5) || Global_36322 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0xFFE4F37124DBE6D9(unk_0xA0081090911D13E5()) || unk_0x96E535A40E0E0B83(unk_0xA0081090911D13E5())) || unk_0xE7B06BF48958E63C(unk_0x0C1D3C552325765B(), 1)) || unk_0x019E78F3A1071807(unk_0xA0081090911D13E5(), 0)) || func_164()) || Global_100600) || Global_25187) || func_163()) || func_162(8, -1)) || func_78()) || func_161()) || func_159()) || Global_101553.f_6543.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_164() || unk_0x7DC70BB637724B43(unk_0x0C1D3C552325765B()) > 0) || func_162(8, -1)) || func_159()) || func_158()) || Global_101553.f_6543.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_162(8, -1) || func_78()) || func_161()) || func_158()) || func_157())
						{
							return 0;
						}
					...
					case 7:
						if ((((((((((((((((((unk_0x019E78F3A1071807(unk_0xA0081090911D13E5(), 0) || !unk_0xDC48E9E2CC7437D3(unk_0x0C1D3C552325765B())) || !unk_0xB8E921FDBC0BA08C(unk_0x0C1D3C552325765B())) || !unk_0xB20CA7A3EE29687A()) || unk_0x630BD2AFB0686BBA(unk_0xA0081090911D13E5())) || unk_0xFFE4F37124DBE6D9(unk_0xA0081090911D13E5())) || unk_0x96E535A40E0E0B83(unk_0xA0081090911D13E5())) || unk_0xE7B06BF48958E63C(unk_0x0C1D3C552325765B(), 1)) || func_164()) || func_161()) || Global_100600) || Global_25187) || func_163()) || Global_36906) || func_162(8, -1)) || func_160()) || func_158()) || func_159()) || Global_101553.f_6543.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_165(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_112(unk_0xA0081090911D13E5()) && func_112(uParam0->f_28[0])) && !func_131()) && (unk_0xDF658EB6CA91DFBC() - uParam0->f_60) > iParam8) && func_169(unk_0xA0081090911D13E5(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_168(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_166(&uVar0, cParam4, sParam5, 7, 0, 0);
		uParam0->f_60 = unk_0xDF658EB6CA91DFBC();
		return 1;
	}
	return 0;
}

void func_166(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	func_167(uParam0, 145, sParam1, iParam4, iParam5, 0);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_170(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0xC0691D80D21C989D(unk_0x0C1D3C552325765B()))
	{
		if (!unk_0x509383441597090D(sParam1))
		{
			...
			{
				if (func_169(unk_0xA0081090911D13E5(), Param2, 1) <= 100f)
				{
					func_173(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_169(unk_0xA0081090911D13E5(), Param2, 1) > 120f)
				{
					func_175(iParam0);
				}
			}
...
void func_178(var uParam0)
{
	...
	if (*uParam0 == 52)
	{
		func_180(&(uParam0->f_41[1]));
		func_180(&(uParam0->f_41[2]));
	}
	if (func_112(unk_0xA0081090911D13E5()))
	{
		iVar0 = 0;
...
void func_179(int iParam0)
{
	...
	if (func_112(unk_0xA0081090911D13E5()) && func_112(uParam0))
	{
...
int func_181(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_183(var uParam0, bool bParam1)
{
	...
	if (Global_69617)
	{
		func_254("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_95(*uParam0, &Var0);
	if ((func_217(*uParam0) || func_215(*uParam0)) || Global_69862 == 1)
	{
		return 1;
	}
	if (!unk_0x43045253AC4C7FF5())
	{
		func_254("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_211(*uParam0))
	{
		...
		func_254("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_254("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_254("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	if (func_187(&(uParam0->f_48)) && bParam1)
	{
		func_184(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}
...
void func_184(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_112(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_186(uParam1) || !unk_0x2FB5C9A04733E5EF(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_185(iParam2) && !unk_0x85F24E93D5789C43(iParam0, unk_0xA0081090911D13E5(), 25f))
					{
						unk_0xCD49DDA254A161AF(iParam0, unk_0xA0081090911D13E5(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_186(uParam1) && uParam1->f_4 == 0) && unk_0x999A157665D69393(unk_0xC59DF10B4FC39DF8(unk_0xA0081090911D13E5(), 1), unk_0xC59DF10B4FC39DF8(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_185(iParam2) || unk_0x85F24E93D5789C43(iParam0, unk_0xA0081090911D13E5(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0xC9567EA69F3CC4C2(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
	...
	if (func_111(unk_0xA0081090911D13E5()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (unk_0xD3FACCDA4D66AEAD(uParam0->f_35[iVar0]))
			{
				...
				{
					func_254("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!unk_0x1F1B2B6E500380C5(uParam0->f_35[iVar0], 0))
				{
					func_254("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (unk_0x4AEC0F4FC7FE62C7(uParam0->f_35[iVar0], unk_0xA0081090911D13E5(), 0))
				{
					func_254("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (unk_0xC6FE0F623405BFA8(uParam0->f_35[iVar0]) < 850)
				{
					func_254("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (unk_0x39FEE545B315414E(unk_0xA0081090911D13E5(), 0))
					{
						...
						{
							func_254("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_182(uVar2))
						{
							if (unk_0x705BC1BB91F530B5(uVar2) == joaat("towtruck") || unk_0x705BC1BB91F530B5(iVar2) == joaat("towtruck2"))
							{
								if (func_182(uParam0->f_35[iVar0]))
								{
									...
									{
										func_254("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_182(iVar3))
						{
							...
							{
								func_254("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							if (func_190(unk_0xA0081090911D13E5(), uParam0->f_35[iVar0]))
							{
								func_254("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_191(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_111(unk_0xA0081090911D13E5()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (unk_0xD3FACCDA4D66AEAD(uParam0->f_28[iVar0]))
			{
				if (!unk_0xEB361B4BD195A4D3(uParam0->f_28[iVar0]))
				{
					if (unk_0x4745637EEB85132D(unk_0xA0081090911D13E5()))
					{
						if (unk_0xE2205194B5B97090(unk_0xA0081090911D13E5(), uParam0->f_28[iVar0]))
						{
							...
							func_254("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((unk_0x6F4A1CCA9E8C97C1(uParam0->f_28[iVar0]) || unk_0x4493EFAB738FA349(uParam0->f_28[iVar0])) || unk_0xE3B7FB966D6E7F69(uParam0->f_28[iVar0]))
					{
						...
						func_254("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (unk_0xFFE4F37124DBE6D9(uParam0->f_28[iVar0]))
					{
						if (unk_0x7298BA0C4D4A4C9E(uParam0->f_28[iVar0], unk_0xA0081090911D13E5(), 3f, 3f, 3f, 0, 1, 0))
						{
							...
							func_254("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_210(*uParam0))
					{
						if (!func_140(*uParam0))
						{
							if (func_205(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_178(uParam0);
								...
								func_254("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (unk_0xA0BE515094F295FB(-1, unk_0xC59DF10B4FC39DF8(uParam0->f_28[iVar0], 1), 15f))
						{
							...
							func_254("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_193(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_254("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_192(*uParam0))
					{
						...
						if (unk_0x7DC70BB637724B43(unk_0x0C1D3C552325765B()) > 0)
						{
							...
							func_254("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_254("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_112(uParam0->f_41[0]))
						{
...
int func_193(int iParam0, float fParam1)
{
	...
	if (func_112(unk_0xA0081090911D13E5()) && func_112(iParam0))
	{
		if (func_204(iParam0) || unk_0x352F748C85BFEDC5(unk_0x0C1D3C552325765B(), iParam0))
		{
...
{
	return func_195(iParam0, unk_0xA0081090911D13E5(), fParam1, 1, 250, 7);
}
...
bool func_195(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_196(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
...
int func_199(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_201(unk_0xC59DF10B4FC39DF8(iParam1, 1) - unk_0xC59DF10B4FC39DF8(iParam0, 1)) };
	...
	{
		Var3 = { func_201(unk_0x7560B9B6FB83879C(iParam0, 31086, 0f, 5f, 0f) - unk_0x7560B9B6FB83879C(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_200(Var3, Var0);
...
float func_200(struct<3> Param0, struct<3> Param3)
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_205(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_112(unk_0xA0081090911D13E5()) && func_112(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_209(uParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_206(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
		else
		{
			...
			else
			{
				...
				if (func_209(iParam0, bParam1, fVar0, fVar1))
				{
					return 1;
				}
			}
			if (func_206(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_206(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_207(var uParam0, float fParam1)
{
	...
	{
		if (func_208(uParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_208(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_201(Param1 - unk_0xC59DF10B4FC39DF8(uParam0, 1)) };
...
int func_209(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (unk_0x4B626BBA5EE1CFF0(unk_0xA0081090911D13E5()))
...
{
	if ((func_216() && Global_91406.f_11 == 6) && iParam0 == func_149(&(Global_91406.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_218(int iParam0)
{
	...
	func_254("Created initial scene");
	return 1;
}
...
int func_219(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			while (iVar5 <= (iVar0 - 1))
			{
				unk_0x491067A8E906F22D(iVar0[iVar5]);
				iVar5++;
			}
			unk_0xA9DC3948106CC3E4(sVar7);
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_226(&iVar0) || !unk_0xAD21C77209FD2024(sVar7))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				if (!func_223(&(uParam0->f_28[0]), 53, -71.93684f, -1259.7f, 28.19359f, -177.55f, "HAO LAUNCHER RC - HAO", 1))
				{
					bVar8 = false;
				}
			}
			if (!unk_0xD3FACCDA4D66AEAD(uParam0->f_35[0]))
			{
				func_221(&(uParam0->f_35[0]), iVar0[1], -72.3226f, -1258.643f, 28.1915f, 90.8326f);
				unk_0x728045E0733945FD(uParam0->f_35[0], 38, 0);
				unk_0xE491F8C2C2A96483(uParam0->f_35[0], 91, 0);
				unk_0xE1A095B0BA3A0EA3(uParam0->f_35[0], 0);
				unk_0xB23B3202A5F55884(uParam0->f_35[0], 0, 2);
				unk_0xB23B3202A5F55884(uParam0->f_35[0], 1, 1);
				unk_0xB23B3202A5F55884(uParam0->f_35[0], 2, 1);
				unk_0xB23B3202A5F55884(uParam0->f_35[0], 3, 1);
				unk_0xB23B3202A5F55884(uParam0->f_35[0], 4, 1);
				unk_0xB23B3202A5F55884(uParam0->f_35[0], 6, 0);
				unk_0xB23B3202A5F55884(uParam0->f_35[0], 7, 2);
				unk_0xB23B3202A5F55884(uParam0->f_35[0], 10, 0);
				unk_0xB23B3202A5F55884(uParam0->f_35[0], 23, 20);
				unk_0xF55EA971ECC0BCE5(uParam0->f_35[0], 0, 2, 0);
				unk_0xF55EA971ECC0BCE5(uParam0->f_35[0], 1, 1, 0);
				unk_0xF55EA971ECC0BCE5(uParam0->f_35[0], 2, 1, 0);
				unk_0xF55EA971ECC0BCE5(uParam0->f_35[0], 3, 1, 0);
				unk_0xF55EA971ECC0BCE5(uParam0->f_35[0], 4, 1, 0);
				unk_0xF55EA971ECC0BCE5(uParam0->f_35[0], 6, 0, 0);
				unk_0xF55EA971ECC0BCE5(uParam0->f_35[0], 7, 2, 0);
				unk_0xF55EA971ECC0BCE5(uParam0->f_35[0], 10, 0, 0);
				unk_0xF55EA971ECC0BCE5(uParam0->f_35[0], 23, 20, 0);
				unk_0x6D0141CBE6B3B145(uParam0->f_35[0], 18, 1);
				unk_0x6D0141CBE6B3B145(uParam0->f_35[0], 17, 1);
				unk_0x6D0141CBE6B3B145(uParam0->f_35[0], 22, 1);
				unk_0xB032923150355520(uParam0->f_35[0], 3);
				unk_0x7ECA096D915B238F(uParam0->f_35[0], 0);
				unk_0x028D0662CAA67D4F(uParam0->f_35[0], 2);
				unk_0x3607936F13065720(iVar0[1], 1);
				unk_0x74207974B5483203(uParam0->f_35[0]);
				unk_0x4EDE34FBADD967A6(0);
			}
			if (!unk_0xD3FACCDA4D66AEAD(uParam0->f_35[1]))
			{
				func_221(&(uParam0->f_35[1]), iVar0[3], -91.07f, -1273.45f, 28.86f, 0.57f);
				unk_0x15E5515C105AB6C8(uParam0->f_35[1], 10);
			}
			if (func_112(uParam0->f_28[0]))
			{
				func_220(&(uParam0->f_41[0]), iVar0[2], -71.93684f, -1259.078f, 28.19359f, -177.55f);
				unk_0xD25643FC09708802(uParam0->f_41[0], uParam0->f_28[0], unk_0xFA167453DE504152(uParam0->f_28[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
			}
			if (bVar8)
			{
				iLocal_91 = 3;
		...
		case 3:
			if (func_111(uParam0->f_28[0]) && func_182(uParam0->f_35[0]))
			{
				uVar9 = unk_0x72759B1F07CD05E3(uParam0->f_35[0], "chassis_dummy");
				Var10 = { unk_0xE08BD350F8125054(uParam0->f_35[0], uVar9) };
				uVar6 = unk_0x6194C3993E6BB2A5(Var10, unk_0x3A02D44277FBA4BE(uParam0->f_35[0], 2), 2);
				unk_0x530044AE9D695B53(uVar6, 1);
				unk_0xEB14A75A6A936DCF(uVar6, 0);
				unk_0xCAD643E9EAD85BD2(uParam0->f_28[0], uVar6, sVar7, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
				unk_0xD5DC2873808A9CB5(uParam0->f_28[0], unk_0xA0081090911D13E5(), -1, 2050, 4);
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
			{
				unk_0x2C07692AA3545079(iVar0[iVar5]);
				iVar5++;
			}
			return 1;
			break;
...
void func_220(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_180(uParam0);
...
void func_221(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_222(uParam0);
...
int func_223(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_224(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0xD3FACCDA4D66AEAD(*uParam0))
		{
...
int func_224(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	int iVar0;
...
int func_229(int iParam0)
{
	...
	if (Global_69617)
	{
		func_254("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_101553.f_7940 && !func_93(1))
	{
		func_254("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_230(iParam0))
	{
		Global_100640[iParam0 /*10*/].f_1 = 1;
		func_254("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	...
	{
		Global_100640[iParam0 /*10*/].f_1 = 1;
		func_254("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}
...
bool func_232(int iParam0, char* sParam1)
{
...
void func_237()
{
	func_254("Running end routines.");
	Global_101271 = (Global_101271 - 1);
}

int func_238(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_239((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_239((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_254("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_239(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_240(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_240(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_241(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		func_254("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_242(iParam0, 0, 0, 0);
	}
	if (iLocal_93 != -1)
	{
		func_254("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_176(&iLocal_93);
	}
	unk_0x322323456FCFAB4D(uLocal_94, 0);
	if (bParam1)
	{
		func_177(*iParam0);
	}
...
void func_242(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_249(uParam0, iParam1);
	func_246(uParam0, bParam2);
	func_243(uParam0, bParam3);
}

void func_243(var uParam0, bool bParam1)
{
	func_244(&(uParam0->f_41), bParam1);
}
...
void func_256()
{
	func_254("Running start routines.");
	Global_101271++;
}
