...
void __EntryFunction__()
{
	...
	{
		func_255("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_100739[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_255("Relinquishing candidate id...");
				func_254(&(Global_100739[Var0.f_0 /*10*/].f_9));
			}
		}
		func_242(&Var0, 1);
	}
	iVar64[0] = 24;
	if (!func_239(&iVar64, &Var0, Var61, 1f))
	{
		func_238();
		func_255("SCRIPT TERMINATED");
		unk_0x01DFCA3621B68C4A();
	}
	if (!func_230(Var0.f_0))
	{
		func_238();
		func_255("SCRIPT TERMINATED");
		unk_0x01DFCA3621B68C4A();
	...
	if (func_228(41))
	{
		func_255("SP_MISSION_FRANKLIN_1 is available... [TERMINATING]");
		unk_0x01DFCA3621B68C4A();
	}
	else
	{
		func_255("SP_MISSION_FRANKLIN_1 is not available...");
	}
	while (!func_219(&Var0))
	{
		...
		{
			func_255("Player out of range [TERMINATING]");
			func_242(&Var0, 1);
		}
	}
	uLocal_94 = unk_0x2B2CCF3F6B9ED3A3(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
	unk_0x500FFA49AC5ABB1D(Var61, Var0.f_15, 1, 0, 0, 0);
	while (true)
	{
		unk_0x4EDE34FBADD967A6(0);
		if (!func_184(&Var0, 1))
		...
		if (func_228(41))
		{
			func_255("SP_MISSION_FRANKLIN_1 became available... [TERMINATING]");
			func_242(&Var0, 1);
		}
		else
		{
		...
		if (func_183(Var0.f_35[0]))
		{
			if (!func_182(-72.323f, -1258.643f, 28.648f, unk_0xC086F8D75730FA3A(Var0.f_35[0], 1), 1056964608))
			{
				func_255("Player has moved HAO's vehicle [TERMINATING]");
				func_179(&Var0);
				func_242(&Var0, 1);
			}
		}
		func_178(Var0.f_0);
		func_171(&iLocal_93, &(Var0.f_9), Var61);
		func_166(&Var0, Var61, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
		if (func_152(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
{
	while (!Global_100739[*iParam0 /*10*/])
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	return 1;
...
int func_2(var* uParam0)
{
	...
	if (!func_151())
	{
		while (!func_142(*uParam0))
		{
			if (func_141(*uParam0))
			{
				func_132();
			}
			if (!func_184(uParam0, *uParam0 != 2))
			{
				func_255("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			unk_0x4EDE34FBADD967A6(0);
		}
	...
	if (!func_98(uParam0))
	{
		func_255("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
{
	func_21(sParam1);
	unk_0x4EA098C870B73AB7(&(Global_101652.f_17517[iParam0 /*6*/]), 5);
	if (unk_0xAB964FCFAC3C767A(joaat("mission_stat_watcher")) > 0)
	{
		while (unk_0xAB964FCFAC3C767A(joaat("mission_stat_watcher")) > 0)
		{
			func_19();
			unk_0x4EDE34FBADD967A6(0);
		}
	...
	{
		Global_55819 = 0;
		unk_0x7FC35FCC666F974E("mission_stat_watcher");
		while (!unk_0x4AAFD43C0AFB7A1A("mission_stat_watcher"))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		unk_0xE81651AD79516E48("mission_stat_watcher", 1828);
		unk_0x0446A34B5E23D747("mission_stat_watcher");
	}
	while (!unk_0xF44A5E894FE76438(Global_101652.f_17517[iParam0 /*6*/], 5))
	{
		if (unk_0xAB964FCFAC3C767A(joaat("mission_stat_watcher")) > 0)
		{
			unk_0xB8A73E7DA87B2968(&(Global_101652.f_17517[iParam0 /*6*/]), 5);
		}
	}
	func_4(iParam0);
}
...
void func_4(int iParam0)
{
	...
	MemCopy(&Global_55833, {func_9(iParam0)}, 4);
	Global_55821 = 0;
	Global_55820 = 0;
	switch (iParam0)
	{
	...
	if (!Global_55808)
	{
		if ((Global_68064 != iVar1 || Global_67913 == 0) || iVar0 != Global_68063)
		{
			Global_25434 = 0;
			func_10();
			func_6(iParam0);
...
void func_5()
{
	...
	while (iVar0 < Global_67913)
	{
		switch (Global_56043[Global_67914[iVar0 /*9*/] /*13*/])
		{
			...
			case 6:
				if (Global_56043[Global_67914[iVar0 /*9*/] /*13*/].f_3)
				{
...
void func_7(int iParam0)
{
	...
	func_8(Global_67913);
	Global_67914[Global_67913 /*9*/] = iParam0;
	Global_67913++;
	if (Global_56043[iParam0 /*13*/] == 16)
	{
		Global_68065 = 1;
	}
}
...
{
	Global_67914[iParam0 /*9*/].f_1 = 0;
	Global_67914[iParam0 /*9*/].f_2 = 0f;
	Global_67914[iParam0 /*9*/].f_3 = 0;
	Global_67914[iParam0 /*9*/].f_4 = 0;
}
...
{
	Global_55837 = 0;
	Global_55841 = func_15(joaat("sp0_shots"));
	Global_55840 = func_15(joaat("sp0_hits"));
	Global_55843 = func_15(joaat("sp1_shots"));
	Global_55842 = func_15(joaat("sp1_hits"));
	Global_55845 = func_15(joaat("sp2_shots"));
	Global_55844 = func_15(joaat("sp2_hits"));
}
...
void func_19()
{
	if (unk_0xAB964FCFAC3C767A(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
		{
			if (Global_55813 && !Global_55812)
			{
				Global_55813 = 0;
				unk_0x69EBA78357A8E292("mission_stat_watcher");
			}
		}
		else
		{
...
void func_23(char[4] cParam0, int iParam1, int iParam2)
{
	if (Global_91486 != 10 && Global_91486 != 9)
	{
		...
		func_25(&Global_93588, cParam0, 0, "Start", iParam1, iParam2);
		func_24();
		Global_85997 = 0;
	}
}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_90();
	...
	if (!unk_0x00B5B0B68211D89B(unk_0xD5A676B97920D126()))
	{
		...
		func_62(unk_0xD5A676B97920D126());
		func_56(unk_0xD5A676B97920D126(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_53())
		{
			func_46(unk_0xD5A676B97920D126(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (unk_0x7887B64A08364778(Global_89150[iVar0]))
		{
			if (Global_89150[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0xA0A4DA31DEDFAC4F(iParam0) == func_34(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0xA4DB44DF73EF4FE5(iParam0, 0))
	{
		...
		*uParam1 = unk_0x643D0787FF300BE8(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xB8A73E7DA87B2968(&(uParam1->f_77), func_38(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_46(int iParam0, var uParam1, int iParam2)
{
	...
	if (!unk_0x00B5B0B68211D89B(iParam0))
	{
		...
		else if (unk_0x1995B52453EF6537() && unk_0xA0A4DA31DEDFAC4F(iParam0) == unk_0xA0A4DA31DEDFAC4F(unk_0xD5A676B97920D126()))
		{
			if (func_50(161, -1))
			{
				uParam1->f_59 = func_47(2045, Global_69516, 0);
			}
			else
			{
				uParam1->f_59 = func_47(747, Global_69516, 0);
			}
			uParam1->f_60 = func_47(748, Global_69516, 0);
			uParam1->f_61 = func_47(749, Global_69516, 0);
		}
...
int func_47(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2503773[iParam0 /*3*/][func_48(iParam1)];
...
int func_50(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2522528[iParam0 /*3*/][func_48(iParam1)];
...
void func_54()
{
	...
	if (unk_0x7887B64A08364778(unk_0xD5A676B97920D126()))
	{
		if (func_45(Global_101652.f_2079.f_539.f_3549) != unk_0xA0A4DA31DEDFAC4F(unk_0xD5A676B97920D126()))
		{
			...
			if (func_36(iVar0) && (!func_55(14) || Global_100604))
			{
				if (Global_101652.f_2079.f_539.f_3549 != iVar0 && func_36(Global_101652.f_2079.f_539.f_3549))
				{
...
void func_56(int iParam0, bool bParam1)
{
	...
	iVar0 = func_44(iParam0);
	if (func_36(iVar0) && !unk_0x00B5B0B68211D89B(iParam0))
	{
		if (iParam0 == unk_0xD5A676B97920D126())
		{
			func_57(iParam0, &(Global_101652.f_2079.f_539.f_298[iVar0 /*284*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_57(int iParam0, var uParam1)
{
	...
	if (!unk_0x00B5B0B68211D89B(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x9B30B9013A2D9ACA(iParam0, func_61(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((unk_0x8B2BCE658D6CB0A1(iVar7, &Var9) && !func_58(Var9.f_1)) && iVar70 < 50)
			{
...
int func_67(var uParam0)
{
	if (!unk_0xB529B2A4B7C64D6D(unk_0xD5A676B97920D126(), 0) && !unk_0x00B5B0B68211D89B(unk_0xD5A676B97920D126()))
	{
		if (func_78())
		{
			*uParam0 = func_73(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 0), 6, -1, 0, 1, -1);
...
int func_69(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x1995B52453EF6537())
	{
		if (func_71() == 0)
		{
			return unk_0xF44A5E894FE76438(func_47(func_70(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 45)
	{
		if (iParam3 == 6 || iParam3 == func_77(iVar0))
		{
			...
			{
				fVar1 = unk_0x8E92CDAEB8357ABD(Param0, func_74(iVar0, 0), 1);
...
var func_79()
{
	...
	func_89(&uVar0, unk_0xABA05E2C283C3D5F());
	func_88(&uVar0, unk_0xF72CA3D5BA977203());
	func_87(&uVar0, unk_0x83D6515EE2CBF18C());
	func_82(&uVar0, unk_0x3D13C79BF80EB767());
	func_81(&uVar0, unk_0xA93FEF8677A8AF58());
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_85(unk_0xF44A5E894FE76438(iParam0, 31), -1, 1)) + 2011;
}
...
void func_91(int iParam0)
{
	...
	{
		uVar0 = iParam0;
		unk_0xC4DF89AB50C9BF26(9, &uVar0, 1, 1);
	}
	else if (unk_0xC0915CC8FE05A943() || unk_0x603D621ED5E06CB0())
	{
		...
		unk_0x470FBAC1F65AC933(9, &cVar1);
	}
}
...
void func_92(char* sParam0, var uParam1, int iParam2)
{
	...
	{
		unk_0x833DB464BF7DB6A6(&Global_88889, 0, 0, 0, 1, 0);
		StringCopy(&Global_88889, "", 64);
	}
	StringCopy(&Global_88889, sParam0, 64);
	unk_0x0B2863EEF54A2CCB(sParam0, uParam1, iParam2, func_93(0));
}
...
int func_98(var* uParam0)
{
	...
	{
		if (!unk_0xC55B9553B3EDADE9(&(uParam0->f_9)))
		{
			func_118(1);
		...
		if (uParam0->f_27)
		{
			if (func_115(*uParam0))
			{
				while (!unk_0x1A77C0702D82B43D(unk_0xD5A676B97920D126()))
				{
					func_132();
					unk_0x4EDE34FBADD967A6(0);
				}
		...
		unk_0x0446A34B5E23D747(&(uParam0->f_1));
		if (unk_0x3EB0F73F509A48BA())
		{
			func_255("Initial cutscene loaded and passing to RC mission.");
			unk_0x0518486E922218EA(iVar0);
		}
		else
		{
			func_255("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_99(int iParam0)
{
	...
	if (Global_36908 == 1)
	{
		if (func_111(unk_0xD5A676B97920D126()))
		{
			func_102(unk_0xD5A676B97920D126());
		}
	}
	if (!func_151())
	{
...
void func_119(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (unk_0x1995B52453EF6537())
		{
			if (((!unk_0x00B5B0B68211D89B(unk_0xD5A676B97920D126()) && !func_123(unk_0xFB6B3EEFAB2DD12C())) && !func_121(unk_0xFB6B3EEFAB2DD12C(), 0)) && !func_120())
			{
				unk_0x0A924F4E6E826379(unk_0xD5A676B97920D126(), 0);
			}
		}
		else if (!unk_0x00B5B0B68211D89B(unk_0xD5A676B97920D126()) && !func_123(unk_0xFB6B3EEFAB2DD12C()))
		{
			unk_0x0A924F4E6E826379(unk_0xD5A676B97920D126(), 0);
		}
		Global_69695 = 0;
...
int func_128(char* sParam0)
{
	...
	{
		unk_0x7FC35FCC666F974E(uParam0);
	...
	func_255("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}
...
void func_133()
{
	if (unk_0x9BA2465846EC8271(unk_0xFB6B3EEFAB2DD12C()))
	{
		if (unk_0x6A0583ECFCCECC9B(unk_0xD5A676B97920D126(), 0))
		{
			if (func_134(unk_0x0DBD8FE531FD620D(unk_0xD5A676B97920D126(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_142(int iParam0)
{
	...
	iVar0 = func_144(&(Global_100739[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
{
	Global_100739[iParam0 /*10*/].f_4 = 1;
	Global_100739[iParam0 /*10*/].f_5 = 0;
	Global_100739[iParam0 /*10*/].f_6 = 0;
	Global_100739[iParam0 /*10*/] = 0;
}
...
{
	return func_147(iParam0, Global_35777);
}
...
int func_149()
{
	return func_150(unk_0x0FBCE11007AF301F(), 0);
}
...
int func_152(var uParam0, int iParam1)
{
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					if (func_112(uParam0->f_28[0]))
					{
						if (unk_0x8E92CDAEB8357ABD(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 1), unk_0xC086F8D75730FA3A(uParam0->f_28[0], 1), 1) < 3f)
						{
							if (func_157(2))
							{
								if (func_156(uParam0->f_27))
								{
									func_155(uParam0->f_27, *uParam0);
									func_255("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
			...
			{
				if ((((!unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), -1895.788f, -434.0192f, 40.30126f, -1883.038f, -444.0811f, 50.24509f, 8.5f, 0, 1, 0) && !unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), -1883.576f, -443.6434f, 36.40581f, -1874.826f, -448.0797f, 49.15162f, 8.5f, 0, 1, 0)) && !unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), -1876.343f, -446.2214f, 35.64637f, -1866.952f, -456.5601f, 49.0442f, 8.5f, 0, 1, 0)) && !unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), -1882.997f, -438.9922f, 44.17246f, -1874.079f, -443.342f, 48.69179f, 0.75f, 0, 1, 0)) || unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), -1878.822f, -441.7655f, 44.9175f, -1877.941f, -439.9522f, 47.28982f, 1.25f, 0, 1, 0))
				{
					if (func_112(uParam0->f_28[0]))
					{
						if (func_154(uParam0))
			...
			{
				if (!unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), 837.0731f, 1261.086f, 366.1592f, 780.8383f, 1260.829f, 351.405f, 17.75f, 0, 1, 0))
				{
					if (func_112(uParam0->f_28[0]))
					{
						if (func_154(uParam0))
		...
		case 2:
			...
			{
				if (unk_0x04D83291EB9DE51D(unk_0xD5A676B97920D126(), uParam0->f_35[0], 0))
				{
					if (func_157(3))
					{
						func_155(uParam0->f_27, *uParam0);
		...
		case 1:
			...
			{
				if (!unk_0xB529B2A4B7C64D6D(uParam0->f_35[0], 0))
				{
					if (unk_0x8E92CDAEB8357ABD(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 1), unk_0xC086F8D75730FA3A(uParam0->f_35[0], 1), 1) < uParam0->f_15)
					{
						if (func_157(2))
						{
							if (func_156(uParam0->f_27))
		...
		case 3:
			if (unk_0x8E92CDAEB8357ABD(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 1), uParam0->f_17[0 /*3*/], 1) < uParam0->f_15)
			{
				if (func_157(2))
				{
					if (func_156(uParam0->f_27))
		...
		case 4:
			if (unk_0x1AAFFE4111587B35(unk_0xD5A676B97920D126(), uParam0->f_17[0 /*3*/], uParam0->f_17[1 /*3*/], 0, 1, 0))
			{
				if (func_157(2))
				{
					if (func_156(uParam0->f_27))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (unk_0x6A0583ECFCCECC9B(unk_0xD5A676B97920D126(), 0))
				{
					if (func_112(unk_0x0DBD8FE531FD620D(unk_0xD5A676B97920D126(), 0)))
					{
						if (unk_0x960985BE189C5A3B(unk_0x0DBD8FE531FD620D(unk_0xD5A676B97920D126(), 0), joaat("towtruck")) || unk_0x960985BE189C5A3B(unk_0x0DBD8FE531FD620D(unk_0xD5A676B97920D126(), 0), joaat("towtruck2")))
						{
							if (unk_0x4D0C2D4CC4868449(unk_0x0DBD8FE531FD620D(unk_0xD5A676B97920D126(), 0), uParam0->f_35[0]))
							{
								if (func_157(3))
								{
									return 1;
						...
						else if ((unk_0x960985BE189C5A3B(unk_0x0DBD8FE531FD620D(unk_0xD5A676B97920D126(), 0), joaat("cargobob")) || unk_0x960985BE189C5A3B(unk_0x0DBD8FE531FD620D(unk_0xD5A676B97920D126(), 0), joaat("cargobob2"))) || unk_0x960985BE189C5A3B(unk_0x0DBD8FE531FD620D(unk_0xD5A676B97920D126(), 0), joaat("cargobob3")))
						{
							if (unk_0x6C1EB91B51905F06(unk_0x0DBD8FE531FD620D(unk_0xD5A676B97920D126(), 0)) && unk_0xF7C279382FE9EFF2(unk_0x0DBD8FE531FD620D(unk_0xD5A676B97920D126(), 0), uParam0->f_35[0]))
							{
								if (func_157(3))
								{
									return 1;
			...
			{
				if (unk_0xBBDCBA7AB8D5F102(unk_0xD5A676B97920D126()) >= 2f)
				{
					if (unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), 245.8885f, 371.9034f, 103.9884f, 241.5898f, 359.6458f, 107.3461f, 1.25f, 0, 1, 0))
					{
						if (func_157(2))
						{
							if (func_156(uParam0->f_27))
							{
								func_155(uParam0->f_27, *uParam0);
								func_255("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			{
				if (unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), -164.2046f, 277.4866f, 91.55322f, -153.6f, 277.4061f, 97.33813f, 10f, 0, 1, 0))
				{
					return 0;
				}
			}
			...
			{
				if (unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), 2728.948f, 4143.44f, 42.29295f, 2722.213f, 4144.521f, 45.43182f, 10f, 0, 1, 0))
				{
					if (func_157(2))
					{
						if (func_156(1))
						{
							func_155(1, *uParam0);
							func_255("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
			...
			{
				if (unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), -992.4995f, 358.7455f, 96.3735f, -1021.94f, 361.8888f, 65.36148f, 30f, 0, 1, 0))
				{
					if (!unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), -983.5426f, 369.1104f, 68.46017f, -1028.566f, 395.4613f, 94.57245f, 15f, 0, 1, 0))
					{
						if (!unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), -983.875f, 346.7556f, 68.02096f, -1021.451f, 336.3458f, 93.18714f, 14.5f, 0, 1, 0))
						{
							if (func_157(2))
							{
								if (func_156(uParam0->f_27))
								{
									func_155(uParam0->f_27, *uParam0);
									func_255("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
			...
			if (unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), uParam0->f_17[0 /*3*/], uParam0->f_17[1 /*3*/], uParam0->f_24, 0, 1, 0))
			{
				if (*uParam0 == 45)
				{
					if (unk_0x1AC9C20D51EE6DC3(unk_0xD5A676B97920D126(), 2338.697f, 2597.037f, 45.39052f, 2324.003f, 2597.185f, 47.74961f, 8.5f, 0, 1, 0))
					{
						return 0;
					}
				}
...
void func_153()
{
	func_27(&(Global_93588.f_2311), &Global_93588, 0, 1, 1, 0);
}
...
int func_154(var uParam0)
{
	...
	if (unk_0x6A0583ECFCCECC9B(unk_0xD5A676B97920D126(), 0) && uParam0->f_27)
	{
		...
		if (unk_0x8E92CDAEB8357ABD(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 1), unk_0xC086F8D75730FA3A(uParam0->f_28[0], 1), 1) < (uParam0->f_15 + fVar0))
		{
			return 1;
		}
	}
	else if (unk_0x8E92CDAEB8357ABD(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 1), unk_0xC086F8D75730FA3A(uParam0->f_28[0], 1), 1) < uParam0->f_15)
	{
		return 1;
	}
	return 0;
...
void func_155(int iParam0, int iParam1)
{
	if (iParam0 == 1)
	{
		...
		if (unk_0x6A0583ECFCCECC9B(unk_0xD5A676B97920D126(), 0))
		{
			func_255("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (unk_0xEDC11DB270927D92(unk_0xD5A676B97920D126()) || unk_0xD6E13289C5649502(unk_0xD5A676B97920D126()))
			{
				func_255("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
				unk_0x09AB636BA0F9BE90(unk_0x0DBD8FE531FD620D(unk_0xD5A676B97920D126(), 0), 0, 1, 0);
			}
			func_132();
		}
	}
		...
		else if (bParam0)
		{
			if (unk_0x6A0583ECFCCECC9B(unk_0xD5A676B97920D126(), 0))
			{
				...
				if (func_183(iVar0))
				{
					if (unk_0xEDC11DB270927D92(unk_0xD5A676B97920D126()) || unk_0xD6E13289C5649502(unk_0xD5A676B97920D126()))
					{
						if ((!unk_0xC9CACD72C7228F98(iVar0) && !unk_0x7C4BC3264552091A(iVar0)) && unk_0x78D3CDB884C74FEB(iVar0) < 1f)
						{
							return 1;
						}
					}
					else if (!unk_0x7C4BC3264552091A(iVar0))
					{
						return 1;
					}
				}
		...
		if (unk_0x7887B64A08364778(unk_0xD5A676B97920D126()))
		{
			if (!unk_0x00B5B0B68211D89B(unk_0xD5A676B97920D126()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0x6F49D44BC97A2171(unk_0xFB6B3EEFAB2DD12C(), 1) || func_165()) || Global_25187) || func_164()) || func_163(8, -1)) || func_161()) || func_78()) || func_162()) || func_160()) || Global_101652.f_6631.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0xFD491158A0A4F57B(unk_0xFB6B3EEFAB2DD12C()) || unk_0x7C4BC3264552091A(unk_0xD5A676B97920D126())) || unk_0xD7143F03AB03DDF2(unk_0xD5A676B97920D126())) || unk_0x9B0C8A2FC23E64AB(unk_0xD5A676B97920D126())) || unk_0xB10E14D4FD54871F(unk_0xD5A676B97920D126())) || unk_0x6F49D44BC97A2171(unk_0xFB6B3EEFAB2DD12C(), 1)) || unk_0xB7FE4CCB71F0CA65(unk_0xFB6B3EEFAB2DD12C())) || unk_0xDA4E21D6BC58AB75(unk_0xD5A676B97920D126(), 0)) || func_165()) || Global_100699) || Global_25187) || func_164()) || func_163(8, -1)) || func_161()) || func_78()) || func_162()) || func_160()) || Global_101652.f_6631.f_919[iVar0] == 5) || Global_36324 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_165() || unk_0xAA5B10AEB58EAA13(unk_0xFB6B3EEFAB2DD12C()) > 0) || func_163(8, -1)) || func_160()) || func_159()) || Global_101652.f_6631.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x7887B64A08364778(unk_0xD5A676B97920D126()))
						{
							if ((((((((((((((unk_0xDA4E21D6BC58AB75(unk_0xD5A676B97920D126(), 0) || unk_0xAA5B10AEB58EAA13(unk_0xFB6B3EEFAB2DD12C()) > 0) || unk_0x7C4BC3264552091A(unk_0xD5A676B97920D126())) || unk_0x9B0C8A2FC23E64AB(unk_0xD5A676B97920D126())) || unk_0xB10E14D4FD54871F(unk_0xD5A676B97920D126())) || unk_0x6F49D44BC97A2171(unk_0xFB6B3EEFAB2DD12C(), 1)) || unk_0xB7FE4CCB71F0CA65(unk_0xFB6B3EEFAB2DD12C())) || func_165()) || Global_25187) || func_164()) || func_163(8, -1)) || func_162()) || func_161()) || func_160()) || Global_101652.f_6631.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((unk_0xDA4E21D6BC58AB75(unk_0xD5A676B97920D126(), 0) || !unk_0x0E4A3783CD75D9CE(unk_0xFB6B3EEFAB2DD12C())) || !unk_0xFD491158A0A4F57B(unk_0xFB6B3EEFAB2DD12C())) || !unk_0x8AFBC859AA63D3D7()) || unk_0x7C4BC3264552091A(unk_0xD5A676B97920D126())) || unk_0x9B0C8A2FC23E64AB(unk_0xD5A676B97920D126())) || unk_0xB10E14D4FD54871F(unk_0xD5A676B97920D126())) || unk_0x6F49D44BC97A2171(unk_0xFB6B3EEFAB2DD12C(), 1)) || func_165()) || func_162()) || Global_100699) || Global_25187) || func_164()) || Global_36908) || func_163(8, -1)) || func_161()) || func_159()) || func_160()) || Global_101652.f_6631.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((unk_0xDA4E21D6BC58AB75(unk_0xD5A676B97920D126(), 0) || !unk_0x0E4A3783CD75D9CE(unk_0xFB6B3EEFAB2DD12C())) || !unk_0xFD491158A0A4F57B(unk_0xFB6B3EEFAB2DD12C())) || !unk_0x8AFBC859AA63D3D7()) || unk_0x222B4D6308DFC3F1(unk_0xFB6B3EEFAB2DD12C(), 0)) || unk_0x7C4BC3264552091A(unk_0xD5A676B97920D126())) || unk_0x6A0583ECFCCECC9B(unk_0xD5A676B97920D126(), 1)) || unk_0x9B0C8A2FC23E64AB(unk_0xD5A676B97920D126())) || unk_0xB10E14D4FD54871F(unk_0xD5A676B97920D126())) || unk_0x13A15A61A159801A(unk_0xD5A676B97920D126())) || unk_0x6F49D44BC97A2171(unk_0xFB6B3EEFAB2DD12C(), 1)) || unk_0xB7FE4CCB71F0CA65(unk_0xFB6B3EEFAB2DD12C())) || func_165()) || Global_100699) || Global_25187) || func_164()) || func_163(8, -1)) || func_161()) || func_159()) || func_78()) || func_162()) || func_160())
						{
							return 0;
						}
						break;
...
int func_166(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_112(unk_0xD5A676B97920D126()) && func_112(uParam0->f_28[0])) && !func_131()) && (unk_0x84A97C70FFDEC0C8() - uParam0->f_60) > iParam8) && func_170(unk_0xD5A676B97920D126(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_169(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_167(&uVar0, cParam4, sParam5, 7, 0, 0);
		uParam0->f_60 = unk_0x84A97C70FFDEC0C8();
		return 1;
	}
	return 0;
}

void func_167(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	func_168(uParam0, 145, sParam1, iParam4, iParam5, 0);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_168(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_171(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x9BA2465846EC8271(unk_0xFB6B3EEFAB2DD12C()))
	{
		if (!unk_0xC55B9553B3EDADE9(sParam1))
		{
			...
			{
				if (func_170(unk_0xD5A676B97920D126(), Param2, 1) <= 100f)
				{
					func_174(iParam0, 1);
				}
			}
			else
			{
				...
				{
					case 1:
						if (unk_0xCC257DA11A122B5F(sParam1, "JOSH_1_INT_CONCAT"))
						{
							unk_0x48BB86FCFA957833(sParam1, 14, 8);
						}
						else
						{
							unk_0x39F6F9ACA4D01043(sParam1, 8);
						}
						unk_0xE3B3660B8812E951(2);
						func_172(*iParam0, 1);
						break;
					...
					case 2:
						...
						unk_0xB3D2665821762068();
						unk_0xE3B3660B8812E951(0);
						func_172(*iParam0, 0);
						break;
				}
				if (func_170(unk_0xD5A676B97920D126(), Param2, 1) > 120f)
				{
					func_176(iParam0);
				}
			}
...
void func_172(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (Global_69693 == iParam0)
		{
			Global_69694 = iParam0;
		}
	}
	else if (Global_69694 == iParam0)
	{
		Global_69694 = -1;
	}
}
...
int func_173(int iParam0)
{
	if (Global_69693 == iParam0)
	{
		if (Global_69694 == -1)
		{
			if (Global_69692 < unk_0xAF48077651290FAC())
			{
				return 1;
			}
		}
...
void func_174(int iParam0, int iParam1)
{
	...
	if (Global_69690 < 5)
	{
		Global_69679[Global_69690 /*2*/] = 0;
		Global_69679[Global_69690 /*2*/].f_1 = iParam1;
		bVar0 = false;
		while (!bVar0)
		{
			bVar0 = true;
			iVar1 = 0;
			while (iVar1 < Global_69690)
			{
				if (Global_69679[iVar1 /*2*/] == Global_69679[Global_69690 /*2*/])
				{
					Global_69679[Global_69690 /*2*/]++;
					bVar0 = false;
				}
				iVar1++;
			}
		}
		*iParam0 = Global_69679[Global_69690 /*2*/];
		Global_69690++;
		Global_69691 = 1;
	}
	else
...
void func_177(int iParam0)
{
	...
	bVar0 = false;
	iVar1 = 0;
	while (!bVar0 && iVar1 < Global_69690)
	{
		if (Global_69679[iVar1 /*2*/] == *iParam0)
		{
			bVar0 = true;
		}
		else
	...
	iVar2 = iVar1;
	while (iVar2 <= (Global_69690 - 2))
	{
		Global_69679[iVar2 /*2*/] = Global_69679[iVar2 + 1 /*2*/];
		Global_69679[iVar2 /*2*/].f_1 = Global_69679[iVar2 + 1 /*2*/].f_1;
		iVar2++;
	}
	Global_69679[(Global_69690 - 1) /*2*/] = -1;
	Global_69679[(Global_69690 - 1) /*2*/].f_1 = 3;
	Global_69690 = (Global_69690 - 1);
	Global_69691 = 1;
	Global_69692 = unk_0xAF48077651290FAC();
	*iParam0 = -1;
}
...
void func_178(int iParam0)
{
	...
	Global_100739[iParam0 /*10*/].f_1 = 1;
}
...
void func_179(var uParam0)
{
	...
	if (func_112(unk_0xD5A676B97920D126()))
	{
		iVar0 = 0;
		while (iVar0 <= (uParam0->f_28 - 1))
		{
			...
			{
				if (!unk_0x6A0583ECFCCECC9B(uParam0->f_28[iVar0], 0))
				{
					unk_0x01976E3C7B2E5437(uParam0->f_28[iVar0], 1, 0);
					unk_0xBBAF4B768DDB7572(uParam0->f_28[0], 0);
				}
				unk_0x7D99F00F48D15ADB(uParam0->f_28[iVar0], 1);
				if (*uParam0 == 34)
				{
					if (func_112(uParam0->f_41[0]))
					{
						unk_0x01976E3C7B2E5437(uParam0->f_41[0], 1, 0);
						unk_0xBBAF4B768DDB7572(uParam0->f_41[0], 0);
					}
				}
				switch (*uParam0)
				{
					case 19:
						func_180(uParam0->f_28[iVar0]);
						break;
					
					case 8:
						unk_0x49E996A1E39EAAD7("rcmcollect_paperleadinout@");
						while (!unk_0xD7669BF035CDA5F6("rcmcollect_paperleadinout@"))
						{
							unk_0x4EDE34FBADD967A6(0);
						}
						unk_0x456121A0AAC868D4(&uVar1);
						unk_0x290A57C93304EF16(0, "rcmcollect_paperleadinout@", "meditate_getup", 8f, -8f, -1, 8, 0, 0, 0, 0);
						unk_0xBB8F1D58B7578137(0, unk_0xD5A676B97920D126(), 10000f, -1, 0, 0);
						unk_0xCFE67FBB69F1C410(uVar1);
						unk_0x8B06B801B92CEC2D(uParam0->f_28[iVar0], uVar1);
						unk_0x873418BFBF9A6780(&uVar1);
						break;
					
					case 0:
					case 1:
						unk_0x49E996A1E39EAAD7("rcmabigail");
						while (!unk_0xD7669BF035CDA5F6("rcmabigail"))
						{
							unk_0x4EDE34FBADD967A6(0);
						}
						unk_0x456121A0AAC868D4(&uVar1);
						unk_0x290A57C93304EF16(0, "rcmabigail", "breakout_base", 8f, -8f, -1, 8, 0, 0, 0, 0);
						unk_0xBB8F1D58B7578137(0, unk_0xD5A676B97920D126(), 10000f, -1, 0, 0);
						unk_0xCFE67FBB69F1C410(uVar1);
						unk_0x8B06B801B92CEC2D(uParam0->f_28[iVar0], uVar1);
						unk_0x873418BFBF9A6780(&uVar1);
					...
					case 32:
						unk_0x49E996A1E39EAAD7("rcmminute1");
						while (!unk_0xD7669BF035CDA5F6("rcmminute1"))
						{
							unk_0x4EDE34FBADD967A6(0);
						}
						unk_0x456121A0AAC868D4(&uVar1);
						if (iVar0 == 0)
						{
							unk_0x290A57C93304EF16(0, "rcmminute1", "base_to_idle_joe", 8f, -8f, -1, 32776, 0, 0, 0, 0);
						}
						else
						{
							unk_0x290A57C93304EF16(0, "rcmminute1", "base_to_idle_josef", 8f, -8f, -1, 32776, 0, 0, 0, 0);
						}
						unk_0xBB8F1D58B7578137(0, unk_0xD5A676B97920D126(), 10000f, -1, 0, 0);
						unk_0xCFE67FBB69F1C410(uVar1);
						unk_0x8B06B801B92CEC2D(uParam0->f_28[iVar0], uVar1);
					...
					case 24:
						unk_0x49E996A1E39EAAD7("special_ped@hao@base");
						while (!unk_0xD7669BF035CDA5F6("special_ped@hao@base"))
						{
							unk_0x4EDE34FBADD967A6(0);
						}
						unk_0x456121A0AAC868D4(&uVar1);
						unk_0x290A57C93304EF16(0, "special_ped@hao@base", "hao_exit", 8f, -8f, -1, 520, 0, 0, 0, 0);
						unk_0xBB8F1D58B7578137(0, unk_0xD5A676B97920D126(), 10000f, -1, 0, 0);
						unk_0xCFE67FBB69F1C410(uVar1);
						unk_0x8B06B801B92CEC2D(uParam0->f_28[iVar0], uVar1);
						unk_0x873418BFBF9A6780(&uVar1);
					...
					default:
						unk_0xB42E7901B9B18D2A(uParam0->f_28[iVar0]);
						unk_0xBB8F1D58B7578137(uParam0->f_28[iVar0], unk_0xD5A676B97920D126(), 10000f, -1, 0, 0);
						break;
					}
			}
			iVar0++;
...
void func_180(int iParam0)
{
	...
	if (func_112(unk_0xD5A676B97920D126()) && func_112(uParam0))
	{
		unk_0x49E996A1E39EAAD7("rcmextreme3");
		while (!unk_0xD7669BF035CDA5F6("rcmextreme3"))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		unk_0x456121A0AAC868D4(&uVar0);
		unk_0x290A57C93304EF16(0, "rcmextreme3", "jump_fall", 1000f, -8f, -1, 8, 0, 0, 0, 0);
		unk_0x1EDFE8C8C6BB7CF0(0, 1);
		unk_0xA94B941686A427C4(0, 64.6f, -737.8f, 44.2f);
		unk_0xBB8F1D58B7578137(0, unk_0xD5A676B97920D126(), 10000f, -1, 0, 0);
...
int func_182(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_184(var uParam0, bool bParam1)
{
	...
	if (Global_69697)
	{
		func_255("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_95(*uParam0, &Var0);
	if ((func_218(*uParam0) || func_216(*uParam0)) || Global_69942 == 1)
	{
		return 1;
	}
	if (!unk_0x0943F317505D1E39())
	{
		func_255("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_212(*uParam0))
	{
		if (*uParam0 == 19)
		{
			func_180(uParam0->f_28[0]);
		}
		func_255("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1)
	{
	...
	if (uParam0->f_16 == 2 || uParam0->f_16 == 1)
	{
		if (func_112(uParam0->f_35[0]))
		{
			if (!unk_0x1AAFFE4111587B35(uParam0->f_35[0], Var0.f_6, 8f, 8f, 8f, 0, 1, 0))
			{
				return 0;
			}
		}
	...
	if (*uParam0 == 10)
	{
		if (unk_0x4404F63C94223B29(-1, uParam0->f_17[0 /*3*/], 8f))
		{
			func_255("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		if (!unk_0xF44A5E894FE76438(Var0.f_26, func_90()))
		{
			func_255("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	if (func_188(&(uParam0->f_48)) && bParam1)
	{
...
void func_185(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_112(iParam0))
	{
		switch (uParam1->f_3)
		{
				...
				if (func_188(uParam1))
				{
					if (unk_0xD7669BF035CDA5F6(*uParam1))
					{
						...
						if (iParam2 != 21)
						{
							...
							{
								unk_0x290A57C93304EF16(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
							}
							else
							{
								unk_0x456121A0AAC868D4(&uVar0);
								if (func_187(uParam1))
								{
									unk_0x41BEEEA11752409B(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0, 2, 0);
								}
								else
								{
									unk_0x41BEEEA11752409B(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0, 2, 0);
								}
								unk_0x41BEEEA11752409B(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0, 2, 0);
								unk_0xCFE67FBB69F1C410(uVar0);
						...
						{
							unk_0x41BEEEA11752409B(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0, 2, 3);
						}
						uParam1->f_3 = 2;
					}
					else
			...
			case 2:
				if (!func_187(uParam1) || !unk_0xEBA40DFF7CCE3511(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_186(iParam2) && !unk_0x205B4FC17ACAF4C8(iParam0, unk_0xD5A676B97920D126(), 25f))
					{
						unk_0xBE29918F5B8EC2EF(iParam0, unk_0xD5A676B97920D126(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_187(uParam1) && uParam1->f_4 == 0) && unk_0x8E92CDAEB8357ABD(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 1), unk_0xC086F8D75730FA3A(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 3:
				...
				if (func_66(uParam1->f_5, 0f, 0f, 0f, 0))
				{
					unk_0x290A57C93304EF16(0, *uParam1, uParam1->f_2, 4f, -4f, -1, 262144, 0, 0, 0, 0);
					unk_0x290A57C93304EF16(0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
				}
				else
				{
					unk_0x41BEEEA11752409B(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 4f, -4f, -1, 262152, 0, 2, 0);
					unk_0x41BEEEA11752409B(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0, 2, 0);
				}
				unk_0xCFE67FBB69F1C410(uVar1);
				unk_0x8B06B801B92CEC2D(iParam0, uVar1);
				unk_0x873418BFBF9A6780(&uVar1);
				uParam1->f_4 = 1;
				if (func_186(iParam2))
				{
			...
			case 5:
				if (!func_186(iParam2) || unk_0x205B4FC17ACAF4C8(iParam0, unk_0xD5A676B97920D126(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x290A57C93304EF16(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					...
					{
						unk_0x41BEEEA11752409B(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0, 2, 0);
					}
					uParam1->f_3 = 2;
				}
				break;
...
{
	if (unk_0xC55B9553B3EDADE9(uParam0->f_2))
	{
		return 0;
	}
	return 1;
...
void func_189(var uParam0)
{
	...
	if (func_112(unk_0xD5A676B97920D126()))
	{
		...
		while (iVar0 <= (uParam0->f_28 - 1))
		{
			if (func_111(uParam0->f_28[iVar0]))
			{
				unk_0x77E24C0B92B4FC24(uParam0->f_28[iVar0], 1, 0);
				unk_0x5457695C257D1470(uParam0->f_28[iVar0], 0);
				unk_0x7D99F00F48D15ADB(uParam0->f_28[iVar0], 1);
				unk_0x182DAF81B229194E(uParam0->f_28[iVar0], unk_0xD5A676B97920D126(), 0, 16);
				unk_0xD4B3FF1E63C36391(&(uParam0->f_28[iVar0]));
			}
			iVar0++;
		}
	}
...
int func_190(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (func_111(unk_0xD5A676B97920D126()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (unk_0x7887B64A08364778(uParam0->f_35[iVar0]))
			{
				if (unk_0xB529B2A4B7C64D6D(uParam0->f_35[iVar0], 0))
				{
					func_255("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!unk_0xA4DB44DF73EF4FE5(uParam0->f_35[iVar0], 0))
				{
					func_255("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (unk_0x7D720C677145C91C(uParam0->f_35[iVar0], unk_0xD5A676B97920D126(), 0))
				{
					func_255("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (unk_0xB38A470B669AC00B(uParam0->f_35[iVar0]) < 850)
				{
					func_255("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (unk_0x6A0583ECFCCECC9B(unk_0xD5A676B97920D126(), 0))
					{
						if (unk_0xC85EEB48C05E2A8A(uParam0->f_35[iVar0], unk_0xD5A676B97920D126()) && unk_0x78D3CDB884C74FEB(unk_0xD5A676B97920D126()) > 5f)
						{
							func_255("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						uVar2 = unk_0x80AA649904BB5788();
						if (func_183(uVar2))
						{
							if (unk_0xA0A4DA31DEDFAC4F(uVar2) == joaat("towtruck") || unk_0xA0A4DA31DEDFAC4F(iVar2) == joaat("towtruck2"))
							{
								if (func_183(uParam0->f_35[iVar0]))
								{
									if (unk_0x4D0C2D4CC4868449(iVar2, uParam0->f_35[iVar0]))
									{
										func_255("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_183(iVar3))
						{
							if (unk_0xC85EEB48C05E2A8A(uParam0->f_35[iVar0], iVar3) && unk_0x78D3CDB884C74FEB(iVar3) > 6f)
							{
								func_255("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							if (func_191(unk_0xD5A676B97920D126(), uParam0->f_35[iVar0]))
							{
								func_255("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_192(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_111(unk_0xD5A676B97920D126()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (unk_0x7887B64A08364778(uParam0->f_28[iVar0]))
			{
				if (!unk_0x00B5B0B68211D89B(uParam0->f_28[iVar0]))
				{
					if (unk_0x81C4995860081BC3(unk_0xD5A676B97920D126()))
					{
						if (unk_0xC85EEB48C05E2A8A(unk_0xD5A676B97920D126(), uParam0->f_28[iVar0]))
						{
							if (iParam2 == 0)
							{
								func_179(uParam0);
							...
							func_255("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((unk_0x1F72B125B26A6238(uParam0->f_28[iVar0]) || unk_0x88D40E81D8E0AD6F(uParam0->f_28[iVar0])) || unk_0x19B286F71A76840C(uParam0->f_28[iVar0]))
					{
						if (iParam2 == 0)
						{
							func_179(uParam0);
						...
						func_255("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (unk_0x9B0C8A2FC23E64AB(uParam0->f_28[iVar0]))
					{
						if (unk_0x108650178993C477(uParam0->f_28[iVar0], unk_0xD5A676B97920D126(), 3f, 3f, 3f, 0, 1, 0))
						{
							if (iParam2 == 0)
							{
								func_179(uParam0);
							...
							func_255("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_211(*uParam0))
					{
						if (!func_141(*uParam0))
						{
							if (func_206(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_255("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (unk_0x4404F63C94223B29(-1, unk_0xC086F8D75730FA3A(uParam0->f_28[iVar0], 1), 15f))
						{
							if (iParam2 == 0)
							{
								func_179(uParam0);
							...
							func_255("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_194(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_255("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_193(*uParam0))
					{
						if (unk_0x4404F63C94223B29(-1, unk_0xC086F8D75730FA3A(uParam0->f_28[iVar0], 1), 5f))
						{
							if (iParam2 == 0)
							{
								func_179(uParam0);
						...
						if (unk_0xAA5B10AEB58EAA13(unk_0xFB6B3EEFAB2DD12C()) > 0)
						{
							...
							func_255("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_255("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_112(uParam0->f_41[0]))
						{
...
int func_194(int iParam0, float fParam1)
{
	...
	if (func_112(unk_0xD5A676B97920D126()) && func_112(iParam0))
	{
		if (func_205(iParam0) || unk_0x982AB85BDD884D31(unk_0xFB6B3EEFAB2DD12C(), iParam0))
		{
...
{
	return func_196(iParam0, unk_0xD5A676B97920D126(), fParam1, 1, 250, 7);
}
...
bool func_196(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_197(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x84A97C70FFDEC0C8() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_197(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_200(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_202(unk_0xC086F8D75730FA3A(iParam1, 1) - unk_0xC086F8D75730FA3A(iParam0, 1)) };
	...
	{
		Var3 = { func_202(unk_0x6DE9A8183DA7678E(iParam0, 31086, 0f, 5f, 0f) - unk_0x6DE9A8183DA7678E(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_201(Var3, Var0);
...
Vector3 func_202(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
{
	if (unk_0xF84188B3D9E24D81(unk_0xFB6B3EEFAB2DD12C(), uParam0) && unk_0xB3EED8E53275CA90(unk_0xD5A676B97920D126(), 6))
	{
		return 1;
	}
	return 0;
...
int func_206(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_112(unk_0xD5A676B97920D126()) && func_112(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_210(uParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_207(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
		else
		{
			if (unk_0xAB3AA0F867F67480(unk_0xD5A676B97920D126()))
			{
				...
				{
					if (unk_0x1DEB1994A3C25E35(unk_0xC086F8D75730FA3A(uParam0, 1), fVar0, 1))
					{
						return 1;
					}
				}
			...
			else
			{
				...
				if (func_210(iParam0, bParam1, fVar0, fVar1))
				{
					return 1;
				}
			}
			if (func_207(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_207(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_208(var uParam0, float fParam1)
{
	...
	{
		if (func_209(uParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_209(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_202(Param1 - unk_0xC086F8D75730FA3A(uParam0, 1)) };
...
int func_210(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (unk_0x515E262CBF491958(unk_0xD5A676B97920D126()))
		{
			if (unk_0x108650178993C477(unk_0xD5A676B97920D126(), uParam0, fParam3, fParam3, fParam3, 0, 1, 0))
			{
				return 1;
			}
		}
...
int func_212(int iParam0)
{
	...
	if (!unk_0xF44A5E894FE76438(Global_101652.f_17517[iParam0 /*6*/], 2))
	{
		return 1;
	}
	return 0;
...
{
	if ((func_217() && Global_91486.f_11 == 6) && iParam0 == func_150(&(Global_91486.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_218(int iParam0)
{
	if (func_93(0))
	{
		if (Global_69943.f_1 == 7)
		{
			if (Global_69943 == iParam0)
			{
				return 1;
			}
		}
...
int func_219(int iParam0)
{
	...
	func_255("Created initial scene");
	return 1;
}
...
int func_220(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x49E996A1E39EAAD7(sVar7);
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_227(&iVar0) || !unk_0xD7669BF035CDA5F6(sVar7))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				if (!func_224(&(uParam0->f_28[0]), 53, -71.93684f, -1259.7f, 28.19359f, -177.55f, "HAO LAUNCHER RC - HAO", 1))
				{
					bVar8 = false;
				}
			}
			if (!unk_0x7887B64A08364778(uParam0->f_35[0]))
			{
				func_222(&(uParam0->f_35[0]), iVar0[1], -72.3226f, -1258.643f, 28.1915f, 90.8326f);
				unk_0xC243EB5E21E9A4EE(uParam0->f_35[0], 38, 0);
				unk_0x44ADE3DECA6FE50F(uParam0->f_35[0], 91, 0);
				unk_0x8A541F8CF0625EB6(uParam0->f_35[0], 0);
				unk_0x229C760B16E05210(uParam0->f_35[0], 0, 2);
				unk_0x229C760B16E05210(uParam0->f_35[0], 1, 1);
				unk_0x229C760B16E05210(uParam0->f_35[0], 2, 1);
				unk_0x229C760B16E05210(uParam0->f_35[0], 3, 1);
				unk_0x229C760B16E05210(uParam0->f_35[0], 4, 1);
				unk_0x229C760B16E05210(uParam0->f_35[0], 6, 0);
				unk_0x229C760B16E05210(uParam0->f_35[0], 7, 2);
				unk_0x229C760B16E05210(uParam0->f_35[0], 10, 0);
				unk_0x229C760B16E05210(uParam0->f_35[0], 23, 20);
				unk_0x47EE94F716B70695(uParam0->f_35[0], 0, 2, 0);
				unk_0x47EE94F716B70695(uParam0->f_35[0], 1, 1, 0);
				unk_0x47EE94F716B70695(uParam0->f_35[0], 2, 1, 0);
				unk_0x47EE94F716B70695(uParam0->f_35[0], 3, 1, 0);
				unk_0x47EE94F716B70695(uParam0->f_35[0], 4, 1, 0);
				unk_0x47EE94F716B70695(uParam0->f_35[0], 6, 0, 0);
				unk_0x47EE94F716B70695(uParam0->f_35[0], 7, 2, 0);
				unk_0x47EE94F716B70695(uParam0->f_35[0], 10, 0, 0);
				unk_0x47EE94F716B70695(uParam0->f_35[0], 23, 20, 0);
				unk_0xDEFD029E49A376A2(uParam0->f_35[0], 18, 1);
				unk_0xDEFD029E49A376A2(uParam0->f_35[0], 17, 1);
				unk_0xDEFD029E49A376A2(uParam0->f_35[0], 22, 1);
				unk_0xAFC3B32426D08964(uParam0->f_35[0], 3);
				unk_0x7A726458462CD325(uParam0->f_35[0], 0);
				unk_0x193EE3AC82EA96AB(uParam0->f_35[0], 2);
				unk_0xFA03BA297FE81584(iVar0[1], 1);
				unk_0x2D739561304957CC(uParam0->f_35[0], 1084227584);
				unk_0x4EDE34FBADD967A6(0);
			}
			if (!unk_0x7887B64A08364778(uParam0->f_35[1]))
			{
				func_222(&(uParam0->f_35[1]), iVar0[3], -91.07f, -1273.45f, 28.86f, 0.57f);
				unk_0xE7D6BFCADFE1076B(uParam0->f_35[1], 10);
			}
			if (func_112(uParam0->f_28[0]))
			{
				func_221(&(uParam0->f_41[0]), iVar0[2], -71.93684f, -1259.078f, 28.19359f, -177.55f);
				unk_0xD157F7C56C5A2FCC(uParam0->f_41[0], uParam0->f_28[0], unk_0xF9F732E1B7BD0FE4(uParam0->f_28[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
			}
			if (bVar8)
			{
				iLocal_91 = 3;
		...
		case 3:
			if (func_111(uParam0->f_28[0]) && func_183(uParam0->f_35[0]))
			{
				uVar9 = unk_0x96C78339A82E0B67(uParam0->f_35[0], "chassis_dummy");
				Var10 = { unk_0xA277059EBE3B154A(uParam0->f_35[0], uVar9) };
				uVar6 = unk_0x0C17C9FDFC9120BD(Var10, unk_0xB73B9913DD4EE2AA(uParam0->f_35[0], 2), 2);
				unk_0x38B09454913E83A9(uVar6, 1);
				unk_0x5377255E3660D870(uVar6, 0);
				unk_0xECA52D26609A09F3(uParam0->f_28[0], uVar6, sVar7, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
				unk_0x0988FFC0C75637DF(uParam0->f_28[0], unk_0xD5A676B97920D126(), -1, 2050, 4);
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
			{
...
void func_222(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_223(uParam0);
...
int func_224(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_225(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0x7887B64A08364778(*uParam0))
		{
...
int func_225(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	int iVar0;
	
	if (!func_36(iParam1))
	{
		iVar0 = func_258(iParam1);
...
int func_229(int iParam0)
{
	...
	if (!unk_0xF44A5E894FE76438(Var0.f_26, iVar32))
	{
		return 1;
	}
	return 0;
...
int func_230(int iParam0)
{
	...
	if (Global_69697)
	{
		func_255("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_101652.f_8028 && !func_93(1))
	{
		func_255("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_231(iParam0))
	{
		Global_100739[iParam0 /*10*/].f_1 = 1;
		func_255("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_91486.f_11 == 6)
	{
		if (Global_91486 < 9)
		{
			func_95(iParam0, &sVar0);
			if (unk_0xCC257DA11A122B5F(&(Global_91486.f_3), sVar0))
			{
				func_255("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	if (unk_0xAB964FCFAC3C767A(joaat("candidate_controller")) == 0)
	{
		Global_100739[iParam0 /*10*/].f_1 = 1;
		func_255("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}
...
int func_231(int iParam0)
{
	...
	if (iParam0 == 58)
	{
		if (func_232(5))
		{
			Global_100739[iParam0 /*10*/].f_3 = 0;
		}
	}
	if (Global_100739[iParam0 /*10*/].f_3 == 1)
	{
		return 0;
	}
	return 1;
...
int func_232(int iParam0)
{
	...
	{
		func_233(iParam0, &sVar1);
		iVar9 = unk_0xC294D34374133831(Global_86857[iParam0 /*10*/].f_3, &sVar1);
		if (iVar9 != 0 && Global_91538.f_301 == iVar9)
		{
			return 1;
		}
	}
...
bool func_233(int iParam0, char* sParam1)
{
	...
	switch (iParam0)
	{
		...
		case 2:
		case 1:
			if (unk_0xC5C451876961F4BA("TrevorsTrailer"))
			{
				StringCopy(sParam1, "v_trailer", 32);
			}
			else if (unk_0xC5C451876961F4BA("TrevorsTrailerTidy"))
			{
				StringCopy(sParam1, "V_TrailerTIDY", 32);
			}
			else if (unk_0xC5C451876961F4BA("TrevorsTrailerTrash"))
			{
	...
	return !unk_0xCC257DA11A122B5F(sParam1, "");
}
...
bool func_235(int iParam0)
{
	...
	return unk_0xF44A5E894FE76438(Global_101652.f_17517[iParam0 /*6*/], 2);
}
...
void func_238()
{
	func_255("Running end routines.");
	Global_101370 = (Global_101370 - 1);
}

int func_239(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_240((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_240((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_255("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_240(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_241(Var1.f_6, Param1, fParam4, 0))
	{
		if (unk_0xF44A5E894FE76438(Global_101652.f_17517[iParam0 /*6*/], 0))
		{
...
void func_242(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		func_255("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_243(iParam0, 0, 0, 0);
	}
	if (iLocal_93 != -1)
	{
		func_255("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_177(&iLocal_93);
	}
	unk_0x1AAA727AD9762D22(uLocal_94, 0);
	if (bParam1)
	{
		func_178(*iParam0);
	}
...
void func_243(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_250(uParam0, iParam1);
	func_247(uParam0, bParam2);
	func_244(uParam0, bParam3);
}

void func_244(var uParam0, bool bParam1)
{
	func_245(&(uParam0->f_41), bParam1);
}
...
void func_257()
{
	func_255("Running start routines.");
	Global_101370++;
}
