...
void __EntryFunction__()
{
	...
	uLocal_94 = unk_0xA7B0B03284E7503C(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
...
int func_188(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_132(unk_0x4A8C381C258A124D()) && func_132(uParam0->f_28[0])) && !func_151()) && (unk_0x1DD05E817C89C737() - uParam0->f_60) > iParam8) && func_192(unk_0x4A8C381C258A124D(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_222(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var3 = { func_224(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_242(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x80813AC549A1E8AE(sVar7);
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_249(&iVar0) || !unk_0xE100DD4F82A51BDE(sVar7))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 3:
			...
			{
				uVar9 = unk_0x365DC1E8054AF31A(uParam0->f_35[0], "chassis_dummy");
				Var10 = { unk_0x75DF72FC74EED046(uParam0->f_35[0], uVar9) };
				uVar6 = unk_0x2EC137C692A52458(Var10, unk_0x88124E0D60FB8D11(uParam0->f_35[0], 2), 2);
				unk_0xBF3497E24DEAD835(uVar6, 1);
				unk_0xA7C372501A8A3B23(uVar6, 0);
				unk_0x3DA436E63AB0F541(uParam0->f_28[0], uVar6, sVar7, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
