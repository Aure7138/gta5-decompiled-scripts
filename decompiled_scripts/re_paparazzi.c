...
int func_117(int iParam0, int iParam1)
{
	...
	if (func_127(&Global_2543696))
	{
		if (func_125(&Global_2543696, iParam0))
		{
			return 0;
		}
		if (func_118(&Global_2543696, iParam0))
		{
			return 1;
		}
	}
...
void func_201(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	iVar0 = Global_2454187[iParam0 /*6*/][func_202(iParam2)];
	if (iVar0 != 0)
	{
...
int func_203(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2454187[iParam0 /*6*/][func_202(iParam1)];
