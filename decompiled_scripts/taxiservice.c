...
char* func_48()
{
	...
	StringCopy(&cVar0, unk_0x122A00293D3E7167(func_49(Local_43.f_0)), 32);
	...
	switch (iLocal_826)
	{
		case 92:
			...
			if (fVar3 < 100f)
			{
				...
				Var0 = { (Global_111331 + (Var0.f_0 * IntToFloat((100 - unk_0xF2DB717A73826179(fVar3))))), (Global_111331.f_1 + (Var0.f_1 * IntToFloat((100 - unk_0xF2DB717A73826179(fVar3))))), Global_111331.f_2 };
...
void func_113(int iParam0)
{
	...
	if (unk_0xB7A628320EFF8E47(Var3, Global_111331) > 2f)
	{
...
void func_123()
{
	iLocal_105 = (iLocal_105 + unk_0xF2DB717A73826179((unk_0x7FF6ACE380ED166C() * 1000f)));
	if (iLocal_105 > 5000)
	{
	...
	if (iLocal_103 != iLocal_104)
	{
		...
		unk_0x392841D58D2EED1D();
		fLocal_85 = unk_0x2A488C176D52CCA5(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 0), Global_111331);
...
{
	if (unk_0xA1CB00B61C47B900(Param0.f_0, Param0.f_1, Param3.f_0, Param3.f_1))
	{
		return 1;
	}
	return 0;
...
void func_182()
{
	...
	if (unk_0x575B7C28D81C0B4D(Local_43.f_0))
	{
		Var0 = { unk_0xB5BBED356C99E704(Local_43.f_0) };
