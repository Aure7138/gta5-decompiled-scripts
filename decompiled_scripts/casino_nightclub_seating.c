...
void func_1(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 4:
			...
			Var20 = { unk_0xBE8776D2466E9EA6(&sVar0, &sVar16, func_31(uParam0), func_30(uParam0), 0, 2) };
			Var23 = { unk_0x7A6103DCF5EE8CC3(&sVar0, &sVar16, func_31(uParam0), func_30(uParam0), 0, 2) };
			uVar26 = Var23.f_2;
			fVar27 = 0.05f;
		...
		case 5:
			...
			Var29 = { unk_0x7A6103DCF5EE8CC3(&sVar0, &sVar16, func_31(uParam0), func_30(uParam0), 0, 2) };
			fVar32 = Var29.f_2;
			if ((iVar28 != 1 && iVar28 != 0) || func_16(unk_0xCFC0C995455A6204(unk_0x4A8C381C258A124D()), fVar32, 5f))
			{
				if (uParam0->f_1.f_1 == 3)
				{
					if (unk_0xBCF87EE3DC296C2A(0) == 4)
...
int func_50(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((unk_0xFC8BFE4B41177C22(uVar0[iVar11]) && !unk_0x4FAFF4BCB7633475(uVar0[iVar11])) && unk_0xE5E2AE8B19267B8A(uVar0[iVar11])) && func_57(uVar0[iVar11], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar11++;
	...
	else
	{
		...
		if (unk_0x762604C40829DB72(iParam0) && (unk_0x75EAB09F5E974116(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_94(unk_0x259BE71D8A81D4FA(), 0) && !func_93()))
				{
