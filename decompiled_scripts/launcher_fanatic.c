			...
			if (Var0.f_0 == 22)
			{
				if (unk_0x2566F947AAB7B2A7())
				{
					if (func_200(Var0.f_28[1]))
					{
						...
						unk_0x3817498C7B1515DD("MaryAnnes_Friend", Var0.f_28[1], 0);
						unk_0x6D690024C2BB1053("MaryAnnes_Friend", 0, 0, 0, 0);
						iLocal_95 = 1;
					}
				}
			}
	...
	switch (iParam0->f_16)
	{
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
				{
					if (func_200(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0)))
					{
...
void func_189(int iParam0)
{
	...
	if ((unk_0x320D1840B6DAA1CC() - iLocal_97) >= 900)
	{
		if (func_200(iParam0->f_28[0]))
		{
			if (!func_147())
...
void func_190(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	unk_0x49C085D876A9986D(uParam0, sParam1, sParam2, func_191(iParam3), 0);
}
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_200(unk_0xE2D3D51028F0428A()) && func_200(iParam0->f_28[0])) && !func_147()) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam8) && func_196(unk_0xE2D3D51028F0428A(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_180(2))
	{
		if (!func_147())
		{
			if (((func_200(unk_0xE2D3D51028F0428A()) && func_200(iParam0->f_28[0])) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam8) && func_196(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_195(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_193(&uVar0, cParam4, sParam5, 7, 0, 0);
		...
		{
			if (func_200(unk_0xE2D3D51028F0428A()))
			{
				if (func_196(unk_0xE2D3D51028F0428A(), Param1, 1) >= 20f)
				{
					func_145();
				}
			}
...
void func_201(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		if (!unk_0xACC32B78196FBC2A(sParam1))
		{
			...
			{
				if (func_196(unk_0xE2D3D51028F0428A(), Param2, 1) <= 100f)
				{
					func_204(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_196(unk_0xE2D3D51028F0428A(), Param2, 1) > 120f)
				{
					func_206(iParam0);
				}
			}
...
void func_210(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_200(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_212(uParam1) || !unk_0xFCF559C8631ABED7(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_211(iParam2) && !unk_0x2E7F5417D4F4DD69(iParam0, unk_0xE2D3D51028F0428A(), 25f))
					{
						unk_0x529D306014D3C29A(iParam0, unk_0xE2D3D51028F0428A(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_212(uParam1) && uParam1->f_4 == 0) && unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_211(iParam2) || unk_0x2E7F5417D4F4DD69(iParam0, unk_0xE2D3D51028F0428A(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x49D97B076E3590AC(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0xE5965CDF24F93A9F(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_218(unk_0xE2D3D51028F0428A(), uParam0->f_35[iVar0]))
							{
...
int func_221(int iParam0, float fParam1)
{
	...
	if (func_200(unk_0xE2D3D51028F0428A()) && func_200(iParam0))
	{
		if (func_232(iParam0) || unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iParam0))
		{
...
{
	return func_223(iParam0, unk_0xE2D3D51028F0428A(), fParam1, 1, 250, 7);
}
...
int func_227(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_229(unk_0x6B62510F212526DC(iParam1, 1) - unk_0x6B62510F212526DC(iParam0, 1)) };
	...
	{
		Var3 = { func_229(unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_233(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_200(unk_0xE2D3D51028F0428A()) && func_200(uParam0))
	{
...
int func_236(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_229(Param1 - unk_0x6B62510F212526DC(uParam0, 1)) };
...
int func_247(int iParam0)
{
	...
	{
		uLocal_93 = func_248();
		unk_0xF96094A43D443C41(816.3f, 1275.61f, 359.5f, 75f, 0);
	}
...
var func_248()
{
	return unk_0x2915D98110F23A29(744.7144f, 1254.726f, 357.0291f, 847.8754f, 1342.243f, 370.0352f, 0, 1, 1, 1);
}
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0xE5965CDF24F93A9F(uParam0->f_28[1]))
			{
				...
				{
					unk_0xE3752B10DC995E95(uParam0->f_28[1], 3, 1, 2, 0);
					unk_0xE3752B10DC995E95(uParam0->f_28[1], 4, 1, 0, 0);
					unk_0xD9D122A54FFE62B8(uParam0->f_28[1], 0, 0, 0, 0);
					unk_0x50274A7EACA3133A(uParam0->f_28[1], 1);
					unk_0x9D4D63EB83A103AD(uParam0->f_28[1], 3.5f);
				}
				else
				{
					bVar5 = false;
		...
		case 3:
			...
			while (iVar4 <= 1)
			{
				...
				{
					unk_0xD584204572DF0440(uParam0->f_35[iVar4], iVar4);
				}
				iVar4++;
			}
			unk_0x7CD708DEB04F8474(iVar0[2], 1);
			if (unk_0x6F940C2636C076AD("rcm_fanatic2"))
			{
				if (func_200(uParam0->f_28[1]))
				{
					unk_0x49D97B076E3590AC(uParam0->f_28[1], "rcm_fanatic2", "ef_2_rcm__maryann_biking_cyclist", 8f, -8f, -1, 1, 0, 0, 0, 0);
...
int func_257()
{
	...
	iVar0 = 0;
	if (unk_0x574E2A23F0F76E35(801.7148f, 1270.138f, 359.2855f, 6f, joaat("prop_facgate_03_l"), 0))
	{
		unk_0x798E4BBA7A3C56AE(joaat("prop_facgate_03_l"), 801.7148f, 1270.138f, 359.2855f, 1, 0f, 0);
		iVar0++;
	}
	if (unk_0x574E2A23F0F76E35(802.9195f, 1280.92f, 360.7272f, 6f, joaat("prop_facgate_03_r"), 0))
	{
		unk_0x798E4BBA7A3C56AE(joaat("prop_facgate_03_r"), 802.9195f, 1280.92f, 360.7272f, 1, 0f, 0);
		iVar0++;
	}
	if (iVar0 == 2)
	{
...
void func_260(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_261(uParam0);
