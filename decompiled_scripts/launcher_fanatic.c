	...
	if (unk_0x4210287E2833D44B(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_111380[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_289(&(Global_111380[Var0.f_0 /*10*/].f_9));
			}
		}
		func_274(&Var0, 1);
	}
			...
			if (Var0.f_0 == 22)
			{
				if (unk_0xE807694ABD40478F())
				{
					if (func_198(Var0.f_28[1]))
					{
						...
						unk_0xF81CBD28BD382566("MaryAnnes_Friend", Var0.f_28[1], 0);
						unk_0xE13F3E0ED3407B90("MaryAnnes_Friend", 0, 0, 0, 0);
						iLocal_95 = 1;
					}
				}
			}
	...
	switch (iParam0->f_16)
	{
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
				{
					if (func_198(unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0)))
					{
...
void func_187(int iParam0)
{
	...
	if ((unk_0xDFB7BFA6482FEE1E() - iLocal_97) >= 900)
	{
		if (func_198(iParam0->f_28[0]))
		{
			if (!func_145())
...
{
	unk_0xF91D68602B0BFFFF(uParam0, sParam1, sParam2, func_189(iParam3), 0);
}
...
int func_190(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_198(unk_0x7D2B9E6A64637269()) && func_198(iParam0->f_28[0])) && !func_145()) && (unk_0xDFB7BFA6482FEE1E() - iParam0->f_60) > iParam8) && func_194(unk_0x7D2B9E6A64637269(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_178(2))
	{
		if (!func_145())
		{
			if (((func_198(unk_0x7D2B9E6A64637269()) && func_198(iParam0->f_28[0])) && (unk_0xDFB7BFA6482FEE1E() - iParam0->f_60) > iParam8) && func_194(unk_0x7D2B9E6A64637269(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_193(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_191(&uVar0, cParam4, sParam5, 7, 0, 0);
		...
		{
			if (func_198(unk_0x7D2B9E6A64637269()))
			{
				if (func_194(unk_0x7D2B9E6A64637269(), Param1, 1) >= 20f)
				{
					func_143();
				}
			}
...
void func_199(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0xCAD1755E530A6012(unk_0x1146A9AE09CE2B14()))
	{
		if (!unk_0xAB6A270F84A8781E(sParam1))
		{
			...
			{
				if (func_194(unk_0x7D2B9E6A64637269(), Param2, 1) <= 100f)
				{
					func_202(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_194(unk_0x7D2B9E6A64637269(), Param2, 1) > 120f)
				{
					func_204(iParam0);
				}
			}
...
void func_208(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_198(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_210(uParam1) || !unk_0x698F51FB33ADAF7B(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_209(iParam2) && !unk_0x836F48E8C4A773BF(iParam0, unk_0x7D2B9E6A64637269(), 25f))
					{
						unk_0xB0C1A43193C25F7A(iParam0, unk_0x7D2B9E6A64637269(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_210(uParam1) && uParam1->f_4 == 0) && unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), unk_0xD6E677FAD7521410(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_209(iParam2) || unk_0x836F48E8C4A773BF(iParam0, unk_0x7D2B9E6A64637269(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x4261814A9A26E86F(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0x419E13582192CFEA(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_216(unk_0x7D2B9E6A64637269(), uParam0->f_35[iVar0]))
							{
...
int func_219(int iParam0, float fParam1)
{
	...
	if (func_198(unk_0x7D2B9E6A64637269()) && func_198(iParam0))
	{
		if (func_230(iParam0) || unk_0x87BE50F80F3FCEAB(unk_0x1146A9AE09CE2B14(), iParam0))
		{
...
{
	return func_221(iParam0, unk_0x7D2B9E6A64637269(), fParam1, 1, 250, 7);
}
...
int func_225(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_227(unk_0xD6E677FAD7521410(iParam1, 1) - unk_0xD6E677FAD7521410(iParam0, 1)) };
	...
	{
		Var3 = { func_227(unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 5f, 0f) - unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_231(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_198(unk_0x7D2B9E6A64637269()) && func_198(uParam0))
	{
...
int func_234(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_227(Param1 - unk_0xD6E677FAD7521410(uParam0, 1)) };
...
int func_245(int iParam0)
{
	...
	{
		uLocal_93 = func_246();
		unk_0x91F94D2287684BDB(816.3f, 1275.61f, 359.5f, 75f, 0);
	}
...
var func_246()
{
	return unk_0x0823FA7465392E20(744.7144f, 1254.726f, 357.0291f, 847.8754f, 1342.243f, 370.0352f, 0, 1, 1, 1);
}
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x419E13582192CFEA(uParam0->f_28[1]))
			{
				...
				{
					unk_0x4170FE884DF7426D(uParam0->f_28[1], 3, 1, 2, 0);
					unk_0x4170FE884DF7426D(uParam0->f_28[1], 4, 1, 0, 0);
					unk_0xC8749D706BBF16E1(uParam0->f_28[1], 0, 0, 0, 0);
					unk_0xBE91B077ADADE97F(uParam0->f_28[1], 1);
					unk_0x63EC3B3BCF4B0D48(uParam0->f_28[1], 3.5f);
				}
				else
				{
					bVar5 = false;
		...
		case 3:
			...
			while (iVar4 <= 1)
			{
				...
				{
					unk_0x473DA067A7AE5435(uParam0->f_35[iVar4], iVar4);
				}
				iVar4++;
			}
			unk_0x16C6E55F8C91ED24(iVar0[2], 1);
			if (unk_0x0EC2B29D4172D225("rcm_fanatic2"))
			{
				if (func_198(uParam0->f_28[1]))
				{
					unk_0x4261814A9A26E86F(uParam0->f_28[1], "rcm_fanatic2", "ef_2_rcm__maryann_biking_cyclist", 8f, -8f, -1, 1, 0, 0, 0, 0);
...
int func_255()
{
	...
	iVar0 = 0;
	if (unk_0xCC09B877A009E41F(801.7148f, 1270.138f, 359.2855f, 6f, joaat("prop_facgate_03_l"), 0))
	{
		unk_0x863490667AD88563(joaat("prop_facgate_03_l"), 801.7148f, 1270.138f, 359.2855f, 1, 0f, 0);
		iVar0++;
	}
	if (unk_0xCC09B877A009E41F(802.9195f, 1280.92f, 360.7272f, 6f, joaat("prop_facgate_03_r"), 0))
	{
		unk_0x863490667AD88563(joaat("prop_facgate_03_r"), 802.9195f, 1280.92f, 360.7272f, 1, 0f, 0);
		iVar0++;
	}
	if (iVar0 == 2)
	{
