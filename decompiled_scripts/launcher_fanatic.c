	...
	switch (iParam0->f_16)
	{
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
				{
					if (func_198(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0)))
					{
...
{
	unk_0x49C085D876A9986D(uParam0, sParam1, sParam2, func_189(iParam3), 0);
}
...
int func_190(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_198(unk_0xE2D3D51028F0428A()) && func_198(iParam0->f_28[0])) && !func_145()) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam8) && func_194(unk_0xE2D3D51028F0428A(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_178(2))
	{
		if (!func_145())
		{
			if (((func_198(unk_0xE2D3D51028F0428A()) && func_198(iParam0->f_28[0])) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam8) && func_194(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_193(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_191(&uVar0, cParam4, sParam5, 7, 0, 0);
		...
		{
			if (func_198(unk_0xE2D3D51028F0428A()))
			{
				if (func_194(unk_0xE2D3D51028F0428A(), Param1, 1) >= 20f)
				{
					func_143();
				}
			}
...
int func_219(int iParam0, float fParam1)
{
	...
	if (func_198(unk_0xE2D3D51028F0428A()) && func_198(iParam0))
	{
...
int func_231(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_198(unk_0xE2D3D51028F0428A()) && func_198(uParam0))
	{
