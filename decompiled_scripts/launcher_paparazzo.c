...
int func_202(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_132(unk_0xC1A5EC5C986B98AD()) && func_132(iParam0->f_28[0])) && !func_151()) && (unk_0xA5E11AF0A2B928C1() - iParam0->f_60) > iParam8) && func_197(unk_0xC1A5EC5C986B98AD(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_215(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[iVar0]))
							{
...
int func_218(int iParam0, float fParam1)
{
	...
	{
		if (func_229(iParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), iParam0))
		{
...
{
	return func_220(iParam0, unk_0xC1A5EC5C986B98AD(), fParam1, 1, 250, 7);
}
...
int func_224(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_226(unk_0x30BE8A934C020461(iParam1, 1) - unk_0x30BE8A934C020461(iParam0, 1)) };
	...
	{
		Var3 = { func_226(unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_233(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_226(Param1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
int func_246(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			while (iVar9 <= (iVar0 - 1))
			{
				unk_0x852EC2A7DE66202D(iVar0[iVar9]);
				iVar9++;
			}
			unk_0x28818732C8F0F80E(sVar8);
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_255(&iVar0) || !unk_0x2BBF749E555360DC(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
			{
				if (func_252(&(uParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
					...
					uVar10 = unk_0x191673E3F99212B2(-490.809f, 232.39f, 82.018f, 0f, 0f, 33.84f, 2);
					unk_0x5F243F8265BB664F(uVar10, 1);
					unk_0xE4E4F775E5660E56(uVar10, 0);
					unk_0x468D976993BF7FE1(uParam0->f_28[0], uVar10, "rcmpaparazzo_4", "pap_4_rcm_leadin", 8f, -8f, 1, 16, 1148846080, 0);
				}
				else
				{
					bVar11 = false;
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[0]))
			{
				...
				if (func_132(uParam0->f_28[0]) && unk_0x7DE17ACDD8BA2642(uParam0->f_41[0]))
				{
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[1]))
			{
				...
				if (func_132(uParam0->f_28[1]) && unk_0x7DE17ACDD8BA2642(uParam0->f_41[1]))
				{
		...
		case 3:
			...
			while (iVar9 <= (iVar0 - 1))
			{
				unk_0xE0A291F406691F03(iVar0[iVar9]);
				iVar9++;
			}
			return 1;
			break;
...
int func_258(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_255(&iVar0) || !unk_0x2BBF749E555360DC(sVar30))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_131(uParam0->f_28[0]))
			{
				...
				{
					func_247(&(uParam0->f_41[3]), iVar0[1], unk_0x7394CB479CCA24AF(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			if (func_132(uParam0->f_41[0]))
			{
				...
				unk_0xA2CBB04560DD6361(uParam0->f_41[0], uLocal_94, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1148846080);
				unk_0x5F243F8265BB664F(uLocal_94, 1);
				if (func_132(uParam0->f_28[0]))
				{
					unk_0x468D976993BF7FE1(uParam0->f_28[0], uLocal_94, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_132(uParam0->f_41[1]))
				{
					unk_0xA2CBB04560DD6361(uParam0->f_41[1], uLocal_94, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1148846080);
				}
				if (func_132(uParam0->f_41[2]))
				{
					unk_0xA2CBB04560DD6361(uParam0->f_41[2], uLocal_94, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1148846080);
				}
			}
			iVar31 = 0;
			while (iVar31 <= (iVar0 - 1))
...
int func_259(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_255(&iVar0) || !unk_0x2BBF749E555360DC("rcmpaparazzo_2"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_131(uParam0->f_28[0]))
			{
				if (!unk_0x7DE17ACDD8BA2642(uParam0->f_41[0]))
				{
					func_247(&(uParam0->f_41[0]), iVar0[2], unk_0x7394CB479CCA24AF(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_132(uParam0->f_41[0]))
					{
						...
						unk_0xE0A291F406691F03(iVar0[2]);
					}
					else
					{
						bVar5 = false;
		...
		case 3:
			if (func_132(uParam0->f_28[0]) && func_132(unk_0xC1A5EC5C986B98AD()))
			{
...
int func_260(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_255(&iVar0) || !unk_0x2BBF749E555360DC(sVar7))
			{
				return 0;
			}
			func_261(46, 1);
		...
		case 3:
			if (func_132(uParam0->f_28[0]))
			{
				if (unk_0x2BBF749E555360DC("rcmpaparazzo1beckon"))
				{
					...
					unk_0x3EE48ADC8C7F5CC4(0, sVar7, "pap_idle_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x3EE48ADC8C7F5CC4(0, sVar7, "pap_idle_action_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x3EE48ADC8C7F5CC4(0, sVar7, "pap_idle_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x3EE48ADC8C7F5CC4(0, sVar7, "pap_idle_action_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x00E06E21BBC8227A(uVar6, 1);
					unk_0xF2CFC6EC8C85FA78(uVar6);
					unk_0x3D7110D966B0CEA2(uParam0->f_28[0], uVar6);
					unk_0x63EF69C6969A3D26(&uVar6);
				}
			}
			unk_0x0B34FA69ECCE3927(sVar7);
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
				if (iVar4 != 1)
...
void func_261(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 46:
			if (bParam1)
			{
				unk_0x8E09E8C52602EBB2(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, 0, 1);
				unk_0xC6AD633F6B896D88(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, 0);
			}
			else
			{
				unk_0x8E09E8C52602EBB2(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, 1, 1);
			}
			break;
	}
}
