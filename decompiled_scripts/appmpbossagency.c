...
void __EntryFunction__()
{
	...
	fLocal_113 = 35.5f;
	StringCopy(&Local_122, "CELL_206", 16);
	StringCopy(&Local_126, "CELL_214", 16);
	StringCopy(&Local_130, "CELL_243", 16);
	StringCopy(&Local_134, "CELL_244", 16);
	StringCopy(&Local_138, "CELL_265", 16);
	StringCopy(&Local_142, "CELL_300", 16);
	unk_0x945226432ACF160F();
	func_95(&uLocal_149);
	iLocal_146 = 0;
	func_93();
	func_92(Global_14424, "SET_THEME", unk_0xBBDA792448DB5A89(5), -1082130432, -1082130432, -1082130432, -1082130432);
	func_82(0);
	while (true)
	{
...
void func_5()
{
	...
	Global_1621535.f_6 = 1;
	if (iLocal_148)
	{
		if (unk_0x69EEC6F255864D43(2, Global_14412))
		{
			iLocal_148 = 0;
		}
		return;
	...
	unk_0xDC38CC1E35B6A5D7("HUD_INPUT23", "BA_APP_PASS_W", 36, 0, 0, -1, 0, 0, 1);
}
...
void func_6(int iParam0)
{
	...
	iVar0 = Global_1621535.f_7[iParam0 /*8*/].f_2;
	if (Global_1621535.f_7[iParam0 /*8*/].f_1 == 1 && iLocal_147 == iVar0)
	{
		func_24(iVar0, Global_1621535.f_7[iParam0 /*8*/].f_6);
		func_11(iParam0);
	}
	Global_1621535.f_6 = 0;
	func_7(0);
...
void func_11(int iParam0)
{
	...
	if (iParam0 != -1)
	{
		if (Global_1621535.f_7[iParam0 /*8*/].f_1 == 1)
		{
			if (unk_0xAA4F14DA15DB0B51(Global_1621535.f_7[iParam0 /*8*/].f_5, 0))
			{
				func_23();
				if (Global_1621535.f_7[iParam0 /*8*/].f_7 == 0)
				{
					func_23();
				}
				else
				{
					Global_1621535.f_4 = (Global_1621535.f_4 - 1);
					if (Global_1621535.f_4 < 0)
					{
						Global_1621535.f_4 = 0;
					}
					func_16();
				}
			}
			unk_0x507FE690B1271947(&(Global_1622795[unk_0x0FFED3E94261A832() /*431*/].f_11.f_21), Global_1621535.f_7[iParam0 /*8*/].f_2);
			unk_0xA216C26603EB04E7(Global_1621535.f_7[iParam0 /*8*/].f_4);
			func_15();
			func_13(0);
		}
		iVar0 = iParam0;
		while (iVar0 <= 8)
		{
			Global_1621535.f_7[iVar0 /*8*/] = { Global_1621535.f_7[iVar0 + 1 /*8*/] };
			iVar0++;
		}
		Global_1621535.f_7[9 /*8*/].f_1 = 0;
		Global_1621535.f_7[9 /*8*/].f_2 = func_12();
	}
}
...
void func_13(int iParam0)
{
	if (!func_14(iParam0))
	{
		unk_0xF6082E2ADA1C795B(&(Global_1621535.f_3), iParam0);
	}
}

bool func_14(int iParam0)
{
	return unk_0xAA4F14DA15DB0B51(Global_1621535.f_3, iParam0);
}

void func_15()
{
	Global_1621535 = (Global_1621535 - 1);
}
...
void func_17()
{
	if (!Global_14605)
	{
		...
		{
			func_92(Global_14424, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_18(1);
			func_92(Global_14424, "DISPLAY_VIEW", 1f, unk_0xBBDA792448DB5A89(Global_14423), -1082130432, -1082130432, -1082130432);
		}
	}
}
...
void func_23()
{
	Global_1621535.f_1 = (Global_1621535.f_1 - 1);
	if (Global_1621535.f_1 < 0)
	{
		Global_1621535.f_1 = 0;
	}
}

void func_24(int iParam0, var uParam1)
{
	if (Global_1622795[unk_0x0FFED3E94261A832() /*431*/].f_11.f_25 == func_12())
	{
		if (unk_0x885F483F34E47503(iParam0))
		{
			Global_1622795[unk_0x0FFED3E94261A832() /*431*/].f_11.f_25 = iParam0;
			Global_2497344.f_4828.f_36 = uParam1;
...
int func_27(int iParam0, int iParam1)
{
	...
	while (iVar0 < func_28())
	{
		if (Global_1621535.f_7[iVar0 /*8*/].f_7 == iParam1)
		{
			iParam0 = (iParam0 - 1);
			if (iParam0 < 0)
			{
...
void func_29()
{
	...
	iVar1 = Global_1621535.f_7[iVar0 /*8*/].f_2;
	if (!func_44(iVar1, 0, 1) || iLocal_147 != iVar1)
	{
		func_82(1);
		return;
	}
	func_39(&uLocal_149);
	if (func_37(&uLocal_149))
	{
		func_82(1);
		return;
	}
	...
	if (func_32(&uLocal_149))
	{
		...
		else if (Global_1621535.f_7[iVar0 /*8*/] == 0)
		{
			func_6(iVar0);
		}
		else if (Global_1621535.f_7[iVar0 /*8*/] == 1)
		{
			func_30(iVar0);
		}
		else
...
{
	unk_0xF6082E2ADA1C795B(&Global_1573830, 15);
	func_11(iParam0);
	Global_1621535.f_6 = 0;
	func_7(0);
}
...
int func_32(var uParam0)
{
	...
	if (!unk_0x92BC4A8239BDDACC(2, Global_14412))
	{
		return 0;
	}
	func_33();
...
int func_37(var uParam0)
{
	...
	if (!unk_0x92BC4A8239BDDACC(2, Global_14413))
	{
		return 0;
	}
	func_38();
...
{
	if (unk_0x3732B96D7A1859B4() < uParam0->f_1)
	{
		return;
	}
	if (!unk_0x0B21CC5276C2CE1B())
	...
	if (unk_0x92BC4A8239BDDACC(2, Global_14419) || unk_0x92BC4A8239BDDACC(2, 181))
	{
		func_42();
		uParam0->f_1 = unk_0x3732B96D7A1859B4() + 50;
	}
	if (unk_0x92BC4A8239BDDACC(2, Global_14420) || unk_0x92BC4A8239BDDACC(2, 180))
	{
		func_40();
		uParam0->f_1 = unk_0x3732B96D7A1859B4() + 50;
	}
...
void func_40()
{
	func_92(Global_14424, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_42()
{
	func_92(Global_14424, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(1), -1082130432, -1082130432, -1082130432, -1082130432);
	unk_0x08BE237DBCD9CBD9(-1, "Menu_Navigate", &Global_14432, 1);
	func_43();
}
...
void func_45()
{
	...
	if (func_32(&uLocal_149))
	{
		...
		while (!unk_0x49312763BCF4C85A(uVar0))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		iLocal_146 = unk_0x7E45511185E08C01(uVar0);
		iVar1 = func_27(iLocal_146, 0);
		switch (Global_1621535.f_7[iVar1 /*8*/].f_1)
		{
			case 0:
				return;
	...
	{
		unk_0xD1FCC52F87A98873(Global_14424, "GET_CURRENT_SELECTION");
		uVar2 = unk_0xCA19844C8EBF135B();
		while (!unk_0x49312763BCF4C85A(uVar2))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		iLocal_146 = unk_0x7E45511185E08C01(uVar2);
		iVar3 = func_27(iLocal_146, 0);
		switch (Global_1621535.f_7[iVar3 /*8*/].f_1)
		{
			case 0:
				return;
...
void func_46(int iParam0)
{
	if (func_14(iParam0))
	{
		unk_0x507FE690B1271947(&(Global_1621535.f_3), iParam0);
	}
}
...
void func_47()
{
	...
	func_92(Global_14424, "SET_DATA_SLOT_EMPTY", unk_0xBBDA792448DB5A89(26), -1082130432, -1082130432, -1082130432, -1082130432);
	bVar0 = false;
	iVar3 = func_27(iLocal_146, 0);
	iLocal_147 = Global_1621535.f_7[iVar3 /*8*/].f_2;
	iVar4 = Global_1621535.f_7[iVar3 /*8*/].f_2;
	unk_0xD1FCC52F87A98873(Global_14424, "SET_DATA_SLOT");
	unk_0x4CECF13AF144A8F6(26);
	unk_0x4CECF13AF144A8F6(0);
	if (func_44(iVar4, 0, 1))
	{
		Var5 = { func_79(iVar4) };
		unk_0xADBDBA2DF8443753("STRING");
		unk_0x95CE6D748899618C(func_73(iVar4));
		unk_0xCF6846167A5EFE98(&Var5);
		unk_0xF7D95CCE1364B5CE();
		bVar0 = true;
	}
	else
	...
	if (Global_1621535.f_7[iVar3 /*8*/] == 0)
	{
		if (Global_262145.f_13512)
		{
			bVar25 = func_72(iVar4);
			iVar26 = 0;
			while (iVar26 < 3)
			{
				if (iVar27 < 3)
				{
					if (Global_1622795[iVar4 /*431*/].f_11.f_10[iVar26] != func_12())
					{
						if (func_44(Global_1622795[iVar4 /*431*/].f_11.f_10[iVar26], 0, 1))
						{
							uVar21[iVar27] = Global_1622795[iVar4 /*431*/].f_11.f_10[iVar26];
							iVar27++;
						}
					}
				}
			...
			else
			{
				...
				unk_0xADBDBA2DF8443753(&cVar28);
				iVar26 = 0;
				while (iVar26 < iVar27)
				{
					Var32 = { func_79(uVar21[iVar26]) };
					unk_0xCF6846167A5EFE98(&Var32);
					iVar26++;
				}
				unk_0xF7D95CCE1364B5CE();
			}
		...
		{
			if (Global_1621535.f_88[iVar3 /*5*/].f_1)
			{
				if (Global_1621535.f_88[iVar3 /*5*/].f_2)
				{
			...
			else if (Global_1621535.f_88[iVar3 /*5*/].f_2)
			{
			...
			unk_0xADBDBA2DF8443753(&cVar48);
			unk_0xEA97619D8B89D387(Global_1621535.f_88[iVar3 /*5*/]);
			unk_0xEA97619D8B89D387(func_71(iVar4));
			unk_0xEA97619D8B89D387(Global_1621535.f_88[iVar3 /*5*/].f_3);
			unk_0xEA97619D8B89D387(Global_1621535.f_88[iVar3 /*5*/].f_4);
			unk_0xF7D95CCE1364B5CE();
		}
	}
	else if (Global_1621535.f_7[iVar3 /*8*/] == 1)
	{
		unk_0xADBDBA2DF8443753("BA_APP_BODY_DM2");
		unk_0x95CE6D748899618C(func_73(Global_1621535.f_7[iVar3 /*8*/].f_2));
		unk_0xCF6846167A5EFE98(func_59(Global_1621535.f_7[iVar3 /*8*/].f_2));
		unk_0xF7D95CCE1364B5CE();
	}
	if (bVar0)
	{
		iVar2 = func_53(Global_1621535.f_7[iVar3 /*8*/].f_2);
		if (iVar2 == 0)
		{
			bVar0 = false;
		}
		...
		{
			sVar1 = unk_0xCF8EC788EB8AB4DB(iVar2);
		}
	}
	if (bVar0)
	{
		unk_0x4B897FDFB899F911(sVar1);
	}
	else
	{
		func_20(&Local_142);
	...
	unk_0x8123397DC676E794();
	func_92(Global_14424, "DISPLAY_VIEW", unk_0xBBDA792448DB5A89(26), -1082130432, -1082130432, -1082130432, -1082130432);
	func_51(&Local_138);
	func_48(13, &Local_130, 12, &Local_134, 4, &Local_122, &uLocal_149);
	iLocal_121 = 1;
}

void func_48(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)
{
	func_49(2, iParam0, sParam1, 0, uParam6, -1);
	func_49(1, iParam2, sParam3, 1, uParam6, 17);
	func_49(3, iParam4, sParam5, 2, uParam6, -1);
}

void func_49(int iParam0, int iParam1, char* sParam2, int iParam3, var uParam4, int iParam5)
{
	if (iParam1 == 1)
	{
		func_19(Global_14424, "SET_SOFT_KEYS", unk_0xBBDA792448DB5A89(iParam0), 0f, unk_0xBBDA792448DB5A89(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	...
	if (Global_14431)
	{
		func_19(Global_14424, "SET_SOFT_KEYS", unk_0xBBDA792448DB5A89(iParam0), 1f, unk_0xBBDA792448DB5A89(iParam1), -1f, -1f, sParam2, 0, 0, 0, 0);
		unk_0xF6082E2ADA1C795B(uParam4, iParam3);
		func_50(iParam5, 1);
		return;
	}
	func_19(Global_14424, "SET_SOFT_KEYS", unk_0xBBDA792448DB5A89(iParam0), 1f, unk_0xBBDA792448DB5A89(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	unk_0xF6082E2ADA1C795B(uParam4, iParam3);
	func_50(iParam5, 1);
}
...
{
	func_52(Global_14424, "SET_HEADER", sParam0, 0, 0, 0, 0);
}
...
void func_57(int iParam0)
{
	...
	func_58(&(Global_1362801[iVar32 /*5*/]));
...
char* func_59(int iParam0)
{
	...
	{
		uVar0 = func_70(&(Global_1622795[iParam0 /*431*/].f_11.f_98));
		return uVar0;
	}
	if (Global_1622795[iParam0 /*431*/].f_11.f_114 != Global_1622795[unk_0x0FFED3E94261A832() /*431*/].f_11.f_114)
	{
		uVar0 = func_65(iParam0, 0);
		return uVar0;
	}
	if (((func_64(iParam0, 28) || func_64(unk_0x0FFED3E94261A832(), 28)) || func_63(iParam0)) && !func_61(iParam0))
	{
	...
	if (iVar1 != func_12())
	{
		uVar0 = func_70(&(Global_1622795[iVar1 /*431*/].f_11.f_98));
...
int func_68(int iParam0, bool bParam1, int iParam2)
{
	...
	if (iVar0 != func_12() && Global_1622795[iVar0 /*431*/].f_11.f_317 == iParam2)
	{
		return 1;
	}
	return 0;
...
int func_69(int iParam0, int iParam1)
{
	if (iParam0 != func_12())
	{
		if (Global_1622795[iParam0 /*431*/].f_11 != func_12())
		{
...
bool func_77(int iParam0, bool bParam1)
{
	...
	return Global_1622795[iParam0 /*431*/].f_11 != func_12();
}
...
struct<16> func_79(var uParam0)
{
	struct<16> Var0;
	
	StringCopy(&Var0, "<C>", 64);
	StringConCat(&Var0, unk_0x4325D353D7D27B34(uParam0), 64);
...
void func_81()
{
	unk_0x712F381D6DC979A0(0, 176);
	unk_0x712F381D6DC979A0(0, 177);
}
...
void func_82(bool bParam0)
{
	...
	iVar1 = func_28();
	iVar1 = (iVar1 - func_91());
	if ((func_77(unk_0x0FFED3E94261A832(), 0) && !func_90(1)) && iVar1 <= 0)
	{
		func_88();
		return;
	}
	func_83();
	func_92(Global_14424, "DISPLAY_VIEW", unk_0xBBDA792448DB5A89(25), unk_0xBBDA792448DB5A89(iVar0), -1082130432, -1082130432, -1082130432);
	...
	if (bVar2)
	{
		func_48(13, &Local_126, 12, &Local_134, 4, &Local_122, &uLocal_149);
	}
	else
	{
		func_48(1, "", 1, "", 4, &Local_122, &uLocal_149);
	}
	iLocal_121 = 0;
}
...
void func_83()
{
	...
	func_92(Global_14424, "SET_DATA_SLOT_EMPTY", unk_0xBBDA792448DB5A89(25), -1082130432, -1082130432, -1082130432, -1082130432);
	iVar0 = 0;
	while (iVar0 < func_28())
	{
		if (Global_1621535.f_7[iVar0 /*8*/].f_1 == 1 && Global_1621535.f_7[iVar0 /*8*/].f_7 == 0)
		{
			switch (Global_1621535.f_7[iVar0 /*8*/])
			{
				case 0:
...
int func_85(int iParam0, int iParam1)
{
	...
	if (Global_1621535.f_7[iParam0 /*8*/].f_2 == func_12() || !func_44(Global_1621535.f_7[iParam0 /*8*/].f_2, 0, 1))
	{
		return 0;
	}
	unk_0xD1FCC52F87A98873(Global_14424, "SET_DATA_SLOT");
	...
	Var0 = { func_79(Global_1621535.f_7[iParam0 /*8*/].f_2) };
	func_86(&Var0);
	unk_0xADBDBA2DF8443753("BA_APP_BODY_DM1");
	unk_0xF7D95CCE1364B5CE();
	unk_0x4CECF13AF144A8F6(-1);
	iVar16 = 1;
	iVar17 = func_76(Global_1621535.f_7[iParam0 /*8*/].f_2);
	if (iVar17 != -1)
	{
		iVar16 = func_74(iVar17);
	}
...
int func_87(int iParam0, int iParam1)
{
	...
	Var0 = { func_79(Global_1621535.f_7[iParam0 /*8*/].f_2) };
	func_86(&Var0);
	bVar16 = func_72(Global_1621535.f_7[iParam0 /*8*/].f_2);
	iVar17 = func_71(Global_1621535.f_7[iParam0 /*8*/].f_2);
	if (iVar17 == 0)
	{
		if (bVar16)
		{
	...
	else if (iVar17 == 1)
	{
		if (bVar16)
		{
			unk_0xADBDBA2DF8443753("BA_APP_BODYCT3");
		}
		else
		{
			unk_0xADBDBA2DF8443753("BA_APP_BODY_T3");
		}
		unk_0xEA97619D8B89D387(iVar17);
		unk_0xF7D95CCE1364B5CE();
	}
	else
	{
		if (bVar16)
		{
			unk_0xADBDBA2DF8443753("BA_APP_BODYCT2");
		}
		else
		{
			unk_0xADBDBA2DF8443753("BA_APP_BODY_T2");
		}
		unk_0xEA97619D8B89D387(iVar17);
		unk_0xF7D95CCE1364B5CE();
	}
	unk_0x4CECF13AF144A8F6(-1);
	iVar18 = 1;
	iVar19 = func_76(Global_1621535.f_7[iParam0 /*8*/].f_2);
	if (iVar19 != -1)
	{
		iVar18 = func_74(iVar19);
	}
...
void func_88()
{
	...
	unk_0x4CECF13AF144A8F6(0);
	unk_0xADBDBA2DF8443753("STRING");
	unk_0x95CE6D748899618C(func_73(unk_0x0FFED3E94261A832()));
	unk_0xCF6846167A5EFE98(func_89());
	unk_0xF7D95CCE1364B5CE();
...
char* func_89()
{
	...
	if (iVar0 != func_12())
	{
		...
		{
			if (((func_64(iVar0, 28) || func_64(unk_0x0FFED3E94261A832(), 28)) || func_63(iVar0)) && !func_61(iVar0))
			{
		...
		uVar1 = func_70(&(Global_1622795[iVar0 /*431*/].f_11.f_98));
...
{
	return func_67(unk_0x0FFED3E94261A832(), bParam0);
}
...
int func_91()
{
	...
	while (iVar0 < func_28())
	{
		if (Global_1621535.f_7[iVar0 /*8*/].f_7 == 1)
		{
			iVar1++;
		}
		iVar0++;
