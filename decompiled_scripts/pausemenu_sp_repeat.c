...
void __EntryFunction__()
{
	...
	if (Global_2883694)
	{
		if (unk_0xB4C854DD86E40FDA(-43879923) == 0)
		{
			unk_0x251C5C1DDC74D01D(-43879923);
			while (!unk_0x095032C22DEE1587(-43879923))
			{
	...
	{
		if (unk_0xB4C854DD86E40FDA(1179280373) == 0)
		{
			unk_0x251C5C1DDC74D01D(1179280373);
			while (!unk_0x095032C22DEE1587(1179280373))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
		...
		case 1:
			switch (ScriptParam_0.f_1)
			{
				...
				case 52:
					...
					{
						unk_0x46978FCA0F1EA6CE(ScriptParam_0.f_3);
					}
					break;
		...
		case 2:
			switch (ScriptParam_0.f_1)
			{
				...
				case 76:
					if (Global_78124 != -1)
					{
						func_1(Global_78124, Global_78107);
						func_27(-1);
						unk_0xDD0B677578E78E45(0);
						unk_0x859006DB870314C5(0);
						unk_0x1CA083636A4D1B3C();
						if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
						{
							if (unk_0x55A0C756C4A8220C(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0), 0))
							{
								Global_78109 = { unk_0xC35FBD95659582C4(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0)) };
							}
						}
...
{
	Global_78104 = iParam0;
	Global_78104.f_1 = iParam1;
	if (iParam1 == 7)
	{
		if (iParam0 >= 0 && iParam0 < 63)
		{
			Global_112009[iParam0 /*10*/].f_3 = 1;
		}
	}
	unk_0xCED9E32812D6C7C7(&Global_78106, 0);
}
...
{
	unk_0x249A0D3C5714BCF4("MISHSTA", 8);
	if (!unk_0x01896B71C5AC966E(8))
	{
		return 0;
	}
	iParam0++;
...
int func_6()
{
	if (Global_112922.f_18574.f_380 > 0)
	{
		return 1;
	}
	return 0;
...
int func_7()
{
	...
	else if (Global_112922.f_10016.f_21 > 0)
	{
		return 1;
	}
	return 0;
...
int func_8()
{
	...
	if (unk_0x04458B4E5D9E466A() || func_9())
	{
		return 2;
	}
...
void func_28(int iParam0, int iParam1)
{
	...
	unk_0xCA3CB5CE1B9BFE03("SHOW_COLUMN");
...
void func_29(int iParam0, int iParam1)
{
	...
	unk_0xCA3CB5CE1B9BFE03("SHOW_WARNING_MESSAGE");
	...
	unk_0x4F47E317C74C543B((3 - iVar2));
	func_30(sVar0);
	func_30(sVar1);
	...
	if (func_8() == -1)
	{
		if (func_5(Global_78107))
		{
			...
			if (Global_78108 > 16)
			{
				...
				func_33(func_34(iParam0), Global_78108);
			}
		}
	}
}
...
void func_35()
{
	...
	{
		case 1:
			Global_78108 = func_36(&Local_30, 1, 0, 1);
			break;
		
		case 7:
			Global_78108 = func_36(&Local_30, 0, 1, 1);
			break;
...
int func_39(int iParam0, int iParam1)
{
	...
	{
		case 1:
			return !BitTest(Global_90768[iParam0 /*34*/].f_15, 5);
			break;
...
int func_41(int iParam0, int iParam1)
{
	...
	{
		case 1:
			return Global_112922.f_9085.f_330[iParam0 /*6*/].f_3;
			break;
		
		case 7:
			return Global_112922.f_18574[iParam0 /*6*/].f_3;
			break;
...
int func_43()
{
	if (((Global_112922.f_9085.f_330[24 /*6*/] == 1 || Global_112922.f_9085.f_330[25 /*6*/] == 1) || Global_112922.f_9085.f_330[26 /*6*/] == 1) || Global_112922.f_9085.f_330[27 /*6*/] == 1)
	{
		return 1;
	}
	return 0;
...
void func_46(int iParam0)
{
	...
	Local_28 = { func_78(iParam0, Global_78107) };
	if (!func_4(2))
	{
		return;
	}
	...
	iVar4 = 0;
	iVar0 = 0;
	while (iVar0 < func_75(iParam0, Global_78107))
	{
		iVar5 = func_73(iParam0, Global_78107, iVar0);
		iVar6 = 1;
		switch (iVar5)
		{
			case 42:
		...
		if (!Global_62921[iVar5 /*13*/].f_7 && iVar6)
		{
...
float func_48(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	else
	{
		unk_0xCA3CB5CE1B9BFE03("SET_DESCRIPTION");
		unk_0x4F47E317C74C543B(2);
		unk_0x4F47E317C74C543B(func_49(iVar1));
		unk_0xCA5D23E5F0F0306F(fVar0);
...
void func_52(int iParam0, int iParam1)
{
	...
	if (Global_78107 == 7)
	{
		...
		{
			case 52:
				*iParam1 = Global_112922.f_2352[0 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
			...
			case 53:
				*iParam1 = Global_112922.f_2352[1 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
			...
			case 54:
				*iParam1 = Global_112922.f_2352[2 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
			...
			case 55:
				*iParam1 = Global_112922.f_2352[3 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
			...
			case 56:
				*iParam1 = Global_112922.f_2352[4 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
...
int func_53(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam2 != 0)
	{
		if (!unk_0x0347CCBD719C8ADC(iParam2))
		{
			return 0;
		}
	}
	if (Global_62921[iParam0 /*13*/].f_7)
	{
		return 1;
	}
	Var0 = { Global_62921[iParam0 /*13*/] };
...
void func_54(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	if (iParam5 != 0)
	{
		unk_0xEA5DEA46C3EE64D3(iParam5, "SET_DATA_SLOT");
	}
	else
	{
	...
	if (iParam5 == 0)
	{
		unk_0x4ADC8B166E139423("PM_RP_STATD");
		unk_0x26C23BE14F66F202(sParam3);
		unk_0x26C23BE14F66F202(func_55(iParam4));
		unk_0xD1D4F8D5470AFA4C();
	}
	else
	{
...
void func_57(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	...
	if (iParam6 != 0)
	{
		unk_0xEA5DEA46C3EE64D3(iParam6, "SET_DATA_SLOT");
	}
	else
	{
		unk_0xCA3CB5CE1B9BFE03("SET_DATA_SLOT");
	...
	if (iParam6 == 0)
	{
		...
		unk_0x26C23BE14F66F202(func_55(iParam5));
		unk_0xD1D4F8D5470AFA4C();
	}
	else
	{
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	...
	unk_0x4F47E317C74C543B(unk_0x11E019C8F43ACC8A(fVar0));
	if (iParam6 == 0)
	{
		unk_0x4ADC8B166E139423("PM_RP_STATD");
		unk_0x26C23BE14F66F202(sParam4);
...
void func_59(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4)
{
	if (iParam4 != 0)
	{
		unk_0xEA5DEA46C3EE64D3(iParam4, "SET_DATA_SLOT");
	}
	else
	{
		unk_0xCA3CB5CE1B9BFE03("SET_DATA_SLOT");
	...
	if (iParam4 == 0)
	{
		...
		unk_0x26C23BE14F66F202(func_55(iParam3));
		unk_0xD1D4F8D5470AFA4C();
	}
	else
	{
...
{
	if (func_64(iParam0, func_71(Global_62921[iParam0 /*13*/].f_4)))
	{
		return 1;
	}
	return 0;
...
int func_64(int iParam0, int iParam1)
{
	...
	if (((iParam0 == 881 || iParam0 == 889) || iParam0 == 897) && Global_112922.f_24904[4 /*4*/] == func_65())
	{
...
void func_66()
{
	...
	if (unk_0xE5965CDF24F93A9F(unk_0xE2D3D51028F0428A()))
	{
		if (func_69(Global_112922.f_2363.f_539.f_4321) != unk_0x15CAA6D7B11F1A7C(unk_0xE2D3D51028F0428A()))
		{
			...
			if (func_67(iVar0) && (!func_25(14) || Global_111873))
			{
				if (Global_112922.f_2363.f_539.f_4321 != iVar0 && func_67(Global_112922.f_2363.f_539.f_4321))
				{
...
int func_72(int iParam0)
{
	...
	iVar0 = func_71(Global_62921[iParam0 /*13*/].f_4);
	if (iVar0 > -2)
	{
		return iVar0;
	}
...
int func_73(int iParam0, int iParam1, int iParam2)
{
	...
	{
		case 1:
			return Global_90768[iParam0 /*34*/].f_17[iParam2];
			break;
...
int func_75(int iParam0, int iParam1)
{
	...
	{
		case 1:
			return Global_90768[iParam0 /*34*/].f_16;
			break;
...
{
	unk_0xCA3CB5CE1B9BFE03("SET_DATA_SLOT_EMPTY");
	unk_0x4F47E317C74C543B(iParam0);
	unk_0x6F06CF0E9AB02847();
	if (iParam0 == 1)
	{
...
void func_82(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	if (Global_78107 != iParam0 || iParam2 == 1)
	{
		iVar0 = 1;
	}
...
void func_83()
{
	...
	iVar3 = 0;
	iVar0 = 0;
	while (iVar0 < Global_78108)
	{
		iVar2 = 0;
		iVar3 = 0;
		iVar8 = -1;
		iVar1 = Local_30[iVar0 /*2*/];
		Local_28 = { func_78(iVar1, Global_78107) };
		iVar7 = 0;
		while (iVar7 < func_75(iVar1, Global_78107))
		{
			iVar4 = func_73(iVar1, Global_78107, iVar7);
			if (!Global_62921[iVar4 /*13*/].f_7)
			{
				if (func_63(iVar4) == 1)
				{
					iVar3++;
