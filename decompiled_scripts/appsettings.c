...
void __EntryFunction__()
{
	...
	Global_3069[Global_14394 /*2811*/][2 /*281*/].f_259 = Global_98931.f_12665[Global_14394 /*20*/].f_6;
	Global_3069[Global_14394 /*2811*/][4 /*281*/].f_259 = Global_98931.f_12665[Global_14394 /*20*/].f_9;
	iVar0 = 0;
	while (iVar0 < 9)
	{
		if (Global_69020)
		{
			Global_3069[Global_14394 /*2811*/][1 /*281*/].f_259 = func_43(1188, -1, 0);
			Global_3069[Global_14394 /*2811*/][2 /*281*/].f_259 = func_43(2016, -1, 0);
			Global_3069[Global_14394 /*2811*/][4 /*281*/].f_259 = func_43(2015, -1, 0);
		}
		else if (unk_0xD994929E13CC1ED5(&(Global_98931.f_12665[Global_14394 /*20*/].f_11), &(Global_3069[Global_14394 /*2811*/][1 /*281*/].f_144[iVar0 /*6*/])))
		{
	...
	if (Global_69020)
	{
		Global_98931.f_12665[3 /*20*/].f_10 = func_43(1187, -1, 0);
	}
	Global_3069[Global_14394 /*2811*/][3 /*281*/].f_259 = Global_98931.f_12665[Global_14394 /*20*/].f_10;
	func_42();
	if (Global_69020)
	{
	...
	while (true)
	{
		...
		if (iLocal_49)
		{
			if (unk_0xC9D9444186B5A374() > 3500)
			{
				...
				{
					unk_0x6CEAB2A5314C285D(unk_0x81873881071CD9FE());
				}
				iLocal_49 = 0;
			}
		}
...
void func_2()
{
	...
	if (Global_98931.f_12665.f_83 == 0 || Global_98931.f_12665.f_82 == 0)
	{
		func_3();
	}
...
{
	return func_6(iParam0, Global_35443);
}
...
void func_11()
{
	...
	{
		unk_0x8C7933B8CC1FCB35(0, 100, 100);
	}
}
...
void func_12()
{
	...
	if (iLocal_42 == 1)
	{
		...
		if ((((func_10(2, Global_14370, 0) || func_10(2, Global_14371, 0)) || iLocal_50) || iLocal_64 == 1) || iLocal_65 == 1)
		{
			...
			uLocal_40 = unk_0x723E3684EF582590();
			while (!unk_0xAB56DCBFCD98FF03(uLocal_40))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			iLocal_46 = iLocal_17[unk_0x2D1F70CC7C051146(uLocal_40)];
			if (!unk_0x930F8FBB8E9537CC(unk_0x81873881071CD9FE()))
			{
				unk_0x6CEAB2A5314C285D(unk_0x81873881071CD9FE());
				...
				if (!unk_0x930F8FBB8E9537CC(unk_0x81873881071CD9FE()))
				{
					if (!unk_0xDAA4B2A449536FE5(unk_0x81873881071CD9FE()))
					{
						if (unk_0xD994929E13CC1ED5(&(Global_3069[Global_14394 /*2811*/][1 /*281*/].f_144[iLocal_46 /*6*/]), "Silent Ringtone Dummy"))
						{
						}
						else
						{
							unk_0xE27E1939271C4D12(&(Global_3069[Global_14394 /*2811*/][1 /*281*/].f_144[iLocal_46 /*6*/]), unk_0x81873881071CD9FE(), 1);
						}
					}
				}
			}
	...
	if (Global_14372 == 0)
	{
		if (func_10(2, Global_14363, 0))
		{
			...
			iLocal_45 = unk_0x2D1F70CC7C051146(uLocal_40);
			if (iLocal_45 < 0)
			{
				iLocal_45 = 0;
			}
			...
			if (iLocal_42 == 2)
			{
				...
				Global_98931.f_12665[Global_14394 /*20*/].f_6 = Global_3069[Global_14394 /*2811*/][2 /*281*/].f_260[iVar0];
				func_45(Global_14375, "SET_THEME", unk_0xBBDA792448DB5A89(Global_98931.f_12665[Global_14394 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_69020)
				{
					Global_2550577 = Global_3069[3 /*2811*/][2 /*281*/].f_259;
					func_20(2016, Global_3069[3 /*2811*/][2 /*281*/].f_259, -1, 1);
					func_45(Global_14375, "SET_THEME", unk_0xBBDA792448DB5A89(Global_2550577), -1082130432, -1082130432, -1082130432, -1082130432);
				}
				else
				{
					func_45(Global_14375, "SET_THEME", unk_0xBBDA792448DB5A89(Global_98931.f_12665[Global_14394 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
			...
			if (iLocal_42 == 4)
			{
				Global_98931.f_12665[Global_14394 /*20*/].f_9 = Global_3069[Global_14394 /*2811*/][iLocal_42 /*281*/].f_259;
				if (Global_69020)
				{
					Global_2550578 = Global_3069[3 /*2811*/][4 /*281*/].f_259;
					func_20(2015, Global_3069[3 /*2811*/][4 /*281*/].f_259, -1, 1);
					if (Global_2550578 == 0)
					{
						Var17 = { func_17(unk_0x1329891157A54C63()) };
						iVar30 = 0;
						if (unk_0xBEC1291D6B41868E(0) == 0)
						{
						}
						if ((unk_0x464883E45616A088(&Var17) && unk_0xBEC1291D6B41868E(0)) && Global_2550581 == 0)
						{
							unk_0xC1B1E9A034A63A62(0);
							while (!unk_0x6045493FDFA75257(&Var17, &uVar1) && unk_0x83666F9FB8FEBD4B() < 3000)
							{
								unk_0x4EDE34FBADD967A6(0);
							...
							if (iVar30 == 0)
							{
								unk_0x21ED0FC9B5CC748B(Global_14375, "SET_BACKGROUND_CREW_IMAGE");
								unk_0x6CE839BF5D87A428("CELL_2000");
								unk_0x6222A57F463E8EE7(&uVar1);
					...
					{
						func_45(Global_14375, "SET_BACKGROUND_IMAGE", unk_0xBBDA792448DB5A89(Global_2550578), -1082130432, -1082130432, -1082130432, -1082130432);
					}
				}
				else
				{
					func_45(Global_14375, "SET_BACKGROUND_IMAGE", unk_0xBBDA792448DB5A89(Global_98931.f_12665[Global_14394 /*20*/].f_9), -1082130432, -1082130432, -1082130432, -1082130432);
				}
				func_18(Global_14375, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(22), unk_0xBBDA792448DB5A89(iLocal_44), unk_0xBBDA792448DB5A89(23), -1f, -1f, &(Global_3069[Global_14394 /*2811*/][iLocal_42 /*281*/].f_7[iLocal_17[iLocal_44] /*4*/]), 0, 0, 0, 0);
				func_18(Global_14375, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(22), unk_0xBBDA792448DB5A89(iLocal_45), unk_0xBBDA792448DB5A89(48), -1f, -1f, &(Global_3069[Global_14394 /*2811*/][iLocal_42 /*281*/].f_7[iLocal_17[iLocal_45] /*4*/]), 0, 0, 0, 0);
				iLocal_44 = iLocal_45;
			...
			if (iLocal_42 == 1)
			{
				Global_98931.f_12665[Global_14394 /*20*/].f_11 = { Global_3069[Global_14394 /*2811*/][1 /*281*/].f_144[Global_3069[Global_14394 /*2811*/][1 /*281*/].f_259 /*6*/] };
				if (Global_69020)
				{
					func_20(1188, Global_3069[3 /*2811*/][1 /*281*/].f_259, -1, 1);
				}
			...
			if (iLocal_42 == 3)
			{
				Global_98931.f_12665[Global_14394 /*20*/].f_10 = Global_3069[Global_14394 /*2811*/][iLocal_42 /*281*/].f_259;
				if (Global_69020)
				{
					func_20(1187, Global_98931.f_12665[3 /*20*/].f_10, -1, 1);
				}
				if (Global_98931.f_12665[Global_14394 /*20*/].f_10 == 1)
				{
					iLocal_52 = 1;
					iLocal_54 = unk_0x48E480685981C7D4();
				}
				else
				{
					iLocal_52 = 0;
			...
			if (iLocal_42 == 0)
			{
				if (Global_69020 == 1)
				{
					...
					iLocal_44 = iLocal_45;
					func_45(Global_14375, "DISPLAY_VIEW", 22f, unk_0xBBDA792448DB5A89(iLocal_45), -1082130432, -1082130432, -1082130432);
					func_20(2078, Global_3069[3 /*2811*/][iLocal_42 /*281*/].f_259, -1, 1);
				}
				else
				{
					...
					if (Global_3069[Global_14394 /*2811*/][0 /*281*/].f_259 == 2)
					{
						if (Global_35443 == 15)
						{
							if (Global_98931.f_12665.f_82 == 0)
							{
								unk_0xB8BB626315D394F5(1);
								func_16("CELL_7050");
							...
							else
							{
								...
								unk_0xF3148AAF69AF9CBC(&Global_2265, 11);
								if (Global_98931.f_12665.f_83 == 0)
								{
									unk_0xB8BB626315D394F5(1);
									func_15("CELL_7051", -1);
									Global_98931.f_12665.f_83 = 1;
								}
							}
						}
					}
...
void func_26()
{
	if (Global_14372 == 0)
	{
		if (func_10(2, Global_14363, 0))
		{
			...
			iLocal_43 = unk_0x2D1F70CC7C051146(uLocal_40);
...
void func_27()
{
	...
	if (Global_69020)
	{
		...
		Var21 = { func_17(unk_0x1329891157A54C63()) };
		if (!unk_0x464883E45616A088(&Var21))
		{
	...
	while (iVar20 < 19)
	{
		...
		iVar0[iVar35] = 1;
		if (unk_0xD994929E13CC1ED5(&(Global_3069[Global_14394 /*2811*/][iLocal_42 /*281*/].f_7[Global_3069[Global_14394 /*2811*/][iLocal_42 /*281*/].f_259 /*4*/]), &(Global_3069[Global_14394 /*2811*/][iLocal_42 /*281*/].f_7[iVar35 /*4*/])))
		{
			iLocal_47 = iVar20;
			if (iLocal_47 < 0)
			{
...
void func_36()
{
	...
	{
		if (func_40(Global_98931.f_1750.f_539.f_3549) != unk_0x14B7103DBD149FFE(unk_0x81873881071CD9FE()))
		{
			iVar0 = func_39(unk_0x81873881071CD9FE());
			if (func_38(iVar0) && (!func_37(14) || Global_97883))
			{
