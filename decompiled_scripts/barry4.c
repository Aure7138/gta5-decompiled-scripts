...
void func_1()
{
	switch (iLocal_82)
	{
		...
		case 1:
			...
			func_215(&uLocal_145, 1, unk_0xFC1458A37D98B502(), "FRANKLIN", 0, 1);
	...
	if (Global_71110 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x3E9CABD07B829173())
			{
				...
				Var4 = { func_227(Global_71111, Global_71113, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
void func_242(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == 1)
	{
		if (!func_335(iParam6, iParam7, iParam8, iParam13))
		{
			iVar0 = 0;
		}
	}
		...
		else
		{
			...
			if (unk_0x9A0B2ED5055D3F0B(Var5.f_0))
			{
				...
				*iParam0 = unk_0xEA60F3B426BB095B(Var5.f_0, Param2, fParam5, 1, 1, 0);
				...
				func_298(iParam0, &(Var5.f_31), &(Var5.f_81));
				unk_0xC0E8D21B09ADD40A(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
int func_298(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_268(unk_0x82FF3DFBC3965CC0(*uParam0), 1) && unk_0xF928889F6E5C7677(*uParam0, 24) != func_301(*uParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xA9EF3F93CBFFF6D0(*uParam0, 24, func_301(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_300(uParam0);
	if (func_299(*uParam0))
	{
...
{
	return func_314(&(Global_98118.f_2875), Param0, fParam3, 0);
}

int func_314(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_316(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_318(iParam0, uVar1[iVar6], 1) && func_317(unk_0xB3328BA8976B416C(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_312(Param1, 0f, 0f, 0f, 0)) || unk_0xBE3C4023003180FC(unk_0xB3328BA8976B416C(iParam0, 1), unk_0xB3328BA8976B416C(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_360(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_366())
	{
		...
		{
			iVar33 = func_361(unk_0x436287B7DB306165());
			if (iVar33 > -1)
			{
