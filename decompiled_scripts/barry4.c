...
void func_1()
{
	switch (iLocal_82)
	{
		...
		case 1:
			...
			func_221(&uLocal_145, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
...
int func_309(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_279(unk_0x36FE6D3220816ADA(*uParam0), 1) && unk_0x7F8B14CBFB9813E5(*uParam0, 24) != func_312(*uParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x8DFB45E7317A7ED7(*uParam0, 24, func_312(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_311(uParam0);
	if (func_310(*uParam0))
	{
...
int func_327(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_329(iParam0, uVar1[iVar6], 1) && func_328(unk_0x3E4D3CCC220BDFB1(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_323(Param1, 0f, 0f, 0f, 0)) || unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(iParam0, 1), unk_0x3E4D3CCC220BDFB1(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_371(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_377())
	{
		...
		{
			iVar33 = func_372(unk_0x6C5C6B207AA78253());
			if (iVar33 > -1)
			{
