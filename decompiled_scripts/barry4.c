...
void func_1()
{
	switch (iLocal_82)
	{
		...
		case 1:
			...
			func_221(&uLocal_145, 1, unk_0x16F2683693E537C9(), "FRANKLIN", 0, 1);
...
int func_309(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_279(unk_0x134B62B726CEC8E6(*uParam0), 1) && unk_0x0ECB5CA5140957AD(*uParam0, 24) != func_312(*uParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xEE6A1776A67F70C1(*uParam0, 24, func_312(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_311(uParam0);
	if (func_310(*uParam0))
	{
...
int func_327(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_329(iParam0, uVar1[iVar6], 1) && func_328(unk_0x68F4C0EC296D3901(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_323(Param1, 0f, 0f, 0f, 0)) || unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(iParam0, 1), unk_0x68F4C0EC296D3901(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_371(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_377())
	{
		...
		{
			iVar33 = func_372(unk_0xBB0808A181D4745C());
			if (iVar33 > -1)
			{
