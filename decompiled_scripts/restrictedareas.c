					...
					else
					{
						if (iLocal_58)
						{
							...
							while (iLocal_68 < 8)
							{
								...
								{
									if (func_32(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 0), iLocal_68 + 1, 0, 0))
									{
						...
						if (unk_0x83666F9FB8FEBD4B() > 125)
						{
							...
							if (func_29(iLocal_37, unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 0)))
							{
								...
								if (func_28(iLocal_37))
								{
									...
									if (unk_0xAB964FCFAC3C767A(unk_0x6D9FF4C899CD785F(&Local_72)) == 0)
									{
								...
								else if (!Global_25398[iLocal_37])
								{
									if (unk_0x51D836BF46000450(unk_0xD5A676B97920D126()))
									{
										...
										if (!bLocal_56)
										{
											if (func_32(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 0), iLocal_37, 0, 0))
											{
												if ((unk_0x84A97C70FFDEC0C8() - iLocal_78[iLocal_70]) > 8000)
												{
													func_18();
												}
												else if (unk_0x4B16FF7207D89FDF(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 0) + Vector(200f, 200f, 200f), unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 0) - Vector(200f, 200f, 200f), 1))
												{
													func_18();
												}
												else if (iLocal_37 != 4)
											...
											{
												iLocal_78[iLocal_70] = unk_0x84A97C70FFDEC0C8();
											}
										}
									}
									else
									{
										...
										if (!bLocal_56)
										{
											if (func_32(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 0), iLocal_37, 0, 0))
											{
												if (!iLocal_37 == 4 || (unk_0x84A97C70FFDEC0C8() - iLocal_78[iLocal_70]) > 8000)
												{
													func_18();
												}
											}
...
void func_18()
{
	switch (iLocal_70)
	{
		case 0:
			iLocal_71 = 2;
			if (unk_0xAA5B10AEB58EAA13(unk_0xFB6B3EEFAB2DD12C()) < iLocal_71)
			{
			}
			break;
		
		case 1:
			if (unk_0x51D836BF46000450(unk_0xD5A676B97920D126()) && unk_0x4B16FF7207D89FDF(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 0) + Vector(200f, 200f, 200f), unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 0) - Vector(200f, 200f, 200f), 1))
			{
				iLocal_71 = 5;
			}
			else
	...
	if (unk_0xAA5B10AEB58EAA13(unk_0xFB6B3EEFAB2DD12C()) < iLocal_71)
	{
		unk_0xD333A6376EE57D56(unk_0xFB6B3EEFAB2DD12C(), iLocal_71, 0);
...
int func_23()
{
	...
	if (unk_0x6A0583ECFCCECC9B(unk_0xD5A676B97920D126(), 0))
	{
		...
		{
			if ((unk_0xA214826AC4BEA074(unk_0xA0A4DA31DEDFAC4F(uVar0)) || unk_0xA0A4DA31DEDFAC4F(uVar0) == joaat("caddy")) || unk_0xA0A4DA31DEDFAC4F(uVar0) == joaat("caddy2"))
			{
				return 1;
			}
			else
