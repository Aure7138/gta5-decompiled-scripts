...
int func_1()
{
	...
	{
		func_45();
		if (func_44(unk_0x9F92518438215DD0()))
		{
			func_43(unk_0x9F92518438215DD0(), -347.4067f, -93.5801f, 44.6639f, 306.0178f);
		}
...
void func_39(int iParam0)
{
	...
	while (iVar15 < Global_97358.f_5944.f_198)
	{
		...
		{
			func_40(Global_97358.f_5944.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
void func_45()
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				uLocal_63[iVar1] = unk_0xA7DA1E6D4C99864B(joaat("prop_paints_can02"), -335.66f, -95.24f, 46.16f, 1, 1, 0);
				unk_0x18487241EBD142A4(uLocal_63[iVar1], -335.66f, -95.24f, 46.16f, 0, 0, 1);
				unk_0x8F856D0103CF1B91(uLocal_63[iVar1], -2.32f, 0.66f, -0.8f, 2, 1);
				break;
			
			case 2:
				uLocal_63[iVar1] = unk_0xA7DA1E6D4C99864B(joaat("prop_paint_brush05"), -336.04f, -94.9f, 46.02f, 1, 1, 0);
				unk_0x18487241EBD142A4(uLocal_63[iVar1], -336.04f, -94.9f, 46.02f, 0, 0, 1);
				unk_0x8F856D0103CF1B91(uLocal_63[iVar1], 0.01f, 3.85f, 2.72f, 2, 1);
				break;
			
			case 3:
				uLocal_63[iVar1] = unk_0xA7DA1E6D4C99864B(joaat("prop_paint_spray01b"), -336.34f, -95.66f, 46.02f, 1, 1, 0);
				unk_0x18487241EBD142A4(uLocal_63[iVar1], -336.34f, -95.66f, 46.02f, 0, 0, 1);
				unk_0x8F856D0103CF1B91(uLocal_63[iVar1], -2.86f, 0.76f, 28.89f, 2, 1);
				break;
		}
		iVar0++;
	}
...
int func_49()
{
	...
	else if (iLocal_47 == 1)
	{
		if (func_44(unk_0x9F92518438215DD0()))
		{
			func_43(unk_0x9F92518438215DD0(), -366.6139f, -79.7531f, 44.6616f, 230.7299f);
		}
		unk_0x5EF916489F3787FC(0);
		unk_0x203B2685C1715644(0, 1065353216);
		unk_0xF391B7BD1F131C3F(250);
	...
	else if (iLocal_47 == 2)
	{
		...
		{
			if (unk_0x8CFF6B55E671AD64(iLocal_49, 1))
			{
				func_144();
			}
		}
		...
		switch (iLocal_48)
		{
			...
			case 1:
				if (func_50())
				{
					...
					{
						if (unk_0x59136FBEF21C89D9(1106247680, 31086, 1061997773, 1060320051, 1048576000, 1090519040, 1051361018, 31086, 24818) == iLocal_49)
						{
							iLocal_82 = unk_0x17103F66FBB44C3C() + 2000;
							iLocal_48++;
						}
					}
				}
			...
			case 2:
				if (iLocal_82 < unk_0x17103F66FBB44C3C())
				{
					iLocal_55 = 1;
					iLocal_48++;
				}
...
int func_51()
{
	...
	{
		unk_0x3BC6D217451D6BB7(joaat("u_m_m_streetart_01"));
		if (unk_0x149162179DBAEDB0(joaat("u_m_m_streetart_01")))
		{
			iLocal_49 = unk_0xA00B5D954AD320BF(26, joaat("u_m_m_streetart_01"), Local_50, fLocal_53, 1, 1);
			unk_0x0880E86251A44B7F(joaat("u_m_m_streetart_01"));
			uLocal_63[0] = unk_0xA7DA1E6D4C99864B(joaat("prop_cs_spray_can"), Local_68, 1, 1, 0);
			unk_0x80BA810554025DFF(uLocal_63[0], iLocal_49, unk_0xB8BF0926F5E41F7D(iLocal_49, 28422), 0f, -0.01f, -0.02f, Local_77, 1, 1, 0, 0, 2, 1);
			unk_0xE8105B7E3908547D(iLocal_49, 1);
			unk_0x9001FCB58244C11D(iLocal_49, 42, 1);
			uLocal_56 = func_62(iLocal_49, 0, 145);
			func_52(1);
			unk_0xA50AD6983D49A772(iLocal_49, joaat("player"));
			unk_0x5E66F70CFC4EF61D(iLocal_49, 2.5f);
		}
	}
	return 0;
}
...
int func_56()
{
	switch (func_57(&Global_24503, 0, 5, 0, unk_0x81ACA1EEF1E4410D()))
	{
		case 1:
			return 1;
			break;
...
int func_63(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xD4916ED85412C8D9(uVar0, func_64(unk_0x4B69FB3A5B09A1BA(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xD4916ED85412C8D9(uVar0, func_64(unk_0x4B69FB3A5B09A1BA(), 0.7f, 0.7f));
		unk_0xFEE42298F5E238BE(uVar0, bParam1);
	}
...
{
	func_66();
	if (!unk_0xB819D1DD7DA58F08() && iLocal_54 < 3)
	{
		func_144();
	}
}
...
void func_66()
{
	...
	if (func_44(iLocal_49))
	{
		...
		bVar1 = func_44(unk_0x9F92518438215DD0());
		Var2 = { unk_0x77009B1C011405A9(iLocal_49, 0) };
		fVar8 = 7.5f;
		Var9 = { fVar8, fVar8, fVar8 };
		if (bVar1)
		{
			Var5 = { unk_0x77009B1C011405A9(unk_0x9F92518438215DD0(), 0) };
			bVar12 = unk_0x827151D7B70CB853(unk_0x9F92518438215DD0(), 0);
			bVar13 = unk_0x8524DF00FC9C3785(unk_0x9F92518438215DD0());
		}
		if (iLocal_54 < 3)
		{
			if (unk_0xD18D82BE9A1A5E43(Var2, fVar8, 0) || unk_0xFDD233BBDD8E0FFE(Var2 - Var9, Var2 + Var9, 0))
			{
				iLocal_54 = 3;
			}
		}
		...
		{
			case 0:
				unk_0xDA293E5084610B09(sLocal_73);
				if (unk_0x3DA2EED4204CE591(sLocal_73))
				{
					unk_0x4A1AC49BA4A747F7(iLocal_49, 1);
					unk_0x7CF15DD8B3815A0D(iLocal_49, sLocal_73, sLocal_74, 1000f, -8f, -1, 8193, 0, 0, 0, 0);
					iLocal_54++;
				}
				break;
			...
			case 1:
				...
				if (func_76(unk_0x9F92518438215DD0(), iLocal_49, 35f))
				{
					unk_0xF87DA7F5BA8C7D0F(&uLocal_81);
					unk_0x7CF15DD8B3815A0D(0, sLocal_73, sLocal_75, 8f, -8f, -1, 8192, 0, 0, 0, 0);
					unk_0x7CF15DD8B3815A0D(0, sLocal_73, sLocal_76, 8f, -2f, -1, 8193, 0, 0, 0, 0);
					unk_0x3179CCC77CBAB31F(uLocal_81);
					unk_0xC7EBE3C9AC83FAAA(iLocal_49, uLocal_81);
					unk_0xCD02E3C29B8253A6(&uLocal_81);
					unk_0xE29F0AC6C728DD9C(sLocal_73);
					iLocal_54++;
				}
				break;
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_76(unk_0x9F92518438215DD0(), iLocal_49, fVar14))
				{
					iLocal_54 = 3;
				}
				if (iLocal_55)
			...
			case 4:
				unk_0xA334EDA2335A13CA(iLocal_49, 8, 1);
				unk_0xA334EDA2335A13CA(iLocal_49, 32, 1);
				unk_0xF87DA7F5BA8C7D0F(&uLocal_81);
				unk_0x23F243BF5B07DA90(0, unk_0x9F92518438215DD0(), 800);
				unk_0x722E6B3A5162A6BB(0, unk_0x9F92518438215DD0(), 9999f, -1, 1, 0);
				unk_0x3179CCC77CBAB31F(uLocal_81);
				unk_0xC7EBE3C9AC83FAAA(iLocal_49, uLocal_81);
				unk_0xCD02E3C29B8253A6(&uLocal_81);
				iLocal_54++;
			...
			case 5:
				...
				if (!unk_0x0FF9FE2CB115CFB9(iLocal_49) && unk_0xB7A628320EFF8E47(Var2, unk_0x77009B1C011405A9(unk_0x9F92518438215DD0(), 0)) > 2500f)
				{
					uLocal_80 = unk_0xA14FCCC1B46CB913(Var5, Var2, 1, 0, 7);
					iLocal_54++;
				}
				break;
			...
			case 6:
				...
				iVar23 = unk_0xD200D7E3AEDD340D(uLocal_80, &iVar15, &uVar16, &uVar19, &uVar22);
				if (iVar23 == 2)
				{
					if (iVar15 == 1)
					{
			...
			case 7:
				unk_0x7763EDCBED8A5840(&iLocal_49);
				break;
		}
	}
	else if (unk_0x746960881FB19A89(iLocal_49))
	{
		unk_0xD9B13F0A69759C12(iLocal_49, 0);
	}
}
...
int func_67()
{
	...
	{
		case 0:
			if (unk_0x3C17D9ED0E5F3FCA(iLocal_49, sLocal_73, sLocal_76, 3))
			{
				fLocal_57 = 0.349f;
				iLocal_58 = 900;
				Local_60 = { Var0 };
			...
			else if (unk_0x3C17D9ED0E5F3FCA(iLocal_49, sLocal_73, sLocal_75, 3))
			{
				fLocal_57 = unk_0xD17241758B91AAED(iLocal_49, sLocal_73, sLocal_75);
				...
				if (fLocal_57 != 0.2f)
				{
					...
					Local_60 = { unk_0x77009B1C011405A9(iLocal_49, 0) - Vector(1f, 0f, 0f) };
					iLocal_59 = 1;
				}
				else
				{
		...
		case 1:
			unk_0xD9B13F0A69759C12(iLocal_49, 1);
			unk_0x7CF15DD8B3815A0D(iLocal_49, sLocal_73, sLocal_75, 4f, -8f, -1, 0, fLocal_57, 1, 0, 0);
			iLocal_82 = unk_0x17103F66FBB44C3C();
			func_70(&uLocal_56);
			func_69();
			if (unk_0x746960881FB19A89(uLocal_63[0]))
			{
				unk_0x8ED1C81168F4A10C(uLocal_63[0], 1, 1);
			}
			iLocal_59++;
			break;
		
		case 2:
			if (unk_0x3C17D9ED0E5F3FCA(iLocal_49, sLocal_73, sLocal_75, 3))
			{
				iVar7 = (unk_0x17103F66FBB44C3C() - iLocal_82);
				...
				unk_0x4A0F05AE369A5C44(iLocal_49, sLocal_73, sLocal_75, fVar9);
				fVar10 = (fVar8 - 0.12f);
				fVar10 = func_71(fVar10, 0f, 0.8f);
				Var11 = { func_68(Local_60, Var3, fVar10) };
				unk_0xFA51DC22F6E34F6E(iLocal_49, Var11, 0, 1, 0, 1);
				if (fVar9 == 0.161f)
				{
					unk_0xD9B13F0A69759C12(iLocal_49, 0);
					return 1;
...
void func_69()
{
	if (iLocal_71 != 0)
	{
		unk_0xF79214064B997EEA(iLocal_71, 0);
		iLocal_71 = 0;
	}
}
...
void func_72()
{
	...
	if (unk_0x3C17D9ED0E5F3FCA(iLocal_49, sLocal_73, sLocal_75, 3))
	{
		fVar0 = unk_0xD17241758B91AAED(iLocal_49, sLocal_73, sLocal_75);
		if (fVar0 < 0.383793f)
		{
			func_69();
		}
	...
	else if (unk_0x3C17D9ED0E5F3FCA(iLocal_49, sLocal_73, sLocal_76, 3))
	{
		fVar0 = unk_0xD17241758B91AAED(iLocal_49, sLocal_73, sLocal_76);
		if (fVar0 < 0.1124f)
		{
			func_69();
		}
...
void func_73()
{
	if (iLocal_71 == 0)
	{
		iLocal_71 = unk_0x14B5563C7C3321EA(sLocal_72, uLocal_63[0], Local_77, Local_77, 1065353216, 0, 0, 0);
		unk_0x58A68987E37E712E(iLocal_71, 1f, 1f, 1f, 0);
		unk_0x9F325048FA3B62AD(iLocal_71, 0.2f);
	}
}
...
bool func_75()
{
	return (unk_0xFE0FA79BC49EBB07(unk_0x9F92518438215DD0(), -334.4651f, -93.42171f, 48.57328f, -332.2641f, -82.78552f, 45.8103f, 3f, 0, 1, 0) && !unk_0xFE0FA79BC49EBB07(unk_0x9F92518438215DD0(), -329.1134f, -83.87273f, 45.79989f, -331.0937f, -88.05348f, 48.71878f, 3f, 0, 1, 0));
}
...
int func_76(int iParam0, int iParam1, float fParam2)
{
	...
	if (unk_0x746960881FB19A89(uParam0) && unk_0x746960881FB19A89(uParam1))
	{
		fVar0 = (fParam2 * fParam2);
		return unk_0xB7A628320EFF8E47(unk_0x77009B1C011405A9(iParam0, 0), unk_0x77009B1C011405A9(iParam1, 0)) <= fVar0;
	}
	return 0;
}
...
int func_77(int iParam0)
{
	...
	{
		func_70(&uLocal_56);
		unk_0x722E6B3A5162A6BB(iLocal_49, unk_0x9F92518438215DD0(), 9999f, -1, 1, 0);
		return 1;
	}
	return 0;
}
...
int func_89(struct<3> Param0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		if (unk_0x378E80A2B7D7C8DF(unk_0xCFC72E446B0B3AD7()) && !unk_0x3E0478C40AB5B38D(unk_0x9F92518438215DD0()))
		{
			...
			if (unk_0xA8CEACB4F35AE058(unk_0xAEA1379E6840A7DA(unk_0x9F92518438215DD0())) > 1369f && !func_143())
			{
				return 0;
			}
		}
		...
		if (!func_127(Global_97358.f_28192.f_43[iParam3]))
		{
			return 0;
		}
		...
		if (unk_0x746960881FB19A89(unk_0x9F92518438215DD0()))
		{
			if (!unk_0x3E0478C40AB5B38D(unk_0x9F92518438215DD0()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0x6BD7C167138FCD4C(unk_0xCFC72E446B0B3AD7(), 1) || func_124()) || Global_24446) || func_123()) || func_122(8, -1)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_97358.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x6C08E4B26051504F(unk_0xCFC72E446B0B3AD7()) || unk_0xFAF3D214E00907D8(unk_0x9F92518438215DD0())) || unk_0x11CF47CA7B00BE4F(unk_0x9F92518438215DD0())) || unk_0xBD280C076BC69C97(unk_0x9F92518438215DD0())) || unk_0x6B6534ADCC502CF1(unk_0x9F92518438215DD0())) || unk_0x6BD7C167138FCD4C(unk_0xCFC72E446B0B3AD7(), 1)) || unk_0x29F9C49274370985(unk_0xCFC72E446B0B3AD7())) || unk_0x5D1AEC61B1517F38(unk_0x9F92518438215DD0(), 0)) || func_124()) || Global_96405) || Global_24446) || func_123()) || func_122(8, -1)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_97358.f_5944.f_919[iVar0] == 5) || Global_35460 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_124() || unk_0xD092BBE40A1C72AA(unk_0xCFC72E446B0B3AD7()) > 0) || func_122(8, -1)) || func_118()) || func_117()) || Global_97358.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_145(int iParam0)
{
	...
	if (func_156())
	{
		...
		func_148(30000);
		StringCopy(&cVar0, func_147(Global_97347, 1), 64);
