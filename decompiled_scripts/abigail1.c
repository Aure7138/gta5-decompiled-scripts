...
void func_1()
{
	switch (iLocal_153)
	{
		case 0:
			...
			{
				if (unk_0xB4ECF989E2C1DAC8(iLocal_149, "rcmabigail", "loop_talk", 3) || unk_0xB4ECF989E2C1DAC8(iLocal_149, "rcmabigail", "loop_look", 3))
				{
					unk_0xC6EB89C59F2AF6B8(iLocal_149, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0, 0, 0, 0);
		...
		case 1:
			func_299();
			if ((func_303(iLocal_149) && unk_0xB4ECF989E2C1DAC8(iLocal_149, "rcmabigail", "loop_2_cs", 3)) && unk_0x8CA9406E01C7EE58(iLocal_149, "rcmabigail", "loop_2_cs") > 0.99f)
			{
				iLocal_153++;
			}
			break;
		...
		case 2:
			...
			if (func_290(1, 1093140480, 0))
			{
				if (func_303(iLocal_149))
				{
					unk_0x29E8331978B73E7F(iLocal_149, "ABIGAIL", 0, 0, 0);
				}
				func_289();
		...
		case 4:
			if (unk_0x22A8E52414415B76())
			{
				...
				{
					uLocal_150 = unk_0x0D032838710EE57D("DEFAULT_SCRIPTED_CAMERA", 1);
					unk_0x86F44313DFA8F00C(uLocal_150, -1606.249f, 5273.964f, 5.199186f, -1.633685f, 0f, -175.2748f, 30.16609f, 0, 1, 1, 2);
					unk_0x86F44313DFA8F00C(uLocal_150, -1605.681f, 5274.014f, 3.870102f, -2.089875f, 0f, -178.064f, 30.16609f, 10000, 1, 1, 2);
					unk_0xB3A1B75CB59FEB56(1, 0, 3000, 1, 0, 0);
					unk_0x91F5B0244AAE6222(uLocal_150, "HAND_SHAKE", 0.3f);
				}
				...
				if (func_303(iLocal_149) && unk_0x3148AE92ED70DC30("Abigail", 0))
				{
					unk_0xA3BF0AA5A2608191(iLocal_149);
					unk_0x96167B03C5A77156(iLocal_149, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 1048576000, 0, 1193033728);
				}
			}
			else
			{
				iLocal_152 = unk_0x1C0640BA9A7327B3() + 10000;
				iLocal_153++;
			}
			break;
		
		case 5:
			if ((iLocal_155 == 0 && unk_0x6C3F127AAF415E69() == 4) && unk_0x1C0640BA9A7327B3() > (iLocal_152 - 300))
			{
			...
			if (func_224(1000) || unk_0x1C0640BA9A7327B3() > iLocal_152)
			{
	...
	if (unk_0xC844350D5D58C99A(Global_102203.f_4))
	{
		if (unk_0xDF1306B443CD3D15(Global_102203.f_4, 0))
		{
			if (func_281(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_278(unk_0x68F4C0EC296D3901(Global_102203.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_260(unk_0xEAE0D21A50E6C7F4(iParam0, 31), -1, 1)) + 2011;
}
...
void func_299()
{
	if (func_303(unk_0x16F2683693E537C9()))
	{
		...
		if (iLocal_154 == 0)
		{
			if (func_303(iLocal_149))
			{
				if (func_300(unk_0x16F2683693E537C9(), iLocal_149, 1) < 4f || (unk_0x9C66D99E63E8E24C(unk_0x16F2683693E537C9()) > 2f && func_300(unk_0x16F2683693E537C9(), iLocal_149, 1) < 6f))
				{
...
int func_345(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_351())
	{
		...
		{
			iVar33 = func_346(unk_0xBB0808A181D4745C());
			if (iVar33 > -1)
			{
