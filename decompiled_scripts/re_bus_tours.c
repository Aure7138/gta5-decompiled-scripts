...
void func_30()
{
	...
	if (unk_0x0E8572B08CEB6A11(uLocal_328))
	{
		...
		func_32();
		iVar10 = unk_0xF34EE736CF047844((unk_0x98501142AE80A99C(2, 218) * 127f));
		iVar11 = unk_0xF34EE736CF047844((unk_0x98501142AE80A99C(2, 219) * 127f));
		iVar12 = unk_0xF34EE736CF047844((unk_0x98501142AE80A99C(2, 220) * 127f));
		iVar13 = unk_0xF34EE736CF047844((unk_0x98501142AE80A99C(2, 221) * 127f));
		...
		unk_0x612434A5544F5847(uLocal_328, unk_0x7D2B9E6A64637269(), Var7.f_0, (Var7.f_1 - 1f), (Var7.f_2 + 1f), 1);
	}
	else
	{
...
void func_31(int iParam0, var uParam1, struct<3> Param2)
{
	...
	if (!unk_0xECEC7528A52B4EE8(uParam0))
	{
		if (unk_0x0E8572B08CEB6A11(*uParam1))
		{
			...
			Var1.f_2 = uVar0;
			Var1 = { Var1 + Param2 };
			unk_0xBD833AA6EB59C81B(*uParam1, Var1.f_0, Var1.f_1, Var1.f_2, 2);
		}
	}
}
...
void func_36(struct<3> Param0, float fParam3)
{
	...
	if (unk_0xBFCE58B2B3249999(iLocal_306, 0))
	{
		unk_0xB7D390F8F682127B(Param0.f_0, Param0.f_1, Param0.f_2, 5f, 0, 0, 0, 0, 0, 0);
		unk_0x78CDDD1E6367978D(iLocal_306, Param0.f_0, Param0.f_1, Param0.f_2, 1, 0, 0, 1);
		...
		switch (iLocal_50)
		{
			...
			case 1:
				...
				if (unk_0xBFCE58B2B3249999(iLocal_306, 0))
				{
					...
					if (unk_0xA1CB00B61C47B900(Local_320.f_0, Local_320.f_1, Local_323.f_0, Local_323.f_1))
					{
...
void func_57()
{
	...
	{
		func_59(13, unk_0xF34EE736CF047844(Global_112293.f_10192.f_3853));
	}
...
int func_144()
{
	...
	if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
	{
		if (unk_0xA8CEACB4F35AE058(unk_0x9F2928DF31D785C7(unk_0x7D2B9E6A64637269())) > 1369f && !func_151())
		{
			return 0;
		}
	}
...
void func_184()
{
	if (iLocal_318)
	{
		unk_0xABAA7F8FD10DCDF2(Local_320.f_0, Local_320.f_1, Local_323.f_0, Local_323.f_1);
	}
}
...
void func_187()
{
	...
	unk_0x78B2DF314748056B(1, uLocal_309, joaat("player"));
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_211(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
