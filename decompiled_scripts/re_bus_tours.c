...
void func_32()
{
	...
	{
		if (unk_0x174CED88B97C78D9(uLocal_287[2], -880529684) == 7)
		{
...
void func_57()
{
	...
	{
		func_59(13, unk_0xF34EE736CF047844(Global_112915.f_10194.f_3853));
	}
			...
			if ((unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_306, 5f, 5f, 5f, 0, 1, 0) && !unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0)) && !func_124("TX_H02"))
			{
				if (func_155())
				{
					...
					if (!unk_0x12DD4A0B247D9B4D(uLocal_310))
					{
						...
						unk_0x293A9399E902A33B(uLocal_310, Global_31552);
						if (!unk_0xF68107C40359970C(iLocal_286))
						{
...
{
	if (func_172(uParam0, &uLocal_337, &uLocal_334, iLocal_332, bLocal_338, 1077936128, 0) || unk_0x32DCDA1B2F8A0694(uParam0))
	{
		func_167(uParam0);
		return 1;
	}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_209(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
