...
void __EntryFunction__()
{
	...
	while (iVar0 != 7)
	{
		...
		unk_0xE10447427D928F55("RE_GI", 0);
		switch (iVar0)
		{
			case 0:
				if (func_95())
			...
			case 4:
				iVar23 = 0;
				unk_0x8668A841B325FF16(Local_243 - Vector(10f, 30f, 30f), Local_243 + Vector(10f, 30f, 30f), 0, 1, 1, 1);
				unk_0xA30D54731C0AAECF(Local_243 - Vector(50f, 50f, 50f), Local_243 + Vector(100f, 100f, 100f));
				unk_0xBDF0A810DD6A47D3(Local_243 - Vector(15f, 15f, 15f), Local_243 + Vector(15f, 15f, 15f), 0, 1);
				unk_0x9956FB0E4B50ECB8(&iVar8, 4);
				unk_0x9956FB0E4B50ECB8(&iVar8, 1);
				unk_0x9956FB0E4B50ECB8(&iVar8, 5);
				unk_0x103FCC2BD24292A3("GangOne", &uLocal_49);
				unk_0xA9CA101B50B90993(5, uLocal_49, joaat("player"));
				iVar22 = unk_0xA7F4088D9A2629CC(12, Var1.f_4, Var14, fVar17, 1, 1);
				unk_0x9BEE7E791BC4D38B(iVar22, 1);
				unk_0x839E9476E54502A2(Var1.f_4);
				unk_0x690C5239500171FE(iVar22, uLocal_49);
				unk_0x321C1AA209172C00(iVar22, 0);
				unk_0x497AFDFE79EEFE4F(iVar22, 2, 0, 0, 0);
				unk_0x497AFDFE79EEFE4F(iVar22, 0, 0, 0, 0);
				unk_0x497AFDFE79EEFE4F(iVar22, 3, 2, 0, 0);
				unk_0x497AFDFE79EEFE4F(iVar22, 4, 0, 0, 0);
				unk_0x497AFDFE79EEFE4F(iVar22, 8, 1, 1, 0);
				unk_0x0814FB03E16A03C1(iVar22, "G_F_Y_Vagos_01_LATINO_MINI_02");
				if (func_82() == 0)
				{
					func_81(&uLocal_55, 0, unk_0xE7869D5D7816A9B6(), "MICHAEL", 0, 1);
				}
				else if (func_82() == 1)
				{
					func_81(&uLocal_55, 0, unk_0xE7869D5D7816A9B6(), "FRANKLIN", 0, 1);
				}
				else if (func_82() == 2)
				{
					func_81(&uLocal_55, 0, unk_0xE7869D5D7816A9B6(), "TREVOR", 0, 1);
				}
				func_81(&uLocal_55, 3, iVar22, "REGIFemale", 0, 1);
				func_81(&uLocal_55, 4, iVar18[2], "REGIMale", 0, 1);
				unk_0xDCF460AE46C9489C(iVar22, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 49, 0, 0, 0, 0);
				if (!unk_0xD11595488376CB53(uLocal_224))
				{
				}
				iVar24 = 0;
				while (iVar24 <= (iLocal_51 - 1))
				{
					if (!unk_0xD51CFE69539DB6D8(iVar18[iVar24]))
					{
						iVar18[iVar24] = unk_0xA7F4088D9A2629CC(12, Var1[iVar24], Local_229[iVar24 /*3*/], fLocal_239[iVar24], 1, 1);
						unk_0x9BEE7E791BC4D38B(iVar18[iVar24], 1);
						unk_0x839E9476E54502A2(Var1[iVar24]);
						unk_0x690C5239500171FE(iVar18[iVar24], uLocal_49);
						unk_0x1C26C4B0DAB91B21(iVar18[iVar24], 42, 1);
						unk_0xCC897563F1971D6A(iVar18[iVar24], func_80(), -1, 1, 1);
						unk_0x79EE909282B7E387(iVar18[iVar24], 2);
						unk_0x45AC72BF50E50EFE(iVar18[iVar24], 0);
						unk_0xB161EBD04DDDE4AD(iVar18[iVar24], 13);
						unk_0x82F10D839CF95C09(iVar18[iVar24], unk_0x0ADD324BC46177EF(200, 500));
					}
					iVar24++;
				}
				unk_0xCC897563F1971D6A(iVar18[0], joaat("weapon_sawnoffshotgun"), 40, 1, 1);
				uLocal_52 = unk_0xB839A1C489B63ACC(1283.205f, -1622.71f, 54.299f, 0f, 0f, 103.68f, 2);
				if (!unk_0xAF437D7C802AB246(iVar18[0]))
				{
					unk_0x360F0D01112F8AD0(iVar18[0], uLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!unk_0xAF437D7C802AB246(iVar18[1]))
				{
					unk_0x360F0D01112F8AD0(iVar18[1], uLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_c", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!unk_0xAF437D7C802AB246(iVar18[2]))
				{
					unk_0x360F0D01112F8AD0(iVar18[2], uLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
				}
				unk_0x3A7DEF86891D2891(uLocal_52, 1);
				iLocal_249 = 1;
				iVar0 = 5;
				break;
			...
			case 5:
				...
				if (iVar7 < 3)
				{
					if ((((((((func_73(&iVar18, &uVar11, &uVar10, &uVar9, iVar8, bVar12, 1075838976, 0) || func_72(iVar18[0], 0)) || func_72(iVar18[1], 0)) || func_72(iVar18[2], 0)) || unk_0x742CA22C114D89E4(Local_229[0 /*3*/], 40f, 1)) || unk_0xE31E0B1502061553(Local_229[0 /*3*/] - Vector(25f, 25f, 25f), Local_229[0 /*3*/] + Vector(25f, 25f, 25f), joaat("weapon_smokegrenade"), 1)) || unk_0xE31E0B1502061553(Local_229[0 /*3*/] - Vector(25f, 25f, 25f), Local_229[0 /*3*/] + Vector(25f, 25f, 25f), joaat("weapon_grenade"), 1)) || unk_0xE31E0B1502061553(Local_229[0 /*3*/] - Vector(25f, 25f, 25f), Local_229[0 /*3*/] + Vector(25f, 25f, 25f), joaat("weapon_grenadelauncher"), 1)) || unk_0xE31E0B1502061553(Local_229[0 /*3*/] - Vector(25f, 25f, 25f), Local_229[0 /*3*/] + Vector(25f, 25f, 25f), joaat("weapon_stickybomb"), 1))
					{
						iVar25 = 0;
						while (iVar25 < iVar18)
						{
							if (!unk_0xAF437D7C802AB246(iVar18[iVar25]))
							{
								func_70();
								if (!unk_0xAF437D7C802AB246(iVar18[iVar25]))
								{
									unk_0xFA2C5C2D054C888E(iVar18[iVar25]);
									unk_0x94026C1D1DB14225(&iLocal_50);
									unk_0x6A8BCE61F660B8D0(0, unk_0xE7869D5D7816A9B6(), 1000, 2048, 2);
									unk_0x4B79E06845D63B96(0, unk_0xE7869D5D7816A9B6(), 200f, -1, 0, 0);
									unk_0x911ECBCE73F8EC3F(iLocal_50);
									unk_0xC2C4A3A9FF2FBFFF(iVar18[iVar25], iLocal_50);
									unk_0x33A90AD8FA327B72(&iLocal_50);
									unk_0x8D6671D78D1F569B(iVar18[iVar25], 1);
								}
							}
							iVar25++;
						}
						if (!unk_0xAF437D7C802AB246(iVar22))
						{
							if (!unk_0xAF437D7C802AB246(iVar22))
							{
								unk_0xFA2C5C2D054C888E(iVar22);
								unk_0x94026C1D1DB14225(&iLocal_50);
								unk_0x6A8BCE61F660B8D0(0, unk_0xE7869D5D7816A9B6(), 1000, 2048, 2);
								unk_0x4B79E06845D63B96(0, unk_0xE7869D5D7816A9B6(), 200f, -1, 0, 0);
								unk_0x911ECBCE73F8EC3F(iLocal_50);
								unk_0xC2C4A3A9FF2FBFFF(iVar22, iLocal_50);
								unk_0x33A90AD8FA327B72(&iLocal_50);
								unk_0x8D6671D78D1F569B(iVar22, 1);
							}
						}
						iLocal_248 = 1;
					}
				...
				else
				{
					...
					while (iVar26 < iVar18)
					{
						if (!unk_0xAF437D7C802AB246(iVar18[iVar26]))
						{
							if (unk_0x915685CA559C211B(iVar18[iVar26], unk_0xE7869D5D7816A9B6(), 1))
							{
								func_70();
								iVar7 = 6;
							}
...
int func_1(int iParam0, struct<6> Param1, int iParam7, int iParam8, int iParam9, int iParam10)
{
	...
	if (*iParam0 >= 3)
	{
		if (!unk_0x47B2F09FC779F5CD(uLocal_53))
		{
			if ((!unk_0x3761EA7F8628B81A(unk_0xE7869D5D7816A9B6(), Local_257, 9f, 9f, 9f, 0, 1, 0) && !unk_0x3761EA7F8628B81A(unk_0xE7869D5D7816A9B6(), 1276.21f, -1613.05f, 53f, 9f, 9f, 9f, 0, 1, 0)) || unk_0x32CB82F773482629(unk_0xE7869D5D7816A9B6()))
			{
				*iParam0 = 6;
			}
		}
	...
	switch (*iParam0)
	{
		case 0:
			if (func_54(iParam7, iParam8))
			{
				...
				if (!unk_0xAF437D7C802AB246(iParam7))
				{
					unk_0xC31A3F1982C7B12B(iParam7, 247, 1);
					if (!func_72(iParam7, 0))
					{
						if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iParam7, 15f, 15f, 15f, 0, 1, 0))
						{
							if ((unk_0x72957E5DA83E879F(unk_0xE7869D5D7816A9B6(), 6) && unk_0x7F895384D1330018(iParam7, unk_0xE7869D5D7816A9B6())) && !unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
							{
								if ((unk_0x72957E5DA83E879F(unk_0xE7869D5D7816A9B6(), 6) || unk_0xBC273BCD46110BE6(unk_0x3F80C6638E3A1A90(), iParam7)) || unk_0x386C3192F791D414(unk_0x3F80C6638E3A1A90(), iParam7))
								{
									unk_0xAA6742AEFA0B2BC4(iParam7);
									unk_0x6A8BCE61F660B8D0(iParam7, unk_0xE7869D5D7816A9B6(), 5000, 1024, 2);
									func_70();
									...
									while (iVar0 < *iParam8)
									{
										if (!unk_0xAF437D7C802AB246((*iParam8)[iVar0]))
										{
											unk_0xAA6742AEFA0B2BC4((*iParam8)[iVar0]);
											unk_0x4B79E06845D63B96((*iParam8)[iVar0], unk_0xE7869D5D7816A9B6(), 200f, -1, 0, 0);
											unk_0x8D6671D78D1F569B((*iParam8)[iVar0], 1);
										}
										iVar0++;
									}
									if (!unk_0xAF437D7C802AB246(iParam7))
									{
										unk_0x4B79E06845D63B96(iParam7, unk_0xE7869D5D7816A9B6(), 200f, -1, 0, 0);
										unk_0x8D6671D78D1F569B(iParam7, 1);
									}
									iLocal_248 = 1;
								}
							}
					...
					else
					{
						...
						if (!unk_0xAF437D7C802AB246(iParam7))
						{
							unk_0xFA2C5C2D054C888E(iParam7);
							unk_0x4B79E06845D63B96(iParam7, unk_0xE7869D5D7816A9B6(), 200f, -1, 0, 0);
							unk_0x8D6671D78D1F569B(iParam7, 1);
						}
						iLocal_248 = 1;
				...
				if ((unk_0xAF437D7C802AB246((*iParam8)[0]) || unk_0xAF437D7C802AB246((*iParam8)[1])) || unk_0xAF437D7C802AB246((*iParam8)[2]))
				{
				...
				else if (unk_0x8E2CF6ACCED3BD0F(iParam7))
				{
					if (unk_0x23417CDB252083F9(iParam7, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", 3))
					{
						unk_0x91BC1C1D86377CB9(iParam7, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", -1056964608);
					}
				}
			}
			else
		...
		case 2:
			unk_0x25464EB6EAD8ED1B(unk_0x1141852D07400777(unk_0xE7869D5D7816A9B6(), 1), Local_243, 0, 0, 255, 255);
			unk_0x82606438816C878C(unk_0xE7869D5D7816A9B6(), 1000);
			Local_257 = { unk_0x1141852D07400777(unk_0xE7869D5D7816A9B6(), 1) };
			if (!unk_0xAF437D7C802AB246((*iParam8)[1]))
			{
				if (!unk_0xD11595488376CB53(uLocal_220[1]))
				{
				}
				unk_0xE72D045151F6CA70("RE28_OS");
				uLocal_53 = unk_0xB839A1C489B63ACC(1283.205f, -1622.71f, 54.299f, 0f, 0f, 103.68f, 2);
				if (!unk_0xAF437D7C802AB246((*iParam8)[0]))
				{
					unk_0x360F0D01112F8AD0((*iParam8)[0], uLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!unk_0xAF437D7C802AB246((*iParam8)[1]))
				{
					unk_0x360F0D01112F8AD0((*iParam8)[1], uLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_c", 4f, -4f, 16, 0, 1148846080, 0);
				}
				if (!unk_0xAF437D7C802AB246((*iParam8)[2]))
				{
					unk_0x360F0D01112F8AD0((*iParam8)[2], uLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
				}
				*iParam0 = 3;
			}
			break;
		...
		case 3:
			*iParam9 = 0;
			if (unk_0x47B2F09FC779F5CD(uLocal_53))
			{
				if (unk_0x4D221DFBB84DCF0B(uLocal_53) > 0.3f)
				{
					if (!unk_0xAF437D7C802AB246((*iParam8)[0]))
					{
						unk_0xC31A3F1982C7B12B((*iParam8)[0], 156, 1);
						unk_0x94026C1D1DB14225(&iLocal_50);
						unk_0xBE9AFED5018B4A06(0, unk_0x1141852D07400777(unk_0xE7869D5D7816A9B6(), 1) - Vector(0f, 0f, 1f), unk_0xE7869D5D7816A9B6(), 2f, 0, 3.5f, 5f, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
						unk_0xA02736B50802C8BB(0, unk_0xE7869D5D7816A9B6(), 25000, 0);
						unk_0x911ECBCE73F8EC3F(iLocal_50);
						unk_0xC2C4A3A9FF2FBFFF((*iParam8)[0], iLocal_50);
						unk_0x33A90AD8FA327B72(&iLocal_50);
						iLocal_50 = 0;
					}
				}
				if (unk_0x4D221DFBB84DCF0B(uLocal_53) > 0.35f)
				{
					if (!unk_0xAF437D7C802AB246((*iParam8)[1]))
					{
						unk_0xC31A3F1982C7B12B((*iParam8)[1], 156, 1);
						unk_0x94026C1D1DB14225(&iLocal_50);
						unk_0x8C2752F3FF55C28A(0, unk_0xE7869D5D7816A9B6(), unk_0xE7869D5D7816A9B6(), 2f, 0, 5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
						unk_0xA02736B50802C8BB(0, unk_0xE7869D5D7816A9B6(), 25000, 0);
						unk_0x911ECBCE73F8EC3F(iLocal_50);
						unk_0xC2C4A3A9FF2FBFFF((*iParam8)[1], iLocal_50);
						unk_0x33A90AD8FA327B72(&iLocal_50);
						iLocal_50 = 0;
					}
				}
				if (unk_0x4D221DFBB84DCF0B(uLocal_53) > 0.275f)
				{
					if (!unk_0xAF437D7C802AB246((*iParam8)[2]))
					{
						unk_0xC31A3F1982C7B12B((*iParam8)[2], 156, 1);
						unk_0x94026C1D1DB14225(&iLocal_50);
						unk_0x8C2752F3FF55C28A(0, unk_0xE7869D5D7816A9B6(), unk_0xE7869D5D7816A9B6(), 2f, 0, 3.5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
						unk_0xA02736B50802C8BB(0, unk_0xE7869D5D7816A9B6(), 25000, 0);
						unk_0x911ECBCE73F8EC3F(iLocal_50);
						unk_0xC2C4A3A9FF2FBFFF((*iParam8)[2], iLocal_50);
						unk_0x33A90AD8FA327B72(&iLocal_50);
						iLocal_50 = 0;
					}
				}
			...
			if (!unk_0xAF437D7C802AB246((*iParam8)[2]))
			{
				if (unk_0x0E6C083BC5101C8B((*iParam8)[2], unk_0xE7869D5D7816A9B6(), 4f, 4f, 2f, 0, 1, 0))
				{
					func_40(uLocal_224);
					func_40(uLocal_225);
					func_36(iParam8);
					...
					iLocal_251 = unk_0x9D40BBF80D8F5E8A();
					*iParam0 = 4;
				}
			}
			break;
		...
		case 4:
			...
			else if (unk_0x72957E5DA83E879F(unk_0xE7869D5D7816A9B6(), 6))
			{
				*iParam0 = 6;
			}
			break;
		...
		case 6:
			...
			if (func_31(iParam8))
			{
				*iParam10 = 1;
				if (!unk_0xAF437D7C802AB246(iParam7))
				{
					if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iParam7, 8f, 8f, 8f, 0, 1, 0))
					{
						func_44(&uLocal_55, "REGIAU", "REGIN_SORRY", 4, 0, 0, 0);
					}
				}
				if (!unk_0xD11595488376CB53(uLocal_225))
				{
				}
				while (func_69())
				{
...
void func_33(var uParam0)
{
	...
	if (iLocal_254 == 0)
	{
		...
		{
			if (!unk_0xAF437D7C802AB246((*uParam0)[iVar2]))
			{
				iVar0++;
				iVar1 = iVar2;
			}
		...
		if (iVar0 == 1)
		{
			if (!unk_0xAF437D7C802AB246((*uParam0)[iVar1]))
			{
				unk_0x7E3DC7ED30B648F0((*uParam0)[iVar1], 0, 1);
				unk_0x45AC72BF50E50EFE((*uParam0)[iVar1], 0);
				iLocal_254 = 1;
			}
		}
	}
...
int func_34(struct<6> Param0, int iParam6, var uParam7)
{
	switch (iLocal_252)
	{
		...
		case 1:
			if (!unk_0xAF437D7C802AB246(iParam6))
			{
				if (unk_0xC47857E5E74EA5AF(iParam6, 242628503) == 7 || unk_0x0E6C083BC5101C8B(iParam6, unk_0xE7869D5D7816A9B6(), 8f, 8f, 8f, 0, 1, 0))
				{
					if (!func_69())
					{
		...
		case 2:
			if (!unk_0xAF437D7C802AB246((*uParam7)[2]))
			{
				...
				{
					unk_0x94026C1D1DB14225(&iLocal_50);
					unk_0x39FD98334BDB065B(0, 700);
					unk_0x33E113E52A91C5C3(0, Local_229[0 /*3*/], 1f, -1, 0.25f, 0, 40000f);
					unk_0xF78809EA8A08F2D1(0, fLocal_239[0], 0);
					unk_0xCECFBDAE08977579(0, Param0.f_5, "sit_down_idle_01", Local_229[0 /*3*/], 0f, 0f, fLocal_239[0], 1000f, -4f, -1, 1, 0, 2, 0);
					unk_0x911ECBCE73F8EC3F(iLocal_50);
					unk_0xC2C4A3A9FF2FBFFF((*uParam7)[0], iLocal_50);
					unk_0x33A90AD8FA327B72(&iLocal_50);
					iLocal_50 = 0;
				}
				...
				{
					unk_0x94026C1D1DB14225(&iLocal_50);
					unk_0x39FD98334BDB065B(0, 200);
					unk_0x33E113E52A91C5C3(0, Local_229[1 /*3*/], 1f, -1, 0.25f, 0, 40000f);
					unk_0x5EE92E5069683596(0, 1193033728, 0);
					unk_0x911ECBCE73F8EC3F(iLocal_50);
					unk_0xC2C4A3A9FF2FBFFF((*uParam7)[1], iLocal_50);
					unk_0x33A90AD8FA327B72(&iLocal_50);
					iLocal_50 = 0;
				}
				if (!unk_0xAF437D7C802AB246((*uParam7)[2]))
				{
					...
					unk_0xE0B41A177C6DAB44(0, (*uParam7)[0], 0f, -0.5f, 0f, 1f, 10000, 1036831949, 1);
					unk_0x5EE92E5069683596(0, 1193033728, 0);
					unk_0x911ECBCE73F8EC3F(iLocal_50);
					unk_0xC2C4A3A9FF2FBFFF((*uParam7)[2], iLocal_50);
					unk_0x33A90AD8FA327B72(&iLocal_50);
					iLocal_50 = 0;
				}
			}
...
void func_36(var uParam0)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		if (!unk_0xD11595488376CB53(uLocal_220[iVar0]))
		{
			if (!unk_0xAF437D7C802AB246((*uParam0)[iVar0]))
			{
				uLocal_220[iVar0] = func_37((*uParam0)[iVar0], 1, 145);
				unk_0x5D04A2BDCC04FCAE((*uParam0)[iVar0], 1, 0);
			}
		}
		iVar0++;
	}
...
int func_38(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xFC630C7120A34CE4(uVar0, func_39(unk_0x00AAD79B42B3E036(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xFC630C7120A34CE4(uVar0, func_39(unk_0x00AAD79B42B3E036(), 0.7f, 0.7f));
		unk_0x4ADC112587E95B61(uVar0, bParam1);
	}
...
void func_41(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		if (!unk_0xAF437D7C802AB246((*uParam0)[iVar0]))
		{
			unk_0x13C351F151D49F89((*uParam0)[iVar0], unk_0xE7869D5D7816A9B6(), 0, 16);
			unk_0x7E3DC7ED30B648F0((*uParam0)[iVar0], 0, 1);
	...
	{
		unk_0xAA6742AEFA0B2BC4(iParam1);
		unk_0xC2EA5B4B2052D2F1(iParam1, -1);
		unk_0x8D6671D78D1F569B(iParam1, 1);
	}
}
...
int func_54(int iParam0, var uParam1)
{
	switch (iLocal_255)
	{
		case 0:
			...
			{
				if ((unk_0x22E902D6AF27E232(unk_0xE7869D5D7816A9B6(), 1272.878f, -1532.84f, 36.4104f, 1339.482f, -1623.636f, 71.4792f, 105.1875f, 0, 1, 0) && !unk_0x51AAB57E2FC16B14(iParam0)) || unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iParam0, 15f, 15f, 15f, 0, 1, 0))
				{
					if (!func_108())
					{
						func_58(1);
					...
					if (!unk_0xD11595488376CB53(uLocal_225))
					{
						...
						unk_0x9C9B069F802F9A20(uLocal_225, 0);
					}
					if (unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
					{
						if (!unk_0xCFA5146E8AEF8EB0(unk_0xE7869D5D7816A9B6()))
						{
							...
							{
								if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iParam0, 10f, 10f, 10f, 0, 1, 0))
								{
									unk_0xAA6742AEFA0B2BC4(iParam0);
									unk_0x94026C1D1DB14225(&iLocal_50);
									unk_0x58F62EDF6111D598(0, unk_0xE7869D5D7816A9B6(), -1);
									unk_0x6A8BCE61F660B8D0(0, unk_0xE7869D5D7816A9B6(), 20000, 1024, 2);
									unk_0x911ECBCE73F8EC3F(iLocal_50);
									unk_0xC2C4A3A9FF2FBFFF(iParam0, iLocal_50);
									unk_0x33A90AD8FA327B72(&iLocal_50);
									if (unk_0xD11595488376CB53(uLocal_225))
									{
										unk_0x9C9B069F802F9A20(uLocal_225, 1);
									}
							...
							else if (iLocal_246 == 0)
							{
								...
								if (!unk_0xAF437D7C802AB246(iParam0))
								{
									unk_0x94026C1D1DB14225(&iLocal_50);
									unk_0x6A8BCE61F660B8D0(0, unk_0xE7869D5D7816A9B6(), 20000, 1024, 2);
									unk_0xDCF460AE46C9489C(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", 2f, -2f, -1, 49, 0, 0, 0, 0);
									unk_0x58F62EDF6111D598(0, unk_0xE7869D5D7816A9B6(), -1);
									unk_0x911ECBCE73F8EC3F(iLocal_50);
									unk_0xC2C4A3A9FF2FBFFF(iParam0, iLocal_50);
									unk_0x33A90AD8FA327B72(&iLocal_50);
					...
					{
						if (unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iParam0, 8f, 8f, 8f, 0, 1, 0))
						{
							unk_0x94026C1D1DB14225(&iLocal_50);
							unk_0x58F62EDF6111D598(0, unk_0xE7869D5D7816A9B6(), -1);
							unk_0x6A8BCE61F660B8D0(0, unk_0xE7869D5D7816A9B6(), 20000, 1024, 2);
			...
			{
				if (unk_0x22E902D6AF27E232(unk_0xE7869D5D7816A9B6(), 1273.098f, -1604.172f, 53.1535f, 1276.568f, -1615.127f, 56.7879f, 10f, 0, 1, 0) && !func_57())
				{
					iLocal_255 = 3;
				}
				else if (unk_0x22E902D6AF27E232(unk_0xE7869D5D7816A9B6(), 1298.546f, -1617.742f, 53.2254f, 1262.868f, -1629.36f, 64.2894f, 30.4375f, 0, 1, 0))
				{
		...
		case 1:
			...
			if (!unk_0xAF437D7C802AB246(iParam0) && !unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
			{
				unk_0xC797AB6C3A6482E1(Local_243, 13f, 0, 0, 0, 0, 0);
				unk_0xAA6742AEFA0B2BC4(iParam0);
				if (!unk_0xAF437D7C802AB246(iParam0))
				{
					unk_0x94026C1D1DB14225(&iLocal_50);
					unk_0x33E113E52A91C5C3(0, Local_243, 2f, 20000, 0.25f, 0, 32.2195f);
					unk_0x6A8BCE61F660B8D0(0, unk_0xE7869D5D7816A9B6(), -1, 1024, 2);
					unk_0x58F62EDF6111D598(0, unk_0xE7869D5D7816A9B6(), -1);
					unk_0x911ECBCE73F8EC3F(iLocal_50);
					unk_0xC2C4A3A9FF2FBFFF(iParam0, iLocal_50);
					unk_0x33A90AD8FA327B72(&iLocal_50);
					iLocal_50 = 0;
					if ((unk_0x72957E5DA83E879F(unk_0xE7869D5D7816A9B6(), 6) && unk_0x0E6C083BC5101C8B(unk_0xE7869D5D7816A9B6(), iParam0, 6f, 6f, 6f, 0, 1, 0)) && !unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
					{
					}
				}
				iLocal_255 = 2;
		...
		case 2:
			if (!unk_0xAF437D7C802AB246(iParam0) && !func_69())
			{
		...
		case 3:
			...
			{
				if (unk_0x83666F9FB8FEBD4B() > 8000 && unk_0x3761EA7F8628B81A(iParam0, Local_243, 3f, 3f, 3f, 0, 1, 0))
				{
					if (unk_0xFA68268DB708808B(iParam0, unk_0xE7869D5D7816A9B6(), 60f))
					{
						if (func_158())
						{
							unk_0xDCF460AE46C9489C(iParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_a", 2f, -2f, -1, 48, 0, 0, 0, 0);
						}
						else
						{
							unk_0xDCF460AE46C9489C(iParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 0, 0, 0, 0, 0);
						}
						func_44(&uLocal_55, "REGIAU", "REGIN_HERE", 4, 0, 0, 0);
						unk_0xC1B1E9A034A63A62(0);
					}
				}
				if ((unk_0x72957E5DA83E879F(unk_0xE7869D5D7816A9B6(), 6) && unk_0x7F895384D1330018(iParam0, unk_0xE7869D5D7816A9B6())) && !unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
				{
		...
		case 4:
			if (!unk_0xAF437D7C802AB246(iParam0))
			{
				...
				unk_0x33E113E52A91C5C3(0, Local_243, 2f, 20000, 0.25f, 0, 40000f);
				unk_0x911ECBCE73F8EC3F(iLocal_50);
				unk_0x33A90AD8FA327B72(&iLocal_50);
				iLocal_50 = 0;
			}
...
void func_55(int iParam0)
{
	if (!unk_0xAF437D7C802AB246(iParam0))
	{
		unk_0xFA2C5C2D054C888E(iParam0);
		unk_0x94026C1D1DB14225(&iLocal_50);
		unk_0x33E113E52A91C5C3(0, 1286.037f, -1623.207f, 53.2297f, 2f, -1, 0.25f, 0, 40000f);
...
void func_56(int iParam0, var uParam1)
{
	...
	while (iVar0 < *uParam1)
	{
		if (!unk_0xAF437D7C802AB246((*uParam1)[iVar0]) && !unk_0xAF437D7C802AB246(iParam0))
		{
			if ((unk_0x7F895384D1330018((*uParam1)[iVar0], unk_0xE7869D5D7816A9B6()) || unk_0x336C780EEEFE4E4B(unk_0x3F80C6638E3A1A90(), (*uParam1)[iVar0])) || unk_0x7F895384D1330018(iParam0, unk_0xE7869D5D7816A9B6()))
			{
				func_70();
				if (!unk_0xAF437D7C802AB246((*uParam1)[iVar0]))
				{
					unk_0xFA2C5C2D054C888E((*uParam1)[iVar0]);
					unk_0x94026C1D1DB14225(&iLocal_50);
					unk_0x6A8BCE61F660B8D0(0, unk_0xE7869D5D7816A9B6(), 1000, 2048, 2);
					unk_0x4B79E06845D63B96(0, unk_0xE7869D5D7816A9B6(), 200f, -1, 0, 0);
					unk_0x911ECBCE73F8EC3F(iLocal_50);
					unk_0xC2C4A3A9FF2FBFFF((*uParam1)[iVar0], iLocal_50);
					unk_0x33A90AD8FA327B72(&iLocal_50);
					unk_0x8D6671D78D1F569B((*uParam1)[iVar0], 1);
				}
				if (!unk_0xAF437D7C802AB246(iParam0))
				{
					unk_0xFA2C5C2D054C888E(iParam0);
...
int func_57()
{
	if (unk_0x51374A0BB2871E6E(unk_0xE7869D5D7816A9B6(), 0))
	{
		...
		{
			if (unk_0x63E25E4341FF2308(unk_0xE7869D5D7816A9B6(), joaat("rhino")))
			{
				return 1;
			}
		}
	}
	if (unk_0xC62AC8D7E29686A2(unk_0xE7869D5D7816A9B6()) || unk_0xCFA5146E8AEF8EB0(unk_0xE7869D5D7816A9B6()))
	{
		return 1;
	}
	return 0;
...
int func_62()
{
	switch (func_63(&Global_25093, 0, 5, 0, unk_0xE3E113B4DB09AAF8()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_66(iParam0, Global_35619);
}
...
int func_68(struct<3> Param0, int iParam3)
{
	if (!unk_0xAF437D7C802AB246(unk_0xE7869D5D7816A9B6()))
	{
		if (unk_0x2A488C176D52CCA5(unk_0x1141852D07400777(unk_0xE7869D5D7816A9B6(), 1), Param0) > IntToFloat(iParam3))
		{
			return 1;
		}
	}
...
int func_74(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5, int iParam6)
{
					...
					if (unk_0x386C3192F791D414(unk_0x3F80C6638E3A1A90(), iParam0) || unk_0xBC273BCD46110BE6(unk_0x3F80C6638E3A1A90(), iParam0))
					{
						if (fVar9 < fVar0)
						{
							if (unk_0xF70F7CD913F23E2A(iParam0, unk_0xE7869D5D7816A9B6(), 17))
							{
								...
								func_79("\n");
								func_75("		time since not LockedOn = ", (unk_0x9D40BBF80D8F5E8A() - iLocal_45));
								func_79("\n");
								bVar2 = true;
								if (unk_0x9D40BBF80D8F5E8A() > (iLocal_45 + *uParam2))
								{
	...
	if (!bVar2)
	{
		iLocal_45 = unk_0x9D40BBF80D8F5E8A();
	}
	return 0;
}
		...
		if (unk_0xD51CFE69539DB6D8(unk_0xE7869D5D7816A9B6()))
		{
			if (!unk_0xAF437D7C802AB246(unk_0xE7869D5D7816A9B6()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xA01404E50546EA1D(unk_0x3F80C6638E3A1A90(), 1) || func_94()) || Global_25036) || func_93()) || func_52(8, -1)) || func_90()) || func_92()) || func_91()) || func_89()) || Global_99155.f_6302.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x69CFD69005B7F5D7(unk_0x3F80C6638E3A1A90()) || unk_0x47EF9ED961F4F559(unk_0xE7869D5D7816A9B6())) || unk_0xF3140D055686CF79(unk_0xE7869D5D7816A9B6())) || unk_0x8E2CF6ACCED3BD0F(unk_0xE7869D5D7816A9B6())) || unk_0xA2245114BF58F40D(unk_0xE7869D5D7816A9B6())) || unk_0xA01404E50546EA1D(unk_0x3F80C6638E3A1A90(), 1)) || unk_0x39CB1B5DEC5DD307(unk_0x3F80C6638E3A1A90())) || unk_0x0930CF2B56CCE2B8(unk_0xE7869D5D7816A9B6(), 0)) || func_94()) || Global_98202) || Global_25036) || func_93()) || func_52(8, -1)) || func_90()) || func_92()) || func_91()) || func_89()) || Global_99155.f_6302.f_919[iVar0] == 5) || Global_36166 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x8E2CF6ACCED3BD0F(unk_0xE7869D5D7816A9B6()) || unk_0xA2245114BF58F40D(unk_0xE7869D5D7816A9B6())) || unk_0xA01404E50546EA1D(unk_0x3F80C6638E3A1A90(), 1)) || unk_0x0930CF2B56CCE2B8(unk_0xE7869D5D7816A9B6(), 0)) || func_94()) || Global_98202) || Global_25036) || func_93()) || func_52(8, -1)) || func_92()) || func_91()) || func_89()) || Global_99155.f_6302.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_94() || unk_0x44B59DB1458EE8E0(unk_0x3F80C6638E3A1A90()) > 0) || func_52(8, -1)) || func_89()) || func_88()) || Global_99155.f_6302.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_95()
{
	...
	{
		if (unk_0xB7A628320EFF8E47(unk_0x1141852D07400777(unk_0xE7869D5D7816A9B6(), 1), Local_46) < (75f * 75f))
		{
			return 1;
		}
		if (unk_0xA8CEACB4F35AE058(unk_0x834FF019A048DE2C(unk_0xE7869D5D7816A9B6())) > 1369f && !func_106())
		{
			return 0;
		}
	}
...
int func_109(int iParam0, struct<5> Param1, var uParam6)
{
	...
	if (iParam0 == 1)
	{
		...
		{
			unk_0x801429C020C467BA(Param1[iVar0]);
			iVar0++;
		}
		unk_0x801429C020C467BA(Param1.f_4);
		unk_0x2B0BB514F9140141("random@gang_intimidation@");
		unk_0x062A4B39164546AD("RE28_OS");
		if (!unk_0x5053BF6D5604065B(Param1.f_4))
		{
			return 0;
		}
		iVar0 = 0;
		while (iVar0 <= (iLocal_51 - 1))
		{
			if (!unk_0x5053BF6D5604065B(Param1[iVar0]))
			{
				return 0;
			}
			iVar0++;
		}
		if (unk_0x2917D5E1CB5CE43A("random@gang_intimidation@"))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 <= (iLocal_51 - 1))
		{
			unk_0x839E9476E54502A2(Param1[iVar0]);
			iVar0++;
		}
...
int func_113(struct<3> Param0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		...
		if (!func_140(Global_99155.f_29444.f_43[iParam3]))
		{
			return 0;
		}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_127(unk_0xB519E5386FBF69E5(iParam0, 31), -1, 1)) + 2011;
}
...
int func_130()
{
	...
	func_136(&uVar0, unk_0x0CE219089BDB83C5());
	func_135(&uVar0, unk_0x1B24A2CA27443F7B());
	func_134(&uVar0, unk_0x7C833E3C6EEE41E0());
	func_133(&uVar0, unk_0x2DA3502053F9E535());
	func_132(&uVar0, unk_0xEB4EA596232DA76E());
	func_131(&uVar0, unk_0xB99227ECC84A576C());
	return uVar0;
}
...
void func_146(struct<6> Param0, int iParam6, int iParam7, int iParam8)
{
	...
	if (iLocal_249)
	{
		...
		unk_0xBDF0A810DD6A47D3(Local_243 - Vector(10f, 10f, 10f), Local_243 + Vector(10f, 10f, 10f), 1, 1);
		...
		while (iVar0 <= (iLocal_51 - 1))
		{
			if (!unk_0xAF437D7C802AB246((*iParam7)[iVar0]))
			{
			}
			iVar0++;
		}
		if (!unk_0xAF437D7C802AB246(iParam8))
		{
			unk_0x9BEE7E791BC4D38B(iParam8, 0);
		}
		func_83(0);
		func_109(0, Param0);
	}
...
void func_147(int iParam0)
{
	...
	if (func_108())
	{
		...
		func_150(30000);
		StringCopy(&cVar0, func_149(Global_99144, 1), 64);
