...
void func_1()
{
	...
	if (iLocal_150 && !iLocal_149)
	{
		...
		unk_0x78B2DF314748056B(255, uLocal_152, joaat("player"));
		if (bLocal_59)
		{
	...
	switch (iLocal_69)
	{
		...
		case 5:
			if (!unk_0xECEC7528A52B4EE8(iLocal_58) && !unk_0xE50EB54E0F21BED0(iLocal_121[8], 0))
			{
				...
				else if (unk_0xC9D9444186B5A374() > 10000 || unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), unk_0xD6E677FAD7521410(iLocal_121[8], 1), 1.5f, 1.5f, 3f, 0, 1, 0))
				{
...
void func_152()
{
	...
	unk_0x78B2DF314748056B(5, uLocal_152, joaat("player"));
...
int func_168()
{
	if (unk_0xCAD1755E530A6012(unk_0x1146A9AE09CE2B14()) && !unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
	{
		...
		if (unk_0xA8CEACB4F35AE058(unk_0x9F2928DF31D785C7(unk_0x7D2B9E6A64637269())) > 1369f && !func_179())
		{
			return 0;
		}
	}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_199(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
