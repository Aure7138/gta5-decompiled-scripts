...
void func_1()
{
	...
	if (iLocal_150 && !iLocal_149)
	{
		...
		unk_0xEFBCE8F8316F89EA(255, uLocal_152, joaat("player"));
		if (bLocal_59)
		{
	...
	switch (iLocal_69)
	{
		...
		case 5:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58) && !unk_0xA59F96B50B97E63C(iLocal_121[8], 0))
			{
				...
				else if (unk_0xC9D9444186B5A374() > 10000 || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), unk_0x3E4D3CCC220BDFB1(iLocal_121[8], 1), 1.5f, 1.5f, 3f, 0, 1, 0))
				{
...
void func_152()
{
	...
	unk_0xEFBCE8F8316F89EA(5, uLocal_152, joaat("player"));
...
int func_168()
{
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (unk_0xA8CEACB4F35AE058(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_179())
		{
			return 0;
		}
	}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_199(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
