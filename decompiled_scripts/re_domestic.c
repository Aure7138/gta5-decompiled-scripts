...
void __EntryFunction__()
{
	...
	if (unk_0xC11469DCA6FC3BB5(11))
	{
		...
		{
			if (unk_0x5D6C6BD519D63337(iLocal_57))
			{
				unk_0x5BEB6DE8CD28F036(iLocal_57);
			}
		}
		func_217();
	}
	...
	while (true)
	{
		...
		if ((unk_0x4F4FF2F3B81506A7() || iLocal_48 == 4) || iLocal_67 > 18)
		{
			if (!func_170())
			{
				if (func_169())
			...
			unk_0xCBBDAEEE9AB391E3("RE_DO", 0);
					...
					case 1:
						...
						switch (iLocal_48)
						{
							...
							case 1:
								if (!iLocal_98)
								{
									if ((unk_0x5E58342602E94718(unk_0x096275889B8E0EE0(), -467.0595f, 540.1724f, 125.3034f, 91.875f, 90.875f, 30f, 0, 1, 0) && unk_0x2E941B5FFA2989C6(Local_105, 1f)) || unk_0x5E58342602E94718(unk_0x096275889B8E0EE0(), Local_105, 20f, 20f, 20f, 0, 1, 0))
									{
										func_140();
										func_131(1);
										iLocal_98 = 1;
								...
								{
									if (unk_0x5E58342602E94718(unk_0x096275889B8E0EE0(), Local_105, 50f, 50f, 50f, 0, 1, 0))
									{
										func_129();
									}
									if (!unk_0x6CFF81397164A1D3(iLocal_57))
									{
										if (!unk_0x5E58342602E94718(iLocal_57, Local_62, 30f, 30f, 30f, 0, 1, 0))
										{
											iLocal_48 = 11;
										}
									}
							...
							case 4:
								...
								if (!iLocal_88)
								{
									if (func_51())
									{
										if (unk_0x5E58342602E94718(unk_0x096275889B8E0EE0(), Local_111, 23f, 60f, 20f, 0, 1, 0))
										{
											func_56(0);
											func_54();
											unk_0x4EDE34FBADD967A6(0);
						...
						{
							if (unk_0xDEE49D5CA6C49148(iLocal_56, "random@domestic", "f_attack_end", 3))
							{
						...
						if ((func_47() && !func_46()) && iLocal_47 != 2)
						{
							if (!unk_0x6CFF81397164A1D3(iLocal_57))
							{
								if (unk_0x5E58342602E94718(iLocal_57, Local_117, 5f, 5f, 5f, 0, 1, 0))
								{
									if (!unk_0xD42BD6EB2E0F1677(iLocal_120[8]))
									{
										iLocal_120[8] = unk_0x1A2D7464B1CAA1C8(joaat("prop_golf_iron_01"), -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
										unk_0x1B21CF9397F27FEE(iLocal_120[8], iLocal_57, unk_0xD1E5B4D09626571A(iLocal_57, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, 1, 0, 0, 0, 2, 1);
									}
									func_45(0);
									unk_0x4EDE34FBADD967A6(0);
									func_54();
...
void func_1()
{
	...
	if (iLocal_149 && !iLocal_148)
	{
		...
		if (unk_0xD42BD6EB2E0F1677(iLocal_120[8]))
		{
			uLocal_132 = unk_0xEC57323A2B4BC5EE(joaat("pickup_weapon_golfclub"), unk_0xA86D5F069399F44D(iLocal_120[8], 1), unk_0xE09CAF86C32CB48F(iLocal_120[8], 2) + Vector(2.8157f, -159.5768f, -14.1956f), 0, -1, 2, 1, 0);
			unk_0x931914268722C263(&(iLocal_120[8]));
		}
		unk_0xBBB134FB9D50C0CC(Local_62 - Vector(10f, 10f, 10f), Local_62 + Vector(10f, 10f, 10f), 1, 1);
		unk_0x9E0FEFE102840007(255, uLocal_151, joaat("player"));
		if (bLocal_58)
		{
		...
		if (unk_0xCD82FA174080B3B1(uLocal_101[0]))
		{
			unk_0xF2C3C9DA47AAA54A(&(uLocal_101[0]));
		}
		if (unk_0xD42BD6EB2E0F1677(iLocal_57))
		{
			if (!unk_0x6CFF81397164A1D3(iLocal_57))
			{
				if (!unk_0x52BE10F427339B39(iLocal_57, 0))
				{
					unk_0xF75B54D7038487AF(iLocal_57);
				}
				unk_0x5BEB6DE8CD28F036(iLocal_57);
				unk_0x49876BF356F39E66(iLocal_57, 0);
				unk_0x5E95290AF8605EA1(iLocal_57, 1);
			}
		}
		iVar0 = 0;
		while (iVar0 < iLocal_120)
		{
			...
			{
				unk_0x64CDE9D6BF8ECAD3(iLocal_120[iVar0], 1, 1);
			}
			iVar0++;
		}
		unk_0x305538B87F955257(-499.9164f, 575.6557f, 124.5584f, -346.8641f, 483.3948f, 111.7201f, 74.0625f, 1);
		unk_0x7E42B5424BF0E844();
		iLocal_148 = 1;
	}
	if ((!unk_0x5E58342602E94718(unk_0x096275889B8E0EE0(), Local_62, 80f, 80f, 80f, 0, 1, 0) || unk_0x0696A2ED1650FFA2(uLocal_132)) || !(unk_0xD42BD6EB2E0F1677(iLocal_120[8]) && !unk_0x7663C03D63716314(uLocal_132)))
	{
		func_217();
	}
}
...
int func_13(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x03A753E2C8458335())
	{
		if (func_11() == 0)
		{
			return unk_0x4ED6CFDFE8D4131A(func_9(func_10(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_21()
{
	...
	{
		func_22(13, unk_0xF34EE736CF047844(Global_97353.f_8448.f_3853));
	}
...
int func_44()
{
	if (unk_0x6CFF81397164A1D3(iLocal_56) && unk_0x6CFF81397164A1D3(iLocal_57))
	{
		return 1;
	}
	return 0;
...
{
	unk_0xD318BF1FC64DD7D9(iParam0, sParam1, sParam2, func_49(iParam3), 0);
}
...
int func_51()
{
	...
	{
		iLocal_150 = unk_0xB3598EA616C3FFC3(unk_0x096275889B8E0EE0(), 0);
		if (unk_0xB86D29B10F627379(iLocal_150, 0))
		{
			if (!unk_0x6CFF81397164A1D3(iLocal_57))
			{
				if (unk_0xEB8F1713A0FC1B96(iLocal_57, iLocal_150))
				{
					return 1;
				}
			}
...
void func_56(bool bParam0)
{
	...
	else if ((!iLocal_70 && unk_0x200E87988220C592()) && !func_61())
	{
		Local_77 = { func_60() };
		Local_71 = { func_59() };
		func_57();
...
void func_75()
{
	switch (iLocal_69)
	{
		case 0:
			...
			else if (!unk_0x6CFF81397164A1D3(iLocal_57))
			{
				unk_0x20AEBA4CC5125CEC(iLocal_57, 1f);
				if (unk_0xC057F02B837A27F6(iLocal_57, unk_0x096275889B8E0EE0(), 8f, 8f, 8f, 0, 1, 0))
				{
					if (iLocal_67 < 19)
					{
		...
		case 1:
			...
			if (unk_0xD42BD6EB2E0F1677(iLocal_57))
			{
				if (!unk_0x6CFF81397164A1D3(iLocal_57))
				{
					...
					{
						if (unk_0x29B959D9755B1A71(iLocal_57))
						{
							unk_0x931914268722C263(&(iLocal_120[8]));
						}
					}
					if (unk_0x08B96A437661F1BC(iLocal_57))
					{
						func_116();
						func_110();
		...
		case 2:
			...
			if (unk_0x5E58342602E94718(unk_0x096275889B8E0EE0(), Local_111, 10f, 10f, 10f, 0, 1, 0))
			{
			...
			if (unk_0xD42BD6EB2E0F1677(iLocal_57))
			{
				if (!unk_0x6CFF81397164A1D3(iLocal_57))
				{
					if (unk_0x5E58342602E94718(iLocal_57, Local_111, Global_18, 1, 1, 0) && func_106(1, 0, 1))
					{
						if (unk_0xCD82FA174080B3B1(uLocal_99))
						{
							unk_0xF2C3C9DA47AAA54A(&uLocal_99);
						}
						...
						if (unk_0x52BE10F427339B39(iLocal_57, 0))
						{
							unk_0x334357D0C82BAE3D(unk_0xB3598EA616C3FFC3(iLocal_57, 0), 10.5f, 3, 0);
							iLocal_69++;
						}
						else
						{
	...
	switch (iLocal_142)
	{
		...
		case 2:
			...
			if (!unk_0x6CFF81397164A1D3(iLocal_57))
			{
				...
				unk_0x14A4402A811D03C0(0, Local_114, 1f, -1, 0.25f, 0, 311.3569f);
				unk_0x42E581F1274EFDB7(0, "WORLD_HUMAN_SMOKING", 0, 1);
				unk_0xFF7E39890B2840DD(uLocal_94);
				unk_0xD59C10966EB589EA(iLocal_57, uLocal_94);
				unk_0x5EC7E18324A7D03D(&uLocal_94);
				unk_0x2AD4789CBFD829EC(iLocal_57, 1);
				iLocal_143 = unk_0x4F67E8ECA7D3F667() + 4000;
				iLocal_142++;
			}
			break;
		
		case 3:
			if (iLocal_143 < unk_0x4F67E8ECA7D3F667())
			{
				unk_0x916ED8321F087059();
				iLocal_142++;
			}
...
void func_81(int iParam0)
{
	...
	else if (unk_0x4ED6CFDFE8D4131A(Global_97353.f_23789.f_471, iParam0) || unk_0x4ED6CFDFE8D4131A(Global_2097152[func_83() /*8053*/].f_5756.f_10, iParam0))
	{
		bVar0 = true;
		unk_0x7D1D4A3602B6AD4E(&(Global_97353.f_23789.f_471), iParam0);
		unk_0x7D1D4A3602B6AD4E(&(Global_2097152[func_83() /*8053*/].f_5756.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		unk_0x88D2BE4120CBF840("COUP_RED");
		unk_0x734AB59A7DBD1DAA(func_82(iParam0));
...
bool func_85(int iParam0)
{
	...
	return unk_0x4ED6CFDFE8D4131A(Global_2097152[func_83() /*8053*/].f_5756.f_10, iParam0);
}
...
{
	uParam0->f_1 = (func_94(unk_0x4ED6CFDFE8D4131A(*uParam0, 4)) - fParam1);
	...
	switch (iLocal_142)
	{
		...
		case 3:
			...
			if (!unk_0x6CFF81397164A1D3(iLocal_57))
			{
				...
				iLocal_143 = unk_0x4F67E8ECA7D3F667() + 1000;
				iLocal_142++;
			}
			break;
		...
		case 4:
			...
			if (iLocal_143 < unk_0x4F67E8ECA7D3F667())
			{
				...
				{
					unk_0x4D51E59243281D80(unk_0x217E9DC48139933D(), 1, 0);
					iLocal_143 = unk_0x4F67E8ECA7D3F667() + 3000;
					iLocal_142++;
				}
			}
			break;
...
void func_107()
{
	...
	if (!func_146())
	{
		switch (iLocal_140)
		{
			...
			case 13:
				iLocal_141 = unk_0x4F67E8ECA7D3F667() + 600;
				iLocal_140++;
				break;
			...
			case 17:
				iLocal_141 = unk_0x4F67E8ECA7D3F667() + 800;
				iLocal_140++;
				break;
...
void func_108()
{
	if (!unk_0x6CFF81397164A1D3(iLocal_57))
	{
		if (!iLocal_83)
		{
			...
			{
				if (!unk_0x9C8E4D238C999648(unk_0x096275889B8E0EE0(), unk_0x2F96E7720B0B19EA(), 1) && unk_0x9C8E4D238C999648(iLocal_57, unk_0x2F96E7720B0B19EA(), 0))
				{
					func_56(0);
					func_54();
					unk_0x4EDE34FBADD967A6(0);
		...
		{
			if (unk_0x9C8E4D238C999648(unk_0x096275889B8E0EE0(), unk_0x2F96E7720B0B19EA(), 0) && unk_0x9C8E4D238C999648(iLocal_57, unk_0x2F96E7720B0B19EA(), 0))
			{
				iLocal_83 = 0;
			}
		}
...
void func_109()
{
	...
	if ((iLocal_136 - iLocal_135) > 60000)
	{
		...
		if (!unk_0x6CFF81397164A1D3(iLocal_57))
		{
			if (unk_0x5E58342602E94718(iLocal_57, Local_114, 200f, 200f, 200f, 0, 1, 0))
			{
				unk_0x14A4402A811D03C0(iLocal_57, Local_114, 1f, -1, 0.25f, 0, 1193033728);
			}
			else
			{
				unk_0x4736475B6CFB795C(iLocal_57, 1193033728, 0);
			}
			unk_0x2AD4789CBFD829EC(iLocal_57, 1);
			unk_0x5BEB6DE8CD28F036(iLocal_57);
		}
...
void func_110()
{
	if (!unk_0x6CFF81397164A1D3(iLocal_57))
	{
		if (unk_0xC057F02B837A27F6(unk_0x096275889B8E0EE0(), iLocal_57, 8f, 8f, 8f, 0, 1, 0) || unk_0x7B3FE8C8BC422763(unk_0x096275889B8E0EE0()))
		{
			if ((unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 0) && !unk_0x52BE10F427339B39(iLocal_57, 0)) && !unk_0x7B3FE8C8BC422763(unk_0x096275889B8E0EE0()))
			{
				if (!unk_0xCD82FA174080B3B1(uLocal_101[0]))
				{
			...
			else
			{
				...
				if (func_53() == 2 && !func_46())
				{
					if (!unk_0xCD82FA174080B3B1(uLocal_100))
					{
						...
						unk_0x74F74D3207ED525C(uLocal_100, 269);
						func_111();
					}
				}
			}
...
var func_112(struct<3> Param0, int iParam3)
{
	...
	unk_0x17D3E31025A05A57(uVar0, func_113(unk_0x03A753E2C8458335(), 1f, 1f));
...
int func_115(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x17D3E31025A05A57(uVar0, func_113(unk_0x03A753E2C8458335(), 0.7f, 0.7f));
		unk_0x5F3268378F24D97B(uVar0, bParam1);
	}
...
void func_116()
{
	...
	while (iVar0 < iLocal_120)
	{
		unk_0x0AD8BB0ADAFEDEE5(&(iLocal_120[iVar0]));
		iVar0++;
	}
	unk_0x4763145053A33D46("random@domestic");
}
	...
	if (!unk_0x6CFF81397164A1D3(iLocal_57))
	{
		if (unk_0x52BE10F427339B39(unk_0x096275889B8E0EE0(), 1))
		{
			if (!func_121())
			{
				...
				if (unk_0x04932A97CB319DE0(iLocal_57, 1227113341) != 1 && unk_0x04932A97CB319DE0(iLocal_57, 1227113341) != 0)
				{
					unk_0xF553365A64BDFF94(iLocal_57, unk_0x096275889B8E0EE0(), -1, 6f, 1073741824, 1073741824, 0);
				}
				if (unk_0x52BE10F427339B39(iLocal_57, 0))
				{
					unk_0x36DBE8E570B9FBCE(iLocal_57, 0, 0);
				}
				if (!iLocal_90)
				{
					func_56(0);
			...
			else
			{
				...
				if (unk_0x04932A97CB319DE0(iLocal_57, 1227113341) == 1 && unk_0x04932A97CB319DE0(iLocal_57, 1227113341) == 0)
				{
					unk_0x0F1ABE64C3C18E5A(iLocal_57);
				}
			}
		}
		else if (!unk_0x5D6C6BD519D63337(iLocal_57))
		{
			unk_0xC17B8A7D48C194DB(iLocal_57, func_119());
			unk_0xA8F442E84EF050FC(iLocal_57, 1);
			unk_0x4C60E33A2CB9B14D(iLocal_57, 0);
		}
	}
}
...
void func_122()
{
	switch (iLocal_68)
	{
		...
		case 2:
			iLocal_139 = unk_0x4F67E8ECA7D3F667();
			if (!unk_0x6CFF81397164A1D3(iLocal_57))
			{
				if (unk_0xC057F02B837A27F6(unk_0x096275889B8E0EE0(), iLocal_57, 12f, 12f, 5f, 0, 1, 2))
				{
					if (func_121())
					{
						unk_0x9E0FEFE102840007(255, uLocal_151, joaat("player"));
		...
		case 3:
			if (!unk_0x6CFF81397164A1D3(iLocal_57) && unk_0xD42BD6EB2E0F1677(iLocal_120[8]))
			{
				unk_0xF4BF3E3D7FE56705(&uLocal_94);
				if (iLocal_67 > 18)
				{
				}
				unk_0x14A4402A811D03C0(0, unk_0xA86D5F069399F44D(iLocal_120[8], 1) + Vector(0f, 0.39f, 0.35f), 1f, -1, 0f, 512, func_124(unk_0xA86D5F069399F44D(unk_0x096275889B8E0EE0(), 1), unk_0xA86D5F069399F44D(iLocal_120[8], 1)));
				unk_0x8DBC05C86F873CC9(0, "random@domestic", "pickup_low", 2f, -2f, -1, 0, 0, 0, 0, 0);
				unk_0x8DBC05C86F873CC9(0, "random@security_van", "sec_hand_override", 8f, -4f, -1, 33, 0, 0, 0, 0);
				unk_0xFF7E39890B2840DD(uLocal_94);
				unk_0xD59C10966EB589EA(iLocal_57, uLocal_94);
				unk_0x5EC7E18324A7D03D(&uLocal_94);
				unk_0x5AE11BC36633DE4E(0);
		...
		case 4:
		case 5:
			if (!unk_0x6CFF81397164A1D3(iLocal_57) && !unk_0x7D5B1F88E7504BBA(iLocal_120[8]))
			{
				if (unk_0xDEE49D5CA6C49148(iLocal_57, "random@domestic", "pickup_low", 3))
				{
					unk_0xE037BF068223C38D(iLocal_57, iLocal_120[8], 0);
					if (unk_0x6B0B5671C53485D8(iLocal_57, "random@domestic", "pickup_low") > 0.388f)
					{
						iLocal_68 = 7;
					}
				}
				else if (unk_0xC9D9444186B5A374() > 10000 || unk_0x5E58342602E94718(unk_0x096275889B8E0EE0(), unk_0xA86D5F069399F44D(iLocal_120[8], 1), 1.5f, 1.5f, 3f, 0, 1, 0))
				{
					if (!unk_0xEE6AD63ABF59C0B7(iLocal_120[8]))
					{
						unk_0xF4BF3E3D7FE56705(&uLocal_94);
						unk_0x8DBC05C86F873CC9(0, "random@domestic", "pickup_low", 2f, -2f, -1, 0, 0, 0, 0, 0);
						unk_0x8DBC05C86F873CC9(0, "random@security_van", "sec_hand_override", 8f, -4f, -1, 33, 0, 0, 0, 0);
		...
		case 7:
			if (!unk_0x6CFF81397164A1D3(iLocal_57))
			{
				if (unk_0xC057F02B837A27F6(iLocal_57, unk_0x096275889B8E0EE0(), 20f, 20f, 20f, 0, 1, 0))
				{
					unk_0x1B21CF9397F27FEE(iLocal_120[8], iLocal_57, unk_0xD1E5B4D09626571A(iLocal_57, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, 1, 0, 0, 0, 2, 1);
					unk_0xC17B8A7D48C194DB(iLocal_57, unk_0x9BAB31815159ABCF(unk_0x217E9DC48139933D()));
					unk_0xA8F442E84EF050FC(iLocal_57, 1);
					unk_0x4C60E33A2CB9B14D(iLocal_57, 0);
					func_123();
					iLocal_48 = 4;
...
void func_126()
{
	if (!iLocal_97)
	{
		if (!unk_0x6CFF81397164A1D3(iLocal_57))
		{
			if (unk_0xC057F02B837A27F6(iLocal_57, unk_0x096275889B8E0EE0(), 12f, 12f, 5f, 0, 1, 0))
			{
				unk_0x0F1ABE64C3C18E5A(iLocal_57);
				unk_0xF4BF3E3D7FE56705(&uLocal_94);
				unk_0xFE920E72A4B34285(0, unk_0x096275889B8E0EE0(), 0);
				unk_0xD4648EA39998A07B(0, unk_0x096275889B8E0EE0(), 18000, 0, 2);
				unk_0xFF7E39890B2840DD(uLocal_94);
				unk_0xD59C10966EB589EA(iLocal_57, uLocal_94);
				unk_0x5EC7E18324A7D03D(&uLocal_94);
				unk_0xD4648EA39998A07B(unk_0x096275889B8E0EE0(), iLocal_57, 15000, 0, 2);
				iLocal_97 = 1;
			}
		}
	}
			...
			if (bLocal_137)
			{
				if (bLocal_53)
				{
					...
					if (!unk_0x6CFF81397164A1D3(iLocal_57))
					{
						if (!func_146())
						{
							if (unk_0x9B4CC17D919C8FC4(iLocal_57, unk_0x096275889B8E0EE0(), 90f))
							{
...
void func_127()
{
	if (unk_0xD42BD6EB2E0F1677(iLocal_57))
	{
		if (unk_0xC057F02B837A27F6(unk_0x096275889B8E0EE0(), iLocal_57, 15f, 15f, 15f, 0, 1, 0))
		{
			if (func_128())
			{
				func_45(0);
...
void func_129()
{
	...
	{
		case 0:
			if (!unk_0x6CFF81397164A1D3(iLocal_57) && !unk_0x6CFF81397164A1D3(iLocal_56))
			{
				if (unk_0x2E941B5FFA2989C6(unk_0xA86D5F069399F44D(iLocal_56, 1), 3f))
				{
					if (!func_146())
					{
						if (func_145(&uLocal_154, "REDO2AU", "REDO2_ARMA", 4, 0, 0, 0))
						{
							unk_0x8DBC05C86F873CC9(iLocal_57, "random@domestic", "balcony_fight_male", 2f, -2f, -1, 0, 0.3f, 0, 0, 0);
							unk_0x8DBC05C86F873CC9(iLocal_56, "random@domestic", "balcony_fight_female", 2f, -2f, -1, 0, 0.3f, 0, 0, 0);
							iLocal_67++;
						}
					}
				}
		...
		case 1:
			if (!unk_0x6CFF81397164A1D3(iLocal_56) && unk_0xD42BD6EB2E0F1677(iLocal_120[8]))
			{
				unk_0x1B21CF9397F27FEE(iLocal_120[8], iLocal_56, unk_0xD1E5B4D09626571A(iLocal_56, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
				iLocal_67++;
			}
			break;
		...
		case 2:
			if (!unk_0x6CFF81397164A1D3(iLocal_56) && unk_0xD42BD6EB2E0F1677(iLocal_120[8]))
			{
				if (unk_0xDEE49D5CA6C49148(iLocal_56, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x6B0B5671C53485D8(iLocal_56, "random@domestic", "balcony_fight_female") > 0.335f)
					{
						unk_0x64CDE9D6BF8ECAD3(iLocal_120[8], 0, 1);
						unk_0xF15E8F5D333F09C4(iLocal_120[8], 1, 0f, 6f, 4f, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
						iLocal_67++;
					}
				}
			}
		...
		case 3:
			if (!iLocal_87 && unk_0xD42BD6EB2E0F1677(iLocal_120[8]))
			{
				if (unk_0xDF18751EC74F90FF(iLocal_120[8]))
				{
					unk_0x6856F5517E486379(-1, "CLOTHES_THROWN", iLocal_120[8], "RE_DOMESTIC_SOUNDSET", 0, 0);
					iLocal_87 = 1;
				}
			}
		...
		case 4:
			if (!unk_0x6CFF81397164A1D3(iLocal_56) && unk_0xD42BD6EB2E0F1677(iLocal_120[9]))
			{
				if (unk_0xDEE49D5CA6C49148(iLocal_56, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x6B0B5671C53485D8(iLocal_56, "random@domestic", "balcony_fight_female") > 0.473f)
					{
						unk_0x1B21CF9397F27FEE(iLocal_120[9], iLocal_56, unk_0xD1E5B4D09626571A(iLocal_56, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
						iLocal_67++;
					}
				}
			}
		...
		case 6:
			if (!unk_0x6CFF81397164A1D3(iLocal_56) && unk_0xD42BD6EB2E0F1677(iLocal_120[9]))
			{
				if (unk_0xDEE49D5CA6C49148(iLocal_56, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x6B0B5671C53485D8(iLocal_56, "random@domestic", "balcony_fight_female") > 0.55f)
					{
						unk_0x64CDE9D6BF8ECAD3(iLocal_120[9], 0, 1);
						unk_0xF15E8F5D333F09C4(iLocal_120[9], 1, 1f, 2f, 3f, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
						iLocal_67++;
					}
				}
			}
		...
		case 7:
			if (!iLocal_87 && unk_0xD42BD6EB2E0F1677(iLocal_120[9]))
			{
				if (unk_0xDF18751EC74F90FF(iLocal_120[9]))
				{
					unk_0x6856F5517E486379(-1, "CLOTHES_THROWN", iLocal_120[9], "RE_DOMESTIC_SOUNDSET", 0, 0);
					iLocal_87 = 1;
				}
			}
			if (!func_146() || func_128())
		...
		case 8:
			if (!unk_0x6CFF81397164A1D3(iLocal_56) && unk_0xD42BD6EB2E0F1677(iLocal_120[10]))
			{
				if (unk_0xDEE49D5CA6C49148(iLocal_56, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x6B0B5671C53485D8(iLocal_56, "random@domestic", "balcony_fight_female") > 0.705f)
					{
						unk_0x1B21CF9397F27FEE(iLocal_120[10], iLocal_56, unk_0xD1E5B4D09626571A(iLocal_56, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
						iLocal_67++;
					}
				}
			}
		...
		case 9:
			if (!unk_0x6CFF81397164A1D3(iLocal_56) && unk_0xD42BD6EB2E0F1677(iLocal_120[10]))
			{
				if (unk_0xDEE49D5CA6C49148(iLocal_56, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x6B0B5671C53485D8(iLocal_56, "random@domestic", "balcony_fight_female") > 0.838f)
					{
						unk_0x64CDE9D6BF8ECAD3(iLocal_120[10], 0, 1);
						unk_0xF15E8F5D333F09C4(iLocal_120[10], 1, 1f, 3f, 3f, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
						iLocal_67++;
					}
				}
			}
		...
		case 10:
			if (!iLocal_87 && unk_0xD42BD6EB2E0F1677(iLocal_120[10]))
			{
				if (unk_0xDF18751EC74F90FF(iLocal_120[10]))
				{
					unk_0x6856F5517E486379(-1, "CLOTHES_THROWN", iLocal_120[10], "RE_DOMESTIC_SOUNDSET", 0, 0);
					iLocal_87 = 1;
				}
			}
			if (!func_146() || func_128())
		...
		case 11:
			if (!unk_0x6CFF81397164A1D3(iLocal_56) && !unk_0x6CFF81397164A1D3(iLocal_57))
			{
				if (unk_0xDEE49D5CA6C49148(iLocal_56, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x6B0B5671C53485D8(iLocal_56, "random@domestic", "balcony_fight_female") > 0.94f)
					{
						unk_0xFE920E72A4B34285(iLocal_56, iLocal_57, 0);
					}
				}
			}
			if (!func_146() || func_128())
		...
		case 16:
			if (!unk_0x6CFF81397164A1D3(iLocal_57))
			{
				...
				unk_0x26D1C211B43D46E1(0, Local_108, 0);
				unk_0xFF7E39890B2840DD(uLocal_94);
				unk_0xD59C10966EB589EA(iLocal_57, uLocal_94);
				unk_0x5EC7E18324A7D03D(&uLocal_94);
				iLocal_67++;
		...
		case 17:
			if (unk_0xD42BD6EB2E0F1677(iLocal_56))
			{
				...
				{
					if (unk_0x5E58342602E94718(iLocal_56, Local_108, 1f, 1f, 5f, 0, 1, 0) && unk_0x140188E884645624(iLocal_56))
					{
						unk_0xCC0EF140F99365C5(&iLocal_56);
					}
				}
			}
			if (iLocal_92 < unk_0x4F67E8ECA7D3F667())
			{
				if (!func_146())
				{
					if (func_145(&uLocal_154, "REDO2AU", "REDO2_INS1", 4, 0, 0, 0))
					{
						iLocal_92 = unk_0x4F67E8ECA7D3F667() + 5000;
						iLocal_93++;
					}
				}
			}
	...
	if (!bLocal_53)
	{
		if (iLocal_67 > 2 && iLocal_67 < 8)
		{
			if (!unk_0x6CFF81397164A1D3(iLocal_57))
			{
				if (unk_0xC057F02B837A27F6(unk_0x096275889B8E0EE0(), iLocal_57, 6f, 4f, 5f, 0, 1, 0) || (unk_0xC057F02B837A27F6(unk_0x096275889B8E0EE0(), iLocal_57, 12f, 12f, 5f, 0, 1, 2) && unk_0xD1D5C591B9D44995(unk_0x217E9DC48139933D())))
				{
					unk_0x0F1ABE64C3C18E5A(iLocal_57);
					func_130();
					if (iLocal_67 > 18)
		...
		else if (iLocal_67 > 7)
		{
			if (!unk_0x6CFF81397164A1D3(iLocal_57))
			{
				if (unk_0xC057F02B837A27F6(unk_0x096275889B8E0EE0(), iLocal_57, 6f, 8f, 5f, 0, 1, 0))
				{
					if (unk_0xCD82FA174080B3B1(uLocal_101[0]))
					{
						unk_0x8BB337CC6CD674F2(uLocal_101[0], 1);
					}
					unk_0x0F1ABE64C3C18E5A(iLocal_57);
					func_130();
					if (iLocal_67 > 18)
	...
	if (bLocal_55)
	{
		if (iLocal_54 < unk_0x4F67E8ECA7D3F667())
		{
			func_57();
			if (unk_0xD42BD6EB2E0F1677(iLocal_56))
			{
...
void func_130()
{
	...
	{
		unk_0xF4BF3E3D7FE56705(&uLocal_94);
		unk_0xAF2345A328AF713D(0, Local_108, 1f, -1, 1193033728, 1056964608);
		unk_0x8DBC05C86F873CC9(0, "random@domestic", "f_attack_end", 2f, -2f, -1, 1, 0, 0, 0, 0);
		unk_0xFF7E39890B2840DD(uLocal_94);
		unk_0xD59C10966EB589EA(iLocal_56, uLocal_94);
		unk_0x5EC7E18324A7D03D(&uLocal_94);
...
int func_134()
{
	switch (func_135(&Global_24503, 0, 5, 0, unk_0x55525C346BEF6960()))
	{
		case 1:
			return 1;
			break;
...
void func_140()
{
	...
	{
		uLocal_101[0] = func_114(iLocal_57, 0, 145);
		unk_0x8BB337CC6CD674F2(uLocal_101[0], 0);
	}
}
...
void func_141()
{
	...
	func_4(42, 1);
	func_4(43, 1);
	unk_0x3B882A96EA77D5B1(Local_62, 2f, 1, 0, 0, 0);
	unk_0x3B882A96EA77D5B1(Local_59, 2f, 1, 0, 0, 0);
	unk_0xBBB134FB9D50C0CC(Local_62 - Vector(10f, 10f, 10f), Local_62 + Vector(10f, 10f, 10f), 0, 1);
	unk_0x014C4B659562111A(-499.9164f, 575.6557f, 124.5584f, -346.8641f, 483.3948f, 111.7201f, 74.0625f, 0, 0, 1);
	unk_0x55686F8055FF786B(Local_62 - Vector(10f, 10f, 10f), Local_62 + Vector(10f, 10f, 10f), 0, 1, 1, 1);
	unk_0x55686F8055FF786B(Local_111 - Vector(3f, 2f, 2f), Local_111 + Vector(3f, 2f, 2f), 0, 1, 1, 1);
	unk_0x55686F8055FF786B(Vector(53.1038f, 56.6649f, -1366.481f) - Vector(1f, 1f, 1f), Vector(53.1038f, 56.6649f, -1366.481f) + Vector(1f, 1f, 1f), 0, 1, 1, 1);
	unk_0x352AB5EAB2338B18("rghDomestic", &uLocal_151);
	unk_0x9E0FEFE102840007(5, uLocal_151, joaat("player"));
	iLocal_56 = unk_0x9066DFD4D92E6773(26, iLocal_95, Local_59, fLocal_65, 1, 1);
	unk_0x49876BF356F39E66(iLocal_56, 1);
	unk_0x32A582AACCBCAEFE(iLocal_56, 17, 1);
	unk_0x32A582AACCBCAEFE(iLocal_56, 8, 0);
	unk_0xF6482620334B0094(iLocal_56, 1, 0);
	unk_0xF6482620334B0094(iLocal_56, 2, 0);
	unk_0xF6482620334B0094(iLocal_56, 128, 1);
	unk_0xF6482620334B0094(iLocal_56, 8, 0);
	unk_0x8DBC05C86F873CC9(iLocal_56, "random@domestic", "balcony_fight_idle_female", 8f, -4f, -1, 1, 0, 0, 0, 0);
	unk_0x6ECBACF91786FB7A(iLocal_56, uLocal_151);
	func_144(iLocal_56, "GENERIC_WHATEVER", 24);
	unk_0x4AD96EF928BD4F9A(iLocal_95);
	unk_0x020E173F318C12DA(iLocal_56, 185, 1);
	iLocal_57 = unk_0x9066DFD4D92E6773(26, iLocal_96, Local_62, fLocal_66, 1, 1);
	unk_0x49876BF356F39E66(iLocal_57, 1);
	unk_0xF6482620334B0094(iLocal_57, 1, 1);
	unk_0xF6482620334B0094(iLocal_57, 2, 0);
	unk_0xF6482620334B0094(iLocal_57, 128, 1);
	unk_0xF6482620334B0094(iLocal_57, 8, 0);
	unk_0xF6482620334B0094(iLocal_57, 65536, 1);
	unk_0x020E173F318C12DA(iLocal_57, 185, 1);
	unk_0x020E173F318C12DA(iLocal_57, 206, 1);
	unk_0x082FA643218F5655(iLocal_57, 0);
	unk_0x5E95290AF8605EA1(iLocal_57, 0);
	unk_0x8DBC05C86F873CC9(iLocal_57, "random@domestic", "balcony_fight_idle_male", 8f, -4f, -1, 1, 0, 0, 0, 0);
	unk_0x6ECBACF91786FB7A(iLocal_57, uLocal_151);
	func_144(iLocal_57, "GENERIC_WHATEVER", 24);
	unk_0x4AD96EF928BD4F9A(iLocal_96);
	unk_0xD4648EA39998A07B(iLocal_57, iLocal_56, -1, 0, 2);
	unk_0xD4648EA39998A07B(iLocal_56, iLocal_57, -1, 0, 2);
	unk_0x584EEBEECD248926(iLocal_56, 0, 1, 0, 0);
	unk_0x584EEBEECD248926(iLocal_56, 2, 1, 1, 0);
	unk_0x584EEBEECD248926(iLocal_56, 3, 1, 1, 0);
	unk_0x584EEBEECD248926(iLocal_56, 4, 1, 2, 0);
	unk_0x584EEBEECD248926(iLocal_57, 0, 0, 0, 0);
	unk_0x584EEBEECD248926(iLocal_57, 2, 1, 0, 0);
	unk_0x584EEBEECD248926(iLocal_57, 3, 1, 2, 0);
	unk_0x584EEBEECD248926(iLocal_57, 4, 1, 1, 0);
	unk_0x584EEBEECD248926(iLocal_57, 8, 0, 0, 0);
	func_143();
	unk_0xF73FBE4845C43B5B(&uLocal_133, 5);
	if (func_53() == 0)
	{
		func_142(&uLocal_154, 0, unk_0x096275889B8E0EE0(), "MICHAEL", 0, 1);
	}
	if (func_53() == 1)
	{
		func_142(&uLocal_154, 1, unk_0x096275889B8E0EE0(), "FRANKLIN", 0, 1);
	}
	if (func_53() == 2)
	{
		func_142(&uLocal_154, 2, unk_0x096275889B8E0EE0(), "TREVOR", 0, 1);
	}
	func_142(&uLocal_154, 3, iLocal_57, "REDOCastro", 0, 1);
	unk_0xD937A3C5EF78C429(iLocal_57, sLocal_152);
	func_142(&uLocal_154, 4, iLocal_56, "NATHALIA", 0, 1);
	unk_0xD937A3C5EF78C429(iLocal_56, sLocal_153);
	unk_0xC1B1E9A034A63A62(0);
	iLocal_149 = 1;
}
...
void func_143()
{
	iLocal_120[0] = unk_0x1A2D7464B1CAA1C8(joaat("prop_ld_tshirt_02"), -470.3661f, 541.385f, 120.0205f, 1, 1, 0);
	unk_0x9CC8314DFEDE441E(iLocal_120[0], -13.7262f, 0.5001f, -0.5886f, 2, 1);
	unk_0x7D9EFB7AD6B19754(iLocal_120[0], 1);
	unk_0x4AD96EF928BD4F9A(joaat("prop_ld_tshirt_02"));
	iLocal_120[1] = unk_0x1A2D7464B1CAA1C8(joaat("prop_ld_jeans_02"), -470.8998f, 540.7595f, 120.169f, 1, 1, 0);
	unk_0x9CC8314DFEDE441E(iLocal_120[1], -7.3906f, -12.8136f, -63.733f, 2, 1);
	unk_0x7D9EFB7AD6B19754(iLocal_120[1], 1);
	unk_0x4AD96EF928BD4F9A(joaat("prop_ld_jeans_02"));
	iLocal_120[2] = unk_0x1A2D7464B1CAA1C8(joaat("prop_ld_shoe_01"), -468.3266f, 540.7725f, 120.1762f, 1, 1, 0);
	unk_0x9CC8314DFEDE441E(iLocal_120[2], -7.041683f, 10.17298f, 45.7617f, 2, 1);
	unk_0x7D9EFB7AD6B19754(iLocal_120[2], 1);
	unk_0x4AD96EF928BD4F9A(joaat("prop_ld_shoe_01"));
	iLocal_120[3] = unk_0x1A2D7464B1CAA1C8(joaat("prop_ld_jeans_01"), -468.7787f, 541.864f, 119.9098f, 1, 1, 0);
	unk_0x9CC8314DFEDE441E(iLocal_120[3], -8.5884f, 12.6893f, 57.1792f, 2, 1);
	unk_0x7D9EFB7AD6B19754(iLocal_120[3], 1);
	unk_0x4AD96EF928BD4F9A(joaat("prop_ld_jeans_01"));
	iLocal_120[4] = unk_0x1A2D7464B1CAA1C8(joaat("prop_ld_shoe_02"), -470.9009f, 541.2538f, 120.0578f, 1, 1, 0);
	unk_0x9CC8314DFEDE441E(iLocal_120[4], -16.4886f, 2.4979f, -3.8769f, 2, 1);
	unk_0x7D9EFB7AD6B19754(iLocal_120[4], 1);
	unk_0x4AD96EF928BD4F9A(joaat("prop_ld_shoe_02"));
	iLocal_120[5] = unk_0x1A2D7464B1CAA1C8(joaat("prop_ld_shirt_01"), -472.0366f, 542.0591f, 119.8243f, 1, 1, 0);
	unk_0x9CC8314DFEDE441E(iLocal_120[5], -3.5946f, -15.0978f, -75.5026f, 2, 1);
	unk_0x7D9EFB7AD6B19754(iLocal_120[5], 1);
	unk_0x4AD96EF928BD4F9A(joaat("prop_ld_shirt_01"));
	iLocal_120[6] = unk_0x1A2D7464B1CAA1C8(joaat("prop_porn_mag_03"), -472.7543f, 542.3022f, 119.7628f, 1, 1, 0);
	unk_0x9CC8314DFEDE441E(iLocal_120[6], 6.402527f, -15.68665f, -104.1308f, 2, 1);
	unk_0x7D9EFB7AD6B19754(iLocal_120[6], 1);
	unk_0x4AD96EF928BD4F9A(joaat("prop_porn_mag_03"));
	iLocal_120[7] = unk_0x1A2D7464B1CAA1C8(joaat("prop_porn_mag_01"), -471.8675f, 543.6655f, 119.4991f, 1, 1, 0);
	unk_0x9CC8314DFEDE441E(iLocal_120[7], -8.3642f, 1.9344f, 2.6889f, 2, 1);
	unk_0x7D9EFB7AD6B19754(iLocal_120[7], 1);
	unk_0x4AD96EF928BD4F9A(joaat("prop_porn_mag_01"));
	iLocal_120[8] = unk_0x1A2D7464B1CAA1C8(joaat("prop_golf_iron_01"), -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
	iLocal_120[9] = unk_0x1A2D7464B1CAA1C8(joaat("prop_cs_rub_binbag_01"), -473.195f, 537.2585f, 123.3303f, 1, 1, 0);
	unk_0x4AD96EF928BD4F9A(joaat("prop_cs_rub_binbag_01"));
	iLocal_120[10] = unk_0x1A2D7464B1CAA1C8(joaat("prop_golf_bag_01"), -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
	unk_0x4AD96EF928BD4F9A(joaat("prop_golf_bag_01"));
}

void func_144(var uParam0, char* sParam1, int iParam2)
{
	unk_0x17033CDF9E0B42C6(uParam0, sParam1, func_49(iParam2), 1);
}
...
void func_147()
{
	if (!unk_0x6CFF81397164A1D3(iLocal_57) && !unk_0x6CFF81397164A1D3(iLocal_56))
	{
		...
		{
			if (unk_0xB6C3A42B887CE035(iLocal_57, unk_0x096275889B8E0EE0()) || unk_0xB6C3A42B887CE035(iLocal_56, unk_0x096275889B8E0EE0()))
			{
				if (((unk_0x27F89FDC16688A7A(unk_0x217E9DC48139933D(), iLocal_57) || unk_0x8C67C11C68713D25(unk_0x217E9DC48139933D(), iLocal_57)) || unk_0x27F89FDC16688A7A(unk_0x217E9DC48139933D(), iLocal_56)) || unk_0x8C67C11C68713D25(unk_0x217E9DC48139933D(), iLocal_56))
				{
					if (iLocal_134 == -1)
					{
			...
			if ((iLocal_134 != -1 && unk_0x4F67E8ECA7D3F667() > iLocal_134 + 500) || unk_0x69BBBA1223D4C644(unk_0x096275889B8E0EE0()))
			{
				func_154();
			}
		}
	...
	if (unk_0x5E58342602E94718(unk_0x096275889B8E0EE0(), -471.1757f, 535.356f, 124.8557f, 3f, 2.5f, 1.5f, 0, 1, 0))
	{
		func_151();
	}
	if (unk_0xD42BD6EB2E0F1677(iLocal_56))
	...
	if (unk_0xD42BD6EB2E0F1677(iLocal_57))
	{
		if (func_150(iLocal_57) || unk_0x7B6E7BEC1143AC86(iLocal_57, unk_0x096275889B8E0EE0(), 1))
		{
			func_148();
		}
	}
	if (unk_0xD42BD6EB2E0F1677(iLocal_56))
	{
		if (func_150(iLocal_56) || unk_0x7B6E7BEC1143AC86(iLocal_56, unk_0x096275889B8E0EE0(), 1))
		{
			func_148();
		}
	}
	if (!unk_0x6CFF81397164A1D3(iLocal_57))
	{
		if (!unk_0xC057F02B837A27F6(unk_0x096275889B8E0EE0(), iLocal_57, 250f, 250f, 250f, 0, 1, 0) || unk_0xDDE5C125AC446723(iLocal_57))
		{
			iLocal_48 = 11;
		}
	}
...
void func_149()
{
	...
	if (!unk_0x6CFF81397164A1D3(iLocal_56))
	{
		unk_0x6EE9AE1124E7C613(iLocal_56, -1);
		unk_0x2AD4789CBFD829EC(iLocal_56, 1);
		iVar0 = 0;
		while (iVar0 < iLocal_120)
		{
...
void func_152()
{
	...
	{
		unk_0x0F1ABE64C3C18E5A(iLocal_57);
		unk_0x4EFB17949DC06F34(iLocal_57, unk_0xA86D5F069399F44D(unk_0xB3598EA616C3FFC3(unk_0x096275889B8E0EE0(), 0), 1), 150f, -1, 0, 0);
		unk_0x2AD4789CBFD829EC(iLocal_57, 1);
	}
	iLocal_48 = 11;
}
...
int func_153(int iParam0)
{
	...
	{
		if (!unk_0x52BE10F427339B39(iParam0, 0) && unk_0xC057F02B837A27F6(unk_0x096275889B8E0EE0(), iParam0, 1.5f, 1.5f, 8f, 0, 1, 2))
		{
			if (unk_0xFB6BA510A533DF81(unk_0xB3598EA616C3FFC3(unk_0x096275889B8E0EE0(), 0)) > 4f)
			{
				return 1;
			}
		}
...
void func_154()
{
	...
	{
		unk_0xF4BF3E3D7FE56705(&uLocal_94);
		unk_0x36DBE8E570B9FBCE(0, 0, 4096);
		unk_0x06C6AD4F38E8412D(0, unk_0x096275889B8E0EE0(), 250f, -1, 0, 0);
		unk_0xFF7E39890B2840DD(uLocal_94);
		unk_0xD59C10966EB589EA(iLocal_57, uLocal_94);
		unk_0x5EC7E18324A7D03D(&uLocal_94);
...
void func_155()
{
	...
	unk_0xFA28FE3A6246FC30(joaat("prop_golf_iron_01"));
	unk_0xFA28FE3A6246FC30(joaat("prop_cs_rub_binbag_01"));
	unk_0xFA28FE3A6246FC30(joaat("prop_golf_bag_01"));
	unk_0xFA28FE3A6246FC30(joaat("prop_ld_tshirt_02"));
	unk_0xFA28FE3A6246FC30(joaat("prop_ld_jeans_02"));
	unk_0xFA28FE3A6246FC30(joaat("prop_ld_shoe_01"));
	unk_0xFA28FE3A6246FC30(joaat("prop_ld_jeans_01"));
	unk_0xFA28FE3A6246FC30(joaat("prop_ld_shoe_02"));
	unk_0xFA28FE3A6246FC30(joaat("prop_ld_shirt_01"));
	unk_0xFA28FE3A6246FC30(joaat("prop_porn_mag_03"));
	unk_0xFA28FE3A6246FC30(joaat("prop_porn_mag_01"));
	unk_0xA862A2AD321F94B4("random@domestic");
	unk_0xA862A2AD321F94B4("random@security_van");
	if ((((((((((((((unk_0x1283B8B89DD5D1B6(iLocal_95) && unk_0x1283B8B89DD5D1B6(iLocal_96)) && unk_0x1283B8B89DD5D1B6(joaat("prop_golf_iron_01"))) && unk_0x1283B8B89DD5D1B6(joaat("prop_cs_rub_binbag_01"))) && unk_0x1283B8B89DD5D1B6(joaat("prop_golf_bag_01"))) && unk_0x1283B8B89DD5D1B6(joaat("prop_ld_tshirt_02"))) && unk_0x1283B8B89DD5D1B6(joaat("prop_ld_jeans_02"))) && unk_0x1283B8B89DD5D1B6(joaat("prop_ld_shoe_01"))) && unk_0x1283B8B89DD5D1B6(joaat("prop_ld_jeans_01"))) && unk_0x1283B8B89DD5D1B6(joaat("prop_ld_shoe_02"))) && unk_0x1283B8B89DD5D1B6(joaat("prop_ld_shirt_01"))) && unk_0x1283B8B89DD5D1B6(joaat("prop_porn_mag_03"))) && unk_0x1283B8B89DD5D1B6(joaat("prop_porn_mag_01"))) && unk_0x27FF6FE8009B40CA("random@domestic")) && unk_0x27FF6FE8009B40CA("random@security_van"))
	{
		bLocal_49 = true;
	}
	else
...
int func_157()
{
	if (unk_0xBFFB35986CAAE58C(unk_0x217E9DC48139933D()) && !unk_0x6CFF81397164A1D3(unk_0x096275889B8E0EE0()))
	{
		...
		if (unk_0xA8CEACB4F35AE058(unk_0xC3BBBD114C2B597B(unk_0x096275889B8E0EE0())) > 1369f && !func_168())
		{
			return 0;
		}
	}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_188(unk_0x4ED6CFDFE8D4131A(iParam0, 31), -1, 1)) + 2011;
}
...
int func_191()
{
	...
	func_197(&uVar0, unk_0xB6101ABE62B5F080());
	func_196(&uVar0, unk_0x4E162231B823DBBF());
	func_195(&uVar0, unk_0xC82CF208C2B19199());
	func_194(&uVar0, unk_0xDF2FD796C54480A5());
	func_193(&uVar0, unk_0x2D44E8FC79EAB1AC());
	func_192(&uVar0, unk_0xE136DCA28C4A48BA());
	return uVar0;
}
		...
		if (unk_0xD42BD6EB2E0F1677(unk_0x096275889B8E0EE0()))
		{
			if (!unk_0x6CFF81397164A1D3(unk_0x096275889B8E0EE0()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xC8183AE963C58374(unk_0x217E9DC48139933D(), 1) || func_208()) || Global_24446) || func_207()) || func_71(8, -1)) || func_204()) || func_206()) || func_205()) || func_203()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_208() || unk_0xABC532F9098BFD9D(unk_0x217E9DC48139933D()) > 0) || func_71(8, -1)) || func_203()) || func_202()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_217()
{
	...
	if (iLocal_149 && !iLocal_148)
	{
		...
		if (unk_0xD42BD6EB2E0F1677(iLocal_57))
		{
			if (!unk_0x6CFF81397164A1D3(iLocal_57))
			{
				unk_0x020E173F318C12DA(iLocal_57, 317, 1);
				if (!unk_0x52BE10F427339B39(iLocal_57, 0))
				{
					unk_0xF75B54D7038487AF(iLocal_57);
				}
