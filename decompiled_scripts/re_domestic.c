					...
					case 1:
						...
						switch (iLocal_49)
						{
							...
							case 1:
								if (!iLocal_99)
								{
									if ((unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), -467.0595f, 540.1724f, 125.3034f, 91.875f, 90.875f, 30f, 0, 1, 0) && unk_0x8E28E832BEAC3DCE(Local_106, 1f)) || unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), Local_106, 20f, 20f, 20f, 0, 1, 0))
									{
										func_151();
										func_142(1);
										iLocal_99 = 1;
								...
								{
									if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), Local_106, 50f, 50f, 50f, 0, 1, 0))
									{
										func_140();
									}
									if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
									{
										if (!unk_0x5A91F08DF773C39D(iLocal_58, Local_63, 30f, 30f, 30f, 0, 1, 0))
										{
											iLocal_49 = 11;
										}
									}
							...
							case 4:
								...
								if (!iLocal_89)
								{
									if (func_52())
									{
										if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), Local_112, 23f, 60f, 20f, 0, 1, 0))
										{
											func_57(0);
											func_55();
											unk_0x4EDE34FBADD967A6(0);
						...
						if ((func_48() && !func_47()) && iLocal_48 != 2)
						{
							if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
							{
								if (unk_0x5A91F08DF773C39D(iLocal_58, Local_118, 5f, 5f, 5f, 0, 1, 0))
								{
									if (!unk_0xC844350D5D58C99A(iLocal_121[8]))
									{
										iLocal_121[8] = unk_0x7707E48765093646(joaat("prop_golf_iron_01"), -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
...
void func_1()
{
	...
	if (iLocal_150 && !iLocal_149)
	{
		...
		if (unk_0xC844350D5D58C99A(iLocal_121[8]))
		{
			uLocal_133 = unk_0x2D7B5CDDF12654D2(joaat("pickup_weapon_golfclub"), unk_0x68F4C0EC296D3901(iLocal_121[8], 1), unk_0x835730A2D89F6093(iLocal_121[8], 2) + Vector(2.8157f, -159.5768f, -14.1956f), 0, -1, 2, 1, 0);
			unk_0xF690C84DADBB3551(&(iLocal_121[8]));
		}
		unk_0xE342F209E49C5314(Local_63 - Vector(10f, 10f, 10f), Local_63 + Vector(10f, 10f, 10f), 1, 1);
		unk_0x0E2400AB9174FA81(255, uLocal_152, joaat("player"));
		if (bLocal_59)
		{
		...
		if (unk_0xC844350D5D58C99A(iLocal_58))
		{
			if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
			{
				...
				unk_0x25C5402CC10F76CD(iLocal_58, 1);
			}
		}
		iVar0 = 0;
		while (iVar0 < iLocal_121)
		{
			...
			{
				unk_0x15AFB6CBDE990FB6(iLocal_121[iVar0], 1, 1);
			}
			iVar0++;
		}
	...
	if ((!unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), Local_63, 80f, 80f, 80f, 0, 1, 0) || unk_0xEB751B41BC4080D4(uLocal_133)) || !(unk_0xC844350D5D58C99A(iLocal_121[8]) && !unk_0x762119754C50557A(uLocal_133)))
	{
		func_228();
	}
}
...
void func_81()
{
	switch (iLocal_70)
	{
		...
		case 2:
			...
			if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), Local_112, 10f, 10f, 10f, 0, 1, 0))
			{
			...
			if (unk_0xC844350D5D58C99A(iLocal_58))
			{
				if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
				{
					if (unk_0x5A91F08DF773C39D(iLocal_58, Local_112, Global_19, 1, 1, 0) && func_117(1, 0, 1))
					{
						if (unk_0xE4EDC4B0E92C078B(uLocal_100))
						{
							unk_0x142CC44DB769B57E(&uLocal_100);
						}
	...
	switch (iLocal_143)
	{
		...
		case 2:
			...
			if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
			{
				...
				unk_0x96167B03C5A77156(0, Local_115, 1f, -1, 0.25f, 0, 311.3569f);
				unk_0x509B8296EBA9B408(0, "WORLD_HUMAN_SMOKING", 0, 1);
				unk_0x75ABDC5F81978924(uLocal_95);
				unk_0x78ADC381772E3D54(iLocal_58, uLocal_95);
				unk_0xF82EA857DA10E0CD(&uLocal_95);
				unk_0xFADC0A217229F6B5(iLocal_58, 1);
...
void func_120()
{
	...
	if ((iLocal_137 - iLocal_136) > 60000)
	{
		...
		if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
		{
			if (unk_0x5A91F08DF773C39D(iLocal_58, Local_115, 200f, 200f, 200f, 0, 1, 0))
			{
				unk_0x96167B03C5A77156(iLocal_58, Local_115, 1f, -1, 0.25f, 0, 1193033728);
			}
			else
			{
			...
			else
			{
				...
				if (func_54() == 2 && !func_47())
				{
					if (!unk_0xE4EDC4B0E92C078B(uLocal_101))
					{
						...
						unk_0xBC8E0A7390523199(uLocal_101, 269);
						func_122();
					}
				}
			}
...
var func_123(struct<3> Param0, int iParam3)
{
	...
	unk_0x516E63E474722206(uVar0, func_124(unk_0x8CD06866876216F2(), 1f, 1f));
...
int func_126(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x516E63E474722206(uVar0, func_124(unk_0x8CD06866876216F2(), 0.7f, 0.7f));
		unk_0x321E019A46034F39(uVar0, bParam1);
	}
	...
	if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
	{
		if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 1))
		{
			if (!func_132())
			{
				...
				{
					unk_0xE185F110925D87DB(iLocal_58, unk_0x16F2683693E537C9(), -1, 6f, 1073741824, 1073741824, 0);
				}
				if (unk_0x405E212DDE472467(iLocal_58, 0))
				{
	...
	switch (iLocal_69)
	{
		...
		case 3:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_58) && unk_0xC844350D5D58C99A(iLocal_121[8]))
			{
				...
				unk_0x96167B03C5A77156(0, unk_0x68F4C0EC296D3901(iLocal_121[8], 1) + Vector(0f, 0.39f, 0.35f), 1f, -1, 0f, 512, func_135(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), unk_0x68F4C0EC296D3901(iLocal_121[8], 1)));
		...
		case 5:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_58) && !unk_0x437347B10A200C4B(iLocal_121[8], 0))
			{
				...
				{
					unk_0xB0703A3FDD659128(iLocal_58, iLocal_121[8], 0);
					if (unk_0x8CA9406E01C7EE58(iLocal_58, "random@domestic", "pickup_low") > 0.388f)
					{
						iLocal_69 = 7;
					}
				}
				else if (unk_0xC9D9444186B5A374() > 10000 || unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), unk_0x68F4C0EC296D3901(iLocal_121[8], 1), 1.5f, 1.5f, 3f, 0, 1, 0))
				{
...
void func_140()
{
	switch (iLocal_68)
	{
		case 0:
			...
			{
				if (unk_0x8E28E832BEAC3DCE(unk_0x68F4C0EC296D3901(iLocal_57, 1), 3f))
				{
					if (!func_157())
					{
		...
		case 2:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_57) && unk_0xC844350D5D58C99A(iLocal_121[8]))
			{
				if (unk_0xB4ECF989E2C1DAC8(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					...
					{
						unk_0x15AFB6CBDE990FB6(iLocal_121[8], 0, 1);
		...
		case 6:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_57) && unk_0xC844350D5D58C99A(iLocal_121[9]))
			{
				if (unk_0xB4ECF989E2C1DAC8(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					...
					{
						unk_0x15AFB6CBDE990FB6(iLocal_121[9], 0, 1);
		...
		case 9:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_57) && unk_0xC844350D5D58C99A(iLocal_121[10]))
			{
				if (unk_0xB4ECF989E2C1DAC8(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					...
					{
						unk_0x15AFB6CBDE990FB6(iLocal_121[10], 0, 1);
		...
		case 16:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
			{
				...
				unk_0x796BDF31572BB055(0, Local_109, 0);
				unk_0x75ABDC5F81978924(uLocal_95);
				unk_0x78ADC381772E3D54(iLocal_58, uLocal_95);
				unk_0xF82EA857DA10E0CD(&uLocal_95);
				iLocal_68++;
		...
		case 17:
			if (unk_0xC844350D5D58C99A(iLocal_57))
			{
				...
				{
					if (unk_0x5A91F08DF773C39D(iLocal_57, Local_109, 1f, 1f, 5f, 0, 1, 0) && unk_0x03068588A1FCED1A(iLocal_57))
					{
		...
		else if (iLocal_68 > 7)
		{
			if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
			{
				if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_58, 6f, 8f, 5f, 0, 1, 0))
				{
					if (unk_0xE4EDC4B0E92C078B(uLocal_102[0]))
					{
						unk_0xF2D30B8ACAF12A39(uLocal_102[0], 1);
					}
					unk_0xA3BF0AA5A2608191(iLocal_58);
					func_141();
					if (iLocal_68 > 18)
...
void func_141()
{
	...
	{
		unk_0xDD353D0E9C789D0E(&uLocal_95);
		unk_0x80AA372E04ED318D(0, Local_109, 1f, -1, 1193033728, 1056964608);
		unk_0xC6EB89C59F2AF6B8(0, "random@domestic", "f_attack_end", 2f, -2f, -1, 1, 0, 0, 0, 0);
		unk_0x75ABDC5F81978924(uLocal_95);
		unk_0x78ADC381772E3D54(iLocal_57, uLocal_95);
		unk_0xF82EA857DA10E0CD(&uLocal_95);
...
void func_151()
{
	...
	{
		uLocal_102[0] = func_125(iLocal_58, 0, 145);
		unk_0xF2D30B8ACAF12A39(uLocal_102[0], 0);
	}
}
...
void func_152()
{
	...
	func_4(43, 1);
	func_4(44, 1);
	unk_0x536F1BE96C726C4B(Local_63, 2f, 1, 0, 0, 0);
	unk_0x536F1BE96C726C4B(Local_60, 2f, 1, 0, 0, 0);
	unk_0xE342F209E49C5314(Local_63 - Vector(10f, 10f, 10f), Local_63 + Vector(10f, 10f, 10f), 0, 1);
	unk_0xB5376EA942202450(-499.9164f, 575.6557f, 124.5584f, -346.8641f, 483.3948f, 111.7201f, 74.0625f, 0, 0, 1);
	unk_0x7D6CA5F52B3748BF(Local_63 - Vector(10f, 10f, 10f), Local_63 + Vector(10f, 10f, 10f), 0, 1, 1, 1);
	unk_0x7D6CA5F52B3748BF(Local_112 - Vector(3f, 2f, 2f), Local_112 + Vector(3f, 2f, 2f), 0, 1, 1, 1);
	...
	unk_0xF63400DBE3303D26("rghDomestic", &uLocal_152);
	unk_0x0E2400AB9174FA81(5, uLocal_152, joaat("player"));
	iLocal_57 = unk_0x36F2404464202779(26, iLocal_96, Local_60, fLocal_66, 1, 1);
	unk_0x11AD11297DC58CC7(iLocal_57, 1);
	unk_0xAFF39FB306F8E232(iLocal_57, 17, 1);
	unk_0xAFF39FB306F8E232(iLocal_57, 8, 0);
	unk_0xBAFED2F6486F771A(iLocal_57, 1, 0);
	unk_0xBAFED2F6486F771A(iLocal_57, 2, 0);
	unk_0xBAFED2F6486F771A(iLocal_57, 128, 1);
	unk_0xBAFED2F6486F771A(iLocal_57, 8, 0);
	unk_0xC6EB89C59F2AF6B8(iLocal_57, "random@domestic", "balcony_fight_idle_female", 8f, -4f, -1, 1, 0, 0, 0, 0);
	unk_0x6DF7BF67E86AAE86(iLocal_57, uLocal_152);
	func_155(iLocal_57, "GENERIC_WHATEVER", 24);
	unk_0x71199B01895C6202(iLocal_96);
	unk_0x4E885A246A9D983A(iLocal_57, 185, 1);
	iLocal_58 = unk_0x36F2404464202779(26, iLocal_97, Local_63, fLocal_67, 1, 1);
	unk_0x11AD11297DC58CC7(iLocal_58, 1);
	unk_0xBAFED2F6486F771A(iLocal_58, 1, 1);
	unk_0xBAFED2F6486F771A(iLocal_58, 2, 0);
	unk_0xBAFED2F6486F771A(iLocal_58, 128, 1);
	unk_0xBAFED2F6486F771A(iLocal_58, 8, 0);
	unk_0xBAFED2F6486F771A(iLocal_58, 65536, 1);
	unk_0x4E885A246A9D983A(iLocal_58, 185, 1);
	unk_0x4E885A246A9D983A(iLocal_58, 206, 1);
	unk_0xCC095276B3DD380E(iLocal_58, 0);
	unk_0x25C5402CC10F76CD(iLocal_58, 0);
	unk_0xC6EB89C59F2AF6B8(iLocal_58, "random@domestic", "balcony_fight_idle_male", 8f, -4f, -1, 1, 0, 0, 0, 0);
	unk_0x6DF7BF67E86AAE86(iLocal_58, uLocal_152);
...
void func_154()
{
	iLocal_121[0] = unk_0x7707E48765093646(joaat("prop_ld_tshirt_02"), -470.3661f, 541.385f, 120.0205f, 1, 1, 0);
	unk_0xC023D1C4BF532815(iLocal_121[0], -13.7262f, 0.5001f, -0.5886f, 2, 1);
	unk_0x1E9649458B15960F(iLocal_121[0], 1);
	unk_0x71199B01895C6202(joaat("prop_ld_tshirt_02"));
	iLocal_121[1] = unk_0x7707E48765093646(joaat("prop_ld_jeans_02"), -470.8998f, 540.7595f, 120.169f, 1, 1, 0);
	unk_0xC023D1C4BF532815(iLocal_121[1], -7.3906f, -12.8136f, -63.733f, 2, 1);
	unk_0x1E9649458B15960F(iLocal_121[1], 1);
	unk_0x71199B01895C6202(joaat("prop_ld_jeans_02"));
	iLocal_121[2] = unk_0x7707E48765093646(joaat("prop_ld_shoe_01"), -468.3266f, 540.7725f, 120.1762f, 1, 1, 0);
	unk_0xC023D1C4BF532815(iLocal_121[2], -7.041683f, 10.17298f, 45.7617f, 2, 1);
	unk_0x1E9649458B15960F(iLocal_121[2], 1);
	unk_0x71199B01895C6202(joaat("prop_ld_shoe_01"));
	iLocal_121[3] = unk_0x7707E48765093646(joaat("prop_ld_jeans_01"), -468.7787f, 541.864f, 119.9098f, 1, 1, 0);
	unk_0xC023D1C4BF532815(iLocal_121[3], -8.5884f, 12.6893f, 57.1792f, 2, 1);
	unk_0x1E9649458B15960F(iLocal_121[3], 1);
	unk_0x71199B01895C6202(joaat("prop_ld_jeans_01"));
	iLocal_121[4] = unk_0x7707E48765093646(joaat("prop_ld_shoe_02"), -470.9009f, 541.2538f, 120.0578f, 1, 1, 0);
	unk_0xC023D1C4BF532815(iLocal_121[4], -16.4886f, 2.4979f, -3.8769f, 2, 1);
	unk_0x1E9649458B15960F(iLocal_121[4], 1);
	unk_0x71199B01895C6202(joaat("prop_ld_shoe_02"));
	iLocal_121[5] = unk_0x7707E48765093646(joaat("prop_ld_shirt_01"), -472.0366f, 542.0591f, 119.8243f, 1, 1, 0);
	unk_0xC023D1C4BF532815(iLocal_121[5], -3.5946f, -15.0978f, -75.5026f, 2, 1);
	unk_0x1E9649458B15960F(iLocal_121[5], 1);
	unk_0x71199B01895C6202(joaat("prop_ld_shirt_01"));
	iLocal_121[6] = unk_0x7707E48765093646(joaat("prop_porn_mag_03"), -472.7543f, 542.3022f, 119.7628f, 1, 1, 0);
	unk_0xC023D1C4BF532815(iLocal_121[6], 6.402527f, -15.68665f, -104.1308f, 2, 1);
	unk_0x1E9649458B15960F(iLocal_121[6], 1);
	unk_0x71199B01895C6202(joaat("prop_porn_mag_03"));
	iLocal_121[7] = unk_0x7707E48765093646(joaat("prop_porn_mag_01"), -471.8675f, 543.6655f, 119.4991f, 1, 1, 0);
	unk_0xC023D1C4BF532815(iLocal_121[7], -8.3642f, 1.9344f, 2.6889f, 2, 1);
	unk_0x1E9649458B15960F(iLocal_121[7], 1);
	unk_0x71199B01895C6202(joaat("prop_porn_mag_01"));
	iLocal_121[8] = unk_0x7707E48765093646(joaat("prop_golf_iron_01"), -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
	iLocal_121[9] = unk_0x7707E48765093646(joaat("prop_cs_rub_binbag_01"), -473.195f, 537.2585f, 123.3303f, 1, 1, 0);
	unk_0x71199B01895C6202(joaat("prop_cs_rub_binbag_01"));
	iLocal_121[10] = unk_0x7707E48765093646(joaat("prop_golf_bag_01"), -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
	unk_0x71199B01895C6202(joaat("prop_golf_bag_01"));
}

void func_155(var uParam0, char* sParam1, int iParam2)
{
	unk_0xC8B576D6F470FFC6(uParam0, sParam1, func_50(iParam2), 1);
}
...
void func_158()
{
	...
	if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), -471.1757f, 535.356f, 124.8557f, 3f, 2.5f, 1.5f, 0, 1, 0))
	{
		func_162();
	}
	if (unk_0xC844350D5D58C99A(iLocal_57))
...
void func_163()
{
	...
	{
		unk_0xA3BF0AA5A2608191(iLocal_58);
		unk_0xEEB67C3D0A71A47B(iLocal_58, unk_0x68F4C0EC296D3901(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), 1), 150f, -1, 0, 0);
		unk_0xFADC0A217229F6B5(iLocal_58, 1);
	}
	iLocal_49 = 11;
}
...
int func_168()
{
	if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()) && !unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
		...
		if (unk_0xA8CEACB4F35AE058(unk_0x56E9E0FD5ACCD35D(unk_0x16F2683693E537C9())) > 1369f && !func_179())
		{
			return 0;
		}
	}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_199(unk_0xEAE0D21A50E6C7F4(iParam0, 31), -1, 1)) + 2011;
}
...
void func_228()
{
	...
	if (iLocal_150 && !iLocal_149)
	{
		...
		if (unk_0xC844350D5D58C99A(iLocal_58))
		{
			if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
			{
				unk_0x4E885A246A9D983A(iLocal_58, 317, 1);
				if (!unk_0x405E212DDE472467(iLocal_58, 0))
				{
					unk_0x61F0DE0226FF7252(iLocal_58);
				}
