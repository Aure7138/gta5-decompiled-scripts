...
void func_7(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 4:
			...
			Var20 = { unk_0xBE8776D2466E9EA6(&sVar0, &sVar16, func_38(uParam0), func_37(uParam0), 0, 2) };
			Var23 = { unk_0x7A6103DCF5EE8CC3(&sVar0, &sVar16, func_38(uParam0), func_37(uParam0), 0, 2) };
			uVar26 = Var23.f_2;
			fVar27 = 0.05f;
		...
		case 5:
			...
			Var29 = { unk_0x7A6103DCF5EE8CC3(&sVar0, &sVar16, func_38(uParam0), func_37(uParam0), 0, 2) };
			fVar32 = Var29.f_2;
			if ((iVar28 != 1 && iVar28 != 0) || func_24(unk_0xCFC0C995455A6204(unk_0x4A8C381C258A124D()), fVar32, 5f))
			{
...
int func_49(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((unk_0xFC8BFE4B41177C22(uVar0[iVar11]) && !unk_0x4FAFF4BCB7633475(uVar0[iVar11])) && unk_0xE5E2AE8B19267B8A(uVar0[iVar11])) && func_56(uVar0[iVar11], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar11++;
...
void func_67(var uParam0, struct<3> Param1, int iParam4, char* sParam5, int iParam6, int iParam7, bool bParam8)
{
	if (!unk_0xC450B06E5AAA0985(*uParam0))
	{
...
int func_72()
{
	...
	if (unk_0xED977E2AE2CB16EE(func_83(unk_0x259BE71D8A81D4FA()), Global_1950108.f_1029[161 /*3*/], 1) >= 150f)
	{
		return 1;
	}
	if (func_75())
