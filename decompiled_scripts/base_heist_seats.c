...
void func_11()
{
	...
	if (Global_1852971 == unk_0x9E2D6C50374FCFA9() && !unk_0xE2D0C323A1AE5D85(Global_1890187[unk_0xA52C4F51ECAB7E02() /*105*/].f_38.f_27, 5))
	{
		...
		if (func_18(&Local_47, 0, 0))
		{
			...
			if ((((((iLocal_484 == 0 && !unk_0xE2D0C323A1AE5D85(Global_1890187[unk_0xA52C4F51ECAB7E02() /*105*/].f_38.f_27, 3)) && !func_16()) && !unk_0xF1EC2C71FD1371B8()) && !func_15(0)) && !func_14()) && unk_0xF01464D7AF0B7347(0, 225))
			{
				func_12(&Local_47);
			}
		}
...
bool func_81(var uParam0, int iParam1)
{
	...
	if (func_84(unk_0x9E2D6C50374FCFA9()) || unk_0xE2D0C323A1AE5D85(iLocal_484, 0))
	{
		return 0;
	}
	Var0 = { uParam0->f_1 };
