...
{
	func_19(&Local_47);
	if (Global_1852974 == unk_0x9E2D6C50374FCFA9() && !BitTest(Global_1890190[unk_0xA52C4F51ECAB7E02() /*105*/].f_38.f_27, 5))
	{
		...
		if (func_18(&Local_47, 0, 0))
		{
			...
			if ((((((iLocal_484 == 0 && !BitTest(Global_1890190[unk_0xA52C4F51ECAB7E02() /*105*/].f_38.f_27, 3)) && !func_16()) && !unk_0xF1EC2C71FD1371B8()) && !func_15(0)) && !func_14()) && unk_0xF01464D7AF0B7347(0, 225))
			{
				func_12(&Local_47);
			}
		}
	...
	iLocal_484 = 0;
	if (BitTest(Global_1890190[unk_0xA52C4F51ECAB7E02() /*105*/].f_38.f_27, 3))
	{
...
int func_75()
{
	if (Global_1852974 != func_65())
	{
		if (unk_0x7B0A672B0283F03E("base_heist_seats", Global_1852974, 1, 0))
		{
			return 0;
		}
