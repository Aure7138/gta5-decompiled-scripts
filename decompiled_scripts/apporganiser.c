...
void func_4(int iParam0, bool bParam1)
{
	...
	{
		iVar4 = iVar3;
		iVar3 = Global_97072[iVar0 /*25*/][iVar1];
		if (!iVar3 == iVar4)
		{
			if (!iVar3 == 0)
			{
		...
		if (iVar0 == Global_97071 && iVar1 == Global_97070)
		{
			bVar2 = false;
		}
	}
	Global_97068 = Global_97067;
}
...
void func_8()
{
	...
	if (!Global_97066)
	{
		Global_97250 = unk_0x771485043FDC55DE();
		Global_97249 = unk_0xD52BD97E61483713();
		Global_97248 = unk_0x09FC827691DACE59();
		Global_97066 = 1;
		Global_97071 = unk_0x4BFEE961F7BC72B6();
		Global_97070 = unk_0x09FC827691DACE59();
		func_12();
		return;
	}
	...
	if (iVar11 > 0)
	{
		...
		if (iVar11 > 7)
		{
			...
			while (iVar8 < 7)
			{
				...
				while (iVar9 < 24)
				{
					if (!Global_97072[iVar6 /*25*/][iVar7] == 0)
					{
						Global_97067++;
						Global_97069 = (Global_97069 - 1);
					}
					Global_97072[iVar6 /*25*/][iVar7] = 0;
					iVar9++;
				}
				iVar8++;
			}
