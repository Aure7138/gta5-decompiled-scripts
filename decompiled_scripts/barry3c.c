...
void __EntryFunction__()
{
	...
	if (unk_0x1F2158D615BC4B25(Local_81.f_35[0]))
	{
		if (!unk_0x0B6E83A9A7ED3EBA(Local_81.f_35[0]))
		{
			unk_0x9CB904BE3666FEDF(Local_81.f_35[0], 1, 0);
			func_436(&(Local_159.f_4), &(Local_81.f_35[0]));
			unk_0xA09672E91FA74DCA(Local_159.f_4, 1);
			func_435(Local_159.f_4, 0);
		}
	}
	func_434(&uLocal_172, &(Local_81.f_41[0]));
	func_425();
	if (unk_0x1F2158D615BC4B25(Local_81.f_35[1]))
	{
	...
	{
		if (func_391(unk_0x77F050A399DB77ED()))
		{
			unk_0x2DA164E80FDEE7F2(unk_0x77F050A399DB77ED(), 113.9f);
	...
	while (true)
	{
		unk_0x185B194BB229460F("SF_GRTD", 0);
...
void func_1()
{
	...
	{
		case 0:
			if (func_16(3) && (!func_15() || unk_0x824EA95BCC498CB4(203) == 0))
			{
				func_12(3);
			}
			func_11(5, 0);
		...
		case 1:
			if (unk_0xCA55F1A0D9ADE3AD(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/], Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 0, 1, 0))
			{
				iLocal_157 = 2;
			}
			else
...
int func_2()
{
	if (func_391(iLocal_188) && func_391(Local_159.f_4))
	{
		if (func_3())
		{
			if (unk_0xDC7078A48CFB0178(iLocal_188) && unk_0x540DEF730009CA9B(iLocal_188, Local_159.f_4))
			{
				bLocal_180 = true;
				return 1;
			}
		}
		else if (unk_0xFF8B60AD533C7DBD(iLocal_188, Local_159.f_4))
		{
			bLocal_180 = true;
			return 1;
		}
...
int func_3()
{
	...
	iVar0 = unk_0xDF1398076E26B0E4(iLocal_188);
...
int func_4()
{
	...
	if (unk_0x1F2158D615BC4B25(iLocal_188) && unk_0xE5FADE1166052251(unk_0x77F050A399DB77ED(), iLocal_188, 0))
	{
		return 1;
	}
	else if (unk_0xB42592B9FFEB5EDE(unk_0x77F050A399DB77ED(), 0))
	{
		...
		if (func_391(iVar0))
		{
			...
			{
				bVar2 = false;
				if (unk_0x1F2158D615BC4B25(iLocal_188))
				{
					if (iLocal_168)
					{
						unk_0xF290DF09A88A384C(iLocal_188);
						iLocal_168 = 0;
					}
					unk_0xB84D4C251623B60C(&iLocal_188);
				}
				iLocal_250 = 0;
				while (iLocal_250 <= 7)
				{
					if (func_391(Local_191[iLocal_250 /*7*/].f_4) && unk_0xE5FADE1166052251(unk_0x77F050A399DB77ED(), Local_191[iLocal_250 /*7*/].f_4, 0))
					{
						bVar2 = true;
				...
				unk_0x2AB597CDC87E0949(iLocal_188);
				iLocal_168 = 1;
				unk_0x9CB904BE3666FEDF(iLocal_188, 0, 0);
				iLocal_438 = 0;
				return 1;
			}
		}
...
void func_5(bool bParam0)
{
	...
	else
	{
		...
		while (iLocal_250 <= 7)
		{
			if (unk_0x1F2158D615BC4B25(Local_191[iLocal_250 /*7*/].f_4))
			{
				if (!func_9(unk_0x77F050A399DB77ED(), Local_191[iLocal_250 /*7*/], 175f) && func_8(unk_0x77F050A399DB77ED(), Local_191[iLocal_250 /*7*/].f_4, 1) > 175f)
				{
					func_6(&(Local_191[iLocal_250 /*7*/].f_4));
				}
			}
			else if (!Local_191[iLocal_250 /*7*/].f_6 && func_9(unk_0x77F050A399DB77ED(), Local_191[iLocal_250 /*7*/], 100f))
			{
				Local_191[iLocal_250 /*7*/].f_4 = unk_0x2EEA15C0C12C8CDE(joaat("towtruck"), Local_191[iLocal_250 /*7*/], Local_191[iLocal_250 /*7*/].f_3, 1, 1);
				if (iLocal_250 == 6)
				{
					unk_0xEDB159E56B64D182(Local_191[iLocal_250 /*7*/].f_4, 39, 43);
				}
				else
				{
					unk_0x1FC7DFD5477816B3(Local_191[iLocal_250 /*7*/].f_4, 0);
				}
				unk_0xC1D3820702043A43(Local_191[iLocal_250 /*7*/].f_4);
				unk_0x9CB904BE3666FEDF(Local_191[iLocal_250 /*7*/].f_4, 0, 0);
				unk_0xD1CF9849336C4ED5(Local_191[iLocal_250 /*7*/].f_4, 1);
			}
			iLocal_250++;
		}
	}
...
void func_17()
{
	if (!iLocal_428)
	{
		if (unk_0xE5FADE1166052251(unk_0x77F050A399DB77ED(), Local_159.f_4, 0))
		{
			iLocal_428 = 1;
			bLocal_427 = false;
			iLocal_424 = 0;
		...
		else if (unk_0xE5FADE1166052251(unk_0x77F050A399DB77ED(), Local_159.f_4, 1))
		{
			func_18();
		}
	}
	else
	{
		...
		{
			if (!bLocal_427 && unk_0x09097C4EB51A520B(0, 75))
			{
				bLocal_427 = true;
			}
			switch (iLocal_424)
			{
				case 0:
					...
					{
						unk_0x6E2E777C1AD81C36(sLocal_429);
						if (unk_0x5F4EA7D1E9029E5C("BARRY3C_IGNITION_FAIL", 0) && unk_0x5263DE3D9A17A86F(sLocal_429))
						{
							if (unk_0x07A8845F7F106A38(Local_159.f_4, -1) == unk_0x77F050A399DB77ED())
							{
								iLocal_424 = 1;
							}
						}
				...
				case 1:
					...
					else if (unk_0x09097C4EB51A520B(0, 71))
					{
						iLocal_424 = 2;
					}
					break;
				...
				case 2:
					unk_0x2A6B9F9E71C479CF(&uLocal_430);
					unk_0x642DDF74A8A2B3BB(0, sLocal_429, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
					unk_0x642DDF74A8A2B3BB(0, sLocal_429, "franklinfailingtostartcar_loop", 8f, -8f, 1500, 9, 0, 0, 0, 0);
					unk_0x642DDF74A8A2B3BB(0, sLocal_429, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
					unk_0x44642CB08FA1637E(uLocal_430);
					unk_0xE2CB8488CFA42209(unk_0x77F050A399DB77ED());
					unk_0xB8A8FA4B28E9F423(unk_0x77F050A399DB77ED(), uLocal_430);
					unk_0xAAD288E877AC833D(&uLocal_430);
					iLocal_421 = unk_0x3EAC9995EC220C5A() + 2000;
					iLocal_424 = 3;
					break;
				
				case 3:
					if (unk_0x3EAC9995EC220C5A() > iLocal_421)
					{
						unk_0x44F52B5BE61F39DD(uLocal_426, "IGNITION_FAIL", Local_159.f_4, "BARRY_03_SOUNDSET", 0, 0);
						unk_0xDB8724F8CA3DA851(uLocal_426, "HOLD TIME", 1.5f);
						iLocal_421 = unk_0x3EAC9995EC220C5A() + 2400;
						iLocal_424 = 4;
					}
					break;
				...
				case 7:
					if (unk_0x3EAC9995EC220C5A() > iLocal_421 && !unk_0x7DB98D7C4F2882FD(unk_0x77F050A399DB77ED(), 2))
					{
						unk_0xE2CB8488CFA42209(unk_0x77F050A399DB77ED());
						unk_0x365CA2781A1728CB(unk_0x77F050A399DB77ED(), Local_159.f_4, 0);
						unk_0xC5FC9A0E5FD51B1A(unk_0x8ACD527A7E574590(), 1, 0);
					}
					break;
				}
	...
	switch (iLocal_157)
	{
		case 0:
			...
			if (func_391(iLocal_188))
			{
				...
				unk_0x49AFDB1662AE2A92(iLocal_158, 1);
				if (bLocal_180)
				{
					func_12(7);
				}
				if ((!func_15() && iLocal_438) && !unk_0xE721293454745300(0, 74))
				{
					iLocal_431 = 0;
				}
				iLocal_157 = 1;
		...
		case 1:
			...
			else if (unk_0xCA55F1A0D9ADE3AD(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/], Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 0, 0, 0) && !unk_0x314654A7E186B6B2(Local_159.f_4))
			{
				Var0 = { unk_0xAF99169F0F5AE41D(Local_159.f_4, 1) };
				if (Var0.f_2 < 6.7f)
				{
					iLocal_156 = 12;
					iLocal_157 = 0;
...
void func_29()
{
	...
	if (unk_0x1F2158D615BC4B25(unk_0x77F050A399DB77ED()))
	{
		if (func_32(Global_99250.f_1754.f_539.f_3549) != unk_0xDF1398076E26B0E4(unk_0x77F050A399DB77ED()))
		{
			...
			if (func_30(iVar0) && (!func_33(14) || Global_98202))
			{
	...
	switch (iLocal_157)
	{
		case 0:
			...
			if (func_391(iLocal_188))
			{
				...
				unk_0x49AFDB1662AE2A92(iLocal_158, 1);
				if (unk_0x824EA95BCC498CB4(203) == 0 || !func_15())
				{
					if (func_3())
					{
						func_12(8);
		...
		case 2:
			...
			if (func_4())
			{
				if (func_2())
				{
					...
					else if (unk_0xCA55F1A0D9ADE3AD(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/], Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 0, 1, 0))
					{
						iLocal_156 = 6;
					}
					else
...
void func_43()
{
	...
	switch (iLocal_157)
	{
		...
		case 2:
			unk_0xA1E3A2CCF985EE86();
			if (!unk_0xE5FADE1166052251(unk_0x77F050A399DB77ED(), iLocal_188, 0))
			{
				iLocal_156 = 8;
			}
			else if (!unk_0xFF8B60AD533C7DBD(iLocal_188, Local_159.f_4))
...
{
	unk_0xF497FB718B4C0AC3(Local_458[iParam0 /*3*/].f_2);
}
...
void func_45()
{
	...
	switch (iLocal_157)
	{
		case 0:
			func_41(&iLocal_158);
			if (func_16(5) && (!func_15() || unk_0x824EA95BCC498CB4(203) == 0))
			{
				func_12(5);
			}
			iLocal_157 = 1;
		...
		case 1:
			if (unk_0xCA55F1A0D9ADE3AD(Local_159.f_4, Local_439[1 /*7*/][0 /*3*/], Local_439[1 /*7*/][1 /*3*/], fLocal_454[1], 0, 1, 0))
			{
				if (!func_241(unk_0x77F050A399DB77ED(), Local_159.f_4, 150f) && !func_15())
				{
					iLocal_157 = 2;
				}
...
void func_47(int iParam0, bool bParam1)
{
	...
	{
		func_207(&(Global_98337[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (unk_0x6DF20EAB8093DF19(unk_0x8ACD527A7E574590()))
...
int func_75(int iParam0, int iParam1, int iParam2)
{
	...
	Global_69178[1 /*14*/] = { func_125(iVar0, iParam1, iParam2) };
	...
	else
	{
		...
		Global_69178[1 /*14*/] = { func_125(iVar0, iParam1, uVar30[iParam1]) };
		if (unk_0xE41B65EDA3260A72(iParam0, func_117(iParam1)) > 0 && unk_0x6F812DB834EA1E9B(iParam0, func_117(iParam1), Global_69178[1 /*14*/].f_3) > 0)
		{
			unk_0x5F2AACB0122E1554(iParam0, func_117(iParam1), Global_69178[1 /*14*/].f_3, Global_69178[1 /*14*/].f_4, 0);
		}
	}
...
int func_76(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_189(iParam0, Global_99250.f_1754.f_539[iVar0 /*65*/].f_64, Global_99250.f_1754.f_539[iVar0 /*65*/].f_63))
		{
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	...
	if (iParam5 == 0)
	{
		Global_69178[1 /*14*/] = { func_125(iVar10, iParam1, iParam2) };
		if (!func_115(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_69178[1 /*14*/] = { func_125(iVar10, iVar0, uVar11[iVar0]) };
				if (unk_0xB56FEBC510E7E9DE(Global_69178[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_69178[1 /*14*/] = { func_125(iVar10, 14, uVar27[iVar1]) };
							func_94(iParam0, Global_69178[1 /*14*/].f_12, Global_69178[1 /*14*/].f_3, Global_69178[1 /*14*/].f_4);
							func_108(14);
							if (Global_69177 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							unk_0x5F2AACB0122E1554(iParam0, func_117(iVar0), Global_69178[1 /*14*/].f_3, Global_69178[1 /*14*/].f_4, unk_0x1B1CA05B66B2441C(iParam0, func_117(iVar0)));
						}
						else
						{
							unk_0x5F2AACB0122E1554(iParam0, func_117(iVar0), Global_69178[1 /*14*/].f_3, Global_69178[1 /*14*/].f_4, iParam4);
						}
						func_108(iVar0);
						if (Global_69177 == 1)
						{
			...
			{
				Global_69178[1 /*14*/] = { func_125(iVar10, iVar0, func_84(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_69178[1 /*14*/] = { func_125(iVar10, 14, uVar67[iVar1]) };
			func_94(iParam0, Global_69178[1 /*14*/].f_12, Global_69178[1 /*14*/].f_3, Global_69178[1 /*14*/].f_4);
			func_108(14);
			if (Global_69177 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			unk_0x5F2AACB0122E1554(iParam0, func_117(iParam1), Global_69178[1 /*14*/].f_3, Global_69178[1 /*14*/].f_4, unk_0x1B1CA05B66B2441C(iParam0, func_117(iParam1)));
		}
		else
		{
			unk_0x5F2AACB0122E1554(iParam0, func_117(iParam1), Global_69178[1 /*14*/].f_3, Global_69178[1 /*14*/].f_4, iParam4);
		}
		if (Global_69177 == 1)
		{
			iVar2 = 0;
...
{
	Global_69178[1 /*14*/] = { func_125(iParam0, iParam1, iParam2) };
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (unk_0x99A214601817F926(func_96(iParam0, iParam2, 14, 3), joaat("HAT"), 1) || unk_0x99A214601817F926(func_96(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (unk_0x99A214601817F926(func_96(iParam0, iParam2, 1, 3), joaat("HAT"), 0) || unk_0x99A214601817F926(func_96(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (unk_0x99A214601817F926(func_96(iParam0, iParam2, 14, 4), joaat("HAT"), 1) || unk_0x99A214601817F926(func_96(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (unk_0x99A214601817F926(func_96(iParam0, iParam2, 1, 4), joaat("HAT"), 0) || unk_0x99A214601817F926(func_96(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = unk_0x95CB63A3CE2E9535(iParam3, 6, -1, 0, -1, func_117(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return unk_0x99A214601817F926(func_96(iParam0, iParam2, 14, 3), joaat("GLASSES"), 1);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return unk_0x99A214601817F926(func_96(iParam0, iParam2, 14, 4), joaat("GLASSES"), 1);
				}
			}
			break;
	}
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_104(unk_0xDF1398076E26B0E4(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_104(unk_0xDF1398076E26B0E4(iParam0), iVar1, 14, 4);
		}
	}
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = unk_0x95CB63A3CE2E9535(iParam3, 6, -1, 0, -1, func_117(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_108(int iParam0)
{
	...
	{
		func_114(iParam0, Global_69178[1 /*14*/].f_5, Global_69178[1 /*14*/].f_2, 2, Global_69178[1 /*14*/].f_1, 1, 0);
	}
	if (unk_0xB56FEBC510E7E9DE(Global_69178[1 /*14*/].f_6, 1) && unk_0xB56FEBC510E7E9DE(Global_69178[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = Global_2466327[iParam0 /*5*/][func_111(iParam2)];
	if (iVar0 != 0)
	{
...
int func_112(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2466327[iParam0 /*5*/][func_111(iParam1)];
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_189(iParam0, Global_99250.f_1754.f_539[iVar0 /*65*/].f_61, Global_99250.f_1754.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_124(&Var1, -99, -99, Global_99250.f_1754.f_539.f_196[0], Global_99250.f_1754.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_124(&Var1, -99, -99, Global_99250.f_1754.f_539.f_196[1], Global_99250.f_1754.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_124(&Var1, -99, -99, Global_99250.f_1754.f_539.f_196[2], Global_99250.f_1754.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_127(int iParam0)
{
	...
	func_128(&(Global_69178[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_112(func_131(iParam1, uParam0->f_2), Global_69176, 0);
			if (unk_0xB56FEBC510E7E9DE(iVar0, uParam0->f_1))
			{
				unk_0x573691DB812DC8AA(&(uParam0->f_6), 1);
			}
			iVar0 = func_112(func_130(iParam1, uParam0->f_2), Global_69176, 0);
			if (unk_0xB56FEBC510E7E9DE(iVar0, uParam0->f_1))
			{
				unk_0x573691DB812DC8AA(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_112(iVar1, Global_69176, 0);
				if (!unk_0xB56FEBC510E7E9DE(iVar0, uParam0->f_1))
				{
					unk_0x573691DB812DC8AA(&(uParam0->f_6), 4);
				}
...
void func_134(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!unk_0xD5451DF6AA0E4BDB(Var2.f_0))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					func_128(&(Global_69178[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_128(&(Global_69178[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!unk_0xD5451DF6AA0E4BDB(Var20.f_0))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_128(&(Global_69178[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, unk_0x99A214601817F926(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = unk_0x95CB63A3CE2E9535(iVar1, 6, -1, 0, -1, func_117(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!unk_0xD5451DF6AA0E4BDB(Var41.f_0))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_128(&(Global_69178[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, unk_0x99A214601817F926(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
int func_189(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_189(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_189(iParam0, 14, uVar21[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_69178[2 /*14*/] = { func_125(iVar0, 14, iVar4) };
									if (Global_69178[2 /*14*/].f_12 == iVar3)
									{
										if (func_189(iParam0, 14, iVar4))
										{
											if (!func_82(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_69178[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_69178[2 /*14*/] = { func_125(iVar0, iVar2, iVar1) };
						if (!func_82(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_69178[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_69178[1 /*14*/].f_3 == unk_0xB2833E96F49D3CDC(iParam0, func_117(iParam1)) && Global_69178[1 /*14*/].f_4 == unk_0xD01703B8B3FC785F(iParam0, func_117(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_196(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_197(&uVar32, Var0.f_3, Global_91143, iParam1, iParam2);
	}
}
...
void func_202()
{
	...
	{
		func_29();
		unk_0xB5338219E528B84F(func_203(Global_99250.f_1754.f_539.f_3549));
	}
	else
	{
...
{
	func_212(iParam0, 1);
	Global_99250.f_17192[iParam0 /*6*/].f_3 = func_211();
...
int func_237()
{
	return func_238(unk_0x664B47C58CE8A0A4(), 0);
}
...
void func_240(bool bParam0)
{
	if (bParam0)
	{
		unk_0x9CB904BE3666FEDF(Local_159.f_4, 0, 0);
		unk_0x9F7AB2EE21BE4C36(Local_159.f_4, 1);
	}
	else
	{
		unk_0x9CB904BE3666FEDF(Local_159.f_4, 1, 0);
		unk_0x9F7AB2EE21BE4C36(Local_159.f_4, 0);
	}
}
...
void func_242()
{
	if (unk_0x3EAC9995EC220C5A() > iLocal_422)
	{
...
void func_243(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_302(unk_0x664B47C58CE8A0A4(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_238(unk_0x664B47C58CE8A0A4(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_299(&(Global_91106.f_3));
				if (iVar10 > -1)
				{
...
{
	func_245(&Global_95315, unk_0x664B47C58CE8A0A4(), iParam0, uParam1, iParam3, iParam2);
}
	...
	while (iVar0 < 9)
	{
		if (unk_0x1F2158D615BC4B25(Global_88770[iVar0]))
		{
			if (Global_88770[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0xDF1398076E26B0E4(iParam0) == func_254(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0x968EA16107097324(iParam0, 0))
	{
		...
		*uParam1 = unk_0x21C7BB3FC7BDA875(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x573691DB812DC8AA(&(uParam1->f_77), func_257(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_262(int iParam0, var uParam1, int iParam2)
{
	...
	if (!unk_0x1E80C02AC16B6622(iParam0))
	{
		...
		else if (unk_0x4C779B19E6DDCDA2() && unk_0xDF1398076E26B0E4(iParam0) == unk_0xDF1398076E26B0E4(unk_0x77F050A399DB77ED()))
		{
			if (func_263(161, -1))
			{
				uParam1->f_59 = func_112(2040, Global_69176, 0);
			}
			else
			{
				uParam1->f_59 = func_112(742, Global_69176, 0);
			}
			uParam1->f_60 = func_112(743, Global_69176, 0);
			uParam1->f_61 = func_112(744, Global_69176, 0);
		}
...
int func_263(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2486179[iParam0 /*5*/][func_111(iParam1)];
...
void func_267(int iParam0, bool bParam1)
{
	...
	iVar0 = func_31(iParam0);
	if (func_30(iVar0) && !unk_0x1E80C02AC16B6622(iParam0))
	{
		if (iParam0 == unk_0x77F050A399DB77ED())
		{
...
void func_273(int iParam0)
{
	...
	if (func_30(iVar0) && !unk_0x1E80C02AC16B6622(uParam0))
	{
...
int func_278(var uParam0)
{
	if (!unk_0x0B6E83A9A7ED3EBA(unk_0x77F050A399DB77ED()) && !unk_0x1E80C02AC16B6622(unk_0x77F050A399DB77ED()))
	{
		if (func_287())
		{
			*uParam0 = func_283(unk_0xAF99169F0F5AE41D(unk_0x77F050A399DB77ED(), 0), 5, -1, 0, 1, -1);
...
int func_280(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x4C779B19E6DDCDA2())
	{
		if (func_51() == 0)
		{
			return unk_0xB56FEBC510E7E9DE(func_112(func_281(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_283(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_286(iVar0))
		{
			...
			{
				fVar1 = unk_0xA2490B3CE6382FBB(Param0, func_284(iVar0, 0), 1);
...
var func_288()
{
	...
	func_298(&uVar0, unk_0x624CC88A8815545E());
	func_297(&uVar0, unk_0xD3D98375D5CA69E4());
	func_296(&uVar0, unk_0x5C5157A539753532());
	func_291(&uVar0, unk_0xCB12BC5A618B995B());
	func_290(&uVar0, unk_0x9746D90F14C930B9());
	func_289(&uVar0, unk_0xD45B57A596913560());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_294(unk_0xB56FEBC510E7E9DE(iParam0, 31), -1, 1)) + 2011;
}
...
int func_300(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_301(Global_99250.f_7703.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_301(Global_99250.f_7703.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_301(Global_99250.f_7703.f_99.f_205[11]);
			break;
		
		case 90:
			return func_301(Global_99250.f_7703.f_99.f_205[7]);
			break;
		
		case 93:
			return func_301(Global_99250.f_7703.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_306()
{
	...
	switch (iLocal_157)
	{
		...
		case 1:
			...
			else if (!unk_0xE5FADE1166052251(unk_0x77F050A399DB77ED(), iLocal_188, 0))
			{
				iLocal_157 = 2;
			}
			else if (func_2())
			{
				if (unk_0xCA55F1A0D9ADE3AD(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/], Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 0, 1, 0))
				{
					...
					if (!iLocal_420)
					{
						if ((unk_0x3EAC9995EC220C5A() - iLocal_423) > 1000)
						{
				...
				else if (!unk_0xCA55F1A0D9ADE3AD(Local_159.f_4, Local_439[1 /*7*/][0 /*3*/], Local_439[1 /*7*/][1 /*3*/], fLocal_454[1], 0, 1, 0))
				{
					iLocal_156 = 10;
					iLocal_157 = 0;
				}
		...
		case 2:
			...
			else if (!unk_0xFF8B60AD533C7DBD(iLocal_188, Local_159.f_4))
			{
				if (unk_0xCA55F1A0D9ADE3AD(Local_159.f_4, Local_439[1 /*7*/][0 /*3*/], Local_439[1 /*7*/][1 /*3*/], fLocal_454[1], 0, 1, 0))
				{
					...
					{
						iLocal_422 = unk_0x3EAC9995EC220C5A() + 5000;
						iLocal_156 = 12;
					}
				}
				else
...
void func_310()
{
	...
	switch (iLocal_157)
	{
		case 0:
			...
			if (unk_0xAEE8018B8C539989(unk_0x8ACD527A7E574590()) < 1)
			{
				if (!func_15() || unk_0x824EA95BCC498CB4(203) == 0)
				{
					func_12(1);
					iLocal_486 = 0;
				}
		...
		case 1:
			...
			else if (!func_2())
			{
				if (func_3())
				{
					if (unk_0xCA55F1A0D9ADE3AD(Local_159.f_4, Local_439[1 /*7*/][0 /*3*/], Local_439[1 /*7*/][1 /*3*/], fLocal_454[1], 0, 0, 0))
					{
						if (!unk_0x314654A7E186B6B2(Local_159.f_4))
						{
							Var0 = { unk_0xAF99169F0F5AE41D(Local_159.f_4, 1) };
							if (Var0.f_2 < 6.7f)
							{
			...
			else if (unk_0xCA55F1A0D9ADE3AD(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/], Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 1, 1, 0))
			{
				iLocal_157 = 2;
			}
			else if (iLocal_486)
		...
		case 2:
			...
			{
				if (func_3() && unk_0xCA55F1A0D9ADE3AD(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/], Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 0, 0, 0))
				{
					if (!unk_0x314654A7E186B6B2(Local_159.f_4))
					{
						Var0 = { unk_0xAF99169F0F5AE41D(Local_159.f_4, 1) };
...
void func_312()
{
	...
	switch (iLocal_157)
	{
		case 0:
			...
			if (iLocal_248)
			{
				...
				else
				{
					...
					if (!unk_0xC3B073777B46C61A(iLocal_158))
					{
						iLocal_158 = func_40(Local_159.f_4, 1, 5);
					}
					iLocal_157 = 1;
		...
		case 1:
			if (((!iLocal_419 && unk_0xCA55F1A0D9ADE3AD(unk_0x77F050A399DB77ED(), -458.11f, -1725.3f, 17.67f, -456.71f, -1701.81f, 22f, 17.5f, 0, 1, 0)) && !func_2()) && !func_3())
			{
				func_309("B3CTTHB", -1);
				iLocal_419 = 1;
			}
...
void func_315()
{
	switch (iLocal_157)
	{
		case 0:
			...
			{
				func_17();
				if (!iLocal_416 && (unk_0x3EAC9995EC220C5A() - iLocal_422) > 8000)
				{
				...
				else if (!iLocal_417 && (unk_0x3EAC9995EC220C5A() - iLocal_422) > 120000)
				{
					if (!func_317())
					{
				...
				else if (!iLocal_418 && (unk_0x3EAC9995EC220C5A() - iLocal_422) > 160000)
				{
		...
		case 1:
			if (iLocal_248)
			{
				...
				else if (unk_0xCA55F1A0D9ADE3AD(unk_0x77F050A399DB77ED(), -417.58f, -1723.81f, 15.42f, -473.6f, -1705.96f, 26.95f, 49f, 0, 1, 0))
				{
					iLocal_157 = 2;
				}
				else if (func_2())
...
int func_317()
{
	...
	while (iLocal_250 <= 7)
	{
		if (!Local_191[iLocal_250 /*7*/].f_6 && func_9(unk_0x77F050A399DB77ED(), Local_191[iLocal_250 /*7*/], 8f))
		{
			return 1;
		}
		iLocal_250++;
...
void func_319(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (unk_0x1F2158D615BC4B25(Global_92910.f_4))
	{
		...
		{
			if (func_343(24) != Global_92910.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_340(unk_0xAF99169F0F5AE41D(Global_92910.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_320(Global_92910.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_321(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_335(&(Global_68186.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (unk_0x1F2158D615BC4B25(iParam1))
	{
		if (unk_0x968EA16107097324(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_99250.f_18735.f_4801 = func_288();
			}
...
void func_322(int iParam0, int iParam1)
{
	...
	func_256(iParam0, &(Global_99250.f_18735.f_5510));
}

int func_323(int iParam0)
{
	if ((((((((((!unk_0x1F2158D615BC4B25(iParam0) || !unk_0x968EA16107097324(iParam0, 0)) || func_260(iParam0, 0, 0)) || func_260(iParam0, 1, 0)) || func_260(iParam0, 2, 0)) || func_252(iParam0) != 145) || func_334(iParam0)) || func_333(iParam0)) || func_332(iParam0)) || func_331(iParam0)) || !func_324(unk_0xDF1398076E26B0E4(iParam0)))
	{
		if (func_333(iParam0))
		{
		}
...
void func_336(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6)
{
	if (func_335(&(Global_68186.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_338(iParam0);
			func_337(uParam1, &(Global_99250.f_18735.f_69[Global_68186.f_555[0 /*21*/].f_14 /*78*/]));
	...
	switch (iLocal_157)
	{
		case 0:
			...
			if (func_4())
			{
				...
				func_314(3);
				func_314(4);
				unk_0xC3B35B74D44539B6(Local_159.f_4, 0);
				unk_0xE11D7E04CD92C874(Local_159.f_4, 0);
				if (func_2())
				{
					iLocal_157 = 0;
					iLocal_156 = 5;
		...
		case 1:
			if (((!bLocal_427 && iLocal_424 != 0) && (iLocal_425 > 0 && iLocal_425 < 4)) && unk_0x09097C4EB51A520B(0, 75))
			{
				bLocal_427 = true;
			}
			switch (iLocal_424)
			{
				case 0:
					if (unk_0x5F4EA7D1E9029E5C("BARRY3C_IGNITION_FAIL", 0) && unk_0x5263DE3D9A17A86F(sLocal_429))
					{
						if (unk_0x07A8845F7F106A38(Local_159.f_4, -1) == unk_0x77F050A399DB77ED())
						{
							if (!iLocal_169)
							{
								unk_0x2AB597CDC87E0949(Local_159.f_4);
								iLocal_169 = 1;
							}
							iLocal_425 = 0;
							uLocal_426 = unk_0xBE8BBC6340F2B731();
							iLocal_424 = 2;
						}
					}
					break;
				...
				case 2:
					if (unk_0x07A8845F7F106A38(Local_159.f_4, -1) == unk_0x77F050A399DB77ED() && unk_0xBF0744BF24FE8D11(unk_0x77F050A399DB77ED(), Local_159.f_4))
					{
						if (iLocal_425 == 3)
						{
							unk_0x2A6B9F9E71C479CF(&uLocal_430);
							unk_0x642DDF74A8A2B3BB(0, sLocal_429, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
							unk_0x642DDF74A8A2B3BB(0, sLocal_429, "franklinfailingtostartcar_loop", 8f, -8f, 8000, 9, 0, 0, 0, 0);
							unk_0x642DDF74A8A2B3BB(0, sLocal_429, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
							unk_0x44642CB08FA1637E(uLocal_430);
							unk_0xB8A8FA4B28E9F423(unk_0x77F050A399DB77ED(), uLocal_430);
							unk_0xAAD288E877AC833D(&uLocal_430);
						...
						else if (iLocal_425 == 2)
						{
							if (func_21(&uLocal_251, "BAR3CAU", "BAR3C_C1", 7, 0, 0, 0))
							{
								unk_0x2A6B9F9E71C479CF(&uLocal_430);
								unk_0x642DDF74A8A2B3BB(0, sLocal_429, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
								unk_0x642DDF74A8A2B3BB(0, sLocal_429, "franklinfailingtostartcar_loop", 8f, -8f, (1200 + iLocal_425 * 250), 9, 0, 0, 0, 0);
								unk_0x642DDF74A8A2B3BB(0, sLocal_429, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
								unk_0x44642CB08FA1637E(uLocal_430);
								unk_0xB8A8FA4B28E9F423(unk_0x77F050A399DB77ED(), uLocal_430);
								unk_0xAAD288E877AC833D(&uLocal_430);
				...
				case 3:
					if (unk_0x3EAC9995EC220C5A() > iLocal_421)
					{
						...
						{
							unk_0x44F52B5BE61F39DD(uLocal_426, "IGNITION_FAIL", Local_159.f_4, "BARRY_03_SOUNDSET", 0, 0);
							unk_0xDB8724F8CA3DA851(uLocal_426, "HOLD TIME", 3f);
							iLocal_421 = unk_0x3EAC9995EC220C5A() + 9100;
						}
						else
						{
							unk_0x44F52B5BE61F39DD(uLocal_426, "IGNITION_FAIL", Local_159.f_4, "BARRY_03_SOUNDSET", 0, 0);
							unk_0xDB8724F8CA3DA851(uLocal_426, "HOLD TIME", (unk_0xBBDA792448DB5A89((1200 + iLocal_425 * 250)) / 1000f));
							iLocal_421 = (unk_0x3EAC9995EC220C5A() + iLocal_425 * 250) + 1200 + 766;
						}
						iLocal_424 = 4;
					}
					break;
				...
				case 4:
					if (unk_0x3EAC9995EC220C5A() > iLocal_421)
					{
						...
						else
						{
							...
							if (iLocal_425 == 4)
							{
								unk_0x642DDF74A8A2B3BB(unk_0x77F050A399DB77ED(), sLocal_429, "franklinfailingtostartcar_slamwheel", 1000f, -8f, 3300, 0, 0, 0, 0, 0);
								iLocal_421 = unk_0x3EAC9995EC220C5A() + 330;
								iLocal_424 = 5;
							}
							else
							{
				...
				case 5:
					if (unk_0x3EAC9995EC220C5A() > iLocal_421)
					{
						unk_0xB5387DF587FF85F0(Local_159.f_4, 500, unk_0x39BD4614CF899227("NORMAL"), 0);
						iLocal_421 = unk_0x3EAC9995EC220C5A() + 2000;
						iLocal_424 = 8;
					}
					break;
				...
				case 6:
					if (unk_0xBF0744BF24FE8D11(unk_0x77F050A399DB77ED(), Local_159.f_4))
					{
						if (!func_15())
						{
							if (func_21(&uLocal_251, "BAR3CAU", "BAR3C_C2", 7, 0, 0, 0))
							{
								iLocal_421 = unk_0x3EAC9995EC220C5A();
								iLocal_424 = 7;
							}
						}
						else
		...
		case 2:
			if (!func_15() && (unk_0x3EAC9995EC220C5A() - iLocal_421) > 2500)
			{
				iLocal_157 = 0;
				iLocal_156 = 2;
			}
		...
		case 0:
			if (unk_0x77E40DD6F32BC674(0))
			{
				...
				else
				{
					...
					func_12(0);
					iLocal_157 = 1;
					unk_0x5F4EA7D1E9029E5C("BARRY3C_IGNITION_FAIL", 0);
				}
			}
			break;
...
void func_348(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		...
		case 4:
			if (!unk_0x1066B6347C40B301() && func_349(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
int func_354()
{
	...
	if (unk_0x1F2158D615BC4B25(Local_159.f_4))
	{
		if (unk_0x0B6E83A9A7ED3EBA(Local_159.f_4))
		{
		...
		{
			if (unk_0x184475778464D638(Local_159.f_4))
			{
				if (iLocal_166)
				{
					if ((unk_0x3EAC9995EC220C5A() - iLocal_170) > 7000)
					{
				...
				{
					iLocal_166 = 1;
					iLocal_170 = unk_0x3EAC9995EC220C5A();
				}
			}
			else
			{
	...
	if (unk_0x1F2158D615BC4B25(iLocal_188))
	{
		if (unk_0x0B6E83A9A7ED3EBA(iLocal_188) && iLocal_457 == 0)
		{
			if (func_3())
			{
		...
		{
			if (unk_0x184475778464D638(iLocal_188))
			{
				if (iLocal_167)
				{
...
void func_355()
{
	switch (iLocal_157)
	{
		case 0:
			func_41(&iLocal_158);
			if (unk_0x0AAC2160036975D9(sLocal_487))
			{
				sLocal_487 = "DEFAULT";
			}
			if (unk_0x35D1CAD6ADAB6491(sLocal_487, "DEFAULT"))
			{
				func_439(1);
			}
			else
		...
		case 1:
			if (func_371())
			{
				if ((func_391(Local_159.f_4) && func_391(iLocal_188)) && unk_0xD8EEAAAE9301A49D(Local_159.f_4, iLocal_188))
				{
					unk_0xEA8F6D695177222B(Local_159.f_4);
				}
				func_356();
				func_437();
			}
...
void func_356()
{
	...
	{
		unk_0xA09672E91FA74DCA(Local_159.f_4, 0);
	}
	func_10(&iLocal_188);
	...
	if (Global_69571 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x2CC731F9E664299E())
			{
				...
				Var4 = { func_376(Global_69572, Global_69574, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_388(0) || Global_69586) || Global_69575 == 1) || !unk_0x398F615441F52A47())
	{
		return 0;
	}
	switch (Global_69571)
	{
		...
		case 5:
			if ((unk_0x7B8549A4F94FA4C8() || func_387(0)) || func_386(1))
			{
			}
			else
			{
...
{
	return func_390(iParam0, Global_35700);
}
...
void func_396(struct<3> Param0, float fParam3, bool bParam4)
{
	...
	unk_0xC60576ADD1AECA45(iLocal_189);
	while (!unk_0x4A4B6FD54C499B7D(iLocal_189))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	iLocal_188 = unk_0x2EEA15C0C12C8CDE(iLocal_189, Param0, fParam3, 1, 1);
	unk_0xFB4F6722A032A0F0(iLocal_189);
	unk_0x1FC7DFD5477816B3(iLocal_188, iLocal_190);
	unk_0xC1D3820702043A43(iLocal_188);
	if (bParam4)
	{
		func_397(unk_0x77F050A399DB77ED(), iLocal_188, -1);
	}
	unk_0xC3B35B74D44539B6(iLocal_188, 0);
	unk_0xE11D7E04CD92C874(iLocal_188, 0);
	unk_0xD1CF9849336C4ED5(iLocal_188, 1);
	if (!unk_0x0B6E83A9A7ED3EBA(iLocal_188))
	{
		unk_0x2AB597CDC87E0949(iLocal_188);
		iLocal_168 = 1;
	}
...
void func_397(int iParam0, int iParam1, int iParam2)
{
	if (func_398(uParam0))
	{
		if (func_391(iParam1))
		{
			...
			{
				unk_0xB92C428B448B51A4(unk_0xEA18E45F1CE3F692(uParam0), 0);
			}
			else
			{
				unk_0xB92C428B448B51A4(uParam0, 0);
			}
			unk_0x213DEA03167527BC(uParam0, iParam1, iParam2);
		}
	}
}
...
{
	unk_0xC60576ADD1AECA45(Local_159.f_5);
	if (unk_0x1F2158D615BC4B25(Local_159.f_4))
	{
		if (iLocal_169)
		{
			unk_0xF290DF09A88A384C(Local_159.f_4);
			iLocal_169 = 0;
		}
	}
	while (!unk_0x4A4B6FD54C499B7D(Local_159.f_5))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	func_239(&uLocal_172);
	func_6(&(Local_159.f_4));
	Local_159.f_4 = unk_0x2EEA15C0C12C8CDE(Local_159.f_5, Param0, fParam3, 1, 1);
	unk_0xFB4F6722A032A0F0(Local_159.f_5);
	unk_0xC1D3820702043A43(Local_159.f_4);
	unk_0xC3B35B74D44539B6(Local_159.f_4, 0);
	unk_0xE11D7E04CD92C874(Local_159.f_4, 0);
	unk_0x1FC7DFD5477816B3(Local_159.f_4, 1);
	unk_0x85EBF053D80F635B(Local_159.f_4, 1);
	unk_0xD1CF9849336C4ED5(Local_159.f_4, 1);
	unk_0xA09672E91FA74DCA(Local_159.f_4, 1);
	if (!unk_0x0B6E83A9A7ED3EBA(Local_159.f_4))
	{
		unk_0x2AB597CDC87E0949(Local_159.f_4);
	...
	uLocal_172 = unk_0x4A498A71A7B2E7A5(iLocal_179, Param0 + Local_173, 1, 1, 0);
	unk_0xCA41E71A6AD186D8(uLocal_172, Local_159.f_4, 0, Local_173, Local_176, 0, 0, 0, 0, 2, 1);
}
...
void func_411(bool bParam0)
{
	...
	{
		iLocal_457 = 0;
		iLocal_422 = unk_0x3EAC9995EC220C5A() + 3000;
		iLocal_156 = 12;
	}
	iLocal_157 = 0;
	iLocal_250 = 0;
...
void func_412(bool bParam0)
{
	...
	else if (unk_0xE5FADE1166052251(unk_0x77F050A399DB77ED(), Local_159.f_4, 0))
	{
		unk_0x0B5F372F57E469AC(unk_0x77F050A399DB77ED(), Local_159, 1, 0, 0, 1);
	}
	func_401();
	func_400();
	func_41(&iLocal_158);
	...
	if (bParam0)
	{
		...
		{
			unk_0x6D2480B3F6A72BD6(iLocal_188, 0f);
		}
		while (!unk_0x77E40DD6F32BC674(0))
		{
			unk_0x4EDE34FBADD967A6(0);
...
void func_414(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_398(unk_0x77F050A399DB77ED()))
	{
...
void func_415(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (!unk_0x1E80C02AC16B6622(unk_0x77F050A399DB77ED()) && !func_416(unk_0x8ACD527A7E574590()))
		{
...
void func_422(bool bParam0)
{
	...
	else
	{
		...
		func_399(Local_159, Local_159.f_3);
		unk_0x213DEA03167527BC(unk_0x77F050A399DB77ED(), Local_159.f_4, -1);
	}
}
...
void func_425()
{
	...
	unk_0x790D9B26AC61AB91(-1188.409f, -1233.006f, 0f, -1165.782f, -1214.378f, 15f);
	unk_0xC8C54AFEF8609CEF("BARR3C", 0);
	Local_182 = { -1152.43f, -1238.824f, 5.9752f };
	uLocal_142 = func_433();
	uLocal_185[0] = unk_0x2277155D92E898D2(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
	uLocal_185[1] = unk_0x2277155D92E898D2(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
	...
	if (func_391(unk_0x77F050A399DB77ED()))
	{
		func_431(&uLocal_251, 1, unk_0x77F050A399DB77ED(), "FRANKLIN", 0, 1);
	}
	...
	func_426(49, 1, 0);
	iLocal_457 = 0;
	unk_0x790D9B26AC61AB91(-1132.88f, -1262.01f, 0f, -1102.43f, -1196.58f, 15f);
	func_367(1);
}
...
var func_433()
{
	return unk_0x2277155D92E898D2(-564f, -1758.1f, 16.5f, -419.31f, -1649f, 23f, 0, 1, 1, 1);
}
...
void func_437()
{
	...
	unk_0x4AAD01BBE039D160(1f);
	func_357(&Local_81, 1, 0, 0);
	unk_0x54575489AE798654(uLocal_142, 0);
	unk_0x54575489AE798654(uLocal_185[0], 0);
	unk_0x54575489AE798654(uLocal_185[1], 0);
...
void func_439(bool bParam0)
{
	...
	if (!func_453())
	{
		...
		{
			func_196(iVar0, 1, 0);
			func_440(unk_0x664B47C58CE8A0A4(), iVar0);
		}
		else
		{
			if (Global_98337[iVar0 /*10*/].f_9 == -1)
...
int func_441(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_444())
	{
		...
		{
			iVar33 = func_299(unk_0x664B47C58CE8A0A4());
			if (iVar33 > -1)
			{
...
int func_442()
{
	...
	iVar0 = func_302(&(Global_91106.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_444()
{
	...
	{
		if (func_299(&(Global_91106.f_3)) > -1)
		{
			return 1;
		}
	}
