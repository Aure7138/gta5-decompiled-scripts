...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (iLocal_59 > unk_0xE3903F59E2F22150())
			{
			...
			if (!func_93())
			{
				...
				unk_0x65F534DDBF48606F("RE_CGF", 0);
				switch (iLocal_46)
				{
					case 0:
						if (func_80())
					...
					case 1:
						func_78();
						if (!func_77() || unk_0x09287BFEE1D9F6EF(unk_0x95B959F18401C09A(), 0))
						{
							if ((!unk_0xBC2FC12AD0FBF72E(uLocal_68) && !unk_0xBC2FC12AD0FBF72E(iLocal_69[0])) && !unk_0xBC2FC12AD0FBF72E(iLocal_69[1]))
							{
								if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), 969.2191f, 3608.665f, 41.8758f, 100f, 80f, 20f, 0, 1, 0))
								{
									uLocal_60 = func_74(uLocal_68, 0, 145);
									unk_0xC51C58C963968740(uLocal_60, 9);
									uLocal_61[0] = func_74(iLocal_69[0], 1, 145);
									uLocal_61[1] = func_74(iLocal_69[1], 1, 145);
									unk_0x983D75D9630FD905(uLocal_60, 0);
									unk_0x983D75D9630FD905(uLocal_61[0], 0);
									unk_0x983D75D9630FD905(uLocal_61[1], 0);
									func_64(1);
								}
							}
						}
						else
						{
							...
							while (iVar0 < iLocal_69)
							{
								...
								{
									unk_0xECCD4FDA45197F97(iLocal_69[iVar0], unk_0x33CD235DF1E6A94E(), 150f, -1, 0, 0);
								}
								iVar0++;
							}
							if (!unk_0xBC2FC12AD0FBF72E(uLocal_68))
							{
								unk_0xECCD4FDA45197F97(uLocal_68, unk_0x33CD235DF1E6A94E(), 150f, -1, 0, 0);
							}
							func_63();
						}
						break;
			...
			else
			{
				...
				if (!unk_0xBC2FC12AD0FBF72E(uLocal_68))
				{
					if (unk_0x91BBD269506D61D2(uLocal_68, unk_0x33CD235DF1E6A94E(), 1))
					{
						unk_0xECCD4FDA45197F97(uLocal_68, unk_0x33CD235DF1E6A94E(), 150f, -1, 0, 0);
						func_63();
					}
					if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), uLocal_68, 150f, 150f, 50f, 0, 1, 0))
					{
						...
						switch (iLocal_47)
						{
							...
							case 1:
								if (iLocal_48 < 7 && !unk_0xBC2FC12AD0FBF72E(uLocal_68))
								{
									if (unk_0x910FF514D7BC5674(unk_0x33CD235DF1E6A94E(), uLocal_68, 90f))
									{
										if (unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), uLocal_68) || unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), uLocal_68))
										{
											func_58();
										}
									}
				...
				else
				{
					...
					if (((!unk_0xBC2FC12AD0FBF72E(iLocal_69[0]) && !unk_0xBC2FC12AD0FBF72E(iLocal_69[1])) && !unk_0xD62C4419A41F106A(iLocal_77[0], 0)) && !unk_0xD62C4419A41F106A(iLocal_77[1], 0))
					{
						func_63();
					}
					iVar1 = 0;
					...
					{
						if (!unk_0xBC2FC12AD0FBF72E(iLocal_69[iVar2]))
						{
							unk_0x277716E9E7CC0692(iLocal_69[iVar2], unk_0x33CD235DF1E6A94E(), 0, 16);
							unk_0x897EF720254BBEA3(iLocal_69[iVar2], 1);
							if (!unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_69[iVar2], 150f, 150f, 50f, 0, 1, 0))
							{
								func_63();
							}
							iVar1 = 1;
						}
						else if (unk_0xE38E3CF1625A4145(uLocal_61[iVar2]))
						{
							unk_0x1ABDB383C83A336A(&(uLocal_61[iVar2]));
						}
						iVar2++;
					}
					if (iVar1 == 0)
...
void func_1()
{
	...
	if (iLocal_53 && !iLocal_58)
	{
		...
		if (!unk_0xBC2FC12AD0FBF72E(uLocal_68))
		{
			unk_0xAD3D24C8070DA056(uLocal_68, 0);
			unk_0x4A852F02088ECC9D(uLocal_68, 0);
		}
		iVar0 = 0;
		while (iVar0 < iLocal_69)
		{
			if (unk_0xE38E3CF1625A4145(uLocal_61[iVar0]))
			{
				unk_0x1ABDB383C83A336A(&(uLocal_61[iVar0]));
			}
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_69[iVar0]) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
			{
				if (iVar0 < 2)
				{
					if (!unk_0xD62C4419A41F106A(iLocal_77[iVar0], 0))
					{
						unk_0x48B8A6610EAA0C89(iLocal_69[iVar0], iLocal_77[iVar0], unk_0x33CD235DF1E6A94E(), 8, 20f, 786469, 150f, 10f, 1);
						unk_0x897EF720254BBEA3(iLocal_69[iVar0], 1);
					}
					else
					{
						unk_0xECCD4FDA45197F97(iLocal_69[iVar0], unk_0x33CD235DF1E6A94E(), 200f, -1, 0, 0);
					}
				}
				else
				{
				...
				unk_0x4A852F02088ECC9D(iLocal_69[iVar0], 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_77)
		{
			if (!unk_0xD62C4419A41F106A(iLocal_77[iVar0], 0))
			{
				...
				if (unk_0x7C71681384076318("RE_COUNTRYSIDE_GANG_FIGHT_SCENE"))
				{
				}
			}
			iVar0++;
		}
		unk_0x7CED302277C0F3D3("RE_COUNTRYSIDE_GANG_FIGHT_SCENE");
		unk_0x4B06B5746CBEC99F(1f);
		unk_0x78713C03966ED44F(417.901f, 3578.002f, 31.176f, 1305.897f, 3604.306f, 40.1064f, 100.0625f, 1);
	...
	if (unk_0x16E00F066AFFEA0D(func_2(unk_0x95B959F18401C09A()), Local_50, 1) > 50f)
	{
		func_140();
	}
}
	...
	switch (iLocal_48)
	{
		case 0:
			if (unk_0xC9D9444186B5A374() > 2000)
			{
				...
				while (iVar0 < iLocal_69)
				{
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_69[iVar0]) && !unk_0xD62C4419A41F106A(iLocal_77[iVar0], 0))
					{
						if (!unk_0xE38E3CF1625A4145(uLocal_61[iVar0]))
						{
							uLocal_61[iVar0] = func_74(iLocal_69[iVar0], 1, 145);
							if (unk_0xF0D230FB550CD6EB(iLocal_69[iVar0], 0))
							{
								if (!bLocal_55)
								{
									unk_0x09294EA9B5694081(iLocal_69[iVar0], unk_0x33CD235DF1E6A94E(), 0, 0f, 0f, 0f, 150f, 100, 1, -753768974);
								}
								else
								{
									unk_0x99414FB2D30425C1(&uLocal_84);
									unk_0x277716E9E7CC0692(0, unk_0x33CD235DF1E6A94E(), 0, 16);
									unk_0xC734F59A13D39AEF(uLocal_84);
									unk_0x13A2D602CD10CBAC(iLocal_69[iVar0], uLocal_84);
									unk_0xA7A57E7757ED035E(&uLocal_84);
									unk_0x897EF720254BBEA3(iLocal_69[iVar0], 1);
								}
							}
						}
		...
		case 1:
			...
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_69[iVar1]))
				{
					if (unk_0x18FB647D79B09657(iLocal_69[iVar1], 904.3153f, 3631.684f, 31.574f, 7f, 7f, 7f, 0, 1, 0))
					{
						if (!unk_0xD62C4419A41F106A(iLocal_77[iVar1], 0))
						{
							unk_0xA6E32819044BBB6A(iLocal_77[iVar1], 0);
						}
						if (unk_0xF0D230FB550CD6EB(iLocal_69[iVar1], 0))
						{
							unk_0x99414FB2D30425C1(&uLocal_84);
							unk_0x07C339D4328CA16C(0, 0, 0);
							unk_0x277716E9E7CC0692(0, unk_0x33CD235DF1E6A94E(), 0, 16);
							unk_0xC734F59A13D39AEF(uLocal_84);
							unk_0x13A2D602CD10CBAC(iLocal_69[iVar1], uLocal_84);
							unk_0xA7A57E7757ED035E(&uLocal_84);
							unk_0x897EF720254BBEA3(iLocal_69[iVar1], 1);
						}
					}
					if (!unk_0xF0D230FB550CD6EB(iLocal_69[iVar1], 0))
					{
						unk_0x277716E9E7CC0692(iLocal_69[iVar1], unk_0x33CD235DF1E6A94E(), 0, 16);
						unk_0x897EF720254BBEA3(iLocal_69[iVar1], 1);
					}
					if (!unk_0xD62C4419A41F106A(iLocal_77[iVar1], 0))
					{
						if (unk_0x9DC577E2A517CC1E(iLocal_77[iVar1]))
						{
						}
					}
				}
				if (unk_0xBC2FC12AD0FBF72E(iLocal_69[iVar1]))
				{
					if (unk_0xE38E3CF1625A4145(uLocal_61[iVar1]))
					{
						unk_0x1ABDB383C83A336A(&(uLocal_61[iVar1]));
					}
				}
				iVar1++;
			}
			if (((unk_0xBC2FC12AD0FBF72E(iLocal_69[2]) && unk_0xBC2FC12AD0FBF72E(iLocal_69[3])) && unk_0xBC2FC12AD0FBF72E(iLocal_69[4])) && unk_0xBC2FC12AD0FBF72E(iLocal_69[5]))
			{
				unk_0x7CED302277C0F3D3("RE_COUNTRYSIDE_GANG_FIGHT_SCENE");
				iLocal_48++;
			}
		...
		case 2:
			...
			if (!unk_0xBC2FC12AD0FBF72E(uLocal_68))
			{
				unk_0xED68CDDDE25A144E(uLocal_68);
				unk_0x99414FB2D30425C1(&uLocal_84);
				unk_0xC4A347124F39D998(0, unk_0x33CD235DF1E6A94E(), -1, 2056, 2);
				unk_0x11C4AF4137F2A4B5(0, unk_0x33CD235DF1E6A94E(), -1);
				unk_0xC734F59A13D39AEF(uLocal_84);
				unk_0x13A2D602CD10CBAC(uLocal_68, uLocal_84);
				unk_0xA7A57E7757ED035E(&uLocal_84);
			}
			if (!unk_0xD62C4419A41F106A(uLocal_76, 0))
			{
				unk_0x0D847D71D9E6142E(uLocal_76);
				if (!unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), uLocal_68, 5f, 5f, 5f, 0, 1, 0))
				{
		...
		case 3:
			if (!unk_0xBC2FC12AD0FBF72E(uLocal_68))
			{
				if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), uLocal_68, 6f, 6f, 6f, 0, 1, 0))
				{
					if (unk_0x910FF514D7BC5674(uLocal_68, unk_0x33CD235DF1E6A94E(), 60f))
					{
						if (!func_8())
						{
			...
			if (!unk_0xBC2FC12AD0FBF72E(uLocal_68))
			{
				if (!unk_0x335C0645074963FE(uLocal_68, unk_0x33CD235DF1E6A94E(), 120f, 120f, 120f, 0, 1, 0))
				{
					func_10();
				}
			}
			if (!unk_0xD62C4419A41F106A(uLocal_76, 0))
			{
				if (unk_0x91BBD269506D61D2(uLocal_76, unk_0x33CD235DF1E6A94E(), 0))
				{
					func_63();
				}
			}
		...
		case 5:
			if (!unk_0xBC2FC12AD0FBF72E(uLocal_68) && !unk_0xD62C4419A41F106A(uLocal_76, 0))
			{
				unk_0x99414FB2D30425C1(&uLocal_84);
				unk_0x11C4AF4137F2A4B5(0, unk_0x33CD235DF1E6A94E(), 1500);
				unk_0xC838CE9837D0ABAF(0, uLocal_76, -1, -1, 2f, 8, 0);
				unk_0x838F76C6C0AB6849(0, 2000);
				unk_0x108754262311D34F(0, "veh@drivebystd_ds_grenades", "drop_grenade", 2f, -2f, -1, 0, 0, 0, 0, 0);
				unk_0x21D56A8927F5A92A(0, uLocal_76, 10f, 786603);
				unk_0xC734F59A13D39AEF(uLocal_84);
				unk_0x13A2D602CD10CBAC(uLocal_68, uLocal_84);
				unk_0xA7A57E7757ED035E(&uLocal_84);
				unk_0x897EF720254BBEA3(uLocal_68, 1);
				unk_0x8A065911C6F917C0(uLocal_76, 1);
				iLocal_48++;
			}
			break;
		...
		case 6:
			if (!unk_0xBC2FC12AD0FBF72E(uLocal_68))
			{
				if (unk_0x1CE8F0A08E65CA6A(uLocal_68, "veh@drivebystd_ds_grenades", "drop_grenade", 3))
				{
					if (unk_0x204DEACC5BECF723(uLocal_68, "veh@drivebystd_ds_grenades", "drop_grenade") > 0.436f && unk_0xF0D230FB550CD6EB(uLocal_68, 0))
					{
						unk_0xAC584348B06672DD(unk_0x2CA911E7569D12EA(unk_0xF2C96862595654B4(uLocal_68, 0), -1f, 0f, 0f), 1000, 1, 0);
						iLocal_48++;
					}
				}
			}
...
void func_40(int iParam0)
{
	...
	iVar0 = (unk_0xE3903F59E2F22150() + iParam0);
...
void func_53()
{
	...
	switch (iLocal_48)
	{
		...
		case 1:
			if (!unk_0xBC2FC12AD0FBF72E(uLocal_68))
			{
				if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), uLocal_68, 20f, 20f, 20f, 0, 1, 0))
				{
					unk_0xC4A347124F39D998(uLocal_68, unk_0x33CD235DF1E6A94E(), -1, 2060, 2);
		...
		case 2:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_68) && !unk_0xD62C4419A41F106A(uLocal_76, 0))
			{
				unk_0x99414FB2D30425C1(&uLocal_84);
				unk_0x7E268975AF5EA74F(0, 916.5764f, 3602.146f, 31.9262f, 1f, 40000, 1048576000, 0, 1193033728);
				unk_0xC734F59A13D39AEF(uLocal_84);
				unk_0x13A2D602CD10CBAC(iLocal_68, uLocal_84);
				unk_0xA7A57E7757ED035E(&uLocal_84);
				iLocal_48++;
			}
			break;
		...
		case 4:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_68))
			{
				if (unk_0x18FB647D79B09657(iLocal_68, 916.5764f, 3602.146f, 31.9262f, 3.3f, 3.3f, 3.3f, 0, 1, 0))
				{
					if (!unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_68, 8f, 8f, 8f, 0, 1, 0))
					{
						if (!func_8())
						{
							if (func_41(&uLocal_85, "RECGFAU", "RECGF_STASH", 4, 0, 0, 0))
							{
								unk_0x11C4AF4137F2A4B5(iLocal_68, unk_0x33CD235DF1E6A94E(), -1);
								if (!unk_0xD62C4419A41F106A(uLocal_76, 0))
								{
									unk_0x0D847D71D9E6142E(uLocal_76);
								}
			...
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_68))
			{
				if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_68, 8f, 8f, 8f, 0, 1, 0))
				{
					if (!unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0) || unk_0xA2F0EA9AB6142D97(unk_0x33CD235DF1E6A94E()))
					{
						...
						{
							func_40(1000);
							if ((!unk_0xBC2FC12AD0FBF72E(iLocal_68) && !unk_0xBC2FC12AD0FBF72E(iLocal_69[2])) && !unk_0xD62C4419A41F106A(uLocal_76, 0))
							{
								unk_0x99414FB2D30425C1(&uLocal_84);
								unk_0xB470BF3A9F5DA9A5(0, uLocal_76, -1, -1, 1f);
								unk_0xC4A347124F39D998(0, iLocal_69[2], 2000, 0, 2);
								unk_0x11C4AF4137F2A4B5(0, iLocal_69[2], 0);
								unk_0xC734F59A13D39AEF(uLocal_84);
								unk_0x13A2D602CD10CBAC(iLocal_68, uLocal_84);
								unk_0xA7A57E7757ED035E(&uLocal_84);
								func_40(2000);
								...
								if ((!unk_0xBC2FC12AD0FBF72E(iLocal_68) && !unk_0xD62C4419A41F106A(uLocal_76, 0)) && unk_0xF0D230FB550CD6EB(iLocal_68, 0))
								{
									iLocal_48++;
								}
								else
								{
									if (!unk_0xBC2FC12AD0FBF72E(iLocal_68) && !unk_0xBC2FC12AD0FBF72E(iLocal_69[2]))
									{
										unk_0x99414FB2D30425C1(&uLocal_84);
		...
		case 7:
			if ((((!unk_0xBC2FC12AD0FBF72E(iLocal_68) && !unk_0xD62C4419A41F106A(uLocal_76, 0)) && !unk_0x10930B9CAD4111C2(iLocal_68, uLocal_76, 0)) && !unk_0xB5D4E8F757C24136(iLocal_68, 0)) && !unk_0x743EC1E3DC1090F3(iLocal_68))
			{
			}
			iVar0 = 0;
			while (iVar0 < iLocal_69)
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_69[iVar0]) && !unk_0xD62C4419A41F106A(iLocal_77[iVar0], 0))
				{
					if (((((unk_0xE5472B649A9E9734(unk_0x33CD235DF1E6A94E(), (916.3351f - 100f), (3602.048f - 100f), (31.9209f - 100f), (916.3351f + 100f), (3602.048f + 100f), (31.9209f + 100f), 0, 1) || unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_69[iVar0], 5f, 5f, 5f, 0, 1, 0)) || unk_0x91BBD269506D61D2(iLocal_69[iVar0], unk_0x33CD235DF1E6A94E(), 1)) || unk_0x91BBD269506D61D2(iLocal_77[iVar0], unk_0x33CD235DF1E6A94E(), 1)) || unk_0x4ED4D1D8B2023FD8(unk_0x33CD235DF1E6A94E(), iLocal_69[iVar0])) || unk_0x4ED4D1D8B2023FD8(unk_0x33CD235DF1E6A94E(), iLocal_77[iVar0]))
					{
						bLocal_55 = true;
			...
			if (unk_0x18FB647D79B09657(iLocal_69[2], 970.3641f, 3629.886f, 31.3694f, 5f, 5f, 5f, 0, 1, 0) || unk_0xC9D9444186B5A374() > 13000)
			{
				func_40(2000);
				iVar0 = 0;
				while (iVar0 < iLocal_69)
				{
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_69[iVar0]))
					{
						if (!unk_0xD62C4419A41F106A(iLocal_77[iVar0], 0))
						{
							if (unk_0x10930B9CAD4111C2(iLocal_69[iVar0], iLocal_77[iVar0], 0))
							{
								unk_0x48B8A6610EAA0C89(iLocal_69[iVar0], iLocal_77[iVar0], unk_0x33CD235DF1E6A94E(), (iVar0 - 2) + 10, 60f, 786475, 5f, 10f, 1);
							}
						}
					}
					iVar0++;
				...
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_68))
				{
					if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_68, 15f, 15f, 15f, 0, 1, 0))
					{
						func_54();
						func_40(0);
...
int func_56()
{
	...
	if (((((((!unk_0x765F6FEEFF39224F(iLocal_77[2]) && !unk_0x765F6FEEFF39224F(iLocal_77[3])) && !unk_0x765F6FEEFF39224F(iLocal_77[4])) && !unk_0x765F6FEEFF39224F(iLocal_77[5])) && !unk_0x765F6FEEFF39224F(iLocal_69[2])) && !unk_0x765F6FEEFF39224F(iLocal_69[3])) && !unk_0x765F6FEEFF39224F(iLocal_69[4])) && !unk_0x765F6FEEFF39224F(iLocal_69[5]))
	{
		unk_0xB815670C37E03CDE(joaat("hexer"));
		unk_0xB815670C37E03CDE(joaat("g_m_y_lost_01"));
		unk_0xB815670C37E03CDE(joaat("g_m_y_lost_02"));
		unk_0xDEFB5E2E5CBD460A("RE_COUNTRYSIDE_GANG_FIGHT_SCENE");
		if (unk_0x5D98D654CDC2165A(joaat("hexer")))
		{
			iLocal_77[2] = unk_0xC651C43AB13A15E5(joaat("hexer"), 863.4697f, 3633.5f, 31.9874f, 290.5797f, 1, 1, 0);
			iLocal_77[3] = unk_0xC651C43AB13A15E5(joaat("hexer"), 866.4073f, 3636.039f, 31.9514f, 270.3649f, 1, 1, 0);
			iLocal_77[4] = unk_0xC651C43AB13A15E5(joaat("hexer"), 866.3153f, 3631.587f, 31.9545f, 276.6327f, 1, 1, 0);
			iLocal_77[5] = unk_0xC651C43AB13A15E5(joaat("hexer"), 868.5937f, 3633.523f, 31.9622f, 267.0991f, 1, 1, 0);
			unk_0x71CA80D41E1338B4(joaat("hexer"));
			unk_0x6D056AC3FCCA974B(iLocal_77[2], 3);
			unk_0x6D056AC3FCCA974B(iLocal_77[4], 3);
			iLocal_59 = unk_0xE3903F59E2F22150() + 1500;
		}
		if ((unk_0x5D98D654CDC2165A(joaat("g_m_y_lost_01")) && unk_0x5D98D654CDC2165A(joaat("g_m_y_lost_02"))) && unk_0x7C71681384076318("RE_COUNTRYSIDE_GANG_FIGHT_SCENE"))
		{
			iLocal_69[2] = unk_0xE196503B36B6194B(iLocal_77[2], 22, joaat("g_m_y_lost_01"), -1, 1, 1);
			iLocal_69[3] = unk_0xE196503B36B6194B(iLocal_77[3], 22, joaat("g_m_y_lost_02"), -1, 1, 1);
			iLocal_69[4] = unk_0xE196503B36B6194B(iLocal_77[4], 22, joaat("g_m_y_lost_01"), -1, 1, 1);
			iLocal_69[5] = unk_0xE196503B36B6194B(iLocal_77[5], 22, joaat("g_m_y_lost_02"), -1, 1, 1);
			...
			while (iVar0 < iLocal_69)
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_69[iVar0]) && !unk_0xD62C4419A41F106A(iLocal_77[iVar0], 0))
				{
					unk_0x7B1011A61F402324(iLocal_77[iVar0], "RE_COUNTRYSIDE_GANG_BIKES", 0);
					unk_0x5FEE418CE11E6DDE(iLocal_69[iVar0], 137, 1);
					unk_0xC475906893AEB995(iLocal_69[iVar0], 0);
					unk_0x34A51926277F67BC(iLocal_69[iVar0], 2);
					unk_0x28F648743D7DE312(iLocal_69[iVar0], 50, 1);
					unk_0x52F5AAAD4824B17E(iLocal_69[iVar0], 2);
					unk_0x16D56D398FB73BE7(iLocal_69[iVar0], 50f, 20);
					unk_0x1E0350F1D7702D6A(iLocal_69[iVar0], 1);
					unk_0xDE9FF07CFD5DC172(iLocal_69[iVar0], 13);
					unk_0x5F9955D3E93BCC84(iLocal_69[iVar0], 100f);
					unk_0x18E5E2B41CD6CE17(iLocal_69[iVar0], 100f);
					unk_0x0648A75D3F60E864(iLocal_69[iVar0], uLocal_250);
					unk_0x4A852F02088ECC9D(iLocal_69[iVar0], 1);
					unk_0x66CDA3DCBCEDF782(iLocal_69[iVar0], 3);
					unk_0x2B4A2E9ED65D5C93(iLocal_69[iVar0], 0);
					unk_0xF0BE7CB40DE62A2F(iLocal_69[iVar0], 1);
					unk_0x428C55A965F78103(iLocal_69[iVar0], 1, 1000f);
					if (iVar0 > 1 && iVar0 < 5)
					{
						unk_0x697EBA5CF1A6AB57(iLocal_69[iVar0], joaat("weapon_pistol"), -1, 1, 1);
					}
					else
					{
						unk_0x697EBA5CF1A6AB57(iLocal_69[iVar0], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
					}
					unk_0x99414FB2D30425C1(&uLocal_84);
					unk_0x77C4189A8E5C57C2(0, iLocal_77[2], 966.7098f, 3633.926f, 31.3974f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0xAE5B044AA2973E2A(0, Local_50, 5000, 0, 2);
					unk_0xC734F59A13D39AEF(uLocal_84);
					unk_0x13A2D602CD10CBAC(iLocal_69[2], uLocal_84);
					unk_0xA7A57E7757ED035E(&uLocal_84);
					unk_0x99414FB2D30425C1(&uLocal_84);
					unk_0x77C4189A8E5C57C2(0, iLocal_77[3], 970.6208f, 3636.743f, 31.3666f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0xAE5B044AA2973E2A(0, Local_50, 5000, 0, 2);
					unk_0xC734F59A13D39AEF(uLocal_84);
					unk_0x13A2D602CD10CBAC(iLocal_69[3], uLocal_84);
					unk_0xA7A57E7757ED035E(&uLocal_84);
					unk_0x897EF720254BBEA3(iLocal_69[3], 1);
					unk_0x99414FB2D30425C1(&uLocal_84);
					unk_0x77C4189A8E5C57C2(0, iLocal_77[4], 971.023f, 3631.225f, 31.3807f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0xAE5B044AA2973E2A(0, Local_50, 5000, 0, 2);
					unk_0xC734F59A13D39AEF(uLocal_84);
					unk_0x13A2D602CD10CBAC(iLocal_69[4], uLocal_84);
					unk_0xA7A57E7757ED035E(&uLocal_84);
					unk_0x99414FB2D30425C1(&uLocal_84);
					unk_0x77C4189A8E5C57C2(0, iLocal_77[5], 974.8073f, 3633.771f, 31.3818f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0xAE5B044AA2973E2A(0, Local_50, 5000, 0, 2);
					unk_0xC734F59A13D39AEF(uLocal_84);
					unk_0x13A2D602CD10CBAC(iLocal_69[5], uLocal_84);
					unk_0xA7A57E7757ED035E(&uLocal_84);
				}
				iVar0++;
			}
			unk_0x71CA80D41E1338B4(joaat("hexer"));
			unk_0x71CA80D41E1338B4(joaat("g_m_y_lost_01"));
			unk_0x71CA80D41E1338B4(joaat("g_m_y_lost_02"));
			return 1;
		}
	}
	return 0;
...
void func_58()
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_68))
	{
		unk_0xECCD4FDA45197F97(iLocal_68, unk_0x33CD235DF1E6A94E(), 200f, -1, 0, 0);
		unk_0x897EF720254BBEA3(iLocal_68, 1);
		if (!unk_0xD62C4419A41F106A(iLocal_69[0], 0) && !unk_0xD62C4419A41F106A(iLocal_69[1], 0))
		{
			unk_0x7FC2040EB34E0E31(iLocal_68, 101, 0);
			unk_0xAD3D24C8070DA056(iLocal_68, 0);
			unk_0x0B303ED4E12A5F06(iLocal_69[0], iLocal_68, 1000, 0);
			unk_0x0B303ED4E12A5F06(iLocal_69[1], iLocal_68, 1000, 0);
		}
		else
		{
			func_4();
...
{
	unk_0xAEED0213982928AC(uParam0, sParam1, func_60(iParam2), 1);
}
...
void func_61()
{
	...
	{
		case 0:
			if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_68, 45f, 45f, 20f, 0, 1, 0))
			{
				if (!func_8())
				{
					if (func_48() == 0)
		...
		case 1:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_68))
			{
				if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_68, 40f, 40f, 20f, 0, 1, 0))
				{
		...
		case 3:
			if ((!unk_0xBC2FC12AD0FBF72E(iLocal_68) && !unk_0xBC2FC12AD0FBF72E(iLocal_69[0])) && !unk_0xBC2FC12AD0FBF72E(iLocal_69[1]))
			{
				...
				{
					if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_68, 12f, 12f, 2.5f, 0, 1, 0))
					{
						if (((unk_0xDAAA48CE50D80F52(iLocal_69[0], unk_0x33CD235DF1E6A94E()) || unk_0xDAAA48CE50D80F52(iLocal_69[1], unk_0x33CD235DF1E6A94E())) || unk_0xC4BA1231BBAF1161(iLocal_69[0], unk_0x33CD235DF1E6A94E())) || unk_0xC4BA1231BBAF1161(iLocal_69[1], unk_0x33CD235DF1E6A94E()))
						{
							unk_0xC4A347124F39D998(iLocal_69[0], unk_0x33CD235DF1E6A94E(), 4000, 2056, 4);
							unk_0xC4A347124F39D998(iLocal_69[1], unk_0x33CD235DF1E6A94E(), 4000, 2056, 4);
							if (!iLocal_57)
							{
								func_4();
								func_40(0);
					...
					else if (!unk_0x1CE8F0A08E65CA6A(iLocal_69[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 3))
					{
						if (!unk_0x910FF514D7BC5674(iLocal_69[0], iLocal_68, 10f))
						{
							unk_0x4DDF5809B68AA635(iLocal_69[0], iLocal_68, -1, 0);
						}
					}
				}
				else if (!unk_0xD62C4419A41F106A(iLocal_77[0], 0) && !unk_0xD62C4419A41F106A(iLocal_77[1], 0))
				{
					func_4();
					func_40(0);
		...
		case 4:
			...
			while (iVar0 < iLocal_69)
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_69[iVar0]))
				{
					unk_0x41E36A540F8F323F(iLocal_69[iVar0], 156, 1);
					unk_0x277716E9E7CC0692(iLocal_69[iVar0], unk_0x33CD235DF1E6A94E(), 0, 16);
					unk_0x897EF720254BBEA3(iLocal_69[iVar0], 1);
				}
				iVar0++;
			}
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_68))
			{
				unk_0xE0345C3A81F4471A(iLocal_68, -1);
			}
			iLocal_48++;
			break;
		...
		case 5:
			...
			if (unk_0xBC2FC12AD0FBF72E(iLocal_69[0]) && unk_0xBC2FC12AD0FBF72E(iLocal_69[1]))
			{
				iLocal_48 = 0;
				iLocal_47 = 1;
			}
...
void func_62()
{
	if (!unk_0x73E7A21FD53144AB(916.4631f, 3601.261f, 31.9327f, 3f))
	{
		if (!unk_0xD62C4419A41F106A(unk_0x8918EC905FC8975D(), 0))
		{
			if (unk_0x18FB647D79B09657(unk_0x8918EC905FC8975D(), 916.4631f, 3601.261f, 31.9327f, 2f, 2f, 2f, 0, 1, 0))
			{
				unk_0xBEADAF07D2339505(unk_0x8918EC905FC8975D(), 915.6531f, 3595.061f, 32.0774f, 1, 0, 0, 1);
			}
		}
	}
}
...
int func_68()
{
	switch (func_69(&Global_25824, 0, 5, 0, unk_0x8C40DC84EDF05997()))
	{
		case 1:
			return 1;
			break;
...
int func_75(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xCE5C49921A521962(uVar0, func_76(unk_0xB331FCEB94EB05C8(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xCE5C49921A521962(uVar0, func_76(unk_0xB331FCEB94EB05C8(), 0.7f, 0.7f));
		unk_0xBF11C8A43770C598(uVar0, bParam1);
	}
...
int func_77()
{
	...
	if (!bLocal_55)
	{
		unk_0xD2E80177F27FD43F(255, uLocal_250, joaat("player"));
		if (!unk_0xD62C4419A41F106A(iLocal_69[0], 0) && !unk_0xD62C4419A41F106A(iLocal_69[1], 0))
		{
			if (unk_0x91BBD269506D61D2(iLocal_69[0], unk_0x33CD235DF1E6A94E(), 1) || unk_0x91BBD269506D61D2(iLocal_69[1], unk_0x33CD235DF1E6A94E(), 1))
			{
				func_4();
				return 1;
			}
			if (!unk_0xD62C4419A41F106A(unk_0x8918EC905FC8975D(), 0))
			{
				if (unk_0x91BBD269506D61D2(iLocal_69[0], unk_0x8918EC905FC8975D(), 1) || unk_0x91BBD269506D61D2(iLocal_69[1], unk_0x8918EC905FC8975D(), 1))
				{
					func_4();
					return 1;
				}
		...
		if (!unk_0xD62C4419A41F106A(iLocal_77[0], 0) && !unk_0xD62C4419A41F106A(iLocal_77[1], 0))
		{
			if (((unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_77[0], 0) || unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_77[1], 0)) || unk_0x91BBD269506D61D2(iLocal_77[0], unk_0x33CD235DF1E6A94E(), 1)) || unk_0x91BBD269506D61D2(iLocal_77[1], unk_0x33CD235DF1E6A94E(), 1))
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_69[0]) && !unk_0xBC2FC12AD0FBF72E(iLocal_69[1]))
				{
					if (func_93())
		...
		Var0 = { 15f, 15f, 15f };
		Var3 = { -15f, -15f, -15f };
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_69[0]))
		{
			if (unk_0x416C37C19CCE0077(unk_0x61B226C460A8FCC2(iLocal_69[0], 31086, 0f, 0f, 0f), 5f, 1))
			{
				func_4();
				return 1;
			}
			Var0 = { Var0 + unk_0x61B226C460A8FCC2(iLocal_69[0], 31086, 0f, 0f, 0f) };
			Var3 = { Var3 + unk_0x61B226C460A8FCC2(iLocal_69[0], 31086, 0f, 0f, 0f) };
			if (((unk_0x7EEE8B447AB73C25(Var3, Var0, joaat("weapon_smokegrenade"), 1) || unk_0x7EEE8B447AB73C25(Var3, Var0, joaat("weapon_grenade"), 1)) || unk_0x7EEE8B447AB73C25(Var3, Var0, joaat("weapon_grenadelauncher"), 1)) || unk_0x7EEE8B447AB73C25(Var3, Var0, joaat("weapon_stickybomb"), 1))
			{
				func_4();
				return 1;
			}
			if (unk_0x4141DE783FB62352(unk_0x61B226C460A8FCC2(iLocal_69[0], 31086, 0f, 0f, 0f), 3f))
			{
				func_4();
				return 1;
			}
		}
		if (unk_0xE5472B649A9E9734(unk_0x33CD235DF1E6A94E(), (973.053f - 30f), (3616.738f - 30f), (32.6181f - 30f), (973.053f + 30f), (3616.738f + 30f), (32.6181f + 30f), 0, 1))
		{
			func_4();
			return 1;
		}
		if ((!unk_0xBC2FC12AD0FBF72E(iLocal_68) && !unk_0xBC2FC12AD0FBF72E(iLocal_69[0])) && !unk_0xBC2FC12AD0FBF72E(iLocal_69[1]))
		{
			if (iLocal_49 != -1)
			{
				if (((unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iLocal_69[0]) || unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iLocal_69[1])) || unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_69[0])) || unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_69[1]))
				{
					func_4();
					return 1;
				}
			...
			if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_68, 12f, 12f, 2.5f, 0, 1, 0))
			{
				if (((unk_0xDAAA48CE50D80F52(iLocal_69[0], unk_0x33CD235DF1E6A94E()) || unk_0xDAAA48CE50D80F52(iLocal_69[1], unk_0x33CD235DF1E6A94E())) || unk_0xC4BA1231BBAF1161(iLocal_69[0], unk_0x33CD235DF1E6A94E())) || unk_0xC4BA1231BBAF1161(iLocal_69[1], unk_0x33CD235DF1E6A94E()))
				{
					if (!iLocal_54)
					{
						unk_0x4DDF5809B68AA635(iLocal_69[0], unk_0x33CD235DF1E6A94E(), -1, 0);
						iLocal_54 = 1;
					}
					if (unk_0xE38E3CF1625A4145(uLocal_60))
					{
						unk_0x983D75D9630FD905(uLocal_60, 1);
					}
					if (unk_0xE38E3CF1625A4145(uLocal_61[0]))
					{
						unk_0x983D75D9630FD905(uLocal_61[0], 1);
					}
					if (unk_0xE38E3CF1625A4145(uLocal_61[1]))
					{
						unk_0x983D75D9630FD905(uLocal_61[1], 1);
					}
			...
			if (iLocal_49 != -1 && unk_0xE3903F59E2F22150() > iLocal_49 + 10000)
			{
				func_4();
				func_40(0);
			...
			if (!unk_0x91BBD269506D61D2(iLocal_69[0], unk_0x33CD235DF1E6A94E(), 1) && !unk_0x91BBD269506D61D2(iLocal_69[1], unk_0x33CD235DF1E6A94E(), 1))
			{
				if (unk_0x91BBD269506D61D2(iLocal_68, unk_0x33CD235DF1E6A94E(), 1))
				{
					if (func_93())
					{
						func_4();
...
void func_78()
{
	if (unk_0x91D5C8283D19AF49(uLocal_76, 0))
	{
		if ((!unk_0x18FB647D79B09657(uLocal_76, 915.7905f, 3603.449f, 31.9111f, 5f, 5f, 5f, 0, 1, 0) && !unk_0x10930B9CAD4111C2(iLocal_68, iLocal_76, 0)) || unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_76, 1))
		{
			func_58();
		}
	}
...
int func_79()
{
	...
	if (((((!unk_0x765F6FEEFF39224F(iLocal_68) && !unk_0x765F6FEEFF39224F(iLocal_69[0])) && !unk_0x765F6FEEFF39224F(iLocal_69[1])) && !unk_0x765F6FEEFF39224F(iLocal_76)) && !unk_0x765F6FEEFF39224F(iLocal_77[0])) && !unk_0x765F6FEEFF39224F(iLocal_77[1]))
	{
		unk_0xB815670C37E03CDE(joaat("a_m_m_skidrow_01"));
		unk_0xB815670C37E03CDE(joaat("g_m_y_lost_01"));
		unk_0xB815670C37E03CDE(joaat("g_m_y_lost_02"));
		unk_0xB815670C37E03CDE(joaat("picador"));
		unk_0xB815670C37E03CDE(joaat("hexer"));
		unk_0x0483D0035D6E46FD("random@countryside_gang_fight");
		unk_0x0483D0035D6E46FD("veh@drivebystd_ds_grenades");
		unk_0xC5AC1209923D6240("move_m@gangster@var_i");
		if (((((((unk_0x5D98D654CDC2165A(joaat("a_m_m_skidrow_01")) && unk_0x5D98D654CDC2165A(joaat("g_m_y_lost_01"))) && unk_0x5D98D654CDC2165A(joaat("g_m_y_lost_02"))) && unk_0x5D98D654CDC2165A(joaat("picador"))) && unk_0x5D98D654CDC2165A(joaat("hexer"))) && unk_0xE9CCF312047EBEE0("random@countryside_gang_fight")) && unk_0xE9CCF312047EBEE0("veh@drivebystd_ds_grenades")) && unk_0x657046D7B5023C3B("move_m@gangster@var_i"))
		{
			unk_0x8C4EA5F6857553AE(joaat("picador"), 1);
			unk_0x8C4EA5F6857553AE(joaat("hexer"), 1);
			unk_0xAF9EA4E314ED45C2(417.901f, 3578.002f, 31.176f, 1305.897f, 3604.306f, 40.1064f, 100.0625f, 0, 0, 1);
			unk_0x0335D8135051EA56(Local_50 - Vector(20f, 50f, 80f), Local_50 + Vector(20f, 50f, 70f), 0, 1, 1, 1);
			unk_0xA53C1C92EE35EC0E(3, 0);
			unk_0xA53C1C92EE35EC0E(5, 0);
			unk_0x9315FCF6CFE2AB41("rghLost", &uLocal_250);
			unk_0xD2E80177F27FD43F(5, uLocal_250, joaat("player"));
			iLocal_68 = unk_0x9BA5CF280376EEA4(26, joaat("a_m_m_skidrow_01"), 973.053f, 3616.738f, 31.6181f, 110.2753f, 1, 1);
			unk_0x93AA93DA1B137032(iLocal_68, 0, 0, 1, 0);
			unk_0x93AA93DA1B137032(iLocal_68, 2, 1, 0, 0);
			unk_0x93AA93DA1B137032(iLocal_68, 3, 1, 2, 0);
			unk_0x93AA93DA1B137032(iLocal_68, 4, 0, 0, 0);
			unk_0x71CA80D41E1338B4(joaat("a_m_m_skidrow_01"));
			unk_0x4A852F02088ECC9D(iLocal_68, 1);
			unk_0x28F648743D7DE312(iLocal_68, 17, 1);
			unk_0xF0BE7CB40DE62A2F(iLocal_68, 0);
			unk_0xAD3D24C8070DA056(iLocal_68, 1);
			unk_0x5FEE418CE11E6DDE(iLocal_68, 185, 1);
			unk_0xBE470ACBEDCBF6FC(iLocal_68, 16);
			unk_0x5464B9731013E08C(iLocal_68, "A_M_M_TRAMP_01_BLACK_MINI_01");
			func_57(&uLocal_85, 1, iLocal_68, "RECGFDealer", 0, 1);
			unk_0x9FD099B0593CD91D(iLocal_68, 1);
			unk_0x108754262311D34F(iLocal_68, "random@countryside_gang_fight", "gangmember_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0x511559F67646F1C0(iLocal_68, "move_m@gangster@var_i", 1048576000);
			iLocal_76 = unk_0xC651C43AB13A15E5(joaat("picador"), 915.7905f, 3603.449f, 31.9111f, 111.9593f, 1, 1, 0);
			unk_0x65EA11CF317FE4FA(iLocal_76, 37, 0);
			unk_0x4A7AB87632044178(iLocal_76, 4, 0);
			unk_0xD266F9D236AE6C86(iLocal_76, 1);
			unk_0x6F10E9B95245828B(iLocal_76, "WDU 696");
			iLocal_69[0] = unk_0x9BA5CF280376EEA4(22, joaat("g_m_y_lost_01"), 970.2217f, 3614.821f, 31.6909f, 297.4345f, 1, 1);
			func_57(&uLocal_85, 3, iLocal_69[0], "RECGFLost2", 0, 1);
			iLocal_69[1] = unk_0x9BA5CF280376EEA4(22, joaat("g_m_y_lost_02"), 971.504f, 3618.054f, 31.5565f, 216.9967f, 1, 1);
			func_57(&uLocal_85, 2, iLocal_69[1], "RECGFLost1", 0, 1);
			unk_0x71CA80D41E1338B4(joaat("g_m_y_lost_01"));
			unk_0x71CA80D41E1338B4(joaat("g_m_y_lost_02"));
			iLocal_77[0] = unk_0xC651C43AB13A15E5(joaat("hexer"), 968.2626f, 3611.717f, 31.7874f, 296.8978f, 1, 1, 0);
			iLocal_77[1] = unk_0xC651C43AB13A15E5(joaat("hexer"), 970.8362f, 3625.563f, 31.3415f, 212.3456f, 1, 1, 0);
			unk_0x71CA80D41E1338B4(joaat("hexer"));
			unk_0x108754262311D34F(iLocal_69[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0x108754262311D34F(iLocal_69[1], "random@countryside_gang_fight", "biker_01_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			iVar0 = 0;
			while (iVar0 < iLocal_69)
			{
				if (iVar0 < 2)
				{
					...
					unk_0x34A51926277F67BC(iLocal_69[iVar0], 2);
					unk_0x28F648743D7DE312(iLocal_69[iVar0], 50, 1);
					unk_0x1E0350F1D7702D6A(iLocal_69[iVar0], 0);
					unk_0x697EBA5CF1A6AB57(iLocal_69[0], joaat("weapon_pistol"), -1, 1, 1);
					unk_0x697EBA5CF1A6AB57(iLocal_69[1], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
					unk_0x897EF720254BBEA3(iLocal_69[iVar0], 1);
					unk_0x4A852F02088ECC9D(iLocal_69[iVar0], 1);
					unk_0x43D47AD82DA3C6EC(iLocal_69[iVar0], 1, 1);
				}
				iVar0++;
			}
			iLocal_59 = unk_0xE3903F59E2F22150() + 1500;
			if (func_48() == 0)
			{
				func_57(&uLocal_85, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 0, 1);
			}
			else if (func_48() == 1)
			{
				func_57(&uLocal_85, 0, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
			}
			else if (func_48() == 2)
			{
				func_57(&uLocal_85, 0, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
			}
			return 1;
		}
	}
...
int func_80()
{
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		...
		if (unk_0xA8CEACB4F35AE058(unk_0x43D8A2CCB19FE8A8(unk_0x33CD235DF1E6A94E())) > 1369f && !func_91())
		{
			return 0;
		}
	}
...
int func_93()
{
	if ((Global_106554 == func_37() && unk_0x40AC0B9EFCB6A65B()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_112(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
...
int func_115()
{
	...
	func_121(&uVar0, unk_0xE6A7CE90720B9037());
	func_120(&uVar0, unk_0x7EA67BD818402745());
	func_119(&uVar0, unk_0x13348E86D5B8A052());
		...
		if (unk_0x765F6FEEFF39224F(unk_0x33CD235DF1E6A94E()))
		{
			if (!unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xE51F6AFEA84C2923(unk_0x95B959F18401C09A(), 1) || func_132()) || Global_25767) || func_131()) || func_50(8, -1)) || func_128()) || func_130()) || func_129()) || func_127()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0xE027064B1C47E424(unk_0x95B959F18401C09A()) || unk_0x7DD221C91135596A(unk_0x33CD235DF1E6A94E())) || unk_0x707FFB0E65C1C546(unk_0x33CD235DF1E6A94E())) || unk_0x3AF2B3B68DD52355(unk_0x33CD235DF1E6A94E())) || unk_0xE19223B3551F58B8(unk_0x33CD235DF1E6A94E())) || unk_0xE51F6AFEA84C2923(unk_0x95B959F18401C09A(), 1)) || unk_0x63E238348058FF52(unk_0x95B959F18401C09A())) || unk_0x71E0DAA57FE7D5C7(unk_0x33CD235DF1E6A94E(), 0)) || func_132()) || Global_105612) || Global_25767) || func_131()) || func_50(8, -1)) || func_128()) || func_130()) || func_129()) || func_127()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x3AF2B3B68DD52355(unk_0x33CD235DF1E6A94E()) || unk_0xE19223B3551F58B8(unk_0x33CD235DF1E6A94E())) || unk_0xE51F6AFEA84C2923(unk_0x95B959F18401C09A(), 1)) || unk_0x71E0DAA57FE7D5C7(unk_0x33CD235DF1E6A94E(), 0)) || func_132()) || Global_105612) || Global_25767) || func_131()) || func_50(8, -1)) || func_130()) || func_129()) || func_127()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_132() || unk_0x002F527E1A3238DC(unk_0x95B959F18401C09A()) > 0) || func_50(8, -1)) || func_127()) || func_126()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_140()
{
	...
	if (iLocal_53 && !iLocal_58)
	{
		...
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_68))
		{
			unk_0x5FEE418CE11E6DDE(iLocal_68, 317, 1);
			unk_0xAD3D24C8070DA056(iLocal_68, 0);
			unk_0x4A852F02088ECC9D(iLocal_68, 0);
		}
		iVar0 = 0;
		while (iVar0 < iLocal_69)
		{
