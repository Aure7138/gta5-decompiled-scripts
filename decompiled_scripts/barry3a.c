...
void __EntryFunction__()
{
	...
	if (unk_0x2137828D03306CAF(Local_81.f_28[0]))
	{
		func_414(&(Local_186[0 /*29*/].f_1), &(Local_81.f_28[0]));
	}
	if (unk_0x2137828D03306CAF(Local_81.f_28[1]))
	{
	...
	while (true)
	{
		unk_0xE57EE82872DC7A9F("SF_GRTP", 0);
...
void func_1()
{
	switch (iLocal_143)
	{
		case 0:
			func_213(&iLocal_144);
			if (unk_0x5B9B499C707C2A95(unk_0x2A5EB8B0FE590B91(), Local_145.f_4, 0))
			{
				...
				else
				{
					iLocal_437 = 1;
					iLocal_438 = 1;
					if (unk_0x29B06605BA5CF280(203) == 0 || !func_211())
					{
						func_209(2);
						iLocal_436 = 0;
					}
		...
		case 1:
			...
			else if (!iLocal_437)
			{
				if (unk_0x5B9B499C707C2A95(unk_0x2A5EB8B0FE590B91(), Local_145.f_4, 0))
				{
					...
					{
						iLocal_438 = 0;
						if (unk_0x7DDA81F38FB30F23(Local_145.f_4, Local_161, 6f, 6f, 2f, 1, 1, 0))
						{
							func_213(&iLocal_144);
							iLocal_143 = 0;
							iLocal_142 = 6;
			...
			else if (!unk_0x5B9B499C707C2A95(unk_0x2A5EB8B0FE590B91(), Local_145.f_4, 0))
			{
				unk_0x0508903FC1B0ED24();
				iLocal_437 = 0;
				iLocal_436 = 1;
			...
			else if (unk_0x7DDA81F38FB30F23(Local_145.f_4, Local_161, 6f, 6f, 2f, 1, 1, 0))
			{
				func_213(&iLocal_144);
				iLocal_143 = 0;
				iLocal_142 = 6;
...
void func_6()
{
	...
	{
		func_8(13, unk_0xF34EE736CF047844(Global_103236.f_9975.f_3853));
	}
	if (!unk_0xA8A044A76B03FC4C())
	{
		if (!Global_69800)
		{
			if (func_7() == 2 == 0 && !unk_0x591AF4C50B46E014())
			{
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_69(func_88(iParam1, uParam0->f_2), Global_69618, 0);
			if (unk_0xAA4F14DA15DB0B51(iVar0, uParam0->f_1))
			{
				unk_0xF6082E2ADA1C795B(&(uParam0->f_6), 1);
			}
			iVar0 = func_69(func_87(iParam1, uParam0->f_2), Global_69618, 0);
			if (unk_0xAA4F14DA15DB0B51(iVar0, uParam0->f_1))
			{
				unk_0xF6082E2ADA1C795B(&(uParam0->f_6), 2);
			}
...
int func_199()
{
	return func_200(unk_0xFABF5258A318B1DC(), 0);
}
...
void func_214()
{
	...
	{
		case 0:
			if (unk_0x7DDA81F38FB30F23(Local_145.f_4, Local_161, 10f, 10f, 2f, 0, 1, 0))
			{
				func_213(&iLocal_144);
		...
		case 1:
			if (unk_0x7DDA81F38FB30F23(Local_145.f_4, Local_161, 10f, 10f, 2f, 0, 1, 0))
			{
				...
				{
					func_216();
					if (!func_215(unk_0x2A5EB8B0FE590B91(), Local_145.f_4, 55f, 1) && !unk_0x57F6052FCF93BCFF(Local_145.f_4))
					{
						iLocal_143 = 2;
					}
					else if ((iLocal_433 && func_208(5)) && (unk_0x29B06605BA5CF280(203) == 0 || !func_211()))
					{
						func_209(5);
					}
				}
...
void func_216()
{
	if (!iLocal_434)
	{
		iLocal_435 = unk_0x3732B96D7A1859B4() + 3500;
		iLocal_434 = 1;
	}
	else if (!iLocal_433)
	{
		if (unk_0x3732B96D7A1859B4() > iLocal_435)
		{
			if (iLocal_429 == 1)
			{
...
void func_231()
{
	...
	{
		case 0:
			if (unk_0x67ED3C44A2B3E8F2(Local_145.f_4) < 1f)
			{
				unk_0x6385100E76566DD6(Local_145.f_4, 10f);
			}
			if (unk_0xB01B1648698791BB(Local_145.f_4) < 1f)
			{
				unk_0x525CB8A0699017B3(Local_145.f_4, 10f);
			}
...
void func_236()
{
	switch (iLocal_143)
	{
		case 0:
			func_213(&iLocal_144);
			if (!func_211() || unk_0x29B06605BA5CF280(203) == 0)
			{
				func_209(2);
				func_247(&uLocal_450);
				iLocal_431 = 0;
			...
			iLocal_429 = 1;
			iLocal_249 = unk_0x3732B96D7A1859B4() + 2500;
			iLocal_143 = 1;
			break;
		
		case 1:
			func_242(&uLocal_450, &uLocal_251, "BAR3AAU", &sLocal_451, &cLocal_457);
			if (!iLocal_248 && unk_0x3732B96D7A1859B4() > iLocal_249)
			{
				unk_0x74A5A7443264D9EE("SCRIPTED_SCANNER_REPORT_BARRY_3A_01", 0f);
				iLocal_248 = 1;
			}
			if (unk_0x5B9B499C707C2A95(unk_0x2A5EB8B0FE590B91(), Local_145.f_4, 0))
			{
...
void func_239()
{
	...
	{
		if (!func_211() && unk_0x5B9B499C707C2A95(unk_0x2A5EB8B0FE590B91(), Local_145.f_4, 0))
		{
			if (!iLocal_425)
			{
				iLocal_425 = 1;
			...
			if ((unk_0x3732B96D7A1859B4() - iLocal_427) > Local_416[iLocal_426 /*2*/].f_1 && (func_241() || iLocal_426 == 0))
			{
				if (iLocal_426 != 2 || unk_0xD2660BAC03EB7433(Local_145.f_4) > 10f)
				{
					if (func_229() || unk_0x29B06605BA5CF280(203) == 0)
					{
...
int func_241()
{
	if (unk_0xFA2E229A03371E02(unk_0xD1EE0E9FCD74A37B(unk_0x2A5EB8B0FE590B91(), 1) - Vector(70f, 70f, 70f), unk_0xD1EE0E9FCD74A37B(unk_0x2A5EB8B0FE590B91(), 1) + Vector(70f, 70f, 70f)))
	{
		return 1;
	}
	return 0;
...
void func_242(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		...
		case 4:
			if (!unk_0x4FF1AD2B1A443280() && func_243(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_248()
{
	switch (iLocal_143)
	{
		case 0:
			func_213(&iLocal_144);
			iLocal_144 = func_207(Local_145.f_4, 1, 5);
			unk_0xD42DEAFD12809447(iLocal_144, 1);
			if (func_208(3) && (unk_0x29B06605BA5CF280(203) == 0 || !func_211()))
			{
				func_209(3);
				func_247(&uLocal_450);
			}
	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (unk_0x5B9B499C707C2A95(unk_0x2A5EB8B0FE590B91(), Local_145.f_4, 0))
			{
				func_213(&iLocal_144);
				iLocal_144 = func_212(Local_161, 5, 1);
				if (func_208(0) && (unk_0x29B06605BA5CF280(203) == 0 || !func_211()))
				{
					func_209(0);
					func_247(&uLocal_450);
				}
		...
		case 1:
			if (unk_0x5B9B499C707C2A95(unk_0x2A5EB8B0FE590B91(), Local_145.f_4, 0))
			{
				...
				else
				{
					...
					if (unk_0xF8ED2D0629FE764D(unk_0x2A5EB8B0FE590B91(), Local_145.f_4) && unk_0x7DDA81F38FB30F23(Local_145.f_4, Local_161, 6f, 6f, 2f, 1, 1, 0))
					{
						iLocal_439 = 0;
						iLocal_143 = 2;
					}
					if (!iLocal_432)
					{
						if (((unk_0x3732B96D7A1859B4() - iLocal_427) > 8000 && iLocal_426 >= 4) && !func_211())
						{
...
void func_252(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_323(unk_0xFABF5258A318B1DC(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_200(unk_0xFABF5258A318B1DC(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_320(&(Global_91777.f_3));
				if (iVar10 > -1)
				{
...
{
	func_254(&Global_97012, unk_0xFABF5258A318B1DC(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_254(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_224();
	...
	if (!unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()))
	{
		...
		func_283(unk_0x2A5EB8B0FE590B91());
		func_276(unk_0x2A5EB8B0FE590B91(), 0);
	...
	while (iVar0 < 9)
	{
		if (unk_0x2137828D03306CAF(Global_89253[iVar0]))
		{
			if (Global_89253[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0xD3B21CE53AA7BE51(iParam0) == func_263(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0x7FAC45D56235AB39(iParam0, 0))
	{
		...
		*uParam1 = unk_0x8721B6183C713CE4(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xF6082E2ADA1C795B(&(uParam1->f_77), func_266(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_271(int iParam0, var uParam1, int iParam2)
{
	...
	if (!unk_0x769F0F6444C1ABE0(iParam0))
	{
		...
		else if (unk_0x591AF4C50B46E014() && unk_0xD3B21CE53AA7BE51(iParam0) == unk_0xD3B21CE53AA7BE51(unk_0x2A5EB8B0FE590B91()))
		{
			if (func_272(161, -1))
			{
				uParam1->f_59 = func_69(2046, Global_69618, 0);
			}
			else
			{
				uParam1->f_59 = func_69(748, Global_69618, 0);
			}
			uParam1->f_60 = func_69(749, Global_69618, 0);
			uParam1->f_61 = func_69(750, Global_69618, 0);
		}
...
int func_272(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2526994[iParam0 /*3*/][func_68(iParam1)];
...
void func_276(int iParam0, bool bParam1)
{
	...
	iVar0 = func_148(iParam0);
	if (func_150(iVar0) && !unk_0x769F0F6444C1ABE0(iParam0))
	{
		if (iParam0 == unk_0x2A5EB8B0FE590B91())
		{
			func_277(iParam0, &(Global_103236.f_2164.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_277(int iParam0, var uParam1)
{
	...
	if (!unk_0x769F0F6444C1ABE0(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x09B17C9438F9DE41(iParam0, func_282(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((unk_0xAEF11B8C6B59FE54(iVar9, &Var11) && !func_279(Var11.f_1)) && iVar72 < 50)
			{
...
void func_283(int iParam0)
{
	...
	if (func_150(iVar0) && !unk_0x769F0F6444C1ABE0(uParam0))
	{
...
int func_288(var uParam0)
{
	if (!unk_0xA9A04898798AE9E6(unk_0x2A5EB8B0FE590B91(), 0) && !unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()))
	{
		if (func_308())
		{
			*uParam0 = func_293(unk_0xD1EE0E9FCD74A37B(unk_0x2A5EB8B0FE590B91(), 0), 6, -1, 0, 1, -1);
...
int func_290(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x591AF4C50B46E014())
	{
		if (func_7() == 0)
		{
			return unk_0xAA4F14DA15DB0B51(func_69(func_291(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_293(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 46)
	{
		if (iParam3 == 6 || iParam3 == func_307(iVar0))
		{
			...
			{
				fVar1 = unk_0x4A2E6F541CD8C36E(Param0, func_294(iVar0, 0), 1);
...
Vector3 func_294(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_305(Global_93305);
			break;
		
		case 46:
			if (Global_1592304 != func_304())
			{
				if (func_303(Global_1592304))
				{
					return func_296(2, 2);
				}
				else if (func_295(Global_1592304))
				{
...
var func_309()
{
	...
	func_319(&uVar0, unk_0xD887411BD4A4A92D());
	func_318(&uVar0, unk_0xA4EAAF8247A3A69E());
	func_317(&uVar0, unk_0xDA870B7547A455EA());
	func_312(&uVar0, unk_0x56E76B9CA4BBAA18());
	func_311(&uVar0, unk_0x0FD588FC21950895());
	func_310(&uVar0, unk_0x15C180E135C728D1());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_315(unk_0xAA4F14DA15DB0B51(iParam0, 31), -1, 1)) + 2011;
}
...
int func_321(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_322(Global_103236.f_8866.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_322(Global_103236.f_8866.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_322(Global_103236.f_8866.f_99.f_205[11]);
			break;
		
		case 90:
			return func_322(Global_103236.f_8866.f_99.f_205[7]);
			break;
		
		case 93:
			return func_322(Global_103236.f_8866.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_327(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (unk_0x2137828D03306CAF(Global_94043.f_4))
	{
		...
		{
			if (func_354(24) != Global_94043.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_351(unk_0xD1EE0E9FCD74A37B(Global_94043.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_328(Global_94043.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_329(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_346(&(Global_68628.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (unk_0x2137828D03306CAF(iParam1))
	{
		if (unk_0x7FAC45D56235AB39(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_103236.f_32211.f_4801 = func_309();
			}
...
void func_330(int iParam0, int iParam1)
{
	...
	func_265(iParam0, &(Global_103236.f_32211.f_5510));
}

int func_331(int iParam0)
{
	if ((((((((((!unk_0x2137828D03306CAF(iParam0) || !unk_0x7FAC45D56235AB39(iParam0, 0)) || func_269(iParam0, 0, 0)) || func_269(iParam0, 1, 0)) || func_269(iParam0, 2, 0)) || func_261(iParam0) != 145) || func_345(iParam0)) || func_344(iParam0)) || func_343(iParam0)) || func_342(iParam0)) || !func_332(unk_0xD3B21CE53AA7BE51(iParam0)))
	{
		if (func_344(iParam0))
		{
		}
...
int func_346(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0xAA4F14DA15DB0B51(uParam0->f_9, 10))
	{
		...
		if (!func_287(Global_103236.f_32211.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_287(Global_103236.f_2164.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_287(Global_103236.f_2164.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_347(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6)
{
	if (func_346(&(Global_68628.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_349(iParam0);
			func_348(uParam1, &(Global_103236.f_32211.f_69[Global_68628.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_357()
{
	...
	{
		unk_0x20A9229D8F4F054A(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, 0, 1);
		iLocal_144 = func_207(Local_145.f_4, 1, 5);
		iLocal_142 = 1;
		iLocal_143 = 0;
	}
...
void func_358()
{
	...
	{
		unk_0xFD213087BC4CC3B3(iLocal_247);
		unk_0xFD213087BC4CC3B3(iLocal_246);
		iLocal_245 = 0;
	}
}
...
void func_359(int iParam0)
{
	...
	{
		case 0:
			if (!unk_0x2137828D03306CAF(Local_186[iParam0 /*29*/].f_1))
			{
				if (func_203(Local_186[iParam0 /*29*/]))
				{
					if (unk_0xA1FC9D7AEA164881(iLocal_247))
					{
						Local_186[iParam0 /*29*/].f_1 = unk_0x7B47BFDF39EC38D3(Local_186[iParam0 /*29*/], 6, iLocal_247, -1, 1, 1);
						Local_186[iParam0 /*29*/].f_2 = unk_0x7B47BFDF39EC38D3(Local_186[iParam0 /*29*/], 6, iLocal_247, 0, 1, 1);
					}
				}
				else if (unk_0xA1FC9D7AEA164881(iLocal_246))
				{
					Local_186[iParam0 /*29*/] = unk_0xE42A511281C9895B(iLocal_246, Local_186[iParam0 /*29*/].f_3, Local_186[iParam0 /*29*/].f_6, 1, 1, 0);
				}
			}
			else if (!unk_0xA9A04898798AE9E6(Local_186[iParam0 /*29*/].f_1, 0))
			{
				unk_0x83B7EDBCFB45EB8C(Local_186[iParam0 /*29*/].f_1, 1);
				unk_0x4C47904AE69D7393(Local_186[iParam0 /*29*/].f_1, 1);
				unk_0x64B11F881078C75D(Local_186[iParam0 /*29*/].f_1, joaat("weapon_pistol"), 100, 1);
				unk_0x176253610C53F0E0(Local_186[iParam0 /*29*/].f_1, 10);
				if (func_203(Local_186[iParam0 /*29*/].f_2))
				{
					unk_0x83B7EDBCFB45EB8C(Local_186[iParam0 /*29*/].f_2, 1);
					unk_0x4C47904AE69D7393(Local_186[iParam0 /*29*/].f_2, 1);
					unk_0x64B11F881078C75D(Local_186[iParam0 /*29*/].f_2, joaat("weapon_pistol"), 100, 1);
					unk_0x176253610C53F0E0(Local_186[iParam0 /*29*/].f_2, 10);
				}
		...
		case 1:
			if (func_206(unk_0x2A5EB8B0FE590B91(), Local_186[iParam0 /*29*/].f_3, 275f))
			{
				if (func_378(iParam0))
				{
					Local_186[iParam0 /*29*/].f_25 = unk_0x3732B96D7A1859B4() + 1750;
			...
			{
				if (!Local_186[iParam0 /*29*/].f_26 && unk_0x2137828D03306CAF(Local_186[iParam0 /*29*/].f_1))
				{
					func_361(&(Local_186[iParam0 /*29*/].f_1));
					Local_186[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_186[iParam0 /*29*/].f_27 && unk_0x2137828D03306CAF(Local_186[iParam0 /*29*/].f_2))
				{
					func_361(&(Local_186[iParam0 /*29*/].f_2));
					Local_186[iParam0 /*29*/].f_27 = 1;
				}
				if (!Local_186[iParam0 /*29*/].f_28 && unk_0x2137828D03306CAF(Local_186[iParam0 /*29*/]))
				{
		...
		case 2:
			if (unk_0x3732B96D7A1859B4() > Local_186[iParam0 /*29*/].f_25)
			{
				func_362(iParam0, 1);
			}
...
void func_362(int iParam0, int iParam1)
{
	...
	{
		unk_0x4C47904AE69D7393(Local_186[iParam0 /*29*/].f_1, 0);
		unk_0xADC658162F2B08CD(Local_186[iParam0 /*29*/].f_1, 1);
		func_360(&(Local_186[iParam0 /*29*/].f_1), 1, 0, 1);
	}
	if (func_203(Local_186[iParam0 /*29*/].f_2))
	{
		unk_0x83B7EDBCFB45EB8C(Local_186[iParam0 /*29*/].f_2, 1);
		unk_0x4C47904AE69D7393(Local_186[iParam0 /*29*/].f_2, 0);
		unk_0xADC658162F2B08CD(Local_186[iParam0 /*29*/].f_2, 1);
		func_360(&(Local_186[iParam0 /*29*/].f_2), 1, 0, 1);
	}
	if (iParam1 && func_203(Local_186[iParam0 /*29*/]))
	{
		unk_0x2DEA38A68AA89671(Local_186[iParam0 /*29*/], 1, 1, 0);
...
int func_364(int iParam0)
{
	...
	if (func_203(iParam0))
	{
		...
		if (unk_0xB833DDD4C8B30212(iParam0) && func_215(iParam0, unk_0x2A5EB8B0FE590B91(), 2f, 1))
		{
			return 1;
		}
		...
		else if (unk_0x05A9C36EF40B6941(Var0 - Vector(3f, 3f, 3f), Var0 + Vector(3f, 3f, 3f), 1))
		{
			return 1;
		}
...
int func_365(int iParam0, float fParam1)
{
	...
	if (func_203(unk_0x2A5EB8B0FE590B91()) && func_203(iParam0))
	{
		if (func_376(iParam0) || unk_0xE97AF56371F08BE1(unk_0x0FFED3E94261A832(), iParam0))
		{
...
{
	return func_367(iParam0, unk_0x2A5EB8B0FE590B91(), fParam1, 1, 250, 7);
}
...
int func_371(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_373(unk_0xD1EE0E9FCD74A37B(iParam1, 1) - unk_0xD1EE0E9FCD74A37B(iParam0, 1)) };
	...
	{
		Var3 = { func_373(unk_0x585F703DF3E83B6E(iParam0, 31086, 0f, 5f, 0f) - unk_0x585F703DF3E83B6E(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_377(int iParam0)
{
	...
	if (unk_0x2137828D03306CAF(iParam0))
	{
		...
		else if (unk_0x05A9C36EF40B6941(Var0 - Vector(5f, 5f, 5f), Var0 + Vector(5f, 5f, 5f), 1))
		{
			return 1;
		}
	}
...
{
	if (unk_0x9A46207BB68ED2F0(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[0 /*8*/][0 /*3*/], Local_186[iParam0 /*29*/].f_7[0 /*8*/][1 /*3*/], Local_186[iParam0 /*29*/].f_7[0 /*8*/].f_7, 0, 1, 0))
	{
		return 1;
	}
	else if (Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7 != 0f && unk_0x9A46207BB68ED2F0(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_186[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_381()
{
	if (unk_0xF8B9DB65ACBA5275(Local_145.f_4))
	{
		if (iLocal_153)
		{
			if ((unk_0x3732B96D7A1859B4() - iLocal_154) > 7000)
			{
				return 1;
			}
		}
...
int func_382()
{
	switch (iLocal_439)
	{
		...
		case 1:
			iLocal_440 = unk_0x8CB0BCE2283F9861() * 120;
			iLocal_440 = (iLocal_440 + unk_0x3732B96D7A1859B4());
			iLocal_441 = (iLocal_440 - unk_0x8CB0BCE2283F9861() * 30);
		...
		case 2:
			if (unk_0x3732B96D7A1859B4() >= iLocal_440)
			{
				return 1;
			}
			else
			{
				if ((!iLocal_443 && unk_0x3732B96D7A1859B4() >= iLocal_441) && !func_211())
				{
...
void func_383()
{
	...
	if (iVar0 >= iLocal_446)
	{
		if ((iVar0 - iLocal_447) > 500)
		{
			...
			iLocal_447 = unk_0x3732B96D7A1859B4() + 1000;
		}
	}
	else if (iVar0 >= iLocal_445)
	{
		if ((iVar0 - iLocal_447) > 500)
		{
			...
			iLocal_447 = unk_0x3732B96D7A1859B4();
		}
	}
	...
	switch (iLocal_143)
	{
		case 0:
			if (!func_390())
			{
				...
				if (unk_0x58478145CAF8429C(sLocal_449))
				{
					sLocal_449 = "DEFAULT";
				}
				if (unk_0x35302CD5A5D37EED(sLocal_449, "DEFAULT"))
				{
					func_459(1);
				}
				else
...
void func_385(bool bParam0)
{
	...
	unk_0x20A9229D8F4F054A(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, 1, 1);
}
...
void func_391()
{
	...
	if (iLocal_442)
	{
		if ((!unk_0x863D84AFAC2AB730() && !func_395(0)) && !func_390())
		{
			iVar0 = (iLocal_440 - unk_0x3732B96D7A1859B4());
			if (iVar0 < 0)
			{
				iVar0 = 0;
			}
	...
	if (Global_70054 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0xF4EE9D6C8E60AE22())
			{
				...
				Var4 = { func_398(Global_70055, Global_70057, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_409(0) || Global_70069) || Global_70058 == 1) || !unk_0x0B21CC5276C2CE1B())
	{
		return 0;
	}
	switch (Global_70054)
	{
		...
		case 5:
			if ((unk_0x863D84AFAC2AB730() || func_395(0)) || func_408(1))
			{
			}
			else
			{
...
void func_412()
{
	if (func_203(Local_145.f_4))
	{
		unk_0x3EACD080B21FFD9A(Local_145.f_4, 1);
		unk_0x9897DB908AE3BCFF(Local_145.f_4, 1);
		unk_0x3A9F98251E1877CD(Local_145.f_4, 0);
		unk_0x4CC32589F27FBD47(Local_145.f_4, 0);
		if (!bLocal_152)
		{
			unk_0x170A2AFB4FF42C5A(Local_145.f_4);
		}
...
void func_421(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (unk_0x591AF4C50B46E014())
		{
			if (((!unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()) && !func_425(unk_0x0FFED3E94261A832())) && !func_423(unk_0x0FFED3E94261A832(), 0)) && !func_422())
			{
				unk_0xF65C7766FB8D4B2C(unk_0x2A5EB8B0FE590B91(), 0);
			}
		}
		else if (!unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()) && !func_425(unk_0x0FFED3E94261A832()))
		{
			unk_0xF65C7766FB8D4B2C(unk_0x2A5EB8B0FE590B91(), 0);
		}
		Global_69798 = 0;
...
void func_429(bool bParam0)
{
	...
	{
		unk_0x8E979F037EACE55A(unk_0x2A5EB8B0FE590B91(), -1243.316f, -1041.637f, 7.5121f, 1, 0, 0, 1);
		unk_0x2681BA3707AF6DA7(unk_0x2A5EB8B0FE590B91(), 28.2f);
	}
	func_418(500, 1);
}
...
void func_433(bool bParam0)
{
	...
	while (iLocal_250 <= 1)
	{
		...
		if (bParam0)
		{
			...
			if (!iLocal_245)
			{
				unk_0x0F39DF6675B2333E(iLocal_247);
				unk_0x0F39DF6675B2333E(iLocal_246);
			}
			iLocal_245 = 1;
		}
		else
...
{
	unk_0x0F39DF6675B2333E(Local_145.f_5);
	unk_0x0F39DF6675B2333E(iLocal_159);
	while (!unk_0xA1FC9D7AEA164881(Local_145.f_5) || !unk_0xA1FC9D7AEA164881(iLocal_159))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (func_203(Local_145.f_4))
	{
		if (bLocal_152)
		{
			unk_0x7B2B49C597D57523(Local_145.f_4);
			bLocal_152 = false;
		}
	}
	if (bParam4)
	...
	func_205(&uLocal_155);
	func_202(&(Local_145.f_4));
	Local_145.f_4 = unk_0xE42A511281C9895B(Local_145.f_5, Param0, fParam3, 1, 1, 0);
	unk_0x23B7F0BEB9890E62(Local_145.f_4, 1);
	if (bParam4)
	{
		func_435(unk_0x2A5EB8B0FE590B91(), Local_145.f_4, -1);
	}
	unk_0x3A9F98251E1877CD(Local_145.f_4, 0);
	unk_0x4CC32589F27FBD47(Local_145.f_4, 0);
	unk_0x3EACD080B21FFD9A(Local_145.f_4, 1);
	unk_0x9897DB908AE3BCFF(Local_145.f_4, 1);
	unk_0x170A2AFB4FF42C5A(Local_145.f_4);
	unk_0xE4246493481B5222(Local_145.f_4, 1, 1);
	unk_0xE4246493481B5222(Local_145.f_4, 2, 1);
	unk_0xE4246493481B5222(Local_145.f_4, 3, 1);
	uLocal_155 = unk_0xA3618B5F6184DAD2(iLocal_159, Param0, 1, 1, 0);
	unk_0x5DAB197A499B8499(uLocal_155, Local_145.f_4, 0, Local_156, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
	unk_0x81642E3BC0111BF2(uLocal_155, 1, 0);
	bLocal_152 = true;
	func_413(Local_145.f_4, 0);
	unk_0xFD213087BC4CC3B3(Local_145.f_5);
	unk_0xFD213087BC4CC3B3(iLocal_159);
}
...
void func_435(int iParam0, int iParam1, int iParam2)
{
	if (func_420(uParam0))
	{
		if (func_203(uParam1))
		{
			...
			unk_0x01EE2412A2609146(uParam0, uParam1, iParam2);
		}
	}
}
...
void func_438(bool bParam0)
{
	...
	if (bParam0)
	{
		if (!unk_0x2137828D03306CAF(Local_145.f_4))
		{
...
void func_443()
{
	unk_0xC9173FA08E7D8227("BARR3A", 0);
	Local_145.f_5 = joaat("dloader");
	Local_145 = { 1199.8f, -1259.22f, 34.23f };
	Local_145.f_3 = 174.7f;
	if (func_203(unk_0x2A5EB8B0FE590B91()))
	{
		func_232(&uLocal_251, 1, unk_0x2A5EB8B0FE590B91(), "FRANKLIN", 0, 1);
	}
	iLocal_432 = 0;
	iLocal_443 = 0;
	iLocal_426 = 0;
	...
	sLocal_449 = "DEFAULT";
	func_444(49, 1, 0);
	uLocal_164[0] = unk_0x25118499AB6F447B(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
	uLocal_164[1] = unk_0x25118499AB6F447B(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
...
void func_450()
{
	...
	unk_0x6790C1CEA32DA629(uLocal_164[0], 0);
	unk_0x6790C1CEA32DA629(uLocal_164[1], 0);
	unk_0x34B2EF6CD6495C38(0);
...
void func_459(bool bParam0)
{
	...
	if (!func_475())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_460(unk_0xFABF5258A318B1DC(), iVar0);
		}
		else
		{
			if (Global_102323[iVar0 /*10*/].f_9 == -1)
...
int func_461(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_464())
	{
		...
		{
			iVar33 = func_320(unk_0xFABF5258A318B1DC());
			if (iVar33 > -1)
			{
...
int func_462()
{
	...
	iVar0 = func_323(&(Global_91777.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_464()
{
	...
	{
		if (func_320(&(Global_91777.f_3)) > -1)
		{
			return 1;
		}
	}
