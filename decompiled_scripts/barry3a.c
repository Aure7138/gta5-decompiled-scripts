...
void __EntryFunction__()
{
	...
	if (unk_0x746960881FB19A89(Local_80.f_28[0]))
	{
		func_396(&(Local_185[0 /*29*/].f_1), &(Local_80.f_28[0]));
	}
	if (unk_0x746960881FB19A89(Local_80.f_28[1]))
	{
	...
	while (true)
	{
		unk_0x2F626F4BEC43C4F6("SF_GRTP", 0);
...
void func_1()
{
	switch (iLocal_142)
	{
		case 0:
			func_211(&iLocal_143);
			if (unk_0x44E080690DA76A2A(unk_0x9F92518438215DD0(), Local_144.f_4, 0))
			{
				...
				else
				{
					iLocal_436 = 1;
					iLocal_437 = 1;
					if (unk_0xF10205C2D28EABD5(203) == 0 || !func_209())
					{
						func_207(2);
						iLocal_435 = 0;
					}
		...
		case 1:
			...
			else if (!iLocal_436)
			{
				if (unk_0x44E080690DA76A2A(unk_0x9F92518438215DD0(), Local_144.f_4, 0))
				{
					...
					{
						iLocal_437 = 0;
						if (unk_0x41EEB10CCC2497A8(Local_144.f_4, Local_160, 6f, 6f, 2f, 1, 1, 0))
						{
							func_211(&iLocal_143);
							iLocal_142 = 0;
							iLocal_141 = 6;
			...
			else if (!unk_0x44E080690DA76A2A(unk_0x9F92518438215DD0(), Local_144.f_4, 0))
			{
				unk_0xDA31FF1629FE9693();
				iLocal_436 = 0;
				iLocal_435 = 1;
			...
			else if (unk_0x41EEB10CCC2497A8(Local_144.f_4, Local_160, 6f, 6f, 2f, 1, 1, 0))
			{
				func_211(&iLocal_143);
				iLocal_142 = 0;
				iLocal_141 = 6;
...
void func_6()
{
	...
	{
		func_8(13, unk_0xF34EE736CF047844(Global_97358.f_8448.f_3853));
	}
	if (!unk_0xE30896F28DC0733C())
	{
		if (!Global_68245)
		{
			if (func_7() == 2 == 0 && !unk_0x4B69FB3A5B09A1BA())
			{
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_88(14))
			{
				iVar0 = func_68(func_87(iParam1, uParam0->f_2), Global_68104, 0);
				if (unk_0x94E72F17611BCD3C(iVar0, uParam0->f_1))
				{
					unk_0xEDB9A377CD8B7F03(&(uParam0->f_6), 1);
				}
				iVar0 = func_68(func_86(iParam1, uParam0->f_2), Global_68104, 0);
				if (unk_0x94E72F17611BCD3C(iVar0, uParam0->f_1))
				{
					unk_0xEDB9A377CD8B7F03(&(uParam0->f_6), 2);
				}
				...
				{
					iVar0 = func_68(iVar1, Global_68104, 0);
					if (!unk_0x94E72F17611BCD3C(iVar0, uParam0->f_1))
					{
						unk_0xEDB9A377CD8B7F03(&(uParam0->f_6), 4);
					}
...
int func_197()
{
	return func_198(unk_0xC2E9075570B5D2B9(), 0);
}
...
bool func_204(int iParam0, struct<3> Param1, float fParam4)
{
...
void func_212()
{
	...
	{
		case 0:
			if (unk_0x41EEB10CCC2497A8(Local_144.f_4, Local_160, 10f, 10f, 2f, 0, 1, 0))
			{
				func_211(&iLocal_143);
		...
		case 1:
			if (unk_0x41EEB10CCC2497A8(Local_144.f_4, Local_160, 10f, 10f, 2f, 0, 1, 0))
			{
				...
				{
					func_214();
					if (!func_213(unk_0x9F92518438215DD0(), Local_144.f_4, 55f) && !unk_0x0FF9FE2CB115CFB9(Local_144.f_4))
					{
						iLocal_142 = 2;
					}
					else if ((iLocal_432 && func_206(5)) && (unk_0xF10205C2D28EABD5(203) == 0 || !func_209()))
					{
						func_207(5);
					}
				}
...
void func_214()
{
	if (!iLocal_433)
	{
		iLocal_434 = unk_0x17103F66FBB44C3C() + 3500;
		iLocal_433 = 1;
	}
	else if (!iLocal_432)
	{
		if (unk_0x17103F66FBB44C3C() > iLocal_434)
		{
			if (iLocal_428 == 1)
			{
...
void func_226(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_229()
{
	...
	{
		case 0:
			if (unk_0x5252DDFA0FA75C54(Local_144.f_4) < 1f)
			{
				unk_0x76DD68AB949475D7(Local_144.f_4, 10f);
			}
			if (unk_0x9D878480FA8925BB(Local_144.f_4) < 1f)
			{
				unk_0x8063FF52148C1749(Local_144.f_4, 10f);
			}
...
int func_232(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4, bool bParam5)
{
...
void func_233()
{
	switch (iLocal_142)
	{
		case 0:
			func_211(&iLocal_143);
			if (!func_209() || unk_0xF10205C2D28EABD5(203) == 0)
			{
				func_207(2);
				func_244(&uLocal_449);
				iLocal_430 = 0;
			...
			iLocal_428 = 1;
			iLocal_248 = unk_0x17103F66FBB44C3C() + 2500;
			iLocal_142 = 1;
			break;
		
		case 1:
			func_239(&uLocal_449, &uLocal_250, "BAR3AAU", &sLocal_450, &cLocal_456);
			if (!iLocal_247 && unk_0x17103F66FBB44C3C() > iLocal_248)
			{
				unk_0x19E25152FB60E562("SCRIPTED_SCANNER_REPORT_BARRY_3A_01", 0f);
				iLocal_247 = 1;
			}
			if (unk_0x44E080690DA76A2A(unk_0x9F92518438215DD0(), Local_144.f_4, 0))
			{
...
void func_236()
{
	...
	{
		if (!func_209() && unk_0x44E080690DA76A2A(unk_0x9F92518438215DD0(), Local_144.f_4, 0))
		{
			if (!iLocal_424)
			{
				iLocal_424 = 1;
			...
			if ((unk_0x17103F66FBB44C3C() - iLocal_426) > Local_415[iLocal_425 /*2*/].f_1 && (func_238() || iLocal_425 == 0))
			{
				if (iLocal_425 != 2 || unk_0x9EF11DECA38804B6(Local_144.f_4) > 10f)
				{
					if (func_227() || unk_0xF10205C2D28EABD5(203) == 0)
					{
...
int func_238()
{
	if (unk_0x1D3BAF174600D6E8(unk_0x77009B1C011405A9(unk_0x9F92518438215DD0(), 1) - Vector(70f, 70f, 70f), unk_0x77009B1C011405A9(unk_0x9F92518438215DD0(), 1) + Vector(70f, 70f, 70f)))
	{
		return 1;
	}
	return 0;
...
void func_239(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		...
		case 4:
			if (!unk_0xDFF00E8709AA7095() && func_240(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_245()
{
	switch (iLocal_142)
	{
		case 0:
			func_211(&iLocal_143);
			iLocal_143 = func_205(Local_144.f_4, 1, 5);
			unk_0xD8EEE815F0120FCE(iLocal_143, 1);
			if (func_206(3) && (unk_0xF10205C2D28EABD5(203) == 0 || !func_209()))
			{
				func_207(3);
				func_244(&uLocal_449);
			}
	...
	switch (iLocal_142)
	{
		case 0:
			...
			if (unk_0x44E080690DA76A2A(unk_0x9F92518438215DD0(), Local_144.f_4, 0))
			{
				func_211(&iLocal_143);
				iLocal_143 = func_210(Local_160, 5, 1);
				if (func_206(0) && (unk_0xF10205C2D28EABD5(203) == 0 || !func_209()))
				{
					func_207(0);
					func_244(&uLocal_449);
				}
		...
		case 1:
			if (unk_0x44E080690DA76A2A(unk_0x9F92518438215DD0(), Local_144.f_4, 0))
			{
				...
				else
				{
					...
					if (unk_0x2A2DBEFFFC03A22F(unk_0x9F92518438215DD0(), Local_144.f_4) && unk_0x41EEB10CCC2497A8(Local_144.f_4, Local_160, 6f, 6f, 2f, 1, 1, 0))
					{
						iLocal_438 = 0;
						iLocal_142 = 2;
					}
					if (!iLocal_431)
					{
						if (((unk_0x17103F66FBB44C3C() - iLocal_426) > 8000 && iLocal_425 >= 4) && !func_209())
						{
...
void func_249(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_308(unk_0xC2E9075570B5D2B9(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_198(unk_0xC2E9075570B5D2B9(), 1);
			if (iVar5 != -1)
			{
...
{
	func_251(&Global_93593, unk_0xC2E9075570B5D2B9(), iParam0, uParam1, iParam3, iParam2);
}

void func_251(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_222();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_272())
		{
			func_268(unk_0x9F92518438215DD0(), &(uParam0->f_472[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
void func_253(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_254(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0x746960881FB19A89(Global_87698[iVar0]))
		{
			if (Global_87698[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0xB6A50C909A8FABC3(iParam0) == func_260(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0xFC38B241541883D3(iParam0, 0))
	{
		...
		*uParam1 = unk_0x015D5CDAA9114947(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xEDB9A377CD8B7F03(&(uParam1->f_53), func_263(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_268(int iParam0, var uParam1, int iParam2)
{
	...
	if (!unk_0x3E0478C40AB5B38D(iParam0))
	{
		...
		else if (unk_0x4B69FB3A5B09A1BA() && unk_0xB6A50C909A8FABC3(iParam0) == unk_0xB6A50C909A8FABC3(unk_0x9F92518438215DD0()))
		{
			if (func_269(161, -1))
			{
				uParam1->f_59 = func_68(2039, Global_68104, 0);
			}
			else
			{
				uParam1->f_59 = func_68(744, Global_68104, 0);
			}
			uParam1->f_60 = func_68(745, Global_68104, 0);
			uParam1->f_61 = func_68(746, Global_68104, 0);
		}
...
int func_269(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2474108[iParam0 /*6*/][func_67(iParam1)];
...
void func_273(int iParam0, bool bParam1)
{
	...
	iVar0 = func_147(iParam0);
	if (func_149(iVar0) && !unk_0x3E0478C40AB5B38D(iParam0))
	{
		if (iParam0 == unk_0x9F92518438215DD0())
		{
...
void func_279(int iParam0)
{
	...
	if (func_149(iVar0) && !unk_0x3E0478C40AB5B38D(uParam0))
	{
...
bool func_283(struct<3> Param0, struct<3> Param3)
{
...
int func_286(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x4B69FB3A5B09A1BA())
	{
		if (func_7() == 0)
		{
			return unk_0x94E72F17611BCD3C(func_68(func_287(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
var func_294()
{
	...
	func_304(&uVar0, unk_0xD9940DF735CED1D5());
	func_303(&uVar0, unk_0x00CE62DFC32D8B1E());
	func_302(&uVar0, unk_0x3E15607264E063C3());
	func_297(&uVar0, unk_0xA2C54D866C588926());
	func_296(&uVar0, unk_0x35E06151CD8A2DD1());
	func_295(&uVar0, unk_0x4C625096668FC49E());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_300(unk_0x94E72F17611BCD3C(iParam0, 31), -1, 1)) + 2011;
}
...
int func_306(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_307(Global_97358.f_7341.f_99.f_203[10]);
			break;
		
		case 74:
		case 75:
			return func_307(Global_97358.f_7341.f_99.f_203[8]);
			break;
		
		case 84:
		case 85:
			return func_307(Global_97358.f_7341.f_99.f_203[11]);
			break;
		
		case 90:
			return func_307(Global_97358.f_7341.f_99.f_203[7]);
			break;
		
		case 93:
			return func_307(Global_97358.f_7341.f_99.f_203[9]);
			break;
	}
	return 0;
}
...
void func_312(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (unk_0x746960881FB19A89(Global_91356.f_4))
	{
		...
		{
			if (func_336(24) != Global_91356.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_333(unk_0x77009B1C011405A9(Global_91356.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
void func_314(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0x746960881FB19A89(iParam1))
	{
		if (unk_0xFC38B241541883D3(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_97358.f_18371.f_4249 = func_294();
			}
...
void func_315(int iParam0, int iParam1)
{
	...
	func_262(iParam0, &(Global_97358.f_18371.f_4742));
}

int func_316(int iParam0)
{
	if ((((((((((!unk_0x746960881FB19A89(iParam0) || !unk_0xFC38B241541883D3(iParam0, 0)) || func_266(iParam0, 0, 0)) || func_266(iParam0, 1, 0)) || func_266(iParam0, 2, 0)) || func_258(iParam0) != 145) || func_327(iParam0)) || func_326(iParam0)) || func_325(iParam0)) || func_324(iParam0)) || !func_317(unk_0xB6A50C909A8FABC3(iParam0)))
	{
		if (func_326(iParam0))
		{
		}
...
int func_328(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0x94E72F17611BCD3C(uParam0->f_9, 10))
	{
		...
		if (!func_283(Global_97358.f_18371.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_283(Global_97358.f_1729.f_539.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_283(Global_97358.f_1729.f_539.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
void func_329(int iParam0, struct<54> Param1, struct<3> Param55, var uParam58, int iParam59)
{
	if (func_328(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_331(iParam0);
			func_330(Param1, &(Global_97358.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/]));
...
void func_330(struct<54> Param0, var uParam54)
{
...
int func_333(struct<3> Param0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
...
int func_334(struct<3> Param0, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_339()
{
	...
	{
		unk_0xCF023D488D3EAE4D(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, 0, 1);
		iLocal_143 = func_205(Local_144.f_4, 1, 5);
		iLocal_141 = 1;
		iLocal_142 = 0;
	}
...
void func_340()
{
	...
	{
		unk_0x0880E86251A44B7F(iLocal_246);
		unk_0x0880E86251A44B7F(iLocal_245);
		iLocal_244 = 0;
	}
}
...
void func_341(int iParam0)
{
	...
	{
		case 0:
			if (!unk_0x746960881FB19A89(Local_185[iParam0 /*29*/].f_1))
			{
				if (func_201(Local_185[iParam0 /*29*/]))
				{
					if (unk_0x149162179DBAEDB0(iLocal_246))
					{
						Local_185[iParam0 /*29*/].f_1 = unk_0xAD7526C9AA33EE39(Local_185[iParam0 /*29*/], 6, iLocal_246, -1, 1, 1);
						Local_185[iParam0 /*29*/].f_2 = unk_0xAD7526C9AA33EE39(Local_185[iParam0 /*29*/], 6, iLocal_246, 0, 1, 1);
					}
				}
				else if (unk_0x149162179DBAEDB0(iLocal_245))
				{
					Local_185[iParam0 /*29*/] = unk_0xB0694AD0A3BB8936(iLocal_245, Local_185[iParam0 /*29*/].f_3, Local_185[iParam0 /*29*/].f_6, 1, 1);
				}
			}
			else if (!unk_0x0BA451447C3B1A8D(Local_185[iParam0 /*29*/].f_1))
			{
				unk_0x9A8E4919D4CCCE41(Local_185[iParam0 /*29*/].f_1, 1);
				unk_0x4A1AC49BA4A747F7(Local_185[iParam0 /*29*/].f_1, 1);
				unk_0x3CD9EE39C1A990B1(Local_185[iParam0 /*29*/].f_1, joaat("weapon_pistol"), 100, 1);
				unk_0x488909512824324E(Local_185[iParam0 /*29*/].f_1, 10);
				if (func_201(Local_185[iParam0 /*29*/].f_2))
				{
					unk_0x9A8E4919D4CCCE41(Local_185[iParam0 /*29*/].f_2, 1);
					unk_0x4A1AC49BA4A747F7(Local_185[iParam0 /*29*/].f_2, 1);
					unk_0x3CD9EE39C1A990B1(Local_185[iParam0 /*29*/].f_2, joaat("weapon_pistol"), 100, 1);
					unk_0x488909512824324E(Local_185[iParam0 /*29*/].f_2, 10);
				}
		...
		case 1:
			if (func_204(unk_0x9F92518438215DD0(), Local_185[iParam0 /*29*/].f_3, 275f))
			{
				if (func_360(iParam0))
				{
					Local_185[iParam0 /*29*/].f_25 = unk_0x17103F66FBB44C3C() + 1750;
			...
			{
				if (!Local_185[iParam0 /*29*/].f_26 && unk_0x746960881FB19A89(Local_185[iParam0 /*29*/].f_1))
				{
					func_343(&(Local_185[iParam0 /*29*/].f_1));
					Local_185[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_185[iParam0 /*29*/].f_27 && unk_0x746960881FB19A89(Local_185[iParam0 /*29*/].f_2))
				{
					func_343(&(Local_185[iParam0 /*29*/].f_2));
					Local_185[iParam0 /*29*/].f_27 = 1;
				}
				if (!Local_185[iParam0 /*29*/].f_28 && unk_0x746960881FB19A89(Local_185[iParam0 /*29*/]))
				{
		...
		case 2:
			if (unk_0x17103F66FBB44C3C() > Local_185[iParam0 /*29*/].f_25)
			{
				func_344(iParam0, 1);
			}
...
void func_344(int iParam0, int iParam1)
{
	...
	{
		unk_0x4A1AC49BA4A747F7(Local_185[iParam0 /*29*/].f_1, 0);
		unk_0x3DB2056294531304(Local_185[iParam0 /*29*/].f_1, 1);
		func_342(&(Local_185[iParam0 /*29*/].f_1), 1, 0, 1);
	}
	if (func_201(Local_185[iParam0 /*29*/].f_2))
	{
		unk_0x9A8E4919D4CCCE41(Local_185[iParam0 /*29*/].f_2, 1);
		unk_0x4A1AC49BA4A747F7(Local_185[iParam0 /*29*/].f_2, 0);
		unk_0x3DB2056294531304(Local_185[iParam0 /*29*/].f_2, 1);
		func_342(&(Local_185[iParam0 /*29*/].f_2), 1, 0, 1);
	}
	if (iParam1 && func_201(Local_185[iParam0 /*29*/]))
	{
		unk_0x6FD45FA39DD18625(Local_185[iParam0 /*29*/], 1, 1);
...
int func_346(int iParam0)
{
	...
	if (func_201(iParam0))
	{
		...
		if (unk_0xBCBBB7902DEFA79B(iParam0) && func_213(iParam0, unk_0x9F92518438215DD0(), 2f))
		{
			return 1;
		}
		...
		else if (unk_0xFDD233BBDD8E0FFE(Var0 - Vector(3f, 3f, 3f), Var0 + Vector(3f, 3f, 3f), 1))
		{
			return 1;
		}
...
int func_347(int iParam0, float fParam1)
{
	...
	if (func_201(unk_0x9F92518438215DD0()) && func_201(iParam0))
	{
		if (func_358(iParam0) || unk_0xEA02B89C167BF0E3(unk_0xCFC72E446B0B3AD7(), iParam0))
		{
...
{
	return func_349(iParam0, unk_0x9F92518438215DD0(), fParam1, 1, 250, 7);
}

bool func_349(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_350(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_353(int iParam0, int iParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_355(unk_0x77009B1C011405A9(iParam1, 1) - unk_0x77009B1C011405A9(iParam0, 1)) };
	...
	{
		Var3 = { func_355(unk_0xAA04EEFB14FDE2E9(iParam0, 31086, 0f, 5f, 0f) - unk_0xAA04EEFB14FDE2E9(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_359(int iParam0)
{
	...
	if (unk_0x746960881FB19A89(iParam0))
	{
		...
		else if (unk_0xFDD233BBDD8E0FFE(Var0 - Vector(5f, 5f, 5f), Var0 + Vector(5f, 5f, 5f), 1))
		{
			return 1;
		}
	}
...
{
	if (unk_0xFE0FA79BC49EBB07(Local_144.f_4, Local_185[iParam0 /*29*/].f_7[0 /*8*/][0 /*3*/], Local_185[iParam0 /*29*/].f_7[0 /*8*/][1 /*3*/], Local_185[iParam0 /*29*/].f_7[0 /*8*/].f_7, 0, 1, 0))
	{
		return 1;
	}
	else if (Local_185[iParam0 /*29*/].f_7[1 /*8*/].f_7 != 0f && unk_0xFE0FA79BC49EBB07(Local_144.f_4, Local_185[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_185[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_185[iParam0 /*29*/].f_7[1 /*8*/].f_7, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_363()
{
	if (unk_0x37A3C3737EB1B394(Local_144.f_4))
	{
		if (iLocal_152)
		{
			if ((unk_0x17103F66FBB44C3C() - iLocal_153) > 7000)
			{
				return 1;
			}
		}
...
int func_364()
{
	switch (iLocal_438)
	{
		...
		case 1:
			iLocal_439 = unk_0xCA35CA70AAE8FBC6() * 120;
			iLocal_439 = (iLocal_439 + unk_0x17103F66FBB44C3C());
			iLocal_440 = (iLocal_439 - unk_0xCA35CA70AAE8FBC6() * 30);
		...
		case 2:
			if (unk_0x17103F66FBB44C3C() >= iLocal_439)
			{
				return 1;
			}
			else
			{
				if ((!iLocal_442 && unk_0x17103F66FBB44C3C() >= iLocal_440) && !func_209())
				{
...
void func_365()
{
	...
	if (iVar0 >= iLocal_445)
	{
		if ((iVar0 - iLocal_446) > 500)
		{
			...
			iLocal_446 = unk_0x17103F66FBB44C3C() + 1000;
		}
	}
	else if (iVar0 >= iLocal_444)
	{
		if ((iVar0 - iLocal_446) > 500)
		{
			...
			iLocal_446 = unk_0x17103F66FBB44C3C();
		}
	}
	...
	switch (iLocal_142)
	{
		case 0:
			if (!func_372())
			{
				...
				if (unk_0x9E9AFDBF482248F6(sLocal_448))
				{
					sLocal_448 = "DEFAULT";
				}
				if (unk_0x6B08EC9A88700FBB(sLocal_448, "DEFAULT"))
				{
					func_440(1);
				}
				else
...
void func_367(bool bParam0)
{
	...
	unk_0xCF023D488D3EAE4D(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, 1, 1);
}
...
void func_373()
{
	...
	if (iLocal_441)
	{
		if ((!unk_0xC42238EA2EBA3C42() && !func_377(0)) && !func_372())
		{
			iVar0 = (iLocal_439 - unk_0x17103F66FBB44C3C());
			if (iVar0 < 0)
			{
				iVar0 = 0;
			}
...
void func_374(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	int iVar1;
...
{
	if (((!func_391(0) || Global_68514) || Global_68503 == 1) || !unk_0x9685D9855970A029())
	{
		return 0;
	}
	switch (Global_68499)
	{
		...
		case 5:
			if ((unk_0xC42238EA2EBA3C42() || func_377(0)) || func_390(1))
			{
			}
			else
			{
...
void func_394()
{
	if (func_201(Local_144.f_4))
	{
		unk_0x17E8CB2415E3DCFE(Local_144.f_4, 1);
		unk_0xA27F610688163CA9(Local_144.f_4, 1);
		unk_0x7FAB46C418640A64(Local_144.f_4, 0);
		unk_0x629271E0FB6556E2(Local_144.f_4, 0);
		if (!bLocal_151)
		{
			unk_0x013A216DDFCAE218(Local_144.f_4);
		}
...
void func_401(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_402(unk_0x9F92518438215DD0()))
	{
...
void func_403(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (!unk_0x3E0478C40AB5B38D(unk_0x9F92518438215DD0()) && !func_404(unk_0xCFC72E446B0B3AD7()))
		{
...
void func_410(bool bParam0)
{
	...
	{
		unk_0xFA51DC22F6E34F6E(unk_0x9F92518438215DD0(), -1243.316f, -1041.637f, 7.5121f, 1, 0, 0, 1);
		unk_0x03D97EDECF2E1859(unk_0x9F92518438215DD0(), 28.2f);
	}
	func_400(500, 1);
}
...
void func_414(bool bParam0)
{
	...
	while (iLocal_249 <= 1)
	{
		...
		if (bParam0)
		{
			...
			if (!iLocal_244)
			{
				unk_0x3BC6D217451D6BB7(iLocal_246);
				unk_0x3BC6D217451D6BB7(iLocal_245);
			}
			iLocal_244 = 1;
		}
		else
...
{
	unk_0x3BC6D217451D6BB7(Local_144.f_5);
	unk_0x3BC6D217451D6BB7(iLocal_158);
	while (!unk_0x149162179DBAEDB0(Local_144.f_5) || !unk_0x149162179DBAEDB0(iLocal_158))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (func_201(Local_144.f_4))
	{
		if (bLocal_151)
		{
			unk_0x147A431959878235(Local_144.f_4);
			bLocal_151 = false;
		}
	}
	if (bParam4)
	...
	func_203(&uLocal_154);
	func_200(&(Local_144.f_4));
	Local_144.f_4 = unk_0xB0694AD0A3BB8936(Local_144.f_5, Param0, fParam3, 1, 1);
	unk_0xDFA36C740458266A(Local_144.f_4, 1);
	if (bParam4)
	{
		func_416(unk_0x9F92518438215DD0(), Local_144.f_4, -1);
	}
	unk_0x7FAB46C418640A64(Local_144.f_4, 0);
	unk_0x629271E0FB6556E2(Local_144.f_4, 0);
	unk_0x17E8CB2415E3DCFE(Local_144.f_4, 1);
	unk_0xA27F610688163CA9(Local_144.f_4, 1);
	unk_0x013A216DDFCAE218(Local_144.f_4);
	unk_0x2125574BF8773B98(Local_144.f_4, 1, 1);
	unk_0x2125574BF8773B98(Local_144.f_4, 2, 1);
	unk_0x2125574BF8773B98(Local_144.f_4, 3, 1);
	uLocal_154 = unk_0xA7DA1E6D4C99864B(iLocal_158, Param0, 1, 1, 0);
	unk_0x80BA810554025DFF(uLocal_154, Local_144.f_4, 0, Local_155, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
	unk_0x4220BD8C5CDBF540(uLocal_154, 1, 0);
	bLocal_151 = true;
	func_395(Local_144.f_4, 0);
	unk_0x0880E86251A44B7F(Local_144.f_5);
	unk_0x0880E86251A44B7F(iLocal_158);
}
...
void func_416(int iParam0, int iParam1, int iParam2)
{
	if (func_402(uParam0))
	{
		if (func_201(uParam1))
		{
			...
			unk_0x4DB6897DB04DE279(uParam0, uParam1, iParam2);
		}
	}
}
...
void func_419(bool bParam0)
{
	...
	if (bParam0)
	{
		if (!unk_0x746960881FB19A89(Local_144.f_4))
		{
...
void func_424()
{
	unk_0x9C53AD1E8A38ADEE("BARR3A", 0);
	Local_144.f_5 = joaat("dloader");
	Local_144 = { 1199.8f, -1259.22f, 34.23f };
	Local_144.f_3 = 174.7f;
	if (func_201(unk_0x9F92518438215DD0()))
	{
		func_230(&uLocal_250, 1, unk_0x9F92518438215DD0(), "FRANKLIN", 0, 1);
	}
	iLocal_431 = 0;
	iLocal_442 = 0;
	iLocal_425 = 0;
	...
	sLocal_448 = "DEFAULT";
	func_425(49, 1, 0);
	uLocal_163[0] = unk_0x676E460800A9E1B7(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
	uLocal_163[1] = unk_0x676E460800A9E1B7(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
...
void func_431()
{
	...
	unk_0xD643E324F7E6A17B(uLocal_163[0], 0);
	unk_0xD643E324F7E6A17B(uLocal_163[1], 0);
	unk_0xA65F8C84413BA46B(0);
...
int func_442(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_445())
	{
		...
		{
			iVar33 = func_305(unk_0xC2E9075570B5D2B9());
			if (iVar33 > -1)
			{
