...
void __EntryFunction__()
{
	...
	if (unk_0x9315DBF7D972F07A())
	{
		...
		{
			if (func_225(unk_0x9E2D6C50374FCFA9()) != 1 && !BitTest(Global_2810701.f_900.f_7, 0))
			{
				func_226();
			}
		}
	...
	while (true)
	{
		...
		if (ScriptParam_0.f_16 >= 32)
		{
			if (func_225(unk_0x9E2D6C50374FCFA9()) != 1 && Global_1889770 == 0)
			{
				func_226();
			}
		}
		if (unk_0x0843570206F71F38() != iLocal_173)
		{
			func_226();
		}
		...
		switch (func_216(unk_0xF1354995C6159A78()))
		{
			case 0:
				if (func_215())
				{
					if (func_214() == 1)
					{
						Local_71[unk_0xF1354995C6159A78() /*3*/] = 1;
					}
					else if (func_214() == 4)
					{
						Local_71[unk_0xF1354995C6159A78() /*3*/] = 3;
					}
				}
				break;
			...
			case 1:
				...
				if (Local_71[unk_0xF1354995C6159A78() /*3*/].f_2 == 0)
				{
					if ((!unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_60.f_3, 500f, 500f, 500f, 0, 1, 0) && func_225(unk_0x9E2D6C50374FCFA9()) != 1) && !BitTest(Global_2810701.f_900.f_7, 0))
					{
						Local_71[unk_0xF1354995C6159A78() /*3*/] = 4;
					}
				}
				break;
...
int func_2()
{
	if (Local_60.f_7 >= 32 && func_225(unk_0x9E2D6C50374FCFA9()) == 1)
	{
		if (func_4(Global_2810701.f_900.f_1))
		{
			return 1;
		}
	}
	...
	if (!unk_0xCCDCD6672DAE6835(Local_60.f_2))
	{
		if (func_215())
		{
			if (unk_0x853FFA3D0A54864F(1))
			{
				...
				{
					Var0 = { Global_2810701.f_900.f_1 };
					uVar3 = Global_2810701.f_900.f_4;
				}
				if (func_225(unk_0x9E2D6C50374FCFA9()) == 7)
				{
					iVar12 = unk_0x0E40F846A70BA3EC(unk_0x9E2D6C50374FCFA9());
					if (Global_4718592.f_595[iVar12 /*17044*/].f_2325[0 /*36*/].f_23 > 0f)
					{
						Var6 = { Global_4718592.f_595[iVar12 /*17044*/].f_2325[0 /*36*/].f_16 };
						Var9 = { Global_4718592.f_595[iVar12 /*17044*/].f_2325[0 /*36*/].f_19 };
						fVar5 = Global_4718592.f_595[iVar12 /*17044*/].f_2325[0 /*36*/].f_23;
						iVar4 = 1;
					}
					else if (Global_4718592.f_595[iVar12 /*17044*/].f_2325[0 /*36*/].f_22 > 0f)
					{
						Var6 = { Global_4718592.f_595[iVar12 /*17044*/].f_2325[0 /*36*/].f_13 };
						fVar5 = Global_4718592.f_595[iVar12 /*17044*/].f_2325[0 /*36*/].f_22;
					}
				}
				...
				if (iVar4 == 0)
				{
					if (BitTest(Local_60.f_1, 8) || func_184(Var6, fVar5, &Var0, &uVar3, &Var13))
					{
						if (Local_60.f_7 >= 32 || func_225(unk_0x9E2D6C50374FCFA9()) == 1)
						{
						...
						unk_0xBBF86885619695CE(unk_0xE8BBC6CC2C60F24A(Local_60.f_2), uVar3);
					}
				}
...
int func_9(var uParam0, var uParam1, var uParam2)
{
	...
	{
		case 0:
			if (((!Global_2667223.f_2466 == *uParam0 || !Global_2667223.f_2466.f_1 == uParam0->f_1) || !Global_2667223.f_2466.f_2 == uParam0->f_2) || !Global_2667223.f_2469 == uParam0->f_4)
			{
				bVar25 = true;
			}
			break;
		...
		case 1:
			if (((((!Global_2667223.f_2480 == uParam0->f_8 || !Global_2667223.f_2480.f_1 == uParam0->f_8.f_1) || !Global_2667223.f_2480.f_2 == uParam0->f_8.f_2) || !Global_2667223.f_2483 == uParam0->f_11) || !Global_2667223.f_2483.f_1 == uParam0->f_11.f_1) || !Global_2667223.f_2483.f_2 == uParam0->f_11.f_2)
			{
				bVar25 = true;
			}
			break;
		...
		case 2:
			if ((((((!Global_2667223.f_2480 == uParam0->f_8 || !Global_2667223.f_2480.f_1 == uParam0->f_8.f_1) || !Global_2667223.f_2480.f_2 == uParam0->f_8.f_2) || !Global_2667223.f_2483 == uParam0->f_11) || !Global_2667223.f_2483.f_1 == uParam0->f_11.f_1) || !Global_2667223.f_2483.f_2 == uParam0->f_11.f_2) || !Global_2667223.f_2486 == uParam0->f_14)
			{
				bVar25 = true;
			}
			break;
	...
	if (Global_1574477)
	{
		if (!Global_2667223.f_2487 == uParam0->f_7)
		{
			bVar25 = true;
		}
		if (unk_0x87C0DA419F19FF57(Global_2667223.f_2473) && !Global_2667223.f_2473 == unk_0x69CE66B03B2184EB())
		{
			bVar25 = true;
		}
	}
	if (bVar25)
	{
		if (Global_2667223.f_2464 == 1)
		{
			if (unk_0x87C0DA419F19FF57(Global_2667223.f_2473))
			{
				if (Global_2667223.f_2473 == unk_0x69CE66B03B2184EB())
				{
					if (unk_0x780A854E3A976A66(unk_0x0A89FDFA763DCAED(), Global_2667223.f_2470) < func_183(0))
					{
						return 0;
					}
				}
				else if (unk_0x780A854E3A976A66(unk_0x0A89FDFA763DCAED(), Global_2667223.f_2470) < func_183(0))
				{
					return 0;
				}
			}
		...
		Global_2667223.f_2464 = 0;
	}
	else if (unk_0x780A854E3A976A66(unk_0x0A89FDFA763DCAED(), Global_2667223.f_2470) > func_183(0))
	{
		Global_2667223.f_2471 = unk_0x0A89FDFA763DCAED();
		func_176();
	}
	switch (uParam0->f_7)
	{
	...
	if (!Global_2667223.f_2464)
	{
		...
		{
			Global_2667223.f_2487 = uParam0->f_7;
			switch (uParam0->f_7)
			{
				case 0:
					Global_2667223.f_2466 = { *uParam0 };
					Global_2667223.f_2469 = uParam0->f_4;
					break;
				
				case 1:
					Global_2667223.f_2480 = { uParam0->f_8 };
					Global_2667223.f_2483 = { uParam0->f_11 };
					Global_2667223.f_2486 = 0f;
					Global_2667223.f_2466 = { uParam0->f_8 + uParam0->f_11 / Vector(2f, 2f, 2f) };
					break;
				
				case 2:
					Global_2667223.f_2480 = { uParam0->f_8 };
					Global_2667223.f_2483 = { uParam0->f_11 };
					Global_2667223.f_2486 = uParam0->f_14;
					Global_2667223.f_2466 = { uParam0->f_8 + uParam0->f_11 / Vector(2f, 2f, 2f) };
					break;
			}
			...
			Global_2667223.f_2465 = 1;
			Global_2667223.f_2464 = 1;
			Global_2667223.f_2471 = unk_0x0A89FDFA763DCAED();
			Global_2667223.f_2470 = unk_0x0A89FDFA763DCAED();
			Global_2667223.f_2473 = unk_0x69CE66B03B2184EB();
		}
		else
		{
			return 0;
	...
	if (Global_2667223.f_2464)
	{
		if (Global_2667223.f_2465 == 1)
		{
			if (unk_0xF8805443C3DB6256(fVar4, fVar5, fVar6, fVar7) || unk_0x780A854E3A976A66(unk_0x0A89FDFA763DCAED(), Global_2667223.f_2471) > 5000)
			{
				Global_2667223.f_2471 = unk_0x0A89FDFA763DCAED();
				if (uParam1->f_8 || uParam1->f_9)
				{
					...
					if (func_173(Global_4718592.f_138376))
					{
						Var26.f_9 = 1;
					}
					...
					Global_2667223.f_2465 = 9;
				}
				else
				{
					Global_2667223.f_2465 = 2;
				}
			}
		}
		if (Global_2667223.f_2465 == 2)
		{
			if ((unk_0x422C66E6B46D5AEF(Var11, Var14) || unk_0x780A854E3A976A66(unk_0x0A89FDFA763DCAED(), Global_2667223.f_2471) > 15000) || unk_0xE64C2E86EAC945DD(Var11, Var14) == 0)
			{
				Global_2667223.f_2471 = unk_0x0A89FDFA763DCAED();
				if (uParam0->f_5 && !func_142(unk_0x9E2D6C50374FCFA9(), 0))
				{
					Global_2667223.f_2465 = 3;
				}
				else
				{
					Global_2667223.f_2465 = 4;
				}
			}
			else if (unk_0x780A854E3A976A66(unk_0x0A89FDFA763DCAED(), Global_2667223.f_2475) > 7000)
			{
				func_141(Var8.f_0, Var8.f_1);
			}
		}
		if (Global_2667223.f_2465 == 3)
		{
			if (func_140() || unk_0x780A854E3A976A66(unk_0x0A89FDFA763DCAED(), Global_2667223.f_2471) > 10000)
			{
				Global_2667223.f_2471 = unk_0x0A89FDFA763DCAED();
				Global_2667223.f_2465 = 4;
			}
		}
		if (Global_2667223.f_2465 == 4)
		{
			if (unk_0xCCD530822438FEA4())
			{
				unk_0x8CAEA922D207D693();
				...
				if (uParam0->f_5)
				{
					...
					switch (uParam0->f_7)
					{
						case 0:
							...
							{
								Global_2667223.f_2471 = unk_0x0A89FDFA763DCAED();
								Global_2667223.f_2465 = 5;
							}
							break;
						
						case 1:
							func_139(uParam0->f_8, uParam0->f_11, &Var18, &Var21, &uVar24);
		...
		if (Global_2667223.f_2465 == 5)
		{
			if (func_64(uParam2, uParam0, uParam1, 0))
			{
				if (Global_2667223.f_2491.f_5)
				{
					Global_2667223.f_2471 = unk_0x0A89FDFA763DCAED();
					Global_2667223.f_2465 = 6;
				}
				else
				{
					Global_2667223.f_2471 = unk_0x0A89FDFA763DCAED();
			...
			else if (unk_0x780A854E3A976A66(unk_0x0A89FDFA763DCAED(), Global_2667223.f_2471) > 20000)
			{
				unk_0x8CAEA922D207D693();
				unk_0x3D9CB48B182F9F3B();
				Global_2667223.f_2471 = unk_0x0A89FDFA763DCAED();
				Global_2667223.f_2465 = 8;
			}
		}
		if (Global_2667223.f_2465 == 6)
		{
			iVar0 = 0;
			Global_2667223.f_2491.f_1 = 0;
			if (uParam1->f_3)
			{
				iVar0++;
			}
			...
			if (func_64(uParam2, uParam0, uParam1, 1))
			{
				if (unk_0x652D2EEEF1D3E62C(*(uParam2[0 /*3*/])) == 0f)
				{
					...
					while (iVar17 < 3)
					{
						if (unk_0x652D2EEEF1D3E62C(*(uParam2[0 /*3*/])) == 0f)
						{
							if (!unk_0x652D2EEEF1D3E62C(Global_2667223.f_2625[iVar17 /*3*/]) == 0f)
							{
								switch (uParam0->f_7)
								{
									case 0:
										if (func_145(Global_2667223.f_2625[iVar17 /*3*/], *uParam0, uParam0->f_4, 0, 0))
										{
											*(uParam2[0 /*3*/]) = { Global_2667223.f_2625[iVar17 /*3*/] };
										}
										break;
									
									case 1:
										if (func_60(Global_2667223.f_2625[iVar17 /*3*/], uParam0->f_8, uParam0->f_11, 0, 0))
										{
											*(uParam2[0 /*3*/]) = { Global_2667223.f_2625[iVar17 /*3*/] };
										}
										break;
									...
									case 2:
										if (unk_0x5F8653E60ED2288E(Global_2667223.f_2625[iVar17 /*3*/], uParam0->f_8, uParam0->f_11, uParam0->f_14, 0, 1))
										{
											*(uParam2[0 /*3*/]) = { Global_2667223.f_2625[iVar17 /*3*/] };
										}
										break;
		...
		if (Global_2667223.f_2465 == 8)
		{
			if (uParam0->f_5)
			{
				if (func_11(Global_2667223.f_489))
				{
				}
			}
			else if (Global_2667223.f_2491.f_2)
			{
				func_10(uParam2, &(Global_2667223.f_2491.f_6));
			}
			else
			{
				if (uParam0->f_15)
				...
				*(uParam2[0 /*3*/]) = { Global_2667223.f_2466 };
				func_12(uParam2[0 /*3*/], 0, bVar87, 0, 0, uParam0, uParam1);
			}
			Global_2667223.f_2471 = unk_0x0A89FDFA763DCAED();
			Global_2667223.f_2465 = 9;
		}
		if (Global_2667223.f_2465 == 9)
		{
			Global_2667223.f_2464 = 0;
			unk_0x8CAEA922D207D693();
			unk_0x3D9CB48B182F9F3B();
		...
		if (uParam5->f_5)
		{
			...
			else
			{
				switch (uParam5->f_7)
				{
					case 0:
						Var69 = { *uParam5 };
						if (func_63(uParam5->f_4) || !unk_0xBCC73B466E2B2350(unk_0xA0F62C1038208492(Var69)))
						{
							iVar68 += 4;
						}
						break;
					...
					case 1:
						...
						if (func_62(uParam5->f_8, uParam5->f_11, 0f) || !unk_0xBCC73B466E2B2350(unk_0xA0F62C1038208492(Var69)))
						{
							iVar68 += 4;
						}
						break;
					...
					case 2:
						Var69 = { uParam5->f_8 + uParam5->f_11 * Vector(0.5f, 0.5f, 0.5f) };
						if (func_62(uParam5->f_8, uParam5->f_11, uParam5->f_14) || !unk_0xBCC73B466E2B2350(unk_0xA0F62C1038208492(Var69)))
						{
							iVar68 += 4;
						}
						break;
...
int func_13(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < 12)
	{
		if (Global_2672167[iVar0 /*17*/].f_9 == 1)
		{
			...
			{
				if (func_22(*uParam0, &(Global_2672167[iVar0 /*17*/]), 1008981770, bParam4, 0))
				{
					if (bParam1)
					{
						...
						{
							Var1 = { *uParam0 };
							func_14(&Var1, &(Global_2672167[iVar0 /*17*/]), 1036831949, 0, bParam3);
							if (func_13(&Var1, 0, 0, 0, 1))
							{
								Var1 = { *uParam0 };
								func_14(&Var1, &(Global_2672167[iVar0 /*17*/]), 1036831949, 1, 0);
							}
							*uParam0 = { Var1 };
						}
					}
...
void func_14(var uParam0, var uParam1, float fParam2, bool bParam3, bool bParam4)
{
	if (bParam4)
	{
		...
		{
			case 0:
				*uParam0 = { func_21(*uParam0, *uParam1, 0f, 0f, 0f, (uParam1->f_6 + (IntToFloat(Global_2667223.f_2735) * uParam1->f_8)), 0, fParam2, bParam3) };
				break;
	...
	else
	{
		...
		{
			case 0:
				func_19(uParam0, *uParam1, (uParam1->f_6 + (IntToFloat(Global_2667223.f_2735) * uParam1->f_8)), fParam2, bParam3, 0);
				break;
...
int func_22(struct<3> Param0, var uParam3, float fParam4, bool bParam5, bool bParam6)
{
	...
	{
		case 0:
			return func_145(Param0, *uParam3, ((uParam3->f_6 + fParam4) + (IntToFloat(Global_2667223.f_2735) * uParam3->f_8)), bParam5, bParam6);
			break;
...
int func_24(int iParam0, bool bParam1)
{
	...
	if (iParam0 != func_27())
	{
		...
		{
			if (Global_2689224[iParam0 /*451*/].f_317.f_6 != -1 && Global_2689224[iParam0 /*451*/].f_317.f_9 != func_27())
			{
				return func_25(Global_2689224[iParam0 /*451*/].f_317.f_6) == 12;
			}
		}
	}
	return 0;
...
int func_29(struct<3> Param0, var uParam3, int iParam4, bool bParam5)
{
	...
	if (fVar0 < 40f)
	{
		uVar1 = 2;
		uVar8 = 2;
		if ((iParam4 == 1 && !func_45(Global_2667223.f_512, uParam3, &uVar1, &uVar8, bParam5, 1)) || iParam4 == 0)
		{
...
int func_30(var uParam0, bool bParam1)
{
	...
	iVar4 = func_32(Var1);
	iVar0 = 0;
	while (iVar0 < Global_2673768[iVar4])
	{
		if (func_31(Var1, &(Global_2672372[iVar4 /*155*/][iVar0 /*7*/])))
		{
			if (bParam1)
			{
				func_15(&Var1, Global_2672372[iVar4 /*155*/][iVar0 /*7*/], Global_2672372[iVar4 /*155*/][iVar0 /*7*/].f_3, Global_2672372[iVar4 /*155*/][iVar0 /*7*/].f_6, 1036831949, 0);
				*uParam0 = { Var1 };
			}
			return 1;
		}
	...
	iVar0 = 0;
	while (iVar0 < Global_2673768[8])
	{
		if (func_31(Var1, &(Global_2672372[8 /*155*/][iVar0 /*7*/])))
		{
			if (bParam1)
			{
				func_15(&Var1, Global_2672372[8 /*155*/][iVar0 /*7*/], Global_2672372[8 /*155*/][iVar0 /*7*/].f_3, Global_2672372[8 /*155*/][iVar0 /*7*/].f_6, 1036831949, 0);
				*uParam0 = { Var1 };
			}
			return 1;
		}
	...
	if (func_42(unk_0x9E2D6C50374FCFA9(), 1, 0))
	{
		...
		if (Global_4980736.f_72844 > 0)
		{
			...
			while (iVar0 < Global_4980736.f_72844)
			{
				...
				{
					if (func_34(Param0, Global_4980736.f_72848[iVar0 /*435*/], Global_4980736.f_72848[iVar0 /*435*/].f_3, Global_4980736.f_72848[iVar0 /*435*/].f_12, 0.5f))
					{
						return 1;
					}
				}
		...
		if (Global_1058068.f_268 > 0)
		{
			...
			while (iVar0 < Global_1058068.f_268)
			{
				...
				{
					if (func_34(Param0, unk_0x6B62510F212526DC(Global_1058068.f_233[iVar0], 1), unk_0x82FE2343F8BDFF0B(Global_1058068.f_233[iVar0]), unk_0x15CAA6D7B11F1A7C(Global_1058068.f_233[iVar0]), 0.5f))
					{
						return 1;
					}
				}
		...
		if (Global_1058068.f_266 > 0)
		{
			...
			while (iVar0 < Global_1058068.f_266)
			{
				...
				{
					if (func_34(Param0, unk_0x6B62510F212526DC(Global_1058068.f_119[iVar0], 1), unk_0x82FE2343F8BDFF0B(Global_1058068.f_119[iVar0]), unk_0x15CAA6D7B11F1A7C(Global_1058068.f_119[iVar0]), 0.5f))
					{
						return 1;
					}
				}
...
void func_37(int iParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5)
{
	...
	func_38(iParam0, &Global_1577988);
	iVar0 = 0;
	while (iVar0 < 2)
	{
...
int func_47(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (func_49(*uParam0, &iVar0))
	{
		...
		{
			Var2 = { *uParam0 };
			func_14(&Var2, &(Global_2667223.f_368[iVar0 /*12*/]), 1036831949, 0, bParam2);
			if (func_49(Var2, &uVar1) || func_48(Var2))
			{
				Var2 = { *uParam0 };
				func_14(&Var2, &(Global_2667223.f_368[iVar0 /*12*/]), 1036831949, 1, bParam2);
			}
			*uParam0 = { Var2 };
		}
		return 1;
...
int func_49(struct<3> Param0, var uParam3)
{
	...
	while (iVar0 < iVar1)
	{
		...
		{
			if (func_22(Param0, &(Global_2667223.f_368[iVar0 /*12*/]), 1008981770, 0, 0))
			{
				*uParam3 = iVar0;
				return 1;
			}
	...
	if (!Global_2667223.f_515 && !Global_2667223.f_516)
	{
		if (!Global_2667223.f_45.f_317)
		{
			...
			else
			{
				...
				if (iVar0 > -1)
				{
					Var1 = { func_53(&(Global_2667223.f_45[iVar0 /*12*/])) };
					if (!func_13(&Var1, 0, 0, 0, 1))
					{
						if (!func_13(&Param0, 0, 0, 0, 1))
						{
...
int func_54(struct<3> Param0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_22(Param0, &(Global_2667223.f_45[iVar0 /*12*/]), fParam3, 0, 0))
			{
				return iVar0;
			}
		}
...
int func_59(struct<3> Param0, var uParam3)
{
	...
	iVar1 = -1;
	fVar2 = 999999.9f;
	if (Global_2667223.f_2262 > 0)
	{
		iVar0 = 0;
		while (iVar0 < Global_2667223.f_2262)
		{
			fVar3 = unk_0x2A488C176D52CCA5(Global_2667223.f_2263[iVar0 /*4*/], Param0);
			if (fVar3 < fVar2)
			{
				iVar1 = iVar0;
				fVar2 = fVar3;
		...
		if (!iVar1 == -1)
		{
			*uParam3 = { Global_2667223.f_2263[iVar1 /*4*/] };
			return 1;
		}
	}
	return 0;
...
int func_64(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (Global_2667223.f_2491.f_1 == 0 && Global_2667223.f_2491 == 0)
	{
		if (uParam1->f_5 && !bParam3)
		{
			switch (unk_0xFCB1DFEFD6237222(&(Global_2667223.f_2491.f_1)))
			{
				case 0:
					func_137(uParam1, uParam2);
					if (!Global_2667223.f_2491.f_2)
					{
						if (uParam2->f_7 && Global_2667223.f_555.f_7 == 0)
						{
							*(uParam0[0 /*3*/]) = { *uParam1 };
						...
						else
						{
							...
							{
								*(uParam0[0 /*3*/]) = { Global_2667223.f_2466 };
							}
							if (uParam1->f_5 && func_11(Global_2667223.f_489))
							{
								if (!Global_2667223.f_2491.f_5)
								{
									Global_2667223.f_2491.f_5 = 1;
								}
								else
								{
		...
		else if (unk_0xCCD530822438FEA4())
		{
			if (!unk_0xD41858BE1441F8A7())
			{
				...
				{
					func_137(uParam1, uParam2);
					Global_2667223.f_2491.f_1 = unk_0x040E56A95FCFB423();
				}
				else
				{
					return 0;
	...
	if (uParam1->f_5)
	{
		func_134(Global_2667223.f_555, &(Global_2667223.f_2491.f_57), &(Global_2667223.f_2491.f_90));
	}
	if (uParam2->f_7 && !Global_2667223.f_2491.f_4)
	{
		Global_2667223.f_2491.f_4 = 1;
	...
	if (Global_2667223.f_2491.f_1 > 0 || Global_2667223.f_2491 > 0)
	{
		...
		{
			iVar4 = 0;
			while (iVar4 < Global_2667223.f_2491.f_1)
			{
				if (iVar6 < iVar7)
				{
					if (iVar4 <= Global_2667223.f_2491.f_3)
					{
						iVar4 = Global_2667223.f_2491.f_3 + 1;
					}
					if (iVar4 > (Global_2667223.f_2491.f_1 - 1))
					{
						iVar4 = (Global_2667223.f_2491.f_1 - 1);
					}
					if (iVar4 < 0)
					{
						iVar4 = 0;
					...
					iVar6++;
					Global_2667223.f_2491.f_3 = iVar4;
				}
				else
				{
					return 0;
		...
		{
			iVar4 = Global_2667223.f_2491.f_1;
		}
		if (Global_2667223.f_2491.f_1 == iVar4)
		{
			if (uParam1->f_5 && Global_2667223.f_2889)
			{
				func_66(&(Global_2667223.f_2491.f_6[0 /*10*/]), &(Global_2667223.f_2491.f_6[1 /*10*/]), &(Global_2667223.f_2491.f_6[2 /*10*/]));
			}
			if (uParam1->f_5 && func_11(Global_2667223.f_489))
			{
				if (Global_2667223.f_2491.f_2)
				{
					func_10(uParam0, &(Global_2667223.f_2491.f_6));
					func_65(*(uParam0[0 /*3*/]));
					return 1;
				}
				else
			...
			{
				iVar4 = unk_0x5853B15F78E1A265(0, Global_2667223.f_2491.f_1);
...
void func_65(struct<3> Param0)
{
	...
	while (iVar0 < 2)
	{
		if (iVar0 > 0)
		{
			Global_2667223.f_2625[(3 - iVar0) /*3*/] = { Global_2667223.f_2625[(3 - iVar0 + 1) /*3*/] };
		}
		iVar0++;
	}
	Global_2667223.f_2625[0 /*3*/] = { Param0 };
}

void func_66(var uParam0, var uParam1, var uParam2)
{
	if (func_11(Global_2667223.f_489) && func_71() < 4096)
	{
		func_70(uParam0, 0f);
...
void func_67(var uParam0, struct<3> Param1, struct<3> Param4)
{
	...
	while (iVar0 < 128)
	{
		if (Global_2670166[iVar0 /*10*/] > 0)
		{
			fVar2 = unk_0x2A488C176D52CCA5(Global_2670166[iVar0 /*10*/].f_4, Param1);
			fVar3 = unk_0x2A488C176D52CCA5(Global_2670166[iVar0 /*10*/].f_4, Param4);
			fVar4 = (fVar2 + fVar3);
			fVar4 = (fVar4 * Global_2670166[iVar0 /*10*/].f_1);
			if (fVar4 > fVar1)
			{
				fVar1 = fVar4;
				Var5 = { Global_2670166[iVar0 /*10*/] };
			}
		}
		iVar0++;
	}
...
void func_68(var uParam0, struct<3> Param1)
{
	...
	while (iVar0 < 128)
	{
		...
		{
			fVar2 = unk_0x2A488C176D52CCA5(Global_2670166[iVar0 /*10*/].f_4, Param1);
			fVar2 = (fVar2 * Global_2670166[iVar0 /*10*/].f_1);
			if (fVar2 > fVar1)
			{
				fVar1 = fVar2;
				Var3 = { Global_2670166[iVar0 /*10*/] };
			}
		}
		iVar0++;
	}
...
void func_69(var uParam0)
{
	...
	while (iVar0 < 128)
	{
		if (Global_2670166[iVar0 /*10*/] > 0)
		{
			if (Global_2670166[iVar0 /*10*/].f_1 > fVar1)
			{
				fVar1 = Global_2670166[iVar0 /*10*/].f_1;
				Var2 = { Global_2670166[iVar0 /*10*/] };
			}
		}
		iVar0++;
	}
...
void func_70(var uParam0, float fParam1)
{
	...
	while (iVar0 < 128)
	{
		if (Global_2670166[iVar0 /*10*/] > 0)
		{
			if (Global_2670166[iVar0 /*10*/].f_2 < fVar1 && Global_2670166[iVar0 /*10*/].f_2 > fParam1)
			{
				fVar1 = Global_2670166[iVar0 /*10*/].f_2;
				Var2 = { Global_2670166[iVar0 /*10*/] };
			}
		}
		iVar0++;
...
int func_71()
{
	...
	while (iVar0 < 128)
	{
		if (Global_2670166[iVar0 /*10*/] > iVar1)
		{
			iVar1 = Global_2670166[iVar0 /*10*/];
		}
		iVar0++;
	}
	return iVar1;
...
void func_72(struct<3> Param0, float fParam3, var uParam4, var uParam5, bool bParam6, int iParam7)
{
	...
	if (uParam4->f_5)
	{
		if (Global_2667223.f_489 == 1)
		{
			if (unk_0x48053974ED6F63CE((Global_2667223.f_512.f_2 - Param0.f_2)) < 25f)
			{
				iVar8++;
			}
		}
	...
	if (uParam4->f_5)
	{
		if (!Global_2667223.f_701)
		{
			Var12 = { Global_2667223.f_512 };
			if (Global_2667223.f_489 == 26)
			{
				Var12 = { Global_2667223.f_555.f_18 };
			}
	...
	if (uParam4->f_5)
	{
		...
		{
			if (!func_110(&Param0, &(Global_2667223.f_2491.f_90), 0, 1065353216))
			{
				iVar8 += 1024;
			}
		}
	...
	if (uParam4->f_5)
	{
		...
		{
			if (!func_109(Param0, &(Global_2667223.f_2491.f_57), &(Global_2667223.f_2491.f_90), 1073741824))
			{
				iVar8 += 2048;
			}
		}
	...
	else
	{
		...
		if (iVar16 > -1)
		{
			...
			if (!func_101(&(Global_2667223.f_45[iVar16 /*12*/]), Var17, Var20, fVar23))
			{
				iVar8 = -1;
			}
		}
	...
	bVar35 = false;
	bVar36 = false;
	if (Global_2667223.f_2889 && uParam4->f_5)
	{
		if (iVar8 > 0)
		{
			if (bParam6)
			...
			{
				fVar0 = func_91(Param0, Global_2667223.f_2466, uParam5->f_6, uParam5->f_4, bVar4, iVar10, &(Var25.f_8));
			}
			if (bVar9)
			{
				fVar0 = (fVar0 * 3f);
			}
			if (func_11(Global_2667223.f_489) && iVar8 < 4096)
			{
	...
	else
	{
		...
		while (iVar24 < 5)
		{
			if (iVar8 >= Global_2667223.f_2491.f_6[iVar24 /*10*/])
			{
				if (uParam4->f_5)
				{
					if (!bVar35)
					...
					if ((func_11(Global_2667223.f_489) && iVar8 == Global_2667223.f_2491.f_6[iVar24 /*10*/]) && iVar8 < 4096)
					{
						if (!bVar36)
						{
						...
						if (fVar2 < Global_2667223.f_2491.f_6[iVar24 /*10*/].f_2)
						{
							Var25.f_4 = { Param0 };
							Var25.f_7 = fParam3;
							Var25.f_0 = iVar8;
					...
					else if (iVar8 > Global_2667223.f_2491.f_6[iVar24 /*10*/] || (iVar8 == Global_2667223.f_2491.f_6[iVar24 /*10*/] && fVar0 > Global_2667223.f_2491.f_6[iVar24 /*10*/].f_1))
					{
						Var25.f_4 = { Param0 };
						Var25.f_7 = fParam3;
						Var25.f_0 = iVar8;
				...
				else
				{
					...
					if (iVar8 > Global_2667223.f_2491.f_6[iVar24 /*10*/] || (iVar8 == Global_2667223.f_2491.f_6[iVar24 /*10*/] && fVar3 > Global_2667223.f_2491.f_6[iVar24 /*10*/].f_3))
					{
						Var25.f_4 = { Param0 };
						Var25.f_7 = fParam3;
						Var25.f_0 = iVar8;
...
void func_76(struct<10> Param0, int iParam10)
{
	...
	Var0.f_2 = 1176256410;
	Var0 = { Global_2667223.f_2491.f_6[iParam10 /*10*/] };
	Global_2667223.f_2491.f_6[iParam10 /*10*/] = { Param0 };
	if (iParam10 < 4)
	{
...
void func_77(struct<10> Param0)
{
	...
	while (iVar0 < 128)
	{
		if (Global_2670166[iVar0 /*10*/] < iVar11)
		{
			Global_2670166[iVar0 /*10*/] = { Var1 };
		}
		iVar0++;
	}
	if (Param0.f_0 < iVar11)
	...
	while (iVar0 < 128)
	{
		if (Global_2670166[iVar0 /*10*/] == 0)
		{
			Global_2670166[iVar0 /*10*/] = { Param0 };
			return;
		}
		iVar0++;
	}
	...
	while (iVar0 < 128)
	{
		if (Global_2670166[iVar0 /*10*/] > 0)
		{
			if (Global_2670166[iVar0 /*10*/].f_1 < fVar12)
			{
				fVar12 = Global_2670166[iVar0 /*10*/].f_1;
				iVar13 = iVar0;
			}
		}
		iVar0++;
	...
	if (iVar13 > -1)
	{
		Global_2670166[iVar13 /*10*/] = { Param0 };
	}
}
		...
		if (func_26(iVar11, 1, 1) || (iParam7 == 1 && func_26(iVar11, 0, 0)))
		{
			if (!iVar11 == unk_0x9E2D6C50374FCFA9() || iParam5 == 1)
			{
				...
				if (bParam4)
				{
					...
					{
						if (!unk_0x0E40F846A70BA3EC(iVar11) == -1 || !func_56(unk_0x9E2D6C50374FCFA9(), 1))
						{
							bVar4 = true;
						}
					}
...
int func_81(int iParam0)
{
	...
	Global_2783316 = { func_84(iParam0) };
...
int func_85(int iParam0, var uParam1)
{
	...
	{
		Global_2783316 = { func_84(iParam0) };
		Global_2783329 = { func_84(uParam1) };
...
float func_89(struct<3> Param0)
{
	...
	return func_90(Param0, &(Global_2667223.f_45), &uVar0);
}
		...
		if ((uParam3[iVar0 /*12*/])->f_9)
		{
			...
			switch ((uParam3[iVar0 /*12*/])->f_10)
			{
				case 0:
					...
					fVar1 = (fVar1 - ((uParam3[iVar0 /*12*/])->f_6 + (IntToFloat(Global_2667223.f_2735) * (uParam3[iVar0 /*12*/])->f_8)));
					break;
...
float func_91(struct<3> Param0, struct<3> Param3, bool bParam6, bool bParam7, bool bParam8, int iParam9, var uParam10)
{
	...
	*uParam10 = 1E+07f;
	...
	if (bParam8)
	{
		fVar0 = func_73(unk_0x2A488C176D52CCA5(Global_2667223.f_512, Param0), 0f, 100f, 200f, 0.1f, 0.1f);
			...
			if (!iParam3 == iVar2 || iParam4 == 1)
			{
				...
				if (func_26(iVar3, 0, 1))
				{
					if (unk_0x0E40F846A70BA3EC(iVar3) != unk_0x0E40F846A70BA3EC(iParam3) || (unk_0x0E40F846A70BA3EC(iVar3) == -1 && unk_0x0E40F846A70BA3EC(iParam3) == -1))
					{
						...
						{
							if (Global_2680263.f_261[iVar2])
							{
								fVar1 = unk_0x2A488C176D52CCA5(Global_2680263.f_131[iVar2 /*3*/], Param0);
								if (fVar1 < fVar0)
								{
									fVar0 = fVar1;
								}
...
float func_95(struct<3> Param0)
{
	...
	if (Global_2667223.f_2934)
	{
		if (Global_1058068.f_267 > 0)
		{
			iVar2 = 0;
			while (iVar2 < Global_1058068.f_267)
			{
				if (unk_0xE5965CDF24F93A9F(Global_1058068.f_152[iVar2]))
				{
					if (!unk_0x55B23FE400FCEA6B(Global_1058068.f_152[iVar2], 0))
					{
						if (func_96(Global_1058068.f_152[iVar2]))
						{
							Var3 = { unk_0x6B62510F212526DC(Global_1058068.f_152[iVar2], 1) };
							fVar1 = unk_0x987A5F1E1A67E3C0(Param0, Var3, 1);
							if (fVar1 < fVar0)
							{
								fVar0 = fVar1;
...
int func_96(var uParam0)
{
	...
	if (unk_0x5B79688A82EAC2F0(Global_1837150[unk_0x9E2D6C50374FCFA9()]))
	{
		switch (unk_0x76932AF783B85B6A(uVar0, Global_1837150[unk_0x9E2D6C50374FCFA9()]))
		{
			case 3:
			case 5:
				return 1;
	...
	if (Global_1853131[unk_0x9E2D6C50374FCFA9() /*888*/] == 0)
	{
		iVar1 = unk_0x0E40F846A70BA3EC(unk_0x9E2D6C50374FCFA9());
		if (iVar1 > -1 && iVar1 < 4)
		{
			if (unk_0x5B79688A82EAC2F0(Global_1836860[iVar1]))
			{
				switch (unk_0x76932AF783B85B6A(uVar0, Global_1836860[iVar1]))
				{
					case 3:
					case 5:
						return 1;
...
float func_97()
{
	if (func_98())
	{
		if ((unk_0xD6F7D32A98E07F93(Global_2667223.f_45.f_67) || unk_0x4262B4DCEADC2695(Global_2667223.f_45.f_67)) || Global_2667223.f_45.f_67 == joaat("rhino"))
		{
			return 640f;
		}
		else
...
int func_98()
{
	if (Global_2667223.f_45.f_65 && !Global_2667223.f_45.f_304)
	{
...
void func_106(struct<3> Param0, var uParam3, var uParam4, var uParam5)
{
	...
	while (iVar0 < Global_2673768[iVar4])
	{
		if (func_31(Var1, &(Global_2672372[iVar4 /*155*/][iVar0 /*7*/])))
		{
			*uParam3 = { Global_2672372[iVar4 /*155*/][iVar0 /*7*/] };
			*uParam4 = { Global_2672372[iVar4 /*155*/][iVar0 /*7*/].f_3 };
			*uParam5 = Global_2672372[iVar4 /*155*/][iVar0 /*7*/].f_6;
			return;
		}
		iVar0++;
	}
	...
	while (iVar0 < Global_2673768[8])
	{
		if (func_31(Var1, &(Global_2672372[8 /*155*/][iVar0 /*7*/])))
		{
			*uParam3 = { Global_2672372[8 /*155*/][iVar0 /*7*/] };
			*uParam4 = { Global_2672372[8 /*155*/][iVar0 /*7*/].f_3 };
			*uParam5 = Global_2672372[8 /*155*/][iVar0 /*7*/].f_6;
			return;
		}
		iVar0++;
	}
...
int func_107(struct<3> Param0)
{
	...
	if (Global_2667223.f_45.f_55)
	{
		if (unk_0xBCC73B466E2B2350(Global_2667223.f_45.f_56))
		{
			if (!unk_0x15616E8442D3D1E8(Param0))
			{
				...
				if (unk_0xBCC73B466E2B2350(uVar0))
				{
					...
					if (!iVar1 == Global_2667223.f_45.f_57)
					{
						return 0;
					}
				}
...
{
	switch (Global_2667223.f_2487)
	{
		case 0:
			return func_145(Param0, Global_2667223.f_2466, Global_2667223.f_2469, 0, 0);
			break;
		
		case 1:
			return func_60(Param0, Global_2667223.f_2480, Global_2667223.f_2483, 0, 0);
			break;
		
		case 2:
			return unk_0x5F8653E60ED2288E(Param0, Global_2667223.f_2480, Global_2667223.f_2483, Global_2667223.f_2486, 0, 1);
			break;
	}
	return 0;
}
...
int func_111(int iParam0)
{
	switch (func_58())
	{
		case 0:
			if (!func_112(iParam0))
			{
				if (Global_1853131[iParam0 /*888*/] == 0)
				{
					return 1;
				}
			}
...
int func_114(struct<3> Param0, float fParam3, int iParam4)
{
	...
	while (iVar0 < iParam4)
	{
		if (unk_0xB7A628320EFF8E47(Global_2667223.f_2625[iVar0 /*3*/], Param0) < (fParam3 * fParam3))
		{
			return 1;
		}
		iVar0++;
...
int func_115(var uParam0, bool bParam1)
{
	...
	if (func_48(*uParam0))
	{
		if (bParam1)
		{
			...
			func_19(&Var1, Global_2667223.f_593, Global_2667223.f_596, 1036831949, 0, fVar4);
			if (func_49(Var1, &uVar0) || func_48(Var1))
			{
				Var1 = { *uParam0 };
				func_19(&Var1, Global_2667223.f_593, Global_2667223.f_596, 1036831949, 1, fVar4);
			}
			*uParam0 = { Var1 };
		}
	}
	...
	if (iParam4 && !bParam7)
	{
		if (func_26(unk_0x9E2D6C50374FCFA9(), 1, 1))
		{
			if (!unk_0xA829C9A2767AC8EF())
			{
				...
				if (unk_0x987A5F1E1A67E3C0(func_117(unk_0x9E2D6C50374FCFA9()), Param0, 1) <= (fVar2 + fParam3))
				{
					if (unk_0x0318E2EE6FB4563F(Param0, fParam3))
					{
						return 1;
	...
	while (iVar0 < 32)
	{
		...
		if (func_26(iVar1, 1, 1))
		{
			if (!func_142(iVar1, 0) && unk_0xA9E699D3DC7C0B15(unk_0x9E2D6C50374FCFA9(), iVar1))
			{
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != unk_0x9E2D6C50374FCFA9()))
				{
					if ((func_75(iVar1) || !bParam10) && !Global_2689224[iVar1 /*451*/].f_266)
					{
						fVar2 = fParam6;
						if (fParam9 > 0f)
						{
						...
						if (!bParam7)
						{
							if ((iParam5 || (iParam5 == 0 && unk_0x0E40F846A70BA3EC(iVar1) != unk_0x0E40F846A70BA3EC(unk_0x9E2D6C50374FCFA9()))) || unk_0x0E40F846A70BA3EC(iVar1) == -1)
							{
								if (unk_0x987A5F1E1A67E3C0(func_117(iVar1), Param0, 1) <= (fVar2 + fParam3))
								{
									if (unk_0x0809D748691DCA79(iVar1, Param0, fParam3))
									{
										return 1;
...
Vector3 func_117(int iParam0)
{
	...
	iVar0 = iParam0;
	if ((func_118() && Global_1853131[iVar0 /*888*/].f_858) && !func_4(Global_1853131[iVar0 /*888*/].f_859))
	{
	...
	while (iVar0 < 32)
	{
		if (!iParam3 == iVar0 || iParam4 == 1)
		{
			...
			while (iVar1 < 2)
			{
				...
				{
					if (func_34(Param0, Global_2680263.f_461[iVar0 /*11*/][iVar1 /*5*/], Global_2680263.f_461[iVar0 /*11*/][iVar1 /*5*/].f_3, Global_2680263.f_461[iVar0 /*11*/][iVar1 /*5*/].f_4, 1036831949))
					{
...
int func_122(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, float fParam8, float fParam9, float fParam10, float fParam11, float fParam12, float fParam13, bool bParam14, bool bParam15)
{
	...
	if (!func_119(Param0, 0.5f, unk_0x9E2D6C50374FCFA9(), 0, 0))
	{
		...
		if (bParam5)
		{
			...
			{
				Global_2667223.f_3 = (Global_2667223.f_3 + Global_2667223.f_2);
...
{
	if ((Global_2667223.f_489 == 9 || Global_2667223.f_489 == 9) || (Global_2667223.f_489 == 15 && iParam0 == 1))
	{
		return 1;
	}
	return 0;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && unk_0x9E2D6C50374FCFA9() != iVar1) || iParam8 == 0)
		{
			if (func_26(iVar1, bParam4, bParam5))
			{
				...
				{
					if (!bParam7 || (!unk_0xF68107C40359970C(unk_0x407E03586628E458(iVar1)) && func_75(iVar1)))
					{
						...
						{
							if (((unk_0x0E40F846A70BA3EC(unk_0x9E2D6C50374FCFA9()) == -1 && iParam9) && bParam6) && func_81(iVar1))
							{
							}
							else if (unk_0xE5965CDF24F93A9F(unk_0x407E03586628E458(iVar1)))
							{
								if (unk_0x987A5F1E1A67E3C0(func_79(iVar1), Param0, 1) < fParam3)
								{
									return 1;
								}
							}
		...
		while (iVar0 < 32)
		{
			...
			if (func_26(iVar1, 1, 1))
			{
				if ((!func_142(iVar1, 0) && unk_0xA9E699D3DC7C0B15(unk_0x9E2D6C50374FCFA9(), iVar1)) && iVar1 != unk_0x9E2D6C50374FCFA9())
				{
					...
					{
						if (unk_0x987A5F1E1A67E3C0(func_79(iVar1), Param0, 1) <= (fVar2 + fParam3))
						{
							if (unk_0x0809D748691DCA79(iVar1, Param0, fParam3))
							{
								return 1;
...
void func_134(struct<3> Param0, var uParam3, var uParam4)
{
	...
	while (iVar1 < 17)
	{
		...
		while (iVar0 < *uParam3)
		{
			if (unk_0x652D2EEEF1D3E62C(*(uParam3[iVar0 /*4*/])) == 0f || unk_0x2A488C176D52CCA5(Global_262145.f_6158[iVar1 /*3*/], Param0) < unk_0x2A488C176D52CCA5(*(uParam3[iVar0 /*4*/]), Param0))
			{
	...
	while (iVar1 < 17)
	{
		...
		while (iVar2 < 6)
		{
			...
			while (iVar0 < *uParam3)
			{
				if (unk_0x652D2EEEF1D3E62C(*(uParam3[iVar0 /*4*/])) == 0f || unk_0x2A488C176D52CCA5(Global_262145.f_6210[iVar1 /*19*/][iVar2 /*3*/], Param0) < unk_0x2A488C176D52CCA5(*(uParam3[iVar0 /*4*/]), Param0))
				{
...
{
	Global_2674774 = { *(uParam1[iParam2 /*10*/]) };
	*(uParam1[iParam2 /*10*/]) = { *uParam0 };
	if (iParam2 + 1 < *uParam1)
	{
		func_135(&Global_2674774, uParam1, iParam2 + 1);
	}
}

void func_136(var uParam0, var uParam1, int iParam2)
{
	Global_2674770 = { *(uParam1[iParam2 /*4*/]) };
	*(uParam1[iParam2 /*4*/]) = { *uParam0 };
	if (iParam2 + 1 < *uParam1)
	{
		func_136(&Global_2674770, uParam1, iParam2 + 1);
	}
}
...
void func_137(var uParam0, var uParam1)
{
	...
	if (Global_2667223.f_2262 > 0)
	{
		...
		while (iVar0 < Global_2667223.f_2262)
		{
			if (func_138(Global_2667223.f_2263[iVar0 /*4*/], uParam0))
			{
				fVar4 = Global_2667223.f_2263[iVar0 /*4*/].f_3;
				if (unk_0x652D2EEEF1D3E62C(*uParam1) > 0.01f)
				{
					Var1 = { *uParam1 - Global_2667223.f_2263[iVar0 /*4*/] };
					fVar4 = unk_0xD12EFCAB87804BED(Var1.f_0, Var1.f_1);
				}
				func_72(Global_2667223.f_2263[iVar0 /*4*/], fVar4, uParam0, uParam1, 0, uParam0->f_28);
				Global_2667223.f_2491++;
			}
			iVar0++;
		}
	}
	if (uParam0->f_5 && Global_2667223.f_2889)
	{
		func_66(&(Global_2667223.f_2491.f_6[0 /*10*/]), &(Global_2667223.f_2491.f_6[1 /*10*/]), &(Global_2667223.f_2491.f_6[2 /*10*/]));
	}
}
...
void func_139(struct<3> Param0, struct<3> Param3, var uParam6, var uParam7, var uParam8)
{
	float fVar0;
		...
		if (unk_0x958AC759881D0B58(iVar8))
		{
						...
						if ((uParam2->f_13 || uVar7 & 64 == 0) || uParam2->f_33 == 1)
						{
							if (uParam2->f_14 || uVar7 & 16 == 0)
							{
								if ((uVar7 & 128 == 0 && uVar7 & 256 == 0) && uVar7 & 512 == 0)
								{
									if (!func_166(Var1))
									{
										Var1 = { func_162(Var1, &fVar4, iVar9, uParam2->f_9, *uParam2, iVar10, uParam2->f_11, uParam2->f_34, &bVar11, bVar12, 1, uParam2->f_51, uParam2->f_60) };
														...
														if (func_161(Var1, uParam2))
														{
															if ((uParam2->f_48 && !func_167(&Var1, 0)) || uParam2->f_48 == 0)
															{
																...
																if (unk_0x652D2EEEF1D3E62C(Var1) > 0f)
																{
																	...
																	{
																		if ((uParam2->f_12 && !func_157(Var1, fVar4, uParam2->f_34, unk_0x9E2D6C50374FCFA9(), 0, uParam2->f_56)) || !uParam2->f_12)
																		{
			...
			if (iVar0 >= (40 + iVar15) || iVar0 >= 100)
			{
				...
				else
				{
					...
					{
						func_149(iVar15, *uParam0, &iVar0, &Var1, &fVar4, uParam2, iVar10, iVar9, iVar5, fVar13, fVar14, bVar11);
						Var31 = { Var1 };
						fVar34 = fVar4;
						if (!uParam2->f_50)
						{
...
void func_149(int iParam0, struct<3> Param1, int iParam4, var uParam5, float fParam6, var uParam7, int iParam8, int iParam9, int iParam10, float fParam11, float fParam12, bool bParam13)
{
	int iVar0;
	...
	while (iVar0 < 30)
	{
		*iParam4 = unk_0x5853B15F78E1A265((1 + iParam0), (40 + iParam0));
		if (unk_0x15CEDAB46D800682(Param1, *iParam4, uParam5, fParam6, &iParam9, iParam10, fParam11, fParam12))
		{
			...
			{
				*uParam5 = { func_162(*uParam5, fParam6, iParam9, uParam7->f_9, *uParam7, iParam8, uParam7->f_11, uParam7->f_34, &bParam13, 0, 0, uParam7->f_51, uParam7->f_60) };
				if (!func_166(*uParam5))
				{
					iVar0 = 999;
					return;
...
{
	if (!func_161(Global_2674784[iParam0 /*3*/], uParam1))
	{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam9 == 1 && unk_0x9E2D6C50374FCFA9() != iVar1) || iParam9 == 0)
		{
			if (func_26(iVar1, bParam5, bParam6))
			{
				if (unk_0xA9E699D3DC7C0B15(unk_0x9E2D6C50374FCFA9(), iVar1))
				{
					if (!bParam8 || (!unk_0xF68107C40359970C(unk_0x407E03586628E458(iVar1)) && func_75(iVar1)))
					{
						...
						{
							if (((unk_0x0E40F846A70BA3EC(unk_0x9E2D6C50374FCFA9()) == -1 && iParam10) && bParam7) && func_81(iVar1))
							{
							}
							else if (unk_0xE5965CDF24F93A9F(unk_0x407E03586628E458(iVar1)))
							{
								...
								if (unk_0xD5C6B5E3B93A5EDC(unk_0x407E03586628E458(iVar1), 0))
								{
									...
									if (unk_0xE5965CDF24F93A9F(uVar3) && !unk_0x55B23FE400FCEA6B(uVar3, 0))
									{
										...
										fVar8 = unk_0x82FE2343F8BDFF0B(uVar3);
...
int func_155(struct<3> Param0, float fParam3, int iParam4, struct<3> Param5, float fParam8, int iParam9, int iParam10)
{
	...
	func_35(Param0, fParam3, iParam4, &Global_1977137, &(Global_1977137.f_3), &(Global_1977137.f_6), 1036831949);
	func_35(Param5, fParam8, iParam9, &(Global_1977137.f_7), &(Global_1977137.f_10), &(Global_1977137.f_13), 1036831949);
...
int func_156(struct<3> Param0, float fParam3, int iParam4)
{
	...
	if (unk_0xE5965CDF24F93A9F(uVar1) && !unk_0x55B23FE400FCEA6B(uVar1, 0))
	{
		...
		fVar6 = unk_0x82FE2343F8BDFF0B(uVar1);
...
int func_158(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6)
{
	...
	while (iVar0 < 32)
	{
		if (!iParam5 == iVar0 || iParam6 == 1)
		{
			...
			while (iVar1 < 2)
			{
				if (func_159(Param0, iParam4, Global_2680263.f_461[iVar0 /*11*/][iVar1 /*5*/], Global_2680263.f_461[iVar0 /*11*/][iVar1 /*5*/].f_4))
				{
					if (func_155(Param0, fParam3, iParam4, Global_2680263.f_461[iVar0 /*11*/][iVar1 /*5*/], Global_2680263.f_461[iVar0 /*11*/][iVar1 /*5*/].f_3, Global_2680263.f_461[iVar0 /*11*/][iVar1 /*5*/].f_4, 0))
					{
	...
	while (iVar0 < 32)
	{
		if (!iParam5 == iVar0 || iParam6 == 1)
		{
			...
			if (func_26(iVar1, 0, 1) && func_26(iParam5, 0, 1))
			{
				if (Global_2680263.f_261[iVar0])
				{
					if (func_34(Global_2680263.f_131[iVar0 /*3*/], Param0, fParam3, iParam4, 1036831949))
					{
						return 1;
					}
				}
...
Vector3 func_162(struct<3> Param0, var uParam3, int iParam4, bool bParam5, struct<3> Param6, int iParam9, bool bParam10, int iParam11, var uParam12, int iParam13, bool bParam14, bool bParam15, var uParam16)
{
	struct<3> Var0;
	var uVar3;
	var uVar4;
	...
	if (bParam15)
	{
		...
		{
			if (!func_165(Param0, *uParam3, Param6))
			{
	...
	if (uVar4 & 1024 == 0 && !bParam10)
	{
		...
		if (bParam14)
		{
			...
			if (unk_0x4262B4DCEADC2695(iParam11) && func_164(Param0))
			{
				return 0f, 0f, 0f;
			}
		}
...
int func_166(struct<3> Param0)
{
	...
	{
		if (func_31(Param0, &(Global_2673788[iVar1 /*78*/][iVar0 /*7*/])))
		{
			return 1;
		}
		iVar0++;
	...
	{
		if (func_31(Param0, &(Global_2673788[8 /*78*/][iVar0 /*7*/])))
		{
			return 1;
		}
		iVar0++;
...
bool func_167(var uParam0, bool bParam1)
{
	...
	if (Global_2667223.f_26.f_18)
	{
		...
		{
			case 0:
				if (func_145(*uParam0, Global_2667223.f_26.f_10, Global_2667223.f_26.f_16, 0, 0))
				{
					bVar0 = true;
				}
				break;
			...
			case 1:
				if (func_60(*uParam0, Global_2667223.f_26.f_10, Global_2667223.f_26.f_13, 0, 0))
				{
					bVar0 = true;
				}
				break;
		...
		if (bVar0)
		{
			if (bParam1)
			{
				*uParam0 = { func_21(*uParam0, Global_2667223.f_26.f_10, Global_2667223.f_26.f_13, Global_2667223.f_26.f_16, Global_2667223.f_26.f_17, 1036831949, 0) };
			}
		}
	}
	return bVar0;
			...
			if (iVar2 > -1 && iVar2 < 101)
			{
				...
				if (unk_0x652D2EEEF1D3E62C(Var3) > 0f)
				{
					if ((uParam2->f_57 && unk_0x2A488C176D52CCA5(Var3, uParam2->f_35) > uParam2->f_4) || uParam2->f_57 == 0)
					{
						...
						{
							if ((uParam2->f_12 && !func_157(Var3, fVar6, uParam2->f_34, unk_0x9E2D6C50374FCFA9(), 0, uParam2->f_56)) || !uParam2->f_12)
							{
...
void func_174(var uParam0, var uParam1)
{
	...
	Global_2667223.f_2474 = unk_0x69CE66B03B2184EB();
	Global_2667223.f_2472 = 1;
	Global_2667223.f_2475 = unk_0x0A89FDFA763DCAED();
}

int func_175(struct<3> Param0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, int iParam9, float fParam10, bool bParam11, int iParam12, bool bParam13, float fParam14, bool bParam15, float fParam16, bool bParam17, int iParam18)
{
...
void func_178()
{
	...
	while (iVar10 < 4)
	{
		Global_2667223.f_2491.f_90[iVar10 /*10*/] = { Var0 };
		iVar10++;
	}
}
...
void func_179()
{
	...
	while (iVar4 < 8)
	{
		Global_2667223.f_2491.f_57[iVar4 /*4*/] = { Var0 };
		iVar4++;
	}
}
...
void func_180()
{
	...
	while (iVar10 < 5)
	{
		Global_2667223.f_2491.f_6[iVar10 /*10*/] = { Var0 };
		iVar10++;
	}
}
...
void func_181()
{
	...
	Var0.f_3 = -1;
	Global_2667223.f_2491 = { Var0 };
}

void func_182()
{
	if (Global_2667223.f_2472)
	{
		if (unk_0x69CE66B03B2184EB() == Global_2667223.f_2474)
		{
...
void func_188()
{
	switch (Local_71[unk_0xF1354995C6159A78() /*3*/].f_2)
	{
		case 0:
			func_213();
			func_211();
			if (func_200())
			{
				...
				func_191();
				func_189(35);
				Local_71[unk_0xF1354995C6159A78() /*3*/].f_2 = 1;
			}
		...
		case 1:
			if (Local_60.f_8 >= 2)
			{
				Local_71[unk_0xF1354995C6159A78() /*3*/].f_2 = 2;
			}
			break;
...
void func_191()
{
	if (unk_0x12DD4A0B247D9B4D(uLocal_170))
	{
		unk_0xFFD8EB5462B07B59(&uLocal_170);
	}
}

void func_192()
{
	if (!BitTest(Global_2703660.f_3576, 0))
	{
		unk_0xCED9E32812D6C7C7(&(Global_2703660.f_3576), 0);
		func_193();
	}
	else
	{
		unk_0xCED9E32812D6C7C7(&(Global_2703660.f_3576), 1);
	}
}
...
void func_195(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = Global_2822371[iParam0 /*3*/][func_199(iParam2)];
	if (iVar0 != 0)
	{
	...
	{
		case 788:
			Global_1655565[func_199(iParam2)] = iParam1;
			break;
		
		case 789:
			Global_1655571[func_199(iParam2)] = iParam1;
			break;
		
		case 790:
			Global_1655577[func_199(iParam2)] = iParam1;
			break;
		
		case 791:
			Global_1655583[func_199(iParam2)] = iParam1;
			break;
		
		case 8728:
			Global_1655589[func_199(iParam2)] = iParam1;
			break;
		
		case 778:
			Global_1655535[func_199(iParam2)] = iParam1;
			break;
		
		case 779:
			Global_1655541[func_199(iParam2)] = iParam1;
			break;
		
		case 780:
			Global_1655547[func_199(iParam2)] = iParam1;
			break;
		
		case 781:
			Global_1655553[func_199(iParam2)] = iParam1;
			break;
		
		case 8730:
			Global_1655559[func_199(iParam2)] = iParam1;
			break;
		
		case 768:
			Global_1655505[func_199(iParam2)] = iParam1;
			break;
		
		case 769:
			Global_1655511[func_199(iParam2)] = iParam1;
			break;
		
		case 770:
			Global_1655517[func_199(iParam2)] = iParam1;
			break;
		
		case 771:
			Global_1655523[func_199(iParam2)] = iParam1;
			break;
		
		case 8732:
			Global_1655529[func_199(iParam2)] = iParam1;
			break;
		
		case 758:
			Global_1655595[func_199(iParam2)] = iParam1;
			break;
		
		case 759:
			Global_1655601[func_199(iParam2)] = iParam1;
			break;
		
		case 760:
			Global_1655607[func_199(iParam2)] = iParam1;
			break;
		
		case 761:
			Global_1655613[func_199(iParam2)] = iParam1;
			break;
		
		case 8734:
			Global_1655619[func_199(iParam2)] = iParam1;
			break;
		
		case 1304:
			Global_1655625[func_199(iParam2)] = iParam1;
			break;
		
		case 7235:
			Global_1655631[func_199(iParam2)] = iParam1;
			break;
		
		case 640:
			Global_1655637[func_199(iParam2)] = iParam1;
			break;
		
		case 1279:
			Global_1655643[func_199(iParam2)] = iParam1;
			break;
		
		case 1878:
			Global_2863698[0 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 2269:
			Global_2863698[1 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 2931:
			Global_2863698[2 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3060:
			Global_2863698[3 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 10874:
			Global_2863859[func_199(iParam2)] = iParam1;
			break;
		
		case 765:
			Global_1655649[func_199(iParam2)] = iParam1;
			break;
		
		case 766:
			Global_1655655[func_199(iParam2)] = iParam1;
			break;
		
		case 767:
			Global_1655661[func_199(iParam2)] = iParam1;
			break;
		
		case 8733:
			Global_1655667[func_199(iParam2)] = iParam1;
			break;
		
		case 9537:
			Global_1655673[func_199(iParam2)] = iParam1;
			break;
		
		case 1237:
			Global_1655679[func_199(iParam2)] = iParam1;
			break;
		
		case 3055:
			Global_2863777[0 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3056:
			Global_2863777[1 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3057:
			Global_2863777[2 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3058:
			Global_2863777[3 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3059:
			Global_2863777[4 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3638:
			Global_2863862[0 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3639:
			Global_2863862[1 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3640:
			Global_2863862[2 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3641:
			Global_2863862[3 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3642:
			Global_2863862[4 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3643:
			Global_2863878[0 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3644:
			Global_2863878[1 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3645:
			Global_2863878[2 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3646:
			Global_2863878[3 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3647:
			Global_2863878[4 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3223:
			Global_2863777[5 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3229:
			Global_2863698[4 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3665:
			Global_2863894[func_199(iParam2)] = iParam1;
			break;
		
		case 3666:
			Global_2863903[func_199(iParam2)] = iParam1;
			break;
		
		case 3667:
			Global_2863897[func_199(iParam2)] = iParam1;
			break;
		
		case 3668:
			Global_2863906[func_199(iParam2)] = iParam1;
			break;
		
		case 3669:
			Global_2863900[func_199(iParam2)] = iParam1;
			break;
		
		case 3670:
			Global_2863909[func_199(iParam2)] = iParam1;
			break;
		
		case 3691:
			Global_2863912[func_199(iParam2)] = iParam1;
			break;
		
		case 3231:
			Global_2863777[6 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3232:
			Global_2863698[5 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3236:
			Global_2863777[7 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 3234:
			Global_2863698[6 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 4021:
			Global_2863777[8 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 4022:
			Global_2863698[7 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 4024:
			Global_2863777[9 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 4025:
			Global_2863698[8 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 4027:
			Global_2863777[10 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 4028:
			Global_2863698[9 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 4030:
			Global_2863777[11 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 4031:
			Global_2863698[10 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 6111:
			Global_2863777[12 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 6112:
			Global_2863698[11 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 6169:
			Global_2863777[13 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 6170:
			Global_2863698[12 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 6547:
			Global_2863777[14 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 6548:
			Global_2863698[13 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 6560:
			Global_2863777[15 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 6561:
			Global_2863698[14 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 6563:
			Global_2863777[16 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 6564:
			Global_2863698[15 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 6566:
			Global_2863777[17 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 6567:
			Global_2863698[16 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 7285:
			Global_2863698[17 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 7287:
			Global_2863698[18 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 7289:
			Global_2863698[19 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 8012:
			Global_2863698[20 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 8284:
			Global_2863915[func_199(iParam2)] = iParam1;
			break;
		
		case 8285:
			Global_2863918[func_199(iParam2)] = iParam1;
			break;
		
		case 8286:
			Global_2863921[func_199(iParam2)] = iParam1;
			break;
		
		case 8287:
			Global_2863924[func_199(iParam2)] = iParam1;
			break;
		
		case 8288:
			Global_2863927[func_199(iParam2)] = iParam1;
			break;
		
		case 8289:
			Global_2863930[func_199(iParam2)] = iParam1;
			break;
		
		case 8290:
			Global_2863933[func_199(iParam2)] = iParam1;
			break;
		
		case 8291:
			Global_2863936[func_199(iParam2)] = iParam1;
			break;
		
		case 8292:
			Global_2863939[func_199(iParam2)] = iParam1;
			break;
		
		case 8293:
			Global_2863942[func_199(iParam2)] = iParam1;
			break;
		
		case 8294:
			Global_2863945[func_199(iParam2)] = iParam1;
			break;
		
		case 8295:
			Global_2863948[func_199(iParam2)] = iParam1;
			break;
		
		case 8296:
			Global_2863951[func_199(iParam2)] = iParam1;
			break;
		
		case 8904:
			Global_2863954[func_199(iParam2)] = iParam1;
			break;
		
		case 8536:
			Global_2863698[21 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 8981:
			Global_2863777[23 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 8979:
			Global_2863698[22 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 8984:
			Global_2863777[24 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 8982:
			Global_2863698[23 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 9623:
			Global_2863698[24 /*3*/][func_199(iParam2)] = iParam1;
			break;
		
		case 9912:
			Global_2863698[25 /*3*/][func_199(iParam2)] = iParam1;
			break;
...
int func_198(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12581)
	{
		...
		uVar0 = Global_2822371[iParam0 /*3*/][func_199(iParam1)];
	...
	if (unk_0xCCDCD6672DAE6835(Local_60.f_2))
	{
		if (unk_0x90F6E2F6488B98BA(Local_60.f_2))
		{
			if (unk_0x099CAD293190F449(unk_0xE8BBC6CC2C60F24A(Local_60.f_2), unk_0xE2D3D51028F0428A()) && func_210(Local_60.f_2))
			{
				...
				unk_0xCED9E32812D6C7C7(&(Local_71[unk_0xF1354995C6159A78() /*3*/].f_1), 0);
				return 1;
			}
		}
	}
...
int func_208(int iParam0)
{
	...
	{
		case 1:
			return Global_1889770 > 0;
		
		case 2:
			return Global_1889770.f_1 > 0;
		
		case 3:
			return Global_1889770.f_2 > 0;
		
		case 4:
			return Global_1889770.f_4 > 0;
		
		case 5:
			return Global_1889770.f_3 > 0;
...
void func_211()
{
	if (!unk_0x12DD4A0B247D9B4D(uLocal_170))
	{
		if (unk_0xCCDCD6672DAE6835(Local_60.f_2))
		{
			uLocal_170 = unk_0xEFD6451BF0F3352F(unk_0xE8BBC6CC2C60F24A(Local_60.f_2));
			if (func_212())
			{
				unk_0x293A9399E902A33B(uLocal_170, 0.85f);
			}
			else
			{
				unk_0x293A9399E902A33B(uLocal_170, 1.2f);
			}
			unk_0x1A5B5BA56167D412(uLocal_170, 403);
			unk_0xA582EE8380437B1B(uLocal_170, 2);
			unk_0xAF62582F3EA39095(uLocal_170, "ABB_BLIPN");
		}
	}
}
...
{
	return Global_1853131[iParam0 /*888*/];
}
...
void func_228()
{
	Global_2810701.f_900 = 0;
	Global_2810701.f_900.f_1 = { 0f, 0f, 0f };
	Global_2810701.f_900.f_4 = 0f;
	Global_2810701.f_900.f_8 = 0;
	unk_0xB0550BC91B0159D6(&(Global_2810701.f_900.f_7), 0);
}
...
void func_229()
{
	if (BitTest(uLocal_168, 4))
	{
		...
		func_230(1);
		unk_0xB0550BC91B0159D6(&uLocal_168, 5);
		unk_0xB0550BC91B0159D6(&uLocal_168, 7);
		unk_0xB0550BC91B0159D6(&uLocal_168, 4);
	}
}
...
int func_232(struct<21> Param0)
{
	...
	unk_0x7157B1051528D729(&Local_71, 97, 0);
	if (!func_233())
	{
		return 0;
	}
	...
	iLocal_173 = unk_0x0843570206F71F38();
	Local_71[unk_0xF1354995C6159A78() /*3*/] = 0;
	return 1;
}
