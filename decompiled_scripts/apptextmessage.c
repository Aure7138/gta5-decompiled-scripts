...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_20383.f_1 != 9)
		{
			...
			{
				if (unk_0x1B79E937E91F40C3(&(Global_113648.f_14143[iLocal_58 /*104*/]), "CELL_FINV"))
				{
				}
				else
				{
	...
	if (Global_113648.f_14143[iLocal_58 /*104*/].f_24 == 1)
	{
		if (Global_20361 == 0)
		{
			if (unk_0x875A214D5EBCA509(2, Global_20354))
			{
				...
				unk_0xFE3A52C5B7AE3101(Global_113648.f_14143[iLocal_58 /*104*/].f_16);
				func_46(Global_20364, "SET_DATA_SLOT_EMPTY", 6f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_44();
				if (iLocal_56 > 0)
				{
		...
		if ((func_3(2, Global_20352, 0) || Global_113648.f_14053[Global_20383 /*20*/].f_17 == 1) || Global_22785 == 1)
		{
			...
			if (Global_113648.f_14143[iLocal_58 /*104*/].f_24 != 0)
			{
				...
				else
				{
					...
					uLocal_67 = unk_0x6CA3F2B87712B6A4();
					while (!unk_0xA6F779AA284EB20E(uLocal_67) && iLocal_62 == 0)
					{
						unk_0x4EDE34FBADD967A6(0);
					...
					{
						iLocal_63 = unk_0x5DEF122A58D4F685(uLocal_67);
					}
					if (iLocal_63 < 0)
					{
						iLocal_63 = 0;
				...
				if (Global_113648.f_14143[iLocal_58 /*104*/].f_17 == 145)
				{
					...
					unk_0x60D332F23943B34F(&(Global_113648.f_14143[iLocal_58 /*104*/].f_50));
					unk_0xCFAD3D478C87321A();
				}
				else
				{
				...
				switch (Global_113648.f_14143[iLocal_58 /*104*/].f_32)
				{
					...
					case 1:
						unk_0x882AEFD55B8D51FB(&(Global_113648.f_14143[iLocal_58 /*104*/]));
						unk_0x60D332F23943B34F(&(Global_113648.f_14143[iLocal_58 /*104*/].f_33));
						if (Global_113648.f_14143[iLocal_58 /*104*/].f_66 == 1 && !unk_0x1B79E937E91F40C3(&(Global_113648.f_14143[iLocal_58 /*104*/].f_67), "NULL"))
						{
							unk_0x60D332F23943B34F(&(Global_113648.f_14143[iLocal_58 /*104*/].f_67));
						}
						if ((Global_113648.f_14143[iLocal_58 /*104*/].f_66 == 2 && !unk_0x1B79E937E91F40C3(&(Global_113648.f_14143[iLocal_58 /*104*/].f_67), "NULL")) && !unk_0x1B79E937E91F40C3(&(Global_113648.f_14143[iLocal_58 /*104*/].f_83), "NULL"))
						{
							if (unk_0x6BA487C862DB8DDF(&(Global_113648.f_14143[iLocal_58 /*104*/].f_67)))
							{
								unk_0xACF853FB3F6EA7D4(&(Global_113648.f_14143[iLocal_58 /*104*/].f_67));
							}
							else
							{
								unk_0x60D332F23943B34F(&(Global_113648.f_14143[iLocal_58 /*104*/].f_67));
							}
							if (unk_0x6BA487C862DB8DDF(&(Global_113648.f_14143[iLocal_58 /*104*/].f_83)))
							{
								unk_0xACF853FB3F6EA7D4(&(Global_113648.f_14143[iLocal_58 /*104*/].f_83));
							}
							else
							{
								unk_0x60D332F23943B34F(&(Global_113648.f_14143[iLocal_58 /*104*/].f_83));
							}
						}
						unk_0xCFAD3D478C87321A();
						break;
					...
					case 2:
						unk_0x882AEFD55B8D51FB(&(Global_113648.f_14143[iLocal_58 /*104*/]));
						unk_0x511D14ED2DA887E1(Global_113648.f_14143[iLocal_58 /*104*/].f_49);
						unk_0xCFAD3D478C87321A();
						break;
				...
				{
					if (unk_0xCF3FA9D6B87D2277(Global_22794[iLocal_58]))
					{
						if (unk_0x445B6F53EA9E6A6F(Global_22794[iLocal_58]))
						{
							sVar16 = unk_0x008C0EB38E4459EE(Global_22794[iLocal_58]);
						}
						else
						{
							sVar16 = "CHAR_DEFAULT";
...
void func_37()
{
	...
	if (iLocal_2219)
	{
		unk_0x633E3833FB96BCCB(&uLocal_68);
	}
	iLocal_2219 = 0;
	if (Global_113648.f_14143[iLocal_58 /*104*/].f_24 != 0)
	{
		...
		while (iVar0 < 165)
		{
			if (!unk_0xD6F9DEE4765092A9(&(Local_84[iVar0 /*6*/])) && unk_0x1B79E937E91F40C3(&(Global_113648.f_14143[iLocal_58 /*104*/]), &(Local_84[iVar0 /*6*/])))
			{
				if (iVar0 < 19)
				{
				...
				iLocal_2219 = 1;
				unk_0xD0D00ED689D6CA81(&uLocal_68, 0);
				while (!unk_0x38D063D8CF6D1967(&uLocal_68))
				{
	...
	while (iVar36 < 34)
	{
		...
		if (Global_113648.f_14143[iVar38 /*104*/].f_24 != 0)
		{
			if (Global_113648.f_14143[iVar38 /*104*/].f_99[Global_20383] == 1)
			{
				...
				unk_0x330108B080A2132F(Global_113648.f_14143[iVar38 /*104*/].f_18.f_2);
				unk_0x330108B080A2132F(Global_113648.f_14143[iVar38 /*104*/].f_18.f_1);
				unk_0x330108B080A2132F(iLocal_59);
				if (Global_113648.f_14143[iVar38 /*104*/].f_17 == 145)
				{
					unk_0x882AEFD55B8D51FB("CELL_CONDFNH");
					unk_0x60D332F23943B34F(&(Global_113648.f_14143[iVar38 /*104*/].f_50));
					unk_0xCFAD3D478C87321A();
				}
				else
				{
				...
				switch (Global_113648.f_14143[iVar38 /*104*/].f_32)
				{
					...
					case 1:
						unk_0x882AEFD55B8D51FB(&(Global_113648.f_14143[iVar38 /*104*/]));
						unk_0x60D332F23943B34F(&(Global_113648.f_14143[iVar38 /*104*/].f_33));
						if (Global_113648.f_14143[iVar38 /*104*/].f_66 == 1 && !unk_0x1B79E937E91F40C3(&(Global_113648.f_14143[iVar38 /*104*/].f_67), "NULL"))
						{
							unk_0x60D332F23943B34F(&(Global_113648.f_14143[iVar38 /*104*/].f_67));
						}
						if ((Global_113648.f_14143[iVar38 /*104*/].f_66 == 2 && !unk_0x1B79E937E91F40C3(&(Global_113648.f_14143[iVar38 /*104*/].f_67), "NULL")) && !unk_0x1B79E937E91F40C3(&(Global_113648.f_14143[iVar38 /*104*/].f_83), "NULL"))
						{
							if (unk_0x6BA487C862DB8DDF(&(Global_113648.f_14143[iVar38 /*104*/].f_67)))
							{
								unk_0xACF853FB3F6EA7D4(&(Global_113648.f_14143[iVar38 /*104*/].f_67));
							}
							else
							{
								unk_0x60D332F23943B34F(&(Global_113648.f_14143[iVar38 /*104*/].f_67));
							}
							if (unk_0x6BA487C862DB8DDF(&(Global_113648.f_14143[iVar38 /*104*/].f_83)))
							{
								unk_0xACF853FB3F6EA7D4(&(Global_113648.f_14143[iVar38 /*104*/].f_83));
							}
							else
							{
								unk_0x60D332F23943B34F(&(Global_113648.f_14143[iVar38 /*104*/].f_83));
							}
						}
						unk_0xCFAD3D478C87321A();
						break;
					...
					case 2:
						unk_0x882AEFD55B8D51FB(&(Global_113648.f_14143[iVar38 /*104*/]));
						unk_0x511D14ED2DA887E1(Global_113648.f_14143[iVar38 /*104*/].f_49);
						unk_0xCFAD3D478C87321A();
						break;
