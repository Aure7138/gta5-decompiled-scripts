...
void __EntryFunction__()
{
	...
	func_41();
	Global_16811 = 0;
	Global_104439.f_13912[Global_14443 /*20*/].f_18 = 0;
	Global_14603 = 0;
	...
	while (true)
	{
		...
		if (Global_14443.f_1 != 9)
		{
			...
			else if (func_3(2, Global_14411, 0) || unk_0x2A3398C6222EB190(Global_2314, 12))
			{
				if (unk_0xB3404E397FF56B3B(&(Global_104439.f_14002[iLocal_58 /*104*/]), "CELL_FINV"))
				{
				}
				else
				{
					unk_0x4EDE34FBADD967A6(0);
					unk_0xD804ACF2A7171150(&Global_2314, 12);
					func_2();
					Global_14421 = 1;
					Global_16811 = 0;
					if (Global_14443.f_1 > 3)
					...
					func_38();
					func_37();
					if (Global_104439.f_14002[iLocal_58 /*104*/].f_29 > 0)
					{
						if (Global_104439.f_14002[iLocal_58 /*104*/].f_31 == 1)
						{
							Global_104439.f_14002[iLocal_58 /*104*/].f_29 = 4;
							Global_104439.f_14002[iLocal_58 /*104*/].f_24 = 1;
						}
						else
						{
							Global_104439.f_14002[iLocal_58 /*104*/].f_29 = 4;
...
void func_6()
{
	if (Global_104439.f_14002[iLocal_58 /*104*/].f_24 == 1)
	{
		if (Global_14421 == 0)
		{
			if (unk_0xD887E21676314450(2, Global_14414))
			{
				func_2();
				Global_14421 = 1;
				func_22();
				if (Global_104439.f_14002[iLocal_58 /*104*/].f_27 == 1)
				{
					Global_104439.f_14002[iLocal_58 /*104*/].f_99[0] = 0;
					Global_104439.f_14002[iLocal_58 /*104*/].f_99[1] = 0;
					Global_104439.f_14002[iLocal_58 /*104*/].f_99[2] = 0;
				}
				else
				{
					Global_104439.f_14002[iLocal_58 /*104*/].f_99[Global_14443] = 0;
				}
				...
				{
					Global_104439.f_14002[iLocal_58 /*104*/].f_24 = 0;
					Global_104439.f_14002[iLocal_58 /*104*/].f_28 = 0;
				}
				unk_0x184D9974941265BF(Global_104439.f_14002[iLocal_58 /*104*/].f_16);
				func_40(Global_14424, "SET_DATA_SLOT_EMPTY", 6f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_38();
				if (iLocal_56 > 0)
				{
	...
	{
		if (unk_0x9148803485DEDF45(2, Global_14415))
		{
			if (iLocal_60 == 1)
			{
				if (Global_14443.f_1 > 3)
				{
					StringCopy(&Global_68149, unk_0xC0D54565FC1032F4(&Global_16786), 64);
					Global_68277 = 7;
					unk_0xCD7E92DE2BFA0B0D(&Global_2314, 10);
					Global_14443.f_1 = 6;
				}
				func_42();
			}
	...
	if (Global_104439.f_14002[iLocal_58 /*104*/].f_31 == 1)
	{
		if (Global_14421 == 0)
		{
			if (func_3(2, Global_14415, 0))
			{
				func_18();
				Global_14421 = 1;
				Global_104439.f_14002[iLocal_58 /*104*/].f_29 = 2;
				Global_104439.f_14002[iLocal_58 /*104*/].f_24 = 1;
				Global_104439.f_14002[iLocal_58 /*104*/].f_31 = 0;
	...
	if (Global_14421 == 0 && iLocal_64 == 1)
	{
		if (func_3(2, Global_14412, 0))
		{
			...
			{
				func_18();
				Global_104439.f_14002[iLocal_58 /*104*/].f_29 = 3;
				Global_104439.f_14002[iLocal_58 /*104*/].f_24 = 1;
				Global_16811 = 0;
				if (Global_14443.f_1 > 3)
				{
			...
			else if (Global_104439.f_14002[iLocal_58 /*104*/].f_30 == 1)
			{
				func_18();
				Global_1628 = 144;
				if (Global_14443.f_1 > 3)
				...
				unk_0xADA0A4C226503297("appContacts");
				Global_1628 = Global_104439.f_14002[iLocal_58 /*104*/].f_17;
				...
				{
					func_13(Global_14424, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_104439.f_27911[Global_1628 /*29*/].f_3), &(Global_104439.f_27911[Global_1628 /*29*/].f_7), "CELL_211", &(Global_104439.f_27911[Global_1628 /*29*/].f_3), 0);
				}
				func_7();
				func_42();
			}
...
void func_7()
{
	...
	switch (Global_14443.f_1)
	{
		...
		case 9:
			...
			{
				func_10();
				func_40(Global_14424, "SET_THEME", unk_0xBBDA792448DB5A89(Global_104439.f_13912[Global_14443 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_15758)
				{
				...
				{
					func_13(Global_14424, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(2), -1f, -1f, &(Global_104439.f_27911[Global_1628 /*29*/].f_3), &(Global_104439.f_27911[Global_1628 /*29*/].f_7), "CELL_217", &(Global_104439.f_27911[Global_1628 /*29*/].f_3), 0);
				}
				func_40(Global_14424, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_15745 == 4 || Global_15745 == 3)
			{
				...
				else
				{
					...
					{
						func_40(Global_14424, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_13(Global_14424, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_104439.f_27911[Global_1628 /*29*/].f_3), &(Global_104439.f_27911[Global_1628 /*29*/].f_7), &cVar0, &(Global_104439.f_27911[Global_1628 /*29*/].f_3), 0);
					}
				}
				func_40(Global_14424, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
...
void func_15()
{
	...
	{
		if (func_16() && unk_0xCAAA726E313CCCFD(unk_0x0031992CA618A445(), 0))
		{
			iVar1 = 1;
		}
	}
...
void func_24()
{
	...
	if (unk_0x76B3C79DE564AFC6(unk_0x0031992CA618A445()))
	{
		if (func_27(Global_104439.f_2244.f_539.f_4301) != unk_0xE9559A12052415BE(unk_0x0031992CA618A445()))
		{
			...
			if (func_25(iVar0) && (!func_12(14) || Global_103390))
			{
...
void func_28()
{
	...
	if (Global_14421 == 0)
	{
		if ((func_3(2, Global_14412, 0) || Global_104439.f_13912[Global_14443 /*20*/].f_17 == 1) || Global_16805 == 1)
		{
			if (Global_104439.f_13912[Global_14443 /*20*/].f_17 == 0 && Global_16805 == 0)
			{
				func_18();
			}
			Global_14421 = 1;
			...
			if (Global_104439.f_14002[iLocal_58 /*104*/].f_24 != 0)
			{
				if (Global_14443.f_1 > 3)
				{
				...
				if (Global_104439.f_13912[Global_14443 /*20*/].f_17 == 1 || Global_16805 == 1)
				{
				...
				else
				{
					...
					uLocal_67 = unk_0xF55F467DF47A6BB8();
					while (!unk_0xA9BE7EE5DC102E89(uLocal_67) && iLocal_62 == 0)
					{
						unk_0x4EDE34FBADD967A6(0);
					...
					{
						iLocal_63 = unk_0xE6E83F46130402E8(uLocal_67);
					}
					if (iLocal_63 < 0)
					{
						iLocal_63 = 0;
				...
				Global_104439.f_14002[iLocal_58 /*104*/].f_28 = 1;
				iLocal_60 = 0;
				StringCopy(&Global_16786, "NO_HYPERLINK", 64);
				Var0 = { Global_104439.f_14002[iLocal_58 /*104*/] };
				...
				if (unk_0xA56C5821F50C3275(&Var0))
				{
					...
					unk_0xCD7E92DE2BFA0B0D(&Global_2313, 17);
					Global_104439.f_14002[iLocal_58 /*104*/].f_26 = 1;
					Global_104439.f_14002[iLocal_58 /*104*/].f_24 = 2;
				}
				if (Global_104439.f_14002[iLocal_58 /*104*/].f_26 == 0)
				{
					Global_104439.f_14002[iLocal_58 /*104*/].f_24 = 1;
				}
				func_31();
				...
				unk_0x32F9127910F63DFA(0);
				if (Global_104439.f_14002[iLocal_58 /*104*/].f_17 == 145)
				{
					unk_0x9BC6C9E77AAC792E("CELL_2000");
					unk_0x50B3C23D0902259F(&(Global_104439.f_14002[iLocal_58 /*104*/].f_50));
					unk_0xCC5EB3A492FB7D4B();
				}
				else
				{
					func_9(&(Global_104439.f_27911[Global_104439.f_14002[iLocal_58 /*104*/].f_17 /*29*/].f_3));
				}
				switch (Global_104439.f_14002[iLocal_58 /*104*/].f_32)
				{
					case 0:
						func_9(&(Global_104439.f_14002[iLocal_58 /*104*/]));
						break;
					
					case 1:
						unk_0x9BC6C9E77AAC792E(&(Global_104439.f_14002[iLocal_58 /*104*/]));
						unk_0x50B3C23D0902259F(&(Global_104439.f_14002[iLocal_58 /*104*/].f_33));
						if (Global_104439.f_14002[iLocal_58 /*104*/].f_66 == 1 && !unk_0xB3404E397FF56B3B(&(Global_104439.f_14002[iLocal_58 /*104*/].f_67), "NULL"))
						{
							unk_0x50B3C23D0902259F(&(Global_104439.f_14002[iLocal_58 /*104*/].f_67));
						}
						if ((Global_104439.f_14002[iLocal_58 /*104*/].f_66 == 2 && !unk_0xB3404E397FF56B3B(&(Global_104439.f_14002[iLocal_58 /*104*/].f_67), "NULL")) && !unk_0xB3404E397FF56B3B(&(Global_104439.f_14002[iLocal_58 /*104*/].f_83), "NULL"))
						{
							if (unk_0xA56C5821F50C3275(&(Global_104439.f_14002[iLocal_58 /*104*/].f_67)))
							{
								unk_0x7C8A7ECFBAD2C8C4(&(Global_104439.f_14002[iLocal_58 /*104*/].f_67));
							}
							else
							{
								unk_0x50B3C23D0902259F(&(Global_104439.f_14002[iLocal_58 /*104*/].f_67));
							}
							if (unk_0xA56C5821F50C3275(&(Global_104439.f_14002[iLocal_58 /*104*/].f_83)))
							{
								unk_0x7C8A7ECFBAD2C8C4(&(Global_104439.f_14002[iLocal_58 /*104*/].f_83));
							}
							else
							{
								unk_0x50B3C23D0902259F(&(Global_104439.f_14002[iLocal_58 /*104*/].f_83));
							}
						}
						unk_0xCC5EB3A492FB7D4B();
						break;
					...
					case 2:
						unk_0x9BC6C9E77AAC792E(&(Global_104439.f_14002[iLocal_58 /*104*/]));
						unk_0x96577CAA1D1E72DB(Global_104439.f_14002[iLocal_58 /*104*/].f_49);
						unk_0xCC5EB3A492FB7D4B();
						break;
				...
				{
					func_9(&(Global_104439.f_27911[Global_104439.f_14002[iLocal_58 /*104*/].f_17 /*29*/].f_7));
				}
				else
				{
					if (unk_0x1F20678A3517FA33(Global_16814[iLocal_58]))
					{
						if (unk_0x484948706DA7FDE0(Global_16814[iLocal_58]))
						{
							sVar16 = unk_0x7EBBB7725601519D(Global_16814[iLocal_58]);
						}
						else
						{
							sVar16 = "CHAR_DEFAULT";
				...
				if (Global_104439.f_14002[iLocal_58 /*104*/].f_24 == 2)
				{
					if (Global_104439.f_14002[iLocal_58 /*104*/].f_31 == 1)
					{
						iLocal_60 = 0;
				...
				Global_104439.f_13912[Global_14443 /*20*/].f_18 = 0;
				Global_104439.f_13912[Global_14443 /*20*/].f_17 = 0;
			}
			else
			{
				iVar17 = 0;
		...
		if (Global_2510594 == 0)
		{
			if (Global_70785)
			{
				unk_0x8662FAB20C4C3CFB(0, Global_14415);
				if (func_3(2, Global_14415, 0))
				{
					Global_14421 = 1;
					Global_2510594 = 1;
...
void func_30(int iParam0)
{
	...
	iVar0 = 0;
	switch (Global_104439.f_14002[iParam0 /*104*/].f_49)
	{
		case 1:
			unk_0x9BC6C9E77AAC792E("CELL_CL01");
			break;
		
		case 2:
			unk_0x9BC6C9E77AAC792E("CELL_CL02");
			break;
		
		case 3:
			unk_0x9BC6C9E77AAC792E("CELL_CL03");
			break;
		
		case 4:
			unk_0x9BC6C9E77AAC792E("CELL_CL04");
			break;
		
		case 5:
			unk_0x9BC6C9E77AAC792E("CELL_CL05");
			break;
		
		case 6:
			unk_0x9BC6C9E77AAC792E("CELL_CL06");
			break;
		
		case 7:
			unk_0x9BC6C9E77AAC792E("CELL_CL07");
			break;
		
		case 8:
			unk_0x9BC6C9E77AAC792E("CELL_CL08");
			break;
		
		case 9:
			unk_0x9BC6C9E77AAC792E("CELL_CL09");
			break;
	}
	unk_0x7C8A7ECFBAD2C8C4(&(Global_104439.f_14002[iParam0 /*104*/]));
	while (iVar0 < Global_104439.f_14002[iParam0 /*104*/].f_49)
	{
		switch (Global_104439.f_14002[iParam0 /*104*/].f_32)
		{
			case 4:
				unk_0x7C8A7ECFBAD2C8C4(&(Global_2501777.f_1628[iVar0 /*4*/]));
				break;
			
			case 5:
				unk_0x7C8A7ECFBAD2C8C4(&(Global_1767048[iVar0 /*4*/]));
				break;
			
			case 6:
				unk_0x7C8A7ECFBAD2C8C4(&(Global_1767089[iVar0 /*4*/]));
				break;
			
			case 7:
				unk_0x7C8A7ECFBAD2C8C4(&(Global_1767110[iVar0 /*4*/]));
				break;
			
			case 8:
				unk_0x7C8A7ECFBAD2C8C4(&(Global_1767127[iVar0 /*4*/]));
				break;
			
			case 9:
				unk_0x7C8A7ECFBAD2C8C4(&(Global_1767140[iVar0 /*4*/]));
				break;
			
			case 10:
				unk_0x7C8A7ECFBAD2C8C4(&(Global_1767153[iVar0 /*4*/]));
				break;
			
			case 11:
				unk_0x7C8A7ECFBAD2C8C4(&(Global_1767166[iVar0 /*4*/]));
				break;
		}
		iVar0++;
	}
...
void func_31()
{
	...
	if (iLocal_2147)
	{
		unk_0x40C8D24AE8508DEC(&uLocal_68);
	}
	iLocal_2147 = 0;
	if (Global_104439.f_14002[iLocal_58 /*104*/].f_24 != 0)
	{
		...
		while (iVar0 < 159)
		{
			if (unk_0xB3404E397FF56B3B(&(Global_104439.f_14002[iLocal_58 /*104*/]), &(Local_84[iVar0 /*6*/])))
			{
				if (iVar0 < 19)
				{
				...
				iLocal_2147 = 1;
				unk_0x59B2F61C9D01132B(&uLocal_68, 0);
				while (!unk_0xB56F0E1C89B9E069(&uLocal_68))
				{
...
void func_32()
{
	...
	if (iLocal_61 == 0)
	{
		if (func_3(2, Global_14419, 0) || unk_0xD887E21676314450(2, 181))
		{
			if (iLocal_56 > 0)
			{
				iLocal_56 = (iLocal_56 - 1);
		...
		if (func_3(2, Global_14420, 0) || unk_0xD887E21676314450(2, 180))
		{
			iLocal_56++;
...
void func_37()
{
	if (Global_104439.f_13912[Global_14443 /*20*/].f_17 == 0)
	{
		if (iLocal_57 < 0)
		{
			iLocal_57 = 0;
...
void func_38()
{
	...
	while (iVar36 < 34)
	{
		...
		iVar37 = 0;
		iVar38 = 34;
		Global_104439.f_14002[iVar38 /*104*/].f_18 = -1;
		Global_104439.f_14002[iVar38 /*104*/].f_18.f_1 = 0;
		Global_104439.f_14002[iVar38 /*104*/].f_18.f_2 = 0;
		Global_104439.f_14002[iVar38 /*104*/].f_18.f_3 = 0;
		Global_104439.f_14002[iVar38 /*104*/].f_18.f_5 = 0;
		while (iVar37 < 35)
		{
			if (unk_0x7832F791572D5809(joaat("cellphone_flashhand")) == 0)
			{
			...
			if (iVar0[iVar37] == 0)
			{
				if (Global_104439.f_14002[iVar37 /*104*/].f_24 != 0)
				{
					if (Global_104439.f_14002[iVar37 /*104*/].f_99[Global_14443] == 1)
					{
						if (func_39(Global_104439.f_14002[iVar37 /*104*/].f_18, Global_104439.f_14002[iVar38 /*104*/].f_18))
						{
							iVar38 = iVar37;
							if (Global_104439.f_14002[iVar38 /*104*/].f_28 == 0)
							{
								iLocal_59 = 33;
							}
							else
		...
		iVar0[iVar38] = 1;
		if (Global_104439.f_14002[iVar38 /*104*/].f_24 != 0)
		{
			if (Global_104439.f_14002[iVar38 /*104*/].f_99[Global_14443] == 1)
			{
				unk_0xEBD23F68B1A617FC(Global_14424, "SET_DATA_SLOT");
				unk_0x32F9127910F63DFA(6);
				unk_0x32F9127910F63DFA(iVar36);
				unk_0x32F9127910F63DFA(Global_104439.f_14002[iVar38 /*104*/].f_18.f_2);
				unk_0x32F9127910F63DFA(Global_104439.f_14002[iVar38 /*104*/].f_18.f_1);
				unk_0x32F9127910F63DFA(iLocal_59);
				if (Global_104439.f_14002[iVar38 /*104*/].f_17 == 145)
				{
					unk_0x9BC6C9E77AAC792E("CELL_CONDFNH");
					unk_0x50B3C23D0902259F(&(Global_104439.f_14002[iVar38 /*104*/].f_50));
					unk_0xCC5EB3A492FB7D4B();
				}
				else
				{
					func_9(&(Global_104439.f_27911[Global_104439.f_14002[iVar38 /*104*/].f_17 /*29*/].f_3));
				}
				switch (Global_104439.f_14002[iVar38 /*104*/].f_32)
				{
					case 0:
						func_9(&(Global_104439.f_14002[iVar38 /*104*/]));
						break;
					
					case 1:
						unk_0x9BC6C9E77AAC792E(&(Global_104439.f_14002[iVar38 /*104*/]));
						unk_0x50B3C23D0902259F(&(Global_104439.f_14002[iVar38 /*104*/].f_33));
						if (Global_104439.f_14002[iVar38 /*104*/].f_66 == 1 && !unk_0xB3404E397FF56B3B(&(Global_104439.f_14002[iVar38 /*104*/].f_67), "NULL"))
						{
							unk_0x50B3C23D0902259F(&(Global_104439.f_14002[iVar38 /*104*/].f_67));
						}
						if ((Global_104439.f_14002[iVar38 /*104*/].f_66 == 2 && !unk_0xB3404E397FF56B3B(&(Global_104439.f_14002[iVar38 /*104*/].f_67), "NULL")) && !unk_0xB3404E397FF56B3B(&(Global_104439.f_14002[iVar38 /*104*/].f_83), "NULL"))
						{
							if (unk_0xA56C5821F50C3275(&(Global_104439.f_14002[iVar38 /*104*/].f_67)))
							{
								unk_0x7C8A7ECFBAD2C8C4(&(Global_104439.f_14002[iVar38 /*104*/].f_67));
							}
							else
							{
								unk_0x50B3C23D0902259F(&(Global_104439.f_14002[iVar38 /*104*/].f_67));
							}
							if (unk_0xA56C5821F50C3275(&(Global_104439.f_14002[iVar38 /*104*/].f_83)))
							{
								unk_0x7C8A7ECFBAD2C8C4(&(Global_104439.f_14002[iVar38 /*104*/].f_83));
							}
							else
							{
								unk_0x50B3C23D0902259F(&(Global_104439.f_14002[iVar38 /*104*/].f_83));
							}
						}
						unk_0xCC5EB3A492FB7D4B();
						break;
					...
					case 2:
						unk_0x9BC6C9E77AAC792E(&(Global_104439.f_14002[iVar38 /*104*/]));
						unk_0x96577CAA1D1E72DB(Global_104439.f_14002[iVar38 /*104*/].f_49);
						unk_0xCC5EB3A492FB7D4B();
						break;
		...
		if (Global_104439.f_14002[iVar36 /*104*/].f_24 != 0)
		{
			if (Global_104439.f_14002[iVar36 /*104*/].f_99[Global_14443] == 1)
			{
				iLocal_55++;
			}
		}
