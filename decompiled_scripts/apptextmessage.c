...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_14413.f_1 != 9)
		{
			...
			{
				if (unk_0x2F6869889D97DFED(&(Global_101186.f_12907[iLocal_58 /*104*/]), "CELL_FINV"))
				{
				}
				else
				{
					...
					func_38();
					func_37();
					if (Global_101186.f_12907[iLocal_58 /*104*/].f_29 > 0)
					{
						if (Global_101186.f_12907[iLocal_58 /*104*/].f_31 == 1)
						{
							Global_101186.f_12907[iLocal_58 /*104*/].f_29 = 4;
							Global_101186.f_12907[iLocal_58 /*104*/].f_24 = 1;
						}
						else
						{
							Global_101186.f_12907[iLocal_58 /*104*/].f_29 = 4;
...
void func_6()
{
	if (Global_101186.f_12907[iLocal_58 /*104*/].f_24 == 1)
	{
		if (Global_14391 == 0)
		{
			if (unk_0xD471C64C0898A7BF(2, Global_14384))
			{
				func_2();
				Global_14391 = 1;
				func_22();
				if (Global_101186.f_12907[iLocal_58 /*104*/].f_27 == 1)
				{
					Global_101186.f_12907[iLocal_58 /*104*/].f_99[0] = 0;
					Global_101186.f_12907[iLocal_58 /*104*/].f_99[1] = 0;
					Global_101186.f_12907[iLocal_58 /*104*/].f_99[2] = 0;
				}
				else
				{
					Global_101186.f_12907[iLocal_58 /*104*/].f_99[Global_14413] = 0;
				}
				...
				{
					Global_101186.f_12907[iLocal_58 /*104*/].f_24 = 0;
					Global_101186.f_12907[iLocal_58 /*104*/].f_28 = 0;
				}
				unk_0x85AFD230C2980CFF(Global_101186.f_12907[iLocal_58 /*104*/].f_16);
				func_40(Global_14394, "SET_DATA_SLOT_EMPTY", 6f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_38();
				if (iLocal_56 > 0)
				{
	...
	if (Global_101186.f_12907[iLocal_58 /*104*/].f_31 == 1)
	{
		if (Global_14391 == 0)
		{
			if (func_3(2, Global_14385, 0))
			{
				func_18();
				Global_14391 = 1;
				Global_101186.f_12907[iLocal_58 /*104*/].f_29 = 2;
				Global_101186.f_12907[iLocal_58 /*104*/].f_24 = 1;
				Global_101186.f_12907[iLocal_58 /*104*/].f_31 = 0;
	...
	if (Global_14391 == 0 && iLocal_64 == 1)
	{
		if (func_3(2, Global_14382, 0))
		{
			...
			{
				func_18();
				Global_101186.f_12907[iLocal_58 /*104*/].f_29 = 3;
				Global_101186.f_12907[iLocal_58 /*104*/].f_24 = 1;
				Global_16778 = 0;
				if (Global_14413.f_1 > 3)
				{
			...
			else if (Global_101186.f_12907[iLocal_58 /*104*/].f_30 == 1)
			{
				func_18();
				Global_1598 = 144;
				if (Global_14413.f_1 > 3)
				...
				Global_1598 = Global_101186.f_12907[iLocal_58 /*104*/].f_17;
				...
				{
					func_13(Global_14394, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_101186.f_32651[Global_1598 /*29*/].f_3), &(Global_101186.f_32651[Global_1598 /*29*/].f_7), "CELL_211", &(Global_101186.f_32651[Global_1598 /*29*/].f_3), 0);
				}
				func_7();
				func_42();
			}
...
void func_7()
{
	...
	switch (Global_14413.f_1)
	{
		...
		case 9:
			...
			{
				func_10();
				func_40(Global_14394, "SET_THEME", unk_0xBBDA792448DB5A89(Global_101186.f_12817[Global_14413 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_15725)
				{
				...
				{
					func_13(Global_14394, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(2), -1f, -1f, &(Global_101186.f_32651[Global_1598 /*29*/].f_3), &(Global_101186.f_32651[Global_1598 /*29*/].f_7), "CELL_217", &(Global_101186.f_32651[Global_1598 /*29*/].f_3), 0);
				}
				func_40(Global_14394, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_15712 == 4 || Global_15712 == 3)
			{
				...
				else
				{
					...
					{
						func_40(Global_14394, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_13(Global_14394, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_101186.f_32651[Global_1598 /*29*/].f_3), &(Global_101186.f_32651[Global_1598 /*29*/].f_7), &cVar0, &(Global_101186.f_32651[Global_1598 /*29*/].f_3), 0);
					}
				}
				func_40(Global_14394, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
...
void func_15()
{
	...
	{
		if (func_16() && unk_0x55C761BDF0A5BB06(unk_0x06736567F820A39E(), 0))
		{
			iVar1 = 1;
		}
	}
...
void func_24()
{
	...
	if (unk_0xC1EDB61CE0A4B94E(unk_0x06736567F820A39E()))
	{
		if (func_27(Global_101186.f_1902.f_539.f_3549) != unk_0x79469DA5833EACA8(unk_0x06736567F820A39E()))
		{
			...
			if (func_25(iVar0) && (!func_12(14) || Global_100138))
			{
...
void func_28()
{
	...
	if (Global_14391 == 0)
	{
		if ((func_3(2, Global_14382, 0) || Global_101186.f_12817[Global_14413 /*20*/].f_17 == 1) || Global_16772 == 1)
		{
			if (Global_101186.f_12817[Global_14413 /*20*/].f_17 == 0 && Global_16772 == 0)
			{
				func_18();
			}
			Global_14391 = 1;
			...
			if (Global_101186.f_12907[iLocal_58 /*104*/].f_24 != 0)
			{
				if (Global_14413.f_1 > 3)
				{
				...
				if (Global_101186.f_12817[Global_14413 /*20*/].f_17 == 1 || Global_16772 == 1)
				{
				...
				else
				{
					...
					uLocal_67 = unk_0x501E08A637882750();
					while (!unk_0xEC0EC22A8A43C76E(uLocal_67) && iLocal_62 == 0)
					{
						unk_0x4EDE34FBADD967A6(0);
					...
					{
						iLocal_63 = unk_0xFD3CF387C866C665(uLocal_67);
					}
					if (iLocal_63 < 0)
					{
						iLocal_63 = 0;
				...
				Global_101186.f_12907[iLocal_58 /*104*/].f_28 = 1;
				iLocal_60 = 0;
				StringCopy(&Global_16753, "NO_HYPERLINK", 64);
				Var0 = { Global_101186.f_12907[iLocal_58 /*104*/] };
				...
				if (unk_0xDC1F9F222D09400F(&Var0))
				{
					...
					unk_0xE27C8E42A97895CF(&Global_2283, 17);
					Global_101186.f_12907[iLocal_58 /*104*/].f_26 = 1;
					Global_101186.f_12907[iLocal_58 /*104*/].f_24 = 2;
				}
				if (Global_101186.f_12907[iLocal_58 /*104*/].f_26 == 0)
				{
					Global_101186.f_12907[iLocal_58 /*104*/].f_24 = 1;
				}
				func_31();
				...
				unk_0x7AF283DA3BA078CD(0);
				if (Global_101186.f_12907[iLocal_58 /*104*/].f_17 == 145)
				{
					unk_0x7291E2F821FCFC04("CELL_2000");
					unk_0x9C174A0D56FFB64A(&(Global_101186.f_12907[iLocal_58 /*104*/].f_50));
					unk_0xD6360E18957BCDD3();
				}
				else
				{
					func_9(&(Global_101186.f_32651[Global_101186.f_12907[iLocal_58 /*104*/].f_17 /*29*/].f_3));
				}
				switch (Global_101186.f_12907[iLocal_58 /*104*/].f_32)
				{
					case 0:
						func_9(&(Global_101186.f_12907[iLocal_58 /*104*/]));
						break;
					
					case 1:
						unk_0x7291E2F821FCFC04(&(Global_101186.f_12907[iLocal_58 /*104*/]));
						unk_0x9C174A0D56FFB64A(&(Global_101186.f_12907[iLocal_58 /*104*/].f_33));
						if (Global_101186.f_12907[iLocal_58 /*104*/].f_66 == 1 && !unk_0x2F6869889D97DFED(&(Global_101186.f_12907[iLocal_58 /*104*/].f_67), "NULL"))
						{
							unk_0x9C174A0D56FFB64A(&(Global_101186.f_12907[iLocal_58 /*104*/].f_67));
						}
						if ((Global_101186.f_12907[iLocal_58 /*104*/].f_66 == 2 && !unk_0x2F6869889D97DFED(&(Global_101186.f_12907[iLocal_58 /*104*/].f_67), "NULL")) && !unk_0x2F6869889D97DFED(&(Global_101186.f_12907[iLocal_58 /*104*/].f_83), "NULL"))
						{
							if (unk_0xDC1F9F222D09400F(&(Global_101186.f_12907[iLocal_58 /*104*/].f_67)))
							{
								unk_0x4C5D86B5B659C953(&(Global_101186.f_12907[iLocal_58 /*104*/].f_67));
							}
							else
							{
								unk_0x9C174A0D56FFB64A(&(Global_101186.f_12907[iLocal_58 /*104*/].f_67));
							}
							if (unk_0xDC1F9F222D09400F(&(Global_101186.f_12907[iLocal_58 /*104*/].f_83)))
							{
								unk_0x4C5D86B5B659C953(&(Global_101186.f_12907[iLocal_58 /*104*/].f_83));
							}
							else
							{
								unk_0x9C174A0D56FFB64A(&(Global_101186.f_12907[iLocal_58 /*104*/].f_83));
							}
						}
						unk_0xD6360E18957BCDD3();
						break;
					...
					case 2:
						unk_0x7291E2F821FCFC04(&(Global_101186.f_12907[iLocal_58 /*104*/]));
						unk_0xD92C45283BCDA624(Global_101186.f_12907[iLocal_58 /*104*/].f_49);
						unk_0xD6360E18957BCDD3();
						break;
				...
				{
					func_9(&(Global_101186.f_32651[Global_101186.f_12907[iLocal_58 /*104*/].f_17 /*29*/].f_7));
				}
				else
				{
					if (unk_0x7BEEB9D9904F3BAD(Global_16781[iLocal_58]))
					{
						if (unk_0x512211B77C9DF624(Global_16781[iLocal_58]))
						{
							sVar16 = unk_0xA7ABBEE53A1DE38B(Global_16781[iLocal_58]);
						}
						else
						{
							sVar16 = "CHAR_DEFAULT";
				...
				if (Global_101186.f_12907[iLocal_58 /*104*/].f_24 == 2)
				{
					if (Global_101186.f_12907[iLocal_58 /*104*/].f_31 == 1)
					{
						iLocal_60 = 0;
				...
				Global_101186.f_12817[Global_14413 /*20*/].f_18 = 0;
				Global_101186.f_12817[Global_14413 /*20*/].f_17 = 0;
			}
			else
			{
				iVar17 = 0;
		...
		if (Global_2472485 == 0)
		{
			if (Global_69521)
			{
				unk_0xD3D729A98DEDDAFB(0, Global_14385);
				if (func_3(2, Global_14385, 0))
				{
					Global_14391 = 1;
					Global_2472485 = 1;
...
void func_31()
{
	...
	if (iLocal_636)
	{
		unk_0x0DBF9B65543A44DC(&Local_68);
	}
	iLocal_636 = 0;
	if (Global_101186.f_12907[iLocal_58 /*104*/].f_24 != 0)
	{
		...
		while (iVar0 < 25)
		{
			if (unk_0x2F6869889D97DFED(&(Global_101186.f_12907[iLocal_58 /*104*/]), &(Local_84[iVar0 /*6*/])))
			{
				Local_68 = { Local_235[iVar0 /*16*/] };
				iLocal_636 = 1;
				unk_0xC35C76B8E0A47F9F(&Local_68, 0);
				while (!unk_0xF3DECB9D15F48CFF(&Local_68))
				{
...
void func_32()
{
	...
	if (iLocal_61 == 0)
	{
		if (func_3(2, Global_14389, 0) || unk_0xD471C64C0898A7BF(2, 181))
		{
			if (iLocal_56 > 0)
			{
				iLocal_56 = (iLocal_56 - 1);
		...
		if (func_3(2, Global_14390, 0) || unk_0xD471C64C0898A7BF(2, 180))
		{
			iLocal_56++;
...
void func_37()
{
	if (Global_101186.f_12817[Global_14413 /*20*/].f_17 == 0)
	{
		if (iLocal_57 < 0)
		{
			iLocal_57 = 0;
...
void func_38()
{
	...
	while (iVar36 < 34)
	{
		...
		iVar37 = 0;
		iVar38 = 34;
		Global_101186.f_12907[iVar38 /*104*/].f_18 = -1;
		Global_101186.f_12907[iVar38 /*104*/].f_18.f_1 = 0;
		Global_101186.f_12907[iVar38 /*104*/].f_18.f_2 = 0;
		Global_101186.f_12907[iVar38 /*104*/].f_18.f_3 = 0;
		Global_101186.f_12907[iVar38 /*104*/].f_18.f_5 = 0;
		while (iVar37 < 35)
		{
			if (unk_0x98934607F8D0FB03(joaat("cellphone_flashhand")) == 0)
			{
			...
			if (iVar0[iVar37] == 0)
			{
				if (Global_101186.f_12907[iVar37 /*104*/].f_24 != 0)
				{
					if (Global_101186.f_12907[iVar37 /*104*/].f_99[Global_14413] == 1)
					{
						if (func_39(Global_101186.f_12907[iVar37 /*104*/].f_18, Global_101186.f_12907[iVar38 /*104*/].f_18))
						{
							iVar38 = iVar37;
							if (Global_101186.f_12907[iVar38 /*104*/].f_28 == 0)
							{
								iLocal_59 = 33;
							}
							else
		...
		iVar0[iVar38] = 1;
		if (Global_101186.f_12907[iVar38 /*104*/].f_24 != 0)
		{
			if (Global_101186.f_12907[iVar38 /*104*/].f_99[Global_14413] == 1)
			{
				unk_0x2B859AD680983623(Global_14394, "SET_DATA_SLOT");
				unk_0x7AF283DA3BA078CD(6);
				unk_0x7AF283DA3BA078CD(iVar36);
				unk_0x7AF283DA3BA078CD(Global_101186.f_12907[iVar38 /*104*/].f_18.f_2);
				unk_0x7AF283DA3BA078CD(Global_101186.f_12907[iVar38 /*104*/].f_18.f_1);
				unk_0x7AF283DA3BA078CD(iLocal_59);
				if (Global_101186.f_12907[iVar38 /*104*/].f_17 == 145)
				{
					unk_0x7291E2F821FCFC04("CELL_CONDFNH");
					unk_0x9C174A0D56FFB64A(&(Global_101186.f_12907[iVar38 /*104*/].f_50));
					unk_0xD6360E18957BCDD3();
				}
				else
				{
					func_9(&(Global_101186.f_32651[Global_101186.f_12907[iVar38 /*104*/].f_17 /*29*/].f_3));
				}
				switch (Global_101186.f_12907[iVar38 /*104*/].f_32)
				{
					case 0:
						func_9(&(Global_101186.f_12907[iVar38 /*104*/]));
						break;
					
					case 1:
						unk_0x7291E2F821FCFC04(&(Global_101186.f_12907[iVar38 /*104*/]));
						unk_0x9C174A0D56FFB64A(&(Global_101186.f_12907[iVar38 /*104*/].f_33));
						if (Global_101186.f_12907[iVar38 /*104*/].f_66 == 1 && !unk_0x2F6869889D97DFED(&(Global_101186.f_12907[iVar38 /*104*/].f_67), "NULL"))
						{
							unk_0x9C174A0D56FFB64A(&(Global_101186.f_12907[iVar38 /*104*/].f_67));
						}
						if ((Global_101186.f_12907[iVar38 /*104*/].f_66 == 2 && !unk_0x2F6869889D97DFED(&(Global_101186.f_12907[iVar38 /*104*/].f_67), "NULL")) && !unk_0x2F6869889D97DFED(&(Global_101186.f_12907[iVar38 /*104*/].f_83), "NULL"))
						{
							if (unk_0xDC1F9F222D09400F(&(Global_101186.f_12907[iVar38 /*104*/].f_67)))
							{
								unk_0x4C5D86B5B659C953(&(Global_101186.f_12907[iVar38 /*104*/].f_67));
							}
							else
							{
								unk_0x9C174A0D56FFB64A(&(Global_101186.f_12907[iVar38 /*104*/].f_67));
							}
							if (unk_0xDC1F9F222D09400F(&(Global_101186.f_12907[iVar38 /*104*/].f_83)))
							{
								unk_0x4C5D86B5B659C953(&(Global_101186.f_12907[iVar38 /*104*/].f_83));
							}
							else
							{
								unk_0x9C174A0D56FFB64A(&(Global_101186.f_12907[iVar38 /*104*/].f_83));
							}
						}
						unk_0xD6360E18957BCDD3();
						break;
					...
					case 2:
						unk_0x7291E2F821FCFC04(&(Global_101186.f_12907[iVar38 /*104*/]));
						unk_0xD92C45283BCDA624(Global_101186.f_12907[iVar38 /*104*/].f_49);
						unk_0xD6360E18957BCDD3();
						break;
		...
		if (Global_101186.f_12907[iVar36 /*104*/].f_24 != 0)
		{
			if (Global_101186.f_12907[iVar36 /*104*/].f_99[Global_14413] == 1)
			{
				iLocal_55++;
			}
		}
