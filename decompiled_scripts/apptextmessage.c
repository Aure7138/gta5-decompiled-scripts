...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_14393.f_1 != 9)
		{
			...
			else if (func_3(2, Global_14361, 0) || unk_0x61D8FEAF64881CDA(Global_2264, 12))
			{
				if (unk_0xA858564DC37EED5E(&(Global_97173.f_12362[iLocal_57 /*104*/]), "CELL_FINV"))
				{
				}
				else
				{
					unk_0x4EDE34FBADD967A6(0);
					unk_0xCD27BF29FB9012E2(&Global_2264, 12);
					func_2();
					Global_14371 = 1;
					Global_16758 = 0;
					if (Global_14393.f_1 > 3)
...
void func_6()
{
	if (Global_97173.f_12362[iLocal_57 /*104*/].f_24 == 1)
	{
		if (Global_14371 == 0)
		{
			if (unk_0x58FC9C7DF8FE009B(2, Global_14364))
			{
				func_2();
				Global_14371 = 1;
				func_22();
				...
				unk_0x183A54D9B60DAC36(Global_97173.f_12362[iLocal_57 /*104*/].f_16);
				func_40(Global_14374, "SET_DATA_SLOT_EMPTY", 6f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_38();
				if (iLocal_55 > 0)
				{
	...
	{
		if (unk_0xBD883E84B4B6E14E(2, Global_14365))
		{
			if (iLocal_59 == 1)
			{
				if (Global_14393.f_1 > 3)
				{
					StringCopy(&Global_66864, unk_0xB0EEA0615087D74B(&Global_16733), 64);
					Global_66889 = 7;
					unk_0x3DBE2A7AF9E71C82(&Global_2264, 10);
					Global_14393.f_1 = 6;
				}
				func_42();
			}
	...
	if (Global_14371 == 0 && iLocal_63 == 1)
	{
		if (func_3(2, Global_14362, 0))
		{
			...
			else if (Global_97173.f_12362[iLocal_57 /*104*/].f_30 == 1)
			{
				...
				unk_0xDD83BEFDE8CC91AD("appContacts");
...
void func_15()
{
	...
	{
		if (func_16() && unk_0x537F3CB4EFB8C4C1(unk_0x507DA4994C3D8EBD(), 0))
		{
			iVar1 = 1;
		}
	}
	if (!Global_68067)
	{
		if (!unk_0x9F94F2CFDCA78C55(unk_0x507DA4994C3D8EBD()) && iVar1 == 0)
		{
			iVar2 = unk_0x7974CEFA1BFEA57F(unk_0x507DA4994C3D8EBD(), 0);
			if (Global_68067)
			{
				if (((((iVar2 == 15 || iVar2 == 16) || iVar2 == 17) || iVar2 == 18) || iVar2 == 19) || unk_0xB2AFAFC648C71A2A(unk_0x507DA4994C3D8EBD()))
				{
					iVar0 = 1;
				}
			}
			else if (unk_0xB2AFAFC648C71A2A(unk_0x507DA4994C3D8EBD()))
			{
				iVar0 = 1;
			}
			if (!Global_14336)
					...
					if (iVar0 == 0)
					{
						if (!unk_0xE5D56342B0FF1D0D(unk_0x507DA4994C3D8EBD()))
						{
							...
							else
							{
								...
								unk_0x3DBE2A7AF9E71C82(&Global_2263, 11);
	...
	if (iVar1 == 4 && (iVar0 == 0 || unk_0xB4559880093FB79E()))
	{
		...
		if (!unk_0xE5D56342B0FF1D0D(unk_0x507DA4994C3D8EBD()))
		{
			if (unk_0x2A24448FF232F834(unk_0x507DA4994C3D8EBD(), 0))
			{
				...
				if (((((((unk_0xA34706B20AE53D17(unk_0x26EA758C2A691D06(uVar3)) || unk_0xD70F47541E70FD47(unk_0x26EA758C2A691D06(uVar3))) || unk_0x99F5A208CDBDA518(unk_0x26EA758C2A691D06(uVar3))) || unk_0x26EA758C2A691D06(uVar3) == joaat("seashark")) || unk_0x26EA758C2A691D06(uVar3) == joaat("seashark2")) || unk_0x26EA758C2A691D06(uVar3) == joaat("rhino")) || unk_0x26EA758C2A691D06(uVar3) == joaat("submersible")) || unk_0x26EA758C2A691D06(uVar3) == joaat("submersible2"))
				{
					iVar2 = 0;
				}
			}
...
void func_28()
{
	...
	if (Global_14371 == 0)
	{
		if ((func_3(2, Global_14362, 0) || Global_97173.f_12272[Global_14393 /*20*/].f_17 == 1) || Global_16752 == 1)
		{
			...
			if (Global_97173.f_12362[iLocal_57 /*104*/].f_24 != 0)
			{
				...
				else
				{
					...
					uLocal_66 = unk_0x0D72C1C0D4A044A4();
					while (!unk_0xEB72DB563C7B7566(uLocal_66) && iLocal_61 == 0)
					{
						unk_0x4EDE34FBADD967A6(0);
					...
					{
						iLocal_62 = unk_0x88AE9F0292C2B117(uLocal_66);
					}
					if (iLocal_62 < 0)
					{
						iLocal_62 = 0;
				...
				if (Global_97173.f_12362[iLocal_57 /*104*/].f_17 == 145)
				{
					...
					unk_0xD1F22DD7F7363AB6(&(Global_97173.f_12362[iLocal_57 /*104*/].f_50));
					unk_0x113A6F657EE871A3();
				}
				else
				{
				...
				switch (Global_97173.f_12362[iLocal_57 /*104*/].f_32)
				{
					...
					case 1:
						unk_0x44F4D219F8513945(&(Global_97173.f_12362[iLocal_57 /*104*/]));
						unk_0xD1F22DD7F7363AB6(&(Global_97173.f_12362[iLocal_57 /*104*/].f_33));
						if (Global_97173.f_12362[iLocal_57 /*104*/].f_66 == 1 && !unk_0xA858564DC37EED5E(&(Global_97173.f_12362[iLocal_57 /*104*/].f_67), "NULL"))
						{
							unk_0xD1F22DD7F7363AB6(&(Global_97173.f_12362[iLocal_57 /*104*/].f_67));
						}
						if ((Global_97173.f_12362[iLocal_57 /*104*/].f_66 == 2 && !unk_0xA858564DC37EED5E(&(Global_97173.f_12362[iLocal_57 /*104*/].f_67), "NULL")) && !unk_0xA858564DC37EED5E(&(Global_97173.f_12362[iLocal_57 /*104*/].f_83), "NULL"))
						{
							if (unk_0xD177A95825B53731(&(Global_97173.f_12362[iLocal_57 /*104*/].f_67)))
							{
								unk_0x923B18EB34FC2117(&(Global_97173.f_12362[iLocal_57 /*104*/].f_67));
							}
							else
							{
								unk_0xD1F22DD7F7363AB6(&(Global_97173.f_12362[iLocal_57 /*104*/].f_67));
							}
							if (unk_0xD177A95825B53731(&(Global_97173.f_12362[iLocal_57 /*104*/].f_83)))
							{
								unk_0x923B18EB34FC2117(&(Global_97173.f_12362[iLocal_57 /*104*/].f_83));
							}
							else
							{
								unk_0xD1F22DD7F7363AB6(&(Global_97173.f_12362[iLocal_57 /*104*/].f_83));
							}
						}
						unk_0x113A6F657EE871A3();
						break;
					...
					case 2:
						unk_0x44F4D219F8513945(&(Global_97173.f_12362[iLocal_57 /*104*/]));
						unk_0x844339A27F0F1508(Global_97173.f_12362[iLocal_57 /*104*/].f_49);
						unk_0x113A6F657EE871A3();
						break;
				...
				{
					if (unk_0x1132CE7A24BDADC2(Global_16761[iLocal_57]))
					{
						if (unk_0xDCBCBE55C7A8D357(Global_16761[iLocal_57]))
						{
							sVar16 = unk_0x47A5C6F75ADC0C8A(Global_16761[iLocal_57]);
						}
						else
						{
							sVar16 = "CHAR_DEFAULT";
		...
		if (Global_2452830 == 0)
		{
			if (Global_68067)
			{
				unk_0x0756DDDAD8038AC9(0, Global_14365);
				if (func_3(2, Global_14365, 0))
				{
					Global_14371 = 1;
					Global_2452830 = 1;
...
void func_29(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6)
{
	...
	if (!unk_0x8FA72E132AAFA62F(sParam5))
	{
		func_9(sParam5);
	}
	if (!unk_0x8FA72E132AAFA62F(sParam6))
	{
		func_9(sParam6);
	}
	unk_0xA52FC2467E672B55();
...
void func_30(int iParam0)
{
	...
	{
		case 1:
			unk_0x44F4D219F8513945("CELL_CL01");
			break;
		
		case 2:
			unk_0x44F4D219F8513945("CELL_CL02");
			break;
		
		case 3:
			unk_0x44F4D219F8513945("CELL_CL03");
			break;
		
		case 4:
			unk_0x44F4D219F8513945("CELL_CL04");
			break;
		
		case 5:
			unk_0x44F4D219F8513945("CELL_CL05");
			break;
		
		case 6:
			unk_0x44F4D219F8513945("CELL_CL06");
			break;
		
		case 7:
			unk_0x44F4D219F8513945("CELL_CL07");
			break;
		
		case 8:
			unk_0x44F4D219F8513945("CELL_CL08");
			break;
		
		case 9:
			unk_0x44F4D219F8513945("CELL_CL09");
			break;
	}
	unk_0x923B18EB34FC2117(&(Global_97173.f_12362[iParam0 /*104*/]));
	while (iVar0 < Global_97173.f_12362[iParam0 /*104*/].f_49)
	{
		switch (Global_97173.f_12362[iParam0 /*104*/].f_32)
		{
			case 4:
				unk_0x923B18EB34FC2117(&(Global_2446210.f_1548[iVar0 /*4*/]));
				break;
			
			case 5:
				unk_0x923B18EB34FC2117(&(Global_1681090[iVar0 /*4*/]));
				break;
			
			case 6:
				unk_0x923B18EB34FC2117(&(Global_1681131[iVar0 /*4*/]));
				break;
			
			case 7:
				unk_0x923B18EB34FC2117(&(Global_1681152[iVar0 /*4*/]));
				break;
			
			case 8:
				unk_0x923B18EB34FC2117(&(Global_1681169[iVar0 /*4*/]));
				break;
			
			case 9:
				unk_0x923B18EB34FC2117(&(Global_1681182[iVar0 /*4*/]));
				break;
			
			case 10:
				unk_0x923B18EB34FC2117(&(Global_1681195[iVar0 /*4*/]));
				break;
			
			case 11:
				unk_0x923B18EB34FC2117(&(Global_1681208[iVar0 /*4*/]));
				break;
		}
		iVar0++;
	}
...
void func_31()
{
	...
	if (iLocal_503)
	{
		unk_0xB6A951E6C2922F87(&Local_67);
	}
	iLocal_503 = 0;
	if (Global_97173.f_12362[iLocal_57 /*104*/].f_24 != 0)
	{
		...
		while (iVar0 < 19)
		{
			if (unk_0xA858564DC37EED5E(&(Global_97173.f_12362[iLocal_57 /*104*/]), &(Local_83[iVar0 /*6*/])))
			{
				Local_67 = { Local_198[iVar0 /*16*/] };
				iLocal_503 = 1;
				unk_0x685EB3667D702B92(&Local_67, 0);
				while (!unk_0x31920D7070131373(&Local_67))
				{
...
void func_32()
{
	...
	if (iLocal_60 == 0)
	{
		if (func_3(2, Global_14369, 0) || unk_0x58FC9C7DF8FE009B(2, 181))
		{
			if (iLocal_55 > 0)
			{
				iLocal_55 = (iLocal_55 - 1);
		...
		if (func_3(2, Global_14370, 0) || unk_0x58FC9C7DF8FE009B(2, 180))
		{
			iLocal_55++;
	...
	while (iVar36 < 34)
	{
		...
		if (Global_97173.f_12362[iVar38 /*104*/].f_24 != 0)
		{
			if (Global_97173.f_12362[iVar38 /*104*/].f_99[Global_14393] == 1)
			{
				...
				unk_0x876C5D0739031E15(iVar36);
				unk_0x876C5D0739031E15(Global_97173.f_12362[iVar38 /*104*/].f_18.f_2);
				unk_0x876C5D0739031E15(Global_97173.f_12362[iVar38 /*104*/].f_18.f_1);
				unk_0x876C5D0739031E15(iLocal_58);
				if (Global_97173.f_12362[iVar38 /*104*/].f_17 == 145)
				{
					unk_0x44F4D219F8513945("CELL_CONDFNH");
					unk_0xD1F22DD7F7363AB6(&(Global_97173.f_12362[iVar38 /*104*/].f_50));
					unk_0x113A6F657EE871A3();
				}
				else
				{
				...
				switch (Global_97173.f_12362[iVar38 /*104*/].f_32)
				{
					...
					case 1:
						unk_0x44F4D219F8513945(&(Global_97173.f_12362[iVar38 /*104*/]));
						unk_0xD1F22DD7F7363AB6(&(Global_97173.f_12362[iVar38 /*104*/].f_33));
						if (Global_97173.f_12362[iVar38 /*104*/].f_66 == 1 && !unk_0xA858564DC37EED5E(&(Global_97173.f_12362[iVar38 /*104*/].f_67), "NULL"))
						{
							unk_0xD1F22DD7F7363AB6(&(Global_97173.f_12362[iVar38 /*104*/].f_67));
						}
						if ((Global_97173.f_12362[iVar38 /*104*/].f_66 == 2 && !unk_0xA858564DC37EED5E(&(Global_97173.f_12362[iVar38 /*104*/].f_67), "NULL")) && !unk_0xA858564DC37EED5E(&(Global_97173.f_12362[iVar38 /*104*/].f_83), "NULL"))
						{
							if (unk_0xD177A95825B53731(&(Global_97173.f_12362[iVar38 /*104*/].f_67)))
							{
								unk_0x923B18EB34FC2117(&(Global_97173.f_12362[iVar38 /*104*/].f_67));
							}
							else
							{
								unk_0xD1F22DD7F7363AB6(&(Global_97173.f_12362[iVar38 /*104*/].f_67));
							}
							if (unk_0xD177A95825B53731(&(Global_97173.f_12362[iVar38 /*104*/].f_83)))
							{
								unk_0x923B18EB34FC2117(&(Global_97173.f_12362[iVar38 /*104*/].f_83));
							}
							else
							{
								unk_0xD1F22DD7F7363AB6(&(Global_97173.f_12362[iVar38 /*104*/].f_83));
							}
						}
						unk_0x113A6F657EE871A3();
						break;
					...
					case 2:
						unk_0x44F4D219F8513945(&(Global_97173.f_12362[iVar38 /*104*/]));
						unk_0x844339A27F0F1508(Global_97173.f_12362[iVar38 /*104*/].f_49);
						unk_0x113A6F657EE871A3();
						break;
