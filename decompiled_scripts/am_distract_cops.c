...
void __EntryFunction__()
{
	...
	fLocal_95 = 2.99f;
	fLocal_96 = 3.7f;
	if (unk_0xBBAE3E0C60A8AD4B() && func_228(unk_0xA34E7C2A5118D638(), 0, 1))
	{
	...
	while (true)
	{
		...
		switch (func_201(unk_0x935FA14EDA695A82()))
		{
			case 0:
				if (func_200() == 1)
				{
					func_199();
					Local_118[unk_0x935FA14EDA695A82() /*4*/] = 1;
				}
				else if (func_200() == 4)
				{
					Local_118[unk_0x935FA14EDA695A82() /*4*/] = 3;
				}
				break;
			...
			case 3:
				...
				{
					Local_118[unk_0x935FA14EDA695A82() /*4*/] = 4;
				}
				break;
...
void func_11()
{
	...
	if (Local_98.f_0 == 1)
	{
		if (unk_0x784B3253F40F728C(unk_0xD9BFAEBB04416B09(iLocal_253)))
		{
			iVar0 = unk_0x8F765930684A893F(unk_0xD9BFAEBB04416B09(iLocal_253));
			if (func_228(iVar0, 1, 1))
			{
				if (!unk_0xDCC86F723E82125E(Local_98.f_1, 0))
				{
					if (unk_0xDCC86F723E82125E(Local_118[iLocal_253 /*4*/].f_1, 0))
					{
						iLocal_254 = 1;
	...
	iLocal_253++;
	if (iLocal_253 == unk_0x55191629F1199760())
	{
		if (iLocal_254 == 0)
		{
			if (unk_0xDCC86F723E82125E(Local_98.f_1, 0))
			{
				unk_0x77621132305B133B(&(Local_98.f_1), 0);
			}
		}
		else
		{
...
void func_14()
{
	...
	if (!unk_0xDCC86F723E82125E(iLocal_247, 1))
	{
		if ((unk_0xDCC86F723E82125E(Local_118[unk_0x935FA14EDA695A82() /*4*/].f_1, 0) && unk_0x6338DEFCA89B8CD6(unk_0xA34E7C2A5118D638()) >= (Local_98.f_16 - 1)) && Local_118[unk_0x935FA14EDA695A82() /*4*/].f_2 < 10)
		{
			Local_118[unk_0x935FA14EDA695A82() /*4*/].f_2++;
		}
		if (Local_118[unk_0x935FA14EDA695A82() /*4*/].f_2 > 0)
		{
			iVar0 = (Local_118[unk_0x935FA14EDA695A82() /*4*/].f_2 * Global_262145.f_6464);
			...
			if (iVar0 > 0)
			{
				...
				{
					unk_0x7AF7488EF897601F(iVar0, "AM_DISTRACT_COPS", &uVar1);
				}
			}
			if (func_68())
			{
			...
			if (unk_0xDCC86F723E82125E(iLocal_247, 4))
			{
				if (!unk_0xDCC86F723E82125E(iLocal_247, 5))
				{
					func_15(66, 1, -1);
				}
			}
		}
		unk_0x59A0729D503ED758(&iLocal_247, 1);
	}
}
...
void func_16(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2488810[iParam0 /*5*/][func_18(iParam2)];
...
int func_17(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2488810[iParam0 /*5*/][func_18(iParam1)];
...
int func_21(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		else
		{
			...
			if (uParam0->f_1 == 84)
			{
				if (func_22(Global_2426867.f_2138[iVar0 /*72*/].f_1))
				{
					Global_2426867.f_2138[iVar0 /*72*/].f_2 = 5;
...
int func_28(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (func_49(unk_0xA34E7C2A5118D638()) || (func_48() && func_47()))
	{
		uVar0 = func_46();
		if (unk_0x95CCECA3948CFE7B(uVar0))
		{
			if (unk_0xA815CBE767EFA3CB(uVar0))
			{
				...
				{
					if (func_228(unk_0x8ACC9D9AC6076DCB(uVar0), 0, 1))
					{
						if ((iParam1 > -1 && unk_0xDC9A5ADFE0C41DD2()) && iParam1 < 4)
						{
							...
							{
								return func_36(iParam0, unk_0x8ACC9D9AC6076DCB(uVar0), iParam1, bParam2, bParam3);
							}
						}
						else
						{
	...
	if ((iParam1 > -1 && unk_0xDC9A5ADFE0C41DD2()) && iParam1 < 4)
	{
		...
		{
			return func_36(iParam0, unk_0xA34E7C2A5118D638(), iParam1, bParam2, bParam3);
		}
	}
	return func_36(iParam0, unk_0xA34E7C2A5118D638(), iParam1, bParam2, bParam3);
}
...
{
	return func_30(unk_0xA34E7C2A5118D638(), bParam0, iParam1, bParam2);
}
...
int func_30(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if (bParam1)
	{
		if (iParam2 > -1)
		{
			if (func_35(iVar0, iParam2, 0) && !unk_0xDCC86F723E82125E(Global_1613622.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_34(1);
...
int func_31(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_32(Global_1613622.f_68788))
	{
		if (iVar0 == 1)
		{
			iVar0 = 0;
...
int func_36(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_44(iParam1, iParam0, iVar0, 0) && !unk_0xDCC86F723E82125E(Global_1613622.f_15, 18)) || ((func_35(unk_0x07CBE0ED3114C7D8(iParam1), unk_0x07CBE0ED3114C7D8(iParam0), 0) && unk_0xDCC86F723E82125E(Global_1613622.f_15, 23)) && !unk_0xDCC86F723E82125E(Global_1613622.f_15, 18)))
			{
				return func_34(1);
			}
...
int func_39(int iParam0)
{
	if (!iParam0 == func_53())
	{
		...
		{
			return Global_2412494.f_1946.f_11[func_40(iParam0)];
		}
	}
	return -1;
}
...
bool func_41(int iParam0, bool bParam1)
{
	...
	return Global_1608811[iParam0 /*109*/].f_9 != func_53();
}
...
int func_42(int iParam0)
{
	if (iParam0 != func_53())
	{
		if (Global_1608811[iParam0 /*109*/].f_9 != func_53())
		{
...
int func_70(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (!bVar0)
	{
		if (!unk_0x9A07DDC8D6013A35(func_19()) || unk_0x2661EFA58162BE03())
		{
			Global_2555082 = 1;
			return 0;
		}
...
void func_72(int iParam0)
{
	...
	if (iParam0 != -1)
	{
		...
		func_73(&(Global_2554598[iParam0 /*72*/]));
	}
}
...
void func_83(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_228(iParam0, 0, 1))
	{
		...
		Var0.f_2 = iParam1;
		Var0.f_3 = iParam2;
		unk_0x74A5559828D3116B(1, &Var0, 5, func_84(iParam0));
	}
}
...
int func_86(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	...
	if (unk_0x139A9C4D61DFD52E(unk_0xA34E7C2A5118D638(), iParam1) || iParam5)
	{
		...
		unk_0x1AE578B67805BFB7(func_28(iParam1, -2, 1, 0));
		unk_0x2DED6C1306496257(func_91(&Var1));
		if (!iParam3 == 0)
		{
...
void func_87(int iParam0, char* sParam1, int iParam2, char* sParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_90() || !unk_0xDC9A5ADFE0C41DD2()) || !func_51(unk_0xA34E7C2A5118D638(), 0))
	{
		return;
	}
...
{
	return func_41(unk_0xA34E7C2A5118D638(), bParam0);
}

bool func_98()
{
	return func_42(unk_0xA34E7C2A5118D638());
}
...
void func_99()
{
	...
	if (unk_0x6B4865E08E90ACC5(uLocal_248))
	{
		if (func_195())
		{
			unk_0xB8D190382B0188FE(uLocal_248, 0);
		}
		else
		{
			unk_0xB8D190382B0188FE(uLocal_248, 4);
		}
	}
	switch (Local_118[unk_0x935FA14EDA695A82() /*4*/].f_3)
	{
		case 0:
			if (unk_0xA0C23498D8E0BB93(unk_0xC8B93D94F8954288(), Local_98.f_2, Local_98.f_5, Local_98.f_5, 1000f, 0, 1, 0))
			{
				func_172();
				unk_0x59A0729D503ED758(&(Local_118[unk_0x935FA14EDA695A82() /*4*/].f_1), 0);
				unk_0x59A0729D503ED758(&(Global_2458121.f_4418), 0);
				Local_118[unk_0x935FA14EDA695A82() /*4*/].f_3 = 1;
			}
			if (Local_98.f_7 > 1)
			{
				Local_118[unk_0x935FA14EDA695A82() /*4*/].f_3 = 2;
			}
			break;
...
void func_101()
{
	if (!unk_0xDCC86F723E82125E(iLocal_247, 5))
	{
		if (!unk_0xDCC86F723E82125E(iLocal_247, 4))
		{
			if (Local_98.f_17 == 0)
			{
				unk_0x59A0729D503ED758(&iLocal_247, 4);
			}
			else
			{
				unk_0x59A0729D503ED758(&iLocal_247, 5);
			}
		}
		else if (!func_228(unk_0xA34E7C2A5118D638(), 1, 1))
		{
			unk_0x59A0729D503ED758(&iLocal_247, 5);
		}
	}
...
void func_102()
{
	...
	if ((Local_98.f_12 - func_106(&(Local_98.f_10), 0, 0)) >= 0)
	{
		func_103((Local_98.f_12 - func_106(&(Local_98.f_10), 0, 0)), "DCP_TIMER", 0, 1, -1, 0, 2, 0, 1, 0, 0, 0, 0, 0, 0);
	}
	else
	{
...
void func_109()
{
	if (func_9(&uLocal_249, 30000, 0))
	{
		...
		func_110(0, unk_0xC8B93D94F8954288(), "XPT_DSC", -1636175450, 2048546661, (Global_262145.f_6465 * Local_98.f_16), 1, -1, 0, 0);
		Local_118[unk_0x935FA14EDA695A82() /*4*/].f_2++;
		func_5(&uLocal_249);
	}
}
	...
	if (iParam4 == -592022605 || iParam4 == -1915191729)
	{
		if (unk_0x95CCECA3948CFE7B(iParam1))
		{
			if (unk_0x96209AADF56E8FE8(iParam1))
			{
				...
				func_116(unk_0xB867FC7DBA46C0F1(uVar1, 31086, 0f, 0f, 0f), iVar0, 0, sParam8);
			}
		}
	}
	else
...
void func_111(int iParam0, int iParam1, char* sParam2)
{
	...
	if (iParam0 == func_113(unk_0xC8B93D94F8954288()))
	{
		func_112(1);
	}
...
Vector3 func_114(int iParam0, bool bParam1)
{
	...
	if (iParam0 == func_115(unk_0xC8B93D94F8954288()) && unk_0xA9B6C2A8F9FE269A(unk_0xBFFCA1BD025B90B2()) == 4)
	{
...
void func_116(struct<3> Param0, int iParam3, int iParam4, char* sParam5)
{
	...
	if (iParam3 != 0)
	{
		...
		if (iVar1 != -1)
		{
			...
			Global_2426867.f_741[iVar1 /*29*/].f_4 = func_119(Global_2426867.f_741[iVar1 /*29*/], &Global_1312317, &Global_1312318);
			...
			Global_2426867.f_741[iVar1 /*29*/].f_9 = func_118();
			Global_2426867.f_741[iVar1 /*29*/].f_10 = func_117();
...
int func_121(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	if (func_154(unk_0xA34E7C2A5118D638()) || func_153(unk_0xA34E7C2A5118D638()))
	{
	...
	if (func_151())
	{
		...
		if (bParam7)
		{
			...
			if (iParam1 == 0)
			{
				func_132((func_141(unk_0xA34E7C2A5118D638()) + iVar1), iParam9, 0);
				if (iParam8 == 0)
				{
				}
				if (iParam9 == 0)
		...
		if (bParam7)
		{
			if (iParam6 == -1)
			{
				func_122((func_124(unk_0xA34E7C2A5118D638()) + iVar1));
			}
			else
			{
				func_122((func_124(unk_0xA34E7C2A5118D638()) + iParam6));
			}
		}
		if (bParam7)
		{
...
void func_126(int iParam0)
{
	...
	Var0 = { func_131(unk_0xA34E7C2A5118D638()) };
	if (unk_0x14F2268F2CD21E48())
	{
		if (unk_0x0BB7D2D2CAAFD70C(&Var0))
		{
			...
			if (iVar13 == 0)
			{
				...
				func_127(joaat("mpply_crew_local_xp_0"), Global_1347498);
			}
			else if (iVar13 == 1)
			{
				func_128(&Global_1347499, iParam0);
				func_127(joaat("mpply_crew_local_xp_1"), Global_1347499);
			}
			else if (iVar13 == 2)
			{
				func_128(&Global_1347500, iParam0);
				func_127(joaat("mpply_crew_local_xp_2"), Global_1347500);
			}
			else if (iVar13 == 3)
			{
				func_128(&Global_1347501, iParam0);
				func_127(joaat("mpply_crew_local_xp_3"), Global_1347501);
			}
			else if (iVar13 == 4)
			{
				func_128(&Global_1347502, iParam0);
				func_127(joaat("mpply_crew_local_xp_4"), Global_1347502);
			}
		}
	}
}
...
void func_132(int iParam0, int iParam1, int iParam2)
{
	if (func_151())
	{
		...
		if (Global_262145.f_7530 == 0 && iParam1 != -1076930708)
		{
			if (iParam2 == 0)
			{
				if (iParam0 < Global_1347613[func_18(-1)])
				{
					unk_0xEF84C5FA6302A771(iParam0, -523908350, iParam1);
					return;
				}
				else if (iParam0 == Global_1347613[func_18(-1)])
				{
					return;
				}
			}
		...
		if (func_140(unk_0xA34E7C2A5118D638()))
		{
			Global_1587175[unk_0xA34E7C2A5118D638() /*410*/].f_192.f_1 = iParam0;
			Global_1587175[unk_0xA34E7C2A5118D638() /*410*/].f_192.f_6 = func_138(iParam0, 1);
		}
		func_137(629, iParam0, -1, 1);
		func_136(630, func_138(iParam0, 1), -1, 1);
		Global_1347613[func_18(-1)] = iParam0;
		func_133(7, 0);
	}
}
...
void func_136(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = Global_2466774[iParam0 /*5*/][func_18(iParam2)];
	if (iVar0 != 0)
	{
...
void func_137(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 777:
			Global_1347559[func_18(iParam2)] = iParam1;
			break;
		
		case 778:
			Global_1347565[func_18(iParam2)] = iParam1;
			break;
		
		case 779:
			Global_1347571[func_18(iParam2)] = iParam1;
			break;
		
		case 780:
			Global_1347577[func_18(iParam2)] = iParam1;
			break;
		
		case 767:
			Global_1347535[func_18(iParam2)] = iParam1;
			break;
		
		case 768:
			Global_1347541[func_18(iParam2)] = iParam1;
			break;
		
		case 769:
			Global_1347547[func_18(iParam2)] = iParam1;
			break;
		
		case 770:
			Global_1347553[func_18(iParam2)] = iParam1;
			break;
		
		case 757:
			Global_1347511[func_18(iParam2)] = iParam1;
			break;
		
		case 758:
			Global_1347517[func_18(iParam2)] = iParam1;
			break;
		
		case 759:
			Global_1347523[func_18(iParam2)] = iParam1;
			break;
		
		case 760:
			Global_1347529[func_18(iParam2)] = iParam1;
			break;
		
		case 747:
			Global_1347583[func_18(iParam2)] = iParam1;
			break;
		
		case 748:
			Global_1347589[func_18(iParam2)] = iParam1;
			break;
		
		case 749:
			Global_1347595[func_18(iParam2)] = iParam1;
			break;
		
		case 750:
			Global_1347601[func_18(iParam2)] = iParam1;
			break;
		
		case 1293:
			Global_1347607[func_18(iParam2)] = iParam1;
			break;
		
		case 629:
			Global_1347613[func_18(iParam2)] = iParam1;
			break;
		
		case 1268:
			Global_1347619[func_18(iParam2)] = iParam1;
			break;
		
		case 1865:
			Global_2489474[0 /*6*/][func_18(iParam2)] = iParam1;
			break;
		
		case 2256:
			Global_2489474[1 /*6*/][func_18(iParam2)] = iParam1;
			break;
		
		case 2902:
			Global_2489474[2 /*6*/][func_18(iParam2)] = iParam1;
			break;
		
		case 3030:
			Global_2489474[3 /*6*/][func_18(iParam2)] = iParam1;
			break;
		
		case 3732:
			Global_2489525[func_18(iParam2)] = iParam1;
			break;
		
		case 754:
			Global_1347625[func_18(iParam2)] = iParam1;
			break;
		
		case 755:
			Global_1347631[func_18(iParam2)] = iParam1;
			break;
		
		case 756:
			Global_1347637[func_18(iParam2)] = iParam1;
			break;
		
		case 1226:
			Global_1347643[func_18(iParam2)] = iParam1;
			break;
		
		case 3025:
			Global_2489499[0 /*5*/][func_18(iParam2)] = iParam1;
			break;
		
		case 3026:
			Global_2489499[1 /*5*/][func_18(iParam2)] = iParam1;
			break;
		
		case 3027:
			Global_2489499[2 /*5*/][func_18(iParam2)] = iParam1;
			break;
		
		case 3028:
			Global_2489499[3 /*5*/][func_18(iParam2)] = iParam1;
			break;
		
		case 3029:
			Global_2489499[4 /*5*/][func_18(iParam2)] = iParam1;
			break;
...
int func_141(int iParam0)
{
	if (Global_1312466.f_9 == 0)
	{
		if (iParam0 > -1)
		{
			if (iParam0 == unk_0xA34E7C2A5118D638())
			{
				return Global_1347613[func_18(-1)];
			}
...
void func_142(int iParam0)
{
	...
	while (iVar0 < unk_0x55191629F1199760())
	{
		...
		if (unk_0x784B3253F40F728C(iVar4))
		{
			...
			{
				if (unk_0x07CBE0ED3114C7D8(iVar5) == iVar1 || func_35(unk_0x07CBE0ED3114C7D8(iVar5), iVar1, 0))
				{
					iVar2++;
					if (iVar5 != unk_0xA34E7C2A5118D638())
					{
						if (func_144(unk_0xA34E7C2A5118D638(), iVar5))
						{
							bVar3 = true;
						}
					}
...
int func_144(int iParam0, int iParam1)
{
	if (unk_0x14F2268F2CD21E48())
	{
		Global_2457104 = { func_131(iParam0) };
		Global_2457117 = { func_131(iParam1) };
		...
		while (iVar0 < unk_0x55191629F1199760())
		{
			...
			if (unk_0x784B3253F40F728C(iVar3))
			{
				...
				if (func_228(iVar4, 0, 1))
				{
					...
					{
						iVar1++;
						if (func_144(unk_0xA34E7C2A5118D638(), iVar4))
						{
							bVar2 = true;
						}
					}
	...
	else
	{
		...
		while (iVar0 < 32)
		{
			...
			if (func_228(iVar4, 1, 1))
			{
				if (iVar4 != unk_0xA34E7C2A5118D638())
				{
					if (func_146(unk_0xA34E7C2A5118D638(), iVar4) <= 20f)
					{
						iVar1++;
						if (func_144(unk_0xA34E7C2A5118D638(), iVar4))
						{
...
int func_149(int iParam0)
{
	if (iParam0 < 0)
	{
		if (unk_0xA1836B70A59643DD(iParam0) > func_141(unk_0xA34E7C2A5118D638()))
		{
			iParam0 = -func_141(unk_0xA34E7C2A5118D638());
		}
	}
	if (func_150(8000, 0, 0) > 0)
	{
		if (func_150(8000, 0, 0) < (iParam0 + func_141(unk_0xA34E7C2A5118D638())))
		{
			iParam0 = (func_150(8000, 0, 0) - func_141(unk_0xA34E7C2A5118D638()));
		}
	}
	return iParam0;
}
...
int func_157(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2466774[iParam0 /*5*/][func_18(iParam1)];
	if (unk_0x5F0618A5FDAD55C4(uVar0, &uVar1, -1))
	{
		return uVar1;
	}
...
void func_158()
{
	...
	{
		if (unk_0x6338DEFCA89B8CD6(unk_0xA34E7C2A5118D638()) < Local_98.f_16)
		{
			unk_0xB47D5A4E4AE9BEAD(unk_0xA34E7C2A5118D638(), Local_98.f_16, 0);
...
void func_159()
{
	...
	{
		func_162();
		Local_118[unk_0x935FA14EDA695A82() /*4*/].f_3 = 0;
	}
	else if (!unk_0xA0C23498D8E0BB93(unk_0xC8B93D94F8954288(), Local_98.f_2, Local_98.f_6, Local_98.f_6, 950f, 0, 1, 0))
	{
		if (!unk_0xDCC86F723E82125E(iLocal_247, 0) && unk_0xDCC86F723E82125E(iLocal_247, 3))
		{
			if (!unk_0xB45DF29A98EEAD5D() && !func_161())
			{
				if (!func_195())
				{
					func_160("DCP_LEAVE", -1);
				}
				unk_0x59A0729D503ED758(&iLocal_247, 0);
			}
		}
	}
	else
	{
		if (!unk_0xDCC86F723E82125E(iLocal_247, 3))
		{
			unk_0x59A0729D503ED758(&iLocal_247, 3);
		}
		if (unk_0xDCC86F723E82125E(iLocal_247, 0))
		{
			unk_0x77621132305B133B(&iLocal_247, 0);
		}
	}
}
...
void func_162()
{
	...
	func_5(&uLocal_251);
	func_163();
	unk_0x77621132305B133B(&(Local_118[unk_0x935FA14EDA695A82() /*4*/].f_1), 0);
	unk_0x77621132305B133B(&iLocal_247, 3);
	unk_0x59A0729D503ED758(&(Global_2458121.f_4418), 0);
	if (!unk_0xDCC86F723E82125E(iLocal_247, 5))
	{
		unk_0x59A0729D503ED758(&iLocal_247, 5);
...
void func_163()
{
	if (unk_0xDCC86F723E82125E(iLocal_247, 2))
	{
		func_164(1, 1);
		unk_0x77621132305B133B(&iLocal_247, 2);
	}
}
...
void func_164(bool bParam0, bool bParam1)
{
	...
	func_167(0, 1, 0, 1060320051, 1086324736, 1065353216, 1088421888, 1084227584, 0, 1066192077, 0);
	func_166(0);
	func_165();
}
...
void func_167(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	if (bParam0)
	{
...
void func_172()
{
	if (!unk_0xDCC86F723E82125E(iLocal_247, 2))
	{
		func_191(Local_98.f_2, (Local_98.f_6 * 1.5f), 0, 0, 1, 0);
		func_174(Local_98.f_2, Local_98.f_6, 0, 1);
		func_173(Local_98.f_2, 1, 0);
		unk_0x59A0729D503ED758(&iLocal_247, 2);
	}
}
...
void func_175(struct<3> Param0, struct<3> Param3, var uParam6, int iParam7, int iParam8, var uParam9)
{
	...
	if (func_184(unk_0xA34E7C2A5118D638()) || uParam9)
	{
		if (Var0.f_10 == 1)
		{
		...
		if (func_178(Var0))
		{
			Global_2404919.f_39.f_64 = func_177(unk_0xA34E7C2A5118D638());
...
void func_197()
{
	if (!unk_0xDCC86F723E82125E(iLocal_247, 6))
	{
		if (((((((func_198(60000) && func_200() == 1) && Local_98.f_7 <= 1) && !unk_0xB45DF29A98EEAD5D()) && !unk_0x2BF05095F2389894()) && func_228(unk_0xA34E7C2A5118D638(), 1, 1)) && !func_161()) && Local_98.f_16 != 5)
		{
			if (!func_195())
			{
				func_160("DCP_HELP1", -1);
			}
			unk_0x59A0729D503ED758(&iLocal_247, 6);
		}
	}
}
...
void func_199()
{
	...
	{
		uLocal_248 = unk_0xA761401DBC598B95(Local_98.f_2, Local_98.f_5);
		unk_0x32546F91F646B246(uLocal_248, 50);
		unk_0x7DF168F8439ABF1A(uLocal_248, 220);
		unk_0xEBA460B665086587(uLocal_248, 0);
		unk_0x8755DAC584918BF9(uLocal_248, "DCP_BLIPN");
		if (func_195())
		{
			unk_0xB8D190382B0188FE(uLocal_248, 0);
		}
...
int func_203(int iParam0)
{
	switch (iParam0)
	{
		...
		case 4:
			...
			if (func_205(unk_0xA34E7C2A5118D638(), 7))
			{
				return 0;
			}
...
int func_204(int iParam0)
{
	...
	while (iVar0 < 32)
	{
		if (func_228(unk_0x20A20BF765914E37(iVar0), 0, 1))
		{
...
int func_206()
{
	...
	if (func_207() != 0)
	{
		if (unk_0xCBC8FFE55DC722B5(func_207()) == 0)
		{
			return 1;
		}
	}
...
void func_217()
{
	if (unk_0x6B4865E08E90ACC5(uLocal_248))
	{
		unk_0x5356E82C1E5E0C44(&uLocal_248);
	}
...
void func_220(struct<20> Param0)
{
	...
	func_224(0, -1, 0);
	unk_0xFE7B095449D5F053(&Local_98, 20);
	unk_0x99592530153DB318(&Local_118, 129);
	if (!func_223())
	{
		func_217();
	}
	if (unk_0xBBAE3E0C60A8AD4B())
	{
		...
		func_219(16, 1);
		Local_118[unk_0x935FA14EDA695A82() /*4*/] = 0;
	}
	else
	{
		func_217();
