	...
	while (true)
	{
		...
		switch (func_250(unk_0x57270EE11514DC67()))
		{
			case 0:
				...
				{
					func_248();
					Local_93[unk_0x57270EE11514DC67() /*4*/] = 1;
				}
				else if (func_249() == 4)
				{
					Local_93[unk_0x57270EE11514DC67() /*4*/] = 3;
				}
				break;
			...
			case 3:
				...
				{
					Local_93[unk_0x57270EE11514DC67() /*4*/] = 4;
				}
				break;
	...
	if (Local_73.f_0 == 1)
	{
		if (unk_0x81A93C8315C28F58(unk_0xF4FB3A22FC4991C8(iLocal_228)))
		{
			...
			if (func_277(iVar0, 1, 1))
			{
				if (!unk_0xEAE0D21A50E6C7F4(Local_73.f_1, 0))
				{
					if (unk_0xEAE0D21A50E6C7F4(Local_93[iLocal_228 /*4*/].f_1, 0))
					{
						iLocal_229 = 1;
...
void func_14()
{
	...
	{
		if ((unk_0xEAE0D21A50E6C7F4(Local_93[unk_0x57270EE11514DC67() /*4*/].f_1, 0) && unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) >= (Local_73.f_16 - 1)) && Local_93[unk_0x57270EE11514DC67() /*4*/].f_2 < 10)
		{
			Local_93[unk_0x57270EE11514DC67() /*4*/].f_2++;
		}
		if (Local_93[unk_0x57270EE11514DC67() /*4*/].f_2 > 0)
		{
			iVar0 = (Local_93[unk_0x57270EE11514DC67() /*4*/].f_2 * Global_262145.f_8101);
	...
	if (((func_70(unk_0xD803B885F5E47A62()) || (func_69() && func_68())) && !unk_0xEAE0D21A50E6C7F4(Global_2537071.f_4591, 31)) && !bParam4)
	{
		...
		if (unk_0xC844350D5D58C99A(uVar1))
		{
			if (unk_0x34BFC6F0CB887BC2(uVar1))
			{
				...
				{
					if (func_277(unk_0x83FACCC48B68F9D1(uVar1), 0, 1))
					{
						if ((iParam1 > -1 && unk_0xA14BB9332558B949()) && iParam1 < 4)
						{
							...
							{
								return func_52(iParam0, unk_0x83FACCC48B68F9D1(uVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
...
void func_128()
{
	...
	switch (Local_93[unk_0x57270EE11514DC67() /*4*/].f_3)
	{
		case 0:
			if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), Local_73.f_2, Local_73.f_5, Local_73.f_5, 1000f, 0, 1, 0))
			{
				...
				Local_93[unk_0x57270EE11514DC67() /*4*/].f_3 = 1;
			}
			if (Local_73.f_7 > 1)
			{
				Local_93[unk_0x57270EE11514DC67() /*4*/].f_3 = 2;
			}
			break;
...
void func_194()
{
	...
	{
		func_197();
		Local_93[unk_0x57270EE11514DC67() /*4*/].f_3 = 0;
	}
...
void func_197()
{
	...
	func_5(&uLocal_226);
	func_198();
	unk_0x0674E58A79778E99(&(Local_93[unk_0x57270EE11514DC67() /*4*/].f_1), 0);
...
{
	func_275(func_276(Param0.f_0), Param0);
	func_273(0, -1, 0);
	...
	if (unk_0x8CD06866876216F2())
	{
		...
		func_268(16, 1);
		Local_93[unk_0x57270EE11514DC67() /*4*/] = 0;
	}
	else
	{
		func_266();
