...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (unk_0x4A4851D44CDF03C0(uVar0))
		{
			switch (iLocal_45)
			{
				case 0:
					...
					func_10(&uVar0);
					iLocal_46 = unk_0x9D40BBF80D8F5E8A();
					iLocal_45 = 1;
					break;
				
				case 1:
					if ((unk_0x9D40BBF80D8F5E8A() - iLocal_46) > 3000)
					{
						func_9(&uVar0);
						iLocal_45 = 2;
					}
...
int func_1(var uParam0, bool bParam1)
{
	...
	unk_0xAF5B7C9C0A5116E9(*uParam0, 0.5f, 0.5f, 1f, 1f, 255, 255, 255, 0, 0);
	if (bParam1)
	{
...
float func_3(var uParam0)
{
	if (func_8(uParam0))
	{
		...
		{
			return (func_4(unk_0xB519E5386FBF69E5(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_4(unk_0xB519E5386FBF69E5(*uParam0, 4)) - fParam1);
...
void func_9(var uParam0)
{
	uParam0->f_1 = 300;
	func_6(&(uParam0->f_2));
	unk_0xA4F3B84032D46C13(*uParam0, "SPLASH_TEXT_TRANSITION_OUT");
	unk_0x43C93E686A1E92C5(300);
	unk_0xFF141057ED7B4C73();
}

void func_10(var uParam0)
{
	unk_0xA4F3B84032D46C13(*uParam0, "SPLASH_TEXT_TRANSITION_IN");
	unk_0xFF141057ED7B4C73();
}
...
var func_13()
{
	return unk_0xE3C796DC28BC3254("SPLASH_TEXT");
}
