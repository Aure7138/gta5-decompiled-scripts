...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (unk_0xEDE19C6ED6E2F478(uVar0))
		{
			switch (iLocal_45)
			{
				case 0:
					...
					func_10(&uVar0);
					iLocal_46 = unk_0x3EAC9995EC220C5A();
					iLocal_45 = 1;
					break;
				
				case 1:
					if ((unk_0x3EAC9995EC220C5A() - iLocal_46) > 3000)
					{
						func_9(&uVar0);
						iLocal_45 = 2;
					}
...
int func_1(var uParam0, bool bParam1)
{
	...
	unk_0x50137349427F6296(*uParam0, 0.5f, 0.5f, 1f, 1f, 255, 255, 255, 0, 0);
	if (bParam1)
	{
...
float func_3(var uParam0)
{
	if (func_8(uParam0))
	{
		...
		{
			return (func_4(unk_0xB56FEBC510E7E9DE(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_4(unk_0xB56FEBC510E7E9DE(*uParam0, 4)) - fParam1);
...
void func_9(var uParam0)
{
	uParam0->f_1 = 300;
	func_6(&(uParam0->f_2));
	unk_0x758017413321C628(*uParam0, "SPLASH_TEXT_TRANSITION_OUT");
	unk_0x4D57F6B69CCB6D95(300);
	unk_0x098CA28C04E62E55();
}

void func_10(var uParam0)
{
	unk_0x758017413321C628(*uParam0, "SPLASH_TEXT_TRANSITION_IN");
	unk_0x098CA28C04E62E55();
}
...
var func_13()
{
	return unk_0x2F14983962462691("SPLASH_TEXT");
}
