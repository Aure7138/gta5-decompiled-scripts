...
int func_2()
{
	...
	{
		if (unk_0xAE06B9E39EBDE049(uLocal_239))
		{
			if (unk_0x9934470AA0A08B57(Global_98676, &sLocal_245, &cLocal_277, 3))
			{
				...
				fVar0 = unk_0x369E69441C066912(iLocal_293);
				if (!iLocal_238)
				{
				...
				if (fVar0 < 0.2812f)
				{
					if (iLocal_294 != 0)
					{
						unk_0x994BE8B44E53ECFA(iLocal_294, 0);
						iLocal_294 = 0;
					}
				}
				else if (fVar0 < 0.4778f)
				{
					if (iLocal_294 == 0)
					{
						iLocal_294 = unk_0xF245B4695C9BEF04("scr_lamgraff_paint_spray", uLocal_239, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
						unk_0xC313709BC7ED51D7(iLocal_294, fLocal_295, fLocal_296, fLocal_297, 0);
					}
				}
...
int func_26()
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(Global_98676))
	{
		if (unk_0xAE06B9E39EBDE049(uLocal_239))
		{
			if (unk_0x9934470AA0A08B57(Global_98676, &sLocal_245, &cLocal_261, 3))
			{
				if (unk_0x0922C2E075A5F18C(Global_98676))
				{
					unk_0x3D1D83230EDB53BF(Global_98676, 0, 0);
				...
				else
				{
					...
					{
						iLocal_293 = unk_0xF341A134A5B8D4F6(Local_241, 0f, 0f, uLocal_244, 2);
						unk_0x81493F39713559B1(iLocal_293, 1);
					}
					unk_0xDFDB9C533700BC17(Global_98676, iLocal_293, &sLocal_245, &cLocal_277, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
...
void func_37()
{
	unk_0x78FCB2E22C41B9D5(iLocal_240);
	unk_0x22043B0E5A2FE456();
	while (!unk_0xAE06B9E39EBDE049(Global_98676) || !unk_0x7D167B9A0CCDA347(iLocal_240))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	...
	if (unk_0xAE06B9E39EBDE049(Global_98676))
	{
		...
		unk_0xD3D9D7C84656DAE5(Global_98676, joaat("player"));
	}
	unk_0x4F3C4F457D44BB0F(Global_98676, 1, 1);
	unk_0x694113444F21E39F(Global_98676, 132, 1);
	unk_0x642738D0DCA36EBA(Global_98676, 16);
	func_39(&Global_98676, Global_93959);
	func_38(&uLocal_72, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
	uLocal_239 = unk_0x79CC07752E7432A1(iLocal_240, unk_0x3E4D3CCC220BDFB1(Global_98676, 1), 1, 1, 0);
	unk_0xF8A652CE310FFC53(uLocal_239, Global_98676, unk_0xE6B87C42793036AA(Global_98676, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_44(uParam109, 17, 1785177548, 1785177548, unk_0x658086F2B3C5E4E4(-5f, 5f), unk_0x658086F2B3C5E4E4(-5f, 5f), 0f, unk_0x658086F2B3C5E4E4(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_44(uParam109, 144, 1785177548, 1785177548, unk_0x658086F2B3C5E4E4(-5f, 5f), unk_0x658086F2B3C5E4E4(-5f, 5f), 0f, unk_0x658086F2B3C5E4E4(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_44(uParam109, 43, 1785177548, 1785177548, unk_0x658086F2B3C5E4E4(-5f, 5f), unk_0x658086F2B3C5E4E4(-5f, 5f), 0f, unk_0x658086F2B3C5E4E4(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
