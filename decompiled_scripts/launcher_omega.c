...
void func_189(int iParam0)
{
	...
	if ((unk_0xA5E11AF0A2B928C1() - iLocal_98) > 1250)
	{
		if (func_132(iParam0->f_28[0]) && !unk_0x865259F0333CAA4B(iParam0->f_28[0]))
		{
			if (func_132(unk_0xC1A5EC5C986B98AD()) && !func_190(unk_0xC1A5EC5C986B98AD(), iParam0->f_28[0], 50f, 1))
			{
				Var0 = { unk_0x30BE8A934C020461(iParam0->f_28[0], 1) };
				Var3 = { unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1) };
				fVar7 = (Var3.f_0 - Var0.f_0);
				fVar8 = (Var3.f_1 - Var0.f_1);
				if (fVar8 != 0f)
				{
					fVar6 = unk_0x360118B65D6530C6(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
				...
				unk_0x692C3FDAD7DB53CC(iParam0->f_28[0], fVar6);
			}
		}
...
void func_191()
{
	...
	unk_0x20C68F87D0FDD976(uLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0xA5E11AF0A2B928C1() - iLocal_98) > 1250)
	{
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_180(2))
		{
			if (!func_151())
			{
				if ((func_132(unk_0xC1A5EC5C986B98AD()) && func_132(iParam0->f_28[0])) && func_199(unk_0xC1A5EC5C986B98AD(), Param1, 1) < 20f)
				{
			...
			if (func_199(unk_0xC1A5EC5C986B98AD(), Param1, 1) < 20f && *uParam8 == 1)
			{
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_217(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[iVar0]))
							{
...
int func_220(int iParam0, float fParam1)
{
	...
	{
		if (func_231(iParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), iParam0))
		{
...
{
	return func_222(iParam0, unk_0xC1A5EC5C986B98AD(), fParam1, 1, 250, 7);
}
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_228(unk_0x30BE8A934C020461(iParam1, 1) - unk_0x30BE8A934C020461(iParam0, 1)) };
	...
	{
		Var3 = { func_228(unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_235(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_228(Param1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
int func_249(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 3:
			unk_0x8E09E8C52602EBB2(2314.546f, 2576.33f, 44.7f, 2326.446f, 2579.608f, 47.6645f, 0, 1);
			unk_0x10DFA2EC4C030EB3(2321.252f, 2578.851f, 46.7f, 10f, 0, 0, 0, 0, 0, 0, 0);
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
...
int func_258(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if ((func_132(uParam0->f_28[0]) && unk_0x7DE17ACDD8BA2642(uParam0->f_41[0])) && unk_0x7DE17ACDD8BA2642(uParam0->f_41[1]))
			{
...
void func_272(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 45)
	{
		unk_0x8E09E8C52602EBB2(2314.546f, 2576.33f, 44.7f, 2326.446f, 2579.608f, 47.6645f, 1, 1);
	}
	if (bParam1)
	{
		func_289("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		if (*iParam0 == 44 && unk_0x7DE17ACDD8BA2642(iParam0->f_41[1]))
		{
			unk_0xC621CC7313639986(&(iParam0->f_41[1]));
		}
