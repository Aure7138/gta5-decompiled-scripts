	...
	if (unk_0xD63E63DFACCEB80E(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_96445[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_263(&(Global_96445[Var0.f_0 /*10*/].f_9));
			}
		}
		func_247(&Var0, 1);
	}
...
void func_164(int iParam0)
{
	...
	if ((unk_0x17103F66FBB44C3C() - iLocal_97) > 1250)
	{
		if (func_111(iParam0->f_28[0]) && !unk_0x0FF9FE2CB115CFB9(iParam0->f_28[0]))
		{
			if (func_111(unk_0x9F92518438215DD0()) && !func_165(unk_0x9F92518438215DD0(), iParam0->f_28[0], 50f))
			{
				Var0 = { unk_0x77009B1C011405A9(iParam0->f_28[0], 1) };
				Var3 = { unk_0x77009B1C011405A9(unk_0x9F92518438215DD0(), 1) };
				fVar7 = (Var3.f_0 - Var0.f_0);
				fVar8 = (Var3.f_1 - Var0.f_1);
				if (fVar8 != 0f)
				{
					fVar6 = unk_0x4E9A83F39209A4F6(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
				...
				unk_0x03D97EDECF2E1859(iParam0->f_28[0], fVar6);
			}
		}
		iLocal_97 = unk_0x17103F66FBB44C3C();
	}
}
...
void func_166()
{
	...
	unk_0x48F299599202B77A(uLocal_95, "SET_COLOUR");
	unk_0x4BD4D58838D3F8E5(255);
	...
	unk_0x48F299599202B77A(uLocal_95, "SET_DISTANCE");
	unk_0xC4F81CF078CCB564(10f);
	unk_0x7E86CE5F658823DB();
	unk_0xCC9F831B0FB88625(uLocal_96);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x6FFAE2D893387C6F(uLocal_95, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x17103F66FBB44C3C() - iLocal_97) > 1250)
	{
		unk_0x6687E59C6A0BB305(uLocal_98, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_97 = unk_0x17103F66FBB44C3C();
	}
}
...
int func_167(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_155(2))
		{
			if (!func_129())
			{
				if ((func_111(unk_0x9F92518438215DD0()) && func_111(iParam0->f_28[0])) && func_174(unk_0x9F92518438215DD0(), Param1, 1) < 20f)
				{
			...
			if (func_174(unk_0x9F92518438215DD0(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_184(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_111(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_186(uParam1) || !unk_0x3C17D9ED0E5F3FCA(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_185(iParam2) && !unk_0x53C8F92CF78772BF(iParam0, unk_0x9F92518438215DD0(), 25f))
					{
						unk_0x23F243BF5B07DA90(iParam0, unk_0x9F92518438215DD0(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_186(uParam1) && uParam1->f_4 == 0) && unk_0x91EAD4F2F9B5B38A(unk_0x77009B1C011405A9(unk_0x9F92518438215DD0(), 1), unk_0x77009B1C011405A9(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_185(iParam2) || unk_0x53C8F92CF78772BF(iParam0, unk_0x9F92518438215DD0(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f))
					{
						unk_0x7CF15DD8B3815A0D(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0x746960881FB19A89(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_192(unk_0x9F92518438215DD0(), uParam0->f_35[iVar0]))
							{
...
int func_195(int iParam0, float fParam1)
{
	...
	{
		if (func_206(iParam0) || unk_0xEA02B89C167BF0E3(unk_0xCFC72E446B0B3AD7(), iParam0))
		{
...
{
	return func_197(iParam0, unk_0x9F92518438215DD0(), fParam1, 1, 250, 7);
}
...
int func_201(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_203(unk_0x77009B1C011405A9(iParam1, 1) - unk_0x77009B1C011405A9(iParam0, 1)) };
	...
	{
		Var3 = { func_203(unk_0xAA04EEFB14FDE2E9(iParam0, 31086, 0f, 5f, 0f) - unk_0xAA04EEFB14FDE2E9(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_210(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_203(Param1 - unk_0x77009B1C011405A9(uParam0, 1)) };
...
void func_222()
{
	uLocal_95 = unk_0xC97D787CE7726A2F("digiscanner");
	while (!unk_0x5E3461E729DA646E(uLocal_95))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0xF105313ACEF0ED40("digiscanner"))
	{
		unk_0x6BA97884B189F6EC("digiscanner", 0);
	}
	unk_0x6987F18E73B9F99A(unk_0xA39FEC2F21781866(joaat("weapon_digiscanner")));
	if (unk_0xF105313ACEF0ED40("digiscanner"))
	{
		uLocal_96 = unk_0x5AC5E5B1593F4965("digiscanner");
	}
	uLocal_98 = unk_0x50798E25F4813F2F();
	iLocal_97 = unk_0x17103F66FBB44C3C();
}
...
int func_233(var uParam0)
{
	...
	switch (iLocal_90)
	{
		...
		case 2:
			...
			if ((func_111(uParam0->f_28[0]) && unk_0x746960881FB19A89(uParam0->f_41[0])) && unk_0x746960881FB19A89(uParam0->f_41[1]))
			{
...
int func_246(struct<3> Param0, struct<3> Param3, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_247(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0x746960881FB19A89(iParam0->f_41[1]))
		{
			unk_0x8FCF30FFEAA1C4D4(&(iParam0->f_41[1]));
		}
