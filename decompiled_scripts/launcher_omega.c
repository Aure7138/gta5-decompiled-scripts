	...
	if (unk_0x7D9C4B359376D38A(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_103642[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_278(&(Global_103642[Var0.f_0 /*10*/].f_9));
			}
		}
		func_262(&Var0, 1);
	}
...
void func_179(int iParam0)
{
	...
	if ((unk_0x53C562FD2B9E3AB0() - iLocal_98) > 1250)
	{
		if (func_124(iParam0->f_28[0]) && !unk_0x841ED61760A7D07B(iParam0->f_28[0]))
		{
			if (func_124(unk_0xFC1458A37D98B502()) && !func_180(unk_0xFC1458A37D98B502(), iParam0->f_28[0], 50f, 1))
			{
				...
				unk_0x48ED7B2293A96722(iParam0->f_28[0], fVar6);
			}
		}
...
void func_181()
{
	...
	unk_0x008F3E3CC076EA0E(uLocal_96, "SET_COLOUR");
	...
	unk_0x008F3E3CC076EA0E(uLocal_96, "SET_DISTANCE");
	unk_0x9499D7329FB840A2(10f);
	unk_0x271AA5469AF471B3();
	unk_0x7913685BF7335C7B(uLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x0EB9853DF8BC0D87(uLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x53C562FD2B9E3AB0() - iLocal_98) > 1250)
	{
		unk_0x23A4CE7F9EBB02D4(uLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = unk_0x53C562FD2B9E3AB0();
	}
}
...
int func_182(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_170(2))
		{
			if (!func_143())
			{
				if ((func_124(unk_0xFC1458A37D98B502()) && func_124(iParam0->f_28[0])) && func_189(unk_0xFC1458A37D98B502(), Param1, 1) < 20f)
				{
			...
			if (func_189(unk_0xFC1458A37D98B502(), Param1, 1) < 20f && *uParam8 == 1)
			{
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_201(uParam1) || !unk_0xA5F6598E13F98E08(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_201(uParam1) && uParam1->f_4 == 0) && unk_0xBE3C4023003180FC(unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1), unk_0xB3328BA8976B416C(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_216(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_218(unk_0xB3328BA8976B416C(iParam1, 1) - unk_0xB3328BA8976B416C(iParam0, 1)) };
	...
	{
		Var3 = { func_218(unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 5f, 0f) - unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_225(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_218(Param1 - unk_0xB3328BA8976B416C(uParam0, 1)) };
...
void func_237()
{
	uLocal_96 = unk_0xD704C81492296A37("digiscanner");
	while (!unk_0x34D11AB5BA7922C2(uLocal_96))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	...
	if (unk_0x7118556A56307B25("digiscanner"))
	{
		uLocal_97 = unk_0x3B46B5E6947B1597("digiscanner");
	}
	uLocal_99 = unk_0xD0CA83418A236CB4();
	iLocal_98 = unk_0x53C562FD2B9E3AB0();
}
