...
void __EntryFunction__()
{
	...
	if (unk_0x24862A9CDC8F8874(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_100063[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_263(&(Global_100063[Var0.f_0 /*10*/].f_9));
			}
		}
		func_247(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_182(Var0.f_0);
		func_175(&iLocal_93, &(Var0.f_9), Var61);
		if (Var0.f_0 == 44)
		{
			func_167(&Var0, Var61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_94);
			func_166();
		}
		else if (Var0.f_0 == 45)
		{
			func_167(&Var0, Var61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_95);
			func_164(&Var0);
		}
		if (func_149(&Var0, 0))
		{
...
void func_164(int iParam0)
{
	...
	if ((unk_0x693EBB4F13506457() - iLocal_98) > 1250)
	{
		if (func_111(iParam0->f_28[0]) && !unk_0xE77F5DDBC2E96204(iParam0->f_28[0]))
		{
			if (func_111(unk_0xC8B93D94F8954288()) && !func_165(unk_0xC8B93D94F8954288(), iParam0->f_28[0], 50f))
			{
				Var0 = { unk_0x44C17CCB85A88A1F(iParam0->f_28[0], 1) };
				Var3 = { unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1) };
				fVar7 = (Var3.f_0 - Var0.f_0);
				fVar8 = (Var3.f_1 - Var0.f_1);
				if (fVar8 != 0f)
				{
					fVar6 = unk_0x77491A28B7D799AF(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
				...
				unk_0x765E3FA65D011F03(iParam0->f_28[0], fVar6);
			}
		}
		iLocal_98 = unk_0x693EBB4F13506457();
	}
}

bool func_165(int iParam0, int iParam1, float fParam2)
{
...
void func_166()
{
	...
	unk_0x7C38F93AF52620B1(uLocal_96, "SET_COLOUR");
	unk_0x65960B4E2ADC9F6D(255);
	...
	unk_0x7C38F93AF52620B1(uLocal_96, "SET_DISTANCE");
	unk_0x512B59C08EAFA3B9(10f);
	unk_0xD013AC29829DDC02();
	unk_0x052F8F69DC6157DE(uLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x06D856499865F31F(uLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x693EBB4F13506457() - iLocal_98) > 1250)
	{
		unk_0xE55275772E833643(uLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = unk_0x693EBB4F13506457();
	}
}

int func_167(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_155(2))
		{
			if (!func_129())
			{
				if ((func_111(unk_0xC8B93D94F8954288()) && func_111(iParam0->f_28[0])) && func_174(unk_0xC8B93D94F8954288(), Param1, 1) < 20f)
				{
			...
			if (func_174(unk_0xC8B93D94F8954288(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_175(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x06972B20E75CBE06(unk_0xA34E7C2A5118D638()))
	{
...
int func_183(int iParam0, bool bParam1)
{
	...
	func_94(*iParam0, &Var0);
	if ((func_220(*iParam0) || func_218(*iParam0)) || Global_69562 == 1)
	{
		return 1;
	}
	if (!unk_0xCAA967E16BBE69CE())
...
void func_184(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_111(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_186(uParam1) || !unk_0xCD61E9D5CABC7E35(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_185(iParam2) && !unk_0xAF9BF2C76079B4BF(iParam0, unk_0xC8B93D94F8954288(), 25f))
					{
						unk_0xC518AECFA9CF7722(iParam0, unk_0xC8B93D94F8954288(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_186(uParam1) && uParam1->f_4 == 0) && unk_0x4F982ED5336EA899(unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1), unk_0x44C17CCB85A88A1F(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_185(iParam2) || unk_0xAF9BF2C76079B4BF(iParam0, unk_0xC8B93D94F8954288(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x5323F488E6A1B660(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0x95CCECA3948CFE7B(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_192(unk_0xC8B93D94F8954288(), uParam0->f_35[iVar0]))
							{
...
int func_195(int iParam0, float fParam1)
{
	...
	{
		if (func_206(iParam0) || unk_0x0BBFEAC55291063A(unk_0xA34E7C2A5118D638(), iParam0))
		{
...
{
	return func_197(iParam0, unk_0xC8B93D94F8954288(), fParam1, 1, 250, 7);
}
...
int func_201(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_203(unk_0x44C17CCB85A88A1F(iParam1, 1) - unk_0x44C17CCB85A88A1F(iParam0, 1)) };
	...
	{
		Var3 = { func_203(unk_0xB867FC7DBA46C0F1(iParam0, 31086, 0f, 5f, 0f) - unk_0xB867FC7DBA46C0F1(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_210(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_203(Param1 - unk_0x44C17CCB85A88A1F(uParam0, 1)) };
...
{
	if ((func_219() && Global_91106.f_11 == 6) && iParam0 == func_147(&(Global_91106.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_222()
{
	uLocal_96 = unk_0x31DC2CEFEF13C96D("digiscanner");
	while (!unk_0xF518F3C7FACD43B7(uLocal_96))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0x4C4B08464D56970E("digiscanner"))
	{
		unk_0x55C5397453BE04EB("digiscanner", 0);
	}
	unk_0x8D3EF96B70C29C06(unk_0x06C0DD6C22493B3F(joaat("weapon_digiscanner")));
	if (unk_0x4C4B08464D56970E("digiscanner"))
	{
		uLocal_97 = unk_0xEA2A23EE27BAE0D5("digiscanner");
	}
	uLocal_99 = unk_0x83E9D86E63672B9A();
	iLocal_98 = unk_0x693EBB4F13506457();
}
...
int func_233(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if ((func_111(uParam0->f_28[0]) && unk_0x95CCECA3948CFE7B(uParam0->f_41[0])) && unk_0x95CCECA3948CFE7B(uParam0->f_41[1]))
			{
...
void func_247(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0x95CCECA3948CFE7B(iParam0->f_41[1]))
		{
			unk_0xC2BB205CCEB68102(&(iParam0->f_41[1]));
		}
