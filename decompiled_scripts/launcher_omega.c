...
void func_189(int iParam0)
{
	...
	if ((unk_0x1DD05E817C89C737() - iLocal_98) > 1250)
	{
		if (func_132(iParam0->f_28[0]) && !unk_0xCB5CAFF0A4A8B74B(iParam0->f_28[0]))
		{
			if (func_132(unk_0x4A8C381C258A124D()) && !func_190(unk_0x4A8C381C258A124D(), iParam0->f_28[0], 50f, 1))
			{
				...
				if (fVar8 != 0f)
				{
					fVar6 = unk_0x4964D7A2BFD2F9A3(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
				...
				unk_0x5C96CEA06531AB03(iParam0->f_28[0], fVar6);
			}
		}
...
void func_191()
{
	...
	unk_0x88F483FBD433696A(uLocal_96, "SET_COLOUR");
	...
	unk_0x88F483FBD433696A(uLocal_96, "SET_DISTANCE");
	unk_0x74BF156C860580D4(10f);
	unk_0xE6B753D52F4CA222();
	unk_0x61055542D9D877AE(uLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x6D16B99FEB0AFFF1(uLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x1DD05E817C89C737() - iLocal_98) > 1250)
	{
		unk_0xF37CDE164C892195(uLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = unk_0x1DD05E817C89C737();
	}
}
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_180(2))
		{
			if (!func_151())
			{
				if ((func_132(unk_0x4A8C381C258A124D()) && func_132(iParam0->f_28[0])) && func_199(unk_0x4A8C381C258A124D(), Param1, 1) < 20f)
				{
			...
			if (func_199(unk_0x4A8C381C258A124D(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_209(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_132(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_211(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_210(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_211(uParam1) && uParam1->f_4 == 0) && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_210(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_217(unk_0x4A8C381C258A124D(), uParam0->f_35[iVar0]))
							{
...
int func_220(int iParam0, float fParam1)
{
	...
	{
		if (func_231(iParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), iParam0))
		{
...
{
	return func_222(iParam0, unk_0x4A8C381C258A124D(), fParam1, 1, 250, 7);
}
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_228(unk_0xD1A6A821F5AC81DB(iParam1, 1) - unk_0xD1A6A821F5AC81DB(iParam0, 1)) };
	...
	{
		Var3 = { func_228(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_235(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_228(Param1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
void func_247()
{
	uLocal_96 = unk_0x8DE4F68A9728925E("digiscanner");
	while (!unk_0xA0C7B98BCF1EEF9E(uLocal_96))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	...
	if (unk_0xC13AFEAFC3F7AD96("digiscanner"))
	{
		uLocal_97 = unk_0x08732C0099FA1813("digiscanner");
	}
	uLocal_99 = unk_0xCA369FBC0DE29517();
	iLocal_98 = unk_0x1DD05E817C89C737();
}
...
int func_258(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if ((func_132(uParam0->f_28[0]) && unk_0xFC8BFE4B41177C22(uParam0->f_41[0])) && unk_0xFC8BFE4B41177C22(uParam0->f_41[1]))
			{
