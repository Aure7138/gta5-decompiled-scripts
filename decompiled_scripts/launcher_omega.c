	...
	if (unk_0xC11469DCA6FC3BB5(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_96440[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_263(&(Global_96440[Var0.f_0 /*10*/].f_9));
			}
		}
		func_247(&Var0, 1);
	}
...
void func_164(int iParam0)
{
	...
	if ((unk_0x4F67E8ECA7D3F667() - iLocal_97) > 1250)
	{
		if (func_111(iParam0->f_28[0]) && !unk_0x613C15D5D8DB781F(iParam0->f_28[0]))
		{
			if (func_111(unk_0x096275889B8E0EE0()) && !func_165(unk_0x096275889B8E0EE0(), iParam0->f_28[0], 50f))
			{
				Var0 = { unk_0xA86D5F069399F44D(iParam0->f_28[0], 1) };
				Var3 = { unk_0xA86D5F069399F44D(unk_0x096275889B8E0EE0(), 1) };
				fVar7 = (Var3.f_0 - Var0.f_0);
				fVar8 = (Var3.f_1 - Var0.f_1);
				if (fVar8 != 0f)
				{
					fVar6 = unk_0x965B220A066E3F07(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
				...
				unk_0xCF2B9C0645C4651B(iParam0->f_28[0], fVar6);
			}
		}
		iLocal_97 = unk_0x4F67E8ECA7D3F667();
	}
}
...
void func_166()
{
	...
	unk_0xF6EA2AC68E7C7293(uLocal_95, "SET_COLOUR");
	unk_0xA734310215BCF528(255);
	...
	unk_0xF6EA2AC68E7C7293(uLocal_95, "SET_DISTANCE");
	unk_0xBC38230AD29DBDD4(10f);
	unk_0xD4D85E4148B638AD();
	unk_0xE550CDE128D56757(uLocal_96);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x029823681D10A10E(uLocal_95, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x4F67E8ECA7D3F667() - iLocal_97) > 1250)
	{
		unk_0x8DA75EC60D972359(uLocal_98, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_97 = unk_0x4F67E8ECA7D3F667();
	}
}
...
int func_167(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_155(2))
		{
			if (!func_129())
			{
				if ((func_111(unk_0x096275889B8E0EE0()) && func_111(iParam0->f_28[0])) && func_174(unk_0x096275889B8E0EE0(), Param1, 1) < 20f)
				{
			...
			if (func_174(unk_0x096275889B8E0EE0(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_184(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_111(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_186(uParam1) || !unk_0xDEE49D5CA6C49148(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_185(iParam2) && !unk_0x9B4CC17D919C8FC4(iParam0, unk_0x096275889B8E0EE0(), 25f))
					{
						unk_0xFE920E72A4B34285(iParam0, unk_0x096275889B8E0EE0(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_186(uParam1) && uParam1->f_4 == 0) && unk_0x0BE7F4E3CDBAFB28(unk_0xA86D5F069399F44D(unk_0x096275889B8E0EE0(), 1), unk_0xA86D5F069399F44D(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_185(iParam2) || unk_0x9B4CC17D919C8FC4(iParam0, unk_0x096275889B8E0EE0(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f))
					{
						unk_0x8DBC05C86F873CC9(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0xD42BD6EB2E0F1677(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_192(unk_0x096275889B8E0EE0(), uParam0->f_35[iVar0]))
							{
...
int func_195(int iParam0, float fParam1)
{
	...
	{
		if (func_206(iParam0) || unk_0x27F89FDC16688A7A(unk_0x217E9DC48139933D(), iParam0))
		{
...
{
	return func_197(iParam0, unk_0x096275889B8E0EE0(), fParam1, 1, 250, 7);
}
...
int func_201(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_203(unk_0xA86D5F069399F44D(iParam1, 1) - unk_0xA86D5F069399F44D(iParam0, 1)) };
	...
	{
		Var3 = { func_203(unk_0x012B43913EE9671C(iParam0, 31086, 0f, 5f, 0f) - unk_0x012B43913EE9671C(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_210(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_203(Param1 - unk_0xA86D5F069399F44D(uParam0, 1)) };
...
void func_222()
{
	...
	while (!unk_0x64BAE9BE701E6C19(uLocal_95))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0x3EE32F7964C40FE6("digiscanner"))
	{
		unk_0x98AF2BB6F62BD588("digiscanner", 0);
	}
	unk_0x2F506B8556242DDB(unk_0x7238A63D4D013335(joaat("weapon_digiscanner")));
	if (unk_0x3EE32F7964C40FE6("digiscanner"))
	{
		uLocal_96 = unk_0xB6762A85EE29AA60("digiscanner");
	}
	uLocal_98 = unk_0xC488DC56F57F2505();
	iLocal_97 = unk_0x4F67E8ECA7D3F667();
}
...
int func_233(var uParam0)
{
	...
	switch (iLocal_90)
	{
		...
		case 2:
			...
			if ((func_111(uParam0->f_28[0]) && unk_0xD42BD6EB2E0F1677(uParam0->f_41[0])) && unk_0xD42BD6EB2E0F1677(uParam0->f_41[1]))
			{
...
void func_247(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0xD42BD6EB2E0F1677(iParam0->f_41[1]))
		{
			unk_0x0AD8BB0ADAFEDEE5(&(iParam0->f_41[1]));
		}
