...
void func_184(int iParam0)
{
	...
	if ((unk_0x320D1840B6DAA1CC() - iLocal_98) > 1250)
	{
		if (func_127(iParam0->f_28[0]) && !unk_0xBC7D3EDF3455BC35(iParam0->f_28[0]))
		{
			if (func_127(unk_0xE2D3D51028F0428A()) && !func_185(unk_0xE2D3D51028F0428A(), iParam0->f_28[0], 50f, 1))
			{
				Var0 = { unk_0x6B62510F212526DC(iParam0->f_28[0], 1) };
				Var3 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) };
				fVar7 = (Var3.f_0 - Var0.f_0);
				fVar8 = (Var3.f_1 - Var0.f_1);
				if (fVar8 != 0f)
				{
					fVar6 = unk_0xC529D13129C03CF4(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
				...
				unk_0xBBF86885619695CE(iParam0->f_28[0], fVar6);
			}
		}
...
void func_186()
{
	...
	unk_0xEA5DEA46C3EE64D3(uLocal_96, "SET_COLOUR");
	...
	unk_0xEA5DEA46C3EE64D3(uLocal_96, "SET_DISTANCE");
	unk_0xCA5D23E5F0F0306F(10f);
	unk_0x6F06CF0E9AB02847();
	unk_0xCF0E3BB302EAC0EA(uLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x694170BB080C08FF(uLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x320D1840B6DAA1CC() - iLocal_98) > 1250)
	{
		unk_0xD336F8D9637B963F(uLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = unk_0x320D1840B6DAA1CC();
	}
}
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_175(2))
		{
			if (!func_146())
			{
				if ((func_127(unk_0xE2D3D51028F0428A()) && func_127(iParam0->f_28[0])) && func_194(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f)
				{
			...
			if (func_194(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_242()
{
	uLocal_96 = unk_0x528279F3F1EEF869("digiscanner");
	while (!unk_0x0347CCBD719C8ADC(uLocal_96))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0xBB75DCB31B62483C("digiscanner"))
	{
		unk_0x7F31E4CDB9FB2193("digiscanner", 0);
	}
	unk_0xC043F1F3CF279111(unk_0xB8DEE91181C30E65(joaat("weapon_digiscanner")));
	if (unk_0xBB75DCB31B62483C("digiscanner"))
	{
		uLocal_97 = unk_0x014679E62446327A("digiscanner");
	}
	uLocal_99 = unk_0xA9ADCC8D104AA552();
	iLocal_98 = unk_0x320D1840B6DAA1CC();
}
...
int func_253(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if ((func_127(uParam0->f_28[0]) && unk_0xE5965CDF24F93A9F(uParam0->f_41[0])) && unk_0xE5965CDF24F93A9F(uParam0->f_41[1]))
			{
...
void func_267(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0xE5965CDF24F93A9F(iParam0->f_41[1]))
		{
			unk_0x59E393B344098656(&(iParam0->f_41[1]));
		}
