...
void func_186(int iParam0)
{
	...
	{
		if (func_129(iParam0->f_28[0]) && !unk_0xBC7D3EDF3455BC35(iParam0->f_28[0]))
		{
			if (func_129(unk_0xE2D3D51028F0428A()) && !func_187(unk_0xE2D3D51028F0428A(), iParam0->f_28[0], 50f, 1))
			{
...
bool func_187(int iParam0, int iParam1, float fParam2, int iParam3)
{
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_177(2))
		{
			if (!func_148())
			{
				if ((func_129(unk_0xE2D3D51028F0428A()) && func_129(iParam0->f_28[0])) && func_196(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f)
				{
			...
			if (func_196(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
int func_250(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	int iVar0;
...
int func_255(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if ((func_129(uParam0->f_28[0]) && unk_0xE5965CDF24F93A9F(uParam0->f_41[0])) && unk_0xE5965CDF24F93A9F(uParam0->f_41[1]))
			{
