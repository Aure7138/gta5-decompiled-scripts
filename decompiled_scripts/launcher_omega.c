	...
	if (unk_0xD4BE58A7E3E102AC(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_110647[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_283(&(Global_110647[Var0.f_0 /*10*/].f_9));
			}
		}
		func_267(&Var0, 1);
	}
...
void func_184(int iParam0)
{
	...
	if ((unk_0x9B35D07DCD0F0B43() - iLocal_98) > 1250)
	{
		if (func_127(iParam0->f_28[0]) && !unk_0x62E95D2FED28E41C(iParam0->f_28[0]))
		{
			if (func_127(unk_0x0FA8183DAD2B3203()) && !func_185(unk_0x0FA8183DAD2B3203(), iParam0->f_28[0], 50f, 1))
			{
				Var0 = { unk_0xACE5E491FC1B0D37(iParam0->f_28[0], 1) };
				Var3 = { unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1) };
				fVar7 = (Var3.f_0 - Var0.f_0);
				fVar8 = (Var3.f_1 - Var0.f_1);
				if (fVar8 != 0f)
				{
					fVar6 = unk_0x68862EAA0B66897C(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
				...
				unk_0x5A2B7C446C0CF087(iParam0->f_28[0], fVar6);
			}
		}
		iLocal_98 = unk_0x9B35D07DCD0F0B43();
	}
}

bool func_185(int iParam0, int iParam1, float fParam2, int iParam3)
{
...
void func_186()
{
	...
	unk_0xF1BC72CEC2746995(uLocal_96, "SET_COLOUR");
	unk_0xD02F24F3E2DB263A(255);
	...
	unk_0xF1BC72CEC2746995(uLocal_96, "SET_DISTANCE");
	unk_0xD435957F6275B434(10f);
	unk_0xAC7C2DE2DDC7AF03();
	unk_0x2419788BC7E0A733(uLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x1C65AC18AFC2CA39(uLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x9B35D07DCD0F0B43() - iLocal_98) > 1250)
	{
		unk_0x0A41046A9C717367(uLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = unk_0x9B35D07DCD0F0B43();
	}
}
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_175(2))
		{
			if (!func_146())
			{
				if ((func_127(unk_0x0FA8183DAD2B3203()) && func_127(iParam0->f_28[0])) && func_194(unk_0x0FA8183DAD2B3203(), Param1, 1) < 20f)
				{
			...
			if (func_194(unk_0x0FA8183DAD2B3203(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_204(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_206(uParam1) || !unk_0xF6FD8019402CF03B(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_205(iParam2) && !unk_0x9B1F9CEC0CB28F35(iParam0, unk_0x0FA8183DAD2B3203(), 25f))
					{
						unk_0x845704CC8ADF1918(iParam0, unk_0x0FA8183DAD2B3203(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && unk_0xD34AF93E9BCF12F0(unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1), unk_0xACE5E491FC1B0D37(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_205(iParam2) || unk_0x9B1F9CEC0CB28F35(iParam0, unk_0x0FA8183DAD2B3203(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x5D672CB011E20B28(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0xD4B321D9096B01FC(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_212(unk_0x0FA8183DAD2B3203(), uParam0->f_35[iVar0]))
							{
...
int func_215(int iParam0, float fParam1)
{
	...
	{
		if (func_226(iParam0) || unk_0x4412340828EC2614(unk_0x7C7787D2D7139A85(), iParam0))
		{
...
{
	return func_217(iParam0, unk_0x0FA8183DAD2B3203(), fParam1, 1, 250, 7);
}
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_223(unk_0xACE5E491FC1B0D37(iParam1, 1) - unk_0xACE5E491FC1B0D37(iParam0, 1)) };
	...
	{
		Var3 = { func_223(unk_0x0E516C24C87F5D0C(iParam0, 31086, 0f, 5f, 0f) - unk_0x0E516C24C87F5D0C(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_230(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_223(Param1 - unk_0xACE5E491FC1B0D37(uParam0, 1)) };
...
void func_242()
{
	uLocal_96 = unk_0x1FAFE9BB9D8960C1("digiscanner");
	while (!unk_0x08EA887200715AD9(uLocal_96))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0x1473B221A4507333("digiscanner"))
	{
		unk_0x0D4D70259A823FB9("digiscanner", 0);
	}
	unk_0x58121333AB1E3EA0(unk_0x287754837725E34B(joaat("weapon_digiscanner")));
	if (unk_0x1473B221A4507333("digiscanner"))
	{
		uLocal_97 = unk_0x9F932A236AD1D911("digiscanner");
	}
	uLocal_99 = unk_0x04B8CCFB93858A27();
	iLocal_98 = unk_0x9B35D07DCD0F0B43();
}
...
int func_253(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if ((func_127(uParam0->f_28[0]) && unk_0xD4B321D9096B01FC(uParam0->f_41[0])) && unk_0xD4B321D9096B01FC(uParam0->f_41[1]))
			{
...
void func_267(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0xD4B321D9096B01FC(iParam0->f_41[1]))
		{
			unk_0x86A9549BD3D71664(&(iParam0->f_41[1]));
		}
