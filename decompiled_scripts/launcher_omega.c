	...
	if (unk_0x2EBF608FFE6CA406(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_110725[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_283(&(Global_110725[Var0.f_0 /*10*/].f_9));
			}
		}
		func_267(&Var0, 1);
	}
...
void func_184(int iParam0)
{
	...
	if ((unk_0x1C0640BA9A7327B3() - iLocal_98) > 1250)
	{
		if (func_127(iParam0->f_28[0]) && !unk_0x0A059E0DB9253280(iParam0->f_28[0]))
		{
			if (func_127(unk_0x16F2683693E537C9()) && !func_185(unk_0x16F2683693E537C9(), iParam0->f_28[0], 50f, 1))
			{
				...
				unk_0xD8F6A53F4799FAFE(iParam0->f_28[0], fVar6);
			}
		}
...
void func_186()
{
	...
	unk_0x7E60C62A7CE58FC8(uLocal_96, "SET_COLOUR");
	...
	unk_0x7E60C62A7CE58FC8(uLocal_96, "SET_DISTANCE");
	unk_0x7C19E5E4784BD7CF(10f);
	unk_0x7E60D21B163E9D56();
	unk_0x3039591AD3E735CE(uLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0xEF45C43067063F18(uLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x1C0640BA9A7327B3() - iLocal_98) > 1250)
	{
		unk_0xEB819BD1E585E9CB(uLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = unk_0x1C0640BA9A7327B3();
	}
}
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_175(2))
		{
			if (!func_146())
			{
				if ((func_127(unk_0x16F2683693E537C9()) && func_127(iParam0->f_28[0])) && func_194(unk_0x16F2683693E537C9(), Param1, 1) < 20f)
				{
			...
			if (func_194(unk_0x16F2683693E537C9(), Param1, 1) < 20f && *uParam8 == 1)
			{
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_206(uParam1) || !unk_0xB4ECF989E2C1DAC8(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), unk_0x68F4C0EC296D3901(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_223(unk_0x68F4C0EC296D3901(iParam1, 1) - unk_0x68F4C0EC296D3901(iParam0, 1)) };
	...
	{
		Var3 = { func_223(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_230(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_223(Param1 - unk_0x68F4C0EC296D3901(uParam0, 1)) };
...
void func_242()
{
	uLocal_96 = unk_0xB01F55A0FD1CFD49("digiscanner");
	while (!unk_0x83D8570832F172A7(uLocal_96))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	...
	if (unk_0xE6CD5C6925050049("digiscanner"))
	{
		uLocal_97 = unk_0x3FF702268B97B673("digiscanner");
	}
	uLocal_99 = unk_0xD68EA767274B7444();
	iLocal_98 = unk_0x1C0640BA9A7327B3();
}
