...
void func_164(int iParam0)
{
	...
	if ((unk_0x9CD27B0045628463() - iLocal_97) > 1250)
	{
		if (func_111(iParam0->f_28[0]) && !unk_0xE659E47AF827484B(iParam0->f_28[0]))
		{
			if (func_111(unk_0xD80958FC74E988A6()) && !func_165(unk_0xD80958FC74E988A6(), iParam0->f_28[0], 50f))
			{
				...
				if (fVar8 != 0f)
				{
					fVar6 = unk_0x8927CBF9D22261A4(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
				...
				unk_0x8E2530AA8ADA980E(iParam0->f_28[0], fVar6);
			}
		}
...
void func_166()
{
	...
	unk_0x54972ADAF0294A93(iLocal_95, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x9CD27B0045628463() - iLocal_97) > 1250)
	{
		unk_0x8D8686B622B88120(iLocal_98, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", false, 0, false);
		iLocal_97 = unk_0x9CD27B0045628463();
	}
}
...
int func_167(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_155(2))
		{
			if (!func_129())
			{
				if ((func_111(unk_0xD80958FC74E988A6()) && func_111(iParam0->f_28[0])) && func_174(unk_0xD80958FC74E988A6(), Param1, 1) < 20f)
				{
			...
			if (func_174(unk_0xD80958FC74E988A6(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_184(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_111(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_186(uParam1) || !unk_0x1F0B79228E461EC9(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_185(iParam2) && !unk_0xD71649DB0A545AA3(iParam0, unk_0xD80958FC74E988A6(), 25f))
					{
						unk_0x5AD23D40115353AC(iParam0, unk_0xD80958FC74E988A6(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_186(uParam1) && uParam1->f_4 == 0) && unk_0xF1B760881820C952(unk_0x3FEF770D40960D5A(unk_0xD80958FC74E988A6(), true), unk_0x3FEF770D40960D5A(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_185(iParam2) || unk_0xD71649DB0A545AA3(iParam0, unk_0xD80958FC74E988A6(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f))
					{
						unk_0xEA47FE3719165B94(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
			...
			if (unk_0x7239B21A38F536BA(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_192(unk_0xD80958FC74E988A6(), uParam0->f_35[iVar0]))
							{
...
int func_195(int iParam0, float fParam1)
{
	...
	{
		if (func_206(iParam0) || unk_0x7912F7FC4F6264B6(unk_0x4F8644AF03D0E0D6(), iParam0))
		{
...
{
	return func_197(iParam0, unk_0xD80958FC74E988A6(), fParam1, 1, 250, 7);
}
...
int func_201(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_203(unk_0x3FEF770D40960D5A(iParam1, true) - unk_0x3FEF770D40960D5A(iParam0, true)) };
	...
	{
		Var3 = { func_203(unk_0x17C07FC640E86B4E(iParam0, 31086, 0f, 5f, 0f) - unk_0x17C07FC640E86B4E(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_209(int iParam0, float fParam1)
{
	...
	{
		if (func_210(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_210(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_203(Param1 - unk_0x3FEF770D40960D5A(iParam0, true)) };
...
void func_222()
{
	...
	iLocal_98 = unk_0x430386FE9BF80B45();
	iLocal_97 = unk_0x9CD27B0045628463();
}
...
void func_225(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_226(iParam0);
...
int func_233(var uParam0)
{
	...
	switch (iLocal_90)
	{
		...
		case 2:
			...
			if ((func_111(uParam0->f_28[0]) && unk_0x7239B21A38F536BA(uParam0->f_41[0])) && unk_0x7239B21A38F536BA(uParam0->f_41[1]))
			{
