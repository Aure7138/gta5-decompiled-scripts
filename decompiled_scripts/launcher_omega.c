...
void __EntryFunction__()
{
	...
	if (unk_0x9EC5BDC006623C42(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_105652[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_105652[Var0.f_0 /*10*/].f_9));
			}
		}
		func_265(&Var0, 1);
	}
	...
	while (true)
	{
		...
		if (Var0.f_0 == 44)
		{
			func_185(&Var0, Var61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_94);
			func_184();
		}
		else if (Var0.f_0 == 45)
		{
			func_185(&Var0, Var61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_95);
			func_182(&Var0);
		}
		if (func_167(&Var0, 0))
		{
...
void func_182(int iParam0)
{
	...
	if ((unk_0xE3903F59E2F22150() - iLocal_98) > 1250)
	{
		if (func_126(iParam0->f_28[0]) && !unk_0x3F219400E5FE4B69(iParam0->f_28[0]))
		{
			if (func_126(unk_0x33CD235DF1E6A94E()) && !func_183(unk_0x33CD235DF1E6A94E(), iParam0->f_28[0], 50f, 1))
			{
				Var0 = { unk_0xFBB1F99A825CAB09(iParam0->f_28[0], 1) };
				Var3 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1) };
				fVar7 = (Var3.f_0 - Var0.f_0);
				fVar8 = (Var3.f_1 - Var0.f_1);
				if (fVar8 != 0f)
				{
					fVar6 = unk_0xB92C3C556226E8F9(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
				...
				unk_0x3C990C409B3845DE(iParam0->f_28[0], fVar6);
			}
		}
		iLocal_98 = unk_0xE3903F59E2F22150();
	}
}

bool func_183(int iParam0, int iParam1, float fParam2, int iParam3)
{
...
void func_184()
{
	...
	unk_0xBB698266C5FDF0A7(uLocal_96, "SET_COLOUR");
	unk_0x4D9DA18AB3C2A466(255);
	...
	unk_0xBB698266C5FDF0A7(uLocal_96, "SET_DISTANCE");
	unk_0x8DAB5B12D7B9AD29(10f);
	unk_0x818901B332D5541D();
	unk_0x93B6B00E52590FB9(uLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x5A2C46836B4DF5B3(uLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0xE3903F59E2F22150() - iLocal_98) > 1250)
	{
		unk_0xEC95D37A139F1D5C(uLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = unk_0xE3903F59E2F22150();
	}
}

int func_185(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_173(2))
		{
			if (!func_145())
			{
				if ((func_126(unk_0x33CD235DF1E6A94E()) && func_126(iParam0->f_28[0])) && func_192(unk_0x33CD235DF1E6A94E(), Param1, 1) < 20f)
				{
			...
			if (func_192(unk_0x33CD235DF1E6A94E(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_202(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_126(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_204(uParam1) || !unk_0x1CE8F0A08E65CA6A(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_203(iParam2) && !unk_0x910FF514D7BC5674(iParam0, unk_0x33CD235DF1E6A94E(), 25f))
					{
						unk_0x11C4AF4137F2A4B5(iParam0, unk_0x33CD235DF1E6A94E(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_204(uParam1) && uParam1->f_4 == 0) && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1), unk_0xFBB1F99A825CAB09(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_203(iParam2) || unk_0x910FF514D7BC5674(iParam0, unk_0x33CD235DF1E6A94E(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x108754262311D34F(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0x765F6FEEFF39224F(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_210(unk_0x33CD235DF1E6A94E(), uParam0->f_35[iVar0]))
							{
...
int func_213(int iParam0, float fParam1)
{
	...
	{
		if (func_224(iParam0) || unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iParam0))
		{
...
{
	return func_215(iParam0, unk_0x33CD235DF1E6A94E(), fParam1, 1, 250, 7);
}
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_221(unk_0xFBB1F99A825CAB09(iParam1, 1) - unk_0xFBB1F99A825CAB09(iParam0, 1)) };
	...
	{
		Var3 = { func_221(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_228(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_221(Param1 - unk_0xFBB1F99A825CAB09(uParam0, 1)) };
...
void func_240()
{
	uLocal_96 = unk_0x199B24FF79A52CCF("digiscanner");
	while (!unk_0x11AE7F6A404414C9(uLocal_96))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0x464516DA815840A7("digiscanner"))
	{
		unk_0x043937B909498729("digiscanner", 0);
	}
	unk_0xB1D0D338D38FBD61(unk_0x12772FC739A13F81(joaat("weapon_digiscanner")));
	if (unk_0x464516DA815840A7("digiscanner"))
	{
		uLocal_97 = unk_0x61A52F6201AA9959("digiscanner");
	}
	uLocal_99 = unk_0x8CCC0A0504C52531();
	iLocal_98 = unk_0xE3903F59E2F22150();
}
...
int func_251(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if ((func_126(uParam0->f_28[0]) && unk_0x765F6FEEFF39224F(uParam0->f_41[0])) && unk_0x765F6FEEFF39224F(uParam0->f_41[1]))
			{
...
void func_265(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0x765F6FEEFF39224F(iParam0->f_41[1]))
		{
			unk_0x26ABAE1D971CEACD(&(iParam0->f_41[1]));
		}
