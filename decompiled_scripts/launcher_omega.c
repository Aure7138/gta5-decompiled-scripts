	...
	if (unk_0x2C897F101BA20806(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_96526[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_263(&(Global_96526[Var0.f_0 /*10*/].f_9));
			}
		}
		func_247(&Var0, 1);
	}
...
void func_164(int iParam0)
{
	...
	if ((unk_0x09560C7DE2A384BD() - iLocal_97) > 1250)
	{
		if (func_111(iParam0->f_28[0]) && !unk_0x98666858610065B8(iParam0->f_28[0]))
		{
			if (func_111(unk_0xA16EC202D9D35357()) && !func_165(unk_0xA16EC202D9D35357(), iParam0->f_28[0], 50f))
			{
				Var0 = { unk_0xBF8499F46AD9093A(iParam0->f_28[0], 1) };
				Var3 = { unk_0xBF8499F46AD9093A(unk_0xA16EC202D9D35357(), 1) };
				fVar7 = (Var3.f_0 - Var0.f_0);
				fVar8 = (Var3.f_1 - Var0.f_1);
				if (fVar8 != 0f)
				{
					fVar6 = unk_0xCE9082F704DCC33A(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
				...
				unk_0x34639238667C4381(iParam0->f_28[0], fVar6);
			}
		}
		iLocal_97 = unk_0x09560C7DE2A384BD();
	}
}
...
void func_166()
{
	...
	unk_0xB067107D878E9585(uLocal_95, "SET_COLOUR");
	unk_0x26221D1D76579618(255);
	...
	unk_0xB067107D878E9585(uLocal_95, "SET_DISTANCE");
	unk_0x50050D925C27B388(10f);
	unk_0xD3DF251F2DF3B257();
	unk_0x8E515AA7023E13EA(uLocal_96);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x782CAB485999E384(uLocal_95, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x09560C7DE2A384BD() - iLocal_97) > 1250)
	{
		unk_0x859FD7253E29A93D(uLocal_98, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_97 = unk_0x09560C7DE2A384BD();
	}
}
...
int func_167(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_155(2))
		{
			if (!func_129())
			{
				if ((func_111(unk_0xA16EC202D9D35357()) && func_111(iParam0->f_28[0])) && func_174(unk_0xA16EC202D9D35357(), Param1, 1) < 20f)
				{
			...
			if (func_174(unk_0xA16EC202D9D35357(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
int func_183(int iParam0, bool bParam1)
{
	...
	func_94(*iParam0, &Var0);
	if ((func_220(*iParam0) || func_218(*iParam0)) || Global_68570 == 1)
	{
		return 1;
	}
	if (!unk_0xFEC6476AFCF2033F())
...
void func_184(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_111(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_186(uParam1) || !unk_0x95EDB2DEFA5BB405(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_185(iParam2) && !unk_0x68E6C2D89A534992(iParam0, unk_0xA16EC202D9D35357(), 25f))
					{
						unk_0x1CAB36EC4E43E586(iParam0, unk_0xA16EC202D9D35357(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_186(uParam1) && uParam1->f_4 == 0) && unk_0x4970185D4CC64616(unk_0xBF8499F46AD9093A(unk_0xA16EC202D9D35357(), 1), unk_0xBF8499F46AD9093A(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_185(iParam2) || unk_0x68E6C2D89A534992(iParam0, unk_0xA16EC202D9D35357(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x5B5659C49032B96C(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0x538DF9E5B1DF01EB(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_192(unk_0xA16EC202D9D35357(), uParam0->f_35[iVar0]))
							{
...
int func_195(int iParam0, float fParam1)
{
	...
	{
		if (func_206(iParam0) || unk_0xCE95EFC08A74C6D8(unk_0x1788E93557766241(), iParam0))
		{
...
{
	return func_197(iParam0, unk_0xA16EC202D9D35357(), fParam1, 1, 250, 7);
}
...
int func_201(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_203(unk_0xBF8499F46AD9093A(iParam1, 1) - unk_0xBF8499F46AD9093A(iParam0, 1)) };
	...
	{
		Var3 = { func_203(unk_0xCDC62EA66023BC94(iParam0, 31086, 0f, 5f, 0f) - unk_0xCDC62EA66023BC94(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_210(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_203(Param1 - unk_0xBF8499F46AD9093A(uParam0, 1)) };
...
{
	if ((func_219() && Global_90042.f_11 == 6) && iParam0 == func_147(&(Global_90042.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_222()
{
	uLocal_95 = unk_0x36ECDA4DD9A3F08D("digiscanner");
	while (!unk_0xC8378A96673BCC40(uLocal_95))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0x2E968B59470173AB("digiscanner"))
	{
		unk_0x29A7E12FB932C4BC("digiscanner", 0);
	}
	unk_0x51EE3BB4A6B99F1C(unk_0x46BF5F23C21A2D0D(joaat("weapon_digiscanner")));
	if (unk_0x2E968B59470173AB("digiscanner"))
	{
		uLocal_96 = unk_0x180C45774462E561("digiscanner");
	}
	uLocal_98 = unk_0x74F076F396F8C361();
	iLocal_97 = unk_0x09560C7DE2A384BD();
}
...
int func_233(var uParam0)
{
	...
	switch (iLocal_90)
	{
		...
		case 2:
			...
			if ((func_111(uParam0->f_28[0]) && unk_0x538DF9E5B1DF01EB(uParam0->f_41[0])) && unk_0x538DF9E5B1DF01EB(uParam0->f_41[1]))
			{
...
void func_247(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0x538DF9E5B1DF01EB(iParam0->f_41[1]))
		{
			unk_0x2E674C3D6D338EFA(&(iParam0->f_41[1]));
		}
