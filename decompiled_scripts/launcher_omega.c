...
void __EntryFunction__()
{
	...
	if (unk_0x2170E7BC25114A22(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_100739[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_266(&(Global_100739[Var0.f_0 /*10*/].f_9));
			}
		}
		func_250(&Var0, 1);
	}
	if (!func_247(&iVar64, &Var0, Var61, 1f))
	{
		func_246();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 44)
		{
			func_170(&Var0, Var61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_94);
			func_169();
		}
		else if (Var0.f_0 == 45)
		{
			func_170(&Var0, Var61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_95);
			func_167(&Var0);
		}
		if (func_152(&Var0, 0))
		{
...
void func_167(int iParam0)
{
	...
	if ((unk_0x84A97C70FFDEC0C8() - iLocal_98) > 1250)
	{
		if (func_112(iParam0->f_28[0]) && !unk_0xBB5DD90D4926F21A(iParam0->f_28[0]))
		{
			if (func_112(unk_0xD5A676B97920D126()) && !func_168(unk_0xD5A676B97920D126(), iParam0->f_28[0], 50f, 1))
			{
				Var0 = { unk_0xC086F8D75730FA3A(iParam0->f_28[0], 1) };
				Var3 = { unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 1) };
				fVar7 = (Var3.f_0 - Var0.f_0);
				fVar8 = (Var3.f_1 - Var0.f_1);
				if (fVar8 != 0f)
				{
					fVar6 = unk_0x2047800436E7B1E2(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
				...
				unk_0x99569FEC2425586D(iParam0->f_28[0], fVar6);
			}
		}
		iLocal_98 = unk_0x84A97C70FFDEC0C8();
	}
}

bool func_168(int iParam0, int iParam1, float fParam2, int iParam3)
{
...
void func_169()
{
	...
	unk_0x3B6EF6403E3F1CAC(uLocal_96, "SET_COLOUR");
	unk_0x1B215CC37BF52E79(255);
	...
	unk_0x3B6EF6403E3F1CAC(uLocal_96, "SET_DISTANCE");
	unk_0x573CAEB6F4A4E750(10f);
	unk_0xBBAAC5B2437ACF2A();
	unk_0x285A02D21520F128(uLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x733D2C5CCB2A212B(uLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x84A97C70FFDEC0C8() - iLocal_98) > 1250)
	{
		unk_0xEE59E0DAFA4B08CD(uLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = unk_0x84A97C70FFDEC0C8();
	}
}

int func_170(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_158(2))
		{
			if (!func_131())
			{
				if ((func_112(unk_0xD5A676B97920D126()) && func_112(iParam0->f_28[0])) && func_177(unk_0xD5A676B97920D126(), Param1, 1) < 20f)
				{
					func_267("start conversation");
					uVar0 = 16;
					if (*uParam8 == 0)
					{
					...
					{
						func_267("conversation ended");
						*uParam8 = 3;
						return 1;
					}
				}
			}
			else if (func_172(sParam5))
			{
				if (!*uParam8 == 1)
				{
			...
			if (func_177(unk_0xD5A676B97920D126(), Param1, 1) < 20f && *uParam8 == 1)
			{
				func_267("unpause conversation");
				func_171(0);
				*uParam8 = 2;
			}
		}
...
int func_186(int iParam0, bool bParam1)
{
	...
	func_95(*iParam0, &Var0);
	if ((func_223(*iParam0) || func_221(*iParam0)) || Global_69942 == 1)
	{
		return 1;
	}
	if (!unk_0x0943F317505D1E39())
	...
	if (func_190(&(iParam0->f_48)) && bParam1)
	{
		func_187(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}
...
void func_187(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_112(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_189(uParam1) || !unk_0xEBA40DFF7CCE3511(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_188(iParam2) && !unk_0x205B4FC17ACAF4C8(iParam0, unk_0xD5A676B97920D126(), 25f))
					{
						unk_0xBE29918F5B8EC2EF(iParam0, unk_0xD5A676B97920D126(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_189(uParam1) && uParam1->f_4 == 0) && unk_0x8E92CDAEB8357ABD(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 1), unk_0xC086F8D75730FA3A(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_188(iParam2) || unk_0x205B4FC17ACAF4C8(iParam0, unk_0xD5A676B97920D126(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x290A57C93304EF16(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0x7887B64A08364778(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_195(unk_0xD5A676B97920D126(), uParam0->f_35[iVar0]))
							{
...
int func_198(int iParam0, float fParam1)
{
	...
	{
		if (func_209(iParam0) || unk_0x982AB85BDD884D31(unk_0xFB6B3EEFAB2DD12C(), iParam0))
		{
...
{
	return func_200(iParam0, unk_0xD5A676B97920D126(), fParam1, 1, 250, 7);
}
...
int func_204(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_206(unk_0xC086F8D75730FA3A(iParam1, 1) - unk_0xC086F8D75730FA3A(iParam0, 1)) };
	...
	{
		Var3 = { func_206(unk_0x6DE9A8183DA7678E(iParam0, 31086, 0f, 5f, 0f) - unk_0x6DE9A8183DA7678E(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_213(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_206(Param1 - unk_0xC086F8D75730FA3A(uParam0, 1)) };
...
{
	if ((func_222() && Global_91486.f_11 == 6) && iParam0 == func_150(&(Global_91486.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_225()
{
	uLocal_96 = unk_0x542F16A736FAC9A6("digiscanner");
	while (!unk_0x52622CA85B1C304B(uLocal_96))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (!unk_0xF1D6D0D1F3A18A37("digiscanner"))
	{
		unk_0x73E7D509782366DB("digiscanner", 0);
	}
	unk_0x9EB69DB9D5A45673(unk_0x7F5CBF5830F62E4D(joaat("weapon_digiscanner")));
	if (unk_0xF1D6D0D1F3A18A37("digiscanner"))
	{
		uLocal_97 = unk_0xE9D2BE06AC165275("digiscanner");
	}
	uLocal_99 = unk_0xA6EB3FD2D3CE76A2();
	iLocal_98 = unk_0x84A97C70FFDEC0C8();
}
...
int func_227(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_235(&(uParam0->f_48), "rcmrc_omega_2", "omega_idle_looking_around", 0);
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			{
				if (!func_230(&(uParam0->f_28[0]), 69, 2319.443f, 2583.588f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
			...
			{
				func_228(&(uParam0->f_35[0]), iVar0[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
			}
			if (bVar4)
			{
				iLocal_91 = 3;
...
void func_228(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_229(uParam0);
...
int func_236(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_235(&(uParam0->f_48), "rcmrc_omega_1", "omega_idle_geiger_counter", 0);
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0x7887B64A08364778(uParam0->f_28[0]))
			{
				if (!func_230(&(uParam0->f_28[0]), 69, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar5 = false;
				}
			}
			...
			if ((func_112(uParam0->f_28[0]) && unk_0x7887B64A08364778(uParam0->f_41[0])) && unk_0x7887B64A08364778(uParam0->f_41[1]))
			{
...
void func_250(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0x7887B64A08364778(iParam0->f_41[1]))
		{
			unk_0x523D268641392C22(&(iParam0->f_41[1]));
		}
