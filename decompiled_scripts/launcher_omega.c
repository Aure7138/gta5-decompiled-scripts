	...
	if (unk_0xED06FD5709A59F02(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_110945[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_283(&(Global_110945[Var0.f_0 /*10*/].f_9));
			}
		}
		func_267(&Var0, 1);
	}
...
void func_184(int iParam0)
{
	...
	if ((unk_0x578C4EF320340AF7() - iLocal_98) > 1250)
	{
		if (func_127(iParam0->f_28[0]) && !unk_0xA38BFCB05DBE439D(iParam0->f_28[0]))
		{
			if (func_127(unk_0x9B0761B4C3EB8BC7()) && !func_185(unk_0x9B0761B4C3EB8BC7(), iParam0->f_28[0], 50f, 1))
			{
				...
				unk_0xE922BAA80E8F9324(iParam0->f_28[0], fVar6);
			}
		}
...
void func_186()
{
	...
	unk_0x830F007E19C63E14(uLocal_96, "SET_COLOUR");
	...
	unk_0x830F007E19C63E14(uLocal_96, "SET_DISTANCE");
	unk_0x49B9B8101B158AEE(10f);
	unk_0xE1FDD153F5858534();
	unk_0xCA1F114B668562E5(uLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0xE6A03BA84586E67B(uLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x578C4EF320340AF7() - iLocal_98) > 1250)
	{
		unk_0x057194D526464DC0(uLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = unk_0x578C4EF320340AF7();
	}
}
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_175(2))
		{
			...
			if (func_194(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < 20f && *uParam8 == 1)
			{
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_206(uParam1) || !unk_0x9934470AA0A08B57(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_223(unk_0x3E4D3CCC220BDFB1(iParam1, 1) - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
	...
	{
		Var3 = { func_223(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_230(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_223(Param1 - unk_0x3E4D3CCC220BDFB1(uParam0, 1)) };
...
void func_242()
{
	uLocal_96 = unk_0x5DEA4192B46CB99B("digiscanner");
	while (!unk_0x95EF219D38B20CFF(uLocal_96))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	...
	if (unk_0xA9A353D835A7867C("digiscanner"))
	{
		uLocal_97 = unk_0x2BC38EC678978375("digiscanner");
	}
	uLocal_99 = unk_0x5E54B0823F46079E();
	iLocal_98 = unk_0x578C4EF320340AF7();
}
