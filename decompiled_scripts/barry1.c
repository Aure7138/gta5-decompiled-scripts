...
void __EntryFunction__()
{
	...
	{
		unk_0x9444470D6D9ADB88("RC18A_STOP");
		if (func_567(unk_0xA19140A5C42D8715()))
		{
			func_558(unk_0xA19140A5C42D8715(), 1);
			func_557(unk_0xA19140A5C42D8715(), 0);
		}
		else
		{
			func_556(0);
		...
		if (unk_0x3CAC2741CC1A631F(sLocal_159, "B1_FAIL3"))
		{
			func_553("B1_FAIL3", 1);
		}
		else if (unk_0xD32647D293B05ADD(unk_0xD4E735F4B6A956AC()))
		{
			func_553("B1_FAIL2", 1);
		}
		else
	...
	func_500(181.3f, -969.1f, 30.3f, 200f, &Var0, &Var3);
	func_499(iLocal_876);
	if (func_498(0))
	{
	...
	while (true)
	{
		unk_0x4789FEFEDF029858("SF_GRM", 0);
		...
		unk_0xACDA0BDD50CBABE4(unk_0xA6580F898F4E801C(), fLocal_179);
		unk_0x9C6B1D3C923893C5(unk_0xA6580F898F4E801C(), fLocal_178);
		if (func_9())
		{
			func_1();
		}
...
void func_1()
{
	...
	bVar0 = func_8(unk_0xA19140A5C42D8715(), Local_170, 1) < (fLocal_173 + 10f);
	if (iLocal_181)
	{
		if (bVar0 == 0 && bLocal_559 == 0)
		{
			...
			iLocal_182 = unk_0xFD34717937104F1C() + 10000;
			func_3(0);
			iLocal_181 = 0;
		}
	}
	else if (func_8(unk_0xA19140A5C42D8715(), Local_170, 1) > fLocal_173)
	{
		if (unk_0xFD34717937104F1C() > iLocal_182 && bLocal_559 == 0)
		{
			func_2("B1_FAIL");
		}
	}
...
void func_3(int iParam0)
{
	...
	iVar0 = unk_0xFD34717937104F1C() + 2000;
...
void func_10(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			func_54(1);
			unk_0x9444470D6D9ADB88("RC18A_STOP");
			if (unk_0x429D45A6C6520026(sLocal_159))
			{
				func_536(1);
			}
			else
		...
		case 2:
			...
			else if (unk_0x3CAC2741CC1A631F(sLocal_159, "B1_FAIL"))
			{
			...
			else if (unk_0x3CAC2741CC1A631F(sLocal_159, "B1_FAIL2"))
			{
				func_11();
			}
			break;
...
void func_11()
{
	if (unk_0xFD34717937104F1C() > iLocal_158 && iLocal_158 != -1)
	{
		if (func_12(unk_0xA19140A5C42D8715()))
		{
...
int func_13(int iParam0)
{
	...
	if (unk_0x2686487E572FE93A())
	{
		if (func_567(unk_0xA19140A5C42D8715()))
		{
			unk_0x034CA621E59C939F("Michael", unk_0xA19140A5C42D8715(), unk_0x8F474E419F56E48D(unk_0xA19140A5C42D8715()));
			unk_0x90683BECDF939A74(unk_0xA19140A5C42D8715(), 0, -1, 0);
		}
		unk_0x6A22D8EF80E82583(sLocal_328, 1, 0, 0, 0);
	}
	switch (iLocal_161)
	{
		case 0:
			...
			unk_0x7B5129A25EE58E36("RC18A_END_OS");
		...
		case 1:
			if (iParam0 == 0)
			{
				...
				{
					unk_0xF334C9B245CD323D(iLocal_163, 1, 0);
				}
				unk_0x2F89329397A277BC(&uVar4);
				unk_0x3F01127ECD227890(0, sLocal_338, sLocal_352, 8f, -8f, -1, 0, 0, 0, 0, 0);
				unk_0x3F01127ECD227890(0, sLocal_338, sLocal_353, 8f, -8f, -1, 1, 0, 0, 0, 0);
				unk_0x301F42EEE3C40328(uVar4);
				unk_0xE1072FA2FECBAD96(unk_0xA19140A5C42D8715(), uVar4);
				unk_0x3A95A0A3221D4208(&uVar4);
			}
			uVar5 = unk_0x4AD86AC07DD005D4("DEFAULT_SCRIPTED_CAMERA", unk_0x1E8E507A99E298E6(), unk_0x087F3F13CDC55984(2), unk_0xDF662A6C1FE3B1F0(), 1, 2);
			Var0 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1) - unk_0x1E8E507A99E298E6() };
			unk_0xABE3EC0FA16227B5(uVar5, unk_0xA19140A5C42D8715(), -Var0, 1);
			if (unk_0x37B568B777BC65F9(uVar5))
			{
				unk_0x930701157A4B9374(uVar5, 1);
			}
			iLocal_158 = unk_0xFD34717937104F1C() + 6000;
			func_35(&uLocal_390, 0, unk_0xA19140A5C42D8715(), "MICHAEL", 0, 1);
			iLocal_161 = 2;
			break;
		...
		case 2:
			...
			if (iParam0 == 1)
			{
				if (func_34(&uLocal_390, "BARY1AU", "BARY1_PREOUT", 8, 0, 0, 0) || unk_0xFD34717937104F1C() > iLocal_158)
				{
					if (unk_0xFD34717937104F1C() < iLocal_158)
					{
					}
					iLocal_158 = unk_0xFD34717937104F1C() + 4500;
					bVar3 = true;
				}
			}
			else if (func_17(&uLocal_390, "BARY1AU", "BARY1_PREOUT", "BARY1_PREOUT_2", 8, 0, 0) || unk_0xFD34717937104F1C() > iLocal_158)
			{
				iLocal_158 = unk_0xFD34717937104F1C() + 2000;
				if (unk_0xFD34717937104F1C() < iLocal_158)
				{
				}
				bVar3 = true;
		...
		case 4:
			...
			if (iParam0 == 1)
			{
				...
				{
					func_16();
					unk_0xE60B9F9B48D4783F(sLocal_337, 0, 0);
					iLocal_158 = unk_0xFD34717937104F1C() + 3500;
					bVar3 = true;
				}
			}
			else
		...
		case 3:
			if (iParam0 == 1)
			{
				bVar3 = unk_0xFD34717937104F1C() > iLocal_158;
			}
			else
			{
				if (unk_0xFD34717937104F1C() < iLocal_158)
				...
				if (func_12(unk_0xA19140A5C42D8715()))
				{
					...
					if (func_12(iLocal_163) && unk_0xF797E4DD45066C88(iLocal_163))
					{
						unk_0xF334C9B245CD323D(iLocal_163, 1, 0);
					}
				}
			...
			if (bVar3 == 1)
			{
				unk_0x9444470D6D9ADB88("RC18A_END_OS");
				iLocal_158 = unk_0xFD34717937104F1C() + 1000;
				iLocal_161 = 5;
			}
			break;
...
int func_15(int iParam0, int iParam1)
{
	...
	iVar0 = unk_0xDAD26B7BC6DCE4C1(unk_0x410D194E9495C303(iParam0), unk_0x505186370955851F(unk_0xA19140A5C42D8715(), iVar1, 0f, 0f, 0f), 1, 1, 0);
	if (!unk_0xDC5D81351D6A4DDB(iVar0))
	{
		return 0;
	}
	unk_0x96B71B23D409A3DB(iVar0, unk_0xA19140A5C42D8715(), unk_0xF622A022C26057AA(unk_0xA19140A5C42D8715(), iVar1), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	return iVar0;
}

void func_16()
{
	if (unk_0x493E42DC8C29B51A(sLocal_335))
	{
		unk_0xEF9AD7817AAF81A5(sLocal_335);
	}
	if (unk_0x493E42DC8C29B51A(sLocal_336))
	{
		unk_0xEF9AD7817AAF81A5(sLocal_336);
	}
	if (unk_0x493E42DC8C29B51A(sLocal_337))
	{
		unk_0xEF9AD7817AAF81A5(sLocal_337);
	}
}
...
void func_25()
{
	...
	{
		if (func_28(Global_106070.f_2355.f_539.f_4301) != unk_0x8F474E419F56E48D(unk_0xA19140A5C42D8715()))
		{
			iVar0 = func_27(unk_0xA19140A5C42D8715());
...
void func_47(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_48(unk_0xA19140A5C42D8715()))
	{
...
{
	func_50(&(Global_99633.f_2875), Param0, fParam3);
}
...
void func_59(var uParam0)
{
	if (*uParam0 != 0)
	{
		...
		{
			unk_0x2C3DB562E463BBE7(*uParam0, 0);
		}
		*uParam0 = 0;
	}
}
...
void func_62()
{
	...
	while (iVar0 < Local_586.f_0)
	{
		if (func_4(&(Local_586[iVar0 /*33*/])))
		{
			...
			unk_0x1659AF2827EC9D40(Local_586[iVar0 /*33*/].f_2, unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), 400f, -1, 0, 0);
		}
		iVar0++;
	}
}
...
void func_64(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_12(iLocal_163) && unk_0xF797E4DD45066C88(iLocal_163))
			{
				unk_0xF334C9B245CD323D(iLocal_163, 1, 1);
			}
			unk_0x2F89329397A277BC(&uVar0);
			unk_0x3F01127ECD227890(0, sLocal_338, sLocal_348, 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x3F01127ECD227890(0, sLocal_338, sLocal_351, 8f, -2f, -1, 0, 0, 0, 0, 0);
		...
		case 2:
			if (unk_0xF9D4EF1338E38AFB(unk_0xA19140A5C42D8715(), 242628503) == 7)
			{
				...
				unk_0x882807816FB26635("scr_alien_teleport", unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), unk_0x288B716F47E9BBBC(unk_0xA19140A5C42D8715(), 2), fLocal_573, 0, 0, 0);
				unk_0x6020229E34827A69(-1, "SPAWN", unk_0xA19140A5C42D8715(), "BARRY_01_SOUNDSET", 0, 0);
				fLocal_208 = 255f;
				*iParam0 = 4;
			}
			break;
		...
		case 4:
			fLocal_208 = (fLocal_208 - (unk_0xDE089748C4C76C96() * 512f));
			if (fLocal_208 <= 0f)
			{
				fLocal_208 = 0f;
				unk_0xA9DC61CC95D220CF(unk_0xA19140A5C42D8715());
				unk_0x7C73A424F1117528(unk_0xA19140A5C42D8715(), 0, 0);
				*iParam0 = 3;
				return;
			}
			func_74(unk_0xA19140A5C42D8715(), unk_0xF34EE736CF047844(fLocal_208), &iLocal_186);
			break;
		...
		case 3:
			...
			{
				func_2("B1_FAIL3");
				iLocal_158 = unk_0xFD34717937104F1C() + 50;
			}
			break;
	}
}
...
int func_65()
{
	...
	{
		case 0:
			uLocal_930 = unk_0x4AD86AC07DD005D4("DEFAULT_SCRIPTED_CAMERA", Local_967, Local_970, 50f, 0, 2);
			Local_931.f_11 = uLocal_930;
			iLocal_966 = unk_0xFD34717937104F1C() + 400;
			iLocal_965++;
			break;
		
		case 1:
			if (unk_0xFD34717937104F1C() > iLocal_966)
			{
		...
		case 2:
			...
			{
				iLocal_966 = unk_0xFD34717937104F1C() + 500;
				iLocal_965++;
			}
			break;
		...
		case 3:
			if (unk_0xFD34717937104F1C() > iLocal_966)
			{
				unk_0x4299736016AECE26(unk_0xA19140A5C42D8715(), Local_967, 1, 0, 0, 1);
				...
				if (unk_0x1F7BAD75218F1A2C(0) != 4)
				{
					...
					{
						unk_0xC831502E35848BE4(uLocal_930, Local_970, 2);
						unk_0x930701157A4B9374(uLocal_930, 1);
						unk_0xABE3EC0FA16227B5(uLocal_930, unk_0xA19140A5C42D8715(), 0f, 0f, 4f, 0);
					}
				}
				else
				{
...
int func_69(var uParam0, float fParam1)
{
	...
	if (!uParam0->f_15)
	{
		if (unk_0x37B568B777BC65F9(uParam0->f_11))
		{
			uParam0->f_27 = 0;
			if (func_44() == 0)
			{
				iVar11 = unk_0xA19140A5C42D8715();
			}
			else
			{
				iVar11 = func_73();
			...
			uParam0->f_9 = unk_0x57FC10C74CC15F22("DEFAULT_SPLINE_CAMERA", 0);
			iVar0 = 0;
			while (iVar0 <= 7)
			{
				if (unk_0x37B568B777BC65F9((*uParam0)[iVar0]))
				{
					unk_0x77F0486CE0E598D5((*uParam0)[iVar0], 0);
				}
				iVar0++;
			}
			if (!unk_0x7112137033807390(iVar11, 0))
			{
				fVar2 = unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iVar11, 1), unk_0x7AE8C2E4C6335A8D(uParam0->f_11), 1);
			}
			else
			{
				fVar2 = unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iVar11, 0), unk_0x7AE8C2E4C6335A8D(uParam0->f_11), 1);
			}
			fVar2 = func_72(fVar2, 50f, 4000f);
			iVar1 = unk_0xF2DB717A73826179((((fVar2 / ((4000f - 50f) / (2000f - 1000f))) + 400f) * fParam1));
			if (unk_0x5D7DFE2058701942(iVar11, 0))
			{
				iVar10 = unk_0xD1A189C6C27EE0CA(iVar11);
				bVar9 = true;
			}
			Var3 = { unk_0xB89F0BB02739BD58(2) };
			uParam0->f_24 = 0;
			unk_0xF62A5A3CB8DB2402(uParam0->f_9, unk_0xFE38FABCB947043C());
			if (!unk_0x37B568B777BC65F9((*uParam0)[uParam0->f_24]))
			{
				(*uParam0)[uParam0->f_24] = unk_0x57FC10C74CC15F22("DEFAULT_SCRIPTED_CAMERA", 0);
			}
			if (bVar9)
			{
				Var6 = { unk_0x61141C81AF57CBDC(iVar10, unk_0x13C6B72A19970EAD()) };
				unk_0xABE3EC0FA16227B5((*uParam0)[uParam0->f_24], iVar10, Var6, 1);
			}
			else
			{
				Var6 = { unk_0x61141C81AF57CBDC(iVar11, unk_0x13C6B72A19970EAD()) };
				unk_0xABE3EC0FA16227B5((*uParam0)[uParam0->f_24], iVar11, Var6, 1);
			}
			unk_0xC831502E35848BE4((*uParam0)[uParam0->f_24], Var3, 2);
			unk_0xF62A5A3CB8DB2402((*uParam0)[uParam0->f_24], unk_0xFE38FABCB947043C());
			unk_0x1B4C160CA2A30BF9(uParam0->f_9, (*uParam0)[uParam0->f_24], 0, 1);
			uParam0->f_24++;
			...
			{
				Var6 = { unk_0x61141C81AF57CBDC(iVar10, unk_0x13C6B72A19970EAD()) };
				unk_0xABE3EC0FA16227B5((*uParam0)[uParam0->f_24], iVar10, Var6 + Vector(15f, 0f, 0f), 1);
			}
			else
			{
				unk_0xABE3EC0FA16227B5((*uParam0)[uParam0->f_24], iVar11, 0f, 0f, 5f, 0);
			}
			unk_0xC831502E35848BE4((*uParam0)[uParam0->f_24], -87.5f, 0f, Var3.f_2, 2);
			unk_0xF62A5A3CB8DB2402((*uParam0)[uParam0->f_24], unk_0xFE38FABCB947043C());
			unk_0x1B4C160CA2A30BF9(uParam0->f_9, (*uParam0)[uParam0->f_24], 400, 1);
			uParam0->f_24++;
			uParam0->f_27 += 400;
			if (!unk_0x37B568B777BC65F9((*uParam0)[uParam0->f_24]))
			{
			...
			if (bVar9)
			{
				unk_0xABE3EC0FA16227B5((*uParam0)[uParam0->f_24], iVar10, 0f, 0f, 75f, 0);
			}
			else
			{
				unk_0xABE3EC0FA16227B5((*uParam0)[uParam0->f_24], iVar11, 0f, 0f, 75f, 0);
			}
			unk_0xC831502E35848BE4((*uParam0)[uParam0->f_24], -87.5f, 0f, Var3.f_2, 2);
			unk_0xF62A5A3CB8DB2402((*uParam0)[uParam0->f_24], unk_0xFE38FABCB947043C());
			unk_0x1B4C160CA2A30BF9(uParam0->f_9, (*uParam0)[uParam0->f_24], 400, 1);
			uParam0->f_24++;
			uParam0->f_27 += 400;
			Var12 = { unk_0x21AC08654FDAADC9(uParam0->f_11, 2) };
			Var12.f_0 = 21f;
			unk_0xD07B71F12856EB70(uParam0->f_9, unk_0x7AE8C2E4C6335A8D(uParam0->f_11), Var12, iVar1, 3, 2);
	...
	if (uParam0->f_15 && !uParam0->f_16)
	{
		if (unk_0x37B568B777BC65F9(uParam0->f_9))
		{
			if (uParam0->f_24 > 0)
			{
				...
				{
					unk_0x930701157A4B9374((*uParam0)[iVar0], 1);
					iVar0++;
				}
			}
			unk_0x930701157A4B9374(uParam0->f_9, 1);
			unk_0x8E88E73F74A9FF79(1, 0, 3000, 1, 0, 0);
			if (!Global_17228.f_111)
			{
				unk_0xACDAE29FDF15956C(-1, "CHARACTER_CHANGE_UP_MASTER", 0, 0, 0, 1);
				if (Global_17228.f_109 == -1)
				{
					Global_17228.f_109 = unk_0x7A3ECD08D6D1D554();
					Global_17228.f_110 = unk_0xFEB6EEC0545AF7AA(unk_0x61D2332983ACC05C());
				}
				unk_0xACDAE29FDF15956C(Global_17228.f_109, "CHARACTER_CHANGE_SKY_MASTER", 0, 0, 0, 1);
				unk_0x8969D02DEDC106D2("CHARACTER_CHANGE_IN_SKY_SCENE");
				if (unk_0x2F8EAF18929E1E59("CHARACTER_CHANGE_IN_SKY_SCENE"))
				{
				}
			}
	...
	if (uParam0->f_16)
	{
		if (unk_0x37B568B777BC65F9(uParam0->f_9))
		{
			...
			if (bVar15)
			{
				if (unk_0x4EFA8CFA30651DD4(uParam0->f_9))
				{
					if (unk_0x0A6D55EFA1872255(uParam0->f_9) > 0.5f && unk_0xD8AE52C8418BED79(uParam0->f_9))
					{
						uParam0->f_18 = 1;
					}
				}
	...
	if (uParam0->f_17)
	{
		if (unk_0x37B568B777BC65F9(uParam0->f_9))
		{
			if (unk_0x37B568B777BC65F9(uParam0->f_11))
			{
				Global_1312466.f_1 = { unk_0x7AE8C2E4C6335A8D(uParam0->f_9) };
				Global_1312466.f_4 = { unk_0x21AC08654FDAADC9(uParam0->f_9, 2) };
				Global_1312466.f_7 = unk_0x3EC5C28A5B7DA7B8(uParam0->f_9);
				unk_0x057123F3A835FE47(uParam0->f_11, Global_1312466.f_1);
				unk_0xC831502E35848BE4(uParam0->f_11, Global_1312466.f_4, 2);
				unk_0xF62A5A3CB8DB2402(uParam0->f_11, Global_1312466.f_7);
			}
			unk_0x77F0486CE0E598D5(uParam0->f_9, 0);
		}
		if (uParam0->f_24 > 0)
		...
		uParam0->f_24 = 0;
		uParam0->f_27 = 0;
		if (Global_17228.f_109 != -1 && Global_17228.f_110 == unk_0xFEB6EEC0545AF7AA(unk_0x61D2332983ACC05C()))
		{
			unk_0x5DE59A67B5F326CF(Global_17228.f_109);
			unk_0xB4442316D0B880FD(Global_17228.f_109);
		...
		if (unk_0x37B568B777BC65F9(uParam0->f_11))
		{
			unk_0x930701157A4B9374(uParam0->f_11, 1);
		}
		func_70(0);
		return 0;
	}
...
float func_71(var uParam0)
{
	...
	{
		Var0 = { unk_0x7AE8C2E4C6335A8D(uParam0) };
		return Var0.f_2;
	}
	return 0f;
}
...
void func_74(int iParam0, int iParam1, int iParam2)
{
	...
	unk_0x7BC735BFDF7BC819(iParam0, iParam1, 0);
	*iParam2++;
}
...
void func_75(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (func_327(1, 1093140480, 0) && unk_0xB1FDFCECA75CE4A7("postRC_Barry1and2"))
			{
				iLocal_356 = 0;
				if (func_12(unk_0xA19140A5C42D8715()))
				{
				...
				func_326();
				unk_0x01AF8CB960828C2B(Local_174, 250f, 0, 0, 0, 0, 0, 0);
				unk_0x3521B10FB737CE36(Local_174, 50f, 0);
				unk_0x39F8A3E01BC1A69B(Local_174, 30f, 0);
				unk_0x8566A4AC1CA77939(Local_174, 500f);
				unk_0xDEE4574BA71257AB(unk_0xD4E735F4B6A956AC());
				func_277();
				unk_0xE216F8B2802ABABF(0, sLocal_328, 2, func_570(49), 0);
				unk_0xE216F8B2802ABABF(0, sLocal_330, 2, joaat("prop_protest_table_01"), 0);
				unk_0xE216F8B2802ABABF(0, sLocal_329, 2, joaat("prop_chair_08"), 0);
				if (func_567(unk_0xA19140A5C42D8715()))
				{
		...
		case 2:
			...
			else
			{
				...
				{
					if (unk_0xDC5D81351D6A4DDB(unk_0xD6AE14889DC50F06(sLocal_328, 0)))
					{
						Local_96.f_28[0] = unk_0xA2EA4BA455370F3C(unk_0xD6AE14889DC50F06(sLocal_328, 0));
						unk_0x73774776D23F43BA(Local_96.f_28[0], 1, 0, 0, false);
					}
				}
				if (!func_567(Local_96.f_41[0]))
				{
					if (unk_0xDC5D81351D6A4DDB(unk_0xD6AE14889DC50F06(sLocal_330, 0)))
					{
						Local_96.f_41[0] = unk_0x63F4756F241D86B8(unk_0xD6AE14889DC50F06(sLocal_330, 0));
					}
				}
				if (!func_567(Local_96.f_41[1]))
				{
					if (unk_0xDC5D81351D6A4DDB(unk_0xD6AE14889DC50F06(sLocal_329, 0)))
					{
						Local_96.f_41[1] = unk_0x63F4756F241D86B8(unk_0xD6AE14889DC50F06(sLocal_329, 0));
					}
				}
				if (unk_0xAEC987ADEFBCB5F8(sLocal_330, 0))
				{
		...
		case 3:
			...
			func_47(1, 1, 1, 1);
			func_269(unk_0xA19140A5C42D8715(), Local_174);
			unk_0x92DDCF53AA47A63D(unk_0xA19140A5C42D8715(), fLocal_177);
			unk_0xAA32DD4848CF93E0(0f, 1065353216);
			unk_0xD87B76260C547F31(0f);
...
void func_76()
{
	if (iLocal_209 == iLocal_191 && unk_0x22B3625D717A4563(unk_0xA19140A5C42D8715(), iLocal_209, 0))
	{
		unk_0x808CD8B497BA1FB8(unk_0xA19140A5C42D8715(), 0, iLocal_209);
	}
	if (func_567(unk_0xA19140A5C42D8715()))
	{
		func_558(unk_0xA19140A5C42D8715(), 1);
...
void func_274(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0x58E3CCF930D23BD5(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0x3521B10FB737CE36(func_275(unk_0xA6580F898F4E801C()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_277()
{
	...
	if (unk_0xDC5D81351D6A4DDB(func_325()) && !func_52(Local_925, Local_166, 0))
	{
		unk_0xFDD15D670AD33E10(Local_925, 3f, 1, 0, 0, 0);
		if (func_567(func_325()))
		{
			unk_0x4299736016AECE26(func_325(), Local_925, 1, 0, 0, 1);
			unk_0x92DDCF53AA47A63D(func_325(), fLocal_928);
			unk_0x99F546A9200EA026(func_325(), 1084227584);
		}
...
{
	if ((((((((((!unk_0xDC5D81351D6A4DDB(iParam0) || !unk_0x1095F403F52B42E1(iParam0, 0)) || func_296(iParam0, 0, 0)) || func_296(iParam0, 1, 0)) || func_296(iParam0, 2, 0)) || func_316(iParam0) != 145) || func_295(iParam0)) || func_294(iParam0)) || func_293(iParam0)) || func_292(iParam0)) || !func_282(unk_0x8F474E419F56E48D(iParam0)))
	{
		if (func_294(iParam0))
		{
		}
...
var func_299()
{
	...
	func_309(&uVar0, unk_0xC5B07C33AC7BB174());
	func_308(&uVar0, unk_0x65DA628D62901275());
	func_307(&uVar0, unk_0x34CEB9721AC6A0A9());
	func_302(&uVar0, unk_0xC9A0B68BA813CF99());
	func_301(&uVar0, unk_0x897D202BD69186D5());
	func_300(&uVar0, unk_0x56EBDF0E39D83471());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_305(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (unk_0x1095F403F52B42E1(iParam0, 0))
	{
		...
		*uParam1 = unk_0xDDB38D7590A81CE5(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x2BCFB39E86340DAA(&(uParam1->f_77), func_318(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	return func_323(Global_96664.f_2875.f_12.f_66, Param0, iParam3);
}
...
void func_326()
{
	if (unk_0x2F8EAF18929E1E59(sLocal_340))
	{
		unk_0x5AD7D03C214BDA88(sLocal_340);
	}
	unk_0x473E5DC92DBF82B9(sLocal_555, 1);
	...
	unk_0xA3990C1A918DC68A(func_28(0));
	unk_0x90683BECDF939A74(unk_0xA19140A5C42D8715(), 0, -1, 0);
	func_66();
	unk_0xA2A6897BF485DF5C(0);
}
...
int func_327(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		...
		{
			if (!func_333(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_332(unk_0xA19140A5C42D8715(), -828834893))
				{
...
void func_338(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 2:
			if (iLocal_874 != 0 && unk_0xFD34717937104F1C() > iLocal_874)
			{
				iLocal_874 = 0;
				iLocal_873 = 0;
			}
			if (unk_0x2F8EAF18929E1E59(sLocal_340))
			{
				unk_0x60DA182D61035BA9(sLocal_340, "DrugsEffect", ((unk_0x0BADBFA3B172435F((((unk_0xBBDA792448DB5A89(unk_0xFD34717937104F1C()) / 1000f) * 45f) % 360f)) * 0.25f) + 0.25f));
			}
...
void func_339()
{
	...
	if (unk_0xFD34717937104F1C() < iLocal_363)
	{
		return;
	}
	if (!bLocal_360)
	...
	{
		iLocal_363 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(20000, 40000));
		if ((iLocal_362 - unk_0xFD34717937104F1C()) < 2500)
		{
			iLocal_362 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(3000, 5000));
		}
	}
}
...
void func_345()
{
	...
	if (!iLocal_556)
	{
		iLocal_582 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(iLocal_583, iLocal_584));
		return;
	}
	if (bLocal_559)
	{
		iLocal_582 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(iLocal_583 * 3, iLocal_584 * 2));
		return;
	}
	...
	if (unk_0xFD34717937104F1C() > iLocal_582)
	{
		if (func_361(&iVar1))
		{
...
int func_346(var uParam0)
{
	...
	{
		*uParam0 = { unk_0x2F230B37E9FFF23F(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), unk_0xF59B9063EDAC7451(0f, 360f), 0f, unk_0xF59B9063EDAC7451(fLocal_580, fLocal_581), 6f) };
	}
...
int func_347(var uParam0, bool bParam1)
{
	...
	if (func_349(unk_0xA19140A5C42D8715(), Var0, fVar3))
	{
		return 0;
	}
	if (unk_0x499324B3EF19C288(Var0, Local_170, 1) > fLocal_173)
	{
		return 0;
	}
	if (!unk_0x0C4DF083566CCC1C(Var0, Local_200[0 /*3*/], Local_200[1 /*3*/], Local_200.f_7, 0, 1))
	{
		return 0;
	}
	if (bLocal_185)
	...
	else if (unk_0x5ACD8081B0AC1F22(Var0, 2f))
	{
		return 0;
	}
	*uParam0 = { Var0 };
...
{
	return unk_0xD3DCB71AF4A2BE13(Param0, fParam3, 0, 0, 1, 0, 0, iParam4, iParam5);
}
...
Vector3 func_350(struct<3> Param0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	Var0 = { func_351(Var0, unk_0xF59B9063EDAC7451(0f, fParam3)) };
...
void func_352(var uParam0)
{
	...
	{
		unk_0x6259CDB47862A4F3(uParam0->f_2, (iLocal_567 / 4), 0);
		unk_0x80B6201B269FC581(uParam0->f_2, 1);
		unk_0x2C3F3D88E305DCA7(uParam0->f_2, 1);
	}
}
...
int func_353(var uParam0, struct<3> Param1, int iParam4, bool bParam5)
{
	...
	uParam0->f_2 = unk_0x35C6E06B120EB2E3(26, iLocal_357, Param1, 0, 1, 1);
	if (!unk_0xDC5D81351D6A4DDB(uParam0->f_2))
	{
		return 0;
	}
	unk_0x836A6A722DEA63F1(uParam0->f_2);
	func_269(uParam0->f_2, Param1);
	func_355(uParam0->f_2);
	unk_0xDFA901280292A2FB(uParam0->f_2, -2065892691);
	unk_0x13E0A8160525AE55(uParam0->f_2, 122, 1);
	unk_0x605FF8F1D0D5E4DE(uParam0->f_2, 1);
	unk_0xAAB061EFC631505C(uParam0->f_2, 1);
	unk_0x4FE3554969185993(uParam0->f_2, "ALIENS");
	unk_0x1F4E5EFBFE503FB3(uParam0->f_2, 1);
	unk_0xA0DEC6E1399EE624(uParam0->f_2);
	unk_0xB6544ED6F57109F3(uParam0->f_2, 1);
	unk_0x8C26EBB3525646D4(uParam0->f_2, 0);
	unk_0xB29E08C7AB729BAD(uParam0->f_2, 1);
	unk_0x33CF95E95A476FB9(uParam0->f_2, 1);
	unk_0xDCFB67537602326F(uParam0->f_2, 0, 0);
	unk_0x7C73A424F1117528(uParam0->f_2, 0, 0);
	unk_0xAC09CC5F667F6AB7(uParam0->f_2, 0);
	unk_0x96BFF0680C7B6FD5(uParam0->f_2, 0);
	unk_0xD759B92031944D46(uParam0->f_2, 1, 0);
	unk_0x1F6EFEE448608A68(uParam0->f_2, iLocal_567);
	unk_0x6259CDB47862A4F3(uParam0->f_2, iLocal_567, 0);
	uParam0->f_4 = unk_0xDAD26B7BC6DCE4C1(iLocal_358, unk_0x3201284584C7CD83(uParam0->f_2, 0f, -5f, 0f), 1, 1, 0);
	if (func_12(uParam0->f_4))
	{
		unk_0xDCFB67537602326F(uParam0->f_4, 0, 0);
		unk_0x7C73A424F1117528(uParam0->f_4, 0, 0);
		unk_0xB29E08C7AB729BAD(uParam0->f_4, 1);
	}
	uParam0->f_5 = unk_0xDAD26B7BC6DCE4C1(iLocal_358, unk_0x3201284584C7CD83(uParam0->f_2, 0f, -5f, 0f), 1, 1, 0);
	if (func_12(uParam0->f_5))
	{
		unk_0xDCFB67537602326F(uParam0->f_5, 0, 0);
		unk_0x7C73A424F1117528(uParam0->f_5, 0, 0);
		unk_0xB29E08C7AB729BAD(uParam0->f_5, 1);
	}
	uParam0->f_6 = unk_0xDAD26B7BC6DCE4C1(iLocal_358, unk_0x3201284584C7CD83(uParam0->f_2, 0f, 5f, 0f), 1, 1, 0);
	if (func_12(uParam0->f_6))
	{
		unk_0xDCFB67537602326F(uParam0->f_6, 0, 0);
		unk_0x7C73A424F1117528(uParam0->f_6, 0, 0);
		unk_0xB29E08C7AB729BAD(uParam0->f_6, 1);
	}
	uParam0->f_1 = 1;
	*uParam0 = 1;
	uParam0->f_32 = 0;
	uParam0->f_7 = (unk_0xFD34717937104F1C() + iParam4 * 500);
	uParam0->f_16 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(iLocal_568, iLocal_569));
	uParam0->f_10 = func_354(uParam0->f_2, unk_0xA19140A5C42D8715(), 1);
	uParam0->f_11 = unk_0xF59B9063EDAC7451(2f, 3f);
	uParam0->f_14 = (fLocal_857 + (unk_0xF59B9063EDAC7451(fLocal_861, fLocal_862) * fLocal_857));
	uParam0->f_15 = 0f;
	if (iLocal_184 == 1)
	{
	}
	unk_0x3F01127ECD227890(uParam0->f_2, sLocal_338, sLocal_350, 1000f, -8f, -1, 1, 0, 0, 0, 0);
	iLocal_876++;
	return 1;
}
...
void func_355(int iParam0)
{
	...
	uVar0 = func_356(unk_0xE2BBD32891C18569(iParam0, 1), unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), 1);
	unk_0x92DDCF53AA47A63D(iParam0, uVar0);
}
...
int func_357(var uParam0, float fParam1)
{
	...
	fVar0 = unk_0xF59B9063EDAC7451(0f, 1f);
	if (fVar0 > fParam1)
	{
		return 0;
	}
...
int func_358(var uParam0)
{
	...
	while (iVar0 < 9)
	{
		if (iVar1 < Var2.f_0)
		{
			if (!unk_0x5ACD8081B0AC1F22(Local_897[iVar0 /*3*/], 1.5f))
			{
	...
	{
		iVar30 = unk_0x22C775856F4633CA(0, iVar1);
...
void func_362(int iParam0)
{
	...
	{
		unk_0x581CF279D6A7E3D6(unk_0xA19140A5C42D8715(), *iParam0);
	}
	*iParam0 = func_364(*iParam0);
	iVar0 = func_363(*iParam0);
	unk_0xF0188A1B49D79AF7(unk_0xA19140A5C42D8715(), *iParam0, iVar0, 1, 1);
	if (*iParam0 == iLocal_191)
	{
		unk_0x808CD8B497BA1FB8(unk_0xA19140A5C42D8715(), 1, *iParam0);
	}
	else
	{
		unk_0x2B82D6FCC6504E49(unk_0xA19140A5C42D8715(), *iParam0, 0);
		unk_0x368DD2AEABF7CF44(unk_0xA19140A5C42D8715(), *iParam0, 0, 0);
...
int func_365(int iParam0)
{
	...
	if (unk_0x8F62F4EC66847EC2(unk_0xA19140A5C42D8715(), iParam0) == 0)
	{
		return 1;
	}
	return 0;
...
float func_370(var uParam0)
{
	if (func_373(uParam0))
	{
		...
		{
			return (func_371(unk_0x05EFB6A616B6FADE(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_371(unk_0x05EFB6A616B6FADE(*uParam0, 4)) - fParam1);
...
void func_377(int iParam0)
{
	...
	{
		case 0:
			unk_0xDED73F11B8CB95B1(fLocal_180);
			unk_0x8F2B662BE32A9181("BARRY_01_SLOWMO");
			unk_0xEE059E753F371708("BARRY_01_SLOWMO");
			...
			*iParam0 = 1;
			...
			func_383();
			func_382(iLocal_209);
			unk_0xB4378167DA4A5EC4(sLocal_555, 1, 0);
			break;
		
		case 1:
			unk_0x4F93066CECE72793();
			unk_0x8969D02DEDC106D2(sLocal_340);
			unk_0x1EB647171187A459(unk_0xA19140A5C42D8715());
			iLocal_876 = 0;
			iLocal_877 = 0;
			iLocal_563 = 0;
			...
			func_276(500, 0);
			func_7("PRIME2", 7500, 1);
			func_381(unk_0xA19140A5C42D8715(), -1);
			func_374(&uLocal_890);
			fLocal_893 = 5f;
			*iParam0 = 2;
			break;
		...
		if (func_367(&uLocal_890, fLocal_893))
		{
			if (func_361(&iVar0))
			{
				if (func_379(Param0, fParam3, &Var1))
				{
					...
					func_374(&uLocal_890);
					fLocal_893 = unk_0xF59B9063EDAC7451(1.5f, 2.5f);
				}
				else
				{
					func_374(&uLocal_890);
...
void func_380()
{
	...
	if (unk_0xFD34717937104F1C() < iLocal_361)
	{
		return;
	}
	if (unk_0x904275961B875DEB())
	...
	StringIntConCat(&Var0, unk_0x22C775856F4633CA(0, 3) + 1, 16);
	func_35(&uLocal_390, 0, unk_0xA19140A5C42D8715(), "MICHAEL", 0, 1);
...
void func_382(int iParam0)
{
	...
	if (func_567(unk_0xA19140A5C42D8715()))
	{
		if (!unk_0x22B3625D717A4563(unk_0xA19140A5C42D8715(), iParam0, 0))
		{
			unk_0xF0188A1B49D79AF7(unk_0xA19140A5C42D8715(), iParam0, 10, 1, 1);
		}
		else if (!unk_0xF990CFC0F1D94A39(unk_0xA19140A5C42D8715(), &iVar0, 1) || iVar0 != iParam0)
		{
			unk_0xB20B772FD9DE1847(unk_0xA19140A5C42D8715(), iParam0, 1);
		}
		unk_0x41FC0EC2502D4105(unk_0xA19140A5C42D8715(), iParam0, 10000);
		unk_0x808CD8B497BA1FB8(unk_0xA19140A5C42D8715(), 1, iParam0);
		unk_0x09831B64584D4C11(unk_0xA19140A5C42D8715(), 1, 1, 1, 0);
		unk_0x853127AB7582A765(unk_0xA19140A5C42D8715(), 0);
		unk_0xDEFAC29A3FC5AFAD(unk_0xA19140A5C42D8715());
...
{
	func_35(&uLocal_390, 0, unk_0xA19140A5C42D8715(), "MICHAEL", 0, 1);
	iLocal_361 = unk_0xFD34717937104F1C() + 1500;
	iLocal_363 = (iLocal_361 + unk_0x22C775856F4633CA(20000, 40000));
	iLocal_362 = (iLocal_361 + unk_0x22C775856F4633CA(12000, 18000));
	iLocal_364 = unk_0xFD34717937104F1C();
	bLocal_360 = false;
}
...
void func_407(int iParam0)
{
	...
	switch (*iParam0)
	{
		case 0:
			...
			{
				unk_0x1EB647171187A459(unk_0xA19140A5C42D8715());
				func_429(unk_0xA19140A5C42D8715());
				unk_0x1C09E70D9D927D95(unk_0xA19140A5C42D8715(), 1);
			}
			break;
		...
		case 1:
			...
			if (func_327(1, 1093140480, 0))
			{
				if (func_567(Local_96.f_28[0]))
				{
					unk_0xE216F8B2802ABABF(Local_96.f_28[0], sLocal_328, 0, 0, 0);
				}
				else
				{
					unk_0xE216F8B2802ABABF(Local_96.f_28[0], sLocal_328, 2, func_570(49), 0);
				}
				if (func_567(Local_96.f_41[0]))
				{
					unk_0xE216F8B2802ABABF(Local_96.f_41[0], sLocal_330, 0, 0, 0);
				}
				else
				{
					unk_0xE216F8B2802ABABF(Local_96.f_41[0], sLocal_330, 2, joaat("prop_protest_table_01"), 0);
				}
				if (func_567(Local_96.f_41[1]))
				{
					unk_0xE216F8B2802ABABF(Local_96.f_41[1], sLocal_329, 0, 0, 0);
				}
				else
				{
					unk_0xE216F8B2802ABABF(Local_96.f_41[1], sLocal_329, 2, joaat("prop_chair_08"), 0);
				}
				if (func_567(Local_96.f_41[2]))
				{
					unk_0xE216F8B2802ABABF(Local_96.f_41[2], sLocal_332, 0, 0, 0);
				}
				else
				{
					unk_0xE216F8B2802ABABF(Local_96.f_41[2], sLocal_332, 2, joaat("p_a4_sheets_s"), 0);
				}
				if (func_567(Local_96.f_41[3]))
				{
					unk_0xE216F8B2802ABABF(Local_96.f_41[3], sLocal_333, 0, 0, 0);
				}
				else
				{
					unk_0xE216F8B2802ABABF(Local_96.f_41[3], sLocal_333, 2, joaat("p_cs_lighter_01"), 0);
				}
				if (func_567(Local_96.f_41[4]))
				{
					unk_0xE216F8B2802ABABF(Local_96.f_41[4], sLocal_334, 0, 0, 0);
				}
				else
				{
					unk_0xE216F8B2802ABABF(Local_96.f_41[4], sLocal_334, 2, joaat("p_cs_joint_01"), 0);
				}
				if (func_567(unk_0xA19140A5C42D8715()))
				{
					unk_0xE216F8B2802ABABF(unk_0xA19140A5C42D8715(), "Michael", 0, 0, 0);
				}
				unk_0xF0188A1B49D79AF7(unk_0xA19140A5C42D8715(), iLocal_209, -1, 0, 0);
				iLocal_884 = func_422(unk_0xA19140A5C42D8715(), iLocal_209, 1, 0, 0, 0, 0, 0, 0);
				unk_0xE216F8B2802ABABF(iLocal_884, sLocal_331, 0, 0, 0);
				func_421();
				unk_0x80D42964D19AF118(0);
				unk_0xF748D06B9A97191E(1);
				...
				if (func_567(Local_96.f_41[4]))
				{
					if (unk_0xF797E4DD45066C88(Local_96.f_41[4]))
					{
						unk_0xF334C9B245CD323D(Local_96.f_41[4], 1, 1);
					}
				}
				func_420(0, 0, 1, 0);
				func_412();
		...
		case 2:
			...
			else
			{
				...
				if (bLocal_37)
				{
					...
					func_410(0.1f, 0.1f, "NUMBER", unk_0x95BED12E084A8F9A(), 0);
				}
				if (func_404(&uLocal_210))
				{
					if (!iLocal_883)
				...
				{
					unk_0x288F680FFC13665D(iLocal_884);
					if (unk_0x0FFE9FEDC2E0AC88(sLocal_331, 0))
					{
						unk_0xE2C0081C99CB2618(iLocal_884, unk_0xA19140A5C42D8715());
					}
				}
				if (unk_0x0FFE9FEDC2E0AC88(sLocal_332, 0))
				{
					if (func_567(Local_96.f_41[2]))
					{
						unk_0xC0AC848E56940C34(&(Local_96.f_41[2]));
					}
				}
				if (iLocal_354 == 0)
				{
					if (iVar0 >= 58500)
					{
						...
						unk_0x9444470D6D9ADB88("RC18A_START");
					}
				}
				if (iLocal_355 == 0)
				{
					...
					{
						iLocal_355 = 1;
						unk_0x9444470D6D9ADB88("RC18A_INCREASE");
					}
				}
			}
			break;
		...
		case 3:
			...
			{
				iLocal_354 = 1;
				unk_0x9444470D6D9ADB88("RC18A_CS_SKIP_BEFORE");
				if (!unk_0x493E42DC8C29B51A(sLocal_336))
				{
					unk_0xE60B9F9B48D4783F(sLocal_336, 0, 1);
				}
			}
			else
			{
				unk_0x9444470D6D9ADB88("RC18A_CS_SKIP_AFTER");
				iLocal_355 = 1;
			}
			if (func_567(iLocal_884))
			{
			...
			func_269(unk_0xA19140A5C42D8715(), Local_174);
			unk_0x92DDCF53AA47A63D(unk_0xA19140A5C42D8715(), 327.2303f);
			func_382(iLocal_209);
...
void func_411(var uParam0, int iParam1)
{
	...
	*uParam0 = unk_0xF66A39BBE7B3C278(-7000f, -7000f, -100f, 7000f, 7000f, 315f, 0, 1, 1, 1);
	...
	if (func_12(unk_0xA19140A5C42D8715()) && iParam1 == 1)
	{
...
void func_412()
{
	if (func_322(func_324(), 1))
	{
		if (func_567(func_325()))
		{
			Local_925 = { unk_0xE2BBD32891C18569(func_325(), 1) };
			fLocal_928 = unk_0x552C823E1D2A019C(func_325());
		}
	}
...
int func_422(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_426(iVar2, iVar8) != 0)
	{
		if (!unk_0x7112137033807390(iParam0, 0))
		{
			if (unk_0x15763A17141CD6EE(iParam0, iVar2, func_426(iVar2, iVar8)))
			{
				if (func_425(func_426(iVar2, iVar8)))
				{
					uVar9 = unk_0x73929A7BB3EF0A64(func_426(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_426(iVar2, iVar8) != 0)
	{
		if (!unk_0x7112137033807390(iParam0, 0))
		{
			if (unk_0x15763A17141CD6EE(iParam0, iVar2, func_426(iVar2, iVar8)))
			{
				unk_0x9D1B97F26237B39F(uVar1, func_426(iVar2, iVar8));
...
void func_429(int iParam0)
{
	...
	if (!unk_0x4915F4759304D5CF(iParam0))
	{
		...
		while (iVar1 <= (8 - 1))
		{
			Global_106070.f_2355.f_539.f_1715[iVar1 /*4*/][iVar0] = unk_0x3A15689FB6B31DEF(iVar1);
			iVar1++;
		}
	}
}
...
void func_430(int iParam0, var uParam1)
{
	...
	if (!unk_0x4915F4759304D5CF(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x3D2A81E3C295D501(iParam0, func_432(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((unk_0x8798F3E6AE76AF63(iVar9, &Var11) && !func_431(Var11.f_1)) && iVar72 < 50)
			{
...
void func_433(int iParam0)
{
	...
	switch (*iParam0)
	{
		case 0:
			...
			*iParam0 = 1;
			if (func_567(Local_96.f_28[0]))
			{
				if (unk_0x1F7BAD75218F1A2C(0) == 4)
				{
					unk_0x39102BE90DA2BED2(Local_96.f_28[0], 0f, 0f, 0.8f, 1, -1, 3000, 2000, 0);
					unk_0x374E4DFFB92FA338(0f);
				}
				else
				{
					unk_0x39102BE90DA2BED2(Local_96.f_28[0], 0.5f, 0f, 0.8f, 1, -1, 3000, 2000, 0);
		...
		case 1:
			if (unk_0x39C2D9AB77873F84(sLocal_339) && !func_330())
			{
				uVar0 = 16;
				func_35(&uVar0, 0, unk_0xA19140A5C42D8715(), "MICHAEL", 0, 1);
				func_35(&uVar0, 5, Local_96.f_28[0], "BARRY", 0, 1);
				if (func_34(&uVar0, "BARY1AU", "BARY1_LEADIN", 7, 0, 0, 0))
				{
					unk_0x3F01127ECD227890(Local_96.f_28[0], sLocal_339, "leadin", 8f, -4f, -1, 2, 0, 0, 0, 0);
					unk_0x22DD1D053CFF9707(Local_96.f_28[0], unk_0xA19140A5C42D8715(), -1, 2048, 4);
					*iParam0 = 2;
					iLocal_157 = unk_0xFD34717937104F1C() + 30000;
				}
			}
			break;
		...
		case 2:
			if (func_567(Local_96.f_28[0]))
			{
				if (!func_330() || unk_0xFD34717937104F1C() > iLocal_157)
				{
					*iParam0 = 4;
				}
			}
...
void func_437()
{
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			if (func_333(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_438()
{
	...
	if (unk_0xFD34717937104F1C() < iLocal_563)
	{
		iLocal_561 = -1;
	}
...
void func_440(var uParam0)
{
	...
	{
		Var0 = { unk_0x505186370955851F(uParam0->f_2, 31086, Local_864) };
		unk_0xE8B3104D1CB25CDC(uParam0->f_4, Var0, 0, 0, 1);
		unk_0xDCFB67537602326F(uParam0->f_4, 0, 0);
	}
	if (func_469(uParam0) && bLocal_559 == 1)
	{
		...
		unk_0x3F01127ECD227890(uParam0->f_2, sLocal_338, sLocal_349, 8f, -8f, -1, 1, 0, 0, 0, 0);
		func_58(uParam0);
		func_60(&(uParam0->f_17));
		uParam0->f_1 = 13;
		uParam0->f_26 = 0;
	...
	{
		case 1:
			if (unk_0xFD34717937104F1C() > uParam0->f_7)
			{
				uParam0->f_31 = 0;
				uParam0->f_26 = 0;
				uParam0->f_1 = 2;
				uParam0->f_15 = 0f;
				unk_0x7BC735BFDF7BC819(uParam0->f_2, unk_0xF34EE736CF047844(uParam0->f_15), 0);
			}
			break;
		...
		case 2:
			...
			unk_0x96BFF0680C7B6FD5(uParam0->f_2, 0);
			func_355(uParam0->f_2);
			unk_0x3F01127ECD227890(uParam0->f_2, sLocal_338, sLocal_350, 8f, -8f, -1, 1, 0, 0, 0, 0);
			unk_0xF593FC0961E061E6("scr_alien_teleport", uParam0->f_2, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_573, 0, 0, 0);
			uParam0->f_7 = unk_0xFD34717937104F1C() + 450;
			uParam0->f_1 = 3;
			unk_0xC4C22DDB26872744(uParam0->f_2, "TELEPORT ST");
			unk_0x6020229E34827A69(-1, "SPAWN", uParam0->f_2, "BARRY_01_SOUNDSET", 0, 0);
			func_6(&(uParam0->f_3));
			break;
		
		case 3:
			uParam0->f_15 = (uParam0->f_15 + (unk_0xDE089748C4C76C96() * 512f));
			...
			if (unk_0xFD34717937104F1C() > uParam0->f_7)
			{
				unk_0xB29E08C7AB729BAD(uParam0->f_2, 0);
				unk_0x33CF95E95A476FB9(uParam0->f_2, 0);
				unk_0x96BFF0680C7B6FD5(uParam0->f_2, 1);
				unk_0xDCFB67537602326F(uParam0->f_2, 1, 0);
				unk_0x7C73A424F1117528(uParam0->f_2, 1, 0);
				uParam0->f_15 = 255f;
				unk_0xDFA901280292A2FB(uParam0->f_2, -2065892691);
				unk_0xC4C22DDB26872744(uParam0->f_2, "ACTIVE");
				uParam0->f_1 = 9;
			}
			if (uParam0->f_15 < 255f)
			{
			...
			{
				unk_0xA9DC61CC95D220CF(uParam0->f_2);
			}
			break;
		...
		case 4:
			...
			func_6(&(uParam0->f_3));
			func_60(&(uParam0->f_17));
			unk_0x882807816FB26635("scr_alien_teleport", unk_0xE2BBD32891C18569(uParam0->f_2, 1), unk_0x288B716F47E9BBBC(uParam0->f_2, 2), fLocal_573, 0, 0, 0);
			unk_0x6020229E34827A69(-1, "SPAWN", uParam0->f_2, "BARRY_01_SOUNDSET", 0, 0);
			uParam0->f_7 = unk_0xFD34717937104F1C() + 450;
			uParam0->f_1 = 5;
			unk_0xC4C22DDB26872744(uParam0->f_2, "TPORT OUT");
			break;
		
		case 5:
			uParam0->f_15 = (IntToFloat((uParam0->f_7 - unk_0xFD34717937104F1C()) * 255) / unk_0xBBDA792448DB5A89(450));
			if (uParam0->f_15 < 0f)
			{
				uParam0->f_15 = 0f;
			}
			func_74(uParam0->f_2, unk_0xF34EE736CF047844(uParam0->f_15), &iLocal_186);
			if (unk_0xFD34717937104F1C() > uParam0->f_7 || uParam0->f_15 == 0f)
			{
				unk_0xC4C22DDB26872744(uParam0->f_2, "RELOCATE");
				uParam0->f_1 = 6;
			}
			break;
		...
		case 6:
			...
			if (func_346(&Var0))
			{
				...
				uParam0->f_7 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(1250, 2000));
				uParam0->f_14 = (fLocal_857 + (unk_0xF59B9063EDAC7451(fLocal_861, fLocal_862) * fLocal_857));
				if (iLocal_184 == 1)
				{
				}
		...
		case 9:
			...
			if (!uParam0->f_32)
			{
				if (unk_0xF9D4EF1338E38AFB(uParam0->f_2, 1227113341) != 1)
				{
					unk_0x8F65948C5AFB744E(uParam0->f_2, unk_0xA19140A5C42D8715(), 20000, 1056964608, 1073741824, 1073741824, 0);
				}
			}
			if (!func_9())
			{
			...
			if (func_466(uParam0))
			{
				unk_0x4BA42BD797F0E898(uParam0->f_2, 3f);
		...
		case 12:
			unk_0xC4C22DDB26872744(uParam0->f_2, "SUMMON FAIL");
			if (iLocal_561 == uParam0->f_30)
			{
				iLocal_561 = -1;
			}
			if (unk_0x411C28019DEA5CEF(unk_0xA19140A5C42D8715(), sLocal_338, sLocal_346, 3))
			{
			}
			else if (unk_0xFD34717937104F1C() > uParam0->f_7)
			{
				if (iLocal_184 == 1)
				{
				}
				if (!unk_0x6D6FD221326F0FEB(unk_0xA19140A5C42D8715()))
				{
					unk_0x90683BECDF939A74(unk_0xA19140A5C42D8715(), 1, -1, 0);
				}
				if (unk_0x22B3625D717A4563(unk_0xA19140A5C42D8715(), iLocal_209, 0))
				{
					if (unk_0x8F62F4EC66847EC2(unk_0xA19140A5C42D8715(), iLocal_209) > 0)
					{
						if (unk_0xDDEA04F5EE48EED4(unk_0xA19140A5C42D8715(), iLocal_209, &iVar4))
						{
							if (iVar4 == 0)
							{
								unk_0xDEFAC29A3FC5AFAD(unk_0xA19140A5C42D8715());
		...
		case 13:
			unk_0xC4C22DDB26872744(uParam0->f_2, "WATCH");
			if (bLocal_559 == 1)
			{
				if (unk_0xF9D4EF1338E38AFB(uParam0->f_2, -2017877118) != 1)
				{
					unk_0x3F01127ECD227890(uParam0->f_2, sLocal_338, sLocal_349, 4f, -4f, -1, 1, 0, 0, 0, 0);
				}
				return;
			}
			uParam0->f_1 = 14;
			uParam0->f_7 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA((iLocal_562 - 1500), (iLocal_562 - 500)));
			break;
		
		case 14:
			unk_0xC4C22DDB26872744(uParam0->f_2, "WATCH END");
			if (unk_0xFD34717937104F1C() > uParam0->f_7 && !unk_0x411C28019DEA5CEF(unk_0xA19140A5C42D8715(), sLocal_338, sLocal_346, 3))
			{
				uParam0->f_1 = 9;
			}
			break;
		...
		case 15:
			func_58(uParam0);
			unk_0xB0D7019224A3A443(uParam0->f_2, 63, 1);
			unk_0xC4C22DDB26872744(uParam0->f_2, "C-RUSH");
			if (!uParam0->f_32)
			{
				unk_0x4A8666AE4BBDBEFB(uParam0->f_2, 1.15f);
				unk_0x4BA42BD797F0E898(uParam0->f_2, 3f);
				if (unk_0xF9D4EF1338E38AFB(uParam0->f_2, 1227113341) != 1)
				{
					unk_0x8F65948C5AFB744E(uParam0->f_2, unk_0xA19140A5C42D8715(), 20000, 1056964608, 1073741824, 1073741824, 0);
		...
		case 17:
			unk_0x4299736016AECE26(uParam0->f_5, unk_0xE2BBD32891C18569(uParam0->f_4, 1), 1, 0, 0, 1);
			unk_0xC4C22DDB26872744(uParam0->f_2, "CHARGE");
			if (unk_0xFD34717937104F1C() > uParam0->f_7)
			{
				if (func_9())
				{
		...
		case 18:
			if (!unk_0x2C09842CA701A793(uParam0->f_2))
			{
				unk_0xC4C22DDB26872744(uParam0->f_2, "BEAM ST");
				func_355(uParam0->f_2);
				Var0 = { unk_0x505186370955851F(unk_0xA19140A5C42D8715(), 31086, 0f, 0f, 0f) };
				func_452(uParam0->f_4, Var0);
				uParam0->f_7 = (unk_0xFD34717937104F1C() + iLocal_856);
				func_59(&(uParam0->f_21));
				func_59(&(uParam0->f_22));
				func_59(&(uParam0->f_23));
				func_59(&(uParam0->f_24));
				uParam0->f_12 = 0f;
				uParam0->f_22 = unk_0x8E3AC3DF6783369A("scr_alien_impact", uParam0->f_4, 0f, 0f, 0f, 0f, 0f, 0f, (fLocal_571 / 3f), 0, 0, 0);
				uParam0->f_23 = unk_0x8E3AC3DF6783369A("scr_alien_beam", uParam0->f_4, 0f, 0f, 0f, Local_867, fLocal_858, 0, 0, 0);
				unk_0x60ABD61039B2F96B(uParam0->f_23, uParam0->f_12);
				unk_0x3F01127ECD227890(uParam0->f_2, sLocal_338, "MIND_CONTROL_B_Loop", 4f, -8f, -1, 1, 0, 0, 0, 0);
				uParam0->f_1 = 19;
			}
			break;
		...
		case 20:
			...
			{
				if (((unk_0x68477FE20127AEDA(uParam0->f_2) || unk_0xC35EE16DB41A098F(uParam0->f_2)) || unk_0x685AE6AF34B35D3B(uParam0->f_2)) || unk_0x2C09842CA701A793(uParam0->f_2))
				{
					return;
				}
			}
			if (unk_0xF9D4EF1338E38AFB(uParam0->f_2, -2017877118) != 1)
			{
				unk_0x3F01127ECD227890(uParam0->f_2, sLocal_338, "MIND_CONTROL_B_LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
			}
			if (unk_0xF9D4EF1338E38AFB(uParam0->f_2, -2017877118) == 1)
			{
				unk_0x92DDCF53AA47A63D(uParam0->f_4, unk_0x552C823E1D2A019C(uParam0->f_2));
				if (!unk_0x059A39F1D399060B(uParam0->f_22))
				{
					uParam0->f_22 = unk_0x8E3AC3DF6783369A("scr_alien_charging", uParam0->f_4, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_572, 0, 0, 0);
				}
				if (iLocal_184 == 1)
				{
				}
		...
		case 7:
			if (func_441(uParam0) || unk_0xFD34717937104F1C() > uParam0->f_7)
			{
				Var0 = { unk_0xE2BBD32891C18569(uParam0->f_2, 1) };
				if (unk_0x8F7BA8E028ADF980(Var0, &uVar3, 0, 0))
				{
					Var0.f_2 = uVar3;
				}
				unk_0xF593FC0961E061E6("scr_alien_disintegrate", uParam0->f_2, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_574, 0, 0, 0);
				unk_0x7A15C6C664F7334E(-1, "DESPAWN", Var0, "BARRY_01_SOUNDSET", 0, 0, 0);
				if (iLocal_184 == 1)
				{
				}
				uParam0->f_1 = 8;
				unk_0xC4C22DDB26872744(uParam0->f_2, "DEAD");
				uParam0->f_7 = unk_0xFD34717937104F1C() + 1000;
			}
			break;
		
		case 8:
			uParam0->f_15 = (IntToFloat((uParam0->f_7 - unk_0xFD34717937104F1C()) * 255) / unk_0xBBDA792448DB5A89(1000));
			if (uParam0->f_15 < 0f)
			{
				uParam0->f_15 = 0f;
			}
			if (unk_0x1A8481A7E865EC7C(uParam0->f_2))
			{
				func_74(uParam0->f_2, unk_0xF34EE736CF047844(uParam0->f_15), &iLocal_186);
			}
			else
...
int func_441(var uParam0)
{
	...
	if (!func_442(unk_0x57323E573695B13F(uParam0->f_2), 0f, 0f, 0f, 0.125f, 0))
	{
		if (iLocal_184 == 1)
		{
		}
	...
	if (unk_0x685AE6AF34B35D3B(uParam0->f_2) || unk_0x2C09842CA701A793(uParam0->f_2))
	{
		return 0;
	}
	return 1;
...
void func_443(var uParam0)
{
	...
	unk_0xC4C22DDB26872744(uParam0->f_2, "BEAM");
	if (unk_0xFD34717937104F1C() >= uParam0->f_7)
	{
		func_60(&(uParam0->f_17));
		func_58(uParam0);
	...
	if (unk_0x817B152F7462D506() >= uParam0->f_9 + 8)
	{
	...
	if (uParam0->f_12 <= 0f)
	{
		if (unk_0x059A39F1D399060B(uParam0->f_23))
		{
			unk_0x60ABD61039B2F96B(uParam0->f_23, uParam0->f_12);
		}
		func_60(&(uParam0->f_17));
	...
	Var5 = { unk_0xE2BBD32891C18569(uParam0->f_4, 1) };
	Var8 = { Var5 + unk_0xFA0A034A8C86C35E(uParam0->f_4) * FtoV((uParam0->f_12 + 3f)) };
	if (uParam0->f_26 == 0)
	{
		uParam0->f_26 = unk_0x931DC90E31FA1705(Var5, Var8, 511, uParam0->f_2, 7);
	}
	else
	{
		iVar1 = unk_0x7C00B4755E048785(uParam0->f_26, &iVar0, &Var11, &uVar14, &uVar17);
		if (iVar1 == 0)
		{
			uParam0->f_26 = 0;
		}
		else if (iVar1 == 2)
		{
			if (iVar0 > 0)
			{
				uParam0->f_9 = unk_0x817B152F7462D506();
				unk_0xF55215956686F728(unk_0xA19140A5C42D8715(), 1);
				uParam0->f_27 = { unk_0x8D0C441B2F86EA3E(Var11, Var5, Var8, 0) };
				unk_0x4299736016AECE26(uParam0->f_5, uParam0->f_27, 1, 0, 0, 1);
				uParam0->f_12 = func_354(uParam0->f_5, uParam0->f_4, 1);
				Var2 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1) };
				if (unk_0x499324B3EF19C288(uParam0->f_27, Var2, 1) <= 0.7f)
				{
					fLocal_179 = 0f;
					if (unk_0x69C0BB7D03EE045D((uParam0->f_27.f_2 - Var2.f_2)) < 1f)
					{
						if ((unk_0x817B152F7462D506() % 20) == 0)
						{
							unk_0x1E368F42D982FEE0(Var5, Var8, 0, 1, joaat("weapon_pistol"), 0, 0, 1, -1082130432);
						}
						if (iLocal_851 == 1)
						{
							unk_0xFAE5E5AC968944E8(unk_0xA19140A5C42D8715(), 1, Vector(fLocal_863, fLocal_863, fLocal_863) * unk_0xFA0A034A8C86C35E(uParam0->f_4), 0f, 0f, 0f, 0, 0, 1, 1, 0, 1);
						}
						if (iLocal_852 == 0)
						{
							if (unk_0xBEE435F0F4CCC194(unk_0xA19140A5C42D8715()) > 0)
							{
								func_446("BAR1_MIND_HLP", -1);
								iLocal_852 = 1;
							}
						}
						if (unk_0xFD34717937104F1C() > uParam0->f_8)
						{
							func_445();
							...
							{
								case 0:
									unk_0x130C1C99206E5D84(unk_0xA19140A5C42D8715(), iVar0, 0.657f, 0.566f, 126.36f, 0.07f, 1, 0f, "cs_trev1_blood");
									break;
								
								case 1:
									unk_0x130C1C99206E5D84(unk_0xA19140A5C42D8715(), iVar0, 0.582f, 0.383f, 111.36f, 0.05f, 3, 0f, "cs_trev1_blood");
									break;
								
								case 2:
									unk_0x130C1C99206E5D84(unk_0xA19140A5C42D8715(), iVar0, 0.709f, 0.396f, 126.36f, 0f, 3, 0f, "cs_trev1_blood");
									break;
								
								default:
									unk_0x130C1C99206E5D84(unk_0xA19140A5C42D8715(), iVar0, 0.582f, 0.383f, 200.36f, 0.1f, 2, 0f, "cs_trev1_blood");
									break;
							}
							if ((unk_0x24A1A7BF4ED94B71(unk_0xA19140A5C42D8715()) - iLocal_853) <= 100)
							{
								func_62();
								func_54(1);
							...
							{
								unk_0xA20E2C99B8F1EB38(unk_0xA19140A5C42D8715(), iLocal_853, 0, 0);
							}
							uParam0->f_8 = (unk_0xFD34717937104F1C() + unk_0xF2DB717A73826179((IntToFloat(iLocal_854) * 1.25f)));
							unk_0xB0E737394929E89F(0, (iLocal_854 / 2), 255);
							unk_0xB0E737394929E89F(0, (iLocal_854 / 2), 255);
						}
					}
				}
	...
	{
		unk_0x4299736016AECE26(uParam0->f_5, unk_0xE2BBD32891C18569(uParam0->f_4, 1) + unk_0xFA0A034A8C86C35E(uParam0->f_4) * Vector(uParam0->f_12, uParam0->f_12, uParam0->f_12), 1, 0, 0, 1);
	}
	if (unk_0x059A39F1D399060B(uParam0->f_23))
	{
		unk_0x60ABD61039B2F96B(uParam0->f_23, uParam0->f_12);
	}
	if (!unk_0x059A39F1D399060B(uParam0->f_24))
	{
		uParam0->f_24 = unk_0x8E3AC3DF6783369A("scr_alien_impact", uParam0->f_5, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_571, 0, 0, 0);
	}
}

void func_444(struct<3> Param0, struct<3> Param3, int iParam6)
{
	unk_0xACDA0BDD50CBABE4(unk_0xD4E735F4B6A956AC(), 0f);
	...
	if (iParam6 == 1)
	{
		unk_0xA20E2C99B8F1EB38(unk_0xA19140A5C42D8715(), 100000, 1, 0);
...
void func_445()
{
	if (unk_0xFD34717937104F1C() < iLocal_364)
	{
		return;
	}
	if (unk_0x904275961B875DEB())
	...
	{
		iLocal_364 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(4000, 7000));
	}
}
...
void func_447(var uParam0)
{
	...
	Var3 = { func_451(unk_0xB89F0BB02739BD58(2)) };
	Var6 = { Var0 + Var3 * FtoV(unk_0x767C76C24BA2B071()) };
	fVar13 = (fLocal_571 * 1.25f);
	if (func_450(&Var9, unk_0xE2BBD32891C18569(uParam0->f_4, 1), unk_0xE2BBD32891C18569(uParam0->f_5, 1), Var3, Var6))
	{
		if (unk_0x317672E799676CA5(Var9, 0.5f))
		{
			iVar14 = func_448(Var3, Var0, unk_0xE2BBD32891C18569(uParam0->f_4, 1));
			iVar15 = func_448(Var3, Var0, unk_0xE2BBD32891C18569(uParam0->f_5, 1));
			if (iVar14 > 0 && iVar15 < 0)
			{
				Var9 = { Var9 - unk_0xFA0A034A8C86C35E(uParam0->f_4) * Vector(fLocal_870, fLocal_870, fLocal_870) };
			}
			else if (iVar14 < 0 && iVar15 > 0)
			{
				Var9 = { Var9 + unk_0xFA0A034A8C86C35E(uParam0->f_4) * FtoV((fLocal_870 * 4.5f)) };
			}
			if (!unk_0x059A39F1D399060B(uParam0->f_25))
			{
				uParam0->f_25 = unk_0xA711E33651B4D849("scr_alien_impact", Var9, 0f, 0f, 0f, fVar13, 0, 0, 0, 0);
			}
...
int func_450(var uParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10)
{
	...
	if (unk_0x69C0BB7D03EE045D(fVar6) < 1E-08f)
	{
		return 0;
	}
	fVar8 = (fVar7 / fVar6);
...
void func_452(int iParam0, struct<3> Param1)
{
	...
	func_453(unk_0xE2BBD32891C18569(iParam0, 1), Param1, &fVar0, &fVar1, 1);
	unk_0x76D3D51F5F66367F(iParam0, fVar0, 0f, fVar1, 2, 1);
}
...
void func_455(var uParam0)
{
	...
	Var3 = { unk_0xE2BBD32891C18569(uParam0->f_4, 1) };
	if (!uParam0->f_32)
	{
		if (unk_0xF9D4EF1338E38AFB(uParam0->f_2, 1227113341) != 1)
		{
	...
	else if (unk_0xF9D4EF1338E38AFB(uParam0->f_2, -982327190) != 1)
	{
		unk_0xB3E1967E66494060(uParam0->f_2, -1);
		uParam0->f_7 = (unk_0xFD34717937104F1C() + iLocal_855 * 2);
	}
	if (!func_9())
	{
		return;
	...
	if (uParam0->f_26 == 0)
	{
		Var6 = { unk_0x505186370955851F(unk_0xA19140A5C42D8715(), 31086, 0f, 0f, 0f) };
		uParam0->f_26 = unk_0x931DC90E31FA1705(Var3, Var6, 511, unk_0xA19140A5C42D8715(), 7);
		if (unk_0xFD34717937104F1C() > uParam0->f_7 && uParam0->f_32)
		{
			func_60(&(uParam0->f_17));
			uParam0->f_17 = unk_0x7A3ECD08D6D1D554();
			unk_0x6020229E34827A69(uParam0->f_17, "MIND_CONTROL", uParam0->f_2, "BARRY_01_SOUNDSET", 0, 0);
			uParam0->f_1 = 17;
		}
	}
	else
	{
		iVar1 = unk_0x7C00B4755E048785(uParam0->f_26, &iVar0, &Var6, &uVar9, &uVar12);
		if (iVar1 == 2)
		{
			if (iVar0 == 0 && func_9())
			{
				...
				unk_0x3F01127ECD227890(0, sLocal_338, "MIND_CONTROL_B_Enter", 8f, -8f, -1, 2, 0, 0, 0, 0);
				unk_0x301F42EEE3C40328(uVar2);
				unk_0xE1072FA2FECBAD96(uParam0->f_2, uVar2);
				unk_0x3A95A0A3221D4208(&uVar2);
				if (!unk_0x059A39F1D399060B(uParam0->f_22))
				{
					uParam0->f_22 = unk_0x8E3AC3DF6783369A("scr_alien_charging", uParam0->f_4, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_572, 0, 0, 0);
				}
				unk_0x4299736016AECE26(uParam0->f_5, Var3, 1, 0, 0, 1);
				if (!unk_0x059A39F1D399060B(uParam0->f_24))
				{
					uParam0->f_24 = unk_0x8E3AC3DF6783369A("scr_alien_impact", uParam0->f_5, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_571, 0, 0, 0);
				}
				...
				uParam0->f_7 = (unk_0xFD34717937104F1C() + iLocal_855);
				func_60(&(uParam0->f_17));
				uParam0->f_17 = unk_0x7A3ECD08D6D1D554();
				unk_0x6020229E34827A69(uParam0->f_17, "MIND_CONTROL", uParam0->f_2, "BARRY_01_SOUNDSET", 0, 0);
			}
...
{
	unk_0x85AF6DC3641E2442(uParam0, sParam1, sParam2, func_457(iParam3), 0);
}
...
void func_458(var uParam0)
{
	...
	iLocal_563 = (unk_0xFD34717937104F1C() + iLocal_564);
	bLocal_559 = true;
	unk_0x34ED9CAB6ECFFE1B(1);
	unk_0xC4C22DDB26872744(uParam0->f_2, "SUMMON");
	func_436();
	iVar0 = func_461(unk_0x8CBB8AEBE6D8962B(0, 30));
	if (unk_0x53E955948D35BDB5(0, 30) || iVar0 != uParam0->f_20)
	{
		uParam0->f_20 = iVar0;
		uParam0->f_18++;
	}
	if (unk_0xFD34717937104F1C() > uParam0->f_19)
	{
		unk_0xF593FC0961E061E6("scr_alien_teleport", unk_0xA19140A5C42D8715(), 0f, 0f, 0f, 0f, 0f, 0f, fLocal_573, 0, 0, 0);
		uParam0->f_19 = unk_0xFD34717937104F1C() + 2000;
	}
	if (uParam0->f_18 > iLocal_565 || unk_0xF9D4EF1338E38AFB(uParam0->f_2, 242628503) > 1)
	{
		if (unk_0x411C28019DEA5CEF(uParam0->f_2, sLocal_338, sLocal_343, 3) || unk_0x411C28019DEA5CEF(uParam0->f_2, sLocal_338, sLocal_341, 3))
		{
			unk_0x3F01127ECD227890(uParam0->f_2, sLocal_338, sLocal_345, 8f, -8f, -1, 0, 0, 0, 0, 0);
		}
		if (unk_0x411C28019DEA5CEF(unk_0xA19140A5C42D8715(), sLocal_338, sLocal_344, 3))
		{
			unk_0x9568B1B58F78FF36(unk_0xA19140A5C42D8715());
			unk_0x3F01127ECD227890(unk_0xA19140A5C42D8715(), sLocal_338, sLocal_346, 8f, -4f, -1, 0, 0, 0, 0, 0);
			unk_0x3A3E4B7C6FBE305D(unk_0xA19140A5C42D8715(), 0, 0);
		}
		else if (unk_0x411C28019DEA5CEF(unk_0xA19140A5C42D8715(), sLocal_338, sLocal_342, 3))
		{
			unk_0x9568B1B58F78FF36(unk_0xA19140A5C42D8715());
			unk_0x3F01127ECD227890(unk_0xA19140A5C42D8715(), sLocal_338, sLocal_346, 8f, -4f, -1, 0, 0, 0, 0, 0);
			unk_0x3A3E4B7C6FBE305D(unk_0xA19140A5C42D8715(), 0, 0);
		...
		uParam0->f_18 = 0;
		uParam0->f_1 = 12;
		uParam0->f_7 = unk_0xFD34717937104F1C() + 2000;
		...
		if (iLocal_187 == 0)
		{
			...
			unk_0xE061C3261E51F663(fVar1, 2f, 1);
		}
		iLocal_187++;
		return;
	}
	if (unk_0xFD34717937104F1C() > uParam0->f_7)
	{
		unk_0x3F01127ECD227890(uParam0->f_2, sLocal_338, sLocal_347, 8f, -8f, -1, 0, 0, 0, 0, 0);
		func_60(&(uParam0->f_17));
		func_459();
	}
}
...
void func_462(var uParam0)
{
	...
	func_58(uParam0);
	unk_0xB0D7019224A3A443(uParam0->f_2, 63, 1);
	unk_0xC4C22DDB26872744(uParam0->f_2, "S-RUSH");
	unk_0x4A8666AE4BBDBEFB(uParam0->f_2, 1.15f);
	unk_0x4BA42BD797F0E898(uParam0->f_2, 3f);
	if (unk_0xF9D4EF1338E38AFB(uParam0->f_2, 1227113341) != 1)
	{
	...
	if (!func_465(uParam0->f_2, unk_0xA19140A5C42D8715(), 1126825984, 0))
	{
		return;
	}
	if (!unk_0x581D3C560D601491(uParam0->f_2, unk_0xA19140A5C42D8715()))
	{
		return;
	}
	func_355(uParam0->f_2);
	unk_0x2F89329397A277BC(&uVar0);
	unk_0x3F01127ECD227890(0, sLocal_338, sLocal_341, 8f, -8f, -1, 0, 0, 0, 0, 0);
	unk_0x3F01127ECD227890(0, sLocal_338, sLocal_343, 8f, -8f, -1, 1, 0, 0, 0, 0);
	unk_0x301F42EEE3C40328(uVar0);
	unk_0xE1072FA2FECBAD96(uParam0->f_2, uVar0);
	unk_0x3A95A0A3221D4208(&uVar0);
	unk_0x3A3E4B7C6FBE305D(uParam0->f_2, 0, 0);
	func_464(unk_0xA19140A5C42D8715(), uParam0->f_2);
	unk_0x2F89329397A277BC(&uVar0);
	unk_0x3F01127ECD227890(0, sLocal_338, sLocal_342, 8f, -8f, -1, 0, 0, 0, 0, 0);
	unk_0x3F01127ECD227890(0, sLocal_338, sLocal_344, 8f, -8f, -1, 1, 0, 0, 0, 0);
	unk_0x301F42EEE3C40328(uVar0);
	unk_0xE1072FA2FECBAD96(unk_0xA19140A5C42D8715(), uVar0);
	unk_0x3A95A0A3221D4208(&uVar0);
	unk_0x3A3E4B7C6FBE305D(unk_0xA19140A5C42D8715(), 0, 0);
	...
	if (iLocal_875 == 0)
	{
		...
		uParam0->f_7 = (unk_0xFD34717937104F1C() + iLocal_566) + 2000;
		unk_0xC5C406F6DDA838AC(uParam0->f_2, 0f, 0f, 0f, 1, iLocal_566 + 2000, 2000, 2000);
	}
	else
	{
		uParam0->f_7 = (unk_0xFD34717937104F1C() + iLocal_566);
		unk_0xC5C406F6DDA838AC(uParam0->f_2, 0f, 0f, 0f, 1, iLocal_566, 2000, 2000);
	}
	iLocal_875++;
	uParam0->f_18 = 0;
	unk_0x962CF6A9EA6FDCAC(unk_0xD4E735F4B6A956AC(), false, 0);
	...
	func_60(&(uParam0->f_17));
	uParam0->f_17 = unk_0x7A3ECD08D6D1D554();
	unk_0x6020229E34827A69(uParam0->f_17, "PLAYER_BEAMED_UP", uParam0->f_2, "BARRY_01_SOUNDSET", 0, 0);
	unk_0xF593FC0961E061E6("scr_alien_teleport", unk_0xA19140A5C42D8715(), 0f, 0f, 0f, 0f, 0f, 0f, fLocal_573, 0, 0, 0);
	uParam0->f_19 = unk_0xFD34717937104F1C() + 2000;
}
...
void func_464(int iParam0, int iParam1)
{
	...
	uVar0 = func_356(unk_0xE2BBD32891C18569(iParam0, 1), unk_0xE2BBD32891C18569(iParam1, 1), 1);
	unk_0x92DDCF53AA47A63D(iParam0, uVar0);
}
...
int func_465(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_418(unk_0xE2BBD32891C18569(iParam1, 1) - unk_0xE2BBD32891C18569(iParam0, 1)) };
	...
	{
		Var3 = { func_418(unk_0x505186370955851F(iParam0, 31086, 0f, 5f, 0f) - unk_0x505186370955851F(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_466(var uParam0)
{
	...
	return ((iLocal_560 == 1 && unk_0xFD34717937104F1C() > iLocal_563) && uParam0->f_30 == iLocal_561);
}
...
void func_470(var uParam0)
{
	...
	if (unk_0xFD34717937104F1C() > uParam0->f_16)
	{
		if (uParam0->f_10 < 20f)
		{
			uParam0->f_16 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(iLocal_568, iLocal_569));
...
int func_471(var uParam0)
{
	if (!func_475(uParam0))
	{
		uParam0->f_10 = func_354(uParam0->f_2, unk_0xA19140A5C42D8715(), 0);
		if (unk_0x7112137033807390(uParam0->f_2, 0) || unk_0x4915F4759304D5CF(uParam0->f_2))
		{
			if (func_61(uParam0))
			{
				iLocal_558 = 0;
			...
			func_474("ALIEN_DEATH", "ALIENS", unk_0xE2BBD32891C18569(uParam0->f_2, 1), 10);
			func_58(uParam0);
			func_60(&(uParam0->f_17));
			func_14(&(uParam0->f_4));
			func_14(&(uParam0->f_5));
			...
			func_473();
			func_6(&(uParam0->f_3));
			uParam0->f_7 = unk_0xFD34717937104F1C() + 2500;
			if (iLocal_184 == 1)
			{
			}
			iLocal_877++;
			if (iLocal_873 == 0)
			{
				iLocal_874 = unk_0xFD34717937104F1C() + 10000;
			}
			iLocal_873++;
...
void func_473()
{
	...
	if (unk_0xFD34717937104F1C() < iLocal_362)
	{
		return;
	}
	if (!bLocal_360)
	...
	{
		iLocal_362 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(10000, 20000));
		if ((iLocal_363 - unk_0xFD34717937104F1C()) < 2500)
		{
			iLocal_363 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(3000, 5000));
		}
	}
}
...
{
	unk_0xE4047DB6963CF33D(sParam0, sParam1, Param2, func_457(iParam5));
}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x71364F510A1CB69F())
			{
				...
				Var4 = { func_484(Global_71460, Global_71462, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_495(0) || Global_71474) || Global_71463 == 1) || !unk_0x3A83743561B4F70C())
	{
		return 0;
	}
	switch (Global_71459)
	{
		...
		case 5:
			if ((unk_0x5CA3186381FC012C() || func_479(0)) || func_494(1))
			{
			}
			else
			{
...
void func_500(struct<3> Param0, float fParam3, var uParam4, var uParam5)
{
	struct<3> Var0;
...
int func_501(int iParam0, int iParam1)
{
	...
	iVar0 = unk_0xFD34717937104F1C() + 7500;
	unk_0x9231E8057B40EF0E(iParam0, 31, 0);
	if (unk_0x86FB195D8E9C4FAB(iParam0))
	{
		return 1;
	}
	if (iParam1 == 0)
	...
	while (!unk_0x86FB195D8E9C4FAB(iParam0))
	{
		unk_0x4EDE34FBADD967A6(0);
		if (unk_0xFD34717937104F1C() > iVar0 && !unk_0x86FB195D8E9C4FAB(iParam0))
		{
			return 0;
		}
	}
...
void func_502()
{
	...
	func_519();
	func_518();
	unk_0x717B84DE5E60E767(func_28(0));
	...
	if (func_515() == 1)
	{
		...
		func_505(Local_880, 327.2303f, 0, 0);
		unk_0x9444470D6D9ADB88("RC18A_RESTART");
		iLocal_160 = 1;
		iLocal_162 = 0;
		if (func_567(unk_0xA19140A5C42D8715()))
		{
			if (unk_0x411C28019DEA5CEF(unk_0xA19140A5C42D8715(), sLocal_338, sLocal_344, 3))
			{
				unk_0xED3CB2E0519060F1(unk_0xA19140A5C42D8715(), sLocal_338, sLocal_344, -1056964608);
			}
			if (unk_0x411C28019DEA5CEF(unk_0xA19140A5C42D8715(), sLocal_338, sLocal_342, 3))
			{
				unk_0xED3CB2E0519060F1(unk_0xA19140A5C42D8715(), sLocal_338, sLocal_342, -1056964608);
			}
			unk_0x7C73A424F1117528(unk_0xA19140A5C42D8715(), 1, 0);
			func_429(unk_0xA19140A5C42D8715());
			unk_0x1C09E70D9D927D95(unk_0xA19140A5C42D8715(), 1);
...
int func_506(var uParam0)
{
	...
	switch (iLocal_82)
	{
		case 0:
			...
			{
				unk_0xCACEBBBEAD8F262E(iVar0[iVar12]);
				iVar12++;
			}
		...
		case 2:
			...
			{
				if (func_507(&(uParam0->f_28[0]), 49, Var8, uVar11, "RC LAUNCHER: BARRY 1", 1))
				{
			...
			{
				unk_0x39F8A3E01BC1A69B(189.5964f, -956.0344f, 29.09179f, 5f, 0);
		...
		case 3:
			if (func_567(uParam0->f_28[0]))
			{
				...
				unk_0x4299736016AECE26(uParam0->f_28[0], Var8, 1, 0, 0, 1);
				unk_0x92DDCF53AA47A63D(uParam0->f_28[0], uVar11);
			...
			{
				unk_0x76D3D51F5F66367F(uParam0->f_41[4], -90f, 0f, -30.8f, 2, 1);
				unk_0xB29E08C7AB729BAD(uParam0->f_41[4], 1);
			}
			func_273(&(uParam0->f_41[3]), iVar0[4], 189.783f, -956.015f, 29.79f, 0f);
			if (func_567(uParam0->f_41[3]))
			{
				unk_0x76D3D51F5F66367F(uParam0->f_41[3], -90f, 0f, 75f, 2, 1);
				unk_0xB29E08C7AB729BAD(uParam0->f_41[3], 1);
			}
			func_272(&(uParam0->f_41[5]), iVar0[6]);
			iVar12 = 0;
			while (iVar12 <= (iVar0 - 1))
			{
				unk_0xA5DE74AE39867B03(iVar0[iVar12]);
				iVar12++;
			}
			return 1;
			break;
...
int func_507(var uParam0, int iParam1, struct<3> Param2, var uParam5, char* sParam6, int iParam7)
{
	if (func_508(uParam0, iParam1, Param2, uParam5, 1))
	{
		if (unk_0xDC5D81351D6A4DDB(*uParam0))
		{
			if (!unk_0x7112137033807390(*uParam0, 0))
...
int func_508(var uParam0, int iParam1, struct<3> Param2, int iParam5, bool bParam6)
{
	int iVar0;
...
void func_521(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	*(uParam0[0 /*3*/]) = { Param1 };
	*(uParam0[1 /*3*/]) = { Param4 };
	uParam0->f_7 = fParam7;
...
int func_530(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x4C9BACA8D249CB13())
	{
		if (func_81() == 0)
		{
			return unk_0x05EFB6A616B6FADE(func_142(func_528(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_536(bool bParam0)
{
	...
	if (!func_551())
	{
		...
		{
			func_226(iVar0, 1, 0);
			func_537(unk_0x61D2332983ACC05C(), iVar0);
		}
		else
		{
			if (Global_105157[iVar0 /*10*/].f_9 == -1)
...
int func_538(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_544())
	{
		...
		{
			iVar33 = func_539(unk_0x61D2332983ACC05C());
			if (iVar33 > -1)
			{
...
void func_557(int iParam0, bool bParam1)
{
	...
	iVar0 = func_27(iParam0);
	if (func_26(iVar0) && !unk_0x4915F4759304D5CF(iParam0))
	{
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar168)
			{
				if (iVar8 < 50)
				{
					...
					{
						if (!unk_0x3B61940560400F58(Var9.f_0) && !func_431(Var9.f_1))
						{
							if (iVar7 == 0)
							{
							...
							if (unk_0xA9A013B7FD7A9A7F(iVar8, iVar6, &Var48))
							{
								if (!func_427(Var48.f_3))
								{
									...
									else if (unk_0x15763A17141CD6EE(iParam0, iVar3, Var48.f_3))
									{
										...
										func_560(iParam0, iVar3, Var48.f_3);
									}
									iVar71++;
								}
							}
						...
						while (iVar6 < unk_0x6E55AE7B1FEC08C5(iVar8))
						{
							if (unk_0xA9A013B7FD7A9A7F(iVar8, iVar6, &Var48))
							{
								if (unk_0x15763A17141CD6EE(iParam0, iVar2, Var48.f_3))
								{
									...
									func_560(iParam0, iVar2, Var48.f_3);
								}
							}
							iVar6++;
						}
...
void func_560(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 != 0)
	{
		if (unk_0x15763A17141CD6EE(uParam0, iParam1, iVar0))
		{
...
void func_561(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	if (iVar0 != 0)
	{
		unk_0x509420F171C550DF(uParam0, iParam1, iVar0, uParam3);
	}
}
...
void func_563(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 != 0)
	{
		unk_0xED02AF87669391F2(uParam0, iParam1, iVar0);
	}
}
...
int func_564(int iParam0)
{
	...
	if (iParam0 == -61829581)
	{
		if (unk_0x4C9BACA8D249CB13() && func_566())
		{
			return 1;
		}
		else
	...
	switch (iParam0)
	{
		...
		case joaat("weapon_railgun"):
			if (!func_291() || unk_0x4C9BACA8D249CB13())
			{
				return 0;
			}
			break;
	...
	while (iVar0 < unk_0x0AD363FF0CEF93B1())
	{
		if (unk_0x8798F3E6AE76AF63(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (unk_0x3B61940560400F58(Var1.f_0) || func_431(Var1.f_1))
				{
					return 0;
				}
			}
