...
void __EntryFunction__()
{
	...
	{
		unk_0x4EDE34FBADD967A6(0);
		unk_0x643E26919A174002("SF_GRF", 0);
		...
		{
			unk_0x960CDFA3CBFD7760(392.7562f, -842.7891f, 511.9787f, -669.2035f);
			switch (iLocal_143)
			{
				case 0:
					func_298();
...
void func_1()
{
	if (func_350(unk_0x0FA8183DAD2B3203()))
	{
	...
	switch (iLocal_144)
	{
		case 0:
			if (func_237())
			{
				...
				if (!bLocal_163[3] && func_234(unk_0x0FA8183DAD2B3203(), iLocal_147, 15f, 1))
				{
				...
				{
					func_218(1);
					unk_0xC544A8E1032AC1CF(iLocal_147, uLocal_146);
					if (unk_0x01B4DA7FA4E5AD3A(iLocal_147, unk_0x0FA8183DAD2B3203()))
					{
						unk_0xECC035CAE5B59E06(iLocal_147);
					}
				}
				if (unk_0x01B4DA7FA4E5AD3A(unk_0x0FA8183DAD2B3203(), iLocal_147))
				{
		...
		case 1:
			...
			{
				if ((func_217(uLocal_149[0], Local_360, 30f) || func_214(uLocal_149[0], unk_0x0FA8183DAD2B3203(), 1126825984, 0)) || func_214(uLocal_149[1], unk_0x0FA8183DAD2B3203(), 1126825984, 0))
				{
...
int func_214(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_216(unk_0xACE5E491FC1B0D37(iParam1, 1) - unk_0xACE5E491FC1B0D37(iParam0, 1)) };
	...
	{
		Var3 = { func_216(unk_0x0E516C24C87F5D0C(iParam0, 31086, 0f, 5f, 0f) - unk_0x0E516C24C87F5D0C(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_218(bool bParam0)
{
	if (bParam0)
	{
		if (unk_0xD4B321D9096B01FC(iLocal_148))
		{
			...
			unk_0x5D672CB011E20B28(0, sLocal_145, "barry_get_up", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
			unk_0xAAAD1B054EFBF5A7(0, unk_0xACE5E491FC1B0D37(iLocal_148, 0), 200f, -1, 0, 0);
...
int func_222()
{
	...
	if (unk_0x7C7787D2D7139A85() == func_225())
	{
		return 0;
	}
	if (func_223(unk_0x7C7787D2D7139A85()))
	{
		return 0;
	}
...
void func_236(bool bParam0)
{
	if (unk_0xD4B321D9096B01FC(Local_81.f_41[0]))
	{
		if (bParam0)
		{
			if (!unk_0xCA7317DE7E0F89E9(Local_81.f_41[0]))
			{
				unk_0x01DF2D3988024DB4(Local_81.f_41[0], iLocal_147, unk_0xDD454299E9E58208(iLocal_147, 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			}
		}
		else if (unk_0xCA7317DE7E0F89E9(Local_81.f_41[0]))
		{
			unk_0x363E2170E626A00A(Local_81.f_41[0], 1, 1);
			unk_0xDBAAA280792CB384(Local_81.f_41[0], 1);
		}
	}
}
...
int func_237()
{
	...
	if ((!unk_0xD4B321D9096B01FC(iLocal_148) && unk_0x6DF9C43E3CC645BC(iLocal_153)) && unk_0x6DF9C43E3CC645BC(iLocal_154))
	{
		Var0 = { Local_354 };
		fVar3 = fLocal_365;
		if (func_238(unk_0x0FA8183DAD2B3203(), Local_354, 1) < func_238(unk_0x0FA8183DAD2B3203(), Local_357, 1))
		{
			Var0 = { Local_357 };
			fVar3 = fLocal_366;
		}
		iLocal_148 = unk_0x847817A65E16621A(iLocal_153, Var0, fVar3, 1, 1, 0);
		uLocal_149[0] = unk_0x81024A420EDCE2B5(iLocal_148, 6, iLocal_154, -1, 1, 1);
		unk_0x068EF666AEEC0162(uLocal_149[0], joaat("weapon_pistol"), -1, 1);
		unk_0xE4A2B85AD2F9993F(uLocal_149[0], 1, joaat("weapon_pistol"));
		uLocal_149[1] = unk_0x81024A420EDCE2B5(iLocal_148, 6, iLocal_154, 0, 1, 1);
		unk_0x068EF666AEEC0162(uLocal_149[1], joaat("weapon_pistol"), -1, 1);
		unk_0xE4A2B85AD2F9993F(uLocal_149[1], 1, joaat("weapon_pistol"));
		unk_0xBE6526C2B21229F7(iLocal_148, 1);
		unk_0xD32341B4ADEC0821(iLocal_148, 20f);
		unk_0xD67C82BBC9A488A6(uLocal_149[0], iLocal_148, Local_360, 20f, 1, iLocal_153, 786603, 5f, 5f);
		return 1;
	}
	return 0;
}
...
void func_239()
{
	switch (iLocal_144)
	{
		case 0:
			...
			{
				unk_0xC5982E6B35E11265(unk_0xACE5E491FC1B0D37(iLocal_147, 1), 1000f, 0);
				uLocal_368 = unk_0xF2A54C51C03CADAA(Local_372, Local_375, 2);
				unk_0x3F8774A014F77C2D(uLocal_368, 1);
				unk_0x8582CCEB95B1F1BE(iLocal_147, uLocal_368, sLocal_145, "barry_3_sit_loop", 1000f, -8f, 1, 16, 1148846080, 0);
			}
			...
			iLocal_156 = unk_0x9B35D07DCD0F0B43();
			iLocal_178 = unk_0x9B35D07DCD0F0B43();
			iLocal_144 = 1;
			break;
		...
		case 1:
			if (!func_244())
			{
				...
				if (iLocal_162 < 3)
				{
					if (func_234(unk_0x0FA8183DAD2B3203(), iLocal_147, 15f, 1))
					{
						if (!bLocal_163[iLocal_162])
						{
							if ((unk_0x9B35D07DCD0F0B43() - iLocal_178) > iLocal_344[iLocal_162])
							{
			...
			else if (func_234(unk_0x0FA8183DAD2B3203(), iLocal_147, 15f, 1))
			{
				if (!bLocal_169)
				{
			...
			if (!iLocal_157)
			{
				if ((unk_0x9B35D07DCD0F0B43() - iLocal_156) > 40000 || unk_0xEBE4F888D9965006(unk_0x7A8732CFB5113E77()) > 0)
				{
					iLocal_157 = 1;
					iLocal_144 = 2;
				}
				else if (!func_234(unk_0x0FA8183DAD2B3203(), iLocal_147, 100f, 1))
				{
					iLocal_144 = 2;
				}
			}
...
void func_243()
{
	if (func_234(iLocal_147, unk_0x0FA8183DAD2B3203(), 7f, 1))
	{
		if (!unk_0x01B4DA7FA4E5AD3A(iLocal_147, unk_0x0FA8183DAD2B3203()))
		{
			unk_0x6E2920E14F5F962C(iLocal_147, unk_0x0FA8183DAD2B3203(), -1, 2048, 2);
		}
	}
	else if (unk_0x46BF7A6280E30BAA(iLocal_147))
	{
		if (!unk_0x01B4DA7FA4E5AD3A(iLocal_147, unk_0x0FA8183DAD2B3203()))
		{
			unk_0x6E2920E14F5F962C(iLocal_147, unk_0x0FA8183DAD2B3203(), -1, 2048, 2);
	...
	else if (unk_0x01B4DA7FA4E5AD3A(iLocal_147, unk_0x0FA8183DAD2B3203()))
	{
		unk_0xECC035CAE5B59E06(iLocal_147);
	}
	if (func_234(iLocal_147, unk_0x0FA8183DAD2B3203(), 6f, 1))
	{
		if (!unk_0x01B4DA7FA4E5AD3A(unk_0x0FA8183DAD2B3203(), iLocal_147))
		{
			unk_0x6E2920E14F5F962C(unk_0x0FA8183DAD2B3203(), iLocal_147, -1, 0, 2);
		}
	}
	else if (unk_0x01B4DA7FA4E5AD3A(unk_0x0FA8183DAD2B3203(), iLocal_147))
	{
		unk_0xECC035CAE5B59E06(unk_0x0FA8183DAD2B3203());
	}
}
...
bool func_244()
{
	if (unk_0xAF4B0945AD382D5D(unk_0x0FA8183DAD2B3203()))
	{
		...
		{
			if (func_234(iLocal_147, unk_0x0FA8183DAD2B3203(), 40f, 1))
			{
				bLocal_158 = true;
			}
			else
		...
		{
			if (func_234(iLocal_147, unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0), 15f, 1))
			{
				bLocal_159 = true;
				unk_0x623942A4F366F9BB(0);
				func_218(0);
...
void func_248()
{
	...
	{
		case 0:
			if (!unk_0xB50E39CA0A3E6020(uLocal_367))
			{
				if (func_350(iLocal_147))
				{
					uLocal_367 = unk_0xF2A54C51C03CADAA(417.533f, -765.23f, 28.41f, 0f, 0f, 12.96f, 2);
					unk_0x8582CCEB95B1F1BE(iLocal_147, uLocal_367, sLocal_145, "lead_out", 1000f, -8f, 1, 16, 1148846080, 0);
				}
			}
			func_236(1);
			iLocal_172 = 0;
		...
		case 1:
			if (unk_0xB50E39CA0A3E6020(uLocal_367))
			{
				...
				if (unk_0x91F0628278985DB8(uLocal_367) > 0.99f)
				{
					iLocal_144 = 2;
				}
			}
...
void func_250()
{
	...
	{
		case 0:
			unk_0xC5982E6B35E11265(417.78f, -765.71f, 29.39f, 40f, 0);
			unk_0xF263AA20D7DC147B(0);
			if (unk_0xF628B2ECEE913E4E())
			{
				if (func_350(unk_0x0FA8183DAD2B3203()))
				{
					func_281(sLocal_369, unk_0x0FA8183DAD2B3203(), 0, 2);
				}
				unk_0xC4E267F66CDE12B7(sLocal_370, 1, 0, 0, 0);
			}
			if (func_274(1, 1093140480, 0))
			{
				unk_0x38F2C110546BD846(iLocal_147, sLocal_370, 0, 0, 0);
				unk_0x38F2C110546BD846(unk_0x0FA8183DAD2B3203(), sLocal_369, 0, 0, 0);
				if (unk_0xD4B321D9096B01FC(Local_81.f_41[0]))
				{
					func_236(0);
					unk_0x38F2C110546BD846(Local_81.f_41[0], "Barrys_Clipboard", 0, 0, 0);
				}
				func_273();
		...
		case 1:
			...
			if (unk_0xDFB741CB32BE818E(sLocal_369, 0))
			{
				unk_0xB300618E39F089F8(unk_0x0FA8183DAD2B3203(), joaat("MotionState_Idle"), 0, 1, 0);
			}
			if (unk_0xDFB741CB32BE818E(sLocal_370, 0))
			{
				if (func_350(iLocal_147))
				{
					uLocal_367 = unk_0xF2A54C51C03CADAA(417.533f, -765.23f, 28.41f, 0f, 0f, 12.96f, 2);
			...
			if (unk_0xD4B321D9096B01FC(Local_81.f_41[0]))
			{
				if (unk_0xDFB741CB32BE818E("Barrys_Clipboard", 0))
				{
					func_236(1);
				}
			}
...
void func_251(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_252(unk_0x0FA8183DAD2B3203()))
	{
...
void func_261()
{
	if (!unk_0xD4B321D9096B01FC(iLocal_152))
	{
		iLocal_152 = unk_0x7187764DB5121FC9(iLocal_155, 416.3885f, -764.8415f, 28.3848f, 1, 1, 0);
	}
	if (unk_0xD4B321D9096B01FC(iLocal_152))
	{
		unk_0xF3D48447FACBBE72(iLocal_152, 0f, 0f, 20f, 2, 1);
	}
}
...
void func_262(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (unk_0xD699DB8EAB756F25(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			unk_0xBB65AAC660EECEA8(func_263(unk_0x7A8732CFB5113E77()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_274(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
	{
		...
		{
			if (!func_279(unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_278(unk_0x0FA8183DAD2B3203(), -828834893))
				{
...
void func_287()
{
	...
	if (iLocal_144 == 0)
	{
		...
		if (!func_460())
		{
			if (func_350(iLocal_147))
			{
				unk_0x5D672CB011E20B28(iLocal_147, sLocal_145, "lead_in", 8f, -8f, -1, 2, 0, 0, 0, 0);
				iLocal_144 = 1;
			}
		}
		else
	...
	else if (iLocal_144 == 1)
	{
		...
		{
			if (!bLocal_161 && (unk_0x42A24CB7B8A08E11(unk_0x0FA8183DAD2B3203(), 415.4781f, -771.7041f, 27.85562f, 415.5606f, -759.9372f, 31.36162f, 7.25f, 0, 1, 0) || func_288()))
			{
				bLocal_161 = true;
				if (func_234(unk_0x0FA8183DAD2B3203(), iLocal_147, 5f, 1))
				{
					bLocal_171 = true;
				}
			}
			if (bLocal_161)
			{
				if (!bLocal_171)
				{
					if (func_288())
					{
						unk_0xFFFB9D39E6C8D02D(iLocal_147, 0f, 0f, 0.5f, 1, 5000, 2000, 2000, 0);
					}
					else
					{
						unk_0xFFFB9D39E6C8D02D(iLocal_147, 0.5f, 0f, 0.5f, 1, 5000, 2000, 2000, 0);
						unk_0x6ED5C852EC8B4D01(35f);
						unk_0x5476CF199D6A8619(0f);
						unk_0x2AAAA86E5F9FA80C(0.35f);
						unk_0x975B7DA1F63360EC(0.2f);
						unk_0x825B331DFF75F2BD(0.01f);
						unk_0x13DD5FDC457B7DBC(1);
					}
				}
				if (func_234(unk_0x0FA8183DAD2B3203(), iLocal_147, 2.5f, 1))
				{
					unk_0x3D0DE925C0536CA0(unk_0x7C7787D2D7139A85(), false, 256);
					unk_0x845704CC8ADF1918(unk_0x0FA8183DAD2B3203(), iLocal_147, 0);
				}
			}
			if (unk_0xF6FD8019402CF03B(iLocal_147, sLocal_145, "lead_in", 3))
			{
				if (iLocal_170 == 0)
				{
				...
				if (unk_0x79825B919DB9FB1C(iLocal_147, sLocal_145, "lead_in") > 0.9f)
				{
					iLocal_144 = 2;
				}
			}
...
void func_289()
{
	if (unk_0xD699DB8EAB756F25(unk_0x7C7787D2D7139A85()) && func_350(iLocal_147))
	{
		unk_0xE5179DA34687BDF7(iLocal_147, 1, unk_0x0FA8183DAD2B3203(), 31086, 0f, 0f, 0f, 0, -1, -1);
		unk_0xE5179DA34687BDF7(unk_0x0FA8183DAD2B3203(), 1, iLocal_147, 31086, 0f, 0f, 0f, 0, -1, -1);
	}
}
...
void func_291()
{
	if (unk_0xD699DB8EAB756F25(unk_0x7C7787D2D7139A85()))
	{
		if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
		{
			if (func_279(unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_298()
{
	...
	if (iLocal_144 == 0)
	{
		...
		iLocal_344[1] = 20000;
		iLocal_344[2] = 7000;
		uLocal_371 = unk_0x79CDB5CF25B388E3(unk_0x0FA8183DAD2B3203());
		unk_0xDB889DCC8B0139E6(iLocal_147, uLocal_371);
		unk_0x1DB66BD2267055C0(iLocal_147, 132, 1);
		unk_0xB0675208A25FD4B5(iLocal_147, 1);
		unk_0x1DB66BD2267055C0(iLocal_147, 185, 1);
		unk_0xACD33DBAF2546FCF(iLocal_147, 0);
		func_306(&uLocal_179, 1, unk_0x0FA8183DAD2B3203(), "FRANKLIN", 0, 1);
		func_306(&uLocal_179, 3, iLocal_147, "BARRY", 0, 1);
		unk_0x9F815D4FA0C47F97("BARY3", 0);
		unk_0x6BB2B1818CAE531E(iLocal_155);
		unk_0x36B659209EBDD366(sLocal_145);
		iLocal_144 = 1;
	}
	if (iLocal_144 == 1)
	{
		if ((unk_0xA3D567B14856EDE1(0) && unk_0x6DF9C43E3CC645BC(iLocal_155)) && unk_0xB25A0D192C6A0A5B(sLocal_145))
		{
			if (func_460())
			{
				switch (func_305())
				{
					case 0:
						...
						if (func_350(iLocal_147))
						{
							uLocal_368 = unk_0xF2A54C51C03CADAA(Local_372, Local_375, 2);
							unk_0x3F8774A014F77C2D(uLocal_368, 1);
							unk_0x8582CCEB95B1F1BE(iLocal_147, uLocal_368, sLocal_145, "barry_3_sit_loop", 1000f, -8f, 0, 0, 1148846080, 0);
						}
						func_261();
...
int func_307()
{
	...
	else if (unk_0xD4B321D9096B01FC(iLocal_147))
	{
		if (unk_0xF4B969E0807E76C7(iLocal_147, 0))
		{
			func_236(0);
			func_325("B3BARRYDEAD");
			return 1;
		}
		else if (unk_0x3656B691E303FDE0(iLocal_147, unk_0x0FA8183DAD2B3203(), 1) || func_324(unk_0x0FA8183DAD2B3203(), iLocal_147, 1))
		{
			unk_0xF0E9590A910B74BE(iLocal_147, unk_0x0FA8183DAD2B3203(), 500f, -1, 0, 0);
			func_236(0);
			func_325("B3BARRYHURT");
			return 1;
		}
		else if (func_308(iLocal_147, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_324(unk_0x0FA8183DAD2B3203(), iLocal_147, 1))
		{
			if (!iLocal_157)
			{
				if ((iLocal_143 == -2 && unk_0xB50E39CA0A3E6020(uLocal_367)) && unk_0x91F0628278985DB8(uLocal_367) < 0.82f)
				{
				}
				else
				{
...
int func_308(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_350(unk_0x0FA8183DAD2B3203()) && func_350(iParam0))
	{
		...
		if (!unk_0x9DCEF22792B5C15C(unk_0x0FA8183DAD2B3203(), 6))
		{
			if (unk_0x132DF66D50A7DE4E(unk_0x0FA8183DAD2B3203()))
			{
				...
				{
					return func_318(unk_0x0FA8183DAD2B3203(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_309(int iParam0, float fParam1)
{
	...
	if (func_350(unk_0x0FA8183DAD2B3203()) && func_350(iParam0))
	{
		if (func_317(iParam0) || unk_0x4412340828EC2614(unk_0x7C7787D2D7139A85(), iParam0))
		{
			if (unk_0x9DCEF22792B5C15C(unk_0x0FA8183DAD2B3203(), 6))
			{
				fVar0 = 40f;
...
{
	return func_311(iParam0, unk_0x0FA8183DAD2B3203(), fParam1, 1, 250, 7);
}
...
int func_322(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_216(Param1 - unk_0xACE5E491FC1B0D37(iParam0, 1)) };
...
{
	if (func_252(iParam0) && unk_0x5294582CE404D3F4(iParam0, 0))
	{
		if (func_252(iParam1))
		{
...
void func_326()
{
	...
	{
		case 0:
			if (unk_0x2553916E420E8EF0(sLocal_142, "DEFAULT"))
			{
				func_476(1);
			}
			else
		...
		case 1:
			...
			else if (!unk_0x9591DE0F00127F2A(sLocal_142))
			{
				if (func_252(iLocal_147))
				{
					if (func_252(unk_0x0FA8183DAD2B3203()) && func_234(unk_0x0FA8183DAD2B3203(), iLocal_147, 15f, 1))
					{
						func_327();
					}
				}
...
{
	if (((!func_345(0) || Global_76846) || Global_76835 == 1) || !unk_0xBF28CCACDDFF5346())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((unk_0x33D7ABC47E81DCF9() || func_296(0)) || func_344(1))
			{
			}
			else
			{
...
{
	unk_0x5A7415845A02A4EB(437.6351f, -747.0594f, 28.4126f, 397.6351f, -787.0594f, 28.4126f, iParam0);
}
...
void func_353(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_151(iParam0) && unk_0xD4B321D9096B01FC(*iParam1)) && unk_0xD960230552BC4165(*iParam1, 0))
	{
		...
		if (unk_0xFE78FB1ABAF99F41(*iParam1) >= 0 && func_358(*iParam1, 0, &uVar0))
		{
...
int func_358(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = unk_0x7F375072508F738F(iParam0);
	if ((!func_385(iVar0, bParam1, uParam2) && !func_384(unk_0x7C7787D2D7139A85())) && !func_368(iParam0))
	{
		return 0;
	}
	if (func_384(unk_0x7C7787D2D7139A85()))
	{
		if (func_367(iVar0))
		{
			return 1;
	...
	bVar1 = false;
	if (func_366(unk_0x7C7787D2D7139A85()) && (unk_0xDC118E11A4081E9A(iVar0) || unk_0x31337ABC07783F10(iVar0)))
	{
		bVar1 = true;
	}
	if (((unk_0x01412376937BFF5B(iParam0) && !func_364(iParam0)) && !bVar1) && !(func_363(unk_0x7F375072508F738F(iParam0)) && func_360(unk_0x7C7787D2D7139A85())))
	{
	...
	if (!unk_0x393E9918BC37548A())
	{
		if ((func_359(iParam0) && unk_0x7F375072508F738F(iParam0) != joaat("sentinel2")) && unk_0x7F375072508F738F(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_383(unk_0x7C7787D2D7139A85()) || func_382(unk_0x7C7787D2D7139A85()))
	{
		if (func_369(iParam0))
		{
			return 1;
...
int func_370(int iParam0)
{
	...
	if (func_371(unk_0x7F375072508F738F(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_372(int iParam0, bool bParam1)
{
	switch (unk_0x7F375072508F738F(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_374(unk_0x7F375072508F738F(iParam0), 0))
			{
...
int func_385(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_366(unk_0x7C7787D2D7139A85()) && (unk_0xDC118E11A4081E9A(iParam0) || unk_0x31337ABC07783F10(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (unk_0xD960230552BC4165(iParam0, 0))
	{
		...
		*uParam1 = unk_0x15573EDB7C261B90(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xA1E7A40E1F56E511(&(uParam1->f_77), func_389(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!unk_0xD4B321D9096B01FC(iParam0) || !unk_0xD960230552BC4165(iParam0, 0)) || func_268(iParam0, 0, 0)) || func_268(iParam0, 1, 0)) || func_268(iParam0, 2, 0)) || func_405(iParam0) != 145) || func_404(iParam0)) || func_403(iParam0)) || func_359(iParam0)) || func_402(iParam0)) || !func_392(unk_0x7F375072508F738F(iParam0)))
	{
		if (func_403(iParam0))
		{
		}
...
int func_409(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_381(unk_0x7F375072508F738F(*uParam0), 1) && unk_0xF05B9E4C6631EA28(*uParam0, 24) != func_412(*uParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xED4CA44675A55548(*uParam0, 24, func_412(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_411(uParam0);
	if (func_410(*uParam0))
	{
...
void func_415(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xD4B321D9096B01FC(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x7F375072508F738F(Global_96030[iVar0]) == func_416(iParam0, iParam1))
				{
...
void func_417(struct<3> Param0, float fParam3, int iParam4)
{
	int iVar0;
...
{
	return func_425(&(Global_105109.f_2890), Param0, fParam3, 0);
}
	...
	if (func_442(uParam0))
	{
		...
		if (func_441(uParam0))
		{
			...
			if (unk_0xD4B321D9096B01FC(iVar0))
			{
				...
				else if ((!func_427(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && unk_0x2553916E420E8EF0(unk_0x0037AFCBDC61F351(), "startup_positioning"))
				{
...
int func_427(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_429(iParam0, uVar1[iVar6], 1) && func_428(unk_0xACE5E491FC1B0D37(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_423(Param1, 0f, 0f, 0f, 0)) || unk_0xD34AF93E9BCF12F0(unk_0xACE5E491FC1B0D37(iParam0, 1), unk_0xACE5E491FC1B0D37(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_430(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (unk_0xD960230552BC4165(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (unk_0xA2BC31158C8CEFD2(uParam1->f_77, func_389(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (unk_0xA2BC31158C8CEFD2(uParam1->f_77, func_389(iVar1 + 1)))
			{
			}
			else
			{
				unk_0xA1E7A40E1F56E511(&(uParam1->f_77), func_389(iVar1 + 1));
			}
		}
		...
		if (((unk_0xA2BC31158C8CEFD2(uParam1->f_77, 15) || func_433(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_432())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!unk_0xDC118E11A4081E9A(uParam1->f_66) && !unk_0x5EA23EAAAD4E34BF(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (unk_0xA2BC31158C8CEFD2(uParam1->f_77, func_389(iVar2 + 1)))
				{
...
int func_434(int iParam0)
{
	if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
	{
		if (!func_440(unk_0x7C7787D2D7139A85(), -1))
		{
	...
	if (func_436(unk_0x7C7787D2D7139A85()) == 3)
	{
		if (unk_0xD4B321D9096B01FC(iParam0) && unk_0xD960230552BC4165(iParam0, 0))
		{
...
int func_450(var uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			{
				if (func_453(&(uParam0->f_28[0]), 49, Var3, fVar6, "RC LAUNCHER: BARRY 3", 1))
				{
			...
			{
				func_451(&(uParam0->f_41[0]), iVar0[1], Var3 + Vector(0f, 0f, 5f), -115.18f);
...
int func_454(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	int iVar0;
...
void func_472(bool bParam0)
{
	...
	{
		func_471(&(uLocal_149[0]));
		func_471(&(uLocal_149[1]));
		func_467(&iLocal_148);
	}
}
