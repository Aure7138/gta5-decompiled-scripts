...
void func_12(int iParam0)
{
	...
	while (iVar15 < Global_112293.f_7686.f_198)
	{
		...
		{
			func_13(Global_112293.f_7686.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_13(int iParam0)
{
	...
	{
		if (func_19(iParam0, Global_19798) == 1)
		{
			func_18(iParam0, Global_19798, 0);
			if (func_17(iParam0, Global_19798) == 0)
			{
				iVar0 = Global_19798;
...
void func_26()
{
	...
	if (unk_0x419E13582192CFEA(unk_0x7D2B9E6A64637269()))
	{
		if (func_29(Global_112293.f_2361.f_539.f_4321) != unk_0x6471F4759775FCA4(unk_0x7D2B9E6A64637269()))
		{
			...
			if (func_10(iVar0) && (!func_27(14) || Global_111244))
			{
