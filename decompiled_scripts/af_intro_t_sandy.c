...
void func_12(int iParam0)
{
	...
	while (iVar15 < Global_112922.f_7688.f_198)
	{
		...
		{
			func_13(Global_112922.f_7688.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
void func_26()
{
	...
	{
		if (func_29(Global_112922.f_2363.f_539.f_4321) != unk_0x15CAA6D7B11F1A7C(unk_0xE2D3D51028F0428A()))
		{
			iVar0 = func_28(unk_0xE2D3D51028F0428A());
			if (func_10(iVar0) && (!func_27(14) || Global_111873))
			{
