		...
		switch (*iParam0)
		{
			...
			case 2:
				if ((unk_0x1DD05E817C89C737() - iParam0->f_6) > iParam0->f_7)
				{
					...
					iParam0->f_9 = (0.5f * unk_0xBBDA792448DB5A89(unk_0xC5935DFB3F39785A(-2, 3)));
...
int func_198(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_132(unk_0x4A8C381C258A124D()) && func_132(iParam0->f_28[0])) && !func_150()) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam8) && func_202(unk_0x4A8C381C258A124D(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_203(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_184(2))
		{
			...
			else if (((func_205(sParam5) && !*uParam10 == 1) && func_132(unk_0x4A8C381C258A124D())) && func_202(unk_0x4A8C381C258A124D(), Param1, 1) >= 20f)
			{
				func_321("pause conversation");
				func_204(1);
				*uParam10 = 1;
			}
			if (func_202(unk_0x4A8C381C258A124D(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var3 = { func_237(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_257(var uParam0, var uParam1)
{
	...
	if (unk_0xFC8BFE4B41177C22(*uParam1) && unk_0x6252BC0DD8A320DB(iLocal_94))
	{
		*uParam0 = unk_0xB1DBFEB95C0EFB88(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, 1, 1);
		...
		fVar6 = (-90f + unk_0xCFC0C995455A6204(*uParam1));
		Var3 = { 0f, 0f, fVar6 };
		unk_0x62C438C53BB57AFD(*uParam0, Var0, 0, 0, 1);
		unk_0xCF39804E8C88080E(*uParam0, Var3, 2, 1);
...
int func_271(var uParam0, var uParam1)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_264(&iVar0) || !unk_0xE100DD4F82A51BDE(uParam0->f_48)) || !unk_0xE100DD4F82A51BDE(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_275(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_264(&iVar0) || !unk_0xE100DD4F82A51BDE(sVar4))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0x10425721983AE158(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x10425721983AE158(0, sVar4, "dexy_stay_there", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x10425721983AE158(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x10425721983AE158(0, sVar4, "price_tag", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x10425721983AE158(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x10425721983AE158(0, sVar4, "such_a_good", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x10425721983AE158(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x10425721983AE158(0, sVar4, "this_looks", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x10425721983AE158(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x10425721983AE158(0, sVar4, "who_would", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
int func_276(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (func_132(uParam0->f_35[0]))
			{
				fVar9 = unk_0x7BFB76C576628F3D(uParam0->f_35[0], 2);
				if (!unk_0x6B0915C0DDD2954F(uParam0->f_35[0], 2) && fVar9 < 0.8f)
				{
					unk_0x3E13A302AA0F06BF(uParam0->f_35[0], 2, 0, 1f);
				}
				else
		...
		case 3:
			if (func_132(uParam0->f_35[0]))
			{
				if (!unk_0x13CCB1AD131C1082(uParam0->f_35[0], sVar8, "idle_speedo", 3))
				{
					if (unk_0xE100DD4F82A51BDE(sVar8))
					{
						unk_0x3D98759970C5FCC9(uParam0->f_35[0], sVar8, "idle_speedo");
						return 0;
					}
					else
					{
			...
			if (func_131(uParam0->f_28[0]))
			{
				...
				unk_0x10425721983AE158(uParam0->f_28[0], sVar8, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			...
			if (func_131(uParam0->f_28[2]))
			{
				...
				if (unk_0xE100DD4F82A51BDE(sVar8))
				{
					unk_0x10425721983AE158(uParam0->f_28[2], sVar8, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
				}
			}
...
int func_280(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			uParam0->f_59 = -1;
			func_267(38, 1);
			uVar9 = unk_0x0556019E7EE8EC9A(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
			if (unk_0xF8A8852F99E201DD(uVar9))
			{
				unk_0xEEC112F70F9E6543(iVar9);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0xEC9DAA34BBB4658C(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x80813AC549A1E8AE(uParam0->f_48);
			iLocal_91 = 1;
		...
		case 2:
			...
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0x55098D9E9AD58806(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x268BE77F77533D03(uParam0->f_48);
			return 1;
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_132(uParam0->f_28[0]) && func_132(uParam0->f_28[1]))
			{
				unk_0xAAA71DD7E9059338(uParam0->f_28[0], 1);
				unk_0xAAA71DD7E9059338(uParam0->f_28[1], 1);
				uVar5 = unk_0x2EC137C692A52458(-1100.558f, 789.8862f, 163.3285f, 0f, 0f, 0f, 2);
				unk_0x3DA436E63AB0F541(uParam0->f_28[0], uVar5, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1148846080, 0);
				unk_0x3DA436E63AB0F541(uParam0->f_28[1], uVar5, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1148846080, 0);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
