...
void __EntryFunction__()
{
	...
	uLocal_92 = func_299(64);
	uLocal_93 = func_299(63);
	...
	if (unk_0x24862A9CDC8F8874(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_100063[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_295(&(Global_100063[Var0.f_0 /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		func_195(Var0.f_0);
		func_188(&iLocal_108, &(Var0.f_9), Var61);
		if (Var0.f_0 == 42)
		{
			if (unk_0x35081E98CA82CBB4())
			{
				unk_0x4C385591266379A9(func_187(), 4, 0, 0, func_186());
				func_296("Nigel 2 : set Di Napoli's cutscene trousers variation in launcher");
			}
		}
		if (func_185(&uLocal_96) && Var0.f_0 == 37)
		{
			func_182(Var0.f_28[1], &uLocal_96, Var0.f_0);
		}
		if (Var0.f_0 == 37)
		{
			func_178(&Var0, Var61, "NIG1AAU", "NIG1A_AMB", 0, "NIGEL", 1, "MRSTHORNHILL", &uLocal_110);
		}
		else if (Var0.f_0 == 42)
		{
...
int func_168(int iParam0)
{
	...
	if (func_111(unk_0xC8B93D94F8954288()))
	{
		...
		{
			if (unk_0x95CCECA3948CFE7B(iParam0->f_28[iVar0]))
			{
				if (func_111(iParam0->f_28[iVar0]))
				{
					if (unk_0x87D4C731B013290A(iParam0->f_28[iVar0], unk_0xC8B93D94F8954288(), 1) || unk_0x0592F98C32AC22CA(unk_0x44C17CCB85A88A1F(iParam0->f_28[iVar0], 1), 7.5f, 1))
					{
						if (func_159(2))
						{
							func_156(iParam0->f_27, *iParam0);
...
{
	if (func_170(uParam1, unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1)))
	{
		if (func_159(2))
		{
			if (func_157(iParam0->f_27))
...
bool func_170(var uParam0, struct<2> Param1, Vector3 vParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_171(int iParam0, var uParam1, var uParam2)
{
	if (func_111(*uParam1))
	{
		...
		{
			case 0:
				if (unk_0xC4C141A321D45FD8("CAR_TRUNK_THUMPS", 0))
				{
					iParam0->f_1 = unk_0x83E9D86E63672B9A();
					iParam0->f_2 = unk_0x693EBB4F13506457();
					iParam0->f_3 = unk_0x531444754C426278(6000, 12000);
					*iParam0 = 1;
				}
				break;
			
			case 1:
				if ((unk_0x693EBB4F13506457() - iParam0->f_2) > iParam0->f_3)
				{
					unk_0xE55275772E833643(iParam0->f_1, "TRUNK_THUMPS", unk_0xCC31DB73C65552D8(*uParam1, 0f, -2.2f, 0.5f), 0, 0, 0, 0);
					unk_0x7033366221CC71C6(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_172(0), 0);
					iParam0->f_4 = unk_0x531444754C426278(3, 7);
					iParam0->f_5 = 0;
					iParam0->f_6 = unk_0x693EBB4F13506457();
					iParam0->f_7 = unk_0x531444754C426278(100, 250);
					*iParam0 = 2;
				}
				break;
			
			case 2:
				if ((unk_0x693EBB4F13506457() - iParam0->f_6) > iParam0->f_7)
				{
					iParam0->f_8 = unk_0x531444754C426278(-200, -120);
					iParam0->f_9 = (0.5f * unk_0xBBDA792448DB5A89(unk_0x531444754C426278(-2, 3)));
					unk_0x3A2304A561B7D162(*uParam1, 1, 0f, 0f, IntToFloat(iParam0->f_8), iParam0->f_9, -1.5f, 0f, 0, 1, 1, 0, 1, 1);
					iParam0->f_5++;
					if (iParam0->f_5 < iParam0->f_4)
					{
						iParam0->f_6 = unk_0x693EBB4F13506457();
						iParam0->f_7 = unk_0x531444754C426278(150, 280);
					}
					else
					{
						iParam0->f_2 = unk_0x693EBB4F13506457();
...
int func_173(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_111(unk_0xC8B93D94F8954288()) && func_111(iParam0->f_28[0])) && !func_128()) && (unk_0x693EBB4F13506457() - iParam0->f_60) > iParam8) && func_177(unk_0xC8B93D94F8954288(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_178(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	var uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_159(2))
		{
			if (!func_128())
			{
				if (((func_111(unk_0xC8B93D94F8954288()) && func_111(iParam0->f_28[0])) && func_111(iParam0->f_28[1])) && func_177(unk_0xC8B93D94F8954288(), Param1, 1) < 20f)
				{
			...
			else if (((func_180(sParam5) && !*uParam10 == 1) && func_111(unk_0xC8B93D94F8954288())) && func_177(unk_0xC8B93D94F8954288(), Param1, 1) >= 20f)
			{
				func_296("pause conversation");
				func_179(1);
				*uParam10 = 1;
			}
			if (func_177(unk_0xC8B93D94F8954288(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
int func_196(var uParam0, bool bParam1)
{
	...
	if ((func_229(*uParam0) || func_227(*uParam0)) || Global_69562 == 1)
	{
		return 1;
	}
	if (!unk_0xCAA967E16BBE69CE())
			...
			if (unk_0x95CCECA3948CFE7B(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_201(unk_0xC8B93D94F8954288(), uParam0->f_35[iVar0]))
							{
...
int func_204(int iParam0, float fParam1)
{
	...
	{
		if (func_215(iParam0) || unk_0x0BBFEAC55291063A(unk_0xA34E7C2A5118D638(), iParam0))
		{
...
{
	return func_206(iParam0, unk_0xC8B93D94F8954288(), fParam1, 1, 250, 7);
}
...
bool func_206(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_207(&(Local_49[iVar4 /*4*/]), Var1, iParam1, &(Local_49[iVar4 /*4*/].f_3), iParam0, iParam5);
...
int func_210(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_212(unk_0x44C17CCB85A88A1F(iParam1, 1) - unk_0x44C17CCB85A88A1F(iParam0, 1)) };
	...
	{
		Var3 = { func_212(unk_0xB867FC7DBA46C0F1(iParam0, 31086, 0f, 5f, 0f) - unk_0xB867FC7DBA46C0F1(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_219(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_212(Param1 - unk_0x44C17CCB85A88A1F(uParam0, 1)) };
...
{
	if ((func_228() && Global_91106.f_11 == 6) && iParam0 == func_146(&(Global_91106.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_231(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				func_233(&(uParam0->f_35[0]), iLocal_95, -39.9688f, -1285.962f, 28.3505f, 181.02f);
				if (func_111(uParam0->f_35[0]))
				{
					unk_0x46E519A001AC83B2(uParam0->f_35[0], 65, 0);
					unk_0xF94FAE1326F14E1F(uParam0->f_35[0], 5, 0);
					unk_0x673B8FB2A362DAB5(uParam0->f_35[0], "28BNT310");
					unk_0x6C4F5FC03FDA2437(uParam0->f_35[0], 0);
					unk_0x0782F0CAEA719452(uParam0->f_35[0], 10);
					unk_0x1A2A10C43488E28D(uParam0->f_35[0], 0);
...
int func_232(var uParam0, var uParam1)
{
	...
	if (unk_0x95CCECA3948CFE7B(*uParam1) && unk_0x0845149A26DABBA5(iLocal_94))
	{
		*uParam0 = unk_0x71DD988C1B903F5D(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, 1, 1);
		unk_0x64B2BC184771BDA3(*uParam0, "NI3_LNCH_CELEB");
		unk_0x8C245572EDB27776(*uParam0, 4, 0, 0, 0);
		unk_0xAAD662D7E0D59F4C(*uParam0, 1);
		Var0 = { unk_0xCC31DB73C65552D8(*uParam1, -0.2f, -1.8f, -1f) };
		fVar6 = (-90f + unk_0x59DD203239FBDCAD(*uParam1));
		Var3 = { 0f, 0f, fVar6 };
		unk_0x636EE5A38E3EB8FF(*uParam0, Var0, 0, 0, 1);
		unk_0x68931E8B45B3CA92(*uParam0, Var3, 2, 1);
		unk_0xAD318582A32CA5D2(*uParam0, *uParam1, 0, 0.2f, -1.8f, 0f, 0f, 0f, 90f, 0, 0, 0, 0, 2, 1);
...
void func_233(var uParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_234(uParam0);
...
int func_236(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_240(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_241(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x95CCECA3948CFE7B(uParam0->f_35[0]))
			{
				func_233(&(uParam0->f_35[0]), iLocal_95, -1304.01f, -644.58f, 25.91f, 127.67f);
				if (func_111(uParam0->f_35[0]))
				{
					unk_0x46E519A001AC83B2(uParam0->f_35[0], 65, 0);
					unk_0xF94FAE1326F14E1F(uParam0->f_35[0], 5, 0);
			...
			if (!unk_0x95CCECA3948CFE7B(uParam0->f_35[1]))
			{
				...
				{
					unk_0x46E519A001AC83B2(uParam0->f_35[1], 0, 0);
					unk_0x0782F0CAEA719452(uParam0->f_35[1], 10);
				}
			}
			if (bVar5)
			{
...
int func_246(var uParam0, var uParam1)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_239(&iVar0) || !unk_0xF9B86DC1728F1339(uParam0->f_48)) || !unk_0xF9B86DC1728F1339(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0x9982920999FF4733(uParam0->f_28[0], 0, 0, 0, 0);
...
int func_250(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_239(&iVar0) || !unk_0xF9B86DC1728F1339(sVar4))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0x5323F488E6A1B660(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5323F488E6A1B660(0, sVar4, "dexy_stay_there", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5323F488E6A1B660(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5323F488E6A1B660(0, sVar4, "price_tag", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5323F488E6A1B660(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5323F488E6A1B660(0, sVar4, "such_a_good", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5323F488E6A1B660(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5323F488E6A1B660(0, sVar4, "this_looks", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5323F488E6A1B660(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5323F488E6A1B660(0, sVar4, "who_would", 8f, -8f, -1, 0, 0, 0, 0, 0);
	...
	switch (iLocal_91)
	{
		...
		case 2:
			if (!unk_0x95CCECA3948CFE7B(uParam0->f_35[0]))
			{
				...
				{
					unk_0xF18809B65D87E197(uParam0->f_35[0]);
					unk_0x46E519A001AC83B2(uParam0->f_35[0], 97, 97);
					unk_0xCBA56A0CB9A36919(uParam0->f_35[0], 13.5f);
					unk_0xF94FAE1326F14E1F(uParam0->f_35[0], 2, 0);
					unk_0x8619CDF424980CF9(uParam0->f_35[0], 2, 0, 1);
					unk_0x90C5C985D97A0D33(uParam0->f_35[0], 2, 0, 1f);
					unk_0x7ABC16BB2DEF73E6(uParam0->f_35[0]);
					return 0;
				}
			}
			if (func_111(uParam0->f_35[0]))
			{
				fVar9 = unk_0xBEF21CF3DCA0E59B(uParam0->f_35[0], 2);
				if (!unk_0x3500BEF26479E0EB(uParam0->f_35[0], 2) && fVar9 < 0.8f)
				{
					unk_0x90C5C985D97A0D33(uParam0->f_35[0], 2, 0, 1f);
				}
				else
		...
		case 3:
			if (func_111(uParam0->f_35[0]))
			{
				if (!unk_0xCD61E9D5CABC7E35(uParam0->f_35[0], sVar8, "idle_speedo", 3))
				{
					if (unk_0xF9B86DC1728F1339(sVar8))
					{
						unk_0x30484045C1242373(uParam0->f_35[0], sVar8, "idle_speedo");
						return 0;
					}
					else
					{
			...
			if (func_111(uParam0->f_35[1]))
			{
				unk_0x46E519A001AC83B2(uParam0->f_35[1], 27, 27);
			}
			func_253(&(uParam0->f_28[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			if (func_110(uParam0->f_28[0]))
			{
				unk_0x9880BAA7286E1072(uParam0->f_28[0], 0);
				unk_0x636EE5A38E3EB8FF(uParam0->f_28[0], -1054.7f, 355.94f, 68.35f, 0, 0, 1);
				unk_0x765E3FA65D011F03(uParam0->f_28[0], 23.67f);
				unk_0x5323F488E6A1B660(uParam0->f_28[0], sVar8, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			...
			if (func_110(uParam0->f_28[1]))
			{
				...
				unk_0x8C245572EDB27776(uParam0->f_28[1], 3, 0, 2, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[1], 4, 0, 0, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[1], 8, 0, 1, 0);
				unk_0x9880BAA7286E1072(uParam0->f_28[1], 0);
				uParam0->f_59 = unk_0x0B15BB6DFB729046(-1059f, 360.976f, 69f, 0f, 0f, -1.08f, 2);
				unk_0x53DDB73894A6597A(uParam0->f_59, 1);
				unk_0x4528D7AA6C2BEF06(uParam0->f_59, 0);
				unk_0xA5666A46C1079EFE(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "base_girl", 1000f, -8f, 592, 0, 1148846080, 0);
			}
			func_253(&(uParam0->f_28[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			if (func_110(uParam0->f_28[2]))
			{
				unk_0x9AA5A07C66C84468(uParam0->f_28[2]);
				unk_0x636EE5A38E3EB8FF(uParam0->f_28[2], -1012.57f, 357.48f, 70.62f, 0, 0, 1);
				unk_0xFE93132CC8944C8C(uParam0->f_28[2], 160);
				if (unk_0xF9B86DC1728F1339(sVar8))
				{
					unk_0x5323F488E6A1B660(uParam0->f_28[2], sVar8, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
				}
			}
			func_252(&(uParam0->f_41[0]), iVar0[5], -1050.03f, 368.95f, 69.29f, -11.27f);
			if (func_111(uParam0->f_41[0]))
			{
				unk_0x68931E8B45B3CA92(uParam0->f_41[0], 0f, 0f, -11.27f, 2, 1);
				unk_0xBC4E8EDD8046417B(uParam0->f_41[0], 0);
				unk_0xEE6504C7ECC425AB(uParam0->f_41[0], 1);
				unk_0x6FF2818EA5F19F45(uParam0->f_41[0], 0);
			...
			unk_0x3ECF1E41E6ED71D8(uParam0->f_48);
			unk_0x3ECF1E41E6ED71D8(sVar8);
			return 1;
			break;
	}
	return 0;
...
void func_252(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_198(uParam0);
...
int func_255(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			uParam0->f_59 = -1;
			func_242(38, 1);
			uVar9 = unk_0x4C910D0CCCE65059(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
			if (unk_0x8F89BA1339F45476(uVar9))
			{
				unk_0x516F18DCAD064077(iVar9);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0x7567CEA8E6B5340B(iVar0[iVar8]);
				iVar8++;
			}
			unk_0xC0E8B67A4385D37D(uParam0->f_48);
			iLocal_91 = 1;
		...
		case 1:
			if (!func_239(&iVar0) || !unk_0xF9B86DC1728F1339(uParam0->f_48))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_110(uParam0->f_28[1]))
			{
				unk_0x58F516BB5E324590(uParam0->f_28[1], 0);
				unk_0x8C245572EDB27776(uParam0->f_28[1], 0, 1, 0, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[1], 2, 0, 2, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[1], 3, 1, 2, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[1], 4, 0, 1, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[1], 7, 0, 1, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[1], 8, 1, 0, 0);
			}
			uParam0->f_59 = unk_0x0B15BB6DFB729046(-552.18f, 285.476f, 81.976f, 0f, 0f, 79.5f, 2);
			unk_0x53DDB73894A6597A(uParam0->f_59, 1);
			unk_0x4528D7AA6C2BEF06(uParam0->f_59, 0);
			if (func_110(uParam0->f_28[0]))
			{
				unk_0xA5666A46C1079EFE(uParam0->f_28[0], uParam0->f_59, uParam0->f_48, "BASE_02_Willie", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			if (func_110(uParam0->f_28[1]))
			{
				unk_0xA5666A46C1079EFE(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "BASE_02_GIRL", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			...
			if (func_110(uParam0->f_28[2]))
			{
				...
				unk_0x8C245572EDB27776(uParam0->f_28[2], 2, 1, 2, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[2], 3, 1, 1, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[2], 4, 1, 0, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[2], 7, 1, 0, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[2], 8, 1, 0, 0);
			}
			if (func_110(uParam0->f_28[3]))
			{
				unk_0x8C245572EDB27776(uParam0->f_28[3], 0, 1, 1, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[3], 2, 1, 0, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[3], 3, 1, 0, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[3], 4, 1, 1, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[3], 7, 1, 0, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[3], 8, 1, 0, 0);
			}
			if (func_110(uParam0->f_28[4]))
			{
				unk_0x8C245572EDB27776(uParam0->f_28[4], 0, 0, 0, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[4], 2, 0, 2, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[4], 3, 0, 0, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[4], 4, 0, 1, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[4], 8, 0, 0, 0);
			}
			if (func_110(uParam0->f_28[5]))
			{
				unk_0x8C245572EDB27776(uParam0->f_28[5], 0, 1, 0, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[5], 2, 2, 0, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[5], 3, 0, 3, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[5], 4, 1, 0, 0);
				unk_0x8C245572EDB27776(uParam0->f_28[5], 8, 0, 2, 0);
			}
			...
			if (func_111(uParam0->f_35[0]))
			{
				...
				unk_0x6FF2818EA5F19F45(uParam0->f_35[0], 0);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0x4BBD72565A0AF033(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x3ECF1E41E6ED71D8(uParam0->f_48);
			return 1;
...
int func_263(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_240(&uLocal_96, "rcmnigel1", "base_mrs_thornhill", "base_mrs_thornhill");
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0x95CCECA3948CFE7B(uParam0->f_35[0]))
			{
				func_233(&(uParam0->f_35[0]), iLocal_95, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
				if (func_111(uParam0->f_35[0]))
				{
					unk_0x46E519A001AC83B2(uParam0->f_35[0], 65, 0);
					unk_0xF94FAE1326F14E1F(uParam0->f_35[0], 5, 0);
		...
		case 3:
			if (func_111(uParam0->f_28[0]) && func_111(uParam0->f_28[1]))
			{
				unk_0xAAD662D7E0D59F4C(uParam0->f_28[0], 1);
				unk_0xAAD662D7E0D59F4C(uParam0->f_28[1], 1);
				uVar5 = unk_0x0B15BB6DFB729046(-1100.558f, 789.8862f, 163.3285f, 0f, 0f, 0f, 2);
				unk_0xA5666A46C1079EFE(uParam0->f_28[0], uVar5, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1148846080, 0);
				unk_0xA5666A46C1079EFE(uParam0->f_28[1], uVar5, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1148846080, 0);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_277(int iParam0, int iParam1, bool bParam2)
{
	...
	if (unk_0x6B4865E08E90ACC5(uLocal_109))
	{
		unk_0x5356E82C1E5E0C44(&uLocal_109);
	}
	if (bParam2)
	{
	...
	switch (*iParam0)
	{
		case 43:
			if (iParam1->f_1 != -1)
			{
				unk_0x279EB90079F76860(iParam1->f_1);
			}
			break;
	}
...
void func_292(var uParam0)
{
	if (unk_0xBC6B93737FCDC466(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[1]))
		{
			...
			unk_0x20D399098E17A191(uParam0->f_28[1], -1000f, 1);
		}
	}
}
