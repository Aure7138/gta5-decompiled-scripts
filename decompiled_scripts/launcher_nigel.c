...
void __EntryFunction__()
{
	...
	uLocal_92 = func_300(64);
	uLocal_93 = func_300(63);
	...
	if (unk_0x9CEB376419A71A96(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_100273[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_296(&(Global_100273[Var0.f_0 /*10*/].f_9));
			}
		}
		func_278(&Var0, &Var116, 1);
	}
	if (!func_275(&iVar126, &Var0, Var61, 1f))
	{
		func_274();
	...
	while (true)
	{
		...
		func_196(Var0.f_0);
		func_189(&iLocal_108, &(Var0.f_9), Var61);
		if (Var0.f_0 == 42)
		{
			if (unk_0xC93DEE57F8E20436())
			{
				unk_0x76F779008A3C18B4(func_188(), 4, 0, 0, func_187());
				func_297("Nigel 2 : set Di Napoli's cutscene trousers variation in launcher");
			}
		}
		if (func_186(&uLocal_96) && Var0.f_0 == 37)
		{
			func_183(Var0.f_28[1], &uLocal_96, Var0.f_0);
		}
		if (Var0.f_0 == 37)
		{
			func_179(&Var0, Var61, "NIG1AAU", "NIG1A_AMB", 0, "NIGEL", 1, "MRSTHORNHILL", &uLocal_110);
		}
		else if (Var0.f_0 == 42)
		{
			func_174(&Var0, Var61, "NIG2AUD", "NIG2_AMB", 4, "NIGEL", 5000, 14f);
		}
		else if (Var0.f_0 == 43)
		{
			func_172(&Var116, &(Var0.f_35[0]), &(Var0.f_28[1]));
			func_174(&Var0, -44.75f, -1289.86f, 29.16f, "NIGE3AU", "NIGEL3_AMB", 4, "NIGEL", 8000, 1101004800);
		}
		bVar134 = false;
		if (Var0.f_0 == 41)
		{
			if (func_170(&Var0, &uVar64) || func_169(&Var0))
			{
				bVar134 = true;
			}
		}
		else if (func_154(&Var0, 0))
		{
			bVar134 = true;
		}
		if (bVar134)
...
int func_169(int iParam0)
{
	...
	if (func_111(unk_0x06736567F820A39E()))
	{
		...
		{
			if (unk_0xC1EDB61CE0A4B94E(iParam0->f_28[iVar0]))
			{
				if (func_111(iParam0->f_28[iVar0]))
				{
					if (unk_0x1D58D319587D567F(iParam0->f_28[iVar0], unk_0x06736567F820A39E(), 1) || unk_0xDECA6CE314913AC1(unk_0xF4745590D18D14B8(iParam0->f_28[iVar0], 1), 7.5f, 1))
					{
						if (func_160(2))
						{
							func_157(iParam0->f_27, *iParam0);
						...
						{
							func_297("Player damaged the N1D peds but it's not safe to trigger the mission!");
						}
					}
				}
				else if (func_160(2))
				...
				{
					func_297("Player killed a N1D ped but it's not safe to trigger the mission!");
				}
			}
			iVar0++;
		}
...
{
	if (func_171(uParam1, unk_0xF4745590D18D14B8(unk_0x06736567F820A39E(), 1)))
	{
		if (func_160(2))
		{
			if (func_158(iParam0->f_27))
...
bool func_171(var uParam0, struct<2> Param1, Vector3 vParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_172(int iParam0, var uParam1, var uParam2)
{
	if (func_111(*uParam1))
	{
		...
		{
			case 0:
				if (unk_0x63BA14E731F141F2("CAR_TRUNK_THUMPS", 0, -1))
				{
					iParam0->f_1 = unk_0xD619EBCC6AD6E414();
					iParam0->f_2 = unk_0x1ADBAAC322D61F73();
					iParam0->f_3 = unk_0xA6055C735E3DD877(6000, 12000);
					*iParam0 = 1;
				}
				break;
			
			case 1:
				if ((unk_0x1ADBAAC322D61F73() - iParam0->f_2) > iParam0->f_3)
				{
					unk_0x2299DE0D50444F5B(iParam0->f_1, "TRUNK_THUMPS", unk_0xF42E2289B33D5C38(*uParam1, 0f, -2.2f, 0.5f), 0, 0, 0, 0);
					unk_0x00BD2542D40FB0C9(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_173(0), 0);
					iParam0->f_4 = unk_0xA6055C735E3DD877(3, 7);
					iParam0->f_5 = 0;
					iParam0->f_6 = unk_0x1ADBAAC322D61F73();
					iParam0->f_7 = unk_0xA6055C735E3DD877(100, 250);
					*iParam0 = 2;
				}
				break;
			
			case 2:
				if ((unk_0x1ADBAAC322D61F73() - iParam0->f_6) > iParam0->f_7)
				{
					iParam0->f_8 = unk_0xA6055C735E3DD877(-200, -120);
					iParam0->f_9 = (0.5f * unk_0xBBDA792448DB5A89(unk_0xA6055C735E3DD877(-2, 3)));
					unk_0x5DEA7ABDE35AF820(*uParam1, 1, 0f, 0f, IntToFloat(iParam0->f_8), iParam0->f_9, -1.5f, 0f, 0, 1, 1, 0, 1, 1);
					iParam0->f_5++;
					if (iParam0->f_5 < iParam0->f_4)
					{
						iParam0->f_6 = unk_0x1ADBAAC322D61F73();
						iParam0->f_7 = unk_0xA6055C735E3DD877(150, 280);
					}
					else
					{
						iParam0->f_2 = unk_0x1ADBAAC322D61F73();
...
int func_174(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_111(unk_0x06736567F820A39E()) && func_111(iParam0->f_28[0])) && !func_129()) && (unk_0x1ADBAAC322D61F73() - iParam0->f_60) > iParam8) && func_178(unk_0x06736567F820A39E(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_179(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	var uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_160(2))
		{
			if (!func_129())
			{
				if (((func_111(unk_0x06736567F820A39E()) && func_111(iParam0->f_28[0])) && func_111(iParam0->f_28[1])) && func_178(unk_0x06736567F820A39E(), Param1, 1) < 20f)
				{
					...
					{
						func_177(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
						func_177(&uVar0, iParam8, iParam0->f_28[1], sParam9, 0, 1);
						func_175(&uVar0, cParam4, sParam5, 7, 0, 0);
						*uParam10 = 2;
					}
					else if (*uParam10 == 2)
			...
			else if (((func_181(sParam5) && !*uParam10 == 1) && func_111(unk_0x06736567F820A39E())) && func_178(unk_0x06736567F820A39E(), Param1, 1) >= 20f)
			{
				func_297("pause conversation");
				func_180(1);
				*uParam10 = 1;
			}
			if (func_178(unk_0x06736567F820A39E(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
int func_197(var uParam0, bool bParam1)
{
	...
	if ((func_230(*uParam0) || func_228(*uParam0)) || Global_69766 == 1)
	{
		return 1;
	}
	if (!unk_0x920167EE0888FA4E())
			...
			if (unk_0xC1EDB61CE0A4B94E(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_202(unk_0x06736567F820A39E(), uParam0->f_35[iVar0]))
							{
...
int func_205(int iParam0, float fParam1)
{
	...
	{
		if (func_216(iParam0) || unk_0x225B26AE60B121A0(unk_0xE0BDAFA1A39552D6(), iParam0))
		{
...
{
	return func_207(iParam0, unk_0x06736567F820A39E(), fParam1, 1, 250, 7);
}
...
bool func_207(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_208(&(Local_49[iVar4 /*4*/]), Var1, iParam1, &(Local_49[iVar4 /*4*/].f_3), iParam0, iParam5);
...
int func_211(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_213(unk_0xF4745590D18D14B8(iParam1, 1) - unk_0xF4745590D18D14B8(iParam0, 1)) };
	...
	{
		Var3 = { func_213(unk_0xB90C4C04BACF96A1(iParam0, 31086, 0f, 5f, 0f) - unk_0xB90C4C04BACF96A1(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_220(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_213(Param1 - unk_0xF4745590D18D14B8(uParam0, 1)) };
...
{
	if ((func_229() && Global_91310.f_11 == 6) && iParam0 == func_147(&(Global_91310.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_232(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_241(&(uParam0->f_48), "rcmnigel3", "base", 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_240(&iVar0) || !func_239(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				if (!func_236(&(uParam0->f_28[0]), 64, -44.6f, -1289.86f, 29.16f, 22.9f, "RC NIGEL", 1))
				{
					bVar5 = false;
				}
			}
			...
			{
				func_234(&(uParam0->f_35[0]), iLocal_95, -39.9688f, -1285.962f, 28.3505f, 181.02f);
				if (func_111(uParam0->f_35[0]))
				{
					unk_0x22984397339DE6D1(uParam0->f_35[0], 65, 0);
					unk_0x51C0D2C5E7CCC540(uParam0->f_35[0], 5, 0);
					unk_0x2D6C9BA99459C01C(uParam0->f_35[0], "28BNT310");
					unk_0xC8A930DCA124A85E(uParam0->f_35[0], 0);
					unk_0x818E8D7BA45E01E7(uParam0->f_35[0], 10);
					unk_0x90D3858DD0B148C4(uParam0->f_35[0], 0);
					unk_0x1FA3FA93BAAC64F0(uParam0->f_35[0], 0);
					unk_0x89FEA50F04D34AD7(uParam0->f_35[0], 0);
				}
			}
			if (!func_233(&(uParam0->f_28[1]), &(uParam0->f_35[0])))
			{
				bVar5 = false;
			}
			if (bVar5)
...
int func_233(var uParam0, var uParam1)
{
	...
	if (unk_0xC1EDB61CE0A4B94E(*uParam1) && unk_0x5C9FE32E2FF37989(iLocal_94))
	{
		*uParam0 = unk_0xB500796AAD639F82(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, 1, 1);
		unk_0xE7065A6CD6FEB3A6(*uParam0, "NI3_LNCH_CELEB");
		unk_0x47222A663B914109(*uParam0, 4, 0, 0, 0);
		unk_0xBA63517ADBC1E5E3(*uParam0, 1);
		Var0 = { unk_0xF42E2289B33D5C38(*uParam1, -0.2f, -1.8f, -1f) };
		fVar6 = (-90f + unk_0x3CAD22C2D36A7F14(*uParam1));
		Var3 = { 0f, 0f, fVar6 };
		unk_0x7C15BF0B58B608BA(*uParam0, Var0, 0, 0, 1);
		unk_0x5C5B23A2682A1514(*uParam0, Var3, 2, 1);
		unk_0x4819029CE8AA1780(*uParam0, *uParam1, 0, 0.2f, -1.8f, 0f, 0f, 0f, 90f, 0, 0, 0, 0, 2, 1);
...
int func_237(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_241(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_242(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_243(42, 1);
			func_241(&(uParam0->f_48), "rcmnigel2", "base_nigel", "base_nigel");
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
				unk_0xBECC89ACB4E5D4ED(iVar0[iVar4]);
		...
		case 2:
			...
			if (!unk_0xC1EDB61CE0A4B94E(uParam0->f_28[0]))
			{
				if (!func_236(&(uParam0->f_28[0]), 64, -1310.65f, -640.17f, 26.52f, 153.43f, "RC NIGEL", 1))
				{
					bVar5 = false;
				}
			}
			if (!unk_0xC1EDB61CE0A4B94E(uParam0->f_35[0]))
			{
				func_234(&(uParam0->f_35[0]), iLocal_95, -1304.01f, -644.58f, 25.91f, 127.67f);
				if (func_111(uParam0->f_35[0]))
				{
					unk_0x22984397339DE6D1(uParam0->f_35[0], 65, 0);
					unk_0x51C0D2C5E7CCC540(uParam0->f_35[0], 5, 0);
			...
			{
				func_234(&(uParam0->f_35[1]), iVar0[2], -1290.73f, -634.603f, 26.1004f, 126.961f);
				if (func_111(uParam0->f_35[1]))
				{
					unk_0x22984397339DE6D1(uParam0->f_35[1], 0, 0);
					unk_0x818E8D7BA45E01E7(uParam0->f_35[1], 10);
				}
			}
			if (bVar5)
			{
...
int func_247(var uParam0, var uParam1)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_250(uParam1);
			func_249(uParam1, -1313.714f, -27.2202f, 48.0314f);
			func_249(uParam1, -1294.066f, -27.0136f, 47.5724f);
			func_249(uParam1, -1069.844f, -143.769f, 39.7493f);
			func_249(uParam1, -925.2529f, -89.9079f, 38.3457f);
			func_249(uParam1, -1010.948f, 40.0643f, 49.9277f);
			func_249(uParam1, -1122.838f, 233.7037f, 64.7587f);
			func_249(uParam1, -1282.578f, 188.8798f, 59.2769f);
			func_249(uParam1, -1328.153f, 192.0178f, 57.8136f);
			func_249(uParam1, -1386.75f, 167.32f, 57.11f);
			func_249(uParam1, -1411.5f, 109.64f, 51.49f);
			func_249(uParam1, -1379.52f, 111.05f, 54.28f);
			func_249(uParam1, -1371.77f, 24.07f, 52.88f);
			func_249(uParam1, -1342.27f, 16.92f, 52.16f);
			func_248(uParam1);
			iVar9 = 0;
			while (iVar9 <= (iVar0 - 1))
			{
		...
		case 1:
			if ((!func_240(&iVar0) || !unk_0x7B43775D6E0D7325(uParam0->f_48)) || !unk_0x7B43775D6E0D7325(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0x08660D6522AC2288(uParam0->f_28[0], 0, 0, 0, 0);
...
int func_251(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_240(&iVar0) || !unk_0x7B43775D6E0D7325(sVar4))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0x28B5966B12DC5B0F(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x28B5966B12DC5B0F(0, sVar4, "dexy_stay_there", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x28B5966B12DC5B0F(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x28B5966B12DC5B0F(0, sVar4, "price_tag", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x28B5966B12DC5B0F(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x28B5966B12DC5B0F(0, sVar4, "such_a_good", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x28B5966B12DC5B0F(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x28B5966B12DC5B0F(0, sVar4, "this_looks", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x28B5966B12DC5B0F(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x28B5966B12DC5B0F(0, sVar4, "who_would", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
int func_252(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			if (!unk_0xC1EDB61CE0A4B94E(uParam0->f_35[0]))
			{
				func_234(&(uParam0->f_35[0]), iVar0[3], -1010.97f, 359.91f, 70.65f, 331.46f);
				if (func_111(uParam0->f_35[0]))
				{
					unk_0xCE889B96E78E6DC5(uParam0->f_35[0]);
					unk_0x22984397339DE6D1(uParam0->f_35[0], 97, 97);
					unk_0x327BBF9465E5CF74(uParam0->f_35[0], 13.5f);
					unk_0x51C0D2C5E7CCC540(uParam0->f_35[0], 2, 0);
					unk_0xFAE5DD72895807B1(uParam0->f_35[0], 2, 0, 1);
					unk_0x07F9E7A373EE431B(uParam0->f_35[0], 2, 0, 1f);
					unk_0x4AD9DD3DDE71D980(uParam0->f_35[0]);
					return 0;
				}
			}
			if (func_111(uParam0->f_35[0]))
			{
				fVar9 = unk_0xFC47A7E8D708D117(uParam0->f_35[0], 2);
				if (!unk_0xDED24504E85C2660(uParam0->f_35[0], 2) && fVar9 < 0.8f)
				{
					unk_0x07F9E7A373EE431B(uParam0->f_35[0], 2, 0, 1f);
				}
				else
		...
		case 3:
			if (func_111(uParam0->f_35[0]))
			{
				if (!unk_0x46E9388908C80483(uParam0->f_35[0], sVar8, "idle_speedo", 3))
				{
					if (unk_0x7B43775D6E0D7325(sVar8))
					{
						unk_0x3BDE9CF4745B4597(uParam0->f_35[0], sVar8, "idle_speedo");
						return 0;
					}
					else
					{
			...
			func_234(&(uParam0->f_35[1]), iVar0[4], -1018.26f, 357.76f, 70.2f, 339.52f);
			if (func_111(uParam0->f_35[1]))
			{
				unk_0x22984397339DE6D1(uParam0->f_35[1], 27, 27);
			}
			func_254(&(uParam0->f_28[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			if (func_110(uParam0->f_28[0]))
			{
				unk_0xEDA1E7EBC96811E2(uParam0->f_28[0], 0);
				unk_0x7C15BF0B58B608BA(uParam0->f_28[0], -1054.7f, 355.94f, 68.35f, 0, 0, 1);
				unk_0xEF32567B3A5047F5(uParam0->f_28[0], 23.67f);
				unk_0x28B5966B12DC5B0F(uParam0->f_28[0], sVar8, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			func_254(&(uParam0->f_28[1]), iVar0[1], -1058.43f, 362.78f, 69.86f, 130.45f, 26);
			if (func_110(uParam0->f_28[1]))
			{
				unk_0x47222A663B914109(uParam0->f_28[1], 0, 0, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[1], 2, 0, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[1], 3, 0, 2, 0);
				unk_0x47222A663B914109(uParam0->f_28[1], 4, 0, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[1], 8, 0, 1, 0);
				unk_0xEDA1E7EBC96811E2(uParam0->f_28[1], 0);
				uParam0->f_59 = unk_0x70D62E1C98FBC411(-1059f, 360.976f, 69f, 0f, 0f, -1.08f, 2);
				unk_0x58E3D20EAF3A6C20(uParam0->f_59, 1);
				unk_0xF0B400EA537067E0(uParam0->f_59, 0);
				unk_0x13F17EF7A260536D(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "base_girl", 1000f, -8f, 592, 0, 1148846080, 0);
			}
			func_254(&(uParam0->f_28[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			if (func_110(uParam0->f_28[2]))
			{
				unk_0x6DF76F53F418FB2D(uParam0->f_28[2]);
				unk_0x7C15BF0B58B608BA(uParam0->f_28[2], -1012.57f, 357.48f, 70.62f, 0, 0, 1);
				unk_0xEC337F42DFBAD859(uParam0->f_28[2], 160);
				if (unk_0x7B43775D6E0D7325(sVar8))
				{
					unk_0x28B5966B12DC5B0F(uParam0->f_28[2], sVar8, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
				}
			}
			func_253(&(uParam0->f_41[0]), iVar0[5], -1050.03f, 368.95f, 69.29f, -11.27f);
			if (func_111(uParam0->f_41[0]))
			{
				unk_0x5C5B23A2682A1514(uParam0->f_41[0], 0f, 0f, -11.27f, 2, 1);
				unk_0x6FB44A9D2C537B29(uParam0->f_41[0], 0);
				unk_0xB2C123C54D84E6A7(uParam0->f_41[0], 1);
				unk_0xADC490336B26A2EA(uParam0->f_41[0], 0);
			...
			unk_0x6B09668CBB188BED(uParam0->f_48);
			unk_0x6B09668CBB188BED(sVar8);
			return 1;
			break;
	}
	return 0;
...
void func_254(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_255(uParam0);
...
int func_256(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			uParam0->f_27 = 1;
			func_257(4, 0);
			func_297(" SetupScene_NIGEL_1A - SET_INTERIOR_CAPPED(INTERIOR_V_ROCKCLUB, FALSE)	");
			uParam0->f_48 = "rcmnigel1aig_1";
			uParam0->f_59 = -1;
			func_243(38, 1);
			uVar9 = unk_0xC9E9FBB6826F5158(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
			if (unk_0x80B7B1E21DC40E6E(uVar9))
			{
				unk_0x65C5ADF3D61813AE(iVar9);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0xBECC89ACB4E5D4ED(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x198E497B820DA913(uParam0->f_48);
			iLocal_91 = 1;
		...
		case 1:
			if (!func_240(&iVar0) || !unk_0x7B43775D6E0D7325(uParam0->f_48))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			func_254(&(uParam0->f_28[0]), iVar0[0], -552.66f, 287.75f, 82.18f, 123.75f, 26);
			func_254(&(uParam0->f_28[1]), iVar0[1], -553.46f, 287.34f, 82.18f, -65.86f, 26);
			if (func_110(uParam0->f_28[1]))
			{
				unk_0xA26A1133034ECD59(uParam0->f_28[1], 0);
				unk_0x47222A663B914109(uParam0->f_28[1], 0, 1, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[1], 2, 0, 2, 0);
				unk_0x47222A663B914109(uParam0->f_28[1], 3, 1, 2, 0);
				unk_0x47222A663B914109(uParam0->f_28[1], 4, 0, 1, 0);
				unk_0x47222A663B914109(uParam0->f_28[1], 7, 0, 1, 0);
				unk_0x47222A663B914109(uParam0->f_28[1], 8, 1, 0, 0);
			}
			uParam0->f_59 = unk_0x70D62E1C98FBC411(-552.18f, 285.476f, 81.976f, 0f, 0f, 79.5f, 2);
			unk_0x58E3D20EAF3A6C20(uParam0->f_59, 1);
			unk_0xF0B400EA537067E0(uParam0->f_59, 0);
			if (func_110(uParam0->f_28[0]))
			{
				unk_0x13F17EF7A260536D(uParam0->f_28[0], uParam0->f_59, uParam0->f_48, "BASE_02_Willie", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			if (func_110(uParam0->f_28[1]))
			{
				unk_0x13F17EF7A260536D(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "BASE_02_GIRL", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			func_254(&(uParam0->f_28[2]), iVar0[2], -559.94f, 285.99f, 85.38f, -59.06f, 26);
			func_254(&(uParam0->f_28[3]), iVar0[3], -558.87f, 289.79f, 85.38f, 162.44f, 26);
			func_254(&(uParam0->f_28[4]), iVar0[4], -559f, 286.09f, 85.38f, 65.92f, 26);
			func_254(&(uParam0->f_28[5]), iVar0[5], -558.84f, 288.97f, 85.38f, -7.72f, 26);
			if (func_110(uParam0->f_28[2]))
			{
				unk_0x47222A663B914109(uParam0->f_28[2], 0, 0, 1, 0);
				unk_0x47222A663B914109(uParam0->f_28[2], 2, 1, 2, 0);
				unk_0x47222A663B914109(uParam0->f_28[2], 3, 1, 1, 0);
				unk_0x47222A663B914109(uParam0->f_28[2], 4, 1, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[2], 7, 1, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[2], 8, 1, 0, 0);
			}
			if (func_110(uParam0->f_28[3]))
			{
				unk_0x47222A663B914109(uParam0->f_28[3], 0, 1, 1, 0);
				unk_0x47222A663B914109(uParam0->f_28[3], 2, 1, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[3], 3, 1, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[3], 4, 1, 1, 0);
				unk_0x47222A663B914109(uParam0->f_28[3], 7, 1, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[3], 8, 1, 0, 0);
			}
			if (func_110(uParam0->f_28[4]))
			{
				unk_0x47222A663B914109(uParam0->f_28[4], 0, 0, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[4], 2, 0, 2, 0);
				unk_0x47222A663B914109(uParam0->f_28[4], 3, 0, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[4], 4, 0, 1, 0);
				unk_0x47222A663B914109(uParam0->f_28[4], 8, 0, 0, 0);
			}
			if (func_110(uParam0->f_28[5]))
			{
				unk_0x47222A663B914109(uParam0->f_28[5], 0, 1, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[5], 2, 2, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[5], 3, 0, 3, 0);
				unk_0x47222A663B914109(uParam0->f_28[5], 4, 1, 0, 0);
				unk_0x47222A663B914109(uParam0->f_28[5], 8, 0, 2, 0);
			}
			func_234(&(uParam0->f_35[0]), iVar0[6], -553.55f, 308.61f, 82.81f, 202.78f);
			if (func_111(uParam0->f_35[0]))
			{
				unk_0x5B9D79C27A5B31DC(uParam0->f_35[0], 1);
				unk_0x818E8D7BA45E01E7(uParam0->f_35[0], 1);
				unk_0xADC490336B26A2EA(uParam0->f_35[0], 0);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0x0B87AFC0B2EECA19(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x6B09668CBB188BED(uParam0->f_48);
			return 1;
...
int func_264(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_241(&(uParam0->f_48), "rcmnigel1", "base_nigel", "base_nigel");
			func_241(&uLocal_96, "rcmnigel1", "base_mrs_thornhill", "base_mrs_thornhill");
			iLocal_91 = 1;
			break;
		...
		case 2:
			bVar6 = true;
			if (!func_236(&(uParam0->f_28[0]), 64, -1100.5f, 789.8f, 164.34f, 1.82f, "RC: NIGEL", 1))
			{
				bVar6 = false;
			}
			if (!func_236(&(uParam0->f_28[1]), 63, -1099.35f, 789.15f, 164.47f, 0f, "RC: MRS THORNHILL", 1))
			{
				bVar6 = false;
			}
			if (!unk_0xC1EDB61CE0A4B94E(uParam0->f_35[0]))
			{
				func_234(&(uParam0->f_35[0]), iLocal_95, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
				if (func_111(uParam0->f_35[0]))
				{
					unk_0x22984397339DE6D1(uParam0->f_35[0], 65, 0);
					unk_0x51C0D2C5E7CCC540(uParam0->f_35[0], 5, 0);
		...
		case 3:
			if (func_111(uParam0->f_28[0]) && func_111(uParam0->f_28[1]))
			{
				unk_0xBA63517ADBC1E5E3(uParam0->f_28[0], 1);
				unk_0xBA63517ADBC1E5E3(uParam0->f_28[1], 1);
				uVar5 = unk_0x70D62E1C98FBC411(-1100.558f, 789.8862f, 163.3285f, 0f, 0f, 0f, 2);
				unk_0x13F17EF7A260536D(uParam0->f_28[0], uVar5, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1148846080, 0);
				unk_0x13F17EF7A260536D(uParam0->f_28[1], uVar5, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1148846080, 0);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_278(int iParam0, int iParam1, bool bParam2)
{
	...
	if (*iParam0 == 43)
	{
		func_255(&(iParam0->f_28[1]));
	}
	if (unk_0xCDB4C4200A9B478A(uLocal_109))
	{
		unk_0x2239ED27B231AE2E(&uLocal_109);
	}
	if (bParam2)
	{
		...
		if (*iParam0 == 38)
		{
			func_257(4, 1);
			func_295(iParam0);
			func_297(" Script_Cleanup - SET_INTERIOR_CAPPED(INTERIOR_V_ROCKCLUB, TRUE)");
		}
		else if (*iParam0 == 39)
		{
			func_293(iParam0);
	...
	switch (*iParam0)
	{
		case 43:
			if (iParam1->f_1 != -1)
			{
				unk_0x2B84DF57725231E1(iParam1->f_1);
			}
			break;
	}
...
void func_293(var uParam0)
{
	if (unk_0x4958900440DDE4E4(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[1]))
		{
			if (func_294(uParam0->f_28[1], 1785177548))
			{
				unk_0x1F6717C33A02B7AC(uParam0->f_28[1]);
			}
			unk_0xC1DCFD0B8D2E4221(uParam0->f_28[1], -1000f, 1);
		}
	}
}
...
void func_295(var uParam0)
{
	if (unk_0x4958900440DDE4E4(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[0]))
		{
			if (func_294(uParam0->f_28[0], 1785177548))
			{
