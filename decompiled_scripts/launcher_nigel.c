...
void __EntryFunction__()
{
	...
	if (unk_0x78BF2001491914AC(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_102323[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_309(&(Global_102323[Var0.f_0 /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		if (Var0.f_0 == 42)
		{
			...
			{
				unk_0xA73D2885CDC54CCB(func_201(), 4, 0, 0, func_200());
...
int func_182(int iParam0)
{
	...
	if (func_123(unk_0x2A5EB8B0FE590B91()))
	{
		...
		{
			if (unk_0x2137828D03306CAF(iParam0->f_28[iVar0]))
			{
				if (func_123(iParam0->f_28[iVar0]))
				{
					if (unk_0xE8594BE97055E9A1(iParam0->f_28[iVar0], unk_0x2A5EB8B0FE590B91(), 1) || unk_0xD42AA0CF76AFB4D8(unk_0xD1EE0E9FCD74A37B(iParam0->f_28[iVar0], 1), 7.5f, 1))
					{
						if (func_173(2))
						{
							func_170(iParam0->f_27, *iParam0);
...
{
	if (func_184(uParam1, unk_0xD1EE0E9FCD74A37B(unk_0x2A5EB8B0FE590B91(), 1)))
	{
		if (func_173(2))
		{
			if (func_171(iParam0->f_27))
...
void func_185(int iParam0, var uParam1, var uParam2)
{
	if (func_123(*uParam1))
	{
		...
		{
			case 0:
				if (unk_0x741298E7009A20C9("CAR_TRUNK_THUMPS", 0, -1))
				{
					iParam0->f_1 = unk_0x9FF6FFD9EB30D086();
					iParam0->f_2 = unk_0x3732B96D7A1859B4();
					iParam0->f_3 = unk_0x895FB9FE885E36ED(6000, 12000);
					*iParam0 = 1;
				}
				break;
			
			case 1:
				if ((unk_0x3732B96D7A1859B4() - iParam0->f_2) > iParam0->f_3)
				{
					unk_0x52EF42797AD5A36D(iParam0->f_1, "TRUNK_THUMPS", unk_0x82D9CF397BA8C885(*uParam1, 0f, -2.2f, 0.5f), 0, 0, 0, 0);
					unk_0xA2782778D22DC0EA(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_186(0), 0);
					iParam0->f_4 = unk_0x895FB9FE885E36ED(3, 7);
					iParam0->f_5 = 0;
					iParam0->f_6 = unk_0x3732B96D7A1859B4();
					iParam0->f_7 = unk_0x895FB9FE885E36ED(100, 250);
					*iParam0 = 2;
				}
				break;
			
			case 2:
				if ((unk_0x3732B96D7A1859B4() - iParam0->f_6) > iParam0->f_7)
				{
					iParam0->f_8 = unk_0x895FB9FE885E36ED(-200, -120);
					iParam0->f_9 = (0.5f * unk_0xBBDA792448DB5A89(unk_0x895FB9FE885E36ED(-2, 3)));
					unk_0x748D711A16EB2994(*uParam1, 1, 0f, 0f, IntToFloat(iParam0->f_8), iParam0->f_9, -1.5f, 0f, 0, 1, 1, 0, 1, 1);
					iParam0->f_5++;
					if (iParam0->f_5 < iParam0->f_4)
					{
						iParam0->f_6 = unk_0x3732B96D7A1859B4();
						iParam0->f_7 = unk_0x895FB9FE885E36ED(150, 280);
					}
					else
					{
						iParam0->f_2 = unk_0x3732B96D7A1859B4();
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_123(unk_0x2A5EB8B0FE590B91()) && func_123(iParam0->f_28[0])) && !func_141()) && (unk_0x3732B96D7A1859B4() - iParam0->f_60) > iParam8) && func_191(unk_0x2A5EB8B0FE590B91(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_173(2))
		{
			if (!func_141())
			{
				if (((func_123(unk_0x2A5EB8B0FE590B91()) && func_123(iParam0->f_28[0])) && func_123(iParam0->f_28[1])) && func_191(unk_0x2A5EB8B0FE590B91(), Param1, 1) < 20f)
				{
			...
			else if (((func_194(sParam5) && !*uParam10 == 1) && func_123(unk_0x2A5EB8B0FE590B91())) && func_191(unk_0x2A5EB8B0FE590B91(), Param1, 1) >= 20f)
			{
				func_310("pause conversation");
				func_193(1);
				*uParam10 = 1;
			}
			if (func_191(unk_0x2A5EB8B0FE590B91(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
int func_210(var uParam0, bool bParam1)
{
	...
	if ((func_243(*uParam0) || func_241(*uParam0)) || Global_70045 == 1)
	{
		return 1;
	}
	if (!unk_0xC6D11983DAD48A48())
			...
			if (unk_0x2137828D03306CAF(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_215(unk_0x2A5EB8B0FE590B91(), uParam0->f_35[iVar0]))
							{
...
int func_218(int iParam0, float fParam1)
{
	...
	{
		if (func_229(iParam0) || unk_0xE97AF56371F08BE1(unk_0x0FFED3E94261A832(), iParam0))
		{
...
{
	return func_220(iParam0, unk_0x2A5EB8B0FE590B91(), fParam1, 1, 250, 7);
}
...
int func_224(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_226(unk_0xD1EE0E9FCD74A37B(iParam1, 1) - unk_0xD1EE0E9FCD74A37B(iParam0, 1)) };
	...
	{
		Var3 = { func_226(unk_0x585F703DF3E83B6E(iParam0, 31086, 0f, 5f, 0f) - unk_0x585F703DF3E83B6E(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_233(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_226(Param1 - unk_0xD1EE0E9FCD74A37B(uParam0, 1)) };
...
{
	if ((func_242() && Global_91777.f_11 == 6) && iParam0 == func_160(&(Global_91777.f_3), 0))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x2137828D03306CAF(uParam0->f_35[0]))
			{
				...
				if (func_123(uParam0->f_35[0]))
				{
					unk_0xC2C096B78AB918EB(uParam0->f_35[0], 65, 0);
					unk_0x15872CD5DF7D67EF(uParam0->f_35[0], 5, 0);
					unk_0x08DCA8665D0C20FA(uParam0->f_35[0], "28BNT310");
					unk_0xA7314A354509BF8F(uParam0->f_35[0], 0);
					unk_0xD1A53D507962BF1F(uParam0->f_35[0], 10);
					unk_0x87169A16D1C6C9F1(uParam0->f_35[0], 0);
...
int func_246(var uParam0, var uParam1)
{
	...
	if (unk_0x2137828D03306CAF(*uParam1) && unk_0xA1FC9D7AEA164881(iLocal_94))
	{
		*uParam0 = unk_0xD00B79C0E206E082(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, 1, 1);
		unk_0x15A19BB3A39023C8(*uParam0, "NI3_LNCH_CELEB");
		unk_0x6CA29A70250F194F(*uParam0, 4, 0, 0, 0);
		unk_0x4C47904AE69D7393(*uParam0, 1);
		Var0 = { unk_0x82D9CF397BA8C885(*uParam1, -0.2f, -1.8f, -1f) };
		fVar6 = (-90f + unk_0x6DAB28241B34DEED(*uParam1));
		Var3 = { 0f, 0f, fVar6 };
		unk_0x8F35D7268F7D4402(*uParam0, Var0, 0, 0, 1);
		unk_0xD39DE0C6C0F91C27(*uParam0, Var3, 2, 1);
		unk_0x5DAB197A499B8499(*uParam0, *uParam1, 0, 0.2f, -1.8f, 0f, 0f, 0f, 90f, 0, 0, 0, 0, 2, 1);
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x2137828D03306CAF(uParam0->f_35[1]))
			{
				...
				{
					unk_0xC2C096B78AB918EB(uParam0->f_35[1], 0, 0);
					unk_0xD1A53D507962BF1F(uParam0->f_35[1], 10);
				}
			}
			if (bVar5)
			{
...
int func_260(var uParam0, var uParam1)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_253(&iVar0) || !unk_0x45834D6C20FFF689(uParam0->f_48)) || !unk_0x45834D6C20FFF689(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0xDEC831C0189DE207(uParam0->f_28[0], 0, 0, 0, 0);
...
int func_264(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_253(&iVar0) || !unk_0x45834D6C20FFF689(sVar4))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0xF1C3427BFED79E6B(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, sVar4, "dexy_stay_there", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, sVar4, "price_tag", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, sVar4, "such_a_good", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, sVar4, "this_looks", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xF1C3427BFED79E6B(0, sVar4, "who_would", 8f, -8f, -1, 0, 0, 0, 0, 0);
	...
	switch (iLocal_91)
	{
		...
		case 2:
			if (!unk_0x2137828D03306CAF(uParam0->f_35[0]))
			{
				...
				{
					unk_0x07C140F31B3CDAFA(uParam0->f_35[0], 1084227584);
					unk_0xC2C096B78AB918EB(uParam0->f_35[0], 97, 97);
					unk_0x170792970BF5726F(uParam0->f_35[0], 13.5f);
					unk_0x15872CD5DF7D67EF(uParam0->f_35[0], 2, 0);
					unk_0xE90B4C21E7E6817C(uParam0->f_35[0], 2, 0, 1);
					unk_0x1873102BDC0A9FE0(uParam0->f_35[0], 2, 0, 1f);
					unk_0x11F65D12FCF484B5(uParam0->f_35[0]);
					return 0;
				}
			}
			if (func_123(uParam0->f_35[0]))
			{
				fVar9 = unk_0xB2C6EB7B345D25EC(uParam0->f_35[0], 2);
				if (!unk_0xBDABA203E908C8D5(uParam0->f_35[0], 2) && fVar9 < 0.8f)
				{
					unk_0x1873102BDC0A9FE0(uParam0->f_35[0], 2, 0, 1f);
				}
				else
		...
		case 3:
			if (func_123(uParam0->f_35[0]))
			{
				if (!unk_0x453DB1DBE5D81637(uParam0->f_35[0], sVar8, "idle_speedo", 3))
				{
					if (unk_0x45834D6C20FFF689(sVar8))
					{
						unk_0xCEF455E756555E7E(uParam0->f_35[0], sVar8, "idle_speedo");
						return 0;
					}
					else
					{
			...
			if (func_123(uParam0->f_35[1]))
			{
				unk_0xC2C096B78AB918EB(uParam0->f_35[1], 27, 27);
			}
			func_267(&(uParam0->f_28[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			if (func_122(uParam0->f_28[0]))
			{
				unk_0x2E0701CEBB06668C(uParam0->f_28[0], 0);
				unk_0x8F35D7268F7D4402(uParam0->f_28[0], -1054.7f, 355.94f, 68.35f, 0, 0, 1);
				unk_0x2681BA3707AF6DA7(uParam0->f_28[0], 23.67f);
				unk_0xF1C3427BFED79E6B(uParam0->f_28[0], sVar8, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			...
			if (func_122(uParam0->f_28[1]))
			{
				...
				unk_0x6CA29A70250F194F(uParam0->f_28[1], 3, 0, 2, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[1], 4, 0, 0, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[1], 8, 0, 1, 0);
				unk_0x2E0701CEBB06668C(uParam0->f_28[1], 0);
				uParam0->f_59 = unk_0x6D46C949A32B8D73(-1059f, 360.976f, 69f, 0f, 0f, -1.08f, 2);
				unk_0xA2218E1CAB0028A5(uParam0->f_59, 1);
				unk_0xEE68E88B8F41075D(uParam0->f_59, 0);
				unk_0x5F778B8D6D7DF47B(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "base_girl", 1000f, -8f, 592, 0, 1148846080, 0);
			}
			func_267(&(uParam0->f_28[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			if (func_122(uParam0->f_28[2]))
			{
				unk_0x1EC40B161E6A203A(uParam0->f_28[2]);
				unk_0x8F35D7268F7D4402(uParam0->f_28[2], -1012.57f, 357.48f, 70.62f, 0, 0, 1);
				unk_0x67E5DE1657F60AC6(uParam0->f_28[2], 160);
				if (unk_0x45834D6C20FFF689(sVar8))
				{
					unk_0xF1C3427BFED79E6B(uParam0->f_28[2], sVar8, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
				}
			}
			func_266(&(uParam0->f_41[0]), iVar0[5], -1050.03f, 368.95f, 69.29f, -11.27f);
			if (func_123(uParam0->f_41[0]))
			{
				unk_0xD39DE0C6C0F91C27(uParam0->f_41[0], 0f, 0f, -11.27f, 2, 1);
				unk_0xE86C3B50CF07F041(uParam0->f_41[0], 0);
				unk_0xF65C7766FB8D4B2C(uParam0->f_41[0], 1);
				unk_0x1F89DE54A0C24BD3(uParam0->f_41[0], 0);
			...
			unk_0x15167ADA0B7D44AE(uParam0->f_48);
			unk_0x15167ADA0B7D44AE(sVar8);
			return 1;
			break;
	}
	return 0;
...
int func_269(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			uParam0->f_59 = -1;
			func_256(38, 1);
			uVar9 = unk_0xD79C30F3A2706E90(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
			if (unk_0xA419466089F321B4(uVar9))
			{
				unk_0x83180C5D46916B1C(iVar9);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0x0F39DF6675B2333E(iVar0[iVar8]);
				iVar8++;
			}
			unk_0xA7C81DED990D3418(uParam0->f_48);
			iLocal_91 = 1;
		...
		case 1:
			if (!func_253(&iVar0) || !unk_0x45834D6C20FFF689(uParam0->f_48))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_122(uParam0->f_28[1]))
			{
				unk_0x2725C3746060DA66(uParam0->f_28[1], 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[1], 0, 1, 0, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[1], 2, 0, 2, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[1], 3, 1, 2, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[1], 4, 0, 1, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[1], 7, 0, 1, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[1], 8, 1, 0, 0);
			}
			uParam0->f_59 = unk_0x6D46C949A32B8D73(-552.18f, 285.476f, 81.976f, 0f, 0f, 79.5f, 2);
			unk_0xA2218E1CAB0028A5(uParam0->f_59, 1);
			unk_0xEE68E88B8F41075D(uParam0->f_59, 0);
			if (func_122(uParam0->f_28[0]))
			{
				unk_0x5F778B8D6D7DF47B(uParam0->f_28[0], uParam0->f_59, uParam0->f_48, "BASE_02_Willie", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			if (func_122(uParam0->f_28[1]))
			{
				unk_0x5F778B8D6D7DF47B(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "BASE_02_GIRL", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			...
			if (func_122(uParam0->f_28[2]))
			{
				...
				unk_0x6CA29A70250F194F(uParam0->f_28[2], 2, 1, 2, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[2], 3, 1, 1, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[2], 4, 1, 0, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[2], 7, 1, 0, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[2], 8, 1, 0, 0);
			}
			if (func_122(uParam0->f_28[3]))
			{
				unk_0x6CA29A70250F194F(uParam0->f_28[3], 0, 1, 1, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[3], 2, 1, 0, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[3], 3, 1, 0, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[3], 4, 1, 1, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[3], 7, 1, 0, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[3], 8, 1, 0, 0);
			}
			if (func_122(uParam0->f_28[4]))
			{
				unk_0x6CA29A70250F194F(uParam0->f_28[4], 0, 0, 0, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[4], 2, 0, 2, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[4], 3, 0, 0, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[4], 4, 0, 1, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[4], 8, 0, 0, 0);
			}
			if (func_122(uParam0->f_28[5]))
			{
				unk_0x6CA29A70250F194F(uParam0->f_28[5], 0, 1, 0, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[5], 2, 2, 0, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[5], 3, 0, 3, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[5], 4, 1, 0, 0);
				unk_0x6CA29A70250F194F(uParam0->f_28[5], 8, 0, 2, 0);
			}
			func_247(&(uParam0->f_35[0]), iVar0[6], -553.55f, 308.61f, 82.81f, 202.78f);
			if (func_123(uParam0->f_35[0]))
			{
				unk_0x23B7F0BEB9890E62(uParam0->f_35[0], 1);
				unk_0xD1A53D507962BF1F(uParam0->f_35[0], 1);
				unk_0x1F89DE54A0C24BD3(uParam0->f_35[0], 0);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0xFD213087BC4CC3B3(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x15167ADA0B7D44AE(uParam0->f_48);
			return 1;
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_123(uParam0->f_28[0]) && func_123(uParam0->f_28[1]))
			{
				unk_0x4C47904AE69D7393(uParam0->f_28[0], 1);
				unk_0x4C47904AE69D7393(uParam0->f_28[1], 1);
				uVar5 = unk_0x6D46C949A32B8D73(-1100.558f, 789.8862f, 163.3285f, 0f, 0f, 0f, 2);
				unk_0x5F778B8D6D7DF47B(uParam0->f_28[0], uVar5, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1148846080, 0);
				unk_0x5F778B8D6D7DF47B(uParam0->f_28[1], uVar5, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1148846080, 0);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_291(int iParam0, int iParam1, bool bParam2)
{
	...
	if (unk_0xBDD3EABACAB97D09(uLocal_109))
	{
		unk_0x789C84F1B8496AD0(&uLocal_109);
	}
	if (bParam2)
	{
	...
	switch (*iParam0)
	{
		case 43:
			if (iParam1->f_1 != -1)
			{
				unk_0x15BA16B33BC155D8(iParam1->f_1);
			}
			break;
	}
...
void func_306(var uParam0)
{
	if (unk_0x354ACA1BAED67927(uParam0->f_59))
	{
		if (func_122(uParam0->f_28[1]))
		{
			...
			unk_0x860D46ACBCB64ED9(uParam0->f_28[1], -1000f, 1);
		}
	}
}
