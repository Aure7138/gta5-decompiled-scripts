...
int func_193(int iParam0)
{
	...
	if (func_132(unk_0xC1A5EC5C986B98AD()))
	{
		...
		{
			if (unk_0x7DE17ACDD8BA2642(iParam0->f_28[iVar0]))
			{
				if (func_132(iParam0->f_28[iVar0]))
				{
					if (unk_0x7559C38E6535AB89(iParam0->f_28[iVar0], unk_0xC1A5EC5C986B98AD(), 1) || unk_0x612907CF3208D1E3(unk_0x30BE8A934C020461(iParam0->f_28[iVar0], 1), 7.5f, 1))
					{
						if (func_184(2))
						{
							func_181(iParam0->f_27, *iParam0);
	...
	if (func_132(*uParam1))
	{
		switch (*iParam0)
		{
			case 0:
				...
				{
					iParam0->f_1 = unk_0x9F2C1BA4F2BF5CF8();
					iParam0->f_2 = unk_0xA5E11AF0A2B928C1();
					iParam0->f_3 = unk_0x15A88CFAAFFC6C4B(6000, 12000);
					*iParam0 = 1;
				}
				break;
			
			case 1:
				if ((unk_0xA5E11AF0A2B928C1() - iParam0->f_2) > iParam0->f_3)
				{
					unk_0x4473578485E594D7(iParam0->f_1, "TRUNK_THUMPS", unk_0x7394CB479CCA24AF(*uParam1, 0f, -2.2f, 0.5f), 0, 0, 0, 0);
					unk_0xB7C28610A558761B(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_197(0), 0);
					iParam0->f_4 = unk_0x15A88CFAAFFC6C4B(3, 7);
					iParam0->f_5 = 0;
					iParam0->f_6 = unk_0xA5E11AF0A2B928C1();
					iParam0->f_7 = unk_0x15A88CFAAFFC6C4B(100, 250);
					*iParam0 = 2;
				}
				break;
			
			case 2:
				if ((unk_0xA5E11AF0A2B928C1() - iParam0->f_6) > iParam0->f_7)
				{
					iParam0->f_8 = unk_0x15A88CFAAFFC6C4B(-200, -120);
					iParam0->f_9 = (0.5f * unk_0xBBDA792448DB5A89(unk_0x15A88CFAAFFC6C4B(-2, 3)));
					unk_0x9E1A4BBC2E70DCFB(*uParam1, 1, 0f, 0f, IntToFloat(iParam0->f_8), iParam0->f_9, -1.5f, 0f, 0, 1, 1, 0, 1, 1);
					iParam0->f_5++;
					if (iParam0->f_5 < iParam0->f_4)
					{
						iParam0->f_6 = unk_0xA5E11AF0A2B928C1();
						iParam0->f_7 = unk_0x15A88CFAAFFC6C4B(150, 280);
					}
					else
					{
						iParam0->f_2 = unk_0xA5E11AF0A2B928C1();
...
int func_198(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_132(unk_0xC1A5EC5C986B98AD()) && func_132(iParam0->f_28[0])) && !func_150()) && (unk_0xA5E11AF0A2B928C1() - iParam0->f_60) > iParam8) && func_202(unk_0xC1A5EC5C986B98AD(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_203(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_184(2))
		{
			if (!func_150())
			{
				if (((func_132(unk_0xC1A5EC5C986B98AD()) && func_132(iParam0->f_28[0])) && func_132(iParam0->f_28[1])) && func_202(unk_0xC1A5EC5C986B98AD(), Param1, 1) < 20f)
				{
			...
			else if (((func_205(sParam5) && !*uParam10 == 1) && func_132(unk_0xC1A5EC5C986B98AD())) && func_202(unk_0xC1A5EC5C986B98AD(), Param1, 1) >= 20f)
			{
				func_321("pause conversation");
				func_204(1);
				*uParam10 = 1;
			}
			if (func_202(unk_0xC1A5EC5C986B98AD(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_213(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(sParam1))
		{
			...
			{
				if (func_202(unk_0xC1A5EC5C986B98AD(), Param2, 1) <= 100f)
				{
					func_216(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_202(unk_0xC1A5EC5C986B98AD(), Param2, 1) > 120f)
				{
					func_218(iParam0);
				}
			}
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_226(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[iVar0]))
							{
...
int func_229(int iParam0, float fParam1)
{
	...
	{
		if (func_240(iParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), iParam0))
		{
...
{
	return func_231(iParam0, unk_0xC1A5EC5C986B98AD(), fParam1, 1, 250, 7);
}
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_237(unk_0x30BE8A934C020461(iParam1, 1) - unk_0x30BE8A934C020461(iParam0, 1)) };
	...
	{
		Var3 = { func_237(unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_244(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_237(Param1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
int func_257(var uParam0, var uParam1)
{
	...
	{
		*uParam0 = unk_0x69FDD9508259E5B5(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, 1, 1);
		unk_0x260A70C42FAA4EDC(*uParam0, "NI3_LNCH_CELEB");
		unk_0xFECAE061D8C80757(*uParam0, 4, 0, 0, 0);
		unk_0xC5B2830898581862(*uParam0, 1);
		Var0 = { unk_0x7394CB479CCA24AF(*uParam1, -0.2f, -1.8f, -1f) };
		fVar6 = (-90f + unk_0xD850DD08D5434072(*uParam1));
		Var3 = { 0f, 0f, fVar6 };
		unk_0x2EDDA32F6EF3C8B7(*uParam0, Var0, 0, 0, 1);
		unk_0x464B5B0F22497FC5(*uParam0, Var3, 2, 1);
...
int func_271(var uParam0, var uParam1)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_264(&iVar0) || !unk_0x2BBF749E555360DC(uParam0->f_48)) || !unk_0x2BBF749E555360DC(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_275(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_264(&iVar0) || !unk_0x2BBF749E555360DC(sVar4))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0x3EE48ADC8C7F5CC4(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x3EE48ADC8C7F5CC4(0, sVar4, "dexy_stay_there", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x3EE48ADC8C7F5CC4(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x3EE48ADC8C7F5CC4(0, sVar4, "price_tag", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x3EE48ADC8C7F5CC4(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x3EE48ADC8C7F5CC4(0, sVar4, "such_a_good", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x3EE48ADC8C7F5CC4(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x3EE48ADC8C7F5CC4(0, sVar4, "this_looks", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x3EE48ADC8C7F5CC4(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x3EE48ADC8C7F5CC4(0, sVar4, "who_would", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
int func_276(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (func_132(uParam0->f_35[0]))
			{
				fVar9 = unk_0x75208DE6B34AB66E(uParam0->f_35[0], 2);
				if (!unk_0x572AF637991A13A2(uParam0->f_35[0], 2) && fVar9 < 0.8f)
				{
					unk_0x70B81583DCDC7F26(uParam0->f_35[0], 2, 0, 1f);
				}
				else
		...
		case 3:
			if (func_132(uParam0->f_35[0]))
			{
				if (!unk_0x7BB3D8F4F6310EB8(uParam0->f_35[0], sVar8, "idle_speedo", 3))
				{
					if (unk_0x2BBF749E555360DC(sVar8))
					{
						unk_0x4455605CA03B7F5A(uParam0->f_35[0], sVar8, "idle_speedo");
						return 0;
					}
					else
					{
			...
			if (func_131(uParam0->f_28[0]))
			{
				...
				unk_0x3EE48ADC8C7F5CC4(uParam0->f_28[0], sVar8, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			...
			if (func_131(uParam0->f_28[2]))
			{
				...
				if (unk_0x2BBF749E555360DC(sVar8))
				{
					unk_0x3EE48ADC8C7F5CC4(uParam0->f_28[2], sVar8, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
				}
			}
...
int func_280(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			uParam0->f_59 = -1;
			func_267(38, 1);
			uVar9 = unk_0xAF0CB15312D8B8E3(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
			if (unk_0x4D3D95146FD3490D(uVar9))
			{
				unk_0xE4499355C4A6EC13(iVar9);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0x852EC2A7DE66202D(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x28818732C8F0F80E(uParam0->f_48);
			iLocal_91 = 1;
		...
		case 1:
			if (!func_264(&iVar0) || !unk_0x2BBF749E555360DC(uParam0->f_48))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0xE0A291F406691F03(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x0B34FA69ECCE3927(uParam0->f_48);
			return 1;
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_132(uParam0->f_28[0]) && func_132(uParam0->f_28[1]))
			{
				unk_0xC5B2830898581862(uParam0->f_28[0], 1);
				unk_0xC5B2830898581862(uParam0->f_28[1], 1);
				uVar5 = unk_0x191673E3F99212B2(-1100.558f, 789.8862f, 163.3285f, 0f, 0f, 0f, 2);
				unk_0x468D976993BF7FE1(uParam0->f_28[0], uVar5, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1148846080, 0);
				unk_0x468D976993BF7FE1(uParam0->f_28[1], uVar5, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1148846080, 0);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_302(int iParam0, int iParam1, bool bParam2)
{
	...
	switch (*iParam0)
	{
		case 43:
			if (iParam1->f_1 != -1)
			{
				unk_0x8A1B9F78F1F46A12(iParam1->f_1);
			}
			break;
	}
