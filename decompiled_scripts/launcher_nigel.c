...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Var0.f_0 == 42)
		{
			...
			{
				unk_0x44F8EFEFF0CDA3FE(func_209(), 4, 0, 0, func_208());
...
{
	if (func_192(uParam1, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)))
	{
		if (func_181(2))
		{
			if (func_179(iParam0->f_27))
		...
		switch (*iParam0)
		{
			...
			case 1:
				if ((unk_0x320D1840B6DAA1CC() - iParam0->f_2) > iParam0->f_3)
				{
					...
					unk_0x49C085D876A9986D(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_194(0), 0);
			...
			case 2:
				if ((unk_0x320D1840B6DAA1CC() - iParam0->f_6) > iParam0->f_7)
				{
					...
					iParam0->f_9 = (0.5f * unk_0xBBDA792448DB5A89(unk_0x5853B15F78E1A265(-2, 3)));
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_129(unk_0xE2D3D51028F0428A()) && func_129(iParam0->f_28[0])) && !func_147()) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam8) && func_199(unk_0xE2D3D51028F0428A(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_200(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_181(2))
		{
			if (!func_147())
			{
				if (((func_129(unk_0xE2D3D51028F0428A()) && func_129(iParam0->f_28[0])) && func_129(iParam0->f_28[1])) && func_199(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f)
				{
			...
			else if (((func_202(sParam5) && !*uParam10 == 1) && func_129(unk_0xE2D3D51028F0428A())) && func_199(unk_0xE2D3D51028F0428A(), Param1, 1) >= 20f)
			{
				func_318("pause conversation");
				func_201(1);
				*uParam10 = 1;
			}
			if (func_199(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_210(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		if (!unk_0xACC32B78196FBC2A(sParam1))
		{
			...
			{
				if (func_199(unk_0xE2D3D51028F0428A(), Param2, 1) <= 100f)
				{
					func_213(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_199(unk_0xE2D3D51028F0428A(), Param2, 1) > 120f)
				{
					func_215(iParam0);
				}
			}
...
void func_255(var uParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_256(uParam0);
...
int func_268(var uParam0, var uParam1)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_261(&iVar0) || !unk_0x6F940C2636C076AD(uParam0->f_48)) || !unk_0x6F940C2636C076AD(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_272(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_261(&iVar0) || !unk_0x6F940C2636C076AD(sVar4))
			{
				return 0;
			}
			iLocal_91 = 2;
...
void func_275(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_276(uParam0);
...
int func_277(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_261(&iVar0) || !unk_0x6F940C2636C076AD(uParam0->f_48))
			{
				return 0;
			}
			iLocal_91 = 2;
