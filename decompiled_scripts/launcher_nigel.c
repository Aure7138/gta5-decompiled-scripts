...
void __EntryFunction__()
{
	...
	if (unk_0xD4BE58A7E3E102AC(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_110647[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_315(&(Global_110647[Var0.f_0 /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		if (Var0.f_0 == 42)
		{
			...
			{
				unk_0xD1FEA8C1A32B5B0C(func_207(), 4, 0, 0, func_206());
...
int func_188(int iParam0)
{
	...
	if (func_127(unk_0x0FA8183DAD2B3203()))
	{
		...
		{
			if (unk_0xD4B321D9096B01FC(iParam0->f_28[iVar0]))
			{
				if (func_127(iParam0->f_28[iVar0]))
				{
					if (unk_0x3656B691E303FDE0(iParam0->f_28[iVar0], unk_0x0FA8183DAD2B3203(), 1) || unk_0x6C979EE77983FC04(unk_0xACE5E491FC1B0D37(iParam0->f_28[iVar0], 1), 7.5f, 1))
					{
						if (func_179(2))
						{
							func_176(iParam0->f_27, *iParam0);
...
{
	if (func_190(uParam1, unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1)))
	{
		if (func_179(2))
		{
			if (func_177(iParam0->f_27))
...
void func_191(int iParam0, var uParam1, var uParam2)
{
	if (func_127(*uParam1))
	{
		...
		{
			case 0:
				if (unk_0x059780A8877D0C70("CAR_TRUNK_THUMPS", 0, -1))
				{
					iParam0->f_1 = unk_0x04B8CCFB93858A27();
					iParam0->f_2 = unk_0x9B35D07DCD0F0B43();
					iParam0->f_3 = unk_0xBAC643F143880136(6000, 12000);
					*iParam0 = 1;
				}
				break;
			
			case 1:
				if ((unk_0x9B35D07DCD0F0B43() - iParam0->f_2) > iParam0->f_3)
				{
					unk_0x0A41046A9C717367(iParam0->f_1, "TRUNK_THUMPS", unk_0xC12F91346EA13947(*uParam1, 0f, -2.2f, 0.5f), 0, 0, 0, 0);
					unk_0x8ED81066343F07B4(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_192(0), 0);
					iParam0->f_4 = unk_0xBAC643F143880136(3, 7);
					iParam0->f_5 = 0;
					iParam0->f_6 = unk_0x9B35D07DCD0F0B43();
					iParam0->f_7 = unk_0xBAC643F143880136(100, 250);
					*iParam0 = 2;
				}
				break;
			
			case 2:
				if ((unk_0x9B35D07DCD0F0B43() - iParam0->f_6) > iParam0->f_7)
				{
					iParam0->f_8 = unk_0xBAC643F143880136(-200, -120);
					iParam0->f_9 = (0.5f * unk_0xBBDA792448DB5A89(unk_0xBAC643F143880136(-2, 3)));
					unk_0x0977D05D452C9828(*uParam1, 1, 0f, 0f, IntToFloat(iParam0->f_8), iParam0->f_9, -1.5f, 0f, 0, 1, 1, 0, 1, 1);
					iParam0->f_5++;
					if (iParam0->f_5 < iParam0->f_4)
					{
						iParam0->f_6 = unk_0x9B35D07DCD0F0B43();
						iParam0->f_7 = unk_0xBAC643F143880136(150, 280);
					}
					else
					{
						iParam0->f_2 = unk_0x9B35D07DCD0F0B43();
...
int func_193(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_127(unk_0x0FA8183DAD2B3203()) && func_127(iParam0->f_28[0])) && !func_145()) && (unk_0x9B35D07DCD0F0B43() - iParam0->f_60) > iParam8) && func_197(unk_0x0FA8183DAD2B3203(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_198(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_179(2))
		{
			if (!func_145())
			{
				if (((func_127(unk_0x0FA8183DAD2B3203()) && func_127(iParam0->f_28[0])) && func_127(iParam0->f_28[1])) && func_197(unk_0x0FA8183DAD2B3203(), Param1, 1) < 20f)
				{
			...
			else if (((func_200(sParam5) && !*uParam10 == 1) && func_127(unk_0x0FA8183DAD2B3203())) && func_197(unk_0x0FA8183DAD2B3203(), Param1, 1) >= 20f)
			{
				func_316("pause conversation");
				func_199(1);
				*uParam10 = 1;
			}
			if (func_197(unk_0x0FA8183DAD2B3203(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_208(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0xD699DB8EAB756F25(unk_0x7C7787D2D7139A85()))
	{
		if (!unk_0x9591DE0F00127F2A(sParam1))
		{
			...
			{
				if (func_197(unk_0x0FA8183DAD2B3203(), Param2, 1) <= 100f)
				{
					func_211(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_197(unk_0x0FA8183DAD2B3203(), Param2, 1) > 120f)
				{
					func_213(iParam0);
				}
			}
			...
			if (unk_0xD4B321D9096B01FC(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_221(unk_0x0FA8183DAD2B3203(), uParam0->f_35[iVar0]))
							{
...
int func_224(int iParam0, float fParam1)
{
	...
	{
		if (func_235(iParam0) || unk_0x4412340828EC2614(unk_0x7C7787D2D7139A85(), iParam0))
		{
...
{
	return func_226(iParam0, unk_0x0FA8183DAD2B3203(), fParam1, 1, 250, 7);
}
...
int func_230(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_232(unk_0xACE5E491FC1B0D37(iParam1, 1) - unk_0xACE5E491FC1B0D37(iParam0, 1)) };
	...
	{
		Var3 = { func_232(unk_0x0E516C24C87F5D0C(iParam0, 31086, 0f, 5f, 0f) - unk_0x0E516C24C87F5D0C(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_239(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_232(Param1 - unk_0xACE5E491FC1B0D37(uParam0, 1)) };
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0xD4B321D9096B01FC(uParam0->f_35[0]))
			{
				...
				if (func_127(uParam0->f_35[0]))
				{
					unk_0x9E0EE3FF7D8C67E8(uParam0->f_35[0], 65, 0);
					unk_0xCDB2F1BE1F602D35(uParam0->f_35[0], 5, 0);
					unk_0x34F7B46842A3104F(uParam0->f_35[0], "28BNT310");
					unk_0x74861AF798EAAC89(uParam0->f_35[0], 0);
					unk_0x54B5C3A13D3588F0(uParam0->f_35[0], 10);
					unk_0x3FD465D1D51AC900(uParam0->f_35[0], 0);
...
int func_252(var uParam0, var uParam1)
{
	...
	if (unk_0xD4B321D9096B01FC(*uParam1) && unk_0x6DF9C43E3CC645BC(iLocal_94))
	{
		*uParam0 = unk_0xB983F26E7AFB47BF(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, 1, 1);
		unk_0x6705087D187F1047(*uParam0, "NI3_LNCH_CELEB");
		unk_0x0453EBC0FB8D8A80(*uParam0, 4, 0, 0, 0);
		unk_0xCC94EE23853F38E4(*uParam0, 1);
		Var0 = { unk_0xC12F91346EA13947(*uParam1, -0.2f, -1.8f, -1f) };
		fVar6 = (-90f + unk_0xD2809C7F7FD79247(*uParam1));
		Var3 = { 0f, 0f, fVar6 };
		unk_0xC67026146B0E835A(*uParam0, Var0, 0, 0, 1);
		unk_0xF3D48447FACBBE72(*uParam0, Var3, 2, 1);
		unk_0x01DF2D3988024DB4(*uParam0, *uParam1, 0, 0.2f, -1.8f, 0f, 0f, 0f, 90f, 0, 0, 0, 0, 2, 1);
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0xD4B321D9096B01FC(uParam0->f_35[1]))
			{
				...
				{
					unk_0x9E0EE3FF7D8C67E8(uParam0->f_35[1], 0, 0);
					unk_0x54B5C3A13D3588F0(uParam0->f_35[1], 10);
				}
			}
			if (bVar5)
			{
...
int func_266(var uParam0, var uParam1)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_259(&iVar0) || !unk_0xB25A0D192C6A0A5B(uParam0->f_48)) || !unk_0xB25A0D192C6A0A5B(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0x3B004D77F93A4D58(uParam0->f_28[0], 0, 0, 0, 0);
...
int func_270(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_259(&iVar0) || !unk_0xB25A0D192C6A0A5B(sVar4))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0x5D672CB011E20B28(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, sVar4, "dexy_stay_there", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, sVar4, "price_tag", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, sVar4, "such_a_good", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, sVar4, "this_looks", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x5D672CB011E20B28(0, sVar4, "who_would", 8f, -8f, -1, 0, 0, 0, 0, 0);
	...
	switch (iLocal_91)
	{
		...
		case 2:
			if (!unk_0xD4B321D9096B01FC(uParam0->f_35[0]))
			{
				...
				{
					unk_0x1ECAE5FB4DE78CF8(uParam0->f_35[0], 1084227584);
					unk_0x9E0EE3FF7D8C67E8(uParam0->f_35[0], 97, 97);
					unk_0xFA8246C40ECE4497(uParam0->f_35[0], 13.5f);
					unk_0xCDB2F1BE1F602D35(uParam0->f_35[0], 2, 0);
					unk_0x6A99D1F228E18F5B(uParam0->f_35[0], 2, 0, 1);
					unk_0x48AB9211DB740DB5(uParam0->f_35[0], 2, 0, 1f);
					unk_0x7DC20B8D2FDE9E56(uParam0->f_35[0]);
					return 0;
				}
			}
			if (func_127(uParam0->f_35[0]))
			{
				fVar9 = unk_0x43C4AA3B2D6164A1(uParam0->f_35[0], 2);
				if (!unk_0xFCF8BAC7DFF6CFEA(uParam0->f_35[0], 2) && fVar9 < 0.8f)
				{
					unk_0x48AB9211DB740DB5(uParam0->f_35[0], 2, 0, 1f);
				}
				else
		...
		case 3:
			if (func_127(uParam0->f_35[0]))
			{
				if (!unk_0xF6FD8019402CF03B(uParam0->f_35[0], sVar8, "idle_speedo", 3))
				{
					if (unk_0xB25A0D192C6A0A5B(sVar8))
					{
						unk_0x18C08175756EF1A5(uParam0->f_35[0], sVar8, "idle_speedo");
						return 0;
					}
					else
					{
			...
			if (func_127(uParam0->f_35[1]))
			{
				unk_0x9E0EE3FF7D8C67E8(uParam0->f_35[1], 27, 27);
			}
			func_273(&(uParam0->f_28[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			if (func_126(uParam0->f_28[0]))
			{
				unk_0x11BA22EEA4D73366(uParam0->f_28[0], 0);
				unk_0xC67026146B0E835A(uParam0->f_28[0], -1054.7f, 355.94f, 68.35f, 0, 0, 1);
				unk_0x5A2B7C446C0CF087(uParam0->f_28[0], 23.67f);
				unk_0x5D672CB011E20B28(uParam0->f_28[0], sVar8, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			...
			if (func_126(uParam0->f_28[1]))
			{
				...
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[1], 3, 0, 2, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[1], 4, 0, 0, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[1], 8, 0, 1, 0);
				unk_0x11BA22EEA4D73366(uParam0->f_28[1], 0);
				uParam0->f_59 = unk_0xF2A54C51C03CADAA(-1059f, 360.976f, 69f, 0f, 0f, -1.08f, 2);
				unk_0x3F8774A014F77C2D(uParam0->f_59, 1);
				unk_0xC8210337A7389E13(uParam0->f_59, 0);
				unk_0x8582CCEB95B1F1BE(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "base_girl", 1000f, -8f, 592, 0, 1148846080, 0);
			}
			func_273(&(uParam0->f_28[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			if (func_126(uParam0->f_28[2]))
			{
				unk_0x987CAFE10CF766ED(uParam0->f_28[2]);
				unk_0xC67026146B0E835A(uParam0->f_28[2], -1012.57f, 357.48f, 70.62f, 0, 0, 1);
				unk_0x0BBBAC4546BFE280(uParam0->f_28[2], 160, 0);
				if (unk_0xB25A0D192C6A0A5B(sVar8))
				{
					unk_0x5D672CB011E20B28(uParam0->f_28[2], sVar8, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
				}
			}
			func_272(&(uParam0->f_41[0]), iVar0[5], -1050.03f, 368.95f, 69.29f, -11.27f);
			if (func_127(uParam0->f_41[0]))
			{
				unk_0xF3D48447FACBBE72(uParam0->f_41[0], 0f, 0f, -11.27f, 2, 1);
				unk_0xE679FB04E61F88AA(uParam0->f_41[0], 0);
				unk_0x04F5A8AA60EC662B(uParam0->f_41[0], 1);
				unk_0xE247C08E02044243(uParam0->f_41[0], 0);
			...
			unk_0x7D74D6A091150B86(uParam0->f_48);
			unk_0x7D74D6A091150B86(sVar8);
			return 1;
			break;
	}
	return 0;
...
int func_275(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			uParam0->f_59 = -1;
			func_262(38, 1);
			uVar9 = unk_0x2BA8B1187A604700(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
			if (unk_0x61837007ACF2F2C2(uVar9))
			{
				unk_0x996621493F6A3486(iVar9);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0x6BB2B1818CAE531E(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x36B659209EBDD366(uParam0->f_48);
			iLocal_91 = 1;
		...
		case 1:
			if (!func_259(&iVar0) || !unk_0xB25A0D192C6A0A5B(uParam0->f_48))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_126(uParam0->f_28[1]))
			{
				unk_0x6E712A176E3EEFA8(uParam0->f_28[1], 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[1], 0, 1, 0, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[1], 2, 0, 2, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[1], 3, 1, 2, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[1], 4, 0, 1, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[1], 7, 0, 1, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[1], 8, 1, 0, 0);
			}
			uParam0->f_59 = unk_0xF2A54C51C03CADAA(-552.18f, 285.476f, 81.976f, 0f, 0f, 79.5f, 2);
			unk_0x3F8774A014F77C2D(uParam0->f_59, 1);
			unk_0xC8210337A7389E13(uParam0->f_59, 0);
			if (func_126(uParam0->f_28[0]))
			{
				unk_0x8582CCEB95B1F1BE(uParam0->f_28[0], uParam0->f_59, uParam0->f_48, "BASE_02_Willie", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			if (func_126(uParam0->f_28[1]))
			{
				unk_0x8582CCEB95B1F1BE(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "BASE_02_GIRL", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			...
			if (func_126(uParam0->f_28[2]))
			{
				...
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[2], 2, 1, 2, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[2], 3, 1, 1, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[2], 4, 1, 0, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[2], 7, 1, 0, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[2], 8, 1, 0, 0);
			}
			if (func_126(uParam0->f_28[3]))
			{
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[3], 0, 1, 1, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[3], 2, 1, 0, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[3], 3, 1, 0, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[3], 4, 1, 1, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[3], 7, 1, 0, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[3], 8, 1, 0, 0);
			}
			if (func_126(uParam0->f_28[4]))
			{
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[4], 0, 0, 0, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[4], 2, 0, 2, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[4], 3, 0, 0, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[4], 4, 0, 1, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[4], 8, 0, 0, 0);
			}
			if (func_126(uParam0->f_28[5]))
			{
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[5], 0, 1, 0, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[5], 2, 2, 0, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[5], 3, 0, 3, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[5], 4, 1, 0, 0);
				unk_0x0453EBC0FB8D8A80(uParam0->f_28[5], 8, 0, 2, 0);
			}
			func_253(&(uParam0->f_35[0]), iVar0[6], -553.55f, 308.61f, 82.81f, 202.78f);
			if (func_127(uParam0->f_35[0]))
			{
				unk_0xA429E610637A53F5(uParam0->f_35[0], 1);
				unk_0x54B5C3A13D3588F0(uParam0->f_35[0], 1);
				unk_0xE247C08E02044243(uParam0->f_35[0], 0);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0xE0AC40EF164A2569(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x7D74D6A091150B86(uParam0->f_48);
			return 1;
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_127(uParam0->f_28[0]) && func_127(uParam0->f_28[1]))
			{
				unk_0xCC94EE23853F38E4(uParam0->f_28[0], 1);
				unk_0xCC94EE23853F38E4(uParam0->f_28[1], 1);
				uVar5 = unk_0xF2A54C51C03CADAA(-1100.558f, 789.8862f, 163.3285f, 0f, 0f, 0f, 2);
				unk_0x8582CCEB95B1F1BE(uParam0->f_28[0], uVar5, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1148846080, 0);
				unk_0x8582CCEB95B1F1BE(uParam0->f_28[1], uVar5, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1148846080, 0);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_297(int iParam0, int iParam1, bool bParam2)
{
	...
	if (unk_0x39A01A052D9B5FF0(uLocal_109))
	{
		unk_0xAA2276003B2ADF1B(&uLocal_109);
	}
	if (bParam2)
	{
	...
	switch (*iParam0)
	{
		case 43:
			if (iParam1->f_1 != -1)
			{
				unk_0x0972EA9E8102C153(iParam1->f_1);
			}
			break;
	}
...
void func_312(var uParam0)
{
	if (unk_0xB50E39CA0A3E6020(uParam0->f_59))
	{
		if (func_126(uParam0->f_28[1]))
		{
			...
			unk_0x1498B6B9F7C33B0A(uParam0->f_28[1], -1000f, 1);
		}
	}
}
