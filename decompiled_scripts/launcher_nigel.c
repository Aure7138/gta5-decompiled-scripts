...
void __EntryFunction__()
{
	...
	if (unk_0x7547D7CF93115D6D(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_96260[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_295(&(Global_96260[Var0.f_0 /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		if (Var0.f_0 == 42)
		{
			...
			{
				unk_0x71D9E46EE013306A(func_187(), 4, 0, 0, func_186());
				func_296("Nigel 2 : set Di Napoli's cutscene trousers variation in launcher");
			}
		}
		if (func_185(&uLocal_95) && Var0.f_0 == 37)
		{
			func_182(Var0.f_28[1], &uLocal_95, Var0.f_0);
		}
		if (Var0.f_0 == 37)
		{
...
int func_168(int iParam0)
{
	...
	if (func_111(unk_0x507DA4994C3D8EBD()))
	{
		...
		{
			if (unk_0xFD68187442384158(iParam0->f_28[iVar0]))
			{
				if (func_111(iParam0->f_28[iVar0]))
				{
					if (unk_0x6255AE2591FE7603(iParam0->f_28[iVar0], unk_0x507DA4994C3D8EBD(), 1) || unk_0x0982F2F40B035E77(unk_0xBF1B13057E5119A4(iParam0->f_28[iVar0], 1), 7.5f, 1))
					{
						if (func_159(2))
						{
							func_156(iParam0->f_27, *iParam0);
...
{
	if (func_170(uParam1, unk_0xBF1B13057E5119A4(unk_0x507DA4994C3D8EBD(), 1)))
	{
		if (func_159(2))
		{
			if (func_157(iParam0->f_27))
...
void func_171(int iParam0, var uParam1, var uParam2)
{
	if (func_111(*uParam1))
	{
		...
		{
			case 0:
				if (unk_0xF08CFB68522305B2("CAR_TRUNK_THUMPS", 0))
				{
					iParam0->f_1 = unk_0xCA225EEF4090469C();
					iParam0->f_2 = unk_0xF976C624234A4AA8();
					iParam0->f_3 = unk_0x4D3E68F73B727E49(6000, 12000);
					*iParam0 = 1;
				}
				break;
			
			case 1:
				if ((unk_0xF976C624234A4AA8() - iParam0->f_2) > iParam0->f_3)
				{
					unk_0xE89B40A4D255370C(iParam0->f_1, "TRUNK_THUMPS", unk_0x0CAFB9D38494283D(*uParam1, 0f, -2.2f, 0.5f), 0, 0, 0, 0);
					unk_0xD5197208E9370D3D(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_172(0), 0);
					iParam0->f_4 = unk_0x4D3E68F73B727E49(3, 7);
					iParam0->f_5 = 0;
					iParam0->f_6 = unk_0xF976C624234A4AA8();
					iParam0->f_7 = unk_0x4D3E68F73B727E49(100, 250);
					*iParam0 = 2;
				}
				break;
			
			case 2:
				if ((unk_0xF976C624234A4AA8() - iParam0->f_6) > iParam0->f_7)
				{
					iParam0->f_8 = unk_0x4D3E68F73B727E49(-200, -120);
					iParam0->f_9 = (0.5f * unk_0xBBDA792448DB5A89(unk_0x4D3E68F73B727E49(-2, 3)));
					unk_0x5784591F4D03884C(*uParam1, 1, 0f, 0f, IntToFloat(iParam0->f_8), iParam0->f_9, -1.5f, 0f, 0, 1, 1, 0, 1, 1);
					iParam0->f_5++;
					if (iParam0->f_5 < iParam0->f_4)
					{
						iParam0->f_6 = unk_0xF976C624234A4AA8();
						iParam0->f_7 = unk_0x4D3E68F73B727E49(150, 280);
					}
					else
					{
						iParam0->f_2 = unk_0xF976C624234A4AA8();
...
int func_173(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_111(unk_0x507DA4994C3D8EBD()) && func_111(iParam0->f_28[0])) && !func_128()) && (unk_0xF976C624234A4AA8() - iParam0->f_60) > iParam8) && func_177(unk_0x507DA4994C3D8EBD(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_178(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_159(2))
		{
			if (!func_128())
			{
				if (((func_111(unk_0x507DA4994C3D8EBD()) && func_111(iParam0->f_28[0])) && func_111(iParam0->f_28[1])) && func_177(unk_0x507DA4994C3D8EBD(), Param1, 1) < 20f)
				{
			...
			else if (((func_180(sParam5) && !*uParam10 == 1) && func_111(unk_0x507DA4994C3D8EBD())) && func_177(unk_0x507DA4994C3D8EBD(), Param1, 1) >= 20f)
			{
				func_296("pause conversation");
				func_179(1);
				*uParam10 = 1;
			}
			if (func_177(unk_0x507DA4994C3D8EBD(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
int func_196(var uParam0, bool bParam1)
{
	...
	if ((func_229(*uParam0) || func_227(*uParam0)) || Global_68312 == 1)
	{
		return 1;
	}
	if (!unk_0x3BCCCFB165E15A65())
			...
			if (unk_0xFD68187442384158(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_201(unk_0x507DA4994C3D8EBD(), uParam0->f_35[iVar0]))
							{
...
int func_204(int iParam0, float fParam1)
{
	...
	{
		if (func_215(iParam0) || unk_0x8DEF14B60C4A9D01(unk_0xAF65E5A58BE87D95(), iParam0))
		{
...
{
	return func_206(iParam0, unk_0x507DA4994C3D8EBD(), fParam1, 1, 250, 7);
}
...
int func_210(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_212(unk_0xBF1B13057E5119A4(iParam1, 1) - unk_0xBF1B13057E5119A4(iParam0, 1)) };
	...
	{
		Var3 = { func_212(unk_0xC5B1818639240D24(iParam0, 31086, 0f, 5f, 0f) - unk_0xC5B1818639240D24(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_219(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_212(Param1 - unk_0xBF1B13057E5119A4(uParam0, 1)) };
...
{
	if ((func_228() && Global_89784.f_11 == 6) && iParam0 == func_146(&(Global_89784.f_3), 0))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_90)
	{
		...
		case 2:
			...
			if (!unk_0xFD68187442384158(uParam0->f_35[0]))
			{
				...
				if (func_111(uParam0->f_35[0]))
				{
					unk_0x2972E055244638AD(uParam0->f_35[0], 65, 0);
					unk_0xC7523792059C60E4(uParam0->f_35[0], 5, 0);
					unk_0x0BC897C4AD5A4F17(uParam0->f_35[0], "28BNT310");
					unk_0x4181147B4609CD58(uParam0->f_35[0], 0);
					unk_0xCDC1FD4387DA32EC(uParam0->f_35[0], 10);
					unk_0x95F0524EC2321783(uParam0->f_35[0], 0);
...
int func_232(var uParam0, var uParam1)
{
	...
	if (unk_0xFD68187442384158(*uParam1) && unk_0xD291857D0C9C7FEC(iLocal_93))
	{
		*uParam0 = unk_0x7B88529CAE3B7F15(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, 1, 1);
		unk_0x3F671607BC1804B5(*uParam0, "NI3_LNCH_CELEB");
		unk_0xF2685765B7BEBCB0(*uParam0, 4, 0, 0, 0);
		unk_0x2DC5B31EBB810396(*uParam0, 1);
		Var0 = { unk_0x0CAFB9D38494283D(*uParam1, -0.2f, -1.8f, -1f) };
		fVar6 = (-90f + unk_0xA9D6B28E708753B6(*uParam1));
		Var3 = { 0f, 0f, fVar6 };
		unk_0x5614D4217C75FFE5(*uParam0, Var0, 0, 0, 1);
		unk_0xC1619F9F00BCB470(*uParam0, Var3, 2, 1);
		unk_0x26030664C7D28388(*uParam0, *uParam1, 0, 0.2f, -1.8f, 0f, 0f, 0f, 90f, 0, 0, 0, 0, 2, 1);
	...
	switch (iLocal_90)
	{
		...
		case 2:
			...
			if (!unk_0xFD68187442384158(uParam0->f_35[1]))
			{
				...
				{
					unk_0x2972E055244638AD(uParam0->f_35[1], 0, 0);
					unk_0xCDC1FD4387DA32EC(uParam0->f_35[1], 10);
				}
			}
			if (bVar5)
			{
...
void func_242(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				uLocal_106 = unk_0x92832F671263F8E0(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
				unk_0xF81DFFDCEDAA4951("WORLD_HUMAN_GUARD_STAND", 0);
				unk_0xF81DFFDCEDAA4951("WORLD_HUMAN_CLIPBOARD", 0);
				unk_0xF81DFFDCEDAA4951("WORLD_VEHICLE_DRIVE_SOLO", 0);
		...
		case 39:
			if (bParam1)
			{
				uLocal_106 = unk_0x92832F671263F8E0(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
		...
		case 41:
			if (bParam1)
			{
				uLocal_106 = unk_0x92832F671263F8E0(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
		...
		case 42:
			if (bParam1)
			{
				uLocal_106 = unk_0x92832F671263F8E0(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
...
int func_246(var uParam0, var uParam1)
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if ((!func_239(&iVar0) || !unk_0xCE40391AB65FE305(uParam0->f_48)) || !unk_0xCE40391AB65FE305(sVar8))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			...
			unk_0x06543DA07CCCC7F5(uParam0->f_28[0], 0, 0, 0, 0);
...
int func_250(var uParam0)
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if (!func_239(&iVar0) || !unk_0xCE40391AB65FE305(sVar4))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			...
			unk_0xEC0A546609840086(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEC0A546609840086(0, sVar4, "dexy_stay_there", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEC0A546609840086(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEC0A546609840086(0, sVar4, "price_tag", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEC0A546609840086(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEC0A546609840086(0, sVar4, "such_a_good", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEC0A546609840086(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEC0A546609840086(0, sVar4, "this_looks", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEC0A546609840086(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEC0A546609840086(0, sVar4, "who_would", 8f, -8f, -1, 0, 0, 0, 0, 0);
	...
	switch (iLocal_90)
	{
		...
		case 2:
			if (!unk_0xFD68187442384158(uParam0->f_35[0]))
			{
				...
				{
					unk_0xD90C30D269B19096(uParam0->f_35[0]);
					unk_0x2972E055244638AD(uParam0->f_35[0], 97, 97);
					unk_0xBEFA69C2C9E8754D(uParam0->f_35[0], 13.5f);
					unk_0xC7523792059C60E4(uParam0->f_35[0], 2, 0);
					unk_0xE25E46198A369207(uParam0->f_35[0], 2, 0, 1);
					unk_0x377AA6DD990C0D26(uParam0->f_35[0], 2, 0, 1f);
					unk_0x4A99017CF06B75D9(uParam0->f_35[0]);
					return 0;
				}
			}
			if (func_111(uParam0->f_35[0]))
			{
				fVar9 = unk_0x790D2A28F6320CC8(uParam0->f_35[0], 2);
				if (!unk_0xA0D5C9E71EAFB346(uParam0->f_35[0], 2) && fVar9 < 0.8f)
				{
					unk_0x377AA6DD990C0D26(uParam0->f_35[0], 2, 0, 1f);
				}
				else
		...
		case 3:
			if (func_111(uParam0->f_35[0]))
			{
				if (!unk_0x22605DE2E6933CF2(uParam0->f_35[0], sVar8, "idle_speedo", 3))
				{
					if (unk_0xCE40391AB65FE305(sVar8))
					{
						unk_0xF1D4D0F36FDE4539(uParam0->f_35[0], sVar8, "idle_speedo");
						return 0;
					}
					else
					{
			...
			if (func_111(uParam0->f_35[1]))
			{
				unk_0x2972E055244638AD(uParam0->f_35[1], 27, 27);
			}
			func_253(&(uParam0->f_28[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			if (func_110(uParam0->f_28[0]))
			{
				unk_0x89A2F145B2FE98D8(uParam0->f_28[0], 0);
				unk_0x5614D4217C75FFE5(uParam0->f_28[0], -1054.7f, 355.94f, 68.35f, 0, 0, 1);
				unk_0x248DC16118AE5035(uParam0->f_28[0], 23.67f);
				unk_0xEC0A546609840086(uParam0->f_28[0], sVar8, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			...
			if (func_110(uParam0->f_28[1]))
			{
				...
				unk_0xF2685765B7BEBCB0(uParam0->f_28[1], 3, 0, 2, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[1], 4, 0, 0, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[1], 8, 0, 1, 0);
				unk_0x89A2F145B2FE98D8(uParam0->f_28[1], 0);
				uParam0->f_59 = unk_0x1BEDF9ACAEAB15F8(-1059f, 360.976f, 69f, 0f, 0f, -1.08f, 2);
				unk_0x15B365C4645F79B8(uParam0->f_59, 1);
				unk_0x36069312B76436F6(uParam0->f_59, 0);
				unk_0x206610E40EE4D7D9(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "base_girl", 1000f, -8f, 592, 0, 1148846080, 0);
			}
			func_253(&(uParam0->f_28[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			if (func_110(uParam0->f_28[2]))
			{
				unk_0x4376624421FB329B(uParam0->f_28[2]);
				unk_0x5614D4217C75FFE5(uParam0->f_28[2], -1012.57f, 357.48f, 70.62f, 0, 0, 1);
				unk_0x3E16CE93BAE616EE(uParam0->f_28[2], 160);
				if (unk_0xCE40391AB65FE305(sVar8))
				{
					unk_0xEC0A546609840086(uParam0->f_28[2], sVar8, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
				}
			}
			func_252(&(uParam0->f_41[0]), iVar0[5], -1050.03f, 368.95f, 69.29f, -11.27f);
			if (func_111(uParam0->f_41[0]))
			{
				unk_0xC1619F9F00BCB470(uParam0->f_41[0], 0f, 0f, -11.27f, 2, 1);
				unk_0x843E25883D2C32A3(uParam0->f_41[0], 0);
				unk_0xF732465E1FF70CE4(uParam0->f_41[0], 1);
				unk_0x76527CDA9FF31B20(uParam0->f_41[0], 0);
			...
			unk_0xA878656BC39BBC51(uParam0->f_48);
			unk_0xA878656BC39BBC51(sVar8);
			return 1;
			break;
	}
	return 0;
...
int func_255(var uParam0)
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			uParam0->f_59 = -1;
			func_242(38, 1);
			uVar9 = unk_0x9C3273B36FEFD46F(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
			if (unk_0x93AF5BB44F9A2E1B(uVar9))
			{
				unk_0x37F4E82E5B10AADF(iVar9);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0xCBE6AC5010E5CE5C(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x395C5D98343F0040(uParam0->f_48);
			iLocal_90 = 1;
		...
		case 1:
			if (!func_239(&iVar0) || !unk_0xCE40391AB65FE305(uParam0->f_48))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			...
			if (func_110(uParam0->f_28[1]))
			{
				unk_0x6A750A31D18DA81A(uParam0->f_28[1], 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[1], 0, 1, 0, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[1], 2, 0, 2, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[1], 3, 1, 2, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[1], 4, 0, 1, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[1], 7, 0, 1, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[1], 8, 1, 0, 0);
			}
			uParam0->f_59 = unk_0x1BEDF9ACAEAB15F8(-552.18f, 285.476f, 81.976f, 0f, 0f, 79.5f, 2);
			unk_0x15B365C4645F79B8(uParam0->f_59, 1);
			unk_0x36069312B76436F6(uParam0->f_59, 0);
			if (func_110(uParam0->f_28[0]))
			{
				unk_0x206610E40EE4D7D9(uParam0->f_28[0], uParam0->f_59, uParam0->f_48, "BASE_02_Willie", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			if (func_110(uParam0->f_28[1]))
			{
				unk_0x206610E40EE4D7D9(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "BASE_02_GIRL", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			...
			if (func_110(uParam0->f_28[2]))
			{
				...
				unk_0xF2685765B7BEBCB0(uParam0->f_28[2], 2, 1, 2, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[2], 3, 1, 1, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[2], 4, 1, 0, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[2], 7, 1, 0, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[2], 8, 1, 0, 0);
			}
			if (func_110(uParam0->f_28[3]))
			{
				unk_0xF2685765B7BEBCB0(uParam0->f_28[3], 0, 1, 1, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[3], 2, 1, 0, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[3], 3, 1, 0, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[3], 4, 1, 1, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[3], 7, 1, 0, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[3], 8, 1, 0, 0);
			}
			if (func_110(uParam0->f_28[4]))
			{
				unk_0xF2685765B7BEBCB0(uParam0->f_28[4], 0, 0, 0, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[4], 2, 0, 2, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[4], 3, 0, 0, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[4], 4, 0, 1, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[4], 8, 0, 0, 0);
			}
			if (func_110(uParam0->f_28[5]))
			{
				unk_0xF2685765B7BEBCB0(uParam0->f_28[5], 0, 1, 0, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[5], 2, 2, 0, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[5], 3, 0, 3, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[5], 4, 1, 0, 0);
				unk_0xF2685765B7BEBCB0(uParam0->f_28[5], 8, 0, 2, 0);
			}
			...
			if (func_111(uParam0->f_35[0]))
			{
				...
				unk_0x76527CDA9FF31B20(uParam0->f_35[0], 0);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0xFF467904A8A12BBE(iVar0[iVar8]);
				iVar8++;
			}
			unk_0xA878656BC39BBC51(uParam0->f_48);
			return 1;
	...
	switch (iLocal_90)
	{
		...
		case 3:
			if (func_111(uParam0->f_28[0]) && func_111(uParam0->f_28[1]))
			{
				unk_0x2DC5B31EBB810396(uParam0->f_28[0], 1);
				unk_0x2DC5B31EBB810396(uParam0->f_28[1], 1);
				uVar5 = unk_0x1BEDF9ACAEAB15F8(-1100.558f, 789.8862f, 163.3285f, 0f, 0f, 0f, 2);
				unk_0x206610E40EE4D7D9(uParam0->f_28[0], uVar5, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1148846080, 0);
				unk_0x206610E40EE4D7D9(uParam0->f_28[1], uVar5, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1148846080, 0);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
int func_276(struct<3> Param0, struct<3> Param3, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_277(int iParam0, int iParam1, bool bParam2)
{
	...
	if (unk_0xD361727124133DF3(uLocal_108))
	{
		unk_0xA0A65B537B1F11EC(&uLocal_108);
	}
	if (bParam2)
	{
	...
	switch (*iParam0)
	{
		case 43:
			if (iParam1->f_1 != -1)
			{
				unk_0x71EA2F1D0184D8C7(iParam1->f_1);
			}
			break;
	}
...
void func_292(var uParam0)
{
	if (unk_0x1955A5B9B65FEEBD(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[1]))
		{
			...
			unk_0x520A583BA5E4F9A7(uParam0->f_28[1], -1000f, 1);
		}
	}
}
