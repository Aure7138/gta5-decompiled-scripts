...
void __EntryFunction__()
{
	...
	if (unk_0xBCA819F9975BEDFA(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_100787[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_298(&(Global_100787[Var0.f_0 /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		if (Var0.f_0 == 42)
		{
			...
			{
				unk_0x5C9E441B0B13FC8B(func_190(), 4, 0, 0, func_189());
...
int func_171(int iParam0)
{
	...
	if (func_112(unk_0x17B5CC8A8615737D()))
	{
		...
		{
			if (unk_0x23E9113C762466ED(iParam0->f_28[iVar0]))
			{
				if (func_112(iParam0->f_28[iVar0]))
				{
					if (unk_0xC017443DBE6DA4D6(iParam0->f_28[iVar0], unk_0x17B5CC8A8615737D(), 1) || unk_0x579A94EB2BF9398F(unk_0x57240623C1BC6E88(iParam0->f_28[iVar0], 1), 7.5f, 1))
					{
						if (func_162(2))
						{
							func_159(iParam0->f_27, *iParam0);
...
{
	if (func_173(uParam1, unk_0x57240623C1BC6E88(unk_0x17B5CC8A8615737D(), 1)))
	{
		if (func_162(2))
		{
			if (func_160(iParam0->f_27))
...
void func_174(int iParam0, var uParam1, var uParam2)
{
	if (func_112(*uParam1))
	{
		...
		{
			case 0:
				if (unk_0x985A2515CBAF7290("CAR_TRUNK_THUMPS", 0, -1))
				{
					iParam0->f_1 = unk_0x3DF2C10FD29336A3();
					iParam0->f_2 = unk_0x94E3E074F38DF86C();
					iParam0->f_3 = unk_0x0E29C61F26D96FDB(6000, 12000);
					*iParam0 = 1;
				}
				break;
			
			case 1:
				if ((unk_0x94E3E074F38DF86C() - iParam0->f_2) > iParam0->f_3)
				{
					unk_0x4876B73C5A534970(iParam0->f_1, "TRUNK_THUMPS", unk_0x854ED33E6D715648(*uParam1, 0f, -2.2f, 0.5f), 0, 0, 0, 0);
					unk_0xECF05B7D463A3321(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_175(0), 0);
					iParam0->f_4 = unk_0x0E29C61F26D96FDB(3, 7);
					iParam0->f_5 = 0;
					iParam0->f_6 = unk_0x94E3E074F38DF86C();
					iParam0->f_7 = unk_0x0E29C61F26D96FDB(100, 250);
					*iParam0 = 2;
				}
				break;
			
			case 2:
				if ((unk_0x94E3E074F38DF86C() - iParam0->f_6) > iParam0->f_7)
				{
					iParam0->f_8 = unk_0x0E29C61F26D96FDB(-200, -120);
					iParam0->f_9 = (0.5f * unk_0xBBDA792448DB5A89(unk_0x0E29C61F26D96FDB(-2, 3)));
					unk_0x5C9883713FC5A923(*uParam1, 1, 0f, 0f, IntToFloat(iParam0->f_8), iParam0->f_9, -1.5f, 0f, 0, 1, 1, 0, 1, 1);
					iParam0->f_5++;
					if (iParam0->f_5 < iParam0->f_4)
					{
						iParam0->f_6 = unk_0x94E3E074F38DF86C();
						iParam0->f_7 = unk_0x0E29C61F26D96FDB(150, 280);
					}
					else
					{
						iParam0->f_2 = unk_0x94E3E074F38DF86C();
...
int func_176(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_112(unk_0x17B5CC8A8615737D()) && func_112(iParam0->f_28[0])) && !func_130()) && (unk_0x94E3E074F38DF86C() - iParam0->f_60) > iParam8) && func_180(unk_0x17B5CC8A8615737D(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_181(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_162(2))
		{
			if (!func_130())
			{
				if (((func_112(unk_0x17B5CC8A8615737D()) && func_112(iParam0->f_28[0])) && func_112(iParam0->f_28[1])) && func_180(unk_0x17B5CC8A8615737D(), Param1, 1) < 20f)
				{
			...
			else if (((func_183(sParam5) && !*uParam10 == 1) && func_112(unk_0x17B5CC8A8615737D())) && func_180(unk_0x17B5CC8A8615737D(), Param1, 1) >= 20f)
			{
				func_299("pause conversation");
				func_182(1);
				*uParam10 = 1;
			}
			if (func_180(unk_0x17B5CC8A8615737D(), Param1, 1) < 20f && *uParam10 == 1)
			{
			...
			if (unk_0x23E9113C762466ED(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_204(unk_0x17B5CC8A8615737D(), uParam0->f_35[iVar0]))
							{
...
int func_207(int iParam0, float fParam1)
{
	...
	{
		if (func_218(iParam0) || unk_0x5ADC20A7C6AB8336(unk_0xBE369BE1BC57A796(), iParam0))
		{
...
{
	return func_209(iParam0, unk_0x17B5CC8A8615737D(), fParam1, 1, 250, 7);
}
...
int func_213(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_215(unk_0x57240623C1BC6E88(iParam1, 1) - unk_0x57240623C1BC6E88(iParam0, 1)) };
	...
	{
		Var3 = { func_215(unk_0x425DAA25CBB7EDE2(iParam0, 31086, 0f, 5f, 0f) - unk_0x425DAA25CBB7EDE2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_222(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_215(Param1 - unk_0x57240623C1BC6E88(uParam0, 1)) };
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x23E9113C762466ED(uParam0->f_35[0]))
			{
				...
				if (func_112(uParam0->f_35[0]))
				{
					unk_0x357EE036FE09513D(uParam0->f_35[0], 65, 0);
					unk_0x114D595E662E3EFD(uParam0->f_35[0], 5, 0);
					unk_0xBFA6D869BA395202(uParam0->f_35[0], "28BNT310");
					unk_0xE0B7A718D08DF2B6(uParam0->f_35[0], 0);
					unk_0xD602D152E57C823D(uParam0->f_35[0], 10);
					unk_0x930207476D7C5D02(uParam0->f_35[0], 0);
...
int func_235(var uParam0, var uParam1)
{
	...
	if (unk_0x23E9113C762466ED(*uParam1) && unk_0x9F746898F7881612(iLocal_94))
	{
		*uParam0 = unk_0x2AD5F4170F4ACBEB(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, 1, 1);
		unk_0x3BEB2E27EBD72589(*uParam0, "NI3_LNCH_CELEB");
		unk_0x2F933BB106547968(*uParam0, 4, 0, 0, 0);
		unk_0xCC61640A821F277C(*uParam0, 1);
		Var0 = { unk_0x854ED33E6D715648(*uParam1, -0.2f, -1.8f, -1f) };
		fVar6 = (-90f + unk_0x638527C9799F2AE4(*uParam1));
		Var3 = { 0f, 0f, fVar6 };
		unk_0x394AE1BE8F25AC5B(*uParam0, Var0, 0, 0, 1);
		unk_0x04A5FAE5B1EB8E28(*uParam0, Var3, 2, 1);
		unk_0x593C85206F061E3E(*uParam0, *uParam1, 0, 0.2f, -1.8f, 0f, 0f, 0f, 90f, 0, 0, 0, 0, 2, 1);
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x23E9113C762466ED(uParam0->f_35[1]))
			{
				...
				{
					unk_0x357EE036FE09513D(uParam0->f_35[1], 0, 0);
					unk_0xD602D152E57C823D(uParam0->f_35[1], 10);
				}
			}
			if (bVar5)
			{
...
int func_249(var uParam0, var uParam1)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_242(&iVar0) || !unk_0xF4F8AE8DD0F08C1E(uParam0->f_48)) || !unk_0xF4F8AE8DD0F08C1E(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_253(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_242(&iVar0) || !unk_0xF4F8AE8DD0F08C1E(sVar4))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0xEB1EFACA68933402(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, sVar4, "dexy_stay_there", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, sVar4, "price_tag", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, sVar4, "such_a_good", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, sVar4, "this_looks", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0xEB1EFACA68933402(0, sVar4, "who_would", 8f, -8f, -1, 0, 0, 0, 0, 0);
	...
	switch (iLocal_91)
	{
		...
		case 2:
			if (!unk_0x23E9113C762466ED(uParam0->f_35[0]))
			{
				...
				{
					unk_0x482AE8C0EAF5AE07(uParam0->f_35[0], 1084227584);
					unk_0x357EE036FE09513D(uParam0->f_35[0], 97, 97);
					unk_0xC2BFC2AEE65D5595(uParam0->f_35[0], 13.5f);
					unk_0x114D595E662E3EFD(uParam0->f_35[0], 2, 0);
					unk_0xDE043EE8B3F02B86(uParam0->f_35[0], 2, 0, 1);
					unk_0x800D9F6E9FDC9680(uParam0->f_35[0], 2, 0, 1f);
					unk_0x464F1CA52B023D8D(uParam0->f_35[0]);
					return 0;
				}
			}
			if (func_112(uParam0->f_35[0]))
			{
				fVar9 = unk_0x7F841F0B66D99047(uParam0->f_35[0], 2);
				if (!unk_0x8358BFE2634F295E(uParam0->f_35[0], 2) && fVar9 < 0.8f)
				{
					unk_0x800D9F6E9FDC9680(uParam0->f_35[0], 2, 0, 1f);
				}
				else
		...
		case 3:
			if (func_112(uParam0->f_35[0]))
			{
				if (!unk_0x5132972D2BBC5A62(uParam0->f_35[0], sVar8, "idle_speedo", 3))
				{
					if (unk_0xF4F8AE8DD0F08C1E(sVar8))
					{
						unk_0x0F54253A1DFBE9B0(uParam0->f_35[0], sVar8, "idle_speedo");
						return 0;
					}
					else
					{
			...
			if (func_112(uParam0->f_35[1]))
			{
				unk_0x357EE036FE09513D(uParam0->f_35[1], 27, 27);
			}
			func_256(&(uParam0->f_28[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			if (func_111(uParam0->f_28[0]))
			{
				unk_0x2BFFCC859E7DDFFF(uParam0->f_28[0], 0);
				unk_0x394AE1BE8F25AC5B(uParam0->f_28[0], -1054.7f, 355.94f, 68.35f, 0, 0, 1);
				unk_0x0608D50823C6AA6D(uParam0->f_28[0], 23.67f);
				unk_0xEB1EFACA68933402(uParam0->f_28[0], sVar8, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			...
			if (func_111(uParam0->f_28[1]))
			{
				...
				unk_0x2F933BB106547968(uParam0->f_28[1], 3, 0, 2, 0);
				unk_0x2F933BB106547968(uParam0->f_28[1], 4, 0, 0, 0);
				unk_0x2F933BB106547968(uParam0->f_28[1], 8, 0, 1, 0);
				unk_0x2BFFCC859E7DDFFF(uParam0->f_28[1], 0);
				uParam0->f_59 = unk_0x356EABB012B22D07(-1059f, 360.976f, 69f, 0f, 0f, -1.08f, 2);
				unk_0x8B06F7FDDA8B98FB(uParam0->f_59, 1);
				unk_0xD3BB86584359B533(uParam0->f_59, 0);
				unk_0xA17D768ED938600C(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "base_girl", 1000f, -8f, 592, 0, 1148846080, 0);
			}
			func_256(&(uParam0->f_28[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			if (func_111(uParam0->f_28[2]))
			{
				unk_0x7F73E2B58861632F(uParam0->f_28[2]);
				unk_0x394AE1BE8F25AC5B(uParam0->f_28[2], -1012.57f, 357.48f, 70.62f, 0, 0, 1);
				unk_0x4B04B4FAE554FA03(uParam0->f_28[2], 160);
				if (unk_0xF4F8AE8DD0F08C1E(sVar8))
				{
					unk_0xEB1EFACA68933402(uParam0->f_28[2], sVar8, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
				}
			}
			func_255(&(uParam0->f_41[0]), iVar0[5], -1050.03f, 368.95f, 69.29f, -11.27f);
			if (func_112(uParam0->f_41[0]))
			{
				unk_0x04A5FAE5B1EB8E28(uParam0->f_41[0], 0f, 0f, -11.27f, 2, 1);
				unk_0xC3085A602BCA8C13(uParam0->f_41[0], 0);
				unk_0xC6042F55A6EA17B2(uParam0->f_41[0], 1);
				unk_0xABCF7963E043518F(uParam0->f_41[0], 0);
			...
			unk_0xF9FFB9857F3120F8(uParam0->f_48);
			unk_0xF9FFB9857F3120F8(sVar8);
			return 1;
			break;
	}
	return 0;
...
int func_258(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			uParam0->f_59 = -1;
			func_245(38, 1);
			uVar9 = unk_0xCA0D2B42E97CB506(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
			if (unk_0x623BDE1B17A9D9E3(uVar9))
			{
				unk_0xCA6CBCAD7B35C261(iVar9);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0xE1324F59713746FA(iVar0[iVar8]);
				iVar8++;
			}
			unk_0xA0E7D0E8FE126EE8(uParam0->f_48);
			iLocal_91 = 1;
		...
		case 1:
			if (!func_242(&iVar0) || !unk_0xF4F8AE8DD0F08C1E(uParam0->f_48))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_111(uParam0->f_28[1]))
			{
				unk_0x6F65279C9BC14EDB(uParam0->f_28[1], 0);
				unk_0x2F933BB106547968(uParam0->f_28[1], 0, 1, 0, 0);
				unk_0x2F933BB106547968(uParam0->f_28[1], 2, 0, 2, 0);
				unk_0x2F933BB106547968(uParam0->f_28[1], 3, 1, 2, 0);
				unk_0x2F933BB106547968(uParam0->f_28[1], 4, 0, 1, 0);
				unk_0x2F933BB106547968(uParam0->f_28[1], 7, 0, 1, 0);
				unk_0x2F933BB106547968(uParam0->f_28[1], 8, 1, 0, 0);
			}
			uParam0->f_59 = unk_0x356EABB012B22D07(-552.18f, 285.476f, 81.976f, 0f, 0f, 79.5f, 2);
			unk_0x8B06F7FDDA8B98FB(uParam0->f_59, 1);
			unk_0xD3BB86584359B533(uParam0->f_59, 0);
			if (func_111(uParam0->f_28[0]))
			{
				unk_0xA17D768ED938600C(uParam0->f_28[0], uParam0->f_59, uParam0->f_48, "BASE_02_Willie", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			if (func_111(uParam0->f_28[1]))
			{
				unk_0xA17D768ED938600C(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "BASE_02_GIRL", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			...
			if (func_111(uParam0->f_28[2]))
			{
				...
				unk_0x2F933BB106547968(uParam0->f_28[2], 2, 1, 2, 0);
				unk_0x2F933BB106547968(uParam0->f_28[2], 3, 1, 1, 0);
				unk_0x2F933BB106547968(uParam0->f_28[2], 4, 1, 0, 0);
				unk_0x2F933BB106547968(uParam0->f_28[2], 7, 1, 0, 0);
				unk_0x2F933BB106547968(uParam0->f_28[2], 8, 1, 0, 0);
			}
			if (func_111(uParam0->f_28[3]))
			{
				unk_0x2F933BB106547968(uParam0->f_28[3], 0, 1, 1, 0);
				unk_0x2F933BB106547968(uParam0->f_28[3], 2, 1, 0, 0);
				unk_0x2F933BB106547968(uParam0->f_28[3], 3, 1, 0, 0);
				unk_0x2F933BB106547968(uParam0->f_28[3], 4, 1, 1, 0);
				unk_0x2F933BB106547968(uParam0->f_28[3], 7, 1, 0, 0);
				unk_0x2F933BB106547968(uParam0->f_28[3], 8, 1, 0, 0);
			}
			if (func_111(uParam0->f_28[4]))
			{
				unk_0x2F933BB106547968(uParam0->f_28[4], 0, 0, 0, 0);
				unk_0x2F933BB106547968(uParam0->f_28[4], 2, 0, 2, 0);
				unk_0x2F933BB106547968(uParam0->f_28[4], 3, 0, 0, 0);
				unk_0x2F933BB106547968(uParam0->f_28[4], 4, 0, 1, 0);
				unk_0x2F933BB106547968(uParam0->f_28[4], 8, 0, 0, 0);
			}
			if (func_111(uParam0->f_28[5]))
			{
				unk_0x2F933BB106547968(uParam0->f_28[5], 0, 1, 0, 0);
				unk_0x2F933BB106547968(uParam0->f_28[5], 2, 2, 0, 0);
				unk_0x2F933BB106547968(uParam0->f_28[5], 3, 0, 3, 0);
				unk_0x2F933BB106547968(uParam0->f_28[5], 4, 1, 0, 0);
				unk_0x2F933BB106547968(uParam0->f_28[5], 8, 0, 2, 0);
			}
			func_236(&(uParam0->f_35[0]), iVar0[6], -553.55f, 308.61f, 82.81f, 202.78f);
			if (func_112(uParam0->f_35[0]))
			{
				unk_0xEF9B9F466C3E73F6(uParam0->f_35[0], 1);
				unk_0xD602D152E57C823D(uParam0->f_35[0], 1);
				unk_0xABCF7963E043518F(uParam0->f_35[0], 0);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0x924CDE68BA2ED3BA(iVar0[iVar8]);
				iVar8++;
			}
			unk_0xF9FFB9857F3120F8(uParam0->f_48);
			return 1;
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_112(uParam0->f_28[0]) && func_112(uParam0->f_28[1]))
			{
				unk_0xCC61640A821F277C(uParam0->f_28[0], 1);
				unk_0xCC61640A821F277C(uParam0->f_28[1], 1);
				uVar5 = unk_0x356EABB012B22D07(-1100.558f, 789.8862f, 163.3285f, 0f, 0f, 0f, 2);
				unk_0xA17D768ED938600C(uParam0->f_28[0], uVar5, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1148846080, 0);
				unk_0xA17D768ED938600C(uParam0->f_28[1], uVar5, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1148846080, 0);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_280(int iParam0, int iParam1, bool bParam2)
{
	...
	if (unk_0xA3794949321E107C(uLocal_109))
	{
		unk_0x020DF7300725ECAB(&uLocal_109);
	}
	if (bParam2)
	{
	...
	switch (*iParam0)
	{
		case 43:
			if (iParam1->f_1 != -1)
			{
				unk_0xB47CC6339ADB0B67(iParam1->f_1);
			}
			break;
	}
...
void func_295(var uParam0)
{
	if (unk_0x00743AFDA92F3B04(uParam0->f_59))
	{
		if (func_111(uParam0->f_28[1]))
		{
			...
			unk_0x36CA2EF7ACE06D15(uParam0->f_28[1], -1000f, 1);
		}
	}
}
