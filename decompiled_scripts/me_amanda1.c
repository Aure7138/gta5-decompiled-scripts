...
void __EntryFunction__()
{
	...
	uLocal_51 = unk_0xE66C877C9033DBB0();
	...
	while (true)
	{
		...
		{
			unk_0x8342E6CB98CD545C(iLocal_408, 124, 1);
		}
		func_532();
		switch (iLocal_404)
		{
...
void func_1()
{
	...
	if (unk_0xAE06B9E39EBDE049(iLocal_408) && unk_0x5AEB5DDFFAD43CA5(iLocal_408))
	{
		func_2(2);
	}
	else if (func_533(iLocal_408) && func_533(unk_0x9B0761B4C3EB8BC7()))
	{
		if (unk_0xCDF860E56BBCC6B4(iLocal_408, unk_0x9B0761B4C3EB8BC7(), 1))
		{
			if (unk_0x37BCA35686C6B213(iLocal_408, 0, 2) || unk_0x06C1E4CCB13F773B(iLocal_408))
			{
				func_2(1);
			}
		}
...
void func_3()
{
	...
	switch (iLocal_405)
	{
		case 0:
			...
			func_35(&iLocal_407);
			if (unk_0xAE06B9E39EBDE049(iLocal_408))
			{
				if (unk_0x5AEB5DDFFAD43CA5(iLocal_408))
				{
					iLocal_406 = 2;
				}
				else if (unk_0xCDF860E56BBCC6B4(iLocal_408, unk_0x9B0761B4C3EB8BC7(), 1))
				{
					iLocal_406 = 1;
				}
			}
...
void func_4(bool bParam0, bool bParam1)
{
	...
	{
		if (func_533(iLocal_408) && unk_0x7DA97DBB7F7D2DE5(iLocal_408))
		{
			unk_0x59478CBBF96AF7D1(iLocal_408);
		}
		if (bParam1)
		{
			func_17(&iLocal_408, 1, 0, 1);
		}
		else if (func_533(iLocal_408) && unk_0xC2169C00B643278B(iLocal_408, Local_390, 50f, 50f, 50f, 0, 1, 0))
		{
			func_11(iLocal_408);
		}
		else
	...
	if (unk_0xAE06B9E39EBDE049(iLocal_416))
	{
		func_6(&uLocal_95, 6);
		iVar0 = 1;
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_416))
		{
			if (unk_0xF83D0A2EC884A4DD(iLocal_416, 0) && !func_5(iLocal_416) == joaat("weapon_pistol"))
			{
				unk_0x9B94F6169B0DAEFD(iLocal_416);
				unk_0x30291E2E564E9B47(iLocal_416, 1193033728, 0);
			}
		}
		if (bParam0)
		{
	...
	unk_0x5FEF237DD22FAAC2(Local_381, Local_384, 0);
	unk_0xCCF292009C6F1D61(Local_381, Local_384, 1, 0);
...
void func_36()
{
	...
	if (func_533(unk_0x9B0761B4C3EB8BC7()) && func_533(iLocal_408))
	{
		unk_0x8342E6CB98CD545C(iLocal_408, 60, 1);
		...
		switch (iLocal_405)
		{
			case 0:
				...
				uLocal_308 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -1392.254f, 367.9411f, 75.0046f, -44.2648f, 0f, -119.873f, 48.4f, 0, 2);
				unk_0x856549C07003344B(uLocal_308, 1);
				...
				{
					unk_0xD08E9EAF091A1AAB(unk_0x9B0761B4C3EB8BC7(), iLocal_408, 0);
					...
					unk_0x3C1B180EE30D36EF(0, Local_294, 1f, 20000, 1048576000, 0, 1193033728);
					unk_0x19F29730874AD6F1(uVar2);
					unk_0x9B6EC2CECE1010EF(iLocal_408, uVar2);
			...
			case 3:
				...
				if (unk_0x47DBF174A0CB9D55(iLocal_408, 0) && func_8(iVar0))
				{
					if (!func_52(iLocal_408, -828834893))
					{
						if (unk_0xFD7B900D58065E3B(iVar0))
						{
							...
							unk_0x9B6EC2CECE1010EF(iLocal_408, uVar3);
				...
				else if (func_51(iLocal_408, Local_294, 1.5f) || func_53(&iLocal_459, 10000))
				{
					...
					unk_0xB8B0F7C8C1548C5B(uLocal_308, 0);
					func_37();
				}
				break;
			}
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = unk_0x21A524CB091C80DE(iParam3, 7, -1, 0, -1, func_86(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_122(func_132(iParam1, uParam0->f_2), Global_76644, 0);
...
void func_135(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_129(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, unk_0x4D0432E34C5996D9(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_129(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, unk_0x4D0432E34C5996D9(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = unk_0x21A524CB091C80DE(iVar1, 7, -1, 0, -1, func_86(iParam0));
			if (iVar57 > iVar56)
			{
		...
		switch (iLocal_405)
		{
			case 0:
				...
				if (func_9(iVar1) && unk_0x0922C2E075A5F18C(iVar1))
				{
					...
					unk_0xCFF81C0C8D63E62E(unk_0x3E4D3CCC220BDFB1(iVar1, 1), 2.5f);
					unk_0x6D5673CA7E01D619(unk_0x3E4D3CCC220BDFB1(iVar1, 1), 2.5f);
				...
				iLocal_459 = -1;
				func_73(0f, 0f, 0f, 1, 1, 1, 1, 1, 1, 1, 1, 1, 0);
				uLocal_308 = unk_0x45DEF9871BA3107A("DEFAULT_SCRIPTED_CAMERA", -840.7f, 185.3f, 78.4f, -14f, 0f, -110.4f, 48.4f, 0, 2);
				unk_0x856549C07003344B(uLocal_308, 1);
				unk_0x3ED9330214992278(1, 0, 3000, 1, 0, 0);
				if (func_8(iVar0))
				{
					...
					{
						unk_0x694113444F21E39F(iLocal_408, 179, 1);
					}
					func_71(iVar0, 1093140480, 1, 1056964608, 0, 1, 0);
				...
				else
				{
					...
					unk_0x2BB0EF9DE445EA13(iLocal_408);
					func_198(iLocal_408, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1) + Vector(0f, 2f, 2f));
					unk_0xE922BAA80E8F9324(iLocal_408, -155.84f);
					unk_0xE922BAA80E8F9324(unk_0x9B0761B4C3EB8BC7(), -43.04f);
					unk_0xD08E9EAF091A1AAB(unk_0x9B0761B4C3EB8BC7(), iLocal_408, 0);
					unk_0x9DC06E2A59C5AEBB(&uVar3);
					unk_0xD08E9EAF091A1AAB(0, unk_0x9B0761B4C3EB8BC7(), 3000);
					unk_0x3C1B180EE30D36EF(0, Local_291, 1f, 20000, 1048576000, 0, 1193033728);
					unk_0x19F29730874AD6F1(uVar3);
					unk_0x9B6EC2CECE1010EF(iLocal_408, uVar3);
					unk_0x4F83FEE4454169D4(&uVar3);
					unk_0xCFF81C0C8D63E62E(Local_470, 2.5f);
					unk_0x6D5673CA7E01D619(Local_470, 2.5f);
					iLocal_405 = 2;
				}
				break;
				...
				if (unk_0x47DBF174A0CB9D55(iLocal_408, 0) && func_8(iVar0))
				{
					if (!func_52(iLocal_408, 242628503))
					{
						if (unk_0xFD7B900D58065E3B(iVar0))
						{
							...
							unk_0x9B6EC2CECE1010EF(iLocal_408, uVar4);
...
void func_210()
{
	...
	switch (iLocal_405)
	{
		case 0:
			...
			if (func_533(iLocal_408))
			{
				if (unk_0xFE6F151E15A69B3A(iLocal_408, func_226()))
				{
			...
			iLocal_331 = unk_0x578C4EF320340AF7() + 1000;
			iLocal_405 = 1;
			break;
		...
		case 1:
			if (func_533(unk_0x9B0761B4C3EB8BC7()) && func_533(iLocal_408))
			{
				...
				if (unk_0xFE6F151E15A69B3A(iLocal_408, func_226()))
				{
					if (func_218(unk_0x9B0761B4C3EB8BC7(), iLocal_408) < 5f)
					{
						func_217();
					}
				}
				else if (((func_8(iLocal_410) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_410, 0)) && unk_0xE0B3BC41DDA88DF0(iLocal_408, iLocal_410, 0)) || (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_410, 0) && !unk_0xE0B3BC41DDA88DF0(iLocal_408, iLocal_410, 0)))
				{
					func_217();
				}
				func_215();
				if (func_218(unk_0x9B0761B4C3EB8BC7(), iLocal_408) > 200f)
				{
					func_2(4);
				}
			}
...
void func_211()
{
	...
	if (unk_0x578C4EF320340AF7() > iLocal_370)
	{
		if ((((func_533(unk_0x9B0761B4C3EB8BC7()) && func_533(iLocal_408)) && unk_0x47DBF174A0CB9D55(iLocal_408, 0)) && !func_214()) && func_218(unk_0x9B0761B4C3EB8BC7(), iLocal_408) < 10f)
		{
			iVar0 = unk_0xA5D5B1042E8F47BD(iLocal_408, 0);
			if (func_8(iVar0) && !unk_0xACBCFA3095C5A434(unk_0x9B0761B4C3EB8BC7(), iVar0))
			{
				if (unk_0xCDF860E56BBCC6B4(iVar0, unk_0x9B0761B4C3EB8BC7(), 1))
				{
					...
					iLocal_370 = unk_0x578C4EF320340AF7() + 5000;
					unk_0xBB7976F6FB9C9DD2(iLocal_410);
				}
			}
...
void func_215()
{
	if (((func_9(iLocal_410) && func_533(iLocal_408)) && unk_0xE0B3BC41DDA88DF0(iLocal_408, iLocal_410, 0)) && func_218(unk_0x9B0761B4C3EB8BC7(), iLocal_408) < 10f)
	{
		if (unk_0x578C4EF320340AF7() > iLocal_331)
		{
			if (!func_214())
			{
				func_69(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
				if ((func_216("MEA1_03", 0, 0) || func_216("MEA1_05", 0, 0)) || func_216("MEA1_06", 0, 0))
				{
					...
					{
						iLocal_331 = unk_0x578C4EF320340AF7() + 9000;
					}
				}
...
void func_221()
{
	unk_0xE19B69814D61BBA5(iLocal_408, func_226());
	unk_0xF5230D38AD1D873D(iLocal_408, 0);
	unk_0x10162EF76529C10F(iLocal_408, 1);
	unk_0x0DC39BE87E4C5599(iLocal_408, 0);
	unk_0xB1AC1F996633F5B4(iLocal_408, 0);
	unk_0x5B91E038374B8BD8(iLocal_408, 0);
...
void func_233()
{
	...
	if (func_533(iLocal_408))
	{
		unk_0x72126609486AAC5B(iLocal_408, 1);
	}
	switch (iLocal_405)
	{
		case 0:
			...
			if (func_257())
			{
				if (unk_0xC614DDE265D18415(sLocal_380))
				{
					unk_0xA3AB9D48A7E8EA48(iLocal_408, sLocal_380, 1048576000);
				}
				iLocal_364 = unk_0x578C4EF320340AF7() + 20000;
		...
		case 1:
			if (iLocal_438)
			{
				if (unk_0x578C4EF320340AF7() > iLocal_307)
				{
					if (!func_214())
					{
						if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_410, 0) && unk_0xE0B3BC41DDA88DF0(iLocal_408, iLocal_410, 0))
						{
			...
			{
				iLocal_429 = unk_0x578C4EF320340AF7() + 1000;
				unk_0x54360E90A0E17AED(unk_0x460153A63B9477BC());
				iLocal_405 = 2;
			}
			break;
		...
		case 2:
			if (func_533(unk_0x9B0761B4C3EB8BC7()) && func_533(iLocal_408))
			{
				...
				if (!unk_0xFE6F151E15A69B3A(iLocal_408, func_226()))
				{
					if (func_8(iLocal_410))
					{
						if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_410, 0))
						{
							func_257();
						}
					}
				...
				if (func_218(unk_0x9B0761B4C3EB8BC7(), iLocal_408) > 15f)
				{
					func_237();
					iLocal_405 = 0;
					iLocal_404 = 5;
...
void func_234()
{
	if (func_533(iLocal_422) && func_218(unk_0x9B0761B4C3EB8BC7(), iLocal_422) > 100f)
	{
		func_17(&iLocal_422, 0, 0, 1);
	}
	if (func_533(iLocal_416) && func_218(unk_0x9B0761B4C3EB8BC7(), iLocal_416) > 100f)
	{
...
void func_235()
{
	...
	if (((iLocal_462 && !unk_0x2F80DB5A41D045E6()) && func_533(unk_0x9B0761B4C3EB8BC7())) && func_533(iLocal_408))
	{
		if (unk_0x6E0C5E7AAF8B6214(unk_0x9B0761B4C3EB8BC7()))
		{
			iVar0 = unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0);
			if ((func_8(iVar0) && !unk_0xE0B3BC41DDA88DF0(iLocal_408, iVar0, 1)) && !func_236(iVar0))
			{
...
void func_240()
{
	...
	{
		if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_428, 0) && unk_0xE0B3BC41DDA88DF0(iLocal_408, iLocal_428, 0))
		{
			if (((unk_0xBCB2BD5C2E502335(iLocal_428, 2, 5000) || unk_0xBCB2BD5C2E502335(iLocal_428, 3, 5000)) || unk_0xBCB2BD5C2E502335(iLocal_428, 0, 5000)) || unk_0xBCB2BD5C2E502335(iLocal_428, 1, 5000))
			{
				if (iLocal_431 == iLocal_430)
				{
					iLocal_430++;
					iLocal_436 = unk_0x578C4EF320340AF7() + 5000;
				}
				else if (unk_0x578C4EF320340AF7() > iLocal_436 && !func_214())
				{
					func_69(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
...
void func_243()
{
	...
	if (func_533(unk_0x9B0761B4C3EB8BC7()) && unk_0x578C4EF320340AF7() > iLocal_429)
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			iVar0 = unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0);
...
void func_244()
{
	if ((((iLocal_369 < 3 && !func_214()) && func_242()) && func_245()) && unk_0xFE6F151E15A69B3A(iLocal_408, func_226()))
	{
...
int func_245()
{
	...
	{
		iVar0 = unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0);
		if (func_8(iVar0) && unk_0xE0B3BC41DDA88DF0(iLocal_408, iVar0, 0))
		{
			return 1;
		}
	}
...
void func_246()
{
	...
	if ((((iLocal_337 < 3 && unk_0x578C4EF320340AF7() > iLocal_332) && func_242()) && unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0)) && func_245())
	{
		iVar0 = unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0);
		if (func_8(iVar0) && func_70(unk_0x36FE6D3220816ADA(iVar0)))
		{
			bLocal_338 = unk_0xDCD47F31CE777FDC(iVar0);
			if (bLocal_338)
			{
				if (!func_214() && bLocal_339 == 0)
				{
					...
					if (func_241(&uLocal_95, "MEA1AUD", "MEA1_SIREN", sLocal_333[iLocal_337], 7, 0, 0))
					{
						...
						iLocal_332 = unk_0x578C4EF320340AF7() + 9000;
					}
				}
			}
			else
	...
	else if (bLocal_339 && unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		iVar1 = unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0);
		if (func_8(iVar1) && func_70(unk_0x36FE6D3220816ADA(iVar1)))
		{
			bLocal_339 = unk_0xDCD47F31CE777FDC(iVar1);
		}
	}
}
...
void func_247()
{
	if (((iLocal_330 < 3 && unk_0x578C4EF320340AF7() > iLocal_324) && func_242()) && func_245())
	{
...
void func_248()
{
	...
	if (((iLocal_323 < 4 && unk_0x578C4EF320340AF7() > iLocal_317) && func_242()) && func_245())
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) && !unk_0x920BF19A74BAB0F0(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			if (func_8(iVar0))
			{
				if (unk_0x4162501391EDB9BF(iVar0))
				{
					if (!func_214())
					{
						if (((((iLocal_323 == 0 && func_8(iLocal_410)) && unk_0xE0B3BC41DDA88DF0(iLocal_408, iLocal_410, 0)) && func_249(iLocal_408, 0) == 2) || (((iLocal_323 == 1 || iLocal_323 == 2) && unk_0x47DBF174A0CB9D55(iLocal_408, 0)) && (func_249(iLocal_408, 0) == 2 || func_249(iLocal_408, 0) == 1))) || (iLocal_323 == 3 && unk_0x653A331834B72BC0(unk_0x9B0761B4C3EB8BC7())))
						{
							func_69(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
							if (func_241(&uLocal_95, "MEA1AUD", "MEA1_CRASH", sLocal_318[iLocal_323], 7, 0, 0))
							{
								iLocal_323++;
								iLocal_317 = unk_0x578C4EF320340AF7() + 9000;
							}
						}
						else
						{
...
void func_250()
{
	if ((((iLocal_302 < 4 && !func_214()) && func_242()) && (func_245() || func_251())) && unk_0xFE6F151E15A69B3A(iLocal_408, func_226()))
	{
		if (iLocal_303 == iLocal_302)
		{
			iLocal_302++;
			iLocal_307 = unk_0x578C4EF320340AF7() + 2000;
		}
		else if (unk_0x578C4EF320340AF7() > iLocal_307)
		{
			func_69(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
...
int func_251()
{
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) || unk_0x47DBF174A0CB9D55(iLocal_408, 0))
	{
		return 0;
	}
	return 1;
...
void func_252()
{
	if (iLocal_445)
	{
		if (func_214())
		{
			if (unk_0x578C4EF320340AF7() > iLocal_448)
			{
				unk_0x2DB2D4C3CB88500D(uLocal_447, "MICHAEL_EVENT_AMANDA_REMOVE_HANDCUFFS_MASTER", iLocal_408, 0, 0, 0);
				iLocal_445 = 0;
			}
		}
	}
		...
		else if (!func_214())
		{
			...
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_410, 0) && unk_0xE0B3BC41DDA88DF0(iLocal_408, iLocal_410, 0))
			{
				if (func_258(&uLocal_95, "MEA1AUD", "MEA1_LOSTCOP", "MEA1_LOSTCOP_1", "MEA1_LOSTCOP", "MEA1_LOSTCOP_2", "MEA1_LOSTCOP", "MEA1_LOSTCOP_3", "MEA1_LOSTCOP", "MEA1_LOSTCOP_4", 7, 1, 0) || func_53(&iLocal_457, 5000))
				{
					...
					unk_0x439AF5D920F78274(0, unk_0x7EC595B99EA7C4B1(iLocal_410, 2f, 2f, 0f), 2000, 2050, 4);
					...
					unk_0x9B6EC2CECE1010EF(iLocal_408, uVar0);
					unk_0x4F83FEE4454169D4(&uVar0);
					iLocal_448 = unk_0x578C4EF320340AF7() + 9000;
					iLocal_445 = 1;
					return 1;
				}
			}
...
int func_261(int iParam0)
{
	...
	if ((func_533(unk_0x9B0761B4C3EB8BC7()) && unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0)) && func_8(iParam0))
	{
		iVar0 = unk_0xA5D3CD332CD10EE9();
		if (func_8(iVar0))
		{
...
void func_262()
{
	...
	switch (iLocal_405)
	{
		case 0:
			...
			func_223(&uLocal_474);
			iLocal_405 = 1;
			iLocal_403 = unk_0x578C4EF320340AF7() + 10000;
			iLocal_457 = -1;
			break;
		...
		case 1:
			...
			if (iLocal_446)
			{
				...
				{
					uLocal_447 = unk_0x5E54B0823F46079E();
					iLocal_446 = 0;
				}
			}
			func_268();
			if (func_533(unk_0x9B0761B4C3EB8BC7()) && func_533(iLocal_408))
			{
				...
				if (unk_0xFE6F151E15A69B3A(iLocal_408, func_226()))
				{
					if (func_218(unk_0x9B0761B4C3EB8BC7(), iLocal_408) > (15f * 2f))
					{
						func_237();
						iLocal_405 = 0;
						iLocal_404 = 5;
				...
				else if (((func_8(iLocal_410) && unk_0xACBCFA3095C5A434(iLocal_408, iLocal_410)) && !unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_410, 0)) && !func_261(iLocal_410))
				{
					func_237();
					iLocal_405 = 0;
					iLocal_404 = 5;
	...
	func_235();
	func_211();
	if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -806.21f, 165.83f, 68.98f, 52f, 36f, 16.25f, 0, 1, 0) || unk_0xC2169C00B643278B(iLocal_408, -806.21f, 165.83f, 68.98f, 52f, 36f, 16.25f, 0, 1, 0))
	{
...
void func_263()
{
	if (func_533(iLocal_408) && !unk_0xFE6F151E15A69B3A(iLocal_408, func_226()))
	{
		if (func_8(iLocal_410))
		{
			if (((unk_0xBCB2BD5C2E502335(iLocal_410, 2, 30000) || unk_0xBCB2BD5C2E502335(iLocal_410, 3, 30000)) || unk_0xBCB2BD5C2E502335(iLocal_410, 0, 7000)) || unk_0xBCB2BD5C2E502335(iLocal_410, 1, 40000))
			{
				func_2(5);
			}
		}
...
void func_264()
{
	if (((((func_533(unk_0x9B0761B4C3EB8BC7()) && func_533(iLocal_416)) && !unk_0x0922C2E075A5F18C(iLocal_416)) && !unk_0x12C99794D883929B(iLocal_416)) && !unk_0x78F9A93AC3E99CD8(iLocal_416)) && !unk_0xCED6B5226244381C(iLocal_416))
	{
		if (unk_0x578C4EF320340AF7() > iLocal_403)
		{
			if (!func_5(iLocal_416) == joaat("weapon_pistol"))
			{
				unk_0xBF0DD7DAFAF15103(iLocal_416, 1);
				unk_0x92BD213E6A0E666B(iLocal_416, joaat("weapon_pistol"), -1, 0, 1);
			}
			if (!unk_0xF83D0A2EC884A4DD(iLocal_416, 0))
			{
				unk_0x9B94F6169B0DAEFD(iLocal_416);
				unk_0xA79461EDE020EDEB(iLocal_416, unk_0x9B0761B4C3EB8BC7());
...
void func_265()
{
	if (((((iLocal_351 < 9 && !func_214()) && func_242()) && func_245()) && unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) > 0) && !func_267(unk_0x9B0761B4C3EB8BC7()))
	{
		if (unk_0x578C4EF320340AF7() > iLocal_340)
		{
			func_69(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
			iLocal_362 = unk_0x344C570D6F8700DF(0, 4);
			...
			{
				iLocal_340 = unk_0x578C4EF320340AF7() + 9000;
				iLocal_351++;
...
void func_268()
{
	...
	{
		if ((func_270(iLocal_422, 1090519040, 1097859072) || unk_0x7922FF28ED63354A(unk_0x9B0761B4C3EB8BC7())) || (func_533(iLocal_416) && unk_0x7922FF28ED63354A(iLocal_416)))
		{
			if (unk_0x9934470AA0A08B57(iLocal_422, sLocal_379, sLocal_273, 2) || unk_0x9934470AA0A08B57(iLocal_422, sLocal_379, sLocal_277, 2))
			{
				unk_0x1CD098484842AE0B(iLocal_422, -8f, 1);
			}
...
{
	if (((((func_533(iLocal_416) && func_533(unk_0x9B0761B4C3EB8BC7())) && !unk_0x0922C2E075A5F18C(iLocal_416)) && !unk_0x12C99794D883929B(iLocal_416)) && !unk_0x78F9A93AC3E99CD8(iLocal_416)) && !unk_0xCED6B5226244381C(iLocal_416))
	{
		if (!func_5(iLocal_416) == joaat("weapon_pistol"))
		{
			unk_0xBF0DD7DAFAF15103(iLocal_416, 1);
	...
	if ((func_533(iLocal_422) && !unk_0xA26A1295C5145A11(iLocal_422)) && !unk_0xF83D0A2EC884A4DD(iLocal_422, 0))
	{
		if (unk_0x9934470AA0A08B57(iLocal_422, sLocal_379, sLocal_273, 2) || unk_0x9934470AA0A08B57(iLocal_422, sLocal_379, sLocal_277, 2))
		{
			unk_0x1CD098484842AE0B(iLocal_422, -8f, 1);
...
int func_270(int iParam0, float fParam1, float fParam2)
{
	if (func_9(iParam0))
	{
		if (unk_0xC7EB33BFDB436C87(unk_0x3E4D3CCC220BDFB1(iParam0, 1), fParam1, 0))
		{
			return 1;
		}
...
int func_273(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_207(Param1 - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
	...
	{
		Var3 = { func_207(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_275()
{
	if ((iLocal_441 && unk_0x578C4EF320340AF7() > iLocal_437) && func_245())
	{
		func_6(&uLocal_95, 4);
...
void func_276()
{
	...
	switch (iLocal_405)
	{
		case 0:
			...
			func_365();
			iLocal_309 = unk_0x578C4EF320340AF7() + 7000;
			iVar0 = unk_0xA5D3CD332CD10EE9();
			if (func_8(iVar0) && unk_0x36FE6D3220816ADA(iVar0) != iLocal_411)
			{
		...
		case 1:
			...
			func_302();
			func_298();
			if (((func_533(unk_0x9B0761B4C3EB8BC7()) && func_8(iLocal_410)) && unk_0xCDF860E56BBCC6B4(iLocal_410, unk_0x9B0761B4C3EB8BC7(), 1)) && !unk_0xCED6B5226244381C(unk_0x9B0761B4C3EB8BC7()))
			{
				unk_0x6A8F948698B360B4(iLocal_410, 0);
				func_269(1);
			}
			func_306();
			break;
		...
		case 2:
			if (func_8(iLocal_410))
			{
				if (func_533(iLocal_416))
				{
					...
					{
						func_297();
						iLocal_437 = unk_0x578C4EF320340AF7() + 1000;
						iLocal_261 = 4;
						iLocal_278 = 5;
					}
				}
...
void func_277()
{
	...
	if (func_280(unk_0x9B0761B4C3EB8BC7(), Local_262, 100f))
	{
		if (iLocal_444)
		{
			func_279(0);
	...
	else if (func_214())
	{
		if (!iLocal_444)
		{
			Var0 = { func_231() };
			sVar6 = func_278(&Var0);
			if (unk_0xF005CCA4263DF67F(sVar6, "MEA1_SCENE"))
			{
				func_279(1);
				iLocal_444 = 1;
			}
...
void func_281()
{
	...
	iVar0 = unk_0xA5D3CD332CD10EE9();
	if (((((unk_0x5AEB5DDFFAD43CA5(iLocal_416) || unk_0x5AEB5DDFFAD43CA5(iLocal_422)) || func_283(iLocal_416, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || func_283(iLocal_422, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || ((func_8(iVar0) && func_8(iLocal_410)) && unk_0xA65352E7FEA59881(iVar0, iLocal_410))) || (unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) > 0 && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_387, 1) < 30f))
	{
		if (!unk_0xE0B3BC41DDA88DF0(iLocal_408, iLocal_410, 0))
		{
			if (!unk_0xFE6F151E15A69B3A(iLocal_408, func_226()))
			{
				func_237();
				iLocal_261 = 5;
				iLocal_278 = 5;
				if (unk_0xFC5D6FB6EECB392F(uLocal_260))
				{
					fVar1 = unk_0x369E69441C066912(uLocal_260);
					unk_0x1CD098484842AE0B(iLocal_408, -1000f, 1);
					unk_0x1CD098484842AE0B(iLocal_410, -1000f, 1);
					if (fVar1 > 0.75f)
					{
						unk_0x1CD098484842AE0B(iLocal_408, -1000f, 0);
						func_282(iLocal_408, iLocal_410, 2, 0);
					}
					else
					{
						unk_0x1CD098484842AE0B(iLocal_408, -1000f, 1);
						unk_0x58ADF88C51AAFDC5(iLocal_408, 1, 0);
					}
					if (func_533(iLocal_416))
					{
						unk_0x1CD098484842AE0B(iLocal_416, -1000f, 1);
					}
					if (func_533(iLocal_422))
					{
						unk_0x1CD098484842AE0B(iLocal_422, -1000f, 1);
					}
				}
				unk_0x6A8F948698B360B4(iLocal_408, 0);
				unk_0x6A8F948698B360B4(iLocal_410, 0);
				if ((func_8(iVar0) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iVar0, 0)) && unk_0xB064AF9925F5537B(iVar0, 0, 0))
				{
					if (!func_52(iLocal_408, -1794415470))
					{
						unk_0xC584E49FC3559A86(iLocal_408, iVar0, 20000, 0, 3f, 1, 0);
					}
				}
				else if (func_218(iLocal_408, unk_0x9B0761B4C3EB8BC7()) > 10f)
				{
					if (!func_52(iLocal_408, 1227113341))
					{
						unk_0xE021DCE1063D5DC2(iLocal_408, unk_0x9B0761B4C3EB8BC7(), 20000, 7f, 1073741824, 1073741824, 0);
					}
				}
				else
				{
					unk_0x9B94F6169B0DAEFD(iLocal_408);
				}
				func_221();
				func_35(&iLocal_407);
				iLocal_443 = 1;
...
int func_290(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_207(unk_0x3E4D3CCC220BDFB1(iParam1, 1) - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
...
void func_297()
{
	...
	if (func_533(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		else
		{
			...
			if (func_533(iLocal_408))
			{
				unk_0xE2348E4036041923(iLocal_408);
			}
			unk_0x6F9222C1283B5094(Local_450, Local_453, fLocal_456, 1);
			iLocal_446 = 1;
			iLocal_441 = 1;
			iLocal_457 = -1;
			if ((((func_533(iLocal_416) && !unk_0x0922C2E075A5F18C(iLocal_416)) && !unk_0x12C99794D883929B(iLocal_416)) && !unk_0x78F9A93AC3E99CD8(iLocal_416)) && !unk_0xCED6B5226244381C(iLocal_416))
			{
				if (!func_52(iLocal_416, 1392476864))
				{
					if (unk_0x9934470AA0A08B57(iLocal_416, sLocal_379, sLocal_272, 2) || unk_0x9934470AA0A08B57(iLocal_416, sLocal_379, sLocal_276, 2))
					{
						unk_0x1CD098484842AE0B(iLocal_416, -8f, 1);
					}
					unk_0x9DC06E2A59C5AEBB(&uVar0);
					unk_0xD08E9EAF091A1AAB(0, unk_0x9B0761B4C3EB8BC7(), 1500);
					unk_0xA79461EDE020EDEB(0, unk_0x9B0761B4C3EB8BC7());
					unk_0x19F29730874AD6F1(uVar0);
					unk_0x9B6EC2CECE1010EF(iLocal_416, uVar0);
					unk_0x4F83FEE4454169D4(&uVar0);
				}
			}
			if (func_533(iLocal_422) && !unk_0xA26A1295C5145A11(iLocal_422))
			{
				if (unk_0x9934470AA0A08B57(iLocal_422, sLocal_379, sLocal_273, 2) || unk_0x9934470AA0A08B57(iLocal_422, sLocal_379, sLocal_277, 2))
				{
					unk_0x1CD098484842AE0B(iLocal_422, -8f, 1);
...
void func_298()
{
	...
	if (((func_8(iLocal_410) && func_533(unk_0x9B0761B4C3EB8BC7())) && func_533(iLocal_416)) && func_533(iLocal_422))
	{
		switch (iLocal_316)
		{
			case 0:
				if (func_214())
				{
					...
					{
						Local_310 = { func_301() };
						if ((((((((func_300(unk_0x9B0761B4C3EB8BC7(), iLocal_410, 5f, 1) || func_300(unk_0x9B0761B4C3EB8BC7(), iLocal_416, 5f, 1)) && !unk_0xF005CCA4263DF67F(&Local_310, "MEA1_SCENE_1")) && !unk_0xF005CCA4263DF67F(&Local_310, "MEA1_SCENE_2")) && !unk_0xF005CCA4263DF67F(&Local_310, "MEA1_SCENE_3")) && !unk_0xF005CCA4263DF67F(&Local_310, "MEA1_SCENE_4")) && !unk_0xF005CCA4263DF67F(&Local_310, "MEA1_SCENE_5")) && !unk_0xF005CCA4263DF67F(&Local_310, "MEA1_SCENE_6")) && func_285(iLocal_416, 1126825984))
						{
			...
			case 1:
				fVar7 = func_219(unk_0x9B0761B4C3EB8BC7(), iLocal_416, 1);
				fVar8 = func_219(unk_0x9B0761B4C3EB8BC7(), iLocal_410, 1);
				bVar9 = false;
				func_69(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
				if (fVar7 < fVar8)
				{
				...
				if (bVar9)
				{
					unk_0xA785552633ED203B(iLocal_416, unk_0x9B0761B4C3EB8BC7(), 2000, 2048, 4);
					iLocal_316 = 2;
				}
				break;
			...
			case 2:
				if (!func_214())
				{
					if (!unk_0xF005CCA4263DF67F(&Local_310, "") && !unk_0xF005CCA4263DF67F(&Local_310, "NULL"))
					{
						func_69(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
...
void func_302()
{
	...
	if (func_533(unk_0x9B0761B4C3EB8BC7()) && iLocal_261 != 5)
	{
		bVar0 = false;
		if ((func_533(iLocal_416) && unk_0xA65352E7FEA59881(unk_0x9B0761B4C3EB8BC7(), iLocal_416)) || (((func_533(iLocal_422) && unk_0xA65352E7FEA59881(unk_0x9B0761B4C3EB8BC7(), iLocal_422)) && !((func_283(iLocal_416, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_283(iLocal_422, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || unk_0x7922FF28ED63354A(unk_0x9B0761B4C3EB8BC7()))) && unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) == 0))
		{
			if (unk_0xCED6B5226244381C(iLocal_416) || unk_0xCED6B5226244381C(iLocal_422))
			{
				bVar0 = true;
			}
			else if (iLocal_460)
		...
		if (((((((((((unk_0xAE06B9E39EBDE049(iLocal_416) && unk_0xCDF860E56BBCC6B4(iLocal_416, unk_0x9B0761B4C3EB8BC7(), 1)) || (unk_0xAE06B9E39EBDE049(iLocal_416) && unk_0x5AEB5DDFFAD43CA5(iLocal_416))) || func_295(iLocal_416, 1, 0, 0, 0)) || func_284(iLocal_416, 1126825984)) || func_284(iLocal_422, 1126825984)) || (unk_0xAE06B9E39EBDE049(iLocal_422) && unk_0xCDF860E56BBCC6B4(iLocal_422, unk_0x9B0761B4C3EB8BC7(), 1))) || (unk_0xAE06B9E39EBDE049(iLocal_422) && unk_0x5AEB5DDFFAD43CA5(iLocal_422))) || unk_0x7922FF28ED63354A(unk_0x9B0761B4C3EB8BC7())) || bVar0) || func_270(iLocal_422, 1090519040, 1097859072)) || unk_0x7922FF28ED63354A(unk_0x9B0761B4C3EB8BC7()))
		{
			unk_0x5FEF237DD22FAAC2(Local_381, Local_384, 0);
			unk_0xCCF292009C6F1D61(Local_381, Local_384, 1, 0);
			if (bVar0)
			...
			if ((((func_533(iLocal_416) && !unk_0x0922C2E075A5F18C(iLocal_416)) && !unk_0x12C99794D883929B(iLocal_416)) && !unk_0x78F9A93AC3E99CD8(iLocal_416)) && !unk_0xCED6B5226244381C(iLocal_416))
			{
				...
				if (!unk_0xF83D0A2EC884A4DD(iLocal_416, 0) && !func_52(iLocal_416, 1392476864))
				{
					func_237();
					unk_0xBF0DD7DAFAF15103(iLocal_416, 1);
					unk_0x92BD213E6A0E666B(iLocal_416, joaat("weapon_pistol"), -1, 0, 1);
...
void func_303()
{
	if ((func_533(unk_0x9B0761B4C3EB8BC7()) && func_8(iLocal_410)) && func_533(iLocal_408))
	{
		if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_410, 0) || func_261(iLocal_410))
		{
			func_237();
			func_35(&iLocal_407);
			unk_0x6A8F948698B360B4(iLocal_410, 0);
		...
		else if (func_300(unk_0x9B0761B4C3EB8BC7(), iLocal_410, 6.5f, 1))
		{
			if (iLocal_442)
			{
				unk_0x6A8F948698B360B4(iLocal_410, 0);
		...
		{
			unk_0x6A8F948698B360B4(iLocal_410, 1);
			iLocal_442 = 1;
		}
	}
}
...
void func_304()
{
	if ((((func_533(iLocal_416) && func_533(iLocal_422)) && func_533(iLocal_408)) && func_8(iLocal_410)) && unk_0xC614DDE265D18415(sLocal_379))
	{
		switch (iLocal_261)
		{
			case 0:
				func_305();
				uLocal_260 = unk_0xF341A134A5B8D4F6(Local_262, Local_265, 2);
				unk_0x81493F39713559B1(uLocal_260, 1);
				unk_0x882281B10B0A5932(uLocal_260, 0);
				iLocal_449 = 1;
				unk_0xDFDB9C533700BC17(iLocal_416, uLocal_260, sLocal_379, sLocal_268, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0xDFDB9C533700BC17(iLocal_422, uLocal_260, sLocal_379, sLocal_269, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0xDFDB9C533700BC17(iLocal_408, uLocal_260, sLocal_379, sLocal_270, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0x1FEB07A1AF22700F(iLocal_410, uLocal_260, sLocal_271, sLocal_379, 1000f, -8f, 1, 1148846080);
				iLocal_458 = -1;
				iLocal_278 = 1;
				iLocal_261 = 2;
				break;
			...
			case 1:
				func_305();
				uLocal_260 = unk_0xF341A134A5B8D4F6(Local_262, Local_265, 2);
				unk_0x81493F39713559B1(uLocal_260, 0);
				unk_0x882281B10B0A5932(uLocal_260, 0);
				unk_0xDFDB9C533700BC17(iLocal_416, uLocal_260, sLocal_379, sLocal_272, 1000f, -4f, 4, 16, 1148846080, 0);
				unk_0xDFDB9C533700BC17(iLocal_422, uLocal_260, sLocal_379, sLocal_273, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0xDFDB9C533700BC17(iLocal_408, uLocal_260, sLocal_379, sLocal_274, 1000f, -4f, 4, 16, 1148846080, 0);
				unk_0x1FEB07A1AF22700F(iLocal_410, uLocal_260, sLocal_275, sLocal_379, 1000f, -8f, 1, 1148846080);
				unk_0x8430A80C3E4F5F98(uLocal_260, 0.622f);
				iLocal_261 = 3;
				break;
			...
			case 3:
				...
				if (!unk_0xFC5D6FB6EECB392F(uLocal_260))
				{
					uLocal_260 = unk_0xF341A134A5B8D4F6(Local_262, Local_265, 2);
					unk_0x81493F39713559B1(uLocal_260, 1);
					unk_0xDFDB9C533700BC17(iLocal_416, uLocal_260, sLocal_379, sLocal_276, 1000f, -4f, 1, 16, 1148846080, 0);
					unk_0xDFDB9C533700BC17(iLocal_422, uLocal_260, sLocal_379, sLocal_277, 1000f, -4f, 1, 16, 1148846080, 0);
					if (unk_0xB064AF9925F5537B(iLocal_410, 2, 0))
					{
						unk_0x13A4BD6CC31F7B8F(iLocal_408, iLocal_410, 2);
						unk_0x7CC9C12947A9030C(iLocal_410, 3, 1);
						unk_0xA5DA49AF5FFE9112(iLocal_410, 1);
						unk_0xA785552633ED203B(iLocal_408, unk_0x9B0761B4C3EB8BC7(), -1, 2050, 4);
					}
					if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_410, 1))
					{
				...
				else if (unk_0x369E69441C066912(uLocal_260) >= 0.9f)
				{
					if (unk_0x9934470AA0A08B57(iLocal_408, sLocal_379, sLocal_274, 2))
					{
						unk_0x1CD098484842AE0B(iLocal_408, -1000f, 0);
						if (unk_0xB064AF9925F5537B(iLocal_410, 2, 0))
						{
				...
				else if (unk_0x369E69441C066912(uLocal_260) >= 0.85f)
				{
					if (unk_0x9934470AA0A08B57(iLocal_410, sLocal_379, sLocal_275, 2))
					{
						unk_0x58ADF88C51AAFDC5(iLocal_408, 0, 0);
						unk_0x1CD098484842AE0B(iLocal_410, -4f, 1);
						unk_0x7CC9C12947A9030C(iLocal_410, 3, 1);
					}
				}
				break;
			...
			case 4:
				...
				if (func_533(iLocal_416))
				{
					unk_0xD08E9EAF091A1AAB(iLocal_416, unk_0x9B0761B4C3EB8BC7(), -1);
				}
				iLocal_261 = 5;
				break;
			}
	...
	switch (iLocal_278)
	{
		...
		case 1:
			if (!func_214())
			{
				...
				{
					if (func_280(unk_0x9B0761B4C3EB8BC7(), Local_262, 90f))
					{
						func_69(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
				...
				else if (func_280(unk_0x9B0761B4C3EB8BC7(), Local_262, (90f * 2f)))
				{
					func_69(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
		...
		case 2:
			if (!func_214())
			{
				if ((func_280(unk_0x9B0761B4C3EB8BC7(), Local_262, 90f) && !func_216("MEA1_02", 0, 0)) && !func_216("MEA1_03", 0, 0))
				{
					func_69(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
		...
		case 3:
			if (func_214())
			{
				...
				{
					Local_279 = { func_230() };
					if (unk_0xF005CCA4263DF67F(&Local_279, "") || unk_0xF005CCA4263DF67F(&Local_279, "NULL"))
					{
						iLocal_278 = 5;
					}
					else
		...
		case 4:
			if (func_214())
			{
				if (!func_280(unk_0x9B0761B4C3EB8BC7(), Local_262, 91f))
				{
					Local_279 = { func_230() };
					if (unk_0xF005CCA4263DF67F(&Local_279, "") || unk_0xF005CCA4263DF67F(&Local_279, "NULL"))
					{
...
void func_310()
{
	...
	{
		if (unk_0xE0B3BC41DDA88DF0(iLocal_416, iLocal_410, 0))
		{
			unk_0x6A8F948698B360B4(iLocal_410, 0);
			if (func_52(iLocal_416, -258271821))
			{
				if (unk_0x578C4EF320340AF7() > iLocal_398)
				{
					func_2(3);
				}
			}
			...
			{
				unk_0xD8C1C38EE8BC2AC6(iLocal_416, iLocal_410, 30f, 786469);
				iLocal_398 = unk_0x578C4EF320340AF7() + 2000;
			}
		}
	}
}
...
void func_311()
{
	...
	if (iLocal_440)
	{
		unk_0x5FEF237DD22FAAC2(Local_381, Local_384, 0);
		unk_0xCCF292009C6F1D61(Local_381, Local_384, 1, 0);
		if ((func_533(iLocal_416) && func_8(iLocal_410)) && unk_0xB064AF9925F5537B(iLocal_410, -1, 0))
		{
			func_237();
			func_69(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
			...
			{
				unk_0x9DC06E2A59C5AEBB(&uVar0);
				unk_0xC584E49FC3559A86(0, iLocal_410, 20000, -1, 1f, 1, 0);
				unk_0xD8C1C38EE8BC2AC6(0, iLocal_410, 50f, 786597);
				unk_0x19F29730874AD6F1(uVar0);
				unk_0x9B6EC2CECE1010EF(iLocal_416, uVar0);
				unk_0x4F83FEE4454169D4(&uVar0);
				unk_0x6A8F948698B360B4(iLocal_410, 0);
	...
	if (unk_0xAE06B9E39EBDE049(unk_0xA5D3CD332CD10EE9()))
	{
		if (unk_0x80FF6C016CDB0FAF(unk_0xA5D3CD332CD10EE9(), 0))
		{
			if (func_364(24) != unk_0xA5D3CD332CD10EE9())
			{
				if (iParam4 == 1)
				{
					if (func_361(unk_0x3E4D3CCC220BDFB1(unk_0xA5D3CD332CD10EE9(), 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_315(unk_0xA5D3CD332CD10EE9(), Param0, fParam3, 24, 0);
			}
		}
	}
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_339(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_366(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_418(unk_0x6C5C6B207AA78253(), 1);
			if (iVar5 != -1)
			{
...
int func_378(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2588062[iParam0 /*3*/][func_121(iParam1)];
...
void func_383(int iParam0, var uParam1)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x285D770154CF7612(iParam0, func_388(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
int func_393(var uParam0)
{
	if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_415())
		{
			*uParam0 = func_399(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), 6, -1, 0, 1, -1);
...
int func_399(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 53)
	{
		if (iParam3 == 6 || iParam3 == func_414(iVar0))
		{
			...
			{
				fVar1 = unk_0x272784C60C397DB6(Param0, func_400(iVar0, 0), 1);
...
void func_428()
{
	...
	switch (iLocal_405)
	{
		case 0:
			...
			unk_0xB023F5C66F5716C7(iLocal_407, "MEA1_AMA");
			unk_0xECC9A00CF1181EC2(iLocal_407, 3);
			unk_0x72BEFB9451782F60(iLocal_407, 1);
			func_435(&iLocal_407, -838.47f, -177.11f, 36.92f, 31.44f);
			func_433();
			iLocal_307 = unk_0x578C4EF320340AF7() + 10000;
			iLocal_305 = -1;
			iLocal_306 = -1;
			iLocal_443 = 0;
			iLocal_444 = 0;
		...
		case 1:
			if (func_533(unk_0x9B0761B4C3EB8BC7()))
			{
				if (unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_387, 1) < 200f)
				{
					iLocal_405 = 2;
				}
			}
		...
		case 2:
			func_430();
			if ((((func_533(unk_0x9B0761B4C3EB8BC7()) && func_533(iLocal_408)) && unk_0xAE06B9E39EBDE049(iLocal_422)) && unk_0xAE06B9E39EBDE049(iLocal_416)) && func_8(iLocal_410))
			{
				if (unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_387, 1) < 30f)
				{
					iLocal_457 = -1;
					iLocal_405 = 0;
					iLocal_404 = 2;
...
void func_429()
{
	if ((((iLocal_305 < 1 && func_533(unk_0x9B0761B4C3EB8BC7())) && !func_214()) && !func_216("MEA1_01", 0, 0)) && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_387, 1) > (30f * 3f))
	{
...
void func_430()
{
	if (!unk_0xAE06B9E39EBDE049(iLocal_410))
	{
		if (unk_0x7D167B9A0CCDA347(iLocal_411))
		{
			iLocal_410 = unk_0xCE4780E24AFDFBF9(iLocal_411, Local_412, fLocal_415, 1, 1, 0);
			unk_0xC160551F55D6365A(iLocal_410, 1, 1, 0);
			unk_0x6A8F948698B360B4(iLocal_410, 1);
			unk_0x29B700FB89C9DAC1(iLocal_410, 0);
			unk_0xA5DA49AF5FFE9112(iLocal_410, 0);
			unk_0xF242CEB863060ABC(iLocal_410, 2, true);
			iLocal_442 = 1;
			unk_0x74528AC0906CBABE(iLocal_411);
			unk_0x01A2F6B26EAAEAC5(Local_450, Local_453, fLocal_456, 0, 0, 1);
		}
	}
	if (!unk_0xAE06B9E39EBDE049(iLocal_408))
	{
		if (func_8(iLocal_410) && unk_0x7D167B9A0CCDA347(func_16(17)))
		{
			func_431(&iLocal_408, 17, iLocal_410, 2, 1);
			unk_0x28C15279799DB33B(iLocal_408, 2, 4, 0);
			unk_0x28C15279799DB33B(iLocal_408, 3, 5, 0);
			unk_0x28C15279799DB33B(iLocal_408, 4, 5, 0);
			unk_0x28C15279799DB33B(iLocal_408, 8, 1, 0);
			unk_0x28C15279799DB33B(iLocal_408, 1, 0, 0);
			unk_0x28C15279799DB33B(iLocal_408, 10, 1, 0);
			unk_0x45F588C0DD767737(iLocal_408, 2, 4, 0, 0);
			unk_0x45F588C0DD767737(iLocal_408, 3, 5, 0, 0);
			unk_0x45F588C0DD767737(iLocal_408, 4, 5, 0, 0);
			unk_0x45F588C0DD767737(iLocal_408, 8, 1, 0, 0);
			unk_0x45F588C0DD767737(iLocal_408, 1, 0, 0, 0);
			unk_0x45F588C0DD767737(iLocal_408, 10, 1, 0, 0);
			unk_0x78024EFD31A7FAD4(iLocal_408, 1, 0, 0, false);
			unk_0x0DC39BE87E4C5599(iLocal_408, 0);
			unk_0x694113444F21E39F(iLocal_408, 29, 0);
			unk_0x694113444F21E39F(iLocal_408, 116, 0);
			unk_0x694113444F21E39F(iLocal_408, 104, 1);
			unk_0x4E65320BC9AD521C(iLocal_408, 1);
			unk_0xD3D9D7C84656DAE5(unk_0x9B0761B4C3EB8BC7(), uLocal_409);
			unk_0xD3D9D7C84656DAE5(iLocal_408, uLocal_409);
			unk_0xB1AC1F996633F5B4(iLocal_408, 1);
			unk_0x5B91E038374B8BD8(iLocal_408, 1);
			unk_0x72126609486AAC5B(iLocal_408, 1);
			iLocal_261 = 0;
		}
	}
	if (!unk_0xAE06B9E39EBDE049(iLocal_416))
	{
		if (unk_0x7D167B9A0CCDA347(iLocal_417))
		{
			iLocal_416 = unk_0xB3116B49FE00E2F1(6, iLocal_417, Local_418, fLocal_421, 1, 1);
			func_69(&uLocal_95, 6, iLocal_416, "MEAmandaCop", 1, 1);
			unk_0xBF0DD7DAFAF15103(iLocal_416, 0);
			unk_0x78024EFD31A7FAD4(iLocal_416, 1, 0, 0, false);
			unk_0xF94DFEAE3DD1EE7E(iLocal_416, 25);
			unk_0xCBF81D3222C77066(iLocal_416, Local_418, 0, 0, 1);
			unk_0x697DA7132EE43ABC(iLocal_416, 110, 0);
			unk_0x74528AC0906CBABE(iLocal_417);
		}
	}
	if (!unk_0xAE06B9E39EBDE049(iLocal_422))
	{
		if (unk_0x7D167B9A0CCDA347(iLocal_423))
		{
			iLocal_422 = unk_0xB3116B49FE00E2F1(4, iLocal_423, Local_424, fLocal_427, 1, 1);
			unk_0x4E65320BC9AD521C(iLocal_422, 1);
			unk_0xCBF81D3222C77066(iLocal_422, Local_424, 0, 0, 1);
			func_69(&uLocal_95, 5, iLocal_422, "MEAmandaShop", 1, 1);
			unk_0x74528AC0906CBABE(iLocal_423);
			unk_0x773B9DEB93E81B2F(Local_418, 50f, 0);
			unk_0x5FEF237DD22FAAC2(Local_381, Local_384, 1);
			unk_0xCCF292009C6F1D61(Local_381, Local_384, 0, 0);
			unk_0x258412C3949C0486(Local_381, Local_384);
			unk_0xC08A186299DFDA0A(Local_381, Local_384, 0, 1, 1, 1);
		}
	}
}
...
int func_431(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	if (!func_15(iParam1))
	{
		...
		if (unk_0x7D167B9A0CCDA347(iVar0))
		{
			...
			{
				*iParam0 = unk_0x6A7A2C83BD302BA4(iParam2, 26, iVar0, iParam3, 0, 0);
...
void func_433()
{
	unk_0x78FCB2E22C41B9D5(iLocal_411);
	unk_0x78FCB2E22C41B9D5(iLocal_417);
	func_434(func_16(17));
	unk_0x78FCB2E22C41B9D5(iLocal_423);
...
void func_436()
{
	...
	if (unk_0xF5EE205091CE6DB2(0))
	{
		if (func_533(unk_0x9B0761B4C3EB8BC7()))
		{
			func_69(&uLocal_95, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 1, 1);
			unk_0x72126609486AAC5B(unk_0x9B0761B4C3EB8BC7(), 1);
		}
		func_69(&uLocal_95, 4, 0, "AMANDA", 0, 1);
		if (func_533(unk_0x9B0761B4C3EB8BC7()))
		{
			uLocal_409 = unk_0x86FB3A0D4870FE62(unk_0x9B0761B4C3EB8BC7());
		}
		...
		if (func_34(0) && func_533(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			unk_0xF27E737981AFB47D(Var1, 100f, 0, 0, 0, 0, 0, 0);
		}
		if (func_461())
		{
			iVar5 = func_460();
			...
			switch (iVar5)
			{
				...
				case 2:
					func_437(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), 1112014848, 12, 5000, 0, 0);
...
void func_446()
{
	...
	if (func_533(unk_0x9B0761B4C3EB8BC7()))
	{
		unk_0x03D382CB0B44E2FC(unk_0x9B0761B4C3EB8BC7(), -832.1946f, -178.313f, 36.5807f, 1, 0, 0, 1);
		unk_0xE922BAA80E8F9324(unk_0x9B0761B4C3EB8BC7(), 41.9602f);
		iVar0 = unk_0xA5D3CD332CD10EE9();
		if (func_8(iVar0))
		{
			unk_0x03D382CB0B44E2FC(iVar0, -836.72f, -179.78f, 37.1f, 1, 0, 0, 1);
		...
		unk_0xF27E737981AFB47D(-836.72f, -179.78f, 37.1f, 100f, 0, 0, 0, 0, 0, 0);
		unk_0x7965943E39128B42(0f, 1065353216);
		unk_0x4C4FC7841A5FB983(0f);
...
int func_500(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_491(unk_0x36FE6D3220816ADA(*uParam0), 1) && unk_0x7F8B14CBFB9813E5(*uParam0, 24) != func_503(*uParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x8DFB45E7317A7ED7(*uParam0, 24, func_503(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_502(uParam0);
	if (func_501(*uParam0))
	{
...
int func_513(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_514(iParam0, uVar1[iVar6], 1) && func_458(unk_0x3E4D3CCC220BDFB1(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_354(Param1, 0f, 0f, 0f, 0)) || unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(iParam0, 1), unk_0x3E4D3CCC220BDFB1(uVar1[iVar6], 1), 1) < 10f)
					{
						unk_0x03A2522C845CFAC6(&iParam0);
						return 1;
					}
...
void func_530()
{
	...
	fVar0 = func_531(unk_0x9B0761B4C3EB8BC7(), Local_387, 1);
...
void func_532()
{
	if (func_533(iLocal_408))
	{
		if (iLocal_449)
		{
			if (unk_0x47DBF174A0CB9D55(iLocal_408, 0))
			{
				unk_0x45F588C0DD767737(iLocal_408, 8, 0, 0, 0);
				iLocal_449 = 0;
			}
		}
		else if (!unk_0x47DBF174A0CB9D55(iLocal_408, 1))
		{
			unk_0x45F588C0DD767737(iLocal_408, 8, 1, 0, 0);
			iLocal_449 = 1;
		}
