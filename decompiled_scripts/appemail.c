...
void func_5()
{
	...
	switch (Global_19681.f_1)
	{
		case 6:
			...
			if (Global_8156 == 1)
			{
				func_64(Global_19662, "DISPLAY_VIEW", 1f, unk_0xBBDA792448DB5A89(Global_19685), -1082130432, -1082130432, -1082130432);
				Global_19661 = Global_19685;
			}
			else
			{
				func_64(Global_19662, "DISPLAY_VIEW", 1f, unk_0xBBDA792448DB5A89(Global_19686), -1082130432, -1082130432, -1082130432);
		...
		case 9:
			...
			{
				func_10();
				func_64(Global_19662, "SET_THEME", unk_0xBBDA792448DB5A89(Global_111858.f_14047[Global_19681 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_21018)
				{
				...
				{
					func_13(Global_19662, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(2), -1f, -1f, &(Global_117[Global_6866 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
				}
				else
				{
					func_13(Global_19662, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(2), -1f, -1f, &(Global_1848[Global_6866 /*29*/].f_3), &(Global_1848[Global_6866 /*29*/].f_7), "CELL_217", &(Global_1848[Global_6866 /*29*/].f_3), 0);
				}
				func_64(Global_19662, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_21005 == 4 || Global_21005 == 3)
			{
				...
				else
				{
					...
					if (func_8(Global_6866, Global_19681) == 0)
					{
						...
						func_13(Global_19662, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_117[Global_6866 /*10*/].f_4), "CELL_300", &Var0, "CELL_195", 0);
					}
					else
					{
						func_64(Global_19662, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_13(Global_19662, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_1848[Global_6866 /*29*/].f_3), &(Global_1848[Global_6866 /*29*/].f_7), &Var0, &(Global_1848[Global_6866 /*29*/].f_3), 0);
					}
				}
				func_64(Global_19662, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
					...
					if (iVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[iVar0] == 0)
						{
							...
							if (Global_2462473)
							{
								if (iVar1 == 14)
								{
									func_13(Global_19662, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7558[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(Global_22068), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8120[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_13(Global_19662, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7558[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(Global_22073), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76833)
								{
									...
									func_13(Global_19662, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7558[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(iVar4), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19681)
									...
									func_13(Global_19662, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7558[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(iVar6), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7558[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_13(Global_19662, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7558[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(iVar9), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_13(Global_19662, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(Global_7558[iVar1 /*15*/].f_10), unk_0xBBDA792448DB5A89(0), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8120[iVar0] = 1;
						}
					}
...
void func_17()
{
	...
	if (!iLocal_63)
	{
		if (unk_0x22D6FB6153F774D3(2, 176) && unk_0xC9D9444186B5A374() > 100)
		{
			if (iLocal_60 == -1)
			{
				unk_0x830F007E19C63E14(Global_19662, "GET_CURRENT_SELECTION");
				uLocal_53 = unk_0xF4712E16A4C164FE();
				while (!unk_0x654BC7395AE9BF77(uLocal_53))
				{
					unk_0x4EDE34FBADD967A6(0);
				}
				iLocal_54 = unk_0x14E3913C604B1108(uLocal_53);
				iLocal_60 = iLocal_54;
				if (func_39(iLocal_55) == 0)
				{
					iLocal_60 = -1;
...
void func_56(var uParam0, int iParam1, int iParam2)
{
	...
	if (!bVar5)
	{
		...
		if (Global_46145[iVar2 /*46*/].f_42 > 1)
		{
			...
			while (iVar41 < iVar39)
			{
				...
				unk_0x830F007E19C63E14(uParam0, "SET_DATA_SLOT");
				unk_0xAD291B8F75D737AD(9);
				unk_0xAD291B8F75D737AD(iVar41 + 1);
	...
	else
	{
		...
		else
		{
			...
			bVar79 = false;
			bVar79 = func_57(uParam0, Global_52120[iVar43 /*203*/].f_1, iVar3, iVar46);
			if (!bVar79)
			{
				unk_0x830F007E19C63E14(uParam0, "SET_DATA_SLOT");
				unk_0xAD291B8F75D737AD(9);
				...
				{
					unk_0xB23270F3D5E62FDE(&Var63);
					iVar80 = 0;
					iVar80 = 0;
					while (iVar80 < Global_52120[iVar43 /*203*/].f_10[iVar3 /*48*/].f_6)
					{
						unk_0x6A826E35A3096ED0(&(Global_52120[iVar43 /*203*/].f_10[iVar3 /*48*/].f_7[iVar80 /*4*/]));
						iVar80++;
					}
					unk_0x2042E9CA4306F725();
				}
...
int func_57(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	while (iVar35 < 16)
	{
		...
		if (bVar37)
		{
			...
			unk_0x6A826E35A3096ED0(sVar38);
			unk_0x42710E9E08FA375A(Global_111858.f_24900[iVar36 /*4*/].f_3);
			unk_0x2042E9CA4306F725();
			unk_0xE1FDD153F5858534();
			iVar2++;
			iVar0 = 1;
...
void func_67(int iParam0)
{
	...
	Global_51758[iVar0 /*120*/] = Var4.f_0;
	iVar124 = 0;
	while (iVar124 < 16)
	{
...
float func_69(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, bool bParam13)
{
	...
	fVar3 = func_71((unk_0xBBDA792448DB5A89((unk_0x578C4EF320340AF7() - iLocal_18)) / fParam12), 0f, 1f);
	if (fVar3 < 1f)
	{
		fVar4 = fVar3;
		if (bParam13)
