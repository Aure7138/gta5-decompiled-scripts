...
void __EntryFunction__()
{
	...
	if (func_35(Global_101652.f_19060, 16384))
	{
		func_36(0);
	}
	while (true)
	{
		...
		if (unk_0x7887B64A08364778(uLocal_95))
		{
			if (unk_0xB529B2A4B7C64D6D(uLocal_95, 0) && !iLocal_99 == 7)
			{
				func_34(&(Global_101652.f_19060), 16384);
				iLocal_99 = 7;
			}
		}
		switch (iLocal_99)
		{
			case 0:
				if ((unk_0x0943F317505D1E39() && !func_33()) && !func_12())
				{
					if (func_11())
					{
						uLocal_95 = unk_0x8C855D8124E955CE(26, iLocal_90, Local_91, uLocal_94, 1, 1);
						unk_0x5457695C257D1470(uLocal_95, 1);
						uLocal_96 = unk_0xF21B698F4FCCA3D3(joaat("prop_tapeplayer_01"), 704.7615f, 4179.574f, 39.7093f, 1, 1, 0);
						unk_0x99569FEC2425586D(uLocal_96, (233.8288f + 180f));
						unk_0xA89A57E40879561F(uLocal_95, 0, 0, 0, 0);
						iLocal_99 = 1;
					}
				}
				else
			...
			case 1:
				iLocal_101 = unk_0x0C17C9FDFC9120BD(Local_91 + Vector(1f, 0f, 0f), 0f, 0f, uLocal_94, 2);
				unk_0xECA52D26609A09F3(uLocal_95, iLocal_101, sLocal_98, "MTN_DNC_if_you_want_to_get_to_heaven", 2f, -2f, 1, 0, 1148846080, 0);
				unk_0xB1B2DE2511B63F4A("MNT_DNC", uLocal_95);
				iLocal_99 = 2;
				break;
			
			case 2:
				if (unk_0xA00FFA2FEFB1A86C(iLocal_101, "MNT_DNC") == 1)
				{
					unk_0x653C3BED81F64F44(iLocal_101);
					iLocal_99 = 3;
				}
				break;
			
			case 3:
				Var0 = { unk_0xC086F8D75730FA3A(uLocal_95, 1) };
				unk_0x7A5660BBF4677EF8(uLocal_95, 3f);
				if (func_10(unk_0xD5A676B97920D126(), uLocal_95) < 10f)
				{
					unk_0x3441075BD734FF79(unk_0xD5A676B97920D126(), 1, uLocal_95, 31086, 0f, 0f, 0f, 0, -1, -1);
					unk_0x3441075BD734FF79(uLocal_95, 1, unk_0xD5A676B97920D126(), 31086, 0f, 0f, 0f, 0, -1, -1);
				}
				if (func_9(uLocal_95, unk_0xD5A676B97920D126(), 1) < 25f)
				{
					if (!unk_0x6901135DDCC4904D(uLocal_100))
					{
						func_5(&uLocal_100, &uLocal_95, 0);
						unk_0x4F095059F1C175D5(uLocal_100, 3);
					}
				}
				else if (unk_0x6901135DDCC4904D(uLocal_100))
				{
					func_4(&uLocal_100);
				}
				if (unk_0x2C3B61BDCED77B45(iLocal_101) > 0.9999999f)
				{
					iLocal_99 = 1;
				}
				if (unk_0x9B0C8A2FC23E64AB(uLocal_95))
				{
					unk_0x14DA5DDB8B6ADFCE(iLocal_101);
					iLocal_99 = 4;
				}
				if (((((unk_0x00B5B0B68211D89B(uLocal_95) || unk_0x1DEB1994A3C25E35(Var0, 50f, 1)) || unk_0x1DEB1994A3C25E35(Var0, 50f, 0)) || unk_0x4B16FF7207D89FDF(Var0, 20f, 20f, 20f, 0)) || unk_0x4404F63C94223B29(-1, Var0, 50f)) || (((unk_0xF84188B3D9E24D81(unk_0xFB6B3EEFAB2DD12C(), uLocal_95) || unk_0x982AB85BDD884D31(unk_0xFB6B3EEFAB2DD12C(), uLocal_95)) && unk_0x8E92CDAEB8357ABD(unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 1), Var0, 1) < 25f) && func_1(uLocal_95, unk_0xD5A676B97920D126(), 1126825984, 0)))
				{
					unk_0x14DA5DDB8B6ADFCE(iLocal_101);
					iLocal_99 = 4;
					iLocal_97 = 1;
			...
			case 4:
				...
				if (!unk_0x9B0C8A2FC23E64AB(uLocal_95))
				{
					if (iLocal_97 == 1)
					{
						unk_0x1D2CBA8F2F00D745(uLocal_95, 723.1315f, 4171.957f, 39.7091f, 2f, -1, 1f, 1024, 1193033728);
					}
					else
					{
						unk_0x1D2CBA8F2F00D745(uLocal_95, 723.1315f, 4171.957f, 39.7091f, 1f, -1, 1f, 1024, 1193033728);
					}
					unk_0x7D99F00F48D15ADB(uLocal_95, 1);
					iLocal_99 = 6;
				}
				break;
			
			case 6:
				if (unk_0x1774A68441553185(uLocal_95, 713668775) != 1 && unk_0x1774A68441553185(uLocal_95, 713668775) != 0)
				{
					unk_0x5457695C257D1470(uLocal_95, 0);
					if (iLocal_97 == 1)
					{
						unk_0xBB8F1D58B7578137(uLocal_95, unk_0xD5A676B97920D126(), 100f, -1, 0, 0);
					}
					else
					{
						unk_0xEBF1276539CCAA92(uLocal_95, 1193033728, 0);
					}
					unk_0x7D99F00F48D15ADB(uLocal_95, 1);
					iLocal_99 = 5;
				}
			...
			case 5:
				if ((unk_0x27A556D1AF39812E(uLocal_95) && unk_0x8E92CDAEB8357ABD(unk_0xC086F8D75730FA3A(uLocal_95, 1), unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 1), 1) > 50f) && !unk_0x0943F317505D1E39())
				{
					func_36(1);
				}
				break;
...
int func_1(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_3(unk_0xC086F8D75730FA3A(uParam1, 1) - unk_0xC086F8D75730FA3A(uParam0, 1)) };
	...
	{
		Var3 = { func_3(unk_0x6DE9A8183DA7678E(uParam0, 31086, 0f, 5f, 0f) - unk_0x6DE9A8183DA7678E(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_7(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xF563C3AC64885E69(uVar0, func_8(unk_0x1995B52453EF6537(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xF563C3AC64885E69(uVar0, func_8(unk_0x1995B52453EF6537(), 0.7f, 0.7f));
		unk_0x1BDDADB5ACDFD382(uVar0, bParam1);
	}
...
int func_11()
{
	...
	unk_0x49E996A1E39EAAD7(sLocal_98);
	if (unk_0x7AD0E9452821C95D(iLocal_90) && unk_0xD7669BF035CDA5F6(sLocal_98))
	{
		return 1;
	}
	return 0;
...
int func_12()
{
	...
	{
		if (unk_0xA8CEACB4F35AE058(unk_0x9C0A225C3A240597(unk_0xD5A676B97920D126())) > 1369f && !func_26())
		{
			return 0;
		}
	}
...
void func_20()
{
	...
	if (unk_0x7887B64A08364778(unk_0xD5A676B97920D126()))
	{
		if (func_23(Global_101652.f_2079.f_539.f_3549) != unk_0xA0A4DA31DEDFAC4F(unk_0xD5A676B97920D126()))
		{
			...
			if (func_24(iVar0) && (!func_21(14) || Global_100604))
			{
...
{
	return func_32(iParam0, Global_35777);
}
...
{
	if (unk_0x7887B64A08364778(uLocal_96))
	{
		unk_0x77CEDAB7C44BFD4E(&uLocal_96);
	}
	if (unk_0x6901135DDCC4904D(uLocal_100))
	{
		func_4(&uLocal_100);
	...
	if (unk_0x7887B64A08364778(uLocal_95))
	{
		if (bParam0)
		{
			unk_0xA2AC407F9132DD0B(&uLocal_95);
		}
		else
		{
			unk_0xD4B3FF1E63C36391(&uLocal_95);
		}
	}
