...
void __EntryFunction__()
{
	...
	func_397();
	func_383();
	uLocal_360 = unk_0x2915D98110F23A29(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, 0, 1, 1, 1);
	func_382(27, 0);
	if (func_381())
	{
		func_380(409.6954f, -1567.046f, 28.2916f, 138.7093f, 1, 0);
	}
	unk_0xF30CF8286FBA13D7(0);
	while (true)
	{
		unk_0x6D3F703013ED87D3("M_STS", 0);
		if (func_379(unk_0xE2D3D51028F0428A()))
		{
			func_372();
			func_369();
			func_364();
...
void func_1()
{
	switch (iLocal_81)
	{
		case 0:
			...
			func_33();
			if (!unk_0xACC32B78196FBC2A(sLocal_353))
			{
				func_31(sLocal_353);
			}
			else
		...
		case 1:
			if (func_14())
			{
				...
				else if (func_12(&uLocal_196, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)))
				{
					func_10(408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_8(471.5946f, -1412.737f, 28.1562f, 68.5531f);
				}
				unk_0x7A997A0A971D305F(372.9868f, -1623.531f, 28.2928f, 100f, 1, 0, 0, 0);
				func_2();
				func_398();
			}
			break;
...
void func_2()
{
	...
	unk_0xF5644C53558C678D(Local_456.f_0);
	func_5(&Local_456);
	func_4(&uLocal_358);
	iVar0 = 0;
	while (iVar0 <= 2)
...
void func_15(int iParam0)
{
	...
	if (Global_112922.f_9085 || func_30(0))
	{
		iVar0 = func_29();
		if (!func_16(iVar0))
		{
...
int func_16(int iParam0)
{
	...
	func_17(&(Global_112922.f_2363.f_539), iVar1);
...
void func_17(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_19(Global_112922.f_18533[iVar0], &Var2, &fVar5))
			{
...
void func_23()
{
	...
	{
		if (func_27(Global_112922.f_2363.f_539.f_4321) != unk_0x15CAA6D7B11F1A7C(unk_0xE2D3D51028F0428A()))
		{
			iVar0 = func_26(unk_0xE2D3D51028F0428A());
			if (func_25(iVar0) && (!func_24(14) || Global_111873))
			{
...
void func_35()
{
	...
	switch (iLocal_81)
	{
		case 0:
			...
			{
				if (unk_0x63B063064DC08617("FHPRA_STOP"))
				{
					iLocal_385 = 0;
					iLocal_663 = 0;
					iLocal_81 = 1;
					unk_0x1CF3F44FC2EB9F99("FHPRA_STOP");
				}
			}
			break;
		...
		case 1:
			...
			if (iLocal_91 == 2)
			{
				if (func_12(&uLocal_196, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)))
				{
			...
			{
				unk_0x2DA9F9D8E5530E75(5f, 6f, 4);
				func_55();
				func_50();
			}
			break;
		...
		case 3:
			...
			{
				if (!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), Local_456.f_0, 0))
				{
					unk_0xA9F390242F9EB2E1(unk_0xE2D3D51028F0428A(), Local_456.f_0, -1);
				}
				else
				{
...
int func_49(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
void func_51(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_30(0) && Global_78104.f_1 == 1) && func_52(Global_78104))
		{
		}
		else
		{
...
int func_58(int iParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	...
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			if (!unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Param1, fParam12, fParam12, 2f, 0, 1, 2))
			{
				...
				{
					unk_0xE2EC74D02A707B37(func_68(func_69()));
				}
				*iParam7 = 1;
			...
			else
			{
				...
				{
					fVar0 = (fParam12 / 2f);
					if (func_63(unk_0xE2D3D51028F0428A(), Param1, fVar0))
					{
						*iParam7 = 0;
	...
	else
	{
		...
		if (!*iParam8)
		{
			...
			{
				unk_0xE2EC74D02A707B37(func_61(func_69(), 0));
			}
...
int func_62(int iParam0, int iParam1)
{
	...
	if (unk_0x55A0C756C4A8220C(iVar0, 0))
	{
		if (unk_0xAB793EA186AB8DAA(iVar0, -1, 0) == unk_0xE2D3D51028F0428A())
		{
			...
			{
				unk_0xD28E3800883DED83(iVar0, iParam0, iParam1, 0);
				return 0;
			}
		}
		else
...
void func_64(int iParam0, struct<3> Param1, int iParam4)
{
	if (!unk_0x12DD4A0B247D9B4D(*iParam0))
	{
		*iParam0 = func_65(Param1, 5, iParam4);
	}
}

int func_65(struct<3> Param0, int iParam3, int iParam4)
{
	int iVar0;
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_82(1, Local_361, 0))
			{
				...
				{
					uLocal_371 = unk_0x7AFC31F33CB9B8D5(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), 0, 7);
					if (unk_0x47B4A2F6A146C0BB(Local_456.f_0) != 0)
					{
						iVar0 = unk_0x47B4A2F6A146C0BB(Local_456.f_0);
		...
		case 1:
			if (bParam1)
			{
				if (((func_82(2, Local_456.f_1, Local_456.f_4) && func_82(4, Local_361, 0)) && func_82(3, Local_361, 0)) && func_82(5, Local_361, 0))
				{
					func_74(unk_0xE2D3D51028F0428A(), 408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_72();
					unk_0xF96094A43D443C41(369.0115f, -1609.116f, 28.2928f, 5f, 0);
					unk_0xF96094A43D443C41(Local_389[0 /*22*/].f_1, 5f, 0);
					func_77();
					func_75();
					bLocal_28 = false;
					func_36(1, 1, 1);
...
void func_72()
{
	...
	iLocal_662 = 1;
	func_382(27, 0);
	unk_0x7E15597AA5F53F9A(Global_41298[13 /*31*/], 4, 1, 0);
	iLocal_663 = 0;
}
...
void func_73()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (bVar0 <= (15 - 1))
		{
			unk_0xB0550BC91B0159D6(&(Local_389[iVar1 /*22*/].f_15), bVar0);
			bVar0++;
		}
...
void func_75()
{
	...
	func_76(&uLocal_483, iVar0, unk_0xE2D3D51028F0428A(), sVar1, 0, 1);
...
void func_77()
{
	...
	while (iVar0 <= 2)
	{
		unk_0x50274A7EACA3133A(Local_389[iVar0 /*22*/], false);
		if (!func_78(Local_389[iVar0 /*22*/], joaat("script_task_start_scenario_at_position")))
		{
			switch (iVar0)
			{
				case 0:
				case 1:
					unk_0xDB4F67AAFBF32AA5(Local_389[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET", Local_389[iVar0 /*22*/].f_1, Local_389[iVar0 /*22*/].f_4, 0, 0, 1);
					break;
				
				case 2:
					unk_0x57CAA5FBF134D4AE(Local_389[iVar0 /*22*/], 1, 1);
					break;
				}
		}
		unk_0x9521FB98DB6DDF50(Local_389[iVar0 /*22*/], joaat("weapon_pistol"), -1, 0, 0);
		unk_0xFF4BEB6CFF55A013(Local_389[iVar0 /*22*/], uLocal_481);
...
void func_79(int iParam0, int iParam1, int iParam2)
{
	if (!unk_0x12DD4A0B247D9B4D(*iParam0))
	{
		*iParam0 = func_80(iParam1, iParam2, 5);
	}
}

int func_80(var uParam0, var uParam1, int iParam2)
{
	int iVar0;
...
int func_82(int iParam0, struct<3> Param1, float fParam4)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			unk_0x249A0D3C5714BCF4(sLocal_354, 0);
			unk_0x249A0D3C5714BCF4(cLocal_482, 6);
			if (unk_0x01896B71C5AC966E(0) && unk_0x01896B71C5AC966E(6))
			{
				return 1;
			}
			break;
		...
		case 2:
			if (func_7(Global_96477[0]))
			{
				unk_0x2D58A6131679D82C(Global_96477[0], 1, 1);
				Local_456.f_0 = Global_96477[0];
				if (func_7(Local_456.f_0))
				{
					if (!unk_0x79A822779CC6508A(Local_456.f_0))
					{
						unk_0x66E36C5E6E28930C(Local_456.f_0);
					}
					unk_0x6D60ABBA76DB955A(Local_456.f_0, 2, 0);
					unk_0x6D60ABBA76DB955A(Local_456.f_0, 3, 0);
					func_89(Local_456.f_0, 0);
					unk_0x05EAB38F5AC8DA1D(Local_456.f_0, 1);
					unk_0x3B2646B62E7BBE11(Local_456.f_0, 1);
					return 1;
				}
			}
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				if (unk_0xE5965CDF24F93A9F(Global_96477.f_9[iVar0]))
				{
					if (!unk_0xE63474311C6E3825(Global_96477.f_9[iVar0], 1))
					{
						unk_0x2D58A6131679D82C(Global_96477.f_9[iVar0], 1, 1);
						Local_389[iVar0 /*22*/] = Global_96477.f_9[iVar0];
						if (func_379(Local_389[iVar0 /*22*/]))
						{
							unk_0x7DCB4594ACF18DA7(Local_389[iVar0 /*22*/], 2);
							unk_0x059473086913178C(Local_389[iVar0 /*22*/], 1);
							func_87(iVar0);
							iVar1++;
						}
					}
				...
				else if (func_86(&(Local_389[iVar0 /*22*/]), Local_389[iVar0 /*22*/].f_5, Local_389[iVar0 /*22*/].f_1, Local_389[iVar0 /*22*/].f_4, 0, 0, 0, 1))
				{
					...
					unk_0xD8B630F464FE1D6D(Local_389[iVar0 /*22*/], &cVar2);
					iVar1++;
				}
				iVar0++;
			}
		...
		case 4:
			...
			while (iVar6 <= 3)
			{
				if (func_7(Global_96477[iVar6]))
				{
					unk_0x2D58A6131679D82C(Global_96477[iVar6], 1, 1);
					Local_462[iVar7 /*6*/] = Global_96477[iVar6];
		...
		case 5:
			if (func_83(&uLocal_358, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_456.f_0))
				{
					unk_0x9A97DC6DBC7B223D(uLocal_358, Local_456.f_0, 0, 0f, -1.85f, 0.05f, unk_0x63A8BF5E6C2BF85C(Local_456.f_0, 2), 0, 0, 0, 0, 2, 1);
					if (unk_0x099CAD293190F449(Local_456.f_0, uLocal_358))
					{
						return 1;
					}
				}
...
int func_83(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	if (!unk_0xE5965CDF24F93A9F(*uParam0))
	{
...
int func_85(var uParam0, char* sParam1, int iParam2)
{
...
int func_86(var uParam0, var uParam1, struct<3> Param2, var uParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	if (!unk_0xE5965CDF24F93A9F(*uParam0))
	{
		if (func_85(uParam1, "Loading", 0))
		{
...
void func_87(int iParam0)
{
	if (func_379(Local_389[iParam0 /*22*/]))
	{
		if (iParam0 == 0)
		{
			unk_0xE3752B10DC995E95(Local_389[iParam0 /*22*/], 0, 0, 1, 0);
			unk_0xE3752B10DC995E95(Local_389[iParam0 /*22*/], 3, 0, 0, 0);
			unk_0xE3752B10DC995E95(Local_389[iParam0 /*22*/], 4, 0, 0, 0);
			unk_0xE3752B10DC995E95(Local_389[iParam0 /*22*/], 8, 0, 0, 0);
			unk_0xE3752B10DC995E95(Local_389[iParam0 /*22*/], 9, 1, 0, 0);
			unk_0xE3752B10DC995E95(Local_389[iParam0 /*22*/], 10, 0, 0, 0);
		}
		else
		{
			unk_0xE3752B10DC995E95(Local_389[iParam0 /*22*/], 0, 1, 1, 0);
			unk_0xE3752B10DC995E95(Local_389[iParam0 /*22*/], 3, 0, 1, 0);
			unk_0xE3752B10DC995E95(Local_389[iParam0 /*22*/], 4, 0, 0, 0);
			unk_0xE3752B10DC995E95(Local_389[iParam0 /*22*/], 8, 1, 0, 0);
			unk_0xE3752B10DC995E95(Local_389[iParam0 /*22*/], 9, 2, 0, 0);
			unk_0xE3752B10DC995E95(Local_389[iParam0 /*22*/], 10, 0, 1, 0);
		}
	}
}

int func_88(int iParam0, var uParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	if (!unk_0xE5965CDF24F93A9F(*iParam0))
	{
		if (func_85(uParam1, "Loading", 0))
		{
			*iParam0 = unk_0xBA715A7BEBA5A1F9(uParam1, Param2, uParam5, 1, 1, 0);
			if (unk_0xE5965CDF24F93A9F(*iParam0))
			{
	...
	else
	{
		if (func_7(*iParam0))
		{
			...
			unk_0xBBF86885619695CE(*iParam0, uParam5);
		}
		if (!unk_0xA6A089369417736E(*iParam0))
		{
			unk_0x2D58A6131679D82C(*iParam0, 1, 0);
...
{
	Global_99980.f_22[iParam1] = iParam0;
}
...
void func_91(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, struct<3> Param5, int iParam8, bool bParam9, int iParam10)
{
	if (func_7(*iParam0))
	{
		switch (*iParam2)
		{
			case 0:
				if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), *iParam0, 0))
				{
					...
					if (func_66(func_60(func_69()), 0, 0))
					{
						unk_0xE2EC74D02A707B37(func_60(func_69()));
					}
					if (*iParam0 == iParam8)
					{
						*iParam2 = 1;
				...
				else
				{
					...
					{
						unk_0xE2EC74D02A707B37(func_61(func_69(), bParam9));
					}
					if (func_69() != 33)
					{
						func_94(iParam0);
			...
			case 2:
			case 1:
				if ((!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), *iParam0, 0) && !func_97(*iParam0)) && !func_96(*iParam0))
				{
					func_34(iParam4);
...
void func_94(var uParam0)
{
	...
	if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
	{
		...
		if (iVar0 != *uParam0)
		{
			if (func_7(iVar0))
			{
				if (unk_0x15CAA6D7B11F1A7C(iVar0) == func_95(func_69()))
				{
					func_93(uParam0);
					*uParam0 = iVar0;
					func_89(*uParam0, 1);
...
int func_96(int iParam0)
{
	...
	if ((func_379(unk_0xE2D3D51028F0428A()) && unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0)) && func_7(iParam0))
	{
...
void func_98()
{
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_71(iLocal_80, bLocal_28))
			{
				if (unk_0x63B063064DC08617("FHPRA_VAN"))
				{
					if (unk_0xC378B7F0D175A5B0(unk_0x9E2D6C50374FCFA9()) == 0)
					{
						if (iLocal_82 == 1 || iLocal_82 == 2)
						{
							...
							unk_0x2DA9F9D8E5530E75(5f, 6f, 4);
							unk_0x1CF3F44FC2EB9F99("FHPRA_VAN");
		...
		case 1:
			...
			if (iLocal_91 == 2)
			{
				...
				if (!iLocal_664)
				{
					unk_0x8BAE3B6695282DC0("SCRIPTED_SCANNER_REPORT_BS_PREP_A_01", 0f);
					iLocal_664 = 1;
				}
			}
	...
	while (iVar0 < 3)
	{
		...
		if (!unk_0xF68107C40359970C(iVar1))
		{
			switch (iLocal_87[iVar0])
			{
						...
						if (func_114(iVar1, 0))
						{
							if (func_113(iVar0, iVar1) || func_111(iVar0, iVar1))
							{
								if (func_110(iVar1, 0))
								{
									...
									unk_0x50274A7EACA3133A(iVar1, true);
				...
				case 1:
					if (func_109(iVar0, iVar1) && unk_0x930E64CB0285CAEC(iVar1, 1))
					{
						iLocal_87[iVar0] = 0;
						func_108(iVar1);
					}
				...
				case 2:
					if (func_107(iVar0, iVar1) && unk_0x930E64CB0285CAEC(iVar1, 1))
					{
						iLocal_87[iVar0] = 0;
						func_108(iVar1);
					}
...
int func_107(int iParam0, int iParam1)
{
	...
	{
		case 0:
			unk_0xFDB121077308E944(iParam1, unk_0xB3FF0049C1FD38EC(iParam1, 0), Local_364, 4, 20f, 786469, 3.5f, 5f, 1);
			iLocal_83[iParam0] = 3;
			break;
		
		case 3:
			if (!func_111(iParam0, iParam1) || func_63(unk_0xE2D3D51028F0428A(), Local_364, 2f))
			{
				iLocal_83[iParam0] = 4;
			}
			break;
...
int func_108(int iParam0)
{
	...
	if (!unk_0xF68107C40359970C(iParam0))
	{
		...
		unk_0xB0550BC91B0159D6(&Global_95834, bVar0);
		return 1;
	}
	return 0;
}
...
int func_109(int iParam0, int iParam1)
{
	...
	{
		case 0:
			if (!unk_0x90BD7EB173E1CFD6(Local_300[iLocal_665 /*4*/], 1.5f, 0, 0, 1, 0, 0, iParam1, 0))
			{
				...
				unk_0x7D1424753688EE7A(iParam1, Local_300[iLocal_665 /*4*/], fVar0, 20000, 0.25f, 0, Local_300[iLocal_665 /*4*/].f_3);
				iLocal_83[iParam0] = 1;
			}
			break;
		...
		case 1:
			...
			{
				unk_0x893DDD76CC7C67B1(iParam1, 0);
				iLocal_83[iParam0] = 2;
			}
			break;
...
int func_110(int iParam0, int iParam1)
{
	...
	if (!unk_0xF68107C40359970C(iParam0))
	{
		...
		if (BitTest(Global_95833, bVar0))
		{
			...
			unk_0xCED9E32812D6C7C7(&Global_95834, bVar0);
			return 1;
		}
	}
	return 0;
...
int func_111(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if ((unk_0xE5965CDF24F93A9F(Local_456.f_0) && unk_0x55A0C756C4A8220C(Local_456.f_0, 0)) && !unk_0x8F41785F110B0DA0(Local_456.f_0, Local_364, 2f, 2f, 2f, 0, 1, 0))
		{
			if ((!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()) && unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), Local_456.f_0, 0)) && unk_0xC378B7F0D175A5B0(unk_0x9E2D6C50374FCFA9()) == 0)
			{
				if (unk_0xF6F5D18EF8EAB859(iParam1, Local_456.f_0, 0) && unk_0xAB793EA186AB8DAA(Local_456.f_0, -1, 0) == iParam1)
				{
					iLocal_87[iParam0] = 2;
					return 1;
				}
...
int func_113(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if (unk_0xD132EDDA78FF4A51(iParam1, 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.63f, 0, 1, 0) && unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.38f, 0, 1, 0))
		{
			iLocal_665 = 0;
			iLocal_87[iParam0] = 1;
			return 1;
		}
		else if (unk_0xD132EDDA78FF4A51(iParam1, 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.63f, 0, 1, 0) && unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.38f, 0, 1, 0))
		{
			iLocal_665 = 1;
			iLocal_87[iParam0] = 1;
			return 1;
...
int func_116(int iParam0)
{
	...
	return Global_97458[func_117(iParam0)];
}
...
void func_118()
{
	...
	if (!bLocal_28)
	{
		...
		{
			unk_0x01E6FD194DCBEB7D(unk_0x9E2D6C50374FCFA9(), 38);
			unk_0x01E6FD194DCBEB7D(unk_0x9E2D6C50374FCFA9(), 30);
			bLocal_374 = false;
		}
		if (iLocal_80 == 2)
		{
			if (!iLocal_386)
			{
				if (!func_63(unk_0xE2D3D51028F0428A(), Local_456.f_1, 180f))
				{
					iVar0 = 0;
					while (iVar0 <= 2)
					{
...
void func_119()
{
	...
	{
		if (unk_0xE5965CDF24F93A9F(Local_389[iVar0 /*22*/]) && !unk_0xF68107C40359970C(Local_389[iVar0 /*22*/]))
		{
			if (unk_0x0747E45CFF1F74AA(Local_389[iVar0 /*22*/], unk_0xE2D3D51028F0428A(), 1))
			{
				unk_0xE68645525D451A8B(Local_389[iVar0 /*22*/]);
				if (((unk_0x807D601FA146717A(unk_0xE2D3D51028F0428A()) || unk_0x4B7E6E16D3345FE8(Local_389[iVar0 /*22*/])) || unk_0xE573ACA59D8C5C18(Local_389[iVar0 /*22*/])) || unk_0xED41AAC94202B65C(Local_389[iVar0 /*22*/]))
				{
					if (!bLocal_374)
					{
						unk_0x01E6FD194DCBEB7D(unk_0x9E2D6C50374FCFA9(), 41);
						unk_0x01E6FD194DCBEB7D(unk_0x9E2D6C50374FCFA9(), 33);
...
void func_120(int iParam0)
{
	...
	switch (Local_389[iParam0 /*22*/].f_20)
	{
		case 1:
			...
			{
				if (unk_0x320D1840B6DAA1CC() - Local_389[iParam0 /*22*/].f_14) > unk_0x5853B15F78E1A265(1000, 1500)
				{
					if (!func_78(Local_389[iParam0 /*22*/], joaat("script_task_turn_ped_to_face_entity")))
					{
						unk_0x41FBE02637A70478(Local_389[iParam0 /*22*/]);
						unk_0x529D306014D3C29A(Local_389[iParam0 /*22*/], unk_0xE2D3D51028F0428A(), 0);
					}
					Local_389[iParam0 /*22*/].f_14 = unk_0x320D1840B6DAA1CC();
				}
			}
			else
			{
		...
		case 2:
			if (unk_0x320D1840B6DAA1CC() - Local_389[iParam0 /*22*/].f_14) > unk_0x5853B15F78E1A265(5000, 6000)
			{
		...
		case 3:
			if (unk_0x320D1840B6DAA1CC() - Local_389[iParam0 /*22*/].f_14) > unk_0x5853B15F78E1A265(2500, 3000)
			{
		...
		case 6:
			...
			if ((unk_0x320D1840B6DAA1CC() - Local_389[iParam0 /*22*/].f_14) > iVar0)
			{
				if (!unk_0x7114C4D8AC9360FE(Local_389[iParam0 /*22*/], 0) && !unk_0x645F244ECDDEF6CF(Local_389[iParam0 /*22*/]))
				{
					Local_389[iParam0 /*22*/].f_14 = unk_0x320D1840B6DAA1CC();
					func_127(iParam0);
				}
		...
		case 5:
			if (unk_0x320D1840B6DAA1CC() - Local_389[iParam0 /*22*/].f_14) > unk_0x5853B15F78E1A265(1000, 3000)
			{
				func_125();
				return;
			}
		...
		case 7:
			if ((unk_0x320D1840B6DAA1CC() - Local_389[iParam0 /*22*/].f_14) > 350)
			{
				if (!bLocal_374 && func_124(iParam0, 15))
				{
					func_73();
					func_134(iParam0);
					unk_0xE38EE0041B752011(Local_389[iParam0 /*22*/]);
					return;
				}
				else
				{
					if (iLocal_660 != -1)
					{
						if ((unk_0x320D1840B6DAA1CC() - iLocal_660) > 12000)
						{
							func_123(-1);
						}
						else if ((unk_0xE323E6755636A70E(unk_0xE2D3D51028F0428A()) || unk_0x1755A0CD57C780C6(unk_0xE2D3D51028F0428A())) || unk_0x7A6B8C262362C722(unk_0xE2D3D51028F0428A()))
						{
							func_123(2);
						}
						else if (unk_0xFD48978E4E1BAA06(unk_0x9E2D6C50374FCFA9(), &iVar1))
						{
							if (unk_0x9044EDB8A7BF67B4(iVar1))
							{
								iVar2 = unk_0x28AA31872A651BC7(iVar1);
					...
					if ((func_78(Local_389[iParam0 /*22*/], joaat("script_task_invalid")) || func_78(Local_389[iParam0 /*22*/], joaat("script_task_stand_still"))) && unk_0xC378B7F0D175A5B0(unk_0x9E2D6C50374FCFA9()) < 2)
					{
						if (!func_78(Local_389[iParam0 /*22*/], joaat("script_task_arrest_ped")))
						{
							unk_0x463D4F9C4826A59B(Local_389[iParam0 /*22*/], unk_0xE2D3D51028F0428A());
						}
					}
				}
			}
...
void func_123(int iParam0)
{
	...
	iLocal_660 = -1;
	if (func_379(Local_389[0 /*22*/]))
	{
		unk_0x50274A7EACA3133A(Local_389[0 /*22*/], false);
	}
	if (func_379(Local_389[1 /*22*/]))
	{
		unk_0x50274A7EACA3133A(Local_389[1 /*22*/], false);
	}
	if (func_379(Local_389[2 /*22*/]))
	{
		unk_0x50274A7EACA3133A(Local_389[2 /*22*/], false);
	}
	if (iParam0 != -1)
	{
		unk_0xBCD99B4EDAE55BE6(unk_0x9E2D6C50374FCFA9(), iParam0, 0);
		unk_0xB78CBE6C9550E5EF(unk_0x9E2D6C50374FCFA9(), 0);
	}
}
...
void func_125()
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			func_195(&(Local_389[iVar0 /*22*/].f_6));
			Local_389[iVar0 /*22*/].f_14 = unk_0x320D1840B6DAA1CC();
...
void func_126()
{
	if (!iLocal_375)
	{
		iLocal_660 = unk_0x320D1840B6DAA1CC();
		if (!iLocal_659)
		{
			func_104();
		}
...
void func_127(int iParam0)
{
	if (Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (func_379(Local_389[iParam0 /*22*/]))
		{
			if (func_78(Local_389[iParam0 /*22*/], joaat("script_task_perform_sequence")) || unk_0xE7B380B27E19C446(Local_389[iParam0 /*22*/]))
			{
				unk_0x03A927199A2DFE46(Local_389[iParam0 /*22*/]);
			}
			...
			unk_0x8601AD4E55C81412(Local_389[iParam0 /*22*/], 1);
			unk_0x463D4F9C4826A59B(Local_389[iParam0 /*22*/], unk_0xE2D3D51028F0428A());
			unk_0x9521FB98DB6DDF50(Local_389[iParam0 /*22*/], joaat("weapon_pistol"), -1, 0, 1);
			unk_0xE68645525D451A8B(Local_389[iParam0 /*22*/]);
			unk_0xB2CC2A0592C4EFCF(unk_0x9E2D6C50374FCFA9());
			func_128(iParam0);
...
void func_128(int iParam0)
{
	...
	if ((iLocal_80 != 2 && !iLocal_659) && !unk_0x55B23FE400FCEA6B(Local_389[iParam0 /*22*/], 0))
	{
		if (func_133(iParam0) && func_131(Local_389[iParam0 /*22*/], 30f))
		{
			...
			else if (!func_124(iParam0, 15) || unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
			{
				func_129();
				iLocal_656 = 0;
				if (iParam0 == 2)
				...
				{
					unk_0x49C085D876A9986D(Local_389[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", 0);
				}
				iLocal_659 = 1;
			}
		}
...
int func_131(int iParam0, float fParam1)
{
	...
	if (func_379(unk_0xE2D3D51028F0428A()) && func_379(iParam0))
	{
		if (func_132(unk_0xE2D3D51028F0428A(), iParam0, 0) <= fParam1)
		{
			return 1;
		}
	}
...
void func_134(int iParam0)
{
	...
	{
		unk_0x03A927199A2DFE46(Local_389[iParam0 /*22*/]);
		unk_0xFF4BEB6CFF55A013(Local_389[iParam0 /*22*/], uLocal_481);
		if (iParam0 == 2)
		{
			unk_0xA888F8CC04F25CC8(&uVar0);
			if (!func_63(Local_389[iParam0 /*22*/], Local_389[iParam0 /*22*/].f_1, 3f))
			{
				unk_0x7D1424753688EE7A(0, Local_389[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, 0, Local_389[iParam0 /*22*/].f_4);
			}
			else
			{
				unk_0x30E00B59448AB97E(0, Local_389[iParam0 /*22*/].f_4, 0);
			}
			if (iLocal_648[2] && unk_0xACC32B78196FBC2A("sResumeRoot"))
			{
				unk_0xC9FEFB406C44F60B(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
			}
			else
			{
				unk_0x57CAA5FBF134D4AE(0, 1, 1);
			}
			unk_0xC963A45B50851768(uVar0);
			unk_0x8ACADA903FCAA42F(Local_389[iParam0 /*22*/], uVar0);
		...
		func_135();
		unk_0x50274A7EACA3133A(Local_389[iParam0 /*22*/], false);
...
void func_135()
{
	if (func_12(&uLocal_92, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)))
	{
		if (!func_103())
		{
			if ((!unk_0x3C57C2F07FEE34D2(&cLocal_666, "NONE") && !unk_0x3C57C2F07FEE34D2(&cLocal_672, "NONE")) && !func_66("PR_TAKBACK", 0, 0))
			{
...
int func_139()
{
	...
	if (unk_0x9E2D6C50374FCFA9() == func_142())
	{
		return 0;
	}
	if (func_140(unk_0x9E2D6C50374FCFA9()))
	{
		return 0;
	}
...
void func_151(int iParam0)
{
	switch (Local_389[iParam0 /*22*/].f_21)
	{
		case 0:
			if (func_103())
			{
				if (unk_0x4B7E6E16D3345FE8(Local_389[iParam0 /*22*/]))
				{
					func_129();
				}
			}
			...
			{
				if (iLocal_648[2] && !unk_0x769CB0E209F11AD8(Local_389[iParam0 /*22*/]))
				{
					unk_0x03A927199A2DFE46(Local_389[iParam0 /*22*/]);
					unk_0xC9FEFB406C44F60B(Local_389[iParam0 /*22*/], "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				}
			}
			break;
...
void func_152(int iParam0)
{
	...
	if (!func_173(iParam0))
	{
		if (func_154(Local_389[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || unk_0x89D0E0233F6E59A7(-1, unk_0x6B62510F212526DC(Local_389[iParam0 /*22*/], 1), 100f))
		{
			if ((!unk_0x4B7E6E16D3345FE8(Local_389[iParam0 /*22*/]) && !unk_0xE573ACA59D8C5C18(Local_389[iParam0 /*22*/])) && !unk_0xED41AAC94202B65C(Local_389[iParam0 /*22*/]))
			{
				func_125();
			}
			else if (!bLocal_374)
			{
				unk_0x01E6FD194DCBEB7D(unk_0x9E2D6C50374FCFA9(), 41);
				unk_0x01E6FD194DCBEB7D(unk_0x9E2D6C50374FCFA9(), 33);
				unk_0x01E6FD194DCBEB7D(unk_0x9E2D6C50374FCFA9(), 12);
				unk_0xBCD99B4EDAE55BE6(unk_0x9E2D6C50374FCFA9(), 0, 0);
				unk_0xB78CBE6C9550E5EF(unk_0x9E2D6C50374FCFA9(), 0);
			}
		}
	}
	else if (func_153(Local_389[iParam0 /*22*/], unk_0xE2D3D51028F0428A(), 5f, 1))
	{
		if (!bLocal_374)
		{
			unk_0x01E6FD194DCBEB7D(unk_0x9E2D6C50374FCFA9(), 41);
...
bool func_153(int iParam0, int iParam1, float fParam2, int iParam3)
{
...
int func_154(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_6(unk_0xE2D3D51028F0428A()) && func_6(iParam0))
	{
		...
		if (!unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 6))
		{
			if (unk_0x7A6B8C262362C722(unk_0xE2D3D51028F0428A()))
			{
				...
				{
					return func_167(unk_0xE2D3D51028F0428A(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_155(int iParam0, float fParam1)
{
	...
	if (func_6(unk_0xE2D3D51028F0428A()) && func_6(iParam0))
	{
		if (func_166(iParam0) || unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iParam0))
		{
			if (unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 6))
			{
				fVar0 = 40f;
...
{
	return func_157(iParam0, unk_0xE2D3D51028F0428A(), fParam1, 1, 250, 7);
}
...
int func_161(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_163(unk_0x6B62510F212526DC(iParam1, 1) - unk_0x6B62510F212526DC(iParam0, 1)) };
	...
	{
		Var3 = { func_163(unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_171(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_163(Param1 - unk_0x6B62510F212526DC(iParam0, 1)) };
...
{
	if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), unk_0xCACAD935C0BEE14F(Local_389[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 6))
	{
		return 1;
	}
	return 0;
...
void func_174(int iParam0)
{
	...
	{
		if (((!bLocal_372 && !unk_0x4B7E6E16D3345FE8(Local_389[iParam0 /*22*/])) && !unk_0xE573ACA59D8C5C18(Local_389[iParam0 /*22*/])) && !unk_0xED41AAC94202B65C(Local_389[iParam0 /*22*/]))
		{
			func_175(iParam0);
		}
	}
...
void func_177(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_149(iParam0) || iParam2)
	{
		...
		{
			if (Local_389[func_150(iParam0) /*22*/].f_20 != 3 || (unk_0x320D1840B6DAA1CC() - iLocal_376) > 7500)
			{
		...
		{
			if (Local_389[func_150(iParam0) /*22*/].f_20 != 4 || (unk_0x320D1840B6DAA1CC() - iLocal_376) > 7500)
			{
				if (!bLocal_373)
				{
					if (iParam0 == 0)
		...
		else if (iParam1 == 5)
		{
			if (Local_389[func_150(iParam0) /*22*/].f_20 != 5)
			{
				if (iParam0 == 0)
				{
					...
					unk_0x49C085D876A9986D(Local_389[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", 0);
				}
				else if (iParam0 == 1)
				{
		...
		Local_389[iParam0 /*22*/].f_14 = unk_0x320D1840B6DAA1CC();
		Local_389[func_150(iParam0) /*22*/].f_14 = unk_0x320D1840B6DAA1CC();
...
void func_178(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	Var0 = { func_181() };
	if (unk_0xACC32B78196FBC2A(sParam1) || unk_0xACC32B78196FBC2A(&Var0))
	{
		func_121(&uLocal_483, cLocal_482, sParam1, 7, 0, 0);
		if (bParam2)
		{
			iLocal_376 = unk_0x320D1840B6DAA1CC();
		}
		return;
	}
	if ((!unk_0x3C57C2F07FEE34D2(&Var0, sParam1) && !func_66("PR_TAKBACK", 0, 0)) && !func_66("PR_GOVEH", 0, 0))
	{
		func_179();
		func_121(&uLocal_483, cLocal_482, sParam1, 7, 0, 0);
		if (bParam2)
...
void func_179()
{
	...
	{
		Var0 = { func_181() };
		if (unk_0x3C57C2F07FEE34D2(&Var0, "PRA_COPTLK1") || unk_0x3C57C2F07FEE34D2(&Var0, "PRA_COPTLK2"))
		{
			cLocal_666 = { func_181() };
			cLocal_672 = { func_180() };
		}
...
void func_182(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_149(iParam0) || iParam2)
	{
		if (iParam1 == 1)
		{
			if (Local_389[iParam0 /*22*/].f_19 != 1 || (unk_0x320D1840B6DAA1CC() - iLocal_376) > 7500)
			{
				if (!bLocal_372)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_389[iParam0 /*22*/].f_19 != 2 || (unk_0x320D1840B6DAA1CC() - iLocal_376) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPPLY1";
		...
		{
			if (Local_389[iParam0 /*22*/].f_19 != 4 || (unk_0x320D1840B6DAA1CC() - iLocal_376) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPST1";
		...
		else if (iParam1 == 5)
		{
			if (Local_389[iParam0 /*22*/].f_19 != 5)
			{
				...
				unk_0x49C085D876A9986D(Local_389[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", 0);
				func_183(iParam0, iParam1, 0);
			}
		}
		else if (iParam1 == 7)
		...
		if (bLocal_372)
		{
			if (!BitTest(Local_389[iParam0 /*22*/].f_15, 12))
			{
				unk_0xCED9E32812D6C7C7(&(Local_389[iParam0 /*22*/].f_15), 12);
			}
		}
	}
}
...
void func_184(int iParam0)
{
	...
	{
		fVar0 = unk_0x62DDE94612B5849E(unk_0x9E2D6C50374FCFA9());
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_382)
			{
				if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 340.0758f, -1598.255f, 28.29322f, 346.4939f, -1603.684f, 38.29278f, 6.22f, 0, 1, 0))
				{
					if (unk_0x0208598D19E7A49F(unk_0xE2D3D51028F0428A()) || unk_0x1755A0CD57C780C6(unk_0xE2D3D51028F0428A()))
					{
						iLocal_382 = 1;
						iLocal_381 = unk_0x320D1840B6DAA1CC();
						return;
					}
					else if (!BitTest(Local_389[iParam0 /*22*/].f_15, 11))
					{
						if ((((fVar0 > 16f && !Local_389[iParam0 /*22*/].f_16) && !BitTest(Local_389[iParam0 /*22*/].f_15, 10)) && !unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0)) && unk_0xD132EDDA78FF4A51(Local_389[iParam0 /*22*/], Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0))
						{
							func_186(iParam0, 11);
							return;
						}
				...
				if (((unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0) && unk_0xD132EDDA78FF4A51(Local_389[iParam0 /*22*/], Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0)) && !BitTest(Local_389[iParam0 /*22*/].f_15, 10)) && !BitTest(Local_389[iParam0 /*22*/].f_15, 11))
				{
					if ((fVar0 > 12f && !Local_389[iParam0 /*22*/].f_16) && !unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0))
					{
						func_186(iParam0, 11);
					}
				}
			}
			else if ((unk_0x320D1840B6DAA1CC() - iLocal_381) > 4000)
			{
				iLocal_382 = 0;
			}
		}
		else if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, 0, 1, 0) && unk_0xD132EDDA78FF4A51(Local_389[iParam0 /*22*/], Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, 0, 1, 0))
		{
...
void func_185(int iParam0, bool bParam1)
{
	...
	{
		unk_0xB0550BC91B0159D6(&(Local_389[iParam0 /*22*/].f_15), bParam1);
		Local_389[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_186(int iParam0, bool bParam1)
{
	if (!BitTest(Local_389[iParam0 /*22*/].f_15, bParam1))
	{
		unk_0xCED9E32812D6C7C7(&(Local_389[iParam0 /*22*/].f_15), bParam1);
		Local_389[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_187(int iParam0)
{
	...
	{
		bVar0 = false;
		if (((func_153(Local_389[iParam0 /*22*/], unk_0xE2D3D51028F0428A(), 5f, 1) && !unk_0x4B7E6E16D3345FE8(Local_389[iParam0 /*22*/])) && !unk_0xE573ACA59D8C5C18(Local_389[iParam0 /*22*/])) && !unk_0xED41AAC94202B65C(Local_389[iParam0 /*22*/]))
		{
	...
	else if (!func_153(Local_389[iParam0 /*22*/], unk_0xE2D3D51028F0428A(), 5.5f, 1))
	{
		func_185(iParam0, 5);
		func_185(iParam0, 3);
	}
...
int func_188(int iParam0)
{
	...
	if (Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), unk_0xCACAD935C0BEE14F(Local_389[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, 0, 1, 0))
		{
			return 1;
		}
	}
...
{
	if (unk_0x72F6AE51B7E34865(Local_389[iParam0 /*22*/], unk_0xE2D3D51028F0428A()))
	{
		if (unk_0x32DCDA1B2F8A0694(Local_389[iParam0 /*22*/]))
		{
			*iParam1 = 1;
		}
		else
...
void func_190(int iParam0)
{
	...
	if (Local_389[iParam0 /*22*/].f_20 != 6 && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		...
		while (iVar0 <= 5)
		{
			if (Local_389[iParam0 /*22*/].f_16)
			{
				if (!BitTest(Local_389[iParam0 /*22*/].f_15, 12))
				{
					if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_309[iVar0 /*7*/], Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, 1, 0))
					{
						iLocal_382 = 1;
						iLocal_381 = unk_0x320D1840B6DAA1CC();
						if (iVar0 == 4)
			...
			else if (!unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_309[iVar0 /*7*/], Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, 1, 0) || BitTest(Local_389[iParam0 /*22*/].f_15, 12))
			{
				func_191(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_309[3 /*7*/], Local_309[3 /*7*/].f_3, Local_309[3 /*7*/].f_6, 0, 1, 0))
	{
		func_193(iParam0, 3);
	}
	else
	...
	switch (iParam1)
	{
		...
		case 4:
			if (!unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
			{
				...
				if (func_7(iVar0))
				{
					if (func_192(unk_0x15CAA6D7B11F1A7C(iVar0)))
					{
						bLocal_373 = true;
					}
					else
					...
					if (!unk_0xD132EDDA78FF4A51(iVar0, Local_309[4 /*7*/], Local_309[4 /*7*/].f_3, Local_309[4 /*7*/].f_6, 0, 1, 0))
					{
						func_185(iParam0, 8);
						func_185(iParam0, 7);
					}
	...
	switch (iParam1)
	{
		...
		case 4:
			if (!BitTest(Local_389[iParam0 /*22*/].f_15, 8))
			{
				...
				{
					unk_0xCED9E32812D6C7C7(&(Local_389[iParam0 /*22*/].f_15), 9);
					func_186(iParam0, 8);
				}
				else
				{
					unk_0xB0550BC91B0159D6(&(Local_389[iParam0 /*22*/].f_15), 9);
					func_186(iParam0, 8);
				}
			}
			break;
...
{
	if (func_153(unk_0xE2D3D51028F0428A(), Local_389[iParam0 /*22*/], 30f, 1))
	{
		if (func_157(Local_389[iParam0 /*22*/], unk_0xE2D3D51028F0428A(), 140f, 1, 250, 7))
		{
...
void func_195(int iParam0)
{
	...
	if (unk_0x12DD4A0B247D9B4D(iParam0->f_1))
	{
		unk_0xFFD8EB5462B07B59(&(iParam0->f_1));
		bVar0 = true;
	}
	if (unk_0xE5965CDF24F93A9F(iParam0->f_7))
	{
		if (!unk_0x55B23FE400FCEA6B(iParam0->f_7, 0))
		{
			if (unk_0x227D9DCE160DDA9D(iParam0->f_7))
			{
				unk_0x0B69DCF6FE80E8EB(iParam0->f_7, 0);
			}
		}
		bVar0 = true;
	}
...
int func_196(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10, int iParam11)
{
	bool bVar0;
...
void func_197()
{
	...
	while (iVar0 <= 1)
	{
		...
		{
			if (unk_0xE5965CDF24F93A9F(Local_389[iVar0 /*22*/]))
			{
				if (func_7(unk_0x9993EF7FDBCDB632()))
				{
					if (unk_0x0747E45CFF1F74AA(Local_389[iVar0 /*22*/], unk_0x9993EF7FDBCDB632(), 1))
					{
						unk_0xE68645525D451A8B(Local_389[iVar0 /*22*/]);
						func_125();
					}
...
void func_198(int iParam0)
{
	...
	switch (Local_389[iParam0 /*22*/].f_19)
	{
		case 1:
			if (unk_0x320D1840B6DAA1CC() - Local_389[iParam0 /*22*/].f_14) > unk_0x5853B15F78E1A265(2500, 3000)
			{
				if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
				{
					func_127(iParam0);
					func_125();
					return;
				...
				{
					if ((BitTest(Local_389[iParam0 /*22*/].f_15, 13) && (unk_0x320D1840B6DAA1CC() - iLocal_376) > 2500) && !iLocal_661)
					{
						if (iParam0 == 0)
						{
							sVar0 = "PRA_COPST1";
						...
						func_121(&uLocal_483, cLocal_482, sVar0, 7, 0, 0);
						unk_0xB0550BC91B0159D6(&(Local_389[iParam0 /*22*/].f_15), 13);
						unk_0xB0550BC91B0159D6(&(Local_389[func_150(iParam0) /*22*/].f_15), 13);
						iLocal_661 = 1;
					}
					Local_389[iParam0 /*22*/].f_17 = 1;
				}
		...
		case 2:
			if (unk_0x320D1840B6DAA1CC() - Local_389[iParam0 /*22*/].f_14) > unk_0x5853B15F78E1A265(1500, 2000)
			{
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 5:
			if (unk_0x320D1840B6DAA1CC() - Local_389[iParam0 /*22*/].f_14) > unk_0x5853B15F78E1A265(2500, 3000)
			{
				if (!func_153(Local_389[iParam0 /*22*/], unk_0xE2D3D51028F0428A(), 1.5f, 1))
				{
					unk_0xB0550BC91B0159D6(&(Local_389[iParam0 /*22*/].f_15), 5);
				}
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 7:
			if (unk_0x320D1840B6DAA1CC() - Local_389[iParam0 /*22*/].f_14) > unk_0x5853B15F78E1A265(2500, 3000)
			{
				fVar1 = unk_0x62DDE94612B5849E(unk_0x9E2D6C50374FCFA9());
				...
				{
					unk_0xB0550BC91B0159D6(&(Local_389[iParam0 /*22*/].f_15), 11);
				}
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
...
void func_201(int iParam0)
{
	...
	if (!iLocal_661)
	{
		bVar0 = unk_0x6ABFD2A0B56D6940(unk_0xE2D3D51028F0428A());
		...
		else if (func_133(iParam0))
		{
			if (bVar0)
			{
				if (!func_153(unk_0xE2D3D51028F0428A(), Local_389[iParam0 /*22*/], 10f, 1))
				{
...
void func_202(int iParam0)
{
	...
	bVar0 = unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 4);
	if (Local_389[iParam0 /*22*/].f_20 != 6 && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (func_153(unk_0xE2D3D51028F0428A(), Local_389[iParam0 /*22*/], 12f, 1))
		{
			if (bVar0)
			{
				if (Local_389[iParam0 /*22*/].f_16)
...
void func_203(int iParam0)
{
	if (!func_173(iParam0))
	{
		...
		else if (func_154(Local_389[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || unk_0x89D0E0233F6E59A7(-1, unk_0x6B62510F212526DC(Local_389[iParam0 /*22*/], 1), 100f))
		{
			func_125();
		}
...
int func_204(int iParam0)
{
	...
	if (func_379(Local_389[iParam0 /*22*/]))
	{
		...
		if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), Local_389[iParam0 /*22*/], fVar0, fVar0, fVar0, 0, 1, 0))
		{
			if (unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), Local_389[iParam0 /*22*/]) || unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), Local_389[iParam0 /*22*/]))
			{
				if (Local_389[iParam0 /*22*/].f_16)
				{
					return 1;
...
void func_205()
{
	...
	{
		if ((((func_379(Local_389[0 /*22*/]) && func_379(Local_389[1 /*22*/])) && func_12(&uLocal_92, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1))) && func_63(Local_389[0 /*22*/], Local_389[0 /*22*/].f_1, 3f)) && func_63(Local_389[1 /*22*/], Local_389[1 /*22*/].f_1, 3f))
		{
		...
		else if ((func_379(Local_389[2 /*22*/]) && func_12(&uLocal_144, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1))) && func_63(Local_389[2 /*22*/], Local_389[2 /*22*/].f_1, 3f))
		{
...
bool func_206(int iParam0, var uParam1, char* sParam2, float fParam3, int iParam4)
{
	if (!*uParam1)
	{
		if (!func_103() && unk_0xE9E8955A780DDA01())
		{
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_71(iLocal_80, bLocal_28))
			{
				...
				unk_0x1CF3F44FC2EB9F99("FHPRA_START");
				if (unk_0xEC32121F2E3875C8(Global_41298[13 /*31*/]))
				{
					unk_0x99C46337F53EECAD(Global_41298[13 /*31*/], 1);
				}
				iLocal_678 = 0;
				unk_0x2DA9F9D8E5530E75(2f, 10f, 4);
				iLocal_81 = 1;
			}
			break;
		...
		case 1:
			if (unk_0xC378B7F0D175A5B0(unk_0x9E2D6C50374FCFA9()) < 3)
			{
				if (func_379(Local_389[2 /*22*/]))
				{
					...
					{
						if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 371.9393f, -1604.252f, 45.603f, 399.8371f, -1627.065f, 31.75287f, 32.73f, 0, 1, 2) || unk_0xE323E6755636A70E(unk_0xE2D3D51028F0428A()))
						{
			...
			if ((unk_0x1755A0CD57C780C6(unk_0xE2D3D51028F0428A()) && iLocal_678 == 0) && func_132(Local_456.f_0, unk_0xE2D3D51028F0428A(), 1) < 100f)
			{
				unk_0x2DA9F9D8E5530E75(7f, 7f, 4);
				iLocal_678 = 1;
			}
			if (func_7(Local_456.f_0))
			{
				...
				{
					unk_0x2DA9F9D8E5530E75(10f, 6f, 4);
					iLocal_81 = 2;
				}
				if (bLocal_374)
				{
...
void func_210()
{
	switch (iLocal_81)
	{
		case 0:
			...
			{
				func_363(78);
				unk_0xC0F70A3CDEC87ECE(1);
				unk_0x8576657A629C4B0A(0.5f);
				unk_0xF96094A43D443C41(369.0115f, -1609.116f, 28.2928f, 5f, 0);
				unk_0xF96094A43D443C41(Local_389[0 /*22*/].f_1, 5f, 0);
				if (func_275(unk_0xE2D3D51028F0428A(), 12, 4) || func_275(unk_0xE2D3D51028F0428A(), 12, 3))
				{
					bLocal_372 = true;
				}
				func_224();
...
{
	unk_0xCED9E32812D6C7C7(&Global_95835, bParam0);
}
...
void func_224()
{
	...
	if (unk_0xE5965CDF24F93A9F(iVar0))
	{
		if (unk_0x55A0C756C4A8220C(iVar0, 0))
		{
			func_225(iVar0, unk_0x6B62510F212526DC(iVar0, 1), unk_0x82FE2343F8BDFF0B(iVar0), 24, 0);
		}
	}
}
...
void func_225(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6)
{
	...
	if (unk_0xE5965CDF24F93A9F(iParam0) && unk_0x55A0C756C4A8220C(iParam0, 0))
	{
		...
		func_262(iParam5, &Var0, Param1, uParam4, func_268(iParam0));
...
void func_226(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_259(&(Global_76676.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (unk_0xE5965CDF24F93A9F(iParam1))
	{
		if (unk_0x55A0C756C4A8220C(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_112922.f_32749.f_4801 = func_248();
			}
...
void func_227(int iParam0, int iParam1)
{
	...
	func_269(iParam0, &(Global_112922.f_32749.f_5510));
}

int func_228(int iParam0)
{
	if ((((((((((!unk_0xE5965CDF24F93A9F(iParam0) || !unk_0x55A0C756C4A8220C(iParam0, 0)) || func_245(iParam0, 0, 0)) || func_245(iParam0, 1, 0)) || func_245(iParam0, 2, 0)) || func_268(iParam0) != 145) || func_244(iParam0)) || func_243(iParam0)) || func_242(iParam0)) || func_241(iParam0)) || !func_229(unk_0x15CAA6D7B11F1A7C(iParam0)))
	{
		if (func_243(iParam0))
		{
		}
...
int func_230(int iParam0, bool bParam1)
{
	...
	{
		if ((func_235() || unk_0x8FE9914D4872D601()) || func_234())
		{
		}
		else if (!func_237())
		{
...
int func_246(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
var func_248()
{
	...
	func_258(&uVar0, unk_0xAA2844CAD88768B5());
	func_257(&uVar0, unk_0x80F97D7D29800A1A());
	func_256(&uVar0, unk_0x09FC827691DACE59());
	func_251(&uVar0, unk_0xD52BD97E61483713());
	func_250(&uVar0, unk_0x771485043FDC55DE());
	func_249(&uVar0, unk_0x1137FD08B8D3F874());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_254(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
int func_259(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_11(Global_112922.f_32749.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_11(Global_112922.f_2363.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_11(Global_112922.f_2363.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_262(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6)
{
	if (func_259(&(Global_76676.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_267(iParam0);
			func_266(uParam1, &(Global_112922.f_32749.f_69[Global_76676.f_555[0 /*21*/].f_14 /*78*/]));
	...
	if (unk_0x55A0C756C4A8220C(iParam0, 0))
	{
		...
		*uParam1 = unk_0xC264F708491D88D7(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xCED9E32812D6C7C7(&(uParam1->f_77), func_270(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_275(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = unk_0x15CAA6D7B11F1A7C(iParam0);
	Global_77669[1 /*14*/] = { func_295(iVar0, iParam1, iParam2, -1) };
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_275(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_275(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_77669[2 /*14*/] = { func_295(iVar0, 14, iVar4, -1) };
									if (Global_77669[2 /*14*/].f_12 == iVar3)
									{
										if (func_275(iParam0, 14, iVar4))
										{
											if (!func_279(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_77669[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_77669[2 /*14*/] = { func_295(iVar0, iVar2, iVar1, -1) };
						if (!func_279(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_77669[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_77669[1 /*14*/].f_3 == unk_0x5355BAA621C153CF(iParam0, func_276(iParam1)) && Global_77669[1 /*14*/].f_4 == unk_0xF1050E548C37F4A5(iParam0, func_276(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_278(var uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x036D1EA7243F2CCC(iParam3, joaat("hat"), 1) || unk_0x036D1EA7243F2CCC(func_281(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x036D1EA7243F2CCC(iParam3, joaat("hat"), 0) || unk_0x036D1EA7243F2CCC(func_281(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x036D1EA7243F2CCC(iParam3, joaat("hat"), 1) || unk_0x036D1EA7243F2CCC(func_281(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x036D1EA7243F2CCC(iParam3, joaat("hat"), 0) || unk_0x036D1EA7243F2CCC(func_281(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_281(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = unk_0xA188D1127A77C942(iParam3, 10, -1, 0, -1, func_276(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
struct<10> func_287(int iParam0, int iParam1)
{
	int iVar0;
	struct<10> Var1;
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			{
				case 31:
					func_290(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 0:
					func_290(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_290(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_290(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 3:
					func_290(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_290(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_290(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_290(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_290(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_290(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 9:
					func_290(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 1:
					func_290(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_290(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 4:
					func_290(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_290(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_290(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_290(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_290(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 0:
					func_290(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_290(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 3:
					func_290(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_290(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_290(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_290(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_290(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_290(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				...
				case 0:
					func_290(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_290(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_290(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 3:
					func_290(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_290(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_290(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_290(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_290(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_290(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 9:
					func_290(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 10:
					func_290(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 12:
					func_290(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 13:
					func_290(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 14:
					func_290(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 15:
					func_290(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 16:
					func_290(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 17:
					func_290(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 18:
					func_290(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 19:
					func_290(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 20:
					func_290(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 21:
					func_290(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8);
					break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				...
				case 0:
					func_290(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_290(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_290(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 3:
					func_290(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_290(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_290(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_290(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_290(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 9:
					func_290(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 10:
					func_290(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 11:
					func_290(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 12:
					func_290(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 13:
					func_290(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8);
					break;
				
				case 14:
					func_290(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 16:
					func_290(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 17:
					func_290(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 18:
					func_290(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 19:
					func_290(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 20:
					func_290(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 21:
					func_290(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 22:
					func_290(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 23:
					func_290(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8);
					break;
...
int func_289(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam2 == 14)
	{
		...
		if (iVar0 != -1)
		{
			return (func_283(iParam0) + iVar0);
		}
	}
	else
	{
		unk_0xA188D1127A77C942(iParam3, 10, -1, 0, -1, func_276(iParam2));
		iVar1 = unk_0x8F3F503BADA161ED(iParam1);
		if (iVar1 != -1)
		{
			return (func_282(iParam0, func_276(iParam2)) + iVar1);
		}
	}
	return -99;
}

void func_290(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_291(int iParam0, int iParam1)
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				case 0:
					...
					{
						func_294(&Var1, -99, -99, 1, 1, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					}
					else
					{
						func_294(&Var1, -99, -99, 0, 0, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					}
					break;
				
				case 1:
					func_294(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0);
					break;
				
				case 2:
					func_294(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8);
					break;
				
				case 3:
					func_294(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31);
					break;
				
				case 4:
					func_294(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2);
					break;
				
				case 5:
					func_294(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[0], Global_112922.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				
				case 6:
					func_294(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 7:
					func_294(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 8:
					func_294(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 9:
					func_294(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 10:
					func_294(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4);
					break;
				
				case 11:
					func_294(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5);
					break;
				
				case 12:
					func_294(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31);
					break;
				
				case 13:
					func_294(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 14:
					func_294(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6);
					break;
				
				case 15:
					func_294(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31);
					break;
				
				case 16:
					func_294(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31);
					break;
				
				case 17:
					func_294(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 18:
					func_294(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7);
					break;
				
				case 19:
					func_294(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 20:
					func_294(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 21:
					func_294(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 22:
					func_294(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 23:
					func_294(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 24:
					func_294(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31);
					break;
				
				case 25:
					func_294(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 26:
					func_294(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 27:
					func_294(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 28:
					func_294(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				
				case 29:
					func_294(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 30:
					func_294(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 31:
					func_294(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31);
					break;
				
				case 32:
					func_294(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 33:
					func_294(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 34:
					func_294(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31);
					break;
				
				case 35:
					func_294(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 36:
					func_294(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 37:
					func_294(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 38:
					func_294(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 39:
					func_294(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 40:
					func_294(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 41:
					func_294(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 42:
					func_294(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 43:
					func_294(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 44:
					func_294(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 45:
					func_294(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 46:
					func_294(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 47:
					func_294(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 48:
					func_294(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 49:
					func_294(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 50:
					func_294(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9);
					break;
				
				case 51:
					func_294(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 52:
					func_294(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				default:
					func_292(&Var1, iParam0, iParam1, 53);
					break;
			}
			break;
		...
		case joaat("player_one"):
			...
			{
				case 0:
					func_294(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 1:
					func_294(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
				
				case 2:
					func_294(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[1], Global_112922.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				
				case 3:
					func_294(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1);
					break;
				
				case 4:
					func_294(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2);
					break;
				
				case 5:
					func_294(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 6:
					func_294(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 7:
					func_294(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3);
					break;
				
				case 8:
					func_294(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5);
					break;
				
				case 9:
					func_294(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 10:
					func_294(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 11:
					func_294(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
				
				case 12:
					func_294(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 13:
					func_294(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 14:
					func_294(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 15:
					func_294(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 16:
					func_294(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 17:
					func_294(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 18:
					func_294(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31);
					break;
				
				case 19:
					func_294(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 20:
					func_294(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 21:
					func_294(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4);
					break;
				
				case 22:
					func_294(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31);
					break;
				
				case 23:
					func_294(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31);
					break;
				
				case 24:
					func_294(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31);
					break;
				
				case 25:
					func_294(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31);
					break;
				
				case 26:
					func_294(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31);
					break;
				
				case 27:
					func_294(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31);
					break;
				
				case 28:
					func_294(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31);
					break;
				
				case 29:
					func_294(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31);
					break;
				
				case 30:
					func_294(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31);
					break;
				
				case 31:
					func_294(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31);
					break;
				
				case 32:
					func_294(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31);
					break;
				
				case 33:
					func_294(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31);
					break;
				
				case 34:
					func_294(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31);
					break;
				
				case 35:
					func_294(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31);
					break;
				
				case 36:
					func_294(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31);
					break;
				
				case 37:
					func_294(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31);
					break;
				
				case 38:
					func_294(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 39:
					func_294(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 40:
					func_294(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 41:
					func_294(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 42:
					func_294(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 43:
					func_294(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6);
					break;
				
				case 44:
					func_294(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
				
				case 45:
					func_294(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8);
					break;
				
				case 46:
					func_294(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31);
					break;
				
				default:
					func_292(&Var1, iParam0, iParam1, 47);
					break;
			}
			break;
		...
		case joaat("player_two"):
			...
			{
				case 0:
					func_294(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 1:
					func_294(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8);
					break;
				
				case 2:
					func_294(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1);
					break;
				
				case 3:
					func_294(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2);
					break;
				
				case 4:
					func_294(&Var1, -99, -99, Global_112922.f_2363.f_539.f_196[2], Global_112922.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 5:
					func_294(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6);
					break;
				
				case 6:
					func_294(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3);
					break;
				
				case 7:
					func_294(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4);
					break;
				
				case 8:
					func_294(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31);
					break;
				
				case 9:
					func_294(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 10:
					func_294(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 11:
					func_294(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5);
					break;
				
				case 12:
					func_294(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				
				case 13:
					func_294(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 14:
					func_294(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31);
					break;
				
				case 15:
					func_294(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 16:
					func_294(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 17:
					func_294(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 18:
					func_294(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 19:
					func_294(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 20:
					func_294(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 21:
					func_294(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 22:
					func_294(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 23:
					func_294(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 24:
					func_294(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 25:
					func_294(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 26:
					func_294(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 27:
					func_294(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 28:
					func_294(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 29:
					func_294(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 30:
					func_294(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 31:
					func_294(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 32:
					func_294(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 33:
					func_294(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 34:
					func_294(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 35:
					func_294(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 36:
					func_294(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 37:
					func_294(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 38:
					func_294(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 39:
					func_294(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 40:
					func_294(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 41:
					func_294(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 42:
					func_294(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 43:
					func_294(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 44:
					func_294(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 45:
					func_294(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
				
				case 46:
					func_294(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 47:
					func_294(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				default:
					func_292(&Var1, iParam0, iParam1, 48);
					break;
			}
			break;
		...
		case joaat("mp_m_freemode_01"):
			...
			{
				case 0:
					func_294(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31);
					break;
				
				case 1:
					func_294(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0);
					break;
				
				case 2:
					func_294(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1);
					break;
				
				case 3:
					func_294(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2);
					break;
				
				case 4:
					func_294(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3);
					break;
				
				case 5:
					func_294(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4);
					break;
				
				case 6:
					func_294(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5);
					break;
				
				case 7:
					func_294(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6);
					break;
				
				case 8:
					func_294(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7);
					break;
				
				case 9:
					func_294(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8);
					break;
				
				case 10:
					func_294(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9);
					break;
				
				case 11:
					func_294(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10);
					break;
				
				case 12:
					func_294(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11);
					break;
				
				case 13:
					func_294(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12);
					break;
				
				case 14:
					func_294(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13);
					break;
				
				case 15:
					func_294(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14);
					break;
				
				case 16:
					func_294(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15);
					break;
				
				case 17:
					func_294(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16);
					break;
				
				case 18:
					func_294(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17);
					break;
				
				case 19:
					func_294(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18);
					break;
				
				case 20:
					func_294(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19);
					break;
				
				case 21:
					func_294(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20);
					break;
				
				case 22:
					func_294(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21);
					break;
				
				case 23:
					func_294(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22);
					break;
				
				case 24:
					func_294(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23);
					break;
				
				case 25:
					func_294(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24);
					break;
				
				default:
					func_292(&Var1, iParam0, iParam1, 26);
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			...
			{
				case 0:
					func_294(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31);
					break;
				
				case 1:
					func_294(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31);
					break;
				
				case 2:
					func_294(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0);
					break;
				
				case 3:
					func_294(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1);
					break;
				
				case 4:
					func_294(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2);
					break;
				
				case 5:
					func_294(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3);
					break;
				
				case 6:
					func_294(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4);
					break;
				
				case 7:
					func_294(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5);
					break;
				
				case 8:
					func_294(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6);
					break;
				
				case 9:
					func_294(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7);
					break;
				
				case 10:
					func_294(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8);
					break;
				
				case 11:
					func_294(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9);
					break;
				
				case 12:
					func_294(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10);
					break;
				
				case 13:
					func_294(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31);
					break;
				
				case 14:
					func_294(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11);
					break;
				
				case 15:
					func_294(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12);
					break;
				
				case 16:
					func_294(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13);
					break;
				
				case 17:
					func_294(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14);
					break;
				
				case 18:
					func_294(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15);
					break;
				
				case 19:
					func_294(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16);
					break;
				
				case 20:
					func_294(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17);
					break;
				
				case 21:
					func_294(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31);
					break;
				
				case 22:
					func_294(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18);
					break;
				
				case 23:
					func_294(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19);
					break;
				
				case 24:
					func_294(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20);
					break;
				
				case 25:
					func_294(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21);
					break;
				
				case 26:
					func_294(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22);
					break;
				
				case 27:
					func_294(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23);
					break;
				
				default:
					func_292(&Var1, iParam0, iParam1, 28);
					break;
			}
			break;
	}
		...
		while (iVar36 < Var1.f_4)
		{
			if (unk_0xA5404CDF63BADF48(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_293(Var16.f_2)] = Var16.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_293(Var16.f_2)] = func_289(iParam1, Var16.f_0, func_293(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*uParam0)[func_293(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar36++;
		}
...
void func_294(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_295(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_362();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_297(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_308(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_298(&(Global_77669[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_298(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_305(Global_2883588, 1, 1, 1, -1))
			{
				unk_0xB0550BC91B0159D6(&(uParam0->f_6), 2);
			}
			if (!func_305(Global_2883588, 2, 1, 1, -1))
			{
	...
	else if (uParam0->f_5 >= 0 && uParam0->f_5 < 3)
	{
		unk_0xCED9E32812D6C7C7(&(uParam0->f_6), false);
		unk_0xCED9E32812D6C7C7(&(uParam0->f_6), 5);
		if (func_304(iParam1, uParam0->f_5, uParam0->f_2, 0, uParam0->f_1, 0, 0))
		{
			unk_0xCED9E32812D6C7C7(&(uParam0->f_6), true);
		}
		if (func_304(iParam1, uParam0->f_5, uParam0->f_2, 1, uParam0->f_1, 0, 0))
		{
			unk_0xCED9E32812D6C7C7(&(uParam0->f_6), 2);
		}
		if (!func_304(iParam1, uParam0->f_5, uParam0->f_2, 2, uParam0->f_1, 0, 0))
		{
			unk_0xCED9E32812D6C7C7(&(uParam0->f_6), 4);
		}
	}
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_301(func_303(iParam1, uParam0->f_2), Global_77666, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				unk_0xCED9E32812D6C7C7(&(uParam0->f_6), true);
			}
			uVar0 = func_301(func_300(iParam1, uParam0->f_2), Global_77666, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				unk_0xCED9E32812D6C7C7(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_301(iVar1, Global_77666, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					unk_0xCED9E32812D6C7C7(&(uParam0->f_6), 4);
				}
...
int func_301(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12581)
	{
		...
		uVar0 = Global_2822371[iParam0 /*3*/][func_302(iParam1)];
...
int func_304(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_305(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (func_306(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
		uVar3 = func_301(iVar2, iVar0, 0);
...
void func_308(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_298(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_298(&(Global_77669[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_298(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, unk_0x036D1EA7243F2CCC(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77839)
		{
			...
			func_298(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, unk_0x036D1EA7243F2CCC(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = unk_0xA188D1127A77C942(iVar1, 10, -1, 0, -1, func_276(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_365()
{
	if (unk_0x97D65C0968CFE3AF(385.8528f, -1629.945f, 35.29278f, 398.8063f, -1640.865f, 28f))
	{
		unk_0x7E15597AA5F53F9A(iLocal_369, 0, 1, 1);
	}
	else
	{
		unk_0x7E15597AA5F53F9A(iLocal_369, 1, 1, 1);
	}
}
...
void func_366()
{
	if (bLocal_374)
	{
		if (unk_0x97D65C0968CFE3AF(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, 1, 0))
		{
			if (func_12(&uLocal_196, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)))
			{
				func_368(Global_41298[13 /*31*/], &fLocal_370);
				return;
			}
		}
		else
		{
			func_367(Global_41298[13 /*31*/], &fLocal_370);
		}
	}
	else if (unk_0x79135882170E3D22(unk_0xE2D3D51028F0428A()) || iLocal_82 == 1)
	{
		if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, 1, 0) || unk_0x97D65C0968CFE3AF(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
		{
			func_368(Global_41298[13 /*31*/], &fLocal_370);
		}
		else
	...
	else if (!unk_0x97D65C0968CFE3AF(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
	{
		func_367(Global_41298[13 /*31*/], &fLocal_370);
	}
	else
...
void func_367(int iParam0, float fParam1)
{
	if (unk_0xEC32121F2E3875C8(iParam0))
	{
		if (*fParam1 != 0f)
		{
			if (!unk_0x046B574E2CF3F2CC(uLocal_371))
			{
				uLocal_371 = unk_0x7AFC31F33CB9B8D5(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), 0, 7);
			}
			unk_0x1B3E1454BD86FCE6(iParam0, *fParam1, 1, 1);
			*fParam1 = (*fParam1 - (0.2f * unk_0x0000000050597EE2()));
			if (*fParam1 <= 0f)
			{
				unk_0x7E15597AA5F53F9A(iParam0, 1, 1, 0);
				unk_0xB251DDFA99084C56(uLocal_371);
				*fParam1 = 0f;
			}
		}
	}
...
void func_368(int iParam0, float fParam1)
{
	if (*fParam1 != 1f)
	{
		unk_0x1B3E1454BD86FCE6(uParam0, *fParam1, 1, 1);
		*fParam1 = (*fParam1 + (0.2f * unk_0x0000000050597EE2()));
		if (unk_0x046B574E2CF3F2CC(uLocal_371))
		{
			unk_0xB251DDFA99084C56(uLocal_371);
...
void func_373()
{
	...
	{
		if (!func_63(unk_0xE2D3D51028F0428A(), 372.0053f, -1604.076f, 36.7536f, 100f) && !bLocal_387)
		{
			func_375("PR_AREAWARN", &bLocal_387);
		}
		else if (!func_63(unk_0xE2D3D51028F0428A(), 372.0053f, -1604.076f, 36.7536f, 170f) && bLocal_387)
		{
			func_374(3);
		}
	}
...
void func_375(char* sParam0, bool bParam1)
{
	if (!*bParam1)
	{
		func_59(sParam0, 7500, 0);
...
void func_376()
{
	...
	else
	{
		...
		if (iLocal_80 == 2 || iLocal_80 == 3)
		{
			if (!func_153(unk_0xE2D3D51028F0428A(), Local_456.f_0, 50f, 1) && !bLocal_388)
			{
				func_375("PR_VANWARN", &bLocal_388);
			}
			else if (!func_153(unk_0xE2D3D51028F0428A(), Local_456.f_0, 100f, 1) && bLocal_388)
			{
				func_374(4);
			}
		}
...
void func_377()
{
	if (unk_0x66AA8BC9CA1BE26C(Local_456.f_0))
	{
		if (iLocal_368)
		{
			if ((unk_0x320D1840B6DAA1CC() - iLocal_367) > 5000)
			{
				func_374(2);
				return;
			}
		...
		{
			iLocal_367 = unk_0x320D1840B6DAA1CC();
			iLocal_368 = 1;
		}
	}
	else
...
void func_380(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_381())
	{
...
void func_384()
{
	Local_309[1 /*7*/] = { func_385(359.5238f, -1581.445f, 28.29278f, 341.1343f, -1603.052f, 40.37049f, 7.3f) };
	Local_309[2 /*7*/] = { func_385(352.2312f, -1590.471f, 28.29277f, 341.1343f, -1603.052f, 40.37049f, 6.78f) };
	Local_309[0 /*7*/] = { func_385(344.5851f, -1601.562f, 28.29278f, 342.4275f, -1604.071f, 40.29278f, 3.79f) };
	Local_309[3 /*7*/] = { func_385(345.0102f, -1604.096f, 40.6735f, 361.0914f, -1617.46f, 28.29278f, 3.33f) };
	Local_309[4 /*7*/] = { func_385(362.7986f, -1577.081f, 28.29278f, 341.1343f, -1603.052f, 40.37049f, 6.78f) };
	Local_309[5 /*7*/] = { func_385(365.9773f, -1611.556f, 28.29277f, 373.1279f, -1617.806f, 40.37049f, 19.19f) };
}

struct<7> func_385(struct<3> Param0, struct<3> Param3, float fParam6)
{
	struct<7> Var0;
...
void func_387()
{
	...
	if (!unk_0xEC32121F2E3875C8(iLocal_369))
	{
		unk_0x5DD86AC785D8E188(iLocal_369, joaat("prop_fnclink_03gate5"), 391.8602f, -1636.07f, 29.9744f, 1, 1, 0);
	}
	unk_0x7E15597AA5F53F9A(Global_41298[13 /*31*/], 1, 1, 0);
	unk_0x7E15597AA5F53F9A(iLocal_369, 1, 1, 0);
}
...
void func_388()
{
	...
	func_392(&uLocal_196, &Var0, 4);
	func_391(&uLocal_248);
	func_390(&uLocal_248, 408.8245f, -1616.011f, 31.7537f);
	func_390(&uLocal_248, 376.3118f, -1588.036f, 36.7534f);
	func_390(&uLocal_248, 354.1272f, -1614.819f, 31.5335f);
	func_390(&uLocal_248, 387.2971f, -1641.943f, 31.833f);
	func_389(&uLocal_248);
}
...
void func_392(var uParam0, var uParam1, int iParam2)
{
	int iVar0;
	...
	{
		func_390(uParam0, *(uParam1[iVar0 /*3*/]));
		iVar0++;
	}
	func_389(uParam0);
}
...
void func_393()
{
	...
	Local_389[0 /*22*/] = { func_394(353.1191f, -1589.606f, 28.2928f, 270.0968f, iVar0) };
	Local_389[1 /*22*/] = { func_394(354.557f, -1590.549f, 28.2928f, 16.3702f, iVar0) };
	Local_389[2 /*22*/] = { func_394(369.8186f, -1611.029f, 28.3928f, 9.0837f, iVar0) };
	iVar1 = 0;
	while (iVar1 <= 2)
	{
		...
		while (bVar2 <= (15 - 1))
		{
			unk_0xB0550BC91B0159D6(&(Local_389[iVar1 /*22*/].f_15), bVar2);
			bVar2++;
		}
		iVar1++;
	}
...
struct<22> func_394(struct<3> Param0, float fParam3, int iParam4)
{
	struct<22> Var0;
...
void func_395()
{
	Local_456 = { func_396(372.9868f, -1623.531f, 28.2928f, 321.7075f, joaat("policet")) };
	Local_462[0 /*6*/] = { func_396(400.5771f, -1618.927f, 28.2928f, 48.8115f, joaat("police3")) };
	Local_462[1 /*6*/] = { func_396(396.6843f, -1623.222f, 28.2928f, 231.3392f, joaat("police3")) };
	Local_462[2 /*6*/] = { func_396(394.3527f, -1625.337f, 28.2928f, 49.3732f, joaat("police3")) };
}

struct<6> func_396(struct<3> Param0, float fParam3, int iParam4)
{
	struct<6> Var0;
...
void func_397()
{
	unk_0xD642E010A287ADFD("COPS", &uLocal_481);
}

void func_398()
{
	unk_0x8813F60F6F44C9E3(uLocal_481);
	func_409(1);
	if (unk_0xEC32121F2E3875C8(Global_41298[13 /*31*/]))
	{
		unk_0x99C46337F53EECAD(Global_41298[13 /*31*/], 0);
	}
	unk_0x1B3E1454BD86FCE6(Global_41298[13 /*31*/], 0f, 1, 1);
	unk_0x7E15597AA5F53F9A(Global_41298[13 /*31*/], 4, 1, 1);
	unk_0x7E15597AA5F53F9A(iLocal_369, 0, 1, 0);
	unk_0xA5BD780899E2D5F0(iLocal_369, 0);
	unk_0x7BACBB4C6A7B18B7(uLocal_360, 0);
	func_55();
	unk_0xC0F70A3CDEC87ECE(5);
	unk_0x8576657A629C4B0A(1f);
	func_408();
...
void func_399(bool bParam0)
{
	...
	if (bParam0)
	{
		if (unk_0xE5965CDF24F93A9F(Local_456.f_0))
		{
			if (unk_0xE5965CDF24F93A9F(unk_0xE2D3D51028F0428A()))
			{
				if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	...
	if (unk_0x876B1078E90C91CB(uLocal_359))
	{
		unk_0x850D4EF3D40FB068(0, 0, 3000, 1, 0, 0);
		unk_0x588DDCB644C6486A(uLocal_359, 0);
	}
}
...
void func_405()
{
	...
	unk_0xF1A23B343DFEDFD0(Local_456.f_5);
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		unk_0xF1A23B343DFEDFD0(Local_462[iVar0 /*6*/].f_5);
		iVar0++;
	}
}
