...
void __EntryFunction__()
{
	...
	func_395();
	func_381();
	uLocal_360 = unk_0xC08A186299DFDA0A(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, 0, 1, 1, 1);
	func_380(27, 0);
	if (func_379())
	{
	...
	while (true)
	{
		unk_0xAEF7C45DAFB8E9B0("M_STS", 0);
		if (func_377(unk_0x9B0761B4C3EB8BC7()))
		{
			func_370();
			func_367();
			func_362();
...
void func_1()
{
	switch (iLocal_81)
	{
		case 0:
			...
			func_33();
			if (!unk_0x7BCC91F3C1CF24E8(sLocal_353))
			{
				func_31(sLocal_353);
			}
			else
		...
		case 1:
			if (func_14())
			{
				...
				else if (func_12(&uLocal_196, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1)))
				{
					func_10(408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_8(471.5946f, -1412.737f, 28.1562f, 68.5531f);
				}
				unk_0x555EE41D7C7078E6(372.9868f, -1623.531f, 28.2928f, 100f, 1, 0, 0, 0);
				func_2();
				func_396();
			}
			break;
...
void func_2()
{
	...
	unk_0x54123F77C25DD02B(Local_456.f_0);
	func_5(&Local_456);
	func_4(&uLocal_358);
	iVar0 = 0;
	while (iVar0 <= 2)
...
void func_17(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_19(Global_111858.f_18529[iVar0], &Var2, &fVar5))
			{
...
void func_35()
{
	...
	switch (iLocal_81)
	{
		case 0:
			...
			{
				if (unk_0x1BDBFE8EFF10BC95("FHPRA_STOP"))
				{
					iLocal_385 = 0;
					iLocal_663 = 0;
					iLocal_81 = 1;
					unk_0x21723EF7B2FCC4CC("FHPRA_STOP");
				}
			}
			break;
		...
		case 1:
			...
			if (iLocal_91 == 2)
			{
				if (func_12(&uLocal_196, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1)))
				{
			...
			{
				unk_0xBE1CA603598C1441(5f, 6f, 4);
				func_55();
				func_50();
			}
			break;
		...
		case 3:
			...
			{
				if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_456.f_0, 0))
				{
					unk_0x13A4BD6CC31F7B8F(unk_0x9B0761B4C3EB8BC7(), Local_456.f_0, -1);
				}
				else
				{
	...
	if (iParam1 == 1)
	{
		if ((iLocal_37 != 0 && iLocal_37 != joaat("object")) && iLocal_37 != joaat("gadget_parachute"))
		{
			if (func_6(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				{
					unk_0x69C71C91F56D82B9(unk_0x9B0761B4C3EB8BC7(), iLocal_37, 0);
				}
			}
		}
	}
...
void func_39(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_44(unk_0x460153A63B9477BC())) && !func_41(unk_0x460153A63B9477BC(), 0)) && !func_40()) && !bParam4) && !bParam5)
			{
				unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), 0);
			}
		}
		else if (((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && !func_44(unk_0x460153A63B9477BC())) && !bParam4) && !bParam5)
		{
			unk_0x0312E5501F93E5AB(unk_0x9B0761B4C3EB8BC7(), 0);
		}
		Global_76831 = 0;
...
int func_58(int iParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	...
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Param1, fParam12, fParam12, 2f, 0, 1, 2))
			{
				unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Param1, fParam12, fParam12, 2f, 1, 1, 2);
				if (func_66(func_68(func_69()), 0, 0))
				{
					unk_0x213AAAF3AB16731C(func_68(func_69()));
				}
				*iParam7 = 1;
			...
			else
			{
				...
				{
					fVar0 = (fParam12 / 2f);
					if (func_63(unk_0x9B0761B4C3EB8BC7(), Param1, fVar0))
					{
						*iParam7 = 0;
	...
	else if (unk_0xC2169C00B643278B(iParam0, Param1, fParam12, fParam12, 2f, 0, 1, 2))
	{
		if (*iParam9 == -1)
		{
		...
		if (!*iParam10)
		{
			...
			*iParam9 = unk_0x578C4EF320340AF7();
			*iParam10 = 1;
			unk_0x5DC21979EC6C531F(iParam0, 2);
		}
		else if ((unk_0x578C4EF320340AF7() - *iParam9) > 3000)
		{
			return 1;
		}
	}
	else
	{
		...
		if (!*iParam8)
		{
			...
			{
				unk_0x213AAAF3AB16731C(func_61(func_69(), 0));
			}
...
int func_62(int iParam0, int iParam1)
{
	...
	if (unk_0x80FF6C016CDB0FAF(iVar0, 0))
	{
		if (unk_0x10D3F7E169A49C44(iVar0, -1, 0) == unk_0x9B0761B4C3EB8BC7())
		{
			...
			{
				unk_0xD4C86DEC93F19FB0(iVar0, iParam0, iParam1, 0);
				return 0;
			}
		}
		else
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_82(1, Local_361, 0))
			{
				...
				{
					uLocal_371 = unk_0x5700FF65A7E1B390(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), 0, 7);
					if (unk_0x43ED7EAE11FD94FF(Local_456.f_0) != 0)
					{
						iVar0 = unk_0x43ED7EAE11FD94FF(Local_456.f_0);
		...
		case 1:
			if (bParam1)
			{
				if (((func_82(2, Local_456.f_1, Local_456.f_4) && func_82(4, Local_361, 0)) && func_82(3, Local_361, 0)) && func_82(5, Local_361, 0))
				{
					func_74(unk_0x9B0761B4C3EB8BC7(), 408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_72();
					unk_0x773B9DEB93E81B2F(369.0115f, -1609.116f, 28.2928f, 5f, 0);
					unk_0x773B9DEB93E81B2F(Local_389[0 /*22*/].f_1, 5f, 0);
					func_77();
					func_75();
					bLocal_28 = false;
					func_36(1, 1, 1);
...
void func_72()
{
	...
	iLocal_662 = 1;
	func_380(27, 0);
	unk_0xDC5C33A98881772F(Global_40754[13 /*31*/], 4, 1, 0);
	iLocal_663 = 0;
}
...
void func_73()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar0 <= (15 - 1))
		{
			unk_0xD2459066EA58CE43(&(Local_389[iVar1 /*22*/].f_15), iVar0);
			iVar0++;
		}
...
void func_75()
{
	...
	func_76(&uLocal_483, iVar0, unk_0x9B0761B4C3EB8BC7(), sVar1, 0, 1);
...
void func_77()
{
	...
	while (iVar0 <= 2)
	{
		unk_0x4E65320BC9AD521C(Local_389[iVar0 /*22*/], false);
		if (!func_78(Local_389[iVar0 /*22*/], -1098463898))
		{
			switch (iVar0)
			{
				case 0:
				case 1:
					unk_0x3605DDBB702E6DDF(Local_389[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET", Local_389[iVar0 /*22*/].f_1, Local_389[iVar0 /*22*/].f_4, 0, 0, 1);
					break;
				
				case 2:
					unk_0x48E48D5929D45C6F(Local_389[iVar0 /*22*/], 1, 1);
					break;
				}
		}
		unk_0x92BD213E6A0E666B(Local_389[iVar0 /*22*/], joaat("weapon_pistol"), -1, 0, 0);
		unk_0xD3D9D7C84656DAE5(Local_389[iVar0 /*22*/], uLocal_481);
...
int func_80(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_6(uParam0))
	{
		...
		unk_0x3060C53EAE54BBE7(iVar0, uParam1);
...
int func_82(int iParam0, struct<3> Param1, float fParam4)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			unk_0xBAA4D421B8B8A744(sLocal_354, 0);
			unk_0xBAA4D421B8B8A744(cLocal_482, 6);
			if (unk_0xF5EE205091CE6DB2(0) && unk_0xF5EE205091CE6DB2(6))
			{
				return 1;
			}
			break;
		...
		case 2:
			if (func_7(Global_95452[0]))
			{
				...
				Local_456.f_0 = Global_95452[0];
				if (func_7(Local_456.f_0))
				{
					if (!unk_0xDF3A359D2643ED5A(Local_456.f_0))
					{
						unk_0x7C4F70F41134C357(Local_456.f_0);
					}
					unk_0x4C5D57B67B567ADC(Local_456.f_0, 2, 0);
					unk_0x4C5D57B67B567ADC(Local_456.f_0, 3, 0);
					func_89(Local_456.f_0, 0);
					unk_0x494ACC4552B7881B(Local_456.f_0, 1);
					unk_0x5DC21979EC6C531F(Local_456.f_0, 1);
					return 1;
				}
			}
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				...
				{
					if (!unk_0x7C4984752F886E92(Global_95452.f_9[iVar0], 1))
					{
						unk_0x4F3C4F457D44BB0F(Global_95452.f_9[iVar0], 1, 1);
						Local_389[iVar0 /*22*/] = Global_95452.f_9[iVar0];
						if (func_377(Local_389[iVar0 /*22*/]))
						{
							unk_0x38CCFC7E1952A745(Local_389[iVar0 /*22*/], 2);
							unk_0x44225B42FE388400(Local_389[iVar0 /*22*/], 1);
							func_87(iVar0);
							iVar1++;
						}
					}
				...
				else if (func_86(&(Local_389[iVar0 /*22*/]), Local_389[iVar0 /*22*/].f_5, Local_389[iVar0 /*22*/].f_1, Local_389[iVar0 /*22*/].f_4, 0, 0, 0, 1))
				{
					...
					unk_0x14EFF93E9B692DAD(Local_389[iVar0 /*22*/], &cVar2);
					iVar1++;
				}
				iVar0++;
			}
		...
		case 4:
			...
			while (iVar6 <= 3)
			{
				...
				{
					unk_0x4F3C4F457D44BB0F(Global_95452[iVar6], 1, 1);
		...
		case 5:
			if (func_83(&uLocal_358, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_456.f_0))
				{
					unk_0xF8A652CE310FFC53(uLocal_358, Local_456.f_0, 0, 0f, -1.85f, 0.05f, unk_0x090239DEAF625B17(Local_456.f_0, 2), 0, 0, 0, 0, 2, 1);
					if (unk_0x0A43129B43E05B32(Local_456.f_0, uLocal_358))
					{
						return 1;
					}
				}
...
void func_84(var uParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		{
			unk_0x74528AC0906CBABE(uParam0);
		}
	}
	else
	{
...
int func_86(var uParam0, var uParam1, struct<3> Param2, var uParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	if (!unk_0xAE06B9E39EBDE049(*uParam0))
	{
		...
		{
			*uParam0 = unk_0xB3116B49FE00E2F1(26, uParam1, Param2, uParam5, 1, 1);
			if (func_377(*uParam0))
			{
				if (bParam7)
				{
				...
				if (bParam8)
				{
					unk_0x4E65320BC9AD521C(*uParam0, bParam8);
				}
				if (!bParam9)
				{
					unk_0x0DC39BE87E4C5599(*uParam0, bParam9);
				}
				if (bParam6)
				{
					func_84(uParam1, 1);
...
void func_87(int iParam0)
{
	if (func_377(Local_389[iParam0 /*22*/]))
	{
		if (iParam0 == 0)
		{
			unk_0x45F588C0DD767737(Local_389[iParam0 /*22*/], 0, 0, 1, 0);
			unk_0x45F588C0DD767737(Local_389[iParam0 /*22*/], 3, 0, 0, 0);
			unk_0x45F588C0DD767737(Local_389[iParam0 /*22*/], 4, 0, 0, 0);
			unk_0x45F588C0DD767737(Local_389[iParam0 /*22*/], 8, 0, 0, 0);
			unk_0x45F588C0DD767737(Local_389[iParam0 /*22*/], 9, 1, 0, 0);
			unk_0x45F588C0DD767737(Local_389[iParam0 /*22*/], 10, 0, 0, 0);
		}
		else
		{
			unk_0x45F588C0DD767737(Local_389[iParam0 /*22*/], 0, 1, 1, 0);
			unk_0x45F588C0DD767737(Local_389[iParam0 /*22*/], 3, 0, 1, 0);
			unk_0x45F588C0DD767737(Local_389[iParam0 /*22*/], 4, 0, 0, 0);
			unk_0x45F588C0DD767737(Local_389[iParam0 /*22*/], 8, 1, 0, 0);
			unk_0x45F588C0DD767737(Local_389[iParam0 /*22*/], 9, 2, 0, 0);
			unk_0x45F588C0DD767737(Local_389[iParam0 /*22*/], 10, 0, 1, 0);
		}
	}
}
...
int func_88(int iParam0, var uParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	if (!unk_0xAE06B9E39EBDE049(*iParam0))
	{
		if (func_85(uParam1, "Loading", 0))
		{
			*iParam0 = unk_0xCE4780E24AFDFBF9(uParam1, Param2, uParam5, 1, 1, 0);
			if (unk_0xAE06B9E39EBDE049(*iParam0))
			{
	...
	else
	{
		if (func_7(*iParam0))
		{
			...
			unk_0xE922BAA80E8F9324(*iParam0, uParam5);
		}
		if (!unk_0x1758275D343D5BA3(*iParam0))
		{
			unk_0x4F3C4F457D44BB0F(*iParam0, 1, 0);
		...
		switch (*iParam2)
		{
			case 0:
				if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), *iParam0, 0))
				{
					...
					if (func_66(func_60(func_69()), 0, 0))
					{
						unk_0x213AAAF3AB16731C(func_60(func_69()));
					}
					if (*iParam0 == iParam8)
					{
						*iParam2 = 1;
				...
				else
				{
					...
					{
						unk_0x213AAAF3AB16731C(func_61(func_69(), bParam9));
					}
					if (func_69() != 33)
					{
						func_94(iParam0);
			...
			case 2:
			case 1:
				if ((!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), *iParam0, 0) && !func_97(*iParam0)) && !func_96(*iParam0))
				{
					func_34(iParam4);
					if (!unk_0xC2169C00B643278B(*iParam0, Param5, iParam10, iParam10, 2f, 0, 1, 2))
					{
				...
				if (func_7(iVar0))
				{
					...
					if (iVar1 == joaat("trash"))
					{
						...
						*uParam0 = iVar0;
						...
						if (!unk_0x1758275D343D5BA3(*uParam0))
						{
							unk_0x4F3C4F457D44BB0F(*uParam0, 1, 1);
						}
					}
					else if (iVar1 == joaat("towtruck"))
					{
						uVar2 = unk_0x5959D27CDB842BA7(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0));
						if (func_6(uVar2))
						{
							iVar0 = unk_0xEA90A5DC55A2F652(uVar2);
...
void func_94(var uParam0)
{
	...
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		if (iVar0 != *uParam0)
		{
			if (func_7(iVar0))
			{
				if (unk_0x36FE6D3220816ADA(iVar0) == func_95(func_69()))
				{
					func_93(uParam0);
					*uParam0 = iVar0;
					func_89(*uParam0, 1);
...
int func_96(int iParam0)
{
	...
	if ((func_377(unk_0x9B0761B4C3EB8BC7()) && unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0)) && func_7(iParam0))
	{
...
void func_98()
{
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_71(iLocal_80, bLocal_28))
			{
				if (unk_0x1BDBFE8EFF10BC95("FHPRA_VAN"))
				{
					if (unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) == 0)
					{
						if (iLocal_82 == 1 || iLocal_82 == 2)
						{
							...
							unk_0xBE1CA603598C1441(5f, 6f, 4);
							unk_0x21723EF7B2FCC4CC("FHPRA_VAN");
		...
		case 1:
			...
			if (iLocal_91 == 2)
			{
				...
				if (!iLocal_664)
				{
					unk_0x2D806C94B9A84B20("SCRIPTED_SCANNER_REPORT_BS_PREP_A_01", 0f);
					iLocal_664 = 1;
				}
			}
	...
	if ((iParam6 == 1 || iParam6 == 2) || iParam6 == 3)
	{
		if (iParam5 == 0)
		{
			...
			if (!bParam10)
			{
				if (func_7(iParam0))
				{
					if (unk_0xC2169C00B643278B(iParam0, Param1, fParam11, fParam11, 2f, 1, 1, 0))
					{
						return 1;
					}
				}
			}
			else if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Param1, fParam11, fParam11, 2f, 1, 1, 2))
			{
				return 1;
			}
			if (func_66(func_60(func_69()), 0, 0))
	...
	while (iVar0 < 3)
	{
		...
		if (!unk_0x5AEB5DDFFAD43CA5(iVar1))
		{
			switch (iLocal_87[iVar0])
			{
				...
				case 1:
					if (func_109(iVar0, iVar1) && unk_0x1D2A3118784C0272(iVar1, 1))
					{
						iLocal_87[iVar0] = 0;
						func_108(iVar1);
					}
				...
				case 2:
					if (func_107(iVar0, iVar1) && unk_0x1D2A3118784C0272(iVar1, 1))
					{
						iLocal_87[iVar0] = 0;
						func_108(iVar1);
					}
...
int func_107(int iParam0, int iParam1)
{
	...
	{
		case 0:
			unk_0x47107451B20C1093(iParam1, unk_0xA5D5B1042E8F47BD(iParam1, 0), Local_364, 4, 20f, 786469, 3.5f, 5f, 1);
			iLocal_83[iParam0] = 3;
			break;
		
		case 3:
			if (!func_111(iParam0, iParam1) || func_63(unk_0x9B0761B4C3EB8BC7(), Local_364, 2f))
			{
				iLocal_83[iParam0] = 4;
			}
			break;
...
int func_109(int iParam0, int iParam1)
{
	...
	{
		case 0:
			if (!unk_0x01C55C66D4B126EF(Local_300[iLocal_665 /*4*/], 1.5f, 0, 0, 1, 0, 0, iParam1, 0))
			{
				...
				unk_0x3C1B180EE30D36EF(iParam1, Local_300[iLocal_665 /*4*/], fVar0, 20000, 0.25f, 0, Local_300[iLocal_665 /*4*/].f_3);
				iLocal_83[iParam0] = 1;
			}
			break;
		...
		case 1:
			...
			{
				unk_0xF7E0A845F25F0FFE(iParam1, 0);
				iLocal_83[iParam0] = 2;
			}
			break;
...
int func_111(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if ((unk_0xAE06B9E39EBDE049(Local_456.f_0) && unk_0x80FF6C016CDB0FAF(Local_456.f_0, 0)) && !unk_0xC2169C00B643278B(Local_456.f_0, Local_364, 2f, 2f, 2f, 0, 1, 0))
		{
			if ((!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()) && unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), Local_456.f_0, 0)) && unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) == 0)
			{
				if (unk_0xE0B3BC41DDA88DF0(iParam1, Local_456.f_0, 0) && unk_0x10D3F7E169A49C44(Local_456.f_0, -1, 0) == iParam1)
				{
					iLocal_87[iParam0] = 2;
					return 1;
				}
...
int func_113(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if (unk_0x1037B9D45CE6B788(iParam1, 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.63f, 0, 1, 0) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.38f, 0, 1, 0))
		{
			iLocal_665 = 0;
			iLocal_87[iParam0] = 1;
			return 1;
		}
		else if (unk_0x1037B9D45CE6B788(iParam1, 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.63f, 0, 1, 0) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.38f, 0, 1, 0))
		{
			iLocal_665 = 1;
			iLocal_87[iParam0] = 1;
			return 1;
...
void func_118()
{
	...
	if (!bLocal_28)
	{
		...
		{
			unk_0xACBA79A91C121E78(unk_0x460153A63B9477BC(), 38);
			unk_0xACBA79A91C121E78(unk_0x460153A63B9477BC(), 30);
			bLocal_374 = false;
		}
		if (iLocal_80 == 2)
		{
			if (!iLocal_386)
			{
				if (!func_63(unk_0x9B0761B4C3EB8BC7(), Local_456.f_1, 180f))
				{
					iVar0 = 0;
					while (iVar0 <= 2)
					{
...
void func_119()
{
	...
	{
		func_196(Local_389[iVar0 /*22*/], &(Local_389[iVar0 /*22*/].f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
	}
	else
	{
	...
	{
		if (unk_0xAE06B9E39EBDE049(Local_389[iVar0 /*22*/]) && !unk_0x5AEB5DDFFAD43CA5(Local_389[iVar0 /*22*/]))
		{
			if (unk_0xCDF860E56BBCC6B4(Local_389[iVar0 /*22*/], unk_0x9B0761B4C3EB8BC7(), 1))
			{
				unk_0xBB7976F6FB9C9DD2(Local_389[iVar0 /*22*/]);
				if (((unk_0xEBFC112B3EEB18E5(unk_0x9B0761B4C3EB8BC7()) || unk_0xD2E9CCDC3186A6E0(Local_389[iVar0 /*22*/])) || unk_0x9F2D0A782C34E6FD(Local_389[iVar0 /*22*/])) || unk_0x4DBFB8024CDFF1D7(Local_389[iVar0 /*22*/]))
				{
					if (!bLocal_374)
					{
						unk_0xACBA79A91C121E78(unk_0x460153A63B9477BC(), 41);
						unk_0xACBA79A91C121E78(unk_0x460153A63B9477BC(), 33);
...
void func_120(int iParam0)
{
	...
	switch (Local_389[iParam0 /*22*/].f_20)
	{
		case 1:
			...
			{
				if (unk_0x578C4EF320340AF7() - Local_389[iParam0 /*22*/].f_14) > unk_0x344C570D6F8700DF(1000, 1500)
				{
					if (!func_78(Local_389[iParam0 /*22*/], -875674219))
					{
						unk_0x1210730BDCD39CB4(Local_389[iParam0 /*22*/]);
						unk_0xD08E9EAF091A1AAB(Local_389[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7(), 0);
					}
					Local_389[iParam0 /*22*/].f_14 = unk_0x578C4EF320340AF7();
				}
			}
			else
			{
		...
		case 2:
			if (unk_0x578C4EF320340AF7() - Local_389[iParam0 /*22*/].f_14) > unk_0x344C570D6F8700DF(5000, 6000)
			{
				if (unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 2))
				{
					func_127(iParam0);
					func_125();
					return;
		...
		case 3:
			if (unk_0x578C4EF320340AF7() - Local_389[iParam0 /*22*/].f_14) > unk_0x344C570D6F8700DF(2500, 3000)
			{
				if (unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 8))
				{
					Local_389[iParam0 /*22*/].f_17 = 1;
				}
				else
		...
		case 4:
			if (unk_0x578C4EF320340AF7() - Local_389[iParam0 /*22*/].f_14) > unk_0x344C570D6F8700DF(2500, 3000)
			{
				if (unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 8))
				{
					...
					else if (unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 9) && !bLocal_372)
					{
						func_127(iParam0);
						func_125();
						return;
		...
		case 6:
			...
			if ((unk_0x578C4EF320340AF7() - Local_389[iParam0 /*22*/].f_14) > iVar0)
			{
				if (!unk_0x02275D26F97B0510(Local_389[iParam0 /*22*/], 0) && !unk_0x4FCA2ADE072802D1(Local_389[iParam0 /*22*/]))
				{
					Local_389[iParam0 /*22*/].f_14 = unk_0x578C4EF320340AF7();
					func_127(iParam0);
				}
		...
		case 5:
			if (unk_0x578C4EF320340AF7() - Local_389[iParam0 /*22*/].f_14) > unk_0x344C570D6F8700DF(1000, 3000)
			{
				func_125();
				return;
			}
		...
		case 7:
			if ((unk_0x578C4EF320340AF7() - Local_389[iParam0 /*22*/].f_14) > 350)
			{
				if (!bLocal_374 && func_124(iParam0, 15))
				{
					func_73();
					func_134(iParam0);
					unk_0xB3F9B90AEF90F111(Local_389[iParam0 /*22*/]);
					return;
				}
				else
				{
					if (iLocal_660 != -1)
					{
						if ((unk_0x578C4EF320340AF7() - iLocal_660) > 12000)
						{
							func_123(-1);
						}
						else if ((unk_0x7922FF28ED63354A(unk_0x9B0761B4C3EB8BC7()) || unk_0xDB9E558E914A4D5C(unk_0x9B0761B4C3EB8BC7())) || unk_0x42A04E707DE50816(unk_0x9B0761B4C3EB8BC7()))
						{
							func_123(2);
						}
						else if (unk_0x6FC5840B397E185A(unk_0x460153A63B9477BC(), &iVar1))
						{
					...
					if ((func_78(Local_389[iParam0 /*22*/], -2128726980) || func_78(Local_389[iParam0 /*22*/], -982327190)) && unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) < 2)
					{
						if (!func_78(Local_389[iParam0 /*22*/], 1392476864))
						{
							unk_0xA79461EDE020EDEB(Local_389[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7());
						}
					}
				}
			}
			if (!iLocal_658)
			{
				if (unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 1) && unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 14))
				{
					if (iParam0 == 0)
					{
						sVar3 = "PRA_COPSHT1";
...
void func_123(int iParam0)
{
	...
	{
		unk_0x4E65320BC9AD521C(Local_389[0 /*22*/], false);
	}
	if (func_377(Local_389[1 /*22*/]))
	{
		unk_0x4E65320BC9AD521C(Local_389[1 /*22*/], false);
	}
	if (func_377(Local_389[2 /*22*/]))
	{
		unk_0x4E65320BC9AD521C(Local_389[2 /*22*/], false);
	}
	if (iParam0 != -1)
	{
		unk_0xCAD5C18968E57C30(unk_0x460153A63B9477BC(), iParam0, 0);
		unk_0x4B86C627B5EABFBF(unk_0x460153A63B9477BC(), 0);
	}
}
...
int func_124(int iParam0, int iParam1)
{
	...
	while (iVar0 <= 14)
	{
		if (iVar0 != iParam1)
		{
			if (unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, iVar0))
			{
				return 0;
			}
		}
...
void func_125()
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			func_195(&(Local_389[iVar0 /*22*/].f_6));
			Local_389[iVar0 /*22*/].f_14 = unk_0x578C4EF320340AF7();
...
void func_126()
{
	if (!iLocal_375)
	{
		iLocal_660 = unk_0x578C4EF320340AF7();
		if (!iLocal_659)
		{
			func_104();
		}
...
void func_127(int iParam0)
{
	if (Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (func_377(Local_389[iParam0 /*22*/]))
		{
			if (func_78(Local_389[iParam0 /*22*/], 242628503) || unk_0xCC8A9D2D16D94DA3(Local_389[iParam0 /*22*/]))
			{
				unk_0x9B94F6169B0DAEFD(Local_389[iParam0 /*22*/]);
			}
			else if (func_78(Local_389[iParam0 /*22*/], -1098463898) || func_78(Local_389[iParam0 /*22*/], 993674639))
			{
				unk_0x1210730BDCD39CB4(Local_389[iParam0 /*22*/]);
			}
			unk_0xD78F28ADCAD8C88C(Local_389[iParam0 /*22*/], 1);
			unk_0xA79461EDE020EDEB(Local_389[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7());
			unk_0x92BD213E6A0E666B(Local_389[iParam0 /*22*/], joaat("weapon_pistol"), -1, 0, 1);
			unk_0xBB7976F6FB9C9DD2(Local_389[iParam0 /*22*/]);
			unk_0x458523DB8A789DCF(unk_0x460153A63B9477BC());
			func_128(iParam0);
...
void func_128(int iParam0)
{
	...
	if ((iLocal_80 != 2 && !iLocal_659) && !unk_0xA59F96B50B97E63C(Local_389[iParam0 /*22*/], 0))
	{
		if (func_133(iParam0) && func_131(Local_389[iParam0 /*22*/], 30f))
		{
			...
			if (unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 3))
			{
				iLocal_659 = 1;
			}
			else if (!func_124(iParam0, 15) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
			{
				func_129();
				iLocal_656 = 0;
				if (iParam0 == 2)
				...
				{
					unk_0x1A454EFB8BC73430(Local_389[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", 0);
				}
				iLocal_659 = 1;
			}
		}
...
int func_131(int iParam0, float fParam1)
{
	...
	if (func_377(unk_0x9B0761B4C3EB8BC7()) && func_377(iParam0))
	{
		if (func_132(unk_0x9B0761B4C3EB8BC7(), iParam0, 0) <= fParam1)
		{
			return 1;
		}
	}
...
void func_134(int iParam0)
{
	...
	{
		unk_0x9B94F6169B0DAEFD(Local_389[iParam0 /*22*/]);
		unk_0xD3D9D7C84656DAE5(Local_389[iParam0 /*22*/], uLocal_481);
		if (iParam0 == 2)
		{
			unk_0x9DC06E2A59C5AEBB(&uVar0);
			if (!func_63(Local_389[iParam0 /*22*/], Local_389[iParam0 /*22*/].f_1, 3f))
			{
				unk_0x3C1B180EE30D36EF(0, Local_389[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, 0, Local_389[iParam0 /*22*/].f_4);
			}
			else
			{
				unk_0xF4726838A5A40509(0, Local_389[iParam0 /*22*/].f_4, 0);
			}
			if (iLocal_648[2] && unk_0x7BCC91F3C1CF24E8("sResumeRoot"))
			{
				unk_0x3964C1CAAE858CB1(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
			}
			else
			{
				unk_0x48E48D5929D45C6F(0, 1, 1);
			}
			unk_0x19F29730874AD6F1(uVar0);
			unk_0x9B6EC2CECE1010EF(Local_389[iParam0 /*22*/], uVar0);
		...
		func_135();
		unk_0x4E65320BC9AD521C(Local_389[iParam0 /*22*/], false);
...
void func_135()
{
	if (func_12(&uLocal_92, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1)))
	{
		if (!func_103())
		{
			if ((!unk_0xF005CCA4263DF67F(&cLocal_666, "NONE") && !unk_0xF005CCA4263DF67F(&cLocal_672, "NONE")) && !func_66("PR_TAKBACK", 0, 0))
			{
...
int func_139()
{
	...
	if (unk_0x460153A63B9477BC() == func_142())
	{
		return 0;
	}
...
void func_151(int iParam0)
{
	switch (Local_389[iParam0 /*22*/].f_21)
	{
		case 0:
			if (func_103())
			{
				if (unk_0xD2E9CCDC3186A6E0(Local_389[iParam0 /*22*/]))
				{
					func_129();
				}
			}
			...
			{
				if (iLocal_648[2] && !unk_0xCB21B99A8BFC080B(Local_389[iParam0 /*22*/]))
				{
					unk_0x9B94F6169B0DAEFD(Local_389[iParam0 /*22*/]);
					unk_0x3964C1CAAE858CB1(Local_389[iParam0 /*22*/], "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				}
			}
			break;
...
void func_152(int iParam0)
{
	...
	if (!func_173(iParam0))
	{
		if (func_154(Local_389[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || unk_0x3628D28B8671F14F(-1, unk_0x3E4D3CCC220BDFB1(Local_389[iParam0 /*22*/], 1), 100f))
		{
			if ((!unk_0xD2E9CCDC3186A6E0(Local_389[iParam0 /*22*/]) && !unk_0x9F2D0A782C34E6FD(Local_389[iParam0 /*22*/])) && !unk_0x4DBFB8024CDFF1D7(Local_389[iParam0 /*22*/]))
			{
				func_125();
			}
			else if (!bLocal_374)
			{
				unk_0xACBA79A91C121E78(unk_0x460153A63B9477BC(), 41);
				unk_0xACBA79A91C121E78(unk_0x460153A63B9477BC(), 33);
				unk_0xACBA79A91C121E78(unk_0x460153A63B9477BC(), 12);
				unk_0xCAD5C18968E57C30(unk_0x460153A63B9477BC(), 0, 0);
				unk_0x4B86C627B5EABFBF(unk_0x460153A63B9477BC(), 0);
			}
		}
	}
	else if (func_153(Local_389[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7(), 5f, 1))
	{
		if (!bLocal_374)
		{
			unk_0xACBA79A91C121E78(unk_0x460153A63B9477BC(), 41);
...
int func_154(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_6(unk_0x9B0761B4C3EB8BC7()) && func_6(iParam0))
	{
		...
		if (!unk_0xC0A3F78AF5448915(unk_0x9B0761B4C3EB8BC7(), 6))
		{
			if (unk_0x42A04E707DE50816(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				{
					return func_167(unk_0x9B0761B4C3EB8BC7(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_155(int iParam0, float fParam1)
{
	...
	if (func_6(unk_0x9B0761B4C3EB8BC7()) && func_6(iParam0))
	{
		if (func_166(iParam0) || unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), iParam0))
		{
			if (unk_0xC0A3F78AF5448915(unk_0x9B0761B4C3EB8BC7(), 6))
			{
				fVar0 = 40f;
...
{
	return func_157(iParam0, unk_0x9B0761B4C3EB8BC7(), fParam1, 1, 250, 7);
}
...
bool func_157(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	return (uVar0 || (unk_0x578C4EF320340AF7() - Local_38[iVar4 /*4*/].f_3) < iParam4);
}
...
int func_161(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_163(unk_0x3E4D3CCC220BDFB1(iParam1, 1) - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
	...
	{
		Var3 = { func_163(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_171(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_163(Param1 - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
...
{
	if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(Local_389[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !unk_0xC0A3F78AF5448915(unk_0x9B0761B4C3EB8BC7(), 6))
	{
		return 1;
	}
	return 0;
...
void func_174(int iParam0)
{
	...
	{
		if (((!bLocal_372 && !unk_0xD2E9CCDC3186A6E0(Local_389[iParam0 /*22*/])) && !unk_0x9F2D0A782C34E6FD(Local_389[iParam0 /*22*/])) && !unk_0x4DBFB8024CDFF1D7(Local_389[iParam0 /*22*/]))
		{
			func_175(iParam0);
		}
	}
...
void func_177(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_149(iParam0) || iParam2)
	{
		...
		{
			if (Local_389[func_150(iParam0) /*22*/].f_20 != 3 || (unk_0x578C4EF320340AF7() - iLocal_376) > 7500)
			{
				if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 9))
				{
					if (iParam0 == 0)
					{
						sVar0 = "PRA_CWCAR1";
		...
		{
			if (Local_389[func_150(iParam0) /*22*/].f_20 != 4 || (unk_0x578C4EF320340AF7() - iLocal_376) > 7500)
			{
				if (!bLocal_373)
				{
					if (iParam0 == 0)
		...
		else if (iParam1 == 5)
		{
			if (Local_389[func_150(iParam0) /*22*/].f_20 != 5)
			{
				if (iParam0 == 0)
				{
					...
					unk_0x1A454EFB8BC73430(Local_389[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", 0);
				}
				else if (iParam0 == 1)
				{
		...
		Local_389[iParam0 /*22*/].f_14 = unk_0x578C4EF320340AF7();
		Local_389[func_150(iParam0) /*22*/].f_14 = unk_0x578C4EF320340AF7();
...
void func_178(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		if (unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 12))
		{
			return;
		}
	}
	Var0 = { func_181() };
	if (unk_0x7BCC91F3C1CF24E8(sParam1) || unk_0x7BCC91F3C1CF24E8(&Var0))
	{
		func_121(&uLocal_483, cLocal_482, sParam1, 7, 0, 0);
		if (bParam2)
		{
			iLocal_376 = unk_0x578C4EF320340AF7();
		}
		return;
	}
	if ((!unk_0xF005CCA4263DF67F(&Var0, sParam1) && !func_66("PR_TAKBACK", 0, 0)) && !func_66("PR_GOVEH", 0, 0))
	{
		func_179();
		func_121(&uLocal_483, cLocal_482, sParam1, 7, 0, 0);
		if (bParam2)
...
void func_179()
{
	...
	{
		Var0 = { func_181() };
		if (unk_0xF005CCA4263DF67F(&Var0, "PRA_COPTLK1") || unk_0xF005CCA4263DF67F(&Var0, "PRA_COPTLK2"))
		{
			cLocal_666 = { func_181() };
			cLocal_672 = { func_180() };
		}
...
void func_182(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_149(iParam0) || iParam2)
	{
		if (iParam1 == 1)
		{
			if (Local_389[iParam0 /*22*/].f_19 != 1 || (unk_0x578C4EF320340AF7() - iLocal_376) > 7500)
			{
				if (!bLocal_372)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_389[iParam0 /*22*/].f_19 != 2 || (unk_0x578C4EF320340AF7() - iLocal_376) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPPLY1";
		...
		{
			if (Local_389[iParam0 /*22*/].f_19 != 4 || (unk_0x578C4EF320340AF7() - iLocal_376) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPST1";
		...
		else if (iParam1 == 5)
		{
			if (Local_389[iParam0 /*22*/].f_19 != 5)
			{
				...
				unk_0x1A454EFB8BC73430(Local_389[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", 0);
				func_183(iParam0, iParam1, 0);
			}
		}
		else if (iParam1 == 7)
		...
		if (bLocal_372)
		{
			if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 12))
			{
				unk_0xBE20AB8238688965(&(Local_389[iParam0 /*22*/].f_15), 12);
			}
		}
	}
}
...
void func_184(int iParam0)
{
	...
	{
		fVar0 = unk_0x86BA1DAC0CEADD50(unk_0x460153A63B9477BC());
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_382)
			{
				if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 340.0758f, -1598.255f, 28.29322f, 346.4939f, -1603.684f, 38.29278f, 6.22f, 0, 1, 0))
				{
					if (unk_0xEC787E1D3B804A72(unk_0x9B0761B4C3EB8BC7()) || unk_0xDB9E558E914A4D5C(unk_0x9B0761B4C3EB8BC7()))
					{
						iLocal_382 = 1;
						iLocal_381 = unk_0x578C4EF320340AF7();
						return;
					}
					else if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 11))
					{
						if ((((fVar0 > 16f && !Local_389[iParam0 /*22*/].f_16) && !unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 10)) && !unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0)) && unk_0x1037B9D45CE6B788(Local_389[iParam0 /*22*/], Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0))
						{
							func_186(iParam0, 11);
							return;
						}
				...
				if (((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0) && unk_0x1037B9D45CE6B788(Local_389[iParam0 /*22*/], Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0)) && !unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 10)) && !unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 11))
				{
					if ((fVar0 > 12f && !Local_389[iParam0 /*22*/].f_16) && !unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0))
					{
						func_186(iParam0, 11);
					}
				}
			}
			else if ((unk_0x578C4EF320340AF7() - iLocal_381) > 4000)
			{
				iLocal_382 = 0;
			}
		}
		else if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, 0, 1, 0) && unk_0x1037B9D45CE6B788(Local_389[iParam0 /*22*/], Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, 0, 1, 0))
		{
...
{
	if (unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, iParam1))
	{
		unk_0xD2459066EA58CE43(&(Local_389[iParam0 /*22*/].f_15), iParam1);
		Local_389[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_186(int iParam0, int iParam1)
{
	if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, iParam1))
	{
		unk_0xBE20AB8238688965(&(Local_389[iParam0 /*22*/].f_15), iParam1);
		Local_389[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_187(int iParam0)
{
	...
	{
		bVar0 = false;
		if (((func_153(Local_389[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7(), 5f, 1) && !unk_0xD2E9CCDC3186A6E0(Local_389[iParam0 /*22*/])) && !unk_0x9F2D0A782C34E6FD(Local_389[iParam0 /*22*/])) && !unk_0x4DBFB8024CDFF1D7(Local_389[iParam0 /*22*/]))
		{
	...
	else if (!func_153(Local_389[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7(), 5.5f, 1))
	{
		func_185(iParam0, 5);
		func_185(iParam0, 3);
	}
...
int func_188(int iParam0)
{
	...
	if (Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), unk_0x7EC595B99EA7C4B1(Local_389[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, 0, 1, 0))
		{
			return 1;
		}
	}
...
{
	if (unk_0xA65352E7FEA59881(Local_389[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7()))
	{
		if (unk_0xCED6B5226244381C(Local_389[iParam0 /*22*/]))
		{
			*iParam1 = 1;
		}
		else
...
void func_190(int iParam0)
{
	...
	if (Local_389[iParam0 /*22*/].f_20 != 6 && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		...
		while (iVar0 <= 5)
		{
			if (Local_389[iParam0 /*22*/].f_16)
			{
				if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 12))
				{
					if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_309[iVar0 /*7*/], Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, 1, 0))
					{
						iLocal_382 = 1;
						iLocal_381 = unk_0x578C4EF320340AF7();
						if (iVar0 == 4)
			...
			else if (!unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_309[iVar0 /*7*/], Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, 1, 0) || unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 12))
			{
				func_191(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_309[3 /*7*/], Local_309[3 /*7*/].f_3, Local_309[3 /*7*/].f_6, 0, 1, 0))
	{
		func_193(iParam0, 3);
	}
	else
	...
	switch (iParam1)
	{
		...
		case 4:
			if (!unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				...
				if (func_7(iVar0))
				{
					if (func_192(unk_0x36FE6D3220816ADA(iVar0)))
					{
						bLocal_373 = true;
					}
					else
					...
					if (!unk_0x1037B9D45CE6B788(iVar0, Local_309[4 /*7*/], Local_309[4 /*7*/].f_3, Local_309[4 /*7*/].f_6, 0, 1, 0))
					{
						func_185(iParam0, 8);
						func_185(iParam0, 7);
					}
					else if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 7))
					{
						func_186(iParam0, 7);
					}
				}
...
void func_193(int iParam0, int iParam1)
{
	...
	{
		case 1:
			if ((!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 6) && !unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 1)) && !unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 9))
			{
				if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 10))
				{
					func_186(iParam0, 10);
				}
			}
		...
		case 2:
			if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 1))
			{
				if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 6))
				{
					func_186(iParam0, 6);
				}
			}
		...
		case 3:
			if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 14))
			{
				func_186(iParam0, 14);
			}
			break;
		...
		case 4:
			if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 8))
			{
				...
				{
					unk_0xBE20AB8238688965(&(Local_389[iParam0 /*22*/].f_15), 9);
					func_186(iParam0, 8);
				}
				else
				{
					unk_0xD2459066EA58CE43(&(Local_389[iParam0 /*22*/].f_15), 9);
					func_186(iParam0, 8);
				}
			}
			break;
		...
		case 5:
			if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 4))
			{
				if ((!unk_0xD2E9CCDC3186A6E0(Local_389[iParam0 /*22*/]) && !unk_0x9F2D0A782C34E6FD(Local_389[iParam0 /*22*/])) && !unk_0x4DBFB8024CDFF1D7(Local_389[iParam0 /*22*/]))
				{
					func_186(iParam0, 4);
...
{
	if (func_153(unk_0x9B0761B4C3EB8BC7(), Local_389[iParam0 /*22*/], 30f, 1))
	{
		if (func_157(Local_389[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7(), 140f, 1, 250, 7))
		{
...
int func_196(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_197()
{
	...
	while (iVar0 <= 1)
	{
		...
		{
			if (unk_0xAE06B9E39EBDE049(Local_389[iVar0 /*22*/]))
			{
				if (func_7(unk_0xA5D3CD332CD10EE9()))
				{
					if (unk_0xCDF860E56BBCC6B4(Local_389[iVar0 /*22*/], unk_0xA5D3CD332CD10EE9(), 1))
					{
						unk_0xBB7976F6FB9C9DD2(Local_389[iVar0 /*22*/]);
						func_125();
					}
...
void func_198(int iParam0)
{
	...
	switch (Local_389[iParam0 /*22*/].f_19)
	{
		case 1:
			if (unk_0x578C4EF320340AF7() - Local_389[iParam0 /*22*/].f_14) > unk_0x344C570D6F8700DF(2500, 3000)
			{
				if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
				{
					func_127(iParam0);
					func_125();
					return;
				...
				{
					if ((unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 13) && (unk_0x578C4EF320340AF7() - iLocal_376) > 2500) && !iLocal_661)
					{
						if (iParam0 == 0)
						{
							sVar0 = "PRA_COPST1";
						...
						func_121(&uLocal_483, cLocal_482, sVar0, 7, 0, 0);
						unk_0xD2459066EA58CE43(&(Local_389[iParam0 /*22*/].f_15), 13);
						unk_0xD2459066EA58CE43(&(Local_389[func_150(iParam0) /*22*/].f_15), 13);
						iLocal_661 = 1;
					}
					Local_389[iParam0 /*22*/].f_17 = 1;
				}
		...
		case 2:
			if (unk_0x578C4EF320340AF7() - Local_389[iParam0 /*22*/].f_14) > unk_0x344C570D6F8700DF(1500, 2000)
			{
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 5:
			if (unk_0x578C4EF320340AF7() - Local_389[iParam0 /*22*/].f_14) > unk_0x344C570D6F8700DF(2500, 3000)
			{
				if (!func_153(Local_389[iParam0 /*22*/], unk_0x9B0761B4C3EB8BC7(), 1.5f, 1))
				{
					unk_0xD2459066EA58CE43(&(Local_389[iParam0 /*22*/].f_15), 5);
				}
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 7:
			if (unk_0x578C4EF320340AF7() - Local_389[iParam0 /*22*/].f_14) > unk_0x344C570D6F8700DF(2500, 3000)
			{
				fVar1 = unk_0x86BA1DAC0CEADD50(unk_0x460153A63B9477BC());
				if (((fVar1 < 12f && !Local_389[iParam0 /*22*/].f_16) && !unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 10)) && !func_78(Local_389[iParam0 /*22*/], -875674219))
				{
					unk_0xD2459066EA58CE43(&(Local_389[iParam0 /*22*/].f_15), 11);
				}
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
...
void func_201(int iParam0)
{
	...
	if (!iLocal_661)
	{
		bVar0 = unk_0x48238AD298F1A5F0(unk_0x9B0761B4C3EB8BC7());
		if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 13))
		{
			if (unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 10))
			{
				if (Local_389[iParam0 /*22*/].f_16)
		...
		else if (func_133(iParam0))
		{
			if (bVar0)
			{
				if (!func_153(unk_0x9B0761B4C3EB8BC7(), Local_389[iParam0 /*22*/], 10f, 1))
				{
					if (!unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 10) && !unk_0xCE990E643CD9D0E5(Local_389[iParam0 /*22*/].f_15, 6))
					{
						unk_0xD2459066EA58CE43(&(Local_389[iParam0 /*22*/].f_15), 13);
					}
				}
...
void func_202(int iParam0)
{
	...
	bVar0 = unk_0xC0A3F78AF5448915(unk_0x9B0761B4C3EB8BC7(), 4);
	if (Local_389[iParam0 /*22*/].f_20 != 6 && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (func_153(unk_0x9B0761B4C3EB8BC7(), Local_389[iParam0 /*22*/], 12f, 1))
		{
			if (bVar0)
			{
				if (Local_389[iParam0 /*22*/].f_16)
...
void func_203(int iParam0)
{
	if (!func_173(iParam0))
	{
		...
		else if (func_154(Local_389[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || unk_0x3628D28B8671F14F(-1, unk_0x3E4D3CCC220BDFB1(Local_389[iParam0 /*22*/], 1), 100f))
		{
			func_125();
		}
...
int func_204(int iParam0)
{
	...
	if (func_377(Local_389[iParam0 /*22*/]))
	{
		...
		if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), Local_389[iParam0 /*22*/], fVar0, fVar0, fVar0, 0, 1, 0))
		{
			if (unk_0x2311EB213A0CB707(unk_0x460153A63B9477BC(), Local_389[iParam0 /*22*/]) || unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), Local_389[iParam0 /*22*/]))
			{
				if (Local_389[iParam0 /*22*/].f_16)
				{
					return 1;
...
void func_205()
{
	...
	{
		if ((((func_377(Local_389[0 /*22*/]) && func_377(Local_389[1 /*22*/])) && func_12(&uLocal_92, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1))) && func_63(Local_389[0 /*22*/], Local_389[0 /*22*/].f_1, 3f)) && func_63(Local_389[1 /*22*/], Local_389[1 /*22*/].f_1, 3f))
		{
		...
		else if ((func_377(Local_389[2 /*22*/]) && func_12(&uLocal_144, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1))) && func_63(Local_389[2 /*22*/], Local_389[2 /*22*/].f_1, 3f))
		{
			if (!unk_0xCE990E643CD9D0E5(Local_389[2 /*22*/].f_15, 2) && !unk_0xCE990E643CD9D0E5(Local_389[2 /*22*/].f_15, 4))
			{
...
bool func_206(int iParam0, var uParam1, char* sParam2, float fParam3, int iParam4)
{
	if (!*uParam1)
	{
		if (!func_103() && unk_0x87F0CB19476706C3())
		{
...
void func_208(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (unk_0xAE06B9E39EBDE049(*uParam0))
	{
		if (!unk_0x5AEB5DDFFAD43CA5(*uParam0))
		{
			...
			if (iParam2 == 1)
			{
				unk_0x4E65320BC9AD521C(*uParam0, false);
			}
		}
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_71(iLocal_80, bLocal_28))
			{
				...
				unk_0x21723EF7B2FCC4CC("FHPRA_START");
				if (unk_0x60C47897C07F44B1(Global_40754[13 /*31*/]))
				{
					unk_0xA1EAD9664B908A31(Global_40754[13 /*31*/], 1);
				}
				iLocal_678 = 0;
				unk_0xBE1CA603598C1441(2f, 10f, 4);
				iLocal_81 = 1;
			}
			break;
		...
		case 1:
			if (unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) < 3)
			{
				if (func_377(Local_389[2 /*22*/]))
				{
					...
					{
						if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 371.9393f, -1604.252f, 45.603f, 399.8371f, -1627.065f, 31.75287f, 32.73f, 0, 1, 2) || unk_0x7922FF28ED63354A(unk_0x9B0761B4C3EB8BC7()))
						{
			...
			if ((unk_0xDB9E558E914A4D5C(unk_0x9B0761B4C3EB8BC7()) && iLocal_678 == 0) && func_132(Local_456.f_0, unk_0x9B0761B4C3EB8BC7(), 1) < 100f)
			{
				unk_0xBE1CA603598C1441(7f, 7f, 4);
				iLocal_678 = 1;
			}
			if (func_7(Local_456.f_0))
			{
				...
				{
					unk_0xBE1CA603598C1441(10f, 6f, 4);
					iLocal_81 = 2;
				}
				if (bLocal_374)
				{
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_71(iLocal_80, 0))
			{
				...
				unk_0x773B9DEB93E81B2F(369.0115f, -1609.116f, 28.2928f, 5f, 0);
				unk_0x773B9DEB93E81B2F(Local_389[0 /*22*/].f_1, 5f, 0);
				if (func_273(unk_0x9B0761B4C3EB8BC7(), 12, 4) || func_273(unk_0x9B0761B4C3EB8BC7(), 12, 3))
				{
					bLocal_372 = true;
				}
				func_224();
...
void func_224()
{
	...
	if (unk_0xAE06B9E39EBDE049(iVar0))
	{
		if (unk_0x80FF6C016CDB0FAF(iVar0, 0))
		{
			func_225(iVar0, unk_0x3E4D3CCC220BDFB1(iVar0, 1), unk_0xEF7858F25585F853(iVar0), 24, 0);
		}
	}
}
...
{
	if ((((((((((!unk_0xAE06B9E39EBDE049(iParam0) || !unk_0x80FF6C016CDB0FAF(iParam0, 0)) || func_243(iParam0, 0, 0)) || func_243(iParam0, 1, 0)) || func_243(iParam0, 2, 0)) || func_266(iParam0) != 145) || func_242(iParam0)) || func_241(iParam0)) || func_240(iParam0)) || func_239(iParam0)) || !func_229(unk_0x36FE6D3220816ADA(iParam0)))
	{
		if (func_241(iParam0))
		{
		}
...
var func_246()
{
	...
	func_256(&uVar0, unk_0x1D3A3697182AD8B3());
	func_255(&uVar0, unk_0x81F2E25F8C019191());
	func_254(&uVar0, unk_0x1F596C965B00E290());
	func_249(&uVar0, unk_0x371CFD525753F70C());
	func_248(&uVar0, unk_0xF225116F449A5CC6());
	func_247(&uVar0, unk_0x2E48CFA70ABFC06A());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_252(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (unk_0x80FF6C016CDB0FAF(iParam0, 0))
	{
		...
		*uParam1 = unk_0x999BFF5D72C9701A(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xBE20AB8238688965(&(uParam1->f_77), func_268(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_273(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76647[1 /*14*/].f_3 == unk_0x3FB4D40A857CEA77(iParam0, func_274(iParam1)) && Global_76647[1 /*14*/].f_4 == unk_0x79AFA009D186C4FB(iParam0, func_274(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 1) || unk_0x4D0432E34C5996D9(func_279(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 0) || unk_0x4D0432E34C5996D9(func_279(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 1) || unk_0x4D0432E34C5996D9(func_279(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4D0432E34C5996D9(iParam3, joaat("HAT"), 0) || unk_0x4D0432E34C5996D9(func_279(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_279(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = unk_0x21A524CB091C80DE(iParam3, 7, -1, 0, -1, func_274(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_287(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		unk_0x21A524CB091C80DE(iParam3, 7, -1, 0, -1, func_274(iParam2));
...
void func_295(int iParam0)
{
	...
	func_296(&(Global_76647[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_299(func_301(iParam1, uParam0->f_2), Global_76644, 0);
...
int func_299(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		uVar0 = Global_2551832[iParam0 /*3*/][func_300(iParam1)];
...
void func_306(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_296(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, unk_0x4D0432E34C5996D9(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_296(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, unk_0x4D0432E34C5996D9(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = unk_0x21A524CB091C80DE(iVar1, 7, -1, 0, -1, func_274(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_363()
{
	if (unk_0x2975580CCA617F3B(385.8528f, -1629.945f, 35.29278f, 398.8063f, -1640.865f, 28f))
	{
		unk_0xDC5C33A98881772F(iLocal_369, 0, 1, 1);
	}
	else
	{
		unk_0xDC5C33A98881772F(iLocal_369, 1, 1, 1);
	}
}
...
void func_364()
{
	if (bLocal_374)
	{
		if (unk_0x2975580CCA617F3B(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, 1, 0))
		{
			if (func_12(&uLocal_196, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1)))
			{
	...
	else if (unk_0x653A331834B72BC0(unk_0x9B0761B4C3EB8BC7()) || iLocal_82 == 1)
	{
		if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, 1, 0) || unk_0x2975580CCA617F3B(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
		{
			func_366(Global_40754[13 /*31*/], &fLocal_370);
		}
		else
	...
	else if (!unk_0x2975580CCA617F3B(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
	{
		func_365(Global_40754[13 /*31*/], &fLocal_370);
	}
	else
...
{
	if (unk_0x60C47897C07F44B1(iParam0))
	{
		if (*fParam1 != 0f)
		{
			if (!unk_0x357560AE34564BFA(uLocal_371))
			{
				uLocal_371 = unk_0x5700FF65A7E1B390(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), 0, 7);
			}
			unk_0xCCD157619BAD6BE2(iParam0, *fParam1, 1, 1);
			*fParam1 = (*fParam1 - (0.2f * unk_0x0000000050597EE2()));
			if (*fParam1 <= 0f)
			{
				unk_0xDC5C33A98881772F(iParam0, 1, 1, 0);
				unk_0x9142D74AFE3ACF6B(uLocal_371);
				*fParam1 = 0f;
			}
		}
	}
...
void func_366(int iParam0, float fParam1)
{
	if (*fParam1 != 1f)
	{
		unk_0xCCD157619BAD6BE2(uParam0, *fParam1, 1, 1);
		*fParam1 = (*fParam1 + (0.2f * unk_0x0000000050597EE2()));
		if (unk_0x357560AE34564BFA(uLocal_371))
		{
			unk_0x9142D74AFE3ACF6B(uLocal_371);
...
void func_371()
{
	...
	{
		if (!func_63(unk_0x9B0761B4C3EB8BC7(), 372.0053f, -1604.076f, 36.7536f, 100f) && !bLocal_387)
		{
			func_373("PR_AREAWARN", &bLocal_387);
		}
		else if (!func_63(unk_0x9B0761B4C3EB8BC7(), 372.0053f, -1604.076f, 36.7536f, 170f) && bLocal_387)
		{
			func_372(3);
		}
	}
...
void func_374()
{
	...
	else
	{
		...
		if (iLocal_80 == 2 || iLocal_80 == 3)
		{
			if (!func_153(unk_0x9B0761B4C3EB8BC7(), Local_456.f_0, 50f, 1) && !bLocal_388)
			{
				func_373("PR_VANWARN", &bLocal_388);
			}
			else if (!func_153(unk_0x9B0761B4C3EB8BC7(), Local_456.f_0, 100f, 1) && bLocal_388)
			{
				func_372(4);
			}
		}
...
void func_375()
{
	if (unk_0x1ADEE74BA60EE218(Local_456.f_0))
	{
		if (iLocal_368)
		{
			if ((unk_0x578C4EF320340AF7() - iLocal_367) > 5000)
			{
				func_372(2);
				return;
			}
		...
		{
			iLocal_367 = unk_0x578C4EF320340AF7();
			iLocal_368 = 1;
		}
	}
	else
...
void func_385()
{
	...
	if (!unk_0x60C47897C07F44B1(iLocal_369))
	{
		unk_0x6ADE529A7C2BA641(iLocal_369, joaat("prop_fnclink_03gate5"), 391.8602f, -1636.07f, 29.9744f, 1, 1, 0);
	}
	unk_0xDC5C33A98881772F(Global_40754[13 /*31*/], 1, 1, 0);
	unk_0xDC5C33A98881772F(iLocal_369, 1, 1, 0);
}
...
void func_391()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar2 <= (15 - 1))
		{
			unk_0xD2459066EA58CE43(&(Local_389[iVar1 /*22*/].f_15), iVar2);
			iVar2++;
		}
		iVar1++;
	}
...
void func_395()
{
	unk_0xDE8F8016287F771F("COPS", &uLocal_481);
}

void func_396()
{
	unk_0xF4F95D084B662764(uLocal_481);
	func_407(1);
	if (unk_0x60C47897C07F44B1(Global_40754[13 /*31*/]))
	{
		unk_0xA1EAD9664B908A31(Global_40754[13 /*31*/], 0);
	}
	unk_0xCCD157619BAD6BE2(Global_40754[13 /*31*/], 0f, 1, 1);
	unk_0xDC5C33A98881772F(Global_40754[13 /*31*/], 4, 1, 1);
	unk_0xDC5C33A98881772F(iLocal_369, 0, 1, 0);
	unk_0x830F38EF3826B066(iLocal_369);
	unk_0x1E337EE68290597A(uLocal_360, 0);
	func_55();
	unk_0x53797676AD34A9AA(5);
	unk_0x34FEEAC2548C3789(1f);
	func_406();
...
void func_397(bool bParam0)
{
	...
	if (bParam0)
	{
		if (unk_0xAE06B9E39EBDE049(Local_456.f_0))
		{
			if (unk_0xAE06B9E39EBDE049(unk_0x9B0761B4C3EB8BC7()))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	...
	if (unk_0x40397A9A17EEC1C5(uLocal_359))
	{
		unk_0x3ED9330214992278(0, 0, 3000, 1, 0, 0);
		unk_0xB8B0F7C8C1548C5B(uLocal_359, 0);
	}
}
...
void func_403()
{
	...
	unk_0x74528AC0906CBABE(Local_456.f_5);
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		unk_0x74528AC0906CBABE(Local_462[iVar0 /*6*/].f_5);
		iVar0++;
	}
}
