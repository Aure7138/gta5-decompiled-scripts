...
void __EntryFunction__()
{
	...
	func_383();
	func_369();
	uLocal_360 = unk_0x8738B068D97CDC64(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, 0, 1, 1, 1);
	func_368(27, 0);
	if (func_367())
	{
		func_366(409.6954f, -1567.046f, 28.2916f, 138.7093f, 1, 0);
	}
	unk_0xF7CE1213DA9898BD(0);
	while (true)
	{
		unk_0xBB5777EE55D3B041("M_STS", 0);
		if (func_365(unk_0xC8B93D94F8954288()))
		{
			func_358();
			func_355();
			func_350();
...
void func_1()
{
	switch (iLocal_81)
	{
		case 0:
			...
			func_32();
			if (!unk_0xB8A06E7E729EED0A(sLocal_353))
			{
				func_30(sLocal_353);
			}
			else
		...
		case 1:
			if (func_14())
			{
				...
				else if (func_12(&uLocal_196, unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1)))
				{
					func_10(408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_8(471.5946f, -1412.737f, 28.1562f, 68.5531f);
				}
				unk_0x98371F41D43CDFA9(372.9868f, -1623.531f, 28.2928f, 100f, 1, 0, 0, 0);
				func_2();
				func_384();
			}
			break;
...
void func_2()
{
	...
	unk_0x7DDB2C923BACAEED(Local_456.f_0);
	func_5(&Local_456);
	func_4(&uLocal_358);
	iVar0 = 0;
	while (iVar0 <= 2)
...
void func_15(int iParam0)
{
	...
	if (Global_100976.f_7719 || func_29(0))
	{
		iVar0 = func_28();
		if (!func_16(iVar0))
		{
...
int func_16(int iParam0)
{
	...
	func_17(&(Global_100976.f_1770.f_539), iVar1);
...
void func_17(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_19(Global_100976.f_17167[iVar0], &Var2, &fVar5))
			{
...
void func_23()
{
	...
	if (unk_0x95CCECA3948CFE7B(unk_0xC8B93D94F8954288()))
	{
		if (func_27(Global_100976.f_1770.f_539.f_3549) != unk_0x6D5BB810CC209E15(unk_0xC8B93D94F8954288()))
		{
			...
			if (func_25(iVar0) && (!func_24(14) || Global_99928))
			{
...
void func_34()
{
	...
	func_89(&Local_456, &uVar0, &iLocal_82, &iLocal_357, &iLocal_356, Local_364, 0, 0, 1090519040);
	switch (iLocal_81)
	{
		case 0:
			if (func_69(iLocal_80, bLocal_28))
			{
				if (unk_0xE685497EA92333FF("FHPRA_STOP"))
				{
					iLocal_385 = 0;
					iLocal_663 = 0;
					iLocal_81 = 1;
					unk_0x233432976E597324("FHPRA_STOP");
				}
			}
			break;
		
		case 1:
			func_68(&iLocal_356, Local_364, &iLocal_91, iLocal_82, &iLocal_355, &iLocal_384);
			if (iLocal_91 == 2)
			{
				if (func_12(&uLocal_196, unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1)))
				{
					unk_0x43D8F02EB6B05180(unk_0xA34E7C2A5118D638());
				}
			}
			if (func_56(Local_456.f_0, Local_364, &iLocal_356, iLocal_82, iLocal_91, &iLocal_663, &iLocal_385, &iLocal_379, &iLocal_380, &iLocal_355, 1090519040))
			{
				unk_0xD810132681A9B83C(5f, 6f, 4);
				func_53();
				func_48();
			}
			break;
		...
		case 3:
			...
			{
				if (!unk_0x0C7EC810080F0459(unk_0xC8B93D94F8954288(), Local_456.f_0, 0))
				{
					unk_0x6D9DB313D50E9A0D(unk_0xC8B93D94F8954288(), Local_456.f_0, -1);
				}
				else
				{
					func_47(Local_456.f_0, Local_364, 126.0705f, 0, 1);
					func_35(1, 1, 1);
					iLocal_81 = 1;
				}
			}
...
void func_38(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (!unk_0x2DC9BA2299B45EA6(unk_0xC8B93D94F8954288()) && !func_39(unk_0xA34E7C2A5118D638()))
		{
...
void func_49(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_29(0) && Global_69563.f_1 == 1) && func_50(Global_69563))
		{
		}
		else
		{
...
int func_56(int iParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	...
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			if (!unk_0xA0C23498D8E0BB93(unk_0xC8B93D94F8954288(), Param1, fParam12, fParam12, 2f, 0, 1, 2))
			{
				...
				{
					unk_0x74F83E6AF43012A7(func_66(func_67()));
				}
				*iParam7 = 1;
			...
			else
			{
				...
				{
					fVar0 = (fParam12 / 2f);
					if (func_61(unk_0xC8B93D94F8954288(), Param1, fVar0))
					{
						*iParam7 = 0;
	...
	else
	{
		...
		if (!*iParam8)
		{
			...
			{
				unk_0x74F83E6AF43012A7(func_59(func_67(), 0));
			}
...
int func_60(int iParam0, int iParam1)
{
	...
	if (unk_0x5D42322C7DB888D0(iVar0, 0))
	{
		if (unk_0xC0ADAF0814175B68(iVar0, -1) == unk_0xC8B93D94F8954288())
		{
			...
			{
				unk_0x5C384485B80ABDBC(iVar0, iParam0, iParam1, 0);
				return 0;
			}
		}
		else
...
int func_69(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_80(1, Local_361, 0))
			{
				if (((func_80(2, Local_456.f_1, Local_456.f_4) && func_80(4, Local_361, 0)) && func_80(3, Local_361, 0)) && func_80(5, Local_361, 0))
				{
					uLocal_371 = unk_0xDC3487ADA3784C61(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_79(229.3746f), 0, 7);
					if (unk_0x5A1CC333DD669834(Local_456.f_0) != 0)
					{
						iVar0 = unk_0x5A1CC333DD669834(Local_456.f_0);
						unk_0x8F5BCDB4D8191665(1);
						func_33(&iVar0);
						unk_0x8F5BCDB4D8191665(0);
					}
					func_77(&iLocal_356, Local_456.f_0, 1);
					func_75();
					func_73();
					return 1;
				}
		...
		case 1:
			if (bParam1)
			{
				if (((func_80(2, Local_456.f_1, Local_456.f_4) && func_80(4, Local_361, 0)) && func_80(3, Local_361, 0)) && func_80(5, Local_361, 0))
				{
					func_72(unk_0xC8B93D94F8954288(), 408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_70();
					unk_0x425A7D451DB73551(369.0115f, -1609.116f, 28.2928f, 5f, 0);
					unk_0x425A7D451DB73551(Local_389[0 /*22*/].f_1, 5f, 0);
					func_75();
					func_73();
					bLocal_28 = false;
					func_35(1, 1, 1);
		...
		case 2:
			if (bParam1)
			{
				if ((func_80(2, Local_456.f_1, Local_456.f_4) && func_80(4, Local_361, 0)) && func_80(3, Local_361, 0))
				{
					func_70();
					unk_0x425A7D451DB73551(369.0115f, -1609.116f, 28.2928f, 5f, 0);
					unk_0x425A7D451DB73551(Local_389[0 /*22*/].f_1, 5f, 0);
		...
		case 3:
			if (bParam1)
			{
				if (func_80(2, Local_364, Local_456.f_4))
				{
					func_70();
					unk_0x6D9DB313D50E9A0D(unk_0xC8B93D94F8954288(), Local_456.f_0, -1);
					func_73();
...
void func_70()
{
	...
	iLocal_662 = 1;
	func_368(27, 0);
	unk_0x130F0C5AE7B52B7A(Global_34823[13 /*31*/], 4, 1, 0);
	iLocal_663 = 0;
}
...
void func_71()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar0 <= (15 - 1))
		{
			unk_0x77621132305B133B(&(Local_389[iVar1 /*22*/].f_15), iVar0);
			iVar0++;
		}
...
void func_73()
{
	...
	func_74(&uLocal_483, iVar0, unk_0xC8B93D94F8954288(), sVar1, 0, 1);
	func_74(&uLocal_483, 6, Local_389[0 /*22*/], "BSPRACopBreak1", 0, 1);
	func_74(&uLocal_483, 7, Local_389[1 /*22*/], "BSPRACopBreak2", 0, 1);
	func_74(&uLocal_483, 5, Local_389[2 /*22*/], "BSPRACopBreak3", 0, 1);
}
...
void func_75()
{
	...
	while (iVar0 <= 2)
	{
		unk_0xAAD662D7E0D59F4C(Local_389[iVar0 /*22*/], false);
		if (!func_76(Local_389[iVar0 /*22*/], -1098463898))
		{
			switch (iVar0)
			{
				case 0:
				case 1:
					unk_0xDF9BE96D850502A6(Local_389[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET", Local_389[iVar0 /*22*/].f_1, Local_389[iVar0 /*22*/].f_4, 0, 0, 1);
					break;
				
				case 2:
					unk_0xD9D576FD55B4B03C(Local_389[iVar0 /*22*/], 1, 1);
					break;
				}
		}
		unk_0x640290651A86938B(Local_389[iVar0 /*22*/], joaat("weapon_pistol"), -1, 0, 0);
		unk_0xCBD60E398042F554(Local_389[iVar0 /*22*/], uLocal_481);
...
int func_80(int iParam0, struct<3> Param1, float fParam4)
{
	...
	{
		case 0:
			if (func_88(Param1, Local_361, 1056964608, 0) && fParam4 == 0f)
			{
				return 1;
			}
			break;
		...
		case 1:
			unk_0xF3AC452C34BF0E13(sLocal_354, 0);
			unk_0xF3AC452C34BF0E13(cLocal_482, 6);
			if (unk_0xF0DCEBB4ADA5D981(0) && unk_0xF0DCEBB4ADA5D981(6))
			{
				return 1;
			}
			break;
		...
		case 2:
			if (func_7(Global_87936[0]))
			{
				unk_0xFD816D0E738EB817(Global_87936[0], 1, 1);
				Local_456.f_0 = Global_87936[0];
				if (func_7(Local_456.f_0))
				{
					if (!unk_0x9431892AE74F024C(Local_456.f_0))
					{
						unk_0x3F6DAED48C8A6943(Local_456.f_0);
					}
					unk_0xF94FAE1326F14E1F(Local_456.f_0, 2, 0);
					unk_0xF94FAE1326F14E1F(Local_456.f_0, 3, 0);
					func_87(Local_456.f_0, 0);
					unk_0x0CE9795408B4B974(Local_456.f_0, 1);
					unk_0x0782F0CAEA719452(Local_456.f_0, 1);
					return 1;
				}
			}
			else if (func_86(&Local_456, Local_456.f_5, Local_456.f_1, Local_456.f_4, 1))
			{
				if (!unk_0x9431892AE74F024C(Local_456.f_0))
				{
					unk_0x3F6DAED48C8A6943(Local_456.f_0);
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				if (unk_0x95CCECA3948CFE7B(Global_87936.f_9[iVar0]))
				{
					if (!unk_0x902595DAD7718896(Global_87936.f_9[iVar0], 1))
					{
						unk_0xFD816D0E738EB817(Global_87936.f_9[iVar0], 1, 1);
						Local_389[iVar0 /*22*/] = Global_87936.f_9[iVar0];
						if (func_365(Local_389[iVar0 /*22*/]))
						{
							unk_0x7867B753FDFAFE2B(Local_389[iVar0 /*22*/], 2);
							unk_0x63E00E88AE3C86A3(Local_389[iVar0 /*22*/], 1);
							func_85(iVar0);
							iVar1++;
						}
					}
				...
				else if (func_84(&(Local_389[iVar0 /*22*/]), Local_389[iVar0 /*22*/].f_5, Local_389[iVar0 /*22*/].f_1, Local_389[iVar0 /*22*/].f_4, 0, 0, 0, 1))
				{
					func_85(iVar0);
					unk_0x63E00E88AE3C86A3(Local_389[iVar0 /*22*/], 1);
					unk_0x7867B753FDFAFE2B(Local_389[iVar0 /*22*/], 2);
					...
					unk_0x64B2BC184771BDA3(Local_389[iVar0 /*22*/], &cVar2);
					iVar1++;
				}
				iVar0++;
			}
		...
		case 4:
			...
			while (iVar6 <= 3)
			{
				if (func_7(Global_87936[iVar6]))
				{
					unk_0xFD816D0E738EB817(Global_87936[iVar6], 1, 1);
					Local_462[iVar7 /*6*/] = Global_87936[iVar6];
					if (func_7(Local_462[iVar7 /*6*/]))
					{
						iVar8++;
					}
				}
				else if (func_86(&(Local_462[iVar7 /*6*/]), Local_462[iVar7 /*6*/].f_5, Local_462[iVar7 /*6*/].f_1, Local_462[iVar7 /*6*/].f_4, 1))
				{
					iVar8++;
				}
				iVar7++;
		...
		case 5:
			if (func_81(&uLocal_358, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_456.f_0))
				{
					unk_0xAD318582A32CA5D2(uLocal_358, Local_456.f_0, 0, 0f, -1.85f, 0.05f, unk_0xF57992155BDFCC67(Local_456.f_0, 2), 0, 0, 0, 0, 2, 1);
					if (unk_0x57BA797A9A91EF93(Local_456.f_0, uLocal_358))
					{
						return 1;
					}
				}
...
{
	if (func_365(Local_389[iParam0 /*22*/]))
	{
		if (iParam0 == 0)
		{
			unk_0x8C245572EDB27776(Local_389[iParam0 /*22*/], 0, 0, 1, 0);
			unk_0x8C245572EDB27776(Local_389[iParam0 /*22*/], 3, 0, 0, 0);
			unk_0x8C245572EDB27776(Local_389[iParam0 /*22*/], 4, 0, 0, 0);
			unk_0x8C245572EDB27776(Local_389[iParam0 /*22*/], 8, 0, 0, 0);
			unk_0x8C245572EDB27776(Local_389[iParam0 /*22*/], 9, 1, 0, 0);
			unk_0x8C245572EDB27776(Local_389[iParam0 /*22*/], 10, 0, 0, 0);
		}
		else
		{
			unk_0x8C245572EDB27776(Local_389[iParam0 /*22*/], 0, 1, 1, 0);
			unk_0x8C245572EDB27776(Local_389[iParam0 /*22*/], 3, 0, 1, 0);
			unk_0x8C245572EDB27776(Local_389[iParam0 /*22*/], 4, 0, 0, 0);
			unk_0x8C245572EDB27776(Local_389[iParam0 /*22*/], 8, 1, 0, 0);
			unk_0x8C245572EDB27776(Local_389[iParam0 /*22*/], 9, 2, 0, 0);
			unk_0x8C245572EDB27776(Local_389[iParam0 /*22*/], 10, 0, 1, 0);
		}
	}
}
...
int func_86(int iParam0, var uParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	if (!unk_0x95CCECA3948CFE7B(*iParam0))
	{
		if (func_83(uParam1, "Loading", 0))
		{
			*iParam0 = unk_0xD53B4DCC7B2C8551(uParam1, Param2, uParam5, 1, 1);
			if (unk_0x95CCECA3948CFE7B(*iParam0))
			{
	...
	else
	{
		if (func_7(*iParam0))
		{
			unk_0xC76B5C68AB6DC7DF(*iParam0, Param2, 1, 0, 0, 1);
			unk_0x765E3FA65D011F03(*iParam0, uParam5);
		}
		if (!unk_0xD28A89C669EAD2E4(*iParam0))
		{
			unk_0xFD816D0E738EB817(*iParam0, 1, 0);
...
int func_88(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
		...
		switch (*iParam2)
		{
			case 0:
				if (unk_0x0C7EC810080F0459(unk_0xC8B93D94F8954288(), *iParam0, 0))
				{
					...
					if (func_64(func_58(func_67()), 0, 0))
					{
						unk_0x74F83E6AF43012A7(func_58(func_67()));
					}
					if (*iParam0 == iParam8)
					{
						*iParam2 = 1;
				...
				else
				{
					...
					{
						unk_0x74F83E6AF43012A7(func_59(func_67(), bParam9));
					}
					if (func_67() != 33)
					{
						func_92(iParam0);
			...
			case 2:
			case 1:
				if ((!unk_0x0C7EC810080F0459(unk_0xC8B93D94F8954288(), *iParam0, 0) && !func_95(*iParam0)) && !func_94(*iParam0))
				{
					func_33(iParam4);
...
void func_92(var uParam0)
{
	...
	if (unk_0x277ECDA23D8CCEB4(unk_0xC8B93D94F8954288(), 0))
	{
		...
		if (iVar0 != *uParam0)
		{
			if (func_7(iVar0))
			{
				if (unk_0x6D5BB810CC209E15(iVar0) == func_93(func_67()))
				{
					func_91(uParam0);
					*uParam0 = iVar0;
					func_87(*uParam0, 1);
...
int func_94(int iParam0)
{
	...
	if ((func_365(unk_0xC8B93D94F8954288()) && unk_0x277ECDA23D8CCEB4(unk_0xC8B93D94F8954288(), 0)) && func_7(iParam0))
	{
...
void func_96()
{
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_69(iLocal_80, bLocal_28))
			{
				if (unk_0xE685497EA92333FF("FHPRA_VAN"))
				{
					if (unk_0x6338DEFCA89B8CD6(unk_0xA34E7C2A5118D638()) == 0)
					{
						if (iLocal_82 == 1 || iLocal_82 == 2)
						{
							...
							if (!func_101())
							{
								func_65("PR_TAKBACK", &iLocal_355);
							}
							unk_0xD810132681A9B83C(5f, 6f, 4);
							unk_0x233432976E597324("FHPRA_VAN");
							func_62(&iLocal_356, Local_364, 1);
						}
					}
					iLocal_664 = 0;
					iLocal_81 = 1;
		...
		case 1:
			...
			if (iLocal_91 == 2)
			{
				...
				if (!iLocal_664)
				{
					unk_0x6550E854B6D80CD9("SCRIPTED_SCANNER_REPORT_BS_PREP_A_01", 0f);
					iLocal_664 = 1;
				}
			}
			if (func_99(Local_456.f_0, Local_364, &iLocal_356, iLocal_91, iLocal_82, &iLocal_355, &iLocal_385, 0, 0, 1086324736))
			{
				unk_0xD810132681A9B83C(5f, 6f, 4);
				iLocal_81 = 2;
			}
	...
	while (iVar0 < 3)
	{
		...
		if (!unk_0x2DC9BA2299B45EA6(iVar1))
		{
			switch (iLocal_87[iVar0])
			{
						...
						if (func_112(iVar1, 0))
						{
							if (func_111(iVar0, iVar1) || func_109(iVar0, iVar1))
							{
								if (func_108(iVar1, 0))
								{
									...
									unk_0xAAD662D7E0D59F4C(iVar1, true);
				...
				case 1:
					if (func_107(iVar0, iVar1) && unk_0x1F59F772AA90087D(iVar1, 1))
					{
						iLocal_87[iVar0] = 0;
						func_106(iVar1);
					}
				...
				case 2:
					if (func_105(iVar0, iVar1) && unk_0x1F59F772AA90087D(iVar1, 1))
					{
						iLocal_87[iVar0] = 0;
						func_106(iVar1);
					}
...
int func_105(int iParam0, int iParam1)
{
	...
	{
		case 0:
			unk_0x52521828021B7DC5(iParam1, unk_0x275BEBE583A163B5(iParam1, 0), Local_364, 4, 20f, 786469, 3.5f, 5f, 1);
			iLocal_83[iParam0] = 3;
			break;
		
		case 3:
			if (!func_109(iParam0, iParam1) || func_61(unk_0xC8B93D94F8954288(), Local_364, 2f))
			{
				iLocal_83[iParam0] = 4;
			}
			break;
...
int func_107(int iParam0, int iParam1)
{
	...
	{
		case 0:
			if (!unk_0xF473E4B36466850D(Local_300[iLocal_665 /*4*/], 1.5f, 0, 0, 1, 0, 0, iParam1, 0))
			{
				if (func_61(iParam1, Local_300[iLocal_665 /*4*/], 5f))
				{
					fVar0 = 1f;
				}
				else
				...
				unk_0x81333BEA4837207C(iParam1, Local_300[iLocal_665 /*4*/], fVar0, 20000, 0.25f, 0, Local_300[iLocal_665 /*4*/].f_3);
				iLocal_83[iParam0] = 1;
			}
			break;
		...
		case 1:
			...
			{
				unk_0x0A13FCE812002F87(iParam1, 0);
				iLocal_83[iParam0] = 2;
			}
			break;
...
int func_109(int iParam0, int iParam1)
{
	if (!func_110())
	{
		if ((unk_0x95CCECA3948CFE7B(Local_456.f_0) && unk_0x5D42322C7DB888D0(Local_456.f_0, 0)) && !unk_0xA0C23498D8E0BB93(Local_456.f_0, Local_364, 2f, 2f, 2f, 0, 1, 0))
		{
			if ((!unk_0x2DC9BA2299B45EA6(unk_0xC8B93D94F8954288()) && unk_0x0C7EC810080F0459(unk_0xC8B93D94F8954288(), Local_456.f_0, 0)) && unk_0x6338DEFCA89B8CD6(unk_0xA34E7C2A5118D638()) == 0)
			{
				if (unk_0x0C7EC810080F0459(iParam1, Local_456.f_0, 0) && unk_0xC0ADAF0814175B68(Local_456.f_0, -1) == iParam1)
				{
					iLocal_87[iParam0] = 2;
					return 1;
				}
...
int func_111(int iParam0, int iParam1)
{
	if (!func_110())
	{
		if (unk_0x8DF850DA069BF37C(iParam1, 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.63f, 0, 1, 0) && unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.38f, 0, 1, 0))
		{
			iLocal_665 = 0;
			iLocal_87[iParam0] = 1;
			return 1;
		}
		else if (unk_0x8DF850DA069BF37C(iParam1, 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.63f, 0, 1, 0) && unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.38f, 0, 1, 0))
		{
			iLocal_665 = 1;
			iLocal_87[iParam0] = 1;
			return 1;
...
int func_114(int iParam0)
{
	...
	return Global_88917[func_115(iParam0)];
}
...
void func_116()
{
	...
	if (!bLocal_28)
	{
		...
		{
			unk_0x35E434328CEC3651(unk_0xA34E7C2A5118D638(), 38);
			unk_0x35E434328CEC3651(unk_0xA34E7C2A5118D638(), 30);
			bLocal_374 = false;
		}
		if (iLocal_80 == 2)
		{
			if (!iLocal_386)
			{
				if (!func_61(unk_0xC8B93D94F8954288(), Local_456.f_1, 180f))
				{
					iVar0 = 0;
					while (iVar0 <= 2)
					{
						func_201(&(Local_389[iVar0 /*22*/]), 1, 0, 1);
						iVar0++;
					}
					iLocal_386 = 1;
				}
...
void func_117()
{
	...
	{
		func_189(Local_389[iVar0 /*22*/], &(Local_389[iVar0 /*22*/].f_6), -1, 0, 0, 0, -1082130432, 0, -1);
	}
	else
	{
		func_188(&(Local_389[iVar0 /*22*/].f_6));
	}
	if (func_365(Local_389[iVar0 /*22*/]))
	{
		func_145(iVar0);
	...
	{
		if (unk_0x95CCECA3948CFE7B(Local_389[iVar0 /*22*/]) && !unk_0x2DC9BA2299B45EA6(Local_389[iVar0 /*22*/]))
		{
			if (unk_0x87D4C731B013290A(Local_389[iVar0 /*22*/], unk_0xC8B93D94F8954288(), 1))
			{
				unk_0x0CBE045BBBA5CFDE(Local_389[iVar0 /*22*/]);
				if (((unk_0xBCB541CE877969BE(unk_0xC8B93D94F8954288()) || unk_0x3DFC8C2B3444478A(Local_389[iVar0 /*22*/])) || unk_0x64A71C92E3B69E73(Local_389[iVar0 /*22*/])) || unk_0x21D2CF167438FDE0(Local_389[iVar0 /*22*/]))
				{
					if (!bLocal_374)
					{
						unk_0x35E434328CEC3651(unk_0xA34E7C2A5118D638(), 41);
						unk_0x35E434328CEC3651(unk_0xA34E7C2A5118D638(), 33);
...
void func_118(int iParam0)
{
	...
	{
		case 1:
			if (func_142(iParam0) && func_61(Local_389[iParam0 /*22*/], Local_389[iParam0 /*22*/].f_1, 3f))
			{
				if (unk_0x693EBB4F13506457() - Local_389[iParam0 /*22*/].f_14) > unk_0x531444754C426278(1000, 1500)
				{
					if (!func_76(Local_389[iParam0 /*22*/], -875674219))
					{
						unk_0x77BB53B713A3FB22(Local_389[iParam0 /*22*/]);
						unk_0xC518AECFA9CF7722(Local_389[iParam0 /*22*/], unk_0xC8B93D94F8954288(), 0);
					}
					Local_389[iParam0 /*22*/].f_14 = unk_0x693EBB4F13506457();
				}
			}
			else
			{
		...
		case 2:
			if (unk_0x693EBB4F13506457() - Local_389[iParam0 /*22*/].f_14) > unk_0x531444754C426278(5000, 6000)
			{
				if (unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 2))
				{
					func_125(iParam0);
					func_123();
					return;
		...
		case 3:
			if (unk_0x693EBB4F13506457() - Local_389[iParam0 /*22*/].f_14) > unk_0x531444754C426278(2500, 3000)
			{
				if (unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 8))
				{
					Local_389[iParam0 /*22*/].f_17 = 1;
				}
				else
		...
		case 4:
			if (unk_0x693EBB4F13506457() - Local_389[iParam0 /*22*/].f_14) > unk_0x531444754C426278(2500, 3000)
			{
				if (unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 8))
				{
					...
					else if (unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 9) && !bLocal_372)
					{
						func_125(iParam0);
						func_123();
						return;
		...
		case 6:
			...
			if ((unk_0x693EBB4F13506457() - Local_389[iParam0 /*22*/].f_14) > iVar0)
			{
				if (!unk_0x3070735E644ED1A1(Local_389[iParam0 /*22*/], 0) && !unk_0xDFBD3B9BC8118D74(Local_389[iParam0 /*22*/]))
				{
					Local_389[iParam0 /*22*/].f_14 = unk_0x693EBB4F13506457();
					func_125(iParam0);
				}
		...
		case 5:
			if (unk_0x693EBB4F13506457() - Local_389[iParam0 /*22*/].f_14) > unk_0x531444754C426278(1000, 3000)
			{
				func_123();
				return;
			}
		...
		case 7:
			if ((unk_0x693EBB4F13506457() - Local_389[iParam0 /*22*/].f_14) > 350)
			{
				if (!bLocal_374 && func_122(iParam0, 15))
				{
					func_71();
					func_132(iParam0);
					unk_0x4E8B09A15BF6947A(Local_389[iParam0 /*22*/]);
					return;
				}
				else
				{
					if (iLocal_660 != -1)
					{
						if ((unk_0x693EBB4F13506457() - iLocal_660) > 12000)
						{
							func_121(-1);
						}
						else if ((unk_0x1E8D3FA42E89ED72(unk_0xC8B93D94F8954288()) || unk_0x56A705EEDF9090AD(unk_0xC8B93D94F8954288())) || unk_0x7E515EEFC038658D(unk_0xC8B93D94F8954288()))
						{
							func_121(2);
						}
						else if (unk_0x07AC36C22591E640(unk_0xA34E7C2A5118D638(), &iVar1))
						{
							if (unk_0x96209AADF56E8FE8(iVar1))
							{
								iVar2 = unk_0x4D3C2AC8339BFB4F(iVar1);
					...
					if ((func_76(Local_389[iParam0 /*22*/], -2128726980) || func_76(Local_389[iParam0 /*22*/], -982327190)) && unk_0x6338DEFCA89B8CD6(unk_0xA34E7C2A5118D638()) < 2)
					{
						if (!func_76(Local_389[iParam0 /*22*/], 1392476864))
						{
							unk_0xD538F54FFE87B03A(Local_389[iParam0 /*22*/], unk_0xC8B93D94F8954288());
						}
					}
				}
			}
			if (!iLocal_658)
			{
				if (unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 1) && unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 14))
				{
					if (iParam0 == 0)
					{
						sVar3 = "PRA_COPSHT1";
					...
					func_51();
					func_119(&uLocal_483, cLocal_482, sVar3, 7, 0, 0);
					iLocal_658 = 1;
				}
			}
			break;
...
void func_121(int iParam0)
{
	...
	iLocal_660 = -1;
	if (func_365(Local_389[0 /*22*/]))
	{
		unk_0xAAD662D7E0D59F4C(Local_389[0 /*22*/], false);
	}
	if (func_365(Local_389[1 /*22*/]))
	{
		unk_0xAAD662D7E0D59F4C(Local_389[1 /*22*/], false);
	}
	if (func_365(Local_389[2 /*22*/]))
	{
		unk_0xAAD662D7E0D59F4C(Local_389[2 /*22*/], false);
	}
	if (iParam0 != -1)
	{
		unk_0xB47D5A4E4AE9BEAD(unk_0xA34E7C2A5118D638(), iParam0, 0);
		unk_0x1C9B7C3360143C4C(unk_0xA34E7C2A5118D638(), 0);
	}
}
...
int func_122(int iParam0, int iParam1)
{
	...
	while (iVar0 <= 14)
	{
		if (iVar0 != iParam1)
		{
			if (unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, iVar0))
			{
				return 0;
			}
		}
...
void func_123()
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			func_188(&(Local_389[iVar0 /*22*/].f_6));
			Local_389[iVar0 /*22*/].f_14 = unk_0x693EBB4F13506457();
...
void func_124()
{
	if (!iLocal_375)
	{
		iLocal_660 = unk_0x693EBB4F13506457();
		if (!iLocal_659)
		{
			func_102();
		}
...
void func_125(int iParam0)
{
	if (Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (func_365(Local_389[iParam0 /*22*/]))
		{
			if (func_76(Local_389[iParam0 /*22*/], 242628503) || unk_0x6A4F5A3AC1E5ECDE(Local_389[iParam0 /*22*/]))
			{
				unk_0x5124C5FA52D2AF3E(Local_389[iParam0 /*22*/]);
			}
			else if (func_76(Local_389[iParam0 /*22*/], -1098463898) || func_76(Local_389[iParam0 /*22*/], 993674639))
			{
				unk_0x77BB53B713A3FB22(Local_389[iParam0 /*22*/]);
			}
			unk_0x54B7E2FDCB9A874B(Local_389[iParam0 /*22*/], 1);
			unk_0xD538F54FFE87B03A(Local_389[iParam0 /*22*/], unk_0xC8B93D94F8954288());
			unk_0x640290651A86938B(Local_389[iParam0 /*22*/], joaat("weapon_pistol"), -1, 0, 1);
			unk_0x0CBE045BBBA5CFDE(Local_389[iParam0 /*22*/]);
			unk_0x14F4A23DF51924BF(unk_0xA34E7C2A5118D638());
			func_126(iParam0);
...
void func_126(int iParam0)
{
	...
	if ((iLocal_80 != 2 && !iLocal_659) && !unk_0xB6900B8CB0ABBD2B(Local_389[iParam0 /*22*/]))
	{
		if (func_131(iParam0) && func_129(Local_389[iParam0 /*22*/], 30f))
		{
			if (iParam0 == 0)
			{
			...
			if (unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 3))
			{
				iLocal_659 = 1;
			}
			else if (!func_122(iParam0, 15) || unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
			{
				func_127();
				iLocal_656 = 0;
				if (iParam0 == 2)
				{
					func_119(&uLocal_483, cLocal_482, sVar0, 7, 0, 0);
				}
				else
				{
					unk_0x7033366221CC71C6(Local_389[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", 0);
				}
				iLocal_659 = 1;
			}
		}
...
int func_129(int iParam0, float fParam1)
{
	...
	if (func_365(unk_0xC8B93D94F8954288()) && func_365(iParam0))
	{
		if (func_130(unk_0xC8B93D94F8954288(), iParam0, 0) <= fParam1)
		{
			return 1;
		}
	}
...
void func_132(int iParam0)
{
	...
	if (Local_389[iParam0 /*22*/].f_18 != 1 && !func_76(Local_389[iParam0 /*22*/], 242628503))
	{
		unk_0x5124C5FA52D2AF3E(Local_389[iParam0 /*22*/]);
		unk_0xCBD60E398042F554(Local_389[iParam0 /*22*/], uLocal_481);
		if (iParam0 == 2)
		{
			unk_0x3E2E609450787FFE(&uVar0);
			if (!func_61(Local_389[iParam0 /*22*/], Local_389[iParam0 /*22*/].f_1, 3f))
			{
				unk_0x81333BEA4837207C(0, Local_389[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, 0, Local_389[iParam0 /*22*/].f_4);
			}
			else
			{
				unk_0x6EAFBB3A7F6ADEA9(0, Local_389[iParam0 /*22*/].f_4, 0);
			}
			if (iLocal_648[2] && unk_0xB8A06E7E729EED0A("sResumeRoot"))
			{
				unk_0xFCA99C3640D1F1B5(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
			}
			else
			{
				unk_0xD9D576FD55B4B03C(0, 1, 1);
			}
			unk_0x939BC11172AA1303(uVar0);
			unk_0xBFE865E3B513451B(Local_389[iParam0 /*22*/], uVar0);
		...
		func_133();
		unk_0xAAD662D7E0D59F4C(Local_389[iParam0 /*22*/], false);
...
void func_133()
{
	if (func_12(&uLocal_92, unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1)))
	{
		if (!func_101())
		{
			if ((!unk_0xF8D041B05C3D1FD4(&cLocal_666, "NONE") && !unk_0xF8D041B05C3D1FD4(&cLocal_672, "NONE")) && !func_64("PR_TAKBACK", 0, 0))
			{
				if (func_134(&uLocal_483, cLocal_482, &cLocal_666, &cLocal_672, 7, 0, 0))
				{
					StringCopy(&cLocal_666, "NONE", 24);
					StringCopy(&cLocal_672, "NONE", 24);
					iLocal_656 = 1;
...
{
	if (Local_389[func_143(iParam0) /*22*/].f_18 > 1 && Local_389[func_143(iParam0) /*22*/].f_20 != 1)
	{
		return 1;
	}
	return 0;
...
void func_144(int iParam0)
{
	switch (Local_389[iParam0 /*22*/].f_21)
	{
		case 0:
			if (func_101())
			{
				if (unk_0x3DFC8C2B3444478A(Local_389[iParam0 /*22*/]))
				{
					func_127();
				}
			}
			...
			{
				if (iLocal_648[2] && !unk_0xD44470620D6C81EA(Local_389[iParam0 /*22*/]))
				{
					unk_0x5124C5FA52D2AF3E(Local_389[iParam0 /*22*/]);
					unk_0xFCA99C3640D1F1B5(Local_389[iParam0 /*22*/], "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				}
			}
			break;
...
void func_145(int iParam0)
{
	...
	if (!func_166(iParam0))
	{
		if (func_147(Local_389[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || unk_0xDF87568D121A99AC(-1, unk_0x44C17CCB85A88A1F(Local_389[iParam0 /*22*/], 1), 100f))
		{
			if ((!unk_0x3DFC8C2B3444478A(Local_389[iParam0 /*22*/]) && !unk_0x64A71C92E3B69E73(Local_389[iParam0 /*22*/])) && !unk_0x21D2CF167438FDE0(Local_389[iParam0 /*22*/]))
			{
				func_123();
			}
			else if (!bLocal_374)
			{
				unk_0x35E434328CEC3651(unk_0xA34E7C2A5118D638(), 41);
				unk_0x35E434328CEC3651(unk_0xA34E7C2A5118D638(), 33);
				unk_0x35E434328CEC3651(unk_0xA34E7C2A5118D638(), 12);
				unk_0xB47D5A4E4AE9BEAD(unk_0xA34E7C2A5118D638(), 0, 0);
				unk_0x1C9B7C3360143C4C(unk_0xA34E7C2A5118D638(), 0);
			}
		}
	}
	else if (func_146(Local_389[iParam0 /*22*/], unk_0xC8B93D94F8954288(), 5f))
	{
		if (!bLocal_374)
		{
			unk_0x35E434328CEC3651(unk_0xA34E7C2A5118D638(), 41);
...
int func_147(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_6(unk_0xC8B93D94F8954288()) && func_6(iParam0))
	{
		...
		if (!unk_0x74BBB84E37C71AAC(unk_0xC8B93D94F8954288(), 6))
		{
			if (unk_0x7E515EEFC038658D(unk_0xC8B93D94F8954288()))
			{
				...
				{
					return func_160(unk_0xC8B93D94F8954288(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_148(int iParam0, float fParam1)
{
	...
	if (func_6(unk_0xC8B93D94F8954288()) && func_6(iParam0))
	{
		if (func_159(iParam0) || unk_0x0BBFEAC55291063A(unk_0xA34E7C2A5118D638(), iParam0))
		{
			if (unk_0x74BBB84E37C71AAC(unk_0xC8B93D94F8954288(), 6))
			{
				fVar0 = 40f;
...
{
	return func_150(iParam0, unk_0xC8B93D94F8954288(), fParam1, 1, 250, 7);
}
...
bool func_150(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_151(&(Local_38[iVar4 /*4*/]), Var1, iParam1, &(Local_38[iVar4 /*4*/].f_3), iParam0, iParam5);
...
int func_154(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_156(unk_0x44C17CCB85A88A1F(iParam1, 1) - unk_0x44C17CCB85A88A1F(iParam0, 1)) };
	...
	{
		Var3 = { func_156(unk_0xB867FC7DBA46C0F1(iParam0, 31086, 0f, 5f, 0f) - unk_0xB867FC7DBA46C0F1(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_164(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_156(Param1 - unk_0x44C17CCB85A88A1F(iParam0, 1)) };
...
{
	if (unk_0xA0C23498D8E0BB93(unk_0xC8B93D94F8954288(), unk_0xCC31DB73C65552D8(Local_389[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !unk_0x74BBB84E37C71AAC(unk_0xC8B93D94F8954288(), 6))
	{
		return 1;
	}
	return 0;
...
void func_167(int iParam0)
{
	...
	{
		if (((!bLocal_372 && !unk_0x3DFC8C2B3444478A(Local_389[iParam0 /*22*/])) && !unk_0x64A71C92E3B69E73(Local_389[iParam0 /*22*/])) && !unk_0x21D2CF167438FDE0(Local_389[iParam0 /*22*/]))
		{
			func_168(iParam0);
		}
	}
...
void func_168(int iParam0)
{
	...
	if ((((!func_142(iParam0) && Local_389[iParam0 /*22*/].f_20 != 7) && Local_389[iParam0 /*22*/].f_20 != 6) && !bLocal_374) && Local_389[iParam0 /*22*/].f_17)
	{
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
void func_170(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_142(iParam0) || iParam2)
	{
		if (iParam1 == 2)
		{
			if (Local_389[func_143(iParam0) /*22*/].f_20 != 2)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPGUNW1";
		...
		{
			if (Local_389[func_143(iParam0) /*22*/].f_20 != 3 || (unk_0x693EBB4F13506457() - iLocal_376) > 7500)
			{
				if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 9))
				{
					if (iParam0 == 0)
					{
						sVar0 = "PRA_CWCAR1";
		...
		{
			if (Local_389[func_143(iParam0) /*22*/].f_20 != 4 || (unk_0x693EBB4F13506457() - iLocal_376) > 7500)
			{
				if (!bLocal_373)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_389[func_143(iParam0) /*22*/].f_20 != 5)
			{
				if (iParam0 == 0)
				{
					sVar1 = "S_M_Y_COP_01_WHITE_MINI_03";
					unk_0x7033366221CC71C6(Local_389[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", 0);
				}
				else if (iParam0 == 1)
				{
		...
		Local_389[iParam0 /*22*/].f_14 = unk_0x693EBB4F13506457();
		Local_389[func_143(iParam0) /*22*/].f_14 = unk_0x693EBB4F13506457();
		Local_389[func_143(iParam0) /*22*/].f_18 = 3;
		Local_389[func_143(iParam0) /*22*/].f_20 = 1;
		Local_389[iParam0 /*22*/].f_18 = 3;
...
void func_171(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		if (unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 12))
		{
			return;
		}
	}
	Var0 = { func_174() };
	if (unk_0xB8A06E7E729EED0A(sParam1) || unk_0xB8A06E7E729EED0A(&Var0))
	{
		func_119(&uLocal_483, cLocal_482, sParam1, 7, 0, 0);
		if (bParam2)
		{
			iLocal_376 = unk_0x693EBB4F13506457();
		}
		return;
	}
	if ((!unk_0xF8D041B05C3D1FD4(&Var0, sParam1) && !func_64("PR_TAKBACK", 0, 0)) && !func_64("PR_GOVEH", 0, 0))
	{
		func_172();
		func_119(&uLocal_483, cLocal_482, sParam1, 7, 0, 0);
		if (bParam2)
...
void func_172()
{
	...
	{
		Var0 = { func_174() };
		if (unk_0xF8D041B05C3D1FD4(&Var0, "PRA_COPTLK1") || unk_0xF8D041B05C3D1FD4(&Var0, "PRA_COPTLK2"))
		{
			cLocal_666 = { func_174() };
			cLocal_672 = { func_173() };
		}
...
void func_175(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_142(iParam0) || iParam2)
	{
		if (iParam1 == 1)
		{
			if (Local_389[iParam0 /*22*/].f_19 != 1 || (unk_0x693EBB4F13506457() - iLocal_376) > 7500)
			{
				if (!bLocal_372)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_389[iParam0 /*22*/].f_19 != 2 || (unk_0x693EBB4F13506457() - iLocal_376) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPPLY1";
		...
		{
			if (Local_389[iParam0 /*22*/].f_19 != 4 || (unk_0x693EBB4F13506457() - iLocal_376) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPST1";
		...
		else if (iParam1 == 5)
		{
			if (Local_389[iParam0 /*22*/].f_19 != 5)
			{
				...
				unk_0x7033366221CC71C6(Local_389[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", 0);
				func_176(iParam0, iParam1, 0);
			}
		}
		else if (iParam1 == 7)
		...
		if (bLocal_372)
		{
			if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 12))
			{
				unk_0x59A0729D503ED758(&(Local_389[iParam0 /*22*/].f_15), 12);
			}
		}
	}
}
...
void func_177(int iParam0)
{
	...
	if ((!func_142(iParam0) && Local_389[iParam0 /*22*/].f_20 != 6) && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		fVar0 = unk_0x63B860B4D08A206F(unk_0xA34E7C2A5118D638());
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_382)
			{
				if (unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), 340.0758f, -1598.255f, 28.29322f, 346.4939f, -1603.684f, 38.29278f, 6.22f, 0, 1, 0))
				{
					if (unk_0xC1D9AF0588D03376(unk_0xC8B93D94F8954288()) || unk_0x56A705EEDF9090AD(unk_0xC8B93D94F8954288()))
					{
						iLocal_382 = 1;
						iLocal_381 = unk_0x693EBB4F13506457();
						return;
					}
					else if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 11))
					{
						if ((((fVar0 > 16f && !Local_389[iParam0 /*22*/].f_16) && !unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 10)) && !unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0)) && unk_0x8DF850DA069BF37C(Local_389[iParam0 /*22*/], Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0))
						{
							func_179(iParam0, 11);
							return;
						}
				...
				if (((unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0) && unk_0x8DF850DA069BF37C(Local_389[iParam0 /*22*/], Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0)) && !unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 10)) && !unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 11))
				{
					if ((fVar0 > 12f && !Local_389[iParam0 /*22*/].f_16) && !unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0))
					{
						func_179(iParam0, 11);
					}
				}
			}
			else if ((unk_0x693EBB4F13506457() - iLocal_381) > 4000)
			{
				iLocal_382 = 0;
			}
		}
		else if (unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, 0, 1, 0) && unk_0x8DF850DA069BF37C(Local_389[iParam0 /*22*/], Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, 0, 1, 0))
		{
...
{
	if (unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, iParam1))
	{
		unk_0x77621132305B133B(&(Local_389[iParam0 /*22*/].f_15), iParam1);
		Local_389[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_179(int iParam0, int iParam1)
{
	if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, iParam1))
	{
		unk_0x59A0729D503ED758(&(Local_389[iParam0 /*22*/].f_15), iParam1);
		Local_389[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_180(int iParam0)
{
	...
	{
		bVar0 = false;
		if (((func_146(Local_389[iParam0 /*22*/], unk_0xC8B93D94F8954288(), 5f) && !unk_0x3DFC8C2B3444478A(Local_389[iParam0 /*22*/])) && !unk_0x64A71C92E3B69E73(Local_389[iParam0 /*22*/])) && !unk_0x21D2CF167438FDE0(Local_389[iParam0 /*22*/]))
		{
	...
	else if (!func_146(Local_389[iParam0 /*22*/], unk_0xC8B93D94F8954288(), 5.5f))
	{
		func_178(iParam0, 5);
		func_178(iParam0, 3);
	}
...
int func_181(int iParam0)
{
	...
	if (Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (unk_0xA0C23498D8E0BB93(unk_0xC8B93D94F8954288(), unk_0xCC31DB73C65552D8(Local_389[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, 0, 1, 0))
		{
			return 1;
		}
	}
...
{
	if (unk_0xA499226F64D3A26A(Local_389[iParam0 /*22*/], unk_0xC8B93D94F8954288()))
	{
		if (unk_0x770AAB67BDD9C729(Local_389[iParam0 /*22*/]))
		{
			*iParam1 = 1;
		}
		else
...
void func_183(int iParam0)
{
	...
	if (Local_389[iParam0 /*22*/].f_20 != 6 && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		...
		while (iVar0 <= 5)
		{
			if (Local_389[iParam0 /*22*/].f_16)
			{
				if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 12))
				{
					if (unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), Local_309[iVar0 /*7*/], Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, 1, 0))
					{
						iLocal_382 = 1;
						iLocal_381 = unk_0x693EBB4F13506457();
						if (iVar0 == 4)
			...
			else if (!unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), Local_309[iVar0 /*7*/], Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, 1, 0) || unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 12))
			{
				func_184(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), Local_309[3 /*7*/], Local_309[3 /*7*/].f_3, Local_309[3 /*7*/].f_6, 0, 1, 0))
	{
		func_186(iParam0, 3);
	}
	else
	...
	switch (iParam1)
	{
		...
		case 4:
			if (!unk_0x277ECDA23D8CCEB4(unk_0xC8B93D94F8954288(), 0))
			{
				...
				if (func_7(iVar0))
				{
					if (func_185(unk_0x6D5BB810CC209E15(iVar0)))
					{
						bLocal_373 = true;
					}
					else
					...
					if (!unk_0x8DF850DA069BF37C(iVar0, Local_309[4 /*7*/], Local_309[4 /*7*/].f_3, Local_309[4 /*7*/].f_6, 0, 1, 0))
					{
						func_178(iParam0, 8);
						func_178(iParam0, 7);
					}
					else if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 7))
					{
						func_179(iParam0, 7);
					}
				}
...
void func_186(int iParam0, int iParam1)
{
	...
	{
		case 1:
			if ((!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 6) && !unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 1)) && !unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 9))
			{
				if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 10))
				{
					func_179(iParam0, 10);
				}
			}
		...
		case 2:
			if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 1))
			{
				if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 6))
				{
					func_179(iParam0, 6);
				}
			}
		...
		case 3:
			if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 14))
			{
				func_179(iParam0, 14);
			}
			break;
		...
		case 4:
			if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 8))
			{
				...
				{
					unk_0x59A0729D503ED758(&(Local_389[iParam0 /*22*/].f_15), 9);
					func_179(iParam0, 8);
				}
				else
				{
					unk_0x77621132305B133B(&(Local_389[iParam0 /*22*/].f_15), 9);
					func_179(iParam0, 8);
				}
			}
			break;
		...
		case 5:
			if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 4))
			{
				if ((!unk_0x3DFC8C2B3444478A(Local_389[iParam0 /*22*/]) && !unk_0x64A71C92E3B69E73(Local_389[iParam0 /*22*/])) && !unk_0x21D2CF167438FDE0(Local_389[iParam0 /*22*/]))
				{
					func_179(iParam0, 4);
...
{
	if (func_146(unk_0xC8B93D94F8954288(), Local_389[iParam0 /*22*/], 30f))
	{
		if (func_150(Local_389[iParam0 /*22*/], unk_0xC8B93D94F8954288(), 140f, 1, 250, 7))
		{
...
void func_188(int iParam0)
{
	...
	if (unk_0x6B4865E08E90ACC5(iParam0->f_1))
	{
		unk_0x5356E82C1E5E0C44(&(iParam0->f_1));
		bVar0 = true;
	}
	if (unk_0x95CCECA3948CFE7B(iParam0->f_7))
	{
		if (!unk_0x2DC9BA2299B45EA6(iParam0->f_7))
		{
			if (unk_0x4E12F93E42909E85(iParam0->f_7))
			{
				unk_0xA474BF93C34BB50D(iParam0->f_7, 0);
			}
		}
		bVar0 = true;
	}
...
int func_189(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8)
{
	if (iParam3 == 0)
	{
...
void func_190()
{
	...
	while (iVar0 <= 1)
	{
		...
		{
			if (unk_0x95CCECA3948CFE7B(Local_389[iVar0 /*22*/]))
			{
				if (func_7(unk_0x974516F979AD07BC()))
				{
					if (unk_0x87D4C731B013290A(Local_389[iVar0 /*22*/], unk_0x974516F979AD07BC(), 1))
					{
						unk_0x0CBE045BBBA5CFDE(Local_389[iVar0 /*22*/]);
						func_123();
					}
...
void func_191(int iParam0)
{
	...
	switch (Local_389[iParam0 /*22*/].f_19)
	{
		case 1:
			if (unk_0x693EBB4F13506457() - Local_389[iParam0 /*22*/].f_14) > unk_0x531444754C426278(2500, 3000)
			{
				if (unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
				{
					func_125(iParam0);
					func_123();
					return;
				...
				{
					if ((unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 13) && (unk_0x693EBB4F13506457() - iLocal_376) > 2500) && !iLocal_661)
					{
						if (iParam0 == 0)
						{
							sVar0 = "PRA_COPST1";
						...
						func_119(&uLocal_483, cLocal_482, sVar0, 7, 0, 0);
						unk_0x77621132305B133B(&(Local_389[iParam0 /*22*/].f_15), 13);
						unk_0x77621132305B133B(&(Local_389[func_143(iParam0) /*22*/].f_15), 13);
						iLocal_661 = 1;
					}
					Local_389[iParam0 /*22*/].f_17 = 1;
				}
		...
		case 2:
			if (unk_0x693EBB4F13506457() - Local_389[iParam0 /*22*/].f_14) > unk_0x531444754C426278(1500, 2000)
			{
				if (func_122(iParam0, 12))
				{
					func_132(iParam0);
		...
		case 5:
			if (unk_0x693EBB4F13506457() - Local_389[iParam0 /*22*/].f_14) > unk_0x531444754C426278(2500, 3000)
			{
				if (!func_146(Local_389[iParam0 /*22*/], unk_0xC8B93D94F8954288(), 1.5f))
				{
					unk_0x77621132305B133B(&(Local_389[iParam0 /*22*/].f_15), 5);
				}
				if (func_122(iParam0, 12))
				{
					func_132(iParam0);
		...
		case 7:
			if (unk_0x693EBB4F13506457() - Local_389[iParam0 /*22*/].f_14) > unk_0x531444754C426278(2500, 3000)
			{
				fVar1 = unk_0x63B860B4D08A206F(unk_0xA34E7C2A5118D638());
				if (((fVar1 < 12f && !Local_389[iParam0 /*22*/].f_16) && !unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 10)) && !func_76(Local_389[iParam0 /*22*/], -875674219))
				{
					unk_0x77621132305B133B(&(Local_389[iParam0 /*22*/].f_15), 11);
				}
				if (func_122(iParam0, 12))
				{
					func_132(iParam0);
...
void func_193(int iParam0)
{
	...
	if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 1))
	{
		...
		{
			if (!bLocal_372 && func_61(Local_389[iParam0 /*22*/], Local_389[iParam0 /*22*/].f_1, 6f))
			{
				func_195(iParam0);
			}
			func_180(iParam0);
...
void func_194(int iParam0)
{
	...
	if (!iLocal_661)
	{
		bVar0 = unk_0x271A74D807F62BC0(unk_0xC8B93D94F8954288());
		if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 13))
		{
			if (unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 10))
			{
				if (Local_389[iParam0 /*22*/].f_16)
		...
		else if (func_131(iParam0))
		{
			if (bVar0)
			{
				if (!func_146(unk_0xC8B93D94F8954288(), Local_389[iParam0 /*22*/], 10f))
				{
					if (!unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 10) && !unk_0xDCC86F723E82125E(Local_389[iParam0 /*22*/].f_15, 6))
					{
						unk_0x77621132305B133B(&(Local_389[iParam0 /*22*/].f_15), 13);
					}
				}
...
void func_195(int iParam0)
{
	...
	bVar0 = unk_0x74BBB84E37C71AAC(unk_0xC8B93D94F8954288(), 4);
	if (Local_389[iParam0 /*22*/].f_20 != 6 && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (func_146(unk_0xC8B93D94F8954288(), Local_389[iParam0 /*22*/], 12f))
		{
			if (bVar0)
			{
				if (Local_389[iParam0 /*22*/].f_16)
...
void func_196(int iParam0)
{
	if (!func_166(iParam0))
	{
		...
		else if (func_147(Local_389[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || unk_0xDF87568D121A99AC(-1, unk_0x44C17CCB85A88A1F(Local_389[iParam0 /*22*/], 1), 100f))
		{
			func_123();
		}
...
int func_197(int iParam0)
{
	...
	if (func_365(Local_389[iParam0 /*22*/]))
	{
		...
		if (unk_0x5534579797ACFD77(unk_0xC8B93D94F8954288(), Local_389[iParam0 /*22*/], fVar0, fVar0, fVar0, 0, 1, 0))
		{
			if (unk_0xFEDC9F0F78A56158(unk_0xA34E7C2A5118D638(), Local_389[iParam0 /*22*/]) || unk_0x0BBFEAC55291063A(unk_0xA34E7C2A5118D638(), Local_389[iParam0 /*22*/]))
			{
				if (Local_389[iParam0 /*22*/].f_16)
				{
					return 1;
...
void func_198()
{
	...
	{
		if ((((func_365(Local_389[0 /*22*/]) && func_365(Local_389[1 /*22*/])) && func_12(&uLocal_92, unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1))) && func_61(Local_389[0 /*22*/], Local_389[0 /*22*/].f_1, 3f)) && func_61(Local_389[1 /*22*/], Local_389[1 /*22*/].f_1, 3f))
		{
			if ((func_122(0, 15) && func_122(1, 15)) && !iLocal_648[iLocal_657])
			{
				if (func_199(0, &(iLocal_648[iLocal_657]), sLocal_652[iLocal_657], 10f, 4))
				{
					iLocal_657++;
					if (iLocal_657 == 2)
					{
		...
		else if ((func_365(Local_389[2 /*22*/]) && func_12(&uLocal_144, unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1))) && func_61(Local_389[2 /*22*/], Local_389[2 /*22*/].f_1, 3f))
		{
			if (!unk_0xDCC86F723E82125E(Local_389[2 /*22*/].f_15, 2) && !unk_0xDCC86F723E82125E(Local_389[2 /*22*/].f_15, 4))
			{
				if (func_199(0, &(iLocal_648[2]), "PRA_COPTLK3", 10f, 4))
				{
					iLocal_656 = 1;
				}
			}
		}
		else if (iLocal_656 && func_101())
		{
			func_51();
			iLocal_656 = 0;
		}
...
bool func_199(int iParam0, var uParam1, char* sParam2, float fParam3, int iParam4)
{
	if (!*uParam1)
	{
		if (!func_101() && unk_0xB66DD474AA9E764E())
		{
			if (func_129(iParam0, fParam3) && !func_64("PR_TAKBACK", 0, 0))
			{
				*uParam1 = func_200(&uLocal_483, cLocal_482, sParam2, iParam4, 0, 0, 0);
			}
		}
	}
...
void func_202()
{
	...
	switch (iLocal_81)
	{
		case 0:
			...
			{
				func_77(&iLocal_356, Local_456.f_0, 1);
				func_65("PR_GOVEH", &iLocal_355);
				unk_0x233432976E597324("FHPRA_START");
				if (unk_0x42277337DA18A497(Global_34823[13 /*31*/]))
				{
					unk_0x41E7A00C38FD122C(Global_34823[13 /*31*/], 1);
				}
				iLocal_678 = 0;
				unk_0xD810132681A9B83C(2f, 10f, 4);
				iLocal_81 = 1;
			}
			break;
		...
		case 1:
			if (unk_0x6338DEFCA89B8CD6(unk_0xA34E7C2A5118D638()) < 3)
			{
				if (func_365(Local_389[2 /*22*/]))
				{
					...
					{
						if (unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), 371.9393f, -1604.252f, 45.603f, 399.8371f, -1627.065f, 31.75287f, 32.73f, 0, 1, 2) || unk_0x1E8D3FA42E89ED72(unk_0xC8B93D94F8954288()))
						{
							unk_0xB47D5A4E4AE9BEAD(unk_0xA34E7C2A5118D638(), 3, 0);
							unk_0x1C9B7C3360143C4C(unk_0xA34E7C2A5118D638(), 0);
						}
					}
				}
			}
			if ((unk_0x56A705EEDF9090AD(unk_0xC8B93D94F8954288()) && iLocal_678 == 0) && func_130(Local_456.f_0, unk_0xC8B93D94F8954288(), 1) < 100f)
			{
				unk_0xD810132681A9B83C(7f, 7f, 4);
				iLocal_678 = 1;
			}
			if (func_7(Local_456.f_0))
			{
				...
				{
					unk_0xD810132681A9B83C(10f, 6f, 4);
					iLocal_81 = 2;
				}
				if (bLocal_374)
				{
...
void func_203()
{
	...
	{
		case 0:
			if (func_69(iLocal_80, 0))
			{
				func_349(78);
				unk_0x60B57BC5E51D2074(1);
				unk_0xFD62177C7242216E(0.5f);
				unk_0x425A7D451DB73551(369.0115f, -1609.116f, 28.2928f, 5f, 0);
				unk_0x425A7D451DB73551(Local_389[0 /*22*/].f_1, 5f, 0);
				if (func_261(unk_0xC8B93D94F8954288(), 12, 4) || func_261(unk_0xC8B93D94F8954288(), 12, 3))
				{
					bLocal_372 = true;
				}
				func_215();
...
void func_215()
{
	...
	if (unk_0x95CCECA3948CFE7B(iVar0))
	{
		if (unk_0x5D42322C7DB888D0(iVar0, 0))
		{
			func_216(iVar0, unk_0x44C17CCB85A88A1F(iVar0, 1), unk_0x59DD203239FBDCAD(iVar0), 24, 0);
		}
	}
}
...
void func_216(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6)
{
	...
	if (unk_0x95CCECA3948CFE7B(iParam0) && unk_0x5D42322C7DB888D0(iParam0, 0))
	{
		...
		func_249(iParam5, &Var0, Param1, uParam4, func_255(iParam0));
...
void func_217(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_246(&(Global_68186.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (unk_0x95CCECA3948CFE7B(iParam1))
	{
		if (unk_0x5D42322C7DB888D0(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_100976.f_18751.f_4801 = func_235();
			}
...
void func_218(int iParam0, int iParam1)
{
	...
	func_256(iParam0, &(Global_100976.f_18751.f_5510));
}

int func_219(int iParam0)
{
	if ((((((((((!unk_0x95CCECA3948CFE7B(iParam0) || !unk_0x5D42322C7DB888D0(iParam0, 0)) || func_232(iParam0, 0, 0)) || func_232(iParam0, 1, 0)) || func_232(iParam0, 2, 0)) || func_255(iParam0) != 145) || func_231(iParam0)) || func_230(iParam0)) || func_229(iParam0)) || func_228(iParam0)) || !func_220(unk_0x6D5BB810CC209E15(iParam0)))
	{
		if (func_230(iParam0))
		{
		}
...
int func_221(int iParam0, bool bParam1)
{
	...
	{
		if ((((!func_226() && !func_225()) && !func_224()) && !func_223()) && !func_227())
		{
			return 0;
		}
	}
...
int func_232(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_233(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_233(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
var func_235()
{
	...
	func_245(&uVar0, unk_0x4C374828FD653ECC());
	func_244(&uVar0, unk_0x44AD07D9D178F321());
	func_243(&uVar0, unk_0x342FDFC48311CCCE());
	func_238(&uVar0, unk_0x818078CDB71D3E9C());
	func_237(&uVar0, unk_0x49D01BEA8D03E892());
	func_236(&uVar0, unk_0x90D477BB666B03DB());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_241(unk_0xDCC86F723E82125E(iParam0, 31), -1, 1)) + 2011;
}
...
int func_246(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0xDCC86F723E82125E(uParam0->f_9, 10))
	{
		...
		if (!func_11(Global_100976.f_18751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_11(Global_100976.f_1770.f_539.f_2816[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_11(Global_100976.f_1770.f_539.f_2816[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_249(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6)
{
	if (func_246(&(Global_68186.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_254(iParam0);
			func_253(uParam1, &(Global_100976.f_18751.f_69[Global_68186.f_555[0 /*21*/].f_14 /*78*/]));
	...
	if (unk_0x5D42322C7DB888D0(iParam0, 0))
	{
		...
		*uParam1 = unk_0x65979062393E9301(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x59A0729D503ED758(&(uParam1->f_77), func_257(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_261(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = unk_0x6D5BB810CC209E15(iParam0);
	Global_69178[1 /*14*/] = { func_281(iVar0, iParam1, iParam2) };
	...
	if (iParam1 == 12)
	{
		uVar5 = { func_277(iVar0, iParam2) };
		iVar2 = 0;
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_261(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar21 = { func_273(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_261(iParam0, 14, uVar21[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									Global_69178[2 /*14*/] = { func_281(iVar0, 14, iVar4) };
									if (Global_69178[2 /*14*/].f_12 == iVar3)
									{
										if (func_261(iParam0, 14, iVar4))
										{
											if (!func_265(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_69178[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					{
						iVar1 = func_263(iParam0, iVar2);
						Global_69178[2 /*14*/] = { func_281(iVar0, iVar2, iVar1) };
						if (!func_265(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_69178[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	{
		uVar32 = { func_273(iVar0, iParam2) };
		iVar31 = 0;
		while (iVar31 <= 8)
		{
			if (!func_261(iParam0, 14, uVar32[iVar31]))
			{
				return 0;
			}
			iVar31++;
	...
	else if (Global_69178[1 /*14*/].f_3 == unk_0x3A59BCC40A12FD28(iParam0, func_262(iParam1)) && Global_69178[1 /*14*/].f_4 == unk_0x268F3DC177BF5D38(iParam0, func_262(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_263(int iParam0, int iParam1)
{
	...
	return func_264(iParam0, iVar1, iVar2, iParam1);
}
...
int func_265(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	var uVar0;
	int iVar10;
	...
	if (iParam2 == 14)
	{
		uVar0 = { func_273(iParam0, (*uParam4)[13]) };
		iVar10 = 0;
		while (iVar10 <= 8)
		{
	...
	if (iParam0 == joaat("player_zero"))
	{
		...
		else if (func_270(iParam0, iParam2, iParam3))
		{
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (unk_0xED5E7EEE0DB220EF(func_267(iParam0, iParam2, 14, 3), joaat("HAT"), 1) || unk_0xED5E7EEE0DB220EF(func_267(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (unk_0xED5E7EEE0DB220EF(func_267(iParam0, iParam2, 1, 3), joaat("HAT"), 0) || unk_0xED5E7EEE0DB220EF(func_267(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (unk_0xED5E7EEE0DB220EF(func_267(iParam0, iParam2, 14, 4), joaat("HAT"), 1) || unk_0xED5E7EEE0DB220EF(func_267(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (unk_0xED5E7EEE0DB220EF(func_267(iParam0, iParam2, 1, 4), joaat("HAT"), 0) || unk_0xED5E7EEE0DB220EF(func_267(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_267(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam2 == 14)
	{
		...
		iVar18 = 0;
		iVar19 = (iParam1 - func_269(iParam0));
		if (iVar19 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar39 = 0;
		iVar40 = (iParam1 - func_268(iParam0, func_262(iParam2)));
		if (iVar40 < 0)
		{
			return -1;
		}
		iVar41 = unk_0xC9E3A692557F7FB1(iParam3, 6, -1, 0, -1, func_262(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	else if (iParam0 == joaat("mp_m_freemode_01"))
	{
		if (iParam1 == 1)
		{
			if (iParam2 > 0)
			{
				if (iParam2 >= 26)
				{
					uVar0 = func_267(iParam0, iParam2, 1, 3);
	...
	else if (iParam0 == joaat("mp_f_freemode_01"))
	{
		if (iParam1 == 1)
		{
			if (iParam2 > 0)
			{
				if (iParam2 >= 26)
				{
					uVar1 = func_267(iParam0, iParam2, 1, 4);
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return unk_0xED5E7EEE0DB220EF(func_267(iParam0, iParam2, 14, 3), joaat("GLASSES"), 1);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return unk_0xED5E7EEE0DB220EF(func_267(iParam0, iParam2, 14, 4), joaat("GLASSES"), 1);
				}
			}
			break;
	}
...
struct<10> func_273(int iParam0, int iParam1)
{
	int iVar0;
	struct<10> Var1;
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			{
				case 31:
					func_276(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 0:
					func_276(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_276(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_276(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 3:
					func_276(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_276(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_276(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_276(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_276(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_276(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 9:
					func_276(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8);
					break;
				
				default:
					func_274(&Var1, iParam0, iParam1, 10);
					break;
			}
			break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 1:
					func_276(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_276(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 4:
					func_276(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_276(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_276(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_276(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_276(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				default:
					func_274(&Var1, iParam0, iParam1, 9);
					break;
			}
			break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 0:
					func_276(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_276(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 3:
					func_276(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_276(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_276(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_276(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_276(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_276(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				...
				case 0:
					func_276(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_276(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_276(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 3:
					func_276(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_276(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_276(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_276(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_276(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 8:
					func_276(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 9:
					func_276(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 10:
					func_276(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 12:
					func_276(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 13:
					func_276(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 14:
					func_276(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 15:
					func_276(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 16:
					func_276(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 17:
					func_276(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 18:
					func_276(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 19:
					func_276(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 20:
					func_276(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 21:
					func_276(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				default:
					func_274(&Var1, iParam0, iParam1, 25);
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				...
				case 0:
					func_276(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 1:
					func_276(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 2:
					func_276(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 3:
					func_276(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 4:
					func_276(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 5:
					func_276(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 6:
					func_276(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 7:
					func_276(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 9:
					func_276(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 10:
					func_276(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 11:
					func_276(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 12:
					func_276(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 13:
					func_276(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8);
					break;
				
				case 14:
					func_276(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 16:
					func_276(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 17:
					func_276(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 18:
					func_276(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 19:
					func_276(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 20:
					func_276(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 21:
					func_276(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 22:
					func_276(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8);
					break;
				
				case 23:
					func_276(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8);
					break;
		...
		if (!unk_0x06C32703437E5BC3(Var1.f_0))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (unk_0x6EA8C608EE7829A3(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_275(iParam1, Var16.f_0, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
...
int func_275(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam2 == 14)
	{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!unk_0x06C32703437E5BC3(Var0.f_0))
			{
				if (iParam1 == Var0.f_1)
				{
					return (func_269(iParam0) + iVar18);
				}
				iVar18++;
			}
			iVar17++;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = unk_0xC9E3A692557F7FB1(iParam3, 6, -1, 0, -1, func_262(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			if (!unk_0x06C32703437E5BC3(Var20.f_0))
			{
				...
				{
					return (func_268(iParam0, func_262(iParam2)) + iVar38);
				}
				iVar38++;
			}
			iVar37++;
...
void func_276(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<16> func_277(int iParam0, int iParam1)
{
	int iVar0;
	struct<16> Var1;
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				case 0:
					...
					{
						func_280(&Var1, -99, -99, 1, 1, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					}
					else
					{
						func_280(&Var1, -99, -99, 0, 0, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					}
					break;
				
				case 1:
					func_280(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0);
					break;
				
				case 2:
					func_280(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8);
					break;
				
				case 3:
					func_280(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31);
					break;
				
				case 4:
					func_280(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2);
					break;
				
				case 5:
					func_280(&Var1, -99, -99, Global_100976.f_1770.f_539.f_196[0], Global_100976.f_1770.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				
				case 6:
					func_280(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 7:
					func_280(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 8:
					func_280(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 9:
					func_280(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 10:
					func_280(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4);
					break;
				
				case 11:
					func_280(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5);
					break;
				
				case 12:
					func_280(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31);
					break;
				
				case 13:
					func_280(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 14:
					func_280(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6);
					break;
				
				case 15:
					func_280(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31);
					break;
				
				case 16:
					func_280(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31);
					break;
				
				case 17:
					func_280(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 18:
					func_280(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7);
					break;
				
				case 19:
					func_280(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 20:
					func_280(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 21:
					func_280(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 22:
					func_280(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 23:
					func_280(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 24:
					func_280(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31);
					break;
				
				case 25:
					func_280(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 26:
					func_280(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 27:
					func_280(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 28:
					func_280(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				
				case 29:
					func_280(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 30:
					func_280(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 31:
					func_280(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31);
					break;
				
				case 32:
					func_280(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 33:
					func_280(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 34:
					func_280(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31);
					break;
				
				case 35:
					func_280(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 36:
					func_280(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 37:
					func_280(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 38:
					func_280(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 39:
					func_280(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 40:
					func_280(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 41:
					func_280(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 42:
					func_280(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 43:
					func_280(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 44:
					func_280(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 45:
					func_280(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 46:
					func_280(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 47:
					func_280(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 48:
					func_280(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 49:
					func_280(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 50:
					func_280(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9);
					break;
				
				case 51:
					func_280(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 52:
					func_280(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				default:
					func_278(&Var1, iParam0, iParam1, 53);
					break;
			}
			break;
		...
		case joaat("player_one"):
			...
			{
				case 0:
					func_280(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 1:
					func_280(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
				
				case 2:
					func_280(&Var1, -99, -99, Global_100976.f_1770.f_539.f_196[1], Global_100976.f_1770.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				
				case 3:
					func_280(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1);
					break;
				
				case 4:
					func_280(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2);
					break;
				
				case 5:
					func_280(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 6:
					func_280(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 7:
					func_280(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3);
					break;
				
				case 8:
					func_280(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5);
					break;
				
				case 9:
					func_280(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 10:
					func_280(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 11:
					func_280(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
				
				case 12:
					func_280(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 13:
					func_280(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 14:
					func_280(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 15:
					func_280(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 16:
					func_280(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 17:
					func_280(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 18:
					func_280(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31);
					break;
				
				case 19:
					func_280(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 20:
					func_280(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 21:
					func_280(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4);
					break;
				
				case 22:
					func_280(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31);
					break;
				
				case 23:
					func_280(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31);
					break;
				
				case 24:
					func_280(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31);
					break;
				
				case 25:
					func_280(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31);
					break;
				
				case 26:
					func_280(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31);
					break;
				
				case 27:
					func_280(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31);
					break;
				
				case 28:
					func_280(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31);
					break;
				
				case 29:
					func_280(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31);
					break;
				
				case 30:
					func_280(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31);
					break;
				
				case 31:
					func_280(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31);
					break;
				
				case 32:
					func_280(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31);
					break;
				
				case 33:
					func_280(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31);
					break;
				
				case 34:
					func_280(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31);
					break;
				
				case 35:
					func_280(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31);
					break;
				
				case 36:
					func_280(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31);
					break;
				
				case 37:
					func_280(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31);
					break;
				
				case 38:
					func_280(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 39:
					func_280(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 40:
					func_280(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 41:
					func_280(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 42:
					func_280(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31);
					break;
				
				case 43:
					func_280(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6);
					break;
				
				case 44:
					func_280(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
				
				case 45:
					func_280(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8);
					break;
				
				case 46:
					func_280(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31);
					break;
				
				default:
					func_278(&Var1, iParam0, iParam1, 47);
					break;
			}
			break;
		...
		case joaat("player_two"):
			...
			{
				case 0:
					func_280(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 1:
					func_280(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8);
					break;
				
				case 2:
					func_280(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1);
					break;
				
				case 3:
					func_280(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2);
					break;
				
				case 4:
					func_280(&Var1, -99, -99, Global_100976.f_1770.f_539.f_196[2], Global_100976.f_1770.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 5:
					func_280(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6);
					break;
				
				case 6:
					func_280(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3);
					break;
				
				case 7:
					func_280(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4);
					break;
				
				case 8:
					func_280(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31);
					break;
				
				case 9:
					func_280(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 10:
					func_280(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 11:
					func_280(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5);
					break;
				
				case 12:
					func_280(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				
				case 13:
					func_280(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 14:
					func_280(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31);
					break;
				
				case 15:
					func_280(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 16:
					func_280(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 17:
					func_280(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 18:
					func_280(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 19:
					func_280(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 20:
					func_280(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 21:
					func_280(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 22:
					func_280(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 23:
					func_280(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 24:
					func_280(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 25:
					func_280(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 26:
					func_280(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 27:
					func_280(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 28:
					func_280(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 29:
					func_280(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 30:
					func_280(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 31:
					func_280(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 32:
					func_280(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 33:
					func_280(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 34:
					func_280(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 35:
					func_280(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 36:
					func_280(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 37:
					func_280(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 38:
					func_280(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 39:
					func_280(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 40:
					func_280(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 41:
					func_280(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 42:
					func_280(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 43:
					func_280(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 44:
					func_280(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				case 45:
					func_280(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
				
				case 46:
					func_280(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				
				case 47:
					func_280(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
				
				default:
					func_278(&Var1, iParam0, iParam1, 48);
					break;
			}
			break;
		...
		case joaat("mp_m_freemode_01"):
			...
			{
				case 0:
					func_280(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31);
					break;
				
				case 1:
					func_280(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0);
					break;
				
				case 2:
					func_280(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1);
					break;
				
				case 3:
					func_280(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2);
					break;
				
				case 4:
					func_280(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3);
					break;
				
				case 5:
					func_280(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4);
					break;
				
				case 6:
					func_280(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5);
					break;
				
				case 7:
					func_280(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6);
					break;
				
				case 8:
					func_280(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7);
					break;
				
				case 9:
					func_280(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8);
					break;
				
				case 10:
					func_280(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9);
					break;
				
				case 11:
					func_280(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10);
					break;
				
				case 12:
					func_280(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11);
					break;
				
				case 13:
					func_280(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12);
					break;
				
				case 14:
					func_280(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13);
					break;
				
				case 15:
					func_280(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14);
					break;
				
				case 16:
					func_280(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15);
					break;
				
				case 17:
					func_280(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16);
					break;
				
				case 18:
					func_280(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17);
					break;
				
				case 19:
					func_280(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18);
					break;
				
				case 20:
					func_280(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19);
					break;
				
				case 21:
					func_280(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20);
					break;
				
				case 22:
					func_280(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21);
					break;
				
				case 23:
					func_280(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22);
					break;
				
				case 24:
					func_280(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23);
					break;
				
				case 25:
					func_280(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24);
					break;
				
				default:
					func_278(&Var1, iParam0, iParam1, 26);
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			...
			{
				case 0:
					func_280(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31);
					break;
				
				case 1:
					func_280(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31);
					break;
				
				case 2:
					func_280(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0);
					break;
				
				case 3:
					func_280(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1);
					break;
				
				case 4:
					func_280(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2);
					break;
				
				case 5:
					func_280(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3);
					break;
				
				case 6:
					func_280(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4);
					break;
				
				case 7:
					func_280(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5);
					break;
				
				case 8:
					func_280(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6);
					break;
				
				case 9:
					func_280(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7);
					break;
				
				case 10:
					func_280(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8);
					break;
				
				case 11:
					func_280(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9);
					break;
				
				case 12:
					func_280(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10);
					break;
				
				case 13:
					func_280(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31);
					break;
				
				case 14:
					func_280(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11);
					break;
				
				case 15:
					func_280(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12);
					break;
				
				case 16:
					func_280(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13);
					break;
				
				case 17:
					func_280(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14);
					break;
				
				case 18:
					func_280(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15);
					break;
				
				case 19:
					func_280(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16);
					break;
				
				case 20:
					func_280(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17);
					break;
				
				case 21:
					func_280(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31);
					break;
				
				case 22:
					func_280(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18);
					break;
				
				case 23:
					func_280(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19);
					break;
				
				case 24:
					func_280(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20);
					break;
				
				case 25:
					func_280(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21);
					break;
				
				case 26:
					func_280(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22);
					break;
				
				case 27:
					func_280(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23);
					break;
				
				default:
					func_278(&Var1, iParam0, iParam1, 28);
					break;
			}
			break;
	}
		...
		while (iVar19 < Var1.f_4)
		{
			if (unk_0x4CACF88CE190EAAD(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_279(Var16.f_2)] = Var16.f_0;
					}
					else
					{
						(*iParam0)[func_279(Var16.f_2)] = func_275(iParam1, Var16.f_0, func_279(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*iParam0)[func_279(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar19++;
		}
...
void func_280(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[2] = iParam2;
	(*iParam0)[3] = iParam3;
...
struct<14> func_281(int iParam0, int iParam1, int iParam2)
{
	func_348();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_283(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_294(iVar10, iParam0, 155);
			return;
			break;
	}
	func_284(&(Global_69178[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_284(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_287(func_289(iParam1, uParam0->f_2), Global_69176, 0);
			if (unk_0xDCC86F723E82125E(uVar0, uParam0->f_1))
			{
				unk_0x59A0729D503ED758(&(uParam0->f_6), 1);
			}
			iVar0 = func_287(func_286(iParam1, uParam0->f_2), Global_69176, 0);
			if (unk_0xDCC86F723E82125E(iVar0, uParam0->f_1))
			{
				unk_0x59A0729D503ED758(&(uParam0->f_6), 2);
			}
			if (func_285(iParam1, uParam0->f_2, &iVar1))
			{
				iVar0 = func_287(iVar1, Global_69176, 0);
				if (!unk_0xDCC86F723E82125E(iVar0, uParam0->f_1))
				{
					unk_0x59A0729D503ED758(&(uParam0->f_6), 4);
				}
...
int func_287(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2466774[iParam0 /*5*/][func_288(iParam1)];
...
int func_291(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_292(uParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
		uVar3 = func_287(iVar2, iVar0, 0);
		return unk_0xDCC86F723E82125E(uVar3, iVar1);
	}
	return 0;
}

bool func_292(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_294(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!unk_0x06C32703437E5BC3(Var2.f_0))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					func_284(&(Global_69178[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_284(&(Global_69178[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!unk_0x06C32703437E5BC3(Var20.f_0))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_284(&(Global_69178[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, unk_0xED5E7EEE0DB220EF(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = unk_0xC9E3A692557F7FB1(iVar1, 6, -1, 0, -1, func_262(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!unk_0x06C32703437E5BC3(Var41.f_0))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_284(&(Global_69178[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, unk_0xED5E7EEE0DB220EF(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_351()
{
	if (unk_0x0C570E251979C1C4(385.8528f, -1629.945f, 35.29278f, 398.8063f, -1640.865f, 28f))
	{
		unk_0x130F0C5AE7B52B7A(iLocal_369, 0, 1, 1);
	}
	else
	{
		unk_0x130F0C5AE7B52B7A(iLocal_369, 1, 1, 1);
	}
}
...
void func_352()
{
	if (bLocal_374)
	{
		if (unk_0x0C570E251979C1C4(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, 1, 0))
		{
			if (func_12(&uLocal_196, unk_0x44C17CCB85A88A1F(unk_0xC8B93D94F8954288(), 1)))
			{
				func_354(Global_34823[13 /*31*/], &fLocal_370);
				return;
			}
		}
		else
		{
			func_353(Global_34823[13 /*31*/], &fLocal_370);
		}
	}
	else if (unk_0xA16C4830554834C5(unk_0xC8B93D94F8954288()) || iLocal_82 == 1)
	{
		if (unk_0x8DF850DA069BF37C(unk_0xC8B93D94F8954288(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, 1, 0) || unk_0x0C570E251979C1C4(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
		{
			func_354(Global_34823[13 /*31*/], &fLocal_370);
		}
		else
	...
	else if (!unk_0x0C570E251979C1C4(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
	{
		func_353(Global_34823[13 /*31*/], &fLocal_370);
	}
	else
...
{
	if (unk_0x42277337DA18A497(iParam0))
	{
		if (*fParam1 != 0f)
		{
			if (!unk_0xDA33F6DC6574B8DD(uLocal_371))
			{
				uLocal_371 = unk_0xDC3487ADA3784C61(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_79(229.3746f), 0, 7);
			}
			unk_0xC0E67E73A6E9A0EE(iParam0, *fParam1, 1, 1);
			*fParam1 = (*fParam1 - (0.2f * unk_0x0000000050597EE2()));
			if (*fParam1 <= 0f)
			{
				unk_0x130F0C5AE7B52B7A(iParam0, 1, 1, 0);
				unk_0x78DFC4B56BCF3DA9(uLocal_371);
				*fParam1 = 0f;
			}
		}
	}
...
void func_354(int iParam0, float fParam1)
{
	if (*fParam1 != 1f)
	{
		unk_0xC0E67E73A6E9A0EE(uParam0, *fParam1, 1, 1);
		*fParam1 = (*fParam1 + (0.2f * unk_0x0000000050597EE2()));
		if (unk_0xDA33F6DC6574B8DD(uLocal_371))
		{
			unk_0x78DFC4B56BCF3DA9(uLocal_371);
...
void func_359()
{
	...
	{
		if (!func_61(unk_0xC8B93D94F8954288(), 372.0053f, -1604.076f, 36.7536f, 100f) && !bLocal_387)
		{
			func_361("PR_AREAWARN", &bLocal_387);
		}
		else if (!func_61(unk_0xC8B93D94F8954288(), 372.0053f, -1604.076f, 36.7536f, 170f) && bLocal_387)
		{
			func_360(3);
		}
	}
...
void func_361(char* sParam0, bool bParam1)
{
	if (!*bParam1)
	{
		func_57(sParam0, 7500, 0);
...
void func_362()
{
	...
	else
	{
		...
		if (iLocal_80 == 2 || iLocal_80 == 3)
		{
			if (!func_146(unk_0xC8B93D94F8954288(), Local_456.f_0, 50f) && !bLocal_388)
			{
				func_361("PR_VANWARN", &bLocal_388);
			}
			else if (!func_146(unk_0xC8B93D94F8954288(), Local_456.f_0, 100f) && bLocal_388)
			{
				func_360(4);
			}
		}
...
void func_363()
{
	if (unk_0xA4EFBED0A0F1C60C(Local_456.f_0))
	{
		if (iLocal_368)
		{
			if ((unk_0x693EBB4F13506457() - iLocal_367) > 5000)
			{
				func_360(2);
				return;
			}
		...
		{
			iLocal_367 = unk_0x693EBB4F13506457();
			iLocal_368 = 1;
		}
	}
	else
...
void func_366(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_367())
	{
...
void func_370()
{
	Local_309[1 /*7*/] = { func_371(359.5238f, -1581.445f, 28.29278f, 341.1343f, -1603.052f, 40.37049f, 7.3f) };
	Local_309[2 /*7*/] = { func_371(352.2312f, -1590.471f, 28.29277f, 341.1343f, -1603.052f, 40.37049f, 6.78f) };
	Local_309[0 /*7*/] = { func_371(344.5851f, -1601.562f, 28.29278f, 342.4275f, -1604.071f, 40.29278f, 3.79f) };
	Local_309[3 /*7*/] = { func_371(345.0102f, -1604.096f, 40.6735f, 361.0914f, -1617.46f, 28.29278f, 3.33f) };
	Local_309[4 /*7*/] = { func_371(362.7986f, -1577.081f, 28.29278f, 341.1343f, -1603.052f, 40.37049f, 6.78f) };
	Local_309[5 /*7*/] = { func_371(365.9773f, -1611.556f, 28.29277f, 373.1279f, -1617.806f, 40.37049f, 19.19f) };
}

struct<7> func_371(struct<3> Param0, struct<3> Param3, float fParam6)
{
	struct<7> Var0;
...
void func_373()
{
	...
	if (!unk_0x42277337DA18A497(iLocal_369))
	{
		unk_0xD4C94FD09D793556(iLocal_369, joaat("prop_fnclink_03gate5"), 391.8602f, -1636.07f, 29.9744f, 1, 1, 0);
	}
	unk_0x130F0C5AE7B52B7A(Global_34823[13 /*31*/], 1, 1, 0);
	unk_0x130F0C5AE7B52B7A(iLocal_369, 1, 1, 0);
}
...
void func_374()
{
	...
	func_378(&uLocal_196, &Var0, 4);
	func_377(&uLocal_248);
	func_376(&uLocal_248, 408.8245f, -1616.011f, 31.7537f);
	func_376(&uLocal_248, 376.3118f, -1588.036f, 36.7534f);
	func_376(&uLocal_248, 354.1272f, -1614.819f, 31.5335f);
	func_376(&uLocal_248, 387.2971f, -1641.943f, 31.833f);
	func_375(&uLocal_248);
}
...
void func_376(var uParam0, struct<3> Param1)
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_378(var uParam0, var uParam1, int iParam2)
{
	int iVar0;
	...
	{
		func_376(uParam0, *(uParam1[iVar0 /*3*/]));
		iVar0++;
	}
	func_375(uParam0);
}
...
void func_379()
{
	...
	Local_389[0 /*22*/] = { func_380(353.1191f, -1589.606f, 28.2928f, 270.0968f, iVar0) };
	Local_389[1 /*22*/] = { func_380(354.557f, -1590.549f, 28.2928f, 16.3702f, iVar0) };
	Local_389[2 /*22*/] = { func_380(369.8186f, -1611.029f, 28.3928f, 9.0837f, iVar0) };
	iVar1 = 0;
	while (iVar1 <= 2)
	{
		...
		while (iVar2 <= (15 - 1))
		{
			unk_0x77621132305B133B(&(Local_389[iVar1 /*22*/].f_15), iVar2);
			iVar2++;
		}
		iVar1++;
	}
...
struct<22> func_380(struct<3> Param0, float fParam3, int iParam4)
{
	struct<22> Var0;
...
void func_381()
{
	Local_456 = { func_382(372.9868f, -1623.531f, 28.2928f, 321.7075f, joaat("policet")) };
	Local_462[0 /*6*/] = { func_382(400.5771f, -1618.927f, 28.2928f, 48.8115f, joaat("police3")) };
	Local_462[1 /*6*/] = { func_382(396.6843f, -1623.222f, 28.2928f, 231.3392f, joaat("police3")) };
	Local_462[2 /*6*/] = { func_382(394.3527f, -1625.337f, 28.2928f, 49.3732f, joaat("police3")) };
}

struct<6> func_382(struct<3> Param0, float fParam3, int iParam4)
{
	struct<6> Var0;
...
void func_383()
{
	unk_0x4A606A8BE6924115("COPS", &uLocal_481);
}

void func_384()
{
	unk_0xC2389B725A8A1CD3(uLocal_481);
	func_395(1);
	if (unk_0x42277337DA18A497(Global_34823[13 /*31*/]))
	{
		unk_0x41E7A00C38FD122C(Global_34823[13 /*31*/], 0);
	}
	unk_0xC0E67E73A6E9A0EE(Global_34823[13 /*31*/], 0f, 1, 1);
	unk_0x130F0C5AE7B52B7A(Global_34823[13 /*31*/], 4, 1, 1);
	unk_0x130F0C5AE7B52B7A(iLocal_369, 0, 1, 0);
	unk_0xCF381AA7C0D65934(iLocal_369);
	unk_0x9DBF08025225340D(uLocal_360, 0);
	func_53();
	unk_0x60B57BC5E51D2074(5);
	unk_0xFD62177C7242216E(1f);
	func_394();
...
void func_385(bool bParam0)
{
	...
	if (bParam0)
	{
		if (unk_0x95CCECA3948CFE7B(Local_456.f_0))
		{
			if (unk_0x95CCECA3948CFE7B(unk_0xC8B93D94F8954288()))
			{
				if (!unk_0x2DC9BA2299B45EA6(unk_0xC8B93D94F8954288()))
	...
	if (unk_0x844838E5D8A21336(uLocal_359))
	{
		unk_0x2544549FDE4C3A7E(0, 0, 3000, 1, 0, 0);
		unk_0x5CF5A880ED809DDA(uLocal_359, 0);
	}
}
...
void func_391()
{
	...
	unk_0x4BBD72565A0AF033(Local_456.f_5);
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		unk_0x4BBD72565A0AF033(Local_462[iVar0 /*6*/].f_5);
		iVar0++;
	}
}
...
void func_393(bool bParam0, int iParam1, int iParam2)
{
	bool bVar0;
