...
void func_326(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xE5965CDF24F93A9F(Global_97311[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x15CAA6D7B11F1A7C(Global_97311[iVar0]) == func_320(iParam0, iParam1))
				{
...
int func_328(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_332(unk_0x15CAA6D7B11F1A7C(*iParam0), 1) && unk_0x0DD0BC46C4CFD6AD(*iParam0, 24) != func_331(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x0061B7C9351B41ED(*iParam0, 24, func_331(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_330(iParam0);
	if (func_329(*iParam0))
	{
...
void func_349(struct<3> Param0, float fParam3, int iParam4)
{
	int iVar0;
...
int func_364(var uParam0, int iParam1, struct<3> Param2, int iParam5, bool bParam6)
{
	int iVar0;
...
void func_367(int iParam0)
{
	...
	{
		func_369(unk_0xE2D3D51028F0428A(), 2);
	}
	iVar0 = 0;
	while (iVar0 < Local_755.f_0)
	{
...
void func_377(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_447(unk_0x05CBA41180F5D521(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
			Global_112922.f_9085.f_330[iVar1 /*6*/].f_1 = 0;
			uVar2 = func_445(iVar1);
		...
		{
			iVar5 = func_440(unk_0x05CBA41180F5D521(), 1);
			if (iVar5 != -1)
			{
...
{
	func_379(&Global_106470, unk_0x05CBA41180F5D521(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_379(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_48();
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		func_402(unk_0xE2D3D51028F0428A());
		func_395(unk_0xE2D3D51028F0428A(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_394())
		{
			func_388(unk_0xE2D3D51028F0428A(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
int func_389(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12581)
	{
		...
		uVar0 = Global_2822371[iParam0 /*3*/][func_390(iParam1)];
...
int func_391(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2860791[iParam0 /*3*/][func_390(iParam1)];
...
void func_396(int iParam0, var uParam1)
{
	...
	if (!unk_0xF68107C40359970C(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0xCB497F652ACB2DD3(iParam0, func_401(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((unk_0x75BACF95335672B8(iVar9, &Var11) && !func_398(Var11.f_1)) && iVar72 < 51)
			{
...
int func_406(var uParam0)
{
	if (!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (func_34())
		{
			*uParam0 = func_411(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 0), 6, -1, 0, 1, -1);
...
int func_411(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam3 == 6 || iParam3 == func_426(iVar0))
		{
			...
			{
				fVar1 = unk_0x987A5F1E1A67E3C0(Param0, func_412(iVar0, 0), 1);
...
int func_423()
{
	return func_424(unk_0x9E2D6C50374FCFA9());
}
...
var func_427()
{
	...
	func_437(&uVar0, unk_0xAA2844CAD88768B5());
	func_436(&uVar0, unk_0x80F97D7D29800A1A());
	func_435(&uVar0, unk_0x09FC827691DACE59());
	func_430(&uVar0, unk_0xD52BD97E61483713());
	func_429(&uVar0, unk_0x771485043FDC55DE());
	func_428(&uVar0, unk_0x1137FD08B8D3F874());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_433(BitTest(iParam0, 31), -1, 1)) + 2011;
}
