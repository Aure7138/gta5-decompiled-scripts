...
void func_1()
{
	...
	{
		case 0:
			if (((!unk_0xA929B2923D14E2F8(unk_0x17B5CC8A8615737D(), 0) && !unk_0xF4F87C6CDA931EF1()) && !func_8()) && !func_7())
			{
...
void func_11(char* sParam0, int iParam1)
{
	...
	{
		if (func_14(sParam0) && !unk_0x70F6041CE3E701CC())
		{
	...
	while (iVar0 < Global_101700.f_19369.f_145)
	{
		if (unk_0x6A7B0D91FD88D9EE(sParam0, &(Global_101700.f_19369[iVar0 /*16*/])))
		{
			...
			func_12((Global_101700.f_19369.f_145 - 1));
