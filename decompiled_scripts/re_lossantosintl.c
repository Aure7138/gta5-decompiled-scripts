	...
	switch (iLocal_83)
	{
		...
		case 2:
			...
			if (unk_0xAE06B9E39EBDE049(uLocal_54) && !unk_0xA59F96B50B97E63C(uLocal_54, 0))
			{
				if (!unk_0x3AF46A926C830E50(uLocal_54))
				{
					if ((unk_0x1D88F87079AF2FA7(uLocal_54) && !unk_0x9A70B1BD2A5BA09C(-1602.086f, -2674.039f, 12.9444f, 50f)) && unk_0xB7A628320EFF8E47(Var0, unk_0x3E4D3CCC220BDFB1(uLocal_54, 1)) > 62500f)
					{
						iLocal_83 = 1;
					}
				}
