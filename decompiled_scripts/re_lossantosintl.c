	...
	switch (iLocal_83)
	{
		...
		case 2:
			...
			if (unk_0x419E13582192CFEA(uLocal_54) && !unk_0xE50EB54E0F21BED0(uLocal_54, 0))
			{
				if (!unk_0xAB0BB1BDD76B67DC(uLocal_54))
				{
					if ((unk_0x98E18969B1D0C4AB(uLocal_54) && !unk_0x3D6C3476988DE6E1(-1602.086f, -2674.039f, 12.9444f, 50f)) && unk_0xB7A628320EFF8E47(Var0, unk_0xD6E677FAD7521410(uLocal_54, 1)) > 62500f)
					{
						iLocal_83 = 1;
					}
				}
