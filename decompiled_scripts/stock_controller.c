		...
		if (!Global_59104[iVar0 /*7*/])
		{
			if (Global_59104[iVar0 /*7*/].f_2)
			{
				...
				else
				{
					...
					Global_59104[iVar0 /*7*/].f_5 = unk_0xF34EE736CF047844(fVar1);
				}
			}
		}
		iVar0++;
	...
	if (fVar0 > 1f)
	{
		...
		if (((iVar5 + iVar6) + iVar7) > 0)
		{
			...
			while (iVar2 < 10)
			{
				...
				{
					iVar8 = (iVar8 + unk_0xF34EE736CF047844(Global_113648.f_20566.f_11[iVar2]));
				}
				if (Global_113648.f_20566.f_55[iVar2] > 0)
				{
					iVar8 = (iVar8 + unk_0xF34EE736CF047844(Global_113648.f_20566.f_44[iVar2]));
				}
				if (Global_113648.f_20566.f_88[iVar2] > 0)
				{
					iVar8 = (iVar8 + unk_0xF34EE736CF047844(Global_113648.f_20566.f_77[iVar2]));
				}
				iVar2++;
			}
			iVar9 = 700000000;
...
void func_80()
{
	...
	if (unk_0x7F420695E3F776FB(unk_0x56E414973C2A8C0E(unk_0xB6B621402486C3E4()), 0))
	{
		...
		if (func_81(iVar1, unk_0xED977E2AE2CB16EE(Local_27, Local_30, 0)))
		{
			Local_30 = { Local_27 };
		}
	}
