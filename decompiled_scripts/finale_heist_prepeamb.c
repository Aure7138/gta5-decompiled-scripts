...
void func_137()
{
	...
	func_144();
	func_109();
	if (func_76(unk_0x7D2B9E6A64637269(), Local_106, 150f) && !unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, 0, 1, 0))
	{
		unk_0xB7D390F8F682127B(Local_106, 6f, 0, 1, 0, 0, 0, 0);
		unk_0x86DA8A407ED8A381(-169.4253f, -622.0479f, 31.42444f, -162.2762f, -620.509f, 35.42448f, 0, 1);
	}
	if (!unk_0x234B68AC2E35ED5A(iLocal_105, 18))
	{
		if (!func_15(0) && !func_117())
		{
			func_143(sLocal_53[4], 7500, 0);
			unk_0x191DDA30577F440A(&iLocal_105, 18);
		}
	}
	if (unk_0x234B68AC2E35ED5A(iLocal_105, 0))
	{
		if (unk_0x234B68AC2E35ED5A(iLocal_105, 1))
		{
			...
			if (func_85(iLocal_109))
			{
				if (!unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_109, 0))
				{
					if (unk_0x8879B2803A5F8682(iLocal_109))
					{
						func_139();
						...
						unk_0x86DA8A407ED8A381(-169.4253f, -622.0479f, 31.42444f, -162.2762f, -620.509f, 35.42448f, 1, 1);
						func_78(4, 0);
					}
				}
			}
	...
	{
		unk_0xC664C0067EEAB8D1(&iLocal_105, 18);
		func_138(&uLocal_1439);
		unk_0x86DA8A407ED8A381(-169.4253f, -622.0479f, 31.42444f, -162.2762f, -620.509f, 35.42448f, 1, 1);
		func_78(0, 1);
	}
...
void func_144()
{
	...
	{
		case 0:
			if (((!unk_0x575B7C28D81C0B4D(uLocal_1438) && unk_0x234B68AC2E35ED5A(iLocal_105, 0)) && !unk_0x234B68AC2E35ED5A(iLocal_105, 1)) && unk_0x234B68AC2E35ED5A(iLocal_105, 18))
			{
	...
	if (func_103(35))
	{
		if (iLocal_38 == 0)
		{
			if (!unk_0x234B68AC2E35ED5A(iLocal_105, 1))
			{
				if (func_85(iLocal_109))
				{
					unk_0x591190E69BE43117(iLocal_109, Local_106, 4f, 4f, 2f, 1, 1, 0);
					if (unk_0x8954E9D0A9F6F8CF(iLocal_109, -168.8162f, -619.9002f, 31.42446f, -162.6423f, -622.0781f, 33.42446f, 4.14f, 0, 1, 0))
					{
						func_150(24, 46);
			...
			{
				if (!func_76(iLocal_109, Local_106, 10f) || unk_0x020175C59CBE79DB(iLocal_109))
				{
					unk_0xC664C0067EEAB8D1(&iLocal_105, 1);
				}
			}
							...
							if (func_85(iVar0))
							{
								if (!func_168(iVar0))
								{
									if (func_161(iVar0) && !func_160())
									{
										...
										{
											if (!unk_0x234B68AC2E35ED5A(iLocal_105, 19))
											{
												func_69(9);
												unk_0x191DDA30577F440A(&iLocal_105, 19);
											}
											else if (func_70(unk_0x7D2B9E6A64637269()) == 0)
											{
												func_69(17);
											}
											else
...
int func_172()
{
	...
	{
		iLocal_40 = 1;
		func_173(192, unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1));
		return 1;
	}
	return 0;
}
...
int func_177()
{
	...
	if (unk_0x1146A9AE09CE2B14() == func_180())
	{
		return 0;
	}
...
void func_190(int iParam0, var uParam1)
{
	...
	func_191(&uLocal_1273, Local_44.f_0, unk_0x7D2B9E6A64637269(), Local_44.f_1, 0, 1);
...
void func_209()
{
	...
	if (((((((Global_42009 == 15 && iLocal_37 != 3) && unk_0x234B68AC2E35ED5A(iLocal_105, 5)) && !func_169()) && Global_77245 == -1) && !func_219()) && !func_84(9)) || func_103(35))
	{
		func_218();
		func_217();
		switch (iLocal_39)
...
void func_211(int iParam0, bool bParam1)
{
	...
	{
		case 1:
			if ((!unk_0xE8FFE38E2BA32BD6() && !func_214(func_89())) && !func_213())
			{
...
int func_232(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x02BFF15CAA701972())
	{
		if (func_96() == 0)
		{
			return unk_0x234B68AC2E35ED5A(func_233(func_235(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
