...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if ((unk_0x320D1840B6DAA1CC() - iVar6) > 100)
		{
			if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				...
				{
					if (unk_0xB7A628320EFF8E47(Var0, unk_0x6B62510F212526DC(iLocal_79[iVar3], 0)) >= IntToFloat((iVar5 * iVar5)) && unk_0x4D21C9FB671ED18F(iLocal_79[iVar3]))
					{
				...
				else if (unk_0xE5965CDF24F93A9F(iLocal_79[iVar3]))
				{
					func_6(&(iLocal_79[iVar3]), 1, 0, 1);
				}
				if (func_3(iLocal_79.f_5[iVar4]))
				{
					...
					{
						if (unk_0x4D21C9FB671ED18F(iLocal_79.f_5[iVar4]) || unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_79.f_5[iVar4], 0))
						{
							func_2(&(iLocal_79.f_5[iVar4]));
						}
					}
				}
				else if (unk_0xE5965CDF24F93A9F(iLocal_79.f_5[iVar4]))
				{
					func_2(&(iLocal_79.f_5[iVar4]));
				}
				iVar3++;
...
int func_1()
{
	...
	{
		if (unk_0xE5965CDF24F93A9F(iLocal_79.f_5[iVar0]))
		{
			return 0;
		}
		iVar0++;
	...
	{
		if (unk_0xE5965CDF24F93A9F(iLocal_79[iVar0]))
		{
			return 0;
		}
		iVar0++;
...
int func_9()
{
	if (unk_0xB4C854DD86E40FDA(joaat("bailbond2")) == 0)
	{
		if (!func_17(4))
		{
			return 0;
...
void func_19()
{
	...
	unk_0xD642E010A287ADFD("ENEMIES", &iLocal_145);
	unk_0x9972EFADA7A2A47D(5, joaat("player"), iLocal_145);
	unk_0x9972EFADA7A2A47D(5, iLocal_145, joaat("player"));
	iVar0 = 0;
	while (iVar0 <= (iLocal_79.f_5 - 1))
	{
		if (func_3(iLocal_79.f_5[iVar0]))
		{
			unk_0x2D58A6131679D82C(iLocal_79.f_5[iVar0], 1, 1);
			Local_88[iVar0 /*3*/] = { unk_0x6B62510F212526DC(iLocal_79.f_5[iVar0], 0) };
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= (iLocal_79 - 1))
	{
		...
		{
			unk_0x2D58A6131679D82C(iLocal_79[iVar0], 1, 1);
			unk_0xFF4BEB6CFF55A013(iLocal_79[iVar0], iLocal_145);
...
void func_20()
{
	...
	unk_0x33B3A4723D5DBD35(5, joaat("player"), iLocal_145);
	unk_0x33B3A4723D5DBD35(5, iLocal_145, joaat("player"));
	iVar0 = 0;
	while (iVar0 <= (iLocal_79 - 1))
	{
