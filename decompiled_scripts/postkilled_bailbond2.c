...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if ((unk_0x1DD05E817C89C737() - iVar6) > 100)
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				{
					if (unk_0xB7A628320EFF8E47(Var0, unk_0xD1A6A821F5AC81DB(iLocal_79[iVar3], 0)) >= IntToFloat((iVar5 * iVar5)) && unk_0xF6C26AE940C14749(iLocal_79[iVar3]))
					{
				...
				else if (unk_0xFC8BFE4B41177C22(iLocal_79[iVar3]))
				{
					func_6(&(iLocal_79[iVar3]), 1, 0, 1);
				}
				if (func_3(iLocal_79.f_5[iVar4]))
				{
					...
					{
						if (unk_0xF6C26AE940C14749(iLocal_79.f_5[iVar4]) || unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), iLocal_79.f_5[iVar4], 0))
						{
							func_2(&(iLocal_79.f_5[iVar4]));
						}
					}
				}
				else if (unk_0xFC8BFE4B41177C22(iLocal_79.f_5[iVar4]))
				{
					func_2(&(iLocal_79.f_5[iVar4]));
				}
				iVar3++;
...
void func_19()
{
	...
	unk_0x06CD913C241C765E("ENEMIES", &iLocal_145);
	unk_0xD414C47AFF81382A(5, joaat("player"), iLocal_145);
	unk_0xD414C47AFF81382A(5, iLocal_145, joaat("player"));
	iVar0 = 0;
	while (iVar0 <= (iLocal_79.f_5 - 1))
	{
	...
	while (iVar0 <= (iLocal_79 - 1))
	{
		if (func_8(iLocal_79[iVar0]))
		{
			...
			unk_0x3CEA1FD137ACE2D9(iLocal_79[iVar0], iLocal_145);
...
void func_20()
{
	...
	unk_0x40D1AAC4EFD3C281(5, joaat("player"), iLocal_145);
	unk_0x40D1AAC4EFD3C281(5, iLocal_145, joaat("player"));
	iVar0 = 0;
	while (iVar0 <= (iLocal_79 - 1))
	{
