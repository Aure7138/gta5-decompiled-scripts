...
void __EntryFunction__()
{
	...
	if (unk_0x7B70881748D166CD(joaat("ambient_mrsphilips")) > 1)
	{
	...
	while (true)
	{
		...
		iVar0 = func_170();
		fVar1 = (unk_0x575382CC31BAB50D() + 5f);
		if (unk_0xB7A628320EFF8E47(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), 1973.324f, 3815.594f, 31.42936f) < (fVar1 * fVar1))
		{
	...
	while (iVar0 < 9)
	{
		if (unk_0xAE06B9E39EBDE049(Global_96286[iVar0]))
		{
			if (Global_96286[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0x36FE6D3220816ADA(iParam0) == func_35(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0x80FF6C016CDB0FAF(iParam0, 0))
	{
		...
		*uParam1 = unk_0x999BFF5D72C9701A(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xBE20AB8238688965(&(uParam1->f_77), func_39(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_59(int iParam0, bool bParam1)
{
	...
	iVar0 = func_46(iParam0);
	if (func_37(iVar0) && !unk_0x5AEB5DDFFAD43CA5(iParam0))
	{
		if (iParam0 == unk_0x9B0761B4C3EB8BC7())
		{
...
void func_108(char* sParam0, var uParam1, int iParam2)
{
	...
	unk_0x1FCF66376799FB94(sParam0, uParam1, iParam2, func_109(0));
}
...
void func_114()
{
	...
	func_115(36);
	unk_0xE81651AD79516E48(sVar0, 37500);
...
int func_142()
{
	return func_137(unk_0x6C5C6B207AA78253(), 0);
}
		...
		if (unk_0xAE06B9E39EBDE049(unk_0x9B0761B4C3EB8BC7()))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xD5EAF42B1EAE828F(unk_0x460153A63B9477BC(), 1) || func_156()) || Global_30970) || func_155()) || func_154(8, -1)) || func_152()) || func_94()) || func_153()) || func_151()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0xCED6B5226244381C(unk_0x9B0761B4C3EB8BC7()) || unk_0xEC787E1D3B804A72(unk_0x9B0761B4C3EB8BC7())) || unk_0xD5EAF42B1EAE828F(unk_0x460153A63B9477BC(), 1)) || unk_0xF83D0A2EC884A4DD(unk_0x9B0761B4C3EB8BC7(), 0)) || func_156()) || Global_110905) || Global_30970) || func_155()) || func_154(8, -1)) || func_94()) || func_153()) || func_151()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_156() || unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) > 0) || func_154(8, -1)) || func_151()) || func_150()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_157()
{
	...
	switch (iLocal_80)
	{
		...
		case 1:
			if (!func_162(25) && !unk_0x9CC4D06F5338CA6B())
			{
