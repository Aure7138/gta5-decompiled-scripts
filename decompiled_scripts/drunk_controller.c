...
void func_2()
{
	...
	if (Global_43747 > iVar1 || Global_43747 == -1)
	{
		...
		if (Global_43750 != Global_43751)
		{
			...
			if (unk_0x48053974ED6F63CE((Global_43750 - Global_43751)) < 0.01f)
			{
		...
		{
			unk_0x87CA6430083E790D("DRUNK_SHAKE", ((Global_43750 * fVar3) * fVar5));
		}
		if ((unk_0x320D1840B6DAA1CC() % 100) == 0)
		{
			...
			else
			{
				...
				unk_0x0ED8565383E33DA1(((Global_43750 * fVar3) * fVar5));
				unk_0xE776D70A603C3C81(((Global_43749 * fVar3) * fVar5));
				fLocal_26 = fVar3;
			}
		}
		if (((Global_43749 * fVar3) * fVar5) < 1f)
		{
			unk_0x97E56574A6AA6C7D(((Global_43749 * fVar3) * fVar5));
		}
		else
		{
		...
		{
			unk_0x3B58BE9E133FD48D("DRUNK_SHAKE", (((Global_43750 * Global_43744) * fVar3) * fVar5));
		}
		unk_0x86A2751C5F3AF8F8((((Global_43750 * Global_43744) * fVar3) * fVar5));
		if (unk_0x876B1078E90C91CB(Global_43746))
		{
			if (unk_0x629B37AF59212703(Global_43746))
			{
				unk_0x1342E9E0CDE9B323(Global_43746, ((Global_43750 * fVar3) * fVar5));
			}
		}
		if (!unk_0xACC32B78196FBC2A(&Global_43774) && !unk_0xACC32B78196FBC2A(&Global_43758))
		{
			unk_0x66B27A59829491D3(&Global_43758);
		...
		if (Global_43753 > 0f)
		{
			if (fLocal_16 != Global_43753)
			{
				...
				{
					unk_0x4ECB2825299DF02E(&Global_43754, 15f);
					fLocal_16 = Global_43753;
					if (Global_43752 != 1f)
					{
						unk_0xAC7136A72DE288C8(Global_43752);
					}
				}
			}
			else
			{
				...
				if (iVar7 <= (Global_43748 / 2) && Global_43747 != -1)
				{
					...
					else
					{
						...
						{
							unk_0xBBFAAE0F5C7709C5((unk_0xBBDA792448DB5A89((Global_43748 / 2)) / 1000f));
						}
						fLocal_16 = -99f;
						Global_43753 = 0f;
...
float func_14()
{
	...
	if (iVar2 <= Global_43748)
	{
		if (Global_43747 != -1)
		{
			fVar1 = (unk_0xBBDA792448DB5A89(iVar2) / unk_0xBBDA792448DB5A89(Global_43748));
		}
	}
	return fVar1;
}
...
void func_16(int iParam0)
{
	...
	if (unk_0x55B23FE400FCEA6B(Global_43540[iParam0 /*5*/].f_1, 0))
	{
		func_19(iParam0);
		return;
	}
