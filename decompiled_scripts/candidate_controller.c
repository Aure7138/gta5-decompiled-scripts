	...
	while (true)
	{
		if (Global_42596 != 15)
		{
			if (Global_42559 != 0)
			{
				if (Global_42558 != -1)
				{
					if (!unk_0x87C0DA419F19FF57(Global_42559))
					{
		...
		Global_31781 = unk_0x4BFEE961F7BC72B6();
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_7(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
