		...
		switch (iLocal_27)
		{
			...
			case 1:
				...
				while (iLocal_22 < Global_16941[1 /*42*/].f_32[1])
				{
					...
					{
						if (unk_0xDC5D81351D6A4DDB(uLocal_23[iLocal_22]))
						{
							if (unk_0x4915F4759304D5CF(uLocal_23[iLocal_22]))
							{
								if (unk_0xDEAEC99031DCB92A(uLocal_23[iLocal_22], unk_0xA19140A5C42D8715(), 1))
								{
									...
									if (unk_0x7112137033807390(uLocal_23[iLocal_22], 0))
									{
										if (!Global_25513[iLocal_22])
										{
											if (unk_0xEAB341EF962B57C6(uLocal_23[iLocal_22]) && func_1())
											{
