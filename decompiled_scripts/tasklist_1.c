		...
		switch (iLocal_27)
		{
			...
			case 1:
				...
				while (iLocal_22 < Global_22124[1 /*42*/].f_32[1])
				{
					...
					{
						if (unk_0xAE06B9E39EBDE049(uLocal_23[iLocal_22]))
						{
							if (unk_0x5AEB5DDFFAD43CA5(uLocal_23[iLocal_22]))
							{
								if (unk_0xCDF860E56BBCC6B4(uLocal_23[iLocal_22], unk_0x9B0761B4C3EB8BC7(), 1))
								{
									...
									if (unk_0xA59F96B50B97E63C(uLocal_23[iLocal_22], 0))
									{
										if (!Global_31022[iLocal_22])
										{
											if (unk_0x9D5618CE05635426(uLocal_23[iLocal_22]) && func_1())
											{
