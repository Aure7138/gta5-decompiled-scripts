...
void func_6()
{
	...
	{
		func_100(26.15189f, 560.6541f, 190.3232f, -14.36067f, 539.8602f, 170.3472f, 30f, 3.518f, 546.9235f, 173.7262f, 125.6127f, func_103(), 1, 1, 1, 0, 0);
	}
	else
	{
		func_87(26.15189f, 560.6541f, 190.3232f, -14.36067f, 539.8602f, 170.3472f, 30f, 9.039f, 554.2676f, 175.12f, 119.3638f, 1, 1, 1, 0, 0);
	}
	bVar1 = false;
	...
	while (unk_0xFD216000DC314A92() || !bVar1)
	{
		...
		if (!iLocal_28)
		{
			if ((unk_0x1DD05E817C89C737() - iLocal_29) > 92400)
			{
...
void func_9(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_85(iParam0) && unk_0xFC8BFE4B41177C22(*iParam1)) && unk_0xD9F5E1FEFD1329E4(*iParam1, 0))
	{
...
int func_14(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_47(iVar0, bParam1, uParam2) && !func_46(unk_0x259BE71D8A81D4FA())) && !func_27(iParam0))
	{
		return 0;
	}
...
int func_25(int iParam0)
{
	...
	if (((!func_26(unk_0x259BE71D8A81D4FA()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger")) && !bVar0)
	{
		return 0;
	}
	return 1;
...
{
	if (func_45(unk_0x259BE71D8A81D4FA()) || func_44(unk_0x259BE71D8A81D4FA()))
	{
		if (func_28(iParam0))
		{
			return 1;
...
int func_28(int iParam0)
{
	...
	if (func_31(unk_0x259BE71D8A81D4FA()) && (!func_25(unk_0x4B423FAA24E8ABF0(iParam0)) || unk_0x2E6A27037F1DC473(iParam0, joaat("thruster"))))
	{
		return 0;
	}
...
int func_29(int iParam0)
{
	...
	{
		iVar0 = unk_0x4B423FAA24E8ABF0(iParam0);
		if ((unk_0x9E20DC08879FF3FC(iParam0) && !func_21(iParam0)) || func_30(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_32(int iParam0, bool bParam1)
{
	switch (unk_0x4B423FAA24E8ABF0(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_34(unk_0x4B423FAA24E8ABF0(iParam0), 0))
			{
	...
	if (unk_0xD9F5E1FEFD1329E4(iParam0, 0))
	{
		...
		*uParam1 = unk_0x4F06416A18248EA0(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_51(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!unk_0xFC8BFE4B41177C22(iParam0) || !unk_0xD9F5E1FEFD1329E4(iParam0, 0)) || func_71(iParam0, 0, 0)) || func_71(iParam0, 1, 0)) || func_71(iParam0, 2, 0)) || func_70(iParam0) != 145) || func_69(iParam0)) || func_68(iParam0)) || func_15(iParam0)) || func_67(iParam0)) || !func_55(unk_0x4B423FAA24E8ABF0(iParam0)))
	{
		if (func_68(iParam0))
		{
		}
...
int func_56(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		if ((func_61() || unk_0x761778199FE1211C()) || func_60())
		{
		}
		else if (!func_63())
		{
...
int func_76(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_43(unk_0x4B423FAA24E8ABF0(*uParam0), 1) && unk_0x94C9CD3D66808551(*uParam0, 24) != func_79(*uParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x8450270DC5896D39(*uParam0, 24, func_79(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_78(uParam0);
	if (func_77(*uParam0))
	{
...
{
	if (!func_82() && unk_0xAF82FE1B3E949337(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_86(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	struct<82> Var1;
	int iVar99;
	...
	if (iVar99 != 0)
	{
		...
		while (iVar0 < 9)
		{
			if (unk_0xFC8BFE4B41177C22(Global_98012[iVar0]) && unk_0xD9F5E1FEFD1329E4(Global_98012[iVar0], 0))
			{
				if (unk_0x4B423FAA24E8ABF0(Global_98012[iVar0]) == iVar99 && Global_98022[iVar0] == iParam0)
				{
					if (fParam5 == -1f || unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(Global_98012[iVar0], 0), Param2, 1) <= fParam5)
					{
						return 1;
					}
				}
...
void func_87(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_88(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_88(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, var uParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_96(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_97(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_98(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
bool func_101(struct<3> Param0, int iParam3)
{
	return func_102(Global_104212.f_2890.f_12.f_66, Param0, iParam3);
}

int func_102(int iParam0, struct<3> Param1, int iParam4)
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_104(struct<3> Param0, float fParam3, int iParam4)
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (unk_0xFC8BFE4B41177C22(Global_98012[iVar0]))
		{
			if (Global_98012[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0x4B423FAA24E8ABF0(iParam0) == func_114(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_116()
{
	...
	while (!unk_0x0DDDD9D153BCF51F())
	{
		...
		{
			func_117("FRANKLIN", unk_0x4A8C381C258A124D(), 0, 2);
		}
		unk_0x4EDE34FBADD967A6(0);
	}
}

void func_117(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	struct<50> Var0;
	int iVar65;
...
int func_120(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_122(unk_0x4B423FAA24E8ABF0(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_122(unk_0x4B423FAA24E8ABF0(iParam0), iVar1, 14, 4);
		}
	}
...
int func_136(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 14192)
	{
		...
		uVar0 = Global_2805029[iParam0 /*3*/][func_137(iParam1)];
...
void func_144(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_133(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, unk_0x304A39EB177D246B(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_133(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, unk_0x304A39EB177D246B(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = unk_0x7B6C0A0D604E68FA(iVar1, 10, -1, 0, -1, func_124(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_202(int iParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
...
int func_203(int iParam0, var uParam1)
{
	...
	uVar0 = Global_2848282[iParam0 /*3*/][func_137(uParam1)];
...
void func_204(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_205(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_207()
{
	unk_0x68298CA6191CDFDB(&iLocal_30);
