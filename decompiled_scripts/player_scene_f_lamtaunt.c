	...
	while (iLocal_287 && func_119(2, 0))
	{
		...
		switch (iLocal_96)
		{
			...
			case 2:
				if (func_115())
				{
					func_114(&uLocal_98, 0, unk_0xE7869D5D7816A9B6(), "FRANKLIN", 0, 1);
					func_114(&uLocal_98, 2, Global_90811, "LAMAR", 0, 1);
					iLocal_96 = 3;
				}
				break;
...
int func_2()
{
	...
	func_107(&Global_90811, iLocal_288);
	func_3(Global_90811);
	return 0;
}
...
void func_3(var uParam0)
{
	...
	{
		if (!iLocal_543 && unk_0x915685CA559C211B(uParam0, unk_0xE7869D5D7816A9B6(), 1))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_92(75, unk_0x1141852D07400777(uParam0, 0), 250f, -1);
						if (func_35(Global_87092, iVar0, 2, 0, iVar3, iVar2, 75))
						{
							iLocal_543 = 1;
						}
					}
	...
	else
	{
		...
		if (iLocal_541 > 0)
		{
			if (iLocal_542 == 0)
			{
				if (iLocal_541 + 15000 < unk_0x9D40BBF80D8F5E8A())
				{
			...
			else if (iLocal_541 + 10000 < unk_0x9D40BBF80D8F5E8A())
			{
...
{
	unk_0x489E3B00AFB0758C(uParam0, sParam1, func_5(iParam2), 1);
}
...
int func_6(var uParam0, int iParam1, var uParam2, char* sParam3, var uParam4, var uParam5, int iParam6)
{
	...
	if (iVar18 || func_26(sParam3, &Var8, uParam4))
	{
		if (iVar7 == 5)
		{
			if (iVar6 == 0)
			{
				func_114(uParam2, 0, unk_0xE7869D5D7816A9B6(), "MICHAEL", 0, 1);
			}
			else if (iVar6 == 1)
			{
				func_114(uParam2, 0, unk_0xE7869D5D7816A9B6(), "FRANKLIN", 0, 1);
			}
			else if (iVar6 == 2)
			{
				func_114(uParam2, 0, unk_0xE7869D5D7816A9B6(), "TREVOR", 0, 1);
			}
		}
...
int func_10(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, int iParam5)
{
	...
	if (func_24(sParam0, 7))
	{
		...
		{
			func_114(uParam2, 0, unk_0xE7869D5D7816A9B6(), sVar0, 0, 1);
...
int func_24(var uParam0, int iParam1)
{
	...
	else if (!func_25() && !unk_0xD6F17BA188A65E8F())
	{
...
void func_33()
{
	...
	if (unk_0xD51CFE69539DB6D8(unk_0xE7869D5D7816A9B6()))
	{
		if (func_29(Global_99155.f_1750.f_539.f_3549) != unk_0x1B2DC87EFB36DF80(unk_0xE7869D5D7816A9B6()))
		{
			...
			if (func_30(iVar0) && (!func_19(14) || Global_98107))
			{
...
int func_37(int iParam0, int iParam1, int iParam2)
{
	...
	return func_38(Global_99155.f_32499[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_41(int iParam0)
{
	...
	else if (unk_0xB519E5386FBF69E5(Global_99155.f_25013.f_471, iParam0) || unk_0xB519E5386FBF69E5(Global_2097152[func_43() /*10169*/].f_7698.f_10, iParam0))
	{
		bVar0 = true;
		unk_0x73817D396768E4C6(&(Global_99155.f_25013.f_471), iParam0);
		unk_0x73817D396768E4C6(&(Global_2097152[func_43() /*10169*/].f_7698.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		unk_0x4A4F36C4EFDE341F("COUP_RED");
		unk_0x9359E7CC54335EB9(func_42(iParam0));
...
bool func_45(int iParam0)
{
	...
	return unk_0xB519E5386FBF69E5(Global_2097152[func_43() /*10169*/].f_7698.f_10, iParam0);
}
...
int func_48(int iParam0, int iParam1)
{
	...
	if (func_58(&Global_2558814))
	{
		if (func_56(&Global_2558814, iParam0))
		{
			return 0;
		}
		if (func_49(&Global_2558814, iParam0))
		{
			return 1;
		}
	}
...
void func_52(var uParam0)
{
	...
	func_54(uParam0, (Global_2558813 - 0.5f));
}
...
void func_78()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_79(Global_99155.f_12755[iVar2 /*104*/].f_18, Global_99155.f_12755[Global_16779 /*104*/].f_18))
		{
			Global_16779 = iVar2;
		}
		iVar2++;
...
int func_94(int iParam0, int iParam1)
{
	...
	bVar10 = false;
	if (unk_0xB519E5386FBF69E5(Var0.f_2, func_95()))
	{
		bVar10 = true;
	}
	if (Var0.f_4 > iParam1)
	...
	if (bVar10)
	{
		if (Var0.f_3 < Global_99155.f_6302.f_919[func_95()])
		{
			return 5;
		}
	}
...
int func_107(var uParam0, int iParam1)
{
	...
	if (unk_0xD51CFE69539DB6D8(*uParam0))
	{
		...
		{
			case 0:
				if (unk_0x23417CDB252083F9(*uParam0, &cLocal_387, &(Local_468[iParam1 /*16*/]), 2))
				{
					fVar1 = fLocal_540;
					fVar2 = -1f;
					fVar3 = -1f;
					if (unk_0xBC72FB156464483D(&cLocal_387, &(Local_468[iParam1 /*16*/]), "WalkInterruptible", &fVar2, &fVar3))
					{
						fVar1 = fVar2;
					}
					else
					...
					if (unk_0x4D221DFBB84DCF0B(Global_88688) > fVar1)
					{
						if (func_113(Local_317[iParam1 /*3*/], 0f, 0f, 0f, 0))
						{
							Var4 = { unk_0x1141852D07400777(*uParam0, 1) };
						...
						if (unk_0xAF437D7C802AB246(*uParam0))
						{
							...
							unk_0x34912824AE482D65(*uParam0, Local_303 + Local_317[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 1193033728, 1056964608);
							unk_0x29F3FAC40F745C80(*uParam0, joaat("MotionState_Walk"), 0, 1, 0);
							unk_0xA573D5E64CDFAF83(*uParam0, 0, 0);
			...
			case 1:
				if (unk_0xC47857E5E74EA5AF(*uParam0, 2106541073) != 1)
				{
					unk_0x33E113E52A91C5C3(*uParam0, Local_303 + Local_317[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
					iLocal_296[iParam1] = 2;
					return 1;
				}
				fVar7 = unk_0x652D2EEEF1D3E62C(Local_317[iParam1 /*3*/] * Vector(0.05f, 0.05f, 0.05f));
				if (unk_0xB7A628320EFF8E47(unk_0x1141852D07400777(*uParam0, 1), Local_303) >= fVar7)
				{
					if (!func_112() && !unk_0xD525F9D50CBB6A5D(*uParam0))
					{
						unk_0x33E113E52A91C5C3(*uParam0, Local_303 + Local_317[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
						iLocal_296[iParam1] = 2;
						return 1;
				...
				if (unk_0x386C3192F791D414(unk_0x3F80C6638E3A1A90(), *uParam0) || unk_0x0930CF2B56CCE2B8(*uParam0, 0))
				{
			...
			case 2:
				...
				if (unk_0xC47857E5E74EA5AF(*uParam0, 713668775) != 1)
				{
					...
					unk_0xA2D63849729F3A91(*uParam0, Local_303 + Local_317[iParam1 /*3*/], fLocal_334[iParam1], 1077936128, 1086324736);
			...
			case 3:
				...
				if (unk_0xDCB2484D478483C6(sLocal_539))
				{
					unk_0x7146F608C2C17ACC(sLocal_539, 0);
				}
				if (unk_0xB7A628320EFF8E47(unk_0x1141852D07400777(*uParam0, 1), Local_303 + Local_317[iParam1 /*3*/]) < (fLocal_334[iParam1] * fLocal_334[iParam1]))
				{
					if (unk_0x22E8CF9DF233BFE5(Local_303 + Local_317[iParam1 /*3*/], fLocal_334[iParam1], 1))
					{
						unk_0xA3A25B3BCF95E908(*uParam0, Local_303 + Local_317[iParam1 /*3*/], fLocal_334[iParam1], 0);
			...
			case 4:
				...
				else
				{
					...
					if (unk_0xC47857E5E74EA5AF(*uParam0, 1647992574) == 1)
					{
					}
					else if (unk_0xDDF72D11359E25EC(Var8, 0, &Var11, 14))
					{
						if (unk_0xB7A628320EFF8E47(unk_0x1141852D07400777(*uParam0, 1), Var11) > 100f)
						{
							unk_0x33E113E52A91C5C3(*uParam0, Var11, 1f, -1, 0.25f, iVar0, 1193033728);
							iLocal_296[iParam1] = 1;
							return 1;
						}
					}
			...
			case 10:
				...
				unk_0xA9CA101B50B90993(5, iLocal_301, joaat("player"));
				unk_0xA9CA101B50B90993(5, joaat("player"), iLocal_301);
				unk_0xA9CA101B50B90993(5, iLocal_301, Global_86362);
				unk_0xA9CA101B50B90993(5, Global_86362, iLocal_301);
				unk_0xE8EC59D96A176616(*uParam0, 15f, 0);
...
Vector3 func_109(struct<3> Param0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	Var0 = { func_110(Var0, unk_0x8AF26D6D6BBE6931(0f, fParam3)) };
...
int func_117()
{
	...
	if (!func_116())
	{
		if (unk_0x47B2F09FC779F5CD(Global_88688))
		{
			...
			while (iVar0 < iLocal_288)
			{
				if (!unk_0xAF437D7C802AB246(iLocal_288[iVar0]))
				{
					unk_0x360F0D01112F8AD0(iLocal_288[iVar0], Global_88688, &cLocal_387, &(Local_468[iVar0 /*16*/]), 8f, -4f, 3, 0, 1148846080, 0);
					iLocal_296[iVar0] = 0;
				}
				else
				{
...
int func_118()
{
	...
	if (unk_0x47B2F09FC779F5CD(Global_88687))
	{
		...
		while (iVar0 < iLocal_288)
		{
			if (!unk_0xAF437D7C802AB246(iLocal_288[iVar0]))
			{
				unk_0x360F0D01112F8AD0(iLocal_288[iVar0], Global_88687, &cLocal_387, &(Local_403[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		if (!unk_0xAF437D7C802AB246(unk_0xE7869D5D7816A9B6()))
		{
			func_114(&uLocal_98, 1, unk_0xE7869D5D7816A9B6(), "FRANKLIN", 0, 1);
		}
		if (!unk_0xAF437D7C802AB246(Global_90811))
		{
			func_114(&uLocal_98, 4, Global_90811, "LAMAR", 0, 1);
		}
		if (!unk_0xAF437D7C802AB246(iLocal_288[0]))
		{
			func_114(&uLocal_98, 5, iLocal_288[0], "GangMember1", 0, 1);
		}
		if (!unk_0xAF437D7C802AB246(iLocal_288[1]))
		{
...
int func_119(int iParam0, int iParam1)
{
	...
	if (!unk_0xF478777FFCC96862())
	{
		...
		else if (iParam1 == func_120(Global_90811) && iParam1 != 0)
		{
			Global_90811 = 0;
		}
	}
...
void func_127()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_288)
		{
			...
			{
				unk_0x801429C020C467BA(iLocal_292[iVar0]);
				if (!unk_0x5053BF6D5604065B(iLocal_292[iVar0]))
				{
					bVar2 = false;
					unk_0x801429C020C467BA(iLocal_292[iVar0]);
				}
		...
		if (!unk_0xF6917DE0E003509D(&cLocal_387))
		{
			unk_0x2B0BB514F9140141(&cLocal_387);
			if (!unk_0x2917D5E1CB5CE43A(&cLocal_387))
			{
				bVar2 = false;
				unk_0x2B0BB514F9140141(&cLocal_387);
			}
	...
	if (unk_0xD51CFE69539DB6D8(Global_90811))
	{
		if (func_31(19) == unk_0x1B2DC87EFB36DF80(Global_90811))
		{
			unk_0x20BB4B94CC6DDC9A(Global_90811, 1, 1);
		}
		func_128(&Global_90811, Global_86362);
		unk_0x1C26C4B0DAB91B21(Global_90811, 132, 1);
		unk_0x1C26C4B0DAB91B21(Global_90811, 317, 1);
		func_128(&Global_90811, Global_86362);
	}
	unk_0x103FCC2BD24292A3("TAUNTERS", &iLocal_301);
	iVar0 = 0;
	while (iVar0 < iLocal_288)
	{
		if (iLocal_292[iVar0] != 0)
		{
			iLocal_288[iVar0] = unk_0xA7F4088D9A2629CC(iLocal_302, iLocal_292[iVar0], Local_303 + Local_307[iVar0 /*3*/], 0, 1, 1);
			unk_0x151F32CB40BE730C(iLocal_288[iVar0], (fLocal_306 + fLocal_330[iVar0]));
			unk_0xE88E7BF4F83B5AAC(iLocal_288[iVar0], 0);
			unk_0x690C5239500171FE(iLocal_288[iVar0], iLocal_301);
			unk_0xDCF460AE46C9489C(iLocal_288[iVar0], &cLocal_387, &(Local_403[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
			unk_0x1C26C4B0DAB91B21(iLocal_288[iVar0], 317, 1);
			if (iLocal_302 == 6)
			{
				unk_0xCC897563F1971D6A(iLocal_288[iVar0], joaat("weapon_stungun"), 1000, 0, 1);
			}
		}
		iVar0++;
	}
...
void func_129()
{
	...
	{
		case 218:
			Local_307[0 /*3*/] = { unk_0x8AF26D6D6BBE6931(-10f, 10f), unk_0x8AF26D6D6BBE6931(-10f, 10f), 0f };
			Local_307[1 /*3*/] = { unk_0x8AF26D6D6BBE6931(-10f, 10f), unk_0x8AF26D6D6BBE6931(-10f, 10f), 0f };
			Local_317[0 /*3*/] = { -77.3f, -4.1f, 1f };
			Local_317[1 /*3*/] = { Local_317[0 /*3*/] };
			Local_317[iLocal_288 /*3*/] = { 66.7f, -7.299f, 1f };
			fLocal_330[0] = unk_0x8AF26D6D6BBE6931(-180f, 180f);
			fLocal_330[1] = unk_0x8AF26D6D6BBE6931(-180f, 180f);
			fLocal_334[0] = 30f;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_99155.f_1750.f_539.f_1538[0];
			StringCopy(sParam2, func_139(Global_99155.f_1750.f_539.f_1542[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_99155.f_1750.f_539.f_1538[1];
			StringCopy(sParam2, func_139(Global_99155.f_1750.f_539.f_1542[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_99155.f_1750.f_539.f_1538[2];
			StringCopy(sParam2, func_139(Global_99155.f_1750.f_539.f_1542[2]), 32);
			return 1;
			break;
...
void func_140()
{
	...
	while (iVar0 < iLocal_292)
	{
		if (iLocal_292[iVar0] != 0)
		{
			unk_0x506D42CB68AE4EA5(&(iLocal_288[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_292)
	{
		if (iLocal_292[iVar0] != 0)
		{
			unk_0x839E9476E54502A2(iLocal_292[iVar0]);
		}
		iVar0++;
	}
	unk_0xF6231EA8B0BD197C(iLocal_301);
	if (!unk_0xDCB2484D478483C6(sLocal_539))
	{
		unk_0x7146F608C2C17ACC(sLocal_539, 1);
	}
