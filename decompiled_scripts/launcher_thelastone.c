...
int func_189(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_180(2))
	{
		if (!func_151())
		{
			if (((func_132(unk_0xC1A5EC5C986B98AD()) && func_132(uParam0->f_28[0])) && (unk_0xA5E11AF0A2B928C1() - uParam0->f_60) > iParam8) && func_195(unk_0xC1A5EC5C986B98AD(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_190(sParam5))
		{
			...
			{
				if (func_195(unk_0xC1A5EC5C986B98AD(), Param1, 1) >= 20f)
				{
					func_149();
				}
			}
...
void func_196(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	...
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(uParam2))
		{
			...
			{
				if (func_195(unk_0xC1A5EC5C986B98AD(), Param3, 1) <= 100f)
				{
					func_199(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_195(unk_0xC1A5EC5C986B98AD(), Param6, 1);
					fVar1 = func_195(unk_0xC1A5EC5C986B98AD(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
				...
				if (func_195(unk_0xC1A5EC5C986B98AD(), Param3, 1) > 120f)
				{
					func_200(iParam0);
				}
			}
...
int func_243(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_246(&iVar0) || !unk_0x2BBF749E555360DC("rcmlastone1")) || !unk_0x4ACA2D82C1D0DB4F(joaat("weapon_pumpshotgun"))) || !unk_0x4ACA2D82C1D0DB4F(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_91 = 2;
