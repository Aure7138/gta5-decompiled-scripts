...
void __EntryFunction__()
{
	...
	if (unk_0xB9B05E900D325C36(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_103526[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_262(&(Global_103526[Var0.f_0 /*10*/].f_9));
			}
		}
		func_249(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_192(Var0.f_0);
		func_185(&iLocal_93, &uLocal_94, &(Var0.f_9), Var61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_178(&Var0, Var61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_163(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_178(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_169(2))
	{
		if (!func_142())
		{
			if (((func_123(unk_0x0031992CA618A445()) && func_123(uParam0->f_28[0])) && (unk_0x31CD6E9F83C10233() - uParam0->f_60) > iParam8) && func_184(unk_0x0031992CA618A445(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_183(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		...
		else if (func_179(sParam5))
		{
			...
			{
				if (func_184(unk_0x0031992CA618A445(), Param1, 1) >= 20f)
				{
					func_140();
				}
			}
...
void func_185(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (unk_0x4B0365EB2D59E6FA(unk_0x3D35F9864E4640B1()))
	{
		if (!unk_0x0BD3CCFB6C6CFA91(uParam2))
		{
			...
			{
				if (func_184(unk_0x0031992CA618A445(), Param3, 1) <= 100f)
				{
					func_188(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_184(unk_0x0031992CA618A445(), Param6, 1);
					fVar1 = func_184(unk_0x0031992CA618A445(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0x3246AF72F8EF9ADE();
								unk_0x600D7C5231400610(uParam2, 5, 8);
								func_186(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0x3246AF72F8EF9ADE();
							unk_0x600D7C5231400610(uParam2, 6, 8);
							func_186(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_184(unk_0x0031992CA618A445(), Param3, 1) > 120f)
				{
					func_189(iParam0);
				}
			}
...
int func_232(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_235(&iVar0) || !unk_0xB3379AC2E71D1E7E("rcmlastone1")) || !unk_0x95E1E5C0AD9DDDB7(joaat("weapon_pumpshotgun"))) || !unk_0x95E1E5C0AD9DDDB7(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = unk_0x5618B819E5B9C053(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
			...
			if (!unk_0x76B3C79DE564AFC6(uParam0->f_35[0]))
			{
				func_233(&(uParam0->f_35[0]), iVar0[1], -1303.163f, 4648.085f, 104.9664f, 293.1504f);
				if (unk_0x76B3C79DE564AFC6(uParam0->f_35[0]))
				{
...
void func_249(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		func_251(iParam0, 0, 0, 0);
	}
	func_250(&(iParam0->f_48));
	if (iLocal_93 != -1)
	{
