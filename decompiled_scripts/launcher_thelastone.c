	...
	if (unk_0x4B4BD87E3D30C50D(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_98337[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_248(&(Global_98337[Var0.f_0 /*10*/].f_9));
			}
		}
		func_235(&Var0, 1);
	}
...
int func_164(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_155(2))
	{
		if (!func_129())
		{
			if (((func_111(unk_0x77F050A399DB77ED()) && func_111(uParam0->f_28[0])) && (unk_0x3EAC9995EC220C5A() - uParam0->f_60) > iParam8) && func_170(unk_0x77F050A399DB77ED(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_165(sParam5))
		{
			...
			{
				if (func_170(unk_0x77F050A399DB77ED(), Param1, 1) >= 20f)
				{
					func_127();
				}
			}
...
void func_171(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	...
	if (unk_0x6DF20EAB8093DF19(unk_0x8ACD527A7E574590()))
	{
		if (!unk_0x0AAC2160036975D9(uParam2))
		{
			...
			{
				if (func_170(unk_0x77F050A399DB77ED(), Param3, 1) <= 100f)
				{
					func_174(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_170(unk_0x77F050A399DB77ED(), Param6, 1);
					fVar1 = func_170(unk_0x77F050A399DB77ED(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0xF5626435714EF511();
								unk_0x1C4A0258E033922A(uParam2, 5, 8);
								func_172(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0xF5626435714EF511();
							unk_0x1C4A0258E033922A(uParam2, 6, 8);
							func_172(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_170(unk_0x77F050A399DB77ED(), Param3, 1) > 120f)
				{
					func_175(iParam0);
				}
			}
...
int func_218(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_221(&iVar0) || !unk_0x5263DE3D9A17A86F("rcmlastone1")) || !unk_0x12BE006683564B78(joaat("weapon_pumpshotgun"))) || !unk_0x12BE006683564B78(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = unk_0x6665DCC708A346F3(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
