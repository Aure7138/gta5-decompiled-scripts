	...
	if (unk_0x7547D7CF93115D6D(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_96260[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_248(&(Global_96260[Var0.f_0 /*10*/].f_9));
			}
		}
		func_235(&Var0, 1);
	}
...
int func_164(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_155(2))
	{
		if (!func_129())
		{
			if (((func_111(unk_0x507DA4994C3D8EBD()) && func_111(uParam0->f_28[0])) && (unk_0xF976C624234A4AA8() - uParam0->f_60) > iParam8) && func_170(unk_0x507DA4994C3D8EBD(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_165(sParam5))
		{
			...
			{
				if (func_170(unk_0x507DA4994C3D8EBD(), Param1, 1) >= 20f)
				{
					func_127();
				}
			}
...
void func_171(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	...
	if (unk_0x52A84D9C3A400EA8(unk_0xAF65E5A58BE87D95()))
	{
		if (!unk_0x8FA72E132AAFA62F(uParam2))
		{
			if (func_177())
			{
				if (*iParam0 != -1)
			...
			{
				if (func_170(unk_0x507DA4994C3D8EBD(), Param3, 1) <= 100f)
				{
					func_174(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_170(unk_0x507DA4994C3D8EBD(), Param6, 1);
					fVar1 = func_170(unk_0x507DA4994C3D8EBD(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0xCB0201F0BA3841A2();
								unk_0xC25755924A02755B(uParam2, 5, 8);
								func_172(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0xCB0201F0BA3841A2();
							unk_0xC25755924A02755B(uParam2, 6, 8);
							func_172(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_170(unk_0x507DA4994C3D8EBD(), Param3, 1) > 120f)
				{
					func_175(iParam0);
				}
			}
...
int func_218(var uParam0)
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if (((!func_221(&iVar0) || !unk_0xCE40391AB65FE305("rcmlastone1")) || !unk_0xC35CCF23F0A1E055(joaat("weapon_pumpshotgun"))) || !unk_0xC35CCF23F0A1E055(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = unk_0x7B88529CAE3B7F15(25, iLocal_91, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
...
int func_234(struct<3> Param0, struct<3> Param3, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
