	...
	if (unk_0xC11469DCA6FC3BB5(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_96440[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_248(&(Global_96440[Var0.f_0 /*10*/].f_9));
			}
		}
		func_235(&Var0, 1);
	}
...
int func_164(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_155(2))
	{
		if (!func_129())
		{
			if (((func_111(unk_0x096275889B8E0EE0()) && func_111(uParam0->f_28[0])) && (unk_0x4F67E8ECA7D3F667() - uParam0->f_60) > iParam8) && func_170(unk_0x096275889B8E0EE0(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_165(sParam5))
		{
			...
			{
				if (func_170(unk_0x096275889B8E0EE0(), Param1, 1) >= 20f)
				{
					func_127();
				}
			}
...
void func_171(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	...
	if (unk_0xBFFB35986CAAE58C(unk_0x217E9DC48139933D()))
	{
		if (!unk_0x2CF12F9ACF18F048(uParam2))
		{
			if (func_177())
			{
				if (*iParam0 != -1)
			...
			{
				if (func_170(unk_0x096275889B8E0EE0(), Param3, 1) <= 100f)
				{
					func_174(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_170(unk_0x096275889B8E0EE0(), Param6, 1);
					fVar1 = func_170(unk_0x096275889B8E0EE0(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0x375387B5BA5B6056();
								unk_0xAAA4D9BDD4077B87(uParam2, 5, 8);
								func_172(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0x375387B5BA5B6056();
							unk_0xAAA4D9BDD4077B87(uParam2, 6, 8);
							func_172(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_170(unk_0x096275889B8E0EE0(), Param3, 1) > 120f)
				{
					func_175(iParam0);
				}
			}
...
int func_218(var uParam0)
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if (((!func_221(&iVar0) || !unk_0x27FF6FE8009B40CA("rcmlastone1")) || !unk_0x487F2A1C5AAB89EF(joaat("weapon_pumpshotgun"))) || !unk_0x487F2A1C5AAB89EF(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = unk_0x9066DFD4D92E6773(25, iLocal_91, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
