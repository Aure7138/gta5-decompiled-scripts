	...
	if (unk_0x76BF814AB8D4CAB8(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_103638[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_262(&(Global_103638[Var0.f_0 /*10*/].f_9));
			}
		}
		func_249(&Var0, 1);
	}
...
int func_178(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_169(2))
	{
		if (!func_142())
		{
			if (((func_123(unk_0x18F7BE9ACB7D08F4()) && func_123(uParam0->f_28[0])) && (unk_0x5AFB8ED811F05E4D() - uParam0->f_60) > iParam8) && func_184(unk_0x18F7BE9ACB7D08F4(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_179(sParam5))
		{
			...
			{
				if (func_184(unk_0x18F7BE9ACB7D08F4(), Param1, 1) >= 20f)
				{
					func_140();
				}
			}
...
void func_185(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	...
	if (unk_0x557001354138B7FB(unk_0x8CFC7D6E1DA5D304()))
	{
		if (!unk_0xFAFFA408239A026B(uParam2))
		{
			...
			{
				if (func_184(unk_0x18F7BE9ACB7D08F4(), Param3, 1) <= 100f)
				{
					func_188(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_184(unk_0x18F7BE9ACB7D08F4(), Param6, 1);
					fVar1 = func_184(unk_0x18F7BE9ACB7D08F4(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0x183705334A83083E();
								unk_0x2638484EFB343584(uParam2, 5, 8);
								func_186(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0x183705334A83083E();
							unk_0x2638484EFB343584(uParam2, 6, 8);
							func_186(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_184(unk_0x18F7BE9ACB7D08F4(), Param3, 1) > 120f)
				{
					func_189(iParam0);
				}
			}
...
int func_232(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_235(&iVar0) || !unk_0x028356968FDD2DF2("rcmlastone1")) || !unk_0xA1A1ED32111D2031(joaat("weapon_pumpshotgun"))) || !unk_0xA1A1ED32111D2031(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = unk_0x364B87C5C64BD100(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
