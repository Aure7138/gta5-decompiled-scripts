...
void __EntryFunction__()
{
	...
	if (unk_0x524AF15206846700(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_100241[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_249(&(Global_100241[Var0.f_0 /*10*/].f_9));
			}
		}
		func_236(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_179(Var0.f_0);
		func_172(&iLocal_93, &uLocal_94, &(Var0.f_9), Var61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_165(&Var0, Var61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_150(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_165(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_156(2))
	{
		if (!func_130())
		{
			if (((func_111(unk_0x27D769C59BC9D030()) && func_111(uParam0->f_28[0])) && (unk_0xA0F74982C6AAA9D4() - uParam0->f_60) > iParam8) && func_171(unk_0x27D769C59BC9D030(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_170(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
				func_168(&uVar0, cParam4, sParam5, 7, 0, 0);
				uParam0->f_60 = unk_0xA0F74982C6AAA9D4();
				return 1;
			}
		}
		else if (func_166(sParam5))
		{
			if (func_111(unk_0x27D769C59BC9D030()))
			{
				if (func_171(unk_0x27D769C59BC9D030(), Param1, 1) >= 20f)
				{
					func_128();
				}
			}
...
void func_172(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (unk_0x2DB75A8F096AB1F1(unk_0x4D29100D094E5511()))
	{
		if (!unk_0x75CB9E30BA492FF0(uParam2))
		{
			...
			{
				if (func_171(unk_0x27D769C59BC9D030(), Param3, 1) <= 100f)
				{
					func_175(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_171(unk_0x27D769C59BC9D030(), Param6, 1);
					fVar1 = func_171(unk_0x27D769C59BC9D030(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0x18159512D699D089();
								unk_0xD6EC97AEEF3FE2E2(uParam2, 5, 8);
								func_173(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0x18159512D699D089();
							unk_0xD6EC97AEEF3FE2E2(uParam2, 6, 8);
							func_173(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_171(unk_0x27D769C59BC9D030(), Param3, 1) > 120f)
				{
					func_176(iParam0);
				}
			}
...
int func_219(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_222(&iVar0) || !unk_0x482101C9B3483958("rcmlastone1")) || !unk_0xFF6542840B510590(joaat("weapon_pumpshotgun"))) || !unk_0xFF6542840B510590(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = unk_0x91D233CD0204A37F(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
			...
			if (!unk_0xD2CFFE76B625AE55(uParam0->f_35[0]))
			{
				func_220(&(uParam0->f_35[0]), iVar0[1], -1303.163f, 4648.085f, 104.9664f, 293.1504f);
				if (unk_0xD2CFFE76B625AE55(uParam0->f_35[0]))
				{
