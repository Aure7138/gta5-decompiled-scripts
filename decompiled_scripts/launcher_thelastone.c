...
int func_186(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_177(2))
	{
		if (!func_148())
		{
			if (((func_129(unk_0xE2D3D51028F0428A()) && func_129(uParam0->f_28[0])) && (unk_0x320D1840B6DAA1CC() - uParam0->f_60) > iParam8) && func_192(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_187(sParam5))
		{
			...
			{
				if (func_192(unk_0xE2D3D51028F0428A(), Param1, 1) >= 20f)
				{
					func_146();
				}
			}
...
void func_193(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		if (!unk_0xACC32B78196FBC2A(uParam2))
		{
			...
			{
				if (func_192(unk_0xE2D3D51028F0428A(), Param3, 1) <= 100f)
				{
					func_196(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_192(unk_0xE2D3D51028F0428A(), Param6, 1);
					fVar1 = func_192(unk_0xE2D3D51028F0428A(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
				...
				if (func_192(unk_0xE2D3D51028F0428A(), Param3, 1) > 120f)
				{
					func_197(iParam0);
				}
			}
...
int func_240(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_243(&iVar0) || !unk_0x6F940C2636C076AD("rcmlastone1")) || !unk_0xC870CD3D6D40CB09(joaat("weapon_pumpshotgun"))) || !unk_0xC870CD3D6D40CB09(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_91 = 2;
