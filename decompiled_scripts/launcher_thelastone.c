...
void __EntryFunction__()
{
	...
	if (unk_0x24862A9CDC8F8874(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_100063[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_248(&(Global_100063[Var0.f_0 /*10*/].f_9));
			}
		}
		func_235(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_178(Var0.f_0);
		func_171(&iLocal_93, &uLocal_94, &(Var0.f_9), Var61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
...
int func_164(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_155(2))
	{
		if (!func_129())
		{
			if (((func_111(unk_0xC8B93D94F8954288()) && func_111(uParam0->f_28[0])) && (unk_0x693EBB4F13506457() - uParam0->f_60) > iParam8) && func_170(unk_0xC8B93D94F8954288(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_165(sParam5))
		{
			...
			{
				if (func_170(unk_0xC8B93D94F8954288(), Param1, 1) >= 20f)
				{
					func_127();
				}
			}
...
void func_171(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (unk_0x06972B20E75CBE06(unk_0xA34E7C2A5118D638()))
	{
		if (!unk_0xB8A06E7E729EED0A(uParam2))
		{
			...
			{
				if (func_170(unk_0xC8B93D94F8954288(), Param3, 1) <= 100f)
				{
					func_174(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_170(unk_0xC8B93D94F8954288(), Param6, 1);
					fVar1 = func_170(unk_0xC8B93D94F8954288(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0xCDBEE0F3B4A74754();
								unk_0x4767D2EEF03042F6(uParam2, 5, 8);
								func_172(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0xCDBEE0F3B4A74754();
							unk_0x4767D2EEF03042F6(uParam2, 6, 8);
							func_172(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_170(unk_0xC8B93D94F8954288(), Param3, 1) > 120f)
				{
					func_175(iParam0);
				}
			}
...
int func_218(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_221(&iVar0) || !unk_0xF9B86DC1728F1339("rcmlastone1")) || !unk_0xC0212C3CDA6939B3(joaat("weapon_pumpshotgun"))) || !unk_0xC0212C3CDA6939B3(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = unk_0x71DD988C1B903F5D(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
...
int func_223(int iParam0)
{
	...
	{
		func_249("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_224(iParam0))
	{
