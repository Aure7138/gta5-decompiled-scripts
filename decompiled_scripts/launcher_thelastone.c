...
void __EntryFunction__()
{
	...
	if (unk_0x2EC83C7ACA23E8A4(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_100640[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_250(&(Global_100640[Var0.f_0 /*10*/].f_9));
			}
		}
		func_237(&Var0, 1);
	}
	if (!func_234(&iVar64, &Var0, Var61, 1f))
	{
		func_233();
		func_251("SCRIPT TERMINATED");
		unk_0x78C587487CD40B92();
	}
	if (!func_225(Var0.f_0))
	{
		func_233();
		func_251("SCRIPT TERMINATED");
		unk_0x78C587487CD40B92();
	...
	while (true)
	{
		...
		func_180(Var0.f_0);
		func_173(&iLocal_93, &uLocal_94, &(Var0.f_9), Var61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_166(&Var0, Var61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_151(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_166(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_157(2))
	{
		if (!func_131())
		{
			if (((func_112(unk_0xA0081090911D13E5()) && func_112(uParam0->f_28[0])) && (unk_0xDF658EB6CA91DFBC() - uParam0->f_60) > iParam8) && func_172(unk_0xA0081090911D13E5(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_167(sParam5))
		{
			if (func_112(unk_0xA0081090911D13E5()))
			{
				if (func_172(unk_0xA0081090911D13E5(), Param1, 1) >= 20f)
				{
					func_129();
				}
			}
...
void func_173(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (unk_0xC0691D80D21C989D(unk_0x0C1D3C552325765B()))
	{
		if (!unk_0x509383441597090D(uParam2))
		{
			...
			{
				if (func_172(unk_0xA0081090911D13E5(), Param3, 1) <= 100f)
				{
					func_176(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_172(unk_0xA0081090911D13E5(), Param6, 1);
					fVar1 = func_172(unk_0xA0081090911D13E5(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0x6987F23FD8A8D8B0();
								unk_0xC9ED8FFB30E7C224(uParam2, 5, 8);
								func_174(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0x6987F23FD8A8D8B0();
							unk_0xC9ED8FFB30E7C224(uParam2, 6, 8);
							func_174(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_172(unk_0xA0081090911D13E5(), Param3, 1) > 120f)
				{
					func_177(iParam0);
				}
			}
...
int func_220(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_223(&iVar0) || !unk_0xAD21C77209FD2024("rcmlastone1")) || !unk_0x3B53211A0839BF4E(joaat("weapon_pumpshotgun"))) || !unk_0x3B53211A0839BF4E(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = unk_0xF8418B3B87CFCCBF(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
			...
			if (!unk_0xD3FACCDA4D66AEAD(uParam0->f_35[0]))
			{
				func_221(&(uParam0->f_35[0]), iVar0[1], -1303.163f, 4648.085f, 104.9664f, 293.1504f);
				if (unk_0xD3FACCDA4D66AEAD(uParam0->f_35[0]))
				{
...
int func_234(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_235((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_235((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_235(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_236(Var1.f_6, Param1, fParam4, 0))
	{
...
void func_237(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		func_239(iParam0, 0, 0, 0);
	}
	func_238(&(iParam0->f_48));
	if (iLocal_93 != -1)
	{
...
void func_239(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	func_243(uParam0, bParam2);
	func_240(uParam0, bParam3);
}

void func_240(var uParam0, bool bParam1)
{
	func_241(&(uParam0->f_41), bParam1);
}
