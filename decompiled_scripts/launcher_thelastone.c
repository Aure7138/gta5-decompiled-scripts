	...
	if (unk_0x9CEB376419A71A96(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_100273[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_249(&(Global_100273[Var0.f_0 /*10*/].f_9));
			}
		}
		func_236(&Var0, 1);
	}
...
int func_165(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_156(2))
	{
		if (!func_130())
		{
			if (((func_111(unk_0x06736567F820A39E()) && func_111(uParam0->f_28[0])) && (unk_0x1ADBAAC322D61F73() - uParam0->f_60) > iParam8) && func_171(unk_0x06736567F820A39E(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_166(sParam5))
		{
			...
			{
				if (func_171(unk_0x06736567F820A39E(), Param1, 1) >= 20f)
				{
					func_128();
				}
			}
...
void func_172(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	...
	if (unk_0x7868479D9B6694C0(unk_0xE0BDAFA1A39552D6()))
	{
		if (!unk_0x226FA58470A21AEF(uParam2))
		{
			...
			{
				if (func_171(unk_0x06736567F820A39E(), Param3, 1) <= 100f)
				{
					func_175(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_171(unk_0x06736567F820A39E(), Param6, 1);
					fVar1 = func_171(unk_0x06736567F820A39E(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0xD52FDE89B5325D3A();
								unk_0x177901EA0FEB57D3(uParam2, 5, 8);
								func_173(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0xD52FDE89B5325D3A();
							unk_0x177901EA0FEB57D3(uParam2, 6, 8);
							func_173(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_171(unk_0x06736567F820A39E(), Param3, 1) > 120f)
				{
					func_176(iParam0);
				}
			}
...
int func_219(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_222(&iVar0) || !unk_0x7B43775D6E0D7325("rcmlastone1")) || !unk_0xBE17C5B77DABDDAB(joaat("weapon_pumpshotgun"))) || !unk_0xBE17C5B77DABDDAB(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = unk_0xB500796AAD639F82(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
