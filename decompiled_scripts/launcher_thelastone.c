...
int func_189(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_180(2))
	{
		if (!func_151())
		{
			if (((func_132(unk_0x4A8C381C258A124D()) && func_132(uParam0->f_28[0])) && (unk_0x1DD05E817C89C737() - uParam0->f_60) > iParam8) && func_195(unk_0x4A8C381C258A124D(), Param1, 1) < 20f)
			{
				uVar0 = 16;
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam2))
		{
			...
			else
			{
				...
				{
					fVar0 = func_195(unk_0x4A8C381C258A124D(), Param6, 1);
					fVar1 = func_195(unk_0x4A8C381C258A124D(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
