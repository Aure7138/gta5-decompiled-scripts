...
void func_1()
{
	...
	{
		case 0:
			unk_0xC9173FA08E7D8227("PGANG", 0);
			if (unk_0x44FB58EFDA8731B7(0))
			{
				iVar4 = 0;
				while (iVar4 <= 5)
				{
					if (unk_0x2137828D03306CAF(Global_101948.f_225[iVar4]))
					{
						uLocal_284[iVar4] = Global_101948.f_225[iVar4];
						Global_101948.f_225[iVar4] = 0;
						unk_0x216B434C1A609F5B(uLocal_284[iVar4], 1, 1);
						if (iLocal_307 == 0)
						{
							iLocal_307 = unk_0xD3B21CE53AA7BE51(uLocal_284[iVar4]);
						}
						if (!unk_0x769F0F6444C1ABE0(uLocal_284[iVar4]))
						{
							unk_0x3C030E241A3543D2(uLocal_284[iVar4], iLocal_305);
							unk_0xB5AEEE6CCF634ECA(uLocal_284[iVar4], 1);
							unk_0xE92D3CD695EE863C(uLocal_284[iVar4], 0);
							unk_0x176253610C53F0E0(uLocal_284[iVar4], 5);
							unk_0x0E05C8E294DD31A1(uLocal_284[iVar4], 1);
							func_46(uLocal_284[iVar4], 20f, 5f, 90f, -80f, 80f);
							if (iLocal_106 == 0)
							{
								unk_0xB5AEEE6CCF634ECA(uLocal_284[iVar4], 2);
							}
				...
				while (iVar4 <= 1)
				{
					if (unk_0x2137828D03306CAF(Global_101948.f_222[iVar4]))
					{
						uLocal_281[iVar4] = Global_101948.f_222[iVar4];
						Global_101948.f_222[iVar4] = 0;
						unk_0x216B434C1A609F5B(uLocal_281[iVar4], 1, 1);
						if (iLocal_306 == 0)
						{
							iLocal_306 = unk_0xD3B21CE53AA7BE51(uLocal_281[iVar4]);
						}
					}
					iVar4++;
				}
		...
		case 1:
			...
			while (iVar4 <= 5)
			{
				...
				if (unk_0x2137828D03306CAF(uLocal_284[iVar4]) && !unk_0x769F0F6444C1ABE0(uLocal_284[iVar4]))
				{
					bVar6 = false;
				}
				iVar4++;
	...
	while (iVar4 <= 5)
	{
		if (unk_0x2137828D03306CAF(uLocal_284[iVar4]))
		{
			if (unk_0x769F0F6444C1ABE0(uLocal_284[iVar4]))
			{
				unk_0x6C559FCFFD2365CB(&(uLocal_284[iVar4]));
			}
			else if (func_6(uLocal_284[iVar4], func_7(func_8()), 1) > 100f && func_5(unk_0x2A5EB8B0FE590B91(), uLocal_284[iVar4], 1) > 300f)
			{
				func_4();
			}
		...
		if (unk_0xBDD3EABACAB97D09(uLocal_298[iVar4]))
		{
			if (!unk_0x2137828D03306CAF(uLocal_284[iVar4]) || unk_0x769F0F6444C1ABE0(uLocal_284[iVar4]))
			{
				unk_0x789C84F1B8496AD0(&(uLocal_298[iVar4]));
			}
		}
		iVar4++;
	}
...
void func_9()
{
	...
	while (iVar0 <= 5)
	{
		if (unk_0x2137828D03306CAF(uLocal_284[iVar0]) && !unk_0x769F0F6444C1ABE0(uLocal_284[iVar0]))
		{
			switch (uLocal_291[iVar0])
			{
				...
				case 1:
					...
					while (iVar1 <= 5)
					{
						if (unk_0x2137828D03306CAF(uLocal_284[iVar1]) && !unk_0x769F0F6444C1ABE0(uLocal_284[iVar1]))
						{
							iVar2++;
						}
						iVar1++;
			...
			{
				iVar3 = 0;
				unk_0xE3B6C923999B844E(uLocal_284[iVar0], &iVar3, 1);
				if (iVar3 == joaat("weapon_molotov"))
				{
					if (unk_0x871755D0EC5A9997(uLocal_284[iVar0], joaat("weapon_microsmg"), 0))
					{
						unk_0x1776A639860985BF(uLocal_284[iVar0], joaat("weapon_microsmg"), 1);
					}
					else
					{
						unk_0x0013D519C885E60B(uLocal_284[iVar0], joaat("weapon_microsmg"), -1, 1, 1);
					}
				}
			}
			switch (uLocal_291[iVar0])
			{
				...
				case 1:
					...
					{
						unk_0xDD0413EAB0ADDE6A(uLocal_284[iVar0], unk_0x2A5EB8B0FE590B91(), 0, 16);
					}
					break;
				...
				case 2:
					...
					{
						unk_0xCD6FB688ED8B6284(uLocal_284[iVar0], unk_0x2A5EB8B0FE590B91(), 1000f, -1, 1, 0);
					}
					break;
				}
		}
	...
	switch (iLocal_272)
	{
		case 0:
			...
			{
				iVar4 = func_30();
				if (iVar4 != -1 && !unk_0x7C8D4D8A617D31D0(uLocal_284[iVar4]))
				{
		...
		case 3:
			if ((func_31() && (unk_0x3732B96D7A1859B4() - iLocal_273) > 3000) && !unk_0x7C8D4D8A617D31D0(unk_0x2A5EB8B0FE590B91()))
			{
				func_28(unk_0x2A5EB8B0FE590B91(), "BLIND_RAGE", 10);
				iLocal_272++;
			}
			break;
		
		case 4:
			if (func_31() && (unk_0x3732B96D7A1859B4() - iLocal_273) > 1000)
			{
				iVar4 = func_30();
				if (iVar4 != -1 && !unk_0x7C8D4D8A617D31D0(uLocal_284[iVar4]))
				{
...
{
	unk_0x430053236FA97FB8(uParam0, sParam1, func_29(iParam2), 1);
}
...
int func_30()
{
	...
	while (iVar1 <= 5)
	{
		if (unk_0x2137828D03306CAF(uLocal_284[iVar1]) && !unk_0x769F0F6444C1ABE0(uLocal_284[iVar1]))
		{
			fVar3 = func_5(uLocal_284[iVar1], unk_0x2A5EB8B0FE590B91(), 1);
...
void func_33(int iParam0, struct<3> Param1)
{
	...
	if (!func_36(Param1))
	{
		unk_0xE3B6C923999B844E(iParam0, &iVar1, 1);
		if (iVar0 == joaat("weapon_molotov"))
		{
			if (iVar1 != joaat("weapon_molotov"))
			{
				unk_0x1776A639860985BF(iParam0, joaat("weapon_molotov"), 1);
			}
			if (unk_0xE897E371352225D5(iParam0, 242628503) != 1 && unk_0xE897E371352225D5(iParam0, 242628503) != 0)
			{
				unk_0x219EE6A7B599E7DC(&uVar2);
				unk_0xD605CAC9F8611B4D(0, unk_0x895FB9FE885E36ED(1000, 6000));
				unk_0x1C3092F35039FC86(0, func_34(Param1, 1f), 0, 0);
				unk_0xD605CAC9F8611B4D(0, unk_0x895FB9FE885E36ED(1000, 6000));
				unk_0x1C3092F35039FC86(0, func_34(Param1, 1f), 0, 0);
				unk_0xD605CAC9F8611B4D(0, unk_0x895FB9FE885E36ED(1000, 6000));
				unk_0x1C3092F35039FC86(0, func_34(Param1, 1f), 0, 0);
				...
				unk_0xD605CAC9F8611B4D(0, unk_0x895FB9FE885E36ED(1000, 6000));
				unk_0x1C3092F35039FC86(0, func_34(Param1, 1f), 0, 0);
				unk_0x61CCF2A09F373F7B(uVar2, 1);
				unk_0xBD718C5BA2122192(uVar2);
				unk_0x234E551BB8E8813B(iParam0, uVar2);
				unk_0xEDD36C58DDE03C8F(&uVar2);
			}
		}
		else if (unk_0xE897E371352225D5(iParam0, -653332088) != 1 && unk_0xE897E371352225D5(iParam0, -653332088) != 0)
		{
			unk_0xC2525D907B883138(iParam0, Param1, -1, joaat("FIRING_PATTERN_BURST_FIRE"));
		}
	}
	else if (unk_0xE897E371352225D5(iParam0, -982327190) != 1 && unk_0xE897E371352225D5(iParam0, -982327190) != 0)
	{
...
Vector3 func_34(struct<3> Param0, float fParam3)
{
	...
	return Param0 + func_35(Var0, unk_0x399F81B56505EE6F(0f, fParam3));
}
...
int func_37(int iParam0)
{
	...
	while (iVar0 <= 5)
	{
		if ((unk_0x2137828D03306CAF(uLocal_284[iVar0]) && !unk_0x769F0F6444C1ABE0(uLocal_284[iVar0])) && uLocal_291[iVar0] > 0)
		{
			iLocal_280 = 1;
		}
		iVar0++;
	}
	if (((((((((((func_38(Global_101948.f_35, 134217728) || unk_0x296AF7133305081C(uLocal_284[iParam0], unk_0x2A5EB8B0FE590B91())) || unk_0xD7AC8A8028A7ECC8(unk_0x0FFED3E94261A832(), uLocal_284[iParam0])) || unk_0x971F6A3B4BE8006F(uLocal_284[iParam0])) || unk_0xD42AA0CF76AFB4D8(unk_0xD1EE0E9FCD74A37B(uLocal_284[iParam0], 1), 15f, 1)) || unk_0x25EA54098EA8BC13(unk_0xD1EE0E9FCD74A37B(uLocal_284[iParam0], 1), 15f, 1, 1)) || unk_0x4A40D388873A536C(21, unk_0xD1EE0E9FCD74A37B(uLocal_284[iParam0], 1), 15f)) || unk_0x4A40D388873A536C(10, unk_0xD1EE0E9FCD74A37B(uLocal_284[iParam0], 1), 15f)) || unk_0x4A40D388873A536C(7, unk_0xD1EE0E9FCD74A37B(uLocal_284[iParam0], 1), 15f)) || unk_0x4A40D388873A536C(0, unk_0xD1EE0E9FCD74A37B(uLocal_284[iParam0], 1), 15f)) || unk_0x4A40D388873A536C(1, unk_0xD1EE0E9FCD74A37B(uLocal_284[iParam0], 1), 15f)) || iLocal_280)
	{
		return 1;
	}
	return 0;
...
void func_39()
{
	...
	while (iVar0 <= 1)
	{
		if (unk_0x2137828D03306CAF(uLocal_281[iVar0]) && unk_0x7FAC45D56235AB39(uLocal_281[iVar0], 0))
		{
			iVar4 = 0;
			while (iVar4 <= 5)
			{
				if (unk_0x2137828D03306CAF(uLocal_284[iVar4]) && !unk_0x769F0F6444C1ABE0(uLocal_284[iVar4]))
				{
					...
					{
						if (!unk_0x5B9B499C707C2A95(uLocal_284[iVar4], uLocal_281[iVar0], 0))
						{
							uVar1[iVar0]++;
						}
					}
		...
		unk_0x10E6318A0AC17B8D(&cVar5, 0.05f, (0.25f + (IntToFloat(iVar0) * 0.025f)), 0f, 255, 255, 255, 255);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
		...
		if (unk_0x2137828D03306CAF(uLocal_284[iVar0]) && !unk_0x769F0F6444C1ABE0(uLocal_284[iVar0]))
		{
			switch (uLocal_291[iVar0])
			{
				...
				case 1:
					...
					{
						if (!unk_0xEFB4328133A837C8(uLocal_284[iVar0], 286, 1))
						{
							unk_0x31AC59B7C21A2047(uLocal_284[iVar0], 286, 1);
						}
					}
					else
					{
						bVar12 = false;
						if (unk_0xC4A39E4229BD3ABE(uLocal_284[iVar0], 0))
						{
							iVar13 = unk_0x0C20E539D876C5B3(uLocal_284[iVar0], 0);
							iVar11 = 0;
							while (iVar11 <= 1)
							{
								if (!bVar12)
				...
				case 2:
					if (iLocal_276 != -1)
					{
						...
						if (unk_0x2137828D03306CAF(uLocal_284[iLocal_276]))
						{
							if (unk_0xC4A39E4229BD3ABE(uLocal_284[iLocal_276], 0))
							{
								uVar14 = unk_0x0C20E539D876C5B3(uLocal_284[iLocal_276], 0);
							}
						}
					}
					if ((((((((iLocal_276 == -1 || !unk_0x2137828D03306CAF(uLocal_284[iLocal_276])) || unk_0x769F0F6444C1ABE0(uLocal_284[iLocal_276])) || !unk_0x2137828D03306CAF(uVar14)) || !unk_0x7FAC45D56235AB39(iVar14, 0)) || unk_0xD8BFF899C7596F35(iVar14, 0, 1)) || unk_0xD8BFF899C7596F35(iVar14, 1, 1)) || unk_0xD8BFF899C7596F35(iVar14, 4, 1)) || unk_0xD8BFF899C7596F35(iVar14, 5, 1))
					{
						iVar15 = -1;
						bVar16 = false;
						iVar11 = 0;
						while (iVar11 <= 5)
						{
							if (unk_0x2137828D03306CAF(uLocal_284[iVar11]) && !unk_0x769F0F6444C1ABE0(uLocal_284[iVar11]))
							{
			...
			{
				iVar17 = 0;
				unk_0xE3B6C923999B844E(uLocal_284[iVar0], &iVar17, 1);
			...
			switch (uLocal_291[iVar0])
			{
				...
				case 1:
					...
					else if (!unk_0x5B9B499C707C2A95(uLocal_284[iVar0], uLocal_281[Local_37[iVar0 /*10*/].f_8], 0))
					{
						if (func_5(uLocal_284[iVar0], uLocal_281[Local_37[iVar0 /*10*/].f_8], 1) > 4f)
						{
							if (!func_32(uLocal_284[iVar0], 780511057, 1))
							{
								unk_0x6EB9CDEFE029E586(uLocal_284[iVar0], uLocal_281[Local_37[iVar0 /*10*/].f_8], 0f, 0f, 0f, 4f, 0);
								unk_0xDD0413EAB0ADDE6A(uLocal_284[iVar0], unk_0x2A5EB8B0FE590B91(), 0, 16);
							}
						}
						else if (!func_32(uLocal_284[iVar0], -1794415470, 1))
						{
							unk_0xA6AC097BEBB7B1F0(uLocal_284[iVar0], uLocal_281[Local_37[iVar0 /*10*/].f_8], -1, Local_37[iVar0 /*10*/].f_9, 2f, 1, 0);
						}
					}
					else if (!func_32(uLocal_284[iVar0], 538064912, 1))
					{
						unk_0x898FFDB6F6603910(uLocal_284[iVar0], unk_0x2A5EB8B0FE590B91(), 1101004800);
					}
					break;
					...
					if (unk_0xC4A39E4229BD3ABE(uLocal_284[iVar0], 0))
					{
						if (iLocal_276 == iVar0)
						{
							if (func_40(uLocal_284[iVar0], 0) != -1)
							{
								...
								{
									unk_0x91233DD2A90FD0C8(uLocal_284[iVar0], unk_0x0C20E539D876C5B3(uLocal_284[iVar0], 0));
								}
							}
							else if (!func_32(uLocal_284[iVar0], -1273030092, 1) || iLocal_276 != iLocal_277)
							{
								unk_0x8C6A1F8B258BDF97(uLocal_284[iVar0], unk_0x0C20E539D876C5B3(uLocal_284[iVar0], 0), unk_0x2A5EB8B0FE590B91(), 8, 40f, 786468, 1000f, 0f, 1);
							}
							else if (unk_0xE897E371352225D5(uLocal_284[iVar0], -1273030092) == 1)
							{
								if (!unk_0xB85D9C77323AABF6(uLocal_284[iVar0]))
								{
									unk_0xD8E6C10EE9F7CE5D(uLocal_284[iVar0], unk_0x2A5EB8B0FE590B91(), 0, 0f, 0f, 0f, 1000f, 100, 1, -753768974);
								}
							}
						}
						else if (func_40(uLocal_284[iVar0], 0) == -1)
						{
							...
							{
								unk_0x17C38D257AE58A92(uLocal_284[iVar0], unk_0x0C20E539D876C5B3(uLocal_284[iVar0], 0), unk_0x0C20E539D876C5B3(uLocal_284[iLocal_276], 0), -1, 40f, 786468, -1082130432, 20, 1101004800);
							}
							else if (unk_0xE897E371352225D5(uLocal_284[iVar0], -1273030092) == 1)
							{
								if (!unk_0xB85D9C77323AABF6(uLocal_284[iVar0]))
						...
						{
							iVar18 = unk_0x8F8E5C33266ED978(unk_0x0C20E539D876C5B3(uLocal_284[iVar0], 0), -1, 0);
							if (!unk_0x2137828D03306CAF(iVar18) || unk_0x769F0F6444C1ABE0(iVar18))
							{
								if (!func_32(uLocal_284[iVar0], 355471868, 1))
								{
									unk_0x91233DD2A90FD0C8(uLocal_284[iVar0], unk_0x0C20E539D876C5B3(uLocal_284[iVar0], 0));
	...
	switch (iLocal_272)
	{
		case 0:
			...
			{
				iVar19 = func_30();
				if (iVar19 != -1 && !unk_0x7C8D4D8A617D31D0(uLocal_284[iVar19]))
				{
		...
		case 4:
			if (func_31() && (unk_0x3732B96D7A1859B4() - iLocal_273) > 1000)
			{
				...
				if (iVar19 != -1 && !unk_0x7C8D4D8A617D31D0(uLocal_284[iVar19]))
				{
					if (unk_0xC4A39E4229BD3ABE(uLocal_284[iVar19], 0))
					{
...
void func_48()
{
	...
	{
		case 0:
			func_54(&uLocal_107, 0, unk_0x2A5EB8B0FE590B91(), "MICHAEL", 0, 1);
			break;
		
		case 1:
			func_54(&uLocal_107, 1, unk_0x2A5EB8B0FE590B91(), "FRANKLIN", 0, 1);
			break;
		
		case 2:
			func_54(&uLocal_107, 2, unk_0x2A5EB8B0FE590B91(), "TREVOR", 0, 1);
			break;
	}
	...
	unk_0xEE8231F61ED038B0("relGang", &iLocal_305);
	unk_0x3A8EFBE4AB457FE2(5, joaat("player"), iLocal_305);
	unk_0x3A8EFBE4AB457FE2(5, iLocal_305, joaat("player"));
	unk_0x3A8EFBE4AB457FE2(5, iLocal_305, joaat("COP"));
	switch (iVar0)
	{
		case 0:
			unk_0x3A8EFBE4AB457FE2(5, joaat("player"), 296331235);
			unk_0x3A8EFBE4AB457FE2(1, iLocal_305, 296331235);
			unk_0x3A8EFBE4AB457FE2(1, 296331235, iLocal_305);
			break;
		
		case 1:
			unk_0x3A8EFBE4AB457FE2(5, joaat("player"), -1033021910);
			unk_0x3A8EFBE4AB457FE2(1, iLocal_305, -1033021910);
			unk_0x3A8EFBE4AB457FE2(1, -1033021910, iLocal_305);
			break;
		
		case 2:
			unk_0x3A8EFBE4AB457FE2(5, joaat("player"), 1782292358);
			unk_0x3A8EFBE4AB457FE2(1, iLocal_305, 1782292358);
			unk_0x3A8EFBE4AB457FE2(1, 1782292358, iLocal_305);
			break;
	}
}
...
int func_52()
{
	return func_53(Global_101948.f_20, Global_101948.f_29);
}
...
void func_55()
{
	...
	while (iVar0 <= 5)
	{
		if (unk_0x2137828D03306CAF(uLocal_284[iVar0]))
		{
			if (!unk_0x769F0F6444C1ABE0(uLocal_284[iVar0]) && !unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()))
			{
				unk_0xCD6FB688ED8B6284(uLocal_284[iVar0], unk_0x2A5EB8B0FE590B91(), 1000f, -1, 0, 1);
			}
			unk_0x6C559FCFFD2365CB(&(uLocal_284[iVar0]));
		}
		if (unk_0xBDD3EABACAB97D09(uLocal_298[iVar0]))
		{
			unk_0x789C84F1B8496AD0(&(uLocal_298[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		if (unk_0x2137828D03306CAF(uLocal_281[iVar0]))
		{
			unk_0xFECCD8AF38671477(&(uLocal_281[iVar0]));
		}
		iVar0++;
	}
	unk_0xF81FB2DEF90C0B69(iLocal_306, 0);
	unk_0x02E663D7DDAE8202(iLocal_307, 0);
