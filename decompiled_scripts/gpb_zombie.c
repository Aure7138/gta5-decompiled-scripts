...
void func_53(int iParam0, int iParam1, float fParam2)
{
	if (iParam0 == 3)
	{
		...
		{
			uLocal_448 = unk_0x7707E48765093646(joaat("prop_npc_phone"), unk_0x68F4C0EC296D3901(uLocal_240, 1), 1, 1, 0);
...
void func_105()
{
	unk_0xC978532B427F303B(uLocal_240, 0);
	unk_0x4E885A246A9D983A(uLocal_240, 185, 1);
	unk_0x4E885A246A9D983A(uLocal_240, 318, 1);
}
