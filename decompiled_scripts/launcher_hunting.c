...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_171(&Var0, 0) && unk_0x48053974ED6F63CE((Var61.f_2 - Var67.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_262(&Var0, 1);
...
int func_186(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_129(unk_0xE2D3D51028F0428A()) && func_129(iParam0->f_28[0])) && !func_148()) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam8) && func_190(unk_0xE2D3D51028F0428A(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_238(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_245(&iVar0) || !unk_0x6F940C2636C076AD("rcmhunting2"))
			{
				return 0;
			}
			iLocal_91 = 2;
...
void func_239(var uParam0, struct<3> Param1, float fParam4, int iParam5)
{
	func_240(uParam0, iLocal_93, Param1, fParam4);
	if (unk_0xE5965CDF24F93A9F(*uParam0))
	{
...
void func_240(var uParam0, int iParam1, struct<3> Param2, var uParam5)
{
	func_241(uParam0);
...
int func_246(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_245(&iVar0) || !func_247(&(uParam0->f_48))) || !unk_0x6F940C2636C076AD("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
