...
void __EntryFunction__()
{
	...
	iLocal_94 = unk_0x6B7EC7B5B6B57364(joaat("weapon_sniperrifle"));
	...
	if (unk_0x2EBF608FFE6CA406(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_110725[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_272(&(Global_110725[Var0.f_0 /*10*/].f_9));
			}
		}
		func_260(&Var0, 1);
	}
	...
	unk_0x536F1BE96C726C4B(Var61, 3f, 1, 0, 0, 0);
	while (true)
	{
		unk_0x4EDE34FBADD967A6(0);
		if (!func_197(&Var0, 1))
		...
		{
			Var67 = { unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0) };
		}
		if (Var0.f_0 == 25)
		{
		...
		if (func_169(&Var0, 0) && unk_0x755FF954DAE327E1((Var61.f_2 - Var67.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_260(&Var0, 1);
...
int func_184(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_127(unk_0x16F2683693E537C9()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam8) && func_188(unk_0x16F2683693E537C9(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_200(uParam1) || !unk_0xB4ECF989E2C1DAC8(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_200(uParam1) && uParam1->f_4 == 0) && unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), unk_0x68F4C0EC296D3901(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_217(unk_0x68F4C0EC296D3901(iParam1, 1) - unk_0x68F4C0EC296D3901(iParam0, 1)) };
	...
	{
		Var3 = { func_217(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_224(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_217(Param1 - unk_0x68F4C0EC296D3901(uParam0, 1)) };
...
int func_236(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0xC844350D5D58C99A(uLocal_100))
			{
				iLocal_100 = unk_0x5ACD4E66C7BF0F49(joaat("weapon_sniperrifle"), 0, Local_97, 0, 1065353216, 0, 0, 1);
				unk_0x3599C729CF725E87(iLocal_100, joaat("component_at_scope_large"));
				unk_0x3599C729CF725E87(iLocal_100, joaat("component_at_ar_supp_02"));
			}
			if (bVar7)
			{
				iLocal_91 = 3;
		...
		case 3:
			...
			if (unk_0xBF75E4DF4C367CD9(Local_97, 1f, iLocal_94, 0))
			{
