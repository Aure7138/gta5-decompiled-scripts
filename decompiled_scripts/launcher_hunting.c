...
void __EntryFunction__()
{
	...
	uLocal_92 = func_271(54);
	iLocal_93 = joaat("dune");
	iLocal_94 = unk_0x20839301BD7D82F0(joaat("weapon_sniperrifle"));
	iLocal_95 = unk_0xE756C4AA1BCB8705(joaat("component_at_scope_large"));
	iLocal_96 = unk_0xE756C4AA1BCB8705(joaat("component_at_ar_supp_02"));
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_104307[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_267(&(Global_104307[Var0.f_0 /*10*/].f_9));
			}
		}
		func_255(&Var0, 1);
	}
	...
	unk_0x6C5F5B5F6894CCE3(Var61, 3f, 1, 0, 0, 0);
	while (true)
	{
		unk_0x4EDE34FBADD967A6(0);
		if (!func_192(&Var0, 1))
		...
		func_191(Var0.f_0);
		func_184(&iLocal_101, &(Var0.f_9), Var61);
		if (Var0.f_0 == 25)
		{
			func_179(&Var0, Var61, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()) && !unk_0x1D403DFADBC2DE3C(unk_0xBC25C936A095B5BA(), 0))
		{
			Var67 = { unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 0) };
		}
		if (Var0.f_0 == 25)
		{
		...
		if (func_164(&Var0, 0) && unk_0x357058E632979E65((Var61.f_2 - Var67.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_255(&Var0, 1);
...
int func_179(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_124(unk_0xBC25C936A095B5BA()) && func_124(iParam0->f_28[0])) && !func_143()) && (unk_0x105601648511CC64() - iParam0->f_60) > iParam8) && func_183(unk_0xBC25C936A095B5BA(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		...
		switch (uParam1->f_3)
		{
					...
					if (unk_0xF9E082857622D91E(*uParam1))
					{
						...
						if (iParam2 != 21)
						{
							...
							else
							{
								...
								if (func_195(uParam1))
								{
									unk_0x16F091616F4E9EA0(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								else
								{
									unk_0x16F091616F4E9EA0(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								unk_0x16F091616F4E9EA0(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
						...
						{
							unk_0x16F091616F4E9EA0(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 3);
						}
						uParam1->f_3 = 2;
					}
					else
			...
			case 2:
				if (!func_195(uParam1) || !unk_0x96044E39418AAF17(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_195(uParam1) && uParam1->f_4 == 0) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 1), unk_0x541C2AEF053615BC(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 3:
				...
				{
					unk_0x16F091616F4E9EA0(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 4f, -4f, -1, 262152, 0f, 2, 0);
					unk_0x16F091616F4E9EA0(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
				}
			...
			case 5:
				if (!func_194(iParam2) || unk_0xC5B8A5F778E321DD(iParam0, unk_0xBC25C936A095B5BA(), 10f))
				{
					...
					{
						unk_0x16F091616F4E9EA0(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
					}
					uParam1->f_3 = 2;
				}
				break;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_201(unk_0xBC25C936A095B5BA(), uParam0->f_35[iVar0]))
							{
...
int func_210(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_212(unk_0x541C2AEF053615BC(iParam1, 1) - unk_0x541C2AEF053615BC(iParam0, 1)) };
	...
	{
		Var3 = { func_212(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_219(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_212(Param1 - unk_0x541C2AEF053615BC(uParam0, 1)) };
...
int func_231(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uLocal_100))
			{
				iLocal_100 = unk_0x8DF8172E178D3B37(joaat("weapon_sniperrifle"), 0, Local_97, 0, 1065353216, 0, 0, 1);
				unk_0x112064CBEF6B2384(iLocal_100, joaat("component_at_scope_large"));
				unk_0x112064CBEF6B2384(iLocal_100, joaat("component_at_ar_supp_02"));
			}
			if (bVar7)
			{
				iLocal_91 = 3;
		...
		case 3:
			...
			if (unk_0x70CF24CEFB0F53B0(Local_97, 1f, iLocal_94, 0))
			{
				unk_0x784C605D172817C8(iLocal_100, 0f, -90f, -162.64f, 2, 1);
			}
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
			{
...
void func_232(var uParam0, struct<3> Param1, float fParam4, int iParam5)
{
	func_233(uParam0, iLocal_93, Param1, fParam4);
	if (unk_0x724D816EA203A79E(*uParam0))
	{
...
void func_233(var uParam0, int iParam1, struct<3> Param2, var uParam5)
{
	func_234(uParam0);
...
int func_239(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_238(&iVar0) || !func_240(&(uParam0->f_48))) || !unk_0xF9E082857622D91E("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
