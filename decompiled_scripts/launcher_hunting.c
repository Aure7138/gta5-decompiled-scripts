...
void __EntryFunction__()
{
	...
	iLocal_94 = unk_0x823FFE0ED27D2780(joaat("weapon_sniperrifle"));
	iLocal_95 = unk_0x1BF6E110CDFA29AD(joaat("component_at_scope_large"));
	iLocal_96 = unk_0x1BF6E110CDFA29AD(joaat("component_at_ar_supp_02"));
	...
	unk_0xF82BC5193AF62796(Var61, 3f, 1, 0, 0, 0);
	while (true)
	{
		unk_0x4EDE34FBADD967A6(0);
		if (!func_202(&Var0, 1))
		...
		{
			Var67 = { unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 0) };
		}
		if (Var0.f_0 == 25)
		{
		...
		if (func_174(&Var0, 0) && unk_0x2655A8EC638E4FD1((Var61.f_2 - Var67.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_265(&Var0, 1);
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_132(unk_0xC1A5EC5C986B98AD()) && func_132(iParam0->f_28[0])) && !func_151()) && (unk_0xA5E11AF0A2B928C1() - iParam0->f_60) > iParam8) && func_193(unk_0xC1A5EC5C986B98AD(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
	...
	if (func_132(iParam0))
	{
		switch (uParam1->f_3)
		{
					...
					if (unk_0x2BBF749E555360DC(*uParam1))
					{
						...
						if (iParam2 != 21)
						{
							...
							else
							{
								...
								if (func_205(uParam1))
								{
									unk_0xC4F7B29AE0A7D629(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								else
								{
									unk_0xC4F7B29AE0A7D629(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								unk_0xC4F7B29AE0A7D629(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
						...
						{
							unk_0xC4F7B29AE0A7D629(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 3);
						}
						uParam1->f_3 = 2;
					}
					else
			...
			case 3:
				...
				{
					unk_0xC4F7B29AE0A7D629(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 4f, -4f, -1, 262152, 0f, 2, 0);
					unk_0xC4F7B29AE0A7D629(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
				}
			...
			case 5:
				if (!func_204(iParam2) || unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 10f))
				{
					...
					{
						unk_0xC4F7B29AE0A7D629(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
					}
					uParam1->f_3 = 2;
				}
				break;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_211(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[iVar0]))
							{
...
int func_214(int iParam0, float fParam1)
{
	...
	{
		if (func_225(iParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), iParam0))
		{
...
{
	return func_216(iParam0, unk_0xC1A5EC5C986B98AD(), fParam1, 1, 250, 7);
}
...
int func_220(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_222(unk_0x30BE8A934C020461(iParam1, 1) - unk_0x30BE8A934C020461(iParam0, 1)) };
	...
	{
		Var3 = { func_222(unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_229(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_222(Param1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
int func_241(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !unk_0x2BBF749E555360DC("rcmhunting2"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				iLocal_100 = unk_0x9A27CA9A0DA58E5D(joaat("weapon_sniperrifle"), 0, Local_97, 0, 1065353216, 0, 0, 1);
				unk_0xDAE94EB7AAFB39B9(iLocal_100, joaat("component_at_scope_large"));
				unk_0xDAE94EB7AAFB39B9(iLocal_100, joaat("component_at_ar_supp_02"));
			}
			if (bVar7)
			{
				iLocal_91 = 3;
		...
		case 3:
			...
			if (unk_0x17AE936FF608BF89(Local_97, 1f, iLocal_94, 0))
			{
				unk_0x464B5B0F22497FC5(iLocal_100, 0f, -90f, -162.64f, 2, 1);
			}
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
			{
...
int func_249(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_248(&iVar0) || !func_250(&(uParam0->f_48))) || !unk_0x2BBF749E555360DC("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
