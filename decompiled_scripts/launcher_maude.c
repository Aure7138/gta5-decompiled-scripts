	...
	if (unk_0xC11469DCA6FC3BB5(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_96440[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_249(&(Global_96440[Var0.f_0 /*10*/].f_9));
			}
		}
		func_233(&Var0, 1);
	}
...
int func_212(var uParam0)
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			unk_0xA862A2AD321F94B4("special_ped@maude@base");
			iLocal_90 = 1;
			break;
		
		case 1:
			if (!func_217(&iVar0) || !unk_0x27FF6FE8009B40CA("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			bVar5 = true;
			if (!unk_0xD42BD6EB2E0F1677(uParam0->f_41[0]))
			{
				func_216(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0xD42BD6EB2E0F1677(uParam0->f_41[1]))
			{
		...
		case 3:
			...
			{
				uParam0->f_59 = unk_0x4D3B117F889EADDA(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0x074C419F65D01DE7(uParam0->f_59, 1);
				unk_0x0D750763E4B00866(uParam0->f_59, 0);
				unk_0x3605588B4955CFAF(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0xCF307902D4A3A68C(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_218(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_91 = unk_0x55686F8055FF786B(Var0, Var3, 0, 1, 1, 1);
...
int func_232(struct<3> Param0, struct<3> Param3, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
{
	if (unk_0x0ACACDD53B4C4879(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[0]))
		{
			if (func_248(uParam0->f_28[0], 1785177548))
			{
				unk_0x0F1ABE64C3C18E5A(uParam0->f_28[0]);
			}
			unk_0x9BBC32B584987163(uParam0->f_28[0], -1000f, 1);
		}
		if (func_111(uParam0->f_41[0]))
		{
			unk_0x9BBC32B584987163(uParam0->f_41[0], -1000f, 1);
		}
	}
}
