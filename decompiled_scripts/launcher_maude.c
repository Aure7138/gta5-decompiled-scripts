	...
	if (unk_0x5EBD03AF78E7B4DB(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_105157[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_267(&(Global_105157[Var0.f_0 /*10*/].f_9));
			}
		}
		func_251(&Var0, 1);
	}
...
int func_230(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x6D68030C791111E0("special_ped@maude@base");
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_235(&iVar0) || !unk_0x39C2D9AB77873F84("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_41[0]))
			{
				func_234(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_41[1]))
			{
				func_234(&(uParam0->f_41[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_28[0]))
			{
				if (!func_231(&(uParam0->f_28[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar5 = false;
				}
			}
		...
		case 3:
			if (func_125(uParam0->f_28[0]) && func_126(uParam0->f_41[0]))
			{
				uParam0->f_59 = unk_0x70788DC3D80C9DEB(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0xDA16255FBFC16B28(uParam0->f_59, 1);
				unk_0x52CEAE2B7DAC257E(uParam0->f_59, 0);
				unk_0xE5565DEAABF9D588(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0x341C49A9159E80FB(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
int func_231(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_232(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0xDC5D81351D6A4DDB(*uParam0))
		{
			if (!unk_0x7112137033807390(*uParam0, 0))
...
int func_232(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	int iVar0;
...
void func_236(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_92 = unk_0xF66A39BBE7B3C278(Var0, Var3, 0, 1, 1, 1);
				unk_0xFF54548CCE498035(Var0, Var3);
				unk_0x68184E06469338F4(2697.222f, 4119.894f, 42.79107f, 2746.04f, 4162.974f, 43.62732f, 0, 1);
				unk_0x413F34FCFABEDE4B(Var0, Var3, 0, 1);
				if (bParam2)
				{
					unk_0xF54514EACB543898(Var0, Var3, 0);
					unk_0xFDD15D670AD33E10(2728.333f, 4144.778f, 43.29292f, 7.5f, 1, 0, 0, 0);
				}
			}
			else
			{
				...
				unk_0x413F34FCFABEDE4B(Var0, Var3, 1, 1);
				unk_0x387E83E60256EA18(2697.222f, 4119.894f, 42.79107f, 2746.04f, 4162.974f, 43.62732f, 1);
			}
			break;
	}
}
...
{
	if (unk_0xFE5DE0C3200E00F2(uParam0->f_59))
	{
		if (func_125(uParam0->f_28[0]))
		{
			if (func_266(uParam0->f_28[0], 1785177548))
			{
				unk_0x9568B1B58F78FF36(uParam0->f_28[0]);
			}
			unk_0x6AE6C20282990E48(uParam0->f_28[0], -1000f, 1);
		}
		if (func_126(uParam0->f_41[0]))
		{
			unk_0x6AE6C20282990E48(uParam0->f_41[0], -1000f, 1);
		}
	}
}
