...
void __EntryFunction__()
{
	...
	if (unk_0x2C897F101BA20806(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_96526[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_249(&(Global_96526[Var0.f_0 /*10*/].f_9));
			}
		}
		func_233(&Var0, 1);
	}
	...
	if (!func_221(Var0.f_0))
	{
		func_229();
		func_250("SCRIPT TERMINATED");
		unk_0x82706E6C897B0FA1();
	}
	if (func_220(Var0.f_0))
	{
		func_229();
		func_250("SCRIPT TERMINATED");
		unk_0x82706E6C897B0FA1();
...
int func_212(var uParam0)
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			unk_0x3D28909AF30D70F4("special_ped@maude@base");
			iLocal_90 = 1;
			break;
		
		case 1:
			if (!func_217(&iVar0) || !unk_0x6C47E32491756A1A("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			bVar5 = true;
			if (!unk_0x538DF9E5B1DF01EB(uParam0->f_41[0]))
			{
				func_216(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0x538DF9E5B1DF01EB(uParam0->f_41[1]))
			{
		...
		case 3:
			...
			{
				uParam0->f_59 = unk_0x7D9AB6E493591276(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0x3E26976B7A367C36(uParam0->f_59, 1);
				unk_0x3CEAE981C57EBDD4(uParam0->f_59, 0);
				unk_0x10D8E64E13BD715C(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0x5024D69DC4B0F09A(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
int func_213(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_214(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	int iVar0;
...
void func_216(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_179(uParam0);
...
void func_218(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_91 = unk_0x4210B2DCFC2838AC(Var0, Var3, 0, 1, 1, 1);
				unk_0xF003F4333EDCC0BE(Var0, Var3);
				unk_0xD3590DDD9D1A8E0D(2697.222f, 4119.894f, 42.79107f, 2746.04f, 4162.974f, 43.62732f, 0, 1);
				unk_0xC7210908156431E0(Var0, Var3, 0, 1);
				if (bParam2)
				{
					unk_0xD1D6EEB3AEFA757C(Var0, Var3);
					unk_0x84710FE7666EBF7B(2728.333f, 4144.778f, 43.29292f, 7.5f, 1, 0, 0, 0);
				}
			}
			else
			{
				...
				unk_0xC7210908156431E0(Var0, Var3, 1, 1);
				unk_0x46A747493835E815(2697.222f, 4119.894f, 42.79107f, 2746.04f, 4162.974f, 43.62732f, 1);
			}
			break;
	}
}
...
int func_221(int iParam0)
{
	...
	{
		func_250("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_222(iParam0))
	{
...
int func_230(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
...
int func_231(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_232(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_232(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
{
	if (unk_0xCFC5CE3AD496DA0B(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[0]))
		{
			if (func_248(uParam0->f_28[0], 1785177548))
			{
				unk_0x937785D9C1929236(uParam0->f_28[0]);
			}
			unk_0xC706B36DC1764375(uParam0->f_28[0], -1000f, 1);
		}
		if (func_111(uParam0->f_41[0]))
		{
			unk_0xC706B36DC1764375(uParam0->f_41[0], -1000f, 1);
		}
	}
}
