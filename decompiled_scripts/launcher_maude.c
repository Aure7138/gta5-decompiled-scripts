...
int func_212(var uParam0)
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			unk_0x395C5D98343F0040("special_ped@maude@base");
			iLocal_90 = 1;
			break;
		
		case 1:
			if (!func_217(&iVar0) || !unk_0xCE40391AB65FE305("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 3:
			...
			{
				uParam0->f_59 = unk_0x1BEDF9ACAEAB15F8(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0x15B365C4645F79B8(uParam0->f_59, 1);
				unk_0x36069312B76436F6(uParam0->f_59, 0);
				unk_0x206610E40EE4D7D9(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0x763BBCB2253879B8(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_218(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_91 = unk_0x92832F671263F8E0(Var0, Var3, 0, 1, 1, 1);
...
{
	if (unk_0x1955A5B9B65FEEBD(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[0]))
		{
			if (func_248(uParam0->f_28[0], 1785177548))
			{
				unk_0xAC57FBF981AB03F4(uParam0->f_28[0]);
			}
			unk_0x520A583BA5E4F9A7(uParam0->f_28[0], -1000f, 1);
		}
		if (func_111(uParam0->f_41[0]))
		{
			unk_0x520A583BA5E4F9A7(uParam0->f_41[0], -1000f, 1);
		}
	}
}
