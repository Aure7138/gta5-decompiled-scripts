...
void __EntryFunction__()
{
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_104307[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_264(&(Global_104307[Var0.f_0 /*10*/].f_9));
			}
		}
		func_248(&Var0, 1);
	}
	iVar64[0] = 31;
	if (!func_245(&iVar64, &Var0, Var61, 1f))
	{
		func_244();
	...
	while (true)
	{
		...
		func_187(Var0.f_0);
		func_179(&iLocal_93, &(Var0.f_9), Var61);
		if (func_164(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_227(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x522053D86D6E1C7A("special_ped@maude@base");
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_232(&iVar0) || !unk_0xF9E082857622D91E("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			if (!unk_0x724D816EA203A79E(uParam0->f_41[0]))
			{
				func_231(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_41[1]))
			{
				func_231(&(uParam0->f_41[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_28[0]))
			{
				if (!func_228(&(uParam0->f_28[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar5 = false;
				}
			}
		...
		case 3:
			if (func_123(uParam0->f_28[0]) && func_124(uParam0->f_41[0]))
			{
				uParam0->f_59 = unk_0xD0D858E538FD01C3(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0xC2BF3DE5E47F801D(uParam0->f_59, 1);
				unk_0x69D4A898629B0BDA(uParam0->f_59, 0);
				unk_0xB62398E536F695FC(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0xBEBE356CCD6268A1(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
int func_228(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_229(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0x724D816EA203A79E(*uParam0))
		{
			if (!unk_0x1D403DFADBC2DE3C(*uParam0, 0))
...
int func_229(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	int iVar0;
...
void func_233(int iParam0, bool bParam1, bool bParam2)
{
	struct<3> Var0;
	struct<3> Var3;
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_92 = unk_0x1DAA351326EA3537(Var0, Var3, 0, 1, 1, 1);
...
bool func_239(int iParam0, char* sParam1)
{
...
int func_245(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_246((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_246((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_246(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_247(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_247(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
{
	if (unk_0x77FC50899603581D(uParam0->f_59))
	{
		if (func_123(uParam0->f_28[0]))
		{
			if (func_263(uParam0->f_28[0], 1785177548))
			{
				unk_0xA4E856A8CD53B8DF(uParam0->f_28[0]);
			}
			unk_0x6C3BE67B02D72CDC(uParam0->f_28[0], -1000f, 1);
		}
		if (func_124(uParam0->f_41[0]))
		{
			unk_0x6C3BE67B02D72CDC(uParam0->f_41[0], -1000f, 1);
		}
	}
}
