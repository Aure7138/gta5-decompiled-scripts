	...
	if (unk_0x8D841F1DD3FA555F(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_98018[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_249(&(Global_98018[Var0.f_0 /*10*/].f_9));
			}
		}
		func_233(&Var0, 1);
	}
...
int func_212(var uParam0)
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			unk_0x295DC04FC13E025B("special_ped@maude@base");
			iLocal_90 = 1;
			break;
		
		case 1:
			if (!func_217(&iVar0) || !unk_0x8E8B546E1A81D27F("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 3:
			...
			{
				uParam0->f_59 = unk_0x59C061A719024602(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0xFD9AE4CEB0ED9DDF(uParam0->f_59, 1);
				unk_0xC64A07C5C44EA267(uParam0->f_59, 0);
				unk_0x58BEA8B2364F8C48(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0x0F5BEB6747CF25B4(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_218(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_91 = unk_0x13705C66F125D98D(Var0, Var3, 0, 1, 1, 1);
...
{
	if (unk_0xDD7720E17AF5FE17(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[0]))
		{
			if (func_248(uParam0->f_28[0], 1785177548))
			{
				unk_0x27CC98B7C879C320(uParam0->f_28[0]);
			}
			unk_0x80E0D9AA3C331C9A(uParam0->f_28[0], -1000f, 1);
		}
		if (func_111(uParam0->f_41[0]))
		{
			unk_0x80E0D9AA3C331C9A(uParam0->f_41[0], -1000f, 1);
		}
	}
}
