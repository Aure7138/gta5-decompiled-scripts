...
void __EntryFunction__()
{
	...
	if (unk_0x2EC83C7ACA23E8A4(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_100640[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_251(&(Global_100640[Var0.f_0 /*10*/].f_9));
			}
		}
		func_235(&Var0, 1);
	}
	iVar64[0] = 31;
	if (!func_232(&iVar64, &Var0, Var61, 1f))
	{
		func_231();
		func_252("SCRIPT TERMINATED");
		unk_0x78C587487CD40B92();
	}
	if (!func_223(Var0.f_0))
	{
		func_231();
		func_252("SCRIPT TERMINATED");
		unk_0x78C587487CD40B92();
	}
	if (func_222(Var0.f_0))
	{
		func_231();
		func_252("SCRIPT TERMINATED");
		unk_0x78C587487CD40B92();
	...
	while (true)
	{
		...
		func_174(Var0.f_0);
		func_166(&iLocal_93, &(Var0.f_9), Var61);
		if (func_151(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_214(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0xA9DC3948106CC3E4("special_ped@maude@base");
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_219(&iVar0) || !unk_0xAD21C77209FD2024("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				func_218(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0xD3FACCDA4D66AEAD(uParam0->f_41[1]))
			{
				func_218(&(uParam0->f_41[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!unk_0xD3FACCDA4D66AEAD(uParam0->f_28[0]))
			{
				if (!func_215(&(uParam0->f_28[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar5 = false;
				}
			}
		...
		case 3:
			if (func_111(uParam0->f_28[0]) && func_112(uParam0->f_41[0]))
			{
				uParam0->f_59 = unk_0x6194C3993E6BB2A5(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0x530044AE9D695B53(uParam0->f_59, 1);
				unk_0xEB14A75A6A936DCF(uParam0->f_59, 0);
				unk_0xCAD643E9EAD85BD2(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0x6101ECFE82230F9B(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
int func_215(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_216(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0xD3FACCDA4D66AEAD(*uParam0))
		{
...
int func_216(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	int iVar0;
...
void func_218(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_181(uParam0);
...
void func_220(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_92 = unk_0x6A173E5A316F6DE8(Var0, Var3, 0, 1, 1, 1);
...
int func_223(int iParam0)
{
	...
	{
		func_252("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_224(iParam0))
	{
...
bool func_226(int iParam0, char* sParam1)
{
...
int func_232(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_233((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_233((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_233(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_234(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_234(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_235(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		func_220(*iParam0, 0, 1);
		func_249(iParam0);
		func_237(iParam0, 0, 0, 0);
	}
	if (iLocal_93 != -1)
	{
...
void func_237(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	func_241(uParam0, bParam2);
	func_238(uParam0, bParam3);
}

void func_238(var uParam0, bool bParam1)
{
	func_239(&(uParam0->f_41), bParam1);
}
...
{
	if (unk_0x74CC94B98FBFE813(uParam0->f_59))
	{
		if (func_111(uParam0->f_28[0]))
		{
			if (func_250(uParam0->f_28[0], 1785177548))
			{
				unk_0xD3032BAC1ECE011F(uParam0->f_28[0]);
			}
			unk_0x50DFD9BDECE0C913(uParam0->f_28[0], -1000f, 1);
		}
		if (func_112(uParam0->f_41[0]))
		{
			unk_0x50DFD9BDECE0C913(uParam0->f_41[0], -1000f, 1);
		}
	}
}
