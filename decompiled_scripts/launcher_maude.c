	...
	if (unk_0x9EC5BDC006623C42(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_105652[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_267(&(Global_105652[Var0.f_0 /*10*/].f_9));
			}
		}
		func_251(&Var0, 1);
	}
...
int func_230(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x0483D0035D6E46FD("special_ped@maude@base");
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_235(&iVar0) || !unk_0xE9CCF312047EBEE0("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			if (!unk_0x765F6FEEFF39224F(uParam0->f_41[0]))
			{
				func_234(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0x765F6FEEFF39224F(uParam0->f_41[1]))
			{
		...
		case 3:
			...
			{
				uParam0->f_59 = unk_0x38A6890195DD00D1(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0x6359F1F7F5174D4A(uParam0->f_59, 1);
				unk_0x34C803C2BC1CAFB2(uParam0->f_59, 0);
				unk_0x08798CBF817BA887(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0xCF73ED7F74F29138(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_236(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_92 = unk_0x0335D8135051EA56(Var0, Var3, 0, 1, 1, 1);
				unk_0x798B28A324675954(Var0, Var3);
				unk_0x496BE3DBA113D228(2697.222f, 4119.894f, 42.79107f, 2746.04f, 4162.974f, 43.62732f, 0, 1);
				unk_0x5856B9BF2B4E98C4(Var0, Var3, 0, 1);
				if (bParam2)
				{
					unk_0x7F327D8D184FAB7F(Var0, Var3, 0);
					unk_0xCE04CE961AF41AB9(2728.333f, 4144.778f, 43.29292f, 7.5f, 1, 0, 0, 0);
				}
			}
			else
			{
				...
				unk_0x5856B9BF2B4E98C4(Var0, Var3, 1, 1);
				unk_0xF699E61158861D53(2697.222f, 4119.894f, 42.79107f, 2746.04f, 4162.974f, 43.62732f, 1);
			}
			break;
	}
}
...
{
	if (unk_0xDB4C79A9697E6A55(uParam0->f_59))
	{
		if (func_125(uParam0->f_28[0]))
		{
			if (func_266(uParam0->f_28[0], 1785177548))
			{
				unk_0xED68CDDDE25A144E(uParam0->f_28[0]);
			}
			unk_0x0C6BB9365C4A5F6E(uParam0->f_28[0], -1000f, 1);
		}
		if (func_126(uParam0->f_41[0]))
		{
			unk_0x0C6BB9365C4A5F6E(uParam0->f_41[0], -1000f, 1);
		}
	}
}
