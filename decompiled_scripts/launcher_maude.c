	...
	if (unk_0xD63E63DFACCEB80E(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_96445[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_249(&(Global_96445[Var0.f_0 /*10*/].f_9));
			}
		}
		func_233(&Var0, 1);
	}
...
int func_212(var uParam0)
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			unk_0xDA293E5084610B09("special_ped@maude@base");
			iLocal_90 = 1;
			break;
		
		case 1:
			if (!func_217(&iVar0) || !unk_0x3DA2EED4204CE591("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			bVar5 = true;
			if (!unk_0x746960881FB19A89(uParam0->f_41[0]))
			{
				func_216(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0x746960881FB19A89(uParam0->f_41[1]))
			{
		...
		case 3:
			...
			{
				uParam0->f_59 = unk_0x8E83718430E22797(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0x25821CAAB3B8EF73(uParam0->f_59, 1);
				unk_0xBC5F61BBFCA70907(uParam0->f_59, 0);
				unk_0x6C4954C76B25F972(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0xB3ABC7B97480C0A5(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_218(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_91 = unk_0x676E460800A9E1B7(Var0, Var3, 0, 1, 1, 1);
...
void func_247(var uParam0)
{
	if (unk_0xAA446425C3A969F9(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[0]))
		{
			...
			{
				unk_0x32D18ECD9E6F9BE2(uParam0->f_28[0]);
			}
			unk_0xFCD8CBB0DC357C30(uParam0->f_28[0], -1000f, 1);
		}
		if (func_111(uParam0->f_41[0]))
		{
			unk_0xFCD8CBB0DC357C30(uParam0->f_41[0], -1000f, 1);
		}
	}
}
