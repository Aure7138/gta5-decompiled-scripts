	...
	if (unk_0x89522B8E487D4EF9(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_98242[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_249(&(Global_98242[Var0.f_0 /*10*/].f_9));
			}
		}
		func_233(&Var0, 1);
	}
...
int func_212(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x2B0BB514F9140141("special_ped@maude@base");
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_217(&iVar0) || !unk_0x2917D5E1CB5CE43A("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			if (!unk_0xD51CFE69539DB6D8(uParam0->f_41[0]))
			{
				func_216(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0xD51CFE69539DB6D8(uParam0->f_41[1]))
			{
		...
		case 3:
			...
			{
				uParam0->f_59 = unk_0xB839A1C489B63ACC(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0x3A7DEF86891D2891(uParam0->f_59, 1);
				unk_0xDB14F40E3E8CB36F(uParam0->f_59, 0);
				unk_0x360F0D01112F8AD0(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0xDE77F887DBEE3953(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_218(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_92 = unk_0x8668A841B325FF16(Var0, Var3, 0, 1, 1, 1);
				unk_0xA30D54731C0AAECF(Var0, Var3);
				unk_0x39895086D78BEA60(2697.222f, 4119.894f, 42.79107f, 2746.04f, 4162.974f, 43.62732f, 0, 1);
				unk_0xBDF0A810DD6A47D3(Var0, Var3, 0, 1);
				if (bParam2)
				{
					unk_0x98ED910C6513D537(Var0, Var3, 0);
					unk_0xB86B1248EA9B87EA(2728.333f, 4144.778f, 43.29292f, 7.5f, 1, 0, 0, 0);
				}
			}
			else
			{
				...
				unk_0xBDF0A810DD6A47D3(Var0, Var3, 1, 1);
				unk_0x3EB6E5FC1FA6912C(2697.222f, 4119.894f, 42.79107f, 2746.04f, 4162.974f, 43.62732f, 1);
			}
			break;
	}
}
...
void func_247(var uParam0)
{
	if (unk_0x47B2F09FC779F5CD(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[0]))
		{
			...
			{
				unk_0xFA2C5C2D054C888E(uParam0->f_28[0]);
			}
			unk_0xB4E40069DFD4B86F(uParam0->f_28[0], -1000f, 1);
		}
		if (func_111(uParam0->f_41[0]))
		{
			unk_0xB4E40069DFD4B86F(uParam0->f_41[0], -1000f, 1);
		}
	}
}
