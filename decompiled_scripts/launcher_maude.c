	...
	if (unk_0x7D9C4B359376D38A(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_103642[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_264(&(Global_103642[Var0.f_0 /*10*/].f_9));
			}
		}
		func_248(&Var0, 1);
	}
...
int func_227(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x6450931B826B49D9("special_ped@maude@base");
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_232(&iVar0) || !unk_0x3A801AA34DD821BE("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 3:
			...
			{
				uParam0->f_59 = unk_0x8383F9C605E523B7(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0xD0E12C501EE26329(uParam0->f_59, 1);
				unk_0x7122D672EBE0EA6E(uParam0->f_59, 0);
				unk_0x8E628F774C748D93(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0xEBB74134CCA3442E(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_233(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_92 = unk_0xCB389937EDB1519A(Var0, Var3, 0, 1, 1, 1);
...
void func_262(var uParam0)
{
	if (unk_0xD56F740235B1E8F0(uParam0->f_59))
	{
		...
		if (func_124(uParam0->f_41[0]))
		{
			unk_0xBD1486160AB0661B(uParam0->f_41[0], -1000f, 1);
		}
	}
}
