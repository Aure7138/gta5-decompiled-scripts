	...
	if (unk_0xC968670BFACE42D9(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_96260[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_249(&(Global_96260[Var0.f_0 /*10*/].f_9));
			}
		}
		func_233(&Var0, 1);
	}
...
int func_212(var uParam0)
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			unk_0xD3BD40951412FEF6("special_ped@maude@base");
			iLocal_90 = 1;
			break;
		
		case 1:
			if (!func_217(&iVar0) || !unk_0xD031A9162D01088C("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 3:
			...
			{
				uParam0->f_59 = unk_0x8C18E0F9080ADD73(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0xD9A897A4C6C2974F(uParam0->f_59, true);
				unk_0x394B9CD12435C981(uParam0->f_59, false);
				unk_0xEEA929141F699854(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1000f, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0xC77720A12FE14A86(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1000f);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
int func_213(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_214(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0x7239B21A38F536BA(*iParam0))
		{
			if (!unk_0x5F9532F3B5CC2551(*iParam0))
...
int func_214(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_216(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_179(iParam0);
...
void func_218(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_91 = unk_0x1B5C85C612E5256E(Var0, Var3, false, true, true, true);
...
void func_247(var uParam0)
{
	if (unk_0x25D39B935A038A26(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[0]))
		{
			...
			{
				unk_0xE1EF3C1216AFF2CD(uParam0->f_28[0]);
			}
			unk_0x43D3807C077261E3(uParam0->f_28[0], -1000f, true);
		}
		if (func_111(uParam0->f_41[0]))
		{
			unk_0x43D3807C077261E3(uParam0->f_41[0], -1000f, true);
		}
	}
}
