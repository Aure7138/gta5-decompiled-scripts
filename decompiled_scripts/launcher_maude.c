	...
	if (unk_0x4B4BD87E3D30C50D(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_98337[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_249(&(Global_98337[Var0.f_0 /*10*/].f_9));
			}
		}
		func_233(&Var0, 1);
	}
...
int func_212(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x6E2E777C1AD81C36("special_ped@maude@base");
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_217(&iVar0) || !unk_0x5263DE3D9A17A86F("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			if (!unk_0x1F2158D615BC4B25(uParam0->f_41[0]))
			{
				func_216(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0x1F2158D615BC4B25(uParam0->f_41[1]))
			{
		...
		case 3:
			...
			{
				uParam0->f_59 = unk_0xFCF0CDCAF2761068(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0x33AD23CCE6A61B0F(uParam0->f_59, 1);
				unk_0xEBA174204B3A690F(uParam0->f_59, 0);
				unk_0x3C6CCFC07FD12077(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0x1D8909C3B0308E1E(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_218(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_92 = unk_0x2277155D92E898D2(Var0, Var3, 0, 1, 1, 1);
...
void func_247(var uParam0)
{
	if (unk_0x671C6C3F21245221(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[0]))
		{
			...
			{
				unk_0xE2CB8488CFA42209(uParam0->f_28[0]);
			}
			unk_0x8A817B41A6EAEFB5(uParam0->f_28[0], -1000f, 1);
		}
		if (func_111(uParam0->f_41[0]))
		{
			unk_0x8A817B41A6EAEFB5(uParam0->f_41[0], -1000f, 1);
		}
	}
}
