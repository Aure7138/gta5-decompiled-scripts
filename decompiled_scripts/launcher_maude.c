...
void __EntryFunction__()
{
	...
	if (unk_0x24862A9CDC8F8874(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_100063[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_249(&(Global_100063[Var0.f_0 /*10*/].f_9));
			}
		}
		func_233(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_172(Var0.f_0);
		func_164(&iLocal_93, &(Var0.f_9), Var61);
		if (func_149(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_212(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0xC0E8B67A4385D37D("special_ped@maude@base");
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_217(&iVar0) || !unk_0xF9B86DC1728F1339("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			if (!unk_0x95CCECA3948CFE7B(uParam0->f_41[0]))
			{
				func_216(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0x95CCECA3948CFE7B(uParam0->f_41[1]))
			{
		...
		case 3:
			...
			{
				uParam0->f_59 = unk_0x0B15BB6DFB729046(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				unk_0x53DDB73894A6597A(uParam0->f_59, 1);
				unk_0x4528D7AA6C2BEF06(uParam0->f_59, 0);
				unk_0xA5666A46C1079EFE(uParam0->f_28[0], uParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				unk_0x16A73DD34A0EE6C3(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_218(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_92 = unk_0x8738B068D97CDC64(Var0, Var3, 0, 1, 1, 1);
...
void func_247(var uParam0)
{
	if (unk_0xBC6B93737FCDC466(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[0]))
		{
			...
			{
				unk_0x5124C5FA52D2AF3E(uParam0->f_28[0]);
			}
			unk_0x20D399098E17A191(uParam0->f_28[0], -1000f, 1);
		}
		if (func_111(uParam0->f_41[0]))
		{
			unk_0x20D399098E17A191(uParam0->f_41[0], -1000f, 1);
		}
	}
}
