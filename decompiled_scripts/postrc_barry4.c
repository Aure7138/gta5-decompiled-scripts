...
void func_1()
{
	if ((unk_0x9D40BBF80D8F5E8A() - iLocal_202) > 5000)
	{
...
void func_19()
{
	iLocal_202 = unk_0x9D40BBF80D8F5E8A();
	func_20(&uLocal_37, 1, unk_0xE7869D5D7816A9B6(), "FRANKLIN", 0, 1);
	iLocal_36 = 1;
}
...
{
	if (((!func_9() == iParam0 || func_23()) || func_22()) || Global_69233 != -1)
	{
		if (!func_9() == 1)
		{
		}
