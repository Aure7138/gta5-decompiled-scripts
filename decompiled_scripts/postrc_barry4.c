...
void func_1()
{
	if ((unk_0x105601648511CC64() - iLocal_202) > 5000)
	{
...
void func_19()
{
	iLocal_202 = unk_0x105601648511CC64();
	func_20(&uLocal_37, 1, unk_0xBC25C936A095B5BA(), "FRANKLIN", 0, 1);
	iLocal_36 = 1;
}
...
{
	if (((!func_9() == iParam0 || func_23()) || func_22()) || Global_70975 != -1)
	{
		if (!func_9() == 1)
		{
		}
