...
void func_1()
{
	if ((unk_0xF976C624234A4AA8() - iLocal_200) > 5000)
	{
...
void func_19()
{
	iLocal_200 = unk_0xF976C624234A4AA8();
	func_20(&uLocal_35, 1, unk_0x507DA4994C3D8EBD(), "FRANKLIN", 0, 1);
	iLocal_34 = 1;
}
...
{
	if (((!func_9() == iParam0 || func_23()) || func_22()) || Global_68064 != -1)
	{
		if (!func_9() == 1)
		{
		}
