...
void func_1()
{
	if ((unk_0xDF658EB6CA91DFBC() - iLocal_202) > 5000)
	{
...
void func_19()
{
	iLocal_202 = unk_0xDF658EB6CA91DFBC();
	func_20(&uLocal_37, 1, unk_0xA0081090911D13E5(), "FRANKLIN", 0, 1);
	iLocal_36 = 1;
}
...
{
	if (((!func_9() == iParam0 || func_23()) || func_22()) || Global_69614 != -1)
	{
		if (!func_9() == 1)
		{
		}
