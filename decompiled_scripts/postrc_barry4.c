...
void func_1()
{
	if ((unk_0x48E480685981C7D4() - iLocal_201) > 5000)
	{
...
void func_19()
{
	iLocal_201 = unk_0x48E480685981C7D4();
	func_20(&uLocal_36, 1, unk_0x81873881071CD9FE(), "FRANKLIN", 0, 1);
	iLocal_35 = 1;
}
...
{
	if (((!func_9() == iParam0 || func_23()) || func_22()) || Global_69017 != -1)
	{
		if (!func_9() == 1)
		{
		}
