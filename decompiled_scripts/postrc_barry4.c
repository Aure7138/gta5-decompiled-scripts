...
void func_1()
{
	if ((unk_0xDFB7BFA6482FEE1E() - iLocal_202) > 5000)
	{
...
void func_25()
{
	iLocal_202 = unk_0xDFB7BFA6482FEE1E();
	func_26(&uLocal_37, 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
	iLocal_36 = 1;
}
...
{
	if (((!func_14() == iParam0 || func_29()) || func_28()) || Global_77245 != -1)
	{
		if (!func_14() == 1)
		{
		}
