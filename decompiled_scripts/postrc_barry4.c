...
void func_1()
{
	if ((unk_0x53C562FD2B9E3AB0() - iLocal_202) > 5000)
	{
...
void func_19()
{
	iLocal_202 = unk_0x53C562FD2B9E3AB0();
	func_20(&uLocal_37, 1, unk_0xFC1458A37D98B502(), "FRANKLIN", 0, 1);
	iLocal_36 = 1;
}
...
{
	if (((!func_9() == iParam0 || func_23()) || func_22()) || Global_70853 != -1)
	{
		if (!func_9() == 1)
		{
		}
