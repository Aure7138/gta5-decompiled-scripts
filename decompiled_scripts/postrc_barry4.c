...
void func_1()
{
	if ((unk_0x693EBB4F13506457() - iLocal_202) > 5000)
	{
...
void func_19()
{
	iLocal_202 = unk_0x693EBB4F13506457();
	func_20(&uLocal_37, 1, unk_0xC8B93D94F8954288(), "FRANKLIN", 0, 1);
	iLocal_36 = 1;
}
...
{
	if (((!func_9() == iParam0 || func_23()) || func_22()) || Global_69314 != -1)
	{
		if (!func_9() == 1)
		{
		}
