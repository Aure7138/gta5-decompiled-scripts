...
void func_1()
{
	if ((unk_0x3732B96D7A1859B4() - iLocal_202) > 5000)
	{
...
void func_19()
{
	iLocal_202 = unk_0x3732B96D7A1859B4();
	func_20(&uLocal_37, 1, unk_0x2A5EB8B0FE590B91(), "FRANKLIN", 0, 1);
	iLocal_36 = 1;
}
...
{
	if (((!func_9() == iParam0 || func_23()) || func_22()) || Global_69797 != -1)
	{
		if (!func_9() == 1)
		{
		}
