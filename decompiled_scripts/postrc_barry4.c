...
void func_1()
{
	if ((unk_0x84A97C70FFDEC0C8() - iLocal_202) > 5000)
	{
...
void func_19()
{
	iLocal_202 = unk_0x84A97C70FFDEC0C8();
	func_20(&uLocal_37, 1, unk_0xD5A676B97920D126(), "FRANKLIN", 0, 1);
	iLocal_36 = 1;
}
...
{
	if (((!func_9() == iParam0 || func_23()) || func_22()) || Global_69694 != -1)
	{
		if (!func_9() == 1)
		{
		}
