...
void func_1()
{
	if ((unk_0xFD34717937104F1C() - iLocal_202) > 5000)
	{
...
void func_19()
{
	iLocal_202 = unk_0xFD34717937104F1C();
	func_20(&uLocal_37, 1, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
	iLocal_36 = 1;
}
...
{
	if (((!func_9() == iParam0 || func_23()) || func_22()) || Global_71202 != -1)
	{
		if (!func_9() == 1)
		{
		}
