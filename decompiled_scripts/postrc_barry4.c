...
void func_1()
{
	if ((unk_0x320D1840B6DAA1CC() - iLocal_202) > 5000)
	{
...
void func_25()
{
	iLocal_202 = unk_0x320D1840B6DAA1CC();
	func_26(&uLocal_37, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
	iLocal_36 = 1;
}

void func_26(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
{
	if (((!func_14() == iParam0 || func_29()) || func_28()) || Global_77855 != -1)
	{
		if (!func_14() == 1)
		{
		}
