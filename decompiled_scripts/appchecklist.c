...
void func_4()
{
	...
	if (Global_14389 == 0)
	{
		while (iVar0 < 5)
		{
			func_7(Global_14374, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(18), unk_0xBBDA792448DB5A89(iLocal_114), unk_0xBBDA792448DB5A89(0), -1f, -1f, &(Local_130[iVar0 /*6*/]), 0, 0, 0, 0);
	...
	if (Global_14389 == 1)
	{
		...
		while (iVar0 < 5)
		{
			if (Local_130[iVar1 /*6*/].f_5 > 0)
			{
				...
				{
					func_7(Global_14374, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(18), unk_0xBBDA792448DB5A89(iLocal_114), unk_0xBBDA792448DB5A89(0), -1f, -1f, &(Local_130[iVar1 /*6*/]), 0, 0, 0, 0);
	...
	if (iLocal_114 == 0)
	{
		func_7(Global_14374, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(18), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(0), -1f, -1f, "CELL_3092", 0, 0, 0, 0);
	}
	else
	{
		bLocal_129 = true;
...
void func_10()
{
	...
	if (Global_14371 == 0)
	{
		if (func_9(2, Global_14362, 0))
		{
			...
			uLocal_128 = unk_0x0D72C1C0D4A044A4();
			while (!unk_0xEB72DB563C7B7566(uLocal_128))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			iVar0 = unk_0x88AE9F0292C2B117(uLocal_128);
			...
			unk_0x876C5D0739031E15(0);
			unk_0x44F4D219F8513945("CELL_3206");
			unk_0x844339A27F0F1508(iLocal_125);
			unk_0x113A6F657EE871A3();
			unk_0xA52FC2467E672B55();
			unk_0xF48C88BD1F0007E8(Global_14374, "SET_DATA_SLOT");
			unk_0x876C5D0739031E15(18);
			...
			unk_0x876C5D0739031E15(0);
			unk_0x44F4D219F8513945("CELL_3101");
			unk_0x844339A27F0F1508(iLocal_126);
			unk_0x113A6F657EE871A3();
			unk_0xA52FC2467E672B55();
			func_33(Global_14374, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_11()
{
	...
	{
		case 0:
			iLocal_125 = Global_96892;
			iLocal_126 = Global_96909;
			break;
		
		case 1:
			iLocal_125 = (Global_96893 + Global_96894);
			iLocal_126 = (Global_96910 + Global_96911);
			break;
		
		case 2:
			iLocal_125 = Global_96895;
			iLocal_126 = Global_96912;
			break;
		
		case 3:
			iLocal_125 = Global_96896;
			iLocal_126 = Global_96913;
			break;
		
		case 4:
			iLocal_125 = (Global_96897 + Global_96898);
			iLocal_126 = (Global_96914 + Global_96915);
			break;
...
void func_15()
{
	if (Global_14371 == 0)
	{
		if (func_9(2, Global_14362, 0))
		{
			...
			iLocal_127 = unk_0x88AE9F0292C2B117(uLocal_128);
			if (Global_14393.f_1 > 3)
			{
				Global_14393.f_1 = 8;
				if (iLocal_127 == 0)
...
void func_16()
{
	...
	if (func_17(0))
	{
		func_7(Global_14374, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(18), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(0), -1f, -1f, "CELL_229", 0, 0, 0, 0);
	}
	else
	{
		while (iVar0 < Global_85190)
		{
			func_7(Global_14374, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(18), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(0), -1f, -1f, &(Global_84981[iVar0 /*4*/]), 0, 0, 0, 0);
			iLocal_114++;
...
{
	return func_19(iParam0, Global_34909);
}
...
void func_20()
{
	...
	while (iVar0 < 7)
	{
		if (Global_80941[iVar0 /*5*/] != -1)
		{
			if (Global_85190 < 52)
			{
				iVar1 = Global_68336.f_109[Global_80941[iVar0 /*5*/] /*4*/];
				MemCopy(&(Global_84981[Global_85190 /*4*/]), {func_24(iVar1)}, 4);
				Global_85190++;
			}
			else
			{
	...
	while (iVar0 < 63)
	{
		if ((unk_0x61D8FEAF64881CDA(Global_97173.f_16795[iVar0 /*6*/], 0) && unk_0x61D8FEAF64881CDA(Global_97173.f_16795[iVar0 /*6*/], 1)) && !unk_0x61D8FEAF64881CDA(Global_97173.f_16795[iVar0 /*6*/], 3))
		{
			if (Global_85190 < 52)
			{
				MemCopy(&(Global_84981[Global_85190 /*4*/]), {func_22(iVar0)}, 4);
				Global_85190++;
			}
			else
			{
	...
	while (iVar0 < 20)
	{
		if (unk_0x61D8FEAF64881CDA(Global_97173.f_7311.f_99.f_214[0], iVar0))
		{
			if (Global_85190 < 52)
			{
				StringCopy(&(Global_84981[Global_85190 /*4*/]), func_21(iVar0), 16);
				Global_85190++;
			}
			else
			{
...
void func_26()
{
	func_33(Global_14374, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_28()
{
	func_33(Global_14374, "SET_INPUT_EVENT", unk_0xBBDA792448DB5A89(1), -1082130432, -1082130432, -1082130432, -1082130432);
	unk_0x84795EA8F54230A1(-1, "Menu_Navigate", &Global_14382, 1);
	func_29();
}
...
{
	func_33(Global_14374, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_7(Global_14374, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(18), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(0), -1f, -1f, "CELL_3301", 0, 0, 0, 0);
	func_7(Global_14374, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(18), unk_0xBBDA792448DB5A89(1), unk_0xBBDA792448DB5A89(0), -1f, -1f, "CELL_3302", 0, 0, 0, 0);
	iLocal_114 = 2;
	func_33(Global_14374, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_5(Global_14374, "SET_HEADER", "CELL_23", 0, 0, 0, 0);
	if (Global_14381)
...
void func_31()
{
	func_32(0, "CELL_3001", 1, Global_96909);
	func_32(1, "CELL_3008", 3, Global_96909);
	func_32(2, "CELL_3004", 7, Global_96912);
	func_32(3, "CELL_3005", 9, Global_96913);
	func_32(4, "CELL_3007", 11, Global_96914);
}
