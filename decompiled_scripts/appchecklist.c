...
void func_10()
{
	...
	if (Global_14371 == 0)
	{
		if (func_9(2, Global_14362, 0))
		{
			...
			iLocal_128 = unk_0xC50AA39A577AF886();
			while (!unk_0x768FF8961BA904D6(iLocal_128))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			iVar0 = unk_0x2DE7EFA66B906036(iLocal_128);
			...
			unk_0x03B504CF259931BC(iLocal_125);
			unk_0x362E2D3FE93A9959();
			unk_0xC6796A8FFA375E53();
			unk_0xF6E48914C7A8694E(Global_14374, "SET_DATA_SLOT");
			unk_0xC3D0841A0CC546A6(18);
			...
			unk_0x03B504CF259931BC(iLocal_126);
			unk_0x362E2D3FE93A9959();
			unk_0xC6796A8FFA375E53();
			func_33(Global_14374, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_15()
{
	if (Global_14371 == 0)
	{
		if (func_9(2, Global_14362, 0))
		{
			...
			iLocal_127 = unk_0x2DE7EFA66B906036(iLocal_128);
			if (Global_14393.f_1 > 3)
			{
				Global_14393.f_1 = 8;
				if (iLocal_127 == 0)
...
void func_20()
{
	...
	while (iVar0 < 63)
	{
		if ((unk_0xA921AA820C25702F(Global_97173.f_16795[iVar0 /*6*/], 0) && unk_0xA921AA820C25702F(Global_97173.f_16795[iVar0 /*6*/], 1)) && !unk_0xA921AA820C25702F(Global_97173.f_16795[iVar0 /*6*/], 3))
		{
			if (Global_85190 < 52)
			{
	...
	while (iVar0 < 20)
	{
		if (unk_0xA921AA820C25702F(Global_97173.f_7311.f_99.f_214[0], iVar0))
		{
			if (Global_85190 < 52)
			{
