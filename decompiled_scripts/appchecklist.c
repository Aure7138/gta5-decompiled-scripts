...
void func_10()
{
	...
	if (Global_14391 == 0)
	{
		if (func_9(2, Global_14382, 0))
		{
			...
			uLocal_129 = unk_0xE8866D60840897A4();
			while (!unk_0x6745682088A5D775(uLocal_129))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
			iVar0 = unk_0x287E98C932B92D48(uLocal_129);
			...
			unk_0x65960B4E2ADC9F6D(18);
			unk_0x65960B4E2ADC9F6D(0);
			unk_0x65960B4E2ADC9F6D(0);
			unk_0x276F16E002D00C0C("CELL_3206");
			unk_0x6DC80A902A91958F(iLocal_126);
			unk_0x354E2E7AA52E941F();
			unk_0xD013AC29829DDC02();
			unk_0x7C38F93AF52620B1(Global_14394, "SET_DATA_SLOT");
			unk_0x65960B4E2ADC9F6D(18);
			...
			unk_0x65960B4E2ADC9F6D(0);
			unk_0x276F16E002D00C0C("CELL_3101");
			unk_0x6DC80A902A91958F(iLocal_127);
			unk_0x354E2E7AA52E941F();
			unk_0xD013AC29829DDC02();
			func_33(Global_14394, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_11()
{
	...
	{
		case 0:
			iLocal_126 = Global_100695;
			iLocal_127 = Global_100712;
			break;
		
		case 1:
			iLocal_126 = (Global_100696 + Global_100697);
			iLocal_127 = (Global_100713 + Global_100714);
			break;
		
		case 2:
			iLocal_126 = Global_100698;
			iLocal_127 = Global_100715;
			break;
		
		case 3:
			iLocal_126 = Global_100699;
			iLocal_127 = Global_100716;
			break;
		
		case 4:
			iLocal_126 = (Global_100700 + Global_100701);
			iLocal_127 = (Global_100717 + Global_100718);
			break;
...
void func_15()
{
	if (Global_14391 == 0)
	{
		if (func_9(2, Global_14382, 0))
		{
			...
			iLocal_128 = unk_0x287E98C932B92D48(uLocal_129);
			if (Global_14413.f_1 > 3)
			{
				Global_14413.f_1 = 8;
				if (iLocal_128 == 0)
...
void func_16()
{
	...
	{
		while (iVar0 < Global_86440)
		{
			func_7(Global_14394, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(18), unk_0xBBDA792448DB5A89(iVar0), unk_0xBBDA792448DB5A89(0), -1f, -1f, &(Global_86231[iVar0 /*4*/]), 0, 0, 0, 0);
			iLocal_115++;
...
{
	return func_19(iParam0, Global_35700);
}
...
void func_20()
{
	...
	while (iVar0 < 7)
	{
		if (Global_82191[iVar0 /*5*/] != -1)
		{
			if (Global_86440 < 52)
			{
				iVar1 = Global_69586.f_109[Global_82191[iVar0 /*5*/] /*4*/];
				MemCopy(&(Global_86231[Global_86440 /*4*/]), {func_24(iVar1)}, 4);
				Global_86440++;
			}
			else
			{
	...
	while (iVar0 < 63)
	{
		if ((unk_0xDCC86F723E82125E(Global_100976.f_17208[iVar0 /*6*/], 0) && unk_0xDCC86F723E82125E(Global_100976.f_17208[iVar0 /*6*/], 1)) && !unk_0xDCC86F723E82125E(Global_100976.f_17208[iVar0 /*6*/], 3))
		{
			if (Global_86440 < 52)
			{
				MemCopy(&(Global_86231[Global_86440 /*4*/]), {func_22(iVar0)}, 4);
				Global_86440++;
			}
			else
			{
	...
	while (iVar0 < 20)
	{
		if (unk_0xDCC86F723E82125E(Global_100976.f_7719.f_99.f_219[0], iVar0))
		{
			if (Global_86440 < 52)
			{
				StringCopy(&(Global_86231[Global_86440 /*4*/]), func_21(iVar0), 16);
				Global_86440++;
			}
			else
			{
...
void func_31()
{
	func_32(0, "CELL_3001", 1, Global_100712);
	func_32(1, "CELL_3008", 3, Global_100712);
	func_32(2, "CELL_3004", 7, Global_100715);
	func_32(3, "CELL_3005", 9, Global_100716);
	func_32(4, "CELL_3007", 11, Global_100717);
}
