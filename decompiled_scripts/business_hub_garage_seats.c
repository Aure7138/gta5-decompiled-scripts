...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		uVar0 = unk_0xB57F0B6D6209FF97(uParam0->f_141.f_1);
		if (unk_0x77FC50899603581D(uVar0))
		{
			unk_0x913ADDC330AF164E(uParam0->f_141.f_1);
		}
	}
}
...
{
	Global_2457726 = iParam0;
	Global_1589291[unk_0xB5CEFD608600A09F() /*770*/].f_769 = iParam0;
}
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_141.f_4)
	{
		...
		case 1:
			...
			if (func_63(uParam0))
			{
				uParam0->f_141.f_6 = unk_0x105601648511CC64();
				func_64(uParam0, 2);
			}
			break;
		
		case 2:
			if (func_62(unk_0xBC25C936A095B5BA(), uParam0[uParam0->f_141.f_2 /*14*/]) && func_61(unk_0xBC25C936A095B5BA(), (uParam0[uParam0->f_141.f_2 /*14*/])->f_8.f_3, (*uParam0)[uParam0->f_141.f_2 /*14*/]))
			{
				if ((func_58(uParam0) || func_54(uParam0)) || !func_53(uParam0))
				{
					func_5(uParam0, 1);
					func_64(uParam0, 1);
				}
				else
				{
					...
					{
						if ((unk_0x105601648511CC64() - uParam0->f_141.f_6) > 150)
						{
							func_52(&(uParam0->f_141.f_5), 4, "MPJAC_SIT", 0, 0, 0, 0);
						}
					}
		...
		case 4:
			func_48(uParam0, &sVar0);
			func_47(uParam0, &sVar16);
			Var20 = { unk_0x883FF674F22D1F7C(&sVar0, &sVar16, func_46(uParam0), func_45(uParam0), 0, 2) };
			Var23 = { unk_0xBFDD14D0A09BE0FA(&sVar0, &sVar16, func_46(uParam0), func_45(uParam0), 0, 2) };
			uVar26 = Var23.f_2;
			fVar27 = 0.05f;
			...
			unk_0xDF14F570C0180463(unk_0xBC25C936A095B5BA(), Var20, 1f, 500, uVar26, fVar27);
		...
		case 5:
			...
			func_48(uParam0, &sVar0);
			func_47(uParam0, &sVar16);
			iVar28 = unk_0xF4FCC3C1048FF2AB(unk_0xBC25C936A095B5BA(), 2106541073);
			Var29 = { unk_0xBFDD14D0A09BE0FA(&sVar0, &sVar16, func_46(uParam0), func_45(uParam0), 0, 2) };
			fVar32 = Var29.f_2;
			if ((iVar28 != 1 && iVar28 != 0) || func_34(unk_0x349C94FFF43E2979(unk_0xBC25C936A095B5BA()), fVar32, 5f))
			{
				uParam0->f_141.f_1 = unk_0xC3B4161C4E86D1FA(func_46(uParam0), func_45(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
				unk_0xE09EEAFD88EC7AA1(unk_0xBC25C936A095B5BA(), uParam0->f_141.f_1, &sVar0, &sVar16, 2f, -1000f, 13, 16, 1148846080, 0);
				unk_0x6013B113B38211A7(uParam0->f_141.f_1);
				uParam0->f_141.f_8.f_4 = unk_0x105601648511CC64();
		...
		case 6:
			...
			{
				func_65(&(uParam0->f_141), 10);
				func_30(uParam0);
			}
			func_35(uParam0);
			func_16(uParam0);
			uVar33 = unk_0xB57F0B6D6209FF97(uParam0->f_141.f_1);
			if (unk_0x77FC50899603581D(uVar33))
			{
				if (unk_0x8FD30584EB38411B(uVar33) >= 1f)
				{
					func_10(uParam0, 0);
					func_48(uParam0, &sVar0);
					func_47(uParam0, &sVar16);
					uParam0->f_141.f_1 = unk_0xC3B4161C4E86D1FA(func_46(uParam0), func_45(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
					unk_0xE09EEAFD88EC7AA1(unk_0xBC25C936A095B5BA(), uParam0->f_141.f_1, &sVar0, &sVar16, 4f, -1.5f, 13, 16, 1148846080, 0);
					unk_0x6013B113B38211A7(uParam0->f_141.f_1);
					func_33(&(uParam0->f_141), 8);
		...
		case 8:
			uVar34 = unk_0xB57F0B6D6209FF97(uParam0->f_141.f_1);
			iVar35 = unk_0xF4FCC3C1048FF2AB(unk_0xBC25C936A095B5BA(), 1785177548);
			if (iVar35 == 0 || iVar35 == 1)
			{
				if (unk_0x77FC50899603581D(uVar34))
				{
					if ((unk_0x8FD30584EB38411B(uVar34) >= 0.7f || unk_0x619CCA1A6FD0BC87(unk_0xBC25C936A095B5BA(), 364629851)) || unk_0x619CCA1A6FD0BC87(unk_0xBC25C936A095B5BA(), 2116425869))
					{
						unk_0x913ADDC330AF164E(uParam0->f_141.f_1);
						func_4(-1);
						func_5(uParam0, 1);
...
void func_10(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((unk_0x105601648511CC64() - uParam0->f_141.f_8.f_4) >= 90000)
		{
			iVar1 = func_11(uParam0);
			if (iVar1 != uParam0->f_141.f_8.f_1)
			{
...
bool func_12()
{
	return func_13(unk_0xB5CEFD608600A09F());
}
...
void func_16(var uParam0)
{
	...
	{
		Var0 = { unk_0x5F9521C8EE73F79F(0, 218), unk_0x5F9521C8EE73F79F(0, 219), 0f };
		fVar3 = unk_0x652D2EEEF1D3E62C(Var0);
		if ((uParam0->f_141.f_4 == 6 && !unk_0x619CCA1A6FD0BC87(unk_0xBC25C936A095B5BA(), -1322051853)) && !func_32(&(uParam0->f_141), 12))
		{
			if ((fVar3 >= 0.35f && !Global_2499382) && !Global_2499384)
			{
				func_29(uParam0);
			}
		}
		...
		else if (Global_2499382 || Global_2499384)
		{
			func_5(uParam0, 1);
		}
		...
		else
		{
			...
			bVar4 = false;
			if (((func_26(func_27()) && func_25()) && func_24(Global_2423644[unk_0xB5CEFD608600A09F() /*406*/].f_305.f_4, 4)) && func_23(Global_2423644[unk_0xB5CEFD608600A09F() /*406*/].f_305.f_4))
			{
				bVar4 = true;
			}
			if (((((!unk_0xE186ACC7BE9B244E() && !func_32(&(uParam0->f_141), 0)) && !func_32(&(uParam0->f_141), 4)) && !func_22()) && !func_20(1)) && uParam0->f_141.f_8.f_2 != 3)
			{
				if (uParam0->f_141.f_5 == -1)
				{
					if (uParam0->f_141.f_8 == 1 || uParam0->f_141.f_8 == 0)
					{
						if (unk_0x50465D2C022B9E04(2))
						{
							if (bVar4)
							{
								if (func_17(unk_0xB5CEFD608600A09F()) == 3)
								{
									func_52(&(uParam0->f_141.f_5), 4, "DJ_SEAT_PC_BM", 0, 0, 0, 0);
								}
								else if (func_17(unk_0xB5CEFD608600A09F()) == 2)
								{
									func_52(&(uParam0->f_141.f_5), 4, "DJ_SEAT_PC_TOU", 0, 0, 0, 0);
								}
								else
								{
									func_52(&(uParam0->f_141.f_5), 4, "DJ_SEAT_PC", 0, 0, 0, 0);
								}
							}
							else
							{
								func_52(&(uParam0->f_141.f_5), 4, "MPOF_AC_PC_EXIT", 0, 0, 0, 0);
							}
						}
						else if (bVar4)
						{
							if (func_17(unk_0xB5CEFD608600A09F()) == 3)
							{
								func_52(&(uParam0->f_141.f_5), 4, "DJ_SEAT_BM", 0, 0, 0, 0);
							}
							else if (func_17(unk_0xB5CEFD608600A09F()) == 2)
							{
								func_52(&(uParam0->f_141.f_5), 4, "DJ_SEAT_TOU", 0, 0, 0, 0);
							}
							else
							{
								func_52(&(uParam0->f_141.f_5), 4, "DJ_SEAT", 0, 0, 0, 0);
							}
						}
						else
						{
							func_52(&(uParam0->f_141.f_5), 4, "MPOF_AC_EXIT", 0, 0, 0, 0);
						}
					}
					else if (uParam0->f_141.f_8 == 2)
					{
						if (unk_0x50465D2C022B9E04(2))
						{
							if (bVar4)
							{
								if (func_17(unk_0xB5CEFD608600A09F()) == 3)
								{
									func_52(&(uParam0->f_141.f_5), 4, "DJ_PSEAT_PC_BM", 0, 0, 0, 0);
								}
								else if (func_17(unk_0xB5CEFD608600A09F()) == 2)
								{
									func_52(&(uParam0->f_141.f_5), 4, "DJ_PSEAT_PC_TOU", 0, 0, 0, 0);
								}
								else
								{
									func_52(&(uParam0->f_141.f_5), 4, "DJ_PSEAT_PC", 0, 0, 0, 0);
								}
							}
							else
							{
								func_52(&(uParam0->f_141.f_5), 4, "MPOFSEAT_PCEXIT", 0, 0, 0, 0);
							}
						}
						else if (bVar4)
						{
							if (func_17(unk_0xB5CEFD608600A09F()) == 3)
							{
								func_52(&(uParam0->f_141.f_5), 4, "DJ_PSEAT_BM", 0, 0, 0, 0);
							}
							else if (func_17(unk_0xB5CEFD608600A09F()) == 2)
							{
								func_52(&(uParam0->f_141.f_5), 4, "DJ_PSEAT_TOU", 0, 0, 0, 0);
							}
							else
							{
								func_52(&(uParam0->f_141.f_5), 4, "DJ_PSEAT", 0, 0, 0, 0);
							}
						}
						else
						{
							func_52(&(uParam0->f_141.f_5), 4, "MPOFSEAT_EXIT", 0, 0, 0, 0);
						}
					}
				}
				if (uParam0->f_141.f_4 == 6)
				{
					...
					if (((unk_0xF7DDAAF0EFDAFA22(2, iVar5) && !unk_0x694514BD37EC4E94(2, 203)) && !Global_2499384) && !Global_2499382)
					{
						func_30(uParam0);
					}
					if (((((unk_0xF7DDAAF0EFDAFA22(2, 203) && !unk_0xF7DDAAF0EFDAFA22(2, iVar5)) && func_26(func_27())) && func_25()) && func_24(Global_2423644[unk_0xB5CEFD608600A09F() /*406*/].f_305.f_4, 4)) && func_23(Global_2423644[unk_0xB5CEFD608600A09F() /*406*/].f_305.f_4))
					{
						Global_2499384 = 1;
						Global_2499382 = 1;
					}
...
bool func_18(int iParam0, int iParam1)
{
	...
	iVar0 = iParam1 + 20;
	return unk_0xFA30DFD0084E92FE(Global_1589291[iParam0 /*770*/].f_273.f_307.f_1, iVar0);
}
...
int func_20(bool bParam0)
{
	if (unk_0x546584EE3E61A6C6())
	{
		...
		{
			if (func_21(unk_0xBC25C936A095B5BA()))
			{
...
int func_21(var uParam0)
{
	...
	if (unk_0xADF4D6B0407B3CC1())
	{
		...
		{
			unk_0x9CDD10270A1ACF6F(uParam0, &iVar0, 1);
...
bool func_23(int iParam0)
{
	...
	return unk_0xFA30DFD0084E92FE(Global_1589291[iParam0 /*770*/].f_273.f_307.f_1, 1);
}
...
int func_24(int iParam0, int iParam1)
{
	...
	{
		case 0:
			return unk_0xFA30DFD0084E92FE(Global_1589291[iParam0 /*770*/].f_273.f_266.f_7, 0);
			break;
		
		case 1:
			return unk_0xFA30DFD0084E92FE(Global_1589291[iParam0 /*770*/].f_273.f_266.f_7, 1);
			break;
		
		case 4:
			return unk_0xFA30DFD0084E92FE(Global_1589291[iParam0 /*770*/].f_273.f_266.f_7, 2);
			break;
		
		case 2:
			return unk_0xFA30DFD0084E92FE(Global_1589291[iParam0 /*770*/].f_273.f_266.f_7, 3);
			break;
		
		case 3:
			return unk_0xFA30DFD0084E92FE(Global_1589291[iParam0 /*770*/].f_273.f_266.f_7, 4);
			break;
		
		case 5:
			return unk_0xFA30DFD0084E92FE(Global_1589291[iParam0 /*770*/].f_273.f_266.f_7, 5);
			break;
	}
	return 0;
}
...
int func_25()
{
	if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -1612.283f, -3021.792f, -76.18069f, -1612.22f, -3005.203f, -74.20517f, 12.75f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
void func_30(var uParam0)
{
	...
	uParam0->f_141.f_1 = unk_0xC3B4161C4E86D1FA(func_46(uParam0), func_45(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
	func_48(uParam0, &sVar0);
	unk_0xE09EEAFD88EC7AA1(unk_0xBC25C936A095B5BA(), uParam0->f_141.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1148846080, 0);
	unk_0x6013B113B38211A7(uParam0->f_141.f_1);
	func_7(&(uParam0->f_141.f_5));
	func_64(uParam0, 8);
}
...
bool func_31()
{
	return unk_0xFA30DFD0084E92FE(Global_1667157.f_3297, 25);
}
...
{
	uParam0->f_141.f_8 = func_51((*uParam0)[uParam0->f_141.f_2 /*14*/]);
	uParam0->f_141.f_8.f_1 = func_50(uParam0);
...
int func_50(var uParam0)
{
	...
	switch (uParam0->f_141.f_8)
	{
		...
		default:
			iVar0 = unk_0x491B2241281A03B7(0, func_14(uParam0->f_141.f_8));
	}
	if (uParam0->f_141.f_8 == 1)
	{
		if (func_12())
...
void func_52(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	int iVar0;
...
int func_54(var uParam0)
{
	...
	while (iVar0 < unk_0x81C86888AEA2F49B())
	{
		if (unk_0x05086B70D2CFEA6F(unk_0xCFA8A401AAD7BB5A(iVar0)))
		{
			...
			if (iVar1 != unk_0xB5CEFD608600A09F() && func_57(iVar1, 1, 1))
			{
				if (func_62(unk_0xA95CF30C72EB526E(iVar1), uParam0[uParam0->f_141.f_2 /*14*/]) || func_56(iVar1) == uParam0->f_141.f_2)
				{
					return 1;
				}
			}
...
int func_55(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((unk_0x724D816EA203A79E(uVar0[iVar11]) && !unk_0x36CEFBE9B745A58D(uVar0[iVar11])) && unk_0x8F6EAC9E7D6812D5(uVar0[iVar11])) && (func_62(uVar0[iVar11], uParam0[uParam0->f_141.f_2 /*14*/]) || unk_0xB7A628320EFF8E47(unk_0x541C2AEF053615BC(uVar0[iVar11], 0), (uParam0[uParam0->f_141.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_141.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar11++;
...
int func_56(int iParam0)
{
	if (iParam0 != func_19())
	{
		return Global_1589291[iParam0 /*770*/].f_769;
	}
	return -1;
}
...
bool func_59()
{
	return func_60(unk_0xB5CEFD608600A09F());
}

bool func_60(int iParam0)
{
	return unk_0xFA30DFD0084E92FE(Global_2423644[iParam0 /*406*/].f_305.f_21, 13);
}

int func_61(var uParam0, struct<3> Param1, int iParam4)
{
	if (unk_0x724D816EA203A79E(uParam0))
	{
		if (iParam4 == 3)
		{
			if (func_34(unk_0x349C94FFF43E2979(uParam0), (Param1.f_2 - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_34(unk_0x349C94FFF43E2979(uParam0), Param1.f_2, 45f))
		{
			return 1;
		}
	}
...
{
	return unk_0x0C265B3C448E6954(uParam0, uParam1->f_1, uParam1->f_1.f_3, uParam1->f_1.f_6, 0, 1, 0);
}
...
void func_66(var uParam0)
{
	...
	else if (uParam0->f_141.f_4 > 4)
	{
		...
		unk_0x215E73A9479A9C9B(unk_0xBC25C936A095B5BA(), func_67());
		uParam0->f_141.f_7 = unk_0xC87A57742F7D3C06();
	}
	else if ((unk_0xC87A57742F7D3C06() - uParam0->f_141.f_7) < 5)
	{
		unk_0x215E73A9479A9C9B(unk_0xBC25C936A095B5BA(), func_67());
	}
}
...
{
	func_69(&(uParam0->f_141), 4, func_70());
	func_69(&(uParam0->f_141), 1, unk_0x1D403DFADBC2DE3C(unk_0xBC25C936A095B5BA(), 0));
	func_69(&(uParam0->f_141), 3, unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 1));
	func_69(&(uParam0->f_141), 0, func_44(0));
	func_69(&(uParam0->f_141), 2, unk_0x226A1FD8C273ADE9(unk_0xBC25C936A095B5BA()));
}
...
void func_69(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		unk_0xF0059F27F7BB6680(uParam0, uVar0);
	}
	else
	{
...
int func_71()
{
	...
	if (Global_2423644[unk_0xB5CEFD608600A09F() /*406*/].f_305.f_4 == func_19())
	{
		return 1;
	}
	return 0;
...
int func_82()
{
	if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -1502.824f, -3006.31f, -80.557f, -1513.824f, -3006.31f, -84.557f, 9.5f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_83()
{
	if (Global_2423644[unk_0xB5CEFD608600A09F() /*406*/].f_305.f_4 != func_19())
	{
		if (unk_0x18C4EA3345AA5A99("business_hub_garage_seats", Global_2423644[unk_0xB5CEFD608600A09F() /*406*/].f_305.f_4, 1, 0))
		{
			return 0;
		}
		unk_0xBF463BC3D6FFDE31(32, 0, Global_2423644[unk_0xB5CEFD608600A09F() /*406*/].f_305.f_4);
		func_91(0, -1, 0);
...
void func_84()
{
	func_85(0, &uLocal_144, 0, 2);
	func_85(1, &uLocal_144, 1, 1);
	func_85(2, &uLocal_144, 2, 2);
	func_85(3, &uLocal_144, 3, 1);
	func_85(4, &uLocal_144, 4, 2);
	func_85(5, &uLocal_144, 5, 1);
	func_85(6, &uLocal_144, 6, 2);
	func_85(7, &uLocal_144, 7, 1);
	func_85(8, &uLocal_144, 8, 1);
}
