	...
	switch (uParam0->f_141.f_4)
	{
		...
		case 5:
			...
			if ((iVar28 != 1 && iVar28 != 0) || func_34(unk_0xCFC0C995455A6204(unk_0x4A8C381C258A124D()), fVar32, 5f))
			{
				...
				unk_0x0B94AB707B44E754(unk_0x4A8C381C258A124D(), uParam0->f_141.f_1, &sVar0, &sVar16, 2f, -1000f, 13, 16, 1148846080, 0);
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			uVar33 = unk_0x643DC062EE904FCA(uParam0->f_141.f_1);
			if (unk_0x5266F1D2AEF6F73A(uVar33))
			{
				if (unk_0xBD3B265153D3BA2D(uVar33) >= 1f)
				{
					...
					func_49(uParam0, &sVar16);
					uParam0->f_141.f_1 = unk_0xBC5D9A293974F095(func_48(uParam0), func_47(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
					unk_0x0B94AB707B44E754(unk_0x4A8C381C258A124D(), uParam0->f_141.f_1, &sVar0, &sVar16, 4f, -1.5f, 13, 16, 1148846080, 0);
					unk_0xE7101255AD6F1952(uParam0->f_141.f_1);
					func_33(&(uParam0->f_141), 8);
		...
		case 8:
			uVar34 = unk_0x643DC062EE904FCA(uParam0->f_141.f_1);
...
int func_57(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((unk_0xFC8BFE4B41177C22(uVar0[iVar11]) && !unk_0x4FAFF4BCB7633475(uVar0[iVar11])) && unk_0xE5E2AE8B19267B8A(uVar0[iVar11])) && (func_63(uVar0[iVar11], uParam0[uParam0->f_141.f_2 /*14*/]) || unk_0xB7A628320EFF8E47(unk_0xD1A6A821F5AC81DB(uVar0[iVar11], 0), (uParam0[uParam0->f_141.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_141.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar11++;
...
int func_82()
{
	if (Global_2657589[unk_0x259BE71D8A81D4FA() /*466*/].f_321.f_10 != func_19())
	{
		if (unk_0x99F8FC8A6D8E20C0("business_hub_garage_seats", Global_2657589[unk_0x259BE71D8A81D4FA() /*466*/].f_321.f_10, 1, 0))
		{
			return 0;
		}
