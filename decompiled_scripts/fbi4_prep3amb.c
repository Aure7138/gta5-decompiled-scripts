		...
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_105, 1))
			{
				if (!func_78(unk_0xE2D3D51028F0428A(), Local_106, 5f))
				{
					...
					{
						if ((func_251(unk_0xE2D3D51028F0428A()) && !BitTest(uLocal_101[0], 17)) && !BitTest(uLocal_101[1], 18))
						{
...
int func_186()
{
	...
	while (iVar6 <= 4)
	{
		if (func_251(uVar0[iVar6]) && uVar0[iVar6] != unk_0xE2D3D51028F0428A())
		{
...
int func_222(var uParam0)
{
	...
	if (func_251(unk_0xE2D3D51028F0428A()) && unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
	{
		iVar0 = unk_0x9993EF7FDBCDB632();
		if (func_87(iVar0))
		{
...
void func_225(bool bParam0, bool bParam1)
{
	...
	{
		case 1:
			if ((!unk_0xF847447D4467709D() && !func_228(func_91())) && !func_227())
			{
