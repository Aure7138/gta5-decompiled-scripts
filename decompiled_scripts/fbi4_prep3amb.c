		...
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_105, 1))
			{
				if (!func_78(unk_0x4A8C381C258A124D(), Local_106, 5f, 1))
				{
					...
					{
						if ((func_251(unk_0x4A8C381C258A124D()) && !BitTest(uLocal_101[0], 17)) && !BitTest(uLocal_101[1], 18))
						{
...
int func_186()
{
	...
	while (iVar6 <= 4)
	{
		if (func_251(uVar0[iVar6]) && uVar0[iVar6] != unk_0x4A8C381C258A124D())
		{
...
int func_207()
{
	if (unk_0xB7A628320EFF8E47(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), 855.7258f, -2344.491f, 29.33145f) <= 52900f)
	{
		if (func_13())
		{
			func_71(28);
	...
	else if (unk_0xB7A628320EFF8E47(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), 1383.21f, -2068.02f, 51.87057f) <= 160000f)
	{
		if (func_13())
		{
			func_71(29);
