...
void __EntryFunction__()
{
	...
	iLocal_1705 = 1;
	iLocal_1727 = -1;
	iLocal_1730 = unk_0xBAC643F143880136(5, 15);
	iLocal_1735 = unk_0xBAC643F143880136(5, 10);
	iLocal_1740 = 1000;
	fLocal_1752 = 0.5f;
	fLocal_1756 = 15f;
	...
	if (unk_0xD4BE58A7E3E102AC(3))
	{
		...
		func_542();
		func_540();
		if (unk_0xD4B321D9096B01FC(iLocal_1646))
		{
			unk_0x2BBEC4B37B923F4B(iLocal_1646, 1, 0);
			unk_0x8C85E8C71AD74415(iLocal_1646, 1, 0);
			unk_0xE679FB04E61F88AA(iLocal_1646, 1);
		}
		func_539();
	...
	while (true)
	{
		...
		unk_0x643E26919A174002("M_ASS4", 0);
		if (func_487(&uScriptParam_0))
		{
			if (func_486())
			{
				...
				func_483();
				unk_0x9E64FD43AF331B00(uLocal_1808[0], 0);
				unk_0x9E64FD43AF331B00(uLocal_1808[1], 0);
				unk_0x9E64FD43AF331B00(uLocal_1808[2], 0);
				unk_0x9E64FD43AF331B00(uLocal_1808[3], 0);
				unk_0x9E64FD43AF331B00(uLocal_1808[4], 0);
				unk_0x9E64FD43AF331B00(uLocal_1808[5], 0);
		...
		else if (!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
		{
			...
			{
				Global_111560.f_19958.f_8 = func_165(&uLocal_1038);
				fLocal_134 = Global_111560.f_19958.f_8;
				func_164();
				func_114();
...
void func_114()
{
	if (unk_0xD4B321D9096B01FC(iLocal_1805) && unk_0xD960230552BC4165(iLocal_1805, 0))
	{
...
{
	if ((((((((((!unk_0xD4B321D9096B01FC(iParam0) || !unk_0xD960230552BC4165(iParam0, 0)) || func_133(iParam0, 0, 0)) || func_133(iParam0, 1, 0)) || func_133(iParam0, 2, 0)) || func_156(iParam0) != 145) || func_132(iParam0)) || func_131(iParam0)) || func_130(iParam0)) || func_129(iParam0)) || !func_119(unk_0x7F375072508F738F(iParam0)))
	{
		if (func_131(iParam0))
		{
		}
...
var func_136()
{
	...
	func_146(&uVar0, unk_0xCA3729F4C3A9E58A());
	func_145(&uVar0, unk_0x8F7802EF0E800F47());
	func_144(&uVar0, unk_0xA63165E74E9A042B());
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_142(unk_0xA2BC31158C8CEFD2(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (unk_0xD960230552BC4165(iParam0, 0))
	{
		...
		*uParam1 = unk_0x15573EDB7C261B90(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xA1E7A40E1F56E511(&(uParam1->f_77), func_159(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_164()
{
	...
	while (iVar0 < 4)
	{
		...
		while (iVar1 <= 2)
		{
			if (!unk_0x2BF5E63466422C38(Local_2246[iVar0 /*30*/].f_14[iVar1]) && unk_0x5294582CE404D3F4(Local_2246[iVar0 /*30*/].f_14[iVar1], 0))
			{
				unk_0xDEB0AA30ABFDCF48(Local_2246[iVar0 /*30*/].f_14[iVar1], 3, 0);
				unk_0x3A6FD57A8EC62253(Local_2246[iVar0 /*30*/].f_14[iVar1], 2, 0);
				unk_0x7D81B41B134BD6F2(Local_2246[iVar0 /*30*/].f_14[iVar1], 1);
			}
			iVar1++;
		}
		iVar0++;
...
float func_165(var uParam0)
{
	if (func_168(uParam0))
	{
		...
		{
			return (func_166(unk_0xA2BC31158C8CEFD2(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
int func_169(var uParam0, var uParam1)
{
	...
	switch (iLocal_1042)
	{
		...
		case 4:
			...
			func_460();
			unk_0xB6C190A9FAFAEC2F(*uParam0, 1);
			...
			if (bLocal_1703)
			{
				...
				{
					func_455(&uLocal_1038, Global_111560.f_19958.f_8);
				}
				if (iLocal_1750 == 0)
				{
		...
		case 6:
			if (!unk_0xC862E94A8ABC89B8())
			{
				...
				{
					unk_0xAA2276003B2ADF1B(&(uParam1->f_2));
		...
		case 7:
			...
			{
				func_372();
				if (func_370(uParam0->f_6, fLocal_1756) && unk_0xB5ACA45580455592(unk_0x7C7787D2D7139A85()))
				{
					if (unk_0x39A01A052D9B5FF0(uParam1->f_2))
					{
						unk_0xAA2276003B2ADF1B(&(uParam1->f_2));
			...
			{
				uParam1->f_2 = unk_0xACAD99314B51277E(uParam0->f_6);
			...
			func_365(uParam1);
			func_364();
			if ((((unk_0x586E95A1CE46FC21(unk_0x7C7787D2D7139A85(), 0) && func_363(uParam1->f_1, 1) < fLocal_1756) || !func_362(uParam1->f_1)) || unk_0x54D242CA888C9BF1(-1, uParam0->f_9, 25f)) || unk_0x3656B691E303FDE0(uParam1->f_1, unk_0x0FA8183DAD2B3203(), 1))
			{
		...
		case 10:
			...
			if (func_350(&Local_1045, uParam0))
			{
				if (iLocal_1027 == 1)
				{
					if (unk_0x780F6A9A674A5ECD(*uParam1, &iVar0) && iVar0 != -1)
					{
						if (!func_349(*uParam1))
						{
							unk_0x913D0E0BA9220F9C("scr_ojbusass_bus_impact", *uParam1, 0f, 0f, 0f, unk_0xDF29CF810DF94B60(uParam1->f_1), iVar0, 2f, 0, 0, 0);
						}
					}
					else if (!func_349(*uParam1))
					{
						unk_0x913D0E0BA9220F9C("scr_ojbusass_bus_impact", *uParam1, 0f, 0f, 0f, unk_0xDF29CF810DF94B60(uParam1->f_1), 31086, 2f, 0, 0, 0);
					}
				}
...
int func_174(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x393E9918BC37548A())
	{
		if (func_176() == 0)
		{
			return unk_0xA2BC31158C8CEFD2(func_19(func_175(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_179()
{
	if (!iLocal_1722)
	{
		if (unk_0xEBE4F888D9965006(unk_0x7C7787D2D7139A85()) > 0)
		{
			...
			{
				unk_0x2136EFCE710EB280("SCRIPTED_SCANNER_REPORT_ASS_BUS_01", 0f);
				iLocal_1722 = 1;
			}
		}
	}
...
int func_189()
{
	...
	if (unk_0x7C7787D2D7139A85() == func_192())
	{
		return 0;
	}
	if (func_190(unk_0x7C7787D2D7139A85()))
	{
		return 0;
	}
...
int func_202(var uParam0)
{
	...
	{
		case 0:
			if (!unk_0xF4B969E0807E76C7(uParam0->f_1, 0) && !unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
			{
		...
		case 1:
			if (!unk_0xF4B969E0807E76C7(uParam0->f_1, 0) && !unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
			{
				if (!unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), uParam0->f_1, 0))
				{
					Var3 = { unk_0xACE5E491FC1B0D37(uParam0->f_1, 0) };
			...
			else if (!unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0) && unk_0xD4B321D9096B01FC(uParam0->f_1))
			{
				if (!unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), uParam0->f_1, 0))
				{
					Var3 = { unk_0xACE5E491FC1B0D37(uParam0->f_1, 0) };
		...
		case 2:
			...
			if (unk_0xB7A628320EFF8E47(Var3, Var0) > 2500f)
			{
				...
				{
					unk_0x38C6C3B6F4074898("ASS_BS_EXIT");
				}
				return 1;
			}
			break;
...
void func_204(int iParam0, bool bParam1)
{
	...
	if (func_165(&uLocal_1837) > fLocal_1757)
	{
		...
		iVar1 = unk_0xBAC643F143880136(0, 2);
		if (unk_0xD960230552BC4165(iParam0, 0))
		{
			iVar2 = unk_0x300C62F79A4441EB(iParam0, iVar0, 0);
			if (!unk_0x2BF5E63466422C38(iVar2))
			{
				if (!bParam1)
				{
					if (iVar1 == 0)
					{
						unk_0x308CB1217E10567C(iVar2, 6, 0, 0);
					}
					else if (iVar1 == 1)
					{
						unk_0x308CB1217E10567C(iVar2, 7, 0, 0);
					}
					else if (iVar1 == 2)
					{
						unk_0x308CB1217E10567C(iVar2, 3, 0, 0);
					}
				}
			}
		}
		fLocal_1757 = unk_0x64A3FFD9D62755C5(0f, 3f);
		func_183(&uLocal_1837);
	}
}
...
void func_206(var uParam0)
{
	...
	else if (unk_0xD960230552BC4165(uParam0->f_1, 0))
	{
		if (unk_0xD4B321D9096B01FC(*uParam0))
		{
			...
			{
				if (unk_0xD960230552BC4165(uParam0->f_8, 0) && unk_0x95ED3BD0F52D542A(*uParam0, uParam0->f_8, 0))
				{
					if (unk_0x7A10CED38342D31F(uParam0->f_1, *uParam0) || unk_0x7A10CED38342D31F(uParam0->f_1, uParam0->f_8))
					{
						func_183(&uLocal_1035);
					}
				}
				else if (unk_0x7A10CED38342D31F(uParam0->f_1, *uParam0) || unk_0x7A10CED38342D31F(uParam0->f_1, uParam0->f_8))
				{
					func_183(&uLocal_1035);
				}
			}
...
void func_207(var uParam0, var uParam1)
{
	...
	switch (iLocal_1461)
	{
		...
		case 2:
			if (unk_0x3656B691E303FDE0(uParam1->f_1, unk_0x0FA8183DAD2B3203(), 1))
			{
				func_352(Local_1462, uParam0, 2);
				return;
			}
			if (unk_0xD960230552BC4165(uParam1->f_1, 0))
			{
				...
				{
					func_339();
					unk_0x0A43D5D11052D038(joaat("bus"), 1);
					if (unk_0x39A01A052D9B5FF0(uParam1->f_2))
					{
						unk_0xAA2276003B2ADF1B(&(uParam1->f_2));
					}
	...
	if (iLocal_1461 > 4)
	{
		if (func_225(*uParam1, 175f, 0))
		{
			...
			{
				if (!unk_0x62E95D2FED28E41C(*uParam1) || unk_0x7FB035B5755E076D(*uParam1))
				{
					if (unk_0x39A01A052D9B5FF0(uParam1->f_2))
					{
						unk_0xAA2276003B2ADF1B(&(uParam1->f_2));
			...
			if (func_165(&uLocal_1831) > 5f)
			{
				if (iLocal_1696)
				{
					if (unk_0xD960230552BC4165(uParam0->f_1, 0))
					{
						if (unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), uParam0->f_1, 0))
						{
							fVar0 = unk_0xB8D4A2BAA78AB950(uParam0->f_1);
							if (fVar0 > 10f)
							{
								if (!unk_0x2BF5E63466422C38(*uParam0))
								{
									...
									{
										if (unk_0xD960230552BC4165(uParam0->f_8, 0))
										{
											if (unk_0x95ED3BD0F52D542A(*uParam0, uParam0->f_8, 0))
											{
												func_220(uParam0);
											}
											else if (!iLocal_1694)
...
{
	if (!unk_0x2BF5E63466422C38(iParam1) && unk_0x95ED3BD0F52D542A(iParam1, uParam0->f_1, 0))
	{
		return 1;
	}
	return 0;
...
void func_214(var uParam0)
{
	...
	iVar0 = unk_0x35D31BEBAFD53DE6(uParam0->f_1);
	switch (iLocal_1741)
	{
		case 0:
			if (unk_0x45E40FFF88F2D4D9(uParam0->f_1) >= 2)
			{
				iLocal_1740 = unk_0x35D31BEBAFD53DE6(uParam0->f_1);
				iLocal_1741++;
			}
			break;
		...
		case 1:
			if (!func_221())
			{
				if (iVar0 < (iLocal_1740 - 50) || unk_0xC29ACA630455C49B(uParam0->f_1))
				{
					if (func_213(uParam0, iLocal_1791))
					{
						func_201(&(uParam0->f_16), 4, iLocal_1791, "BusPed1", 0, 1);
		...
		case 2:
			if (!func_221())
			{
				if (iVar0 < (iLocal_1740 - 150) || unk_0xC29ACA630455C49B(uParam0->f_1))
				{
					if (func_213(uParam0, iLocal_1792))
					{
						func_201(&(uParam0->f_16), 5, iLocal_1792, "BusPed2", 0, 1);
		...
		case 3:
			if (!func_221())
			{
				if (iVar0 < (iLocal_1740 - 200) || unk_0xC29ACA630455C49B(uParam0->f_1))
				{
...
{
	iLocal_1735 = unk_0xBAC643F143880136(iParam0, iParam1);
	func_183(&uLocal_1825);
	func_183(&uLocal_1831);
	iLocal_1731++;
}
...
{
	iLocal_1730 = unk_0xBAC643F143880136(iParam0, iParam1);
	func_183(&uLocal_1822);
	func_183(&uLocal_1831);
	iLocal_1729++;
}
...
void func_222(var uParam0, var uParam1)
{
	if (iLocal_1461 < 4)
	{
		if (unk_0xD4B321D9096B01FC(uParam1->f_1))
		{
			...
			if (unk_0x812D517F863583BE(uParam1->f_1, 0, 1000))
			{
				func_352(Local_1462, uParam0, 3);
			}
			if (iLocal_1461 >= 3)
			{
				if (unk_0xD960230552BC4165(uParam1->f_1, 0))
				{
					if (!unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), uParam1->f_1, 0))
					{
						if (bLocal_1692 == 1)
						{
							bLocal_1692 = false;
		...
		if (!bLocal_1692)
		{
			if (!unk_0xF4B969E0807E76C7(uParam1->f_1, 0))
			{
				Local_1779 = { unk_0xACE5E491FC1B0D37(uParam1->f_1, 1) };
			}
			if (!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
			{
				Local_1782 = { unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1) };
			}
...
void func_223(var uParam0)
{
	if (func_168(uParam0))
	{
		if (!func_167(uParam0))
		{
			uParam0->f_2 = (func_166(unk_0xA2BC31158C8CEFD2(*uParam0, 4)) - uParam0->f_1);
...
void func_224()
{
	unk_0xAA2276003B2ADF1B(&(Local_2246[0 /*30*/].f_9));
	unk_0xAA2276003B2ADF1B(&(Local_2246[1 /*30*/].f_9));
	unk_0xAA2276003B2ADF1B(&(Local_2246[2 /*30*/].f_9));
	unk_0xAA2276003B2ADF1B(&(Local_2246[3 /*30*/].f_9));
}
...
void func_226(var uParam0, var uParam1)
{
	if (!iLocal_1691 == 1)
	{
		if (iLocal_1461 < 4)
		{
			if (((((func_235(*uParam1, 0, &uLocal_122, &uLocal_133, 0, 0, 0, 1, 1) || func_233(&uLocal_1728)) || iLocal_1738 >= 2) || unk_0xEBE4F888D9965006(unk_0x7C7787D2D7139A85()) > 0) || !unk_0xD960230552BC4165(uParam1->f_1, 0)) || func_232(*uParam1, uParam1->f_8, 1097859072))
			{
				if (unk_0xEBE4F888D9965006(unk_0x7C7787D2D7139A85()) > 0)
				{
				}
				...
				if (unk_0xD960230552BC4165(uParam1->f_1, 0))
				{
					if (unk_0xD4B321D9096B01FC(*uParam1))
					{
						if (!unk_0x2BF5E63466422C38(*uParam1))
						{
							if (func_363(*uParam1, 1) < 30f || unk_0x3656B691E303FDE0(*uParam1, unk_0x0FA8183DAD2B3203(), 1))
							{
								func_224();
								if (unk_0x39A01A052D9B5FF0(uParam1->f_2))
								{
								...
								iLocal_1695 = 1;
								if ((func_230(uParam1) && !unk_0x62E95D2FED28E41C(uParam1->f_1)) && !unk_0x62E95D2FED28E41C(*uParam1))
								{
									unk_0xB425E338F85508A5(*uParam1, uParam1->f_8, -1);
...
{
	unk_0xBA0ADF29DCCA9258(unk_0x7C7787D2D7139A85(), iParam0, 0);
	unk_0xF1E958D9BB4D1EF6(unk_0x7C7787D2D7139A85(), 0);
	unk_0xA79E892D0DDB947B(unk_0x7C7787D2D7139A85(), iParam1);
...
void func_228(var uParam0, var uParam1)
{
	if (unk_0xD960230552BC4165(*uParam1, 0))
	{
		if (!unk_0x2BF5E63466422C38(*uParam0))
		{
			if (unk_0x95ED3BD0F52D542A(*uParam0, *uParam1, 0))
			{
				if (!unk_0x7271314D6DEBF5AE(*uParam1))
				{
...
{
	unk_0x9B9D9C83AC80FFE4(iParam0, uParam1, "OJASbs_102", 52, 0, 20, -1, -1082130432, 0, 1073741824);
	Local_1758 = { -455.2892f, -326.1364f, 41.22218f };
	unk_0xA871F3C63A1AA375("OJASbs_102", &iLocal_1748);
	unk_0xDA778D908FD69EEE(iParam0, 1, 1);
	fLocal_1753 = unk_0x4683A25541D81B5D(uParam1);
	unk_0xB9470B741AA0818C(uParam1, (fLocal_1752 * 100f));
	unk_0xDEB0AA30ABFDCF48(iParam0, 3, 1);
	unk_0xD32341B4ADEC0821(uParam1, 1.5f);
}

int func_230(var uParam0)
{
	if (!unk_0xF4B969E0807E76C7(uParam0->f_1, 0) && !unk_0xF4B969E0807E76C7(uParam0->f_8, 0))
	{
		if (unk_0xD960230552BC4165(uParam0->f_1, 0))
		{
			if (unk_0xD960230552BC4165(uParam0->f_8, 0))
			{
				if (func_231(uParam0->f_8, Local_2246[iLocal_1727 /*30*/].f_5, 1) > 5f || unk_0x7A10CED38342D31F(uParam0->f_1, uParam0->f_8))
				{
					return 0;
				}
			}
...
int func_232(int iParam0, int iParam1, float fParam2)
{
	if (unk_0xD4B321D9096B01FC(iParam1))
	{
		if (unk_0xD960230552BC4165(iParam1, 0))
		{
			...
			else if (unk_0x7A10CED38342D31F(unk_0x0FA8183DAD2B3203(), iParam1))
			{
				return 1;
			}
		}
...
int func_234()
{
	if (bLocal_1692)
	{
		if (!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
		{
			...
			{
				if (unk_0x90D8021D13215A35(unk_0x0FA8183DAD2B3203()) && !unk_0x64F825FCEFC07239(unk_0x0FA8183DAD2B3203()))
				{
					return 1;
				}
			}
...
int func_236(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_237(unk_0x0FA8183DAD2B3203(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (unk_0x3DAA08BFD9A801FD(iParam0) && func_363(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_239(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (unk_0x9DCEF22792B5C15C(iParam0, 2))
	{
		...
		else
		{
			...
			if (unk_0x7E1657C6CCABF258(iParam0) || func_240(iVar3))
			{
				if (unk_0xC49563EAE7AACA6C(iParam1, unk_0xACE5E491FC1B0D37(iParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (unk_0x9B1F9CEC0CB28F35(unk_0x3D464779B732760F(iParam1), iParam0, 120f) && unk_0x20510084026BC387(iParam1, iParam0, 17))
		...
		if (unk_0xD960230552BC4165(iParam0, 0))
		{
			if (unk_0x300C62F79A4441EB(iParam0, -1, 0) != 0)
			{
				if (unk_0x63EA4FAF7CDEFEC7(unk_0x0FA8183DAD2B3203(), &iVar0, 1))
				{
					...
					{
						if (func_241(unk_0x0FA8183DAD2B3203(), iParam0, 1) < 40f)
						{
...
void func_243(var uParam0)
{
	if (!unk_0x2BF5E63466422C38(*uParam0))
	{
		if (!unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
		{
			if ((unk_0x411C065ADB822CD9(*uParam0, 1805844857) != 1 && unk_0x411C065ADB822CD9(*uParam0, -1824940423) != 1) && unk_0x411C065ADB822CD9(*uParam0, 242628503) != 1)
			{
				unk_0xF0E9590A910B74BE(*uParam0, unk_0x0FA8183DAD2B3203(), 500f, -1, 0, 0);
			}
			unk_0x4465F4659EE7FAE4(*uParam0, 2f);
		}
		else if (((unk_0x411C065ADB822CD9(*uParam0, 1805844857) != 1 && unk_0x411C065ADB822CD9(*uParam0, 1805844857) != 0) && unk_0x411C065ADB822CD9(*uParam0, 242628503) != 1) && unk_0x411C065ADB822CD9(*uParam0, 242628503) != 0)
		{
			unk_0xF0E9590A910B74BE(*uParam0, unk_0x0FA8183DAD2B3203(), 500f, -1, 0, 0);
		}
	}
	...
	if (!unk_0x39A01A052D9B5FF0(uParam0->f_2))
	{
		if (!unk_0x2BF5E63466422C38(*uParam0))
		{
			if (iParam1 || !func_221())
			{
				...
				uParam0->f_2 = unk_0xADA89D4F1A58FCBA(*uParam0);
...
void func_249(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_272(iParam1) && unk_0x0975E9E48EA2CC7B(iParam1))
	{
		iVar1 = 0;
...
{
	if (func_272(unk_0x0FA8183DAD2B3203()))
	{
...
int func_254(char* sParam0)
{
	if (!func_255(1, 1, 0))
	{
		if ((!unk_0x9591DE0F00127F2A(sParam0) && func_274(sParam0)) || func_274("CMN_HINT"))
		{
			unk_0x0D23E3918F7AF11B(1);
		}
		return 0;
...
int func_255(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_262() || func_261(Global_4456448.f_190930)) || func_260())
	{
		if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
		{
			...
			iVar1 = func_259(unk_0x0FA8183DAD2B3203(), 0);
			if (((unk_0x2068C310844A89D8(iVar0, iVar1) || (unk_0x7F375072508F738F(iVar0) == joaat("apc") && iVar1 != -1)) || (unk_0x7F375072508F738F(iVar0) == joaat("akula") && iVar1 != -1)) || (((unk_0x7F375072508F738F(iVar0) == joaat("riot2") && iVar1 == 0) && func_258(iVar0, 10)) && unk_0xF05B9E4C6631EA28(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_256(int iParam0)
{
	if (iParam0 != func_192())
	{
		...
		else if ((Global_1312873 && iParam0 == unk_0x7C7787D2D7139A85()) && func_257(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
bool func_265()
{
	return func_266(unk_0x7C7787D2D7139A85());
}
...
int func_267(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_270(bParam1, bParam2, bParam3) || unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((unk_0x9B35D07DCD0F0B43() - uParam0->f_4) > 500)
			{
				...
				{
					if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 1) || func_268(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_275(int iParam0, int iParam1, var uParam2)
{
	if (unk_0xD960230552BC4165(iParam1, 0))
	{
		if (!unk_0xF4B969E0807E76C7(iParam0, 0))
		{
			if (unk_0x5294582CE404D3F4(iParam0, 0))
			{
				if (!unk_0x7271314D6DEBF5AE(iParam1))
				{
					if (unk_0x411C065ADB822CD9(iParam0, 451360105) != 1 && unk_0x411C065ADB822CD9(iParam0, 451360105) != 0)
					{
						unk_0x3D1E9B6872B0AE00(iParam0, iParam1, 0);
					}
				}
				else
				{
			...
			else if (unk_0x411C065ADB822CD9(iParam0, 713668775) != 1 && unk_0x411C065ADB822CD9(iParam0, -1794415470) != 1)
			{
				func_276(iParam0);
			}
		}
...
void func_276(int iParam0)
{
	...
	if (!unk_0xF4B969E0807E76C7(iParam0, 0))
	{
		if (unk_0x411C065ADB822CD9(iParam0, 242628503) != 1 && unk_0x411C065ADB822CD9(iParam0, 242628503) != 0)
		{
			if (func_231(iParam0, Local_1758, 1) <= 50f)
			{
				unk_0x78829A259A6975CD(&uVar0);
				unk_0xA12E1659DEF57244(&uVar0);
				unk_0x2DA4721F22121754(0, Local_1758, 2f, 0, 0, 786603, -1082130432);
...
void func_278(int iParam0, int iParam1)
{
	...
	if (func_165(&uLocal_1834) > 1f)
	{
		...
		if (unk_0xD4B321D9096B01FC(iParam0) && unk_0xD960230552BC4165(iParam1, 0))
		{
			if (unk_0x7271314D6DEBF5AE(iParam1))
			{
				if (fVar0 > 150f)
				...
				iVar1 = unk_0xDD79C2CC8061EFC4(iParam1);
				...
				if (fLocal_1754 != 0f)
				{
					unk_0x22C7063B80BCBEF1(iParam0, fLocal_1754);
				}
			}
		}
	}
...
void func_279()
{
	if (!iLocal_1710)
	{
		if (!unk_0x2BF5E63466422C38(iLocal_1846))
		{
			unk_0xC6612209077465DD(iLocal_1846);
			unk_0x5D672CB011E20B28(iLocal_1846, "oddjobs@assassinate@bus@", "looking_for_help", 8f, -8f, -1, 1, 0, 0, 0, 0);
			unk_0x308CB1217E10567C(iLocal_1846, 6, 0, 0);
			iLocal_1710 = 1;
		}
	}
	else if (unk_0xD4B321D9096B01FC(iLocal_1846))
	{
		if (func_235(iLocal_1846, 0, &uLocal_122, &uLocal_133, 0, 0, 0, 1, 1))
		{
			if (unk_0x411C065ADB822CD9(iLocal_1846, 1805844857) != 1)
			{
				unk_0xC6612209077465DD(iLocal_1846);
				unk_0xF0E9590A910B74BE(iLocal_1846, unk_0x0FA8183DAD2B3203(), 1000f, -1, 0, 0);
			}
		}
		if (func_363(iLocal_1846, 1) > 100f)
		{
			if (!unk_0x62E95D2FED28E41C(iLocal_1846) || unk_0x7FB035B5755E076D(iLocal_1846))
			{
				unk_0x4F058F27442031CC(&iLocal_1846);
			}
		}
	}
}
	...
	switch (iLocal_1726)
	{
		case 0:
			if (func_300(1, 3f))
			{
				...
				if (!unk_0xF4B969E0807E76C7(uParam1->f_1, 0))
				{
					unk_0xE56FA7CB317C0282(uParam1->f_1, 1);
				}
				...
				{
					unk_0x38F2C110546BD846(*uParam0, "Mugger", 0, unk_0x7F375072508F738F(*uParam0), 0);
				}
				if (!unk_0xF4B969E0807E76C7(iLocal_1846, 0))
				{
					unk_0x38F2C110546BD846(iLocal_1846, "Mugging_Victim", 0, joaat("a_f_o_genstreet_01"), 0);
				}
				if (!unk_0xF4B969E0807E76C7(uParam1->f_1, 0))
				{
					if (bLocal_1713)
					{
						unk_0x38F2C110546BD846(uParam1->f_1, "Franklins_Coach", 0, joaat("coach"), 0);
						unk_0x38F2C110546BD846(0, "Franklins_Bus", 3, joaat("bus"), 0);
					}
					else
					{
						unk_0x38F2C110546BD846(uParam1->f_1, "Franklins_Bus", 0, joaat("bus"), 0);
						unk_0x38F2C110546BD846(0, "Franklins_Coach", 3, joaat("coach"), 0);
					}
				}
				if (!unk_0xF4B969E0807E76C7(uParam1->f_8, 0))
				{
					unk_0x38F2C110546BD846(uParam1->f_8, "Stolen_Bike", 0, joaat("scorcher"), 0);
				}
		...
		case 1:
			if (unk_0x33D7ABC47E81DCF9())
			{
				...
				if (unk_0xD2652A8A890B29BA(uLocal_1806) && unk_0x1F70CA72458DB6BD(uLocal_1806))
				{
					unk_0x0472F75F711AABCE(uLocal_1806, 0);
					unk_0xDC5BA18043353983(uLocal_1806, 0);
					unk_0x0298C8010FD5A69E(0, 0, 3000, 1, 0, 0);
				}
				else if (unk_0xD2652A8A890B29BA(uLocal_1806))
				{
					unk_0xDC5BA18043353983(uLocal_1806, 0);
				}
				if ((unk_0xD4B321D9096B01FC(*uParam0) && !unk_0x2BF5E63466422C38(*uParam0)) && unk_0xD960230552BC4165(uParam1->f_8, 0))
				{
					if (unk_0xDFB741CB32BE818E("Mugger", 0) && unk_0xDFB741CB32BE818E("Stolen_Bike", 0))
					{
						unk_0x31A7662B885C7549(*uParam0, uParam1->f_8, 20000, -1, 2f, 1, 0);
						unk_0xDEB0AA30ABFDCF48(*uParam0, 3, 0);
						unk_0x53F3ED9BDCD06444(*uParam0, 3);
						func_229(*uParam0, uParam1->f_8);
						iLocal_1696 = 1;
					}
				}
				if (unk_0xDFB741CB32BE818E("Mugging_Victim", 0))
				{
					if (unk_0xD4B321D9096B01FC(iLocal_1846) && !unk_0x2BF5E63466422C38(iLocal_1846))
					{
						func_279();
					}
				}
				...
				{
					if (((unk_0xD4B321D9096B01FC(unk_0x0FA8183DAD2B3203()) && !unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203())) && unk_0xD4B321D9096B01FC(uParam1->f_1)) && !unk_0xF4B969E0807E76C7(uParam1->f_1, 0))
					{
						unk_0xB425E338F85508A5(unk_0x0FA8183DAD2B3203(), uParam1->f_1, -1);
			...
			if (unk_0x5E05FB12444196F6())
			{
				...
				if (!unk_0x2BF5E63466422C38(*uParam0))
				{
					if (unk_0xD4B321D9096B01FC(uParam1->f_8) && unk_0xD960230552BC4165(uParam1->f_8, 0))
					{
						unk_0xB425E338F85508A5(*uParam0, uParam1->f_8, -1);
						unk_0xDEB0AA30ABFDCF48(*uParam0, 3, 0);
						unk_0x53F3ED9BDCD06444(*uParam0, 3);
					}
					else
					{
						if (!unk_0xD4B321D9096B01FC(uParam1->f_8))
						{
						}
						else if (!unk_0xD960230552BC4165(uParam1->f_8, 0))
						{
						}
						unk_0xF0E9590A910B74BE(*uParam0, unk_0x0FA8183DAD2B3203(), 500f, -1, 0, 0);
					}
				...
				unk_0x0298C8010FD5A69E(0, 0, 3000, 1, 0, 0);
				func_284(1, 1, 1);
				unk_0x860A5CC30A0EF207(uParam1->f_1, 0);
		...
		case 2:
			...
			if (!unk_0xF4B969E0807E76C7(uParam1->f_1, 0))
			{
				unk_0xE56FA7CB317C0282(uParam1->f_1, 0);
			}
			iLocal_1461 = 5;
			break;
	}
...
void func_282(int iParam0, int iParam1)
{
	if (unk_0xD960230552BC4165(iParam0, 0))
	{
		unk_0x0B4387FBA5326E78(iParam0, 1, iParam1);
		unk_0x0B4387FBA5326E78(iParam0, 0, iParam1);
	}
}
...
void func_283(int iParam0, int iParam1)
{
	...
	if (!unk_0x2BF5E63466422C38(iParam0))
	{
		...
		while (iVar0 <= 2)
		{
			if (!unk_0x2BF5E63466422C38(Local_2246[iParam1 /*30*/].f_14[iVar0]))
			{
				if (iVar0 == 0)
				{
				...
				unk_0xC6612209077465DD(Local_2246[iParam1 /*30*/].f_14[iVar0]);
				unk_0xA12E1659DEF57244(&uVar1);
				unk_0x845704CC8ADF1918(0, iParam0, 0);
				unk_0x5D672CB011E20B28(0, "misscommon@response", sVar2, 8f, -8f, -1, 0, 0, 0, 0, 0);
				unk_0xDE8E5CE8855FA963(0, 1193033728, 0);
				unk_0x15A7B753872B3CE3(uVar1);
				unk_0xC544A8E1032AC1CF(Local_2246[iParam1 /*30*/].f_14[iVar0], uVar1);
...
void func_286(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (unk_0x393E9918BC37548A())
		{
			if (((((!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()) && !func_290(unk_0x7C7787D2D7139A85())) && !func_288(unk_0x7C7787D2D7139A85(), 0)) && !func_287()) && !bParam4) && !bParam5)
			{
				unk_0x04F5A8AA60EC662B(unk_0x0FA8183DAD2B3203(), 0);
			}
		}
		else if (((!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()) && !func_290(unk_0x7C7787D2D7139A85())) && !bParam4) && !bParam5)
		{
			unk_0x04F5A8AA60EC662B(unk_0x0FA8183DAD2B3203(), 0);
		}
		Global_76575 = 0;
...
void func_294(int iParam0, int iParam1)
{
	...
	unk_0x7385F0BCDE320A17(iVar0, 0);
	unk_0x3D0DE925C0536CA0(iVar0, 1, 0);
	...
	if (iParam1 == 1)
	{
		...
		{
			if (func_349(unk_0x0FA8183DAD2B3203()))
			{
				unk_0xE5DAA5553A176799(unk_0x0FA8183DAD2B3203(), iLocal_1847, 0);
			}
		}
	}
}
...
void func_295(struct<3> Param0, struct<3> Param3, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	...
	{
		func_297();
		unk_0x99B2718F025505AF(unk_0x7A8732CFB5113E77(), 0);
		if (iParam10 == 1)
		{
			unk_0xBB65AAC660EECEA8(func_296(unk_0x7A8732CFB5113E77()), 50f, 0);
		}
		...
		if (iParam8 == 1)
		{
			...
			if (func_349(unk_0x0FA8183DAD2B3203()))
			{
				iLocal_1847 = unk_0x00F29906A2DBA15D(unk_0x0FA8183DAD2B3203());
...
void func_297()
{
	...
	{
		unk_0x3D0DE925C0536CA0(iVar0, 0, 16);
		unk_0x3D0DE925C0536CA0(iVar0, 0, 32);
...
void func_298(int iParam0)
{
	if (unk_0xD960230552BC4165(iParam0, 0))
	{
		if (!bLocal_1713)
		{
			unk_0x6A99D1F228E18F5B(iParam0, 1, 0, 0);
		}
		unk_0x6A99D1F228E18F5B(iParam0, 0, 0, 0);
	}
}

void func_299()
{
	if (unk_0x257687A186581E55(uLocal_1845))
	{
		unk_0xD28D0A0B38E43BAC(uLocal_1845);
		iLocal_1720 = 0;
	}
}
...
int func_300(int iParam0, float fParam1)
{
	...
	iVar0 = 1;
	unk_0xBA51426C369A1164("ASS_MCS_1", 8);
	unk_0x9F21C99A9E064055(133.2094f, -791.931f, 35.3551f, -4.9404f, 0f, 68.7852f);
	if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
	{
		if (!func_303(unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0), fParam1, 1, 1056964608, 0, 1, 0))
		{
			iVar0 = 0;
		}
		if (!unk_0x0514219B96C5A22A(unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0)))
		{
			iVar0 = 0;
		}
	}
		...
		if (unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), uParam0->f_1, 0))
		{
			...
			if (func_267(&uLocal_2367, 1, 0, 0))
			{
				if (!bParam1)
				{
					...
					func_306(uParam0);
					if (unk_0x6FE3A7E505FEC20C("ASSASSINATION_BUS_SCREAMS_INT_SCENE"))
					{
						unk_0x8E3496DF5BF7F24D("ASSASSINATION_BUS_SCREAMS_INT_SCENE");
					}
				}
				else if (!unk_0x6FE3A7E505FEC20C("ASSASSINATION_BUS_SCREAMS_INT_SCENE"))
				{
					unk_0x7D17F1A2E0EEDBB9("ASSASSINATION_BUS_SCREAMS_INT_SCENE");
				}
				if (!unk_0xD2652A8A890B29BA(uLocal_142))
				{
					uLocal_142 = unk_0xBCB04DDDF3778A10(26379945, 0);
					unk_0x0B38A1D88F1316A4(uLocal_142, 1);
					...
					if (bLocal_1712)
					{
						unk_0x9F2F93BD843587E2(uLocal_142, uParam0->f_1, 0.0467f, -6.4343f, 1.5665f, 1);
						unk_0x0620057C4982F1C1(uLocal_142, uParam0->f_1, -0.0074f, -3.4691f, 1.1139f, 1);
					}
					else if (bLocal_1713)
					{
						unk_0x9F2F93BD843587E2(uLocal_142, uParam0->f_1, -0.0387f, -5.3568f, 0.8942f, 1);
						unk_0x0620057C4982F1C1(uLocal_142, uParam0->f_1, 0.0245f, -2.4095f, 0.3379f, 1);
					}
					else
					{
						unk_0x9F2F93BD843587E2(uLocal_142, uParam0->f_1, 0.0467f, -6.4343f, 1.5665f, 1);
					...
					unk_0x494374BCB9580EA5(uLocal_142, 35f);
				}
				if (!unk_0x1F70CA72458DB6BD(uLocal_142))
				{
			...
			else if (unk_0xD2652A8A890B29BA(uLocal_142))
			{
				if (unk_0x1F70CA72458DB6BD(uLocal_142))
				{
					unk_0x0472F75F711AABCE(uLocal_142, 0);
...
void func_307(var uParam0, var uParam1)
{
	...
	if (iVar0 == 3)
	{
		if (!unk_0xF4B969E0807E76C7(uParam0->f_1, 0) && !unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
		{
			if (unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), uParam0->f_1, 1))
			{
				if (unk_0x42A24CB7B8A08E11(uParam0->f_1, 112.8744f, -780.2048f, 29.41912f, 118.2785f, -782.2339f, 34.38423f, 2.5f, 0, 1, 0))
				{
	...
	if (!unk_0x93086679C0E859D8(Local_2246[iVar0 /*30*/].f_1, 15f))
	{
		unk_0x7FB505C34A14BAAA(Local_2246[iVar0 /*30*/].f_1, 15f, 0, 0, 0, 0, 0, 0);
	}
	if (iLocal_1705)
	{
		fVar1 = ((unk_0xB8D4A2BAA78AB950(unk_0x0FA8183DAD2B3203()) / 5f) + 6f);
	...
	if (iLocal_1705)
	{
		if (unk_0xD960230552BC4165(uParam0->f_1, 0) && unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), uParam0->f_1, 0))
		{
			if (unk_0xC49563EAE7AACA6C(unk_0x0FA8183DAD2B3203(), Local_2246[iVar0 /*30*/].f_21, 5f, 5f, 2f, 1, 1, 0))
			{
			}
		}
	}
	if (!unk_0xF4B969E0807E76C7(uParam0->f_1, 0))
	{
		if (unk_0x7E6F0519746C2295(unk_0x0FA8183DAD2B3203(), uParam0->f_1))
		{
			if (Local_2246[iVar0 /*30*/])
			{
				Var3 = { unk_0x0E516C24C87F5D0C(unk_0x0FA8183DAD2B3203(), 31086, 0f, 0f, 0f) };
				if ((((unk_0xD34AF93E9BCF12F0(Var3, Local_2246[iVar0 /*30*/].f_21, 1) <= fVar1 && unk_0xB5ACA45580455592(unk_0x7C7787D2D7139A85())) && unk_0xF3F9A773BB9105E8(uLocal_1845)) && !func_334(iVar0)) && !bLocal_1701)
				{
					iLocal_1705 = 0;
				}
				if (iLocal_1747 > 0)
...
void func_308(var uParam0, var uParam1, int iParam2)
{
	...
	unk_0x70CBCB37A00F34A2(unk_0x0FA8183DAD2B3203(), 287, 1);
	unk_0x70CBCB37A00F34A2(unk_0x0FA8183DAD2B3203(), 309, 1);
	switch (iLocal_1725)
	{
		case 0:
			if (Local_2246[iParam2 /*30*/])
			{
				...
				func_331(0, 0, 1);
				func_329(iParam2);
				Var0 = { unk_0x15797166B26DA912(uParam0->f_1, 1.21f, 6.15f, 0.3f) };
				if (unk_0xD34AF93E9BCF12F0(Var0, 0f, 0f, 0f, 1) > 0.23f)
				{
					bLocal_1702 = true;
					unk_0xD48D4B847652B1D9(uParam0->f_1, 1, 1);
					unk_0xD48D4B847652B1D9(uParam0->f_1, 0, 1);
				}
				if (iLocal_1747 == 0)
				{
					func_383(1, "assassin_bus_stage_drive_to_stops", 0, 0, 0, 1);
				...
				uLocal_1806 = unk_0x3715936BB73409D6(26379945, Local_1767, Local_1770, 65f, 0, 2);
				unk_0x494374BCB9580EA5(uLocal_1806, 38f);
				unk_0x0472F75F711AABCE(uLocal_1806, 1);
				if (!bLocal_1698)
				{
					unk_0x9F2F93BD843587E2(uLocal_1806, uParam0->f_1, -4.4984f, 8.6802f, -0.3745f, 1);
					unk_0x0620057C4982F1C1(uLocal_1806, uParam0->f_1, -2.0642f, 7.0391f, 0.243f, 1);
				}
				unk_0x5EB47C7F004ABFCA(Local_2246[iParam2 /*30*/].f_1, 30f, 0);
				unk_0xBB65AAC660EECEA8(Local_2246[iParam2 /*30*/].f_1, 30f, 0);
				unk_0xA61B7DD77FE81428(Local_2246[iParam2 /*30*/].f_1, 7f);
				unk_0x0298C8010FD5A69E(1, 0, 3000, 1, 0, 0);
				if (iParam2 == 0)
				{
					func_328(uParam0);
				...
				else
				{
					...
					unk_0xCB3446C6A91D1A78(uParam0->f_1, Local_1764, 1, 0, 0, 1);
					unk_0x5A2B7C446C0CF087(uParam0->f_1, fLocal_1785);
					unk_0x43C33457132CC44C(uParam0->f_1);
					unk_0x1ECAE5FB4DE78CF8(uParam0->f_1, 1084227584);
					unk_0xD32341B4ADEC0821(uParam0->f_1, 2f);
					Var4 = { unk_0xACE5E491FC1B0D37(uParam0->f_1, 1) };
					fVar10 = unk_0xD2809C7F7FD79247(uParam0->f_1);
					Var7 = { unk_0x16DECC52D9360F1E(Var4, fVar10, 2f, 5.6201f, 0.1098f) };
					unk_0x33BF981A2389AF13(unk_0x0FA8183DAD2B3203(), Var7, 5000, 0, 2);
				}
			...
			if (func_168(&uLocal_1816))
			{
				if (func_165(&uLocal_1816) > fLocal_1755)
				{
					...
					if (iParam2 == 0)
					{
						...
						{
							unk_0x31A7662B885C7549(iVar3, uParam0->f_1, 20000, 0, 2f, 258, 0);
							if (unk_0xD4B321D9096B01FC(iVar3))
							{
								unk_0xCFEC09B98C6C5993(iVar3, 1, 0);
							}
						}
					}
					else if (iParam2 == 1)
		...
		case 2:
			...
			if ((func_165(&uLocal_1816) > 1.5f && !bLocal_1702) || (bLocal_1702 && !func_221()))
			{
				...
				func_183(&uLocal_1816);
				unk_0xAA2276003B2ADF1B(&(Local_2246[iParam2 /*30*/].f_9));
	...
	if (iLocal_1725 == 1)
	{
		if (func_310(iLocal_144))
		{
			...
			if (!unk_0xF4B969E0807E76C7(uParam0->f_1, 0))
			{
				unk_0x5A2B7C446C0CF087(uParam0->f_1, Local_2246[iParam2 /*30*/].f_20);
			}
			unk_0xAA2276003B2ADF1B(&(Local_2246[iParam2 /*30*/].f_9));
			if (iParam2 == iLocal_1727)
			{
				...
				if (!unk_0x2BF5E63466422C38(*uParam0))
				{
					if (unk_0xD960230552BC4165(uParam0->f_8, 0))
					{
						...
						unk_0xCB3446C6A91D1A78(uParam0->f_8, Local_2246[iLocal_1727 /*30*/].f_5, 1, 0, 0, 1);
						unk_0x5A2B7C446C0CF087(uParam0->f_8, Local_2246[iLocal_1727 /*30*/].f_8);
						unk_0x1ECAE5FB4DE78CF8(uParam0->f_8, 1084227584);
						unk_0x53F3ED9BDCD06444(*uParam0, 3);
						if (!unk_0x95ED3BD0F52D542A(*uParam0, uParam0->f_8, 0))
						{
							unk_0xB425E338F85508A5(*uParam0, uParam0->f_8, -1);
						}
					}
				}
				unk_0xB82DC93528F8603C(Local_2246[iLocal_1727 /*30*/].f_5, 30f, 0, 0, 0, 0);
				unk_0x5EB47C7F004ABFCA(Local_2246[iLocal_1727 /*30*/].f_5, 30f, 0);
...
void func_309(var uParam0)
{
	...
	func_284(1, 1, 1);
	unk_0xCF33E56642B34516(500);
	unk_0x860A5CC30A0EF207(uParam0->f_1, 0);
	iLocal_1724 = 0;
...
{
	if (func_311() && unk_0x9B35D07DCD0F0B43() >= iParam0 + 1000)
	{
...
void func_313(var uParam0)
{
	if (!unk_0x2BF5E63466422C38(*uParam0))
	{
		unk_0x0453EBC0FB8D8A80(*uParam0, 0, 0, 1, 0);
		unk_0x0453EBC0FB8D8A80(*uParam0, 2, 2, 2, 0);
		unk_0x0453EBC0FB8D8A80(*uParam0, 3, 0, 0, 0);
		unk_0x0453EBC0FB8D8A80(*uParam0, 4, 0, 0, 0);
	}
}
...
void func_314(var uParam0, var uParam1, int iParam2)
{
	...
	if (unk_0xD4B321D9096B01FC(Local_2246[iParam2 /*30*/].f_14[2]))
	{
		unk_0x4F058F27442031CC(&(Local_2246[iParam2 /*30*/].f_14[2]));
	}
	if (!unk_0xD4B321D9096B01FC(*uParam1))
	{
		uParam0->f_1 = { Var0 };
		...
		unk_0x0BBBAC4546BFE280(*uParam1, 175, 0);
	}
	uParam1->f_8 = Local_2246[iParam2 /*30*/].f_19;
	if (!unk_0xF6FD8019402CF03B(*uParam1, "oddjobs@assassinate@bus@", "base", 3))
	{
		unk_0x5D672CB011E20B28(*uParam1, "oddjobs@assassinate@bus@", "base", 8f, -16f, -1, 1, 0, 0, 0, 0);
	}
}
...
void func_315(var uParam0, var uParam1)
{
	if (!unk_0xD4B321D9096B01FC(*uParam1))
	{
		*uParam1 = unk_0xB983F26E7AFB47BF(4, *uParam0, uParam0->f_1, uParam0->f_4, 1, 1);
		unk_0xB6C190A9FAFAEC2F(*uParam0, 1);
		...
		if (uParam0->f_13 != 0)
		{
			unk_0xC167C31F20B1FD61(*uParam1, uParam0->f_13, -1, 0, 1);
		}
		if (uParam0->f_274 == 0)
		{
...
void func_316(var uParam0, int iParam1)
{
	...
	unk_0xB82DC93528F8603C(Local_2246[iParam1 /*30*/].f_1, 10f, 0, 0, 0, 0);
	unk_0x80BCF42B42433CEB((Local_2246[iParam1 /*30*/].f_1 - 30f), (Local_2246[iParam1 /*30*/].f_1.f_1 - 30f), (Local_2246[iParam1 /*30*/].f_1.f_2 - 30f), (Local_2246[iParam1 /*30*/].f_1 + 30f), (Local_2246[iParam1 /*30*/].f_1.f_1 + 30f), (Local_2246[iParam1 /*30*/].f_1.f_2 + 30f), 0, 1);
	if (!unk_0xD4B321D9096B01FC(Local_2246[iParam1 /*30*/].f_14[0]))
	{
		Local_2246[iParam1 /*30*/].f_14[0] = unk_0xB983F26E7AFB47BF(4, uParam0->f_16, Var0[0 /*3*/], Local_2246[iParam1 /*30*/].f_4, 1, 1);
		if (iParam1 == 0)
		{
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 0, 0, 2, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 2, 2, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 3, 2, 1, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 4, 0, 1, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 8, 0, 0, 0);
		}
		else if (iParam1 == 1)
		{
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 0, 0, 2, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 2, 1, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 3, 1, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 4, 0, 0, 0);
		}
		else if (iParam1 == 2)
		{
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 0, 1, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 2, 2, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 3, 1, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 4, 0, 2, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 8, 1, 0, 0);
		}
		else if (iParam1 == 3)
		{
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 0, 1, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 2, 0, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 3, 1, 2, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[0], 4, 0, 0, 0);
		}
		unk_0x6E2920E14F5F962C(Local_2246[iParam1 /*30*/].f_14[0], unk_0x0FA8183DAD2B3203(), -1, 2048, 4);
		unk_0x5D672CB011E20B28(Local_2246[iParam1 /*30*/].f_14[0], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, unk_0x64A3FFD9D62755C5(0, 1065353216), 0, 0, 0);
		unk_0xCC94EE23853F38E4(Local_2246[iParam1 /*30*/].f_14[0], 1);
		unk_0x1BB4C3187097FCD7(Local_2246[iParam1 /*30*/].f_14[0], "PASSENGERS_Group", 0);
	}
	if (!unk_0xD4B321D9096B01FC(Local_2246[iParam1 /*30*/].f_14[1]))
	{
		Local_2246[iParam1 /*30*/].f_14[1] = unk_0xB983F26E7AFB47BF(4, joaat("a_m_m_eastsa_01"), Var0[1 /*3*/], Local_2246[iParam1 /*30*/].f_4, 1, 1);
		if (iParam1 == 0)
		{
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[1], 0, 0, 2, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[1], 3, 1, 3, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[1], 4, 0, 1, 0);
		}
		else if (iParam1 == 1)
		{
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[1], 0, 0, 1, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[1], 3, 0, 1, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[1], 4, 0, 0, 0);
		}
		else if (iParam1 == 2)
		{
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[1], 0, 0, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[1], 3, 0, 1, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[1], 4, 0, 2, 0);
		}
		else if (iParam1 == 3)
		{
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[1], 0, 0, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[1], 3, 2, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[1], 4, 0, 1, 0);
		}
		unk_0x6E2920E14F5F962C(Local_2246[iParam1 /*30*/].f_14[1], unk_0x0FA8183DAD2B3203(), -1, 2048, 4);
		unk_0x5D672CB011E20B28(Local_2246[iParam1 /*30*/].f_14[1], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, unk_0x64A3FFD9D62755C5(0, 1065353216), 0, 0, 0);
		unk_0xCC94EE23853F38E4(Local_2246[iParam1 /*30*/].f_14[1], 1);
		unk_0x1BB4C3187097FCD7(Local_2246[iParam1 /*30*/].f_14[1], "PASSENGERS_Group", 0);
	}
	if (!unk_0xD4B321D9096B01FC(Local_2246[iParam1 /*30*/].f_14[2]))
	{
		Local_2246[iParam1 /*30*/].f_14[2] = unk_0xB983F26E7AFB47BF(4, uParam0->f_14, Var0[2 /*3*/], Local_2246[iParam1 /*30*/].f_4, 1, 1);
		if (iParam1 == 0)
		{
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 0, 0, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 2, 0, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 3, 0, 2, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 4, 0, 2, 0);
		}
		else if (iParam1 == 1)
		{
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 0, 0, 2, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 2, 0, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 3, 1, 1, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 4, 0, 1, 0);
		}
		else if (iParam1 == 2)
		{
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 0, 0, 2, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 2, 0, 1, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 3, 1, 2, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 4, 0, 1, 0);
		}
		else if (iParam1 == 3)
		{
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 0, 0, 1, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 2, 0, 0, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 3, 0, 1, 0);
			unk_0x0453EBC0FB8D8A80(Local_2246[iParam1 /*30*/].f_14[2], 4, 0, 1, 0);
		}
		unk_0x6E2920E14F5F962C(Local_2246[iParam1 /*30*/].f_14[2], unk_0x0FA8183DAD2B3203(), -1, 2048, 4);
		unk_0x5D672CB011E20B28(Local_2246[iParam1 /*30*/].f_14[2], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, unk_0x64A3FFD9D62755C5(0, 1065353216), 0, 0, 0);
		unk_0xCC94EE23853F38E4(Local_2246[iParam1 /*30*/].f_14[2], 1);
		unk_0x1BB4C3187097FCD7(Local_2246[iParam1 /*30*/].f_14[2], "PASSENGERS_Group", 0);
	}
	if (iParam1 == 3)
	{
		if (!unk_0xD4B321D9096B01FC(Local_2246[iParam1 /*30*/].f_19))
		{
			Local_2246[iParam1 /*30*/].f_19 = unk_0x847817A65E16621A(uParam0->f_15, Local_2246[iParam1 /*30*/].f_5, Local_2246[iParam1 /*30*/].f_8, 1, 1, 0);
			unk_0x1ECAE5FB4DE78CF8(Local_2246[iParam1 /*30*/].f_19, 1084227584);
		}
	}
}
...
void func_318(var uParam0)
{
	...
	while (iVar1 < 9)
	{
		if (iLocal_1737 < 4)
		{
			if (unk_0xD960230552BC4165(uParam0->f_1, 0))
			{
				if (unk_0x300C62F79A4441EB(uParam0->f_1, iVar1, 0) != 0)
				{
					iVar0 = unk_0x300C62F79A4441EB(uParam0->f_1, iVar1, 0);
					if (iLocal_1737 == 0)
					{
	...
	while (iVar0 <= 2)
	{
		if (unk_0xD960230552BC4165(uParam0->f_1, 0))
		{
			if (!unk_0x2BF5E63466422C38(Local_2246[iParam1 /*30*/].f_14[iVar0]))
			{
				...
				if (unk_0xBAA38708D7439CA7(uParam0->f_1, iVar1, 0))
				{
					unk_0xB425E338F85508A5(Local_2246[iParam1 /*30*/].f_14[iVar0], uParam0->f_1, iVar1);
				}
			}
		}
		iVar0++;
...
void func_320()
{
	iLocal_1846 = unk_0xB983F26E7AFB47BF(5, joaat("a_f_o_genstreet_01"), 110.6556f, -776.3679f, 30.439f, 346.1708f, 1, 1);
	unk_0x0453EBC0FB8D8A80(iLocal_1846, 0, 0, 0, 0);
	unk_0x0453EBC0FB8D8A80(iLocal_1846, 2, 1, 2, 0);
	unk_0x0453EBC0FB8D8A80(iLocal_1846, 3, 0, 2, 0);
	unk_0x0453EBC0FB8D8A80(iLocal_1846, 4, 0, 0, 0);
	unk_0x0453EBC0FB8D8A80(iLocal_1846, 8, 1, 2, 0);
	unk_0xCC94EE23853F38E4(iLocal_1846, 1);
}
...
var func_322(struct<3> Param0, int iParam3)
{
	...
	while (iVar3 <= 2)
	{
		if (!unk_0xF4B969E0807E76C7(Local_2246[iParam3 /*30*/].f_14[iVar3], 0))
		{
...
{
	if (!unk_0xD2652A8A890B29BA(uLocal_1806))
	{
		uLocal_1806 = unk_0x3715936BB73409D6(26379945, unk_0x72DDC427E84EEBD1(), unk_0x765F48D6E8886201(2), 35f, 0, 2);
	}
	if (!unk_0xD2652A8A890B29BA(uLocal_1807))
	{
		uLocal_1807 = unk_0x3715936BB73409D6(26379945, unk_0x72DDC427E84EEBD1(), unk_0x765F48D6E8886201(2), 34f, 0, 2);
	}
	if (unk_0xD960230552BC4165(uParam0->f_1, 0) && !unk_0xF4B969E0807E76C7(uParam0->f_1, 0))
	{
		if (bLocal_1712)
		{
			unk_0x9F2F93BD843587E2(uLocal_1806, uParam0->f_1, -1.7004f, 5.5826f, 1.0005f, 1);
			unk_0x0620057C4982F1C1(uLocal_1806, uParam0->f_1, 1.2599f, 5.969f, 0.7051f, 1);
		}
		else if (bLocal_1713)
		{
			unk_0x9F2F93BD843587E2(uLocal_1806, uParam0->f_1, -1.6144f, 4.8097f, 0.4117f, 1);
			unk_0x0620057C4982F1C1(uLocal_1806, uParam0->f_1, 1.328f, 4.756f, -0.1711f, 1);
		}
		else
		{
			unk_0x9F2F93BD843587E2(uLocal_1806, uParam0->f_1, -1.7004f, 5.5826f, 1.0005f, 1);
		...
		unk_0x03036E4985212F72(uLocal_1806, 0.55f);
		unk_0x0472F75F711AABCE(uLocal_1806, 1);
	}
	unk_0xF224B39A11E00AF6(0);
	unk_0xAEF65C2BBEAF5B91(0.3f);
	unk_0x0298C8010FD5A69E(1, 0, 3000, 1, 0, 0);
}
...
void func_324(var uParam0, int iParam1)
{
	...
	if (!unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
	{
		Var4 = { unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 1) };
		fVar7 = unk_0xD2809C7F7FD79247(unk_0x0FA8183DAD2B3203());
	}
	if (bLocal_1712)
	{
		Var0 = { unk_0x16DECC52D9360F1E(Var4, fVar7, 2.519f, 5.6f, 0.1098f) };
		unk_0xDF956C4106F1E9C5(Var0, &fVar8, 0, 0);
	}
	else if (bLocal_1713)
	{
		Var0 = { unk_0x16DECC52D9360F1E(Var4, fVar7, 2.519f, 5.6f, 0.1098f) };
	...
	if (!unk_0x2BF5E63466422C38(iVar3))
	{
		unk_0x5BBDAD06F405ED2C(iVar3);
		unk_0xCB3446C6A91D1A78(iVar3, Var0.f_0, Var0.f_1, fVar8, 1, 0, 0, 1);
		unk_0x5A2B7C446C0CF087(iVar3, fVar9);
	}
}
...
void func_325(var uParam0, int iParam1)
{
	...
	{
		unk_0xCFEC09B98C6C5993(iVar0, 0, 0);
		if (iParam1 == 0)
		{
			unk_0x9C3314BBA5EDB2F9(iVar0, "move_m@casual@d", 1048576000);
			unk_0xD06C31EF9A42C2B4(iVar0, 305.2689f, -768.1415f, 28.17335f, 1f, 20000, 1048576000, 0, 1193033728);
			unk_0xB300618E39F089F8(iVar0, joaat("MotionState_Walk"), 0, 0, 0);
		}
		else if (iParam1 == 1)
		{
			unk_0x9C3314BBA5EDB2F9(iVar0, "move_m@casual@d", 1048576000);
			unk_0x43D490C8BFA124BB(iVar0, 358.6953f, -1065.935f, 28.39328f, 1f, 20000, 1193033728, 1056964608);
		}
		else if (iParam1 == 3)
		{
			unk_0x43D490C8BFA124BB(iVar0, 111.6832f, -781.5098f, 30.26971f, 1f, 20000, 1193033728, 1056964608);
		}
		else
		{
			unk_0x31A7662B885C7549(iVar0, uParam0->f_1, 20000, 0, 1f, 256, 0);
		}
	}
}
...
void func_326(var uParam0, int iParam1)
{
	switch (iLocal_1749)
	{
		case 0:
			...
			{
				case 0:
					unk_0x9B9D9C83AC80FFE4(unk_0x0FA8183DAD2B3203(), uParam0->f_1, "OJASbs01", 786603, 0, 16, -1, 3f, 0, 1073741824);
					func_212(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNG", 9, 0, 0, 0);
					break;
				
				case 1:
					unk_0x9B9D9C83AC80FFE4(unk_0x0FA8183DAD2B3203(), uParam0->f_1, "OJASbs02", 786603, 0, 16, -1, 3f, 0, 1073741824);
					func_212(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNGa", 9, 0, 0, 0);
					break;
				
				case 2:
					unk_0x9B9D9C83AC80FFE4(unk_0x0FA8183DAD2B3203(), uParam0->f_1, "OJASbs03", 786603, 0, 16, -1, 3f, 0, 1073741824);
					func_212(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNGb", 9, 0, 0, 0);
					break;
				
				case 3:
					unk_0x9B9D9C83AC80FFE4(unk_0x0FA8183DAD2B3203(), uParam0->f_1, "OJASbs04", 786603, 0, 16, -1, 3f, 0, 1073741824);
		...
		case 1:
			if (func_168(&uLocal_1816))
			{
				if (func_165(&uLocal_1816) > 3f)
				{
					...
					unk_0x3B5A16EB2D59D4F6(uLocal_1806);
					unk_0xC12E7EA60408C575(uLocal_1806);
					unk_0xF44C160C97CC41EB(uLocal_1806, Local_1767);
					unk_0x92B8564A1A66EF0A(uLocal_1806, Local_1770, 2);
...
void func_327(var uParam0, int iParam1, bool bParam2)
{
	...
	Var1 = { 0f, -3f, 0f };
	unk_0xC6612209077465DD(unk_0x0FA8183DAD2B3203());
	if (unk_0x7271314D6DEBF5AE(uParam0->f_1))
	{
		unk_0x8344FF07EF951706(uParam0->f_1);
	}
	if (iParam1 == 0)
	{
		Local_1764 = { 308.0244f, -765.3675f, 29.2651f };
		fLocal_1785 = 160.65f;
		Local_1773 = { unk_0x16DECC52D9360F1E(Local_1764, fLocal_1785, Var1) };
	}
	else if (iParam1 == 1)
	{
	...
	unk_0xDF956C4106F1E9C5(Local_1764, &uVar0, 0, 0);
	unk_0x61C432330FFEC578(unk_0x0FA8183DAD2B3203(), Local_1773);
	unk_0x5A2B7C446C0CF087(uParam0->f_1, fLocal_1785);
	unk_0x1ECAE5FB4DE78CF8(uParam0->f_1, 1084227584);
	unk_0xD32341B4ADEC0821(uParam0->f_1, 5f);
	unk_0x43C33457132CC44C(uParam0->f_1);
	if (bLocal_1712)
	{
		Local_1761 = { unk_0x16DECC52D9360F1E(Local_1764, fLocal_1785, 2f, 5.6201f, 0.1098f) };
	}
	else if (bLocal_1713)
	{
		Local_1761 = { unk_0x16DECC52D9360F1E(Local_1764, fLocal_1785, 2f, 5.6201f, 0.1098f) };
	...
	if (bParam2)
	{
		unk_0x33BF981A2389AF13(unk_0x0FA8183DAD2B3203(), Local_1761, 5000, 0, 2);
	}
}
...
void func_328(var uParam0)
{
	...
	if (unk_0xD4B321D9096B01FC(uParam0->f_1) && !unk_0xF4B969E0807E76C7(uParam0->f_1, 0))
	{
		iVar9 = 0;
		while (iVar9 < 8)
		{
			if (!unk_0xBAA38708D7439CA7(uParam0->f_1, iVar9, 0))
			{
				iVar0[iVar9] = unk_0x300C62F79A4441EB(uParam0->f_1, iVar9, 0);
				unk_0xE5C667CF3B4642D2(iVar0[iVar9], 1, 0);
				if (unk_0xD4B321D9096B01FC(iVar0[iVar9]))
				{
					unk_0x4F058F27442031CC(&(iVar0[iVar9]));
				}
			}
			iVar9++;
		}
...
void func_329(int iParam0)
{
	...
	fVar0 = unk_0xD2809C7F7FD79247(unk_0x0FA8183DAD2B3203());
	...
	Var11 = { unk_0x8C2358925451F246(unk_0x0FA8183DAD2B3203(), 0) };
	Var14 = { unk_0xDF29CF810DF94B60(unk_0x0FA8183DAD2B3203()) };
	if (!bLocal_1700)
	{
...
void func_333()
{
	if (unk_0xD4B321D9096B01FC(uLocal_1796[0]))
	{
		unk_0x0FFB05DA97E810B5(&(uLocal_1796[0]));
	}
	if (unk_0xD4B321D9096B01FC(uLocal_1796[1]))
	{
		unk_0x0FFB05DA97E810B5(&(uLocal_1796[1]));
	}
	if (unk_0xD4B321D9096B01FC(uLocal_1796[2]))
	{
		unk_0x0FFB05DA97E810B5(&(uLocal_1796[2]));
	}
	if (unk_0xD4B321D9096B01FC(uLocal_1796[3]))
	{
		unk_0x0FFB05DA97E810B5(&(uLocal_1796[3]));
	}
}
...
int func_334(int iParam0)
{
	...
	fVar0 = unk_0xD2809C7F7FD79247(unk_0x0FA8183DAD2B3203());
	fVar1 = (Local_2246[iParam0 /*30*/].f_4 - 180f);
	if (unk_0xD0FFB162F40A139C(unk_0x01CBD71E072E9F33((fVar0 - fVar1))) <= 0.766f)
	{
		bLocal_1700 = false;
		iVar2 = 0;
	}
	else
	{
		...
		{
			unk_0x38C6C3B6F4074898("ASS_BS_BOARD");
		}
...
void func_335(int iParam0)
{
	if (!iLocal_1720)
	{
		if (func_368(Local_2246[iParam0 /*30*/].f_1, 1) <= 100f)
		{
			...
			{
				uLocal_1845 = unk_0x7E82FEE7E6CEB68D(Local_2246[iParam0 /*30*/].f_24, Local_2246[iParam0 /*30*/].f_27, 25f, 12, 127);
				if (iLocal_1747 == 3)
				{
					unk_0xBA51426C369A1164("ASS_MCS_1", 8);
					unk_0x9F21C99A9E064055(133.2094f, -791.931f, 35.3551f, -4.9404f, 0f, 68.7852f);
...
void func_337()
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			if (!unk_0x39A01A052D9B5FF0(Local_2246[iVar0 /*30*/].f_9))
			{
				Var1 = { unk_0x16DECC52D9360F1E(Local_2246[iVar0 /*30*/].f_1, Local_2246[iVar0 /*30*/].f_4, 0f, 3f, 0f) };
				Local_2246[iVar0 /*30*/].f_9 = func_338(Var1, 1);
				unk_0x058B6969CEED705F(Local_2246[iVar0 /*30*/].f_9, &(Local_2246[iVar0 /*30*/].f_10));
			}
		}
		iVar0++;
	}
...
void func_339()
{
	if (!unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), iLocal_1801, 0))
	{
		unk_0xF25956700ADFD77F(&iLocal_1801);
	}
	if (!unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), iLocal_1802, 0))
	{
		unk_0xF25956700ADFD77F(&iLocal_1802);
	}
}
...
int func_340(var uParam0)
{
	...
	if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
	{
		if (unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), uParam0->f_1, 0))
		{
			unk_0xE5C667CF3B4642D2(uParam0->f_1, 1, 0);
			return 1;
		}
		else
		{
			iVar0 = unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0);
			if (unk_0x7F375072508F738F(iVar0) == joaat("bus"))
			{
				uParam0->f_1 = iVar0;
				unk_0xE5C667CF3B4642D2(uParam0->f_1, 1, 0);
				bLocal_1712 = true;
			}
			else if (unk_0x7F375072508F738F(iVar0) == joaat("coach"))
			{
				uParam0->f_1 = iVar0;
				unk_0xE5C667CF3B4642D2(uParam0->f_1, 1, 0);
				bLocal_1713 = true;
...
int func_343(var uParam0)
{
	...
	unk_0x6BB2B1818CAE531E(joaat("a_f_o_genstreet_01"));
	if (unk_0x6DF9C43E3CC645BC(*uParam0) && unk_0x6DF9C43E3CC645BC(joaat("a_f_o_genstreet_01")))
	{
		iVar0 = 1;
	}
	else
...
int func_344(var uParam0)
{
	...
	unk_0x6BB2B1818CAE531E(uParam0->f_16);
	unk_0x6BB2B1818CAE531E(uParam0->f_14);
	unk_0x6BB2B1818CAE531E(joaat("a_m_m_eastsa_01"));
	if ((unk_0x6DF9C43E3CC645BC(uParam0->f_16) && unk_0x6DF9C43E3CC645BC(uParam0->f_14)) && unk_0x6DF9C43E3CC645BC(joaat("a_m_m_eastsa_01")))
	{
		iVar0 = 1;
	}
	else
			...
			if (iLocal_1747 > 0)
			{
				if (!iLocal_1709)
				{
					...
					while (iVar0 < 9)
					{
						if (unk_0xD960230552BC4165(uParam0->f_1, 0))
						{
							if (unk_0x300C62F79A4441EB(uParam0->f_1, iVar0, 0) != 0)
							{
								iLocal_1795 = unk_0x300C62F79A4441EB(uParam0->f_1, iVar0, 0);
...
void func_347(var uParam0, bool bParam1)
{
	...
	unk_0x36B659209EBDD366("veh@bus@passenger@rds@idle_panic");
	unk_0x36B659209EBDD366("veh@bus@passenger@rps@idle_panic");
	if (!iLocal_1706)
	{
		if (unk_0xB25A0D192C6A0A5B("veh@bus@passenger@rds@idle_panic") && unk_0xB25A0D192C6A0A5B("veh@bus@passenger@rps@idle_panic"))
		{
			iLocal_1706 = 1;
		}
	}
	if (!iLocal_1716)
	{
		if (!unk_0xF4B969E0807E76C7(uParam0->f_1, 0) && !unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
		{
			if (unk_0xC29ACA630455C49B(uParam0->f_1) || unk_0x90D8021D13215A35(unk_0x0FA8183DAD2B3203()))
			{
				iLocal_1716 = 1;
			}
		}
	...
	if (iLocal_1706 && iLocal_1716)
	{
		if (!iLocal_1704)
		{
			...
			while (iVar0 < 9)
			{
				if (unk_0xD960230552BC4165(uParam0->f_1, 0))
				{
					if (unk_0x300C62F79A4441EB(uParam0->f_1, iVar0, 0) != 0)
					{
						iVar1 = unk_0x300C62F79A4441EB(uParam0->f_1, iVar0, 0);
						if (!bParam1)
						{
							if ((unk_0xBAC643F143880136(0, 65535) % 3) < 1)
							{
								if (unk_0xF6FD8019402CF03B(iVar1, "veh@bus@passenger@rds@idle_panic", "sit", 3) || unk_0xF6FD8019402CF03B(iVar1, "veh@bus@passenger@rps@idle_panic", "sit", 3))
								{
						...
						if (bParam1)
						{
							if ((iVar0 % 2) == 0)
							{
								unk_0x5D672CB011E20B28(iVar1, "veh@bus@passenger@rps@idle_panic", "sit", 8f, -8f, -1, 1, unk_0x64A3FFD9D62755C5(0, 1065353216), 0, 0, 0);
							}
							else
							{
								unk_0x5D672CB011E20B28(iVar1, "veh@bus@passenger@rds@idle_panic", "sit", 8f, -8f, -1, 1, unk_0x64A3FFD9D62755C5(0, 1065353216), 0, 0, 0);
							}
						}
					}
				}
		...
		if (bParam1)
		{
			...
			if (!unk_0x6FE3A7E505FEC20C("ASSASSINATION_BUS_SCREAMS_EXT_SCENE"))
			{
				unk_0x7D17F1A2E0EEDBB9("ASSASSINATION_BUS_SCREAMS_EXT_SCENE");
			}
		}
	}
}
...
void func_351(var uParam0)
{
	if (!iLocal_1723)
	{
		if (unk_0xD4B321D9096B01FC(uParam0->f_8) && !unk_0xF4B969E0807E76C7(uParam0->f_8, 0))
		{
			if (!unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0) && unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), uParam0->f_8, 0))
			{
				unk_0xB9470B741AA0818C(uParam0->f_8, 0f);
				iLocal_1723 = 1;
			}
		}
	}
...
void func_355(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_357(Global_111560.f_18528[iVar0], &Var2, &fVar5))
			{
...
{
	return func_241(unk_0x23625FE58BACEBFD(unk_0x7A8732CFB5113E77()), iParam0, iParam1);
}
	...
	if (iLocal_1042 > 4)
	{
		if (!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
		{
			...
			if (unk_0xD4B321D9096B01FC(iVar0))
			{
				...
				{
					if ((iVar0 != iLocal_1805 && unk_0x7F375072508F738F(iVar0) != joaat("bus")) && unk_0x7F375072508F738F(iVar0) != joaat("coach"))
					{
						iLocal_1805 = iVar0;
						unk_0xE5C667CF3B4642D2(iLocal_1805, 1, 1);
						unk_0xB570C44B09DEF4A5(iLocal_1805, 0);
					}
				}
			}
		}
...
void func_365(var uParam0)
{
	...
	if (!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
	{
		if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
		{
			iLocal_1803 = unk_0xA4BF70099C074BA0(unk_0x0FA8183DAD2B3203());
			iLocal_1815 = unk_0x7F375072508F738F(iLocal_1803);
			if (iLocal_1815 != 0)
			{
				if (iLocal_1815 == joaat("bus"))
				{
					...
					bLocal_1712 = true;
					unk_0x4BA8ED9D4B9825B8(uParam0->f_1, 1);
					iLocal_1042 = 10;
				}
...
int func_367(var uParam0)
{
	if (!unk_0xD4B321D9096B01FC(uLocal_1796[3]))
	{
		...
		if ((unk_0x6DF9C43E3CC645BC(uParam0->f_16) && unk_0x6DF9C43E3CC645BC(uParam0->f_14)) && unk_0x6DF9C43E3CC645BC(joaat("a_m_m_eastsa_01")))
		{
			if (!unk_0xD4B321D9096B01FC(uLocal_1796[0]))
			{
				uLocal_1796[0] = unk_0xB983F26E7AFB47BF(4, joaat("a_m_m_eastsa_01"), 435.0773f, -650.2194f, 27.74271f, 85.9928f, 1, 1);
				unk_0x0453EBC0FB8D8A80(uLocal_1796[0], 0, 0, 0, 0);
				unk_0x0453EBC0FB8D8A80(uLocal_1796[0], 2, 0, 0, 0);
				unk_0x0453EBC0FB8D8A80(uLocal_1796[0], 3, 0, 2, 0);
				unk_0x0453EBC0FB8D8A80(uLocal_1796[0], 4, 1, 2, 0);
				unk_0x0453EBC0FB8D8A80(uLocal_1796[0], 10, 1, 1, 0);
				if (unk_0x52EC8D7433C7E520(435.0773f, -650.2194f, 27.74271f, 2f, 1))
				{
					unk_0x78D0594B2B5D62A1(uLocal_1796[0], 435.0773f, -650.2194f, 27.74271f, 2f, -1);
				}
				else
				{
					unk_0xDE8E5CE8855FA963(uLocal_1796[0], 1193033728, 0);
				}
			}
			if (!unk_0xD4B321D9096B01FC(uLocal_1796[1]))
			{
				uLocal_1796[1] = unk_0xB983F26E7AFB47BF(4, uParam0->f_16, 436.3171f, -642.8832f, 27.73943f, 32.8396f, 1, 1);
				if (unk_0x52EC8D7433C7E520(436.3171f, -642.8832f, 27.73943f, 2f, 1))
				{
					unk_0x78D0594B2B5D62A1(uLocal_1796[1], 436.3171f, -642.8832f, 27.73943f, 2f, -1);
				}
				else
				{
					unk_0xDE8E5CE8855FA963(uLocal_1796[1], 1193033728, 0);
				}
			}
			if (!unk_0xD4B321D9096B01FC(uLocal_1796[2]))
			{
				uLocal_1796[2] = unk_0xB983F26E7AFB47BF(4, uParam0->f_14, 435.6569f, -645.5588f, 27.73775f, 343.8998f, 1, 1);
				if (unk_0x52EC8D7433C7E520(435.6569f, -645.5588f, 27.73775f, 2f, 1))
				{
					unk_0x78D0594B2B5D62A1(uLocal_1796[2], 435.6569f, -645.5588f, 27.73775f, 2f, -1);
				}
				else
				{
					unk_0xDE8E5CE8855FA963(uLocal_1796[2], 1193033728, 0);
				}
			}
			uLocal_1796[3] = unk_0xB983F26E7AFB47BF(4, joaat("a_m_m_eastsa_01"), 436.6802f, -629.7325f, 27.71444f, 179.4746f, 1, 1);
			unk_0x0453EBC0FB8D8A80(uLocal_1796[1], 0, 0, 2, 0);
			unk_0x0453EBC0FB8D8A80(uLocal_1796[1], 2, 0, 0, 0);
			unk_0x0453EBC0FB8D8A80(uLocal_1796[1], 3, 0, 1, 0);
			unk_0x0453EBC0FB8D8A80(uLocal_1796[1], 4, 0, 2, 0);
			unk_0x0453EBC0FB8D8A80(uLocal_1796[1], 10, 1, 0, 0);
			if (unk_0x52EC8D7433C7E520(436.6802f, -629.7325f, 27.71444f, 2f, 1))
			{
				unk_0x78D0594B2B5D62A1(uLocal_1796[3], 436.6802f, -629.7325f, 27.71444f, 2f, -1);
			}
			else
			{
				unk_0xDE8E5CE8855FA963(uLocal_1796[3], 1193033728, 0);
			}
			return 1;
		}
	}
...
{
	return func_231(unk_0x23625FE58BACEBFD(unk_0x7A8732CFB5113E77()), Param0, iParam3);
}
...
void func_375()
{
	if (!unk_0xD4B321D9096B01FC(iLocal_1804))
	{
		if (!unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
		{
			if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
			{
				iLocal_1804 = unk_0x4D57D3E5ECE15A41(unk_0x0FA8183DAD2B3203(), 0);
				if (unk_0xD4B321D9096B01FC(iLocal_1804) && !unk_0xF4B969E0807E76C7(iLocal_1804, 0))
				{
					func_377(iLocal_1804);
				}
			}
...
void func_376()
{
	...
	if (!unk_0xD4B321D9096B01FC(iLocal_1647))
	{
		return;
	}
	if (!unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
	...
	if (unk_0xB7A628320EFF8E47(Var0, Local_1650) > 10000f)
	{
		if (unk_0xD4B321D9096B01FC(iLocal_1647))
		{
			...
			unk_0x377C9F2989832369(&iLocal_1647);
		}
		if (unk_0xD4B321D9096B01FC(iLocal_1646))
		{
			unk_0x2BBEC4B37B923F4B(iLocal_1646, 1, 0);
	...
	while (iVar0 < 9)
	{
		if (unk_0xD4B321D9096B01FC(Global_96030[iVar0]))
		{
			if (Global_96030[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0x7F375072508F738F(iParam0) == func_148(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_383(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_431(unk_0x0037AFCBDC61F351(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_424(unk_0x0037AFCBDC61F351(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_422(&(Global_98669.f_3));
				if (iVar10 > -1)
				{
...
{
	func_385(&Global_105109, unk_0x0037AFCBDC61F351(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_385(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_43();
	...
	if (!unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
	{
		...
		func_401(unk_0x0FA8183DAD2B3203());
		func_394(unk_0x0FA8183DAD2B3203(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_393())
		{
			func_389(unk_0x0FA8183DAD2B3203(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
void func_395(int iParam0, var uParam1)
{
	...
	if (!unk_0x2BF5E63466422C38(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x8DF76C2DDD0C74F6(iParam0, func_400(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((unk_0xF361E8FFC872484A(iVar9, &Var11) && !func_397(Var11.f_1)) && iVar72 < 51)
			{
...
int func_405(var uParam0)
{
	if (!unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0) && !unk_0x2BF5E63466422C38(unk_0x0FA8183DAD2B3203()))
	{
		if (func_178())
		{
			*uParam0 = func_407(unk_0xACE5E491FC1B0D37(unk_0x0FA8183DAD2B3203(), 0), 6, -1, 0, 1, -1);
...
int func_407(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_177(iVar0))
		{
			...
			{
				fVar1 = unk_0xD34AF93E9BCF12F0(Param0, func_408(iVar0, 0), 1);
...
int func_435(var uParam0, var uParam1, bool bParam2)
{
	...
	if (uParam0->f_274 == 0)
	{
		if (((((((!unk_0xDFE2DFB40A988E19("OJASbs_102") || !unk_0xDFE2DFB40A988E19("OJASbs01")) || !unk_0xDFE2DFB40A988E19("OJASbs02")) || !unk_0xDFE2DFB40A988E19("OJASbs03")) || !unk_0xDFE2DFB40A988E19("OJASbs04")) || !unk_0xC697561B7CE4A050(uParam0->f_5)) || !unk_0xC697561B7CE4A050(uParam0->f_15)) || !unk_0x5B9201742B00334D())
		{
			return 0;
		}
	}
	...
	{
		if ((((!unk_0xDFE2DFB40A988E19("OJAShk_101") || !unk_0xDFE2DFB40A988E19("OJAShk_102")) || !unk_0xDFE2DFB40A988E19("OJAShk_103")) || !unk_0xDFE2DFB40A988E19("OJAShk_104")) || !unk_0xB25A0D192C6A0A5B("ODDJOBS@assassinate@vice@incar"))
		{
		}
	}
	...
	if ((!unk_0xA3D567B14856EDE1(3) && !func_441(&(uParam0->f_34))) && !func_436(uParam1))
	{
		func_488(uParam1);
		return 0;
	}
...
void func_448(var uParam0, var uParam1)
{
	...
	unk_0xB489E71A45CDC02F(0);
	unk_0xA291E27354439AE9(0, 1065353216);
	if (!unk_0xD4B321D9096B01FC(Local_2246[3 /*30*/].f_19))
	{
		Local_2246[3 /*30*/].f_19 = unk_0x847817A65E16621A(uParam0->f_15, Local_2246[3 /*30*/].f_5, Local_2246[3 /*30*/].f_8, 1, 1, 0);
		unk_0x1ECAE5FB4DE78CF8(Local_2246[3 /*30*/].f_19, 1084227584);
	}
	iLocal_1719 = 0;
	iLocal_1722 = 0;
	iLocal_1747 = 3;
	...
	unk_0xCB3446C6A91D1A78(uParam1->f_8, 110.2194f, -775.8312f, 30.4426f, 1, 0, 0, 1);
	unk_0x5A2B7C446C0CF087(uParam1->f_8, 77.2454f);
	unk_0xB425E338F85508A5(*uParam1, uParam1->f_8, -1);
	iLocal_1706 = 0;
	unk_0x9B9D9C83AC80FFE4(*uParam1, uParam1->f_8, "OJASbs_102", 52, 0, 20, -1, -1082130432, 0, 1073741824);
	Local_1758 = { -455.2892f, -326.1364f, 41.22218f };
	unk_0xA871F3C63A1AA375("OJASbs_102", &iLocal_1748);
	unk_0xDA778D908FD69EEE(*uParam1, 1, 1);
	fLocal_1753 = unk_0x4683A25541D81B5D(uParam1->f_8);
	unk_0xB9470B741AA0818C(uParam1->f_8, (fLocal_1752 * 100f));
	unk_0xDEB0AA30ABFDCF48(*uParam1, 3, 1);
	unk_0xD32341B4ADEC0821(uParam1->f_8, 1.5f);
	iLocal_1696 = 1;
	unk_0x860A5CC30A0EF207(uParam1->f_1, 0);
...
{
	if (unk_0xD4B321D9096B01FC(uParam1->f_1) && !unk_0xF4B969E0807E76C7(uParam1->f_1, 0))
	{
		Local_2246[0 /*30*/].f_14[0] = unk_0x81024A420EDCE2B5(uParam1->f_1, 4, uParam0->f_16, 3, 1, 1);
		unk_0xCC94EE23853F38E4(Local_2246[0 /*30*/].f_14[0], 1);
		Local_2246[0 /*30*/].f_14[1] = unk_0x81024A420EDCE2B5(uParam1->f_1, 4, joaat("a_m_m_eastsa_01"), 4, 1, 1);
		unk_0x0453EBC0FB8D8A80(Local_2246[0 /*30*/].f_14[1], 0, 0, 2, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[0 /*30*/].f_14[1], 2, 1, 0, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[0 /*30*/].f_14[1], 3, 1, 0, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[0 /*30*/].f_14[1], 4, 0, 0, 0);
		unk_0xCC94EE23853F38E4(Local_2246[0 /*30*/].f_14[1], 1);
		Local_2246[0 /*30*/].f_14[2] = unk_0x81024A420EDCE2B5(uParam1->f_1, 4, uParam0->f_14, 5, 1, 1);
		unk_0x0453EBC0FB8D8A80(Local_2246[0 /*30*/].f_14[2], 0, 1, 0, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[0 /*30*/].f_14[2], 2, 2, 0, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[0 /*30*/].f_14[2], 3, 1, 0, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[0 /*30*/].f_14[2], 4, 0, 2, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[0 /*30*/].f_14[2], 8, 1, 0, 0);
		unk_0xCC94EE23853F38E4(Local_2246[0 /*30*/].f_14[2], 1);
		Local_2246[1 /*30*/].f_14[0] = unk_0x81024A420EDCE2B5(uParam1->f_1, 4, uParam0->f_16, 6, 1, 1);
		unk_0xCC94EE23853F38E4(Local_2246[1 /*30*/].f_14[0], 1);
		Local_2246[1 /*30*/].f_14[1] = unk_0x81024A420EDCE2B5(uParam1->f_1, 4, joaat("a_m_m_eastsa_01"), 7, 1, 1);
		unk_0x0453EBC0FB8D8A80(Local_2246[1 /*30*/].f_14[1], 0, 0, 1, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[1 /*30*/].f_14[1], 3, 0, 1, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[1 /*30*/].f_14[1], 4, 0, 0, 0);
		unk_0xCC94EE23853F38E4(Local_2246[1 /*30*/].f_14[1], 1);
		Local_2246[1 /*30*/].f_14[2] = unk_0x81024A420EDCE2B5(uParam1->f_1, 4, uParam0->f_14, 8, 1, 1);
		unk_0x0453EBC0FB8D8A80(Local_2246[1 /*30*/].f_14[2], 0, 0, 0, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[1 /*30*/].f_14[2], 3, 0, 1, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[1 /*30*/].f_14[2], 4, 0, 2, 0);
		unk_0xCC94EE23853F38E4(Local_2246[1 /*30*/].f_14[2], 1);
		Local_2246[2 /*30*/].f_14[0] = unk_0x81024A420EDCE2B5(uParam1->f_1, 4, uParam0->f_16, 0, 1, 1);
		unk_0xCC94EE23853F38E4(Local_2246[2 /*30*/].f_14[0], 1);
		Local_2246[2 /*30*/].f_14[1] = unk_0x81024A420EDCE2B5(uParam1->f_1, 4, joaat("a_m_m_eastsa_01"), 1, 1, 1);
		unk_0x0453EBC0FB8D8A80(Local_2246[2 /*30*/].f_14[1], 0, 0, 2, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[2 /*30*/].f_14[1], 2, 0, 0, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[2 /*30*/].f_14[1], 3, 1, 1, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[2 /*30*/].f_14[1], 4, 0, 1, 0);
		unk_0xCC94EE23853F38E4(Local_2246[2 /*30*/].f_14[1], 1);
		Local_2246[2 /*30*/].f_14[2] = unk_0x81024A420EDCE2B5(uParam1->f_1, 4, uParam0->f_14, 2, 1, 1);
		unk_0x0453EBC0FB8D8A80(Local_2246[2 /*30*/].f_14[2], 0, 0, 2, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[2 /*30*/].f_14[2], 2, 0, 1, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[2 /*30*/].f_14[2], 3, 1, 2, 0);
		unk_0x0453EBC0FB8D8A80(Local_2246[2 /*30*/].f_14[2], 4, 0, 1, 0);
		unk_0xCC94EE23853F38E4(Local_2246[2 /*30*/].f_14[2], 1);
	}
}

void func_450(var uParam0)
{
	if (unk_0xD4B321D9096B01FC(uParam0->f_1))
	{
		unk_0xBD22862A2C5FD6DF(&(uParam0->f_1));
	}
	if (bLocal_1713)
	{
		uParam0->f_1 = unk_0x847817A65E16621A(joaat("coach"), 118.3466f, -786.1586f, 30.3105f, 68.7988f, 1, 1, 0);
		unk_0x1ECAE5FB4DE78CF8(uParam0->f_1, 1084227584);
		unk_0xA429E610637A53F5(uParam0->f_1, 0);
	}
	else
	{
		uParam0->f_1 = unk_0x847817A65E16621A(joaat("bus"), 118.3466f, -786.1586f, 30.3105f, 68.7988f, 1, 1, 0);
		unk_0x1ECAE5FB4DE78CF8(uParam0->f_1, 1084227584);
		unk_0xA429E610637A53F5(uParam0->f_1, 0);
	}
	if (unk_0xD960230552BC4165(uParam0->f_1, 0))
	{
		unk_0xCB3446C6A91D1A78(uParam0->f_1, 118.3466f, -786.1586f, 30.3105f, 1, 0, 0, 1);
		unk_0x5A2B7C446C0CF087(uParam0->f_1, 68.7988f);
	}
}
...
void func_451()
{
	...
	while (iVar0 < 4)
	{
		...
		while (iVar1 < 3)
		{
			if (unk_0xD4B321D9096B01FC(Local_2246[iVar0 /*30*/].f_14[iVar1]))
			{
				unk_0x4F058F27442031CC(&(Local_2246[iVar0 /*30*/].f_14[iVar1]));
			}
			iVar1++;
		}
		iVar0++;
...
{
	unk_0xB82DC93528F8603C(Local_1776, 50f, 1, 0, 0, 0);
	unk_0x80BCF42B42433CEB((Local_1776.f_0 - 40f), (Local_1776.f_1 - 40f), (Local_1776.f_2 - 40f), (Local_1776.f_0 + 40f), (Local_1776.f_1 + 40f), (Local_1776.f_2 + 40f), 0, 1);
	if (unk_0xD4B321D9096B01FC(uParam1->f_1))
	{
		if (!bLocal_1703)
		{
			if (unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), uParam1->f_1, 0))
			{
				...
				unk_0xCB3446C6A91D1A78(unk_0x0FA8183DAD2B3203(), uParam0->f_9, 1, 0, 0, 1);
			}
			else
			{
				unk_0xCB3446C6A91D1A78(unk_0x0FA8183DAD2B3203(), 423.25f, -641.36f, 28.5068f, 1, 0, 0, 1);
			}
		}
		unk_0xBD22862A2C5FD6DF(&(uParam1->f_1));
	}
	if (!unk_0xD4B321D9096B01FC(uParam1->f_1))
	{
		if (bLocal_1713)
		{
			uParam1->f_1 = unk_0x847817A65E16621A(joaat("coach"), uParam0->f_9, uParam0->f_12, 1, 1, 0);
			unk_0x1ECAE5FB4DE78CF8(uParam1->f_1, 1084227584);
			unk_0xA429E610637A53F5(uParam1->f_1, 0);
		}
		else
		{
			uParam1->f_1 = unk_0x847817A65E16621A(joaat("bus"), uParam0->f_9, uParam0->f_12, 1, 1, 0);
			unk_0x1ECAE5FB4DE78CF8(uParam1->f_1, 1084227584);
			unk_0xA429E610637A53F5(uParam1->f_1, 0);
		}
	}
...
{
	uParam0->f_1 = (func_166(unk_0xA2BC31158C8CEFD2(*uParam0, 4)) - fParam1);
...
{
	iLocal_1801 = unk_0x847817A65E16621A(uParam0->f_5, 439.7705f, -571.9359f, 27.5068f, 325f, 1, 1, 0);
	unk_0x1ECAE5FB4DE78CF8(iLocal_1801, 1084227584);
	iLocal_1802 = unk_0x847817A65E16621A(uParam0->f_5, 406.7046f, -625.4039f, 27.5068f, 91f, 1, 1, 0);
	unk_0x1ECAE5FB4DE78CF8(iLocal_1802, 1084227584);
}
...
void func_457(var uParam0, var uParam1)
{
	...
	func_201(&(uParam1->f_16), 1, unk_0x0FA8183DAD2B3203(), "FRANKLIN", 0, 1);
	if (uParam0->f_274 == 1)
	{
	...
	if (uParam0->f_274 == 1)
	{
		unk_0x058B6969CEED705F(uParam1->f_2, "ASS_HK_DESTBLIP");
	}
	else if (uParam0->f_274 == 0)
	{
	}
	...
	if (uParam0->f_14 != 0 && uParam0->f_274 != 0)
	{
		...
		{
			uParam1->f_7 = unk_0xB983F26E7AFB47BF(4, uParam0->f_14, uParam0->f_18, uParam0->f_21, 1, 1);
			if (uParam0->f_274 == 1)
			{
				unk_0x5D672CB011E20B28(uParam1->f_7, "ODDJOBS@ASSASSINATE@VICE@HOOKER", "idle_b", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
	...
	if (uParam0->f_15 != 0)
	{
		if (uParam0->f_274 != 0)
		{
			uParam1->f_8 = unk_0x847817A65E16621A(uParam0->f_15, uParam0->f_26, uParam0->f_29, 1, 1, 0);
		}
		if (uParam0->f_274 == 1)
		{
			...
			iLocal_1029 = unk_0x81024A420EDCE2B5(uParam1->f_8, 4, uParam0->f_16, -1, 1, 1);
	...
	if (uParam0->f_274 == 2)
	{
		if (!unk_0x39A01A052D9B5FF0(uParam1->f_2))
		{
			uParam1->f_2 = unk_0xACAD99314B51277E(uParam0->f_6);
			unk_0x925BD1075D119B45(uParam1->f_2, 1);
			unk_0x878F49741469A18E(uParam1->f_2, 1);
			unk_0x088577CF98F96D05(uParam1->f_2, 1);
		}
	}
	else if (uParam0->f_274 == 0)
	{
		...
		unk_0x058B6969CEED705F(uParam1->f_2, "ASS_BS_BLIP");
	}
	else
	{
		uParam1->f_2 = unk_0xACAD99314B51277E(uParam0->f_6);
	...
	while (iVar0 < 4)
	{
		...
		{
			uParam1->f_11[iVar0] = unk_0x7187764DB5121FC9(uParam0->f_244[iVar0], uParam0->f_249[iVar0 /*3*/], 1, 1, 0);
			unk_0x775879DF24E29944(uParam1->f_11[iVar0], 1);
			unk_0x8C85E8C71AD74415(uParam1->f_11[iVar0], 1, 0);
			if (iVar0 == 1)
			{
			...
			{
				unk_0x5A2B7C446C0CF087(uParam1->f_11[iVar0], uParam0->f_262[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_458(var uParam0, var uParam1)
{
	if (uParam0->f_5 != 0)
	{
		if (!unk_0xD4B321D9096B01FC(uParam1->f_1))
		{
			uParam1->f_1 = unk_0x847817A65E16621A(uParam0->f_5, uParam0->f_9, uParam0->f_12, 1, 1, 0);
			if (uParam0->f_274 == 1)
			{
...
void func_460()
{
	...
	unk_0xAC5263AEA7D6AA8A(1.5f);
	unk_0xF67073C8A7485B66(0.5f);
	unk_0xEAD374C7213329E9(426.035f, -644.93f, -100f, 421.035f, -644.93f, 100f, 55f, 0, 0, 1);
	...
	uLocal_1808[0] = unk_0x740FE9B7B3FE1CE5(Var0[0 /*3*/] - Vector(8f, 8f, 8f), Var0[0 /*3*/] + Vector(8f, 8f, 8f), 0, 1, 1, 1);
	uLocal_1808[1] = unk_0x740FE9B7B3FE1CE5(Var0[1 /*3*/] - Vector(8.5f, 8.5f, 8.5f), Var0[1 /*3*/] + Vector(8.5f, 8.5f, 8.5f), 0, 1, 1, 1);
	uLocal_1808[2] = unk_0x740FE9B7B3FE1CE5(Var0[2 /*3*/] - Vector(8.5f, 8.5f, 8.5f), Var0[2 /*3*/] + Vector(8.5f, 8.5f, 8.5f), 0, 1, 1, 1);
	uLocal_1808[3] = unk_0x740FE9B7B3FE1CE5(Var0[3 /*3*/] - Vector(9.5f, 9.5f, 9.5f), Var0[3 /*3*/] + Vector(9.5f, 9.5f, 9.5f), 0, 1, 1, 1);
	uLocal_1808[4] = unk_0x740FE9B7B3FE1CE5(Var0[4 /*3*/] - Vector(8f, 8f, 8f), Var0[4 /*3*/] + Vector(8f, 8f, 8f), 0, 1, 1, 1);
	uLocal_1808[5] = unk_0x740FE9B7B3FE1CE5(Var0[5 /*3*/] - Vector(15f, 15f, 15f), Var0[5 /*3*/] + Vector(15f, 15f, 15f), 0, 1, 1, 1);
}
...
void func_461(var uParam0, var uParam1, bool bParam2)
{
	...
	while ((!unk_0xA3D567B14856EDE1(3) || !func_441(&(uParam0->f_34))) || !func_436(uParam1))
	{
		func_488(uParam1);
		unk_0x4EDE34FBADD967A6(0);
	}
...
void func_471(var uParam0)
{
	...
	{
		case 0:
			unk_0x36B659209EBDD366("oddjobs@assassinate@bus@call");
			unk_0x6BB2B1818CAE531E(joaat("p_phonebox_01b_s"));
			if (unk_0xB25A0D192C6A0A5B("oddjobs@assassinate@bus@call") && unk_0x6DF9C43E3CC645BC(joaat("p_phonebox_01b_s")))
			{
			...
			if (bLocal_1680)
			{
				if (unk_0xD4B321D9096B01FC(iLocal_1646))
				{
					...
					unk_0xB82DC93528F8603C(-26.48f, -110.66f, 56.0227f, 3f, 1, 0, 0, 0);
					...
					if (unk_0xD4B321D9096B01FC(iLocal_1646))
					{
						unk_0x2BBEC4B37B923F4B(iLocal_1646, 0, 0);
						unk_0x8C85E8C71AD74415(iLocal_1646, 0, 0);
						unk_0xE679FB04E61F88AA(iLocal_1646, 0);
						iLocal_1647 = unk_0x7187764DB5121FC9(joaat("p_phonebox_01b_s"), -26.48f, -110.66f, 56.0227f, 1, 1, 0);
						unk_0xF3D48447FACBBE72(iLocal_1647, 0f, 0f, 157.62f, 2, 1);
						unk_0x8C85E8C71AD74415(iLocal_1647, 0, 0);
						unk_0xE679FB04E61F88AA(iLocal_1647, 0);
						unk_0x2BBEC4B37B923F4B(unk_0x0FA8183DAD2B3203(), 1, 0);
					}
					uLocal_1690 = unk_0xB455EDED5B2FA6ED(-26.48f, -110.66f, 56.0227f, 350f, 12, 127);
					func_286(1, 1, 1, 0, 0, 0);
					unk_0xBB65AAC660EECEA8(Local_1653, 5f, 0);
					if (!unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
					{
						unk_0xCFEC09B98C6C5993(unk_0x0FA8183DAD2B3203(), 0, 0);
						unk_0xCB3446C6A91D1A78(unk_0x0FA8183DAD2B3203(), Local_1653, 1, 0, 0, 1);
						unk_0x5A2B7C446C0CF087(unk_0x0FA8183DAD2B3203(), fLocal_1656);
						unk_0xFBE658450F3CCCC4(unk_0x0FA8183DAD2B3203(), 1);
					}
					uLocal_1687 = unk_0xF2A54C51C03CADAA(Local_1681, Local_1684, 2);
					if (unk_0xD4B321D9096B01FC(iLocal_1647))
					{
						unk_0xADFCDA47D7031CF3(uLocal_1687, iLocal_1647, -1);
					}
					unk_0x8582CCEB95B1F1BE(unk_0x0FA8183DAD2B3203(), uLocal_1687, "oddjobs@assassinate@bus@call", "ass_bus_call_p1", 1000f, -2f, 2, 0, 1148846080, 0);
					unk_0xD9EC67B3064ADB79(iLocal_1647, uLocal_1687, "ass_bus_call_phone", "oddjobs@assassinate@bus@call", 1000f, -2f, 0, 1148846080);
					if (!unk_0xD2652A8A890B29BA(uLocal_1648))
					{
						uLocal_1649 = unk_0x3715936BB73409D6(26379945, Local_1660, Local_1663, 36f, 1, 2);
						uLocal_1648 = unk_0x3715936BB73409D6(26379945, Local_1666, Local_1669, 36f, 0, 2);
						unk_0x479DACF5AA4C6D03(uLocal_1648, uLocal_1649, 2500, 1, 1);
						unk_0x0298C8010FD5A69E(1, 0, 3000, 1, 0, 0);
						unk_0x678A9FFAA65D1846(uLocal_1648, "HAND_SHAKE", 0.2f);
					}
					func_201(&(uParam0->f_16), 3, 0, "LESTER", 0, 1);
					func_201(&(uParam0->f_16), 1, unk_0x0FA8183DAD2B3203(), "FRANKLIN", 0, 1);
					unk_0x4BEE8AE599A4A300(0);
					unk_0x5AC8A91A3FD00B39(0);
					uLocal_1689 = unk_0x3C54B78DD92BEA65(-26.48f, -110.66f, 56.0227f, 3f, 3f, 3f, 0f, 0, 7);
					unk_0xE5DAA5553A176799(unk_0x0FA8183DAD2B3203(), joaat("weapon_unarmed"), 1);
				...
				else
				{
					...
					if (!unk_0xD4B321D9096B01FC(iLocal_1646))
					{
						iLocal_1646 = unk_0x91D67DB02D1040F1(Local_1650, 5f, joaat("prop_phonebox_01b"), 1, 0, 1);
					}
				}
			}
			break;
		...
		case 1:
			...
			if (!iLocal_1679)
			{
				if (!unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0))
				{
					if (unk_0xB50E39CA0A3E6020(uLocal_1687))
					{
						if (unk_0x91F0628278985DB8(uLocal_1687) > 0.05f)
						{
			...
			if (func_168(&uLocal_1672))
			{
				if ((func_165(&uLocal_1672) > fLocal_1657 || (unk_0xB50E39CA0A3E6020(uLocal_1687) && unk_0x91F0628278985DB8(uLocal_1687) >= 0.962f)) || bLocal_1678)
				{
					iLocal_1645 = 3;
				}
			}
		...
		case 2:
			...
			if (bLocal_1678)
			{
				if (unk_0x260395BA7F0C83CB())
				{
					...
					{
						unk_0xCFEC09B98C6C5993(unk_0x0FA8183DAD2B3203(), 0, 0);
						unk_0xCB3446C6A91D1A78(unk_0x0FA8183DAD2B3203(), -25.8488f, -109.9882f, 56.0738f, 1, 0, 0, 1);
						unk_0x5A2B7C446C0CF087(unk_0x0FA8183DAD2B3203(), 236.2218f);
					}
					unk_0x1498B6B9F7C33B0A(iLocal_1647, -1000f, 1);
					unk_0x4EDE34FBADD967A6(0);
					unk_0xCF33E56642B34516(500);
		...
		case 3:
			...
			if (unk_0x257687A186581E55(uLocal_1690))
			{
				unk_0xD28D0A0B38E43BAC(uLocal_1690);
			}
			unk_0x8C85E8C71AD74415(iLocal_1647, 1, 0);
			unk_0x4BEE8AE599A4A300(1);
			unk_0x5AC8A91A3FD00B39(1);
			unk_0xC6612209077465DD(unk_0x0FA8183DAD2B3203());
			unk_0x3D0DE925C0536CA0(unk_0x7C7787D2D7139A85(), 1, 0);
			...
			unk_0x31EBACD75CD1F9EC(unk_0x7C7787D2D7139A85(), 0, 0);
			unk_0xF1E958D9BB4D1EF6(unk_0x7C7787D2D7139A85(), 0);
			unk_0x7D74D6A091150B86("oddjobs@assassinate@bus@call");
			unk_0x86A9549BD3D71664(&iLocal_1646);
			iLocal_1042 = 4;
			break;
	}
}
...
int func_474(var uParam0, float fParam1, struct<3> Param2, struct<3> Param5, float fParam8, bool bParam9, float fParam10)
{
	if (unk_0xD2652A8A890B29BA(*uParam0))
	{
		if (func_168(&uLocal_1675))
		{
			...
			{
				unk_0xF44C160C97CC41EB(uLocal_1648, Param2);
				unk_0x92B8564A1A66EF0A(uLocal_1648, Param5, 2);
				unk_0x494374BCB9580EA5(uLocal_1648, fParam8);
				if (bParam9)
				{
					unk_0x678A9FFAA65D1846(uLocal_1648, "HAND_SHAKE", fParam10);
				}
				return 1;
			}
		}
...
void func_483()
{
	...
	{
		if (unk_0x95ED3BD0F52D542A(unk_0x0FA8183DAD2B3203(), iLocal_1803, 0))
		{
			unk_0x5BBDAD06F405ED2C(unk_0x0FA8183DAD2B3203());
			unk_0xCB3446C6A91D1A78(unk_0x0FA8183DAD2B3203(), 421.5518f, -640.2153f, 27.5072f, 1, 0, 0, 1);
		}
		unk_0xE5C667CF3B4642D2(iLocal_1803, 1, 0);
		unk_0xBD22862A2C5FD6DF(&iLocal_1803);
	}
}
...
void func_484(var uParam0, struct<3> Param1, struct<3> Param4)
{
	...
	unk_0x5A7415845A02A4EB(Param1, Param4, 0);
}
	...
	while (iVar1 < 9)
	{
		if (unk_0xD960230552BC4165(uParam0->f_1, 0))
		{
			if (unk_0x300C62F79A4441EB(uParam0->f_1, iVar1, 0) != 0)
			{
				...
				if (unk_0xD4B321D9096B01FC(iVar0) && !unk_0xF4B969E0807E76C7(iVar0, 0))
				{
					unk_0xD7114C99B4392863(iVar0, 0);
				}
			}
		}
		iVar1++;
...
{
	return func_493(&(Global_105109.f_2890), Param0, fParam3, 0);
}
	...
	if (func_521(uParam0))
	{
		...
		if (func_520(uParam0))
		{
			...
			if (unk_0xD4B321D9096B01FC(iVar0))
			{
				...
				else if ((!func_498(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && unk_0x2553916E420E8EF0(unk_0x0037AFCBDC61F351(), "startup_positioning"))
				{
...
int func_498(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_500(iParam0, uVar1[iVar6], 1) && func_499(unk_0xACE5E491FC1B0D37(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_157(Param1, 0f, 0f, 0f, 0)) || unk_0xD34AF93E9BCF12F0(unk_0xACE5E491FC1B0D37(iParam0, 1), unk_0xACE5E491FC1B0D37(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_502(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xD4B321D9096B01FC(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x7F375072508F738F(Global_96030[iVar0]) == func_148(iParam0, iParam1))
				{
...
void func_503(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (unk_0xD960230552BC4165(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (unk_0xA2BC31158C8CEFD2(uParam1->f_77, func_159(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (unk_0xA2BC31158C8CEFD2(uParam1->f_77, func_159(iVar1 + 1)))
			{
			}
			else
			{
				unk_0xA1E7A40E1F56E511(&(uParam1->f_77), func_159(iVar1 + 1));
			}
		}
		...
		if (((unk_0xA2BC31158C8CEFD2(uParam1->f_77, 15) || func_511(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_510())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!unk_0xDC118E11A4081E9A(uParam1->f_66) && !unk_0x5EA23EAAAD4E34BF(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (unk_0xA2BC31158C8CEFD2(uParam1->f_77, func_159(iVar2 + 1)))
				{
...
int func_504(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_508(unk_0x7F375072508F738F(*uParam0), 1) && unk_0xF05B9E4C6631EA28(*uParam0, 24) != func_507(*uParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xED4CA44675A55548(*uParam0, 24, func_507(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_506(uParam0);
	if (func_505(*uParam0))
	{
...
int func_512(int iParam0)
{
	if (unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 0))
	{
		if (!func_518(unk_0x7C7787D2D7139A85(), -1))
		{
	...
	if (func_514(unk_0x7C7787D2D7139A85()) == 3)
	{
		if (unk_0xD4B321D9096B01FC(iParam0) && unk_0xD960230552BC4165(iParam0, 0))
		{
...
{
	unk_0xC5F5645D67898993(Param0, Param3);
	unk_0x5A7415845A02A4EB(Param0, Param3, 1);
	return unk_0x740FE9B7B3FE1CE5(Param0, Param3, 0, 1, 1, 1);
}
...
void func_539()
{
	if (unk_0xE0DB261862B06C9E(uLocal_1689))
	{
		unk_0xA9BF3ADA157950AE(uLocal_1689);
	}
}
