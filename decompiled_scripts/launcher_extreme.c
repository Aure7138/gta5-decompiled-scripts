...
void __EntryFunction__()
{
	...
	iLocal_94 = -1;
	uLocal_96 = unk_0x9F2C1BA4F2BF5CF8();
	...
	if (Var0.f_0 == 17)
	{
		uLocal_97 = unk_0x54ECDA2DAB9CFB10(Var61 - Vector(40f, 40f, 40f), Var61 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
		unk_0x2112CE9FD54D593A("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
	}
	else if (Var0.f_0 == 18)
	{
		uLocal_97 = unk_0x54ECDA2DAB9CFB10(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
	}
	unk_0xF82BC5193AF62796(Var61, Var0.f_15, 1, 0, 0, 0);
	while (true)
	{
		unk_0x4EDE34FBADD967A6(0);
		if (!func_210(&Var0, 1))
		...
		{
			func_201(&Var0);
			if (unk_0x209C5E3492025E4B(uLocal_96))
			{
				func_196(&Var0, Var61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_195() && func_194(Var0.f_28[0])) && !unk_0x70ACD9400516DB25(Var0.f_28[0])) && unk_0x209C5E3492025E4B(uLocal_96)) && unk_0xF6AFEDAAE44A2159("EXTREME_04_DOM_A", 0, -1)) && unk_0xF6AFEDAAE44A2159("EXTREME_04_DOM_B", 0, -1)) && unk_0xF6AFEDAAE44A2159("EXTREME_04_DOM_C", 0, -1))
			{
				unk_0x03AC3DF6C3FAD811(uLocal_96, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_95 == 0 && func_194(unk_0xC1A5EC5C986B98AD())) && unk_0x1C4E4DC1EFE24DF1(unk_0xC1A5EC5C986B98AD(), Var61, Var0.f_15, Var0.f_15, Var0.f_15, 0, 0, 0))
			{
				Var69 = { unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1) };
				if (Var69.f_2 < 100f)
				{
					iLocal_95 = 1;
					func_193("TOPMAZE_HELP", -1);
		...
		if (func_178(&Var0, 0) || func_176(&Var0))
		{
			...
			{
				unk_0xA13B5B0EF7402391(uLocal_96);
			}
			if (func_1(&Var0))
			{
				func_277(&Var0, 0);
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_108();
	...
	if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
	{
		...
		func_65(unk_0xC1A5EC5C986B98AD());
		func_58(unk_0xC1A5EC5C986B98AD(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_55())
		{
			func_48(unk_0xC1A5EC5C986B98AD(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (unk_0x7DE17ACDD8BA2642(Global_98012[iVar0]))
		{
			if (Global_98012[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0x504B9BB48D41C264(iParam0) == func_34(bParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0xFBD273FDBCF0C5BD(iParam0, 0))
	{
		...
		*uParam1 = unk_0x46177D0BA2953EC5(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xECDAB41968FF21A8(&(uParam1->f_77), func_38(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_52(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2848280[iParam0 /*3*/][func_50(iParam1)];
...
void func_56()
{
	...
	{
		if (func_46(Global_113648.f_2365.f_539.f_4321) != unk_0x504B9BB48D41C264(unk_0xC1A5EC5C986B98AD()))
		{
			iVar0 = func_45(unk_0xC1A5EC5C986B98AD());
...
void func_58(int iParam0, bool bParam1)
{
	...
	bVar0 = func_45(iParam0);
	if (func_36(bVar0) && !unk_0x66599E73DBA5A850(iParam0))
	{
		if (iParam0 == unk_0xC1A5EC5C986B98AD())
		{
...
void func_59(int iParam0, var uParam1)
{
	...
	if (!unk_0x66599E73DBA5A850(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x91BEC56C475EB62C(iParam0, func_64(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((unk_0xA44505E95028BA80(iVar9, &Var11) && !func_61(Var11.f_1)) && iVar72 < 51)
			{
...
int func_70(var uParam0)
{
	if (!unk_0x055111B11E6624FD(unk_0xC1A5EC5C986B98AD(), 0) && !unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
	{
		if (func_96())
		{
			*uParam0 = func_76(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 0), 6, -1, 0, 1, -1);
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 59)
	{
		if (iParam3 == 6 || iParam3 == func_95(iVar0))
		{
			...
			{
				fVar1 = unk_0x2E496FE654DA4166(Param0, func_77(iVar0, 0), 1);
...
int func_92()
{
	return func_93(unk_0x93E99A2DBCBA9CFA());
}
...
var func_97()
{
	...
	func_107(&uVar0, unk_0x731F95B6458DCF80());
	func_106(&uVar0, unk_0x77BBAAED3E25322C());
	func_105(&uVar0, unk_0x30DFE1FFD2CC7420());
	func_100(&uVar0, unk_0x8C0F17CAC308A14B());
	func_99(&uVar0, unk_0x61117764C67882B7());
	func_98(&uVar0, unk_0x367F557725B53815());
	return uVar0;
}
...
void func_109(int iParam0)
{
	...
	if (unk_0xCCE9BCDAB8B7FAED() || func_111())
	{
		uVar0 = iParam0;
		unk_0x989939160154E37F(9, &uVar0, 1, 1);
	}
	else if (unk_0x674D69D3896862C7() || func_110())
	{
...
void func_112(char* sParam0, var uParam1, int iParam2)
{
	...
	unk_0x363D7D2154F0040D(sParam0, uParam1, iParam2, func_113(0));
}
...
void func_119(int iParam0)
{
	...
	if (Global_44446 == 1)
	{
		if (func_131(unk_0xC1A5EC5C986B98AD()))
		{
			func_122(unk_0xC1A5EC5C986B98AD());
		}
	}
	if (!func_171())
	{
...
void func_138(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (unk_0xA26A9A07F761D8F8())
		{
			if ((((((!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()) && !func_142(unk_0x93E99A2DBCBA9CFA())) && !func_140(unk_0x93E99A2DBCBA9CFA(), 0)) && !func_139()) && !bParam4) && !bParam5) && !unk_0x8253CEEA17ED481B())
			{
				unk_0x226C3A30511D5DC4(unk_0xC1A5EC5C986B98AD(), 0);
			}
		}
		else if (((!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()) && !func_142(unk_0x93E99A2DBCBA9CFA())) && !bParam4) && !bParam5)
		{
			unk_0x226C3A30511D5DC4(unk_0xC1A5EC5C986B98AD(), 0);
		}
		Global_78556 = 0;
...
void func_151()
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
		{
			if (func_152(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_169()
{
	return func_170(unk_0x688846D56810779A(), 0);
}
...
void func_172(int iParam0, var uParam1)
{
	...
	{
		case 0:
			*uParam1 = func_173(-1604.668f, 5239.1f, 3.01f, 0);
			unk_0xEA4639F4444B7003(*uParam1, 66);
			unk_0x1886753DA39F38F8(*uParam1, 42);
			break;
		
		case 1:
			*uParam1 = func_173(-1592.84f, 5214.04f, 3.01f, 0);
			unk_0xEA4639F4444B7003(*uParam1, 400);
			unk_0x1886753DA39F38F8(*uParam1, 42);
			break;
		
		case 2:
		case 3:
			*uParam1 = func_173(190.26f, -956.35f, 29.63f, 0);
			if ((BitTest(Global_113648.f_18576[2 /*6*/], 3) || BitTest(Global_113648.f_18576[4 /*6*/], 3)) || BitTest(Global_113648.f_18576[4 /*6*/], 3))
			{
				unk_0xEA4639F4444B7003(*uParam1, 381);
			}
			else
			{
				unk_0xEA4639F4444B7003(*uParam1, 66);
			...
			{
				unk_0x1886753DA39F38F8(*uParam1, 44);
			}
			break;
		
		case 4:
			*uParam1 = func_173(414f, -761f, 29f, 0);
			...
			unk_0x1886753DA39F38F8(*uParam1, 43);
			break;
		
		case 9:
			*uParam1 = func_173(-1622.89f, 4204.87f, 83.3f, 0);
			unk_0xEA4639F4444B7003(*uParam1, 66);
			unk_0x1886753DA39F38F8(*uParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
			{
				*uParam1 = func_173(1835.53f, 4705.86f, 38.1f, 0);
			}
			else if (iParam0 == 12)
			{
				*uParam1 = func_173(1826.13f, 4698.88f, 38.92f, 0);
			}
			else
			{
				*uParam1 = func_173(637.02f, 119.7093f, 89.5f, 0);
			}
			unk_0xEA4639F4444B7003(*uParam1, 206);
			unk_0x1886753DA39F38F8(*uParam1, 42);
			break;
		...
		case 19:
			if (iParam0 == 18)
			{
				*uParam1 = func_173(-954.19f, -2760.05f, 14.64f, 0);
			}
			else
			{
				*uParam1 = func_173(-63.8f, -809.5f, 321.8f, 0);
			}
			unk_0xEA4639F4444B7003(*uParam1, 382);
			unk_0x1886753DA39F38F8(*uParam1, 43);
			break;
		...
		case 23:
			if (iParam0 == 21)
			{
				*uParam1 = func_173(-1877.82f, -440.649f, 45.05f, 0);
			}
			else
			{
				*uParam1 = func_173(-915.6f, 6139.2f, 5.5f, 0);
			}
			if ((BitTest(Global_113648.f_18576[21 /*6*/], 3) || BitTest(Global_113648.f_18576[22 /*6*/], 3)) || BitTest(Global_113648.f_18576[23 /*6*/], 3))
			{
				unk_0xEA4639F4444B7003(*uParam1, 405);
			}
			else
			{
				unk_0xEA4639F4444B7003(*uParam1, 66);
		...
		case 27:
			*uParam1 = func_173(-1104.93f, 291.25f, 64.3f, 0);
			unk_0xEA4639F4444B7003(*uParam1, 66);
			unk_0x1886753DA39F38F8(*uParam1, 44);
			break;
		...
		case 30:
			*uParam1 = func_173(-1104.93f, 291.25f, 64.3f, 0);
			unk_0xEA4639F4444B7003(*uParam1, 385);
			unk_0x1886753DA39F38F8(*uParam1, 44);
			break;
		
		case 34:
			*uParam1 = func_173(-303.82f, 6211.29f, 31.05f, 0);
			unk_0xEA4639F4444B7003(*uParam1, 386);
			unk_0x1886753DA39F38F8(*uParam1, 44);
			break;
		
		case 43:
			*uParam1 = func_173(-44.75f, -1288.67f, 28.21f, 0);
			unk_0xEA4639F4444B7003(*uParam1, 149);
			unk_0x1886753DA39F38F8(*uParam1, 44);
			break;
		
		case 46:
			*uParam1 = func_173(-149.75f, 285.81f, 93.67f, 0);
			unk_0xEA4639F4444B7003(*uParam1, 66);
			unk_0x1886753DA39F38F8(*uParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
			{
				*uParam1 = func_173(-70.71f, 301.43f, 106.79f, 0);
			}
			else
			{
				*uParam1 = func_173(-257.22f, 292.85f, 90.63f, 0);
			}
			unk_0xEA4639F4444B7003(*uParam1, 389);
			unk_0x1886753DA39F38F8(*uParam1, 43);
			break;
	}
}

var func_173(struct<3> Param0, int iParam3)
{
	var uVar0;
	
	uVar0 = unk_0x7F0C74F83813841D(Param0);
	unk_0x225EB85DBC38E707(uVar0, func_174(unk_0xA26A9A07F761D8F8(), 1f, 1f));
	unk_0xBD91E7D4B770F97E(uVar0, iParam3);
	return uVar0;
}

float func_174(bool bParam0, float fParam1, float fParam2)
{
	if (bParam0)
	{
		return fParam1;
...
int func_176(var uParam0)
{
	if (*uParam0 == 18)
	{
		if (unk_0x9DC9E896F189AAA5(unk_0xC1A5EC5C986B98AD(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, 0, 1, 0))
		{
			if (!unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
			{
			...
			else if ((!func_177(unk_0xC1A5EC5C986B98AD(), joaat("script_task_leave_any_vehicle")) && func_194(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0))) && func_152(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0), 3f, 1, 1056964608, 0, 1, 0))
			{
				unk_0x6FE9A0C01D25F413(unk_0xC1A5EC5C986B98AD(), 0, 0);
			}
		}
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (unk_0x3C3D6D026CF7F51B(unk_0xC1A5EC5C986B98AD(), 0))
				{
					if (func_194(unk_0x95DC39736F6748E3(unk_0xC1A5EC5C986B98AD(), 0)))
					{
		...
		if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
		{
			if (!unk_0x66599E73DBA5A850(unk_0xC1A5EC5C986B98AD()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1) || func_192()) || Global_32166) || func_191()) || func_190(8, -1)) || func_188()) || func_96()) || func_189()) || func_187()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0xE2A83DCD3E79D8D3(unk_0x93E99A2DBCBA9CFA()) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD())) || unk_0x5CD470B5BDDAC029(unk_0xC1A5EC5C986B98AD())) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD())) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD())) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1)) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA())) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0)) || func_192()) || Global_112695) || Global_32166) || func_191()) || func_190(8, -1)) || func_188()) || func_96()) || func_189()) || func_187()) || Global_113648.f_7690.f_919[bVar0] == 5) || Global_43804 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD()) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD())) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1)) || unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0)) || func_192()) || Global_112695) || Global_32166) || func_191()) || func_190(8, -1)) || func_96()) || func_189()) || func_187()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_192() || unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) > 0) || func_190(8, -1)) || func_187()) || func_186()) || Global_113648.f_7690.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
						{
							if ((((((((((((((unk_0xB8C39D031C377E33(unk_0xC1A5EC5C986B98AD(), 0) || unk_0x83C5A442AAD15BAF(unk_0x93E99A2DBCBA9CFA()) > 0) || unk_0xDA70CA6A0D1738D3(unk_0xC1A5EC5C986B98AD())) || unk_0x48A4D45B3B4CEFFD(unk_0xC1A5EC5C986B98AD())) || unk_0x854821B2A72B2E98(unk_0xC1A5EC5C986B98AD())) || unk_0xF41A4983A3778F18(unk_0x93E99A2DBCBA9CFA(), 1)) || unk_0x5150E13C3DAAE892(unk_0x93E99A2DBCBA9CFA())) || func_192()) || Global_32166) || func_191()) || func_190(8, -1)) || func_189()) || func_188()) || func_187()) || Global_113648.f_7690.f_919[bVar0] == 5)
							{
								return 0;
							}
						}
...
int func_196(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_194(unk_0xC1A5EC5C986B98AD()) && func_194(iParam0->f_28[0])) && !func_195()) && (unk_0xA5E11AF0A2B928C1() - iParam0->f_60) > iParam8) && func_200(unk_0xC1A5EC5C986B98AD(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_199(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_197(&uVar0, cParam4, sParam5, 7, 0, 0);
		iParam0->f_60 = unk_0xA5E11AF0A2B928C1();
		return 1;
	}
	return 0;
}
...
void func_201(int iParam0)
{
	if (unk_0x3B7E6BE32C24780B())
	{
		...
		{
			unk_0x414C472A4880EAA3("Dom", iParam0->f_28[0], 0);
		}
	}
}
...
void func_202(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x48DC6A21D1CAD89C(unk_0x93E99A2DBCBA9CFA()))
	{
		if (!unk_0x2AC37494BBF1DB16(sParam1))
		{
			...
			{
				if (func_200(unk_0xC1A5EC5C986B98AD(), Param2, 1) <= 100f)
				{
					func_205(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_200(unk_0xC1A5EC5C986B98AD(), Param2, 1) > 120f)
				{
					func_207(iParam0);
				}
			}
...
void func_211(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_194(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_213(uParam1) || !unk_0x7BB3D8F4F6310EB8(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_212(iParam2) && !unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 25f))
					{
						unk_0x06A2A5F6A6959BE7(iParam0, unk_0xC1A5EC5C986B98AD(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_213(uParam1) && uParam1->f_4 == 0) && unk_0x2E496FE654DA4166(unk_0x30BE8A934C020461(unk_0xC1A5EC5C986B98AD(), 1), unk_0x30BE8A934C020461(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_212(iParam2) || unk_0xD495130AEF425591(iParam0, unk_0xC1A5EC5C986B98AD(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x3EE48ADC8C7F5CC4(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
void func_215(var uParam0)
{
	...
	if (func_194(unk_0xC1A5EC5C986B98AD()))
	{
		iVar0 = 0;
			...
			if (unk_0x7DE17ACDD8BA2642(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_219(unk_0xC1A5EC5C986B98AD(), uParam0->f_35[iVar0]))
							{
...
int func_222(int iParam0, float fParam1)
{
	...
	if (func_194(unk_0xC1A5EC5C986B98AD()) && func_194(iParam0))
	{
		if (func_233(iParam0) || unk_0xEE404E66D9BD6D2A(unk_0x93E99A2DBCBA9CFA(), iParam0))
		{
...
bool func_223(int iParam0, float fParam1)
{
	return func_224(iParam0, unk_0xC1A5EC5C986B98AD(), fParam1, 1, 250, 7);
}

bool func_224(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_225(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_228(int iParam0, int iParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_230(unk_0x30BE8A934C020461(iParam1, 1) - unk_0x30BE8A934C020461(iParam0, 1)) };
	...
	{
		Var3 = { func_230(unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 5f, 0f) - unk_0x985D9D5ED4D5145A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_234(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_194(unk_0xC1A5EC5C986B98AD()) && func_194(uParam0))
	{
...
int func_236(var uParam0, float fParam1)
{
	...
	{
		if (func_237(uParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_237(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_230(Param1 - unk_0x30BE8A934C020461(uParam0, 1)) };
...
int func_249(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			while (iVar2 <= (iVar0 - 1))
			{
				unk_0x852EC2A7DE66202D(iVar0[iVar2]);
				iVar2++;
			}
		...
		case 2:
			...
			unk_0x149C9BF03FAA7A38(uParam0->f_28[0], 1);
			unk_0xE3A4D3C32DE7B62E(uParam0->f_28[0], 2);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
				unk_0xE0A291F406691F03(iVar0[iVar2]);
				iVar2++;
			}
			return 1;
			break;
...
void func_250(var uParam0, struct<3> Param1, float fParam4)
{
	func_251(uParam0, iLocal_93, Param1, fParam4, 26);
	unk_0x87EDBB907BE25521(*uParam0);
	unk_0x1B58D923DDA17255(*uParam0, 0);
	unk_0x260A70C42FAA4EDC(*uParam0, "EXTREME LAUNCHER RC");
}

void func_251(var uParam0, int iParam1, struct<3> Param2, var uParam5, int iParam6)
{
	func_252(uParam0);
	*uParam0 = unk_0x69FDD9508259E5B5(iParam6, iParam1, Param2, uParam5, 0, 0);
}
...
void func_255(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
			{
				...
				{
					unk_0x598D91BBD045C1F3(uParam0->f_28[0], 118, 0);
					unk_0x598D91BBD045C1F3(uParam0->f_28[0], 208, 1);
					unk_0xCBDC2B59922F92C3(uParam0->f_28[0], joaat("gadget_parachute"), 1, 0, 0);
					unk_0xFECAE061D8C80757(uParam0->f_28[0], 8, 1, 0, 0);
				}
				else
				{
					bVar3 = false;
...
int func_257(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_258(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0x7DE17ACDD8BA2642(*uParam0))
		{
			if (!unk_0x055111B11E6624FD(*uParam0, 0))
...
int func_258(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	int iVar0;
...
int func_260(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			while (iVar4 <= (iVar0 - 1))
			{
				unk_0x852EC2A7DE66202D(iVar0[iVar4]);
				iVar4++;
			}
		...
		case 2:
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_28[0]))
			{
				...
				{
					unk_0x2EDDA32F6EF3C8B7(uParam0->f_28[0], -954.2f, -2760.05f, 14.04f, 1, 0, 1);
					unk_0x598D91BBD045C1F3(uParam0->f_28[0], 118, 0);
					unk_0x598D91BBD045C1F3(uParam0->f_28[0], 208, 1);
					unk_0x2718E9CC165A99F6(uParam0->f_28[0], 1);
					unk_0xDDE449983CE7572E(uParam0->f_28[0], 0, 0);
					unk_0xFECAE061D8C80757(uParam0->f_28[0], 8, 1, 0, 0);
					unk_0x3EE48ADC8C7F5CC4(uParam0->f_28[0], uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 33281, 0, 0, 0, 0);
					if (unk_0x7DE17ACDD8BA2642(unk_0xC1A5EC5C986B98AD()))
					{
						unk_0xEDB03CCB50D11479(uParam0->f_28[0], unk_0xC1A5EC5C986B98AD(), -1, 48, 2);
					}
				}
				else
				{
			...
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[0]))
			{
				...
				unk_0x439314AD4FC79186(uParam0->f_35[0], 2);
				unk_0x7A1950259E8A78CC(uParam0->f_35[0], 0);
				unk_0x24C146D70061EDE5(uParam0->f_35[0], 0f);
			}
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[1]))
			{
				func_261(&(uParam0->f_35[1]), iVar0[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
				unk_0x439314AD4FC79186(uParam0->f_35[1], 2);
				unk_0x7A1950259E8A78CC(uParam0->f_35[1], 1);
				unk_0x24C146D70061EDE5(uParam0->f_35[1], 0f);
			}
			if (!unk_0x7DE17ACDD8BA2642(uParam0->f_35[2]))
			{
				func_261(&(uParam0->f_35[2]), iVar0[1], -957.23f, -2764.89f, 14.04f, 147.61f);
				unk_0x439314AD4FC79186(uParam0->f_35[2], 2);
				unk_0x7A1950259E8A78CC(uParam0->f_35[2], 2);
				unk_0x24C146D70061EDE5(uParam0->f_35[2], 0f);
				unk_0x53A563E258997DA8(uParam0->f_35[2], 0);
				unk_0x495ED6976429C1E8(uParam0->f_35[2], 0, 0);
			}
			if (bVar5)
			{
				iLocal_91 = 3;
		...
		case 3:
			...
			while (iVar4 <= (iVar0 - 1))
			{
				unk_0xE0A291F406691F03(iVar0[iVar4]);
				iVar4++;
			}
			return 1;
			break;
...
void func_261(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_262(uParam0);
...
void func_277(int iParam0, bool bParam1)
{
	if (*iParam0 == 18)
	{
		...
		{
			unk_0x439314AD4FC79186(iParam0->f_35[0], 1);
		}
		if (func_194(iParam0->f_35[1]))
		{
			unk_0x439314AD4FC79186(iParam0->f_35[1], 1);
		}
	}
	if (bParam1)
	{
	...
	if (unk_0xCE4AAA035282336C(uLocal_98))
	{
		unk_0x45533C09A6C9B409(&uLocal_98);
	}
	func_278(&(iParam0->f_48));
	if (*iParam0 == 17)
	{
		unk_0x17D46728E18012D3(uLocal_97, 0);
		unk_0x2112CE9FD54D593A("WORLD_VEHICLE_SALTON_DIRT_BIKE", 1);
	}
	else if (*iParam0 == 18)
	{
		unk_0x17D46728E18012D3(uLocal_97, 0);
	...
	{
		unk_0xA13B5B0EF7402391(uLocal_96);
		unk_0x0B34FA69ECCE3927("rcmextreme3");
