...
void __EntryFunction__()
{
	...
	iLocal_92 = func_286(52);
	iLocal_93 = joaat("a_c_retriever");
	iLocal_94 = -1;
	uLocal_96 = unk_0x7A3ECD08D6D1D554();
	...
	if (unk_0x5EBD03AF78E7B4DB(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_105157[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_283("Relinquishing candidate id...");
				func_282(&(Global_105157[Var0.f_0 /*10*/].f_9));
			}
		}
		func_270(&Var0, 1);
	}
	...
	if (Var0.f_0 == 17)
	{
		uLocal_97 = unk_0xF66A39BBE7B3C278(Var61 - Vector(40f, 40f, 40f), Var61 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
		unk_0x66E6A13BAFFFB63C("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
	}
	else if (Var0.f_0 == 18)
	{
		uLocal_97 = unk_0xF66A39BBE7B3C278(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
	}
	unk_0xFDD15D670AD33E10(Var61, Var0.f_15, 1, 0, 0, 0);
	while (true)
	{
		unk_0x4EDE34FBADD967A6(0);
		if (!func_203(&Var0, 1))
		...
		func_202(Var0.f_0);
		func_195(&iLocal_94, &(Var0.f_9), Var61);
		if (Var0.f_0 == 18)
		{
			func_194(&Var0);
			func_189(&Var0, Var61, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0.f_0 == 19)
		{
			func_194(&Var0);
			if (unk_0x57269F5E44F5F616(uLocal_96))
			{
				func_189(&Var0, Var61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_188() && func_187(Var0.f_28[0])) && !unk_0x958D2327555FAEA5(Var0.f_28[0])) && unk_0x57269F5E44F5F616(uLocal_96)) && unk_0x61346376C1469A0E("EXTREME_04_DOM_A", 0, -1)) && unk_0x61346376C1469A0E("EXTREME_04_DOM_B", 0, -1)) && unk_0x61346376C1469A0E("EXTREME_04_DOM_C", 0, -1))
			{
				unk_0x6020229E34827A69(uLocal_96, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_95 == 0 && func_187(unk_0xA19140A5C42D8715())) && unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), Var61, Var0.f_15, Var0.f_15, Var0.f_15, 0, 0, 0))
			{
				Var69 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1) };
				if (Var69.f_2 < 100f)
				{
					iLocal_95 = 1;
					func_186("TOPMAZE_HELP", -1);
					func_283("Player below mission start location so displaying help text TOPMAZE_HELP");
				}
			}
		}
		if (func_171(&Var0, 0) || func_169(&Var0))
		{
			if (func_168(Var0.f_0))
			{
				func_165(Var0.f_0, &uLocal_98);
			}
			if (!func_2(&Var0))
			{
				func_270(&Var0, 1);
			...
			{
				unk_0x5DE59A67B5F326CF(uLocal_96);
			}
			if (func_1(&Var0))
			{
				func_270(&Var0, 0);
...
{
	while (!Global_105157[*iParam0 /*10*/])
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	return 1;
...
int func_2(int iParam0)
{
	...
	MemCopy(&sVar32, {func_108(*iParam0)}, 4);
...
{
	func_21(sParam1);
	unk_0xFA57C719261AA55D(&(Global_106070.f_18546[iParam0 /*6*/]), 5);
	if (unk_0x8B1574454E8C2421(joaat("mission_stat_watcher")) > 0)
	{
		while (unk_0x8B1574454E8C2421(joaat("mission_stat_watcher")) > 0)
		{
			func_19();
			unk_0x4EDE34FBADD967A6(0);
		}
	...
	{
		Global_56182 = 0;
		unk_0xD75A4240F0AD8613("mission_stat_watcher");
		while (!unk_0xB1FDFCECA75CE4A7("mission_stat_watcher"))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		unk_0xE81651AD79516E48("mission_stat_watcher", 1828);
		unk_0x4659F4154D948B01("mission_stat_watcher");
	}
	while (!unk_0x05EFB6A616B6FADE(Global_106070.f_18546[iParam0 /*6*/], 5))
	{
		if (unk_0x8B1574454E8C2421(joaat("mission_stat_watcher")) > 0)
		{
			unk_0x2BCFB39E86340DAA(&(Global_106070.f_18546[iParam0 /*6*/]), 5);
		}
	}
	func_4(iParam0);
}
...
void func_4(int iParam0)
{
	...
	MemCopy(&Global_56196, {func_9(iParam0)}, 4);
	Global_56184 = 0;
	Global_56183 = 0;
	switch (iParam0)
	{
...
{
	Global_56200 = 0;
	Global_56204 = func_15(joaat("sp0_shots"));
	Global_56203 = func_15(joaat("sp0_hits"));
	Global_56206 = func_15(joaat("sp1_shots"));
	Global_56205 = func_15(joaat("sp1_hits"));
	Global_56208 = func_15(joaat("sp2_shots"));
	Global_56207 = func_15(joaat("sp2_hits"));
}
...
void func_19()
{
	if (unk_0x8B1574454E8C2421(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
		{
			...
			{
				Global_56176 = 0;
				unk_0xE38A3C362F1CFBF3("mission_stat_watcher");
			}
		}
		else
		{
...
void func_23(char[4] cParam0, int iParam1, int iParam2)
{
	if (Global_93232 != 10 && Global_93232 != 9)
	{
		...
		func_25(&Global_96664, cParam0, 0, "Start", iParam1, iParam2);
		func_24();
		Global_87505 = 0;
	}
}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_104();
	...
	if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		...
		func_64(unk_0xA19140A5C42D8715());
		func_57(unk_0xA19140A5C42D8715(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_54())
		{
			func_47(unk_0xA19140A5C42D8715(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (unk_0xDC5D81351D6A4DDB(Global_90658[iVar0]))
		{
			if (Global_90658[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0x8F474E419F56E48D(iParam0) == func_34(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0x1095F403F52B42E1(iParam0, 0))
	{
		...
		*uParam1 = unk_0xDDB38D7590A81CE5(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x2BCFB39E86340DAA(&(uParam1->f_77), func_38(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_55()
{
	...
	{
		if (func_46(Global_106070.f_2355.f_539.f_4301) != unk_0x8F474E419F56E48D(unk_0xA19140A5C42D8715()))
		{
			iVar0 = func_45(unk_0xA19140A5C42D8715());
			if (func_36(iVar0) && (!func_56(14) || Global_105021))
			{
				if (Global_106070.f_2355.f_539.f_4301 != iVar0 && func_36(Global_106070.f_2355.f_539.f_4301))
				{
...
void func_57(int iParam0, bool bParam1)
{
	...
	iVar0 = func_45(iParam0);
	if (func_36(iVar0) && !unk_0x4915F4759304D5CF(iParam0))
	{
		if (iParam0 == unk_0xA19140A5C42D8715())
		{
			func_58(iParam0, &(Global_106070.f_2355.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_58(int iParam0, var uParam1)
{
	...
	if (!unk_0x4915F4759304D5CF(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = unk_0x3D2A81E3C295D501(iParam0, func_63(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((unk_0x8798F3E6AE76AF63(iVar9, &Var11) && !func_60(Var11.f_1)) && iVar72 < 50)
			{
...
int func_69(var uParam0)
{
	if (!unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		if (func_92())
		{
			*uParam0 = func_75(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 0), 6, -1, 0, 1, -1);
...
int func_71(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x4C9BACA8D249CB13())
	{
		if (func_73() == 0)
		{
			return unk_0x05EFB6A616B6FADE(func_48(func_72(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_75(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam3 == 6 || iParam3 == func_91(iVar0))
		{
			...
			{
				fVar1 = unk_0x499324B3EF19C288(Param0, func_76(iVar0, 0), 1);
...
Vector3 func_76(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_87(Global_95303);
			break;
		
		case 46:
			if (Global_1589591 != func_86())
			{
				if (func_85(Global_1589591))
				{
					return func_78(2, 2);
				}
				else if (func_77(Global_1589591))
				{
					return func_78(45, 3);
				}
				else
...
int func_88()
{
	return func_89(unk_0xD4E735F4B6A956AC());
}
...
var func_93()
{
	...
	func_103(&uVar0, unk_0xC5B07C33AC7BB174());
	func_102(&uVar0, unk_0x65DA628D62901275());
	func_101(&uVar0, unk_0x34CEB9721AC6A0A9());
	func_96(&uVar0, unk_0xC9A0B68BA813CF99());
	func_95(&uVar0, unk_0x897D202BD69186D5());
	func_94(&uVar0, unk_0x56EBDF0E39D83471());
	return uVar0;
}
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_99(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
...
void func_105(int iParam0)
{
	...
	{
		uVar0 = iParam0;
		unk_0x14D4D10C8FD9E0DD(9, &uVar0, 1, 1);
	}
	else if (unk_0x332D85764ED0503F() || unk_0x7DD04831D0FC44CA())
	{
		...
		unk_0x5182FF270C9DCEBC(9, &cVar1);
	}
}
...
void func_106(char* sParam0, var uParam1, int iParam2)
{
	...
	unk_0x68A0B28BF08CE0B0(sParam0, uParam1, iParam2, func_107(0));
}
...
int func_112(var* uParam0)
{
	...
	{
		if (!unk_0x429D45A6C6520026(&(uParam0->f_9)))
		{
			func_131(1);
		...
		if (uParam0->f_27)
		{
			if (func_128(*uParam0))
			{
				while (!unk_0x2206F47E5C82D52C(unk_0xA19140A5C42D8715()))
				{
					func_144();
					unk_0x4EDE34FBADD967A6(0);
				}
		...
		func_113(*uParam0);
		iVar0 = unk_0xB8BA7F44DF1575E1(&(uParam0->f_1), uParam0, 61, 25000);
		unk_0x4659F4154D948B01(&(uParam0->f_1));
		if (unk_0x7974D616EF03E483())
		{
			func_283("Initial cutscene loaded and passing to RC mission.");
			unk_0x97ADECA58E284B43(iVar0);
		}
		else
		{
...
void func_113(int iParam0)
{
	...
	if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		...
		unk_0x13E0A8160525AE55(unk_0xA19140A5C42D8715(), 250, 0);
	}
	if (func_126(iParam0))
	{
	...
	if (Global_37271 == 1)
	{
		...
		{
			func_116(unk_0xA19140A5C42D8715());
		}
	}
	if (!func_164())
	{
...
void func_129(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 6)
	{
		if (func_187(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_187(uParam0->f_41[iVar0]))
		{
...
void func_132(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (unk_0x4C9BACA8D249CB13())
		{
			if ((((!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()) && !func_136(unk_0xD4E735F4B6A956AC())) && !func_134(unk_0xD4E735F4B6A956AC(), 0)) && !func_133()) && !bParam4)
			{
				unk_0x33CF95E95A476FB9(unk_0xA19140A5C42D8715(), 0);
			}
		}
		else if ((!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()) && !func_136(unk_0xD4E735F4B6A956AC())) && !bParam4)
		{
			unk_0x33CF95E95A476FB9(unk_0xA19140A5C42D8715(), 0);
		}
		Global_71203 = 0;
...
int func_141(char* sParam0)
{
	...
	{
		unk_0xD75A4240F0AD8613(uParam0);
...
void func_145()
{
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			if (func_146(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_155(int iParam0)
{
	...
	iVar0 = func_157(&(Global_105157[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
int func_162()
{
	return func_163(unk_0x61D2332983ACC05C(), 0);
}
...
void func_165(int iParam0, var uParam1)
{
	...
	{
		case 0:
			*uParam1 = func_166(-1604.668f, 5239.1f, 3.01f, 0);
			unk_0x7DB79A42AADE120F(*uParam1, 66);
			unk_0x570128B7829A8EAA(*uParam1, 42);
			break;
		
		case 1:
			*uParam1 = func_166(-1592.84f, 5214.04f, 3.01f, 0);
			unk_0x7DB79A42AADE120F(*uParam1, 400);
			unk_0x570128B7829A8EAA(*uParam1, 42);
			break;
		
		case 2:
		case 3:
			*uParam1 = func_166(190.26f, -956.35f, 29.63f, 0);
			if ((unk_0x05EFB6A616B6FADE(Global_106070.f_18546[2 /*6*/], 3) || unk_0x05EFB6A616B6FADE(Global_106070.f_18546[4 /*6*/], 3)) || unk_0x05EFB6A616B6FADE(Global_106070.f_18546[4 /*6*/], 3))
			{
				unk_0x7DB79A42AADE120F(*uParam1, 381);
			}
			else
			{
				unk_0x7DB79A42AADE120F(*uParam1, 66);
			...
			{
				unk_0x570128B7829A8EAA(*uParam1, 44);
			}
			break;
		
		case 4:
			*uParam1 = func_166(414f, -761f, 29f, 0);
			if (unk_0x05EFB6A616B6FADE(Global_106070.f_18546[2 /*6*/], 3) || unk_0x05EFB6A616B6FADE(Global_106070.f_18546[3 /*6*/], 3))
			{
				unk_0x7DB79A42AADE120F(*uParam1, 381);
			}
			else
			...
			unk_0x570128B7829A8EAA(*uParam1, 43);
			break;
		
		case 9:
			*uParam1 = func_166(-1622.89f, 4204.87f, 83.3f, 0);
			unk_0x7DB79A42AADE120F(*uParam1, 66);
			unk_0x570128B7829A8EAA(*uParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
			{
				*uParam1 = func_166(1835.53f, 4705.86f, 38.1f, 0);
			}
			else if (iParam0 == 12)
			{
				*uParam1 = func_166(1826.13f, 4698.88f, 38.92f, 0);
			}
			else
			{
				*uParam1 = func_166(637.02f, 119.7093f, 89.5f, 0);
			}
			unk_0x7DB79A42AADE120F(*uParam1, 206);
			unk_0x570128B7829A8EAA(*uParam1, 42);
			break;
		...
		case 19:
			if (iParam0 == 18)
			{
				*uParam1 = func_166(-954.19f, -2760.05f, 14.64f, 0);
			}
			else
			{
				*uParam1 = func_166(-63.8f, -809.5f, 321.8f, 0);
			}
			unk_0x7DB79A42AADE120F(*uParam1, 382);
			unk_0x570128B7829A8EAA(*uParam1, 43);
			break;
		...
		case 23:
			if (iParam0 == 21)
			{
				*uParam1 = func_166(-1877.82f, -440.649f, 45.05f, 0);
			}
			else
			{
				*uParam1 = func_166(-915.6f, 6139.2f, 5.5f, 0);
			}
			if ((unk_0x05EFB6A616B6FADE(Global_106070.f_18546[21 /*6*/], 3) || unk_0x05EFB6A616B6FADE(Global_106070.f_18546[22 /*6*/], 3)) || unk_0x05EFB6A616B6FADE(Global_106070.f_18546[23 /*6*/], 3))
			{
				unk_0x7DB79A42AADE120F(*uParam1, 405);
			}
			else
			{
				unk_0x7DB79A42AADE120F(*uParam1, 66);
		...
		case 27:
			*uParam1 = func_166(-1104.93f, 291.25f, 64.3f, 0);
			unk_0x7DB79A42AADE120F(*uParam1, 66);
			unk_0x570128B7829A8EAA(*uParam1, 44);
			break;
		...
		case 30:
			*uParam1 = func_166(-1104.93f, 291.25f, 64.3f, 0);
			unk_0x7DB79A42AADE120F(*uParam1, 385);
			unk_0x570128B7829A8EAA(*uParam1, 44);
			break;
		
		case 34:
			*uParam1 = func_166(-303.82f, 6211.29f, 31.05f, 0);
			unk_0x7DB79A42AADE120F(*uParam1, 386);
			unk_0x570128B7829A8EAA(*uParam1, 44);
			break;
		
		case 43:
			*uParam1 = func_166(-44.75f, -1288.67f, 28.21f, 0);
			unk_0x7DB79A42AADE120F(*uParam1, 149);
			unk_0x570128B7829A8EAA(*uParam1, 44);
			break;
		
		case 46:
			*uParam1 = func_166(-149.75f, 285.81f, 93.67f, 0);
			unk_0x7DB79A42AADE120F(*uParam1, 66);
			unk_0x570128B7829A8EAA(*uParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
			{
				*uParam1 = func_166(-70.71f, 301.43f, 106.79f, 0);
			}
			else
			{
				*uParam1 = func_166(-257.22f, 292.85f, 90.63f, 0);
			}
			unk_0x7DB79A42AADE120F(*uParam1, 389);
			unk_0x570128B7829A8EAA(*uParam1, 43);
			break;
	}
}

var func_166(struct<3> Param0, int iParam3)
{
	var uVar0;
	
	uVar0 = unk_0xA70969818F182A36(Param0);
	unk_0x575CF00E129E0CE1(uVar0, func_167(unk_0x4C9BACA8D249CB13(), 1f, 1f));
...
int func_169(var uParam0)
{
	if (*uParam0 == 18)
	{
		if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, 0, 1, 0))
		{
			if (!unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
			{
				func_283("Special launching Extreme 2");
				return 1;
			}
			else if ((!func_170(unk_0xA19140A5C42D8715(), -828834893) && func_187(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0))) && func_146(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), 3f, 1, 1056964608, 0, 1, 0))
			{
				unk_0xCB482EF95FAE4D73(unk_0xA19140A5C42D8715(), 0, 0);
			}
		}
...
int func_171(var uParam0, int iParam1)
{
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					if (func_187(uParam0->f_28[0]))
					{
						if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), unk_0xE2BBD32891C18569(uParam0->f_28[0], 1), 1) < 3f)
						{
							if (func_177(2))
							{
				...
				else if (func_187(uParam0->f_28[0]))
				{
					if (func_173(uParam0))
					{
						if (func_177(2))
			...
			{
				if ((((!unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -1895.788f, -434.0192f, 40.30126f, -1883.038f, -444.0811f, 50.24509f, 8.5f, 0, 1, 0) && !unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -1883.576f, -443.6434f, 36.40581f, -1874.826f, -448.0797f, 49.15162f, 8.5f, 0, 1, 0)) && !unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -1876.343f, -446.2214f, 35.64637f, -1866.952f, -456.5601f, 49.0442f, 8.5f, 0, 1, 0)) && !unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -1882.997f, -438.9922f, 44.17246f, -1874.079f, -443.342f, 48.69179f, 0.75f, 0, 1, 0)) || unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -1878.822f, -441.7655f, 44.9175f, -1877.941f, -439.9522f, 47.28982f, 1.25f, 0, 1, 0))
				{
					if (func_187(uParam0->f_28[0]))
					{
						if (func_173(uParam0))
			...
			{
				if (!unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), 837.0731f, 1261.086f, 366.1592f, 780.8383f, 1260.829f, 351.405f, 17.75f, 0, 1, 0))
				{
					if (func_187(uParam0->f_28[0]))
					{
						if (func_173(uParam0))
		...
		case 2:
			if (func_187(uParam0->f_35[0]))
			{
				if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), uParam0->f_35[0], 0))
				{
					if (func_177(3))
					{
						func_174(uParam0->f_27, *uParam0);
		...
		case 1:
			...
			{
				if (!unk_0x7112137033807390(uParam0->f_35[0], 0))
				{
					if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), unk_0xE2BBD32891C18569(uParam0->f_35[0], 1), 1) < uParam0->f_15)
					{
						if (func_177(2))
						{
							if (func_175(uParam0->f_27))
		...
		case 3:
			if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), uParam0->f_17[0 /*3*/], 1) < uParam0->f_15)
			{
				if (func_177(2))
				{
					if (func_175(uParam0->f_27))
		...
		case 4:
			if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), uParam0->f_17[0 /*3*/], uParam0->f_17[1 /*3*/], 0, 1, 0))
			{
				if (func_177(2))
				{
					if (func_175(uParam0->f_27))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
				{
					if (func_187(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0)))
					{
						...
						{
							if (unk_0xDF44B80BAA1F87F7(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), uParam0->f_35[0]))
							{
								if (func_177(3))
								{
									return 1;
						...
						else if ((unk_0xD3C4AB5E628133C1(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), joaat("cargobob")) || unk_0xD3C4AB5E628133C1(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), joaat("cargobob2"))) || unk_0xD3C4AB5E628133C1(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), joaat("cargobob3")))
						{
							if (unk_0x9F4F316E48259F95(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0)) && unk_0x7FCCC18142BCC594(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), uParam0->f_35[0]))
							{
								if (func_177(3))
								{
									return 1;
			...
			{
				if (unk_0xE51A575102B2A3C7(unk_0xA19140A5C42D8715()) >= 2f)
				{
					if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), 245.8885f, 371.9034f, 103.9884f, 241.5898f, 359.6458f, 107.3461f, 1.25f, 0, 1, 0))
					{
						if (func_177(2))
						{
							if (func_175(uParam0->f_27))
			...
			{
				if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -164.2046f, 277.4866f, 91.55322f, -153.6f, 277.4061f, 97.33813f, 10f, 0, 1, 0))
				{
					return 0;
				}
			}
			...
			{
				if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), 2728.948f, 4143.44f, 42.29295f, 2722.213f, 4144.521f, 45.43182f, 10f, 0, 1, 0))
				{
					if (func_177(2))
					{
						if (func_175(1))
			...
			{
				if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -992.4995f, 358.7455f, 96.3735f, -1021.94f, 361.8888f, 65.36148f, 30f, 0, 1, 0))
				{
					if (!unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -983.5426f, 369.1104f, 68.46017f, -1028.566f, 395.4613f, 94.57245f, 15f, 0, 1, 0))
					{
						if (!unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -983.875f, 346.7556f, 68.02096f, -1021.451f, 336.3458f, 93.18714f, 14.5f, 0, 1, 0))
						{
							if (func_177(2))
							{
								if (func_175(uParam0->f_27))
			...
			if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), uParam0->f_17[0 /*3*/], uParam0->f_17[1 /*3*/], uParam0->f_24, 0, 1, 0))
			{
				if (*uParam0 == 45)
				{
					if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), 2338.697f, 2597.037f, 45.39052f, 2324.003f, 2597.185f, 47.74961f, 8.5f, 0, 1, 0))
					{
						return 0;
					}
				}
...
void func_172()
{
	func_27(&(Global_96664.f_2875), &Global_96664, 0, 1, 1, 0);
}
...
int func_173(var uParam0)
{
	...
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0) && uParam0->f_27)
	{
		...
		if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), unk_0xE2BBD32891C18569(uParam0->f_28[0], 1), 1) < (uParam0->f_15 + fVar0))
		{
			return 1;
		}
	}
	else if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), unk_0xE2BBD32891C18569(uParam0->f_28[0], 1), 1) < uParam0->f_15)
	{
		return 1;
	}
	return 0;
		...
		else if (bParam0)
		{
			if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
			{
				...
				if (func_176(iVar0))
				{
					if (unk_0x5BFF0F72CC04E4DA(unk_0xA19140A5C42D8715()) || unk_0xA22CC9D85ECBCC81(unk_0xA19140A5C42D8715()))
					{
						if ((!unk_0xFD2A0C4CDE18D862(iVar0) && !unk_0x26D28D230F871E8D(iVar0)) && unk_0xEAA5CEF8875FEEED(iVar0) < 1f)
						{
							return 1;
						}
					}
					else if (!unk_0x26D28D230F871E8D(iVar0))
					{
						return 1;
					}
				}
		...
		if (unk_0xDC5D81351D6A4DDB(unk_0xA19140A5C42D8715()))
		{
			if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x3123C1A565BB7D3B(unk_0xD4E735F4B6A956AC()) || unk_0x26D28D230F871E8D(unk_0xA19140A5C42D8715())) || unk_0x3D77D31E25961596(unk_0xA19140A5C42D8715())) || unk_0x685AE6AF34B35D3B(unk_0xA19140A5C42D8715())) || unk_0x68477FE20127AEDA(unk_0xA19140A5C42D8715())) || unk_0xD571C0459FC227D0(unk_0xD4E735F4B6A956AC(), 1)) || unk_0x426122A77B3391B0(unk_0xD4E735F4B6A956AC())) || unk_0x967743032563101F(unk_0xA19140A5C42D8715(), 0)) || func_185()) || Global_105117) || Global_25461) || func_184()) || func_183(8, -1)) || func_92()) || func_182()) || func_181()) || func_180()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xD571C0459FC227D0(unk_0xD4E735F4B6A956AC(), 1) || func_185()) || Global_25461) || func_184()) || func_183(8, -1)) || func_181()) || func_92()) || func_182()) || func_180()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x3123C1A565BB7D3B(unk_0xD4E735F4B6A956AC()) || unk_0x26D28D230F871E8D(unk_0xA19140A5C42D8715())) || unk_0x3D77D31E25961596(unk_0xA19140A5C42D8715())) || unk_0x685AE6AF34B35D3B(unk_0xA19140A5C42D8715())) || unk_0x68477FE20127AEDA(unk_0xA19140A5C42D8715())) || unk_0xD571C0459FC227D0(unk_0xD4E735F4B6A956AC(), 1)) || unk_0x426122A77B3391B0(unk_0xD4E735F4B6A956AC())) || unk_0x967743032563101F(unk_0xA19140A5C42D8715(), 0)) || func_185()) || Global_105117) || Global_25461) || func_184()) || func_183(8, -1)) || func_181()) || func_92()) || func_182()) || func_180()) || Global_106070.f_7660.f_919[iVar0] == 5) || Global_36664 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x685AE6AF34B35D3B(unk_0xA19140A5C42D8715()) || unk_0x68477FE20127AEDA(unk_0xA19140A5C42D8715())) || unk_0xD571C0459FC227D0(unk_0xD4E735F4B6A956AC(), 1)) || unk_0x967743032563101F(unk_0xA19140A5C42D8715(), 0)) || func_185()) || Global_105117) || Global_25461) || func_184()) || func_183(8, -1)) || func_92()) || func_182()) || func_180()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_185() || unk_0x91347D2A80F38492(unk_0xD4E735F4B6A956AC()) > 0) || func_183(8, -1)) || func_180()) || func_179()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_187(unk_0xA19140A5C42D8715()) && func_187(iParam0->f_28[0])) && !func_188()) && (unk_0xFD34717937104F1C() - iParam0->f_60) > iParam8) && func_193(unk_0xA19140A5C42D8715(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_192(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_190(&uVar0, cParam4, sParam5, 7, 0, 0);
		iParam0->f_60 = unk_0xFD34717937104F1C();
		return 1;
	}
	return 0;
}

void func_190(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_194(int iParam0)
{
	...
	{
		if (func_187(iParam0->f_28[0]))
		{
			unk_0x034CA621E59C939F("Dom", iParam0->f_28[0], 0);
		}
	}
}
...
void func_195(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		if (!unk_0x429D45A6C6520026(sParam1))
		{
			...
			{
				if (func_193(unk_0xA19140A5C42D8715(), Param2, 1) <= 100f)
				{
					func_198(iParam0, 1);
				}
			}
			else
			{
				...
				{
					case 1:
						if (unk_0x3CAC2741CC1A631F(sParam1, "JOSH_1_INT_CONCAT"))
						{
							unk_0xE319E8535AE1BF59(sParam1, 14, 8);
						}
						else
						{
							unk_0x9D7A6D81C3BE2AAE(sParam1, 8);
						}
						unk_0x8E081838A5F7B09F(2);
						func_196(*iParam0, 1);
						break;
					...
					case 2:
						...
						unk_0xFB35B0BAD6F5AD8F();
						unk_0x8E081838A5F7B09F(0);
						func_196(*iParam0, 0);
						break;
				}
				if (func_193(unk_0xA19140A5C42D8715(), Param2, 1) > 120f)
				{
					func_200(iParam0);
				}
			}
...
int func_197(int iParam0)
{
	if (Global_71201 == iParam0)
	{
		if (Global_71202 == -1)
		{
			if (Global_71200 < unk_0x817B152F7462D506())
			{
				return 1;
			}
		}
...
int func_203(var uParam0, bool bParam1)
{
	...
	func_109(*uParam0, &Var0);
	if ((func_240(*uParam0) || func_238(*uParam0)) || Global_71450 == 1)
	{
		return 1;
	}
	if (!unk_0x1F85F8C7CC4639AE())
	...
	if (uParam0->f_16 == 2 || uParam0->f_16 == 1)
	{
		if (func_187(uParam0->f_35[0]))
		{
			if (!unk_0xA60C975CBAB69F34(uParam0->f_35[0], Var0.f_6, 8f, 8f, 8f, 0, 1, 0))
			{
				return 0;
			}
		}
	...
	if (*uParam0 == 10)
	{
		if (unk_0x6D7FFF527E125F24(-1, uParam0->f_17[0 /*3*/], 8f))
		{
	...
	if (Var0.f_4 != 17)
	{
		if (!unk_0x05EFB6A616B6FADE(Var0.f_26, func_104()))
		{
...
void func_204(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_187(iParam0))
	{
		switch (uParam1->f_3)
		{
				...
				if (func_207(uParam1))
				{
					if (unk_0x39C2D9AB77873F84(*uParam1))
					{
						...
						if (iParam2 != 21)
						{
							...
							{
								unk_0x3F01127ECD227890(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
							}
							else
							{
								...
								if (func_206(uParam1))
								{
									unk_0xE3A372256B081BD7(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0, 2, 0);
								}
								else
								{
									unk_0xE3A372256B081BD7(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0, 2, 0);
								}
								unk_0xE3A372256B081BD7(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0, 2, 0);
						...
						{
							unk_0xE3A372256B081BD7(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0, 2, 3);
						}
						uParam1->f_3 = 2;
					}
					else
			...
			case 2:
				if (!func_206(uParam1) || !unk_0x411C28019DEA5CEF(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_205(iParam2) && !unk_0xC42DE41AEED00E7B(iParam0, unk_0xA19140A5C42D8715(), 25f))
					{
						unk_0x0177431263151C4E(iParam0, unk_0xA19140A5C42D8715(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), unk_0xE2BBD32891C18569(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 3:
				...
				if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
				{
					unk_0x3F01127ECD227890(0, *uParam1, uParam1->f_2, 4f, -4f, -1, 262144, 0, 0, 0, 0);
					unk_0x3F01127ECD227890(0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
				}
				else
				{
					unk_0xE3A372256B081BD7(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 4f, -4f, -1, 262152, 0, 2, 0);
					unk_0xE3A372256B081BD7(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0, 2, 0);
				}
			...
			case 5:
				if (!func_205(iParam2) || unk_0xC42DE41AEED00E7B(iParam0, unk_0xA19140A5C42D8715(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x3F01127ECD227890(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					...
					{
						unk_0xE3A372256B081BD7(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0, 2, 0);
					}
					uParam1->f_3 = 2;
				}
				break;
...
{
	if (unk_0x429D45A6C6520026(uParam0->f_2))
	{
		return 0;
	}
	return 1;
...
void func_208(var uParam0)
{
	...
	if (func_187(unk_0xA19140A5C42D8715()))
	{
		iVar0 = 0;
		while (iVar0 <= (uParam0->f_28 - 1))
		{
			...
			{
				if (!unk_0x5D7DFE2058701942(uParam0->f_28[iVar0], 0))
				{
					unk_0xDCFB67537602326F(uParam0->f_28[iVar0], 1, 0);
					unk_0xB29E08C7AB729BAD(uParam0->f_28[0], 0);
				}
				unk_0xD738221C247C8B71(uParam0->f_28[iVar0], 1);
				if (*uParam0 == 34)
				{
					if (func_187(uParam0->f_41[0]))
					{
						unk_0xDCFB67537602326F(uParam0->f_41[0], 1, 0);
						unk_0xB29E08C7AB729BAD(uParam0->f_41[0], 0);
					}
				}
				switch (*uParam0)
				{
					...
					case 8:
						unk_0x6D68030C791111E0("rcmcollect_paperleadinout@");
						while (!unk_0x39C2D9AB77873F84("rcmcollect_paperleadinout@"))
						{
							unk_0x4EDE34FBADD967A6(0);
						}
						unk_0x2F89329397A277BC(&uVar1);
						unk_0x3F01127ECD227890(0, "rcmcollect_paperleadinout@", "meditate_getup", 8f, -8f, -1, 8, 0, 0, 0, 0);
						unk_0x33B5487515BD13D5(0, unk_0xA19140A5C42D8715(), 10000f, -1, 0, 0);
						unk_0x301F42EEE3C40328(uVar1);
						unk_0xE1072FA2FECBAD96(uParam0->f_28[iVar0], uVar1);
						unk_0x3A95A0A3221D4208(&uVar1);
						break;
					
					case 0:
					case 1:
						unk_0x6D68030C791111E0("rcmabigail");
						while (!unk_0x39C2D9AB77873F84("rcmabigail"))
						{
							unk_0x4EDE34FBADD967A6(0);
						}
						unk_0x2F89329397A277BC(&uVar1);
						unk_0x3F01127ECD227890(0, "rcmabigail", "breakout_base", 8f, -8f, -1, 8, 0, 0, 0, 0);
						unk_0x33B5487515BD13D5(0, unk_0xA19140A5C42D8715(), 10000f, -1, 0, 0);
						unk_0x301F42EEE3C40328(uVar1);
						unk_0xE1072FA2FECBAD96(uParam0->f_28[iVar0], uVar1);
						unk_0x3A95A0A3221D4208(&uVar1);
					...
					case 32:
						unk_0x6D68030C791111E0("rcmminute1");
						while (!unk_0x39C2D9AB77873F84("rcmminute1"))
						{
							unk_0x4EDE34FBADD967A6(0);
						}
						unk_0x2F89329397A277BC(&uVar1);
						if (iVar0 == 0)
						{
							unk_0x3F01127ECD227890(0, "rcmminute1", "base_to_idle_joe", 8f, -8f, -1, 32776, 0, 0, 0, 0);
						}
						else
						{
							unk_0x3F01127ECD227890(0, "rcmminute1", "base_to_idle_josef", 8f, -8f, -1, 32776, 0, 0, 0, 0);
						}
						unk_0x33B5487515BD13D5(0, unk_0xA19140A5C42D8715(), 10000f, -1, 0, 0);
						unk_0x301F42EEE3C40328(uVar1);
						unk_0xE1072FA2FECBAD96(uParam0->f_28[iVar0], uVar1);
					...
					case 24:
						unk_0x6D68030C791111E0("special_ped@hao@base");
						while (!unk_0x39C2D9AB77873F84("special_ped@hao@base"))
						{
							unk_0x4EDE34FBADD967A6(0);
						}
						unk_0x2F89329397A277BC(&uVar1);
						unk_0x3F01127ECD227890(0, "special_ped@hao@base", "hao_exit", 8f, -8f, -1, 520, 0, 0, 0, 0);
						unk_0x33B5487515BD13D5(0, unk_0xA19140A5C42D8715(), 10000f, -1, 0, 0);
						unk_0x301F42EEE3C40328(uVar1);
						unk_0xE1072FA2FECBAD96(uParam0->f_28[iVar0], uVar1);
						unk_0x3A95A0A3221D4208(&uVar1);
					...
					default:
						unk_0x3F29BBC16DCB8A23(uParam0->f_28[iVar0]);
						unk_0x33B5487515BD13D5(uParam0->f_28[iVar0], unk_0xA19140A5C42D8715(), 10000f, -1, 0, 0);
						break;
					}
			}
			iVar0++;
...
void func_210(var uParam0)
{
	...
	if (func_187(unk_0xA19140A5C42D8715()))
	{
		...
		while (iVar0 <= (uParam0->f_28 - 1))
		{
			if (func_125(uParam0->f_28[iVar0]))
			{
				unk_0x3B7A32E04BBE59A5(uParam0->f_28[iVar0], 1, 0);
				unk_0x1F4E5EFBFE503FB3(uParam0->f_28[iVar0], 0);
				unk_0xD738221C247C8B71(uParam0->f_28[iVar0], 1);
				unk_0xDA4D3941AFF8EF12(uParam0->f_28[iVar0], unk_0xA19140A5C42D8715(), 0, 16);
				unk_0x7E4E83D33161D01A(&(uParam0->f_28[iVar0]));
			}
			iVar0++;
		}
	}
	...
	if (func_125(unk_0xA19140A5C42D8715()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (unk_0xDC5D81351D6A4DDB(uParam0->f_35[iVar0]))
			{
				...
				if (unk_0x24A1A7BF4ED94B71(uParam0->f_35[iVar0]) < 850)
				{
				...
				if (bParam2)
				{
					if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
					{
						if (unk_0xC556072C29E00F04(uParam0->f_35[iVar0], unk_0xA19140A5C42D8715()) && unk_0xEAA5CEF8875FEEED(unk_0xA19140A5C42D8715()) > 5f)
						{
						...
						uVar2 = unk_0xC409B91AC4749F88();
						if (func_176(uVar2))
						{
							if (unk_0x8F474E419F56E48D(uVar2) == joaat("towtruck") || unk_0x8F474E419F56E48D(iVar2) == joaat("towtruck2"))
							{
								if (func_176(uParam0->f_35[iVar0]))
								{
									if (unk_0xDF44B80BAA1F87F7(iVar2, uParam0->f_35[iVar0]))
									{
					...
					else
					{
						...
						if (func_176(iVar3))
						{
							if (unk_0xC556072C29E00F04(uParam0->f_35[iVar0], iVar3) && unk_0xEAA5CEF8875FEEED(iVar3) > 6f)
							{
						...
						if (*uParam0 == 16)
						{
							if (func_212(unk_0xA19140A5C42D8715(), uParam0->f_35[iVar0]))
							{
...
int func_213(var uParam0, bool bParam1, int iParam2)
{
	...
	if (func_125(unk_0xA19140A5C42D8715()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (unk_0xDC5D81351D6A4DDB(uParam0->f_28[iVar0]))
			{
				if (!unk_0x4915F4759304D5CF(uParam0->f_28[iVar0]))
				{
					if (unk_0x8A29BBDF4603E52B(unk_0xA19140A5C42D8715()))
					{
						if (unk_0xC556072C29E00F04(unk_0xA19140A5C42D8715(), uParam0->f_28[iVar0]))
						{
							if (iParam2 == 0)
							{
								func_208(uParam0);
					...
					if ((unk_0x80C8B831B972D6A0(uParam0->f_28[iVar0]) || unk_0x6C55C22D72D438C8(uParam0->f_28[iVar0])) || unk_0xAD001F5D569438EC(uParam0->f_28[iVar0]))
					{
						if (iParam2 == 0)
						{
							func_208(uParam0);
					...
					if (unk_0x685AE6AF34B35D3B(uParam0->f_28[iVar0]))
					{
						if (unk_0x10E54C268D1B3FED(uParam0->f_28[iVar0], unk_0xA19140A5C42D8715(), 3f, 3f, 3f, 0, 1, 0))
						{
							if (iParam2 == 0)
							{
								func_208(uParam0);
					...
					if (func_232(*uParam0))
					{
						...
						if (unk_0x6D7FFF527E125F24(-1, unk_0xE2BBD32891C18569(uParam0->f_28[iVar0], 1), 15f))
						{
							if (iParam2 == 0)
							{
								func_208(uParam0);
					...
					if (!func_214(*uParam0))
					{
						if (unk_0x6D7FFF527E125F24(-1, unk_0xE2BBD32891C18569(uParam0->f_28[iVar0], 1), 5f))
						{
							if (iParam2 == 0)
							{
								func_208(uParam0);
...
int func_215(int iParam0, float fParam1)
{
	...
	if (func_187(unk_0xA19140A5C42D8715()) && func_187(iParam0))
	{
		if (func_226(iParam0) || unk_0x7591AFB11E7EDDA0(unk_0xD4E735F4B6A956AC(), iParam0))
		{
...
{
	return func_217(iParam0, unk_0xA19140A5C42D8715(), fParam1, 1, 250, 7);
}
...
bool func_217(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (!func_187(iParam0) || !func_187(iParam1))
	{
		if (iVar4 != -1)
		{
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_223(unk_0xE2BBD32891C18569(iParam1, 1) - unk_0xE2BBD32891C18569(iParam0, 1)) };
	...
	{
		Var3 = { func_223(unk_0x505186370955851F(iParam0, 31086, 0f, 5f, 0f) - unk_0x505186370955851F(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_227(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_187(unk_0xA19140A5C42D8715()) && func_187(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_231(uParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_228(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_229(var uParam0, float fParam1)
{
	...
	{
		if (func_230(uParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_230(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_223(Param1 - unk_0xE2BBD32891C18569(uParam0, 1)) };
...
void func_233(int iParam0)
{
	...
	if (func_187(unk_0xA19140A5C42D8715()) && func_187(uParam0))
	{
		unk_0x6D68030C791111E0("rcmextreme3");
		while (!unk_0x39C2D9AB77873F84("rcmextreme3"))
		{
			unk_0x4EDE34FBADD967A6(0);
		}
		unk_0x2F89329397A277BC(&uVar0);
		unk_0x3F01127ECD227890(0, "rcmextreme3", "jump_fall", 1000f, -8f, -1, 8, 0, 0, 0, 0);
		unk_0x00135C6A6DDEC2EA(0, 1);
		unk_0x0817EDF0F9344930(0, 64.6f, -737.8f, 44.2f);
		unk_0x33B5487515BD13D5(0, unk_0xA19140A5C42D8715(), 10000f, -1, 0, 0);
		unk_0x301F42EEE3C40328(uVar0);
...
int func_234(int iParam0)
{
	...
	if (!unk_0x05EFB6A616B6FADE(Global_106070.f_18546[iParam0 /*6*/], 2))
	{
		return 1;
	}
	return 0;
...
{
	if ((func_239() && Global_93232.f_11 == 6) && iParam0 == func_163(&(Global_93232.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_242(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_248(&(uParam0->f_48), "rcmextreme4", "idle_a", "idle_c");
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_247(&iVar0) || !func_246(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			func_243(&(uParam0->f_28[0]), 1732.27f, 96.36f, 170.29f, -98.56f);
			unk_0xADAE751BF0667488(uParam0->f_28[0], 1);
			unk_0x53462E9112DC81AA(uParam0->f_28[0], 2);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
...
void func_243(var uParam0, struct<3> Param1, float fParam4)
{
	func_244(uParam0, iLocal_93, Param1, fParam4, 26);
	unk_0xA0DEC6E1399EE624(*uParam0);
	unk_0xCB6F83EEDBCC77C4(*uParam0, 0);
	unk_0xC4C22DDB26872744(*uParam0, "EXTREME LAUNCHER RC");
}

void func_244(var uParam0, int iParam1, struct<3> Param2, var uParam5, int iParam6)
{
	func_245(uParam0);
	*uParam0 = unk_0x35C6E06B120EB2E3(iParam6, iParam1, Param2, uParam5, 0, 0);
}
...
void func_248(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_249(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_248(&(uParam0->f_48), "rcmextreme3", "idle_calm", "fidget_02");
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_250(&(uParam0->f_28[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
					unk_0x13E0A8160525AE55(uParam0->f_28[0], 118, 0);
					unk_0x13E0A8160525AE55(uParam0->f_28[0], 208, 1);
					unk_0xF0188A1B49D79AF7(uParam0->f_28[0], joaat("gadget_parachute"), 1, 0, 0);
					unk_0x72A0FF8C49CFFC0D(uParam0->f_28[0], 8, 1, 0, 0);
				}
				else
				{
					bVar3 = false;
...
int func_250(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_251(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (unk_0xDC5D81351D6A4DDB(*uParam0))
		{
			if (!unk_0x7112137033807390(*uParam0, 0))
...
int func_251(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	int iVar0;
...
int func_253(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			while (iVar4 <= (iVar0 - 1))
			{
				unk_0xCACEBBBEAD8F262E(iVar0[iVar4]);
				iVar4++;
			}
			func_248(&(uParam0->f_48), "rcmextreme2", "sitting_idle", "loop_punching");
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_28[0]))
			{
				if (func_250(&(uParam0->f_28[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
					unk_0xE8B3104D1CB25CDC(uParam0->f_28[0], -954.2f, -2760.05f, 14.04f, 1, 0, 1);
					unk_0x13E0A8160525AE55(uParam0->f_28[0], 118, 0);
					unk_0x13E0A8160525AE55(uParam0->f_28[0], 208, 1);
					unk_0xB29E08C7AB729BAD(uParam0->f_28[0], 1);
					unk_0xDCFB67537602326F(uParam0->f_28[0], 0, 0);
					unk_0x72A0FF8C49CFFC0D(uParam0->f_28[0], 8, 1, 0, 0);
					unk_0x3F01127ECD227890(uParam0->f_28[0], uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 33281, 0, 0, 0, 0);
					if (unk_0xDC5D81351D6A4DDB(unk_0xA19140A5C42D8715()))
					{
						unk_0x22DD1D053CFF9707(uParam0->f_28[0], unk_0xA19140A5C42D8715(), -1, 48, 2);
					}
				}
				else
				{
			...
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_35[0]))
			{
				func_254(&(uParam0->f_35[0]), iVar0[0], -950.8f, -2751.98f, 13.21f, 199.05f);
				unk_0x14293208022014FA(uParam0->f_35[0], 2);
				unk_0xEA847E35BAC71F2A(uParam0->f_35[0], 0);
				unk_0xFB94F197528404D4(uParam0->f_35[0], 0f);
			}
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_35[1]))
			{
				func_254(&(uParam0->f_35[1]), iVar0[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
				unk_0x14293208022014FA(uParam0->f_35[1], 2);
				unk_0xEA847E35BAC71F2A(uParam0->f_35[1], 1);
				unk_0xFB94F197528404D4(uParam0->f_35[1], 0f);
			}
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_35[2]))
			{
				func_254(&(uParam0->f_35[2]), iVar0[1], -957.23f, -2764.89f, 14.04f, 147.61f);
				unk_0x14293208022014FA(uParam0->f_35[2], 2);
				unk_0xEA847E35BAC71F2A(uParam0->f_35[2], 2);
				unk_0xFB94F197528404D4(uParam0->f_35[2], 0f);
				unk_0xF0F3162A538A2D92(uParam0->f_35[2], 0);
				unk_0x9F3F43B8D4BC7F09(uParam0->f_35[2], 0, 0);
			}
			if (bVar5)
			{
				iLocal_91 = 3;
		...
		case 3:
			...
			while (iVar4 <= (iVar0 - 1))
			{
				unk_0xA5DE74AE39867B03(iVar0[iVar4]);
				iVar4++;
			}
			return 1;
			break;
...
void func_254(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_255(uParam0);
...
int func_256(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_248(&(uParam0->f_48), "rcm_extreme1", "idle_a", "idle_c");
			iLocal_91 = 1;
			break;
		...
		case 2:
			func_243(&(uParam0->f_28[0]), -188.22f, 1296.1f, 302.86f, 43.7f);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
				unk_0xA5DE74AE39867B03(iVar0[iVar2]);
...
int func_257(int iParam0)
{
	...
	if (!unk_0x05EFB6A616B6FADE(Var0.f_26, iVar32))
	{
		return 1;
	}
	return 0;
...
int func_258(int iParam0)
{
	...
	if (!Global_106070.f_9057 && !func_107(1))
	{
	...
	if (Global_93232.f_11 == 6)
	{
		if (Global_93232 < 9)
		{
			...
			if (unk_0x3CAC2741CC1A631F(&(Global_93232.f_3), sVar0))
			{
	...
	if (unk_0x8B1574454E8C2421(joaat("candidate_controller")) == 0)
	{
		Global_105157[iParam0 /*10*/].f_1 = 1;
...
int func_260(int iParam0)
{
	...
	else if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		...
		iVar9 = unk_0xB68EB57358F46F86(Global_88365[iParam0 /*10*/].f_3, &sVar1);
...
bool func_261(int iParam0, char* sParam1)
{
	...
	switch (iParam0)
	{
		...
		case 2:
		case 1:
			if (unk_0x471855870C045BD0("TrevorsTrailer"))
			{
				StringCopy(sParam1, "v_trailer", 32);
			}
			else if (unk_0x471855870C045BD0("TrevorsTrailerTidy"))
			{
				StringCopy(sParam1, "V_TrailerTIDY", 32);
			}
			else if (unk_0x471855870C045BD0("TrevorsTrailerTrash"))
			{
	...
	return !unk_0x3CAC2741CC1A631F(sParam1, "");
}
...
bool func_263(int iParam0)
{
	...
	return unk_0x05EFB6A616B6FADE(Global_106070.f_18546[iParam0 /*6*/], 2);
}
...
int func_268(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	...
	{
		if (unk_0x05EFB6A616B6FADE(Global_106070.f_18546[iParam0 /*6*/], 0))
		{
...
void func_270(int iParam0, bool bParam1)
{
	if (*iParam0 == 18)
	{
		if (func_187(iParam0->f_35[0]))
		{
			unk_0x14293208022014FA(iParam0->f_35[0], 1);
		}
		if (func_187(iParam0->f_35[1]))
		{
			unk_0x14293208022014FA(iParam0->f_35[1], 1);
		}
	}
	if (bParam1)
	{
	...
	if (unk_0xCE3CB618AFE55EFB(uLocal_98))
	{
		unk_0xE1623437A3194332(&uLocal_98);
	}
	func_271(&(iParam0->f_48));
	if (*iParam0 == 17)
	{
		unk_0xE70AC26DFC59863A(uLocal_97, 0);
		unk_0x66E6A13BAFFFB63C("WORLD_VEHICLE_SALTON_DIRT_BIKE", 1);
	}
	else if (*iParam0 == 18)
	{
		unk_0xE70AC26DFC59863A(uLocal_97, 0);
	...
	{
		unk_0x5DE59A67B5F326CF(uLocal_96);
		unk_0x4DC885EA8D6AF7FC("rcmextreme3");
...
int func_271(var uParam0)
{
	if (func_207(uParam0))
	{
		if (unk_0x39C2D9AB77873F84(*uParam0))
		{
			unk_0x4DC885EA8D6AF7FC(*uParam0);
			*uParam0 = "";
			uParam0->f_1 = "";
			return 1;
		}
