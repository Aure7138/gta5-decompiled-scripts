						...
						if (fVar0 < fLocal_46)
						{
							...
							if (((((fVar15 >= 0.35f && func_97(Var1, 0f, 1f)) && func_97(Var4, 0f, 1f)) && func_97(Var7, 0f, 1f)) && func_97(Var10, 0f, 1f)) || ((((fVar15 < 0.35f && func_97(Var1, 0.05f, 0.95f)) && func_97(Var4, 0.05f, 0.95f)) && func_97(Var7, 0.05f, 0.95f)) && func_97(Var10, 0.05f, 0.95f)))
							{
								if (fVar13 >= 0.08f && fVar14 >= 0.101f)
								{
									...
									{
										bVar16 = ((((unk_0x0112BD5CB0C9E9FF(iLocal_49) && unk_0x0112BD5CB0C9E9FF(iLocal_50)) && unk_0x0112BD5CB0C9E9FF(iLocal_51)) && unk_0x0112BD5CB0C9E9FF(iLocal_52)) && unk_0x0112BD5CB0C9E9FF(iLocal_53));
										iVar17++;
										unk_0x4EDE34FBADD967A6(0);
									}
									if (bVar16)
									{
										func_95(iLocal_48, 1);
										unk_0x076A5661EF5ABEE4(joaat("num_hidden_packages_6"), func_92(), 1);
										bLocal_460 = true;
										if (func_105())
										{
											func_6();
...
void func_2(int iParam0, bool bParam1)
{
	...
	if (iVar0 < 31)
	{
		if (bParam1)
		{
			unk_0xCED9E32812D6C7C7(&(Global_112922.f_24995), iVar0);
		}
		else
		{
			unk_0xB0550BC91B0159D6(&(Global_112922.f_24995), iVar0);
		}
	}
	else
	{
		...
		if (bParam1)
		{
			unk_0xCED9E32812D6C7C7(&(Global_112922.f_24995.f_1), iVar0);
		}
		else
		{
			unk_0xB0550BC91B0159D6(&(Global_112922.f_24995.f_1), iVar0);
		}
	}
}
...
int func_16(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12581)
	{
		...
		uVar0 = Global_2822371[iParam0 /*3*/][func_17(iParam1)];
...
void func_23(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_13(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, unk_0x036D1EA7243F2CCC(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77839)
		{
			...
			func_13(&(Global_77669[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, unk_0x036D1EA7243F2CCC(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = unk_0xA188D1127A77C942(iVar1, 10, -1, 0, -1, func_24(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_79(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			{
				unk_0xCED9E32812D6C7C7(&(Global_112922.f_2363.f_539.f_3816[0 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			break;
		...
		case joaat("player_two"):
			...
			{
				unk_0xCED9E32812D6C7C7(&(Global_112922.f_2363.f_539.f_3816[1 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			if (!bParam3 || BitTest(Global_112922.f_7229[4], 0))
			{
				unk_0xCED9E32812D6C7C7(&(Global_112922.f_2363.f_539.f_3816[2 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			break;
	}
}
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		unk_0xA188D1127A77C942(iParam3, 10, -1, 0, -1, func_24(iParam2));
...
void func_95(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		unk_0xCED9E32812D6C7C7(&(Global_112922.f_10049.f_135[iVar0]), uVar1);
	}
	else
	{
		unk_0xB0550BC91B0159D6(&(Global_112922.f_10049.f_135[iVar0]), iVar1);
	}
}
...
int func_97(struct<3> Param0, float fParam3, float fParam4)
{
	...
	if (unk_0xF00526C1598A6868(Param0, &fVar0, &fVar1))
	{
...
void func_98(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9, float fParam10)
{
	...
	unk_0xF00526C1598A6868(Param0, &Var0, &(Var0.f_1));
	unk_0xF00526C1598A6868(Param3, &Var3, &(Var3.f_1));
	unk_0xF00526C1598A6868(Param6, &Var6, &(Var6.f_1));
...
bool func_105()
{
	...
	return Global_112922.f_10049.f_135[iVar0] == (unk_0xF2DB717A73826179(unk_0xE3621CC40F31FE2E(2f, unk_0xBBDA792448DB5A89(iVar1 + 1))) - 1);
}
...
void func_106()
{
	if (bLocal_460)
	{
		if (unk_0x0347CCBD719C8ADC(uLocal_459))
		{
			unk_0x694170BB080C08FF(uLocal_459, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
		}
		switch (iLocal_458)
		{
			case 0:
				iLocal_462 = unk_0x320D1840B6DAA1CC() + 2000;
				iLocal_458++;
				break;
			
			case 1:
				if (iLocal_462 < unk_0x320D1840B6DAA1CC())
				{
					if (!func_112())
					{
						uLocal_459 = unk_0x528279F3F1EEF869("MIDSIZED_MESSAGE");
						iLocal_462 = unk_0x320D1840B6DAA1CC() + 5000;
						iLocal_458++;
					}
				}
				break;
			...
			case 2:
				if (unk_0x0347CCBD719C8ADC(uLocal_459) || iLocal_462 < unk_0x320D1840B6DAA1CC())
				{
					if (iLocal_462 < unk_0x320D1840B6DAA1CC())
					{
						bLocal_460 = false;
			...
			case 3:
				unk_0xEA5DEA46C3EE64D3(uLocal_459, "SHOW_BRIDGES_KNIVES_PROGRESS");
				func_111("PM_TITLE");
				unk_0x4F47E317C74C543B(50);
				func_111("PM_PASS");
				func_111("PM_CHALLENGE");
				unk_0x4F47E317C74C543B(func_92());
				unk_0x6F06CF0E9AB02847();
				iLocal_462 = unk_0x320D1840B6DAA1CC() + 7500;
				unk_0x91DFC8F68F6D9B05(-1, "UNDER_THE_BRIDGE", "HUD_AWARDS", 1);
				iLocal_458++;
				break;
			
			case 4:
				if ((((((iLocal_462 < unk_0x320D1840B6DAA1CC() || unk_0xA829C9A2767AC8EF()) || !unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9())) || func_112()) || !unk_0x1C7A1A7E9E4766CF(unk_0x9E2D6C50374FCFA9())) || func_110()) || func_109())
				{
					unk_0xEA5DEA46C3EE64D3(uLocal_459, "SHARD_ANIM_OUT");
					unk_0x4F47E317C74C543B(1);
					unk_0xCA5D23E5F0F0306F(0.33f);
					unk_0x6F06CF0E9AB02847();
					iLocal_462 = unk_0x320D1840B6DAA1CC() + 500;
					iLocal_458++;
				}
				break;
			...
			case 6:
				unk_0x705B098546DEB18A(&uLocal_459);
				if (func_105())
				{
					iLocal_462 = unk_0x320D1840B6DAA1CC() + 1000;
					iLocal_458++;
				}
				else
				{
...
void func_116(int iParam0)
{
	if (*iParam0 != -1)
	{
		unk_0x499B2A8EBB5D097A(*iParam0);
		*iParam0 = -1;
	}
}
