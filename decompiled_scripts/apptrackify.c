		...
		if (Global_14443.f_1 != 9)
		{
			switch (Global_14443.f_1)
			{
				case 7:
					...
					{
						unk_0x3B6EF6403E3F1CAC(Global_14424, "APP_FUNCTION");
...
{
	Global_2595463[iParam0] = iParam1;
}
...
void func_10()
{
	...
	if (func_18() == 0)
	{
		if (!unk_0xB529B2A4B7C64D6D(unk_0xD5A676B97920D126(), 0))
		{
			Local_20 = { unk_0xC086F8D75730FA3A(unk_0xD5A676B97920D126(), 1) };
			fLocal_23 = unk_0x714F015B4D2DE1DC(unk_0xD5A676B97920D126());
			func_17();
			func_16();
			func_15();
			...
			if (iLocal_31 == 0)
			{
				...
				if (unk_0xF44A5E894FE76438(Global_2314, 30))
				{
				...
				{
					unk_0x1B215CC37BF52E79(unk_0xF34EE736CF047844(fLocal_27));
					unk_0x1B215CC37BF52E79(unk_0xF34EE736CF047844(fLocal_28));
				}
				unk_0x1B215CC37BF52E79(100);
				if (unk_0xF44A5E894FE76438(Global_2314, 22))
				{
					unk_0x1B215CC37BF52E79(1);
				}
				else
				...
				if (unk_0xF44A5E894FE76438(Global_2314, 29))
				{
				...
				{
					unk_0x573CAEB6F4A4E750(fLocal_30);
				}
				unk_0xBBAAC5B2437ACF2A();
			}
	...
	else if (!unk_0xB529B2A4B7C64D6D(unk_0xD5A676B97920D126(), 0))
	{
		...
		while (iVar0 < Global_2595469)
		{
			...
			if (iLocal_31 == 0)
			{
				...
				{
					case 0:
						if (unk_0xF44A5E894FE76438(Global_2595258, 5))
						{
							bVar1 = true;
						}
						break;
					...
					case 1:
						if (unk_0xF44A5E894FE76438(Global_2595258, 6))
						{
							bVar1 = true;
						}
						break;
					...
					case 2:
						if (unk_0xF44A5E894FE76438(Global_2595258, 7))
						{
							bVar1 = true;
						}
						break;
					...
					case 3:
						if (unk_0xF44A5E894FE76438(Global_2595258, 8))
						{
							bVar1 = true;
						}
						break;
				...
				unk_0x573CAEB6F4A4E750(fLocal_30);
				unk_0x1B215CC37BF52E79(Global_2595463[iVar0]);
				unk_0xBBAAC5B2437ACF2A();
			}
			if (fLocal_23 == fLocal_23)
			{
...
{
	fLocal_25 = (Global_2595447[iParam0 /*3*/] - Local_20.f_0);
	fLocal_26 = (unk_0xD0FFB162F40A139C(((3.14159f / 180f) * Local_20.f_0)) * (Global_2595447[iParam0 /*3*/].f_1 - Local_20.f_1));
	fLocal_27 = unk_0x2047800436E7B1E2(fLocal_25, fLocal_26);
	if (fLocal_27 < 0f)
	{
		fLocal_27 = (fLocal_27 + 360f);
	}
...
{
	fLocal_29 = unk_0x71D93B57D07F9804(unk_0xB7A628320EFF8E47(Global_2595447[iParam0 /*3*/], Local_20));
	fLocal_30 = (Global_2595447[iParam0 /*3*/].f_2 - Local_20.f_2);
	return fLocal_29;
}

float func_13(int iParam0)
{
	fLocal_28 = unk_0x71D93B57D07F9804((((Global_2595447[iParam0 /*3*/] - Local_20.f_0) * (Global_2595447[iParam0 /*3*/] - Local_20.f_0)) + ((Global_2595447[iParam0 /*3*/].f_1 - Local_20.f_1) * (Global_2595447[iParam0 /*3*/].f_1 - Local_20.f_1))));
	return fLocal_28;
}
