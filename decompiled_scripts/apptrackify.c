...
void func_10()
{
	...
	if (func_18() == 0)
	{
		if (!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0))
		{
			...
			func_14(Global_19935, "DISPLAY_VIEW", 23f, unk_0xBBDA792448DB5A89(1), -1082130432, -1082130432, -1082130432);
		}
	}
...
float func_11(int iParam0)
{
	...
	fLocal_26 = (unk_0xD0FFB162F40A139C(((3.14159f / 180f) * Local_20.f_0)) * (Global_4535516[iParam0 /*3*/].f_1 - Local_20.f_1));
...
{
	fLocal_29 = unk_0x71D93B57D07F9804(unk_0xB7A628320EFF8E47(Global_4535516[iParam0 /*3*/], Local_20));
...
{
	fLocal_28 = unk_0x71D93B57D07F9804((((Global_4535516[iParam0 /*3*/] - Local_20.f_0) * (Global_4535516[iParam0 /*3*/] - Local_20.f_0)) + ((Global_4535516[iParam0 /*3*/].f_1 - Local_20.f_1) * (Global_4535516[iParam0 /*3*/].f_1 - Local_20.f_1))));
	return fLocal_28;
}
...
float func_15()
{
	...
	fLocal_26 = (unk_0xD0FFB162F40A139C(((3.14159f / 180f) * Local_20.f_0)) * (Global_22391.f_1 - Local_20.f_1));
	fLocal_27 = unk_0xC529D13129C03CF4(fLocal_25, fLocal_26);
	if (fLocal_27 < 0f)
	{
		fLocal_27 = (fLocal_27 + 360f);
...
float func_16()
{
	fLocal_29 = unk_0x71D93B57D07F9804(unk_0xB7A628320EFF8E47(Global_22391, Local_20));
...
float func_17()
{
	fLocal_28 = unk_0x71D93B57D07F9804((((Global_22391 - Local_20.f_0) * (Global_22391 - Local_20.f_0)) + ((Global_22391.f_1 - Local_20.f_1) * (Global_22391.f_1 - Local_20.f_1))));
	return fLocal_28;
}
