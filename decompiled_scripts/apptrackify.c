	...
	if (func_18() == 0)
	{
		if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			...
			if (iLocal_31 == 0)
			{
				...
				{
					unk_0xAD291B8F75D737AD(unk_0xF34EE736CF047844(fLocal_27));
					unk_0xAD291B8F75D737AD(unk_0xF34EE736CF047844(fLocal_28));
				}
			...
			func_14(Global_19662, "DISPLAY_VIEW", 23f, unk_0xBBDA792448DB5A89(1), -1082130432, -1082130432, -1082130432);
		}
	}
...
{
	fLocal_25 = (Global_4271213[iParam0 /*3*/] - Local_20.f_0);
	fLocal_26 = (unk_0xD0FFB162F40A139C(((3.14159f / 180f) * Local_20.f_0)) * (Global_4271213[iParam0 /*3*/].f_1 - Local_20.f_1));
...
{
	fLocal_29 = unk_0x71D93B57D07F9804(unk_0xB7A628320EFF8E47(Global_4271213[iParam0 /*3*/], Local_20));
...
{
	fLocal_28 = unk_0x71D93B57D07F9804((((Global_4271213[iParam0 /*3*/] - Local_20.f_0) * (Global_4271213[iParam0 /*3*/] - Local_20.f_0)) + ((Global_4271213[iParam0 /*3*/].f_1 - Local_20.f_1) * (Global_4271213[iParam0 /*3*/].f_1 - Local_20.f_1))));
	return fLocal_28;
}
...
float func_15()
{
	fLocal_25 = (Global_22111 - Local_20.f_0);
	fLocal_26 = (unk_0xD0FFB162F40A139C(((3.14159f / 180f) * Local_20.f_0)) * (Global_22111.f_1 - Local_20.f_1));
	fLocal_27 = unk_0x8C91FF3D82E6FB27(fLocal_25, fLocal_26);
	if (fLocal_27 < 0f)
	{
		fLocal_27 = (fLocal_27 + 360f);
...
float func_16()
{
	fLocal_29 = unk_0x71D93B57D07F9804(unk_0xB7A628320EFF8E47(Global_22111, Local_20));
...
float func_17()
{
	fLocal_28 = unk_0x71D93B57D07F9804((((Global_22111 - Local_20.f_0) * (Global_22111 - Local_20.f_0)) + ((Global_22111.f_1 - Local_20.f_1) * (Global_22111.f_1 - Local_20.f_1))));
	return fLocal_28;
}
