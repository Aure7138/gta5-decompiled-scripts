		...
		if (Global_14393.f_1 != 9)
		{
			switch (Global_14393.f_1)
			{
				case 7:
					...
					{
						unk_0xF6E48914C7A8694E(Global_14374, "APP_FUNCTION");
	...
	if (func_17() == 0)
	{
		if (!unk_0x5F9532F3B5CC2551(unk_0xD80958FC74E988A6()))
		{
			...
			if (iLocal_30 == 0)
			{
				...
				if (unk_0xA921AA820C25702F(Global_2264, 30))
				{
				...
				else
				{
					...
					unk_0xC3D0841A0CC546A6(unk_0xF34EE736CF047844(fLocal_27));
				}
				unk_0xC3D0841A0CC546A6(100);
				if (unk_0xA921AA820C25702F(Global_2264, 22))
				{
					unk_0xC3D0841A0CC546A6(1);
				}
				else
				...
				if (unk_0xA921AA820C25702F(Global_2264, 29))
				{
				...
				if (unk_0xA921AA820C25702F(Global_2265, 1))
				{
					unk_0xD69736AAE04DB51A(fLocal_29);
				}
				unk_0xC6796A8FFA375E53();
			}
