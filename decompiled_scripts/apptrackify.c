		...
		if (Global_14453.f_1 != 9)
		{
			switch (Global_14453.f_1)
			{
				case 7:
					...
					{
						unk_0x76F4FB5EFF5BDED5(Global_14434, "APP_FUNCTION");
...
void func_2()
{
	...
	func_3(3, 0);
	func_3(4, 0);
	unk_0x62148293B793073B(&Global_2324, 22);
...
void func_10()
{
	...
	if (func_18() == 0)
	{
		if (!unk_0x74C2FE037DFC8B4A(unk_0x18F7BE9ACB7D08F4(), 0))
		{
			Local_20 = { unk_0x761660F5CE986DC4(unk_0x18F7BE9ACB7D08F4(), 1) };
			fLocal_23 = unk_0x93FDA3BF59E7B77F(unk_0x18F7BE9ACB7D08F4());
			func_17();
			func_16();
			func_15();
			...
			if (iLocal_31 == 0)
			{
				...
				if (unk_0xB03A1684359C50A1(Global_2324, 30))
				{
				...
				{
					unk_0x22DD5585E00B80C3(unk_0xF34EE736CF047844(fLocal_27));
					unk_0x22DD5585E00B80C3(unk_0xF34EE736CF047844(fLocal_28));
				}
				unk_0x22DD5585E00B80C3(100);
				if (unk_0xB03A1684359C50A1(Global_2324, 22))
				{
					unk_0x22DD5585E00B80C3(1);
				}
				else
				...
				if (unk_0xB03A1684359C50A1(Global_2324, 29))
				{
				...
				{
					unk_0x954263F3D07BEFC2(fLocal_30);
				}
				unk_0xE2B30EB9B14EEAB2();
			}
	...
	else if (!unk_0x74C2FE037DFC8B4A(unk_0x18F7BE9ACB7D08F4(), 0))
	{
		...
		while (iVar0 < Global_4267354)
		{
			...
			if (iLocal_31 == 0)
			{
				...
				{
					case 0:
						if (unk_0xB03A1684359C50A1(Global_4267143, 5))
						{
							bVar1 = true;
						}
						break;
					...
					case 1:
						if (unk_0xB03A1684359C50A1(Global_4267143, 6))
						{
							bVar1 = true;
						}
						break;
					...
					case 2:
						if (unk_0xB03A1684359C50A1(Global_4267143, 7))
						{
							bVar1 = true;
						}
						break;
					...
					case 3:
						if (unk_0xB03A1684359C50A1(Global_4267143, 8))
						{
							bVar1 = true;
						}
						break;
				...
				unk_0x954263F3D07BEFC2(fLocal_30);
				unk_0x22DD5585E00B80C3(Global_4267348[iVar0]);
				unk_0xE2B30EB9B14EEAB2();
			}
			if (fLocal_23 == fLocal_23)
			{
...
float func_11(int iParam0)
{
	...
	fLocal_27 = unk_0xE3269852A87D46D2(fLocal_25, fLocal_26);
	if (fLocal_27 < 0f)
	{
		fLocal_27 = (fLocal_27 + 360f);
	}
