...
void func_10()
{
	...
	if (func_18() == 0)
	{
		if (!unk_0xE50EB54E0F21BED0(unk_0x7D2B9E6A64637269(), 0))
		{
			...
			fLocal_23 = unk_0xA8D713A937F31250(unk_0x7D2B9E6A64637269());
			func_17();
			func_16();
			func_15();
			...
			if (iLocal_31 == 0)
			{
				...
				{
					unk_0x9E3D03981E2E9AD9(unk_0xF34EE736CF047844(fLocal_27));
					unk_0x9E3D03981E2E9AD9(unk_0xF34EE736CF047844(fLocal_28));
				}
				...
				{
					unk_0x82D42F43BE26EB72(fLocal_30);
				}
				unk_0x392841D58D2EED1D();
			}
			...
			func_14(Global_19779, "DISPLAY_VIEW", 23f, unk_0xBBDA792448DB5A89(1), -1082130432, -1082130432, -1082130432);
		}
	}
...
{
	fLocal_25 = (Global_4272668[iParam0 /*3*/] - Local_20.f_0);
	fLocal_26 = (unk_0xD0FFB162F40A139C(((3.14159f / 180f) * Local_20.f_0)) * (Global_4272668[iParam0 /*3*/].f_1 - Local_20.f_1));
	fLocal_27 = unk_0xF0AE30F012D1FD8C(fLocal_25, fLocal_26);
	if (fLocal_27 < 0f)
	{
		fLocal_27 = (fLocal_27 + 360f);
	}
...
{
	fLocal_29 = unk_0x71D93B57D07F9804(unk_0xB7A628320EFF8E47(Global_4272668[iParam0 /*3*/], Local_20));
	fLocal_30 = (Global_4272668[iParam0 /*3*/].f_2 - Local_20.f_2);
	return fLocal_29;
}

float func_13(int iParam0)
{
	fLocal_28 = unk_0x71D93B57D07F9804((((Global_4272668[iParam0 /*3*/] - Local_20.f_0) * (Global_4272668[iParam0 /*3*/] - Local_20.f_0)) + ((Global_4272668[iParam0 /*3*/].f_1 - Local_20.f_1) * (Global_4272668[iParam0 /*3*/].f_1 - Local_20.f_1))));
	return fLocal_28;
}
...
float func_15()
{
	fLocal_25 = (Global_22231 - Local_20.f_0);
	fLocal_26 = (unk_0xD0FFB162F40A139C(((3.14159f / 180f) * Local_20.f_0)) * (Global_22231.f_1 - Local_20.f_1));
	fLocal_27 = unk_0xF0AE30F012D1FD8C(fLocal_25, fLocal_26);
	if (fLocal_27 < 0f)
	{
		fLocal_27 = (fLocal_27 + 360f);
...
float func_16()
{
	fLocal_29 = unk_0x71D93B57D07F9804(unk_0xB7A628320EFF8E47(Global_22231, Local_20));
	fLocal_30 = (Global_22231.f_2 - Local_20.f_2);
	return fLocal_29;
}

float func_17()
{
	fLocal_28 = unk_0x71D93B57D07F9804((((Global_22231 - Local_20.f_0) * (Global_22231 - Local_20.f_0)) + ((Global_22231.f_1 - Local_20.f_1) * (Global_22231.f_1 - Local_20.f_1))));
	return fLocal_28;
}
