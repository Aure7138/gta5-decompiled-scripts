...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		uVar0 = unk_0xAB6BAF5BFCAFB141(uParam0->f_43.f_1);
		if (unk_0xFC5D6FB6EECB392F(uVar0))
		{
			unk_0x71B9CAADD460F7CC(uParam0->f_43.f_1);
		}
	}
}
...
{
	Global_2462507 = iParam0;
	Global_1590682[unk_0x460153A63B9477BC() /*883*/].f_877 = iParam0;
}
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 1:
			...
			if (func_64(uParam0))
			{
				uParam0->f_43.f_6 = unk_0x578C4EF320340AF7();
				func_65(uParam0, 2);
			}
			break;
		
		case 2:
			if (func_63(unk_0x9B0761B4C3EB8BC7(), uParam0[uParam0->f_43.f_2 /*14*/]) && func_62(unk_0x9B0761B4C3EB8BC7(), (uParam0[uParam0->f_43.f_2 /*14*/])->f_8.f_3, (*uParam0)[uParam0->f_43.f_2 /*14*/]))
			{
				...
				else
				{
					...
					{
						if ((unk_0x578C4EF320340AF7() - uParam0->f_43.f_6) > 150)
						{
		...
		case 4:
			...
			Var20 = { unk_0xD7D25254A712E758(&sVar0, &sVar16, func_48(uParam0), func_47(uParam0), 0, 2) };
			Var23 = { unk_0xD78F5800B90C4843(&sVar0, &sVar16, func_48(uParam0), func_47(uParam0), 0, 2) };
			uVar26 = Var23.f_2;
			fVar27 = 0.05f;
			...
			unk_0x83CAF206A9B8748C(unk_0x9B0761B4C3EB8BC7(), Var20, 1f, 500, uVar26, fVar27);
		...
		case 5:
			...
			func_50(uParam0, &sVar0);
			func_49(uParam0, &sVar16);
			iVar28 = unk_0x16BC17A8EDC701A2(unk_0x9B0761B4C3EB8BC7(), 2106541073);
			Var29 = { unk_0xD78F5800B90C4843(&sVar0, &sVar16, func_48(uParam0), func_47(uParam0), 0, 2) };
			fVar32 = Var29.f_2;
			if ((iVar28 != 1 && iVar28 != 0) || func_34(unk_0xEF7858F25585F853(unk_0x9B0761B4C3EB8BC7()), fVar32, 5f))
			{
				uParam0->f_43.f_1 = unk_0xAA579EC5104BFDA9(func_48(uParam0), func_47(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
				unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), uParam0->f_43.f_1, &sVar0, &sVar16, 2f, -1000f, 13, 16, 1148846080, 0);
				unk_0xB88AF19828BF16ED(uParam0->f_43.f_1);
				uParam0->f_43.f_8.f_4 = unk_0x578C4EF320340AF7();
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			uVar33 = unk_0xAB6BAF5BFCAFB141(uParam0->f_43.f_1);
			if (unk_0xFC5D6FB6EECB392F(uVar33))
			{
				if (unk_0x369E69441C066912(uVar33) >= 1f)
				{
					func_10(uParam0, 0);
					func_50(uParam0, &sVar0);
					func_49(uParam0, &sVar16);
					uParam0->f_43.f_1 = unk_0xAA579EC5104BFDA9(func_48(uParam0), func_47(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
					unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), uParam0->f_43.f_1, &sVar0, &sVar16, 4f, -1.5f, 13, 16, 1148846080, 0);
					unk_0xB88AF19828BF16ED(uParam0->f_43.f_1);
					func_33(&(uParam0->f_43), 8);
		...
		case 8:
			uVar34 = unk_0xAB6BAF5BFCAFB141(uParam0->f_43.f_1);
			iVar35 = unk_0x16BC17A8EDC701A2(unk_0x9B0761B4C3EB8BC7(), 1785177548);
			if (iVar35 == 0 || iVar35 == 1)
			{
				if (unk_0xFC5D6FB6EECB392F(uVar34))
				{
					if ((unk_0x369E69441C066912(uVar34) >= 0.7f || unk_0x39CABCD7925B9200(unk_0x9B0761B4C3EB8BC7(), 364629851)) || unk_0x39CABCD7925B9200(unk_0x9B0761B4C3EB8BC7(), 2116425869))
					{
						unk_0x71B9CAADD460F7CC(uParam0->f_43.f_1);
						func_4(-1);
						func_5(uParam0, 1);
...
void func_10(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((unk_0x578C4EF320340AF7() - uParam0->f_43.f_8.f_4) >= 90000)
		{
			iVar1 = func_11(uParam0);
			if (iVar1 != uParam0->f_43.f_8.f_1)
			{
...
void func_16(var uParam0)
{
	...
	if (uParam0->f_43.f_4 == 6)
	{
		...
		if ((uParam0->f_43.f_4 == 6 && !unk_0x39CABCD7925B9200(unk_0x9B0761B4C3EB8BC7(), -1322051853)) && !func_32(&(uParam0->f_43), 12))
		{
			if ((fVar3 >= 0.35f && !Global_2517024) && !Global_2517026)
			{
				func_29(uParam0);
			}
		}
		...
		else if (Global_2517024 || Global_2517026)
		{
			func_5(uParam0, 1);
		}
		...
		else
		{
			...
			bVar4 = false;
			if (((func_26(func_27()) && func_25()) && func_24(Global_2426097[unk_0x460153A63B9477BC() /*443*/].f_314.f_9, 4)) && func_23(Global_2426097[unk_0x460153A63B9477BC() /*443*/].f_314.f_9))
			{
				bVar4 = true;
			}
			if (((((!unk_0xF0C12886E5C1B20E() && !func_32(&(uParam0->f_43), 0)) && !func_32(&(uParam0->f_43), 4)) && !func_22()) && !func_20(1)) && uParam0->f_43.f_8.f_2 != 3)
			{
				if (uParam0->f_43.f_5 == -1)
				{
					if (uParam0->f_43.f_8 == 1 || uParam0->f_43.f_8 == 0)
					{
						if (unk_0xC1F43F8D0D5EB664(2))
						{
							if (bVar4)
							{
								if (func_17(unk_0x460153A63B9477BC()) == 3)
								{
									func_54(&(uParam0->f_43.f_5), 4, "DJ_SEAT_PC_BM", 0, 0, 0, 0);
								}
								else if (func_17(unk_0x460153A63B9477BC()) == 2)
								{
				...
				if (uParam0->f_43.f_4 == 6)
				{
					...
					if (((unk_0x79800E51B3B6D197(2, iVar5) && !unk_0x1BD7199394D7F19A(2, 203)) && !Global_2517026) && !Global_2517024)
					{
						func_30(uParam0);
					}
					if (((((unk_0x79800E51B3B6D197(2, 203) && !unk_0x79800E51B3B6D197(2, iVar5)) && func_26(func_27())) && func_25()) && func_24(Global_2426097[unk_0x460153A63B9477BC() /*443*/].f_314.f_9, 4)) && func_23(Global_2426097[unk_0x460153A63B9477BC() /*443*/].f_314.f_9))
					{
						Global_2517026 = 1;
						Global_2517024 = 1;
					}
...
bool func_18(int iParam0, int iParam1)
{
	...
	iVar0 = iParam1 + 20;
	return unk_0xCE990E643CD9D0E5(Global_1590682[iParam0 /*883*/].f_274.f_322.f_1, iVar0);
}
...
int func_20(bool bParam0)
{
	if (unk_0xDE4629DF35A51BEF())
	{
		...
		{
			if (func_21(unk_0x9B0761B4C3EB8BC7()))
			{
...
int func_21(var uParam0)
{
	...
	if (unk_0xE8CD061CB2B99F32())
	{
		...
		{
			unk_0x1386E5E658CE3032(uParam0, &iVar0, 1);
...
bool func_23(int iParam0)
{
	...
	return unk_0xCE990E643CD9D0E5(Global_1590682[iParam0 /*883*/].f_274.f_322.f_1, 1);
}
...
int func_25()
{
	if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), -1612.283f, -3021.792f, -76.18069f, -1612.22f, -3005.203f, -74.20517f, 12.75f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
void func_30(var uParam0)
{
	...
	uParam0->f_43.f_1 = unk_0xAA579EC5104BFDA9(func_48(uParam0), func_47(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
	func_50(uParam0, &sVar0);
	unk_0x54D6514F20DE2E13(unk_0x9B0761B4C3EB8BC7(), uParam0->f_43.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1148846080, 0);
	unk_0xB88AF19828BF16ED(uParam0->f_43.f_1);
	func_7(&(uParam0->f_43.f_5));
	func_65(uParam0, 8);
}
...
bool func_31()
{
	return unk_0xCE990E643CD9D0E5(Global_1678289.f_3, 25);
}
...
int func_52(var uParam0)
{
	...
	switch (uParam0->f_43.f_8)
	{
		...
		default:
			iVar0 = unk_0x344C570D6F8700DF(0, func_14(uParam0->f_43.f_8));
	}
	if (uParam0->f_43.f_8 == 1)
	{
		if (func_12())
...
int func_56(var uParam0)
{
	...
	while (iVar0 < unk_0xEFA28384DDD283E1())
	{
		if (unk_0xBD09DF93F957A0CF(unk_0x628A51AC66E80772(iVar0)))
		{
			...
			if (iVar1 != unk_0x460153A63B9477BC() && func_59(iVar1, 1, 1))
			{
				if (func_63(unk_0x1FA7B77001D60F9D(iVar1), uParam0[uParam0->f_43.f_2 /*14*/]) || func_58(iVar1) == uParam0->f_43.f_2)
				{
					return 1;
				}
			}
...
int func_57(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((unk_0xAE06B9E39EBDE049(uVar0[iVar11]) && !unk_0x5AEB5DDFFAD43CA5(uVar0[iVar11])) && unk_0xDC79F755CB11603C(uVar0[iVar11])) && (func_63(uVar0[iVar11], uParam0[uParam0->f_43.f_2 /*14*/]) || unk_0xB7A628320EFF8E47(unk_0x3E4D3CCC220BDFB1(uVar0[iVar11], 0), (uParam0[uParam0->f_43.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_43.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar11++;
...
{
	return unk_0xCE990E643CD9D0E5(Global_2426097[iParam0 /*443*/].f_314.f_3, 13);
}
...
int func_62(var uParam0, struct<3> Param1, int iParam4)
{
	if (unk_0xAE06B9E39EBDE049(uParam0))
	{
		if (iParam4 == 3)
		{
			if (func_34(unk_0xEF7858F25585F853(uParam0), (Param1.f_2 - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_34(unk_0xEF7858F25585F853(uParam0), Param1.f_2, 45f))
		{
			return 1;
		}
	}
...
{
	return unk_0x1037B9D45CE6B788(uParam0, uParam1->f_1, uParam1->f_1.f_3, uParam1->f_1.f_6, 0, 1, 0);
}
...
void func_67(var uParam0)
{
	...
	else if (uParam0->f_43.f_4 > 4)
	{
		...
		unk_0xE1A91D6D0E2CF9AE(unk_0x9B0761B4C3EB8BC7(), func_68());
		uParam0->f_43.f_7 = unk_0xD3137A576BE9EC5C();
	}
	else if ((unk_0xD3137A576BE9EC5C() - uParam0->f_43.f_7) < 5)
	{
		unk_0xE1A91D6D0E2CF9AE(unk_0x9B0761B4C3EB8BC7(), func_68());
	}
}
...
void func_69(var uParam0)
{
	...
	func_70(&(uParam0->f_43), 1, unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0));
	func_70(&(uParam0->f_43), 3, unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 1));
	func_70(&(uParam0->f_43), 0, func_45(0));
	func_70(&(uParam0->f_43), 2, unk_0x4D71E6F618DC5C0E(unk_0x9B0761B4C3EB8BC7()));
}
...
void func_70(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		unk_0xBE20AB8238688965(uParam0, uVar0);
	}
	else
	{
...
int func_72()
{
	if ((unk_0x03DB5C6AABF8DA46() && !func_85()) && !Global_2517024)
	{
		return 1;
	}
	if (!func_84())
	...
	if (Global_2426097[unk_0x460153A63B9477BC() /*443*/].f_314.f_9 == func_19())
	{
		return 1;
	}
	return 0;
...
int func_73()
{
	...
	if (func_74() != 0)
	{
		if (unk_0x7B70881748D166CD(func_74()) == 0)
		{
			return 1;
		}
	}
...
int func_84()
{
	if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 207.5193f, 5163.855f, -86.59737f, 211.7083f, 5163.879f, -83.6007f, 6.25f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
bool func_85()
{
	return unk_0xCE990E643CD9D0E5(Global_1678289.f_4, 10);
}
...
int func_86()
{
	if (Global_2426097[unk_0x460153A63B9477BC() /*443*/].f_314.f_9 != func_19())
	{
		if (unk_0x1B2EFC1EEC84CBE3("arena_workshop_seats", Global_2426097[unk_0x460153A63B9477BC() /*443*/].f_314.f_9, 1, 0))
		{
			return 0;
		}
		unk_0xA88557896B79E30D(32, 0, Global_2426097[unk_0x460153A63B9477BC() /*443*/].f_314.f_9);
		func_95(0, -1, 0);
