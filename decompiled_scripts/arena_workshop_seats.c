...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		uVar0 = unk_0xE8EC5AFFC564CC19(uParam0->f_43.f_1);
		if (unk_0xB50E39CA0A3E6020(uVar0))
		{
			unk_0x6E567C25E3028753(uParam0->f_43.f_1);
		}
	}
}
...
void func_4(int iParam0)
{
	...
	Global_1590446[unk_0x7C7787D2D7139A85() /*871*/].f_865 = iParam0;
}
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 1:
			...
			if (func_64(uParam0))
			{
				uParam0->f_43.f_6 = unk_0x9B35D07DCD0F0B43();
				func_65(uParam0, 2);
			}
			break;
		
		case 2:
			if (func_63(unk_0x0FA8183DAD2B3203(), uParam0[uParam0->f_43.f_2 /*14*/]) && func_62(unk_0x0FA8183DAD2B3203(), (uParam0[uParam0->f_43.f_2 /*14*/])->f_8.f_3, (*uParam0)[uParam0->f_43.f_2 /*14*/]))
			{
				...
				else
				{
					...
					{
						if ((unk_0x9B35D07DCD0F0B43() - uParam0->f_43.f_6) > 150)
						{
							func_54(&(uParam0->f_43.f_5), 4, "MPJAC_SIT", 0, 0, 0, 0);
						}
					}
					else if (unk_0x26BB91778477F482(0, 51))
					{
						func_7(&(uParam0->f_43.f_5));
						func_51(uParam0);
						func_65(uParam0, 3);
		...
		case 3:
			...
			if (unk_0xB25A0D192C6A0A5B(&sVar0))
			{
				func_65(uParam0, 4);
			}
			break;
		...
		case 4:
			...
			Var20 = { unk_0xD0D335A69D1FFE54(&sVar0, &sVar16, func_48(uParam0), func_47(uParam0), 0, 2) };
			Var23 = { unk_0xCEFF26ED96E453A8(&sVar0, &sVar16, func_48(uParam0), func_47(uParam0), 0, 2) };
			uVar26 = Var23.f_2;
			fVar27 = 0.05f;
			...
			unk_0x43D490C8BFA124BB(unk_0x0FA8183DAD2B3203(), Var20, 1f, 500, uVar26, fVar27);
		...
		case 5:
			...
			func_50(uParam0, &sVar0);
			func_49(uParam0, &sVar16);
			iVar28 = unk_0x411C065ADB822CD9(unk_0x0FA8183DAD2B3203(), 2106541073);
			Var29 = { unk_0xCEFF26ED96E453A8(&sVar0, &sVar16, func_48(uParam0), func_47(uParam0), 0, 2) };
			fVar32 = Var29.f_2;
			if ((iVar28 != 1 && iVar28 != 0) || func_34(unk_0xD2809C7F7FD79247(unk_0x0FA8183DAD2B3203()), fVar32, 5f))
			{
				uParam0->f_43.f_1 = unk_0x7A2D5FD0FD8749D9(func_48(uParam0), func_47(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
				unk_0x701B83BD92AC8A8E(unk_0x0FA8183DAD2B3203(), uParam0->f_43.f_1, &sVar0, &sVar16, 2f, -1000f, 13, 16, 1148846080, 0);
				unk_0xFE38E793F7E4AD65(uParam0->f_43.f_1);
				uParam0->f_43.f_8.f_4 = unk_0x9B35D07DCD0F0B43();
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			uVar33 = unk_0xE8EC5AFFC564CC19(uParam0->f_43.f_1);
			if (unk_0xB50E39CA0A3E6020(uVar33))
			{
				if (unk_0x91F0628278985DB8(uVar33) >= 1f)
				{
					func_10(uParam0, 0);
					func_50(uParam0, &sVar0);
					func_49(uParam0, &sVar16);
					uParam0->f_43.f_1 = unk_0x7A2D5FD0FD8749D9(func_48(uParam0), func_47(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
					unk_0x701B83BD92AC8A8E(unk_0x0FA8183DAD2B3203(), uParam0->f_43.f_1, &sVar0, &sVar16, 4f, -1.5f, 13, 16, 1148846080, 0);
					unk_0xFE38E793F7E4AD65(uParam0->f_43.f_1);
					func_33(&(uParam0->f_43), 8);
		...
		case 8:
			uVar34 = unk_0xE8EC5AFFC564CC19(uParam0->f_43.f_1);
			iVar35 = unk_0x411C065ADB822CD9(unk_0x0FA8183DAD2B3203(), 1785177548);
			if (iVar35 == 0 || iVar35 == 1)
			{
				if (unk_0xB50E39CA0A3E6020(uVar34))
				{
					if ((unk_0x91F0628278985DB8(uVar34) >= 0.7f || unk_0x5149CDB3FF43EDD1(unk_0x0FA8183DAD2B3203(), 364629851)) || unk_0x5149CDB3FF43EDD1(unk_0x0FA8183DAD2B3203(), 2116425869))
					{
						unk_0x6E567C25E3028753(uParam0->f_43.f_1);
						func_4(-1);
						func_5(uParam0, 1);
...
void func_10(var uParam0, bool bParam1)
{
	...
	else if (uParam0->f_43.f_8.f_2 == 5)
	{
		iVar1 = uParam0->f_43.f_8.f_1;
		iVar2 = 3;
		iVar0 = unk_0xBAC643F143880136(0, iVar2);
	...
	else
	{
		...
		if ((unk_0x9B35D07DCD0F0B43() - uParam0->f_43.f_8.f_4) >= 90000)
		{
			iVar1 = func_11(uParam0);
			if (iVar1 != uParam0->f_43.f_8.f_1)
			{
...
bool func_12()
{
	return func_13(unk_0x7C7787D2D7139A85());
}
...
void func_16(var uParam0)
{
	...
	{
		Var0 = { unk_0x43499278F7E25871(0, 218), unk_0x43499278F7E25871(0, 219), 0f };
		fVar3 = unk_0x652D2EEEF1D3E62C(Var0);
		if ((uParam0->f_43.f_4 == 6 && !unk_0x5149CDB3FF43EDD1(unk_0x0FA8183DAD2B3203(), -1322051853)) && !func_32(&(uParam0->f_43), 12))
		{
			if ((fVar3 >= 0.35f && !Global_2509232) && !Global_2509234)
			{
				func_29(uParam0);
			}
		}
		...
		if (unk_0x5149CDB3FF43EDD1(unk_0x0FA8183DAD2B3203(), -1322051853))
		{
			func_5(uParam0, 1);
		}
		...
		else
		{
			...
			bVar4 = false;
			if (((func_26(func_27()) && func_25()) && func_24(Global_2424073[unk_0x7C7787D2D7139A85() /*421*/].f_309.f_8, 4)) && func_23(Global_2424073[unk_0x7C7787D2D7139A85() /*421*/].f_309.f_8))
			{
				bVar4 = true;
			}
			if (((((!unk_0xCD97B9861557C025() && !func_32(&(uParam0->f_43), 0)) && !func_32(&(uParam0->f_43), 4)) && !func_22()) && !func_20(1)) && uParam0->f_43.f_8.f_2 != 3)
			{
				if (uParam0->f_43.f_5 == -1)
				{
					if (uParam0->f_43.f_8 == 1 || uParam0->f_43.f_8 == 0)
					{
						if (unk_0x59415A8719336539(2))
						{
							if (bVar4)
							{
								if (func_17(unk_0x7C7787D2D7139A85()) == 3)
								{
									func_54(&(uParam0->f_43.f_5), 4, "DJ_SEAT_PC_BM", 0, 0, 0, 0);
								}
								else if (func_17(unk_0x7C7787D2D7139A85()) == 2)
								{
				...
				if (uParam0->f_43.f_4 == 6)
				{
					...
					if (((unk_0x80E2BA2BD5AB1A3F(2, iVar5) && !unk_0x26BB91778477F482(2, 203)) && !Global_2509234) && !Global_2509232)
					{
						func_30(uParam0);
					}
					if (((((unk_0x80E2BA2BD5AB1A3F(2, 203) && !unk_0x80E2BA2BD5AB1A3F(2, iVar5)) && func_26(func_27())) && func_25()) && func_24(Global_2424073[unk_0x7C7787D2D7139A85() /*421*/].f_309.f_8, 4)) && func_23(Global_2424073[unk_0x7C7787D2D7139A85() /*421*/].f_309.f_8))
					{
						Global_2509234 = 1;
						Global_2509232 = 1;
					}
...
bool func_18(int iParam0, int iParam1)
{
	...
	iVar0 = iParam1 + 20;
	return unk_0xA2BC31158C8CEFD2(Global_1590446[iParam0 /*871*/].f_273.f_318.f_1, iVar0);
}
...
int func_20(bool bParam0)
{
	if (unk_0x8F0856319BE615A3())
	{
		...
		{
			if (func_21(unk_0x0FA8183DAD2B3203()))
			{
...
int func_21(var uParam0)
{
	...
	if (unk_0xC6649C48084573DA())
	{
		...
		{
			unk_0x63EA4FAF7CDEFEC7(uParam0, &iVar0, 1);
...
bool func_23(int iParam0)
{
	...
	return unk_0xA2BC31158C8CEFD2(Global_1590446[iParam0 /*871*/].f_273.f_318.f_1, 1);
}
...
int func_25()
{
	if (unk_0x42A24CB7B8A08E11(unk_0x0FA8183DAD2B3203(), -1612.283f, -3021.792f, -76.18069f, -1612.22f, -3005.203f, -74.20517f, 12.75f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
void func_30(var uParam0)
{
	...
	uParam0->f_43.f_1 = unk_0x7A2D5FD0FD8749D9(func_48(uParam0), func_47(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
	func_50(uParam0, &sVar0);
	unk_0x701B83BD92AC8A8E(unk_0x0FA8183DAD2B3203(), uParam0->f_43.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1148846080, 0);
	unk_0xFE38E793F7E4AD65(uParam0->f_43.f_1);
	func_7(&(uParam0->f_43.f_5));
	func_65(uParam0, 8);
}
...
bool func_31()
{
	return unk_0xA2BC31158C8CEFD2(Global_1676879.f_3, 25);
}
...
void func_35(var uParam0)
{
	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 6:
			...
			unk_0x739718D22B6F3760(0);
			unk_0x09F37649D7BCA897(0);
			unk_0x0AF55029F939BA65(19);
			unk_0x0AF55029F939BA65(2);
			unk_0xB6D9C526B6425F4A();
			func_39();
			if (unk_0x63EA4FAF7CDEFEC7(unk_0x0FA8183DAD2B3203(), &iVar0, 1) && iVar0 != joaat("weapon_unarmed"))
			{
...
int func_52(var uParam0)
{
	...
	switch (uParam0->f_43.f_8)
	{
		...
		default:
			iVar0 = unk_0xBAC643F143880136(0, func_14(uParam0->f_43.f_8));
	}
	if (uParam0->f_43.f_8 == 1)
	{
		if (func_12())
...
int func_56(var uParam0)
{
	...
	while (iVar0 < unk_0xACF7D965CEBE5714())
	{
		if (unk_0x2700CB8907086DF3(unk_0x9DBE48BD26DE1888(iVar0)))
		{
			...
			if (iVar1 != unk_0x7C7787D2D7139A85() && func_59(iVar1, 1, 1))
			{
				if (func_63(unk_0x23625FE58BACEBFD(iVar1), uParam0[uParam0->f_43.f_2 /*14*/]) || func_58(iVar1) == uParam0->f_43.f_2)
				{
					return 1;
				}
			}
...
int func_57(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((unk_0xD4B321D9096B01FC(uVar0[iVar11]) && !unk_0x2BF5E63466422C38(uVar0[iVar11])) && unk_0x0975E9E48EA2CC7B(uVar0[iVar11])) && (func_63(uVar0[iVar11], uParam0[uParam0->f_43.f_2 /*14*/]) || unk_0xB7A628320EFF8E47(unk_0xACE5E491FC1B0D37(uVar0[iVar11], 0), (uParam0[uParam0->f_43.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_43.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar11++;
...
{
	return unk_0xA2BC31158C8CEFD2(Global_2424073[iParam0 /*421*/].f_309.f_3, 13);
}
...
int func_62(var uParam0, struct<3> Param1, int iParam4)
{
	if (unk_0xD4B321D9096B01FC(uParam0))
	{
		if (iParam4 == 3)
		{
			if (func_34(unk_0xD2809C7F7FD79247(uParam0), (Param1.f_2 - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_34(unk_0xD2809C7F7FD79247(uParam0), Param1.f_2, 45f))
		{
			return 1;
		}
	}
...
{
	return unk_0x42A24CB7B8A08E11(uParam0, uParam1->f_1, uParam1->f_1.f_3, uParam1->f_1.f_6, 0, 1, 0);
}
...
void func_67(var uParam0)
{
	...
	{
		unk_0x0BF8D8D00F238596(unk_0x0FA8183DAD2B3203());
		unk_0x216F49BC95110ED2(unk_0x0FA8183DAD2B3203(), func_68());
		uParam0->f_43.f_7 = unk_0xB3EE417AD9F0CAA2();
	}
	else if ((unk_0xB3EE417AD9F0CAA2() - uParam0->f_43.f_7) < 5)
	{
		unk_0x216F49BC95110ED2(unk_0x0FA8183DAD2B3203(), func_68());
	}
}
...
void func_69(var uParam0)
{
	...
	func_70(&(uParam0->f_43), 1, unk_0xF4B969E0807E76C7(unk_0x0FA8183DAD2B3203(), 0));
	func_70(&(uParam0->f_43), 3, unk_0x5294582CE404D3F4(unk_0x0FA8183DAD2B3203(), 1));
	func_70(&(uParam0->f_43), 0, func_45(0));
	func_70(&(uParam0->f_43), 2, unk_0xDFBCC78414C44B91(unk_0x0FA8183DAD2B3203()));
}
...
void func_70(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		unk_0xA1E7A40E1F56E511(uParam0, uVar0);
	}
	else
	{
...
int func_72()
{
	if ((unk_0x260395BA7F0C83CB() && !func_85()) && !Global_2509232)
	{
		return 1;
	}
	if (!func_84())
	...
	if (Global_2424073[unk_0x7C7787D2D7139A85() /*421*/].f_309.f_8 == func_19())
	{
		return 1;
	}
	return 0;
...
int func_73()
{
	...
	if (func_74() != 0)
	{
		if (unk_0x222F76006659B0EB(func_74()) == 0)
		{
			return 1;
		}
	}
...
int func_84()
{
	if (unk_0x42A24CB7B8A08E11(unk_0x0FA8183DAD2B3203(), 207.5193f, 5163.855f, -86.59737f, 211.7083f, 5163.879f, -83.6007f, 6.25f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
bool func_85()
{
	return unk_0xA2BC31158C8CEFD2(Global_1676879.f_4, 10);
}
...
int func_86()
{
	if (Global_2424073[unk_0x7C7787D2D7139A85() /*421*/].f_309.f_8 != func_19())
	{
		if (unk_0x09573FC4C0F4DB13("arena_workshop_seats", Global_2424073[unk_0x7C7787D2D7139A85() /*421*/].f_309.f_8, 1, 0))
		{
			return 0;
		}
		unk_0x4CF6FBF2580A447D(32, 0, Global_2424073[unk_0x7C7787D2D7139A85() /*421*/].f_309.f_8);
		func_95(0, -1, 0);
