...
void func_2()
{
	...
	if (!bVar1)
	{
		if (((((((((unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()) || (!unk_0x9315DBF7D972F07A() && !func_73(iLocal_58))) || unk_0x04458B4E5D9E466A()) || func_72()) || unk_0xF34D8FCAE3FD4EE4()) || unk_0xA829C9A2767AC8EF()) || !unk_0x1C7A1A7E9E4766CF(unk_0x9E2D6C50374FCFA9())) || Global_77856) || Global_97264) || iLocal_61)
		{
			iLocal_82 = 1;
...
int func_9()
{
	...
	if (BitTest(Global_1853131[unk_0x9E2D6C50374FCFA9() /*888*/].f_887, 16))
	{
		return 0;
	}
	if (func_42())
	...
	if (BitTest(Global_1853131[unk_0x9E2D6C50374FCFA9() /*888*/].f_887, 6))
	{
		return 0;
	}
	...
	switch (iParam1)
	{
		...
		case 2:
			if (iParam0 == 0)
			{
				...
				fVar0 = (unk_0xBBDA792448DB5A89((iVar3 - Global_112922.f_2363.f_539.f_2359[iParam0])) / 20f);
			}
			else if (iParam0 == 1)
			{
		...
		case 4:
			if (iParam0 == 0)
			{
				...
				fVar0 = (fVar0 + (unk_0xBBDA792448DB5A89((iVar3 - Global_112922.f_2363.f_539.f_2363[iParam0])) / 50f));
			}
			else if (iParam0 == 1)
			{
		...
		case 7:
			...
			if (iParam0 == 0)
			{
				...
				fVar0 = (fVar0 + ((unk_0xBBDA792448DB5A89((iVar3 - Global_112922.f_2363.f_539.f_2371[iParam0])) / 2f) * 1.5f));
			}
			else if (iParam0 == 1)
			{
		...
		case 6:
			if (iParam0 == 0)
			{
				...
				iVar6 = (iVar6 - iVar5);
				fVar0 = (unk_0xBBDA792448DB5A89((iVar5 - Global_112922.f_2363.f_539.f_2375[iParam0])) / 40f);
				fVar0 = (fVar0 + (unk_0xBBDA792448DB5A89((iVar6 - Global_112922.f_2363.f_539.f_2379[iParam0])) / 80f));
			}
			else if (iParam0 == 1)
			{
...
void func_79()
{
	...
	if (!iLocal_80)
	{
		...
		else
		{
			...
			{
				Global_112922.f_2363.f_539.f_2280[iLocal_58] = unk_0x48352343BC5A41AE();
			}
