...
void func_2()
{
	...
	if (unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), Local_45, 50f, 50f, 50f, 0, 1, 0))
	{
		...
		uLocal_52 = unk_0xB1DBFEB95C0EFB88(19, joaat("g_m_y_mexgoon_02"), Local_45.f_0, Local_45.f_1, Local_48.f_2, 0f, 1, 1);
		if (!unk_0x1C2F771CDC87A3A5(uLocal_52, 0))
		{
			unk_0xB5396F1FB088FE38(&uLocal_54);
			unk_0xCD76801E1106CABE(0, Local_48, 0);
		...
		if (iLocal_51 == 1)
		{
			Local_48 = { unk_0x0D1381B6E0F3987D(uLocal_52, 3.8f, 0.8f, 0f) };
			iLocal_53 = unk_0xB1DBFEB95C0EFB88(5, joaat("a_f_m_bevhills_02"), Local_48, 0f, 1, 1);
			if (!unk_0x1C2F771CDC87A3A5(iLocal_53, 0))
			{
				unk_0xCD76801E1106CABE(iLocal_53, Local_45, 0);
			}
		}
		iLocal_44 = 1;
	}
