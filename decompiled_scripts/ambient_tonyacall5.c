...
void __EntryFunction__()
{
	...
	if (unk_0x8E34C953364A76DD(joaat("ambient_tonyacall5")) > 1)
	{
	...
	while (true)
	{
		...
		switch (iLocal_36)
		{
			...
			case 1:
				...
				if (((unk_0x1283B8B89DD5D1B6(joaat("prop_phone_ing")) && unk_0x27FF6FE8009B40CA("amb@world_human_stand_mobile@female@standing@call@enter")) && unk_0x27FF6FE8009B40CA("amb@world_human_stand_mobile@female@standing@call@base")) && unk_0x27FF6FE8009B40CA("amb@world_human_stand_mobile@female@standing@call@exit"))
				{
					iLocal_36 = 2;
				}
				break;
...
int func_1()
{
	...
	if ((unk_0xB7A628320EFF8E47(Var0, Var3) > 10000f || unk_0x7D5B1F88E7504BBA(uLocal_37)) || func_21())
	{
		return 1;
	}
	switch (iLocal_39)
		...
		case 0:
			if (unk_0xD42BD6EB2E0F1677(uLocal_37) && !unk_0x7D5B1F88E7504BBA(uLocal_37))
			{
				if (unk_0x5E58342602E94718(uLocal_37, Local_56, 1f, 1f, 1f, 0, 1, 0))
				{
					...
					unk_0xD59C10966EB589EA(uLocal_37, uVar7);
					unk_0x5EC7E18324A7D03D(&uVar7);
					iLocal_39 = 1;
				}
			}
			...
			if (unk_0xD42BD6EB2E0F1677(uLocal_37) && !unk_0x7D5B1F88E7504BBA(uLocal_37))
			{
				if (unk_0x25E686EB2B4BE2B7(uLocal_37) == 1)
				{
					if (!unk_0xD42BD6EB2E0F1677(uLocal_38))
					{
						...
						{
							fVar8 = unk_0x6B0B5671C53485D8(uLocal_37, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar8 >= 0.157f)
							{
				...
				{
					iVar6 = (unk_0x9C1C462D7B1DD1F9(0, 65535) % 2);
					if (iVar6 == 0)
					{
