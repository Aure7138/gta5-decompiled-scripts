...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!Global_36842 && unk_0xA0F74982C6AAA9D4() > Global_36262)
		{
			iVar127 = 0;
			while (iVar127 < 122)
			{
			...
			if (iVar128 > 0 && Global_14413.f_1 == 3)
			{
				...
				if (Global_47574 > 0)
				{
					...
					while (iVar131 != 0)
					{
						...
						{
							Global_47575[iVar132 /*53*/].f_2 = (Global_47575[iVar132 /*53*/].f_2 - iVar128);
							bVar133 = false;
							bVar134 = false;
							bVar135 = false;
							iVar136 = 0;
							...
							else if (Global_47575[iVar132 /*53*/].f_2 < 1)
							{
								if (func_33(7, 145, 2, -1, 0))
								{
									...
									if (func_16(Global_47575[iVar132 /*53*/], Global_47575[iVar132 /*53*/].f_1, bVar137))
									{
										bVar138 = true;
										...
										{
											func_15(Global_47575[iVar132 /*53*/], &(Global_47575[iVar132 /*53*/].f_6), bVar138);
										}
										if (Global_47575[iVar132 /*53*/].f_10 > 0)
										{
											iVar130 = 0;
...
void func_2(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_3(unk_0xE8386CF1E84A5B3D(&cVar2, &cVar2, 0, 2, unk_0xC754513C760635E8(func_4(iParam1)), 0));
		}
		else
		{
			func_3(unk_0xE8386CF1E84A5B3D("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, unk_0xC754513C760635E8(func_4(iParam1)), 0));
		}
		switch (Global_14413)
		{
			case 0:
...
int func_16(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar1 < Global_46152[iVar0 /*203*/].f_3)
	{
		...
		if (iVar3 < 3)
		{
			func_17(Global_46152[iVar0 /*203*/].f_4[iVar1], Global_46152[iVar0 /*203*/].f_1, 1, bParam2, 0);
		}
		iVar1++;
	}
	return 1;
...
{
	return (unk_0x97EF1E5BCE9DC075(iParam0, 26) & 31 * func_27(unk_0xF426A5DE932B3BEE(iParam0, 31), -1, 1)) + 2011;
}
...
void func_31(int iParam0, bool bParam1)
{
	...
	func_17(Global_36852[iVar1 /*12*/].f_3, iParam0, 0, 0, bParam1);
	iVar3 = 0;
	while (iVar3 < iVar2)
	{
		...
		{
			func_17(Global_40177[iParam0 /*46*/].f_3[iVar3], iParam0, 0, 0, bParam1);
		}
		iVar3++;
	}
	if (Global_40177[iParam0 /*46*/].f_31 == Global_40177[iParam0 /*46*/].f_30)
...
int func_33(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (unk_0x2DB75A8F096AB1F1(unk_0x4D29100D094E5511()))
	{
		...
		{
			if (unk_0xF426A5DE932B3BEE(iParam0, func_52()) && !unk_0xF426A5DE932B3BEE(iParam4, 19))
			{
				return 0;
			}
		}
	...
	{
		if (!unk_0xF426A5DE932B3BEE(iParam0, func_52()))
		{
			return 0;
		}
	}
	...
	if (iParam3 != -1)
	{
		if (func_35(unk_0x27D769C59BC9D030(), iParam3, 0))
		{
			return 0;
		}
	}
...
float func_37(var uParam0)
{
	if (func_40(uParam0))
	{
		...
		{
			return (func_38(unk_0xF426A5DE932B3BEE(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
var func_58()
{
	...
	func_64(&uVar0, unk_0x2FADF5E93AB8D64B());
	func_63(&uVar0, unk_0x51C7DC141C5D0E6B());
	func_62(&uVar0, unk_0xEFEADD7EBD01C0A6());
	func_61(&uVar0, unk_0x388418AD39C0F4DE());
	func_60(&uVar0, unk_0xE3911478C9FE04B2());
	func_59(&uVar0, unk_0x8FB5B60BC869990E());
	return uVar0;
}
