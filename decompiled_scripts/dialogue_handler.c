...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (unk_0xAA4F14DA15DB0B51(Global_2314, 1))
		{
			if (!unk_0xAA4F14DA15DB0B51(Global_2313, 20))
			{
				if (unk_0x3813EBE69CF8CAD2())
				{
					...
					unk_0x507FE690B1271947(&Global_2314, 1);
				}
			}
		}
		if (unk_0xAA4F14DA15DB0B51(Global_14611, 0))
		{
			if (!func_105())
			{
				if (!unk_0xAA4F14DA15DB0B51(Global_14611, 1))
				{
					unk_0xF6082E2ADA1C795B(&Global_14611, 1);
					if (unk_0x591AF4C50B46E014())
					{
						uLocal_106 = unk_0x11ABC381A58DD5AB();
					}
					else
					{
				...
				if (unk_0x591AF4C50B46E014())
				{
					iLocal_108 = unk_0x2AA4F22517A69BB6(unk_0x11ABC381A58DD5AB(), uLocal_106);
				}
				else
				{
					iLocal_103 = unk_0x3732B96D7A1859B4();
		...
		if (!unk_0xB8B285A272E7A79E(unk_0x0FFED3E94261A832()) && !unk_0xAA4F14DA15DB0B51(Global_1638223.f_17, 4))
		{
			if (Global_15745 != 0)
			{
...
void func_2()
{
	...
	else if (unk_0xAA4F14DA15DB0B51(Global_2313, 11))
	{
		func_3();
	}
	Global_15751 = 0;
	...
	unk_0x507FE690B1271947(&Global_2314, 23);
	unk_0x507FE690B1271947(&Global_2315, 0);
	unk_0x507FE690B1271947(&Global_2314, 9);
	unk_0x507FE690B1271947(&Global_2314, 31);
	unk_0x507FE690B1271947(&Global_2314, 17);
	unk_0x507FE690B1271947(&Global_2315, 5);
	Global_16729 = 0;
	Global_16728 = 0;
	...
	else
	{
		Global_15745 = 0;
		Global_16756 = 0;
		Global_16767 = unk_0x3732B96D7A1859B4();
	}
}
...
void func_5()
{
	...
	{
		iLocal_37 = unk_0x3732B96D7A1859B4();
...
void func_7()
{
	...
	if (Global_15798 == 0)
	{
		if (!Global_15758)
		{
			if (!unk_0xAA4F14DA15DB0B51(Global_2314, 31))
			{
				if (!unk_0xAA4F14DA15DB0B51(Global_2314, 27))
				{
					if (func_49())
					{
						if (Global_14443.f_1 > 6)
						{
							unk_0xF6082E2ADA1C795B(&Global_2314, 24);
							unk_0xF6082E2ADA1C795B(&Global_2314, 27);
							unk_0x507FE690B1271947(&Global_2314, 26);
							unk_0x507FE690B1271947(&Global_2314, 25);
						}
					}
				}
			}
	...
	if (unk_0x3813EBE69CF8CAD2() == 0 && Global_15758 == 0)
	{
		if (Global_15798 == 1)
		{
			unk_0xF6082E2ADA1C795B(&Global_2314, 23);
		}
		else
		{
			unk_0x507FE690B1271947(&Global_2314, 23);
				...
				else
				{
					if (iLocal_30 == 0)
					{
						...
						if (Global_15800)
						{
							iLocal_30 = 1;
							Global_16760 = 1;
							func_106(Global_14424, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(4), -1f, -1f, &Global_15887, &(Global_103236.f_27831[Global_1628 /*29*/].f_7), &(Global_103236.f_27831[Global_1628 /*29*/].f_3), &(Global_103236.f_27831[Global_1628 /*29*/].f_3), 0);
					...
					if (func_45(2, Global_14413, 0) || unk_0xAA4F14DA15DB0B51(Global_2313, 24))
					{
						func_43();
						Global_14369 = 0.19f;
						Global_15798 = 0;
			...
			while (Global_15798)
			{
				...
				else
				{
					...
					if (func_45(2, Global_14412, 0))
					{
						...
						uLocal_236 = unk_0xCA19844C8EBF135B();
						while (!unk_0x49312763BCF4C85A(uLocal_236))
						{
							unk_0x4EDE34FBADD967A6(0);
						}
						iVar2 = unk_0x7E45511185E08C01(uLocal_236);
						switch (iVar2)
						{
							case 0:
								Global_15364 = { Global_15875 };
...
void func_8()
{
	...
	switch (Global_14443.f_1)
	{
		...
		case 9:
			...
			{
				func_10();
				func_46(Global_14424, "SET_THEME", unk_0xBBDA792448DB5A89(Global_103236.f_13832[Global_14443 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_15758)
				{
				...
				{
					func_106(Global_14424, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(2), -1f, -1f, &(Global_103236.f_27831[Global_1628 /*29*/].f_3), &(Global_103236.f_27831[Global_1628 /*29*/].f_7), "CELL_217", &(Global_103236.f_27831[Global_1628 /*29*/].f_3), 0);
				}
				func_46(Global_14424, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_15745 == 4 || Global_15745 == 3)
			{
				...
				else
				{
					...
					{
						func_46(Global_14424, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_106(Global_14424, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_103236.f_27831[Global_1628 /*29*/].f_3), &(Global_103236.f_27831[Global_1628 /*29*/].f_7), &Var0, &(Global_103236.f_27831[Global_1628 /*29*/].f_3), 0);
					}
				}
				func_46(Global_14424, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
...
void func_13()
{
	...
	switch (Global_14445)
	{
		...
		case 6:
			if (unk_0xAA4F14DA15DB0B51(Global_2314, 5))
			{
				Global_14445 = 6;
				unk_0x507FE690B1271947(&Global_2314, 5);
			}
			else
			{
				Global_14445 = 3;
...
void func_14()
{
	...
	if (iLocal_235 == 0)
	{
		if (func_45(2, Global_14419, 0) || unk_0x92BC4A8239BDDACC(2, 181))
		{
			func_18();
			iLocal_235 = 1;
			unk_0xC1B1E9A034A63A62(0);
		}
		if (func_45(2, Global_14420, 0) || unk_0x92BC4A8239BDDACC(2, 180))
		{
			func_15();
			iLocal_235 = 1;
			unk_0xC1B1E9A034A63A62(0);
...
void func_29()
{
	...
	if (unk_0x2137828D03306CAF(unk_0x2A5EB8B0FE590B91()))
	{
		if (func_32(Global_103236.f_2164.f_539.f_4301) != unk_0xD3B21CE53AA7BE51(unk_0x2A5EB8B0FE590B91()))
		{
			...
			if (func_30(iVar0) && (!func_12(14) || Global_102188))
			{
...
int func_49()
{
	if (unk_0x591AF4C50B46E014())
	{
		iLocal_108 = unk_0x2AA4F22517A69BB6(unk_0x11ABC381A58DD5AB(), uLocal_107);
	}
	else
	{
...
void func_53()
{
	if (func_45(2, Global_14420, 0))
	{
		if (Global_16756 == 0)
		{
			if (Global_15751)
			{
				if (unk_0xAA4F14DA15DB0B51(Global_2314, 17))
				{
				}
				else
				{
					unk_0xF23B33FA37A3E801();
				}
			}
		}
	}
...
void func_54()
{
	...
	if (!unk_0x769F0F6444C1ABE0(unk_0x2A5EB8B0FE590B91()))
	{
		if (func_55() && unk_0xC8AAE02019F925E6(unk_0x2A5EB8B0FE590B91(), 0))
		{
			iVar1 = 1;
		}
	}
...
void func_56()
{
	...
	else if (!unk_0x3813EBE69CF8CAD2())
	{
		iLocal_32 = 0;
		unk_0xE40123A348A5FEDA(0);
		Global_15745 = 6;
...
void func_57()
{
			...
			if (unk_0xB8B285A272E7A79E(unk_0x0FFED3E94261A832()))
			{
				if (unk_0x7B0D0EA42CF4A6CC(unk_0x0FFED3E94261A832()))
				{
					...
					else
					{
						...
						if (!Global_15756)
						{
							unk_0xF6082E2ADA1C795B(&Global_2314, 5);
						}
						func_13();
						Global_14443.f_1 = Global_14445;
						func_8();
	...
	else
	{
		...
		if (!Global_15758)
		{
			if (Global_16762 == 0)
			{
				if (!unk_0xAA4F14DA15DB0B51(Global_2315, 5))
				{
					unk_0xC32A92D2D7336141();
				}
				unk_0x507FE690B1271947(&Global_2315, 5);
			...
			{
				unk_0x743B6850DF702D1C(Global_15364.f_368, Global_15364.f_369);
			}
		}
		func_58();
	}
...
void func_58()
{
	if (unk_0x591AF4C50B46E014())
	{
		uLocal_107 = unk_0x11ABC381A58DD5AB();
	}
	else
	{
		iLocal_104 = unk_0x3732B96D7A1859B4();
	}
}
...
void func_60()
{
	if (unk_0xA8AF99BD8D81CFB7(Global_14424))
	{
		if (!Global_15753)
		{
			...
			{
				func_106(Global_14424, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_103236.f_27831[Global_1628 /*29*/].f_3), &(Global_103236.f_27831[Global_1628 /*29*/].f_7), "CELL_219", &(Global_103236.f_27831[Global_1628 /*29*/].f_3), 0);
			}
		}
		func_46(Global_14424, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
	}
...
void func_61()
{
	if (unk_0x591AF4C50B46E014())
	{
		iLocal_109 = unk_0x2AA4F22517A69BB6(unk_0x11ABC381A58DD5AB(), uLocal_95);
		iLocal_110 = unk_0x2AA4F22517A69BB6(unk_0x11ABC381A58DD5AB(), uLocal_98);
	}
	else
	{
...
void func_63()
{
	...
	if (unk_0x822F3797A8B64786())
	{
		...
		else if (func_66(Global_2503090.f_20))
		{
...
void func_67()
{
	...
	while (iLocal_92 < Global_15741)
	{
		...
		while (iVar2 < 70 && iLocal_29 == 0)
		{
			...
			if (unk_0x9418F0AE636D9770(&cLocal_38))
			{
				StringCopy(&cLocal_50, unk_0x91D2F083AE17E209(&cLocal_38), 64);
				...
				if (unk_0x9418F0AE636D9770(&(Global_14613[iVar2 /*6*/])))
				{
					if (unk_0x35302CD5A5D37EED(&(Global_14613[iVar2 /*6*/]), &(Global_15364.f_187[iLocal_92 /*6*/])))
					{
						if (iVar3 > 36 || iVar4 > 36)
						{
						}
						unk_0xAF93021C28541B11(iVar3, &cLocal_50, &(Global_14613[iVar2 /*6*/]), iVar4, uVar5, 0, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
					}
				}
				iVar1 = (iVar1 + iVar0);
			}
			else if (unk_0x9418F0AE636D9770(&cLocal_44))
			{
				StringCopy(&cLocal_50, unk_0x91D2F083AE17E209(&cLocal_44), 64);
				iVar3 = func_81(0);
				iVar4 = func_80(0);
				uVar5 = func_78(0);
				uLocal_82 = func_77();
				...
				uVar10 = func_69(0);
				uVar11 = func_68(0);
				unk_0xAF93021C28541B11(iVar3, &cLocal_50, &(Global_15364.f_6[iLocal_92 /*6*/]), iVar4, uVar5, 1, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
	...
	if (Global_15751 == 0)
	{
		unk_0x5D9DAEAA245C2BFF(uLocal_83);
		unk_0x039CB58173301057(uLocal_84);
		unk_0x72DC42F8995A352D(Global_15364.f_368, Global_15364.f_369, Global_15364.f_370, uLocal_82);
		Global_15745 = 4;
	}
}
...
int func_68(int iParam0)
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_85), iParam0 * 7 + 6, iParam0 * 7 + 7);
	if (unk_0x35302CD5A5D37EED(uVar0, "0"))
	{
		return 0;
	}
	return 1;
...
int func_69(int iParam0)
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_85), iParam0 * 7 + 5, iParam0 * 7 + 6);
	if (unk_0x35302CD5A5D37EED(uVar0, "0"))
	{
		return 0;
	}
...
int func_70(int iParam0)
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_85), iParam0 * 7 + 4, iParam0 * 7 + 5);
	if (unk_0x35302CD5A5D37EED(uVar0, "0"))
	{
		return 0;
	}
...
int func_71(int iParam0)
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_85), iParam0 * 7 + 3, iParam0 * 7 + 4);
	if (unk_0x35302CD5A5D37EED(uVar0, "0"))
	{
		return 1;
	}
	if (unk_0x35302CD5A5D37EED(uVar0, "1"))
	{
		return 1;
	}
	if (unk_0x35302CD5A5D37EED(uVar0, "2"))
	{
		return 2;
	}
	if (unk_0x35302CD5A5D37EED(uVar0, "3"))
	{
		return 3;
	}
	if (unk_0x35302CD5A5D37EED(uVar0, "4"))
	{
		return 0;
	}
	return 0;
...
int func_72(int iParam0)
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_85), iParam0 * 7 + 2, iParam0 * 7 + 3);
	if (unk_0x35302CD5A5D37EED(uVar0, "0"))
	{
		return 0;
	}
...
int func_73(int iParam0)
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_85), iParam0 * 7 + 1, iParam0 * 7 + 2);
	if (unk_0x35302CD5A5D37EED(uVar0, "0"))
	{
		return 0;
	}
...
int func_74(int iParam0)
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_85), iParam0 * 7, iParam0 * 7 + 1);
	if (unk_0x35302CD5A5D37EED(uVar0, "0"))
	{
		return 0;
	}
...
int func_75()
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_73), 2, 3);
	if (unk_0x35302CD5A5D37EED(uVar0, "0"))
	{
		return 0;
	}
...
int func_76()
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_73), 1, 2);
	if (unk_0x35302CD5A5D37EED(uVar0, "0"))
	{
		return 0;
	}
...
int func_77()
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_73), 0, 1);
	if (unk_0x35302CD5A5D37EED(uVar0, "0"))
	{
		return 0;
	}
...
int func_78(int iParam0)
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_66), iParam0 * 3 + 2, iParam0 * 3 + 3);
...
int func_79(var uParam0)
{
	...
	if (unk_0x35302CD5A5D37EED(uParam0, "1"))
	{
		return 1;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "2"))
	{
		return 2;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "3"))
	{
		return 3;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "4"))
	{
		return 4;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "5"))
	{
		return 5;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "6"))
	{
		return 6;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "7"))
	{
		return 7;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "8"))
	{
		return 8;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "9"))
	{
		return 9;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "A"))
	{
		return 10;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "B"))
	{
		return 11;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "C"))
	{
		return 12;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "D"))
	{
		return 13;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "E"))
	{
		return 14;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "F"))
	{
		return 15;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "G"))
	{
		return 16;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "H"))
	{
		return 17;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "I"))
	{
		return 18;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "J"))
	{
		return 19;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "K"))
	{
		return 20;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "L"))
	{
		return 21;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "M"))
	{
		return 22;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "N"))
	{
		return 23;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "O"))
	{
		return 24;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "P"))
	{
		return 25;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "Q"))
	{
		return 26;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "R"))
	{
		return 27;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "S"))
	{
		return 28;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "T"))
	{
		return 29;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "U"))
	{
		return 30;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "V"))
	{
		return 31;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "W"))
	{
		return 32;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "X"))
	{
		return 33;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "Y"))
	{
		return 34;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "Z"))
	{
		return 35;
	}
	if (unk_0x35302CD5A5D37EED(uParam0, "z"))
...
int func_80(int iParam0)
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_66), iParam0 * 3 + 1, iParam0 * 3 + 2);
	return func_79(uVar0);
}
...
int func_81(int iParam0)
{
	...
	uVar0 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_66), iParam0 * 3, iParam0 * 3 + 1);
	return func_79(uVar0);
}
...
void func_82()
{
	...
	if (unk_0x9418F0AE636D9770(&cLocal_85))
	{
		sLocal_91 = unk_0x91D2F083AE17E209(&cLocal_85);
		if (unk_0x47988E04F8E2F0AD(sLocal_91))
		{
		}
	}
}
...
void func_83()
{
	...
	if (unk_0x9418F0AE636D9770(&cLocal_73))
	{
		sLocal_79 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_73), 0, 1);
		if (unk_0x47988E04F8E2F0AD(sLocal_79))
		{
		}
		sLocal_80 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_73), 1, 2);
		if (unk_0x47988E04F8E2F0AD(sLocal_80))
		{
		}
		sLocal_81 = unk_0xB016D23B4D241322(unk_0x91D2F083AE17E209(&cLocal_73), 2, 3);
		if (unk_0x47988E04F8E2F0AD(sLocal_81))
		{
		}
	}
}
...
void func_84()
{
	...
	if (unk_0x9418F0AE636D9770(&cLocal_66))
	{
		sLocal_72 = unk_0x91D2F083AE17E209(&cLocal_66);
		if (unk_0x47988E04F8E2F0AD(sLocal_72))
		{
		}
	}
}
...
void func_85()
{
	...
	if (Global_16737)
	{
		unk_0x83B2DF19DE1FF395(Global_15364.f_368, Global_15364.f_369, Global_15364.f_370, uLocal_82);
...
void func_86()
{
	...
	iLocal_31 = 0;
	iLocal_33 = 0;
	if (unk_0x8B6A82A35983BFC8(&Global_15821))
	{
		if (unk_0x35302CD5A5D37EED(&Global_15821, "CT_AUD"))
		{
			Global_2621442 = 1;
		}
		iVar13 = 0;
		if (unk_0x429A1F8C699BEE23() || unk_0x97FFE0491AC179A2())
		{
			if (Global_1573338 == 1)
			{
				iVar13 = 1;
		...
		if (((Global_15747 < 5 || Global_15747 == 10) || Global_15747 == 12) || Global_15747 == 13)
		{
			...
			{
				unk_0xC9173FA08E7D8227(&Global_15821, 7);
				while (!unk_0x44FB58EFDA8731B7(7))
				{
					unk_0x4EDE34FBADD967A6(0);
				}
			}
			...
			{
				unk_0x324D82949BFAAC9B(&Global_15821, 15);
		...
		{
			unk_0xC9173FA08E7D8227(&Global_15821, 6);
			while (!unk_0x44FB58EFDA8731B7(6))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
		}
		...
		{
			unk_0x324D82949BFAAC9B(&Global_15821, 14);
			while (!unk_0x44FB58EFDA8731B7(14))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
		}
	...
	while (iVar2 < 70 && iLocal_29 == 0)
	{
		...
		if (unk_0x9418F0AE636D9770(&cLocal_38))
		{
			...
			if (unk_0x9418F0AE636D9770(&(Global_14613[iVar2 /*6*/])))
			{
				...
				else if (unk_0x35302CD5A5D37EED(&(Global_14613[iVar2 /*6*/]), &Global_16743))
				{
					if (iVar3 > 36 || iVar4 > 36)
					{
					}
			...
			{
				unk_0xAF93021C28541B11(iVar3, &cLocal_50, &cLocal_50, iVar4, uVar5, 0, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
			}
			iVar1 = (iVar1 + iVar0);
		}
		else
		{
			if (unk_0x9418F0AE636D9770(&cLocal_44))
			{
				StringCopy(&cLocal_50, unk_0x91D2F083AE17E209(&cLocal_44), 64);
				iVar3 = func_81(iVar2);
				iVar4 = func_80(iVar2);
				...
				uVar10 = func_69(iVar2);
				uVar11 = func_68(iVar2);
				unk_0xAF93021C28541B11(iVar3, &cLocal_50, &Global_15364, iVar4, uVar5, 1, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
			}
			iLocal_29 = 1;
		}
		iVar2++;
...
void func_87()
{
	...
	while (iVar0 <= 15)
	{
		...
		{
			if (unk_0x2137828D03306CAF(Global_15034[iVar0 /*10*/]) || Global_15034[iVar0 /*10*/] == 0)
			{
				unk_0x482C2672A12EDD62(iVar0, Global_15034[iVar0 /*10*/], &(Global_15034[iVar0 /*10*/].f_1));
			}
			if (Global_15034.f_161 == iVar0)
			{
				...
				{
					unk_0x4EDE34FBADD967A6(0);
					unk_0x910855BC5B588D74(Global_15034.f_161, Global_15034.f_162);
				}
			}
		}
		iVar0++;
	...
	if (Global_2600873 == 1)
	{
		...
		while (iVar0 <= 19)
		{
			if (Global_2600692[iVar0 /*9*/].f_7 == 1)
			{
				if (unk_0x2137828D03306CAF(Global_2600692[iVar0 /*9*/]) || Global_2600692[iVar0 /*9*/] == 0)
				{
					unk_0x482C2672A12EDD62(Global_2600692[iVar0 /*9*/].f_8, Global_2600692[iVar0 /*9*/], &(Global_2600692[iVar0 /*9*/].f_1));
				}
			}
			iVar0++;
		}
...
int func_91()
{
	if ((((((((((((((((((((((((((((((((((((unk_0x35302CD5A5D37EED(&Global_15821, "APCUTAU") || unk_0x35302CD5A5D37EED(&Global_15821, "APAIR")) || unk_0x35302CD5A5D37EED(&Global_15821, "APCALAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "PBPAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "EXPOWAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "EXCALAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "EXCPAAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "EXHELAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "BPLESAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "BPMALAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "LOWREAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMTRAAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMAMPAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMWEDAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMBUSAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMROCAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMFLIAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMPAAUD")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMDUNAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMRUIAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMMECAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMARMAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMBLZAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMPHAAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMTECAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMVOLAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "IMWASAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "GNRCAUD")) || unk_0x35302CD5A5D37EED(&Global_15821, "GNRWEAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "GRAPCAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "GRHALAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "GRDUNAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "GRMOCAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "GROPPAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "GROP2AU")) || unk_0x35302CD5A5D37EED(&Global_15821, "GRTAMAU")) || unk_0x35302CD5A5D37EED(&Global_15821, "GRTRSAU"))
	{
		return 1;
	}
	return 0;
...
void func_96()
{
	while (Global_14426 == 1 && unk_0x09952BA662A7629B(joaat("cellphone_flashhand")) > 0)
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	Global_14426 = 0;
	if (unk_0xAA4F14DA15DB0B51(Global_2313, 20))
	{
		unk_0xF6082E2ADA1C795B(&Global_2314, 1);
	}
	else
	{
		unk_0x507FE690B1271947(&Global_2314, 1);
	...
	if (Global_15755)
	{
		if (Global_16762 == 0)
		{
			...
			{
				iLocal_34 = 5000;
				unk_0xCFE0AEB4EF0935F3(Global_15364.f_368, Global_15364.f_369);
			}
			else
			{
				iLocal_34 = 0;
	...
	else
	{
		...
		if (Global_15755 == 0)
		{
			...
			if (Global_16762 == 0)
			{
				...
				Global_14612 = 1;
				unk_0x5AE11BC36633DE4E(0);
				unk_0xF6082E2ADA1C795B(&Global_2313, 27);
				unk_0xC1B1E9A034A63A62(0);
			}
			else
			{
			...
			if (unk_0x591AF4C50B46E014())
			{
				uLocal_101 = unk_0x11ABC381A58DD5AB();
			}
			else
			{
			...
			while (Global_14443.f_1 != 9 && Global_14426 == 0)
			{
				...
				if (unk_0x591AF4C50B46E014())
				{
					iLocal_108 = unk_0x2AA4F22517A69BB6(unk_0x11ABC381A58DD5AB(), uLocal_101);
				}
				else
				{
					iLocal_100 = unk_0x3732B96D7A1859B4();
		...
		else
		{
			...
			if (!unk_0xA9A04898798AE9E6(unk_0x2A5EB8B0FE590B91(), 0))
			{
				...
				{
					unk_0x507FE690B1271947(&Global_2314, 21);
				}
			}
			if (Global_15796 == 0)
			{
			...
			if (unk_0x591AF4C50B46E014())
			{
				uLocal_95 = unk_0x11ABC381A58DD5AB();
				uLocal_98 = unk_0x11ABC381A58DD5AB();
			}
			else
			{
				iLocal_93 = unk_0x3732B96D7A1859B4();
				iLocal_96 = unk_0x3732B96D7A1859B4();
			}
		}
	}
}
...
float func_99(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, bool bParam13)
{
	...
	fVar3 = func_101((unk_0xBBDA792448DB5A89((unk_0x3732B96D7A1859B4() - iLocal_18)) / fParam12), 0f, 1f);
	if (fVar3 < 1f)
	{
		fVar4 = fVar3;
		if (bParam13)
