...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (unk_0xA921AA820C25702F(Global_2264, 1))
		{
			if (!unk_0xA921AA820C25702F(Global_2263, 20))
			{
				if (unk_0x7497D2CE2C30D24C())
				{
					...
					unk_0xE80492A9AC099A93(&Global_2264, 1);
				}
			}
		}
		if (unk_0xA921AA820C25702F(Global_14558, 0))
		{
			if (!func_104())
			{
				if (!unk_0xA921AA820C25702F(Global_14558, 1))
				{
					unk_0x933D6A9EEC1BACD0(&Global_14558, 1);
					if (unk_0x10FAB35428CCC9D7())
					{
						iLocal_105 = unk_0x7A5487FE9FAA6B48();
					}
					else
					{
				...
				if (unk_0x10FAB35428CCC9D7())
				{
					iLocal_107 = unk_0xA2C6FC031D46FFF0(unk_0x7A5487FE9FAA6B48(), iLocal_105);
				}
				else
				{
...
void func_2()
{
	...
	else if (unk_0xA921AA820C25702F(Global_2263, 11))
	{
		func_3();
	}
	Global_15698 = 0;
	...
	unk_0xE80492A9AC099A93(&Global_2264, 23);
	unk_0xE80492A9AC099A93(&Global_2265, 0);
	unk_0xE80492A9AC099A93(&Global_2264, 9);
	unk_0xE80492A9AC099A93(&Global_2264, 31);
	unk_0xE80492A9AC099A93(&Global_2264, 17);
	unk_0xE80492A9AC099A93(&Global_2265, 5);
	Global_16676 = 0;
	Global_16675 = 0;
	...
	else
	{
		Global_15692 = 0;
		Global_16703 = 0;
		Global_16714 = unk_0x9CD27B0045628463();
	}
}
...
void func_7()
{
	...
	if (unk_0x7497D2CE2C30D24C() == 0 && Global_15705 == 0)
	{
		if (Global_15745 == 1)
		{
			unk_0x933D6A9EEC1BACD0(&Global_2264, 23);
		}
		else
		{
			unk_0xE80492A9AC099A93(&Global_2264, 23);
				...
				else
				{
					if (iLocal_29 == 0)
					{
						...
						if (Global_15747)
						{
							iLocal_29 = 1;
							Global_16707 = 1;
							func_105(Global_14374, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(4), -1f, -1f, &Global_15834, &(Global_97173.f_29699[Global_1578 /*29*/].f_7), &(Global_97173.f_29699[Global_1578 /*29*/].f_3), &(Global_97173.f_29699[Global_1578 /*29*/].f_3), 0);
					...
					if (func_45(2, Global_14363, 0) || unk_0xA921AA820C25702F(Global_2263, 24))
					{
						func_43();
						Global_14319 = 0.19f;
						Global_15745 = 0;
			...
			while (Global_15745)
			{
				...
				else
				{
					...
					if (func_45(2, Global_14362, 0))
					{
						...
						iLocal_235 = unk_0xC50AA39A577AF886();
						while (!unk_0x768FF8961BA904D6(iLocal_235))
						{
							unk_0x4EDE34FBADD967A6(0);
						}
						iVar2 = unk_0x2DE7EFA66B906036(iLocal_235);
						switch (iVar2)
						{
							case 0:
								Global_15311 = { Global_15822 };
...
void func_8()
{
	...
	switch (Global_14393.f_1)
	{
		...
		case 9:
			...
			{
				func_10();
				func_46(Global_14374, "SET_THEME", unk_0xBBDA792448DB5A89(Global_97173.f_12272[Global_14393 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_15705)
				{
				...
				{
					func_105(Global_14374, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(2), -1f, -1f, &(Global_97173.f_29699[Global_1578 /*29*/].f_3), &(Global_97173.f_29699[Global_1578 /*29*/].f_7), "CELL_217", &(Global_97173.f_29699[Global_1578 /*29*/].f_3), 0);
				}
				func_46(Global_14374, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_15692 == 4 || Global_15692 == 3)
			{
				...
				else
				{
					...
					if (Global_97173.f_29699[Global_1578 /*29*/].f_24[Global_14393] == 0)
					{
						...
						func_105(Global_14374, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_97[Global_1578 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_46(Global_14374, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_105(Global_14374, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_97173.f_29699[Global_1578 /*29*/].f_3), &(Global_97173.f_29699[Global_1578 /*29*/].f_7), &cVar0, &(Global_97173.f_29699[Global_1578 /*29*/].f_3), 0);
					}
				}
				func_46(Global_14374, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
...
void func_13()
{
	...
	switch (Global_14395)
	{
		...
		case 6:
			if (unk_0xA921AA820C25702F(Global_2264, 5))
			{
				Global_14395 = 6;
...
void func_14()
{
	...
	if (iLocal_234 == 0)
	{
		if (func_45(2, Global_14369, 0) || unk_0x580417101DDB492F(2, 181))
		{
			func_18();
			iLocal_234 = 1;
			unk_0xC1B1E9A034A63A62(0);
		}
		if (func_45(2, Global_14370, 0) || unk_0x580417101DDB492F(2, 180))
		{
			func_15();
			iLocal_234 = 1;
			unk_0xC1B1E9A034A63A62(0);
...
void func_29()
{
	...
	if (unk_0x7239B21A38F536BA(unk_0xD80958FC74E988A6()))
	{
		if (func_32(Global_97173.f_1729.f_539.f_3213) != unk_0x9F47B058362C84B5(unk_0xD80958FC74E988A6()))
		{
			...
			if (func_30(iVar0) && (!func_12(14) || Global_96126))
			{
...
int func_49()
{
	if (unk_0x10FAB35428CCC9D7())
	{
		iLocal_107 = unk_0xA2C6FC031D46FFF0(unk_0x7A5487FE9FAA6B48(), iLocal_106);
	}
	else
	{
...
void func_53()
{
	if (func_45(2, Global_14370, 0))
	{
		if (Global_16703 == 0)
		{
			if (Global_15698)
			{
				if (unk_0xA921AA820C25702F(Global_2264, 17))
				{
				}
				else
				{
...
void func_54()
{
	...
	if (!unk_0x84A2DD9AC37C35C1(unk_0xD80958FC74E988A6()))
	{
		if (func_55() && unk_0x60DFD0691A170B88(unk_0xD80958FC74E988A6(), false))
		{
			iVar1 = 1;
		}
	}
...
void func_57()
{
			...
			if (unk_0x5E9564D8246B909A(unk_0x4F8644AF03D0E0D6()))
			{
				if (unk_0x49C32D60007AFA47(unk_0x4F8644AF03D0E0D6()))
				{
					...
					else
					{
						...
						if (!Global_15703)
						{
							unk_0x933D6A9EEC1BACD0(&Global_2264, 5);
						}
						func_13();
						Global_14393.f_1 = Global_14395;
						func_8();
	...
	else
	{
		...
		if (!Global_15705)
		{
			if (Global_16709 == 0)
			{
				if (!unk_0xA921AA820C25702F(Global_2265, 5))
				{
					unk_0x23641AFE870AF385();
				}
				unk_0xE80492A9AC099A93(&Global_2265, 5);
			...
			{
				unk_0x252E5F915EABB675(Global_15311.f_368, Global_15311.f_369);
			}
		}
		func_58();
	}
...
void func_58()
{
	if (unk_0x10FAB35428CCC9D7())
	{
		iLocal_106 = unk_0x7A5487FE9FAA6B48();
	}
	else
	{
...
void func_60()
{
	if (unk_0x85F01B8D5B90570E(Global_14374))
	{
		if (!Global_15700)
		{
			...
			{
				func_105(Global_14374, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_97173.f_29699[Global_1578 /*29*/].f_3), &(Global_97173.f_29699[Global_1578 /*29*/].f_7), "CELL_219", &(Global_97173.f_29699[Global_1578 /*29*/].f_3), 0);
			}
		}
		func_46(Global_14374, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
	}
...
void func_61()
{
	if (unk_0x10FAB35428CCC9D7())
	{
		iLocal_108 = unk_0xA2C6FC031D46FFF0(unk_0x7A5487FE9FAA6B48(), iLocal_94);
		iLocal_109 = unk_0xA2C6FC031D46FFF0(unk_0x7A5487FE9FAA6B48(), iLocal_97);
	}
	else
	{
...
void func_63()
{
	...
	if (unk_0x1077788E268557C2())
	{
		...
		else if (func_66(Global_2450664.f_20))
		{
...
void func_67()
{
	...
	while (iLocal_91 < Global_15688)
	{
		...
		while (iVar2 < 70 && iLocal_28 == 0)
		{
			...
			if (unk_0xAC09CA973C564252(&cLocal_37))
			{
				StringCopy(&cLocal_49, unk_0x7B5280EBA9840C72(&cLocal_37), 64);
				...
				bLocal_82 = func_76();
				bLocal_83 = func_75();
				bVar6 = func_74(iVar13);
				bVar7 = func_73(iVar13);
				bVar8 = func_72(iVar13);
				iVar12 = func_71(iVar13);
				bVar9 = func_70(iVar13);
				bVar10 = func_69(iVar13);
				bVar11 = func_68(iVar13);
				if (unk_0xAC09CA973C564252(&(Global_14560[iVar2 /*6*/])))
				{
					if (unk_0x0C515FAB3FF9EA92(&(Global_14560[iVar2 /*6*/]), &(Global_15311.f_187[iLocal_91 /*6*/])))
					{
						if (iVar3 > 36 || iVar4 > 36)
						{
						}
						unk_0xC5EF963405593646(iVar3, &cLocal_49, &(Global_14560[iVar2 /*6*/]), iVar4, iVar5, false, bVar6, bVar7, bVar8, iVar12, bVar9, bVar10, bVar11);
					}
				}
				iVar1 = (iVar1 + iVar0);
			}
			else if (unk_0xAC09CA973C564252(&cLocal_43))
			{
				StringCopy(&cLocal_49, unk_0x7B5280EBA9840C72(&cLocal_43), 64);
				iVar3 = func_81(0);
				iVar4 = func_80(0);
				iVar5 = func_78(0);
				bLocal_81 = func_77();
				...
				bVar10 = func_69(0);
				bVar11 = func_68(0);
				unk_0xC5EF963405593646(iVar3, &cLocal_49, &(Global_15311.f_6[iLocal_91 /*6*/]), iVar4, iVar5, true, bVar6, bVar7, bVar8, iVar12, bVar9, bVar10, bVar11);
	...
	if (Global_15698 == 0)
	{
		unk_0x0B568201DD99F0EB(bLocal_82);
		unk_0x61631F5DF50D1C34(bLocal_83);
		unk_0x6B17C62C9635D2DC(Global_15311.f_368, Global_15311.f_369, Global_15311.f_370, bLocal_81);
		Global_15692 = 4;
	}
}
...
int func_68(int iParam0)
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_84), iParam0 * 7 + 6, iParam0 * 7 + 7);
...
int func_69(int iParam0)
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_84), iParam0 * 7 + 5, iParam0 * 7 + 6);
	if (unk_0x0C515FAB3FF9EA92(sVar0, "0"))
	{
		return 0;
	}
...
int func_70(int iParam0)
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_84), iParam0 * 7 + 4, iParam0 * 7 + 5);
	if (unk_0x0C515FAB3FF9EA92(sVar0, "0"))
	{
		return 0;
	}
...
int func_71(int iParam0)
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_84), iParam0 * 7 + 3, iParam0 * 7 + 4);
	if (unk_0x0C515FAB3FF9EA92(sVar0, "0"))
	{
		return 1;
	}
...
int func_72(int iParam0)
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_84), iParam0 * 7 + 2, iParam0 * 7 + 3);
	if (unk_0x0C515FAB3FF9EA92(sVar0, "0"))
	{
		return 0;
	}
...
int func_73(int iParam0)
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_84), iParam0 * 7 + 1, iParam0 * 7 + 2);
	if (unk_0x0C515FAB3FF9EA92(sVar0, "0"))
	{
		return 0;
	}
...
int func_74(int iParam0)
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_84), iParam0 * 7, iParam0 * 7 + 1);
	if (unk_0x0C515FAB3FF9EA92(sVar0, "0"))
	{
		return 0;
	}
...
int func_75()
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_72), 2, 3);
	if (unk_0x0C515FAB3FF9EA92(sVar0, "0"))
	{
		return 0;
	}
...
int func_76()
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_72), 1, 2);
	if (unk_0x0C515FAB3FF9EA92(sVar0, "0"))
	{
		return 0;
	}
...
int func_77()
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_72), 0, 1);
	if (unk_0x0C515FAB3FF9EA92(sVar0, "0"))
	{
		return 0;
	}
...
int func_78(int iParam0)
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_65), iParam0 * 3 + 2, iParam0 * 3 + 3);
...
int func_80(int iParam0)
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_65), iParam0 * 3 + 1, iParam0 * 3 + 2);
	return func_79(sVar0);
}
...
int func_81(int iParam0)
{
	...
	sVar0 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_65), iParam0 * 3, iParam0 * 3 + 1);
	return func_79(sVar0);
}
...
void func_82()
{
	...
	if (unk_0xAC09CA973C564252(&cLocal_84))
	{
		sLocal_90 = unk_0x7B5280EBA9840C72(&cLocal_84);
		if (unk_0xF22B6C47C6EAB066(sLocal_90))
		{
		}
	}
}
...
void func_83()
{
	...
	if (unk_0xAC09CA973C564252(&cLocal_72))
	{
		sLocal_78 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_72), 0, 1);
		if (unk_0xF22B6C47C6EAB066(sLocal_78))
		{
		}
		sLocal_79 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_72), 1, 2);
		if (unk_0xF22B6C47C6EAB066(sLocal_79))
		{
		}
		sLocal_80 = unk_0x169BD9382084C8C0(unk_0x7B5280EBA9840C72(&cLocal_72), 2, 3);
		if (unk_0xF22B6C47C6EAB066(sLocal_80))
		{
		}
	}
}
...
void func_84()
{
	...
	if (unk_0xAC09CA973C564252(&cLocal_65))
	{
		sLocal_71 = unk_0x7B5280EBA9840C72(&cLocal_65);
		if (unk_0xF22B6C47C6EAB066(sLocal_71))
		{
		}
	}
}
...
void func_85()
{
	...
	if (Global_16684)
	{
		unk_0x3B3CAD6166916D87(Global_15311.f_368, Global_15311.f_369, Global_15311.f_370, bLocal_81);
...
void func_86()
{
	...
	iLocal_30 = 0;
	iLocal_32 = 0;
	if (unk_0x1C7302E725259789(&Global_15768))
	{
		if (unk_0x0C515FAB3FF9EA92(&Global_15768, "CT_AUD"))
		{
			Global_2621442 = 1;
		}
		iVar13 = 0;
		if (unk_0xA72BC0B675B1519E() || unk_0x4D982ADB1978442D())
		{
			if (Global_1572928 == 1)
			{
				iVar13 = 1;
		...
		if (((Global_15694 < 5 || Global_15694 == 10) || Global_15694 == 12) || Global_15694 == 13)
		{
			...
			{
				unk_0x71A78003C8E71424(&Global_15768, 7);
			...
			{
				unk_0x6009F9F1AE90D8A6(&Global_15768, 14);
		...
		{
			unk_0x71A78003C8E71424(&Global_15768, 6);
		...
		{
			unk_0x6009F9F1AE90D8A6(&Global_15768, 13);
			while (!unk_0x02245FE4BED318B8(13))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
		}
	...
	while (iVar2 < 70 && iLocal_28 == 0)
	{
		...
		if (unk_0xAC09CA973C564252(&cLocal_37))
		{
			...
			bVar9 = func_70(iVar2);
			bVar10 = func_69(iVar2);
			bVar11 = func_68(iVar2);
			if (unk_0xAC09CA973C564252(&(Global_14560[iVar2 /*6*/])))
			{
				...
				else if (unk_0x0C515FAB3FF9EA92(&(Global_14560[iVar2 /*6*/]), &Global_16690))
				{
					if (iVar3 > 36 || iVar4 > 36)
					{
					}
			...
			{
				unk_0xC5EF963405593646(iVar3, &cLocal_49, &cLocal_49, iVar4, iVar5, false, bVar6, bVar7, bVar8, iVar12, bVar9, bVar10, bVar11);
			}
			iVar1 = (iVar1 + iVar0);
		}
		else
		{
			if (unk_0xAC09CA973C564252(&cLocal_43))
			{
				StringCopy(&cLocal_49, unk_0x7B5280EBA9840C72(&cLocal_43), 64);
				iVar3 = func_81(iVar2);
				iVar4 = func_80(iVar2);
				...
				bVar10 = func_69(iVar2);
				bVar11 = func_68(iVar2);
				unk_0xC5EF963405593646(iVar3, &cLocal_49, &Global_15311, iVar4, iVar5, true, bVar6, bVar7, bVar8, iVar12, bVar9, bVar10, bVar11);
			}
			iLocal_28 = 1;
		}
		iVar2++;
...
void func_87()
{
	...
	while (iVar0 <= 15)
	{
		...
		{
			if (unk_0x7239B21A38F536BA(Global_14981[iVar0 /*10*/]) || Global_14981[iVar0 /*10*/] == 0)
			{
				unk_0x95D9F4BC443956E7(iVar0, Global_14981[iVar0 /*10*/], &(Global_14981[iVar0 /*10*/].f_1));
			}
			if (Global_14981.f_161 == iVar0)
			{
				...
				{
					unk_0x4EDE34FBADD967A6(0);
					unk_0x33E3C6C6F2F0B506(Global_14981.f_161, Global_14981.f_162);
				}
			}
		}
		iVar0++;
	...
	if (Global_2543670 == 1)
	{
		...
		while (iVar0 <= 19)
		{
			if (Global_2543489[iVar0 /*9*/].f_7 == 1)
			{
				if (unk_0x7239B21A38F536BA(Global_2543489[iVar0 /*9*/]) || Global_2543489[iVar0 /*9*/] == 0)
				{
					unk_0x95D9F4BC443956E7(Global_2543489[iVar0 /*9*/].f_8, Global_2543489[iVar0 /*9*/], &(Global_2543489[iVar0 /*9*/].f_1));
				}
			}
			iVar0++;
		}
...
void func_95()
{
	while (Global_14376 == 1 && unk_0x2C83A9DA6BFFC4F9(joaat("cellphone_flashhand")) > 0)
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	Global_14376 = 0;
	if (unk_0xA921AA820C25702F(Global_2263, 20))
	{
		unk_0x933D6A9EEC1BACD0(&Global_2264, 1);
	}
	else
	{
		unk_0xE80492A9AC099A93(&Global_2264, 1);
	...
	if (Global_15702)
	{
		if (Global_16709 == 0)
		{
			...
			{
				iLocal_33 = 5000;
				unk_0x6004BCB0E226AAEA(Global_15311.f_368, Global_15311.f_369);
			}
			else
			{
				iLocal_33 = 0;
	...
	else
	{
		...
		if (Global_15702 == 0)
		{
			...
			if (Global_16709 == 0)
			{
				...
				Global_14559 = 1;
				unk_0x5AE11BC36633DE4E(0);
				unk_0x933D6A9EEC1BACD0(&Global_2263, 27);
				unk_0xC1B1E9A034A63A62(0);
			}
			else
			{
			...
			if (unk_0x10FAB35428CCC9D7())
			{
				iLocal_100 = unk_0x7A5487FE9FAA6B48();
			}
			else
			{
			...
			while (Global_14393.f_1 != 9 && Global_14376 == 0)
			{
				...
				if (unk_0x10FAB35428CCC9D7())
				{
					iLocal_107 = unk_0xA2C6FC031D46FFF0(unk_0x7A5487FE9FAA6B48(), iLocal_100);
				}
				else
				{
		...
		else
		{
			...
			if (unk_0x10FAB35428CCC9D7())
			{
				iLocal_94 = unk_0x7A5487FE9FAA6B48();
				iLocal_97 = unk_0x7A5487FE9FAA6B48();
			}
			else
			{
...
float func_98(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, bool bParam13)
{
	...
	fVar3 = func_100((unk_0xBBDA792448DB5A89((unk_0x9CD27B0045628463() - iLocal_17)) / fParam12), 0f, 1f);
	if (fVar3 < 1f)
	{
		fVar4 = fVar3;
		if (bParam13)
...
void func_105(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)
{
	unk_0xF6E48914C7A8694E(iParam0, sParam1);
	unk_0xC3D0841A0CC546A6(unk_0xF2DB717A73826179(fParam2));
	if (fParam3 != -1f)
