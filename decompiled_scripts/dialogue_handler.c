...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (unk_0xB56FEBC510E7E9DE(Global_2284, 1))
		{
			if (!unk_0xB56FEBC510E7E9DE(Global_2283, 20))
			{
				if (unk_0xEA9C2A206A86B744())
				{
					...
					unk_0xA5F70A8B83BDFA49(&Global_2284, 1);
				}
			}
		}
		if (unk_0xB56FEBC510E7E9DE(Global_14578, 0))
		{
			if (!func_104())
			{
				if (!unk_0xB56FEBC510E7E9DE(Global_14578, 1))
				{
					unk_0x573691DB812DC8AA(&Global_14578, 1);
					if (unk_0x4C779B19E6DDCDA2())
					{
						uLocal_106 = unk_0xE23D71F521207E8D();
					}
					else
					{
				...
				if (unk_0x4C779B19E6DDCDA2())
				{
					iLocal_108 = unk_0xC552B3A8E47271B7(unk_0xE23D71F521207E8D(), uLocal_106);
				}
				else
				{
					iLocal_103 = unk_0x3EAC9995EC220C5A();
...
void func_2()
{
	...
	else if (unk_0xB56FEBC510E7E9DE(Global_2283, 11))
	{
		func_3();
	}
	Global_15718 = 0;
	...
	unk_0xA5F70A8B83BDFA49(&Global_2284, 23);
	unk_0xA5F70A8B83BDFA49(&Global_2285, 0);
	unk_0xA5F70A8B83BDFA49(&Global_2284, 9);
	unk_0xA5F70A8B83BDFA49(&Global_2284, 31);
	unk_0xA5F70A8B83BDFA49(&Global_2284, 17);
	unk_0xA5F70A8B83BDFA49(&Global_2285, 5);
	Global_16696 = 0;
	Global_16695 = 0;
	...
	else
	{
		Global_15712 = 0;
		Global_16723 = 0;
		Global_16734 = unk_0x3EAC9995EC220C5A();
	}
}
	...
	if (!Global_69317)
	{
		if (!unk_0x1E80C02AC16B6622(unk_0x77F050A399DB77ED()))
		{
			if (unk_0xB56FEBC510E7E9DE(Global_2283, 11))
			{
				if (!Global_14356)
				{
					unk_0xFDDC8EE655FF7D0D(unk_0x77F050A399DB77ED(), 0, 1);
				}
				if (Global_69317)
				{
					unk_0x1706625EBCDDEBF9(unk_0x77F050A399DB77ED(), 244, 1);
					unk_0x1706625EBCDDEBF9(unk_0x77F050A399DB77ED(), 243, 1);
					unk_0x1706625EBCDDEBF9(unk_0x77F050A399DB77ED(), 242, 1);
				}
				unk_0xA5F70A8B83BDFA49(&Global_2283, 11);
			}
		}
	}
}
...
void func_5()
{
	...
	{
		iLocal_37 = unk_0x3EAC9995EC220C5A();
...
void func_7()
{
	...
	if (Global_15765 == 0)
	{
		if (!Global_15725)
		{
			if (!unk_0xB56FEBC510E7E9DE(Global_2284, 31))
			{
				if (!unk_0xB56FEBC510E7E9DE(Global_2284, 27))
				{
					if (func_49())
					{
						if (Global_14413.f_1 > 6)
						{
							unk_0x573691DB812DC8AA(&Global_2284, 24);
							unk_0x573691DB812DC8AA(&Global_2284, 27);
							unk_0xA5F70A8B83BDFA49(&Global_2284, 26);
							unk_0xA5F70A8B83BDFA49(&Global_2284, 25);
						}
					}
				}
			}
	...
	if (unk_0xEA9C2A206A86B744() == 0 && Global_15725 == 0)
	{
		if (Global_15765 == 1)
		{
			unk_0x573691DB812DC8AA(&Global_2284, 23);
		}
		else
		{
			unk_0xA5F70A8B83BDFA49(&Global_2284, 23);
				...
				else
				{
					if (iLocal_30 == 0)
					{
						...
						if (Global_15767)
						{
							iLocal_30 = 1;
							Global_16727 = 1;
							func_105(Global_14394, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(4), -1f, -1f, &Global_15854, &(Global_99250.f_32503[Global_1598 /*29*/].f_7), &(Global_99250.f_32503[Global_1598 /*29*/].f_3), &(Global_99250.f_32503[Global_1598 /*29*/].f_3), 0);
					...
					if (func_45(2, Global_14383, 0) || unk_0xB56FEBC510E7E9DE(Global_2283, 24))
					{
						func_43();
						Global_14339 = 0.19f;
						Global_15765 = 0;
			...
			while (Global_15765)
			{
				...
				else
				{
					...
					if (func_45(2, Global_14382, 0))
					{
						...
						uLocal_236 = unk_0xF284D8942965CE6A();
						while (!unk_0x8839C60883DD0C88(uLocal_236))
						{
							unk_0x4EDE34FBADD967A6(0);
						}
						iVar2 = unk_0xE4DE284FF929097F(uLocal_236);
						switch (iVar2)
						{
							case 0:
								Global_15331 = { Global_15842 };
...
void func_8()
{
	...
	switch (Global_14413.f_1)
	{
		...
		case 9:
			...
			{
				func_10();
				func_46(Global_14394, "SET_THEME", unk_0xBBDA792448DB5A89(Global_99250.f_12669[Global_14413 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_15725)
				{
				...
				{
					func_105(Global_14394, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(2), -1f, -1f, &(Global_99250.f_32503[Global_1598 /*29*/].f_3), &(Global_99250.f_32503[Global_1598 /*29*/].f_7), "CELL_217", &(Global_99250.f_32503[Global_1598 /*29*/].f_3), 0);
				}
				func_46(Global_14394, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_15712 == 4 || Global_15712 == 3)
			{
				...
				else
				{
					...
					{
						func_46(Global_14394, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_105(Global_14394, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_99250.f_32503[Global_1598 /*29*/].f_3), &(Global_99250.f_32503[Global_1598 /*29*/].f_7), &Var0, &(Global_99250.f_32503[Global_1598 /*29*/].f_3), 0);
					}
				}
				func_46(Global_14394, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
...
void func_13()
{
	...
	switch (Global_14415)
	{
		...
		case 6:
			if (unk_0xB56FEBC510E7E9DE(Global_2284, 5))
			{
				Global_14415 = 6;
				unk_0xA5F70A8B83BDFA49(&Global_2284, 5);
			}
			else
			{
				Global_14415 = 3;
...
void func_14()
{
	...
	if (iLocal_235 == 0)
	{
		if (func_45(2, Global_14389, 0) || unk_0x618071F6827C232E(2, 181))
		{
			func_18();
			iLocal_235 = 1;
			unk_0xC1B1E9A034A63A62(0);
		}
		if (func_45(2, Global_14390, 0) || unk_0x618071F6827C232E(2, 180))
		{
			func_15();
			iLocal_235 = 1;
			unk_0xC1B1E9A034A63A62(0);
...
void func_29()
{
	...
	if (unk_0x1F2158D615BC4B25(unk_0x77F050A399DB77ED()))
	{
		if (func_32(Global_99250.f_1754.f_539.f_3549) != unk_0xDF1398076E26B0E4(unk_0x77F050A399DB77ED()))
		{
			...
			if (func_30(iVar0) && (!func_12(14) || Global_98202))
			{
...
int func_49()
{
	if (unk_0x4C779B19E6DDCDA2())
	{
		iLocal_108 = unk_0xC552B3A8E47271B7(unk_0xE23D71F521207E8D(), uLocal_107);
	}
	else
	{
...
void func_53()
{
	if (func_45(2, Global_14390, 0))
	{
		if (Global_16723 == 0)
		{
			if (Global_15718)
			{
				if (unk_0xB56FEBC510E7E9DE(Global_2284, 17))
				{
				}
				else
				{
					unk_0x7676A1EFB681C325();
				}
			}
		}
	}
...
void func_54()
{
	...
	if (!unk_0x1E80C02AC16B6622(unk_0x77F050A399DB77ED()))
	{
		if (func_55() && unk_0x0B6380E19682EA99(unk_0x77F050A399DB77ED(), 0))
		{
			iVar1 = 1;
		}
	}
...
void func_56()
{
	...
	else if (!unk_0xEA9C2A206A86B744())
	{
		iLocal_32 = 0;
		unk_0xC9AB825AA4821BDA(0);
		Global_15712 = 6;
...
void func_57()
{
			...
			if (unk_0x6DF20EAB8093DF19(unk_0x8ACD527A7E574590()))
			{
				if (unk_0x116E9F29D23ADBBE(unk_0x8ACD527A7E574590()))
				{
					...
					else
					{
						...
						Global_15761 = 1;
						Global_15712 = 6;
						unk_0xA5F70A8B83BDFA49(&Global_2283, 27);
						if (!Global_15723)
						{
							unk_0x573691DB812DC8AA(&Global_2284, 5);
						}
						func_13();
						Global_14413.f_1 = Global_14415;
						func_8();
	...
	else
	{
		...
		if (!Global_15725)
		{
			if (Global_16729 == 0)
			{
				if (!unk_0xB56FEBC510E7E9DE(Global_2285, 5))
				{
					unk_0x2E276854CAE5053A();
				}
				unk_0xA5F70A8B83BDFA49(&Global_2285, 5);
			...
			{
				unk_0x8DE4C04E61198D2F(Global_15331.f_368, Global_15331.f_369);
			}
		}
		func_58();
	}
...
void func_58()
{
	if (unk_0x4C779B19E6DDCDA2())
	{
		uLocal_107 = unk_0xE23D71F521207E8D();
	}
	else
	{
		...
		if (Global_69317)
		{
			if (unk_0xEDE19C6ED6E2F478(Global_14394))
			{
				if (!unk_0x2C063B4379F0C076())
				{
					...
					unk_0x573691DB812DC8AA(&(Global_2457713.f_1632), 15);
				}
			}
		}
	}
...
void func_60()
{
	if (unk_0xEDE19C6ED6E2F478(Global_14394))
	{
		if (!Global_15720)
		{
			...
			{
				func_105(Global_14394, "SET_DATA_SLOT", unk_0xBBDA792448DB5A89(4), unk_0xBBDA792448DB5A89(0), unk_0xBBDA792448DB5A89(3), -1f, -1f, &(Global_99250.f_32503[Global_1598 /*29*/].f_3), &(Global_99250.f_32503[Global_1598 /*29*/].f_7), "CELL_219", &(Global_99250.f_32503[Global_1598 /*29*/].f_3), 0);
			}
		}
		func_46(Global_14394, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
	}
...
void func_61()
{
	if (unk_0x4C779B19E6DDCDA2())
	{
		iLocal_109 = unk_0xC552B3A8E47271B7(unk_0xE23D71F521207E8D(), uLocal_95);
		iLocal_110 = unk_0xC552B3A8E47271B7(unk_0xE23D71F521207E8D(), uLocal_98);
	}
	else
	{
...
void func_63()
{
	...
	if (unk_0x3A691B47D5DE2593())
	{
		...
		else if (func_66(Global_2462514.f_20))
		{
...
void func_67()
{
	...
	while (iLocal_92 < Global_15708)
	{
		...
		while (iVar2 < 70 && iLocal_29 == 0)
		{
			...
			if (unk_0x03BBACB5FC5BF182(&cLocal_38))
			{
				StringCopy(&cLocal_50, unk_0x366B33759CCFE37B(&cLocal_38), 64);
				...
				if (unk_0x03BBACB5FC5BF182(&(Global_14580[iVar2 /*6*/])))
				{
					if (unk_0x35D1CAD6ADAB6491(&(Global_14580[iVar2 /*6*/]), &(Global_15331.f_187[iLocal_92 /*6*/])))
					{
						if (iVar3 > 36 || iVar4 > 36)
						{
						}
						unk_0xDEE5F3CD0486C29F(iVar3, &cLocal_50, &(Global_14580[iVar2 /*6*/]), iVar4, uVar5, 0, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
					}
				}
				iVar1 = (iVar1 + iVar0);
			}
			else if (unk_0x03BBACB5FC5BF182(&cLocal_44))
			{
				StringCopy(&cLocal_50, unk_0x366B33759CCFE37B(&cLocal_44), 64);
				iVar3 = func_81(0);
				iVar4 = func_80(0);
				uVar5 = func_78(0);
				uLocal_82 = func_77();
				...
				uVar10 = func_69(0);
				uVar11 = func_68(0);
				unk_0xDEE5F3CD0486C29F(iVar3, &cLocal_50, &(Global_15331.f_6[iLocal_92 /*6*/]), iVar4, uVar5, 1, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
	...
	if (Global_15718 == 0)
	{
		unk_0xA59AF4A89730858C(uLocal_83);
		unk_0x6ED1CF7901987402(uLocal_84);
		unk_0x2EBE42F6BE23D78D(Global_15331.f_368, Global_15331.f_369, Global_15331.f_370, uLocal_82);
		Global_15712 = 4;
	}
}
...
int func_68(int iParam0)
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_85), iParam0 * 7 + 6, iParam0 * 7 + 7);
	if (unk_0x35D1CAD6ADAB6491(uVar0, "0"))
	{
		return 0;
	}
	return 1;
...
int func_69(int iParam0)
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_85), iParam0 * 7 + 5, iParam0 * 7 + 6);
	if (unk_0x35D1CAD6ADAB6491(uVar0, "0"))
	{
		return 0;
	}
...
int func_70(int iParam0)
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_85), iParam0 * 7 + 4, iParam0 * 7 + 5);
	if (unk_0x35D1CAD6ADAB6491(uVar0, "0"))
	{
		return 0;
	}
...
int func_71(int iParam0)
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_85), iParam0 * 7 + 3, iParam0 * 7 + 4);
	if (unk_0x35D1CAD6ADAB6491(uVar0, "0"))
	{
		return 1;
	}
	if (unk_0x35D1CAD6ADAB6491(uVar0, "1"))
	{
		return 1;
	}
	if (unk_0x35D1CAD6ADAB6491(uVar0, "2"))
	{
		return 2;
	}
	if (unk_0x35D1CAD6ADAB6491(uVar0, "3"))
	{
		return 3;
	}
	if (unk_0x35D1CAD6ADAB6491(uVar0, "4"))
	{
		return 0;
	}
	return 0;
...
int func_72(int iParam0)
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_85), iParam0 * 7 + 2, iParam0 * 7 + 3);
	if (unk_0x35D1CAD6ADAB6491(uVar0, "0"))
	{
		return 0;
	}
...
int func_73(int iParam0)
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_85), iParam0 * 7 + 1, iParam0 * 7 + 2);
	if (unk_0x35D1CAD6ADAB6491(uVar0, "0"))
	{
		return 0;
	}
...
int func_74(int iParam0)
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_85), iParam0 * 7, iParam0 * 7 + 1);
	if (unk_0x35D1CAD6ADAB6491(uVar0, "0"))
	{
		return 0;
	}
...
int func_75()
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_73), 2, 3);
	if (unk_0x35D1CAD6ADAB6491(uVar0, "0"))
	{
		return 0;
	}
...
int func_76()
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_73), 1, 2);
	if (unk_0x35D1CAD6ADAB6491(uVar0, "0"))
	{
		return 0;
	}
...
int func_77()
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_73), 0, 1);
	if (unk_0x35D1CAD6ADAB6491(uVar0, "0"))
	{
		return 0;
	}
...
int func_78(int iParam0)
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_66), iParam0 * 3 + 2, iParam0 * 3 + 3);
...
int func_79(var uParam0)
{
	...
	if (unk_0x35D1CAD6ADAB6491(uParam0, "1"))
	{
		return 1;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "2"))
	{
		return 2;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "3"))
	{
		return 3;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "4"))
	{
		return 4;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "5"))
	{
		return 5;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "6"))
	{
		return 6;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "7"))
	{
		return 7;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "8"))
	{
		return 8;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "9"))
	{
		return 9;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "A"))
	{
		return 10;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "B"))
	{
		return 11;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "C"))
	{
		return 12;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "D"))
	{
		return 13;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "E"))
	{
		return 14;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "F"))
	{
		return 15;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "G"))
	{
		return 16;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "H"))
	{
		return 17;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "I"))
	{
		return 18;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "J"))
	{
		return 19;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "K"))
	{
		return 20;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "L"))
	{
		return 21;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "M"))
	{
		return 22;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "N"))
	{
		return 23;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "O"))
	{
		return 24;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "P"))
	{
		return 25;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "Q"))
	{
		return 26;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "R"))
	{
		return 27;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "S"))
	{
		return 28;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "T"))
	{
		return 29;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "U"))
	{
		return 30;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "V"))
	{
		return 31;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "W"))
	{
		return 32;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "X"))
	{
		return 33;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "Y"))
	{
		return 34;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "Z"))
	{
		return 35;
	}
	if (unk_0x35D1CAD6ADAB6491(uParam0, "z"))
...
int func_80(int iParam0)
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_66), iParam0 * 3 + 1, iParam0 * 3 + 2);
	return func_79(uVar0);
}
...
int func_81(int iParam0)
{
	...
	uVar0 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_66), iParam0 * 3, iParam0 * 3 + 1);
	return func_79(uVar0);
}
...
void func_82()
{
	...
	if (unk_0x03BBACB5FC5BF182(&cLocal_85))
	{
		sLocal_91 = unk_0x366B33759CCFE37B(&cLocal_85);
		if (unk_0x9D14A941038EF8A3(sLocal_91))
		{
		}
	}
}
...
void func_83()
{
	...
	if (unk_0x03BBACB5FC5BF182(&cLocal_73))
	{
		sLocal_79 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_73), 0, 1);
		if (unk_0x9D14A941038EF8A3(sLocal_79))
		{
		}
		sLocal_80 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_73), 1, 2);
		if (unk_0x9D14A941038EF8A3(sLocal_80))
		{
		}
		sLocal_81 = unk_0xDD65BFAE1F2CA44F(unk_0x366B33759CCFE37B(&cLocal_73), 2, 3);
		if (unk_0x9D14A941038EF8A3(sLocal_81))
		{
		}
	}
}
...
void func_84()
{
	...
	if (unk_0x03BBACB5FC5BF182(&cLocal_66))
	{
		sLocal_72 = unk_0x366B33759CCFE37B(&cLocal_66);
		if (unk_0x9D14A941038EF8A3(sLocal_72))
		{
		}
	}
}
...
void func_85()
{
	...
	if (Global_16704)
	{
		unk_0xFA6A919FFBCABE96(Global_15331.f_368, Global_15331.f_369, Global_15331.f_370, uLocal_82);
...
void func_86()
{
	...
	iLocal_31 = 0;
	iLocal_33 = 0;
	if (unk_0xD6F6FD43E370714E(&Global_15788))
	{
		if (unk_0x35D1CAD6ADAB6491(&Global_15788, "CT_AUD"))
		{
			Global_2621442 = 1;
		}
		iVar13 = 0;
		if (unk_0xA24A81C5933F1B29() || unk_0xBB3DCD23C363D187())
		{
			if (Global_1572930 == 1)
			{
				iVar13 = 1;
		...
		if ((unk_0x35D1CAD6ADAB6491(&Global_15788, "APCUTAU") || unk_0x35D1CAD6ADAB6491(&Global_15788, "APAIR")) || unk_0x35D1CAD6ADAB6491(&Global_15788, "APCALAU"))
		{
			iVar14 = 0;
			Global_2621442 = 0;
			iVar13 = 1;
		...
		if (((Global_15714 < 5 || Global_15714 == 10) || Global_15714 == 12) || Global_15714 == 13)
		{
			...
			{
				unk_0xC8C54AFEF8609CEF(&Global_15788, 7);
				while (!unk_0x77E40DD6F32BC674(7))
				{
					unk_0x4EDE34FBADD967A6(0);
				}
			}
			...
			{
				unk_0xE65D5DDE46C8B787(&Global_15788, 14);
				while (!unk_0x77E40DD6F32BC674(14))
				{
					unk_0x4EDE34FBADD967A6(0);
				}
			}
		...
		{
			unk_0xC8C54AFEF8609CEF(&Global_15788, 6);
			while (!unk_0x77E40DD6F32BC674(6))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
		}
		...
		{
			unk_0xE65D5DDE46C8B787(&Global_15788, 13);
			while (!unk_0x77E40DD6F32BC674(13))
			{
				unk_0x4EDE34FBADD967A6(0);
			}
		}
	...
	while (iVar2 < 70 && iLocal_29 == 0)
	{
		...
		if (unk_0x03BBACB5FC5BF182(&cLocal_38))
		{
			...
			if (unk_0x03BBACB5FC5BF182(&(Global_14580[iVar2 /*6*/])))
			{
				...
				else if (unk_0x35D1CAD6ADAB6491(&(Global_14580[iVar2 /*6*/]), &Global_16710))
				{
					if (iVar3 > 36 || iVar4 > 36)
					{
					}
			...
			{
				unk_0xDEE5F3CD0486C29F(iVar3, &cLocal_50, &cLocal_50, iVar4, uVar5, 0, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
			}
			iVar1 = (iVar1 + iVar0);
		}
		else
		{
			if (unk_0x03BBACB5FC5BF182(&cLocal_44))
			{
				StringCopy(&cLocal_50, unk_0x366B33759CCFE37B(&cLocal_44), 64);
				iVar3 = func_81(iVar2);
				iVar4 = func_80(iVar2);
				...
				uVar10 = func_69(iVar2);
				uVar11 = func_68(iVar2);
				unk_0xDEE5F3CD0486C29F(iVar3, &cLocal_50, &Global_15331, iVar4, uVar5, 1, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
			}
			iLocal_29 = 1;
		}
		iVar2++;
...
void func_87()
{
	...
	while (iVar0 <= 15)
	{
		...
		{
			if (unk_0x1F2158D615BC4B25(Global_15001[iVar0 /*10*/]) || Global_15001[iVar0 /*10*/] == 0)
			{
				unk_0xBBA8D4B7E3EBF713(iVar0, Global_15001[iVar0 /*10*/], &(Global_15001[iVar0 /*10*/].f_1));
			}
			if (Global_15001.f_161 == iVar0)
			{
				...
				{
					unk_0x4EDE34FBADD967A6(0);
					unk_0x2BB060D407401668(Global_15001.f_161, Global_15001.f_162);
				}
			}
		}
		iVar0++;
	...
	if (Global_2558945 == 1)
	{
		...
		while (iVar0 <= 19)
		{
			if (Global_2558764[iVar0 /*9*/].f_7 == 1)
			{
				if (unk_0x1F2158D615BC4B25(Global_2558764[iVar0 /*9*/]) || Global_2558764[iVar0 /*9*/] == 0)
				{
					unk_0xBBA8D4B7E3EBF713(Global_2558764[iVar0 /*9*/].f_8, Global_2558764[iVar0 /*9*/], &(Global_2558764[iVar0 /*9*/].f_1));
				}
			}
			iVar0++;
		}
...
void func_95()
{
	while (Global_14396 == 1 && unk_0xB1A77D5C890711F9(joaat("cellphone_flashhand")) > 0)
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	Global_14396 = 0;
	if (unk_0xB56FEBC510E7E9DE(Global_2283, 20))
	{
		unk_0x573691DB812DC8AA(&Global_2284, 1);
	}
	else
	{
		unk_0xA5F70A8B83BDFA49(&Global_2284, 1);
	...
	if (Global_15722)
	{
		if (Global_16729 == 0)
		{
			...
			{
				iLocal_34 = 5000;
				unk_0x780760E3B8427465(Global_15331.f_368, Global_15331.f_369);
			}
			else
			{
				iLocal_34 = 0;
	...
	else
	{
		...
		if (Global_15722 == 0)
		{
			...
			if (Global_16729 == 0)
			{
				...
				Global_14579 = 1;
				unk_0x5AE11BC36633DE4E(0);
				unk_0x573691DB812DC8AA(&Global_2283, 27);
				unk_0xC1B1E9A034A63A62(0);
			}
			else
			{
			...
			if (unk_0x4C779B19E6DDCDA2())
			{
				uLocal_101 = unk_0xE23D71F521207E8D();
			}
			else
			{
			...
			while (Global_14413.f_1 != 9 && Global_14396 == 0)
			{
				...
				if (unk_0x4C779B19E6DDCDA2())
				{
					iLocal_108 = unk_0xC552B3A8E47271B7(unk_0xE23D71F521207E8D(), uLocal_101);
				}
				else
				{
					iLocal_100 = unk_0x3EAC9995EC220C5A();
		...
		else
		{
			...
			if (!unk_0x0B6E83A9A7ED3EBA(unk_0x77F050A399DB77ED()))
			{
				...
				{
					unk_0xA5F70A8B83BDFA49(&Global_2284, 21);
				}
			}
			if (Global_15763 == 0)
			{
			...
			if (unk_0x4C779B19E6DDCDA2())
			{
				...
				uLocal_98 = unk_0xE23D71F521207E8D();
			}
			else
			{
...
float func_98(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, bool bParam13)
{
	...
	fVar3 = func_100((unk_0xBBDA792448DB5A89((unk_0x3EAC9995EC220C5A() - iLocal_18)) / fParam12), 0f, 1f);
	if (fVar3 < 1f)
	{
		fVar4 = fVar3;
		if (bParam13)
