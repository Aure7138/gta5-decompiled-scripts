	...
	switch (Global_110852)
	{
		case 0:
			if (!Global_110852.f_27)
			{
				...
				{
					iVar0 = iVar1;
					if (func_66(func_67(iVar0)) && (Global_110852.f_15[iVar1] + 120000) < unk_0x578C4EF320340AF7())
					{
						if (func_64(iVar0))
						{
							func_63(iVar0, 0);
						...
						else
						{
							...
							else if (((unk_0x578C4EF320340AF7() >= Global_110852.f_4[iVar1] && func_51()) && func_50(iVar0)) && func_49(iVar0) >= func_48(iVar0))
							{
							...
							if (func_47() == 2)
							{
								func_55(&uLocal_36, 0, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
							}
							else if (func_47() == 0)
							{
								func_55(&uLocal_36, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 0, 1);
							}
							else if (func_47() == 1)
							{
								func_55(&uLocal_36, 0, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
							}
...
void func_19(int iParam0)
{
	...
	unk_0xBE9B3870B1B370E3("stripperhome");
	while (!unk_0x8DC2EFD1CECAA468("stripperhome"))
	{
		unk_0x4EDE34FBADD967A6(0);
	}
	if (func_51())
...
int func_50(int iParam0)
{
	switch (iParam0)
	{
		...
		case 6:
		case 7:
			if (unk_0x1F596C965B00E290() < 6 || unk_0x1F596C965B00E290() > 14)
			{
				return 1;
			}
			break;
...
void func_68()
{
	...
	switch (Global_110852)
	{
		case 0:
			...
			{
				if (unk_0x578C4EF320340AF7() >= Global_110852.f_3)
				{
...
int func_75()
{
	switch (func_12(unk_0x9B0761B4C3EB8BC7()))
	{
		case 0:
			return 0;
			break;
...
int func_76()
{
	...
	while (iVar0 < 10)
	{
		if (Global_111858.f_243[func_47() /*53*/].f_2[iVar0 /*5*/].f_4 && unk_0x578C4EF320340AF7() >= Global_110852.f_4[iVar0])
		{
			iVar2[iVar1] = iVar0;
			iVar1++;
		}
	...
	if (iVar1 > 0)
	{
		iVar13 = unk_0x344C570D6F8700DF(0, iVar1);
		return iVar2[iVar13];
	}
	return -1;
}
...
void func_79()
{
	...
	{
		if (Global_110852.f_3 < (unk_0x578C4EF320340AF7() + 120000))
		{
			func_82(1800000);
		}
