	...
	switch (iLocal_43)
	{
				...
				if (unk_0x9390801B06EE998F())
				{
					if (!func_20())
					{
						if (((!unk_0xE87F28FD4128D063() && !func_14()) && !func_13()) && !func_12())
						{
							...
							uLocal_612 = unk_0x8DE4F68A9728925E("LETTER_SCRAPS");
							while (!unk_0xA0C7B98BCF1EEF9E(uLocal_612))
							{
								unk_0x4EDE34FBADD967A6(0);
							}
							unk_0x88F483FBD433696A(uLocal_612, "SET_LETTER_TEXT");
		...
		case 1:
			...
			if (iLocal_613 < 4)
			{
				...
				unk_0xA91A4C18A2DB01BD(uLocal_612, 255, 255, 255, 255, 0);
			}
			else
			{
				iLocal_43 = 2;
		...
		if (!(iParam1[uParam0->f_10 /*11*/])->f_10)
		{
			if (!bVar1)
			{
				...
				else if (uParam0->f_10 == iLocal_608)
				{
					...
					{
						unk_0x57303BAC3E5DA035((iParam1[uParam0->f_10 /*11*/])->f_1, sLocal_609);
					}
				}
				else
				{
...
int func_38(var uParam0, var uParam1, struct<3> Param2)
{
	...
	{
		if ((unk_0xB7A628320EFF8E47(Param2, unk_0x80C8AA1625977488((uParam1[bVar0 /*11*/])->f_1)) > (60f * 60f) || func_58(13)) || func_58(14))
		{
...
void func_73()
{
	...
	unk_0xD314260005F064BF(&uLocal_612);
