...
void func_1()
{
	...
	if (func_11(8))
	{
		...
		{
			iVar1 = func_10(iVar0);
			if (unk_0xE2D0C323A1AE5D85(Global_112915.f_24979.f_1, iVar0))
			{
				if (unk_0xE2D0C323A1AE5D85(Global_112915.f_24979.f_3, iVar0))
				{
					...
					if (fVar2 > 43681f)
					{
						if (!func_7(iVar1))
						{
							if (!Global_112889[iVar0])
							{
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								unk_0xB0550BC91B0159D6(&(Global_112915.f_24979.f_3), iVar0);
							}
							else if ((unk_0x320D1840B6DAA1CC() - Global_112895[iVar0]) > 60000)
							{
								Global_112889[iVar0] = 0;
								Global_112895[iVar0] = unk_0x320D1840B6DAA1CC();
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								unk_0xB0550BC91B0159D6(&(Global_112915.f_24979.f_3), iVar0);
							}
...
{
	return unk_0xE2D0C323A1AE5D85(Global_112915.f_9085.f_99.f_219[0], iParam0);
}
...
void func_19()
{
	...
	if (func_11(7))
	{
		...
		{
			iVar1 = func_22(iVar0);
			if (unk_0xE2D0C323A1AE5D85(Global_112915.f_24976.f_2, iVar0))
			{
				fVar2 = unk_0xB7A628320EFF8E47(func_9(unk_0x9E2D6C50374FCFA9()), func_8(iVar1, 0));
				if (fVar2 > 43681f)
				{
					if (!func_7(iVar1))
					{
						if (!Global_112879[iVar0])
						{
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							unk_0xB0550BC91B0159D6(&(Global_112915.f_24976.f_2), iVar0);
						}
						else if ((unk_0x320D1840B6DAA1CC() - Global_112884[iVar0]) > 60000)
						{
							Global_112879[iVar0] = 0;
							Global_112884[iVar0] = unk_0x320D1840B6DAA1CC();
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							unk_0xB0550BC91B0159D6(&(Global_112915.f_24976.f_2), iVar0);
						}
