...
void __EntryFunction__()
{
	...
	if (unk_0x25531002BCF0D968(joaat("controller_races")) > 1)
	{
		unk_0x883793591E631A3B();
	}
	while (unk_0x25531002BCF0D968(joaat("initial")) > 0)
	{
...
void func_1()
{
	...
	if (func_11(8))
	{
		...
		{
			iVar1 = func_10(iVar0);
			if (unk_0x61D8FEAF64881CDA(Global_97173.f_28101.f_1, iVar0))
			{
				if (unk_0x61D8FEAF64881CDA(Global_97173.f_28101.f_3, iVar0))
				{
					fVar2 = unk_0xB7A628320EFF8E47(func_9(unk_0xAF65E5A58BE87D95()), func_8(iVar1, 0));
					if (fVar2 > 43681f)
					{
						if (!func_7(iVar1))
						{
							if (!Global_97147[iVar0])
							{
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								unk_0xCD27BF29FB9012E2(&(Global_97173.f_28101.f_3), iVar0);
							}
							else if ((unk_0xF976C624234A4AA8() - Global_97153[iVar0]) > 60000)
							{
								Global_97147[iVar0] = 0;
								Global_97153[iVar0] = unk_0xF976C624234A4AA8();
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								unk_0xCD27BF29FB9012E2(&(Global_97173.f_28101.f_3), iVar0);
							}
...
{
	return unk_0x61D8FEAF64881CDA(Global_97173.f_7311.f_99.f_214[0], iParam0);
}
...
void func_18()
{
	...
	if (func_11(7))
	{
		...
		{
			iVar1 = func_21(iVar0);
			if (unk_0x61D8FEAF64881CDA(Global_97173.f_28098.f_2, iVar0))
			{
				fVar2 = unk_0xB7A628320EFF8E47(func_9(unk_0xAF65E5A58BE87D95()), func_8(iVar1, 0));
				if (fVar2 > 43681f)
				{
					if (!func_7(iVar1))
					{
						if (!Global_97137[iVar0])
						{
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							unk_0xCD27BF29FB9012E2(&(Global_97173.f_28098.f_2), iVar0);
						}
						else if ((unk_0xF976C624234A4AA8() - Global_97142[iVar0]) > 60000)
						{
							Global_97137[iVar0] = 0;
							Global_97142[iVar0] = unk_0xF976C624234A4AA8();
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							unk_0xCD27BF29FB9012E2(&(Global_97173.f_28098.f_2), iVar0);
						}
