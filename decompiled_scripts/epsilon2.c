...
void func_1()
{
	...
	unk_0xEDC1A5B84AEF33FF(iLocal_147, 241.3494f, 361.0303f, 105.9036f, &uVar0, &fVar1);
	switch (iLocal_146)
	{
		case 0:
			iLocal_151 = 0;
		...
		case 1:
			...
			{
				if (!iLocal_151 && (unk_0x9CD27B0045628463() - iLocal_148) > 15000)
				{
				...
				if (!iLocal_153 && !unk_0x51210CED3DA1C78A(unk_0xD80958FC74E988A6(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, false, true, 0))
				{
					if (!unk_0x51210CED3DA1C78A(unk_0xD80958FC74E988A6(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, false, true, 0))
					{
						...
						if (unk_0x73D57CFFDD12C355(fVar1) <= 0.05f && !iLocal_153)
						{
							func_3(109, 6);
							func_3(109, 1);
							iLocal_152 = 1;
...
void func_38(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_39(unk_0xD80958FC74E988A6()))
	{
...
int func_177()
{
	return func_178(unk_0x442E0A7EDE4A738A(), 0);
}
...
void func_196(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (unk_0x7239B21A38F536BA(*iParam0))
	{
		if (!unk_0x84A2DD9AC37C35C1(*iParam0))
...
int func_199(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x997ABD671D25CA0B(unk_0xD80958FC74E988A6(), false))
	{
		...
		{
			if (!func_206(unk_0x9A9112A0FE9A4713(unk_0xD80958FC74E988A6(), false), fParam1, 1, 1056964608, 0, 1))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_205(unk_0xD80958FC74E988A6(), -828834893))
				{
...
int func_206(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5)
{
...
{
	if (((!func_222(0) || Global_68336) || Global_68325 == 1) || !unk_0x5A859503B0C08678())
	{
		return 0;
	}
	switch (Global_68321)
	{
		...
		case 5:
			if ((unk_0xD3C2E180A40F031E() || func_221(0)) || func_220(1))
			{
			}
			else
			{
...
int func_269(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (unk_0x27561561732A7842(iParam0, func_62(iParam1)) > 0 && unk_0x8F7156A3142A6BAD(iParam0, func_62(iParam1), Global_67928[1 /*14*/].f_3) > 0)
		{
			unk_0x262B14F48D29DE80(iParam0, func_62(iParam1), Global_67928[1 /*14*/].f_3, Global_67928[1 /*14*/].f_4, 0);
		}
	}
...
void func_273(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (iParam1 == 1)
	{
		func_274(iParam0, bParam2, bParam3);
	}
...
void func_274(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_275(&sVar32, Var0.f_3, Global_89821, bParam1, bParam2);
	}
}

void func_275(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
...
void func_277()
{
	...
	{
		func_8();
		unk_0xBF59707B3E5ED531(func_278(Global_97173.f_1729.f_539.f_3213));
	}
	else
	{
...
void func_312(bool bParam0)
{
	...
	if (!func_331())
	{
		...
		{
			func_274(iVar0, 1, 0);
			func_313(unk_0x442E0A7EDE4A738A(), iVar0);
		}
		else
		{
			if (Global_96260[iVar0 /*10*/].f_9 == -1)
...
int func_314(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_320())
	{
		...
		{
			iVar33 = func_315(unk_0x442E0A7EDE4A738A());
			if (iVar33 > -1)
			{
