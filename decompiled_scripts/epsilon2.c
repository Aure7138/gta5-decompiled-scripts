...
void func_1()
{
	...
	unk_0x696D2AC31CB5932A(iLocal_149, 241.3494f, 361.0303f, 105.9036f, &uVar0, &fVar1);
	switch (iLocal_148)
	{
		case 0:
			iLocal_153 = 0;
		...
		case 1:
			...
			{
				if (!iLocal_153 && (unk_0x1DD05E817C89C737() - iLocal_150) > 15000)
				{
				...
				if (!iLocal_155 && !unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, 1, 0))
				{
					if (!unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, 1, 0))
					{
						...
						if (unk_0x1D5CD3EAAA7422B0(fVar1) <= 0.05f && !iLocal_155)
						{
							func_3(109, 6);
							func_3(109, 1);
							iLocal_154 = 1;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = unk_0x7B6C0A0D604E68FA(iParam3, 10, -1, 0, -1, func_72(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
void func_122(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar56 >= 0)
		{
			iVar57 = unk_0x7B6C0A0D604E68FA(iVar1, 10, -1, 0, -1, func_72(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_260()
{
	...
	{
		func_323(13, unk_0xF34EE736CF047844(Global_113648.f_10196.f_3853));
	}
...
int func_334(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_340())
	{
		...
		{
			iVar33 = func_335(unk_0x1AF90EB93E0012D6());
			if (iVar33 > -1)
			{
